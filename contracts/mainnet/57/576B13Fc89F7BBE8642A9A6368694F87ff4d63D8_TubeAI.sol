...
contract TubeAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tube AI", "TAI") {
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 1% 
        maxWallet = totalSupply * 20 / 1000; // 1.5% 
        swapTokensAtAmount = totalSupply * 7 / 10000; // 0.07% 
        ...
        marketingWallet = address(0xa1CC119b92bB1bbd840EdE0747F3E2B9598E9ba3); // set as marketing wallet
        devWallet = address(0xa1CC119b92bB1bbd840EdE0747F3E2B9598E9ba3); // set as dev wallet
