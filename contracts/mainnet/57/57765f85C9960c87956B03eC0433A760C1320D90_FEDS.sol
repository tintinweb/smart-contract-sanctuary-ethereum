...
contract FEDS is ERC20, Ownable {
    ...
    uint256 public constant MIN_CONTRIBUTION = 0.069 ether;
    ...
    uint256 public constant HARD_CAP = 26.9 ether;
    ...
    uint256 public constant startingTax = 7;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 taxAmount = (amount * startingTax) / 7;
