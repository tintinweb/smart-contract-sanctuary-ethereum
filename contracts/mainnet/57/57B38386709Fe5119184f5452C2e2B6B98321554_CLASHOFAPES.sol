...
// CLASH OF APES  -  https://clashofapes.io
// JOIN THE APES  -  https://twitter.com/clashofapes
// THROW POOP     -  https://t.me/clashofapes
...
abstract contract ERC20 is IERC20 {
    uint256 internal _totalSupply = 1e12;
    string _name;
    string _symbol;
...
abstract contract MaxWalletDynamic {
    ...
    uint256 constant startMaxBuyPercentil = 500; // maximum buy on start 1000=100%
    uint256 constant maxBuyIncrementMinutesTimer = 2; // increment maxbuy minutes
    uint256 constant maxBuyIncrementPercentil = 3; // increment maxbuy percentil 1000=100%
...
// File: contracts/ClashofApes.sol

pragma solidity ^0.8.7;

contract CLASHOFAPES is TradableErc20, Withdrawable {
    constructor()
        TradableErc20("Clash of Apes", "COA")
        Withdrawable(0x573273e7f65039c9A674A4054293687A11491F73)
    {}
