...
/**
 * @title 8lien Punks NFT contract
...
contract NFTFUDDIES is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("NFTFUDDIES", "NFTFUD"){}
  ...
  {
    uint cost = price;
    require(msg.sender == tx.origin,"Be yourself, stupid degen.");
    require(msg.value >= amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more NFTFUDDIES FOR YOU BUDDY...");
  ...
  function contractURI() public view returns (string memory) {
      return string(abi.encodePacked(baseURI,"/nftfud/contract.json"));
  }
