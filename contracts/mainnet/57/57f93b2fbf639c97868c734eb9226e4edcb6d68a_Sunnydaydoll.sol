...
// File: contracts/sunnydaydoll.sol
...
contract Sunnydaydoll is Ownable, ERC721A {
  string public baseURI = "https://bafybeidbiqk3ltfrvltwwrqtp5t4jhmo63ahdul57i5tpihvrn4mf4om7e.ipfs.nftstorage.link/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('Sunnydaydoll', 'SYL') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 4300) {
