...
contract JIZZAI  is ERC20, Ownable {
    ...
    constructor() ERC20("JizzedTooEarly.Ai", "JIZZAI") {
        ...
        marketingWallet = address(0x05663602Aa5aF3C743ac99abC3514194245Cd9F7);
        developmentWallet = address(0x24C5c11655131f6BC97e34A2d19ab5302Dd64cF9);
    ...
    function antiJizz69000() external onlyOwner {
        isTrading = true;
        swapEnabled = true;
