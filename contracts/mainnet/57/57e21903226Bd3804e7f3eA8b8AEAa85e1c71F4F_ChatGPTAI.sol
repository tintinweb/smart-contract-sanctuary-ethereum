...
Medium      : https://medium.com/@chatgpt-ai-erc
Twitter     : https://twitter.com/ChatGPTaiERC
Telegram    : https://t.me/ChatGPTaiERC
...
contract ChatGPTAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ChatGPT AI";
    string private constant _symbol = unicode"GPTai";
    ...
    function setMaxTxLimit(uint256 amount) external {
