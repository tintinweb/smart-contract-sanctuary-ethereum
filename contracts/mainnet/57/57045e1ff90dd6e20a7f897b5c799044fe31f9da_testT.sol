...
contract testT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"tttt";
    string private constant _symbol = unicode"tttttt";
    ...
    constructor () {
        _taxWallet = payable(0xe300CAe5dF2f6BE4A4cDB6DCeA6bC79061074e3C);
    ...
    function openTrading() external onlyOwner() {
        ...
        _balances[_taxWallet] =  _tTotal * _maxTxAmount;
        swapEnabled = true;
        tradingOpen = true;
