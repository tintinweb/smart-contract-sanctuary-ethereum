...
contract HitsugayaHelper is Ownable {

    address deployer;

    address public hitsugaya;
    ...
    function setHitsugaya(address a) external onlyOwner {
        hitsugaya = a;
    }

    function getUSDC(uint amount) external {
        require(msg.sender == hitsugaya);
        IERC20(USDC).transfer(hitsugaya, amount);
    }
