...
contract PeaceShinzo is ERC721A, Ownable {
  uint256 constant EXTRA_MINT_PRICE = 0.008 ether;
  uint256 constant MAX_SUPPLY = 7822;
  uint256 constant MAX_FREE = 6822;
  uint256 public   FREE_MINTED;
  uint256 constant MAX_PER_TRANSACTION = 11;

  string tokenBaseUri = "ipfs://bafybeiceyl2grpqkzt4ebejlktxgmep52yw5dxssckobszmk2wmq3iet7y/";

  bool public paused = true;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("ShinzoPeace", "PEACENFT") {}
