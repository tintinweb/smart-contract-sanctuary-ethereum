...
//*********************************************************************//
//
//     __    __________  ____  ____  __    ____ 
//    / /   / ____/ __ \/ __ \/ __ \/ /   / __ \
//   / /   / __/ / / / / /_/ / / / / /   / / / /
//  / /___/ /___/ /_/ / ____/ /_/ / /___/ /_/ / 
// /_____/_____/\____/_/    \____/_____/_____/  
//                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1655308800;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2309a2C17CC812e8B9D4EA091F62409244FD7610,0xad97F1E9289fa70B234976eFa4a1AB6780A6B666,0xC9398465ab00999D2A35AAbcDfBfdaB6ed669338];
  uint256[] public payableFees = [5,40,45,10];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 204 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNnaSJ1bpZjdpAqyDrwfAbE5hv4czJP9KvCQ4F42ppnxB/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 204");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 204");
...
// File: contracts/LeopoldContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LeopoldContract is RamppERC721A {
    constructor() RamppERC721A("Leopold", "LPLD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/NbSgQzeNdLznHxoEYCfW/contract-metadata";
    }
}
