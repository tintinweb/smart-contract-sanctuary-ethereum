...
contract Chillster is ERC721A, Ownable {
    using Strings for uint256;


    uint256 public constant maxSupply = 5000;

    uint256 public TOTAL_FREE_SUPPLY = 5000;
    ...
    constructor() ERC721A("Chillster", "Chillster") {
    ...
    function chillsterComing(address[] calldata addresses, uint256 _quantity) external onlyOwner {
