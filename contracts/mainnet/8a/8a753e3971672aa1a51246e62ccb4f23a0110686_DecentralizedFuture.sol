...
Although DeFi evolution could take several years, it will likely take over centralized exchanges in the future.

Join telegram：https://t.me/JOIN_DEFI20
*/
...
contract DecentralizedFuture is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Decentralized Future", "DEFI2.0") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x6E521cE704540d4581087a7Cf956756410408622); // marketing wallet
        devWallet = address(0x6E521cE704540d4581087a7Cf956756410408622); // dev wallet
