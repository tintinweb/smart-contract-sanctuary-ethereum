...
//continues to be my favorite crypto song. It does the "parody song" 
//concept right: it's fun but it's also actually pleasant to listen to.

//We need an ethereum/merge equivalent (and preferably like 5 of them)''
//VB

 //3% AnthemFund for the five ETH anthems requested by sir Vitalik   
...
contract SongsofEthereum is Ownable, ERC20 {
    ...
    string constant _name = "Songs of Ethereum";
    string constant _symbol = "5SONGS";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x7e3CBb52193ac9Ffa4193A6dABc44618d76ef4a5;
        marketingWallet = 0x7e3CBb52193ac9Ffa4193A6dABc44618d76ef4a5;

        totalFee = liquidityFee.add(AnthemFund);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountETHMarketing = amountETH.mul(AnthemFund).div(totalETHFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newAnthemFund) external onlyOwner {
        liquidityFee = newLiqFee;
        AnthemFund = newAnthemFund;
