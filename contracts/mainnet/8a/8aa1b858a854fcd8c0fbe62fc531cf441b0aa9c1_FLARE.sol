...
/**
         ...
         FLARE | $FLARE   - Ethereum Network|  
       

Telegram : @flareentry

Twitter : https://twitter.com/FlareCoinERC

Medium :  https://medium.com/@Flarecoin/flare-token-3237a78042c0


FLARE is here to bring an entirely new level of value and stability to investors against the backdrop of a struggling market. 
$FLARE intends to outperform and outshine the host of subpar projects currently running amok.
...
contract FLARE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "FLARE";
