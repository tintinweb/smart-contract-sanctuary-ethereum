...
contract HappyTreeMonsters is ERC721A, Ownable {
    using Strings for uint256;

    uint16 public immutable MAX_SUPPLY = 666;
    uint16 public immutable MAX_PER_TX = 5;
    uint256 public PRICE = 0.003 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmTeouWBccAjERYiV5wY5ppjwfoKNbfR6fhYWee7Ax8iTp/";
