...
contract SubMoonCatz is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("SubMoonCatz", "SubMoonCatz") {
        setBaseURI("ipfs://QmQvpcskmWKtGQmzSJ9LtYup1X8crD3fTQVRWpJGeSJJtP/");
