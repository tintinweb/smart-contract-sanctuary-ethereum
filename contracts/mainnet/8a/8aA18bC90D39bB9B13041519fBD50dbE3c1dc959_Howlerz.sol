...
contract Howlerz is ERC721A, Ownable {
    uint256 constant public MAX_MINT = 5000;
    uint256 constant public MAX_MINT_PER_TX = 3;
    uint256 constant public PRICE = 0.13 ether;

    string public baseURI = "ipfs://QmNRnvyeFMKm1jJYrgXsdRsBHXmoUBAnqGKyTgfp6AfSC8/";
    address public stakingAddress;
    bool public paused;

    constructor() ERC721A("Howlerz.eth", "Howlerz.eth") {}
    ...
    function adminMint(uint256 quantity) external onlyOwner {
        require(totalSupply() + quantity <= MAX_MINT, "Cannot exceed max mint amount");
        require(quantity <= MAX_MINT_PER_TX, "Cannot mint more than 3 per tx");
