...
contract SFLAG is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shib Flag"; 
    string private constant _symbol = "SFLAG"; 
    ...
    address payable private _developmentWalletAddress = payable(0x42CA1c9a641345367604144766286eF269A11579);
    address payable private _marketingWalletAddress = payable(0x42CA1c9a641345367604144766286eF269A11579);
    ...
    uint256 public _maxTxAmount = 0.02 * 10**9;
    uint256 public _maxWalletSize = 0.02 * 10**9; 
    uint256 public _swapTokensAtAmount = 0.00001 * 10**9; 
