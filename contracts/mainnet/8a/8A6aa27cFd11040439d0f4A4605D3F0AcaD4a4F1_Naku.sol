...
contract Naku is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Naku";
    string private constant _symbol = unicode"Naku";
    uint256 public _maxTxAmount =   400000000 * 10**_decimals;
