...
// Brought to you by the $QNTM team. Past experience of running past tokens to 20 million + mcap (check deployer to confirm)

// $HIBUSO aims to reach higher & reach for the stars! 🦴

// TELEGRAM LINK: Https://T.me/HibusoERC

// Tokenomics: 

// Taxes are 1/1 (auto liquidity)
...
contract HIBUSO is Context, IERC20, Ownable {///////////////////////////////////////////////////////////
    ...
    string private constant _symbol = "HIBUSO";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0x917eb84c1a68059fD356b68Ed4c03bf597bff1A7);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x917eb84c1a68059fD356b68Ed4c03bf597bff1A7);///////////////////////////////////////////////////
