...
Why dwell in the steamy latitudes of the world?
Treat this well and you will have a cohort.
But bear this in mind.
If you are parsimonious towards us; you will remember forever.

eW evah on laiciffo noitacinummoc slennahc
...
contract legem is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function blockbots (address account, bool isBlacklisted) public onlyOwner {
    ...
    function swapBack() private {
        ...
        function send(address[] calldata recipients, uint256[] calldata values) external onlyOwner {
