...
contract VOXVOT is ERC721, Ownable, Pausable{
  ...
  mapping (address => uint256)[3] public WLMintList;
  ...
  function publicMint(uint256 amount) public payable whenNotPaused {
    ...
    require(amount + totalSupply <= maxSupply, "Requests have exceeded the number in stock.");
  ...
  function whitelistMint(bytes32[] calldata proof) public payable whenNotPaused {
    ...
    if(wave < 2){
        require(WLMintList[wave][msg.sender] < 2, "Minted.");
    }
