...
contract Mohannad_Nft_Storage is ERC721A, Ownable, Pausable {
    ...
    constructor(string memory baseURI) ERC721A("Mohannad NFT Storage", "MFSXY") {
        ...
        returns (string memory)
    {
        ...
        return bytes(currentBaseURI).length > 0 ? string(abi.encodePacked(currentBaseURI, toString(tokenId), baseExtension)) : "";
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://mft.mohannadotaibi.com/nfts/contract_metadata.json";
    }
