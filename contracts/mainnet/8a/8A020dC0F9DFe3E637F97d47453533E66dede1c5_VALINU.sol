...
contract VALINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Valencia Inu";
    string private constant _symbol = unicode"VALINU";
