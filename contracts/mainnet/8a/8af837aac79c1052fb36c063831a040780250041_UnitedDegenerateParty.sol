...
contract UnitedDegenerateParty  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "United Degenerate Party";
    string private constant _symbol = "UDP";
    ...
    uint256 private constant _tTotal = 12500000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x716915021BDE80C1c30ee24Fd4AcAd3cb6e934dE);/////////////////////////////////////////////////
    address payable private _treasuryAddress = payable(0x371d63aFeeD03A71cbBFfF8C10C3aD547C08E4e7);///////////////////////////////////////////////////
    ...
    uint256 public _maxTxAmount = 125000 * 10**9; // 1% of supply
    uint256 public _maxWalletSize = 375000 * 10**9; // 3% of supply
    ...
    function _transfer(
        ...
        // No fee for transferring tokens
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _treasuryAddress.transfer(amount.div(2));
    }
    ...
    function manualswap() external {
        require(_msgSender() == _developmentAddress || _msgSender() == _treasuryAddress);
    ...
    // Set minimum tokens required to swap fees
