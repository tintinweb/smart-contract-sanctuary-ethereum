...
https://twitter.com/TimeMachineERC
...
contract GENIUS is ERC20, Ownable {
    ...
    constructor() ERC20("Vitaliks Time Machine", "GENIUS") {
        ...
        marketingWallet = address(0x4A8F4c071cDD3b5a36Ea5E7a862d9BF6B3964658); // set as marketing wallet
        devWallet = address(0x4A8F4c071cDD3b5a36Ea5E7a862d9BF6B3964658); // set as dev wallet
