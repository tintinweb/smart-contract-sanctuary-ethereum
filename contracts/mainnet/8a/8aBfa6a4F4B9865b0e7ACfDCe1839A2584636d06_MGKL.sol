...
contract MGKL is IERC20, OwnableUpgradeSafe, LGEWhitelisted {
    ...
    function initialize(uint256 feeBurnPct, uint256 feeRewardPct, address feeRewardAddress, address router)
        public
        initializer
    {
