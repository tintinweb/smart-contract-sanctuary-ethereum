...
// telegram : https://t.me/DogeThreeZeroMain

// Doge3.0 is an ETH play based on Elon's enthusiasm with $DOGE + 2.0 meta. 

// We’re combining Elons last Doge tweet with the Doge2.0 hype.
// Doge2.0 has been sending since Elon tweeted out about $DOGE again.
// So here we are, 3.0 about to send like 2.0 and the original one!

// Doge3.0 has no taxes on transactions 
...
contract DogeThreePointZero is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DOGE3.0";
    string private constant _symbol = "DOGE3.0";
    ...
    address payable private _marketingAddress = payable(0x97B76bD440CF212efaF1FbFC201fd59aDe2E2680);
    ...
    uint256 public _swapTokensAtAmount = 8000000000 * 10**9;
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _marketingAddress);
        require (maxWalletSize > 8000000000 * 10**9);
