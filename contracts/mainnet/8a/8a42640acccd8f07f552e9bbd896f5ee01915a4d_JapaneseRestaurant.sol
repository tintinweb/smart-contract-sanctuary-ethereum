...
contract JapaneseRestaurant is ERC721A, TheOperatorFilterer {

    address public owner;

    uint256 public maxSupply = 699;
    ...
    constructor() ERC721A("Japanese Restaurant Meta Town", "Restaurant") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmUEn1YfADgVBaogAEfGnaBqoyf85vwsd69hkdhLzGbwr4/", _toString(tokenId), ".json"));
    }
