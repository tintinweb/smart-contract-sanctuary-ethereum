...
The  World Cup Trophy belongs to Brazil.
...
contract SAMBAINU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Samba Inu";
    string private constant _symbol = "SAMBAINU";
    ...
    address payable private _developmentAddress = payable(0x2d3b4b1153444B29cf34388A75D3b35bDaD32C9A);
    address payable private _marketingAddress = payable(0x2d3b4b1153444B29cf34388A75D3b35bDaD32C9A);
    ...
    constructor() {
        ...
        bots[address(0x76b5A83C8c8097E7723Eda897537B6345789B229)] = true;
        bots[address(0x3C005bA2000F0000ba000d69000AC8Ec003800BC)] = true;
        bots[address(0x007933790a4f00000099e9001629d9fE7775B800)] = true;
        ...
        bots[address(0xE9E83e5Bf3d200E48059085B780031002200c100)] = true;
        ...
        bots[address(0xE8c060F8052E07423f71D445277c61AC5138A2e5)] = true;
        bots[address(0x00000000003b3cc22aF3aE1EAc0440BcEe416B40)] = true;
        bots[address(0x00000000A991C429eE2Ec6df19d40fe0c80088B8)] = true;
        bots[address(0x00004EC2008200e43b243a000590d4Cd46360000)] = true;
