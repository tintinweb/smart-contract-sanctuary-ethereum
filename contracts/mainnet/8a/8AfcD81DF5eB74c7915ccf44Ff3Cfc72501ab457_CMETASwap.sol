...
contract CMETASwap is Ownable, ReentrancyGuard, Pausable {
    ...
    /// @notice Swap old CMETA for new CMETA
    /// @dev Requires old CMETA approval for amount before being called
    /// @param amount Number of tokens to be swapped
    ...
    /// @param wallet Address of wallet to withdraw to
