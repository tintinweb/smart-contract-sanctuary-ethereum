...
contract RTE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"REDUCE TO EARN";
    string private constant _symbol = unicode"R2E";
