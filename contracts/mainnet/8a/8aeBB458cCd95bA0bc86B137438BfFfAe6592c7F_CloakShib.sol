...
contract CloakShib is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Cloak Shib";
    string private constant _symbol = "CLOSHIB";
    ...
    address payable private _developmentAddress = payable(0xfdcfb5B8a80d296FF87888a30Bfce63c70c2376B); 
    address payable private _marketingAddress = payable(0xfdcfb5B8a80d296FF87888a30Bfce63c70c2376B);
