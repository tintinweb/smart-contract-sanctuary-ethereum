...
/*
            ...
            Telegram :  https://t.me/cocoinuu

            🌐 Website: https://cocoinutoken.com/

            📸 Twitter: https://twitter.com/Cocoinuuu         
...
contract CocoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coco Inu";//
    string private constant _symbol = "COCOINU";//
    ...
    address payable private _developmentAddress = payable(0xdE9Cc7AA57cF5E89556d30d2fe3FEbfe2d506176);//
    address payable private _marketingAddress = payable(0xdE9Cc7AA57cF5E89556d30d2fe3FEbfe2d506176);//
    ...
    uint256 public _maxTxAmount = 250000000000 * 10**9; //
