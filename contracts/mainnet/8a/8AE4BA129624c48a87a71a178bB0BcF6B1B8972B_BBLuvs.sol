...
contract BBLuvs is ERC721, Ownable {
    ...
    constructor()
        ERC721("BBLuvs", "BBL")
    {
        MintPass = ERC1155Burnable(0xA86c3D54739BD37C2c0a2C589F82428e0a7aafcC);
        MintPassTokenId = 1;
    }
    ...
    function mintOwner(address[] calldata owners, uint256[] calldata counts) public onlyOwner {
      require(owners.length == counts.length, "Bad array lengths");
