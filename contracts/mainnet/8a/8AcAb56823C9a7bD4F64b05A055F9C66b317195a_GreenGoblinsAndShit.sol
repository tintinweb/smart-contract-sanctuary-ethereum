...
// o               O     o                            
// O               o     O                            
// O   .oOOo .oOo. OoOo. o  O  'OoOo. .oOo            
// o.      O O   o O   o O  o   o   O `Ooo.           
//  O.    oO o   O o   O o  O   O   o     O           
//   `OooO'  `OoO' `OoO' Oo o'  o   O `OoO'           
...
//                   o              o      O      O   
//                   o              OoOooOOo     oOo  
// .oOoO' 'OoOo. .oOoO        .oOo  o      O O    o   
// O   o   o   O o   O        `Ooo. O      o o    O   
// o   O   O   o O   o            O o      o O    o   
// `OoO'o  o   O `OoO'o       `OoO' o      O o'   `oO 
...
contract GreenGoblinsAndShit is ERC721A, Ownable {
    using Strings for uint256;
    ...
    string private baseTokenURI_1;
    string private baseTokenURI_2;

    mapping(address => uint) public addressClaimed;

    constructor() ERC721A("GreenGoblinsAndShit", "GGSHIT") {}
    ...
    function mint(uint256 _count) external payable {
        ...
        uint256 mintedByAddress = addressClaimed[_msgSender()];
    ...
    //checks if address owns more than 10 tokens
    function isHoarder(address _wallet) public view returns (bool) {
        uint256 ownedByAddress = balanceOf(_wallet);

        return (ownedByAddress > 10);
    }

    //baseURI is assigned based on the number of tokens held
    function _baseURI(uint256 _tokenId) internal view virtual returns (string memory) {

        (bool _hoarder) = isHoarder(ownerOf(_tokenId));
      
        if (!_hoarder) {
            return baseTokenURI_1;
        } else
        {
            return baseTokenURI_2;
        }
    ...
    function setBaseURI_1(string memory baseURI_1) public onlyOwner {
        baseTokenURI_1 = baseURI_1;
    }

    function setBaseURI_2(string memory baseURI_2) public onlyOwner {
        baseTokenURI_2 = baseURI_2;
    }
