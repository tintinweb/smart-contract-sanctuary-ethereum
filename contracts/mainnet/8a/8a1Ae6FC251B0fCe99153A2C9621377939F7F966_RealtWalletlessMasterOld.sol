...
abstract contract AbstractGnosisSafeProxyFactory {
    event ProxyCreation(GnosisSafeProxy proxy, address singleton, uint256 salt);
    ...
    function createProxyWithNonce(
        ...
        emit ProxyCreation(proxy, _singleton, saltNonce);
    }
