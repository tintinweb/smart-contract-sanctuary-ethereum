...
pragma solidity ^0.6.12;
    ...
    contract FedInu is Context, IERC20, Ownable {
        ...
        string private _name = 'Fed Inu';
        string private _symbol = 'COKEN';
        ...
        uint256 private _maxTxAmount = 100 * 10**7 * 10**9; // .1%
        uint256 private _numOfTokensToExchangeForTeam = 500 * 10**7 * 10**9; // 0.05%
