...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0f54b22523BB6CC2DCdfaE652A2FBD50A20D44F1; 
...
contract OnlySers is Context, IERC20, Ownable {
    ...
    string private _symbol = "SERS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f54b22523BB6CC2DCdfaE652A2FBD50A20D44F1); // 
    address payable public teamWalletAddress = payable(0x0f54b22523BB6CC2DCdfaE652A2FBD50A20D44F1); // 
