...
// File: NewCommunityFTX_flat.sol
    ...
    /*
        ...
        cFTT New Community FTX Token

        Alameda Research, a trading company founded by Sam Bankman-Friend (SBF)
        shows signs of insolvency.

        Key market analyzers points out they have been doing financial engineering the could 
        leave them insolvent in a short period of time.

        Market is hurt after the Celsius case and immedietely reacts.

        CZ, former investor of FTX, publically announces that will be selling each and every
        remaining FTX Token that belongs to Binance. 

        Alameda does its best to hold the price at the $22 range but fails.

        Whole crypto market gets imapcted by the fear of an eventual mass liquidation.

        We've seen this movie before, and it is happening all over again.

        t.me/NewCommunityFTXErc
    ...
    */
    ...
    contract NewCommunityFTX is ERC20, Ownable {
        ...
        constructor() ERC20("New Community FTX", "cFTT") {
