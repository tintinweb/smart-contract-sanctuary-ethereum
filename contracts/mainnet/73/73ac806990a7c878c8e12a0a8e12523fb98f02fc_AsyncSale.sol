...
contract AsyncSale is ReentrancyGuard, Ownable {
    ...
    function buyTokens(uint256 amountInUSD, address token_) public payable nonReentrant whenSaleOn {
        ...
        if(token_== address(0)){
            ...
            TransferHelper.safeTransferFrom(token_, msg.sender, safe, amountInUSD);
    ...
    function _buy(address buyer_, uint256 amount) private {
        ...
        require(purchase[msg.sender][roundId].tokensAmount <= saleRounds[roundId].maxAmount, "Purchase would exceed max limit");   
