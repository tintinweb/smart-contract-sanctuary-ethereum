...
Hachiko AI bot in honor of Japanese most loyal dog that protected its owner even after death.

Hachikai will use data from your furry friends’ behavior and pattern to create diagnosis about their health and wellness even before a visit to the vet.

Data can be in form of images, x-ray or text.

AI Bot has been fully built already and will be deployed along with website after testing round.

Tax: 5/5

Twitter: https://twitter.com/HachikaiERC
TG: https://t.me/HachikaiERC
...
contract Hachikai is Context, IERC20, Ownable
{
    using SafeMath for uint256;

    address payable public marketingAddress = payable(0x6C0EF32562a46baC50F88d525F871631EC100878);
    ...
    string private _name = "Hachiko AI";
    string private _symbol = "Hachikai";
