...
contract DrAgONcAvewtf is Ownable, ERC721A {
    ...
    string private _baseTokenURI = "ipfs://QmYHo7hJ723bZGuEv33kgD7hpAJYya1vPmMxpLQKTmMyCr/hidden.json";

    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("DrAgONcAvewtf", "WFTDRAG") {
