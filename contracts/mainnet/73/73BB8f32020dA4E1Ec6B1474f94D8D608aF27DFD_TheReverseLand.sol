...
contract TheReverseLand is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmNidMnZi4LRijvQ7XTBbSPyDXLgAdvRVs2BE6ZSJzqziJ";
  ...
  uint256 public  TOTAL_FREE_MINTS = 400;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("The Reverse Land", "The Reverse Land") {
