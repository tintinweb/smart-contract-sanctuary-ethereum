...
contract Virtualroyalfamily is Ownable, ERC721A {
  string public baseURI = "https://bafybeihstg3uuyr4vlylgzmepufegi7xhtmeqd3symlqhvsar3quoh46jy.ipfs.nftstorage.link/";
  ...
  uint256 public immutable maxSupply = 3100;

  uint256 public immutable maxWalletSupply = 13;

  uint256 public immutable maxWalletFreeSupply = 3;

  constructor(uint256 _mintCntToOwner) ERC721A('Virtual royal family', 'VRF') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 2900) {
