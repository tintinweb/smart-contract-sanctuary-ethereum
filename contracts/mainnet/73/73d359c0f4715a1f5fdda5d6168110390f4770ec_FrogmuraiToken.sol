...
contract FrogmuraiToken is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxBuyAmount = 100000 * 10**9; 
    ...
    string private constant _name = "Frogmurai";
    string private constant _symbol = "FGM";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x798798647b0d882cB26D3320B0C20CdB3809846E);
    address payable private _marketingAddress = payable(0xC3Bc1B03470eF4e360ec20fb7cFddC28313a0399);
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(amount <= _maxTxBuyAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
    ...
    function setTxBuyLimit(uint256 amount) public onlyOwner {
        _maxTxBuyAmount = amount;
    }   
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 30, "Tax cannot be more than 30.");
	    require(taxFeeOnSell < 30, "Tax cannot be more than 30.");
