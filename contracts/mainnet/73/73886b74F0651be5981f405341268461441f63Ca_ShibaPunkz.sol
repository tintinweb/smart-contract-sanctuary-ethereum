...
https://t.me/ShibaPunkz2

I'm $SPUNK whale, we are going to beat 1.0 brothers.
...
interface IUniswapV2Pair {
    ...
    contract ShibaPunkz is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "ShibaPunkz2.0";
    string private _symbol = "SPUNK2.0";
    ...
    address payable public marketingWallet = payable(0x6983343820E1C20f2B2D7A71c2a0694d15587C6e);
