...
contract Pidapipo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pidapipo", "Pidapipo") {
        ...
        maxTransactionAmount = 7 * 10 ** 3 * 10 ** decimals(); // 0.7% maxTransactionAmountTxn
        maxWallet = 21 * 10 ** 3 * 10 ** decimals(); // 2.1% maxWallet
