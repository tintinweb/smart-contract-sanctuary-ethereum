...
contract NightSky is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xFDfdb97E0ae51472b1d4900005b1743Ed588fB48); // Marketing Address
    address payable public multiSigAddress = payable(0xFDfdb97E0ae51472b1d4900005b1743Ed588fB48); // Marketing Address
    address payable public devAddress = payable(0xFDfdb97E0ae51472b1d4900005b1743Ed588fB48); // Dev Address
    address payable public liquidityAddress = payable(0xFDfdb97E0ae51472b1d4900005b1743Ed588fB48); // Liquidity Address
    ...
    string private constant _name = unicode"NightSky";
    string private constant _symbol = unicode"Mūnribā";
