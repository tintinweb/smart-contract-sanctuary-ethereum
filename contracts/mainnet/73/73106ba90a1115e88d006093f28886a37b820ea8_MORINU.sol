...
contract MORINU  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Morocco Inu";
    string private constant _symbol = "Morinu";
    ...
    address payable private _developmentAddress = payable(0x0D5D89F65013B98e2394825Ac41592B55FE9980F); 
    address payable private _marketingAddress = payable(0x83050dc0ADc51Cf166FE877d45fa6f524594Dd8B);
