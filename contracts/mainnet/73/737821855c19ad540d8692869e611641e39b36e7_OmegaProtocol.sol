...
contract OmegaProtocol is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0xb831AA2900bfa167ada47d449B6a6c82C3BbbC4C); // Dev Address
    address payable public liquidityAddress = payable(0xb831AA2900bfa167ada47d449B6a6c82C3BbbC4C); // Liquidity Address
    ...
    string private constant _name = unicode"Omega Protocol";
