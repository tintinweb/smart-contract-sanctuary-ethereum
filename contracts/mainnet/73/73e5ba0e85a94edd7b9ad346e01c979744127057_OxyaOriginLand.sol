...
contract OxyaOriginLand is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 7777;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "https://ipfs.io/ipfs/QmVmM2oT2FdHqUwRzznRsaAgsJnAdjyK1xDXW8kkcbMjXK/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("Oxya Origin Land", "OXYALAND", MAX_MINTS, MAX_SUPPLY) {  
    }
