...
contract Whayle_ERC721 is ERC721, Ownable {
    ...
    constructor() ERC721("Whayle", "WHAYLE") {
        ...
        for (uint256 i = 0; i < 50; i++) {
            _tokenSupply.increment();
            _safeMint(0xAB4f05F5f26e7b40F812F7236DDF85Cd9Ab472c1, supply + i);
        }
    }
    ...
    function withdraw() public payable onlyOwner {
        address a1 = 0xAB4f05F5f26e7b40F812F7236DDF85Cd9Ab472c1;
