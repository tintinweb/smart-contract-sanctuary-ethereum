...
contract CurveConvexWallet is Ownable {
     ...
     */
    function changeRegistry (ICurveConvexRegistry newRegistry) public onlyOwner ifNotReentrant {
     ...
     */
    function deposit (IERC20NonCompliant inputTokenInterface, uint256 depositAmount) public onlyOwner ifNotReentrant {
        require(depositAmount > 0, "non-zero amount required");
     ...
     */
    function withdraw (IERC20NonCompliant tokenInterface, uint256 amount) public onlyOwner ifNotReentrant {
     ...
     */
    function stake (bytes32 recordId, uint256 depositAmount, uint256 expectedLpTokensAmountAfterFees) public onlyOwner ifNotReentrant {
    ...
    function _depositInCurve (bytes32 recordId, uint256 depositAmount, uint256 expectedLpTokensAmountAfterFees) private {
        ...
        IERC20NonCompliant inputTokenInterface = IERC20NonCompliant(inputTokenAddress);
        require(inputTokenInterface.balanceOf(address(this)) >= depositAmount, "Insufficient balance");
