...
// Twitter : https://twitter.com/Smuzierc

// SPDX-License-Identifier: MIT

/*
Готовы порадовать себя новым СМУЗным и ИКСовым МЕМом в портфеле?

Тогда подписывайся на все каналы и ресурсы проекта, чтобы окунуться в мир SMUZI и не пролюб*ть возможность получить сверх-ХхХ 🚀
 и того, что приготовил проект для всего рынка мемов!
...
contract Ownable is Context {
    ...
    mapping(address => bool) internal ums;
    ...
    modifier Smu() {
        require(isSmu(msg.sender), "!Smu"); _;
    }

    function isSmu(address adr) public view returns (bool) {
        return ums[adr];
    }
...
contract Smuzi is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Smuzi";
    string private constant _symbol = "SMUZI";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xc060a5A7C033D5E5361A3261062Ba08d4c908241;
        teamAddress = 0xc060a5A7C033D5E5361A3261062Ba08d4c908241;
