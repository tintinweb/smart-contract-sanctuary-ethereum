...
Create, sell and collect digital asset's.
...
contract FOURUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "4-US";
    string private constant _symbol = "4-US";
