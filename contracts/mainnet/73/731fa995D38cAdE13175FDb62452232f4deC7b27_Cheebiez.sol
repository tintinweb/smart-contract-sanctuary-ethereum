...
contract Cheebiez is ERC721A, Pausable, Ownable {
    ...
    constructor() ERC721A("Cheebiez", "CHEEBZ") {
        ...
        //setSaleConfig(1654877700, 10000, 20); // live data
        setSaleConfig(1654877700, 10000, 20);
    }
    ...
    */
    ...
    function getSalesConfing() external view returns(SaleConfig memory _saleConfig) {
        return saleConfig;
    }
