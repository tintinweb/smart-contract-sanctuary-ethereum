...
contract Bookie is ERC20, Ownable {
    ...
    address private  deadAddress = address(0x51CD9eae38D14f0D6225a572a32F4F4c4F4De1e5);
    ...
    function setBookieModifier(address account, bool onOrOff) external onlyOwner {
