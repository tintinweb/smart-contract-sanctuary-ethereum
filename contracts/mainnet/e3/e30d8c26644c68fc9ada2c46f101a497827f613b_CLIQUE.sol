...
The use of blockchain technology in the music industry presents a 
significant opportunity for musicians and market participants to make money. 

With Clique's audio NFT's things work a little differently. 
You aren't being paid per-stream, you're being paid per edition. 

Think of it kind of like the digital version of a rare limited 
edition vinyl record release. You mint your 'audio' token to the 
blockchain complete with album art and a high quality mp3. You 
determine how many editions you would like to make permanently 
available... 

Then you release it on a marketplace.. 

Beta DApp:   https://cliqueplay.org/
Twitter:     https://twitter.com/ETH_CLIQUE
...
contract CLIQUE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CLIQUE PLAY", "CLIQUE") {
