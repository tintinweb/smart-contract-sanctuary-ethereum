...
contract HootyNest is ERC20, Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accRewardTokenPerShare;   // Accumulated tokens per share, times 1e30. See below.
    ...
    function pendingRewardToken(uint256 _pid, address _user) external view returns (uint256) {
        ...
        uint256 pending = user.amount.mul(accRewardTokenPerShare).div(1e30).sub(user.rewardDebt);
