...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"On-Chain Legend", unicode"Kevin's Crew", unicode"Lasers", unicode"Head", unicode"Face", unicode"Eyes", unicode"Nose", unicode"Mouth", unicode"Shirt", unicode"Skin", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"gm kevin", unicode"we love kevin. CC0. On-Chain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9b3a6662-a2bb-4d78-b2a1-f20c35add4b1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9b3a6662-a2bb-4d78-b2a1-f20c35add4b1", "", 600, "0x5D76f8887B6e8bd6b73ed435c935Fa8FC2872EDB");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"gm kevin", unicode"gmk") {
        tiers[0] = [1,1,418];
        tiers[1] = [1,1,1,417];
        tiers[2] = [0,4,6,7,403];
        tiers[3] = [0,4,8,9,17,19,19,20,20,20,21,21,23,23,24,25,26,35,38,48];
        tiers[4] = [0,0,7,8,10,10,10,11,12,12,13,14,25,25,26,26,29,30,33,119];
        tiers[5] = [0,0,0,46,87,90,94,103];
        tiers[6] = [0,0,45,52,54,64,65,66,74];
        tiers[7] = [0,0,8,8,9,9,10,18,22,24,25,26,27,29,30,31,34,51,59];
        tiers[8] = [0,38,41,46,52,57,58,59,69];
        tiers[9] = [0,27,172,221];
        tiers[10] = [0,6,16,20,38,39,42,44,52,53,54,56];
