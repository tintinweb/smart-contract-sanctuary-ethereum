...
contract LarvaApes is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string uriPrefix = "";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri =
        "ipfs://Qmba23ZWygZikNQfsqvB96KxUSFYsyJLwZk4S9P3koGSrY/LA_hidden.json";
    uint256 public cost = 0.03301 ether;
    ...
    constructor(string memory _uriPrefix) ERC721A("Larva Apes", "LAPES") {
    ...
    function mintLarva(uint256 _mintAmount)
        public
        payable
    ...
    function withdraw() public onlyOwner {
        (bool os, ) = payable(0xe5648a7ee73f84DDD5146f379B5a9c2690798b66).call{
