...
/*
https://medium.com/@proofofsanta

Social:
https://twitter.com/ProofofSantaERC
https://t.me/proofofsanta
...
contract Token is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(1,4); //dev tax, liquidity tax
        setSellTax(1,17); //dev tax, liquidity tax
        setTaxWallets(0xd60C91828447e0FbdC06412afD76dBe0126Ef050); // 
        exclude(msg.sender);
