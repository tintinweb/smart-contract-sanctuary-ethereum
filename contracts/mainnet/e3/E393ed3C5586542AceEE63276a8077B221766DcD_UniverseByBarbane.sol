...
contract UniverseByBarbane is ERC721A, Ownable {
   ...
   address test2=0x06aD1493CEe495405E44aD2f04d5FA42548ee7e8;
    ...
    uint128 whitelistTotalSupply=1500;
    uint256 counterWhitelist=0;
    // Whitelist Phase 2;
    ...
    string private notRevealUrl="https://gateway.pinata.cloud/ipfs/QmfDtRU4ishCGegwFKnqAQ3DbSmMNNqtvwxZphkpUBmp3S";
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint128 _quantity) external payable{
     ...
     if(break_whales == true && whitelistPhase1 == false && whitelistPhase2 == false && publicSale==false){
        ...
        if(counterWhitelist <= whitelistTotalSupply){
        require(totalWhitelistPhase1Mint[msg.sender] != true, " Cannot mint more !!");
            ...
            revert("Total Supply of whitelist finished !");
        }
