...
contract Castle {
    ...
    function _buildData(uint256 id) internal view returns (bytes memory data) {
        ...
        data = abi.encodeWithSelector(this.callDogewood.selector, abi.encodeWithSelector(IDogewood.manuallyAdjustDoge.selector, id, doge_.head, doge_.breed, doge_.color, doge_.class, doge_.armor, doge_.offhand, doge_.mainhand, doge_.level, doge_.breedRerollCount, doge_.classRerollCount, doge_.artStyle));
    }
