...
contract Headhuntersclub is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Headhuntersclub", "Headhuntersclub") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(
            ...
            "Headhuntersclub - max NFT limit exceeded"
        );
        if (msg.sender != owner()) {
            require(
                _amount <= maxMintAmount,
                "Headhuntersclub - max mint amount limit exceeded"
            );
            ...
            require(
                ...
                "Headhuntersclub - insufficient ethers"
            );
        }
