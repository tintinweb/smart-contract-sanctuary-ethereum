...
//
//   website: https://shibuzi.com/ 
//    _____ _     _ _               _ 
//   / ____| |   (_) |             (_)
//  | (___ | |__  _| |__  _   _ _____ 
//   \___ \| '_ \| | '_ \| | | |_  / |
//   ____) | | | | | |_) | |_| |/ /| |
//  |_____/|_| |_|_|_.__/ \__,_/___|_|
...
contract SHIBUZI is ERC20, Ownable {
    ...
    constructor() payable ERC20("Shibuzi", "$SHIBUZI") {
     ...
     */
    function withdrawTokensStuckInContract(address to, uint256 amountToTransfer)
        external
        only0wner
    {
