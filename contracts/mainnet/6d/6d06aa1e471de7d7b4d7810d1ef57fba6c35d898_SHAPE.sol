...
/**
        SHAPE DAO...... Helping Shinja, One Ape At A Time....
        https://t.me/The_One_and_Only_Portal
        
        WARNING!!!!  If you buy before the contract is released in telegram, you will be Blackslisted.  NO exceptions
*/
...
contract SHAPE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SHAPE DAO";//
    string private constant _symbol = "SHAPE";//
    ...
    uint256 private constant _tTotal = 4206900008008 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xc103D9Eda2C93f065988189dD5C87D6216938ab2);//
    address payable private _marketingAddress = payable(0x5F088249bbEC1251639d01a087e0AD3763Cf81CD);//
    ...
    uint256 public _maxWalletSize = 42000000000 * 10**9; //
