...
/*
    ...
    Join us today and experience the power of our $PGPT4 Telegram bot!

    LINKS:
    Website: https://pgpt4.com
    Telegram: https://t.me/pgpt4
    Twitter: https://twitter.com/pgpt4_token
    Medium: https://medium.com/@pgpt4/introducing-pgpt4-the-ultimate-bot-detection-portal-telegram-groups-cf9b827e762
    ...
    */
    ...
    contract PGPT4 is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        constructor() ERC20("Portal GPT-4", "PGPT4") {
            ...
            marketingWallet = address(0x22e65685f7BF4a6Fcfa45cfA219532A6C4cff90E); // Marketing Wallet
        ...
        function uLimits(uint256 _maxTransactionAmount, uint256 _maxWallet) external onlyOwner {
        ...
        function uFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _buyBurnFee, uint256 _sellMarketingFee, 
