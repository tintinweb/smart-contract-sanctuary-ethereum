...
All we need is a BTC erection to the moon.
...
contract BTCPENIS is Context, IERC20, Ownable {
    ...
    string private constant _name = "BTCPENIS";
    string private constant _symbol = "BTCPENIS";
    uint256 public _maxTxAmount = 1_000_000 * 10**_decimals;
    uint256 public _maxWalletSize = 1_000_000 * 10**_decimals;
    uint256 public _taxSwap=100_000 * 10**_decimals;
