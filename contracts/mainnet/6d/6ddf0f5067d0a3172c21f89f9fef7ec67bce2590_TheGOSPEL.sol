...
/**
  Ryoshi doesn't exist and never did.
  The group of highly influencing personas
  paid the right people the right amount
  and SHIB was born. 
  Ryoshi was a fairytale made by the group to inspire 
  others and hide themselves from being connected to the project.
*/
...
contract TheGOSPEL is Context, IERC20, Ownable {
