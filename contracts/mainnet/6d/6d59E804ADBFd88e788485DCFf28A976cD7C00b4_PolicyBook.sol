...
contract PolicyBook is IPolicyBook, ERC20PermitUpgradeable, AbstractDependant {
    ...
    function _submitClaimAndInitializeVoting(
        ...
        claimVoting.initializeVoting(_msgSender(), evidenceURI, cover, bmiPriceInUSDT, appeal);
    }
    ...
    function submitClaimAndInitializeVoting(string calldata evidenceURI, uint256 bmiPriceInUSDT)
        ...
        override
    {
        _submitClaimAndInitializeVoting(evidenceURI, bmiPriceInUSDT, false);
    }
    ...
    function submitAppealAndInitializeVoting(string calldata evidenceURI, uint256 bmiPriceInUSDT)
        ...
        override
    {
        _submitClaimAndInitializeVoting(evidenceURI, bmiPriceInUSDT, true);
    }
