...
contract AzukiAmbush is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Azuki x AMBUSH Hoodie", "AAHOODIE")
    {
        baseURI = _baseURI;
