...
contract RealMfers is ERC721, Ownable, Pausable {
	using Counters for Counters.Counter;
	using Strings for uint256;

	address 								_address_for_withdrawal = 0x21BfAfC812901cdbBAf89a4e1283DF432AC0b634;
	...
	uint256 private 						_mint_reserved = 25;
	uint256 private 						_mint_limit = 5;
	uint256 private 						_mint_limit_whitelist = 5;
	string private 							_base_url = 'WILL BE UPDATED';
	bool private							_is_whitelist_only = false;
	bool private							_mint_limit_by_addy = true;

	//construct
	constructor() ERC721('RealMfers','RealMfers') {
