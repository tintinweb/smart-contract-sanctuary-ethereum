...
contract Koyosha is Ownable, ERC20, Pausable {

    mapping(address => bool) private pair;
    bool public tradingOpen;
    uint256 public _maxWalletSize = 250000 * 10 ** decimals();
    uint256 private _totalSupply = 10000000 * 10 ** decimals();

    constructor() ERC20(unicode"Precursor of Genyōsha", unicode"Koyōsha") {
