...
contract DoraDreamon is Ownable, ERC721A {
    uint256 public maxSupply                    = 1111;
    uint256 public maxFreeSupply                = 333;
    
    uint256 public maxPerTxDuringMint           = 5;
    uint256 public maxPerAddressDuringMint      = 31;
    uint256 public maxPerAddressDuringFreeMint  = 1;
    
    uint256 public price                        = 0.005 ether;
    bool    public saleIsActive                 = false;

    address constant internal TEAM_ADDRESS = 0xdd67df4e68c9e0932fDE9AAab269f9CaB1CB407c;
    ...
    constructor() ERC721A("DoraDreamon", "DORA") {
