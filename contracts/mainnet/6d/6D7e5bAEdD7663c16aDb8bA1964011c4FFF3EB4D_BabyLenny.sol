...
Tax will be 4% buy after 1st buy 

Telegram - @BabyLennyERC
...
contract BabyLenny is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Lenny Face";
    string private constant _symbol = unicode"(͡◕ ͜ʖ ͡◕)";
