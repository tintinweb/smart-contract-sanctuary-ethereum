...
contract ShibariumPawpetuals is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xeEB7f9277876D5F28319556A818280843C4C3Ca3);
    ...
    constructor() ERC20("Shibarium Pawpetuals", "PAWP") {
        ...
        marketingWallet = address(0x4cdd0A6BC5A4f57dbBF78b52Ce700D02C17bF2c9); // set as marketing wallet
        devWallet = address(0xe29D45D728047c3317ea58A7E2D85B9E9a0564B7); // set as dev wallet
