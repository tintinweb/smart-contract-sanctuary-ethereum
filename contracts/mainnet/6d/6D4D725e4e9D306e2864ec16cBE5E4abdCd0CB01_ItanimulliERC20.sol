...
contract ItanimulliERC20 is Context, IERC20, Ownable {
    ...
    function removeLimits() external onlyOwner{
        _maxTxAmount = 4000 * 10**_decimals;
        _maxWalletSize = 4000 * 10**_decimals;
        emit MaxTxAmountUpdated(4000 * 10**_decimals);
    }
