...
// File: contracts/RegularPunks.sol
...
contract RegularPunks is ERC721A, Ownable{
    ...
    constructor() ERC721A("Regular Punks", "REGULARPUNKS"){
    }
    function mint(uint256 _quantity) external{
        require(publicSale == true, "Not Yet Active.");
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "Beyond Max Supply");
        require(this.balanceOf(msg.sender) + _quantity <= 1, "Per wallet limit reached! Per wallet limit is 1 tokens.");
