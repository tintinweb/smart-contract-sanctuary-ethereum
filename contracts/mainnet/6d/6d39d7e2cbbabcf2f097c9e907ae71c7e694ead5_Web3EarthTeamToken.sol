...
/// @title Web3Earth Team Token
/// @author André Costa @ Web3Texas
...
contract Web3EarthTeamToken is ERC1155, Ownable {
    using Strings for uint256;
    
    string private baseURI;

    //identifying different token types
    uint256 public constant ADVISORYBOARDMEMBER = 1;
    uint256 public constant FOUNDINGBOARDMEMBER = 2;
    uint256 public constant FOUNDINGTEAMMEMBER = 3;

    event SetBaseURI(string indexed _baseURI);

    constructor() ERC1155("ipfs://QmSEntENCn3ZriqPby5PScKb2JLKZL2wEFG5q3tUpmuaSC/") {
        baseURI = "ipfs://QmSEntENCn3ZriqPby5PScKb2JLKZL2wEFG5q3tUpmuaSC/";
