...
// 99888AABBD D3EDZE998E89 OPOABNVEYQ997
// :eyes: :woof: :chirp:
...
contract Squawk is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Squawk Box"; 
    string private constant _symbol = "SQBox"; 
    ...
    address payable private _developmentWalletAddress = payable(0x8C0f835920316086370a0A93C90056Ec9A9A63E5);
    address payable private _marketingWalletAddress = payable(0x8C0f835920316086370a0A93C90056Ec9A9A63E5);
