...
/**
In a land resting near a large body of water, a King of the people is crowned; This place holds a few many secrets, one of which, the next clue can be found.
*/
...
contract PierVidalNakay is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pier Vidal Nakay", "PierVidalNakay") {
