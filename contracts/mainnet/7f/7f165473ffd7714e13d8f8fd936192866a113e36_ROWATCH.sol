...
contract ROWATCH is ERC721A, Ownable, ReentrancyGuard { 

    uint256 public _maxSupply = 3000;
    uint256 public _mintPrice = 0.003 ether;
    uint256 public _maxMintPerTx = 300;
    ...
    constructor(string memory initBaseURI) ERC721A("Royal Oak Watch It's Really Worth 300E", "ROWATCH") {
        baseURI = initBaseURI;
    }
