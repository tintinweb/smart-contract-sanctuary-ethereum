...
// File: contracts/ExpoCompoundVault.sol
...
contract ExpoCompoundVault is Ownable {
    ...
    // Withdraw without updating rewards. EMERGENCY ONLY.
    ...
    // Safe EXPO transfer function, just in case if rounding error causes pool to not have enough EXPO.
