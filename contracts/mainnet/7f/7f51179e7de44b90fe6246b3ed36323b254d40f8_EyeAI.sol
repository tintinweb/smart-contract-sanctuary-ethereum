...
contract EyeAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "EyeAI";
    string private constant _symbol = "Eye-AI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7ac8802aD34E2462d40a63aC5E6d0Cd9fBA4A99f);
    address payable private _marketingAddress = payable(0x4e1491Ff76CcE4d0606EBbb68a0f9b4D5DD981c1);
    ...
    constructor () {
        ...
        emit Transfer(address(0x4e1491Ff76CcE4d0606EBbb68a0f9b4D5DD981c1), _msgSender(), _tTotal);
    }
