...
contract doooooobby is ERC721A, Ownable {
    
    string  public uriPrefix = "ipfs://QmU6YPPzw75wAtbUJLs8A9ydv8EtrVtynnS6wLWgYWZXqV/";

    uint256 public immutable cost = 0.003 ether;
    uint32 public immutable maxSupply = 2300;
