...
contract TokenVault is Upgradeable {
    ...
    function transfer(IERC20 token, address to, uint256 amount) public onlyRole(MANAGER_ROLE) whenNotPaused {
        token.safeTransfer(to, amount);
    }

    function approve(IERC20 token, address spender, uint256 amount) public onlyRole(MANAGER_ROLE) whenNotPaused {
