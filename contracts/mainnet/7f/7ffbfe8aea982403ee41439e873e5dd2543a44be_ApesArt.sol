...
contract ApesArt is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4444;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://QmXvSifuhjU1m8YF6yjh7Jtp3oCMcX59pYHLhRmrGRHABK/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Apes Art", "AA", MAX_MINTS, MAX_SUPPLY) {  
