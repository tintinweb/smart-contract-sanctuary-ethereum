...
Katawaguruma appears as a tormented naked woman riding a single, flaming ox-cart wheel, eternally suffering and burning with pain.
She can bring calamity upon an entire village, to feed us properly.
...
contract Katawaguruma is Context, IERC20, Ownable {
    ...
    string private constant _name = "Katawaguruma";
    string private constant _symbol = "KATAWAGURUMA";
    ...
    uint256 private _maxTxAmount = 10000000 * 10**9;
