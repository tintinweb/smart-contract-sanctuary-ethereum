...
contract motion is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmU1v2KEQ7nKE7a1ti5PDo5f5ZKBgCzctx5Gg1sX4JGUB9";
    ...
    constructor(
    ) ERC721A("motion by anon", "motion", 100, maxSupply) {
    }
