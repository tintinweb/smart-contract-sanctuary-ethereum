...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    } //telegram https://t.me/DejitaruMusashi 
}     // 
...
contract DejitaruMusashi  is Context, IERC20, Ownable {
    ...
    string private constant _name = "DejitaruMusashi";
    string private constant _symbol = "$DMH";
