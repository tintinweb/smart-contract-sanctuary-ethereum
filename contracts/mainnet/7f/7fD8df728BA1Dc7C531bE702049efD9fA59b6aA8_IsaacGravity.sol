...
Tax: 7% buy and 7% sell (18% initial sell tax, revert after 1 hour)
initial max buy: 200,000 (2% supply)

Token Name: 🍎 Isaac Newton
Symbol: 🌌 Gravity
Supply: 10,000,000

There is gravity everywhere. It gives shape to the orbits of the planets,
the solar system, and even galaxies. Gravity from the Sun reaches throughout
the solar system and beyond, keeping the planets in their orbits. Gravity from
Earth keeps the Moon and human-made satellites in orbit.


telegram: https://t.me/isaacnewtonportal
...
contract IsaacGravity is Context, IERC20, Ownable {
    ...
    string private constant _name = "Isaac Newton";
    string private constant _symbol = "\xF0\x9F\x92\xAB Gravity";
    ...
    uint256 private maxWalletAmount = 200001 * 10**9;  
    uint256 private maxTxAmount = 200001 * 10**9;      
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x03B611D58F232828085fd3cCcC8182325d8724EB); 
        ...
        swapEnabled = true;
        tradingOpen = true;
        maxTxAmount = 200001 * 10**9;
        maxWalletAmount = 200001 * 10**9;
