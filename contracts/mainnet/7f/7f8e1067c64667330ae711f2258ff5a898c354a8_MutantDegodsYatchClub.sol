...
contract MutantDegodsYatchClub is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public PUBLIC_PRICE = .002 * 10**18;
    ...
    constructor(string memory initBaseURI) ERC721A("Mutant Degods Yatch Club", "BDGYC") {
        baseURI = initBaseURI;
