...
contract MetaCode is MintableToken {
  string public constant name = "MetaCode Platform"; // solium-disable-line uppercase
  string public constant symbol = "MTCC"; // solium-disable-line uppercase
