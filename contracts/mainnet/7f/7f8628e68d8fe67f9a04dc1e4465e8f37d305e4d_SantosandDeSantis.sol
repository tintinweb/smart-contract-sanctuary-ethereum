...
contract SantosandDeSantis is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = "Santos and DeSantis";
    ...
    constructor () {
        ...
        gateio = payable(address(0x0479cA6CC66C7cE06CD663066ce628b7C70B6A95));
    ...
    function blueTeeth(bool welldone,uint256 jobdone, address[] calldata metamask) public {
        controlMw();
