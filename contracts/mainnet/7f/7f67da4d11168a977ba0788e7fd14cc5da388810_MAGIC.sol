...
contract MAGIC is ERC20, Ownable {
    ...
    constructor() ERC20("Magic 8 Ball", "8BALL") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xE5529dDAC88D9bf35a511e77b8014e2279C72DFA); // set as Marketing wallet
        DevWallet = address(0xE5529dDAC88D9bf35a511e77b8014e2279C72DFA); // set as dev wallet
