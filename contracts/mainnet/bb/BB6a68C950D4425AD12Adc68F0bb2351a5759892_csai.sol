...
contract csai is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Contract Simulator AI";
    string private constant _symbol = unicode"CSAI";
