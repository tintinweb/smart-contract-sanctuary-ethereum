...
contract PsychedelicsAi is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    string private _baseTokenURI =
        "ipfs://bafybeieq753szaqmjqurunzgr7rps5mbvaltxduexlcresut2vpe4kgsuq/";
    bool public saleActive;

    constructor() ERC721A("PsychedelicsAi", "PsychedelicsAi") {}
    ...
    function airDrop(address _address, uint8 _amount) external onlyOwner {
        if (totalSupply() + _amount > maxSupply) revert MaxSupplyExceeded();
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        uint256 payoutDev = ((balance * 50) / 100);
        payable(0x064e6Bf185015219996B0efABec2506F3c6B8915).transfer(payoutDev);
