...
contract MintAPIFactory {
     ...
     * @param admin The owner of the NFT collection.
     * @param transferable The transferability status of the NFT.
     ...
     * @param admin The owner of the SFT collection.
     * @param name The name of the SFT.
     * @param symbol The symbol of the SFT.
     * @param salt The salt for creating the BeaconProxy using Create2.
