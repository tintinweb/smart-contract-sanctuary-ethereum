...
contract TheKekBunch is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 450000 * 10**9; //
  
    string private constant _name = "TheKekBunch"; // 
