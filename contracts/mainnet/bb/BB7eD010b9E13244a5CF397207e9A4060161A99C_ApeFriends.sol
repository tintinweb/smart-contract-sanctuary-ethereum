...
contract ApeFriends is ERC721, Ownable {
  ...
  {
      if(_supply < 300 && cost == 20000000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 300 && cost != 20000000000000000){
           return cost;
       }
      else if (_supply <= maxSupply && cost == 20000000000000000){
           return 0.02 ether;
       }
       else if (_supply <= maxSupply && cost != 20000000000000000){
           return cost;
  ...
  {
       if(_supply < 300 && maxTokensPerWallet == 3) {
           return 3;
       } 
       else if (_supply < 300 &&  maxTokensPerWallet != 3){
