...
/**
 *Submitted for verification at Eth on 2022-09-24
*/ 
 
//  A-flow’s protocol provides the user with an easy to use interface that is best-in-class,
//  allowing to onboard companies, DAOs, investors, and service providers into a same ecosystem.
//  https://t.me/Aflowchat
//  https://a-flow.gitbook.io/whitepaper/                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
...
contract Aflow  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "A-Flow";
    string private constant _symbol = "Flow";
    ...
    address payable private _developmentAddress = payable(0x884faF15D20Bd1FbF8369CF3F8AB5E59766022EB); 
    address payable private _marketingAddress = payable(0x7624e65773013d0357a9cB4f12240854AD3cE0C2);
