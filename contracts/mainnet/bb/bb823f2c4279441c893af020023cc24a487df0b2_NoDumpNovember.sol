...
/*
    ...
    🐦 Twitter:    https://twitter.com/NoDumpNovember    
    📰  Telegram:   https://t.me/+5Hecvfc_BaJlYWNk
...
// ##### GENERAL #####
contract NoDumpNovember is ERC20, Ownable {
    using SafeMath for uint256;

    // Namings
    string private projectName = "No DUMP November";
    string private tokenName = string.concat("$", "NDN");
   ...
   // Exlcude from fees and max transaction amount
    ...
    constructor() ERC20(projectName, tokenName) {
        ...
        // Wallets
        devWallet = address(0x369bFd842FC694149c7C7F3fB44A0E4d013b5898);
        ...
        maxTransactionAmount = (totalSupply * 10) / 100; // 10% of totalSupply
        
        // Max Wallet
        maxWalletAmount = (totalSupply * 10) / 100; // 10% of totalSupply
    ...
    function updateLimitsToFirstStable() external onlyOwner {
        // Max Transaction Amount
        maxTransactionAmount = (totalSupply() * 15) / 100; // 15% of totalSupply  
        
        // Max Wallet
        maxWalletAmount = (totalSupply() * 15) / 100; // 15% of totalSupply
    ...
    function updateLimitsToSecondStable() external onlyOwner {
        // Max Transaction Amount
        maxTransactionAmount = (totalSupply() * 25) / 100; // 25% of totalSupply  
        
        // Max Wallet
        maxWalletAmount = (totalSupply() * 25) / 100; // 25% of totalSupply
