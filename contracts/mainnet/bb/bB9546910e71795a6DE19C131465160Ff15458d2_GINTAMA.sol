...
contract GINTAMA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GINTAMA", "GINTAMA") {
        ...
        thresholdSwapAmount = totalSupply * 1 / 10000000; // 0.01% swap wallet
        ...
        marketingWallet = address(0x6e8561d0ae423005C5Ad8bF569Fe47e24aCe9b2e);
        devWallet = address(0x6e8561d0ae423005C5Ad8bF569Fe47e24aCe9b2e);
