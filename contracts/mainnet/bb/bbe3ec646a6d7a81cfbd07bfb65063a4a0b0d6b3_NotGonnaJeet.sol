...
CLUE :
https://t.me/pswolesplayground/229339
...
contract NotGonnaJeet is ERC20, Ownable {
    ...
    constructor() ERC20("Not Gonna Jeet", "NGJ") { 
    ...
    function LimitCall(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
