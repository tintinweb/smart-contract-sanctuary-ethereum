...
contract EpicBonksSyndicate is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 44;
    ...
    constructor()
        ERC721("epicbonkssyndicate.xyz", "EBS")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifven26fvqxbnf5qazm25l7yuguk2rfvdvjoxx2bam2zxeeyw4d7e/", Strings.toString(tokenId), ".json")
            );
    }
