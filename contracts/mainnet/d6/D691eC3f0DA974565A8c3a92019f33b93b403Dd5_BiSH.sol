...
contract BiSH is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
string public CONTRACT_URI = "";
mapping(address => uint) public userHasMinted;
bool public REVEALED;
string public UNREVEALED_URI = "";
string public BASE_URI = "ipfs://aaa/hidden.json";
bool public isPublicMintEnabled = true;
uint public COLLECTION_SIZE = 1111;
...
constructor() ERC721A("BiSH Bye Bye Show", "BiSH") {}
        ...
        nonReentrant
    {
        ...
        require(isPublicMintEnabled, "BiSH not ready yet!");
        require(totalSupply() + quantity <= COLLECTION_SIZE, "No more BiSH!");

        require(balanceOf(msg.sender) + quantity <= SUPPLY_PER_WALLET, "Tried to total mint BiSH per wallet over limit");

        require(quantity <= MAX_BATCH_SIZE, "Tried to mint BiSH over limit, retry with reduced quantity");
