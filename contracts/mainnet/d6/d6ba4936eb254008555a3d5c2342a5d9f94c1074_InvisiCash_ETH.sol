...
/*
  ___ _   ___     _____ ____ ___ ____    _    ____  _   _ 
 |_ _| \ | \ \   / /_ _/ ___|_ _/ ___|  / \  / ___|| | | |
  | ||  \| |\ \ / / | |\___ \| | |     / _ \ \___ \| |_| |
  | || |\  | \ V /  | | ___) | | |___ / ___ \ ___) |  _  |
 |___|_| \_|  \_/  |___|____/___\____/_/   \_\____/|_| |_|
...
contract MerkleTreeWithHistory {
  ...
  function hashLeftRight(bytes32 _left, bytes32 _right) public pure returns (bytes32) {
    ...
    uint256 C = 0;
      (R, C) = Hasher(0xEfB1f7e3646Dc3cce187e7D8930437c3242Cc6C7).MiMCSponge(R, C);
...
contract InvisiCash is MerkleTreeWithHistory, ReentrancyGuard {
  ...
  uint256 public withdraw_fee = 0;

  uint256 public base_fee = 1e17;

  uint256 public split1_fee = 50;
  uint256 public split2_fee = 50;

  address payable fee_reciever_1 = 0x27042d3Da2A4C27B318Ef7B39455e9117739C5FB; 
  address payable fee_reciever_2 = 0x27042d3Da2A4C27B318Ef7B39455e9117739C5FB;
...
contract InvisiCash_ETH is InvisiCash {
  constructor(
    IVerifier _verifier,
    uint256 _denomination,
    uint32 _merkleTreeHeight,
    address payable _operator
  ) InvisiCash(_verifier, _denomination, _merkleTreeHeight, _operator) public {
