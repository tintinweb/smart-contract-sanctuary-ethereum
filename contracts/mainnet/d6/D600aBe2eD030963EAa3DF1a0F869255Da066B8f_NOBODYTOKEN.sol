...
Telegram :https://t.me/NobodyToken
          twitter : https://twitter.com/Nobody_Token
                        Wrbsite : https://NobodyToken.club
...
contract NOBODYTOKEN is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Nobody Token", "NOBO") {
        ...
        uint256 _buyDevFee = 1; //1% buy tax 
        uint256 _buyBuyBackFee = 0; 

        uint256 _sellDevFee = 4; //this is launch tax final sell tax 1%
        ...
        swapTokensAtAmount = (totalSupply * 20) / 10000; // 0.02% swap wallet
        ...
        devwallet = address(0x5A21ab26E29FC0796aC10979D635B0b52E5Fb202); // set as dev wallet Or owner
