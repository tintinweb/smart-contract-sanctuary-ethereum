...
https://medium.com/@dawntoken/dawn-d2b3eb8b59cf
**/
...
contract APerfectSunrise  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5000000 * 10**8;
    ...
    string private constant _name = "A Perfect Sunrise";
    ...
    uint256 private _maxTxAmount = 100000 * 10**8;
    uint256 private _maxWalletSize = 100000 * 10**8;
