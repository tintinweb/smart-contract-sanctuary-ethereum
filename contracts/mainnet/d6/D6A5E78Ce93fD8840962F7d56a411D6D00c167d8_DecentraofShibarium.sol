...
Make Blockchain Connect With Shibarium And Create A New Era In Crypto

Decentra of Shibarium is a blockchain project that connects public storage & blockchain ecoystem that can connect all its performance with Shibarium

Website : https://decenofrium.net
Twitter : https://twitter.com/ShibariumD
Telegram : https://t.me/DecentraofShibarium

Decentra of Shibarium

Dashboard : https://labs.decenofrium.net
Exchange : https://app.decenofrium.net

Do not forget to check our Whitepaper to have a brief knowledge of what is coming and what we are building
https://docs.decenofrium.net
...
contract DecentraofShibarium is Context, IERC20, Ownable {
    ...
    string private constant _name = "Decentra of Shibarium";
    ...
    uint256 public swapTokenAtAmount = 7000000 * 10**_decimals;
