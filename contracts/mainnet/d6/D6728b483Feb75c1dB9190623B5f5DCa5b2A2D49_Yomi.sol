...
contract Yomi is Context, IERC20, Ownable {
    ...
    uint256 public immutable _totalSupply =  2000000000 * 10**_decimals;
    uint256 public immutable _buyTax =1;
    uint256 public immutable _sellTax = 2;
    string private _name = unicode"Yomi";
    string private _symbol = unicode"死者の国";
