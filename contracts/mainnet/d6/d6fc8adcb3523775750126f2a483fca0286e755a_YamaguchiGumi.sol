...
Bond together as one and fight the strong!

With the power of the people that hold their bags, spread the words, buy the dip.

We can make Yamaguchi to be the greatest crypto community.

https://t.me/Yamaguchigumiportal	
https://yamaguchi-gumi.org	
https://twitter.com/YamaguchiGumiE
...
contract YamaguchiGumi is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Yamaguchi-gumi";
    ...
    uint256 public _taxSwap= _tTotal.mul(1).div(1000);
