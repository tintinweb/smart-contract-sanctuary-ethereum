...
contract BRAINPOWER is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmeizPvgosgNb49fYR1z56mAbvuMeAZhoyrmc6XZDR4VZ6";
    ...
    constructor(
    ) ERC721A("BRAINPOWER", "BRAIN", 100, maxSupply) {
    }
