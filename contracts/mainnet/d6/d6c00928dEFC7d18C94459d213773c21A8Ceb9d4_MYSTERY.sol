...
// FOLLOW US ON TWITTER: @fungibleMystery
// All MYSTERY PERKS WILL BE REVEALED ONCE MINTED OUT


// File: contracts/MysteryNFT/Strings.sol
...
// File: contracts/MysteryNFT/Context.sol
...
// File: contracts/MysteryNFT/Ownable.sol
...
// File: contracts/MysteryNFT/Address.sol
...
// File: contracts/MysteryNFT/IERC721Receiver.sol
...
// File: contracts/MysteryNFT/IERC165.sol
...
// File: contracts/MysteryNFT/ERC165.sol
...
// File: contracts/MysteryNFT/IERC721.sol
...
// File: contracts/MysteryNFT/IERC721Enumerable.sol
...
// File: contracts/MysteryNFT/IERC721Metadata.sol
...
// File: contracts/MysteryNFT/ERC721A.sol
...
// File: contracts/MysteryNFT/mystery.sol
pragma solidity ^0.8.0;

contract MYSTERY is ERC721A {

    constructor(string memory baseURI) ERC721A("MYSTERY", "MSTRY") {
        setBaseURI(baseURI);
    }
    ...
    function mint(address _to, uint256 _count) external payable {
        ...
        if (msg.sender != owner()) {
            require(saleOpen, "Sale Is Not Opened Yet");
            require(
                _count <= 10,
