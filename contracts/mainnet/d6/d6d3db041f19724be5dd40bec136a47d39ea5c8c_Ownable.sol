...
// File: imperialdoge_flat.sol


// File: imperialdoge.sol
...
This week in crypto it is all about the IDOGE. This meme coin is focussed on the unique tokenomics we gave to the dollar, completely weakening it. All prayers go out to the Dollar

IDOGE tokenomics 💲

💲 1.000.000 total supply
💲 20.000 max 
💲 6% tax, lowered to 3% after 40 trades
💲 tax will be used for marketing, buybacks and burns

Website: Released at 150k marketcap
...
contract Powellnomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "Imperial Doge";
    string private constant _symbol = "IDOGE";
...
contract imperialdoge is Context {
    address private _owner;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
