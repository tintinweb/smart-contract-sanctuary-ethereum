...
contract HALFHEX is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public HEX = 0x2b591e99afE9f32eAA6214f7B7629768c40Eeb39;
    ...
    constructor() ERC20("Half Hex", "HEX0.5") {
        ...
        devWallet = address(0x23a56caE642056be9E7041426aED7A70747F519C); // set as dev wallet
    ...
    function swapBack() private {
        ...
        swapTokensForHEX(contractBalance);
    }
