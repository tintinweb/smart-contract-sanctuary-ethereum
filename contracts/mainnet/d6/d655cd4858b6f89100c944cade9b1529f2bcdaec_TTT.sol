...
contract TTT is Context, IERC20, Ownable {
    ...
    address payable private taxWallet1 = payable(0x6C91d4EAa54bA3c5fd5A489A2FAA8b47bc88107C);
    address payable private taxWallet2 = payable(0x6C91d4EAa54bA3c5fd5A489A2FAA8b47bc88107C);
    ...
    uint256 public _buyMarketingFees = 95;
