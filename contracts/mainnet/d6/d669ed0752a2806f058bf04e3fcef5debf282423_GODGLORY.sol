...
/**
  ...
  There is no glory in battle that compares to the blood that must be shed
...
contract GODGLORY is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"God Glory", "GOD") {
        ...
        devWallet = address(0xBD27CEF82FA58EDB0854839367C0C7B5a851CbAf); 
