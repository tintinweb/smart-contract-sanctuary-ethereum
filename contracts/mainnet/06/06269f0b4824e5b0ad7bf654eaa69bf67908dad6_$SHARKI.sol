...
contract $SHARKI is Context, IERC20, Ownable {
    ...
    string public constant name = unicode"$SharkInutoken";
    string public constant symbol = unicode"$SHARKI";
