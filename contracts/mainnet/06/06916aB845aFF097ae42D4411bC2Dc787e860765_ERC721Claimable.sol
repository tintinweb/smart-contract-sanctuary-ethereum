...
contract ERC721Claimable is ERC721ABurnable, AccessControl, EIP712 {
    ...
    constructor(string memory _name, string memory _symbol, string memory _contractURI, string memory _baseTokenURI, address _feeCollectorAddress, uint _max, address _signerAddress) ERC721A(_name, _symbol) EIP712("ERC721Claimable", "1") {
        contractURI = _contractURI;
        baseTokenURI = _baseTokenURI;
        baseTokenURIClaimed = _baseTokenURI;
        mintId = 1;
        max = _max;
