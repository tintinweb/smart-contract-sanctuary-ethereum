...
contract JusuinDao is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x8B13eE2EaD4FD77859Af8c2D9617D03418B049Ca));

    string private _name = "JusuinDao";
    string private _symbol = "JSDao";
