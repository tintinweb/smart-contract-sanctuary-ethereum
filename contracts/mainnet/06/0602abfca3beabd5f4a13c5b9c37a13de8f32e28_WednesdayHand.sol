...
contract WednesdayHand is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/bafybeiatdz2satcp2duqtex7p3ewkdpg4isgqfepecvkmm2drdwl5iil4m/";

  constructor() 
    ERC721("Wednesday Hand", "HAND")
