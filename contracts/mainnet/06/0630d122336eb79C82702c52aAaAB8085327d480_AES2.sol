...
contract AES2 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public          maxSupply         = 10435;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Aes Bears", "AES2"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Request mismatch.");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more bears");
    require(mintEnabled, "Minting is not yet live.");
    require(numberMinted(msg.sender) + amt <= maxPerWallet,"Limit per wallet reached.");
