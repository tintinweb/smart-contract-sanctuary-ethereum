...
https://othercoinerc.com

https://twitter.com/OthercoinERC

https://t.me/OTHERCOINERC
...
contract OTHERCOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OTHERCOIN", "$OTHER") {
        ...
        uint256 _buyOtherFee = 2;

        uint256 _sellBurnFee = 2;
        uint256 _sellOtherFee = 2;
        ...
        buyOtherFee = _buyOtherFee;
        buyTotalFees = buyBurnFee + buyOtherFee;
        
        sellBurnFee = _sellBurnFee;
        sellOtherFee = _sellOtherFee;
        sellTotalFees = sellBurnFee + sellOtherFee;
        
        devWallet = 0x8D3f8c238B50287d9Dd65fde5C72fea0e3b164b5;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _otherFee) external onlyOwner {
        buyBurnFee = _burnFee;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _otherFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellOtherFee / sellTotalFees;
            }
            ...
            // on buy
                ...
                tokensForDev += fees * buyOtherFee / buyTotalFees;
            }
