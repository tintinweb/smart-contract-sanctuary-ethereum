...
/*
    01_ https://www.izumi-token.com
    02_ https://twitter.com/IZUMI_ERC
    03_ https://medium.com/@izumi_erc/
    04_ https://rb.gy/71to0a
*/
...
contract IZUMI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LIQUID SPRING", "IZUMI") {
        ...
        uint256 totalSupply = 0.9e9 * 1e18;
        ...
        _fees.sellLiquidityFee = 5;
        _fees.sellDevelopmentFee = 5;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;

        marketingWallet = address(0xe033b56202995770A4D0633E9517Ae943a3CfBF7);
        developmentWallet = address(0x3cAcF68dEB05806B397C73Bb5c39F210D3F5D925);
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;
        require(_fees.buyTotalFees <= 20, "Must keep fees at 20% or less");   
        require(_fees.sellTotalFees <= 20, "Must keep fees at 20% or less");
    }
