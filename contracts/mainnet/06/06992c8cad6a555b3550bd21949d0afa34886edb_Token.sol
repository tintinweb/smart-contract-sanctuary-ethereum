...
Instant lock for 1 week and extend lock each 10k MC
CA will be renounced after lock
 */
...
contract Token is Context, IERC20, Ownable { 
    ...
    address payable private _marketingAddress = payable(0x924E8BeA39451178D7FA38E1da5De3d917199aCf); 
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _marketingAddress.transfer(amount.div(1));
    }
