...
contract MadMangaFSCC is ERC721, ERC721Enumerable, Ownable {
    bool public IsActive = true;
    string private _baseURIextended;
    address payable public immutable contract_owner;
    uint256 public _price = 0;

    constructor(address payable _owner) ERC721("MadMangaFSCC", "FSCC") {
    ...
    function mint(address _addr, uint num) public payable onlyOwner{
        require(IsActive, "Sale must be active to mint Tokens");
        require(_addr != address(0));
        require(num > 0);
        require(_price * num <= msg.value, "Ether value sent is not correct");
