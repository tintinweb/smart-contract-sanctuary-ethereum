...
contract Cumgoblins is Ownable, ERC721A {
    uint256 public constant MAX_SUPPLY = 5300;

    uint256 public publicPrice = 0.003 ether;

    uint256 public constant PUBLIC_MINT_LIMIT_TXN = 20;
	uint256 public constant PUBLIC_MINT_LIMIT = 300;

    string public baseURI = 'ipfs://bafybeie6m3aa2ibeo7a53ssk3is6fvc5bz4ae7odvoetsxhfwxbd7dv2su/';
    ...
    constructor() ERC721A("Cumgoblins", "cgbl") {}
        ...
        mintCompliance(quantity)
    {
        ...
        require(quantity < 4, "Only 3 free");
	...
	address private constant walletB = 0x59C9b14B5EBa10a46FE9C309BC82a671D287E6ab;

    function withdraw() public onlyOwner {
        uint256 balance = address(this).balance;

		Address.sendValue(payable(walletA), (balance * 55) / 100);
		Address.sendValue(payable(walletB), (balance * 45) / 100);
    }
