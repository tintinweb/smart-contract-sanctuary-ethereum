...
contract LePew is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PEPELEPEW", "LePew") {
        ...
        _fees.sellMarketingFee = 7;
        _fees.sellLiquidityFee = 2;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee;


        marketingWallet = address(0x50a48EDf546a0ac80aC714d9A35734e07E08014D); // set as marketing wallet
