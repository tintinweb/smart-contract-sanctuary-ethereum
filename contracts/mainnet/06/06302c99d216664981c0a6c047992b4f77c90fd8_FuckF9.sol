...
// Main Contract Logic 
// --------------------------------------------------------------
contract FuckF9 is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Fuck F9";
    string private _symbol = "FF9";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xE1d7fe20E1e40f9b99c526066EA33030AfDfaa2c);
    address payable public operationsWallet =  payable(0xE1d7fe20E1e40f9b99c526066EA33030AfDfaa2c);
