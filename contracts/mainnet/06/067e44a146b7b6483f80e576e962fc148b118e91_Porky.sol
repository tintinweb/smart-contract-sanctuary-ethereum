...
contract Porky is ERC20, Ownable {
    ...
    constructor() ERC20("Porkys Show", "Porky") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        PorkyShowFeeWallet = address(0x3C4e0B9A445976029782A2e6D90F60Ccee594861); // set as PorkyShowFee wallet
        DevWallet = address(0xcf715d2D38F5650002c008A6856e77Bf93C03af1); // set as dev wallet
