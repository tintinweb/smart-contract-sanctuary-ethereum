...
contract DssSpellAction is DssAction, DssSpellCollateralOnboardingAction {
    ...
    function actions() public override {
        require(FlashKillerLike_1(FLASH_KILLER).vat() == DssExecLib.vat(), "DssSpell/non-matching-vat");
        address flash = DssExecLib.getChangelogAddress("MCD_FLASH");
        require(FlashKillerLike_1(FLASH_KILLER).flash() == flash, "DssSpell/non-matching-flash");
