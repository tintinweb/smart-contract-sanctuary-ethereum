...
//
//    _____                  __                          
//   / ___/____  ____  _____/ /__   _____  _____________ 
//   \__ \/ __ \/ __ \/ ___/ __/ | / / _ \/ ___/ ___/ _ \
//  ___/ / /_/ / /_/ / /  / /_ | |/ /  __/ /  (__  )  __/
// /____/ .___/\____/_/   \__/ |___/\___/_/  /____/\___/ 
//     /_/                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x32820C4a18a16F49870599d285396Cf07B1A2019];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 433 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcGrRHex6bxxUbmeQAxAUadtx5i2w3Q3BwN3sXMYPxNfG/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 433");
...
// File: contracts/SportverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SportverseContract is RamppERC721A {
    constructor() RamppERC721A("Sportverse", "SV"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/oLMWANzEKidK10P14fPD/contract-metadata";
    }
}
