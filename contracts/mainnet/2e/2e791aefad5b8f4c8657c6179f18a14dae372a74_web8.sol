...
contract  web8 is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "web8";
    string private _symbol = "web8";
    ...
    constructor () {
        ...
        Mark = payable(address(0xEf1D52785FC7E94C02B6b1f10cc7BDF4190BBCE3));
