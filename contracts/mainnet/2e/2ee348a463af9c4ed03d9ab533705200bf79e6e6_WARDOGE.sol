...
// The Official War Doge.
// Telegram: T.me/wardoge_official
...
contract WARDOGE is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "WARDOGE";
    string private _symbol = "WARDOGE";
    ...
    uint256 public _marketingFee4Sellers = 15;
    ...
    address payable public marketingWallet = payable(0x04C7dFbD980a2D134B3e13df4d2647257483B2aF);
