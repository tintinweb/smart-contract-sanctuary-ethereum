...
We at TRPP believe that most project on the erc network claiming that they wont rug are actually false.

We will also rug this project soon, but at least we are transparent and honest about it. 

Note. This is no way means that we won't ever try to market it and produce a utility. 
Once we have a successful launch, we will initiate a community vote and decide on a 
utility that is genuinely beneficial for the project.

We strongly hope that the community don't take the name so seriously, 
we at TRPP will burn the LP and RENOUNCE the ownership so that rugpulling is 100% IMPOSSIBLE. 
Be it in life or anything else for that matter doesn't determine the end result of your journey.
*/
...
contract TRPP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "THE RUGPULL PROJECT";
    string private constant _symbol = "TRPP";
    ...
    address payable private liqAddress = payable(0x16A6754F371a8f7454575b16c656D9d3933f215F);
