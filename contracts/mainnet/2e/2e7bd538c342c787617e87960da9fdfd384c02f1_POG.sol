...
https://t.me/proofofgemportal

Proof that there are still Gems in the shitcoin world at bear market.

No private/public presale, just a pure OG stealth launch and decentralized token.
...
| $$     | $$      | $$  | $$| $$  | $$| $$            | $$  | $$| $$            | $$  \ $$| $$_____/| $$ | $$ | $$
| $$     | $$      |  $$$$$$/|  $$$$$$/| $$            |  $$$$$$/| $$            |  $$$$$$/|  $$$$$$$| $$ | $$ | $$
|__/     |__/       \______/  \______/ |__/             \______/ |__/             \______/  \_______/|__/ |__/ |__/
...
contract POG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of Gem";
    ...
    function sendETHToFee(uint256 amount) private {
        _feeAddrWallet1.transfer(amount.mul(70).div(100));
        _feeAddrWallet2.transfer(amount.mul(30).div(100));
    }
