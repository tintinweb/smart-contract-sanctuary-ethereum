...
contract KittyAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kitty AI😺";
    string private constant _symbol = unicode"KittyAI";
