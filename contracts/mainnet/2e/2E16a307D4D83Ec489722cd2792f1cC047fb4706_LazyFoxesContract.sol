...
//    / /   ____ _____  __  __/ ____/___  _  _____  _____   | |  / /__  __________(_)___  ____     |__ \
//   / /   / __ `/_  / / / / / /_  / __ \| |/_/ _ \/ ___/   | | / / _ \/ ___/ ___/ / __ \/ __ \    __/ /
//  / /___/ /_/ / / /_/ /_/ / __/ / /_/ />  </  __(__  )    | |/ /  __/ /  (__  ) / /_/ / / / /   / __/ 
// /_____/\__,_/ /___/\__, /_/    \____/_/|_|\___/____/     |___/\___/_/  /____/_/\____/_/ /_/   /____/ 
//                   /____/                                                                             
//                                              
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x3d4Fa311b8146419eB538BC12E766C7B8121569C];
  address public erc20Payable = 0x3d4Fa311b8146419eB538BC12E766C7B8121569C;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  */
  function setEarlyMintOwnershipCap(uint256 _newCap) public onlyTeamOrOwner {
    require(_newCap >= 1, "Cannot set cap to less than 1");
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4444) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTRxVcsLD59CBbmC59ditSnxPdePxLcvsrQwT1n5k7zDs/";
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(msg.value == getPrice(1, _to), "Value below required mint fee for amount");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(msg.value == getPrice(_amount, _to), "Value below required mint fee for amount");
...
// File: contracts/LazyFoxesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LazyFoxesContract is RamppERC721A {
    constructor() RamppERC721A("LazyFoxes", "LFox"){}
}