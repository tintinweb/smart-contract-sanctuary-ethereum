...
contract OINKERS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Oinkers Inu", "OINK") {
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 1% from total supply maxTransactionAmount
        maxWallet = totalSupply * 40 / 1000; // 2% from total supply maxWallet
        ...
        marketingWallet = payable(0xf1aF2A7D1d0119Ec701Ce42F2648B26b448A8Fd1);
        devWallet = payable(0xf1aF2A7D1d0119Ec701Ce42F2648B26b448A8Fd1);
