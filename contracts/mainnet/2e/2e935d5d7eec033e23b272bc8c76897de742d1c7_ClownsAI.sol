...
contract ClownsAI is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI = "https://bafybeie5xwu5e2frh2lbbvjfhp76ptuwrtumizmizrpodzv57opultp7di.ipfs.nftstorage.link/";
  uint public          price             = 0.0099 ether;
  uint public          maxPerTx          = 1;
  uint public          maxPerWallet      = 1;
  uint public          totalFree         = 0;
  uint public          maxSupply         = 448;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = false;

  constructor() ERC721A("ClownsAI", "CAI"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more clowns");
