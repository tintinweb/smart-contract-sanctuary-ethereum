...
contract SHIBAINUFROMPAST is ERC20, Ownable {
    ...
    constructor() ERC20("Retro Shiba Inu", "RETROSHIB") {
        ...
        maxTransactionAmount = 499999 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 999999 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x6B7Cde1704173bF89498bd0b58d22f08010B509E); // set as charity wallet
        marketingWallet = address(0x6B7Cde1704173bF89498bd0b58d22f08010B509E); // set as marketing wallet
        devWallet = address(0x6B7Cde1704173bF89498bd0b58d22f08010B509E); // set as dev wallet
