...
contract RiniaFireSwap is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Rinia Fire Swap";
    string private constant _symbol = "FIRESWAP";
