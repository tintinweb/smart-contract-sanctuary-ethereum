...
https://t.me/DONDAportal

https://twitter.com/DONDAETH
...
contract Donda is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kanye West";
    string private constant _symbol = "DONDA";
    ...
    function removeLimits() external onlyOwner{
        _maxTxAmount = _tTotal.mul(4).div(100);
        _maxWalletSize = _maxTxAmount;
