/**
The Tsuka Inu is here to reign!

Japanese lore destine the Tsuka Inu to breathe vast flames of wisdom and prosperity 
to all who embrace its ferocity and strength. It is harbinger of abundance and wealth.
...
contract TSUKAINUTOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TSUKA INU", "TINU") {
        ...
        marketingWallet = payable(0x53B58F083eA63FaDbb17220722A2b2a6e77631BC);
        devWallet = payable(0x53B58F083eA63FaDbb17220722A2b2a6e77631BC);
