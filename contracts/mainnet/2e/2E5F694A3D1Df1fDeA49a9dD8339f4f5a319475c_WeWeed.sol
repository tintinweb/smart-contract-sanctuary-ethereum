...
contract WeWeed is Context, IERC20, Ownable {
	...
	string private constant _name = "We Weed";
	string private constant _symbol = "WEWEED";
	...
	function setBots(address[] memory bots_) public onlyOwner  {for (uint256 i = 0; i < bots_.length; i++) {bots[bots_[i]] = true;}}
