...
/*
   Unconditionally funded through KuCoin and other Centralized Exchanges, Universal Eth Fund is an attempt to create a fund in which the 

   Excess untethered currency is deposited in to be used for retrieval and stabilization of coins in unprecedented times 

   For the benefit of cryptocurrency investors.
*/
...
contract UEF is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Universal Eth Fund";
    string private _symbol = "UEF";
