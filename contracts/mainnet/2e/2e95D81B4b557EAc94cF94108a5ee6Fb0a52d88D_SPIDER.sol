...
/**
Xigou - $XIGOU is a rare and unique breed originating from China. It is challenging to find them outside of their native China and those who are lucky enough to own one of these remarkable dogs can attest to their devotion and loyalty as a pet.

Telegram: https://t.me/SpiderTokenentry
Twitter : https://twitter.com/SpiderTokenERC
Website : http://spider-token.xyz
...
contract SPIDER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Spider Token";
    string private constant _symbol = unicode"スパイダートークン";
