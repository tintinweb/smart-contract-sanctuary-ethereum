...
contract NewYearNewFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Year New Floki";
    string private constant _symbol = "$NYNF";
