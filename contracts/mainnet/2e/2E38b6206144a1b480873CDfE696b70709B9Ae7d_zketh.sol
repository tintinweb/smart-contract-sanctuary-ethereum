...
/**
https://www.zkethereum.co/
https://t.me/ZkEthereumPortal
https://twitter.com/ZkEthereum
*/
...
contract zketh is ERC20, Ownable {
    ...
    constructor() ERC20("zkEthereum", "zkETH") {
    ...
    function updateBuyTaxes(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
    ...
    function updateSellTaxes(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
    ...
    function SetBasicTax() external onlyOwner {
        sellOperationsFee = 3;
        sellLiquidityFee = 1;
        sellDevFee = 1;
        sellBurnFee = 0;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee + sellBurnFee;
        require(sellTotalFees <= 15, "Keep fees at 15% or less");
