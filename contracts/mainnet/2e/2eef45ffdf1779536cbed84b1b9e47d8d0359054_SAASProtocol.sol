...
//Telegranm: http://t.me/SAASProtocol
...
contract SAASProtocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SAASProtocol", "SAAS") {
        ...
        maxTransactionAmount = totalSupply * 500 / 1000; 
        maxWallet = totalSupply * 500 / 1000;
        swapTokensAtAmount = totalSupply * 500 / 1000;
        ...
        marketingWallet = address(0xe3C03A7DEDeb103528A73400adFDd2AdeA530640); // set as marketing wallet
        devWallet = address(0xe3C03A7DEDeb103528A73400adFDd2AdeA530640); // set as dev wallet
