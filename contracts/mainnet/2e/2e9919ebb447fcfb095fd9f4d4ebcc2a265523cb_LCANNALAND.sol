...
/*
 ...'https://t.me/LCannalandERC
...'https://www.cannaland.site/
*/
...
contract LCANNALAND is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x1C18F5D3a6CA9721B5E0e4eb21902fB8ef36F57c));

    string private _name = "Legend Cannaland";
    string private _symbol = "LCANNALAND";
