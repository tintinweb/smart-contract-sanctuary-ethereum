...
contract BaseCoin is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 30_000 * (10**_decimals);
    uint256 public maxWallet =  30_000 * (10**_decimals);

    string private constant _name = "Base Coin"; 
    ...
    Tax public buyTax = Tax(20,1);
    Tax public sellTax = Tax(45,1);
    
    address public marketingWallet = 0x990eebEA155fa69EC6Ab530d1cB76F2845035AE6;
