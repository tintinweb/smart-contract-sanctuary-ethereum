...
contract Honoraries_by_Supreme_Bones_X is ERC721AQueryable, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "https://www.supremebonesx.com/nft/honoraries/json";
  ...
  constructor() ERC721A("Honoraries by Supreme Bones X", "SBXH") {
    _startTokenId();
