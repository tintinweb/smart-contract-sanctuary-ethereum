...
// This project is created for purpose to collect funds to find Kwon since he is Gone ,
// We all want him Gone but not in the way we cant find him lol 
// Hell is one of them places
// Bring Kwon home ;)jk lets kill him ,ps fuck Luna  
...
contract KwonGone is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "KWON GONE";//
    string private constant _symbol = "GONE";//
    ...
    address payable private _developmentAddress = payable(0x1Cb798F84dCfeE9af12e3415555b13EAE5d8071D);
    address payable private _marketingAddress = payable(0x1Cb798F84dCfeE9af12e3415555b13EAE5d8071D);
