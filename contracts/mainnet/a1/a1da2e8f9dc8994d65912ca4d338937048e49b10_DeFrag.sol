...
/*
    DeFrag is a decentralized liquidity market protocol 
    where borrowers can use NFT assets 
    as collateral to get an instant loan.
*/
...
contract DeFrag is Context, IERC20, Ownable {
    ...
    string private _name = 'DeFrag';
    string private _symbol = 'FRAG';
