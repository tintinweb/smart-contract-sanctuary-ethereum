...
contract LaeebInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "La'eeb Inu";
    string private constant _symbol = "LaINU";
    uint256 public _maxTxAmount = 12_000 * 10**_decimals;
    uint256 public _maxWalletSize = 12_000 * 10**_decimals;
