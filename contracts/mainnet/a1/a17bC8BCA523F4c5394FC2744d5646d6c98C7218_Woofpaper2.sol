...
contract Woofpaper2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Woofpaper 2";
    string private constant _symbol = unicode"WOOF2";
