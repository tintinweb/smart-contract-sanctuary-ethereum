 ...
 * allowances. See {IERC20-approve}.
 */
 contract XO is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "XO";
    string private _symbol = "XO";
    uint8 private _decimals = 9;
    uint256 private _supply = 10000000;
    uint256 public taxForLiquidity = 99;
    uint256 public taxForMarketing = 99;
    uint256 public maxTxAmount = 100000 * 10**_decimals;
    uint256 public maxWalletAmount = 100000 * 10**_decimals;
    address public marketingWallet = 0x2E74bcF2100a939733003DbcabE5Fb4d8A73E7A8;
    // TOKENOMICS END ============================================================>
