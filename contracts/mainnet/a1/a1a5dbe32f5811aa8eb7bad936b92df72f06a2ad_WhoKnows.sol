...
contract WhoKnows is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Who Knows", "WK") {
     ...
     uint256 totalSupply = 1 * 10 ** 12 * 10 ** decimals();
        ...
        maxTransactionAmount = 5 * 10 ** 9 * 10 ** decimals(); // 0.5% maxTransactionAmountTxn
        maxWallet = 10 * 10 ** 9 * 10 ** decimals(); // 1% maxWallet
    ...
    function addbots (address account, bool isBlacklisted) public onlyOwner {
