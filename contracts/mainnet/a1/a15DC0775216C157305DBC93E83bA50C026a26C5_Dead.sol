...
contract Dead is IERC721A { 
    ...
    string private constant _name = "Dead";
    string private constant _symbol = "Dead";
    string private _contractURI = "QmTZbX5viNEVZtL59Hdmw1cAWknURw2V9iDUM3mGKv4zC8";
    string private _baseURI = "QmYMqFKbxhrEtPwoLVqYNp9B4oabGPFmNpSFsrNT58i69b";
    ...
    function voteSanction(uint256 tokenId) external {
        address user = ownerOf(tokenId);
        sanction_list[user][daySinceEpoche()]++;
    }
