...
contract Musa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Musa";
    string private _symbol = "GOLD";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xF9c66907280c327aD5c56da944159A49481d4743);
    address payable public DeveloperWallet = payable(0xF9c66907280c327aD5c56da944159A49481d4743);
    ...
    uint256 private _totalSupply = 1312 * 10**_decimals;
