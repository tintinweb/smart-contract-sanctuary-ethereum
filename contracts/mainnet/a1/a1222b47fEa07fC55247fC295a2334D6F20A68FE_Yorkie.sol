...
contract Yorkie is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"🐶","$Yorkie") {
        ...
        marketingWallet = address(0x28E0314f520C0D2Fb786c6b32A33839af53c1CA0); // set as marketing wallet
        devWallet = address(0x28E0314f520C0D2Fb786c6b32A33839af53c1CA0); // set as dev wallet
