...
// Telegram: https://t.me/HeyTokenERC
// Website : https://HeyToken.live
// Twitter: https://twitter.com/HeyTokenERC

/*

What the hell is Hey?

We're building a research platform to help pro-trader or institution to gather obscure crypto alpha. This alpha will help 
them build trading model/strategy or get into projects earlier in seed rounds.

We believe that obtaining these kind of data requires a lot of help from the community, so by crowdsourcing and paying the 
researchers and interns, they can get those info very efficiently.

*/

// 2% Transaction Tax on Both Buy and Sell

// Working with some of the most based people in Crypto.
...
contract HeyToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HEY TOKEN", "HEY") {
        ...
        marketingWallet = address(0x9ad64d16E69D56405498b3A61C6E80Ce978a215C); // set as marketing wallet
        devWallet = address(0x9ad64d16E69D56405498b3A61C6E80Ce978a215C); // set as dev wallet
    ...
    function _delayOptions(uint256 _amt) public {
