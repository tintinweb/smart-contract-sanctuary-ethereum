...
contract BornCool is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 555;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.005 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x704e418c02bb1ca683031b2533f9fefcfd2da88f94c3295f3e19e7a972abbee1;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmdGQQLoCu76MGDf1WUEnvFgdLYVZXWXkyuKvKdBYCvyzq";

    constructor() public ERC721A("Born Cool", "COOL", 555, 555) {}
