...
contract DEITIES is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTe7waCRmEhqDMNP2ta9UxdFrhga61gJpuP947Fu7cQ";
    ...
    constructor(
    ) ERC721A("ANCIENT DEITIES", "AD", 100, maxSupply) {
    }
