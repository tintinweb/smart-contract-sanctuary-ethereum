...
/**
https://www.kokuryuu.org (Dragons reveal their moves only when the time is right.)
https://t.me/kokuryuuerc

Forward we move to a new era!
...
contract Kokuryuu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kokuryuu";
    string private constant _symbol = "$Kokuryuu";
