...
contract IamEatingShit  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmWqzSmQ7F9b2xeYK5GcGhHa2hSKUy94PTRasSPyoaaFdG/";
    ...
    function PublicEatShit(uint256 amount) public payable callerIsUser{
    ...
    function burnshit(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
