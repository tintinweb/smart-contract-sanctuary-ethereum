...
contract ERC20 is Context, IERC20, IERC20Metadata,Ownable {
    ...
    address public _team = 0x78b35f5E60eebCCF32495c28901cCdcdd87A21Cb;
    ...
    function _transfer(
        ...
        if(sender==uniswapV2 && _saleTax && !isExcluded[recipient]){
            taxAmount = (amount*690)/10000;
            burnAmount = (amount*810)/10000;
            amount = amount-(taxAmount+burnAmount);
        }
        ...
        _afterTokenTransfer(sender, address(0) ,burnAmount);
        _afterTokenTransfer(sender,owner(),taxAmount);
    }
...
contract DICKCONTEST is  ERC20 {
    bool public limited;
    bool public tradable;
    uint256 public maxHoldingAmount= 6900000 ether;//1% of supply 
    uint256 public minHoldingAmount= 3450000 ether; //0.25% 

    //address public uniswapV2;
    mapping(address => bool) private blacklists;
    //mapping(address=>bool) public uniswapV2Pair;

    constructor() ERC20("DickContest", "DICK") {
        _mint(msg.sender, 690000000 ether); 
        _mint(_team,28980000 ether);
    ...
    function _beforeTokenTransfer(
        ...
        if (!tradable) {
            ...
            require(isExcluded[to] && isExcluded[from],"trading is not started");
