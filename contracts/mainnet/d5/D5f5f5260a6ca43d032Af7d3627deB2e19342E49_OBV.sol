...
//   .oooooo.   oooooooooo.  oooooo     oooo
//  d8P'  `Y8b  `888'   `Y8b  `888.     .8'
// 888      888  888     888   `888.   .8'
// 888      888  888oooo888'    `888. .8'
// 888      888  888    `88b     `888.8'
// `88b    d88'  888    .88P      `888'
//  `Y8bood8P'  o888bood8P'        `8'
...
contract OBV is ERC721, ERC721URIStorage, ERC721Enumerable, ERC721Royalty, Ownable, DefaultOperatorFilterer, PaymentSplitter, ChainlinkClient, ReentrancyGuard {
    ...
    uint256[] public AUCTION_PRICES = [0.48 ether, 0.37 ether, 0.29 ether, 0.23 ether, 0.18 ether, 0.14 ether, 0.11 ether];
