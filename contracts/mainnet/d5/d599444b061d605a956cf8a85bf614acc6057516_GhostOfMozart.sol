...
contract GhostOfMozart is ERC20, Ownable {
    ...
    constructor() ERC20( "GhostOfMozart", "$ARTIST") {
        ...
        operationsAddress = address(0x78a599e4E681e3e7d3CD7b4A082d2808A4273AEE); // change this address to wallet u want for operations   
        TaxAddress = address(0xb788149D4E84B19b295F099C674aEc70Aeb2C41E);  // change this address to the one for tax 
