...
contract SACRIFICE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://bafybeidrxud435so6urevvzuzyaqusqiiyoqobzipv53o5uq5wgix6wuaq/";
    ...
    uint256 public NUM_FREE_MINTS = 222;
    ...
    constructor(
    ) ERC721A("SACRIFICE", "BURN", 100, maxSupply) {
    }
