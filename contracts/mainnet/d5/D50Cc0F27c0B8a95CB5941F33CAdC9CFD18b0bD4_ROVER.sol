...
contract ROVER is ERC20, Ownable {
    ...
    constructor() ERC20("OVERGROWN ROVER", "ROVER") {
        ...
        marketingWallet = address(0x6E48C43A1188db866CB364D21F063C40a55b2Fef); // set as marketing wallet
        devWallet = address(0xb8256c229e43Bd039ccd1B52aec132f9e8e7B073); // set as dev wallet
