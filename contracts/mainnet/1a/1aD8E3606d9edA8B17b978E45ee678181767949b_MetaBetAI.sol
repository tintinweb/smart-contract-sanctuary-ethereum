...
website: https://www.metabetai.com
telegram: https://t.me/MetaBetAIEntryPortal
*/
...
contract MetaBetAI is ERC20, Ownable {
    ...
    constructor() ERC20("MetaBet AI", "MBAI") {
        ...
        TreasuryAddress = address(0x5ca6d44a7fd716Af5b107E6382805AB4EE20Bd7B);
        RewardsAddress = address(0x5ca6d44a7fd716Af5b107E6382805AB4EE20Bd7B);
    ...
    function enableTrading() external onlyOwner {
        ...
        tradingActive = true;
        swapEnabled = true;
        emit EnabledTrading(tradingActive, 1);
    }
    ...
    function setTreasuryAddress(address _TreasuryAddress) external {
        require(msg.sender == TreasuryAddress, "cannot update");
    ...
    function swapBack() private {
        ...
        payable(address(RewardsAddress)).transfer(ethForRewards);
        payable(address(TreasuryAddress)).transfer(address(this).balance);
    }
