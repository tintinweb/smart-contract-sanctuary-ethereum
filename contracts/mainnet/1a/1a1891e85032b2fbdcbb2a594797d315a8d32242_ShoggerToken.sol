...
contract ShoggerToken is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x7CA034C29ab87f20999DAc1c6F94b96832827C32);
    address payable public utilityAddress = payable(0x7CA034C29ab87f20999DAc1c6F94b96832827C32);
    address payable public teamAddress = payable(0x7CA034C29ab87f20999DAc1c6F94b96832827C32);
    ...
    constructor () BEP20Detailed("SHOGGER TOKEN", "SHOGGER", 18) {
      _owner = msg.sender ;
