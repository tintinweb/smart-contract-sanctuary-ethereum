...
/*
There are eight bead bearers in total, so far, all bead bearers have five things in common, they all have a bead, there is a peony imprint on them somewhere.
the surname starts with "Inu", and they all die and then Resurrected, they all have a guardian or ability to keep them alive.
...
Join TG:https://t.me/HAKKENDEN_ERC20
*/
...
contract HakkendenInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Hakkenden Inu";
    string private constant _symbol = "HAKKENDEN";
