...
//
//
//          _______  ___   _  __   __  ___      ___      _______  _______ 
// |       ||   | | ||  | |  ||   |    |   |    |   _   ||       |
// |  _____||   |_| ||  | |  ||   |    |   |    |  |_|  ||  _____|
// | |_____ |      _||  |_|  ||   |    |   |    |       || |_____ 
// |_____  ||     |_ |       ||   |___ |   |___ |       ||_____  |
//  _____| ||    _  ||       ||       ||       ||   _   | _____| |
// |_______||___| |_||_______||_______||_______||__| |__||_______|
//     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5dbeFAc0cc97C38cc5782fA814cF7d6F75CFD5DD];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSTjQ2Dzt4otHk35xE8DbypAK614jN9i58GTZuNnvYuTP/";
...
// File: contracts/SkullasContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SkullasContract is RamppERC721A {
    constructor() RamppERC721A("Skullas", "SKC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SyHBa7VxVFqy4vEOBY7F/contract-metadata";
    }
}
