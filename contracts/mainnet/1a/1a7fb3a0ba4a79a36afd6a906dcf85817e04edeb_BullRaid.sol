...
// Let’s kick off a Bull run. Rise from the Ashes. Roar like a king...

// 💚 Fair Launching, ETHEREUM / ETH!.
// 💜  Support/Marketing at launch!
// ✊ 3% Buy/Sell Supply Limit (first 3 mins)
// 📑 5%: Buy/Sell tax (10% for first 1 hour jeet proof)
// 💹 No Buy/Sell Limit after first 3 minutes.
// 🔐 30 days Liq Lock on Launch
// 🏦 1 Billion Supply!
...
contract BullRaid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Bull Raid";
    ...
    address payable private _marketingAddress = payable(0xF864be78129FAbA05c4b8fC28158056700c0FcF0);
    address payable private _devAddress = payable(0xF864be78129FAbA05c4b8fC28158056700c0FcF0);
    ...
    uint256 public _maxTxAmount = 30000000 * 10**9; //1.8% of total supply per txn 
    ...
    function setNumbers(uint256 distroFeeOnBuy, uint256 distroFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
