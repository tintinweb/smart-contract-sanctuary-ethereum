 ...
 * allowances. See {IERC20-approve}.
 */
 contract MFR is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Memefier";
    string private _symbol = "$MFR";
    ...
    address public marketingWallet = 0x821B4f911DCc9950a554B7DB3645961922673A61;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToETH = 2000000 * 10**_decimals;
