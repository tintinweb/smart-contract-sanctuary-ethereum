...
// Degen Dobermans NFT collection
// Website: https://degen-dobermans.com/
// Twitter: https://twitter.com/DegenDobermans
...
contract DegenDobermans is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  string public        baseExtension     = ".json";
  uint public          price             = 0.003 ether;
  uint public          maxPerTx          = 4;
  uint public          totalFree         = 2800;
  uint public          maxSupply         = 6000;
  bool public          mintEnabled;

  constructor() ERC721A("degen dobermans", "degendobermans"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on degen");
    require(totalSupply() + amount < maxSupply + 1,"No more dobermans");
