...
/**
🐶 Floki cult $FCULT  | ERC20 🐶

A Decentralized Meme Token on the Ethereum Blockchain
Our mission is to give back to the crypto community, give to charity, 
and win the heart of the greatest token of all time, Floki cult $FCULT (ERC).

https://t.me/flokiculterc
https://twitter.com/flokicult
...
contract FCULT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Floki cult";
    string private constant _symbol = unicode"FCULT";
