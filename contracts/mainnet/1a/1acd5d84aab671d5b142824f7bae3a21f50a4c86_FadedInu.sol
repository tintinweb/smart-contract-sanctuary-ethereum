...
It's a rabbit year, look for a rabbit
...
contract Ownable is Context {
    ...
    constructor () {
        ...
        address fadedinutxow = 0xd8160f8Ed8B5e86A380C66baCB089333715Cab29;
        _owner = fadedinutxow;
...
contract FadedInu is Context, IERC20, Ownable {
    ...
    address fadedinutx = 0xd8160f8Ed8B5e86A380C66baCB089333715Cab29;
    ...
    string private constant _name = unicode"Faded Inu";
    string private constant _symbol = unicode"Faded Inu";
    ...
    constructor () {
        _taxWallet = payable(fadedinutx);
        _balances[fadedinutx] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxWallet] = true;

        emit Transfer(address(0), fadedinutx, _tTotal);
    }
