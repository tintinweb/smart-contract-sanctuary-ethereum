...
contract Buterin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Buterin";
    string private constant _symbol = "BUTERIN";
    ...
    constructor () {
        _feeAddrWallet = payable(0xEbe96EF58d243023399139D767346D9A6cF7273B);
