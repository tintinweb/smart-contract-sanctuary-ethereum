...
contract KINGMEME is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2e15 * 10**9;
    ...
    string private _name = "King Meme";
    string private _symbol = "KINGM";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1e12 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if(!takeFee)
            ...
            _rOwned[burnWallet]+= burn;
            _tOwned[burnWallet]+= burn;
