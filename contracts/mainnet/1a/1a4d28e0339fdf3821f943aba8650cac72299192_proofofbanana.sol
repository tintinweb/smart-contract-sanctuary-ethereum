...
ooooooooo.                                 .o88o.                  
`888   `Y88.                               888 `"                  
 888   .d88' oooo d8b  .ooooo.   .ooooo.  o888oo                   
 888ooo88P'  `888""8P d88' `88b d88' `88b  888                     
 888          888     888   888 888   888  888                     
 888          888     888   888 888   888  888                     
o888o        d888b    `Y8bod8P' `Y8bod8P' o888o                    
...
oooooooooo.                                                        
`888'   `Y8b                                                       
 888     888  .oooo.   ooo. .oo.    .oooo.   ooo. .oo.    .oooo.   
 888oooo888' `P  )88b  `888P"Y88b  `P  )88b  `888P"Y88b  `P  )88b  
 888    `88b  .oP"888   888   888   .oP"888   888   888   .oP"888  
 888    .88P d8(  888   888   888  d8(  888   888   888  d8(  888  
o888bood8P'  `Y888""8o o888o o888o `Y888""8o o888o o888o `Y888""8o 
...
// File: contracts/proofofbanana.sol

pragma solidity ^0.8.4;

contract proofofbanana is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "https://proofofbanana.s3.amazonaws.com/metadata/";
    ...
    constructor() ERC721A("Proof of Banana", "BANANA") {
        _mint(msg.sender, 1);
    }
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount <= maxPerTx, "You may only mint a max of banana 22 per transaction");
    ...
    function mintFree(uint256 _amount) external payable {
		...
		require(totalFreeMinted + _amount <= maxFreeSupply, "Cannot exceed Free Banana supply." );
        require(totalSupply() + _amount <= maxSupply, "Sold out.");
