...
/**
name: Dejitaru Chooky
SYB: Choo
tax: 5/5
Chooky wasn't the first dog to grace the world of social media but he certainly was one of its most popular canine stars!

https://t.me/DejiChooky
...
contract DejitaruChooky is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Dejitaru Chooky", unicode"Choo") {
		...
		marketingWallet = address(0x14a1e9EcC7587e9A5E32ccF177FDf96478e6C08E); // set as marketing wallet
        devWallet = address(0x14a1e9EcC7587e9A5E32ccF177FDf96478e6C08E); // set as dev wallet
