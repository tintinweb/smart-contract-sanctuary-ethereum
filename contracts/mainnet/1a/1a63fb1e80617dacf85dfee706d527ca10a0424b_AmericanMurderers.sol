...
contract AmericanMurderers is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPGPMYMkbBbzkZsJCjx6FF4MU9UAAncRytAzTc21K4VAP";
    ...
    constructor(
    ) ERC721A("American Murderers By Brigitte Clementine", "MURDER", 100, maxSupply) {
    }
