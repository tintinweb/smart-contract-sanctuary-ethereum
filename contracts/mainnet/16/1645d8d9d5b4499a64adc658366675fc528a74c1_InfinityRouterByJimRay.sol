...
contract InfinityRouterByJimRay is ERC721A, DefaultOperatorFilterer {
    uint256 private maxSupply = 999; 
    ...
    constructor() ERC721A("Infinity Router By Jim Ray", "Rou") {
        owner = msg.sender;
        maxFree = 200;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmbFTDmaRoD73XS77DcheuEJistsg5XeoC8iz7rUCSBK59/", _toString(tokenId)));
    }
