...
contract CryptoHooter is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://Qmbj7872guwPnq1AYLXqonPJY1aLm2ckdqjntkGHB7n18C/";
  uint256  public  maxSupply = 2000;
  uint256 public  max_per_txn = 4;
  uint256 public  public_price = 0.002 ether;
  uint256 public  free_mints = 420;
