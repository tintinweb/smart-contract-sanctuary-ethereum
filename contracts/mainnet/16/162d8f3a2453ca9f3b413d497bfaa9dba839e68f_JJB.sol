...
//Want to try out our Jeet alert bot?
//Join our Telegram at https://t.me/JohnnyJeetBot for more information!
...
contract JJB is Context, IERC20, Ownable {
    ...
    uint256 private percent1=46;
    uint256 private percent2=27;   
    uint256 private percent3=27;
    string private constant _name = "Johnny Jeet Bot";
    string private constant _symbol = "JJB";
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0xb9A1927F3f0cd1f09016595D3a75879E2eF8844B);
        _feeAddrWallet3 = payable(0x11483473594Dc1b33c646Cc9a5Aa803C09dD54E4);
        _tOwned[address(this)] = _tTotal.div(100).mul(100);
        _tOwned[address(0xb9A1927F3f0cd1f09016595D3a75879E2eF8844B)] = _tTotal.div(100).mul(2);
        _tOwned[address(0x414e7fF75E5D9e6F196df490e8C41622081fb6ee)] = _tTotal.div(100).mul(2);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[address(0x414e7fF75E5D9e6F196df490e8C41622081fb6ee)] = true;
