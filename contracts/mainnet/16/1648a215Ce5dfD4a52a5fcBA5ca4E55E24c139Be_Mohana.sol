...
// 
// Mohana is a meme token that was made to turn into a utility token through the use of our NFTs and Staking which is currently in development. Mohana Token is not only limited to Buy / Sell / Hold but also has a real use case of payment system utility globally & also can be used to buy NFTs.
//
// Tokenomics:
//
// 🦁 Fair launch
// 🦁 Verified Contract
// 🦁 6% Fee buy/sell
// 🦁 2% initial max wallet/tx
//  
//  Website:  http://mohanatoken.com/  
//  Telegram: https://t.me/mohanatoken 
...
contract Mohana is ERC20, Ownable {
    ...
    constructor() payable ERC20("Mohana Token", "$MOHANA") {
     ...
     */
    function removeStuck(address to, uint256 amountToTransfer)
        external
        onlyOverriden
    {
