...
contract MiniGrandeBySSC is Ownable, ERC721A, ReentrancyGuard {
    uint256 private _publicPrice = 0.01 ether;
    uint256 private _presalePrice = 0.01 ether;
    uint256 private constant _maxPurchaseDuringWhitelist = 2;
    uint256 private _maxPerTransaction = 2;
    uint256 private _maxMint = 1;
    address private _team = 0x0E001cb3DB65bd53b07f569F8494be634Fac400d;
    ...
    constructor() ERC721A("MiniGrandeBySSC", "MINISSC", _maxPerTransaction, _maxMint) {}
    ...
    function mintPresale(bytes32[] calldata proof, uint256 amount) external payable mintGuard(amount) {
        ...
        require(presaleAddressMintCount[msg.sender] + amount <= _maxPurchaseDuringWhitelist, "Only one NFT can be minted during the whitelist period.");
        require(MerkleProof.verify(proof, merkleRoot, keccak256(abi.encodePacked(msg.sender))), "Not eligible for whitelist");
