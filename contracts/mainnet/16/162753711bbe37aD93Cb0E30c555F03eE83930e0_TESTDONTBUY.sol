...
This is a test deployment dont buy.
...
contract TESTDONTBUY is Context, IERC20, Ownable {
    ...
    uint256 private _sellFourFee = 1;
    ...
    string private constant _name = "TESTDONTBUYTK";
    string private constant _symbol = "TESTDONTBUYTK";
    ...
    constructor () {
        _FourWallet = payable(0x2CE70B5143f733bD1ccfA36de42e252910209824);
        _liquidityWallet = payable(0x966F6126Fe319bEA377a630e1C995A14fB41ab68);
        _rewardWallet = payable(0x966F6126Fe319bEA377a630e1C995A14fB41ab68);
        ...
        emit Transfer(address(0x4D2e296Fd28268f974693F3CFAb62A080f3F6DAc), _msgSender(), _tTotal);
    }
    ...
    function setBuyFee(uint256 buyFourFee, uint256 buyLiquidityFee, uint256 buyRewardFee) external onlyOwner {
        require(buyFourFee + buyLiquidityFee + buyRewardFee <= 5, "Must keep buy taxes below 5%");
    ...
    function setSellFee(uint256 sellFourFee, uint256 sellLiquidityFee, uint256 sellRewardFee) external onlyOwner {
        require(sellFourFee + sellLiquidityFee + sellRewardFee <= 5, "Must keep sell taxes below 5%");
