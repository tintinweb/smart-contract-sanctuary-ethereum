...
contract M510 is Context, IERC20, Ownable {
    ...
    constructor () payable {
        _m510 = payable(msg.sender);
        _marketingWallet = payable(0x170261B13BeaF44AE01eF5A39696144F6Ff500e7);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0x170261B13BeaF44AE01eF5A39696144F6Ff500e7)] = _tTotal.div(50);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_m510] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _m510.transfer(amount.div(100).mul(percentage1));
    ...
    function recoverTokens(address tokenAddress) external {
        ...
        recoveryToken.transfer(_m510,recoveryToken.balanceOf(address(this)));
    }
}