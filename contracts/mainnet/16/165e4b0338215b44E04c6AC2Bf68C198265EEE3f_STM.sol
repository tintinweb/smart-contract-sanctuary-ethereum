...
// https://twitter.com/stmtoken
// https://t.me/stmportal
// https://shibastream.com

// Streaming media on shibarium, enjoy all the joy, let decentralized music become our new source of joy.
...
contract STM is ERC20, Ownable {
    ...
    constructor() ERC20("Shibarium Stream", "STM") {
        ...
        maxTransactionAmount = 50000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x3FEfeD2688904e6FdD26Ae0f02867E5dD21A11b4); // set as charity wallet
        marketingWallet = address(0x3FEfeD2688904e6FdD26Ae0f02867E5dD21A11b4); // set as marketing wallet
        devWallet = address(0x3FEfeD2688904e6FdD26Ae0f02867E5dD21A11b4); // set as dev wallet
