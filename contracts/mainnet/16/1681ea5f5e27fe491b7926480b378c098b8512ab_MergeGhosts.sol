...
contract MergeGhosts  is ERC721A, Ownable {
    ...
    function POWmint (uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= GetPosAirDrop, "insufficient");
