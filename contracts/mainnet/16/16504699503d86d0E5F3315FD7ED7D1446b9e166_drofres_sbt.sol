...
contract drofres_sbt is ERC721A, Ownable {
    using Strings for uint256;
    address public admin;   // Upgradable admin (only by owner)

    uint256 public maxSupply = 60;
    string public baseURI = "ipfs://QmWV3pzgShk4i5oMP3E7SSZ6DVvvHTxVDEd9FBms5qGj8m/";
    string public baseExtension = ".json";

    constructor() ERC721A('DLoFres Staff SBT', 'DSS') {
        admin = owner();
    }
