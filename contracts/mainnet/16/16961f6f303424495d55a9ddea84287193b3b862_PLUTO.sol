...
contract PLUTO is ERC20, Ownable {
    ...
    constructor() ERC20("Pluto Inu", "ORBIT") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xF2eD270f6b578f87e86E347eAfd1A5A8ff0916c8); // set as Marketing wallet
        DevWallet = address(0xF2eD270f6b578f87e86E347eAfd1A5A8ff0916c8); // set as dev wallet
