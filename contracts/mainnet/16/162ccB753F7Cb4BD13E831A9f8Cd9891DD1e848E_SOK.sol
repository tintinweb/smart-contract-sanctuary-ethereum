...
contract SOK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shadow Of Kabosu";
    string private constant _symbol = unicode"SOK";
