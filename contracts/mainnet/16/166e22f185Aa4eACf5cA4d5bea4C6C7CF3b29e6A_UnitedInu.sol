...
contract UnitedInu  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "United Inu";
    ...
    address payable private _developmentAddress = payable(0xA2f68640e650428283437458365EF21baB8E07b7); 
    address payable private _marketingAddress = payable(0xA2f68640e650428283437458365EF21baB8E07b7);
