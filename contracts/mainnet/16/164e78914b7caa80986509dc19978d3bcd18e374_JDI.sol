...
JP Morgan CEO Jamie Dimon said crypto is a decentralized Ponzi
It's a pet rock

Did you also know that JP Morgan has been fined $36 BILLION since 2000?

He doesn't really understand Bitcoin
He is a clown

Which is why we are making a meme coin about him

Jamie Dimon Inu
$JDI

For the ones that don't understand what we are all about
...
contract JDI is ERC20, Ownable {
    ...
    constructor() ERC20("Jamie Dimon Inu", "JDI") {
        ...
        maxTransactionAmount = 210000 * 1e18; // 1% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x4F6B461CE92BC5261E8949577Aa6af3500F4a163); // set as charity wallet
        marketingWallet = address(0x4F6B461CE92BC5261E8949577Aa6af3500F4a163); // set as marketing wallet
        devWallet = address(0x4F6B461CE92BC5261E8949577Aa6af3500F4a163); // set as dev wallet
