...
contract btools is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BoneTools";
    string private constant _symbol = unicode"BTOOLS";
