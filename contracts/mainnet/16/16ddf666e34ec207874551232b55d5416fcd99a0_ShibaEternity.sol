...
//  Just saying... 👀
//  
//  #ShibaEternity is trending on twitter
//  
//  https://twitter.com/search?q=%23ShibaEternity&src=trend_click&vertical=trends
//
//  https://t.me/SHEVEReth
//  https://twitter.com/SHEVEReth
//
...
contract ShibaEternity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "ShibaEternity";
    string private constant _symbol = "SHEVER";
    ...
    address payable private _marketingAddress = payable(0x65086221F8E2b055c9DaeA063115d27F63966edb);
    ...
    uint256 public _maxTxAmount = 3e10 * 10**9; //3%
    uint256 public _maxWalletSize = 3e10 * 10**9; //3%
    uint256 public _swapTokensAtAmount = 1000 * 10**9;
    uint256 public _minimumBuyAmount = 3e10 * 10**9 ; // 3%
    ...
    function setTaxFee(uint256 amountBuy, uint256 amountSell) external onlyOwner {
        require(amountBuy >= 0 && amountBuy <= 5);
        require(amountSell >= 0 && amountSell <= 5);
    ...
    function setJeetsFee(uint256 amountRedisJeets, uint256 amountTaxJeets) external onlyOwner {
        ...
        require(amountTaxJeets >= 0 && amountTaxJeets <= 5);
