...
contract LIMIT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public lpWithdrawRequestDuration = 0 days;
    ...
    constructor() ERC20("Limit", "LIMIT") {
    	...
    	operationsWallet = address(0x1C99b0071C097b67B143BDAA653517b438Bd294c); // set as operations wallet
    ...
    function enableTradingToPublic() external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 160, "Must keep fees at 16% or less");
    }
