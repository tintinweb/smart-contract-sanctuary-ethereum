...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract CoinbasePunks is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("Coinbase Punks", "CBP") {
  }


  
 
  function mintCPunk(uint8 _mintAmount) external payable  {
...
if ( reveal == false)
{
 ...
 function CBPStake(uint8 _limit) external onlyOwner{
 ...
 function RevealCPunks() external onlyOwner{
     reveal = !reveal;
 }
