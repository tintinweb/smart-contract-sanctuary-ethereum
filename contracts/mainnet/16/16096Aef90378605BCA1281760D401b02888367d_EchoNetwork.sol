...
contract EchoNetwork is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EchoNetwork", "ECHO") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xA4A47A56cFe27e0aee3489E558FA3737f8427B15); // marketing wallet
        devWallet = address(0xc225F029456DaA2E87F66B674a4d2396CBf6863d); // dev wallet
