...
contract CVMS is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public mintSupply = 1950;
    uint256 public maxPerTransaction = 1; 
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("Crypto Vending Machines", "CVMS") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "CVMS isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "CVMS Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"CMVS Soldout !");
        require(msg.value >= qty * price,"CVMS Insufficient Funds !");
