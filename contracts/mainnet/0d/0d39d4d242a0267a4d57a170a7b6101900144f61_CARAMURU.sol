...
- Low Tax (1% buy/sell);
- KYC'd Developers;
- a true community oriented philosophy! No social media curated by Developers!
- more to come...
*/
...
contract CARAMURU is Context, IERC20, Ownable {
    ...
    string constant private _name = "CARAMURU";
    string constant private _symbol = "CARAMURU";
    ...
    uint256 public numTokensSellToFee = 10000 * 10**9;
    ...
    function _transfer(
        ...
        if (contractTokenBalance >= numTokensSellToFee && !inSwapAndLiquify && from != uniswapV2Pair && swapAndLiquifyEnabled) {
            if(contractTokenBalance >= numTokensSellToFee) {
