...
contract ObamnaInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Obamna Inu";
    string private constant _symbol = "2024";
    ...
    address payable private _developmentAddress = payable(0x67C7eD6D0197244cc351bBB2C9b9afFA400342fC); 
    address payable private _marketingAddress = payable(0x67C7eD6D0197244cc351bBB2C9b9afFA400342fC);
