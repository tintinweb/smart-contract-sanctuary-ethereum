...
contract Mandela is Context, IERC20, Ownable {
    ...
    string private _name = "The Mandela Effect Token";
    string private _symbol = "$MANDELA";
    ...
    address payable public marketingWallet = payable(0x5a531B5855F2a17E1856dF404F0109dAB0E7b7D6);
