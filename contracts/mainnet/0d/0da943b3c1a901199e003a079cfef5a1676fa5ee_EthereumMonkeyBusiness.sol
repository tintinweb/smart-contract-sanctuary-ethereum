...
https://t.me/EthereumMonkeyBusiness
...
contract EthereumMonkeyBusiness is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "EthereumMonkeyBusiness";
    string private _symbol = "EMB";
    ...
    uint256 private _totalSupply = (1000000000 * 10**4) * 8**_decimals; //1T supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0xf0592aC93BfB7632Da47ecf2dfa2d43c693301fb);
