...
contract alphaSHIB is IERC20, ERC20Token {
    ...
    string private _name = "Shibarium Alpha";
    string private  _symbol = unicode"αSHIB";
    ...
    uint256 minSwapTokensThreshold = 0;
    function setMinSwapTokensThreshold(uint256 threshold) external onlyOwner {
        minSwapTokensThreshold = threshold;
    }
