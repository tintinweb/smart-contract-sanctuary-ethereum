...
/* 
On a Adventure Time on the road to $1
Will disable Trading delay once coin is stable
will remove limits once coin is stable
https://twitter.com/JakeErc
*/
...
contract JI is ERC20, Ownable {
    ...
    address public constant jiAddress = address(0xBD547b7B8f24F08b9aA6f792ec5a0a78332BCb3A);
    ...
    constructor() ERC20("Jake Inu", "JI") {
        ...
        uint256 totalSupply = 20 * 1e6 * 1e18;
        ...
        devWallet = address(0xBD547b7B8f24F08b9aA6f792ec5a0a78332BCb3A); // offical JI address, totally an adventure wallet
