...
/**
 * @title DegenDao Applications contract
...
contract DegenDaoApplications is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("DegenDao Applications", "DAPP"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(numberMinted(msg.sender) + amt <= maxPerWallet,"Exceeds max mint per wallet.");
    require( amt < maxPerTx + 1, "Exceeds max mint per txn.");
  ...
  {
    require(totalSupply() + amt < maxSupply + 1,"Exceeds supply.");
