...
contract ShibariumBridge is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibarium Bridge"; 
    string private constant _symbol = "SHIBRIDGE"; 
    ...
    address payable private _developmentWalletAddress = payable(0x2B3C0EF80d2Bc9020F3cb3289e0091aE712C753c);
    address payable private _marketingWalletAddress = payable(0x2B3C0EF80d2Bc9020F3cb3289e0091aE712C753c);
