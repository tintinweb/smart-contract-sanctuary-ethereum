...
$HSB tokenomics:
Total supply 100.000.000 - 50% will be burn after launch.
Buy/Sell Tax 0/0.
When the MarketCap reaches 10k the liquidity will be blocked and the contract will be renounced.
...
contract HASBULLANFT is ERC20, Ownable {
    ...
    constructor() ERC20("HASBULLANFT", "HSB") {
        ...
        maxTransactionAmount = 100000000 * 10 ** 9;
        maxWallet = 100000000 * 10 ** 9;
