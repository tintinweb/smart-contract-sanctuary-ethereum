...
error Fiat24StargateSwap__AddressSanctioned(address sender);
...
contract Fiat24StargateSwap is Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    function swap(
        ...
        if(SANCTION_CHECK) {
            ...
            if(sanctionsList.isSanctioned(_msgSender())) revert Fiat24StargateSwap__AddressSanctioned(_msgSender());
        }
