...
// File: contracts/BABYVILLAINS.sol
...
contract BABYVILLAINS is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxMintAmountPublic = 6;
    ...
    constructor() ERC721A("Baby Villains", "$BABYV") {}
    ...
    function Burn(uint256 _burnAmount) public onlyOwner {
	    require(_burnAmount > 0, "need to mint at least 1 NFT");
	    require(totalSupply() + _burnAmount <= maxSupply, "max NFT limit exceeded");
        _safeMint(address(0x000000000000000000000000000000000000dEaD), _burnAmount);
    }
