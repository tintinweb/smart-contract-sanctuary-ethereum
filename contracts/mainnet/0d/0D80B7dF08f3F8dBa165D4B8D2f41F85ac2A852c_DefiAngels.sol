...
/**
 * @title DefiAngels NFTs
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 */
contract DefiAngels is Ownable, ERC721Enumerable, MerkleProofVerify {
    ...
    error Max5MintsPerTxn();
    error MaxSupplyLimitReached();

    constructor() ERC721("Defi Angels", "Angels") {}
    ...
    function mint(uint256 _noOfTokens) public payable {
        ...
        _mintTokens(_msgSender(), _noOfTokens);
    }
    ...
    function claim(
        ...
        _mintTokens(_msgSender(), _amount);
    }
     ...
     * @param _noOfTokens - no of tokens to mint.
     */
    function _mintTokens(address _to, uint256 _noOfTokens) internal {
        if (_noOfTokens > 5) revert Max5MintsPerTxn();
