...
Teleram account: https://t.me/LightningCatcherPortal
*/
...
contract RAIKIRI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lightning Catcher";
    ...
    uint256 private maxWalletAmount = 1000001  * 10**9;
    uint256 private maxTxAmount = 1000001 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xa8659a21Fb234cE643FB7d17Aa1fdDA0065378aF); 
        ...
        maxTxAmount = 1000001  * 10**9;
        maxWalletAmount = 1000001 * 10**9;
