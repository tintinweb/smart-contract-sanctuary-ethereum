...
contract MIKU is Context, IERC20, Ownable {
    ...
    uint256 private _initialSellTax=47;
    ...
    string private constant _name = unicode"MIKU";
    string private constant _symbol = unicode"未来";
    uint256 public _maxTxAmount =   420000 * 10**_decimals;
    uint256 public _maxWalletSize = 420000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 420000 * 10**_decimals;
