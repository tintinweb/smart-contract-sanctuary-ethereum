...
contract POPEYE is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "POPEYE";
    string constant _symbol = "POPEYE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 696_969_696 * (10 ** _decimals);
    ...
    uint256 marketingFee = 17;
    uint256 totalFee = liquidityFee + marketingFee;
    uint256 feeDenominator = 100;

    address public marketingFeeReceiver = 0x14cb16974B6975E9fa1a5Aa73d4AeD77E40e9BEC;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x14cb16974B6975E9fa1a5Aa73d4AeD77E40e9BEC] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x14cb16974B6975E9fa1a5Aa73d4AeD77E40e9BEC] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x14cb16974B6975E9fa1a5Aa73d4AeD77E40e9BEC,
                block.timestamp
            );
