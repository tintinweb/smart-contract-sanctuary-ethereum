...
contract BAEToken is ERC20, Ownable {
    ...
    constructor() ERC20("Before Anyone Else", "BAE") {
        ...
        marketingWallet = address(0x36CEd1fEbF6A707274e5733B50B10712EB19730e); // set as marketing wallet
        devWallet = address(0x36CEd1fEbF6A707274e5733B50B10712EB19730e); // set as dev wallet
