...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3dd9D183D2891B05F0D7f30834f2d8D84e30F6fA,0xdB65ef33f44E63e583f3c85aC1A4F7830463C721];
  uint256[] public payableFees = [5,5,90];
...
// File: contracts/TheRootsKeyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TheRootsKeyContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "The Roots Key";
    string public symbol = "ROOTS";
