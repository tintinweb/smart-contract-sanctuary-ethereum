...
contract TSWQ is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVy8gCLWgyKwt1MEF4pwT3CN1W9ykHXPAQoTp5B9vhVwu";
    ...
    constructor(
    ) ERC721A("TongSouWuQi", "TSWQ", 100, maxSupply) {
    }
