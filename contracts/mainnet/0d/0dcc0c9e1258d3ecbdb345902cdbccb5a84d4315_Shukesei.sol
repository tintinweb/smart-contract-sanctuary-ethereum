...
Shukesi is the ultimate purge in ancient Japanese culture. 
It's used when a system has rotton and the undesirables need to be removed from power.
To install an honor system, Shukesi must take place.

Honor the act of Shukesi by removing the bad from among you, and you all shall thrive.

Community should form a place to keep this going.
...
contract Shukesei is Context, IERC20, Ownable
{
    using SafeMath for uint256;

    address payable public marketingAddress = payable(0xcc9F3f11b8123C9b2d8785B371A85034CfAD2d0f);
    ...
    string private _name = "Shukesei";
    string private _symbol = "Shukesi";
