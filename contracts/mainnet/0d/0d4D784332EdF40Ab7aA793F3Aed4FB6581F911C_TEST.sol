...
contract TEST is ERC20, Ownable {
    ...
    constructor() ERC20("Toon Finance", "TFT") 
    {
        _maxSupply = 1000000000 * (10**18); //Max Supply
        _setOwner(msg.sender);
        maxWallet = _maxSupply * 3 / 100; // 2% Of total supply
        uniswapV2Router02 = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // PCS V2 Router
