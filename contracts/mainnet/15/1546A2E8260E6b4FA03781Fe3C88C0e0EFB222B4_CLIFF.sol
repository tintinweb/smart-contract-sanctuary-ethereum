...
contract CLIFF is ERC20, Ownable {
    ...
    constructor() ERC20("Clifford", "CLIFF") {
    ...
    function removeClifflimits() external onlyOwner returns (bool){
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 60, "Must keep fees at 20% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 98, "Must keep fees at 25% or less");
    }
