...
Website: https://rebone.xyz/

Twitter: https://twitter.com/reBONEerc

Telegram Portal: https://t.me/rebonetoken

LightPaper : https://rebone.gitbook.io/rebone-ecosystem/
...
contract REBONE is ERC20, Ownable{
    ...
    uint256 public maxWalletAmount = 30_000 * 10**18;
    
    address public marketingWallet = 0x9daCb142b12035952bC09861E266dBA7B1843868;
    address public devWallet = 0x9daCb142b12035952bC09861E266dBA7B1843868;
    ...
    constructor() ERC20("Rebone Shibarium", unicode" $REBONE") {
    ...
    function fireTrading(uint256 numOfDeadBlocks) external onlyOwner{
    ...
    function putTaxes(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function putSellTaxes(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
