...
abstract contract Ownable is Context {
    ...
    contract GroovyDoodles is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmXHJYbZAVyAMaYesbqB1gu1YFsg4pc7UdGzcXE9kWMuTL";
  ...
  constructor() ERC721A("Groovy Doodles", "GDood") {
  }
