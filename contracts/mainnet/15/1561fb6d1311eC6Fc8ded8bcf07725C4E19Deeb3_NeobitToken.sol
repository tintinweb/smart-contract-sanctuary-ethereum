...
contract NeobitToken is BEP20 {
    ...
    payable(0x016f74925740EE10016ea11b19d9c988dbe86F28);
    ...
    uint256 public devmarketingShare = 14;
    uint256 public totalShares = 15;

    bool public SwapAndLiquifyEnabled = false;
    uint256 public maxTxAmount = 300000000 * (10**9); // Initial Max Tx Amount
    ...
    constructor() public BEP20("Neorbit", "NRB", 9) {
        devmarketingFeeOnBuy = 7;
        devmarketingFeeOnSell = 7;
        liquidityFeeOnBuy = 1;
    ...
    function updateShares(
        ...
        totalShares = liquidityShare.add(devmarketingShare);

        emit SetDistribution(_liquidity, _devmarketing);
    }
