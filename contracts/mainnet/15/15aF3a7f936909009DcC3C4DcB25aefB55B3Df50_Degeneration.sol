...
contract Degeneration is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 999;
    ...
    address[] public withdrawAddresses = [0xFF621B12576Aae06ea4fD8223aF703F38FC95Ce1, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x3e74cd8f8db73db3277d4e22bd5f6f56ba3d94bca56a326e7191edb3ea6068c7;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x2E25F71fCc8bc7C5b48D0cE608602B026320c63f, _royaltyAmount);
    }
