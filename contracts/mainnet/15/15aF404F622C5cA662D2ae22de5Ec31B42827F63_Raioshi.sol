...
contract Raioshi is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Raioshi";
    ...
    uint256 private blocksToBlacklist = 15;
    ...
    function withdrawStuckETH() external onlyOwner {
        ...
        require(success, "Eth withdraw unsuccessful");
    }
}