...
/**
Kaioken Wallet Tracker


https://t.me/KaiokenWalletTracker
http://t.me/kaiokenwalletbot
...
contract KaiokenWalletTracker is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Kaioken Wallet Tracker"; 
    string private constant _symbol = "KAIOKEN"; 
    ...
    uint256 private _taxOnBuy = 90;   
 
    //Sell Fee
    uint256 private _feeOnSell = 0; 
    uint256 private _taxOnSell = 90;  
    ...
    address payable private _developmentWalletAddress = payable(0x7442fefa494a5271D27609b70E9B9A78Fb239278);
    address payable private _marketingWalletAddress = payable(0x7442fefa494a5271D27609b70E9B9A78Fb239278);
