...
contract EpicNetwork is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Epic Network"; 
    string private constant _symbol = "EPIC"; 
    ...
    address payable private _developmentWalletAddress = payable(0xd461C9Bda65d845438944198260dE3Bd30D67E26);
    address payable private _marketingWalletAddress = payable(0xd461C9Bda65d845438944198260dE3Bd30D67E26);
