    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 297) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeielp23riwaff7etiuqdkx5frfv3nax5lnlfgc5gyvgamj52xubp7u/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/oDMk1jzXzegaAU3AFy8A/contract-metadata";
  }
...
// File: contracts/TheWhirlingWaterfallContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheWhirlingWaterfallContract is RamppERC721A {
    constructor() RamppERC721A("The Whirling Waterfall", "TWW"){}
}
