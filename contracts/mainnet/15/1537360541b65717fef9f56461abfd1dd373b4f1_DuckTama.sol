...
Contract will be verified and liquidity locked before launch.  Renounce after remove limits, $10k-15k

2% Max Txn
4% Max Wallet
TG Opened soon after launch
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xE957DC6690Cf04A3208377f9D736b3464f1191B5] = _marketingwallet;
    }
...
contract DuckTama is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ducktama.", "duckma.") {
        ...
        excludeFromFees(address(0xE957DC6690Cf04A3208377f9D736b3464f1191B5), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xE957DC6690Cf04A3208377f9D736b3464f1191B5), true);
