...
contract nootNOOT is ERC721A, Ownable, ReentrancyGuard {

    string public baseURI = "Not revealed";
    string public baseExtension = ".json";
  uint public          multiplePrice = 0.0069 ether;
  uint public          price = 0.000 ether;
  uint public          maxPerTx = 10;
  uint public          maxSupply = 1999; //change in real
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = true;
  bool public          revealed = false;

  constructor() ERC721A("nootNOOT", "nootNOOT"){
