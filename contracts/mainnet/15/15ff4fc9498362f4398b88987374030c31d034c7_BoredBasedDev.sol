...
https://medium.com/@BoredBasedDev/
...
contract BoredBasedDev is ERC20, Ownable {
    ...
    constructor() ERC20("Bored Based Dev", "BASED") {
        ...
        marketingWallet = address(0x27257C6A4CB4554E0571FB1F2c1415126b9af0D1); // set as marketing wallet
        devWallet = address(0x27257C6A4CB4554E0571FB1F2c1415126b9af0D1); // set as dev wallet
