...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xE5B2C146ADC13Dc05cc8ca7faD25743738682862];
  address public erc20Payable = 0xE5B2C146ADC13Dc05cc8ca7faD25743738682862;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 225) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifcm65jus4wstjrtsweggdhspkspont4dmmnab33upxexvoz7zkk4/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 225");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 225");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 225");
...
// File: contracts/InvaderWasHereContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InvaderWasHereContract is RamppERC721A {
    constructor() RamppERC721A("Invader Was Here", "MINTPLEX"){}
}
