...
contract TrickorTrump is ERC20, Ownable {
    ...
    constructor() ERC20("Trick or Trump", "TRIMP") {
        ...
        maxTransactionAmount = 3500000 * 1e18; // 0.35% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x2DB006649af0C33f50D75dA69B86f22a63bf0713); // set as charity wallet
        marketingWallet = address(0x2DB006649af0C33f50D75dA69B86f22a63bf0713); // set as marketing wallet
        devWallet = address(0x2DB006649af0C33f50D75dA69B86f22a63bf0713); // set as dev wallet
