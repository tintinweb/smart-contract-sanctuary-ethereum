...
The mysterious human-bird-like creatures that physically distinguishes this mythological creature from its Gongmyeongjo counterpart are the amount of heads. It has a bird body, while the upper portion is human. But it’s believed by some that the Kalaviṅka is based on the real birds of India.
...
Don't you believe that Kalaviṅka in here? 
You just think that's a story only?

https://t.me/kalavinkacommunity
**/
...
contract KALAVINKA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kalaviṅka";
    string private constant _symbol = "KALAVINKA";
