...
contract  BRMBV1MintContract is ERC721A, Ownable {
    ...
    //Pricing
    //***************************************************************************************************
    uint256 public pricePartner = 0.044 ether; //set NFT price
    uint256 public pricePresale = 0.044 ether; //set NFT price
    uint256 public pricePublic = 0.044 ether; //set NFT price

    //***************************************************************************************************
    //Supply and Reserve
    //***************************************************************************************************
    uint256 public maxSupply = 5000; // set max supply according to your need
