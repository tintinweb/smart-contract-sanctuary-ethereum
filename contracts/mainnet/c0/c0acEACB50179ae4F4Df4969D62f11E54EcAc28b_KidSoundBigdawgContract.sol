...
//*********************************************************************//
//
//     __ __ _     __   _____                       __            ____  __________   ____  ___ _       ________
//    / //_/(_)___/ /  / ___/____  __  ______  ____/ /           / __ )/  _/ ____/  / __ \/   | |     / / ____/
//   / ,<  / / __  /   \__ \/ __ \/ / / / __ \/ __  /  ______   / __  |/ // / __   / / / / /| | | /| / / / __  
//  / /| |/ / /_/ /   ___/ / /_/ / /_/ / / / / /_/ /  /_____/  / /_/ // // /_/ /  / /_/ / ___ | |/ |/ / /_/ /  
// /_/ |_/_/\__,_/   /____/\____/\__,_/_/ /_/\__,_/           /_____/___/\____/  /_____/_/  |_|__/|__/\____/   
//                                                                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1665417600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1665356400;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xAA73FCe9499E1dCC4B9B43427FD590A37583014e];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xAA73FCe9499E1dCC4B9B43427FD590A37583014e;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.015 ether;
  uint256 public earlyMintTokenIdCap = 44;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 45) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigcuq3v2v6bccue5uf7476glrc3yvh2go33ql36psyu7jph36wyy4/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 45");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 45");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 45");
...
// File: contracts/KidSoundBigdawgContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KidSoundBigdawgContract is RamppERC721A {
    constructor() RamppERC721A("Kid Sound  BIG DAWG", "KS BigDawg"){}
}
