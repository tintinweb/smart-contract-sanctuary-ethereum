...
// File: contracts/LittleFellas.sol
...
contract LittleFellas is ERC721A, Ownable {
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Little Fellas", "LILFELLAS") {
        setBaseURI(baseURI);
        isSaleActive = false;
