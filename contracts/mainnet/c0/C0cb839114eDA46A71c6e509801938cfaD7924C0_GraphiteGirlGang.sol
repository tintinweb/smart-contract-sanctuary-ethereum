...
// File: contracts/GraphiteGirlGang.sol
...
contract GraphiteGirlGang is ERC721A, Ownable, ReentrancyGuard {

  using Address for address;
  using Strings for uint;

  string public baseTokenURI = "ipfs://QmVwTJivYj1gv586apS47MswjnWuEFNcvi6NPfJEWKAaV9";
  uint256 public COLLECTION_SIZE = 3142;
  uint256 public MAX_MINTS_PER_TX = 5;
  uint256 public SALE_PRICE = 0.009 ether;
  uint256 public NUM_FREE_MINTS = 500;
  uint256 public MAX_FREE_PER_WALLET = 1;
  uint256 public freeNFTAlreadyMinted = 0;
  bool public SaleIsActive = false;

  constructor() ERC721A("Graphite Girl Gang", "GGG") {}
      ...
      payable
  {
    ...
    require(
      totalSupply() + numberOfTokens <= COLLECTION_SIZE,
...
function setSalePrice(uint256 _price)
  ...
  function setNumOfFreeMint(uint256 _limit)
      external
      onlyOwner
  {
      NUM_FREE_MINTS = _limit;
  }
