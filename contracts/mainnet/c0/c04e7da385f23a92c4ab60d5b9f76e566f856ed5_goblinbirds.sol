...
contract goblinbirds is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qme8wJrTrax5wsk5732vhmZo8A1oUeYkPQResZ25cfryuc";
    ...
    constructor(
    ) ERC721A("GoblinBirds", "BIRDS", 100, maxSupply) {
    }
