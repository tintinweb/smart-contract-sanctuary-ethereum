...
contract DrunkenVikingsTribe is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 3636;

    
    uint256 public FREE_SUPPLY = 333;
    uint256 public WHITELIST_SUPPLY = 3636;
    uint256 public PUBLIC_SUPPLY = 3636;
    ...
    mapping(address => uint) public FREE_Minted;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmXdPbaX5j78XnjUqaSEDgw5Enzr6PWhbCi8ePZuSwivQP";
    ...
    constructor(
        bytes32 _Free,
        bytes32 _Whitelist) ERC721A("DrunkenVikingsTribe", "DVT") {
        
        FREE_ROOT = _Free;
        WHITELIST_ROOT = _Whitelist;
        
        _safeMint(0x9C63aF2ed991F9ddEB63eEECAf79c95E9F3368B5, 1);
    }
    ...
    function FREEMint(uint256 numberOfTokens, bytes32[] memory proof) external isSecured(FREE_PRICE * numberOfTokens) payable {
        validateMint(IS_FREE_ACTIVE, FREE_COUNT, FREE_SUPPLY, FREE_Minted[msg.sender], FREE_WALLET_LIMIT, FREE_TX_LIMIT, numberOfTokens, MerkleProof.verify(proof, FREE_ROOT, keccak256(abi.encodePacked(msg.sender))));
    ...
    function WHITELISTMint(uint256 numberOfTokens, bytes32[] memory proof) external isSecured(WHITELIST_PRICE * numberOfTokens) payable {
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0x20A1468F3C9527ebd33F324bDE4c7Ea45faF1d7a).call{ value: address(this).balance }("");
