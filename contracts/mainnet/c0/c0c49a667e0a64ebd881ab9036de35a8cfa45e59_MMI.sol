...
/**
Name: Money Mayweather Inu
Ticker: MMI
1,000,000,000 MMI

Our socials:
    t.me/mmierc20
    twitter.com/mmierc20
    medium.com/@mmierc20
*/
...
contract MMI is ERC20, Ownable {
    ...
    constructor() ERC20("Money Mayweather Inu","MMI") {
        ...
        marketingWallet = address(0xeD3e418891F8307C1B1d6176564ff5B6f390a32c); 
    ...
    function updateFee(uint256 newbuyMarketingFee, uint256 newsellMarketingFee) public onlyOwner {
        buyMarketingFee = newbuyMarketingFee;
        buyTotalFees = buyMarketingFee;
        sellMarketingFee = newsellMarketingFee;
        sellTotalFees = sellMarketingFee;
        require (buyTotalFees+sellTotalFees <= 10,"Max fee at 10%");
    }
