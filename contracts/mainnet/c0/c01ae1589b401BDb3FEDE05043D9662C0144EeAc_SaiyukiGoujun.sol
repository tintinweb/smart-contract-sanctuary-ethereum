...
SAIYUKI GOUJUN - KING OF THE SEAS

Telegram: https://t.me/SaiyukiGoujun

Website: https://saiyukigoujun.com 

Twitter: https://twitter.com/saiyukigoujun
...
contract SaiyukiGoujun  is ERC20, Ownable {

    string constant _name = unicode"Saiyuki Goujun";
    string constant _symbol = "SaiyukiGoujun";
    ...
    uint256 public maxTxAmount = 3 * _totalSupply / 100; // 2%
    uint256 public maxWalletAmount = 3 * _totalSupply / 100; // 2%

    mapping (address => bool) isFeeExempt;

    uint256 public finalFeeTimestamp;
    uint256 constant public finalFeePercent = 3; // 
    uint256 constant public startingFeePercent = 7; //
    ...
    uint256 immutable public swapThreshold = _totalSupply / 9_000; // 0.1%
    bool inSwap;
