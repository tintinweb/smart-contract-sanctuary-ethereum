...
'   ;  \; /  | / \  \  \ ;   : ;   |   :    |'   ; :__ |  | ' \ \ 
 \   \  ',  /./__;   ;  \|   ,/     \   \  / '   | '.'|'  : |--'  
  ;   :    / |   :/\  \ ;'---'       `----'  |   :    :;  |,'     
   ...
   Website: https://www.0xlock.io/
   Telegram:  https://t.me/zeroxLock
   Twitter: https://twitter.com/zeroXLock
...
contract ZeroxLock is ERC20, Ownable {
    ...
    constructor() ERC20("0xLock", "0xL") {
        ...
        marketingWallet = address(0xC18DA2c0a5f5A34069C83c0849124cC5C600C41c);
        developmentWallet = address(0x57c2642871E306574b04849aaD2A52bf533d7aaF);
