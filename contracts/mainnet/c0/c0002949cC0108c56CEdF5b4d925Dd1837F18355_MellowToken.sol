...
/// @title LabToken
///
/// @dev This is the contract for the Mellow governance token.
///
...
contract MellowToken is AccessControl, ERC20("Lab Token", "LAB") {
  ...
  modifier onlyMinter() {
    require(hasRole(MINTER_ROLE, msg.sender), "MellowToken: only minter");
    _;
  }
