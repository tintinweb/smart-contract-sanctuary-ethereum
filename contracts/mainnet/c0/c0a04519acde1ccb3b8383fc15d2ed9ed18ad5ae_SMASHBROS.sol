...
// SmashBros is going to be the next metaverse NFT marketplace for video game themed nft fighting tokens, 
// integrating each token for a battle royale. Use your SmashBros tokens to purchase NFTs 
// and then fight other NFT holders to the death. Once the NFT dies
// Telegram: https://t.me/+UaDI_MYQ-AphNjJh 
// Twitter: https://twitter.com/smashbros_eth?s=21
// Website: Smashbroseth.com
...
contract SMASHBROS is Context, IERC20, Ownable {
    ...
    string private _name = "Smash Bros Token";
    string private _symbol = "SMASHBROS";
