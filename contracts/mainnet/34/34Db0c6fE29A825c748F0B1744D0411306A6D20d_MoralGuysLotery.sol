...
// File: contracts/MoralGuysLotery.sol
...
contract MoralGuysLotery is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("MoralGuysLotery", "MGL") {
    setHiddenMetadataUri("ipfs://bafybeicsmw5jbdnsz5hys43ub3tzfwbh7zlbodlpecfw4xz3x5zf3lzfua/hidden.json");
  }
