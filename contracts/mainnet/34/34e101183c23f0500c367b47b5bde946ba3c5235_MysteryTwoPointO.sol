...
contract MysteryTwoPointO is ERC20, Ownable {
    ...
    constructor() ERC20("Mystery2.0", "MYSTERY2") {
        ...
        maxTransactionAmount =  totalSupply * 10 / 100; // 1% from total supply maxTransactionAmountTxn
        maxWallet = totalSupply * 10 / 100; // 2% from total supply maxWallet
        ...
        devWallet = address(0x86A57E2F8a971a4b6de0A82CE88495B3F795DfA5); // set as dev wallet
