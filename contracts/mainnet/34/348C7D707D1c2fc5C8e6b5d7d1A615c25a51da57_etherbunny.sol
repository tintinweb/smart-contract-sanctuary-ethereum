...
Welcome to The Ether Bunny, this bunny isn't laying eggs, he's is dropping .5 ETH 
on the heads of three lucky holders on Easter Sunday!

Hold some of this in your basket through the holiday to find out what this Bunny 
is really hopping towards.

Beyond the “Easter” holiday theme, we are a team of developer’s who can actually 
generate real innovative utility.  

The teams ATH on ETH has been previously  involved in tokens with hundreds of 
millions in MCAP.

With this  year being the year of the rabbit, anything is possible with The Ether 
Bunny! So load up!

Socials:

Telegram: https://t.me/TheEtherBunny
Twitter: https://twitter.com/theethbunny
...
contract etherbunny is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"The Ether Bunny";
