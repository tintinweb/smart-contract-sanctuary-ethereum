              ...
              *b     J"      $       3r    dP                     
               ^$c  z%       $        "c z$"                      
                 "*$L        $        .d$"                        
                    "*$ee..  $  ..ze$P"                           
                        ""*******""                         
./Web:Basketballjesus.net
./Telegram:@BASKETBALLJESUS
./RIP Kobe
./Tokenomics:
   - 81 Billion Supply
...
contract JESUSHOOP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Basketball Jesus";
    string private constant _symbol = "JESUSHOOP";
    ...
    uint256 private constant _tTotal = 81000000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x9E5533c1e36B0ed922bA9e532C211AAa8a6aB0f9);
    address payable private _marketingAddress = payable(0xe954cC54550238D2558D8d2f7357D393edF9Cc2b);
    ...
    uint256 public _maxTxAmount = 810000000 * 10**9; // 1.0%
    uint256 public _maxWalletSize = 1620000000 * 10**9; // 2.0%
    uint256 public _swapTokensAtAmount = 81000000 * 10**9; // 0.1%
