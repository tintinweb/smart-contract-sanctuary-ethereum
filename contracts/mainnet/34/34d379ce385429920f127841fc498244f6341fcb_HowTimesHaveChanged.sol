...
contract HowTimesHaveChanged is Context, IERC20, Ownable {
    ...
    string private constant _name = "How Times Have Changed";
    string private constant _symbol = "HTHC";
    ...
    uint256 private _maxWalletSize = 5_000_000 * 10**9;
