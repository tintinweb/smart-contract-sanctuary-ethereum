...
contract FTXTRAPINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTX TRAP INU";
    string private _symbol = "FTXTINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf7b5F69087A07939DEa149a29783B780F427d81B);
    address payable private BuyBackAddress = payable(0x4ed7C15a8EED42d45af3dAb83cAe47E6AD2d8D05);
