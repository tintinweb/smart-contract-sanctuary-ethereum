...
contract NI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2 * 10**8;
    ...
    string private constant _name = "NI";
    ...
    uint256 private _maxTxAmount = 0.04 * 10**8;
    uint256 private _maxWalletSize = 0.05 * 10**8;
