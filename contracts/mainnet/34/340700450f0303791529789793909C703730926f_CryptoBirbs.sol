...
contract CryptoBirbs is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 420;
    uint256 public immutable supply = 2000;
    ...
    address[] public withdrawAddresses = [0xfAf3106bCbC512cE0f4026Ce1CcfcfF833b77cb3, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xc3fbf92e0f533674fcdbb3179c7e963302d8d40fad1d452d141c26cff784d800;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xfAf3106bCbC512cE0f4026Ce1CcfcfF833b77cb3, _royaltyAmount);
    }
