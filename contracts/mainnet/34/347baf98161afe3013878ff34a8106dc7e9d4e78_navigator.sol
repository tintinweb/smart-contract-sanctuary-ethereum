...
// File: contracts/navigator.sol

// https://t.me/+9yNso0iM2fhhNDEv
...
contract navigator is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "navigator";
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount > 1000000 * 10**9 );
