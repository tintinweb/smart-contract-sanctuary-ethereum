...
contract EtherPredictx is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EtherPredictx() {
        ...
        name = "EtherPredictx Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETHPX";                                             // Set the symbol for display purposes (CHANGE THIS)
