...
contract qingbao is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Qingbao";
    string private constant _symbol = unicode"QING";
