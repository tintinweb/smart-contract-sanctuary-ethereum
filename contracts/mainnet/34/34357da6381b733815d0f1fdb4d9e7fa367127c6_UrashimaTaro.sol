...
//The princess gives Urashima Taro a box and tells him that as long as he does not open it, he will stay happy,
// but of course, he opens the box when he returns to land. 
// Follow along for the story of Urashima $TARO.

// TG - https://t.me/UrashimaTaroToken

// twitter - https://twitter.com/urashimataro

// website - the story unravels itself. The one who seeks, shall find.
...
contract UrashimaTaro is ERC20, Ownable {
    ...
    constructor() ERC20("Urashima Taro", "TARO") {
        ...
        devOpsWallet = address(0x93330e523274FF2cD140A21aDa815B899f014613); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x93330e523274FF2cD140A21aDa815B899f014613), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x93330e523274FF2cD140A21aDa815B899f014613), true);
