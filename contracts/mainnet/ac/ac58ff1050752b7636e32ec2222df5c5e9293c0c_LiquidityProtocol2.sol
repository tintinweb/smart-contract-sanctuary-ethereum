...
contract LiquidityProtocol2 is ERC20, Ownable{
    ...
    Taxes public taxes = Taxes(0,6,1);
    Taxes public sellTaxes = Taxes(0,6,1);
    ...
    constructor() ERC20("LiquidityProtocol2", "LP2") {
