...
interface IERC20 {
    ...
    function StakeBalance() external returns (uint256);
...
contract RatInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa62B477a7eF10A13Dfc1D44CcE394Fba5a27b1Fd); 
    address payable public Wallet_Developer = payable(0xa62B477a7eF10A13Dfc1D44CcE394Fba5a27b1Fd);
    ...
    string private constant _symbol = unicode"Rat Inu";
    ...
    constructor () {
        ...
        _owner = 0xa62B477a7eF10A13Dfc1D44CcE394Fba5a27b1Fd;
    ...
    function StakeBalance() public override returns (uint256) {
