...
/**t.me/yuskiportal
website;yuski.org
twitter.com/yuskierc20
Read through the medium for more info.
Yuski is creating a web3 protocol enabled social safe space forum,a totally decentralized
platform for all crypto Degen's discussion,with an escrow p2p enabled service,NFT,charts
and token analysis with more functionalities added options determined by the community.
Yuski will only support based and valid projects on its plaform.
certain % of all revenue generated from the app will be use for buy back and burn. 
 *
*/
...
contract YUSKI is IBEP20, Ownable {
    ...
    string constant _name = "YUSKI";
    string constant _symbol = "YS8";
