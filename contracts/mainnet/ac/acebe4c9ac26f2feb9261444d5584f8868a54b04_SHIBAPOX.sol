...
contract SHIBAPOX is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x08F998EbDC7744BC01ECa1E74678800bAa024D26);
    ...
    constructor() ERC20("SHIBA POX", "SHIBA POX") {
        ...
        */
        _createSupply(owner(), 1000000 * (10**9));
    }
