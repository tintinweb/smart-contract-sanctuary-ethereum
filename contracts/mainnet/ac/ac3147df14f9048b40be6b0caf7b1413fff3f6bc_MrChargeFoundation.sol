...
// File: contract/MrChargeFoundation.sol
...
contract MrChargeFoundation is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Mr. Charge Foundation", "MCF") {
    setHiddenMetadataUri("ipfs://bafkreigig3eus3sa6la5gvvfzucdufryb25ozfiuuidrhnlhzgufqb5oku/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool os, ) = payable(0xE65283c3e09777F8466655B7145FA6A01e43d44B).call{value: address(this).balance * 100 / 100}("");
    require(os);
    // =============================================================================
  }
