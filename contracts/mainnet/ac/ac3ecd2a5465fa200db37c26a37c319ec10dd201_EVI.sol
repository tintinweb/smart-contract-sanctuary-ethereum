...
contract EVI is ERC20, Ownable {
    ...
    constructor() ERC20("Journey to the Abyss", "EVI") {
        ...
        marketingWallet = address(0x41480829b1108A49AD98409d6D6f9c4d1e993c24); // set as marketing wallet
        devWallet = address(0x7E2D20Ec785801A6C128Fb133b8Fef0332DA2e00); // set as dev wallet
