 ...
 * @notice This contract handles minting Santoshi Bullrunner tokens.
 */
contract SantoshiBullrunner is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xa4c63689F28197132Fa3f3b4eC0372BCfaAc0b0e;
    address[] public payoutAddresses = [
        0xDD707B3067837221E259A71eE77F511c26A438CE,
        0xa4c63689F28197132Fa3f3b4eC0372BCfaAc0b0e,
        0xa60C2D4394BA204BF345554E73AD7F86000ca7bb
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeiflslucza7fuzfnzlqqhq4xg5ngmfzmmm54dk5tkubkeislznmnkm/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 2023;
    uint256 public publicMintsAllowedPerAddress = 5;
    uint256 public publicMintsAllowedPerTransaction = 2023;
    ...
    uint256[] public payoutBasisPoints = [3300, 3400, 3300];
    uint96 public royaltyFee = 500;

    constructor(address _blocklistContractAddress)
        ERC721A("Santoshi Bullrunner", "SBR")
    {
