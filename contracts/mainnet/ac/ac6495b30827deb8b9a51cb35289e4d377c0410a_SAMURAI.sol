...
contract SAMURAI is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmP5m7zYGVjxq75MZJ2hA1MQuSD6ra87SckjZWa2iJtkah";
    ...
    constructor(
    ) ERC721A("Samurai | Akane Yin", "KATANA", 100, maxSupply) {
    }
