...
contract SteppnApes is ERC721A, Ownable, ReentrancyGuard {
  ...
  {
    require(totalSupply() + amt < maxSupply + 1,"Not enough to reserve.");
    _safeMint(msg.sender, amt);
  }
