...
contract TiffApes is Ownable, ERC721 {
    ...
    uint256 public maxFreeAmount = 2;
    ...
    function mint(uint256 amount) external payable {
        ...
        uint256 freeAmount = (_totalSupply < 3000 && _balance < maxFreeAmount) ? maxFreeAmount - _balance : 0;
        require(msg.value >= (amount > freeAmount ? amount - freeAmount : 0) * price, "wrong price");
    ...
    function setMaxFreeAmount(uint256 _amount) public onlyOwner {
