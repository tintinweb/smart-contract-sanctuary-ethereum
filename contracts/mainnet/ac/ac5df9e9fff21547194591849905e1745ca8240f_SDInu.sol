...
/*
    If it quacks like a duck, walks like a duck it’s probably a Saudi Duck.
    ********************************************
    ** Telegram:    https://t.me/SaudiDuckInu **
    ********************************************
*/
...
contract SDInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buyTxFee = 6;
    uint256 public sellTxFee = 6;
    ...
    constructor(address _dev) public ERC20("Saudi Duck Inu", "$SDINU") {
