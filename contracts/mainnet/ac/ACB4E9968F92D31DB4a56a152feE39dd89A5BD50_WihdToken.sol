...
// File: contracts/WihdToken.sol

pragma solidity ^0.4.24;

/*
 * WihdToken is a standard ERC20 token with some additional functionalities:
...
contract WihdToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "WIHD";
	string public constant name = "Wealth in Health Dollar";
	uint8 public constant decimals = 18;
	uint256 public constant INITIAL_SUPPLY = 100000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 100000000000 * (10 ** uint256(decimals));
	...
	modifier onlyWhenTransferAllowed() {
		require(transferEnabled || msg.sender == tokenOfferingAddr);
		_;
	}
	...
	* @param value Amount of wihdtokens to send
	*/
