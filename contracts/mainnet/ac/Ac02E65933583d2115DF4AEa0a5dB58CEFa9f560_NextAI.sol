 ...
 * allowances. See {IERC20-approve}.
 */
 contract NextAI is ERC20, Ownable {

    //TOKENOMICS
    string private _name = "NextAI";
    string private _symbol = "NEXTAI";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 45; //snipers
    uint256 public maxTxAmount = 1000000 * 10**_decimals;
    uint256 public maxWalletAmount = 1000000 * 10**_decimals;
    address public marketingWallet = 0x273f6d76995357C9fEe81562F735203490542525;
