...
contract BreXXA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"BreXXA"; 
    string private constant _symbol = unicode"BreX"; 
    ...
    address payable private _marketingWalletAddress = payable(0x2E2707cC857A2Ad23d6c526FF6177ABfce0d4274);
