...
// The end of FTX and $FTT is near and together we can replace them.

// https://t.me/FTXDogePortal

// https://twitter.com/FTXDoge
...
contract FTXDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FTX DOGE", "FTXD") {
        ...
        devOpsWallet = address(0x68534C33bCE84B3AE63B51BadCCe91f8C11521aF); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x68534C33bCE84B3AE63B51BadCCe91f8C11521aF), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x68534C33bCE84B3AE63B51BadCCe91f8C11521aF), true);
