...
/**
Telegram: https://t.me/QtaruNoTamashi
*/
...
contract QtaruNoTamashi is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Qtaru No Tamashi";
    string private constant _symbol = "QTARU";
