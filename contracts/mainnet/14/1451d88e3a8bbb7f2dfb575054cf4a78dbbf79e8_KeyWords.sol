...
contract KeyWords is ERC721, ERC721URIStorage, Pausable, Ownable, PullPayment {
    ...
    event guessResult(bool result, uint256 tokenId, address gamer);
    event safeMinted(uint256 tokenId, address owner, string uri, uint256 prize, uint256 cost);

    // Creator address
    address private creatorAddress = 0x6E909edeDffc28C4Ad12e0d94b6CD2A59936BA46;

    constructor() ERC721("KeyWords", "KW") {}
    ...
    function safeMint(bytes32 wordHash, string memory uri, uint256 tryValue) public payable {
        ...
        emit safeMinted(tokenId, msg.sender, uri, msg.value, tryValue);
    }

    function guess(uint256 tokenId, string memory word) public payable {
        ...
        emit guessResult(equal, tokenId, msg.sender);
    }
