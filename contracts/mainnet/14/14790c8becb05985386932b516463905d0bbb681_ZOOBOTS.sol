...
// This is an NFT of the Zoobots, intended to clarify the terms of use for any NFT it is included with. It was originally authored in this form by H.A.J. a.k.a. LIONBRUSH and the text of the license itself is licensed under the Creative Commons Attribution 4.0 International License. To view a copy of this license, visit http://creativecommons.org/licenses/by/4.0/ or send a letter to Creative Commons, PO Box 1866, Mountain View, CA 94042, USA.
...
contract ZOOBOTS is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public constant _TOTALSUPPLY = 1001;
    ...
    uint256 public preSaleMaxQuantity = 1;
    uint256 private startReserve = 982;
    ...
    constructor(string memory baseURI) ERC721("Zoobots", "ZOO") {
        setBaseURI(baseURI);
    }
    ...
    function preSalemint(
        ...
        require(
            totalSupply() + quantity <= _TOTALSUPPLY,
    ...
    function mint(uint256 chosenAmount) public payable isSaleOpen {
        ...
        require(
            totalSupply() + chosenAmount <= _TOTALSUPPLY - reserve,
        ...
        require(
            chosenAmount <= maxQuantity,
            "Chosen Amount exceeds MaxQuantity"
        );
        require(
