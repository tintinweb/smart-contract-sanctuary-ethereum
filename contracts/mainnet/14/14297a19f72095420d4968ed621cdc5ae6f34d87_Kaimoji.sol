...
contract Kaimoji is ERC721A, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    string private baseURI = "https://gateway.pinata.cloud/ipfs/CID_HERE/";
    string public privateSigWord = "Kaimoji_PRIVATE";
    uint256 public maxSaleSupply = 5200;
    uint256 public maxRedeemSupply = 2500;
    uint256 public maxTeamSupply = 77;
    ...
    address public kaiWarrantContract = 0x89E331970dba855A8E5d86371C4c47bCf60aa4F5;
    address public privateSigner = 0x4651B58E2259437e6d1c51A064B351Ea2ebfBc7c;
    bool public publicLive;
    bool public privateLive;
    bool public redeemLive;
    mapping(address => uint256) public privateMinters;

    constructor() ERC721A("Kaimoji", "KAI") {}
    ...
    function redeem(address _to, uint256 tokenQuantity) external {
        require(redeemLive, "REDEEM_CLOSED");
        require(msg.sender == kaiWarrantContract, "INVALID_SENDER");
        require(
            redeemCounter + tokenQuantity <= maxRedeemSupply,
            "EXCEED_REDEEM_SUPPLY"
        );
        redeemCounter += tokenQuantity;
        _mint(_to, tokenQuantity);
    }
    ...
    function setRedeemMax(uint256 newCount) external onlyOwner {
        maxRedeemSupply = newCount;
    }
    ...
    function setKaiWArrantAddress(address newAddress) external onlyOwner {
        kaiWarrantContract = newAddress;
    }
    ...
    function withdraw() external onlyOwner {
        Address.sendValue(
            payable(0x62140D753E5a424d643921ac93cabfD1B743f390),
