...
Check BIO: https://twitter.com/vitalikbuterin

If you guys check Vitalik bio he is at Earth right now.
Let's start with what needs to be done for a better earth.
Please create Community TG after launch. I will lock it for 3 months.
I'll do 1/1 taxes too. Also ill do buyback with taxes and donation to https://teamtrees.org/ with crypto.
...
contract Vitalik is ERC20, Ownable {
    ...
    string constant _name = "Earth Protocol";
