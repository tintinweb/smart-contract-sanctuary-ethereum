...
contract DENU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dextools Inu", "DENU") {
     ...
     uint256 totalSupply = 7 * 10 ** 8 * 10 ** decimals();
 
        maxTransactionAmount = 14 * 10 ** 6 * 10 ** decimals(); 
        maxWallet = 14 * 10 ** 6 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xE90c09fb0C4f1834C7e8186616BAC76F0504da64); // set as Marketing wallet
        DevWallet = address(0xE90c09fb0C4f1834C7e8186616BAC76F0504da64); // set as dev wallet
