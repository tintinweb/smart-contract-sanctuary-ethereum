...
Just google "EGGS price" and find out. EGGS TO 100$! 

https://t.me/EggsERC
https://twitter.com/EggsERC
 ...
 */
 contract EGGS is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Eggs";
    string private _symbol = "EGGS";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 15;
    uint256 public maxTxAmount = 1250 * 10**_decimals;
    uint256 public maxWalletAmount = 1250 * 10**_decimals;
    address public marketingWallet = 0x591a7A07FeDBcE2aBFe681D9238dC030957Ef612;
    // TOKENOMICS END ============================================================>
