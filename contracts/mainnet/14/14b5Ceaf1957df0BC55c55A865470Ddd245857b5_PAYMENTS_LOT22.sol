...
contract PAYMENTS_LOT22 is Context, Ownable {
     ...
     */
    function resetSplit(address[] memory payees, uint256[] memory shares_) public onlyOwner {
        require(payees.length == shares_.length, "PaymentSplitter: payees and shares length mismatch");
        require(payees.length > 0, "PaymentSplitter: no payees");
...
/**
    ...
    payees[1] = 0xFc421B076C69Bb25b39733568D2a20d44AFada60; //SCOTT 38%
    payees[2] = 0xBf0717cF3fCc4aCDE0dE2cfEc37b08321AF6a508; //CARMEN 15%
    payees[3] = 0x39A251271EF453D19c4da34fAccb357F747Dd390; //PROJECT 20%
    payees[4] = 0x1BA3fe6311131A67d97f20162522490c3648F6e2; //Nate 5%
