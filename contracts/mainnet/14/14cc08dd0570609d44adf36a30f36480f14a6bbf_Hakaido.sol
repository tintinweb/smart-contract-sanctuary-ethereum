...
contract Hakaido is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCE5ca3BaA5a26934262a7f1Fa05d3D16d450c480); 
    address payable public Wallet_Dev = payable(0xCE5ca3BaA5a26934262a7f1Fa05d3D16d450c480);
    ...
    string private constant _name = "Hakaido"; 
    string private constant _symbol = unicode"KAIDO"; 
...
*/
  // https://web.wechat.com/HakaidoJPN
  
    constructor () {

        _owner = 0xCE5ca3BaA5a26934262a7f1Fa05d3D16d450c480;
