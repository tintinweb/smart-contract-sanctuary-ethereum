...
/**
Pentacles token on Ethereum Ecosystem provides you a vision on seeing the bigger picture,
 like a farmer planning for the future, he doesn't allow momentary fads or fancies to distract him, 
 and he doesn't take seriously those who do. One can sense his persistence and commitment; he is completely 
 responsible and even somewhat predictable with regard to his projects. He is as simple and profound
as the soil he cultivates and the flowers he adores.

https://medium.com/@PentaclesETH
*/
...
contract Pentacles is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB1Ca9Cc20A6A5B7dF655737cde9D2bA1137C8BE2;

    string private _name = "Knight of Pentacles";
    string private _symbol = "PENTACLES";
