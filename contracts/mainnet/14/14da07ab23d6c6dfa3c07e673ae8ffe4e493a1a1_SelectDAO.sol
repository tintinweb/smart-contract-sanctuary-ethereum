...
pragma solidity ^0.6.12;
    ...
    contract SelectDAO is Context, IERC20, Ownable {
        ...
        string private _name = 'Select DAO';
        string private _symbol = 'SELDAO';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xA6F176eC053688e8A4647bE158aDd61b1261321F, 'We can not exclude Uniswap router.');
