...
contract JerkOffInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Jerk Off Inu";
    string private constant _symbol = "JERKOFF";
    ...
    address payable private _opAddress = payable(0x32e1D0229FdEBba20279B5F7ffAd4Ad4a3CF3ff4);
