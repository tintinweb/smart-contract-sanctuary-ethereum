...
Telegram: https://t.me/HitoERC20

The first community token with 1% Buy and 1% sell after tax revert happens.



Token Name: Hibakusha Sabaiba
Symbol: 人 Hito
Supply: 650,000,000

Tokenomics: 7% Tax initial
First hour sell Tax 16% all goes to Marketing to pump funds for Dextools Social Fastrack Uploading
                           
Initial max buy:  13,000,000 (2% supply)
...
contract Hito is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hibakusha Sabaiba";
    string private constant _symbol = "Hito";
    ...
    uint256 private _tTotal = 650000000 * 10**9;
    uint256 private maxWalletAmount = 13000001 * 10**9;  
    uint256 private maxTxAmount = 13000001 * 10**9;      
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x1142020F04F040bB4F4d6C35b6eD00EC7c395cbC); 
        ...
        swapEnabled = true;
        tradingOpen = true;
        maxTxAmount = 13000001 * 10**9;
        maxWalletAmount = 13000001 * 10**9;
