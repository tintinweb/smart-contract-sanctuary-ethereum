...
contract ChocolateMonkeys is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    string internal baseuri = "ipfs://QmXs81N7dpaENn5Rq55JK3Tn2wkKA2puH6i233XQuSRgF2/";
    ...
    constructor() ERC721("Chocolate Monkeys", "CHOCO") {
        NFTPrice = 0.07 ether;                    
        NFTMaxSupply = 10000;
        mint(20);
        _pause();
