 ...
 * allowances. See {IERC20-approve}.
 */
contract MariaOzawa is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Maria Ozawa";
    string private _symbol = "Maria";
    ...
    address public marketingWallet = 0xA408b49F165fCB9450063DaEFf8A44F95bb1E868;
    // TOKENOMICS END ============================================================>
    ...
    function changeMaxTxAmount(uint256 _maxTxAmount)
        ...
        returns (bool)
    {
        require(_maxTxAmount > 0, "ERC20: maxTxAmount must be greater than 0");
    ...
    function changeMaxWalletAmount(uint256 _maxWalletAmount)
        ...
        returns (bool)
    {
        require(_maxWalletAmount > 0, "ERC20: maxWalletAmount must be greater than 0");
