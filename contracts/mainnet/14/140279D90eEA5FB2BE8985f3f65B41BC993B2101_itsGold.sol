...
/*
  ___   __   __    ____    ____  _  _  ____  _  _ 
 / __) /  \ (  )  (    \  (  _ \/ )( \/ ___)/ )( \
( (_ \(  O )/ (_/\ ) D (   )   /) \/ (\___ \) __ (
 \___/ \__/ \____/(____/  (__\_)\____/(____/\_)(_/
 */                                                                                                        

  contract itsGold is ERC721B, Ownable {
    ...
    constructor() ERC721B("itsGold", "GLD") {}
    ...
    function mintMultiplePublic(address to, uint256 quantity) external payable {
        ...
        require(
          ...
          "Only 10 mints per wallet, priced at 0.0005 eth"
        );
