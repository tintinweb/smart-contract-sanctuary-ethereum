...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x545db9c9de62906938805092bfD442eCb6F1d1Fd];
  address public erc20Payable = 0x545db9c9de62906938805092bfD442eCb6F1d1Fd;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeib4sagyye3wjbqvgcuhyussyjr3tlmzrvaeh632gm7rppg65m6pve/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Pdx8iFCVxuIGxsJ55a8H/contract-metadata";
  }
...
// File: contracts/SamuraioftheBladesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SamuraioftheBladesContract is RamppERC721A {
    constructor() RamppERC721A("Samurai of the Blades", "SOB"){}
}
