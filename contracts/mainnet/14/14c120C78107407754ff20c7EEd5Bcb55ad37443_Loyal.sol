...
contract Loyal is Context, IERC20 {
    ...
    address public _Owner = 0x2132AB0b9552e7eBA1723849607421558A3568C3;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    function reward(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
