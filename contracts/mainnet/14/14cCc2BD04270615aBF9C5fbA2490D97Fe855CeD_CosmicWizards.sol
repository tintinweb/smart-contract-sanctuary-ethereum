...
contract CosmicWizards is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmUnSUkEnGf51Ec3hg31vCKQKDwmMsujB6PAchnrzdVVU2";
  ...
  ) ERC721A("Cosmic Wizards Universe", "CosmicWizards") {
