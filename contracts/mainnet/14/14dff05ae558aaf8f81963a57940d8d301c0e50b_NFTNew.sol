...
contract NFTNew is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Imaginary Ones NFT Collection", "IO") {
    setHiddenMetadataUri("ipfs://QmTD3jxpF1pSXpVfRYhTGYb7QS4ngSjfsayNEBcfDSaCc6/hidden.json");
  }
