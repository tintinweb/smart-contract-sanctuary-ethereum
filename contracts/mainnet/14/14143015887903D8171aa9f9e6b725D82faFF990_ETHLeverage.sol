...
contract ETHLeverage is OwnableUpgradeable, ISubStrategy, IETHLeverage {
     ...
     */
    function loanFallback(uint256 loanAmt, uint256 feeAmt) external override onlyReceiver {
        require(curState != SSState.Normal, "NORMAL_STATE_CANT_CALL_THIS");
        require(IERC20(weth).balanceOf(address(this)) >= loanAmt, "INSUFFICIENT_TRANSFERED");
    ...
    */
     ...
     */
    function deposit(uint256 _amount) external override onlyController onDeposit returns (uint256) {
