    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721AUpgradeable_init("Heartbreak Bear Gen 2", "HBB2");
        ...
        unrevealedUrl = "https://ipfs.io/ipfs/QmPESZNvFGtdh7ziERcEcPPSZuaZCNyTubAhSSZjqnAqcw/Unrevealed.json";
    }
    ...
    function setSaleActive() external onlyRole(CONTRACT_ADMIN_ROLE) {
        deactivateAllowList();
        saleActive = true;
        TOTAL_MINTABLE_AMOUNT = 10;
        PRICE_PER_TOKEN = 0.049 ether;
    }
    ...
    function setAllowListActive() external onlyRole(CONTRACT_ADMIN_ROLE) {
        ...
        TOTAL_MINTABLE_AMOUNT = 3;
        PRICE_PER_TOKEN = 0.045 ether;
    }
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        for (uint256 i = 0; i < users.length; i++) {
            require(
                totalSupply() + numberOfTokens[i] < MAX_SUPPLY,
                "Purchase would exceed max tokens"
            );
