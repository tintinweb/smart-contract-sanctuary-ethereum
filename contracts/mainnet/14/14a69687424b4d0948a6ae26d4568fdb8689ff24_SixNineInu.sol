...
// Main Contract Logic 
// --------------------------------------------------------------
contract SixNineInu is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "6ix9ine Inu";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xF3435BccaBa0500DA665a0317C06882f363B2259);
    address payable public operationsWallet =  payable(0xF3435BccaBa0500DA665a0317C06882f363B2259);
    ...
    uint256 public operationsFeeSell = 44;
