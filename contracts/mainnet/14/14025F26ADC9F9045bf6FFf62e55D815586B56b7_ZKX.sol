...
contract ZKX is ERC20, Ownable {
    ...
    address payable marketingWallet = payable(address(0x1513ac6099f49eE8980e5d75aB03c7203D19f944)); // marketingWallet to receive ETH
    ...
    constructor() ERC20("ZKExchange", "ZKX") {
    ...
    require(newAddress != address(uniswapV2Router), "ZKX: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded,"ZKX: Account is already the value of excluded");
   ...
   function enableTrading() external onlyOwner {
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "ZKX: The uniswap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "ZKX: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
