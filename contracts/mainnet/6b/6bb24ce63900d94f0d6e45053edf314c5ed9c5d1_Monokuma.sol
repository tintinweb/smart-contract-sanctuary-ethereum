...
contract Monokuma is ERC20, Ownable {
    ...
    constructor() ERC20("Monokuma", "Monokuma") {
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 3, "Buy fee can not be set higher than 3%");
        buyFee = _fee;
    }

    function updateSellFee(uint256 _fee) external onlyOwner {
        require(_fee <= 3, "Sell fee can not be set higher than 3%");
        sellFee = _fee;
    }
