 ...
 * @notice This contract handles minting Blue chip Bots tokens.
 */
contract BlueChipBots is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xe3eaDE2A47B37a202764de6301C920904C35144B;
    address public royaltyAddress = 0xb8C4b842C122BE6DaE95D25bee048d94812855AA;
    address[] public payoutAddresses = [
        0xb8C4b842C122BE6DaE95D25bee048d94812855AA
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibdxwhsetiuhbkvnynzgjpo6uhvuwqumyngjzm6wfvfda5zlqfd3q/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 606;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 606;
    uint256 public presaleMintsAllowedPerAddress = 606;
    uint256 public presaleMintsAllowedPerTransaction = 606;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 606;
    uint256 public publicMintsAllowedPerTransaction = 606;
    ...
    constructor() ERC721A("Blue chip Bots", "BCB") {
