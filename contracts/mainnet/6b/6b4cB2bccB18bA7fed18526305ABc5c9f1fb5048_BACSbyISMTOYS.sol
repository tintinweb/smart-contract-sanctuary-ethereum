...
contract BACSbyISMTOYS is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 0.16 ether;
    uint256 private whitelistCost = 0.16 ether;
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("The Bored Ape Chess Set by IsmToys", "BACS")
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 399) revert SoldOut();
