...
contract X is Context, IERC20, Ownable {
    ...
    string private _name = "Xen Project";
    ...
    address public marketingTokenFeeWallet = 0xbbb5003c3f9e0937220c2Fd2d1b291D603C3D0D2;
    address public marketingETHFeeWallet = 0xbbb5003c3f9e0937220c2Fd2d1b291D603C3D0D2;
    ...
    uint256 public _maxWallet = 3 * 10**10 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 1 * 10**10 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
