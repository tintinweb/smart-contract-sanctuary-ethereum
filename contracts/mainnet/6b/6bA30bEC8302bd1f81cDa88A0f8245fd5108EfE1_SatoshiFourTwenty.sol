...
/**
Satoshi420 A meme token Decentralized Ecosystem for the community on ERC20

A community owned, fully decentralized and has a mission to bring popular crypto concepts into the mainstream in the future. 
Our enthusiast volunteers are welcome to embrace diverse perspectives to build Satoshi420 into the best community in crypto.

TAX: 3%
-2% Marketing
1% Liquidity 

TELEGRAM - https://t.me/Satoshi420ERC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69D84bB362B2E2dd29e061042173A346955BceC8;
...
contract SatoshiFourTwenty is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x69D84bB362B2E2dd29e061042173A346955BceC8);
    ...
    */
    ...
    string private _name = "Satoshi FourTwenty"; 
    string private _symbol = "$Satoshi420";  
    ...
    */
    ...
    function tradingStatus(bool true_or_false) public onlyOwner {
    ...
    */
    ...
    // Default is true
    function setsellfee(bool true_or_false, uint256 _uint) external onlyOwner {
