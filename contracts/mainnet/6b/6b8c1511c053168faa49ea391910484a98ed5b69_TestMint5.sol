...
contract TestMint5 is ERC721A, Ownable, ReentrancyGuard, Pausable{

    // uint256 mint variables
    uint256 public maxSupply = 2499;
    ...
    function whitelistMint(uint256 _quantity, bytes32[] memory proof) external payable whenNotPaused nonReentrant {
        ...
        if (totalFreeMints[msg.sender] == 0 && freeMax <= 3) {
            require(freeMax <= 3, "No more free apes left!");
