...
contract AikenInu is ERC20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() ERC20("Aiken Inu", "KEN") { // 
        marketingWallet = payable(0x2cB431E26B639864a5E54c7af4EeaD65A9d3B450); // 
        devWallet = payable(0x2cB431E26B639864a5E54c7af4EeaD65A9d3B450); // 
