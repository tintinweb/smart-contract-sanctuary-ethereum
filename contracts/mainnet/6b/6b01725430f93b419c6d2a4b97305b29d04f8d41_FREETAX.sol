...
Will be properly renounced and fully locked on team.finance
...
Good Vibes Only. Twitter will be out with the name : @FreeTaxERC for more official informations.

At launch : 
Max tx : 1%, will be auto removed. 
Max wallet : 3%
...
contract FREETAX is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"FreeTax"; ////
    string public constant symbol = unicode"FREETAX"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 10000 * 10**9; // 1% for the first 5 min
