...
contract PLSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Pulse Shib";
    string private constant _symbol = "PLSHIB";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; //1
    uint256 public _maxWalletSize = 80000000 * 10**9; //1
