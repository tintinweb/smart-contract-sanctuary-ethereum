...
contract GeorgeWashington is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'President George Washington';
    string private constant _symbol = 'GEORGE';
    ...
    address internal constant development_receiver = 0xcd034E9F8B91F4c2a35ed3c317d48687d3ff5bbC; 
    address internal constant marketing_receiver = 0xcd034E9F8B91F4c2a35ed3c317d48687d3ff5bbC;
    address internal constant liquidity_receiver = 0xcd034E9F8B91F4c2a35ed3c317d48687d3ff5bbC;
    ...
    function Fee(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
    ...
    function Wallet(uint256 _buy, uint256 _trans, uint256 _wallet) external onlyOwner {
