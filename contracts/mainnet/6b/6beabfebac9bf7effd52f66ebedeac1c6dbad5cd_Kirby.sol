...
//*Twitter: https://twitter.com/kirby_tw
//*Telegram: https://t.me/kirbymooneth
...
contract Kirby is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xC37Ed2286cF3e07f6c10a932d018A109EEBc4326);
    address payable private _marketingAddress = payable(0xC37Ed2286cF3e07f6c10a932d018A109EEBc4326);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(redisFeeOnSell < 7, "Redis cannot be more than 6.");
