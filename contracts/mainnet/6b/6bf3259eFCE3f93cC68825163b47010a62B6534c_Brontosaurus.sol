...
Telegram: https://t.me/brontosaurus_erc
Twitter: https://twitter.com/BrontosaurusErc
...
contract Brontosaurus is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Brontosaurus", "$BRONTO") {

        address _owner = 0xfDE1EF055364e0AaC6B82edDd8C81bC48BfC51c2;
        ...
        marketingWallet = address(0xfDE1EF055364e0AaC6B82edDd8C81bC48BfC51c2); // set as marketing wallet
        devWallet = address(0xfDE1EF055364e0AaC6B82edDd8C81bC48BfC51c2); // set as dev wallet
        buyBackWallet = address(0xfDE1EF055364e0AaC6B82edDd8C81bC48BfC51c2); // set as buyBackWallet
