...
contract SOLGROW is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "SOLGROW";
    string private constant tokenSymbol = "SOLGROW";
    ...
    constructor() payable {
        ...
        maxWallet = tokenSupply.mul(15).div(100);
        minTaxSwap = tokenSupply.mul(5).div(10000);

        marketingAddress = payable(0x88ECDC68049a284f185904654EC762e5C2E4Eb99);
        devAddress = payable(0x88ECDC68049a284f185904654EC762e5C2E4Eb99);
