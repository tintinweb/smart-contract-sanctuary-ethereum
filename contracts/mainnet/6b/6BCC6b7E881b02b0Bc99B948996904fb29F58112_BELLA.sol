...
/**
Given the atmosphere of the meme coin space on ethereum for 2023 $BELLA has decided to take its place.
Providing multiple avenues for a strong ecosystem $BELLA has decided it will set the standards for a low market cap coin. 


TELEGRAM: T.me/BellaErc

Twitter: twitter.com/BellaERC

Website: https://bellaerc.com/

Medium medium.com/@bellaerc20/a-very-special-meme-coin-361329c50f26
...
contract BELLA is Context, IERC20, Ownable {
    ...
    string private _name ="Bella Inu";
    string private _symbol = "BELLA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x71D0e6D721A7D740b66B1a8E1A2d1107E3AA02f7);
    address payable private taxWallet2 = payable(0x71D0e6D721A7D740b66B1a8E1A2d1107E3AA02f7);
