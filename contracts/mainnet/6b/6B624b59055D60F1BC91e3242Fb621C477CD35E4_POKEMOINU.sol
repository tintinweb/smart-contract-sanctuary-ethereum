...
contract POKEMOINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POKEMO INU";
    string private _symbol = "$POKEMO";
    ...
    uint256 public _maxTxAmount = 4000000 * 10**_decimals;  // max buy 4% at launch 
    address payable public marketingwallet = payable(0xEf16A1827df546040c86Ac2F7525589dc8309Cf4);
    ...
    //transfer Ownership to deadwallet(0x000000000000000000000000000000000000dEaD)
