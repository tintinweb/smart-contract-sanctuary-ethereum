...
https://medium.com/@Maneki--Neko

$Maneki-neko is a token that is going to bring luck and fortune to everyone token holder!
...
contract JapeneseLuckyCat is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Japense Lucky Cat";
    string private constant _symbol = "Maneki-Neko";
