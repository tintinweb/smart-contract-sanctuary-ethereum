...
Simple Rules for Huge Gains:

Visit our website, follow the rules for a perfect raid, 
onboard new people and tell them to do the same. 
If we all cooperate as a strong community, 1M mcap will be only FUD. Lfg wagmi.
 Working on 'Raid to Earn' feature!
...
Social Links:
TG: https://t.me/raidprotocolportal
*/
...
contract RaidProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Raid Protocol", "RAID") {
        ...
        marketingWallet = address(0x089574723c40de68A4E3697CeFDC595321aB70CC);
