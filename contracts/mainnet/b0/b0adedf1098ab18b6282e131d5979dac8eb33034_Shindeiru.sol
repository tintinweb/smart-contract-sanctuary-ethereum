...
contract Shindeiru is Context, IERC20, Ownable {
    ...
    string private constant _name = "Omae Wa Mou";
    string private constant _symbol = "SHINDEIRU";
    ...
    constructor () {
        _feeAddrWallet = payable (0x11486132EEecA21889434DFD316ccFDC8F2d04B9);
