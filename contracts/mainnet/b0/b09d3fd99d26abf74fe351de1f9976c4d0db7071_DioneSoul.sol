...
/*
DIONE SOUL IS A CRYPTO TOKEN ON THE ETHEREUM SMARTCHAIN ALSO OFFERING UNIQUE NFTS AND FARMING CAPABILITIES
Become a soulkeepers with us.

TAX
8% COLLECTED ON TAX WILL BE DISTRIBUTED AS 
...
contract DioneSoul is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x0C55e36b52E7611D861A5CeBcC0E0f39426161Cd));

    string private _name = "The Beauty";
    string private _symbol = "DioneSoul";
