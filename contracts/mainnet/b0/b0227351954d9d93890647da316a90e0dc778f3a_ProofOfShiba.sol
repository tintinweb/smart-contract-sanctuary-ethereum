...
contract ProofOfShiba is ERC20, Ownable {
    ...
    constructor() ERC20("Proof Of Shiba", "POS") {
        ...
        _maxTransactionAmount = TOTAL_SUPPLY * 1 / 100;
        _maxWallet = TOTAL_SUPPLY * 2 / 100;
        _swapTokensAtAmount = TOTAL_SUPPLY * 1 / 1000;
        ...
        marketingWallet = address(0xe91c2B97201C124A5a3834f59CB0b2Cf1bF9BdaB);
