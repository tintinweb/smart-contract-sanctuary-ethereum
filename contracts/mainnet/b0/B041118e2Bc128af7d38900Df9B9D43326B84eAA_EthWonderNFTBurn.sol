...
// File: contracts/ethNftBurn/NFTBurnAccessControl.sol

pragma solidity ^0.8.0;


abstract contract NftBurnAccessControl is AccessControl {
    ...
    modifier whenNotPaused() {
        require(!isPaused, "Wonder Game Character Inventory Burn is paused");
        _;
    }
...
// File: contracts/interfaces/IWonderGameCharacterInventory.sol
...
// File: contracts/ethNftBurn/EthWonderNFTBurn.sol
    ...
    NftBurnAccessControl
{
    ...
    function onERC721Received(
        ...
        require(
            ...
            "Direct transfer to contract not allowed"
        );
    ...
    function burnTokens(uint256[] memory tokenIds) public whenNotPaused {
        ...
        for (uint256 i; i < totalTokens; i++) {
            ...
            require(wonderGame.ownerOf(token) == owner, "Only owner can burn");
