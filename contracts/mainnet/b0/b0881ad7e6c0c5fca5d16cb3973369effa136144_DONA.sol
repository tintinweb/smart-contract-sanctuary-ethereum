...
contract DONA is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Dogeana";
    ...
    address payable private _developmentAddress = payable(0x57F537D4d4be432e31c241C08F30d66AA7B8a2B3);
    address payable private _marketingAddress = payable(0x57F537D4d4be432e31c241C08F30d66AA7B8a2B3);
