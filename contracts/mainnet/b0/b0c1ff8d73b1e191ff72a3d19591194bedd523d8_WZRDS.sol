...
// Website: wzrds.wtf
// Twitter: https://twitter.com/WZRDSxyz
// Supply: 10,000 NFTs
// Total FREE: 5000
// Rest for 0.005 ETH
// Max 2 per tx during free mint and 5 during paid mint
...
contract WZRDS is ERC721A, Ownable, ReentrancyGuard {

  uint public price = 0.005 ether;
  uint public maxPerTx = 5;
  uint public maxPerTxDuringFree = 2;
  ...
  constructor() ERC721A("WZRDS", "WZRDS"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    if(totalSupply() + amount < totalFree + 1) {
      cost = 0;
      require(amount < maxPerTxDuringFree + 1, "Max per TX reached");
    }
    require(mintEnabled, "Minting is not live yet, hold on WZRD");
    require(totalSupply() + amount < maxSupply + 1,"No more WZRDS");
