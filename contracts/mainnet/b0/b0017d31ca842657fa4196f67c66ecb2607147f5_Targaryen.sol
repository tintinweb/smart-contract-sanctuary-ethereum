...
contract Targaryen is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Fable of Targaryen";
    string private constant _symbol = "Targaryen";
