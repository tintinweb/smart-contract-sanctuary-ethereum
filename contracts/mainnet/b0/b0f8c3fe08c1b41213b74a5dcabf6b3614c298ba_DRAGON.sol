...
contract DRAGON is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Ryuu";
    string private _symbol = "RYUU";
    uint8 private _decimals = 9;
    uint256 private _supply = 120000;
    uint256 public taxForLiquidity = 2;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 1200 * 10**_decimals;
    uint256 public maxWalletAmount = 1200 * 10**_decimals;
    address public marketingWallet = 0x41BbD00274a0dE8ff97C89Bf1d0167e3CbfDF57d;
    // TOKENOMICS END ============================================================>
