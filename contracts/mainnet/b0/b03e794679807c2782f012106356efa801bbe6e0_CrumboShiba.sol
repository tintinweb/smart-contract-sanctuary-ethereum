...
contract CrumboShiba is ERC20, Ownable {
    ...
    constructor() ERC20("Crumbo Shiba", "CRSH") {
        ...
        maxTransactionAmount = 25000000 * 1e18; // 2.5% from total supply maxTransactionAmountTxn
        maxWallet = 35000000 * 1e18; // 3.5% from total supply maxWallet
		...
		charityWallet = address(0x5D5323C56eFC8a48DEBBDb79FEC4babc74a9b4Ab); // set as charity wallet
        marketingWallet = address(0x5D5323C56eFC8a48DEBBDb79FEC4babc74a9b4Ab); // set as marketing wallet
        devWallet = address(0x5D5323C56eFC8a48DEBBDb79FEC4babc74a9b4Ab); // set as dev wallet
