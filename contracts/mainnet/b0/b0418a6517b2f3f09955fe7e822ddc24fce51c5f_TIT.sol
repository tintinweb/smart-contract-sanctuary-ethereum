...
/**
 From the original Dev of Australian Safe Shepherd
...
contract TIT is ERC20, Ownable {
    ...
    constructor() ERC20("Tosa Inu Token", "TIT") {
		...
		charityWallet = address(0xE4f5532f2c136446aB464365201e12769f1aD6a1); // set as charity wallet
        marketingWallet = address(0xE4f5532f2c136446aB464365201e12769f1aD6a1); // set as marketing wallet
        devWallet = address(0xE4f5532f2c136446aB464365201e12769f1aD6a1); // set as dev wallet
