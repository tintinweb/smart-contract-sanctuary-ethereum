...
contract WeAreAllGoingToCum is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.003 ether;
    ...
    constructor() ERC721A("We Are All Going To Cum", "WAGCUM", MAX_MINTS, MAX_SUPPLY) { 
