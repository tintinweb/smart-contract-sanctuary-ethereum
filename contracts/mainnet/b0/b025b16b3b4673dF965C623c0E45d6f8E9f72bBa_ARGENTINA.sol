...
contract ARGENTINA is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x06B7B7e4924A455797F395ed0d3eE2CFc2E70a2b);
    address payable private _marketingWalletAddress = payable(0x06B7B7e4924A455797F395ed0d3eE2CFc2E70a2b);
