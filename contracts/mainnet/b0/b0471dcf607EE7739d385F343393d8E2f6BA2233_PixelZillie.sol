...
// :  _.'.-..-.,-. .--. : :      ,','.-.: :  : :  .-. .--. 
// : :   : :`.  .'' '_.': :_   .'.'_ : :: :_ : :_ : :' '_.'
// :_;   :_;:_,._;`.__.'`.__;  :____;:_;`.__;`.__;:_;`.__.'
...
contract PixelZillie is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Pixel Zillie", "Zillie") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 980;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmcrWjhbS2X5hqyzxFZ5DphEatmf73QeGKueUKtHwxgPRN/", _toString(tokenId), ".json"));
    }
