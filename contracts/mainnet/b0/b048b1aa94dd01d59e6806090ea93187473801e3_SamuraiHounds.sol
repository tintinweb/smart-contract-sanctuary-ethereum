...
contract SamuraiHounds is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiggz7junhqmgnhsvmbtbsvjaxsnpqfc3muy4klcmqcero2i6k6w7a/", Strings.toString(tokenId), ".json")
            );
    }
