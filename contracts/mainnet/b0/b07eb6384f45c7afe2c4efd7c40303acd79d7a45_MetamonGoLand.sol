...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract MetamonGoLand   is ERC721Enumerable,  Ownable {
    using Strings for uint256;


  string private uriPrefix = "";
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmR8kGw6oZUQ71yWTPY6ZPYAbVJqdq7s9sui5RqNKxAyLW";
  ...
  uint16 public maxNFTPerWallet = 250;  
  ...
  constructor() ERC721("Metamon Go Land  ", "Mtmngl") {
    
  }
  function publicSale(uint16 _mintAmount) external payable  {
...
function preSale(uint16 _mintAmount , bytes32[] calldata merkleProof) external payable  {
  ...
  function setNFTPerWallet(uint8 _limit) external onlyOwner{
