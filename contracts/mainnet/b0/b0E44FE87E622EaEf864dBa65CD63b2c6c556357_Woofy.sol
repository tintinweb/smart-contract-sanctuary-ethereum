...
contract Woofy is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xF486BA487fa5db96E7BC6366F92a188C55b06327); 
    address payable private _marketingAddress = payable(0xF486BA487fa5db96E7BC6366F92a188C55b06327);
