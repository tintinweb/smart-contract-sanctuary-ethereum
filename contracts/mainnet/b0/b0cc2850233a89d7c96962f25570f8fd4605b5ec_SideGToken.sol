...
contract SideGToken is ERC20, Ownable {
    ...
    address payable public  marketingWallet = payable(0x1166236991F0717767A20677b5e5125Ba3bef587);
    ...
    constructor(address _owner) ERC20("Side G Token", "SGT") {
