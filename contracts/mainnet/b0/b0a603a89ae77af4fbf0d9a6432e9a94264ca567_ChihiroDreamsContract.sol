...
//*********************************************************************//
//
//    ________    _ __    _               ____                                
//   / ____/ /_  (_) /_  (_)________     / __ \________  ____ _____ ___  _____
//  / /   / __ \/ / __ \/ / ___/ __ \   / / / / ___/ _ \/ __ `/ __ `__ \/ ___/
// / /___/ / / / / / / / / /  / /_/ /  / /_/ / /  /  __/ /_/ / / / / / (__  ) 
// \____/_/ /_/_/_/ /_/_/_/   \____/  /_____/_/   \___/\__,_/_/ /_/ /_/____/  
//                                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeA4f71BEa07730Ac076f381f2FF2F7FEd42aFC10];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmemnp2iAisnRgauwHbkauBLvvdj4HLeHUk1X926JiauNg/";
...
// File: contracts/ChihiroDreamsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChihiroDreamsContract is RamppERC721A {
    constructor() RamppERC721A("Chihiro Dreams", "CHIRO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/l45J51bmgLU492oxhOAX/contract-metadata";
    }
}
