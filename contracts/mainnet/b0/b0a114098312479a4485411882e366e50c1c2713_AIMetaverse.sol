...
contract AIMetaverse is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbkKPpVd5HxoMkuU8zDdCoL8e2iJeYmcjsg1bnxcnuajK";
    ...
    constructor(
    ) ERC721A("AIMetaverse", "AIM", 100, maxSupply) {
    }
