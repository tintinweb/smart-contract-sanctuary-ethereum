...
/**
$implify, The simplest of new era blockchains with the "$imple" web app coming out 3rd of September 2022!!!
The app will have simple, user friendly courses for making money trough crypto in a lot of different ways.

We simplify everything we can for who it really matters.. 
The community! It's so simple that we have no logo, our community will create one.
So simple that the CA will be renounced so we can own it!

The dev will be in contact with us only trough the blockchain.
 It's so simple that all you need to do is hold and trust the dev that's helping expend our community. 

We simplify, We unify!
*/
...
contract $implify is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "$implify";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$implify";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xc2e366C0Bd7800bAcd59eb138a9cE29050e34F22;
        marketingFeeReceiver = 0xc2e366C0Bd7800bAcd59eb138a9cE29050e34F22;
