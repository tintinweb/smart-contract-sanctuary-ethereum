...
contract Drogens is Context, IERC20, Ownable {
    ...
    string private constant _name = "Drogens"; // 
    string private constant _symbol = unicode" DROGE"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x5F073261E12DddA41825862C5C61861cB4C378b5).transfer(ethToSend); //marketing wallet
    }
