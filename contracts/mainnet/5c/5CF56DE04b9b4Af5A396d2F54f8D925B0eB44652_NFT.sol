    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize(
        ...
        __ERC721_init("Plus Are Apepes", "PRAYC");
    ...
    function mint(address _recipient) external onlyRole(ROLE_MINTER) {
    ...
    function setRoyaltyInfo(address receiver, uint96 feeBasisPoints) external restricted {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlUpgradeable, ERC2981Upgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable)
        returns (bool)
    {
