...
/**
Website: badsanta.live
Telegram: t.me/badsantaentry
medium.com/@badsantaerc
*/
...
contract BadSanta  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**3* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'Santa';
    string private _symbol = 'BAD';
