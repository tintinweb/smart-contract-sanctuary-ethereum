...
Direct link to the cryptography subsection:

https://t.co/HJWAH9KSPu
...
contract Cryptography is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cryptography";
    string private constant _symbol = unicode"CRYPTOG";
