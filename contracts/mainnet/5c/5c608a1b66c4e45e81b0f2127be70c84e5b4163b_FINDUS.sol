...
/*
"Finding the wealth of mental battle" According to the end of the puzzle, you will get into the TG and click on the reward distribution website to divide up the huge reward.
...
The top 10 holders who buy $Findus will be rewarded with ETH for holding the same value of $Findus, 11-50 holders will be rewarded with ETH for 70%, 51-100 holders will be rewarded with ETH for 30%, 101-200 holders will receive ETH rewards for holding 10% of the value of $Findus.
The amount of the reward will be based on the following rules. The earlier you buy, the more portions you get.
We want you all to find your potential, and you are the answer. Release yourself, please go to our website to submit your evaluation of yourself, we will publish these words on the website and burn them on NFT, distribute them to you for free, this is also an incentive.
Of course, our web is hidden and you need to find the answer in the picture of this tweet (https://twitter.com/finduseth/status/1546402586055438337?s=21). It's not just about finding the answer but also finding your soul. Please find more information, we will wait for you at TG, there will be unexpected surprises.
https://twitter.com/finduseth
*/
...
contract FINDUS is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Find Us';
    string private constant _symbol = 'FINDUS';
    ...
    //DevWallets
    address public Development=payable(0x00F4eEB8700E9E3fFFE071FBaCa454f9b98c6049);
    address public Marketing=payable(0x987a1C35Ad45776CbebdCA787ecaEdf82B950732);
    //MainNet
