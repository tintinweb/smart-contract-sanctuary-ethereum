...
/*
	    *******************************************************
		******** SOLA ********* Forget LUNA and ape SOLA ******
		******** Supply: 4,000,000 ****** Max Tx: 40,000 ******
		******** TG: https://t.me/terrasola ***** Tax: 10% ****
        *******************************************************
 		*******************************************************
**/
...
contract Sola is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 4000000 * 10**8;
	string private constant _name = "Sola";
	string private constant _symbol = "SOLA";
