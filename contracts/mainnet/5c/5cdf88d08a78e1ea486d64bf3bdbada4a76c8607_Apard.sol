...
It's okay to be separated. Parents spread that part of the sofa to yours.
 It's not so convenient for your mother to say that you don't have a fever.
$Apard
*/
...
pragma solidity 0.8.8;
contract Apard is Context, IERC20, Ownable {
    ...
    string private constant _name = "Apard Token";
    string private constant _symbol = "Apard";
