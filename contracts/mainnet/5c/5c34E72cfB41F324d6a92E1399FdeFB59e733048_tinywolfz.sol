...
contract tinywolfz is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("tiny wolfz", "wolfz") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmaqWnxoeQnAWd7448paQfgCeVLAsLcgMWcVBnkDkBhiMa/", _toString(tokenId), ".json"));
    }
