...
contract DALC_NFT is ERC721A, Ownable {
    ...
    address[] public owners = [0x9cB4938391b02da0B199c05f513F42b76f689Cf1, 0x31B1a530A4c399e9dE9Ed90FCFc33FC85bb66fd4, 0x889cc146F43c914ebb0778C9d36340e777C9747f];

    constructor(string memory _initBaseURI, string memory _initUnrevURI)
        ERC721A("Deaded Anatomy Lion Club", "DALC")
        {
    ...
    function ownerMint(address _to, uint _amount) public {
    ...
    function withdraw() public payable {
        uint share1 = address(this).balance * 45 / 100;
        uint share2 = address(this).balance * 25 / 100;

        payable(owners[0]).transfer(share1);
        payable(owners[1]).transfer(share2);
        payable(owners[2]).transfer(address(this).balance);
    }
}