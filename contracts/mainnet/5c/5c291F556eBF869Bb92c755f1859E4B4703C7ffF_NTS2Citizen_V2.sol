    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getIdentityIdOfTokenId(
        ...
        if (citizen.flags != 0) {
            return NTS2Citizen_V2(v1Contract).getIdentityIdOfTokenId(citizenId);
        }
    ...
    function getItemCacheIdOfTokenId(
        ...
        CitizenData storage citizen = citizenData[citizenId];
        if (citizen.flags != 0) {
            return NTS2Citizen_V2(v1Contract).getItemCacheIdOfTokenId(citizenId);
        }
    ...
    function getLandDeedIdOfTokenId(
        ...
        CitizenData storage citizen = citizenData[citizenId];
        if (citizen.flags != 0) {
            return NTS2Citizen_V2(v1Contract).getLandDeedIdOfTokenId(citizenId);
        }
    ...
    function getSpecialMessageOfTokenId(
        ...
        if (hasFlag(citizen.flags, SPECIAL_MESSAGE_UPDATED)) {
            ...
            return
                NTS2Citizen_V2(config.findComponent(NTComponent.S2_CITIZEN,false)).getSpecialMessageOfTokenId(citizenId);
        } else {
            return _specialMessageByCitizenId[citizenId];
        }
    }
    ...
    function migrateAsset(
        ...
        NTS2Citizen_V2 oldContract = NTS2Citizen_V2(
    ...
    function _unmintedDisassemble(uint256 citizenId) private {
        NTS2Citizen_V2 v2Citizen = NTS2Citizen_V2(
            config.findComponent(NTComponent.S2_CITIZEN, false)
        );
    ...
    function setCurrentId(uint16 currentId_) external onlyOwner {
        require(currentId_ > currentId, "New index needs to be greater than the old index");
        currentId = currentId_;
    }
}
