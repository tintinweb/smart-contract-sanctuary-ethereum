...
contract ArabianEaster is Context, IERC20, Ownable {
	...
	string private constant _name = " Arabian Easter  ";
	string private constant _symbol = "AEASTER";
