...
abstract contract Ownable is Context {
    ...
    contract Lil13s is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmRaNKCQFJZg44MkMYMDLcmqxf87DBnhpXtn9N1tLThFms/" ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmZMvM4JbrrSrbAZp1MqojhjTaw57APmowSLAypnxQdzFF";
  ...
  uint16 public constant maxSupply = 1313;
  ...
  constructor() ERC721A("Lil13s", "L13") {
  }
  ...
  function mint(uint8 _mintAmount) external payable  {
    ...
    require(nft + _mintAmount <= maxMintAmountPerWallet, "Exceeds max nft limit per wallet.");
