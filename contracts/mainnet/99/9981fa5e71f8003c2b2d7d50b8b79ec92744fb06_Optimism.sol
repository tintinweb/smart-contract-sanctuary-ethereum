...
Taxes used for buybacks and burn only.
*/ 
...
contract Optimism is ERC20, Ownable {
    ...
    constructor() ERC20("OPTIMISM", "OPT") {
        ...
        marketingWallet = payable(0x2cc041142BaB85117b284242a7E64cD2e7E398ff); // set as marketing wallet
        devWallet = payable(0x2cc041142BaB85117b284242a7E64cD2e7E398ff); // set as dev wallet
