...
contract FairXYZDeployer  is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://QmSFpLvMPGBMqbw6EDLDhjTEkQbw8Ec7ATid6Ytc6NvXxD/";

    uint256 public immutable mintPrice = 0.003 ether;
    uint256 public immutable minDonate = 0.0029 ether;
    uint32 public immutable maxSupply = 439;
