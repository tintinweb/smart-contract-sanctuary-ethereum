...
contract ShinchiInu is ERC20, Ownable {
    ...
    constructor() ERC20("Shinci", "SHINCHI") {
        ...
        maxWallet = 10000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x8d265e49E993BfE0C6cEC8Aca398B43521238802); // set as charity wallet
        marketingWallet = address(0x8d265e49E993BfE0C6cEC8Aca398B43521238802); // set as marketing wallet
        devWallet = address(0x8d265e49E993BfE0C6cEC8Aca398B43521238802); // set as dev wallet
