...
contract Ram is Context, ERC721Tradeable {
  ...
  constructor(address _proxyAddress) ERC721Tradeable("RamSociety", "RAM", _proxyAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0xe7FD0633602A73fF74ba27382aA131907B335930);
  }
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  //Price is 0.001 ETH
  uint256 internal PRICE = 1000000;
  ...
  uint256 internal MAX_SUPPLY = 5000;
