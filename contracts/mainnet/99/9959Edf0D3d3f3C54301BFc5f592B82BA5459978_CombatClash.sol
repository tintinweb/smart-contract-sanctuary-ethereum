...
contract CombatClash is Context, IERC20, Ownable {
    ...
    string private constant _name = "Combat Clash";
    string private constant _symbol = "CLASH";
    ...
    constructor(address payable _marketingWallet, address payable _prizePoolWallet) {
        ...
        excludeFromReward(prizePoolWallet);
