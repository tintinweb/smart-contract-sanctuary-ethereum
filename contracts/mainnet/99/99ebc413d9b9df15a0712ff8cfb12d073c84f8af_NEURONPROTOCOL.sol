...
contract NEURONPROTOCOL is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "NEURON PROTOCOL";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x05846216F01b99300CB6De4180f1B718dC6f0acB);
