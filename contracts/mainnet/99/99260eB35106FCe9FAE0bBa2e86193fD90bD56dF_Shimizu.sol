...
contract Shimizu is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Shimizu";
    string public _symbol= "SHIZU";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x1A30C520Ce49A9CA62F652B79027A3C26B9b8d1A);
