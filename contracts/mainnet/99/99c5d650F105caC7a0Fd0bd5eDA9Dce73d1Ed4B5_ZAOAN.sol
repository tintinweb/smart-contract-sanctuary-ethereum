...
/**
"Zǎo ān" is often considered more polite and respectful than "nǐ hǎo." While both greetings are generally polite, "zǎo ān" showcases a 
higher level of thoughtfulness and consideration for others. It reflects an understanding of social etiquette and demonstrates a genuine 
interest in the other person's welfare.
*/

// https://zaoancoin.xyz
// https://t.me/ZaoAn_Portal
// https://twitter.com/ZaoAn_Token
...
contract ZAOAN is ERC20, Ownable {
    ...
    constructor() ERC20("ZAO AN", "ZAOAN") {
        ...
        maxTransactionAmount = 2_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 2_000_000 * 1e18; // 2% max wallet at launch
        ...
        marketgwallet = address(0xc0CAAB4e1d04AbEB3B84C7dd5b0cb64B481Bd5E2); 
        devWallet = address(0xff32899e9E487869be283C30BC6c181Ca9b323DD); 
        liqWallet = address(0xff32899e9E487869be283C30BC6c181Ca9b323DD); 
        operationsWallet = address(0xff32899e9E487869be283C30BC6c181Ca9b323DD);
    ...
    function updatemktWallet(address newmktWallet) external onlyOwner {
        emit mktWalletUpdated(newmktWallet, marketgwallet);
        marketgwallet = newmktWallet;
    }
    ...
    function swapBack() private {
        ...
        (success, ) = address(marketgwallet).call{value: address(this).balance}("");
    }
}