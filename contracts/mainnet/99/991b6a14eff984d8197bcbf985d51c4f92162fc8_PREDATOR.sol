...
/**
   ...
   Become a Predator.
   maxTxAmount = 1000000
   maxWalletSize = 2000000

   At launch :
   Liquidity tax will be set to 20%( buys and sells ) for first 10 minutes.

   10 minutes after the launch:

   Liquidity tax will be lowered to 3% and contract will be renounced.



           No socials,no website,no twitter,no team.
                   JUST PREDATOR
...
contract PREDATOR is Context, IERC20, Ownable {
    ...
    string private _name = "Predator";
    string private _symbol = "PREDATOR";
