...
contract Invasion is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Invasion";
    string private constant _symbol = "$INVASION";
    ...
    uint256 private constant _tTotal = 51000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xD8C52d7Bfe4f2f10dDDEA23145DF061908c066E0);
    ...
    function AlienWave(bool _tradingOpen) public onlyOwner {
