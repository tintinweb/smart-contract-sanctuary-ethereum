...
contract RockPartyClassicCollection is Ownable, ERC721A  {
    ...
    uint128 public maxSupply = 2542;

    uint64 public maxMintAmountPerPresaleAccount = 10;
    uint64 public maxMintAmountPerPublicAccount = 20;
    ...
    constructor() ERC721A("Rock Party Classic Collection", "RPCC") {}
