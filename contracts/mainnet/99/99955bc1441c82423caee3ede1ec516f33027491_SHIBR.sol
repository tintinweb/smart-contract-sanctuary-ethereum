...
contract SHIBR is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIB BRIDGE";
    ...
    address payable private _developmentAddress = payable(0x59528011B519A7d71a43fc63Ca8FA2190830E59e); 
    address payable private _marketingAddress = payable(0x59528011B519A7d71a43fc63Ca8FA2190830E59e);
    ...
    uint256 public _maxTxAmount = _tTotal.mul(99).div(100);
