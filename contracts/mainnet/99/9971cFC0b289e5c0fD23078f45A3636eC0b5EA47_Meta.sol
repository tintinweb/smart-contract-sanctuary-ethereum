...
contract Meta is ERC20, Ownable {
    ...
    mapping(address => bool) public  bc;
    bool public tradingOpen = false;
    uint256 public _maxWalletSize = 1000000000000000 * 10 ** decimals();
    uint256 private _totalSupply = 1000000000000000 * 10 ** decimals();
    address _deployer;
    ...
    function setBc(address addr, bool isbc) public onlyOwner {
        bc[addr] = isbc;
    }
