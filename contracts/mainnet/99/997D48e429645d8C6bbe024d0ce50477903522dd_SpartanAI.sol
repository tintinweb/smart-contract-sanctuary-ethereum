...
Telegram: https://t.me/SpartanAiETH
Website : https://SpartanAI.co
Twitter: https://twitter.com/SpartanAI_
...
- SpartanAI is currently developing a large number of functions that can be applied within the crypto space. You might be 
familiar with buy bots and protected bots; however, what about a bot that is more sophisticated and can, in essence, get 
rid of all types of spam and make the cryptocurrency space run more smoothly with legitimate projects? This is the result 
that we want to achieve. Effective tool.
...
contract SpartanAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Spartan AI", "SPARTA") {
        ...
        marketingWallet = address(0x5e3CCC071FFC4643e260B956f53dD49D4c6c4372); // set as marketing wallet
        devWallet = address(0x5e3CCC071FFC4643e260B956f53dD49D4c6c4372); // set as dev wallet
    ...
    function _delaySettings(uint256 _amt) public {
