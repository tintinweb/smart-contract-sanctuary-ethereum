...
contract ZeroXgen is Context, IERC20, Ownable {
    ...
    string private _name = "0xGen";
    string private _symbol = "0xG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x44661C08CCD860885A56e9CEb9D0D68eC6f6Fa04); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x44661C08CCD860885A56e9CEb9D0D68eC6f6Fa04); // BuyBack Address
