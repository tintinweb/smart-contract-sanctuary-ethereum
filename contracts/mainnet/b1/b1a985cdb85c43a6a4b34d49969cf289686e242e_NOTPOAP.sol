...
contract NOTPOAP is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Not POAP", "XPOAP")
    {
        baseURI = _baseURI;
