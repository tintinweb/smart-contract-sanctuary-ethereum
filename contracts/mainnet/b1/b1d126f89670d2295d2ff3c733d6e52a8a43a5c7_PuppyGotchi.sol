...
Telegram- https://t.me/PuppyGotchi
...
contract PuppyGotchi is Context, IERC20, Ownable {
    ...
    string private constant _name = "PuppyGotchi";
    string private constant _symbol = "PUPP";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xD02E54bAFDe706b159c1826eFE3a1Da9F438847d);
        _feeAddrWallet2 = payable(0xD02E54bAFDe706b159c1826eFE3a1Da9F438847d);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xD02E54bAFDe706b159c1826eFE3a1Da9F438847d), _msgSender(), _tTotal);
    }
