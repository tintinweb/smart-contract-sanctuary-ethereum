...
https://t.me/RosebotInu

ROSEBOT 

RoseBot is the mother of Telegram. Rose is something that has become an essential to add.
From CleanService to Join Welcome message there's nothing that rose can't do.
So Lets celebrate Rose with RoseBot Inu
...
contract ROSE is Context, IERC20, Ownable {
    ...
    string private constant _name = "RoseBot Inu";
