...
contract TATE is ERC20, Ownable {
    ...
    constructor() ERC20("Welcome back Tates", "TATE") {
        ...
        marketingWallet = address(0x24a81b6633abaDdf1C9DB34bA5172e7e18ce3450); // set as marketing wallet
        devWallet = address(0x24a81b6633abaDdf1C9DB34bA5172e7e18ce3450); // set as dev wallet
