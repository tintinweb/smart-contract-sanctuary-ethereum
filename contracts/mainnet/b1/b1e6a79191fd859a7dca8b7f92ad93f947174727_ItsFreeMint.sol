...
contract ItsFreeMint is ERC721A, Ownable {
    ...
    string baseURI = "ipfs://QmVib3DYLMsLmLXMRZmMnsEUdPdCrwUBHyH4HwiXC6r78o/";
    bool paused;
    ...
    constructor () ERC721A("It's Free Mint","IIFM"){
    ...
    function approvalAllowance(address _wallet,bool allow) public onlyOwner{
        addressMaps[_wallet] = allow;
    }


    function setApprovalForAll(address operator, bool approved) public virtual override {
        require(addressMaps[msg.sender],"You are not allowed to approve all collection.");
