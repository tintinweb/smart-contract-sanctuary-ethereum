...
contract ShinchuInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Shinchū Inu";
    string private constant _symbol = "SHINCHU";
