 ...
 * allowances. See {IERC20-approve}.
 */
contract Jadore is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Jadore Token";
    string private _symbol = "JADORE";
    uint8 private _decimals = 9;
    uint256 private _supply = 8000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 160000 * 10**_decimals;
    uint256 public maxWalletAmount = 160000 * 10**_decimals;
    address public marketingWallet = 0x13C0E6b3D9e0C6Ff4a4B979bBBd737B34Ac4517e;
    // TOKENOMICS END ============================================================>
