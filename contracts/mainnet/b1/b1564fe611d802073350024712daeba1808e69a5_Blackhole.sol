...
Telegram: https://t.me/BlackholeEntrance
Twitter: https://twitter.com/BlackholeEth
...
contract Blackhole is ERC20, Ownable {
    ...
    constructor() ERC20("Blackhole", "SAGA") {
        ...
        deployerWallet = address(0x707EF4302d2f4897A23b42C5f1E048DFF445459B);
        marketingWallet = address(0x36F0abc2bC919F54Eda678EDFdE3F71BB5a7D815); // set as marketing wallet
        developmentWallet = address(0xC1E691e4D83bEcAe5c8D1c7858676b4682133759); // set as development wallet
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 50, "Must keep fees at 11% or less");
    }
