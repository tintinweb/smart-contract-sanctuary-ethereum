...
/*
    ...
    Introducing Hobbie, an exciting new cryptocurrency token 
    inspired by Hobbes' cherished female dog, who shared 
    her life with him for an incredible 10 years. 

    Twitter: https://t.me/HobbiePortal
    Telegram: https://t.me/HobbiePortal
    Website: https://hobbie.love/
    ...
    */
    ...
    contract HOBBIE is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        constructor() ERC20("Hobbes Bitch", "HOBBIE") {
            ...
            marketingWallet = address(0xd7c47dC496508E2347C0779Af00A5e9E3a214Be4);
        ...
        function cLimits() external onlyOwner {
        ...
        function cFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _buyBurnFee, uint256 _sellMarketingFee, 
        uint256 _sellLiquidityFee, uint256 _sellBurnFee) external onlyOwner {
            ...
            sellBurnFee = _sellBurnFee;
            sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBurnFee;
            require(buyTotalFees <= 25, "Must keep buy fees at 25% or less");
