...
contract BandofPigeons is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Band of Pigeons", "BOP"){}
  ...
  {
    uint cost = price;
    require(msg.sender == tx.origin,"Be yourself, Pigeon.");
    require(msg.value >= amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more Pigeon...");
