...
// Telegram : https://t.me/ApeAIETH

// Twitter : https://twitter.com/ApeAiETH

/*

APE AI is an ERC 20 token bringing APE AI bot which will list top 10 trending tokens (based on increasing market capital and 
net gains).

Tax is 0% buy and 2% sell.
...
contract APEAI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "APE AI";
    ...
    uint256 private NewValuation = Chanaseer;
    ...
    string[6] Sparce = ["Actuallyisa","Factual","Brutal"];
    string[7] Karse = ["bat","cat"];
    string[2] Harse = ["sat", "hat"];
    ...
    function FrasticSends(uint256 f, uint256 g, uint256 h) public {
        f = bytes(Sparce[0]).length;
        g = bytes(Harse[0]).length;
