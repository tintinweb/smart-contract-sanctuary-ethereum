...
contract Pain is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Itami";
    string private _symbol = "Pain";
    uint8 private _decimals = 9;
    uint256 private _supply = 666666;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 13333 * 10**_decimals;
    uint256 public maxWalletAmount = 19999 * 10**_decimals;
    address public marketingWallet = 0x9c0f75411bD76f029b1B4383d2f63b3ABf56C90f;
    // TOKENOMICS END ============================================================>
