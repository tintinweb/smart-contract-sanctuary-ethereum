...
contract WorldCupApesYC is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("World Cup Apes YC", "WCAYC"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more  World Cup Apes");
    require(mintEnabled, "Minting is not live yet, hold on World Cup Ape.");
