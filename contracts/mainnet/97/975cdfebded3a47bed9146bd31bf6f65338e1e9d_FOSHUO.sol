 ...
 * allowances. See {IERC20-approve}.
 */
contract FOSHUO is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Foshuo";
    string private _symbol = "FOSHUO";
    uint8 private _decimals = 9;
    uint256 private _supply = 80000;
    uint256 public taxForLiquidity = 3;
    uint256 public taxForMarketing = 8;
    uint256 public maxTxAmount = 800 * 10**_decimals;
    uint256 public maxWalletAmount = 1600 * 10**_decimals;
    address public marketingWallet = 0xF84E4D4548B9ee5b98d9eef59a044ADAbbD335A0;
    // TOKENOMICS END ============================================================>
