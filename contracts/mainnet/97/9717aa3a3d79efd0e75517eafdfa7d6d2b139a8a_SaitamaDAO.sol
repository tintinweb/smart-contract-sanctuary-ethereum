...
contract SaitamaDAO is ERC20, Ownable {
    ...
    uint256 public percentForLPBurn = 2; // 2 = 2%
    ...
    constructor() ERC20("SaitamaDAO", "SaitDAO") {
        ...
        marketingWallet = address(0x01DbF552D89f9b2D06df3F638E72270B038De84B); // set as marketing wallet
        devWallet = address(0x01DbF552D89f9b2D06df3F638E72270B038De84B); // set as dev wallet
