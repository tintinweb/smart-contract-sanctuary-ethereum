...
// https://twitter.com/elonmusk/status/1589396236464898048
...
contract WarningProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private constant _name = "Warning Protocol";
    string private constant _symbol = "$WARNING";
