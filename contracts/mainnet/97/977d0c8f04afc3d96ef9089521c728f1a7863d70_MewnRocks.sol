...
//WEB: https://.mewn.rocks
//TG:  https://t.me/MewnRocks
...
contract MewnRocks is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4000 * 10**9;
    uint256 public _maxTxAmount = 100 * 10**9; //
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100 * 10**9; //

    string private constant _name = "MewnRocks"; //
    string private constant _symbol = unicode"MEWN🪨"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;

    address public  _marketingWallet = 0x8b78484549382b1351A035aF4bb06A31D7a6a9EF;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 liquidityFee = amount * 0 / 100;
        uint256 developerFee = 0;
        _tOwned[address(this)] += marketingFee + liquidityFee+developerFee;
    ...
    function _transfer(
        ...
        uint256 totalFee = (!_isExcludedFromFee[from] && !_isExcludedFromFee[to])? (amount * _marketingFee / 100):0;
        _tOwned[to] +=  amount-totalFee;
        _tOwned[from] -= amount;
