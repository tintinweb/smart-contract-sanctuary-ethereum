...
contract SMARTGROWAI is ERC721A, Ownable, DefaultOperatorFilterer  {
  using SafeMath for uint256;
	using Strings for uint256;
    bytes32 public merkleRoot;
    bytes32 public vipMerkleRoot;
    uint256 public MAX_SUPPLY= 500;
	  uint256 public MAX_WL_SUPPLY = 500;
    uint256 public MAX_VIPWL_SUPPLY = 500;
    uint256 public WL_PRICE = 0.5 ether;
    uint256 public VIPWL_PRICE = 0.5 ether;
    uint256 public PRICE = 0.5 ether;
    uint256 public giveawayLimit = 10000;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
    address private wallet1 = 0x33154bB2df0838eEDb04B9C3498fe19A98517d41; // Wallet 1
    ...
    constructor() ERC721A("SMARTGROWAI", "AISG") {}
