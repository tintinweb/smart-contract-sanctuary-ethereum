...
The Ninth Game $NINTH
The 9th world has multi-epoch iterations, 
trade markets, #DAOs, game guilds and virtual buildings.

Website: https://the-ninth-game.xyz/
Telegram: https://t.me/TheNinthGamePortal
...
contract THENINTH is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        treasuryWallet = address(0xFab9eA795B3bbD2ab4682700a0893ecE6Ae7fA5D); // set as treasury wallet
        devAddress = address(0x3Feb2fDD5e4A2efF589eb09824AA4CAcea684E9C); // set as dev wallet
