...
contract SoulIO is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("SOULIO", "soul") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 599;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://Qme8k5ZWSY6KG1S3E5tM5HbL8ZdRCbdKjieasvHkcjKHxA/", _toString(tokenId), ".json"));
    }
