...
contract Xmascember is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Xmascember";
    string private constant _symbol = "XCEMBER";
    ...
    function changeFee(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
        require(_buyMarketingFee + _buyLiquidityFee < 100 || _sellLiquidityFee + _sellMarketingFee < 100, "Can't change fee higher than 10%");
