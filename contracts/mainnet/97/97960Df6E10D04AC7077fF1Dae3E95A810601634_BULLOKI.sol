...
/*
According to Cz is bull season (https://twitter.com/cz_binance/status/1627947492456161285?s=20).
Here is Floki Bull. 
$BULLOKI

TG: https://t.me/BullokiERC
*/
...
contract BULLOKI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "FLOKI BULL";
    string private constant _symbol = "BULLOKI";
    ...
    address payable private _developmentAddress = payable(0x98DfC882da6C0D3F9130A9813BC371E63DD02F5B); 
    address payable private _marketingAddress = payable(0x98DfC882da6C0D3F9130A9813BC371E63DD02F5B);
