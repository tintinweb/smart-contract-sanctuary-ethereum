...
Goku represents “pump”. Lets Goku it! 

Goku is the next memecoin and abbreviation for the crypto space. We are developing a collection of Goku family with multiple token airdrops and NFTs to token holders. Further utilities include Goku Swap, Goku Stake. Be part of the Goku family now!
...
contract GOKU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Goku Inu";
