...
contract GodLoveBananaas is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public maxperAddressPublicMint = 25;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("ChubbyPixelJiras", "ChubbyPiuxelJiras") {
        setBaseURI("ipfs://QmTuKre248CM7dfdAgBYFfMAwpnb77GbkLjjQpkCpVHnVK/");
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more then max mint" );
