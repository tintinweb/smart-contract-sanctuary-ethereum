...
//https://t.me/FundsAreSafuErc
//https://twitter.com/FundsAre_Safu
...
contract FUNDSARESAFU is ERC20, Ownable {
    ...
    constructor() ERC20("FUNDS ARE SAFU", "SAFU") {
    ...
    function updateTax(uint256 _marketingBuyFee, uint256 _liquidityBuyFee, uint256 _marketingSellFee, uint256 _liquiditySellFee) external onlyOwner {
