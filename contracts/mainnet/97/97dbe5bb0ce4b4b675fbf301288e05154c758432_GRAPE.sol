...
GRAPE is the official ERC-20 Token for GrapeFinance.
GrapeFinance is a DeFi DEX that splits fees amongst token holders.
LP Tokens sent to burn address on launch
...
contract GRAPE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "GrapeFinance";
