...
SOCIALS:
https://twitter.com/ShibaMuzzle
https://t.me/ShibaMuzzle
https://shibamuzzle.com 
...
contract MUZZLE is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba's Muzzle'", "MUZZLE") {
        ...
        uint256 _sellDevFee = 27;

        uint256 totalSupply = 10000000 * 1e18;

        maxTransactionAmount = 50000 * 1e18; // 0.5% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x2Ac97a3D20ed409E23864A8cB1Cc8317528F61f5); // set as charity wallet
        marketingWallet = address(0x2Ac97a3D20ed409E23864A8cB1Cc8317528F61f5); // set as marketing wallet
        devWallet = address(0x2Ac97a3D20ed409E23864A8cB1Cc8317528F61f5); // set as dev wallet
