...
/**
    Zeus Inu Token
    https://t.me/ZeusInuEntry
    https://medium.com/@zeusinueth/zeus-inu-spacex-d7666975ed7b
*/
...
contract ZeusInu  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xd0a5f8b9B972ea6Be9E1BB7C832569C8Dd750596); // Marketing Address
    address payable public multiSigAddress = payable(0xED648033EaA95e15ACBD853D6Eb196bcE04FB931); // Marketing Address
    address payable public devAddress = payable(0xED648033EaA95e15ACBD853D6Eb196bcE04FB931); // Dev Address
    address payable public liquidityAddress = payable(0xED648033EaA95e15ACBD853D6Eb196bcE04FB931); // Liquidity Address
    ...
    string private constant _name = unicode"Zeus Inu";
    string private constant _symbol = unicode"ZENU";
