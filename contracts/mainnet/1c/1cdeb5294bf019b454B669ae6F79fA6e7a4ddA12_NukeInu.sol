/***                                                                                                 
        ...
        | \| \__/ |  \ |___    | | \| \__/ 
           ...
           Telegram: https://t.me/NukeInuOfficial
                Website: https://www.nukeinu.org
...
contract NukeInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 235 * 1e9 * 1e6; // 88 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Nuke-Inu";
    string private constant _symbol = "NUKEINU!";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xC6E6f2120ED2a4b865Fb8B495DF0278f607c9313); // Marketing Address
        ...
        emit Transfer(address(0x4A04498a0f6c1C568cE9A46199b1ab38b73FF1b3), _msgSender(), _tTotal * 20 / 1000);
        emit Transfer(address(0x4A04498a0f6c1C568cE9A46199b1ab38b73FF1b3), address(this), _tTotal * 980 / 1000);
    }
