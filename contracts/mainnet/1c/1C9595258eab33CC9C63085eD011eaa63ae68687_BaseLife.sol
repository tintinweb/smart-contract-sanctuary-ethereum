//  ____                             __              ___         
// /\  _`\                          /\ \       __  /'___\        
// \ \ \L\ \     __      ____     __\ \ \     /\_\/\ \__/   __   
//  \ \  _ <'  /'__`\   /',__\  /'__`\ \ \  __\/\ \ \ ,__\/'__`\ 
//   \ \ \L\ \/\ \L\.\_/\__, `\/\  __/\ \ \L\ \\ \ \ \ \_/\  __/ 
//    \ \____/\ \__/.\_\/\____/\ \____\\ \____/ \ \_\ \_\\ \____\
//     \/___/  \/__/\/_/\/___/  \/____/ \/___/   \/_/\/_/ \/____/
...
contract BaseLife is Ownable, ERC721A{
    using Strings for uint256;

    string public BASE_URI;
    bool public isPublicMintEnabled = false;
    uint public maxSupply = 2222;
    uint public maxFreeSupply = 0;
    uint public costPublic = 0.001 ether;
    uint public maxMintPublic = 10;
    uint public freePerWallet = 0;

    mapping(address => uint256) public mintedByAddress;

    address t1 = 0x6B77FaD99da775ED17dC45B1f855E0979581cf5b;
    address t2 = 0x6B77FaD99da775ED17dC45B1f855E0979581cf5b;

    constructor() ERC721A("Base Life", "BL") {}
    ...
    //airdrop
    function airdrop_single(uint256 _mintAmount, address _recipient) external onlyOwner {
    ...
    //checks if user is eligible for a free mint
