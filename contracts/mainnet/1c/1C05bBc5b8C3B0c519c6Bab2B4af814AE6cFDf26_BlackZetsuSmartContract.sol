...
/*********************
->Token Name:  Kuro Zetsu
->Symbol: ZETSU

->Supply: 10,000,000,000
->Initial buy (200,000,000)

->Tax: 5% buy and 5% sell (20% initial sell tax for the 1st hour)

->Telegram: https://t.me/kurozetsuerc20
->Website: building....
->Utility: visit tg for more info..

We will build DAPP for Black Zetsu. visit TG for more info...
...
contract BlackZetsuSmartContract is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromMaxWalletSize;
    string private constant _name = "Kuro Zetsu";
    string private constant _symbol = "ZETSU";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0xA4373AAc40921600BD5f77e203C01fE61658e463); 
