...
MM"""""""`MM MM""""""""`M M""MMMMM""M MMP"""""YMM M""MMMMMMMM M""MMMMM""M M""""""""M M""M MMP"""""YMM M"""""""`YM 
MM  mmmm,  M MM  mmmmmmmM M  MMMMM  M M' .mmm. `M M  MMMMMMMM M  MMMMM  M Mmmm  mmmM M  M M' .mmm. `M M  mmmm.  M 
M'        .M M`      MMMM M  MMMMP  M M  MMMMM  M M  MMMMMMMM M  MMMMM  M MMMM  MMMM M  M M  MMMMM  M M  MMMMM  M 
MM  MMMb. "M MM  MMMMMMMM M  MMMM' .M M  MMMMM  M M  MMMMMMMM M  MMMMM  M MMMM  MMMM M  M M  MMMMM  M M  MMMMM  M 
MM  MMMMM  M MM  MMMMMMMM M  MMP' .MM M. `MMM' .M M  MMMMMMMM M  `MMM'  M MMMM  MMMM M  M M. `MMM' .M M  MMMMM  M 
MM  MMMMM  M MM        .M M     .dMMM MMb     dMM M         M Mb       dM MMMM  MMMM M  M MMb     dMM M  MMMMM  M 
MMMMMMMMMMMM MMMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMM MMMM MMMMMMMMMMM MMMMMMMMMMM 
                                                                                                                  

A Revolutionary Community Project aiming to help Mother Nature, reduce pollution, and spread environmental awareness and the power of decentralized world. 
Breaking Crypto stigma as a non-environmental friendly, and creates a whole new meaning – a revolutionary community.

                                                                                                                                                                                            
                                                                           
TG: https://t.me/RevolutionErc
Twitter: https://twitter.com/RevolutionErc
...
interface IUniswapV2Pair {
    ...
    contract Revolution is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Revolution";
    string private _symbol = "REVOLUTION";
    ...
    uint256 public defaultMarketingFee = 2;
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _marketingFee4Sellers = 2;
    ...
    address payable public marketingWallet = payable(0x9909e9119d2406Adba457206297AD631DA00D9FA);
