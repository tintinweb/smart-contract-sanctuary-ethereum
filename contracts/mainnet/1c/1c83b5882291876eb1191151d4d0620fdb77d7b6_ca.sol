...
$MOON is a stealth launched community made token on the Erc20 Blockchain.
It's main objective is promoting the ShitCoin market via his self made popularity 
Shh.. Dev's past project hit 150k, don't tell anybody
...
contract ca  is ERC20, Ownable{
    ...
    address public marketingWallet = 0xa592FFB08074D52Dc28F6E11090B5bE7f8A5A6fa;
    address public devWallet = 0xa592FFB08074D52Dc28F6E11090B5bE7f8A5A6fa;
   ...
   Taxes public taxes = Taxes(3,0,0);
    ...
    constructor() ERC20("SpaceDoge", "MOON") {
