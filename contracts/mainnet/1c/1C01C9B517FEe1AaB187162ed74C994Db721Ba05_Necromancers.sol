...
contract Necromancers is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmUnqVYormiMEwmfM9eEoWLCdVo58pkHW67q6c65yFLcbQ";
  ...
  ) ERC721A("Necromancers", "Necromancers") {
