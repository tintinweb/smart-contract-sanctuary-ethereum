...
$Score AI is the first crypto project incubator using state of the art AI deep learning technology to check credit some projects with the lowest possibility of a scam and the highest growth potential. 
...
contract SCORE is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xaB85176E654E9503768C72A1800749AD4c5df72c); // 
        exclude(msg.sender);
