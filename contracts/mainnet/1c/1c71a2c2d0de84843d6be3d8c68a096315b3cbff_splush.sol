...
contract splush is Context, IERC20, Ownable {
    ...
    string private constant _name = "splush";
    string private constant _symbol = "splush";
    ...
    bool private issplushtoken = false;
