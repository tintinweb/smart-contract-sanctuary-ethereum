...
contract RonBielecki is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    string namecontract = "RonBielecki";
    
    // Symbol of the NFT contract.
    string symboltoken = "RTDC";
    string tokenname = "Ron Bielecki Tornado Card";
    ...
    uint256 minttwoPrice = 0.4 ether;
    uint256 mintfreePrice = 0.5 ether;
    ...
    require(msg.value >= amount * mintprises, "Payment too small");
