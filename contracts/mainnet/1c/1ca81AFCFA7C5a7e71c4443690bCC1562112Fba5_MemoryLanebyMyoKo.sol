...
contract MemoryLanebyMyoKo is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 666;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.02 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x4c682bf4cea7a04b79f9e316919cb6580febda785c6de55599496797d458a81d;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmZGmg2DquSDtWwgBh2XLmfvJurZtoQvzCTBUnBqRSH3Ec";

    constructor() public ERC721A("Memory Lane by MyoKo", "MEMORY", 666, 666) {}
