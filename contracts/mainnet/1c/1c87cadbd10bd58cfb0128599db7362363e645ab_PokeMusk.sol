...
contract PokeMusk is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Poke Musk";
    string private constant _symbol = "$POKEM";
    ...
    address payable private _developmentAddress = payable(0xE0d47ac10a3Db11c694f0f058A7B371301Ce5f34);
    address payable private _marketingAddress = payable(0xE0d47ac10a3Db11c694f0f058A7B371301Ce5f34);
