...
contract CAO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CAO NI MA";
    string private constant _symbol = unicode"CAO";
