...
contract HASH is ERC20, Ownable {
    ...
    constructor() ERC20("HASH", "$Hash") {
        ...
        marketingWallet = address(0xcc643223af837851d93B81fd800c7BCf549a8d17); // set as marketing wallet
        devWallet = address(0xcc643223af837851d93B81fd800c7BCf549a8d17); // set as dev wallet
