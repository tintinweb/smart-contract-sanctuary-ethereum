...
contract Upcember is ERC20, Ownable {
    ...
    constructor() ERC20("Upcember", "Upcember") {
		...
		charityWallet = address(0xCc95b78977DB0F49d6eD8D7bAEe70FD82f48CAFe); // set as charity wallet
        marketingWallet = address(0xCc95b78977DB0F49d6eD8D7bAEe70FD82f48CAFe); // set as marketing wallet
        devWallet = address(0xCc95b78977DB0F49d6eD8D7bAEe70FD82f48CAFe); // set as dev wallet
