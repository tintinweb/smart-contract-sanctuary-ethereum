...
contract GenesisLPPool is LPTokenWrapper, Ownable, AccessControlEnumerable {
    using SafeMath for uint256;
    ...
    constructor(IERC20 _lpAddress) LPTokenWrapper(_lpAddress) {
