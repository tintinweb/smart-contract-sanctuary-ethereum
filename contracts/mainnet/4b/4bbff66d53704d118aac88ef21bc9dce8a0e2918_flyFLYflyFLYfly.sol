...
contract flyFLYflyFLYfly is ERC721A, Ownable {
    using Strings for uint256;

    string public baseURI = "ipfs://QmRPm2YJiYMfhMgTanrarEeaTEFUADinnvsUCk4dF8cSxA/";
    ...
    constructor(string memory _name, string memory _symbol) ERC721A("cFLY", "flyFLYflyFLYflyFLY") {}
