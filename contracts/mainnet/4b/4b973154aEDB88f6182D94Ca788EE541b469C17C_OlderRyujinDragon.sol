...
contract OlderRyujinDragon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Older Ryujin Dragon";
    string constant _symbol = "Older TSUKA";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0x7b343b61F8f3FdDD80e78b0206DdE24E429e94C2; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x7b343b61F8f3FdDD80e78b0206DdE24E429e94C2;
        solor = msg.sender;
...
contract StandarToken is OlderRyujinDragon {
    constructor() {}
}