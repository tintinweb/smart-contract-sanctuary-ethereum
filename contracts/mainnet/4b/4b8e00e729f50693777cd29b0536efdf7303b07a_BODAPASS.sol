...
contract BODAPASS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbEN8rzswKhffiKKM2mEmpiPbPzkPbKjsv4dGcH87ReTx";
    ...
    constructor(
    ) ERC721A("[B]ODA PASS", "[B]ODA", 100, maxSupply) {
    }
