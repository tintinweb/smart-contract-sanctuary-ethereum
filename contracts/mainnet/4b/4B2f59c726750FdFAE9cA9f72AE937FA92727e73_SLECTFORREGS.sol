...
// If anyone out there is a very clever ape, this should be enough. All my love, Ian.
// Clue 2: K04000001	England and Wales	2017	4,840	9.4	9.2	9.7	3,629	14.4	14.0	14.9	1,211	4.6	4.4	4.9
contract SLECTFORREGS is ERC721A, Ownable {
    uint256 public constant _MAX_MINT_ERC2309_QUANTITY_LIMIT = 5;
    uint256 public constant MINT_PRICE = 0.0 ether;
    uint256 public currentTokenId;

    constructor() ERC721A("SLECTFORREGS", "SL4R") {}

    // Deploying to Arweave for permanency ;-)
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://arweave.net/EGkgO3yUp8v8jcSCSpLCr7wVJUZggxZ1t7HcACWggNw/";
    }
