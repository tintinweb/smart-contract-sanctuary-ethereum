...
contract BoredHoundCollars is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmctXEpA7iBKAp8pqf9qKgsp7FKsYebrGvmed1MFTZW4zB";
    ...
    constructor(
    ) ERC721A("Bored Hound Collars", "BHC", 100, maxSupply) {
    }
