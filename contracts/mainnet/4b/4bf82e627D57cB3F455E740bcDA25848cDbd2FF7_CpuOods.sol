...
contract MemoryMap {
    ...
    */
    ...
    uint256 constant internal MM_TRACE_QUERY_RESPONSES =                   0x219; // uint256[480]
    uint256 constant internal MM_COMPOSITION_QUERY_RESPONSES =             0x3f9; // uint256[96]
    uint256 constant internal MM_LOG_N_STEPS =                             0x459;
    uint256 constant internal MM_N_PUBLIC_MEM_ENTRIES =                    0x45a;
    uint256 constant internal MM_N_PUBLIC_MEM_PAGES =                      0x45b;
    uint256 constant internal MM_CONTEXT_SIZE =                            0x45c;
}
// ---------- End of auto-generated code. ----------
