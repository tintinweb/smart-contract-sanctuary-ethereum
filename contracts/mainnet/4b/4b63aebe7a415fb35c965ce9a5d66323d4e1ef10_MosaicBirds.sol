...
contract MosaicBirds is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYwvigXTwvPqCJkL2oLNXJ8iaMKc84TWpqzH6uRQZnLRQ";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("MosaicBirds", "MOSAIC", 100, MAX_SUPPLY) {
    }
