...
contract ThatWasEasy is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ThatWasEasy";//
    string private constant _symbol = "WEAZY";//
    ...
    address payable private _developmentAddress = payable(0x6668f6409588aBB2557d7B19a9269be6641779f2);//
    address payable private _marketingAddress = payable(0xf18a0EA05a8D9C03f699Dda8b00A013f1420FE8c);//
