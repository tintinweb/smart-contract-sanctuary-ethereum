...
contract CultAfro is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x8F5a4e2aB152b2A4447030f4234CfE7ffAD7489A);
    address payable public devWallet = payable(0x8AD0BC663C4D98a34D37c82ec7778ea95bA35bA2);
    ...
    constructor(address router) ERC20("Cult Afro", "CULTAFRO") {
