...
contract TheHunter is ERC721A, Ownable {
    using Strings for uint256;

    string public baseMetaUri;
    
    //General Settings
    uint16 public maxMintAmountPerTransaction = 0;
    uint16 public maxMintAmountPerWallet = 0;
    ...
    constructor(string memory _baseUrl) ERC721A("The Hunter", "The Hunter") {
