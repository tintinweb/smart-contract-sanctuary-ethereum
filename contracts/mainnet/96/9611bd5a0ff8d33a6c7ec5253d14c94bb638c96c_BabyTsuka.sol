...
https://www.babydejitarutsuka.com/
...
contract BabyTsuka  is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "Baby Dejitaru Tsuka";
    ...
    uint256 private _maxWalletSize = 40000001 * 10**9;
    ...
    constructor() {
        ...
        devAddress = payable(0x2eD93AFaE5C19d357A599319C63111110036466e);
        marketingAddress = payable(0x2eD93AFaE5C19d357A599319C63111110036466e);
        minTokensBeforeSwap = _tTotal.mul(5).div(100);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
			require(amount <= 20000001 * 10**9, "Limits are in place, please lower buying amount");
		}
