...
contract RFI_AutoLP is Context, IERC20, Ownable {
    ...
    string private _name = "RFI_AutoLP";
    string private _symbol = "RFI_AutoLP";
    ...
    uint256 private _developmentFee = 500; // marketing 
    ...
    uint256 public _maxTxAmount = 1_000_000 * 10**9;  // max tx is set to 100% of the supply by default
    uint256 public _maxWallet = 10_000 * 10**9;      // max wallet is 1% of the supply by default
    ...
    constructor () {
        ...
        rareSwapRouter = IRARESwapRouter(0x5244d856A383fE3cc1339368107B8698B65FFAb8); // RareSwap ETH-mainnet Router 0x5244d856A383fE3cc1339368107B8698B65FFAb8
        WETH = rareSwapRouter.WETH();
         // Create a RareSwap pair for this new token
        ...
        IRARESwapPair(rareSwapPair).updateTotalFee((_developmentFee + _autoLPFee));
