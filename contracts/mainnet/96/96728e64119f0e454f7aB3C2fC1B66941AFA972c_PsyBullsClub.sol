...
contract PsyBullsClub is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmWoPoc7CMP1vGB8vgfSNWvDbFEjKa8qLsLRRoqumyyKg9";
  ...
  ) ERC721A("Psy Bulls Club", "PsyBulls") {
