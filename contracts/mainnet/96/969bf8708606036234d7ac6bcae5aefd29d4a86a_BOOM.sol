...
/**
Combining auto-LP with auto-burns and manual buybacks, BOOM! is the next meme to take the scene by storm.

Ready to say "BOOM!" when you look at the chart? 

Liquidity will be locked initially and then burnt after establishing a solid floor so that BOOM! will live forever on chain and in the hearts of degens worldwide! 

Looking for a sick meme with big dreams? 
...
contract BOOM is ERC20, Ownable {
    ...
    constructor() ERC20("Boom", "BOOM") {
        ...
        marketingAddress = 0x3C795a6799244183cc577927Df38b8695B9aaf9E;
