...
contract FlowMonsters is ERC721Enumerable, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721("Flow Monsters", "FLOW") {
    setBaseURI("ipfs://QmfKmamLN9SRBzt9bhEXunjLWeZcd4pLyiZHWAmk1XgTJ7/");
    mint(msg.sender, 1);
  }
