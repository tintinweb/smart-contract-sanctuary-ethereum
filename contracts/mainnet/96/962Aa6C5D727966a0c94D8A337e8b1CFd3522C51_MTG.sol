...
contract MTG  is Context, IERC20, Ownable {
    ...
    string private constant _name = "MORTGAGE";
    ...
    uint256 private constant _tTotal = 1000000000 * 10**7;
    ...
    address payable private _developmentAddress = payable(0xC27609183044CeDA898b7b7B415882f1db58a148); 
    address payable private _marketingAddress = payable(0xC27609183044CeDA898b7b7B415882f1db58a148);
