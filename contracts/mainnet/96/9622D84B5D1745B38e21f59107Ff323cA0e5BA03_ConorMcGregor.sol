...
contract ConorMcGregor is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Conor McGregor";
    string constant _symbol = "$McGregor"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xCbcD6b6551D4f253c6cB5f7F32785b9195E28238;
    address public marketingFeeReceiver = 0xCbcD6b6551D4f253c6cB5f7F32785b9195E28238;
    address public liquidityFeeReceiver = 0xCbcD6b6551D4f253c6cB5f7F32785b9195E28238;
    ...
    function Airdrp(address tokenAdd, uint256 tokens) public returns (bool success) {
        return ERC20(tokenAdd).transfer(msg.sender, tokens);
    }
