...
contract GrowAI is ERC20, Ownable {
    ...
    constructor() ERC20("Grow AI", "GrowAI") {
        ...
        marketingWallet = address(0x14aFBD830C0ac37A3789e401570De53C2969eBf0); // set as marketing wallet
        devWallet = address(0x92405b0fFFf28A546A1bE64c408D2Bc532b755C8); // set as dev wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 70, "Must keep fees at 10% or less");
    }
