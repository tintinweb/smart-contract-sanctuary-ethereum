    ...
    PausableUpgradeable
{
    ...
    function changeMinAndMaxBuy(uint256 _minBuy, uint256 _maxBuy)
        external
        onlyOwner
    {
        minBuy = _minBuy;
        ...
        returns (bool)
    {
        ...
        if (purchasedAmountETH[_msgSender()] == 0) {
            require(
                msg.value >= minBuy && ethAmount <= maxBuy,
     ...
     * @param _usersToWhitelist addresses of the users
     */
    function buyWhitelistUsers(address[] calldata _usersToWhitelist)
        external
        onlyOwner
    {
    ...
    /**
     * @dev To set status for publicSale
     * @param _status bool value
     */
     ...
     */
    function roundDetails(uint256 _no)
        external
        view
     ...
     */
    function setCurrentStep(uint256 _step, uint256 _checkpoint)
        external
        onlyOwner
    {
        currentStep = _step;
