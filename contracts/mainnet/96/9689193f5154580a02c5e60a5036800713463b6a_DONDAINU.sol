...
contract DONDAINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 15000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Donda Inu";
    string private _symbol = "DONDA";
