 ...
 * @notice This contract handles minting Taiji by Gobyt tokens.
 */
contract TaijiByGobyt is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xB18Dd2C4ACc5B2fa1371350d120C9a94C2DAb463;
    ...
    string public baseTokenURI =
        "ipfs://bafybeidq3iqqz32jslfqzqixbfz5yl3p4uztd43lrjldpvzva73tcoihdy/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 365;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 365;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 365;
    uint256 public presaleMintsAllowedPerTransaction = 365;
