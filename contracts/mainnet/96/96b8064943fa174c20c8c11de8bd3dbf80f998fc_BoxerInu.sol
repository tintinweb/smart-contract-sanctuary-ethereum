...
contract BoxerInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Boxer Inu";//
    string private constant _symbol = "BOXER";//
    ...
    address payable private _developmentAddress = payable(0x931514846b3a625B02FB9F1CFB2b2ad38439Aa88);//
    address payable private _marketingAddress = payable(0xDF9DB18876AEAd058a023cdef3eD1dD4C113bE60);//
