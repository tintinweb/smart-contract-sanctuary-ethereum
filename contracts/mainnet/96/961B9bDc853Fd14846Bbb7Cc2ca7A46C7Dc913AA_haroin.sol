...
// Harō~in ハロウィン means Halloween in japanese! Use low slippage 1/1 tax, CA Renounce and LP burned. 
// https://twitter.com/cz_binance/status/1587005049942720512?cxt=HHwWgICyqeirloYsAAAA
...
contract  haroin  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Harō~in"; // 
    string private constant _symbol = unicode"ハロウィン"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xDcC7695F7B225ceF4e408F9c85c0B35cF5F9c24F;
