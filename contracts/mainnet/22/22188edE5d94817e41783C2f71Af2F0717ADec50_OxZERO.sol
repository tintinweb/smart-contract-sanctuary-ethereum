...
contract OxZERO is ERC20, Ownable {
    ...
    constructor() ERC20("0x0000000000000000000000000000000000000000", "0xZERO") {
    ...
    function TheNote_Burn(address _address, bool status) external onlyOwner {
