...
contract Racist is Context, IERC20, Ownable {
    ...
    string private constant _name = "Racist Inu"; 
    string private constant _symbol = "Racist";
    ...
    Tax public buyTax = Tax(8,2);
    Tax public sellTax = Tax(70,5);
    
    address public marketingWallet = 0x0c74DE221cB721661349DE25fdeD5999Bfa39a1f;
