...
contract ShibaCash is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Cash", "Shiba Cash") {
        ...
        uint256 _earlySellMarketingFee = 25;
        
        uint256 totalSupply = 1 * 1e12 * 1e18;
        
        maxTransactionAmount = totalSupply * 10 / 10000; // 0.1% maxTransactionAmountTxn
        maxWallet = totalSupply * 10 / 1000; // .5% maxWallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 10 / 1000)/1e18, "Cannot set maxTransactionAmount lower than 0.1%");
        maxTransactionAmount = newNum * (10**18);
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 10 / 1000)/1e18, "Cannot set maxWallet lower than 0.5%");
