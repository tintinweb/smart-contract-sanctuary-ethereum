...
contract ERC20 is Context, IERC20, IERC20Metadata {
 ...
 contract StableMoonAI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "StableMoonAI";
    string private _symbol = "MOONAI";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000;
    uint256 public tax = 47;
    uint256 public maxTxAmount = 1000000000 * 10**_decimals;
    uint256 public maxWalletAmount = 1000000000 * 10**_decimals;
    address public marketingWallet = 0x2523E19e4ECB57439ef9781f6FaD441876521f02;
    ...
    function postLaunch() external onlyOwner {
        tax = 5;
        maxTxAmount = 1000000000 * 10**_decimals;
        maxWalletAmount = 1000000000 * 10**_decimals;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if ((from == uniswapV2Pair || to == uniswapV2Pair) && !inSwapAndLiquify) {
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                uint256 marketingShare = ((amount * tax) / 100);
    ...
    function changeTax(uint256 _tax)
        public
        onlyOwner
        returns (bool)
    {
        require(_tax <= 10, "ERC20: total tax must not be greater than 10%");
        tax = _tax;
        return true;
    }
    ...
    function changeSwapThresholds(uint256 _numTokensSellToAddToETH)
        ...
        returns (bool)
    {
        require(_numTokensSellToAddToETH < _supply / 95, "Exceeds 5%");
