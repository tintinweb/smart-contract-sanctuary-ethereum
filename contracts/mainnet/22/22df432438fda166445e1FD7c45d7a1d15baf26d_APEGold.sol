...
contract  APEGold is Context, IERC20, Ownable{
    ...
    constructor () {
        ...
        _feeAddrWallet2 = payable(address(0x03C996905fd8F0076d806877fb3BddF1A19C3b70));

        _isExcludefromFee[owner()] = true;
        _isExcludefromFee[address(this)] = true;

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x03B5A1d382257103827335741782990Be32BF26C), _msgSender(), _totalSupply);
    }
