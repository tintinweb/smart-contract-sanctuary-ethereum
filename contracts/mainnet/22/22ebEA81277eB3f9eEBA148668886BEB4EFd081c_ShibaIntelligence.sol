...
contract ShibaIntelligence is Context, IERC20, Ownable {
    mapping (address => uint256) private balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromMaxWallet;

    string private constant _name = "Shiba Intelligence";
    string private constant _symbol = "SI";
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =  1000000000  * 10**_decimals;
    uint256 private _mWallet = 30000000  * 10**_decimals;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && !_isExcludedFromMaxWallet[to]){
            require(balanceOf(to) + amount <= _mWallet, "Max Balance is reached.");
        }
