...
Now $MDAO is here, we focus on the investment of Meme coin, our community will make investment proposals and vote, welcome to your arrival.

TOTAL: 1,000,000,000,000 (100％)
Max wallet:10,000,000,000 (1％)
Max buy: 5,000,000,000 (0.5％)
SLIPPAGE: 1％
...
contract MDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meme DAO";
    ...
    address payable private _developmentAddress = payable(0x42433cb7dA0f9447dB91F32A78c9aaE295A3fd0d);
    address payable private _marketingAddress = payable(0x42433cb7dA0f9447dB91F32A78c9aaE295A3fd0d);
    ...
    uint256 public _maxTxAmount = 5000000005 * 10**9;
