...
// Welcome to Shytoshi's Playground...


// https://t.me/ShytoshisPlayground
...
contract ShytoshisPlaygorund is ERC20, Ownable {
    ...
    constructor() ERC20("Shytoshi's Playground", "PLAYGROUND") {
		...
		charityWallet = address(0x42553D76b39137CcDc930faF072CD1Be99C4B3e7); // set as charity wallet
        marketingWallet = address(0x42553D76b39137CcDc930faF072CD1Be99C4B3e7); // set as marketing wallet
        devWallet = address(0x511042c69b9F1C0d5a75d25563dbcE28BC4031Ae); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 15, "Max BuyFee 15%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 15, "Max SellFee 15%");
