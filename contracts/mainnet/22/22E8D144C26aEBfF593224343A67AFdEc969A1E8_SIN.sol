...
Is it a $SIN to want to Send It.

$SIN | Official Links
https://twitter.com/SendItInu
https://t.me/SendItInu
https://medium.com/SendItInuETH
...
contract SIN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 150000 * 10**_decimals;
    string private constant _name = unicode"Send It Inu";
    string private constant _symbol = unicode"SIN";
    uint256 public _maxTxAmount =   2250 * 10**_decimals;
    uint256 public _maxWalletSize = 4500 * 10**_decimals;
    uint256 public _taxSwapThreshold=750 * 10**_decimals;
    uint256 public _maxTaxSwap=4500 * 10**_decimals;
