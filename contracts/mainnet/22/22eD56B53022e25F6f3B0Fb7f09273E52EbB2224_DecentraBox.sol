...
contract DecentraBox is ERC20, Ownable {
    ...
    uint256 public lpBurnFrequency = 103600 seconds;
    ...
    constructor() ERC20("Decentra Box", "DBOX") {
        ...
        marketingWallet = address(0x6b8307CE0dEa19A7546D5ad8903C6274f9935127); 
        developmentWallet = address(0x29c56805E81FfE256285Fc896faBA94CB88a98b4); 
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevelopmentFee;
        require(sellTotalFees <= 100, "Must keep fees at 40% or less");
    }
