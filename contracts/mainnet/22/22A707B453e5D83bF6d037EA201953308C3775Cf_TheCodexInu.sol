...
The Codex Inu is being born to prove that even a meme coin can have a successful ecosystem similar to tornado.cash

Website, telegram and twitter will be updated soon on Dextools, keep an eye out for more info.

We are going to redefine the term “privacy” on the Ethereum blockchain.
...
contract TheCodexInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = "The Codex Inu";
