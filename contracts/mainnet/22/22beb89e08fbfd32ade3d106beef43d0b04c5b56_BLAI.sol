...
/*
    ...
    BLAI is the heart of the BlockChain AI tools that leverage powerful AI models 
    to give you insight into DeFi trading so you can make profitable trades.

    Website: https://blai.tech/
    Telegram: https://t.me/BLAIportal
    Twitter: https://twitter.com/blai_eth
    Medium: https://medium.com/@blockchainai/
...
*/
    ...
    contract BLAI is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        constructor() ERC20("BlockChain AI", "BLAI") {
            ...
            marketingWallet = address(0xFe8BF0A2acfEE1ccDC7bc0AA97F1fa1b7386015E); // Marketing / Development wallet
