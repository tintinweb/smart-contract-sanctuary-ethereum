...
contract Samuraitama is Context, IERC20, Ownable {
    ...
    string private _name = "SamuraiTama";
    string private _symbol = "SamuraiTama";
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 10000000000000000000000000 * 10**9;
    }
