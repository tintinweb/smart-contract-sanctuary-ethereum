...
/*    Tyrant Reflections coded in contract
https://t.me/TyrantBank
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x8EE325AE3E54e83956eF2d5952d3C8Bc1fa6ec27)); // TYRANT - 0x8EE325AE3E54e83956eF2d5952d3C8Bc1fa6ec27
...
contract TyrantBank is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tyrant Bank", "TB") {

        uint256 totalSupply = 100 * 1e6 * 1e18;
        
        swapTokensAtAmount = totalSupply * 1 / 100; // 1% swap tokens amount
        ...
        mktWallet = address(0xce9B90f022Fb20F49900Ef569DC205e7f9ae5A76);
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 400, "Must keep fees at 40% or less");
    }
    ...
    function swapBack() private {
        ...
        uint256 marketingbalance = taxbalance.div(2);
        (success,) = address(operationsWallet).call{value: marketingbalance}("");
        (success,) = address(mktWallet).call{value: marketingbalance}("");
    }
