...
contract SeaSide is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmecUGeC6wEwaC4G1txFVdRBRUEi1c4pP4DVesH7NoU9PR";
    ...
    constructor(
    ) ERC721A("Seaside Banners", "SEASIDE", 100, maxSupply) {
    }
