...
contract GodOfWar is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"God Of War";
    string private constant _symbol = unicode"$ARES";
