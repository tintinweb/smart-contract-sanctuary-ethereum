...
contract DarkWolrd is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Dark Wolrd", "Dark") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 850;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmdrXixaHjs16Hp98TdqDVmNEyARGVryxUcgDaiRCgexzs/", _toString(tokenId), ".json"));
    }
