...
contract PrivateKeys is ERC20, Ownable {
    ...
    constructor() ERC20("Private Keys", "$PK") payable {
        ...
        maxTxnAmount = totalSupply * 15 / 1000; // 1.5% of supply
        maxWallet = totalSupply * 2 / 100; // 2% maxWallet
        swapTokensAtAmount = totalSupply * 75 / 10000; // 0.75% swap amount half of max tx 
