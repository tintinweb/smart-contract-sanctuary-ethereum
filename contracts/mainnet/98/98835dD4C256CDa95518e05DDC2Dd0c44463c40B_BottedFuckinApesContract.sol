...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xCE5E1b7B3d80dE272eEDA83f36A77b496F663970];
  address public erc20Payable = 0xCE5E1b7B3d80dE272eEDA83f36A77b496F663970;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmegW2C8GRcsAfEdpXTmTQAxBCFq4XVGwzRgRPQo5rA9yP/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/az4k9acCDxT0Dw3gaqhz/contract-metadata";
  }
...
// File: contracts/BottedFuckinApesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BottedFuckinApesContract is RamppERC721A {
    constructor() RamppERC721A("Botted Fuckin Apes", "BFApes"){}
}