...
// File: contracts/Astrofinft.sol
pragma solidity ^0.6.0;




contract AstrofiNft is ERC721, Ownable {
    ...
    constructor(string memory _baseURI) public ERC721("Astrofi Nft", "AFINFT") {
     ...
     */
    function getNftName(uint8 _nftId)
        external
        view
     ...
     */
    function setNftName(uint8 _nftId, string calldata _name)
        external
        onlyOwner
    {
