...
https://t.me/EnigmaEthPortal

https://twitter.com/EnigmaEthPortal
...
contract Enigma is ERC20, Ownable {
    ...
    constructor() ERC20("ENIGMA", "ENIGMA") {
        ...
        uint256 totalSupply = 1000000 * 1e18; //1M TOTAL SUPPLY

        maxTransactionAmount = 20000 * 1e18; //2% MAX TRANSACTION
        maxWallet = 20000 * 1e18; //2% MAX WALLET
        swapTokensAtAmount = (totalSupply * 3) / 10000; //0.03% SWAP AMOUNT
