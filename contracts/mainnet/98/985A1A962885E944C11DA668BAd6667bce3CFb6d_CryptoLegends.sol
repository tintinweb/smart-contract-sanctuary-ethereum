...
contract CryptoLegends is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10000 * 10**9; // swap at amnt
    string private constant _name = "Crypto Legends"; // name
    string private constant _symbol = unicode"LEGENDS"; // ticker
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x97b3C36C7D4a229E7372CCb1788F2789D1b0Ea65;
