...
contract Vacuum is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2997924580 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 2997924 * 10**_decimals;
    uint256 public maxBuyLimit = 29979245 * 10**_decimals;
    uint256 public maxSellLimit = 29979245 * 10**_decimals;
    uint256 public maxWalletLimit = 59958490 * 10**_decimals;
        
    address public marketingWallet = 0x67834E7FD4cf846aA91a7BDacB6fA6FdFeEd617C;

    string private constant _name = "Vacuum";
    ...
    Taxes public sellTaxes = Taxes(1, 2, 0);
