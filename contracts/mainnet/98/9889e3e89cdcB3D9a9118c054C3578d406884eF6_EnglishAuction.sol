...
contract EnglishAuction is IEnglishAuction, OperatorAccessControl {
    using SafeERC20 for IERC20;

    IAddressesProvider private _addressesProvider;

    struct AuctionERC721Request {
        uint256 orderId;
        address nftAddress;
        uint256 tokenId;
        uint256 price;
    ...
    function auctionOperateERC721(
        ...
        AuctionERC721Request memory request = AuctionERC721Request({
            orderId: orderId,
    ...
    function auctionOperateERC1155(
        uint256 orderId,
        address nftAddress,
        uint256 tokenId,
        uint256 amount,
        ...
        AuctionERC1155Request memory request = AuctionERC1155Request({
            orderId: orderId,
            nftAddress: nftAddress,
            tokenId: tokenId,
            amount: amount,
        ...
        IERC1155 _erc1155 = IERC1155(request.nftAddress);
        require(
            _erc1155.balanceOf(request.sellerAddress, request.tokenId) >=
                amount,
            "EnglishAuction: seller erc1155 balance is insufficient"
        );
        require(
