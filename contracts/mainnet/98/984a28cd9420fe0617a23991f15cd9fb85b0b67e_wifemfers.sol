...
contract wifemfers is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("wifemfers", "wifemf") {
    setHiddenMetadataUri("ipfs://QmRQSJyaRPCjJrv2KDmcZhMsxT9TiujStXYUKRNMj5mrXE/hidden.json");
  }
