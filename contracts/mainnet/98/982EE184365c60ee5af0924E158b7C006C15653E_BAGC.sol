...
contract BAGCCore is OwnableUpgradeable {
    ...
    function getRandomAvailableTokenId(address to) internal returns (uint256) {
    ...
    function getRealTokenId(uint256 tempTokenId) internal view returns (uint256) {
        ...
        } else if (2487 < tempTokenId && tempTokenId <= 4887) {
    ...
    function isUserToken(uint256 tokenId) public view returns (bool) {
        require(msg.sender != merchNFTAddress || msg.sender != address(this), "BAGC: not allowed");
        return
