...
contract TaskExecutorFacet is IDiamondFacet {
    ...
    function getFacetPI()
      external pure override returns (string[] memory) {
        ...
        pi[ 0] = "getTaskManagerKeys()";
        pi[ 1] = "getTaskManager(string)";
        pi[ 2] = "setTaskManager(uint256,string,address)";
        return pi;
    }
    ...
    function getFacetProtectedPI()
      external pure override returns (string[] memory) {
        ...
        pi[ 0] = "setTaskManager(uint256,string,address)";
        return pi;
    }
    ...
    function getTaskManagerKeys() external view returns (string[] memory) {
        return TaskExecutorInternal._getTaskManagerKeys();
    }

    function getTaskManager(string memory key) external view returns (address) {
        return TaskExecutorInternal._getTaskManager(key);
    }
    ...
    function setTaskManager(
        ...
        return TaskExecutorInternal._setTaskManager(adminTaskId, key, newTaskManager);
    }
}
