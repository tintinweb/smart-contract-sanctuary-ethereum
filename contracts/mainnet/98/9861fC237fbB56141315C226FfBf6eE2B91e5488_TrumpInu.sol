...
contract TrumpInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x56d013C5daD8B2e7AAb1E13603AC413968D88273);
    address payable private _marketingWalletAddress = payable(0x56d013C5daD8B2e7AAb1E13603AC413968D88273);
