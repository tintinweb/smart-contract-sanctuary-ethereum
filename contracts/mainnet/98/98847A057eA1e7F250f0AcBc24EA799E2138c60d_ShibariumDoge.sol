...
contract ShibariumDoge is ERC20, Ownable {
    ...
    constructor() ERC20("Shibarium Doge", "SOGE") {
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 0.5% maxTransactionAmountTxn
        maxWallet = totalSupply * 1 / 1000; // 0.5% maxWallet
