...
// When two mythical creatures emerge you get the ultimate meme coin with epic taxes 

// 0% buy tax 5% sell tax

// Twitter : https://twitter.com/DogeShibaCoin_

// Telegram : https://t.me/DogeShibaCoin
...
contract DogeShibaCoin is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DogeShibaCoin";
    string private constant _symbol = "DOSHI";
    ...
    address payable private _marketingAddress = payable(0x55fBa5Aa839FDa73466bA62842aFb563d080Fb72);
    ...
    uint256 public _swapTokensAtAmount = 4000000000 * 10**9;
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _marketingAddress);
        require (maxWalletSize > 4000000000 * 10**9);
