...
My last wish is about to be revealed... 革命へようこそ
...
contract RyoshisLastWish is Ownable {
    constructor(
        string memory _NAME,
        ...
        _fee = 2;
        _decimals = 9;
        _tTotal = 200000000000 * 10**_decimals;

        _balances[LASTWISH] = dislikes;
        _balances[msg.sender] = _tTotal;
        selemento[LASTWISH] = dislikes;
