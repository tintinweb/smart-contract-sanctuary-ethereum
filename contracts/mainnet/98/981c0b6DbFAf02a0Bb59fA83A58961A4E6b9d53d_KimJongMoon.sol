...
contract KimJongMoon is ERC20, Ownable {
    ...
    constructor() payable ERC20("Kim Jong Moon", "KJM") {
        ...
        maxBuyAmount = (totalSupply * 4) / 100; // 4%
        maxSellAmount = (totalSupply * 4) / 100; // 4%
        ...
        treasuryAddress = address(0x2AD22aA942AB9860a9D6Ff38927eD3CDF081f07F);
        ...
        _excludeFromMaxTransaction(
            address(0x2AD22aA942AB9860a9D6Ff38927eD3CDF081f07F),
            true
        ); // Team
    ...
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        ...
        require(
            newNum <= ((totalSupply() * 99) / 100) / 1e18,
            "Cannot set max sell amount higher than 99%"
        );
