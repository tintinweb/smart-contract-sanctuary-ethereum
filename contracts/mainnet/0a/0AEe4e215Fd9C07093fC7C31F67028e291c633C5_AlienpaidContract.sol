...
//
//     ___    ___                        _     __
//    /   |  / (_)__  ____  ____  ____ _(_)___/ /
//   / /| | / / / _ \/ __ \/ __ \/ __ `/ / __  / 
//  / ___ |/ / /  __/ / / / /_/ / /_/ / / /_/ /  
// /_/  |_/_/_/\___/_/ /_/ .___/\__,_/_/\__,_/   
//                      /_/                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x52D8cD7745d1dD9916c60C9b8CDE6C8de97f3EDa];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 8888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZYTZ7xULBHZTwheXA84c1F1qaVuT1Fa6ufdGYEtiw1XN/";
...
// File: contracts/AlienpaidContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlienpaidContract is RamppERC721A {
    constructor() RamppERC721A("Alienpaid", "ALPD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/l1Y866n1UMWKKB6MGVw8/contract-metadata";
    }
}
