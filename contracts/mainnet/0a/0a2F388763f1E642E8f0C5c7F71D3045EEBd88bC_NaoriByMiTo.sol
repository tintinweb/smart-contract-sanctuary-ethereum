...
contract NaoriByMiTo is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 666;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x68db60f74286be10b60089b5ccde62f7ff44c9144ed8a7c05beeec4dbd72f99f;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmcntK1ZSgtgKyfYH2ixR9Qo6aA5cdQar8WdUgz32V2z6A";

    constructor() public ERC721A("Naori By MiTo", "NAORI", 666, 666) {}
