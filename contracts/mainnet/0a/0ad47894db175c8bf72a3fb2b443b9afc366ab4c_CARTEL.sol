...
// Welcome to the home of the Cartel aka The Elites!
...
// Youtube: https://www.youtube.com/channel/UCK_xL_i-n_ia4lp9NgowG-g

// Telegram: https://t.me/ElCartelEliteERC

// 5/5 TAX, LIQUIDITY WILL BE LOCKED FOR 44 YEARS. 

// Tax will be used for developments of our Dapps & utilities. Marketing funds will be stored in our MultiSig Wallet.
...
contract CARTEL is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "El Cartel Elite DAO";//////////////////////////
    string private constant _symbol = "GUERRILLAS";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0x4E783754e81b3d4fB751E9aB0a504ecadcA2eB5b);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x4E783754e81b3d4fB751E9aB0a504ecadcA2eB5b);///////////////////////////////////////////////////
    ...
    uint256 public _maxTxAmount = 2000000 * 10**9; //1%
    uint256 public _maxWalletSize = 2000000 * 10**9; //1%
