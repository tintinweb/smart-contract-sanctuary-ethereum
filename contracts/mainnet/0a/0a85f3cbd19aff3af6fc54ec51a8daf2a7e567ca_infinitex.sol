...
contract infinitex is IERC721A { 
    ...
    uint256 public constant MAX_PER_MINUTE = 60;
    uint256 public constant MAX_SUPPLY = 777;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public MAX_PER_WALLET = 5;
    uint256 public COST = 0.001 ether;

    string private constant _name = "infinitex";
    string private constant _symbol = "infinitex";
    string private _contractURI = "QmUsCarPbesGr2KYtwZP57FHYtsbKCvioKX3UsbhB4ruzJ";
    string private _baseURI = "QmdidZjctJ8DMuPmXWvcQz3er6FTNQpyhb7Z4pui1LbzDu";
