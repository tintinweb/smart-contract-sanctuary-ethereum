...
contract Ethernite is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Ethernite() {
        ...
        name = "Ethernite";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETRN";                                             // Set the symbol for display purposes (CHANGE THIS)
