...
contract omamori  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "amulet to vanquish all evil";
    string private constant _symbol = "$OMAMORI";
    ...
    address payable private _developmentAddress = payable(0xea38E167cEC8fe1A95d1fD60963c13762968b8A7); 
    address payable private _marketingAddress = payable(0xea38E167cEC8fe1A95d1fD60963c13762968b8A7);
