...
contract SocialHouse is ERC1155, ReentrancyGuard, Ownable {
    ...
    function mint() public onlyStarted payable {
        require(address(msg.sender).balance > cost, "Mint: Balance isn't enough"); 
    ...
    function updateDev(address payable _devAddress, uint256 _rate) public onlyOwner() {
        devteam = _devAddress;
        DEV_TEAM_ROYALTY = _rate;
    }

    function updateArtist(address payable _artistAddress, uint256 _rate) public onlyOwner() {
