...
I'm Mr. Floki and I'm the dog and Mr. Tweet (Elon Musk)

My community will speak about me everywhere.

Buy & Sell Tax (final): 1% 

Max tx is 1.5%
Max wallet is 3%

Twitter and telegram are the place where i should be seen and heard.
...
contract MrFloki is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Mr.Floki"; ////
    string public constant symbol = unicode"Mr.Floki"; ////
