...
contract GoofBears is ERC721A, Ownable { 

  using Strings for uint256;

  string public uriPrefix = "ipfs://QmZekP4eMbkUjbfKBbGcZRprJnanNFzbUgrDkUJjZoPd6P/";
  ...
  uint256 public freeAmount = 3250; 
  uint256 public freeMaxMintAmount = 7; 
  ...
  constructor() ERC721A("GOOF BEARS", "GBNFT") { 
