...
// File @zeppelin-solidity-4.4.0/contracts/access/[email protected]
// License-Identifier: MIT
...
// File @zeppelin-solidity-4.4.0/contracts/utils/introspection/[email protected]
// License-Identifier: MIT
...
// File @zeppelin-solidity-4.4.0/contracts/utils/structs/[email protected]
// License-Identifier: MIT
...
// File @zeppelin-solidity-4.4.0/contracts/proxy/utils/[email protected]
// License-Identifier: MIT
...
contract Erc20Sub2EthMappingTokenFactory is DailyLimit, MappingTokenFactory {
    ...
    function repairTokenList() external {
        bytes32 salt = keccak256(abi.encodePacked(0x0000000000000000000000000000000000000000, 0xE7578598Aac020abFB918f33A20faD5B71d670b4));
        delete allMappingTokens;
        allMappingTokens.push(0x9469D013805bFfB7D3DEBe5E7839237e535ec483);
        allMappingTokens.push(0x9F284E1337A815fe77D2Ff4aE46544645B20c5ff);
        delete salt2MappingToken[salt];
    }
}