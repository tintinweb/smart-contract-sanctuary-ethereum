...
contract YeaIamShocked  is ERC721A, Ownable {
    ...
    constructor()
    ERC721A ("Yea I am Shocked", "Shocked") {
    }
    ...
    function PublicShock(uint256 amount) public payable callerIsUser{
    ...
    function Shocking(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
