...
This is what the Eth official said. Our team is planning on launching the Bellatrix Token with the objective of developing the Bellatrix Ecosystem.

3% tax
5% max hold (No max wallet right before renouncing)
1 ETH initial liq

https://t.me/BellatrixINU
https://twitter.com/ethereum/status/1564288006898458627?t=V_9Vqn0ekcz1na2B0weMJQ&s=19
*/
...
contract ca  is ERC20, Ownable{
    ...
    address public marketingWallet = 0x007b4Cd2F25cE44C7C78167900Bef9fc30e688AF;
    address public devWallet = 0x007b4Cd2F25cE44C7C78167900Bef9fc30e688AF;
   ...
   Taxes public taxes = Taxes(3,0,0);
    ...
    constructor() ERC20("BellatrixINU", "BELLATRIXINU") {
