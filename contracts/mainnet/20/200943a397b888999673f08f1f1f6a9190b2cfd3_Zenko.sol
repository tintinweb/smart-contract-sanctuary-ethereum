...
|_____ $$ | $$_____/| $$$ | $$| $$  /$$/ /$$__  $$      
  ...
  /$$/    | $$      | $$\  $$$| $$\  $$ | $$  | $$      
 /$$$$$$$$| $$$$$$$$| $$ \  $$| $$ \  $$|  $$$$$$/      
|________/|________/|__/  \__/|__/  \__/ \______/       
...
contract Zenko is ERC20, Ownable {
    ...
    constructor() ERC20("Zenko", "Z") {
        ...
        maxWallet = 25_001 * 1e18; // 2% from total supply maxWallet
        ...
        marketingWallet = payable(0xC17e0543b29C5a4816E28c91f824DEbEC1c97DeC); // set as marketing wallet
        devWallet = payable(0xC17e0543b29C5a4816E28c91f824DEbEC1c97DeC); // set as dev wallet
