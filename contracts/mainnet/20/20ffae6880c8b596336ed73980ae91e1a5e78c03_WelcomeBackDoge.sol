...
We been in a bearmarket for a longggg time but doge is making a comback thats why we made welcome back Doge 
0% tax insane marketing strategies 

Telegram : https://t.me/WelcomeBackDOge
...
contract WelcomeBackDoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0724Aa8c9D85c9922Ab59586778A1c5485c45ec1); 
    address payable public Wallet_Utility = payable(0x0724Aa8c9D85c9922Ab59586778A1c5485c45ec1);
    ...
    string private constant _symbol = unicode"WBD"; 
    ...
    constructor () {
        ...
        _owner = 0x0724Aa8c9D85c9922Ab59586778A1c5485c45ec1;
