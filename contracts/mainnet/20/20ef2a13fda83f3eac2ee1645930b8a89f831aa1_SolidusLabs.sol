...
contract SolidusLabs is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xb3B749aC516bEf3d669b1C5aDA9B1828f6B9bA5D));

    string private _name = "Solidus Labs";
    string private _symbol = "SOLIDUS";
