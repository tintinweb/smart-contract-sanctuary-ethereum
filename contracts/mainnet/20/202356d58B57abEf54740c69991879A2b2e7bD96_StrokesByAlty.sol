...
contract StrokesByAlty is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 5;
    uint256 public price = 0.03 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x84543b9b79ab07045eb7966fd390741f2b0aa173d7e8adea8fbee521dcd06666;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmbzoyiDSYmW7BErAzmog8XFTm1oTg3xEiZdpqSEz3JNtw";

    constructor() public ERC721A("Strokes by Alty", "STROKES", 999, 999) {}
