...
abstract contract Project {
    address public marketingWallet = 0xFAdaC697CD0618636Fad50339Cb7aDEE75eC7395;
    address public devWallet = 0xFAdaC697CD0618636Fad50339Cb7aDEE75eC7395;

    string constant _name = "AiGlobal";
    string constant _symbol = "AiGo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000; // (_totalSupply * 10) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = (_totalSupply * 15) / 1000; //
 ...
 * MainContract
 */
contract AiGlobalContract is Project, IERC20, Ownable {
