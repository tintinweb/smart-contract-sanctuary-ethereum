...
contract BLURFACE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Blur Face";
    string private constant _symbol = "$BLURFACE";
    ...
    address payable private _developmentAddress = payable(0x11FB3D6F34C41C4B1E18aa4714B87c15Af45dde2); 
    address payable private _marketingAddress = payable(0xd22380eaE2D9005FcD5e8289e5236DC10c2b7d1E);
