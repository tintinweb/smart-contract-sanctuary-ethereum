...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x6088c9ff8c098a317E472929F82E8430Ebb77E1C];
  address public erc20Payable = 0x6088c9ff8c098a317E472929F82E8430Ebb77E1C;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 6666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXUBZdzVYcpgp1BmwTkerqPKLsykTKBRJ9swzRMZzbL9b/";
...
// File: contracts/WeAreBlindContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeAreBlindContract is RamppERC721A {
    constructor() RamppERC721A("WeAreBlind", "WAB"){}
}