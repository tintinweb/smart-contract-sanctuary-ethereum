...
/*^
https://t.me/BritishBreakfastERC
*/
...
contract BRITISHBREAKFAST is ERC20, Ownable {
    ...
    constructor() ERC20("British Breakfast", "BREAKFAST") {
		...
		charityWallet = address(0xc221c9D82464F17B802E15703274A64d3e5B5B17); // set as charity wallet
        marketingWallet = address(0xc221c9D82464F17B802E15703274A64d3e5B5B17); // set as marketing wallet
        devWallet = address(0xc221c9D82464F17B802E15703274A64d3e5B5B17); // set as dev wallet
