...
lets make this hit $50,000,000 market cap

low liquidty moonshot!

Tax will be used to do buy backs and then re add to liquidity!
...
contract FIFTY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FIFTY";
    string private constant _symbol = unicode"FIFTY";
