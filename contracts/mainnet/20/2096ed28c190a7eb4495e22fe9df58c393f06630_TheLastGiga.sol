...
5 % On Sell : 
2% Auto-Liq / 2 % Marketing / 1% Dev

5% Tax will be changed to 0% tax once chart stabilises and liq fat enough 
We got a special function for this, we will use it too for buy comp + wall buy event

The Liquidity will be initially locked for 1 week then we will extend the lock when we reach certain milestones
We won't renounce since we need Owner privileges to trigger the SetZeroTax function 
...
contract TheLastGiga is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TheLastGiga", "TLGG") {
