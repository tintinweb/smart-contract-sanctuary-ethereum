...
/**
🐈 🔥Cat Burn 🐈🔥
🔥Launching 1/9/2023 @7pm Est 
Please don’t buy any contract unless it’s pinned here in the telegram

The world is burning, whether it be war, the economy, or the environment… and we want to make a difference.

Cat Burn is here to provide a hyper deflationary currency that has a 5% daily burn from the token in its LP. This not only provides value for it investors but on top of that, Cat Burn pledges to donate a percentage of its taxes to cat shelters. 

Cats get 9 tries at life, humans only get one, but what if we can make that one life better for everyone. 

Purr the burn

Telegram: https://t.me/CatburnOfficialERC

Twitter: https://twitter.com/CatBurnOfficial

Website: https://catburn.xyz/
...
contract Catburn is ERC20, Ownable {
