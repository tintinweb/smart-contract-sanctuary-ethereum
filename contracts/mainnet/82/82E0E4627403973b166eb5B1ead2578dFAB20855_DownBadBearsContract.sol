...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5C9755bb8a416023BF128fcD2a277963176dA245];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 2000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcySKgDUFwANqptiQqY1qtFxP8bdZ7vs6KwJXhc6Ny4sM/";
...
// File: contracts/DownBadBearsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DownBadBearsContract is RamppERC721A {
    constructor() RamppERC721A("Down Bad Bears", "DOWNBAD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/FusxQt2EhXsyLBh80s5w/contract-metadata";
    }
}
