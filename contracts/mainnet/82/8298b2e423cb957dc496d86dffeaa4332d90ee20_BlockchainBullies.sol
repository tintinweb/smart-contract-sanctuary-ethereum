...
contract BlockchainBullies is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Variables Start =======================
  ...
  string public names= "Blockchain Bullies";
  string public symbols= "BB";
  
  address ownerrr= 0xbe7173767D042C063C905Eb47Bdf80BB674FA6cA;
...
// ================== Constructor Start =======================
  ...
  constructor(
    ...
    seturi("ipfs://bafybeie2zovf6jut5obfqmex5kxj7vw64t7maattjwqrrezt5dbm4dtp5e");
  }
...
// price
  ...
  function setcost(uint256 _cost2) public onlyOwner {
    cost = _cost2;
  }  
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
    //owner withdraw
                ...
                require(payable(dev).send(_20percent));    
                require(payable(ownerrr).send(_80percent));
