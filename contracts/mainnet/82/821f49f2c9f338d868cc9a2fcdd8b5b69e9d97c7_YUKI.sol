...
contract YUKI is ERC20, Ownable {
    ...
    constructor() ERC20("YUKI","YUKI") {
        ...
        marketingWallet = address(0x06FA4E0880DB64Dc0B14618EEe2aA3F3dC2D3577); // set as marketing wallet
        devWallet = address(0x06FA4E0880DB64Dc0B14618EEe2aA3F3dC2D3577); // set as dev wallet
