...
contract RestoredPaul is ERC20, Ownable {
    ...
    constructor() ERC20("Restored Paul", "REPAULED") {
        ...
        marketingWallet = address(0x120776c239a9eE37ad7E7AFcFB863cb8555Eb52C); // set as marketing wallet
        devWallet = address(0xC29724BBf7662eeaE40FCD3dc2A94323723a8D62); // set as dev wallet
