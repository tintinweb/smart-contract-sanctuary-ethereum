...
// File: contracts/ITeaVaultV2.sol
...
// File: contracts/IHighTableVault.sol
...
// File: contracts/HighTableVault.sol
...
contract HighTableVault is IHighTableVault, AccessControl, ERC20 {
    ...
    function setEnabledNFTs(address[] memory _nfts) external override {
    ...
    function previewNextCycle(uint128 _fundValue, uint64 _timestamp) external override view returns (uint256 withdrawAmount) {
        ...
        if (cycleState[cycleIndex].requestedWithdrawals > 0) {
            ...
            withdrawAmount += uint256(cycleState[cycleIndex].requestedWithdrawals) * _fundValue / totalSupply();
        }
