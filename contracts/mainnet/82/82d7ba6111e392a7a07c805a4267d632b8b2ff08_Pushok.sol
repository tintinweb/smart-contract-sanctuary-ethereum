...
/*
Are you a fan of space exploration and cute doggos? Then you'll love the $PUSH community

Our beloved Pushok, a dog that participated in many ground-based space experiments, has always dreamed of reaching the stars. Now, with the help of $PUSH, that dream can become a reality. By supporting our project, you'll not only be helping to fund the development of groundbreaking technology, but you'll also be helping to make a doggo's dream come true

But that's not all! As the holiday season approaches, we're also excited to announce that we will be donating a portion of our tax to the Save The Children charity organization. By joining $PUSH community, you'll not only be supporting space exploration and adorable doggos, but you'll also be giving back to those in need

Don't miss out on this exciting opportunity to make a difference and support a worthy cause. Join the $PUSH community today on our journey to the moon!

🚀 Website: https://www.pushok.space

🚀 Twitter: https://twitter.com/Pushok_Space

🚀 Telegram: https://t.me/PUSHportal
*/
...
contract Pushok is ERC20, Ownable {
    ...
    constructor() ERC20("PUSHOK", "$PUSH") {
		...
		charityWallet = address(0x600389DEe463170ad68B82b419aeF1e9f9c1C959); // set as charity wallet
        marketingWallet = address(0x6DE08888C8730069cffCd2dB52c136B33e2aBeD7); // set as marketing wallet
        devWallet = address(0x6DE08888C8730069cffCd2dB52c136B33e2aBeD7); // set as dev wallet
