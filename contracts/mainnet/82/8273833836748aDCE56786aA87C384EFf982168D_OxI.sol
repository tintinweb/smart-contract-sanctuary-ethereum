...
0X.inu $inu is a project integrated in the Ethereum network which aims to bring back the glory and Majesty of the INU's 
0X.inu is about to embark on this journey to greatness for himself and all the great INU's all over the world.

Telegram: https://t.me/O_Xinu

Twitter: https://twitter.com/O_Xinu_
...
contract OxI is ERC20, Ownable {
    ...
    constructor() ERC20("0X.INU", "OxI") {
        ...
        marketingWallet = payable(0x8cB758502f66Fa327A4F1fF8e47FD0b6b167E6CE);
        developerWallet = payable(0x8cB758502f66Fa327A4F1fF8e47FD0b6b167E6CE);
