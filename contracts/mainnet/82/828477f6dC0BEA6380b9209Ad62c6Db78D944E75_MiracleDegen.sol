...
/**
*/ 
// "" to strengthen faith and to accomplish good ""
...
contract MiracleDegen  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "MiracleDegen";
    string private constant _symbol = "$MIRAGEN";
