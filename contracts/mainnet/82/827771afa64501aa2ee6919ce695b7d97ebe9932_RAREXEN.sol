...
contract RAREXEN is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x0FE12f1d76F140130d24eE1F62540749B8Ec47a1);
  ...
  string private constant _name = 'Rare XEN';
  string private constant _symbol = 'r_XEN';
  ...
  address public buybackTokenAddress = 0x06450dEe7FD2Fb8E39061434BAbCFC05599a6Fb8;
  ...
  uint256 public _maxTxAmount = _tTotal.mul(25).div(1000); // 2%
  uint256 public _maxWalletSize = _tTotal.mul(3).div(100); // 3%
  uint256 public _maximumBuyAmount = _tTotal.mul(20).div(1000); // 0.3%
