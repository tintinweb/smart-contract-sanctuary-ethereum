...
/**
Engimono (縁起物) is a good luck charm in Japanese culture.
...
contract Engimono is Context, IERC20, Ownable {
    ...
    string private constant _name = "Engimono";
    string private constant _symbol = unicode"縁起物";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4099A2ea07E9A5904990C79b97f1996AED508Ad1);
        _feeAddrWallet2 = payable(0x4099A2ea07E9A5904990C79b97f1996AED508Ad1);
