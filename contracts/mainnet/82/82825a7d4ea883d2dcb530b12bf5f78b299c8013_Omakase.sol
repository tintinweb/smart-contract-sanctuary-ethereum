...
The phrase omakase, literally means 'I leave it up to you’. 
It is most commonly used when dining at Japanese restaurants 
where the customer leaves it up to the chef to select and serve seasonal specialties.

So are you ready to omakase with me the dev?

I will make an official twitter and share the link.
There will be no telegram.
Please do not make community telegram (it is bearish).
...
contract Omakase is Context, IERC20, Ownable {
    ...
    string private constant _name = "Omakase";
    ...
    address payable private _developmentAddress = payable(0xbcFdE8fcABCbea5a251d135DC33B0e19475f90c1);
    address payable private _marketingAddress = payable(0xbcFdE8fcABCbea5a251d135DC33B0e19475f90c1);
