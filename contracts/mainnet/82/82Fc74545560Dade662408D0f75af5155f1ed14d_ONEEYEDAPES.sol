...
// File: contracts/OneEyedApes.sol


// ONEEYEDAPES SMART CONTRACT
...
contract ONEEYEDAPES  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI           = "ipfs://QmNZPsTFAzLUjV4VNcubXsjcGNR3yh7y8KgLFLukLSLGty/";
    uint   public price             = 0.008 ether;
    uint   public maxPerTx          = 8;
    uint   public maxPerFree        = 2;
    uint   public totalFree         = 4567;
    uint   public maxSupply         = 4567;
    bool   public mintEnabled       = false;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("OneEyedApes", "1EA"){}
