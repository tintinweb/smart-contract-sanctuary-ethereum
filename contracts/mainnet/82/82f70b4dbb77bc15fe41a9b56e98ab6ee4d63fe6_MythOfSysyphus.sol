...
// File: TheMythOfSysyphus.sol

/*⠀⠀⠀⠀

    As AI systems become increasingly capable and widespread, it is essential that we do not lose sight of the unique and valuable contributions that human beings bring to the table.
    
    This is where the our project comes in. The goal of $SYSYPHUS is to bring awareness to the importance of human capacity and to highlight the areas where humans can still outshine AI.

    

    https://t.me/TheMythOfSysyphus

    https://medium.com/@mexaxok608/the-myth-of-sysyphus-tale-of-a-i-9f3981589a6c
...
contract MythOfSysyphus is ERC20, Ownable {
    ...
    constructor() ERC20("The Myth Of Sysyphus", "SYSYPHUS") {
        ...
        uint256 _sellReflectionsFee = 98;
        ...
        marketingWallet = address(0xb2b8EF3b1C00F736b669f6d025f43b44319b31D8); // set as marketing wallet
        devWallet = address(0xb2b8EF3b1C00F736b669f6d025f43b44319b31D8); // set as dev wallet
