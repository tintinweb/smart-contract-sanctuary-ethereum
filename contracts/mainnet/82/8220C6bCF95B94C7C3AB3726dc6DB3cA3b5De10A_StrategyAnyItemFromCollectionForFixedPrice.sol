...
contract StrategyAnyItemFromCollectionForFixedPrice is IExecutionStrategy {
    ...
    {
        // Not supported as this strategy relies on makerBid to make an offer on all collection
        return (false, 0, 0);
    }
     ...
     * @return (whether strategy can be executed, tokenId to execute, amount of tokens to execute)
     */
    function canExecuteMakerOrder(OrderTypes.MakerOrder calldata, OrderTypes.MakerOrder calldata)
        external
        pure
        override
        returns (
    ...
    {
        // Not supported as there will not be a makerAsk created with this strategy
        return (false, 0, 0);
    }
