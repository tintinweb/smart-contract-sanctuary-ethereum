...
/*
APEABILITY - Ape's possession of the means to moon.
https://apeability.site/
*/
...
contract APEABILITY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Apeability";
    string private constant _symbol = "APEABILITY";
    ...
    uint256 public _maxWalletSize = 700000000000 * 10**8;
