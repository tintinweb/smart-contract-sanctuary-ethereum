...
/**
KNIGHT INU is building an army of Kingdom and warriors alike! With so much distress and destruction across Space. Knight Inu is building a new community to fight the tax farmer powers. 

Come Join the Fight now!

https://t.me/knightinuentry
https://www.knightinuofficial.com
**/
...
contract knightinuentry is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Knight Inu";
    string private constant _symbol = unicode"KNIGHTINU";
