 ...
 *
————————————————
Telegram: https://t.me/CumpornInu

twitter: https://twitter.com/CumPornInu
————————————————

Tax:
👉 12% total tax for buying/selling:
        - 4 % goes into marketing
        - 4 % goes into liquidity 
        - 4 % goes into team wallet
...
contract Cumporn is Context, IERC20, Ownable {
    ...
    string private _name = 'Cumporn Inu';
