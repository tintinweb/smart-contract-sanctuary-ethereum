...
import {RevokableDefaultOperatorFilterer} from "./utils/RevokableDefaultOperatorFilterer.sol";
import {UpdatableOperatorFilterer} from "./utils/UpdatableOperatorFilterer.sol";
...
contract Mannay_x_Marrast_Decal is
  ERC721,
  ReentrancyGuard,
  AccessControl,
  ...
  Ownable
{
  ...
  constructor(
    ...
    address _artist
  ) ERC721("Decal by Mannay x A. Marrast", "DECAL") {
