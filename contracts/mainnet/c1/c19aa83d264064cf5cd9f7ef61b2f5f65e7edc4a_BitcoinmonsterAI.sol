...
contract BitcoinmonsterAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bitcoinmonsterai";
    string private constant _symbol = "btcmAI";
    ...
    uint256 private constant _tTotal = 11000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xafF7767097705df2DD0cC1c8B69071f6FF044aaa); 
    address payable private _marketingAddress = payable(0xafF7767097705df2DD0cC1c8B69071f6FF044aaa);
    ...
    uint256 public _maxTxAmount = 110001 * 10**9; 
    uint256 public _maxWalletSize = 110001 * 10**9; 
