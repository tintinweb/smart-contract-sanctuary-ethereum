...
contract DataFunks is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xa826b43A2Ac4050893f208bBb6D326E4C47A7c3C));

    string private _name = "DataFunks";
    string private _symbol = "DFNK";
