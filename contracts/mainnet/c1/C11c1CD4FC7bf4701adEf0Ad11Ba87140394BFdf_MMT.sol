...
contract MMT is ERC20, Ownable {
    ...
    address public MilkShakeWallet;
    address public devWallet= 0x8242e56a759aa0B069B9c983fe3f582020CD1eC9;
    ...
    uint256 public sellWindow2 = 60 minutes; 
    uint256 public sellWindow3 = 90 minutes; 
    uint256 public sellWindow4 = 120 minutes; 
    ...
    uint256 public sellMarketingFeeWindow3 = 2;
    uint256 public sellMarketingFeeWindow4 = 2;

    uint256 public sellMilkShakeFee = 1;
    uint256 public sellDevFee = 1; 
 
    uint256 public tokensForLiquidity;   
    uint256 public tokensForMarketing;
    uint256 public tokensForMilkShake;
    ...
    event MilkShakeWalletUpdated(address indexed newAddr, address indexed oldAddr);
    ...
    constructor() ERC20("MEMEMILKSHAKETHEORY", "MMT") {
    ...
    function updateMilkShakeWallet(address addr) external onlyOwner returns (bool) {
        emit MilkShakeWalletUpdated(addr, MilkShakeWallet);
        MilkShakeWallet = addr;
        return true;
    }
    ...
    function updateMilkShakeSellFee(uint256 fee) external onlyOwner returns (bool) {  
        require(fee <= 10, 
        "must not be higher than 10%");

        sellMilkShakeFee = fee;
        return true;
    }
   ...
   function updateMarketingFeeForSellWindows(
        ...
        override 
    {
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                ...
                tokensForMilkShake += fees * sellMilkShakeFee / sellTotalFees;
            ...
            if (automatedMarketMakerPairs[from] && buyTotalFees > 0) {
                ...
                tokensForMilkShake += fees / buyDivisorFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForMilkShake = ethBalance * tokensForMilkShake / tokensToSwap; 
        ...
        delete tokensForMilkShake;
        delete tokensForDev;
        
        (success,) = address(MilkShakeWallet).call{value: ethForMilkShake}("");
    ...
    function getSellFeesAccount(address addr) 
        ...
        uint256 CurrentMarketingFee) 
    {
        uint256 feesWithoutLiquidityAndMarketing = sellMilkShakeFee + sellDevFee;
