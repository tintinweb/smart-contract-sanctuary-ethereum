...
// Main Contract Logic 
// --------------------------------------------------------------
contract DragonDoge is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Dragon Doge";
    string private _symbol = "$DragonDoge";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x0e9369af65438193C26a9c21CBf01C9a7B45FDb5);
    address payable public operationsWallet =  payable(0x0e9369af65438193C26a9c21CBf01C9a7B45FDb5);
    ...
    // distribution ratio
    uint256 public _liquiditySharePercentage = 33;
    uint256 public _operationsSharePercentage = 67;
