...
Amaterasu Omikami means 'the great divinity illuminating heaven'. Amaterasu is the sun goddess and most important deity of the Shinto religion.
...
Tax 2/2 : Marketing & Buy Backs

TG link :
 https://t.me/AmaterasuEntry

Twitter : https://twitter.com/AmaterasuERC20
*/
...
contract AMATERASU is Context, IERC20, Ownable {
    ...
    string private _name ="GODDESS OF SUN";
    string private _symbol = "AMATERASU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x4Dd83F672CfB992A02AfcA4aCa6b3CD631C0c735);
    address payable private taxWallet2 = payable(0x4Dd83F672CfB992A02AfcA4aCa6b3CD631C0c735);
    ...
    uint256 public _walletMax = _totalSupply*17/1000;
