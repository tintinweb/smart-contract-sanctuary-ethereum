...
contract PeaceForHand is ERC1155Supply, Ownable {
    ...
    bool public pauseTokenTwo = false;
    ...
    uint256 public constant TOKEN_TWO_PRICE = 0.05 ether;
    address public DonationAddress = 0x84977438f109A909CC8392a8C282046263Daf071;
    // uint256 public constant MAX_TOKENS_ONE = 1000;
    // uint256 public constant MAX_MINT_TOKENS_ONE = 50;
    // uint256 public constant MAX_TOKENS_TWO = 1000;
    // uint256 public constant MAX_MINT_TOKENS_TWO = 5;
    ...
    constructor(
        ...
        tokenURI[TOKEN_ID_TWO] = uriTokenTwo;
    }
    ...
    function setDonationAddress(address _newAddress) public onlyOwner {
    ...
    function setPauseStateTwo(bool _pause) public onlyOwner {
        pauseTokenTwo = _pause;
    }

    function mint(uint256 numberOfTokens, uint256 tokenId) external payable {
        require(tokenId > 0, "TokenId must be more than zero");
        require(tokenId < 3, "TokenId must be less than 3");
        ...
        if(tokenId == 2) {
            require(!pauseTokenTwo, "Token Two sale is not active");
            require(TOKEN_TWO_PRICE * numberOfTokens == msg.value, "Incorrect Price");
        }
