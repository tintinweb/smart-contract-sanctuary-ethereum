...
Website: https://www.stealthxcoin.com/

Gitbook: https://stealthy.gitbook.io/stealth-x/
*/
...
contract  StealthX    is Context, IERC20, Ownable {
    ...
    string private _name = 'StealthX  ';
    string private _symbol = 'STHX ';
