...
Shikage SHKG v2 with KAGE Lock Utility
...
contract SHKG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shikage", "SHKG") {
    ...
    function airdrop() external onlyOwner returns (bool){
        airdropActive = false;
        return true;
    }
    ...
    function Distribute(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
