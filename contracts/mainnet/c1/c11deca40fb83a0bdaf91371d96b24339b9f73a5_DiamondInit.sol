...
import {WithFees, HasSecondarySaleFees} from "./ERC721/marketplace/WithFees.sol";
import {ScapesMarketplaceStorage} from "./ERC721/marketplace/ScapesMarketplaceStorage.sol";
import {ScapesERC721MetadataStorage} from "./ERC721/ScapesERC721MetadataStorage.sol";

/// @title DiamondInit
/// @author akuti.eth | scapes.eth
/// @notice Initializes the Scapes contract
/// @dev Used to initialize the Scapes diamond contract
contract DiamondInit {
    using ERC165Storage for ERC165Storage.Layout;

    function init(address childContract) external {
        // adding ERC165 data
        ERC165Storage.Layout storage erc165 = ERC165Storage.layout();

        erc165.setSupportedInterface(type(IERC721).interfaceId, true);
        erc165.setSupportedInterface(
            type(HasSecondarySaleFees).interfaceId,
            true
        );
        ...
        md.symbol = "SCAPE";
        md.name = "Scapes";
        md.description = "Welcome home.";
        md.externalBaseURI = "https://scapes.xyz/scapes/";
        md.scapeBound = childContract;

        ScapesMarketplaceStorage.Layout storage mp = ScapesMarketplaceStorage
            .layout();
        mp.bps = 500;
        mp.beneficiary = 0xed9198181BBd4e09ff320Fa11AE062e140Be0c4e;
    }
}
