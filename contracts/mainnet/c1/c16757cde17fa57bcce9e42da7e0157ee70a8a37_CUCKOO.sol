...
contract CUCKOO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cuckoo"; // 
    string private constant _symbol = unicode"CUCKOO"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xDf3E270Ad36F258f58449696F311AA75120619ac).transfer(ethToSend); //marketing wallet
    }
