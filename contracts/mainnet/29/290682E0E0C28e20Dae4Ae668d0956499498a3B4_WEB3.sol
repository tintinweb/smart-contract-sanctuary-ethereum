...
contract WEB3 is ERC20, Ownable {
    ...
    constructor() ERC20("WEB3", "WEB3") {
        ...
        marketingWallet = address(0xB5d27719a16036dB166B46203943056101bbebad); // set as marketing wallet
        devWallet = address(0x828Ecb8b7a2D990743db9E83b87cAa566d15e911); // set as dev wallet
