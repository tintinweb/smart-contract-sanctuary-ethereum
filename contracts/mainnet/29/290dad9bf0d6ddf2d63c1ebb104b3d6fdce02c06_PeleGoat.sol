...
/**
    Pele Goat ERC20 Token

    https://t.me/PeleGoatERC20
...
contract PeleGoat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x832D9e6ce2F377bBAAC272dcea7fAb45D0cE7683); // Marketing Address
    address payable public multiSigAddress = payable(0x5CCaf835ea1feb615F874Cf50Bb7E2DbF5aDCCf0); // Marketing Address
    address payable public devAddress = payable(0x832D9e6ce2F377bBAAC272dcea7fAb45D0cE7683); // Dev Address
    address payable public liquidityAddress = payable(0x832D9e6ce2F377bBAAC272dcea7fAb45D0cE7683); // Liquidity Address
    ...
    string private constant _name = unicode"Pelé Goat";
    ...
    uint256 public _buyMultiSigFee = 500;
