...
contract Council is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0x4a2b2bC9d79Fc93268F8463cc1328593816A74b3));

    string private _name = "The Council";
    string private _symbol = "Council";
