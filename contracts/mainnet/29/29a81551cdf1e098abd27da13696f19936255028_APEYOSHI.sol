...
contract APEYOSHI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "APEYOSHI";
    string private constant _symbol = "AYOSHI";
    ...
    address payable private _developmentAddress = payable(0x6241932732b36d91102922dF3545C88B0D6B183b); 
    address payable private _marketingAddress = payable(0x167e41D734794294FC30A884df25f94AFf9761c1);
