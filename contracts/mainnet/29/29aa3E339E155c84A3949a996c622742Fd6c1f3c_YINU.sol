...
/* 
    The Warrior Token for the Digital Age. 

    ❀  Stealth Launch, No tokens in the contract. 100% to UniV2.
    ❀  Slippage Recommended: 7%+ (5/5)
    ❀  1% Supply limit per TX for the first 10 minutes.

    ❀  Web:        https://www.yagutoken.com/
    ❀  Yinupaper:  https://tinyurl.com/YAGUTO
    ❀  Twitter:    https://twitter.com/YAGUTO_INU
    ❀  Linktree:   https://linktr.ee/yagutoinu
...
contract YINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Yaguto Inu", "YINU") {
        ...
        marketingWallet = address(0xe6cca06F828afE865D886C0214C04896Cdd16A5B);
        developmentWallet = address(0xe6cca06F828afE865D886C0214C04896Cdd16A5B);
