...
/**
 * @title DIGauImplementationV2
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing DignityGoldImplementation
 ...
 */
contract DIGauImplementationV2 {
    ...
    string public constant name = "DIGau"; // solium-disable-line
    string public constant symbol = "DIGau"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all DIGG at the contract address.
     * This sends the DIGG tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimDIGG() external onlyOwner {
