...
contract TenMagicPremium  is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public mintPrice = 1.00 ether;
    uint256 public maxBalance = 4;
    ...
    function whitelistMint(
        ...
        require(
            totalSupply() + tokenQuantity <= MAX_SUPPLY,
            "Sale would exceed max max supply"
        );
        require(
            totalSupply() + tokenQuantity <= currentSupply,
            "Sale would exceed max current supply"
