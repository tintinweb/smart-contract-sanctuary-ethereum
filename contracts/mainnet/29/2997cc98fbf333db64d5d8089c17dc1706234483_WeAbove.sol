...
contract WeAbove is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 8751;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =5;
    string baseURI = "ipfs://QmaD7iS9iMpVJzhwwxoRUcaM5iMhCs1nRBYm8dM3727bEt/";
    bool paused;



    constructor () ERC721A("WeAbove","WA"){
