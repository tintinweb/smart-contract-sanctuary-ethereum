...
contract LRIP is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "https://mypinata.space/ipfs/QmaTiPhURWZ61yidFqZQ4RBvbmmEF2JfPcKhpQ5fMRvV5y";

  uint256 public maxSupply = 2222;
  uint256 public  MAX_MINTS_PER_TX = 2;
  uint256 public FREE_MINTS = 400;
  ...
  ) ERC721A("Lost Robots In Space", "LRIP") {
