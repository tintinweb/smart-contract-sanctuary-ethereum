...
// File @openzeppelin/contracts/utils/cryptography/Merkle[email protected]
...
contract Bushi is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 300;
    ...
    address[] public withdrawAddresses = [0xa508057216E50e364dadc6e423a7D3De1079Cc24, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xa470057ec97afacc3cbd100c16d308a859de99ea091da035ef61829a92024cbf;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xa508057216E50e364dadc6e423a7D3De1079Cc24, _royaltyAmount);
    }
