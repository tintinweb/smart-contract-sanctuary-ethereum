...
contract SoxialPug is Ownable, ERC721, ReentrancyGuard{
    using Strings for uint256;
    ...
    uint256 public maxPublic = 1; //max total for public mint
    ...
    constructor() ERC721("SoxialPug", "SOXIALPUG") {
