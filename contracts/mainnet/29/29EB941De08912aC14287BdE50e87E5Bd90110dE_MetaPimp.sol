...
� Liq lock, Ownership renounced
  🖥Telegram: https://t.me/MetaPimpEth
  🖥Website: www.MetaPimpToken.com

Pimpin’ is about learning, and capitalizing on the new information
spreading through the Internet every day. Things they don’t always 
teach in the streets.

Pimpin’ is about the modern world, where Brothas and Sistas unite. 
We want to give humanity a chance to be a multi-cultural, multi 
planetary species of Pimp’s alike.
...
contract MetaPimp is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Meta Pimp Inu";//
    string private constant _symbol = "MetaPimp";//
    ...
    uint256 private _taxFeeOnSell = 19;//
    ...
    address payable private _developmentAddress = payable(0x165E34Fd883Aa4680a39Ff693de30771a1485591);//
    address payable private _marketingAddress = payable(0x165E34Fd883Aa4680a39Ff693de30771a1485591);//
