...
contract CHEDELON is Context, IERC20, Ownable {
    ...
    string private _name = "CHEDELON";
    string private _symbol = "CHEDELON";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 100000, "Max Tx Amount cannot be less than 69 Million");
