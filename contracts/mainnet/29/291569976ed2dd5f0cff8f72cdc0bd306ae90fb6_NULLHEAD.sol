...
// | \| || | || |  | |   | U || __| / \ |  \ 
// | \\ || U || |_ | |_  |   || _| | o || o )
// |_|\_||___||___||___| |_n_||___||_n_||__/ 
...
contract NULLHEAD is ERC721A, TheOperatorFilterer {
    ...
    function mint_head(uint256 amount) payable public {
    ...
    function team_mint(address rec, uint256 amount) public onlyOwner {
    ...
    constructor() ERC721A("NULL HEAD", "HEAD") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmYAixf5mcgyo7xuGzUQZEQcDbw1xF68ipesuMd7HmUF7t/", _toString(tokenId), ".json"));
    }
