...
pragma solidity ^0.6.12;
    ...
    contract FenrirInu is Context, IERC20, Ownable {
        ...
        string private _name = 'Fenrir Inu';
        string private _symbol = 'FENRIR';
        ...
        address payable private _developerWalletAddress;
        ...
        constructor (address payable teamWalletAddress, address payable developerWalletAddress) public {
            _teamWalletAddress = teamWalletAddress;
            _developerWalletAddress = developerWalletAddress;
        ...
        function sendETHToTeam(uint256 amount) private {
            ...
            _developerWalletAddress.transfer(amount.div(2));
        }
