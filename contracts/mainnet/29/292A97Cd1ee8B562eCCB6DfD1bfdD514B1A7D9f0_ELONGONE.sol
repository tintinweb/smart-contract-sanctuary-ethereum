...
contract ELONGONE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ELONGONE";//
    string private constant _symbol = "BANNED";//
    ...
    address payable private _developmentAddress = payable(0xa33E404E5995FfB7Ca814577e68FCd93d5E4501C);//
    address payable private _marketingAddress = payable(0xa33E404E5995FfB7Ca814577e68FCd93d5E4501C);//
    ...
    uint256 public _swapTokensAtAmount = 250000000 * 10**9; //
