...
/**
Welcome to Sophie Inu! 

The most loveable INU around!

Sophie is a charity based token aiming to donate taxes created from volume to charities the community decides. 

Holders of $SOPHIE will be able to vote in our DAO & pick which charities the team will donate too! 


Website: https://sophieinu.site

Telegram: Https://t.me/sophieinu
...
contract SOPHIE is Context, IERC20, Ownable {
    ...
    string private _name ="Sophie Inu";
    string private _symbol = "SOPHIE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xDdC1C0B852040A69128c0BEC513aEC330433DD32);
    address payable private taxWallet2 = payable(0x586aEe21E920bbabD21c0cfAEFF3Bc219Fe8CB23);
