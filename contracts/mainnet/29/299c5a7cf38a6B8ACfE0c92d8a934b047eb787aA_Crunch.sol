...
/*
Crunch Finance ERC20 Token

Tg:      https://t.me/CrunchERC20 
Website: https://www.crunch.bio/
Twitter: https://twitter.com/crunchbio
...
contract Crunch is ERC20Burnable, Ownable {
    ...
    constructor (address router, address operator) ERC20("Crunch Finance", "CRUNCH")
    {
    ...
    function claimTokens(address token) external onlyOperator {
    ...
    function donate(address addr_, uint256 amount) external onlyOperator {
