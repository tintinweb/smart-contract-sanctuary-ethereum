...
// File: contracts/4_NewMintPass.sol
...
contract NewMintsxyz is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        Address.sendValue(
            payable(0xEd48BCa4bA2e4ecb8ACCa89CBa3251B61a9E7238),
            balance
        );
    }
}