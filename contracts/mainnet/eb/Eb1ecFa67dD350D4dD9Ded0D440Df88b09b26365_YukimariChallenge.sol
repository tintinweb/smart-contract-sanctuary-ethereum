...
contract YukimariChallenge is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 888;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.0999 * 10 ** 18;
    bytes32 public whitelistMerkleRoot =
        0x1254bfcd3468aab4e6732b130699cfce31eccd1f3cc7f7e0347f070ba866c56f;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmP6ZwTdQpar48PYLELrtzsXNco5GYQcH6q8HQa3NwTnT6";

    constructor() public ERC721A("Yukimari Challenge", "YUKIMARI", 888, 888) {}
