...
contract Consortium is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Consortium", "Consortium") {
     ...
     uint256 totalSupply = 1 * 10 ** 9 * 10 ** decimals();
        ...
        maxTransactionAmount = 10 * 10 ** 6 * 10 ** decimals(); // 1% maxTransactionAmountTxn
    ...
    function ManageBots (address account, bool isBlacklisted) public onlyOwner {
