...
contract xCOPYvv is ERC721A {

    address public owner;

    uint256 public constant maxSupply = 1000;

    uint256 public constant mintPrice = 0.0018 ether;
    ...
    constructor() ERC721A("xCOPY.vv", "xCOPY") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeia24pfzcksfplxy2qo2s5zk52xhvdkswwlmm2iaigdkcpvbz5wqku/", _toString(tokenId), ".json"));
    }
