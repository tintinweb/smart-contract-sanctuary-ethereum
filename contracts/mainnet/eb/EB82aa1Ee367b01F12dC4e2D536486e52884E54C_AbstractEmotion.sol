...
contract AbstractEmotion is ERC721A, TheOperatorFilterer {
    ...
    function mintABE(uint256 amount) payable public {
    ...
    constructor() ERC721A("Abstract Emotion", "Emotion") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmPoLBhRRYLCDQSAaaUfZA1Z6iv855cD8EjrUDq2mqHJYS/", _toString(tokenId), ".json"));
    }
