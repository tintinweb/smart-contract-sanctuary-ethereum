...
contract TheClimb is ERC1155,Ownable(){
    ...
    constructor()  ERC1155("https://gateway.pinata.cloud/ipfs/QmZAdfmSRMF21gcPG4X8DruE55FY4qSBBLg6SgVNz6DpvE") {
        MembershipToken = IERC721(0x83b7261DB8c795701C6fc86D1fcd073ece940E10);
        maxSupply = 5555;
        currentSupply = 0;
        basePrice = 0.02 ether;
        artist = 0xE3B44a6aDF6C3835e69F0DA2f9AED037C9cCc500;
        sale = false;
    }
