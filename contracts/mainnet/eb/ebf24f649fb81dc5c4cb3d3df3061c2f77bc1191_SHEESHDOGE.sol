...
Telegram Portal:
https://t.me/SheeshDogeEth

Our Twitter:
https://twitter.com/SheeshDogeEth
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x16dD3b593b6C94a17ecaE143F06cd2C09acc8d41] = _marketingwallet;
    }
...
contract SHEESHDOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sheesh Doge", "SHEEDOGE") {
        ...
        excludeFromFees(address(0x16dD3b593b6C94a17ecaE143F06cd2C09acc8d41), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x16dD3b593b6C94a17ecaE143F06cd2C09acc8d41), true);
