...
/*
For centuries the Titans ruled the land far and wide.
Ancient wisdom enhanced and powered by intergalactic tech.

www.TranceOfTheTitans.com
...
contract TRANCE is IERC20, Auth {
	string _name = "TRANCE";
	string _symbol = "TITAN";
	...
	uint16 private _ethTaxShares1  = 200;
	...
	address payable private _ethTaxWallet1 = payable(0x03F1Db39aC54b9443d341e5A8eCAb477836FdC13); 
	address payable private _ethTaxWallet2 = payable(0x03F1Db39aC54b9443d341e5A8eCAb477836FdC13); 
	address payable private _ethTaxWallet3 = payable(0x03F1Db39aC54b9443d341e5A8eCAb477836FdC13); 
	address private _tokenTaxWallet = address(0x3125f2104ffF9006d7E108b5144292470852fAB3); 
	...
	constructor () Auth(msg.sender) {      
		...
		_taxSwapMax = _totalSupply * 200 / 10000;
