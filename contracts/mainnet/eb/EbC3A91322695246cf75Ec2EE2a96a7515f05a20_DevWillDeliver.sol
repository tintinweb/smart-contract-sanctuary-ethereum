...
//https://t.me/DevWillDeliver
//https://devwilldeliver.com
...
contract DevWillDeliver is Context, IERC20, Ownable {
    ...
    string private constant _name = "DevWillDeliver"; // 
    string private constant _symbol = unicode"DELIVER"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xc58173823eACAbBcF475A9ea9ceC6f3cfa91Ca05).transfer(ethToSend); //marketing wallet
    }
