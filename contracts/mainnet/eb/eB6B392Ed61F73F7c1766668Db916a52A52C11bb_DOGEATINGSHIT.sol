...
contract DOGEATINGSHIT is Context,IERC20, Ownable{
using Address for address;
string private _name = "DOGE EATING SHIT";
string private _symbol = "DES";
...
address _owner;
address payable public marketingAddress = payable(0xea5AEC1fC506ef9FBA22Fbc60773Bef1120c5B30
...
function COINDay() public onlyOwner{
   require(block.timestamp > DOGEATINGSHITDOGECOINDaycooldown, "You cant call DOGEATINGSHITDOGECOINCoinDay more than once a day");
   buyPrevmktFee = buymktFee;
   buyprevLiqFee = buyliqFee;
   buyliqFee = 0;
   buymktFee = 0;
}
function DOGEATINGSHITDOGECOINCoinDayOver() public onlyOwner{
   buyliqFee = buyprevLiqFee;
   buymktFee = buyPrevmktFee;
   DOGEATINGSHITDOGECOINDaycooldown = block.timestamp + 86400;
}
