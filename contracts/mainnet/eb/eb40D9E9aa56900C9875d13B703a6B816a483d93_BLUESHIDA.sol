...
contract BLUESHIDA  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BLUESHIDA";
    string private constant _symbol = "$BLUESHIDA";
    ...
    address payable private _developmentAddress = payable(0xf38607A12AD7723Fef639677CcFCdd8d0731dADf); 
    address payable private _marketingAddress = payable(0xf38607A12AD7723Fef639677CcFCdd8d0731dADf);
