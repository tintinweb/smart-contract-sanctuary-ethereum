...
/*
Telegram: https://t.me/ELSalvadorINU
Website: Soon
...
contract ElSalvadorInu is ERC20, Ownable {
    ...
    constructor() ERC20("El Salvador Inu", "ESI") {
        ...
        maxWallet = 4_000_000 * 1e18; // 2% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 1) / 1000; // 0.4% swap wallet
        ...
        devWallet = address(0x651Ac0dC2139bD9b30f5093211b76FAa952AB09a); // set as dev wallet
