...
/*
        ...
        Website :   https://shibxai.com/


        Twitter :   https://twitter.com/shibXAIERC


        Telegram :  https://t.me/shibXAIERC
...
contract ShibXAI is Context, IERC20, Ownable { 
    ...
    address payable public Tax_Address = payable(0x976400739f04fD075683eEC377a8b47058C033d6);
    address payable public Developer_Address = payable(0xD63ca77A2B787e40C83E3f4b1Ef91CD4de42c9Fe);

    string public _name = "ShibXAI";
    string public _symbol = "SHIBX";
