...
//https://t.me/TWENTYSEVENTEENISBACK
//www.2017.pro
...
contract back2017 is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 50000000 * 10**8; // 
    uint256 private  TaxSwapAmount = _tTotal * 5 / 100; //
  
    string private constant _name = "2017ISBACK"; // 
    string private constant _symbol = unicode"2017"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xCe20791608E859d8419FCA4a5E6473a1F3f28876).transfer(ethToSend); //marketing wallet
    }
