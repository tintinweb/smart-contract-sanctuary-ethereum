...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x59257a15B1D618F371F151D84072188cA00d76A6];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x59257a15B1D618F371F151D84072188cA00d76A6;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmQUyX4zy3q1e6rFsHVLcTztMP4npqKHPWfBmL3szMNrmU/";
...
// File: contracts/WasterZContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WasterZContract is RamppERC721A {
    constructor() RamppERC721A("WasterZ", "WasterZ"){}
}
