...
/*
Orora - A Degens Wish
Make a wish to the Orora. HODL until the 24/9 before the arrival of the Four Horsemen.

No Tax
No Website
No Community

Token info on: https://medium.com/@orora
*/
...
contract Orora is Context, IERC20, Ownable { 
    ...
    string private constant _name = "A Degens Wish";
    string private constant _symbol = "Orora";
