...
contract OperationCenter {
    ...
    modifier onlyOwner() {
        require(accountCenter != address(0), "CHFRY: accountCenter not setup 2");
        require(
    ...
    {
        require(
            _eventCenterAddress != address(0),
            "CHFRY: address should not be 0"
        );
    ...
    {
        require(
            _connectorCenterAddress != address(0),
            "CHFRY: address should not be 0"
        );
    ...
    {
        require(
            _protocolCenterAddress != address(0),
            "CHFRY: address should not be 0"
        );
