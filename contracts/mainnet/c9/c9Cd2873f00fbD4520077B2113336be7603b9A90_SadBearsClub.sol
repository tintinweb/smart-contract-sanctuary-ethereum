...
contract SadBearsClub is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public whitelistAddressLimit = 3;
  ...
  constructor() ERC721("Sad Bears Club Official", "SBC") {
    setHiddenMetadataUri("ipfs://QmUfHNxDiSPAp3M5MuEsvaiwpszW3MBGiKxhkXyR5BAigS/unrevealed.json");
  }
