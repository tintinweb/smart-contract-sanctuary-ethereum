...
contract COMFY is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 300000 * 10**9; //
  
    string private constant _name = "ComfyHold.org"; // 
    string private constant _symbol = unicode"COMFY"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x46bf96e17ecC84F02d6d74d9f03740eE83F813e8).transfer(ethToSend); //marketing wallet
    }
