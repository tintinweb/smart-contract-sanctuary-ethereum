...
/*  
    ...
    BUFFALO SHOOTER INU
    ERC20 token was created to raise awareness about the victims of mass shootings

    Website: https://shooterinu.com
    
    Telegram: https://t.me/BuffaloInu
...
contract SHOOTERINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Buffalo Shooter Inu";
    string private constant _symbol = "SHOOTERINU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x929E1203DdEBbD530270b9619FFad63F15d3432D);
        deadBlocks = 1;
