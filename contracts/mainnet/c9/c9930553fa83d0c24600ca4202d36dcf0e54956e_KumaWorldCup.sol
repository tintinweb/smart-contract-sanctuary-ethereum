...
/*
Welcome Football and Kuma Fans!
Kuma World Cup: Our mission is to become a bridge between football fans and Blockchain.

https://medium.com/@kumaworldcup
https://twitter.com/KumaWorldCup
https://t.me/kumaworldcup

Tax 5/8
Max Wallet: 3%


Website will be live tomorrow.
...
contract KumaWorldCup is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setSellTax(7,1); //dev tax, liquidity tax
        setTaxWallets(0x1C22F6F5f9efD154F9aa5587984DA7e239E77097); // 
        exclude(msg.sender);
