...
contract GeggsChef is Ownable, ReentrancyGuard {
    ...
    // The block number when GEGGS mining starts.
    ...
    // Update the given pool's GEGGS allocation point. Can only be called by the owner.
    function set(
        uint256 _pid,
        uint256 _allocPoint,
        bool _withUpdate
    ...
    // View function to see pending GEggs on frontend.
    ...
    // Deposit tokens to GEggsChef for GEGGS allocation.
    function deposit(
        uint256 _pid,
        uint256 _amount,
        address _account
    ...
    // Withdraw tokens from GeggsChef.
