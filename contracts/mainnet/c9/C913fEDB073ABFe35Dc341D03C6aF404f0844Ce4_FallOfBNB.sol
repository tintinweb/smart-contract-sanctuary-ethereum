 ...
 * allowances. See {IERC20-approve}.
 */
contract FallOfBNB is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Fall Of BNB";
    string private _symbol = unicode"BNB⬇️";
    ...
    address public marketingWallet = 0x6B75dCC72706F8B1277a94e02DA0dC06EB1BA359;
    uint256 private _numTokensSellToAddToLiquidity = 80 * 10**_decimals;
