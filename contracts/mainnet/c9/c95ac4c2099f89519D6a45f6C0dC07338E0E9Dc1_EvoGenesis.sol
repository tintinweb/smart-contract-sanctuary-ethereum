...
/**
    R(e)volutionary way to end-to-end encryption which is used for communication throught Evo.

    Start chatting, start EVOlving.
*/
...
contract EvoGenesis is Context, IERC20, Ownable {
    ...
    string private constant _name = "EvoGenesis";
    string private constant _symbol = "E-Gen";
