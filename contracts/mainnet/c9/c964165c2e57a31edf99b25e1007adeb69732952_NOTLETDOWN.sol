...
contract NOTLETDOWN is Context, IERC20, Ownable {
    ...
    string private constant _name = "NOT LET YOU DOWN";
    string private constant _symbol = "NOMATTERWHAT";
