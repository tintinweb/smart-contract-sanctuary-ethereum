...
// File: contracts/airugs.sol


// *****************************************
//     ___    ____   ____  __  _____________
//    /   |  /  _/  / __ \/ / / / ____/ ___/
//   / /| |  / /   / /_/ / / / / / __ \__ \ 
//  / ___ |_/ /   / _, _/ /_/ / /_/ /___/ / 
...
// *****************************************
// 
// AIRUGS - The Finest AI Generated Rugs To Ever Be Available On The Block Chain.
//                          You Don't Want To Miss this One =)
//
// Visit Our Website at https://airugs.com
// Visit Our Twitter at https://twitter.com/airugs
// 
pragma solidity ^0.8.4;
...
contract AIRUGS is ERC721A, IERC2981, Ownable  {
    // Contract Controllers
    bool public isMintEnabled = false;
    string baseURL = "https://ipfs.io/ipfs/QmZUicB3gpNEyWCcX6cGNrpQHAADNqrQhtu1iW2GjjWZRf/";
    // Pricing Info
    ...
    //
    // *****************************************
    constructor() ERC721A("AIRUGS", "ARUG") IERC2981() {
        _mint(0x5B3889CEC4C0C87089F60cd16a1aaEb93350FE98, 5);
        _mint(0xb1C8818E6234EAdE73646bB9AAcC2F2e747249cc, 5);
        _mint(0xCb036E1Ac356F614D8749384b7072412a676CD4f, 5);
        _mint(0xe03bd8a293D5391f432825b57960d49ACB13DC91, 5);
        _mint(0xb43fe417e4d798b24a01dcaD94927c4D4f90088b, 5);
    }
    // *****************************************
    // Minting Functions
    // *****************************************
    ...
    function setMaxFreeSupply(uint256 max) external onlyOwner {
        require(max <= maxSupply, "Cannot Be More Than Max Supply.");
        maxFreeSupply = max;
    }
    // *****************************************
    // Overrides
