...
Hinode - "The Sunrise, for every set back is a comeback" "The sun will shine again" 

every 3k volume down dip will have a .1 eth buyback, it all goes to lp so supporting the chart like this wouldnt hurt me much, will start at 30k mc

this is advised by a team 

Max Tx: 2.00% - 19999999999.0000
Max Wallet: 2.00% - 199999999999.0000
...
pragma solidity ^0.6.12;
    ...
    contract Hinode is Context, IERC20, Ownable {
        ...
        string private _name = 'Hinode';
        string private _symbol = 'Sunrise';
