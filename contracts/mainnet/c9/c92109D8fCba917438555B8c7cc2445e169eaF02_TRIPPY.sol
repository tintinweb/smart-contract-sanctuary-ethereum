...
contract TRIPPY is Ownable, ERC20 {
    ...
    string constant _name = "TRIPPY";
    string constant _symbol = "TRIPPY";
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function setStructure(uint256 _percentonbuy, uint256 _percentonsell, uint256 _wallettransfer) external onlyOwner {
     ...
     function startTrading() public onlyOwner {
        TradingOpen = true;
        buypercent = 250; // How much percentages the original taxes increase.
        sellpercent = 250;  // How much percentages the original taxes increase.
        transferpercent = 100;
