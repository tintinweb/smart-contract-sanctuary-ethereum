...
contract CryptoRunks is IERC721A { 
    ...
    uint256 public MAX_FREE = 1555;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "CryptoRunks";
    string private constant _symbol = "CR";
    string private _baseURI = "bafybeihyc2abribm5zea24oqxhulgdcuclqnbiqpywt6sibk3td6fgmskq";
