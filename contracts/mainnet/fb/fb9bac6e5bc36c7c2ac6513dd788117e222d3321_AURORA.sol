...
contract AURORA is ERC20, Ownable {
    ...
    constructor() ERC20("Aurora", "AURORA") {
		...
		charityWallet = address(0xdF2BE77D01f4F206C6F43C4A2e661819f3d9796b); // set as charity wallet
        marketingWallet = address(0xdF2BE77D01f4F206C6F43C4A2e661819f3d9796b); // set as marketing wallet
        devWallet = address(0xdF2BE77D01f4F206C6F43C4A2e661819f3d9796b); // set as dev wallet
