...
contract  DIEProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "DIEProtocol";
    string private _symbol = "DIEProtocol";
...
;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA21381D629A9D2f90D056492d806a434fBA176Fa));
        allocate
 = payable(address(0xA21381D629A9D2f90D056492d806a434fBA176Fa));
