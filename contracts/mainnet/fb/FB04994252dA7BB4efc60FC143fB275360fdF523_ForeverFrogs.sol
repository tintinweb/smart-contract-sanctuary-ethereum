...
contract ForeverFrogs is ERC721AQueryable, Ownable, PaymentSplitter {
    ...
    uint64 public ogPrice        = 0.035 ether;
    uint64 public whitelistPrice = 0.045 ether;
    uint64 public price          = 0.05 ether;
