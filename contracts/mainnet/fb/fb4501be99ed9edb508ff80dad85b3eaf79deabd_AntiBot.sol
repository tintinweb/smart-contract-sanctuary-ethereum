...
contract AntiBot is Ownable, IAntiBot {
    ...
    function onPreTransferCheck(
        ...
        require(blacklistCheck(from), "AntiBot: from is in decentralized blacklist");
        require(blacklistCheck(to), "AntiBot: to is in decentralized blacklist");
        return true;
    }
