pragma solidity 0.4.24;
	...
	/*=================================================================
				  _     _                                          
				 | |   | |                                         
	   __ _  ___ | | __| | ___ _ __    _ __ ___   ___   ___  _ __  
	  / _` |/ _ \| |/ _` |/ _ \ '_ \  | '_ ` _ \ / _ \ / _ \| '_ \ 
	 | (_| | (_) | | (_| |  __/ | | | | | | | | | (_) | (_) | | | |
	  \__, |\___/|_|\__,_|\___|_| |_| |_| |_| |_|\___/ \___/|_| |_|
	   __/ |                                                       
	  |___/        
	https://goldenmoon.io/  launch on :
	25th August on 10pm est 
	7pm pst (US Timezone) 
	26th Aug at 9am (South Korea) 
	10am (China)
	...
	*/
	...
	contract GoldenMoon {
			...
			string public symbol = "GoldenMoon";
			...
			uint256 constant internal preLiveIndividualFoundersMaxPurchase_ = 0.4 ether;
			uint256 constant internal preLiveTeamFoundersMaxPurchase_ = 2.8 ether;
		   ...
		   /*===============================
			...
			function ProofOf()
				public
			{
				ambassadors_[0x00C9c7c50db252aE8813A8857f02918933eAdd30  ] = true; //KP 
				ambassadors_[0x00A32C09c8962AEc444ABde1991469eD0a9ccAf7  ] = true; //MS
				ambassadors_[0x0c46117804260339f8fe2b7f62432fe287e2bd2b] = true; //LM
				ambassadors_[0x7A97733B08B6d3AA7944A58719D3c9FBcc6c6c53] = true; //MK
				ambassadors_[0x8d60d529c435e2a4c67fd233c49c3f174afc72a8] = true; //TA
				ambassadors_[0x0050755b5b59202889e971f6ece04debbd99d687] = true; //PX
