...
contract GamestopClassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "GameStop Classic";
    string private constant _symbol = "GMEC";
