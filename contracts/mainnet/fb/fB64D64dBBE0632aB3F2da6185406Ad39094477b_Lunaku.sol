...
- Our advisors will bootstrap the investments in our initial phase. We invest on multiple chains and return the profits to $Lunaku holders.

Tokenomics:
- Buy Tax / Sell Tax: 14%
    - 4% of each buy goes to ETH reflections
...
Twitter:
https://twitter.com/Lunagokuoffical
...
contract Lunaku is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    string _name = "Luna Goku";
    string _symbol = "$Lunaku";
    ...
    address treasuryWallet = address(0xd129063777fA8a7B56Ab67FA9AfB85DB9dFcC2Ce); //change this
