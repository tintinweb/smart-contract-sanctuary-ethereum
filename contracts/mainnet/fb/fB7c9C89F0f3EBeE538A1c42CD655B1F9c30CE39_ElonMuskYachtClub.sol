...
contract ElonMuskYachtClub is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Elon Musk Yacht Club", "EMYC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihgbxzdizq2bgr46djoxookdldtdy5hk4bfpmgyy4auhvitudamd4/", Strings.toString(tokenId), ".json")
            );
    }
