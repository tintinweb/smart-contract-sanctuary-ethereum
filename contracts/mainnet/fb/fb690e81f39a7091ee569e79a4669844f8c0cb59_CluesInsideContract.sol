...
/*
https://life-ankh-death.medium.com/the-ankh-10b26c77c3e3
*/
contract CluesInsideContract is ERC20, Ownable {
    ...
    constructor() ERC20("Ankh", unicode"☥") {
        ...
        uint256 totalSupply = 333_555_777 * 1e18;
        ...
        devWallet = address(0x87bF7a0F83862F36FfEd8bD07A11364A094FEcB2); // set as dev wallet
        ...
        returns (bool)
    {
        ...
        require(
            newAmount <= (totalSupply() * 6) / 1000,
            "Swap amount cannot be higher than 0.6% total supply."
        );
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyDevFee + buyLiquidityFee;
        require(buyTotalFees <= 9, "Must keep fees at 10% or less");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellDevFee + sellLiquidityFee;
        require(sellTotalFees <= 9, "Must keep fees at 10% or less");
    }
