...
// This is the deployment contract of the Company Global Token where mints and contract specific functions are defined. 

pragma solidity ^0.8.0;

import "./coERC777.sol";

contract companyToken is coERC777 {
    constructor(uint256 initialSupply, address[] memory defaultOperators)
        coERC777("Company Token", "SYN", defaultOperators) {
