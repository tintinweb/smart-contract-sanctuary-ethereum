 ...
 *  | |  `\ | | ' | |; |  ; | | |       | |  `\ | |  .'.-.|  .'.-.| '  | |   | |  | |  | ||  .'.-.| |  | |  | || '  | || |  | |       | |  `\ |  
 *  ; '._,' ' ' `-' ;' `-'  | | |       ; '._,' ' '  `-' /'  `-' /' `-'  /   | |  | |  | |'  `-' /| |  | |  | |'  `-' /| |  | |       ; '._,' '  
 *  '.___.'   `.__. `.__.'_.(___)       '.___.'   `.__.'  `.__.'  `.__,'   (___)(___)(___)`.__.'(___)(___)(___)`.__.'(___)(___)       '.___.'   
 * 
 */

/**
 * @title Myth Division Starseed Memoirs Comic Book Series ERC-721 Smart Contract
 */

contract StarseedMemoirsComics is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Starseed Memoirs Comic Book Series", "STRSDCOMIC") {}
