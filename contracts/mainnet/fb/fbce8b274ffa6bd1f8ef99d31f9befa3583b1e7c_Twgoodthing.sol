...
// File: contracts/twgoodthing.sol
...
contract Twgoodthing is Ownable, ERC721A, ReentrancyGuard {
    mapping(address => uint256) public whitelistPurchased;

    struct TwgoodthingConfig {
        bytes32 rootHash;
        bool paused;
        bool isPublicSale;
        bool isPreSale;
    ...
    TwgoodthingConfig public twgoodthingConfig;

    constructor() ERC721A("Twgoodthing", "TWGOODTHING") {
        initConfig( 
    ...
    function initConfig(
        ...
        twgoodthingConfig.rootHash = rootHash;
        twgoodthingConfig.paused = paused;
        twgoodthingConfig.isPublicSale = isPublicSale;
        twgoodthingConfig.isPreSale = isPreSale;
        twgoodthingConfig.preSaleMaxMint = preSaleMaxMint;
        twgoodthingConfig.publicSaleMaxMint = publicSaleMaxMint;
        twgoodthingConfig.publicSalePrice = publicSalePrice;
        twgoodthingConfig.preSalePrice = preSalePrice;
        twgoodthingConfig.maxSupply = maxSupply;
    }
    ...
    function preSaleMint(uint256 quantity, bytes32[] calldata proof)
        ...
        payable
    {
        TwgoodthingConfig memory config = twgoodthingConfig;
    ...
    function publicSaleMint(uint256 quantity) external payable {
        ...
        if (whitelistPurchased[msg.sender] > 0) {
          require(
    ...
    function flipSaleStatus() public onlyOwner {
        twgoodthingConfig.isPreSale = !twgoodthingConfig.isPreSale;
        twgoodthingConfig.isPublicSale = !twgoodthingConfig.isPublicSale;
    }

    function setPaused(bool _state) public onlyOwner {
        twgoodthingConfig.paused = _state;
    }

    function setRootHash(bytes32 _hash) public onlyOwner {
        twgoodthingConfig.rootHash = _hash;
    }
