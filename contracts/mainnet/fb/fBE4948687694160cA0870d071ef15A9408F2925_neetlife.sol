...
contract neetlife is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEETLife"; // 
    string private constant _symbol = unicode"NEET"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x73d5e56463f44653A6f90c4fC102963224b4ac82).transfer(ethToSend); //marketing wallet
    }
