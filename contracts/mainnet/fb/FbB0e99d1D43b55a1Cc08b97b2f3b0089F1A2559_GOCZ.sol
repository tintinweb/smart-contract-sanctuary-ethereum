...
// We support CZ with his latest legal battle against Bloomberg/ Modern Media.
// 
// Buying GOCZ shows your support of CZ’s case against the mainstream media. SAFU. Let’s Go CZ!
// 
// All info in our Telegram group @LetsGoCZ
...
contract GOCZ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xCC551Cb63Ad2dd333dB633715A1B66B755d10109); // Marketing Address
    ...
    string private constant _name = "LetsGoCZ";
    string private constant _symbol = "GOCZ";
