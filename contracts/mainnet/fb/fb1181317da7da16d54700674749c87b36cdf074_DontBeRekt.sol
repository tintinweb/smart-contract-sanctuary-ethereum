...
Don't Be Rekt by the market.

Think twice before opening a position and don't let the fear make you lose your money.

Cryptocurrency is cruel, only the real ones will stay with us.

Tax Fee : 3%

Locked (extended each highter MC) & will be renounced once limits will be removed.
...
contract DontBeRekt is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"DontBeRekt"; ////
    string public constant symbol = unicode"REKT"; ////
