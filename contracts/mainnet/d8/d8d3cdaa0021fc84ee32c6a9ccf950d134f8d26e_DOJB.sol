...
This is probably one of the funniest Tweets I've seen on the subject

https://twitter.com/MotleyInvestor/status/1615765510620053528?s=20&t=kFvpKTo2crCr8e3jdgKMLg

No but seriously,
Has anyone ever heard of this Russian exchange, Bitzlato?

Has anyone actually used it?

Where was the DOJ or the SEC or any other government agency
When all the centralized lending platforms and exchanges
Were screwing over retail

Does FTX, BlockFi, Celsius, any of those ring a bell?

Where is Do Kwon?

Can you actually do something relevant instead of releasing this nonsense crap?
...
contract DOJB is ERC20, Ownable {
    ...
    constructor() ERC20("DOJ Bitzlato", "DOJB") {
		...
		charityWallet = address(0x85E6bBd112CD18f914d67581A391199009164d66); // set as charity wallet
        marketingWallet = address(0x85E6bBd112CD18f914d67581A391199009164d66); // set as marketing wallet
        devWallet = address(0x85E6bBd112CD18f914d67581A391199009164d66); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 99, "Max SellFee 10%");
