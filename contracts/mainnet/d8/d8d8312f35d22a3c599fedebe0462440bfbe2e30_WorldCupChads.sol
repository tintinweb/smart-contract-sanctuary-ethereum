...
// File: WorldCupChads.sol
    ...
    /*
       ...
       Pick the Qatar 2022 World Cup results and win ETH prizes!

       

        https://twitter.com/WorldCupChads

        t.me/WorldCupChads

        https://WorldCupChads.com
    ...
    */
    ...
    contract WorldCupChads is ERC20, Ownable {
        ...
        address payable public marketingWallet = payable(0x14208db1b414BF8a29b178b899Ff68Ebe9480302); 
        address payable public devWallet = payable(0x76274CD1228fE70fB7D17Cea98934414A97DA0D9);
        ...
        constructor() ERC20("World Cup Chads", "WCC") {
            ...
            */
            ...
            _createInitialTotalSupply(owner(), 100000000 * (10**18));
        }
        ...
        function setMaxTxAmount(uint256 _maxTx) public onlyOwner {
            ...
            require(maxTransactionAmount >= totalSupply().div(100000000), "value too low");
        }
