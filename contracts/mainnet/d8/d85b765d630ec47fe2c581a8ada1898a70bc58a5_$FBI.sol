...
//https://medium.com/@footballinu/football-inu-6a5035808601
...
contract $FBI is ERC20, Ownable {
    ...
    constructor() ERC20("$FBI", "Football Inu") {
        ...
        devWallet = address(0x0242435cDEd8454E402Ee5200C3d964Ae1acb6d5); // set as dev wallet
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellDevFee + sellLiquidityFee;
        require(sellTotalFees <= 5, "Must keep fees at 100% or less");
    }
