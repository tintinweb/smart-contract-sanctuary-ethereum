...
Riding the OPTIMUS hype with a baby version.
2% tax in and out that will be used entirely to help and add LP into $OPTIMUS.

TG: https://t.me/BabyOptimusOff

WEB : TBA after launch.
*/
...
interface IRouter {
    ...
    contract BOPTIMUS is ERC20, Ownable{
    ...
    address public marketingWallet = 0x5c6FEE3F6a641bCd368194AF8AB8E87aFb0a7F53;
    address public devWallet = 0x5c6FEE3F6a641bCd368194AF8AB8E87aFb0a7F53;
    ...
    constructor() ERC20("BABY OPTIMUS","BOPTIMUS") {
