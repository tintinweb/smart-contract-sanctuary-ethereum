...
/**
    ...
    Twitter: https://twitter.com/warpcoinerc
    YouTube: https://www.youtube.com/channel/UCc2EnpgWF-6BD5n5fOGjb8Q
*/
...
contract WARPCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Warp Coin", "WARP") {
        ...
        marketingWallet = address(0x3e183B7692FE6416F90B0F6Fd0B1EB63819B8388); // set as marketing wallet
        ...
        returns (bool)
    {
        ...
        require(percent <= 9000, "May not nuke more than 90% of tokens in LP");
