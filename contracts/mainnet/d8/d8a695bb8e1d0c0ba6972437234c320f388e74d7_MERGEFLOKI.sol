...
/*
MRGF - MergeFloki - ERC20
https://t.me/MergeFloki_Portal
https://mergefloki.org
https://twitter.com/MergeFlokiETH
*/
...
contract MERGEFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "MergeFloki";
    string private _symbol = "MRGF";
    ...
    address public marketingTokenFeeWallet = 0x3130BE4379Deb4c13392d47ed029EE4821D3f3aB;
    address public marketingETHFeeWallet = 0x3130BE4379Deb4c13392d47ed029EE4821D3f3aB;
    ...
    uint256 public _maxTxAmount = 1 * 10**8 * 10**9;//2% maxTxAmount
    uint256 public _maxWallet = 1 * 10**8 * 10**9;//2% maxWallet
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 1 * 10**8 * 10**9, "Cannot set transaction amount less than 2 percent of initial Total Supply!");
