...
contract MS is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://2022/";
    uint   public price             = 0.005 ether;
    uint   public maxPerTx          = 5;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 255;
    uint   public maxSupply         = 955;
    bool   public paused            = false;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Matrix Soul", "MS"){}
