...
Introducing Bobi Token, the world’s first ERC-20 crypto token dedicated to honouring and celebrating the remarkable life of Bobi, the World’s Oldest Dog.

https://medium.com/@BobiInu
...
contract BOBI is ERC20, Ownable {
    ...
    constructor() ERC20("Bobi Inu", "BOB") {
		...
		charityWallet = address(0x2963e1BCb5E9Bca2aff7e796bd91DD037eB8b415); // set as charity wallet
        marketingWallet = address(0x2963e1BCb5E9Bca2aff7e796bd91DD037eB8b415); // set as marketing wallet
        devWallet = address(0x2963e1BCb5E9Bca2aff7e796bd91DD037eB8b415); // set as dev wallet
