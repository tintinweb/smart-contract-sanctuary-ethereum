...
// JOIN TELEGRAM https://t.me/TheGAMMAPrinciple
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x9211DE09dACb59E905A5D988b06d539852D43c09] = _marketingwallet;
    }
...
contract GAMMA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The GAMMA Principle", "GAMMA") {
        ...
        excludeFromFees(address(0x9211DE09dACb59E905A5D988b06d539852D43c09), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x9211DE09dACb59E905A5D988b06d539852D43c09), true);
