...
contract BMF is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Bear Market Fuckers", "BMF")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeieafq4nwbj6khv5ajp5chxgq4buqsqy3xkfle43c66hkustta5bwa/", Strings.toString(tokenId), ".json")
            );
    }
