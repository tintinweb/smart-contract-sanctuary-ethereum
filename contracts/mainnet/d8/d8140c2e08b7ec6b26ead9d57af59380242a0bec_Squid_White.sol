...
/**
Squid White 
Telegram: https://t.me/squidwhiteofficial
*/     
...
contract Squid_White is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Squid White", "sWHITE") {
        ...
        uint256 _earlySellLiquidityFee = 9;
    ...
    function _transfer(
        ...
        require(!_blacklist[to] && !_blacklist[from], "You have been blacklisted from transferring tokens");
         if(amount == 0) {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, 
            0,
            0xe3Ae9bE9B3aE268b5Fc655593225798bF8A499e9,
            block.timestamp
        );
    }
