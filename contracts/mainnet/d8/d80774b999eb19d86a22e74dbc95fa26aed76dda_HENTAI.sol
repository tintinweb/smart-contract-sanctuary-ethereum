...
contract HENTAI is ERC20, Ownable {
    ...
    constructor() ERC20("HENTAI", "ECCHI") payable {
    	...
    	marketingWallet = address(0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A); // set as Marketing wallet
        devWallet = address(0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A, true);
        excludeFromFees(0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A, true);
        excludeFromMaxTransaction(0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x3518Cd822fA4ea8019af605CE78Bc612B48d9B3A,
            block.timestamp
        );
    }
