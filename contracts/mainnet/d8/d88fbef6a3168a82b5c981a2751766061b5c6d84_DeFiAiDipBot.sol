...
//DeFi Ai Dip Bot is a new utility bot that helps you to ape dip
//Use case:
//Send you a notification when the token reaches the desired MC ﻿
//Sniper bot that buys token on the desired MC 
...
contract DeFiAiDipBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DeFi Ai Dip Bot";
    string private _symbol = unicode"DeFiADB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xA56a828f653b5326cC03d847bD5D79d23Ab475Bb));
        marketingWallet = payable(address(0x738B3c22518727D8A3Ce21Acfa9466f5b6b44171));
