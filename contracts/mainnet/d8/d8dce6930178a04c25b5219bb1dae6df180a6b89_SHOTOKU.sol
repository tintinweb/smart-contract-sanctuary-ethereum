...
Prince Shōtoku was an influential leader in seventh-century Japan, 
popularly credited with achievements from establishing courtly ranks 
and a constitution to encouraging the spread of Buddhism and sending envoys to China.

Legendary TG: https://t.me/ShotokuTaishiPortal
Legendary Website: https://shotoku-taishi.com
...
contract SHOTOKU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shotoku Taishi";
    string private constant _symbol = "SHOTOKU";
