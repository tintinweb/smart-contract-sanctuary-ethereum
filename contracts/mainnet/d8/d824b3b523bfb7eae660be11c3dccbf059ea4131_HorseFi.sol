...
/**
      New decentralized Horse swap, pure Ho-Fi!
    Connect - finger  - done
 
 Fast, convenient, easy to use, fingerish!
...
contract HorseFi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Horse-Fi";
    string private constant _symbol = "HoFi";
