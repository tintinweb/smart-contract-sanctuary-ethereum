...
contract PandaBears is ERC721A, Ownable {
    using Strings for uint256;

    uint256 private _maxPerTx = 5;
    uint256 private _maxPerWallet = 5;
    uint256 private _maxSupply = 3333;
    uint256 private _earlySupply = 3000;
    bool private _revealed = false;
    bool private _isStarted = false;
    string private _unrevealURI = "ipfs://bafybeicqjabpkmd2aqwfxuutjdnxe4bv3inh3etwxcosdk4w6nyvxinxzq/unreveal.json";
    string private _baseURL = "";
    mapping(address => uint256) private _walletMintedAmount;

    constructor() ERC721A("PandaBears", "PB") {}
    ...
    function mint(uint256 amount) external payable {
        ...
        require(
            _totalMinted() + amount <= _earlySupply,
