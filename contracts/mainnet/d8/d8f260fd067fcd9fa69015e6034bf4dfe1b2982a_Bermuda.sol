...
contract Bermuda is ERC20, Ownable {
    ...
    constructor() ERC20("Bermuda", "Bermuda") {
...
Bermuda Tor (BTOR) is a fully decentralized "Devil's Triangle", providing anonymity & security to all users when depositing ETH into the anonymity pool, followed by a simple withdrawal of the ETH anonymously into any wallet of their choosing, all without cost. 
