...
contract SomethingOverTheRanibow  is Ownable, ERC721A, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721A("Something Over The Ranibow","SOTR", MaxMintPerBatch_, TotalCollectionSize_) {
