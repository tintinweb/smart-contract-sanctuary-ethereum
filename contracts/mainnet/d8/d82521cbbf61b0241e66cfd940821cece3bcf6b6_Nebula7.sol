...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    function lastTokenId() external virtual override returns(uint256){
       return tokenCounter;
    }
    ...
    function contractOwner() external view virtual override returns(address){
        return _owner;
    }
...
contract Nebula7 is ERC721 {
    ...
    constructor (string memory name, string memory symbol, address _transferProxy) ERC721 (name, symbol, _transferProxy){
    }
