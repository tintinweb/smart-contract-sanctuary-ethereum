...
contract HUG is ERC20, Ownable {
    ...
    constructor() ERC20("HugMElon", "HUG") {
		...
		charityWallet = address(0x1139254781A985eC95b9591b1Bdf2e38C08A5e48); // set as charity wallet
        marketingWallet = address(0x85C006b3893945b30960805A0c35750b1D45115a); // set as marketing wallet
        devWallet = address(0xe375ba9C4a21A945832B080F7E9eb54b7b77b30a); // set as dev wallet
