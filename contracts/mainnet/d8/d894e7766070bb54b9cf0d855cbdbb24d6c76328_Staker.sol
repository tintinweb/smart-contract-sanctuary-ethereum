...
contract Staker is ERC721Holder, ReentrancyGuard, Ownable {
    ...
    IERC20 public stakingToken20 = IERC20(0x5C9381e67F50A5B1982d8290C60a56fd8A7A0095);
	...
	function addBurnt(address[] memory users, uint16[1] memory ids) external onlyOwner {
        uint16 i;
        uint16 j;
        address old;
        bool newBurner;
