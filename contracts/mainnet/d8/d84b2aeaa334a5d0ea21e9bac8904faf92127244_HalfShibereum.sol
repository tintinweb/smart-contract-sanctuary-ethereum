...
/**
Half Shibereum Moon
https://t.me/HalfShibereum

Half Shibereum Moon Tracker 
@HShibereumTracker_bot
**/
...
contract HalfShibereum is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HALF Shibereum"; 
    string private constant _symbol = "Shibereum0.5"; 
    ...
    uint256 private _taxOnBuy = 70;   
 
    //Sell Fee
    uint256 private _feeOnSell = 0; 
    uint256 private _taxOnSell = 70;  
    ...
    address payable private _developmentWalletAddress = payable(0x1B169062a7BbFccAe6C841709857953Cd914eD6a);
    address payable private _marketingWalletAddress = payable(0x1B169062a7BbFccAe6C841709857953Cd914eD6a);
