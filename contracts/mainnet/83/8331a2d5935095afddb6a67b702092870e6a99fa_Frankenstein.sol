    ...
    Frankenstein tells the story of Victor Frankenstein,
         a young scientist who creates a sapient creature in an unorthodox scientific experiment.
            Shelley started writing the story when she was 18,
                and the first edition was published anonymously in London on 1 January 1818,
                 when she was 20. 
*/
...
contract Frankenstein is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("Frankenstein", "Frankenstein") { // 
        marketingWallet = payable(0x176119cbCA3E619a65f631310E23362aB6E7ea89); // 
        devWallet = payable(0x176119cbCA3E619a65f631310E23362aB6E7ea89); // 
