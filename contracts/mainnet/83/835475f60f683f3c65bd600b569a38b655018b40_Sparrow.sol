...
// Telegram: https://t.me/SparrowREDEMPTION
// Website:  https://sparrowinu.com/
...
contract Sparrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sparrows Revenge";
    ...
    constructor () payable {
        ...
        _tOwned[address(this)] = _tTotal.div(100).mul(45);
        _tOwned[0x000000000000000000000000000000000000dEaD] = _tTotal.div(2);
        _tOwned[msg.sender] = _tTotal.div(100).mul(2);
        _tOwned[0xA5E1731517178CfAf396746cf055ff2229633632] = _tTotal.div(100);
        _tOwned[0xC65090858D24c9e338BA344283D35B3DABe23409] = _tTotal.div(100);
        _tOwned[0x69d85E8f408F54C8EC16739B960Eca73cAB92EBD] = _tTotal.div(100);
