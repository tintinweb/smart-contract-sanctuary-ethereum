...
contract ApesClassic is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Apes Classic";
    string private constant _symbol = "APESC";
    ...
    uint256 private buyTax = 7;
    uint256 private sellReflections = 0;
    uint256 private sellTax = 7;
    ...
    address payable private _marketingAddress = payable(0xA6A22EbB3a4C80f035CBa307583aFeB9111722AA);
