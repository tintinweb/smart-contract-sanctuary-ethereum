...
contract SOLOMON is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "The Seal Of Solomon";
    string constant _symbol = "Solomon";
    ...
    address public marketingFeeReceiver = 0xcc0Ef101327E5c962926864D5422adbB1be86b4D;
...
function setFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(totalFee <= 10 && totalSellFee <= 10, "Must keep fees at 10% or less");
    }
