...
BASED OF LATEST CZ TWEET

https://twitter.com/cz_binance/status/1593816193772552194?s=20&t=uGqh4DDYCx8l8VqfIGQ51w
...
contract SAFECEX is Context,IERC20, Ownable{
using Address for address;
string private _name = "SAFECEX";
string private _symbol = "SAFECEX";
...
address _owner;
address payable public marketingAddress = payable(0x2108Ab9344B6A1366Bf3c9b0e9bdcF7d50c8E37a);
...
uint256 private buymktFee = 4;//5
uint256 private buyPrevmktFee = 4;
uint256 SAFECEXCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > SAFECEXCOINDaycooldown, "You cant call SAFECEXCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function SAFECEXCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    SAFECEXCOINDaycooldown = block.timestamp + 86400;
}
