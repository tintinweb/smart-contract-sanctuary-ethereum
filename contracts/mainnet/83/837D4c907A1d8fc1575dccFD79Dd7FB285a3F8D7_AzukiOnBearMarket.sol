...
contract AzukiOnBearMarket is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_MINTS = 100;
    string public baseURI = "ipfs://Qmdru7f6rJhuGvGeCuLfJYmGwkjUwJKzaPtzoqDFkqXfCk/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Azuki On Bear Market", "AOBM", MAX_MINTS, MAX_SUPPLY) {  
    }
