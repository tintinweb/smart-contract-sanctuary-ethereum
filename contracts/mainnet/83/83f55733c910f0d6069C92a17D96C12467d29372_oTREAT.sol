...
pragma solidity =0.8.18 >=0.8.10 >=0.8.0 <0.9.0;
...
contract oTREAT is ERC20, Ownable {
    ...
    constructor() ERC20("Ordinal Treat", "oTREAT") {
        ...
        marketingWallet = address(0x919b137F165536185D33aCDCDCF3De5678277Cb2); // set as marketing wallet
        devWallet = address(0x919b137F165536185D33aCDCDCF3De5678277Cb2); // set as dev wallet
