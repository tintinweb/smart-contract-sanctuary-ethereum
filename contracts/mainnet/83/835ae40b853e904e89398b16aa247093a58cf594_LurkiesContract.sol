...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmf8T1McTtupEo6BsX1QBgmkmD46TRNF9koWKC9MQproBY/";
...
// File: contracts/LurkiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LurkiesContract is RamppERC721A {
    constructor() RamppERC721A("Lurkies", "LURK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/eJBdrke83FsJpLyQTo7T/contract-metadata";
    }
}
