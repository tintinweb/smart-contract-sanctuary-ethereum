...
contract Macarm is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Macarm Macarm Macarm Macarm Macarm Macarm Macarm";
    string private constant _symbol = unicode"MARCARM";
