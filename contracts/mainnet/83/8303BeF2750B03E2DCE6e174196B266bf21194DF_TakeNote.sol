...
/**
https://t.me/TakeNoteToken

https://twitter.com/TakeNoteToken
*/
...
contract TakeNote is Context, IERC20, Ownable {
    ...
    uint256 public SWAPamount = 1 * 1e12 * 1e9; // 0.1%
    ...
    string private constant _name = "Take Note";
    string private constant _symbol = "TakeNote";
    ...
    constructor () {
        dev = payable(0xe5e9e4e6639eB0d80324C1BDd34eb55BB985d3eC);
        mktg = payable(0x82AA3707c0a30D951cc72284503dF1529D062e11);
