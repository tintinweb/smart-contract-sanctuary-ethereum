...
import {Distributor} from "../claim/abstract/Distributor.sol";
...
abstract contract Distributor is IVotesLite {
  ...
  function getTotalVotes() external override view returns (uint256) {
    // Return total voting power for this distributor across all users
    return (total - claimed) * weightBips / 10000;
  }
...
//   // must be able to claim if initialized
//   function claim(
