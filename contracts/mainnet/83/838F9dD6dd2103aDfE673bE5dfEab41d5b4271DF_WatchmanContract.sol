...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xeDba98cAfC7E9091b7D63CcfC9fb4bb0F93E4e7b];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xeDba98cAfC7E9091b7D63CcfC9fb4bb0F93E4e7b;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 250;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmQNaK47nusqEDAsupcXEryBdTpKCwoMQ9Az3PEo5forUZ/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 666");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 666");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 666");
...
// File: contracts/WatchmanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WatchmanContract is RamppERC721A {
    constructor() RamppERC721A("Watchman ", "Watch"){}
}
