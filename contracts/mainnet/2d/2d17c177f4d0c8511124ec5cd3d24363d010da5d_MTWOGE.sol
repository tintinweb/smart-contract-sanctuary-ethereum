...
contract MTWOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Mini Twoge Inu";
    string private constant _symbol = "MTWOGE";
    ...
    address payable private _opAddress = payable(0xC452c5d3D37DcE3D5AA380cc768c38436668f3D3);
