...
Telegram: https://t.me/thexdie_eth
...
contract TheXDie is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 950_000_000 * 10**_decimals;
    ...
    address public marketingAddress = 0xc0AE55D301318C05c2b66Bb9e7Ef4d13FbdaB291;
    address public devAddress = 0x535dc7043dF5644d547d771dD70A7E67999D8004;

    string private constant _name = "TheXDie";
    string private constant _symbol = "TheXDie";
    ...
    // Owner cannot transfer out TheXDie from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out TheXDie!");
