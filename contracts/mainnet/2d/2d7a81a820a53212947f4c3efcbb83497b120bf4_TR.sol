...
/*
https://twitter.com/cz_binance/status/1585648844217667585
**/
...
contract TR is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = " Thomson Reuters";
    string private constant _symbol = "TR";
    ...
    function newFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
