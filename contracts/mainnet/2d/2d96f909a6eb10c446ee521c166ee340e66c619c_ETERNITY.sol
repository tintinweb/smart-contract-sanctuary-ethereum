...
//  $ETERNITY
    ...
    Financial immortality is not the acquisition of goods 
    but rather learning to live with less than you make 
    so that you can return your money and have money to invest.
...
contract ETERNITY is ERC20, Ownable {
    ...
    constructor() ERC20("SPACE Of ETERNITY", "ETERNITY") {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _DevelopmentFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevelopmentFee;
        require(sellTotalFees <= 19, "Must keep fees at 19% or less");
    }
