...
contract COMMUNITY is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "For The Community";
    ...
    address public marketingWallet = 0xdd64e0c715C0757f69A54C659aa737BD05B04246;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 8, "ERC20: total tax must not be greater than 8");
