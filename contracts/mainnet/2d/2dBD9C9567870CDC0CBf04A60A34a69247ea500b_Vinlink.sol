...
contract Vinlink is ERC20, LockToken {
    ...
    constructor() ERC20("VINLINK", "VINLINK") {
        ...
        developmentWallet = address(0x01bC6C4b50138B5Ce714E102C4C61BE867b860d1); // set as Development wallet
        treasuryWallet = address(0xD777038Ae25BFe2F9E85a7D5B70a5d0091FaA79A); // set as treasury wallet
