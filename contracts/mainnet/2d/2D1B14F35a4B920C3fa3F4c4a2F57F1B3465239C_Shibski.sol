...
contract Shibski is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibski";
    string private constant _symbol = "Shibski";
    ...
    address payable private _developmentAddress = payable(0x982840a5B715459C77Cde78401a32A3a178ce53d); 
    address payable private _marketingAddress = payable(0x982840a5B715459C77Cde78401a32A3a178ce53d);
