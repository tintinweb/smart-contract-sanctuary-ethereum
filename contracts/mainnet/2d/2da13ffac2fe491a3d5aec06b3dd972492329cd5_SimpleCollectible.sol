...
// File: contracts/WallStreetCircle.sol
...
contract SimpleCollectible is ERC1155, Ownable {
    ...
    uint256 private _totalSupply = 550; 

    string private _baseTokenURI;
    string private _baseSuffix;

    constructor () ERC1155 ('')  {
        setBaseURI('ipfs://QmXssTLz5DZbk2QxMeUxWEM5ZmfFrrZq6KngbuJCNaRfj4/');
        setBaseSuffix('.json');
    }
    ...
    function ownerMint(uint256 count, address user) external onlyOwner {
        require(count + tokenCounter < _totalSupply, "Cant mint more than mintMax");
        createCollectibles(user, count);
    }
