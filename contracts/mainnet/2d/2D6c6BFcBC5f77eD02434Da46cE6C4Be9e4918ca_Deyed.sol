...
contract Deyed is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 488;
    uint256 public MAX_FREE = 422;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "Deyed";
    string private constant _symbol = "DEYE";
    string private _baseURI = "QmWjozHV9aqZNp4Yx1s7D54mXMuPtT1mgsqE8esWAjS6Ex";
