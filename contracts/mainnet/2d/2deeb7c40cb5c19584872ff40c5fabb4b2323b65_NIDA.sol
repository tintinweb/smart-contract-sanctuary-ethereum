...
contract NIDA is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x1c3DE6963d30792C67394eEdbcFeBfE9071C624B);
    ...
    constructor() ERC20("NIDA", "NIDA") {
        ...
        */
        _createSupply(owner(), 1000000000000 * (10**9));
    }
