...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x479025391AF8cb9A8ca0F6C51c18E827d25Dc551];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRKjetnaoqigNkerQoDpWZUeS8svJr7YfKjggNESjoA3G/";
...
// File: contracts/Yusoskullv1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Yusoskullv1Contract is RamppERC721A {
    constructor() RamppERC721A("YUSOSKULL V1", "YUSOSKULL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/oE5p2Vbz7tfnD2rvfZyq/contract-metadata";
    }
}
