...
/**
 Telegram: https://t.me/BudgePortal
 Medium: https://medium.com/@BudgeFinance
 Twitter: https://twitter.com/Budge_Finance
*/
...
contract BUDGE is ERC20, Ownable {
    ...
    constructor() ERC20("Budge Finance", "BUDGE") {
        ...
        devWallet = address(0x65fF7c67947D91225827aF4Ed2105CC1be2afA8F); 
    ...
    function updateFees(uint256 _buyLiquidityFee, uint256 _buyMarketingFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
        ...
        sellMarketingFee = _sellMarketingFee;
        sellTotalFees = sellLiquidityFee + sellMarketingFee;
        require( (buyTotalFees + sellTotalFees) < 100, "Check roundtrip");
    } 
