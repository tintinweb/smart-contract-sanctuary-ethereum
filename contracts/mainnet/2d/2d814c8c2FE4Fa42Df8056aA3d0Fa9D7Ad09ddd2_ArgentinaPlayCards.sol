...
contract ArgentinaPlayCards is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
// ================== Variables Start =======================
  ...
  string public hiddenMetadataUri = "ipfs://QmeFJpEUq2Kno7gcyetqh37g3GA1x1htf2nT7Xb7UVBH3K/hidden.json";
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("ArgentinaPlayCards", "APC")  {
    seturi(_uri);
  }
