...
contract DeToadz is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.005 ether;
    uint256 public MAX_SUPPLY = 445;
    uint256 public MAX_MINTS = 1;
    string public baseURI = "ipfs://QmVcDk3kBFyn8HqdY3yTLHgtxuuRGQZU34YW3vYZ3K5Qvh/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("De Toadz", "DETDZ", MAX_MINTS, MAX_SUPPLY) {  
    }
