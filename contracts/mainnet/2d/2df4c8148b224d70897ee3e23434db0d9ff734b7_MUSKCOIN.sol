...
| $$\  $ | $$| $$  | $$ /$$  \ $$| $$\  $$ | $$    $$| $$  | $$  | $$  | $$\  $$$      
| $$ \/  | $$|  $$$$$$/|  $$$$$$/| $$ \  $$|  $$$$$$/|  $$$$$$/ /$$$$$$| $$ \  $$      
|__/     |__/ \______/  \______/ |__/  \__/ \______/  \______/ |______/|__/  \__/      
                                                                                       
                                                                                       
https://t.me/musk_coin_portal
...
contract MUSKCOIN is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "MUSKCOIN";
    string private _symbol = "MUSKCOIN";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x8dF8F2490a1C56A6b26eEb8E77dC73dD51f15B5F);
    ...
    uint256 private buymktFee = 6;//4
    uint256 private buyPrevmktFee = 4;
    uint256 MuskCoinDaycooldown = 0;
    bool private tradeEnabled = false;

    
    uint256 private sellliqFee = 2;
    uint256 private sellprevLiqFee = 2;
    uint256 private sellmktFee = 6;
    uint256 private sellPrevmktFee = 6;
    ...
    function MuskCoinDay() public onlyOwner{
         require(block.timestamp > MuskCoinDaycooldown, "You cant call MuskCoinDay more than once a day");
    ...
    function MuskCoinDayOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         MuskCoinDaycooldown = block.timestamp + 86400;
    }
