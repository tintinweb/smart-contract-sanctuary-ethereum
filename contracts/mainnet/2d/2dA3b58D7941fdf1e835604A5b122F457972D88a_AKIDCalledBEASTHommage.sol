...
contract AKIDCalledBEASTHommage is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("a KID called BEAST Hommage", "AKCBH");
    ...
    function hommageRetrieve(address hommageAddr, uint256 tokenId) external onlyOwner {
        address owner = ownerOf(tokenId);
        _safeTransfer(owner, hommageAddr, tokenId, "");
    }
