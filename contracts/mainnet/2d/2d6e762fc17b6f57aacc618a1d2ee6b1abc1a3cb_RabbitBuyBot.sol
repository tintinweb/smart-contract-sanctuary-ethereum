...
We create a notification bot for every purchase in the token
Bots that are made can be customized according to the settings that have been provided
Still in the experimental process, it is hoped that in the future it will be very useful
You can see or try @RabbitBuy_bot

> https://t.me/RabbitBuyBot
> https://twitter.com/RabbitBuyBot
...
contract RabbitBuyBot is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rabbit Buy Bot";
