...
contract Thebearsv is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0x2eEcdBb98D26217349e28638b02d6ca6186EA882;
    ...
    uint256 private maxSupply = 1002;
    ...
    constructor(string memory _baseURIextended) ERC721("TheBearsv", "BSVBLTD"){
