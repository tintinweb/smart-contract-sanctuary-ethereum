...
contract MadManga is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xE0e95c5Bf4EEC2fD9ce6C9CEfb7225d83FE3C098));

    string private _name = "MadManga";
    string private _symbol = "MadManga";
