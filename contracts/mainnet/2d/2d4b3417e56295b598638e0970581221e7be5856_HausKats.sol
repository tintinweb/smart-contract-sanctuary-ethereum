...
// File: contracts/HausKats.sol

pragma solidity >=0.8.12 <=0.8.17;

contract HausKats is ERC721A, Ownable, ReentrancyGuard, ERC2981, DefaultOperatorFilterer {
    ...
    address payable public withdrawalAddress = payable(0x5247E913433ec2237881eF0C590a9CF206FAc8f8);
    ...
    string public notRevealedMetadataURL = "ipfs://bafybeieu6kvsyf657mrik6iatjwglhjruab2sn6i6xzko67tc2jqcxdohi/HausKats.json";

    /// @notice Collection max supply.
    uint256 public maxSupply = 10000;

    constructor() ERC721A("Haus Kats","HK") {}
