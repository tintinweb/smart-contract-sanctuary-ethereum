...
contract Abstract is ERC721A, DefaultOperatorFilterer, Ownable {
  enum SaleStates {
    CLOSED,
    PUBLIC,
    WHITELIST
  ...
  address public partnerAddress = 0xb3E362548ad2c51f3494cD07A354D26e6011CD36;

  constructor() ERC721A("Abstract", "Abstract") {
