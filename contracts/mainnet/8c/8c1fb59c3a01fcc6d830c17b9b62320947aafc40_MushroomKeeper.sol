...
/**
The Mushroom Keeper - $MUSH

In a far land, there was a giant, two meters tall, and half a meter wide. 
His oily hair stank like nothing else. Big blue eyes and a funny smile, things which are the most appreciable in his outlook. 
Well, yes, that was a Mushroom Keeper - MUSH.

The notorious mushroom - sweet and sour, yet poisonable. Unlucky ones have never survived to tell a story.

The question is whether you will hold back or try it. Think carefully and maybe you will see the continuation of this story...
*/
...
contract MushroomKeeper is ERC20, Ownable {
    ...
    constructor() ERC20("Mushroom Keeper", "MUSH") {
		...
		charityWallet = address(0x8E712AA66E7509E6e466113764436E2e68D0D510); // set as charity wallet
        marketingWallet = address(0x8E712AA66E7509E6e466113764436E2e68D0D510); // set as marketing wallet
        devWallet = address(0x8E712AA66E7509E6e466113764436E2e68D0D510); // set as dev wallet
