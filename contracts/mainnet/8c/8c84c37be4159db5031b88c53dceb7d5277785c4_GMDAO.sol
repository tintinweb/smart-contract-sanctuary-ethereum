...
contract GMDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buyTxFee = 4;
    uint256 public sellTxFee = 4;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTax;

    uint256 public _tTotal = 10**12 * 10**9;                         // 466 billion
    ...
    constructor(address _dev) public ERC20("gmDAO", "GMDAO") {
