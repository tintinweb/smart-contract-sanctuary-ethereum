...
contract CheckInvadersERC721A_V2 is
    OwnableUpgradeable,
    ...
    ERC721AUpgradeable
{
    ...
    */
    ...
    event UpdateExpiration(uint256);
    ...
    */
    ...
    function setExpiresAt(uint256 expiresAt_) public onlyOwner {
        _setExpiresAt(expiresAt_);
        emit UpdateExpiration(expiresAt_);
    }
    ...
    */
    ...
    function _setExpiresAt(uint256 expiresAt_) internal {
