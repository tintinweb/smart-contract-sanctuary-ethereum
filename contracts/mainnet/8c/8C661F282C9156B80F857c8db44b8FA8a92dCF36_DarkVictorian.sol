...
contract DarkVictorian is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 10000;
    uint256 Allremain = 10000;
    uint256 public price = 0.003 ether; 
    uint256 MintForWallet = 10000;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = "ipfs://QmYCN4g8ye3usTEM4CAT6KNN1hLR2narpvTYJzcHmVfbMA/" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("Dark Victorian", "DV") {}
