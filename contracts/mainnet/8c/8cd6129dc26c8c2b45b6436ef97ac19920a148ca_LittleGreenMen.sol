...
// File: contracts/LittleGreenMen.sol


// Little Green Men NFT.  From 8BallLabs.
...
contract LittleGreenMen is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  constructor() ERC721("Little Green Men", "LGM") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    // proxyRegistryAddress = 0x1E525EEAF261cA41b809884CBDE9DD9E1619573A; // rinkeby
    ...
    _initializeEIP712("Little Green Men");
  }
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x37c2349eB90D5E702dBA7480B11Cf9f944ac164F).call{value: address(this).balance}("");
    require(hs);
  }
  ...
  // =================================================================
  // -------------- Opensea/whitelist functionality ------------------
  // =================================================================
  ...
  // This is used instead of msg.sender as transactions won't
  // be sent by the original token owner, but by OpenSea.
