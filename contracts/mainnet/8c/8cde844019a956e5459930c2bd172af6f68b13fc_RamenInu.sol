...
contract RamenInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x028F98d6119319b6D5C97a7f0519D11ce1D55Fa3));

    string private _name = "RamenInu";
    string private _symbol = "$RamInu";
