...
contract Hyottoko is Context, IERC20, Ownable {
    ...
    string private constant _name = "FIRE OTTOKO";
    string private constant _symbol = "Hyottoko";
    ...
    uint256 public _maxTxAmount = 200000000 * 10**8;
    uint256 public _maxWalletSize = 200000000 * 10**8;
