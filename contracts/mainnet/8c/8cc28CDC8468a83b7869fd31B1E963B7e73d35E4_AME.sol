...
contract AME is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal * 1 / 100; // 2% of supply
    uint256 public maxWalletAmount = _tTotal * 3 / 100; // 2% of supply
    uint256 public maxBuyFee = 15; 
    uint256 public maxSellFee = 99; 
    ...
    string private constant _name = "Ame-no-Uzume";
    string private constant _symbol = "GODDESTOFDAWN";
