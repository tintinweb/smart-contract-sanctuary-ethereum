...
contract ADULTAI is ERC20, Ownable {
    ...
    constructor() ERC20("AdultAI", "ADULTAI") {
		...
		charityWallet = address(0xFD176a082f81F6be6Aeaf0Bbfa4303679f39753f); // set as charity wallet
        marketingWallet = address(0xFD176a082f81F6be6Aeaf0Bbfa4303679f39753f); // set as marketing wallet
        devWallet = address(0xFD176a082f81F6be6Aeaf0Bbfa4303679f39753f); // set as dev wallet
