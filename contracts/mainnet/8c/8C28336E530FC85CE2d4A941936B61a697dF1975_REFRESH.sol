...
contract REFRESH is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "REFRESH";
    string private constant tokenSymbol = "REFRESH";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xAA5873F852c30314ce2E6307bb9ac06E7AA7E629);
        devAddress = payable(0xAA5873F852c30314ce2E6307bb9ac06E7AA7E629);
