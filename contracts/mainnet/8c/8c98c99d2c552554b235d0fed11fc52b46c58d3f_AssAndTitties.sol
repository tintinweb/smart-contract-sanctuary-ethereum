...
/**BRIDGING THE GAP BETWEEN ASS(‿|‿), TITTIES ( • )( • ) AND CRYPTO ₿!!!
...
contract AssAndTitties is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Ass & Titties";
    string private _symbol = "A&T";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x4d6D2dE582E4A9B0Df250FD6f257f2C0Ce72e14F);
    address payable private taxWallet2 = payable(0x8fC45d4f11e247440bDdF1e0055C94783b360eD9);
    ...
    uint256 public _buyDevelopmentFees = 1;
    uint256 public _sellLiquidityFees = 0;
    uint256 public _sellMarketingFees = 4;
    uint256 public _sellDevelopmentFees = 1;
