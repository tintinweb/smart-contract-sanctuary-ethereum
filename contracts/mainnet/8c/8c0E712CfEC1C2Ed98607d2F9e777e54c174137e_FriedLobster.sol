...
contract FriedLobster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Friend Lobster";
    ...
    uint256 public j_pyroBuy = 1;
    uint256 public j_jeetBuy = 0;

    uint256 public j_liqSell = 1; 
    uint256 public j_burnSell = 1;
    uint256 public j_pyroSell = 1;
    uint256 public j_jeetSell = 3;
    ...
    address payable private scorcherWallet = payable(0x6A497aFd3BaF29061E4ab6Bfb47FbEDC62F4B5BE);
    address payable private jeetWallet = payable(0x6A497aFd3BaF29061E4ab6Bfb47FbEDC62F4B5BE);
