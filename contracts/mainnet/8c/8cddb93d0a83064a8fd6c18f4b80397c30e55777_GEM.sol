...
contract GEM is Context, IERC20, Ownable {
    ...
    string private _name = "This is a Gem";
    ...
    uint256 public _maxTxAmount = 100000000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 990000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 100000000000000000000000 * 10**9;
