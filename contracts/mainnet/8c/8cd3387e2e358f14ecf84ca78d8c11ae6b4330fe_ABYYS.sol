...
contract ABYYS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Made in Abbys";
    string private constant _symbol = "ABYYS";
    ...
    address payable private _developmentAddress = payable(0x24671500FD249C1fd1F3a2a4e7a3CD9Bb24323a1); 
    address payable private _marketingAddress = payable(0x24671500FD249C1fd1F3a2a4e7a3CD9Bb24323a1);
