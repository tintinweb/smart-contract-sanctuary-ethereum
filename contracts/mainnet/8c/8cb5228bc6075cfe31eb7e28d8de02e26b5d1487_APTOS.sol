...
contract APTOS is ERC20, Ownable {
    ...
    constructor() ERC20("APTOS INU", "APTI") {
        ...
        marketingWallet = address(0x32FCEC6c7F4De072DbfC91251d90614D843c03F6); // set as marketing wallet
        devWallet = address(0x32FCEC6c7F4De072DbfC91251d90614D843c03F6); // set as dev wallet
