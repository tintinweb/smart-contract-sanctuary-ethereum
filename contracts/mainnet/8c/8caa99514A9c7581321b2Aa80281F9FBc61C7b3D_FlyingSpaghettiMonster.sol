...
contract FlyingSpaghettiMonster is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("FlyingSpaghettiMonster", "FSM", maxBatchSize_, collectionSize_) {
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xf37FB766aBbBb45F46e00B5d4343cBbE21d33B6b);
