...
contract SQUAWKER is Context, IERC20, ERC20Ownable {
    ...
    address payable private GiveawayWallet;
    ...
    uint256 private _giveawayTax = 1;
    uint256 private _previousGiveawayTax = _giveawayTax;
    ...
    uint256 private _divForLiq = _marketingTax + _liquidityTax + _giveawayTax;
    uint256 private taxBuyMarketing = 0;
    uint256 private taxBuyGiveaway = 1;
    uint256 private taxBuyReflections = 0;
    uint256 private taxBuyLiquidity = 1;
    uint256 private taxSellMarketing = 4;
    uint256 private taxSellGiveaway = 5;
    uint256 private taxSellReflections = 0;
    uint256 private taxSellLiquidity = 6;
	
    uint256 public activeTradingBlock = 0;
    uint256 public earlyBuyPenaltyEnd;
    uint256 public maxTxnAmount;

    bool public oneBuyPerBlock = false;
    bool public limitsOn = false;
    bool private _initiateTrades = true;
    bool public maxWalletOn = false;
    bool private _declog = false;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;

    string private constant _name = "SQUAWKER";
    string private constant _symbol = "SQUAWKER";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x42626C0D46bdaf53d1C078A55D76F040A0EFeCC6);
        GiveawayWallet = payable(0xdf48C51358621246834bc6cbD912994D8075CE52);
        DevWallet = payable(0x8D236E9103D3E84d8ADC6546Ef98ae2bF7343572);
        ...
        _isMaxWalletExclude[GiveawayWallet] = true;
        ...
        _isExcludedMaxTxnAmount[GiveawayWallet] = true;
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityTax + _marketingTax + _giveawayTax).div(10**2);
    }
    ...
    function swapTokens() private lockTheSwap {
        ...
        uint256 totalTokensToSwap = tokensForMarketing + tokensForLiquidity + tokensForGiveaway;
    ...
    function removeAllFee() private {
        if (_reflectionsTax == 0 && _liquidityTax == 0 && _marketingTax == 0 && _giveawayTax == 0) return;
    ...
    function setBuyTax(uint256 _buyLiquidityTax, uint256 _buyReflectionsTax, uint256 _buyMarketingTax, uint256 _buyGiveawayTax) external onlyOwner {
        taxBuyReflections = _buyReflectionsTax;
        taxBuyGiveaway = _buyGiveawayTax;
        taxBuyMarketing = _buyMarketingTax;
        taxBuyLiquidity = _buyLiquidityTax;
    }
    function setSellTax(uint256 _sellLiquidityTax, uint256 _sellReflectionsTax, uint256 _sellMarketingTax, uint256 _sellGiveawayTax) external onlyOwner {
        taxSellReflections = _sellReflectionsTax;
        taxSellGiveaway = _sellGiveawayTax;
    ...
    function setGiveawayAddress(address _giveawayAddress) external onlyOwner {
        require(_giveawayAddress != address(0), "address cannot be 0");
        _isExcludedFromFee[GiveawayWallet] = false;
        GiveawayWallet = payable(_giveawayAddress);
        _isExcludedFromFee[GiveawayWallet] = true;
    }
