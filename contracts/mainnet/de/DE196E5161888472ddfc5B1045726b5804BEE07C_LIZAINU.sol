...
J O I N - T H E - L I Z A - C U L T - N O W
...
contract LIZAINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3333333 * 10**18;

    address payable private _marketingAddress = payable(address(0x8b934850Da36012156036ebC7C2121fa4d3C6e25));

    string private _name = "LIZA INU";
