...
interface ILlamaBoost2{
  function balanceOfBatch(address[] calldata accounts, uint256[] calldata ids) external view returns(uint256[] memory);
}

interface ILlamaVerse2{
  function balanceOf(address) external view returns(uint256);
}

interface ILlamaZoo2{
...
contract LVMintProxy is Delegated, Merkle {
  ILlamaBoost2 public llamaBoost = ILlamaBoost2(0x0BD4D37E0907C9F564aaa0a7528837B81B25c605);
  ILlamaVerse2 public llamaVerse = ILlamaVerse2(0x9df8Aa7C681f33E442A0d57B838555da863504f3);
  ILlamaZoo2 public llamaZoo = ILlamaZoo2(0x48193776062991c2fE024D9c99C35576A51DaDe0);
  ...
  string public name = "WhitelistPing: Proxy";
  string public symbol = "WLP:P";
  ...
  function setLlamaProxies(ILlamaBoost2 boost, ILlamaVerse2 verse, ILlamaZoo2 zoo) external onlyDelegates{
    llamaBoost = boost;
    llamaVerse = verse;
    llamaZoo = zoo;
  }
