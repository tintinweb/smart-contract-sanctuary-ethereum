...
//**  LOOBR NFT Contract */
//** Author Ishanshahzad: LooBr Marketplace Contract 2022.6 */
...
// File contracts/interfaces/IMRNFT.sol
...
contract LNFT is IMRNFT, ERC721Enumerable, ERC721URIStorage, IERC2981, Ownable {
    using Strings for uint256;
    ...
    constructor(address _owner) ERC721("LooBrNFT", "LooBrNFT")  {
    ...
    function mint(address _to, string memory uri) override external  {
     ...
     function multiMint(string[] calldata URIs, address _to) external  {
        ...
        for (uint256 i = 0; i < URIs.length; i++) {
            ...
            emit Minted(msg.sender, _to, URIs[i], tokenId);
        }

        emit MultiMinted(msg.sender, _to, tokenIds, URIs);
    }
