...
contract MoonTools is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "MoonToolsToken";
    ...
    address payable private _developmentAddress = payable(0x9a0279eAAEc121be4291c7fA9BfC817CB69b0bec); 
    address payable private _marketingAddress = payable(0x9a0279eAAEc121be4291c7fA9BfC817CB69b0bec);
    ...
    function MoonToolsRealLaunch(int code) public onlyOwner {
        tradingOpen = code== 10;
        _taxFeeOnBuy = 5;
        _taxFeeOnSell = 5;
    }
