...
contract batchSender {
    ...
    function multisendToken(
        ...
        require(contributors.length <= arrayLimit());
        require(contributors.length == balances.length, "Invalid inputs");
        uint256 total = 0;
    ...
    function multisendEther(
        ...
        require(contributors.length <= arrayLimit(), "Invalid length");
        require(contributors.length == balances.length, "Invalid inputs");
