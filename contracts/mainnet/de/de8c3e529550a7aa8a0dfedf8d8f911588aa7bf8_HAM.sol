...
/**
Ham the chimp also know Ham the Astrochimp, was the first Great Ape launched into space
...
contract HAM is ERC20, Ownable {
    ...
    constructor() ERC20("Ham The Chimp", "$HAM") {
        ...
        marketingWallet = address(0x0Bc36f37E1D9690c3bd934856EFCD7639A47545C); // set as marketing wallet
        devWallet = address(0x0Bc36f37E1D9690c3bd934856EFCD7639A47545C); // set as dev wallet
