...
Laika, a Mongrel Breed, the first dog who entered space. 
Today, he made his comeback to bite off Ryoshi, the founder and creator of Shiba Inu, hidden dirty tail. 

Laika deserve the upmost respect of all and hence we attribute him an “Inu” behind his name. He who deserves it shall be crowned it. 

His Token will be fully community with low taxes. 
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x92C43c91362D7d1d4318cb4D8653dE1fa7cA9991] = _marketingwallet;
    }
...
contract LAIKAINU is ERC20, Ownable {
    ...
    constructor() ERC20("LAIKA INU", "LAINU") {
        ...
        excludeFromFees(address(0x92C43c91362D7d1d4318cb4D8653dE1fa7cA9991), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x92C43c91362D7d1d4318cb4D8653dE1fa7cA9991), true);
