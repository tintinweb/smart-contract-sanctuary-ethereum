...
// FILE 14: GoodBoys.sol

pragma solidity ^0.8.0;

contract GoodBoys is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "ipfs://bafybeib6slxjycam2qvqvgirvgb2lmb3bge4nrfzvefu7tw65pi2srjoni/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("GoodBoys", "GB") {
        setHiddenMetadataUri("ipfs://bafybeib6slxjycam2qvqvgirvgb2lmb3bge4nrfzvefu7tw65pi2srjoni/hidden.json");
    }
