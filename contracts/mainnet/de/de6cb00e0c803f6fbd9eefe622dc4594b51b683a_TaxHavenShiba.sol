...
/**
If it looks familiar, that's not much of a surprise either 
Tax Haven Shiba | $THSHIB tax 0
Tg:https://t.me/taxhavenshiba
...
contract TaxHavenShiba is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tax Haven Shiba", "THSHIB") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xD5685c5474cf49f037635a822f90e91A57968BA2); // marketing wallet
        devWallet = address(0xD5685c5474cf49f037635a822f90e91A57968BA2); // dev wallet
