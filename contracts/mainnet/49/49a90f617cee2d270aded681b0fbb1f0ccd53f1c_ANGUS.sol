...
/**
$ANGUS is brought to you by the $NTI team (15 million ATH), $WPI TEAM (2M ATH) AND $ANARCHY TEAM (10M ATH)

Angus is a group bot that helps telegram group to manage their conversations and activities more effectively! 
Angus is the first and only bot that provides all in one solution to manage telegram group conversations, including anti-spam, chart update, auto-message scheduler, mass announcement, and more to come. 
What makes Angus different from the rest is that it can help the admins free up their time, so they could focus on more important things!

TELEGRAM: Https//T.me/AngusETH

Twitter: twitter.com/Angusethereum

Website: http://anguseth.tech
...
contract ANGUS is Context, IERC20, Ownable {
    ...
    string private _name ="Angus";
    string private _symbol = "ANGUS";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xc682c03009fD5CA6d158973C087A5C3E45751FDE);
    address payable private taxWallet2 = payable(0xc682c03009fD5CA6d158973C087A5C3E45751FDE);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (contractTokenBalance >= minimumTokensBeforeSwap*2)
                contractTokenBalance = minimumTokensBeforeSwap*2;
