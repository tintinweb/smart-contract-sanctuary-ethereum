 ...
 * https://eips.ERCereum.org/EIPS/eip-165[EIP].
 *
...
interface IERC165Upgradeable {
     ...
     * https://eips.ERCereum.org/EIPS/eip-165#how-interfaces-are-identified[EIP section]
...
interface IERC721Upgradeable is IERC165Upgradeable {
     ...
     *
     * WARNING: Usage of this mERCod is discouraged, use {safeTransferFrom} whenever possible.
     *
     * Requirements:
     *
     * - `from` cannot be the zero address.
 ...
 * @dev See https://eips.ERCereum.org/EIPS/eip-721
 */
...
library AddressUpgradeable {
    ...
    function isContract(address account) internal view returns (bool) {
        // This mERCod relies on extcodesize, which returns 0 for contracts in
     ...
     *
     * https://eips.ERCereum.org/EIPS/eip-1884[EIP1884] increases the gas cost
     ...
     * Requirements:
     *
     * - the calling contract must have an ERC balance of at least `value`.
 ...
 */
 library StringsUpgradeable {
    ...
    function toString(uint256 value) internal pure returns (string memory) {
        ...
        // https://github.com/oraclize/ERCereum-api/blob/b42146b063c7d6ee1358846c198246239e9360e8/oraclizeAPI_0.4.25.sol
...
/**
 * @dev Implementation of https://eips.ERCereum.org/EIPS/eip-721[ERC721] Non-Fungible Token Standard, including
...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    /**
     * @dev Returns whERCer `tokenId` exists.
     *
    ...
    /**
     * @dev Returns whERCer `spender` is allowed to manage `tokenId`.
     *
     * Requirements:
     *
     * - `tokenId` must exist.
     ...
     *
     * WARNING: Usage of this mERCod is discouraged, use {_safeMint} whenever possible
     *
     * Requirements:
     *
     * - `tokenId` must not exist.
     ...
     * @return bool whERCer the call correctly returned the expected magic value
     */
...
interface IERC20Upgradeable {
     ...
     *
     * Returns a boolean value indicating whERCer the operation succeeded.
     *
     * Emits a {Transfer} event.
     */
    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize() public initializer  {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("DITMAXNFT", "$DITMAXNFT");
        _tid = 1;
