...
contract Bet is VRFConsumerBaseV2 {
   ...
   function _settleBet(uint256 requestId, uint256 randomNumber) private {
        ...
        if (randomNumber > 55 && randomNumber < 76){
            //50 percent
            uint burnAmount = (_amountWagered/100) *10 ; 
            uint WinAmount1 = (_amountWagered/100) *50 ; 
            uint WinAmount = WinAmount1 - burnAmount; 
            ...
            //2x
            uint burnAmount = (_amountWagered/100) *10 ; 
            uint WinAmount1 = _amountWagered*2;
            uint WinAmount = WinAmount1 - burnAmount; 
            ...
            //4x
            uint burnAmount = (_amountWagered/100) *10 ; 
            uint WinAmount1 = _amountWagered*4;
            uint WinAmount = WinAmount1 - burnAmount; 
        ...
        if (randomNumber > 20 && randomNumber < 71){
            //20 percent
            uint burnAmount = (_amountWagered/100) *10 ; 
            uint WinAmount1 = (_amountWagered/100) *20 ; 
            uint WinAmount = WinAmount1 - burnAmount; 
            ...
            //25 percent
            uint burnAmount = (_amountWagered/100) *10 ; 
            uint WinAmount1 = (_amountWagered/100) *25 ;
            uint WinAmount = WinAmount1 - burnAmount; 
        ...
        if (randomNumber > 50 && randomNumber < 91){
            ...
            //3x
            uint burnAmount = (_amountWagered/100) *10 ; 
            uint WinAmount1 = _amountWagered*3;
            uint WinAmount = WinAmount1 - burnAmount; 
