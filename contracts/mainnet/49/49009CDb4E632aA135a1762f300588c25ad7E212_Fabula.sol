...
contract Fabula is IBEP20, Auth {
    ...
    string constant _name = "Fabula";
    string constant _symbol = "FAB";
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingAmountReceiver = 0xc9A7617eb57Fd88792AE46b19Dee479b71E30652;
        projectMaintenanceReceiver = 0xc9A7617eb57Fd88792AE46b19Dee479b71E30652;
    ...
    function takeFee(
        ...
        if (antisnipe) {
            feeAmount = amount.mul(30).div(100);
        } else {
            //buying
            if (pairs[sender]) {
