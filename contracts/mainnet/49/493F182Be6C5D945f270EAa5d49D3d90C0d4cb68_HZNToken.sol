...
contract HZNToken is ERC721ABurnable, ReentrancyGuard, Ownable {
    ...
    uint256 public waitlistBatchTime = 1668193860; // 1.11PM EST
    ...
    function setPrice(uint256 _whitelist, uint256 _waitlist) external onlyOwner {
