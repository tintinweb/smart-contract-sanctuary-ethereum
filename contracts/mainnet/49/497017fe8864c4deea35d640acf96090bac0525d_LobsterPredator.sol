...
/**
    Lobster Predator - 3/3 Tax
    t.me/LobsterPredator
    https://mobile.twitter.com/LobsterPredator
**/
...
contract LobsterPredator is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lobster Predator";
    ...
    uint256 private _maxWalletSize = 300_000 * 10**_decimals;
