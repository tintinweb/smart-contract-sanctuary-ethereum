...
contract HeartOfSteel is Context, IERC20, Ownable {
    ...
    string private _name = "Heart Of Steel";
    string private _symbol = "HOS";
    ...
    uint256 public _maxTxAmount = 8000000000 * 10**9;
