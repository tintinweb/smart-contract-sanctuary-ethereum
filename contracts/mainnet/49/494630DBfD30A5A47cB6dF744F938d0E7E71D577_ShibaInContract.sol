...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x68604806ba711F7Ce0D923FAf3D158A2D684D84D];
  address public erc20Payable = 0x68604806ba711F7Ce0D923FAf3D158A2D684D84D;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 4999) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.shibain.life/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/LMwPhvOMK82Z7doLlym7/contract-metadata";
  }
...
// File: contracts/ShibaInContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ShibaInContract is RamppERC721A {
    constructor() RamppERC721A("Shiba In", "Shiba"){}
}