...
contract FelineFlippers is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public maxSupply = 2500;
	uint256 public Ownermint = 15;
  ...
  constructor(string memory baseURI) ERC721A("FelineFlippers", "FF") {
