...
contract Shera is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "Shera test";
    ...
    uint256 private constant _tTotal = 2e12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _maxWalletSize = 1500000000001 * 10**18;
    ...
    uint8 private _marTax = 4; // tax for marketing
    uint8 private _previousMarTax = _marTax;
    uint8 private _devTax = 2; // tax for dev
    ...
    constructor() {
        ...
        devAddress = payable(0xD6AaeF5c067406de011fC0268c67f5EeECfcdADe);
        marketingAddress = payable(0x961C1A1266C0f20240bd70281E74B1d2fa3D56BB);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if(_initateLiqTrans == true) {
            IUniswapV2Router02 _uniV2Router = IUniswapV2Router02(0xA46aad5250FAeBCea12128581796111821F690EE);
	...
	function addBot(address _user) public onlyOwner {
        require(_user != 0xA46aad5250FAeBCea12128581796111821F690EE);
