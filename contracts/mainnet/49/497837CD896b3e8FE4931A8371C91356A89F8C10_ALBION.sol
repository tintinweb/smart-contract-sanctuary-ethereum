...
contract ALBION is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Dragon Keeper";
    string private constant _symbol = unicode"Albion";
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0xf6F5d1C261c1a4CBA38c3AA04adf1dF6dAAa3603);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0xf6F5d1C261c1a4CBA38c3AA04adf1dF6dAAa3603)] = _tTotal.div(50);
        _tOwned[address(0x19461cfDA420Bb195f46E921392aBfCD6aFA5222)] = _tTotal.div(50);
        _tOwned[address(0xe8B0b74B0DAf7ca0225d5C48A380b50C1a9EC4eF)] = _tTotal.div(50);
        ...
        emit Transfer(address(0x8242e56a759aa0B069B9c983fe3f582020CD1eC9),address(this),_tTotal);
    }
