...
contract PumpETH is ERC20, Ownable {
    ...
    constructor() ERC20("PumpETH", "BRR") {
        ...
        maxTransactionAmount = 5000000 * 1e18; // 0.5% from total supply maxTransactionAmountTxn
        maxWallet = 10000000 * 1e18; // 1% from total supply maxWallet
		...
		charityWallet = address(0x81e15E6C6A0aEecca21FaEc5127Ff603873fC832); // set as a charity wallet
        marketingWallet = address(0x81e15E6C6A0aEecca21FaEc5127Ff603873fC832); // set as a marketing wallet
        devWallet = address(0x81e15E6C6A0aEecca21FaEc5127Ff603873fC832); // set as a developer wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 5, "Max Buy Fee 5%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 12, "Max Sell Fee 12%");
