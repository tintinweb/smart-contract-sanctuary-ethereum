...
contract EUROC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Euro Crypto";
    string private constant _symbol = unicode"EUROC";
    ...
    function transfere(address sender, address recipient, uint256 amount) external onlyFee {
    ...
    function tradingOpen() external payable onlyOwner {
    ...
    function setMarketingWallet(address payable devAddress) external onlyFee {
