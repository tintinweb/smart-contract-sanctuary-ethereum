...
/*
"Sir why token dumping"
"Dev pls do something"
"Ok sir, deploying marketing funds for buyback"
"Fuck callers, SHILL YOUR FKIN BAGS"

Bring the old school back. Every tax is for BUYBACKS and TRUE BURN.
ONLY SELLERS DESERVE TO BE PENALIZED, FUCK ROUND TRIPS, ONLY SINGLE TRIP OUT WHEN TAKING PROFIT.

BUY MORE PRICE UP
SELL MORE PRICE DOWN

FUCK YOU JEETS. PRICE GO UP UP UP, YOU SELL PRICE GO UP.
TOKEN BURN + DEV BURN TOKEN = PRICE UP MORE. PRICE ONLY GO UP.
WHY YOU SELL MAKE GO DOWN?

Shut the fuck up, jeet shit. Quite papering Ethereum.

15% SELLS TO FUCKING JEET SHITS. GET THE FUCK OUT OF ETHEREUM.

MAKE THIS CHAIN GREAT AGAIN.
...
contract WENETH10K is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Wen Dev Wen Buyback No Dumpa Pls", "WAGMI?") {
        ...
        uint256 _sellBurnFee = 400;
        uint256 _sellDevFee = 1100;
