...
/*
Website: https://www.oxideprotocol.com/
Twitter: https://twitter.com/OxideProtocol
Telegram: https://t.me/oxideprotocol
Medium: https://medium.com/@OxideProtocol
Whitepaper: https://oxide-protocol.gitbook.io/oxide-whitepaper/
*/
...
contract Oxide is ERC20, Ownable {
    ...
    event rewardsWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("Oxide Protocol", "OXIDE") {
        ...
        uint256 _buyRewardsFee = 6;

        uint256 _sellMarketingFee = 2;
        uint256 _sellLiquidityFee = 2;
        uint256 _sellRewardsFee = 6;
        ...
        rewardsWallet = address(0xFd09aaCF0417e52023e037f01e6BD3BEFb4d6bD1); 
    ...
    function updateRewardsWallet(address newWallet) external onlyOwner {
        emit rewardsWalletUpdated(newWallet, rewardsWallet);
