...
Revolutionary FOMO-generating protocol on the ERC-20. 
Change history forever - Join the community for the full experience!
...
contract LAD is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Last Doge";
    string private constant _symbol = "LAD";
    ...
    address payable private _developmentAddress = payable(0xdcF68508EAf551405c85e9C25f6746e1C4Db2eA7); 
    address payable private _marketingAddress = payable(0x6a7DC3fF228094B7A394466b8161880631339112);
