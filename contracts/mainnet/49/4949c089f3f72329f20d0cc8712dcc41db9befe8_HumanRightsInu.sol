...
contract HumanRightsInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Human Rights Inu";
    string private constant _symbol = unicode"$HRI";
