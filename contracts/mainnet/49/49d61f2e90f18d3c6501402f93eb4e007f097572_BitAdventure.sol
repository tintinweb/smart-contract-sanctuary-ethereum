...
// File contracts/BitAdventure.sol


contract BitAdventure is ERC721A, Ownable {

    string public baseURI = "ipfs://QmRRDRtXnAWPYcm3vYj24u44BrwYiV2RuvU4gBwMKzvbPt/";
    string public contractURI = "ipfs://QmNSVgv57LeaXWMsQQSwH28Y6TQWGomWuGYgYcXxT3CHKm";
    string public constant baseExtension = ".json";

    uint256 public constant MAX_PER_TX_FREE = 1;
    uint256 public FREE_MAX_SUPPLY = 600;
    uint256 public constant MAX_PER_TX = 10;
    uint256 public constant MAX_PER_WALLET = 0;
    uint256 public constant MAX_SUPPLY = 1215;
    uint256 public price = 0.002 ether;

    bool public paused = true;

    constructor() ERC721A("BitAdventure", "BA") {}
