...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x3de5FC4D3c616742C84A3dd2B94faBA4aF87d774];
  address public erc20Payable = 0x3de5FC4D3c616742C84A3dd2B94faBA4aF87d774;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.burtonsquad.monster/";
...
// File: contracts/BurtonssquadContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BurtonssquadContract is RamppERC721A {
    constructor() RamppERC721A("BURTONS SQUAD", "BS"){}
}