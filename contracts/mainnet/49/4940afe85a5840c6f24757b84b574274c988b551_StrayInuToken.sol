...
contract StrayInuToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stray Inu Token";
    string private constant _symbol = "STRAYINU.";
    ...
    uint256 private _maxWalletSize = 40000000000 * 10**9;
