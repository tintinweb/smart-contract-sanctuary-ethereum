...
contract TestDudes is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant TOTAL_TOKENS = 100; //8888
    uint256 public constant TOTAL_PRIVATE_TOKENS = 10; //100;
    uint256 public constant TOTAL_PUBLIC_TOKENS = TOTAL_TOKENS - TOTAL_PRIVATE_TOKENS;
    uint256 public constant PRICE = 0.001 ether; //0.08 ether;
    ...
    bytes32 public merkleRoot = 0x32dab610d0eb584bcb32772558bdf7199ab0248b7ede2b96f728b74a5157bd03;
    ...
    constructor(
        ...
        require(bytes(name).length != 0, "Must set the contact's name");
        require(bytes(symbol).length != 0, "Must set the contact's symbol");
        require(bytes(baseURI).length != 0, "Must set the contact's baseURI");
        setBaseURI(baseURI);
    ...
    // TODO: REMOVE
    function monsterBudsCheckTrue() public view returns (uint256) {
        return ERC721(0x6317C4CAB501655D7B85128A5868E98a094C0082).balanceOf(0xf3fd9CDe0dC0675bc18dD99210B56D40c4286542); // TeamMonsterBuds
    }
    function monsterBudsCheckFalse() public view returns (uint256) {
        return ERC721(0x6317C4CAB501655D7B85128A5868E98a094C0082).balanceOf(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4); // Random
    }
