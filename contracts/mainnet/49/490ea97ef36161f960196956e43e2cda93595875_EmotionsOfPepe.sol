...
// File: contracts/PepeEmotions.sol
...
contract EmotionsOfPepe is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "";
  uint256  public  Max_Supply = 2400;
  ...
  ) ERC721A("The Many Emotions of Pepe", "MEP") {
