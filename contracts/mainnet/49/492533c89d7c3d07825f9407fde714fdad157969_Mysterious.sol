...
I am mysterious and anonymous.

I have already done 3 projects, which are between 10 and 400k of MC.

Organic growth is the best there is, we don't need to pump & dump on calls.

Low tax : 3%

I will make one telegram group only for Bobby and some Official informations.
...
contract Mysterious is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Mysterious"; ////
    string public constant symbol = unicode"MYST"; ////
