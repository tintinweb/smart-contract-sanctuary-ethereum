...
/*
       ...
       ,'' . O       \              $ C H R P
      / ,-. \      '`|_
      |/--._/` _     \ '.           AI driven influencer marketplace specifically focused on 
      '   /'-|/ \|`\|-`  \          nano-micro influencers - ensuring the best engagement available.
         /   /       \   |
         |  ;    '`  |  .'
         '. |;;      ;  /           Documentation:  https://chirpley.gitbook.io/docs
          \ \ ;     / ,'            Whitepaper:     https://chirpley.gitbook.io/project/
           ;--,   .,--,             Homepage:       https://chirpley.ai/
        __||=|=|./|=|=||___
          `'-'-'  `-'-'`
...
contract CHRP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Chirp AI", "CHRP") {
