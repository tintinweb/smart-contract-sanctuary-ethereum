...
// File contracts/bad/nft.sol

pragma solidity ^0.8.9;

contract HeroWorldCup is ERC721Enumerable, Ownable {
	using Strings for uint256;
	...
	function batchMint(address account, uint256 amount) public returns (uint256[] memory tokenIds) {
		require(minters[_msgSender()] >= amount, "not minter");
