...
contract PulseSwap is ERC20 {
    ...
    constructor(address tokenHolder) public Owned(msg.sender) {
               ...
               name = "PulseSwap";
               symbol = "PSWAP";
              _mint(tokenHolder, 6666666666666 *10**18);
    ...
    require(!blackListed[sender] || !blackListed[msg.sender], "User is blacklisted");
   ...
   function addBlackList (address _blacklist) public whenNotPaused onlyOwner returns (bool) {
       
     blackListed[_blacklist] = true;
       
   }      

   function removeBlackList (address _blacklist) public whenNotPaused onlyOwner returns (bool) {
       
     blackListed[_blacklist] = false;
