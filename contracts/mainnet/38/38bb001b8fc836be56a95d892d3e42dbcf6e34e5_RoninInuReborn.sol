...
/*
Ronin Inu Reborn
On the previous recent episode, a 4000x moonshot led to the devs disabling trades after the LP got thick enough.
What now?

Lets carry on the hype, the name. On the Ethereum chain. Except, this time will be different.

Buys will gain 3% Extra tokens for the first 10mins then removed.
Sells will be punished with 4% Burns and the rest for buybacks to add into LP
for the floor to be raised indefinitely.
...
contract RoninInuReborn is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Ronin Inu Reborn", "RONIN2.0") {
