...
contract UnderSkull is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("Under Skull", "Skull") {
        owner = msg.sender;
        maxPerTx = 10;
        price = 0.002 ether;
        maxSupply = 899;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmShTU34vaM6rZYZ7hEYZVEhpNP3nW8Ro62HziYNHtXcmd/", _toString(tokenId), ".json"));
    }
