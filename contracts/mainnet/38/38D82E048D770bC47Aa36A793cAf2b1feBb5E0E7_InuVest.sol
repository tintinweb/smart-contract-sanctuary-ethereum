...
contract InuVest is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "InuVest DAO";
    string private constant _symbol = "InuVest";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        //max fees should not exceed 95%
        require(redisFeeOnBuy + taxFeeOnBuy <= 95);
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
        require(maxTxAmount >= 500000 * 10**9, "Max TX amount must be bigger than 0.5%!");
        _maxTxAmount = maxTxAmount;
    }
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
        require(maxWalletSize >= 1000000 * 10**9, "Wallet size must be bigger than 1%!");
