...
/*
    ...
    Experience the world through an endless shrooms trip 
    in our metaverse where you will be invited to unite with other 
    holders in order to solve fun trippy challenges and earn ETH rewards.

    https://shroomverse.world
    https://twitter.com/shroom_verse
    https://medium.com/@shroomverse/the-shroomverse-90f6b926eb1
    https://t.me/shroomverseportal
    */
    ...
    contract SVERSE is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        constructor() ERC20("Shroomverse", "SVERSE") {
            ...
            maxTransactionAmount = (totalSupply * 2 / 100) + (2* 1e9); // 2% maxTransactionAmountTxn
            ...
            marketingWallet = address(0x39642E0be322d881f045957F86B998FD4430F11E);
        ...
        function changeLimits() external onlyOwner {
