...
// File: contracts/yeTrumpCards.sol

pragma solidity ^0.8.4;

contract yeTrumpCards is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "https://yetrumpdigitaltradingcards.s3.amazonaws.com/metadata/";
    ...
    uint256 public maxFreeSupply = 2024;

    mapping(address => uint256) public _mintedFreeAmount;

    constructor() ERC721A("Ye x Trump 2024 Digital Trading Cards", "YETRUMP2024") {
        _mint(msg.sender, 1);
    }
