...
contract ShardedNinjas is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "https://ipfs.io/ipfs/QmPWNf8kGEtoy8WwbiFowxZjpvB8gHGFEff6AB4GLPAX6n/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Sharded Ninhas", "SHNJ", MAX_MINTS, MAX_SUPPLY) {  
