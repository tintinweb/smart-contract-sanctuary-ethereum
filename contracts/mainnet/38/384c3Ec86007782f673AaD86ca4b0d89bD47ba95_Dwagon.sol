...
We are about to change everything in backpacking.

Twitter: https://twitter.com/DwagonEth
Telegram: https://t.me/DwagonEth
...
contract Dwagon is ERC20, Ownable {
    ...
    constructor() ERC20("Dwagon", "DWAGON") {
        ...
        maxTransactionAmount = 20000000 * 1e18; // 3% from total supply maxTransactionAmountTxn
        maxWallet = 40000000 * 1e18; // 4% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 30) / 10000; // 0.3% swap wallet
		...
		charityWallet = address(0xB98f184Ec4683F5528B4d904246cC3Cd1C152bbe); // set as charity wallet
        marketingWallet = address(0xB98f184Ec4683F5528B4d904246cC3Cd1C152bbe); // set as marketing wallet
        devWallet = address(0xB98f184Ec4683F5528B4d904246cC3Cd1C152bbe); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 100, "Max SellFee 10%");
