...
contract SATOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bitcointalk";
    ...
    address payable private _developmentAddress = payable(0xcf77B68A2dca34a51694E73291F4B6b0B62C07Eb); 
    address payable private _marketingAddress = payable(0xcf77B68A2dca34a51694E73291F4B6b0B62C07Eb);
