...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9ac3a2C32474C8e68490fA43AFf77aF0AB36d9Da];
  address public erc20Payable = 0x9ac3a2C32474C8e68490fA43AFf77aF0AB36d9Da;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.003 ether;
  uint256 public earlyMintTokenIdCap = 830;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 830) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdzrKU8HkjpGEy4UthKwJGw7ckS1f6EnqXSbUtzcRaKsu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/VM7G3gF7MR78yTe4DNqH/contract-metadata";
  }
...
// File: contracts/RezvContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RezvContract is RamppERC721A {
    constructor() RamppERC721A("Rezv", "Rezv"){}
}
