...
contract FluffyTweets is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Fluffy Tweets", "FT") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 1330;
  ...
  uint256 public constant MAX_SUPPLY = 1330;

  uint256 public constant MAX_MULTIMINT = 1330;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1330 at a time");
