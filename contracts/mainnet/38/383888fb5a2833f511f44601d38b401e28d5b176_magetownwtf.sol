...
contract magetownwtf is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("magetown.wtf", "mage.wtf"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on mage");
    require(totalSupply() + amount < maxSupply + 1,"No more mages");
