...
Offical Socials Sent In Deployer MSG Only
*/
...
contract TheGateKeeper is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Gate Keeper";
    string private constant _symbol = "$TGK";
    ...
    address payable private _developmentAddress = payable(0x5Fd23D69f88F926EF7230f78ADa0d22AAF0184a5);
    address payable private _marketingAddress = payable(0x5Fd23D69f88F926EF7230f78ADa0d22AAF0184a5);
    ...
    uint256 public _maxTxAmount = 1000 * 10**9; //1%
    uint256 public _maxWalletSize = 3000 * 10**9; //3%
    uint256 public _swapTokensAtAmount = 2000 * 10**9; //2%
