...
// File: contracts/nft/AiDogeAvatarNFT.sol
...
contract TruthAidoge is Ownable, ERC721, ERC2981, DefaultOperatorFilterer {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    constructor() ERC721("Truth AIDOGE", "AIDO") {
    }
    ...
    function mint(address to, uint num) public onlyMinter {
