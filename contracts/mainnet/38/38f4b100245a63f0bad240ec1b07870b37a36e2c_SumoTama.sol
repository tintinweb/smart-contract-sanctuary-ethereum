...
/*
  ...
  _____________ ___  _____   ________    ________________      _____      _____   
 /   _____/    |   \/     \  \_____  \   \__    ___/  _  \    /     \    /  _  \  
 \_____  \|    |   /  \ /  \  /   |   \    |    | /  /_\  \  /  \ /  \  /  /_\  \ 
 /        \    |  /    Y    \/    |    \   |    |/    |    \/    Y    \/    |    \
/_______  /______/\____|__  /\_______  /   |____|\____|__  /\____|__  /\____|__  /
        \/                \/         \/                  \/         \/         \/ 
...
contract SumoTama is Context, IERC20, Ownable {
    ...
    address public contractMaker;
    string private _name = "SumoTama";
    string private _symbol = "SUMOTAMA";
    ...
    uint256 public _maxTxAmount = 17000000 * 10**9;
    ...
    function excludeAddFromFee(address account) public {
        require(msg.sender == contractMaker , "You don't have permission ");
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 100000, "Swap Threshold Amount cannot be 100000");
    ...
    function setBotWallets(address[] calldata botwallet) external onlyOwner() {
    ...
    function setFeeToZero() external onlyOwner() {
        _taxFee = 0;
        _liquidityFee = 0;
    }

    function reduceFeeToHalf() external onlyOwner() {
        _taxFee = 1;
        _liquidityFee = 7;
    }
    ...
    function setOriginalFee() external onlyOwner() {
        _taxFee = 1;
        _liquidityFee = 14;
    }
