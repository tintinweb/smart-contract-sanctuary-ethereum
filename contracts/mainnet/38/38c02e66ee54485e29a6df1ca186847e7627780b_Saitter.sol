...
contract Saitter is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Saitter";//
    string private constant _symbol = "Saitter";//
    ...
    address payable private _developmentAddress = payable(0xC8e673A81192641498F46f8C3932784f02480A99);//
    address payable private _marketingAddress = payable(0xC8e673A81192641498F46f8C3932784f02480A99);//
