...
contract NineColourArt is ERC721A, Ownable {
    
    uint256 public immutable batchMintCost = 0.009 ether;
    uint32 public immutable MAX_SUPPLY = 2000;
    ...
    function setColour(string memory uri) public onlyOwner {
        uriPrefix = uri;
    }
    ...
    function burnMint(uint256 amount) public onlyOwner {
