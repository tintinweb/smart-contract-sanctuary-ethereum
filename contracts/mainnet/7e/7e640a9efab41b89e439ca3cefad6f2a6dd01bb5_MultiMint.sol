...
contract MultiMint is ERC721, Ownable {
  ...
  uint256 private ogcost = 0.125 ether;
  uint256 public maxSupply = 9999;
  uint256 public _ogSupply = 999;
  uint256 public maxMintAmountPerTx = 10;
  uint256 public maxMintPerUser = 9999;

  bool public whiteListActive = false;
  mapping(address => bool) public _whitelist;
  address private projectfunds = 0x9b3673fa22fFB86A6A43F0fd0A694DEbD5895F35;
  uint256 public startTime;
  uint256 public _WLstartTime;
  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("FAME", "FAME") {
    setHiddenMetadataUri("ipfs://QmZBSHiZQiU8vcz134FrUnZDbvnwxNviXmwmkpEKK9KeeY/hidden.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if(supply.current() + _mintAmount <= 999){
  ...
  function withdraw() public {
    ...
    (bool hs, ) = payable(projectfunds).call{value: address(this).balance * 70 / 100}("");
    require(hs);
