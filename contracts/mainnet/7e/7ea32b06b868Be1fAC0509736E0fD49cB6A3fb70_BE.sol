...
contract BE is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x5F0B1A7a2C52BEE9F10f0598312166F2B3825C6E); 
    address payable private _marketingAddress = payable(0x5F0B1A7a2C52BEE9F10f0598312166F2B3825C6E);
