...
contract X is ERC20, Ownable {
    ...
    constructor() ERC20("X", "X") {
        ...
        marketingWallet = address(0x5A58f2b62393B05DdA1f41D6F18B6C85E08C1001); // set as marketing wallet
        devWallet = address(0x5A58f2b62393B05DdA1f41D6F18B6C85E08C1001); // set as dev wallet
