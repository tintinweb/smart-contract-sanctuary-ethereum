...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x03315Ab16f73756Cd8f257a9B979692A28A530E8];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x03315Ab16f73756Cd8f257a9B979692A28A530E8;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 5000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmSBqYMd7SnitUL9mSN82zBTnvLuXAGSATUKGxUKuihScJ/";
...
// File: contracts/WarriorsoftheGalaxyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WarriorsoftheGalaxyContract is RamppERC721A {
    constructor() RamppERC721A("Warriors of the Galaxy", "Galaxy"){}
}
