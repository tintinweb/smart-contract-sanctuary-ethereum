...
contract ShibariumSwap is Context, IERC20 {
    ...
    address deployer = 0xc7D0445ac2947760b3dD388B8586Adf079972Bf3;
    address public contract_owner = 0x9D588a93B4fEa54A65C18AD0F7552EBDb60f71f5;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    constructor () public {

        
        _name = "Shibarium Swap";
        _symbol = "ShiSwap";
        _decimals = 18;
        ...
        mount(deployer, initialSupply*(10**18)/10);
        mount(deployer, initialSupply*(10**18)/10);
        mount(deployer, initialSupply*(10**18)/2);
