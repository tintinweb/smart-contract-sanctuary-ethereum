...
contract THEBUDOFDRAGONKINGDOM is ERC20, Ownable {
    ...
    constructor() ERC20(" The Bud of Dragon Kingdom ", "TBDK") {
        ...
        maxTransactionAmount = 3000 * 1e18; // 3% from total supply maxTransactionAmountTxn
        maxWallet = 3000 * 1e18; // 3% from total supply maxWallet
		...
		charityWallet = address(0xEb6e79F8285019143e207Aa184E31F123Eb5B28C); 
        marketingWallet = address(0xEb6e79F8285019143e207Aa184E31F123Eb5B28C); // set as marketing wallet
        devWallet = address(0xEb6e79F8285019143e207Aa184E31F123Eb5B28C); // set as dev wallet
