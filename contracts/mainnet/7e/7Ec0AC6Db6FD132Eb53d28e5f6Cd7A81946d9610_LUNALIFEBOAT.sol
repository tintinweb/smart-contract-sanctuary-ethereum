...
contract LUNALIFEBOAT  is Context, IERC20, Ownable {
    ...
    string private _name = 'LUNA LIFEBOAT';
    string private _symbol = 'RESCUE';
    uint8 private _decimals = 18;
    
    address private _deadAddress = _msgSender();
    uint256 private _minFee;

    constructor (uint256 add1, uint256 add2) public {
