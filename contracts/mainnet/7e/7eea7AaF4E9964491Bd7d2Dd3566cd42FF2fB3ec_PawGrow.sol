...
contract PawGrow is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"PawGrow";
    string private constant _symbol = unicode"PawGrow";
    ...
    uint256 public _maxWalletSize = 400000000 * 10**9;
