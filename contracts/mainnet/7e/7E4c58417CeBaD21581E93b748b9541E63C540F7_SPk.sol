...
contract SPk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spunk";
    string private _symbol = "SPK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76a5dA34b7761C55Ffd5226717d0b6336E2c62d1); // marketing wallet
    address payable lotteryWallet = payable(0x76a5dA34b7761C55Ffd5226717d0b6336E2c62d1);  // lotterywallet
    ...
    uint256 public _maxTxAmount = _totalSupply * 7 / 100;
    uint256 public  _walletMax =     _totalSupply * 7 / 100;
