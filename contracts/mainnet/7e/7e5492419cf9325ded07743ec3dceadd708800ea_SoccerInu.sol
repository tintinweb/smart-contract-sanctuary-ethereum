...
contract SoccerInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3500 * 10**_decimals;
    uint256 public maxTxAmount = 30000 * 10**_decimals;
    ...
    address public marketingAddress = 0x5CB4c2A67C3eCC89dA48d3D72255b9bA8f2D0edF;
    address public buybackAddress = 0x5CB4c2A67C3eCC89dA48d3D72255b9bA8f2D0edF;

    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;  //uniswap v2

    string private constant _name = "SoccerInu";
    string private constant _symbol = "SoccerInu";
