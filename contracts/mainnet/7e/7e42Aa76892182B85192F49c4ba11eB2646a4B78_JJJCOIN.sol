...
contract JJJCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _preventSwapBefore=34;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 100000000 * 10**_decimals;
    string private constant _name = unicode"JJJ COIN";
    string private constant _symbol = unicode"JJJ";
