...
contract FlippedMoonbirds is ERC721, Ownable { 
    ...
    constructor() ERC721("Flipped Moonbirds", "FMB") {}
    ...
    function setTotalFree(uint newSupply) external onlyOwner {
        totalFree = newSupply;
    }
