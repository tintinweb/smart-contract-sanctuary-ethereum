 ...
 * Meifu no Yaoh - $YAOH
 * The Sleeping Hound of the Abyss
 
 * https://www.yaoh.one/
 * https://medium.com/@yaoh_labs/y-a-o-h-210f07d5aaca
 * https://twitter.com/Meifu_Yaoh
 
 * Y>A>O>H is a next-generation cryptocurrency tracker DApp that aims to revolutionize the space with a multi-interface dashboard.
 * No sale limitations, which benefits whales and little fish alike. 
 
   TOKENOMICS:
 * 100,000,000,000 TOTAL SUPPLY (100B YAOH)
 * FIRST TWO MINUTES: 500,000,000 max buy (500M YAOH) / 45-second buy cooldown (these limitations are lifted automatically two minutes post-launch)
 * NO OTHER COOLDOWNS, NO COOLDOWNS BETWEEN SELLS
 * 8% total tax on round-trip
 * No team tokens, no presale, 50% to Vitalik
...
contract YAOH is ERC20, Ownable {
    ...
    constructor() ERC20("Meifu no Yaoh", "YAOH") {
