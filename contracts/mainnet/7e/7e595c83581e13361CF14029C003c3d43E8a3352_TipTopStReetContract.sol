...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x330F94fAA8fCF7e7AA724Bf3768b92f7e5BC7903];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 666;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2222) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmX1uwGQropeC5FR7WVMHUH6J4JG5jnfRspbt1SyLMq6Y8/";
...
// File: contracts/TipTopStReetContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TipTopStReetContract is RamppERC721A {
    constructor() RamppERC721A("TipTop StReet", "TS"){}
}