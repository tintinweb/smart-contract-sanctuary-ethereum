...
contract NOTDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("Not Another Doge Coin", "NOTDOGE") {
        ...
        maxTransactionAmount = 12345678 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 12345678 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xA7549B8AB7d45186c6DC1589b19286aCD0c74209); // set as charity wallet
        marketingWallet = address(0xA7549B8AB7d45186c6DC1589b19286aCD0c74209); // set as marketing wallet
        devWallet = address(0xA7549B8AB7d45186c6DC1589b19286aCD0c74209); // set as dev wallet
