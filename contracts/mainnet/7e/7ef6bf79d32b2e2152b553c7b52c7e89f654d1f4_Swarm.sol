...
contract Swarm is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 300;
    string public baseURI = "ipfs://QmQAptgCARPQ9TEXgcqiEDs5P588qTocron36GMSXAK4vf/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Swarm", "SWARM", MAX_MINTS, MAX_SUPPLY) {  
    }
