...
contract ThePussycats is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicazt2qvz4hyjqvk4z2fvez3swp72o3udqef4undlhqfhuhn5xl5m/", Strings.toString(tokenId), ".json")
            );
    }
