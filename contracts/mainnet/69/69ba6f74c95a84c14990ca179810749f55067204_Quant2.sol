...
Made By The QNT Community Holders.

📱 TELEGRAM : Feel Free To Make One
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable QNT = address(0x4a220E6096B25EADb88358cb44068A3248254675); //QNT
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(QNT).transfer(shareholder, amount);
        }
    }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Claim QNT shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract Quant2 is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Quant2";
    string private constant _symbol = "QNT2";
    ...
    address payable public marketingWallet = payable(0x54FdD827Da49f2e806449839233d573D67e3191f);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForQNT(amountToSwap.div(2));

        uint256 dividends = IERC20(QNT).balanceOf(address(this));

        bool success = IERC20(QNT).transfer(address(distributor), dividends);
    ...
    function swapTokensForQNT(uint256 tokenAmount) private {
