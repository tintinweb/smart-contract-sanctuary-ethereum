...
contract CVNFT is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
	uint256 public SALE_NFT = 2950;
	uint256 public GIVEAWAY_NFT = 50;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION = 7;
	uint256 public MAX_MINT_SALE = 7;
    ...
    constructor() ERC721P("Cyber Vamps NFT", "CVNFT") {}
