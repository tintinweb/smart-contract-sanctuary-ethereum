...
/*
        Offical Telegram: https://t.me/ArcadeEth

        Official Discord: https://discord.gg/agZRdkXHK6

        Official website: https://arcadetoken.io/

        Official Twitter: https://twitter.com/ArcadeEth
...
contract Arcade is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arcade";
    string private constant _symbol = "ARCADE";
    ...
    address payable private _marketingAddress = payable(0x6009E53F6B6dbE2A0AB7D3C9Be5710934ad4660C);
    ...
    uint256 public _maxWalletSize = 100000000 * 10**9;        //100
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if(block.number < startTradingBlock + 3){
                bots[tx.origin] = true;
            }
