...
contract SigilStaking is Ownable {
    ...
    function withdraw(uint256 indexToWithdraw) public {
        ...
        require(block.timestamp - _accountStakingInfo[msg.sender][indexToWithdraw].dateAtStake >= 5184000, "Your tokens must be staked for at least 60 days!");
