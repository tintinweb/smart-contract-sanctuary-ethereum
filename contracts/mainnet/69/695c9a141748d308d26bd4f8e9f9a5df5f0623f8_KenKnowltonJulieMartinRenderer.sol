...
contract KenKnowltonJulieMartinRenderer is ERC721Delegated {
    ...
    function getImage() private pure returns (bytes memory) {
        return
            abi.encodePacked(
                '<svg viewBox="0 0 360 440" width="1440" height="1760" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><style>@font-face {font-family: A; src: url(\'',
                "data:font/woff;base64,"
                "') format('woff');} text{font-family:A;font-size: 8px;fill: black;}</style><rect width='100%' height='100%' fill='white' /><text x='-10'>",
                getTemplate(),
                "</text></svg>"
            );
    }
