...
/**
  All Might
  A power beyond everything
  A power that is invinsible

  https://medium.com/@AllMight
...
contract AllMight is ERC20, Ownable {
    ...
    constructor() ERC20("ALl Might", "All Might") {
        ...
        uint256 totalSupply = 22056078 * 1e18;
        ...
        devWallet = address(0x840c8F1D60BBB2Bb418ecCefB9681482F472773F); // set as dev wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maxTransactionAmount lower than 2%"
        );
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 4) / 100) / 1e18,
            "Cannot set maxWallet lower than 4%"
        );
