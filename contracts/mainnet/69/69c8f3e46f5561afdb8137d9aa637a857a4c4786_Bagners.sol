...
contract Bagners is Ownable, ERC721A {
    ...
    constructor() ERC721A("Bagners", "BAGNER") {
    ...
    function whitelistMint(uint256 _quantity) external mintCompliance() {
        require(
            69 >= totalSupply() + _quantity,
            "GDZ: Not whitelisted."
        );
        uint256 _freeMintedAmount = freeMintedAmount[msg.sender];
        require(
            _freeMintedAmount + _quantity <= 1,
