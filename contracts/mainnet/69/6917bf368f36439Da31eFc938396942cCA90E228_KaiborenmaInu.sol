...
$KAIBO the long lost Ancient Shiba inu Yokai spirit, now on ERC20

https://t.me/KaiborenmaInu
http://kaiborenmainu.site/
...
contract KaiborenmaInu is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "Kaiborenma Inu";
    string private constant _symbol = unicode"$KAIBO";
