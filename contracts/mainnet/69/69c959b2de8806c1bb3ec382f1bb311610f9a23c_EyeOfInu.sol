...
/**
   ...
   We are going to burn 100% of the initial Liquidity - meaning Eye of Inu will be tradeable for ever !! 

   Tax will be 20/40 for Few minutes to dissuade the bots from sniping. It will be gradually reduced until 1/1 & will be renounced.
...
contract EyeOfInu  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Eye Of Inu";
    string private constant _symbol = "EOI";
    ...
    address payable private _developmentAddress = payable(0x028903dFd36b702e5e6b59F20743C73147927533); 
    address payable private _marketingAddress = payable(0x028903dFd36b702e5e6b59F20743C73147927533);
