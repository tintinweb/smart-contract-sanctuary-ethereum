...
contract PassTokenReborn {
    ...
    function PassTokenReborn(address _passFoundation) {
        ...
        require(_passFoundation != 0x0);

        passFoundation = _passFoundation;

        pass = new DSToken("PASS");
        pass.setName("North PASS");
        pass.mint(TOTAL_SUPPLY);
        pass.transfer(passFoundation, TOTAL_SUPPLY);
        pass.setOwner(passFoundation);
    }
}