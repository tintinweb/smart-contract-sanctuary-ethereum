...
// File: contracts/GoblinVsElf.sol
...
contract GoblinVsElfs is ERC721A, Ownable {
  ...
  uint256 public freeMaxMintPerWallet = 3;
  ...
  constructor(string memory baseTokenURI) ERC721A("Goblin Vs Elfs", "GVE") payable {
