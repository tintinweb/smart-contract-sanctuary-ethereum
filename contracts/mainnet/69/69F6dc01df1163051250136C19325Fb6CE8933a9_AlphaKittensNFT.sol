...
contract AlphaKittensNFT is ERC721A, Ownable, RoyaltiesV2Impl, ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs://QmZd2HBVURBkPYbzULxedHQCMsC2hLnfAsiYDcaZBynMTC/';
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(whitelistMintEnabled, 'The VIP Backstage Pass is not open yet'); 
  ...
  function royaltyInfo(uint256 _tokenId, uint256 _salePrice) virtual override external view returns (address receiver, uint256 royaltyAmount) {
