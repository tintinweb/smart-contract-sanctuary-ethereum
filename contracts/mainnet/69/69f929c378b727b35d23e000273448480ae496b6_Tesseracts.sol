...
contract Tesseracts is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRs5sXiaHB3RDrRFqq2RbP2iiTQTEEHPpt3xCCcw2bJcS";
    ...
    constructor(
    ) ERC721A("Tesseracts | by Aki Amida", "TESSERACTS", 100, maxSupply) {
    }
