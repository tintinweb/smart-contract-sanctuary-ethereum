...
At the island, Momotarō and his animal friends penetrated the demons' fort and beat the band of demons into surrendering. Momotarō and his new friends returned home with the demons' plundered treasure and the demon chief as a captive Ozaki.
...
Guys I am launching this coin because I find the Peach boy to be an awesome character, Imagine being born out of a peach, how cool is that and on top of that fighting demons knowing that you are born out of a peach. The nickname speaks for itself Peach Boy. Overall Momotaro is an awesome character.
...
contract MOMOTARO is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Peach Boy";
    string private constant _symbol = "MOMOTARO";
    ...
    address payable private _developmentAddress = payable(0xFf954984155B987F091Af58b3fbf95dB69DC0142); 
    address payable private _marketingAddress = payable(0xFf954984155B987F091Af58b3fbf95dB69DC0142);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy >= 0 && redisFeeOnBuy <= 10, "Buy rewards must be between 0% and 4%");
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 10, "Buy tax must be between 0% and 20%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 10, "Sell rewards must be between 0% and 4%");
