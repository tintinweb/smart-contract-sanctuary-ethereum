...
// File: RainbowStripes.sol

pragma solidity ^0.8.13;


contract RainbowStripes is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  constructor() ERC721A("Rainbow Stripes by Andreotti", "RainbowStripes") payable {
    _mint(msg.sender, 1);
  }
