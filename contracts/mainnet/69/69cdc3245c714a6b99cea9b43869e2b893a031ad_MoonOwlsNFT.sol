...
contract MoonOwlsNFT is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;
  string  public  baseTokenURI = "ipfs://QmUEpwCJk2smphjucTSNhQRHUWRJsTCFmfAR1FuVSK6hvt";
  ...
  constructor() ERC721A("Moon Owls NFT", "MOOWL") {
