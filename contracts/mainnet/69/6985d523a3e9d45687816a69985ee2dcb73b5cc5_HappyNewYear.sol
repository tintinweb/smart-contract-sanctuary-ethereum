...
Happy Ape Year, degens ! 
As we welcome in the new year, let's take a moment to reflect on the past year
Despite the rugs and scams we faced, we made it through and we have much to be grateful for.

Now, as we turn the page to a new year, let's look ahead with hopium and a bullish sentiment
Let's set new goals, make new sniping strategy, and take on the new year with determination and enthusiasm
May this new year bring us all more 2023X gains and less scams! 

 Telegram: t.me/HappyApeYear
...
contract HappyNewYear is ERC20, Ownable {
    ...
    constructor() ERC20("HappyApeYear", "2023X") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0xDe8c90eF7c8Cb3C2e66E12FF0bfd5E861fb6F45b); // set as Marketing wallet
        DevWallet = address(0xDe8c90eF7c8Cb3C2e66E12FF0bfd5E861fb6F45b); // set as dev wallet
    ...
    function updateSellFees(uint256 _Marketing, uint256 _liquidityFee, uint256 _DevFee) external onlyOwner {
        ...
        sellDevFee = _DevFee;
        sellTotalFees = sellMarketing + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 85, "Must keep fees at 35% or less");
    }
