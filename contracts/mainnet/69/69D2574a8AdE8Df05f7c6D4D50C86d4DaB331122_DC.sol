...
/**
 *Submitted for verification at Etherscan.io on XXX
*/
...
contract DC is Context, IERC20, Ownable {
    ...
    string private constant _name = "DC";
    string private constant _symbol = "DC1";
    ...
    address payable private _developmentAddress = payable(0x1ec6793Cde9148bEC6286D1bd87Ed9E53FFbC480); 
    address payable private _marketingAddress = payable(0x1ec6793Cde9148bEC6286D1bd87Ed9E53FFbC480);
