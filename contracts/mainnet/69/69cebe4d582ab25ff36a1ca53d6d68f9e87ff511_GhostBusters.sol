...
/*
 ...
 Twitter: https://twitter.com/GhBusters_token
 Website: https://www.ghostbusterstoken.com/
 Medium: https://medium.com/@ghostbusterstoken
*/
...
contract GhostBusters is ERC20, Ownable {
    ...
    constructor() ERC20("Ghost Busters", "GB") {
        ...
        maxTransactionAmount = 1_000_000 * 1e18; // 1% from total supply
        ...
        prizepotWallet = address(0x20238c8ea49EE613509711537C562bf7cf2eC67C); // set as prizepot wallet
        devWallet = address(0xe15A0529b5b3B63EFaCBFCe16FF02EAAb7ef452d); // set as dev wallet
