...
contract EthereumLicensePlates is ERC721Delegated, ReentrancyGuard {
  using Counters for Counters.Counter;

  constructor(address baseFactory, string memory customBaseURI_)
    ERC721Delegated(
      baseFactory,
      "Ethereum License Plates",
      "ETH PLATES",
      ConfigSettings({
        royaltyBps: 0,
  ...
  {
    allowedMintCountMap[msg.sender] = 26;
  }
  ...
  uint256 public constant MAX_SUPPLY = 30001;
