...
Let's celebrate the return of the cult-classic KFC Double Down, and Diablo IV.
Will open an official Tg before greasy sammies hit hands, or if a community effort takes while I sleep, that's fine too.
B/S tax will settle to 5%, liquidity will be locked for the promo, and ca renounced in short order to pacify TokenSniffer.
...
abstract contract Project {
    ...
    string constant _name = "DoubleDown";
    string constant _symbol = "KFC";
    ...
    uint256 public buyFee             = 75;
    uint256 public buyTotalFee        = buyFee;

    uint256 public swapLpFee          = 31;
    uint256 public swapMarketing      = 43;
 ...
 * MainContract
 */
contract doubledownContract is Project, IERC20, Ownable {
