...
/*
   Website :https://shibfeninu.app
   Telegram:https://t.me/ShibFenInu
   Discord:https://discord.gg/hvccuHad

   
   Tested under:https://ropsten.etherscan.io/address/0x62272E457272cF6c85f32610Ef0eb9418617985e#code
*/
...
contract ShibFenInu is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaBurn";
    string private _symbol = "SHIBURN";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 10;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 15, "Tax fee cannot be more than 15%");
        _taxFee = taxFee;
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 10000000, "Max Tx Amount cannot be less than 10 Million");
