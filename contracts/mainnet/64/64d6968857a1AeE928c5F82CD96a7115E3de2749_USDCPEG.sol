 ...
 * allowances. See {IERC20-approve}.
 */
 contract USDCPEG is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "USDCPEG";
    string private _symbol = "PEGME";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000;
    uint256 public taxForLiquidity = 1; //liquidity tax
    uint256 public taxForMarketing = 3; //marketing tax
    uint256 public maxTxAmount = 10000001 * 10**_decimals;
    uint256 public maxWalletAmount = 20000001 * 10**_decimals;
    address public marketingWallet = 0x94A0EFd9b85Cb9e09C7AaCA8b9C59994d125147F;
