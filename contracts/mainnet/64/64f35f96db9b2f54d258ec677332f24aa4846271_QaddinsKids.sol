...
contract QaddinsKids is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Qaddins Kids", "QK"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on Qaddins Kid");
    require(totalSupply() + amount < maxSupply + 1,"No more Qaddins Kids");
