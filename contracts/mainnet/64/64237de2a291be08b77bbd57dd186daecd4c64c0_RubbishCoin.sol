...
contract RubbishCoin is ERC20, Ownable {
    uint256 public constant MAX_SUPPLY = 50_000_000_000_000 ether;
    uint256 public constant RESERVED_FOR_POOL_SUPPLY = 25_000_000_000_000 ether;
    uint256 public constant HOLDER_SUPPLY = 25_000_000_000_000 ether;

    address public constant ECOSYSTEM_ADDRESS = 0x5E5f5D9Cb7DbB7BD26400EFD1c8f7102e5600A95;

    uint256 public _holderClaimed;
    address public _claimer;

    constructor() ERC20("RubbishCoin", "Rubbish") {
    ...
    function holderClaim(address holder, uint256 amount) external {
        require(_claimer == msg.sender, "RubbishCoin: Not Claimer");
        require(_holderClaimed + amount <= HOLDER_SUPPLY, "RubbishtCoin: Exceed supply");
