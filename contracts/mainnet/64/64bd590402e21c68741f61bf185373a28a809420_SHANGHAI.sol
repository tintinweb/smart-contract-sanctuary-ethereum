...
TG: https://t.me/ShanghaiErc
Twitter: https://twitter.com/ShanghaiErc
Medium : https://medium.com/@ShanghaiErc/shanghai-8abe176e16e1
*/
...
contract SHANGHAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="SHANGHAI";
    string private _symbol = "SHAN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x28B3CA6C4e63344092ABCc275b1fd6FB1cFa0Ceb);
    address payable private taxWallet2 = payable(0x28B3CA6C4e63344092ABCc275b1fd6FB1cFa0Ceb);
    ...
    uint256 public _walletMax = 200 * 10**6 * 10**9;
