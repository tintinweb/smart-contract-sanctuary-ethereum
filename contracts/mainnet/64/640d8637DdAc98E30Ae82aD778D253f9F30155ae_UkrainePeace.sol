...
/*
    TG: https://t.me/UkrainePeace
    WEB: https://ukrainepeacetoken.com/
    TW: https://twitter.com/UkrainePeaceEth
*/
...
contract UkrainePeace is Context, IERC20, Ownable {
    ...
    string private constant _name = "UkrainePeace";
    string private constant _symbol = "$UPEACE";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xC66A4Fb0871fFEFF1F91b2A2a27bAB63Ff561dBB);
        _feeAddrWallet2 = payable(0xa01a7675465F64265F02Ce00A1A121eD5336EaaD);
