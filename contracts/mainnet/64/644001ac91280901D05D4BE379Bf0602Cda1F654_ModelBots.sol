...
contract ModelBots is Context, IERC20, Ownable {
    ...
    uint256 private _totalfees=20;
    uint256 private _swapAfter=10;
    uint256 private _tTxs=0;
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1e9 * 10**_decimals;
    string private constant _name = unicode"Modlbots";
    string private constant _symbol = unicode"MDB";
