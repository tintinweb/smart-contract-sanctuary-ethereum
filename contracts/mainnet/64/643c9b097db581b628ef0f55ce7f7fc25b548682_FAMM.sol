...
contract FAMM  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fuck Around and Make Money";
    string private constant _symbol = "FAMM";
    ...
    address payable private _developmentAddress = payable(0xBD6c493f557388A1318C51d0C6975FFD12decE76); 
    address payable private _marketingAddress = payable(0xBD6c493f557388A1318C51d0C6975FFD12decE76);
