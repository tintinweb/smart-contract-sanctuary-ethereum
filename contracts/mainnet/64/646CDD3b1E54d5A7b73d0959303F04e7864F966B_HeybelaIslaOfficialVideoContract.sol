...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x0A032Cd1433DD23616B94F925CB6c86db6b7f073];
  address public erc20Payable = 0x0A032Cd1433DD23616B94F925CB6c86db6b7f073;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 25) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmULqATJDj5j3T8ayQwRUCHMKrK7rCCVVtUC9MzAKCNABq/";
...
// File: contracts/HeybelaIslaOfficialVideoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HeybelaIslaOfficialVideoContract is RamppERC721A {
    constructor() RamppERC721A("Heybela Isla Official Video", "ISLA"){}
}
