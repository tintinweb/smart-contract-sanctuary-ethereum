...
contract COO is ERC20, Ownable {
    ...
    constructor() ERC20("The Predators Dream", "COO") {
        ...
        uint256 totalSupply = 999999999999999 * 1e18;
        ...
        TreasuryAddress = payable(address(0x48eE6c7541b37e489cd11317A849B2682F805c41));
    ...
    function updateBuyFees(uint256 _treasuryFee, uint256 _liquidityFee) external onlyOwner {
        ...
        buyTotalFees = buyTreasuryFee + buyLiquidityFee;
        require(buyTotalFees <= 10, "Must keep fees less than 10%");
    }
    ...
    function updateSellFees(uint256 _treasuryFee, uint256 _liquidityFee) external onlyOwner {
        ...
        sellTotalFees = sellTreasuryFee + sellLiquidityFee;
        require(sellTotalFees <= 10, "Must keep fees less than 10%");
    }
