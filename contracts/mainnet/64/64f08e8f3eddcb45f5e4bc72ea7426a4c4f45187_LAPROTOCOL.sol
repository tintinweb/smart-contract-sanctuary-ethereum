...
contract LAPROTOCOL is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private Ledger;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _outList;
    string private  _name = "LIQUIDITY ACUTE PROTOCOL";
    string private  _symbol = "LAP";
    uint8 private  _decimals = 18;
    uint256 private _totalSupply = 2e9 * 10 ** _decimals;
    ...
    constructor () {
        ...
        _outList[owner()] = true;
        _outList[address(this)] = true;
        _outList[_msgSender()] = true;
