...
https://thegreatwaveoffkanagawa.com/
...
contract THEGREATWAVEOFFKANAGAWA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("THE GREAT WAVE OFF KANAGAWA", "GAWA") {
    ...
    function RideTheWave() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function DrownBot (address account, bool isBlacklisted) public onlyOwner {
