...
t.me/animalrescueinu
twitter.com/animalrescueinu
https://animalrescueinu.com/
https://animalrescuecorps.org/ 
*/
...
contract ARI is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Animal Rescue Inu";
    ...
    address private AnimalrescuecorpAddress;
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        AnimalrescuecorpAddress = 0xAe19342a1D580C060543F185587613b59728220F;
        ...
        isFeeExempt[AnimalrescuecorpAddress] = true;
    ...
    function changeWallets(
        ...
        AnimalrescuecorpAddress = newMktWallet;
    ...
    function swapBackAndPair() internal lockTheSwap {
        ...
        (bool tmpSuccess1, ) = payable(AnimalrescuecorpAddress).call{
