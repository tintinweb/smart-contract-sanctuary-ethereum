...
contract PepeTouch is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Touch", "PPTouch") {
        ...
        marketingWallet = address(0x9de2Ce1a0783BE051f6d7afc3456Ee5CcbB7F297); // set as marketing wallet
        devWallet = address(0xd54a50a82b2D0038F7df4DdF3A6b1cA42A4577b1); // set as dev wallet
