...
import "@openzeppelin/contracts3/utils/EnumerableSet.sol";
...
contract XFIA is ERC20("XFIA", "XFIA"), Ownable, AccessControl {
  ...
  function mint(address _to, uint256 _amount) public {
    require(hasRole(MINTER_ROLE, _msgSender()), "XFIA::mint: only MINTER role");
    _mint(_to, _amount);
  }
}
