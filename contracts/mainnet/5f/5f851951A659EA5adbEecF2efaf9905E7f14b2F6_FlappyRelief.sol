...
/**
  ...
  DONATION TO TURKEY AND UKRAINE

$FLAPPY  is to tap into the solidarity within the web3 ecosystem and coordinate to bring about a trusted,
 sustainable fund as well as provide support to the wider Turkish disaster fundraising ecosystem.

 Website: https://www.flappyrelief.org
 Twitter: https://twitter.com/FlappyRelief
 Medium: https://medium.com/@flappy.relief
 TG: https://t.me/flappyrelief
...
contract FlappyRelief is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Flappy Relief", "FLAPPY") {
