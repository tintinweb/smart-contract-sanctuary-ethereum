...
Habu is said to be the master snake and Dragon slayer of Sakishima.

Changing to 0/0 tax then locking and renounce.
...
contract Habu is Context, IERC20, Ownable
{
    using SafeMath for uint256;

    address payable public marketingAddress = payable(0x56167031A45cbC6b26c5367f7F1e9118706E377C);
    ...
    string private _name = "Sakishima Habu";
