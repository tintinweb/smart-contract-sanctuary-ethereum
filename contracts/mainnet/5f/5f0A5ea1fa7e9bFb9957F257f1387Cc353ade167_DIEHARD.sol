...
https://t.me/diehardERC
https://twitter.com/DieHardERC20
...
contract DIEHARD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Die Hard";
    string private constant _symbol = unicode"$DIEHARD";
