...
contract REDPILLV2 is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0xa4DC01Dd9cb364bCd6b7016b09A025136655596E);
    ...
    constructor() ERC20("REDPILL V2 ", "PILL") {
    ...
    function setPILLModifier(address account, bool onOrOff) external onlyOwner {
