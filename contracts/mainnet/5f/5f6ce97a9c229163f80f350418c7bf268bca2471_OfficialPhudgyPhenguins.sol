...
contract OfficialPhudgyPhenguins is ERC721A, Ownable {

    uint256 constant public maxSupply = 8888;
    uint256 public mintPrice = 0.0022 ether;
    uint256 constant public MaxMintPerTx = 10;
    uint256 constant public MaxMintPerWallet = 23; 
    uint256 constant public MaxFreeMintPerWallet = 3;

    bool public isSaleLive = true;
    string public baseURI = "ipfs://QmTgCQtL9Eec4uwu3tJajWSmEJjC5AKv1QCkFr33iKm2c3/";
     mapping(address => uint) public addressClaimed;

    constructor() ERC721A("OfficialPhudgyPhenguins", "PhudgyPhenguin") {}
