...
/*
 Telegram - https://t.me/bobafettaentry
 Website - https://bobafetta.app/

 -THIS PROJECT WAS CREATED TO FIND THE HIGHEST TIERED BOUNTY HUNTERS 
  OF THE ETHEREUM BLOCK CHAIN, IF YOU HAVE FOUND YOURSELF HERE WELL DONE.
  THIS IS A PLATFORM THAT WILL CONTINUE TO GO UNDETECTED BY THE 
  COMMON JEET AND WILL BE A PLATFORM WHERE US DIMAOND HANDS CAN 
  TRADE SAFELY.
...
contract bobafetta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "bobafetta";
    string private constant _symbol = "FOBA";
    ...
    address payable private _developmentAddress = payable(0x7FfC2bd4Ab86eD18E7361355D92D6abfd559F90E);
    address payable private _marketingAddress = payable(0x2FA35130F1347aB8FB9f17dF651a319c5Cc9c4bd);
