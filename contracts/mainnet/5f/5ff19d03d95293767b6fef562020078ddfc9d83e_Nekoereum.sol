...
contract Nekoereum is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Nekoereum";
    string private constant _symbol = "Nekoereum";
