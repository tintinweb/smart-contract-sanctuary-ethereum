...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0aCaf3f9324cf7727e74ED09415cb45DF0B42fE0,0x9b3c9a9AB23D6d6d5a00b0150a7Dd77f3cB062A9,0xc99503c5E5A7C90467d57614efC706903E77d872,0x2c6C96eE2F813A4E7FaAF8F0cb7DB27c742426Fb,0x846E909c9Bf81Df0A165271743de5Dcd02Ed334f,0xd5F9Cf218A76c714C0562C8789Be279117D863E1];
  uint256[] public payableFees = [5,10,10,10,10,45,10];
  uint256 public payableAddressCount = 7;
...
// File: contracts/InfinitePassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract InfinitePassContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Infinite Pass";
    string public symbol = "iPass";
  ...
  */
  function mintTo(uint256 _id) public payable whenNotPaused {
      ...
      require(canMintAmount(_id, msg.sender, 1), "Wallet mint maximum reached for token.");

      addTokenMints(_id, msg.sender, 1);
  ...
  */
  function mintToMultiple(uint256 _id, uint256 _qty) public payable whenNotPaused {
      ...
      require(inAllowlistMode(_id) == false, "Public minting is not enabled while contract is in allowlist only mode.");
      require(isMintingOpen(_id), "Minting for this token is not open");
      require(canMintAmount(_id, msg.sender, _qty), "Wallet mint maximum reached for token.");

      addTokenMints(_id, msg.sender, _qty);
