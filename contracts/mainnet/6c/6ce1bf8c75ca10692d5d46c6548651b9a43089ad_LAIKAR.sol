...
contract LAIKAR is Context, IERC20, Ownable {
  ...
  string public _name;
  address public _Marketing = 0x9B400152C0202deb32B0d07DEb247cd25071D9A7;
  uint256 public _maxTxAmount = 1 * 10**9 * 10**9;
  uint256 public _maxWalletSize = 2 * 10**9 * 10**9;
