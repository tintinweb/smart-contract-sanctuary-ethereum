...
contract CAVALIER is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;
    string private _name = "Cavalier Inu";
    string private _symbol = "CAVALIER";
    uint256 private _tTotal = 777 * 10**9 * 10**uint256(_decimals);
    uint256 public defaultTaxFee = 0;
    uint256 public _taxFee = defaultTaxFee;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public defaultMarketingFee = 33;
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _marketingFee4Sellers = 66;
    ...
    address payable public marketingWallet = payable(0x68A21B81c150987Ab42DF54DC018Fb3db9c916b5);
