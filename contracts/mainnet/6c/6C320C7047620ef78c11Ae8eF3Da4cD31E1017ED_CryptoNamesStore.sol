...
CryptoNames Store is your only place to trade crypto domains with real deals and 100% secure.

Telegram: https://t.me/CryptoNamesStore
Website:  https://cryptonames.store/
...
contract CryptoNamesStore is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crypto Names Store";
    string private constant _symbol = "CNS";
