...
https://twitter.com/VitalikButerin/status/1568069910890250240

* ERC 4337 has a nice immediate benefit to users on L2s: with signature aggregation, it can decrease fees up to 2x. No similar benefit here.
...
contract ERC4337 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 4337 * 10**9;
    ...
    string private constant _name = "ERC 4337";
