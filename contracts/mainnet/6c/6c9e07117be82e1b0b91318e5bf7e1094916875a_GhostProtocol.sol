 ...
 * Telegram: https://t.me/GhostProtocolERC
...
contract GhostProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Ghost", "GHOST") {
    	...
    	marketingWallet = address(0x14a7307E6a239864222455a20e4193e8af5d9D8D); // set as marketing wallet
    	devWallet = address(0x14a7307E6a239864222455a20e4193e8af5d9D8D); // set as dev wallet
