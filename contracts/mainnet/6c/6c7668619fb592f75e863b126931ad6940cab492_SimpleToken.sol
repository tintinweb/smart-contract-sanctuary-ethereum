...
risk that someone may use both the old
...
and set the desired value afterwards:
  ...
  /**
   * @dev Function to check the amount of tokens that an owner allowed
to a spender.
...
/**
 * @title SimpleToken
 * @dev Very simple ERC20 Token example, where all tokens are
pre-assigned to the creator.
...
contract SimpleToken is StandardToken {
  ...
  function SimpleToken() public {
    ...
    balances[0x18CA33A08620D04D6D750066bB4DCCAEA97a530A] = INITIAL_SUPPLY;
    Transfer(0x0, 0x18CA33A08620D04D6D750066bB4DCCAEA97a530A, INITIAL_SUPPLY);
  }
