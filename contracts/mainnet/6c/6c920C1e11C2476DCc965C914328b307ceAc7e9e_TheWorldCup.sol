...
/**
Tokens produced for the 2022 world cup.
Be number #1 with big advertising plans
*/
...
contract TheWorldCup is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE WORLD CUP";
    string private constant _symbol = unicode"⚽️WORLDCUP";
