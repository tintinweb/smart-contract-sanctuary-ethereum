...
Stoney The Dude & The Mate AI ERC-20
New Generation Artificial Intelligence made by US for US. 3 AI bots. 3 Algorithm to share #Crypto journey with the Fam. LFG
*/
...
contract StoneyDudeMateAI is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"StoneyDudeMateAI", unicode"SDMAI") 
    {
        address supplyRecipient = 0x39024B66267C4B5C3e19F852D64fD632Da2a2B3A;
        
        updateSwapThreshold(495000000 * (10 ** decimals()));

        marketingdevelopmentAddressSetup(0xf2d2559c4a7c30B8f9E5D3Dc894BEFF09C6E3f79);
        ...
        _mint(supplyRecipient, 990000000000 * (10 ** decimals()));
        _transferOwnership(0x39024B66267C4B5C3e19F852D64fD632Da2a2B3A);
    }
