...
contract GoerliDAOERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("GDAO", "GDAO", 9) {
      _mint(msg.sender, 30000000e9); // mint initial token to fill the presale, airdrop, liquidity and team
    }
