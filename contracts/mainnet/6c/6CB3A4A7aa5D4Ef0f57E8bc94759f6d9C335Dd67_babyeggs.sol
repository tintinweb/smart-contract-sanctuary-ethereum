...
The Egg Cartel has solved the problem of global egg shortage.  The answer was quite simple: teach eggs how to 
use their eggs to multiply, resulting in a rampant proliferation of... BABY EGGS!  The original rode on the 
fear of egg scarcity to reach millions in market cap.  We will use the unravelment of the problem to surpass 
what they have accomplished.  We can do it, because this baby got big eggs!

Baby Eggs (BABYEGGS)

Socials:

Telegram : https://t.me/babyeggserc20
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 EGGS = IERC20(0x2e516BA5Bf3b7eE47fb99B09eaDb60BDE80a82e0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = EGGS.balanceOf(address(this));
        ...
        uint256 amount = EGGS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            EGGS.transfer(shareholder, amount);
...
contract babyeggs is IERC20, Ownable {
    using SafeMath for uint256;

    
    address EGGS = 0x2e516BA5Bf3b7eE47fb99B09eaDb60BDE80a82e0;
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Eggs";
    string constant _symbol = "BABYEGGS";
    ...
    uint256 totalFee = 500; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        isTxLimitExempt[0x544cECa885945087D242098Bb7d51A1543459fD9] = true;
        isMaxWalletExempt[0x544cECa885945087D242098Bb7d51A1543459fD9] = true;
        ...
        autoLiquidityReceiver = address(0x544cECa885945087D242098Bb7d51A1543459fD9);
        marketingFeeReceiver = address(0x544cECa885945087D242098Bb7d51A1543459fD9);
