...
// The Firestarters collection consists of 1000 unique characters.
// Owning a Firestarters makes you part of a community of entrepreneurs from Poland
// who exchange their knowledge and build great things together.


// https://firestarters.pl/
 ...
 */
contract FirestartersNFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    string private _base_uri = "ipfs://QmTeaJb7bxXrbspJsBvG8RWGKmSymD7r6j1LdJajwrMraR/";
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = FirestartersNFT.ownerOf(tokenId);
