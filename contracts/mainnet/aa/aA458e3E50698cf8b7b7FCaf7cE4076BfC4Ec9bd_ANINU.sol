...
contract ANINU is ERC20, Ownable {
    ...
    constructor() ERC20("Animne Inu", "ANINU") {
        ...
        maxWallet = 2000000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x777609988C7BfFC9c41B4477f9AfE30EBDE854a8); // set as charity wallet
        marketingWallet = address(0x777609988C7BfFC9c41B4477f9AfE30EBDE854a8); // set as marketing wallet
        devWallet = address(0x777609988C7BfFC9c41B4477f9AfE30EBDE854a8); // set as dev wallet
