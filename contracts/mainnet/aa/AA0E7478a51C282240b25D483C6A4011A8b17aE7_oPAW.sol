...
contract oPAW is ERC20, Ownable {
    ...
    constructor() ERC20("ORDINAL PAW","oPAW") {
        ...
        marketingWallet = address(0x1052CcFE262476B3390585C122817369008A7505); // set as marketing wallet
        devWallet = address(0x1052CcFE262476B3390585C122817369008A7505); // set as dev wallet
