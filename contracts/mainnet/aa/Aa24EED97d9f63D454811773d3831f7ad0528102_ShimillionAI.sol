...
contract ShimillionAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Shimillion AI";
    string private _symbol = "SHIMLN";
    ...
    constructor () {
        ...
        blockw = payable(address(0x4bDe3B85ABfC138c853Eb69f7E9d86aA0e5BCA95));
