...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe9F978D8a625D793a7392cC9fEe2973f8E9500f0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUcrHrdDLERFFJTNQKdD5BViqgEP3y3sEEKxnLVayETWT/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 0.00789 ether;
...
// File: contracts/DwarfTownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DwarfTownContract is RamppERC721A {
    constructor() RamppERC721A("Dwarf Town", "DWARF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ltzkNk7FxDAjBozPohrv/contract-metadata";
    }
}
