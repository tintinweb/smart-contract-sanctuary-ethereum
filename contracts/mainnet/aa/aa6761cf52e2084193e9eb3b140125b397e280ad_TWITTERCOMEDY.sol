...
contract TWITTERCOMEDY is ERC20, Ownable {
    ...
    constructor() ERC20("Twitter Comedy", "COMEDY") {
        ...
        marketingWallet = address(0x40a138e4D6A7BD678dF657719A92425Da644ccdb); // set as marketing wallet
        devWallet = address(0x420406Be3807F28a21620EA87359Fd0d87b4a90C); // set as dev wallet
