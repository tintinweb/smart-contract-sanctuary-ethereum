...
Elon's favourite middle night snack? Cheese? Pizza? 
We think Elon's favourite cereal might be the secret behind his 1000 IQ. 
Cinnamon Toast Crunch should be implemented to the daily meal schedule of a true degen! 
Elon's favourite middle night snack!


Twitter: https://twitter.com/CTCMUSKeth

Website: http://ctcmusk.com

Telegram: https://t.me/CTCMUSK
...
contract CinnamonToastCrunch is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cinnamon Toast Crunch", "CTCMUSK") {
	    ...
	    uint256 _earlySellDevFee = 6
 
    ; uint256 totalSupply = 1 * 1e12 * 1e18;
 
        maxTransactionAmount = totalSupply * 9 / 1000; // 0.9% maxTransactionAmountTxn
