...
/*   
    ...
    WHOLE LOTTA APE ($WLAPE) | an ERC20 Project
        -Liquidity Locked & Contract Renounced
        -2% ApeCoin Rewards

    WEBSITE & SOCIALS:

        TG:      https://t.me/WholeLottaApe
        Website: https://wholelottaape.com/
        Twitter: https://twitter.com/wholelottaape 
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x4d224452801ACEd8B2F0aebE155379bb5D594381)); // ApeCoin - 0x4d224452801ACEd8B2F0aebE155379bb5D594381
...
contract WLAPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Whole Lotta APE", "WLAPE") {

        uint256 totalSupply = 100 * 1e6 * 1e18;
        
        swapTokensAtAmount = totalSupply * 2 / 100; // 2% swap tokens amount
