...
contract UltronVision is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 6400000000 * 10**8;
	...
	string private constant _name = "Ultron Vision";
	string private constant _symbol = "ULTRON";
