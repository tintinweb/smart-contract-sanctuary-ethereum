...
contract ShibariumPrize is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shibarium Prize";
    string private constant _symbol = unicode"SPrize";
