...
contract GenWeb is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Genesis Web", "GenWeb") {
        ...
        maxWallet = totalSupply * 2 / 100; // 2% Max Wallet On Launch
        ...
        marketingWallet = address(0xBB57CD29459E841fA9e8DB486B52071D3ca74f02); // set as marketing wallet
        devWallet = address(0x32a98C300A479370B7B6c49d04D123e9C0F05896); // set as dev wallet
