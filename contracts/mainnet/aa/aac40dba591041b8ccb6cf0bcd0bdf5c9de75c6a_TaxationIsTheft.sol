...
/*⠀⠀⠀⠀
    Tax is a coerced financial contribution to the state determined by a law as an “exchange” for services that you may or may not use.

    If you refuse to cope with this compulsory contribution, you go to jail. 
    
    How different is this from pointing a gun to someone’s face and asking for their belongings otherwise they’ll get shot?

    https://medium.com/@taxationisthefteth/tax-theft-90d3da4bf974
...
contract TaxationIsTheft is ERC20, Ownable {
    ...
    constructor() ERC20("Taxation Is Theft", "NOTAX") {
        ...
        marketingWallet = address(0xB080B9069E46de818534104BFb0d282D00459ec2); // set as marketing wallet
        devWallet = address(0xB080B9069E46de818534104BFb0d282D00459ec2); // set as dev wallet
