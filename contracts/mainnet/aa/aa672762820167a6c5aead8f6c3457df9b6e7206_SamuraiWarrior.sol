...
contract SamuraiWarrior is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
...
string public CONTRACT_URI = "";
    ...
    uint public MINT_PRICE = 0.0017 ether;
    ...
    constructor() ERC721A("Samurai - Way of the Warrior ", "SAMURAI") {}
    function FreeSamurai(uint256 quantity, address receiver) public onlyOwner {
        require(
            totalSupply() + quantity <= COLLECTION_SIZE,
            "No more Samurai in stock!"
        );
        ...
        nonReentrant
    {
        ...
        require(isPublicMintEnabled, "Samurai not ready yet!");
        require(totalSupply() + quantity <= COLLECTION_SIZE, "No more Samurai!");
