...
/**
TG- https://t.me/FooDogs
Twitter- https://twitter.com/FooDogsETH
Website- https://foodogseth.com
*/
...
contract FOO is ERC20, Ownable {
    ...
    constructor() ERC20("Foodogs", "FOO") {
		...
		charityWallet = address(0xA3d0c4e690a6B9dcA1B1A3bC8e00Aaf34118C4Af); // set as charity wallet
        marketingWallet = address(0x27e8B309b26CBE419ec40FcE36D682EA229cc5A7); // set as marketing wallet
        devWallet = address(0xA3d0c4e690a6B9dcA1B1A3bC8e00Aaf34118C4Af); // set as dev wallet
