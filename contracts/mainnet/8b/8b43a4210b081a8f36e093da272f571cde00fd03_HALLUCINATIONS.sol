...
contract HALLUCINATIONS is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALLUCINATIONS";
    string private constant _symbol = "HALLUCINATIONS";
