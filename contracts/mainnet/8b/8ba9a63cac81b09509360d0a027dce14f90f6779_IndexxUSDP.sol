...
// File: contracts/prod_usd+/ETH_IndexxUSDP.sol
...
contract IndexxUSDP is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    /**
     * transfer tokens from owner to the given to address
     * @param to address of the sender
     * @param amount of tokens to be sent
     * @return true on successfully transfer 
     */
    ...
    /**
     * transferFrom tokens from owner to the given to address
