...
// File: contracts/NFTips.sol



pragma solidity >=0.7.0 <0.9.0;

contract NFTips is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NFTips", "NFTips") {
    setHiddenMetadataUri("ipfs://bafybeiavddchqnro4xdl3nygsiqtyxvcdzk3hqmaivw7yy62akvfbq2jda/hidden.json");
  }
