...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xEc55Ced6eAF1F7F25328c4184eac13DFf3be59F3];
  address public erc20Payable = 0xEc55Ced6eAF1F7F25328c4184eac13DFf3be59F3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.ghostsinthe.city/";
...
// File: contracts/GhostsInTheCityContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GhostsInTheCityContract is RamppERC721A {
    constructor() RamppERC721A("Ghosts In The City", "GHOSTS"){}
}