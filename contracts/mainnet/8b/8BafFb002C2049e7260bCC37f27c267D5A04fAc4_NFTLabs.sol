...
/**
 *Submitted for verification at Etherscan.io by NFT Labs on 2023-02-13
*/
...
Website:    https://nftlabs.world/
Twitter:    https://twitter.com/NFTlabs

Group of creative technologists probably best known for our crypto art projects Trippy Apes Club and our utility NFT token Fractal.
...
contract NFTLabs is ERC20Burnable, Ownable {
    ...
    constructor (address router, address operator) ERC20("NFTLabs", "NLab")
    {
