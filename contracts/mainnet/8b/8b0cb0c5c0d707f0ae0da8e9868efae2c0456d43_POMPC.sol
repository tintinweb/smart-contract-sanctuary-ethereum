...
In celebration of the FOMC's decision.
6/6 Tax will be lowered before renounce
*/
...
contract POMPC is Context, IERC20, Ownable {
    ...
    string private constant _name = "POMPC";
    ...
    constructor () {
        _feeAddrWallet = payable(0x2c78eCA586c6f0D33D7bBc052d61390FDf06A52C);
