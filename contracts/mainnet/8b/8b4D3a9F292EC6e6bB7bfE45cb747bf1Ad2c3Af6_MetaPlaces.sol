...
// File contracts/Archive/lib/utils/introspection/IERC165.sol
...
// File contracts/Archive/lib/token/ERC721/IERC721.sol
...
// File contracts/Archive/lib/token/ERC721/IERC721Receiver.sol
...
// File contracts/Archive/lib/token/ERC721/extensions/IERC721Metadata.sol
...
// File contracts/Archive/lib/utils/Address.sol
...
// File contracts/Archive/lib/utils/Context.sol
...
// File contracts/Archive/lib/utils/Strings.sol
...
// File contracts/Archive/lib/utils/introspection/ERC165.sol
...
// File contracts/Archive/lib/token/ERC721A.sol
...
// File contracts/Archive/lib/token/ERC721AOwnersExplicit.sol
...
// File contracts/Archive/lib/token/ERC721/extensions/ERC721Ownable.sol
...
// File contracts/Archive/lib/utils/cryptography/MerkleProof.sol
...
// File contracts/Archive/contracts/Erc721amp.sol
...
contract ERC721AMP is ERC721AOwnersExplicit, Ownable {
    ...
    // Number of NFTs reserved for the dev & marketing team
    uint16 private constant devMintAmount = 60;
    ...
    // Executed only once at contract creation to generate NFTs for marketing and developers
    function devMint(address _address) external onlyOwner {
        uint _mintQuantity = devMintAmount;
        uint _maxBatchSize = maxBatchSize;
        require(devMinted == false, "Dev already minted");
        require(
            totalSupply() + _mintQuantity <= maxSupply,
            "insufficient supply"
        );
        require(
            _mintQuantity % _maxBatchSize == 0,
            "can only mint a multiple of the maxBatchSize"
        );
        uint numChunks = _mintQuantity / _maxBatchSize;
        devMinted = true;
        for (uint i = 0; i < numChunks; i++) {
            _safeMint(_address, _maxBatchSize);
        }
    }
...
// File contracts/Archive/contracts/MP.sol



contract MetaPlaces is ERC721AMP {
    constructor() ERC721AMP("MP", "MP") {}
