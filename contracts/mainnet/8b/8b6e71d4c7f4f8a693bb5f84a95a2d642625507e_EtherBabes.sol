...
contract EtherBabes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("EtherBabes", "EBABES") {
    setHiddenMetadataUri("ipfs://QmTStji7kSmzg5XBu35wLb3ze6wDcasja1BBd9afQJzkTq/hidden.json");
  }
