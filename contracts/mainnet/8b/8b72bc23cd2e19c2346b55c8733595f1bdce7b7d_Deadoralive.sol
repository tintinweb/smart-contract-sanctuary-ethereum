...
/**
 $WANTED is a memecoin that aims to create its own swap where you can adjust your slippage to 100% and trade with MEV protection.
Lets have our ownswap where we can freely adjust slippage 100% and avoid MEVs from draining our liquidity at the same time. 
...
// Telegram: https://t.me/wantederc
// Twitter: https://twitter.com/wantedoa
// Web: https://wantedswap.online/
...
contract Deadoralive is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dead or Alive", "WANTED") {
