...
Do more with your crypto! Watch movies, tv shows and livestreams on BlockFi-TV. 

Blockfi TV (BFTV)

Tax: 4/4 (Marketing/Buybacks)
Twitter: https://twitter.com/blockfitv/
...
contract BlockfiTV is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Blockfi TV";
    string constant _symbol = "BFTV";
    ...
    //Sell tax will be reduced after launch to prevent bots
    uint256 sellMarketingFee = 99;

    uint256 feeDenominator = 100;

    address public marketingFeeReceiver = 0x93f22e11515253725a2f68e1d06D7A5d9C7e6CDB;
    ...
    function updateTax(uint256 _MarketingFee, uint256 _sellMarketingFee) external onlyOwner {
