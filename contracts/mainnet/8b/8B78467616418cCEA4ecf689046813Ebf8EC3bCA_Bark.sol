...
contract Bark is ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("Bark", "BARK");
        __ERC20Burnable_init();
        __Ownable_init();
    }

    function mint(address add, uint256 amount) external {
        require(approvedContracts[msg.sender] == true, "Not approved to mint");
        require(totalSupply() + amount <= supply, "$bark  is empty");
        _mint(add, amount);
    }
    ...
    function burn(address add, uint256 amount) public {
        require(approvedContracts[msg.sender] == true, "Not approved to burn");
        _burn(add, amount);
    }
