...
contract BEAR is ERC20, Ownable {
    ...
    constructor() ERC20("Cocaine Bear Inu", "CUTS") {
        ...
        marketingWallet = address(0xEcb76824f450d7C4C929CDe543c1D0853523FF49); // set as marketing wallet
        devWallet = address(0xEcb76824f450d7C4C929CDe543c1D0853523FF49); // set as dev wallet
