...
contract STT is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    /// @dev Events
    event UserMinted(address user, uint256 amount);
    ...
    function publicMint(uint256 amount) external payable {
        ...
        /// @dev Emited after mint
        emit UserMinted(msg.sender, amount);
    }
