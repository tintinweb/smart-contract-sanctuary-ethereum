 ...
 * allowances. See {IERC20-approve}.
 */
contract DecentralBankDigitalCurrency  is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Decentral Bank Digital Currency";
    string private _symbol = "DBDC";
    uint8 private _decimals = 9;
    uint256 private _supply = 999999999;
    uint256 public taxForLiquidity = 10;
    uint256 public taxForMarketing = 89;
    uint256 public maxTxAmount = 25000000 * 10**_decimals;
    uint256 public maxWalletAmount = 25000000 * 10**_decimals;
    address public marketingWallet = 0x7FcF773Fc572887f3D3F301735544616f359b624;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 9999999 * 10**_decimals;
