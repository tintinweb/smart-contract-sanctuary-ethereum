...
contract PremierLeagueInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Premier League Inu";
    string private constant _symbol = "PLI";
