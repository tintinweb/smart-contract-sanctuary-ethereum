...
// Website: https://betshiba.casino/
// Telegram: https://t.me/betshibaportal
// Twitter: https://twitter.com/betshiba_erc20
...
contract BETSHIBA is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 4e9 * 10**18;
    uint256 public maxWalletLimit = 2e10 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 0;
    uint256 private launchtax = 900;

    address public marketingWallet = 0x184184B8227617caed6B7dC7CF8e438ACa771763;
    address public utilityWallet = 0x485deFd76c82839C175573663276B253eEE0c653; 
    ...
    Taxes private taxes = Taxes(25, 15, 0, 10, 10);
    Taxes private sellTaxes = Taxes(25, 15, 0, 10, 10);
    ...
    constructor() ERC20("BetShiba", "BSHIBA") {
    ...
    function _transfer(
        ...
        if (_liquidityMutex || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.marketing + sellTaxes.utility + sellTaxes.liquidity + sellTaxes.dev;
            feesum = feeswap;
            currentTaxes = sellTaxes;
            _taxDenominator = sellTaxes.denominator;
        } else if (!useLaunchFee) {
            feeswap = taxes.marketing + taxes.utility + taxes.liquidity + taxes.dev;
            feesum = feeswap;
            currentTaxes = taxes;
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 utilityAmt = (unitBalance * 2 * swapTaxes.utility)/swapTaxes.denominator;
            if (utilityAmt > 0) {
                payable(utilityWallet).sendValue(utilityAmt);
            }
   ...
   function enableTrading() external onlyOwner {
    ...
    function updatedeadline(uint256 _deadline) external onlyOwner {
        ...
        require (_deadline < 10,"Deadline should be less than 10");
        deadline = _deadline;
    }
    ...
    function updateMaxWallet(uint256 maxWallet) external onlyOwner {
