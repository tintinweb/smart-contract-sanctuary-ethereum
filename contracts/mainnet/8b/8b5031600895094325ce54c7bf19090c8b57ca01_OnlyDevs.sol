...
OnlyDevs is an ERC-20 database platform which acts as a registry for developers, 
and a database for degens to aid them in making more informed decisions on the 
tokens they choose to invest in.

Website: https://www.onlydevs.me
Twitter: https://twitter.com/OnlyDevsCrypto
Telegram: T.me/OnlyDevsERC
...
contract OnlyDevs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OnlyDevs", "ODT") {
        ...
        marketingAddress = 0x0DA14B5ed0D3E3A17d811c5aeDa75C0Ed20764c5;
