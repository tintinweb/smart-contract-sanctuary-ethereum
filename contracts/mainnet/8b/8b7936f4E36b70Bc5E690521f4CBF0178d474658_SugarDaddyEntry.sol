...
contract SugarDaddyEntry is Context, IERC20, Ownable {
	...
	string private constant _name = "Sugar Daddy";
	string private constant _symbol = "SUGARDADDY";
