...
contract UragaweDistrictofUwatae is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.001 ether;
    uint   public maxTx             = 10;
    uint   public maxSupply         = 1001;
    uint256 public reservedSupply   = 1001;
    string private baseURI          = "ipfs://bafybeicm7mdjkwtiab3ky4obazilzuvg5fyzwgluvxxm4uzpaelfujiguu/";
    ...
    constructor() ERC721A("Uragawe District of Uwatae", "Uragawe") {}
