...
contract HappyHolidays is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HappyHolidays"; 
    ...
    address payable private _developmentWalletAddress = payable(0x546D8EaC8885c893c35479E2Fb0055cC8fb5E8B8);
    address payable private _marketingWalletAddress = payable(0x7665C86F1A019edFAA7a172269538789949B3fbb);
