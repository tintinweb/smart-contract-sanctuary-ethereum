...
A nuclear bomb needs about 33 pounds (15 kilograms) of enriched uranium to be operational.
Uranium is a silvery-white metallic chemical element in the periodic table, with atomic number 92.

Nuke92 will DESTROY the Uranium Token Supply, Forever. 

TG: https://t.me/Nuke92_Entry
...
contract Nuke92 is Context, IERC20, Ownable {
    ...
    string private _name = "Nuke92";
    string private _symbol = "Nuke";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 100;
