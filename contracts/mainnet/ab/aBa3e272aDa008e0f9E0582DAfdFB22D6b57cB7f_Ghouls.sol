...
contract Ghouls is TwoStage, DefaultOperatorFiltererUpgradeable {
  ...
  function initialize(
    ...
    __ERC721A_init("The Ghouls", "GHOULS");
    __Ownable_init();
    __AdminManager_init_unchained();
    ...
    __UriManager_init_unchained(
      "https://ipfs.io/ipfs/QmU4erZejKAi1rGH5nzhCFHR36zgf18QLGKyqxsYJ4xWvt/",
      "json"
    );
    ...
    setPrice(uint8(Stage.Whitelist), 0.04 ether);
    setPrice(uint8(Stage.Public), 0.05 ether);
  }
