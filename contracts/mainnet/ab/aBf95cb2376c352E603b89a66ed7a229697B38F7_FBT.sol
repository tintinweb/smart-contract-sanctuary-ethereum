...
FBT are digital assets which fluctuate in value, as with any cryptocurrency. 
Fan token owners receive perks and can occasionally vote on club issues.

Join us now !
Choose your favourite team !

FBT Community : https://t.me/FBTTInu

FBT Web : https://www.fbtt.net/
*/
...
contract FBT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FootBall Token";
    string private constant _symbol = unicode"FBT";
