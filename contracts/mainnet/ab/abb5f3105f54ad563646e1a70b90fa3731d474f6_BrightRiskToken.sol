    ...
    PausableUpgradeable
{
    ...
    function stakeAt(
        ...
        _stakeExternalPool(_controllerAddress, _staking, _exchangeData);
        _accrueManagerFee();
    ...
    function _stakeExternalPool(
        ...
        IPositionController(_controllerAddress).stake(_amount, _exchangeData);
...
interface IPositionController {
    ...
    function stake(uint256 _amount, bytes calldata _exchangeData) external;
    ...
    function withdrawRewards(bytes calldata _exchangeData) external;
