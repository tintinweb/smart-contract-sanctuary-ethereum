...
contract FELI is ERC20, Ownable {
    ...
    constructor() ERC20("Felicette", "FELI") {
        ...
        maxTransactionAmount = 1500000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 1500000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x79bDEE0DE433E88B057a87293D5f64f0A1a07d29); // set as charity wallet
        marketingWallet = address(0x79bDEE0DE433E88B057a87293D5f64f0A1a07d29); // set as marketing wallet
        devWallet = address(0x79bDEE0DE433E88B057a87293D5f64f0A1a07d29); // set as dev wallet
