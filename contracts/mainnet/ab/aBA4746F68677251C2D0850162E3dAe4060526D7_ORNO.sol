...
// https://www.ordinato.fund/
// https://assets.website-files.com/63effe9a68e04151c7fa249f/63f6749ec2b5890c53182b8d_orno33.pdf
// https://medium.com/@ordinato_eth/unlocking-the-power-of-ordinal-nfts-ordinato-and-the-community-driven-fund-model-12d952b1b4a5
// https://twitter.com/ORDINATO_FUND
...
contract ORNO is ERC20, Ownable {
    ...
    constructor() ERC20("ORDINATO", "ORNO") {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _salaryFee) external onlyOwner {
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellSalaryFee;
        require(sellTotalFees <= 15, "Must keep fees at 20% or less");
    }
