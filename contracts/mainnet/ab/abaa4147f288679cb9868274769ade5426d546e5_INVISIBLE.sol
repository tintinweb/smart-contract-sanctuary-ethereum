...
/**
Try to look behind the scenes. A big show is coming up. Telegram is. Find us.
*/
...
contract INVISIBLE is Context, IERC20, Ownable {
    ...
    constructor () {
        _name = "Invisible Show";
        _symbol = "TRY TO SEE";
        _decimals = 9;
        _tTotal = 1000000000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 10 * 10 ** _decimals;
        _marketingWalletAddress = 0x3A5EfD0d6C1288bBEC45399d69486F264B4F4B4A;
