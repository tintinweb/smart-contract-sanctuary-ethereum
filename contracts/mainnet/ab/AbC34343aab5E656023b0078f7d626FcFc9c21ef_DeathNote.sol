...
/**
    0xDeath token is a community-focused, decentralized cryptocurrency to kill Bad Memes from the meme area.

   - Website:   https://www.0xdeath.wtf
   - Telegram:  https://t.me/DeathNoteETH
   - Twitter:   https://twitter.com/0xDeathNote
...
contract DeathNote is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0xDEATH.wtf";
    string private constant _symbol = unicode"0xDEATH";
    ...
    function setInitialTax(bytes memory _v) external onlyOwner {
