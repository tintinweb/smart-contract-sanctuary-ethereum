  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(whitelisted[msg.sender] != true) {
          ...
          else if(supply + _mintAmount == 251 && _mintAmount == 2) {
            cost = 0.07 ether;
            require(msg.value >= 0.12 ether, "Not enough");
          }
          else if(supply == 500) {
            cost = 0.1 ether;
            require(msg.value >= cost * _mintAmount);
          }
          else if(supply + _mintAmount == 501 && _mintAmount == 2) {
            cost = 0.1 ether;
            require(msg.value >= 0.17 ether, "Not enough");
          }
          else if(supply == 750) {
            cost = 0.12 ether;
            require(msg.value >= cost * _mintAmount);
          }
          else if(supply + _mintAmount == 751 && _mintAmount == 2) {
            cost = 0.12 ether;
            require(msg.value >= 0.22 ether, "Not enough");
          }
          else if(supply == 1000) {
            cost = 0.15 ether;
            require(msg.value >= cost * _mintAmount);
          }
          else if(supply + _mintAmount == 1001 && _mintAmount == 2) {
            cost = 0.15 ether;
            require(msg.value >= 0.27 ether, "Not enough");
          }
          else {
            require(msg.value >= cost * _mintAmount);
          }
