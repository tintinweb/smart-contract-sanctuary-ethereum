...
contract nounmfers is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("NoundMfs", "NMF") {}
    ...
    function freeMint(uint256 amount) external payable nonReentrant {
        ...
        require(addressMinted[msg.sender] <= maxMint, "Max Mint per wallet is 10");
