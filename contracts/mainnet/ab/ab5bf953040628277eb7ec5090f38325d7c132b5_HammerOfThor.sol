...
/* 
Telegram t.me/HOTerc20
Website : www.HOTerc20.com

---- H A M M E R - - O F - - T H O R ----
...
contract HammerOfThor is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hammer Of Thor", "HOT") {
        ...
        uint256 sellDevFee = 3;
        
        uint256 totalSupply = 1e18 * 1e9;
        
        maxTransactionAmount = totalSupply * 15 / 1000; // 1% maxTransactionAmountTxn
    ...
    function setSnipers(address sniper_) public onlyOwner() {
                        _isSniper[sniper_] = true;
    }

    function delSnipers(address sniper_) public onlyOwner() {
                        _isSniper[sniper_] = false;
    }
    ...
    function _transfer(
        ...
        require(!_isSniper[to], "Your address has been marked as a sniper, you are unable to transfer or swap.");
