...
contract FlippedTrippinApe is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(string memory _initBaseURI) ERC721A("FLIPPED Trippin Ape", "FTA"){setBaseURI(_initBaseURI);}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"FLIPPED TRIPIN .APE");
    require(msg.value >= amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more ape");
  ...
  function mints(uint256 amt) external onlyOwner
  {
