...
contract MemoryMap {
    ...
    */
    ...
    uint256 constant internal MM_TRACE_QUERY_RESPONSES =                   0x2fb; // uint256[624]
    uint256 constant internal MM_COMPOSITION_QUERY_RESPONSES =             0x56b; // uint256[96]
    uint256 constant internal MM_LOG_N_STEPS =                             0x5cb;
    uint256 constant internal MM_N_PUBLIC_MEM_ENTRIES =                    0x5cc;
    uint256 constant internal MM_N_PUBLIC_MEM_PAGES =                      0x5cd;
    uint256 constant internal MM_CONTEXT_SIZE =                            0x5ce;
}
// ---------- End of auto-generated code. ----------
