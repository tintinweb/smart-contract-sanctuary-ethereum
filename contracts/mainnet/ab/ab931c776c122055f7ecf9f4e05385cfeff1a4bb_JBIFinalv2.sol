...
contract JBIFinalv2 is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("JohnBriggsinu2", "JBI2") { // PROJECTNAME AND TICKER GO HERE
        ...
        uint256 _totalSupply = (1_000_000_000_100) * (10**18); // TOTAL SUPPLY IS SET HERE
