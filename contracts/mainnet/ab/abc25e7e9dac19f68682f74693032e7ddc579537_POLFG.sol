...
contract POLFG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Proof of LFG", "POLFG") {
     ...
     uint256 totalSupply = 4 * 10 ** 6 * 10 ** decimals();
 
        maxTransactionAmount = 8 * 10 ** 4 * 10 ** decimals(); 
        maxWallet = 8 * 10 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xee4b364326E15853f530337A9ff9F0566692695E); // set as Marketing wallet
        DevWallet = address(0xee4b364326E15853f530337A9ff9F0566692695E); // set as dev wallet
