...
BeastPunks is a collection of unique 1,000 NFTs made by experienced team. 
Each Beast is a unique digital beast descending upon the Ethereum blockchain.

https://opensea.io/collection/beastpunks

https://t.me/beastpunks
...
contract BUNKZ is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Beast Punks";
    string private constant _symbol = "BUNKZ";
    ...
    address payable private _developmentAddress = payable(0xbdd7780d0e1804623412A4d62567C8b5d22331EA); 
    address payable private _marketingAddress = payable(0xb94adEC21B6a2145e2c37C85d5bf9d3f5BD16CD7);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _developmentAddress.transfer(amount.mul(4).div(5));
    }
