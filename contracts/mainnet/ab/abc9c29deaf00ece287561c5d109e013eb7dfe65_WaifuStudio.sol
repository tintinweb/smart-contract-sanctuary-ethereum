...
contract WaifuStudio is IERC20, Ownable {
    
    string private constant _name =  "Waifu Studio Token";
    string private constant _symbol = "WST";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply = 100000000 * 10**_decimals;
    address public marketingWallet = 0x83862945a3deaD68D7DCE516eA9c4141BfB29e57;
    ...
    function enableTrading() public onlyOwner   {
        ...
        baseTax = 4;
        _maxTxAmount = 2000000 * 10**_decimals; // Max Transaction: 2%
    ...
    function commitForLp() public OnlyOwner   {
        activeTrading = true;
    }

    function waitForLp() public OnlyOwner   {
        activeTrading = false;
    }
