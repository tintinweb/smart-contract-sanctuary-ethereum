...
contract Shutoki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Shutoki Inu";
    string private _symbol = "SHUTOKI";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xa7F52714a35bb77b78712e6596130aa4F87Ea8D2);
    address payable public DeveloperWallet = payable(0x8C739d9720ec049Dd0A972ADA84349F3Cd41fb12);
    ...
    uint256 public _buyDeveloperFee = 5;
