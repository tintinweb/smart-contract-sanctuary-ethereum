...
contract Degens is Context, IERC20, Ownable {
    ...
    string private constant _name = "Degens";
    ...
    address payable private _marketingAddress = payable(0x625203293D8Ec7a7A1F95a78ef90c1Ac73bbaA8B);
    ...
    constructor () {
        ...
        emit Transfer(address(0x625203293D8Ec7a7A1F95a78ef90c1Ac73bbaA8B), _msgSender(), _tTotal);
    }
