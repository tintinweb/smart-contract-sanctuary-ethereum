...
Diversifies your exposure to the largest cryptocurrencies by 
market cap during rising markets and systematically trades 
them to stablecoins during unfavorable conditions.

 https://www.ridian.io/
 https://twitter.com/ridiancrypto

TOKENOMICS:
MAX Tx      1.2         * FIRST TWO MINUTES: 10,000,000,000 max buy (10B RDAI)
MAX WALLET  2.4         * 45-second buy cooldown (these limitations are lifted automatically two minutes post-launch)
TAX         4/4         * 8% total tax on round-trip, 2 marketing, 1 lp, 1 dev
...
contract RDAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ; uint256 totalSupply = 0.25 * 1e12 * 1e18;
    ...
    function transferCooldown(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
