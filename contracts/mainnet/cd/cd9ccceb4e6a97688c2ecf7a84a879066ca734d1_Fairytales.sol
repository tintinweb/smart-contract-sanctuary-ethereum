...
contract Fairytales is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmfLY8M9KRTYmRuGzM2uFcBinRFJoUMskpZgHzu7dexTiA";
    ...
    constructor(
    ) ERC721A("Fairytales", "FAIRYTALES", 100, maxSupply) {
    }
    ...
    function mints(uint256 _numfreemints)
        external
        onlyOwner
    {
