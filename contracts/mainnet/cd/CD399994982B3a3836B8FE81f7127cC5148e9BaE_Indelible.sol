...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Head", unicode"Eyes", unicode"Nose", unicode"Neck", unicode"Mouth", unicode"Shoulders", unicode"Skin Color", unicode"Background", unicode"Skin Type"];
    ...
    uint public allowListPrice = 0.0025 ether;
    uint public maxPerAllowList = 4;
    bool public isAllowListActive;

    ContractData public contractData = ContractData(unicode"0x000000000000000000000000000000000000[UN]dEaD", unicode"Send Kevin to burn. What still remains?", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/58183935-76f9-418f-95d3-99131f0c6dc0", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/58183935-76f9-418f-95d3-99131f0c6dc0", "", 700, "0x5D76f8887B6e8bd6b73ed435c935Fa8FC2872EDB");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"0x000000000000000000000000000000000000[UN]dEaD", unicode"UDK") {
        tiers[0] = [9,11,21,25,27,30,32,35,39,41,44,46,48,50,52,55,101];
        tiers[1] = [13,21,23,23,23,23,23,23,23,23,23,24,24,24,24,24,24,24,24,25,25,25,25,26,26,27,27,27];
        tiers[2] = [59,62,62,63,64,65,67,73,75,76];
        tiers[3] = [121,160,167,218];
        tiers[4] = [67,69,72,73,73,74,77,79,82];
        tiers[5] = [85,107,109,110,122,133];
        tiers[6] = [17,34,38,49,67,72,74,75,77,79,84];
        tiers[7] = [15,22,50,74,124,125,127,129];
        tiers[8] = [0,0,666];
