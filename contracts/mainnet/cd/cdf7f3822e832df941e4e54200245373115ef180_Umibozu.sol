...
contract Umibozu is Context, IERC20, Ownable {
    ...
    string private _name = "Umibozu";
    string private _symbol = "UMI";
    ...
    uint256 public _maxTxAmount = 10000000000000000 * 10**9;
