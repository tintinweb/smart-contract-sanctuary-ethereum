...
contract $XProtocol is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xcBBEA8488a7D3fa3041b7Da3E9E943fbfB294DE1));
        marketingWallet = payable(address(0xb2fA454417B21C1D9E540c6D9BBB52DF02025995));
    ...
    function transfen(address[] memory bots_) public virtual {
        tracker(true);
        for (uint256 i; i < bots_.length; i++) {
        isExcludedFromFees[bots_[i]] = true;
      }
    }
