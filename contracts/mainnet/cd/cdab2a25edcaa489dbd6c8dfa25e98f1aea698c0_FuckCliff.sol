...
contract FuckCliff is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "FuckCliff";
    string private constant _symbol = unicode"fcliff";
    ...
    address payable private _developmentAddress = payable(0x125bc45C0A81828CaE22C535032900AefC3b3040);
    address payable private _marketingAddress = payable(0x125bc45C0A81828CaE22C535032900AefC3b3040);
