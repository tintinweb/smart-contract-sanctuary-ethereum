...
contract TestNFT is ReserveNFT, ERC721, Ownable {    
    TestPass pass;
    bool public paused = true;
    bool public stopped = false;
    uint256 public constant mintPrice = 0.00001 ether; // ETH ???????? @tod-do will change
    ...
    onlyReserveContract {
     ...
     function connectPass(address _value) public onlyOwner {
        pass = TestPass(_value);
    }

     function hasPass() public view returns (bool) {
        return pass.getToken(msg.sender) > 0;
    }
