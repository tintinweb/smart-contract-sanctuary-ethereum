...
contract NEONCHAD is Context,IERC20, Ownable{
using Address for address;
string private _name = "NEON CHAD";
string private _symbol = "NEONCHAD";
...
address _owner;
address payable public marketingAddress = payable(0x52EF0be20a17631eD69008731fA671128256ad95);
...
function openTrading() public view returns (bool){
   return tradeEnabled;
}
