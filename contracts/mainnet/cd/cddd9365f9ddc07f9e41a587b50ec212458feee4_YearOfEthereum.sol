...
Year of Ethereum, is a decentralized autonomous organization, a true embodiment of blockchain. 
Aims to establish an organization wherein there’s no centralization. 
Meaning, the community will be in control of the project itself, following the project’s vision and mission. 
Utilities and its vision are its main keypoints.

◾ 5% Tax
◾ 2% Burned
◾ 3% LP

https://t.me/yearofethereum
...
contract YearOfEthereum is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5C59F9D73539d76aD35349FFf1001b91674FC26b); 
    address payable public Wallet_Utility = payable(0x5C59F9D73539d76aD35349FFf1001b91674FC26b);
    ...
    string private constant _name = "Year of Ethereum"; 
    string private constant _symbol = unicode"YoE"; 
    ...
    constructor () {
        ...
        _owner = 0x5C59F9D73539d76aD35349FFf1001b91674FC26b;
