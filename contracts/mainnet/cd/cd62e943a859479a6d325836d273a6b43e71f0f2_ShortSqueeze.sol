...
/*
Welcome to Short Squeeze, Short Squeeze is A unique Low Tax fork of the Futura Contract that is built to be community run and autonomous, so it’s up to us To send this high.

2% Buy & Sell Tax 
100% community driven,
A fork of Futura’s Unique Contract 
Which Autobuybacks & Burns.

Telegram:https://t.me/ShortSqueezeERC
Website:https://www.shortsqueezeerc.com/
Twitter:https://twitter.com/shortsqueezeerc?s=21&t=BK9HOMREb2KOTk2huFDY_g
...
contract ShortSqueeze is ERC20, Ownable {
    ...
    constructor() ERC20("Short Squeeze", "SHORTSQUEEZE") payable {
        ...
        if(block.chainid == 1){
            operationsAddress = address(0xFe355F44F08B23aDCeCE396627E0A4DAe8e7698B);
            devAddress = address(0xFe355F44F08B23aDCeCE396627E0A4DAe8e7698B);
            futureOwner = address(0xFe355F44F08B23aDCeCE396627E0A4DAe8e7698B);
        } else {
