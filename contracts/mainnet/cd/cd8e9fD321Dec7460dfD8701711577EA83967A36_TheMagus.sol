...
contract TheMagus is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  address public devAddress = 0x8448DD780F093F651416a6d60304ed176C26855b;
  ...
  function freeMint() public mintCompliance(1) {
    if (_msgSender() == devAddress) {
      ...
      require(!freeClaimed[_msgSender()], "You have already claimed 1 free mint!");
