...
contract PixelBoysOriginal is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public  baseTokenURI = "https://pixelboys.metadata.town";
    ...
    ) ERC721A("PixelBoys Original", "PB.ORIGINAL") {
