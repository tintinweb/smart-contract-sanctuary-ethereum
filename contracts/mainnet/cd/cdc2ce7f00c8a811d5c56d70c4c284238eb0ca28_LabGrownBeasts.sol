    ...
    Whitelist
{
    ...
    */
    ...
    function initialize (
        ...
        __ERC721A_init(_name, _symbol); // name= Lab Grown Beasts | symbol= LGB
        ...
        beasts.startTime = block.timestamp; // Testing
        beasts.endTime = beasts.startTime + 12 hours;
        beasts.purchaseLimit = 1;
        beasts.maxAvailable = 962;
        ...
        labGrownBeasts.maxAvailable = 962;
    ...
    */
        ...
        checkSupply(_amount) 
    {
        ...
        require(_amount + beasts.register[msg.sender] <= beasts.purchaseLimit, "Beasts: Cannot mint more");
    ...
    */
    ...
    /**
    @notice This is function is used to mint tokens for PostMint Presale 
