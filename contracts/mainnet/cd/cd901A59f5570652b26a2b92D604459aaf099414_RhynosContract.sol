...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1679162400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1679155200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x335F4dED38597003Ab0C9CD399BdF8c662E24e2f];
  address public erc20Payable = 0x335F4dED38597003Ab0C9CD399BdF8c662E24e2f;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmZYkk9yQhmjYwMn9AoheuMvdGRpJBV7pBUZVa2nNtGJQx/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5G3um7nP3X6BtJzv0aGP/contract-metadata";
  }
...
// File: contracts/RhynosContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RhynosContract is ERC721APlus {
    constructor() ERC721APlus("RHYNOS", "RHYS"){}
}