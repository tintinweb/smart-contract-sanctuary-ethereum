...
/**
 https://t.me/deathforestresearch
 */
...
contract DeathForest is Context, IERC20, Ownable {
    ...
    string private constant _name = "Death Forest";
    string private constant _symbol = "Yoshie";
    ...
    uint256 private _maxWalletAmount = 20_000_000 * 10**9;
