...
contract PeePeePooPoo is ERC20, Ownable {
    ...
    constructor() ERC20("Pee Pee Poo Poo", "PeePoo") {
		...
		charityWallet = address(0xEC394a98dc2D41C2776d06E4a46d01aeAdD51440); // set as charity wallet
        marketingWallet = address(0xEC394a98dc2D41C2776d06E4a46d01aeAdD51440); // set as marketing wallet
        devWallet = address(0x354A8A332d286AAb78AFB008569e51f22cF6654b); // set as dev wallet
