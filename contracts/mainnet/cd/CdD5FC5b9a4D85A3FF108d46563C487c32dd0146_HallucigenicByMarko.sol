...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x94C204D30CBE9654df98392c9B3a92E1C079d647);
...
contract HallucigenicByMarko is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Hallucigenic By Marko", "HBM") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmPDt4MFFw29SFenDrWYvRXeKgbFpCa7aKSu5cSCAhHPWT/", _toString(tokenId), ".json"));
    }
