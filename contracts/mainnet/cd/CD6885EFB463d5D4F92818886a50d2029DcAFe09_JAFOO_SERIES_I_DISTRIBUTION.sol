...
constructor() public {  /// CKED 
    ...
    _enableAllowances(owner, MAX_INT);
 
}


///  enables owner to be spender.
function _enableAllowances(address _spender, uint256 _value) internal {  
    token.safeIncreaseAllowance(_spender, _value);
...
function DepNDis(uint256 _value) external _onlyOwner{        /// WORKED
    require(_value > 0, "Deposit amount must be greater than 0");
...
function withdraw() external _withdrawalIsEnabled {
    ...
    _enableAllowances(holder, withdrawAmount);
