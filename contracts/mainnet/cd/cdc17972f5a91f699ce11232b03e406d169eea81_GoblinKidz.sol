...
contract GoblinKidz is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.003 ether;
  uint public          maxPerTx          = 22;
  uint public          maxPerWallet      = 88;
  uint public          totalFree         = 1000;
  uint public          maxSupply         = 5555;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("GoblinKidz", "GKZ"){}
