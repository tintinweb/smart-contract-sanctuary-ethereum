...
contract BabyPoof is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Poof", "BPF") {
        ...
        marketingWallet = address(0xAceBe926A3df86beCA43cecb3819482a5035452B); // set as marketing wallet
        devWallet = address(0xAceBe926A3df86beCA43cecb3819482a5035452B); // set as dev wallet
