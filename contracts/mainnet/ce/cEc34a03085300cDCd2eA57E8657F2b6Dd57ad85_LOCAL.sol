...
The Loopback Address Reserved for Local Testing and Debugging

Why did the computer go to 127.0.0.8?

To find its own happiness and inner peace with a never-ending loop of positive affirmations!

Website: https://loopback.pro
Telegram: https://t.me/loopbacketh
Twitter: https://twitter.com/loopbacketh
...
contract LOCAL is Context, IERC20, Ownable {
    ...
    string private _name = "127.0.0.8";
    string private _symbol = "127.0.0.8";
