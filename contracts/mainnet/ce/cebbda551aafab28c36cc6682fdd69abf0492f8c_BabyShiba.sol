...
┃╰━╯┃╭━╮┃╰━╯┃┃┃╱╱┃╰━╯┃┃╱┃┣┫┣┫╰━╯┃╭━╮┃
╰━━━┻╯╱╰┻━━━╯╰╯╱╱╰━━━┻╯╱╰┻━━┻━━━┻╯╱╰
Telegram: https://t.me/BabyShibaETHEntry   
*/
...
contract BabyShiba is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x52B26a548605bE37b21830954A47628bbC818142); // Marketing Address
    address payable public multiSigAddress = payable(0x52B26a548605bE37b21830954A47628bbC818142); // Marketing Address
    address payable public devAddress = payable(0x52B26a548605bE37b21830954A47628bbC818142); // Dev Address
    address payable public liquidityAddress = payable(0x52B26a548605bE37b21830954A47628bbC818142); // Liquidity Address
    ...
    string private constant _symbol = unicode"BBSHIB";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 300 / 10000; // 3% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 300 / 10000; // 3%
