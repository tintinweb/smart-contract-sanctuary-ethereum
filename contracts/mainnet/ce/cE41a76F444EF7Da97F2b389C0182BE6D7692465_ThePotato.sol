...
// https://thepotato.io/
// https://t.me/ThePotatoERC
// https://twitter.com/ThePotatoERC
...
contract ThePotato is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"The Potato", "POTATO") {
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // 1% maxtrx
        maxWallet = totalSupply * 15 / 1000; // 1.5% maxw
        ...
        marketingWallet = address(0xC42770903e0E3c5610D5Af43d840C67DEbD9696a); // mwallet
        devWallet = address(0xC42770903e0E3c5610D5Af43d840C67DEbD9696a); // dwallet
