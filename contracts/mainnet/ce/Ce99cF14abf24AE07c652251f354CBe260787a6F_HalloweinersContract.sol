...
//
//     __  __      ____                   _                     
//    / / / /___ _/ / /___ _      _____  (_)___  ___  __________
//   / /_/ / __ `/ / / __ \ | /| / / _ \/ / __ \/ _ \/ ___/ ___/
//  / __  / /_/ / / / /_/ / |/ |/ /  __/ / / / /  __/ /  (__  ) 
// /_/ /_/\__,_/_/_/\____/|__/|__/\___/_/_/ /_/\___/_/  /____/  
//                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xBd6c591A471f897a0a04e22E90450a5Ae9dFA40e];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 3000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihp4nl7wnrjb6p7gtvprn4b3wuygvbtyvrqk3knwtm2aki3anebzm/";
...
// File: contracts/HalloweinersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HalloweinersContract is RamppERC721A {
    constructor() RamppERC721A("Halloweiners", "WEINER"){}
}
