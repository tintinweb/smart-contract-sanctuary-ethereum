...
contract BoredApeSneakerClub is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://boredapesneakerclub.mypinata.cloud/ipfs/QmYz7QgHrwBabTcXzHP6nC9a5M91bWoydYYysiz99FyBBr/unreveal.json";
    bool public reveal = false;

    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 1000000000000000000;
    ...
    constructor() ERC721("Bored Ape Sneaker Club", "BASC") {
    }
