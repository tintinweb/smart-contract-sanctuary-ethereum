 ...
 \$$\ $$  / $$ /  $$ |$$ |  $$ |      $$ |      $$ /  $$ |  $$ |         $$ |      $$ |  $$ |$$ /  \__|$$ |$$  / 
  \$$$$  /  $$ |  $$ |$$ |  $$ |      $$$$$\    $$$$$$$$ |  $$ |         $$$$$\    $$ |  $$ |$$ |      $$$$$  /  
   \$$  /   $$ |  $$ |$$ |  $$ |      $$  __|   $$  __$$ |  $$ |         $$  __|   $$ |  $$ |$$ |      $$  $$<   
    $$ |    $$ |  $$ |$$ |  $$ |      $$ |      $$ |  $$ |  $$ |         $$ |      $$ |  $$ |$$ |  $$\ $$ |\$$\  
    $$ |     $$$$$$  |\$$$$$$  |      $$ |      $$ |  $$ |  $$ |         $$ |      \$$$$$$  |\$$$$$$  |$$ | \$$\ 
    \__|     \______/  \______/       \__|      \__|  \__|  \__|         \__|       \______/  \______/ \__|  \__|                                                                                                                                        
*/
...
contract fatfuckgoblinz is ERC721A, Ownable, ReentrancyGuard {  
    using Strings for uint256;
    string public _partslink;
    bool public byebye = false;
    uint256 public goblins = 5000;
    uint256 public goblinbyebye = 4; 
    mapping(address => uint256) public howmanygobblins;
   
	constructor() ERC721A("fatfuckgoblinz", "FATFUCK") {}

    function _baseURI() internal view virtual override returns (string memory) {
        return _partslink;
    }

 	function makingobblin(uint256 _bye) external nonReentrant {
  	    uint256 totalgobnlinsss = totalSupply();
        require(byebye);
        require(totalgobnlinsss + _bye <= goblins);
        require(msg.sender == tx.origin);
    	require(howmanygobblins[msg.sender] + _bye <= goblinbyebye);
        _safeMint(msg.sender, _bye);
        howmanygobblins[msg.sender] += _bye;
    }
