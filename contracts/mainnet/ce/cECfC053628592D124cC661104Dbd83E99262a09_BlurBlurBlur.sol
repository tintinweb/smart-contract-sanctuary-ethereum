...
contract BlurBlurBlur is ERC721A {
    ...
    constructor() ERC721A("BlurBlurBlur", "bbb") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidbimvijrwqc27qnm4dsc4ercl2kahkun3uj5lfbyxl7mlt7eapjy/", _toString(tokenId), ".json"));
    }
