...
contract WojakInu is ERC20, Ownable {
    ...
    constructor() ERC20("Wojak Inu", "$WINU") {
		...
		charityWallet = address(0x46787dE5053c7532429504608DABfF6eFB21b065); // set as charity wallet
        marketingWallet = address(0x46787dE5053c7532429504608DABfF6eFB21b065); // set as marketing wallet
        devWallet = address(0x46787dE5053c7532429504608DABfF6eFB21b065); // set as dev wallet
