...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Phantom", "PHANTOM") {
        ...
        uint256 totalSupply = 1_000_000_00 ether;
    ...
    function blacklistBotBatch(address[] memory bots, bool isBot) external onlyOwner {
        for (uint256 i = 0; i < bots.length; i++) {
            _holderIsBot[bots[i]] = isBot;
        }
    }
    ...
    function excludeFromFeesBatch(address[] memory accounts, bool excluded) public onlyOwner {
