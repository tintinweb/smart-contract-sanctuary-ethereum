...
/*  
        No TG. No Website. No social media page is made by mmyself.
        Worlds's first ever meme token with no use-case at all. 
        Community driven. We are tired.
*/
...
contract NOTHING is ERC20, Ownable {
    ...
    constructor() ERC20( "TO SEE", "NOTHING") {
        ...
        operationsAddress = address(0xE0bbAF5E5137Cc2B36D9A3d690abbfCa4c13cC46); //    
        TaxAddress = address(0xE0bbAF5E5137Cc2B36D9A3d690abbfCa4c13cC46);  // change this address to the one for tax 
