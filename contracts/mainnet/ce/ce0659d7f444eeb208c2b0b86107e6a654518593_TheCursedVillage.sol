...
contract TheCursedVillage is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("The Cursed Village", "Cursed Man") {
        setHiddenMetadataUri("https://api.thecursedvillage.xyz/");
        setBaseURI("https://api.thecursedvillage.xyz/");
    }
    ...
    function StealthMint(address to, uint256 quantity)public onlyOwner{
