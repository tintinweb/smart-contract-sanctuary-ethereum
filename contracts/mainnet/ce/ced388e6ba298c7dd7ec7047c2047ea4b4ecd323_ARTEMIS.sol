...
contract ARTEMIS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of Artemis";
    ...
    address payable private _developmentAddress = payable(0xF4ad51f564067617e996be1ccb2380b98b178108); 
    address payable private _marketingAddress = payable(0xF4ad51f564067617e996be1ccb2380b98b178108);
