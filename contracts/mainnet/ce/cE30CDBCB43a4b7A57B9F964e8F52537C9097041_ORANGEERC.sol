...
contract ORANGEERC is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = unicode"ORANGE";
    string private _symbol = unicode"オレンジ";
    ...
    constructor () {
        ...
        raca = payable(address(0xf18527193Cb4D1DCcC423b7aC00CE8B923218197));
