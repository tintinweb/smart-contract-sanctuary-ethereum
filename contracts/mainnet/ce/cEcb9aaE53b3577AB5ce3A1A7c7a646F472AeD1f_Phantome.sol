...
contract Phantome is IERC721A { 
    ...
    string private constant _name = "Phantome";
    string private constant _symbol = "PHAN";
    string private _baseURI = "QmdY7hxduBNfwRRumt3bxRiqD2ZUryKpUtPFYpbZxmUfGQ";
