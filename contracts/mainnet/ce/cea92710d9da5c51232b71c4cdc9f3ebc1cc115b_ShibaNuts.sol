...
/*
https://t.me/ShibNuts
https://shibnuts.com - Website will be live within 2 hours of launch
https://twitter.com/ShibNuts

LLaunching at 1:30am UTC 27th May 2022 to hand out deez nuts...

We have a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, as a result; $SHIBNUTS is designed to reward holders and discourage dumping.
...
Token Information:
- 1,000,000,000,000 Total Supply, 10% is burned immediately
- Liquidity provided by ShibaNuts devs and then locked with Team.Finance
- Using the fairest possible launch method for everyone and this is pre-announced, so there is no early secret buyers! 
- 0,2% transaction limit on launch - You can only buy 2,000,000,000 $SHIBNUTS until it's lifted
- Buy limit lifted to 1% of the supply 30 minutes after launch, then the ownership of the token is immediately renounced
- Sells limited to 4% of the Liquidity Pool, <4% price impact - Keeps the whales out
...
contract ShibaNuts is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "shibnuts.com";
    string private constant _symbol = "SHIBNUTS\xF0\x9F\xA5\x9C";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                if(firstsell[from] + (6 hours) < block.timestamp){
                    sellnumber[from] = 0;
                }
                if (sellnumber[from] == 0) {
                    ...
                    sellnumber[from]++;
                sellcooldown[from] = firstsell[from] + (6 hours);                }
