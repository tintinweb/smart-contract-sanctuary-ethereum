...
//
//   ________            ____                             __                
//  /_  __/ /_  ___     / __ \__  ______ ___  ____  _____/ /____  __________
//   / / / __ \/ _ \   / / / / / / / __ `__ \/ __ \/ ___/ __/ _ \/ ___/ ___/
//  / / / / / /  __/  / /_/ / /_/ / / / / / / /_/ (__  ) /_/  __/ /  (__  ) 
// /_/ /_/ /_/\___/  /_____/\__,_/_/ /_/ /_/ .___/____/\__/\___/_/  /____/  
//                                        /_/                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xaDc58C11B565aA3928Db24cfD17a57224FCc95C4,0x9b35b84a2d08e6aB505a90af360Ce818A9B384A9];
  uint256[] public payableFees = [5,37,58];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmV3vfqRMeqySSgbQFwYGUTnPRpqgeXt7A2eRhM7TGvDKT/";
...
// File: contracts/TheDumpstersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDumpstersContract is RamppERC721A {
    constructor() RamppERC721A("The Dumpsters", "DumpDump"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/tCNk26Ms19tbQYSRmxjf/contract-metadata";
    }
}
