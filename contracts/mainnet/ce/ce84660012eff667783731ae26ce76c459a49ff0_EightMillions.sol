...
/*
https://twitter.com/cz_binance/status/1603025607570644994
*/
...
contract EightMillions is ERC20, Ownable {
    ...
    constructor() ERC20("8s", "8s") {
        ...
        maxTransactionAmount = 3 * 1e4 * 1e18; // 3% from total supply maxTransactionAmountTxn
        maxWallet = 3 * 1e4 * 1e18; // 3% from total supply maxWallet
        ...
        devWallet = address(0x62537BD405F68b357e9721ccE96f9729E0acbc2B);
