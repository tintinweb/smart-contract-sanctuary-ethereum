...
contract ELE is Context, IERC20, Ownable {
    ...
    string private _name = "Elephant Inu";
    ...
    uint256 public numTokensSellToAddToLiquidity = 99000000000 * 10**9;
    ...
    function launchNewPair() external onlyOwner{
