...
`--'     `--'    `---' `--'  `--'`--' `----'|  |-' `--''--'  '--''--''--'   '--'  `--'  `--'   
 ...
 Twitter = https://twitter.com/Profilepixwtf                                           
*/
...
contract profilepixwtf is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("profilepix.wtf", "PFPX") {
