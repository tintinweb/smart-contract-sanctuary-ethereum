 ...
 */
contract ERC721Common is ERC721PreApproval, OwnerPausable {
    ...
    function _beforeTokenTransfers(
        ...
        require(!paused(), "ERC721Common: paused");
...
abstract contract Seller is OwnerPausable, ReentrancyGuard {
    ...
    */
    ...
    when unneeded.
     */
    function _purchase(address to, uint256 tokenId) internal virtual {
        _purchase(to, tokenId, 0);
    }
    ...
    function _purchase(
        ...
        _handlePurchase(to, tokenId, false);
        _totalSold.add(n);
