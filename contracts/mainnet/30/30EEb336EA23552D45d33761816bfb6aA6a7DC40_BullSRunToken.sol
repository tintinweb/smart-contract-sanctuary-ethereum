...
contract BullSRunToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888000000000 * 10**9 * 10**9;
    ...
    uint256 private numTokensSellToAddToLiquidity = 15 * 10**9 * 10**9;
    uint256 public _maxWalletSize = 0 * 10**9 * 10**9;
    ...
    uint256 public coolDownTime = 88 seconds;
