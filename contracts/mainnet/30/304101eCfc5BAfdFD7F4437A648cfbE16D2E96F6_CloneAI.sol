...
contract CloneAI is ERC20, Ownable {
    ...
    constructor() ERC20("CloneAI", "CAI") {
        ...
        marketingWallet = address(0x7F2cDDFBD2E6DA2A17ABb9C85DBF679ac32523f0); //
        devWallet = address(0x7F2cDDFBD2E6DA2A17ABb9C85DBF679ac32523f0); //
