...
contract TrillionaireBirds is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Trillionaire Birds", "TRLL") {
      sethiddenURI(baseURI); 
