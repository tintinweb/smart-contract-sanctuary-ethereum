...
//*********************************************************************//
//
//    ______      __    ___          ________              __ 
//   / ____/___  / /_  / (_)___     / ____/ /_  ___  _____/ /_
//  / / __/ __ \/ __ \/ / / __ \   / /   / __ \/ _ \/ ___/ __/
// / /_/ / /_/ / /_/ / / / / / /  / /___/ / / /  __(__  ) /_  
// \____/\____/_.___/_/_/_/ /_/   \____/_/ /_/\___/____/\__/  
//                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc0E03Dce3b04D271cd0C953d6E7c916CF0137648,0xf32b2A8503E9384FD513f4A98C0dd90B7ED8ED3f,0x4ED31C9f9248d14059AC51BA5688Cf32060E926A];
  uint256[] public payableFees = [5,20,40,35];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 6666 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcaT6Ygkjkk1vH6HvrjGSGvdYMMvSjGJKmwadfjXgWvZq/";
...
// File: contracts/GoblinChestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinChestContract is RamppERC721A {
    constructor() RamppERC721A("Goblin Chest", "GCHEST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YTlWlWzNwfv3aGu9hxnR/contract-metadata";
    }
}
