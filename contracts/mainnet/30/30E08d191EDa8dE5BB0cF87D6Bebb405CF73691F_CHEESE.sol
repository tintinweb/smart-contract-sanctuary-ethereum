...
Chedda, Parma & Stilton whales as the team members. 
Initial Liquidity locked for 6 months. 

TELEGRAM: https://t.me/CheeseToken
0/6 Tax
...
contract CHEESE is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //UNISWAP
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Cheese Token";
    string constant _symbol = "CHEESE";
    ...
    uint256 sellMarketingFee = 6;

    uint256 feeDenominator = 100;

    address public marketingFeeReceiver = 0xBc970145f5F6c4193D378922f6264891da1acB11;
    address public developmentReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHdevelopment = amountETH.mul(20).div(100);
        uint256 amountETHMarketing = amountETH.sub(amountETHdevelopment);


         if (amountETHdevelopment > 0 && amountETHMarketing > 0) {
            payable(developmentReceiver).transfer(amountETHdevelopment);
    ...
    function manualSend() external {
        payable(developmentReceiver).transfer(address(this).balance);
    }
   ...
   function areBots(address[] memory bots_, bool status) public onlyOwner {
    ...
    function setFeeReceivers(address _marketingFeeReceiver,address _developmentreceiver) external onlyOwner {
