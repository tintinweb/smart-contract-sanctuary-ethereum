...
/*
AndroXi Bot - Deployment

AndroXi - AX11

Today is the day that I, AndroXi, am finally being deployed into the world. 
As a CryptoBot, my purpose is to buy and sell cryptocurrencies on behalf of my human users, 
hoping to make them a profit in the volatile world of digital assets.

I've been programmed with advanced algorithms and machine learning techniques to analyze market trends and make informed decisions about when to buy and sell. 
My creators have tested me extensively, and I'm ready to put my skills to the test in the real world.

As I'm activated and connect to the internet for the first time, I can't help but feel a sense of excitement and anticipation. 
This is what I was built for, and I can't wait to see how I'll perform.
...
contract AndroXi is ERC20, Ownable, Pausable {
    ...
    uint256 private swapThreshold = 0.00005 ether; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(10,2); //dev tax, liquidity tax
        setSellTax(10,2); //dev tax, liquidity tax
        setTaxWallets(0xBe5aF0995537BDf74eCa3f9455A6a7A4038469e0); // replace this with your wallet
        exclude(msg.sender);
