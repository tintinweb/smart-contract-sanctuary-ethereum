...
/**
    Samurai Shinobi ERC Token
    Telegram: https://t.me/SamuraiShinobiERC
    Twitter:  https://twitter.com/SAMURAISHINOBI_
...
contract SamuraiShinobi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x236d12ae5Bd2796d1F6124919579409E3dC45553); // Marketing Address
    address payable public multiSigAddress = payable(0x236d12ae5Bd2796d1F6124919579409E3dC45553); // Marketing Address
    address payable public devAddress = payable(0x236d12ae5Bd2796d1F6124919579409E3dC45553); // Dev Address
    address payable public liquidityAddress = payable(0x236d12ae5Bd2796d1F6124919579409E3dC45553); // Liquidity Address
    ...
    string private constant _name = unicode"Samurai Shinobi";
    string private constant _symbol = unicode"SANOBI";
