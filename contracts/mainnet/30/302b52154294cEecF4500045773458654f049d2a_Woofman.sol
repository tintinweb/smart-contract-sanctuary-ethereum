...
/**
$WOOF is the latest meme to hit ERC20 and boy we've got huge plan for this!
Tax will be 3/3 final with lp burned and ca renounced.
...
contract Woofman is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0x84aa1D599D54eF176eFFf75bB73F0808AFf41a42); 
    address payable public Dev_Wallet = payable(0x3F16DB2D386373A996471e1027F2004e6CbC9B4c);
    ...
    constructor () {
        ...
        _owner = 0x3F16DB2D386373A996471e1027F2004e6CbC9B4c;
