...
/*
  ...
  _____    _   _  U _____ u       ____   _   _               ____    _____  
 |_ " _|  |'| |'| \| ___"|/    U /"___| |'| |'|     ___    U|  _"\ u|"_  /u 
   | |   /| |_| |\ |  _|"      \| | u  /| |_| |\   |_"_|   \| |_) |/U / //  
  /| |\  U|  _  |u | |___       | |/__ U|  _  |u    | |     |  __/  \/ /_   
 u |_|U   |_| |_|  |_____|       \____| |_| |_|   U/| |\u   |_|     /____|  
 _// \\_  //   \\  <<   >>      _// \\  //   \\.-,_|___|_,-.||>>_   _//<<,- 
(__) (__)(_") ("_)(__) (__)    (__)(__)(_") ("_)\_)-' '-(_/(__)__) (__) (_/ 

*/

contract TheChipzNFT is IERC721A { 
    ...
    string private constant _name = "The Chipz";
    string private constant _symbol = "CHIPZ";
    string private constant _contractURI = "ipfs://QmZfvQPvzAn5HCr61aYB1K5sFq4GH1rpJqec3X2oLSEQhU";
    string private _baseURI = "ipfs://QmeMr7wv77afCiyEM5c9Lfjc5BaTLYxo8Waz9kdDKacvxM/";
    ...
    function mint5() external payable{
        address _caller = _msgSenderERC721A();
        uint256 _amount = 5;

        require(saleIsActive, "NotActive");
        require(totalSupply() + _amount <= MAX_SUPPLY, "SoldOut");
        require(msg.value >= 0.025 ether, "More Cash");
    ...
    function mint50() external payable{
        ...
        require(saleIsActive, "NotActive");
        require(totalSupply() + _amount <= MAX_SUPPLY, "SoldOut");
        require(msg.value >= 0.20 ether, "More Cash");
