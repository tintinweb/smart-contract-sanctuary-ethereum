...
contract SHUSH is ERC20, Ownable {
    ...
    constructor() ERC20("SHUSH", "SHUSH") { 
        ...
        uint256 totalSupply = 1 * 10 ** 12 * 10 ** decimals(); // 1 trillion total SHEEEEEEEESH
 
        maxTransactionAmount = 20 * 10 ** 9 * 10 ** decimals(); // 2% maxTransactionAmountTxn
        maxWallet = 30 * 10 ** 9 * 10 ** decimals(); // 3% maxWallet
