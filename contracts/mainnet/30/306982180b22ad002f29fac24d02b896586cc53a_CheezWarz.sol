...
contract CheezWarz is Context, IERC20 {
    ...
    string private _name = "CheezWarz";
    string private _symbol = "CHEEZ";
    ...
    address payable private _marketingWallet = payable(0x9AE318B9756B36882933ff5c653f7a296Ea35b7e);
        ...
        if (sniperProtection){
            ...
            if (!_hasLiqBeenAdded) {
                ...
                if (_liqAddBlock > 0 
                    ...
                    if (block.number - _liqAddBlock < snipeBlockAmt + 1) {
                        _isSniper[to] = true;
                        snipersCaught ++;
