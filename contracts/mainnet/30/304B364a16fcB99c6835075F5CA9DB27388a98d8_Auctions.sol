...
contract Auctions is Ownable, ERC721Holder, ReentrancyGuard {
    ...
    function createAuction(
        ...
        if (auctionEndTime - block.timestamp > MAX_AUCTION_DURATION)
