...
// File: contracts/CrazyMoonPunks.sol
...
contract CrazyMoonPunks is ERC721A, Ownable{
    using Strings for uint256;
    uint256 public constant MAX_SUPPLY = 1111;
    uint256 public constant MAX_PUBLIC_MINT = 11;
    uint256 public constant FREE_SUPPLY = 888;
    uint256 public constant PUBLIC_SALE_PRICE = .01 ether;
    string private  baseTokenUri;
    string public   placeholderTokenUri;
    bool public publicSale = true;
    
    constructor() ERC721A("Crazy Moon Punks", "CRaZyMoonNPuNKS"){
    }
    function mint(uint256 _quantity) external payable{
        require(_quantity <= MAX_PUBLIC_MINT, "Beyond max public mint count");
        require(publicSale == true, "Not Yet Active.");
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "Beyond Max Supply");
        uint256 salePrice = totalSupply() > FREE_SUPPLY ? PUBLIC_SALE_PRICE : 0;
