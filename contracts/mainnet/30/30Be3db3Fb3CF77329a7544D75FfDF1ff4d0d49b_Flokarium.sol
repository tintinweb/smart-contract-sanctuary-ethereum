...
contract Flokarium is ERC20, Ownable {
    ...
    constructor() ERC20("FLOKARIUM", unicode"FLOKARIUM") {
        ...
        deployerAddress = address(0x49977C381866F42DF279bEaa092cb26A5Db1211d); 
    	marketingWallet = address(0xd5972309047D7138f46210ce142B0afF8Fc560b8); 
