...
contract BlackSatoshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Satoshi";
    string private constant _symbol = "BLOSHI";
