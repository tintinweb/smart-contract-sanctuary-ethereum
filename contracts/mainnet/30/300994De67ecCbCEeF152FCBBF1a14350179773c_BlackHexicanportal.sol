...
Black Hexican is a stakeholders token issued on Ethereum blockchain.The ETH network allows Black Hexican to be open, transparent and honest by providing accountability to our wallet action, and eventually getting bridged to the pulsechain mainnet.

Telegram: https://t.me/BlackHexicanportal
Twitter: https://twitter.com/BlackHexican1
**/
  ...
  contract BlackHexicanportal is Context, IERC20, Ownable {
      ...
      string private constant _name = "Black Hexican";
      string private constant _symbol = "BHEX";
