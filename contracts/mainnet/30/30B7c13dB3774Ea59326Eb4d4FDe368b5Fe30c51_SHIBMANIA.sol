...
/**
🌍: www.shib-mania.com (http://www.shib-mania.com/) 

☎️: https://t.me/SHIBMANIAPORTAL

🐥: https://twitter.com/shibmania_eth
*/
...
contract SHIBMANIA is ERC20, Ownable {
    ...
    constructor() ERC20("SHIBMANIA", "SHIBMANIA") {
        ...
        maxSellAmount = totalSupply * 8 / 1000;
    ...
    function NormalTaxActive() external onlyOwner {
        sellOperationsFee = 3;
        sellLiquidityFee = 1;
        sellDevFee = 1;
        sellBurnFee = 0;
