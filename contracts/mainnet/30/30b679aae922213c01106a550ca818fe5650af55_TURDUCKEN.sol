...
contract TURDUCKEN is RewardsToken {
    ...
    uint256 private platformFee = 100; //  0.75%
    uint256 private _previousPlatformFee = platformFee;

    uint256 public devFee = 400; // 4%
    uint256 public sellDevFee = 400; // 5%
    uint256 private _previousDevFee = devFee;
    
    uint256 public rewardsFee = 0; // 4%
    uint256 public sellRewardsFee = 0; // 5%
    uint256 private _previousRewardsFee = rewardsFee;

    uint256 public launchSellFee = 0; // 9.25%
    ...
    address payable private _devWalletAddress =
        payable(0x10F96358C91D19f500a473410e3Fc77831753014);
    ...
    uint256 private minTokensBeforeSwap = 420000 * 10**9;
    ...
    constructor() ERC20("Gobble, Quack, & Cluck", "TURDUCKEN") {
