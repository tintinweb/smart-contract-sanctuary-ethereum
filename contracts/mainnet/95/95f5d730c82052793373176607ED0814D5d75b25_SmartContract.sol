...
Initial Buy: 100,000,000(1%)
Max Hold: 300,000,000 (3%)
Tax: 4/4


Telegram: https://t.me/KIMETSUKokushibomoon
Website: https://kokushibomoon.com/
...
contract SmartContract is Context, IERC20, Ownable {///////////////////////////////////////////////////////////
    ...
    string private constant _name = "Kokushibomoon";//////////////////////////
    string private constant _symbol = "KIMETSU";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0x53fbECf5D07dfE53dB457ddf2d9983Ed78831178);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x53fbECf5D07dfE53dB457ddf2d9983Ed78831178);///////////////////////////////////////////////////
    ...
    uint256 public _maxTxAmount = 100000001 * 10**9; //1%
    uint256 public _maxWalletSize = 100000001 * 10**9; //1%
    uint256 public _swapTokensAtAmount = 100000001 * 10**9; //1%
    ...
    //Set MAx transaction
     function setMaxTxnWalletAmount(uint256 maxTxAmount, uint256 maxWalletSize) public onlyOwner {
