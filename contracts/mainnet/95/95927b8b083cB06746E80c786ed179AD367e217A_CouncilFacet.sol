...
contract CouncilFacet is IDiamondFacet, ICouncil {
    ...
    function getFacetPI()
      external pure override returns (string[] memory) {
        ...
        pi[ 0] = "initializeCouncil(uint256,address,address,address,uint256,uint256,uint256,uint256)";
        pi[ 1] = "getCouncilSettings()";
        pi[ 2] = "setCouncilSettings(address,address,uint256,uint256,bool,uint256,uint256)";
        pi[ 3] = "setDefaultHolderEligibilityThreshold(uint256,uint256)";
        pi[ 4] = "setDefaultProposalPassThreshold(uint256,uint256)";
        pi[ 5] = "isVotingBlacklisted(address)";
        pi[ 6] = "blacklistVoting(uint256,address,bool)";
        pi[ 7] = "isVotingExcluded(address)";
        pi[ 8] = "excludeVoting(uint256,address,bool)";
        pi[ 9] = "getAccountProposals(address,bool)";
        pi[10] = "transferTokensFromCouncil(uint256,address,uint256)";
        pi[11] = "icoTransferTokensFromCouncil(address,address,address,uint256)";
        pi[12] = "executeAdminProposal(address,uint256)";
        pi[13] = "executeProposal(address,uint256)";
        return pi;
    }
    ...
    function getFacetProtectedPI()
      external pure override returns (string[] memory) {
        ...
        pi[ 0] = "setCouncilSettings(address,address,uint256,uint256,bool,uint256)";
        return pi;
    }
    ...
    function supportsInterface(bytes4 interfaceId)
      external pure override returns (bool) {
        return
            ...
            interfaceId == type(ICouncil).interfaceId;
    }
    ...
    function initializeCouncil(
        ...
        CouncilInternal._initialize(
            registereeId,
            grantToken,
            feeCollectionAccount,
            icoCollectionAccount,
            proposalCreationFeeMicroUSD,
            adminProposalCreationFeeMicroUSD,
            icoTokenPriceMicroUSD,
            icoFeeMicroUSD
        );
    }

    function getCouncilSettings() external view returns (
        address, // registrar
        uint256, // registereeId
        address, // grantToken
        ...
        return CouncilInternal._getCouncilSettings();
    }

    function setCouncilSettings(
        address feeCollectionAccount,
        address icoCollectionAccount,
        uint256 proposalCreationFeeMicroUSD,
        uint256 adminProposalCreationFeeMicroUSD,
        ...
        CouncilInternal._setCouncilSettings(
            feeCollectionAccount,
            icoCollectionAccount,
            proposalCreationFeeMicroUSD,
            adminProposalCreationFeeMicroUSD,
    ...
    function setDefaultHolderEligibilityThreshold(
        uint256 adminProposalId,
        uint256 newValue
    ) external {
       CouncilInternal._setDefaultHolderEligibilityThreshold(adminProposalId, newValue);
    }

    function setDefaultProposalPassThreshold(
        uint256 adminProposalId,
        uint256 newValue
    ) external {
        CouncilInternal._setDefaultProposalPassThreshold(adminProposalId, newValue);
    }

    function isVotingBlacklisted(address account) external view returns (bool) {
        return CouncilInternal._isVotingBlacklisted(account);
    }

    function blacklistVoting(
        uint256 adminProposalId,
        address account,
        bool blacklist
    ) external {
        CouncilInternal._blacklistVoting(adminProposalId, account, blacklist);
    }

    function isVotingExcluded(address account) external view returns (bool) {
        return CouncilInternal._isVotingExcluded(account);
    }

    function excludeVoting(
        uint256 adminProposalId,
        address account,
        bool excluded
    ) external {
        CouncilInternal._excludeVoting(adminProposalId, account, excluded);
    }
    ...
    function getAccountProposals(
        ...
        return CouncilInternal._getAccountProposals(account, onlyPending);
    }

    function transferTokensFromCouncil(
        uint256 adminProposalId,
        address to,
        uint256 amount
    ) external reentrancyProtected {
        CouncilInternal._transferTokensFromCouncil(adminProposalId, to, amount);
    }
    ...
    function icoTransferTokensFromCouncil(
        ...
        address to,
        uint256 amount
    ) external override reentrancyProtected payable {
        CouncilInternal._icoTransferTokensFromCouncil(payErc20, payer, to, amount);
    }

    // NOTE: this function SHOULD be called by a contract however we don't
    //       make this a MUST as we have the condition for the caller on
    //       being a finalizer.
    function executeAdminProposal(
        ...
        CouncilInternal._executeAdminProposal(caller, executor, adminProposalId);
    }
    ...
    function executeProposal(
        ...
        address caller = msg.sender;
        CouncilInternal._executeProposal(caller, executor, proposalId);
    }
}
