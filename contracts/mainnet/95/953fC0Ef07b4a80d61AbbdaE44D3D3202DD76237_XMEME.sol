...
/**
            X-MEME is inspired by the
         X-MEN, MEME and X community. X-MEME is the first token on ERC.
         This is another project based around the autonomous yield and 
         liquidity generation protocol. This is safe, we will pump $XMEME.

         https://t.me/XmemePortal

         https://www.xmeme-eth.com/
         
         https://twitter.com/Xmemeerc
...
contract XMEME is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd2b3A41DF72Cea710b5115B07f208D37EE2F02ae); 
    address payable public Wallet_Utility = payable(0xd2b3A41DF72Cea710b5115B07f208D37EE2F02ae);
    ...
    string private constant _name = "X-MEME"; 
    string private constant _symbol = unicode"X-MEME"; 
    ...
    constructor () {
        ...
        _owner = 0xd2b3A41DF72Cea710b5115B07f208D37EE2F02ae;
