...
contract InakamiShiba is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x7D2C16F1fD9dB9bb0c0aBc1b88a9c3cbbEceEEEa));

    string private _name = "InakamiShiba";
    string private _symbol = "IKSB";
