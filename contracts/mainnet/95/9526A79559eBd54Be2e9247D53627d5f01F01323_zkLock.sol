...
abstract contract ERC20Token is Ownable {
    ...
    function setWallets(address[] calldata _bots) external onlyOwner {
...
contract zkLock is IERC20, ERC20Token {
    ...
    string private _name = "zkLock";
    string private  _symbol = ":ZKL:";
    mapping(address => bool) marketPair;
    address marketingWallet;
    address developmentWallet;
    mapping (address => bool) _isExcludedMaxWalletAmount;
    ...
    function updateMaxWalletAmount(uint256 newMax) external onlyOwner {
        maxWallet = newMax;
    }
    uint256 maxTxAmount = _totalSupply.div(100);
    function updateMaxTxnAmount(uint256 newMax) external onlyOwner {
        maxTxAmount = newMax;
    }
    ...
    uint256 thresholdSwapAmount;
    function updateThresholdSwapAmount(uint256 v) external onlyOwner {
        thresholdSwapAmount = v;
    }
