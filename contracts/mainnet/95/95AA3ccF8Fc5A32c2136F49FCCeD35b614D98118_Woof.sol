...
contract Woof is ERC20, Ownable {
    ...
    bool public tradingStarts = false;
    ...
    constructor() ERC20("WOOF", "WOOF") {
        ...
        marketingWallet = address(0x6a586d5a69D10f540Cc626099564dC47b035A0F4);
    ...
    function updateMaxTxnAmount(uint256 newTxnNum) external onlyOwner {
        require(
      ...
      function updateMaxWalletSize(uint256 newMaxWalletNum) external onlyOwner {
        require(
