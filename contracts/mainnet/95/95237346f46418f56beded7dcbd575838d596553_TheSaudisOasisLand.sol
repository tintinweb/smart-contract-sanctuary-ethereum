...
// File: contracts/TheSaudisOasisLand.sol
...
contract TheSaudisOasisLand is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  ERC721A private tmac=ERC721A(0xC68C9C5FA14f718b39A6d836b8870fADDE4f2Aa5);
  constructor(
    string memory _hiddenMetadataUri
  ) ERC721A("The Saudis Oasis Land", "TSOL") {
 ...
 function claim() public nonReentrant {
  ...
  function unclaimed(address user) public view returns(uint256){
    ...
    if (tbac.balanceOf(user) >= tmac.balanceOf(user) ) {
          return tmac.balanceOf(user);
      } else {
