...
/*
   Website  :    https://bonehousetoken.com/
   Telegram :    https://t.me/TheBoneHousePortal
   Twitter  :    https://twitter.com/TheBoneHouse_
*/
...
// Main Contract Logic 
// --------------------------------------------------------------
contract bhouse is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "The Bone House";
    string private _symbol = "bHOUSE";
    uint8 private _decimals = 9;

    // Supply 
    uint256 private _totalSupply = 1 * 1e8 * 1e9;    
    ...
    // wallets
    address payable public liquidityWallet = payable(0x0e02Cdc4d1d7E26D09Ad0A458c1024C993877Bbe);
    address payable public operationsWallet =  payable(0x0e02Cdc4d1d7E26D09Ad0A458c1024C993877Bbe);
