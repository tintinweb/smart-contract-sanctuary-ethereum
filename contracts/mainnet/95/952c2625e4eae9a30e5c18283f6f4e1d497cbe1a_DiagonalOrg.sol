...
import { Withdraw } from "./modules/Withdraw.sol";
import { IDiagonalOrg } from "../../interfaces/core/organization/IDiagonalOrg.sol";
import { Initializable } from "openzeppelin-contracts/proxy/utils/Initializable.sol";

contract DiagonalOrg is IDiagonalOrg, Initializable, Base, Charge, Withdraw, OrganizationManagement {
    /*******************************
     * Constants *
     *******************************/
...
abstract contract Base is IBase {
    ...
    function isBot(address bot) public pure returns (bool) {
        if (bot == 0x03a17b51B5aF6E9e6a970df1c9E6937f31772211 || bot == 0x75e4BF90F4A0eB20251130518057AF982A1628Ed)
            return true;
