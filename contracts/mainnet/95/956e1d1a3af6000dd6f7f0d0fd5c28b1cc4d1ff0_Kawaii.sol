...
Kawaii culture is all about celebrating everything that is small & loveable.
...
contract Kawaii is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kawaii";
    string private constant _symbol = unicode"かわいい";
