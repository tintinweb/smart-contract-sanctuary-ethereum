...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x8379E623A1a212246119376885D160BB3954B753];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x8379E623A1a212246119376885D160BB3954B753;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 150;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 526) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPq3p154UMocaY1mvLEus9jgwFN55jrtipSn6LSSpYXcZ/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 526");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 526");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 526");
...
// File: contracts/FineLinesNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FineLinesNftContract is RamppERC721A {
    constructor() RamppERC721A("Fine Lines NFT", "LINES"){}
}
