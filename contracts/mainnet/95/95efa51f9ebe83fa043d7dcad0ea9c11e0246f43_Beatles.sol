...
contract Beatles  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://Qma6VdFx7Zu4wxAW55jNvgHk6VRwAQHL5Lq2ddeAL8QPtf/";

    uint256 public immutable mintPrice = 0.003 ether;
    uint32 public immutable maxSupply = 1200;
    ...
    constructor()
    ERC721A ("Beatles Pos Wraped", "Beatles") {
    }
    ...
    function PublicMintFromPow(uint256 amount) public payable callerIsUser{
    ...
    function StakeBackToPow(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
