...
contract ERC20DividendToken is Context, ERC20Burnable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_, address routerV2_, address marketingAddress_) ERC20(name_, symbol_) {
        ...
        minTokensBeforeSwap = 10_000_000 * (10**18);

        maxWalletAmount = totalSupply_ * (10**18);
        ...
        */
        ...
        _mint(_msgSender(), totalSupply_ * (10**18));
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (marketingBuyFee > 0 || marketingSellFee > 0) {
                swapAndSendDividendsToMarketing(balanceOf(address(this)));
            }
...
contract $WOJAK is ERC20DividendToken {

    uint256 private _tokenSupply = 100_000_000_000;

    address private _routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    constructor (address _marketingAddress) ERC20DividendToken("WojakInu", "$WOJAK", _tokenSupply, _routerAddress, _marketingAddress) {
