...
/**
https://twitter.com/syndicateerc20/status/1638178952832495619?s=20
https://t.me/syndicateofficialgroup
*/
...
contract SYNDICATE is ERC20, Ownable {
    ...
    constructor() ERC20("SYNDICATE", unicode"📦SYN") payable {
    	...
    	marketingWallet = address(0x3915776dA22d4DAbe0D494b051c7637e30e6CdF4); // set as Marketing wallet
        devWallet = address(0x145A8958e729B307c80EdbfFfbC0e442c6eb8215); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x3915776dA22d4DAbe0D494b051c7637e30e6CdF4, true);
        excludeFromFees(0x145A8958e729B307c80EdbfFfbC0e442c6eb8215, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x3915776dA22d4DAbe0D494b051c7637e30e6CdF4, true);
        excludeFromMaxTransaction(0x145A8958e729B307c80EdbfFfbC0e442c6eb8215, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x145A8958e729B307c80EdbfFfbC0e442c6eb8215,
            block.timestamp
        );
    }
