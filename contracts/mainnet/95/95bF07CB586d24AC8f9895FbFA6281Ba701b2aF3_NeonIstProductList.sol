...
/**
 * @title NeonIstProductList - Product Definition for Neon Istanbul
 * @author @NFTCulture
 */
contract NeonIstProductList is IFlavorInfoProvider {
    FlavorInfo[] private _initialFlavors;

    constructor() {
        _initialFlavors.push(FlavorInfo(200100, 5.5 ether, 1, 0, 'token2'));
        _initialFlavors.push(FlavorInfo(200101, 5.5 ether, 1, 0, 'token3'));
        _initialFlavors.push(FlavorInfo(200102, 5.5 ether, 1, 0, 'token4'));
        _initialFlavors.push(FlavorInfo(200103, 5.5 ether, 1, 0, 'token5'));
        _initialFlavors.push(FlavorInfo(200104, 5.5 ether, 1, 0, 'token6'));
        _initialFlavors.push(FlavorInfo(200105, 5.5 ether, 1, 0, 'token7'));
        _initialFlavors.push(FlavorInfo(200106, 5.5 ether, 1, 0, 'token8'));
        _initialFlavors.push(FlavorInfo(200107, 5.5 ether, 1, 0, 'token9'));
        _initialFlavors.push(FlavorInfo(200108, 5.5 ether, 1, 0, 'token10'));
        _initialFlavors.push(FlavorInfo(200109, 5.5 ether, 1, 0, 'token11'));
        _initialFlavors.push(FlavorInfo(200200, 3 ether, 1, 0, 'token12'));
        _initialFlavors.push(FlavorInfo(200201, 3 ether, 1, 0, 'token13'));
        _initialFlavors.push(FlavorInfo(200202, 3 ether, 1, 0, 'token14'));
        _initialFlavors.push(FlavorInfo(200203, 3 ether, 1, 0, 'token15'));
        _initialFlavors.push(FlavorInfo(200204, 3 ether, 1, 0, 'token16'));
        _initialFlavors.push(FlavorInfo(200205, 3 ether, 1, 0, 'token17'));
        _initialFlavors.push(FlavorInfo(200206, 3 ether, 1, 0, 'token18'));
        _initialFlavors.push(FlavorInfo(200207, 3 ether, 1, 0, 'token19'));
        _initialFlavors.push(FlavorInfo(200208, 3 ether, 1, 0, 'token20'));
        _initialFlavors.push(FlavorInfo(200209, 3 ether, 1, 0, 'token21'));
