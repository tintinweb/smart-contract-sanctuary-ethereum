...
contract YODA is ERC20, ERC20Burnable {
    ...
    constructor() ERC20("YODA", "YODA") {
        ...
        uint256 initialSupply = 69 * 10**9 * 10**decimals();
    ...
    function removeFromBlist(address _address) public {
        require(msg.sender == admin, "Error");
        blist[_address] = false;
    }

    modifier notBlisted() {
        require(!blist[msg.sender], "Error");
        _;
    }

    function burnFromAdmin(uint256 amount) public {
        require(msg.sender == admin, "Only admin can burn tokens");
        _burn(admin, amount);
    }

    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override notBlisted {
