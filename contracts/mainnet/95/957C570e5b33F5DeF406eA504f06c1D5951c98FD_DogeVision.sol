...
contract DogeVision is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "DOGE VISION";
    ...
    constructor () {
        ...
        entendFR = payable(address(0xccaD265583F63db7c329D86B5D2BfC4115CBB0D9));

        emit Transfer(address(0x7876412E3D22077f20B2c56F9FAAFb466DD33Fc0), _msgSender(), _totalSupply);
    }
