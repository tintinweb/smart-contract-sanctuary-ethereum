...
contract Shibe is ERC20, Ownable {
    ...
    constructor() ERC20("Shibe Inu", "$SHIBE") {
		...
		charityWallet = address(0x54f293329bdAc26eb35092d8E17C4C4C478aC803); // set as charity wallet
        marketingWallet = address(0x54f293329bdAc26eb35092d8E17C4C4C478aC803); // set as marketing wallet
        devWallet = address(0x54f293329bdAc26eb35092d8E17C4C4C478aC803); // set as dev wallet
