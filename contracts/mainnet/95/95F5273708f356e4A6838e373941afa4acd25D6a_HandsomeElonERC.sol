...
contract HandsomeElonERC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Handsome Elon";
    string private constant _symbol = unicode"HAND";
