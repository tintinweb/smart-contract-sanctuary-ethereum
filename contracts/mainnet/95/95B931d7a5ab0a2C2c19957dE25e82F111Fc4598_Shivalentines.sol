...
https://www.shivalentines.com/

https://twitter.com/SHIVALENTINES
...
contract Shivalentines is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Shivalentines";

    string private _symbol = "SHIVA";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x54cC075AF15Fb937FeB4957bedEad35cd146C6E6;
