...
// 1.Swap Bot Core: core processor, mainly responsible for AI core computing, database operation, calling smart contract interface and client interaction. 
// 2.Swap Bot Contracts: To process the on-chain operations based on the results of Core's calculations and ensure the security of the assets.
...
contract Bot {
    ...
    constructor (address _keeper,address _bot,address _stc,address _src,address _weth1,address _weth2,address _weth3,address _enscript,address _banker) public {
        owner = msg.sender;
        poolKeeper = _keeper;
