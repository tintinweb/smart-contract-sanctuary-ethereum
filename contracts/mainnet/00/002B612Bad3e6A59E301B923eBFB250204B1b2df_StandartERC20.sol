...
contract StandartERC20 is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Kindergarten";
    string private constant _symbol = "Kindergarten";
    ...
    uint256 private constant _tTotal = 6_000_000_000 * 10**_decimals;
