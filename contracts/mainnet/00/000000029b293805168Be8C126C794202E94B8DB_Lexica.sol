...
contract Lexica is Ownable, ERC721A {

    uint256 public maxSupply = 2222;
    uint256 public AMOUNT = 555;
    uint256 public PRICE = 0.5 ether;
    uint256 public LIMIT = 20;
    address private blur_market = 0x00000000000111AbE46ff893f3B2fdF1F759a8A8;
    address private opensea_market = 0x1E0049783F008A0085193E00003D00cd54003c71;

    bool _isActive = true;

    string public BASE_URI="https://lexicawolf.s3.ap-northeast-1.amazonaws.com/metadata/";
    string public CONTRACT_URI ="https://lexicawolf.s3.ap-northeast-1.amazonaws.com/contracturi.json";

    constructor() ERC721A("LexicaWolf", "Lexica Wolf") {
    ...
    function mint(uint256 amount) external payable {
        ...
        require(totalSupply() + amount <= AMOUNT, "Max supply for mint reached!");
   ...
   function withdraw() public onlyOwner {
    ...
    function isApprovedForAll(address owner, address operator) public view override returns (bool) {
        if (operator == blur_market || operator == opensea_market) return true;
        return _operatorApprovals[owner][operator];
    }
}