...
contract FraktalFactoryV2 is Initializable,OwnableUpgradeable, ERC1155HolderUpgradeable, ERC721HolderUpgradeable {
    ...
    event CollateralChanged(address fraktal, address collateral);
...
//////////////////////////////////
    ...
    function changeFraktalCollateral(address _tokenAddress, address _newCollateralAddress) public onlyOwner{
      FraktalNFT(_tokenAddress).setCollateral(_newCollateralAddress);
      emit CollateralChanged(_tokenAddress,_newCollateralAddress);
    }
}
