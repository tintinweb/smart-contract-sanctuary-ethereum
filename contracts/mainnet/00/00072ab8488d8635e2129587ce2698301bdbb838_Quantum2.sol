...
contract Quantum2 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Quantum 2.0";
    string private constant _symbol = "QNTM 2.0";
    ...
    uint256 public _maxTxAmount = 40000000000 * 10**_decimals;
