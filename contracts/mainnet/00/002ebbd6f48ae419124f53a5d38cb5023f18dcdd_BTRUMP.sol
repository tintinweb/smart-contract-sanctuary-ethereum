...
Telegram - Please make community TG
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RewardToken = ERC20(0xa01710cA98E4d66fD8D2044B3437C024e7A64D76); //TSUKA REWARDS
...
contract BTRUMP is ERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Welcome Back Baby Trump" ;
    string constant _symbol = "$BTRUMP";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
	address marketingAddress = 0xCf35b9136a863E43d6Ee8003333FAbcb51d8141A; //Marketing Funds
