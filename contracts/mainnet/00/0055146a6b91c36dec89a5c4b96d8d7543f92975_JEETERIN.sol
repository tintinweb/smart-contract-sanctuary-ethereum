...
/*
VITALIK IS THE ULTIMATE JEET.
HE SOLD SOME COINS FOR $2X
VITALIK JEETERIN NGMI
*/
...
contract JEETERIN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Vitalik Jeeterin";
    string private constant _symbol = "2X";
    ...
    address payable private _developmentAddress = payable(0xcd4113aba017CB2B5C866f1A3adceFBAFf3562F7); 
    address payable private _marketingAddress = payable(0xcd4113aba017CB2B5C866f1A3adceFBAFf3562F7);
