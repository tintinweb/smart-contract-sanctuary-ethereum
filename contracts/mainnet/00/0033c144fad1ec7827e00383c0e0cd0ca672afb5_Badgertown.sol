...
contract Badgertown is ERC721A, Ownable {

	using Strings for uint256;
	
	uint public constant MAX_TOKENS = 1690;
	...
	constructor() ERC721A("Badgertown", "Badgertown") {
		setBaseURI("ipfs://QmSeNUoEcgRvnSCAhWRnn52EzgwBLw9nsukDwGRfeDbJ9M/");
	}
