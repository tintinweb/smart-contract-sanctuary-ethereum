...
contract Blacklist is ERC20, Ownable {
    ...
    uint256 public devBuyFee = 35; 
    uint256 public devSellFee = 55; 
    uint256 public burnSellFee = 0;
    uint256 public maxBuyTransactionAmount = 37037037 * (10**18);
    uint256 public maxSellTransactionAmount = 37037037 * (10**18);
    uint256 public swapTokensAtAmount = 370373 * (10**18);
    uint256 public maxWalletToken = 37037037 * (10**18);

    address payable public devWallet = payable(0xf96837A6D46A2557d0e09D6C56Fae9C3f8aaCe67);
    ...
    constructor() ERC20("Blacklist", "Black") {
        ...
        */
        _createTotalSupply(owner(), 1234567890 * (10**18));
    }
