...
// AMERICAN DREAM 
// From Rags To Riches. A Gamify and Payment Network token reviving the American Dream. 
// https://twitter.com/USDREAMTOKEN 
// https://american-dream.io
...
contract AmericanDream is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50505050000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "AMERICAN DREAM";
    ...
    uint256 public marketingFeePercent = 89;
    ...
    uint256 public _maxTxAmount = 50505050000000000; 
    uint256 public numTokensSellToAddToLiquidity = 505050500000000;
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 89, "Marketing fee cannot be more than 50% of liquidity");
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 69, "Max Tx Amount cannot be less than 69 ");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 69, "Swap Threshold Amount cannot be less than 69 ");
