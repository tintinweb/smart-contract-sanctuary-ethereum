...
contract Migration is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0x9fC3c3F52a9B18b0E7E3893CA51CB3E640d9C2bd));
        
        // Token V2 -- will be updated to new Contract once live
        token2 = IERC20(address(0xCB5F2CC43b5Cb1902E43E647e279932fA0a14f87));  // UPDATE
        
        // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
        liquidityWalletForV2 = address(0x3B826D817058179889e289903038e6D4AC6Ab144);  // UPDATE
