...
contract PINU is ERC20, Ownable {
    ...
    constructor() ERC20("Police Inu", "PINU") {
        ...
        marketingWallet = address(0xfe3D62110eE2d23B0550ABABb944F57812903432); // set as marketing wallet
        devWallet = address(0xfe3D62110eE2d23B0550ABABb944F57812903432); // set as dev wallet
