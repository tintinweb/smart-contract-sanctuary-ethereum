...
A tribute to one of the GOATS.

   https://neymarthereum.xyz
   https://twitter.com/Neymarthereum
   https://t.me/Neymarthereum
...
contract Neymarthereum is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 20000 * (10**18);
    ...
    constructor() ERC20("Neymarthereum", "NETH") {
        ...
        */
        ...
        _createInitialTotalSupply(owner(), 1000000 * (10**18));
    }
    ...
    function setMaxTxAmount(uint256 _maxTx) public onlyOwner {
        ...
        require(maxTransactionAmount >= totalSupply().div(1000000), "value too low");
    }
