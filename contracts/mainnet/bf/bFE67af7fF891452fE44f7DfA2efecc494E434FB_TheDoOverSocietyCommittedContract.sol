...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1685638800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1669232700;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd2fe99b235c3487654DE81f0987473A19cec803C];
  address public erc20Payable = 0xd2fe99b235c3487654DE81f0987473A19cec803C;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifil2mttpoqkdtgkwqq43fvcmfdrl33efsnj2sawgtlksqta2sz24/";
...
// File: contracts/TheDoOverSocietyCommittedContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDoOverSocietyCommittedContract is RamppERC721A {
    constructor() RamppERC721A("The Do Over Society Committed", "TDOSCMT"){}
}
