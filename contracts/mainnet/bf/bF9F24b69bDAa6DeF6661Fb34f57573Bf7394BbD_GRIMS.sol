...
contract GRIMS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Grims", "McGrims") {
        ...
        marketingWallet = address(0xc6EeC8CD04416F00E54952136BcfaEE993A8989D);
        developmentWallet = address(0xc6EeC8CD04416F00E54952136BcfaEE993A8989D);
    ...
    function McstartGrims() external onlyOwner {
        isTrading = true;
        swapEnabled = true;
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;
        require(_fees.buyTotalFees <= 3, "Must keep fees at 3% or less");   
        require(_fees.sellTotalFees <= 3, "Must keep fees at 3% or less");
    }
