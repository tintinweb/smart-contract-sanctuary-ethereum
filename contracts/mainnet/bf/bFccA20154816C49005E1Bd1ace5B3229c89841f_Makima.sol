...
contract Makima is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode" Chainsaw Man";
    string private constant _symbol = unicode"MAKIMA";
