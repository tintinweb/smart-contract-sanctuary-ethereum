...
The fastest, lightest and most secure sniper bot ever created.

The SimpleSnipe Sniper Bot is only available to users holding atleast 2% of the Total Supply, 
Which means that not all have access to the bot, decreasing lag and increasing the speed of the bot over traditional bots.

Website - https://simplesnipe.com/
Telegram - https://t.me/SimpleSnipeErc
Twitter - https://twitter.com/simplesnipeerc
...
contract SimpleSnipe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Simple Snipe";
    ...
    uint256 private constant _tTotal = 33333333 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x928591493BCC67B8BD351c5334DF52c01D15f683); 
    address payable private _marketingAddress = payable(0x928591493BCC67B8BD351c5334DF52c01D15f683);
