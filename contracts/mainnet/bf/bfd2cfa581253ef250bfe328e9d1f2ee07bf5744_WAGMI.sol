...
contract WAGMI is ERC1155, Ownable {
    ...
    string public constant symbol = "WAGMI";

    uint32 public constant maxSupply = 3022;
    uint256 public constant unitPrice = 0.125 ether;

    uint32 public totalSupply = 0;
    uint32 public saleStart = 1648324800;
    ...
    function withdraw() external onlyOwner {
        address[2] memory addresses = [
            0xb166139a65fe53162936760aB9596b71b2467E82,
            0x6951E3dF5AeE8b018325ce2FBC0c399858d76eE0
        ];
