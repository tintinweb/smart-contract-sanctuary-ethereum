...
/**
Welcome to Deploy.AI, the first artificial intelligence that will help you create your contracts on the ETH Network from Telegram.

- Portal: t.me/deployaiportal
- DeployAI Bot for Goerli Network: t.me/DeployAIBot
- Website: https://www.deployaierc20.com/
- Twitter: https://twitter.com/DeployAIerc20
...
contract DAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "DeployAI";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x86Ae2E82C48A065275886d28263A99cEeefdCe2B);
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingWallet.transfer(amount.mul(70).div(100));
        _teamWallet.transfer(amount.mul(30).div(100));
    }
