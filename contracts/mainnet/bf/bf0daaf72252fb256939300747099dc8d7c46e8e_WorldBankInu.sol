...
/** 
The financial system is broken... We must be the change we want to see in the world.

WorldBankInu.com

medium.com/@WorldBankInu

twitter.com/WorldBankInu
...
contract WorldBankInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="World Bank Inu";
    string private _symbol = "WBI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x332dF3fA23218FE4C238AFa4539979fe697dD81A);
    address payable private taxWallet2 = payable(0x332dF3fA23218FE4C238AFa4539979fe697dD81A);
    ...
    uint256 public _maxTxAmount = 400 * 10**6 * 10**9;
    uint256 public _walletMax = 400 * 10**6 * 10**9;
