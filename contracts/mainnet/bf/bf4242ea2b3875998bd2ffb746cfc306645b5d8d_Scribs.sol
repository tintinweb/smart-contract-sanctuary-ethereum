...
contract Scribs is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Scribs", "SCRIBS") {}
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) external payable {
        ...
        require(WHITELIST_PRICE * _mintAmount <= msg.value, "ETH not enough");
    ...
    function mintPublic(uint256 _mintAmount) external payable {
        ...
        require(PUBLIC_PRICE * _mintAmount <= msg.value, "ETH not enough");
