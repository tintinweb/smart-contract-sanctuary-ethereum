...
/*
    Website: 
    Contract Name: BROSKI
    Twitter: 
    Telegram: https://t.me/broskiERC20
    Contract Version: 2.05
    Contract Supply: 1,000,000,000
    Contract Tokenomics:
    ...
    1% Marketing.
    7% Total Tax.
Dev Notes: Publicly Doxxed dev, Clean Contract and Amazing Community
...
contract BROSKI is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress =
        payable(0xb2df661067aE8d0405D17aBC9Bbc47A899473C57); // Marketing Wallet Address
    address payable public ecosystemWalletAddress =
        payable(0xb2df661067aE8d0405D17aBC9Bbc47A899473C57); // ecosystem Wallet Address
    ...
    uint256 private _tTotal = 1_000_000_000 gwei;
    uint256 private _tFeeTotal;

    string private constant _name = "BROSKI";
    string private constant _symbol = "BROSKI";
    ...
    event UsernameSet(address indexed _user, bytes32 indexed _username);
    ...
    function _transfer(
        ...
        require(isMaxWalletExempt[to] || balanceOf(to) + amount <= maxWalletAmount, "Max Wallet Limit Exceeds!");
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        uint256 walletsTotal = marketingTokensCollected + ecosystemTokensCollected;

        uint256 ethForMarketing = (newBalance * marketingTokensCollected) /
            walletsTotal;
        uint256 ethForecosystem = (newBalance * ecosystemTokensCollected) /
            walletsTotal;

        transferToAddressETH(marketingWalletAddress, ethForMarketing);
        transferToAddressETH(ecosystemWalletAddress, ethForecosystem);

        liquidityTokensCollected = 0;
        marketingTokensCollected = 0;
        ecosystemTokensCollected = 0;
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            1, // accept any amount of ETH //testing 1 from 0
            path,
    ...
    function countUpFeeShare(uint256 amount) private {
        ...
        ecosystemTokensCollected += (amount * _ecosystemFee) / 100;
    }
    ...
    function restoreAllFee() private {
        ...
        totalSwapableFee = _liquidityFee + _marketingFee + _ecosystemFee;
    }
    ...
    function setAllFeePercent(uint256 liquidityFee, uint256 ecosystemFee, uint256 marketingFee) 
    external onlyOwner() 
    {
        ...
        totalSwapableFee = _liquidityFee + _ecosystemFee + _marketingFee; 
    ...
    function setecosystemWalletAddress(address _ecosystemWallet) external onlyOwner {
        require(_ecosystemWallet != address(0), "setecosystemWalletAddress: ZERO");
        ecosystemWalletAddress = payable(_ecosystemWallet);
        emit AuditLog("We have Updated the ecosystemWallet:", ecosystemWalletAddress);
    }
    function setMaxWalletPercentage(uint256 percentage) public onlyOwner {
        require(percentage > 10, "Need to be greater than 0.01%");
        maxWalletAmount = (totalSupply() * percentage) / 10000;
    }

    function setMaxTxExempt(address account, bool value) external onlyOwner {
        isMaxWalletExempt[account] = value;
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        emit AuditLog("We have withdraw eth from contract.", msg.sender);
    }
