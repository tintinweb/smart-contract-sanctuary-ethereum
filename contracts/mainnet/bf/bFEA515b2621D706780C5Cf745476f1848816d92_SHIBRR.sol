...
// IF JPOW WON'T TURN THE MONEY PRINTER BACK ON IT IS UP TO US TO TAKE MATTERS INTO OUR OWN HANDS!!!

// Website: https://shibrr.com/
// Twitter: https://twitter.com/SHIBRRtoken 
// Telegram: https://t.me/ShibariumMoneyPrinter
...
contract SHIBRR is Context, IERC20, Ownable {
    ...
    string private _name = "Shibarium Money Printer";
    string private _symbol = "SHIBRR";
    ...
    uint256 public _maxTxAmount = 2000000000000 * 10**9; // 2% max tx
