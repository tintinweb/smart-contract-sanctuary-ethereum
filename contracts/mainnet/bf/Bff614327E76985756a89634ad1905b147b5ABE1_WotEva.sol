...
contract WotEva is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Whatever";
    string private constant _symbol = "Woteva";
    ...
    address payable private _developmentAddress = payable(0x9D69Ec36744f6e045769B74288410810D184C82C); 
    address payable private _marketingAddress = payable(0x9D69Ec36744f6e045769B74288410810D184C82C);
