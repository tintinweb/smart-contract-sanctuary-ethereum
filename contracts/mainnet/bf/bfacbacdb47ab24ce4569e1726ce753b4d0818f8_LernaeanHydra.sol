...
The Hydra is one of the most notorious dragons, uniquely dangerous and difficult to defeat.
...
contract LernaeanHydra is ERC20, Ownable {
    ...
    constructor() ERC20("Lernaean Hydra", "Hydra") {
		...
		charityWallet = address(0x8C145002752E030eA6305314816Af2f8B6bAF4e9); // set as charity wallet
        marketingWallet = address(0x8C145002752E030eA6305314816Af2f8B6bAF4e9); // set as marketing wallet
