...
the new golden age awaits. 

your first clue has been provided. 
good luck
...
contract CICADA3301 is ERC20, Ownable {
    ...
    constructor() ERC20("A Pilgrims Journey", "CICADA") {
        ...
        uint256 totalSupply = 5_671_110 * 1e18; // iluvw foxh (719)

        maxTransactionAmount = 85_000 * 1e18; // 1.5%
        maxWallet = 170_000 * 1e18; // 3%
        swapTokensAtAmount = (totalSupply * 3) / 10000; // 

        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0x6653DB61216E6a4d408d05Ae12dd06b224acd8E1); // set as marketing wallet
        devWallet = address(0x6653DB61216E6a4d408d05Ae12dd06b224acd8E1); // set as dev wallet
