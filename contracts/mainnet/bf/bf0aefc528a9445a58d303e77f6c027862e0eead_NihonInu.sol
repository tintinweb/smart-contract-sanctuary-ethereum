...
Find the community to unite the Inus. No fees no taxes.
...
contract NihonInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nihon Inu", "NIHON") {
        ...
        uint256 totalSupply = 1 * 1e18 * 1e9;
    ...
    function _transfer(
        ...
        if (automatedMarketMakerPairs[to] && enableEarlySellTax) {
