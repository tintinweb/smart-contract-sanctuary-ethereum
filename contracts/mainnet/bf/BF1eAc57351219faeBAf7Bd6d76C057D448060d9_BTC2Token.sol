...
contract BTC2Token is ERC20 {
    string public constant name = "bitcoin2";
    string public constant symbol = "btc2";
    ...
    constructor() public {
        ...
        uint256 data = 10000000 * (10 ** uint256(decimals));
        for (uint256 i = 0; i < 17; i++) {
            lock(msg.sender, data/2, 1798729200 + 126230400*i);
            data = data - data/2;
        }
        lock(msg.sender, data, 1798729200 + 126230400*17);
    }
