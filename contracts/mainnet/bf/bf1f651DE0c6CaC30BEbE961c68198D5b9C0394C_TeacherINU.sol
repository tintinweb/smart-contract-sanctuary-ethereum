...
//   .-:._ `:::'`:::'-'`;;;;'.;`  ` `:::'.;'          .;'     .:'.;    \: ;;     ;   
//  (_/  `-                                       .;;;;;;;;;'(__.'      `.`;.__.:    
    Let’s take a moment to reflect on the teachers in our lives and all of the lessons (inside and outside the classroom) 
    they’ve shared to help students learn and grow. #ThankATeacher #TeacherAppreciationWeek
    Portion of the tax will be donated to our Teachers worldwide
    TG: https://t.me/Teachersinu_portal
...
contract TeacherINU is Context, IERC20, Ownable {
    ...
    string private _name = "Teacher Inu";
    string private _symbol = "TEACH";
    ...
    uint256 public numTokensSellToAddToLiquidity = 77777777 * 10**9;
