...
contract EMG is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xadf422b9CFCeB44fe04a498d60Ee95D601aD6e64));

    string private _name = "Ethereum Merge 2.0";
    string private _symbol = "EMG 2.0";
