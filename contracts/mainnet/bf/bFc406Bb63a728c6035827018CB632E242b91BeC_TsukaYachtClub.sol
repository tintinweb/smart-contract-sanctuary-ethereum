...
contract TsukaYachtClub is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Tsuka Yacht Club";
    string private constant tokenSymbol = "TYC";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x6Fd5b198492B6De9Da86fA2944437275bF9A6805);
        devAddress = payable(0x6Fd5b198492B6De9Da86fA2944437275bF9A6805);
