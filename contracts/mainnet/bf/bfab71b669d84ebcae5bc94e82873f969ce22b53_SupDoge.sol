...
https://t.me/supdogetoken
https://twitter.com/SupDoge_erc
https://supdoge.xyz
...
contract SupDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sup Doge", "SUP") {
        ...
        maxTransactionAmount = totalSupply * 25 / 1000; // 2% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x37a9feFE62E253a9925e1535DA7EBFABe1EEdb52); // set as marketing wallet
        devWallet = address(0x37a9feFE62E253a9925e1535DA7EBFABe1EEdb52); // set as dev wallet
