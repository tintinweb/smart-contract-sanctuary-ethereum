...
/*
	...
	Baby Zinu ($BZINU)
	When Shiba and Zinu existed in the same plane within the ZombieVerse, the Infamous Baby Zinu was created. 
	Follow along while we unravel the story of the Baby Zinu.
	
	Telegram: https://t.me/babyzinu_portal
	Twitter: https://twitter.com/babyzinu
	Website: https://babyzinu.org
...
contract BZINU is ERC20, Ownable {
    ...
    constructor() ERC20( "Baby Zinu", "$BZINU") {
        ...
        operationsAddress = address(0x4b25C1798237721F211D727D4F37c5f171a38CeA); 
        TaxAddress = address(0xeDCe98E9d8509528F99619eCA13137F413e0cE80);
