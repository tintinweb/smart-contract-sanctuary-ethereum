...
contract ROBO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZbVggQFYXgptPoByLNn2ZL3qWmtiATgHmYLeQK5zNbmu";

    uint256 public constant MAX_MINTS_PER_TX = 10;
    uint256 public maxSupply = 589;
    ...
    constructor(
    ) ERC721A("Ether Robots", "ROBO", 100, maxSupply) {
    }
