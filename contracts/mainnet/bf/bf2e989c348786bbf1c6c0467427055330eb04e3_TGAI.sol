...
contract TGAI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Telegram AI";
    string private constant _symbol = "TGAI";
    ...
    constructor(address developmentAddr, address marketingAddr, address devFeeAddr1, address devFeeAddr2) {
        ...
        distribution = Distribution(10, 10, 80);
