...
contract MoonGnomes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWcHf7aaNMn51LRSmA33UGwMeq5y2LFhn6JJLfe1LstPD";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("MoonGnomes", "MGNOME", 100, MAX_SUPPLY) {
    }
