...
contract KITTY is ERC20, Ownable, Pausable, ReentrancyGuard {
    ...
    /// @notice Get Catpocalypse token ID by account and index
    ...
    /// @notice Get amount of claimable KITTY tokens
    ...
    /// @notice Claim available KITTY tokens
    ...
    /// @notice Remove Catpocalypse tokens from staking contract and optionally collect KITTY tokens
    ...
    /// @notice Stake Catpocalypse tokens
    ...
    /// @notice Remove Catpocalypse tokens and optionally collect KITTY tokens
    /// @param tokenIds The tokens IDs to unstake
    /// @param claimTokens Whether KITTY tokens should be claimed
    ...
    /// @notice Burn a specified amount of KITTY tokens
    ...
    /// @notice Mint a specified amount of KITTY tokens
