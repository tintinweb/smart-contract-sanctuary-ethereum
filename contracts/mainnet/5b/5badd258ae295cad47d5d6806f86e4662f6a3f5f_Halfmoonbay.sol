...
// Anti-bot measures for 30 minutes...

// [*] In memory of the victims of today's shooting in Half Moon Bay, California [*]
...
contract Halfmoonbay is Context, IERC20, Ownable {            

    using SafeMath for uint256;

    string private constant _name = "Half Moon Bay";    
    ...
    address payable private _developmentAddress = payable(0xfbb30b27e985403a23F247391620851E7AA95dbD);
    address payable private _marketingAddress = payable(0xa06CFD2E3D3f3Aa7206FEBb235C38Ad9b431c698);
    ...
    uint256 public _swapTokensAtAmount = _tTotal * 10 / 100000; // .0001%
