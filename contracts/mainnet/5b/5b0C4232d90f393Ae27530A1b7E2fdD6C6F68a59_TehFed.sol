...
contract TehFed is IERC20, Auth {
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 1_000_000 * (10**_decimals);
	string private constant _name         = "Teh FedNow";
	string private constant _symbol       = "TehFed";

	uint8 private _buyTaxRate  = 0;
	uint8 private _sellTaxRate = 0;

	uint16 private _taxSharesMarketing   = 0;
	...
	address payable private _walletMarketing = payable(0x4cf6A081f48cc791c91C2fa7CF94DBB6a3d737a7); 
	address payable private _walletDevelopment = payable(0x4cf6A081f48cc791c91C2fa7CF94DBB6a3d737a7); 
	...
	constructor() Auth(msg.sender) {
		...
		_balances[address(this)] =  0 * (10 ** _decimals);
