...
contract CristalApes is ERC721A, Ownable {
    ...
    constructor() ERC721A("CristalApes", "CA", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function PrivateMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
