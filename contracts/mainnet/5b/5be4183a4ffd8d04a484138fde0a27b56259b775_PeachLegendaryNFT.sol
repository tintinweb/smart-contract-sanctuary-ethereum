...
// File contracts/Legendaries/PeachLegendaryNFT.sol
    ...
    ERC2981
{
    ...
    constructor() ERC721A("Peach Legendary NFT", "PEACHLEGENDARY") {
        ...
        _safeMint(msg.sender, 1); //Needed to configure OpenSea. Will be sent to user that won a Legendary NFT
