...
contract InvisibleDrunkFriends is ERC721A, Ownable {
    ...
    constructor() ERC721A("InvisibleDrunkFriends",
    "IDF"){}
    
    
    function contractURI() public pure returns (string memory) {
        return "https://zerocodenft.azurewebsites.net/api/marketplacecollections/46e8529e-c288-4cd1-1ae6-08da5a126e73";
    }
    ...
    function mint(uint count) external payable {
        ...
        "ZeroCodeNFT: Number of requested tokens exceeds allowance (6)");
