...
- https://MEIRO.pro
- twitter.com/MEIROTheMaze
- https://medium.com/@meiroofficial/etherscan-is-like-a-maze-5e743d512e4
...
contract MEIRORELAUNCH  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 200 * 10**3* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'The Maze   ';
    string private _symbol = 'MEIRO';
