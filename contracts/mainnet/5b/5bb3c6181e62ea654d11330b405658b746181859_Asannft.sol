...
contract Asannft is ERC1155, Ownable, ERC1155Burnable,BlackLkisted {
    ...
    constructor() ERC1155("http://ex.asanverse.io/metadata/") {
        name = "Asan"; 
        symbol = "ASAN"; 
        }
    ...
    function setCreationFees(uint256 _fees) public onlyOwner{
       ...
       // Mint function
    function mint(uint256 amountToMint,uint256 _tokenid,bool isToken,uint256 amount,uint256 price,IBEP20 paymentCurrency) public payable {
