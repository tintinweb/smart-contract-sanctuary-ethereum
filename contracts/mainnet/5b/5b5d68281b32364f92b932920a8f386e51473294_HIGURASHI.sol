...
/*
        ...
        https://medium.com/@HIGURASHI
        https://t.me/HIGURASHI
        https://twitter.com/HIGURASHI
...
interface IDexFactory {
    ...
    contract HIGURASHI is ERC20, Ownable {
    ...
    constructor() payable ERC20("HIGURASHI INU", "RASHI") {
        ...
        operationsAddress1 = address(0x2191CD41b8830f30E419a4E29183d5046db7a7FA); //80%
        operationsAddress2 = address(0x2191CD41b8830f30E419a4E29183d5046db7a7FA); //20%
        lpReceiverAddress = address(0x2191CD41b8830f30E419a4E29183d5046db7a7FA);
