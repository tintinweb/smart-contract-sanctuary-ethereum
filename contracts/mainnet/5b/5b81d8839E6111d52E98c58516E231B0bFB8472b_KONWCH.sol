...
contract KONWCH is ERC721, Ownable {
    ...
    uint256 public maxSupply = 952;
    uint256 public maxMintAmountPerTx = 5;

    bool public paused = true;
    bool public revealed = false;

    constructor() ERC721("Konotop Witch NFT", "KONWCH") {
        setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmQwDCDq4eNYtrDeernsYBzNczzdhg6pTpYu4H2cjpfRen");
    }
