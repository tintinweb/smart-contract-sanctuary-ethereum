...
contract ShibRacers is ERC20, Ownable {
    ...
    constructor() ERC20("ShibRacers", "SHIBRA") {
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buydevfee + buyLiquidityFee;
        require(buyTotalFees <= 35, "Must keep fees at 10% or less");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = selldevfee + sellLiquidityFee;
        require(sellTotalFees <= 35, "Must keep fees at 10% or less");
    }
