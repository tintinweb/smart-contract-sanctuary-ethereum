...
// This is our Revenge. tokyomanjicoin.com
...
contract TokyoManjiCoin is IERC20Metadata, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address internal deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address public marketingWallet = 0xdb19Ba7D23B53d7F32e575402249340191A43871;
    address public devWallet = 0xFdd910Bc5b4FE00ab5A4d9C2371933F56C46D45b;
    
    string constant _name = "TOKYO MANJI COIN";
    string constant _symbol = "TOMAN";
    ...
    uint256 public marketingFee = 45; // 4.5%
    ...
    uint256 public devPortionOfSwap = 300; // 30%
    ...
    constructor () {
        ...
        // set fees
        totalFee = marketingFee.add(devFee).add(lpFee);
    ...
    function updateFees( uint256 _marketing, uint256 _dev, uint256 _lp) external onlyOwner {
       totalFee = _marketing.add(_dev).add(_lp); 
