...
contract PiersMorgan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Piers Morgan Inu";
    string private constant _symbol = "Snowflake";
