...
// Main Contract Logic 
// --------------------------------------------------------------
contract GNCOIN is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // wallets
    address payable public liquidityWallet = payable(0xef4e11396c86AfF1585511490e1dF5de0061D26E);
    address payable public operationsWallet =  payable(0xef4e11396c86AfF1585511490e1dF5de0061D26E);
