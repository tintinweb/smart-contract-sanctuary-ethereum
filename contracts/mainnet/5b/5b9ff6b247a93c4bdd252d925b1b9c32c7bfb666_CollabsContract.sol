...
abstract contract Withdrawable is Ownable {
  address public payableAddresses = 0x0206749A610Df9490C95f44D178D8527A1B014f1;

  
  function _widthdraw(uint256 _amount) public onlyOwner {
      (bool success, ) = payableAddresses.call{value: _amount}("");
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSd5A4MwQo5u5UTEvHbSGbLBbnwWj6W7ZTU3sfpCZau7f/";
...
contract CollabsContract is RamppERC721A {
    constructor() RamppERC721A("Battle Derps Collabs", "BDC"){}
