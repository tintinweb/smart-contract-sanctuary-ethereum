...
contract Protocol is ERC20, Ownable {
    ...
    constructor() ERC20("777", "777") {
     ...
     uint256 totalSupply = 7 * 10 ** 5 * 10 ** decimals();
 
        maxTransactionAmount = 14 * 10 ** 3 * 10 ** decimals(); 
        maxWallet = 14 * 10 ** 3 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xC66A1E18ef5201f970f83F4D0fF2FB623603221b); // set as Marketing wallet
        DevWallet = address(0xC66A1E18ef5201f970f83F4D0fF2FB623603221b); // set as dev wallet
