...
Ordinal Floki $oFloki

https://t.me/OrdinalFlokiErc
...
contract oFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ordinal Floki";
    string private constant _symbol = unicode"oFloki";
