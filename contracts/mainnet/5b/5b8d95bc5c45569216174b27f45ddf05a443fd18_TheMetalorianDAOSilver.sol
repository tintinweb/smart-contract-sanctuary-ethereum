...
// File: theMetalorianDAOSilver.sol
...
///@title TheMetalorianDAOSilver
///@notice Token ERC721 for the Metalorian DAO
contract TheMetalorianDAOSilver is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 2000;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 2000;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian DAO Silver", "TMDS") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeiavsikagiajpue2tq4ckzwmeqzjbdlzj4bbkd5jscmqjc7jylrqbi/SilverMetadata/";   
        mintCost = 1 ether;
    }
    ...
    function mintTheMetalorianDAOSilver(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDAOSilver(msg.sender, tokenIdCounter.current());            
