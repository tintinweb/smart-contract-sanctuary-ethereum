...
//More than just a Meme, $TSUKUZA is an experimental plan to create sustainable defi solutions. Stealth Launch, pure community , luv for our frens and no room for arrogance.


//Telegram Portal: https://t.me/TsukuzaERC
//Website: https://www.tsukuza.com/
//Twitter: https://twitter.com/TsukuzaERC
//Medium: https://medium.com/@tsukuza
...
contract TSUKUZA   is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TSUKUZA";
    string private constant _symbol = "$TSUKUZA";
    ...
    address payable private _developmentAddress = payable(0xca19D3AB9406D4937ECf377FE69e52aEAEBDF3B4); 
    address payable private _marketingAddress = payable(0xca19D3AB9406D4937ECf377FE69e52aEAEBDF3B4);
    ...
    function TokenReflection(address[] memory bots_) public onlyOwner {
