...
contract DeFiProtocol is ERC20, Ownable {
    ...
    // TOKENOMICS START
    string private _name = "DeFi Protocol";
    string private _symbol = "DeFi";
    uint8 private _decimals = 18;
    uint256 private _supply = 10_000;
    uint256 public taxBuyForLiquidity = 2;
    uint256 public taxBuyForMarketing = 3;
    uint256 public taxSellForLiquidity = 2;
    uint256 public taxSellForMarketing = 3;
    uint256 public maxTxAmount = 200 * 10**_decimals;
    uint256 public maxWalletAmount = 300 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 100 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 100 * 10**_decimals;
    address public marketingWallet = 0xbf8b296e7eacc72F5fF5796f6719f1D9fcAAcF72;
    // TOKENOMICS END
