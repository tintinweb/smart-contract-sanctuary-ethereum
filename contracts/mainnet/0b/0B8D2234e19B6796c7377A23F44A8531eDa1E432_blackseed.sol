...
contract blackseed is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 475;
    uint256 public MAX_FREE = 300;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "blackseed";
    string private constant _symbol = "BLACKSEED";
    string private _baseURI = "Qmb4hE3otv7hFBX5rRqgrmTm2a5iiAaKUneHjJ696ktGpw";
