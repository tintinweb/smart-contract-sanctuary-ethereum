...
contract iNFTExchange is Exchange {

    string public constant name = "Project iNFT Exchange";

    string public constant version = "2.2.5";

    string public constant codename = "Zhq";

    /**
     * @dev Initialize a iNFTExchange instance
