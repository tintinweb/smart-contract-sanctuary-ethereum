...
+44 OFF SEASON DROP
NFT + Real World product shipping

QUALITY RACING FASHION 
in both META <> WORLD

Feel its idle hum

META>  https://t.me/plus44meta
WORLD> https://plus44.world/
INSTA> https://www.instagram.com/plus44world/

📌ERC20 network tokens
symbol [ PLUS44 ]
transaction fee [  5% ]
token supply [  44,000,000  ]

📌Stay tuned for Plus 44 NFT announcement
*/
...
contract PLUS44 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Plus44";
    string private constant _symbol = unicode"PLUS44";
