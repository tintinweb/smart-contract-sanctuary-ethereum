...
contract BBC is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 0.075 ether; //0.075 during sale 

  uint256 private constant TotalCollectionSize_ = 5000; // total number of nfts
  ...
  constructor() ERC721A("BBC","BBC", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmfTyipnj7u9MTp8Jjeyrha1hTjcBQqz4tJFmSxveCkX1e/";
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmS81Ff39MQ8QFgACJUd2zXgyBfwkr62XvfbP9QaWAcF68/";
  }
  ...
  function mint(uint256 quantity) external payable callerIsUser {
    ...
    require(quantity <= MAX_PER_Transtion,"Max can mint 15 per transaction");
