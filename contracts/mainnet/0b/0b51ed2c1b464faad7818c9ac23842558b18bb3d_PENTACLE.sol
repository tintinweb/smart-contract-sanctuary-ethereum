...
contract PENTACLE is ERC20, Ownable {
    ...
    constructor() ERC20("Pentacle", unicode"🐐") {
        ...
        maxTransactionAmount = 1 * 1e8 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 1 * 1e8 * 1e18; // 2% from total supply maxWallet
        ...
        devWallet = address(0x25f6E30f0e8f34166809ABB90767e5291439a83E); // set as dev wallet
