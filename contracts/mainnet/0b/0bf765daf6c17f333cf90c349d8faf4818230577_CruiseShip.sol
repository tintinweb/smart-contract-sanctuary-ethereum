...
contract CruiseShip is ERC20, Ownable {
    ...
    constructor() ERC20("CruiseShip", "CRSP") {
        ...
        marketingWallet = address(0x3a64758A5a179d420f062126537319c51F50A6CF);
    ...
    function setIsExcludeFromLimit(address updAds, bool isEx)
    public
    onlyOwner
    {
