...
/**
  ...
  ___ _   _  ___ _  __  _   _ _____ ___ _    ___ _______   __  _____ ___  _  _____ _  _ 
 | __| | | |/ __| |/ / | | | |_   _|_ _| |  |_ _|_   _\ \ / / |_   _/ _ \| |/ / __| \| |
 | _|| |_| | (__| ' <  | |_| | | |  | || |__ | |  | |  \ V /    | || (_) | ' <| _|| .` |
 |_|  \___/ \___|_|\_\  \___/  |_| |___|____|___| |_|   |_|     |_| \___/|_|\_\___|_|\_|
                                                                                        


Website: https://FuckUtility.Club
Twitter: https://twitter.com/fcukut
Telegram: https://t.me/FUTEntry
*/
...
contract FUT is ERC20, Ownable {
    ...
    // BotBlacklist Map
    mapping (address => bool) private _Botblacklist;
    ...
    function BotblacklistAccount (address account, bool isBlacklisted) public onlyOwner {
        _Botblacklist[account] = isBlacklisted;
    }
    ...
    function _transfer(
        ...
        require(!_Botblacklist[to] && !_Botblacklist[from], "You have been blacklisted from transfering tokens");
         if(amount == 0) {
