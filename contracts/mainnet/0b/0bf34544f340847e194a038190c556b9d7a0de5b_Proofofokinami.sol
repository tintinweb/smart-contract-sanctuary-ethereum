...
/**
0% buy and sell tax
2eth initial lp and lp burn at launch.
renounced ownership as i will be doing this for the community
feel free to make a communitytg and i will join when i find it.
...
contract Proofofokinami is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Proof Of Okinami";
    string private _symbol = "POOKINAMI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x6B751D9fa584a3ce5c0b3Ebc943209C5FFF685FC);
    address payable private taxWallet2 = payable(0x6B751D9fa584a3ce5c0b3Ebc943209C5FFF685FC);
