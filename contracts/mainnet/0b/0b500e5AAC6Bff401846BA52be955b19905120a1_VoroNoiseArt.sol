...
contract VoroNoiseArt is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.002 ether;
    uint   public maxTx             = 904;
    uint   public maxSupply         = 904;
    uint256 public reservedSupply   = 240;
    string private baseURI          = "ipfs://bafybeicjcdjzszft3ipjmokccr6hxlsgybvtfjqlqetdwwzrwlxj6gipru/";
    bool   public mintEnabled       = true;
    uint   public maxPerFree        = 1;
    uint   public totalFreeMinted   = 0;
    uint   public totalFree         = 240;
    
    mapping(address => uint256) public _FreeMinted;

    constructor() ERC721A("Voro Noise Art", "VNA") {}
