...
contract Morocco is ERC20, Ownable {
    ...
    constructor() ERC20("Morocco Inu", "MINU") {
		...
		charityWallet = address(0x0515d8FC80d841fDd956EB3eeDdfE286Bfa08D84); 
        marketingWallet = address(0x0515d8FC80d841fDd956EB3eeDdfE286Bfa08D84); // set as marketing wallet
        devWallet = address(0x0515d8FC80d841fDd956EB3eeDdfE286Bfa08D84); // set as dev wallet
