...
Introducing InuPad the #Shibarium Launchpad ecosystem
Launching on Etherem and Utilities on Shibarium under developmet
Utilities to be revealed in medium coming soon along with socials.
...
contract INUPAD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"INUPAD";
    string private constant _symbol = unicode"INUPAD";
