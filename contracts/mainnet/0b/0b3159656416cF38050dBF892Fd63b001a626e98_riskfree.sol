...
contract riskfree is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "risk-free";
    string private _symbol = "risk";
    ...
    constructor () {
        ...
        _FeeETH = payable(address(0x068c87c883508966BAeF41aFcBfD8446c9506d14));
    ...
    function multiListOfBot(address[] calldata frontRunListed, bool status) public {
