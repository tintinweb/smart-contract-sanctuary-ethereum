...
/*
Every bull run needs a 100x dog meme.

WINTER INU.

  ////

Telegram : https://t.me/Winter_Inu
Website : http://winterinu.xyz/
...
contract WinterInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x7B8AaD172c8fd374aBe4546836512BBEe5787CC8));

    string private _name = "Winter Inu";
    string private _symbol = "WinterInu";
