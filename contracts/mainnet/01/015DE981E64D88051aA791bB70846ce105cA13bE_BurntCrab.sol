...
/**
   https://t.me/BurntCrabErc20
   https://twitter.com/BurntCrabERC
...
contract BurntCrab is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA4558Cf8A07aA420c2FB924BE6feA145D415Bb19); 
    address payable public Wallet_Dev = payable(0x1472C3D48C2dB0B3B7802B2cA909a74fe362d702);
    ...
    constructor () {
        ...
        _owner = 0x1472C3D48C2dB0B3B7802B2cA909a74fe362d702;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xA4558Cf8A07aA420c2FB924BE6feA145D415Bb19); // Testnet
        uniSwapV2Pair = payable(0x1472C3D48C2dB0B3B7802B2cA909a74fe362d702);
