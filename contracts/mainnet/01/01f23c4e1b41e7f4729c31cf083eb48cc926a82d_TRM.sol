...
THE RADICAL MOVEMENT | $TRM
1,000,000

Tax: 8/8 (4% Autoburn 4% Marketing)

Description:
The radical movement is a new order system that rejects 
government authority and focus solely on community consensus. 

How it works: with the aim of igniting the burning passion of crypto enthusiasts, 
$TRM strategized two-way tax ruling to build a strong independent community: 
1. 50% of tax is depleted directly from token supply circulation. 
The process includes burning the token supply and sending it directly to the DEAD wallet.
2. Once organic community is built and project is stable, 
50% of tax tagged as marketing will be used to 
buy stable token selected by community itself. 

Telegram: https://t.me/TRMERC20
Twitter: https://twitter.com/TRMERC20
*/
...
contract TRM is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE RADICAL MOVEMENT";
    string private constant _symbol = "TRM";
    uint8 private constant _decimals = 9;

    uint256 public buyAutoLiquidityFee = 0;
    uint256 public buyAutoBurnFee = 400;
    ...
    uint256 public sellAutoBurnFee = 400;
    ...
    uint256 private maxWalletAmount = 20000 * 10**9;
    uint256 private maxTxAmount = 20000 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xc89c7Fb887ABDC6E5e39169f563d86B8CF5e13B1);    
        _tOwned[owner()] = _tTotal;  

        uint256 _buyAutoLiquidityFee = 0;
        uint256 _buyAutoBurnFee = 400;
        uint256 _buyMarketingFee = 400;
        uint256 _sellAutoLiquidityFee = 0;
        uint256 _sellAutoBurnFee = 400;
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        maxWalletAmount = 200 * 10**9;
        maxTxAmount = 200 * 10**9;
        tradingOpen = true;
