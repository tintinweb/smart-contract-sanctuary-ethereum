...
contract ChowChowF is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ChowChow", "Chow") {
        ...
        maxTransactionAmount = totalSupply * 25 / 1000; // 3% maxTransactionAmountTxn
        maxWallet = totalSupply * 25 / 1000; // 3% maxWallet
