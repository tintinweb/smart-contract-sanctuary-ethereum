...
// `7MMM.     ,MMF'                                   `7MM          db  
//   MMMb    dPMM                                       MM              
//   M YM   ,M MM `7MM  `7MM  `7Mb,od8 ,6"Yb.  ,pP"Ybd  MMpMMMb.  `7MM  
//   M  Mb  M' MM   MM    MM    MM' "'8)   MM  8I   `"  MM    MM    MM  
//   M  YM.P'  MM   MM    MM    MM     ,pm9MM  `YMMMa.  MM    MM    MM  
//   M  `YM'   MM   MM    MM    MM    8M   MM  L.   I8  MM    MM    MM  
// .JML. `'  .JMML. `Mbod"YML..JMML.  `Moo9^Yo.M9mmmP'.JMML  JMML..JMML.
...
contract murashi is ERC721A, TheOperatorFilterer {

    address public owner;

    uint256 public maxSupply = 870;
    ...
    constructor() ERC721A("Murashi by Musa", "Murashi") {
        owner = msg.sender;
        maxPerTx = 20;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmWFJqrV4LwvWHHS1AUF5e5qW37yT1TUfZ7Ty2eALoK39n/", _toString(tokenId), ".json"));
    }
