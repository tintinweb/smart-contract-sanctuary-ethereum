...
// File: contracts/PandaSaviorsClub.sol
...
contract PandaSaviorsClub is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public nftWlPerAddressLimit = 5;
    ...
    function mint(uint256 quantity) public payable {
        ...
        if(onlyWhitelisted == true) {
            ...
            require(whitelistTotalMintSupply + quantity <= whiteListMaxSupply, "Max NFT limit exceeded for whitelist");
            uint256 ownerMintedCount = addressMintedBalance[msg.sender];
            require(ownerMintedCount + quantity <= nftWlPerAddressLimit, "Max NFT per address exceeded");
    ...
    function setPreSalePriceCost(uint256 _newCost) public onlyOwner {
    ...
    function setOnlyWhitelisted(bool _state) public onlyOwner nonReentrant {
