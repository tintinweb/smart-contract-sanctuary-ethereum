...
WeChat:  https://web.wechat.com/DarkOracleCN
*/

contract ETH is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x438efF4210a7b55CEcc7e5a8D86F6BcF9553760d); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x438efF4210a7b55CEcc7e5a8D86F6BcF9553760d);
    ...
    string private constant _name = "Dark Oracle"; 
    string private constant _symbol = unicode"ORACLE";
    ...
    constructor () {
        ...
        _owner = 0x438efF4210a7b55CEcc7e5a8D86F6BcF9553760d;
