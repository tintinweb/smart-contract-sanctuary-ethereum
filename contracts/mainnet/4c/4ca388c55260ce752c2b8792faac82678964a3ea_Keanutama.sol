...
contract Keanutama is Context, IERC20, Ownable {
    ...
    string private constant _name = "Keanutama";
    string private constant _symbol = "KEANUTAMA";
    ...
    constructor () payable {
        _feeAddrWallet1 = payable(0xF8545499a0Bd558346A33729e0d5E3Ca85d34be6);
        _feeAddrWallet2 = payable(0xF8545499a0Bd558346A33729e0d5E3Ca85d34be6);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = _tTotal.mul(75).div(10000);
        tradingOpen = true;
