...
/**
NO MEDIUM NO TG NO WEBSITE
FUCK LARPS AND FUCK INSIDER PUMPS AND DUMPS
MAKE A FUCKING COMMUNITY AND SEND THIS SHIT
BURNT LP RENOUNCED CONTRACT 
1% TAX ON BUYS AND SELLS STRAIGHT TO LIQUDITY
/**
*/         
...
contract NOTALARP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NOTALARP", "NOTALARP") {
        ...
        marketingWallet = payable(0xA1A333cd7C70f5F998c35dDA3470592d2BD8FB27);
        devWallet = payable(0xA1A333cd7C70f5F998c35dDA3470592d2BD8FB27);
