...
Once upon a time, a boy was walking in a big forest when he found a large blackboard hanging from an old tree branch. 
It came with a box of chalk chunks, and bright sparks flew from the end of each chalk chunk. 
The boy took a piece of chalk and began to draw on the board: 
first a tree, then a rabbit, then a flower… 
Like magic, each time he completed a drawing, it came to life and jumped off the board. 
The boy thought to himself “Sweet ! I can just draw a pile of money, and then I can buy all I want”. 
As soon as he finished his drawing, a dark angry face came out of the board: “Careful what you wish for kiddo”.



Medium : https://medium.com/@yorierc20
...
contract YORITOKEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x17A28dEB25ED44583C2C7321A4f6dc6c8D8297EC); 
    address payable public Wallet_Dev = payable(0xCC03bFD087e58a4185CfBf492147e7a7d9976c84);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 888888888 * 10**_decimals;
    string private constant _name = "Yori Token"; 
    string private constant _symbol = unicode"Yori"; 
    ...
    constructor () {
        ...
        _owner = 0xCC03bFD087e58a4185CfBf492147e7a7d9976c84;
