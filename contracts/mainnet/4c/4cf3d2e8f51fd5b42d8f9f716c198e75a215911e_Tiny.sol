...
contract Tiny is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZe7s7qwxgWTXTmLBh3jtQo3wnXL57cifdRrGbn8PxTnS";
    ...
    constructor(
    ) ERC721A("Tiny Deer", "TINYDEER", 100, maxSupply) {
    }
