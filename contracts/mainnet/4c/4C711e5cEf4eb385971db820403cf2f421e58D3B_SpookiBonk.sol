...
// https://t.me/SpookiBonk
// Low tax 5/5, MaxTx - 3%, CA will be renounced and 100% LP Burned. Medium, website and socials will be updated,
...
contract  SpookiBonk  is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 300 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7 * 10**9; //
    string private constant _name = "SpookiBonk"; // 
    string private constant _symbol = unicode"$SBONK"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x79b74BC3b48a3dDC7084F48ca8753349c32ef68A;
