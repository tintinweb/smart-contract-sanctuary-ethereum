...
// / .'`\ \[ `/'`\]| '' <  ( (`\] | | / .'`\ \[ \ [ \ [  ][ `.-. |  [ \ [ \ [  ]| | '-| |-'  
// | \__. | | |    | |`\ \  `'.'. | |,| \__. | \ \/\ \/ /  | | | |  _\ \/\ \/ / | |,  | |    
//  '.__.' [___]  [__|  \_][\__) )\__/ '.__.'   \__/\__/  [___||__](_)\__/\__/  \__/ [___]   
//                                                                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x15eC76ad09D49F75e0bF516B4C5b9B61EBab71e2,0xDcd0a9DdaC5f92b6F0bbDe57a4348dceACa876d8];
  uint256[] public payableFees = [5,60,35];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZ8Rx3kAxhPBEFWKx548Z7XCpPRAWKfnDG7SWWTiFxSUV/";
...
// File: contracts/OrkstownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OrkstownwtfContract is RamppERC721A {
    constructor() RamppERC721A("orkstownwtf", "orkstwnwtf"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/MoklWqyvKCS6rjyekvlw/contract-metadata";
    }
}
