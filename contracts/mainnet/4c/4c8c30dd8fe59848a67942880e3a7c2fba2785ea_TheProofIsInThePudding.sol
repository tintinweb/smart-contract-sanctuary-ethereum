...
/**
 * https://twitter.com/InThe_Pudding
*/

/**
 * https://t.me/TheProofIsInThe_Pudding
*/

/**
 * https://theproofisinthepudding.io/
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract TheProofIsInThePudding is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "The Proof Is In The Pudding";
    string private _symbol = "PUDDING";
    uint8 private _decimals = 18;
    uint256 private _supply = 1000000000;

    uint256 public buyTaxForLiquidity = 1;
    uint256 public buyTaxForMarketing = 6;
    uint256 public buyTaxForBurning = 1;
    uint256 public sellTaxForLiquidity = 1;
    uint256 public sellTaxForMarketing = 6;
    uint256 public sellTaxForBurning = 1;

    address public marketingWallet = 0xf2d4964a10B598C7b84C3F8c9d492D51F08Fed52;

    uint256 public maxTxAmount = 30000000 * 10**_decimals;
    uint256 public maxWalletAmount = 30000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 10000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 6500000 * 10**_decimals;
    // TOKENOMICS END ============================================================>
