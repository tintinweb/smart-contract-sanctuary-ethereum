...
contract Numericon is ERC721A, Ownable {
    ...
    uint256 public max_per_wallet = 1001;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("Numericon", "Numericon") {
