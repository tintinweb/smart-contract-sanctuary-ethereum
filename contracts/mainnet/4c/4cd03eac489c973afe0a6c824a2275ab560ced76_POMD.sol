...
// Website: https://www.pomd.io/
// Telegram: https://t.me/pomeranian_pomd
...
contract POMD is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
	address private _owner_address = 0xf99613B4AE868b1aB1219Ba4FAf933DA928EA8ec;
    ...
    constructor() ERC20("Pomeranian", "POMD") {
        ...
        marketingWallet = 0xf99613B4AE868b1aB1219Ba4FAf933DA928EA8ec; // set as marketing wallet
        devWallet = 0xf99613B4AE868b1aB1219Ba4FAf933DA928EA8ec; // set as dev wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(_owner_address, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
 
        excludeFromMaxTransaction(_owner_address, true);
        ...
        */
        _mint(0xa4c37D24cDC8b047dE9E1aAD30CdbBB37ad76c78, totalSupply);
