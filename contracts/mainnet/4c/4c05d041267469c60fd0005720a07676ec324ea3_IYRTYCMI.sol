...
// (っ◔◡◔)っ ♥ IYRTYCMI ♥
// Telegram Channel: https://t.me/IYRTYCMI (Get the updates from the telegram channel)
...
contract IYRTYCMI is Context, IERC20, Ownable {
    ...
    string private constant _name = "If You're Reading This You Can Make It";
    string private constant _symbol = "IYRTYCMI";
