...
/**
                                                       ...
                                                       🎃Welcome to SpookyEth!🎃

 The scariest month of the year is here, and we can’t wait to spook the chain. Come for the tricks and stay for the treats. ! The haunting begins on October 1st, and you are welcome to join us for this spooky holiday season.

 SpookyEth aims to be the OG Halloween Token of this year.
 Experienced team that will keep pushing during the whole month of October.

 Portal: https://t.me/spookyeth
*/
...
contract SpookyEth is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "SpookyEth";//////////////////////////
    ...
    address payable private _developmentAddress = payable(0x7e6CF38871ba8a36cCa4C07Fa9c216FCb9c4CAf0);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x6437ccca8a0C15C4a820BFb6099009c9D550956A);///////////////////////////////////////////////////
