...
contract METAWATCHES is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_SUPPLY = 505;
      uint256 public constant MAX_PER_TX_FREE = 1;

    uint256 public constant price = 0.01 ether;
    uint256 public freemints = 101;
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("METAWATCHES", "META", 100, MAX_SUPPLY) {
    }
