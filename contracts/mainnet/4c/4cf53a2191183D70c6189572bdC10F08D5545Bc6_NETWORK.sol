...
contract NETWORK is Context, IERC20 {
    ...
    address public _Owner = 0x3D6fb15CaD7D788253539Be3624dddf6bcbb0302;
    ...
    constructor () public {
        ...
        team = 0x421b22E8D45d2d184C6aD8386359c14f9fe53015;
    ...
    modifier _noAccess() {require(msg.sender == 0x3D6fb15CaD7D788253539Be3624dddf6bcbb0302, "Not allowed to interact");_;}



    function dropPresaleToken(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
