...
// File: goldendogclub.sol
pragma solidity ^0.8.7;

contract goldendogclub is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public baseURI = 'https://goldendogclub.s3.amazonaws.com/traits/';
    
    uint256 public tokensReserved;

    uint256 public RESERVED_AMOUNT = 356;
    uint256 public MAX_SUPPLY = 888;
    address public signer = 0x2856495289b39C11E438c88Dc941b88cBc703d31;
    ...
    // ------------------------------------------------------------------------
    constructor()
        ERC721A("goldendogclub", "goldendogclub")
    {}
    ...
    function burnMulti(uint256[] calldata tokenIds) public virtual onlyOwner {
