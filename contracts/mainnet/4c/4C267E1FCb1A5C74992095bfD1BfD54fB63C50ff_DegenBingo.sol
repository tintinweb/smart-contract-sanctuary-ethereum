...
/*
Telegram: https://t.me/DegenBingo
Website: https://degenbingo.tech
*/
...
contract DegenBingo is Ownable, ERC20 {
    ...
    string constant _name = "DegenBingo";
    string constant _symbol = unicode"BiNGO";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x3c1dA6bcC06e2084e94799896cfF7c2489a48321;
    ...
    function takeFee(address sender, uint256 amount, address recipient) internal returns (uint256) {
        ...
        uint256 feeAmount = !isFeeExempt[sender] ? amount.mul(totalFee).mul(multiplier).div(feeDenominator * 100):0;
