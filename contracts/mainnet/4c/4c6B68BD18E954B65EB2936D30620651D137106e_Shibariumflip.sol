...
/**
    ...
    https://t.me/ShibariumCoinFlip/

    https://twitter.com/ShibariumFlip/

    https://shibarium-flip-coin.gitbook.io/

    https://ShibariumFlip.com/
...
contract Shibariumflip  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibarium Coin Flip ",unicode"$FLIP") {
