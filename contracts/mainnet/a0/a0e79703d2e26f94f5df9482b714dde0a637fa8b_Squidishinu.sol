...
contract Squidishinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squidishinu";
    string private constant _symbol = "SQUIDISH";
