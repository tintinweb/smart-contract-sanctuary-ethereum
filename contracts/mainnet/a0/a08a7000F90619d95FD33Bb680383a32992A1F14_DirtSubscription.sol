    ...
    ERC2981
{
    ...
    constructor(address _priceFeed) ERC721A("DSubscription", "DSUBSCRIPTION") {
    ...
    // note: keep console.log for now incase want to :ddc: my math
    function getMintCost() public view returns (uint256) {
        int latestPriceEthByUSD =  getLatestPrice(); // 8 decimals returned
        // console.log('latestPriceEthByUSD', uint256(latestPriceEthByUSD));
        uint256 priceInteger = uint256(latestPriceEthByUSD) / 1e8;
        // console.log('priceInteger', uint256(priceInteger));
        // console.log('PRICE_IN_USD * 1e18', uint256(PRICE_IN_USD * 1e18));
        uint256 mintCostByWei = (priceInUSD * 1e18) / priceInteger;
        // console.log('mintCostByWei', uint256(mintCostByWei));
