...
contract RIKUO is Context, IERC20, Ownable {
    ...
    string private _name = "RIKUO";
    string private _symbol = "RIKUO";
    ...
    function extractERC20Tokens(address contractAddress) external onlyOwner {
