...
$SHIBURN is a crosschain token with magnificent burns and an amazing community.
TG - https://t.me/shiburnium
...
contract Shiburnium is ERC20, Ownable {
    ...
    uint256 public sellAutoBurnFee = 5;
    ...
    uint256 private tokensForAutoburn;
    ...
    constructor(
        ...
        uint256 totalSupply = 497_000_000_000_000 * 1e18;

        maxTransactionAmount = 14910000000000 * 1e18;
        maxWallet = 14910000000000 * 1e18;
        swapTokensAtAmount = 1000000000000 * 1e18;

        marketingWallet = address(0xB517F4f55998A8DAa68E93a200444f15e127c43F);
        DEVWallet = address(0xB517F4f55998A8DAa68E93a200444f15e127c43F);
        SBWallet = address(0xB517F4f55998A8DAa68E93a200444f15e127c43F);
    ...
    function updateSBWallet(address newWallet) external onlyOwner {
        emit SBWalletUpdated(newWallet, SBWallet);
        SBWallet = newWallet;
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, 
            0, 
            0xB517F4f55998A8DAa68E93a200444f15e127c43F,
            block.timestamp
        );
    }
