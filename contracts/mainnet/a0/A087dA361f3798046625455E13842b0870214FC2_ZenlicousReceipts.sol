...
contract ZenlicousReceipts is ERC721A, Ownable, ReentrancyGuard {
    ...
    // ------------------------------------------------------------------------
    constructor()
        ERC721A("ZenlicousReceipts", "ZenlicousReceipts")
    {}
    ...
    function setReservedAmount(uint256 newValue) external onlyOwner {
        RESERVED_AMOUNT = newValue;
    }
