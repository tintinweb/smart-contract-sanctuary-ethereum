...
contract ALBUD is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public MAX_NFT = 3340;
	uint256 public GIVEAWAY_NFT = 50;
	uint256 public SALE_NFT = MAX_NFT - GIVEAWAY_NFT;
    ...
    constructor() ERC721P('Alien Buddies', 'ALBUD') {}
	...
	function updateMaxSupply(uint256 newSupply) external onlyOwner {
	    require(newSupply >= GIVEAWAY_NFT + SALE_MINTED, "Incorrect value");
        MAX_NFT = newSupply;
    }
