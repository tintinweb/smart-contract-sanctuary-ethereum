...
Today is Thanksgiving, now Thanksgiving INU comes to the encrypted universe of ETH, it will protect us from being deceived by RUG, and return us a safe encrypted universe

https://t.me/ThanksgivingINU_ERC
*/
...
contract ThanksgivingINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Thanksgiving INU";
    string private constant _symbol = unicode"THANKSINU";
