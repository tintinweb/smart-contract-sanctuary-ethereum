...
/**
            The vision of Shichiro Inu is to be the go-to platform for NFT creation and trading,
         accessible to everyone within the Shibarium network. The platform aims to make NFTs more 
         accessible and user-friendly, while leveraging the security, scalability, and accessibility 
         of the Shibarium network. Shichiro Inu’s vision is to create a thriving community of NFT 
         enthusiasts and experts who work together to drive innovation and growth within the NFT space. 
         The platform strives to be fair, transparent, and always evolving to meet the needs of its users, 
         with a community-driven governance model that puts users in control. Ultimately, the vision of 
         Shichiro Inu is to become a leader in the NFT space, unlocking the full potential of NFTs as a 
         new asset class and bringing NFTs to the masses.

         WEBSITE: https://www.shichiro-inu.com/

         MEDIUM: https://shichiro-inu.medium.com/shichiro-inu-52d555f327ea

         TWITTER: https://twitter.com/SHICHIROINU

         TELEGRAM: https://t.me/shichiroinuerc
...
contract ShichiroInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shichiro Inu", "SHICHIRO") {
