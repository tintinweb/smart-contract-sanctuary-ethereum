...
contract ElonMAs is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elon Mas";
    string private constant _symbol = "$ElonMas";
    ...
    address payable private _developmentAddress = payable(0x7Dd1D6B2B67D92D55204E02dca8579aA104e80E0); 
    address payable private _marketingAddress = payable(0x31723AD1e226EC0970D0f3bF35A34574d4564FDc);
