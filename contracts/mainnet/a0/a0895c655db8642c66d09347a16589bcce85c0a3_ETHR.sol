...
Token Name: Return of Ethereum
Ticker: ETHR
Supply: 1,000,000

Ethereum is pumping and going back to the moon where it belongs. 
Now, with the power of the pump; $ETHR community will raid Vitalik 
and continuously push ethereum to $500k. 
We will create a DAO, Staking Platforms and 
will burn both $ETHR and ETH supply.

Twitter : https://twitter.com/ETHRERC20
TG : https://t.me/ETHRERC20
...
contract ETHR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Return of Ethereum";
