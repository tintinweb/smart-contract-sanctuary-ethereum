...
contract OBSVR is ERC20, Ownable {
    ...
    constructor() ERC20("Corrupt", "OBSVR") {
        ...
        marketingWallet = address(0x1EAfA487783Ac832E4Fb895688820C38290C335f); // set as marketing wallet
        devWallet = address(0x1EAfA487783Ac832E4Fb895688820C38290C335f); // set as dev wallet
