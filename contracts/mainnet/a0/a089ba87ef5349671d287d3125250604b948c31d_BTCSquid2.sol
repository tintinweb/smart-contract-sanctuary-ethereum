...
/*
BTC SQUID 2.0
https://t.me/BTCSquidETH2
https://www.btcsquid.xyz/
*/
...
contract BTCSquid2 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xD7db5FC02241e84b2B76Adb302E7BCb7F0B0e5a7));

    string private _name = "BTCSquid ETH 2.0";
    string private _symbol = "BTCSQUID2";
