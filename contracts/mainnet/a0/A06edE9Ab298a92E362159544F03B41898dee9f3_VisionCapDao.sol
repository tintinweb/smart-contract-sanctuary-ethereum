...
contract VisionCapDao is ERC20, Ownable {
    ...
    constructor() ERC20("VisionCap Dao", "VCD") {
        ...
        maxWallet = totalSupply * 2 / 100; // 1.5% 
        ...
        marketingWallet = address(0x2c403077C7fa62c78a4C2DEc24E164543896cd8E); // set as marketing wallet
        devWallet = address(0x2c403077C7fa62c78a4C2DEc24E164543896cd8E); // set as dev wallet
