...
contract RAYA_Salomon_X_VanMrthn23 is ERC1155, Ownable, Pausable, ReentrancyGuard {
  /*
   * Public Variables
   */

  // Token name
  string public name = "Run As You Are - Salomon X Van Marathon 2023";
  ...
  constructor() ERC1155("") {
    totalSupplyMinted = 0;
    tokenURI = "ipfs://bafybeibsdjco322k46usn35xnd7qhb4pqacbcfcur4tn4dp6hwgphpfx2q/";
  }
  ...
  /// @param _tokenId RAYA x Salomon X Van Marathon 2023 token Id to view
