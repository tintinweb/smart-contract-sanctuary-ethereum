...
import "./GremGoylesCastle2NFT.sol";
import "hardhat/console.sol";

contract Castle2Sale is ReentrancyGuard, Ownable {
        ...
        roundAvailable(_roundId)
    {
        ...
        GremGoylesCastle2NFT(nftContract).mint(msg.sender,_mintAmount);
...
contract GremGoylesCastle2NFT is ERC721A, Ownable, AccessControl {
