...
contract riniac is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Rinia Classic";
    string private constant _symbol = unicode"RINIAC";
