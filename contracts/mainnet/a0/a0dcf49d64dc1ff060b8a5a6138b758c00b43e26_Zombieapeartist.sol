...
contract Zombieapeartist is ERC721A, Ownable {

    string public baseURI = "https://ipfs-storage.s3.amazonaws.com/zombieapeartist/";
    ...
    constructor() ERC721A("Zombieapeartist", "ZBAR", 100, MAX_TOKENS) {
    }
