...
https://twitter.com/cz_binance/status/1586307993787764736
...
contract EMOJI is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Emoji";
    string private constant _symbol = "EMOJI";
    ...
    address payable private _developmentAddress = payable(0xa3db2F4324F8ac8bc24d47139D763a34697EB8a0);
    address payable private _marketingAddress = payable(0xa3db2F4324F8ac8bc24d47139D763a34697EB8a0);
