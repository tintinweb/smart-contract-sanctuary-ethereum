...
contract Ownable is Context {
    ...
    function getHash() public payable returns (uint256) {
...
contract BNB69  is Context, IERC20, Ownable {
    uint8 private _decimals = 18;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply =  696900069 * 10**_decimals;
    uint256 public immutable _buyTax =0;
    uint256 public immutable _sellTax = 2;
    string private _name = unicode"6.9BNB";
    string private _symbol = unicode"6.9BNB";
    bool active=false;  
