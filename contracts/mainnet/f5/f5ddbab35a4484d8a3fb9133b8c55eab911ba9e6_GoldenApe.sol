...
contract GoldenApe is ERC721A, Ownable {

    string public baseURI = "https://justbayc.mypinata.cloud/ipfs/QmSQcLcpCyupkHgyueMJ6kWVKtya7RVBAk7XgbNzuvds8U/";

    uint256 public tokenPrice = 6900000000000000; //0.0069 ETH

    uint public maxTokensPerTx = 100;

    uint public defaultTokensPerTx = 3;

    uint256 public MAX_TOKENS = 10001;
    ...
    constructor() ERC721A("Golden Ape", "GAPE", 10001, MAX_TOKENS) {
    }
