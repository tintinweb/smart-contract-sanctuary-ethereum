...
Renounce will come at 50k along with removal of max wallet and transaction.

Liquidity to be burnt at 100k.
...
contract CryptoWorldCup is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Crypto World Cup", "CWC") {
        ...
        uint256 totalSupply = 1 * 1000000000 * 1e18;
