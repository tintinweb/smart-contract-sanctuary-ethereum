...
contract COCACOLADAO is Context, IERC20, Ownable {
    ...
    string private _name = "Coca-Cola DAO";
    ...
    uint256 public _maxTxAmount = 6300000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 1000000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 12600000000000000000000 * 10**9;
