...
contract BTCETHSwap {
    ...
    // ARB
    address public PBTC_ETH_ADDRESS = address(0x62199B909FB8B8cf870f97BEf2cE6783493c4908); 
    address public WBTC_ETH_ADDRESS = address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599); 
    address public WETH_ETH_ADDRESS = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    ...
    {
        Token(PBTC_ETH_ADDRESS).transferFrom(msg.sender, address(this), amount);
    ...
    function swapETHforPBTC (string memory recipient) public payable {
        ...
        pToken(PBTC_ETH_ADDRESS).redeem(
            amount_pbtc, 
            recipient,
            PTOKENS_BTC_CHAINID
        );
