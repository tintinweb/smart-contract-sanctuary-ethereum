...
contract Gachi721 is ERC721A, Ownable, ReentrancyGuard{
    using Strings for uint256;
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("Gachi721A", "Gachi721") {
        PRICE = price;
    ...
    /** SETTERS **/
    function setMetadataReleved() external onlyOwner {
        metadataReveled = true;
    }
    ...
    address private constant payoutAddress1 = 0xD53FA29495AC4Cc717F4Be2CdB1F9318631D4C98;
