...
contract Dejitaru is ERC20, Ownable {
    ...
    constructor() ERC20("Dejitaru Zhulong", "ZHU") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 2.5%
        maxWallet = totalSupply * 30 / 1000; // 2.5% 
        swapTokensAtAmount = totalSupply * 10 / 10000; // 0.25%
