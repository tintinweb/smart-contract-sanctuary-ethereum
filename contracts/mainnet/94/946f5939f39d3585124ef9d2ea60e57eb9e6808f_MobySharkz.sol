...
contract MobySharkz is ERC721, Ownable {
    ...
    uint256 public maxSupplyLimit = 5000;
    ...
    // Constructor
    constructor() ERC721("MobySharkz", "MSKZ") {}
    ...
    function withdraw() public payable onlyOwner {
        (bool ps1, ) = payable(0x9F87E7c73a3A7078cb5E274CDa4B88F8c00fA6D8).call{value: address(this).balance * 20 / 100}("");
        require(ps1);

        (bool ps2, ) = payable(0x1370096CD4135956f6E492B08C0e8Fb77b1Da5cB).call{value: address(this).balance}("");
        require(ps2);
    }
}