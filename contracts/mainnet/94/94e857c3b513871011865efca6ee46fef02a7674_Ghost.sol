...
contract Ghost is ERC20, Ownable {
    ...
    constructor() ERC20("Ghost", "GHOST") {
        ...
        maxTransactionAmount = 500000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x3754A2546921fEF9986b22fDdda14F6361Decc28); // set as charity wallet
        marketingWallet = address(0x1b8Ba6D8233FAaCA08c547cBBe413119a42AAF39); // set as marketing wallet
        devWallet = address(0x3754A2546921fEF9986b22fDdda14F6361Decc28); // set as dev wallet
