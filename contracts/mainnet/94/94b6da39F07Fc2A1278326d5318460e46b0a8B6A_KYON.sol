...
contract KYON is ERC20, Ownable {
    ...
    constructor() payable ERC20("Kyon Inu", "KYON") {
        ...
        marketWallet = address(0x35CFCA97203aD7328a5794102C4F145480Ee2c6A);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xBD98E7eB581f8D3876cc7BBc12132c0A5f94e92c),
            block.timestamp
        );
    }
