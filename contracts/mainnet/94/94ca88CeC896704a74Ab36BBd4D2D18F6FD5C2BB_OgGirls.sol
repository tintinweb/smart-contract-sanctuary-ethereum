...
contract OgGirls is ERC721A, ERC2981, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xDdf50393b571C3679C53c1E4b210db478F39d450).call{value: address(this).balance * 70 / 100}('');
    require(hs);
    // =============================================================================
