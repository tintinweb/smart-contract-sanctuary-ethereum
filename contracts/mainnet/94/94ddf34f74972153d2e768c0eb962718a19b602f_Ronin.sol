...
contract Ronin is IERC20, Ownable {
    IRouter public uniswapV2Router;
    address public uniswapV2Pair;
    string private constant _name =  "Ronin";
    string private constant _symbol = "RONIN";
    uint8 private constant _decimals = 18;
    mapping (address => uint256) private balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 private _totalSupply = 10000000000 * 10**18; // 10 billion
    ...
    function activateTrading() external onlyOwner {
        ...
        maxWalletAmount = _totalSupply * 4 / 100; //  4%
        maxTxAmount = _totalSupply * 4 / 100;     //  4%
