...
contract AlienByReal is ERC721A {
    ...
    function freemint() external {
        require(0 == price);
        if (totalSupply() + 1  > 100) revert InvalidPrice();
    ...
    constructor() ERC721A("Alien BY Real", "Alien") {
        _owner = msg.sender;
    }

    string public _baseTokenURI = "ipfs://QmRYPL3uM8yifXeJPrSVRe4uEkacDFFANwyJCTZj9xmhoa/";
