...
contract EA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ethereum Application";
    ...
    address payable private _developmentAddress = payable(0x4BDE0B72ae5e8B17Ead4eEAd31B9a449Db39D89d); 
    address payable private _marketingAddress = payable(0x4BDE0B72ae5e8B17Ead4eEAd31B9a449Db39D89d);
