...
SnoopDOGE-TV $SDGTV is a community-driven token on the Ethereum blockchain. We aim to start a movement of resistance to those people who control the market and help small investors to make it in these rough times.
...
contract SnoopDOGETV is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SnoopDOGE-TV";
    string private constant _symbol = unicode"$SDGTV";
