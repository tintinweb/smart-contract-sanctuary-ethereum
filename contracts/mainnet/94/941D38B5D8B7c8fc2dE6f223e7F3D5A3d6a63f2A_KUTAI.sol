...
contract KUTAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dejitaru Shukutai", "KUTAI") {
        ...
        maxWallet = totalSupply * 10 / 1000; // 1.0 
