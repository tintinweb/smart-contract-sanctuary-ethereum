...
t.me/verygoodtoken
   ...
   *Listed in Uniswap
    ...
    https://ibb.co/XyWjyP8
    https://ibb.co/F3pQ3SC
*/
...
contract VERYGOODTOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("Very Good Token", "GOOD") {
        ...
        maxWallet = 10000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x971390a61f1e0e6806c6528c473E471711a20cbd); // set as charity wallet
        marketingWallet = address(0x971390a61f1e0e6806c6528c473E471711a20cbd); // set as marketing wallet
        devWallet = address(0x971390a61f1e0e6806c6528c473E471711a20cbd); // set as dev wallet
