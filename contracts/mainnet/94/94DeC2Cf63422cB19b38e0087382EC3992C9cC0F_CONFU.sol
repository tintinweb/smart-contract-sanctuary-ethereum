//  TWITTER: https://twitter.com/ConfuciusEth

//  TELEGRAM: https://t.me/confuciuserc

//  WEBSITE: https://confuciuserc.com/
...
contract CONFU is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Confucius";
    string private constant _symbol = "QIU";
    ...
    uint256 public _maxTxAmount = 35 * (_tTotal/1000);
    uint256 public _maxWalletSize = 35 * (_tTotal/1000);
