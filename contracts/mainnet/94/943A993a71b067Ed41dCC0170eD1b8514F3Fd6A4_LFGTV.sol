...
/**
In the real world, every household has a TV for entertainment, not to mention the virtual currency world?  

This one is derived from the decentralized product chain in the virtual currency world!  So that everyone can enjoy endless video experience!

t.me/lfgtvperform
https://medium.com/@lfgtvperform/lfg-tv-656e83f3c42a
twitter.com/lfgtvperform
...
**/
  ...
  contract LFGTV is Context, IERC20, Ownable {
      ...
      string private constant _name = "LFGTV";
      string private constant _symbol = "LFGTV";
