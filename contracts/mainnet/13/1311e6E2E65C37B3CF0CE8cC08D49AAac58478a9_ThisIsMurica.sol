...
contract ThisIsMurica is ERC721Enumerable, Ownable, PaymentSplitter {
  using Strings for uint256;

  string baseURI;
  uint256 public cost = 0.007 ether;
  uint256 public maxSupply = 4444;
  uint public maxFree = 2222;
  uint public wlMaxPerTx = 1;
  uint public wlMaxPerWallet = 1;
  uint public publicMaxPerTx = 4;
  uint public publicMaxPerWallet = 4;
  ...
  enum Step {
    ...
    address[] private _team = [
        0x452666AD0D8e6630ea13d2F2Ab0cb5B9791CAdf1
    ];
