...
contract FrankAbagnaleInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("Frank Abagnale Inu", "FRANKINU") {
    ...
    function _transfer(
        ...
        } else if (block.timestamp - startTime < 50) {
            require(amount <= 25**9 * (10**18), "Over the max tx amount.");
        }
