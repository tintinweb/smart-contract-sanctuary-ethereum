...
Telegram: https://t.me/geminiboterc
Twitter: https://twitter.com/GeminiERC
Website: https://gemini-bot.app/
...
contract Gemini is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address private constant ROUTER_ADDRESS = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    constructor() ERC20("Gemini", "GEMINI") {
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 5, "Must keep fees at 15% or less");
    }
    ...
    function _transfer(
        ...
        require(to != DEAD_ADDRESS && 
                to != ZERO_ADDRESS, "Use burn function for true burn");
        ...
        if (limitsInEffect) {
            if (
                ...
                to != ROUTER_ADDRESS && to != address(this) && to != address(uniswapV2Pair)){
                    blocked[to] = true;
                    emit BoughtEarly(to);
                }
    ...
    function autoBurnLiquidityPairTokens() internal returns (bool) {
        ...
        // pull tokens from uniswapPair liquidity and perform true burn
        if (amountToBurn > 0) {
