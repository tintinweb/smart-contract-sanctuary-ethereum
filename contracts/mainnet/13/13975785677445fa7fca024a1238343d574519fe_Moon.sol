...
contract Moon is ERC20, Ownable {
    ...
    constructor() ERC20("A FISH CALLED", "SANTA") {
     ...
     uint256 totalSupply = 1 * 10 ** 9 * 10 ** decimals();
        ...
        MarketingWallet = address(0x1a53492AA22025351C89eAC3a9df03475Ea5855e); // set as Marketing wallet
        DevWallet = address(0x1a53492AA22025351C89eAC3a9df03475Ea5855e); // set as dev wallet
    ...
    function updateBuyFees(uint256 _Marketing, uint256 _liquidityFee, uint256 _DevFee) external onlyOwner {
        ...
        buyDevFee = _DevFee;
        buyTotalFees = buyMarketing + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 39, "Must keep fees at 3.9% or less");
    }
    ...
    function updateSellFees(uint256 _Marketing, uint256 _liquidityFee, uint256 _DevFee) external onlyOwner {
        ...
        sellDevFee = _DevFee;
        sellTotalFees = sellMarketing + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 69, "Must keep fees at 6.9% or less");
    }
