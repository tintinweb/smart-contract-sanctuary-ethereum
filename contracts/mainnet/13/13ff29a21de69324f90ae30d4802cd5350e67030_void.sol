...
contract void is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSnviMad2UYhgNn1KbmvQFRU1ZzCUo2qkeymZwhLUtXzn";
    ...
    constructor(
    ) ERC721A("abyss by anon", "void", 100, maxSupply) {
    }
