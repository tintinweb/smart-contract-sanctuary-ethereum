...
/*
 __  __                               _   _      _         
 |  \/  |                             | \ | |    | |        
 | \  / | __ _  __ _ _   _ _ __ ___   |  \| | ___| | _____  
 | |\/| |/ _` |/ _` | | | | '__/ _ \  | . ` |/ _ \ |/ / _ \ 
 | |  | | (_| | (_| | |_| | | | (_) | | |\  |  __/   < (_) |
 |_|  |_|\__,_|\__, |\__,_|_|  \___/  |_| \_|\___|_|\_\___/ 
                __/ |                                       
               |___/                                       

Maguro Neko

Telegram - https://t.me/maguro_neko

Twitter - https://www.twitter.com/Maguro_NekoErc
*/
...
contract MAGURONEKO is Context,IERC20, Ownable{
using Address for address;
string private _name = "MAGURONEKO";
string private _symbol = "MAGNEKO\xF0\x9F\x90\x9F\xF0\x9F\x90\x88";
...
address _owner;
address payable public marketingAddress = payable(0x87Fce9062302A99B2D663d347BAc015fd1Cb7963);
...
uint256 maguronekoINUCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > maguronekoINUCOINDaycooldown, "You cant call maguronekoINUCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function maguronekoINUCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    maguronekoINUCOINDaycooldown = block.timestamp + 86400;
}
