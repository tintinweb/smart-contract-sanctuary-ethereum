...
GENGAR is the strongest ghost pokemon

We will always be here in the background
Biding our time
We hate scammers and devs that rug
So we will Hypnosis and then Psychic them
With a Mega Punch and Kick just for good measure
You can run, but you can't hide from $GENGAR...
...
// Messsage to Holders: Gengar will communicate throught he blockchain, let's see what will happen?
...
contract GENGARInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GENGARInu", "GENGARInu") {
