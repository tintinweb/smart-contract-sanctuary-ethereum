// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Bubble Gum", unicode"Eyewear", unicode"Accesories", unicode"Hair", unicode"Mouth", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Pepitos", unicode"smol", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/8ca05bf5-5faa-4e51-b30a-d7a7e5b38607", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/8ca05bf5-5faa-4e51-b30a-d7a7e5b38607", "", 700, "0x4f04c937A3ad3B77c16d856C9EdD683c64e01F45");

        constructor() ERC721A(unicode"Pepitos", unicode"pip") {
            TIERS[0] = [144,1356];
TIERS[1] = [19,22,28,49,60,64,94,98,154,252,660];
TIERS[2] = [83,139,191,211,262,280,334];
TIERS[3] = [7,9,11,16,17,37,37,46,62,67,75,83,96,146,171,196,201,223];
TIERS[4] = [71,114,115,147,148,266,639];
TIERS[5] = [3,5,15,45,45,52,61,176,178,182,187,259,292];
TIERS[6] = [10,24,33,34,40,80,92,103,107,140,243,288,306];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Pepitos #");
