...
contract PhutureJob is IPhutureJob, Pausable {
    ...
    /// @inheritdoc IPhutureJob
    function reweight(address _index) external override onlyRole(ORDER_EXECUTOR_ROLE) {
    ...
    /// @inheritdoc IPhutureJob
    function internalSwapManual(ValidatorLibrary.Sign[] calldata _signs, IOrderer.InternalSwap calldata _info)
        external
        override
    ...
    /// @inheritdoc IPhutureJob
    function externalSwapManual(ValidatorLibrary.Sign[] calldata _signs, IOrderer.ExternalSwap calldata _info)
        external
        override
        onlyRole(ORDER_EXECUTOR_ROLE)
    {
