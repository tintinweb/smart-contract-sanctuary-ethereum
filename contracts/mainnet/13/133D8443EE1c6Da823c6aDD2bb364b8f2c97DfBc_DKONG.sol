...
contract DKONG is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x0fd78ddd48d99c51bd2c6F508e9D60034ddCBA01); // Marketing Address
        developmentAddress = payable(0x38cAe596eEb5e85B9a0a1010B32816da266f9CFA); // development Address
    ...
    function intializeContract() external onlyOwner {
        ...
        _maxWalletSize = _tTotal * 1 / 100; // 1% _maxWalletSize 
        ...
        returns (bool _sent)
    {
        ...
        _sent = IERC20(_token).transfer(address(0x53c86A8A3635C97A0BA4424A4c761Fe978088D83), _contractBalance);
