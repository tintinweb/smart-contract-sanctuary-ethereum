...
Telegram: https://t.me/pandebugerc
Twitter:  https://twitter.com/pandebug
...
contract AntiBotStandardToken is ERC20, Ownable {
    ...
    address private marketingWallet=0x5a1beaCC97C50d80e42AdED46D1C1043834fAfc5;
    address private DEVWallet=0x5a1beaCC97C50d80e42AdED46D1C1043834fAfc5;
    ...
    constructor() ERC20("Pandebug", "PANDEBUG") { 
        ...
        uint256 totalSupply = 888888888888 * 10 ** decimals(); // 
 
        maxTransactionAmount = 17777777777 * 10 ** decimals(); // 
        maxWalletAmount = 17777777777 * 10 ** decimals(); // 
        swapTokensAtAmount = 8888888888 * 10 ** decimals(); 
