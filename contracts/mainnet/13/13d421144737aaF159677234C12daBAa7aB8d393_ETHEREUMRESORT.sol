...
ETHEREUM RESORT is owned and powered by the community who get rewarded for their loyalty with many upcoming special features and distributions.
We welcome all to build the most vibrant and successful crypto in the meme community.

Apply Captcha and join our 📱Telegram: @EthereumResort 
🍸 Taxes 3% IN 3 % OUT, use small slippage just in case. Taxes will be lowered to 0% and contract renounced after smooth launch.
Website: https://ethereumresort.vip/
...
contract ETHEREUMRESORT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ethereum Resort";
    ...
    address payable private _developmentAddress = payable(0x28D1e71119b27DC62a848b2187d14ad47CaeaA1C); 
    address payable private _marketingAddress = payable(0x28D1e71119b27DC62a848b2187d14ad47CaeaA1C);
