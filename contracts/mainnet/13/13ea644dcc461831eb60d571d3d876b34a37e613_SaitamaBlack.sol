...
contract SaitamaBlack is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saitama Black";
    string private constant _symbol = "SAITAMAB";
