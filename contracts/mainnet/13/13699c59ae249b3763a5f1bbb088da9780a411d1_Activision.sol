...
contract Activision is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Call of Duty", "COD") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xeA318305C13D7028BA150F85fd8688De175d31A8); // set as Marketing wallet
        DevWallet = address(0xeA318305C13D7028BA150F85fd8688De175d31A8); // set as dev wallet
