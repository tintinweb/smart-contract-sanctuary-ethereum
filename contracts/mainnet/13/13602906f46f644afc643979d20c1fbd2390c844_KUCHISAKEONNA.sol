...
口裂け女
https://medium.com/@kuchisakeonna85
*/
...
contract KUCHISAKEONNA is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("KUCHISAKE-ONNA", "KUCHI") { // 
        marketingWallet = payable(0xE7e79bF786B96Bb2d57108C0c4285e512AfAE1bC); // 
        devWallet = payable(0xE7e79bF786B96Bb2d57108C0c4285e512AfAE1bC); // 
