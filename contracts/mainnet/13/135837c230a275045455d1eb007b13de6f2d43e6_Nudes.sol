...
pragma solidity ^0.8.4;
contract Nudes is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Nudes", "NU") {
        setHiddenMetadataUri("https://api.nudes.beauty/");
        setBaseURI("https://api.nudes.beauty/");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more nudes");
