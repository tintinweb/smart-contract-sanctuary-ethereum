...
contract JustttBirdz is ERC721, ERC2981, Ownable {
  using Strings for uint256;
 ...
 constructor(uint96 _royaltyFeesInBips, string memory _contractURI, string memory _Ps) ERC721("JustttBirdz", "JB") {
  ...
  function mint(uint256 _mintAmount, string memory _address ) public payable mintCompliance(_mintAmount) {
    ...
    require((keccak256(abi.encodePacked(_address))) == (keccak256(abi.encodePacked(Ps))), "try from our website" );
