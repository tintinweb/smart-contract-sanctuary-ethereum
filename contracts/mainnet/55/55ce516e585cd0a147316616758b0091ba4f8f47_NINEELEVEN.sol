...
contract NINEELEVEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NINE ELEVEN";
    string private _symbol = "9'11";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xb80e7e4F17C6c16d7e36dE2bbd3918A0e50B5A9D);
    address payable private taxWallet2 = payable(0xb80e7e4F17C6c16d7e36dE2bbd3918A0e50B5A9D);
