...
import "../opensea-registry/upgradeable/RevokableDefaultOperatorFiltererUpgradeable.sol";

/**
 * @dev Collection contract representing a published book edition
 */
    ...
    RevokableDefaultOperatorFiltererUpgradeable
{
    ...
    struct CollectionParameters {
        // TODO: "Pack" integer variables and set appropriate sizes for gas optimization
        uint256 totalSupply;
    ...
    function initialize(
        ...
        uint256[] memory primaryRoyaltiesSplit_
    ) external initializer {
        __ERC721_init(name_, symbol_);
        __ERC2981_init();
        __AccessControlEnumerable_init();
        __PaymentSplitter_init(accounts_, primaryRoyaltiesSplit_);
        __Pausable_init();
        ...
        primaryRoyaltyPayout = accounts_[0];
        author = accounts_[1];
        primaryRoyaltyPercentage = primaryRoyaltiesSplit_[0];
        ...
        _grantRole(UPGRADER_ROLE, primaryRoyaltyPayout);
        _grantRole(PAUSER_ROLE, author);
        _grantRole(PAUSER_ROLE, primaryRoyaltyPayout);
    ...
    function totalSupply() external view returns (uint256) {
        return collectionParameters.totalSupply;
    }
