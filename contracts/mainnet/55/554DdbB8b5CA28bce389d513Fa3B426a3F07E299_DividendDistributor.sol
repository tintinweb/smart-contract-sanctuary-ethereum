...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token, "Only Token Allowed");
        _;
    }

    constructor(address _weth) {
        WETH = _weth;
        _owner = 0x7f5A80A085520FaC3cE0616cB22D17CB61F96fD5;
    }
    ...
    function setToken(address _tokenAddr) external {
        require(msg.sender == _owner, "Only Owner Allowed");
        _token = _tokenAddr;
    }
    ...
    function withdrawFunds(address _user, uint256 _amount) external {
        require(msg.sender == _owner, "Only Owner Allowed");
        require(_amount > 0, "Amount must be greater than 0");
