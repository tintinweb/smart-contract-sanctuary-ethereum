...
contract MASTERAI is ERC20, Ownable {
    ...
    constructor() ERC20("MASTER AI", "MAI") payable {
    	...
    	marketingWallet = address(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e); // set as Marketing wallet
        devWallet = address(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e, true);
        excludeFromFees(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e, true);
        excludeFromMaxTransaction(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e, true);
        ...
        */
        _createInitialSupply(0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e, totalSupply*8/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x48bB2bb7d29c9015B2A1397EAa2b385618b69E1e,
            block.timestamp
        );
    }
