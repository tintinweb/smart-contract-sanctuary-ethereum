...
contract USDx_BABB_Token is Pausable, StandardToken, BlackList {
    ...
    function USDx_BABB_Token(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
