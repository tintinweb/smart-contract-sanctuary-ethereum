...
contract Metareel is ERC20, Ownable {
    ...
    address public developmentWallet = 0x9D8660D1092881a0043C0d38f1a05d2e660C74e3;
    uint public constant PERCENT_DIVIDER = 10000;
    uint public constant BUYTAX = 0;
    uint public constant SELLTAX = 70;


    event changeLiquidityPoolStatus(address lpAddress, bool status);


    constructor() ERC20("Meta Reel", "METAR") {
    ...
    function _transfer(address sender, address receiver, uint256 amount) internal virtual override {
        ...
        if(taxAmount > 0) {
            super._transfer(sender, developmentWallet, taxAmount);
        }    
