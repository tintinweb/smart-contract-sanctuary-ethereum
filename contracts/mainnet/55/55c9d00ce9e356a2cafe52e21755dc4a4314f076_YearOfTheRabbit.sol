...
// File: YearOfTheRabbit.sol


/*⠀⠀⠀⠀

    Janurary 22th begins the Year Of The Rabbit 2023
    
    Rabbit is a symbol of longevity, peace and prosperity. 2023 is predicted to be greatest year ever.

    Join us and enjoy the best year of your lives.

    YearOfTheRabbit.fun

    t.me/YearOfTheRabbitETH
...
contract YearOfTheRabbit is ERC20, Ownable {
    ...
    constructor() ERC20("Year Of The Rabbit", "RABBIT") {
        ...
        marketingWallet = address(0x8904713DC39107ad2ba86e932fde5D15E0CC104f); // set as marketing wallet
        devWallet = address(0x8904713DC39107ad2ba86e932fde5D15E0CC104f); // set as dev wallet
    ...
    function setMaxTransactionAmout(uint256 newNum) external onlyOwner {
