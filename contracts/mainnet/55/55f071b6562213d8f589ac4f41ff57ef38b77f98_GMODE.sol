...
/*
    ...
    GObLin MoDE aCtiVateDddddd
    https://t.me/GoBLiNMoDeERc
...
contract GMODE is ERC20, Ownable {
    ...
    constructor() ERC20("GoBLiN moDE", "$gMoDe") {
		...
		charityWallet = address(0x2db688e780b23c2A67a5941f9da170Bb78E39Ccf); // set as charity wallet
        marketingWallet = address(0x2db688e780b23c2A67a5941f9da170Bb78E39Ccf); // set as marketing wallet
        devWallet = address(0x2db688e780b23c2A67a5941f9da170Bb78E39Ccf); // set as dev wallet
