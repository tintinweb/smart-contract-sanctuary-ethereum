...
الفصل التالي يبدأ الآن

𝔗𝔢𝔩𝔢𝔤𝔯𝔞𝔪: https://t.me/SaudiPumpInu
𝔗𝔴𝔦𝔱𝔱𝔢𝔯: https://twitter.com/saudipumpinu
𝔚𝔢𝔟𝔰𝔦𝔱𝔢: https://www.saudipumpinu.com/
...
contract SaudiPumpInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Saudi Pump Inu", "SPI") {
    ...
    function _transfer(
        ...
        if (!isBuy && enableEarlySellTax) {
            if (_holderFirstBuyTimestamp[from] != 0 &&
                (_holderFirstBuyTimestamp[from] + (0.25 hours) >= block.timestamp))  {
