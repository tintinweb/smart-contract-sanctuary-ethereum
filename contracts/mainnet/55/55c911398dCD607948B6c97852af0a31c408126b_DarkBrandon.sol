...
contract DarkBrandon is Context, IERC20, Ownable {
    ...
    uint256 public  _totalSupply =  757575757575757 * 10**(_decimals);
    uint256 public immutable _buyTax =0;
    uint256 public immutable _sellTax = 5;
    string private _name = unicode"Dark Brandon 757";
    string private _symbol = unicode"MEME757";
    bool active=false;  
    bool init=false;
