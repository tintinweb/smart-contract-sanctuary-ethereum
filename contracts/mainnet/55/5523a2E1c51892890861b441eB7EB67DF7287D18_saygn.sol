...
contract saygn is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 5401;
  uint256 public freeSupply = 3401;
