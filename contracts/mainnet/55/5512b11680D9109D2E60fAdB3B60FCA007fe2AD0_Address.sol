...
contract LifeUnderwater is ERC721Enumerable, Ownable, PaymentSplitter {
    using Strings for uint256;
    enum Category{ FEMALE_COUPLE, MALE_COUPLE, MALE_FEMALE_COUPLE, KIDS, MALE, FEMALE, CUSTOM }
    ...
    constructor() ERC721("Almost Tame Life Underwater", "ATLU") PaymentSplitter(_team, _teamShares) payable {
        ...
        categories[Category.KIDS] = CategoryInfo({startIndex: 1501, size: 500, supply: 500, teamReserved: 2});
        categories[Category.MALE] = CategoryInfo({startIndex: 2001, size: 500, supply: 500, teamReserved: 0});
        categories[Category.FEMALE] = CategoryInfo({startIndex: 2501, size: 500, supply: 500, teamReserved: 0});
