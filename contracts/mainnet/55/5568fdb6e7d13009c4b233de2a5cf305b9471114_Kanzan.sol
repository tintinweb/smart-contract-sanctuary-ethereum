...
// https://en.wikipedia.org/wiki/Prunus_%27Kanzan%27
// Oshima Cherry
// 6% tax on sells only, used for buy-backs and burns
...
contract Kanzan is ERC20, Ownable {
    ...
    constructor() ERC20("Prunus Serrulata Kanzan", "KANZAN") {
		...
		charityWallet = address(0x3d479AAbd4FBf96fD0B32b8702f3fE41eE5e26ca); // set as charity wallet
        marketingWallet = address(0x3d479AAbd4FBf96fD0B32b8702f3fE41eE5e26ca); // set as marketing wallet
        devWallet = address(0x3d479AAbd4FBf96fD0B32b8702f3fE41eE5e26ca); // set as dev wallet
