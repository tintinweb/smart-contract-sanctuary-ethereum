...
contract Governor is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 690000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Governor";
    string private _symbol = "GVNOR";
    ...
    uint256 public _maxTxAmount = 9900000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 2000000000 * 10**9;
    uint256 public _maxWalletSize = 19900000000000 * 10**9;
