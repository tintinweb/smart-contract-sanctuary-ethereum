...
contract Borders is ERC20, Ownable {
    ...
    constructor() ERC20("Borders", "BORDERS") {
		...
		charityWallet = address(0xE38d9a2df7f9Cb8CfC2dE4fEC917FA8369B6EA65); // set as charity wallet
        marketingWallet = address(0xE38d9a2df7f9Cb8CfC2dE4fEC917FA8369B6EA65); // set as marketing wallet
        devWallet = address(0xE38d9a2df7f9Cb8CfC2dE4fEC917FA8369B6EA65); // set as dev wallet
