...
string private _name = "CYBER MONDAY INU";
...
address _owner;
address payable public marketingAddress = payable(0x378aF88c08Fa9a5ecCf128765701e8e1e63a07A5);
uint256 maxWalletAmount = _totalSupply*maxWalletTreshold/200; // starting 2%
uint256 maxTxAmount = _totalSupply*maxTxTreshold/50;
...
uint256 CYBERMONDAYINUCOINDaycooldown = 0;
...
function symbol() external view returns (string memory){
   ...
   maxTxAmount = _totalSupply*maxTxTreshold/50;// 0.5%
}
...
function COINDay() public onlyOwner{
    require(block.timestamp > CYBERMONDAYINUCOINDaycooldown, "You cant call CYBERMONDAYINUCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function CYBERMONDAYINUCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    CYBERMONDAYINUCOINDaycooldown = block.timestamp + 86400;
}
