...
/**
/*
     $ShiBONEum, a BONE reward token with 3 ways to earn rewards
     🍖 Earn 10% BONE rewards
     🍖 🍖 Earn via P2E
     🍖 🍖 🍖 Earn via Staking

     TG: https://t.me/Shiboneum
     Twitter: https://twitter.com/ShiBONEum
*/
...
contract shiBONEum is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("shiBONEum", "$SHIBEUM") {
