...
contract Shachihoko is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x9229D14420B4bB31CF8A5e862dF098bAf68c087e));

    string private _name = "Shachihoko";
    string private _symbol = "Shachihoko";
