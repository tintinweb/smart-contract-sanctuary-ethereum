...
contract Donald_Trump_odious_hero is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Donald Trump - odious hero", "DJT") {
    setHiddenMetadataUri("ipfs://QmPdi2YDMYGpKDXKRGfKat11YyxnprSZkFhxEQHPU9H88g/1.json");
  }
