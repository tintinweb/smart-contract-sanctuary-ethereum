...
//
//
// https://t.me/DopiumERC
// https://twitter.com/DopiumETH
//
// 
...
contract Dopium is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dopium";
    string private constant _symbol = unicode"DOPIUM";
    ...
    function reduceDope(uint256 _newFee) external{
