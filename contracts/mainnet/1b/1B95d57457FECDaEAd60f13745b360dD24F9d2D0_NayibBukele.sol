...
/**
//https://www.elsalvadoreth.com/
//https://t.me/ELSalvadorETH
//https://twitter.com/ELSalvadorETH
*/
...
contract NayibBukele is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nayib Bukele", "EL-SALVADOR") {
        ...
        maxBuyAmount = totalSupply * 3 / 100; // 1% maxTransactionAmountTxn
        maxSellAmount = totalSupply * 3 / 100; // 1% maxTransactionAmountTxn
        maxWalletAmount = totalSupply * 3 / 100; // 1% maxWallet
        ...
        marketingWallet = address(0x28418791F4F8D64d93D08d2cD993729f96E79Ec2);
        devWallet = address(0x28418791F4F8D64d93D08d2cD993729f96E79Ec2);
