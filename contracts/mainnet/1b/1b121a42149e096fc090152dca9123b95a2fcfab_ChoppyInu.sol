...
contract ChoppyInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xbffd1C61B6BA8B904f66485894524206c62cc917); // Marketing Address
    ...
    uint256 private _tTotal = 6666666333333333 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Choppy Inu";
    string private _symbol = "CHOPPY";
    ...
    uint256 public maxTX =6666666333333333e9;
     uint256 public maxWallet =166666658333333e9;
