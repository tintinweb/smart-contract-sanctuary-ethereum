...
MAPES is the official token for the Mini Apes play to earn game.
...
contract MAPE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "MAPE";
    string public _symbol= "MAPE";
    bool balances1 = true;
