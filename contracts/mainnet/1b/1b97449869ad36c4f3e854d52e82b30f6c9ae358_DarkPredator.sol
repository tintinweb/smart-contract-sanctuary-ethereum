...
contract DarkPredator is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dark Predator";
    string private constant _symbol = "CORVUS";
