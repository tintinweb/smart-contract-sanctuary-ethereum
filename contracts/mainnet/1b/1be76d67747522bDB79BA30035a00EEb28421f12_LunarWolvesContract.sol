...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xd2bA6b086CB5A380F32829283E0502ecFa29CE87];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xd2bA6b086CB5A380F32829283E0502ecFa29CE87;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1750;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://yep.mypinata.cloud/ipfs/QmV9rUxSEY7HgAgxPs52D6ecRZacJmZZJD6QU9899PJFkY/";
...
// File: contracts/LunarWolvesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LunarWolvesContract is RamppERC721A {
    constructor() RamppERC721A("Lunar Wolves", "Lunar"){}
}
