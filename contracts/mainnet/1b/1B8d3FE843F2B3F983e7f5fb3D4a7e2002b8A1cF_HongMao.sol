...
In the realm where dreams dance with destiny,
there emerges

$HôngMâo

Website: https://redcaterc.com

Telegram: https://t.me/RedCatErc

Twitter: https://twitter.com/RedCatErc
...
contract HongMao is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 88888888 * 10**18;

    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 public _tokensBuyFee = 10;
    uint256 public _tokensSellFee = 35;
    ...
    string private constant _name = "Red Cat";
    string private constant _symbol = "HongMao";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x0f6FbCec1B40429DBB3De8c4c0cd733Aeae47Db3);
