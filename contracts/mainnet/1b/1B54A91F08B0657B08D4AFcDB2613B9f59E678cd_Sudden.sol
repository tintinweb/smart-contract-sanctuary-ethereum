...
contract Sudden is Context, ERC721Tradeable {
  using SafeMath for uint256;
  using SafeMath for int256;
  address payable payableAddress;
  bytes32 public merkleRoot = 0x6c1ca4c81fbf7d6149a1867b5223bb1aca375da230b7a4f839b5b5359d9a6928;
  using Counters for Counters.Counter;
  // mintStage 1 == Whitelist, 2 == public
  uint256 mintStage = 0;

  constructor(address _proxyAddress) ERC721Tradeable("Sudden", "DIEDSU", _proxyAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0xc0b37b898FeCEba79Cb4615bd288c4d83Da52D9e);
  }
    ...
    function whitelistMint(uint256 amount, bytes32[] calldata merkleProof) public virtual payable {
      require(mintStage == 1 || mintStage == 2, "Whitelist mint not started");
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  //Price is 0.05 ETH
  uint256 internal PRICE = 50000000;
  ...
  uint256 internal MAX_SUPPLY = 444;
