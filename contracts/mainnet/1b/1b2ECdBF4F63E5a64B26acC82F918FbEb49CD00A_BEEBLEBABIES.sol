...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function getHolderWL(address owner) public view returns (uint256) {
       uint256 holderWL;
       uint256 hellfire = IERC721(0x39d1cE0ed423C56c262ef025e0619E91ae31e8B7).balanceOf(owner);
       uint256 heaven = IERC721(0x90702Bd8f020De7d5C1FF6730Ac9582741B9155a).balanceOf(owner);
       uint256 genesis = IERC721(0x6FEFb647395e680339bADC84dC774E3CA8bCA7B9).balanceOf(owner);
       uint256[3] memory data;
       data = [hellfire,heaven,genesis];
       uint minimal = data[0];
