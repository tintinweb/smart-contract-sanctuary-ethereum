...
contract MetaMiners is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmXDJKojcoeHwXfpU2bnVW8hfNdgoczjADy7nJTtqRrJjW";
    ...
    constructor(
    ) ERC721A("MetaMiners", "MM", 100, maxSupply) {
    }
