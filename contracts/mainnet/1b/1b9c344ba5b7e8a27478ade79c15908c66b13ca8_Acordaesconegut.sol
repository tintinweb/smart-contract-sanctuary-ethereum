...
contract Acordaesconegut  is ERC721A, Ownable {

    string public baseURI = "https://nftservices.s3.amazonaws.com/acordaesconegut/";

    uint256 public tokenPrice = 150000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("Acordaesconegut", "ACOR", 100, MAX_TOKENS) {
    }
