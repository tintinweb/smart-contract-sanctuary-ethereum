...
_transferOwnership(0x146F7f006980fBf0D496eEBe66B8D9fEBFF3fE11);
}
...
* It may also degrade with extremely large collection sizes (e.g >> 777), test for your use case.
*/
...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x146F7f006980fBf0D496eEBe66B8D9fEBFF3fE11;
...
address[] public payableAddresses = [RAMPPADDRESS,0x146F7f006980fBf0D496eEBe66B8D9fEBFF3fE11];
...
string public _baseTokenURI = "ipfs://QmPMdbhmyjX8PRk7p9NApdNrCABLMEPBiQZUA8fqF6m6qP/";

bool public mintingOpen = false;

uint256 public PRICE = 0.000 ether;
...
// File: contracts/SacredWaters.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SacredWaters is RamppERC721A {
constructor() RamppERC721A("SACRED WATERS", "SCWT"){}

function contractURI() public pure returns (string memory) {
return "ipfs://Qme7PHPa2VPLey6VGoKAX12PkFMf2xgnCUw1fCM1EjwrnH";
}
}