...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2)); // WETH mainnet - 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
      //rewardTokens.push(address(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6)); //weth gorli - 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6
  ...
  function distributeDividends() public override payable { 
    ...
    //gorli weth - 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6
    if(nextRewardToken == address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2)) {
        IWETH9(nextRewardToken).deposit{value: msg.value}();
    } else {
...
contract LiquidityDao is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ethbytes", "Bytes") {
    	...
    	operationsWallet = address(0x196275223b4B6c8359f64c5e00382dc1D01450cB); // set as operations wallet
