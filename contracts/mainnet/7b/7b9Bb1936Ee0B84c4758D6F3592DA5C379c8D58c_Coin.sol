...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public USDT =
        IERC20Extended(0xdAC17F958D2ee523a2206206994597C13D831ec7);
...
// main contract
contract Coin is IERC20Extended, Ownable {
    using SafeMath for uint256;
    ...
    constructor() Ownable() {
        ...
        isFeeExempt[address(0x6831D00A3F2b858cE117B5Ee5dE63F9103687CF5)] = true;
        ...
        isLimitExmpt[
            address(0x6831D00A3F2b858cE117B5Ee5dE63F9103687CF5)
        ] = true;
    ...
    function addOrRemoveBots(address[] memory accounts) external onlyOwner {
