...
/*
Join in the quest to find out what happened with Nikolai
...
contract Nikolai is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Murder Of Nikolai";
    string private constant _symbol = "CONSPIRACY";
