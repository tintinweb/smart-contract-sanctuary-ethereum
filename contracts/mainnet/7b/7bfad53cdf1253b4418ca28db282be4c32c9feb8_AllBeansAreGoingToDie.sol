...
contract AllBeansAreGoingToDie is ERC721A, Ownable {
	...
	string public prerevealURL = 'ipfs://Qmdb5cXxFgWfAYEvRycwSeW7HxdTZbbErDjfzkQq9r5qZM/hidden.json';
	mapping(address => uint) private _walletMintedCount;

    // Name
	constructor()
	ERC721A('All Beans Are Going To Die', 'ABGDIE') {
    }
