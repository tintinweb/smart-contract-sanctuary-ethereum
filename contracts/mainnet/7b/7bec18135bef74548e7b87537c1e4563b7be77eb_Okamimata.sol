...
contract Okamimata is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Okamimata"; ////
    string public constant symbol = unicode"OKAMIMATA"; ////
