...
/*
    ...
    ferocious looking woman. In fairy tales Baba Yaga flies around in a mortar, wields a pestle, 
    and dwells deep in the forest in a hut. She eats her victims 🩸🧙‍♀️
    
    Telegram Community: https://t.me/BabaYagaEth
*/
...
contract BabaYagaInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = address(0x899595ee53660d22aeEE72af9DA4795cAF2de77a);

    string private _name = "Baba Yaga Inu";
    string private _symbol = "YAGA";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 10000, "Max Tx Amount cannot be less than 0.1% ");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount >= 5000, "Swap Threshold Amount cannot be less than 0.05%");
