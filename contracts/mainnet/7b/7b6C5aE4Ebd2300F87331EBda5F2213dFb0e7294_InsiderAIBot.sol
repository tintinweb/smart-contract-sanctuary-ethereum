...
//Follow insiders wallets. Renounce after launch, 100% lp burnt. Utility telegram bot ready to use.
...
contract InsiderAIBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Insider Ai Bot";
    string private _symbol = unicode"IAB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x1ca62083fa73184230297797F803aa273a7e1e9d));
        marketingWallet = payable(address(0xBE2dF8159127Bc4F6e84AF740D124D295E370824));
