...
contract SpiritBlocks is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 67;
    uint256 public immutable supply = 105;
    ...
    address[] public withdrawAddresses = [0x421D9cedF47EA245A1F31a1DDEACE7Eade7d4947, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x644890971774c2c08a369276e89c0742a530ee7c7e072dae119e1a1866cd61a4;
