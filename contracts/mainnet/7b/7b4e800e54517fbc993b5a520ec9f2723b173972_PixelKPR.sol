...
contract PixelKPR is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {

    constructor() ERC721A("Pixel KPR", "PXKPR") DefaultOperatorFilterer() {}

    ContractStatus public CONTRACT_STATUS = ContractStatus.disable;

    uint256 public immutable PRICE = 0.001 ether;
    uint256 public constant MAX_SUPPLY = 8740;
    uint256 public immutable MAX_FREE_PER_WALLET = 1;
    uint256 public immutable MAX_TX_PER_WALLET = 7;

    string internal baseURI = "ipfs://bafybeibqvfbjcvbawavnvi7p5j3mxfvymkr2jlolisbfpbdt3h6q5xqbh4/";
