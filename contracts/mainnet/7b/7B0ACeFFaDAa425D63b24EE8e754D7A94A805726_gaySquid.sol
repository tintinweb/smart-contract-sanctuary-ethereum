...
contract gaySquid is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "Gay Squid";
    string constant _symbol = "GAYY";
    ...
    address public marketingWallet = 0xb1b60ED202059594Abe5Ea3a8831F923C53F6e9c;
    address private teamWallet = 0xb1b60ED202059594Abe5Ea3a8831F923C53F6e9c;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newteamFee) external authorized {
        ...
        require(newRewardFee >= 10, "Rewards Tax on buys can not be lower than 2%");
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell, uint256 newteamFeeSell) external authorized {
        ...
        require(newRewardFeeSell >= 10, "Rewards Tax on sells can not be lower than 2%");
