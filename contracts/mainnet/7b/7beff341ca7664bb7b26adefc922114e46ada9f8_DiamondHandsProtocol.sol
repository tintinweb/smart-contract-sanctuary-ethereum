...
contract LockToken is Ownable {
    ...
    modifier open(address from, address to) {
        require(isOpen || _whiteList[from] || _whiteList[to], "Trading Not Open");
        _;
    }
...
contract DiamondHandsProtocol is Context, IERC20, Ownable,LockToken {
...
//here you write your Marketing account address
    address private _MarketingWalletAddress = 0xB8519ac6A844343c5302C7bE52301972B51e12d5;
    ...
    string private _name = "DiamondHandsProtocol";
    ...
    uint256 public _maxTxAmount = 25000000 * 10**9; //25 million maximum transaction
    uint256 public maxWalletToken = 1000000 * (10**9); //maximum tokens a wallet can hold
