...
/**
Welcome To Chat NZT: Limitless AI

Telegram: https://t.me/Chat_NZT_Official
Twitter: https//twitter.com/ChatNZTOfficial 
Website: https://www.chatnzt.com/
Whitepaper: https://www.canva.com/design/DAFb1GtYczY/Qph4aOL4p07ojTYNuAvL2Q/view?utm_content=DAFb1GtYczY&utm_campaign=designshare&utm_medium=link&utm_source=homepage_design_menu#1
*/
...
contract CHATNZT is ERC20, Ownable {
    ...
    constructor() ERC20("CHAT NZT", "NZT") payable {
    	...
    	marketingWallet = address(0xea07041d23b6883B0D867EDE6aEeb22ab82e776B); // set as marketing wallet
        ...
        excludeFromFees(0xb76561A6bA54DE08352aE8e3d18D43677EC8b1d7, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xb76561A6bA54DE08352aE8e3d18D43677EC8b1d7, true);
        ...
        */
        ...
        _createInitialSupply(0xb76561A6bA54DE08352aE8e3d18D43677EC8b1d7, totalSupply*5/100);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyBackFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBuyBackFee + buyDevFee;
        require(buyTotalFees <= 1, "Must keep fees at 20% or less");
    }
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xb76561A6bA54DE08352aE8e3d18D43677EC8b1d7,
            block.timestamp
        );
    }
