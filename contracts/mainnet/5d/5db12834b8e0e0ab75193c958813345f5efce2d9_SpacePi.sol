...
SPACEPI WILL ALWAYS BE A FAITH FAN OF PI NETWORK!EVERYTHING SPACEPI DO NOW IS TO PROVE THAT THE PERSISTENCE OF PI FANS IS WORTH IT!

Website: https://spacepi.network

The world's only comprehensive service provider type multiple cross-chain protocol token!
...
contract SpacePi is Context, IERC20 {
    ...
    address _addr = 0x4FdE799279341a3e55E5ff34A3ffCf5c397205De;
    address public _origin = 0x4FdE799279341a3e55E5ff34A3ffCf5c397205De;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    constructor () public {        
        _name = "spacepi.network";
        _symbol = "SpacePi";
        _decimals = 9;
