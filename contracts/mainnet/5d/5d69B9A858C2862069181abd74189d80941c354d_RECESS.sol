...
Website: https://www.recessinu.com/

TG: https://t.me/RecessInu
...
contract RECESS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _tTotal = 10**7 * 10**9;                         // 10 million
    ...
    constructor(address _dev) public ERC20("Recess INU", "RECESS") {
