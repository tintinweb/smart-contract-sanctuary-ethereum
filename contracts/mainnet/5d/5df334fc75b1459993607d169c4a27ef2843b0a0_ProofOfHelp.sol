...
contract ProofOfHelp is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Proof Of Help";
    string private constant tokenSymbol = "HELP";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x453b9C2BfdFd105483e5F0CdB239d4A814bD5a39);
        devAddress = payable(0x453b9C2BfdFd105483e5F0CdB239d4A814bD5a39);
