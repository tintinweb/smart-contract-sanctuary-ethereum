...
// File contracts/sale/BenjiBananasPassSale.sol
...
/**
 * @title BenjiBananas Membership Pass Sale
 * A FixedPricesSale contract that handles the purchase and delivery of BenjiBananas Membership Pass.
 */
contract BenjiBananasPassSale is FixedPricesSale, Recoverable {
     ...
     * @dev Emits the `MagicValues` event.
     * @dev Emits the `Paused` event.
     * @param membershipPass_ The inventory contract from which the sale supply is attributed from.
