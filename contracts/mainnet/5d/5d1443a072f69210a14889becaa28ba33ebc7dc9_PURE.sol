...
8 888888888o   8 8888      88 8 888888888o.   8 88888888888
8 8888    `88. 8 8888      88 8 8888    `88.  8 8888           
8 8888     `88 8 8888      88 8 8888     `88  8 8888         
8 8888     ,88 8 8888      88 8 8888     ,88  8 88888888888        
8 888888888P'  8 8888      88 8 888888888P'   8 8888         
8 8888         8 8888      88 8 8888`8b       8 8888         
8 8888         ` 8888     ,8P 8 8888 `8b.     8 8888         
8 8888           8888   ,d8P  8 8888   `8b.   8 8888         
8 8888            `8888888P'  8 8888     `88. 8 88888088888 
                                     #        #####  
#      # ###### ######   #  ####     #    #  #     # 
#      # #      #        # #         #    #        # 
#      # #####  #####    #  ####     #    #   #####  
...
"42 is PURE"
"42 is live, the universe and everything."

Announcements: https://t.me/PureToken

TG Official Channel, Twitter and Website will be released at 420k MCAP,
Taxes will be reduced to 4%/2% at 4:20am CST.
Launch tax will be 8/8%
Pure will add all the marketing funds to liquidity Every 42 hours.
...
contract PURE is Context,IERC20, Ownable{
    ...
    string private _name = "PURE";
    string private _symbol = "PURE";
    ...
    address _owner;
    address payable public marketingAddress = payable(0xCA8f085397128A433bc52427E1b530Dfb817Dc23);
    ...
    function PUREDay() public onlyOwner{
         require(block.timestamp > PUREDaycooldown, "You cant call PUREDay more than once per day");
    ...
    function PUREDayOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         PUREDaycooldown = block.timestamp + 86400;
    }
