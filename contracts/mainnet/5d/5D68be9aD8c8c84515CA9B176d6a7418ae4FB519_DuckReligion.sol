...
contract DuckReligion is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("DuckReligion", "DUCK", maxBatchSize_, collectionSize_) {
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xb70097b0fD2A38719e8d0fd95837CC20ebd4faCe);
