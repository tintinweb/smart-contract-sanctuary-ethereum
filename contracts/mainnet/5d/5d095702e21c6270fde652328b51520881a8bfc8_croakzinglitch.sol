...
contract croakzinglitch is ERC721A {
    ...
    constructor() ERC721A("Croakz in Glitch", "GC") {
        owner = msg.sender;
        maxSupply = 3333;
        mintPrice = 0.0012 ether;
        maxPerWallet = 10;
        maxPerTx = 10;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidig7ikmvrkmetiyetcrngm2hyibrk3z2z2o3tgf7xusgg2ait5we/", _toString(tokenId), ".json"));
    }
