...
contract Genghis_Khan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Genghis Khan 2.0";
    string private constant _symbol = "$GKhan";
    ...
    function tradingState() public view returns(bool){
        return tradingOpen;
    }
