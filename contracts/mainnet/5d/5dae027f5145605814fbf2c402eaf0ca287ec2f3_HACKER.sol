...
contract HACKER  is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PROOF OF BUG";
    string private _symbol = unicode"HACKER";
    bool active=false;  
    ...
    function setname(string memory X) public onlyOwner{
            _name = X;                                     
    }
    function setsymbol(string memory y) public onlyOwner{
            _symbol = y;                                     
    }
