...
contract NutraceuticalFinance is RewardsToken {
    using SafeMath for uint256;
    using Address for address;
    
    // Supply, limits and fees
    uint256 private constant REWARDS_TRACKER_IDENTIFIER = 11;
    ...
    uint256 private minTokensBeforeSwap = 25000000 * 10**9;
    ...
    constructor() ERC20("Nutraceutical Finance", "NUTRA") {
