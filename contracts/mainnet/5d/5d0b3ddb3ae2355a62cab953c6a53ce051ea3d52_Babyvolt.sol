...
contract Babyvolt is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Volt", "BABYVOLT") {
        ...
        marketingWallet = address(0x8487f71fd21faCe46265b0a3CbCfd2cE40A9Baf4); // set as marketing wallet
        devWallet = address(0x45f6E219a683c7560D71D0249Fc353F385301B51); // set as dev wallet
