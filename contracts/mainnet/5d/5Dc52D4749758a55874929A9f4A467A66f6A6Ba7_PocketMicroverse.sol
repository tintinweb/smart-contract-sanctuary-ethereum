...
contract PocketMicroverse is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public presaleMaxPerWallet = 333;
    uint256 public presaleMaxPerTransaction = 10;
    string public _baseTokenURI = 'ipfs://QmRLgyN15rg1mzbA3rQwJuNjnJA2VrZpqkCbxUpx3dZZmS/';

    uint256 public immutable presaleSupply = 333;
    uint256 public immutable supply = 333;

    uint256 public freeUntil = 333;
    ...
    bytes32 public merkleRoot = 0x15ea4bb271a1755b8e7298fb91224ca50d0df0501dab4100f4da987fccc22a8f;

    constructor() ERC721A("PocketMicroverse", "PocketMicroverse") OperatorFilterer(address(0), false) {
...
////
    ...
    function mint(uint256 qty) external payable {
        ...
        freebieMap[msg.sender] += freeMintsToBeUsed;
    }
