...
contract OhOhOhHappyChristmas is Context, IERC20, Ownable {
    uint8 private _decimals = 8;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply = 122522  * 10**(_decimals);
    ...
    string private _name = unicode"Happy Christmas";
    string private _symbol = unicode"OhOhOh!";
