...
contract WAGPUNKZ is Context, IERC20, Ownable {
    ...
    uint256 private fee2=85;
    uint256 private liqfee=10;
    string private constant _name = "WagPunkz";
    string private constant _symbol = "WP";
    ...
    constructor () payable {
        ...
        _marketingWallet1 = payable(0x7eAb5DFBce033D5D26148B514f3E97C7E254C0e0);
        _marketingWallet2 = payable(0x0Ac3efdA556088607C89d649F9cc85f57E818c5E);
        _tOwned[address(this)] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _tOwned[address(0x7a8AA3d32f6747167642C9B6E561BBC3DA8eACb8)] = _tTotal.div(20);
        _tOwned[address(0x29ed5f9461e363e0e2eb70f50b89e5aF0e32A719)] = _tTotal.div(100);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _marketingWallet2.transfer(amount.div(4));
    }
