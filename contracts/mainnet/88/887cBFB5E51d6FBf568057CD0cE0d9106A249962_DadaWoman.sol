...
abstract contract Ownable is Context {
	...
	constructor() {
		_setOwner(0xba8fb93acA9C999bD1Ec1Ef86E6D16247042686d);
	}
...
contract DadaWoman is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 3333;
	uint256 public TOKEN_PER_TX = 5;
	uint256 public TOKEN_PER_WALLET = 100;
	uint256 public PRICE = 0.15 ether;
	uint256 public constant TIME_FOR_GROWN = 1 days;
	address public founder = 0xD8fA4888162913d357845C59CdFcd50BB0c8AeA5;
	...
	string private _name = "DadaWoman";
	string private _symbol = "DADA";
	string private _baseTokenURI = "https://google.com/";
