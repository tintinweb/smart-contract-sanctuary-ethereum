...
The 7% initial tax will decrease to 5% before we lock and renounce. Liquidity will be locked for a month, duration will be extended at higher mcap. 
...
contract CZINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CZ Inu ";
    string private constant _symbol = unicode"CZINU";
