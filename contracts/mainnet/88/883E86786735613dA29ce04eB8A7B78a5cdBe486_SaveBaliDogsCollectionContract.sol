...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x6859436f69f247d0024E191af42c716f2A26463E,0xb0Ef28D37EF0fC309E5c9355a3E1A141E86dC174,0x0aba691F74FE2480b967D416ad66877170254c83];
  address public erc20Payable = 0x6859436f69f247d0024E191af42c716f2A26463E;
  uint256[] public payableFees = [2,40,29,29];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaakne3an34vhwi2k4nhhar5n7cqqcplf2fma7vob43ynb4ztjoc4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/e75sxnvBCUGz2X6tL5Rq/contract-metadata";
  }
...
// File: contracts/SaveBaliDogsCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SaveBaliDogsCollectionContract is ERC721APlus {
    constructor() ERC721APlus("Save Bali Dogs Collection", "MIA"){}
}
  /*******************************************************/
  /*                                                     */
