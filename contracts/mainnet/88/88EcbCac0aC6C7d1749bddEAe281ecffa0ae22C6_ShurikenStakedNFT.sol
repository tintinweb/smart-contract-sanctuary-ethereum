...
import './ShurikenStakedMetadata.sol';

contract ShurikenStakedNFT is ERC721A, Ownable, AccessControl {
    using Strings for uint256;
    bytes32 public constant MINTER_ROLE = keccak256('MINTER_ROLE');
    bytes32 public constant BURNER_ROLE = keccak256('BURNER_ROLE');
    ShurikenStakedMetadata public metadata;
    ...
    constructor(
        ShurikenStakedMetadata _metadata,
        string memory _name,
    ...
    function setMetadata(ShurikenStakedMetadata _metadata) external onlyOwner {
        metadata = _metadata;
    }
