...
// File contracts/legendary.nft.sol
//
pragma solidity ^0.8.4;

contract TokyoStory is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor()
  ERC721A("Tokyo Story", "TS")
  {
    maxPerAddressDuringMint = 30;
    maxBatchSize = 10;
    collectionSize = amountForDevs = amountForSaleAndDev = 6000;
    saleConfig.publicPriceWei = 3 ether / 1000;  // 0.003 ETH
