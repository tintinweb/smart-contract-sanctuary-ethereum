...
// File contracts/StorageToken.sol

pragma solidity ^0.8.4;



contract StorageToken is ERC20, ERC20Burnable, AccessControlEnumerable {
  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  bytes32 public constant CONSUMER_ROLE = keccak256("CONSUMER_ROLE");

  constructor() ERC20("Kilobyte", "KB") {
  ...
  function consume(address spender, uint256 amount)
    public
