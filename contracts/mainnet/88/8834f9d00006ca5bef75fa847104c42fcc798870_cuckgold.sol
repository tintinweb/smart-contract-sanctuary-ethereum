...
contract cuckgold is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Cuck Gold";
    string private constant _symbol = "$CUCK Gold";
    ...
    uint256 public _swapTokensAtAmount = 25000000 * 10**_decimals;
