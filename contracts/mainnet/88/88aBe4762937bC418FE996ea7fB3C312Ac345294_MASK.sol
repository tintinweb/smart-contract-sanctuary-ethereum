...
/**
Mask - MASK
The mask itself represents female rage and pain and is demonic, angry, frightening, and dangerous while at the same time tormented, heartbroken, melancholic, and sorrowful. Depending on the angle the physical mask is being held, the expression will seem either angry or sad. 

For Ethereum, MASK is one of its types, it shows up in different styles. MASK are attractive and stylish.

https://t.me/MASK_ETHEREUM
**/
...
contract MASK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mask ";
