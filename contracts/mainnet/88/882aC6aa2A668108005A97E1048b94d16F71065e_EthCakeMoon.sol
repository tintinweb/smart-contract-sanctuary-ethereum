...
contract EthCakeMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "EthCakeMoon";
    string private constant _symbol = "EthMoon";
