 ...
 * allowances. See {IERC20-approve}.
 */
contract Asana is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Asana Token";
    string private _symbol = "ASANA";
    uint8 private _decimals = 9;
    uint256 private _supply = 8000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 120000 * 10**_decimals;
    uint256 public maxWalletAmount = 120000 * 10**_decimals;
    ...
    uint256 private _numTokensSellToAddToLiquidity = 60000 * 10**_decimals;
