...
contract MikotoV2 is IERC20, Auth {
	...
	address payable private _walletDevelopment = payable(0x707f6d0EC0Bdb96EB0fF9177586C7A42eF59C76A); 
	...
	constructor() Auth(msg.sender) {
		...
		_balances[address(this)] =  100_411_280 * (10 ** _decimals);
