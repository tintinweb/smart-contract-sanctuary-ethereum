...
contract WaterToken is StandardToken, SafeMath {

    // metadata
    string  public constant name = "water";
    string  public constant symbol = "water";
    ...
    uint256 public tokenExchangeRate = 10000;             // 625 BILIBILI 兑换 1 ETH
