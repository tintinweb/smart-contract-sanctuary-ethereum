...
contract EAGLECOIN is ERC20, Ownable {
    ...
    uint256 public percentForLPBurn = 5; // 25 = .5%
    ...
    constructor() ERC20("Eagle Coin", "EAGLE") {
        ...
        marketingWallet = address(0x728378953c040a8d1942771AB53545C12e649068); // set as marketing wallet
        devWallet = address(0x728378953c040a8d1942771AB53545C12e649068); // set as dev wallet
