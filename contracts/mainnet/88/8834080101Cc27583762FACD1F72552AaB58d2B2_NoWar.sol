...
contract NoWar is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("NoWar", "NW", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant PRICE = 0 ether; //lzy modifiy price
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xB046f037064b3e9ce3F7B3Ef1AF96E52a0033f0f);
