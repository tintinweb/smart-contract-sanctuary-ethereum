...
contract BABYETH is ERC20, Ownable{
    using Address for address payable;

    uint256 constant DECIMALS = 18;

    uint256 _totalSupply = 500_000_000_000 * (10**DECIMALS);
    ...
    constructor() ERC20("BABYETH", "BABYETH") {
        ...
        maxWalletAmount = 20_000_000_000 * (10**DECIMALS); // 4%
        maxTxAmount = 10_000_000_000 * (10**DECIMALS); // 2%
