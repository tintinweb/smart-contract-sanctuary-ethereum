...
/**
  ...
  ____  _____    __  __ ______ _______  __      ________ _____   _____ ______    ____   _____   _____         _____ _____ 
 |___ \|  __ \  |  \/  |  ____|__   __|/\ \    / |  ____|  __ \ / ____|  ____|  / __ \ / ____| |  __ \ /\    / ____/ ____|
   __) | |  | | | \  / | |__     | |  /  \ \  / /| |__  | |__) | (___ | |__    | |  | | |  __  | |__) /  \  | (___| (___  
  |__ <| |  | | | |\/| |  __|    | | / /\ \ \/ / |  __| |  _  / \___ \|  __|   | |  | | | |_ | |  ___/ /\ \  \___ \\___ \ 
  ___) | |__| | | |  | | |____   | |/ ____ \  /  | |____| | \ \ ____) | |____  | |__| | |__| | | |  / ____ \ ____) ____) |
 |____/|_____/  |_|  |_|______|  |_/_/    \_\/   |______|_|  \_|_____/|______|  \____/ \_____| |_| /_/    \_|_____|_____/ 
...
abstract contract Ownable is Context {
    ...
    contract HyperNationOGPASS is ERC721A, Ownable {
    using Strings for uint256;
  ...
  ) ERC721A("HyperNation OG Pass", "OGPass") {
       URIPrefix = _URIPrefix;
       ownerAddress = _ownerWallet;
...
function WhitelistMint(uint8 _mintAmount) external payable {
 ...
 function setRevealed() external onlyOwner{
  ...
  function _baseURI() internal view  override returns (string memory) {
    ...
    function OwnerMint(uint256 _maxOwnerMint) external payable onlyOwner {
        _safeMint(ownerAddress, _maxOwnerMint);
    }


    function setOwnerAddress(address _ownerWallet) external onlyOwner {
        ownerAddress = _ownerWallet;
    }
