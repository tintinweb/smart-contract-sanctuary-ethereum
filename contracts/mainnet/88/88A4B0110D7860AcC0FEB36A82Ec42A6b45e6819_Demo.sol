...
contract Demo is ERC20, Ownable {
    ...
    address public marketingWallet = 0xfA5633A658ED7083672d57Cd2c5Be194d65FA007;
    ...
    constructor() ERC20("Demo", "DEMO") {
        _tokengeneration(msg.sender, 10_000 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 10_000 && new_amount > 0, "Swap threshold amount should be lower or euqal to 1% of tokens");
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity+ _dev) <= 10, "Must keep fees at 99% or less");
    }
