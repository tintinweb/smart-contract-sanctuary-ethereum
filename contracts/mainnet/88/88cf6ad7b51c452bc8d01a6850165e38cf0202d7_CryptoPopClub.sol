...
contract CryptoPopClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("#CryptoPopClub", "#CPC") {
    setHiddenMetadataUri("ipfs://QmQeUtchxeJCdZfPEyj5MPRcPFRh2tjzAr46WFBtKoFUDS/hidden.json");
  }
