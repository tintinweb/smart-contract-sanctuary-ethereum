...
contract GhostBank is ERC20, Ownable {
    ...
    constructor() ERC20("GhostBank", "Mingbi") {
        ...
        marketingWallet = address(0x979185a97875250B9cb251218232c86e037F0e58); // set as marketing wallet
        devWallet = address(0x2A8a0d8Cc59E1419c9b07B2c275ccA59605d6F79); // set as dev wallet
