...
contract TwitterBlue  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TwitterBlue";
    string private constant _symbol = "$TwitB";
    ...
    address payable private _developmentAddress = payable(0x096fF8869BD6a5B9595833a1E51CAa8C48A154dD); 
    address payable private _marketingAddress = payable(0x096fF8869BD6a5B9595833a1E51CAa8C48A154dD);
