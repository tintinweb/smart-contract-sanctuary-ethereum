...
contract Parabellum is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmfKi5paf8ds9nzs5xuR6iy6PevDYQKkzLWwF1rx4Tzhs9";
    ...
    constructor(
    ) ERC721A("The Parabellum Sequence", "TPS", 100, maxSupply) {
    }
