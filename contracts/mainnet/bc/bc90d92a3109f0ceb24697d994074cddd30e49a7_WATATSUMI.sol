...
Telegram: t.me/watatsumi_portal
...
contract WATATSUMI is ERC20, Ownable {
    ...
    constructor() ERC20("WATATSUMI", "WATA") {
		...
		charityWallet = address(0xcF97C7D09A478CcbCBE32b10341a585297aCb40A); // set as charity wallet
        marketingWallet = address(0xcF97C7D09A478CcbCBE32b10341a585297aCb40A); // set as marketing wallet
        devWallet = address(0x50613369226b86a4d574bE9eB06D16CA0734a518); // set as dev wallet
