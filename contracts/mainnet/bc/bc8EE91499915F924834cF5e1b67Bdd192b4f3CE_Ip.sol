...
contract Ip is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 990000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Ip";
    string private _symbol = "0x24";
    ...
    uint256 public _maxTxAmount = 9900000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 9900000000000000000 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 99000000, "Swap Threshold Amount cannot be less than 69 Million");
