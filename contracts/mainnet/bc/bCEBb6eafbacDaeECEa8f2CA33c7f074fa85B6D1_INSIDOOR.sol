...
Insidoor provides the investor with insight into whether corporate insiders are net buyers or sellers of cryptocurrencies, 
& which groups are participating. Use our custom tailored tools to find the ALPHA anytime and anywhere!

$INSDR combines the best of Blockchain and AI to bring the latest technological advancements to the masses 
in a decentralized and simple way.

Important Links 
Telegram: https://t.me/insidooreth
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract INSIDOOR is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Insidoor", "INSDR") {
