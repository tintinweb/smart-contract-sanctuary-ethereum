...
// .oOOOo.  O       o .oOOOo.  O       o o          `O    Oo    oOoOOoOOo    Oo    `OooOOo.  ooOoOOo 
// o     o  o       O o     o  o       O O           o   o  O       o       o  O    o     `o    O    
// O.       O       o O.       O       o o           O  O    o      o      O    o   O      O    o    
//  `OOoo.  o       o  `OOoo.  o       o O           O oOooOoOo     O     oOooOoOo  o     .O    O    
//       `O o       O       `O o       O o     o     o o      O     o     o      O  OOooOO'     o    
//        o O       O        o O       O O     O     O O      o     O     O      o  o    o      O    
// O.    .O `o     Oo O.    .O `o     Oo `o   O o   O' o      O     O     o      O  O     O     O    
//  `oooO'   `OoooO'O  `oooO'   `OoooO'O  `OoO' `OoO'  O.     O     o'    O.     O  O      o ooOOoOo 

pragma solidity ^0.8.17;
contract Susuwatari is Ownable, ERC721A {
    ...
    uint public costWL = 0.002 ether;
    uint public maxMintPublic = 20; //per wallet
    uint public maxMintWL = 2; //per wallet
    ...
    address t1 = 0xee3ED661a643D49c2A719FDF3BF158398be0A735; 
    address t2 = 0x4B562a0f7cde6b34efDF7d600a1e5E59814F530c; 
    address t3 = 0x16a70db98698b171546E5cC9E0e8B6A775287EC1; 

    constructor() ERC721A("Susuwatari", "SUSU") {}
    ...
    // set revealed status and unrevealed URI
    ...
    function burnSupply(uint256 _newSupply) public onlyOwner {
        require(_newSupply < maxSupply, "Supply can only be decreases");
    ...
    function withdrawAll() public payable onlyOwner {
      ...
      require(payable(t1).send(_share * 15));
      require(payable(t2).send(_share * 65));
      require(payable(t3).send(_share * 20));
    }
