...
contract GraffGrems is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmctsNeZN4XzSYSRzZvVPhU4Mgnqy7LmWLU57RM2znFixD";
  ...
  ) ERC721A("Graff Grems", "Graff Grems") {
