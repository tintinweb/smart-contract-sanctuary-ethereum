...
//https://medium.com/@thesevenwater
...
contract MEIZU is Context, IERC20, Ownable {
    ...
    string private _name = "The Seven of Water";
    string private _symbol = "MEIZU";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xD49dD39b32b4D5Ae6D29FF1d22EF0f97A02f8AA8, 'We can not exclude Uniswap router.');
