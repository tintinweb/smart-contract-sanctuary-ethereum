...
contract Hesoldcoin is Ownable, ERC20 {
    ...
    string constant _name = "He Sold Coin";
    string constant _symbol = "SOLD";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xaC9F05d22Fb4cf2BBd666CB824a725D2f39b43D8;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        _maxWalletToken = (_totalSupply * maxWallPercent ) / 500;
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function setParameters(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator / 1, "Fees can not be more than 1%"); 
        set_fees();
    }
