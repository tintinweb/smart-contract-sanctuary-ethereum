...
HasSecondarySaleFees
{
    ...
    mapping(uint256 => uint256) private nftIpInfos;
    ...
    function mint(address _to, uint256 _tokenId, uint256 _ip) public onlyOwner {
        _mint(_to, _tokenId);
    ...
    function mint(address[] memory _toList, uint256[] memory _tokenIdList, uint256[] memory _ipList) public onlyOwner {
        require(_toList.length == _tokenIdList.length, "input length must be same");
