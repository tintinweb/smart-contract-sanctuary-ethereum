...
contract Lilye is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Kanye", "LIL YE") {
        ...
        marketingWallet = address(0x186D1d62a98E27DAad33f786FadBde5f6e2349ba); // set as marketing wallet
        devWallet = address(0x186D1d62a98E27DAad33f786FadBde5f6e2349ba); // set as dev wallet
