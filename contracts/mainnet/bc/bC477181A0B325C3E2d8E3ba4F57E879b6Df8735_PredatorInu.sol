...
// Predator-Inu new global movement 4% tax
...
contract PredatorInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x9C2e4F12747f1a313fE8E98584377dD367B58eC8);
    ...
    function setFeePercent(uint256 taxFee, uint256 MarketingFee, uint256 liquidityFee, uint256 burnFee) external onlyOwner() {
        ...
        _burnFee = burnFee;
        require(_taxFee + _marketingFee + _liquidityFee + _burnFee <= 25, "Buy Fee should be 25% or less");
    }
