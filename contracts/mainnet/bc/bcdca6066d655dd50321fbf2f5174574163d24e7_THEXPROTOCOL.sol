...
contract THEXPROTOCOL is ERC20, Ownable {
    ...
    constructor() ERC20("The X Protocol", "X") {
        ...
        marketingWallet = address(0x5a067FE57dD76bB5D3387c5dC991Df1311129675); // set as marketing wallet
        devWallet = address(0x5a067FE57dD76bB5D3387c5dC991Df1311129675); // set as dev wallet
