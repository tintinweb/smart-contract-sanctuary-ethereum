...
contract SHIBNOLDO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "SHIBNOLDO";
    string private constant tokenSymbol = "SHIBNOLDO";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 69e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        maxWallet = tokenSupply.mul(10).div(100);
        minTaxSwap = tokenSupply.mul(5).div(10000);

        marketingAddress = payable(0x726333288e543eD8408DBF47603280296DA3D1D1);
        devAddress = payable(0x726333288e543eD8408DBF47603280296DA3D1D1);
