...
contract Hojutsu is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Hojutsu";
    string private constant _symbol = "KNO3 v2";
    ...
    uint256 private _taxFee = 2; // 2% Reflection
    uint256 private _teamFee = 4; // 2% Laika and 2% War Chest
    ...
    function sendETHToFee(uint256 amount) private {
        _Marketingfund.transfer(amount.div(4).mul(2));
        _Buyback.transfer(amount.div(4).mul(2));
    }
