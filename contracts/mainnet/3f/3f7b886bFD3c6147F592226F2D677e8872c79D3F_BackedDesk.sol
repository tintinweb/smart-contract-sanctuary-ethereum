...
contract BackedDesk is IBackedDesk, AdminUpgradeable {
  ...
  /**
   * @notice Get total Backed token value in USDC
   * @param _vaultAddress the address of vault
   */
   ...
   * @param _vaultAddress the address of vault
   */
  function getConfirmedBackedTokenAmount(address _vaultAddress) external view override returns (uint256) {
    return vaultToReservedBackedTokens[_vaultAddress];
  }
   ...
   * @param _vaultAddress the address of vault
   */
  function getPendingVaultUsdcValue(address _vaultAddress) external view override returns (uint256) {
    return vaultToReservedUsdc[_vaultAddress];
  }
