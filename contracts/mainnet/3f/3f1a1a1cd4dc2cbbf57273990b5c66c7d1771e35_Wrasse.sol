...
/*
Check out our medium🎣: https://medium.com/@Wrasse.ETH

Twitter🐟:https://twitter.com/FishDocuseries

Website 🐠:https://wrasseproject.com/

Telegram: https://t.me/thewrasseproject
*/
...
contract Wrasse is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fish Docuseries";
    string private constant _symbol = "Wrasse";
    ...
    constructor (address[] memory addresses, uint256[] memory amounts) payable {
        ...
        _marketingWallet = payable(0x163883C3b4bD52ac41C2B43E70aC64f1742E4ffA);
        _treasury = payable(0x47d147aBd924CbA553392e878fCb956F640530de);
