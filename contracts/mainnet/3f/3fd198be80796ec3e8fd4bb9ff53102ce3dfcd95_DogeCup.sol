...
In anticipation of the upcoming world cup, this will be a Doge world cup spin off
...
contract DogeCup is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Cup";
