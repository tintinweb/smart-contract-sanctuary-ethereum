...
contract NeuralinkBrainChip is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Neuralink Brain Chip";
    string private _symbol = "NBC";
    uint8 private _decimals = 6;
    address payable public Elon;
    ...
    constructor () {
        ...
        Elon = payable(address(0xA925cd2B3A929C5cC83f961295ac770f7E8FEbfa));
        
        _isExcludefromFee[Elon] = true;
