...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x0c23932315004982D988818399911d87cC6FCe50;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6F93a7c210Cf8a471EbBfcd50567470a6b0dD6c6];
    ...
    
{
  constructor(
    ...
    uint256 public MAX_WALLET_MINTS = 444;
...
contract InvisibleFriends is RamppERC721A {
    constructor() RamppERC721A("Invisible Friends 2", "INVISBLE"){}
}