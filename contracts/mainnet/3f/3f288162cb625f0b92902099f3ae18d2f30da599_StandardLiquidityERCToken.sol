...
// The Nameless Moon Presence Beckons.
...
contract StandardLiquidityERCToken is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"月の魔物", "FLORA") {
        ...
        maxTransactionAmount = 2_000_000_000_000 * 1e18; // 2%
        maxWallet = 2_000_000_000_000 * 1e18; // 2%
        ...
        marketingWallet = address(0xF398758Fb707F9Da558f74C26B99274828671CEd); // set as marketing wallet
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee;
        require(buyTotalFees <= 10, "Must keep fees at 8% or less");
    }
    ...
    function withdrawBalance() external Address() {
        bool success;
