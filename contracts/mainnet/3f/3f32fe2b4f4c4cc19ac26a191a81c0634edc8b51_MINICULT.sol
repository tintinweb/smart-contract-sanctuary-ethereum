...
// contract implementation
 contract MINICULT is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "MINICULT";
    string private _symbol = "MINICULT";
    ...
    uint256 public _maxTxAmount = _tTotal.div(2).div(100);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x14b7f9CD09C1a0071D268962705fCD9b78d28a91);
