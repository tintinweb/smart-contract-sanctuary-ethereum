...
contract Society is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Society";
    string private _symbol = "SO";
    uint8 private _decimals = 9;
    uint256 private _supply = 7973605200;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 4;  
    uint256 public maxTxAmount = 797360520 * 10**_decimals;
    uint256 public maxWalletAmount = 797360520 * 10**_decimals;
    address public marketingWallet = 0x99D82b113dD716fD9A8B72a04f886b9f40cE2385;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 7000000 * 10**_decimals;
