...
Telegram: https://t.me/littledrevilerc
...
contract lildevil is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 9_600_000 * 10**_decimals;
    ...
    address public marketingAddress = 0xD4fF2567ae3986bDFE2fcd30E5Afe980bC7c9528;
    address public devAddress = 0x971C9D6D95A5B910831B58172a143dAD936C92cE;

    string private constant _name = "Little Dr Evil";
    string private constant _symbol = "lildevil";
    ...
    // Owner cannot transfer out lildevil from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out lildevil!");
