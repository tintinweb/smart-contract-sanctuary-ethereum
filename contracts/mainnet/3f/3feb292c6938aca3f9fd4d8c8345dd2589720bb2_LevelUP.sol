...
// Website: https://letslevelup.xyz/
// Twitter: https://twitter.com/
// Telegram: https://twitter.com/LevelUP_Degen
...
contract LevelUP is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 6000 * 10**_decimals;
    ...
    address public marketingAddress = 0x439a686D741246441fbd4Ed7F26Af0f537797062;
    address public buybackAddress = 0x439a686D741246441fbd4Ed7F26Af0f537797062;

    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;  //uniswap v2

    string private constant _name = "LevelUP";
    string private constant _symbol = "LevelUP";
    ...
    Taxes public taxes = Taxes(0,0,2,0,2);
