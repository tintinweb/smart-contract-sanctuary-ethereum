...
Website: https://hkdollar.info/
TG: https://t.me/HongKongDollarERC20/
Twitter: https://twitter.com/HongDollarERC20/
...
// File contracts/Hkd.sol

pragma solidity ^0.8.0;


contract Hkd is Ownable, ERC20 {
    bool public limited = true;
    bool public tradingEnabled;
    bool private swapping;
    bool public swapEnabled;

    uint256 public maxHoldingAmount = 14749475000000000000000000000;
    ...
    constructor() ERC20(unicode"HONG KONG DOLLAR", "HKD") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xe7026aE70EeCD2B5bBa044CaFceb967712cD8Bf1);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 589979000000000000000000000000); //589,979,000,000  HKD
    }
