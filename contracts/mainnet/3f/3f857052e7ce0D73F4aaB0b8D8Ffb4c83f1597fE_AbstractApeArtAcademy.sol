...
contract AbstractApeArtAcademy is Ownable, ERC721A, DefaultOperatorFilterer{
    using Strings for uint256;

    string public BASE_URI;
    bool public isPublicMintEnabled = false;
    uint public maxSupply = 10000;
    uint public costPublic = 0.005 ether;
    uint public maxMintPublic = 10;
    uint public freePerWallet = 1;

    mapping(address => uint256) public mintedByAddress;

    address t1 = 0xa5ea1cA85525851a8F6b9cf5c170215eF9f935F4;
    address t2 = 0x7F32Fdb27Af40B85D2291f4Ec9807Ae26932763B;

    address public WL = 0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85; //ENS

    constructor() ERC721A("AbstractApeArtAcademy", "AAAA") {}
    ...
    function modifyWL(address _replaceWL) external onlyOwner {
        WL = _replaceWL;
    }
