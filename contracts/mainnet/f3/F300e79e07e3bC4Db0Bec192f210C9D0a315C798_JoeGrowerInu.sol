...
2% of supply (max wallet) will be airdropped to JoeGrower420.eth. 

TELEGRAM: https://T.me/JoeGrowerInu
*/
...
contract JoeGrowerInu is ERC20, Ownable {
    ...
    constructor() ERC20("Joe Grower Inu", "420") {
        ...
        marketingWallet = address(0xAc06a11bea8506F508fF98c85a70828621900475); // set as marketing wallet
        devWallet = address(0xAc06a11bea8506F508fF98c85a70828621900475); // set as dev wallet
