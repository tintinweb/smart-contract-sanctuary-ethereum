...
contract WVB  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "White Vitalik";
    string private constant _symbol = "WVB";
    ...
    address payable private _developmentAddress = payable(0x583F188CA359DfeF55C626cCF313d5535AE0E75B); 
    address payable private _marketingAddress = payable(0x583F188CA359DfeF55C626cCF313d5535AE0E75B);
