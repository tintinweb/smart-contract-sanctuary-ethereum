...
contract MCCD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mars Cars Chips and Dips";
    string private constant _symbol = "MCCD";
