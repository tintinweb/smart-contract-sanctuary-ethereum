...
contract NELSON is ERC20, Ownable {
    ...
    constructor() ERC20("Nelson Inu", "NELSON") {
        ...
        marketingWallet = address(0xDd050D30386A7797ecD9a53515595C2027274CAe); // set as marketing wallet
        devWallet = address(0x65c5835e0C294bF78900f77Ddc793F52718402C6); // set as dev wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 60, "Must keep fees at 11% or less");
    }
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 60, "Must keep fees at 11% or less");
    }
