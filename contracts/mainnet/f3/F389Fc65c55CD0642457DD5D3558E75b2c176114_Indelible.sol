// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accessory", unicode"Butt", unicode"Ear", unicode"Mouth", unicode"Eyes", unicode"Hats", unicode"Feet", unicode"Body", unicode"Backgrounds"];
        ...
        ContractData public contractData = ContractData(unicode"BananaDickPhunks", unicode"2500 BananaDickPhunks. Phully On-Chain of course. For the culture.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/aeac5034-6bfd-465a-9d09-470f4aa6bff9", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/aeac5034-6bfd-465a-9d09-470f4aa6bff9", "", 500, "0x2B8454f668669c9C888C8346416E10be86BB7620");

        constructor() ERC721A(unicode"BananaDickPhunks", unicode"BDPH") {
            TIERS[0] = [24,39,42,45,55,210,228,373,377,380,727];
TIERS[1] = [18,65,181,254,284,293,371,434,600];
TIERS[2] = [392,2108];
TIERS[3] = [55,82,184,261,300,388,447,783];
TIERS[4] = [25,70,98,99,148,197,209,228,315,318,370,423];
TIERS[5] = [32,83,104,164,167,172,172,225,357,488,536];
TIERS[6] = [19,34,36,56,125,247,306,638,1039];
TIERS[7] = [13,46,241,401,444,626,729];
TIERS[8] = [42,145,173,315,536,559,730];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"BananaDickPhunks #");
