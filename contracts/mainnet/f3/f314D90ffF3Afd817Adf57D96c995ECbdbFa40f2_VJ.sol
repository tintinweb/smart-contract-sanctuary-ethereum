...
/*
Today Vitalik Buterin jeeted lot of tokens ($MOPS, $SHIK,$CULT).

Hence the name Vitalik Jeeterin $VJ.

0% tax and no tokens sent to him (he may dump this too.)
...
contract VJ is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x166Ed5B688476AB42db1ef49E9Ecb5E3D44496CC); 
    address payable private _marketingAddress = payable(0x166Ed5B688476AB42db1ef49E9Ecb5E3D44496CC);
