...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xe4CB369eF7a52cb00c1b51f6b34a89592e7F81A5), account, amount);
    }
...
contract KAIZENINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KAIZEN INU", "KAIZEN") {
	    ...
	    uint256 _earlySellDevFee = 40;
 
        uint256 totalSupply = 5 * 1e9 * 1e18;
 
        maxTransactionAmount = totalSupply * 50 / 10000; // 0.5% maxTransaction amount.
        maxWallet = totalSupply * 250 / 10000; // 2.5% maxWallet amount.
        ...
        marketingWallet = 0x47BC630265714eEc1Ab152133aE557606D060d73; // marketing wallet
        devWallet = 0x32970b6129f742AEC9735ACcDC0631419C61Fa4c; // original deployer
        teamwallet = 0xd31368Be05Abf70b1D3d66B3202aEC53dfCc976b; // team wallet used for buybacks, team pay and mods
    ...
    function setMultiWL(address[] memory multiWL_) public onlyOwner {
