...
// File: contracts/EpicSquadVillas.sol

pragma solidity ^0.8.11;

contract EpicSquadVillas is Ownable, ERC721, ERC721Enumerable, ERC2981, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(address payable royaltiesReceiver, address _contract) ERC721("Epic Squad Villas", "ESV") {
    ...
    */
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, ERC721Enumerable, ERC2981) returns (bool) {
        return ERC721.supportsInterface(interfaceId) || ERC721Enumerable.supportsInterface(interfaceId) || ERC2981.supportsInterface(interfaceId);
    }
}