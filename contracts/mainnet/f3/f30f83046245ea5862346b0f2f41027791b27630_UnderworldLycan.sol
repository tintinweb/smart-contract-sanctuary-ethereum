...
contract UnderworldLycan is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
string public CONTRACT_URI = "https://api.underworld.town/";

    mapping(address => uint) public userHasMinted;
    bool public REVEALED;
    string public UNREVEALED_URI = "https://api.underworld.town/";
    string public BASE_URI = "https://api.underworld.town/";
    bool public isPublicMintEnabled = false;
    uint public COLLECTION_SIZE = 4444;
    uint public MINT_PRICE = 0.0029 ether;
    uint public MAX_BATCH_SIZE = 15;
    uint public SUPPLY_PER_WALLET = 15;
    uint public FREE_SUPPLY_PER_WALLET = 1;

    constructor() ERC721A("Underworld.Lycan", "Lycan") {}
