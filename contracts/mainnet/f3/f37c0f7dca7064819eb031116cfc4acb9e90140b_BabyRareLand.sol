...
contract BabyRareLand is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3333;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmTewJfoJjKf412M8Xhvm1ocKSuPU7EL8ChBqpoYzvJnSP/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("BabyRareLand", "BRL", MAX_MINTS, MAX_SUPPLY) {  
    }
