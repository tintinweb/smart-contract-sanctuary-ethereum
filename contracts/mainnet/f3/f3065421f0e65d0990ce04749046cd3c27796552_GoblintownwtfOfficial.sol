...
//
/*
This one is for the people. WAGMI;
- There won't be any Telegram created for this token, since the main goal is to gift this project to the community
...
- Taxes, 2% in (Dev), 2% out(Liquidity), for the community!
...
contract GoblintownwtfOfficial is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GoblintownwtfOfficial", "GTWTF") {
        ...
        marketingWallet = payable(0x15a1E8D1B18d1B886559c8CA2541F46CAaBb9082);
        devWallet = payable(0x15a1E8D1B18d1B886559c8CA2541F46CAaBb9082);
