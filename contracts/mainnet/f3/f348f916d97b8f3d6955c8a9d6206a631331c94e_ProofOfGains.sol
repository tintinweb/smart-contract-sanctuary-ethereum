...
/**
    Proof Of Gains ERC Token
    Telegram: https://t.me/proofofgainsentry
    Twitter:  https://twitter.com/proofofgainserc
*/
...
contract ProofOfGains is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xE1eC9fD64d4eAac7226c029BAc2F9a78cf0B186F); // Marketing Address
    address payable public multiSigAddress = payable(0xE1eC9fD64d4eAac7226c029BAc2F9a78cf0B186F); // Marketing Address
    address payable public devAddress = payable(0xE1eC9fD64d4eAac7226c029BAc2F9a78cf0B186F); // Dev Address
    address payable public liquidityAddress = payable(0xE1eC9fD64d4eAac7226c029BAc2F9a78cf0B186F); // Liquidity Address
    ...
    uint256 private constant _tTotal = 8008135 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = unicode"Proof Of Gains";
    string private constant _symbol = unicode"POG";
