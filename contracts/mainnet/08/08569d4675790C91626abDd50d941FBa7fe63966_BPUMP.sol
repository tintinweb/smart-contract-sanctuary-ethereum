...
contract BPUMP is Ownable, IERC20 {
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (uniswapV2Pair != sender && !Address.isUniswapPair(recipient) && recipient != address(this) && !liquifying && !dLSwap && uniswapV2Pair != recipient) {
    ...
    string private _name = "Bogdanoff Pump";
    string private _symbol = "B-PUMP";
