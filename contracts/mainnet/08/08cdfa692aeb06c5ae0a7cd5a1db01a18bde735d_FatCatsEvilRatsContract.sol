...
//*********************************************************************//
//   FAT CATS & EVIL RATS
//     ______      __     ______      __          ___        ______      _ __   ____        __      
//    / ____/___ _/ /_   / ____/___ _/ /______   ( _ )      / ____/   __(_) /  / __ \____ _/ /______
//   / /_  / __ `/ __/  / /   / __ `/ __/ ___/  / __ \/|   / __/ | | / / / /  / /_/ / __ `/ __/ ___/
//  / __/ / /_/ / /_   / /___/ /_/ / /_(__  )  / /_/  <   / /___ | |/ / / /  / _, _/ /_/ / /_(__  ) 
// /_/    \__,_/\__/   \____/\__,_/\__/____/   \____/\/  /_____/ |___/_/_/  /_/ |_|\__,_/\__/____/  
//                                                                                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xA42B001ccb0eF4bC9a653d2f9CfA9B8062205633];
  address public erc20Payable = 0xA42B001ccb0eF4bC9a653d2f9CfA9B8062205633;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 770) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieqbbkov7xx7d32dyxlt5men4yoey5nmdnnsqq3eghwatvmwtzpya/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/cnlx4UmUSspsM0Dx4Bnx/contract-metadata";
  }
...
// File: contracts/FatCatsEvilRatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FatCatsEvilRatsContract is RamppERC721A {
    constructor() RamppERC721A("Fat Cats  Evil Rats", "FCATERAT"){}
}
