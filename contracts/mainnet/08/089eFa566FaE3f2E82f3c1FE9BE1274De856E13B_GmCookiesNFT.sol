...
*/    
contract GmCookiesNFT is Ownable, ERC721AQueryable, ReentrancyGuard {
    constructor() ERC721A("Gm Cookies!", "GmCookies") {
        BASE_URI = "https://meta.gmcookies.xyz/";
        // mint first with owner to make it easy to initialize marketplace
        _safeMint(owner(), 1);
    }
    ...
    mapping(address => bool) public burnPass;
    ...
    function setBurnPass(address _addr, bool pass) public onlyOwner {
        burnPass[_addr] = pass;
    }

    function burn(uint256 tokenId, address _user) external {
        require(_msgSender() == owner() || burnPass[_msgSender()], "gm cookies error:user or contract shall not pass");
