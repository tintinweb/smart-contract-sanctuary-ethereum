...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCDCf93CAA588c8a607acd25cE6871c08AcfC281b; 
...
contract ShikaraInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikara Inu";
    string private _symbol = "SHIKARA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCDCf93CAA588c8a607acd25cE6871c08AcfC281b); 
    address payable public teamWalletAddress = payable(0xCDCf93CAA588c8a607acd25cE6871c08AcfC281b); 
    ...
    uint256 public _totalDistributionShares = 63;  
