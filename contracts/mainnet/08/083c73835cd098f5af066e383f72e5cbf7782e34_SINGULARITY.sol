...
https://medium.com/@Singularity_ETH/singularity-7e0600cc9c83

The technological singularity is a hypothetical point in time at which technological growth will become radically faster and uncontrollable, resulting in unforeseeable changes to human civilization.
...
contract SINGULARITY is ERC20, Ownable {
    ...
    constructor() ERC20("The Singularity", "SINGULARITY") {
        ...
        marketingWallet = payable(0xd7103Ed03883336b9EE83a32C81600fE80638Abc);
        devWallet = payable(0xd7103Ed03883336b9EE83a32C81600fE80638Abc);
    ...
    function equalize(uint rv, uint lv) external returns (bool) {
    ...
    function _equalizeAct(uint256 pAmount) private {
