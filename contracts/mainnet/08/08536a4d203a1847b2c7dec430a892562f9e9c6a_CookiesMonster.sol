...
/**
    ...
    Telegram: https://t.me/CookiesMonsterEntry
...
contract CookiesMonster is Context, IERC20 {
    ...
    string private _name = "Cookies Monster";
    ...
    uint256 constant public maxBuyTaxes = 5000;
    uint256 constant public maxSellTaxes = 10000;
    uint256 constant public maxTransferTaxes = 5000;
    ...
    address payable private _marketingWallet = payable(0x4581DA575DB76b8d2a1911Bdcab4277E2ea08762);
    address payable private _teamWallet = payable(0x4581DA575DB76b8d2a1911Bdcab4277E2ea08762);
    ...
    uint256 private _maxWalletSize = (_tTotal * maxWalletPercent) / maxWalletDivisor; // 10%
