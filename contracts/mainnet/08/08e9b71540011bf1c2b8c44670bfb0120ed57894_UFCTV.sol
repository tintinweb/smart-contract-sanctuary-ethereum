...
contract UFCTV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xF5fCF23D2A549a5A31c8833B38C5c7551C911E36); // Marketing Address
    address payable public multiSigAddress = payable(0x49C2F033FAE70aFf96dE4ee3610731cE3b596fB1); // Multisig Address
    address payable public devAddress = payable(0x2D6E51355D51B7BEb8Ab1f873f666CB5158efe1a); // Dev Address
    address payable public liquidityAddress = payable(0x49C2F033FAE70aFf96dE4ee3610731cE3b596fB1); // Liquidity Address
    ...
    string private constant _name = unicode"UFC TV";
    string private constant _symbol = unicode"UFCTV";
