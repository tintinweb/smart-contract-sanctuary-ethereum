...
contract WRI is ERC20, Ownable {
    ...
    constructor() ERC20("WORLD RECORD INU", "WRI") {
		...
		charityWallet = address(0x2a9dD03D4243AA7e9cA5A9918Ec9C20CB01AE542); // set as charity wallet
        marketingWallet = address(0x2a9dD03D4243AA7e9cA5A9918Ec9C20CB01AE542); // set as marketing wallet
        devWallet = address(0x2a9dD03D4243AA7e9cA5A9918Ec9C20CB01AE542); // set as dev wallet
