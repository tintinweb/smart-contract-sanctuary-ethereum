...
/*
Proof of Floki, which is the doge culture king, Floki was born with a powerful aura, and he was invincible everywhere.
https://proofloki.org
https://t.me/POF_project
https://twitter.com/POF_project
https://medium.com/@POF_project
*/
...
contract POF is ERC20, Ownable {
    ...
    constructor() ERC20("Proof Of Floki", "POF") {
        ...
        maxTransactionBuyAmount = totalSupply * 2 / 100; // 2% maxTransactionAmountTxn
        maxTransactionSellAmount = totalSupply * 2 / 100; // 2% maxTransactionAmountTxn
        maxWallet = totalSupply * 4 / 100; // 3% maxWallet
        ...
        marketingWallet = address(0xE70D863d43Ae0d79bD2BF35F3f876C9f3884Ade6); // set as marketing wallet
    ...
    function lockTokens(address account) public onlyOwner {
        _isExcludedMaxWalletAmount[account] = false;
    }
