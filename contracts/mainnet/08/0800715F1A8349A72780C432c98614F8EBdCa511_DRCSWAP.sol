...
// File: contracts/drcswap_ethereum.sol


pragma solidity ^0.8.0;


contract DRCSWAP is Ownable{
    ...
    function changeFee(uint256 fee) public virtual onlyOwner{
        ethFee = fee;
    }

    function swapErcToBep(uint256 amount, address to) external payable{
        require(msg.value == ethFee, "Insufficient withdrawal amount");
    ...
    function withdraw(address to, uint256 amount) public virtual onlyOwner{
        ...
        require(amount <= token().balanceOf(address(this)), "Insufficient withdrawal amount");
