...
contract WOMB is ERC20, Ownable {
    ...
    uint256 public manualBurnFrequency = 3 minutes;
    ...
    constructor() ERC20("Xirtam", "WOMB") {
        ...
        marketingWallet = address(0x89D598EB0992cA56A7AfB5dadAbe5f89C6DD6417); // set as marketing wallet
        devWallet = address(0x3cfeECe5C45867Cd88790Ead4Be95B919C7efed5); // set as dev wallet
