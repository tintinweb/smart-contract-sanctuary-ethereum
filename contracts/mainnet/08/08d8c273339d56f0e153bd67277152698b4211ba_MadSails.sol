...
contract MadSails is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6000;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmdFh349iKeBLRj21PqkGvw4S9Y4gPhJtPb3UFCpaSpJU4/";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("Mad Sails", "MADSAILS", MAX_MINTS, MAX_SUPPLY) {  
    }
