...
contract Nakamoto is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x65C31B63CE8249C73EA16895a8CebAa69F2fc7DC); 
    address payable private _marketingAddress = payable(0x65C31B63CE8249C73EA16895a8CebAa69F2fc7DC);
