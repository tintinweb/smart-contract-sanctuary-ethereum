...
contract SafeMoonPepe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SafemoonPepe","SFPEPE")  {
        
        address newOwner = address(0xC8d8C49B49bcA6C4185a6Ef2D415Bcd05Add9b6C);
    
        uint256 totalSupply = 420689899999998 * 10**18;
        
        maxTransactionAmount = totalSupply * 2 / 100;
        swapTokensAtAmount = totalSupply / 1000;
        maxWallet = totalSupply * 6 / 100;
    	...
    	marketingWallet = address(0xC8d8C49B49bcA6C4185a6Ef2D415Bcd05Add9b6C); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xC8d8C49B49bcA6C4185a6Ef2D415Bcd05Add9b6C),
            block.timestamp
        );
