...
/**
 ...
 I'm not writing a medium. 

But: A system that utilizes smart liquidity is superior.
...
contract PoolofWealth is ERC20, Ownable {

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    uint256 public liquidityFee = 400; // 4%
    uint256 public devFee = 0; // 0%
    uint256 public burnFee = 0; // 0%

    uint256 public maxTransactionAmount = 30000000 * (10**18);
    uint256 public swapTokensAtAmount = 18000000 * (10**18);
    uint256 public maxWalletToken = 30000000 * (10**18);
 
    address payable private devWallet = payable(0x7De9266C5262135C02c11cF1D17a67e31B5A1e04);
    ...
    constructor() ERC20("Pool of Wealth", "PoW") {
        ...
        */
        _createInitialSupply(owner(), 1900000000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to] &&(from==uniswapV2Pair || to==uniswapV2Pair)) {
            uint256 swapableFees = amount*(devFee+liquidityFee)/10000;
            uint256 burnShare = amount*burnFee/10000;
            ...
            amount = amount-(swapableFees+burnShare);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokens = contractTokenBalance*liquidityFee/10000;
        uint256 devTokens = contractTokenBalance*devFee/10000;
    ...
    function updateFees(uint256 _liqFee, uint256 _devFee, uint256 _burnFee) public onlyOwner() {
        require(_liqFee+_devFee+_burnFee <= 1000, "tax too high");
