 ...
 */
contract JDFWSP is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    string private baseURI = "https://jdfwsp.mypinata.cloud/ipfs/";
    ...
    constructor() ERC721("jdfwsp.io", "JDFWSP") {
        fees.whitelistMintFee = 0.00066 ether; // 0.066
        fees.mintFee = 0.001 ether;   // 0.1
        fees.attackFee = 0.00007 ether; //0.007
        fees.defendFee = 0.00014 ether; //0.014
        fees.trainFee = 0.00007 ether;  //0.007
    }
...
// ----------------------------------------------------------------------------- ON-RAMP FUNCTIONS
    ...
    function mintBuccaneer() external onlyIndividual payable {
        require(_tokenIds < 12, "All buccaneers have been minted");
        bool wl = false;
...
// ----------------------------------------------------------------------------- GAMEPLAY FUNCTIONS
    ...
    function attackBuccaneer(uint16 attacker, uint16 defender) external onlyIndividual payable gameStatus {
        require(msg.value >= fees.attackFee, "You must pay 0.00007 ether to attack another buccaneer");
    ...
    function defendBuccaneer(
        ...
        require(msg.value >= fees.defendFee, "You must pay 0.00014 ether to defend your buccaneer");
    ...
    function trainBuccaneer(uint16 trainee) external onlyIndividual payable gameStatus {
        require(msg.value >= fees.trainFee, "You must pay 0.00007 ether to train your buccaneer");
        refundIfOver(fees.defendFee);
