...
contract WingedLegions is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmeEUqqZFAcyVjfgqKbvspqTUgKtfVbgyA7sddfcwhBqJx/";
    uint256 public constant MAX_MINT_PER_ADDR = 4;
    uint256 public constant MAX_FREE_MINT_PER_ADDR = 1;
    uint256 public PUBLIC_PRICE = 0.002 * 10**18;
    ...
    constructor(string memory initBaseURI) ERC721A("Winged Legions", "WL") {
        baseURI = initBaseURI;
