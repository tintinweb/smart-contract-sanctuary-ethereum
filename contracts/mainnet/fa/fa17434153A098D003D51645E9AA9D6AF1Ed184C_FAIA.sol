...
/**
*/
// https://t.me/FairCoin_Eth
// https://twitter.com/FairCoin_ETH
...
contract FAIA is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Fair Coin";
    string private constant _symbol = "FAIA";
    ...
    uint256 private constant _tTotal = 999444444444444 * 10**_decimals;
    ...
    constructor () {
        ...
        _mktWallet = payable(_msgSender());
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_mktWallet] = true;
    ...
    function removeMax() external onlyOwner {
