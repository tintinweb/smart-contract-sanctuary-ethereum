...
contract BMC is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_MINTS = 10;
    string public baseURI = "ipfs://QmZDc41FwG3TxvVekX3kDNAExNYNvmcJiTDH4M7wsFTEKC/";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("BMC (Blockchain Mining Company)", "BMC", MAX_MINTS, MAX_SUPPLY) {  
    }
