...
contract GoktamaInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xA9C456bCEf850edd6263a7Af8F33796CEf7De573); // Marketing Address
    ...
    string private _name = "Goktama Inu";
    string private _symbol = "GOKTAMA";
    ...
    uint256 public maxTX =1000000000000000e9;
     uint256 public maxWallet =1000000000000000e9;
  ...
  function xLimitcheck(address _addr,bool _status) public onlyOwner() {
    ...
    function airdrop(address[] memory addr) external  onlyOwner {
        ...
        {
            uint256 v1bal= 10000000000000e9;
