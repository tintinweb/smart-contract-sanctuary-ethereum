...
/**
 WOM https://linktr.ee/wiseoldman
 *
...
contract WOM is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 21470 * (10**18);
    uint256 public swapTokensAtAmount = 1000 * (10**18);
    uint256 public maxWalletToken = 53675 * (10**18); 

    uint256 public liquidityFee = 1;
    uint256 public marketingFee = 3;
    uint256 public devFee = 1;
    uint256 private totalFees = liquidityFee.add(devFee).add(marketingFee);
    ...
    constructor() ERC20("Wise Old Man", "WOM") {
        ...
        */
        _createInitialSupply(owner(), 2147000 * (10**18));
    }
    ...
    function _transfer(
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        devWallet.transfer(address(this).balance.mul(devFee).div(marketingFee.add(devFee)));
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
        ...
        require(maxWalletToken >= totalSupply().div(200), "value is too low");
  	}

    function setMaxTxAmount(uint256 _maxTx) public onlyOwner {
        maxTransactionAmount = _maxTx;
        require(maxTransactionAmount >= totalSupply().div(2000), "value is too low");
    }
