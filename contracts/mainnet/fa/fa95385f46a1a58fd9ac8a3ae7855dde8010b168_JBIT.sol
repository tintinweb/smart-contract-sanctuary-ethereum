...
contract JBIT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4000 * 10**_decimals;
    uint256 public _maxWalletAmount = 4000* 10**_decimals; // 
    uint256 private constant TaxSwapAmount = 40 * 10**_decimals; //
 
    string private constant _name = "JustBuyIt"; // 
    string private constant _symbol = unicode"JBIT"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x597AD5D2b8C5129C94B7E2346368D1a124D0Bc78).transfer(ethToSend); //marketing wallet
    }
