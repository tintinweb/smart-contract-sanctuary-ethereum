...
contract TAU is ERC20, Ownable {
    ...
    constructor() ERC20("Automata", "TAU") {
        ...
        marketingWallet = address(0x618A2b25E1CC72B7201F8eC538e391FB5A2D87CA); // set as marketing wallet
        devWallet = address(0x618A2b25E1CC72B7201F8eC538e391FB5A2D87CA); // set as dev wallet
