...
contract WittyAI is ERC20, Ownable {
    ...
    constructor() ERC20("Witty.ai", unicode"WITTYAI") {
        ...
        devWallet = address(0xbb23852DC36a6a8B4edf6107b1c396525C9DDA2A); // set as dev wallet
