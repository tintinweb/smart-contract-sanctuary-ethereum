...
Telegram: https://t.me/boredapepirateclub
...
contract BoredApePirateClub is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.005 ether;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public maxFreeMint = 2;
    uint256 public cap = 2000;
    ...
    constructor() ERC721A("Bored Ape Pirate Club", "BAPC", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function Mint(uint256 numTokens) public payable {
        ...
        if (freeMintCount < maxFreeMint) {
      if (numTokens > maxFreeMint-freeMintCount) {
        payForCount = numTokens - maxFreeMint + freeMintCount;
      } else {
        payForCount = 0;
      }

      _freeMintedCount[msg.sender] = freeMintCount + numTokens - payForCount;
    }
    require(msg.value >= payForCount * NFT_PRICE, "Invalid funds provided");
    ...
    function setRound(uint256 newPrice, uint256 _cap) public onlyOwner {
        NFT_PRICE = newPrice;
        cap = _cap;
    }
