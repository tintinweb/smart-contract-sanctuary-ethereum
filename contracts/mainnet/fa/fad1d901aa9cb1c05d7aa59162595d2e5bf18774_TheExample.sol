...
contract TheExample is ERC20, Ownable {
    ...
    constructor() payable ERC20("The Example", "THEEXAMPLE") {
        ...
        marketingAddress = address(0x4Bea81D285808382306D501348210C1810E59e17);
        ...
        _createInitialSupply(address(0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045), (totalSupply * 10) / 100); // VITALIK
