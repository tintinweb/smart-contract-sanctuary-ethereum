...
/* Twitter:
https://twitter.com/FFIProject

Telegram:
https://t.me/ForbiddenFruitInu
*/
...
contract ForbiddenFruit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Forbidden Fruit Inu";
    ...
    address payable private _marketingAddress = payable(0x998D24b13f181e77239E468F9672099A23550B7a);
    address payable private _devAddress = payable(0x998D24b13f181e77239E468F9672099A23550B7a);
    ...
    function sendETHToFee(uint256 amount) private {
        _devAddress.transfer((amount).div(3).mul(2));
