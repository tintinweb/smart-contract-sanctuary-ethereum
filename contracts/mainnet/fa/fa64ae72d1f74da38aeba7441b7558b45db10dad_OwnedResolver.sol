...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an HI node.
...
abstract contract AddrResolver is IAddrResolver, IAddressResolver, ResolverBase {
    ...
    /**
     * Sets the address associated with an HI node.
     * May only be called by the owner of that node in the HI registry.
     * @param node The node to update.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an HI node.
     * May only be called by the owner of that node in the HI registry.
     * @param node The node to update.
...
abstract contract DNSResolver is IDNSRecordResolver, IDNSZoneResolver, ResolverBase {
     ...
     * other to hi ure the data is updated correctly. For example, if the data
     * was supplied:
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an HI node, for reverse records.
     * May only be called by the owner of that node in the HI registry.
     * @param node The node to update.
     */
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an HI node.
     * @param node The HI node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an HI node and key.
     * May only be called by the owner of that node in the HI registry.
     * @param node The node to update.
