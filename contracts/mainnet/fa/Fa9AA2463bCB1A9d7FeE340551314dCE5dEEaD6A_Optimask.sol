...
// Main Contract Logic 
// --------------------------------------------------------------
contract Optimask  is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Optimus Mask";
    string private _symbol = "OptiMask";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x05Cc3d31b8CAd20333BE7ddeCe2bF68Bf9f5FE36);
    address payable public operationsWallet =  payable(0x05Cc3d31b8CAd20333BE7ddeCe2bF68Bf9f5FE36);
