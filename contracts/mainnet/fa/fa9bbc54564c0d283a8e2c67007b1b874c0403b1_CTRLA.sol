...
The only way to accomplish this is when you Control All.

twitter.com/CTRLALLETH
https://t.me/CTRLAportal
https://medium.com/@ctrlalleth/control-all-all-ccea63373a42?postPublishedType=initial
...
contract CTRLA is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 1248163264128 * 10**8;
    ...
    string private constant _name = "CTRL-A";
