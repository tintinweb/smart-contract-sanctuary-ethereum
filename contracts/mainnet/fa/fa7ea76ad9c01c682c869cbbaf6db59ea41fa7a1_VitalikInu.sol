...
contract VitalikInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Vitalik Inu";
    string private constant _symbol = "VI";
    ...
    address payable private _devAddress1 = payable(0x6Fb9Dfe0A91C49F9Ab6071560dE0fc3B1E66A402);
    address payable private _devAddress2 = payable(0xE1d1b7baE3d0f9486AeCbB684671d7C996297F42);
    ...
    function setMaxLimits(uint256 maxTxAmount,uint256 maxWalletSize) public onlyOwner {
