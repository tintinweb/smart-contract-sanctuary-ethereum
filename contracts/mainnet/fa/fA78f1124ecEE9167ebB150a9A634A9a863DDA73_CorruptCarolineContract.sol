...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9970865762b5266DEf5b242174452037c71e01A8];
  address public erc20Payable = 0x9970865762b5266DEf5b242174452037c71e01A8;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 6969) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibcq7fqpt52k5j73mccbm6qyvztg4f6uryhjvrcpyc4ovylkuni4e/";
...
// File: contracts/CorruptCarolineContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CorruptCarolineContract is RamppERC721A {
    constructor() RamppERC721A("Corrupt Caroline", "CARO"){}
}
