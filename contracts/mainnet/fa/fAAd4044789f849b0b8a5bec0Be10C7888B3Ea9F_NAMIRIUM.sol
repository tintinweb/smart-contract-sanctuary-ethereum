...
contract NAMIRIUM is ERC20, Ownable {
    ...
    constructor() ERC20("NAMIRIUM", "NAMI") {
        ...
        // launch buy fees
        uint256 _buyMarkFee = 4;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevFee = 2;
        uint256 _buyOperationsFee = 4;
        
        // launch sell fees
        uint256 _sellMarkFee = 17;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 6;
        uint256 _sellOperationsFee = 17;

        uint256 totalSupply = 1_000_000 * 1e18;

        maxTransactionAmount = 10_000 * 1e18; // 1% max txn at launch
        ...
        mktWallet = address(0xaa41fEca896B619671dFD29203A95Be21CfB4168); 
        devWallet = address(0xCB76602d6180e1882eB1Ea05473b334591771A00); 
        liqWallet = address(0xCB76602d6180e1882eB1Ea05473b334591771A00); 
        operationsWallet = address(0xd840E65e57FC415FAE566ce188FB5ff97feea20b);
