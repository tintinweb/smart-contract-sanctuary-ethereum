...
contract ChainStrike is ERC20, Ownable {
    ...
    constructor() ERC20("ChainStrike", "CS") {
        ...
        marketingWallet = address(0xd3cB00781cd32E4b3Bc919A60F1dadEA4CBA2ffA); // set as marketing wallet
        devWallet = address(0x96c2735C621f207dc36bd59062932eaDEA2576C5); // set as dev wallet
