...
contract JesuChristo is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Jesu Christo";
    string private constant _symbol = "JESU";
    ...
    address payable private _developmentAddress = payable(0xfBe28AD606F72BC83EbA51934f1137B1F1de8A83); 
    address payable private _marketingAddress = payable(0xfBe28AD606F72BC83EbA51934f1137B1F1de8A83);
