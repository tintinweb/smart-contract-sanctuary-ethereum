...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xd637528F2924F1373DB3E3Ee8d16D2344f45573E];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xd637528F2924F1373DB3E3Ee8d16D2344f45573E;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 400;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 700) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmRPSoPdS77AMi2TVgKzUYwkinNTWCDpvC1qCtHCz4BBab/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 700");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 700");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 700");
...
// File: contracts/ManiaverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ManiaverseContract is RamppERC721A {
    constructor() RamppERC721A("Maniaverse", "Maniaverse"){}
}
