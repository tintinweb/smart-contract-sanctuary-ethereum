...
contract TISM is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private maxBuyLimit = 15000000000 * (10**18);
    uint256 public maxWallet = _tTotal.div(10000).mul(50);

    string private _name = "Teh Tism";
    ...
    function setChromosomeEnabled(bool _enabled) public onlyOwner() {
        trading = _enabled;
    }
