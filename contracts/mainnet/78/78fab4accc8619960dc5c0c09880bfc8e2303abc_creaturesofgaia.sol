...
// File: contracts/creaturesofgaia.sol
...
contract creaturesofgaia is ERC721A, Ownable {

    string public baseURI = "ipfs://QmcjtWpk66wjcSs39bHxXf7ifKqiN74UkPqb1ng1uZymxh/";
    ...
    constructor() ERC721A("Creatures Of Gaia ", "GAIA") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount + ownerTokenCount <= MAX_PER_WALLET, "Exceeds max token count per wallet");
