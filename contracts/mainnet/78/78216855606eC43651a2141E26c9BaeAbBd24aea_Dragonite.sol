...
https://t.me/DragoniteErcportal

https://twitter.com/ErcDragonite
...
contract Dragonite is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Dragonite';
    string private constant _symbol = 'GEN-I';
    ...
    address internal constant development_receiver = 0xc1812Abc1eEF85dE3ECBe17C8De441B1e7A72586; 
    address internal constant marketing_receiver = 0x293e3413647Aa267939F5317130c027a18468095;
    address internal constant liquidity_receiver = 0xc1812Abc1eEF85dE3ECBe17C8De441B1e7A72586;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        uint256 _denominator = (liquidityFee.add(1).add(marketingFee).add(developmentFee)).mul(3);
