...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5DE987dE10E0f93AD97D65C583B296A58c2fcCC8];
  address public erc20Payable = 0x5DE987dE10E0f93AD97D65C583B296A58c2fcCC8;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 0.021 ether;
  uint256 public EARLY_MINT_PRICE = 0.01666 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 3666) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.cryptodevilhell.club/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hHCqnpAFmbeYg3yFSjAM/contract-metadata";
  }
...
// File: contracts/CryptoDevilHellClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoDevilHellClubContract is RamppERC721A {
    constructor() RamppERC721A("Crypto Devil Hell Club", "DEVIL"){}
}