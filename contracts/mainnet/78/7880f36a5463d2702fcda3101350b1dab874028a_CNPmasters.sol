...
/**
0.001 each max 5 per txn, Instant reveal
*/
...
contract CNPmasters is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("CNP Masters", "CNPM") {
