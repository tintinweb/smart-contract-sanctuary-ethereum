...
Molly’s Journey is a Project that has been created to bring more awareness to how the drug can be used to benefit society as a whole.

We will be building a Journal to show different peoples experiences with the drug, used recreationally and medically, as well as funding research to bring more evidence into the drug.

https://t.me/IntoMollysJourney
...
contract MDMA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Molly's Journey";
