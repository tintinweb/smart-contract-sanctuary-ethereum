...
contract MarketConditions is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Market Conditions", "MCON") {
        ...
        maxWallet = totalSupply * 3 / 100; // No Max Wallet On Launch
        ...
        marketingWallet = address(0xBf5651EEc85122DA1915eDcB8dE9F0b533D97499); // set as marketing wallet
        devWallet = address(0xBf5651EEc85122DA1915eDcB8dE9F0b533D97499); // set as dev wallet
