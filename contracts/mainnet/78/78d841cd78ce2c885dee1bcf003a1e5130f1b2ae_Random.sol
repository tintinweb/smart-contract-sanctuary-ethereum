...
// IPFS URL: https://gateway.pinata.cloud/ipfs/Qmb23cJzP7xdwfFVioqJQLoAWp1PeMK8cXciPzRAPuqr68
    ...
    ConfirmedOwner
{
    ...
    event LuckyNumberGenerated(uint256 luckynumber);
    ...
    constructor(uint256 number_of_winners)
    ...
    function fulfillRandomWords(
        ...
        lucky = (_randomWords[0] % winners) + 1;

        s_requests[_requestId].fulfilled = true;
        s_requests[_requestId].randomWords = _randomWords;
        emit LuckyNumberGenerated(lucky);
