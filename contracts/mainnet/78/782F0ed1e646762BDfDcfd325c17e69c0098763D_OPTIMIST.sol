...
contract OPTIMIST is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "OPTIMIST"; 
    string private constant _symbol = "OPTIMIST"; 
    ...
    address payable private _developmentWalletAddress = payable(0x3a89eEd695621d8AECACB999E8729dd67cd5df33);
    address payable private _marketingWalletAddress = payable(0x3a89eEd695621d8AECACB999E8729dd67cd5df33);
