...
//*********************************************************************//
//
//    ______      __    ___          __  __                             _       ______________
//   / ____/___  / /_  / (_)___     / / / /___  ____ ___  ___  _____   | |     / /_  __/ ____/
//  / / __/ __ \/ __ \/ / / __ \   / /_/ / __ \/ __ `__ \/ _ \/ ___/   | | /| / / / / / /_    
// / /_/ / /_/ / /_/ / / / / / /  / __  / /_/ / / / / / /  __(__  )    | |/ |/ / / / / __/    
// \____/\____/_.___/_/_/_/ /_/  /_/ /_/\____/_/ /_/ /_/\___/____/     |__/|__/ /_/ /_/       
//                                                                                            
//
// These banners represent ownership of asset in the goblin valley of the hidden metaverse.
// 1 nft = Home
// 4 nfts = Bungalow
// 6 nfts = Villa
// 9 nfts = Mansion
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xbf8228ABaf7986a5748bFB1D6d590dAE25db3194];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 999;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 5678) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmf7tCcgWScqhdZSD5LuKDatepuGHsHEdog3pHfgNTZQF6/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 5678");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5678");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 5678");
...
// File: contracts/GoblinHomesWtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinHomesWtfContract is RamppERC721A {
    constructor() RamppERC721A("Goblin Homes WTF", "GBH"){}
}
