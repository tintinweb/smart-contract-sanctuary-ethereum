...
contract FamilyDogs is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmWSfztULWijEYa3hvzfQRSMcZuc9GTjuxs4DWrUr7NqtZ/";
  uint256  public  maxSupply = 5555;
  uint256 public  MAX_MINTS_PER_TX = 15;
