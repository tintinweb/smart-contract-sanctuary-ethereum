...
// Portal: https://t.me/TwitterGate_ETH
// Helping Elon to fact check liberal media outlets in search of the truth
...
contract TGATE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Twittergate", "$TGATE") {
        ...
        marketingWallet = address(0x31CFE10fF17d469432De575d0821b931c24C8448); // set as marketing wallet
        devWallet = address(0x31CFE10fF17d469432De575d0821b931c24C8448); // set as dev wallet
