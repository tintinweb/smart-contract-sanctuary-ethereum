...
/**
    ...
    $TROPHY is the new digital currency which will allow users fast and secure transactions through de-fi swapping platform.
...
contract SportSwap is Context, IERC20, Ownable {
    ...
    string private constant _name = "SportSwap";
