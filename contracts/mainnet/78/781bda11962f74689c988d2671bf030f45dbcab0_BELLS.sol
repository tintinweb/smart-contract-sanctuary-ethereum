...
contract BELLS is Context, IERC20 { 
    ...
    address payable public Marketing_Address = payable(0xCcEf43D14C5f54Ea58A8BBa4629859171a520021); 
    address payable public constant Burn_Address = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Developer_Address = payable(0xCcEf43D14C5f54Ea58A8BBa4629859171a520021);
    ...
    string private constant _name = "Jingle Bells"; 
    string private constant _symbol = unicode"$BELLS";
    ...
    constructor () {
        ...
        _owner = 0xCcEf43D14C5f54Ea58A8BBa4629859171a520021;
