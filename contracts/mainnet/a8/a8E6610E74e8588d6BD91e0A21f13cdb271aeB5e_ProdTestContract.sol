...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x390524702bc83592Af17f933F56D82E233BD8a04];
  address public erc20Payable = 0x390524702bc83592Af17f933F56D82E233BD8a04;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.sprawlgame.net/ipfs/QmQ7BN43ce6hcZQJKPGhbC3wHRMZ6ecucRWeZijVuuMrqU/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/seFIByw6utxzyz0ExImw/contract-metadata";
  }
...
// File: contracts/ProdTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ProdTestContract is RamppERC721A {
    constructor() RamppERC721A("Prod Test", "PRPD"){}
}
