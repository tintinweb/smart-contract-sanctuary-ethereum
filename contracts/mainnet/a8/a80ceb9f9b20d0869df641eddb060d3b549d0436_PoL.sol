...
contract PoL is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of Life";
    string private constant _symbol = "ETH4868";
    ...
    address payable private _developmentAddress = payable(0x22371f902be5F04e69488C1C62231AE74A68C6cB); 
    address payable private _marketingAddress = payable(0x22371f902be5F04e69488C1C62231AE74A68C6cB);
