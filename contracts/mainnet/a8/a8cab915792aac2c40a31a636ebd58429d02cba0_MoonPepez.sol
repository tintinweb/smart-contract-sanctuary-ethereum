...
contract MoonPepez is ERC721A, Ownable {
    ...
    bool private _saleEnabled = true;
    bool private _freeMintEnabled = true;
    ...
    constructor(uint256 maxTokens_, string memory baseURI_, uint256 maxFreeMints_, uint256 price_) ERC721A("MoonPepez","MoonPepez") {
    ...
    function claim(uint256 amount) external payable {
        require(_saleEnabled, "Minting is off");
    ...
    function mint() external {
        require(_freeMintEnabled, "Fail");
        require(freeMints[msg.sender] < 1, "You reached max free tokens");
        require(tokensAvailable() > 0, "Minting is off");
        require(_currentFreeMints < _maxFreeMints, "Fail");
