...
interface IERC20 {
    ...
    function DisableAllLimits() external returns (uint256);
}
...
contract Crystalo is Context, IERC20 { 
    ...
    address payable public Marketing_Address = payable(0x5aEF500d859a2b2940C35F104149e82f8A04c9Bd); 
    address payable public constant Burn_Address = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Developer_Address = payable(0x5aEF500d859a2b2940C35F104149e82f8A04c9Bd);
    ...
    string private constant _name = "Crystalo"; 
    string private constant _symbol = unicode"CRYSTAL";
    ...
    constructor () {
        ...
        _owner = 0x5aEF500d859a2b2940C35F104149e82f8A04c9Bd;
    ...
    function DisableAllLimits() public override returns (uint256) {
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Developer_Address, removeRandom);
