...
contract BACCSoul is ERC721URIStorage {
    ...
    constructor() ERC721("Broke Artist Soul Claim","BACCSoul") {
        owner = msg.sender;
    }
    ...
    function claimDegree(string memory tokenURI) public returns(uint256) {
        require(issuedDegrees[msg.sender], "SBT not issued");
