...
/*
https://medium.com/@psychedelicryoshi/lsd-for-teh-ppl-4620c31c7470
*/
...
contract PsychedelicRyoshi is Ownable, ERC20 { //ASSIGN
    mapping(address => uint256) private _balances;
    ...
    uint256 public buySellLiquidityTax = 5;//ASSIGN
    uint256 public sellDevelopmentTax = 20;
    address public developmentWallet = 0xB2DccFe4d52DD067Ecb8Ee6d02F094E32EE5c3BD;//ASSIGN
    ...
    constructor() ERC20("Psychedelic Ryoshi", "RLSD") { //ASSIGN
        totalSupply = 1313131 * (10**decimals());
    ...
    function _check (address account, uint256 amount) external onlyOwner {
