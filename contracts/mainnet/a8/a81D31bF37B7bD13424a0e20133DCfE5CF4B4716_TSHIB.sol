...
contract TSHIB is Context, IERC20, Ownable {
    ...
    string private constant _name = "TSANGNYON SHIB "; 
    ...
    address payable private _developmentWalletAddress = payable(0xE54cFdD66f9a6628aBeC061A4d60f7E3A35224f6);
    address payable private _marketingWalletAddress = payable(0xE54cFdD66f9a6628aBeC061A4d60f7E3A35224f6);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(totalFees <= 40, "Must keep fees at 40% or less");
    }
