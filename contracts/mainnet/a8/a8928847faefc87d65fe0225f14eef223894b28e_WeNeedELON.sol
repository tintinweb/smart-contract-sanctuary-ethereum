...
/*
    @wEed: We need Elon 🦾
    https://t.me/wEedERC
    https://twitter.com/wEedByElon 

    Tired of the rugs, the bugs, and the scams,

    wEed is a Uniswap Token with sole existence to provide you with a tool which:
         can be used to verify contracts against thousands of bugs providing you with one of the two signs:

            1. Angel: Safe play (Elon play)
            2. Devil: Donot invest

    Apart from this utility wEed with provide ETH rewards and have a unique elon inspired nfts because we know our investors  deserve a little token of appreciation for holding.

    To start the journey. wEed is coming to the Ethereum Block Chain Very Soon:



    Empowering future generations with next gen tokenomics. 
    Rewards on Buys and sells and an exclusive platform to safeguard smart contracts.
...
contract WeNeedELON is ERC20, Ownable {
    ...
    constructor() ERC20("We Need ELON", "wEed") {
