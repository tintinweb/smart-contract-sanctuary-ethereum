...
Website: https://apesinaid.org/

Telegram: https://t.me/ApesinAidportal
...
contract ApesInAid is Context, IERC20, Ownable {
    ...
    string private _name = "Apes In Aid";
    ...
    uint256 public _maxTxAmount = 7000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 700000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 700000000000000000000 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 70000000, "Max Tx Amount cannot be less than 70 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 70000000, "Swap Threshold Amount cannot be less than 70 Million");
