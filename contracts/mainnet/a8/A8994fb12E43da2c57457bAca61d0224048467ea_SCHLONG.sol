...
contract SCHLONG is ERC20, Ownable {
    ...
    constructor() ERC20("Schlong", "8==D") {
        ...
        uint256 totalSupply = 69696969969 * 1e18;

        maxTransactionAmount = 696969699 * 1e18; // 0.5% from total supply maxTransactionAmountTxn
        maxWallet = 1393939423 * 1e18; // 1% from total supply maxWallet
		...
		charityWallet = address(0x69208d8c57dbFBAdea0F0eF97956aD2BBefeEA2C); // set as charity wallet
        marketingWallet = address(0x69208d8c57dbFBAdea0F0eF97956aD2BBefeEA2C); // set as marketing wallet
        devWallet = address(0x69208d8c57dbFBAdea0F0eF97956aD2BBefeEA2C); // set as dev wallet
