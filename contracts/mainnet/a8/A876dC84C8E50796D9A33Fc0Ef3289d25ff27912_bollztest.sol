...
contract bollztest is ERC721URIStorage {
    ...
    constructor() ERC721("bollztest", "pllztest"){
    ...
    function getTokenURI() public pure returns (string memory){
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "rar tst salty #61",',
                '"description": "test description",',
                '"image": "ipfs://QmNxfgefu2pbmWhmLf8b5fsES3uRuk9B8WgnSm71rkNDoZ",',
            '}'
        );
