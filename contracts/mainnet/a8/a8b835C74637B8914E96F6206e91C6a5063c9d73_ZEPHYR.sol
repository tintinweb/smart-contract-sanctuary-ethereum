...
contract ZEPHYR is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7500000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _LSHIBURAI_Burned;

    string private _name = "Zephyr Inu";
    string private _symbol = "ZEPHYR";
    ...
    uint256 public _liquidityMarketingFee = 3;
    ...
    uint256 public _maxTxAmount = 67500 * 10**9;
    uint256 public _maxHoldings = 217500 * 10**9;
    ...
    constructor () {
        ...
        _marketingWallet = 0xfE00Fd98540a3CFf256e8f55Fd4EF5311b10bFe1;
        _dWallet = 0xdc7E0c05a7407eF113d0880c1FF3a5819EcE77A8;
    ...
    function burnZEPHYR(uint amount) external {  
    ...
    function sacrificeZEPHYR(uint amount) external {  
