...
Do you always ape the token at the peak and the price going down quickly after your ape? What if there is the AI to help you ape when there is a dip instead? 
Here we are!

Check out more:
Telegram: https://t.me/DipAI_Portal 
Twitter: https://twitter.com/DipAI_ERC 
Website: https://dipai.live 
...
contract DipAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DipAI";
    string private constant _symbol = unicode"DIPAI";
