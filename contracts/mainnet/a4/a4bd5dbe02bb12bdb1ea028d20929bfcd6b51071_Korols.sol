...
contract Korols is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Korols";
    string private constant _symbol = unicode"KOROLS";
