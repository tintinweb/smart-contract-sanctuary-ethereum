...
// Website: https://ox-stocks.com
// Twitter: https://twitter.com/OX_Stocks
// Medium: https://medium.com/@ox_stocks
// Telegram: https://t.me/oxstocks_portal
...
contract OX is ERC20, Ownable {
    ...
    constructor() ERC20("OX", "WOX") {
        ...
        uint256 totalSupply = 1 * 1e6 * 1e18;   //  1M supply
        
        maxBuyAmount = totalSupply * 2 / 100;
        maxSellAmount = totalSupply * 2 / 100;
        maxWalletAmount = totalSupply * 2 / 100;
        swapTokensAtAmount = totalSupply * 2 / 10000; // 0.02% swap amount

        buySustainabilityFee = 2000;
        buyLiquidityFee = 0;
        buyTreasuryFee = 0;
        buyTotalFees = buySustainabilityFee + buyLiquidityFee + buyTreasuryFee;

        sellSustainabilityFee = 6000;
        sellLiquidityFee = 0;
        sellTreasuryFee = 0;
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 100)/1e18, "Cannot set max wallet amount lower than 5%");
