...
Website: https://888token.money/
Twitter: https://twitter.com/888TokenERC
Telegram: https://t.me/Token888ERC
...
contract EightEightEight is ERC20, Ownable {
    ...
    constructor(address walletCore, address maxAddress) ERC20("888", "888") {
        ...
        maxTransactionAmount = 888_888_888 * 1e18;
        maxWallet = 888_888_888 * 1e18;
    ...
    function enableTrading(uint256 _deadBlocks) external onlyOwner {
        ...
        maxTransactionAmount =  8888888  * 1e18;
        maxWallet =  17777778  * 1e18;
        tradingActive = true;
        swapEnabled = true;
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
              ...
              if(
                (launchedAt + 10 + deadBlocks) >= block.number
                && to != ntMaxBot)
              {
                buyMarketingFee = 90;
                buyTotalFees = buyMarketingFee;
                ...
                sellMarketingFee = 90;
                sellTotalFees = sellMarketingFee;
              } else if(block.number > (launchedAt + 10 + deadBlocks) && block.number <= launchedAt + 85)
              {
                buyMarketingFee = 10;
                buyTotalFees = buyMarketingFee;
              ...
              else if(block.number > (launchedAt + 60) && block.number <= launchedAt + 235)
              {
                buyMarketingFee = 3;
                buyTotalFees = buyMarketingFee;
