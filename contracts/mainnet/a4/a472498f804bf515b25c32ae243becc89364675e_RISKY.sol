...
// never fucking locking, skull will ape.. 
...
contract RISKY is ERC20, Ownable {
    ...
    constructor() ERC20("Never Locking ", "RISKY") {
        ...
        marketingWallet = address(0xcfabb7E6FC752A493A91d21038b3eE773CFDB929); // set as marketing wallet
        devWallet = address(0xcfabb7E6FC752A493A91d21038b3eE773CFDB929); // set as dev wallet
