...
contract KAGURA is ERC721A('KAGURA', 'KAGURA'), Ownable, AccessControl, DefaultOperatorFilterer, ERC2981 {
    enum Phase {
        BeforeMint,
        PreMint1,
        PreMint2,
    ...
    address public constant withdrawAddress = 0x8CfABDbf6741cabC1c20519fCA960d66a909B5a5;
    uint256 public constant maxSupply = 8888;
    uint256 public constant publicMaxPerTx = 1;
    string public constant baseExtension = '.json';

    string public baseURI = 'ipfs://QmQ1waBX89KgG6uxojoyQuy1fcH1ZNsZyxwEquytLgWmed/';
    ...
    constructor() {
        ...
        costs[Phase.PreMint1] = 0.02 ether;
        costs[Phase.PreMint2] = 0.03 ether;
        costs[Phase.PublicMint] = 0.03 ether;
        _grantRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _grantRole(MINTER_ROLE, _msgSender());
        _grantRole(BURNER_ROLE, _msgSender());
        _safeMint(0x7F429dc5FFDa5374bb09a1Ba390FfebdeA4797a4, 1334);
