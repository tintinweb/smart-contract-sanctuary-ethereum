...
contract AXE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AXE";
    ...
    address payable private _developmentAddress = payable(0x4607BFeC2D779b0C7e6Cf3B952d9446B57Fd535a);
    address payable private _marketingAddress = payable(0x4607BFeC2D779b0C7e6Cf3B952d9446B57Fd535a);
