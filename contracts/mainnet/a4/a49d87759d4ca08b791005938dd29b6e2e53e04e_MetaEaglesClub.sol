...
contract MetaEaglesClub is ERC721Enumerable, Ownable {
  ...
  address private PartAddress = 0x0212D391e2B26ae165fDb5f2c3bba1039811374e;
  ...
  constructor(string memory baseURI) ERC721("Meta Eagles Club", "MEC") {
    setBaseURI(baseURI);
  }
