...
contract ShibaTreats is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ShibaTreats";
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0x8372F6B2E45e6818D853F0b76B2Ea70B2e77fa96);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0x8372F6B2E45e6818D853F0b76B2Ea70B2e77fa96)] = _tTotal.div(33);
        ...
        _tOwned[address(_deployer)] = _tTotal.div(50);
    ...
    function lowerFees() public onlyOwner {
        fee1 = 50;
        fee2 = 70;
    }
