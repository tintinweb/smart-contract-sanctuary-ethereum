...
contract Pool is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Pool by Costa", "Pool") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmUnZLYg4vZ5tR1FKVZm4Dn35qbikqRibapPGQFCfzSbFo/", _toString(tokenId), ".json"));
    }
