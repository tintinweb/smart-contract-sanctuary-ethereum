...
contract RadiantElements is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x05d39bcfa118dc147671cfa9af37f6afe0467c066802ab5730759327f818f21a;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmbiatbxwJxExEuyhJJhYjVpi5oSRVb8NQHTmXvprhGPiQ";

    constructor() public ERC721A("Radiant Elements", "RADIANT", 999, 999) {}
