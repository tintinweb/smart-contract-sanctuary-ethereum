...
contract BOTFREE is BEP20, Ownable {
    ...
    address public marketingWallet = 0xb2Bef6591C3963931ee0AF2b922a3671139069C5;
    ...
    constructor() BEP20("BOTFREE", "BOTFREE") {
    ...
    function solveCaptcha(uint256 _response)public {
        if(_response == 4){
