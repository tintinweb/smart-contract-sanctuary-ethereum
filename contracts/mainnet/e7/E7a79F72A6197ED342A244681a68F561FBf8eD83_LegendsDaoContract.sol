...
//
//     __                             __     ____  ___   ____ 
//    / /  ___  ____ ____  ____  ____/ /____/ __ \/   | / __ \
//   / /  / _ \/ __ `/ _ \/ __ \/ __  / ___/ / / / /| |/ / / /
//  / /__/  __/ /_/ /  __/ / / / /_/ (__  ) /_/ / ___ / /_/ / 
// /_____|___/\__, /\___/_/ /_/\__,_/____/_____/_/  |_\____/  
//           /____/                                           
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7CBd509f38f327795170A4112f5b20a732A7EBd8];
  address public erc20Payable = 0x7CBd509f38f327795170A4112f5b20a732A7EBd8;
...
abstract contract Feeable is Teams, ProviderFees {
  uint256 public PRICE = 1.77 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 2250) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/9LdXooHwAzQ2NncpKKq0/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/dLlJDxgHrifMPbegex0w/contract-metadata";
  }
...
// File: contracts/LegendsDaoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LegendsDaoContract is ERC721APlus {
    constructor() ERC721APlus("LegendsDAO", "LegendsDAO"){}
}