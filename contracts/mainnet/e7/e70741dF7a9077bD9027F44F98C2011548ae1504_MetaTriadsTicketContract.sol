...
contract MetaTriadsTicketContract is Ownable {
    ...
    uint256 public phaseOneDuration = 30 minutes + marginOfSafety;
    uint256 public phaseTwoStartTime = 1647291600 - marginOfSafety;
    uint256 public phaseTwoDuration =  30 minutes + marginOfSafety;
    ...
    uint256 public redeemStart = startTimeOpen + 1 hours;
