...
contract Bubble is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Bubble";
    ...
    uint256 private _buySalesTax = 1;
    uint256 private _sellSalesTax = 1;
