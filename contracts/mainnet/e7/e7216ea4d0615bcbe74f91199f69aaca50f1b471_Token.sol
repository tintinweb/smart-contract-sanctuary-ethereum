...
/*
TG: https://t.me/BallonDiogePortal
*/
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Ballon DiOge", "$DiOGE") {
        ...
        uint256 totalSupply = 10 * 1e9 * 1e6;
        supply += totalSupply;
        ...
        devWallet = 0x871Fdf8eE9Ae9c41ded5e94Af506A65CefFEb4F2; 
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner{
        MaxTransactionAmount = newNum * 1e6;
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner{
        MaxWallet = newNum * 1e6;
    }
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        buyBurnFee = _burnFee;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
