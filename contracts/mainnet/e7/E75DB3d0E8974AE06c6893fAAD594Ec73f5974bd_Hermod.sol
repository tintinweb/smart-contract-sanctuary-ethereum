...
contract Hermod is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Hermod"; 
    string private constant _symbol = "HERMOD"; 
    ...
    uint256 private _taxOnBuy = 16;   
 
    //Sell Fee
    uint256 private _feeOnSell = 0; 
    uint256 private _taxOnSell = 16;  
    ...
    address payable private _developmentWalletAddress = payable(0x6f7ED8deB00A7F0123ba503086b1B29f811C569D);
    address payable private _marketingWalletAddress = payable(0x6f7ED8deB00A7F0123ba503086b1B29f811C569D);
