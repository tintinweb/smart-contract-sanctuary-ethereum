...
contract FF0000 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbM8SFPEGqrnCc7e4ExGyAkZoMtLLSevUYncfv377x26x";
    ...
    constructor(
    ) ERC721A("FF0000", "FF0000", 100, maxSupply) {
    }
