...
Mr. Beast has officially surpassed PewDiePie as YouTube's no 1  subscribed content creator.

Mr. Beast fan token is dedicated to all mr beast fans around the globe.
Our aim is to become no1 charity base token 

2% of tax goes to charity for 
www.feedingamerica.org

Telegram: https://t.me/MrbeastfantokenErc

Twitter: https://mobile.twitter.com/Mrbeastfan_Erc

Website: www.mrbeastfantoken.space
**/
...
contract MrBeast is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mr Beast Fan Token";
