...
// TOKEN NAME: LEBRON JAMES GOAT TOKEN
// SYMBOL: LBJ GOAT ( GREATNESS OF ALL TIME )
// TOTAL SUPPLY: 1B
// LP WILL BE BURNT
...
contract LBJGOATTOKEN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "LeBron James Goat Token";
    string private _symbol = "LBJ GOAT";
    ...
    constructor () {
        ...
        blockw = payable(address(0xbA8e1A2b875642DE602711E3000ec59bCb4dA8e3));
