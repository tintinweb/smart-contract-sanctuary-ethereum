...
// File: contracts/EpicFriendsSquad.sol
...
contract EpicFriendsSquad is ERC721A, Ownable, ReentrancyGuard {

    string public        baseURI;
    uint public          nextOwnerToExplicitlySet;

    constructor() ERC721A("Epic Friends Squad", "EFS") {}

    function gift(address[] calldata receivers) external onlyOwner {
        require(receivers.length > 0, "Receivers required");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), "Friend does not exist");
