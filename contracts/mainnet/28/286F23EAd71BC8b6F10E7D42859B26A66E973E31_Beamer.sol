...
/**
*/ 
// https://www.beamer.cloud/
// Beamer brings the speed and convenience of centralized exchanges to DeFi
// while remaining fully trustless and transparent.
// Discord Community will be released in our V2 update.
...
contract Beamer  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Beamer";
    ...
    address payable private _developmentAddress = payable(0xb3f2928bd64eC9Db4B47A33845327FB940b9dCBe); 
    address payable private _marketingAddress = payable(0xb3f2928bd64eC9Db4B47A33845327FB940b9dCBe);
