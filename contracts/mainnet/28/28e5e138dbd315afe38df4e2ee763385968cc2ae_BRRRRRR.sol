...
$BRRRRR is here to help the many victims during the recent teamfinance exploit and to protect and serve the degens of 
defi during these bearish times by creating a token that rewards $ETH dividends to $BRRRRR holders! Simply buy $BRRRRR token, 
sit back, relax and watch as your wallet accumulates nonstop $ETH rewards like a money printer going $BRRRRR!

Telegram: https://t.me/brrrrrprotocol
...
contract BRRRRRR is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Brrrrr Protocol", "BRRRRR") {
    	...
    	operationsWallet = address(0x0BDdD1916a6807026F92CeBb48ea1e2A9C4A450d); // set as operations wallet
