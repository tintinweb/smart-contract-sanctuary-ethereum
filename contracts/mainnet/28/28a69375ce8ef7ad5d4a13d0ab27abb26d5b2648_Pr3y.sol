...
contract Pr3y is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x44dB8291eD181682d67497a36Dab598297B4a6c4));
    address payable public _vaultwallet = payable(address(0x44dB8291eD181682d67497a36Dab598297B4a6c4));
    address private _burnAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "Pr3y";
    string private _symbol = "Pr3y";
    ...
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(25); // 2.5%
