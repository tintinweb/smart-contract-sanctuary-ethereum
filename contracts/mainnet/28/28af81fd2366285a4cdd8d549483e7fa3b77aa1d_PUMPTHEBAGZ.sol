...
abstract contract Ownable is Context {
    ...
    contract PUMPTHEBAGZ is ERC721A, Ownable {
    using Strings for uint256;
  ...
  uint8 public maxMintAmountPerWallet = 12;
  ...
  constructor() ERC721A("PUMP THE BAGZ", "PUMP") {
  }
...
function whitelistMint(uint8 _mintAmount) external payable {
       ...
       require (nft + _mintAmount <= maxWLMintAmountPerWallet, "Exceeds max  limit  per address");
 ...
 function setWhiteListMaxLimitPerAddress(uint8 _limit) external onlyOwner{
