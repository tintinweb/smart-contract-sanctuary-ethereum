...
// 0/0 TAX COMMUNITY TOKEN, NO DISCORD/TELEGRAM/TWITTER/MEDIUM 
...
contract $ave0ur$hiba is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("$ave 0ur $hiba",unicode"$0$") {
        ...
        marketingWallet = 0x356f66fA358EA450853c28D1B50f7792cA96145A; // set as marketing wallet
