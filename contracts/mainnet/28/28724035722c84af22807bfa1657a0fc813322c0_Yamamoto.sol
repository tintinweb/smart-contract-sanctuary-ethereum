...
contract Yamamoto is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Genryusai Yamamoto";
    string private constant _symbol = "Yamamoto";
    ...
    uint256 private _MFeeOnBuy = 2;
    uint256 private _taxFeeOnBuy = 2;
    uint256 private _MFeeOnSell = 2;
    ...
    address payable private _developmentAddress = payable(0xAE461199f11F3a968fa32Ee43280cdBBEaebafcb);
    address payable private _marketingAddress = payable(0x885327bcC6d8021248A0F976d3e7Ef04eCBc584F);
