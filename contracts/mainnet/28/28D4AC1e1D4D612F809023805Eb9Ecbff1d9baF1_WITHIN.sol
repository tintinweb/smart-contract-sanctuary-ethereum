...
"True Power,
The Power above everything comes from within,
It Lies within us,
True Power comes with responsibilities,
The power to carve our future,
The power to engage,
The Power to rebuild Ourselves,
True power can not be bought,
Its from within."
...
contract WITHIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "True Power Lies Within";
    string private constant _symbol = "WITHIN";
