...
contract CHOPSTICKS is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"CHOPSTICKS", unicode"CHOP") 
    {
        address supplyRecipient = 0x830A4557aACe96dC5bCCdc5AfB7bb27C3aa324b2;
        
        updateSwapThreshold(500000 * (10 ** decimals()));

        marketingAddressSetup(0xf63bB4E20Ffe08ccF3C252A0826b730297416A8C);
        ...
        _transferOwnership(0x830A4557aACe96dC5bCCdc5AfB7bb27C3aa324b2);
    }
