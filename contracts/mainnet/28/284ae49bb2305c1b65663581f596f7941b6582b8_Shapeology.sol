...
contract Shapeology is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;

    // ===== Variables =====
    string public baseTokenURI;
    uint256 public mintPrice = 0.002 ether;
    uint256 public collectionSize = 250;
    
    uint256 public reservedSize = 1;
    ...
    constructor() ERC721A("Shapeology", "SHP", 1) {}
    ...
    function freeMint() external onlySender nonReentrant {
        ...
        require(
            MintedAmount[msg.sender] + 1 <= maxItemsPerWallet,
    ...
    function publicMint() external payable onlySender nonReentrant {
        ...
        require(
            MintedAmount[msg.sender] + amount <= maxItemsPerWallet,
            "Minting amount exceeds allowance per wallet"
        );
