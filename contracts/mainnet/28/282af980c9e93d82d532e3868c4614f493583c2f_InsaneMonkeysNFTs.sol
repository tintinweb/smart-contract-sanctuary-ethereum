...
// File: contracts/IMN Main Contract.sol
...
contract InsaneMonkeysNFTs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Insane Monkeys NFTs", "IMN") {
    setHiddenMetadataUri("ipfs://QmcjAaS5T9oD4joNPCNDUgBYGUFYqbS27iEhz6F2NENG2T/Hidden.json");
  }
