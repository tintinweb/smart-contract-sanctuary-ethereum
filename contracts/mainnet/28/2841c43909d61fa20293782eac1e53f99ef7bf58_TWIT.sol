...
contract TWIT is Context, IERC20, Ownable {
    ...
    string private constant _name = "TwitMaga";
    string private constant _symbol = "TwitMAGA";
    ...
    address payable private _listingWallet;
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0xBF32c7C4766c286C2E8F45aA6A224DA68CA49C6b);
        _listingWallet = payable(0x5357A289d1CCD278589f5881c0e973566e42d5d9);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0xBF32c7C4766c286C2E8F45aA6A224DA68CA49C6b)] = _tTotal.div(50);
        _tOwned[address(0xD03d821d76c8eE3302934d60927AbdDEa7dB70c7)] = _tTotal.div(50);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _listingWallet.transfer(amount.div(100).mul(pc3));
    }
