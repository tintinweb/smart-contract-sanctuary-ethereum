...
/*
 ...
 Telegram: https://t.me/BullsVsBearsETH
 Twitter: https://twitter.com/BullsVsBearsERC
 Website: https://www.bullsvsbears.biz/


Bulls Vs Bears

Every Bull(buy) has 2% True Burn, Every Sell(Bears) has 1% Supply Increase 1% Marketing
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Bulls Vs Bears", "BVB") {
        ...
        swapTokensAtAmount = supply * 10 / 10000; // 0.05% swap wallet;
        ...
        sellMintFee = _sellMintFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellMintFee + sellDevFee;
        
        devWallet = 0xD87B91946df4e1F8139313a772D57bADd4B20948;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForMint += fees * sellMintFee / sellTotalFees;
                totalMint = totalMint + tokensForMint;
            ...
            // on buy
                ...
                totalBurn = totalBurn + tokensForBurn;
            ...
            if(fees > 0){    
                ...
                if (tokensForMint > 0) {
                    _mint(address(this), tokensForMint);
                    supply = totalSupply();
                    updateLimits();
                    tokensForMint = 0;
                }
