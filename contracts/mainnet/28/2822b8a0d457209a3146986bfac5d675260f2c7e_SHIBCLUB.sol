...
contract SHIBCLUB is Ownable, ERC721A {
  string public baseURI = "https://nftstorage.link/ipfs/bafybeihktsshtsgpnooom65mtanpdjogoov4lt57by2k4qktvacut3bgve/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('SHIBCLUB', 'SC') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 3000) {
