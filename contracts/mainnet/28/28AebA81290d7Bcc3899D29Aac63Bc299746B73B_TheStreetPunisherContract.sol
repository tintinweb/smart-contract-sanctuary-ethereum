...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5B4590a2e4bAE7Ff5eb62d4AdA40c69cdE2E3c30];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 108) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidcjmuekujbtqobe3hmene4kong3yorl76ejtjz4ixups6xnjibkm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 108");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 108");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 108");
...
// File: contracts/TheStreetPunisherContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheStreetPunisherContract is RamppERC721A {
    constructor() RamppERC721A("The Street Punisher", "TSTP"){}
}
