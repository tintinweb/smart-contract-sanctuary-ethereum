...
contract ElonMuskDoge is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Elon Musk Doge";
    string private constant _symbol = unicode"EMD😉";
