...
contract TheNeuralink is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE2b3d45388ff739dA756842f90A5127B5F73a3b9); 
    address payable public Wallet_Utility = payable(0xE2b3d45388ff739dA756842f90A5127B5F73a3b9);
    ...
    string private constant _name = "The Neuralink"; 
    string private constant _symbol = unicode"THE NEURALINK"; 
    ...
    constructor () {
        ...
        _owner = 0xE2b3d45388ff739dA756842f90A5127B5F73a3b9;
