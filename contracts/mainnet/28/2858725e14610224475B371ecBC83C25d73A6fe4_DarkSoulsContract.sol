...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1040E0c82314c349032a78A3D6dB4F058BEbA95B,0x677C1e1e8585f914D9AD6a4565eb4edF43398bBD];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 3666 ) {}
...
// File: contracts/DarkSoulsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DarkSoulsContract is RamppERC721A {
    constructor() RamppERC721A("Dark Souls", "DRKS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/F0pSsoqTyraNKIF3qgIV/contract-metadata";
    }
}
