...
/**
Cryptogram has created a fully decentralized and anonymous ecosystem, that allows crypto investors to communicate and trade safely without any constraints. 
Cryptogram consists of an anonymous and secure on-chain chat, 
as well as a trading DEX, and a host of financial services, all powered by the $CG native token, so that $CG possesses real-world utility
https://t.me/cryptogramplatform
https://www.cryptogramplatform.com/                     
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract Cryptogram is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Cryptogram";
    string private _symbol = "GO";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000000;
    uint256 public taxForLiquidity = 3;
    uint256 public taxForDev = 2;
    ...
    address public MarketingWallet = 0xDa2166445437be0A3a6f4D08A0FFA744B5047c98;
    address public DevWallet = 0xDa2166445437be0A3a6f4D08A0FFA744B5047c98;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToMarketing = 200000 * 10**_decimals;
    uint256 private _numTokensSellToAddToDev = 200000 * 10**_decimals;
