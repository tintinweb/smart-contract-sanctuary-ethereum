...
contract PandazzZClub is ERC721A {
    ...
    constructor() ERC721A("PandazzZ Club", "PC") {
        owner = msg.sender;
        maxSupply = 4444;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeif4dgz33wvkeo2gslbofwbaru4wlww6wqirutzapmhpadjgx3kfkm/", _toString(tokenId), ".json"));
    }
