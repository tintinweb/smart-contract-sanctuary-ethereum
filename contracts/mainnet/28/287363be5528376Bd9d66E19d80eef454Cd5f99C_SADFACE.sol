...
contract SADFACE is Context,IERC20, Ownable{
using Address for address;
string private _name = "Sad face ('{-_-}')";
string private _symbol = "('{-_-}')";
...
address _owner;
address payable public marketingAddress = payable(0x889aA90dB7E493092294cEEe7903220197D1f5aC
...
function COINDay() public onlyOwner{
   require(block.timestamp > SADFACECOINDaycooldown, "You cant call SADFACECOINCoinDay more than once a day");
   buyPrevmktFee = buymktFee;
   buyprevLiqFee = buyliqFee;
   buyliqFee = 0;
   buymktFee = 0;
}
function SADFACECOINCoinDayOver() public onlyOwner{
   buyliqFee = buyprevLiqFee;
   buymktFee = buyPrevmktFee;
   SADFACECOINDaycooldown = block.timestamp + 86400;
}
