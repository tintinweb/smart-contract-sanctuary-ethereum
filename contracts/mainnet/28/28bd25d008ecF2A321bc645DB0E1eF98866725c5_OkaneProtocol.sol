...
Okane Protocol
Super Scalable Blockchain Powerful DeFi Platform
...
contract OkaneProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Okane Protocol";
    string private constant _symbol = unicode"OKANE";
