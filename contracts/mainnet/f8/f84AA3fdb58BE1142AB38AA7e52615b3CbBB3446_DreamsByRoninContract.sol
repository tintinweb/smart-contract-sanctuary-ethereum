...
//
//     ____                                         ____               
//    / __ \ _____ ___   ____ _ ____ ___   _____   / __ ) __  __       
//   / / / // ___// _ \ / __ `// __ `__ \ / ___/  / __  |/ / / /       
//  / /_/ // /   /  __// /_/ // / / / / /(__  )  / /_/ // /_/ /        
// /_____//_/    \___/ \__,_//_/ /_/ /_//____/  /_____/ \__, /         
//    ______   ____                        ____        /____/   _      
//   / ____ \ /  _/      ____ ___         / __ \ ____   ____   (_)____ 
//  / / __ `/ / /       / __ `__ \       / /_/ // __ \ / __ \ / // __ \
// / / /_/ /_/ /       / / / / / /      / _, _// /_/ // / / // // / / /
// \ \__,_//___/______/_/ /_/ /_/______/_/ |_| \____//_/ /_//_//_/ /_/ 
//  \____/     /_____/          /_____/                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 69;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 369) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiegzhnevj4ctwiv4pfx67bqj7bwg5i75uhp2uzyjd7nkhutrwmjtm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/INwRRv2IA14u9c51dfJP/contract-metadata";
  }
...
// File: contracts/DreamsByRoninContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DreamsByRoninContract is RamppERC721A {
    constructor() RamppERC721A("Dreams By Ronin", "DBR"){}
}
