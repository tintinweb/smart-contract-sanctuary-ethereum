...
/**
cake lp will be added so look there for it sers
*/
...
contract FrightNight is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Fright Night';
    string private constant _symbol = 'Night Of Terror';
