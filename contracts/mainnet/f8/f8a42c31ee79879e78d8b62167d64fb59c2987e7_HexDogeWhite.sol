...
contract HexDogeWhite is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xE876B11540A9063af5BBBFc5AE697CB6db60D484));

    string private _name = "HexDogeWhite";
    string private _symbol = "HexDW";
