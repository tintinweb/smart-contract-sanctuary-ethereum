...
contract PoliceCat is Context, IERC20, Ownable { 
    ...
    address payable public MarketingWallet = payable(0xd6Bb87937C911D007922Df678b9DC1305b832630);

    string public _name = "POLICE CAT";
