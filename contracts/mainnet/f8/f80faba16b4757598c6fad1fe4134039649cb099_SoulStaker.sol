...
contract SoulStaker is IERC721Receiver, Ownable{
    ERC721A public splicerContract;
    ...
    constructor() {
        splicerContract = ERC721A(0xfD4BfE64fea2ce11898c4b931AFAF728778a90b4);
    }
    ...
    function setEarlyRelease(bool _earlyRelease) public {
        earlyReleaseActive = _earlyRelease;
    }

    function setT2End(bool _ended) public {
        t2StakingClosed = _ended;
    }

    function SetT3End(bool _ended) public {
        t3StakingClosed = _ended;
    }

    function setSpendingContract(address _contractAddress) public {
