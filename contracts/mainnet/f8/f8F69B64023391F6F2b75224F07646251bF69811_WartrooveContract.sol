    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 877) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmS2zxD6F19taACMiSASTuqLyf25DHQVN5N5mWEWSYDmBL/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/1knfHNWGiP6vGIZGiLP7/contract-metadata";
  }
...
// File: contracts/WartrooveContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WartrooveContract is RamppERC721A {
    constructor() RamppERC721A("Wartroove", "Wartroove"){}
}
