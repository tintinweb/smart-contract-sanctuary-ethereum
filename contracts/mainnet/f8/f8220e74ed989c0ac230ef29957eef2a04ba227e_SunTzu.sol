...
contract SunTzu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SunTzu";
    ...
    address payable private _developmentAddress = payable(0xdAFa2cA3eAe9155E938322232F1fC87420643933);
    address payable private _marketingAddress = payable(0xdAFa2cA3eAe9155E938322232F1fC87420643933);
