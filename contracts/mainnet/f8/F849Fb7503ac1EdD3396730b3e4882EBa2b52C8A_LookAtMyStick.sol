...
contract LookAtMyStick is TinyERC721, Ownable, DefaultOperatorFilterer {
 ...
 constructor(
    ...
    address _lead
  )TinyERC721("LookAtMyStick", "LAMS", 0) {
    baseURI = _baseURI;
    lead = _lead;
  }
  ...
  function myStick(uint256 _quanitity) public onlyOwner {        
    uint256 supply = totalSupply();
  ...
  function buyStick(uint256 _quantity)
    public 
    payable 
    publicnotPaused() 
    callerIsUser() 
  ...
  function pickUpStick(uint256 _quantitty)
    public  
    publicnotPaused() 
    callerIsUser() 
  {
