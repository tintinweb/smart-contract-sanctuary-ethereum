...
/**
* Join https://t.me/dogehiveportal
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract DOGEHIVE is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "DOGE HIVE";
    string private _symbol = "DHIVE";
    ...
    address public marketingWallet = 0x7956519884ac957982e1e1397F5Ac3522b1F2048;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 500000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 300000000 * 10**_decimals;
