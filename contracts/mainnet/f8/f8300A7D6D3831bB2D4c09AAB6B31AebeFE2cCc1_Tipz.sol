...
contract Tipz is ERC721, Ownable {
    ...
    uint256 private min_price = 0 ether;
    uint256 private maxSupply = 3666;
    ...
    constructor(string memory _baseURIextended) ERC721("Tipz", "TIP"){
