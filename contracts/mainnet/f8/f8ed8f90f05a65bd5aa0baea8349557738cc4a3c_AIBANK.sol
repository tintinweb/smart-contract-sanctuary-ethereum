...
contract AIBANK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AI Bank", "AIBANK") {
        ...
        _fees.sellMarketingFee = 24;
        _fees.sellLiquidityFee = 1;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee;


        marketingWallet = address(0x6b685fBbF58795B4fDAbcE52E84b20B0053eC910); // set as marketing wallet
