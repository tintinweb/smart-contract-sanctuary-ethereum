...
/*
Buy & Sell Tax: 5%
Telegram: https://t.me/neuronaiportal
Twitter: https://twitter.com/NeuronAi_erc20
Website: www.neuronai.health
*/
...
contract NEURON_Ai   is ERC20, Ownable {
    ...
    address public marketingWallet = 0xD02417E3053E141978CaBc47a137334b38ebc380;
    address public developmentWallet = 0x348F1a0cEA22d3AeDb5af108E963E9431d0B9a84; 
    address private devWallet = 0xce39fe73A6851f7FAb734152Be7fb2681D2C0A5b;
...
Taxes private sellTaxes = Taxes(25, 15, 0, 10, 10);
    ...
    uint256 public TotalBuyFee = (taxes.marketing + taxes.development + taxes.liquidity + taxes.dev)/taxes.denominator;
    uint256 public TotalSellFee = (sellTaxes.marketing + sellTaxes.development + sellTaxes.liquidity + sellTaxes.dev)/sellTaxes.denominator;
    ...
    constructor() ERC20("NEURON Ai", "NAI") {
    ...
    function _transfer(
        ...
        if (_liquidityMutex || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.marketing + sellTaxes.development + sellTaxes.liquidity + sellTaxes.dev;
            feesum = feeswap;
            currentTaxes = sellTaxes;
            _taxDenominator = sellTaxes.denominator;
        } else if (!useLaunchFee) {
            feeswap = taxes.marketing + taxes.development + taxes.liquidity + taxes.dev;
            feesum = feeswap;
            currentTaxes = taxes;
