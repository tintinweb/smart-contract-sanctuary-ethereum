...
Proletariat is an older word
But it means the workers or working-class people

The people that need to get rich
Are the proletariat

Because we have nothing, we came from nothing
We do not have riches like Do Kwon or Zhu Su
With their superyachts and mansions

No, we play the shitcoin game
In the hope that one day we may strike it rich
And get ourselves out of this hellhole
And maybe into the bourgeoisie

That is the dream of all Proletariat

I hope that we all rise together,
And this is a safe space for you to do just that

We will have a renounced contract
And low taxes that will be used for marketing
We will do stealth marketing
And influencer marketing

We want to spread the word

That we are the Proletariat
And we will thrive!
...
contract proletariat is ERC20, Ownable {
    ...
    constructor() ERC20("Proletariat", "PRLT") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0x30FB8feB34A81916493b183dA6eB632285356b6f); 
        ...
        maxBuyAmount = totalSupply * 30 / 10000;
        maxSellAmount = totalSupply * 30 / 10000;
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _lotteryFee) external onlyOwner {
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellLotteryFee;
        require(sellTotalFees <= 9500, "Must keep fees at 10% or less");
    }
