...
contract pektguy is ERC721A {
    ...
    constructor() ERC721A("pektguy", "pepe") {
        owner = msg.sender;
        maxSupply = 3333;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibxcov7pjkyxptrxozlvui453qi2wvw7x4hec3b4mgvkspldribua/", _toString(tokenId), ".json"));
    }
