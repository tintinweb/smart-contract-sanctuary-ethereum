...
contract LarvaMoonbirds is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcwRXvAP7aw1NzEbTUWggAtpxb9Pg2PV1WN75Rr1mAqoK";
    ...
    constructor(
    ) ERC721A("LarvaMoonbirds", "LMB", 100, maxSupply) {
    }
