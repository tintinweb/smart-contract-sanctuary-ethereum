...
contract MangaNFT is ERC721Tradable {
    string baseURI = "https://us-central1-trophee-support-prod.cloudfunctions.net/v3/memberships/";
    
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("TropheeMembership", "TropheeMembership", _proxyRegistryAddress)
    {}
    ...
    function contractURI() public pure returns (string memory) {
        return "https://us-central1-trophee-support-prod.cloudfunctions.net/v3/memberships/contract";
    }
}