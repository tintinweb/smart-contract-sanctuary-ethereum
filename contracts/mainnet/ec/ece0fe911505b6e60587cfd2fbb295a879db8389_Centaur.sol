...
contract Centaur is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x034AeEFD7E05508B3327BDb68fE220f5c3aB0BF7));

    string private _name = "The Centaur";
    string private _symbol = "TCENT";
