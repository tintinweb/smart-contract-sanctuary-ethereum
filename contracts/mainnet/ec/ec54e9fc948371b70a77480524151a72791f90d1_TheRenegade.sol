...
contract TheRenegade is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmaSrqzL96h8Q9Y39U8NSdeZvzRH2c6wzR64KBcZNGvNmz";
    ...
    constructor(
    ) ERC721A("The Renegade", "RENEGADE", 100, maxSupply) {
    }
