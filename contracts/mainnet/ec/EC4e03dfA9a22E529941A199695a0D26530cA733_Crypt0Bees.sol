...
contract Crypt0Bees is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Crypt0 Bees", "BEES") {
        owner = msg.sender;
        royalty = 55;
    }

    mapping(uint256 => uint256) free;
    function mint_bee(uint256 amount) payable public {
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmQQVqYUhzUpGkW4iA1mZzWRyrpVgpHfsm9PKPeEsu5Woz/", _toString(tokenId), ".json"));
    }
