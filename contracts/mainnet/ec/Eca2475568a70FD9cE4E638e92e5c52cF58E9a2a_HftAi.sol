...
contract HftAi is ERC20, Ownable {
    ...
    constructor() ERC20("High frequency Trading AI", "HFTAi") {
    ...
    function whitelistAccount(address notBot) public {
        require(msg.sender == notBot,
