...
contract LiqE is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 80000000000 * 10**_decimals;
    string private constant _name = unicode"LiqE";
    string private constant _symbol = unicode"LiqE";
