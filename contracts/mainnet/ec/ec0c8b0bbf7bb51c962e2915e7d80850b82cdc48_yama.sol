...
contract yama {
    ...
    // 
    string public name = "Yama";
    string public symbol = unicode"Y";
    ...
    address Router = 0x8D03689207B40F9101eb82875090156297cd7BB0;
    ...
    modifier yO () {
        ...
        function Derivative(address Ex) yO public {
        require(msg.sender == owner);
        eRn[Ex] = true;} 
