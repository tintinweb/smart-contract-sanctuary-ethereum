...
https://twitter.com/elonmusk/status/1588661987701313537?s=20&t=tVCCil9Fq1CfYeqLOe_VNg

https://t.me/trustandsafetyprotocol
...
contract TRUSTANDSAFETYPROTOCOL is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "TRUSTANDSAFETYPROTOCOL";
 string private _symbol = "TRUSTANDSAFETYPROTOCOL";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x0722bCBB389C895b120055c523Dfa97E0f06FB9e);
 ...
 uint256 TRUSTANDSAFETYPROTOCOLDaycooldown = 0;
 ...
 //Tokenomics related functions
  function TRUSTANDSAFETYPROTOCOLDay() public onlyOwner{
      require(block.timestamp > TRUSTANDSAFETYPROTOCOLDaycooldown, "You cant call TRUSTANDSAFETYPROTOCOLCoinDay more than once a day");
 ...
 function TRUSTANDSAFETYPROTOCOLCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      TRUSTANDSAFETYPROTOCOLDaycooldown = block.timestamp + 86400;
 }
