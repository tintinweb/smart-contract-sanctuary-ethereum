  ...
  ERC20PausableUpgradeable
{
  ...
  function initialize(
    ...
    address adminSafeAccount,
    address pauserSafeAccount
  ) public {
  ...
  function __ERC20PresetMinterPauser_init_unchained(address adminSafeAccount, address pauserSafeAccount)
    internal
    initializer
  {
  ...
  function grantRole(bytes32 role, address account) public override {
    ...
    else require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Only DEFAULT_ADMIN_ROLE can grant Roles");
  ...
  function revokeRole(bytes32 role, address account) public override {
    if (role == PAUSER_ROLE) require(false, "PAUSER_ROLE can't be revoked, it can only be renounced");
