...
contract DuckHouseV6 is Initializable, IERC721ReceiverUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    function _unstake(uint256 id) private returns(uint256){
        StakeStatus memory stakeStatus = steak[id];
    ...
    function _unstakeGen2(uint256 id) private returns(uint256){
        ...
        uint256 owed = _claimGen2Quack(id);
