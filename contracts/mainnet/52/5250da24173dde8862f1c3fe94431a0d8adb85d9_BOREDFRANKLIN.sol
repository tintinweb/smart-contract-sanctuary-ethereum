...
contract BOREDFRANKLIN is ERC20, Ownable {
    ...
    constructor() ERC20("Bored Franklin Inu", "BFI") {
        ...
        marketingWallet = address(0xb06F7c80E9144645F0B5dd0bD31237f2e7CdFc33); // set as marketing wallet
        devWallet = address(0xb06F7c80E9144645F0B5dd0bD31237f2e7CdFc33); // set as dev wallet
