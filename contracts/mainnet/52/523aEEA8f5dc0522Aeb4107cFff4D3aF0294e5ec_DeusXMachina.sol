...
7 Days initail lock and extended at every preset mcap.
...
contract DeusXMachina is ERC20, Ownable {
    ...
    constructor() ERC20("Deus X Machina", "DXM") {
        ...
        marketingWallet = address(0xd6a1290f7068922352AD3095e4144C81bB3e70C8); // set as marketing wallet
        devWallet = address(0xd6a1290f7068922352AD3095e4144C81bB3e70C8); // set as dev wallet
