...
contract FWC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Final World Cup";
    ...
    address payable private _developmentAddress = payable(0x77d36Dd8240058a3198F7885AE0Cf6B9EA039923); 
    address payable private _marketingAddress = payable(0x77d36Dd8240058a3198F7885AE0Cf6B9EA039923);
