...
using Strings for uint256;
    ...
    constructor(address implementation)ERC721A("Deemo the movie NFT", "DEEMO") {
        ...
        bytes memory signature = "updateContract(address,string,string)";
         ...
         setBaseURISig = "getUserBoughtCount(address)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "isWhitelisted(address,bytes32[],uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "mint(address,uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setSeed(uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "buyDeemoNFT(bytes32[],uint256,bool)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "craftDeemo(uint256[])";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "burnAdmin(uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "addAllowAddress(address)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "removeAllowAddress(address)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setWhitelistRoot(bytes32)";
         constructorRegisterFunction(setBaseURISig, implementation);
         ...
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setSupply(uint256,uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
