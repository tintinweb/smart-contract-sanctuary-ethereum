...
https://t.me/YoroiERC_Bot
https://medium.com/@YoroiKitsune/yoroi-kitsune-armor-of-kitsune0-497d8ea092c0
...
contract YoroiKitsune is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0x0EcFC99ED8bF1e5ea4d2E96F336e8212ac7A2959); 
    address payable public Dev_Wallet = payable(0x8F82176Eaa4C369dFf41038C89589b32aEB4EB1F);
    ...
    string private constant _name = unicode"Yoroi Kitsune"; 
    string private constant _symbol = unicode"$YOROI";
    ...
    constructor () {
        ...
        _owner = 0x8F82176Eaa4C369dFf41038C89589b32aEB4EB1F;
