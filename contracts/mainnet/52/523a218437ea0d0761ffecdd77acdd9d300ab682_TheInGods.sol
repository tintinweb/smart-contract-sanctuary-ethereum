...
contract TheInGods is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "ipfs://bafybeifbklbabuktufdtz3mmvr7lr7gnxp4kksjlaztd5hfm3h74wrhlna/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("The 'In' Gods", "INGOD") {
        setHiddenMetadataUri("ipfs://bafybeidootf5ooalalwvjxdpfbs2sgvoxtbg4uqyhpzdh26bkqvofreati/hidden.json");
    }

    uint256 public price = 0.003 ether;
    uint256 public maxPerTx = 6;
    uint256 public maxPerFree = 1;    
    uint256 public maxFreeSupply = 4241;
    uint256 public max_Supply = 4241;
