...
//      ';       ; / ,·          .'/',      ,'                   '`,::;         ';       ; / ,·          .'/',      ,'                   '`,::;                              ,'      ;':';       '\      \::'i'°    i               `;:';    'i:::i'       ';        ;'::i   ;         ';::\ .,_';     ';:'i'     /;:- ´        `'·–·;:'/' _        i       i':/:::';       ;/'         'i            ;::::'`;*         /;:- ´        `'·–·;:'/' _   
//      ';      ;' ;´         ~´;:::'i°   i'       ,';´'`;         '\:::', ‘     ';      ;' ;´         ~´;:::'i°   i'       ,';´'`;         '\:::', ‘                          ;     'i::/`':.,_,.:'i      ;:/°     i      ,          \|     '|:::i°      'i        'i::i'   ';         ';::/::::';     ;':;    /     ;:'`:.., __,.·'::/:::';       i       i/:·'´       ,:''            `;           '`;:::::'`:,    /     ;:'`:.., __,.·'::/:::';  
//    /´:;     ;–·:`:,          '`;:/° ,'        ;' /´:`';         ';:::'i‘   /´:;     ;–·:`:,          '`;:/° ,'        ;' /´:`';         ';:::'i‘                          i      ';/::::;::/::;'      i/'       |     ,'`,                i:;'' ‚       ;       'i::;'    \          \/::::;'      i:/'°  ;'      ';:::::::::::::::/;;::/       '; '    ,:,     ~;'´:::'`:,           `·,           '`·;:::::'; ;'      ';:::::::::::::::/;;::/  
// ,/::;:'\,  '/::::::;'           'i/' ° ;        ;/:;::;:';         ',:::;,/::;:'\,  '/::::::;'           'i/' ° ;        ;/:;::;:';         ',:::;                          ';      '`·-:;_;:·'´       ,' °      'i    'i:::i',             ';/'          ';       i:/'      '\          '`~'´     ,'/      ¦         '`·-·:;::·-·'´   ';:/‘       'i      i:/\       `;::::/:'`;'      ,~:-'`·,           `:;::/' ¦         '`·-·:;::·-·'´   ';:/‘  
// '.     '` '´·–·~*´           ,'  '  'i        '´        `'         'i::'/'.     '` '´·–·~*´           ,'  '  'i        '´        `'         'i::'/                           ';                      ,'          'i     ;::/ \           ;/'             ';     ;/ °        \                  /        '\                         /'          ;     ;/   \       '`:/::::/'     /:::::::::';           ';/   '\                         /'    
//   ` ·-.,                 ,-·´   '   ¦       '/`' *^~-·'´\         ';'/'‚  ` ·-.,                 ,-·´   '   ¦       '/`' *^~-·'´\         ';'/'‚                            '\                   ,·'            \    'i/    '`·,      ,''                ';   / °           '`,             ;'            `·,                  ,·'  '          ';   ,'       \         '`;/'    ,:~·- . -·'´          ,'´       `·,                  ,·'  '    
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6148D7Cf318dF21E6257654066DC246356584698];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVGVY8si2gsaMTS7ZS9qq7s4oSDRgiLZNVvk9HmmFyt8Q/";
...
// File: contracts/BabaUniverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BabaUniverseContract is RamppERC721A {
    constructor() RamppERC721A("Baba Universe", "BABAUNIVRS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/1rpemwun7kHkkMOQsftL/contract-metadata";
    }
}
