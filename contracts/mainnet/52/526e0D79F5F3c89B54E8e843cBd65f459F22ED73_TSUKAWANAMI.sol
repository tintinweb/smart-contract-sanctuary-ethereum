...
contract TSUKAWANAMI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "TSUKA WANAMI";
    string private _symbol = "$TSUNAMI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x99f4A90c6c00dB423e8c6593059Fc4069698fbb3));
        _metawallet = payable(address(0x99f4A90c6c00dB423e8c6593059Fc4069698fbb3));
