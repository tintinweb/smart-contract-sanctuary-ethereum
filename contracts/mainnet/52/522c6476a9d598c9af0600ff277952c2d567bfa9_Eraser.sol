...
Inspire Your Thoughts Published in the first half of the hairstand can not buy auxiliary guide books
*/
...
contract Eraser is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Eraser";
    string private constant _symbol = "ERAS";
