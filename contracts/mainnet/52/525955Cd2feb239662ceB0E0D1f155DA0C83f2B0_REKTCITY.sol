// Welcome to Rekt City!
// https://playrektcity.com/

// Do not buy before pinned CA
// https://t.me/RektCityPortal
...
contract REKTCITY is ERC20, Ownable {
    ...
    constructor() payable ERC20("Rekt City", "RC") {
        ...
        marketWallet = address(0xA24C9AF02F8A12a396C93c3A80BA75cF86768b59);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xe41387D8642473BC115d810dF18C16dC6b405668),
            block.timestamp
        );
    }
