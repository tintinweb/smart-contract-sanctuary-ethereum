...
contract DoodledToadz is ERC721A, Ownable, ReentrancyGuard {
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require(
            ...
            "The max supply cannot be exceeded!"
        );
        require(
            _numberMinted(msg.sender) + _mintAmount <= maxMintAmountPerWallet,
            "Your wallet limit has been reached!"
        );
        _;
    }
    ...
    function mint(uint256 _mintAmount)
        ...
        mintPriceCompliance(_mintAmount)
    {
        require(!paused, "The contract is OFF!");
