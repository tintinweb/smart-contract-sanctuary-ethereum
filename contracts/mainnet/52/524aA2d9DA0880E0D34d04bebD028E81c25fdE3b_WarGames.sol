...
contract WarGames is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("War Games", "WAR") {
        ...
        maxWallet = 3 * 1e7 * 1e18; // Max Wallet 3%
        ...
        _isExcludedMaxBuyTransactionAmount[address(owner())] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(owner())] = true;
