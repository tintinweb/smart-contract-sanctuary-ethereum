...
contract Kenjutsu is ERC20, Ownable {
    ...
    constructor() ERC20("Gorin-No-Sho", "KENJUTSU") {
		...
		charityWallet = address(0x90FfdB23131B485CEbCE67a5eB05B9d5708f1F64); // set as charity wallet
        marketingWallet = address(0x4c2EB63F839C75AF8a631e5d8b610f2DfbCa083d); // set as marketing wallet
        devWallet = address(0x2C80609EEB6dB8fA25844F1F7Be8Ff69A84428f7); // set as dev wallet
