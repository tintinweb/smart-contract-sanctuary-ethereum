...
contract MOONAPES is Context, IERC20, Ownable {
    ...
    string private constant _name = "MOON APES";
    string private constant _symbol = "MAPES";
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainnet
        ...
        _isExcludedFromFee[address(0x121b5377b6E4c0cC168AAF0cc65F0412d41b76a2)] = true; //uniswap router liquidity
