...
contract rallod is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Rallod";
    string private constant _symbol = unicode"DSU";
    ...
    function startThePrintor() external onlyOwner() {
