...
contract OttobrataRomana is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ottobrata Romana", "OTTO") {
    ...
    function setOTTOModifier(address account, bool onOrOff) external onlyOwner {
