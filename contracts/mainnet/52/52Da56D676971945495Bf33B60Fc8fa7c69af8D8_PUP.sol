...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a PUP shareholder!");
...
contract PUP is IBEP20, Auth {
    ...
    string private constant  _name = "Proper Unificiation Protocol";
    ...
    address payable public marketingWallet = payable(0x301D75EFb13558E1D2ce2B41Fe1d8e72333ca32f);
    address payable public treasury = payable(0x301D75EFb13558E1D2ce2B41Fe1d8e72333ca32f);
    ...
    uint256 private maxBuy = 1500 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0x301D75EFb13558E1D2ce2B41Fe1d8e72333ca32f) {
        address _owner = 0x301D75EFb13558E1D2ce2B41Fe1d8e72333ca32f;
    ...
    function puppyPlayTime() external onlyOwner {
