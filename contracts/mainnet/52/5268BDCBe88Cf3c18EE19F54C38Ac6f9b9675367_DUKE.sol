...
https://t.me/officialdukeerc

https://twitter.com/officialdukeerc
...
contract DUKE is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'DUKE';
    string private constant _symbol = 'DUKE';
    ...
    address internal constant development_receiver = 0x7703Dc115Ee1F8cD44B86b99E01dd48611e4d3F9; 
    address public constant marketing_receiver =0x26f163aadAD43558B265Ac02173c813f9C9B0697;
    address public constant liquidity_receiver = 0x7703Dc115Ee1F8cD44B86b99E01dd48611e4d3F9;
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(10 minutes) <= block.timestamp){totalFee = uint256(4000); sellFee =uint256(6000);}
        if(launchTime.add(60 minutes) <= block.timestamp){totalFee = uint256(1000); sellFee =uint256(2000);}
        if(launchTime.add(120 minutes) <= block.timestamp){totalFee = uint256(500); sellFee =uint256(500);
            ATLSCompletion = true;}
    }
