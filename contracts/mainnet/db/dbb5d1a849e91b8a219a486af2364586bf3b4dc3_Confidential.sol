...
contract Confidential is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "CONFI";
    ...
    address payable private _developmentAddress = payable(0xd441fA2885894663C799C2aafd64A7bAa764C427);
    address payable private _marketingAddress = payable(0xd441fA2885894663C799C2aafd64A7bAa764C427);
