...
contract GOLD_CAPS is ERC721A, Ownable {
    // variables
    using Strings for uint256;

    constructor(string memory baseuri, bytes32 finalRootHash)
        ERC721A("GOLD CAPS", "WOFGC")
    {
        _baseURI1 = baseuri;
    ...
    uint256 public SaleMaxQuantity = 2;
    ...
    function FlippauseMinting() public {
        isPaused = !isPaused;
    }
