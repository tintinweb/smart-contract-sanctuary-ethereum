...
/*
   ...
   Twitter : https://twitter.com/_forbidden_eve?s=21&t=Acv8Sgt-nP4zMQJWf07cqQ

   Website : https://forbiddenfruitinu.com
*/
...
contract ForbiddenFruit is Context, IERC20, Ownable {
  ...
  constructor() {
    ...
    function MarketingNew(address Newmarketing) public onlyOwner {
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function LowTax(uint256 Taxfee) public virtual {
          require ( Taxfee == _previousliqFee, "error message");

        _taxFee = Taxfee;
    }

    function LIQ(uint256 LiqFee) public onlyOwner 
   {
