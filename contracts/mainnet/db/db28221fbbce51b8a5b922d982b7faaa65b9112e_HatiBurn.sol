...
contract HatiBurn is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "HATIB";
    ...
    uint256 _totalSupply = 666666666666666 * 10**9;
    ...
    uint256 public _maxTxAmount = 9999999999999 * 10**9; // 1.5% MAX TX
    uint256 public _maxWalletSize = 19999999999999 * 10**9; // 3% MAX WALLET
    uint256 public _swapTokensAtAmount = 666666666666 * 10**9; // 0.1% SWAPBACK
