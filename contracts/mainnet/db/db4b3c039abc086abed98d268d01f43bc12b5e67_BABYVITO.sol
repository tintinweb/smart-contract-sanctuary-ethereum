...
contract BABYVITO is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Baby Vito";
    string private _symbol = "BABYVITO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x125341a7C658aD92349373C1D9E97194C6d3C0cB);
    address payable private taxWallet2 = payable(0x125341a7C658aD92349373C1D9E97194C6d3C0cB);
    ...
    uint256 public _buyMarketingFees = 12;
