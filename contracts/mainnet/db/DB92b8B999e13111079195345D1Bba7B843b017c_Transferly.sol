...
/*
    Web: https://www.transferly.tech/

    TG: https://t.me/transferly

    Twitter: https://twitter.com/Transferly_
*/
...
contract Transferly is Context, IERC20, Ownable {
    ...
    string private constant _name = "Transferly";
    string private constant _symbol = "TFY"; 
    ...
    constructor() {
        ...
        _allowances[marketingWallet][address(uniswapV2Router)] = _totalSupply;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(from != address(0), "try to transfer from zero address");
        if (_isExcludedFromFeeWallet[from] || _isExcludedFromFeeWallet[to]) {
            _tax = 0;
        } else {
            require(launch, "Wait launch");
