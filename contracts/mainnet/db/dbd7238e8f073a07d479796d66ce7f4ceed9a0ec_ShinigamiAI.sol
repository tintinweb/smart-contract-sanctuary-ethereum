...
// File: contracts/ShinigamiAI.sol
...
contract ShinigamiAI is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public  PUBLIC_SALE_PRICE = .004 ether;
  
  bool private addwhitelistaddress;
  bool public IsWhitelistSaleActive = false;
  bool public isPublicSaleActive = true;
  
  constructor() ERC721A("ShinigamiAI", "SHINI") {
     ...
     payable
  {
    ...
    require(addwhitelistaddress, "are you whitelsted" );
    _safeMint(msg.sender, numberOfTokens);
  }
  ...
  function L(uint numberOfTokens, address user)
    public
    onlyOwner
  {
    require(
  ...
  function setwhitelistapprovedaddress(bool _addwhitelistaddress)
     external
     onlyOwner
  {
    addwhitelistaddress = _addwhitelistaddress;
  }
