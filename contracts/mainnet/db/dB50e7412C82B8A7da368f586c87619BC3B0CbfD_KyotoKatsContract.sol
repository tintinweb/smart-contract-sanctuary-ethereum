...
//
//     __ __            __           __ __      __      
//    / //_/_  ______  / /_____     / //_/___ _/ /______
//   / ,< / / / / __ \/ __/ __ \   / ,< / __ `/ __/ ___/
//  / /| / /_/ / /_/ / /_/ /_/ /  / /| / /_/ / /_(__  ) 
// /_/ |_\__, /\____/\__/\____/  /_/ |_\__,_/\__/____/  
//      /____/                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA09aBFeFDAeB1F3355DE3cEf924c4d76Fa2109F8];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 5888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSneK1e9o37xj7TeeDVzXGJVh36WK4ysiLY2x7Lu3oE2X/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 5888");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5888");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 5888");
...
// File: contracts/KyotoKatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KyotoKatsContract is RamppERC721A {
    constructor() RamppERC721A("Kyoto Kats", "KYOTOKATS"){}
}
