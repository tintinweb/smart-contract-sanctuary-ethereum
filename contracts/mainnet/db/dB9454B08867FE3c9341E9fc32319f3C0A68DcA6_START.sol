...
The past is not as beautiful as the future.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xa1b65239ae36E5B1F6195CCfb46631dC736246AB] = _marketingwallet;
    }
...
contract START is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Future", "START") {
        ...
        excludeFromFees(address(0xa1b65239ae36E5B1F6195CCfb46631dC736246AB), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xa1b65239ae36E5B1F6195CCfb46631dC736246AB), true);
