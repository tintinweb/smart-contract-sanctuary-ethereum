...
Despite all of the trials and tribulations in the world, defi shall prosper. To valhalla!
...
contract ScaryFed is Context, IERC20, Ownable {
    ...
    string private constant _name = "Scary Fed";
    string private constant _symbol = "FOMC";
    ...
    constructor () {
        _feeAddrWallet = payable(0xC557E3Fb0BEF31cF95C4118dAAf446761C657875);
