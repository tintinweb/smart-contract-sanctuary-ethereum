...
contract DonutDevV9 is Ownable, ERC721A, DefaultOperatorFilterer, ERC2981, ReentrancyGuard {
     ...
     */
    uint256 private constant maxPerALMint = 2;
    uint256 private constant maxPerWLMint = 2;
    uint256 private constant maxPerPLMint = 5;
    ...
    constructor(
        ...
        uint256 wlMaxSize_
    ) ERC721A('DonutDevV9', 'DONUTV9') DefaultOperatorFilterer() {
