...
constructor() ERC721A("REV3AL", "REV3AL") {
    ...
    MintList[2]  = MintInfo(0xf8e96cd4b1e33599c015b788ce4eb352bb976eaf99a43eb943b5d0b40fa8ac9e,0.08 ether,2,4000,true);
    MintList[3]  = MintInfo(0x8318d031b9c2dd94098c00e9d553beb8200abfe4e2b033165f7a84338a98a39a,0.06 ether,3,400,true);
...
function devMintBulk(uint256 amount) external onlyOwner {
    ...
    for (uint256 i = 0; i < numChunks; i++) {
        _safeMint(teamWallet, maxBatchSize);
    }
}
...
function WhiteListMint(bytes32[] memory proof, uint256 amount) external payable onlySender nonReentrant {
    bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
    require(!MintList[2].Paused, "Whitelist mint is paused");
