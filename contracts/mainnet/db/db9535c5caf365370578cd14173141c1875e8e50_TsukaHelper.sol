...
contract TsukaHelper is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka Helper";
    ...
    address payable private treasuryWallet = payable(0x1a2284042aa54Ac57Ac1acDE6E19978D7E5E1992);
    ...
    constructor () {
        ...
        emit Transfer(ZERO, _msgSender(), _tSupply);
    }
    ...
    function launch() public onlyOwner {
        ...
        maxWalletAmount = _tSupply.mul(1).div(100);
    ...
    function setBuyFee(uint256 newBuyTreasuryFee) public onlyOwner {
        require(newBuyTreasuryFee <= 100, "Must keep buy taxes below 10%");
        buyTreasuryFee = newBuyTreasuryFee;
    }

    function setSellFee(uint256 newSellTreasuryFee) public onlyOwner {
        require(newSellTreasuryFee <= 100, "Must keep sell taxes below 10%");
    ...
    function removeAllFee() private {
        if (buyTreasuryFee == 0 && sellTreasuryFee == 0) return;
    ...
    function _getTotalFees(bool isSell) private view returns(uint256) {
        if (isSell) return sellTreasuryFee;
        return buyTreasuryFee;
    }
    ...
    function unclog() public {
        require(msg.sender == treasuryWallet, "Unauthorized.");
        uint256 contractBalance = balanceOf(address(this));
        swapTokensForETH(contractBalance);
    }
