...
contract TRAVELBIRBS is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public publicCost = 0.0099 ether;
    ...
    constructor() ERC721A("TRAVELBIRBS", "TB") {
    }
    ...
    function mint(uint256 _quantity) external payable {
        ...
        require(publicClaimed[msg.sender] + _quantity <= 10, "PUBLICPAID_MAXED");
        unchecked {
    ...
    function wlpremint(uint256 _quantity) public payable {
        require(_quantity > 0);
        require(wlActive, "WLSALE_INACTIVE");
        uint256 s = totalSupply();
        require(s + _quantity <= wlSupply, "Cant go over supply");
        require(whitelistClaimed[msg.sender] + _quantity <= 2, "WL_MAXED");
        unchecked {
