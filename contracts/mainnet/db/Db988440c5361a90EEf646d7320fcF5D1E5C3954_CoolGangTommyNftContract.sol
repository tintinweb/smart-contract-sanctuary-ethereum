...
//   / ____/___ ____ / / / ____/___ _____ ____ _ /_ __/___ ____ ___ ____ ___ __ __
//  / / / __ \/ __ \/ / / / __/ __ `/ __ \/ __ `/ / / / __ \/ __ `__ \/ __ `__ \/ / / /
// / /___/ /_/ / /_/ / / / /_/ / /_/ / / / / /_/ / / / / /_/ / / / / / / / / / /_/ /
// \____/\____/\____/_/ \____/\__,_/_/ /_/\__, / /_/ \____/_/ /_/ /_/_/ /_/ /_/ \__, /  
//                                         /____/ /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9CF4A4974fa9425B098EAEb6451c8044BDC49BF6];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmcgZ54yub9EPheYUG92pNdzKWGyXrHssPVRChKWDoAhgj/";
...
// File: contracts/CoolGangTommyNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolGangTommyNftContract is RamppERC721A {
    constructor() RamppERC721A("Cool Gang Tommy NFT", "CGT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Iy9ZnGgAeDscDdtBpras/contract-metadata";
    }
}
