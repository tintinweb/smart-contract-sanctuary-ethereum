...
// File: contracts/daidigigaku.sol
...
contract DaiDigigaku is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public PUBLIC_PRICE = .0035 * 10**18;
    ...
    constructor(string memory initBaseURI) ERC721A("Dai Digigaku ", "DADIGI") {
        baseURI = initBaseURI;
