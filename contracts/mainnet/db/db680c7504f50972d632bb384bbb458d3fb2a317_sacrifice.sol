...
contract sacrifice  is ERC721A, Ownable {
    ...
    function sacrificeSummon(uint256 amount) public payable callerIsUser{
    ...
    function teamSummon(uint256 quantity) external payable onlyOwner {
