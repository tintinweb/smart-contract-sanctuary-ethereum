...
// File: contracts/RbdToken.sol

pragma solidity ^0.4.24;
/*
 * RbdToken is a standard ERC20 token with some additional functionalities:
...
contract RbdToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "RBD";
	string public constant name = "Rubidium";
	uint8 public constant decimals = 18;
	uint256 public constant INITIAL_SUPPLY = 100000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 100000000 * (10 ** uint256(decimals));
	...
	* @param value Amount of rbdtokens to send
	*/
