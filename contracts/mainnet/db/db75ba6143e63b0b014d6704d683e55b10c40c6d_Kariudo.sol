...
contract Kariudo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("A Hunters Wish", "Kariudo") {
        ...
        maxTransactionAmount = 10000000000 * 1e18;
    ...
    function updateMaxTransAmount(uint256 newNum) external onlyOwner {
