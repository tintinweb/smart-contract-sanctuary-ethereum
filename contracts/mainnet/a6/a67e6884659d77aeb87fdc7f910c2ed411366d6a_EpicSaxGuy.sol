...
/*⠀⠀⠀
    ...
    A tribute for the very best meme that ever existed.

    Bringing back the 2000's vibes.
...
contract EpicSaxGuy is ERC20, Ownable {
    ...
    constructor() ERC20("Epic Sax Guy", "SAXROLL") {
        ...
        marketingWallet = address(0xeA2d904F9949D1D80424979784892630be4d9C65); // set as marketing wallet
        devWallet = address(0xeA2d904F9949D1D80424979784892630be4d9C65); // set as dev wallet
