...
// EtherBank ($ETHBANK🏦) - $eth Reflection token

//🔥Rewards are in $ETH!! 🔥

Hold EtherBank & Earn $eth.

The EtherBank protocol is a community inspired DeFi experiment built on Ethereum.

EtherBank tokens are the keys to your share of Eth held in the Dividend Wallet. Eth accumulating in the Dividend Wallet will be auto distributed.
3% of every buy/sell is deposited into the EtherBank Treasury Wallet ready to be auto redistributed by EtherBank holders in $Eth. 

BUY TAX: 7%
Refelctions: 3% + Liquidity: 2% + Marketing&Team: 2%  = 7%

SELL TAX: 10%
Refelctions: 4% + Liquidity: 2% + Marketing&Team: 4%  = 10%

Max Tx: 2% & Max Wallet 4% >> Slippage - 8% -12%
 
✅ dApp Eth Treasury Dashboard
✅ Anti-Whale, Front-running Bot provisions 
✅ Dedicated Dev & Strategy Team & Exciting DeFi Roadmap
✅ Massive Eth Bounties, Giveaways & rewards to community members
       
Website: https://etherbank.club/
Telegram: https://t.me/etherbankclub
Twitter: https://twitter.com/etherbank_club

Developed & Backed by SevenDayClub.

🔹 🔹 Introducing the Seven Day Club 🔹 🔹

Seven Day Club is formed to design, develop & manage most safest ethereum community on blockchain. Given the hardest times
we wanted to give you 100% Safe Play's through the club and grow reliable community organically. We have a rich plan of action,
roadmap & vision.

✅ Our Each Play's Liquidity will be intially Locked for 7 DAYS -then graudally increasing the Lock as per growth of the token.

>> Every decision in the club will be taken by community.
>> We are in process of creating a DAO.

✅ Support this Play and make the Based Dev the most trusted one on Blockchain.

Our Deployer: sevendayclub.eth
...
Dev twitter: https://twitter.com/bobonblock

🥇 The 1st Play of Seven Day Club : ETHERBANK - $ETH Rewarding Token
