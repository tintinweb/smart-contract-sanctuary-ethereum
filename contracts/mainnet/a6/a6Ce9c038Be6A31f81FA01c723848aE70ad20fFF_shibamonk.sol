...
For every transaction in the Shiba Monk contract has a 6% fee is used to keep the chart building green candles and keep the deflationary system going by burning 1 percent of the transaction to a dead wallet.

Socials links

Telegram https://t.me/shibamonkETH

Twitter https://twitter.com/SHIB_MONK

Website https://www.shibamonk.net
...
contract shibamonk is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shib Monk";
