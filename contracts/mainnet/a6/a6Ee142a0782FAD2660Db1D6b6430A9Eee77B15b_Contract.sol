...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    uint128 internal _currentIndex = 2223;
    ...
    function totalSupply() public view override returns (uint256) {
        ...
        unchecked {
            return _currentIndex - 2223 - _burnCounter;    
        }
    }
    ...
    function tokenByIndex(uint256 index) public view override returns (uint256) {
        uint256 numMintedSoFar = _currentIndex - 2223;
        uint256 tokenIdsIdx;
    ...
    function ownershipOf(uint256 tokenId) internal view returns (TokenOwnership memory) {
        ...
        unchecked {
            if (curr > 2222 && curr < _currentIndex) {
    ...
    function _exists(uint256 tokenId) internal view returns (bool) {
        return tokenId > 2222 && tokenId < _currentIndex && !_ownerships[tokenId].burned;
    }
