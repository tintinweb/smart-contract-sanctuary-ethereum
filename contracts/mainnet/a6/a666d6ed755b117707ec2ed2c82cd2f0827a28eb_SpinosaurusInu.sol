...
/**
 ...
 https://twitter.com/SpinosaurusInu
 https://www.spinosaurusinu.com
 https://t.me/Spinosaurusinu
...
contract SpinosaurusInu is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_000_000 * 10**9; 

    string private constant _name = "TALE OF DINO"; 
    string private constant _symbol = "SPINOSAURUS"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 20;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x98069ab4ea81E22F897Ba44271092F3fA72c8580; 
    ...
    function delbots(address account, bool value) external onlyOwner {
    ...
    function RemoveLimits(uint256 maxTxPercent) external onlyOwner() {
