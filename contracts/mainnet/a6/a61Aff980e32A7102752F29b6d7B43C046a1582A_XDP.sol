...
contract XDP is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"0xDApp"; 
    string private constant _symbol = unicode"XDP"; 
	...
	function setXDPMarketingWallet(address payable MarketingWallet) external onlyOwner() {
