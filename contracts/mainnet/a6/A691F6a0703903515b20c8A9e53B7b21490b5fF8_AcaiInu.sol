...
contract AcaiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Acai Inu";
    string private constant _symbol = "ACAI";
    ...
    address payable private _marketingAddress = payable(0x8574A86Fde42D13A1d5784B61B6f45191978B444);
    ...
    uint256 public _maxTxAmount = 2000000000000 * 10**9; //2.0
    uint256 public _maxWalletSize = 3000000000000 * 10**9; //3.0
