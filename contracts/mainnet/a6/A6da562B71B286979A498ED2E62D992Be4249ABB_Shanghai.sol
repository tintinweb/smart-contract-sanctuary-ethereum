...
contract Shanghai is Context, IERC20, Ownable {
    ...
    // Context
    string private _name = "Shanghai Shiba";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xbD8F46Cf719DDB4Dbf8D8484691C33eB162650cf);
    address payable public operationsWallet =  payable(0xbD8F46Cf719DDB4Dbf8D8484691C33eB162650cf);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    // fees    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 7;
    uint256 public totalFeesBuy;
    uint256 public maxTotalFeeBuy = 10;

    // fees
    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 7;
