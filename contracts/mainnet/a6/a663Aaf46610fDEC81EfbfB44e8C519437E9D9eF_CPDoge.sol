...
contract CPDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CPDoge";
    string private _symbol = "CPDoge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDea38a6a93268b6653e17b99E5C346514995C6e7);
    address payable public teamWalletAddress = payable(0xdE592D3f704892BBF70B0044071e019A0055552F);
    ...
    uint256 private MaxSupply =     100000000 * 10**_decimals;
    ...
    constructor () {
        ...
        _allowances[address(this)][address(uniswapV2Router)] = MaxSupply;
    ...
    function setblockK(uint256 _blockK)external onlyOwner() {
        blockK = _blockK;
    }
    ...
    function getstartingTimeAt()public view returns (uint256) {
        return startingTime;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (sender == uniswapPair) {
            if (block.number <= (startingTime + blockK)) { 
