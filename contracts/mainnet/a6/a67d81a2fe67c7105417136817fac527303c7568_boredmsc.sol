...
// Created by Boredmonkeysockclub
// www.boredmsc.com
...
contract boredmsc is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(
    ...
    cost = 0.01 ether * _cost;
    setMaxSupply(_maxSupply);
    maxMintAmount = _maxSupply;
    walletLimit = _maxSupply;
    mint(msg.sender, _reserve);
  }
