...
import { RoleControl } from '../abstracts/RoleControl.sol';
import { IERC2981 } from '@openzeppelin/contracts/interfaces/IERC2981.sol';
 ...
 */
contract ERC721ContractMetadataCloneable is ERC721ACloneable, TwoStepOwnable, RoleControl, ISeaDropTokenContractMetadata {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC721ACloneable, RoleControl) returns (bool) {
        return
            interfaceId == type(IERC2981).interfaceId ||
            interfaceId == 0x49064906 || // ERC-4906
            super.supportsInterface(interfaceId);
