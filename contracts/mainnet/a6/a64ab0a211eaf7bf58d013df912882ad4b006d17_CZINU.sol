...
/**
Cz Inu - the Superman of crypto.
$CZI
0% tax . locked and renounced
 */
...
contract CZINU is ERC20, Ownable {
    ...
    constructor() ERC20("CZ INU", "CZI") {
        ...
        marketingWallet = address(0xAA316d3e5b1BEeb2Dc44692c8f69AEa18469a7e3); // set as marketing wallet
        devWallet = address(0xAA316d3e5b1BEeb2Dc44692c8f69AEa18469a7e3); // set as dev wallet
