...
contract MIRAGE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "MIRAGE";
    string private constant tokenSymbol = "MIRAGE";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x99c20c957379BB1d809f8Ad6d870B57A296c3e9D);
        devAddress = payable(0x99c20c957379BB1d809f8Ad6d870B57A296c3e9D);
