...
contract OCTOSWAP is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "October Swap";
    string private constant _symbol = "OCTOSWAP";
    ...
    address payable private _developmentAddress = payable(0x99DecA72430ccE7C95A3AE55EFE51E3387F3eB66); 
    address payable private _marketingAddress = payable(0x99DecA72430ccE7C95A3AE55EFE51E3387F3eB66);
