...
contract PYROCRATS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "PYROCRATS";
    ...
    address payable private _developmentAddress = payable(0xFb78Ed797e01E592B6EFE732233C245aBaE0b19b);
    address payable private _marketingAddress = payable(0xFb78Ed797e01E592B6EFE732233C245aBaE0b19b);
