...
A token created for all the countries playing in the World Cup. We believe that we can create an ultimate world cup token by bringing in people from all of these countries! 

World Cup Countries ⚽️🏟️
...
contract WC22 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WCCOUNTRIES";
    string private constant _symbol = unicode"WC22";
