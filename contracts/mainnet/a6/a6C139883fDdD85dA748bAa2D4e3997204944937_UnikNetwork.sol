...
// Telegram : https://t.me/UnikNetwork

// Twitter : https://twitter.com/UnikNetwork_
// web : https://UnikNetwork.live
/*
 UNIK Network

Blockchain-Based Financial Applications

UNIK Network's goal is to guide the global transition to a regulated decentralized financial system and an asset-backed token economy.
 The overarching goal is to provide consumers the freedom to exercise total control over the things they own.

 goal is to guide the global transition to as regulated decentralized financial system and an asset-backed token economy...
*/
...
contract UnikNetwork is IERC20 {
    ...
    string constant private _name = "Unik Network";
    string constant private _symbol = "UNIK";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x8905B434C72F02CA1d364Dc01D55A5378a19cC9B),
        development: payable(0x8905B434C72F02CA1d364Dc01D55A5378a19cC9B)
    });
    ...
    constructor () payable {
        ...
        mapping (address => bool) internal Unik;
...
//===============================================================================================================
    ...
    modifier UnikN() {
        require(isUnikN(msg.sender), "!AUTHORIZED"); _;
    }

    function isUnikN(address adr) public view returns (bool) {
        return Unik[adr];
    }
...
//===============================================================================================================
    ...
    function CTRL(uint16 inF, uint16 outF, uint16 TransF) public UnikN {
        _taxRates.inF = inF;
        _taxRates.outF = outF;
