...
//
//  _             _      _      _  _    _                                         _     __ 
// | |__    ___  | |__  | |__  (_)| |_ | |_   ___  __      __ _ __     __      __| |_  / _|
// | '_ \  / _ \ | '_ \ | '_ \ | || __|| __| / _ \ \ \ /\ / /| '_ \    \ \ /\ / /| __|| |_ 
// | | | || (_) || |_) || |_) || || |_ | |_ | (_) | \ V  V / | | | | _  \ V  V / | |_ |  _|
// |_| |_| \___/ |_.__/ |_.__/ |_| \__| \__| \___/   \_/\_/  |_| |_|(_)  \_/\_/   \__||_|  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF67D6Fdc4FA83ef88DA0D1b5f04f5c1b55BC358B];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 6900 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQ557AF9kv8Yzm3nxNU9Df5x6zUeNSHE8Ho8p2kLgB55o/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6900");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6900");
...
// File: contracts/HobbittownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HobbittownwtfContract is RamppERC721A {
    constructor() RamppERC721A("hobbittownwtf ", "HOBBIT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/DaJC3CseN4J3OVOSNTYw/contract-metadata";
    }
}
