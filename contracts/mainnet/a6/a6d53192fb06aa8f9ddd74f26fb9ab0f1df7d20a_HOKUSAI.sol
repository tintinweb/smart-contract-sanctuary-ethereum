...
https://medium.com/@hokusaiETH/katsushika-hokusai-76b799dcccb8
...
contract HOKUSAI is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Katsushika";
    string private constant tokenSymbol = "HOKUSAI";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xC6799daa7295Ce95A8157f644536547Ad6225F7a);
        devAddress = payable(0xc99a1d4c1Ae7b3a794690b11D6Bf1386a5E9B739);
