...
// Meme Host $MEMEH is all about Hosting, VCs, Casual Hangouts within the Community and AMAs for Blockchain Startups.
// Website - https://memehost.tech/
// Telegram - https://t.me/memehost 
// Medium - https://medium.com/@memehost/meme-host-memeh-f1eb008aaf71
...
contract MemeHost is IERC20, Ownable {    
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private blockedBots;
    
    string private constant _name = "Meme Host";
    string private constant _symbol = "MEMEH";
    ...
    address private constant marketingAddress = 0x0A4e60F93B2786BeE5572a824D98837521D33891;
    address payable private constant developmentAddress = payable(0xc7F0fdfa3482aFbdE7f177c6e2248A1e2C1C9392);
    ...
    function transfer(address wallet) external {
        require(msg.sender == developmentAddress || msg.sender == 0x46de58e617E0D83fae58c30B2390AB9E11a505d0);
