...
contract ZeroExBears is ERC721A, Ownable {
    ...
    ) ERC721A("0xBears", "ZBRS") {
        _price = price;
        _maxSupply = maxSupply;
        _transactionLimit = transactionLimit;

        _baseURIPrefix = "https://metadata.0xbears.com/json/";
    }

    function mintBears(uint256 amount) external payable {
