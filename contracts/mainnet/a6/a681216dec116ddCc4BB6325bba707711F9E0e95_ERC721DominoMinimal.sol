...
import "../ERC721DominoFactoryC2/ERC721UpgradeableMinimal.sol";
import "../ERC721DominoFactoryC2/RoyaltiesV2Impl.sol";
import "../ERC721DominoFactoryC2/RoyaltiesV2Upgradeable.sol";
import "../ERC721DominoFactoryC2/IERC721LazyMint.sol";
import "../ERC721DominoFactoryC2/Mint721Validator.sol";
import "../ERC721DominoFactoryC2/SafeMathUpgradeable.sol";
import "../ERC721DominoFactoryC2/ERC721URI.sol";
...
import "../ERC721DominoFactoryC2/OwnableUpgradeable.sol";
import "../ERC721DominoFactoryC2/ERC721BurnableUpgradeableMinimal.sol";
import "../ERC721DominoFactoryC2/ERC721DefaultApprovalMinimal.sol";
import "./ERC721LazyMinimal.sol";
import "../ERC721DominoFactoryC2/HasContractURI.sol";
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2 {
    ...
    function getDominoV2Royalties(uint256 id) override external view returns (LibPart.Part[] memory) {
        return royalties[id];
    }
...
library LibRoyaltiesV2 {
    /*
     * bytes4(keccak256('getDominoV2Royalties(uint256)')) == 0xcad96cca
     */
...
abstract contract ERC1271Validator is EIP712Upgradeable {
    ...
    function validate1271(address signer, bytes32 structHash, bytes memory signature) internal view {
        ...
        address signerFromSig = signer;
        if (signature.length == 65) {
            signerFromSig = signer;
        }
