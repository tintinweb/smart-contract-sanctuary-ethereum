...
contract OrbofBlur is ERC721A {
    ...
    constructor() ERC721A("Orb of Blur", "orb") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeif7iefhhjce5x4odvneqmwoky4pk2othvzi23tvxkwliumxwd6r5i/", _toString(tokenId), ".json"));
    }
