...
// | $$  | $$ /$$__  $$| $$      | $$_  $$       | $$      | $$  | $$| $$  | $$| $$  | $$| $$_____/  | $$ /$$
// | $$$$$$$/|  $$$$$$$| $$      | $$ \  $$      | $$      |  $$$$$$/| $$$$$$$/| $$$$$$$/|  $$$$$$$  |  $$$$/
// |_______/  \_______/|__/      |__/  \__/      |__/       \______/ | $$____/ | $$____/  \_______/   \___/  
//                                                                   | $$      | $$                          
//                                                                   | $$      | $$                          
//                                                                   |__/      |__/                          
//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xAdCB77fe4cc7154734edB3A1c3baFD584CB917Ea];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xAdCB77fe4cc7154734edB3A1c3baFD584CB917Ea;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiberatdx5o25sd5sjn6irkss2xmol3b4ymmchxrale44fssxrb2ya/";
...
// File: contracts/DarkPuppetContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DarkPuppetContract is RamppERC721A {
    constructor() RamppERC721A("Dark Puppet ", "Darkpuppet"){}
}
