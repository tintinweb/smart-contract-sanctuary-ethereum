...
contract GhostofTsushima is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ghost of Tsushima";
    ...
    address payable private _developmentAddress = payable(0x479CAdAE5cDd6450874DaE126Ff1CD17f1308b20); 
    address payable private _marketingAddress = payable(0x479CAdAE5cDd6450874DaE126Ff1CD17f1308b20);
