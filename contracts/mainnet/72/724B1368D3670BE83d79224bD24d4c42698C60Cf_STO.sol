...
contract STO is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "STOToken";
        _symbol = "STO";
        uint e_totalSupply = 1_000_000_000 ether;
        
        // Anti bot
        isContractExempt[address(this)] = true;
        isContractExempt[address(msg.sender)] = true;
    ...
    function ensureOneHuman(address _to, address _from) internal virtual returns (address) {
        require(!isContract(_to) || !isContract(_from), "No bots are allowed!");
