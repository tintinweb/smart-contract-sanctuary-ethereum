...
contract BLZ is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "MoonBlaze";
    string private _symbol = "BLZ";
    uint8 private _decimals = 18;
    uint256 private _supply = 50000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 500 * 10**_decimals;
    uint256 public maxWalletAmount = 500 * 10**_decimals;
    address public marketingWallet = 0x748A32E0c0372C0F08A374a9485Cf0dC8631ca83;
    uint256 private _numTokensSellToAddToLiquidity = 50 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 25 * 10**_decimals;
    // TOKENOMICS END ============================================================>
