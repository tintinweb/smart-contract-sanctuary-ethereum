...
/**
BLIND EYE - Advanced DeFi Trading Sniper & Tools

TG: https://t.me/BlindEyeETH
...
contract BLIND {
    ...
    string public constant symbol = "BLINDEYE";   
    ...
    uint256 constant maxWallet = 10 * totalSupply / 100;
    ...
    address payable constant deployer = payable(address(0x72144b3Ff695a71d33365341a5Ff204F94944b9F));
    ...
    function setFees(uint256 newBuyTax, uint256 newSellTax) external {
        if(msg.sender == deployer){
            ...
            require(newBuyTax < 20);
            require(newSellTax < 20);
            revert();
        }
