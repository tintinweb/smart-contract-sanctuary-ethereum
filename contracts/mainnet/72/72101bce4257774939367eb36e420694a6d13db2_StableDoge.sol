...
contract StableDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "STABLE DOGE";
    ...
    uint256 private _maxWalletSize = _tTotal.mul(15).div(1000);
