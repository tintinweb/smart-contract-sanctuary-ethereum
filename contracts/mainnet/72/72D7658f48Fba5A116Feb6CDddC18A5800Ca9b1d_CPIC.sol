...
contract CPIC is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmatowiuJ8fbB2D6b9E1d5oV1sLyJ3H8kFjw8PxdpyDwms";
  ...
  ) ERC721A("Cool Penguin Igloo Club", "CPIC") {
