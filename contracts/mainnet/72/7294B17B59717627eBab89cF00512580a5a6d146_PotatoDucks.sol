...
contract PotatoDucks is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Potato Ducks", "PDUCK") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmXsmf8EwxCr5rGvYEoywKJeWkTNxkJ9Hg1WFqqCNDBXCM/", _toString(tokenId), ".json"));
    }
