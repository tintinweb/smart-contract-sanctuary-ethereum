...
// Telegram : https://t.me/SHIKOKOINU

// Twitter : htpps://twitter.com/SHIKOKOINU
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5195A4a450375e61d31E42e608168cbcaF5001f0;
        SHIKOKO[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal SHIKOKO;
    ...
    modifier SHIKMANAGER() {
        require(isSHIKMANAGER(msg.sender), "!SHIKMANAGER"); _;
    }

    function isSHIKMANAGER(address adr) public view returns (bool) {
        return SHIKOKO[adr];
    }
...
contract SHIKOKOINU is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x5195A4a450375e61d31E42e608168cbcaF5001f0);
    ...
    */
    ...
    string private _name = "SHIKOKO INU"; 
    string private _symbol = "SHIKOKO";  
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x5195A4a450375e61d31E42e608168cbcaF5001f0] = true;
    ...
    */
    ...
    function _set_Feees(uint256 Buy_Fee, uint256 Sell_Fee) external SHIKMANAGER() {
