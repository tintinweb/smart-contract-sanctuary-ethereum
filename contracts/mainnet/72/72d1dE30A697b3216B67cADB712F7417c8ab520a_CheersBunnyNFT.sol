 ...
 * @notice This contract handles minting Cheers Bunny NFT tokens.
 */
contract CheersBunnyNFT is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x601937D30a0618356D94852b16b546Dd57cde0f3;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xcEa01dBff5c663c2940302C60321d9Ce47185FB5;
    address[] public payoutAddresses = [
        0xcEa01dBff5c663c2940302C60321d9Ce47185FB5
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeiabs5tdafzg35s7yxn76kas6ajgmvfarcosluujphqox2gimgsvli/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 4444;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 4444;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Cheers Bunny NFT", "BUNNY")
        RevokableOperatorFilterer(
