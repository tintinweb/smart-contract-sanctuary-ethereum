...
An Erc20 Token LOADED WITH WEED 🌿

If you don’t wanna die SOBER 
Come INNN!!!!

5% tax will be deducted as Weed is not free lmao 

Highgram: t.me/highinuentry
Highsite: Highinu.com
...
contract HighInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "HIGH INU";
    ...
    address payable private _developmentAddress = payable(0xcD67FDcD49C71Ed141E9E2ED891e8E3A285f67Eb);
    address payable private _marketingAddress = payable(0xcD67FDcD49C71Ed141E9E2ED891e8E3A285f67Eb);
