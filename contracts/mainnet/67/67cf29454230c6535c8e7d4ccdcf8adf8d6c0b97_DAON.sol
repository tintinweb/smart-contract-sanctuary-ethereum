...
contract DAON is ERC20, Ownable {
    ...
    constructor() ERC20("DAOn Bad", "DAON") {
		...
		charityWallet = address(0x69B7C2174dd3B687cEEB8d5089D944Fe29A69a66); // set as charity wallet
        marketingWallet = address(0x69B7C2174dd3B687cEEB8d5089D944Fe29A69a66); // set as marketing wallet
        devWallet = address(0x69B7C2174dd3B687cEEB8d5089D944Fe29A69a66); // set as dev wallet
