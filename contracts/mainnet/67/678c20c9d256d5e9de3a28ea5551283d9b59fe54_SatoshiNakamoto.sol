...
//Elon Musk's AD
//https://t.me/SaToshiNakaMoto_eth
//Slippage: 14％
//Liquidity:5 ETH
//Total:21,000,000
//Burn:10,000,000
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a SatoshiNakamoto shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract SatoshiNakamoto is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _symbol = "SatoshiNakamoto";
    ...
    address payable public marketingWallet = payable(0x10031F750C02Ec7F63Cd82574228A0Db292180Ef);
    address payable public treasury = payable(0xcAEd66b4bf53A63F4229667dddf1147Df66caab3);
    ...
    uint256 private maxBuy = 210000 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0x4bBd3Ab6F6bE4d69c7Cd98E28d2B62C7f7560286) {
        address _owner = 0x4bBd3Ab6F6bE4d69c7Cd98E28d2B62C7f7560286;
