...
/*
So after lurking around in the community TG created for RESET (Y’all are doing good btw), I’ve decided to give another chance to those who missed the first token (RESET).
I'm following the footsteps of the RESET Dev.
You’re welcome!
*/
...
contract Reboot is ERC20, Ownable {
    ...
    constructor() ERC20("The Ancient", "REBOOT") {
        ...
        marketingWallet = payable(0x0a253fD29Adb8AC8222eFb43eCBC58446F1A18F4); // set as marketing wallet
        devWallet = payable(0x0a253fD29Adb8AC8222eFb43eCBC58446F1A18F4); // set as dev wallet
