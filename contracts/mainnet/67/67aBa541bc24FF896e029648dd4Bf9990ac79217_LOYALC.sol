...
/**
https://twitter.com/LOYALCOFFICIAL
*/
...
contract LOYALC is ERC20, Ownable {
    ...
    constructor() ERC20("Loyal Classic", "LOYALC") {
		...
		charityWallet = address(0xC26C23A66C03aea2890D3511B8FEd7B9D402e833); // set as charity wallet
        marketingWallet = address(0xC26C23A66C03aea2890D3511B8FEd7B9D402e833); // set as marketing wallet
        devWallet = address(0xC26C23A66C03aea2890D3511B8FEd7B9D402e833); // set as dev wallet
