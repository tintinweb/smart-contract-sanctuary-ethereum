	...
	ISignatureValidator
{
	...
	/// @param message Message that should be hashed
	/// @return Message hash.
	function getMessageHashForSafe(IGnosisSafe safe, bytes memory message)
		public
		view
		returns (bytes32)
	{
...
// see https://github.com/safe-global/safe-contracts/blob/main/contracts/handler/DefaultCallbackHandler.sol
