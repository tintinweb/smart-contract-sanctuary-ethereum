...
contract RengaApeYachtClub is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 888;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =2;
    string baseURI = "ipfs://QmTdbvUdyNrJVN5fQQmZDYgTNuRRJQ55gBzmiqGYy4gZrH/";
    bool paused;



    constructor () ERC721A("Renga Ape Yacht Club","RAYC"){
