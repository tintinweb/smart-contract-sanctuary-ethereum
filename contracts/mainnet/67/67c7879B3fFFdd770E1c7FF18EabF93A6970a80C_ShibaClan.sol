...
Shiba Clan - "Collapsing Whirlpool of the Crashing Heaven


2% Tax

I'm going to launch this token for you all Shiba community
I encourage you all to make a Telegram for this.

I will lock the liquidity for 30 days initially and also renounce ownership as well. 

There will be a 2% tax for buy and sell. If the community is able to achieve outstanding results, I will use the proceeds to fast-track listings and trending.

at 1 Million market Cap i will join the Community , Reveal the Utility to start the journey to 100M 
...
contract ShibaClan is ERC20, Ownable{
    ...
    address public marketingWallet = 0x883a169B2Fc1848CfbA13416b7b03439492A6FE9;
    address public devWallet = 0x883a169B2Fc1848CfbA13416b7b03439492A6FE9;
    ...
    constructor() ERC20("Shiba Clan","SHIBCL") {
