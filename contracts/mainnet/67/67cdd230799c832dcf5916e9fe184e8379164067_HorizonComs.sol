...
// File: contracts/HorizonComs.sol
...
contract HorizonComs is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3200;
    uint256 public MAX_MINTS = 3200;
    string public baseURI = "ipfs:///";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Horizon Coms", "HORIZON", MAX_MINTS, MAX_SUPPLY) {  
    }
