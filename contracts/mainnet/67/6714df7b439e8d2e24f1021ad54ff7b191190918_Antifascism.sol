...
/*
September 18th, 1931 is the beginning of the world anti-Fascist War,
opened the second World War Eastern battlefield prelude.
The alarm bells are ringing. Against fascism.
*/
...
contract Antifascism is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Anti-fascism", "918") {
        ...
        uint256 totalSupply = 19310918 * 1e18;
        ...
        marketingWallet = address(0x9D072644e9596b932e0d20A5A9f0953b07b02AC9); // set as marketing wallet
