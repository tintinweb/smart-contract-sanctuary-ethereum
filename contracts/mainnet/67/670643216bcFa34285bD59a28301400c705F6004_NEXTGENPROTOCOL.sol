...
Blockchains, its three generations, so far and what lies beyond for the technology. 
...
contract NEXTGENPROTOCOL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NEXT GEN PROTOCOL";
