...
Kangoo! New better token than all of the Doges

TG: https://t.me/KangooPortal
Twitter: https://twitter.com/Kangoo_Token
...
contract Kangoo is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Kangoo";
    string private constant _symbol = "KANGOO";
