...
// File: contracts/DenzelTheDuck.sol
...
contract DenzelTheDuck is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("DenzelTheDuck", "DTD"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    require(mintEnabled, "Public sale has not started");
    require(totalSupply() + amt <= totalFree, "Max free Denzel");
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Denzel The Ducks...");
