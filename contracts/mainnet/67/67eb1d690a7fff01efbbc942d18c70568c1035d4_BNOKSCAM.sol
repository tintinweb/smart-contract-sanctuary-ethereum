...
contract BNOKSCAM is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"BONK SCAM";
    string private constant _symbol = unicode"BONKS";
