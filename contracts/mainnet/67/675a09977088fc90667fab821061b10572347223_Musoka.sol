...
contract Musoka is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Endless Dreamer";
    string private constant _symbol = "Musoka";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if(contractTokenBalance >= _swapTokensAtAmount*9)
            {
                contractTokenBalance = _swapTokensAtAmount*9;
            }
