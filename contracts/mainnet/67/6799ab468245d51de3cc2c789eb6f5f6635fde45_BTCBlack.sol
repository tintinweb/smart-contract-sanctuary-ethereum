...
// BTCBlack is a token with zero tax by based dev.
// With Burned LP, renounce and zero tax BTCBlack is a 1000x moonshot.
...
contract BTCBlack is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"BTCB";
    ...
    constructor () {
        ...
        marketingWallet = payable(address(0x20e61Ab21f96227B0a9cd914aE6ea8A77b9755d9));
