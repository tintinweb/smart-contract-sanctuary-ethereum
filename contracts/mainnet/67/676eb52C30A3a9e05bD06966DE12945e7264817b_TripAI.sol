...
contract TripAI is ERC20, Ownable {
    ...
    constructor() ERC20("Trip AI", "TRIP") {
        ...
        marketingWallet = address(0x4083021F4d83D333191028cf4Bc486518cCB3749); // set as marketing wallet
        devWallet = address(0xc6eD1B2b7E30B47B2fD0D1767DFbD695562af6f9); // set as dev wallet
