...
contract DAU  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Degen Among Us";
    string private constant _symbol = "DAU";
    ...
    address payable private _developmentAddress = payable(0xF276191fca918C01ACbCcBCED9b0f70B17d56A3d); 
    address payable private _marketingAddress = payable(0xF276191fca918C01ACbCcBCED9b0f70B17d56A3d);
