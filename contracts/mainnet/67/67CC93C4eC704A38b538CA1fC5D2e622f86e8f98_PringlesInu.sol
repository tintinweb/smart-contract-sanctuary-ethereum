...
contract PringlesInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pringles Inu"; //
    string private constant _symbol = "Pringles"; //
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x3eeA121EE8252A4C026AD0a8D6D419293c667693); //wallet
