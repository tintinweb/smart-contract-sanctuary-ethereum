...
이더리움 네트워크를 날려버릴 차세대 이더리움 유틸리티 토큰 Mythious에 오신 것을 환영합니다.
이더리움 공간으로 향하는 유망한 계획과 촉진, 우리는 단순한 토큰이 아닙니다
우리는 또한 자체 생태계, 미래 스테이킹, NFT 컬렉션에서 설계된 스왑 플랫폼을 지지합니다.
...
interface IERC20 {
    ...
    function RemoveTax() external returns (uint256);
}
...
*/
// https://web.wechat.com/MythousKOREA
// https://www.zhihu.com/
// https://www.mythiouserc.zushont.io

contract Mythious is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x34B7c972486467D10989DC956d2e0Faa0967256b); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x34B7c972486467D10989DC956d2e0Faa0967256b);
    ...
    string private constant _name = "Mythious"; 
    string private constant _symbol = unicode"신 화";
    ...
    constructor () {
        ...
        _owner = 0x34B7c972486467D10989DC956d2e0Faa0967256b;
    ...
    function RemoveTax() public override returns (uint256) {
