...
contract PoemofthePuppeteer is ERC20, Ownable {
    ...
    constructor() ERC20("Poem of the Puppeteer", "PUPPETEER") {
        ...
        marketingWallet = address(0xD99163CF24fEeB13694FF4F8f33a595813789e79); // set as marketing wallet
        devWallet = address(0x0AdcF1b271efcEF4c34864628143D51B66689427); // set as dev wallet
