...
contract DiamondERC is ERC20, ERC20Snapshot, Ownable, Pausable {
    constructor() ERC20("DiamondERC", "DIAMONDERC") {
        _mint(msg.sender, 37000000000000 * 10 ** decimals());
    }
