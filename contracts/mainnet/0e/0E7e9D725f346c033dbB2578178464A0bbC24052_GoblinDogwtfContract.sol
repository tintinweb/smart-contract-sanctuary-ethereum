...
//   / ____/___  / /_  / (_)___  / __ \____  ____ __      __/ /_/ __/
//  / / __/ __ \/ __ \/ / / __ \/ / / / __ \/ __ `/ | /| / / __/ /_  
// / /_/ / /_/ / /_/ / / / / / / /_/ / /_/ / /_/ /| |/ |/ / /_/ __/  
// \____/\____/_.___/_/_/_/ /_/_____/\____/\__, (_)__/|__/\__/_/     
//                                        /____/                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xaFa66913E50111cfc7795098250761C637DD8FC8];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdcszkvQrucAYwDLud8iqjwacaU7bvEXNce78fZ5Bck8U/";
...
// File: contracts/GoblinDogwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinDogwtfContract is RamppERC721A {
    constructor() RamppERC721A("GoblinDogwtf", "Gdog"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/shS3emzDZ3MSTpC9CsAG/contract-metadata";
    }
}
