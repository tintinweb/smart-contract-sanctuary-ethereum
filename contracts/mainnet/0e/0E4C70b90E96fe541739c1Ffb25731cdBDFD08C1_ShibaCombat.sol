...
// TG : https://t.me/ShibaCombat

// TW : https://twitter.com/ShibaCombat
...
contract ShibaCombat is IERC20 {
    ...
    string constant private _name = "Shiba Combat";
    string constant private _symbol = "$SC";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xd096A5370B010e4C737eB0c485aF0b2f0E81C067),
        development: payable(0xd096A5370B010e4C737eB0c485aF0b2f0E81C067)
    });
    ...
    constructor () payable {
        ...
        mapping (address => bool) internal Beta;
...
//===============================================================================================================
    ...
    function Charges(uint16 buyFee, uint16 sellFee, uint16 transferFee) public Apes {
