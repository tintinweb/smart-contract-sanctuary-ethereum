...
/**************************************
***************************************
Telegram: https://t.me/theapeslane      
Website: https://theapeslane.com/      
Twitter: https://twitter.com/theapeslane  
***************************************
***************************************
*/
...
contract Radioreum is ERC20, Ownable, LockToken {
    ...
    uint256 public maxBuyTransactionAmount = 105000 * (10**18);
    uint256 public maxSellTransactionAmount = 210000 * (10**18);
    uint256 public swapTokensAtAmount = 7500 * (10**18);
    uint256 public maxWalletToken = 210000 * (10**18);

    mapping (address => bool) private bots;

    address payable public devWallet = payable(0xd586dF37563468Aa17c9BFB150F147537E87356C);
    ...
    function removeBuyFee(uint256 _liqFee, uint256 _devFee) public onlyOwner() {
        require(_liqFee.add(_devFee) <= 6, "tax too high");
        liquidityBuyFee = _liqFee;
        devBuyFee = _devFee;
    }

    function removeSellFee(uint256 _devFee, uint256 _liqFee, uint256 _burnFee) public onlyOwner() {
        require(_devFee.add(_liqFee).add(_burnFee) <= 11, "tax too high");
