...
contract MiniMission is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0xEAB65E600EC7cc8227070293aeE06f03C8A3fDCB);
    ...
    constructor() ERC20("MiniMission", "MM") {
    ...
    function setMissionModifier(address account, bool onOrOff) external onlyOwner {
