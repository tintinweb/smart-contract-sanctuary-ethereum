...
contract HUMANITY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Atlantic", "HUMANITY") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x88B464Ab7387B09766db324585D8020de0Eb793F); // set as Marketing wallet
        DevWallet = address(0x88B464Ab7387B09766db324585D8020de0Eb793F); // set as dev wallet
