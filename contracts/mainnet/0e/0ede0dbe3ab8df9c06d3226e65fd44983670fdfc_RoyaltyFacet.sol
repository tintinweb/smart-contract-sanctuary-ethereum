 ...
 */
abstract contract ERC2981 is IERC2981, Modifiers {
    // struct RoyaltyInfo {
    //     address receiver;
    //     uint96 royaltyFraction;
    // }

    // RoyaltyInfo private s._defaultRoyaltyInfo;
    // mapping(uint256 => RoyaltyInfo) private s.tokenRoyaltyInfo;
        ...
        virtual
    {
        ...
        s.defaultRoyaltyInfo = RoyaltyInfo(receiver, feeNumerator);
    }
    ...
    function _setTokenRoyalty(
        ...
        s.tokenRoyaltyInfo[tokenId] = RoyaltyInfo(receiver, feeNumerator);
    }
    ...
    function _resetTokenRoyalty(uint256 tokenId) internal virtual {
        delete s.tokenRoyaltyInfo[tokenId];
    }
}
 ...
 * _Available since v4.5._
 *
 * Removed IERC165 to be diamond compliant.
 */
interface IERC2981 {
    /**
