...
// Website: http://tsukaburn.io
// Telegram: https://t.me/btsuka
// Twitter: http://twitter.com/bTSUKAio
...
contract bTSUKA is ERC20, Ownable {
    ...
    address public burnTokenAddress = 0xc5fB36dd2fb59d3B98dEfF88425a3F425Ee469eD;
    address public marketingWallet = 0x41e36895fd8Cc55a7553bc1fbC04118c6A294001;
    ...
    constructor() ERC20("Tsuka Burn", "bTSUKA") {
        ...
        tokenburnBuyFee = 30; // 3%, being used to buy and burn TSUKA
        marketingBuyFee = 20; // 2% being used for marketing
        totalBuyFees = 50; // 5%

        tokenburnSellFee = 30; // 3%, all being used to buy and burn TSUKA
        marketingSellFee = 20; // 2% being used for marketing
   ...
   function burnTargetToken(uint256 ethAmountInWei, address BurnToken) internal {
    ...
    function swapBack() private {
        ...
        // buy the bTSUKA token and burn it
