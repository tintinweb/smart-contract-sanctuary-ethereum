...
contract WeStreamers is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant RESERVED_TOKENS = 420;
    uint256 public constant FOR_SALE_TOKENS = 10420 - RESERVED_TOKENS;
    address public constant RESERVED_TOKENS_ADDRESS =  0xC1498d68653eB724148052074889B99C2F21cf76;
    ...
    uint256 public tokenPricePresale = 0.1 ether;
    ...
    string public tokenBaseURI = "ipfs://QmWWBrtucitdg8FBABT98ptNuuYHrEPh4yAHV66LxwVbQ1/";
    string public tokenURIExtension = ".json";

    uint256 public soldAmount = 0;
    mapping(address => uint256) public purchased;

    constructor() ERC721A("WeStreamers", "WSTRM") {
    ...
    function tokenPrice() public view returns (uint256) {
        ...
        if(currentStage == STAGE_PUBLIC && soldAmount < presaleTotalLimit) {
            return tokenPricePresale;
        }
