...
contract OxBLACK is Ownable, ERC721A, ReentrancyGuard {
    ...
    function ogMint(uint256 quantity, bytes32[] calldata _merkleProof) external callerIsUser {
        ...
        require(ogMintActive, "free mint is not currently active");
