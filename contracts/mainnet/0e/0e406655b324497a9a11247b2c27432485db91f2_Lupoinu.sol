...
contract Lupoinu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Lupo Inu";
    ...
    address payable private _developmentAddress = payable(0x8EEe181646c9eA498638464637f7B5F84c2416F4);
    address payable private _marketingAddress = payable(0x8EEe181646c9eA498638464637f7B5F84c2416F4);
