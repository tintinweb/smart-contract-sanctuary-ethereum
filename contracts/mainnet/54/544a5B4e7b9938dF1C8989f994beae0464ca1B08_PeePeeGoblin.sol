...
/**
 * @title OkayMutantBears contract
...
contract PeePeeGoblin is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.004269 ether;
  uint public          maxPerTx          = 5;
  uint public          maxPerWallet      = 10;
  uint public          totalFree         = 5500;
  uint public          maxSupply         = 10000;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("PeePeeGoblin.wtf", "PPG"){}
  ...
  function setMaxTokensPerWallet(uint8 _maxTokensPerWallet) external onlyOwner {
        maxPerWallet = _maxTokensPerWallet;
    }
