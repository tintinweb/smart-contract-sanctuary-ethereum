...
contract LDREY is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Lana Del Rey";
    string private constant _symbol = "LDREY";
    ...
    uint256 public _maxTxAmount = 5000000 * 10**9; //0.75
