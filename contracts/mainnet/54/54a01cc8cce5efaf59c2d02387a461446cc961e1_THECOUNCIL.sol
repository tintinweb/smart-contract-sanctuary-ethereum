...
THE COUNCIL | BLACK MARKET CARTEL

Token Name: The Council    ($Council)
Chain: Ethereum
...
contract THECOUNCIL is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Council";
    string private constant _symbol = "Council";
    ...
    constructor () {
        _MarketingWallet = payable(0xE636b79359407DCddeFCF3abB8Da32A22527Ea7E);
        _liquidityWallet = payable(0x638988315671385483dA1B00F8E738A888D58243);
        _rewardWallet = payable(0x638988315671385483dA1B00F8E738A888D58243);
        ...
        emit Transfer(address(0x638988315671385483dA1B00F8E738A888D58243), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxSellAmount = 2000000 * 10**9;
        _maxWalletAmount = 4000000 * 10**9;
