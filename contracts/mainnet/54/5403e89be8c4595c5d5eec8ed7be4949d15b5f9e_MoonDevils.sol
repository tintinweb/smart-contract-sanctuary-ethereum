...
contract MoonDevils is ERC721A, Ownable {
    using Strings for uint256;
    string private baseURI;
    string public hiddenMetadataUri;
    uint256 public price = 0.00366 ether;
    uint256 public maxPerTx = 10;
    uint256 public maxFreePerWallet = 2;
    uint256 public totalFree = 4444;
    uint256 public maxSupply = 4444;
    uint public nextId = 0;
    bool public mintEnabled = false;
    bool public revealed = true;
    mapping(address => uint256) private _mintedFreeAmount;
    constructor() ERC721A("Moon Devils", "Devils") {
    setHiddenMetadataUri("https://api.moondevils.wtf/");
    setBaseURI("https://api.moondevils.wtf/");
    }
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more Devils");
    ...
    function FreeOwnerMint(address to, uint256 quantity)public onlyOwner{
