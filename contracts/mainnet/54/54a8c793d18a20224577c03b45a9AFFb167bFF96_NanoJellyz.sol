...
contract NanoJellyz is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    address[] public withdrawAddresses = [0xE35545C12421c59D058F4Ad2ADDB0006AbCD24C2, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xb858d005089129a5ebc91e953afa9f339b83bcb3347ac1a37b35528148ed9190;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xE35545C12421c59D058F4Ad2ADDB0006AbCD24C2, _royaltyAmount);
    }
