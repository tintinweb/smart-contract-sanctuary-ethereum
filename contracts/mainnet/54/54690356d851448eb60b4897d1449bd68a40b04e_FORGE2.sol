...
interface IUniswapV2Router02 {
    ...
    contract FORGE2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "FORGE 2.0";
    string private constant _symbol = "FORGE2";
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(0x93D0c2a78BC8Cae8228a078e9D64593d23c719eC);   
        _feeAddrWallet2 = payable(0x93D0c2a78BC8Cae8228a078e9D64593d23c719eC); 
        ...
        emit Transfer(address(0x4c7028AeE6C31201B816e286b8ae16Ab5D2BfCe3), _msgSender(), _tTotal); 
    }
