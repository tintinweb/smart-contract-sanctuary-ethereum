...
https://twitter.com/KoboldETH

https://medium.com/@ethkobold/kobold-the-dragon-kobo-3415e6becdf0

https://t.me/KoboldTheDragon
...
contract KoboldTheDragon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Kobold The Dragon";
    string private _symbol = "Kobo";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x5568f1a4ff79f61303b679E47649bF22CE4AC697);
    address payable public DeveloperWallet = payable(0xC99e7Ac0Eda1747e44EE5CA37767bCb789Ad9A7C);
    ...
    uint256 public _buyMarketingFee = 65;
    uint256 public _buyDeveloperFee = 1;
    
    uint256 public _sellLiquidityFee = 1;
    uint256 public _sellMarketingFee = 65;
