...
/*
The world important matter closes long divide surely, cent is long close surely. 
https://t.me/threekingdomsETH
https://twitter.com/kingdomseth
*/
...
contract TKING is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = unicode'三國 | ThreeKingdoms';
    string private constant _symbol = 'TKING';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 1 000 000 000tokens
    ...
    //DevWallets
    address public Development=payable(0x04D4f02Cb86D1Db66343ddCE5CA059C09bB78535);
    address public Marketing=payable(0x8FF845D4564D15c7Ede3b01073aC707Cf116f393);
    //MainNet
    ...
    uint256 currentAmountToSwap = 4000000 * 10**_decimals;  // 4,000,000 tokens (0.4%)
