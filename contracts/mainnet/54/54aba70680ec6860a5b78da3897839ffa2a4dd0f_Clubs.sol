...
contract Clubs is Context, IERC20, Ownable {
    ...
    string private _name = "Clubs";
    string private _symbol = "Clubs";
    ...
    uint256 public _maxTxAmount = 30000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 50000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 30000000000000000000 * 10**9;
