...
contract LostBulls is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    address public shibaWallet;

    uint96 public royaltyFeesInBips;
    address public royaltyAddress =
        0x9F031337E8D5cA9c55e34631d3c79962615d4645;//moneypipe address
    ...
    uint256 private constant MaxMintPerBatch_ = 200; //max mint per transaction
    ...
    uint256 public whitelistSpots = 500;
    uint256 public burnAmount = 1000000 ether;
    ...
    constructor(string memory _uri, address _shibaWallet, uint96 _royaltyFeesInBips)
        ERC721A(
            "The Lost Bulls",
            "TLB",
            MaxMintPerBatch_,
        ...
        )
    {
       ...
       Shiba = IERC20(0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE); //0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE
        setBaseURI(_uri);
    ...
    function mint(uint256 quantity) public payable {
        ...
        if(onlyWhitelisted) {
            ...
            require(totalSupply() + quantity <= whitelistSpots, "whitelist limit exceeded");
            require(msg.value >= priceWL * quantity, "insufficient funds sent for whitelisted price");
        ...
        IERC20(Shiba).transferFrom(shibaWallet, deadWallet, burnAmount);
  ...
  function removeWhitelistUsers(address[] calldata _users) public onlyOwner {
    ...
    function setShiba(address _newToken) public onlyOwner {
        Shiba = IERC20(_newToken);
    }
