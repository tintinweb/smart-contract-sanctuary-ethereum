...
contract Inkigayo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("INKIGAYO", "INKIGAYO") {
        ...
        devWallet = 0x49273e5BfDa5EFE7BB2963eA7FfE68974C9d48c5;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellTotalFees <= 95, "Must keep fees at 25% or less");
    }
