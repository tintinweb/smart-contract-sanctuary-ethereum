...
//      
//     Introducing NESPEED - the token for endless metaverse utilization. 
//      
//     Our goal is to be the most widely used token in the metaverse and to integrate it into any model or project launched in the space.
//
//     With a strong team of developers, we aim to create a new community in the metaverse where players can meet, communicate and use NESPEED as their preferred token. 
//
//     The metaverse offers a new economic model, where people can trade and build a real community.
//         
//        Website: https://nespeed.pro/
//          
//        Telegram: https://t.me/nespeedtoken
//
//              _   __                              __   
...
contract Nespeed is ERC20, Ownable {
    ...
    constructor() payable ERC20("Nespeed", "NESPEED") {
