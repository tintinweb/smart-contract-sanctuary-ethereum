...
contract femaliens is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeieeagr5xgwaw43da7irgbyx5iwiubeu6666mwz7al6huucxngophu/";
  uint256 public  maxSupply = 280;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.0049 ether;
  uint256 public  NUM_FREE_MINTS = 49;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public freeAlreadyMinted = 0;
  bool public isPublicSaleActive = false;
  constructor() ERC721A("femaliens", "FEMA") {
  }
