...
//
//     ____                      _____ __        __     __                  
//    / __ \____  ____  ___     / ___// /_____  / /__  / /_____  ____  _____
//   / / / / __ \/ __ \/ _ \    \__ \/ //_/ _ \/ / _ \/ __/ __ \/ __ \/ ___/
//  / /_/ / /_/ / /_/ /  __/   ___/ / ,< /  __/ /  __/ /_/ /_/ / / / (__  ) 
// /_____/\____/ .___/\___/   /____/_/|_|\___/_/\___/\__/\____/_/ /_/____/  
//            /_/   by 0xRedrum.eth
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf512173D3C049EA3fF4064DcC9a4A47a664294b0];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRaoCMcBLDNJDTAY89bvoV78YqzMHHpQTW8exbTJRsQEA/";
...
// File: contracts/DopeSkeletonsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DopeSkeletonsContract is RamppERC721A {
    constructor() RamppERC721A("Dope Skeletons", "DPS"){}
}
