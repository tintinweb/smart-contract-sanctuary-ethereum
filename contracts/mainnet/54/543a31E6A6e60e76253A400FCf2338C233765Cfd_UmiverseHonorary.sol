...
// :77?!                                                            .:^~!77??J7            
//                                                                         ..:^                                                                                  
contract UmiverseHonorary is ERC721A, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Strings for string;

    uint256 public constant purchaseLimit = 6;
    ...
    constructor() ERC721A("UmiverseHonorary", "UMIHON") {}

    function mintNFT() external payable onlyOwner {
        require(
