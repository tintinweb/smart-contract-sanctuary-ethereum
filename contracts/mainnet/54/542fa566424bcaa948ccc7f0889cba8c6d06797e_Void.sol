...
contract Void is ERC20, Ownable {
    ...
    constructor() ERC20("Void", "VOID") {
        ...
        marketingWallet = address(0xc42a89D6912700dC536C4f7bbc3Db943498cCb99); // set as marketing wallet
        devWallet = address(0xB1A1e65705524ACCc6741E890cAd9E9dB3D686C1); // set as dev wallet
