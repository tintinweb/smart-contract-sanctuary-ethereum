...
contract FacepunchAbstract is ERC721, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 133;
    ...
    constructor() ERC721("Facepunch Abstract", "FPAB") {
        baseUri = "https://facepunchabstract.com/output/";
