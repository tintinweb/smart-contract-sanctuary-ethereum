...
library LibAsset {
    bytes4 constant ETH_ASSET_CLASS = bytes4(keccak256("ETH"));
    ...
    bytes4 constant COLLECTION = bytes4(keccak256("COLLECTION"));
    bytes4 constant CRYPTO_PUNK = bytes4(keccak256("CRYPTO_PUNK"));
