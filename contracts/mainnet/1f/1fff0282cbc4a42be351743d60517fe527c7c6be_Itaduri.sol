...
contract Itaduri is ERC20, Ownable {
    ...
    constructor() ERC20("Itaduri", "YUJI") payable {
    	...
    	marketingWallet = address(0x943768Fd7777d71914e45b097Ab71ABfe6Cd190E); // set as Marketing wallet
        devWallet = address(0x567776daAA9a3321b0f79EE78302d8CeC836A347); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x567776daAA9a3321b0f79EE78302d8CeC836A347, true);
        excludeFromFees(0x943768Fd7777d71914e45b097Ab71ABfe6Cd190E, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x567776daAA9a3321b0f79EE78302d8CeC836A347, true);
        excludeFromMaxTransaction(0x943768Fd7777d71914e45b097Ab71ABfe6Cd190E, true);
        ...
        */
        ...
        _createInitialSupply(0x567776daAA9a3321b0f79EE78302d8CeC836A347, totalSupply*2/100);
        _createInitialSupply(0xc9424F576afb2f42A954841b630BB0daB3A41544, totalSupply*2/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x943768Fd7777d71914e45b097Ab71ABfe6Cd190E,
            block.timestamp
        );
    }
