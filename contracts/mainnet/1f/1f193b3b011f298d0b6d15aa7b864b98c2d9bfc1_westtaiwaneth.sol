...
West Taiwan ETH (WEST)

Taiwan is a modern, beautiful nation. It has a solid democracy and economy. It has a highly educated population. 
It has freedom of speech and assembly, 
the right to protest, 
the right to marry whoever you wish… to sum it up in one word, 
Taiwan is free. And Taiwan doesn’t need China. 
Taiwan doesn’t need to prove how much of a big military dick it has and defeat Beijing…

Tax for Taiwan: 4%

Tg: https://t.me/westtaiwaneth
...
contract westtaiwaneth is Context, IERC20, Ownable {
    ...
    string private _name = "West Taiwan Eth";
    string private _symbol = "WEST";
    ...
    address payable public marketingaddress = payable(0x982a0b65B0aD127954C48291a3D0E5acdb37badF);
