...
contract TaleOfVitalik is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 72_000_000 * 10**_decimals;
    string private constant _name = "Tale Of Vitalik";
    string private constant _symbol = "TaleOf";
