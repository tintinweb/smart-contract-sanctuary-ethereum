...
contract DegenTV is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DegenTV";
    string private constant _symbol = unicode"DTV";
