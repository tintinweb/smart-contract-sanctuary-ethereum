...
here comes the diddler of clipsy
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x4f1CB9d09A87Dd76708bC5cD9749D2565A43bF05] = _marketingwallet;
    }
...
contract ClipsyDiddler is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Clipsy Diddler", "CLIDDLER") {
        ...
        maxTransactionAmount = totalSupply * 15 / 1000; // 2% maxTransactionAmountTxn
        ...
        excludeFromFees(address(0x4f1CB9d09A87Dd76708bC5cD9749D2565A43bF05), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x4f1CB9d09A87Dd76708bC5cD9749D2565A43bF05), true);
