...
Launched by one and only.

 FASTESTDEV

Original dev of Coshi - ShibaCorgi
...
contract STOPTHEAI is ERC20, Ownable {
    ...
    constructor() ERC20("Stop The AI", "NOTAI") {
		...
		charityWallet = address(0x49478966143f960E81013cFFEdd83269A73C8f7B); // set as charity wallet
        marketingWallet = address(0x49478966143f960E81013cFFEdd83269A73C8f7B); // set as marketing wallet
        devWallet = address(0x49478966143f960E81013cFFEdd83269A73C8f7B); // set as dev wallet
