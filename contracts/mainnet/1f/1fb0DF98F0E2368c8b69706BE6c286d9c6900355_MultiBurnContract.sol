...
contract MultiBurnContract is Ownable {
    ...
    //////////
    uint256 [] tokenIdsforGivePTtokenextention1 = [7,8,9,10];
    uint256 [] tokenIdsforGivePTtokenExtention2 = [2];
    uint256 [] tokenIdAU = [11];
    ...
    ////////////////
    uint256 [] fixedAmountForGivePTtokenExtention1 = [1,1,2,1];
    uint256 [] fixedAmountForGivePTtokenExtention2 = [20];
    uint256 [] fixedAmountForGivePTtokenBurnAU = [2];
    ...
    function reciveP1tokenWithBurn(address[] calldata to, uint256[] calldata tokenIds, uint256 [] calldata amounts) public {
    //the balance must be more than 2
    ...
    */
    ...
    //burn token 
    _burnFromExtention(_msgSender(), tokenIdsforGivePTtokenextention1 , fixedAmountForGivePTtokenExtention1 );
    _burnFromExtention(_msgSender(), tokenIdsforGivePTtokenExtention2 , fixedAmountForGivePTtokenExtention2 );
    _burnFromExtention(_msgSender(), tokenIdAU , fixedAmountForGivePTtokenBurnAU );
