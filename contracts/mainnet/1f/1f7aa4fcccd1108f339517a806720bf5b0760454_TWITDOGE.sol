...
A new Doge coin is taking the crypto market by storm, Chief Twit Doge is a new Elon based coin

There is no shortage of opportunities or opportunities in a person's life, it is how to seize them

https://t.me/ChiefTwitDoge
**/
...
contract TWITDOGE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Chief Twit Doge";
    string private constant _symbol = "TWITDOGE";
    ...
    address payable private _developmentAddress = payable(0x62997E2b647c81757346ebaae50c03eA20A8A8C1);
    address payable private _marketingAddress = payable(0x62997E2b647c81757346ebaae50c03eA20A8A8C1);
