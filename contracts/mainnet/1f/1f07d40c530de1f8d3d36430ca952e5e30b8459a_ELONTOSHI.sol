...
contract ELONTOSHI is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "ELONTOSHI";
    string private _symbol = "ETOSHI";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x9423FE3502B93A09905Ec3eb59F4e2d1A92238C8);
