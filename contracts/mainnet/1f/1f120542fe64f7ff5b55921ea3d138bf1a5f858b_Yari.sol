...
contract Yari is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Dejitaru Yari";
    string private constant _symbol = "YARI";
    ...
    address payable private _developmentAddress = payable(0x30aE74Dc55C30fEA3c7f28720B91Fb3e84c06dA7); 
    address payable private _marketingAddress = payable(0x30aE74Dc55C30fEA3c7f28720B91Fb3e84c06dA7);
    ...
    function YariRealLaunch(int code) public onlyOwner {
        tradingOpen = code== 10;
        _taxFeeOnBuy = 5;
        _taxFeeOnSell = 5;
    }
