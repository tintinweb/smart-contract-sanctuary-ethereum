 ...
 * allowances. See {IERC20-approve}.
 */
 contract EthereumClassic is ERC20, Ownable {

    string private _name = "Ethereum Classic";
    string private _symbol = "EC";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 6;
    uint256 public maxTxAmount = 50000 * 10**_decimals;
    uint256 public maxWalletAmount = 50000 * 10**_decimals;
    address public marketingWallet = 0xC27357D0f7a0443641a3785E60a8F04208EE2D95;
    ...
    uint256 private _numTokensSellToAddToLiquidity = 10000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 10000 * 10**_decimals;
