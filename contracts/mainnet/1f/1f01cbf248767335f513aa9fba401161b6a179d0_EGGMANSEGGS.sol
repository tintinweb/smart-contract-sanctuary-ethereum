...
Socials to be released once eggman stakes his eggs
...
contract EGGMANSEGGS {
    ...
    constructor(IERC20 _eggmans_token) {
        // Set contract owner
        owner = msg.sender;
        // Timestamp values not set yet
        timestampSet = false;
        // Set the erc20 contract address which this timelock is deliberately paired to
        require(address(_eggmans_token) != address(0), "_erc20_contract_address address can not be zero");
        erc20Contract = _eggmans_token;
