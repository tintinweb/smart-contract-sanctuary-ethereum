...
contract GRAYSCALEBITCOINDISTRUST is ERC20, Ownable {
    ...
    constructor() ERC20("Grayscale Bitcoin Distrust", "DCGINU") {
        ...
        marketingWallet = address(0x7a90F94D6E8643bf1aFd43B9a622C75C1d047385); // set as marketing wallet
        devWallet = address(0x527f794Cc68Bc96380F7769E62b2d72979D0b2fD); // set as dev wallet
