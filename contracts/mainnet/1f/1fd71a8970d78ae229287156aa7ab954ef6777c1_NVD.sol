...
contract NVD is ERC20, Ownable{
    using SafeMath for uint256;
    address public treasury = 0xd804dddEed7BF4b7c80EB8b3c676C8f8ef2Ba0Ad;
    uint256 public tax = 8;
    mapping(address => bool) whiteList;

    constructor() ERC20("NFT VC DAO", "NVD") {
        _mint(msg.sender, 100000000000 * 10 ** 18);
    }

    function setTTreasury(address _treasury) external onlyOwner {
        treasury = _treasury;
    }
