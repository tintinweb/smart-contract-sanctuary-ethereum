...
contract bullringstoken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fable Of The Gold";
    string private constant _symbol = unicode"GYRANT";
