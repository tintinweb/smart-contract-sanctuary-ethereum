    ...
    DefaultOperatorFilterer
{
    ...
    constructor() ERC721A("No-to-AI NFT", "No-to-AI") {
        conf.publicBegin = 1671447600;
        conf.publicPrice = 0.02 ether;
        conf.withdrawTo = payable(0x817016163775AaF0B25DF274fB4b18edB67E1F26);
        _baseTokenURI = "https://bafybeic76y3o4au465s6keel45twzzz4i4g2wika46pqrgqz7fotrlanyq.ipfs.nftstorage.link/";
        ...
        onlyRole(MINTER_ROLE)
    {
        ...
        require(totalSupply() <= collectionSize, "over max supply");
    }
