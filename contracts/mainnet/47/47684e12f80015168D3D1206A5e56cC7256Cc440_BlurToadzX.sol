...
contract BlurToadzX is ERC721A {
    ...
    constructor() ERC721A("Blur ToadzX", "BT") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://Qmd7Ptk4wgApZV4GavZFvq7T8yNhHTFUgKRG6UWiDrU2rq/", _toString(tokenId), ".json"));
    }
