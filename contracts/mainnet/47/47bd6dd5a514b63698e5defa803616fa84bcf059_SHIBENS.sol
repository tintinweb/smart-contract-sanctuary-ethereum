...
contract SHIBENS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("$SHIBENS", "$SHIBENS") {
     ...
     uint256 totalSupply = 10 * 10 ** 6 * 10 ** decimals();
        ...
        maxTransactionAmount = 15 * 10 ** 4 * 10 ** decimals(); 
        maxWallet = 15 * 10 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x97976f2a4Baf97feadA8C1735fA5e6B054d259Dc); // set as Marketing wallet
        DevWallet = address(0x97976f2a4Baf97feadA8C1735fA5e6B054d259Dc); // set as dev wallet
