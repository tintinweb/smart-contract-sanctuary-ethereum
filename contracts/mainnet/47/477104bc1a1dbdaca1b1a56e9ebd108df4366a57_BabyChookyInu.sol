...
// Baby Choo Inu
// Marketing Wallet will buy $CHOO then burn $CHOO
...
contract BabyChookyInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Baby Chooky Inu";
    string private constant _symbol = "$CHOOO";
    ...
    uint256 _totalSupply = 420000000 * 10**18;
    ...
    address payable private _marketingAddress = payable(0xaB68E93904afd01b4320Ffa14bD4Ee504FF749AB);
    ...
    uint256 public _maxTxAmount = 82000000 * 10**18; 
    uint256 public _maxWalletSize = 182000000 * 10**18; 
    uint256 public _swapTokensAtAmount = 1000000 * 10**18; 
