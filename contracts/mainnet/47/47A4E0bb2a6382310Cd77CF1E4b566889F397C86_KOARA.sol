...
contract KOARA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Koara";
    string private constant _symbol = "$KOARA";
    ...
    address payable private _developmentAddress = payable(0xc0e1Ac02A1B84261D8e9a91FEB8328B56d59653F); 
    address payable private _marketingAddress = payable(0x3F57c2569DF12E17b51B761155162Dc3572bb104);
