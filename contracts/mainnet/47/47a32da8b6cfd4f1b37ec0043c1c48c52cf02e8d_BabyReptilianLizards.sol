...
contract BabyReptilianLizards is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQgAbj9YZrbGezeSc2Qmkwaj7pc6ErJ7KA7Wp4HR2yYHD";
    ...
    constructor(
    ) ERC721A("Baby Reptilian Renegade Lizards", "BRRL", 100, maxSupply) {
    }
