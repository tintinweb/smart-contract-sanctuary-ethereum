...
contract RICH is IERC20, Ownable {
    ...
    string private constant _name = 'THE RICH';
    ...
    address internal constant development_receiver = 0x4E523a652C78d7F02B1121b1d4539F0a2Fef3e34; 
    address internal constant marketing_receiver = 0x4E523a652C78d7F02B1121b1d4539F0a2Fef3e34;
    address internal constant liquidity_receiver = 0x4E523a652C78d7F02B1121b1d4539F0a2Fef3e34;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(1000) && sellFee <= denominator.div(1000), "totalFee and sellFee cannot be more than 20%");
    }
