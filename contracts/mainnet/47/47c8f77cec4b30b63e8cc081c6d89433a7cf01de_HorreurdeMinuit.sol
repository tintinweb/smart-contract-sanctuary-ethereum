...
// Horreur de Minuit by ChiaroscuroDAO
...
// File: contracts/HorreurdeMinuit.sol
...
contract HorreurdeMinuit is ERC721A, ERC721AQueryable, Ownable {
  ...
  string tokenBaseUri = "ipfs://QmRma2dexjfXRRis622LUXCVbbmiMqTpb2Gc1xZSmtU1js/";

  bool public paused = false;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("Horreur de Minuit by ChiaroscuroDAO", "HDM") {}
  ...
  function mint(uint256 _quantity) external payable {
    unchecked {
      ...
      require(_totalSupply + _quantity < MAX_SUPPLY + 1, "Horreur de Minuit");
