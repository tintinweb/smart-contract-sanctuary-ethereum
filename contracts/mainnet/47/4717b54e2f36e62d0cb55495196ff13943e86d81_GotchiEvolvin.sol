...
contract GotchiEvolvin is ERC721A, Ownable {
    string public baseURI = "https://storageapi.fleek.co/256e1077-3ba4-4f13-9298-2a063e646bf9-bucket/GotchiJson/";
    ...
    constructor() ERC721A("Gotchi Evolvin", "GotchiEvolvin") {
    ...
    function freeMint() public{
        address _caller = _msgSender();
        require(!paused, "Paused");
        require(MAX_SUPPLY >= totalSupply() + 2, "Exceeds max supply");
        require(tx.origin == _caller, "No contracts");
        require(MAX_FREE >= uint256(_getAux(_caller)) + 2, "Excess max per free wallet");
