...
/*
HOMELESS is a community of
people who have ended up in this
awkward situation, community is
and must be united supporting
each other. Getting into the HOMELESS token early and promote it all over social media,
messenger apps like telegram,
discord so more people follow the
trend and buy HOMELESS.

https://t.me/Homelesserc
https://homelesstoken.homes
...
contract HOMELESS is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Homeless Token";
    string private constant tokenSymbol = "HOMELESS";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xF2671F99016f5f0cAb08C1b7582b749E1e1f36d4);
        devAddress = payable(0xF2671F99016f5f0cAb08C1b7582b749E1e1f36d4);
