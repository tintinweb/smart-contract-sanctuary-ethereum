...
contract CookieFarmingAdventure is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Cookie Farming Adventure";
    string private constant _symbol = unicode"CHEF";
