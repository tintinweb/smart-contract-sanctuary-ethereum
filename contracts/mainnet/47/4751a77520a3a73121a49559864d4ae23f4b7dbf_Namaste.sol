...
contract Namaste is Context, IERC20, Ownable {
    ...
    string private constant _name = "Namaste";
    string private constant _symbol = "Namaste";
    ...
    address payable private _developmentAddress = payable(0x5cFF6a2Ae92A81AB79744406f652502237183b2E); 
    address payable private _marketingAddress = payable(0x5cFF6a2Ae92A81AB79744406f652502237183b2E);
