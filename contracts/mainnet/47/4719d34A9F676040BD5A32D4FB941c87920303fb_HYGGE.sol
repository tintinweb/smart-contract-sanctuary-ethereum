...
contract HYGGE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZX9L8GUi7hSBqNsBZjWRLwVQRRJxX5JjuYgkGgxCZzaj";
    ...
    constructor(
    ) ERC721A("HYGGE of Evgeny Lushpin ", "HYGGE", 100, maxSupply) {
    }
