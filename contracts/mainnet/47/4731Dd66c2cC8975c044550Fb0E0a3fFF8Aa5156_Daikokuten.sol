...
contract Daikokuten is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private buyTxFee = 20;
    uint256 private sellTxFee = 20;
    ...
    constructor() ERC20("Daikokuten", "Daiko") { 
        ...
        uint256 totalSupply = 10000000000 * 10 ** _decimals;
        supply += totalSupply;
        ...
        devWallet = 0x17e6273fCe95D7B78167Dc221b3F0a580b830E63; // set as dev wallet 
    ...
    function setSellFee(uint256 bTxFee, uint256 sTxFee) external onlyOwner() {
        buyTxFee = bTxFee;
        sellTxFee = sTxFee;
    }
