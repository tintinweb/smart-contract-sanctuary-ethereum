...
contract WorldSeriesInu is ERC20, Ownable {
    ...
    address private _dev = 0xbC80894D32990a8ADC32eD78796b2BCb6a14CDB6;
    address private _team = 0x40F8117B6A82fBfFB7F16209D3b25596789e0231;
    address public deployer;
    constructor() ERC20("World Series Inu", "WSI") {
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_dev] = true;
        _isExcludedFromFee[_team] = true;
        _isExcludedFromFee[0x8f0cf3994DcE4174D19869DbFc441Fb92dec4446] = true;
        _isExcludedFromFee[0xD67CC7FEe87667806b2973C8e192BF056A3B7B66] = true;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
       ...
       if(from != owner() && to != owner()) {
            ...
            if (from == marketPair && takeFees) {
                require(holderBalance <= _maxWalletAmount, "Wallet cannot exceed max Wallet limit");
            }
            if (from != marketPair && to != marketPair && takeFees) {
                require(holderBalance <= _maxWalletAmount, "Wallet cannot exceed max Wallet limit");
            }
            if(taxAmount > 0) {
   ...
   function swapTokensForEth(uint256 tokenAmount) private {
        ...
        payable(_dev).transfer(split);  
        payable(_team).transfer(split);  
    ...
    function setWalletAddresses(address dev, address team) external onlyOwner {
        _dev = dev;
        _team = team;
    }
