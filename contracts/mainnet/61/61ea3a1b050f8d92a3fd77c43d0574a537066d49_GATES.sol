...
Medium post:  https://link.medium.com/eYzVGEItsvb
...
contract GATES is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Black Gates";
    string private constant _symbol = "GATES";
