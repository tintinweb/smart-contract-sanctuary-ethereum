...
contract EverybodyLoveShiba is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Everybody Love Shiba";//
    string private constant _symbol = "ELS";//
    ...
    address payable private _developmentAddress = payable(0xC7cebE11b566FdDB6aeAB80137351440069f88b1);//
    address payable private _marketingAddress = payable(0xC7cebE11b566FdDB6aeAB80137351440069f88b1);//
