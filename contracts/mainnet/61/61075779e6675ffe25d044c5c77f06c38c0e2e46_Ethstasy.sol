...
Ethstasy is the first ever Defi narcotic and drug cartel on the Ethereum chain.
established and founded by one of the enormous and most anonymous crypto-whales. 


𝐖𝐇𝐀𝐓 𝐈𝐒 𝐄𝐓𝐇𝐒𝐓𝐀𝐒𝐘 ($𝐌𝐎𝐋𝐋𝐘)?
✓ built for the community and it is an open-source community project deployed on Ethereum blockchain. 
✓ the buyers and sellers incur a tax fee, which is then redistributed to the liquidity pool and operations wallet.
✓ stealth launch, no presale, no pre-load wallets, locked liquidity, and renounced ownership

Telegram: https://t.me/EthstasyErc
Website: www.Ethstasy.co
*/
...
pragma solidity ^0.6.12;
    ...
    contract Ethstasy is Context, IERC20, Ownable {
        ...
        string private _name = 'Ethstasy';
        string private _symbol = '$MOLLY';
        ...
        uint256 private _maxTxAmount = 300000000000e9;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xE78ecb8A825ea14bCC63A4C6CffBFb5Ce1dc002B, 'We can not exclude Uniswap router.');
