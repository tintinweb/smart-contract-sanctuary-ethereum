...
/*
JUST IN: 🇺🇸 SEC sues YouTuber Jake Paul for illegal promotion of cryptocurrencies tied to Tron founder Justin Sun.

@WatcherGuru

https://www.coindesk.com/policy/2023/03/22/sec-sues-jake-paul-for-illegally-touting-justin-sun-linked-cryptos/
...
contract JPI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "JAKE PAUL INU";
    string private constant _symbol = "JPI";
    ...
    address payable private _developmentAddress = payable(0xAb927377f9dBAB084319a888a5c6a1cb7a888f11); 
    address payable private _marketingAddress = payable(0xAb927377f9dBAB084319a888a5c6a1cb7a888f11);
