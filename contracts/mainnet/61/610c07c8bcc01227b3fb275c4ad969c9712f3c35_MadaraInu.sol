...
Telegram:   https://t.me/MadaraInuErc20
Twitter:    https://twitter.com/MadaraInuErc20
Medium:     https://medium.com/@madarainueth
Website:    http://madarainu.site

- 1% max wallet first hour, after limit remove 
- 4% buy, 25% sell 1° hour
- 4% buy, 20% sell after 1h and 30 minutes
- 4% buy, 10% sell 2° hour
- 4% buy, 4% sell after 2h and 30 minutes
...
contract MadaraInu is ERC20, Ownable {
    ...
    constructor() ERC20("Madara Inu", "MADARA") {
		...
		charityWallet = address(0x4e9988EB7E7fb563a59fAc2Ed102ce5a3b42cd0F); // set as charity wallet
        marketingWallet = address(0x4e9988EB7E7fb563a59fAc2Ed102ce5a3b42cd0F); // set as marketing wallet
        devWallet = address(0x4e9988EB7E7fb563a59fAc2Ed102ce5a3b42cd0F); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 4, "Max BuyFee 4%");
