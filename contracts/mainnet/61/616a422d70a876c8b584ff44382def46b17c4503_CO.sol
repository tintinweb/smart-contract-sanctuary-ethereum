 ...
 * allowances. See {IERC20-approve}.
 */
contract CO is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "The Chosen Ones";
    string private _symbol = "CH";
    uint8 private _decimals = 18;
    uint256 private _supply = 66666;
    uint256 public taxForLiquidity = 2;
    uint256 public taxForMarketing = 3;
    uint256 public maxTxAmount = 700 * 10**_decimals;
    uint256 public maxWalletAmount = 700 * 10**_decimals;
    address public marketingWallet = 0x812aC7F306060214C50691410Fc2Dfa18B18eeaa;
    uint256 private _numTokensSellToAddToLiquidity = 60 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 30 * 10**_decimals;
    // TOKENOMICS END ============================================================>
