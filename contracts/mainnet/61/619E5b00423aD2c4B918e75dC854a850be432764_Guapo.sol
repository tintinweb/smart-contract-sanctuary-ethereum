...
contract Guapo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Guapo";
    string private constant _symbol = unicode"GUAPO";
