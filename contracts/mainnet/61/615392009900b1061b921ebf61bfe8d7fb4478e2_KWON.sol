...
contract KWON is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x54fAfEe5C100d691Bc707cd84B7f361557e4c0aF);//
    address payable private _marketingAddress = payable(0x54fAfEe5C100d691Bc707cd84B7f361557e4c0aF);//
    ...
    uint256 public _maxWalletSize = 45000000000 * 10**9; //
