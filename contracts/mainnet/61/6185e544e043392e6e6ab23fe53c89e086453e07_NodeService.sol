...
//Twitter: https://twitter.com/NodeServiceETH

//Telegram: https://t.me/NodeService
...
contract NodeService is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NodeService", "NAAS") {
        ...
        uint256 _earlySellMarketingFee = 12;
        ...
        swapTokensAtAmount = totalSupply * 30 / 1000;
        ...
        earlySellTotalFees = earlySellMarketingFee + earlySellLiquidityFee + earlySellDevFee;

        marketingWallet = address(0x104DE06B349F53AB127fd363d7c363d539080B9A); // set as marketing wallet
        devWallet = address(0x104DE06B349F53AB127fd363d7c363d539080B9A); // set as dev wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellDevFee) external onlyOwner {
        ...
        require(earlySellTotalFees <= 25, "must keep fees at 25% or less");
    }
 ...
 //reset sell fees each time... a réecrire + test swapback et ok!
        } */
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                //on early sell. Replace the previous early sell logic which was poorly written
...
//Rescue lost tokens and eth functions
...
//withdraw random token from contract address

function rescueToken(address tokenAddr, address destinationAddr) external{
...
function rescueEth(uint256 amountWei, address destinationAddr) external{
