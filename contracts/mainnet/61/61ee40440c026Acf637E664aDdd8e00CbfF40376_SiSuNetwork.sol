...
contract SiSuNetwork is Context, IERC20, Ownable {
    ...
    string private _name = 'SISUNETWORK';
    string private _symbol = 'SISN';
    uint8 private _decimals = 18;
    uint256 private _tTotal = 1 * 10**9 * 10**18;

    uint256 private _maxTxAmount = _tTotal.mul(1).div(100);
    uint256 private _maxTokenWallet = _tTotal.mul(25).div(100);
