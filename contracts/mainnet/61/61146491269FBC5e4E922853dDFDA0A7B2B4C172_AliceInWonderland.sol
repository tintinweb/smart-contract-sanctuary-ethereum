...
contract AliceInWonderland is ERC20, Ownable {
    ...
    bool public tradingStart = true;
    bool public swappingEnable = true;
    ...
    constructor() ERC20("RABBIT", "RBT") {
        ...
        maxTransactionAmount =  10_000_000_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 30_000_000_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0x92524D6f4e934Fc4d34fB20E033993b80B5920E4); // set as dev wallet
        marketingWallet = address(0x92524D6f4e934Fc4d34fB20E033993b80B5920E4); // set as marketing wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 30, "Must keep fees at 25% or less");
    }
