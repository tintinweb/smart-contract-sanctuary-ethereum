...
contract PlatinumClubToken is Ownable{
    ...
    string public constant name = "Platinum Club Dubai Apartments Avani";
    string public constant symbol = "PCDAA";
    uint32 public constant decimals = 0;
    uint public totalSupply = 146;
    ...
    uint public unlockTransferRemain = 146;
