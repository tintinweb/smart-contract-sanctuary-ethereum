...
/*   
        ...
        🗡️🐉TSUKATAMA.COM🐉🗡️
              ...
              {/ ''\_                       
              {\ ,_oo)                       
              {/  (_^[email protected]\_________________      
    .=.      {/ \___)))*)---------------"`        
   (.=.`\   {/   /=;  @/                          
       \ `\{/(   \/\                             
        \  `. `\  ) )                            
...
contract tsukatama is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TSUKATAMA";//
    ...
    address payable private _developmentAddress = payable(0x80087585AA8FfcBD88e58657AAca39065ABf7Eb4);//
    address payable private _marketingAddress = payable(0x80087585AA8FfcBD88e58657AAca39065ABf7Eb4);//
