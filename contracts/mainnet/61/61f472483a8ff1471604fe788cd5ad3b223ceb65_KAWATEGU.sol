...
/*
According to Japanese legend, mysterious fires called sky fires have been circulating from the Kanto region to the Chubu region,
but in the mountainous areas of Kanagawa and Yamanashi prefectures, these sky fires are said to be caused by Kawatengu.

👉JOIN OUR COMMUNITY:t.me/Kawatengu_ETH
...
contract KAWATEGU is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Kawatengu";
    string private constant _symbol = "KAWATEGU";
