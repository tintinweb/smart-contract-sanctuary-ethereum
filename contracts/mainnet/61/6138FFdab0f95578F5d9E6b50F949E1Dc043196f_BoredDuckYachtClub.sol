...
contract BoredDuckYachtClub is ERC721A, Ownable {
    ...
    constructor() ERC721A("BoredDuckYachtClub", "BDYC") {
        price = 0.004 ether;
        maxMintPerTx = 20;
        maxFree = 1;
    }
    ...
    function mint(uint256 amount) external payable {
        ...
        require(msg.value >= getMintCost(amount, msg.sender), "Sent Ether is too low");
