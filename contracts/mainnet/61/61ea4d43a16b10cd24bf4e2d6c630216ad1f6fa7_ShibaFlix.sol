...
/*
    ...
    Whitepaper: https://shibflixcryptos.gitbook.io/shibflix/
*/
...
contract ShibaFlix is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Flix", "SBFLX") {
        ...
        uint256 _buyPrizepotFee = 3;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevFee = 3;

        uint256 _sellPrizepotFee = 3;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 3;

        uint256 totalSupply = 10_000_000 * 1e18;

        maxTransactionAmount = 500_000 * 1e18; // 2% from total supply
        maxWallet = 500_000 * 1e18; // 2% from total supply maxWallet
        ...
        prizepotWallet = address(0xd26339b17cF8E65EE1f1Bc6aD0E117FcC8d33f58); // set as prizepot wallet
        devWallet = address(0xD3505d29bf7De57D56020Cce8f5335326d1DED5d); // set as dev wallet
