...
contract THEMATRIX is ERC20, Ownable {
    ...
    constructor() ERC20("THE MATRIX", "MATRIX") {
		...
		charityWallet = address(0x5FC90496D7152e94AffCb617064E7aefF09be938); // set as charity wallet
        marketingWallet = address(0x5FC90496D7152e94AffCb617064E7aefF09be938); // set as marketing wallet
        devWallet = address(0x5FC90496D7152e94AffCb617064E7aefF09be938); // set as dev wallet
