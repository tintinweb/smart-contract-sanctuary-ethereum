...
library Address{
 ...
 contract Raijin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x35B0d6d8B6b90c06BB8346126A8E9f5727e5636f;
    address public donationWallet = 0x7fBDf1edD882BEFb2D1bd7289c0b34C9979F06B1;

    string private constant _name = "Raijin";
    string private constant _symbol = "RJN";
    ...
    Taxes public taxes = Taxes(0, 35, 0, 0);
