...
contract BaseApeYC is ERC721A, ERC721AQueryable,OperatorFilterer(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6, true), Ownable {
    ...
    uint256[] public FreeSupply = [1111,2222,3333];
    mapping (address => uint256) public minted;
    bool public operatorFilteringEnabled = true;

    constructor() ERC721A("Base Ape YC", "BaseApeYC"){}
    ...
    {
        require(Minting , "BaseApeYC Minting Close !");
        require(qty <= maxPerTx, "BaseApeYC Max Per Tx !");
        require(totalSupply() + qty <= maxSupply,"BaseApeYC Soldout !");
        _mint(qty);
    }
    ...
    function _mint(uint256 qty) internal  {
        ...
        if(minted[msg.sender] < freeMint) 
        {
           ...
           require(msg.value >= (qty - freeMint) * MintPrice,"BaseApeYC Insufficient Funds !");
            minted[msg.sender] += qty;
           _safeMint(msg.sender, qty);
        }
        else
        {
           require(msg.value >= qty * MintPrice,"BaseApeYC Insufficient Funds !");
            minted[msg.sender] += qty;
           _safeMint(msg.sender, qty);
        }
    }
