...
contract TheDick is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "THE DICK";
    string private _symbol = "$DICK";
    uint8 private _decimals = 18;
    uint256 public _totalDistributionShares = 4;

    address payable public marketingwallet = payable(0xC0473D78A9027f45dc3403BbE1dB90F19aE28B92);
