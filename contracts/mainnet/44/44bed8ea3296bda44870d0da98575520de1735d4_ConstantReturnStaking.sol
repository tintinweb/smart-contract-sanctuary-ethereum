...
contract ConstantReturnStaking is Ownable {
    ...
    address public TRUSTED_REWARD_TOKEN_ADDRESS = 0x6B175474E89094C44Da98b954EedeAC495271d0F;
    address public TRUSTED_WETH_TOKEN_ADDRESS = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    //address public TRUSTED_BUYBACK_CONTRACT_ADDRESS;
    
    // earnings reward rate (Ex: 2500 = 25%)
    // Rate = 10000 * price * 0.25 
    uint public REWARD_RATE_X_100 = 257;
