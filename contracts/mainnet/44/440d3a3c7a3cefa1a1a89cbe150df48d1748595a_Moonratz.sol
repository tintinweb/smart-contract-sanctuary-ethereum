...
contract Moonratz is ERC721A, Ownable {
    ...
    constructor() ERC721A("Moonratz", "MOONR", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function WhiteListMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
