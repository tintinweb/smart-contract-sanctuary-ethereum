...
contract BIZSHIBA is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "BIZ SHIBA";
    string private constant _Symbol = "BS";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e12 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x2587a3a4Be47E853D9677e84b4158F44AbB407fd);
        treasuryAddress = payable(0x2587a3a4Be47E853D9677e84b4158F44AbB407fd);
        devAddress = payable(0x2587a3a4Be47E853D9677e84b4158F44AbB407fd);
