...
contract Head is ERC721A,Ownable {
    ...
    uint256 public plain_price=10000000000000000000;
    uint256 public MaxNum = 500;
    mapping (address => uint256) private minter;
    bool public white_time;
    bool public plain_time;
    constructor() ERC721A("Soccer Bunny", "BU") {}
    ...
    function airdrop(address[] memory _to, uint256[] memory _num)external onlyOwner {
    ...
    function setWhite(address[] memory _to, uint256[] memory _num) external onlyOwner {
        require(_to.length == _num.length, "_to len must =  _num len");
