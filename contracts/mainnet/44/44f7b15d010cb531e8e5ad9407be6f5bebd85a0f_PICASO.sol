...
contract PICASO is ERC1155, Ownable, ERC1155Burnable,BlackLkisted {
    ...
    constructor() ERC1155("https://ktest.koreaapp.kr/metadata/") {
        name = "PICASO";
        symbol = "PICASO";
        }
       ...
       // Mint function
    function mint(uint256 amountToMint,uint256 _tokenid) public {
