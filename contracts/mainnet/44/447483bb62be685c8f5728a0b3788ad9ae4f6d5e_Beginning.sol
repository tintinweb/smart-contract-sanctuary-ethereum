...
contract Beginning is ERC20, Ownable {
    ...
    constructor() ERC20("Beginning", "BEG") {
        priceFeed = AggregatorV3Interface(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419); //0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419
        maxSupply = 10000000 * 10 ** decimals(); //10 million supply
    }
    ...
    function buyTokens(uint256 amount) public payable {
        ...
        require(msg.value >= price * amount / 10 ** decimals(), "Insufficient funds sent to buy this amount of Tokens!");
