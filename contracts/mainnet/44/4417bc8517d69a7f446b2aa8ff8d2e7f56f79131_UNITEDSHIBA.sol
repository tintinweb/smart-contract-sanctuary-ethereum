...
contract UNITEDSHIBA is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'UNITED SHIBA';
    string private constant _symbol = 'UNISHIB';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 300 ) / 10000;
    uint256 public _maxWalletToken = ( _totalSupply * 600 ) / 10000;
    ...
    address public constant liquidity_receiver = 0x3F4ECBD7f095c0Bf45FfAB9Ea06d4b1245F5D78e; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0x3F4ECBD7f095c0Bf45FfAB9Ea06d4b1245F5D78e;
