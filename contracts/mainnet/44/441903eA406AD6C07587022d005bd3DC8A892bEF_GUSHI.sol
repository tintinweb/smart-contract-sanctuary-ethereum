...
contract GUSHI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Guan Shi Yin";
    string private constant _symbol = "GUSHI";
    ...
    uint256 public _maxWalletAmount = 3 * 1e5 * 1e9;

    // fees
    uint256 public _liquidityFeeOnBuy = 0; 
    uint256 public _marketingFeeOnBuy = 10; 
    ...
    address payable private dev = payable(0x2AdD16cc83c2BaC513fF596e16D6BD0F8D0357D8);
    address payable private mktg = payable(0x0a8E4fe8c1d2dc6C75de921deBFeDec9041Cb857);
    ...
    function blacklistmany(address[] memory bots_) public onlyOwner() {
