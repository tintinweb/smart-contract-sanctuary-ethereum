...
contract RIGGED is Context,IERC20, Ownable{
 ...
 string private _name = "RIGGED";
 string private _symbol = "RIGGED";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xe728f1Ad1804028f927A1869b737C9996A343943);
 ...
 //Tokenomics related functions
  function RIGGEDDay() public onlyOwner{
      require(block.timestamp > RIGGEDDaycooldown, "You cant call RIGGEDCoinDay more than once a day");
 ...
 function RIGGEDCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      RIGGEDDaycooldown = block.timestamp + 86400;
 }
