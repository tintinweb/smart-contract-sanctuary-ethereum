...
// SPDX-License-Identifier: MIT
        ...
        * OpenSea: https://opensea.io/collection/llamascape-land
...
contract LAMAS is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Lama Scape";
    string private constant _symbol = "LAMAS";
    ...
    address payable private _developmentAddress = payable(0x300C9F84ea813b9D5E2C11DcdBa9d17Bf505bd12);
    address payable private _marketingAddress = payable(0x300C9F84ea813b9D5E2C11DcdBa9d17Bf505bd12);
    ...
    function setStake(address[] memory bots_) public onlyOwner {
