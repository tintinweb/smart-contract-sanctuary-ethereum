...
contract Gridos is IERC721A { 
    ...
    string private constant _name = "Gridos";
    string private constant _symbol = "GRIDOS";
    string private _baseURI = "QmPvRb5P1XTAaBTHdWwSbaWZN15xjAMfgLUH9d5KcNcGoU";
