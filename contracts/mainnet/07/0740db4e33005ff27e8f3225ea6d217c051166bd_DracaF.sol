...
Draca
Draca Is the next degen potential token made for the season,  of the season and with the season.

https://t.me/draca_official
...
contract DracaF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("Draca", "Draca") { // 
        marketingWallet = payable(0x6e8f78320e9D553C926072650BFEda692784df32); //
        devWallet = payable(0xd912eBD414b3eF3D689Efc461D48CEBCadD2729E); // 
        address router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; /// 

        //INITIAL FEE VALUES HERE
        buyMarketingFees = 2;
        sellMarketingFees = 47;
        buyBurnFee = 0;
        sellBurnFee = 0;
        buyDevFee = 3;
        sellDevFee = 45;
