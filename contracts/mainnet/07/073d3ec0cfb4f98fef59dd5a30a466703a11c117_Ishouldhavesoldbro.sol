...
/**DO NOT LET THEM MANIPULATE YOU BUY CALLING YOU A JEET,
YOU AR NOT A JEET, YOU ONLY TOOK PROFIT WHICH IS WHY YOU BOUGHT IN THE FIRST PLACE.

TAKE PROFIT YOUR FATHER DOESNT OWN BLOCKCHAIN AND NEITHER DID HE CREATE BITCOIN.

I HAVE ALSO ADDED !% TAX FOR THE REKT
 *
*/
...
contract Ishouldhavesoldbro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="IShouldHaveSold Bro";
    string private _symbol = "$TakeProfit";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x50FB32193E0F4167eC5Cb5fcc84a85E3Bc1128e6);
    address payable private taxWallet2 = payable(0xA664e8Bb8d515Fb04a245289Aff6a287B47c9A20);
