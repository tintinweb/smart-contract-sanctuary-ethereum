    ...
    VRFConsumerBaseUpgradeable
{
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        uint256 shiftedIndex = ((shiftValue + tokenId) % MAX_SUPPLY);
        return
            string(
                abi.encodePacked(
                    "ipfs://QmfUV7Bxnv6LbpBQzXExYaUmv6X3mkfwraf676JiM8PFDg/",
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "ipfs://QmfUV7Bxnv6LbpBQzXExYaUmv6X3mkfwraf676JiM8PFDg/";
    }
...
abstract contract VRFConsumerBaseUpgradeable is Initializable, VRFRequestIDBase {
    ...
    //   address _link
    // ) {
    function __VRFConsumerBaseUpgradeable_init(address _vrfCoordinator, address _link)
        internal
        initializer
    {
