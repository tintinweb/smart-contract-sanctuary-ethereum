...
// File: contracts/MergingMoodles.sol
...
contract BoredDoodsApeYachtClub is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    constructor(string memory initBaseURI) ERC721A("Bored Doods Ape Yacht Club", "BADYC") {
        baseURI = initBaseURI;
