...
// File: contracts/SpikeTheMutant.sol
...
contract SpikeTheMutant is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Spike The Mutant", "SPK") {}
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) external payable {
        ...
        require(WHITELIST_COST * _mintAmount <= msg.value,"ETH amount is not sufficient");
    ...
    function mintPublic(uint256 _mintAmount) external payable {
        ...
        require(PUBLIC_COST * _mintAmount <= msg.value,"ETH amount is not sufficient");
