...
contract FlokiTsuka is ERC20, Ownable {
    ...
    constructor() payable ERC20("FlokiTsuka", "fTSUKA") {
        ...
        defaultMarketingFee = 3;
        defaultLiquidityFee = 3;

        sellMarketingFee = 6;
        sellLiquidityFee = 3;
        sellTotalFees = sellMarketingFee + sellLiquidityFee;

        marketingAddress = address(0x7cc9b547d4Ed6AD2F5946C2b18fcC025137DC15C);
    ...
    function initiateLP(bool confirmAddLp) external onlyOwner {
