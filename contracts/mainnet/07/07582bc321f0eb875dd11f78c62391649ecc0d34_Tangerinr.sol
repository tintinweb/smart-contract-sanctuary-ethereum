 ...
 *
 * Tangerinr is a safe haven for all.
 *
 ...
 *
 * Tangerinr represents the lost memories of a time when community was truly all that was needed for
 ...
 *
 * It is up to YOU, the individual, to bring glory and wealth back to the Tangerinr name.
 *
 * All hail the Tangerinr
 *
 * Tax: buy 2% sell 2%
 */
...
contract Tangerinr is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "Tangerinr";
    string private _symbol = "Tangerinr";
