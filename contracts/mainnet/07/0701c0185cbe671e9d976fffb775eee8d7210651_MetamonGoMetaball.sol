...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract MetamonGoMetaball  is ERC721Enumerable,  Ownable {
    using Strings for uint256;


  string private uriPrefix = "";
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmRtTJGhPA6syat2AYJFPL2yhj44YRQzJMmBsgXqBLxKMf";
  ...
  uint16 public constant maxSupply = 40000;
  ...
  constructor() ERC721("Metamon Go Metaball ", "Mtbll") {
