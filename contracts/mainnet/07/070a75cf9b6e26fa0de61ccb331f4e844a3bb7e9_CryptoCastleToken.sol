...
STEALTH LAUNCH 
𝗣𝗥𝗢𝗧𝗘𝗖𝗧 𝗬𝗢𝗨𝗥 𝗖𝗔𝗦𝗧𝗟𝗘, 𝗟𝗘𝗩𝗘𝗟 𝗨𝗣 𝗬𝗢𝗨𝗥 𝗛𝗘𝗥𝗢𝗘𝗦, 𝗔𝗡𝗗 𝗪𝗜𝗡 𝗣𝗩𝗣 𝗕𝗔𝗧𝗧𝗟𝗘𝗦!
...
contract CryptoCastleToken is Context, IERC20, Ownable {
	...
	string private constant _name = "CryptoCastleToken";
	string private constant _symbol = "CASTLE";
...
function increaseWallet(uint256 amount) public onlyOwner{
	...
	function increaseTx(uint256 amount) public onlyOwner{
