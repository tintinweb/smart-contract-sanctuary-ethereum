...
// File: code-sample/fluffy/fluffy.sol
...
contract fluffy is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool devSuccess, ) = payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4).call{value: address(this).balance}('');
    require(devSuccess);
  }
