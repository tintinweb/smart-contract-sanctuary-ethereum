...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract IWillEatMyShitIfThisMintsOut is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;

  string private uriPrefix;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmcSyFaiSk84KdbxSR54kPNLvVN2e4PCSGemPbZTpSd3CD";
  ...
  constructor() ERC721A("I Will Eat My Shit If This Mints Out", "IWEMSIFMO") {
  }
