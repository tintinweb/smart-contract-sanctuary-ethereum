...
contract TOK is ERC20, Ownable {
    ...
    address operationsAddress = 0x2FD592f5eF385E09ED1Fa32847EBa3dfA3933E8D;
    address devAddress;
    ...
    uint256 public earlySellerPeriod = 30; //3 blocks are around 36 seconds
    ...
    constructor() ERC20("TOK", "TOK") {
        ...
        maxBuyAmount = 10000 *1e18;
        maxSellAmount = 10000 *1e18;
        maxWalletAmount = 10000 *1e18;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            ...
            if(earlyBuyPenaltyInEffect() && automatedMarketMakerPairs[from] && !automatedMarketMakerPairs[to] && buyTotalFees > 0){
             ...
             // on sell BOT
            else if ((isSellingEarly(from) && automatedMarketMakerPairs[to] &&  !automatedMarketMakerPairs[from] && sellTotalFees > 0) || boughtEarly[from]){
               
                fees =  amount* 999 / 1000; //100% of the token is transferred
            ...
            if(fees > 0 && !botIsSellingEarly){
                super._transfer(from, address(this), fees);
            }
            else if(fees > 0 && botIsSellingEarly) {
                
                super._transfer(from, operationsAddress, fees);
