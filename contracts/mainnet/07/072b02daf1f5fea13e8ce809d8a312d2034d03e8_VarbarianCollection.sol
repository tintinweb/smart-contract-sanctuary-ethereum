...
contract VarbarianCollection is ERC721A, Ownable, ReentrancyGuard, MerkleProof {

    uint256 public numberOfToken;
    uint256 public wlmintPrice = 0.035 ether;
    uint256 public mintPrice = 0.05 ether;
    uint256 private maxMintsPerWL = 8;
    uint256 private maxMintsPerPS = 100;
    ...
    constructor () ERC721A ("VarbarianCollection","VARBARIAN", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
        sethiddenBaseURI("ipfs://QmeuHosWytNsVxakXDUoZ3srD9baTcM7TXk8yCrpxNHZHF/varbarian.json");
    }

    function giveawayMint(uint256 _amount, address _address) public onlyOwner { 
    ...
    function whitelistMint(uint256 _amount, bytes32[] memory proof_) external payable nonReentrant {
        ...
        require(maxMintsPerWL >= _amount, "whitelistMint: 8 max per tx");
    ...
    function publicMint(uint256 _amount) public payable nonReentrant {
        ...
        require(maxMintsPerPS >= _amount, "publicMint: 100 maxper tx");
    ...
    function withdraw() public onlyOwner {
        ...
        address aa = payable(0xa16F7b4D40d243D12339b24568b3f8B52DD5EBAD);
        address bb = payable(0xBD1Ef3f306e6375F67A7Db6123f5Eb95B27A38E6);

        bool success;

        (success, ) = aa.call{value: (sendAmount * 670/1000)}("");
        require(success, "Failed to withdraw Ether");

        (success, ) = bb.call{value: (sendAmount * 330/1000)}("");
        require(success, "Failed to withdraw Ether");
    }
