...
// File: contracts/SkidsUnrugged.sol
...
contract SkidsUnrugged is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public mintSupply = 7888;
    uint256 public MAX_MINTS = 100;
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("Skids UNRUGGED", "SKIDSUR") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "Still not open!!");
        require(qty <= MAX_MINTS, "That's the limit!");
        require(totalSupply() + qty <= mintSupply,"All Sold Out!");
