...
contract PixTv is Context, ERC721Tradeable {
  using SafeMath for uint256;
  using SafeMath for int256;
  using Counters for Counters.Counter;

  address payable payableAddress;
  constructor(address _proxyRegistryAddress) ERC721Tradeable("Pixalated TV", "PIXTV", _proxyRegistryAddress) {
    _baseTokenURI = "ipfs://bafybeidnuihxxevhbkxnr5fsnjvyfjm24dhd4ngm7mdytw33jjkdlfphce/";
    payableAddress = payable(0x54BAe85a9936a17A08fcD3D7AfE3fC4eD97bCf1C);
  }
    ...
    function contractURI() public pure returns (string memory) {
      return "https://bafkreih2bpgenhghrafdmsrdve4cinit6u7ldf5whbfdbrxwaaqy7rfsdq.ipfs.nftstorage.link";
    }
