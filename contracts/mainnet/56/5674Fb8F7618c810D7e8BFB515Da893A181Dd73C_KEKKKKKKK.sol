...
contract KEKKKKKKK is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Proof Of KEK";
    string private constant _symbol = "KEK2.0";
    ...
    address payable private _developmentAddress = payable(0xD1855c04E4874589ba54C83f37028822643d712b);
    address payable private _marketingAddress = payable(0xD1855c04E4874589ba54C83f37028822643d712b);
