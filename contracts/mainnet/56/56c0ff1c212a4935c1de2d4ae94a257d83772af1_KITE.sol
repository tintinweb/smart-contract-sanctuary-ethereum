...
The Kite introduces an ingenious tax system to stop jeets (no racial slur intended, otherwise known as day traders) from dumping $KITE tokens. 
...
This is done by taxing them immensely at +25% sell tax, which the contract then adds to the $KITE's liquidity pool and in turn stabilizes the price floor of the token. 
However, they are allowed to sell up to 49% of their holdings per transaction to avoid being penalized.

Kite contract also recognizes chads who invest at least 0.5 ETH in total buys and are exempted from the sell penalty tax. 
By giving them the confidence that their investments are safu.

Jeet tax: 5/30
Chad tax: 5/5

Twitter - https://twitter.com/KITE_ERC
...
contract KITE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kite", "KITE") {
        ...
        marketingWallet = address(0x6707F4E2254F08AA07Aaf0c35c9C137B8821Bd33); // set as dev wallet
