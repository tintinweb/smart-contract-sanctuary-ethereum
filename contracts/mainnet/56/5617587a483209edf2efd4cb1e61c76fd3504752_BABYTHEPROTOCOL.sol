...
contract BABYTHEPROTOCOL is ERC20, Ownable {
    ...
    constructor() ERC20("Baby The Protocol", "BTP") {
        ...
        marketingWallet = address(0x70572F48CaC1fcB023FF6e7470d240600CF2cCD7); // set as marketing wallet
        devWallet = address(0x70572F48CaC1fcB023FF6e7470d240600CF2cCD7); // set as dev wallet
