...
contract TheHumanMind is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRfoPDENZ27LYhmBE1FAv2jLDRNoJrA6toxNDHM7Mczu1";
    ...
    constructor(
    ) ERC721A("The Human Mind", "THM", 100, maxSupply) {
    }
