...
/**
     ...
     / ,< / /_ // _ \  / , _/ _ \/ _ \/ / _ \
    /_/|_/_//__/\___/ /_/|_|\___/_//_/_/_//_/
	For The People, By The People

	Website: https://kizoronin.com/
	Telegram: https://t.me/KizoRoninPortal
	Twitter: https://twitter.com/KizoRonin
	YouTube: https://youtube.com/channel/UC-MrrRGFZ3Z8KSLEM-Vj2Hw
...
contract KizoRonin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kizo Ronin", "$KIZO") {
        ...
        maxWallet = 3 * 1e4 * 1e18;
        swapTokensAtAmount = 1 * 1e3 * 1e18;

        BuyTax = _buyTax;
		SellTax = _sellTax;
         
		marketingWallet = address(0x64b137e3a1534C67561dfC97DC6271762e646eCB);
