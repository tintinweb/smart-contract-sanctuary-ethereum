...
contract Chongqing is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chongqing 重庆犬";
    string private constant _symbol = unicode"CHONG";
