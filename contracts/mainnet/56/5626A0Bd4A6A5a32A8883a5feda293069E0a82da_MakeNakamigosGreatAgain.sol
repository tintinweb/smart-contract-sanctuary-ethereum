...
contract MakeNakamigosGreatAgain is Context, IERC20, Ownable {
  ...
  uint256 private _totalSupply = 69420000000 * 10**5;
  string private _symbol = "MNGA";
  string private _name = "Make Nakamigos Great Again";
