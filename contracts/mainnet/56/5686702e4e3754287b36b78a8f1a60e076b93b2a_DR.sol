...
contract DR is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmXtvQw1fDB6wLgyKmVoYhEmeLL7XSKhn3UE1YNGdWoymE";
    ...
    constructor(
    ) ERC721A("Dogg it up: Death Row Mixtape Vol. 2", "DeathRow", 100, maxSupply) {
    }
