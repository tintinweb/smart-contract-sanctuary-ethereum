...
Aithereum is a decentralized platform that integrates AI technology into the DeFi ecosystem. The native token of the platform is $AIETH. Aithereum aims to provide users with a secure, efficient, and user-friendly DeFi experience

Socials

TG: https://t.me/Aithereum
Twitter: https://twitter.com/aithereumeth
Website: www.projectaithereum.com
Medium: https://medium.com/@aithereumeth
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/
...
contract Aithereum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Aithereum";
    string private constant _symbol = "AIETH";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 800;
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            marketing: 4, // marketing fee in %
            lp: 1, // lp rate in %
            toSwap: 5 // marketing + dev + lp
        });
