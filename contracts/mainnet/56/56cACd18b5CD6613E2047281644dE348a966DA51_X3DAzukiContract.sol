...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAbCF2700aDf68ab8A57D8Ec10BA9B3D8c50f001E];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSXBALRwhe6pQYDRHp4sKZbdoBnro9Hk4pJ9bJsEJLrYh/";
...
// File: contracts/X3DAzukiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3DAzukiContract is RamppERC721A {
    constructor() RamppERC721A("3DAzuki", "3DAZU"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HzqIwJqkhh0V405AARfu/contract-metadata";
    }
}
