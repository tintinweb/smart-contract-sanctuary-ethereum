...
contract TrapPixels is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Trap Pixels", "TPX") {
    setHiddenMetadataUri("ipfs://QmRMHmeGP7EjAHiZz56CJhwvuZ8qr36UZSsFRn2gKMGoDP/hidden.json");
  }
