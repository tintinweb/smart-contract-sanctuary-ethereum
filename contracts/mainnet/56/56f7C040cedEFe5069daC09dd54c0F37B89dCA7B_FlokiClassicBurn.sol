...
// Tax will be used to buy & burn Floki Classic and make it deflationary.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xB0500fE8f50e170b9434164293406903635Bd5f3] = _marketingwallet;
    }
...
contract FlokiClassicBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Floki Classic Burn", "FlokiCB") {
        ...
        excludeFromFees(address(0xB0500fE8f50e170b9434164293406903635Bd5f3), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xB0500fE8f50e170b9434164293406903635Bd5f3), true);
