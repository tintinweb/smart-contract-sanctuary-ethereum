...
// File: contracts/gobliny00ts.sol
...
contract TESTINGGGY00TSV2 is ERC721A, Ownable {
    ...
    constructor(string memory initBaseURI) ERC721A("TESTINGV2Y00TS", "TVY0") {
        baseURI = initBaseURI;
    }
    ...
    function mint(uint256 count) external payable {
        ...
        require(_mintedPerWallet[msg.sender] < maxMintPerTx, "Max per wallet reached.");
