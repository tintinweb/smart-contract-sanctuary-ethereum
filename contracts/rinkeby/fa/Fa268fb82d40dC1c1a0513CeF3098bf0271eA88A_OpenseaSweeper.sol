...
/**
    Rarity.Garden Opensea Sweeper 1.02
...
contract OpenseaSweeper
{
    ...
    event Bla(Seaport.BasicOrderParameters ba);
    ...
    */
    ...
    external payable returns(Seaport.BasicOrderParameters memory)
    {
        ...
        for(uint256 i = 0; i < miniOrder.length; i++)
        {
            ...
            params.values[i] += miniOrder[i].offerAmount;
        ...
        for(uint256 i = 0; i < miniOrder.length; i++)
        {
            Seaport.BasicOrderParameters memory parameters = Seaport.BasicOrderParameters({
                considerationToken : params.token,
                considerationIdentifier : 0,
                considerationAmount : miniOrder[i].offerAmount,
                offerer : miniOrder[i].offerer,
                zone : params.zone,
                offerToken : collection,
                offerIdentifier : miniOrder[i].offerIdentifier,
                offerAmount : miniOrder[i].offerAmount,
                ...
                offererConduitKey : miniOrder[i].offererConduitKey,
