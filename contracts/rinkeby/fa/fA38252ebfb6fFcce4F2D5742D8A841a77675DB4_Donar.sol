...
contract Donar is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    uint256 private s_totalPremiado;
    ...
    function fulfillRandomWords(
        ...
        s_donacionesId++;
        s_totalPremiado += ((address(this).balance * 5) / 100);
        s_totalDonado += (((address(this).balance - s_totalPremiado) * 90) / 100);
        s_totalToken += (((address(this).balance - s_totalPremiado) * 10) / 100);
    ...
    function totalPremios() public view returns (uint256) {
        return s_totalPremiado;
    }
