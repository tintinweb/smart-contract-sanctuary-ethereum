...
contract Activity {
    ...
    event AirDropCreated(address indexed distributor, uint256 indexed activityId, address indexed token, uint256 tokenAmount);
    event AirDropStarted(address indexed distributor, uint256 indexed activityId, address indexed token, uint256 tokenAmount, bytes32 rootHash);
    ...
    // distributor --> number of activities/activityId --> airdrop activity
        ...
        returns (bool)
    {
        ...
        emit AirDropCreated(msg.sender, activityId, _tokenAddress, _tokenAmount);
        return true;
    }

    /**
        * @dev set root hash and Start airdrop claim with activityId 
        ...
        returns (bool)
    {
        ...
        emit AirDropStarted(msg.sender, _activityId, activities[msg.sender][_activityId].tokenAddress, activities[msg.sender][_activityId].tokenAmount, _rootHash);        
        return true;
    }
     ...
     * @param activityId the number of the airdrop event
