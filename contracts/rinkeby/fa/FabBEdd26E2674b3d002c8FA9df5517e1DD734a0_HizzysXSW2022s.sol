...
contract HizzysXSW2022s is Ownable, PaymentSplitter, ERC721A {
    ...
    uint public mintLimit = 256;
    uint public collectionLimit = 320;
    ...
    address[] private _addressList = [
        ...
        0x1cD75D18bDd26Bfe906bE4d63c8341474e6A76D6 // TODO: Get hizzy's wallet
    ];
    ...
    function airdrop(uint256 quantity, address addr) external onlyOwner {
