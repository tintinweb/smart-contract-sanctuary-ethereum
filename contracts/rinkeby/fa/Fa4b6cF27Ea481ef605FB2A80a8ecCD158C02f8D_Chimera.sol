...
contract Chimera is ERC721, ERC721Enumerable, Ownable {
  
  uint256 public constant TOKEN_PRICE = 10000000000000000; //0.01 ETH
  uint16 public constant TOTAL_SUPPLY = 300;
  ...
  constructor(string memory preRevealURI, string memory provenanceHash) ERC721 ("Chimera", "CHY") {
    _couponSigner = owner();
    ...
    payable
  {
    ...
    require(totalSupply() < TOTAL_SUPPLY, "Minting limit reached.");
  ...
  function setSaleIsActive(bool saleIsActive)
    external
    onlyOwner
 {
