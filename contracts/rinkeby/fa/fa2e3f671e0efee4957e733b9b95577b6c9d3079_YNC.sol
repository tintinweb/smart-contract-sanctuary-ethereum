...
/// @title YNC collection smart contract
contract YNC is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement {
    using Strings for uint256;
    using Counters for Counters.Counter;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "YNC: total supply reached");
        _;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "YNC: tranfer is temporarily unavailable"
            );
        }
