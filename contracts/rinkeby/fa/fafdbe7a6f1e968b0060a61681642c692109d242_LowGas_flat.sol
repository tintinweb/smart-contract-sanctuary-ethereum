...
contract LowGas_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Lost Camera Roll", "LCR") {
    setHiddenMetadataUri("ipfs://Qmc1Z83UZtvjXLCa3WLH9aLLZiULVqKVe2P3i3rtT7xB7e/hiddenLostCameraRoll.json");
  }
