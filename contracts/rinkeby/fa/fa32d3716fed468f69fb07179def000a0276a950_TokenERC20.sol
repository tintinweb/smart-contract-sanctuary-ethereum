...
contract TokenERC20 {
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        require(_to != 0x0,"address error");
        // 检查发送者余额
        require(balanceOf[_from] >= _value,"value not enough");
        // 确保转移为正数个
        require(balanceOf[_to] + _value > balanceOf[_to],"step3");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        require(_value <= allowance[_from][msg.sender],"allow not right");     // Check allowance
