...
// File: github/chiru-labs/ERC721A/contracts/nic_meta.sol
...
contract Jackman is ERC721A, Ownable {
    enum Status {
        Pending,
        PreSale,
        PublicSale,
    ...
    function setBlindBoxOpened(bool _statu) external onlyOwner {
        _blindBoxOpened = _statu;
    }
