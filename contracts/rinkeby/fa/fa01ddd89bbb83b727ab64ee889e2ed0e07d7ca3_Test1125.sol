...
contract Test1125 is ERC721, ERC721Enumerable, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 22;

    uint256 public constant MAX_PRE_SALE_MINTS = 0;
    uint256 public constant PRE_SALE_PRICE = 99 ether;

    uint256 public constant MAX_PUBLIC_SALE_MINTS = 2;
