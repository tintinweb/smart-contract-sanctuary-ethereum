...
contract FunguysNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Funguys", "FUNG") {
 ...
 function presalemint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    
    require(presaleActive == true, "presale ain't live yet buddy!");
    require(msg.value >= cost * _mintAmount, "Insufficient funds!");
