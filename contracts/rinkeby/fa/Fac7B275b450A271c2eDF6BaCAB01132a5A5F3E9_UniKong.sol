...
contract UniKong is ERC721A, Ownable, Pausable {
    ...
    bytes32 public ogRoot =
        0x776a7ec9126ce3291fb987c39f74ac7ab5907e47852f9eef340e53689ffd322f;
    bytes32 public wlRoot =
        0x66c36c731394267255a625c1139ece77d44670cafad1b573678e88063b9a34ed;

    string public _contractBaseURI = "https://unreveal.unikong.com/";
    string public _contractURI = "https://jsonkeeper.com/b/30KY";
    ...
    uint256 public ogSaleStartTime = 1647099900;
    uint256 public ogSaleEndTime = 1647101699;
    uint256 public whitelistSaleStartTime = 1647101700;
    uint256 public whitelistSaleEndTime = 1647102900;
    uint256 public publicSaleStartTime = 1647103500;
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool all1, ) = payable(0x0eEdAFc55A8f8D26C90EC0F15A72A130b98a3dC6)
            .call{value: (_total_owner * 1) / 3}(""); //l
        require(all1);
        (bool all2, ) = payable(0x0eEdAFc55A8f8D26C90EC0F15A72A130b98a3dC6)
            .call{value: (_total_owner * 1) / 3}(""); //sc
        require(all2);
        (bool all3, ) = payable(0x0eEdAFc55A8f8D26C90EC0F15A72A130b98a3dC6)
