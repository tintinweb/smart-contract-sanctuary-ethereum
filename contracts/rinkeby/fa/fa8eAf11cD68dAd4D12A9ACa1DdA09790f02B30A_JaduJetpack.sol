...
contract JaduJetpack is ERC721Enumerable, AccessControl, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    string _baseTokenURI = "https://us-east1-jadu-e23c4.cloudfunctions.net/getJetPack?tokenId=";

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    address public upgradedToAddress = address(0);
    uint256 internal _cap = 1111;
