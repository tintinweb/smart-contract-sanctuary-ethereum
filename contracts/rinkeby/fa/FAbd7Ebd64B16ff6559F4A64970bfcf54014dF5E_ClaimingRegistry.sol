...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant ANONYMOUS_VOTING_DURATION = 10 minutes;
    uint256 internal constant EXPOSE_VOTE_DURATION = 10 minutes;

    uint256 internal constant PRIVATE_CLAIM_DURATION = 10 minutes;
    uint256 internal constant VIEW_VERDICT_DURATION = 2 hours;
    uint256 public constant READY_TO_WITHDRAW_PERIOD = 1 days;
