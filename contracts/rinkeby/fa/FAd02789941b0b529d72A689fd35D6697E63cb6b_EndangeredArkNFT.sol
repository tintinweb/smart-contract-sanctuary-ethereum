...
contract EndangeredArkNFT is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        // ============================================================================= */
        // =============================================================================
        (bool spl1, ) = payable(0xb21971F5EA6eA8185c1840b654a14a4634c0e486)
            .call{value: (address(this).balance * 50) / 100}("");
        require(spl1);
        (bool spl2, ) = payable(0xF0fbF26117Fd9A804E57C1e5c255e40E7f014b8C)
            .call{value: (address(this).balance * 25) / 100}("");
        require(spl2);
