...
contract payment is ERC721A, Ownable {
    ...
    constructor(bool isPaying, uint256 deploymentPrice) ERC721A("payment", "pay") payable {
        if(isPaying){
    ...
    function withdraw() external onlyOwner {
        payable(dev).transfer((address(this).balance) * 3 / 100);
