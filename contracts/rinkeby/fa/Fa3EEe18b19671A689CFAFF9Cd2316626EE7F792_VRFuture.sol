...
contract VRFuture is ERC721A, Ownable {
    ...
    constructor() ERC721A("VRFuture", "VRF", maxPerTx) {
    ...
    // Make it possible to change the price for WL mint
    function setPriceWL(uint256 _newPrice) external onlyOwner {
        priceWL = _newPrice;
    }
    
    // Make it possible to change the price for public mint
