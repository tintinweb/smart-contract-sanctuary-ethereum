...
// @title GangsterSapiens NFT Smart Contract
// @authors Nathan Smyth & Jon Leveille
// @notice This contract provides 6'666 Gangster Sapiens NFTs
...
contract GangsterSapiens is ERC721Enumerable, Ownable{
    ...
    bool private revealSingle = false;
    ...
    /// @param _newRevealURI for the prevereal uri
    /// @param _newContractURI for the contract Opensea data connection
    ...
    /// @param _to addres to whom the NFT will be minted. Usable for single Airdrops
    ...
    /// @notice switches revealed
    function switchRevealed() public onlyOwner {
        revealed = !revealed;
    }

    /// @notice switches revealed type. True = contract returns url as revealURI/tokenID.json. False = contract returns url as revealURI.
    ...
    /// @notice function for users to mint their airdrop NFT
