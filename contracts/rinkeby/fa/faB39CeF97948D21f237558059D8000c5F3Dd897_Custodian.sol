...
contract Custodian is Ownable, ICustodian {
    ...
    IPoolAddressesProvider public immutable aaveAddresses;
    ...
    uint256 constant baseReserveShare = 0; // portion of liquidity to keep as reserve, in 1/1000th

    constructor(
        ILPToken _lpToken,
        IERC20 _usdc,
        IERC20 _aUsdc,
        IPoolAddressesProvider _aaveAddresses
    ) {
        lpToken = _lpToken;
        usdc = _usdc;
        aUsdc = _aUsdc;
        aaveAddresses = _aaveAddresses;
        aavePool = IAavePool(_aaveAddresses.getPool());
    }
