...
contract MrBiskit is ERC721URIStorage, Ownable {
    //NFT Variables
    ...
    constructor(string[1] memory biskitUri) ERC721("MrBiskit", "MBI") {
        s_biskitUri = biskitUri;
    }

    function mint() public onlyOwner returns (uint256 tokenId) {
        _safeMint(msg.sender, TOKEN_ID);
        _setTokenURI(TOKEN_ID, s_biskitUri[0]);
        emit NftMinted(TOKEN_ID, msg.sender);
        return TOKEN_ID;
    }
