...
// $DDRL is an Ethereum token that gives holders governance rights in Decentralised Research and Design Lab. 
...
contract vendingMachineDDRL is Ownable{
    ...
    function setVotePrice(uint votesPerEth) public onlyOwner {
        _votesPerEth = votesPerEth ;
    }
...
function buyTokens() public payable returns (uint256 tokenAmount) {
    ...
    uint256 amountToBuy = msg.value * _votesPerEth;
