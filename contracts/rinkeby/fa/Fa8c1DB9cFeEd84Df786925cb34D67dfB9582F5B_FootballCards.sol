...
contract FootballCards is ERC721, VRFConsumerBase, Ownable {
    ...
    mapping(uint256 => playerCard) public players;
    mapping(uint256 => playerPerk) public playersPerks;
        ...
        override
    {
        ...
        players[tokenCounter] = playerCard(
            name,
            speed,
            acceleration,
            pass,
    ...
    function getPerks(uint256 randomNumber) internal {
        ...
        playersPerks[tokenCounter] = playerPerk(
            perk1,
            perk2,
            perk3,
            boost1,
    ...
    function updatePlayer(uint256 tokenId, uint256[] memory upgrades)
        ...
        onlyOwner
    {
        playerCard memory player = players[tokenId];
