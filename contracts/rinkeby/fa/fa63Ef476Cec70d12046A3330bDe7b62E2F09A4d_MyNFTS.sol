...
// File: MyNFT/IERC721Receiver.sol
...
// File: MyNFT/IERC721Metadata.sol
...
// File: MyNFT/ERC721URIStorage.sol
...
contract MyNFTS is ERC721, ERC721URIStorage, Ownable {
   ...
   using ECDSA for bytes32;
    ...
    function specialMint(uint256[] memory ids, address to) external payable{
        _safeMint(to, ids[0], '0x00');
        _safeMint(to, ids[1], '0x00');
        _safeMint(to, ids[2], '0x00');
    }
