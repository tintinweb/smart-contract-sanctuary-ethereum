...
contract SpaceBuns is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint256 public alMintPrice = 0.08 ether;
    ...
    modifier priceCalc(uint _price, uint _quantity) {
      ...
      require(maxSupply - reserveSupply >= _tokenIds.current() + _quantity, "Sold out or Exceeds max tokens wtf");
      _;
    }
    ...
    function getClaimIneligibilityReason() public view returns (string memory) {
