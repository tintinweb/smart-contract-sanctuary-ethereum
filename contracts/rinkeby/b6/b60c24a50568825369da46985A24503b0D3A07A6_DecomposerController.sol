...
contract DecomposerController is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        // addContract(0xBACe7E22f06554339911A03B8e0aE28203Da9598, _maxEditions, uint8(cT.ERC721)); // CryptoArte
        // addContract(0xF7a6E15dfD5cdD9ef12711Bd757a9b6021ABf643, _maxEditions, uint8(cT.ERC721)); // CryptoBots
        ...
        // addContract(0x06012c8cf97BEaD5deAe237070F9587f8E7A266d, _maxEditions, uint8(cT.ERC721)); // CryptoKitties
    ...
    function addContract(address contractAddress, uint256 maxEditions, uint8 _cT ) public onlyOwner {
      ...
      if (_cT == uint8(cT.ERC721)) {
        ...
        require(_cT == uint8(cT.Punk) || _cT == uint8(cT.Folia), "Unknown contractType");
      }
    ...
    function buy(address recipient, address contractAddress, uint256 tokenId) public payable notPaused nonReentrant returns(bool) {
        ...
        } else if (aC[contractAddress]._cT == cT.ERC721) {
