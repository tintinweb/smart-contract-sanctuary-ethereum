  ...
  */
  ...
  // == SET SUPPLIES == //
    ...
    function withdraw() public onlyOwner {
      ...
      require(payable(0x0000000000000000000000000000000000000001).send(currentBalance * 42 / 100), "withdraw failed"); // 42%
      require(payable(0x0000000000000000000000000000000000000002).send(currentBalance * 23 / 100), "withdraw failed"); // 23%
      require(payable(0x0000000000000000000000000000000000000003).send(currentBalance * 18 / 100), "withdraw failed"); // 18%
      require(payable(0x0000000000000000000000000000000000000004).send(currentBalance * 9 / 100), "withdraw failed"); // 9%
      require(payable(0x0000000000000000000000000000000000000005).send(currentBalance * 8 / 100), "withdraw failed"); // 8%
  }
