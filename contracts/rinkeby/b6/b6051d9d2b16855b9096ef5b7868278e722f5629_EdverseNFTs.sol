...
contract EdverseNFTs is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.007 ether; // Mint fee in MATIC
  uint256 public maxSupply = 150;
  uint256 public publicsalePerAddressLimit = 15; // Per address mint limit

  bool public paused = false;
  bool public revealed = true;
  
  uint256 metadataUpdateFee = 0.005 ether;// Fee in MATIC
