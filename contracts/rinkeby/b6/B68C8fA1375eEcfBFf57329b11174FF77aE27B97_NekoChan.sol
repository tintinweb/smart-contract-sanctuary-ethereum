...
contract NekoChan is ERC721URIStorage, ERC721Enumerable, Ownable, ERC20TokenCallerBase {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string public baseTokenURI;

    uint private totalNekoChan = 10000;

    constructor() ERC721("NekoChan", "NEKO") {
    }

    function safeMintNeko(address to) public onlyOwner returns (uint256) {
        require (totalNekoChan <= 10000, "over total mint");
        _tokenIds.increment();
    ...
    function safeBatchMintNeko(address to, uint count) public onlyOwner returns (uint) {
        require (totalNekoChan + count <= 10000, "over total mint");
    ...
    function mintNeko() public returns (uint256) {
        require (totalNekoChan <= 10000, "over total mint");
    ...
    function batchMintNeko(uint256 count) public returns (uint256) {
        require (totalNekoChan + count <= 10000, "over total mint");
...
abstract contract ERC20TokenCallerBase {
    ...
    address internal _token20Contract = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709;
