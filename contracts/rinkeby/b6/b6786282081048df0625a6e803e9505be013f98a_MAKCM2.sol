...
contract MAKCM2 is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxWalletLimit = 5;
  ...
  constructor() ERC721A("Mutant Ape Kids Club M2", "MAKCM2") {
      setHiddenMetadataUri("https://ipfs.io/ipfs/QmdYUnqAsiWeTJvp5125JNFU7VtMHEzVdYkQ7QZ5ApFg6x/hidden.json");
  }
