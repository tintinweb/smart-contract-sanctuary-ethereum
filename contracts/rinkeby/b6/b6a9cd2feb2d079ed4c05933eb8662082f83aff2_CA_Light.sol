...
// CONTRACT
contract CA_Light is Context, IERC20, Ownable {
    string private constant _name = "Light";
    string private constant _symbol = "9";
    uint8 private constant _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x32CA1c6E08bd89159816e8cF55768A0F4E8daA9D);
    address payable private constant initialLpReceiver =
        payable(0x1459B62E9c67178122Eb902FE12f9eB643D857eA);
    ...
    uint256 public buyTax = 99; // buy tax = 0.99%
    uint256 public sellTax = 999; // sell tax = 9.99% 

    uint256 public lpShare = 333; // auto_LP = 3.33%
    uint256 public autoBurnShare = 333; // auto_burn = 3.33%
    uint256 public marketingShare = 333; // marketing = 3.33%

    uint256 private constant _totalSupply = 999999 * 10**_decimals; // total supply = 999,999
    uint256 public swapThreshold = 999 * 10**_decimals;
    uint256 public maxTxAmount = 3333 * 10**_decimals; // max_tx = 0.333%
    uint256 public walletMax = 9999 * 10**_decimals; // max_wallet = 0.999%
    ...
    constructor() payable {
        ...
        balances[address(this)] = 667777 * (10 ** decimals());
    ...
    function launch(uint256 _snipePenaltyBlocks, uint256 _sellPenaltyBlocks) external onlyOwner {
        ...
        lpPair = IDexFactory(dexRouter.factory()).createPair(address(this),address(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C));
        //test DAI
        //lpPair_DAI = IDexFactory(dexRouter.factory()).createPair(address(this),dexRouter.address(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C));
      ...
      //FIN_test DAI
        ...
        // add the liquidity //DAI: 0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C

        //require(address(this).balance > 0, "Must have ETH on contract to launch");
        require(balanceOf(address(this)) > 0, "Must have Tokens on contract to launch");
        require(balanceOf(address(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C)) > 0, "Must have DAI on contract to launch");
