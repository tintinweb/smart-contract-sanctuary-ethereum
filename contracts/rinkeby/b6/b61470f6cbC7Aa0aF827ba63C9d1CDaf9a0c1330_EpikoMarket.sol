...
pragma solidity ^0.8.1;
contract EpikoMarket is ERC1155,IERC2981,IERC1155Minter,Ownable{
    ...
    function mint(
        ...
        require(msg.sender == marketplaceAddress, "ERC1155: Not authorised");
    ...
    function burn(address from, uint256 tokenId,uint256 amounts) public override {
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, uint256 value, bytes memory data) public override(ERC1155,IERC1155){
