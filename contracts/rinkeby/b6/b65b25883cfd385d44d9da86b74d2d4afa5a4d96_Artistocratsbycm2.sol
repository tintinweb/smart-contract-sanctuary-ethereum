...
contract Artistocratsbycm2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost_wl = 0.0045 ether;
  ...
  constructor() ERC721("The Aristocrats", "WATA") {
    setHiddenMetadataUri("ipfs://bafybeibvdfqraxcm2ikxl4w3peguadyawfigbh7ro3b5cpspsx25fkjkiy/hidden.json");
  }
