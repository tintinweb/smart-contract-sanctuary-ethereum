...
contract WedreamEscrow is BidValidator, IERC721Receiver, Ownable {
    ...
    constructor() public {
        ESCROW_WALLET = 0xbD90eeDED7bf65a2dac572CaA7772cDa491658d1; // TODO use production wallet
    }
...
library LibBid {
    bytes32 private constant BID_TYPE =
        keccak256(
            "Bid(address tokenContract,uint256 tokenIdentifier,uint256 tokenRegistryId,uing256 amount)"
        );
