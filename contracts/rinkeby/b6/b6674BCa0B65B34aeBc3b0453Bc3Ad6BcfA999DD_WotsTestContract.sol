...
//*********************************************************************//
//
//   __ _____  ___   __          __   _    _______        _   
//  /_ | ____|/ _ \  \ \        / /  | |  |__   __|      | |  
//   | | |__ | | | |  \ \  /\  / /__ | |_ ___| | ___  ___| |_ 
//   | |___ \| | | |   \ \/  \/ / _ \| __/ __| |/ _ \/ __| __|
//   | |___) | |_| |    \  /\  / (_) | |_\__ \ |  __/\__ \ |_ 
//   |_|____/ \___/      \/  \/ \___/ \__|___/_|\___||___/\__|
//                                                            
//                                                            
//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 150 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUWdXAr5EqoAxxnhagwBkju9DZe9pVVXibqiWeqCbinMv/";
...
// File: contracts/WotsTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WotsTestContract is RamppERC721A {
    constructor() RamppERC721A("WotsTest", "WT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/rGAZ54T3VklaaNysL4Zq/contract-metadata";
    }
}
