...
contract goblinssss is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://IK89QANCKX9T2YDDF9T6AUMMV4BVUX8IBT/";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("goblinsss", "BOOB") { }
