    ...
    ReentrancyGuardUpgradeable
{
    ...
    function swapIn(address _erc20, uint256 _amount) external nonReentrant {
        ...
        require(_amount > 0, "SwapIn:: Amount can not be zero");
        require(
            IERC20(_erc20).balanceOf(msg.sender) >= _amount,
            "SwapIn:: Insufficient Balance"
        );
    ...
    function swapOut(address _erc20, uint256 _amount) external nonReentrant {
        ...
        require(_amount > 0, "SwapOut:: Amount can not be zero");
        require(
            IERC20(_erc20).balanceOf(address(this)) >= _amount,
            "SwapIn:: Insufficient Funds"
        );
        uint256 _erc20Decimal = getTokenDecimals(_erc20);
        if (_erc20Decimal == 18) {
