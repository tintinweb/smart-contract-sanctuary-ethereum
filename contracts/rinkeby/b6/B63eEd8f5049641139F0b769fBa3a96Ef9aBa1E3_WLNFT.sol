...
contract WLNFT is ERC721,ERC721Enumerable, Ownable {
    ...
    uint256 public currentBlockTimestamp = 1651641900;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return block.timestamp >= currentBlockTimestamp ? string(abi.encodePacked(baseUri, Strings.toString(tokenId),".json")) : string(abi.encodePacked(baseUri, Strings.toString(0),".json"));
    }
