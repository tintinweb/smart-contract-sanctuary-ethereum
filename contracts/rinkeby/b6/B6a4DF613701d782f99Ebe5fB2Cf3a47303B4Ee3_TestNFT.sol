...
contract TestNFT is ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function traverseChains(uint16 _chainId) external payable {
        // abi.encode() the payload with the values to send
        bytes memory payload = bytes(abi.encode(0));
