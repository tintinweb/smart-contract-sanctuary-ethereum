...
// File: @divergencetech/[email protected]/contracts/sales/Seller.sol
...
// File: @divergencetech/[email protected]/contracts/sales/ArbitraryPriceSeller.sol
...
// File: MouheiConnoisseurPassBeta.sol
...
contract MouheiConnoisseurPassBeta is
    ...
    ERC2981
{
    ...
    constructor(address payable beneficiary, address royaltyReceiver)
        ERC721CommonAutoIncrement("MOUHEI CONNOISSEUR PASS Beta", "MCP")
        BaseTokenURI("")
        ArbitraryPriceSeller(
            Seller.SellerConfig({
