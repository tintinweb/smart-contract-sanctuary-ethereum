...
contract BatchListingOrdersFeature is IBatchListingOrdersFeature {
    ...
    function fillBatchListingOrders(BatchListingOrderParameter[] calldata parameters, bool revertIfIncomplete) external override payable {
        address _impl = _IMPL;
        assembly {
...
interface IBatchListingOrdersFeature {
    ...
    function fillBatchListingOrders(BatchListingOrderParameter[] calldata parameters, bool revertIfIncomplete) external payable;
}
