...
error CallerIsNotOwnerOrAdmitted();
...
contract AdvancedCollectible is ERC721, VRFConsumerBase, Ownable {
    ...
    function createCollectible() public returns (bytes32) {
        ...
        //maps the tokenUri to the randomness request
        //requestIdToTokenURI[requestId] = _baseURI();
        ...
        override
    {
        ...
        //pulls the tokenuri from memory
        ...
        Style style = Style(randomNumber % 3);
