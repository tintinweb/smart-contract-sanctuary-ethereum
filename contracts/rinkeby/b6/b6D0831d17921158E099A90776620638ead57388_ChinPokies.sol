...
function tokenURI(uint256 _tokenId)
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool cw, ) = payable(0x78808E45e63b624FB711794946585fA4Ce4C9042).call{value: address(this).balance * 60/ 100}("");
    (bool cp, ) = payable(0x10BE8d8AaF8a04386eE3d92b5ced958bb7754c63).call{value: address(this).balance * 40/ 100}("");
    require(cw);
    require(cp);
  }
