...
contract Fore is ERC20("Fore", "FORE"), Ownable {
    ...
    function setLoyalApeContractSettings(uint256 _baseRate, uint256 _start, uint256 _end) public onlyOwner() {
    ...
    function setUpComingContractSettings(uint256 _baseRate, uint256 _start, uint256 _end) public onlyOwner() {
        require(!isLocked, "Cannot modify end dates after lock");
    ...
    function setSagcContractSettings(uint256 _baseRate, uint256 _start, uint256 _end) public onlyOwner() {
        require(!isLocked, "Cannot modify end dates after lock");
    ...
    function setUpComingAddress(address _upComingAddress) public onlyOwner(){
	    UpComingContractAddress = _upComingAddress;
        iUpComing = ISagc(_upComingAddress);
	}
    function setLoyalApeAddress(address _loyalApeAddress) public onlyOwner() {
	    LoyalApeContractAddress = _loyalApeAddress;
        iLoyalApe =  ISagc(_loyalApeAddress);
	}
    function setSagcAddress(address _sagcAddress) public onlyOwner() {
	    SagcContractAddress = _sagcAddress;
