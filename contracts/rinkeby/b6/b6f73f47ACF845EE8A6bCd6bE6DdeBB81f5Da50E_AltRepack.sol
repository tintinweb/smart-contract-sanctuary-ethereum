...
/**
 * @title NFT Alt Repack I on Rinkeby, featured by Alt.
 *
 ...
 *
 */
contract AltRepack is PackDropBase {
    /// @dev Rinkeby Mainnet constructor.
    /// See {https://docs.chain.link/docs/vrf-contracts/#rinkeby} for VRF parameters.
    constructor()
        PackDropBase(
            'Alt Repack',
            3,                                                                  // Max 2 tokens per transaction
            50,                                                                  // Max 2 tokens per address
            0.01 * 10**18,                                                      // 0.35 ETH (subject to updates before the drop)
            0xc83320975CF4305157fa9954b8C266aF8fa3924C,                         // Signer Address for the Allow List - to be changed on mainnet
            0xa3BddF923370ffaE55A0D412462320cb8D9e48be,                         // Alt Escrow Admin Multisig
            0xa3BddF923370ffaE55A0D412462320cb8D9e48be,                         // Alt Minting Admin Multisig
            0x470848264C59815592EE09FBE4a20ED2F11D1B18,                         // Alt Vault Proxy deployed on Rinkeby - to be changed on mainnet
            ...
            4614                                                                // Chainlink v2 Subscription ID - to be changed on mainnet
        )
    {}
}
    ...
    TokenMintingPool
{
     ...
     */
    function updateMintPrice(uint256 _mintPrice) public onlyAdmin {
        require(
     ...
     */
    function lockTokenSupply() public onlyAdmin {
        _lockTokenSupply();
    }
    ...
    modifier onlyPublicSale() {
        require(_publicSaleIsOpen, 'PackDropBase: The public sale is closed.');
        _;
    }
     ...
     */
    function openPresale() public onlyAdmin {
     ...
     */
    function openPublicSale() public onlyAdmin onlyPresale {
    ...
    function _processMintRequest(
        ...
        require(_mintsPerAddress[minter] < maxPerAddress, 'PackDropBase: Token limit per wallet already reached.');
...
abstract contract TokenMintingPool is VRFConsumerBaseV2 {
    ...
    uint256 private _randomSeed;     // (_randomValue != 0) serves as a check to verify that the
                                    // supply is locked.
