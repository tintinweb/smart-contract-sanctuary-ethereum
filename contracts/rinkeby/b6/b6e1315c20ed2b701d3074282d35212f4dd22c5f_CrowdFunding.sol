...
contract CrowdFunding {
    ...
    event Log(address funderAdd, uint256 amount);
    ...
    */
    ...
    function getFunders(uint256 campaignID, uint256 funderID) public returns (address funderAdd, uint amount) {
        Campaign storage c = campaigns[campaignID];
        emit Log(c.funders[funderID].addr, c.funders[funderID].amount);
