...
contract TOTO is ERC721A, Ownable {
    ...
    string public baseURI = 'ipfs://QmY2tdfMHTSuPcqruVV4CVxeY3JLKxNVfJkxt7YZFDof2r/token.json';
    ...
    address private _signerAddress = 0x1ccA21Af2b3d5Ec8aE071F20CD9260B3399e08d1;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        } else if (bytes(unrevealedURI).length > 0) {
