...
contract VRFuture is ERC721A, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(0x558AdFbA73b26a235ff3cc0a906C9e88E9CD75eE).send((balance * 200) / 10000));
        require(payable(0xC3b615216362aA20384D74B0dEB082c9a6f1ec20).send((balance * 200) / 10000));
        
        require(payable(0xe6fEC433618adFc516A1270f994B09276ac1380E).send((balance * 6600) / 10000));
