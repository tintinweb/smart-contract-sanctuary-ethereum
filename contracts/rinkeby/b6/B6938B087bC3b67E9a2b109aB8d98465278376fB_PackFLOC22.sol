    ...
    ERC2771ContextUpgradeable
{
        ...
        returns (AVAILABLE_USER_DISCOUNT memory)
    {
        ...
        priceWithDiscount = tokenPrice.sub(discount.div(100).mul(tokenPrice));

        AVAILABLE_USER_DISCOUNT memory response = AVAILABLE_USER_DISCOUNT(userTokenAmount, discount, tokenPrice, priceWithDiscount);
