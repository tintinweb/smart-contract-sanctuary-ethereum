...
contract SessionPaymentPortal is ALBTOracle {
    ...
    uint256 public immutable paymentConfigHash;
        ...
        ALBTOracle(config_.priceFeed)
    {
        ...
        albt = config_.paymentConfig.albt;
        USDTPrice = config_.paymentConfig.USDTPrice;
        recipient = config_.paymentConfig.shares[0].recipient;
        share = config_.paymentConfig.shares[0].share;
    ...
    function payALBT(
        ...
        paidAmount = albtAmount_;
        paidMaxAmount = maxALBT_;
...
//        );
    ...
    /// @param paymentConfig_ Must be the same payment config hashed during
    /// construction of the contract.
    function getPriceInALBT(PaymentConfig calldata paymentConfig_) external returns (uint256) {
