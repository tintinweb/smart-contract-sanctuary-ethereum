...
contract GarageHub is ERC721, Ownable, ERC721URIStorage {
    ...
    function createTokenIdCar(uint256 tokenId) internal view returns (Car memory) { // TODO: change to internal
        ...
        return
            Car({
                ...
                model: weightedRarityGenerator(uint16(uint16(pseudoRandomBase >> 10) % maxSupply), 1)
            });
    }
    ...
    function ownerClaim(uint256 numberOfTokens) external onlyOwner { //TODO: remove function
        internalMint(numberOfTokens);
    }

    function mint(uint256 numberOfTokens) external payable {
        require(mintActive, 'Mint not active yet.');
        require(msg.value >= numberOfTokens * carPrice, 'Wrong value sent.');
    ...
    function toggleClaim() external onlyOwner { //TODO: remove function
