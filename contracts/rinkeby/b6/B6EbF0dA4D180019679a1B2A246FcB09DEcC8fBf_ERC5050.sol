...
// File: contracts/INWILL.sol

//Credit to CopeBears for awareness of ERC5050 to make the minting spicy 
pragma solidity ^0.8.0;
...
contract ERC5050 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public chanceFreeMintsAvailable = 1500;
    uint256 public freeMintsAvailable = 200;
    ...
    constructor() ERC721A("Keeny", "KEEN") {
        _safeMint(_msgSender(), 9); // Mints for team, setup OS and giveaways
        baseURI = "ipfs://QmPvkAsNpgc7V4hMZU6vG7DN5rEcdfuLEsUFHHGJBREdRV/";
    }
