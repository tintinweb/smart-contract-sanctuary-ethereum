...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x6Ab96038D00C943109AF3E101f6B731e9208DA3e];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x6Ab96038D00C943109AF3E101f6B731e9208DA3e;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 5855) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibq3jiukrn3pfcu4nybrfj2voikaodlnqrpq2va55fjcrmjlzhivu/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 5855");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5855");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 5855");
...
// File: contracts/TheMergeNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheMergeNftContract is RamppERC721A {
    constructor() RamppERC721A("The Merge NFT", "Merge"){}
}
