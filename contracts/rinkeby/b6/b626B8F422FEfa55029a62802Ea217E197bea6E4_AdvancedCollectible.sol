...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => myNFT) public tokenIdTomyNFT;
    mapping(bytes32 => address) public requestIdToSender;
    event requestedCollectible(bytes32 indexed requestId, address requester);
    event myNFTAssigned(uint256 indexed tokenId, myNFT mynft);
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        myNFT mynft = myNFT(randomNumber % 3);
        uint256 newTokenId = tokenCounter;
        tokenIdTomyNFT[newTokenId] = mynft;
        emit myNFTAssigned(newTokenId, mynft);
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        ...
        require(
            ...
            "EL QUE HACE LA PETICION NO ES EL DUEÃ‘O >:C"
        );
