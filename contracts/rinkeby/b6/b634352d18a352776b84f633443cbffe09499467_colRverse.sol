...
contract colRverse is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public MAX_PER_Transtion = 1496; // maximam amount that user can mint per transaction
  uint256 public MAX_PER_Address = 1496; // maximam amount that user can mint

  uint256 public  PRICE = 0.0000000001 ether; //0.000 during sale 

  uint256 private constant TotalCollectionSize_ = 1496; // total number of nfts
  uint256 private constant MaxMintPerBatch_ = 1496; //max mint per trx
