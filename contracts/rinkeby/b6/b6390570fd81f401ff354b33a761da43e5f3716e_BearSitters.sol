...
// File: Contracts/BearSitters.sol
...
contract BearSitters is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(addressMintedBalance[msg.sender] + _mintAmount <= maxPerAddressLimit, "max per wallet exceeded");
