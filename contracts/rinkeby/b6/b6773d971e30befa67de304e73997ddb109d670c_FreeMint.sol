...
contract FreeMint is ERC721, ERC721Burnable, AccessControl {
    ...
    constructor(address[] memory gifters) ERC721("FreeMint", "FREEMINT") {
    ...
    //***************************************************************************************************************
    function testWhitelist(uint256 artworkID, address addr, bytes32[] calldata merkleProof) public view returns (bool) {
