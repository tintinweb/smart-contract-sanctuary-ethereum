...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
  ...
  // mapping(key type => value type) variable_name;
  // Good practice: Emit event on mapping update
  ...
  // This is called by the VRFCoordinator
  function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
    internal
    override
  {
    // Breed can only be 0, 1, 2 (enum so: Pug (0), Shiba Inu (1) or St Bernard (2))
  ...
  // Setting the tokenURI manually. In practice, it should be set in the fulfillRandomness function
  // for decentralisation purposes.
