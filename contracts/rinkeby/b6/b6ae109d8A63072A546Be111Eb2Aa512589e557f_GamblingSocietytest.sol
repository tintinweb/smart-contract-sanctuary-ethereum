...
contract GamblingSocietytest is ERC721A {
    using Strings for uint256;

    uint public maxSupply = 10000;
    address public owner;

    constructor() ERC721A("GamblingSocietytest", "GST") {
        owner = msg.sender;
        _mint(msg.sender, 1);
    }
...
//URI_______________________________________________________________________
    string metadataPrefx = "ipfs://QmfYrpwsyhDR1ZaneBFgor5WkAqTrGa6JCDkmc9JwuUQq5/";
...
//MONEY______________________________________________________________________
    address private _dude = 0x4e93a6e56E6a4300Fd1873a43D9c56fEaE8B39Cc;
