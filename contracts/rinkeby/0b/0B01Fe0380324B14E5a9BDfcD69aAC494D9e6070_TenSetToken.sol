...
contract ERC20Fee is Ownable, ERC20 {
    /*///////////////////////////////////////////////////////////////
...
contract TenSetToken is ERC20AnySwap {
    constructor(address _owner) ERC20AnySwap(_owner) {
        _setOwner(_owner);
...
contract Antibot is Ownable {
    ...
    modifier transactionThrottler(
        ...
        if (!whitelisted[_sender] && !whitelisted[_recipient]) {
            require(transactions[_sender][_recipient] < block.number - 1, "Antibot: Transaction throttled");
            require(transactions[_recipient][_sender] < block.number - 1, "Antibot: Transaction throttled");
        }
