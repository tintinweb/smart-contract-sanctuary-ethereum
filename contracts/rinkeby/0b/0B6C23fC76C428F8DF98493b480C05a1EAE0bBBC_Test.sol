...
contract Test{
    ...
    function uniswapTestingTokenforTokens(uint256 price,address tokenAddress1, address tokenAddress2) external returns(uint256){
         address[] memory path = new address[](3);
        path[0] = tokenAddress1;
        path[1] = _WETH;
        path[2] = tokenAddress2;
    ...
    function uniswapTestingTokensforEth(uint256 price, uint256 price2, address tokenAddress) external returns(uint256){
      ...
      IUniswapV2Router01(UNISWAP_ROUTER_ADDRESS).swapExactTokensForETH(
            price2,
            amount[1],
            path,
            msg.sender,
