...
// File: contracts/CustomProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CustomProjectContract is RamppERC721A {
    constructor() RamppERC721A("Custom Project", "TEST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vMR27ipw0SghRKYuVQHX/contract-metadata";
    }
}
