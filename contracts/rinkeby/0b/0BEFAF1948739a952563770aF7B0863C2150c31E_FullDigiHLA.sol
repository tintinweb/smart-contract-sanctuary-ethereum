...
contract FullDigiHLA is Ownable, ERC721A, MerkleWhitelist, ReentrancyGuard {
    ...
    uint256 public DA_MINTED;
    uint256 public MAIN_MINTED;
    uint256 public EXTRA_MINTED;


    //Limit quantity per wallet
    uint256 public WL_LIMIT=3;
    uint256 public DA_LIMIT=5;
    uint256 public MAIN_LIMIT=1;
    uint256 public EXTRA_LIMIT=10;
    ...
    function mintDA(uint256 quantity) public payable {
    ...
    function mintWL(uint256 quantity,bytes32[] memory proof)
        public
        payable
    ...
    function mintMain(uint256 quantity,bytes32[] memory proof)
        public
        payable
       // onlyMainWhitelist(proof)
    {
     ...
     function mintExtra(uint256 quantity,bytes32[] memory proof)
        public
        payable
