...
// File: contracts/TestContract4.sol
...
contract TestContract4  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmeDJ1eJrXSGNKwtGPFqBaBZsGeDLyBwT5ivZfr7H6wjX8/";
    uint   public price             = 0.002 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 6666;
    uint   public maxSupply         = 6666;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Test Contract", "TC"){}
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI,"test.json"))//string(abi.encodePacked(currentBaseURI,Strings.toString(_tokenId+1),".json"))
            : "";
    }
