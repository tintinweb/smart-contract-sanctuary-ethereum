...
/**
 *Submitted for verification at FtmScan.com on 2022-06-16
*/
    ...
    function stake(uint256 poolType) public {
        if(poolType==1){
           ...
           // Stakers[msg.sender].push(staker);
             ...
             emit Staked(address(this),msg.sender,pool1,poolType,staker.id);
        }else if(poolType==2){
             stakerDetails memory staker;
             staker.stakeTime = block.timestamp;
           ...
           // staker.apr = getAPR(noOfDays);    
            ...
            //  Stakers[msg.sender].push(staker);
             ...
             emit Staked(address(this),msg.sender,pool2,poolType,staker.id);
        }else if(poolType==3){
             stakerDetails memory staker;
             staker.stakeTime = block.timestamp;   
             totalStakeRecords[msg.sender] += 1;
             ...
             emit Staked(address(this),msg.sender,pool3,poolType,staker.id);
        }
    }
