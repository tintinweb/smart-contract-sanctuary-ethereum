...
CCCCCCCCCCCCCCCCCC^  [email protected]  CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCC#  [email protected]  .HCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
[email protected]          dMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM,              ..MMMMMMMMM
...
[email protected]         AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
...
contract TOKEN is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
    ...
    string public notRevealedURI =
        "https://pna-generative.s3.ap-northeast-1.amazonaws.com/chimerative/contract_test/unreveal_dummy.json";
    ...
    constructor() ERC721A("codeCive", "CTEST") {
        _setDefaultRoyalty(msg.sender, royaltyFee);

        // _mintERC2309(0x253058B7F0fF2C6218dB7569cE1d399F7183E355, 70); // PJ用入れる
