...
//   / ___// /____  __/ / /  / ____/_______  ____ _/ /______
//   \__ \/ //_/ / / / / /  / /_  / ___/ _ \/ __ `/ //_/_  /
//  ___/ / ,< / /_/ / / /  / __/ / /  /  __/ /_/ / ,<   / /_
// /____/_/|_|\__,_/_/_/  /_/   /_/   \___/\__,_/_/|_| /___/
//                                                          
//
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x80548097b22eDb5DE4C775AAcB0fD48a7C9eACc9];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPDFPzbXqHxgqjHSKQzjt87XEGLeZZWofQVjjhYDF5jco/";
...
// File: contracts/SkullFreakzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SkullFreakzContract is RamppERC721A {
    constructor() RamppERC721A("Skull Freakz", "SKULLS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/q6RLuAhESu0r2FyWAKQY/contract-metadata";
    }
}