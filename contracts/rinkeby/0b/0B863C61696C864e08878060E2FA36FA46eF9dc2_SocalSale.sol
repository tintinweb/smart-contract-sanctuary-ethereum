...
contract SocalSale is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 _count) public payable {
        ...
        if (_msgSender() != owner()) {
            ...
            require(
                IERC20(primaryToken).allowance(_msgSender(), address(this)) >= totalPrice,
                "ERROR: plase approve us to spend you Socal tokens"
            );
    ...
    function addNftsForSale(uint256[] calldata tokenIds, uint256[] calldata prices) external {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(tokenIdToPrice[tokenIds[i]] == 0, "Already on sale");
