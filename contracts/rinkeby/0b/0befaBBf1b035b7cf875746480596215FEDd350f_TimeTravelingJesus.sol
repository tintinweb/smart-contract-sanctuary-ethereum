...
contract TimeTravelingJesus is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TimeTravelingJesus", "TTJ") {
    setHiddenMetadataUri("ipfs://QmNxnFSkL4sgDnfrqEoAwJaVikVtLfLBikwuEn9HEM8pPC.json");
  }
  ...
  function setHiddenMetadataUri(string memory _hiddenMetadataUri) public onlyOwner {
    MetadataUri = _hiddenMetadataUri;
  }
