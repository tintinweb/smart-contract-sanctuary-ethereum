...
// hevm: flattened sources of /nix/store/lvkxdc4lsr4msvf6fa20ngn4wdq1m8rq-geb-lender-first-resort/dapp/geb-lender-first-resort/src/AutoRewardDripper.sol
pragma solidity =0.6.7;

////// /nix/store/lvkxdc4lsr4msvf6fa20ngn4wdq1m8rq-geb-lender-first-resort/dapp/geb-lender-first-resort/src/AutoRewardDripper.sol
...
contract AutoRewardDripper {
    ...
    **/
    ...
    TokenLike_1 public rewardToken;
    ...
    constructor(
      ...
      uint256 rewardCalculationDelay_
        ...
        rewardToken            = TokenLike_1(rewardToken_);
