  ...
  function distributeReward(uint256 _mintAmount) internal {
    if (mintRewardsEnabled == true) {
      ...
      if (rewardMintCount25 + _mintAmount >= 25) {
        rewardMintCount25 = rewardMintCount25 + _mintAmount - 25;
        hidden_num = uint256(keccak256(abi.encode(hidden_num, msg.sender)));
        ...
        rewardMintCount25 = rewardMintCount25 + _mintAmount;
      }

      if (rewardMintCount250 + _mintAmount >= 250) {
        rewardMintCount250 = rewardMintCount250 + _mintAmount - 250;
        hidden_num = uint256(keccak256(abi.encode(hidden_num, msg.sender)));
        num = randomNum(supply, num) + 1;
          if (num <= supply) {
            rewardAdd = ownerOf(num);
        ...
        rewardMintCount250 = rewardMintCount250 + _mintAmount;
      }

      if (rewardMintCount1000 + _mintAmount >= 1000) {
        rewardMintCount1000 = rewardMintCount1000 + _mintAmount - 1000;
        hidden_num = uint256(keccak256(abi.encode(hidden_num, msg.sender)));
        num = randomNum(supply, num) + 1;
          if (num <= supply) {
            rewardAdd = ownerOf(num);
        ...
        rewardMintCount1000 = rewardMintCount1000 + _mintAmount;
      }
    }
  }
