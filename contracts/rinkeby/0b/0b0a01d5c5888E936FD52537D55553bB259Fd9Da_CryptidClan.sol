...
contract CryptidClan is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    WTOKEN = IWRLD_TOKEN(0x675c08fcA4f6D2bccefB162f54166082e5Dcb5d3);
  }
...
/// @dev presale mint for whitelisted
  ...
  function withdraw() public payable onlyOwner nonReentrant {
    (bool success, ) = payable(0x9e4A358854fE92d9bf17af6672503c38C52561D5).call{value: address(this).balance}("");
    require(success);
    WTOKEN.transferFrom(address(this), (0x9e4A358854fE92d9bf17af6672503c38C52561D5), WTOKEN.balanceOf(address(this)));
  }
}