...
contract THESEVENTEENTH is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
...
//   mapping(address => bool) private whitelistedAddresses;
  ...
  constructor() ERC721A("THESEVENTEENTH","THESEVENTEENTH", MaxMintPerBatch_, TotalCollectionSize_) {
...
//   }
   ...
   function conf(uint256 Status , uint256 Price, uint256 Stop_At )external onlyOwner{
      status = Status;
      stopat = Stop_At;
      PRICE = Price;
