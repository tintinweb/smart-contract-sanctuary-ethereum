...
contract Zeuse is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Zeuse", "Zeuse") {
        setBaseURI("ipfs://bafkreiaqs57bbojkyqzk4ivceco3o5adfw7acu5zrq3swtwn4l4fb5j37u");
    }
    ...
    function freemint() public nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max Zeuse per address exceeded");
		require(s + _mintAmount <= maxFree, "Cannot exceed Zeuse supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(!paused, "Paused");
        require(_mintAmount > 0, "Cant mint 0 Zeuse");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more Zeuse" );
        require(s + _mintAmount <= maxSupply, "Cant exceed Zeuse supply");
        ...
        onlyOwner
    {
        ...
        require(s + totalQuantity <= maxSupply, "Too many Zeuse");
