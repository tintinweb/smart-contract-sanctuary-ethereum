...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0D073B061819d7B7E648d1bb34593c701FFaE666];
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xgpC7ykQr4ubOS6kpArJ/contract-metadata";
    }
}
