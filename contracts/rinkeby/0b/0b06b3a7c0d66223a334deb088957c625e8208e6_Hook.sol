...
contract Hook is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address payable internal team =
        payable(0x2c2970038616D455BEF97bc38A1Ef408FE72570a);
    address payable internal dev =
        payable(0x8EB0b9d9dDF5cD558974e75972db02feca8cFd57);

    uint256 public constant MINT_COST = 0.003 ether;
    uint256 public MAX_SUPPLY = 6969;
    uint256 public RESERVED_SUPPLY = 333;
