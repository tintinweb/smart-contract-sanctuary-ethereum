...
contract Academy is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {

    uint256 tokenPrice = 1 wei;
    address ownerContract;

    constructor() ERC20("Academy3", "AC3") ERC20Permit("Academy3") {
        _mint(msg.sender, 180000000 * 10 ** decimals());
        ownerContract = msg.sender;
    }

    function answerToEarn(uint256 _answer) public {
        // require(msg.value >= tokenPrice);
         if(_answer == 2){
            //  uint256 total = msg.value / tokenPrice;
            // _mint(msg.sender, total * 10 ** decimals()); 
            this.transferFrom(ownerContract, msg.sender, 1);
         }
    }
