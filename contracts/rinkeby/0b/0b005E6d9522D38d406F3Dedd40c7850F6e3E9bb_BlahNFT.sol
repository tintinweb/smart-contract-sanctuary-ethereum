    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        string memory image = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 2000"><rect width="2000" height="2000" fill="',
                            factionToColor(city.countryFaction),
                            '" /><image href="',
                            city.image,
                            '" height="2000" width="2000" crossorigin=""/>',
                            '<g transform="translate(50, 50), scale(.3)"><image href="',
                            getCityImage(city.points),
                            '" crossorigin=""/></g>',
                            getPointsIndicator(city.points, factionToColor(city.cityFaction)),
                        '</svg>'
                    )
                )
            )
