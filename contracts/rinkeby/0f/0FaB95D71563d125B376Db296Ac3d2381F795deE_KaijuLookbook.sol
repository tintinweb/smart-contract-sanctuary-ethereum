...
error KaijuLookbook_MustBeAKing();
...
/**
  ...
  *#######################################################################-
  ...
  %######################################################################-
  .+*********************************************************************.
 * @title KaijuMart Essentials Lookbook
 * @author Augminted Labs, LLC
 */
contract KaijuLookbook is ERC721, Ownable {
    ...
    /**
     * @notice Mint a soulbound lookbook token
     */
    function mint() public {
        if (!kmart.isKing(_msgSender())) revert KaijuLookbook_MustBeAKing();
