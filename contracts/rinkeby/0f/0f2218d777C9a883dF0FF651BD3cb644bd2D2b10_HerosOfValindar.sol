...
contract HerosOfValindar is ERC721r, Ownable, ReentrancyGuard, ProxyRegistry {
  ...
  function setParams(uint256 _manualDistCap, uint256 _mintedAllowedCap, uint256 _whitelistLimit, uint256 _whitelistPrice, uint256 _publicPrice, string memory _secretImage,
