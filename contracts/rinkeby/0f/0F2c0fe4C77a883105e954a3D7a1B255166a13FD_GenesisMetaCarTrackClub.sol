...
contract GenesisMetaCarTrackClub is ERC721, ERC721Enumerable, Ownable, PaymentSplitter {
    string public PROVENANCE;
    bool public saleIsActive = false;
    string private _baseURIextended;

    bool public isAllowListActive = false;
    uint256 public constant MAX_SUPPLY = 8080;
    uint256 public constant MAX_PUBLIC_MINT = 20;
    uint256 public constant PRICE_PER_TOKEN = 0.08080 ether;

    mapping(address => uint8) private _allowList;

    constructor(address[] memory payees, uint256[] memory shares)
        ERC721("GenesisMetaCarsTrackClub", "GMTC")
