...
contract DUAZLPAN is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 constant public cost = 0.068 ether;
    uint256 constant public maxSupply = 2048;
    uint256 constant public maxWhitelistMint = 2;
    ...
    constructor() ERC721A("DUAZLPAN", "DPN") {
        setHiddenMetadataUri("ipfs://QmUBfVAVdETuDZ5vs8XSU9ZSrPR2ge65EHeYLgyqNLM38d/hidden.json");
    }
