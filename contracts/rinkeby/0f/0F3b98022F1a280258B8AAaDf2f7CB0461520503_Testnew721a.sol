...
//  | |   / _ \/ __|| __||  \| | / _ \\ \ /\ / /   / /   __) || |  / _ \  
//  | |  |  __/\__ \| |_ | |\  ||  __/ \ V  V /   / /   / __/ | | / ___ \ 
//  |_|   \___||___/ \__||_| \_| \___|  \_/\_/   /_/   |_____||_|/_/   \_\
//
...
contract Testnew721a is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/695/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/695/contract-uri";
	...
	constructor(address _signerAddress) ERC721A("TestNew721A", "TEST") {
