...
contract MergeKingdom is ERC721Enumerable, Ownable, Pausable {
    ...
    */
    ...
    function claimMerge (
        ...
        if (seed < mergeChances[typeOf(firstToken)]) {
        ...
        //DETAILS ⋯ If not
            ...
            emit mergeClaimed(firstToken, secondToken, seed, false);
        }
    ...
    function claimMultipleMerges (
        ...
        for (uint i; i < firstTokens.length; i++) {
            ...
            //DETAILS ⋯ If merge is sucessful
            if (seed < mergeChances[typeOf(token1)]) {
                ...
                emit mergeClaimed(token1, token2, seed, true);
            ...
            //DETAILS ⋯ If not
                ...
                emit mergeClaimed(token1, token2, seed, false);
            }
        }
    }
    ...
    returns (string memory)
  {
    ...
    function setMergeFees (uint32[] memory newfees)
    external 
    onlyOwner {
        mergeFees = newfees;
    }
