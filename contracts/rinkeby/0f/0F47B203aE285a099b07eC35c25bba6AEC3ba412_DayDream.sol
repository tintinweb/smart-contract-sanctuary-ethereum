// SPDX-License-Identifier: MIT
    ...
    contract DayDream is Ownable, ERC721A, ReentrancyGuard {
        ...
        uint256 public constant whiteListPrice = 0.001 ether;
        ...
        function preSale(uint8 _purchaseNum) external payable onlyWhiteList nonReentrant {
        ...
        function publicSale(uint8 _purchaseNum) external payable nonReentrant{
            require(!paused, "DayDream: currently paused");
            require(
