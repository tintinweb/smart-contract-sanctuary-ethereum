...
contract OmniZuki is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTJQ51yVCZ537FS7FGkzrFe9W16Er8XBMukmYkF8Y8LwS";
    ...
    constructor(
    ) ERC721A("OmniZuki", "OZ", 100, maxSupply) {
    }
