...
contract Mega is ERC721A, Ownable,ReentrancyGuard {
    ...
    uint256 private presaleMaxSupply = 2000;
  ...
  function whitelistMint(bytes32[] calldata _merkleProof, uint256[] calldata _position, uint256 _mintAmount) public payable nonReentrant whitelistMintCompliance(_mintAmount){
