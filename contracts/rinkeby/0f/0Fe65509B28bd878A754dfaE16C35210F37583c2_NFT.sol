...
contract NFT is ERC721Enumerable, Ownable {
    ...
    modifier onlyDev() {
        require(msg.sender == devGuy, "Only Developer Can Do this");
        _;
    }

    function stopDevFunding() public onlyDev {
        devFunding = false;
    }
    ...
    function buildImage(uint256 _tokenId) public view returns (string memory) {
        ...
        return
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        '<svg width="1000" height="1000" viewBox="0 0 270 270" fill="none" xmlns="http://www.w3.org/2000/svg"> <rect width="270" height="270" fill="url(#paint0_linear)"/><defs> <filter id="dropShadow" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse" height="270" width="270"> <feDropShadow dx="0" dy="1" stdDeviation="2" flood-opacity="0.225" width="200%" height="200%"/> </filter> </defs> <text x="32.5" y="231" font-size="30px" fill="white" filter="url(#dropShadow)">',
                        currentWord.text,
                        '</text> <defs> <style> text { font-family: Plus Jakarta Sans, DejaVu Sans, Noto Color Emoji, Apple Color Emoji, sans-serif; font-style: normal; font-weight: bold; line-height: 34px;}</style><linearGradient id="paint0_linear" x1="190.5" y1="302" x2="-64" y2="-172.5" gradientUnits="userSpaceOnUse"><stop stop-color="#44BCF0"/><stop offset="0.428185" stop-color="#628BF3"/><stop offset="1" stop-color="#A099FF"/></linearGradient><linearGradient id="paint1_linear" x1="0" y1="0" x2="269.553" y2="285.527" gradientUnits="userSpaceOnUse"><stop stop-color="#EB9E9E"/><stop offset="1" stop-color="#992222"/></linearGradient></defs></svg>'
                    )
                )
            );
    }
