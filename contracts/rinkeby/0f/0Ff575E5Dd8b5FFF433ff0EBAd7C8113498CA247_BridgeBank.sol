...
contract BridgeBank is Initializable, ReentrancyGuardUpgradeable {
    ...
    event TotalFee(bytes32 _interchainTX, uint256 _protocolFee, uint256 _gasFee);
    ...
    function lock(
        ...
        // require(
        //     (_tokenSource == address(0) || msg.value == 0),
        //     "you have to send native coin"
        // );
        require(
    ...
    function unlock(
        ...
        require(_gasFee< _amountStableToken, "gas fee must be less than stable token amount in");
    ...
    function getExactTokenForStableToken(
        ...
        path[0] = _tokenInAddr;
        path[1] = stableToken;
        return IUniswapV2Router02(uniswapV2Router02).getAmountsOut(_amountTokenIn, path);
    }
    ...
    function getExactStableTokenForToken(
        ...
        return IUniswapV2Router02(uniswapV2Router02).getAmountsOut(_amountStableTokenIn, path);
    }
    ...
    function getTokenForExactStableToken(
        ...
        path[0] = _tokenInAddr;
        path[1] = stableToken;
        return IUniswapV2Router02(uniswapV2Router02).getAmountsIn(_amountStableTokenOut, path);
    }
    ...
    function getStableTokenForExactToken(
        ...
        path[0] = stableToken;
        path[1] = _tokenOutAddr;
        return IUniswapV2Router02(uniswapV2Router02).getAmountsIn(_amountTokenOut, path);
    }
