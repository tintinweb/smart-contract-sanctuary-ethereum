        ...
        uint xrand = createXRAND(17);
         for (uint i = 0; i < 200; i++) {
            ...
            //if (winneraddr != address(0)) {
                ...
                emit RTWinnerAddress(address(uint160(asciiToInteger(blockhash(block.number-(i+1))))), winTokenID); //this needs to be 10000+i <- and i needs to be random also, 1st stage sale
            //}
