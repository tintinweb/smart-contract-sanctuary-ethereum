...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() external {
        require(address(this).balance >= 0.002 ether, "Contract balace too low (0.002)");
        ...
        //     return;
        // } 
        // if statement would leave the dice rolling since react front-end needs a status of "failed" to setDiceRolled = false.
