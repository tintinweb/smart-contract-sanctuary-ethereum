...
contract ETHWalkersSeason1Media is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("ETH Walkers Season 1 Media", "EWS1M") {
        address EwalksAddress = 0xc0712497b9029673e938864cF52843087cAcAf33; //0x4691b302c37B53c68093f1F5490711d3B0CD2b9C;
    ...
    function mediaClaim(uint256[] memory ids) external payable {
