...
contract MonkeVoyager is Ownable, ERC721A {
    ...
    uint256 public constant MAX_TEAM_RESERVE = 169;
    ...
    modifier validateMintPerWallet(uint256 _quantity) {
        ...
        require(_numberMinted(msg.sender) + _quantity <= MAX_PER_WALLET, "You are recuiting too many Monke Voyagers my friend");
        _;
    }

    modifier validateFreeMintStatus(uint _quantity) {
    ...
    /**
     * @notice Welcome to the world of Monke Voyager, WL-ters. 1WL = 2 NFTs. Enjoy the ride!
     * @notice Oh Ooh Ah Aah Aaah!
     */
    function WLMonkeOut(uint _quantity, bytes32[] calldata _proof)
        external
        callerIsUser
        atState(MintStage.WHITELISTSALE)
        validateFreeMintStatus(_quantity)
        validateSupply(MAX_WHITELIST, _quantity)
        validateMonkeAddress(_proof, whitelistMerkleRoot)
    ...
    /**
     * @notice Welcome to the world of Monke Voyager!
     * @notice Oh Ooh Ah Aah Aaah!
     */
    function AllMonkeOut(uint256 _quantity)
        external
        payable
        callerIsUser
    ...
    /**
     * @notice Crew members will also ride with ya, Monkes!
     * @notice Oh Ooh Ah Aah Aaah!
     */
    function CrewMonkeOut(uint256 _maxTeamMint) 
        external 
        payable 
        validateSupply(MAX_SUPPLY, _maxTeamMint)
        onlyOwner 
    {
