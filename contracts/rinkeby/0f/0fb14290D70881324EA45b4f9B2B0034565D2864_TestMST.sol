...
import "@openzeppelin/contracts/utils/Strings.sol";
   ...
   contract TestMST is ERC721A, Ownable  {
    ...
    uint256 public MAX_WL_SUPPLY = 5;
    uint256 constant public MAX_SUPPLY_S2= 20;
	uint256 constant public MAX_SUPPLY_S3= 40;
    uint256 public MAX_WL_SUPPLY_S1 = 5;
    uint256 public MAX_MAIN_SUPPLY = 5;
    uint256 public MAX_MAIN_WL_SUPPLY = 5;
    uint256 public PRICE;
    uint256 constant public PRICE_S1 = 0.0025 ether;
    uint256 constant public PRICE_S2 = 0.0035 ether;
    uint256 constant public PRICE_S3 = 0.0045 ether;
    uint256 public PRICE_MAIN = 0.005 ether;
    uint256 public PRICE_MAIN_WL = 0.004 ether;
    
    
    
    uint256 public giveawayLimit = 5;
	...
	address private wallet1 = 0x833AFf717925131df28c79E2C057514565ac6c78; // Company Wallet
    address public Authorized = 0x833AFf717925131df28c79E2C057514565ac6c78; // Dev Wallet for Testing (no percentage)
    ...
    constructor() ERC721A("TestMST", "MST") { }
    ...
    function flipWLSaleStateS1() external onlyOwner {
	 ...
	 function flipMainWLSaleState(uint256 _MAX_MAIN_WL_SUPPLY) external onlyOwner {
    ...
    function FlipMainMint(uint256 _MAX_MAIN_SUPPLY,uint256 _priceMain) external onlyOwner {
         ...
         MAX_MAIN_SUPPLY = _MAX_MAIN_SUPPLY;
    ...
    function mintFounderSeries(uint256 numberOfTokens) external payable callerIsUser {
        require(saleIsActiveS2 || saleIsActiveS3, "Sale must be active to mint");
    ...
    function setMainPriceWL(uint256 _wlPrice) public onlyAuthorized {
        PRICE_MAIN_WL = _wlPrice;
    }

    function setMainPrice(uint256 _price) public onlyAuthorized {
        PRICE_MAIN = _price;
    }
