...
contract  ProjecKGunClub is ERC721Enumerable, Ownable {
   ...
   string public baseTokenURI;
    ...
    uint256 public preSaleStartDate = 1651240800;       //Apr 29, 2022, 10:00:00 EST
    uint256 public publicStartDate = 1652882400;        //May 18, 2022, 10:00:00 EST
    ...
    */
    ...
    constructor() ERC721("ProjecKGunClub", "PGC") {
        //setBaseURI(baseURI);
    }
    ...
    function preSaleMint(uint256 _mintCount) public payable onlyWhitelisted {
        ...
        require(supply + _mintCount < maxSupply,        'This transaction would exceed max supply of ProjecKGunClub');
        require(block.timestamp < publicStartDate,      'Presale Minting is ended.');
        require(tokenCount + _mintCount <= maxMintCount,           string(abi.encodePacked('You can mint only ', maxMintCount.toString(), ' ProjecKGunClub in PreSale')));
    ...
    function mint(uint256 _mintCount) public payable {
        ...
        require(supply + _mintCount < maxSupply,        'This transaction would exceed max supply of ProjecKGunClub');
        require(tokenCount + _mintCount <= maxMintCount,           string(abi.encodePacked('You can mint only ', maxMintCount.toString(), ' ProjecKGunClub in PublicSale')));
        require(msg.value >= price() * _mintCount,                   'Ether value is too low');
    ...
    function info() public view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (price(), preSaleStartDate, publicStartDate, totalSupply(), maxSupply, maxMintCount);
    }
