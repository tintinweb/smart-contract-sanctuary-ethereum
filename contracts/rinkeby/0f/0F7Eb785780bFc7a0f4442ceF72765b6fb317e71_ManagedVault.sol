...
contract ManagedVault is Initializable, OwnableUpgradeable, ERC20Upgradeable, IManagedVault {
    ...
    /**
     * @notice Returns the number of pending mints in blocks at or before vaultPriceBlockNumber.
     * The value of this function could be used in the mint function.
     */
    function pendingMintsCount() external view returns (uint256 count) {
        if (nativeDepositState) {
