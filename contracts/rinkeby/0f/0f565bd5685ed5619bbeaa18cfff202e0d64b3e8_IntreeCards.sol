...
// Static:
// TODO: Change time to 1. of May. And lasts 6 hours (CET GMT+2). 
//              How do you convert this to UINT?

// Supply:
// TODO: Is whitelistTotalSupply implemented correctly?
...
contract IntreeCards is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 CURRENT_PHASE = 0; // 0 -> Alpha, 1 -> Beta, 2 -> Legend.
    uint256 public PRICE = 0.12 ether;
    uint256 public whitelistTotalSupply = 0; // Instantiate?

    uint256 CURRENT_MAX_SUPPLY = 1000;
    // UPDATE SUPPLY IF PHASE IS NOT SOLD OUT.
    uint256[] SUPPLY_MAX = [1000, 1000, 2580];
    uint256[] WL_SUPPLY_MAX = [1000, 1000, 2580];
    ...
    function currentMaxSupply(uint256[] memory _mintTypeMaxSupply) public view returns (uint256) {
        uint256 _supply;
        uint i;
    ...
    // owner has collision with contract owner: owner => wallet
    ...
    // NOTE: Wondering what external and payable does here X) 
