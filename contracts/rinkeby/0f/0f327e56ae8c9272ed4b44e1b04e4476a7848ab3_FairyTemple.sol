...
contract FairyTemple is ERC721, ERC721Enumerable, Ownable
{
    ...
    address payable private Fairy = payable(0xBF12d048673150825FEf8075034d78Cda8d995E3);

    constructor() ERC721("FairyTemper", "FT") {}
    ...
    {
        require(msg.sender == Fairy || msg.sender == owner(), "Invalid sender");

        uint devPart = address(this).balance / 100 * 7; 
        Fairy.transfer(devPart);
