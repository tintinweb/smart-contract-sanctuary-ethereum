...
contract Kalap is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Kalap", "KP") {
 
    
    
    _baseTokenURI = "ipfs://QmSQFoLkKoFhWVAb7JYraBEgvMywLiSTZg96kAdAjDfVRY/";  
