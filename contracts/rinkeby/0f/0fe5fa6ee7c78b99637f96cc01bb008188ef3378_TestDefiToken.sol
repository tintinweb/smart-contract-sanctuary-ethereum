...
contract TestDefiToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 600000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'TestDefi';
    ...
    function claimReward () public {
        ...
        (uint256 rAmount,,,,,) = _getValues(ownerTokenYield);
        ...
        claimCount[msg.sender] = getGolbalClaimCount();
         ...
         emit Transfer(address(0), msg.sender, ownerTokenYield);
    }
}