...
contract ShkreliDaoBeta7 is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public uriPrefix = "https://testshananza.s3.filebase.com/test/";
    ...
    ) ERC721A("ShkreliDaoBeta7", "ShkreliDAO") {
