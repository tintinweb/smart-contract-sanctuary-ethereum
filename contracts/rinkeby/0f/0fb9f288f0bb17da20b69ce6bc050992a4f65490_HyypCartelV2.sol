    ...
    UUPSUpgradeable
{
    ...
    mapping(address => bool) public publicAddresses;

    function initialize() public initializer {
        __Ownable_init();
        __ERC721_init("Hyyp Cartel", "Hyyp");
        __UUPSUpgradeable_init();
        setNotRevealedURI(
            "ipfs://QmQhryDXTs3tciuiKyhWcsPRZXr2mneLWVkMNVg1HaTDHf"
        );
        baseExtension = ".json";
        costPublic = 0.07 ether;
        costWL = 0.05 ether;
        maxSupply = 9999;
        maxMintAmount = 2;
    ...
    function removeFromWhitelistUsers(address _user) public onlyOwner {
