      ...
      generatedAura = metadataEngine.base64Encode(bytes(
          abi.encodePacked(
              '<svg width="1000" height="1000" xmlns="http://www.w3.org/2000/svg">'
                '<defs>'
                    '<radialGradient id="l1" spreadMethod="pad" cx="0.5" cy="0.5" r="1" fx="0.69" fy="0.45" >'
                    '<stop offset="0%" stop-color="hsl(',aura1,', 69%, 75%)" />'
                    '<stop offset="90%" stop-color="hsl(',aura2,', 69%, 35%)" />'
                    '</radialGradient>'
                    '<radialGradient id="l2" spreadMethod="pad" cx="0.5" cy="0.5" r="0.8" fx="0.5" fy="0.5" >'
                    ...
                    '</linearGradient>'
                    '<radialGradient id="l4" spreadMethod="pad" cx="0.5" cy="0.5" r="0.75" fx="0.5" fy="0.5" >'
