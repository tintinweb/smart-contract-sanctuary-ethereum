...
PaymentSplitter
{
    ...
    string public notRevealedUri = "ipfs://QmbaBQw2HBZoj921ya5dh27PjNfWrWjPWo3Vu6GFpMMSai/HIDDEN_THIRD_EYE.json ";
    string public baseExtension = ".json";

    bool public paused = false;  // is paused
    bool public revealed = false;  // is revealed
    bool public presaleM = false;  // presale minting
    bool public publicM = false;  // public minting

    uint256 presaleAmountLimit = 3;
    mapping(address => uint256) public _presaleClaimed;

    uint256 public _price = 10000000000000000; // NFT price 10000000000000000 Wei === 0.01 ETH

    Counters.Counter private _tokenIds;

    //    uint256[] private _teamShares = [25, 35, 40]; // 3 PEOPLE IN THE TEAM
    //    address[] private _team = [
    //        0x34265c972495d7D22AEc4Bd17396A9E34A6864f8, // Admin Account gets 25% of the total revenue
    ...
    address[] private _team = [0x34265c972495d7D22AEc4Bd17396A9E34A6864f8];
