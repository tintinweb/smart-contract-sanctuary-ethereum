...
contract TokenVesting is Ownable, ReentrancyGuard, Pausable {
    ...
    IERC20 private TokenSmartContract;
    ...
    constructor(address addressToken) public // address beneficiary,
    // uint256 start,
    // uint256 cliffDuration,
    // uint256 duration,
    // bool revocable
    {
        // Convertimos la address a formato IERC20 y se la asignamos a TokenSmartContract
        TokenSmartContract = IERC20(address(addressToken));
    ...
    function assignTokensToWallet(
        ...
        // require(tokensRestantes > cantidadBBCNAAsignar, "Not enough tokens left to assign");
        ...
        // require(_firstClaimDate > lastUpdated, "Ending Date needs to be in the future");
