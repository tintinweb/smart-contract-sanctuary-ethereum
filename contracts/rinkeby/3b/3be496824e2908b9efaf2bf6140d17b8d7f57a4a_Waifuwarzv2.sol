...
contract Waifuwarzv2 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbPZTpwDb5QQiEHDX8dBwJcbKhveVfBhsaV9jBgSAQwHd";
    ...
    constructor(
    ) ERC721A("WW", "WaifuWarzv2", 100, maxSupply) {
    }
