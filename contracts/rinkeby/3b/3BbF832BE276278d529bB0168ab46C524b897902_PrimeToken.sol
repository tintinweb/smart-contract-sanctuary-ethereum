...
import "./layerzero/token/oft/extension/BasedOFT.sol";
...
contract PrimeToken is AccessControl, ReentrancyGuard, BasedOFT {
    /**
    ...
    constructor(address _layerZeroEndpoint)
        BasedOFT(NAME, SYMBOL, SUPPLY, msg.sender, _layerZeroEndpoint)
    {
...
contract BasedOFT is OFT {
    constructor(
        ...
        address _owner,
        address _lzEndpoint
    ) OFT(_name, _symbol, _supply, _owner, _lzEndpoint) {}
...
contract OFT is OFTCore, ERC20PresetFixedSupply, IOFT {
    constructor(
        string memory _name,
        string memory _symbol,
        uint256 _supply,
        ...
        ERC20PresetFixedSupply(_name, _symbol, _supply, _owner)
        OFTCore(_lzEndpoint)
    {}
