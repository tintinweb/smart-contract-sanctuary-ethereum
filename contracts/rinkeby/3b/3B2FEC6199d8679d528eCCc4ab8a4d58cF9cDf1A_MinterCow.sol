...
contract MinterCow is ERC721ABurnable, AllowlistSale, Ownable, AccessControlEnumerable, ReentrancyGuard {
    ...
    *       you can get your slaeKey and saleId on cowlony.io
    ...
    */
    ...
    /**
    @notice When OpenSeaProxyOn no need to manually whitelist opensea proxy to be able to list an item,
    ...
    */
    ...
    // grazing based on the moonbirds contract
    ...
    */
    ...
    @dev Grazing is tied to a specific Cow, not to the owner, so it doesn't reset upon sale.
    ...
    *             the current period.
    @return max Longest continous period of time for which the Cow has been grazing across its life,
    ...
    */
    ...
    /**
    @dev Changes the listed Cows' grazing status.
    */
    ...
    */
    function transferRavenues() external onlyOwner {
        require(beneficiary != address(0), "No beneficiary id defined");
