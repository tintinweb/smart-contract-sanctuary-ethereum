...
contract Staker is Ownable {
    ...
    function getStakeToken() public returns (string memory) {
        return IERC20Metadata(_stakingToken).symbol();
    }

    function getRewardToken() public returns (string memory) {
        return IERC20Metadata(_rewardToken).symbol();
    }
}
