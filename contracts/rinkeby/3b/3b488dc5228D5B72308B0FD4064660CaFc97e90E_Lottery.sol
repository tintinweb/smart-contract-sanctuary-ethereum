...
contract Lottery is Ownable,VRFConsumerBase{
    ...
    function enter() public payable  {
        ...
        require(msg.value>=getEntranceFee(),"Not Enough Ether used");
    ...
    function endLottery() public onlyOwner {
        ...
        //     )
        // )%players.length
        //chainlink-vrf provides thr random function that is why we got to 
        // import it
        lottery_state=LOTTERY_STATE.CALCULATING_WINNER;
        // requestRandomness(keyhash,fee);this is same as
        bytes32 requestId=requestRandomness(keyhash,fee);
        emit RequestedRandomness(requestId);
    }
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require(lottery_state==LOTTERY_STATE.CALCULATING_WINNER,"You are not there yet");
        require(_randomness>0,"not a random number");
