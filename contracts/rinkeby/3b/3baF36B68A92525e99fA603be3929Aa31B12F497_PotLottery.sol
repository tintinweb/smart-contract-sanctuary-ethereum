...
contract PotLottery {
    ...
    address private usdt = 0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD;
    ...
    function getPulsePrice() public view returns (uint256) {
        IUniswapV2Factory factory = IUniswapV2Factory(uniswapV2Factory);
        IUniswapV2Pair pair = IUniswapV2Pair(factory.getPair(weth, usdt));
        IPRC20 wethToken = IPRC20(pair.token0());
        (uint256 Res0, uint256 Res1, ) = pair.getReserves();
        uint256 res0 = Res0 * (10**wethToken.decimals());
        return res0 / Res1;
    }
