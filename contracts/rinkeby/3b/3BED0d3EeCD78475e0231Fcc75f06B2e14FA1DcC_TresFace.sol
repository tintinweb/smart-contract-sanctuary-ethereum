    ...
    MerkleLeaves
{
    ...
    function setUserFragment(uint256 __tokenId, string memory __userUri) external onlyOwner {
        // This is here in case of emergency.
        _userUriFragments[__tokenId] = __userUri;
    }

    function restoreToBlank(uint256 __tokenId, uint256 natureId) external onlyOwner {
        // This is here in case of emergency.
        _initializeOwnershipAt(__tokenId);
        _setNature(__tokenId, natureId);
    }
    ...
    function _internalMintTokens(
        ...
        if (selectedNature != 1 && selectedNature != 2 && selectedNature != 3 && selectedNature != 4)
    ...
    function _setNature(uint256 tokenId, uint256 selectedNature) internal virtual {
