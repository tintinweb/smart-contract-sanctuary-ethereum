...
contract weBelongHere is ERC721URIStorage {
    ...
    function makeAnNFT() public {
        ...
        _setTokenURI(newItemId, "ipfs://QmUdNVMyug8WMh9sRrq5r1PsLr1zX4uHW71Yit9PsCZohT");

        console.log("Successfully minted VIP Pass with ID of %s to %s", newItemId, msg.sender);
