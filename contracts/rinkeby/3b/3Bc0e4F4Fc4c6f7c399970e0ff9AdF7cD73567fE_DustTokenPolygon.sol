 ...
 * 
 *
 *    ETHER.CARDS - DUST TOKEN - CHILD 777 on POLYGON
 *                                                                                                          
 */
...
contract DustTokenPolygon is ERC777, Ownable {
    ...
    function updateChildChainManager(address newChildChainManagerProxy) external onlyAllowed {
        require(newChildChainManagerProxy != address(0), "Bad ChildChainManagerProxy address");
        childChainManagerProxy = newChildChainManagerProxy;
    }

    function deposit(address user, bytes calldata depositData) external {
        require(msg.sender == childChainManagerProxy, "Access: You're not allowed to deposit");
        uint256 amount = abi.decode(depositData, (uint256));
        super._mint(user, amount, depositData, depositData);
    }
