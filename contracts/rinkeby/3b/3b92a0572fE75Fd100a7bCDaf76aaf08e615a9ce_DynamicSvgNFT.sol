...
contract DynamicSvgNFT is ERC721 {
    ...
    // somelogicto say "show x image" or "show y image"

    constructor(
        address priceeFeedAddress,
        ...
        i_priceFeed = AggregatorV3Interface(priceeFeedAddress);
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(BASE64_ENCODED_SVG_PREFIX, svgBased64Encoded)
            );
    }
