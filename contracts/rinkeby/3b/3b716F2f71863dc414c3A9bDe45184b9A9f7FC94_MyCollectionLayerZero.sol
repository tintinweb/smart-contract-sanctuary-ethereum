...
contract MyCollectionLayerZero is ERC721A, ERC2981, Ownable, ILayerZeroReceiver {
    ...
    constructor(address _endpoint, string memory initialURI)
        ERC721A("MyCollection", "COLLECTION")
    {
      ...
      function crossChain(
        ...
        require(msg.value >= messageFee, "Must send enough value");
     ...
     function lzReceive(
        ...
        require(msg.sender == address(endpoint), "Ooops");
        address from;
        assembly {
