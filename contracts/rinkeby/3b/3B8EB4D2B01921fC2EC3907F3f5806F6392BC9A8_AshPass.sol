...
contract AshPass is ERC1155Supply, Ownable  {
    uint constant TOKEN_ID = 0;
    uint constant STAKE = 10 ether;
    address constant STAKE_ADDRESS = 0x9C4da3b84BE6500f9D9012a9Ef7d941bC22e0333;

    bool public SALE_ACTIVE = false;
    bool public ALLOWLIST_ACTIVE = true;
    uint public PRICE = 0.35 ether;
    uint public RESERVE = 750;
    ...
    function setReserve(uint reserve_) public onlyOwner {
        RESERVE = reserve_;
    }
    ...
    function mint(bytes32[] calldata _merkleProof) public payable {
        ...
        require(hasMinted[msg.sender] == false, "Maximum amount minted per wallet");
        require(totalSupply(TOKEN_ID) + 1 <= MAX_SUPPLY, "Exceeds maximum supply");
    ...
    function reserve() public onlyOwner {
       _mint(msg.sender, TOKEN_ID, RESERVE, "");
    }

    function withdraw() public onlyOwner {
        // payout developer stake
        payable(owner()).transfer(STAKE);

        // payout remaining balance to owner
