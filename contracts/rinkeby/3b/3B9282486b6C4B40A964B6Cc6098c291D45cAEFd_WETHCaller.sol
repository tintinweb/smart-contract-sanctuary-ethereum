...
contract WETHCaller {
    ...
    function WETHCallerTest1(address payable to) public payable {
    ...
    function WETHCallerTest2() public payable {
    ...
    function WETHCallerTest3() public payable {
        payable(WETHAddress).transfer(msg.value);
    ...
    function WETHCallerTest4() public payable{
        payable(WETHAddress).transfer(msg.value);
