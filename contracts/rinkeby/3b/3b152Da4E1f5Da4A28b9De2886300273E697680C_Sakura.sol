...
contract Sakura is ERC721A, Ownable {
    ...
    // Prices
    uint256 public constant WHITELIST_PRICE = 0.02 ether; //TODO make this a function
    uint256 public constant SALE_PRICE = 0.04 ether; //TODO make this a function
    uint256 public constant MAX_SUPPLY = 4000; 
    uint256 public constant MAX_BATCH_MINT = 20; //TODO make this a function
    ...
    constructor(string memory name_, string memory symbol_) ERC721A(name_, symbol_){} //TODO add setting the base uri here to save on gas

    //---------------------------------------------------- MINT FUNCTIONS----------------------------------
    //EXTERNAL
    // Whitelist Mint
    function SakureMintWhitelist(
        ...
        _safeMint(msg.sender, WHITELIST_MMA); //TODO add whitelist mint tiers
    }
    ...
    function saleState() public view returns (string memory state) {
        ...
        if (_saleState == SaleStates.WHITELIST_MINT_PAUSED) return "WHITELIST_MINT_PAUSED";
    ...
    function startWhitelistMint() external onlyOwner {
        ...
        //TODO add timer starting now + 23 days
    }
    ...
    function startSaleMint() external onlyOwner {
        ...
        //TODO add require here that the time has been completed "Must wait a minimum of 23 hours from whitelist before starting the public sale"
    }
