...
contract NEWMosiMosiMosi is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NEW Mosi Mosi Mosi", "NMMM") {
    setHiddenMetadataUri("ipfs://Qmeb6d9BBez74mDt8t6zkU8y6mZ3FKGtzb9BT8Yc3deSwn/hidden.json");
  }
