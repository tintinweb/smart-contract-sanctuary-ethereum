...
// Standard mint function
    ...
    // QmREDazDTYSu8ZZVhtN7m4DRHQsADSpWwbmHkVbxbWQm4H
   ...
   function setBaseURI(string memory baseURI_) external onlyOwner() {
    ...
    function editEntityRegistering(address _address, bool _done) public  onlyOwner {
        entityRegistering[_address] = _done;
    }

    // get entityRegistering
    function getEntityRegistering(address _address) public view returns(bool) {
        return entityRegistering[_address];
    }
