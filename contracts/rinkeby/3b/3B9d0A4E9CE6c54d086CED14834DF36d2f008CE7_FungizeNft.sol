...
contract FungizeNft is ERC721, Ownable, ReentrancyGuard{
    ...
    uint256 public MaxCollectionSize = 10;
    ...
    function mintMushroom() public payable {
        require(SaleOpen, "Sale closed");
        require(WhiteList[msg.sender], "Not on whitelist");
        require(WalletMintCount[msg.sender] == 0, "Already minted 1");
        require(CurrentSupply < MaxCollectionSize, "Sold out");
        require(MintPrice == msg.value, "Incorrect eth amount");
    ...
    //only owner function
    function mintMushroom(address _to) public onlyOwner { 
        require(CurrentSupply < MaxCollectionSize, "Sold out");
