...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xFf6c862211c12FD62EEcE14f903AC460e149A912];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRcWtLBWV12cRsHSRaqmt6dfzUfWzDpe1jkKSvYKrXrzV/";
...
// File: contracts/KmmContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KmmContract is RamppERC721A {
    constructor() RamppERC721A("kmm", "kmm"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ipHX6g4U4raLiZYWCWU1/contract-metadata";
    }
}
