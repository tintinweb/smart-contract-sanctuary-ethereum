...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmV4ZNXpRTALWgPKmsS25WZ2kHvm8U4bLxvpHQfaNjCj7N/";
...
// File: contracts/LastgiftryoutContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LastgiftryoutContract is RamppERC721A {
    constructor() RamppERC721A("LAST GIF TRYOUT", "LFT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/TMj75gMtueUSQxmj7PnQ/contract-metadata";
    }
}
