...
contract StarBabies is MRC721, Ownable {
    ...
    mapping (address => uint8) public usersMint;
    ...
    function whitelistMint(address _to, uint8 _count) public payable {
        require(usersMint[msg.sender] + _count <= minters[msg.sender], '> availble amount');
        require(_count + totalSupply() <= maxCap, "> maxCap");
        require(msg.value >= price(_count), "!value");
        usersMint[msg.sender] += _count;
        _mint(_to, _count);
    }
