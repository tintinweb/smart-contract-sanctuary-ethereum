...
contract Fluppies is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 private maxReservedMints = 8;
    ...
    constructor() ERC721A("Fluppies", "F") {
        maxTotalTokens = 80;

        _currentBaseURI = "ipfs://QmbKiMJ9UB2xCvSpRGw4QcrjcUFKvyFf7UzxdPMU1KcppB/";
    }
    ...
    function mint() public nonReentrant {
        ...
        require(
            mintsPerAddress[msg.sender] == 0,
            "Wallet has already have minted an NFT!"
        );
