...
contract Staker {
  ...
  function stake() public payable {
    ...
    require(block.timestamp <= deadline, "staking deadline expired");
  ...
  function withdraw() external {
    ...
    require(address(this).balance <= threshold, "threshold exeeded");
    require(balances[msg.sender] > 0, "none to withdraw");
