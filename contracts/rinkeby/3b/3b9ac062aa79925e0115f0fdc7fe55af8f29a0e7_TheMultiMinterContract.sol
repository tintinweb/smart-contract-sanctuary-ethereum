...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/theMultiMinterContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract TheMultiMinterContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("The MultiMinter", "MULTI", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://rampp.xyz/token/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/5qRPE1JYZLiNo8w7YusT/contract-metadata";
        }
    }