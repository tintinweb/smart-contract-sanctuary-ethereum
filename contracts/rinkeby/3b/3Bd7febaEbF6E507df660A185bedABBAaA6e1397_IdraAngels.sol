...
contract IdraAngels is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    /// @dev ETH address for GiveWell charity
    address private giveWellAddress = 0x7cF2eBb5Ca55A8bd671A020F8BDbAF07f60F26C1;

    /// @dev Creator address - Elohim
    address private elohimAddress = 0xE40605cB0c58f5F4d6FB639E016520B395FBDEFc;

    /// @dev Creator address - Adonai
    address private adonaiAddress = 0x2E460d4a464246A90239C1EE7b4ED53F79CF6AA1;
    ...
    /// @dev Maximum total giveaways that can be minted by owners
    ...
    constructor(string memory baseURI, uint256 maxSupply) ERC721("Angel", "AGL") {
        _projectBaseURI = baseURI;
        maxAngels = maxSupply + 1; // Add one to offset zero
    ...
    function mintGiveaway(uint256 count) public onlyOwner {
        require(_tokenIdCounter.current() + count <= maxAngels, "Purchase would exceed supply");
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(elohimAddress).transfer((balance / 100) * (remainder / 2));
        payable(adonaiAddress).transfer((balance / 100) * (remainder / 2));
    }
