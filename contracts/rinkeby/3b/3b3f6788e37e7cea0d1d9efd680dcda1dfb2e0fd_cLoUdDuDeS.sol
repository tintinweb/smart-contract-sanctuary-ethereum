...
contract cLoUdDuDeS is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public CloudPrice = 0.5 ether;
    uint256 public TotalSupplyForFree = 20;
    bool public IsMintingPaused = false;
    
    uint256 public FreeCloudPerAddress = 1;
  ...
  function CloudMint(uint256 _CloudsAmount) public payable {
      uint256 TotalClouds = totalSupply();
       
       require(!IsMintingPaused, "The Cloud Mint is paused!");
       require(msg.value >= CloudPrice * _CloudsAmount, "Insufficient funds!");
       require(TotalClouds + MaxCloudsPerAddress <= maxSupplyClouds);
       require(msg.value >= CloudPrice * _CloudsAmount, "There are insufficient funds in your wallet");
