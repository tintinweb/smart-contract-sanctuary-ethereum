...
contract XHape is ERC721A, Ownable {
    ...
    uint256 public MAX_IN_TRX = 25;
    address payable withdrawTo = payable(0x3Ce231eeE226716456Df971B23decD2b2D599479);
    address payable withdrawDev = payable(0x7c2804Eca97314b2B617DE79e9CFc977ba06C963);
    ...
    constructor(string memory _initBaseURI) ERC721A("0xHAPE", "XHP") {
