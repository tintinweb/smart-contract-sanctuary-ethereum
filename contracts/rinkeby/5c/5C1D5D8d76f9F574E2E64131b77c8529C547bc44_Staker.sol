...
contract Staker {
  ...
  /// balances of staked funds
  mapping (address => uint256) public balances;

  /// threshold required to allow staking execution
  uint256 public constant threshold = 1 ether;

  /// staking deadline
  uint256 public deadline = block.timestamp + 72 hours;

  /// boolean to allow public withdrawls from staking contract
  bool public openForWithdraw;

  /// Events
  event Stake(address staker, uint256 amtToStake);
  ...
  /// mofifier that checks with the external contract has been completed
  ...
  function stake() deadlinePassed(false) public payable {
  ...
  function execute() public deadlinePassed(true) stakingNotCompleted {
    if (address(this).balance >= threshold) {
      balances[address(exampleExternalContract)] = address(this).balance;
