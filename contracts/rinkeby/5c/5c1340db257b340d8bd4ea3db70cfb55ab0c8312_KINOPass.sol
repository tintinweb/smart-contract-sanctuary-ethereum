    ...
    PausableUpgradeable
{
    ...
    mapping(uint256 => bool) private _saleList;
    ...
    function initialize(string memory baseURI_) public initializer {
        ...
        publicSaleLimit = 3;
        publicSalePrice = 200_000_000_000_000_000; // 0.2 ETH
    ...
    function _publicSaleMint(uint256 amount) internal {
        ...
        for (uint256 i; i < amount; i++) {
            while (_saleList[_tokenIdCounter.current()]) {
                _tokenIdCounter.increment();
            }
            _saleList[_tokenIdCounter.current()] = true;
