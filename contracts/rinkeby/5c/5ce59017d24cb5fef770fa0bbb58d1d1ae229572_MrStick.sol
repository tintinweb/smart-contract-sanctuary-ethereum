...
contract MrStick is ERC721A, Ownable {
    ...
    function withdraw() external onlyOwner {
        ...
        (bool mk, ) = payable(0xA41751BCAEb4a029BD1e558E7eeF419664497Bcf).call{value: address(this).balance * 25 / 100}("");
        require(mk, "Transfer failed.");
