...
contract TTS is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC2981Upgradeable, SignedAllowance {
    ...
    function TimeTravellerMint (bool whitelisted, uint256 nonce, bytes memory signature) external payable {
        ...
        if (whitelisted) {
            ...
            //msg.value must be atleast 0.01, but we accept more than that
    ...
    function setRoyaltyBps(uint16 newRoyaltyBps) external onlyOwner {
        quantumStorage.royaltyBps = newRoyaltyBps;
    }
    ...
    function royaltyInfo(uint256, uint256 salePrice) public view virtual override returns (address receiver, uint256 royaltyAmount) {
        return (owner(), (salePrice * quantumStorage.royaltyBps / 10000));
    }
