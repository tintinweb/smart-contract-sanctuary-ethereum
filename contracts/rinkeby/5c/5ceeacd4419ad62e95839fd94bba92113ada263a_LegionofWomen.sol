...
// File: contracts/LegionofWomen.sol
...
contract LegionofWomen is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("LegionofWomen", "LoW") {
        setBaseURI("ipfs://QmXN2ba1Z4FXS2PoCtRjcQUhMKpqZkEHAZFDcmRwZkGngu/");
    ...
    function MintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require (sale_is_active, "Sale is not active");
