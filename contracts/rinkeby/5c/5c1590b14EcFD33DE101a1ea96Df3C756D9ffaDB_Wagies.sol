    ...
    Withdrawable
{
    ...
    constructor() ERC721("The Wagies", "Wagies") Whitelist("Wagies", "1") {}
        ...
        isSenderWhitelisted(_signedQty, _nonce, _signature)
    {
        ...
        require(
            privateSalesMintedQty + publicSalesMintedQty + GIFT_MAX_QTY <
                TOTAL_MAX_QTY,
    ...
    function publicSalesMint(uint256 mintQty)
        external
        payable
        isPublicSalesActive
    {
        ...
        require(
            publicSalesMinterToTokenQty[msg.sender] + mintQty <=
                PUBLIC_MAX_QTY_PER_MINTER,
            "Exceed max mint per minter"
        );
        publicSalesMinterToTokenQty[msg.sender] += mintQty;
        publicSalesMintedQty += mintQty;
    ...
    function gift(address[] calldata receivers) external onlyOwner {
        require(
            privateSalesMintedQty + publicSalesMintedQty + receivers.length <=
                TOTAL_MAX_QTY,
