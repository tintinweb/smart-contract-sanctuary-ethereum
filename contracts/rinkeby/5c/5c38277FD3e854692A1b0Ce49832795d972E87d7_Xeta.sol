...
contract Xeta is ERC20, ERC20Detailed, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    modifier limitCheck(uint256 value) {
        require(msg.sender != allMintedAddress || limit >= value, "limit reach" );
        _;
    }
    ...
    function changeTransferLimit(uint256 _limit) onlyOwner public {
