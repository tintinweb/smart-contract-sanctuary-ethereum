...
contract WOLFTEST is ERC721, Ownable {
    using Strings for uint256;

    // ██████████URI██████████
    string public baseURI; //internal

    // ██████████Price██████████
    uint256 public price = 0.05 ether;

    // ██████████Minting██████████
    uint256 public totalClones = 15;
    uint256 public nftPerWhitelistedLimit = 1;
    bool public paused = true;
    uint256 public _supplyCounter = 0; //internal

    // ██████████Lab Whitelist██████████
    bool public onlyWhitelisted = true;
    address[] public LabWhitelistAddresses; //why not mapping with num of nft authurized
    ...
    function setNftPerWhitelistedLimit(uint256 _limit) external onlyOwner {
        nftPerWhitelistedLimit = _limit;
    }
