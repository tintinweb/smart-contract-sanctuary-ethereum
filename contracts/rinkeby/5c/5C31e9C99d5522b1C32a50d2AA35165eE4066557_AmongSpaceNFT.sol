...
contract AmongSpaceNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        // Verify mint supply
        require(totalSupply() + _mintAmount <= maxSupply,"Not enough Spaceboys available");

        if (onlyWhitelisted == true) {
            require(whitelist[msg.sender] == true, "User is not whitelisted");
            require(_numberMinted(msg.sender) + _mintAmount <= nftPerAddressLimit,"Mint amount exceed your WL limit.");
        }
