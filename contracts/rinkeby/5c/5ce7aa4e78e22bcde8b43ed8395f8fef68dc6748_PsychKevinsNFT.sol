...
// Psychedelic Kevins NFT - ERC721 

// Mints a Psychedelic Anony... ugh.... a Kevin until all 959 are minted!
// Project is for-fun and to bring attention to PA; all royalties used to pay for contract gas fees and to buy more PA :D
// 25 Kept for EarthDweller to give to original minters and in giveaways

// PsychKevinsNFT

contract PsychKevinsNFT is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmapfJ7L9K8Bn9XcDzsAGs5gNRu6gqV2nxvzBNTXWLjkG7/";

  constructor() 
    ERC721("Psychedelic Kevins", "PsychKevinsNFT")
    RandomlyAssigned(959,1) // Max. 959 NFTs available; Start counting from 1 (instead of 0)
    {
