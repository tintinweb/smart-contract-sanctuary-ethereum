  ...
  function createTrackInternal(
    ...
    string[][] memory _artistsNames
      ...
      for (uint256 i = 0; i < _trackNames.length; ++i) {
        ...
        emit TracksCreated(track[currentTrackId], currentPackId, _artistsWallets[i], _trackAminWallet);       
      }
      existingPackId[currentPackId] = true;  
      emit PacksCreated(_packName, currentPackId, _artistsWallets, _trackAminWallet);
  }
