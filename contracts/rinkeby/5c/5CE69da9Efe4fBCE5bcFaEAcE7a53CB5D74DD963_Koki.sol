...
// File contracts/koki.sol

pragma solidity ^0.8.4;



contract Koki is ERC721A, Ownable, ReentrancyGuard {
    ...
    function lowerMaxSupply(uint256 newMaxSupply) external onlyOwner {
        ...
        require(newMaxSupply >= _nextTokenId(), "Invalid new max supply");
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require(
            _nextTokenId() + _mintAmount <= MAX_SUPPLY,
            "Max supply exceeded!"
        );
        _;
    }
        ...
        mintCompliance(_mintAmount)
    {
        ...
        if (_nextTokenId() < FREE_MINT_IS_ALLOWED_UNTIL) {
    ...
    function withdraw() public onlyOwner nonReentrant {
        (bool success, ) = payable(0x9A6024F4B7081ab3da0f309286Fb76267F4b68B1).call{
