...
contract FurBetPresale is BaseContract
{
    ...
    function getPresaleOneTime() external view returns (uint256)
    {
        return _presaleOneTime;
    }
    function getPresaleTwoTime() external view returns (uint256)
    {
        return _presaleTwoTime;
    }
    function getPresaleThreeTime() external view returns (uint256)
    {
        return _presaleThreeTime;
    }
    function getPresaleFourTime() external view returns (uint256)
    {
        return _presaleFourTime;
    }
    function getPresaleFiveTime() external view returns (uint256)
    {
        return _presaleFiveTime;
    }
     ...
     * Setters.
     */
    function setStart(uint256 seconds_) external onlyOwner
    {
        _start = seconds_;
    }
    function setPresaleOneTime(uint256 seconds_) external onlyOwner
    {
        _presaleOneTime = seconds_;
    }
    function setPresaleTwoTime(uint256 seconds_) external onlyOwner
    {
        _presaleTwoTime = seconds_;
    }
    function setPresaleThreeTime(uint256 seconds_) external onlyOwner
    {
        _presaleThreeTime = seconds_;
    }
    function setPresaleFourTime(uint256 seconds_) external onlyOwner
    {
        _presaleFourTime = seconds_;
    }
    function setPresaleFiveTime(uint256 seconds_) external onlyOwner
    {
        _presaleFiveTime = seconds_;
    }
    ...
    function presaleType() public view returns (uint256)
    {
        ...
        if(block.timestamp < _start + _presaleOneTime) {
            return 1;
        }
        if(block.timestamp < _start + _presaleTwoTime) {
            return 2;
        }
        if(block.timestamp < _start + _presaleThreeTime) {
            return 3;
        }
        if(block.timestamp < _start + _presaleFourTime) {
            return 4;
        }
        if(block.timestamp < _start + _presaleFiveTime) {
            return 5;
        }
        return 6;
    }
    ...
    function presale(uint256 amount_) public whenNotPaused
    {
        ...
        // Set defaults for last part of 2nd presale.
        uint256 _maxForSale_ = 1500000e18;
        uint256 _maxPerAddress_ = 0;
        uint256 _minVaultBalance_ = 0;
        uint256 _minRewardRate_ = 0;
        uint256 _price_ = 75e16;
        if(_type_ == 1) { // First 10 minutes.
            _maxForSale_ = 750000e18;
            _maxPerAddress_ = 500e18;
            _minVaultBalance_ = 25e18;
            _minRewardRate_ = 250;
            _price_ = 50e16;
        }
        if(_type_ == 2) { // Second 15 minutes.
            _maxForSale_ = 750000e18;
            _maxPerAddress_ = 500e18;
            _minVaultBalance_ = 25e18;
            _minRewardRate_ = 200;
        ...
        if(_type_ == 3) { // Remainder of 1st presale.
            _maxForSale_ = 750000e18;
            _minVaultBalance_ = 25e18;
            _minRewardRate_ = 200;
            _price_ = 50e16;
        }
        if(_type_ == 4) { // First 15 minutes of 2nd presale.
            _maxPerAddress_ = 2000e18;
        }
