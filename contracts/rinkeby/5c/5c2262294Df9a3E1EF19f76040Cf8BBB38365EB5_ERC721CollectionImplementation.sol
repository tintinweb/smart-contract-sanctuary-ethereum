...
contract ERC721CollectionImplementation is ERC721CollectionBase, ERC721Upgradeable, AdminControlUpgradeable {
     ...
     * Initializer
     */
    function initialize(string memory _name, string memory _symbol, uint16 purchaseMax_, uint256 purchasePrice_, uint16 purchaseLimit_, uint16 transactionLimit_, uint256 presalePurchasePrice_, uint16 presalePurchaseLimit_, address signingAddress, bool useDynamicPresalePurchaseLimit_) public initializer {
