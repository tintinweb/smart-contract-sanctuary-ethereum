...
/*
     STANDARD CONTRACT TEMPLATE "NFTcontract"
     // v20220225.902pm
...
contract TESTname is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    constructor(address[] memory distro, uint[] memory distro_shares, address[] memory teamclaim, bytes32 _merkleRoot)
        ERC721("Standard_Template_2", "STANDARD2")
        PaymentSplitter(distro, distro_shares)
    {
        ...
        // Set Team NFTs and Initial Admin Levels:
        accounts[teamclaim[0]] = Account( 25, 0, 2); // Test acct 1 == deployer / owner
        accounts[teamclaim[1]] = Account( 25, 0, 1); // Test acct 2 == admin level 1
        accounts[teamclaim[2]] = Account( 25, 0, 1); // dd220a 1 == admin level 1
        accounts[teamclaim[3]] = Account( 25, 0, 2); // dd20aa 2 == admin level 2
    ...
    function claimReserved(uint _amount) external minAdmin1 {
        ...
        require(accounts[msg.sender].isAdmin > 0, "Error: Only admins can claim.");
