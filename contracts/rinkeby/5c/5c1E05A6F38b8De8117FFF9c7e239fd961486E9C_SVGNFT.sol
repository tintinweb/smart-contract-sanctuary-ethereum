...
contract SVGNFT is ERC721URIStorage{
    ...
    constructor() ERC721 ("DEALERSHIP_REG3", "DR#3") {
        owner = msg.sender;
        tokenCounter = 0;
    ...
    function create(Dealer memory dealer) public payable canMint {
    ...
    // function formatattributes(Dealer memory info, string memory _imageURI) internal pure returns (string memory){
    //     return string(abi.encodePacked(
    ...
    // function formatTokenURI( string memory _attributes) public pure returns (string memory) {
    //     string memory baseURL = "data:application/json;base64,";
    //     return string(abi.encodePacked(
    //         baseURL,
    //         Base64.encode(bytes(_attributes))
    //     ));
    // }
