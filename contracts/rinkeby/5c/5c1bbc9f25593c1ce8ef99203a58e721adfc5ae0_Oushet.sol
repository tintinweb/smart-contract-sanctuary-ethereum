...
contract Oushet is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbWGYpHYReNjZm8PiG5G3L2sHsTvWod78556NW37qnhAQ/1.json";
    ...
    constructor(
    ) ERC721A("Oushet", "OUS", 100, maxSupply) {
    }
