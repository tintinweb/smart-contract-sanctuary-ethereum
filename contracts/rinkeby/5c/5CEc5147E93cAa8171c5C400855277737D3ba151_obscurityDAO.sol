...
//Initializable, ERC20//, ERC20Burnable, AccessControl,ERC20, ReentrancyGuard  
//ERC20Capped ReentrancyGuard, VestingWallet, PullPayment, Pausable
contract obscurityDAO is ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, FounderWallets, ReentrancyGuardUpgradeable {
    ...
    function initialize() initializer public {
       ...
       // _crowdsaleZero_init(5, companyWallet.founderAddress, IERC20Upgradeable(address(this)), 200);
    }
