...
contract K1Collection is ERC721Enumerable, Ownable {
  using Strings for uint256;

  uint256 public constant START_PRE_SALE_DATE = 1643725800;
  uint256 public constant MAX_AMOUNT = 320;
  ...
  function _beforeTokenTransfer(
    ...
    require(block.timestamp - START_PRE_SALE_DATE < 26 hours, 'test restrict resale');
