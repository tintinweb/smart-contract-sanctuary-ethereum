...
contract CrowdsaleDigitalUYS {
    ...
    constructor () public {
        ...
        /**
        * Network: Rinkeby PriceOracle Interface
        * Aggregator: ETH/USD
        ...
        */
        ...
        _rate = _getTokenAmount(1);
        // int256 currentETHPrice = getLatestPrice();
        // int256 price_rate = currentETHPrice / 10 ** 3;
        // _rate = uint256(price_rate);
       
  
    }

    /**
     * Returns the latest price     // 274131489858   // 1UYS price = $0.00001
     */
    ...
    function _getTokenAmount(uint256 weiAmount) public view returns (uint256) {
        ...
        int256 currentETHPrice = getLatestPrice();  // 2741 31 489 858   // 1UYS price = $0.00001  // 10**5/10**8
        int256 price_rate = currentETHPrice / 10 ** 3;
        int256 UYSAmount = int256(weiAmount) * price_rate;
        return uint256(UYSAmount);
    }
