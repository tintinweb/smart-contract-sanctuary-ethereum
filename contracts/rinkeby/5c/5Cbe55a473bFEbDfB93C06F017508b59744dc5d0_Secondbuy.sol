...
contract Secondbuy is Initializable, ERC2981Upgradeable, EIP712Upgradeable {
    ...
    function secondarybuy(FNVvoucher.marketItem memory seller, address redeemer, uint256 nftAmount) ///////////////////////////////////
        ...
        payable
    {
        require(!batchAmountStatus[seller.counterValue]  , "MintVoucher has expired");
        require(seller.listed, "Not listed");
        console.log(ITemplate1155(seller.nftAddress).balanceOf(seller.owner,seller.tokenId),"ITemplate1155(seller.nftAddress).balanceOf(seller.owner,seller.tokenId)");
        console.log(seller.nftBatchAmount,"seller.nftBatchAmount");
        // require(
        ...
        console.log(nftBatchamountleft[seller.counterValue], "nftBatchamountleft[seller.counterValue]:-");
