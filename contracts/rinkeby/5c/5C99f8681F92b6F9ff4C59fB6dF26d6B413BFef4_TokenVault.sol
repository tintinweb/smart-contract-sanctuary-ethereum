...
contract TokenVault is Initializable, ERC20Upgradeable, ERC721HolderUpgradeable {
    ...
    function initialize(address _settings, address _curator, address _token, uint256 _id, uint256 _supply, uint256 _listPrice, uint256 _fee, string memory _name, string memory _symbol) external initializer {
