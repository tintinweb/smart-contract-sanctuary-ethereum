 ...
 */
contract ERC1155CollectionImplementation is ERC1155Upgradeable, ERC1155CollectionBase, AdminControlUpgradeable
{
    /**
     * Initializer
     */
    function initialize(uint16 maxSupply_, uint16 purchaseMax_, uint256 purchasePrice_, uint16 purchaseLimit_, uint16 transactionLimit_, uint256 presalePurchasePrice_, uint16 presalePurchaseLimit_, address signingAddress_, bool useDynamicPresalePurchaseLimit_) public initializer {
        __ERC1155_init("");
        __Ownable_init();
        _initialize(maxSupply_, purchaseMax_, purchasePrice_, purchaseLimit_, transactionLimit_, presalePurchasePrice_, presalePurchaseLimit_, signingAddress_, useDynamicPresalePurchaseLimit_);
    }

    /**
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, ERC1155CollectionBase, AdminControlUpgradeable) returns (bool) {
      return ERC1155CollectionBase.supportsInterface(interfaceId) || ERC1155Upgradeable.supportsInterface(interfaceId) || AdminControlUpgradeable.supportsInterface(interfaceId);
    }
    ...
    function burn(address from, uint16 amount) public virtual override {
        ...
        ERC1155Upgradeable._burn(from, TOKEN_ID, amount);
    }
    ...
    function _mintERC1155(address to, uint16 amount) internal virtual override {
        return ERC1155Upgradeable._mint(to, TOKEN_ID, amount, "");
    }
