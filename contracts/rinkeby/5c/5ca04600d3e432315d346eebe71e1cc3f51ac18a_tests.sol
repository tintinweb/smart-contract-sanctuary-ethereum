...
contract tests is ERC721A, Ownable, ReentrancyGuard, IERC2981 { 
    ...
    uint256 public _maxFreeMintSupply = 2222;
    uint256 public _teamNft = 100;

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
    using Strings for uint256;
    string public baseURI;
    string private _contractURI = "ipfs://bafkreicih7gxqyngcsk7ip6wcoccfbz3wh6ecfabfgzmpybtkh7fiwg6vu";
    // royalties
    ...
    constructor(string memory initBaseURI) ERC721A("test3", "449") {
        baseURI = initBaseURI;
        royalties = 0xB5a1E77D8589b721CF64eA53d6ba4524Fa515C6C;
    }
    ...
    function mint(uint256 count) external payable {
        ...
        require(totalSupply() + count < _maxSupply - _teamNft + 1, "Sold out!");
    ...
    function mintForAddress(uint256 _mintAmount, address _receiver) public onlyOwner {
        require(totalSupply() + _mintAmount < _maxSupply + 1, 'Max supply exceeded!');
