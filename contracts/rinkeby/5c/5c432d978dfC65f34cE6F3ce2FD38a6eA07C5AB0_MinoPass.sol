...
contract MinoPass is ERC1155Supply, Ownable 
{
    ...
    string public name = "Mino Alpha Pass"; // Token name
    
    uint public reservedTokensMinted = 0;
    
    string public contractURIstr = "";

    constructor() ERC1155("https://ipfs.io/ipfs/QmT5yZKhFsyQt2kq8ZLaZd7PwYuH3KJE3oiN3M85jCepfa/{id}.json") {}
