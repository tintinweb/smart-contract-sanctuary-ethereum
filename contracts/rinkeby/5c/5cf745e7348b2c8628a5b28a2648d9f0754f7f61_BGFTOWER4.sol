...
contract BGFTOWER4 is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    VAULTFROMHELL vaultContract;

    constructor() ERC721("Bad Girlfriend Project Towers", "BGFTOWER") {}
    ...
    function setVaultAddress(address _address) public onlyOwner {
        bgfVault = _address;
        vaultContract = VAULTFROMHELL(_address);
    }
