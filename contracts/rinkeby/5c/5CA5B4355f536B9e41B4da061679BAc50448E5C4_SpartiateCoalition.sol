...
// File: SpartiateCoalition.sol

pragma solidity ^0.8.4;


contract SpartiateCoalition is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
...
// First we setup a new Counter (_totalMinted) to keep track of the total number of NFTs that we have minted
    ...
    constructor() ERC721("Spartiate Coalition", "SPC") {}
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://Qmf9xQ71EfVXGws1oLYHYAsa91aeVhnRR8tB33byZoiQRu/.json";
    }
