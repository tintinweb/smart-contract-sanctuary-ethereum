...
contract Lottery is VRFConsumerBaseV2 {
    ...
    function enter() public payable isState(LotteryState.Open) {
        //$50 minimum
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 adjustedPrice = uint256(price) * 10**10; // 18 decimals (price have 8 decimal (see doc  ETH/USD))
        // $50, $2,000 / ETH
        // 50/2,000
        // 50 * 100000 / 2000
