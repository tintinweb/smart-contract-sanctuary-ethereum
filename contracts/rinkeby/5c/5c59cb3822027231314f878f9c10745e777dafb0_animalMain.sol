...
contract animalMain is  ERC721,Ownable {
  ...
  using SafeMath for uint256;
    string public name_ = "1072929";  //名字
  ...
  function createAnimal() payable public {
      ...
      //使用亂數來產生DNA, 星級, 動物種類
       ...
       if(range_of_star < 1 ) {star=1;}
       else if(range_of_star < 3 ) {star=2;}
       else if(range_of_star < 5 ) {star=3;}
       else if(range_of_star < 7 ) {star=4;}
       else{star=5;}
