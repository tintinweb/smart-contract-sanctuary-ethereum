...
contract THCToken is ERC20Burnable, Ownable {
    ...
    // Legendary Apes Mapping

    mapping(uint256 => bool) public legendApes;
        ...
        returns (uint256)
    {
       ...
       if(legendApes[_ApesID] == true)
       {
           return (_calculatejoint(elapsedDays, leftoverSeconds) - _calculatejoint(elapsedDaysSinceClaim, leftoverSecondsSinceClaim))*2;
       }
       else
       {
