...
contract XCO2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
        ...
        payable 
    {
        ...
        uint retAmount = mintAmount * 5 / 100; 
        totalMinted += mintAmount + retAmount;
        ...
        payable 
    {
        ...
        retiredBalanceOf[msg.sender] += mintAmount;
        txNum++;
        emit Retired(txNum, msg.sender, mintAmount, "mint_burn");
    }
    ...
    function setPrice(uint price) public onlyOwner {
     ...
     function setBulkDiscountAmounts(uint bulkAmount1, uint bulkAmount2) public onlyOwner {
        ...
        bulkDiscountAmounts[1] = bulkAmount2;
    }
    ...
    function genCert(address addr) public view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                '<text x="15" y="57" class="b small">', StringsUpgradeable.toString(retiredBalanceOf[addr] / 1000000), ' Tons Offset</text>',
