...
contract CoolkidsClub is ERC721, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 price) ERC721(name, symbol)
    {
    ...
    function mint(uint256 _quantity) external payable {
        require(whitelist[msg.sender], "Not whitelisted and public mint not started");
