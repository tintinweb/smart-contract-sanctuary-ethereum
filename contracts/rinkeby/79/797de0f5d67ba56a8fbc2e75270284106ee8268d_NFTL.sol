...
contract NFTL is Ownable, ERC721A, ReentrancyGuard {
    ...
    function publicBalanceOfCats(address _owner) public view returns(uint256) {
        ...
        address RektCatsAddress = 0x13fc42944Dc32Bba381A38F2Ee64f8231eF597E2;
        address NounsAddress = 0x9C8fF314C9Bc7F6e59A9d9225Fb22946427eDC03;
        address CryptoadzAddress = 0x1CB1A5e65610AEFF2551A50f76a87a7d3fB649C6;
        address BlitmapAddress = 0x8d04a8c79cEB0889Bdd12acdF3Fa9D207eD3Ff63;
        address ChainRunnersAddress = 0x97597002980134beA46250Aa0510C9B90d87A587;
        ...
        ownTokensCount = ownTokensCount + RektCats.balanceOf(_owner);
        ownTokensCount = ownTokensCount + Nouns.balanceOf(_owner);
        ownTokensCount = ownTokensCount + Cryptoadz.balanceOf(_owner);
        ownTokensCount = ownTokensCount + Blitmap.balanceOf(_owner);
        ownTokensCount = ownTokensCount + ChainRunners.balanceOf(_owner);
        return ownTokensCount;
    }
    ...
    function presaleMintNFTL(uint numberOfTokens) public payable {
        ...
        ERC721Contract Blitmap = ERC721Contract(BlitmapAddress);
        ERC721Contract ChainRunners = ERC721Contract(ChainRunnersAddress);
        ownTokensCount = ownTokensCount + RektCats.balanceOf(msg.sender);
        ownTokensCount = ownTokensCount + Nouns.balanceOf(msg.sender);
        ownTokensCount = ownTokensCount + Cryptoadz.balanceOf(msg.sender);
        ownTokensCount = ownTokensCount + Blitmap.balanceOf(msg.sender);
        ownTokensCount = ownTokensCount + ChainRunners.balanceOf(msg.sender);

        require(ownTokensCount > 1, "Must own one token of 'UMA' ,'Rekt Cats', 'Nouns', Cryptoadz', Blitmap', or 'Chain Runners'");
