...
contract Slash is ERC721, ERC721Royalty, Pausable, Ownable {
    ...
    //uint256 public constant minMintPrice  = 0.001 ether;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://slash.sg/testnets/api/nft/commodity/v1/query/8/";
        //return "http://api-test.slash.sg:8088/api/nft/commodity/v1/query/8/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://slash.sg/slashsg/nft/collection-8";
    }
    ...
    function setDefaultMintPrice(uint256 price) public onlyOwner {
        //require(price >= minMintPrice, "mint value must greater than 1 finney");
    ...
    function publicMint(address to, uint256 tokenId) public payable callerIsUser {
         ...
         */
        // check the price
        //require(msg.value >= minMintPrice, "mint value must greater than 1 finney");
        // public mint must after the token being published
        ...
        if (msg.value < cost) {
            revert(
                "mint price is not enough"
                // string.concat(
                //         name(),
                //         ": mint price for token ",
                //         Strings.toString(tokenId),
                //         " is ",
                //         Strings.toString(cost / 1 gwei),
                //         " gwei"
                // )
            );
        }
