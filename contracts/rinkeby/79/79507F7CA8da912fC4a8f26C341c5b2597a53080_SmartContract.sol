...
// New6 set cooldown to zero 
//set addliquidty from dead to owner
//next create min and max transaction and burn in tax
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500000000000000 * 10**_decimals; //500T
    uint256 public maxTxAmount = 500000000000000 * 10**_decimals; //500T
    uint256 public maxWalletSize = 1000000000000000 * 10**9; //1Q
    ...
    bool public coolDownEnabled = false; // false to trh
    uint256 public coolDownTime =  0 seconds; // 69 to 0e
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; 

    string private constant _name = "New8";
    string private constant _symbol = "New8";
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (lpPairs[to]) { 
            bool canSwap = balanceOf(address(this)) >= swapTokensAtAmount; //tax 12 percent >= 10000
