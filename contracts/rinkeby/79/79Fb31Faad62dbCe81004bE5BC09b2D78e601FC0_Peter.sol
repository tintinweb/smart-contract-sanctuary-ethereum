...
contract Peter is ERC721A, Ownable, ReentrancyGuard {
    // Immutable Values
    uint256 public immutable MAX_SUPPLY = 2000;
    uint256 public OWNER_MINT_MAX_SUPPLY = 5;
    uint256 public AIRDROP_MAX_SUPPLY = 100;
    uint256 public WHITELIST_MAX_SUPPLY = 100;
    ...
    function mintWithETH() external payable nonReentrant {
        ...
        require(quantity <= maxMintLimit, 'The number of quantity is not between the allowed nft mint range.');
        ...
        nonReentrant
    {
        ...
        require(amount <= maxMintLimit, 'The number of quantity is not between the allowed nft mint range.');
