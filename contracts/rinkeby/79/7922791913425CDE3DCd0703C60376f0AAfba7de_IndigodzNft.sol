    ...
    Ownable
{
    ...
    event Reveal(uint[] _tokenIds, string[] _hashes);
     ...
     * @param list of _tokenIds as uint[]
     * @param list of _hashes as string[]
     */
    function reveal(uint[] calldata _tokenIds, string[] calldata _hashes) public onlyRole(REVEAL_ROLE) {
