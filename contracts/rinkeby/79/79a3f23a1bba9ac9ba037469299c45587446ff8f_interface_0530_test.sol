...
//metadata
   ...
   //function _inMint(address _sender,metadataLib.LayerInfo memory _imageInfo)public allowedInterfaceContract returns(bool){
    ...
    {
        //emit transactionReceived(string(abi.encodePacked("received","|",_Layer1)));
...
//metadata
    ...
    m_0530 mainContract = m_0530(0xadB962Ef59B9b9672882ceEa25b6Cd3a29d234D0);
    ...
    function sendMint(string memory _layerInfo,string memory _onlyLayerInfo)public payable returns(string memory){
      ...
      //  require(missList[_msgSender()] < 1,"miss");
        ...
        }
        {
            ...
            return mainContract._inMint(msg.sender,imageInfo.Layer1,imageInfo.Layer2,imageInfo.Layer3,imageInfo.Layer4,imageInfo.Layer5,imageInfo.Layer6,imageInfo.Layer7,imageInfo.Layer8,imageInfo.Image) ;
        }
    }
