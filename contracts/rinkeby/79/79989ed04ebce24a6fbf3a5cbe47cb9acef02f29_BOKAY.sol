...
contract BOKAY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "BOKAY";
    string private constant _symbol = "BOKAY";
    uint8 private constant _decimals = 9;
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    uint256 private constant _tTotal = 1000 * 1e12 * 1e9;

    uint256 public _maxWalletAmount = 30 * 1e12 * 1e9;
    ...
    address payable private deploymentWallet = payable(0x393B72546149585DE40CCb07e8f50F2DfB966584);
