...
import "./BreederDaoTokenLock.sol";
import "../interfaces/IBreederDaoTokenLockManager.sol";

/**
 * @title BreederDaoTokenWallet
 * @notice This contract is built on top of the base BreederDaoToken functionality.
 ...
 * The function calls allowed are queried to the BreederDaoTokenManager, this way
 ...
 */
contract BreederDaoTokenLockWallet is BreederDaoTokenLock {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    // -- State --

    IBreederDaoTokenLockManager public manager;
    ...
    function _setManager(address _newManager) private {
        ...
        manager = IBreederDaoTokenLockManager(_newManager);
    ...
    {
        if (revocable == Revocability.Disabled) {
            return super.releasableAmountByTimestamp(timestamp);
        }
