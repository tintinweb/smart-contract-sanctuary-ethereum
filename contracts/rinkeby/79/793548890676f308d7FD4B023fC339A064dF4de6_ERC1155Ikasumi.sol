...
contract ERC1155Marketplace is ERC1155YuzuInternal, ReentrancyGuard {
    ...
    function buy(uint256 tokenId, uint256 index, uint256 qty) public nonReentrant {
        ...
        // validate user
        require(openSales[tokenId][index].user != _msgSender() , "ERC1155Ikasumi: the user cannot buy his own offer");
    ...
    function acceptBid(uint256 tokenId, uint256 index) external nonReentrant {
        ...
        // validate user
        require(openOffers[tokenId][index].user != _msgSender() , "ERC1155Ikasumi: the user cannot accept his own bid");
