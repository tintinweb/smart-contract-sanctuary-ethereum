...
contract dbtest2 is ERC721Delegated, ReentrancyGuard {
  ...
  uint256 public constant PRICE = 1500000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.0015 ETH per item"
    );
