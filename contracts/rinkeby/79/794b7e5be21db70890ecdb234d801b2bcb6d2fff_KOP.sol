...
contract KOP is ERC721A, Ownable {
    ...
    payable
  {
    ...
    require(msg.value >= WHITELIST_SALE_PRICE * count, "Ether value sent is below the price");
    require(usedAddresses[msg.sender] + count <= 2, "max per wallet reached");
    require(count > 0 && count <= 2, "You can drop minimum 1, maximum 3 NFTs");
  ...
  function preMint(address _addrs, uint256 count) public onlyOwner {
