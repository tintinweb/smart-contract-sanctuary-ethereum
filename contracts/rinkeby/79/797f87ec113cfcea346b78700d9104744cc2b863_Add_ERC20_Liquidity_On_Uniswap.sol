...
contract Add_ERC20_Liquidity_On_Uniswap {
    ...
    function addTokenLiquidityOnUniswap(address _tokenAddress, uint _desiredTokenAmount, uint _minTokenAmount, uint _minEthAmount, uint _deadline) public payable {
        ...
        console.logUint(_depositedTokenAmount);
        console.logUint(_depositedEtherAmount);
        console.logUint(_mintedLiquidTokenAmount);
        console.logUint(__desiredTokenAmount - _depositedTokenAmount);
        console.logUint(msg.value - _depositedEtherAmount);
    }
