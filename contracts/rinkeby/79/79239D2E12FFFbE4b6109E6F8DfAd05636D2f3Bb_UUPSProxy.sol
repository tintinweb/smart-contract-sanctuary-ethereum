...
`7MM"""YMM  db      `7MMM.     ,MMF'`7MMF'`7MMF'   `YMM'   `MM'    
  MM    `7 ;MM:       MMMb    dPMM    MM    MM       VMA   ,V      
  MM   d  ,V^MM.      M YM   ,M MM    MM    MM        VMA ,V       
  MM""MM ,M  `MM      M  Mb  M' MM    MM    MM         VMMP        
  MM   Y AbmmmqMA     M  YM.P'  MM    MM    MM      ,   MM         
  MM    A'     VML    M  `YM'   MM    MM    MM     ,M   MM         
.JMML..AMA.   .AMMA..JML. `'  .JMML..JMML..JMMmmmmMMM .JMML.       
