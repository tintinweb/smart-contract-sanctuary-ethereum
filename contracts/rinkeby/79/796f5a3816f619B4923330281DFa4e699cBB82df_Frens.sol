...
contract Frens is ERC721BaseTokenURI {
    ...
    uint256 public currentScholarshipMint;
    uint256 public currentReferredMint;
    ...
    function addToMaxMints(uint256 scholarshipMax, uint256 referralMax) external onlyOwner {
        maxScholarshipMint += scholarshipMax;
        maxReferredMint += referralMax;
    }
