...
// File: contracts/KENJISREVENGE.sol
...
contract KENJISREVENGE is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmU9AkRcnvWQVoV1TopGT4VeqoKCHE4oHoj3jk9gDLiSox/";
  uint256  public  maxSupply = 1800;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  NUM_FREE_MINTS = 1800;
  ...
  ) ERC721A("KENJISREVENGE", "KNJISRVNG") {
