...
//  You can contact him with this email. [email protected]
//  Slack Channel Invitation: https://join.slack.com/t/jn-co-workspace/shared_invite/zt-14gkogczp-DHdQgU7ocVIJRBJl0mTFoA
//
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  string public baseURI = "https://gateway.pinata.cloud/ipfs/QmZAERvJqK5aZhbEonDedGsF7RLno7xWtZr1QCJi5eksYP/";
  string public baseExtension = ".json";

  bool public paused = false;

  uint256 public maxSupply = 60;
  uint256 public whiteListSupply = 20;
  ...
  function mint(address _to, uint _mintCount) public payable {
    ...
    require(supply + 1 <= maxSupply, "MaxSupply is limited.");
    require(msg.value >= mintPrice * _mintCount, "Not enough fees to mint.");
    require(balanceOf(_to) < 1, "You can mint only 1 NFT");

    if (msg.sender != owner()) {
      if(whitelisted[msg.sender] != true) {
        whitelistMinted ++;
      } else {
        require( maxSupply - supply > whiteListSupply - whitelistMinted, "Now only whitelisted user can mint NFT." );
      }
    }
