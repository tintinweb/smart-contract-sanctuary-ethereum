...
contract NFTPicker is ERC721Enumerable, Ownable{
    ...
    // Card URI
    string private cardUri = "http://myquickdesign.com/cityheighst/0.json";
    ...
    constructor(
        ...
        _prices = [0.05 ether, 0.09 ether, 0.25 ether, 0.5 ether, 0.9 ether];
    ...
    {
        return
            string(abi.encodePacked(_baseTokenUri, Strings.toString(_tokenId), _extension));
    }
