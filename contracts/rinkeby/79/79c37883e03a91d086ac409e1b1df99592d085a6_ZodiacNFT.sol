...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
  ...
  uint256 private totalTokenAssets = 9996;
	uint256 private totalReserve = 100;
 ...
 */
contract ZodiacNFT is ERC1155Tradable {
  constructor(string memory _name)
  ERC1155Tradable(
    _name,
    _name
  ) public {
    _setBaseMetadataURI("https://api.zodiacnft.vip/nft/");
  }
