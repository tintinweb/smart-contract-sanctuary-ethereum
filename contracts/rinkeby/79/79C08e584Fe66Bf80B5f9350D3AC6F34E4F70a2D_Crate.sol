...
/////////////////////////////
    ...
    // bool[] emptyTube; //bool of each tube. Is the tube currently empty?
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    //  uint256 machineMode = 0;  //0 is fixed-percentage. 1 is finite box
    //  select 1 of 2 modes upon creation for empty slot behavior
    //  fixed-percentage  -   if empty slots, could give back nothing. Infinite capsules for purchase
    //  finite box        -   1-to-1 capsule to inventory
    /////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override  {
        ...
        if (lastSlot == q[addyArray[slotWinner] ].length - 1){ //if it's still the same untouched value the tube must be empty
