...
// File: contracts/MUTANTHAPRPRIME.sol
...
contract MUTANTHAPEPRIME is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    using MerkleProof for bytes32[];
    using Strings for uint256;

    bool public isMintable = true;
    uint256 public _mintPrice = 150000000000000000; // 0.63 ether
    ...
    constructor() ERC721("MINT MHP", "MHP") {}
    ...
    function mint(bytes32[] memory proof) external payable {
        ...
        require(
            isMintable == true,
            "MHP NFT is not mintable at the moment!"
        );
        require(
