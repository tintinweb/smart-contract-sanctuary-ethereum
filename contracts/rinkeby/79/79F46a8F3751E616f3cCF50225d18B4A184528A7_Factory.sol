...
contract Factory {
    ...
    constructor(ITreasury _treasury, address _market, address nft) {
        treasury = _treasury;
        market = _market;
        collection[nft] = true;
    }
    ...
    function createCollection(string memory name, string memory symbol) external {
        ...
        collection[address(nft)] = true;
        emit ContractCreated(address(nft), msg.sender, 721, name, symbol);
    }

    function isCollection(address col) public view returns(bool) {
...
contract Factory721 is ERC721URIStorage {
    ...
    constructor(
        ...
        market = NFTMarket(marketplaceAddress);
        owner = _owner;
    }
