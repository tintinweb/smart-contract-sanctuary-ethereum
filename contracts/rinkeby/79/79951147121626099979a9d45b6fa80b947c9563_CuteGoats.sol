...
contract CuteGoats is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Cute Goats", "CUTEGOATS"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on goat");
    require(totalSupply() + amount < maxSupply + 1,"No more goats");
