...
contract MetaKozo is ERC721A, Pausable {
    // Address information
    address private owner;
    address private team = 0x2253C0DAaEf01465fC0EC67CF8FCb72b77650b27;

    // Collection sale information
    uint256 public collectionSize = 1500;
    uint8 public maxPerTX = 5;

    uint64 public preCost = 0.01 ether;
    uint256 public preMaxPerAddress = 3;
    bool public presale = true;

    uint64 public publicCost = 0.02 ether;
    bool public publicsale = true;

    // Salestart time (imestamp second) 2020/01/01 00:00:00 UTC
    uint256 preSaleStartTime = 1577804880; 
    uint256 publicSaleStartTime = 1577804880; 
    ...
    string private notRevealedUri = 'https://gateway.pinata.cloud/ipfs/QmTKhdVeutzpQp6kpM8cKYmJt1BL4UqLaGzFNaEXCRuE39';
    ...
    function setPreSaleStartTime(uint256 preSaleStartTime_) external onlyOwner {
    ...
    function publicMint(uint256 quantity) public payable callerIsUser {
        ...
        require(block.timestamp >= publicSaleStartTime,"Sale has not started yet");
    ...
    // Pre Mint
    function preMint(uint256 _quantity, uint8 _wlCount, bytes32[] calldata _merkleProof) public payable callerIsUser {
        ...
        require(
            whiteListClaimed[msg.sender] + _quantity <= _wlCount * preMaxPerAddress,
            "Already claimed max"
        );
