    ...
    Ownable
{
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Lockout #', Strings.toString(tokenId), '", "description": "LOCKOUT", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
