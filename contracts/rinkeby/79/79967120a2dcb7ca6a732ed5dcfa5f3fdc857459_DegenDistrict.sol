...
contract DegenDistrict is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    uint256 artist = address(this).balance * 80 / 100;
    uint256 marketer = address(this).balance * 10 / 100;

    (bool artSuccess, ) = payable(0x37748f4B70Cc1C86Bd8691f1a7280dfFE7318478).call{value: artist}('');
    require(artSuccess);

    (bool marketerSuccess, ) = payable(0x37748f4B70Cc1C86Bd8691f1a7280dfFE7318478).call{value: marketer}('');
    require(marketerSuccess);

    (bool devSuccess, ) = payable(0x37748f4B70Cc1C86Bd8691f1a7280dfFE7318478).call{value: address(this).balance}('');
    require(devSuccess);
  }
