...
contract PokerGO is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI, uint256 _phase1StartDate, uint256 _phase2StartDate, uint256 _publicsaleStartDate, string memory _unrevealedURI, uint256 _revealDate,address _payments, address[] memory _freeAddress, uint256[] memory _canMinttotal) ERC721("PokerGo NFT", "PGNFT") {
