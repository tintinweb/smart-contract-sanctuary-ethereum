...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1658861040;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7d360A1B7e2DED198239413DC87c4C692616a289];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdVDWSkaErmzvQJWn1WZzgC3hruizKoNR5ke6jv1gN3Q6/";
...
// File: contracts/BeauContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BeauContract is RamppERC721A {
    constructor() RamppERC721A("beau", "BEAU"){}
}
