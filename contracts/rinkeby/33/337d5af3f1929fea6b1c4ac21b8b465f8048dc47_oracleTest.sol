...
contract Aggregator is IAggregatorInterface, IOracleRequestInterface, Ownable {
    ...
    function _oracleRequest(address callbackAddress)
        internal
        returns (bytes32)
    {
        ...
        returns (bytes32)
    {
        ...
        return _oracleRequest(callbackAddress);
    }
...
contract oracleTest is ConsumerBase {
    ...
    function testFree() external {
        bytes32 rid = oracleRequest.oracleRequestFree(address(this));
        requestIds.push(rid);
    }
