...
contract AlienBees is ERC721, Ownable, ReentrancyGuard, RandomlyAssigned{
    ...
    mapping(address => bool) public HivePalsWhiteListedAddresses;
    ...
    constructor(
        ...
        for(uint32 HpwalletLoop =0; HpwalletLoop < _HivePalsHolders.length; HpwalletLoop++){
            HivePalsWhiteListedAddresses[_HivePalsHolders[HpwalletLoop]] = true;
        }
    }
    ...
    function mintBee(uint256 quantity) public payable {
        ...
        require(publicSale == true || (HPSale == true && HivePalsWhiteListedAddresses[msg.sender] == true) || (whiteListSale == true && whiteListedWallets[msg.sender] == true)
                , "Minting is not live.");
        ...
        totalMintLimit += (HivePalsWhiteListedAddresses[msg.sender] == true && HPSale == true) ?  HPLimit: 0;
    ...
    function freeMint(address[] memory walletAddresses) public onlyOwner {
        ...
        for (uint256 i = 0; i < walletAddresses.length; i++) {
            ...
            //mintedTokensByAddress[walletAddresses[i]] += 1;
        }
    }
