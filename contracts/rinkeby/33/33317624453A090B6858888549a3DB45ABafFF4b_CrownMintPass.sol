...
contract CrownMintPass is ERC721, Ownable {
    ...
    // TODO: set back to private before deploy
    string public _validURI; // initially set at deploy
    // TODO: set back to private before deploy
    string public _usedURI; // initially set at deploy
    // TODO: set back to private before deploy
    string public _expiredURI; // initially set at deploy
    ...
    /**
     * @dev Returns the amount of time (sec) until the pass is exired
     */
    ...
    {
        require(_exists(tokenId), "Nonexistent token");
        if (expiration - secondsSinceMint(tokenId) < 0) {
     ...
     */
    function resetTokens(uint256[] memory _tokenIds) public onlyOwner {
