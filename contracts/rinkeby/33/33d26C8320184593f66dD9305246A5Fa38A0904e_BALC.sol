...
contract BALC is ERC721A, Ownable {
    ...
    bytes32 private _merkleRoot = 0x13059c0721d177c45b673133fa5d6d2bd26d93438bb459c47bc46bc5b19db680;
    ...
    function mint(uint256 _quantity) external callerIsUser payable  {
        ...
        require(totalSupply() + _quantity <= 3333, "Exceed supply");
    ...
    function reversemint(address[] memory _reversemintaddress,uint256[] memory _quantity) external payable onlyOwner {
        require(publicMintStatus==EPublicMintStatus.PUBLIC_MINT, "Reversemint sale closed");
        for (uint256 i=0;i<_reversemintaddress.length;i++){
            require(totalSupply() +_quantity[i] <= 3333 , "Exceed supply");
