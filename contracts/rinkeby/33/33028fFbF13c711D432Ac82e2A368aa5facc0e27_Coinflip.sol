...
contract Coinflip is VRFConsumerBaseV2 {
     ...
     *
     * @param flipper address of the flipper
     */
    function flipCoin(address flipper, uint _guess) public payable returns (uint256 requestId) {
        require(results[flipper] != 42, 'Flip in progress.');
        ...
        flippers[requestId] = flipper;
        guess[flipper] = _guess;
        staked[flipper] = msg.value;
        results[flipper] = FLIP_IN_PROGRESS;
