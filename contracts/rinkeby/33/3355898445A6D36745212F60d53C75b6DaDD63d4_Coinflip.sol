...
contract Coinflip is VRFConsumerBaseV2, Ownable {
     ...
     * @param vrfCoordinatorAddress address of the vrf coordinator
     * @param keyHash the key hash to use for this consumer
     * @param gasLimit the gas limit to use for the callback
