...
contract CodStomach is Ownable, ERC721A, ReentrancyGuard{
    ...
    string public CONTRACT_URI =
        "ipfs://QmSdGfXoDGeFP8bDrYz5PopzshYeWhvW81Y6CJ6DVkDnm3";   //should link to the contract.json file //TODO: upload to ipfs and update then update this row

    //Token to token price data
    mapping(address => bool) public userToHasMinted;

    bool public REVEALED;
    string public UNREVEALED_URI = "ipfs://QmcGaP4PVJPBGTRBNu56gzUNpfcJvZNtbWoY93cR5HQ42i";  //TODO: set this
