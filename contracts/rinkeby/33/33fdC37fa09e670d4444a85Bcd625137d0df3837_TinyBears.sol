...
contract TinyBears is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 private nextTokenId = 0;
    uint256 private maxAmount = 0;
    ...
    function mint(uint8 numTokens) external payable {
        require(balanceOf(msg.sender) + numTokens <= MAX_OWNERSHIP, "TinyDoge: Max mint per wallet amount reached");
        require(
            nextTokenId + numTokens <= maxAmount,
            "TinyDoge: Mint exceeds supply for this network"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "tiny bears: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "tiny bears: Failed to withdraw funds");
    }
