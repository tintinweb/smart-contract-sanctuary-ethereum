...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost1 = 0.000000000000000005 ether; //Precio por unidad al comprar 1 o más de 3
  uint256 public cost2 = 0.000000000000000004 ether; //Precio por unidad al comprar 2
  uint256 public cost3 = 0.000000000000000003 ether; //Precio por unidad al comprar 3
  uint256 public maxSupply = 20; // Tokens totales de la colección
  uint256 public maxMintAmount = 20; // Máxima cantidad máxima mints por usuario
...
//------------------------------------------------------------------------------------------
    ...
    */
    ...
    // Setear estado de wallet en white list (True: habilitado; False: Deshabilitado )
  ...
  function WhiteListMint(uint256 _mintAmount) public payable {
    ...
    require(PorConsumirWL + supply + _mintAmount <= maxSupply, "Purchase would exceed max supply of Drinks"); //añadir aquí los pendientes por canjear del whiteList
        ...
        {  
            ...
            require(balanceOf(msg.sender)+_mintAmount<=maxMintAmount , "Max: 20 mints each wallet"); //Nos aseguramos que no puedan tener más de 9 mints
