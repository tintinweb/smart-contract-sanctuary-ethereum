...
///@dev Using counters for Token IDs for the Mystery box NFTs.
 ...
 Counters.Counter private _tokenIds;
    ...
    constructor (IWitnetRandomness _witnetRandomness) ERC721("Thunder Mystery box", "MYSTERY") {
        owner = msg.sender;
    ...
    function mintMysteryBox() external {
        ...
        Users[msg.sender].userRandomness = witnet.random(4, 0, Users[msg.sender].blockNumber);
        Users[msg.sender].canRequestBox = false;

        if (Users[msg.sender].userRandomness == 0) {
            _tokenIds.increment();
             uint256 newItemId = _tokenIds.current();
            _mint(msg.sender, newItemId);
            _setTokenURI(newItemId, commonBoxUri);
            
        } else if (Users[msg.sender].userRandomness == 1) {
            _tokenIds.increment();
             uint256 newItemId = _tokenIds.current();
            _mint(msg.sender, newItemId);
        ...
        else if (Users[msg.sender].userRandomness == 2) {
            _tokenIds.increment();
             uint256 newItemId = _tokenIds.current();
            _mint(msg.sender, newItemId);
        ...
        else if (Users[msg.sender].userRandomness == 3) {
            _tokenIds.increment();
             uint256 newItemId = _tokenIds.current();
