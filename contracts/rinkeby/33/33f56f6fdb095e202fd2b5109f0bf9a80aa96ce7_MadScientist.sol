...
contract MadScientist is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool mr, ) = payable(0x29bF68E3969E0b6686ea55B7C48241ba3f6B9bA0).call{value: address(this).balance * 21 / 100}("");
    require(mr);
    (bool lpr, ) = payable(owner()).call{value: address(this).balance}("");
    require(lpr);
  }
}