...
/**
 * Plan
 * - Mint token ID 1 (directly on core).
 * - Every bidder except for winner will get a token.
 * - Bidder receives token _after_ following bid.
 * - 2nd place bidder gets _special_ toen.
 */
