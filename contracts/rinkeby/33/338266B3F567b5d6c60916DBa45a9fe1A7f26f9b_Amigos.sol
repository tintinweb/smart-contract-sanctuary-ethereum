...
contract Amigos is ERC721A, Ownable {
  ...
  constructor() ERC721A("Fifty Five Amigos", "AMG") {}
  ...
  function withdrawAll() external onlyOwner {
    ...
    _withdraw(mintPayees[1], (contractBalance * 30) / 100);
    _withdraw(mintPayees[2], (contractBalance * 15) / 100);
