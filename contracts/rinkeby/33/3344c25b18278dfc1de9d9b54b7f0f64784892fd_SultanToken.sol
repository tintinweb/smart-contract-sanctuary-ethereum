...
// Root file: contracts/Sultan.sol
...
contract SultanToken is Ownable, IERC20 {
    ...
    modifier validLockTime(address sender, address recipient) {
        if (
            lockedTimeBetweenSwap != 0 && sender == pair && recipient != owner()
        ) {
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal virtual validLockTime(sender, recipient) {
