    ...
    IMintable
{
    ...
    constructor(
        ...
        _grantRole(ADMIN_ROLE, _developer);
    }
    ...
    function mint(
        ...
        uint256 tokenId,
        uint256 amount
    ) public nonReentrant onlyMinter {
        require(tokenId == _tokenIds[tokenId - 1], "Invalid token id");
        uint256 tokenSupply = totalSupply(_tokenIds[tokenId - 1]);
        uint256 tokenMax = _tokenIdMaxTier[tokenId - 1];
