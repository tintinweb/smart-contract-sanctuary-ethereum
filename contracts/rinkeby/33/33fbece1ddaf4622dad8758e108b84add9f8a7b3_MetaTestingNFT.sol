...
contract MetaTestingNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxSupply = 1125;
    uint256 public maxMintAmount = 5;
    uint256 public maxKnightsInWallet = 5;
    uint256 public maxWhitelistKnightsInWallet = 5;
    ...
    function setPublicPrice(uint256 _whitelistPrice) public onlyOwner {
    ...
    function add100Whitelists(address[100] memory _users) public onlyOwner {
