...
contract Contract is ERC721AQueryable, ERC721ABurnable, Ownable {
    // ============ State Variables ============
    ...
    constructor(string memory __name, string memory __symbol, string memory _hiddenMetadataURI, string memory baseTokenURI) ERC721A(__name, __symbol) {
        _name = __name;
        _symbol = __symbol;
