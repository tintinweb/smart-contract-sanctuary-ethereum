...
contract JFO is ERC721Enumerable, ERC2981, Ownable {
  ...
  constructor(
    ...
    string memory _initNotRevealedUri, /// ipfs://  FILE metadata
    string memory _contractURI, /// ipfs://  contractURI for opensea
