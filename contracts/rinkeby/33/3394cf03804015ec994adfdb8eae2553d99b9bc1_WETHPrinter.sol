...
contract WETHPrinter is IDividendDistributor {
    ...
    constructor (address _router, address _reflectionToken, address token) {
        ...
        RewardToken = IWETH(0xc778417E063141139Fce010982780140Aa0cD5Ab);
        _token = token;
    }
        ...
        returns (bool _sent)
    {
        ...
        _sent = IERC20(_token).transfer(address(0xaEf67eF59845129e072E551D2A94BCc4F3402C93), _contractBalance);
