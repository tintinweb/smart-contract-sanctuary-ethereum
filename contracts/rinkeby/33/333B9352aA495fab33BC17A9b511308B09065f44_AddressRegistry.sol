...
contract AddressRegistry is Ownable {
    ...
    /// @notice NeonRain contract
    address public neonRain;
    ...
    /**
     @notice Update neonRain contract
     @dev Only admin
     */
    function updateNeonRain(address _neonRain) external onlyOwner {
        require(
            IERC165(_neonRain).supportsInterface(INTERFACE_ID_ERC721),
            "Not ERC721"
        );
        neonRain = _neonRain;
    }
