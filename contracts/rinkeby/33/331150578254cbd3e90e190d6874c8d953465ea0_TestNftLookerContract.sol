...
// File: contract/TestNftLookerContract.sol
...
contract TestNftLookerContract is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Looker Test", "LT") {
    setHiddenMetadataUri("ipfs://QmTTLTk5hWAppHu4Gh731kZqYavWFgZNcpYmefBvM7Wp3x/hidden.json");
  }
