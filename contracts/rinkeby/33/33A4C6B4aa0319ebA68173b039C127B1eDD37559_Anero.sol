    ...
    */
        ...
        returns (string memory)
    {
        ...
        if (!reveal) {
            ...
            placeholder = string(abi.encodePacked(placeholder, '"name": "Aneroverse NFT #', tokenId.toString(), '", '));
            placeholder = string(abi.encodePacked(placeholder, '"description": "Aneroverse NFT", '));
            placeholder = string(abi.encodePacked(placeholder, '"image": "https://aneroverse.mypinata.cloud/ipfs/QmbAHGu1GezhMC3Y3h3mN5QaFt5wEMkAmwTCUocBBRDc3x", '));
            placeholder = string(abi.encodePacked(placeholder, '"external_url": "https://aneroverse.mypinata.cloud/ipfs/QmbAHGu1GezhMC3Y3h3mN5QaFt5wEMkAmwTCUocBBRDc3x", '));
            placeholder = string(abi.encodePacked(placeholder, '"edition": ', tokenId.toString(), ", "));
            placeholder = string(abi.encodePacked(placeholder, '"date": ', block.timestamp.toString(), ","));
            placeholder = string(abi.encodePacked(placeholder, '"animation_url": "https://aneroverse.mypinata.cloud/ipfs/QmTfLMy6g1xK3MNbBsVREFcDw5xBw3vKgeGf9SZKnmML9A", '));
            placeholder = string(abi.encodePacked(placeholder, '"attributes": []'));

            placeholder = string(abi.encodePacked(placeholder, "}"));
            return placeholder;
        }
