...
contract ERC20Token is Context, IERC20 {
    ...
    uint256 public MaxToken = 6000000000000000000000000;
    string public _name = "Beture";
    string public _symbol = "BET";
    uint8 public _decimals = 18;

    address private _owner;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);

    address public teamWallet = 0x29cFcef3697e633Fb8A29f2EA1B4BF29125aD0A1;
    ...
    */
    ...
    function setDecimal(uint8 decimal) public onlyOwner {
        _decimals = decimal;
    }

    function setMaxToken(uint256 amount) public onlyOwner {
        MaxToken = amount;
    }
