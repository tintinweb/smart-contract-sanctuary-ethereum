...
contract Token is protected, smart, ERC20 {

    string public constant _name = 'NAME';
    string public constant _symbol = 'TICKER';
...
contract Launchpad is protected{
    ...
    function create_token() public payable returns(address) {
        Token token = new Token();
        return token.get_address();
    }
