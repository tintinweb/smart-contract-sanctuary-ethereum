...
contract DEX {
     ...
     */
    event EthToTokenSwap(address to, string message, uint ethsent, uint256 tokenoutput);
    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(address to, string message, uint256 ethoutput, uint256 tokeninput);
    /**
     ...
     */
    event LiquidityRemoved(address to, uint256 liquidityamount, uint256 ethwithdrawn, uint256 tokenamount);
    /* ========== CONSTRUCTOR ========== */
