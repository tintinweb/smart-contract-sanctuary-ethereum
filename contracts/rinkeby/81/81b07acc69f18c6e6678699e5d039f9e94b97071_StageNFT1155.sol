...
contract StageNFT1155 is ERC1155, ERC1155Burnable, StageNFTErc20 ,StageNFT1155Auction { 
    ...
    */
    ...
    function mintLazyMintedNfts (address to, uint tokenID, uint numOfCopies, bytes memory data, string memory tokenURI, uint NftPrice, address payable MinterAddress, uint RoyaltyValueOfMinter) contractIsNotPaused external payable{
        // require(IsPaused == false, "Contract is Paused");
