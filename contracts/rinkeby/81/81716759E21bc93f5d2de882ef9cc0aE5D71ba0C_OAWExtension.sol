...
/**
 * Outside a Window by Andrew Mitchell Contract Extension
 * Uses the Manifold ERC721 Edition Controller Implementation
 */
contract OAWExtension is CreatorExtension, ICreatorExtensionTokenURI, IManifoldERC721Edition, ReentrancyGuard {
    ...
    /**
     * Get price of a series
     */
    function getPrice(address creator, uint256 series, uint256 price) external creatorAdminRequired(creator) {
        require(series > 0 && series <= _currentSeries[creator], "Invalid series");
        _price[creator][series] = price;
    }
     ...
     */
    function mint(address creator, uint256 series, address recipient, uint16 count) external payable override nonReentrant {
