...
//         .__                  __                       
//  ______ |__| ______ ______ _/  |_  ______  _  ______  
//  \____ \|  |/  ___//  ___/ \   __\/  _ \ \/ \/ /    \ 
//  |  |_> >  |\___ \ \___ \   |  | (  <_> )     /   |  \
//  |   __/|__/____  >____  >  |__|  \____/ \/\_/|___|  /
//  |__|           \/     \/                          \/ 
//                                                       
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/contracts/security/Pausable.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/contracts/token/ERC721/extensions/IERC721Enumerable.sol
...
// File: contracts/common/ERC721A.sol
...
contract Pisstown is ERC721A, Ownable, Pausable {
    uint256 public mintPrice = 0.0 ether;
    uint256 public constant maxMints = 5555;

    string public baseURI = "ipfs://QmeecGGDnbxHCsMk4SzsqcRB31mj6NbrW2MjAcJNzpE7cB/";

    constructor() ERC721A("Pisstown", "PTOWN", 2) {
        
    }

    function mint(uint256 count) public payable whenNotPaused {
        require(mintPrice <= msg.value, 'LOW_ETHER');
        unchecked { require(totalSupply() + count <= maxMints, 'MAX_REACHED'); }
        _safeMint(msg.sender, count);
    }

    function mintTo(address addr, uint256 count) public onlyOwner {
        unchecked { require(totalSupply() + count <= maxMints, 'MAX_REACHED'); }
        _safeMint(addr, count);
    }
