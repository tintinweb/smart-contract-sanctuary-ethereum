...
contract erc721atestlol is ERC721A, Ownable, ReentrancyGuard  //You can change the contract title to whatever you want it's just currently set as "NFTAcademy" in this example
{
    //using Strings for string;

    uint public constant MAX_TOKENS = 2222; //This is your total supply limit
    uint public PRESALE_LIMIT = 777; //This is your limit for the presale or whitelist
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 50; //This is your reserved supply that can be used for marketing etc.
    uint256 public PRICE = 0.0044 ether; //50000000000000000 //This is the price per token
    uint public perAddressLimit = 30; //Max per wallet address limit for presale
    ...
    address payable private devguy = payable(0x5b6c4b16463d47cAF0849dcb18223bD8C9AF352c); //Payment Splitter (MORE DETAILS ON THE PAYMENT SPLITTER PROVIDED BELOW)

    constructor() ERC721A("erc721atestlol", "721ATEST") {} //Name of Project and Token "Ticker"
    ...
    function withdraw() external nonReentrant
    {
        ...
        (bool success, ) = devguy.call{value: address(this).balance / 100 * 1}(""); //This is currently set to pay 1% of sales from your mint to support the NFT Academy, but can be adjusted or replaced with another wallet (Explainer: Out of the Total [100%] Contract Balance... 1% of the balance will be sent to NFTacademy wallet address on line 54)
