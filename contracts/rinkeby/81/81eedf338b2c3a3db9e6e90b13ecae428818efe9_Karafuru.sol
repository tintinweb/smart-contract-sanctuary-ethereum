    ...
    Withdrawable
{
    ...
    uint256 public constant AIRDROP_MAX_QTY = 100;
    uint256 public constant PRESALES_MAX_QTY = 3500;
    uint256 public constant SALES_MAX_QTY = TOTAL_MAX_QTY - AIRDROP_MAX_QTY;
    ...
    function AirDrop(address[] calldata receivers) external onlyOwner {
        require(
            giftedQty + receivers.length <= AIRDROP_MAX_QTY,
