...
//ALL PROCEEDS GO DIRECTLY TO UKRAINE OFFICIAL ADDRESS
...
contract UkraineNFTContract is ERC721URIStorage {
    uint256 public tokenCounter; 
     
    uint256 public constant mnftPrice = 10000000000000000; //0.01 ETH per NFT
    uint256 public   maxMintAmount = 50; 

    //constructor for an ERC721 is a name and symbol
    constructor () public ERC721 ("UkraineNFT", "UKRAINE"){
        tokenCounter = 0;
    }

    //number of NFTs to create
    //a token url is a ipfs url of metadata file
    function createNFT(uint32 _numberOfNFTs, string memory tokenURI) public payable {

      require(msg.value >= mnftPrice * _numberOfNFTs , "insufficient funds for qty requested");
      require(_numberOfNFTs > 0, "need to mint at least 1 nft");
      require(_numberOfNFTs <= maxMintAmount, "you cant mint that many at once");
  ...
  /*
      anyone can invoke the withdraw function, balance of ETH goes directly to Ukraine
  */
