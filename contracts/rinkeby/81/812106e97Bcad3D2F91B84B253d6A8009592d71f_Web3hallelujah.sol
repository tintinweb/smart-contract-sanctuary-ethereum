...
contract Web3hallelujah is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public FreeSupply = 50000;
  uint256 public MaxperWallet = 4000;
  uint256 public MaxperWalletFree = 35;
  ...
  ) ERC721A("Web3 Hallelujah", "Hallelujah") {  // change the name and symbol for your collection
