...
// File: contracts/miniscapes.sol

//   __       __  ______  __    __  ______   ______    ______    ______   _______   ________ 
//  /  \     /  |/      |/  \  /  |/      | /      \  /      \  /      \ /       \ /        |
//  $$  \   /$$ |$$$$$$/ $$  \ $$ |$$$$$$/ /$$$$$$  |/$$$$$$  |/$$$$$$  |$$$$$$$  |$$$$$$$$/ 
//  $$$  \ /$$$ |  $$ |  $$$  \$$ |  $$ |  $$ \__$$/ $$ |  $$/ $$ |__$$ |$$ |__$$ |$$ |__    
//  $$$$  /$$$$ |  $$ |  $$$$  $$ |  $$ |  $$      \ $$ |      $$    $$ |$$    $$/ $$    |   
...
contract Miniscape is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 444;
    ...
    string public revealedURI = "ipfs://QmVbhgHpRmPx4Y2DvLGir1JgayajxZn3oMwkrajqowkKpX/";
    ...
    address constant internal DEV_ADDRESS = 0xC32335a716B2E0d9066BAE003a7b8f72e059e3D2;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Miniscape", "MINI") { }
    ...
    function FREE(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 111, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xC32335a716B2E0d9066BAE003a7b8f72e059e3D2");
