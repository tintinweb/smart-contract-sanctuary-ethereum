    ...
    ERC721Holder
{
    ...
    bytes32 public  OPENSEA_CONDUIT_KEY = 0x0000007b02230091a7ed01230072f7006a004d60a8d4e71d599b8104250f0000;
    ...
    function setConduitController(address _conduitControllerAddress) external onlyOwner {
    ...
    function seaportBuy(
        ...
        if(payToken!= address(0)){
            ...
            IERC20(payToken).safeTransferFrom(recipient,address(this),payAmount);

            (address conduit,bool hasConduit) = IConduitController(conduitControllerAddress).getConduit(OPENSEA_CONDUIT_KEY);
        ...
        _tranferNFT(tokenAddress, recipient, tokenId, amount);
