...
contract Beta is ERC721A, Ownable {
 ...
 //   address public proxyRegistryAddress =
   //     0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    ...
    string public baseUri = "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";

    constructor(address _proxyRegistryAddress) ERC721A("Beta", "Beta") 
    {
    ...
    // Pre Sale On/Off
    function setIsPresaleActive(bool value) public onlyOwner {
        isPresaleActive = value;
    }

    // Reduced Pre Sale On/Off
    //function setReducedPresaleActive(bool value) public onlyOwner {
    //    reducedPresaleActive = value;
    //}

    // Public Sale On/Off
    function setIsPublicSaleActive(bool value) public onlyOwner {
        isPublicActive = value;
    }
    ...
    function publicMint(uint256 amount) external payable {
        require(isPublicActive, "Public sale not live");
    ...
    function allowlistMint(uint256 amount, uint256 maxAmount) external payable {
        require(isPresaleActive, "Presale is not live");
