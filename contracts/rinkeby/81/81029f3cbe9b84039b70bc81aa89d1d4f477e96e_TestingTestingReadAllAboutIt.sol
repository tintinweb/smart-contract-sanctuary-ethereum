...
contract TestingTestingReadAllAboutIt is ERC721A, Ownable {

    constructor() ERC721A("TestingTestingReadAllAboutIt", "TTRABI") {}

    uint public maxSupply = 20;
    bool public saleStatus = false;
    uint public freeMaxSupply = 10;
    uint public price;   
    ...
    function mintFree(uint256 amount) external payable {
        ...
        require(currentIndex <= freeMaxSupply, "EXCEEDS_FREE_MINTS");
        _safeMint(msg.sender, amount);
