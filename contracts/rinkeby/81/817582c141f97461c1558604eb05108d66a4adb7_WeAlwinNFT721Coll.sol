    ...
    
{
    ...
    WeAlwinNFT721 public WeAlwinNFT721M;
    ...
    {   
        ...
        WeAlwinNFT721 _WeAlwinNFT721M = WeAlwinNFT721(originalContract);
        // set the rest of the contract variables
        WeAlwinNFT721M = _WeAlwinNFT721M;
    ...
    function getServiceFeeWA() public view returns (uint256) {
        return  WeAlwinNFT721M.getServiceFeeWA();
    }

    function getServiceFee() public view returns (uint256) {
        return  WeAlwinNFT721M.getServiceFee();
    }
    ...
    function newtokenasbid(
        ...
        uint256 serviceVal = WeAlwinNFT721M.getServiceFee();
        if(keccak256(bytes(tokenAss)) == keccak256(bytes("WA")))
        {
             serviceVal = WeAlwinNFT721M.getServiceFeeWA();
        }

        address payable admin =  payable(WeAlwinNFT721M.getOwner());
