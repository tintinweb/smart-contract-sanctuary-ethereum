...
contract MetaHeroes_Genesis is Ownable, ERC721A, ReentrancyGuard  {
    using Strings for uint256;
    string public uri;

    uint public status = 0;
    uint public MAX_PER_ADDRESS_PRESALE = 4;
    uint public MAX_PER_ADDRESS_PUBLICSALE = 10;
    uint public COLLECTION_SIZE = 3333;
    uint public PRICE_PRESALE = 0.085 ether;
    uint public PRICE_PUBLICSALE = 0.097 ether;
    ...
    constructor() ERC721A("Meta$Heroes Genesis", "Heroes") {
        uri = "https://bafkreic7cyisx3w7rwozgbptbxf43arvcoan57vycqqzl6wd6tq4gvavpu.ipfs.nftstorage.link/";
    }

    function presaleMint(uint256 quantity, bytes32[] calldata merkleproof) public payable callerIsUser{
    ...
    function setPRICE(uint presale, uint publicSale) public onlyOwner{
        PRICE_PRESALE = presale;
        PRICE_PUBLICSALE = publicSale;
    }
