...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x418D75f65a02b3D53B2418FB8E1fe493759c7605;
    IDEXRouter router;
...
contract Miraculous is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Miraculous Coin";
    string constant _symbol = "MRCS";
    ...
    uint256 public sellMultiplier  = 118;
