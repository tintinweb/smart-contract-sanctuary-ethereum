...
//JSON URL: https://jsonkeeper.com/b/KR67
//IMG URL: https://imgur.com/a/7WPm0EL
...
contract RandomWords is ERC721URIStorage {
    ...
    string[] thirdWords = ["Run", "Write", "Dead", "Jump", "Bounce", "Fly"];
    string[] colors = ["red", "#08C2A8", "black", "yellow", "blue", "green"];

    constructor() ERC721("Random Words", "RNDMWRDS") {
    ...
    event NewRandomWordMinted(address sender, uint256 tokenId);

    function NFTFactory() public {
        ...
        emit NewRandomWordMinted(msg.sender, newItemId);
    }
}
