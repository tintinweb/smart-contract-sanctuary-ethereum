...
contract Voting is ERC721URIStorage {
    struct Voter {
        uint8 vote;
        bool isVoted;
    ...
    modifier isVotingClosed() {
        require(votingState == VotingState.CLOSED, "The voting is ongoing!");
        _;
    }
    ...
    constructor() ERC721("VoteYourPresident", "VYP") {
    ...
    function votePresident(address presidentAddress, string memory tokenURI)
        public
        isVotingOngoing
    {
        ...
        returns (string memory presidentName)
    {
        ...
        presidentialCandidates[electedPresidentAddress].isCandidate = false;
        presidentialCandidates[electedPresidentAddress].isPresident = true;
    ...
    function resetVoting() public onlyAdministrator isPresidentElected {
        ...
        electedPresidentAddress = address(0);
        totalVotes = 0;
