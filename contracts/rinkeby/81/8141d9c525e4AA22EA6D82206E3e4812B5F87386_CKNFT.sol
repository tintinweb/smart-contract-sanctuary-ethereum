...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    uint256 public constant MAX_TOKEN_ID_PLUS_ONE = 3; // 3 tokens numbered 0, 1 and 2 inclusive
    ...
    constructor()
        ERC1155(
            "ipfs://QmXzmAjB6Dg4ycUpGmyontoZ3RB8FWc6xSnJZZ42FUeAMS/{id}.json"
        )
    {
        contractUri = "ipfs://QmRbNV3FixQgf21csUhj92ohGaV4jqRumingwbtirtU5rE"; // json contract metadata file for OpenSea

        tokenIdToMaxSupplyPlusOne[0] = 10000;
        tokenIdToMaxSupplyPlusOne[1] = 10000;
        tokenIdToMaxSupplyPlusOne[2] = 10000;
