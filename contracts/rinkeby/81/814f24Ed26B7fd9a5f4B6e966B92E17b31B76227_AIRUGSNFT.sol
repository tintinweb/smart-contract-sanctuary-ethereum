...
contract AIRUGSNFT is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Variables Start =======================
  ...
  uint256 public supplyLimitPremint = 1111; 
  uint256 public supplyLimit = 2222;
  uint256 public maxMintAmountPerTxPhase1 = 5;
  uint256 public maxMintAmountPerTxPhase2 = 1000;
  uint256 public maxLimitPerWallet = 2220;
...
// ================== Mint Functions Start =======================
   ...
   function UpdateCost(uint256 _mintAmount) internal view returns  (uint256 _cost) {
    ...
    if (balanceOf(msg.sender) + _mintAmount <= maxMintAmountPerTxPhase1 && totalSupply() < supplyLimitPremint) {
        return cost1;
    }
