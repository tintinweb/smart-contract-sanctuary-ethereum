 ...
 */
contract ETHRewards is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    address public constant WETH =
        address(0xc778417E063141139Fce010982780140Aa0cD5Ab); // reward token
    ...
    function getReward() public nonReentrant updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            require(success, "ETHRewards: Unable to transfer ETH");
    ...
    function setProtocolAddresses(address _ProtocolAddresses)
        external
        onlyOwner
    {
    ...
    modifier onlyProcessor() {
        address Processor = IProtocolAddresses(ProtocolAddresses)
            .HarvestProcessor();
