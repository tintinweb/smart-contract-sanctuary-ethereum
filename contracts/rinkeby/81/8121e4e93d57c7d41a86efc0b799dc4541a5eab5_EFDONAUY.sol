...
contract EFDONAUY is Ownable, ERC721A {
    ...
    function freeMint() external {
        ...
        require(totalSupply() + 1 <= FREE_SUPPLY, "Exceeds free supply");
        require(amountNFTsperWalletFreeMint[msg.sender] < maxFreeNFTPerWallet, "You can only get 1 NFT on the Whitelist Sale");
        amountNFTsperWalletFreeMint[msg.sender] +=  1;
