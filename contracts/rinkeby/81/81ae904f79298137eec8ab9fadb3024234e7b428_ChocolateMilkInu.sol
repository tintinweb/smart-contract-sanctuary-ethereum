...
contract ChocolateMilkInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9Af4bF185adc777422a68CD8b634c17989Aa9901); // Marketing Address
    ...
    string private _name = "Chocolate Milk Inu";
    string private _symbol = "CMI";
    ...
    uint256 public maxTX =10000000e9;
     uint256 public maxWallet =200000e9;
  ...
  function xLimitcheck(address _addr,bool _status) public onlyOwner() {
