...
contract WineBottleClubGenesis is ERC721, EIP712, Ownable {
    ...
    uint256 public _tokenPublicPrice = 0.4 ether;
    ...
    constructor(string memory baseTokenURI, address recipient)
    ...
    function publicMint(address to, uint16 count) external payable {
        ...
        _mintManyLimited(to, _tokenPublicPrice, count);
    }
    ...
    function _mintManyLimited(
        ...
        unchecked {
            _maxTokenPerWallet[msg.sender] += count;
        }
        require(_maxTokenPerWallet[msg.sender] <= MAX_TOKEN_PER_WALLET, "!max");
