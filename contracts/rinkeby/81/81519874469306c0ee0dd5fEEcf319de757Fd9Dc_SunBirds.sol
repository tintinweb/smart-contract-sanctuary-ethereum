...
contract SunBirds is ERC721A, Ownable, ReentrancyGuard {
    ...
    function freezeMetadata(bool metadata_frozen) external onlyOwner {
    ...
    address private payoutAddress = 0x4BDcE4Fb1859973c63ad5487C10CA4C025daf007;
    ...
    function setPayoutAddress(address addy) external onlyOwner {
        payoutAddress = addy;
    }
}