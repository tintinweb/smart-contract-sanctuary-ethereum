...
contract SvgGenerator is ISvgGenerator {
    ...
    function generateTokenUri(IChameleon.Chameleon memory chameleon)
        external
        pure
        override
        ...
        returns (string memory)
    {
        ...
        string memory styleTag = string(
            abi.encodePacked(
                ...
                "100%, 0% { fill: rgb(255, 0, 0); } 8% { fill: rgb(255, 127, 0); } 16% { fill: rgb(255, 255, 0); } 25% { fill: rgb(127, 255, 0); } 33% { fill: rgb(0, 255, 0); } 41% { fill: rgb(0, 255, 127); }",
                "50% { fill: rgb(0, 255, 255); } 58% { fill: rgb(0, 127, 255); } 66% { fill: rgb(0, 0, 255); } 75% { fill: rgb(127, 0, 255); } 83% { fill: rgb(255, 0, 255); } 91% { fill: rgb(255, 0, 127); }",
                "}",
                ...
                ".tongue{fill:brown;}",
                ".leaf{fill:",
                _valueToHSL(chameleon.leaves),
                ";}",
                ".bark{fill:",
                _valueToHSL(chameleon.branch),
                ";}",
                body,
                eye,
                "</style> </defs>"
