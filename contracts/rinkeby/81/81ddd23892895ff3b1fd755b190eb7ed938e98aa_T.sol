...
contract T is ERC721, Ownable, ReentrancyGuard {
    uint256 private PRICE = 15000000000000000; // .015e
    uint256 private MAX_QUANTITY = 10000;
    ...
    function claim(uint256 num) public payable nonReentrant {
        ...
        require(msg.value >= num * PRICE, "Price is .015 per mint");
