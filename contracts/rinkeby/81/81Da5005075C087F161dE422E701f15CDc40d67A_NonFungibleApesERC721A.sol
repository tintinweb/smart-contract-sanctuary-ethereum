...
contract NonFungibleApesERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 private constant MAX_SUPPLY_PUBLIC = 10; // il faudra modifier apres : 100000
    // uint256 private constant MAX_SUPPLY_MINUS_GIFT = MAX_SUPPLY - MAX_GIFT;

    uint256 public publicSalePrice = 0.0001 ether;

    uint256 public saleStartTime = 1653604200; // il faudra mettre le timestamp au meme moment que dans le smart contract

    string public baseURI;

    mapping(address => uint256) amountNFTperWalletPublicSale;

    uint256 private constant maxPerAddressDuringPublicMint = 500; // il faudra modifier apres 500;

    bool public isPaused;

    uint256 private teamLength;

    address[] private _team = [0xCD191738Fd18Cf3da1135fE6279B07Afbe68E3cA];

    uint256[] private _teamShares = [1000];

    //Constructor
    constructor(string memory _baseURI)
        ERC721A("Non Fungible Apes", "NFA")
        ...
        callerIsUser
    {
        ...
        // );
        // require(
        //     currentTime() < saleStartTime + 96 hours,
        ...
        require(
            ...
            "You can only get 500 NFTs on the Public Sale"
        );
        // require(
        ...
        // );
        require(
            totalSupply() + _quantity <= MAX_SUPPLY_PUBLIC,
            "Reached max supply"
        );
    ...
    /**
     * @notice Release the gains to the CEO Address
     */

    function releaseAllGains() external {
