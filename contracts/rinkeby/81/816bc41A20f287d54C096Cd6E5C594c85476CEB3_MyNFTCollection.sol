...
contract MyNFTCollection is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public RANGE_MAX_TOKEN_FOR_FREE_MINT = 20;
    uint256 public MAX_TOKEN_MINT_ON_FREE_MINT = 5; // count +1 for mechamism
    uint256 public PRICE = 0.025 ether;
    address public CREATOR = 0x02D7cAc34A565B3aD93B732578CA46Ac17c8855D;
    ...
    function freeMint(address _to) public {
        ...
        require(tokensByOwnerForFreeMint(msg.sender) <= MAX_TOKEN_MINT_ON_FREE_MINT, "Max Token minted on freemint period reached, please use a default mint fonction");
    ...
    function safeMintCount(address _to, uint256 _count) public payable {
        uint256 supply = totalSupply();
        for (uint256 i = 0; i < _count; i++) {
        _safeMint(_to, supply + i);
        }
