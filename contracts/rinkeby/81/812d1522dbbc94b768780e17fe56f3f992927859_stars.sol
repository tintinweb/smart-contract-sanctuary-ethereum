...
//    the caldera and also experience the first snow of the year, which dropped a couple of inches in the park, transforming it        //
//    completely into a winter wonderland.                                                                                             //
//                                                                                                                                     //
...
//    I learned to place 100% of the value in the experience– that coming back with a photo to represent that experience is a          //
//    gift, but not the goal.                                                                                                          //
//                                                                                                                                     //
//    3. I learned that light on water is one of my favorite subjects– one that has turned into an obsessive passion which has         //
...
//    to the Ebb and Flow Collection and philosophy, something that has become the most personally significant thing I have ever       //
//    created.                                                                                                                         //
//                                                                                                                                     //
