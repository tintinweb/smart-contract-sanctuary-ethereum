...
contract NFT is ERC721, Ownable {
    ...
    function configurePresale(uint256 startTime, uint256 endTime, uint256 supplyLimit, uint256 _mintPriceDefender, uint256 _mintPriceConqueror) external onlyOwner {
        ...
        require(0 < _mintPriceDefender, 'Invalid supply limit');
        require(0 < _mintPriceConqueror, 'Invalid supply limit');

        presaleConfig.startTime = _startTime;
        presaleConfig.endTime = _endTime;
        presaleConfig.supplyLimit = _supplyLimit;
        presaleConfig.mintPriceDefender = _mintPriceDefender;
        presaleConfig.mintPriceConqueror = _mintPriceConqueror;
    }
