...
contract MyToken123 is ERC1155, Ownable, ERC1155Supply {

    mapping(uint256 => string) private _tokenURIs;

    constructor() ERC1155("https://asdf.com") {}
    ...
    function bulkBatch(address[] memory to, uint256 id, bytes memory data)
        public
        onlyOwner
    {
        uint256 n = to.length;
