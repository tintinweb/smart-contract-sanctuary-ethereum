...
contract DNAChip is ERC721, Ownable {
    ...
    constructor() ERC721("DNAChip", "DNA") {
        ...
        _traitsByBase[0][BASE_INDEX] = [450, 400, 100, 50];
        _traitsByBase[0][EARRINGS_INDEX] = [900, 95, 5];
        _traitsByBase[0][EYES_INDEX] = [390, 390, 205, 10, 5];
        _traitsByBase[0][HATS_INDEX] = [570, 270, 145, 10, 5];
        _traitsByBase[0][MOUTHS_INDEX] = [150, 150, 150, 150, 150, 150, 100];
        _traitsByBase[0][NECKS_INDEX] = [700, 270, 30];
        _traitsByBase[0][NOSES_INDEX] = [200, 200, 200, 200, 200];
        _traitsByBase[0][WHISKERS_INDEX] = [240, 240, 240, 230, 50];
        _traitsByBase[1][BASE_INDEX] = [450, 400, 100, 50];
        _traitsByBase[1][EARRINGS_INDEX] = [900, 95, 5];
        _traitsByBase[1][EYES_INDEX] = [390, 390, 205, 10, 5];
        _traitsByBase[1][HATS_INDEX] = [570, 270, 145, 10, 5];
        _traitsByBase[1][MOUTHS_INDEX] = [150, 150, 150, 150, 150, 150, 100];
        _traitsByBase[1][NECKS_INDEX] = [700, 270, 30];
        _traitsByBase[1][NOSES_INDEX] = [200, 200, 200, 200, 200];
        _traitsByBase[1][WHISKERS_INDEX] = [240, 240, 240, 230, 50];
        _traitsByBase[2][BASE_INDEX] = [450, 400, 100, 50];
        _traitsByBase[2][EARRINGS_INDEX] = [900, 95, 5];
        _traitsByBase[2][EYES_INDEX] = [390, 390, 205, 10, 5];
        _traitsByBase[2][HATS_INDEX] = [570, 270, 145, 10, 5];
        _traitsByBase[2][MOUTHS_INDEX] = [150, 150, 150, 150, 150, 150, 100];
        _traitsByBase[2][NECKS_INDEX] = [700, 270, 30];
        _traitsByBase[2][NOSES_INDEX] = [200, 200, 200, 200, 200];
        _traitsByBase[2][WHISKERS_INDEX] = [240, 240, 240, 230, 50];
        _traitsByBase[3][BASE_INDEX] = [450, 400, 100, 50];
        _traitsByBase[3][EARRINGS_INDEX] = [900, 95, 5];
        _traitsByBase[3][EYES_INDEX] = [390, 390, 205, 10, 5];
        _traitsByBase[3][HATS_INDEX] = [570, 270, 145, 10, 5];
        _traitsByBase[3][MOUTHS_INDEX] = [150, 150, 150, 150, 150, 150, 100];
        _traitsByBase[3][NECKS_INDEX] = [700, 270, 30];
        _traitsByBase[3][NOSES_INDEX] = [200, 200, 200, 200, 200];
        _traitsByBase[3][WHISKERS_INDEX] = [240, 240, 240, 230, 50];
    }
