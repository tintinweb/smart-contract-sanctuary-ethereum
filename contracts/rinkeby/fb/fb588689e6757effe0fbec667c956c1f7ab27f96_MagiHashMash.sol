...
// File: contracts/mashFlat.sol


//Extension of the Hashlips base smart contract to include reentrancy guard, merkle tree whitelist support and pre-mint timing, as well as royalties
...
contract MagiHashMash is ERC721Enumerable, Ownable, IERC2981, ReentrancyGuard { //Added IERC2981, ReentrancyGuard
  ...
  string public verificationHash; //Added.
  bool public isPublicSaleActive;  //Added.
  uint256 public MAX_NFTs_PER_WALLET = 10; //Added.
  uint256 public ALLOW_LIST_SALE_PRICE = 0.05 ether; //Added.
  ...
  bytes32 public claimListMerkleRoot; //Added.
  ...
  uint256 public cost = 0.06 ether; //Public mint cost
  uint256 public maxSupply = 1111; //Maximum nfts in the entire collection
  uint256 public maxMintAmount = 10; //Max users can mint per transaction
  ...
  function setCostPerNFT(uint256 _newCost) public onlyOwner {
    cost = _newCost;
  }
...
/*  function withdrawWithCall() public payable onlyOwner {
    (bool os, ) = payable(owner()).call{value: address(this).balance}("");
    require(os);
  }
}*/ //Old Hashlips withdraw function removed
