  ...
  ReentrancyGuard
{
  ...
  string public TOKEN_BASE_URL =
    "https://temp-cdn.coniun.io/resurrection_metadata/rinkeby/";
  ...
  mapping(address => uint256) public transferCountMap;
  ...
  function getTransferCount(address wallet)
    ...
    returns (uint256)
  {
    return transferCountMap[wallet];
  }
  ...
  function onERC721Received(
    ...
    require(
      transferCountMap[from] < WALLET_TRANSFER_LIMIT,
      "too_many_transfers"
    );
