...
// File: contracts/Clueda_Menot.sol
...
contract clueda_menots is ERC721A, Ownable {
    ...
    function freeMint() external payable {
        ...
        require(MAX_PER_TX_FREE >= uint256(_getAux(msg.sender)) + 1, "Excess max free mint per wallet");
