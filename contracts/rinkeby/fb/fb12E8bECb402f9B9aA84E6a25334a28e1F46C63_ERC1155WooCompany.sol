    ...
    UUPSUpgradeable
{
    ...
    function __ERC1155WooCompany_init(
        string memory name_,
        ...
        for (uint8 i = 0; i < _addresses.length; i++) {
            ...
            require(
                ...
                "ERC1155WooCompany: delegate call to non-contract"
            );
    ...
    function transferToRecipients(
        ...
        require(
            ...
            "ERC1155WooCompany: not enough tokens are owned."
        );
    ...
    function toHexDigit(uint8 d) internal pure returns (bytes1) {
        ...
        revert("ERC1155WooCompany: invalid value for hexadecimal.");
    }
