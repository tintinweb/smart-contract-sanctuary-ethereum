...
contract NabConPass is ERC721, ReentrancyGuard, Ownable {
    ...
    string public uriPrefix = "ipfs://Qmb71jGnxDKBUJtmS5C3d2rBpQCh7CYYmCZmDP58dqpsSx";
    string public uriSuffix = "";
    string public uriContract = "ipfs://QmbBpay8bfRuhBJBAT1bw7LXxnYtJHzytJmLLFRsuLBQZZ";

    uint256 public preMintPrice = 0.08 ether;
    ...
    address[] public founderAccounts = [
    0xDC9eeF462bD661D5a14146dFA05f5cdB6Db5Fecf,
    0x2c50Fd1D0CD8660a7935B1BC2e3EdC4752DA6ADF
    ];

    constructor() ERC721("Naber Consulting Pass", "NCP") {
        for (uint256 i = 0; i < founderAccounts.length; i++) {
            address _receiver = founderAccounts[i];
            for (uint256 j= 0; j < maxOwnerMintAmount; j++) {
                supply.increment();
    ...
    function preMint(bytes32[] calldata _merkleProof, uint256  _mintAmount) public payable preMintCompliance(_mintAmount){
    ...
    function withdraw() public onlyOwner nonReentrant{ // TODO
    ...
    function contractURI() public view returns (string memory) { //todo implement setter
        return uriContract;
    }
