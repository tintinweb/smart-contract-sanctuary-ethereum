...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1661013720;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1660840920;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xcb52b85B0AFD833585188444223bEFF12634774A];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.03 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmX7qz8MSwTQQQtfw7Tt2SoCwVprCYvvvn129SqCavVZzV/";
...
// File: contracts/ElvesRebornContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ElvesRebornContract is RamppERC721A {
    constructor() RamppERC721A("Elves Reborn ", "ELVSR"){}
}
