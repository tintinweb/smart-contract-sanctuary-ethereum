...
contract TestPixelDucks is ERC721Delegated, ReentrancyGuard {
  ...
  uint256 public constant PRICE = 3500000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.0035 ETH per item"
    );
