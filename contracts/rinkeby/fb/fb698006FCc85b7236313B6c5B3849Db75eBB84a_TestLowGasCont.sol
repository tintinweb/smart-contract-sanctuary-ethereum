...
// File: contracts/TestLoGasSl.sol



// Amended by MushonThe1st
/**
    !Disclaimer!
...
contract TestLowGasCont is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("testConstructorName", "TStsymb") {
    setHiddenMetadataUri("ipfs://QmcS74Sfjt7tKcWZrhEPbYQ5pBymWRifPrLbfmDYf3m2Ey/Hidden.json");
  }
