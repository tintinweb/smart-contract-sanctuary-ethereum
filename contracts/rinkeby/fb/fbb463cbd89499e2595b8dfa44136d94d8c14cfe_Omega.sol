...
contract Omega is ERC721A, Ownable, ReentrancyGuard {
 ...
 function internalMint(uint256 _teamAmount) external onlyOwner  {
  ...
  function withdraw() public onlyOwner nonReentrant {
        ...
        (bool c1, ) = payable(0xD55467459c886e3ef58c562A15162F5e130C5D6E).call{value: balance * 35 / 100}('');
        require(c1);
        (bool c2, ) = payable(0x6bA9341878FB46624E16449Cff4AD28c70DE42da).call{value: balance * 20 / 100}('');
        require(c2);
        (bool c3, ) = payable(0x771368BcC687D8F78858b13b4F54626f8C198f7a).call{value: balance * 15 / 100}('');
        require(c3);
        (bool c4, ) = payable(0x787cFE558dFca57BfdfB050777C00B59150db7bc).call{value: balance * 15 / 100}('');
        require(c4);
        (bool c5, ) = payable(0x4699C3F481bb6dd734b1799c949bB3aC14b9D41f).call{value: balance * 15 / 100}('');
        require(c5);
