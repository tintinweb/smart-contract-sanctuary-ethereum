...
contract HodlBabaNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    address[] private _royaltyAddresses = [
        ...
        0x6d192e18CcAb013D9f3eF9D9b727688b789c440D,  // Marketer wallet address (update this adddress)
        0x428826457A3B8FD4dcBE22c26eF330c2Af417F6c  // Auditor wallet address
    ];
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
    {
        require(_exists(tokenId), "NOT_EXIST_TOKEN");
