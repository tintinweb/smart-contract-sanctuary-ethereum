...
import "./management/IGenesisNFTManageable.sol";
...
contract VVDealersChoice is ERC721, ERC721Enumerable, ERC2981, AdminControl, Ownable, ReentrancyGuard, Pausable, IGenesisNFTManageable {
    ...
    */
    ...
    function setAllowlistMerkleTreeRoot(bytes32 _root) override public onlyAdmin {
        allowlistMerkleTreeRoot = _root;
    }

    function setPublicSaleStartTime(uint256 _time) override public onlyAdmin {
        publicSaleStartTime = _time;
    }

    function setAllowlistSaleStartTime(uint256 _time) override public onlyAdmin {
