...
contract WEARKey is ERC721A, Ownable {
  ...
  uint256 public constant MAX_SUPPLY = 1000 + 1; // max supply 1000
  uint256 public constant MAX_PER_USER = 15 + 1; // max 15 for user
  uint256 public constant MAX_PER_WHITELIST = 1 + 1; // max 1 for whitelisted user
