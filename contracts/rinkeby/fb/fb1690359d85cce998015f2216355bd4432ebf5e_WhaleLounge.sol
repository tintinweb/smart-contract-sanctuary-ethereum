...
contract WhaleLounge is ERC721A, Ownable, ReentrancyGuard {
  ...
  function isWhitelisted(address _user) public view returns (bool) {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        Address.sendValue(payable(0xA6286487fF71763aE84ea06D2393944eF3c7b390),balance* 2 / 100);
        Address.sendValue(payable(0x3e8C9A71431BBcB4e4203D5ab9Aa78A0D0394478),balance* 98 / 100);
