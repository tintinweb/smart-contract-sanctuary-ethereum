...
contract DRagon is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0xFe24eAd5b3791117f14874A1E2Ae12b46E37ad2a;

    string private _baseTokenURI = "ips://Qmc7kPin6rgMjX33Ev3P8xmkFDvh4ghA7CTok5yZKBC3w5";

    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("DRAG", "BDRAGON") {
