...
contract Bricks is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/26/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/26/contract-uri";
    ...
    uint256 public tokenfyPrice = 1000000000000000000000;
	...
	constructor(address _signerAddress) ERC721("Bricks", "BRIX") {
