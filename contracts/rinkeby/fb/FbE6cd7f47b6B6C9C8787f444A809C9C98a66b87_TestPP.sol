...
contract TestPP is ERC721A, Ownable {
    string public baseURI = "";

    uint256 public immutable mintPrice = 0.0001 ether;
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= (1-a) * mintPrice);
        uint256 num = msg.value / mintPrice + a;
        amount = num >= perTxLimit ? perTxLimit : num;
