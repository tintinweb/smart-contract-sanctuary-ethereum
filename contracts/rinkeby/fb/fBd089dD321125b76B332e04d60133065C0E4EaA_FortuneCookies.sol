...
[email protected]@[email protected]             
  ...
  @[email protected]
[email protected]         
   +9+99999999999999999====9[email protected]
[email protected]       
   @[email protected]     
    @[email protected]    
...
contract FortuneCookies is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function initialize(
        ...
        __ERC721A_init('FortuneCookies', 'FTCK');
        __Ownable_init();
    ...
    // Mint
    function freeMint(uint256 _quantity, bytes32[] calldata proof) external nonReentrant payable whenNotPaused {
        require(
        ...
        require(
            totalMinted + _quantity <= thisRoundSupply,
