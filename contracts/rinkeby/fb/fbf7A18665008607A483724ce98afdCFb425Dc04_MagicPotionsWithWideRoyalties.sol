...
contract MagicPotionsWithWideRoyalties is ERC2981ContractWideRoyalties, TemplateNFT {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(TemplateNFT, ERC2981Base)
        returns (bool)
    {
    ...
    function mintBatch(address[] memory recipients) external onlyAdmin {
