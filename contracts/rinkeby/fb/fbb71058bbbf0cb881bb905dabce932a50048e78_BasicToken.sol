...
contract BTT is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;
  ...
  string public constant name = "BasicTestToken";
  string public constant note = "testtoken";
  uint8 public constant decimals = 18;
  uint256 constant TOTAL_SUPPLY = 9000000099 *(10**uint256(decimals));
