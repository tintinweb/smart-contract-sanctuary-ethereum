...
contract SimpleNFTMarketplace {
    ...
    uint256 public constant PUBLISHING_FEE = 0.0002 ether;
    ...
    function publishItem(
        ...
        // transfer
        IERC721(_nftContract).transferFrom(_tokenOwner, address(this), _tokenId);
    ...
    function buyItem(address _nftContract, address buyer, uint256 _itemId) public payable {
        ...
        getMarketItem[_itemId].owner = payable(buyer);
        ...
        emit MarketItemSold(_itemId, oldOwner, buyer);
    }
