...
contract SibHoodies is ERC1155, AdminPrivileges, RoyaltiesConfig, Allowlist, AdminPause {
    ...
    function mint() public whenNotPaused {
        ...
        require(IERC20(ASH_ADDRESS).transferFrom(msg.sender, payoutAddress, PRICE), "Ash Payment failed - check if this contract is approved");
        ...
        whenNotPaused
    {
        ...
        //     }
        // } else {
        //     require(from == address(0) || to == address(0), "This token may not be transferred now");
        // }
