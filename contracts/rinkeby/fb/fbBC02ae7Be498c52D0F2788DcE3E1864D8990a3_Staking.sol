...
contract Staking is OwnableUpgradeable, ReentrancyGuard{
    ...
    uint256 public timeflag;


    // constructor (address _stakingToken) {
    //     require(AddressUpgradeable.isContract(_stakingToken), "The address does not point to a contract.");
    ...
    // }
      ...
      function initialize() public initializer{
            __Ownable_init();
            stakingTokenAddress = 0x4F67EeD9cA3356FE5E4d4bc5BA2854E512a7DF85;
            StakingToken = IERC20Upgradeable(0x4F67EeD9cA3356FE5E4d4bc5BA2854E512a7DF85);
            _DECIMALS = 18;
            _MIN_STAKE_AMOUNT = 100 * 10 ** _DECIMALS;
            _MAX_STAKE_AMOUNT = 10000 * 10 ** _DECIMALS;
            _REWARD_CYCLE = 5 minutes;
            _REWARD_RATE = 50; // x0.5
