...
contract MyToken is ERC1155, Ownable, Pausable, ERC1155Supply, ERC1155Burnable {
    bytes32 public root;
    ...
    constructor(bytes32 _root)
        ERC1155(
            "https://nftgen.s3.eu-west-2.amazonaws.com/testcheck/meta/{id}.json"
        )
    {
        root = _root;
    }
    ...
    function makeNft(
        ...
        require(nftbalance == 0, "You have exceeding number of mints");
        require(
            isWhitelisted(_proof,keccak256(abi.encodePacked(msg.sender))),
            "Not on Whitelist"
        );
         require(_amount == maxMintAmount, "You only have one pass allocated to you");
        _mint(_account, _id, _amount, "");
        emit Claimedmintpass(_id, _amount, msg.sender);
    }
