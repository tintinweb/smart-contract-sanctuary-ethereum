...
contract Seven22 is Ownable, Pausable, ReentrancyGuard, ERC721A {
  ...
  function teamClaim(uint256 qty, address recipient) external onlyOwner {
    require(block.timestamp > publicSaleEndTs, "public sale has not finished");
    require(totalSupply() + qty <= maxSupply, "max supply");
