...
////////////////////////////////////////
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        ...
        string memory automatonImage = string(abi.encodePacked("https://arweave.net/BDpljNqS7oMyj-2qBB__fB69miweo-xPFUJd5AUdeTA"));
        string memory memoriaImage = string(abi.encodePacked("https://arweave.net/QqSSyWwt-qp_5IYD9uPJpOYSqpN9GlDPbibDNT9VKRE"));
        string memory json;
        if(tokenId == 0) {
            json = string(
            abi.encodePacked( 
