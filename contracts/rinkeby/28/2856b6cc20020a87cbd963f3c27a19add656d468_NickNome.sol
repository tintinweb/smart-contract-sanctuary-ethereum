...
contract NickNome is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(
        string memory name, // NickNome
        string memory symbol, // NNT
        string memory baseTokenURI_, // https://www.curiousaddys.com/token/
        uint256 maxSupply_ // 10000
    ) ERC721(name, symbol) {
