...
contract OdysseyRouter is OdysseyDatabase, ReentrancyGuard {
    ...
    function create1155(
        ...
        if (info.reserveAmounts.length > 0) {
            ...
            require(success, "OdysseyRouter: Pre-mint1155 Call Failure");
        }
        return token;
    }
    ...
    function create721(
        ...
        if (reserveAmount > 0) {
            ...
            require(success, "OdysseyRouter: Pre-mint721 Call Failure");
        }
    ...
    function mintERC721(
        ...
        require(success, "OdysseyRouter: Mint721 Call Failure");
    }
    ...
    function reserveERC721(
        ...
        require(success, "OdysseyRouter: Reserve721 Call Failure");
    }
    ...
    function mintERC1155(
        ...
        require(success, "OdysseyRouter: Mint1155 Call Failure");
    }
    ...
    function reserveERC1155(
        ...
        require(success, "OdysseyRouter: Reserve1155 Call Failure");
    }
