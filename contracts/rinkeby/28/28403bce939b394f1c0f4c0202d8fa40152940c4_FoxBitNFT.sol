...
contract FoxBitNFT is ERC721A, ERC2981, ReentrancyGuard, Ownable {
    ...
    uint256 public maxToken = 20;
    uint256 public price = 0.001 ether;


    string private _baseTokenURI;
    string public notRevealedUri = "ipfs://QmeqXm7xxi1QrdswDRYjyxufELuH1767XhjMu7wD78XgiT/notreveal.json";

    mapping (address => bool) public freeMinted;

    address defaultTreasury = 0x7Cb0150BEa0B9F0cc52Ebe93955A18A6DFe3aC57;
    
    constructor() ERC721A("Fox Bit", "FXBT") {
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        require(totalSupply() + quantity < maxToken, "Exceeds max supply");


        if(freeMinted[msg.sender]){
            require(quantity * price == msg.value, "INVALID_ETH");
        }else if(quantity * price == msg.value){
            require(quantity * price == msg.value, "INVALID_ETH");
        }else{
            require((quantity * price) - price == msg.value, "INVALID_ETH");
    ...
    function reveal() external onlyOwner {
        ...
        /**
     * @dev Update the royalty percentage (750 = 75%)
     */
