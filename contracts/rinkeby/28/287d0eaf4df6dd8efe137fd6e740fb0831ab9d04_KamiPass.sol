...
contract KamiPass is ERC1155, Ownable, ERC1155Supply {
    ...
    uint256 private freeSupply = 4;
    uint256 private maxPerWallet = 2;
    uint256 private whitelistPrice = 5000000000000000; //0.005 ETH
    ...
    function setStatusPublic(bool _status) public onlyOwner {
        mintActive = _status;
    }

    function setStatusFree(bool _status) public onlyOwner {
        freeMintActive = _status;
    }

    function setStatusWhitelist(bool _status) public onlyOwner {
        whitelistMintActive = _status;
    }
    ...
    function freeMint(bytes32[] calldata _merkleProof) public payable {
        ...
        // minting has ended
        require(minted < freeSupply, "Free mint has ended");
    ...
    isCorrectPayment(whitelistPrice, amount) 
    isAtMax(amount)
     {
        require(whitelistMintActive, "Minting is not active");
        // minting has ended
        require(minted < maxSupply, "Sold out, Mint has ended.");
        // check if msg.sender already minted
        /* require(
            !hasRedeemed[msg.sender],
            "You have already redeemed your pass"
    ...
    isAtMax(amount)
    {
      require(mintActive, "Minting is not active");
        // minting has ended
        require(minted < maxSupply, "Minting has ended");
        // check if msg.sender already minted
        /* require(
            !hasRedeemed[msg.sender],
            "You have already redeemed your pass"
