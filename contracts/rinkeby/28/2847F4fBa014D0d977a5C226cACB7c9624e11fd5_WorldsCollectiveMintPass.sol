...
contract WorldsCollectiveMintPass is ERC721A, Ownable {
    ...
    constructor() ERC721A("WorldsCollectiveMintPass", "WCMP"){}
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xF2C6fbD8c639e5168c8164E3781643cC9Bca56Db).transfer((balance * 5000)/10000);
        payable(0x0295F38e51B7fa315dae84A59A4465298eA6E474).transfer((balance * 5000)/10000);
    }
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            require(_whitelistMintedCount[msg.sender] + count <= TOKENS_PER_PERSON_WL_LIMIT, "ZeroCodeNFT: Number of requested tokens exceeds allowance (2)");
