...
contract ShintaroToken is ERC1155Burnable, ERC1155Supply, Ownable {
  ...
  constructor() ERC1155("") {
    // tokenid 0-5: set mint window after draw results, date TBD
    init(0, 1, new uint64[](0), 100, 0.1 ether, 0, 10000000000, "ipfs://QmXda3TupJdM5pUqKMchuDCJyXsBtsbpRcmFD139ZZrMcw"); // change start time, end time and uri
    init(1, 1, new uint64[](0), 100, 0.1 ether, 0, 10000000000, "ipfs://QmXygnK49TfgjHYTZqR7QtnzXtuLfEK1YhjmtDza6j85iY"); // change start time, end time and uri
    init(2, 1, new uint64[](0), 50, 0.2 ether, 0, 10000000000, "ipfs://QmPyk2b8FPmBKueyMJ6KWGaibB5mim9G17eHFwfcRyjB5c"); // change start time, end time and uri
    init(3, 1, new uint64[](0), 50, 0.2 ether, 0, 10000000000, "ipfs://QmemAMyoewjbNxfKWvVVNFoHHhkkRdgics7yoDjuSUCGPy"); // change start time, end time and uri
    init(4, 1, new uint64[](0), 25, 0.7 ether, 0, 10000000000, "ipfs://QmUa9fUCi7fgqQ712HTZb23FqdN3KmDL4a6McyjtpaLpLx"); // change start time, end time and uri
    init(5, 1, new uint64[](0), 10, 1.25 ether, 0, 10000000000, "ipfs://QmZqbQDjDZTBEuTqDqRCWbtz2TmxRwFczhbTT5H796xRZ1"); // change start time, end time and uri

    uint64[] memory counters = new uint64[](1);
    counters[0] = 7;
    // PROD: 1655676000, 1655762400
    init(6, 1, counters, type(uint64).max, 0 ether, 1655676000, 1655762400, "ipfs://QmZqbQDjDZTBEuTqDqRCWbtz2TmxRwFczhbTT5H796xRZ1"); // change start time, end time and uri

    counters[0] = 6;
    // PROD: 1655676000, 1655762400
    init(7, 1, counters, type(uint64).max, 0 ether, 1655676000, 1655762400, "ipfs://QmR714TzFBpfQgmMmJSsYY1VZ1hftG6wAj2QnoQ96TLKU3"); // change start time, end time and uri
  }
