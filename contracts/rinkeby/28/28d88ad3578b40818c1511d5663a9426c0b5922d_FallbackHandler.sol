...
contract FallbackHandler is IERC1271, IERC1155Receiver, IERC721Receiver, IERC777Recipient { // IERC1155Receiver is IERC165
    string public constant name = "Fallback Handler";
    ...
    function isValidSignature(bytes32 hash, bytes memory signature) external view returns (bytes4) {
        StacktWallet wallet = StacktWallet(payable(msg.sender));
        wallet.checkSignatures(hash, signature);
        return 0x1626ba7e;
    }
