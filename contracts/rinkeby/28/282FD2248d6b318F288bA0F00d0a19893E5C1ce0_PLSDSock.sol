...
contract PLSDSock is ERC721A, Ownable, ReentrancyGuard {
  ...
  string private hiddenMetadataUri = "ipfs://bafyreiazbic3p4vuox7bhl6joq2wq5jwt4pbjs7fpvxvtjbthsxrg3pbge/metadata.json";

  constructor(bytes32 _merkleRoot) ERC721A(_name, _symbol) {
    merkleRoot = _merkleRoot;

    _transferOwnership(0xFCE3244af6C4cDD66AB087E143c8c8c9EF012e23);
  }
