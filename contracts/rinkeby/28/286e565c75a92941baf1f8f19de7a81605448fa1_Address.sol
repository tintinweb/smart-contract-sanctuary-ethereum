...
contract Rugged is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Rugged", "RUG") {
        _safeMint(msg.sender, 5);
        setBaseURI("https://nevergoingtoreveal.com");
    }
    ...
    function mint(uint256 count) external payable {
        ...
        require(msg.value >= count * cost, "Don't be cheap! Send enough!");
        require(totalSupply() + count < maxSupply + 1, "No more");
        require(mintEnabled, "Were not ready yet asshole");
    ...
    function setFreeAmount(uint256 amount) public onlyOwner {
        totalFree = amount;
    }
