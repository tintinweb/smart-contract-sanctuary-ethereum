...
// To convert SVG and JSON to Base64. Doing all this on the back-end may take up unneceassary gas, so its better to do it on the front-end and pass the info to the back-end.
library Base64 {
