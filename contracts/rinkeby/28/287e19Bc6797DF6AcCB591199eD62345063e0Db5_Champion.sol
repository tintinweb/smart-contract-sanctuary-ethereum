    ...
    PaymentSplitter
{
    ...
    function setBeforeRevealURI(string memory _beforeRevealURI) public onlyOwner{
    ...
    onlyAccounts{
        ...
        require(current+amount <= maxSupply,                                    "Sold out.");
        require(publicPrice * amount <= msg.value,                              "Not enough ethers sent.");
