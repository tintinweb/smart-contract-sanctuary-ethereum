...
contract TierToken is ERC1363, ERC20Capped, ERC20Burnable, Pausable, AccessControl, TokenRecover {
    ...
    string  private NAME = "Tier Monsters Governance Token";
    string  private SYMBOL = "TIER";
    uint256 private CAP = 10000000000 * (10**18);
    uint    private constant INITIAL_SUPPLY = 100000000000 * (10**18);
