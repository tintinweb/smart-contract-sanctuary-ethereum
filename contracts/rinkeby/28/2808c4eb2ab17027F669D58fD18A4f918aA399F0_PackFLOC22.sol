    ...
    ERC2771ContextUpgradeable
{
        ...
        returns (AVAILABLE_USER_DISCOUNT memory)
    {
        ...
        AVAILABLE_USER_DISCOUNT memory response = AVAILABLE_USER_DISCOUNT(userTokenAmount, discount, tokenPrice, helperCounter);
