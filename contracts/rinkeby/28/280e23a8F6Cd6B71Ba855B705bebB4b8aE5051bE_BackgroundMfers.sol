...
// Background Mfers V3
  nftInterface dadmfersV1Contract = nftInterface(0x298614db08ed42CC05BE520C313f35ABaE6a05fE);

// dadmfers v2 0x68CCdcf9d5CB0e61d72c0b31b654d6408A93C65a
// Background Mfers V2
  nftInterface dadmfersV2Contract = nftInterface(0x04C4fdC5216206B3627D69dB045FdabF26e25c9f);

// mfers 0x79fcdef22feed20eddacbb2587640e45491b757f
// Background Mfers
  nftInterface mfersContract = nftInterface(0x972492ED350895501Bc2Aafc265216Be3354D2Ad);
    ...
    returns (uint256[] memory)
  {
    ...
    uint256 index = 0;
    for (uint256 tokenid = 1; tokenid < foreignSupply + 100; tokenid++) {
      bool owned = false;
      if (input == 0) {
