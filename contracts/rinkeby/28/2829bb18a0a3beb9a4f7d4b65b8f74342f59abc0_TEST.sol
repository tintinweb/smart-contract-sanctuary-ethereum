...
contract TEST is ERC721A, Ownable {
    ...
    uint256 public constant maxFreeMintNum = 2;
    uint public constant maxTrx = 20;
    uint public supply = 10000;
    uint public price = 0.005 ether;
    uint public alrFreeTotal;
    ...
    function goMint(uint256 _amount) external payable {
        ...
        require( alrFreeTotal < maxFreeMintNum, "Mint would exceed max supply of free mints" );
