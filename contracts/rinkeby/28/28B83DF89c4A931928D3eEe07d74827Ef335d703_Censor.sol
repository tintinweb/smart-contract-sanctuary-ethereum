...
contract Censor {
    ...
    constructor() {
        _imageParts.push("<svg xmlns='http://www.w3.org/2000/svg' width='1000' height='1000' viewBox='0 0 1000 1000'>");
            ...
            _imageParts.push("tspan { font-family: 'C'; font-size: 70px; text-transform: uppercase; alignment-baseline: hanging; text-anchor: middle; }");
    ...
    function _renderLines(string memory message) private pure returns (string memory) {
        ...
        return string(abi.encodePacked("<svg y='",uint256(500-(lineCount*35)+20).toString(),"' overflow='visible'><text>",lines,"</text><text>",strikeouts,"</text></svg>"));
    }
