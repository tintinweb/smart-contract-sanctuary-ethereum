...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeF5321a06482bc97f8635984008C914ed51031AC];
...
contract OrcRaidContract is RamppERC721A {
    constructor() RamppERC721A("OrcRaid", "Orc"){}
}