...
contract cyberpunk_mfers is ERC721A, Ownable {
  ...
  modifier mfKnowsWhatTheyDoing(uint256 _mintAmount) {
    require(totalSupply() + _mintAmount <= maxSupply, "max supply exceeded, mfer!");
  ...
  function withdraw() public onlyOwner {
    ...
    // Ukraine War Crisis Relief - check twitter.com/Ukraine for their official tweet on their address. And f Putin.
