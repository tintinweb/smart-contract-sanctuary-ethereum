...
contract TestNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        // CHANGE THIS FOR TESTING URI
        baseURI = "ipfs://QmYBdmWFYSBiA5kqZpi5Et2Basvjsu8rdHVEh1mM2qViJR/";

        for (uint256 i = 0; i <= 3; i++) {
            _safeMint(msg.sender, i);
        }

        for (uint256 i = 5550; i <= 5554; i++) {
            _safeMint(msg.sender, i);
        }

        _safeMint(msg.sender, 656);
        _safeMint(msg.sender, 1756);
        _safeMint(msg.sender, 3000);
        _safeMint(msg.sender, 4255);
        _safeMint(msg.sender, 5391);
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        uint256 tokenIdShifted = tokenId ;
        return
