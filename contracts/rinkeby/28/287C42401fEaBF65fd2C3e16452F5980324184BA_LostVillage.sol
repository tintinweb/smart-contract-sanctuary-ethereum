 ...
 * @notice Implements the Lost Village NFT collection contract.
 */
contract LostVillage is ERC721, Ownable, VRFConsumerBase, ReentrancyGuard {
  ...
  uint256 constant TOKEN_PRICE = 0.03 ether;
  uint256 constant MAX_SUPPLY = 3500;
  uint256 constant MAX_PER_TRANSACTION = 15;
  ...
  function presaleMint(uint256 _mintAmount) public payable correctValue(_mintAmount){
