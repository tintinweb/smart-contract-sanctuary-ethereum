...
contract BasicFunctios {

    // Setting things up
    string coinName = "EPIC Coin";
    int public myBalance = 1000;
    ...
    // function (string memory _variable, int _varible2) public view/pure returns(bool) {}
    ...
    function multiplyBalance (int _multiplier) external {
        myBalance = myBalance * _multiplier;
    }
    
    // That uses a for loop and multiplies params and string comparisons
    ...
    // function get a coin from myCoin mapping (SEEING COIN)
