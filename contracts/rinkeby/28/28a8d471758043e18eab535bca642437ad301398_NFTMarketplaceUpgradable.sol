    ...
    ERC721PausableUpgradeable
{
    ...
    function initialize(
        ...
        __NFTMarketplaceUpgradable_init(name, symbol, baseTokenURI, rootAdmin);
    }
     ...
     * See {ERC721-tokenURI}.
     */
    function __NFTMarketplaceUpgradable_init(
        string memory name,
        string memory symbol,
        string memory baseTokenURI,
        address rootAdmin
        ...
        __NFTMarketplaceUpgradable_init_unchained(
            name,
            symbol,
            baseTokenURI,
            rootAdmin
    ...
    function __NFTMarketplaceUpgradable_init_unchained(
        string memory name,
        string memory symbol,
        string memory baseTokenURI,
        address rootAdmin
     ...
     *
     */
    function isApprovedForOwner(address account)
        public
        view
