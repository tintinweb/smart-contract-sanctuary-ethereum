...
contract IMFONSTEROIDS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "IMF on Steroids";
    ...
    uint256 public extrafee        = 3;
    uint256 public burnFee         = 0;
    uint256 private totalFee        = marketingFee + reflectionFee + liquidityFee + ecosystemfee + extrafee + burnFee;
    ...
    address private extrafeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        extrafeeReceiver = 0x6a9196160846AdF2636DCaDe19e163D474e83662;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBExtra = amountBNB.mul(extrafee).div(totalBNBFee);
        ...
        (tmpSuccess,) = payable(extrafeeReceiver).call{value: amountBNBExtra, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _ecosystemfee, uint256 _extrafee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecosystemfeeReceiver, address _extrafeereciever, address _burnFeeReceiver ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        ecosystemfeeReceiver = _ecosystemfeeReceiver;
        extrafeeReceiver = _extrafeereciever;
