...
contract ProjectP22Token is OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC721AQueryableUpgradeable, VRFConsumerBaseV2 {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
      ...
      Erc721Contract erc721ContractInstance = Erc721Contract(goldenTicketTokens[uint32(newIndex)].contractAddress);
      erc721ContractInstance.transferFrom(goldenTicketHolderWalletAddress, LinkRequestMapping[requestId].userAddress, goldenTicketTokens[uint32(newIndex)].tokenId);
    ...
    function setGoldenTicketConfigration(uint32 _goldenTicketTokenMinAvailableIndex, uint32 _goldenTicketTokenMaxAvailableIndex) external onlyOwner {
