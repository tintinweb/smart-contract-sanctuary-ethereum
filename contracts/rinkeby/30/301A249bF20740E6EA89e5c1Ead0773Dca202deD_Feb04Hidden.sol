...
contract Feb04Hidden is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Feb04Hidden", "F4H") {
    setHiddenMetadataUri("ipfs://QmXGxkhJhRxp1Kfzrd6TFp8GFGEP9GkPhAmcWDMM2Bn8B7/hidden.json");
  }
