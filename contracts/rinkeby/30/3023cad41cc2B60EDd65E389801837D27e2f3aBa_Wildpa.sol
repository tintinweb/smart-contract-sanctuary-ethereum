...
contract ERC721A is IERC721A {
    ...
    function totalSupply() public view override returns (uint256) {
        ...
        unchecked {
            return (totalMintedCommon + totalMintedRare + totalMintedLegendary) - _burnCounter - _startTokenId();
        }
    }
    ...
    function _totalMinted() internal view returns (uint256) {
        ...
        unchecked {
            return (totalMintedCommon + totalMintedRare + totalMintedLegendary) - _startTokenId();
        }
    }
