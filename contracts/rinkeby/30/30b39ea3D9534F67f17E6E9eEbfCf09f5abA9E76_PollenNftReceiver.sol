...
contract PollenNftReceiver is IERC721Receiver { 
 ...
 address public contractSenderAddress;
    ...
    constructor() {
        parentNFT = IERC721(0x00F4b456577beB4234A00e7Bb4C929AF3D1B165a); // Change it to your NFT contract addr
    }
    ...
    function _transferNFT(uint256 _tokenId) public {
