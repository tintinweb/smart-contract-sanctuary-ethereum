        ...
        ERC721Burnable
{
    ...
    function safeMint(address to, uint256 tokenId_dataSha256, string calldata uri, bool absolute)
        public
        canMint
    {
        _safeMint(to, tokenId_dataSha256);
        _setTokenURI(tokenId_dataSha256, uri, absolute);
    }

    function safeMint(address to, uint256 tokenId_dataSha256)
        public
        canMint
    {
        _safeMint(to, tokenId_dataSha256);
    ...
    function fingerprint(uint256 tokenId_sha256)
        public
        pure
        returns (bytes32)
    {
        return bytes32(tokenId_sha256);
    }
