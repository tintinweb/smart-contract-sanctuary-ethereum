...
// File: contracts/kiddoy00ts/kiddoy00ts.sol
...
contract Kiddoy00tsNFT is ERC721A("Kiddoy00ts", "Ky00ts"), ERC721ABurnable, Ownable {
    ...
    function freeMint(bytes32[] calldata _merkleProof) external payable {
    ...
    function preMint(uint256 amount, bytes32[] calldata _merkleProof) external {
        require(currentPhase == Phase.PREMINT, "Pre mint not started"); 
