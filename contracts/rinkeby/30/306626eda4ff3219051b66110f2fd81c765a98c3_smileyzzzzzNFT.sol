...
contract smileyzzzzzNFT is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 20;
    uint256 public owner_MINT_MAX = 30;
    ...
    uint256 public TOTAL_SUPPLY_owner;
    ...
    address constant internal owner_address = 0xa780e5F7E4bbF5130E18251F6bE90DE5ddC69fBA;
    address public ownerwallet = 0xa780e5F7E4bbF5130E18251F6bE90DE5ddC69fBA;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor(string memory _name, string memory _symbol, string memory _revealeduri) ERC721A("smileyzzzzzNFT", "SMILE") { }
    ...
    function ownerMint(uint256 quantity) public payable mintCompliance(quantity) {
        require(msg.sender == ownerwallet, "owner minting only");
        require(TOTAL_SUPPLY_owner + quantity <= owner_MINT_MAX, "No owner mints left");
        require(totalSupply() >= 5, "owner mints after free");

        TOTAL_SUPPLY_owner += quantity;
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 5, "Not enough free supply");
    ...
    function setownerMintMax(uint256 _ownerMintMax) public onlyOwner {
        owner_MINT_MAX = _ownerMintMax;
    }
    ...
    function setownerwalletAddress(address _ownerwallet) public onlyOwner {
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool succ, ) = payable(owner_address).call{
            value: (currBalance * 10000) / 10000
        }("0xa780e5F7E4bbF5130E18251F6bE90DE5ddC69fBA");
