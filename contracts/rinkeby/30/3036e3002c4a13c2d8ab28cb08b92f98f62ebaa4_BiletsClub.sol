/*
KKKKKKKKKKKKKKKKKKKKKK-------Bilets-Club---------KKKKKKKKKKKKKKKKKKKK
KKKKKKKKKKKKKKKKKKKKKK-------Bilets-Club---------KKKKKKKKKKKKKKKKKKKK
...
contract BiletsClub is ERC721A, Ownable {
    ...
    uint256 public constant maxMintsFreePerWallet = 3;
    uint256 public constant maxMintsFree = 100;
    ...
    constructor() ERC721A("BiletsClub", "BLTClub") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        if (maxMintsFree >= totalSupply()) {
            require(
                quantity + _numberMinted(msg.sender) <= maxMintsFreePerWallet,
                "Excess max free mint."
            );
        } else {
    ...
    /******************** OWNER ********************/
    function mint100ForTeam() external onlyOwner {
        require(totalSupply() + 100 <= maxSupply, "Not enough tokens left.");
        require(!teamMint, "Already been mint by the team.");
        teamMint = true;
    ...
    function setMintRate(uint256 _mintRate) public onlyOwner {
        require(
            _mintRate >= mintRate,
            "The mint rate must be higher than the previous one."
        );
        mintRate = _mintRate;
    }
