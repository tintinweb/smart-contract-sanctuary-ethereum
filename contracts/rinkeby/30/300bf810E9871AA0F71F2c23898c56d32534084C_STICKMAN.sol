...
contract STICKMAN is ERC721A, IERC2981Royalties, Ownable {
    ...
    uint256 private royaltyPercentage = 10; 
    ...
    {
        return (treasuryAddress, value * royaltyPercentage / 100);
    }
    ...
    function isPreSaleEnabled() public view onlyOwner returns (bool) {
