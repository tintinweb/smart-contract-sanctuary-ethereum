...
contract MetroBlockScores {
    ...
    function getHoodBoost(uint256[] calldata tokenIds) external view returns (uint256) {
      ...
      for (uint256 i; i < tokenIds.length; i++) {
        ...
        console.log("Token #: %d, boost: %s", tokenId, boost);
        unchecked {
          counterLo +=  boost       & 0x0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001;
          counterHi += (boost >> 8) & 0x0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001_0001;
        }
      }
      ...
      unchecked { // River & River
        uint256 min = (counterHi >> 240) & 0xffff;
        if (min > 0) {totalBoost += 800 * _getSpreadedBoost(hoodSize, min/3);}
        console.log("River, boost %d", min);
      }

      unchecked { // Rail & Rail
        uint256 min = (counterLo >> 240) & 0xffff;
        if (min > 0) {totalBoost += 400 * _getSpreadedBoost(hoodSize, min/3);}
        console.log("River, boost %d", min);
      }
      ...
      unchecked { // Safety
        ...
        if (min > 0) {totalBoost += 500 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 0, boost %d", min);
      }
      unchecked { // Education
        uint256 min = (counterLo >> 208) & 0xffff;
        uint256 v   = (counterHi >> 192) & 0xffff; if (v < min) {min = v;}
        v           = (counterLo >> 192) & 0xffff; if (v < min) {min = v;}
        if (min > 0) {totalBoost += 600 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 1, boost %d", min);
      }
      unchecked { // Entertainment
        ...
        if (min > 0) {totalBoost += 600 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 2, boost %d", min);
      }
      unchecked { // Transport
      ...
      unchecked { // Cultural
        ...
        if (min > 0) {totalBoost += 500 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 6, boost %d", min);
      }
      unchecked { // Mansion
        ...
        if (min > 0) {totalBoost += 600 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 7, boost %d", min);
      }
      unchecked { // Tech
        ...
        if (min > 0) {totalBoost += 800 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 8, boost %d", min);
      }
      unchecked { // Odds
        ...
        if (min > 0) {totalBoost += 600 * _getSpreadedBoost(hoodSize, min);}
        console.log("category 9, boost %d", min);
      }
    ...
    function _getSpreadedBoost(uint256 hoodSize, uint256 stackedBoost) internal view returns (uint256) {
      ...
      uint256 spreadedBoost = 1000 * stackedBoost * MAX_HOOD_SIZE / Math.max(hoodSize, MAX_HOOD_SIZE);

      console.log('spreadedBoost %d', spreadedBoost);
    ...
    function getTokenBoosts256(uint256 tokenId) private view returns (uint256) {
      unchecked {
        ...
        console.log("Token #: %d, mem: %s", tokenId, mem);
