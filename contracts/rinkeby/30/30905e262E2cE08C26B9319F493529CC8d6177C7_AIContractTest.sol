...
/*
    KC - this is going to be an erc721a, free, 3 per wallet
*/
...
contract AIContractTest is ERC721, Ownable, ReentrancyGuard {
    ...
    // metadata
    string public baseURI = "ipfs://bafybeieiadvkcosqpjuhy4exkn4qw4urb2u2netwitkktm7z35n4lojwfa";

    // config
    mapping(address => uint256) public mintsPerWallet;
    address private withdrawAddress = address(0);

    constructor() ERC721("aicontracttest", "TESTY") {}
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        require(maxTotalSupply + _amount <= maxTotalSupply, "Exceeds total supply");
