...
import "./UniswapV2ERC20Mock.sol";
import "./libraries/Math.sol";
import "./libraries/UQ112x112.sol";

contract UniswapV2PairMock is UniswapV2ERC20Mock {
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        require(balance0 <= uint112(int112(int8(-1))) && balance1 <= uint112(int112(int8(-1))), 'UniswapV2: OVERFLOW');
...
contract UniswapV2ERC20Mock {
    ...
    function transferFrom(address from, address to, uint value) external returns (bool) {
        if (allowance[from][msg.sender] != uint(int256(int8(-1)))) {
