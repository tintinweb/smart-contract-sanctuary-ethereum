...
contract RichMamaContract is ERC721A, ReentrancyGuard, Ownable, Pausable {
    ...
    // used to limit total mint amounts by an address
    mapping (address => uint256) public totalMintsPerAddress;

    constructor() ERC721A("RichMama Token", "RMT") {
        setUriPrefix("ipfs://QmfMJCC4gMcZree5Z7XQvPvZHivAGzF8VTqgYHvjetH6uf/RichMama/TokenURI");
    }
    ...
    function mint(
        ...
        unchecked {
            ...
            // First, balanceOf is less than maxMintAmountPerAddress, and _totalMinted is less than maxSupply
            // So balanceOf(msg.sender) + _mintAmount is less than 2 * maxMintAmountPerAddress,
            // and _totalMinted() + _mintAmount is less than maxSupply， neither number will overflow.

            require(totalMintsPerAddress[msg.sender] + _mintAmount <= _maxAllowedMints, "MINT_TOO_MUCH");
        ...
        // ALL checks passed
        totalMintsPerAddress[msg.sender] += _mintAmount;
