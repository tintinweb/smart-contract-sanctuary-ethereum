...
contract Dragonsz is ERC721A, Ownable, ReentrancyGuard {

    using Strings for uint256;

    uint256 public MAX_SUPPLY = 100;
    uint256 public MAX_PUBLIC_MINT = 100;
    uint256 public MAX_PER_TRX = 1;
    ...
    constructor() ERC721A ( "Dragonz", "DGZ" ) {
        setTokenUri( "ipfs://QmTTnjKUmnbaxjEWsDacTdQ3sX6chpNoZFi3vQTTC89GNv/" );
    }
