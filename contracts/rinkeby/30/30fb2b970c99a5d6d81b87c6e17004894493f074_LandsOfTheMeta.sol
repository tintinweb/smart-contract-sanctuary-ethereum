...
Biggest P2E Game of 2022 - Already released, based team. 
...
contract LandsOfTheMeta is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lands Of The Meta", "LOTM") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xE58BaF94B10122c056C3F0514Cd9C5331f82dDEb); // set as marketing wallet
        devWallet = address(0xE58BaF94B10122c056C3F0514Cd9C5331f82dDEb); // set as dev wallet
