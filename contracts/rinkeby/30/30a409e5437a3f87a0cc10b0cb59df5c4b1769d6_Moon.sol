...
contract Moon is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Moon", "MO") {
        // Start token Id at 1.By default s start at 0.
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmUhpzRhmTz6UYZVGATR3WLEaLsad5aKqVaAKUxCFwq5dH/";
    }

    function safeMint(address to) public payable{

        require (totalSupply() < Max_Supply, "cant't mint anymore tokens. ");
