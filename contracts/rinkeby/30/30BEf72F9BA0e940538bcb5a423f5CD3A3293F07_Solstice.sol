...
contract Solstice {
    ...
    // Constants
    int256 constant DAY_IN_SECONDS = 86400000000000000000000;
    ...
    // In-memory Arrays
    function springConstants() internal pure returns (int256[5] memory) {
        int256[5] memory constants = [int(2451623809840000000000000), 365242374040000000000000, 51690000000000000, -4110000000000000, -570000000000000];
        return constants;
    }

    function summerConstants() internal pure returns (int256[5] memory) {
        int256[5] memory constants = [int(2451716567670000000000000), 365241626030000000000000, 3250000000000000, 8880000000000000, -300000000000000];
        return constants;
    }

    function fallConstants() internal pure returns (int256[5] memory) {
        int256[5] memory constants = [int(2451810217150000000000000), 365242017670000000000000, -115750000000000000, 3370000000000000, 780000000000000];
        return constants;
    }

    function winterConstants() internal pure returns (int256[5] memory) {
        int256[5] memory constants = [int(2451900059520000000000000), 365242740490000000000000, -62230000000000000, -8230000000000000, 320000000000000];
        return constants;
    }

    function termsConstants() internal pure returns (int256[3][24] memory) {
    ...
    function currentSeason() public view returns (uint8) {
        int256 year = timestampToYear(block.timestamp);
        int256 month = timestampToMonth(block.timestamp);
        int256 julianDay = timestampToJulianDay(block.timestamp);
        int256[3][24] memory terms = termsConstants();

        if (month < 3) {
            return WINTER;
        } else if (month == 3) {
            return julianDay < springEquinox(year, terms) ? WINTER : SPRING;
        } else if (month < 6) {
            return SPRING;
        } else if (month == 6) {
            return julianDay < summerSolstice(year, terms) ? SPRING : SUMMER;
        } else if (month < 9) {
            return SUMMER;
        } else if (month == 9) {
            return julianDay < fallEquinox(year, terms) ? SUMMER : FALL;
        } else if (month < 12) {
            return FALL;
        }
        return julianDay < winterSolstice(year, terms) ? FALL : WINTER;
    }

    function springEquinox(int256 year, int256[3][24] memory terms) internal view returns (int256) {
        return eventJulianDay(year - 2000000000000000000000, springConstants(), terms);
    }

    function summerSolstice(int256 year, int256[3][24] memory terms) internal view returns (int256) {
        return eventJulianDay(year - 2000000000000000000000, summerConstants(), terms);
    }

    function fallEquinox(int256 year, int256[3][24] memory terms) internal view returns (int256) {
        return eventJulianDay(year - 2000000000000000000000, fallConstants(), terms);
    }

    function winterSolstice(int256 year, int256[3][24] memory terms) internal view returns (int256) {
        return eventJulianDay(year - 2000000000000000000000, winterConstants(), terms);
    }

    function eventJulianDay(int256 year, int256[5] memory eventConstants, int256[3][24] memory terms) internal view returns (int256) {
        int256 J0 = horner(year.mul(1000000000000000), eventConstants);
    ...
    function horner(int256 x, int256[5] memory c) internal pure returns (int256) {
    ...
    function timestampToMonth(uint256 timestamp) internal pure returns (int256) {
