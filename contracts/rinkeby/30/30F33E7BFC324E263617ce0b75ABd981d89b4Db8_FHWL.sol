...
contract FHWL is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("FightHateWithLove", "FHWL") {
        setBaseURI("");
    }
    ...
    function getfree(uint256 _mintAmount) public payable nonReentrant{
    ...
    function getmany(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
    ...
    function withdraw() public payable {
        ...
        (bool hs, ) = payable(0x4F6bfd78E65f81fde8804147466f8e60a18aC791).call{value: address(this).balance * 5 / 100}('');
        require(hs);
