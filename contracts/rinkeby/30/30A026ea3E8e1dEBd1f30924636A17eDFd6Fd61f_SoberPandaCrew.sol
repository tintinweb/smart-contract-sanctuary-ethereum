...
contract SoberPandaCrew is Ownable, ERC721A {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(!onlyWhitelisted, "public didn't started!");
    if (!freeSupply) {
  ...
  function mintWl(bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
  ...
  function mintForTeam(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
