...
// now want to transact some ERC721 token for some native ETH. It works as follows:
//
// 1. Seller initiates Handshake by specifying NFT, Price, and target Buyer (Seller is prompted to give VF Protocol "transferFrom" Approval)
...
// 3. Seller withdraws ETH from VFProtocolv0 when convenient for her
// 
...
// Core data structure for Handshake
  ...
  constructor() payable {
    owner = payable(address(0x3AFA32FDbbe2eF9118Cdf020ae972880C00Fd61E)); // Hard code owner address for emergency pause/withdrawal
  }
