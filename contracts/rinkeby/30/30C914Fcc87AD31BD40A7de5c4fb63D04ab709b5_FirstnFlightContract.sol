...
contract FirstnFlightContract is ERC721AQueryable, AccessControl, ReentrancyGuard {
  ...
  constructor(
    ...
    _setRoleAdmin(COLLECTION_ADMIN_ROLE, COLLECTION_ADMIN_ROLE);
  ...
  modifier onlyAdmin() {
    require(hasRole(COLLECTION_ADMIN_ROLE, msg.sender), "Caller does not have admin role!");
    _;
  }
  ...
  function withdraw() public payable nonReentrant {
    ...
    require(success);
    require(hasRole(WITHDRAW_ROLE, msg.sender), "Caller does not have withdraw role!");
  }
