...
import "./ERC20Voteupgradeable.sol";


contract Crucible is  MinterRole, ERC20SnapshotUpgradeable, ERC20VotesUpgradeables , ERC20CappedUpgradeable, ERC20BurnableUpgradeable,
    ...
    // @dev to have a role of mint , has to be set as a mint role
    ...
    // @title Flash fee setter
    // @author Eugene
    // @notice set Flash fee for the token of flash mint functionality
    ...
    // @title FlashFeeReceiver setter
    // @author Eugene
    // @notice set the flash fee receiver for the flash loan funcionalities.
    // @dev in order to change the receiver dev has to change the address below function.
     ...
     function _afterTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC20Upgradeable,ERC20VotesUpgradeables) {
        super._beforeTokenTransfer(from, to, amount);
    }


     function _burn(address account, uint256 amount) internal virtual override(ERC20Upgradeable, ERC20VotesUpgradeables) {
        super._burn(account, amount);

    }


     function _mint(address account, uint256 amount) internal virtual override(ERC20Upgradeable, ERC20VotesUpgradeables,ERC20CappedUpgradeable) {
 ...
 */
abstract contract ERC20VotesUpgradeables is Initializable, IVotesUpgradeable, ERC20PermitUpgradeable {
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        ...
        if(_delegates[account] == address(0x0)){
