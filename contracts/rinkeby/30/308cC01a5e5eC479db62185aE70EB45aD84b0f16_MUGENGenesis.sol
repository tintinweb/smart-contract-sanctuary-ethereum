...
contract MUGENGenesis is ERC721A('MUGENGenesis', 'MG'), Ownable {
    enum Phase {
        BeforeMint,
        preMint,
        PublicMint
    ...
    address public constant withdrawAddress = 0x351d7e39D36b4e250157D56f7bAC9BeF7365da8f;
    uint256 public constant maxSupply = 5;
    uint256 public constant publicMaxPerTx = 5;
    string public constant baseExtension = '.json';

    string public baseURI = 'ipfs://QmS6cnEJ676BQz2t7sLVwkzXXa6VRbeCY1gVLgmziJmh1i/';
    ...
    constructor() {
        limitedPerWL[Phase.preMint] = 3;
        costs[Phase.preMint] = 0.05 ether;
        costs[Phase.PublicMint] = 0.07 ether;
    }
