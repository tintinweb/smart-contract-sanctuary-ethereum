...
//*********************************************************************//
//
//  __   __   __  ___  __   __               __      __   __        __        __               __      ___     __   __   __   __            ___  ___ 
// / _` /  \ /__`  |  /  \ /__` | |\ | |__| /  \    |  \ /  \ |  | |__)  /\  |  \ | |\ | |__| /  \    |__     /  ` |__) /  \ /  `  /\  |\ |  |  |__  
// \__> \__/ .__/  |  \__/ .__/ | | \| |  | \__/    |__/ \__/ \__/ |  \ /~~\ |__/ | | \| |  | \__/    |___    \__, |  \ \__/ \__, /~~\ | \|  |  |___
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 30 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmadvpujVT6bNoTQKpxic92euBFunaHH9p5gwVo3YgEj3s/";
...
// File: contracts/GmfcContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GmfcContract is RamppERC721A {
    constructor() RamppERC721A("GMFC", "GMFC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/XbdoVZmz5GKYqvQYIK2j/contract-metadata";
    }
}
