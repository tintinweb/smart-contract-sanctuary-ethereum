...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    event Transfer(address indexed _from, bytes32 indexed _id, uint256 _value);

    function transfer(bytes32 _id) public payable {
        emit Transfer(msg.sender, _id, msg.value);
        players.push(msg.sender);
    }
}
