...
// File: contracts/MasterPfpNFT.sol
    ...
    VRFConsumerBase
{
    ...
    uint256 public charityFeePercent = 50;
    uint256 public totalFeeUnitPercent = 100;

    uint256 public royalityMinterFeePercent = 5;
    uint256 public royalityTeamFeePercent = 5;
    ...
    address public royalityTeamWallet =
    ...
    function withdraw() external onlyOwner {
        ...
        payable(teamWallet).transfer(
            (balance * teamFeePercent) / totalFeeUnitPercent
        );
        payable(chartiyWallet).transfer(
            (balance * charityFeePercent) / totalFeeUnitPercent
        );
    }

    function setFee(
        uint256 _teamFeePercent,
        uint256 _charityFeePercent,
        uint256 _royalityMinterFeePercent,
        uint256 _royalityTeamFeePercent,
    ...
    function mint(uint256 amount) public payable {
        ...
        MintAmountPerPublicAddress[msg.sender] =
            MintAmountPerPublicAddress[msg.sender] +
            amount;
