...
/**
    ...
    15% buy and sell tax, .5% max txn 1% max wallet. 
**/
...
contract anoop is Context, IERC20, Ownable {
	...
	string private constant _name = "Anoop";
	string private constant _symbol = "anp";
