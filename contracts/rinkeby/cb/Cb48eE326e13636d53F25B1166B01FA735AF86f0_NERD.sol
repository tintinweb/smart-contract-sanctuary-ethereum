...
contract NERD is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public ETH_PRICE = 1000000000000000; // 0.001 ETH
    uint256 public FOOD_PRICE = 1000000;
    ...
    constructor(
        ...
        _numberOfPresale[0x76bF03981eDef2Ad6c459BE31cc4Fbe9409E3F6b] = 2;
    ...
    function action_A(uint tokenId) public {
        ...
        require(block.timestamp >= (_timeOfLastAction[tokenId] + 300), "Please wait next action time");
        require(FOOD.balanceOf(msg.sender) >= 5000000000, "FOOD token is not enough");

        FOOD.transferFrom(msg.sender, POOL, 5000000000);
