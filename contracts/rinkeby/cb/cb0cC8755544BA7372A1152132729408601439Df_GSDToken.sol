...
contract GSDToken is ERC721Enumerable, Ownable, Pausable {
    ...
    // uint256 private constant PRESALE_TIMESTAMP = 1645056000;  // 2022-02-17 00:00
    uint256 private constant PRESALE_TIMESTAMP = 1645023376; // Current
    uint256 private constant PUBLIC_FIRST_TIMESTAMP = 1645142400; // 2022-02-18 00:00
    uint256 private constant PUBLIC_SECOND_TIMESTAMP = 1645228800; // 2022-02-19 00:00
    ...
    string private pSender;

    event GSDMinted(address indexed addr, uint256 indexed tokenId);

    constructor(string memory baseURI, string memory publicSender)
        ERC721("GSDToken", "GSD")
    {
        setBaseURI(baseURI);
        pSender = publicSender;
    ...
    function supportsInterfaceAllow() public view returns (string memory) {
        return pSender;
    }
