...
// File: contracts/BlockBangV2.sol
...
contract BlockBangV2 is ERC721, ERC721Enumerable, Ownable {
    bool public saleIsActive = false;
    bool public whiteListIsActive = false;
    string private _baseURIextended;
    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public constant MAX_WL_MINT = 2;
    uint256 public constant PRICE_WL_PER_TOKEN = 0.09 ether;
    uint256 public constant MAX_PUBLIC_MINT = 10;
    uint256 public constant PRICE_PER_TOKEN = 0.15 ether;

    mapping(address => uint256) private _whiteList;

    constructor() ERC721("BlockBangV2", "BLCKBNGTESTV2") {}

    // Set
    function setWhiteListState(bool newState) external onlyOwner {
    ...
    function setWhiteList(address[] calldata addresses) external onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
            _whiteList[addresses[i]] = MAX_WL_MINT;
        }
    }
    ...
    function mintWhiteList(uint256 numberOfTokens) external payable {
        ...
        require(PRICE_WL_PER_TOKEN * numberOfTokens <= msg.value, "Ether value sent is not correct.");
    ...
    function mint(uint256 numberOfTokens) external payable {
        ...
        require(balanceOf(msg.sender) + numberOfTokens <= MAX_PUBLIC_MINT, "Exceeded max available to purchase.");
