...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(address=>uint256) prevReward;
...
contract Mega is ERC721, Ownable {
  ...
  function mint(bytes32[] calldata _merkleProof, uint256[] calldata _position, uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
