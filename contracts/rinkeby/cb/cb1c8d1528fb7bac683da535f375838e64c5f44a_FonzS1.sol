...
// File: contracts/BCNFTA_v1.1.sol
...
contract FonzS1 is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE_PER_TOKEN = 100000000000000000; 
    ...
    //New function all NFT share same 
       function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "https://ipfs.io/ipfs/QmPMy8yo8BXNfgQH77vEkC2N6MKmGBmJbXvHRx5xCoRzwd"; // 1 ?
    }
    /* OLD Base URI
