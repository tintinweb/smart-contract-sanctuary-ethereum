...
import "./SongAlbumNFTTradable.sol";

contract SongAlbumNFTFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice SongAlbum auction contract address;
    ...
    */
    ...
    /// @notice Method for deploy new SongAlbumNFTTradable contract
        ...
        returns (address)
    {
        ...
        SongAlbumNFTTradable nft = new SongAlbumNFTTradable(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing SongAlbumNFTTradable contract
    ...
    /// @notice Method for disabling existing SongAlbumNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
