...
contract StakingToken is ERC20{
    ...
    uint256 public minStakePeriod = 0 days;
    ...
    // STANDARD FUNCTIONS
    constructor( uint256 _stakeTime, uint256 _tokenToWeiRate) ERC20("ERC20STakingToken", "STK") payable{
        owner = msg.sender;
    ...
    function _transfer(address from, address to, uint256 amount) internal override hasSufficientBalance(from, amount){
