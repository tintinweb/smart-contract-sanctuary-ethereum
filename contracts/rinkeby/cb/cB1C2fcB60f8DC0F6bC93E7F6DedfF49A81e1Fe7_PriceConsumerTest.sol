...
contract PriceConsumer {
     ...
     */
    function getLatestPrice(address stock) public view returns (int256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(stock);
...
// File contracts/Cryptoides.sol

pragma solidity ^0.8.0;

contract Cryptoides is ERC721, ERC721Enumerable, PriceConsumer {
    struct TokenJson {
        string big;
        string small;
        string normal;
    ...
    mapping(uint256 => TokenJson) public tokenInfo;
    uint256 public maxSupply;

    Counters.Counter private _idCounter;

    constructor(uint256 _maxSupply)
        ERC721("Criptoydes", "CRPT")
        PriceConsumer()
    {
    ...
    function setTokens() internal {
        tokenInfo[0] = TokenJson(
            "https://res.cloudinary.com/dovstvjim/raw/upload/v1650514211/web3/json/1-big_ra2bks.json",
            "https://res.cloudinary.com/dovstvjim/raw/upload/v1650514211/web3/json/1-normal_v60rtl.json",
            "https://res.cloudinary.com/dovstvjim/raw/upload/v1650514211/web3/json/1-small_b1vtou.json"
        );

        tokenInfo[1] = TokenJson(
            "https://res.cloudinary.com/dovstvjim/raw/upload/v1650514211/web3/json/2-big_bmtld5.json",
            "https://res.cloudinary.com/dovstvjim/raw/upload/v1650514211/web3/json/2-normal_khpjge.json",
            "https://res.cloudinary.com/dovstvjim/raw/upload/v1650514211/web3/json/2-small_pf15lj.json"
        );
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No Cryptoides left :(");
        ...
        returns (string memory)
    {
        ...
        return tokenInfo[tokenId].normal;
    }
...
// File contracts/PriceConsumerTest.sol
...
contract PriceConsumerTest {
    ...
    function getLatestRoundId(address stock) public view returns (uint80) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(stock);
    ...
    function getHistoricalPrice(address stock, uint80 roundId)
        public
        view
        returns (int256)
    {
