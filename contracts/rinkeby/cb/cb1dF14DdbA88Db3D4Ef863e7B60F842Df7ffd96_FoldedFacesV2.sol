...
*/
    ...
    uint256 public constant PUBLIC_START_TIME = 0;
    ...
    bytes32 constant whitelistRoot =
        0x2eecba2f62a5964a09b0587bc014fa5ba23e803982088411ed9c0583bf5c9437;
 ...
 \ \_\ \ \_\  \ \_\  \ \_\\"\_\    \ \_\  \ \_\  \ \_\\"\_\  \ \_____\ 
   ...
   */
    ...
    function mintInternal() internal {
        ...
        require(regularCount < 518, "Minted Out Non Reserved Spots");
 ...
 \ \_____\  \ \__/".~\_\  \ \_\\"\_\  \ \_____\  \ \_\ \_\ 
  \/_____/   \/_/   \/_/   \/_/ \/_/   \/_____/   \/_/ /_/ 
    ...
    function withdraw() external payable onlyOwner {
        uint256 genFunds = (address(this).balance / 100) * 65;
        uint256 toadFunds = (address(this).balance / 100) * 15;
        uint256 irrevFunds = (address(this).balance / 100) * 15;
        uint256 circolorFunds = (address(this).balance / 100) * 5;
        (bool sentT, ) = payable(
            address(0xE4260Df86f5261A41D19c2066f1Eb2Eb4F009e84)
        ).call{value: toadFunds}("");
        require(sentT, "Failed to send to Toad");
        (bool sentI, ) = payable(
            address(0x4533d1F65906368ebfd61259dAee561DF3f3559D)
        ).call{value: irrevFunds}("");
        require(sentI, "Failed to send to Irrev");
        (bool sentC, ) = payable(
            address(0x888f8AA938dbb18b28bdD111fa4A0D3B8e10C871)
        ).call{value: circolorFunds}("");
        require(sentC, "Failed to send to Circ");
        (bool sentG, ) = payable(
            address(0x3D36b6A9DE5222005636e968e468caF11eeCA900)
        ).call{value: genFunds}("");
        require(sentG, "Failed to send GenLight");
    }
}