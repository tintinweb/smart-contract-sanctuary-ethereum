...
interface ITransformedNFT {
    ...
    function tokenOfOwnerByIndex(address _owner,uint256 i) external view returns(uint256);
}
    ...
    ERC721URIStorageUpgradeable
{
   ...
   function transform(
    ...
    function getLatestTransformed(address _owner) public view returns (uint256) {
        uint256 balanceOfUser = _transformedNftContract.balanceOf(_owner);
        uint256 latestTokenId = _transformedNftContract.tokenOfOwnerByIndex(_owner, balanceOfUser - 1);
