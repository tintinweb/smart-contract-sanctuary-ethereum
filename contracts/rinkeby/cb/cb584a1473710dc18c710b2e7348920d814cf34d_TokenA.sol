...
contract TokenA is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        console.log("_isBlackListed[from]: %s", _isBlackListed[from]);
        console.log("_isBlackListed[to]: %s", _isBlackListed[to]);
        require(
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (sender == uniswapV2Pair) {
                ...
                console.log("tradingStartBlock: %s", tradingStartBlock);
