    ...
    AccessControlEnumerable
{
    ...
    */
    ...
    /**
     * @dev Throws if called by any account other than an approved signable minter.
     */
    ...
    function mintDoubleHopUsingMsg(
        address to,
        string memory _tokenURI,
        address payable receiver,
        uint256 basisPoints
        ...
        _mintSingle(msg.sender, tokenId, _tokenURI, receiver, basisPoints);
        _tokenIdCounter.increment();
        safeTransferFrom(msg.sender, to, tokenId);
    }

    function mintDoubleHopUsingParam(
        address hopFrom,
        address hopTo,
        string memory _tokenURI,
        address payable receiver,
        ...
        _mintSingle(hopFrom, tokenId, _tokenURI, receiver, basisPoints);
        _tokenIdCounter.increment();
        safeTransferFrom(hopFrom, hopTo, tokenId);
    }
    ...
    function mintSignable(
        ...
        require(hasRole(MINTER_ROLE, to), "Signature not generated by minter role");
