...
*/
contract Timeout is ITimeout, ERC721A, Ownable, ERC2981, ReentrancyGuard {
  ...
  //temporary public for tests, to be removed
  uint16 public indexEvolution2Blue;
  uint16 public indexEvolution2Pink;
  uint16 public indexEvolution3Blue;
  uint16 public indexEvolution3Pink;
  uint16 public indexEvolution4Blue;
  uint16 public indexEvolution4Pink;
  uint16 public indexEvolution5Blue;
  uint16 public indexEvolution5Pink;
  uint16 public indexEvolution6Blue;
  uint16 public indexEvolution6Pink;
  uint16 public indexEvolution7Blue;
  uint16 public indexEvolution7Pink;

  //temporary deleted constant and put public foor tests, to put back
  uint16 public maxSupplyEvolution2PinkAndBlue = 2048;
  uint16 public maxSupplyEvolution3PinkAndBlue = 1024;
  uint16 public maxSupplyEvolution4PinkAndBlue = 512;
  uint16 public maxSupplyEvolution5PinkAndBlue = 256;
  uint16 public maxSupplyEvolution6PinkAndBlue = 128;
  uint16 public maxSupplyEvolution7PinkAndBlue = 64;

  uint16 private constant portionForClaim = 1294;

  uint16 private index = 2506;
  uint16 private maxSupplyPrivateSale = 1901;
  uint16 private maxSupplyPremint = 2505;

  uint16 public phaseForClaim;

  address private WhiteListSigner = 0x831F13996DB0dc7321b09c8340432cF0E24F4d51;
  ...
  */
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(ERC2981, ERC721A) returns (bool) {
    return interfaceId == type(IERC2981).interfaceId // interface ID for royalties
      ...
      || interfaceId == 0x5b5e139f // interface ID for ERC721Enumerable.
  ...
  function setIndexMintForTest(uint16 newValue) external {
    indexMint = newValue;
  }
  function getIndexMintForTest() external view returns(uint16) {
    return indexMint;
  }
  function setMaxSupplyEvo2(uint16 newValue) external {
    maxSupplyEvolution2PinkAndBlue = newValue;
  }
  ...
  */
  ...
  /**
  * @notice premint mint 2505 for the owner1.
  *
  * Requirements:
  *
  * - Only owner of contract can call this function
