...
contract MoodFlippers is ERC721A, ERC2981, Ownable {
  ...
  mapping(SaleState => uint256) public prices;
  ...
  constructor(
    ...
    prices[SaleState.Stage1] = 0.075 ether;
    prices[SaleState.Stage2] = 0.12 ether;
    prices[SaleState.Public] = 0.16 ether;
  ...
  function mintListed(
    ...
    if (msg.value != prices[saleState] * amount) revert IncorrectAmountError();
