...
contract DSP is ERC721A, Ownable, ReentrancyGuard {
    string public baseTokenURI;
    bytes32 whroot;
    uint256 public collectionsize = 555;
    uint256 public reservedsize = 20;
    uint256 public maxmint = 1;
    uint256 public whitelistprice = 0.000001 ether;
...
constructor() ERC721A("Dart Signature Pass", "DSP",3,555)
{}
	...
	outstr = string(abi.encodePacked('{"name": "Dart Signature Pass #',Strings.toString(tokenId),'", "attributes": [{"trait_type": "Segments","value": "',Strings.toString(segments),'"},{"trait_type": "Start color","value": "#',makecolor(eltx),'"}, {"trait_type": "Stop color","value": "#',makecolor(elty),'"}],"image": "data:image/svg+xml;base64,',outstr,'"}'));
