...
import "./libraries/ERC1155URIStorage.sol";

contract AetherERC1155 is IERC2981, ERC1155URIStorage, Ownable {
    struct Royalty {
        address recipient;
        uint16 value;
    }
    ...
    uint16 public maxRoyalty = 1000; // 10% with 10000 precision point
    ...
    {
        Royalty memory _royalty = royalty[_tokenId];
        uint16 royaltyValue = _royalty.value > maxRoyalty
            ? maxRoyalty
            : _royalty.value;
        receiver = _royalty.recipient;
        royaltyAmount = receiver == address(0)
            ? 0
            : (_salePrice * royaltyValue) / 10000;
    }

    // =========================================================== MODIFIER ===========================================================

    modifier onlyWhitelist() {
        require(whitelist[msg.sender] == true, "AetherERC1155: WHITELIST");
        _;
    }
    ...
    function _setTokenRoyalty(
        ...
        require(value <= maxRoyalty, "AetherERC1155: INVALID ROYALTY");
        royalty[tokenId] = Royalty(recipient, value);
    }
    ...
    function whitelistMintBatch(
        ...
        require(
            ...
            "AetherERC1155: Incorrect parameter length"
        );
        require(
        ...
        _mintBatch(msg.sender, _tokenIds, amounts, data);
        _setTokenURIBatch(_tokenIds, metadataURIs);
        return _tokenIds;
    }
    ...
    function setRoyalty(
        ...
        require(msg.sender != address(0), "AetherERC1155: INVALID SENDER");
        require(
            msg.sender == royalty[tokenId].recipient || msg.sender == owner(),
            "AetherERC1155: INVALID SENDER"
        );
        _setTokenRoyalty(tokenId, newRecipient, newRoyalty);
    }
