...
contract SlotsV1 is VRFConsumerBaseV2 {
    ...
    event Prize(address player, uint256 value, uint256 prize);
    ...
    function fulfillRandomWords(
        ...
        if((randomWords[0] % 10) + 1 == (randomWords[1] % 10) + 1 && (randomWords[1] % 10) + 1 == (randomWords[2] % 10) + 1) {
            prize = 2;
            winnings[player] += prize * value;
        }

        emit Prize(player, value, prize);
