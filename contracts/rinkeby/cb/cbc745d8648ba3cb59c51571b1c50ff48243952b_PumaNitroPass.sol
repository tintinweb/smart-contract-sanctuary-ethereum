...
contract PumaNitroPass is ERC721A, Ownable {
    ...
    // Addresses
    address public NitroTokenContractString = 0x6aB9F933A43D1C2306013d826f247916A9a79776;
    IERC721Enumerable constant NitroTokenContractEnumerable = IERC721Enumerable(0x6aB9F933A43D1C2306013d826f247916A9a79776);
    ...
    function claim() external {
        ...
        for (uint256 i; i < NitroTokenContractEnumerable.balanceOf(msg.sender); i++) {
            ...
            PumaNitroToken(NitroTokenContractString).burnNitroTokenForNitroPass(tokenId);
            mintCount++;
