...
function presaleMint(address account, uint256 _mintAmount, bytes32[] calldata _proof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) isValidMerkleProof(_proof) 
    onlyAccounts {
...
function publicSaleMint(address account, uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) onlyAccounts {
