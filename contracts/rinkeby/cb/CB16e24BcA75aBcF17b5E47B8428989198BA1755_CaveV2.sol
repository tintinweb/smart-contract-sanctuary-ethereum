...
contract CaveV2 is ERC721A, Ownable {
  ...
  modifier callerIsUser() {
    ...
    function _beforeTokenTransfers(address from,address to,uint256 _startTokenId, uint256 quantity)
        internal
        virtual override
       {
    ...
    function mint(uint64 _mintAmount, bytes calldata signature) public callerIsUser {
        ...
        ).recover(signature), "Signer address mismatch.");//verify if address is whitelisted
