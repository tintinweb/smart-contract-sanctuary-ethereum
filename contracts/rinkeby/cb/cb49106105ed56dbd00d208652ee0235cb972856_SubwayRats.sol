...
contract SubwayRats is ERC721AQueryable, Ownable {
    ...
    function setMintAmount(uint256 _newMintAmount) public onlyOwner {
        require(_newMintAmount <= 5, "max 5 per mint");
    ...
    function setMaxRats(uint256 _nextBatchSize) public onlyOwner {
        require((MAX_RATS + _nextBatchSize) <= 10000, "max 10,000 total NFTs");
        MAX_RATS =  MAX_RATS + _nextBatchSize;
    }
    ...
    function whitelistMint(bytes32[] calldata _proof) public {
        ...
        require(_totalMinted() < MAX_RATS, "All Rats have already been minted!");
    ...
    function ownerMint(uint amount) public onlyOwner {
        require(_totalMinted() + amount <= MAX_RATS, "Too many rats!");
