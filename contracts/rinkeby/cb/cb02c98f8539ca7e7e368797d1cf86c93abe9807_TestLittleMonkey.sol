...
contract TestLittleMonkey is ERC721Delegated, ReentrancyGuard {
  ...
  uint256 public constant MAX_MULTIMINT = 1200;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1200 at a time");
