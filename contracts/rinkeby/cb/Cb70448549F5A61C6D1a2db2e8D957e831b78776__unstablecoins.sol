...
contract _unstablecoins is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
    ...
    constructor(address signer_, string memory baseUri_) ERC721("unETH", "USC") {
        _signer = signer_;
        _baseUri = baseUri_;
    }
    ...
    function mintTo(
        ...
        validateSignature(tokenId, price, hash, signature);
