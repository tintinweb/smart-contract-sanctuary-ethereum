...
contract BondingSurface {
	...
	uint256 public B = 1_000_000_000_000; // 10e-7
	...
	function tokenOut(uint256 _in, uint256 _ca) public view returns (uint256) {
		...
		console.log("inv2", inv2);
		uint256 inner = inv1 - inv2;
		console.log("inner", inner);
		console.log("BCr", BCr);
		console.log("inv BCr", inv(BCr));
	...
	/// @param _supply Current TPG supply
	function tokenIn(uint256 _out, uint256 _ca, uint256 _supply) public view returns (uint256) {
		if (_out >= _supply) return _ca;
		console.log("tokenIn");
		...
		console.log("ca2inv", ca2inv);

		console.log("BCrM + ca2inv", BCrM + ca2inv);
		console.log("inv BCrM + ca2inv", inv(BCrM + ca2inv));
