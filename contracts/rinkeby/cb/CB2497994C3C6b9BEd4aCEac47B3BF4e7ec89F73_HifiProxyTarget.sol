...
contract HifiProxyTarget is IHifiProxyTarget {
    ...
    /// @inheritdoc IHifiProxyTarget
    function removeLiquidityAndWithdrawUnderlying(IHifiPool hifiPool, uint256 poolTokensBurned) public override {
        // Transfer the LP tokens to the DSProxy.
        hifiPool.transferFrom(msg.sender, address(this), poolTokensBurned);
        ...
        // Calculate how much underlying will be withdrawen,
        uint256 underlyingAmount = normalize(hTokenReturned, hifiPool.underlyingPrecisionScalar());

        // Withdraw underlying in exchange for hTokens.
        IHToken hToken = hifiPool.hToken();
        hToken.withdrawUnderlying(underlyingAmount);
    ...
    function removeLiquidityAndWithdrawUnderlyingWithSignature(
        ...
        permitInternal(hifiPool, poolTokensBurned, deadline, signatureLPToken);
        removeLiquidityAndWithdrawUnderlying(hifiPool, poolTokensBurned);
    }
...
interface IHifiProxyTarget {
    ...
    /// @param hifiPool The address of the HifiPool contract.
    /// @param poolTokensBurned The amount of LP tokens to burn.
    function removeLiquidityAndWithdrawUnderlying(IHifiPool hifiPool, uint256 poolTokensBurned) external;
