// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint256 public allowListPrice = 0.010 ether;
...
TIERS[6] = [84,106,143,170,192,307];
        ...
        receive() external payable {
            ...
            mint(msg.value / publicMintPrice, emptyArr);
        }
        ...
        function mint(uint256 _count, bytes32[] memory merkleProof)
            public
            payable
            nonReentrant
            whenMintActive
        ...
        function onAllowList(address addr, bytes32[] memory merkleProof) public view returns (bool) {
