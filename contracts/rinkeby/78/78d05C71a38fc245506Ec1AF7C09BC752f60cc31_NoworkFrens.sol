...
contract NoworkFrens is Ownable, ERC721A, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 1;
    uint256 MAX_MINT_ETHEREUM = 10000;
    uint256 _reserved = 100;
    uint256 _price = 0.01 ether;
    bool public _paused = true;
    uint256 gasForDestinationLzReceive = 350000;

    address a1 = 0xB159360D79869D524D87f1947e59445156Dcbb04;
    address a2 = 0x97bB393E972fC8480e9fb46352e767C426F30902;
    address a3 = 0xBFB9AC25EBC9105c2e061E7640B167c6150A7325;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721A("NoworkFrens", "NWF")
    {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens < 20, "NoworkFrens: Max 20 NFTs per transaction");
        require( msg.value >= _price * numTokens,  "Ether sent is not correct" );
        require(
            nextTokenId + numTokens <= MAX_MINT_ETHEREUM - _reserved,
            "NoworkFrens: Mint exceeds supply"
        );
        _safeMint( msg.sender, numTokens);
        nextTokenId = nextTokenId + numTokens;
    }
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "NoworkFrens: msg.value not enough to cover messageFee. Send gas for message fees"
        );
