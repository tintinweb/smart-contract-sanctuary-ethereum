...
// File: contracts/DegenDemons.sol
...
contract Demon_Test is Ownable, ERC721A, ERC2981, ReentrancyGuard {
    uint96 public ROYALTY_PERCENTAGE = 250;

    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public MAX_SUPPLY = 3333;
    uint256 public MAX_TX_PER_WALLET = 3;
    uint256 public SALE_PRICE = 0.003 ether;

    bool public SALE_ACTIVE = false;
    string public baseURI = "ipfs://QmZZRSUMSrz4mdbbZcTV9p2VfVoUyWouCdVo6NFUv9WRjd/";
    ...
    constructor() ERC721A("Demon Test", "DeTe") {
        ...
        isUser
    {
        ...
        require(SALE_ACTIVE, "Mint not active");
