...
abstract contract PrimaryMarketplace is Marketplace {
     ...
     * @param message The transaction message.
     */
    function _transferPaymentWETH(TransactionMessage calldata message)
        internal
        override
    {
        uint256 commissionAmount = (
        ...
        WETH.transferFrom(message.buyer, address(this), commissionAmount);
        WETH.transferFrom(message.buyer, message.seller, message.payment - commissionAmount);
    }
    ...
    ReentrancyGuard
{
    ...
    /**
     * IERC-20 object of the WETH address that will be used when using WETH for 
     * market transactions.
     */
    IERC20 WETH;
     ...
     *     that will be used for verifying the royalty numerator of a
     *     transaction.
     * @param wethAddress_ The contract address of the Warped Ethereum smart contract;
     */
    constructor(
        string memory name,
        string memory version,
    ...
    /**
     * Abstract internal function responsible for transferring WETH payments to the
     * seller and an additional royalty receiver (if applicable).
     *
     * @param message The transaction message.
     */
