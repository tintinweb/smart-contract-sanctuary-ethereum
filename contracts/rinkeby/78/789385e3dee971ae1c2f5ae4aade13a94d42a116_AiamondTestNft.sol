...
contract AiamondTestNft is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable, ContextMixin, NativeMetaTransaction {
    ...
    uint256[] public supplies = [5, 100, 400, 5000];

    string public url = "ipfs://QmZKJmG5xYgtUHC62n4rJ9AAnpjrAsrvZVh974AaQ7pZwa/";
    ...
    */
    ...
    function initialize() initializer public {
        __ERC1155_init(string(abi.encodePacked(url, "metadata/{id}.json")));
        __Ownable_init();
