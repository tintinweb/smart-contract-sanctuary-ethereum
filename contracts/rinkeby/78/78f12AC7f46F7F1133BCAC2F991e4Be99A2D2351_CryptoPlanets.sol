...
import '@openzeppelin/contracts/access/Ownable.sol';
    ...
    // check on need of reimplementing tokenURI() function

    // IMPORTANT:
    // Check on how I can save mor gas: but using the ERC721 functions and variables or just creating my own for my contract

    // Create transfer function and loom up the best implementation, wether it is best to only allow the owner to call it
...
contract CryptoPlanets is ERC721, Ownable {
    ...
    function withdraw() external onlyOwner { // understand what are the wayd of withdrawing the money
