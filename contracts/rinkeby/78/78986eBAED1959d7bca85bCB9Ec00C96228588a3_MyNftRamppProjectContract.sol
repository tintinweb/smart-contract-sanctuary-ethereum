...
abstract contract TimedDrop is Ownable {
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656563520;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x145f0BDE83efAb5b2EBB3f82D841d7cCd57e53A6];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieb7fgnw7zi6yoaay2ds5v225e37j6oatqcsv2m7ztf4v4pvihqke/";
