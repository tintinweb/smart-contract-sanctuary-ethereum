...
contract Colornomics is ERC721, ERC721URIStorage, Ownable, Pausable {    
    ...
    function mint(uint256 color) public payable {      
        require(msg.value >= mintPrice, "Should be paid for minting!"); 
    ...
    function mintBatch(uint256[] memory colors) public payable {      
        require(colors.length > 0, "Invalid Param");
