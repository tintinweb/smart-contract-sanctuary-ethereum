...
contract NFT_COLLECTION is ERC1155, Ownable {
    ...
    function whitelistMint() public payable {
        ...
        require(!whitelistMinted[msg.sender]);

        team.transfer(msg.value / 2);
        dev.transfer(msg.value / 2);


        _mint(msg.sender, idCounter, 1, "NFT");
        idCounter++;
