...
contract CreatorsoftheEnd is ERC721Delegated, ReentrancyGuard {
    ...
    )
  {
    ...
    allowedMintCountMap[0x556403d47a9C4cf82ce602D633d1d626aa85DA94] = 1;

    allowedMintCountMap[0x702b6F64aFDe820Ca0503A7Cf528ADCF0796C0Cf] = 2;

    allowedMintCountMap[0x0000000000000000000000000000000000000000] = 1;
