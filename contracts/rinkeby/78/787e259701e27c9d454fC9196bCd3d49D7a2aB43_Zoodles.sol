...
// 1. change contructor token name and symbol
...
contract Zoodles is ERC721A, Ownable {
    ...
    function freeMint() public {
        ...
        userMintCount[msg.sender] += maxFreeMintPerWallet;                                                            
    ...
    function paidMint(uint256 quantity) public payable {
        ...
        require(userMintCount[msg.sender] + quantity <= maxMintPerWallet, "max minted");        // max user mint number             // yes
        require(msg.value == quantity * price, "incorrect eth value");                          // check correct eth value sent     // yes
        userMintCount[msg.sender] += quantity;                                                                                      // yes
