...
// import {IERC20new} from "./IERC20.sol";
...
//         if (
//             IERC20new(nativeToken).transferFrom(
//                 msg.sender,
//                 address(this),
//                 amount
//             ) == false
...
//         address to
//     ) internal {
//         if (IERC20new(nativeToken).transfer(to, amountToUnlock) == false)
...
//         emit transferEvent(msg.sender, receiver, msg.value);
//         return senderBalanceAfterTx;
//     }   
