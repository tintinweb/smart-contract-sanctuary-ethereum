...
contract PetRock is ERC721, Ownable {
    ...
    function freeRock(uint256 _amount) public {
        ...
        // Checks that the mintLimit is met
        require(
            (_tokenIdTracker.current().add(_amount)) < mintLimit,
    ...
    function rock(uint256 _amount) public payable {
        // Checks if sale is public or WL-only
        require(
            publicSale,
            "This sale is Whitelist only. Come back later for Public Sale."
        );
    ...
    function withdraw() public onlyOwner {
        ...
        artistWallet.transfer(_balancePortion.mul(4));
    }
}
