    ...
    ERC721HolderUpgradeable
{
    ...
    ) external nonReentrant contractExist(_contractAddress)
    {
        ...
        uint256 _tokenAmount = _transeferToken(_attempt.vaultAddress, _deposit.owner, _deposit.amount);
    ...
    function _fractionalizeNFT(
        ...
        _transeferToken(_tokenVaultAddress, partyVaultWallet, _partyVaultToken);
