...
contract ArtWivesTest is ERC721, Ownable{
  ...
  // function setLinkage(IERC721 _linkage) public onlyOwner {
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    // TODO UPDATE THE PLACEHOLDER TEXT BELOW
                    '", "description": "This is placeholder text", "image": "data:image/svg+xml;base64,',
