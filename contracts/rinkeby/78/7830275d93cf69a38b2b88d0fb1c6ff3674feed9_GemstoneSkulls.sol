...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
       address owner2=  0x8F3033587Ee7560F531bb02C020FB62AbBb979d9;
        require(owner() == _msgSender() || owner2 == msg.sender, "Ownable: caller is not the owner");
        _;
    }
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract GemstoneSkulls is ERC721Enumerable,  Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmcPC19XXPRaCGVAQrYGmzFVqYRFPwqCYLjyArcSTPacBS/" ;
  string private uriSuffix = ".json";
  string public revealURL = "ipfs://QmPZAyXvXF3pYLib7dvTTTsMeqUPpJTDJQAjRd1Mc5o3rg";

  bytes32 public whitelistMerkleRoot = 0xc3956b3de158d0d464960312844be3dfe476f517cdf23ecc13430627a7d8d8c7;
  string private GPSlocation = "abc";

  uint256 public cost = 0.01 ether;
  uint256 public whiteListCost = 0.005 ether;
  uint256 public treasureReward = 0.001 ether;
  uint16 constant public  maxSupply = 11232; 
  ...
  constructor() ERC721("Gemstone Skulls", "GMS") {
    
  }
 
  function setTreasureHunt (string calldata _setGPS , uint _setReward) external onlyOwner{
 treasureReward = _setReward;
GPSlocation = _setGPS;
 gameStart = true;

  }

  function pauseTreasureHunt() external onlyOwner{
      gameStart = !gameStart;
  }
function TreasureHunt (string memory _GPS) external{
    require(gameStart, "Treasure Hunt is not started yet");
    require(balanceOf(msg.sender) > 0 , "You donot own any NFTs");
    require( keccak256(abi.encodePacked(GPSlocation)) == keccak256(abi.encodePacked(_GPS)) , "Wrong Location");
   


     payable(msg.sender).transfer(treasureReward); 
 ...
 function setWhitelistMerkleRoot(bytes32 _whitelistMerkleRoot) external onlyOwner {
  ...
  function setMaxWLMintAmountPerTx(uint8 _maxWLMintAmountPerTx) external onlyOwner {
