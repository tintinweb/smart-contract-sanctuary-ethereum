...
contract StakeNFT {
    ...
    function callStakeToken(address token, uint _tokenID) public {
        require(token == 0x19534c6bC37fD44C93F3a6506E44F32a99670f43, "incorrect NFT to stake"); // hardcode the NFT smart contract to allow only specific NFT into staking, assume 0xd2...d005 as NFT contract address
