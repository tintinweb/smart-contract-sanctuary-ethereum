...
// File: contracts/DEFIT_to test.sol
...
contract Defi is ERC20Detailed, Ownable, ReentrancyGuard{
    ...
    uint256 public rewardYield = 120000000;//to change from 3958125 in 338830 to get 5% month anf 81% yearly
    uint256 public rewardYieldDenominator = 10000000000;

   // uint256 public rebaseFrequency = 604800;//1 week
    
    uint256 public rebaseFrequency = 900;//15 min
...
//Paolo to change RECEIVER 
 ...
 //  address public usdtToken = 0x55d398326f99059fF775485246999027B3197955; //mainnet
   ...
   address public usdtToken = 0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD; //Rinkeby testnet 
    ...
    uint256 private gonSwapThreshold = TOTAL_GONS  / 1000;// da capire

    mapping(address => uint256) private _gonBalances;
    mapping(address => mapping(address => uint256)) private _allowedFragments;

    constructor() ERC20Detailed("DEFI Token", "DEFI", uint8(DECIMALS))
    {
