...
contract HornslethROW is ERC721ABurnable, Ownable {
    ...
    uint256 public MAX_TOKEN_PER_TRANSACTION = 3;
    uint256 public MAX_CROSSMINT_AMOUNT_PER_TX = 1;

    uint256 public PREMINT_PER_ADDRESS_LIMIT = 3;
    ...
    address payable private Admin1 = // Omar hardware public key
    ...
    function crossmint(address to, uint256 _count) external payable {
        require(
    ...
    function setPremintPerAddressLimit(uint256 _limit) public onlyOwner {
        PREMINT_PER_ADDRESS_LIMIT = _limit;
    }

    function setMaxTokenPerTransaction(uint256 _newmaxMintAmount)
        public
        onlyOwner
    {
    ...
    function setCrossmintMaxAmountPerTransaction(uint256 _newMaxCrossmintAmount)
        public
        onlyOwner
    {
