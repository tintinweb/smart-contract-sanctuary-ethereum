    ...
    ERC165Upgradeable
{
    ...
    function updateRewardQuantities(uint256 _index, uint256 _newQuantity) external onlyOwner {
        require(rewardQuantities[_index] <= _newQuantity, "invalid new quantity");
    ...
    function exchange(uint256 _vialAmount, uint256 _rewardIndex, address _rewardToken, uint256 _rewardTokenId) external {
