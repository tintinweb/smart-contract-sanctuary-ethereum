...
contract TestNFTA is Ownable, ERC721A, ReentrancyGuard {
    ...
    modifier checkLimit(uint256 _amount) {
        ...
        require(balanceOf(msg.sender) + _amount <= maxMint, "max NFT per address exceeded");
    ...
    /// Modify
    constructor() ERC721A("Test NFT", "NFT") {
