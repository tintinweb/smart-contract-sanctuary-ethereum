...
contract SynpulseToken is ERC20, Pausable {
        ...
        ERC20("vSynpulse Token of YYYY", "vSYNYY")
    {
        ...
        owner.push(masterContract); // Wallet allowed to pause and unpause the contract
    ...
    function setAdministrator(address administrator)
        public
        onlyMaster
        whenNotPaused
        returns (bool)
