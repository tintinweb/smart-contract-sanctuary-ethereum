 ...
 */
abstract contract SignerRole is ContextUpgradeable {
 ...
 */
abstract contract OperatorRole is ContextUpgradeable {
    using Roles for Roles.Role;
...
abstract contract PauserRole is ContextUpgradeable {
    using Roles for Roles.Role;
 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is ContextUpgradeable, ERC165Storage, IERC721, IERC721Metadata {
 ...
 */
abstract contract ERC721Burnable is ContextUpgradeable, ERC721Base {
    /**
...
contract ERC1155Base is HasSecondarySaleFees, OwnableUpgradeable, ERC1155Metadata_URI, HasContractURI, ERC1155 {
    using SafeMath for uint256;
