...
contract BaseRegistrarImplementation is BaseRegistrar, ERC721 {
    ...
    constructor(FNS _fns, bytes32 _baseNode) public {
        fns = _fns;
        baseNode = _baseNode;
    }
    ...
    function _register(uint256 id, address owner, bool updateRegistry) internal live onlyController returns(uint) {
        require(available(id), "name(tokenId) has exist");
        _mint(owner, id);
        if(updateRegistry) {
...
contract ERC721 is ERC165, IERC721 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        require(owner != address(0), "to != address(0)");
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "not owner or not approve");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "to != msg.sender");
    ...
    */
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "not owner or not approve");
    ...
    */
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), "not Implementation _checkOnERC721Received");
    }
    ...
    */
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        require(ownerOf(tokenId) == from, "ownerOf(tokenId) == from");
        require(to != address(0), "to != address(0)");
