  ...
  function _beforeTokenTransfer(
        ...
        Ownable
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x038f7F8A44768b8A91d8B4489EA952Ed324B5b25);
      ...
      require(mintingOpen == true, "Minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 500");
    ...
    // File: contracts/alohaFrensPineappleContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AlohaFrensPineappleContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Aloha Frens Pineapple", "ALOHA", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmdoaxoQ36tKcc5aD6wrBZyad64RBNW8ipT56kERym7JsL/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/QbgkWO7QY6hDtC9AF4Rj/contract-metadata";
        }
    }