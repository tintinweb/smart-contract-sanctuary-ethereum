...
contract B4 is ERC721, ERC721URIStorage {

    constructor() ERC721("b4", "b4") {
    }
    ...
    function tokenURI(uint256 tokenId) override(ERC721, ERC721URIStorage) view public returns (string memory) {
           //dynamic string
            ...
            string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "blank#', toString(tokenId), '", "description": "b4", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function contractURI() public pure returns (string memory){
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "b4", "description": "b4"}'))));
