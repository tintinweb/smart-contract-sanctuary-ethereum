...
contract ComfyEggs is ERC721, Ownable,ReentrancyGuard {
    ...
    uint256 public MAX_HERO_GALAXY_HEROES = 20;
    uint256 public RESERVED_HERO_GALAXY = 10;
    uint256 public MAX_HERO_GALAXY_HEROES_PER_PURCHASE = 20;
    uint256 public MAX_HERO_GALAXY_HEROES_WHITELIST_CAP = 2;
    uint256 public constant HERO_GALAXY_PRICE = 0.05 ether;
    ...
    {
        tokenSupply.increment(); //start IDs at 1
    ...
    function presaleMint(uint256 _quantity, bytes calldata _whitelistSignature) external payable nonReentrant
    {
        ...
        require(_quantity <= MAX_HERO_GALAXY_HEROES_WHITELIST_CAP, "You can only mint a maximum of 2 for presale");
        require(whitelistAddressMintCount[msg.sender].add(_quantity) <= MAX_HERO_GALAXY_HEROES_WHITELIST_CAP, "This purchase would exceed the maximum Hero Galaxy Heroes you are allowed to mint in the presale");
    ...
    function publicMint(uint256 _quantity) external payable 
    {
        ...
        require(_quantity <= MAX_HERO_GALAXY_HEROES_PER_PURCHASE, "Quantity is more than allowed per transaction.");
    ...
    function _safeMintHeroes(uint256 _quantity) internal 
    {
        ...
        require(tokenSupply.current().add(_quantity) <= MAX_HERO_GALAXY_HEROES, "This purchase would exceed max supply of Hero Galaxy Heroes");
        require(msg.value >= HERO_GALAXY_PRICE.mul(_quantity), "The ether value sent is not correct");
    ...
    function mintReservedHeroes() external onlyOwner 
    {
        ...
        require(tokenSupply.current().add(RESERVED_HERO_GALAXY) <= MAX_HERO_GALAXY_HEROES, "This mint would exceed max supply of Heroes");
