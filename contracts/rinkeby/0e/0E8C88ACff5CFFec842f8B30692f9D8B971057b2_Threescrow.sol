...
contract Threescrow is NFT, ReentrancyGuard {
    ...
    /// @param genesisURI_ URL of Json metadata for the Genesis NFT
    constructor(
        string memory name_,
        ...
        // temp[0] = owner();
        // temp[1] = escrowFactoryContractAddress;

        // createContract(genesisURI_, temp, treasuryAddress);
    }
