...
contract mailman is Ownable, ERC721A {
    ...
    uint256 constant public FREE_MINT_LIMIT_TXN = 10;
    uint256 constant public FREE_MINT_LIMIT = 20;
    ...
    constructor() ERC721A("Mailman", "MM") { }
   ...
   //reduce gas on first transaction
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        //require(quantity == 1, "Only 10 max per transaction");
        require(quantity <=FREE_MINT_LIMIT_TXN, "only 10 per transaction");
