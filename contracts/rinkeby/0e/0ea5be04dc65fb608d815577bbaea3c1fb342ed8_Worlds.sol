...
contract Worlds {
    ...
    function saveWorld(World calldata world) public {
        ...
        worlds[msg.sender].push(world);
    }

    function getWorld(address worldOwner, uint256 worldIndex) public view returns (World memory) {
        return worlds[worldOwner][worldIndex];
    }

    function getWorlds(address worldOwner) public view returns (World[] memory){
        return worlds[worldOwner];
    }
