...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x67a880bAd4e33E0b8d9F76E2D64611A5528F4B05];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmcgCyLuQ4XsiK63szYoQCTtLo732z1unFVkir5B8mfDdz/";
...
// File: contracts/BuenoTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BuenoTestContract is RamppERC721A {
    constructor() RamppERC721A("BuenoTest", "BNOT"){}
}
