...
contract Owland is ERC721, Ownable {
    ...
    constructor() ERC721 ("Owland", "OWLAND") {
        ...
        cycleLengthInSeconds = 60; // 1 day
        rewardsPerCycle = 1 * 10**18;
        lockedCycles = 5;
        preyAddress = 0x73D5484Dd68C33B125a8b0269F827fd0A2617d70; //$hash contract address
    }
...
//Returns true if DOWL had already minted a OWLAND
    ...
    function claimSingleReward(uint256 tokenID) public {
        ...
        IERC20(preyAddress).transfer(msg.sender, amount);
