    ...
    VRFConsumerBaseV2
{
    ...
    signature.
     */
    function _signaturePayload(address to, bytes32 nonce)
        internal
        pure
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        uint256 metadataId = FPEMap.fpeMappingFeistelAuto(tokenId, s_randomSeed, ERC721Psi.totalSupply());
    ...
    */
    function _toggleStaking(uint256 tokenId)
        internal
    ...
    /**
    @notice Changes the Uncode Genesis' staking status
    */
    function toggleStaking(uint256[] calldata tokenIds) external {
        uint256 n = tokenIds.length;
        for (uint256 i = 0; i < n; ++i) {
            _toggleStaking(tokenIds[i]);
        }
    }
