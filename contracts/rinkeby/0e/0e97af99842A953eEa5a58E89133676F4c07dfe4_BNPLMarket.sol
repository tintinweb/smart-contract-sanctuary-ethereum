    ...
    IERC721Receiver
{
    ...
    AssetReceiptRegister internal assetReceiptRegister;
    ...
    function executeAsBytes(
        ...
        this.execute{value: msg.value}(_submitBidArgs, _atomicMatchInputs, _signature);
    ...
    */
    ...
    function execute(
        ...
        uint256 bidId = _submitBid(_submitBidArgs);
        ...
        /// address nftContractAddress = _atomicMatchInputs.addrs[4];

        (
            address nftTokenAddress,
            uint256 nftTokenId
        ) = fetchTokenInfoFromCalldata(_atomicMatchInputs);

        
        console.log(_atomicMatchInputs.uints[4]);
        ...
        require(validateAssetReceiptRegister(nftTokenAddress,nftTokenId), "Asset Receipt Register Invalid");
    ...
    function _verifySignature(
        ...
        console.log(assetBasePrice);
        console.log(_submitBidArgs.lendingToken);
        console.log(_submitBidArgs.principal);
        console.log(_submitBidArgs.downPayment);
         console.log(_submitBidArgs.duration);
          console.log(_submitBidArgs.interestRate);

        address signer = ECDSAUpgradeable.recover(dataHash, _signature);
        require(signer == CRA_SIGNER, "invalid CRA signature");
    }

    function getSignatureDataHash(
        SubmitBidArgs calldata _submitBidArgs,
        address assetContractAddress,
        uint assetTokenId,
        uint assetBasePrice,
    ...
    function fetchTokenInfoFromCalldata(
        AtomicMatchInputs memory _atomicMatchInputs
    ) internal returns (address nftTokenAddress, uint256 nftTokenId) {
        return
            decodeTokenInfo(
    ...
    function decodeTokenInfo(
        ...
        if (useDirectCall) {
            ...
            return (nftTokenAddress, nftTokenId);
        }
    }
 

    function _submitBid(SubmitBidArgs calldata _submitBidArgs)
        internal
        virtual
    ...
    */
    ...
    function onERC721Received(
        ...
        setAssetReceiptRegister( from, tokenId );
    ...
    function setAssetReceiptRegister( address assetContractAddress, uint assetTokenId) internal {
    ...
    function validateAssetReceiptRegister(address assetContractAddress, uint assetTokenId) internal returns (bool){
