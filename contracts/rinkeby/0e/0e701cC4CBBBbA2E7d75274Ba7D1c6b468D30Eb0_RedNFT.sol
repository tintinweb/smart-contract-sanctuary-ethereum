...
/**
 * @title Red NFT Contract
 * @notice This contract handles minting and loaning of Red NFT ERC721 tokens.
 */
contract RedNFT is ERC721A, ReentrancyGuard, Ownable, Pausable {
    ...
    // Internal vars for 1:9 withdraw of balance
    address acct10 = 0xbC8AD3472B54222667e9D6328691cD1cD628426c;
    address acct90 = 0x0fa9Cf7ae3f67480db7928b4e9222688e6ce5A87;
    ...
    /**
     * @notice Construct a Red NFT instance
    ...
    address private signerAddress = 0x6Bc90311983050527c2A49deCdEef4628fBE8797;
