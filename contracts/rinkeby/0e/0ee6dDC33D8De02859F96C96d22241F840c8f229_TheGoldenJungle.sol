...

{
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init("The Golden Jungle", "TGJ");
        __Ownable_init();
     __UUPSUpgradeable_init();
        ...
        iswhiteListSale = true;
        baseURI = "ipfs://bafybeihryhututniumsoddox4zbl3tptcal4tvemrzghk3vis2u7spflpm/";
      
    }
  function get_cost(uint256 _supply) public pure returns(uint256 _Cost){
         uint256  _Cost;
        if(_supply < 5){
          _Cost = 0.001 ether;
        }
