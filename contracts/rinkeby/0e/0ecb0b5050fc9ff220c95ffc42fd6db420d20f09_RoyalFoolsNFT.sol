...
contract RoyalFoolsNFT is ERC721A, Ownable {
  ...
  uint256 private reserveAtATime = 777;
  ...
  constructor(string memory baseURI) ERC721A("royalsfools", "RF") {
    setBaseURI(baseURI);
  }
  ...
  function mint(uint256 _count) public payable saleIsOpen {
   ...
   function withdraw(address payable _to, uint _amount) external onlyAuthorized {
       _to.transfer(_amount);
    }

   function checkBalance() public view onlyAuthorized returns(uint) {
