...
contract NastyBirds is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount)  {
    ...
    require((!presaleClaimed[_msgSender()] && _mintAmount == 1 && msg.value == 0) || msg.value >= cost * _mintAmount, 'Claimed already:Insufficient funds!');
    if (msg.value==0) {
