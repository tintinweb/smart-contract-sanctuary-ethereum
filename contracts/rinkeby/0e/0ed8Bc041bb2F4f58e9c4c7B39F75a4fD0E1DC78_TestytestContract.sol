...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x47B17da238170Ab28A927a4AE01b46fFf6eB1eA7];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x47B17da238170Ab28A927a4AE01b46fFf6eB1eA7;
...
// File: contracts/TestytestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestytestContract is RamppERC721A {
    constructor() RamppERC721A("testytest", "testy"){}
}
