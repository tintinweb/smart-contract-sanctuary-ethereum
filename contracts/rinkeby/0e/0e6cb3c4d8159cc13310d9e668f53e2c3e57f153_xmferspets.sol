...
contract xmferspets is ERC721, Ownable {
    ...
    uint256 public holders_price = 0.01 ether;
    ...
    // Mainnet - 0xB156ADf8523FdC6152aFFdbA076a2143FD7e3c69
    // Rinkeby - 0x12E4c59AA81A94A9FB543C506eb3ec7E1F003093
    ...
    function holders(uint256 _amountToMint, uint256 _typeOfPet) external payable {
        address _caller = _msgSender();
        require(MAX_SUPPLY >= _totalSupply.current() + _amountToMint, "Exceeds max supply");
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(
            abi.encodePacked(
              baseURI,
              reveal ? Strings.toString(_tokenId) : "placeholder",
              baseExtension
            )
        ) : "";
    }
