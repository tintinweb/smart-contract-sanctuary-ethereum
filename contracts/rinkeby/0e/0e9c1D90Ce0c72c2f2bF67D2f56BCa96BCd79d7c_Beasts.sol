...
contract Beasts is ERC721, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
  ...
  function lives(uint256 tokenId) public view returns (uint256) {
    return _beasts[tokenId].lives.current();
  }

  function beastDefeated(uint256 tokenId) public onlyRole(GAME_MASTER) {
    _beasts[tokenId].lives.decrement();
  }
