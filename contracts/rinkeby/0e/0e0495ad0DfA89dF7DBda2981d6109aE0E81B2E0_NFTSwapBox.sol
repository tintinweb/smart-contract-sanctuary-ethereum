    ...
    ERC1155Holder
{
    ...
    uint256 public _historyCounter = 1;
    /**
        SwapContractFeed
        index 0 : Creating SwapBox Unit Fee,
        index 1 : Waiting_for_offers state Fee,
        index 2 : making an offer fee,
        index 3 :  Delisting Unit Fee
     */
    ...
    function setNFTWhiteListAddress(address nftSwapboxWhiteList) public onlyOwner {
    ...
    function setNFTAssetsAddress(address  assets) public onlyOwner {
        NFTSwapBoxAssets = assets;
    }
    ...
    function deListBox(uint256 listBoxID) public payable isOpenForSwap nonReentrant {
        ...
        require(msg.value >= swapBoxes[listBoxID].offers.length * swapConstantFees[3], "Insufficient Fee for deListing Box");
