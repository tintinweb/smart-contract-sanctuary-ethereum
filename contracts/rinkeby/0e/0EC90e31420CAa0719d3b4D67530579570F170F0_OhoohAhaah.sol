...
contract OhoohAhaah is Ownable, ERC721A {
     ...
     *      when BANANA_HARVEST phase starts
     */
    function _beforeTokenTransfers(
        ...
        /**  @dev Enable the banana token harvesting only 
         * when the current phase exceeds banana harvest phase,
         * and banana token address is set.
        */
        if (monkeAdventurePhase >= AdventurePhase.BANANA_HARVEST && bananaToken != address(0)) {
            if (from != address(0)) {
