...
contract Staker {
    ...
    function execute() public deadlineReached(true) notCompleted {
        ...
        // if (address(this).balance < threshold) revert Stake_Below_Threshold();

        if (contractBalance >= threshold) {exampleExternalContract.complete{value: contractBalance}();}
    }
    ...
    function withdraw() public deadlineReached(true) notCompleted {
        ...
        // .call is preferred over .transfer after december 2019
