...
contract QuickAZ is Context, IERC20, Ownable
{
 ...
 mapping (address => bool) public automatedMarketMakerPairs;
  ...
  string private  _name = "RatnamINU";
  ...
  uint8  private  _decimals = 0;
   ...
   address private _marketingAddress = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4; //local
    ...
    uint256 public _tokenAmountForLiquidityTax;
      constructor ()
     {
       ...
       // _tOwned[_developmentWalletAddress]=_tOwned[_developmentWalletAddress].add(_tTotal).mul(20).div(100);
      //  _tOwned[deadAddress]=_tOwned[deadAddress].add(_tTotal).mul(20).div(100); 
      //  _tOwned[owner()]=_tOwned[owner()].sub(_tOwned[_developmentWalletAddress]).sub(_tOwned[deadAddress]);
 ...
 function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
  ...
  (
       ...
       function _getValues(uint256 amount) private returns (uint256) 
       {
        ...
        _tOwned[_marketingAddress] += _taxFee + _developmentFee +  _liquidityFee;
