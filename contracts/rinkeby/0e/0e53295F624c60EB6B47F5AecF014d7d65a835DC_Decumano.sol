...
import "./interfaces/IDecumano.sol";
import "./Errors.sol";

contract Decumano is IDecumano, Ownable, ERC1155, MerkleProofVerify {
    /**
     * @dev See {IDecumano-name}
     */
    string public constant override name = "Decumano NFT";

    /**
     * @dev See {IDecumano-symbol}
     */
    string public constant override symbol = "DCMN";

    /**
     * @dev See {IDecumano-maxSupply}
     */
    uint32 public constant override maxSupply = 300;

    /**
     * @dev See {IDecumano-price}
     */
    ...
    /**
     * @dev See {IDecumano-wallet}
     */
    address public immutable override wallet;

    /**
     * @dev See {IDecumano-totalSupply}
     */
    ...
    function setURI(string memory uri_) public override onlyOwner {
        if (bytes(_uri).length != 0) revert URIAlreadySet();
        _uri = uri_;
        emit URISet(uri_);
    }

    /**
     * @dev See {IDecumano-setRoot}.
     *
