...
contract CHEDELONAUTOV7 is Context, IERC20, Ownable {
    ...
    string private _name = "CHEDELONAUTOV7";
    string private _symbol = "CHEDELONAUTOV7";
    ...
    function setBotDetect(bool _value) external onlyOwner() {
        botDetect = _value;
    }
