    ...
    LootItems
{
    ...
    (bool os, ) = payable(0x417bA3FaC3F0ED2B1c5424658DD549f742A6c196).call{value: address(this).balance}("");
    require(os);
  }
...
contract LootItems is AccessControl, Roles, Settings
{
    ...
    constructor()
    {
        ...
        //            Cost |  Supply Max                     URI   
        addLootItem(0.001 ether, 1000, 1, getTokenURI(Items.FOUNDERS_BASEBALL_BAT)       ,0.0 ether, false);
