...
contract BIFID is ERC777, Ownable {
    ...
    constructor(
        ...
        sender = defaultOperators[0];
    }

    function getSenderImplementer() public view returns (address) {
        return
    ...
    function getManager() public view returns (address) {
        return _ERC1820_REGISTRY.getManager(address(this));
    }

    function setManager() external onlyOwner {
        _ERC1820_REGISTRY.setManager(address(this), sender);
    }
}
