...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0xf1BAc05dD94349Ac33C3295f162201f3918E8507;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf1BAc05dD94349Ac33C3295f162201f3918E8507];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSEGr78xRSrAdDCLGyS6b4ojQM816ryErNWoFVjrioYuH/";
...
// File: contracts/FtwgoblintownContract.sol

pragma solidity ^0.8.0;

contract FtwgoblintownContract is RamppERC721A {
    constructor() RamppERC721A("ftwgoblintown", "ftwg"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vZimiBUWPOk3i9WtoCjQ/contract-metadata";
    }
}