...
contract GameLootEquipment is GameLoot, Ownable {
    ...
    function setTimeLocker(address timeLocker_) public onlyOwner {
        timeLocker = timeLocker_;
    }
    ...
    function setRevealed(uint256 tokenID) external {
        require(msg.sender == gameMinter, "Permission denied");
    ...
    modifier onlyAttrController() {
        require(
            msg.sender == treasure || msg.sender == gameMinter,
            "Permission denied"
        );
        _;
    }
...
abstract contract GameLoot is ERC721, IGameLoot {
    ...
    function tokenURIGame(uint256 tokenID, address registry)
        public
        view
        returns (string memory)
    {
