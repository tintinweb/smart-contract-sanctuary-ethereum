...
contract NotChimpers is ERC721A, Ownable {
	...
	string public prerevealURL = "ipfs.//QmT3rD4RFxZakeHv89jKvsvWT7QM2GPGumLarGD5BjGYyL";
	mapping(address => uint) private _walletMintedCount;

	constructor(address splitterAddress)
	ERC721A('NotChimpers', 'NCHIMP') {
	...
	function contractURI() public pure returns (string memory) {
		return "ipfs://QmT3rD4RFxZakeHv89jKvsvWT7QM2GPGumLarGD5BjGYyL";
	}
	...
	function airdrop(address to, uint count) external onlyOwner {
		require(
			...
			'Not Chimper: Exceeds max supply'
		);
		_safeMint(to, count);
	}
