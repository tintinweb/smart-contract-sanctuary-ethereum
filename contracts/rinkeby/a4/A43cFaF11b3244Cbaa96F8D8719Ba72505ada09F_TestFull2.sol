...
contract TestFull2 is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.api.tokenfy.com/9/metadata/";
	string private _contractURI = "https://tokenfy-production-public.s3.us-east-2.amazonaws.com/9/contract-uri";
	...
	constructor(address _signerAddress) ERC721("TestFull2", "TEST") {
