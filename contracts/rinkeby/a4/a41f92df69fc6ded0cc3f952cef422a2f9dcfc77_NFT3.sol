...
contract NFT3 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public NUM_FREE_MINTS = 6969 - 500;
    ...
    modifier isCorrectFreeMint(uint256 numberOfTokens) {
    ...
    constructor()
        ERC721A("Buy this NFT or Ape'll do it", "Alldoit", 3000, maxSupply)
    {
        _whiteList[0x23BB6Db7D34471FCe9376854D781d55315c3C114] = true;
        _whiteList[0xC639132DB51a4B70c35e641f7CC2af979512a6D8] = true;
        _whiteList[0xcbA6A9B901F44bc9B7cD9546d25041b814088D99] = true;
    }
    ...
    function mint(uint256 numberOfTokens)
        ...
        nonReentrant
        publicSaleActive
        isCorrectFreeMint(numberOfTokens)
        canMintNFTs(numberOfTokens)
        maxMintsPerTX(numberOfTokens)
    {
        require(balanceOf(msg.sender) < MAX_MINTS_PER_TX);
