...
// File: contracts/test_tele_mint.sol
...
contract test_tele_mint is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("tele_test", "tttt") {
    setHiddenMetadataUri("ipfs://QmR8ANovzwdf8UNyPCpn2FqYzEDLmPWV1XpbdKgmFtqA15/hidden.json");
  }

  modifier mintCompliance(uint256 _mintAmount) {
    require(supply.current() + _mintAmount <= maxSupply, "Max supply exceeded!");
    _;
    require(balanceOf(msg.sender) + _mintAmount <= maxMintAmountPerWallet, "Max mint amount per wallet.");
  }
