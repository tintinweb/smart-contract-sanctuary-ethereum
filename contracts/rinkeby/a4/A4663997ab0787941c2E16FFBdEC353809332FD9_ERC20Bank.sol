...
contract ERC20Bank is IERC20Bank, Ownable {
  ...
  event BankInitialized(address indexed _bankOwner, uint256 _bankId, IERC20 indexed _erc20Token, uint256 _initialRewardPool, uint256 _timePeriod, uint256 _initTime);
  ...
  constructor(IERC20 _erc20Token, uint256 _initialRewardPool, uint256 _timePeriod) {
  ...
  function resetBank(IERC20 _erc20Token, uint256 _initialRewardPool, uint256 _timePeriod) external onlyOwner {
  ...
  function _initializeBank(address _bankOwner, IERC20 _erc20Token, uint256 _initialRewardPool, uint256 _timePeriod) private {
  ...
  function _getUserRewardsPerPool(address _user) private view returns (uint256, uint256, uint256) {
    uint256 userReward1;
    uint256 userReward2;
    uint256 userReward3;
