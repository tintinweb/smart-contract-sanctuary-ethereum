...
contract Gooloos is EIP712 {
    ...
    mapping(address => bool) private usedWhitelistedAccounts;
    ...
    function whitelistMint(uint amount, bytes calldata signature) external payable {
        ...
        require(!usedWhitelistedAccounts[msg.sender], "account already used");

        usedWhitelistedAccounts[msg.sender] = true;
        totalSupply += amount;
    }
