...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Boda_Busd_Dividend_Tracker", "Boda_Busd_Dividend_Tracker",_dividentToken) {
    claimWait = 3600;
        minimumTokenBalanceForDividends = 3000000000 * (10**18); //must hold 3,000,000,000+ tokens
    }
 
    function _transfer(address, address, uint256) pure internal override {
        require(false, "Boda_Busd_Dividend_Tracker: No transfers allowed");
    }
 
    function withdrawDividend() pure public override {
        require(false, "Boda_Busd_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Boda contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Boda_Busd_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Boda_Busd_Dividend_Tracker: Cannot update claimWait to same value");
...
contract BodaV2 is ERC20, Ownable {
    ...
    constructor() payable ERC20("BODA", "BODAV2") {
       
    marketingWallet = 0xBccC4da46b90a9aEe3c608322fbAd585beF3D75a;
    busdDividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD Address
