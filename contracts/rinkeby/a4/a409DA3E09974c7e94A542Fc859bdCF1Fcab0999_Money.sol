...
contract Money is ERC20, Votes, Pausable, AccessControlEnumerable, IMoney {
    /// @notice Minter role for access control
    ...
    /**
     * @notice Grant `minter` addess `MINTER_ROLE`
    ...
    /**
     * @notice Destroys `amount` of tokens owned by `user`
    ...
    /**
     * @notice Mint `amount` of tokens to `user`
     * @dev Only callable by address with `MINTER_ROLE`.
     */
