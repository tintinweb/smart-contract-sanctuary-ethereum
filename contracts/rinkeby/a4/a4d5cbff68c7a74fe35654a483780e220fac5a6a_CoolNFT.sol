...
contract CoolNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(string memory _CoolNFT, string memory _CN) ERC721("CoolNFT", "CN") {}

    function _baseURI() internal pure override returns (string memory) {
        return "http://api.coolnft.com/";
    }

    function safeMint(address to, string memory uri) public payable {
        uint256 tokenId = _tokenIdCounter.current();
        require(msg.value >= mintRate, "not enough ether sent.");
        require(totalSupply() < MAX_SUPPLY, "i'm sorry all NFTs have been minted.");
