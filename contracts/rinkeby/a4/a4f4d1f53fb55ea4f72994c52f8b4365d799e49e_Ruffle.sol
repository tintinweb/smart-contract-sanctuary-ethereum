...
// File: contracts/TOKEN/IRuffle.sol
...
// File: contracts/TOKEN/ILottery.sol
...
// File: contracts/NFT/INFT721.sol
...
interface INFT721 {
  ...
  function getBurnEntries(uint256 n) external view returns (uint256);
...
contract Ruffle is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
  ...
  function updateMappings(
    ...
    require(
      tokenIds.length == freeTokens.length,
      "array lengths must match"
    );
