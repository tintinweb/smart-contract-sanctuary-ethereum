...
// File: @openzeppelin/contracts/security/ReentrancyGuard.sol
    ...
    */
    ...
    contract BoredLizards  is ERC721A, Ownable, ReentrancyGuard {
        using Strings for uint256;
    
        constructor() ERC721A("boredlizards", "bl") {}
        ...
        string public hiddenMetadataUri= "ipfs://QmTUTbZfL49VLpXfgwXqynjZuwBeBfZiTSCMp7cJRNk2zv/"; 
        
        uint256 public cost = 0.02 ether; 
        uint256 public WLcost = 0.02 ether;
        uint256 public maxSupply = 999;
        uint256 public wlSupply = 1;
