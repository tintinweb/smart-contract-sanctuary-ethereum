...
contract ItemClub is ItemBase {
  ...
  internal override returns (IStatController.Attributes memory, ItemRarity) {
    ...
    damageMin : 1,
    damageMax : _randomAttribute(2, 2, 1e18, randomNumbers[5]),
    attackRating : _randomAttribute(0, 50, 5e17, randomNumbers[6]),
    defense : 0,
    blockRating : 0,
    life : 0,
    mana : 0,
...
abstract contract ItemBase is NftBase, IItem {
  ...
  function requirementAttributes() external view override returns (IStatController.CoreAttributes memory) {
  ...
  function _requirementAttributes() internal view virtual returns (IStatController.CoreAttributes memory);
