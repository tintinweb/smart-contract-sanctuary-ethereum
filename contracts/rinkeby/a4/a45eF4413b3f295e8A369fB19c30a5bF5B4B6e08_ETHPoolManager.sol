...
contract ETHPoolManager is Ownable {
    ...
    /// @notice Get total user deposited amount
    ...
    /// @notice Only team can add `amount` reward to pool
    function addReward(uint256 amount) external onlyTeam() {
    ...
    /// @notice User deposit `amount` to pool
    function deposit(uint256 amount) external {
        _userPool[msg.sender] = _userPool[msg.sender].add(amount);
