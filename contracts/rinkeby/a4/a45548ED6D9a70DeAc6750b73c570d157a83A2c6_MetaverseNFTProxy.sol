...
contract MetaverseNFTProxy is Proxy, Initializable {
    ...
    constructor(
        ...
        emit MetaverseNFTCreated(_salt, _name, _symbol, _maxSupply);

        // MetaverseNFT(payable(this)).initialize(
        //     0, // _price,
        //     _maxSupply,
        //     _nReserved,
        //     1, // _maxPerMint,
        //     0, // _royaltyFee,
        //     string(abi.encodePacked("https://metadata.buildship.xyz/api/", _name)),
        //     _name,
        //     _symbol,
        //     false
        // );
    ...
    function initialize(
        ...
        //         MetaverseNFT(payable(this)).maxSupply,
        //         MetaverseNFT(payable(this)).reserved,

        //         _maxTokensPerMint,
        //         _royaltyFee,
        //         _uri,

        //         MetaverseNFT(payable(this)).name,
        //         MetaverseNFT(payable(this)).symbol,

        //         false // miscParams & (1 << 1) != 0
        //     )
        // );
