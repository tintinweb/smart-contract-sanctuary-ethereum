...
contract GenIDO is Initializable {
    ...
    function buyAnAllocation(uint256 _pay, uint256 _staked) external {
        ...
        require(tokensPurchased+pur<=totalTokenAllocation, "GenIDO: Sold Out");
    ...
    function getProjectInfo() external view returns (
        ...
        uint256 _tokenRate,
        uint256 _guranteedSaleDurationuint, 
        uint256 _minTokenAllocationPermitted, 
        uint256 _maxTokenAllocationPermitted,
        uint256[] memory _trancheLength,
        uint256[] memory _trancheWeightage) {

        return (underlyingToken, usdt, totalTokenAllocation, tokenPerUsd, guranteedSaleDuration, minTokenAllocationPermitted, maxTokenAllocationPermitted, trancheLength, trancheWeightage);    
    }
