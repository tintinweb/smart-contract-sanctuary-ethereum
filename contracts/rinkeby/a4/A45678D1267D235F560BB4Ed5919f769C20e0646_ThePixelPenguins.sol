...
contract ThePixelPenguins is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 9822;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("The Pixel Penguins", "TPP") {
    setHiddenMetadataUri("ipfs://QmbFjJjKtBr2wgcVQHBGkFhYPdK8NkHkjDaiRvESovdDjz/Hidden.json");
  }
