...
contract Vesting is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    uint public constant ANGEL_ADDRESS_INDEX = 0;
    uint public constant PRESEED_ADDRESS_INDEX = 1;
    uint public constant SEED_ADDRESS_INDEX = 2;
    uint public constant PRIVATE_1_ADDRESS_INDEX = 3;
    uint public constant PRIVATE_2_ADDRESS_INDEX = 4;
    uint public constant PUBLIC_ADDRESS_INDEX = 5;
    uint public constant REWARDS_ADDRESS_INDEX = 6;
    uint public constant TEAM_ADDRESS_INDEX = 7;
    uint public constant ADVISORS_ADDRESS_INDEX = 8;
    uint public constant MARKETING_ADDRESS_INDEX = 9;
    uint public constant RESEARCH_FOUNDATION_ADDRESS_INDEX = 10;
    uint public constant OPERATIONS_ADDRESS_INDEX = 11;
    uint public constant ECOSYSTEM_ADDRESS_INDEX = 12;
    uint public constant LIQUIDITY_ADDRESS_INDEX = 13;
    uint public constant REVERSE_ADDRESS_INDEX = 14;
    ...
    function updateAllocationAddress(uint _allocationIndex, address _address) external onlyAdmin {
