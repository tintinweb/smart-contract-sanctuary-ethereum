...
contract ApolloDAO is Context {
    ...
    uint256 public constant votingCyleLength = 3600;
    ...
    uint256 public maxBalancePercentage = 1;
    /// @notice The amount of Apollo each vote is worth (5M Apollo)
    uint256 public voteAwardMultiplier = 5000000 * 10**9;
    ...
    uint256 public minimumUSDValueToVote = 200 * 10**6;
    /// @notice The minimum value of Apollo in USDC required to nominate
    uint256 public minimumUSDValueToNominate = 200 * 10**6;
