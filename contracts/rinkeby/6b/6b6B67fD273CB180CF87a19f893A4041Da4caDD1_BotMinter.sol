...
contract BotMinter is Managable, Pausable {
    ...
    function breedWithEarlyClaim(uint256 _matronId, uint256 _sireId, address _token, IRewardsSpender.EarlyClaim calldata _earlyClaim, bytes calldata _signature) external whenNotPaused returns(uint256) {
