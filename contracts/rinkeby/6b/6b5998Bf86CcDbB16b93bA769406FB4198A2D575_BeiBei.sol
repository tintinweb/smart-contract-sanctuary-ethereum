...
contract BeiBei is Ownable, ERC721AQueryable, ERC2981 {
    ...
    uint16 public constant MAX_SUPPLY = 666;
    uint16 public constant MAX_GENESIS_SUPPLY = 66;
    uint16 public constant MAX_ALPHA_SUPPLY = 600;
    ...
    uint8 public constant TEAM_MINT_ALPHA_AMOUNT = 40;
            ...
            string(
                abi.encodePacked(
                    isGenesisMap[tokenId]
                        ? "ipfs://Qme2HxE5xHjzf4vSZeiNAYUpgqTeWKiFyBjDHwbbTU2J4s"
                        : "ipfs://QmXTqsw97784aL2UJKv1CD7u13HnC8qaqCyESjntH7DGCq"
                )
            );
    }
