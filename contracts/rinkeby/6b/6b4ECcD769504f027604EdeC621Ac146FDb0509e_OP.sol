...
contract OP is ERC721Enumerable, ERC721Burnable, Administration {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    string private _baseTokenURI;

    constructor() ERC721("VIP (TEST)", "VIP") Administration(msg.sender) {
        _baseTokenURI = "https://api.goatkeepers.sh/v1/meme/metadata/";
        mint(msg.sender, 33);
    }
    ...
    function mint(address to) public virtual isMinter {
        _mint(to);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721, ERC721Enumerable, Administration)
        returns (bool)
    {
