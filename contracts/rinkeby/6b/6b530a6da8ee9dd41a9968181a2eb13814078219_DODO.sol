...
contract DODO is ERC20, Ownable {
    ...
    constructor() ERC20("DODO", "DODO") {
        ...
        maxTransactionAmount = 25_000_000 * 1e18; // 2.5% from total supply maxTransactionAmountTxn
        maxWallet = 25_000_000 * 1e18; // 2.5% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 3) / 10000; // 0.03% swap wallet

        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0x66db73c71Ac391452941f3789E58CC7356FCa506); // set as marketing wallet
        devWallet = address(0x66db73c71Ac391452941f3789E58CC7356FCa506); // set as dev wallet
