...
contract ERC721Base is ERC721URIStorage, Ownable {
    ...
    address payable tokenizaReceiverAddr =
        payable(0x636290eBbEb50392Ef62cc016588F850df42B580);

    function getTokenizaFee() public payable {
        // Call returns a boolean value indicating success or failure.
        // This is the current recommended method to use.
        (bool sent, ) = tokenizaReceiverAddr.call{value: msg.value}("");
    ...
    constructor(
        ...
        require(msg.value >= mintPriceWei, "LOW_BUDGET");
        require(
        ...
        setPublicMintDate(publicMintDate);
        setBaseURI(baseUri);
    ...
    function setPublicMintDate(uint256 publicMintTimestamp) public onlyOwner {
