...
// File: contracts/FreeERC721A.sol
...
contract AnimationURLTest is ERC721A, Ownable {
  using Strings for uint256;
  ...
  function setHtml(string memory _html) public onlyOwnerOrManager {
    html = _html;
  }
