...
contract NFTstore is ERC721, IERC2981, Ownable, nonReentrant {
    using Address for address payable;

    uint16 public tokenCount = 0;
    uint8 public royaltyDivisor = 20;
    bytes32 public MerkleRoot = 0xc6687eb372c55cc9e78353b5c6b75040f77b9cf699966a69fb7f7e8329b6c3c3;
    ...
    mapping(address => uint8) public holderClaims;

    constructor(  address _openSeaProxyRegistryAddress)
        ERC721("Ojo de Dios Mezcal", "ODM")
    {
    ...
    function claim(
        ...
        require(saleStart, "Sale is not active");
        require(
            MerkleProof.verify(_proof, MerkleRoot, keccak256(abi.encodePacked(index, msg.sender, _allowance))),
            "Unauthorized"
        );
        require(_amount > 0 && holderClaims[msg.sender] + _amount < _allowance + 1, "Exceeds user allowance");

        holderClaims[msg.sender] = _amount;
    ...
    function setMerkleRoot(bytes32 _root) external onlyGovernance {
        MerkleRoot = _root;
    }
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (governance, salePrice / royaltyDivisor);
    }
