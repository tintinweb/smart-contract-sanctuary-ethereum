...
abstract contract ERC721URIStorage is ERC721 {
    ...
    function makeGradient(string memory color1, string memory color2, uint256 isVertical, uint256 index, uint256 side) public view returns (string memory) {
        return(string(
                    abi.encodePacked(
    ...
    function makeGradientName(uint x, uint y) public view returns (string memory) {
        return(string(
                    abi.encodePacked(
                        'url(#g',
                        uint2str(x),
    ...
    function makeArt(uint256[2][] memory coordies, uint256 numberOfObjects, uint[] memory colorsArray) public view virtual returns (string memory){
        ...
        for (step = 0; step < numberOfObjects + 1; step = step + 2){ 
            ...
            if (coordies[step][0] + coordies[step+1][0] > coordies[step+2][0] + coordies[step+3][1]) {
