    ...
    BaseRelayRecipient
{
    ...
    function setState(address _user, bytes32 _state) public {
        require(isAuthorized(_user), "Unauthorized");
    ...
    function spend(bytes32 _id, uint256 _amount) public {
        ...
        require(isAuthorized(card.owner), "Unauthorized");
    ...
    function isAuthorized(address user) internal view returns (bool) {
        return user == _msgSender() || hasRole(ADMIN_ROLE, _msgSender());
    }
