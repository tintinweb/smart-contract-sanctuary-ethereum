  ...
  ILBRLedger
{
  ...
  /**
   * @notice Mints reserved NFTs to an address other than the sender. Sender must be owner
   * @param numMints Number of mints
  ...
  /**
   * @notice Mints reserved NFTs to the sender. Sender must be owner
   * @param numMints Number of mints
   */
  ...
  /**
   * @notice Sets base uri used for tokenURI. Sender must be owner
  ...
  /**
   * @notice Sets price per mint. Sender must be owner
  ...
  /**
   * @notice Changes sale state to opposite of what it was previously. Sender must be owner
   */
