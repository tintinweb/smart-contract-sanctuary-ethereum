...
contract coloface is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("coloface", "CFC") {
    setHiddenMetadataUri("ipfs://QmXRmX6N2ao7RsUrbfAseZKHuRDuZb3FGgXQNFWik2CNW3/hidden_metadata");
  }
