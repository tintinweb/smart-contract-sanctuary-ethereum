...
contract SharkzSoulBadgeGenesisVoter is IVoteScore, Adminable, ReentrancyGuard, EIP712Whitelist, ERC5114SoulBadge {
    ...
    constructor() 
        ERC5114SoulBadge("Genesis Voter", "SZGV", "ipfs://collection.json", "ipfs://tokenBaseUri/") 
        EIP712Whitelist() 
    {
