...
contract FeedsNFT is ERC721, Ownable {
    ...
    function addHatchURI(string memory _svgHatchURI) private onlyOwner {
    ...
    // test
    function hatchEgg(address tokenOwner, uint256 tokenCounter)
        external
        payable
    {
        require(msg.value == hatchFee);
        tokenIdToHatchTimer[tokenCounter] = HatchTime;
    }
