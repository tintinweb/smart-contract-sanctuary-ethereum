...
contract SAS is ERC721A{
   ...
   function cheker_count_mint1() public view returns(uint){
    ...
    function Mint(uint256 count_mint1) public payable{
        ...
        require(cheker_count_mint[msg.sender] + count_mint1 <=3, "Unlimit mint");
    ...
    function Claim(uint256 count_mint) public  {
        ...
        require(cheker_count_claim[msg.sender] + count_mint <=1, "Unlimit claim");
    ...
    function Cheker_address_FreeMint() public view returns (bool){
   ...
   function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return string(string(abi.encodePacked("https://sickapesociety.com/files/metadata/", 
        Strings.toString(tokenId),
        ".json")));
    }

    function AddAddress(address[] memory adr) public Cheker_Owner{
