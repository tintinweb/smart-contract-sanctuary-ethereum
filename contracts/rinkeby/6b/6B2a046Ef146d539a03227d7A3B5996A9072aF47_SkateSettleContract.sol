...
contract SkateSettleContract is Ownable, IERC721Receiver {
	...
	function startAuction() public {
		require(_skateAddress.owner() == address(this), 'Skate: Please transfer ownership to this contract');
		_skateAddress.auctionStart();
	}

	function settleAuction() public virtual {
		_skateAddress.settleCurrentAndCreateNewAuction();
	}

	function transferOwnershipOfSettleContract(address newOwner) public virtual onlyOwner {
