...
contract Fxckwon is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public freeMaxMintPerTx = 5;
    ...
    function freeMint(uint256 _mintAmount) public payable {
        ...
        require(
            _mintAmount > 0 && _mintAmount <= freeMaxMintPerTx,
            "Invalid Mint Amount."
        );
        require(
            freeMinted[msg.sender] + _mintAmount <= freeMaxMintPerTx,
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            minted[msg.sender] + _mintAmount <= maxMintPerTx,
