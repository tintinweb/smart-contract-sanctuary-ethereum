...
contract Test721A is Ownable, ERC721A, ReentrancyGuard {
    ...
    event WithdrawMoney(uint256 indexed blocktime, address indexed sender);
    ...
    function setMinterAllocate(
        ...
        emit WhitelistMint(roundIndex, quantity, msg.sender, totalSupply());
    }
    ...
    function withdrawMoney() external nonReentrant {
        ...
        emit WithdrawMoney(block.timestamp, msg.sender);
    }
