...
contract PoignART is ERC721, EIP712, ERC721URIStorage, Pausable, AccessControl {
    ...
    address public constant GITCOIN = 0xC9F2D9adfa6C24ce0D5a999F2BA3c6b06E36F75E;
...
// OpenZeppelin Contracts v4.4.1 (token/ERC721/ERC721.sol) modified according to Pagzi Tech inc implementation.
...
// One other note: I appreciate the technical approach offered in the Pagzi implementations, but did not like the style,
// and it also wasn't made available on github, so I created this.
...
contract ERC721Public is Context, ERC165, IERC721, IERC721Metadata {
     ...
     *
     * Cleaned up version of Pagzi impl.
     *
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Public.ownerOf(tokenId);
    ...
    function transferFrom(
        ...
        require(
            ...
            "ERC721: xfer caller is not owner/approved"
        );
     ...
     *
     * since Pagzi impl has _owners as an array, needs an extra check here.
     */
     ...
     *
     *
     * Pagzi: gets rid of _balances tracking.
     *
     * Emits a {Transfer} event.
     */
    ...
    function _transfer(
        ...
        require(
            ERC721Public.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Public.ownerOf(tokenId), to, tokenId);
    }
