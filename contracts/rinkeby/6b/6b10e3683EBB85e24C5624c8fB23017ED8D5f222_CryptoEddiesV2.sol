...
contract CryptoEddiesV2 is ERC721A, Ownable {
    ...
    function claimMany(uint256[] calldata tokenIds) external {
        ...
        for (uint256 i = 0; i < num; ++i) {
            ...
            //require(msg.sender == contractEddieOG.ownerOf(originalTokenId)); // check ownership
            ...
            contractEddieOG.transferFrom(msg.sender, address(this), originalTokenId);
            ...
            bytes(string(
                abi.encodePacked(
                    ...
                    '"attributes":[',
                        ...
                        '{"trait_type":"Vibing?", "value":', (vibingStartTimestamp[tokenId] != NULL_VIBING) ? '"Yep"' : '"Nah"', '},',
