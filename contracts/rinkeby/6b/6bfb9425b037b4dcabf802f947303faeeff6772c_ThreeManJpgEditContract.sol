...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXrZzurRrkze53pV6xYGBsNsSZHc2eu4sTdDdG85FKyzZ/";
...
// File: contracts/ThreeManJpgEditContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ThreeManJpgEditContract is RamppERC721A {
    constructor() RamppERC721A("ThreeManJpgEdit", "3MJE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/h6yWPOKZSZROACLrNeUF/contract-metadata";
    }
}
