...
// File: contracts/eggieNFT.sol


// @author: @EggiemonstersTeam
pragma solidity ^0.8.4;
...
contract Eggiemonsters is ERC721A, ERC721AQueryable, Ownable {
    using SafeMath for uint256;
    using ECDSA for bytes32;

    constructor() ERC721A("Eggie Monsters", "EGMON") {}

    uint32 public constant maxEggiemonsters = 5000;
    uint32 public constant teamMintAmount = 200;

    uint32 public constant maxReserveWalletLimit = 4;
    uint32 public constant maxFreelistWalletLimit = 1;
    uint32 public constant maxPublicWalletLimit = 1;
    ...
    string public baseTokenURI = "http://www.ictmedia.be/meta/";
    ...
    function reserveMint(uint amount, uint max, bytes memory signature) external {
        ...
        require(_totalMinted() + amount <= maxEggiemonsters, "All lost tigerz sucessfully lost!");
    ...
    function teamMint() external onlyOwner {
        ...
        require(_totalMinted() + teamMintAmount <= maxEggiemonsters, "All lost tigerz sucessfully lost!");
