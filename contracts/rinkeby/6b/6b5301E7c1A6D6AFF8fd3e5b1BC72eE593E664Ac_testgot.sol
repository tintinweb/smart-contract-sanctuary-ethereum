...
//Qmae3GJ1GjRjSCjTugQFkEDaFgrbdtu69EovgjwBjVH38i
...
contract testgot is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.005 ether; //kaç para
  uint public          maxPerTx          = 30; //kaç tane nft alabilir
  uint public          maxPerWallet      = 10; //cüzdanın ne kadar tutabileceği
  uint public          totalFree         = 1000;  //beleşler
  uint public          maxSupply         = 4000; //toplamlar
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("testgot", "GOT"){}
