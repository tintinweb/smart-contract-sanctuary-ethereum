...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new TarpNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TarpNFTUser1155Token token = TarpNFTUser1155Token(address(addr));
