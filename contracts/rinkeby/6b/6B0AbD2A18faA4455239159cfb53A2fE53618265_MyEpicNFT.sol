...
/*   // Eu crio tres listas, cada uma com seu grupo de palavras aleatorias
  ...
  string[] firstWords = ["Sneaker", "Havaianas", "The Chelsea Boot", "The Trainer", "The Chukka Boot", "Leather Boot"];
  string[] secondWords = ["Oxford Button-Down", "Dress Shirt", "Cuban Collar Shirt", "Casual Shirts", "Soccer Jersey", "Overshirt"];
  string[] thirdWords = ["Fedora", "Panama", "Derby", "Gambler", "Saylor", "Snapback"];

  constructor() ERC721 ("StylesNFT", "STY") {
...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string svgPartOne = "<svg  xmlns='http://www.w3.org/2000/svg'  preserveAspectRatio='xMinYMin meet'  viewBox='0 0 350 350'>  <defs>    <linearGradient id='Gradient1'>      <stop class='stop1' offset='0%'/>      <stop class='stop2' offset='50%'/>      <stop class='stop3' offset='100%'/>    </linearGradient>  </defs>  <style>    .base {      fill: black;      font-family: serif;      font-size: 20px;      color: #FFF;    }    .stop1 { stop-color: ";
  ...
  string baseSvg = "<svg  xmlns='http://www.w3.org/2000/svg'  preserveAspectRatio='xMinYMin meet'  viewBox='0 0 350 350'>  <defs>    <linearGradient id='Gradient1'>      <stop class='stop1' offset='0%'/>      <stop class='stop2' offset='50%'/>      <stop class='stop3' offset='100%'/>    </linearGradient>  </defs>  <style>    .base {      fill: black;      font-family: serif;      font-size: 20px;      color: #FFF;    }    .stop1 { stop-color: green; }    .stop2 { stop-color: yellow; stop-opacity: 1; }    .stop3 { stop-color: red; }      </style>  <rect width='100%' height='100%' fill='url(#Gradient1)' />  <text    x='50%'    y='50%'    class='base'    dominant-baseline='middle'    text-anchor='middle'  >";
  ...
  string[] colors = ["red", "yellow", "grey", "blue", "orange", "green", "pink"];

  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721 ("myEpicNFT", "STY") {
    console.log("MY NFT CONTRACT!");
  } 
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "NFT mens style generator.", "image": "data:image/svg+xml;base64,',
