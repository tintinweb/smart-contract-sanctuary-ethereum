...
contract NindoSale is Ownable, ReentrancyGuard {
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1649221980;
    uint64 public immutable whitelistEndTime = 1649308380;
    uint64 public immutable publicSaleStartTime = 1649225640;
    uint64 public immutable publicSaleEndTime = 1649312040;
    ...
    constructor() {
        ...
        nindoTokenAddress = address(0x1c3477B84bA0d1E24901e08D45cB9901a7a927B9);
