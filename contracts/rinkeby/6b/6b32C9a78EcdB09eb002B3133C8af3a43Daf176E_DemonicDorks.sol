...
contract DemonicDorks is ERC721B2FAEnumLitePausable, GuardianLiteB2FA {
    ...
    address private paymentRecipient =
        0x0b64069d46E68A27C63dC680504d7346Ea663D29;

    // dev: public mints
    uint256 public maxPublicMintsPerWallet = 2;
    uint256 public maxPreSaleMintsPerWallet = 3;

    uint256 public maxTeamMints = 200;
    ...
    function teamMint(uint256 qty, address addy) external onlyDelegates {
        require(qty + teamMinted <= maxTeamMints, "Max team mints");
        teamMinted += qty;
        _minty(qty, addy);
    }
