...
contract Avatar is IAvatar, ERC721, Ownable {
    ...
    function replaceAttendant(IAttendant newAttendant) public onlyOwner {
    ...
    function _afterTokenTransfer(
        ...
        if (attendant != IAttendant(address(0)))
...
interface IAvatar {
    function replaceAttendant(IAttendant newAttendant) external;

    function attendant() external returns (IAttendant);
}
