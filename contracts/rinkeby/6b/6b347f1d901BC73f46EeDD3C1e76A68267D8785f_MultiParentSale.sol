...
contract MultiParentSale is ERC721, Ownable, ReentrancyGuard {  
    ...
    uint256 public constant SALE_SUPPLY = 10;
    ...
    constructor(uint256[] memory parentId, address[] memory parentAddress, bool[] memory isClaimable) ERC721("Multi Parent Sale", "MPS") {
