...
contract SuperNerdNft is ERC721Enumerable, AccessControl, ERC2981ContractWideRoyalties {
    ...
    constructor() ERC721("SuperNerdNft", "SNN") {
    ...
    function mint(address _mintTo) external returns (bool) {
        ...
        require(totalSupply+1  <= _totalCap, "Cap reached, maximum 5555 mints possible");
