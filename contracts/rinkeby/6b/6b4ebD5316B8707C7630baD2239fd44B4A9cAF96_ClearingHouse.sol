...
contract ClearingHouse is IClearingHouse, IncreOwnable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        uint256 _liquidationRewardInsuranceShare,
        ...
        setParameters(
            _minMargin,
            _minMarginAtCreation,
            _minPositiveOpenNotional,
            _liquidationReward,
            _insuranceRatio,
            _liquidationRewardInsuranceShare,
    ...
    function addStakingContract(IStakingContract staking) external override onlyGovernance {
    ...
    function setParameters(
        ...
        _setLiquidationRewardInsuranceShare(newLiquidationRewardInsuranceShare);
        _setLiquidationDiscount(newLiquidationDiscount);
    ...
    function _provideLiquidity(
        ...
        if (tradingFees != 0) {
            vault.settlePnL(msg.sender, tradingFees);
        }
