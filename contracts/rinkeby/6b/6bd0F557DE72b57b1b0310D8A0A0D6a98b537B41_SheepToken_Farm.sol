...
contract SheepToken_Farm {
    string public name = "Sheep Token Farm";
    address public owner;
    SheepToken public sheepAddress;
    BusdToken public busdAddress;
    ...
    constructor(SheepToken _sheepAddress, BusdToken _busdAddress) public {
    ...
    function issueTokens() public {
        ...
        for (uint i=0; i<stakers.length; i++) {
            ...
            if(balance > 0) {
                sheepAddress.transfer(recipient, balance);
            }
        }
    }
}
