...
contract WAS is ERC20, Airdrop, Ownable {
    ...
    public
    {
        ...
        wasNFTContract.safeTransferFrom(address(this), msg.sender, satoshiId);
    ...
    /**
        H&H utility methods
     */
    function addSatoshiToHell(uint256 satoshiId)
    internal 
    {
