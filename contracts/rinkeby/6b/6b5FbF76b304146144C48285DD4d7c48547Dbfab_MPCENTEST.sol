...
// import "hardhat/console.sol"; // TODO: remove before deploying

contract MPCENTEST is ERC721Enumerable, Ownable {
    ...
    string private _baseURIExtended =
        "ipfs://QmeiXU1VWnZuecaPE6cFP4DpyKHp4ZWW6TDjpLiVWx7mhd/";
    string public provenance;
    uint256 public constant cost = 0.001 ether; // TODO: maybe eventually variable
    uint256 public maxSupply = 300; // TODO: maybe eventually constant
    uint256 public maxMintAmount = 20; // TODO: maybe eventually constant
    bool public isRevealed = true;
    SaleState public saleState = SaleState.PUBLIC;

    mapping(address => uint8) private _allowList;

    constructor() ERC721("MPCENTEST", "MPCENTEST") {}
    ...
    function mint(uint256 _mintAmount) external payable {
        ...
        // TODO: Maybe remove this since it might looks sus to some people?
        // if so, keep the require
        if (msg.sender != owner()) {
