...
contract LAND is AbstractERC1155Factory, ReentrancyGuard{
    ...
    address public piplAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138;
    address public weareAddress = 0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8;
    address public tokenAddress = 0xD4Fc541236927E2EAf8F27606bD7309C1Fc2cbee;
    ...
    function claim(uint256[] calldata pipl_tokenId, uint256[] calldata weare_tokenId, uint256 _toalScore, uint8 v, bytes32 r, bytes32 s) public whenNotPaused{
        ...
        //verify signature
        require(verify(pipl_tokenId, _toalScore, v, r, s) == signerAddress, "Not sign by signer");
    ...
    function verify(uint256[] memory tokenId, uint256 _toalScore, uint8 v, bytes32 r, bytes32 s) internal view returns (address) {
        Tokens memory t;
