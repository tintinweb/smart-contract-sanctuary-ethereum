...
contract BBTC is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public _baseURIextended = "ipfs://QmXw1Z2YEdLLBUSaphnP3iQbEjEtquc1KGFBCz8rN87bQB/";
    ...
    constructor() ERC721A("Bulls and Bears Trade Club", "BBTC") {
        ...
        rarity_price[0] = 0.0015 ether;//0.15 ether; // 1
        rarity_price[1] = 0.0030 ether;//0.30 ether; // 2
        rarity_price[2] = 0.0075 ether;//0.75 ether; // 5
        rarity_price[3] = 0.075 ether;//7.50 ether; // 50
    ...
    function switch_pool() external onlyOwner {
     ...
     function update_pool() external onlyOwner  {
        tokens_profit = address(this).balance - total_in_comissions; // - taxa do vendedor
    }
