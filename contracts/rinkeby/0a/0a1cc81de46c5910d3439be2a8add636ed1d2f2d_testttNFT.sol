...
contract testttNFT is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmZ6X8Lv6pe35yR1u3badhHpG2CsZDX2QD8zaR3RLAY5Hq/";

  uint256 public  maxSupply = 1500;
  uint256 public  MAX_MINTS_PER_TX = 2;
  uint256 public  PUBLIC_SALE_PRICE = .0069 ether;
  
  bool public IsWhitelistSaleActive = true;
  bool public isPublicSaleActive = false;
  
  constructor() ERC721A("testttt NFT", "MOOWL") {
