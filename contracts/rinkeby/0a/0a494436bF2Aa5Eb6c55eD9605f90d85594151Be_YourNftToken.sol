...
contract YourNftToken is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    address public hp = 0xdDCA117AA68D10180D2801e633340eEfE7678A0A;
    ...
    function mint(uint256 _mintAmount, uint256 _asmburnTokenId, uint256 _hpburnTokenId) public mintCompliance(_mintAmount) {
        ...
        require(asmownerNftMatch == _msgSender(), "Our patient records indicate IDENTITY FRAUD ! ... (not your patient/nft)");
        require(hpownerNftMatch == _msgSender(), "Our patient records indicate IDENTITY FRAUD ! ... (not your patient/nft)");
