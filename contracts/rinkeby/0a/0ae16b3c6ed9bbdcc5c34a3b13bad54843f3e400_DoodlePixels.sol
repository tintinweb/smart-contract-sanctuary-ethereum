...
contract DoodlePixels is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Doodle Pixels", "Doodle") {
    setHiddenMetadataUri("ipfs://QmNXLc1s9k8f4heRmDppUcSLUm94PaWY2WHipb7PF15Pei/hidden.json");
  }
