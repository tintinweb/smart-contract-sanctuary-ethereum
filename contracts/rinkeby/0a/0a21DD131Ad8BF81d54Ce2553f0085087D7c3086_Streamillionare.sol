...
contract Streamillionare is ERC721AQueryable, Ownable, ERC2981ContractRoyalties, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    // 5% of the initial sale will go to the Lagos Labs LLC wallet for the development of Decentral FM. WAGMI baby.
    // This payment will ensure the development of the Decentral FM ecosystem from the initial sale
    // Tell $PYPE and $MadagaskaTwins to finally release the song they made together and drop the video too ffs lol.
    // =============================================================================
    (bool hs, ) = payable(0x1A07d4bC5b4749449Cbf672A097163E223aa786c).call{value: address(this).balance * 5 / 100}('');
    require(hs);
    // =============================================================================
