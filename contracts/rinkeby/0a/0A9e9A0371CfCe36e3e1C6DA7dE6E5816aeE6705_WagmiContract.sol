...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x05503a728651bF4BF3C938267abcb6a5ff19F3C7];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x05503a728651bF4BF3C938267abcb6a5ff19F3C7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihelyk7ctbrb4s52u6cklwr7in7z7efytoiuosmhd7s7prad3k2zq/";
...
// File: contracts/WagmiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WagmiContract is RamppERC721A {
    constructor() RamppERC721A("WAGMI", "WGM"){}
}
