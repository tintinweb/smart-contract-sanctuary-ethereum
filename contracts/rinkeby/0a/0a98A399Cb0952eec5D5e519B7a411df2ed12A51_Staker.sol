...
contract Staker {
    ...
    modifier canWithdraw() {
        require(
            ...
            "The contract is not open for withdrawals"
        );
        _;
    }
    ...
    function execute() public deadlinePassed notCompleted isExecuted {
        ...
        // If the `threshold` was not met, allow everyone to call a `withdraw()` function
            ...
            openForWithdraw = true;
            console.log("Conditions not met ... openning for withdrawal");
        }
        executed = true;
    }

    // Add a `withdraw()` function to let users withdraw their balance
    function withdraw() public canWithdraw deadlinePassed notCompleted {
