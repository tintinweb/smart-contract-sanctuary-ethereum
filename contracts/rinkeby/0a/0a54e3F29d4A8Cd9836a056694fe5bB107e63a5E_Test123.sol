...
contract Test123 is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.0001 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x06677b203f8bd7f94aae28f8aa0a2482b177820c0b15790cb3af0c4f6bf03543;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri = "ipfs://a";

    constructor() public ERC721A("TestContract", "TEST", 999, 999) {}
