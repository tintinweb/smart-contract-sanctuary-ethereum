...
contract PUPZLAND is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxPresaleWalletLimit = 1;
  uint256 public maxPublicSaleWalletLimit = 3;
  ...
  constructor() ERC721A("PUPZLAND", "PZLD") {
      setHiddenMetadataUri("https://ipfs.io/ipfs/QmSJjjTkWcK7JszXGa8nDtFMw3tHjhuRGVuz6y6VarDitq/hidden.json");
  }
