...
contract CyberPantherzV1 is ERC721, Ownable {
    ...
    // address public constant projAddress = ;
    // address public constant devAddress = ;
    address public constant devTwoAddress =
        0x9C0aC9D88DE0c9AF72Cb7d5Cc4929289110E5BE9;
    // address public constant commAddress = ;
    ...
    mapping(address => uint256) public presaleClaimed; // !!! made public
    mapping(address => uint256) public freesaleClaimed; // !!! made public
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(devTwoAddress, address(this).balance);
    }
