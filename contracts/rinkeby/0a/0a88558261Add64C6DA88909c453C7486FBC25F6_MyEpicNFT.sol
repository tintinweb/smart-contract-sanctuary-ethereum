...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["short", "sweet", "random", "words", "innovate", "create"];
  string[] secondWords = ["smart", "gritty", "hard", "go", "for", "help"];
  string[] thirdWords = ["mindset", "blue", "ocean", "just", "do", "it"];
