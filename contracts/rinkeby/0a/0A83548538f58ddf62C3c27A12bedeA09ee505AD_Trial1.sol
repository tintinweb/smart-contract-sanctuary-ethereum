...
contract Trial1 is ERC721, Ownable {
    ...
    constructor() ERC721("Trial1", "SYMBOL") { 
    ...
    function mint(uint256 _numTokens) external payable { 
        ...
        require(_numTokens * price <= msg.value, "insuffient funds. You need more ETH!");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x90Fe2bC19cd408137F7999C1499EA7463046d373).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x90Fe2bC19cd408137F7999C1499EA7463046d373).call{value: balanceTwo}("");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(
            _exists(tokenId),
            "ERC721Metadata: URI query for nonnexistent token"
        );
