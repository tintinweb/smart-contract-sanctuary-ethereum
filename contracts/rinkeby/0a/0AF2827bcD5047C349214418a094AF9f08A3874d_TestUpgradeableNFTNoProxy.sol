...
contract TestUpgradeableNFTNoProxy is ERC721PresetMinterPauserAutoIdUpgradeSafe {
  ...
  constructor(address owner) public {
    ...
    __ERC721_init_unchained("TestUpgradeableNFT", "TUNFT");
    __Pausable_init_unchained();
  ...
  function __initialize__(address owner) external initializer {
    require(owner != address(0), "Owner cannot be empty");
