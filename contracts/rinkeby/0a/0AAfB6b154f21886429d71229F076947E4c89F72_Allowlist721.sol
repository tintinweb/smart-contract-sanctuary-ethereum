...
/**
 * @dev This is a ERC721 Contract that supports Burnable.
...
contract Allowlist721 is MintpassValidator, ERC721A, ERC2981, Ownable {
     ...
     */
    function mint(address minter) public payable {
        require(
        ...
        require(
            balanceOf(minter) <= 1,
            "Allowlist721: You can only have 1 Team"
        );
        uint256 mintPrice = getLatestPrice();
        require(
            msg.value >= mintPrice * 49 / 50, // 2% treshold due to conversion rate swings
    ...
    function getLatestPrice() public view returns (uint256) {
        ...
        return uint256((publicMintUSDPrice * 1000000000 / price * 1000000000) * (1 wei));
    }
