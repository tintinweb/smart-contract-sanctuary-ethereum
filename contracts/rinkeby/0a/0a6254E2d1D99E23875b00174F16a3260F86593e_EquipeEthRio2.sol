...
contract EquipeEthRio2 is ERC721, Ownable, ReentrancyGuard {
 ...
 // string public NotRevealMetadado; //inserir na booliana
    ...
    returns (string memory)
  {
    ...
    if (revealed == false) {
      return hiddenMetadataUri; // modificar e testar com o metadado hidden
    }
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    //pagando o endereço na hora do lançamento
    // =============================================================================
