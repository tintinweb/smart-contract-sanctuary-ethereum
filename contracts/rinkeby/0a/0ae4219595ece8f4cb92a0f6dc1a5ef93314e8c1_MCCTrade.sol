...
contract MCCTrade is Initializable, OwnableUpgradeable {
    ...
    function buyPack(
        ...
        if (
            ...
            require(
                _premiumpName[_pid].packPrice.mul(_premiumpName[_pid].multiples.div(_nPack)) == msg.value,
                "Invalid Pack Price"
            );
            ...
            require(
                _pName[_pid].packPrice.mul(_pName[_pid].multiples.div(_nPack)) == msg.value,
                "Invalid Pack Price"
            );
