...
// File: nekomato/nekomato_04142218.sol
...
contract nekomato_04142224 is ERC721{
...
//ここが名前
    constructor() ERC721("nekomato_04142224" , "nekomato_04142224" ) {
        //owner address
        //tonoshake
    ...
    function publicSaleMint(uint256 _tokenID) external payable{
        require(mintStarted);
    ...
    function devMint(uint256 _tokenID) external{
    ...
    function allowlistMintManage(bool _allowlistMintStarted)public{
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
