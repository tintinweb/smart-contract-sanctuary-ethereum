...
contract RevealNFT is ERC721URIStorage, Ownable {
    uint256 public tokenCounter;
    event CreatedRevealNFT(uint256 indexed tokenId, string tokenURI);

    constructor() ERC721("Reveal NFT", "revealNFT")
    {
        tokenCounter = 0;
    }
    ...
    function create(string memory svg) public {
        ...
        emit CreatedRevealNFT(tokenCounter, svg);
    }
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "Gift Ball", // You can add whatever name here
                                '", "description":"Wait for reveal!", "attributes":"", "image":"',imageURI,'"}'
                            )
                        )
                    )
                )
