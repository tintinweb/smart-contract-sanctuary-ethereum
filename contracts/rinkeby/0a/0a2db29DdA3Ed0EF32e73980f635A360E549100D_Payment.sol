...
//   }
  ...
  function getPlanSubscriptions(
      ...
      require(msg.sender == getChannelAdminAddress(idToPlan[planId].channelTelegramId) || msg.sender == owner, 'Only channel owner and contract owner are allowed to see channel subscriptions');
  ...
  function getChannelSubscriptions(
    string memory telegramChannelId
      ...
      require(msg.sender == getChannelAdminAddress(telegramChannelId) || msg.sender == owner, 'Only channel owner and contract owner are allowed to see channel subscriptions');
  ...
  function getSubscriberSubscriptions(
    string memory telegramSubscriberId
      ...
      require(msg.sender == owner, 'Only channel owner is allowed to call this method');
