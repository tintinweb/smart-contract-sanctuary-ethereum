...
contract NymphaeCyberis is ERC721A, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x392D50fCFDd5b36E6DdDB22bcB84AA80B8105890; //owner
    address t2 = 0xCE3e42407a54121f4796d75bc92542206d1B724E; //dev 
  ...
  //WL mint
    function mintWhiteList(uint256 numberOfTokens) external payable {
        ...
        require(numberOfTokens <= maxMint, "Too many");
        require(totalSupply() + numberOfTokens <= maxSupply, "Would exceed max supply");
        require(whiteListClaimed[msg.sender] + numberOfTokens <= whiteListMaxMint, 'You have already minted allowed maximum of 10');
        require(costWL * numberOfTokens <= msg.value, 'ETH amount is not sufficient');
