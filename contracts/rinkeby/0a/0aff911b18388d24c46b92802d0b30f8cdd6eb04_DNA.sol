 ...
 */
contract DNA is ERC1155, AccessControl, ReentrancyGuard, VRFConsumerBaseV2 {
    struct Contracts {
        IMutants Mutants;
        IRWaste RWaste;
        IScales Scales;
     ...
     */
    function setMutants(address mutants) external lockable onlyRole(DEFAULT_ADMIN_ROLE) {
        contracts.Mutants = IMutants(mutants);
    }

    /**
     * @notice Set $RWASTE token address
     * @param rwaste Address of $RWASTE token contract
     */
    function setRWaste(address rwaste) external lockable onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    /**
     * @notice Set SCIENTIST token address
     * @param scientists Address of SCIENTIST token contract
     */
    function setScientists(address scientists) external lockable onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    /**
     * @notice Run the extraction process for MUTANT and queued extractions in this batch
