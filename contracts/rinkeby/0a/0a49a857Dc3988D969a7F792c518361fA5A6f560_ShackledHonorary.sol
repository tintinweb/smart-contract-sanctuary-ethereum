...
contract ShackledHonorary is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("ShackledHonorary", "SHON") {}
    ...
    /** @dev store the hash of a token's renderParams
    the hash is generated by running the getRenderParamsHash function
    and the renderParams are stored in each token's metadata
    @param tokenId the id of the token to store the hash of
    @param tokenHash the hash of the token's renderParams
     */
    ...
    /** @dev render the art for a Shackled Honorary NFT
     */
    function render(
        uint256 tokenId,
        int256 canvasDim_,
...
import "../contracts/ShackledHonorary.sol";

contract XShackledHonorary is ShackledHonorary {
    constructor() {}
