...
contract TheRetros is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    setMax_Per_TX(_Max_Per_TX);
    setHiddenMetadataUri(_hiddenMetadataUri);
  }

  

  function whitelistMint(uint256 numberOfTokens, bytes32[] calldata _merkleProof) public payable {
  ...
  function mint(uint256 numberOfTokens) public payable  {
    ...
    require(numberOfTokens > 0 && numberOfTokens <= Max_Per_TX, 'Invalid mint amount!');
