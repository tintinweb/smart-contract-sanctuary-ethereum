...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmRGQ8ByxZocrg6yg6a77T1wwAwU8mMb5s1fvuybzUZgoe/"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("mcu_0841", "Test0") payable {
        // 剛開始我們先自己 Mint 一個
