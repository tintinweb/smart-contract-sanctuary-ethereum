...
contract ThreeGMAIPFP is ERC721A, Ownable {
    ...
    string public baseURI = "https://opensea.mypinata.cloud/ipfs/QmPezNm2TY145vbMA3W3yB9wdqacEmydzLUEhestQyTUCP/";
    string public contractURI = "ipfs://QmYY2VkrWHdHvDgu8Y2R3X4TkiXhwJSSUxnMaKKwZoYG26";
    uint256 constant public MAX_SUPPLY = 5000;
    uint256 public PUBLIC_SUPPLY = 2000;
    bytes32 public whitelistMerkle = 0x27ac1ee0fb77af264577a6813c9c043b9d46d16de862d5c8320a3f6a7512284c ;
    ...
    IERC721A threeGMGenesisPass = IERC721A(0x1e3a023A0597c235Ac9CBfc7F6B620223d0f7058);

    mapping(address => uint256) public claimedWhitelist;
    mapping(address => uint256) public walletMint;

    constructor() ERC721A("FPF", "FPF") {}
