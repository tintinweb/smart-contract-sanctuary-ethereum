...
contract fractionalNft is Ownable, Pausable, ERC1155Upgradeable, VRFConsumerBaseV2 {
...
//    bytes32 keyHash = 0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc;
    ...
    function init (address _vrfCoordinator, address _marketPlaceAddress, uint _supply, uint _royaltyAmount, bytes32 keyhash, uint64 subscriptionId) external  {
    ...
    function mintTokens(address _to, uint _tokenAmount,string[] memory _uri) external  {
        ...
        require(currentTokenId<=_maxSupply,"Exceeds TotalSupply");
    ...
    function fulfillRandomWords(
        ...
        if (winnerTokenId == 0 || winnerTokenId == 1) {
            winnerTokenId += 2;
        }
        _mint(ownerOfToken[winnerTokenId],1,1,mainNFTURI);
    }
    ...
    function setMainNFTURi(string memory __uri) external onlyOwner{
       mainNFTURI=__uri;
    }
