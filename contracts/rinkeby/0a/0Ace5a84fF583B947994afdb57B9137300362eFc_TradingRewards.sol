    ...
    MixinResolver
{
    ...
    function _calculateRewards(address account, uint256 periodID)
        internal
        view
        returns (uint256)
    {
        ...
        uint256 participationRatio = accountFees.divideDecimal(
            period.recordedFees
        );
    ...
    function claimRewardsForPeriods(uint256[] calldata periodIDs)
        external
        nonReentrant
        notPaused
    {
        ...
        onlyPeriodController
    {
        ...
        uint256 availableForNewRewards = currentBalance.sub(
    ...
    event UnassignedRewardTokensRecovered(
        address recoverAddress,
        uint256 amount
    );
