...
contract BoneThroneAlpha is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint public constant PRESALE_MINT_PRICE = 0.07 ether;
    ...
    constructor(string memory uri, address _proxyRegistryAddress) ERC721A("Bone Throne Mr. Alpha",
    "BOTHMA")  ReentrancyGuard()
    {
   ...
   function tokenURI(uint256 tokenId)
    ...
    function presaleMint(uint count) external payable {
