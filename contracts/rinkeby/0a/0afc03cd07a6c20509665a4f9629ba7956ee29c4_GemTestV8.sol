...
// File: contracts/GemTest_A_V1_S.sol
...
contract GemTestV8 is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("GemTestV8", "GTV8", mintLimit, _totalSupply) {
     tokenCount = 0;
  }
