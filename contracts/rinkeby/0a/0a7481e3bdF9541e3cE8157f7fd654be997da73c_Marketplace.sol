    ...
    ITransferManager
{
    ...
    event Match(address from,uint256 salt, uint256 newLeftFill, uint256 newRightFill);
    ...
    */
    function matchAndTransfer(
        ...
        emit Match(msg.sender, orderLeft.salt, newFill.rightValue, newFill.leftValue);
    }
