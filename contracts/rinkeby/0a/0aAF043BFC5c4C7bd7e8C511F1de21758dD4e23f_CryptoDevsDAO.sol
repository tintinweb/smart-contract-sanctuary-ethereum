...
contract CryptoDevsDAO is Ownable {
    ...
    constructor(address _nftMarketPlace, address _cryptoDevsNFT) {
        fakeNFTMarketPlace = IFakeNFTMarketplace(_nftMarketPlace);
    ...
    {
        require(
            fakeNFTMarketPlace.available(_tokenId) == true,
            "Not for Sale"
        );
        ...
        activeProposalOnly(proposalIndex)
    {
        ...
        for (uint256 i = 0; i < voterNFTBalance; i++) {
            uint256 tokenId = cryptoDevsNFT.tokensOfOwnerByIndex(msg.sender, i);
