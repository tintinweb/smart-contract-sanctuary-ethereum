...
contract GohanGo is ERC721A, Ownable {
    ...
    /**
        90 (team)
        100 (faucet)
        100 (another bowl airdrop)
     */
    uint256 public constant RESERVE_NUM = 290;
    ...
    string private unrevealURI =
        "ipfs://QmV3mE1AQr6czTxd6PYNNNY2XCVeQxGbY3jwxLmzJojf4C";
     ...
     * Public mint
     */
    function mintMyGohan(uint256 _quantity) public payable {
        ...
        _safeMint(msg.sender, _quantity);
        if (totalSupply() > MAX_SUPPLY) revert MintAmountIncorrect();
    }

    /** ====== Only Owner ====== */

    /**
     * @notice toggle whitelist state
     */
    ...
    /**
     * Set base URI and toggle the reveal flag
     * @notice set baseURI
     */
    ...
    /**
     * @notice add addresses (with quantity) to whitelist
     */
    ...
    /**
     * Give me the money, I need to buy myself a bubble tea xD
     */
