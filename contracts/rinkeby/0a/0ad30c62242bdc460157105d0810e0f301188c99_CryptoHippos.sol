...
contract CryptoHippos is ERC721A, Ownable {
    ...
    address private Address2 = 0x2Be08be360bd2ef8A7231F44997432D15F80c9b1; //sam
    address private Address3 = 0xee8917D6Af70d4C5287162ec5014c79a68E554c3; // samy(didnt have aditya address)
    address private Address4 = 0xC85bA6c679dA5d0f89E793Aa10938F6dE98e6Ef2; // samy
    address private Address5 = 0xBbB589796d01EF05f24C49f57d53125d4382ab62; // usamah

    constructor() ERC721A("Crypto Hippos", "CH", maxMintAmount, maxSupply) {
        setBaseURI(
        ...
        onlyOwner
    {
        ...
        require(reservedCount < nftReserve, "Marketing reserve exhausted.");
    ...
    function setNftReserved(uint256 _limit) public onlyOwner {
        nftReserve = _limit;
    }
