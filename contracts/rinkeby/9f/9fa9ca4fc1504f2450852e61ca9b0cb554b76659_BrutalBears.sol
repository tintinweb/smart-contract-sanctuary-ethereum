...
// File: contracts/brutal bears new.sol
...
contract BrutalBears is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public PRESALE_SUPPLY = 4000;
    ...
    constructor() ERC721A("Brutal Bears", "BB") {
        setHiddenMetadataUri("ipfs://QmcRK66PvdYWq6npHyHupcRBm56WcvbA7wiojGRFygcvLS/reveal.json");}
    ...
    function presaleMint(uint256 quantity) external payable {
        ...
        require(quantity <= 4 - _presaleWallets[msg.sender], "exceeded max per wallet");
    ...
    function mintBear(uint256 quantity) external payable {
