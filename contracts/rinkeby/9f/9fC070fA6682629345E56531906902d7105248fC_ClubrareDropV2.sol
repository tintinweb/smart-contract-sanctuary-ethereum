...
/**
 * @title ClubrareDropV2 contract
 * @author Ajitesh Mishra
 * @notice NFT collection contract for Clubrare.
 */

contract ClubrareDropV2 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable,Royalties {
   using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    function initialize(address _admin, address _marketplace) public initializer{
        __ERC721_init("Clubrare Drop", "CBRD");
