...
contract KingdomsOfEtherCrystal is IERC1155MetadataURI, EIP712, ERC20, Ownable
{
    /* constants */
    //string private constant TOKEN_URI = "ipfs://QmRzh1uz9pcVspY8L1zg9xGqpZdjrzZtg68rSM4FPwtf1g";
    string private constant TOKEN_URI = "ipfs://QmRo8A1HatTSoonkGR7Hdf2evAkazxU6n6snfEKWCNa5Xs";
    uint256 public constant TOKEN_ID = 1;
    string public constant NAME = "Crystals of Ether";
    string public constant SYMBOL = "COE";
    string public constant EIP712_VERSION = "1.0.0";
    uint private constant PUBLIC_POOL_ID = 0;
    uint private constant PUBLIC_POOL_CAPACITY = 500;
    uint private constant PRIVATE_POOL_CAPACITY = 500;
    uint private constant MAX_SUPPLY = 1500;

    /* state */
    address immutable public signer; // for eip712 verification
    ...
    constructor() ERC20() EIP712(NAME, EIP712_VERSION) Ownable() {
        signer = msg.sender;
        supply.push(PUBLIC_POOL_CAPACITY);
        supply.push(PRIVATE_POOL_CAPACITY);
    }
    ...
    function mint(uint256 _pool, bytes memory _signature) external returns (uint256 _tokenId) {
        ...
        require(supply[_pool] > 0, SUPPLY_EXCEEDED);
        supply[_pool] -= 1;
    ...
    function _mint(address _to) internal returns (uint256 _tokenId) {
        require(!minters[_to], PASS_USED_UP);
        require(supplyTotal < MAX_SUPPLY, TOKENS_OVER);
        supplyTotal += 1;
        minters[_to] = true;
        super._mint(_to, 1);
        return TOKEN_ID;
    ...
    function _setApprovalForAll(
        ...
        approve(_operator, _approved ? 1 : 0);
...
abstract contract ERC20 is Context, IERC20 {
    ...
    function allowance(address owner, address spender) public view virtual override returns (uint256) {
        return _allowances[owner][spender] ? balanceOf(owner) : 0;
    }
    ...
    function _approve(
        ...
        _allowances[owner][spender] = amount > 0;
    }
}
