...
import "./MGYERC721.sol";

contract EDERC721 is MGYERC721{
  constructor (
      string memory _name,
      string memory _symbol
  ) MGYERC721 (_name,_symbol) {
  }
...
contract MGYERC721 is Ownable,ERC721, ReentrancyGuard, MerkleProof, ERC2981{
  ...
  //@dev Increment the next token ID to be minted.
