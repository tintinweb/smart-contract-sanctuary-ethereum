...
contract DEX {
    ...
    function ethToToken() public payable returns (uint256 tokenOutput) {
        ...
        // tokenOutput =
        //     tokenBalance -
        //     (totalLiquidity * tokenBalance) /
        //     ethBalance;
        // tokenOutput = (tokenOutput * 997) / 1000;

        // console.log("ethBalance", ethBalance);
        // console.log("tokenBalance", tokenBalance);
        // console.log("tokenOutput", tokenOutput);

        // totalLiquidity = ethBalance;

        // bool ok = token.transfer(msg.sender, tokenOutput);
        // require(ok, "failed to transfer token");
        // emit EthToTokenSwap(
        //     msg.sender,
        //     "ETH to balloons",
        //     msg.value,
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        // uint256 K = totalLiquidity * tokenBalance;
        // ethOutput = ethBalance - K / (tokenBalance + tokenInput);
        // ethOutput = (ethOutput * 997) / 1000;

        // console.log("ethBalance", ethBalance);
        // console.log("tokenBalance", tokenBalance);
        // console.log("ethOutput", ethOutput);

        // totalLiquidity = ethBalance - ethOutput;
        ...
        // require(ok, "failed to transfer eth");
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        // tokensDeposited = (token_reserve * msg.value) / ethReserve;
