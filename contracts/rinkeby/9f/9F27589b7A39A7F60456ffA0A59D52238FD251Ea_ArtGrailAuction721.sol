...
contract ArtGrailAuction721 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    event BidPlaced721(address indexed nftAddress, uint256 indexed tokenId, address indexed bidder, uint256 bid);

    event BidWithdrawn721(address indexed nftAddress, uint256 indexed tokenId, address indexed bidder, uint256 bid);

    event BidRefunded721(address indexed bidder, uint256 bid);

    event AuctionResulted721(address indexed nftAddress, uint256 indexed tokenId, address indexed winner, uint256 winningBid);

    event AuctionCancelled721(address indexed nftAddress, uint256 indexed tokenId);
    ...
    function placeBid(address _nftAddress, uint256 _tokenId) external payable nonReentrant whenNotPaused {
        ...
        emit BidPlaced721(_nftAddress, _tokenId, _msgSender(), bidAmount);
    }
    ...
    function withdrawBid(address _nftAddress, uint256 _tokenId) external nonReentrant whenNotPaused {
        ...
        emit BidWithdrawn721(_nftAddress, _tokenId, _msgSender(), previousBid);
    }
    ...
    function resultAuction(address _nftAddress, uint256 _tokenId) external nonReentrant {
        ...
        emit AuctionResulted721(_nftAddress, _tokenId, winner, winningBid);
    }
    ...
    function cancelAuction(address _nftAddress, uint256 _tokenId) external nonReentrant {
        ...
        emit AuctionCancelled721(_nftAddress, _tokenId);
    }
    ...
    //     emit ContractWhitelisted721(_addresses[i], true);
    //     }
    // }
    ...
    //     emit ContractWhitelisted721(_addresses[i], false);
    //     }
    // }
