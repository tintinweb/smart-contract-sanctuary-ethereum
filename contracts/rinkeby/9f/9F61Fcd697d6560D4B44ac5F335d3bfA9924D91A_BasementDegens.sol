...
contract BasementDegens is Ownable, ERC721A, ERC721ABurnable {

    using Strings for uint256;

    uint256 public collectionSize = 99;
    string private baseTokenURI;
    bool public saleIsActive;
    bool public burning = true;

    constructor() ERC721A("Basement Degens", "BD") {}
    ...
    function ownerBurn(uint256 tokenId) external onlyOwner {
        require(
            burning,
            "Owner burning no longer allowed"
        );
    ...
    function endOwnerBurn() external onlyOwner {
        burning = false;
    }
}
