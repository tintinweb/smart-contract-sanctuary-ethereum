...
contract FeedsNFT is ERC721, Ownable {
    ...
    uint256 public hatchTime = 60 minutes;
    uint256 public HatchTime;
    uint256 public tokenCounter;
    string public eggImageURI;
    string private hatchImageURI;
    uint256 public hatchFee = 0.01 ether;

    mapping(uint256 => uint256) public tokenIdToHatchTimer;
    AggregatorV3Interface internal priceFeed;
    event LaidEggNFT(uint256 indexed tokenId, uint256 HatchTime);
    // test
    event HatchedEggNFT(uint256 indexed tokenId, uint256 HatchedTime);
    ...
    // test - probably should require the token is owned by the address
    // onlyOwnerOf
    ...
    // maybe a function that mapps tokenIDs to owner? doesn't ERC721 already do that?
