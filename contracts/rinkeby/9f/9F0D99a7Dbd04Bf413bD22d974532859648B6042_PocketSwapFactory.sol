...
// File: contracts/pocketswap/libraries/UQ112x112.sol
...
// File: contracts/pocketswap/PocketSwapERC20.sol
...
contract PocketSwapERC20 is IPocketSwapERC20 {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external override {
        require(deadline >= block.timestamp, 'PocketSwap: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'PocketSwap: INVALID_SIGNATURE');
...
// File: contracts/pocketswap/pair/StorageData.sol
...
// File: contracts/pocketswap/PocketSwapPair.sol
...
// File: contracts/pocketswap/PocketSwapFactory.sol
