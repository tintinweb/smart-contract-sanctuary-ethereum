...
contract MMM is ERC721Enum, Ownable, ReentrancyGuard {
	...
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 30;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 30;
    ...
    constructor() ERC721P('MiMementoMori', 'MMM') {}
