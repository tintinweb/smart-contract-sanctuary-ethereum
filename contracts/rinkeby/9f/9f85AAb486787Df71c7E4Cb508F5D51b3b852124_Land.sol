...
contract Land is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address public tokenContract = 0x5dD4f1A9c4d3d8964Aad91083B3aFB1dBEbc0c6c;
    ...
    constructor(string memory name, string memory symbol
        ...
        MAX_ALPHA_NFT_AMOUNT = 10000;
        MAX_BETA_NFT_AMOUNT = 10000;
        MAX_PUBLIC_SALE_AMOUNT = 10000;
        MAX_FUTURE_LANDS = 10000;
        MAX_LANDS_WITH_FUTURE = 1000;
        RESERVED_CONTRIBUTORS_AMOUNT = 1000;


        mintIndexPublicSaleAndContributors = 1;
        MAX_LANDS = 10000;
