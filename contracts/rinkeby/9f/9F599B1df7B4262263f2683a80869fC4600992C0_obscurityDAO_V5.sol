...
contract obscurityDAO_V5 is ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, FounderWallets, ReentrancyGuardUpgradeable {
    ...
    override (ERC20Upgradeable) returns (bool) {
        ...
        unchecked {
            ...
            ERC20Upgradeable.transfer(charityWallet.founderAddress, 2*fee);
            ...
            ERC20Upgradeable.transfer(swapPool.founderAddress, 2*fee); 
        }
   ...
   function addressSwapExecution(uint256 proposalID) 
    ...
    override {
        ...
        FounderWallets.AddressSwapProposal memory p = FounderWallets.addressSwapProposalVotes[proposalID];
        ...
        FounderWallets.addressSwapProposalVotes[proposalID].sState = fps.ExecutedByFounders;
    }
