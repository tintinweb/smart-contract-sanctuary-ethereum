...
// ERC721A: https://chiru-labs.github.io/ERC721A/#/upgradeable?id=installation
// ERC721A Tutorial: https://www.youtube.com/watch?v=jWp1B_T1OTQ&ab_channel=DanielDil
// ERC721A Example: https://etherscan.io/address/0x2b1037def2aa4ed427627903bdef9bdd27ae1ea3#code
contract WorldsOfTrains is ERC721A, /*PullPaymentUpgradeable,*/ Ownable {
    ...
    // Constants
    uint256 public constant TOTAL_SUPPLY = 111; // For Test;
    ...
    function initialize() initializerERC721A initializer public {
        __ERC721A_init("WorldsOfTrains", "WOFT");
        //__PullPayment_init();
        __Ownable_init();
        //setBaseTokenURI("ipfs://QmdKxCySQ2vaeJUxG1zeuves8iJVcwWZi5VWWmUop25feL/");
    }
    */
    function mintMass(uint256 quantity) public onlyOwner {
        require(totalSupply() + quantity <= TOTAL_SUPPLY, "Max supply reached");
        _mint(msg.sender, quantity);
    }

    function mintTo(address recipient, uint256 quantity) public onlyOwner {
        require(totalSupply() + quantity <= TOTAL_SUPPLY, "Max supply reached");
    ...
    function publicSaleMint(uint256 _quantity) external payable callerIsUser {
        ...
        require(msg.value >= (pricePerToken * _quantity), "Public Sale - Below Price!");
    ...
    function publicSaleTotalSupply() public view returns (uint256) {
        return publicSale ? publicSupply : 0;
    }  

    function publicSaleRemainingSupply() public view returns (uint256) {
        return publicSale ? maxPublicSupply - totalSupply() : 0;
    }    

    function publicSalePricePerToken() public view returns (uint256) {
        return publicSale ? pricePerToken : 0;
    }     

    function publicSaleMintPerWallet() public view returns (uint256) {
