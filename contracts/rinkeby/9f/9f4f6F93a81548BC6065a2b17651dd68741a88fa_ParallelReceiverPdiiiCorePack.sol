...
contract ParallelReceiverPdiiiCorePack is VRFConsumerBaseV2, Ownable {
    ...
    function claim(uint256 _numberOfPacks) public {
        uint256 numAssignedPacks = assignedPackIDs[msg.sender].length;
        ...
        uint256 packID;
        uint256 i;
        // Pop all assigned packs for msg.sender
        ...
        for (
            ...
            i = positionI - 1;
            packID = assignedPackIDs[msg.sender][i];
            assignedPackIDs[msg.sender].pop();
    ...
    modifier onlyParallelAuxiliaryItemsRouter() {
        require(msg.sender == routerContractAddress, "only callable by PAI router");
        _;
    }
