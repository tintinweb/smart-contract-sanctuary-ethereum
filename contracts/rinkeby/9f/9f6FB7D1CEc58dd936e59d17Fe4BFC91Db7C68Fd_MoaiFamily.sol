...
contract MoaiFamily is Ownable, ReentrancyGuard, ERC721A {
    ...
    address public multisig = 0x49bcE3a729749397F1D6EBDEbbaEfDdF3a4CaBC3;
    ...
    constructor(address _minter, address _owner) ERC721A("Moai Family", "MF") {
        minter = _minter;
