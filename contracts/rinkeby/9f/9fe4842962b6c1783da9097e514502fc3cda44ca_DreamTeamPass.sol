...
contract DreamTeamPass is ERC1155Burnable, ReentrancyGuard, Ownable {
    ...
    uint8 public constant MAX_MINT_PUBLIC_DIAMOND = 10;
    uint8 public constant MAX_MINT_PUBLIC_PREMIUM = 20;
    uint8 public constant MAX_MINT_PRESALE_DIAMOND = 2;
    uint8 public constant MAX_MINT_PRESALE_PREMIUM = 2;

    uint8 public constant TEAM_MINT_DIAMOND = 2;
    uint8 public constant TEAM_MINT_PREMIUM = 5;

    uint256 public constant PUBLIC_SALE_DIAMOND_PRICE = 0.00011 ether;
    uint256 public constant PRESALE_DIAMOND_PRICE = 0.0001 ether;

    uint256 public constant PUBLIC_SALE_PREMIUM_PRICE = .00003 ether;
    uint256 public constant PRESALE_PREMIUM_PRICE = .000025 ether;

    uint8 public constant PREMIUM_PASS_TOKEN_ID = 0;
	uint8 public constant DIAMOND_PASS_TOKEN_ID = 1;
	string public constant NAME = "Test Pass";
	string public constant SYMBOL = "TESTDT";

	uint16[2] public supplyCaps = [300, 33];
