...
WEEK: constant(uint256) = 86400  # all future times are rounded by week
MAXTIME: constant(uint256) = 4 * 365 * 86400  # 4 years
MINTIME: constant(uint256) = 365 * 86400  # 1 year
...
def deposit_for(_addr: address, _value: uint256):
    ...
    self._deposit_for(_addr, msg.sender, _value, 0, _locked, DEPOSIT_FOR_TYPE)
