...
contract ttkknn is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    /// @param _owner The wallet address of an ttkknn token owner.
    /// @return An array of tokenIds of the ttkknnss owned by the address.
    ...
    /// @notice A shuffle function to output random hex string for the left square color.
    ...
    /// @notice A shuffle function to output random hex string for the right square color.
    ...
    /// @notice A shuffle function to output random hex string for the background color.
