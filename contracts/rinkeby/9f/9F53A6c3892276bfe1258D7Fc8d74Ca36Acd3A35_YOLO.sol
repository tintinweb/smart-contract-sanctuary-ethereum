...
contract YOLO is ERC721A, Ownable {
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount <= MaxPerTx, "too many for a single txn.");
        ...
        require(msg.value >= amount * cost, "eth is not enough");
