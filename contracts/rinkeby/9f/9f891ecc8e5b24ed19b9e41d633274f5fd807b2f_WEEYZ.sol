...
pragma solidity ^0.8.4;
contract WEEYZ is IERC20, Ownable {
    ...
    constructor(
        ...
        require(taxFeeBps_ + liquidityFeeBps_ <= 10**4, "Total fee is over 100% of transfer amount");
        _name = name_;
        _symbol = symbol_;
        _decimals = 18;
        ...
        numTokensSellToAddToLiquidity = totalSupply_.mul(4).div(10**4); // 0.04%
