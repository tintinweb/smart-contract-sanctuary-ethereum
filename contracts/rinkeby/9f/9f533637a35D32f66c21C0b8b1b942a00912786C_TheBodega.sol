...
contract TheBodega is ERC721A16, Pausable, ReentrancyGuard {
    ...
    function setTokenHash(string calldata hash) 
    	external isSquad notEqual(_tokenHash, hash) { _tokenHash = hash; }
	...
	function setSecret(string calldata newSecret) 
		external isSquad notEqual(_secret, newSecret) { _secret = newSecret; }
