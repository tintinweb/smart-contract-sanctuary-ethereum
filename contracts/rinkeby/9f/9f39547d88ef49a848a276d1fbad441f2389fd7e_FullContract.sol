...
// File: contracts/FullContract.sol
...
_addPayee(payable(msg.sender));
  ...
  function mint(uint256 _mintAmount) public payable {
    require(paused==false,"Sorry but the contract is not available for public sale if you wish to mint then join our whitelist");
    _addPayee(payable(msg.sender));
    require(_mintAmount > 0);
    require(_mintAmount <= maxMintAmount);
