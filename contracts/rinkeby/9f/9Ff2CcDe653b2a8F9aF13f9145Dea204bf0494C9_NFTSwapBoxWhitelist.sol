...
contract NFTSwapBoxWhitelist is INFTSwap, AccessControl {
    ...
    function setUsingERC721Whitelist(bool usingList) external  onlyRole(ADMIN) {
        swapConfig.usingERC721WhiteList = usingList;
    }

    function setUsingERC1155Whitelist(bool usingList) external  onlyRole(ADMIN) {
    ...
    */
    ...
    function addWhiteListToken(address erc20Token) external {
    ...
    function addWhiliteListERC721Token(address erc721Token) external {
