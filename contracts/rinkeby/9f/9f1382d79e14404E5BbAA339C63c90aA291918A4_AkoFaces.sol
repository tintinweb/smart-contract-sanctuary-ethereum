...
contract AkoFaces is ERC721, Ownable,ERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;

    string public baseURI = ""; // IPFS URL WILL BE ADDED WHEN TOKENS ARE ALL SOLD OUT

    uint256 public constant tokenPrice = 1000000000000000; //0.0001 ETH 
    ...
    constructor() ERC721("AkoFaces", "AKF") {}
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
        {
            ...
            if(isRevealed==false){
                return 
                "ipfs://QmZG5NXsyjn59SRTzYkYZVzeeRUy6Xau1UgUrBNumuRzqq/hidden.json";
            }
