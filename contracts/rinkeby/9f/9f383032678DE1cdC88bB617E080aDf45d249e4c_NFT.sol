...
contract NFT is ERC721A {
  ...
  address public teamAddress = 0x96c5F5960A6c215d3C33F6BD22F8341C330f9b9a;
  ...
  function _baseURI() internal view virtual override returns (string memory) {
   ...
   function check(bytes32[] calldata _merkleProof) public view {
  ...
  function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
    ...
    _mintSpclrz(msg.sender, _mintAmount);
    if(!preSalePaused && msg.sender != owner)
      whitelistClaimed[msg.sender] = true;
  }

  function _mintSpclrz(address to, uint256 amount) internal {
    _safeMint(to, amount);
  }

  //only owner
  function gift(uint256 _mintAmount, address to) public {
  ...
  function withdraw() public {
    ...
    require(success, "Error occurred during withdraw...");
  }
}
