...
contract CryptoMason2 is ERC721A, Ownable {
    ...
    function allowUser(
        ...
        if (adrToUsedClaimAmount[msg.sender] >= adrToClaimAmount[msg.sender]) {
            ...
            claimInfo[user1][adrToClaimAmount[msg.sender]] = claim(
                user1,
                tokenIds.length,
                tokenIds,
                0,
    ...
    function getRewards(uint256 numberClaim) internal {
        ...
        claimInfo[msg.sender][numberClaim].lastMoneyTime = nows;
        uint256 myReward;
        bool a;
        if (
            claimInfo[msg.sender][numberClaim].startTime +
        ...
        returns (uint256)
    {
        ...
        if (
            ...
            if (claimInfo[user][numberClaim].alreadyGiven == 0) {
                return myReward;
            } else {
                return
                    claimInfo[user][numberClaim].rewardAmount -
            ...
            uint256 myReward = (claimInfo[user][numberClaim].floor *
                ...
                (block.timestamp -
                    claimInfo[user][numberClaim].startTime -
                    claimInfo[user][numberClaim].lastMoneyTime)) / divide;
            return myReward;
        }
    }
