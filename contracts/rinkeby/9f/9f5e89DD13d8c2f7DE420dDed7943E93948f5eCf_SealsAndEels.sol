...
contract SealsAndEels is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public headshotUriPrefix;
  uint public cost;
  uint public maxSupply;
  bool private paused = false;
  bool private revealed = true;

  constructor() ERC721A("SAE", "SAE"){
    cost = 0;
    maxSupply = supply;
    hiddenMetadataUri = "ipfs://QmRm71pacQv3WyDxhedqFdd1HMWr1c2VyXi5DHYX9tGuoe/";
    uriPrefix = "ipfs://QmYX8CcMmzDVSMa5equEgqn3LfbC28EjuErpZSLcKHrEm6/";
    headshotUriPrefix = "ipfs://QmYX8CcMmzDVSMa5equEgqn3LfbC28EjuErpZSLcKHrEm6/";
  }
  ...
  function headshotURI(uint256 _tokenId) public view returns (string memory){
    require(_exists(_tokenId), "ERC721Metadata: URI query for nonexistent token");

    if (revealed == false){
      return hiddenMetadataUri;
    }
    string memory currentBaseURI = headshotUriPrefix;
    string memory soe = sealOrEel[_tokenId];
  ...
  function setHeadshotUri(string memory _headshotUri) public onlyOwner {
    headshotUriPrefix = _headshotUri;
  }
