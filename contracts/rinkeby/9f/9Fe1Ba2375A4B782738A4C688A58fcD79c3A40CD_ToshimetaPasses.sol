...
contract ToshimetaPasses is ERC1155Supply, Ownable, ReentrancyGuard {
    ...
    uint256 public toshimetaMintAmount = 2;
    uint256 public toshimetaMintPerAddr = 2;
    ...
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/Qmeai4shAuJyHf5Lbh1an3Fd964j19p6ZZ48Ez1hbVicZF{id}.json") {}
    ...
    address dev1 = 0xdC7dBFd6ab4BF3215b01806ae9edDC7447016793;
    address dev2 = 0xB9aC442e606809459d7E80C75c5eaBE5eaC3b88b;
    address dev3 = 0x0cAd323FB84Eb9D7BA2e42Cb4Afaf09157D72A16;
    address dev4 = 0x6352E129FdD4acCd2B1DE6B7bb13142800Ad6CE1;
    address dev5 = 0xB9b2dF03F48d86F9d02c00FB56DaDb42962d784D;
    
    function withdraw() public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
        require(balance > 0, "contract balance is 0");
        payable(dev1).transfer((balance * 200) / 1000);
        payable(dev2).transfer((balance * 200) / 1000);
        payable(dev3).transfer((balance * 200) / 1000);
        payable(dev4).transfer((balance * 200) / 1000);
        payable(dev5).transfer((balance * 200) / 1000);
    }
