...
contract LowGasFreeBabies is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Low Gas Free Babies", "LGFB") {
    setHiddenMetadataUri("ipfs://Qma9jg5biXYapWJdtXwaV6jzD6TxMYxA8fzVE3DjUWAoXk/hidden.json");
  }
