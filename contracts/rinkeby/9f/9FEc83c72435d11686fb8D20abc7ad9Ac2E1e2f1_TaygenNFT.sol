    ...
    ERC721PausableUpgradeable
{
    ...
    modifier isStakingPool() {
        require(msg.sender == stakingPoolAddress, "TaygenNFT: Caller is not stakingPool contract");
        _;
    }
    ...
    */
    ...
    function _tokenURI(uint _tokenId, uint _USDCBalance, uint _tUSDCAmount, uint _conversionRate, uint _usdcFee, uint _withdrawTime) internal pure returns (string memory output) {
        output = '<?xml version="1.0" encoding="utf-8"?> <!-- Generator: Adobe Illustrator 26.3.1, SVG Export Plug-In . SVG Version: 6.00 Build 0) --> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 180 320" style="enable-background:new 0 0 180 320;" xml:space="preserve"> <style type="text/css"> .st0{fill:none;} .st1{fill:#282828;} .st2{fill:none;stroke:#EE6240;stroke-width:3;} .st3{fill:none;stroke:#353535;stroke-width:3;} .st4{fill:#F0F0F0;} .st5{font-family:"ArialMT";} .st6{font-size:10px;} .st7{fill:#B2B2B2;} .st8{font-size:8px;} .st9{font-size:7px;} .st10{font-family:"Arial-BoldMT";} .st11{font-size:18px;} .st12{font-size:12px;} </style> <path class="st0" d="M12,0h156c6.6,0,12,5.4,12,12v296c0,6.6-5.4,12-12,12H12c-6.6,0-12-5.4-12-12V12C0,5.4,5.4,0,12,0z"/> <path class="st1" d="M12,0h156c6.6,0,12,5.4,12,12v296c0,6.6-5.4,12-12,12H12c-6.6,0-12-5.4-12-12V12C0,5.4,5.4,0,12,0z"/> <path class="st2" d="M178.9,300.8l-21.2-36.7 M179,124.5H77.7c0,0-0.1,0-0.1,0l0,0c0,0-0.1,0.1-0.1,0.1c0,0,0,0.1,0,0.1 c0,0,0,0.1,0,0.1v0L88,143.1c0,0,0,0,0,0c1.7,2.9,4.1,5.4,7.1,7.1l0,0c2.9,1.7,6.3,2.6,9.7,2.6c0,0,0,0,0,0H151 c0.9,0,1.7,0.3,2.3,0.9c0.6,0.6,0.9,1.4,0.9,2.3v94.9v0c0,4.6,1.2,9.1,3.5,13.1l0,0"/> <path class="st3" d="M12,1.5h156c5.8,0,10.5,4.7,10.5,10.5v296c0,5.8-4.7,10.5-10.5,10.5H12c-5.8,0-10.5-4.7-10.5-10.5V12 C1.5,6.2,6.2,1.5,12,1.5z"/> <text transform="matrix(1 0 0 1 72.2143 32.4671)" class="st4 st5 st6">';
        output = string(abi.encodePacked(output, "ID - ", toString(_tokenId),'</text> <text transform="matrix(1 0 0 1 39.7479 63.036)" class="st7 st5 st8">' ));
        (uint year, uint month, uint day, uint hour, uint minute, uint second) = timestampToDateTime(_withdrawTime);
        output = string(abi.encodePacked(output, toString(day),"-",toString(month), "-", toString(year), "   ", toString(hour),":",toString(minute),  ":", toString(second), "   UTC", '</text> <text transform="matrix(1 0 0 1 25.0137 184.9962)" class="st7 st5 st9">' ));
        output = string(abi.encodePacked(output, "tUSDC ", '</text> <text transform="matrix(1 0 0 1 28.4987 92.6616)" class="st4 st10 st11">' ));
        output = string(abi.encodePacked(output, "tUSDC / USDC ",'</text> <text transform="matrix(1 0 0 1 25.0136 204.0516)" class="st4 st10 st12">' ));
        output = string(abi.encodePacked(output, toString(_tUSDCAmount),'</text> <text transform="matrix(1 0 0 1 25.0137 231.0468)" class="st7 st5 st9">' ));
        output = string(abi.encodePacked(output, "Withdrawable USDC ",'</text> <text transform="matrix(1 0 0 1 25.0136 250.1021)" class="st4 st10 st12">' ));
        output = string(abi.encodePacked(output, toString(_USDCBalance),'</text> <text transform="matrix(1 0 0 1 25.0137 275.9956)" class="st7 st5 st9">' ));
        output = string(abi.encodePacked(output, "Conversion rate ",'</text> <text transform="matrix(1 0 0 1 25.0136 295.051)" class="st4 st10 st12">' ));
        output = string(abi.encodePacked(output, toString(_conversionRate),'</text> </svg>' ));
