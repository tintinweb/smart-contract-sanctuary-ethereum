...
contract MembershipPassBooth is IMembershipPassBooth, TerminalUtility {
    using SafeMath for uint256;
    ...
    mapping(address => mapping(uint256 => mapping(uint256 => WeightInfo))) public override depositedWeightBy;
