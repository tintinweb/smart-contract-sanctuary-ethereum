...
contract ChainsAirdrop is ERC1155, Ownable {
  ...
  bool public mintEnabled = true; // todo set to false

  // The address of the private key that creates nonces and signs signatures for mint. Always ensure you update your private key environment variable between testnet and mainnet deploys.
  ...
  // TODO: set this with the real URI and data
  constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmPiZNHiyip45jSmwYUqDdeiuY1Dqiad8V9tcRiuhYDNyM/{id}") {}

  // Mint Function

  /// @notice This function can only be called from the aidrop site and will fail if you attempt to call it from Etherscan.
  function mint(uint256 _ownerCount, bool _diamondMens, bool _goldMens, bytes calldata _signature) external {
    require(mintEnabled, "Mint disabxled");
    // require(!hasMinted[msg.sender], "Already minted");
    // hasMinted[msg.sender] = true;

    // On the server, we send in a signature comprising of the msg.sender and the amount the address holds at the time of the snapshot.
