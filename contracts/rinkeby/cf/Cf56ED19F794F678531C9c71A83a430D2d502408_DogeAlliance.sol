...
contract DogeAlliance is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant freeMintSupply = 50;
    ...
    constructor(bytes32 freeRoot) ERC721A("Doge Alliance", "DOGE", 100, 9000)  {
    ...
    function toggleEarlyAccessActive() external onlyOwner {
