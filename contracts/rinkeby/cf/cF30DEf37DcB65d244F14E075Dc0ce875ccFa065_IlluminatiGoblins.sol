...
contract IlluminatiGoblins is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    ...
    if(totalSupply() >= freeSupply){
        require(msg.value >= (_mintAmount * 0.005 ether)  , 'Insufficient funds!');
        _;
    }else{
        require(msg.value >= _mintAmount * 0 , 'Insufficient funds!');
        _;
    }
