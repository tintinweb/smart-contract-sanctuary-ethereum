...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */    
    ...
    function royaltyFee(uint256 tokenId) public view override returns(address[] memory, uint256[] memory) {
    ...
    */
    ...
    /**
        ...
        * @param _royaltyAddress uint256 royalty of the token to be minted
        * @param _royaltyfee uint256 royalty of the token to be minted
    */

    function _mint(uint256 tokenId, uint256 _supply, string memory _uri, address[] memory _royaltyAddress, uint256[] memory _royaltyfee) internal {
...
contract RUSTNFT1155 is ERC1155 {
    ...
    */
    ...
    function mint(string memory uri, uint256 supply, address[] memory royaltyAddress, uint256[] memory royaltyFee, Sign memory sign)  public {
        require(!usedNonce[sign.nonce], "Nonce : Invalid Nonce");
        usedNonce[sign.nonce] = true;
        verifySign(uri, _msgSender(), sign);
        _mint(newItemId, supply, uri, royaltyAddress, royaltyFee);
