  ...
  OwnableUpgradeable
{
  ...
  function withdraw(bytes4 interfaceId, address tokenAddress, uint256 amount, string memory nonce, uint256 expiration, bytes memory signature) public virtual {
    require(verifySignature(interfaceId, tokenAddress, amount, nonce, expiration, "withdraw", signature), "SmartWalletUpgradeable: unauthorized");
  ...
  function verifySignature(bytes4 interfaceId, address tokenAddress, uint256 amount, string memory nonce, uint256 expiration, string memory method, bytes memory signature) public virtual returns (bool) {
