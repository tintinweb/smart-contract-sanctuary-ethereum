...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new CXLDNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CXLDNFTUser1155Token token = CXLDNFTUser1155Token(address(addr));
...
contract CXLDNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
