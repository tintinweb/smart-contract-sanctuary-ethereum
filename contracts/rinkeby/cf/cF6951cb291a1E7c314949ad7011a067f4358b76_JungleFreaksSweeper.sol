...
contract JungleFreaksSweeper is ERC721A, Ownable, Pausable, ReentrancyGuard {  
    ...
    address public treasuryWallet = address(0x10101Ac0932e74494F4A553aE9770084A6c8e181);
    address public wnWallet = address(0x48B80A96E3c14fF24a2732970444Ae6166918190);
    address public bbWallet = address(0x3e2f194cc9EE48EF50C0E82a3c693524f7122D30);

	constructor() ERC721A("Jungle Freaks Sweeper", "JFFS") {
        _pause();
        setBaseUri("https://ipfs.io/ipfs/QmQhVCZnkG1JA34TMkrUW21yvEJX9aoD46vqNuCx48QScQ?");
    }
