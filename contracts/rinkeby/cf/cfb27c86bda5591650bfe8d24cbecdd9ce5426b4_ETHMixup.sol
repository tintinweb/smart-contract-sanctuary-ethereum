...
contract ETHMixup is Mixup, ERC2771Context {
    constructor(MinimalForwarder forwarder, IVerifier _verifier, address _hasher, uint256 _denomination, uint32 _merkleTreeHeight, address _operator, uint256 _commission ) Mixup(_verifier, _hasher, _denomination, _merkleTreeHeight, _operator, _commission) ERC2771Context(address(forwarder)) {}
    ...
    function _processWithdraw(address payable _recipient) internal override {
        ...
        require(success2, "Mixup: payment to operator was not successful");
