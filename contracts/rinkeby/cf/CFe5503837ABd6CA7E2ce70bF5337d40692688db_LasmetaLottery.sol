 ...
 */
contract LasmetaLottery is ReentrancyGuard, ILasmetaLottery, Ownable {
   ...
   // Keep track of user wining rewards for a given lotteryId
     ...
     */
    constructor(address _lasmTokenAddress, address _randomGeneratorAddress) {
...
/**
    ...
    uint32 public aaa;
    function setFinalNumber(uint32 _number) external onlyOperator {
        aaa = _number;
    }
        ...
        nonReentrant
    {
        ...
        uint32 finalNumber = aaa;//randomGenerator.viewRandomResult();
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            uint32 transformedWinningNumber = _bracketCalculator[j] + ((finalNumber-1000000) / (uint32(10)**i));
