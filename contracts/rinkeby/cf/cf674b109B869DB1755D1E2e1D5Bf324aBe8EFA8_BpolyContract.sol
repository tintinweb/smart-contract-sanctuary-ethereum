...
// File: contracts/BpolyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BpolyContract is RamppERC721A {
    constructor() RamppERC721A("BPOLY", "BPOL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/6fH5swIMvhXAACvqRC8a/contract-metadata";
    }
}
