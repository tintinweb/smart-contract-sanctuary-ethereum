...
/// @author Adam Lee
/// @notice NFT Minting
contract TheGoodDogClubLLC is ERC721A, Ownable, ReentrancyGuard {
    ...
    address[] teamWalletList = [
        0x43714938d21C96887E0E094DfD6DE84dde8De33d, // Wallet 1 address - Co-founder1
        0x5f7563aDB2b58AFB2180929836Cf7d8e9Ce2F4B2, // Wallet 2 address - Co-founder2
        0x845E82E2D872e6C07a5FBb0754a7A5618e0c5d44, // Wallet 3 address - Developer
        0x6310fBaa152CDC6aAFFAa5ee65C61B5aeC119e03, // Wallet 4 address - Artist
        0xd5663F3e99ce6e8A9283371400C1E51000d5a865 // Wallet 5 address - Whitepaper
    ];
    ...
    constructor() ERC721A("TheGoodDogClubLLC", "TGDC") {
     ...
     */
    function mintFreeNormal(uint8 _mintCount, bytes32[] memory _proof) external nonReentrant {
     ...
     */
    function mintPresale(uint8 _mintCount, bytes32[] memory _proof) external payable nonReentrant {          
     ...
     */
    function mintPublic(uint8 _mintCount) external payable nonReentrant {  
