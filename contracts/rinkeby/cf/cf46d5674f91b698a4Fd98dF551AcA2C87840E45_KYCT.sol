...
contract KYCT is ERC721URIStorage, AccessControl {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC721("Identity Token", "KYCT") {
    ...
    function transferMinting(address from, address to) external {
        require(hasRole(MINTER_ROLE, from), "ERR1");
    ...
    function currentAdmin() external pure returns (address) {
        revert("Cannot list the admin account");
    }
    ...
    {
        //TODO:  Why require in a getter? All info can be retrieved from the blockchain.
        /*
        require(
            _adminAddress == _msgSender(),
            "KYCT: Only admin can get list of tokens that users have."
        );
        */
