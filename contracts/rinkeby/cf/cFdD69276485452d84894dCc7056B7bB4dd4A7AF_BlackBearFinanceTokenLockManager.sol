...
import "./interfaces/IBlackBearFinanceTokenLockManager.sol";

/**
 * @title BlackBearFinanceTokenLockManager
 ...
 */
contract BlackBearFinanceTokenLockManager is
    MinimalProxyFactory,
    IBlackBearFinanceTokenLockManager
{
    ...
    event TokenLockCreated(
        ...
        IBlackBearFinanceTokenLock.Revocability revocable
    );
    ...
    function createTokenLockWallet(
        ...
        IBlackBearFinanceTokenLock.Revocability _revocable
...
import "./IBlackBearFinanceTokenLock.sol";

interface IBlackBearFinanceTokenLockManager {
    // -- Factory --
...
interface IBlackBearFinanceTokenLock {
    enum Revocability {
        NotSet,
        Enabled,
        Disabled
