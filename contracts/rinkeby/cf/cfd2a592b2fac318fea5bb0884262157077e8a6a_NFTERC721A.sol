...
contract NFTERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public wlSalePrice = 0.00001 ether;

    bytes32 public merkleRoot;

    uint public saleStartTime = 1652637030;
    address public addressMint = 0x38b1008519B29048B30D3dfa583D7D3DCb278593;

    mapping(address => uint) public amountNFTsperWalletWhitelistSale;

    uint private teamLength;

    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("Virtual Cube World", "VCW")
