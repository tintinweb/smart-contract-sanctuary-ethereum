...
// SPDX-License-Identifier: MIT
       ...
       ** Contract "RED_KNIGHTS" start at line 1350.
...
/*       ********************************************************
                 Contract RED_KNIGHTS      */


    pragma solidity ^0.8.0;

        contract RED_KNIGHTS is ERC721A, Ownable {
            using Strings for uint256;

        // Name and Symbol are not Modifiable once deployed.
          constructor() ERC721A("Red Knight Nation", "RKNFT") {}

        //BaseUri and Hidden MetaData URI are Modifiable, If required.
            string public baseURI = "ipfs://QmTEgJB8pifCAV2XPubzTpGE33Ck4wrvE4wbK8uNkWKfkU/";
            string public baseExtension = ".json";
            string public notRevealedUri = "";

        //Max supply is 2000 NFTs
