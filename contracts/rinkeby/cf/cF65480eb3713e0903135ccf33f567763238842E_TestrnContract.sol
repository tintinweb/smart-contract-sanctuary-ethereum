...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB7C414574140Fac23BADbE087624C0dFFf5E4d1D,0xB7C414574140Fac23BAdbE087624c0Dfff5e4D1e];
  uint256[] public payableFees = [5,94,1];
...
// File: contracts/TestrnContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TestrnContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "testrn";
    string public symbol = "testr";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ijW5Bm8cNn3esetOm4Xj/contract-metadata";
    }
