...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xD51478e677736a85Ea553D0557b50eFeAFa648f6];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xD51478e677736a85Ea553D0557b50eFeAFa648f6;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qme5gJj9DKDPMKHzeympkLtsUKx7PxMLig9Sto4x6DM3t3/";
...
// File: contracts/AnimaTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnimaTestContract is RamppERC721A {
    constructor() RamppERC721A("AnimaTest", "ANIM"){}
}
