...
import './StakedNFTSVG.sol';

library StakedNFTDescriptorGenerator {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '-',
                    baseTokenSymbol,
                    ' pool, staked and farming. ',
                    'The owner of this NFT can claim rewards and redeem for the underlying position.\\n',
                    '\\nPool Address: ',
                    poolAddress,
                    '\\n',
                    quoteTokenSymbol
    ...
    function generateSVGImage(ConstructTokenURIParams memory params) internal pure returns (string memory svg) {
        StakedNFTSVG.SVGParams memory svgParams =
            StakedNFTSVG.SVGParams({
                ...
                earningSymbols: params.earningSymbols,
        ...
        return StakedNFTSVG.generateSVG(svgParams);
    }
