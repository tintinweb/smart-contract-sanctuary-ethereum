...
contract GutterArt is ERC1155Burnable, Ownable, ReentrancyGuard {
	...
	function mint(
		...
		require(quantity * ethPrice == msg.value, "wrong price");
	...
	function mintWithGang(
		...
		uint256 price = quantity * gangPrice;
	...
	function setGangAddress(address _gangAddress) public onlyOwner {
