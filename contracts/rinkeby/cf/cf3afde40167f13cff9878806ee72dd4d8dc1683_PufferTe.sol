...
// File: contracts/lidyverse_puffer_test.sol
...
contract PufferTe is  Ownable, ERC2981, ERC721Enumerable {
  ...
  constructor(        
        ...
        uint96 _royaltyValue) ERC721("PufferT", "PUFT") {
  ...
  function isWhitelisted(address addressToQuery, bytes32[] calldata proof) external view  returns (bool){
      return MerkleProof.verify(proof, merkleRoot, keccak256(abi.encodePacked(addressToQuery)));
  }
