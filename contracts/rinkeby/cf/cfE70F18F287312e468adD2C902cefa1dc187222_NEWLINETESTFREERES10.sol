...
contract NEWLINETESTFREERES10 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  //  _safeMint(_msgSender(), _mintAmount);
    ...
    if (msg.sender != owner()) {
      ...
      require(_mintAmount < maxAllowedTokensPerPurchase, "More than max per transaction");
