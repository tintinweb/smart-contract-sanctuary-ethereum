...
/** 
 *  SourceUnit: e:\web\Blockchain\example1\cronos-nft-smartcontract\contracts\AngelStaking.sol
*/
...
contract Angel is ERC721, Ownable {
  using Strings for uint256;
...
contract AngelStaking is Ownable {
  ...
  function setChicksContract(address chicksAddress) public onlyOwner{
    ...
    _angelContract = Angel(chicksAddress);
  }
  ...
  function stakeArray(
    ...
    require(_angelContract.getNFTUser(_tokenIds[i]) == msg.sender || msg.sender == owner(), "Sender is not owner of current NFT token");
  ...
  function stake(
    ...
    require(_angelContract.getNFTUser(_tokenId) == msg.sender || msg.sender == owner(), "Sender is not owner of current NFT token");
  ...
  function _stake(
    ...
    _angelContract.isApprovedForAll(user, address(this));
