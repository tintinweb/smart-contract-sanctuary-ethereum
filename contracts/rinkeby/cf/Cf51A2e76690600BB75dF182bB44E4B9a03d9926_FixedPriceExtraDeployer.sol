...
import "../FixedPriceExtra.sol";
import "../util/OwnableUpgradeable.sol";
import "../interfaces/IFixedPriceExtraDeployer.sol";

contract FixedPriceExtraDeployer is IFixedPriceExtraDeployer, OwnableUpgradeable {
  address public immutable FIXEDPRICEEXTRA_IMPL;

  constructor() {
    __Ownable_init(msg.sender);
    FIXEDPRICEEXTRA_IMPL = address(new FixedPriceExtra());
  }
  ...
  function deployFixedPriceExtra(
    ...
    address clone = Clones.clone(FIXEDPRICEEXTRA_IMPL);

    FixedPriceExtra(clone).initialize(
      _name,
      _symbol,
      _bURI,
      _timelock,
