...
contract ProtocolToken is ERC20Votes, Ownable {
     ...
     */
    function mint(uint256 _amount) external multiAdmin returns (bool) {
        _mint(_msgSender(), _amount);
        return true;
    }

    /**
     * @notice Mint to recipient
     * @dev Only Admins
     * @param _recipient address
     * @param _amount uint256
     */
    function mintTo(address _recipient, uint256 _amount) external multiAdmin returns (bool) {
        _mint(_recipient, _amount);
        return true;
    }

    /**
     * @notice Burn from msg sender
     * @dev Only Admins
     * @param _amount uint256
     */
    function burn(uint256 _amount) external multiAdmin returns (bool) {
