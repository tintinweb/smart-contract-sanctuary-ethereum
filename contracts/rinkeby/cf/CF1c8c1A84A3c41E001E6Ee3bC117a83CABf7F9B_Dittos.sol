...
contract Dittos is ERC721A, Ownable {
    ...
    {
        string
            memory svg = '<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#F1C21B" d="M45.6,-53C59.4,-52.7,71.2,-39.8,77.4,-24.3C83.6,-8.7,84.3,9.4,73.4,17.9C62.4,26.3,39.8,25,25.7,30.3C11.5,35.7,5.7,47.7,-4.8,54.3C-15.3,60.8,-30.6,62,-42.6,55.9C-54.7,49.9,-63.4,36.7,-71.5,21.1C-79.5,5.5,-86.8,-12.6,-81.9,-26.2C-76.9,-39.9,-59.7,-49.2,-44,-48.8C-28.3,-48.4,-14.2,-38.3,0.9,-39.5C15.9,-40.7,31.8,-53.2,45.6,-53Z" transform="translate(100 100)" /></svg>';
        string memory json = string(
            abi.encodePacked(
                '{"name": "dic #',
                Strings.toString(tokenId),
                '", "description": "Dic can use Transform to mimic a different ERC721 or ERC1155 token.", "image": "data:image/svg+xml;base64,',
