...
//                                              __  _        
// _ __    ___ __      __   ___   ___   _ __   / _|(_)  __ _ 
//| '_ \  / _ \\ \ /\ / /  / __| / _ \ | '_ \ | |_ | | / _` |
//| | | ||  __/ \ V  V /  | (__ | (_) || | | ||  _|| || (_| |
...
contract NewConfig is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/808/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/808/contract-uri";
	...
	constructor(address _signerAddress) ERC721A("new config", "TST") {
