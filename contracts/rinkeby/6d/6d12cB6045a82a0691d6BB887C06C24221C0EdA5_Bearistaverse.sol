...
contract Bearistaverse is Ownable, ERC721A, MerkleWhitelist, ReentrancyGuard{
    ...
    mapping(address => bool) public userToHasMinted;  //TODO: remove if no limit on public mint
    ...
    uint public COLLECTION_SIZE = 100;
    uint public MINT_PRICE = 0.01 ether;
    uint public MAX_BATCH_SIZE = 3;
    uint public MAX_WL_BATCH_SIZE = 4;


    constructor() ERC721A("BearTest", "BEARTEST") {}
