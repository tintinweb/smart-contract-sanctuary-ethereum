...
contract RegularPrimeNFT is ERC721, Ownable {
    ...
    constructor() payable ERC721('RegularPrime', 'RPNFT'){
    ...
    // overrides tokenURI function from ERC721.sol to ensure the correct variable is being called
