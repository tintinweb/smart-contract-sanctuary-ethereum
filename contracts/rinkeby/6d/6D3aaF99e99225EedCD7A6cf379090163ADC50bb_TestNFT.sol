...
contract TestNFT is ERC721Tradable{
    ...
    constructor() ERC721Tradable("AR-CADUM", "ARC",0x465cD41394Eb35931f39fdd8507A230FF362f986,"https://gateway.pinata.cloud/ipfs/QmUePVdKQRcmT2ZHHELVqUrVupWUnLpSAedDAHif8PWnM6/") {}
...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, Ownable {
  ...
  function MainsaleSupply(uint256  Mainsale_Supply ) public  onlyOwner {
    ...
    function OwnerPresale(address _to, uint256  _tokens) external onlyOwner {
         require(totalSupply() <= _maxPresaleSupply);
