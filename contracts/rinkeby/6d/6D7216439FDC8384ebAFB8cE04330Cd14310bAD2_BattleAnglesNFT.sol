...
contract BattleAnglesNFT is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    uint256 public maxGiftMintId = 10;
    uint256 public giftMintId = 1;


    uint256 public maxWhitelistId = 53;
    uint256 public whitelistId = 50;
    uint256 public constant WHITELIST_SALE_PRICE = 0.2 ether;

    uint256 public maxPublicMint = 3333;
    uint256 public publicMintId = 60;
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("BattleAngles NFT testfine", "BANFTTESTFINE") {
        setBaseURI(_baseURI);
