...
contract Landscapes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmeFmJxmbBePs4S3snNvNq6f4hEsWxiXbGc2rynzM4h5q7";
    ...
    constructor(
    ) ERC721A("Landscapes 800AD - by Eric Bjornsson V1", "LD", 100, maxSupply) {
    }
