...
contract LegendaryBattleDogs is ERC721Enumerable, Ownable {
    ...
    uint256 public rareCost = 0.5 ether;
    ...
    uint256 public preSaleDate = 1650437563;
    uint256 public preSaleEndDate = 1650438643;
    uint256 public publicSaleDate = 1650438643;
    ...
    function publicsaleValidations(uint256 _ownerMintedCount, uint256 _mintAmount) internal {
        uint256 currentCost = getCurrentCost();
