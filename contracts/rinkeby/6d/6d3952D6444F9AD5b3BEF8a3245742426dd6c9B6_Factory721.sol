...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new FortalezaNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        FortalezaNFTUser721Token token = FortalezaNFTUser721Token(address(addr));
...
contract FortalezaNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
