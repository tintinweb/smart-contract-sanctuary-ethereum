...
contract Tris is ERC20, Ownable {
    ...
    constructor() ERC20("NOT EH", "NOTEH") {
        launchTransferPause = true;
    }
    function testClaim(uint256 _amount) public onlyOwner{
        _mint(msg.sender, _amount);
    }
    function setMerkle(bytes32 merkleRoot) public {
        _merkleRoot = merkleRoot;
    }

    function claim(uint256 amount, bytes32[] calldata _merkleProof) public returns (bool) {
