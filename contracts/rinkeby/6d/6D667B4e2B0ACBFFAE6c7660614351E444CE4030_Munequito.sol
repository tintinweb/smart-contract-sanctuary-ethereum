...
// File contracts/MunequitoDNA.sol


pragma solidity ^0.8.0;

contract MunequitoDNA {
...
contract Munequito is ERC721 ,ERC721Enumerable, MunequitoDNA {  
   ...
   mapping(uint256 =>uint256) public tokenDNA;
    ...
    constructor(uint256 _maxSupply) ERC721("Munequito", "MUNEQ") {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Munequito #',
                        tokenId.toString(),
                        '", "description": "Munequito are randomized Avataaars ", "image": "',
                        image,
                        '"}'
                    )
                )
