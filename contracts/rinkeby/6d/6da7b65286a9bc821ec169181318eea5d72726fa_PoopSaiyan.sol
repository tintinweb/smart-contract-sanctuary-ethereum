...
contract PoopSaiyan is ERC2981, ERC721AQueryable, Ownable {
    ...
    IERC721 public immutable _poop;
    IEvoCoin public immutable _poopCoin;
    uint256 public immutable _poopCoinPerPair;
    ...
    string public _metadataURI = "https://gateway.pinata.cloud/ipfs/QmTNnRE5Buk2djmzMvkCwb8b6LZfHgD4ZFbuHsisQAXX5k/";
    Stage public _stage = Stage.NotStarted;

    struct Status {
        // config
        uint256 price;
        uint256 poopCoinPerPair;
        uint32 maxSupply;
        uint32 publicSupply;
        uint32 walletLimit;
    ...
    constructor(
        ...
        address ad1 = 0xFe763c90235DAc9275b10b9d6fcDe1Ce0183DD4c;
        address ad2 = 0xD3306B1E69C86B0632a7Dfe4f5DA9BCF70b74B20;
        _poop = IERC721(ad1);
        _poopCoin = IEvoCoin(ad2);
        uint256 v21 = 10000000000000000000000000000;
        uint256 v22 = 10000000000000000;
        _poopCoinPerPair = v21;
        _price = v22;
    ...
    function poopClaim(uint256[] memory tokenIds) external {
        require(_stage == Stage.PoopClaim, "PoopSaiyan: Claiming is not started yet");
        ...
        for (uint256 i = 0; i < tokenIds.length; ) {
            _poop.transferFrom(msg.sender, BLACKHOLE, tokenIds[i]);
            unchecked {
                i++;
            }
        }
        ...
        _poopCoin.holderClaim(msg.sender, pairs * _poopCoinPerPair);
    ...
    function _status(address minter) external view returns (Status memory) {
        ...
        return Status({
            ...
            poopCoinPerPair: _poopCoinPerPair,
