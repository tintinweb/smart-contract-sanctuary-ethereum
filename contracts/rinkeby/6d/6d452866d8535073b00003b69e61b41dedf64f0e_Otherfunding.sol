...
contract Otherfunding is ERC1155Supply, Ownable, PaymentSplitter {
    ...
    constructor()
        ERC1155("https://ipfs.io/ipfs/QmPnpjeXvCwUCMLccNNWqMgT9UzvTVydVc5TxanccZe9ys")
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(totalSupply(id) + _amount <= maxSupply, "Not enough supply");
        _mint(msg.sender, id, _amount, "");
    }

    function ownerMint() external onlyOwner {
        require(!didOwnerMint, "Already minted");
        require(totalSupply(id) + 10 <= maxSupply, "Not enough supply");
