...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    ...
    buildings.push(Building("ZERO", 0,0,0,0,0,0)); // 37:17
    buildings.push(Building("House", 1,3,2,2,0,3)); //37:54
    buildings.push(Building("Jimmy House", 2,5,4,10,0,0));
