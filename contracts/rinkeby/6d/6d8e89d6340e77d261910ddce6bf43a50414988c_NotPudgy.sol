...
contract NotPudgy is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public uriPrefix = "https://gateway.pinata.cloud/ipfs/";
    string public uriSuffix = ".json";
    string public metadataUri; //https://gateway.pinata.cloud/ipfs/QmTa2La4jHvM2G5KdZ2HXEvQgFWwiDR2qpcdQt6zoJRokB/

    uint256 public cost = 2500000000000000;
    uint256 public maxSupply = 50;
    uint256 public reserve = 8;
    uint256 public freeClaim = 12;
