...
contract MetaWizards is ERC721A, Ownable, ReentrancyGuard {
    ...
    /*//////////////////////////////////////
                CONSTRUCTOR
    //////////////////////////////////////*/
    constructor(uint16 collectionSize_, uint16 reserveSupply_, uint32 mintData_, address[] memory whitelist_) ERC721A("Meta Wizards", "MWIZ") {
        collectionSize = collectionSize_;
        reserveSupply = reserveSupply_;
        mintData = mintData_;

        for (uint32 i = 0; i < whitelist_.length; i++) {
            mintList[whitelist_[i]] = true;
        }
