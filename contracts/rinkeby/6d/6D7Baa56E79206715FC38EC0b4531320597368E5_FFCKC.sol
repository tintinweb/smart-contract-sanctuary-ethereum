...
contract FFCKC is Ownable, ERC721A, ReentrancyGuard {
  ...
  function setupWhitelistSale(
    ...
    whitelistSaleConfig.endTime = entTime;
    whitelistSaleConfig.maxPerAddress = maxPerAddress;
  }
