...
PullPayment
{
    ...
    function mintItem(address account, uint256 tokenId) external payable
    {
        require(_whitelist[account], "Not on the whitelist.");
