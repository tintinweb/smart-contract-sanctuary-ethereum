...
/**
 * @title BiletsClubSmallHealthPotion Contract
 */

contract BiletsClubSmallHealthPotion is ERC1155, Ownable, ReentrancyGuard {
    string public name = "Bilets Club Small Health Potion";
    string public symbol = "BLT-SHP";

    uint256 public mintRate = 0.00 ether;
    bool public pause = false;

    string public contractURI =
        "https://bilets.club/api/opensea_contracts_meta/contractHeals";
    string public tokenURI = "https://bilets.club//api/opensea_meta_heals/1";
    ...
    constructor(
        ...
        ERC1155(
            "https://bilets.club/api/opensea_contracts_meta/contractHP00001"
        )
    {
