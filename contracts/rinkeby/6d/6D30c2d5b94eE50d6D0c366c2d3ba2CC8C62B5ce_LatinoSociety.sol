 ...
 * Twitter --> https://twitter.com.neftfify 
 ----------------------------------------------------------------------------*/
...
// - Los URIs determinan donde está la metadata de las imágenes
...
// --------------------------------------------------------------------------
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(presaleBeginDate <= block.timestamp &&
            presaleEndDate >= block.timestamp, "Lo sentimos, Phase Not Active"); 
 ...
 function setProvenance(string memory _provenance) public onlyOwner {
  ...
  function setPreSaleTimes(uint256 _PreSaleBeginDt, uint256 _PreSaleEndDt) public onlyOwner {
   ...
   /*
     ...
     *  y tambien el otro como salvaguarda.  
     *  Si ven este comentario, díganle a VHSBoss que 
     *  TODO esta bajo control... ;o)                      *
     *-----------------------------------------------------*/
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
     ...
     *  Recuerden esperamos que nos dejen... ;o)   *
     *---------------------------------------------*/
    ...
    /*
     *  WithdrawAll -Allow contract owner to withdraw to specific accounts        *
     *---------------------------------------------------------------------*/
