...
contract Treasury is Ownable{
    ...
    function withdraw(IERC20 _tokenAddress, address _beneficiery, uint _amount) public onlyOwner{
        _tokenAddress.transfer(_beneficiery, _amount);
    }

    function getUserDetails(address _user) public view returns(IERC20[] memory, uint[] memory){
