...
// File: contracts/Alpha_Collective_Entry.sol



/**
    The Alpha Collective is a premium community that helps corporates and degens partner and win at the business of Web3.
*/

pragma solidity >=0.7.0 <0.9.0;

contract AlphaCollectiveEntry is ERC721, Ownable {
  ...
  address Alpha = 0xb9FC76d8afDDeb73AA10b87dD52416a49141C77D;
  ...
  // Max Free Mints Per Wallet
  mapping(address => uint256) public mintedByAddress;

  constructor() ERC721("Alpha Collective Entry", "ACE") {
  ...
  function mint(uint256 numberOfTokens) public payable {
        ...
        if (holder > 0) {
           ...
           //if (maxMintsPerWallet > mintedByAddress[_msgSender()]) {
           require(numberOfTokens + mintedByAddress[_msgSender()] <= maxMintsPerWallet);
           for(uint i = 0; i < numberOfTokens; i++) internalMint(msg.sender);   

           //mintedByAddress[_msgSender()] += numberOfTokens;
...
*/
  ...
  function setMaxMintsAmountPerWallet(uint256 _maxMintsPerWallet) public onlyOwner {
