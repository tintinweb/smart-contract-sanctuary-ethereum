...
contract pirea is ERC721URIStorage, Ownable, ERC721Enumerable {
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    function mintNFT(address recipient, string memory tokenURI, int16 x_value, int16 y_value) public returns (uint256) {
