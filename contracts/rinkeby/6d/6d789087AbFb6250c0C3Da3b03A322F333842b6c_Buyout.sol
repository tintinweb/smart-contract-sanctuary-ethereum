...
contract Buyout is IBuyout, Multicall, NFTReceiver, SafeSend, SelfPermit {
    ...
    function withdrawERC20(
        ...
        // Initializes vault transaction
        bytes memory data = abi.encodeCall(
            ITransfer(transfer).ERC20Transfer,
            (_token, _to, _value)
        );
    ...
    function withdrawERC721(
        ...
        // Initializes vault transaction
        bytes memory data = abi.encodeCall(
            ITransfer(transfer).ERC721TransferFrom,
    ...
    function withdrawERC1155(
        ...
        // Initializes vault transaction
        bytes memory data = abi.encodeCall(
            ITransfer(transfer).ERC1155TransferFrom,
    ...
    function batchWithdrawERC1155(
        ...
        // Initializes vault transaction
        bytes memory data = abi.encodeCall(
            ITransfer(transfer).ERC1155BatchTransferFrom,
