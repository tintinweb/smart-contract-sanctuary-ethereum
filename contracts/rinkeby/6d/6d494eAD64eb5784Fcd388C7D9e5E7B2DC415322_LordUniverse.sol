...
contract LordUniverse is ERC721A, Ownable, ReentrancyGuard {
    ...
    // address acct97 = 0xC1d8eAD34882129f7F439855B336D23053D9e793;
    address acct97 = 0x33b66102D8984940F2C9e0984eDB1d221A32eC47;
    address acct03 = 0xb20F2a4601aED75B886CC5B84E28a0D65a7Bfd48;

    constructor(
        uint256 maxBatchSize_,
        string memory baseURI_,
        string memory notRevealedURI_
    ) ERC721A("Lord Universe", "LOD") {
    ...
    function withdraw() external onlyOwner nonReentrant {
        require(payable(acct97).send((address(this).balance / 100) * 97));
        require(payable(acct03).send((address(this).balance / 100) * 3));
    }
    ...
    function setAccounts(address _acct97, address _acct03) external onlyOwner {
        acct97 = _acct97;
        acct03 = _acct03;
    }
