...
contract AddStructure{
    ...
    function addAddress(address add) payable public {
    ...
    function removeAddress(address add) payable public{
        //Extra security for method initialization
