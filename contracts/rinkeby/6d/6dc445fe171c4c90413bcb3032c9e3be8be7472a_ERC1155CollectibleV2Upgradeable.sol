...
contract ERC1155CollectibleV2Upgradeable is
    Initializable,
    ERC1155Upgradeable,
    ...
    ERC1155BurnableUpgradeable
{
    ...
    //number of currencies/shards
    uint256 public shards;
    ...
    function mintNFTBatch(
        ...
        require(
            ...
            "#mintNFTBatch: array length mismatch"
        );
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            ...
            require(
                ...
                "#mintNFTBatch: ONLY_CREATOR_OR_APPROVED"
            );
    ...
    /**
     * @dev Mint shards for each id in _ids
     * @param to           The address to mint shards to
     * @param ids          Array of shard ids to mint
     * @param amounts      Array of amounts of shards to mint per id
     * @param data         Data to pass if receiver is contract
     */
    function mintShardBatch(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            require(_exists(ids[i]), "NONEXISTENT_TOKEN");
            require(
            ...
            uint256 _amount = amounts[i];
            tokenSupply[ids[i]] = tokenSupply[ids[i]] + _amount;
            //Emit event
            emit ERC1155NFTMinted(
                ids[i],
                _amount,
     ...
     * @param _type type of the token to create (champion or item)
     * however, if tier is 00, then _type will be shard type (bronze, silver, gold, platinum, diamond)
     * @return The calculated prefix of provided season, tier and type
     */
