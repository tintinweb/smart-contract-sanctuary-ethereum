...
contract LiquidityExamples is IERC721Receiver {
    ...
    constructor(
        ...
        address passedToken0,
        address passedToken1,
        uint24 fee
    ) {
        nonfungiblePositionManager = INonfungiblePositionManager(_nonfungiblePositionManager);
        swapRouter = ISwapRouter(_swapRouter);
        if(passedToken0 < passedToken1) {
            token0 = passedToken0;
            token1 = passedToken1;
        } else {
            token0 = passedToken1;
    ...
    function initTestPool(uint160 sqrt) external {
       nonfungiblePositionManager.createAndInitializePoolIfNecessary(token0, token1, POOL_FEE, sqrt);
    }

    /// @notice Calls the mint function defined in periphery, mints the same amount of each token. For this example we are providing 1000 YADD and 1000 WETH in liquidity
    ...
    function _sendToOwner(
        ...
        address rtoken0 = deposits[tokenId].token0;
        address rtoken1 = deposits[tokenId].token1;
        // send collected fees to owner
        TransferHelper.safeTransfer(rtoken0, owner, amount0);
        TransferHelper.safeTransfer(rtoken1, owner, amount1);
    }
    ...
    SelfPermit
{
    ...
    function getPool(
        ...
        console.log("computedAddress", PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
        console.log("getPool factory", factory);
    ...
    function exactInputInternal(
        ...
        (address tokenIn, address tokenOut, uint24 fee) = data.path.decodeFirstPool();
        console.log(tokenIn, tokenOut, fee);
...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    constructor() {
        int24 _tickSpacing;
        factory = address(0x001f98431c8ad98523631ae4a59f267346ea31f984);
        token0 = address(0x00c778417e063141139fce010982780140aa0cd5ab);
        token1 = address(0x00ef0e4962040c5a8b4c24ef92fe440af749046d41);
        fee = 3000;
        _tickSpacing = 60;
    ...
    function _updatePosition(
        ...
        if (liquidityDelta != 0) {
            ...
            console.log("flippedFirst");
            if (flippedUpper) {
                tickBitmap.flipTick(tickUpper, tickSpacing);
            }
            console.log("flippedSecond");
        }
        console.log("cp");
...
library TickBitmap {
    ...
    function flipTick(
        ...
        console.log(uint256( tickSpacing ));
        console.log(uint256(tick % tickSpacing));
...
contract UniswapV3Factory is IUniswapV3Factory, UniswapV3PoolDeployer, NoDelegateCall {
    ...
    function createPool(
        ...
        console.log(token0, token1, fee, pool);
...
contract TestToken is ERC20Burnable {
    constructor(uint256 _initialSupply, uint8 _decimals) ERC20("Yadd V4", "YD4") {
