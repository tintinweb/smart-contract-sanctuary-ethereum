...
contract BurnToken is ERC721 {
    ...
    address public signerAddress = 0xDFd0FE2adD008a2d5d1d84Fe08bB1cCC245Be40e;
    address public rewardContract = 0x000000000000000000000000000000000000dEaD;
    address public mintPassAddress = 0x9D610B2Bf201dD8Ae4FC1E96e6079D9F290fF3f7;
     ...
     * @dev Mint a token
     */
    function mint(uint256 amount, uint256 _maxMint, bool _hasPass, bytes calldata _signature) external payable callerIsUser contractIsNotFrozen {
    ...
    external payable callerIsUser contractIsNotFrozen {
        ...
        // set the flag that the user has used the pass to mint
