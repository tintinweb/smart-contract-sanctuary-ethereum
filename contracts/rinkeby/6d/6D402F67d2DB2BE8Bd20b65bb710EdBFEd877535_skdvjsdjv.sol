...
contract skdvjsdjv is ERC721, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

    uint256 public totalSupply = 0;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/407/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/407/contract-uri";
	...
	uint256 public presalePricePerToken = 30000000000000000;
    uint256 public tokenfyPresalePrice = 40000000000000000;
    uint256 public presaleEndDate = 1644585032;
	...
	constructor(address _signerAddress) ERC721("dvijdiv", "DVJ") {
