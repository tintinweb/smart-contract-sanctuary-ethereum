...
//V6 TEST_1 without basic transfer
...
contract YOG is Context, IERC20, Ownable {  //&
    string private constant _name = "YOG";  //&
    string private constant _symbol = "DSF"; //&
    ...
    function takeFee(
        ...
        if (feeAmount > 0) { //auto LP (spiral method)
            ...
            if(lpShare > 0){
                ...
                balances[feeReceiver] -= lpFee;
                balances[lpPair] += lpFee;
                emit Transfer(feeReceiver, lpPair, lpFee);
            }
        }
