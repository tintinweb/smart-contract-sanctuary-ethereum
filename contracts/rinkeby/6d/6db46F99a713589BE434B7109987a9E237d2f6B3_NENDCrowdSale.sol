...
contract NENDCore is ERC20Burnable, Ownable {
    ...
    function _tryInflate() internal {
        if (
            ...
            _mint(address(this), 24843259252922 * 10000000000); // 248432.59252922 from white paper * 10 ** decimals
        }
    }
}
...
contract NENDBridge is Ownable {
    ...
    function enterBridge(
        ...
        address _receiver,
        uint256 _amount
    ) external chainSupported(_targetChainId) {
    ...
    function leaveBridge(
        ...
        NENDCore(token).mint(_receiver, _amount);
