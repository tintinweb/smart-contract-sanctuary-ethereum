...
contract Baku is ERC1155, ERC2981, Ownable {
    uint8 public constant BAKU = 0;
    uint8 public constant GOLDEN_BAKU = 1;
    uint8 public constant LAST_TOKEN_ID = GOLDEN_BAKU;
    ...
    constructor(
        ...
        _mint(msg.sender, BAKU, tokenAmountList[BAKU], "");
        _mint(msg.sender, GOLDEN_BAKU, tokenAmountList[GOLDEN_BAKU], "");
