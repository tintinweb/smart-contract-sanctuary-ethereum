...
contract TestCollection is ERC1155Supply, Ownable
{
    ...
    uint256 public constant PRICE = 4400000000000000; //0.25 ETH
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/QmTvFJBYXMSR12CPcKZbdtvbmiar7QHcGaraReKj8h6C8H/{id}.json") {}

    address payable private recipient1 = payable(0x2A1F9c78F270E009c16D92aaccAbD1Bdf35772a9); //partners payout address
