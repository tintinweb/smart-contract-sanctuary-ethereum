...
contract Boki is ERC721A, Ownable, VRFConsumerBase {
  ...
  // ------ Sale Settings
  uint256 private constant PRICE_BOKI = 0.001 ether;
  uint256 private constant MAX_BOKI = 100;
  uint256 private constant DEPLOYER_RESERVED_BOKI = 10;
  uint256 private constant PUBLIC_BOKI_PER_TXN_LIMIT = 3;

  // Remaining public Bokis (7777-1263-3753-1263-150=1348)
  uint256 public publicBokiRemaining = 80;
