...
contract testRobotBoy is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 1;
    uint256 MAX_MINT_SUPPLY = 5;

    uint256 gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("testRobotBoy", "testRobotBoy")
    {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 4, "testRobotBoy: Max 3 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_SUPPLY,
            "testRobotBoy: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "testRobotBoy msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "testRobotBoy: Failed to withdraw Ether");
    }
