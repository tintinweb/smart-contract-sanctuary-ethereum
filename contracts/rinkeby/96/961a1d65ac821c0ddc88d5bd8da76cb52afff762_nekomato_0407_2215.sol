...
// File: nekomato/nekomato_0407.sol
...
contract nekomato_0407_2215 is ERC721{
...
//ここが名前
    constructor() ERC721("nekomato0407_2215" , "nkmt0407_2215" ) {
        //owner address
    ...
    function chengeForm(address _address,uint _id,string memory _uri) external{
        require(allowStoneList[msg.sender]);
        tokenURIs[_id] = _uri;
    }
}