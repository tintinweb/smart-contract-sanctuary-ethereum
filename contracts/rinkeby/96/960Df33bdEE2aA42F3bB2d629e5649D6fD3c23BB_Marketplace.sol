    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    {
        makeMatch = matchAssets(orderLeft.makeAsset.assetType, orderRight.takeAsset.assetType, orderLeft);
        require(makeMatch.assetClass != 0, "assets don't match");
        takeMatch = matchAssets(orderLeft.takeAsset.assetType, orderRight.makeAsset.assetType, orderLeft);
