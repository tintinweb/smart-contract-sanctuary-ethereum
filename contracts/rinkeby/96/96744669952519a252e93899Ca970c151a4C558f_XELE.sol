...
contract XELE is ERC721Metadata {
   ...
   struct Tile {
    ...
    mapping(int128 => mapping(int128 => uint256)) public tile_id_at;
    ...
    function mint(address to, uint256 tokenId ) external returns (bool) 
    {
        ...
        tiles[tokenId] = Tile(0, 0, 0, '', block.timestamp, true);
    ...
    function ownTile(
        ...
        require(_minters[msg.sender], "minter invalid");
        require(tile_id_at[_x][_y] == 0, "unclaimable tile");

        tiles[tokenId] = Tile(_x, _y, _t, _name, block.timestamp, true);
        tile_id_at[_x][_y] = tokenId;
        
        emit OwnTile(tokenId, _x, _y, _t, _name);
    }
    ...
    function burn(uint256 tokenId) external {
        ...
        if(tiles[tokenId].exists){
             int128 _x1 = tiles[tokenId].x;
             int128 _y1 = tiles[tokenId].y;
             tile_id_at[_x1][_y1] = 0;
             emit TileBurn(tokenId, _x1, _y1);
        }
