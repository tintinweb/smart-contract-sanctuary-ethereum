...
// GalaXYKats
contract NFT002 is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using MerkleProof for bytes32[];
    using ECDSA for bytes32;

    // constants
    uint256 public constant PRE_SALE_NFT_PRICE = 0.05 ether;
    uint256 public constant PUBLIC_SALE_NFT_PRICE = 0.1 ether;
    uint256 public constant MAX_NFT_PURCHASE = 5;
    uint256 public constant MAX_SUPPLY = 2022;  // count

    // free claim related
    uint256 public freeClaimStartTime;
    uint256 public freeClaimEndTime;
    bytes32 private _freeClaimMerkleRoot;  // free
    ...
    constructor() ERC721("NFT002", "NFT002") {}
