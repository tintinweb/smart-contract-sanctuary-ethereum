...
contract COI is ERC1155, Ownable, Pausable, ERC1155Supply {
    constructor() ERC1155("") {}

    mapping(address => bool) whitelistedAddresses;
    uint256 public numberOfAddressesWhitelisted;
    uint16 public tokenMaxSupply = 7000;
    ...
    function changetotalSupply(uint16 supply) public onlyOwner whenNotPaused {
       tokenMaxSupply = supply;
    }
    ...
    function mint(address account, uint256 amount) public whenNotPaused {
        if (isPreSale) {
            ...
            require(amount < 3, "Error: Exceed Max mint");
        }
        uint256 ts = totalSupply(1);
        require(ts + amount <= tokenMaxSupply, "Error: Exceed total Supply");
