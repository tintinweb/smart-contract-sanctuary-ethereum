...
Owner = msg.sender;
    ...
    *
    */ 
    function getLastProposalWinning() public view returns(uint, address, string memory){
        return (winnings.length, proposalsWinning[winnings.length].voter, proposalsWinning[winnings.length].description);
    }
