...
contract SpaceCoin is ERC20 {
    ...
    uint256 public maxSupply; // 500,000
    ...
    constructor(address _owner, address _treasury) ERC20("SpaceCoin", "SPCE") {
        owner = _owner;
        treasury = _treasury;
        maxSupply = 500_000 * 10**decimals();
    }

    /**
     * @notice Sets the minter to a specific address
