    ...
    Ownable
{
    ...
    uint256 public constant EARN_RATE = 1157407407400000000; //11574074074000
    ...
    function earned(uint256 tokenId) public view virtual returns (uint256) {
        ...
        return
            base.add(tiers[_tier[tokenId]]).add(_issued[tokenId]).sub(
                _spent[tokenId]
            );
    }
    ...
    function _beforeTokenTransfers(
        ...
        // Always resent spent and issued
        _spent[startTokenId] = 0;
        _issued[startTokenId] = 0;
