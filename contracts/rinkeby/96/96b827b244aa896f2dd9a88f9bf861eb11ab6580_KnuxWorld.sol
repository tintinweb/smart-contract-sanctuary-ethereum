...
contract KnuxWorld is ERC721A, MerkleDistributor, ReentrancyGuard, AccessControl {
    ...
    uint256 public constant PRICE_PER_TOKEN = 0.0125 ether;
    ...
    constructor(address payable shareholderAddress_) ERC721A("KnuxWorld", "KNUXWRLD") {
