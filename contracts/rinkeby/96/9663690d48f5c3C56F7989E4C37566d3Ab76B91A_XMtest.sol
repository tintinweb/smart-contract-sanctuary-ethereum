...
contract XMtest is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("XMtest", "XM") {
    uint256 _cost;
    cost = _cost;
    setHiddenMetadataUri("https://bafybeiaqejny5tyzlgbzhs4doz5o3dx4gpgouv3fuv3umi5ejruvcwgsta.ipfs.nftstorage.link/hidden_metadata/hidden.json");
  }
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    return bytes(currentUriPrefix).length > 0
        ? string(abi.encodePacked(currentUriPrefix, tokenId.toString(), uriSuffix))
        : "";
  }
