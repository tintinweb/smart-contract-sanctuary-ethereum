...
contract WoF is ERC721A, Ownable {
  ...
  constructor(string memory baseTokenURI_, address reserved)
  ...
  function setMaxPerMint(uint256 updatedMaxPerMint) public onlyOwner {
  ...
  function enablePrivateSale(bytes32 _merkleRoot) public onlyOwner {
    saleIsOpen = false;
    _price = 0.15 ether;
    maxPerMint = 2;
    merkleRoot = _merkleRoot;
