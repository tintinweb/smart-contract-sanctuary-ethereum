...
contract OriginStories is PVERC721, PVAllowlist {
    ...
    uint256 constant MAX_SALE_SUPPLY = 5784;

    uint256 public MINT_PRICE = 1e15;
    ...
    constructor(
        ...
        _mint(0x8c685C44fACB8Bf246fCb0E383CCa4Bd46634bF8, totalSupply() + 1);           
    } 
    ...
    * @notice edit windows
    * 
    * @param stage the index of the stage to change
    * @param newWindow UNIX timestamp for window opening time
    */
    function editStageWindows(
        uint256 stage,
        uint256 newWindow     
    ) external onlyOwner {         
        stageWindows[stage] = newWindow;
    }
