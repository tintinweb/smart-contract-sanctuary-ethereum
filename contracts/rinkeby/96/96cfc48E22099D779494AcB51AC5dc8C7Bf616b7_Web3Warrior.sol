...
contract Web3Warrior is ERC721Ab, Ownable, ReentrancyGuard {
 ...
 */
contract ERC721Ab is Context, ERC165, IERC721, IERC721Metadata, IERC2309 {
        ...
        unchecked {
            ...
            if (safe && to.isContract()) {
                ...
                if (_currentIndex != startTokenId) revert();
                    ...
                    emit ConsecutiveTransfer(updatedIndex, end, address(0), to);
                    updatedIndex = end;
            }
