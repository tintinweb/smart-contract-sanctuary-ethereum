...
contract ComicBook721 is ERC721AQueryable, Ownable, ERC2981 {
    ...
    modifier open() {
        require(_mintStatus == 1, 'CB 100 - Minting not open');
        _;
    }
    ...
    function mint(
        ...
        uint256 newTotal = _totalMinted[msg.sender] + amount;
        require(newTotal <= totalAllowance, 'CB 101 - Invalid mint amount');

        uint256 startIndex = _nextTokenId();
        require(startIndex < MAX_LIMIT, 'CB 102 - Exceeds population max');
