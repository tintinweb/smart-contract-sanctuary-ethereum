...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://bafybeigue2ztv65uztbezm3dzwz3anb4a4iibfx4l5wsftxt3svjtx2d6i/1/";
...
// File: contracts/MatosaatanaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MatosaatanaContract is RamppERC721A {
    constructor() RamppERC721A("Matosaatana", "MASA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/jlOBuHXymywkuDXc4WIL/contract-metadata";
    }
}
