...
contract ISAGtest is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("ISAGtest", "ISAG") {
  ...
  string private customContractURI =
    "%20https://arweave.net/G7P08ee_gDiCiob6PrqurTHUMla9wPf9fPd-wtWvqds";
  ...
  address private constant payoutAddress1 =
    0x9D94463Cd316Dc4F811c8a3642ba406058abaB12;
