...
contract MF is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable refundPeriod = 1 days;
    ...
    mapping(uint256 => bool) public isairdropMint;
    ...
    ) ERC721A("MetaFriend", "MF", _maxBatchSize, _collectionSize) {
        baseURI = initBaseURI;
        _signer = signer;
    ...
    function airdropToAddr(address[] memory toList) external onlyOwner {
        ...
        for(uint i; i< toList.length; i++) {
            ...
            airdropMintCount += 1;
            isairdropMint[totalSupply()-1] = true;
    ...
    function refund(uint256 tokenId) external {
        ...
        require(!isairdropMint[tokenId], "AIrdrop minted NFTs cannot be refunded");
    ...
    function withdrawAll() external onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(0xAE60f8A99ede217b482d44BAB18ACCbd6b64Fe76, balance.mul(70).div(100));
        _widthdraw(0xAE60f8A99ede217b482d44BAB18ACCbd6b64Fe76, address(this).balance);
    }
