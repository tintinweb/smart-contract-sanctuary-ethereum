...
contract ggggtest2 is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.005 ether;
    uint256 public maxSupply = 7777;
    uint256 public maxFree = 3000;
    uint256 public maxperAddressFreeLimit = 3000;
    uint256 public maxperAddressPublicMint = 3000;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("ggg test2", "ggg test2") {
        setBaseURI("ipfs://hhh/");
