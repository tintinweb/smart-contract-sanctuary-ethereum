...
contract Test is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public FreemintTotal = 3;
...
if(Supply + _mintAmount <= FreemintTotal) {
        require( msg.value >= 0 );
        require(_numberMinted(_msgSender()) + _mintAmount <= MaxPerWalletFree, 'Only One Free Per Wallet');
}
