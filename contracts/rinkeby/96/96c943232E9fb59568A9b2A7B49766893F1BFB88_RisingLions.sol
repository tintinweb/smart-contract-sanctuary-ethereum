...
// File: RisingLions.sol

contract RisingLions is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxPublicSaleWalletLimit = 10;
  ...
  constructor() ERC721A("Rising Lions", "RISL") {}
