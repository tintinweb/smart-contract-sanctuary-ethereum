...
contract GiftTest is ERC721, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    string private hiddenMetadataUri;   // https://gateway.pinata.cloud/ipfs/QmSSZrpJ9zXkWDmR6z6vBWzESG86WjdPos3nw3oFjZEYrn/hidden.json     BEFORE-DEPLOY
    string private baseMetadataUri;     // https://gateway.pinata.cloud/ipfs/QmdQ7roWep6Ceynpbsvs1rj1T9NsWBE8ZGC1wZQbRWJjra                 BEFORE-DEPLOY
