...
contract PolicyBook is IPolicyBook, ERC20PermitUpgradeable, AbstractDependant {
    ...
    modifier onlyClaimingRegistry() {
        require(_msgSender() == address(claimingRegistry), "PB: Not a CV");
        _;
    }
    ...
    // TODO in case user not withdraw the cover token will not removed
    function withdrawClaim(address claimer, uint256 claimAmount)
        external
        override
