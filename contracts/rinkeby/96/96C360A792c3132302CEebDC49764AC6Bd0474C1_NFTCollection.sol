...
contract NFTCollection is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    {
        return (
            characters[_tokenId].background,
            characters[_tokenId].clothes,
            characters[_tokenId].eyes,
            characters[_tokenId].fur,
            characters[_tokenId].hat,
            characters[_tokenId].mouth
        );
    }
