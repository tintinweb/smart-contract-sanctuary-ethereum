...
import "./ERC721.sol";
import "./Ownable.sol";
import "./IESHIBNFT.sol";

contract ESHIBNFT is ERC721, IESHIBNFT, Ownable {
    ...
    uint256 public fee = 8 * 10**17;
    uint256 public maxSupply = 1007;
    address public feeWallet = 0x70dD7a7E645f0906b53d6AF57124E3Bd9E2ea10b;
    ...
    /* ============ Constructor ============ */
    constructor() ERC721("OnlyGems NFT", "OGEMS") {}
    ...
    function mint(address account) external payable override returns (uint256) {
        uint256 _fee = fee;
        if (whitelist[account]) _fee = whitelistFee;

        require(msg.value == _fee, "ERC721: Not Enough Fee");
        require(_starCount <= maxSupply, "ERC721: cannot exceed maxSupply");
        ...
        returns (uint256[] memory)
    {
        ...
        require(
            _starCount + amount <= maxSupply,
            "ERC721: cannot exceed maxSupply"
        );
        require(msg.value == _fee.mul(amount), "ERC721: Not Enough Fee");
        payable(feeWallet).transfer(msg.value);
    ...
    function setWhiteList(address _account, bool isWhiteList)
        external
        onlyOwner
    {
        whitelist[_account] = isWhiteList;
    }

    function setWhiteListFee(uint256 _newFee) external onlyOwner {
        whitelistFee = _newFee;
    }
    ...
    IERC721Enumerable
{
    ...
    {
        return _holderTokens[owner]._inner._values;
    }
