...
contract TestNFTTwo is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    modifier maxPerWallet(uint256 _mintAmount) {
      require(
          balanceOf(msg.sender) + _mintAmount <= maxMintAmount,
          "Max NFT's to mint is five"
      );
      _;
    }
