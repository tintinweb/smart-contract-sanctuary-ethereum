...
contract Edgehogs is Ownable, ERC721A {
  ...
  uint256 public constant PURCHASE_LIMIT = 10; //change to 10 on final deployment
 ...
 // withdraw addresses
  ...
  address t2 = 0xCE3e42407a54121f4796d75bc92542206d1B724E; //update on deployment 
  address t3 = 0xCE3e42407a54121f4796d75bc92542206d1B724E; //update on deployment
  ...
  function presaleMint(bytes32[] calldata proof_) external {
    ...
    require(supply + 1 <= MAX, "Claim would exceed maximum supply");
  ...
  //puts a legendary edgehogs in place of a common
  ...
  function isLegendary(uint256 _tokenId) public view returns (bool) {
    ...
    //change that the  legendaries were unique, not randomly chosen
  ...
  */
  ...
  function withdrawAll() public payable onlyOwner {
    uint256 _share = address(this).balance / 100;
      require(payable(t1).send(_share * 80));
      require(payable(t2).send(_share * 10));
      require(payable(t3).send(_share * 10));
    }
