...
import "./lib/fee/FeeSettingsFromContract.sol";

contract GigaSwap is Swapper, Ownable, FeeSettingsFromContract {
    constructor(address feeSettingsAddress)
        FeeSettingsFromContract(feeSettingsAddress)
    {}
}
...
abstract contract Swapper is ISwapper, IOwnable {
...
contract FeeSettingsFromContract is IFeeSettings {
    ...
    function feePercentil() external returns (uint256) 
    {
