...
contract NFTMarketplace is Pausable, FeeManager, ERC721Holder {
    ...
    function cancelOrder(address _tokenAddress, uint256 _tokenId) public whenNotPaused {
        ...
        require(bid.bidId == 0, "Can't cancel, This order has active bids");
    ...
    function updateOrder(address _tokenAddress, uint256 _tokenId, uint256 _askingPrice) public whenNotPaused {
        ...
        require(bid.bidId == 0, "Can't update order having active bids");
        ...
        emit OrderUpdated(order.orderId, _askingPrice);
    }
    ...
    function safePlaceBid(address _tokenAddress, uint256 _tokenId) payable public whenNotPaused {
       ...
       // address owner = IERC721(_tokenAddress).ownerOf(_tokenId);
        require( order.seller != msg.sender, "The owner of NFT cannot place bid itself");
    ...
    function acceptBidandExecuteOrder(address _tokenAddress, uint256 _tokenId, uint256 _bidPrice) public whenNotPaused {
        ...
        // uint256 finalAmount = bid.bidPrice
    ...
    function _createBid(address _tokenAddress, uint256 _tokenId,  uint256 value)  internal   {
        ...
        if(bid.bidId != 0) { 
                ...
                require(value >= validBid, "Marketplace: bid price should be higher than last bid");
