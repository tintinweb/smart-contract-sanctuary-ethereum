...
contract Starborn is ERC721, ERC721Enumerable, ERC2981, Ownable {
	...
	function allowlistMint(uint256 amountToMint, bytes32[] calldata merkleProof) external payable onlyEoa {
		...
		require(amountToMint > 0 && amountToMint <= MAX_PER_AL_WALLET, "Invalid amount to mint");
	...
	/// @notice Sets base extension path. Cannot be set if metadata is frozen.
	function setBaseExtension(string memory _baseExtension) external onlyOwner onlyThawed {
	...
	function toggleAllowlistMint() external onlyOwner {
		require(merkleRoot != "", "The merkle root needs to be set first");
	...
	/// @notice Sets the allowlist merkle root.
