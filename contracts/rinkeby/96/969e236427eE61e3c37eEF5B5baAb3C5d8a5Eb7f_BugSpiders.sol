// SPDX-License-Identifier: MIT
    ...
    contract BugSpiders is ERC721, Ownable, ERC721Enumerable {
      ...
      event BugMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("BugSpiders", "BSP") {}
      ...
      function mintBug(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit BugMinted(id, msg.sender);
          }
        }
      }
    
      function presaleBug(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs//QmRN2BK19pTxM6b7itm39KHq9EaTGGoFcQt1vuiJcdwUNg/hidden.json";
        }
