    ...
    UUPSUpgradeable
{
    ...
    uint256 public swapableMarketingFeeAmount;

    uint256 public cappedSwapableLiquidityAmount;
    uint256 public cappedSwapableMarketingAmount;
    bool private inSwap;
    ...
    function initialize() public initializer {
        ...
        cappedSwapableMarketingAmount = 1 * 10**18;
    ...
    function _transfer(
        ...
        if (!swapLiquidity) {
            ...
            inSwap = true;
            if (
               swapableMarketingFeeAmount > cappedSwapableMarketingAmount
            ) {
                if (enableFee) {
                    enableFee = false;
                ...
                swapTokensForEthToWallet(swapableMarketingFeeAmount, address(this));
            ...
            if (
                ...
                swapAndLiquify(swapableLiquidityFeeAmount);
                if (taxDisableInLiquidity) {
                    enableFee = true;
                    taxDisableInLiquidity = false;
                }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
      ...
      function swapTokensForEthToWallet(uint256 tokenAmount, address account) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
    ...
    function _calculateAndDistributeTotalFeeAmount(
        ...
        swapableMarketingFeeAmount += currentMarketingFee;
