...
contract ArtistV5 is ERC721Upgradeable, IERC2981Upgradeable, OwnableUpgradeable {
    ...
    function buyEdition(
        ...
        if (startTime > block.timestamp) {
            ...
            // The reason we check for randomNumRequestId is to allow a final purchase to trigger the
            // random number request.
            require(editions[_editionId].randomNumRequestId != 0, 'This edition is already sold out.');
        }
