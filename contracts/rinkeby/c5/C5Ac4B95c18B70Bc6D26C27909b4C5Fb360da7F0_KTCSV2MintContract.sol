...
contract KTCSV2MintContract is ERC721A, Ownable {
    ...
    uint256 public pricePresale = 0.035 ether; //set NFT price
    uint256 public pricePublic = 0.065 ether; //set NFT price
    ...
    uint256 public maxPublicSaleMint = 5; //set how many NFTs can be minted per wallet in public sale
