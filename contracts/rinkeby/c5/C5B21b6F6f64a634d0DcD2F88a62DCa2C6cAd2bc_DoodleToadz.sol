...
// SPDX-License-Identifier: MIT
// Extension of OpenZeppelin Contracts v4.4.1 (token/ERC721/ERC721.sol)
 ...
 * {ERC721Enumerable}.
 */
contract ERC721Ext is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function numMinted(address owner) public view returns (uint256) {
        return uint256(_addressData[owner].numMinted);
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Ext.ownerOf(tokenId);
...
//        _balances[owner] -= 1;
    ...
    function _transfer(
        ...
        require(ERC721Ext.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
...
//        _balances[to] += 1;
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Ext.ownerOf(tokenId), to, tokenId);
    }
