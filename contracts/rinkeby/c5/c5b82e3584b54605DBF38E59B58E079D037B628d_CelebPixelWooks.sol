...
contract CelebPixelWooks is ERC721, Pausable, Ownable {
  ...
  uint256 public constant tierOnePrice = 0.01 ether; // 1
  uint256 public constant tierTwoPrice = 0.015 ether; // 2
  uint256 public constant tierThreePrice = 0.02 ether; // 3
  ...
  function mintCelebWook(uint256 celebIndex) public payable whenNotPaused {
    ...
    if (tierIndexes[celebIndex] == 3 && msg.value < tierThreePrice) {
      revert('NotEnoughETH');
    }
