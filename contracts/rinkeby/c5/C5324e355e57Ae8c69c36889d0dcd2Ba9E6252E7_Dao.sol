...
contract Dao {
    ...
    function createProposal(string memory _description, uint256 _deadline, uint256 _quorum, address[] memory _canVote) public {
    ...
    function countVotes(uint256 _id) public {
        ...
        if(Proposals[_id].quorum < (Proposals[_id].votesUp/Proposals[_id].maxVotes) ){
            p.passed = true;
        }
