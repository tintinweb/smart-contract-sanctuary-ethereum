...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                ...
                '", "description":"Platzi Punks are ramdomized avatars stored on chain to teach Dapp development on Platzi", "image": "',
                image,
                '"}'
            )
        );
    ...
    // Funciones a├▒adidas para soportar ERC721Enumerable
