...
contract LLGoat is ERC721A, Pausable, Ownable, ReentrancyGuard {
    ...
    function mint(bytes32[] memory _proof, uint256 _qty, uint256 _type) external nonReentrant whenNotPaused {
