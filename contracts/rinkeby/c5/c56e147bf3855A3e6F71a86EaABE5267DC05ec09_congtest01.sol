...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
 ...
 contract congtest01 is Ownable, ERC721A, ReentrancyGuard {
    struct Config {
        uint256 maxSupply;
        uint256 reserved;
    ...
    Config public config= Config(2000, 0, 500, 0.005 ether, 10, "");
    bool public isMintStarted= false;
    uint256 public maxFreeMintAmountPerTx=3;
    uint256 public maxMintAmountPerTx=10;
    constructor() ERC721A("congtest01", "ct01") 
    {
