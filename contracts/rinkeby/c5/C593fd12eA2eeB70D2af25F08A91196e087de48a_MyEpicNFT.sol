...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string svgPartTwo = "; }    .stop2 { stop-color: white; stop-opacity: 0; }    .stop3 { stop-color: purple; }      </style>  <rect width='100%' height='100%' fill='url(#Gradient1)' />  <text    x='50%'    y='50%'    class='base'    dominant-baseline='middle'    text-anchor='middle'  >";
  ...
  string[] firstWords = ["11001011", "00111101", "10100010", "01010001", "01101110", "10010001" "11110000" "00001111" "11101001" "00010110" "00100101" "11011010" "10110011" "01001100" "00111111"];
  string[] secondWords = ["00100111", "01001000", "00101001", "01110110", "01101101", "10011111" "11100110" "11110001" "01011110" "11010001" "10101101" "11111011" "11111111" "00001000" "10110111"];
  string[] thirdWords = ["00000000", "10101010", "01010101", "10000001", "01000010", "01111110" "10011001" "01100110" "00100100" "10110101" "00010000" "01000000" "01000001" "10100111" "00000100"];
    // Nós precisamos passar o nome do nosso token NFT e o símbolo dele.

  string[] colors = ["red", "orange", "black", "yellow", "blue", "green"];

   event NewEpicNFTMinted(address sender, uint256 tokenId);

   constructor() ERC721 ("RandomByteNFT", "rBYTE"){
      console.log("This is a random byte NFT smartcontract on Solidity!");
    }
  ...
  function random(string memory input) internal pure returns (uint256) {
    ...
    string memory finalTokenUri = string(
        ...
        _tokenIds.increment();
        console.log("The NFT ID %s was minted by  %s", newItemId, msg.sender);
