...
contract UArdiansTest2 is ERC721, Ownable {
  ...
  uint256 public supplyStage1 = 2;
  uint256 public supplyStage2 = 2;
  uint256 public supplyStage3 = 2;
  uint256 public supplyStage4 = 2;
  uint256 public supplyStage5 = 900;

  uint256 public maxMintAmountProject = 3;
  uint256 public releasePhase = 1;

  mapping(address => uint256) public mintBalances;

  constructor() ERC721("UArdiansTest2", "UA") {}
