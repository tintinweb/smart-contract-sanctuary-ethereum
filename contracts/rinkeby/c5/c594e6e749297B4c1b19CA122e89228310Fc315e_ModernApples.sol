...
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
    ...
    contract ModernApples is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 1100000000000000; // 0.0011 ETH 
      ...
      event ModernApplesMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("ModernApplesNew", "MA") {}
      ...
      function mintModernApple(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit ModernApplesMinted(id, msg.sender);
          }
        }
      }
    
      function presaleModernApples(uint256 numberOfTokens) external payable {
