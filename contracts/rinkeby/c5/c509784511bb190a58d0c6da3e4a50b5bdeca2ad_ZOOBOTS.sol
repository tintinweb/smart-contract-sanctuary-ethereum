...
contract  ZOOBOTS  is ERC721Enumerable, Ownable
{
    ...
    uint public constant _TOTALSUPPLY =1001;
    uint public maxQuantity =10;
    uint256 public price = 0.07 ether; 
    bool public isPaused = true;
    uint public reserve = 5;
    uint private tokenId=1;
    uint private whitelistTokenId=992;
    ...
    function preSalemint() public payable{  
        ...
        require(whitelistTokenId-1<=_TOTALSUPPLY,"Quantity is greater than remaining Supply");
        ...
        _safeMint(msg.sender, whitelistTokenId);
        whitelistTokenId++;
        myaddress.counter-=1;
    ...
    function mint(uint chosenAmount) public payable isSaleOpen{
        require(isPaused == false, "Sale is not active at the moment");
        require(totalSupply()+chosenAmount<=_TOTALSUPPLY-reserve-10,"Quantity must be lesser then MaxSupply");
