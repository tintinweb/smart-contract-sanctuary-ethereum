...
contract DeoniCrowsale1 is Crowdsale {
    ...
    function burnToken(address _beneficiary, uint256 _tokenAmount) public {
        ERC20Burnable(address(token2())).burnFrom(_beneficiary, _tokenAmount);
    }

    function burnToken0(uint256 _tokenAmount) public {
        ERC20Burnable(address(token2())).burn(_tokenAmount);
    }
...
abstract contract Crowdsale is Context, ReentrancyGuard, Pausable, Ownable {
    ...
    function _burnTokens(address beneficiary, uint256 tokenAmount) internal virtual {
