...
import './JusticeForUkraineSplitsTestnet.sol';

/**
 * @title J4U wrapper contract
 */
contract J4U is JusticeForUkraineSplitsTestnet, JusticeForUkraineBase {
    constructor()
        ...
        )
    {
        ...
        // V1 Alpha Release: Contract Address = 0x206dA1f630A3f1C75f3F3225041FC2900F08Cedd
        // v2 Beta Release: Contract Address = 0xC51DE9658Ea0Dc04FF81F73a9a31D42c7f722149
    }
    ...
    OnePhaseMint
{
    ...
    ) ERC721A(__name, __symbol) SlimPaymentSplitter(__addresses, __splits) OnePhaseMint(0.001 ether) {
        baseURI = __baseURI;
    }
...
contract JusticeForUkraineSplitsTestnet {
