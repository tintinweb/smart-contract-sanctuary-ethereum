...
contract PLSDSock is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public _name = "PLSDSock Genesis";
  ...
  string public hiddenMetadataUri = "ipfs://bafyreiazbic3p4vuox7bhl6joq2wq5jwt4pbjs7fpvxvtjbthsxrg3pbge/metadata.json";
  ...
  ******
  */
  function amountBurned(address _address) public view virtual returns (uint256) {
    return burnedAmount[_address];
  }

  function burn(uint256 tokenId) public virtual {
    burnedAmount[_msgSender()] += 1;
    _burn(tokenId, true);
  }

  /*
  ******
  ** Allow withdraw of ETH collected via mint fees && royalties
  ******
  */
