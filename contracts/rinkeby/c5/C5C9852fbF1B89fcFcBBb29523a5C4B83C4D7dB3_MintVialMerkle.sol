...
contract MintVialMerkle is ERC1155, ERC1155Burnable, IERC2981, Ownable, ReentrancyGuard {
    ...
    Stage public currentStageId = Stage.Pre;
    uint256 public tokenId = 0;
    uint256 public amountMinted = 0;
    bool public migrationStarted = true;
    uint256 public maxAmountPerTransactionPublic = 10;

    address private creator;
    address private collectionContractAddress;
    address private royaltiesAddress = 0xb7D4D21d210513E4Ba95BCcaa7fD3a319072e472;
    ...
    constructor(address payable owner) ERC1155("ipfs://QmYoeae1rQgtR25aKEuNBzbmqzpNh4TryrbdmviGHABuo5") {
        require(owner != address(0), 'Zero address not allowed');

        listsData[1] = listParameters(0x0357a7cc631a700827724ce79355ecca939d0951d58ab2886ad560bc2e49b785, 0.0005 ether, 3333);
        listsData[2] = listParameters(0x0, 0.0005 ether, 800);
        listsData[3] = listParameters(0x0, 0 ether, 3333);
        listsData[4] = listParameters(0x0, 0.0015 ether, 0);
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmcKkzfjoxjaDgF6qprSrQq9BfrMNkJ1VhxcDA8868quKT";
    }
