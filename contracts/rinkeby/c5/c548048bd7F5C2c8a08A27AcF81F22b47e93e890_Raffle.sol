...
error Raffle__UpkeepIsNotRequired(
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
        ...
        )
    {
        ...
        upkeepNeeded = timePassed && isOpen && hasPlayers && isFunded;
    }

    function resetState(RaffleState state) public {
        s_raffleState = state;
    }
    ...
    function performUpkeep(
        ...
        (bool upkeepIsRequired, ) = checkUpkeep('');
        if (!upkeepIsRequired) {
            revert Raffle__UpkeepIsNotRequired(
    ...
    function fulfillRandomWords(
        ...
        (bool transferIsSuccess, ) = payable(winner).call{
    ...
    function getCallbackGsLimit() public view returns (uint32) {
