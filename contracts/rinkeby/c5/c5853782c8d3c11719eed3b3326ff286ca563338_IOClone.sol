...
contract IOClone is ERC721, Ownable, ReentrancyGuard {
    ...
    address public constant MAIN_WALLET =
        0xb05b21eA79B9A92a1EbA5452370143e348417f8B;
    ...
    uint256 public constant COMMUNITY_SUPPLY = 5;
    uint256 public constant FOUNDERS_SUPPLY = 5;
    ...
    // Pre-Sale
    uint256 public floorPrice = 0.02 ether;
    ...
    uint256 public constant PUBLIC_SALE_MINT_LIMIT = 2;

    // Public Sale DA price variables
    uint256 public publicSaleStartTime;
    uint256 public publicSaleStartPrice = .015 ether;
    uint256 public constant PUBLIC_SALE_DROP_INTERVAL = 300;
    uint256 public constant PUBLIC_SALE_DROP_AMOUNT = 0.01 ether;
