...
contract MergeMana is Ownable {
  ...
  function getTotalManaWithNoPenalties(uint256 id) public view returns (uint256) {
    return getInherentManaWithNoPenalties(id) + boostedMana[id] + channeledMana[id];
  }
  ...
  function getInherentManaWithNoPenalties(uint256 id) public view returns (uint256) {
  ...
  function getInherentMana(uint256 id) public view returns (uint256) {
    ...
    uint totalPenalties = getTotalManaPenalties(id);
    uint inherentManaWithNoPenalties = getInherentManaWithNoPenalties(id);
