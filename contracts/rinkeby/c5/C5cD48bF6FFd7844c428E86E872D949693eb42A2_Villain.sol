...
interface IWASNFT {
    ...
    function tokenOfOwnerByIndex(uint256 tokenId) external returns (uint256);
}
...
contract Villain is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor(uint256 initSupply, address wasScAddress) ERC721("WAS Villain", "WASV") {
    ...
    function didSatoshiClaim(uint256 satoshiId)
    public
    view
    returns(bool){
    ...
    public
    {
        ...
        for (uint256 i = 0; i<ownerBalance; i++) {
            satoshiId = IWASNFT(_wasNFTSmartContract).tokenOfOwnerByIndex(i);
