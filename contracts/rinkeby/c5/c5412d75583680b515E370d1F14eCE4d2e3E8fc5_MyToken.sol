...
import { ERC721, ERC721Royalty } from "ERC721Royalty.sol";
import "Pausable.sol";
import "Ownable.sol";
import "Counters.sol";
//import { Withdrawable } from "Withdrawable.sol";

contract MyToken is ERC721Royalty, Pausable, Ownable {
//    bytes32 public constant SUPPORT_ROLE = keccak256('SUPPORT');
    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public constant brrrrrrrrrrrrrrrrrrrrrrrrrrrrrr = 1000;
    ...
    constructor() ERC721("MFG MEKA DOG & YALL", "MFGMEK") {
        _setDefaultRoyalty(address(0x559b8E68b8cA0C370924D36400D7251BcD3b0DEf), 2000);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmRDWZrGtJqeX29JbZUFtvZ2Wey4p8HNa2uMqdmfb6oHwd";
    }
