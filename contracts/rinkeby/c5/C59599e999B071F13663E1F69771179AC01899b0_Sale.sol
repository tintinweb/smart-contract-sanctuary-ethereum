...
contract Sale is Ownable {
    ...
    function setSaleTime(uint256 newStartTime, uint256 newEndTime)
        public
        onlyOwner
    {
    ...
    function changeBuyToken(address newERC20Token) public onlyOwner {
    ...
    function buyAsset(uint256 amount, uint256 collectionId) public {
        require(
            minted[msg.sender] + amount <= MAX_PURCHASE,
            "You Already Crossed Limit"
        );
