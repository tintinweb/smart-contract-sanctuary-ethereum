...
contract Governor is IGovernor, UUPS, Ownable, EIP712, GovernorStorageV1 {
    ...
    function propose(
        ...
        unchecked {
            // Increment the number of total proposals
        ...
        proposal.creation = uint32(block.timestamp);
    ...
    function castVoteBySig(
        ...
        // Used to store the computed message
        bytes32 digest;
    ...
    function _castVote(
        ...
        unchecked {
            ...
            weight = getVotes(_voter, proposal.creation);
