...
contract PlaKUD is ERC721, Ownable, ReentrancyGuard {
  ...
  uint256 public cost = 0.0002 ether;   // Need update to 0.02
  uint256 public costLegend = 0.001 ether;  // Need update to 1
  uint256 public maxMintAmountPerTx = 5;
  uint256 public maxNFTPerAccount = 5;
  uint256 public maxFreeMint = 5200;
  uint256 public whitelistEndDate = 1656060334;
  ...
  constructor() ERC721("Pla KUD", "ADU") {
