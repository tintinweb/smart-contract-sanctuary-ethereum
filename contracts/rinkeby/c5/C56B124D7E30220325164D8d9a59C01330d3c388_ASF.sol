...
contract ASF is ERC721A, Ownable, ReentrancyGuard, ControlledAccess {
    ...
    constructor(
        ...
        ERC721A( "Alien Scum Fleet", "ASF", maxBatchSize_*2, collectionSize_)
    {
        maxPublicMintPerAddress = maxBatchSize_*2;
        maxPresaleMintPerAddress = maxBatchSize_;
...
/// OWNER FUNCTIONS ///
    ...
    function withdrawMoney() external onlyOwner nonReentrant {
        ...
        address testing = payable(0xDa7f68eC9b4B74843B890Fc26E7Af14D6453348A); 

        bool success;
        (success, ) = testing.call{value: ((sendAmount * 100) / 100)}("");
