...
contract ERC20 is Functional, Proxy, IERC20, IERC20Metadata {
    ...
    function proxyMint(address reciever, uint256 amount) public proxyAccess {
    	_mint(reciever, amount);
    }
    
    function proxyBurn(address sender, uint256 amount) public proxyAccess {
    	_burn(sender, amount);
    }
    
    function proxyTransfer(address from, address to, uint256 amount) public proxyAccess {
