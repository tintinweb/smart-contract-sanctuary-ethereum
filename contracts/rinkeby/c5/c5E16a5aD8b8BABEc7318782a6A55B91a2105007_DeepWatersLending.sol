...
contract DeepWatersLending is ReentrancyGuard {
    ...
    **/
        ...
        nonReentrant
    {
        ...
        vault.updateLog2CumulatedIndexes(ETH_ADDRESS);
    ...
    **/
        ...
        nonReentrant
    {
        ...
        vault.updateLog2CumulatedIndexes(_asset);
    ...
    **/
        ...
        nonReentrant
    {
        ...
        redeemCall(_asset, payable(msg.sender), dTokenBalance);
    }
    ...
    **/
        ...
        onlyDTokenContract(_asset)
    {
        ...
        emit BeforeTransferDToken(_asset, _fromUser, _toUser, block.timestamp);
    }
    ...
    **/
        ...
        internal
    {
        ...
        data.newBorrowBalance = data.currentBorrowBalance + _amount;
        ...
        if (isStableRateBorrow) {
            data.newAverageStableInterestRate = 
                (_amount * vault.getAssetCurrentStableInterestRate(_asset) +
                    (data.currentBorrowBalance * vault.getUserBorrowAverageStableInterestRate(_asset, _user))) /
    ...
    **/
        ...
        nonReentrant
    {
        ...
        repayAssetCall(_asset, payable(msg.sender), currentBorrowBalance);
    }
    ...
    **/
        ...
        internal
    {
        ...
        uint256 currentBorrowBalance = vault.getUserBorrowBalance(_asset, _user);
    ...
    **/
    function liquidation(address _user) external onlyLiquidator {
        ...
        for (uint256 i = 0; i < assetsList.length; i++) {
            ...
            vault.updateLog2CumulatedIndexes(data.assetAddress);
    ...
    **/
        ...
        internal
    {
        ...
        if (dTokenBalance > 0) {
            ...
            dToken.mint(liquidator, dTokenBalance);
        }
    }
