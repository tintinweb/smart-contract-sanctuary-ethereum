...
contract BladeRunnerPunkBacks is UnburnableERC721v2, AccessControlEnumerable {
    ...
    ) UnburnableERC721v2(name, symbol) {
        collectionSize = max;
    ...
    function supportsInterface(bytes4 interfaceId) public view override(AccessControlEnumerable, UnburnableERC721v2) returns (bool){
        return AccessControlEnumerable.supportsInterface(interfaceId) || UnburnableERC721v2.supportsInterface(interfaceId);
    }
 ...
 * - Tokens can only be minted linearly 1, 2...
 * - Tokens cannot be burned.
 */
contract UnburnableERC721v2 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    uint256 private _nextIdToMint = 1;
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return tokenId > 0 && tokenId < _nextIdToMint;
    }
    ...
    function _safeMintMany(
        ...
        uint256 firstTokenToMint = _nextIdToMint;
