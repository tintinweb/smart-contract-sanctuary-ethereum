...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 11111 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmd25MemmP2YhwXvvQe1M964MQMEWJs2BZMn5HDTDBV2AW/";
...
// File: contracts/X3DissContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3DissContract is RamppERC721A {
    constructor() RamppERC721A("3Diss", "3Diss"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/BVf4lW15nR0JGjH3UuOQ/contract-metadata";
    }
}
