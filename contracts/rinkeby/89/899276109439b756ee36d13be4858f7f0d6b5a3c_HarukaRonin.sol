...
contract HarukaRonin is Ownable, ERC721A {
    ...
    address constant public doylerAddress = 0xcccb3F573FFF6A755d9fc52D9c4bd82Be21E0A64;
    ...
    // Updated: This was the primary cause of most of the gas issues.
    ...
    */
    ...
    // Note: Generally speaking you COULD save some gas making functions 'external' instead of 'public'
        // That said, you can no longer call them from other functions OR internally.
    ...
    function publicWhitelistMint(uint256 quantity, bytes32[] memory proof) external payable mintCompliance(quantity) {
        ...
        require(msg.value >= (mintRatePublicWhitelist * quantity), "Not enough ETH sent");
        ...
        doylerPayable += ((mintRatePublicWhitelist * quantity) * 30) / 100;
        refundOverpay(mintRatePublicWhitelist * quantity);
    }
    ...
    function publicMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(msg.value >= (mintRatePublicSale * quantity), "Not enough ETH sent");
        ...
        // Note: Having both of these in the mint methods is not the most efficient
            // That said, it worked for the time constraints
        doylerPayable += ((mintRatePublicSale * quantity) * 30) / 100;
        refundOverpay(mintRatePublicSale * quantity);
    }
    ...
    */
    ...
    function withdraw() external payable onlyOwner {
        (bool succ1, ) = payable(doylerAddress).call{
            value: doylerPayable
        }("");
        require(succ1, "Doyler transfer failed");
        ...
        (bool succ2, ) = payable(owner()).call{
            value: address(this).balance
        }("");
        require(succ2, "Team transfer failed");
    }
    ...
    */
    ...
    modifier onlyPublicWL(bytes32[] memory _proof) {
        require(_verifyPublicWL(_proof), "Not on WL");
        _;
    }
}