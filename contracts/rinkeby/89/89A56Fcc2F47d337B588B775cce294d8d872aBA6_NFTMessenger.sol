...
contract PowerNFT is ERC721URIStorage {
    ...
    function addNFTType(uint256 _price, uint256 _power, string memory _tokenURI, bool _isActive) public onlyOwner {
        NFTInfo memory nftInfo = NFTInfo({
            tid: _tokenIds.current(),
            price: _price,
            power: _power,
    ...
    function updateNFTType(uint256 _typeId, uint256 _price, uint256 _power, string memory _tokenURI, bool _isActive) public onlyOwner {
        NFTInfo memory nftInfo = NFTInfo({
            tid: _typeId,
            price: _price,
            power: _power,
