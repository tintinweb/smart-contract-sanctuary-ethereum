...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    ...
    function mint() public {
        PlatziPunksToken token = PlatziPunksToken(
            0x6fa2eD540a06C85f0cbD72aC6bFd7B2D8535b4a4
        );

        require(
            token.balanceOf(msg.sender) >= (1 * 10**token.decimals()),
        ...
        token.transferFrom(
            msg.sender,
            0x693CE2B74A7446fa1BcB33255D636Fb39545cc62,
            (1 * 10**token.decimals())
        );
