...
import {MathUtils} from "../dependencies/math/MathUtils.sol";
...
contract OmniOracle is IOmniOracle {
    ...
    IUniV3NFTOracle public uniV3Oracle;
    /**
    ...
    function setUniV3Oracle(address oracle) external {
        uniV3Oracle = IUniV3NFTOracle(oracle);
    }
    ...
    function calcUniswapV3Price(uint256 tokenId) view public returns (uint256) {
        return uniV3Oracle.getPrice(tokenId);
    }
