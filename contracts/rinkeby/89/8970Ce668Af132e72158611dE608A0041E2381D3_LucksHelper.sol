...
contract LucksHelper is ILucksHelper, Ownable {
    ...
    IPunks public PUNKS;
    IWrappedPunks public WRAPPED_PUNKS; 
    ...
    */
    ...
    function isPunks(address nftContract) public override view returns(bool) {
        if (address(PUNKS) == nftContract && address(WRAPPED_PUNKS) != address(0)) {
            return true;
        }
        return false;
    }
    ...
    */
    ...
    function getWrappedPunks() external view override returns (IWrappedPunks) {
        return WRAPPED_PUNKS;
    }
    ...
    */
    ...
    function setPunks(IPunks punks, IWrappedPunks wrappedPunks) external onlyOperator {
        PUNKS = punks;
