...
contract TheNekoNFT is ERC721A , Ownable { 
    ...
    address payable private _PaymentAddress = payable(0x459657531AACf0F5987Cf21837eef4db56e91a22);

    uint256 public NEKO_MAX = 925;
    uint256 private NEKO_ADMIN = 2;
    uint256 private NEKO_PUBLIC = NEKO_MAX - NEKO_ADMIN;
    
    uint256 private PRESALE_PRICE = 0.33 ether;
    uint256 private PUBLIC_PRICE = 0.33 ether;
    ...
    uint256 private _activeDateTime = 1653444038; // (GMT): Wednesday, May 25, 2022 2:00:38 AM
