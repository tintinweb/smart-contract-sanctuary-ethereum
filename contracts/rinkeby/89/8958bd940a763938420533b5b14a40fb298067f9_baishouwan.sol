...
contract baishouwan is ERC721A, Ownable {
    using Strings for uint256;
    ...
    function setMintPrice2(uint256 _price2) public onlyOwner {
        price2 = _price2;
    } 
    ...
    function publicMint() public payable {
        ...
        require(payable(msg.sender).send(price2));
        }
    }//mint
