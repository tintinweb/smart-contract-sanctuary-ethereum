...
import "./interfaces/token/IERC1155.sol";

contract AggregatorSwap is SpecialTransferHelper, Ownable, ReentrancyGuard {
    ...
    address public gov = 0x40FAE2e8DbE5c2a0Ac9A4FC4182F75cAb6032eaf;
