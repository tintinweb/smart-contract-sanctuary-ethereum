...
contract nonaclub is ERC721, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;

    uint256 public constant MAX_SUPPLY = 380;
    uint256 public reserved = 0;
    uint256 public presaleSupply = 380;
    uint256 public presalePrice = 0.123 ether;
    // uint256 public tier3Price = 0.125  ether;
    // uint256 public tier2Price = 0.124  ether;
    // uint256 public tier1Price = 0.123  ether;
    uint256 public totalSupply;
    uint256 public MINT_CAP = 3;
    // address public dev = 0xA1C524F667Db0879Eec3dF53beB0cD6903232dF5; //address to withdraw to
    address public dev1 = 0xaC246C24657F1879b317a4CDfe820D079aAa9817; //25%
    address public dev2 = 0x81Bf501Df4118d1F9519fba17C987D784F92f37c; //25%
    address public dev3 = 0xD2Fe25d4B025ce007BC408CDc26A0E5CCaB27428; //50%
    address public roy = 0xc7a92645dC1CCD5e80b1f19cA83A955722eae143; //
    ...
    constructor(string memory _baseuri) ERC721("Nona klub", "NK") {
        // Base IPFS URI of the nft
        baseUri = _baseuri;   
        totalSupply = 0;     
    }

    function _mintNona(uint256 num) internal returns (bool) {
    ...
    function presaleNona(uint256 num) public payable returns (bool) {
        ...
        return _mintNona(num);
    }

    // function publicsaleNona(uint256 num) public payable returns (bool) {
    //     uint256 currentSupply = totalSupply;
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 dev1Share = balance.mul(25).div(100);  
        uint256 dev2Share = balance.mul(25).div(100);  
        uint256 dev3Share = balance.mul(50).div(100);  
        uint256 ownerShare = balance.sub(dev1Share+dev2Share+dev3Share); 
        payable(msg.sender).transfer(ownerShare);
        payable(dev1).transfer(dev1Share);
        payable(dev2).transfer(dev2Share);
        payable(dev3).transfer(dev3Share);
    }
