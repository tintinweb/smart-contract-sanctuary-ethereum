...
contract Silly721 is ERC721A, Ownable, ReentrancyGuard
{
    using Strings for string; 

    uint public constant MAX_TOKENS = 5555;
    uint public PRESALE_LIMIT = 2555;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 100;
    uint256 public PRICE = 0.05 ether; //50000000000000000 
    uint public perAddressLimit = 3; //Max per wallet address limit for presale
    ...
    constructor() ERC721A("Sillies NFT", "SNFT") {}
