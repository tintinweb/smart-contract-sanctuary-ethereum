...
contract KidRock is Ownable, ERC721A("Kid Rock", "K Rock") {
    bytes32 public merkleRoot;
    
    uint256 public constant SUPPLY = 20;
    uint256 public constant DEV_SUPPLY = 10;
    uint256 public WHITELIST_SUPPLY = 18;
    uint256 public AUCTION_SUPPLY = 15;
    uint256 public price = 0.3 ether;
    uint256 public maxMintedPerAddress = 5;
    ...
    uint256 public startTime = 1652929200;
    ...
    function auctionMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        if (numberMinted(msg.sender) + quantity > maxMintedPerAddress) 
