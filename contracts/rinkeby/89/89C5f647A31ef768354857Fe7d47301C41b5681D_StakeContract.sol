...
contract StakeContract is ReentrancyGuard {
    ...
    // LEGENDARY_ADDRESS = '0xcd26822004fa36490954e57dba21b63d52255ba3';
    address private LEGENDARY_WALLET = address(this);
    ...
    function _stake( address _owner, address _contract, uint256 _tokenId ) public {
        ...
        IERC721(_contract).transferFrom( _owner, LEGENDARY_WALLET, _tokenId );
    ...
    function _unstake( address _owner, address _contract, uint256 _tokenId ) public {
        ...
        IERC721(_contract).transferFrom( LEGENDARY_WALLET, _owner, _tokenId );
