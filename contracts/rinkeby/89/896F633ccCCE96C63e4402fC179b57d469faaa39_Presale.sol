...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    constructor (uint256 weirate,uint256 busdrate, address payable wallet, IERC20 _reflecto, IERC20 token, IERC20 BUSD, uint256 tokenDecimals, uint256 busdDecimal)  {
    ...
    //Start Pre-Sale
    function startICO(uint enddate , uint256 _hardCap, uint256 _privateICODuration) external onlyOwner icoNotActive() {
    ...
    function buyTokens(address beneficiary) public nonReentrant icoActive payable {
        ...
        uint reflectoUserPercentage= (userBalance/totalSupply) * 100;
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        require(weiAmount > 100000000000000000);    // 1e17
