...
contract Metaversity is ERC721A, Ownable {
    ...
    function getPresaleNumMinted() external view returns (uint) {
        return presaleNumMinted[msg.sender]; 
    }
    ...
    function earlyMint(uint256 numberOfTokens, bytes32[] calldata merkleProof) public payable {
