 ...
 */
contract SGArmorNFT is Context, ERC721Enumerable, Ownable {
  ...
  function burnNFT(address owner, uint256 tokenId_) external {
    require(owner != address(0), 'invalid owner');
    require(ownerOf(tokenId_) == owner, "Not a belonger of NFT");
    _burn(tokenId_);
  }

  function safeMintBatch(address to_, uint256 count_) external {
    require(minters[_msgSender()] == true, 'permission denied');
    require(to_ != address(0), 'invalid receiver');
