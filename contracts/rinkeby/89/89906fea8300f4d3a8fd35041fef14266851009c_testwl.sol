...
contract testwl is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("wlpre", "wlpr") {
    setHiddenMetadataUri("ipfs://QmU1oEUuhBHPN57k2yg3AGtRRbY1SDTKptKPaS6HNewPVp/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x2b25934386c6bc7C84ca93eDDc6b64420F606483).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
