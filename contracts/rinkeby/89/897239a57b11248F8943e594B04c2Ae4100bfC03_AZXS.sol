...
// File: contracts/new.sol
    ...
    contract AZXS is ERC721, Ownable, ERC721Enumerable {
      ...
      mapping(address => uint256) public _presaleListClaimed;
     ...
     function addToPresaleList(address[] calldata addresses) external onlyOwner { //
      ...
      function mintHG(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs/QmcoPKdZqDi1PFUQauk1cwjvQMdhGnhMwifDofWDJpQG8m/hidden.json";
        }
