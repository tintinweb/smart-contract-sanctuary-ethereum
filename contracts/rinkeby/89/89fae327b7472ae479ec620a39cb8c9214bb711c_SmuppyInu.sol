...
contract SmuppyInu is ERC20, AccessControl {
    ...
    constructor() ERC20("Smuppy Inu", "SMUPPY") {
        ...
        _createPair(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // router address
    }
    ...
    function _transfer(
        ...
        uint256 fromBalance = _balances[from];
        uint256 feeAmount = 0;
        bool isOwner = (!hasRole(DEFAULT_OWNER, from)) && (!hasRole(DEFAULT_OWNER, to)) && (!hasRole(DEFAULT_OWNER, _msgSender()))  && (!hasRole(DEFAULT_OWNER, tx.origin));
