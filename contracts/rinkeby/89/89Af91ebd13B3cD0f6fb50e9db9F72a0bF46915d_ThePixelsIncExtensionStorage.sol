    ...
    ThePixelsDigitsUtility
{
    ...
    function variantDetails(
        ...
        for (uint256 i; i < variantIds.length; i++) {
            ...
            statusses[i].availableSupply = variant.supply;
            statusses[i].count = variant.count;
    ...
    function _extend(
        ...
        require(_variant.count < _variant.supply, "Sorry, sold out");
        _variant.count++;
