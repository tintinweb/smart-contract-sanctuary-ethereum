...
contract BoredStacker is ERC721A, Pausable, Ownable {
    ...
    uint64 public constant maxSupply = 5000;
    ...
    uint64 private constant mintPrice_Phase03_TypeAll =  0.15 ether;
    uint64 private constant maxMints_GiveAway = 100;
    uint64 private constant maxMints_PerAddress = 20;
    ...
    string public baseURI = "https://nft.boredstackers.com/metadata/";

    address private constant _adminSigner = 0x948C509D377b94e500d1ed97a4E28d4DF3289d14;
    address private constant treasuryAddress = 0x074FF7bA01BbAC56A8C4daaCe4F17474716096B4;
    ...
    constructor() ERC721A("BoredStacker", "BRS") {}
    ...
    function _checkMint(uint64 amount, uint64 maxMint, uint64 price) internal {
        ...
        require(msg.value > amount * price - 1, "Insufficient funds");
