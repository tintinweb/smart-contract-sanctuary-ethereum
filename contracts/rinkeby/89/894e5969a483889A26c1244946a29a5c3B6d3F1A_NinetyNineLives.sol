...
contract NinetyNineLives is ERC721A, Ownable {
    ...
    // public
    function reserveMint(uint256 _mintAmount)
    external
    onlyOwner
    {
    ...
    // Only Owner
    function setWhitelist(address[] calldata addresses, bool _isWhitelist) external onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
            whitelistedAddresses[addresses[i]] = _isWhitelist;
        }
    }
