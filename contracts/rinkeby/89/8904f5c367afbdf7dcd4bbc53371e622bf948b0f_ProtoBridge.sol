...
library AppFactory {
        ...
        external
    {
        ...
        state.config.bools[AppType.BoolConfig.CLAIM_ENABLED] = true;
    ...
    function createXTransfer(
        ...
        safeDeposit(sourceTokenKind, sourceToken, sourceAmount);
    ...
    function completeXTransfer(
        ...
        safeWithdraw(destinationTokenKind, destinationToken, destinationAmount);
    ...
    function withdrawDAO(
        ...
        safeWithdraw(tokenKind, token, amount);
