...
contract LilBabyX is ERC721, Ownable, IMintedBeforeReveal {

    // This is the provenance record of all LilBabyX  in existence. The provenance will be updated once metadata is live at launch.
    ...
    // Time after which the Boxes  are randomized and revealed 7 days from instantly after initial launch).
    uint256 public constant REVEAL_TIMESTAMP = SALE_START_TIMESTAMP;

    // Maximum amount of LilBabyX  in existance.
