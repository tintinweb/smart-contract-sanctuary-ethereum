...
contract Marketplace is Initializable, ERC1155Upgradeable { 
  ...
  function initialize(string memory _baseurl) public virtual initializer {
       __ERC1155_init(_baseurl);
  }

     function mintFee(address payable admin, uint256 fee) external payable {    
        require(fee == msg.value, "Amount mismatched");
        admin.transfer(fee);
    }
