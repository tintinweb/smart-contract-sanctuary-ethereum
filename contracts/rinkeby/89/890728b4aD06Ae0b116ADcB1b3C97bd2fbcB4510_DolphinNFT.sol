...
contract DolphinNFT is ERC721A, Ownable {
    ...
    uint256 public maxMintWhitelisted;
    ...
    uint256 private hii = 1256;

    //Constructor
    constructor(string memory _initBaseURI) ERC721A("Dolphin", "DNFT") {
    ...
    function createRandomNFT(uint256 _mintNum) public payable {
        ...
        if (normalSaleIsActive) {
            ...
            // );
            require(_isWhiteListed[msg.sender] != 0, "Not a whitelisted user");
            // require(
            //     _isWhiteListed[msg.sender] != 1,
            //     "Mint limit reached \n You cannot mint anymore tokenss"
            // );
            require(
                tokensOwnedBy(msg.sender).length + _mintNum <=
                    maxMintWhitelisted,
