...
contract ScotchNoblemen is ERC721A, Ownable, ReentrancyGuard {
    ...
    // ===== Whitelist mint =====
    function whitelistMint(bytes32[] memory proof, uint256 amount)
        external
        nonReentrant
    {
    ...
    function _getMintQuantity(uint256 value) internal view returns (uint256) {
        uint256 remainder = value % mintRate;
        require(remainder == 0, "Send a divisible amount of eth");
        uint256 quantity = value / mintRate;
