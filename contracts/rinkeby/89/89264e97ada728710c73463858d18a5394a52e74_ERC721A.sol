...
contract boblintown is Ownable, ERC721A {
    ...
    uint256 constant public PUBLIC_MINT_LIMIT = 30;

    uint256 public TOTAL_SUPPLY_TEAM;

    string public revealedURI;
    
    string public hiddenURI = "ipfs://QmNyAmkBN9vX4CfTGVrKmj8hpj23k2ik7WxwvUo3rnPJrY";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmNyAmkBN9vX4CfTGVrKmj8hpj23k2ik7WxwvUo3rnPJrY";
    ...
    address public teamWallet = 0x9D43C6Ce37396B5524CfB95867f6749Ac4f62bC5;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("boblintown", "bt") { }
