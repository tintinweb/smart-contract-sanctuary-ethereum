...
contract InfektedMfers is ERC721A, Ownable, Pausable {
    ...
    address public vmAddress = 0xddBdBC6E11194c29A40a879484593a938976e261; // Viral Mfers contract
    address public mferAddress = 0x655385D930e0F956c32B02723133D17ce1077279; // Mfers contract
    ...
    function myImTokenCount() external view returns (uint256) {
        return balanceOf(msg.sender);
    }

    function myVmTokenCount() external view returns (uint256) {
        ERC721A token = ERC721A(vmAddress);
        uint256 tokenCount = token.balanceOf(msg.sender);
        return tokenCount;
    }

    function myMfTokenCount() external view returns (uint256) {
