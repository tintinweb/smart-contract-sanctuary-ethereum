    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        baseUri = "https://collings.io/";

        collingsAddress = msg.sender;
        clientAddress = msg.sender;
        collingsFee = 5; // 5% of the total sellable amount
        totalSellableAmount = 11;
        royalty = 75; // 75 is 7.5%
    }
    ...
    function activateArtistSale() public {
        publicSaleActive = false;
        artistSaleActive = true;
        whitelistSaleActive = false;
    }

    function activateWhitelistSale() public {
        publicSaleActive = false;
        artistSaleActive = false;
        whitelistSaleActive = true;
    }

    function stopAllSales() public {
        publicSaleActive = false;
        artistSaleActive = false;
        whitelistSaleActive = false;
    }
    ...
    function mint(
        ...
        if (artistSaleActive) {
            _artistMint(account, id, amount);
        } else if (publicSaleActive) {
            _publicMint(account, id, amount);
        } else if (whitelistSaleActive) {
            _whitelistMint(account, id, amount);
        } else {
    ...
    {
        return (address(this), (_salePrice * royalty) / 1000); // eg. (100*75) / 1000 = 7.5
    }
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(baseUri, StringsUpgradeable.toString(id), ".json")
            );
    }
