...
contract Token is ERC20, Ownable, Interest, ReentrancyGuard {
    ...
    constructor(
        ...
        // require(ratePerYearInWei_ >= 1 * 1 ether && ratePerYearInWei_ <= 2 * 1 ether, 'The ratePerYearInWei_ must be between 1 and 2 ethers');

        // require(
        //     maxAmountManuallyMintable_ >= 400000000 * 1 ether && maxAmountManuallyMintable_ <= 500000000 * 1 ether,
