...
contract ACDMPlatform is ReentrancyGuard, AccessControl {
    ...
    function setRerrersPercents(uint256 sale1Percent, uint256 sale2Percent, uint256 trade1Percent, uint256 trade2Percent, uint256 precision) external onlyRole(DAO_ROLE){
    ...
    function getFirstSaleRerrerPercents() external view returns(uint256){
