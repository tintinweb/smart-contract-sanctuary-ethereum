// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"01", unicode"02", unicode"03", unicode"04", unicode"05", unicode"06", unicode"07", unicode"08", unicode"09", unicode"10", unicode"11", unicode"12", unicode"Frame"];
        ...
        ContractData public contractData = ContractData(unicode"Bit Mosaics", unicode"Completely random Mosaic Pixel Art", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/6df2bd29-15f7-4cf5-9a12-8ef33c3b8c19", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/6df2bd29-15f7-4cf5-9a12-8ef33c3b8c19", "", 500, "0x8A651D64E05E1Ebd6612e36ecec5184F549e4106");

        constructor() ERC721A(unicode"Bit Mosaics", unicode"MOSAIC") {
            TIERS[0] = [4,1666,1666,1666,1666,1666,1666];
TIERS[1] = [4,1666,1666,1666,1666,1666,1666];
TIERS[2] = [4,1666,1666,1666,1666,1666,1666];
TIERS[3] = [4,1666,1666,1666,1666,1666,1666];
TIERS[4] = [4,1666,1666,1666,1666,1666,1666];
TIERS[5] = [4,1666,1666,1666,1666,1666,1666];
TIERS[6] = [4,1666,1666,1666,1666,1666,1666];
TIERS[7] = [4,1666,1666,1666,1666,1666,1666];
TIERS[8] = [4,1666,1666,1666,1666,1666,1666];
TIERS[9] = [4,1666,1666,1666,1666,1666,1666];
TIERS[10] = [4,1666,1666,1666,1666,1666,1666];
TIERS[11] = [4,1666,1666,1666,1666,1666,1666];
TIERS[12] = [10,30,100,4930,4930];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Bit Mosaics #");
