...
contract ParallelReceiverPdiiiCorePack is VRFConsumerBaseV2, Ownable {
    ...
    uint256 public corePrice = 75000000000000000;
    ...
    function handleReceive(
        ...
        bytes memory /*_data*/
    ) public payable onlyParallelAuxiliaryItemsContract {
        ...
        require(
            _ethValue >= corePrice * numPacksToSendToUser,
            "insufficient ETH"
        );
        ...
        override
    {
        ...
        require(deposit.owner != address(0), "cannot fufill empty deposit");
    ...
    modifier onlyParallelAuxiliaryItemsContract() {
        require(msg.sender == routerContractAddress, "only callable by PAI");
        _;
    }
