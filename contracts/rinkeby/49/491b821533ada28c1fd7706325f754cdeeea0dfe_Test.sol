...
contract Test is ERC721, Ownable {
    ...
    uint256 public legendaryStartIndex=1451;
    ...
    function legendaryMint(uint256 _mintAmount) public payable{
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
            
            _safeMint(msg.sender, legendaryStartIndex + legendaryminted);
            legendaryminted++;
        }
    }
