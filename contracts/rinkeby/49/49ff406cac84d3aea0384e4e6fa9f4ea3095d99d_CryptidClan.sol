...
contract CryptidClan is ERC721A, Ownable, ReentrancyGuard {
  ...
  bytes32 public merkleRoot = 0x31ff952a33b50501c4450b3861a7278c2050e24510e2dcb03007cf58f1f5992b;
  ...
  constructor(
    ...
    WTOKEN = IWRLD_TOKEN(0xB33Dc1dd40CD1859FcE263641249333c4290514A);
  }
...
/// @dev presale mint for whitelisted
  ...
  function withdraw() public payable onlyOwner nonReentrant {
    (bool success, ) = payable(0x6679A2D9f39863e862ca2499cbE50334f074F2C7).call{value: address(this).balance}("");
    require(success);
    WTOKEN.transferFrom(address(this), (0x6679A2D9f39863e862ca2499cbE50334f074F2C7), WTOKEN.balanceOf(address(this)));
  }
}