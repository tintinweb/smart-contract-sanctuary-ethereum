...
// File @animoca/ethereum-contracts-assets-1.1.5/contracts/token/ERC1155/[email protected]
...
// File @animoca/tokenlaunchpad-ethereum-contracts-1.1.0/contracts/token/ERC1155/[email protected]
...
// File contracts/token/ERC1155/QUIDDVouchersRedeemer.sol
 ...
 */
contract Redeemer is TokenLaunchpadVouchersRedeemer {
    
    mapping (uint256 => uint256) internal _redeemPair;
    ...
    function createPair(uint256 tokenId, uint256 amount) external virtual{
        _requireOwnership(_msgSender());
        require(amount > 0, "Redeemer: wrong amount");
        _redeemPair[tokenId] = amount;
    }
     ...
     */
    function _voucherValue(uint256 tokenId) internal view virtual override returns (uint256) {
        uint256 tokenValue = _redeemPair[tokenId];
        require(tokenValue > 0, "Redeemer: invalid voucher");
        return tokenValue;
    }
}