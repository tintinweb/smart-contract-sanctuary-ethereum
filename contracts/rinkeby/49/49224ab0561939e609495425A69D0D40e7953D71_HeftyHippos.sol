...
contract HeftyHippos is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function oglistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    // Verify oglist requirements
    require(oglistMintEnabled, 'The OG sale is not enabled!');
  ...
  function presalelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    // Verify oglist requirements
...
function setpresalelistMintEnabled(bool _state) public onlyOwner {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // This will pay Dev
    // =============================================================================
/*     (bool gj, ) = payable(0xB991f19931eF839B91ccfC557aFF530217Be0888).call{value: address(this).balance * 20 / 100}('');
    require(gj); */
    (bool garet, ) = payable(0xB991f19931eF839B91ccfC557aFF530217Be0888).call{value: (balance / 100) * 20}("");
    require(garet);
    // This will pay Founder.
    // =============================================================================
/*     (bool far, ) = payable(0x70B13623893DDF3C2785decD72F64BD4b31f5888).call{value: address(this).balance * 20 / 100}('');
    require(far); */
    (bool far, ) = payable(0xa34Dd7D6b390f3008B477f40fE66af6A41C51002).call{value: (balance / 100) * 20}("");
    require (far);
    ...
    (bool project, ) = payable(0x70B13623893DDF3C2785decD72F64BD4b31f5888).call{value: address(this).balance}("");
    require(project);
    // =============================================================================
  }
