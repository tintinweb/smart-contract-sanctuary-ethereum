...
import "../Oddstronauts.sol";

contract OddstronautsTestWrapper is Oddstronauts {
    constructor(
        address signer,
    ...
    {
        metadata = Metadata({
            baseURI: "ipfs://QmWYLTaZ4Fmor63EYkGzP6Xu3sJDgq65MFaqdYU8XwTBJG/",
            collectionURI: "ipfs://",
            placeholderURI: "ipfs://"
        });
...
contract Oddstronauts is ERC721ABase {
    ...
    function reserve(uint256 amount, address receiver) external onlyOwner {
        require(_totalMinted() + amount <= MAX_MINTABLE, "Insufficient total supply");
...
contract ERC721ABase is ERC721AQueryable, Ownable, VRFConsumerBaseV2 {
     ...
     */
    function tokenOffset() public view virtual returns (uint256) {
