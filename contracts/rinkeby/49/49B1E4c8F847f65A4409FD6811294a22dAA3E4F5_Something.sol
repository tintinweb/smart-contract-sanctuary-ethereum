...
contract Something is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
    struct PeriodInfo {
    ...
    address public treasury = 0x30790888CA10e1ca086C16EAE46c524144C1C244;
    ...
    constructor(string memory uri) ERC721A("Something", "STH") {
        ...
        // // freemint period
        // _addPeriod(2, 2222, 0, false);
        // whitelist period
        _addPeriod(2, 1000, 1e16, true);
        // public sale period
        _addPeriod(1000, 1000, 2e16, false);
        _addPeriod(1000, 1000, 3e16, false);
        _addPeriod(1000, 1000, 4e16, false);
        _addPeriod(1000, 1000, 5e16, false);
        _addPeriod(1000, 1000, 6e16, false);
        _addPeriod(1000, 1000, 7e16, false);
        _addPeriod(1000, 1000, 8e16, false);
        _addPeriod(1000, 1000, 9e16, false);
        _addPeriod(1000, 1000, 10e16, false);
        //_addPeriod(MAX_SUPPLY, MAX_SUPPLY, 2e16, false);
    }
    ...
    function setURI(string memory newBaseURI, bool newReveal) external onlyOwner {
        baseURI = newBaseURI;
        reveal = newReveal;
    }
