...
contract MUGENGenesis is ERC721A('MUGENGenesis', 'MUGENGENESIS'), Ownable {
    ...
    address public constant withdrawAddress = 0x21206A7114C99c01b31dC6501Ae95a2CAD9Ce8D2; // TODO 2つめのアカウント
    uint256 public constant maxSupply = 29;
    uint256 public constant publicMaxPerTx = 5;
    string public constant baseExtension = '.json';

    string public baseURI = 'ipfs://QmXPHGQgLCAfvA4SKXX1KWhttxmrEYB3iVsiAsYi4Z9Tkv/'; // TODO JSONリスト 最初はリビール前の画像
