...
contract Dragon is ERC721, Ownable {
    ...
    function birthNewDragon(uint256 _motherId, uint256 _fatherId)
        external
...
contract DragonEgg is ERC721, Ownable {
        ...
        returns (uint256 dragonId)
    {
        ...
        require(
            ...
            "Dragon's Egg is not ready to hatch yet"
        );

        return dragonInterface.birthNewDragon(_motherId, fatherId);
    }
}