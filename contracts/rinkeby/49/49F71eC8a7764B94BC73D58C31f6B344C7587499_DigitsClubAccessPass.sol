...
contract DigitsClubAccessPass is ERC1155, Ownable {
    using Strings for uint256;
    
    string private baseURI;

    //identifying different token types
    uint256 public constant ACCESSPASS = 0;
    uint256 public constant CHOSENPASS = 1;
    uint256 public constant COUNCILPASS = 2;
    ...
    constructor() ERC1155("ipfs://.../") {
        ...
        //mint the specific quantities of each type of pass to owner address
        _mint(msg.sender, ACCESSPASS, 9999, "");
        _mint(msg.sender, CHOSENPASS, 999, "");
        _mint(msg.sender, COUNCILPASS, 9, "");
    }
    ...
    function uri(uint256 typeId)public view override returns (string memory) {
        require(typeId < 3, "URI requested for invalid token type");
        return
