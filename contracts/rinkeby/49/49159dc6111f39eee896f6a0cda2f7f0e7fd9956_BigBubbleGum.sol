...
contract BigBubbleGum is ERC20, Ownable, VRFConsumerBaseV2 {
    // Basic units
    uint256 private constant ONE_HOUR = 60 * 15; //shortened to 15 minutes for testing purposes
        ...
        VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab)
    {
        ...
        LizzieWizzieNFTs = ILizzieWizzie(
            0x3BAa9DCF2c3AeE445c91Ce6F691Df19Cb2Db67D8
        );
    }
        ...
        private
    {
        ...
        if (LizzieWizzieNFTs.balanceOf(_user) > 0) {
            lizzyWizzyTolerance = 100;
        }

        if (rektageOrNot < 1 || _move == Move.SPOCK) {
            // Rektage Finger
            rektage = true;
    ...
    function _checkAndPayBiggestBuyer(uint256 _currentHour) private {
        ...
        if (
            ...
            if (_before > 0) {
                ...
                // if (
                //     distributorGas > 0 && LizzieWizzieNFTs.getTotalSupply() > 0
                // ) {
