...
contract BuxRoyal is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Royalty, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public burned;

    constructor(string memory contractURI_, uint96 feeNumerator) ERC721("Bux Test Arg", "ARGBUX") {
