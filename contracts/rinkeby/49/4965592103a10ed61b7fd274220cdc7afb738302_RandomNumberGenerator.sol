...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the JackpotApe lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == jackpotApeLottery, "Only JackpotApeLottery");
    ...
    /**
     * @notice Set the address for the JackpotApeLottery
     * @param _jackpotApeLottery: address of the JackpotApe lottery
     */
    function setLotteryAddress(address _jackpotApeLottery) external onlyOwner {
