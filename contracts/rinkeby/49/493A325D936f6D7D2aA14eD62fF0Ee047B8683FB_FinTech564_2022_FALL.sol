...
import {ERC20Spendable} from "./DukeCredit.sol";

contract FinTech564_2022_FALL is ERC721, ERC721Burnable, AccessControl {
    ...
    constructor() ERC721("FinTech564_2022_FALL", "FT564-22") {
    ...
    function setMintingPrice(uint256 newMintingPrice)
        external
    ...
    function setMintingCurrency(ERC20Spendable newMintingCurrency)
        external
        onlyRole(MINTER_ROLE)
    {
