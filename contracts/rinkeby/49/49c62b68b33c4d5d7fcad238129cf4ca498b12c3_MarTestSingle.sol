    ...
    BEP721Burnable    
{
    ...
    function addTokenType(
        ...
        _addTokenType(_type, tokenAddress, _sale);
    }
    ...
    function mintByUser(
        ...
        _tid = _tid + 1;
        uint256 tokenId = _tid.add(block.timestamp);
    ...
    function burnToken(uint256 tokenId) public {
        require(balances[tokenId][msg.sender] == 1, "Your Not a Token Owner or insufficient Token Balance");
        burn(tokenId);
