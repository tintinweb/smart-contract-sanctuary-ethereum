...
contract TableChefPass is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    Counters.Counter public _whitelistId;
    Counters.Counter public _exclusibleCount;

    uint256 private constant MAX_TOTAL_SUPPLY = 10_000;
    uint256 private constant MAX_EXCLUSIBLE_SUPPLY = 3_000;

    uint256 private _tokenPublicPrice = 0.2 ether;
    uint256 private _exclusibleTokenPrice = 0.3 ether;
    ...
    modifier whenPublicSale() {
        require(_isPublicSale == true, "!sale");
        _;
    }
    ...
    function publicMint(uint16 count) external payable whenPublicSale {
