...
contract NFT is ERC721A, Ownable {
    ...
    uint256 public constant SALE_TIME_START = 1650002400; // 2022/04/15 13:00
    uint256 public constant PRESALE_TIME_START = 1649998800; // 2022/04/15 13:00
    ...
    bytes32 public wlRoot = 0x7f5ac2647a6c170233be86651caf417afbe3be9cc9ad9c75ede39c465aa45fe0; // todo
    bytes32 public vipRoot = 0x7f5ac2647a6c170233be86651caf417afbe3be9cc9ad9c75ede39c465aa45fe0; // todo

    string public _partslink;

    constructor(address payable fundReceiver, string memory link) ERC721A("NFT", "NFT") {
    ...
    function presaleMint(uint numberOfTokens, bytes32[] memory wlProof, bytes32[] memory vipProof) external payable {
        ...
        if (vipProof.length != 0) {
            require(MerkleProof.verify(vipProof, vipRoot, keccak256(abi.encodePacked(operator))), "Not allowed during presale");
    ...
    function setBaseURI(string memory link) external onlyOwner {
        _partslink = link;
    }
