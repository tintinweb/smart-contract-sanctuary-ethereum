...
contract ECRegistryV3c is Ownable {
    ...
    */
    ...
    // ---- Change start ----
    function setDefaultTraitControllerType(address _addr, uint8 _traitType) public onlyAllowed {
        defaultTraitControllerAddressByType[_traitType] = _addr;
        emit traitControllerEvent(_addr);
    }

    function getDefaultTraitControllerByType(uint8 _traitType) public view returns (address) {
