...
contract TextCollection is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxperAddressFreeLimit = 10;  //max free for a one account
  uint256 public maxperAddressPublicMint = 10; //max public for a account
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxperAddressPublicMint);
  ...
  function MintFree(uint256 _mintAmount) public payable {
        ...
        require(supply + _mintAmount <= maxFree, "Cant go over supply" );
    ...
    returns (string memory)
  {
    ...
    require(_newMaxFreeSupply <= maxSupply, "Cannot increase max supply");
