...
contract LingoPlates is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Lingo Plates", "LP") {
    setHiddenMetadataUri("ipfs://QmNfNvsT2hmVZzG66TpD7WxnZYCp5kc75Ns7AyqzoMWEuF/hidden.json");
  }
