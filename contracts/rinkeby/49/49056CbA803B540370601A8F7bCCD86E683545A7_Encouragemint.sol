...
contract Encouragemint is ERC721A, Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Mint a quantity of tokens when minting is active
     * @param _quantity Number of tokens to mint
     */
    function mint(uint256 _quantity) external payable virtual nonReentrant {
        require(isMintActive, "Minting inactive");
        require(_quantity <= MAX_BATCH_SIZE, "Quantity exceeds max");
        require(msg.value == MINT_PRICE, "No payment required");
