...
contract EmergenceTester {
    ...
    function setMultipleParams(string memory _awesomeString, uint256 _awesomeInt, uint8 smallInt, bool _awesomeBool) public returns (uint256, string memory, bool, uint8){
        awesomeBool = _awesomeBool;
        awesomeInt = _awesomeInt;
        awesomeString = _awesomeString;
