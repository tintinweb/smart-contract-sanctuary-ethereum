...
contract Staking is Ownable {
    ...
    mapping(address => uint256[]) followerStakes;
    ...
    function stakeHelper(uint256 amount, uint256 predictionId) internal {
        ...
        prediction.stakes += amount;
        followers[predictionId].push(Follower({
            follower: msg.sender,
            _stake: amount
        }));
        followerStakes[msg.sender].push(predictionId);
    }
    ...
    function getFollowerStakes(address follower) public view returns(uint256[] memory) {
