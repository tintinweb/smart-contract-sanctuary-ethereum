...
contract SpaceRouter {
        ...
        )
    {
        ...
        uint256 liquidity = liquidityPool.mint{value: _amountEth}(_amountSpc, msg.sender);
...
contract LiquidityPool is ERC20 {
     ...
     */
    function mint(uint256 spcIn, address to) external payable lock returns (uint256) {
        uint256 liquidity;
    ...
    function burn(uint256 liquidity, address to) external lock returns (uint256, uint256) {
        ...
        ethReserve = _ethReserve - ethOut;
        spcReserve = _spcReserve - spcOut;
