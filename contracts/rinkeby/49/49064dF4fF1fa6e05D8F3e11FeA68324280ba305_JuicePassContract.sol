...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x334591c10f85b437915C56b41C8B88922a910B15];
...
// File: contracts/JuicePassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract JuicePassContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Juice Pass";
    string public symbol = "Juice";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vMoyVoflTAiN7ZTCDiIA/contract-metadata";
    }
