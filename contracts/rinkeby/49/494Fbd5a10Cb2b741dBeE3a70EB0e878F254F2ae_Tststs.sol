...
contract Tststs is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("TSTSTS", "TSTST") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount * price == msg.value, "Please send the exact amount.");
        require(totalSupply() + _amount < maxSupply + 1, "No more tygers.");
    ...
    function freemint(uint256 _amount) external {
        ...
        require(maxPerTxFree >= _amount, "Excess max per free tx");
        require(
            maxPerWalletFree >= balanceOf(msg.sender) + _amount,
            "Excess free mint wallet limit reached"
        );
        require(totalSupply() + _amount < maxSupply + 1, "No more tygers.");
