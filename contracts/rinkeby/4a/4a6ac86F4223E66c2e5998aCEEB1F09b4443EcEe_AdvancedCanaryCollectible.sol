    ...
    VRFConsumerBaseV2
{
    ...
    mapping(uint256 => uint256) tokenIdToCanaryRandomBreedNumber; // Store the random mumber identified per tokenId
    mapping(uint256 => uint256) tokenIdToRequestId; //Store the random requestId for each tokenId
    mapping(uint256 => uint256) requestIdToTokenId; //Store the random requestId for each tokenId
