...
contract RRBeginAsNothing is Ownable, ERC721A {
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("RR/BeginAsNothing", "RRnothings") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 50, "Not enough free supply");
