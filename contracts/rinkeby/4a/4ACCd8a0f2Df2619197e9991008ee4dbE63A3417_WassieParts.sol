...
contract WassieParts is ERC721AQueryable, ERC721ABurnable, Ownable {
    ...
    uint256 public constant ALLOWLIST_MINT_PRICE = 0.02 ether;
    ...
    /*--------------------------CONSTRUCTOR-------------------------------*/
    constructor() ERC721A("WassieParts", "WASSIE") {}
    ...
    function mintAirdrop(uint256 nMints, address recipient) external onlyOwner validTxn(nMints) {
        uint256 remainder = nMints % MAX_BATCH_SIZE;
        unchecked {
            uint256 nBatches = nMints / MAX_BATCH_SIZE;
            for (uint256 i; i < nBatches; ++i) {
    ...
    function withdrawAll() external onlyOwner {
        ...
        _withdraw(address(0xD9db2f388BDC61C4f013452CAD5cd0845F22cC42), (contractBalance * 8) / 100);
