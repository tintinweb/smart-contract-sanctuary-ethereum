...
contract StrawhatzMintPassport is ERC1155, IERC2981, Ownable {
    ...
    uint256 public constant PRESALE_TOKEN_PRICE = 0.0123 ether;
    uint256 public constant PUBLIC_TOKEN_PRICE = 0.0333 ether;
    ...
    constructor(string memory _baseTokenURI) ERC1155("") Ownable()
    {
