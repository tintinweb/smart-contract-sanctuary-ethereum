...
contract LanceriaMarketPlace is Ownable{
  ...
  function claimAuction(
    ...
    uint256 price = _price * 10 ** 18;
    // check if price is higher than bottom price
    require(price >= listing.price, 'price_too_low');
    ...
    _purchase(_collection, _tokenId, price, seller, _buyer);

    emit ListingPurchased(seller, _buyer, _collection, _tokenId, price, 2);
  }
