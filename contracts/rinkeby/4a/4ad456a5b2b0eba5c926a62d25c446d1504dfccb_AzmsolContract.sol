...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3b1B709c0c1AB8AC892F56DD161D7E8436C88db4];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://azmsol.com/token/";
...
// File: contracts/AzmsolContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AzmsolContract is RamppERC721A {
    constructor() RamppERC721A("Azmsol", "AZM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/8iuhIHipIwSqpuWDctzN/contract-metadata";
    }
}
