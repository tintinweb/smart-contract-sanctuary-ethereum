...
// File: contracts/InvaderMarketplace.sol
...
contract InvaderMarketplace is ReentrancyGuard {
    ...
    mapping(uint256 => MarketplaceItem) private idToItem;
    ...
    function getListedItems() public view returns(MarketplaceItem[] memory) {
        ...
        for (uint i = 1; i < listedItems; i++) {
            if (idToItem[i].owner == address(this)) {
