...
contract TestContract is ERC721A, Ownable {
    ...
    uint256 public MINT_PRICE = 0.00085 ether;
    string public baseURI = "";
    bool public isSaleActive = false;
    mapping(address => uint) public numFreeMinted;
    ...
    constructor() ERC721A("TestContract", "TC") {}
    ...
    function freeMint(uint8 _quantity) external payable
    {
        ...
        if (numFreeMinted[msg.sender] + _quantity > MAX_FREE_PER_WALLET) {
            revert MaxFreeMints();
        }

        numFreeMinted[msg.sender] += _quantity;
        _safeMint(msg.sender, _quantity);
    }
