...
contract TestNFTB is ERC721A, Ownable {
    constructor() ERC721A("TestNFTB", "TestNFTB") {}
    ...
    */
    function mintNFTDuringPresale(uint256 _numOfTokens, bytes32[] memory _proof) external payable {
