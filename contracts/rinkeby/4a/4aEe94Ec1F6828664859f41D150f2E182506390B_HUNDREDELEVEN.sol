...
contract HUNDREDELEVEN is ERC721A, Ownable, ERC2981 {
    ...
    constructor() ERC721A("HUNDRED ELEVEN", "111") {
    ...
    function editMetaCollection(address _address) public onlyOwner {
    ...
    function publicSale(uint quantity) payable public {
        require(saleOpen);
        require(quantity <= 5);
        require(totalSupply() + quantity <= 100);
        require(msg.value == 0.111 ether * quantity);
