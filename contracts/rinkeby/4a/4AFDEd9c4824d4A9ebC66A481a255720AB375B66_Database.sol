...
contract Database is Ownable, IDB {
    ...
    mapping(uint256 => bool) internal isFeePaid;
    event FeePaid(address payer, uint256 amount, uint256 _bridgeID);
    ...
    function payBridgeFee() external {
        ...
        isFeePaid[bridgeID] = true;
        emit FeePaid(msg.sender, bridgeFee, bridgeID);
    }
