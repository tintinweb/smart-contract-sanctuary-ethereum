...
contract BrightIDSoulboundFake is
    Context,
    ERC165,
    BrightIDValidatorOwnership
{
    ...
    function _burn(uint256 tokenId) internal virtual {
        address owner = BrightIDSoulboundFake.ownerOf(tokenId);
...
import "../BrightIDSoulboundFake.sol";

contract BrightIDSoulboundTest is BrightIDSoulboundFake {
    constructor(
        address verifier,
        bytes32 context,
        string memory name_,
        string memory symbol_
    ) BrightIDSoulboundFake(verifier, context, name_, symbol_) {}
