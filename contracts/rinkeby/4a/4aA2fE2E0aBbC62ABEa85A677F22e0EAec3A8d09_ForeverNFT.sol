...
contract ForeverNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint256 public MAINSALE_PRICE = 0 ether;
    ...
    constructor(
        ...
        require(_royaltyFee <= 30000, "can't more than 10 percent");
        require(
    ...
    modifier callerIsUser() {
        require(
            ...
            "Flinch NFT :: Cannot be called by a contract"
        );
        _;
    }
    ...
    function setPresale(address[] calldata accounts, bool allowed)
        external
        onlyOwner
    {
    ...
    function setPrice(uint256 mainsalePrice, uint256 allowlistSalePrice)
        external
        onlyOwner
    {
        require(
            MAINSALE_PRICE != mainsalePrice ||
                PRESALE_PRICE != allowlistSalePrice,
