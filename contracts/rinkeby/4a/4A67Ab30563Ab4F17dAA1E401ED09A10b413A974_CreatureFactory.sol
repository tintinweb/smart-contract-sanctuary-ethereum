...
contract Creature is ERC721Tradable {
    ...
    constructor(string memory baseURI) ERC721Tradable("NewCreature", "NSC2") {
        _URI = baseURI;
    }
...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    constructor(string memory baseURI) {
        _baseURI = baseURI;
        Creature creature = new Creature(_baseURI);
        creature.transferOwnership(address(this));
        nftAddress = address(creature);
        ...
        onlyOwner
    {
        ...
        openSeaCreature.mintTo(_optionId, _toAddress);
    }
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(_baseURI, Strings.toString(_optionId), ".json")
            );
    }
