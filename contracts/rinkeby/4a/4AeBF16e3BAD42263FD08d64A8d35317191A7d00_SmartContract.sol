 ...
 *Submitted for verification at Etherscan.io on 2022-08-22
 https://rinkeby.etherscan.io/address/0x0C22472E46de43bAfDdef2fAfc783D5896F65425#writeContract
 https://rinkeby.etherscan.io/address/0x797F6BeCEDB2267fA70927c62615757fbDEfaFa9#code

https://rinkeby.etherscan.io/address/0x40b562f974bdbBeff2d9621De43dD9367aEcC9F5#code

latest
https://rinkeby.etherscan.io/address/0xa2bb6a013e03CE132B58c85540fCE02743aD9838#code

https://rinkeby.etherscan.io/token/0xa2bb6a013e03CE132B58c85540fCE02743aD9838#writeContract

https://rinkeby.etherscan.io/address/0x555b4D431C063dD54fbDd85F6b4d4F34d1a0C007#code
//coretokenamount not working. if mode on not income in dev wallet. 

https://rinkeby.etherscan.io/address/0x3e37311359512160d4335E8821bb7FC6c2B750c6#code
//recode tax and swap sendeth still the same
...
for rechecking of core token in eth and token 
august 22
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MSTaug25v3";
    ...
    bool public burnMode = true; // return to false in final
    ...
    uint256 public EthForAutoCore;
    uint256 public amountCoreinEth;
    uint256 public totalCoreinEth;
    uint256 public amountBurntCoreinToken;
    uint256 public totalBurntCoreinToken;
    address payable private feeAddrWallet;
    address payable private feeAddr2Wallet;//for autoburncore
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x88aBA96140F8094754Ebc28dCC8e504596B59107);  //scorcherWallet
        feeAddr2Wallet = payable(0x944C9B1d3A459728172A880C4Ca0ceC4257Ba5b5); //walet 3 for autoburn
      ...
      if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromMaxWalletSize[to]) {             
        ...
        uint256 contractTokenBalance = balanceOf(address(this));
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0) {
                ...
                //portion ni autburncore lang ang i pang buy ng core token
                
                if (!burnMode && (contractETHBalance > 0)) {
                    sendETHToFee(address(this).balance);
                } else if (burnMode && (contractETHBalance > 0) && (EthForAutoCore > buyCoreUpperLimit)) {
                    sendETHToFee(address(this).balance);
                        uint256 buyAmount = EthForAutoCore;
                        amountCoreinEth = buyAmount;
                        totalCoreinEth += amountCoreinEth;
                    buyCore(buyAmount);
                }
  ...
  function swapAndLiquify(uint256 tokenAmount) private lockTheSwap {
        uint256 totalFee = autoLiquidityRatio + autoBurnFeeRatio + autoRewardFeeRatio + autoBurnCoreRatio + autoBurnFeeRatio;
        ...
        uint256 CurrentEthBalance = deltaBalance - ethToAddLiquidityWith;
        //trasnfer autocore eth to feeaddress2
        EthForAutoCore =  (CurrentEthBalance * autoBurnCoreRatio) / (totalFee);
        if (EthForAutoCore > 0)
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        emit Transfer(from, address(this), tokensForAutoBurnCore); //for rechcking if it should be feeAddr2
    ...
    function swapETHForTokens(uint256 amount) private {
        // 
        //uint256 initalBalance = _tOwned[DEAD];
      ...
      // make the swap
        ...
        //uint256 deltaBalance  = _tOwned[DEAD] - initalBalance;
        //amountBurntCoreinToken = deltaBalance;
        //totalBurntCoreinToken += amountBurntCoreinToken;
    }
