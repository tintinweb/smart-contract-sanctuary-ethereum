        ...
        uint256 randnum;
         for (uint i = 0; i < 10000; i++) {
            ...
            //if (winneraddr != address(0)) {
                ...
                emit RTWinnerAddress(address(uint160(321)), 123); //this needs to be 10000+i <- and i needs to be random also, 1st stage sale
            //}
            //emit RTWinnerTokenID(20000-raffle1stStage(), _winnerTokenPRTID);//in case to track all winer tickets in logs         
            emit RTWinnerTokenID(321, _winnerTokenPRTID);//in case to track all winer tickets in logs         
        }
    }
