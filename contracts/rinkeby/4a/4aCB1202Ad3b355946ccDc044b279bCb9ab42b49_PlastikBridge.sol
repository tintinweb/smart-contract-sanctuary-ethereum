    ...
    ReentrancyGuardUpgradeable
{
    ...
    function lock(
        ...
        if (msg.value > 0) {
            ...
            require(msg.value == _amount, "PLASTIK != _amount");
            symbol = "PLASTIK";
        ...
        // ERC20 deposit
            ...
            IERC20(_token).transferFrom(msg.sender, thisadd, _amount);
...
contract BaseBridge {
    ...
    function unlockFunds(
        ...
        if (_token == address(0)) {
            ...
            IERC20(_token).transfer(_recipient, _amount - _fee);
            IERC20(_token).transfer(_owner, _fee);
        }
