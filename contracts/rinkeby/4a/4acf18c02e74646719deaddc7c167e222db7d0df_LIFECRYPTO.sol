...
contract LIFECRYPTO {
    ...
    function setUserNameByAddress(string memory userName, address walletAddress, string memory secret_key) public returns (bool) {
        require(keccak256(bytes(_secretKey)) == keccak256(bytes(secret_key)),"secret key is invalid!.");
