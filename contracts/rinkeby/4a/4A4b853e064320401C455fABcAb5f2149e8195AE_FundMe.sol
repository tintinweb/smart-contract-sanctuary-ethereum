...
contract FundMe {
    ...
    function withdraw() public onlyOwner {
        ...
        //Reset the array
        funders = new address[](0); //In the () we set the elements to start with
    ...
    function returnFunder(uint256 arrayNumber) public view returns (address) {
        console.log("Searching for the founder...");
        return funders[arrayNumber];
    }
}
