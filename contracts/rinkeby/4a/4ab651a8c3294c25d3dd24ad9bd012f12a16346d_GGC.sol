...
contract GGC is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public MAX_NFT = 5555;
	uint256 public MAX_MINT_PRESALE = 5555;
	uint256 public MAX_MINT_SALE = 5555;
	...
	uint256 public PRESALE_PRICE = 25 * 10**16;
	uint256 public SALE_PRICE = 25 * 10**16;
    ...
    constructor() ERC721P('Gabroo Golf', 'GGC') {}
