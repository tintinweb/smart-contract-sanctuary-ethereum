...
contract Unity is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public preSaleWindowCloses  = 1648676146;
...
contract Survive is ERC20, Ownable {
    ...
    function claim() external isPaused {
        ...
        // If user claim but his 55Unity balance is lower than numbers staked, we force this change.
...
contract ToxicPower is ERC1155Supply, Ownable, ReentrancyGuard  {
    ...
    uint16[] public maxSupplyEach = [500, 1, 5];
    uint16[] public tokensNecessary = [2, 5, 10];

    // Timestamp of the start and end of sales
    uint256 public windowCloses = 1649021746;
    uint256 public burnWindowOpens = 1649021746;
