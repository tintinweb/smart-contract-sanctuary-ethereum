...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf3a0BE4f7469FE29bF76D62945ecAb0a75B5F189];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmWun3jHCLLm4iwkbF3wyDHz5T21gchQkx2aMUfEADWpjo/";
...
// File: contracts/GhostGezerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GhostGezerContract is RamppERC721A {
    constructor() RamppERC721A("Ghost Gezer", "GhostG"){}
}
