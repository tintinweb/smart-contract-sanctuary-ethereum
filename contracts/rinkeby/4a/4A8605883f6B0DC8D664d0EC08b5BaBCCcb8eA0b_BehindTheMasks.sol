...
contract BehindTheMasks is ERC721A, IERC2981, Ownable, ReentrancyGuard {
  ...
  // address[] private _payees = ["0x5B38Da6a701c568545dCfcB03FcB875f56beddC4","0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2","0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db"];
  // uint256[] private _shares = [25,35,40];
  ...
  constructor(
    ...
    address _royalties,
    uint256 _maxMintWhitelist,
    uint _maxMintPublic
  // ) ERC721A(_tokenName, _tokenSymbol) PaymentSplitter(_payees, _shares) payable {
  ...
  function setMaxMintPublic(uint _maxMintPublic) public onlyOwner {
    maxMintPublic = _maxMintPublic;
  }
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require((whitelistMinted[_msgSender()] + _mintAmount) <= maxMintWhitelist, 'Exceed Mint Limit!');
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require((publicMinted[_msgSender()] + _mintAmount) <= maxMintPublic, 'Exceed Mint Limit!');
  ...
  function royaltyInfo(uint256 _tokenId, uint256 _salePrice)
        external
        view
        returns (address, uint256 amount)
    {
        require(_tokenId > 0);
        amount = (_salePrice / 100) * 5;
        return (royalties, amount);
    }
    ...
    function balanceOnContract() external view returns (uint256) {
