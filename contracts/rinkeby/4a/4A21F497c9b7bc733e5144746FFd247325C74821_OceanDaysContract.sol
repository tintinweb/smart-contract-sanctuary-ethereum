...
//
//    ____                           ____                  
//   / __ \________  ____ _____     / __ \____ ___  _______
//  / / / / ___/ _ \/ __ `/ __ \   / / / / __ `/ / / / ___/
// / /_/ / /__/  __/ /_/ / / / /  / /_/ / /_/ / /_/ (__  ) 
// \____/\___/\___/\__,_/_/ /_/  /_____/\__,_/\__, /____/  
//                                           /____/        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xECe36E9Feb43A0A7d25A2D0358572613c3B7A710];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmejdav27wQoAmbqRv7sMtA7osAYuar3T2BgwPvqvMJCDj/";
...
// File: contracts/OceanDaysContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OceanDaysContract is RamppERC721A {
    constructor() RamppERC721A("Ocean Days", "Ocean"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/em2IJ8rPV7UBoqpJgRLc/contract-metadata";
    }
}
