...
}// File contracts/templates/BurnSnapshotWhiteListTemplate.sol
...
contract BurnSnapshotWhiteListTemplate is SnapshotFeature, PausableWithWhitelistFeature, ERC20BurnFeature {
    function initialize(
        string memory name_, 
        string memory symbol_, 
        uint8 decimals_, 
