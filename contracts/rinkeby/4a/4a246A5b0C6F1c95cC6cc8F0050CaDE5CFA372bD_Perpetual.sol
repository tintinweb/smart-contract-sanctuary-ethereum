...
/// @title main contract
/// @author Stars Labs
contract Perpetual is Users, Deposits, Withdrawals, UpdateState, Dac, OracleFeeder, ReentrancyGuard, Debug {
    ...
    function initGlobalConfig(
        ...
        console.logBytes("sol globalConfig encode data : ", globalConfig);
...
abstract contract Deposits is Storage {
    ...
    function depositERC20(
        ...
        // Update the balance.
        //uint256 amount = ext_amount * (10 ** token.decimals());
...
abstract contract UpdateState is ForcedWithdrawals, ConditionalTransfer, Config {
    ...
    struct CommitBlockInfo {
        uint32 blockNumber;
        uint32 timestamp;               // TODO : seqence + 1 check, for DEBUG
    ...
    function createBlockCommitment(
        ...
        if (padLen != 0) {
            ...
            console.logBytes("sol rollup_col_full_data : ", abi.encodePacked(newBlock.collateralBalancePubData, padZero));
        } else {
        ...
        console.logBytes32("sol rollup_col_commitment : ", rollup_col_commitment);
        console.logBytes32("sol rollup_assets_commitment : ", rollup_assets_commitment);
        console.logBytes32("h1 : ", h[0]);
        console.logBytes32("h2 : ", h[1]);
        console.logBytes32("h3 : ", h[2]);
        console.logBytes32("h4 : ", h[3]);
        console.logBytes32("h5 : ", h[4]);
        console.logBytes32("h6 : ", h[5]);
        console.logBytes32("h6_2 : ", h6_2);
    ...
    function postProcess(
        ...
        while (offset < pubData.length) {
            ...
            if (op.amount > (1 << 63)) {
                ...
                uint256 externalAmount = innerAmount * (10 ** (collateralToken.decimals() - innerDecimal));
    ...
    function getOrderStateHash(
        ...
        if (oracle_price.length != 0) {
            ...
            //console.logBytes("sol oracle_price encode_data : ", encode_data);
        ...
        if (b.globalFundingIndex.length != 0) {
            ...
            //console.logBytes("sol globalFundingIndex encode_data : ", encode_data);
        ...
        console.logBytes32("sol globalFundingIndexHash : ", globalFundingIndexHash);
        console.logBytes32("sol oraclePriceHash : ", oraclePriceHash);
        console.logBytes32("sol global_state_hash : ", global_state_hash);
        console.logBytes32("sol newOrderStateHash : ", newOrderStateHash);
    }
        ...
        for (uint256 i = 0; i < validium_signature.length; ++i) {
            ...
            for (j = 0; j < sig_dac_num; ++j) {
                if (sigHashs[j] == sigHash) {
                    console.log("ignore same signature : ");
                    console.logBytes(validium_signature[i]);
                    break;
                }
            }
...
contract KeysWithPlonkVerifier is VerifierWithDeserialize {
    ...
    uint256 constant VK_TREE_ROOT = 0x138d6a5adb9d5fdb80ed27664c0c22d8ec8e1f4d0489187d0190c2d7bd660c13;
