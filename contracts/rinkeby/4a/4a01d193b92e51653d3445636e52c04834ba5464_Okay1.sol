...
contract Okay1 is ERC20, Ownable {
    ...
    //SniperBot confusion
    function enableTrading0() external onlyOwner {
        tradingActive = true;
        _launchTime = block.timestamp.add(3);
    }    
    //SniperBot Confusion
    function enableTrading1() external onlyOwner {
        tradingActive = true;
