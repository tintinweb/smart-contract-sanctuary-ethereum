...
uint256 public deadline = block.timestamp + 72 hours;
  ...
  modifier stakeNotCompleted(){
    require(!exampleExternalContract.completed(),'stake is not completed');
    _;
  }
  ...
  function stake()public payable deadlineRemaining stakeNotCompleted{
    require(msg.value>=0,'your value is not enough');
  ...
  function withdraw()public deadlineReached stakeNotCompleted{
    ...
    require(sent,'withdraw function failed');
  ...
  function execute() public stakeNotCompleted deadlineReached{
    ...
    require(sent,'execute function failed');
    }
  }
