...
contract koko is ERC721, Ownable {
    ...
    uint public maxFreeMintPerWallet = 2250;
    uint public maxFreeMint = 2200;
    uint public price = 0.200 ether;
    uint public constant MAX_SUPPLY = 20000;
    bool public isSalesActive = false;
    
    mapping(address => uint) public addressToFreeMinted;

    constructor() ERC721("VEEEKO", "VEKO") {
        _contractUri = "ipfs://";
    }
    ...
    function freeMint() external {
        require(isSalesActive, "VEKKO sale is not active yet");
    ...
    function mint(uint quantity) external payable {
        ...
        require(totalSupply() + quantity <= MAX_SUPPLY, "VEKKO are Sold Out");
