...
contract GombeChimpz is ERC721A, Ownable {
  ...
  function withdraw() external onlyOwner{
        ...
        payable(0xB3D34a4EcFCa69F50F17f4e5947dC5dbE9B3aA4C).transfer(withdrawAmount_35);
        payable(0xB3D34a4EcFCa69F50F17f4e5947dC5dbE9B3aA4C).transfer(withdrawAmount_20);
        payable(0xB3D34a4EcFCa69F50F17f4e5947dC5dbE9B3aA4C).transfer(withdrawAmount_5);
