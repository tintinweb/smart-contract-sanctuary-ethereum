...
contract cLoUdDuDeS is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    function _CloudMint(uint256 _CloudsAmount) public payable nonReentrant {
        require(!IsMintingON, "Cloud minting paused");
        ...
        require(msg.value >= CloudPrice * _CloudsAmount, "Check the Cloud Price!");
        require(msg.value >= _CloudsAmount * CloudPrice, "ETH sent not correct");
