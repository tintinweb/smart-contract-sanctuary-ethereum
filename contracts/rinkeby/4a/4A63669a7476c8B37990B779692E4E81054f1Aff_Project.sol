...
contract Project is IERC721, Ownable, Functional {
    ...
    constructor() {
        ...
        price = 3 * (10 ** 15); // Replace leading value with price in finney
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Project.onERC721Received.selector;
    }
    ...
    function depositRewards() external payable onlyOwner {
        ...
        reserved.push( totalRewards / numberMinted );
        totalRewards -= (totalRewards % numberMinted ); //Prevent remainders from accumulating.
        distroCount++;
    }
