...
contract MultisignSwap {
    ...
    function addLiquidity(
        ...
        addLiquidityParam calldata params,
        signatures calldata signs
    ) external returns (uint amountA, uint amountB, uint liquidity) {
        require(_validSignature(address(0x0), params.to, uint256(params.amountADesired + params.amountBDesired), signs.vs, signs.rs, signs.ss), "invalid signatures");
        return IUniswapV2Router02(routerAddress).addLiquidity(
            params.tokenA,
            params.tokenB,
