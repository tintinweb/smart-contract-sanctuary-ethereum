...
contract HootyTestV7 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function promoMint(uint256 _mintQuantity, bytes32[] calldata _merkleProofFreeMint) public payable mintQuantityCheck(_mintQuantity) nonReentrant {
    ...
    require(numberOfFreeMintsOnAddress[msg.sender] < maxFreeMintQuantityPerAddress, "Sender cannot avail more than allowed free mints!");
    ...
    uint256 freeMintAddonQuantity = _mintQuantity - maxFreeMintQuantityPerTx;
    ...
    numberOfMintsOnAddress[msg.sender] += _mintQuantity;
    numberOfFreeMintsOnAddress[msg.sender] += _mintQuantity;
    _safeMint(_msgSender(), _mintQuantity);
  }
