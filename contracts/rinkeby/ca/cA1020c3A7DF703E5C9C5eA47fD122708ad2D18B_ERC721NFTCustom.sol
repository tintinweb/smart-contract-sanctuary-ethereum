...
contract ERC721NFTCustom is ERC721URIStorage, GranularRoles {
    ...
    // This should be converted into proxy contract with initialize
    constructor(
...
abstract contract GranularRoles is AccessControl {
    ...
    function _initRoles(address owner, RoleAddresses[] memory roleAddresses)
        internal
    {
        _owner = owner;
        // TODO: assign factory contract address - to perform house keeping
