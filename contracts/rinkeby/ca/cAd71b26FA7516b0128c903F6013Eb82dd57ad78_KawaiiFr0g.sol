...
// File: contracts/Kawaiifr0g_lowgas.sol
...
contract KawaiiFr0g is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("KawaiiFr0g","KF") {
    setHiddenMetadataUri("ipfs://QmZgBqQArCJSCzyEL5uUpSwM7LcoRmpV9B3kV14rHkkpZ7/hidden_metadata.json");
  }
