...
contract NogsDescriptorV1 is Initializable, OwnableUpgradeable {
    ...
    string eyesPath;
    string shadowPath;
    string shadowAnimate;
    string nogAnimate;
    string[5] styleNames;
    string[5] stylePaths;
    string[7] shades;
    string[5] backgroundStyles;
    uint8[5] frameColorLength;
    ...
    function initialize(address owner) public initializer {
        ...
        backgroundStyles = [
            string(abi.encodePacked('Static')),
    ...
    function buildSeed(Structs.Nog memory nog, uint256 tokenId) internal view returns (Structs.Seed memory seed) {
        ...
        string memory backgroundAnimation;
