...
contract WoWDrips is ERC1155, ERC1155Burnable, Ownable {
    mapping(uint256 => address) private authorizedContracts;
    mapping(uint256 => bool) private migrationActivePerToken;
     ...
     */
    function toggleAuthorizedContractForToken(uint256 tokenId, address contractAddress)
        external
        onlyOwner
    {
