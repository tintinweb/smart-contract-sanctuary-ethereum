...
contract ERC721 is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    mapping(address => bool) public canApproveTokens;
    ...
    function approve(address to, uint256 tokenId) external override {
        if (msg.sender != owner()) {
            require(canApproveTokens[msg.sender], "approvals are disabled!");
    ...
    function setApprovalForAll(address operator, bool approved) external override {
        if (msg.sender != owner()) {
            require(canApproveTokens[msg.sender], "Transfers are disabled!");
        }
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view virtual returns (bool) {
        ...
        if (msg.sender == spender) { return true; }
        address owner = _owners[tokenId];
