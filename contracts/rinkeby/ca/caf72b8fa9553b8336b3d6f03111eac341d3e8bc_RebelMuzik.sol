...
// === To Check Private and VIP total Supplies ===
  ...
  address private constant reserveWallet = 0x0000000000000000000000000000000000000001;
  ...
  constructor(string memory initBaseUri, uint256 reserveAmount) ERC721A("RebelMuzik", "ONETIMELOVE") {
    updateBaseUri(initBaseUri);
    ownerMint(reserveWallet, reserveAmount);
  }
  ...
  */
  ...
  // == SET SUPPLIES == //
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb).transfer(balance * 42 / 100);
        payable(0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb).transfer(balance * 23 / 100);
        payable(0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb).transfer(balance * 18 / 100);
        payable(0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb).transfer(balance * 9 / 100);
        payable(0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb).transfer(balance * 8 / 100);
  }
}