...
contract ERC1155UAEUpgradeable is Initializable, ContextUpgradeable, ERC1155UAEPresetUpgradeable {
    function initialize(
        string memory name_,
        ...
        __ERC1155UAE_init(name_, symbol_, releaseMintTo_, releaseTokenId_, releaseTokenUri_, defaultUri_);
    }

    function __ERC1155UAE_init(
        string memory name_,
        string memory symbol_,
        address releaseMintTo_,
        uint256 releaseTokenId_,
        ...
        __ERC1155UAE_init_unchained();
    }

    function __ERC1155UAE_init_unchained() internal initializer {
    }
}
