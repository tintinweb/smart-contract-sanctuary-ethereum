...
contract splitter is AccessControl {
    ...
    function setPortion(uint8[] memory newPortion) external payable onlyRole(ADMIN_ROLE) {
    ...
    function setWallet(address newWallet, uint256 user) external payable onlyRole(ADMIN_ROLE) {
