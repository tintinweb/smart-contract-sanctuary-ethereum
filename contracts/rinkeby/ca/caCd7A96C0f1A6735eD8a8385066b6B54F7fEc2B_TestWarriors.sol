...
// File: contracts/WWC.sol

//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;


contract TestWarriors is Ownable, PublicSales, PreSales, WhiteList, ERC721A, PaymentSplitter {
    ...
    uint256 public constant PRESALES_MAX_QTY = 2222;
    ...
    address[] private addressList = [0xD5cB70f89b90D6D494051C9ee5e1FCfF25D23490];
    ...
    constructor(string memory _notRevealedUri) ERC721A("TestWarriors", "WWC") PaymentSplitter(addressList, shareList) {
