...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
     ...
     *0xDA1DFF59329dfA897377Fd20f2259ed7F78Ae7bE
...
function char(bytes1 b) internal pure returns (bytes1 c) {
    ...
    function mintAndTransfer(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public override virtual {
        ...
        require(minter == sender || isApprovedForAll(minter, sender), toAsciiString(minter));
...
contract ERC1155 is ERC1155Base {
  ...
  ///  function safeTransferFrom(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public override {
   //     if (isPrivate){
