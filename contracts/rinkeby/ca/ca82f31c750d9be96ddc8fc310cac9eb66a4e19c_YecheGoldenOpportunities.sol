...
// File: contracts/YecheGoldenOpportunities.sol
...
contract YecheGoldenOpportunities is ERC721A, Ownable, ReentrancyGuard {  
    ...
    constructor() ERC721A("YecheGoldenOpportunities", "GOLDEN") {
    ...
    function checkWhitelist(uint256 artworkID, address user) public view returns (bool) {
        require(artworkInitialized[artworkID] == true, "artwork hasn't been initialized");
        IERC721 keyContract = IERC721(artworks[artworkID].keyAddress);
        bool hasKey = keyContract.balanceOf(user) > 0;
        return hasKey;
    }
    ...
    function mint(uint256 artworkID) public nonReentrant callerIsUser {
        require(artworkInitialized[artworkID] == true, "artwork hasn't been initialized");
        ...
        require(checkWhitelist(artworkID, msg.sender), "address not whitelisted");
    ...
    function gift(uint256 artworkID, address to) public onlyGifter {
        require(artworkInitialized[artworkID] == true, "artwork hasn't been initialized");
    ...
    function updateArtworkBaseURI(uint256 artworkID, string calldata newBaseURI) public onlyOwner {
        require(artworkInitialized[artworkID] == true, "artwork hasn't been initialized");
        require(artworks[artworkID].baseURILocked == false, "artwork base URI is locked");
        artworks[artworkID].baseURI = newBaseURI;
    }

    function lockArtworkBaseURI(uint256 artworkID) public onlyOwner {
        require(artworkInitialized[artworkID] == true, "artwork hasn't been initialized");
        artworks[artworkID].baseURILocked = true;
    }

    function updateArtworkKeyAddress(uint256 artworkID, address newKeyAddress) public onlyOwner {
        require(artworkInitialized[artworkID] == true, "artwork hasn't been initialized");
        artworks[artworkID].keyAddress = newKeyAddress;
    }

    function setupArtwork(uint256 maxSupply, address keyAddress, string calldata baseURI) public onlyOwner {
