...
contract MetaGods is ERC721Enum, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public perClaimTxnLimit = 50;
    ...
    function mintWithPass(uint256 _mintAmount) external payable {
        ...
        uint256 availablePaidMints = maxPassHolderPaidMints - mintedWithPassByAddress[msg.sender];
        ...
        require(_mintAmount <= availableFreeMints + availablePaidMints, "TOO MANY");
        require(_mintAmount <= availableFreeMints || (msg.value >= cost * (_mintAmount - availableFreeMints)), "NOT ENOUGH");

        mintedWithPassByAddress[msg.sender] += _mintAmount;
    ...
    function setMaxPassHolderPaidMints(uint256 _maxPassHolderPaidMints) public onlyOwner {
        maxPassHolderPaidMints = _maxPassHolderPaidMints;
    }
