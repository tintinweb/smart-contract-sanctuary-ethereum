...
contract ERC721BatchTransfer is Ownable,  ERC721Holder {
  ...
  function batchTransfer(ERC721Partial tokenContract, address[] calldata recipients, uint256[] calldata tokenIds) external onlyOwner {
    require(tokenIds.length == recipients.length, "tokenIds and recipients length mismatch");
