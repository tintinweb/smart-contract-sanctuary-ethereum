...
contract PxGoblinFeast is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("PxGoblinFeast", "PxGoblinFeast"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Minting PxGoblins");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"Not enough Eth");
