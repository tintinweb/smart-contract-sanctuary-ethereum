...
contract NFT is ERC721A, Ownable {
    ...
    uint256 public constant MAX_TOKENS_PER_TX = 3;
    uint256 public constant MAXFREEMINTS = 3;
    ...
    function mint(uint256 _quantity) external payable {
        ...
        require(FreeMintsPerAddress[msg.sender] + _quantity <= MAXFREEMINTS
            , "Nom Nom Sharks: max 3 mints per address exceeded");
        FreeMintsPerAddress[msg.sender] += _quantity;
