    ...
    ReentrancyGuard
{
    ...
    /// @dev === Stats ===
    uint256 public BluePassIndex = 301;
    uint256 public OGPassIndex = 0;
        ...
        nonReentrant
    {
        ...
        _setCurrentIndex(BluePassIndex);
        _mint(msg.sender, numberOfTokens);
        BluePassIndex += numberOfTokens;
    }
    ...
    function totalMinted() public view returns (uint256) {
        return OGPassIndex + BluePassIndex - 301;
    }
