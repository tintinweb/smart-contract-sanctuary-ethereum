...
contract smileyNft is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Smiley Collectible", "SMILEY") {
        setBaseURI(baseURI);
    }
    ...
    // function mintWhitelist(uint num) public view isWhitelisted(msg.sender) returns(bool){
    //   mintNFTs(num);
    // }
    ...
    function mintNFTs(uint num) public payable {
        ...
        if(presale) {
            require(whitelistedAddresses[msg.sender], "You are not in whitelist");
        }
