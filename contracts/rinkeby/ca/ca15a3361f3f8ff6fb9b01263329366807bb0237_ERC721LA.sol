...
contract ERC721LA is IERC721LA, Initializable, AccessControl {
        ...
        returns (uint256)
    {
        ...
        uint firsTokenId = editionedTokenId(state._editionCounter, 1);
     ...
     *
     */
    function createAndMintEdition(string calldata _baseURI, uint256 _maxSupply, address _recipient)
        external
        onlyMinter
    {
    ...
    function updateEdition(
        ...
        emit EditionUpdated(address(this), editionId, edition.maxSupply, _baseURI);
    }
    ...
    {
        ERC721LAState storage state = _getERC721LAState();
        return state._royaltyRegistry.royaltyInfo(address(this), _tokenId, _value);
    }
