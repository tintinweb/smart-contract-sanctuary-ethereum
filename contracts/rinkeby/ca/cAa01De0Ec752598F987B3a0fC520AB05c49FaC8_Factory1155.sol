...
import "./RustNFTUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new RustNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        RustNFTUser1155Token token = RustNFTUser1155Token(address(addr));
...
contract RustNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
