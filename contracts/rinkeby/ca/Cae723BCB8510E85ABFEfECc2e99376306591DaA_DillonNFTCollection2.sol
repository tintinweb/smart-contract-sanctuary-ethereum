...
contract DillonNFTCollection2 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxItemsPerWhiteListedWallet = 2;
    ...
    address public _NFT1CollectionAddress;

    // ===== Constructor =====
    
    constructor(string memory name_, string memory symbol_, address rewardWalletAddress_, address devWalletAddress_, address ownerWalletAddress_) 
    ERC721A(name_, symbol_) {
        // baseTokenURI = baseTokenURI_;
        baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmdYuCgUa5qmbKm2qCK5WPGdo2k4p4iXN135DGnrypRZHT/';
        rewardWalletAddress  = rewardWalletAddress_;
    ...
    function whitelistMint(bytes32[] memory proof,uint256 amount) external onlySender nonReentrant {
        ...
        require(
            whitelistMintedAmount[msg.sender] + amount <= NFTHelper(_NFT1CollectionAddress).balanceOf(msg.sender),
    ...
    function publicMint() external payable onlySender nonReentrant {
        ...
        payable(rewardWalletAddress ).transfer((msg.value.mul(10)).div(100));
    ...
    function updateNFT1CollectionAddress (address nft1CollectionAddress_) external onlyOwner {
        _NFT1CollectionAddress  = nft1CollectionAddress_;
    }

    function updateRewardWalletAddress (address rewardWalletAddress_) external onlyOwner {
        rewardWalletAddress  = rewardWalletAddress_;
    }
