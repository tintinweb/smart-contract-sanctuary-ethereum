...
contract TestFalseC is ERC721A, Ownable {
  // general
  ...
  constructor() payable ERC721A('TestFalseC', 'TESTFALSEC') {
    maxSupply = 6942;
    maxPerTxnAllowlist = 5;
    maxPerWalletAllowlist = 5;
    maxPerTxnPublic = 100;
    maxPerWalletPublic = 100;
    mainWallet = payable(address(0xa996C36aB899ae37e151Fd7B6367eccF906dBF9b));
  }
