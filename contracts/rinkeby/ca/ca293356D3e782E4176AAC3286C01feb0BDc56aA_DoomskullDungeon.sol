...
contract DoomskullDungeon is SkullDungeon {
    ...
    constructor(address signer, string memory baseURI) SkullDungeon(signer, baseURI) {
...
// TODO: VRF
// TODO: Opensea (https://docs.opensea.io/docs/metadata-standards)
//       https://blog.chain.link/build-deploy-and-sell-your-own-dynamic-nft/

contract SkullDungeon is ERC721, Pausable, Ownable, ReentrancyGuard {
    ...
    constructor(address signer, string memory baseURI) ERC721("Skull Dungeon", "SXD") {
