...
contract EscrowClone is ReentrancyGuard, Initializable {
    ...
    function withdrawETH(uint256 withdrawAmount) onlyFreeflowOrClient nonReentrant public {
        require(address(this).balance <= withdrawAmount, "Not that much ETH in the contract");
