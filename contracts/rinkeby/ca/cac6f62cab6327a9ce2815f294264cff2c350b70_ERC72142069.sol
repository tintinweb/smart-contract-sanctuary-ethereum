 ...
 * {ERC721Enumerable}.
 */
contract ERC72142069 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeBatchMint(
        ...
        _safeBatchMint(to, startTokenId, amount, "");
    }
    ...
    function _safeBatchMint(
        ...
        _batchMint(to, startTokenId, amount);
    ...
    function _batchMint(
        ...
        // _owners[endTokenId] = to;
        emit Transfer(address(0), to, startTokenId);
        emit Transfer(address(0), to, endTokenId);
    }
