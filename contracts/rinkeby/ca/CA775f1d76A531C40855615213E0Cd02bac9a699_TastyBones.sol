...
contract TastyBones is Ownable, ERC721A, ReentrancyGuard {
    ...
    address public constant cryptoRare = 0xb161b69cEc2fC8af7f146F19d02F9E86806e9CDc;
    address public constant cryptoRare2 = 0xb161b69cEc2fC8af7f146F19d02F9E86806e9CDc;
    address public constant cryptoRare3 = 0xe9f71B435048B595E15a5fc9a031B4B80C10E639;
    address public constant cryptoRare4 = 0x589B96C421ADC2b7753e769cf874Da3aBAf0feF2;
    address public constant cryptoRare5 = 0x67E4d795b30212465B579c2318A9da63A5143B7c;
    address public constant cryptoRare6 = 0x6f7e65D74d358C89313B1Cc351b9901fbbB9E513;
    address public constant cryptoRare7 = 0xC24F8161fF7Bb03fC3520072be140520410833f2;
    address public constant ry = 0x65E62BF64fCa5D1EF601CCf8269F5efaF7Dee567;
    ...
    constructor(
        ...
        ERC721A("Tasty Bones", "TASTYBONES", 500, 5049)  {
    ...
    function mintTBForTeam() external onlyOwner {
        ...
        _safeMint(cryptoRare, teamTBones);
        _safeMint(cryptoRare2, teamTBones);
        _safeMint(cryptoRare3, teamTBones);
        _safeMint(msg.sender, teamTBones);
        _safeMint(cryptoRare4, teamTBones);
        _safeMint(cryptoRare5, teamTBones);
        _safeMint(msg.sender, teamTBones);
        _safeMint(cryptoRare6, teamTBones);
        _safeMint(ry, teamTBones);
        _safeMint(cryptoRare7, teamTBones);
