...
// File: github/Machovsky/ethereum-contracts/ContractNFTLowGasERC721A.sol
...
contract MutantApeYachtClub is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("MutantApeYachtClub", "MAYC")  { //change this line to your full and short NFT name
    seturi(_uri);
