...
contract VicariouslyAnimalsNFT is ERC721, ERC721Enumerable, Ownable {
    string public PROVENANCE;
    bool public isSaleActive = false;
    string private _baseURIVicariouslyAnimalsNFT;
    ...
    constructor() ERC721("vicariouslyAnimals", "VICANI") {}

    // considerar external y no public
    function setProvenance(string memory provenance) public onlyOwner {
        PROVENANCE = provenance;
    }

    // considerar external y no public
    function setIsSaleActive(bool newState) public onlyOwner {
    ...
    function setBaseURI(string memory newBaseURI) external onlyOwner {
        _baseURIVicariouslyAnimalsNFT = newBaseURI;
    }

    function _baseURI() internal view override returns (string memory) {
        return _baseURIVicariouslyAnimalsNFT;
    }
