    ...
    UUPSUpgradeable
{
    ...
    uint256 public dutchAuctionsStartPrice; // in Gwei
    uint256 public dutchAuctionsReservePrice; // in Gwei
    uint256 public dutchAuctionsDecreaseAmount; // in Gwei
    ...
    function setDutchAuction(
        uint256 _startPrice, // gwei
        uint256 _reservePrice, // gwei
        uint256 _decreaseAmount, // gwei
    ...
    function dutchAuctionsNextDecrease() external view returns (uint256) {
        uint256 price = dutchAuctionsCurrentPrice();
