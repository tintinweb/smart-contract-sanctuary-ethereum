    ...
    INFTAuctionsFeature
{
    ...
    function acceptBid(
        ...
        _acceptBid(enBid.auction.maker, msg.sender, enBid, auctionSig, bidSig, unwrapNativeToken);
    }
    ...
    function _onNFTReceived(        
        ...
        _acceptBid(address(this), operator, enBid, auctionSig, bidSig, unwrapNativeToken);
    }
