// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"Blocked HeadsOnChain", unicode"Pixelated BlockedHeads On Chain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/6fc324f6-3971-4358-b58f-d3236a31d1fc", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/6fc324f6-3971-4358-b58f-d3236a31d1fc", "", 500, "0xf8Df47772a7FDEd068a44e5c0e292840211Dd590");

        constructor() ERC721A(unicode"Blocked HeadsOnChain", unicode"BHOC") {
...
TIERS[7] = [49,100,200,200,200,200,220,251,300,300,400];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Blocked HeadsOnChain #");
