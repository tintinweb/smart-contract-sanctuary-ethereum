...
contract HelloWorld is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://enterbaseURIhere/"; //end with /
    string public contractURI = "ipfs://entercontractURIhere"; //do not end with /
    ...
    constructor() ERC721A("HelloWorld v2", "HWV2") {}
