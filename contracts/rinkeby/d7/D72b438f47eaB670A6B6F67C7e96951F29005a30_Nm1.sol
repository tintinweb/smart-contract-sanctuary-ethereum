...
contract Nm1 is Context, ERC721, Ownable {

    uint maxNbr = 341;
    uint counterId = 0;
    event Mint(address buyer, uint256 price, uint256 [] tokenIds);

    constructor() ERC721("nm1", "nm1") {}
    ...
    function contractURI() public pure returns (string memory){
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "nm1", "description": "nm1"}'))));
