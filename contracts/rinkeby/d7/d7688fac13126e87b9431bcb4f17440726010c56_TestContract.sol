...
contract TestContract is ERC1155, Ownable {
    ...
    /*///////////////////////////////////////////////////////////////
                            TOKEN DATA
    //////////////////////////////////////////////////////////////*/
    uint256 public immutable blackMaxSupply = 16;
    uint256 public immutable generalMaxSupply = 33;
    uint256 public immutable blackScholarshipTotal = 2;
    uint256 public immutable generalScholarshipTotal = 3;

    uint256 public immutable blackPrice = 0.0075 ether;
    uint256 public immutable generalPrice = 0.0015 ether;
    ...
    function mintBlack() external payable {
        ...
        require(blackMinted[msg.sender] < 2, "CCC2: you can only mint 5.");
    ...
    function mintGeneral() external payable {
        ...
        require(generalMinted[msg.sender] < 2, "CCC2: You can only mint 5.");
