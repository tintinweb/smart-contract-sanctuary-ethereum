...
//=================================PUBLIC FUNCTIONS================================//
  function redeem(address _address) public {
    ...
    safeTransferFrom(_address, 0x000000000000000000000000000000000000dEaD, tokensFromAddress[0]);
    bytes memory payload = abi.encodeWithSignature("redeemNFT(address[],uint256)", addressArray,tokensFromAddress[0]);
