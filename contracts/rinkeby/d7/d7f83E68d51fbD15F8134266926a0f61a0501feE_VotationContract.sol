...
contract VotationContract is Ownable {
    ...
    address public governanceTokenAddress =
        0xf1Ada2cCbb76Fd2E2EcA5199D41a80AcC6DdF797;
    ...
    function voting_start() public onlyOwner {
        ...
        require(
            proposalTime + 60 seconds < block.timestamp,
    ...
    function approveProposal() public {
        require(
            state_voting == Voting_state.Open,
            "Las votaciones aun no se han abierto"
        );
        ...
        require(alreadyVoted == false, "No se puede votar mas de 1 vez");
    ...
    function closeVotation() public onlyOwner {
        require(
            votationStartTime + 60 seconds < block.timestamp,
            "Aun no ha transcurrido el tiempo necesario para concluir la votacion"
        );
        state_voting = Voting_state.Closed;
    }

    function voters_length() public view returns (uint256) {
        return voters.length;
    }

    function whiteList_length() public view returns (uint256) {
