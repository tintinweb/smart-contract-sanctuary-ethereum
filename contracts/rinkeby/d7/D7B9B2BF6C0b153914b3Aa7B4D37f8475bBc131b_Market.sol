...
contract Market is IMarket {
    ...
    mapping(uint256 => uint) private _tokenAsksCount;
...
contract Media is IMedia, ReentrancyGuard, Ownable, ERC721Burnable,  ERC721URIStorage, ERC721Enumerable {
    ...
    address public tokenContract;
    uint256 public price = 1000000000000000000; // 0.05 ETH
     ...
     */
    constructor(address marketContractAddr, address tokenContractAddr, string memory baseURI) ERC721("HoodieChicken", "HoodieChicken") {
        setBaseURI(baseURI);
        ...
        nonReentrant
    {
        ...
        IERC20(tokenContract).transferFrom(msg.sender, address(this), price * quantity);
        
        for (uint256 i = 0; i < quantity; i++) {
            _mintForCreator(msg.sender);
        }
    }
