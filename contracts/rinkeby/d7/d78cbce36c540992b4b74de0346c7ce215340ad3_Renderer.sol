...
contract Renderer {
    ...
    address[13] public ethersAddresses;
    ...
    function setEthersAddressFirstHalf(
        address chunk1,
        address chunk2,
        address chunk3,
        address chunk4,
    ...
    function setEthersAddressSecondHalf(
        address chunk7,
        address chunk8,
        address chunk9,
        address chunk10,
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        ...
        address[] memory ethers = new address[](13);
        ethers[0] = ethersAddresses[0];
        ethers[1] = ethersAddresses[1];
        ethers[2] = ethersAddresses[2];
        ethers[3] = ethersAddresses[3];
        ethers[4] = ethersAddresses[4];
        ethers[5] = ethersAddresses[5];
        ethers[6] = ethersAddresses[6];
        ethers[7] = ethersAddresses[7];
        ethers[8] = ethersAddresses[8];
        ethers[9] = ethersAddresses[9];
        ethers[10] = ethersAddresses[10];
        ethers[11] = ethersAddresses[11];
        ethers[12] = ethersAddresses[12];
        string memory ethersString = compiler.compileN(ethers);
