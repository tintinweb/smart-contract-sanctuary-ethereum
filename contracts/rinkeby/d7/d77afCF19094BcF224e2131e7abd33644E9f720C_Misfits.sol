...
They call us misfits, they say we don't belong....
...
contract Misfits is ERC721A, EIP712, Ownable {
  ...
  uint256 public MAX_SUPPLY = 233;
  uint256 public FREE_SUPPLY = 33;
  uint256 public TEAM_SUPPLY = 30;
  ...
  function whitelistmint( bytes calldata _signature, uint256 _nftIndex, uint256 _quantity ) external payable  mintCompliance() {
    ...
    require( _mintedAmount + _quantity <= (MaxPerWalletWL + 1), "MAX PER WALLET REACHED" );
  ...
  function publicMint( uint256 _quantity ) external payable mintCompliance() {
    ...
    require( msg.value >= mintFee * _quantity, "INSUFFICIENT BALANCE" );
    uint256 _PublicmintedAmount = PublicmintedAmount[ msg.sender ];
    require( _PublicmintedAmount + _quantity + mintedAmount[ msg.sender ] <= MaxPerWallet, "MAX PER WALLET REACHED" );
    _safeMint( msg.sender, _quantity );
    PublicmintedAmount[ msg.sender ] = _PublicmintedAmount + _quantity;
  }
  ...
  // RETURN TOKEN URL WITH REVEAL FUNCTIONS
