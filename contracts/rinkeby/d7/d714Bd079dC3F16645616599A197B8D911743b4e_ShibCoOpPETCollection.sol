...
contract ShibCoOpPETCollection is ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    address public constant ownerAddress = 0x8cA04fF5b207E4D8F5Ba61111DF3339337BBdb29;
    ...
    function initialize() public initializer {
        ...
        __ERC721_init("Plot Encryption Token", "PLOT");
        __Ownable_init();
        ...
        _mintLimit = 0;
        PRICE = 0.002 ether;
        contractMetaUri = "ipfs://QmbooPMoPgbokYxde5Pr7kWYUxLfp6SWG4QfPgfAE2penE";
    ...
    modifier saleIsLive {
        if (_msgSender() != owner()) {
            require(saleLive == true, "Sale Not Active");
        }

        _;
    }

    modifier contractEditable {
        require(frozen == false, "Contract Is Frozen");
    ...
    function presaleMint(address _to) public payable qtyAvailable(1) {
        require(_presaleList[_to], 'No Role');

        _presaleList[_to] = false;
        _mintAnElement(_to);
    }

    function mint(address _to) public payable saleIsLive qtyAvailable(1) {
        require(msg.value >= price(1), "NSF");
    ...
    function setContractPrivateValue(string memory varName, string memory varValue) public onlyOwner contractEditable {
    ...
    function toggleSale() public onlyOwner contractEditable{
        saleLive = !saleLive;
    }
