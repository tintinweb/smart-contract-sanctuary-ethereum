...
contract SnackShopFounders is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC1155_init("ipfs://Qmay832qrNwXUZPgJBUvq83mNLx7MS6JttGPzrNHbR7jrz/metadata/{id}.json");
    ...
    function foundersMint() public payable {
        require(publicSaleStatus == true, "Sale Not Active");
        require (availableTokens.length > 0, "Sold Out");
        require (msg.value >= founders_salePrice, "Insufficent ETH");
    ...
    function getRandomId () internal returns (uint tokenId) {
        uint256 randomNumber = uint256 (keccak256(abi.encodePacked(msg.sender, block.timestamp, block.difficulty, block.number-1, seed)));
        seed = randomNumber;
