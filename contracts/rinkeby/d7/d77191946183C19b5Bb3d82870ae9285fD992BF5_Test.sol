...
contract Test is Ownable, ERC721A, ERC2981, ReentrancyGuard {

    uint96 public ROYALTY_PERCENTAGE = 600;

    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_TX_PER_WALLET = 5;
    uint256 public SALE_PRICE = 0.003 ether;

    bool public IS_SALE_ACTIVE = false;
    string internal baseURI = "";

    address public constant  _add = 0x836DD6C8fFe6F42C4E07bB2c63c38a29788f8EFE;
    ...
    //Test
    function getTokenIds(uint256 quantity)  public view returns (uint256[] memory){
    quantity;
    uint256 _tokenCount = IERC721Enumerable(_add).balanceOf(msg.sender);
    uint256[] memory _tokens = new uint256[](_tokenCount);
    
        for(uint256 i=0; i < _tokenCount; i++){
         _tokens[i] = (IERC721Enumerable(_add).tokenOfOwnerByIndex(msg.sender, i));
       }
    ...
    function getNumberMinted(address addr) external view virtual returns (uint256){
