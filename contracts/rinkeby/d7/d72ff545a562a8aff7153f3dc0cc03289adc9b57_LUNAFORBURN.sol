...
Had the time in your life when you basically scammed yourself?
Got into a scam, bought at the top, or even BOUGHT LUNA?

Well, it's time to get your liq back. EVERY buy/sell transaction will be burning 2/4% of fees from pool.

Don't get scared about our minimal liquidity - it's for you, early believers to take your places cheap.
First liquidity pool creation - 100$ with 4.5m tokens, 24-36hrs later 2k$ more will be added to liquidity and locked for a week.
BUY YOUR SPOT BEFORE OUR GROWTH BEGINS


LIMITED BUYS BECAUSE OF LOW LIQUIDITY (WILL BE INCREASED WITH SECOND LIQUIDITY TOP-UP)
MAX BUY - 6% ; MAX WALLET 9% - FOR 24hrs
Taxes - 2/4% for burning(2% at buy, 4% at sell), 1% for liquidity(Only when selling), 1% for reflections to holders(Only when selling), 4% for marketing.
TELEGRAM AT 30 HOLDERS. THEN STUFF FOR COMMUNITY.
*/
...
contract LUNAFORBURN is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xb890a0870645A9713c7B55E582a061B329d7a08A));
    address private _burnAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "LUNA FOR BURN";
    string private _symbol = "$L4B";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(60); //6%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(30); //3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(90); // 9%
