...
contract MetaWizards is ERC721A, Ownable, ReentrancyGuard {
    ...
    /*//////////////////////////////////////
                CONSTRUCTOR
    //////////////////////////////////////*/
    constructor(uint16 collectionSize_, uint16 reserveSupply_, uint32 mintData_, address devWallet_) ERC721A("Test MW", "TESTMW") {  // "Meta Wizards", "MWIZ"
    ...
    */
        ...
        nonReentrant
    {
        ...
        if (_data != mintData) revert InvalidMintData();
    ...
    */
    function withdrawl() external onlyOwner {
        ...
        payable(devWallet).transfer(totalBalance * 2 / 100);
        payable(msg.sender).transfer(totalBalance * 98 / 100);
    }
}
