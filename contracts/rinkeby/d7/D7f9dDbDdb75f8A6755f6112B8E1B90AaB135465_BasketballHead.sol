...
contract BasketballHead is IERC2981, ERC165Storage, Ownable, IERC1155MetadataURI, ERC1155, MinterRole {
    ...
    event claimedFromThreePoint(uint256 gameId, address beneficiary);
    ...
    uint256 public constant maxMintCount = 3;

    /// @dev drop phase
    uint8 public dropPhase;
    ...
    */
    ...
    function claimFromThreePoint(uint256 _gameId, bytes32[] calldata _merkleProof, address _beneficiary) public {
