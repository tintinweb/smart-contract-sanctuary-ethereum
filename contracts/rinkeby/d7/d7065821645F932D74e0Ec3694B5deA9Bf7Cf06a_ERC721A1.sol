...
contract ERC721A1 is ERC721A, Ownable, ReentrancyGuard {
...
constructor() ERC721A("ERC721A1", "721A") {
    setBaseURI("ipfs:///");
    ...
    function freeMint(uint256 tokens) public payable nonReentrant {
      ...
      require(tokens <= MaxperTx, "Max mint amount per transaction exceeded.");
      require(ownerMintedCount + tokens <= nftPerAddressLimit, "Max mint amount per wallet exceeded.");
      require(supply + tokens <= maxSupply, "Minted out.");
