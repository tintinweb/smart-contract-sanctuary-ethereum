...
contract InMySkin is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("AWE:In My Skin","SKIN", MaxMintPerBatch_, TotalCollectionSize_) {
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmYSgBB3jvofvmaKrEk2oiDK6AagboDNiy9KMHLvMkfdoc/";
