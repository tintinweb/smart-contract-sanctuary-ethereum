...
contract PlatziPunksDNA {
    ...
    //esta funcion pseudorandom es determinista y no debe ser usado
    //en produccion
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
          ...
          returns(string memory)
    {
        ...
        "ERC721 Metadata: URI qeury for nonexistent token");
    ...
    //Funciones necesarias para a├▒adir el enumerable
