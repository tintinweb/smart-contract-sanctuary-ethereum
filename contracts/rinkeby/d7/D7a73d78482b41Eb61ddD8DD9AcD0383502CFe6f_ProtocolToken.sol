...
contract ProtocolToken is ERC20Votes, Ownable {
    ...
    uint256 public constant timeInterval = 31557600;
    ...
    constructor(string memory _name, string memory _symbol) ERC20(_name, _symbol) ERC20Permit(_name) {
        supplyIncreaseTimestamp = block.timestamp + timeInterval * 3;
    }
    ...
    function setMaxSupply(uint224 _maxTokenSupply) external onlyOwner {
        ...
        supplyIncreaseTimestamp += timeInterval;
    }
