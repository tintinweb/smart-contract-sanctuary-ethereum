...
contract Testttt is ERC20, Ownable {
    ...
    function swapBack() private lockTheSwap {
        if (
            ...
            (balanceOf(address(this)) < _liquidityTokensToSwap &&
                _liquidityTokensToSwap > currentLP / 100)
        ) {
            return;
        }
        uint256 swapBackAmount = currentLP / 100;
        uint256 tokensForLiquidity = swapBackAmount / 2;
        ...
        _liquidityTokensToSwap -= swapBackAmount;
    }
