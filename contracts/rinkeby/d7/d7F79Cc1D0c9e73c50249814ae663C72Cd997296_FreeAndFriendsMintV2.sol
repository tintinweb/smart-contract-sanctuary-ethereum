...
contract FreeAndFriendsMintV2 is Ownable, Pausable {
    ...
    function friendsAndFreeETHWalkersMiamiMint(uint8 numberOfTokens, address originAddressRedeemed) external whenNotPaused {
        ...
        tempTest = ((ewalksMiami.balanceOf(_msgSender()) * 4) + (ewalksMintPass.balanceOf(_msgSender()) * 12));
        require(originAddressNumberMinted[originAddressRedeemed] <= tempTest, "Not enough left to claim");
