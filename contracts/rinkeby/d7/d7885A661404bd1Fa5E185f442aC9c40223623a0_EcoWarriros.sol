...
contract EcoWarriros is ERC721A, Ownable, ReentrancyGuard{
	...
	uint256 public WRLD_MAX = 5;
	uint256 public WRLD_PRICE = 1000 ether;
	uint256 public ETH_MAX = 5;
	...
	constructor(address _wrld_token, address[] memory _addresses, uint256[] memory _amount) ERC721A("EcoWarriros", "ECOW"){
