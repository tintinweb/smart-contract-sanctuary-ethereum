// "SPDX-License-Identifier: Polemarvel"
...
contract PokeDollarToken  is ERC20Burnable, Ownable, AccessControlEnumerable {
    ...
    constructor () ERC20("Poke dollar", "pUSD") {

        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(OPERATOR_ROLE, msg.sender);
        _mint(msg.sender, 50_000 ether); // 50.000 pUSD
        mintEnabled = true;
    }

    fallback () external payable {
        revert(); // Not allow sending ETH to this contract
    }
