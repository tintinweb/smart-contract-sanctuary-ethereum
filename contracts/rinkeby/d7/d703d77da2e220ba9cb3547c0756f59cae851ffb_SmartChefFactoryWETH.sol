...
// File: PyeSwap/PyeSwap_farming/contracts/SmartChefWETH.sol

pragma solidity ^0.8.0;

contract SmartChefWETH is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // The WETH token
    address public WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab; // mainnet: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2, rinkeby: 0xc778417E063141139Fce010982780140Aa0cD5Ab
    ...
    function depositWETH(uint256 _amount) external onlyOwner {
        ...
        IERC20(WETH).transferFrom(address(msg.sender), address(this), _amount);
    ...
    function distributeBounty(address keeper) internal {
        ...
        if(amount > 0){
            ...
            IERC20(WETH).transfer(keeper, amount);
...
// File: PyeSwap/PyeSwap_farming/contracts/SmartChefFactoryWETH.sol
...
contract SmartChefFactoryWETH is Ownable {
    event NewSmartChefWETHContract(address indexed smartChefWETH);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(SmartChefWETH).creationCode;
        ...
        SmartChefWETH(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewSmartChefWETHContract(smartChefAddress);
    }
}