...
contract GenesisExplorers is ERC721, Ownable, ReentrancyGuard {
    ...
    function price() public view returns (uint256){
        ...
        return totalSupply() < 1 ? 0 ether : 0.1 ether;
    }

    modifier canMintGenesisExplorer(uint256 _tokenId, uint256[3] memory _leTokenIds) {
    ...
    function mintGenesisExplorer(uint256 _tokenId, uint256[3] memory _leTokenIds)
        public
        payable
        nonReentrant
