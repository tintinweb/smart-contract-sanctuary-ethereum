...
contract KODAI is Ownable, ERC721 {
    
    uint public tokenPrice = 0.065 ether;
    uint constant maxSupply = 5050;
    uint public presale_price = 0.065 ether;
    ...
    uint public phase= 10;
    bytes32 public whitelistMerkleRoot;
  
         
    constructor() ERC721("KODAI NEW WORLD", "KNW"){}
   ...
   function buy_presale(uint _count, bytes32[] calldata merkleProof) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 45 / 100); 
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 18 / 100);
        payable(0x089C878C36C8Db6F58cfA8fD667d78d7Ec6Ac5D5).transfer(_balance * 20 / 100); 
        payable(0xeD947a0F9170DE48e347F657762199F7E2992110).transfer(_balance * 5 / 100); 
        payable(0xB064227e46E0E6cb087b242eF105b3CCF5f267BB).transfer(_balance * 8 / 100); 
        payable(0x6E817Fa17d4FA28367dd4b598201c1BaA37517Da).transfer(_balance * 4 / 100); 
