...
contract JAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNZ4QQDku6RyfY5XpXUB21tGftDR1TfDnU9RbkMM5syeJ";
    ...
    constructor(
    ) ERC721A("JAOa", "JAO", 100, maxSupply) {
    }
