...
contract Verifier is KeysWithPlonkVerifier, Config {
    ...
    function verifyAggregatedBlockProof(
        ...
        console.log("verifyAggregatedBlockProof hackInfo.length : ", hackInfo.length);
        console.log("verifyAggregatedBlockProof _recursiveInput.length : ", _recursiveInput.length);
...
contract Plonk4VerifierWithAccessToDNext {
    ...
    function batch_evaluate_lagrange_poly_out_of_domain(
        ...
        console.log("dens.length = ", dens.length);
    ...
    function verify_recursive(
        ...
        console.log("recursive_input : ", recursive_input);
        console.log("proof.input_values[0] : ", proof.input_values[0]);
...
contract VerifierWithDeserialize is Plonk4VerifierWithAccessToDNext {
    ...
    function verify_serialized_proof_with_recursion(
        ...
        console.log("vk.num_inputs ", vk.num_inputs);
        console.log("public_inputs.length ", public_inputs.length);
        require(vk.num_inputs == public_inputs.length);
