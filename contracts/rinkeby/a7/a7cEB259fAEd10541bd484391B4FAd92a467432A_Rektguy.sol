...
contract Rektguy is ERC721,Ownable,ReentrancyGuard{
    ...
    bytes32 private merkleRootOne =
        0x6fe67513a34093fd3074bb1062391bf2fe53c9edf9e5aa40ded7ed98db272cc4;

    bytes32 private merkleRootTwo =
        0x9c2ea6ae82ddca9b84463d7b3a128a1a5be0e5c72b606f213d82a03f3652d04c;
    ...
    */
    ...
    modifier restrictMint(uint256 numberOfTokens,bool _saleIsActive) {
        require(_saleIsActive, "minting is not open yet");
    ...
    function mintNFTPreSale(uint256 numberOfTokens, bytes32[] calldata _merkleProof) public nonReentrant() restrictMint(numberOfTokens,preSaleIsActive) {
        ...
        if(tokenBalancePerOwner[msg.sender]==0){
            tokenBalancePerOwner[msg.sender] = 0;
        }
