// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Top", unicode"Accessory", unicode"Ear Accessory", unicode"Nose", unicode"Eyes", unicode"Mouth", unicode"Beard", unicode"Clothing", unicode"Body", unicode"Background"];
        ...
        constructor() ERC721A(unicode"The Appraisoors", unicode"DN") {
            TIERS[0] = [7,8,13,14,16,17,17,17,19,19,33,38,39,39,40,50,75,100,100,100,100,100,100,100,100,100,100,100,100,100,110,129];
TIERS[1] = [7,9,28,30,32,87,108,114,117,119,119,120,127,139,165,177,187,315];
TIERS[2] = [18,72,75,153,158,271,561,692];
TIERS[3] = [77,78,194,307,439,441,464];
TIERS[4] = [19,47,60,61,176,194,227,237,264,715];
TIERS[5] = [60,102,190,260,500,888];
TIERS[6] = [158,356,525,961];
TIERS[7] = [35,71,99,115,121,139,184,247,487,502];
TIERS[8] = [40,80,160,600,1120];
TIERS[9] = [21,22,34,36,49,56,58,69,72,100,122,138,145,156,166,198,267,291];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"The Appraisoors #");
