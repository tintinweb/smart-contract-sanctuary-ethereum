...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        //latestRoundData by default is already 8 decimals
        uint256 adjustedPrice = uint256(price) * 10**10;
        uint256 entranceFeePerEth = (entranceFeeUSD * 10**18) / adjustedPrice;
        return entranceFeePerEth;
    }

    function startLottery() public onlyOwner {
        require(
            lottery_state == LOTTERY_STATE.CLOSED,
            "Lottery currently in progress"
        );
    ...
    //Chainlink node Receive TX will call rawFulfillRandomness, which internally calls fulfillRandomness
        ...
        override
    {
        ...
        require(_randomness > 0, "Not Randomized!");
