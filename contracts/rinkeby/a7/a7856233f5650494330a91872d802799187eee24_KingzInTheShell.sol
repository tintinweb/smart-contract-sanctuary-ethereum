...
contract KingzInTheShell is ERC721 {
    IERC721 internal immutable KAIJU;
    IScales internal immutable SCALES;

    constructor(address kaiju, address scales) ERC721("KITS", "KingzInTheShell") {
        KAIJU = IERC721(kaiju);
    ...
    /**
     * @notice Return the actual owner of a specified token regardless of staking status
     * @param tokenId Token to return the owner of
     * @return address Actual owner of the token
     */
