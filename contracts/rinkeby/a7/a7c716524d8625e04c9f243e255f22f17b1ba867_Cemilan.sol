...
contract Cemilan is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount, "You have reach max mint amount.");
    ...
    if (msg.sender != owner()) {
        ...
        require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "You can not have more than 2 NFTs.");
