...
contract AA_CreatedByNFTGM is GMERC721A {
    ...
    uint256[] _basisPoints  = [600, 200];


    constructor(
    ) GMERC721A(
        unicode"AA",
        unicode"1111111111111111111111111111111111111111111111111111111111111111",
        "https://api.nftgm.art/api/v1/nftgm/metadata/rinkeby/62f6071f70d6aa1bffdfa0e1/",
        10,
