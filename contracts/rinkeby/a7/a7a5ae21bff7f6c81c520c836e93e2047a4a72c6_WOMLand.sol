...
contract WOMLand is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        minttokenId(msg.sender, 15, 5);
        minttokenId(msg.sender, 35, 5);
        minttokenId(msg.sender, 45, 5);
        minttokenId(msg.sender, 60, 5);
    }
    ...
    function updateSupply(uint256 _tokenId, uint256 _mintAmount) internal {
        if(_tokenId < 15 && _mintAmount + _tokenId < 15) {
            setstandardSupply(standardSupply - _mintAmount);
        }
        if((24 < _tokenId && 24 < _tokenId + _mintAmount) && (_tokenId<35&& _tokenId + _mintAmount<35)) {
            setdeluxeSupply(deluxeSupply - _mintAmount);
        }
        if((44 <_tokenId && 44 <_tokenId + _mintAmount) && (_tokenId<45 && _tokenId + _mintAmount<45)) {
            setspecialSupply(specialSupply - _mintAmount);
        }
        if((59 <_tokenId && 59 <_tokenId + _mintAmount) && (_tokenId<60 && _tokenId + _mintAmount<60)) {
    ...
    function minttokenId(address _to, uint256 _tokenId, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            require((_tokenId < 15 && _mintAmount + _tokenId < 15) || ((24 < _tokenId && 24 < _tokenId + _mintAmount) && (_tokenId < 35 && _tokenId + _mintAmount < 35)) || ((44 <_tokenId && 44 <_tokenId + _mintAmount) && (_tokenId<44 && _tokenId + _mintAmount<44)) || ((45 < _tokenId && 45 < _tokenId + _mintAmount) && (_tokenId < 60 && _tokenId + _mintAmount < 60)), "reserved");
