...
//        ╓M▓▓▓▓▄Æ      ▀▓▓▓▀▓▌█▀▓▓▓▓▓▓▓▓▓▓▓▓▄▄▄, `¬  ª█▀▀▀▀╙       ╙^         ▄µ
//      ¬  ▄▄▄#▀ê╗,  "▀ ²▀▀▀▀▀▀Mm▓▓▓▀▀▓▀▀╙"∞╙▀▀▀▀ M*╨╙    ,,▄m#█▓▀è▄▄,  ▄▄,▄ª▓▌▀▓▓▄
// Skully Mint Pass 002 by tortuga
...
contract SkullyMintPass002 is ERC721, ReentrancyGuard, Ownable {
    ...
    constructor(string memory customBaseURI_) ERC721("SkullyMintPass002", "TUGAPASS2"){
    ...
    function mint() public payable nonReentrant {
        ...
        require(tokensMinted[_msgSender()] < 3, "Address already minted max number of mint passes");
