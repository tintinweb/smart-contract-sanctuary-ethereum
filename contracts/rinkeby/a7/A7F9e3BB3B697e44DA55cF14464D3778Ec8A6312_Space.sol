...
contract SpaceBatsUtility is ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        __ERC721_init("Space Bats Utility", "SBU");
...
contract Blackhole is IERC721ReceiverUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        // __ERC721_init("Blackhole", "BLK");
        stakeholders.push();
    }
    ...
    IERC721Upgradeable public spaceBatsUtilityToken;
    IERC20Upgradeable public spaceToken;

    function setSpaceBatsUtilityToken(IERC721Upgradeable _spaceBatsUtilityToken) public onlyOwner {
        spaceBatsUtilityToken = _spaceBatsUtilityToken;
    }

    function setSpaceToken(IERC20Upgradeable _spaceToken) public onlyOwner {
    ...
    * @notice Staked event is triggered whenever a user stakes tokens, address is indexed to make it filterable
    ...
    function unstakeNFT(uint256 tokenId, uint256 index) nonReentrant external {
        _unstakeNFT(tokenId, index);
    }

    function _unstakeNFT(uint256 tokenId, uint256 index) internal onlyStaker(tokenId) requireTimeElapsed(tokenId) returns (bool) {
