...
contract TrapMonkie is ERC721A, Ownable, ReentrancyGuard {
    ...
    function PremintGenesisMob(uint256 _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(isPremintOn(price, PremintTime),"Minting for Genesis/MOB has not yet begun.");
    ...
    */
    ...
    //ADDRESS LIST
    address FOUNDER_WALLET = 0x4cFD35c63CcB0748D0DA38F841af8eA3b20e6Bb3;
    address GNOSIS_VAULT = 0x2EB3862feBc6553CCCC1Da3d09b0F0559Cc80727;
    address MARKETING_WALLET = 0xFa92305d105eBb48Cec608ECe16f78eD1Fed47C2;
    address DEVELOPER_1_WALLET = 0xA8b9b71dB460d5d892d2C645B107E1e744c10Edb;
    address LEAD_ARTIST_WALLET = 0xbcc9FBDd86403E95573E6D59D1D4cB2fe8287DEe;
    address ARTIST_1_WALLET = 0x1d3F0fD48A61D30b4291F1DD7bDeC5442D0742f0;
    address ARTIST_2_WALLET = 0x4cFD35c63CcB0748D0DA38F841af8eA3b20e6Bb3;
    address DEVELOPER_B_WALLET = 0x4cFD35c63CcB0748D0DA38F841af8eA3b20e6Bb3;
