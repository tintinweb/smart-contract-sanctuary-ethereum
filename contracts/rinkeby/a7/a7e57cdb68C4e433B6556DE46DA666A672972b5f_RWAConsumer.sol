...
contract RWAConsumer is ChainlinkClient, Ownable {
    ...
    string public conclude_result;
    bytes32 public conclude_result_in_bytes32;
    bytes conclude_result_in_bytes;
     ...
     * Receive the response in the form of uint256
     */
    function conclude_response(bytes32 _requestId, string calldata _conclude_result) public recordChainlinkFulfillment(_requestId)
    {
        conclude_result = _conclude_result;
        conclude_result_in_bytes32 = bytes32(bytes(conclude_result));
        conclude_result_in_bytes =bytes(conclude_result);
