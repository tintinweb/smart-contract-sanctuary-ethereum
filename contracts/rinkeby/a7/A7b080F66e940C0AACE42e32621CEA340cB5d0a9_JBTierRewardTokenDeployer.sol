...
import './JBTierRewardToken.sol';
import './libraries/juice-nft-rewards/JBTieredLimitedNFTRewardDataSourceProjectDeployer.sol';
import './MeowGatewayUtil.sol';

contract JBTierRewardTokenDeployer {
  ...
  ) public returns (address newDatasource) {
    newDatasource = address(
      new JBTierRewardToken(
        _projectId,
        _directory,
        _name,
        _symbol,
