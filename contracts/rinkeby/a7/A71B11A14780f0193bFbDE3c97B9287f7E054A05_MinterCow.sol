...
// import "../node_modules/@divergencetech/ethier/contracts/erc721/ERC721ACommon.sol";
 ...
 * @dev Extends ERC721A
 */
contract MinterCow is ERC721A, AllowListSale, Ownable, AccessControlEnumerable {
    using ECDSA for bytes32;

    /**
    @notice Role of administrative users allowed to expel a Cows from the
    pasture.
    ...
    */
    function addSale(
        ...
        address signer) external onlyOwner {
    ...
    */
    function allowlistMint(uint256 quantity, bytes calldata saleKey, uint256 saleId) external payable {
    ...
    */
    function publicMint(uint256 quantity, uint256 saleId) external payable {
        require(totalSupply() + quantity <= COLLECTION_SIZE, "purchase would exceed max supply of Cows");
...
contract AllowListSale {
     ...
     */
    mapping(address => bool) public usedKeys;
    ...
    function verifySaleKey(bytes memory saleKey, uint256 saleId) internal virtual {
        ...
        require(sale.isPublicSale || 
                (!usedKeys[msg.sender] && checkSignature(sale.signer, msg.sender, saleKey)),
                "address with this key is not eligible to mint or saleKey has been already used");
        usedKeys[msg.sender] = true;
    }
