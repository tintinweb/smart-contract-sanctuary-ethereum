    ...
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmfAsxCydqZJsj8AKpRKdqPve52ypLNipvaK7wgHvKwEEc/hidden.json";
    ...
    uint256 _price = 10000000000000000; // 0.0001 ETH

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [40, 60]; // 2 PEOPLE IN THE TEAM
    address[] private _team = [
        0x3d53BB93F1894386e3b97B049b015829141b6904, // Admin Account gets 40% of the total revenue, brave metamask
        0xE88e6a225CbD6BfA015905DaE75E2aB1B38B4E1F // Test Account gets 60% of the total revenue, chrome metamask
        
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("BoredApe", "APEE")
    ...
    onlyAccounts
    {
        require(msg.sender == account,          "BA: Not allowed");
