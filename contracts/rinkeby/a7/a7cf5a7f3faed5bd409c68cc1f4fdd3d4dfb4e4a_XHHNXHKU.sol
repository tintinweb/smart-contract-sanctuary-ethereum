...
contract XHHNXHKU is ERC721A, Ownable {
    uint256 public constant PRICE = 0.0069 ether;
    uint256 public constant MAX_SUPPLY = 6969;
    uint256 public constant MAX_SALE_QUANTITY = 20;

    bool private active = false;
    bool private revealed = false;
    string private baseUri = "https://xhhnxhku.com/3b6rw18x44tt9qb3csp4cs8we1akhb/";
    uint96 private royaltyBasisPoints = 100;

    constructor() ERC721A("XHHNXHKU NFT", "XHHNXHKU") {}
    ...
    function mint(uint256 _quantity) external payable {
        require(active == true, "MINT_NOT_ACTIVE");
        require(_quantity > 0, "INCORRECT_QUANTITY");
        require(_quantity <= MAX_SALE_QUANTITY, "INCORRECT_QUANTITY");
