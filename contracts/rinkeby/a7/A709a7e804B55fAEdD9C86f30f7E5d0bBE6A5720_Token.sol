...
contract Token is Ownable, Pausable {
    ...
    address[] public mps;
    address island1Contract =
        address(0x88B48F654c30e99bc2e4A1559b4Dcf1aD93FA656);
    address island2Contract =
        address(0x9B98a64D65F5e18AA8b44aFC7976C14f1B8A77D8);
    ...
    IGPC islandSC1 = IGPC(island1Contract);
    ...
    constructor(address _GPCTokenAddress) {
        ...
        contractStartTime = 1659395145; //block.timestamp;

        islandSC[2] = IGPC721(island2Contract);
        ...
        goldTokensIds[
            1
        ] = 89427287526889206862219222097767809027326398573308042231447769178486287106049;
