...
contract CryptoMaidsItem721 is ERC721URIStorage, Ownable {
    constructor() ERC721("CMI", "CMI") {}
    ...
    function setTokenURI(uint256 tokenId_, string memory tokenURI_) external onlyOperator {
        super._setTokenURI(tokenId_, tokenURI_);
    }

    function mint(address to_, uint256 id_) public {
        super._safeMint(to_, id_);
    }
