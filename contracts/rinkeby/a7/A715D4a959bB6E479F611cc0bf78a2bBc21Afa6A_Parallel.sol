...
contract Parallel is ERC1155, Ownable, ERC2981ContractWideRoyalties, Pausable {
  ...
  function phygitalMint(uint _tokenId, bytes memory _signature) external whenNotPaused {
    require(signatureIsValid(_tokenId, _signature), "INVALID_PHYGITAL_SIGNATURE: please check address and tokenId");
    require(validPhygitalTokenId(_tokenId), "INVALID_TOKEN_ID: invalid phygital token ID");
    require(phygitalTokenIds[_tokenId] == address(0), "UNAVAILABLE_TOKEN: this NFT is already minted.");
