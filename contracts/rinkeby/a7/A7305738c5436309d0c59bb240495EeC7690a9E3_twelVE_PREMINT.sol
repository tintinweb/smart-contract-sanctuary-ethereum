...
contract twelVE_PREMINT is ERC721AQueryable, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_NFT_SUPPLY = 1000;
    uint256 public MAX_NFT_WL = 200;
    uint256 private NFT_GIVEAWAYS = 100; 
    ...
    constructor(string memory baseURI, uint256 mintTimestamp, uint256 wlTimestamp) ERC721A("12ve PREMINT", "12ve_PREMINT") {
        setBaseURI(baseURI);
