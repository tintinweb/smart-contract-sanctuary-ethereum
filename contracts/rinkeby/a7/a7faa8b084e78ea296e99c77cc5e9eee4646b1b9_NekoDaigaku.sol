...
contract NekoDaigaku  is ERC721A, Ownable {
    ...
    string  public DefaultUri = "ipfs://Qmc6suvz4paT1mX6754W6j4wXJHP8YKqmJ4R2y246RHeBA/";

    uint256 public immutable cost = 0.003 ether;
    uint32 public immutable MaxSummon = 999;
    uint32 public immutable MaxSummonPerTx = 3;
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        require(totalSupply() + amount <= MaxSummon, "sold out");
        require(amount <=  MaxSummonPerTx, "invalid amount");
    ...
    function ReservedMint(uint256 amount) public onlyOwner {
        _ReservedMint(amount);
    }
