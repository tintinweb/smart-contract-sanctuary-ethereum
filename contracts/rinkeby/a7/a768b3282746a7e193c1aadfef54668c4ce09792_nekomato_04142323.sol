...
contract nekomato_04142323 is ERC721{
...
//ここが名前
    constructor() ERC721("nekomato_04142323" , "nekomato_04142323" ) {
        //owner address
        //tonoshake
    ...
    function dovMint(uint256 _tokenID)public {//} external callerIsUser owners{
        //require(_tokenID < max);
        //require(_tokenID >= min);
        //require(minted[_tokenID] == false);
        //_safeMint( msg.sender , nftid);
