...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8103d6891bBD0cD947F52Ec97154CAD4e6ce627e];
...
// File: contracts/StarkSightxyzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract StarkSightxyzContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "StarkSightxyz";
    string public symbol = "STARKSIGHT";
