...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IToken.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IPYESwapCallee.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IERC20.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/libraries/UQ112x112.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/libraries/Math.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/libraries/SafeMath.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IPYESwapERC20.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/PYESwapERC20.sol
...
contract PYESwapERC20 is IPYESwapERC20 {
    ...
    string public constant name = 'PYESwap-LP';
    string public constant symbol = 'PYE-LP';
...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IPYESwapRouter.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IPYESwapPair.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/interfaces/IPYESwapFactory.sol
...
// File: PyeSwap/PyeSwap_swap-core/contracts/PYESwapPair.sol
...
contract PYESwapPair is IPYESwapPair, PYESwapERC20 {
    using SafeMath  for uint;
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        require(balance0 <= uint112(-1) && balance1 <= uint112(-1), 'PYESwap: OVERFLOW');
    ...
    function swap(uint amount0Out, uint amount1Out, uint amount0Fee, uint amount1Fee, address to, bytes calldata data) external lock {
        ...
        // uint adminFee = routerAddress.adminFee();
        // uint feeDivisor = 10000;
        // uint adminFee0;
        // uint adminFee1;
        
        // if (routerAddress.pairFeeAddress(address(this)) == token0){
        //     adminFee0 = feeDivisor.sub(adminFee);
        // } else {
        //     adminFee0 = feeDivisor;
        // }
        // if (routerAddress.pairFeeAddress(address(this)) == token1){
        //     adminFee1 = feeDivisor.sub(adminFee);
        // } else {
        //     adminFee1 = feeDivisor;
        // }
        // uint balance0Adjusted = balance0.mul(adminFee0).sub(amount0In.mul(2));
        // uint balance1Adjusted = balance1.mul(adminFee1).sub(amount1In.mul(2));
        // require(balance0Adjusted.mul(balance1Adjusted) >= uint(_reserve0).mul(_reserve1).mul((feeDivisor.sub(adminFee))**2), 'PYESwap: K');
...
// File: PyeSwap/PyeSwap_swap-core/contracts/PYESwapFactory.sol
...
contract PYESwapFactory is IPYESwapFactory {
    ...
    function createPair(address tokenA, address tokenB, bool supportsTokenFee) external returns (address pair) {
        ...
        IPYESwapPair(pair).initialize(token0, token1);
