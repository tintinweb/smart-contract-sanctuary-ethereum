...
contract TestingTheWaters is ERC721, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        string memory output = string(
            abi.encodePacked(
                ...
                '<rect width="450" height="450" x="25" y="25" rx="25" fill="#f0f"',
                ' stroke="#000" />'
                '<rect width="50" height="450" x="25" y="25" fill="0f0"',
                ' stroke="#000" />',
                '<g font-family="serif" font-size="38px" text-anchor="middle">',
                '<text x="275" y="450">',
                "</text></g>",
                '<text transform="rotate(90) translate(50 -45)" font-family="serif" font-size="16px">',
                ", ",
                ", ",
                "</text>",
                "</svg>"
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "Various boxes.", "image": "data:image/svg+xml;base64,',
