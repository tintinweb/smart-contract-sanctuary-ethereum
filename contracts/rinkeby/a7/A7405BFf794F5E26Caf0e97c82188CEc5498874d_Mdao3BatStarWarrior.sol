...
contract Mdao3BatStarWarrior is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PUBLIC_SALE_MAX_AMOUNT = 3000;
    uint256 public constant PRE_SALE_MAX_AMOUNT = 1000;
    ...
    uint256 public constant PRE_SALE_MAX_MINT_LIMIT = 1;
    ...
    function mintPublicSale(uint256 _amount)
        external
        payable
        nonReentrant
        ...
        callerIsUser
    {
        ...
        if (tokenIds.current() + _amount > MAX_SUPPLY) revert ExceedsMaxSupply();
    ...
    function mintPreSale(uint256 _amount, bytes32[] memory _proof)
        public
        payable
        nonReentrant
        whenPreSaleActive
