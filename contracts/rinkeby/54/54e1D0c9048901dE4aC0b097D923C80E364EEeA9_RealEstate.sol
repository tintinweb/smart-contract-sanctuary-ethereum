...
contract RealEstate is Pausable, Ownable {
    ...
    uint256 TicketTokenPrice = 5000000000; //fixed price
    ...
    function buyPropertyToken(
        ...
        require(
            TICKET_TOKEN.TokenTransferTimestamp(properties[_propertyId].folioNumber).add(1209600) >=
                block.timestamp,
            "timeout"
        );
    ...
    function changeBurnTimer(uint256 _propertyId , uint _burnTime) public onlyAgency  {
        burnTimer[_propertyId] = _burnTime;
    }
