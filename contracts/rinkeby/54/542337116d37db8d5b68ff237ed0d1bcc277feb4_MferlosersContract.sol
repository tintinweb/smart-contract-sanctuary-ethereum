...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7Fc610DC166d87765D5AaC52b31Bf63D725c04Fb];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXpBrgNjFiQDtzsuchY4qh43ec8hbx1mXdacCmoLcDENw/";

    bool public mintingOpen = true;
    bool public isRevealed = false;
    
    
    uint256 public MAX_WALLET_MINTS = 18;
...
// File: contracts/MferlosersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MferlosersContract is RamppERC721A {
    constructor() RamppERC721A("Mfer losers", "ML"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gbUG8P4s95lNq5XFXx6D/contract-metadata";
    }
}
