...
contract TheHomegirls is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public whitelistMintRate = 0.00 ether;
    string public notRevealedUri = 'ipfs://QmUzDVRmJP4wxVRjo5J5QaCrqTEfpdMWWNYNxHPDK7pbnb/hidden.json';
    ...
    constructor() ERC721A('TheHomegirls', 'HGRL') {}
