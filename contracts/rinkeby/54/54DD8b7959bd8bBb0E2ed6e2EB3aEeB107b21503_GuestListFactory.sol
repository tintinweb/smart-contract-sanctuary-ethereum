...
import {IGuestList} from "IGuestList.sol";

contract GuestListFactory {
    address public immutable guestlist_implementation;
    address private immutable SOLIDLY_ROUTER;
    address private immutable CURVE_ROUTER;
    address[] private UNISWAP_ROUTERS;
...
contract PricingLogic is OwnableUpgradeable {
    ...
    /**
     * @notice returns the unit price of _tokenIn in _tokenOut denomination using uniswapV2
     */
    ...
    /**
     * @notice returns the unit price of _tokenIn in _tokenOut denomination using solidly
     */
