...
contract nftArabiaNetlify is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    ERC721("NftArabiaNetlify", "ARB") {
        }


    function createNfts(address to, string memory uri) public {
