...
contract BankBank is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address public RewardToken = address(this); //UNI
    ...
    address payable public marketingWallet = payable(0x0E4552ed6c535d18f2750501f517636d10D0bbBe);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForRewardToken(amountToSwap.div(2));
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 11, "Fee can't exceed 11%");
        totalFee = _fee;
    }
