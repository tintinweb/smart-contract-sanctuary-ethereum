...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
        ...
        )
    {
        ...
        //(block.timeStamp - last block.timeStap) - to get if enough time has passed, we're going to need to get the current block dot timestamp minus the last block timestamp
    }
