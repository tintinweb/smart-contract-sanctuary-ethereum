...
/**
 * @title SongAlbumNFTTradablePrivate
 * SongAlbumNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract SongAlbumNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist SongAlbum auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist SongAlbum contracts to enable gas-less listings.
     */
