...
contract StudioZomi is ERC721A, Ownable {
    ...
    uint256 public constant FRIENDS_PRICE = 0.075 ether;
    ...
    function friendsMint(
        ...
        require(msg.value == amount * FRIENDS_PRICE, "wrong eth value");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (!isRevealed) return string(abi.encodePacked("ipfs://", ipfsCID));
    ...
    function setIsRevealed(bool _isRevealed, string memory _ipfsCID) external onlyOwner {
