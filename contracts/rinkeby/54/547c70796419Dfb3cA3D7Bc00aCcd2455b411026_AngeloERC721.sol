...
contract AngeloERC721 is ERC721URIStorage, ERC2981, Ownable {
    ...
    mapping (uint256 => bool) public fractionalizedTokenId;
    ...
    function balanceOf(address owner) public view virtual override returns (uint256) {
        ...
        if (fractionalized) {   // fractionalizedTokenId[tokenId]
            require(ERC20(fractionalToken).balanceOf(owner) > 0, "ERC721: address doesn't own any NFT fractions");
            return 1;
        }
    ...
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        ...
        // if (fractionalizedTokenId[tokenId] && ERC20(fractionalToken).balanceOf(msg.sender) > 0) {
        //     return msg.sender; 
        // }
    ...
    address public fractionalToken; // erc20

    function setFractionalToken(address _fractionalToken) external onlyOwner {
        fractionalToken = _fractionalToken;
    }

    function setIsFractionalized(bool _fractionalized) external onlyOwner {
        fractionalized = _fractionalized;
    }

    function setIsFractionalizedTokenId(bool _fractionalized, uint tokenId) external onlyOwner {
        fractionalizedTokenId[tokenId] = _fractionalized;
    }
