...
contract StacktWalletFactory {
    ...
    // address constant stacktWalletSingletonAddress = 0xd65AD5ce37B39e39EA8d359a53b2e8d12caD80e5; ///

    address public immutable proxyFactoryAddress;
    address public immutable stacktWalletSingletonAddress;

    constructor(address _proxyFactoryAddress, address _stacktWalletSingletonAddress) {
