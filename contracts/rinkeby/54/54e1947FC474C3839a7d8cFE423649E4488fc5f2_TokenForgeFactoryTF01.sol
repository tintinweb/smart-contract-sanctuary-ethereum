...
contract TokenForgeFactoryTF01 is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function initialize(int test_, address impl_) public initializer {
        ...
        _test = test_;
        _addr = impl_;
        console.log("CTOR", impl_);
        tokenImplementation = impl_; // address(new TokenForge1155v3Upgradeable());
    ...
    returns (address)
    {
        return cloneTokenForge1155v3(tokenImplementation, signer, baseUri);
    }

    function cloneTokenForge1155v3(address impl, address signer, string memory baseUri)
        public
        returns (address)
    {
