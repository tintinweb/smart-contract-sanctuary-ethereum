...
contract Moonkeeper721A is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor( uint maxBatchSize_, uint maxCollectionSize_) ERC721A("Moonkeeper", "Moonkeeper", maxBatchSize_, maxCollectionSize_) {
    ...
    function setSalestage(uint8 newSalesStage) public onlyOwner {
        salesStage = newSalesStage;
    }

    function devReserverMint(address[] calldata to_, uint256 quantity_ ) public onlyOwner {        
