...
contract FTLNGS is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0xae6c1e6e20c74291Ecc7f20CA05e00c1fBE4995D).call{value: artistPayment}('');
    require(artistSuccess);

    (bool marketerSuccess, ) = payable(0xae6c1e6e20c74291Ecc7f20CA05e00c1fBE4995D).call{value: marketerPayment}('');
