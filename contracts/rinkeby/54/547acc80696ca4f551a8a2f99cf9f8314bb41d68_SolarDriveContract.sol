...
abstract contract Driveable {
  address public DRIVEADDRESS = 0xa9dAC8f3aEDC55D0FE707B86B8A45d246858d2E1;

  modifier isDrive() {
      require(msg.sender == DRIVEADDRESS, "Ownable: caller is not DRIVE");
      _;
  }
}
...
abstract contract Withdrawable is Ownable, Driveable {
  address[] public payableAddresses = [DRIVEADDRESS,0x657f95b3FfEDF60eF429434C84242Eb11C12E7AD];
  ...
  function withdrawAllDrive() public isDrive {
      require(address(this).balance > 0);
      _withdrawAll();
  }
...
/**
  ...
  function withdrawAllERC20(address _tokenContract, uint256 _amount) public onlyOwner {
    ...
    /**
  * @dev Allows Drive wallet to update its own reference as well as update
  * the address for the Drive-owed payment split. Cannot modify other payable slots
  * and since Drive is always the first address this function is limited to the Drive payout only.
  * @param _newAddress updated Drive Address
  */
  function setDriveAddress(address _newAddress) public isDrive {
    require(_newAddress != DRIVEADDRESS, "Drive: New Drive address must be different");
    DRIVEADDRESS = _newAddress;
...
abstract contract SOLRIERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmTcfqrsnokRa2F7uFoFhksJyTQuZtgZGUngsRTeqxrAbc/";
