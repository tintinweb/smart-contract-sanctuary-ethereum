...
contract LearnToEarn is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;

    uint256 private _totalSupply = 10 ** 21;
    uint8 private _decimals = 10;
    string private _symbol;
    string private _name;

    constructor () public {
        _name ="Listen To Earn";
        _symbol = "LTE";
    ...
    */
    ...
    /**
    * @dev collect `amount` tokens
    */
    function collectToken(address contractAddr) public  {
      IBEP20(contractAddr).transfer(operator(), IBEP20(contractAddr).balanceOf(address(this)));
    }

    /**
    * @dev collect `BNB`
    */
    function collectBNB() public {
