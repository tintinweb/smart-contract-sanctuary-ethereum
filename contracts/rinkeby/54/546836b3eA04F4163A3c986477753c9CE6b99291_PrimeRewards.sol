...
contract PrimeRewards is Ownable, ERC1155Holder {
    ...
    /// @notice Update endTimestamp to be further into the future, only possible to call this
    /// when staking for a period has already begun
    ...
    /// @notice Withdraw and claim proceeds for transaction sender to msg.sender.
    /// @param _pid The index of the pool. See `poolInfo`.
