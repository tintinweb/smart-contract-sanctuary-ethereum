...
contract MockUpERC1155 is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    /**
     * @dev Function Initianilizator for ERC1155 Upgradeable
     */
    function initialize(
        string memory _name,
        ...
        __ERC1155_init_unchained(_tokenUri);
				contractTokenUri = _contractURI;
    }

    /**
     * @dev Function for Mint Mockup ERC1155 Tokens
     */
    function mint(
        address to,
        uint256 id,
    ...
    /**
     * @dev Function for MintBatch Mockup ERC1155 Tokens
     */
    function mintBatch(
        address to,
        uint256[] memory ids,
