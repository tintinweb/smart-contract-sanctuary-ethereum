...
contract ImaginaryBirdy is ERC721A, Ownable {
  using Strings for uint256;
  
  uint256 public mintPriceTier1 = 0.005 ether;
  uint256 public mintPriceTier2 = 0.01 ether;
  uint256 public mintPriceTier3 = 0.015 ether;
  ...
  uint256 public maxFreeMint = 6666;
  uint256 public freeMintPerWallet = 3;
  uint256 public maxSurpriseMint = 4;
  string public baseTokenURI = "";
  string public hiddenURI = "https://gateway.pinata.cloud/ipfs/QmbDwU4Ud1nQVWJrwxbbsNoFsQR9NpizaE3mQvAKerWiAP";

  bool public openMint = false;
  bool public revealed = false;

  bool public onFreeMint = true;
  bool public surpriseMint = true;
  bool public onPackageSale = true;
  bool public on1Free1 = true;

  mapping(address => uint256) public addressMintedBalance;

  constructor() ERC721A("Imaginary Birdy", "imgbirdy", 100) {  }
  ...
  function mintFree() external payable {
    ...
    uint256 _mintAmount;
    if(surpriseMint){
        uint randomQty = uint(keccak256(abi.encodePacked(block.difficulty, block.timestamp))) % maxSurpriseMint;
        _mintAmount = randomQty + 1;
    }
    else {
