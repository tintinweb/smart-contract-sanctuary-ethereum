...
contract ERC721AContract is ERC721A, ReentrancyGuard, Ownable {
    ...
    address payable private multisigAddress;
    address payable private wentMintAddress;
    ...
    uint8 private immutable wenmintShare = 10;
    ...
    constructor(
        ...
        merkleRoot = initialParameters.merkleRoot;
...
contract ERC721AFactory is Ownable {
    ...
    mapping(uint256 => bool) public hasDeployed;
    address payable public treasuryAddress;
    address public launchpassAddress;
    ERC721AContract[] public nfts;

    constructor(address payable _treasuryAddress, address _launchpassAddress) {
    ...
    //     require(!hasDeployed[initialParameters.launchpassId],  "This LaunchPass has already been used.");
    //     hasDeployed[initialParameters.launchpassId] = true;
    //     ERC721AContract nft = new ERC721AContract(treasuryAddress, msg.sender, initialParameters);
    //     nfts.push(nft);
    // }
