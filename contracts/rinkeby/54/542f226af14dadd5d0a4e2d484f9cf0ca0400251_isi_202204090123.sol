...
// File: nekomato/nekomato0407.sol
...
contract nekomato_0408_2333 is ERC721{
    ...
    string baseURI = "https://ipfs.io/ipfs/QmewCUJyn4smzWDGg5ec3mN2Vo3bMHyWEV4qyxvh5ryHXa/";
...
//ここが名前
    constructor() ERC721("nekomato0408_2333" , "nkmt0408_2333" ) {
        //owner address
        //tonoshake
        owner = address(0x5601613b1D2871ed28E3Af31AC9E41DC4A4e8016);
        //awai san 
        owner2 = address(0x9B2f5909EC0F559dE12948E4cb963838C7bEeFf2);
        //fale wallet
    ...
    function publicSaleMint(uint256 _tokenID) public payable{
        require(mintStarted);
    ...
    function devMint(uint256 _tokenID) public payable{
    ...
    function _setTokenURI( uint targetnftid ,string memory _uri ) private {
        require(minted[targetnftid]);
        tokenURIs[targetnftid] = _uri;
    }

    function setTokenIDRange_max_min(uint _max,uint _min)public{
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
        max = _max;
        min = _min;
    }
    ...
    function resetSeasonMint()public {
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
        seasonMint = 0;
    }
    ...
    function addAllowlist(address _address , uint256 _mintableCount,uint _price)public{
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
    ...
    function removeAllowlist(address _address)public{
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
    ...
    function mintManage(bool _mintStarted)public{
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
        mintStarted = _mintStarted;
    }

    function manageStoneList(address _address,bool _state)public {
        require( _msgSender() == owner  || _msgSender() == owner2 || _msgSender() == owner3);
        allowStoneList[_address] = _state;
    }

    function chengeForm(uint _id,string memory _uri) external{
        require(allowStoneList[msg.sender],"not allowed address");
        tokenURIs[_id] = _uri;
    }
}
// File: nekomato/isi.sol
...
contract isi_202204090123 is ERC721{
    
    constructor() ERC721("isi_202204090123" , "isi_202204090123" ) {
        //nkmt = nekomato_0407_2215('0x961a1d65aC821C0dDc88D5Bd8dA76cb52Afff762');
        
        //owner address
        owner = address(0x5601613b1D2871ed28E3Af31AC9E41DC4A4e8016);
        owner2 = address(0x9B2f5909EC0F559dE12948E4cb963838C7bEeFf2);
        //testsol4
        wallet = address(0xacF3c0236839B352A93282501B6E1F3bEDD01D58);
        //testsol
        //account0 = address(0x6b5f8740bBeceF11921d6963Bb2c8deE603894d1);
        //awai san wallet
        account0 = address(0x9B2f5909EC0F559dE12948E4cb963838C7bEeFf2);
        //tonoshake_test mainno
        account1 = address(0x5601613b1D2871ed28E3Af31AC9E41DC4A4e8016);
    ...
    //nkmtInterface nkmt = nkmtInterface(0x961a1d65aC821C0dDc88D5Bd8dA76cb52Afff762);

    //nekomato_0407_2215 nkmt;

    string nkmt_baseURI = "https://ipfs.io/ipfs/QmNiJtV8CFLdi2DbgFamrzud2n5rLzWrU7D53A5ynW6MBv/";
    ...
    function setNKMTBaseURI(string memory _uri)public {
        require( _msgSender() == owner  || _msgSender() == owner2);
        nkmt_baseURI = _uri;
    }

    function changeNKMTForm(uint _id)public{
        require(haveTokens[_msgSender() ] > 0);
        nekomato_0408_2333 nkmt = nekomato_0408_2333(0xF63d3d510d1bC1f9755e03e3FF5b88c6b97ac24D);
        require(nkmt.getHaveTokens(_msgSender() ) > 0);
        string memory uri = string(abi.encodePacked(nkmt_baseURI,Strings.toString(_id),".json") );
        nkmt.chengeForm(_id,uri);
    }
