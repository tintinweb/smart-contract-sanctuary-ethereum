...
// File: contracts/iSupportUkraine.sol
...
contract ISupportUkraine is ERC721URIStorage, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    bytes32 public merkleRoot;

    constructor(bytes32 _merkleRoot) ERC721("I Support Ukraine", "UA") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmZ2fKReJwGntqva6ec7ERqASvwKCW1GRePNb9mBPmjW5F";
    }
