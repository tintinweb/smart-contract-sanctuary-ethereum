...
// File: contracts/zerocodecontract.sol
...
contract TEST is ERC721A, Ownable {
    ...
    enum SaleStatus{ PAUSED, PRESALE, PUBLIC } // 0=PAUSED; 1=PRESALE; 2=PUBLIC

    uint256 public constant maxSupply = 1000;
    uint256 public constant maxMintAmountPerTx = 10;
    uint256 public constant nftPerAddressLimitWl = 1;
    uint256 public constant PRESALE_price = 0 ether;
    uint256 public price = 0.01 ether;

    SaleStatus public saleStatus = SaleStatus.PAUSED;
    bytes32 public merkleRoot;
    string private _baseURL = "ipfs://_____Replace____/";
    
    mapping(address => uint256) private _mintedCount;
    mapping(address => uint256) private _whitelistMintedCount;
    ...
    function mint(bytes32[] calldata merkleProof, uint256 count) external payable {
        ...
        require(count <= maxMintAmountPerTx, "NFT: Number of requested tokens exceeds allowance (10)");
        if(saleStatus == SaleStatus.PRESALE) {
            require(msg.value >= count * PRESALE_price, "Ether value sent is not sufficient");
            require(_whitelistMintedCount[msg.sender] + count <= nftPerAddressLimitWl, "Number of requested tokens exceeds allowance (1)");
