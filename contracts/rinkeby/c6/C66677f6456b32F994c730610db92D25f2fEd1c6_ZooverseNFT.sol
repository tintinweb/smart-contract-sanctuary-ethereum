...
// File: ZooverseNFT.sol

contract ZooverseNFT is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    AccessControl
{
    uint256 public currentTokenLength;
    ...
    constructor() ERC721("ZooverseNFT", "ZOO") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        mintingFee = 0.05 * 10**18;
        currentTokenLength = 0;
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://website.com/zooversenfts";
    }

    function whitelistMint(bytes32[] calldata _merkleProof) public payable {
        require(!whitelistClaimed[msg.sender], "Address has already claimed.");
        require(msg.value > mintingFee, "Not enough ETH.");
        ...
        uint256 tokenId = currentTokenLength;
    ...
    ///Set fee expressed as [price] * 10**18; (wei)
