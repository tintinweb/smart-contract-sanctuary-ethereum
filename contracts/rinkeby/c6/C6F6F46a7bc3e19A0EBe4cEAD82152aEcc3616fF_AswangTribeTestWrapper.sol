...
contract AswangTribeTestWrapper is AswangTribe {
    ...
    function flipRevealed() public override {
        revealed = !revealed;
    }
    ...
    function setPrayingStartedAt(uint256 tokenId, uint64 _prayingStartedAt) public {
        tokenInfo[tokenId].prayingStartedAt = _prayingStartedAt;
    }
}
