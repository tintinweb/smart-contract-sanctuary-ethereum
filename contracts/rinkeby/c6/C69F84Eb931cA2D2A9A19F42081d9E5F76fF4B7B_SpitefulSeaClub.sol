...
contract SpitefulSeaClub is ERC721A, Payable {
    using Strings for uint256;

    //NOTE Token values incremented for gas efficiency
    uint256 private maxSalePlusOne = 1301;
    uint256 private maxPresalePlusOne = 901;
    uint256 public tokenPricePresale = 1 ether; //this value is in CRO
    uint256 public tokenPricePublicSale = 2 ether; //this value is in CRO
    ...
    // amount of nfts to be minted per address in presale plus one
    ...
    address public recipient = 0xe04Bc5be51cE7F1436c6FdC38817b8e4755Cb1ab;

    constructor() ERC721A("Spiteful Sea Club", "SSC") {
        placeholderURI = "ipfs://...";
        //merkleRoot = ''; //0x should be prepended

        // 7% royalties
        _setRoyalties(recipient, 700);
    }
    ...
    /**
     * Ensure amount of tokens to mint is within the presale limit.
     */
