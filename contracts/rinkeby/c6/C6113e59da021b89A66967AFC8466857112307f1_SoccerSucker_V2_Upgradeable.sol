...
contract SoccerSucker_V2_Upgradeable is Initializable, ERC721Upgradeable, OwnableUpgradeable {
  ...
  // Test variable game
  string public nameOfPlayer;

  function initialize(string memory _name, string memory _symbol, string memory _initBaseURI, string memory _initContractURI) public initializer {
    baseExtension = ".json";
    cost = 0.035 ether;
    maxSupply = 1000; 
