...
contract EGG is ERC20, Ownable, Pausable {
  ...
  function _beforeTokenTransfer(
    ...
    uint256 amount
      ...
      if (paused()) {
        // If the contract is paused, ensure only minting can occur, not transfer
        // Minting occurs when the from address is the zero address
        require(from == address(0), "Cannot transfer while paused");
      }
    }
