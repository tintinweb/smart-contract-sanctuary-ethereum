...
contract Treasury is Ownable, ITreasury {
    ...
    function _convertToRewardsToken(address _tokenAddress, uint256 amount, uint256 amountOutMin, uint256 deadlineDuration)
        internal
    {
        ...
        uint256 amountOut = IERC20(rewardsToken).balanceOf(address(this));
        ...
        amountOut = IERC20(rewardsToken).balanceOf(address(this)) - amountOut;
        emit FundsConverted(_tokenAddress, rewardsToken, amountOut);
    }
    ...
    function toVoters(
        ...
        if (_tokenAddress != rewardsToken) {
            _convertToRewardsToken(_tokenAddress, amount, amountOutMin, deadlineDuration);
        }
