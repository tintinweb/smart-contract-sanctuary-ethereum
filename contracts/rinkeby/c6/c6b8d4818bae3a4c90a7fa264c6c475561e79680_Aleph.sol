...
contract Aleph is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor() ERC721A("Aleph Test","APOG", MaxMintPerBatch_, TotalCollectionSize_) {
    setURIbeforeReveal("https://gateway.pinata.cloud/ipfs/Qma1QXa6GkWRGpYe9PKVpXYSrTbErFPq2pn3AA9veom8Ch");
    setBaseURI("https://gateway.pinata.cloud/ipfs/QmZXoaMUykeXQNvzfhtkCquPxWz8SqziSxCzSF4Wi1qUfZ/");
  }
