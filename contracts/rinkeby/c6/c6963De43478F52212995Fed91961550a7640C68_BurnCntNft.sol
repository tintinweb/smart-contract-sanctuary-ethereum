...
contract BurnCntNft is ERC721URIStorage, AccessControl {
    ...
    struct BurnCntNftItem {
        string projectName;
        string projectType;
        string creditStandard;
        string creditingPeriod;
        string methodology;
        uint256 annualCredits;
        string description;
    }
    mapping(uint256 => BurnCntNftItem) public tokenIdBurnCntNftItemMap;

    constructor(address administrator) ERC721("MVGX Carbon Registry", "MCR") {
    ...
    function create(
        ...
        string memory creditStandard,
        string memory creditingPeriod,
