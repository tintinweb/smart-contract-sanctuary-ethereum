...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 251 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUEiGxvkc3Q4HDrsy8HZayJTwxRBhK5HYNG1KEwaXrcWQ/";
...
// File: contracts/OutofthisworldGuysContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OutofthisworldGuysContract is RamppERC721A {
    constructor() RamppERC721A("Out of this world Guys", "OTWG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/kid18ALD3swDf5p7ZEtb/contract-metadata";
    }
}
