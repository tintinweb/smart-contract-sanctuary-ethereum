...
contract IWantToDie is ERC721A, Ownable {
    uint public constant MAX_PER_WALLET_FREE = 1;
    uint public constant MAX_PER_TX = 10;
    uint public MAX_SUPPLY = 6666;
    uint public price = 0.003666 ether;
    string public baseURI = "ipfs://QmQSonTAzNdPu695mUxkcpWedHL8Q8qZU3c9sLG1w9M5DX/";

    bool public paused = false;
    bool public _live = false;

    constructor() ERC721A("I Want To Die", "IWANNADIE") {}
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0
            ? string(abi.encodePacked(baseURI,"pre-reveal.json"))//string(abi.encodePacked(currentBaseURI,Strings.toString(_tokenId+1),".json"))
            : "";
    }
}