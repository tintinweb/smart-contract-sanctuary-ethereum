...
// File contracts/PlatziPunksADN.sol
...
function mint() public {
    ...
    tokenADN[current] = deterministicPseudoRandomDNA(current, msg.sender);
...
string memory jsonURI = Base64.encode(
    abi.encodePacked(
        '{ "name": "PlatziPunks #',
        tokenId.toString(),
        '", "descripcion": "Platzi are randomized Avataars", "image": "',
        image,
        '"}' 
        )
    );
     return string (abi.encodePacked("data:appication/json;base64,", jsonURI));
}
