...
contract CRR is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
	...
	string private BASE_URI = "https://ipfs.io/ipfs/QmPnoCtuczBRFVmn7kjpa44zyG6ALDHMAQAK3ZdecWvxHM/";
	...
	constructor() ERC721("Crazy Rich Rabbit", "CRR") {
		...
		for(uint i=0; i<111; i++) {
			...
			string memory _tokenURI = string.concat(BASE_URI, string.concat(Strings.toString(i), ".json"));
