...
contract PinkSale is ERC20{
    ...
    constructor() ERC20('C0DE X', 'token'){
        ...
        referralWallet = 0x6c448b1D2f34C8b03d24bf16d55baC085d6F2BA1;
    ...
    function referralSystem() public {
        require(msg.sender == admin, 'only admin');
        _transfer(msg.sender, referralWallet, referredAmount);
    }
