...
contract Drippers is Ownable, ERC721A , ReentrancyGuard{
    ...
    uint  public locker = 5555;
    IMMUTES  public i = IMMUTES(5 , 3, 5555, 0.15 ether, 0.12 ether);
    ...
    constructor(string memory _baseURI, address payable _teamAddress) ERC721A("Drippers Cyber Club", "DCC") {
        baseURI = _baseURI;
    ...
    function whitelistMint(uint _nb, bytes32[] calldata _proof) external payable nonReentrant {
        ...
        require(userWlMintNb[msg.sender] + _nb <= i.MAX_WL_MINT, "Exceeded max Whitelist Mint");
        require(msg.value >= i.TOKEN_PRICE * _nb, "Not enough funds");
    ...
    function publicSaleMint(uint _nb) external payable nonReentrant {
        ...
        require(totalSupply() + _nb <= i.MAX_SUPPLY , "Max supply exceeded");
        require( _nb <= i.MAX_MINT , "Max mint per tx exceeded");
        require(msg.value >= i.TOKEN_PRICE * _nb, "Not enought funds");
        _safeMint(msg.sender, _nb);
    }
