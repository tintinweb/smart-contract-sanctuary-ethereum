...
contract CatEye is ERC721, Ownable, ERC721Enumerable{
    ...
    event CatEyeMinted(uint256 tokenId, address owner);

    constructor() ERC721("CatEyeNew", "EFS"){}
    ...
    function mintCatEye(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit CatEyeMinted(id, msg.sender);
          }
        }
      }

      function presaleCatEye(uint256 numberOfTokens) external payable {
