...
contract GooglyEyedRockClub is ERC721Enumerable, Ownable {
    ...
    address internal Shareholder_3 = 0xCFFE08BDf20918007f8Ab268C32f8756494fC8D8;
    ...
    uint public dutchEndingPrice = 0.3 ether;
    uint public dutchPriceAdditional; // = 2.7 ether, record the additional price of dutch and deduct
    ...
    uint public finalPrice = 0.3 ether; // record last sale price
    ...
    function refund(address address_) public onlyOwner {
        ...
        uint _proceeds = finalPrice * maxTokens;
