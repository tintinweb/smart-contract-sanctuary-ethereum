...
contract TempleExploration is ReentrancyGuard {
    function explore(uint256 _difficulty) external payable nonReentrant {} 

    function worship(uint _tokenId) external {}

    function ranking(uint _tokenId) public pure returns (string memory) {}
}
...
contract OhoohAhaah is Ownable, ERC721A {
    ...
    /*=====================================================================
    ==          Functions for TEMPLE_EXPLORATION (Minting) Phase         ==
    =====================================================================*/
