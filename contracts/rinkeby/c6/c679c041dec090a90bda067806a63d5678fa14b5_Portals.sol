...
contract Portals is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmRaaHb8yuKPrfbtd9XCGF7qYWCAzDt44hGzXcWPAKtx3S";
  ...
  uint256 public  TOTAL_FREE_MINTS = 340;
  bool public isPublicSaleActive = true;

  constructor() ERC721A("Portals", "PRTLS") {
