...
contract RichmanHeroesWhitelistSale is Ownable, ReentrancyGuard {
    ...
    uint256 public whiteListSaleMintPrice = 0.29 ether;

    uint256 public remainingCount = 2000;
    ...
    address public nine = 0x72fAffaaD2A73643C126281f931cFc61ae8F89FE;
        ...
        internal
    {
        ...
        uint256 nineShare = msg.value - softstarShare;
        (bool softstarSent, ) = softstar.call{value: softstarShare}("");
        require(softstarSent, "sent value failed");
        (bool nineSent, ) = nine.call{value: nineShare}("");
        require(nineSent, "sent value failed");
    }
