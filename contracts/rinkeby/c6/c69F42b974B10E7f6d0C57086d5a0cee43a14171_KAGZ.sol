...
contract KAGZ is ERC721Enumerable, Ownable {
    ...
    uint256 public preSaleDate = 1644319737; //****// Feb 9
    uint256 public publicSaleDate = 1644319738; //****// Feb 10
    uint256 public publicSaleEndDate = 1644492538; //****//
    ...
    */
    ...
    function publicsaleValidations(uint256 _ownerMintedCount, uint256 _mintAmount) internal {
        ...
        require(msg.value >= getAuctionPrice() * _mintAmount, "insufficient funds");
    ...
    function getAuctionPrice() public view returns (uint256) {
        ...
        if (block.timestamp - publicSaleDate >= AUCTION_PRICE_CURVE_LENGTH) {
            return AUCTION_END_PRICE;
        } else {
            uint256 steps = (block.timestamp - publicSaleDate) / AUCTION_DROP_INTERVAL;
    ...
    function setMaxSupply(uint256 _newMaxSupply) public onlyOwner {
        require(block.timestamp < publicSaleEndDate, "public sale has already begun");
