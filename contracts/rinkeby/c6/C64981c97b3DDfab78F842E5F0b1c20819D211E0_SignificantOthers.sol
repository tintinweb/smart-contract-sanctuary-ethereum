...
contract SignificantOthers is Ownable, ERC721A {
    ...
    // Community cut = 43.75%
    uint256 constant internal COMMUNITY_WITHDRAW_PERCENT = 4375;
    ...
    address constant public communityWallet = 0x994adAd31b1966c74A3f76419E3Ba91F60E52277;
    ...
    */
    ...
    function teamMint(uint256 quantity) external payable {
        require(msg.sender == owner(), "Team mint only");
