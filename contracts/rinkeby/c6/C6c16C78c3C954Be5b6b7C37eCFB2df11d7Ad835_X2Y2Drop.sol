...
contract X2Y2Drop is Ownable, Pausable {
    ...
    constructor(IERC20 dropToken_, address signer_) {
        dropToken = dropToken_;
    ...
    function claim(
        ...
        require(totalAmount > claimed[msg.sender], 'Claim: nothing to send');
        ...
        dropToken.safeTransfer(msg.sender, amount);
