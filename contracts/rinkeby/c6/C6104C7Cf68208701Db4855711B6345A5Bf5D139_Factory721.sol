...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new MonsterNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        MonsterNFTUser721Token token = MonsterNFTUser721Token(address(addr));
...
contract MonsterNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
