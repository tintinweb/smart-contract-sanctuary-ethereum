...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x677C1e1e8585f914D9AD6a4565eb4edF43398bBD];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmbk3dC9u4owLPu1KpRU1sHh8C8cgAsUcY1Y6z8mED759H/";
...
// File: contracts/BerserkerscallContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BerserkerscallContract is RamppERC721A {
    constructor() RamppERC721A("Berserkers call", "Bersk"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/0xam7tE1yqvWBBKkB951/contract-metadata";
    }
}
