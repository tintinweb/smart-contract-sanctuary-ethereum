...
contract ContractForTesting is ERC721A, Ownable {

string public metadataBaseURL = "http:/www.hjasd/sas";

uint256 public nftPerAddressLimit = 3;

uint256 public price = 0.001 ether;

uint256 public maxSupply = 1230;

bool public paused = false;

mapping(address => uint256) public mintedBalance;

constructor() ERC721A("ColName", "CN") {}
...
function mint(uint256[] memory burnTokenIds) external payable {
