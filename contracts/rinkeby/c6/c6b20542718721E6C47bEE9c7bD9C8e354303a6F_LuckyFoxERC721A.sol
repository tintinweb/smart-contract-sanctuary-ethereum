...
contract LuckyFoxERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public saleStartTime = 1660570200;
    ...
    address[] private _team = [
        0x7e0F8AfEE158b50c5e5c38a07eB329D05be8605d,
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require(currentTime() < saleStartTime + 30 minutes, "Sale is finished");
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "Contract is Paused");
        require(currentTime() >= saleStartTime + 1 hours, "Public sale has not started yet");
        require(currentTime() < saleStartTime + 2 hours, "Public Sale is finished");
