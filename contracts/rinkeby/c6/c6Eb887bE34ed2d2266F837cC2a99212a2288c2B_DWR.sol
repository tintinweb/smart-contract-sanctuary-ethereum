...
contract DWR is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PRE_SALE_MINTS = 2;
    //uint256 public constant PRE_SALE_PRICE = 0.0001 ether;

    uint256 public constant MAX_PUBLIC_SALE_MINTS = 1;
    ...
    constructor(address _royaltyReceiverAddress)
        ERC721("DinnerWhoreRegistry", "DWR")
    {
