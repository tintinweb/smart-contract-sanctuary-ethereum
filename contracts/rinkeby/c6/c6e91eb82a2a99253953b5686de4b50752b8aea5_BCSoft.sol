...
contract BCSoft is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    bool public isPremintSaleActive = false;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "Total supply must be less than or equal to maxSupply"
        );
    ...
    function premintMint(uint256 _mintAmount, bytes32[] calldata merkleProof)
        external
        payable
        virtual
    {
        uint256 supply = totalSupply();
        require(!paused, "Contract is currently paused");
        require(isPremintSaleActive, "Public sale is not active");
        require(_mintAmount > 0, "Mint amount must be greater than 0");
        require(
            _mintAmount <= maxMintAmount,
            "Mint amount must be less than or equal to maxMintAmount"
