...
contract Testing_Mints is IERC721, Ownable, Functional {
    ...
    constructor() payable {
        _name = "Testing Mints";
        _symbol = "tment";
        _baseURI = "https://testiesnuts.com";
        _extension = ".json";

        totalTokens = 6969;
        price = 69 * (10 ** 15); // Replace leading value with price in finney
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Testing_Mints.onERC721Received.selector;
    }
