...
contract MaintainanceRecord {
    ...
    function getMaintainance(uint recordNum) public view returns (string[] memory, string[] memory) {
        ...
        string[] memory record_header = new string[](uint256(5));

        record_header[uint256(0)] = "date";
        record_header[uint256(0)] = "location";
        record_header[uint256(0)] = "maintenance workshop";
        record_header[uint256(0)] = "description";
        record_header[uint256(0)] = "engineer";
        ...
        return (record_header, record_list);
