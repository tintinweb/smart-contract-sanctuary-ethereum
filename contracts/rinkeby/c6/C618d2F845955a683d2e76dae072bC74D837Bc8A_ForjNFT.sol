...
contract ForjNFT is ERC1155, ReentrancyGuard, Ownable {
    ...
    {
        require(
            mintedAmount[tokenId] < maxSupply[tokenId],
            "Exception: All was minted."
        );
        require(
    ...
    function batchmint(uint256 tokenId, address[] memory mintAddresses)
        external
