...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => DIGI_EFFECT) tokenIdToDigi;
    mapping(bytes32 => address) public requestIdToSender;
    event requestedCollectible(bytes32 indexed requestId, address requester);
    event digiAssigned(uint256 indexed tokenId, DIGI_EFFECT effect);
    ...
    constructor(
        ...
        ERC721("Generative Art", "Generative Art")
    {
        tokenCounter = 0;
        keyhash = _keyhash;
        fee = _fee;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        DIGI_EFFECT effect = DIGI_EFFECT(randomNumber % 3);
        uint256 newTokenId = tokenCounter;
        tokenIdToDigi[newTokenId] = effect;
        emit digiAssigned(newTokenId, effect);
