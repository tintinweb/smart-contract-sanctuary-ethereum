...
contract BAE is ERC721Enumerable, Ownable {
    ...
    uint256 public OWNER_RESERVED = 222;
    uint256 public price_tier1 = 0.01 ether;
    uint256 public price_tier2 = 0.05 ether;
    uint256 public tier1_limit = 2222;
    ...
    string baseTokenURI = "";
    string notRevealedUri = "https://ipfs.io/ipfs/QmYWom9YzN24KMQCeL2QTetTPTqDy6s16kaCCTcABJTt5c/";
    
    event NFTMinted(uint256 totalMinted);

    constructor() ERC721("Before Anyone Else", "BAE") {}
