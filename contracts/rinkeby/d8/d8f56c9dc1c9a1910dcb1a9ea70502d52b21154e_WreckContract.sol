...
//
//          _       __               __   _             ____              __       
// | |     / /_______  _____/ /__(_)___  ____ _/ __ \__  ______  / /_______
// | | /| / / ___/ _ \/ ___/ //_/ / __ \/ __ `/ /_/ / / / / __ \/ //_/ ___/
// | |/ |/ / /  /  __/ /__/ ,< / / / / / /_/ / ____/ /_/ / / / / ,< (__  ) 
// |__/|__/_/   \___/\___/_/|_/_/_/ /_/\__, /_/    \__,_/_/ /_/_/|_/____/  
//                                    /____/                               
//     
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x22DD09d9FC054177BDe3FAe785fD86dCF4323995];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmaVYuzxnTzdV7p3Ynzi9FbcevMWDuowRPyq42XtVjAXgA/";
...
// File: contracts/WreckContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WreckContract is RamppERC721A {
    constructor() RamppERC721A("Wreck", "WREC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/N6eM9UpsmLaOPoXEgFgw/contract-metadata";
    }
}
