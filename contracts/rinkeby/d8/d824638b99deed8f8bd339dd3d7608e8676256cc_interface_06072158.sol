...
//import "./metadataLib.sol";
contract interface_06072158 is ERC721{
    using strings for *;
   ...
   // string baseURI = "";
    ...
    m_06072158 mainContract = m_06072158(0x8a4985F63e40243607c202116Aa8ae03479878E3);
    
    constructor() ERC721("interface_06072158" , "interface_06072158" ) {
    ...
    function setMainContruct(address _address)public onlyOwner{
        mainContract = m_06072158(_address);
    }
