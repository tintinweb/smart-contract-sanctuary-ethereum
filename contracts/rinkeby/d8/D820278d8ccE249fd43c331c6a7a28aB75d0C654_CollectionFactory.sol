...
contract CollectionFactory is Withdrawable, ERC721A{
  ...
  // NEED TO CHANGE NAME AND TICKER !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    */
    function acceptBid(
      ...
      bytes calldata _signature
        ...
        // console.log("artist", _auctionDetails.buyer);
      if(msg.sender == _auctionDetails.artist || msg.sender == _auctionDetails.buyer){
         ...
         // Verifying signature
         bool isVerified = verifyParams(_auctionDetails, _signature);
        ...
        console.log("tokenId", mintedTokenId);
         ...
         mint(_auctionDetails.auctionID, _auctionDetails.tokenURI, _auctionDetails.buyer, mintedTokenId);
     ...
     * @param _tokenId Buyer of NFT
    */
    function mint(uint256 _auctionId, string memory _tokenURI, address _buyer, uint256 _tokenId) internal {
    ...
    */
    function verifyParams(AuctionDetails memory _auctionDetails, bytes calldata _signature) internal view returns(bool) {
