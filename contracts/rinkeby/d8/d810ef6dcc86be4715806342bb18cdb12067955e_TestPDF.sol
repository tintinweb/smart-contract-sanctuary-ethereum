...
contract TestPDF is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Test PDF", "TsTpDf"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more TestPDF...");
