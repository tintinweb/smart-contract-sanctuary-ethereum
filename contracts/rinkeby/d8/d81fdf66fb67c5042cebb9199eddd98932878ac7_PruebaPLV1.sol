...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721B[email protected]
...
contract PruebaPLV1 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address devWallet = 0x04f152920AA7d69ad4769f716009d5B552484D84;
    address charityWallet = 0x9Bb8CC71019049736B11c1fA9ceCb8950acEB387;
    
    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Prueba Prelaunch 1', 'PPLV1') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 30; i++) internalMint(to);
    }
