...
contract MoonBats is ERC721A, ERC721AQueryable, Owned {
  ...
  uint256 constant maxSupply = 2223;
  uint256 constant maxPerTx = 11;
  ...
  function mint(uint256 _quantity) external payable {
    unchecked {
      ...
      require(_totalSupply + _quantity < maxSupply, "MAX SUPPLY REACHED");
      require(_quantity < maxPerTx, "MAX PER TRANSACTION IS 10");
