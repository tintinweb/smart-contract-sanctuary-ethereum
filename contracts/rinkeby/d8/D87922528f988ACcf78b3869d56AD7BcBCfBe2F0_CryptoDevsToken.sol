...
contract CryptoDevsToken is ERC20, Ownable {
    ...
    // we r giving 10 tkns for 1 nft
    uint256 public constant maxTotalSupply = 10000 * 10**18;
    // contract instance

    ICryptoDevs CryptoDevsNFT;
    // keeping track of claimed tokenIDs
    ...
    function mint(uint256 amount) public payable {
        ...
        // making sure enough money is there
    ...
    function claim() public {
        ...
        uint256 amount = 0; // this is the amount of tokens they will get

        for (uint256 i = 0; i < balance; i++) {
            // only claim the tokens that haven't been claimed yet
