...
contract RefractionSeason0Pass is ERC1155, Ownable, ReentrancyGuard {
    ...
    function greenlistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
        ...
        amountMintedPerWallet[_msgSender()] = 1;
    ...
    function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
        ...
        require(tx.origin == msg.sender && msg.sender != address(0), "no contracts pls");
        require(amountMintedPerWallet[msg.sender] < maxPerWallet, "wallet has minted too many");
        _mint(msg.sender, 1, _mintAmount, "" );
        totalMinted += _mintAmount;
    }
    ...
    function reserve(uint _mintAmount, address _receiver ) public mintCompliance(_mintAmount) onlyOwner {
