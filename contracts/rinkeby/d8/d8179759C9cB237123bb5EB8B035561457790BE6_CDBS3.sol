...
contract CDBS3 is ERC721, Ownable {
    ...
    {
        metadataURI[0] = "ipfs://QmcENAp91phXWRT7JpEpAasVve4oCsYbev56HNHD2BgLjE/0/";
        metadataURI[1] = "ipfs://QmfUxUc1iu2RQSm1AygUEtX7giPrrzhvhKToQ4biQcimLf/1/";
        metadataURI[2] = "ipfs://Qmeo1JdaA4hufbKneRQVNYQS5BJGGziBr4k14gzHeCgb9L/2/";
        metadataURI[3] = "ipfs://QmUQu8Q66QYW2pn77oojimEQhvjH8tCs1jMbDHj43tcCFu/3/";
        metadataURI[4] = "ipfs://Qmd8YGp9yUKtXas1cT3UsYFpWwfWHvV4Bssj8Pbvrq6BZ5/4/";
        metadataURI[5] = "ipfs://QmfWsA2JKaDE3ipd8FdLHsayGQ6PQ4wVAfCK4PEb1ykUif/5/";
        metadataURI[6] = "ipfs://QmdDkgz1a85LaJZxEr6awGCaf2CpZBMWc9eQ1ezEh8sqJW/6/";
        metadataURI[7] = "ipfs://QmaduZqVgbqtJAoW7eyejNSLVsqXVeaRPC5HkG1SeGCyut/7/";
        metadataURI[8] = "ipfs://QmQLmSXT5zY6XcNrdwhX8GbGc9QrbEhbwvEmjggRBxKeib/8/";
        metadataURI[9] = "ipfs://QmTLx6G5hUDCoV8aBbXLuuV1kaUwd6KiSrARUJUHLGhEcP/9/";
        metadataURI[10] = "ipfs://QmZodri3bfsGebBBBjeBAJLztq6DmQLDqiXi4LhEeU2QCS/10/";
    }
    ...
    function tokenURI(uint256 tokenId) public view  override returns (string memory) {
        ...
        uint grouping = tokenId / metadataURIrange;
        ...
        duringSale
    {
        ...
        require(
            msg.value == discountPrice * quantity,
            "Wrong amount of ether sent!"
        );
        ...
        onlyOwner 
    {
        ...
        require(
            totalSupply + totalMintRequested <= maxTokens,
            "Minting this many would exceed supply!"
        );
    ...
    //mint
    function minter(address sender, uint256 quantity) 
        internal 
    {
