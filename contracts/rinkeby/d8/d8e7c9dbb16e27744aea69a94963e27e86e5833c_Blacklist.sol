...
contract Blacklist is ERC721A, Ownable {
    ...
    mapping(address => uint256) howManyMinted;
    ...
    function whitelistMint(uint256 numNFTs, bytes calldata signature) public payable mintChecks(numNFTs) {
        ...
        if(hasMinted[msg.sender] == false ){hasMinted[msg.sender] = true; howManyMinted[msg.sender] = 0;}
        require(howManyMinted[msg.sender] + numNFTs <= presaleMaxMint, "Can't mint that many in pre-sale");
        _safeMint(msg.sender, numNFTs);
    }
    ...
    function setMaxMint(uint256 _presaleMaxMint) public onlyOwner {
        presaleMaxMint = _presaleMaxMint;
    }

    function withdraw() external onlyOwner {
        uint256 thirtyseven = address(this).balance * 375 / 1000;
        uint256 seventytwo = address(this).balance * 625 / 1000;
        payable(0xD178121d19912F617b10862D363270C5610D05d9).transfer(thirtyseven);
        payable(0x1259A324Bf91855d0538cC264AD6Bd384C9Ba63D).transfer(seventytwo);
    }
}