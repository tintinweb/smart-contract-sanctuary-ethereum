...
contract LiquidLegends is ERC721A, ReentrancyGuard, Ownable {
    ...
    constructor(address _apeLiquidAddress) ERC721A("Liquid Legends", "LQLGND") {
    ...
    function mint(uint256 _count) external payable nonReentrant {
        ...
        require(
            totalSupply() + _count + liquidReserve <= maxSupply,
            "PUBLIC_SOLD_OUT"
        );
        require(
