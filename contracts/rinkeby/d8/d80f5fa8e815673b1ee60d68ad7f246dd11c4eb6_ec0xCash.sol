...
// File contracts/examples/ec0xCash.sol
...
contract ec0xCash is BasedOFT {
    constructor(address _layerZeroEndpoint, uint _initialSupply) BasedOFT("ec0xCash", "0xCash", _layerZeroEndpoint) {
