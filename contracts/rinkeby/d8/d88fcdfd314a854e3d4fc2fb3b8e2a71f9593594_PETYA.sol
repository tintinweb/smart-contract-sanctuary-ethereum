...
contract PETYA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Gordon's Bag";//
    string private constant _symbol = "BAG";//
    ...
    address payable private _developmentAddress = payable(0xc756642b6F5D2E0E1F2EA576f70ecfd5B36fb7c9);
    address payable private _marketingAddress = payable(0x43be52DF60e3B0Ba69eD7B13Cc3Ac5469C04BF31);
    address payable private _ukraineDonation = payable(0x165CD37b4C644C2921454429E7F9358d18A45e14);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_ukraineDonation] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingAddress.transfer(amount.div(10).mul(9));
        _ukraineDonation.transfer(amount.div(10).mul(1));
    }
