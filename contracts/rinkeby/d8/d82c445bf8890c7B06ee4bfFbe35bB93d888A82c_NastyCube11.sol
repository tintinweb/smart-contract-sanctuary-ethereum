...
contract NastyCube11 is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    if (msg.value == 0 && freeBuy[msg.sender] == false) {
      require(_mintAmount == 1, "You can't mint more than 1 free NFT");
    ...
    require(limitToBuy[msg.sender] < mintLimit, 'You bought a maximum');
    _;
    limitToBuy[msg.sender]++;
  }
