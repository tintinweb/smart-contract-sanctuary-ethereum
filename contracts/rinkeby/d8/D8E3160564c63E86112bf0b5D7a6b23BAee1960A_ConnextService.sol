...
contract ConnextService is Ownable, Pausable, IMdexCrossChainSwap, MdexController {
    ...
    function connextSwap(
        ...
        (, , originDomain, ) = abi.decode(payload, (address, address, uint32, uint32));
        ...
        CallParams memory callParams = _normalizeData(amount, payload, apiPayload);
    ...
    function _normalizeData(
        ...
        bytes calldata payload,
        bytes calldata apiPayload
    ) internal returns (CallParams memory) {
        uint32 originDomain;
        uint32 destinationDomain;
        address sender;
        address tokenDestinationAddress;
        ...
        (isSpiltSwap, routeIndex) = abi.decode(apiPayload, (bool, uint256));
