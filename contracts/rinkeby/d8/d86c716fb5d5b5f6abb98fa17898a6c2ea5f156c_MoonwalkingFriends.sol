...
contract  MoonwalkingFriends  is ERC721Enumerable, Ownable
{
    ...
    constructor() ERC721("Moonwalking Friends", "MWF")  {
    }
    ...
    function getPrice(uint256 _quantity) public view returns (uint256) {
     ...
     function airdrop(address _address , uint chosenAmount ) public onlyOwner {
