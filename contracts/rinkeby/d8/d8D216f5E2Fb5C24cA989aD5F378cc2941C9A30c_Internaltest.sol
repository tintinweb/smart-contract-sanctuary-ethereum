...
contract Internaltest is ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 100; // Maximun mint ACE
    uint256 public maxMintAmount = 6; //How many can mint for one buyer
    uint256 public maxPreMintAmount = 2; //How many can pre mint in one times
    ...
    constructor() ERC721("YMK UAT", "NFT") {}
    ...
    */
    ...
    /*
        PUBLIC FUNCTION
     */
    function checkCostAmount(uint256 mintAmount) public view returns (uint256){
        if(mintPaused){
