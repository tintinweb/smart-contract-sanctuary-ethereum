...
contract Staking is AccessControl {
  ...
  function claim() external {
    require(wallets[msg.sender].createdAt + rewardPeriod <= block.timestamp, "Too soon");
    updateReward();
  ...
  function setLockStakePeriod(uint256 value) external positive(value) onlyRole(DAO_ROLE) {
