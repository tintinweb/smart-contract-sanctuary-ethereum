...
contract Sale {
    ...
    /// Constanta declarations of utils used inside contract.
    ...
    /// Deployer of the contract, assigned in the constructor.
    ...
    constructor(address _treasury, address[] memory _whitelisted) {
        owner = msg.sender;
        whitelisted = _whitelisted;
        spaceCoinToken = new SpaceCoin(msg.sender, _treasury, address(this));
    }

    /// Modifier that verifies if the caller is the owner
    modifier onlyOwner() {
