    ...
    ShinikiTransfer
{
    ...
    function claim(
        ...
        require(receiver != address(0), "ShinikiFund: receiver is not zero");
        require(receiver == msg.sender, "ShinikiFund: caller is not receiver");
        require(
        ...
        if (token == address(0)) {
            ...
            transferToken(token, WALLET_REWARD, receiver, amount);
        }
    }
