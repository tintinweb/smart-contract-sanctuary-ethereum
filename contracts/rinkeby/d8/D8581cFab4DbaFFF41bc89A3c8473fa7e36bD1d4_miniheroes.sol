...
contract miniheroes is Ownable, ERC721A, ReentrancyGuard {

    //allows for 130 tokens to be minted by team
    uint256 public MAX_TEAM_RESERVES_PRESALE = 130;
    //sets immutable value for total collection of 2222
    ...
    uint256 public MAX_MINTS_PER_TX = 130;
    ...
    uint256 collectionSize_,
    uint256 maxTOKENS_
  ) ERC721A("Miniheroes","MH", maxBatchSize_,collectionSize_) {
