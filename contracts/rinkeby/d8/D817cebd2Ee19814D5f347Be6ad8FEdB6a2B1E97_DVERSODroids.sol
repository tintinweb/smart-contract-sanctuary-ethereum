...
contract DVERSODroids is  ERC721, Pausable,Ownable,RandomlyAssigned , WithWithdrawals , WithTokenPrices, WithFees{

    string public cid;
    bool public revealed = false; 

    constructor() 
        ERC721("DVERSO - Droids", "DROID")
        RandomlyAssigned(100, 1)
        WithTokenPrices(0.1 ether)
        WithFees(payable(0x5211063C82D0CD0aB516a063206D50AA919eac75), 500)
    { 
        setCid('');
    }
    ...
    function safeMint (address to) external ensureAvailability() returns (uint256) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721,WithFees) returns (bool) {
