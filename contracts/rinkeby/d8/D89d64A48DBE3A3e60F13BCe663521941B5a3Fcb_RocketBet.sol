...
contract RocketBet is VRFConsumerBaseV2, Ownable {
    ...
    constructor(uint64 subscriptionId, address _rocketToken, address _devWallet) VRFConsumerBaseV2(vrfCoordinator) {
  ...
  function placeBet(uint256 wager, uint16 bet) public payable {
      ...
      require(activeBets < 4, "max active games");
      require(!playerInfo[msg.sender].activeGame, "player already has active bet");
      ...
      playerInfo[msg.sender].activeGame = true;
      activeBets += 1;
  ...
  function fulfillRandomWords(
    ...
    uint256[] memory randomWords
      ...
      if(_bet.choice == winningBet){
          ...
          playerInfo[msg.sender].activeGame = false;
