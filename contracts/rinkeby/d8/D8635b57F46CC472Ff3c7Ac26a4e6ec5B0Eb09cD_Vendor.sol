...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    //figuring out how many tokens should be bought per eth
    uint256 tokensBought = msg.value * tokensPerEth;
    //require that the token balance should be greater than the tokenspurchased
