...
contract HedgeWorld is ERC721A, Ownable, Pausable {
    uint256 public maxSupply = 1000;

    uint256 public keyAmountPrice = 5;
    uint256 public publicPrice = 0.1 ether;
    uint256 public whitelistPrice = 0 ether;

    bool public isKeySaleEnabled = false;
    bool public isPublicSaleEnabled = false;
    bool public isWhitelistSaleEnabled = false;
    ...
    constructor() ERC721A("Hedge World", "HW") {
        _pause();
    }
