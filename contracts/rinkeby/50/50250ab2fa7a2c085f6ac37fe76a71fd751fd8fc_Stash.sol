    ...
    ERC721Stashable
{
    ...
    IERC721 public constant TOY =
        IERC721(0xd2A2A25B31848e2f9d22129e711cB7a4D4229077);
        //IERC721(0xBF662A0e4069b58dFB9bceBEBaE99A6f13e06f5a);
    IERC721 public constant KIT =
        IERC721(0x721e0B75098cF0157E1026F95813f498326DC4AB);
        //IERC721(0x5ff1863753C1920C38c7BaE94576f2831eF99695);

    uint256 constant PRICE_PER_TOKEN = 0.0025 ether; // TODO
    error Ended();
    error NotStarted();
    error NotEOA();
    ...
    SaleParam public saleParams; //20-24
    ...
    function initialize() public initializer {
        ...
        __Ownable_init();
        setPublicSale(1561014800, 1662210000, 4444, 11111);
        //setPublicSale(1661014800, 1662210000, 4444, 11111); // TODO
