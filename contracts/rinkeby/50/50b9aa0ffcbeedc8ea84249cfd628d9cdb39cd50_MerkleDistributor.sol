...
contract MerkleDistributor is Ownable {
    ...
    /// @notice Claims end after block.timestamp passes this value
    ...
    event ExpirationChanged(uint256 oldExpiration, uint256 newExpiration);
    ...
    function claim(
        ...
        require(block.timestamp < expiration, "MerkleDistributor: expired");
    ...
    /// @notice Changes the expiration
    function setExpiration(uint256 expiration_) external onlyOwner {
        emit ExpirationChanged(expiration, expiration_);
        expiration = expiration_;
    }
    ...
    function end() external onlyOwner {
        require(block.timestamp > expiration, "MerkleDistributor: not expired");
