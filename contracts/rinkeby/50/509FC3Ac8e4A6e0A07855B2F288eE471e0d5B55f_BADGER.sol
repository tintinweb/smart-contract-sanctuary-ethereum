...
contract BADGER is Ownable, ERC721 {
    ...
    constructor() ERC721("Crypto Badger Clan", "CBC"){
        pre_one_package=0.1 ether;
        pre_two_package=0.2 ether;
        pre_three_package=0.5 ether;

        one_package=0.1 ether;
        two_package=0.2 ether;
        three_package=0.5 ether;
