...
import {IDepoExchange} from "./interfaces/IDepoExchange.sol";
...
/**
 * @title DepoExchange
 * @notice It is the core contract of the Depo exchange.
 */
contract DepoExchange is IDepoExchange, ReentrancyGuard, Ownable {
