...
contract Swap is Initializable, OwnableUpgradeable, ChainlinkClientUpgradeable {
    ...
    uint256 private BUY_INDEX = 0;
    uint256 private SELL_INDEX = 0;
    ...
    uint256[] public rate;//0 index conotains buy and 1 coontains sell
    bytes32[] private chainlinkRequestId;//0 index conotains buy and 1 coontains sell
    
    uint256 private fee;
    
    uint256[] lastTimeStamp;//0 index conotains buy and 1 coontains sell
    uint256[] lastPriceFeed;//0 index conotains buy and 1 coontains sell
    uint256 rateTimeOut;
    ...
    function setBuyInitialPrice() external onlyOwner{
         //getting initial value for both buy and sell price
        setPriceFeed(BUY_INDEX);
    }

    function setSellInitialPrice() external onlyOwner{
         //getting initial value for both buy and sell price
