...
contract KodachiToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x805B9Bd203ad2B69A241AE5084abEE11183f9429); // Marketing Address
    address payable public devAddress = payable(0xfD22068Bf2C956bD6f4ab812F11354FB7d7dea35); // Dev Address
    ...
    string private _name = "Kodachi Token";
    string private _symbol = "KODACHI";
    uint8 private _decimals = 18;


    uint256 public _taxFee = 20;  // rfi tax
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public marketingDivisor = 40;
    uint256 public devDivisor = 20;
    uint256 public autoLpDivisor = 20;

    uint256 public _totalFee = 80;  // marketingDivisor + devDivisor + autoLpDivisor
    uint256 private _previousTotalFee = _totalFee;
    uint256 public sellFactor = 20; // divided by 10
    bool public isBuyTaxEnabled = true;

    uint256 public _maxTxAmount = 100 * 10**6 * 10**18;
    uint256 private minimumTokensBeforeSwap = 1 * 10**6 * 10**18; 
    ...
    constructor () {        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x118dFC34100aE8a0B79a5D67F808C0F75f548a75);
