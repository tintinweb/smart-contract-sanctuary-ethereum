...
contract AlienPunkCommunity is ERC1155Supply, ERC1155Burnable, Ownable {
    ...
    uint256 private tokensAvailableToMint = 65 + 1;
    ...
    uint256 public mintsRemaining = 1000;
    ...
    function setMintsRemaining(uint256 remaining) external onlyOwner {
    ...
    function mint(uint quantity) external {
        ...
        for(uint i; i < quantity; i++) {
            tokenIds[i] = uint(keccak256(abi.encodePacked(block.timestamp, msg.sender, i))) % tokensAvailableToMint;
