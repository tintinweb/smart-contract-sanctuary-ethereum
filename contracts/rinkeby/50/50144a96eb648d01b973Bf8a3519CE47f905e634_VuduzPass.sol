...
contract VuduzPass is ERC721, Ownable {
    ...
    constructor() payable ERC721('Vuduz Pass', 'VDZP') {
        ...
        setHiddenMetadataUri("https://orion.mypinata.cloud/ipfs/QmceX6kgrC1h4EHprndf42WdpAcpQ1uf2gzk6oUmqeoKPv/hiddenrinkeby.json");
        isRevealed = false;
    ...
    string private customContractURI = "https://orion.mypinata.cloud/ipfs/QmfY2t8fibUV1aGW16qzRFticc2u4rWor1pLYmCPHrNoNy/metadatarinkeby.json";
    ...
    //Vuduz Pass Future
    function mint() public payable callerIsAWallet {
        uint256 quantity = 1;
        uint256 newTokenId = totalSupply + quantity;
