...
contract RandomNum is VRFConsumerBaseV2 {
    uint64 s_subId;
    ...
    function getVRFNum() public returns (uint256 requestId) {
        requestId = COORDINATOR.requestRandomWords(s_keyHash, s_subId, requestConfirmations, callbackGasLimit, numWords);
    }
