...
contract SixNiner is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("SixNiner", "SixNiner") {
        publicMaxMint = 2;
        presaleMaxMint = 2;
        maxSupply = 5;
        price = 0.1 * 10**18; // 0.1ETH
        status = Status.NotActive;
        whitelistRoot = 0x8a0696c294b5bf050ced7767463682b64ef33652f05e53969f810a957016ba55;
        baseURI = 'ipfs://QmQEQPNDGTUnSyA1QDxQpsZfz5QjAnkA247t8rcmc5DGG7/';
    }
    ...
    function presaleMint(uint256 amount, bytes32[] calldata proof)
        ...
        nonReentrant
    {
        require(status == Status.PreSale, "69: Presale is not active.");
        require(
            amount <= presaleMaxMint,
        ...
        require(
            _numberMinted(msg.sender) + amount <= presaleMaxMint,
