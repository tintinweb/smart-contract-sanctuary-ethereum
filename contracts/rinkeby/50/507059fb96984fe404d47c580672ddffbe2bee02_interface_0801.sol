...
//import "./metadataLib.sol";
contract interface_0801 is ERC721{
    using strings for *;
   ...
   // string baseURI = "";
    ...
    m_0801 mainContract = m_0801(0x2db23c0f4173FA1DAc5F70ABb041Eb819cF9b712);
    
    constructor() ERC721("interface_0801" , "interface_0801" ) {
