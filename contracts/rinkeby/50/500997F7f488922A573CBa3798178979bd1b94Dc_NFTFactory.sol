...
interface IHSNLBP is IERC20Minimal {
    function mint(address to, uint256 amount) external;
    function burn(uint256 amount) external;
}

contract HSNLNFT is ReentrancyGuard, Ownable, ERC721URIStorage, ERC721Royalty {
    /******************************** Constant ********************************/
    ...
    /**************************** Internal function ***************************/
    function isQualifiedMint(address buyer, uint256 mintAmount, uint256 bpAmount) internal returns (bool) {
    ...
    function collectBuyerToken(address buyer, uint256 paymentAmount, uint256 bonusPointAmount) internal nonReentrant returns (bool) {
    ...
    //function collectBuyerTokenPermit() internal; // Transfer tokens with EIP-2612
