...
contract testoflight is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("testoflight", "tol") {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_ETHEREUM - GIFT_RESERVED, "Mint exceeds supply");
