...
contract NonstopFuckingTrouble is ERC721A, Ownable {
    uint256 public MaxPerTx = 30;
    uint256 public maxSupply = 6969;
    uint256 public MaxFreePerWallet = 5;
    uint256 public totalFree = 500;
    uint256 public mintStartTime = 1654170900;
    uint256 public price = 0.01 * 10**18;
    string public baseURI =
        "ipfs://";

    constructor() ERC721A("NonstopFuckingTrouble", "NFT") {}
    ...
    function mint(uint256 amount) external payable {
        require(totalSupply() + amount <= maxSupply, "no more to mint.");
        require(block.timestamp >= mintStartTime, "Sale is not active yet.");
        ...
        require(msg.value >= amount * cost, "eth is not enough  to mint");
