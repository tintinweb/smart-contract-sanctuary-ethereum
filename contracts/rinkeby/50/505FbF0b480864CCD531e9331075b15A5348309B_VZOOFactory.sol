...
contract VZOOFactory is FactoryERC721, Ownable {
    ...
    constructor() {
        ...
        nftAddress = 0xDD7d29425EBCdCE80224Ee97e0844c47aC4e0a4d;
    ...
    /// @dev Reclaim ownership of the collection contract.
    function reclaimOwnership(address newOwner) public onlyOwner {
        require(owner() == newOwner, "new owner must be this contract owner");
        VZOO vzoo = VZOO(nftAddress);
        vzoo.transferOwnership(newOwner);
    }
