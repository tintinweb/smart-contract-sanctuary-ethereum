...
teamVestingWallet = new VestingWallet(devAddr, uint64(block.timestamp), uint64(31536000));//31536000s = 1years
transfer(address(teamVestingWallet),(initialSupply.mul(15).div(100))); // Send 15% of tokens to dev wallet 10,000,000,000 bibtoken
...
privateSaleVestingWallet = new VestingWallet(privateSaleAddr, uint64(block.timestamp) + uint64(31536000), uint64(31536000));
transfer(address(privateSaleVestingWallet),(initialSupply.mul(15).div(100)));
...
nftVestingWallet = new VestingWallet(nftminingAddr, uint64(block.timestamp), uint64(126144000));//31536000 * 4
transfer(address(nftVestingWallet),(initialSupply.mul(16).div(100))); // Send 8% of tokens to liquidity wallet 6,000,000,000 bibtoken
