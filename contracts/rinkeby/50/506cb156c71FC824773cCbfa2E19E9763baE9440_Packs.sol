...
contract Packs is ERC721A, Ownable, Pausable {
    ...
    constructor(address _snac) ERC721A("SPACKS", "SPACKS") {
        ...
        tiers["bronze"] = Tier(30, 0.01 ether, 1000);
        tiers["silver"] = Tier(60, 0.02 ether, 1000);
        tiers["gold"] = Tier(100, 0.03 ether, 1000);
    }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        return string(abi.encodePacked(baseTokenURI, stakes[_tokenId].tier, "/", _tokenId));
    }
}
