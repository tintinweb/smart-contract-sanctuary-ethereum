...
// File contracts/FightersNFTs.sol
...
contract FightersNFTs is ERC721, ERC721Enumerable {
    ...
    constructor(uint256 _maxSupply) ERC721("FightersNFTs", "FGTRS") {
    ...
    function mint() public {
        ...
        require(current < maxSupply, "No Fighters left :(");
        ...
        returns(string memory) 
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "Fighter #',
                tokenId.toString(),
                '", "description": "Fighter de la coleccion de FightersNFTs", "image": "',
                image,
                "attributes: [ {categoria: Novato, rareza: Simple}, {categoria: Veterano, rareza: rara}, {categoria: Maestro, rareza: Muy rara}, {categoria: Leyenda, rareza: Mistico} ]",
                '"}'
            )
        );
