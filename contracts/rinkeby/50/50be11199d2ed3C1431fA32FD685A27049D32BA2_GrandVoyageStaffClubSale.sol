...
contract GrandVoyageStaffClubSale is Ownable, ReentrancyGuard {
    using MerkleProof for bytes32[];

    uint256 public whiteListSaleStartTime = 1661004000; // 8/20 2pm  
    uint256 public whiteListSaleEndTime = 1661090400; // 8/21 2pm
    uint256 public remainingCount = 1800;  //1800 + 222 

    address public grandVoyageStaffClub;
    bytes32 public whiteListMerkleRoot;

    constructor(address _grandVoyageStaffClub) {
        grandVoyageStaffClub = _grandVoyageStaffClub;
    }
        ...
        internal
    {
        ...
        NFT(grandVoyageStaffClub).mint(msg.sender, numberOfTokens);
    }
