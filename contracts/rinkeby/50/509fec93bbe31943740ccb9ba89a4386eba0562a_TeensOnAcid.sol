...
contract TeensOnAcid is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public PUBLIC_PRICE = .005 * 10**18;
    ...
    constructor(string memory initBaseURI) ERC721A("TeensOnAcid", "TOA") {
        baseURI = initBaseURI;
      ...
      onlyOwner
  {
    ...
    function teamMint(uint quantity, address user)
    public
    onlyOwner
  {
    require(
