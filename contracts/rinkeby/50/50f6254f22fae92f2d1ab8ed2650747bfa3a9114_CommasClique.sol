...
contract CommasClique is ERC721A, Ownable 
{
    ...
    string public notRevealedUri = "ipfs://hiddenCID/hidden.json";                      //these 2 can be set before deployment
    bytes32 root = 0x14a5fcc272140b493e9019653a01f9de0a1fecdf734e9757a548824239e6a931;  //these 2 can be set before deployment
    mapping(address => uint) public addressMintedBalance;

    address payable private devgirl = payable(0x17b8E1929Be4a096e00E581f75a6D37AC9ce7B7b);
