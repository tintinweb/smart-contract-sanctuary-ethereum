...
/// @title GmStudio Example
contract GmStudioExample is ERC721Common, ReentrancyGuard {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    uint32 public constant MAX_MINT_PER_TX = 2;

    /// @notice Number of mints throught the signed minting interface.
    uint32 internal constant NUM_SIGNED_MINTS = 400;
    ...
    ) ERC721Common("GmStudio Example", "GME") {
        _signers.add(signer);
        _baseTokenURI = baseTokenURI;

        // @dev Once deloyed, this can be changed to make use of ethier's
        // PaymentSplitter factory. See under
        // https://github.com/divergencetech/ethier/blob/main/factories/finance/PaymentSplitterFactory.sol
        paymentSplitter = payable(address(new PaymentSplitter(payees, shares)));
