...
//*********************************************************************//
//
// Crypto Arbitro Contract Deployer
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZJL7e9xFYz2JpouodREMVqk6KWF9CDTkd6qEBHzt7bak/";
...
// File: contracts/OutoftheworldDudesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OutoftheworldDudesContract is RamppERC721A {
    constructor() RamppERC721A("Out of the world Dudes", "OWD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Oh8UAOJLUtUc2taEAWpp/contract-metadata";
    }
}
