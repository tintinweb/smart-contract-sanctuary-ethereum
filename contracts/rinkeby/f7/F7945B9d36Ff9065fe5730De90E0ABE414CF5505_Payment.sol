...
contract Payment is Ownable {
    ...
    function rewardCustomer(address addr) external returns (bool) {
    ...
    function setBasePrice(uint256 price) public onlyAdmin returns (bool) {
        basePrice = price;
        return true;
    }

    function setTokenReward(uint256 reward) public onlyAdmin returns (bool) {
        tokenReward = reward;
        return true;
    }
...
contract NestToken is ERC20, Ownable {
    ...
    function setPaymentContract(address addr) public returns (bool) {
    ...
    function sellTokens(uint256 amount) public {
        ...
        uint256 totalEther = ethAmount * amount;
