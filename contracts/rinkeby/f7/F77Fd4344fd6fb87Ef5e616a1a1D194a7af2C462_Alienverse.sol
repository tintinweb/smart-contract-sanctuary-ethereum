...
contract Alienverse is ERC721A, Ownable, PaymentSplitter {
    ...
    modifier canMintWl(uint256 qty, bytes32[] calldata merkleProof) {
        ...
        require(msg.value == wlPrice * qty, "Invalid value");
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(
            MerkleProof.verify(merkleProof, fcMerkleRoot, leaf),
