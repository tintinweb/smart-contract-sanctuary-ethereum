...
contract Jukiverse is ERC721A, ERC2981, EIP712, Ownable {
    ...
    uint256 public constant WL_SUPPLY = 2172;
    bytes32 public constant MINTER_TYPEHASH = 
        keccak256("Minter(address recipient,uint256 amount)"); 
    address private constant WALLET_A = 0xdeadAF6bBeF5d815aea569Da44eF09E39F2bBEf8;
    address private constant WALLET_B = 0xdeadAF6bBeF5d815aea569Da44eF09E39F2bBEf8;
    address private constant WALLET_C = 0xdeadAF6bBeF5d815aea569Da44eF09E39F2bBEf8;
        ...
        payable 
    {
        ...
        require(WhitelistMint[msg.sender] + _amount <= _limit, "LIMIT_EXCEDEED");
        require(signer == _verify(_msgSender(), _limit, _signature), "INVALID_SIGNATURE");
        require(totalSupply() + _amount <= WL_SUPPLY, "SUPPLY_EXCEDEED");
        ...
        payable 
    {
        ...
        require(PublicMint[msg.sender] + _amount <= PUBLIC_LIMIT, "LIMIT_EXCEDEED");
        require(totalSupply() + _amount <= MAX_SUPPLY, "SUPPLY_EXCEDEED");
        require(msg.value >= (PRICE * _amount), "INSUFFICIENT_FUND");

        PublicMint[msg.sender] += _amount;
        _mint(msg.sender, _amount, "", false);
        ...
        onlyOwner 
    {
        ...
        sendValue(payable(WALLET_A), walletBBalance);
        sendValue(payable(WALLET_A), walletCBalance);
    }
