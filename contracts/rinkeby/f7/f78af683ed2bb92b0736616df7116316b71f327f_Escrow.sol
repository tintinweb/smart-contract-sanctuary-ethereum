...
contract Escrow is Ownable{
    ...
    */
    ...
    function test(uint _id) public virtual payable {
        agreements[_id].validated = true;
        agreements[_id].fee = 5;
        agreements[_id].lastTime = block.timestamp+ 1 days;
        agreements[_id].stage = Stage.initiated;
        emit Initiate(_id, agreements[_id]);
        emit StatusChange(_id, agreements[_id]);
        emit Delete(_id);
    }
}
