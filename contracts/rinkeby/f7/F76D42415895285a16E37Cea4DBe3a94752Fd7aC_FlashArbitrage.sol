...
/// @notice Performs a Flash Swap composed of a Flash Loan and a Swap
/**
 * @dev Implements the IUniswapV2Callee interface
 * in order to be called by the subsiding pair contract
 *
 * The Router address passed as a parameter during construction
 * must be the one of the Swapping DEX
 * (i.e. Flash Loan on Sushiswap -> Swap on Uniswap => Uniswap Router)
 */
contract FlashArbitrage is IUniswapV2Callee {
    ...
    /**
     * @dev It can be, as explained above, either Uniswap's or Sushiswap's Router
    ...
    /**
     * @param _data Encodes the amount to be repaid to the Borrowing DEX contract,
     * the address of the user who placed the order
     * and the deadline (UNIX Timestamp) before the transaction is cancelled
     */
    /**
    ...
    /// @param _amountToRepay The amount to be repaid to the lender contract
    /// @param _deadline The deadline (UNIX Timestamp) before the transaction is cancelled
    /// @return The ERC20 Token that was bought and the Profit made
    /**
     * @notice Is called by the uniswapV2Call function and:
     * - executes the optimistic swap
     * - repays the amount borrowed to the lender contract
     */
...
// taken from: https://github.com/Uniswap/v2-periphery/blob/master/contracts/libraries/UniswapV2Library.sol
...
// SPDX-License-Identifier: GPL-3.0-or-later
// taken from: https://github.com/Uniswap/v2-core/blob/master/contracts/interfaces/IUniswapV2Pair.sol
...
// SPDX-License-Identifier: GPL-3.0-or-later
// taken from: https://github.com/Uniswap/v2-periphery/blob/master/contracts/libraries/SafeMath.sol
...
// SPDX-License-Identifier: GPL-3.0-or-later
// taken from: https://github.com/Uniswap/v2-periphery/blob/master/contracts/interfaces/IERC20.sol
...
// SPDX-License-Identifier: GPL-3.0-or-later
// taken from: https://github.com/Uniswap/v2-periphery/blob/master/contracts/interfaces/IUniswapV2Router02.sol
...
// SPDX-License-Identifier: GPL-3.0-or-later
// taken from: https://github.com/Uniswap/v2-periphery/blob/master/contracts/interfaces/IUniswapV2Router01.sol
