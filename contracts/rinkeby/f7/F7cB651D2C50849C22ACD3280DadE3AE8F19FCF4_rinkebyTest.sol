...
contract rinkebyTest is ERC721A, Pausable, ReentrancyGuard, Ownable {
        ...
        ERC721A("rinkebyTest", "rinkebyTest")
    {
        ...
        saleConfig.ogPrice = 0.001 ether;
        saleConfig.whitelistPrice = 0.001 ether;
    ...
    event amountExceedsPublicSupply(string message);
        ...
        whenNotPaused
    {
        ...
        while (_mints < _amount) {
            ...
            else if (_publicSupply >= saleConfig.publicReserve) {
                emit amountExceedsPublicSupply("Public Supply Over Allocated");
            }
        }
