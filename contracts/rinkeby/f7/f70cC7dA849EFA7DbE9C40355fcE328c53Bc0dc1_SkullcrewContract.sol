...
//   $$\   $$ |$$  _$$<  $$ |  $$ |$$ |$$ |      $$ |  $$\ $$ |      $$   ____|$$ | $$ | $$ | 
//   \$$$$$$  |$$ | \$$\ \$$$$$$  |$$ |$$ |      \$$$$$$  |$$ |      \$$$$$$$\ \$$$$$\$$$$  | 
//    \______/ \__|  \__| \______/ \__|\__|       \______/ \__|       \_______| \_____\____/  
//                                                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3DA1c4b1c36dC39f74917776254f1ed5591d57E1];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 5555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRdf7U5mNkBD1D3ZhozvoNeMDK1GsUqjWBa9rEoJRLFjG/";
...
// File: contracts/SkullcrewContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SkullcrewContract is RamppERC721A {
    constructor() RamppERC721A("SKULL CREW", "SKC"){}
}
