...
contract NftPrismGalaxy is ERC721URIStorage, Ownable {
    ...
    function mint() public payable {
        ...
        string memory tokenURI = _renderTokenURI(currentId.current());
    ...
    function _renderTokenURI(uint256 tokenId)
        internal
        pure
        returns (string memory)
    {
        ...
        svg[
            0
        ] = "<svg viewbox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'><text font-size='2em' font-weight='bold' x='50' y='50'>";
        svg[1] = Strings.toString(tokenId);
        svg[2] = "</text></svg>";
