...
contract Fountain is BEP20, Whitelist {
    ...
    // My added vars
    uint256 MIN_ADD_LIQUIDITY = 1 ether;
    ...
    constructor () Ownable() public {
        // Edit begins
        address token_addr = 0xe3539425Ef17Eb9554CC47b559cb539C56Ed1983;
        MIN_ADD_LIQUIDITY = 0.001 ether;
        // Edit ends
    ...
    function addLiquidity(uint256 min_liquidity, uint256 max_tokens) isNotPaused public payable returns (uint256) {
        ...
        if (total_liquidity > 0) {
            ...
            require(msg.value >= MIN_ADD_LIQUIDITY, "INVALID_VALUE");
