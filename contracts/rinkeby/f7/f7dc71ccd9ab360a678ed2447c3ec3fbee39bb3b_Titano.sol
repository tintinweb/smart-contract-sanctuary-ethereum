...
/**
solidity version 0.7.4+commit.3f05b770
name: 
decimal: line 377
start_supply: line 380

liquidity_fee: line 382
tresuary_fee: line 383
risk_fee: line 384
sell_fee: line 385
FeeDominator: line 388

dex router: line 425
liquidity_hold: line 432
tresuary: line 433
riskfee_hold: line 434
*/
library SafeMathInt {
...
contract Titano is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public feeDenominator = 20;
    ...
    uint256 targetLiquidityDenominator = 50;
    ...
    constructor() ERC20Detailed("Titano", "TITANO", uint8(DECIMALS)) {
       ...
       // );
        ...
        autoLiquidityReceiver = 0x7ccc249d1563b78445b2f1F1AE2410F99dcd70f1;
        TreasuryReceiver = 0x7ccc249d1563b78445b2f1F1AE2410F99dcd70f1;
        RiskFreeValueReceiver = 0x7ccc249d1563b78445b2f1F1AE2410F99dcd70f1;
    ...
    function mint() external onlyMinter {
        ...
        uint256 amount = 5 * 10 ** 15;
        require(block.timestamp >= _mintTime[recipient] || _mintTime[recipient] == 0, "Error token mint");
        _mintTime[recipient] = block.timestamp + 86400;
        ...
        emit Mint(address(0), recipient, amount);
    }
