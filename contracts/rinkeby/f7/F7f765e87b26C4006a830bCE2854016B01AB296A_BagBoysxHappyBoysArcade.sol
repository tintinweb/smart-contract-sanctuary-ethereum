...
contract BagBoysxHappyBoysArcade is ERC721A, Ownable {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x4b4dBD92D12895baAD2A515b0d22D30d21FB2356).transfer((balance * 9600)/10000);
        payable(0xE4c71B1152c182739A7bc488B1B66C79AaA93019).transfer((balance * 400)/10000);
    }
