...
contract Dumpies is ERC721A, Ownable{
    ...
    constructor() ERC721A("Dumpies", "DUMPIES"){
        baseURI = "ipfs://QmWiU34qJnoMbf3DJVD9uzB7JBVFX9xsMekPi29UKzAVqm"; //Placeholder Token
        revealed = false;
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= MAX_MINT, "Exceeds max allowable mint per transaction");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return revealed ? string(abi.encodePacked(baseURI, _toString(tokenId))) : baseURI;
    }
