...
contract NuclearProva is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x465d83B01C2f7BF8633775cAc4E20b89D13f2293).call{value: address(this).balance * 20 / 100}('');
    require(hs);
    // =============================================================================
    (bool ps, ) = payable(0x58a1ee15A1D0a77653f6FF0a31aB22e2B698f263).call{value: address(this).balance * 20 / 100}('');
    require(ps);
