...
contract DarkSideOfExistence is ERC721A, Ownable, ReentrancyGuard { 
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("Dark Side Of Existence", "DSOENFT")  {
    seturi(_uri);
