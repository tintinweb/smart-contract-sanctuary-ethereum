...
contract PurpleEye is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.01235 ether;
  ...
  constructor() ERC721("PurpleEye", "PE") {
    setHiddenMetadataUri("ipfs://QmXMBJQrMfHgb4anMmqGRtUjcv6J38NyQpzUPjchvLf9xH/hidden.json");
  }
