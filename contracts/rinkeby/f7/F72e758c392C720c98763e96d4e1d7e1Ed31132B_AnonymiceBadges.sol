...
contract AnonymiceBadges is POAPBoard {
    ...
    function rearrangeBoardAndName(
        ...
        if (boardId != currentBoard[msg.sender]) _swapBoard(boardId);
    ...
    function previewBoard(
        ...
        return IDescriptor(descriptorAddress).buildSvg(boardId, badges, text);
    }
...
contract POAPBoard is Ownable, ERC721Bound {
    ...
    function _swapBoard(uint256 boardId) internal {
