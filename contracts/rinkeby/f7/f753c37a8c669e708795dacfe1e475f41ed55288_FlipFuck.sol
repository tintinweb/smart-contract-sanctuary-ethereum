...
contract FlipFuck is ERC721A, Ownable{
    using Strings for uint256;
    ...
    // Prices
    uint256 public FreeSalePrice = 0.00 ether;
    uint256 public PublicSalePrice = 0.00 ether;
    ...
    // Name and symbol
    constructor() ERC721A("Flip fuck", "Flip fuck"){
    ...
    function FreeMint(uint256 _quantity) external payable callerIsUser{
        require(FreeSale, "Private sale not yet active.");
        require((totalSupply() + _quantity) <= 2000, "Beyond max supply");
    ...
    function PublicMint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= 5969, "Beyond Max Supply");
    ...
    function setPlaceHolderUri(string memory _placeholderTokenUri) external onlyOwner{
     ...
     function setFreeSalePrice(uint256 _newFreeSalePrice) public onlyOwner {
    FreeSalePrice = _newFreeSalePrice;
    }
