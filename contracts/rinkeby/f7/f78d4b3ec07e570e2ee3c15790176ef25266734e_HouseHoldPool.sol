...
contract HouseHoldPool is UpgradeablePausable, IHouseHoldPool, AERC20Transfer {
  ...
  function drawdown(uint256 amount, address mortgage) external payable override onlyAdmin whenNotPaused {
...
interface IHouseHoldPool {
  ...
  function drawdown(uint256 amount, address borrower) external payable;
}
