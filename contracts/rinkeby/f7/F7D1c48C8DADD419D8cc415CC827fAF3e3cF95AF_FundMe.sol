...
// could add more error codes instead of using reverts (cheaper, gas-wise)
...
contract FundMe {
    ...
    event FallbackCalled(string err);
    ...
    fallback() external payable {
        fund();
        emit FallbackCalled("fallback called!"); // was doing this to aid my tests, don't need it
    }
