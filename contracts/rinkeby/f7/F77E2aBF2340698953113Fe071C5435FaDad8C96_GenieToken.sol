...
contract GenieToken is Initializable, ContextUpgradeable, ERC20Upgradeable, UUPSUpgradeable, Whitelist {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override returns (bool) {
        ...
        (uint256 adjustedValue, uint256 taxAmount, uint256 taxAmountVault, uint taxAmountStaking, uint taxAmountMarketing) = calculateTransferTaxes(_from, _value);
    ...
    function transfer(address _to, uint256 _value) public override returns (bool) {
        ...
        (uint256 adjustedValue, uint256 taxAmount, uint256 taxAmountVault, uint taxAmountStaking, uint taxAmountMarketing) = calculateTransferTaxes(msg.sender, _value);
    ...
    function calculateTransferTaxes(address _from, uint256 _value) public view returns (uint256 adjustedValue, uint256 taxAmount, uint256 taxAmountVault, uint taxAmountStaking, uint taxAmountMarketing){
