...
contract PeaceDistortion is ERC721, Ownable {
    ...
    */
    ...
    {        
        return string(
            abi.encodePacked(                
                '<html><a href="https://peace.move.xyz/">',
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        " }]",
                        ', "description": , ',
                        '"The Peace DAO Distortion NFT was created to thank contributors to the Peace DAO Movement JuiceBox (https://juicebox.money/#/p/peace). This NFT was developed in collaboration with @onchainworld as an on-chain art piece."',
