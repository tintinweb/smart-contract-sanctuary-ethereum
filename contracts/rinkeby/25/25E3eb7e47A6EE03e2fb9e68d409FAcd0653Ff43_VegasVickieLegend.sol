...
contract VegasVickieLegend is ERC721, ERC721Enumerable, AdminControl, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Vegas Vickie Legend", "VVLEGEND") {}
    ...
    */
    function mintAllowlist(uint256 _quantity, bytes32[] calldata proof) public payable nonReentrant {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721, ERC721Enumerable, AdminControl)
        returns (bool)
    {
