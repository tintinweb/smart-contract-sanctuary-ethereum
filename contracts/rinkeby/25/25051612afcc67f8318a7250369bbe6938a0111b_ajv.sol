...
contract ajv is ERC721Enumerable, ERC721Royalty, MintCounter, ReentrancyGuard, AccessControl, Ownable {
    bytes32 public constant SUPPORT_ROLE = keccak256('SUPPORT');
    uint256 public constant MAX_SUPPLY = 10;
    uint256 public constant MAX_PUBLIC_MINT = 2;
    uint256 public constant MAX_RESERVE_SUPPLY = 2;
    ...
    constructor(address payable shareholderAddress_) ERC721("AJV", "VAYNER") {
