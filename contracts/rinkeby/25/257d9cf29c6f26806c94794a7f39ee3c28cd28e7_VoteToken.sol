...
contract VoteToken is ERC20, Ownable, ERC20Permit, ERC20Votes {
    ...
    mapping(address => bool) public ClaimerDetails;
    ...
    function claimOwn() public {
        require(ClaimerDetails[msg.sender] == false, "You can only claim from this faucet once!");

        _mint(payable(msg.sender), 100 * 1000000000000000000);
        
        ClaimerDetails[msg.sender] = true;
    }
}