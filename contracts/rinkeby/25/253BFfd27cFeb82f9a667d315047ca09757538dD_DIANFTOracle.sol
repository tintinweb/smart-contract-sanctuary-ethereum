...
contract PriceOralceWithDIADataCustomized is IOracle {
    ...
    function getUnderlyingPrice(address asset) external view override returns (uint256) {
        if (asset == nameToAddress["zBAYC"]) {
            // BAYC
            (, uint256 MA30, , , , ) = DIAPriceOracle.getValue("Ethereum-0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D");
            return MA30 * 1e10;
        } else if (asset == nameToAddress["zDoodle"]) {
            //Doodle
            (, uint256 MA30, , , , ) = DIAPriceOracle.getValue("Ethereum-0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e");
            return MA30 * 1e10;
        } else if (asset == nameToAddress["zMAYC"]) {
            //MAYC
            (, uint256 MA30, , , , ) = DIAPriceOracle.getValue("Ethereum-0x60E4d786628Fea6478F785A6d7e704777c86a7c6");
            return MA30 * 1e10;
        } else if (asset == nameToAddress["zMeebits"]) {
            //MEEbits
            (, uint256 MA30, , , , ) = DIAPriceOracle.getValue("Ethereum-0x7Bd29408f11D2bFC23c34f18275bBf23bB716Bc7");
            return MA30 * 1e10;
        } else if (asset == nameToAddress["zOtherside"]) {
            (, uint256 MA30, , , , ) = DIAPriceOracle.getValue("Ethereum-0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258");
            return MA30 * 1e10;
        } else if (
    ...
    function getInsurancePrice(address asset) external view override returns (uint256) {
        if (asset == nameToAddress["zBAYC"]) {
            // BAYC
            (, , , uint256 drawdown, uint256 dev, ) = DIAPriceOracle.getValue("Ethereum-0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D");
            return (drawdown + dev) * 1e10;
        } else if (asset == nameToAddress["zDoodle"]) {
            //Doodle
            (, , , uint256 drawdown, uint256 dev, ) = DIAPriceOracle.getValue("Ethereum-0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e");
            return (drawdown + dev) * 1e10;
        } else if (asset == nameToAddress["zMAYC"]) {
            //MAYC
            (, , , uint256 drawdown, uint256 dev, ) = DIAPriceOracle.getValue("Ethereum-0x60E4d786628Fea6478F785A6d7e704777c86a7c6");
            return (drawdown + dev) * 1e10;
        } else if (asset == nameToAddress["zMeebits"]) {
            //MEEbits
            (, , , uint256 drawdown, uint256 dev, ) = DIAPriceOracle.getValue("Ethereum-0x7Bd29408f11D2bFC23c34f18275bBf23bB716Bc7");
            return (drawdown + dev) * 1e10;
        } else if (asset == nameToAddress["zOtherside"]) {
            (, , , uint256 drawdown, uint256 dev, ) = DIAPriceOracle.getValue("Ethereum-0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258");
            return (drawdown + dev) * 1e10;
        } else {
            revert("Insurance price not set for this asset");
        }
    }
}

contract PriceOralceWithDIAData is IOracle {
    DIANFTOracle DIAPriceOracle = DIANFTOracle(0x7626aF7Eb13580193D2c1d6dD12D96bF1E924764);
    mapping(string => address) nameToAddress;
