...
contract Squatch is ERC1155, Ownable, Pausable, ERC1155Supply {
    uint256 public constant LAND = 0;
    uint256 public constant MINISQUATCH = 1;


    constructor() ERC1155("ipfs.io/ipfs/QmZemgqxAyFTJSEggVRjNMic2z8XExDaZXvHYynxgU4j5F.json") {
        _mint(msg.sender, LAND, 10**3, "");
        _mint(msg.sender, MINISQUATCH, 500, "");
    }
