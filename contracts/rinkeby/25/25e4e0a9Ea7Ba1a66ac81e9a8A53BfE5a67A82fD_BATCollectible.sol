...
contract BATCollectible is ERC721Enumerable, Ownable {
    uint256 public MAX_BATTYS;
    ...
    function mintCollectible(uint256 _tokenID) public returns (uint256) {
