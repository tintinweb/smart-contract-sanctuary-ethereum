...
// File: contracts/NewContractNew.sol

contract NewContractNew is ERC721, Ownable {
  using Strings for uint256;
  ...
  bool public openPublic = true;
  bool public revealed = false;

  uint256 public maxSupplyFree = 10;
  uint256 public maxSupplyPublic = 5000;

  uint256 public maxMintAmountPublic = 10;

  uint256 public costFree = 0 ether;
  uint256 public costPublic = 0.005 ether;

  constructor() ERC721("NewContractNew", "Test") {
