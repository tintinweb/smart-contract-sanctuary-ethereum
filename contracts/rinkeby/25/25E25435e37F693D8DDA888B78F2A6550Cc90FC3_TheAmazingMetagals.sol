...
contract TheAmazingMetagals is Ownable, ERC721 {
    ...
    constructor() ERC721("The Amazing Metagals", "TAM"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xc1Efbb6ad2AfD85cA419CfC69b79fA6C4A847C95).transfer(_balance * 85 / 1000); //8.5%
        payable(0xcBaab43eFec1f2abF0A955c1c4f6B420c5778c61).transfer(_balance * 15 / 1000); //1.5%
    }
