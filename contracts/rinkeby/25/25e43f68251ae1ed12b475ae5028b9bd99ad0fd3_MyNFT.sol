...
contract MyNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Crypto baby", "NFT") {}
        ...
        returns (uint256)
    {
        ...
        require(maxWalletCount>mintedWallet[recipient], "the recipient has enough wallet");
        require(whiteList[recipient], "the recipient is invalid");
        
        _tokenIds.increment();

        uint256 newItemId = _tokenIds.current();
        _safeMint(recipient, tokenId);
        mintedWallet[recipient]++;
