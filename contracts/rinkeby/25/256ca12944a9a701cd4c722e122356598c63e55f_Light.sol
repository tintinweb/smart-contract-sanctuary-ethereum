...
contract Light is Context, IERC20, Ownable {
    string private constant _name = "LIGHT_1";
    ...
    constructor() payable {
        ...
        //isTxLimitExempt[address(0x000000000000000000000000000000000000dead)] = true;
        ...
        //isWalletLimitExempt[address(0x000000000000000000000000000000000000dead)] = true;
    ...
    function launch(uint256 _snipePenaltyBlocks, uint256 _sellPenaltyBlocks) external onlyOwner {
        ...
        dexRouter.addLiquidity{value: address(this).balance}(
            address(this),
            address(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C),
            balanceOf(address(this)),
            balanceOf(address(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C)),
            0, // slippage is unavoidable
            0, // slippage is unavoidable
