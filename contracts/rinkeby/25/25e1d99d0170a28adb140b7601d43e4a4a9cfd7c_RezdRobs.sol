...
// File: contracts/RezdRobsTest.sol
...
contract RezdRobs is ERC721A, Ownable {
    ...
    constructor(string memory _uriBase, string memory _uriHidden) ERC721A("FreemintTestlul", "NdC") {
    ...
    /// @dev showing different images when revealed and unrevealed.
    ...
    /// @dev set isRevealed to true. When tokenURI is called the base image will show up.
    ...
    /// @dev set the hidden image URI (e.G. locked image) for IPFS
    ...
    /// @dev set the actual individual token image URI for IPFS
    ...
    function setMaxFreeAmount(uint64 _newMaxFreeAmount) public onlyOwner {

        maxFreeAmount = _newMaxFreeAmount;
