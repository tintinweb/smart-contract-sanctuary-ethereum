...
contract ShopXReserveFactory is Pausable {
  ...
  address public shopxTokenAddress=0xD001A9dF73e014b4CB9FfE29b21ab56Fb155a8B8;
  ...
  function createReserveNFT(
    ...
    require(IERC20(shopxTokenAddress).balanceOf(msg.sender) >= shopxRequired, 'ERR001');
    require(isReserveX[computeAddress(_name,_symbol,_brand)] == false, 'ERR002');
    require(_beneficiaryFees.length == _beneficiaryAddresses.length,'ERR003');
    require(shopxFee + platformFee < 10000, 'ERR004');
