...
contract LoomiHeads is ERC721A, Ownable, ReentrancyGuard {
    ...
    {
        setBaseURI("");
        setNotRevealedURI("ipfs://Qma6CSrQhRjDmX7xDGaPPzo1NKBdx6BxTgSpYQg6Usp4C3/hidden.json");
    }
    ...
    function teamMint(address to ,uint256 amount) external onlyOwner{
        ...
        require(supply + amount <= reservedForTeam);
        _safeMint(to,amount);
    }
    ...
    function swapSaleState() external onlyOwner{
    ...
    function setWlSupply(uint256 _wlSupply) external onlyOwner{
        maxWL = _wlSupply;
    }
    ...
    (bool r1, ) = payable(0x5bBEC70750169fd75c6b428eca849273a25922aD).call{value: balance * 3125/10000}("");
    require(r1);
     (bool r2, ) = payable(0xA4cEFeeB6624468B3e382137376A69f94c1250F8).call{value: balance * 1425/10000}("");
    require(r2);
     (bool r3, ) = payable(0xD8BCeAc63ec57CCc996Cd7B52d202d77C84BB5cf).call{value: balance * 1625/10000}("");
    require(r3);
     (bool r4, ) = payable(0x6178f7578A4b271927070f21ed16FE94E0292228).call{value: balance * 1525/10000}("");
    require(r4);
     (bool r5, ) = payable(0x9e1049430C4Ab2e4b8b04a450C4Fca13F491aE29).call{value: balance * 500/10000}("");
    require(r5);
       (bool r6, ) = payable(0xfc494FDbD08913D81a2e2437ab408E624611F2D1).call{value: balance * 300/10000}("");
    require(r6);
     (bool r7, ) = payable(0x575612184b7aA0E6866284B40Aec273b7E01b7e3).call{value: balance * 1500/10000}("");
    require(r7);
