...
contract NtentPurchaseOneClaimPerOwner is Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => string) public projectRules;
    ...
    function getProjectRules(uint256 _projectId)
        public
        pure
        returns (string[3] memory rules){
        rules = ["ClaimOnly", "ClaimNoBurn", "OneMintPerOwner"];
    }
    ...
    function exceedsMaxMints(
        ...
        exceeds = false;
        exceeds = projectAddressMints[_projectId][_fromAddress] >= 1;
    }
