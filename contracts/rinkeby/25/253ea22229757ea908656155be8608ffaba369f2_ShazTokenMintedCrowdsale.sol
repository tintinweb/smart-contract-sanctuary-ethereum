 ...
 */
  contract MintedCrowdsale is Crowdsale,ERC20Mintable {
    ...
    //  */
     constructor(uint256 rate_, address payable wallet_, IERC20 token_,string memory name_, string memory symbol_)
...
pragma solidity >0.5.16 < 0.9.0;
  ...
  contract ShazTokenMintedCrowdsale is Crowdsale ,MintedCrowdsale{
