...
contract Goals is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Goals", "GLS") {
    setHiddenMetadataUri("ipfs://QmVfD6pXYHSF4z4up5GxQAzyb2mtJW3QxqEo2sjcYsFu6m/hbuh.json");
  }
