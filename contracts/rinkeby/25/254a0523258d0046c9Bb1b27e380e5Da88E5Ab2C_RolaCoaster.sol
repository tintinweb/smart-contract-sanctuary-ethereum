...
contract RolaCoaster is AbstractRolaCoaster {
    ...
    /// @dev This is the setMaintainerAddress function. It is used by the owner to update the maintainer address in the contract.
    ...
    function setMaintainerAddress(address newMaintainerAddress) external override onlyOwner whenNotPaused {
...
interface IRolaCoaster {
    ...
    function setMaintainerAddress(address newMaintainerAddress) external;
