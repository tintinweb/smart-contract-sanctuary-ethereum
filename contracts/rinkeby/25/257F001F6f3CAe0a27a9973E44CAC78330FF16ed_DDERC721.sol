...
contract DDERC721 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, ERC2771ContextUpgradeable {
    ...
    constructor(MinimalForwarderUpgradeable trustedForwarder) ERC2771ContextUpgradeable(address(trustedForwarder)) {
      _disableInitializers();
    }

    function initialize(string memory _name, string memory _symbol, address _owner, string memory _customContractURI, address _proxyRegistryAddress) initializer public {
