...
contract launchpadNFT is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    NFTcontract public tokenContract;

    address payable NXTLab_wallet;
    address payable Stanley_wallet;
    address payable Treasury_wallet;
    ...
    uint16 internal maxTotalSupply;
