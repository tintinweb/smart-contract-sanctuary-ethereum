...
contract BCASecurityProof is ERC721A {
    ...
    event ProofDeleted(string indexed projectName, address indexed contractAddress, uint indexed DeletedTime);
    ...
    function _checkOwner() internal view {
        if (contractOwner() != _msgSenderERC721A())
