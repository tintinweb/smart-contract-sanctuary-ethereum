...
// File: @metacrypt/contracts/src/security/ContractSafe.sol
...
Blockchain Services @ https://www.metacrypt.org
*/
pragma solidity ^0.8.0;
...
// File: @metacrypt/contracts/src/erc721/ERC721EnumerableSupply.sol
...
/**
 ** Adds Existance Check to ERC721Enumerable
 */
...
contract LazyCubs is ERC721, ERC721EnumerableSupply, Pausable, AccessControl {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://metadata.lazylionsnft.com/api/lazycubs/";
    }
...
// File: contracts/PurchaseManager.sol
...
contract PurchaseManager is Ownable, ContractSafe {
     ...
     **
     **      0 -  9,999 - Public Sale
     ** 10,000 - 19,999 - Mutation: Milk
     ** 20,000 - 29,999 - Mutation: Juice
    ...
    function mintWhitelist(
        ...
        require(msg.value >= (mintingPrice * numberOfTokens), "Incorrect amount");
