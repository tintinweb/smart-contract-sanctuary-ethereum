...
/**
 * @title TradeableMetaERC721Token
 * TradeableMetaERC721Token - ERC721 contract that whitelists a trading address, and has minting functionality (and metatransactions).
 */

contract TradeableMetaERC721Token is TradeableERC721Token, ContextMixin, NativeMetaTransaction {
