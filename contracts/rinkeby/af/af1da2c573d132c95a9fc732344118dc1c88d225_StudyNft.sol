...
contract StudyNft is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint public constant maxMintBatch = 5;
    uint256 public constant tokenPrice = 5000000000000000; // 你要出售的价格0.005 ETH
    uint256 public maxTokensCount = 6666;
    address[] private distributions;
    string private baseURI;
    string public baseTokenURI;
    string public contractURI;

    constructor() ERC721("waterfall.wtf", "waterfall.wtf") {
        // 填写您的baseURI
        baseURI = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK6Y953iJTdS6r5OHKFqaRsyPeLx688tehvA&usqp=CAU";
        //baseTokenURI = "https://angelicrealm.angelsofaether.com/aoagencontif4hw377/AngelsOfAetherGeneral.json";
        //tokenURI = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK6Y953iJTdS6r5OHKFqaRsyPeLx688tehvA&usqp=CAU";
        contractURI = "";
    }
