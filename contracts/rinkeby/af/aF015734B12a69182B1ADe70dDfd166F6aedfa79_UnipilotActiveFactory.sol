...
contract UnipilotActiveVault is ERC20Permit, IUnipilotVault {
    ...
    /// @inheritdoc IUnipilotVault
    function readjustLiquidity(uint8 swapBP) external override {
        _pulled = 1;
    ...
    function rebalance(
        ...
        (, int24 tick, ) = pool.getSqrtRatioX96AndTick();
        require(tickLower <= tick);
        require(tickUpper > tick);
        ...
        pool.mintLiquidity(tickLower, tickUpper, balance0, balance1);
    ...
    function pullLiquidity(address recipient) external {
...
library UniswapLiquidityManagement {
    ...
    function checkRange(
        ...
        require(tickLower % tickSpacing == 0, "TML");
        require(tickUpper % tickSpacing == 0, "TMU");
    }
