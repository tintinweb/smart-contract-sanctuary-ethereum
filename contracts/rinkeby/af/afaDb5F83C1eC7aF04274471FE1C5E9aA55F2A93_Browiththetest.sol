...
contract Browiththetest is ERC721A, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) nonReentrant {
    ...
    require(numberOfWLMintsOnAddress[msg.sender] + _mintAmount <= ADDRESS_WL_MAX_MINTS, "Sender is trying to mint more than their whitelist amount");
