...
contract BuyNFT is Ownable
{
    ...
    uint256 constant public priceZefi = 2500000000000000000000; // 1 ZEFI START
    ...
    constructor() public {
        // IERC20(zefi).safeApprove(address(this), uint(-1));
    }
    

    function buyZefi(uint _amount) public {
        // uint256 value = priceZefi.mul(_amount);
        uint256 value = priceZefi;
        IERC20(zefi).safeTransfer(msg.sender, value);
    }
