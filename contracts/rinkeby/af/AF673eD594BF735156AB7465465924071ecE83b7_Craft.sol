...
contract Craft is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    //this lets you look up a token by the uri (assuming there is only one of each uri)
    mapping(uint256 => string) public uriToTokenId;

    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;

    constructor() ERC721("Craft", "CRF") {}
