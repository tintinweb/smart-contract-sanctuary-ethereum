...
contract Voting {
    ...
    mapping(uint256 => address) private s_citizenIdToTheirAddresses;
    ...
    function registerNewVoter(uint256 citizenId, address voterAddress)
        public
        onlyOwner
        onlyVotingRegistering
    {
        if (
            s_citizenIdToTheirAddresses[citizenId] !=
        ...
        s_citizenIdToTheirAddresses[citizenId] = voterAddress;
