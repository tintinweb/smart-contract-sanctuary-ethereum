...
contract CameraPersonTheLostOnes is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    uint256 immutable public maxGiftMintId = 122;
    uint256 public giftMintId = 1;

    uint256 immutable public maxWhitelistId = 0;
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("CameraPersonTheLostOnes", "CPTLO") {
        setBaseURI(_baseURI);
    ...
    */
    function mintGift(
        ...
        nonReentrant
    {
        require(addressMinted[msg.sender] == false, "Address Minted already");

                addressMinted[msg.sender] == true;
                _safeMint(msg.sender, 1);
        require(presale == true, "sale not public");
    ...
    */
        ...
        nonReentrant
    {
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            publicMintId++;
              require(!presale, "Preasle is over");
        }
    }
