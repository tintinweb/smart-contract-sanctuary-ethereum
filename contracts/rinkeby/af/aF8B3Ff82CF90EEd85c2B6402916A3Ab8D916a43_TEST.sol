...
contract TEST is ERC721A, Ownable {
  ...
  uint private constant MAX_TEAM = 555;
  bool public isActive = false;
  string public URI = "ipfs://QmXKz1Adr6wVutABiSwPvFajgrXPgUzpFJ7NsEBeRSRZBK/";
  uint256 public mintPrice = 0.0039 ether;
  uint256 public constant MAX_SUPPLY = 5288;
  uint256 public maxAllowedTokensPerPurchase = 4;
  uint256 public CLAIMED_SUPPLY;
  uint private constant MAX_WALLET = 5;

  constructor() ERC721A("TEST", "v1") { }
  ...
  function Mint(uint256 _count) public payable saleIsOpen {
    ...
    require(balanceOf(msg.sender)+ _count <= MAX_WALLET, "Exceeded Max per Wallet");
    ...
    returns (string memory)
  {
    ...
    return bytes(currentBaseURI).length > 1 ? string(abi.encodePacked(currentBaseURI, _tokenId.toString(), ".json"))
        : "";
  }
