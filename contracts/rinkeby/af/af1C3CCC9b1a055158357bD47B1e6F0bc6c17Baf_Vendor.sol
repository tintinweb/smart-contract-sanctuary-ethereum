...
contract Vendor is Ownable {
    ...
    event SellTokens(address _user, uint256 _amount, uint256 _amountOfEth);
    ...
    function buyTokens() public payable {
        uint256 amountOfBoughtTokens = tokensPerEth * msg.value;
        yourToken.transfer(msg.sender, amountOfBoughtTokens);
        emit BuyTokens(msg.sender, msg.value, amountOfBoughtTokens);
    }
