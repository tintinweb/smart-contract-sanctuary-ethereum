...
contract LionsNotSheep is ERC721Enumerable, ILionsNotSheep, Ownable {
    ...
    address public constant creatorAddress =
        0x8AA043A60E072c43aFD24b8F36619A016d3cf96e;
    ...
    function freemintTokensOfWallet(address _wallet)
        public
        view
        returns (uint256)
    {
    ...
    function mint(
        ...
        require(total + _tokenAmount <= MAX_ELEMENTS, "Max limit");
        require(
            msg.value >= price(_tokenPrice, _tokenAmount),
            "Value below price"
        );
    ...
    function signatureWallet(
        ...
        return
            ECDSA.recover(
                keccak256(
                    abi.encode(wallet, _tokenAmount, _tokenPrice, _timestamp)
                ),
                _signature
            );
    }
    ...
    function price(uint256 _price, uint256 _count)
        public
        pure
        returns (uint256)
    {
