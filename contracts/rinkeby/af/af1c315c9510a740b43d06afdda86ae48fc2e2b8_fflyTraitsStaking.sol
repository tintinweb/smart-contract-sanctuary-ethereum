...
contract fflyTraitsStaking is Ownable, ReentrancyGuard {
    ...
    */
    ...
    mapping (address => uint256) public lastClaimedByAddress;
    ...
    function getUnclaimedRewards(uint256[] memory _claimableTokenIds) public view returns (uint256){
        ...
        if(!(((lastClaimedByAddress[msg.sender] == 0) || (lastClaimedByAddress[msg.sender] < rewardStartTime)) && (block.timestamp < (rewardStartTime + rewardDuration)))){
            return 0;
        }
    ...
    function claimRewards(uint256[] memory _claimableTokenIds) public nonReentrant {
        ...
        require((((lastClaimedByAddress[msg.sender] == 0) || (lastClaimedByAddress[msg.sender] < rewardStartTime)) && (block.timestamp < (rewardStartTime + rewardDuration))),"You already claimed the tokens for this duration");
        ...
        lastClaimedByAddress[msg.sender] = block.timestamp;
