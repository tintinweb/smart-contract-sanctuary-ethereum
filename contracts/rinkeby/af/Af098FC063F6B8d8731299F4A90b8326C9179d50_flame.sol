...
// 
abstract contract flameRNG is Ownable {
    /**
    * Tiers
    * 0 - Platinum
    * 1 - Gold
    ...
    * 3 - Bronze
    ...
    event newWinnersSelected(uint256 timestamp, address platinumWinner, address goldWinner, address silverWinner, address bronzeWinner, 
        ...
        uint256 platinumflameAmount, uint256 goldflameAmount, uint256 silverflameAmount, uint256 bronzeflameAmount,
    ...
    function calcWeight(uint256 ethAmount, uint256 flameAmount) public view returns(uint256) {
        return ethAmount.div(10 ** 13) + flameAmount.div(10 ** 13).div(ethWeight);
    }
    ...
    * Mutations
    ...
    function addV1Users(address[] memory _users) external onlyOwner {
        ...
        for (uint i = 0; i < len; i ++) {
            ...
            uint256 flamebalance = IERC20(address(this)).balanceOf(user);
            uint256 ethAmount = flamebalance.div(10 ** 10);

            uint256 weight = calcWeight(ethAmount, flamebalance);
...
contract flame is IERC20, Ownable, flameRNG {
    using SafeMath for uint256;
        ...
        public
    {
        ...
        // Excluded flame, pair, owner from gambling list
