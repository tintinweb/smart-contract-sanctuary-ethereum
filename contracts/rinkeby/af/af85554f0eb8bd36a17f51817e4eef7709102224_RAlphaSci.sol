...
pragma solidity ^0.8.0;
 ...
 contract RAlphaSci is Ownable, ERC721A, ReentrancyGuard {
    struct Config {
        uint256 maxSupply;
        uint256 reserved;
    ...
    Config public config= Config(6666, 0, 666, 0.016 ether, 10, "");
    ...
    constructor() ERC721A("RAlphaSci", "RALPHASCI") 
    {
    ...
    function mint(uint256 quantity) external payable   nonReentrant {
        ...
        if (totalSupply() >= config.firstFreeMint) {
           ...
           require(
            numberMinted(msg.sender) + quantity <=3,
