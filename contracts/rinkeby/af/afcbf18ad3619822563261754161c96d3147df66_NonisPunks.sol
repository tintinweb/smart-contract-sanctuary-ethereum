...
// File contracts/NonisPunksDNA.sol


pragma solidity ^0.8.0;

contract NonisPunksDNA{
...
// File contracts/NonisPunks.sol


pragma solidity ^0.8.0;
contract NonisPunks is ERC721, ERC721Enumerable, NonisPunksDNA{
    ...
    constructor(uint256 _maxSupply) ERC721("NonisPunks", "PLPKS"){
        maxSupply = _maxSupply;
    }

    function mint() public{
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No Nonis Punks left... F");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory){
        ...
        string memory jsonURI = Base64.encode(
            ...
            '{"name": "NonisPunks #',
            tokenId.toString(),
            '", "description": "Nonis Punks are random avatars stored on chain to Dapps", "image": "',
            image,
            '"}'
            )
        );
