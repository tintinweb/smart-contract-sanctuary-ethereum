...
contract ScrapHub is ERC20("ScrapV2", "SCRAP"), Ownable {
    ...
    address private scrapBurnAddress = 0x0000000000000000000000000000000000000001;
...
*/
    ...
    function migrateToToken(uint256 _amount) external {
        ScrapVOne.transferFrom(msg.sender, scrapBurnAddress, _amount);
        _mint(msg.sender, _amount);
    }

    function migrateToBalance(uint256 _amount) external {
        uint256 balance = ScrapVOne.balanceOf(msg.sender);
