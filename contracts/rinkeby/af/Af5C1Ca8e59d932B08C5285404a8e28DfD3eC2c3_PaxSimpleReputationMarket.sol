...
contract PaxSimpleReputationMarket is IPaxReputableApplication {
    ...
    function listItem(address seller, string memory itemURI, string memory title, address tokenContract, uint256 price) public {
