...
contract StakeARC is Pausable, Ownable, ReentrancyGuard {
    ...
    function claimReward() external returns (bool){
        ...
        arcToken.transfer(_msgSender(), totalTokens);
    ...
    function stakeToken(uint256 stakeAmount) public payable {
        ...
        require(arcToken.balanceOf(_msgSender()) >= stakeAmount, "Insufficient Balance");
        
           arcToken.transferFrom(_msgSender(), address(this), stakeAmount);
            totalStakers++;
