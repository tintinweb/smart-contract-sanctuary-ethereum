...
//   / __\ __ ___  ___/ _\ |__ (_) |/__   \_____      ___ __ __      _| |_ / _|
//  / _\| '__/ _ \/ _ \ \| '_ \| | __|/ /\/ _ \ \ /\ / / '_ \\ \ /\ / / __| |_ 
// / /  | | |  __/  __/\ \ | | | | |_/ / | (_) \ V  V /| | | |\ V  V /| |_|  _|
// \/   |_|  \___|\___\__/_| |_|_|\__\/   \___/ \_/\_/ |_| |_(_)_/\_/  \__|_|  
//                                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xda46706Dd08ccB7679AF2Ce3Ef033efD66b39C3d];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigfxibyveqgylaawjuouf3esozn5pimewte6yzgmz4uajpjqqzh6u/";
...
// File: contracts/FreeShitTownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FreeShitTownwtfContract is RamppERC721A {
    constructor() RamppERC721A("FreeShitTownwtf", "FST"){}
}
