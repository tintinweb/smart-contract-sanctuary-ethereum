...
contract Pionaut is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {    
    ...
    function setFee(uint256 _mintSplitFeePercent1, uint256 _mintSplitFeePercent2, uint256 _royaltyMinterFeePercent, uint256 _totalFeeUnitPercent) public onlyOwner{
    ...
    function setWallets(address _mintSplitFeeWallet1, address _mintSplitFeeWallet2) public onlyOwner{
