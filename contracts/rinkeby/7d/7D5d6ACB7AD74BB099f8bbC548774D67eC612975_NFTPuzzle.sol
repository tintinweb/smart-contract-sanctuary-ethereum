...
contract NFTPuzzle is ERC721, Ownable, ReentrancyGuard, VRFConsumerBase{
      ...
      constructor(string memory _base_uri, address vrfCoordinator, address linkToken) ERC721("Legendary Puzzle","LGP")  VRFConsumerBase(vrfCoordinator, linkToken)
      {
        base_uri = _base_uri;
    ...
    function mintAll() private returns (bytes32)
    {
      requestCounter++;
  ...
  */
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override { 
      uint256 randomNumber = randomness % 30 + 1; //30 BECAUSE NFT LIMIT, SHOULD BE MAX_LOT
      _mint(tx.origin, randomNumber);
    }
