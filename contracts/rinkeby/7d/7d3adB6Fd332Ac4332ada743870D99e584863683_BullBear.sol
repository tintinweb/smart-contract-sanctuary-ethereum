...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, KeeperCompatibleInterface {
    ...
    function updateUriWhitCounter(uint256 _newPrice,uint256 _pastPrice) public {
        ...
        // debugging
        console.log("new ", _newPrice, " btc ", _pastPrice);
        console.log(" count ", basicChangesCounter);

        if (_pastPrice < _newPrice) {
            uri = bullUrisIpfs[index];
        } 
        else if (_pastPrice > _newPrice) {
    ...
    */
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        updateUriWhitCounter(newPrice, BTCPRice);
        BTCPRice = newPrice;
    }
