...
// File: contracts/FlattenCWOptimized.sol
...
contract Cw1 is ERC721Enumerable, Ownable {
    ...
    address private  constant  wallet = 0xc3B3E4950fFAC8F7A453b8F5E696fa5903c26Ead;
...
/*
    ...
    */
    ...
    uint256 public  MAX_TX = 4;
    uint256 public  reserved = 2;
    uint256 public  free = 3;
    uint256 public  price = 0.03 ether;
    bool public saleState = false;
    
    mapping(address => bool) public projectProxy;

    constructor(string memory _baseURI,address _proxyRegistryAddress) ERC721("CW1", "CW") {
        baseURI = _baseURI;
