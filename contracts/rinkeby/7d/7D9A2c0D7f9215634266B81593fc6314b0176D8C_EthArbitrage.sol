...
contract EthArbitrage is OwnableUpgradeable {
    ...
    function initialize(address _uniswapRouterAddress, address tokenAddressBasic, address tokenAddressStable) external initializer {
        __Ownable_init();
    ...
    function test() external pure returns (uint version) {
        return 3;
    }
}
