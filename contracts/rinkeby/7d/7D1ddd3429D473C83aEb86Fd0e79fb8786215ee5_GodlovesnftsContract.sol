...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1659121200;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiczahtuh6y7brfz5bnhoskaxce4mopx4dgykjhrbfbuvfbch6gkp4/";
...
// File: contracts/GodlovesnftsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GodlovesnftsContract is RamppERC721A {
    constructor() RamppERC721A("GOD LOVES NFTS", "GODSNFTS"){}
}
