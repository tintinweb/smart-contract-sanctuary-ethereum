...
contract PFU is ERC721, Ownable {
    ...
    // constructor
    constructor(string memory _initialBaseUri) ERC721("PFU", "PFU") {
    ...
    function mint() external payable  {
        ...
        require(mintPrice <= msg.value, "ETH sent must be more than 0.1 ETH");
        require(tokenSupply.current() + 1 <= maxSupply, "Purchase would exceed max supply.");
