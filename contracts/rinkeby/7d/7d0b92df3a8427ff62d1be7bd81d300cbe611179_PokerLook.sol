...
contract PokerLook is ERC721Enumerable, Auth {
    ...
    bytes32 public rootHash = 0x71d4e2305a67bc98fba2576221655096cebd91994fc1e35aab2386950554b0fb;
    ...
    uint256 public privateSupply = 1000;
    ...
    uint256[20000] private _availableTokens;
    uint256 private _numAvailableTokens = 20000;
    ...
    constructor() ERC721("PokerLook", "PKL") payable Auth(msg.sender) { }
    ...
    function privateMint(uint256 _number, bytes32[] calldata _merkleProof) public payable {
        require(isPrivate, "Minting is paused!");
    ...
    function publicMint(uint256 _number, address ref_addr) public payable {
    ...
    function mint(uint256 _number) internal {
    ...
    function setRootHash(bytes32 _root) external authorized {
        rootHash = _root;
    }
    ...
    function referee(address ref_add) internal {
        if (user_info[msg.sender].referred == false && ref_add != msg.sender) {
