...
Ownable  {
  ...
  constructor(
    ...
    function minter(uint256 numTokens) public payable
     nonReentrant
    {
     require(numTokens > 0 && numTokens <= MAX_MINTS, "Machine can dispense a minimum of 1, maximum of 10 tokens");
     uint256 price = MINT_PRICE;
     require(msg.value >= numTokens * price, "Insufficient Payment: Amount of Ether sent is not correct. ");
