...
contract VVVS1R is ERC721Enumerable, Ownable {
    ...
    function freeMint(uint256 _cnt) public onlyOwner {
        uint256 enablecnt = tokenMinted + _cnt;
        require(_cnt > 0);
        require(enablecnt < MAX_NFT_SUPPLY, "Sale has already ended");
    ...
    function _beforeTokenTransfer(
        ...
        require(to == stakingContractAddress || from == stakingContractAddress, "Only transferable by staking or unstaking VVVS1");
        super._beforeTokenTransfer(from, to, tokenId);
    }
}