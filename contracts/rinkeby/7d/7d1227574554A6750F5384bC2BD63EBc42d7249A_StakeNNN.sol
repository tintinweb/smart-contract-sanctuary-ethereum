...
contract StakeNNN is Initializable, OwnableUpgradeable {
    ...
    address public constant tokenAddress = 0x5D5c5c1d14FaF8Ff704295b2F502dAA9D06799a0;
    ...
    /// @dev This function is for updating the data if there are any changes.
    function updateAccount(address account) 
        private 
    {
        uint pendings = getPendings(account);
        if(pendings > 0) {
            require(NNNToken(tokenAddress).transfer(account, pendings), "Could not transfer tokens.");
    ...
    */
        ...
        public 
    {
        ...
        require(NNNToken(tokenAddress).transferFrom(msg.sender, address(this), amountToStake), "Insufficient token allowance.");
    ...
    */
        ...
        public 
    {
        ...
        require(NNNToken(tokenAddress).transfer(msg.sender, amountToWithdraw), "Could not transfer tokens.");
