...
contract ViewFunctionsFacet is IERC2981 {
    AppStorage internal s;

    /// Check if holder token redeemed
    function holderTokenRedeemed(address holderContract, uint256 tokenId) external view returns(bool) {
        return s._redeemedTokens[holderContract][tokenId];
    }
