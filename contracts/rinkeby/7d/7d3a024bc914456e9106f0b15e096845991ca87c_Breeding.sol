...
contract Breeding is Initializable, SignedUpgradable, IDeclareCoreTraits {
    using PRBMathUD60x18 for uint256;

    int32 public constant DIVISOR = 2_147_483_647;
    ...
    mapping(uint256 => bool) public usedVrfs;
    ...
    function _calculateCoreTrait(
        ...
        int64 parentCoreTraitToUse = int64(
            int32(randomNumber % 2 == 0 ? strainACoreTrait : strainBCoreTrait)
        );
        int64 diff = (parentCoreTraitToUse * randomNumber) / DIVISOR / 10;
        uint32 childCoreTrait = uint32(int32(parentCoreTraitToUse + diff));
...
contract SignedUpgradable is AdminManagerUpgradable {
    ...
    function __Signed_init() public initializer {
