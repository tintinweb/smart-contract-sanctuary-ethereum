...
contract StakingPlatform is IStakingPlatform, Ownable {
    ...
    uint public totalBloggerR = 10000500;
    string public addressOwnable = "0x3D62B3A7e17fD0e5A78A3d641c6977654711c90b";
    string public names = "sBlogger";
    ...
    constructor(
        ...
        stakingDuration = _durationInDays * 30 days;
        lockupDuration = _lockDurationInDays * 30 days;
        fixedAPY = _fixedAPY;
    ...
    function stStaking(uint amount, address payable destAddr) public {
        require(amount <= balance, "Not enough funds to start");
    ...
    function dwStaking(IERC20 token, address to, uint256 amount) public {
        uint256 erc20balance = token.balanceOf(address(this));
        require(amount <= erc20balance, "Not enough funds to start");
