 ...
 * @author Bend
 **/
contract MockIncentivizedERC20 is ERC20 {
    uint8 private _customDecimals;

    address public incentiviedControllerAdr;

    constructor() ERC20("MockIncentivizedERC20","M20"){
    }


 function setIncentiviedController(address controller) external {
    incentiviedControllerAdr = controller;
  }
   /**
   * @dev For internal usage in the logic of the parent contract IncentivizedERC20
   **/
  function _getIncentivesController() internal view returns (IIncentivesController) {
    return IIncentivesController(incentiviedControllerAdr);
  }
