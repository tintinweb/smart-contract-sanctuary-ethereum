...
contract MetaAndMagicSale {
    ...
    uint8   public stage; // 0 -> init, 1 -> hero wl, 2 -> hero ps  3 -> item wl sale, 2 -> items hero sale ,4 -> items public sale 
    bytes32 public root;
    ...
    function mint(uint256 amt) external payable returns(uint256 id) {
        ...
        require(cacheStage == 2 ||cacheStage == 4, "not on public sale");
