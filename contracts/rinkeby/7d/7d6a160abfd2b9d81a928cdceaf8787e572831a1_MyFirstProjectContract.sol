...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmdT9bC35rcj5RX2QkVT3QUTqY5VrR6jLv2w3eSy5LPC3U/";
        ...
        constructor(
            ...
            payableAddresses.push(0xb62Dd2e40CE562EB8Dc04d3BB7aefE1cfDb309Be);
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(mintingOpen == true, "Minting is not open right now!");
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 5");
    ...
    // File: contracts/myFirstProjectContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MyFirstProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My First Project", "DOG", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/XvHpYMmQde6DBdx6C5el/contract-metadata";
        }
    }