...
contract GYO is Context, IERC20, Ownable {  //&
    string private constant _name = "TESTUSDC";  //&
    string private constant _symbol = "TESTUSDC"; //&
    uint8 private constant _decimals = 18;

    address public USDC = 0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C; //& 

    address payable public devWallet = payable(0xFb67144EEEcdD15E0A1A5c2B233f398Ad78Df2de); //& 
    address payable public treasuryWallet = payable(0x1459B62E9c67178122Eb902FE12f9eB643D857eA); //& 
    address payable public developmentWallet = payable(0x32CA1c6E08bd89159816e8cF55768A0F4E8daA9D); //& 
    address payable public gyoWallet = payable(0x6B074Ac660a95f50165508Aa374346315Efb4454); //& 
