...
contract DeviantAlienCollective is ERC721Delegated, ReentrancyGuard {
  using Counters for Counters.Counter;

  constructor(address baseFactory, string memory customBaseURI_)
    ERC721Delegated(
      baseFactory,
      "Deviant Alien Collective",
      "DAC",
      ConfigSettings({
        royaltyBps: 1000,
  ...
  {
    allowedMintCountMap[msg.sender] = 2;
  }
  ...
  uint256 public constant PRICE = 45000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.045 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x7c5C0884eD86F28EE7884847Ebf6f440E0b5E757;
