...
contract ServiceFee is AccessControl {
    ...
    */
     ...
     */
    function getSellServiceFeeBps() external view onlyProxy returns (uint256) {
     ...
     */
    function getBuyServiceFeeBps() onlyProxy external view returns (uint256) {
     ...
     */
    function getServiceFeeRecipient() onlyProxy external view returns (address) {
