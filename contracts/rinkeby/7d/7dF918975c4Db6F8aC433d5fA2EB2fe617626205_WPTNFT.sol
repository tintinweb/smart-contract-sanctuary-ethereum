...
contract WPTNFT is ERC721, IWPTNFT, Ownable {
    ...
    address private teamWallet = 0x7e10a89549E22199E02a8ED00dB53427CC93259c;
    // Star id to cid.
    ...
    function initialMint(uint256 num) external onlyOwner {
    ...
    IERC721Enumerable
{
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < _holderTokens[owner].length(); i++)
            if (_holderTokens[owner].at(index) == index) {
                flag = true;
                break;
            }
        require(flag, "Owner is not correct");
        return index;
    }
