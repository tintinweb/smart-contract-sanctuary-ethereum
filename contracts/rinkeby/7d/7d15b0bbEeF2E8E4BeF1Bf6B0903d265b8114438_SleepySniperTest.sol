...
contract SleepySniperTest is ERC721A {
    ...
    CurrentSalePhase _currentPhase = CurrentSalePhase.AllowList2;
    ...
    function _allowListTotalTokenAllowed() view internal returns (uint) {
        require(_currentPhase == CurrentSalePhase.AllowList2 || _currentPhase == CurrentSalePhase.AllowList3,  "AllowList mint are not allowed on this phase");
        if(_currentPhase == CurrentSalePhase.AllowList2) {
    ...
    function mint(uint numberTokensToMint) external payable {
        require(_currentPhase == CurrentSalePhase.PublicSale,  "public mint is not allowed on this phase");
