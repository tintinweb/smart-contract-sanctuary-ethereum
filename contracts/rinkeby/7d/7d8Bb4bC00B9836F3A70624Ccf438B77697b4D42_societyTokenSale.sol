...
contract societyTokenSale {
    address payable public admin;
    address payable private ethFunds = payable(0x9B763084c84722D91e9287522c17b506cDe46c6E);
    societyToken public token;
    ...
    constructor(societyToken _token) {
    ...
    function societyTokenPriceInETH() public view returns(int) {
        int ethPrice = getETHPrice();
        return tokenPriceUSD / ethPrice;
    }

    function buyToken(uint256 _amount) public payable {
        int societyTokenPriceETH = societyTokenPriceInETH();
        // Check that the buyer sends the enough ETH
        require(int(msg.value) >= societyTokenPriceETH * int(_amount));
