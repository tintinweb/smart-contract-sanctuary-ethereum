...
contract Claiming is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public tokenPrice = 0.01 ether;

    uint256 public maxTokensPerMint = 10; //not used
    ...
    address public claimingToken = 0xE1Fc0340D90e5445676A280Dbd22bB095cAbFFD7;
    uint256 public claimingCoef = 1;
    mapping(uint256 => bool) public usedTokens;

    constructor() ERC721A("Claim", "CLAIM") {
