...
// @todo remove all references to pace in the smart contract
// @todo have a longstanding field mapping token to a string, like "celeb blurb" IFF kazumasa greenlights
// @todo add a boolean for `isEditedEver`
contract MessageToken is ERC721Enumerable, AccessControl, Ownable, IERC2981 {
    ...
    // @todo should this update isEdited[tokenId]?
