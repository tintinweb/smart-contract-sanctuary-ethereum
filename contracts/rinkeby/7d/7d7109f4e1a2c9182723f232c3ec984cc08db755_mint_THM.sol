...
contract mint_THM is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _nextTokenId;

    uint256 public constant supplyLimit = 3333;
    uint256 public constant mintLimit = 3;
    uint256 public mintTHM = 0 ether;
    string private _baseTokenURI;
    bool public saleActive;

    constructor(string memory initBaseURI) ERC721("The Horsehead man", "THM") {
    ...
    function Mint_THM(uint256 numberOfTokens) external payable {
        ...
        require(
            msg.value >= mintTHM * numberOfTokens,
