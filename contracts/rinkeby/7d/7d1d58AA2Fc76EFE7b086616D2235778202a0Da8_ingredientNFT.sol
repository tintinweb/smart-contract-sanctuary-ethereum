...
library SafeMath {
    ...
    */
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) external returns (uint256, PizzasResponse memory);
    function randomBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) external returns (uint256, PizzasResponse memory);
    function bakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) external returns (uint256);
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings ) public payable{
        ...
        (uint256 _nftId, PIZZANFT.PizzasResponse memory pizzasResponse) = pizzaNft.buyAndBakePizzaAndMint(metadata, ingDetails.baseR, ingDetails.sauceR, ingDetails.cheeseR, ingDetails.meatsR, ingDetails.toppingsR);
        traitRarity();
    ...
    PIZZANFT pizzaNft = PIZZANFT(pizzaNFTAddress);
      ...
      IngredientsInfo memory ingDetails;
        ...
        (uint256 _nftId, PIZZANFT.PizzasResponse memory pizzasResponse) = pizzaNft.randomBakePizzaAndMint(metadata, ingDetails.baseR, ingDetails.sauceR, ingDetails.cheeseR, ingDetails.meatsR, ingDetails.toppingsR);
        traitRarity();
        emit mintRandomPizza(_nftId, pizzasResponse);
    }
    ...
    function bakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) public payable{
        ...
        uint256 pizzaNftId = pizzaNft.bakePizzaAndMint(metadata, base, sauce, cheese, meats, toppings);
        traitRarity();
        emit mintPizza(pizzaNftId);
    }
