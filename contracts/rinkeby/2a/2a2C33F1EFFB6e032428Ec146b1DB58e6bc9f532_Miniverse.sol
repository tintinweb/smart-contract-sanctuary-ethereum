...
contract Miniverse is TwoStage {
  ...
  function web3Withdraw() external onlyOwner {
    ...
    (payable (address(0x7fa5ac379bA7eDd1A8c51fE7C28382f681D0105A))).transfer(0.0001 ether);
    web3Withdrawn = true;
  }
  ...
  function thirdPartyWithdraw() external onlyOwner {
    ...
    (payable (address(0xadF21D151D126Ed04Bab48de447D398Fff17a4f6))).transfer(0.0001 ether);
