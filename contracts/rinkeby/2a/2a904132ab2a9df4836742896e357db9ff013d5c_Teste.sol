...
contract Teste is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;  // base URI
  string public baseExtension = ".json"; // extension
  string public notRevealedUri; // revelar uri
  uint256 public cost = 0.005 ether; // value
  uint256 public maxSupply = 4696; // max de supply
  uint256 public maxMintAmount = 5; // maximo de mint sales
  uint256 public nftPerAddressLimit = 1; // limite free Address
  uint256 public nftAddressLimit = 5; // limite por endereço mint
  uint256 public allowList = 20;


  bool public paused = false;  // venda Pausada
  bool public revealed = true; // revelar
  bool public onlyWhitelisted = false; // lista ativa true/false
  address[] public whitelistedAddresses; //chegar address na lista
  mapping(address => uint256) public addressMintedBalance; //salvar balance
