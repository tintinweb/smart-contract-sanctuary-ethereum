...
contract Lottery is Ownable, VRFConsumerBaseV2{
    ...
    constructor(address _priceFeedAddress, uint64 subscriptionId, address _vrfCoordinator, bytes32 _keyHash) VRFConsumerBaseV2(_vrfCoordinator) {
    ...
    function changeGasLimit(uint32 _callbackGasLimit) public onlyOwner {
