...
contract VhilsStaking is Ownable, ERC721Holder, ERC1155Holder {
  ...
  function withdrawForMedals(uint16 _tokenId) internal {
  ...
  function withdrawForTears(uint16 _tokenId) internal {
