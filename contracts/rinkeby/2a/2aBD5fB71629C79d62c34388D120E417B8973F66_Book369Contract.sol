...
contract Book369Contract is ERC721, Ownable, RandomlyAssigned {
    using Strings for uint256;

    /*
     * Private Variables
     */
    // uint256 private constant MAX_NUMBER_OF_1 = 167; 
    // uint256 private constant MAX_NUMBER_OF_2 = 167;
    // uint256 private constant MAX_NUMBER_OF_3 = 66;
    // uint256 private constant MAX_NUMBER_OF_4 = 167;
    // uint256 private constant MAX_NUMBER_OF_5 = 167;
    // uint256 private constant MAX_NUMBER_OF_6 = 33;
    // uint256 private constant MAX_NUMBER_OF_7 = 167;
    // uint256 private constant MAX_NUMBER_OF_8 = 167;
    // uint256 private constant MAX_NUMBER_OF_9 = 9;

    uint256 private constant MAX_NUMBER_OF_1 = 10; 
    uint256 private constant MAX_NUMBER_OF_2 = 10;
    uint256 private constant MAX_NUMBER_OF_3 = 6;
    uint256 private constant MAX_NUMBER_OF_4 = 10;
    uint256 private constant MAX_NUMBER_OF_5 = 10;
    uint256 private constant MAX_NUMBER_OF_6 = 3;
    uint256 private constant MAX_NUMBER_OF_7 = 10;
    uint256 private constant MAX_NUMBER_OF_8 = 10;
    uint256 private constant MAX_NUMBER_OF_9 = 9;

    mapping (uint256 => uint256) private availableNumbers;


    uint256 private constant MAX_SUPPLY = 1111; // collection size
    uint256 private constant MAX_MINTS_PER_ADDRESS = 4; // max total mints 
    ...
    constructor(
        string memory uri
    ) ERC721("NFT365", "CARD") RandomlyAssigned(MAX_SUPPLY, 0) {
        _defaultUri = uri;

        availableNumbers[1] = MAX_NUMBER_OF_1;
        availableNumbers[2] = MAX_NUMBER_OF_2;
        availableNumbers[3] = MAX_NUMBER_OF_3;
        availableNumbers[4] = MAX_NUMBER_OF_4;
        availableNumbers[5] = MAX_NUMBER_OF_5;
        availableNumbers[6] = MAX_NUMBER_OF_6;
        availableNumbers[7] = MAX_NUMBER_OF_7;
        availableNumbers[8] = MAX_NUMBER_OF_8;
        availableNumbers[9] = MAX_NUMBER_OF_9;
    ...
    function getAvailabilityOfToken(uint256 index) public view returns (uint256){
         return availableNumbers[index];
    }

    function revealNTF(uint256 tokenId) public returns (string memory){
        require(reveal == true,"Not allowed to reveal yet");
        ...
        require(availableNumbers[random] > 0 , "Not enough NFTs");
        availableNumbers[random] = availableNumbers[random]--;
        _uris[tokenId] = string(abi.encodePacked(_tokenBaseURI, "/", random));
        return _uris[tokenId];
    }

    function setRevealState(bool state) public onlyOwner{
         require(bytes(_tokenBaseURI).length > 0,"No BaseURL set");
         reveal = state;
    }
