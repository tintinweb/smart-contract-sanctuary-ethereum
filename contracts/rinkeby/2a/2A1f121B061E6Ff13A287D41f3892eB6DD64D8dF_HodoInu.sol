...
contract HodoInu is ERC20, Ownable {
    ...
    address public marketingWallet = 0xcaA98CBaF47F8fB2b5e2f6add18c43bf7182516E;
...
//Dene
    ...
    function _transfer(
        ...
        if (maxWalletLimitEnabled) {
            if (_isExcludedFromMaxWalletLimit[from] == false && _isExcludedFromMaxWalletLimit[to] == false && to != uniswapV2Pair
            ) {
        ...
        if( canSwap &&
            ...
            swapTokensForEth(contractTokenBalance);//bak
            ...
            if(liquidityFee > 0) {
                ...
                addLiquidity(liqTokensToAdd, liqETH);//bak
            }
        ...
        if(block.timestamp - lastBuy[from] > 5 minutes) {
            takeFee = false;
        }
