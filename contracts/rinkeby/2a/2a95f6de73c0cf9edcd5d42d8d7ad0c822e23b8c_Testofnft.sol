...
contract Testofnft is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
//   address payable commissions = payable(0x1Cf11bbD83cab8c85426566d820B3bf2DB4b7827);               //commisons
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    // (bool success, ) = payable(commissions).call{value: msg.value * 1 / 100}("");      //commisions
    // require(success);                                 //commisions 
  }
