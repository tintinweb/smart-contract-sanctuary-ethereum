...
contract HustleversePassport is ERC721, Ownable {
    ...
    address public immutable a4;

    constructor(address _a1, address _a2, address _a3, address _a4) ERC721("HustleversePassport", "HSTLV") {
        a1 = _a1;
        a2 = _a2;
        a3 = _a3;
        a4 = _a4;
     ...
     * @dev Sale must be active, the sender must be whitelisted and has not claimed their token yet.
     * @param proof the merkle proof for the address minting
     */
    function mint(bytes32[] calldata proof) public payable {
        require(saleIsActive, "Sale is not active yet.");
        require(!mintClaimed[msg.sender], "Mint already claimed.");
    ...
    function adminMint(uint256 quantity, address recipient) public onlyOwner {
        require(totalSupply() + quantity <= TEAM_SUPPLY, "Exceeds max available.");
