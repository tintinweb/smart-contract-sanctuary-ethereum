// An NFT Contract
// Where the tokenURI can be one of 100 different dodo person
// Randomly selected
...
contract DodoCity is ERC721, MinterRole, Ownable {
    ...
    uint256 private _mintPrice; // 1 ETH = 1000000000000000000 wei
    ...
    constructor() public ERC721("Dodo City", "Dodo") {
        //init explicitly.
        _mintIndexForSale = 1;
    }

    function withdraw() external onlyMinter {
        // This code transfers 5% of the withdraw to Dodocity Admin(Minjae) as a donation.
        // =============================================================================
        0x57d4b5Dbee53a287962f75F4180E54FE09cAf2Ae.transfer(
