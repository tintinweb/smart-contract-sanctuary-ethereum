...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        usdEntryFee = 50 * (10**18); // this represents the 50 as an 18 decimal int
    ...
    function getEntranceFee() public view returns (uint256) {
        // remember to use safemath for production
        (, int256 price, , , ) = ethUSDPriceFeed.latestRoundData();
        uint256 adjustedPrice = uint256(price) * (10**10); // price is returned as 8 decimals, so this convert is to 18 decimals
    ...
    function endLottery() public {
        // need to randomly select a player
        // bad way of generating a random number
        //uint256(
        //    keccak256(
        //        abi.encodePacked(
        //            nonce, // predicatable
    ...
    function fulfillRandomness(bytes32 _requesdId, uint256 _randomness)
        internal
        override
    {
        require(
        ...
        require(_randomness > 0, "Randomness faield!");
