...
contract MoonWolfzAmericans is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeihx7donnnkrd2ly3bpwsn3bz5pnrolrkjperrnwyegisdintctqsu/";
  uint256 public  maxSupply = 10000;
  uint256 public  MAX_MINTS_PER_TX = 750;
  uint256 public  PUBLIC_SALE_PRICE = 0 ether;
  uint256 public  NUM_FREE_MINTS = 10000;
  uint256 public  MAX_FREE_PER_WALLET = 10000;
  uint256 public freeNFTAlreadyMinted = 0;
  bool public isPublicSaleActive = false;

  constructor(

  ) ERC721A("MoonWolfz Americans", "MWA") {
