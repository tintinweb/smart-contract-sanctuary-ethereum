 ...
 */
contract StellaLunaAccessPass is ERC1155PresetMinterPauser {
    uint8 public constant ACCESS_PASS = 0;

    constructor(string memory _metadataRepo) ERC1155PresetMinterPauser(_metadataRepo) {
    }

    function mintAccessPass(
    ) public virtual {
        _mint(msg.sender, ACCESS_PASS, 1, "");
    }
