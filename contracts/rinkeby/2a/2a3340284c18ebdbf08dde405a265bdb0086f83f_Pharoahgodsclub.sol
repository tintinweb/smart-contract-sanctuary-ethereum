...
contract Pharoahgodsclub is IERC721, Ownable {
    using Address for address;
    using Strings for uint256;

    string private _name = "Pharoahgodsclub";
    string private _symbol = "PGC";

    uint16 public pubsaleSupply = 4444;
    uint16 public pubsaledAmount;
    uint16 public totalSupply;
    uint16 public limitPerAddress = 15;
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        ...
        string memory zeros = "";
        if (tokenId < 10) zeros = "000";
        else if (tokenId < 100) zeros = "00";
        else if (tokenId < 1000) zeros = "0";
