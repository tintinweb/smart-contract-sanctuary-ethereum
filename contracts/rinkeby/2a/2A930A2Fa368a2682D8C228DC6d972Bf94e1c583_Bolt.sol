...
contract Bolt is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public freezeTill= 2; //tokenId till which team will mint
    
    uint256 public season = 1; 


    //supply
    uint256 public  TotalCollectionSize_ = 15; // total number of nfts
    uint256 public  WL_Supply = 10; // total number of nfts for wl
    uint256 public  team_supply = 5; // total number of nfts for team
    ...
    address[] teamAddy=[0x8D25C539557196049C6097d21c05aBd9b1cA6d6B,0xfacFA92FA6ADC3054b9dF7C83C05dFC0e8323C5f,
    0xA12164734bf1D06d5145fFeeB5B0ca52178fF770]; // store as an array
...
///////////////////////////
        ...
        isCorrectPayment(whiteListCost, 5)
    {
        require(!paused, "mint is paused");
        uint256 supply = totalSupply();
        require(supply + 5 <= team_supply, "max NFT limit exceeded");
    ...
    function addTeamAddy(address addy) external onlyOwner {
        teamAddy.push(addy);
    }
    ...
    function setWarContract(address _contract) external onlyOwner {
        warContract = _contract;
    }

    function warTransfer(address from, address to, uint256 tokenId)
        external
        
    {
        require(msg.sender == warContract, "Not battle contract");
