...
contract Metacruise is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  address private kimsen;
  address private ivche;
  address private kris;
  address private yordan;
  address private mh1;
  address private mh2;


  uint256 private shares_kimsen;
  uint256 private shares_ivche;
  uint256 private shares_kris;
  uint256 private shares_yordan;
  uint256 private shares_mh1;
  uint256 private shares_mh2;
  ...
  constructor() ERC721("Metacruise", "CRUISER") {
    ...
    // Set shareholders
    kimsen = 0x5B72215e47D49357e21a2F783E9b62b9F8949ED1;
    ivche = 0x0a35deE58a71804427Feb3150f5aC3681F62A0cF;

    mh1 = 0xcFE1B40E1827fed718b5df38063c6fD5f3df4Ed9;
    mh2 = 0xb35772acA12DdA6986B6BD2C972037ec88F097E5;

    yordan = 0x6c3d3F92e52a85f0e89b51E7Cb7795A12911B76E;
    kris = 0xb31361553E63c676421A3e8136518ecfd6E5A7aA;
    ...
    whitelistedAddresses[kimsen] = true;
    whitelistedAddresses[ivche] = true;
  }
  ...
  function withdrawEarnings() public onlyAdmin {
      ...
      Address.sendValue(payable(kimsen), balance * shares_kimsen / totalShares);
      Address.sendValue(payable(ivche), balance * shares_ivche / totalShares);
      Address.sendValue(payable(mh1), balance * shares_mh1 / totalShares);
      Address.sendValue(payable(mh2), balance * shares_mh2 / totalShares);
      Address.sendValue(payable(yordan), balance * shares_yordan / totalShares);
      Address.sendValue(payable(kris), balance * shares_kris / totalShares);
  }
}
