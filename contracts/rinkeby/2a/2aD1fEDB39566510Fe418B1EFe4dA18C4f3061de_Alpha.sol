...
contract Alpha is ERC1155, Ownable, ReentrancyGuard {
    string public name = "Chave Alpha";
    ...
    constructor() ERC1155("ipfs://QmVKasjK2vwm5wbRMpkCt1piigzfZjU9sXUBZVikuRkaWp") {
    ...
    function getSupplyLeft() public view returns (uint16) {
        return maxSupply - totalMinted + 1;
    }
    ...
    function getAllowlistMerkle() public view returns (bytes32) {
        return allowlistMerkle;
    }
