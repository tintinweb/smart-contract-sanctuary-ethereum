...
contract RWAConsumer is ChainlinkClient, Ownable {
    ...
    // function get_status(string memory _name) public returns (bytes32 requestId)
    // {
    ...
    // function get_amount(string memory _name) public returns (bytes32 requestId)
    // {
    //     Chainlink.Request memory request = buildChainlinkRequest(get_amount_jobId, address(this), this.get_amount_response.selector);
    ...
    // function get_amount_response(bytes32 _requestId, uint _get_amount_result) public recordChainlinkFulfillment(_requestId)
    // {
    //     get_amount_result = _get_amount_result;
    ...
    // function set_get_ben_meta_JobId(bytes32 _get_ben_meta_jobId) onlyOwner public {
    //     get_ben_meta_jobId =  _get_ben_meta_jobId;
    // }


    // function get_ben_meta() public {
    //     Chainlink.Request memory req = buildChainlinkRequest(
    //         get_ben_meta_jobId,
    //         address(this),
    //         this.fulfill_ben_meta.selector
    //     );
    //     req.add('urlAddress', "http://localhost:8080/address");
    //     req.add('pathAddress', "address");
    //     req.add('urlAmount', "http://localhost:8080/amount");
    //     req.add('pathAmount', 'amount');
    ...
    //  */
    // function fulfill_ben_meta(
    //     bytes32 requestId,
    //     address addressResponse,
    //     uint256 amountResponse
    // ) public recordChainlinkFulfillment(requestId) {
    //     // emit RequestMultipleFulfilled(requestId, addressResponse, amountResponse);
    //     recipient_address = addressResponse;
    //     recipient_amount = amountResponse;
    // }
    ...
    function requestBytes() public {
        Chainlink.Request memory req = buildChainlinkRequest(byte_get_jobId, address(this), this.fulfillBytes.selector);
        req.add(
            'get',
