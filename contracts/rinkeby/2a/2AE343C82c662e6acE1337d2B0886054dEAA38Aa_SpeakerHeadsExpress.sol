...
/*
 * MultiToken SpeakerHeadsExpress contract for managing token drops
 *
 * by @prabhu
 */
contract SpeakerHeadsExpress is ERC1155, Ownable, ReentrancyGuard {
    ...
    function editToken(uint256 tokenId, bool _active, bool _restrictSale,string memory _name, string memory _metadataUrl, uint256 _maxSupply, uint256 _maxPerWallet, uint256 _mintWeiPrice) 
    public
    onlyOwner
    {
        require(_maxSupply > 0, "Invalid maxSupply");
