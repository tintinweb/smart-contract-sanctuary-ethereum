...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string baseSvg = "<svg  xmlns='http://www.w3.org/2000/svg'  preserveAspectRatio='xMinYMin meet'  viewBox='0 0 350 350'>  <defs>    <linearGradient id='Gradient1' gradientTransform='rotate(90)'>      <stop class='stop1' offset='0%'/>      <stop class='stop2' offset='100%'/>    </linearGradient> </defs>  <style>    .base {      fill: black;      font-family: serif;      font-size: 20px;      color: #FFF;    }    .stop1 { stop-color: yellow; }    .stop2 { stop-color: green;}     </style>  <rect width='100%' height='100%' fill='url(#Gradient1)' />  <text    x='50%'    y='50%'    class='base'    dominant-baseline='middle'    text-anchor='middle'  >";
  ...
  string[] firstWords = ["Bufalo", "Cachorro", "Camelo", "Cavalo", "Coelho", "Elefante", "Esquilo", "Galo", "Gato", "Golfinho", "Gorila", "Jacare", "Lagarto", "Leao", "Lobo", "Macaco", "Passaro", "Pato", "Peixe", "Pinguim", "Polvo", "Porco", "Rato", "Rinoceronte", "Sapo", "Tamandua", "Tatu", "Tigre", "Touro", "Tubarao", "Tucano", "Urso", "Urubu"];
  string[] secondWords = ["Acorda", "Ama", "Come", "Bebe", "Aprende", "Corre", "Pula", "Espera", "Bebe", "Come", "Volta", "Dorme", "Joga", "Para", "Chega", "Vive", "Brinca", "Danca", "Pula", "Fica", "Olha", "Chora", "Nada", "Busca", "Caminha", "Mora"];
  string[] thirdWords = ["Feliz" ,"Triste" ,"Grande" ,"Pequeno" ,"Bonito" ,"Feio" ,"Rapido" ,"Devagar" ,"Doce" ,"Rude" ,"Calmo" ,"Engracado" ,"Divertido" ,"Ligeiro" ,"Estressado" ,"Forte" ,"Fraco" ,"Nervoso" ,"Sorridente" ,"Alto" ,"Baixo" ,"Feroz" ,"Medroso" ,"Manso" ,"Selvagem"];

  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721 ('WordsNFT', 'ThreeWords') {
    console.log("Esse eh meu primeiro contrato de NFT! Solidy - Web3Dev - BR");
    }
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "Uma colecao de NFTs BR com palavras aleatorias.", "image": "data:image/svg+xml;base64,',
