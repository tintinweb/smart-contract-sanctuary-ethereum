...
contract KREDI is ERC20, ERC20Burnable, Ownable {
    ...
    address constant public UnitedKeyAddress = 0x4762A7559cB17c55Dd899c43F819f5A32e579148;
    ...
    function setSaleState(bool newState) public onlyOwner {
     ...
     function totalAvailable(address ownwer) public view returns (uint256) {
        uint[] memory punks = UnitedKeyPunks(UnitedKeyAddress).tokensOfOwner(ownwer);
    ...
    function claim() public payable  {
        ...
        uint[] memory punks = UnitedKeyPunks(UnitedKeyAddress).tokensOfOwner(msg.sender);
        uint arrayLength = punks.length;
