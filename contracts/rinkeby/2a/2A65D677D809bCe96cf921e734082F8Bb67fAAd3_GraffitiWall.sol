    ...
    Pausable
{
    ...
    function getSvg(uint tokenId) private view returns (string memory) {
        ...
        parts[0] = "<svg width='350px' height='350px' xmlns='http://www.w3.org/2000/svg'><style>.a { fill: white; font-size: 18px; }</style><rect width='100%' height='100%' fill='black' /><text x='10' y='20' class='a'>";
