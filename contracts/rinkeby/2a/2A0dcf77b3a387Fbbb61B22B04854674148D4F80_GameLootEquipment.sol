...
contract GameLootEquipment is GameLoot, Pausable, Ownable {
    ...
    function reveal(
        ...
        // monthly card's tokenID is zero
        IGameLootTicket(ticket).eqMint(msg.sender, 0, 1);
    ...
    function setReveal(address revealSVG_) public onlyOwner {
