...
contract AirdropTestV4 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function airdrop(uint256 _mintAmount, address[] memory _wallets) public mintCompliance(_mintAmount) onlyOwner{
