...
contract URG is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxSupply = 8813;

    bool public mintEnabled = true;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("UnRektguys", "UNREKT") {
        _safeMint(msg.sender, 10);
        setBaseURI("ipfs://QmPki74obapGx1D4GfEiuK5VHn3sy9R6q7MqkahmhPvTfL/");
    }
