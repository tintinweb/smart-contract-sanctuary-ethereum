...
contract Staker {
    ...
    event Stake(address addres, uint amount);
    ...
    modifier notCompleted() {
        require(!exampleExternalContract.completed(), "Its not completed");
        _;
    }
    ...
    function stake() public payable {
        require(deadline > block.timestamp, "Henuz sure dolmadi");
        uint256 lastBalance = balances[msg.sender];
        balances[msg.sender] = msg.value + lastBalance;
    ...
    function withdraw() public payable notCompleted {
        //require(deadline < block.timestamp, "Henuz sure dolmadi");
        require(balances[msg.sender] > 0, "You have no balances");
