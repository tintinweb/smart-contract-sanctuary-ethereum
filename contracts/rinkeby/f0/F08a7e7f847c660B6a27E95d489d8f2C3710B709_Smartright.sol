...
contract Smartright is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 12000;
    uint256 public immutable supply = 12000;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x25192b334900d406DACC0BEfd8F07286791DfE66];
    uint256[] public withdrawPercentages = [5, 95];

    bytes32 public merkleRoot = 0xa3aef6025fd5fdceb152dddcdc2d5e71dc81760202b4fb51ee4ea1e6c0a5885a;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x25192b334900d406DACC0BEfd8F07286791DfE66, _royaltyAmount);
    }
