...
contract projectP22 is ERC1155, Ownable, IERC721Receiver {
    ...
    function sendBack(uint256 tId) public {
        TestContract test = TestContract(0x6Bd1517cC975f7A09B954dd606873c1801570cF0);
        test.transferFrom(address(this),0x97EC89056293d8E3e3119865725616769e27236b, tId);
    }
    
    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmRmNVJWRxG6F5UpBZtSC1QbNMg229VPNurzjLKgKf633N/"; // TODO: remove static value
