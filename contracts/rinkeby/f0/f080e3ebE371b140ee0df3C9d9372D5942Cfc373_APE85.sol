...
contract APE85 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ape85", "MAC") {
    setHiddenMetadataUri("ipfs://Qme68Eh6j9i8UaZ1ZjQegiPfdNKY58UcRG5zFJihFUTDn4/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xA7F648271b8024dAC88F6F850b0D6b083DFd14Ab).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
