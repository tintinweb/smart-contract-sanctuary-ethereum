...
contract PixelKnight is ERC721A, Owneable {
    ...
    string public baseURI = "https://reptilian-world.com/nft/metadata/";
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount <= MAX_PER_TX, "Exceeds max per tx");
        
        if (FREE_MAX_SUPPLY > totalSupply() + _amount) {
            require(_amount <= MAX_PER_TX_FREE, "Exceeds max per free tx");
        } else {
