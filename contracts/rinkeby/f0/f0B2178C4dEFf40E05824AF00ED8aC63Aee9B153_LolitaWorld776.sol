...
contract LolitaWorld776 is ERC721A, Ownable, ReentrancyGuard {
    using Strings
    for uint256;
    ...
    uint256 public preSaleStartTime = 1649649600;
    uint256 public publicSaleStartTime = 1649660400;
    
    uint256 public mintPrice = 0.06 ether;
    uint256 public mintPriceWL = 0.03 ether;
    uint256 public mintPriceOG2 = 0.03 ether;
