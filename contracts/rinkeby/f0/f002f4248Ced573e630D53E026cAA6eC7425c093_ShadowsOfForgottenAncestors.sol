...
contract ShadowsOfForgottenAncestors is ERC721A {
    ...
    uint256 public constant PRICE_PER_FOLK = 0.01 ether;
    string public constant FOLK_URI = "ipfs://bafkreifzuvxelyjqfh3umdbd5hbbfity4b26xaqaczxedmbnxisfzdbqf4";
    ...
    uint256 public constant TEAM_SHARE_PERCENTAGE = 90;  // 80/20 donation logic
    ...
    function mint(uint256 quantity) external payable {
        require(totalSupply() + quantity <= MAX_FOLKS, "sold out");
        require(_numberMinted(msg.sender) + quantity <= MAX_FOLKS_PER_HOLDER, "leave to others");
        require(msg.value == PRICE_PER_FOLK * quantity, "mispriced");
    ...
    */
    function donate() public {
        ...
        require(successUnchainFundDonate && successTeamDonate, "russian ship, go fuck yourself");
