...
contract Sphinx is Context, IERC20, IERC721Receiver, Ownable{
    ...
    uint256 public _sellTaxFee = 0;  //50
    uint256 public _sellLiquidityFee = 0; //100
    uint256 public _sellDevFee = 0; //50
    ...
    //     if(totalTokensToSwap == 0 || tokenBalance == 0) {return;}
    //     uint256 initialUSDCBalance = IERC20(USDC).balanceOf(address(this));
    //     swapExactInputSingle(tokenBalance);
    ...
    //     _liquidityTokensToSwap = 0; _devTokensToSwap = 0;
    ...
    function updateSwapTokensAtPercent(uint256 percent) external onlyOwner{
