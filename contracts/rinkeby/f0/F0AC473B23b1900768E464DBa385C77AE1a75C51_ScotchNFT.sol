...
contract ScotchNFT is ScotchBeneficiary, ERC721URIStorage {
  ...
  function createAutoNFTs(uint count, string memory baseURI) public payable
  ...
  function createAutoWrappedNFTs(
...

  {
    ...
    IWrapper wrapperHost = IWrapper(wrapper);
...

    {
      ...
      wrapperHost.wrap721(
        ...
        address(this),//address _underlineContract, 

        id,           //uint256 _tokenId, 

        unwrapAfter,  //uint256 _unwrapAfter,

        0,            //uint256 _transferFee,

        address(0),   //address _royaltyBeneficiary,

        0,            //uint256 _royaltyPercent,

        0,            //uint256 _unwraptFeeThreshold,

        address(0)    //address _transferFeeToken
