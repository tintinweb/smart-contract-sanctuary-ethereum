...
contract obscurityDAO_V3 is ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, FounderWallets, ReentrancyGuardUpgradeable {
    ...
    function initialize() initializer public {
        require(!initializedV3, "I");
        addAAWallet("SW",payable(address(0xd0282Bfa9755Ef7c75E16685a9882dEd3E44faa1)));
        initializedV3 = true;
    ...
    override (ERC20Upgradeable) returns (bool) {
        ...
        unchecked {
            ...
            ERC20Upgradeable.transfer(swapPool.founderAddress, 3*fee);  
        }
    ...
    override {
        ...
        else if(swapPool.founderAddress == p.swapOld) {
            swapPool.founderAddress = p.swapNew;
        }
    ...
    virtual
    onlyRole(globals.ADMIN_ROLE) {
        swapPool.founderAddress = _newAddress;
    }
    ...
    virtual {
        if (
            (keccak256(bytes(swapPool.founderAlias))) != keccak256(bytes("SW"))
        ) {
            swapPool = FounderWallet(_fAlias, _fAddress);
        }
    }
