...
contract LuckyCryptoTigers is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("Lucky Crypto Tigers","LCT", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeReveal = "https://gateway.pinata.cloud/ipfs/QmeW4TfzMS16p9koXPzkN3FWMDSVQKpi1B1vi6WPJhBSiu";
  }
