...
/**
 * @dev ERC20Token implementation with Mint, Burn, Cap, Recover capabilities
 */
contract ERC20Token is ERC20Base, ERC20Burnable, ERC20Mintable, ERC20Capped, Ownable, Recoverable, FeeProcessor {
    constructor(
        string memory name_,
