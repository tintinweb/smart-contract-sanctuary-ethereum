...
contract LovelessCityStaking is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
      ...
      address _signer
        ...
        addCollection(_metroPass);
        
        baseYield = 100 ether;
        rerollPrice = 50 ether;
        upgradePrice = 50 ether;
        rerollStep = 50;

        // TODO update odds prior deploy
        rerollOdds = 100;
    ...
    function reroll(uint256 tokenId, bool redeem) public returns (bool) {
      ...
      if (redeem) {
        ...
        // TODO decide wheather we burn it or not
    ...
    function upgrade(uint256 tokenId, bool redeem) public {
      require(metroPass.ownerOf(tokenId) == address(this), "Token not staked");
    ...
    function redeemLove(address user, uint256 amount) public nonReentrant authorised {
    ...
    */
    ...
    /**
    * @dev Returns token owner address (returns address(0) if token is not staked)
    */
    ...
    function addCollection(address _collectionAddress) public onlyOwner {
