...
contract FairXYZDeployer is ERC721xyz, Pausable{
    ...
    function isApprovedForAll(address owner, address operator) public view override(ERC721xyz) returns(bool)
    {
        return( IFairXYZWallets(interfaceAddress).viewPreapproved(operator) || super.isApprovedForAll(owner, operator) );
    }
