...
/*
  * V2 includes access control to grant minter roles to specific accounts
  ...
  *
*/
contract RRNFTv2 is ERC721, ERC721URIStorage, Pausable, ERC721Burnable {
    ...
    constructor(string memory buri) ERC721("RRNFTv2", "RRT2") {
        // Set base URI
        _buri = buri;
        // Set _admin
        _admin = msg.sender;
