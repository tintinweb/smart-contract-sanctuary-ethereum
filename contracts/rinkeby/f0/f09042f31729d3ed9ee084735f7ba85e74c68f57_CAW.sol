...
contract CAW is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTEks14S4quVaZDmdUfCT5gM1GgLmzUBZXo7NNuUaCZWL";
    ...
    uint256 public PUBLIC_SALE_PRICE = 0.0777 ether;
    ...
    constructor(
    ) ERC721A("center arena warriors", "CAW", 100, maxSupply) {
    }
