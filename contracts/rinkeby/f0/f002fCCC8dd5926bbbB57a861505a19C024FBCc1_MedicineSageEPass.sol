...
contract MedicineSageEPass is Ownable, ReentrancyGuard, Pausable, ERC721A {
    ...
    constructor(uint64 saleSupply_, uint64 selfSupply_, string memory url_) ERC721A("MSEPASS", "MST") {
