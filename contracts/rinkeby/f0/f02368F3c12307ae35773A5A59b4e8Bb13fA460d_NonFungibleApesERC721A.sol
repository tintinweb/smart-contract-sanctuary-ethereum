...
contract NonFungibleApesERC721A is Ownable, ERC721A {
    ...
    address private ceoAddress = 0xCD191738Fd18Cf3da1135fE6279B07Afbe68E3cA;
    ...
    // function releaseAllGains() external onlyOwner {
    //     for (uint256 i = 0; i < teamLength; i++) {
    //         release(payable(payee(i)));
    //     }
    // }

    function withdrawAllGains() public payable onlyOwner {
        require(payable(ceoAddress).send(address(this).balance));
    }
}
