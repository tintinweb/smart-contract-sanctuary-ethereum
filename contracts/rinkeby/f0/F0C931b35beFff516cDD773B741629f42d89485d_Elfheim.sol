...
contract Elfheim is ERC721, Ownable{
    ...
    mapping(address => uint8) _nbClaimedByAddress;

    string private _uriSuffix=".json";
    string private _uriPrefixUnrevealed="QmQGwdayx5aePEcc6GpUQZTKKaxvyWt6gigwuv7AsuxnhA/hidden";
    ...
    function drinkWithElf(uint8 _howMuchBuddy) payable public{
        ...
        require(_nbClaimedByAddress[msg.sender] + _howMuchBuddy <=50,"You can only mint 50 Elfves");
        _nbClaimedByAddress[msg.sender] += _howMuchBuddy;
        _whouhouElvesAreComing(msg.sender,_howMuchBuddy);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (isRevealed){
            ...
            return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, _uriSuffix)) : "";
        }
    }
