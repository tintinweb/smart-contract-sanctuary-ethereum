...
contract Testing1155 is ERC1155, IERC2981, TestOwnable {

    string public name = "tseT";
    string public symbol = "TSET";

    string private baseURI;

    uint256 internal commission = 570;
    ...
    function airdropMint(
        ...
        for (uint256 i = 0; i < _to.length; i++) {
            _mint(_to[i],_tokenId,_quantity,'');
        }
    }
    ...
    function airdropMintBatch(
        ...
        for (uint256 i = 0; i < _to.length; i++) {
            _mintBatch(_to[i],_tokenIds,_quantities,'');
        }
    }
    ...
    function setCommission(
        ...
        if (_commission > 2500) revert CommissionTooHigh();
    ...
    function royaltyInfo(
        ...
        uint256 royaltyAmount = (_salePrice * commission) / 10000;
...
contract TestOwnable is Ownable {
    ...
    function setOrdained(
        ...
        if ( _address.code.length > 0 ) revert NotWorthy();
