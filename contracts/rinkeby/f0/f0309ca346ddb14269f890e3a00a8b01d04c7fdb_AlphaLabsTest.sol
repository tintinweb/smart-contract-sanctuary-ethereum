...
// File: contracts/AlphaLabsTest.sol
...
contract AlphaLabsTest is ERC721A, Ownable {
    ...
    bool public isPaused = false; //TODO
    ...
    bytes32 public merkleRoot = 0x2b542ef87b748974fd2737612137f9cc55d2cac3b09aec67e655234abd076a64;

    constructor() ERC721A("AlphaLabsTest", "ALD") {}

    function whitelistMint(uint8 quantity, bytes32[] calldata merkleProof) public payable {
    ...
    function internalMint(uint quantity, uint256 mintPrice) internal {
