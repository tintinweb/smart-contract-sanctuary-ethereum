...
contract pHectagon is Pausable, Ownable, ERC20 {
    ...
    function exercise(uint256 amount_) external started whitelisted whenNotPaused {
        ...
        require(
            IERC20(busdAddress).allowance(msg.sender, address(this)) >= amount_,
    ...
    function _afterTokenTransfer(
        ...
        if (balanceOf(from_) != 0) {
            uint256 claimableToTransfer;
            claimableToTransfer = (amount_ / balanceOf(from_)) * infos[from_].currentSpaceProfit;
