...
contract MonsterMates is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory _initBaseURI) ERC721("Monster Mates", "MM") {
  ...
  function earlyMint(
    ...
    require(verify(root, leaf, proof), "Validation Failed");
    ...
    require(allowListClaimed[msg.sender] + _count <= MAX_PER_ADDRESS, "Purchase exceeds max allowed");
  ...
  function withdraw() external payable onlyOwner {
    ...
    (bool creatorWithdrawal, ) = payable(
      0x63909EF32DA67DFe367b9ed6f02120AB70712060
    ).call{value: address(this).balance}("");
    require(creatorWithdrawal, "Creator Withdrawal Error");
  }
}
