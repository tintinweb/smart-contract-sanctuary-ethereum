...
contract AlphaAd is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Alphabetical advice", "AA") {
    setHiddenMetadataUri("ipfs://QmYZW7Y57pR6Ca6c92C69Fwfxzf9knJThGAsZwRzqsUPg5.json");
  }
