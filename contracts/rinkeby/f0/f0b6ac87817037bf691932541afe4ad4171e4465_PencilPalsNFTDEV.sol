...
contract PencilPalsNFTDEV is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public phase1Supply = 5;
  uint256 public phase2Supply = 10;
  uint256 public phase3Supply = 10;
  ...
  */
  ...
  function _mintLoop(address _receiver, uint256 _mintAmount) internal {
    ...
    function withdraw() external payable onlyOwner nonReentrant {
        ...
        payable(0x9dC7A7D3c4FD55FaC37f62BA311E9759F142c525).transfer((address(this).balance*15) /100);
        payable(0x2e7f7226dD4A08b1FF20Ef3AE0869ee043E82D1F).transfer((address(this).balance*30) /100);
        payable(0x114Cd81Af4700E30faFfD404eaCD67ad050157ae).transfer((address(this).balance*55) /100);
  }
