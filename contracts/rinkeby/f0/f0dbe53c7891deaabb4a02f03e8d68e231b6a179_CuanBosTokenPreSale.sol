...
contract CuanBosTokenPreSale is Ownable {
    ...
    IERC20 public CBSE = IERC20(0x75a711499aa82Fb58B91AE125C784384c91977e6);
    ...
    function deposit() public payable checkIfPaused {
        ...
        require(CBSE.transfer(msg.sender, tokenAmount), "Insufficient balance of presale contract!");
    ...
    function getTokensPerEth(uint256 amount) internal view returns(uint256) {
        return amount.mul(tokenRatePerEth).div(10**(uint256(18).sub(CBSE.decimals())));
    }
}