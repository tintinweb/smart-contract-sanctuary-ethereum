...
contract LL420GreenPass is ERC1155Burnable, ReentrancyGuard, Ownable {
	...
	// uint256 public constant OG_TIME_LIMIT = 4 hours + 20 minutes; // to change in product
	uint256 public constant OG_TIME_LIMIT = 10 minutes; // to change in product
	...
	function vaultMint(uint256 _id, uint256 _amount) public onlyOwner {
