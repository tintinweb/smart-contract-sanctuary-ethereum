...
/**
 * @dev Optimistic Recipient registry with recipient metadata stored externally, potentially in a different network.
 */
contract UniversalRecipientRegistry is Ownable, BaseRecipientRegistry {
