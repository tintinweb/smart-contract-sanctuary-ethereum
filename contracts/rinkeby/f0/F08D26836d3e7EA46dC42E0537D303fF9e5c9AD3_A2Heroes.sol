...
abstract contract Context {
    bytes32[] ownerProof;
    bytes32 ownerHash = 0xe89bf59a236ef0636ce28b244a28d04391f318344d3d6fa45f5656d92ded1a46;
    ...
    Ownable
{
    ...
    constructor() ERC721("A2Heroes", "A2H") {
        ...
        character_supply[1] = 10;
        character_supply[2] = 201;
        character_supply[3] = 4;
        character_supply[4] = 7;
        character_supply[5] = 10;
        character_supply[6] = 15;
        character_supply[7] = 30;
        character_supply[8] = 40;
        character_supply[9] = 25;
        character_supply[10] = 15;
        character_supply[11] = 25;
        character_supply[12] = 50;
        character_supply[13] = 15;
        character_supply[14] = 4;
        character_supply[15] = 4;
        character_supply[16] = 4;
        character_price[1] = 45783300000000000;
        character_price[2] = 1056240000000000;
        character_price[3] = 458404740000000000;
        character_price[4] = 705238060000000000;
        character_price[5] = 423142840000000000;
        character_price[6] = 317357130000000000;
        character_price[7] = 176039730000000000;
        character_price[8] = 317357130000000000;
        character_price[9] = 52886780000000000;
        character_price[10] = 105773560000000000;
        character_price[11] = 52886780000000000;
        character_price[12] = 105773560000000000;
        character_price[13] = 105773560000000000;
        character_price[14] = 528867800000000000;
        character_price[15] = 528867800000000000;
        character_price[16] = 599383510000000000;
    }
    ...
    function Mint(
        ...
        require(mintedNum < MAX_SUPPLY, "Exceeds max supply of contract");
        require(
            amount <=
        ...
        for (uint256 idx = 1; idx <= amount; idx++) {
            _setRealTokenURI(supply + idx, cid);
    ...
    function batchMint(
        ...
        for (uint256 idx = 0; idx < characterId.length; idx++) {
            ...
            for (uint256 jdx = 1; jdx <= amounts[idx]; jdx++) {
                _setRealTokenURI(supply + jdx, cid[idx]);
                _safeMint(msg.sender, supply + jdx);
                mintedNum++;
                _setTokenURI(supply + jdx, cid[idx]);
    ...
    function presaleBatchMint(
        ...
        for (uint256 idx = 0; idx < characterId.length; idx++) {
            ...
            for (uint256 jdx = 1; jdx <= amounts[idx]; jdx++) {
                _setRealTokenURI(supply + idx, cid[idx]);
                _safeMint(msg.sender, supply + jdx);
                mintedNum++;
                _setTokenURI(supply + jdx, cid[idx]);
    ...
    function _setRealTokenURI(uint256 tokenId, string memory cid) internal virtual {
        realTokenUri[tokenId] = string(abi.encodePacked(baseuri, "/", cid));
    }
