...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Pitbull_","Campeao_","Imortal_","Devastador_","Criminoso_","Colossal_","Imperador_","Mad_Max_","Wolverine_","Caminhao_","Matador_","Implacavel_","Sobrenatural_","Magaiver_","Machete_","Satanista_","Gladiador_","Sargento_","Porta_Avioes_","Saiyajin_","Maverick_","Nuclear_","Viking_","Chuck_Norris_","Toretto_","Embaixador_","T_Rex_","Maracana_","Canibal_","Indio_","Rambo"];
  string[] secondWords = ["Turbinado_","Consagrado_","Capricahdo_","Chapeado_","Prensado_","Envelopado_","Apimentado_","Especial_","Enfeiticado_","Completao_","Empachado_","Churrasqueado"];
  string[] thirdWords = ["com_cheddar","com_bacon","triplo","defumado","com_ovo_frito","com_catupiry","mal_passado","com_calabresa","com_frango","com_vinagrete","com_batata_palha","com_ovo_de_codorna","com_maionese_verde"];
