...
contract RealEstate {
    ...
    ************************************************/
    ...
    uint totalRegistryAuthorityapprovals;
    uint GreaterThanTotalRegistryAuthorityApprovals;
    ...
    ************************************************/
    ...
    mapping ( address => mapping ( uint => bool ) ) yourRequestIsAccepted;
    ...
    ************************************************/
    ...
    mapping ( address => mapping ( uint => bool ) ) isRegistryAuthorityAcceptedForSell;
    mapping ( address => mapping ( uint => bool ) ) isRegistryAuthorityDeclinedForSell;
    mapping ( address => mapping ( uint => bool ) ) isRegistryAuthorityAcceptedforBuy;
    mapping ( address => mapping ( uint => bool ) ) isRegistryAuthorityDeclinedforBuy;
