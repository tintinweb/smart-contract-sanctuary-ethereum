...
contract Pig is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public ALL_AMOUNT = 777;

    uint16 public FREE_MINTED;

    uint16 public FREE_LIMIT=10;

    uint256 public FREE_START_TIME = 1650802200;
    uint256 public FREE_END_TIME = 1656288600;
    ...
    constructor() ERC721A("pig", "PIG") {
         _safeMint(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2, 100);
    }  

    
    function freeInfo(address user) public view returns (uint256,uint256,uint256,uint256,uint256,uint256) {
       return  (ALL_AMOUNT,totalSupply(),FREE_MINTED,FREE_START_TIME,FREE_END_TIME,FREE_WALLET_CAP[user]);
    }
   ...
   function withdraw() public onlyOwner nonReentrant {
    ...
    function setPrice(uint256 price) public onlyOwner
    {
     ...
     function setAllStartTime(uint256 freeTime,uint256 freeEndTime) external onlyOwner {
