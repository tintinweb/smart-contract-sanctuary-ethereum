...
contract Testing123 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Testing123", "TST"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin, "Thanks");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"Sorry degen, no more");
    require(mintEnabled, "Not live yet, hold on.");
