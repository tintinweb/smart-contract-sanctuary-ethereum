...
contract Happy is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs://QmZu76x6EUJDPc2kxugdiZ9fX2P48wPqESsDFDgvTucXvy/';
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
   ...
   // public
  function initMint(address _to, uint256 _mintAmount) public payable {
    require(init);
  ...
  function setInit(bool _state) public onlyOwner {
    init = _state;
  }
