...
contract Metashima is Initializable, ERC721AUpgradeable {
    ...
    */
    function setTokenPrice(uint64 _price) external onlyDevOrOwner {
        TOKEN_PRICE = _price;
    }
    ...
    */
    function setMaxSupply(uint64 _quantity) external onlyDevOrOwner {
    ...
    */
    function initialize(string memory name_, string memory symbol_) public initializer {   
        ...
        _owner = msg.sender;
        MAX_SUPPLY = 14159;
        MAX_TOKENS_PER_WALLET = 250;
        TOKEN_PRICE = 0.01 ether;
