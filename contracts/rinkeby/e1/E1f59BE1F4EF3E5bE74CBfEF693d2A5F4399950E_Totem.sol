...
contract Totem is ERC1155, ERC2981, AccessControl {
    ...
    function mint(uint256 id, uint256 items) external payable {
        ...
        // check eth
        require(items * mintPriceInWei == msg.value, "not enough eth balance");
    ...
    function createCollection(uint256 id, uint256 cap)
        public
    ...
    function setMintPriceInWei(uint256 mintPriceInWei_)
        external
        onlyHasRole(ADMIN_ROLE)
    {
