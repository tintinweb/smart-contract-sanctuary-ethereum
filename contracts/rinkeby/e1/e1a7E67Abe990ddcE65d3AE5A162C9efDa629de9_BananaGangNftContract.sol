...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUeDdLjLEAsfmxySSUZspQCChKhPXxDK82JG38xkpKE4h/";
...
// File: contracts/BananaGangNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BananaGangNftContract is RamppERC721A {
    constructor() RamppERC721A("BananaGangNFT", "BNG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/NpLtF1NBNGvu6CEju65A/contract-metadata";
    }
}
