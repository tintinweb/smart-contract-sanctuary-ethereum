...
contract PlatziPunksDNA {
    ...
    //TDO: Calculate DNA
    //This pseudo random is deterministic 
...
contract PlatziPunks is ERC721, ERC721Enumerable,PlatziPunksDNA {
    ...
    function mint() public {
        ...
        require(current < maxSupply, "No PlatziPunks left to mint");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "PlatziPunks is a collection of 10,000 unique avatars generated and stored on chain. Feel free to use your PlatziPunks in any way you want.", "image": "',
                        image,
                        '"}'
                    )
                )
