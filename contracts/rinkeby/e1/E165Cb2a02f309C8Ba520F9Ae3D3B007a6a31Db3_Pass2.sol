...
contract Pass2 is ERC721Enumerable, Ownable {
    // Should we not use a string here?
    // Can we make this dynamic???
    string  public constant              baseURI = "https://alphapasstest.mypinata.cloud/ipfs/";
    ...
    // uint256 neonPassCount;
    // uint256 noirPassCount;
    // uint[2] private passCounts;

    // We have to keep track of all of these
    // make this the boring one
    string private constant _neonMetadata = "QmdHGmUBvkWrFh7ZTA3U4En6bCbwNTE4fF173vrViULWqS";
    // string private constant _noirMetadata = "QmUbNqszgBN2VsPCfiz8ez9j7FKtQhn6ndoiZ1zBon4RvH";

    // string private constant _neonMetadataAllSeeing = "QmdHGmUBvkWrFh7ZTA3U4En6bCbwNTE4fF173vrViULWqS";
    // string private constant _noirMetadataAllSeeing = "QmUbNqszgBN2VsPCfiz8ez9j7FKtQhn6ndoiZ1zBon4RvH";
    // We need all 4 Hacker Contracts

    // We need the list to add to
    // string[] public specialFriends = [
    //     "QmUbNqszgBN2VsPCfiz8ez9j7FKtQhn6ndoiZ1zBon4RvH"
    // ];

    // This should be the count
    // is it good to remove things from a list????
    // string[] public doNotWorryAboutIt = [
    //     "QmUbNqszgBN2VsPCfiz8ez9j7FKtQhn6ndoiZ1zBon4RvH"
    // ];
    ...
    {
        // baseURI = "https://alphapasstest.mypinata.cloud/ipfs/";
        // baseURI = _baseURI;
        // baseURI = bytes32("https://alphapasstest.mypinata.cloud/ipfs/");
    ...
    function mintNeon() public payable {
        // require(_msgSender() != address(0), "ERC721: mint to the zero address");
        // require(priceInWei == msg.value, "Invalid funds provided.");

        // require(saleIsActive(), "Sale must be active to mint Pass");
        // We need just the neon count here
        // require(id <= MaxNeonPasses, "No More Neon Passes");

        uint256 id = _owners.length + 1;
        _tokenURIs[id] = _neonMetadata;
        _mint(msg.sender, id);
        // _mint(_msgSender(), id);
    ...
    function mintNoir() public payable {
        // Why isn't msgSender() correct?
    ...
    // function setBaseURI(bytes32 _baseURI) public onlyOwner {
    //     baseURI = _baseURI;
    // }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
      // So the problem is checking the exists!!!!

        // 1 < 1
        // So this is checking if it exists
