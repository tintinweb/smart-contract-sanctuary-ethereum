...
contract NWAllianceMembership is ERC721, Ownable {
    ...
    uint8 public maxMintPerWalletPlus1 = 11;
    uint8 public mintCost = 7; // in 0.1 ETH increments


    constructor() ERC721("NWAllianceMembership", "NWAC") {

        // nothing to do here. defaults should be set using state variables, updated via set_Var() functions below
