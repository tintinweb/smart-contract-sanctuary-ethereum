...
contract TraitDrop is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint256 public mintPrice = 0.08 * 10**18;
    ...
    modifier mintingGuard(uint256 amount) {
        ...
        require(amount < 11, "You can't claim more than 10 tokens at a time");
        _;
    }
