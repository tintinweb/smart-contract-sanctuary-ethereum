...
contract BridgeHelper {
    ...
    function transfer(
        ...
        console.log("Allowance succeeded");

        // User sends funds to this contract
        token.transferFrom(msg.sender, address(this), _amount);
        console.log("TranferFrom succeeded");
        ...
        console.log("CallParams succeeded");
        ...
        console.log("XCallArgs succeeded");

        connext.xcall(xcallArgs);

        console.log("Xcall succeeded");
