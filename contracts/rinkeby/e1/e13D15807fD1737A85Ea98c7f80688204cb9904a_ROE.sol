...
/** 
 *  SourceUnit: /Users/gaoyang/ETHProjects/fishgun/contracts/ROE.sol
*/
...
contract ROE is Initializable, ERC20PresetMinterPauserUpgradeable {
    function initialize(
        string memory _name,
        ...
        ERC20PresetMinterPauserUpgradeable.mint(msg.sender, initialSupply);
    }

    function ownerPause() public onlyRole(DEFAULT_ADMIN_ROLE) {
        _pause();
    }

    function ownerUnpause() public onlyRole(DEFAULT_ADMIN_ROLE) {
        _unpause();
    }
}