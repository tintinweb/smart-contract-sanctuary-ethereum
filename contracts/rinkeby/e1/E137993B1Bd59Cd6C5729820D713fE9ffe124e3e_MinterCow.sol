 ...
 * @dev Extends ERC721A
 */
contract MinterCow is ERC721A, AllowListSale, Ownable, AccessControlEnumerable, ReentrancyGuard {
    ...
    uint256 private defaultPreSaleId = 0;
    ...
    */
    ...
    address public openSeaProxy = 0xF57B2c51dED3A29e6891aba85459d600256Cf317; // change it to main net: 0xa5409ec958c83c3f309868babaca7c86dcb077c1
    ...
    */
    function publicMint(uint256 quantity, uint256 saleId) external payable nonReentrant {
        require(totalSupply() + quantity <= COLLECTION_SIZE, "purchase would exceed max supply of Cows");
        verifyPublicSale(quantity, saleId);
        _safeMint(msg.sender, quantity);
    }
    ...
    */
    ...
    function setDefaultPreSaleId(uint256 saleId) external onlyOwner {
        defaultPreSaleId = saleId;
    }
...
contract AllowListSale {
    ...
    function _addSale(uint256 id, SaleConfig memory config) internal virtual {
        require(!saleConfig[id].exists, "another sale is defined with this id");
