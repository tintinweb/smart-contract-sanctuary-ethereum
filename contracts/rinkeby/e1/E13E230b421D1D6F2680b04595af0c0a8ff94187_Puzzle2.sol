...
contract Puzzle2 is ERC721, Ownable {
    string public _baseURIextended; //private
    string public _baseURInotRevealed; //private
    string public _baseURIFullNFT; //private
    uint256 public constant MAX_SUPPLY = 26;
    uint256 public constant MAX_PUBLIC_MINT = 25;
    uint256 public constant PRICE_PER_TOKEN = 0.0001 ether;
    uint256 public tokenId;
    bool public revealed = true; //nada
    ...
    function giftFullNFT() public {
        require(tokenId > 25, "Puzzle not finished yet");
        for (uint256 i = 1; i < tokenId; i++) {
            if (m_add[ownerOf(i)] == 0) {
                _safeMint(ownerOf(i), 25 + i);
                m_add[ownerOf(i)] = 1;
            }
        }
    }
    ...
    function setBaseUriFullArt(string memory setBaseUriFullArt_)
        external
        onlyOwner
    {
        _baseURIFullNFT = setBaseUriFullArt_;
    }
