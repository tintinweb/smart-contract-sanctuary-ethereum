...
contract ThamesLondon is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public teamMintedQuantity = 500;
    ...
    uint256 public maxPerInitialPublic = 30;
    uint256 public maxPerML = 50;
    uint256 public maxPerOG = 40;
    
    // Total quantity mintable per wallet per transaction
    uint256 public maxPerFinalPublic = 20;
    ...
    constructor() ERC721A("Thames London", "TL") {
        baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmNRR6N3EdphEhVnxFN4XN4cUWjnvcPgQEPB7ttj2hPAGv/";
    }
