...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA2384863220b0cEfc57Bb0341f9721Fb84def5b3];
...
// File: contracts/MskdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MskdContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "MSKD";
    string public symbol = "MSKD";
