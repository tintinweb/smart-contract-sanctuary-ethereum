...
contract FuglyDoodles is ERC721A, Pausable, Ownable {
  using Strings for uint256;

  constructor() ERC721A("FuglyDoodles", "FG") {}
  ...
  modifier mintCompliance() {
    ...
    require(
      _numberMinted(msg.sender) + 1 <= maxMintAmount,
      "Invalid mint amount!"
    );
    _;
  }
    ...
    mintCompliance
  {
    ...
    require(
      whitelistMinted < maxWhitelistTokens,
      "Max Whitelist Tokens Reached"
    );
  ...
  function publicMint() external payable whenNotPaused mintCompliance {
    require(publicSaleOpen, "PreSale Is Not Open");
    _mint(msg.sender, 1);
  }
  ...
  function withdraw() public onlyOwner {
    (bool dev, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{
