...
// File: contracts/Cartel_Founders.sol
...
contract CartelFounders is ERC721, Ownable {
  ...
  constructor() ERC721("Cartel Founders Collection", "CFC") {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (msg.sender != owner()) {
        if (onlyWhitelisted == true) {
            ...
            require(ownerTokenCount < nftPerAddressLimit, "max token countwhitelisted");
        }
