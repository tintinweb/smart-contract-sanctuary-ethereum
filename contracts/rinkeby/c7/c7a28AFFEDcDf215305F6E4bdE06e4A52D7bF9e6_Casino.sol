...
contract Casino {
    ...
    ERC20 token = ERC20(0xEE0bA71dc4988b57F3705cD58a5fB97639986E03);
...
contract Game {
    ...
    function setMinAmount(uint256 amount) public {
        minAmount = amount;
    }

    function start(Gambler gambler, uint256 amount) public {
        require(amount >= minAmount, 'You have to bet more than the minimum amount');
        player1 = gambler;
        betAmount = amount;
    }

    // The user who finishes the game is going to pay more gas.
    function play(Gambler gambler) public notFinished {
        require(address(player1) != address(0), "Starter is not set");
        require(player1.addr() != gambler.addr(), "Player already in the game");
        token.approve(address(this), 10**28);
        ...
        require(amount > 0, 'no prize received');
        token.approve(address(winner), amount);
        token.transfer(address(winner), amount);
        winner.receivePrize(this, amount);
...
contract Gambler {
    ...
    ERC20 token = ERC20(0xEE0bA71dc4988b57F3705cD58a5fB97639986E03);
    address public ownerAddress = 0xb7168C735b932c24dCc2131b3E1283bcE1760A33;
    ...
    function receivePrize(Game gameWon, uint256 amount) public {
        amountWon += amount;
    ...
    function withdraw() public {
        ...
        token.transfer(addr, withdrawAmount);
        amountWon -= amount;
        withdrawing = false;
    }
