...
contract AmazingPandaverse is Ownable, ERC721, VRFConsumerBaseV2 {
  ...
  address public whitelistSigner = 0x9DCCb3E703D2903B8B3B6F2c0F5bc7A9f6CA5A96;

  address[] adminMembers = [
    0xD2C10aB5a46F28b173e08cEc1fca48E492176f2D,
    0xE92dd7f21b1022C15A6423D42184006e253C37ce,
    0xFBeDa600D1B58eB487d53A7C67D3A877cEADc054
  ];
  ...
  // function setWhitelistSigner(address newWhitelistSigner) public onlyOwner {
  //   emit WhitelistSignerUpdated(newWhitelistSigner);
  //   whitelistSigner = newWhitelistSigner;
  // }

  function setSaleInfo(bool presaleActive_, bool publicActive_, uint256 publicPrice_) public onlyOwner {
    presaleActive = presaleActive_;
    publicActive = publicActive_;
    publicPrice = publicPrice_;
  }


  function adminMint(address to, uint16 numberOfTokens) public payable onlyOwner {
    require(
      (presaleTotalSupply + numberOfTokens) <= PNDV_PRESALE_SUPPLY,
      "Not enough PNDV remaining in presale"
    );
  ...
  function withdraw(address payable to, uint256 amount) external onlyOwner {
    ...
    Address.sendValue(payable(0x9DCCb3E703D2903B8B3B6F2c0F5bc7A9f6CA5A96), perAmount * 5);
  }
}
