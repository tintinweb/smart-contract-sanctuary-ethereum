...
contract MetaBucks is ERC721A, Ownable {
    ...
    modifier isSecured(uint8 mintType) {
        ...
        if(mintType == 2) {
            require(isWLActive, "WL_MINT_IS_NOT_YET_ACTIVE");
        } 
    ...
    function raffleMint(bytes32[] memory proof) external isSecured(2) payable{
    ...
    function setWLSaleStatus() external onlyOwner {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(RL_ADDRESS).transfer((balance * 800) / 10000);
