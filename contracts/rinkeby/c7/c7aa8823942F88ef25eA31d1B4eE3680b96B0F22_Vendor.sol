...
contract Vendor {
  ...
  event SellTokens(address seller, uint256 amountOfETH, uint256 amountofToken);
  ...
  //   payable(address(this)).transfer(amountofETH);
  //   emit BuyTokens(msg.sender, amountofETH, amount);
  // }
