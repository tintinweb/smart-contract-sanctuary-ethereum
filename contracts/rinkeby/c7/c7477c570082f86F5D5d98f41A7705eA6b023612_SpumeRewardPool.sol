...
contract SpumeRewardPool is ReentrancyGuard, Ownable, Pausable {
   ...
   */ 
  function deposit(uint256 amount) external onlyOwner whenNotPaused returns (uint256) {
...
contract SpumeStaking is ReentrancyGuard, Ownable, Pausable { 
     ...
     */ 
    function getStaked(address account) public view whenNotPaused returns (uint256) {
     ...
     */ 
    function getCreatedAt() public view whenNotPaused returns (uint256) {
        return s_createdAt;
    }
