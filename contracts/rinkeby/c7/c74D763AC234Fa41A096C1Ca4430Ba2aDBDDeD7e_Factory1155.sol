...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new TokenAimUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TokenAimUser1155Token token = TokenAimUser1155Token(address(addr));
...
contract TokenAimUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
