...
contract TESTMANZI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "MANZI TEST";
    string private constant _symbol = "TMANZI";
    ...
    //Set the payable addresses
    address payable private _developmentAddress = payable(0xEAd5694b0984FF2A49daf12b5e0847C35c2dFECe);
    address payable private _marketingAddress = payable(0x28333b99E17E0E2EceB2b71b691d78d394d9d615);
    ...
    uint256 public _maxWalletSize = 750000 * 10**9; //
