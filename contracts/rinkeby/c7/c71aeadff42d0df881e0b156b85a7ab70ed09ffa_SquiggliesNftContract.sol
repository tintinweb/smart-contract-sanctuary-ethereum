...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmUnAf6MSJZzGeGSQeTEohtcPbTMU3CfiiVwjxsqqbpU4R/";
        ...
        constructor(
            ...
            payableAddresses.push(0xA119349142FFb6930bee8bA529D635CD42639CE5);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 555");
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 555");
    ...
    // File: contracts/squiggliesNftContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SquiggliesNftContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("SquiggliesNFT", "SQDNFT", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/NfkR8axWqUzlRfi8w7BR/contract-metadata";
        }
    }