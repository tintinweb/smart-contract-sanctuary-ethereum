...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        (, int256 price, , , ) = ehtUsdPriceFeed.latestRoundData();
    ...
    function startLottery() public onlyOwner {
        require(
            lottery_state == LOTTERY_STATE.CLOSED,
            "Can't start a new lottery yetÂ¡"
        );
    ...
    function endLottery() public onlyOwner {
        //randomness
        //uint256(
        //    keccack256( //this is an unacceptable way to get a random number
        //        abi.encodePacked(
        //            nonce, // nonce is preidctable (aka transaction number)
