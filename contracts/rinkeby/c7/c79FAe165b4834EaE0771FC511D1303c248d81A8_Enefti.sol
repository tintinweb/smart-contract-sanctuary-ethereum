...
contract Enefti is ERC721, ERC721Enumerable {
    ...
    // Para todos los enteros256 se utilizar├í la librer├¡a Strings y har├í un override de su funcionalidad.
    using Strings for uint256;
    ...
    constructor() ERC721("Enefti", "ENFT") {
        // Se le settea un m├íximo de NFTs posiblemente generados.
    ...
    // Funci├│n que se usa para indicar de donde vienen los nfts (nft base)
    ...
    // Funci├│n que devuelve el string del json del NFT (TokenURI)
...
/**
    Metadata del ERC721
    El ERC721 Metadata es una extensi├│n al est├índar ERC721 para NFT que a├▒ade estas 3 funciones:
