...
contract UpgradeableOpenTokenV2 is ERC20Upgradeable {
    ...
    bool public inited;
    // decimalsBase 10 ** 18
    uint256 public decimalsBase;
    // supply limit 1 Billion
    uint256 public supplyLimit;
    uint256 public totalOpenSupply;
    uint256 public firstWeekEmission;
    uint256 public emissionWeekCount;
    mapping (uint256 => uint256) public weekEmissionList;
    uint256 public WEEKLY_REDUCTION_RATE; //1.5 ** (1/52) * 1e18
    uint256 public WEEK;
    //start emission time
    ...
    function initialize(string memory name_, string memory symbol_) public initializer    {
        ...
        decimalsBase = 1000000000000000000;
        // supply limit 1 Billion
        supplyLimit = 1000000000 * decimalsBase;
        totalOpenSupply = 6000000000 * decimalsBase;
        firstWeekEmission = 3161335 * decimalsBase;
        emissionWeekCount = 520;
        WEEKLY_REDUCTION_RATE = 1007827884862117171; //1.5 ** (1/52) * 1e18
        WEEK = 7 * 86400;
        //start emission time
        startTime = 0;
        weekNum = 0;
    ...
    function setXxx(uint256 xxx_) external returns (uint256){
        xxx = xxx_;
        return xxx;
    }
