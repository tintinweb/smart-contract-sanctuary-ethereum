...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x125f7b5eb6811Fbc92489c44B46d666205298098];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x125f7b5eb6811Fbc92489c44B46d666205298098;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.crowds.app/getNFTMetadata/crowds/";
...
// File: contracts/EthTestRampContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract EthTestRampContract is RamppERC721A {
    constructor() RamppERC721A("ETH Test Ramp", "ETRAMPP"){}
}
