...
import "./ERC20 extends/token/ERC20Rewards base.sol";
...
contract SocietyKey is ERC20Rewards {
    ...
    ) ERC20Rewards(name, symbol, decimals, rate, delay, operator) {
    ...
    function calculate(address user) public view returns (uint256) {
        ...
        return
            ...
            ((_balanceOf[user] *
                ...
                userRewards_.locked *
                min(rewardDelay, (currentTimestamp - userRewards_.checkpoint))) *
                rewardRate) /
