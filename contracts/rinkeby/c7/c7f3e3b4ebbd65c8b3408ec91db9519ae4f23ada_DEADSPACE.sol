...
contract DEADSPACE is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0x61Ed452f9E02cafCD87FaF27aA7b6859B601557E).call{value: artistPayment}('');
    require(artistSuccess);

    (bool marketerSuccess, ) = payable(0x61Ed452f9E02cafCD87FaF27aA7b6859B601557E).call{value: marketerPayment}('');
