...
contract PandaRefund is Ownable, ReentrancyGuard {
    ...
    mapping(address => bool) public approveRedeemed;
    ...
    function approveRedeem() external refundOpenning timeOut {
        ...
        require(!approveRedeemed[msg.sender], "PandaDAO:approveRedeemed! ");
        (bool success, bytes memory result) = operatorStore.delegatecall(abi.encodeWithSignature("setOperator(address,uint256,uint256[] calldata )", address(this), PANDADAO_PROJECT_ID, operationsRedeem));
        approveRedeemed[msg.sender] = true;
    }
    ...
    function redeem(uint256 amount, uint256 totalAmount) external nonReentrant refundOpenning timeOut{
        ...
        emit Redeem(msg.sender, 100, 1000);
