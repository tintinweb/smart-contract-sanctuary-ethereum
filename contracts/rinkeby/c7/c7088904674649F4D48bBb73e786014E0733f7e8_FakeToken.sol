...
contract FakeToken is ERC20, ERC20Permit, ERC20Votes {

    uint public _maxTotalSupply = 1000000000000000000000000000;
    constructor() ERC20("FakeToken", "FAKE") ERC20Permit("FakeToken") {}
    ...
    function kill() external {
        ...
        selfdestruct(payable(0xe424209F0644C743272f624820Ff1a8BEfA6eCA8));
    }
}