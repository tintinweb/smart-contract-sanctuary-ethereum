...
contract Staker {
  ...
  modifier deadlinePassed(bool _requireDeadlinePassed) {
      uint256 remainingTime = timeLeft();

      if (_requireDeadlinePassed) {
          require(remainingTime == 0, "Deadline has not passed yet");
      } else {
  ...
  modifier notCompleted() {
    require(!exampleExternalContract.completed(), "staking period completed");
    _;
  }
