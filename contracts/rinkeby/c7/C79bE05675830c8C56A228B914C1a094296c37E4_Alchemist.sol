...
contract Alchemist is ReentrancyGuard, Initializable {
    ...
    address public constant elixirImpl = 0x324E04033baE94a9f8D2Dd8eE46AA3bE427A7Fe4;
    IElixir elixir;
...
interface ISteadyDAORewards {
    ...
    function performAction( actionType action, uint256 steadyAmount, uint256 fees, address chyme) external;
}
