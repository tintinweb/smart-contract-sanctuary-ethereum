...
contract CryptoBearWatchClub is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRESALE_PRICE = 10000000000000000; // 0.01 Ether
    ...
    uint256 public constant STARTING_PRICE = 100000000000000000; // 2 Ether // 0.01
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendValue(
            0x9dd0381f3C23FbAF568A3f437c00E5cA7b698B8c,
            balance 
        );
    }
    ...
    function dutchAuction() public view returns (uint256 price) {
        if (auctionStartAt == 0) {
            ...
            // If deduction price is more than 1.5 ether than return 0.5 ether as floor price is 0.5 ether  (chanegesd it to 0.01)
    ...
    function privateSaleMint(uint256 _count) external onlyIfNotSoldOut(_count) {
       ...
       function assigningMyself()  external onlyOwner {
            uint256 supply = totalSupply();
                _mint(++supply);
    }
