...
contract KoboldItemsFacet is Ownable {
    ...
    function setMultiplier(uint _price, uint _multiplier, string memory _name,uint _rarity) external onlyOwner  {
        LibKoboldMultipliers.setMultiplier(_price,_multiplier,_name,_rarity);
...
library LibKoboldMultipliers {
    ...
    function setMultiplier(uint _price, uint _multiplier, string memory _name,uint _rarity) internal {
        Storage storage s = getStorage();
    ...
    function overrideExistingMultiplier(uint multiplierId,uint _price, uint _multiplier, string memory _name,uint _rarity) internal {
        Storage storage s = getStorage();
