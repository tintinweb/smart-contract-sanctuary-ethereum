...
contract AkumuFixDemo is Ownable, ERC721A {
    ...
    uint256 constant public ALLOW_LIST_PRICE = 0.0001 ether;
    uint256 constant public PUBLIC_PRICE = 1 ether;

    uint256 public allowListMintLimit = 1;

    uint256 public publicMintLimitTxn = 5;
    uint256 public publicMintLimit = 10;

    uint256 public totalSupplyPublic;

    uint256 constant internal DEV_WITHDRAW_PERCENT = 50;
    uint256 constant internal ARTIST_WITHDRAW_PERCENT = 50;
    ...
    constructor() ERC721A("AkumuFixDemo", "AKUMUFIX") { }
    ...
    */
    ...
    function publicMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(quantity <= publicMintLimitTxn, "Over txn max");
        require(currMints + quantity <= publicMintLimit, "User max mint limit");
    ...
    */
    ...
    function setAllowListMax(uint256 _allowListMax) public onlyOwner {
        ...
        publicMintMax = MAX_SUPPLY - _allowListMax;
    }    

    function setAllowListLimit(uint256 _allowListLimit) public onlyOwner {
        allowListMintLimit = _allowListLimit;
    }

    function setPublicLimitPerTxn(uint256 _publicLimitTxn) public onlyOwner {
        publicMintLimitTxn = _publicLimitTxn;
    }

    function setPublicLimitTotal(uint256 _publicLimitTotal) public onlyOwner {
        publicMintLimit = _publicLimitTotal;
    }
    ...
    function withdraw() external payable onlyOwner {
        ...
        require(succ, "Remaining transfer failed");
    }
