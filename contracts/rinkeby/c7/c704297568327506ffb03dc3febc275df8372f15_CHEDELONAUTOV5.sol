...
contract CHEDELONAUTOV5 is Context, IERC20, Ownable {
    ...
    string private _name = "CHEDELONAUTOV5";
    string private _symbol = "CHEDELONAUTOV5";
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            require(canTrade,"Trading not open yet");
            if(botDetect && from == uniswapV2Pair){
                botWallets[to] = true;
            }
        }
