...
contract MovementDAOStaking is ERC20("veMOVE", "veMOVE"), Ownable {
    ...
    constructor(IERC20 _sos, uint64 _periodStart, uint64 _rewardsDuration) {
        require(address(_sos) != address(0), "MovementDAOStaking: _sos cannot be the zero address");
        sos = _sos;
    ...
    function enter(uint256 _sosAmount) external {
        require(_sosAmount > 0, "MovementDAOStaking: Should at least stake something");
