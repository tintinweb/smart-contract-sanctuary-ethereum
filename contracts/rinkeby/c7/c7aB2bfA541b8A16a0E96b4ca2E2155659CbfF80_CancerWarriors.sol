...
╚██████╗██║  ██║██║ ╚████║╚██████╗███████╗██║  ██║    ╚███╔███╔╝██║  ██║██║  ██║██║  ██║██║╚██████╔╝██║  ██║███████║
  ...
  */
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    require((msg.value >= cost * _mintAmount) || (_currentIndex + _mintAmount <= freeMintLimit), "Insufficient funds!");
    _;
  }
  ...
  function getCurrentCost() public view returns (uint256 _cost) {
