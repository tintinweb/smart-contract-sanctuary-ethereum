...
contract OneDollarTicket is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    uint wholepercentage = 50;
    uint percenttogive = wholepercentage * 100;
    ...
    // This allows the owner to change the price of the ticket
    function PercentToGive(uint _percentage) public onlyOwner{
        wholepercentage = _percentage;
    }

    // This allows the owner to change the price of the ticket
    function ShowPercentToGive() public view returns (uint) {
        return percenttogive;
    }
    ...
    function payWinner() nonReentrant public onlyOwner {
        ...
        players[index].transfer( (address(this).balance / 1000) * percenttogive );
