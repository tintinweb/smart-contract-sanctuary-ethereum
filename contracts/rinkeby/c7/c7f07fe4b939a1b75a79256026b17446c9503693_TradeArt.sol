...
contract TradeArt is Initializable, OwnableUpgradeable {
    ...
    mapping(uint256 => DayWiseOrder[]) public DayWiseOrderArray;
    ...
    function saleToken(
        ...
        DayWiseOrder memory daywiseorder;
        daywiseorder.from = from;
        daywiseorder.to = msg.sender;
        daywiseorder.amount = amount;
        daywiseorder.typeCurrency = "BNB";

        DayWiseOrderArray[memorydateStake].push(daywiseorder);
    }
    ...
    function acceptBId(
        ...
        DayWiseOrder memory daywiseorder;
        daywiseorder.from = msg.sender;
        daywiseorder.to = bidaddr;
        daywiseorder.amount = amount;
        daywiseorder.typeCurrency = "WETH";

        DayWiseOrderArray[memorydateStake].push(daywiseorder);
    }

    function getOrders(uint256 memorydateStake)
        public
        view
        returns (DayWiseOrder[] memory)
    {
        return DayWiseOrderArray[memorydateStake];
    }
