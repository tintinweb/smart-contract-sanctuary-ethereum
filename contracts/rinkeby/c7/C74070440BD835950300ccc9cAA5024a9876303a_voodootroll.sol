...
contract voodootroll is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmcJdmoQGrTj8YNwjC1iyiUbeqg7pfStbSGH1hUUdPJWiY";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmcJdmoQGrTj8YNwjC1iyiUbeqg7pfStbSGH1hUUdPJWiY";
    ...
    address constant internal DEV_ADDRESS = 0x0376473D2306830EcA550c430805b8425887F9cc;
    address constant internal WEB_ADDRESS = 0x58B7A883C26A55aA7763789872a0E59e00Dc224c;
    ...
    constructor() ERC721A("voodootroll", "VOODOO") {}
    ...
    */
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 10, "Not enough free supply");
