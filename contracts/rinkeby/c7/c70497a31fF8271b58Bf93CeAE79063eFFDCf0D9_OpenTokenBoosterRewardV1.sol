...
contract OpenTokenBoosterRewardV1 is Initializable, ChainlinkClient {
    ...
    * @notice Returns the cid of the target weektime .
    */
    function getCids(uint256 t_) external view returns ( string[] memory) {
        uint256 weekTime = t_ / WEEK * WEEK;
        uint256 cidCount = (maxWeekTime-weekTime)/WEEK+1;
    ...
    */
    function requestReward(uint256 claimGaugeId_) public {
        ...
        req.add('gaugeAddr', StringsUpgradeable.toHexString(uint256(uint160(address(this))), 20));
