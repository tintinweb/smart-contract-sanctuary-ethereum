...
contract FloorPlans is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public ownerMaxMint = 100;
    uint256 public lastMint = 100;
    ...
    function getLastMint() external view onlyOwner returns(uint256 _lastMint) {
        return lastMint;
    }
    ...
    function getOwnerLastMint() external view onlyOwner returns(uint256 _ownerLastMint) {
        return ownerLastMint;
    }
    ...
    constructor(string memory __baseURI) ERC721("NFT Floor Maps", "NFTFLOORMAPS") Ownable() {
        baseURI = __baseURI;
    }
}
