...
contract FirstNightOut is AdminControl, ICreatorExtensionTokenURI {
    ...
    function tokenURI(address creator, uint256 tokenId) external view override returns (string memory) {
       ...
       return string(abi.encodePacked('data:application/json;utf8,',
        '{"name":"First Night Out","created_by":"Andrew Jiang","description":"Andrew Jiang","image":"https://arweave.net/4MkJ36F0KNddbSSCU-kYjsLn7C00Erpno3qnsUp7slU","image_url":"https://arweave.net/4MkJ36F0KNddbSSCU-kYjsLn7C00Erpno3qnsUp7slU"}'));
    //    return string(abi.encodePacked('data:application/json;utf8,',
    //     '{"name":"',
    //     getName(tokenId),
    //     '","created_by":"Andrew Jiang","description":"Andrew Jiang",',
    //     '"}'));
    }
