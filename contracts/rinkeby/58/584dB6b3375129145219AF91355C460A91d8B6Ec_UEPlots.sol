...
contract UEPlots is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	function inWhitelist(address add) public view onlyOwner returns (bool) {
	...
	function getWhitelist() public view onlyOwner returns (address[] memory _adds, uint256[] memory _tokenIDs) {
