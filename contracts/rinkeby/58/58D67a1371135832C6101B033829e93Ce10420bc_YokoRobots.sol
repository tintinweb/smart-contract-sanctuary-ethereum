...
contract YokoRobots is ERC721A, Ownable {
    ...
    constructor(string memory _initBaseURI) ERC721A("YokoRobots", "YokoR") {
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(supply + quantity <= maximumSupply + maximumFreeSupply, "Exceeds maximum supply");
    ...
    function freeMint(uint256 quantity) external payable {
        ...
        require(!publicSale, "Free is expired!");
