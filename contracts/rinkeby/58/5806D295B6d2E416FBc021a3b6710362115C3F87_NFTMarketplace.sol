...
contract NFTMarketplace is Pausable, FeeManager, ERC721Holder {
    ...
    mapping(address => AuctionDataForProfile) public dataForProfile; 
    ...
    function updateOrder( uint256 _tokenId, uint256 _askingPrice) public whenNotPaused {
    ...
    function _createAuction(uint256 _tokenId, uint256 _minBid, uint _expiryTime) internal   {
        ...
        // dataForProfile[msg.sender] = AuctionDataForProfile({
        ...
        function _executeOrder(bytes32 _orderId, address _buyer, uint256 _tokenId) internal {
            ...
            emit OrderSuccessful(_orderId, _buyer);
        }
    ...
    function orderTokensOfOwner()public view returns (uint256[]memory  re)
    {
        uint256[] memory result=new uint256[](orderrID.length);
    ...
    function placeBidEth(uint _tokenId) public payable  {
        ...
        if (bidData.bidCounter != 0) {
            ...
            (bool success, ) = bidData.highestBidder.call {
