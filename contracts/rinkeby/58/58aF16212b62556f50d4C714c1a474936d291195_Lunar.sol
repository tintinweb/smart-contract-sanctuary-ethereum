...
contract Lunar is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Lunar Test v2", "LUN") {
    setHiddenMetadataUri("ipfs://QmQmBcCvWQXzPq2tn9V96A2wpZm9yNaZNNUUVWGAmNNbHF/hidden.json");
  }
