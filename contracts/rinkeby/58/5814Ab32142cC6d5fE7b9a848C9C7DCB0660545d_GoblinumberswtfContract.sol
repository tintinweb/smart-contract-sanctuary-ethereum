...
//
//                                                                _ 
//   _   _   /7  /7()_        _     /7  __ _  __       /7 ,'_7
// ,'o|,'o| /o\ ///7/ \/7/7/7/ \'\ /o\,'o///7(c'/7/7/7/_7/_7  
// |_,'|_,'/_,'/////_n_//__//_nn_//_,'|_(// /__)|,^,'// //    
// _//                                                        
//     
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2325415618ffED7e12292282309867cF6b03B6Db];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  using SafeMath for uint256;
  uint256 public PRICE = 0.002 ether;
  uint256 public EARLY_MINT_PRICE = 0 ether;
  uint256 public earlyMintTokenIdCap = 1000;
  bool public usingEarlyMintIncentive = true;

  function enableEarlyMintIncentive() public onlyOwner {
    usingEarlyMintIncentive = true;
  }

  function disableEarlyMintIncentive() public onlyOwner {
  ...
  */
  function setEarlyMintTokenIdCap(uint256 _newTokenIdCap) public onlyOwner {
  ...
  */
  function setEarlyIncentivePrice(uint256 _feeInWei) public onlyOwner {
  ...
  */
  ...
  function getPrice(uint256 _count) public view returns (uint256) {
    ...
    if(endingTokenId  <= earlyMintTokenIdCap) {
      return EARLY_MINT_PRICE.mul(_count);
    }
    ...
    return EARLY_MINT_PRICE.mul(incentiveTokenCount) + PRICE.mul(outsideIncentiveCount);
  }
}
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 9999) { }
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiabkoe6b6wpt5hgwe3iilxfv53kwcemhgrshblg4xvljkrvg77ztu/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 9999");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9999");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9999");
...
// File: contracts/GoblinumberswtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinumberswtfContract is RamppERC721A {
    constructor() RamppERC721A("goblinumberswtf", "GOBDIGI"){}
}
