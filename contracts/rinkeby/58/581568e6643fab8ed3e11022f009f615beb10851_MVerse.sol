...
contract MVerse is ERC721, Ownable {
  ...
  constructor() ERC721("MVerse", "MVU") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push( Building("ZERO", 0, 0, 0, 0, 0, 0));
    buildings.push( Building("House", 1, 3, 2, 2, 0, 3));
    buildings.push( Building("House 2", 1, 3, 2, 7, 0, 7));
    buildings.push( Building("House 3", 1, 3, 2, 5, 0, 5));
    buildings.push( Building("House 4", 1, 3, 2, -2, 0, -3));
    buildings.push( Building("House 5", 1, 3, 2, 12, 0, 5));
  }
