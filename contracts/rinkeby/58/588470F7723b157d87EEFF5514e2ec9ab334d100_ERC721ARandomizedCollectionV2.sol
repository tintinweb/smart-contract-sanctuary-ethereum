...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint16 internal constant DEFAULT_SEQ_MINT_LIMIT = 5;
    uint16 internal constant MAX_SEQ_MINT_LIMIT = 10;
    uint16 public seqMintLimit;
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        ...
        if (tokenId < _nextSequential) return true;
...
contract ERC721ARandomizedCollectionV2 is ERC721Marketplace {
    ...
    function _init(
        ...
        if (uints[7] == 0 || uints[7] >= 500) {
            ...
            transactionMax = uint64(uints[7]);
        }
        maxMint = uint64(uints[8]);
