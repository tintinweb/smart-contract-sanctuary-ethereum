...
// File: contracts/UpgradedTriangles.sol
...
contract UpgradedTriangles is ERC721A, Ownable { 
    using Address for address;
    ...
    constructor () ERC721A ("UpgradedTriangles", "UPTR") { }
    ...
    function withdrawTeam(uint256 amount) public payable onlyOwner {
        ...
        require(payable(a2).send(percent * 75));
    }
}