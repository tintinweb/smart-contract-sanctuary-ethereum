 ...
 * |--------------------------------------------------------------------------------|
 *
 * Thanks to those below for the awesome gas optimizations
 *
 * @dc & @hotshave
 * @nftchance & @masonnft
 * @squeebo_nft
...
contract PrisonersDilemmaClub is ERC721Enumerable, Ownable {
    string public PROVENANCE_HASH;
    string public baseURI;
    string public unrevealedTokenURI;

    // Opensea Proxy Registration Addresses:
    ...
    uint256 public constant MAX_PER_TX = 6; // Set to 1 more than the desired amount for gas optimzation
    uint256 public constant RESERVES = 500; // Set to the desired amount
    uint256 public constant priceInWei = 0.1 ether;
    uint256 public constant public_sale_priceInWei = 0.2 ether;
    bool isRevealed = false;

    mapping(address => uint256) public addressToMinted;

    constructor(address _proxyRegistryAddress, address _withdrawalAddress) ERC721("Prisoners Dilemma Club NFT", "PDC") {
    ...
    function publicMint(uint256 count) public payable {
        ...
        require(count * public_sale_priceInWei == msg.value, "Invalid funds provided.");
    ...
    // turns on public sale by setting MAX_SUPPLY, which passes require in publicMint()
