...
contract ERC721MarketPlace is Initializable, UUPSUpgradeable, ERC721HolderUpgradeable, OwnableUpgradeable {
    // Storage
        ...
        activeAuction(tokenID, _mintableToken)
    {
        ...
        if (_auction.erc20Token == address(0)) {
            ...
            IERC20Upgradeable erc20Token = IERC20Upgradeable(_auction.erc20Token);
            require(
    ...
    function collect(uint256 tokenID, address _mintableToken) public {
        ...
        if(msg.sender != _auction.lastOwner){
