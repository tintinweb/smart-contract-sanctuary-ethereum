...
contract ClaimClassNFT is Pausable, Ownable {
    ...
    function claim(uint256 glitch, uint256 tokenId, address receiver, bytes memory signature) public {
      require(hasClaimed[glitch] == false, "Already claimed");
      require(_isApprovedOrOwner(msg.sender, glitch), "Not approved");
