...
contract HeartsNFT is ERC721URIStorage, Ownable {
    ...
    function heartToImageURI(string memory _word, string[4] memory colorArray) private pure returns (string memory imageURI) {
        ...
        string memory oneSVG = string(abi.encodePacked("<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='325' width='325'><rect width='100%' height='100%' fill='",colorArray[0],"'/>"));
        ...
        string memory fourSVG = string(abi.encodePacked("<defs><g id='h'><path d='M50 160 l95 125 l95 -125a45 50, 35, 0,0 -95,-45a45,50 -35 0,0 -95,45z' /></g><g id='h2'><path d='M65 160 l88 115 l88 -115a40 45, 35, 0,0 -88,-45a40,45 -35 0,0 -88,45z' /></g></defs>")); 
        string memory fiveSVG = string(abi.encodePacked("<use href='#h' class='heart' fill='",colorArray[1],"'/><use href='#h2' class='heart' fill='",colorArray[2]));
        string memory sixSVG = string(abi.encodePacked("/><text id='d' class='base' x='150px' y='160'>",_word,"</text></svg>"));
        ...
        imageURI = string(abi.encodePacked("data:image/svg+xml;utf-8,",finalHeart));
    }
...
} //Base64.encode(bytes(string(abi.encodePacked(finalHeart))))
