    ...
    PausableUpgradeable
{
    ...
    // access: OPERATOR
    function stakeAt(address _controllerAddress, uint256 _maxAmount) external onlyOperator {
    ...
    // access: OPERATOR
    function unstakeAt(address _controllerAddress, bytes calldata _signature)
        external
        onlyOperator
    {
        uint256 _unstakedAmount = IPositionController(_controllerAddress).unstake(_signature);
