...
contract TipsyTest3 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Tipsy Test 3", "TIPSY"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Beer...");
