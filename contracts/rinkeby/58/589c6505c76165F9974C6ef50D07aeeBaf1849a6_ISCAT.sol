...
contract ISCAT is ERC721A, Ownable {
    uint256 public MAX_CATS;
    string private baseURI_;
    uint256 public MaxBatchSize;

    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 maxBatchSize) ERC721A(name, symbol, maxBatchSize, maxNftSupply) {
