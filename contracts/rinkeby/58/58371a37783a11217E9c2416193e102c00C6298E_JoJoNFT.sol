...
contract JoJoNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("JoJoNFT", "JoJo") {}
    ...
    function publicMint(address recipient, string memory metadataURI)
        public
        payable
        returns (uint256)
    {
        require(existingURIs[metadataURI] != 1, "NFT already minted!");
        require(msg.value == price, "Please Pay");
