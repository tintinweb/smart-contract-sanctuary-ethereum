...
interface IClearingHouse {
    ...
    /// @param isSwapWithBase (true: base -> quote, false: quote -> base)
    /// @param isSell (true: sell, false: buy)
    // Open Long : isSwapWithBase = true, isSell = false || isSwapWithBase = false, isSell = true
    // Open Short: isSwapWithBase = true, isSell = true  || isSwapWithBase = false, isSell = true
    // Close Long : isSwapWithBase = true, isSell = true
    // Close Short: isSwapWithBase = true, isSell = false
    /// @param amountLimit
    // isSell : the price cannot be less than this value after the swap
    // !isSell: the price cannot be greater than this value after the swap
