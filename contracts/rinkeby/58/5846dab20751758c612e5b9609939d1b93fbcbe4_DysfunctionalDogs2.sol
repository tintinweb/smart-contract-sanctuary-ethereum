...
contract DysfunctionalDogs2 is ERC721A("DysfunctionalDogs", "DDs"), Ownable, ERC721ABurnable, ERC2981 {
    ...
    */
    uint256 public startingPrice = 1.00 ether;
    uint256 public endingPrice =   0.10 ether;
    uint256 public discountRate =  0.02 ether;
    uint256 public startAt = 1649894583; // https://www.epochconverter.com/ // auction will not start automatically after deploying of contract
    uint256 public expiresAt = 1659894583; //  auction will not start automatically after deploying of contract
    uint256 public timeBlock = 1 minutes; // prices decreases every 1 minutes
