...
contract DGTEST is ERC721Enumerable, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  uint256 private constant MAX_PER_TX = 20;
  ...
  function mintPublic(uint256 amount) external payable nonReentrant() {
    ...
    require(amount > 0 && amount <= MAX_PER_TX, "You can't mint that many at once.");
    require(
