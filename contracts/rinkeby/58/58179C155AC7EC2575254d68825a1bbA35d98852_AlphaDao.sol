...
contract AlphaDao is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    
    string public baseURI = "";
    string public fullURI = "";
    string public constant baseExtension = ".json";
    uint256 public immutable price = 0.03 ether;
    
    mapping(address => uint256) public allowlist;
    
    constructor() ERC721A("AlphaDao", "ALPHADAO") {}
    ...
    function mint() external payable callerIsUser {
        ...
        require(totalSupply() + 1 <= 500, "Reached max supply");
