...
contract ELL is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmaeEV1MJ4JhN2894jCdYjefMakLSZAc4usiHcDeBYmSYK/";

  uint256 public  maxSupply = 9600;
  uint256 public  MAX_MINTS_PER_TX = 100;
  uint256 public  FREE_MINTS_PER_TX = 100;
  uint256 public  PUBLIC_SALE_PRICE = 0.001 ether;
  uint256 public  TOTAL_FREE_MINTS = 0;
  bool public isPublicSaleActive = true;

  constructor() ERC721A("ELLLL N", "QQ") {
