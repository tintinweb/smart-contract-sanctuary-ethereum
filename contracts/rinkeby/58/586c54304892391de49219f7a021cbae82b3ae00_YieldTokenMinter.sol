...
// File: contracts/YieldTokenMinter.sol
...
contract YieldTokenMinter is ERC20PresetMinterPauser {
    using SafeMath for uint256;

    uint256 public constant BASE_RATE = 10 ether;
    uint256 public constant INITIAL_ISSUANCE = 100 ether;
    //  Tuesday, March 1, 2022 0:00:00 - 1646092800
    //  Tuesday, February 1, 2022 0:00:00 - 1643673600
    uint256 public START = 1643673600;
    // Monday, March 1, 2032 0:00:00
    uint256 public constant END = 1961712000;
    ...
    constructor(address _ntfContract)
        ERC20PresetMinterPauser("NAME", "SYMBOL")
    {
        nftContract = INFTContract(_ntfContract);

        _mint(msg.sender, 10000); //create 10000 initial tokens
    ...
    function updateReward(address _from, address _to) external {
        ...
        if (_from != address(0)) {
            ...
            lastUpdate[_from] = lastUpdate[_from] < END ? time : END;
        }
        if (_to != address(0)) {
            ...
            lastUpdate[_to] = lastUpdate[_to] < END ? time : END;
        }
    }
    ...
    function getPendingReward(address _user) internal view returns (uint256) {
        ...
        return
            nftContract
                ...
                .div(86400); //lastUpdate[_user] >= START ? lastUpdate[_user] : START
    }

    function burn(address _from, uint256 _amount) external {
        //require(msg.sender == address(nftContract)); // will we need to burn outsite of main contract?
        require(
