...
contract MallowAuctionsV2 is Ownable{
    ...
    function spendLove(uint256[] calldata _tokenIds, uint256 _auctionId, uint256 _nounce, uint256 _price, bytes calldata _signature) external {
        ...
        nounces[msg.sender]++;
        emit buy(msg.sender, _auctionId);
    }
