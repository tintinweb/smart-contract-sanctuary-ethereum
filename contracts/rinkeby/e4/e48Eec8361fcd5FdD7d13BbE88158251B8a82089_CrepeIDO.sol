...
contract CrepeIDO is AccessControl, ReentrancyGuard {
    ...
    function finishCampaign(address _recipient) external {
        ...
        uint thisBalance = IERC20Metadata(USDC).balanceOf(address(this));
        IERC20Metadata(USDC).safeTransfer(_recipient, thisBalance);
        emit CampaignFinished(_recipient, thisBalance);
    } 
}
