...
contract MetaSpark is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private SWAPTOKEN = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //WBNB
    address private REWARD = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //BUSD

    string constant _name = "MetaSpark";
    string constant _symbol = "SPARK";
    ...
    // buy fees
    uint256 public buyDividendRewardsFee = 3;
    ...
    // sell fees
    uint256 public sellDividendRewardsFee = 3;
    ...
    address public marketingFeeReceiver = 0x105f24d575792e58b11c659bd90d4061bF87B690;
    address public devFeeReceiver = 0xeA0E151b09a3E0021e748A392f968037ACB5d042;
