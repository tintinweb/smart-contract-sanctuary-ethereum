...
contract Presale is Ownable {
  ...
  uint256 public  RATE = 14705 ; // Number of tokens per 1 ETH : 0.11$ per token
  uint256 public  CAP = 680; // Cap in ETH 
  uint256 public  START = 1663257739; // 10 oct, 2022 10:00 am Istanbul time(gmt +3) 
  uint256 public  DAYS = 21; // 21 Days 
  // The minimum amount of Wei you must pay to participate in the presale 
  uint256 public  MinPurchase = 1 * 1e15; /** 0.001 ETH  **/ // 100 tokens
uint256 public MaxPurchase = 370 * 10 ** 18;  // 50 % of Presale amount

  
  uint256 public constant initialTokens = 10000000 * 10**18; // 5% of total tokens available
  ...
  function destroy() onlyOwner public {
    ...
    // There should be no eth in the contract but just in case
