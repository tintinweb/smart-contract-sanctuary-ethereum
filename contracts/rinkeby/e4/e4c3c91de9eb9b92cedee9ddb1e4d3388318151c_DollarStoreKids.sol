...
/// @dev THIS IS NOT REAL MAINNET CONTRACT. DO NOT USE THIS AS IS FOR MAINNET
...
contract DollarStoreKids is Governable, IERC721Receiver {
    ...
    address public constant WETH = 0xf4BB2e28688e89fCcE3c0580D37d36A7672E8A9F;
    ICapsuleFactory public constant CAPSULE_FACTORY = ICapsuleFactory(0x95A8fEe7c00f72529E0626c4C24327b37DB5D235);
    ICapsuleMinter public constant CAPSULE_MINTER = ICapsuleMinter(0xaa2243319BB8a397288E9505c49E64F1C6Dd0132);
    ...
    uint256 private constant ONE_DOLLAR = 1e13; // 0.00001 WETH
    ...
    constructor(string memory provenanceHash_, string memory baseURI_) payable {
        ...
        IERC20(WETH).safeApprove(address(CAPSULE_MINTER), MAX_DSK * ONE_DOLLAR);
    }
    ...
    function burn(uint256 id_) external {
        ...
        IERC20(WETH).safeTransfer(_caller, ONE_DOLLAR);
