...
contract Fubao is ERC721A, Ownable {
    ...
    function mint(
        ...
        if (whiteListRemainAmount == 0) {
            ...
            _publicMint(amount);
            refundIfOver(amount * publicPrice);
        } else {
            require(
            ...
            if (amount <= whiteListRemainAmount) {
                ...
                refundIfOver(amount * whiteListPrice);
            } else {
                ...
                refundIfOver(publicTotalPrice + whiteListTotalPrice);
            }
        }
    }
    ...
    function getWhiteListRemainAmount(
        ...
        require(
            ...
            "white list total amount must be larger than the minted"
        );
        require(
            MerkleProof.verify(
                merkleProof,
