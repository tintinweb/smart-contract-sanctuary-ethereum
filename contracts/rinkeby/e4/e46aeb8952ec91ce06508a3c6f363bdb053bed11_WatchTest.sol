...
contract WatchTest is ERC721Enumerable, Ownable {
  using Strings for uint256;

  uint256 public maximumWalletHoldings = 100;
  address ethHolderWallet = address(0xB4f8579cF13F7f1eA3c1dC1B9b0193DEE4D34077);
  string baseURI;
  ...
  constructor() ERC721("Watch Plus Test", "WATCHPLUSTEST"){
    setBaseURI("");
    setNotRevealedURI("");
  }
