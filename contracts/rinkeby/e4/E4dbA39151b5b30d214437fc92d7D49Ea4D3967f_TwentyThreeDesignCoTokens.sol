...
// OpenSea Proxy contract stubs for reduced fees.
...
/// @title TwentyThreeDesignCoTokens
/// @author 23 Design Co.
contract TwentyThreeDesignCoTokens is ERC1155PresetMinterPauser
{
    // Attachments.
    ...
    /// @dev Grant roles to deployer address.
    ...
    /// @notice Set base token URI. Should end with trailing slash (/).
    ...
    function uri(uint256 id) public view override returns (string memory) {
        return
            bytes(_baseTokenURI).length > 0
                ? string(
                    abi.encodePacked(
                        abi.encodePacked(_baseTokenURI, id.toString()),
                        ".json"
                    )
                )
                : "";
    ...
    /// @notice Individual token burn reserved for admins and not holders.
    ...
    /// @notice Batch token burn reserved for admins and not holders.
