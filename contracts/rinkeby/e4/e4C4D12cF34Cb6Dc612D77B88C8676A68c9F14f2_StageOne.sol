    ...
    PrivateSalesActivation
{
    ...
    constructor()
        ERC721("Stage 1-1", "Stage1-1")
        Whitelist("Stage 1-1", "1")
    {}
    ...
    function publicSalesMint(
        ...
        isPublicSalesActive
    {
        require(salesMintedQty < TOTAL_SUPPLY, "Exceed sales max limit");
        require(
            salesMinterToTokenQty[msg.sender] + 1 <=
        ...
        isSenderWhitelisted(_signedQty, _nonce, _signature)
    {
        require(salesMintedQty < TOTAL_SUPPLY, "Exceed sales max limit");
        require(
            salesMinterToTokenQty[msg.sender] + 1 <= _signedQty,
