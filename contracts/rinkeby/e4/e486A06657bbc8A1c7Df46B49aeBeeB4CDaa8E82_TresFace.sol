    ...
    DigiSigHelper
{
    ...
    uint256 private constant MAX_NFTS_FOR_SALE = 4069;
    ...
    function presalePhaseOneTokens(
        ...
        (uint32 presalePhase1Purchases, uint32 presalePhase2Purchases) = _unpack32(_getAux(msg.sender));

        uint256 newBalance = presalePhase1Purchases + count;

        _setAux(msg.sender, _pack32(uint16(newBalance), presalePhase2Purchases));
    ...
    function presalePhaseTwoTokens(
        ...
        _setAux(msg.sender, _pack32(presalePhase1Purchases, uint16(newBalance)));
    ...
    function _bindToUser(
        ...
        TokenBindingData memory currentData = _tokenBindingMap[tokenId];
        uint256 generation = currentData.generation;
        ...
        if (generation == 0 && _isRefundingEnabled()) {
