...
contract PNQ1 is ERC721A, ERC721AQueryable, ERC721ABurnable,Ownable, ReentrancyGuard {
   ...
   bytes32 private DOMAIN_VERIFICATION = keccak256(
    ...
    constructor() ERC721A("MOTHEROFALLCONTRACTPNQ1", "PNQ1") {}
