...
contract CurrencySetter is Ownable {
    address public immutable currencyRegistry;
    ...
    constructor(
        ...
        address _adminRoleManager
    ) {
        currencyRegistry = _currencyRegistry;
        adminRoleManager = IRoleManager(_adminRoleManager);
    }

    function transferCurrencyRegistryOwnership(address newOwner) external onlyOwner {
        IOwnable(currencyRegistry).transferOwnership(newOwner);
    }

    function addCurrencyToCollection(
        address collectionAddress,
        address currencyAddress
    ) external hasAdminAccess {
        ICurrencyRegistry(currencyRegistry).addCurrencyToCollection(collectionAddress, currencyAddress);
    }
    ...
    function removeCurrencyFromCollection(
        ...
        ICurrencyRegistry(currencyRegistry).removeCurrencyFromCollection(collectionAddress, currencyAddress);
    }
}
