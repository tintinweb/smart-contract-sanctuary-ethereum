...
contract DPSQRNG is RrpRequesterV0, AccessControlEnumerable {
    ...
    mapping(bytes32 => uint256[]) public requestsArrays;
    mapping(bytes32 => uint256) public requestsSingles;
    ...
    function makeRequestUint256() external onlyRole(REQUEST_ROLE) {
    ...
    function fulfillUint256(bytes32 requestId, bytes calldata data) external onlyAirnodeRrp {
        ...
        lastRequestedSingle = qrngUint256;
        requestsSingles[requestId] = qrngUint256;
        requestIdsSingles.push(requestId);
    ...
    function makeRequestUint256Array(uint256 size) external onlyRole(REQUEST_ROLE) {
        bytes32 requestId = airnodeRrp.makeFullRequest(
            airnode,
    ...
    function fulfillUint256Array(bytes32 requestId, bytes calldata data) external onlyAirnodeRrp {
        ...
        requestsArrays[requestId] = qrngUint256Array;
        requestIdsArrays.push(requestId);
