...
contract OperationPrePunk is Ownable, ERC721A {
    ...
    mapping(bytes32 => bool) private usedHashPremint;
    ...
    mapping(address => uint256) private goblinAllowlist;

    //Addresses
    address private signer = 0xFD66dd3c6c47bad030f4B93212711A3367E4f44B;
    address private daoWallet;
    address private illuminatiNFT = 0x362d00816b9bB7678290d451d87a411Cd848C2B0;
    address private the187NFT = 0x70ed7F2e703bA94aaA3a4BbfC7e0a2D5e7F9B656;
    ...
    function premintMint(
        ...
        bytes32 hashAllowed = keccak256(abi.encodePacked(msg.sender));
        require(verify(hashAllowed, _voucher), "Not on allowlist");

        require(!usedHashPremint[hashAllowed],"Already Minted");

        _checkValid(shapes, colorsPrimary, colorsSecondary, positions, signature);

        amountMinted++;
        usedHashPremint[hashAllowed] = true;
        require(amountMinted <= MAX_SUPPLY, "Mint is over");
