...
//Variables
    ...
    function WithdrawReward()  public 
      {
       uint256 reward1 = rewardOfUser(msg.sender);
       uint256 burnamount=reward1*burnPercent/100;
       uint256 reward = reward1-burnamount;
    
       require(reward1 > 0,"you don't have reward yet!");
       require(token.balanceOf(address(token))>=reward1,"Contract Don't have enough tokens to give reward");
       ...
       User[msg.sender].totlaWithdrawn +=  reward1;
    ...
    function unstake(uint256[] memory _tokenId)  external 
        ...
        totalStakedNft[msg.sender]>0?totalStakedNft[msg.sender]-=_tokenId.length:totalStakedNft[msg.sender]=0;
            ...
            function setBurnPercent(uint256 _burn) external onlyOwner{
                burnPercent=_burn;
            }
