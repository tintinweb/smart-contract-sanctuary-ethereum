...
// hevm: flattened sources of /nix/store/xnb72bvqa188nb41c35nsz3pw04mhhvc-geb-proxy-actions/dapp/geb-proxy-actions/src/GebProxyIncentivesActions.sol
...
////// /nix/store/xnb72bvqa188nb41c35nsz3pw04mhhvc-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Factory.sol
...
////// /nix/store/xnb72bvqa188nb41c35nsz3pw04mhhvc-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Pair.sol
/* pragma solidity ^0.6.7; */
...
////// /nix/store/xnb72bvqa188nb41c35nsz3pw04mhhvc-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Router01.sol
...
////// /nix/store/xnb72bvqa188nb41c35nsz3pw04mhhvc-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Router02.sol
/* pragma solidity >=0.6.2; */
...
////// /nix/store/xnb72bvqa188nb41c35nsz3pw04mhhvc-geb-proxy-actions/dapp/geb-proxy-actions/src/GebProxyIncentivesActions.sol
/// GebProxyActions.sol
...
contract GebProxyIncentivesActions is BasicActions {
    ...
    function _provideLiquidityUniswap(address coinJoin, address uniswapRouter, uint tokenWad, uint ethWad, address to, uint[2] memory minTokenAmounts) internal {
        CoinJoinLike_2(coinJoin).systemCoin().approve(uniswapRouter, tokenWad);
        IUniswapV2Router02_2(uniswapRouter).addLiquidityETH{value: ethWad}(
            address(CoinJoinLike_2(coinJoin).systemCoin()),
            tokenWad,
            minTokenAmounts[0],
            minTokenAmounts[1],
            to,
    ...
    function _removeLiquidityUniswap(address uniswapRouter, address systemCoin, uint value, address to, uint[2] memory minTokenAmounts) internal returns (uint amountA, uint amountB) {
        ...
        return IUniswapV2Router02_2(uniswapRouter).removeLiquidityETH(
            systemCoin,
            value,
            minTokenAmounts[0],
            minTokenAmounts[1],
    ...
    function openLockETHGenerateDebtProvideLiquidityUniswap(
        ...
        safe = openSAFE(manager, collateralType, address(this));
        DSTokenLike_2 systemCoin = DSTokenLike_2(CoinJoinLike_2(coinJoin).systemCoin());
    ...
    function withdrawAndRemoveLiquidity(address coinJoin, address incentives, uint value, address uniswapRouter, uint[2] calldata minTokenAmounts) external returns (uint amountA, uint amountB) {
        GebIncentivesLike incentivesContract = GebIncentivesLike(incentives);
        incentivesContract.withdraw(value);
        return _removeLiquidityUniswap(uniswapRouter, address(CoinJoinLike_2(coinJoin).systemCoin()), value, msg.sender, minTokenAmounts);
    }
    ...
    function exitAndRemoveLiquidity(address coinJoin, address incentives, address uniswapRouter, uint[2] calldata minTokenAmounts) external returns (uint amountA, uint amountB) {
        ...
        incentivesContract.exit();
        rewardToken.transfer(msg.sender, rewardToken.balanceOf(address(this)));
        return _removeLiquidityUniswap(uniswapRouter, address(CoinJoinLike_2(coinJoin).systemCoin()), lpToken.balanceOf(address(this)), msg.sender, minTokenAmounts);
    }
    ...
    function getWethPair(address uniswapRouter, address token) public view returns (address) {
        IUniswapV2Router02_2 router = IUniswapV2Router02_2(uniswapRouter);
        IUniswapV2Factory_2 factory = IUniswapV2Factory_2(router.factory());
