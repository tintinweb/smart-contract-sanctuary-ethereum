...
contract Dwarf is ERC721, Ownable {
    ...
    uint private OG_SALE_PRICE = 0.01 ether;
    uint private PRE_SALE_PRICE = 0.01 ether;
    uint private PUBLIC_SALE_PRICE = 0.01 ether;
    ...
    */
    ...
    function burnPass() internal {
        uint256 tokenId = ipass.tokenOfOwnerByIndex(msg.sender, (ipass.balanceOf(msg.sender)-1));
        ipass.burn(tokenId);
    }
    ...
    onlyAccounts
    {
        ...
        require(ipass.balanceOf(msg.sender) > 0, "You haven't mintPass");
        require(addressToMintCount[msg.sender] + quantity <= NUMBER_OF_TOKENS_ALLOWED_PER_OG, "Exceeds allowance");
        require(msg.value >= OG_SALE_PRICE * quantity, "Not enough money");
        burnPass();
        mintInternal();
    ...
    onlyAccounts
    {
        ...
        require(msg.value >= PRE_SALE_PRICE * quantity, "Not enough money");
        mintInternal();
