...
contract ThreeFile is ERC721A, Ownable, Pausable, ReentrancyGuard {
    string private _metadataBaseURI;
    bool public saleLiveToggle;
    bool public freezeURI;

    uint256 public MAX_BATCH = 100;
    uint256 public PRICE = 0.0 ether;

    address private _creators = 0x2D2A7338e4894950D63f68Da490E22285C27c997;
    ...
    constructor(string memory _mURI)
        ERC721A("3file", "3file", MAX_BATCH, 1000000)
    {
