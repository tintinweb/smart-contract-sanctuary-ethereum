...
contract MyGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes {
    constructor(IVotes _token)
        Governor("MyGovernor")
        GovernorSettings(1 /* 1 block */, 23 /* 5 minutes */, 1)
    ...
    function propose(string memory description)
       ...
       override(Governor)
        returns (uint256)
    {
        return super.propose(description);
    }
    ...
    function _cancel(bytes32 descriptionHash)
        internal
        override(Governor)
        returns (uint256)
    {
        return super._cancel(descriptionHash);
    }
...
abstract contract Governor is Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function execute(
        ...
        uint256 proposalId = hashProposal(descriptionHash);
