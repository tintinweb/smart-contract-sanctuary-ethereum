...
contract WickedWorlds is ERC721A, Ownable {
    using Strings for uint256;

    // Constants
    uint256 public TOTAL_SUPPLY = 6969;
    uint256 public MINT_PRICE = 0.0069 ether;
    uint256 public FREE_ITEMS_COUNT = 1696;
    uint256 public MAX_IN_TRX = 69;
    address payable withdrawTo = payable(0xa1eE6f4df1793e2E3c14F01a22633E0cbbee2dbB);
    ...
    constructor(string memory _initBaseURI) ERC721A("WickedWorlds", "ww") {
