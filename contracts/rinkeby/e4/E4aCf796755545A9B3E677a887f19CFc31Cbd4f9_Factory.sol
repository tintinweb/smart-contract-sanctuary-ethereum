...
contract NFTcontract is ERC721Enumerable, ReentrancyGuard {
    ...
    function setMaxPublicMint(uint256 _maxmint) internal {
    ...
    function setPublicSalePrice(uint256 _publicSalePrice) internal {
        PUBLIC_SALE_PRICE = _publicSalePrice;
    }

    function setCollectAddress(address _collectAddress) internal {
