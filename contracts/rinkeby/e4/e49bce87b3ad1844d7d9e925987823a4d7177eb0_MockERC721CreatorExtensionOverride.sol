...
// File: @manifoldxyz/creator-core-solidity/contracts/extensions/ERC721/ERC721CreatorExtension.sol
/// @author: manifold.xyz
...
// File: @manifoldxyz/creator-core-solidity/contracts/extensions/ERC721/ERC721CreatorExtensionApproveTransfer.sol
/// @author: manifold.xyz
...
// File: MockERC721CreatorExtensionOverride.sol
contract MockERC721CreatorExtensionOverride is ERC721CreatorExtensionApproveTransfer, ICreatorExtensionTokenURI {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721CreatorExtensionApproveTransfer, IERC165) returns (bool) {
        return interfaceId == type(ICreatorExtensionTokenURI).interfaceId || interfaceId == type(IERC721CreatorCore).interfaceId
            || super.supportsInterface(interfaceId);
    }
