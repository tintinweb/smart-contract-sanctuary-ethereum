...
contract TestFull2 is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.api.tokenfy.com/28/metadata/";
	string private _contractURI = "https://tokenfy-production-public.s3.us-east-2.amazonaws.com/28/contract-uri";

    address public tokenfyAddress = 0xC2e1DCB5d323383A1005D3e28F8E6d06765A5264;
	...
	uint256 public pricePerToken = 100000000000000000;
	...
	constructor(address _signerAddress) ERC721A("Test Full 2", "FULL") {
