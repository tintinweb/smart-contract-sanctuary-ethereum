...
contract NFTWith2981 is ERC721URIStorage, ERC2981, Ownable {
    ...
    constructor(address marketplaceAddress) ERC721("Metalamp Tokens", "MLT") {
        contractAddress = marketplaceAddress;
        _setDefaultRoyalty(msg.sender, 111);
    }
