...
contract Marketplace {
    ...
    function listToken(
        ...
        uint256 _price,
        uint256 _duration
    ) public onlyNFTOwner(_nftContractAddress, _tokenId) {
    ...
    ) external onlyNFTOwner(_nftContractAddress, _tokenId) {
    ...
    function _payFeesAndSeller(uint256 _amount, address payable _nftSeller)
        internal
    {
        uint256 royaltyAmount = (_amount * 25) / 1000;
        _nftSeller.transfer(_amount - royaltyAmount);
