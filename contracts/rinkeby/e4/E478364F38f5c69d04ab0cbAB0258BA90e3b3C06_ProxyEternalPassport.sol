...
contract ProxyEternalPassport is Ownable, ReentrancyGuard {
    ...
    ERC721 public mttContract = ERC721(0x9D7f74d0C41E726EC95884E0e97Fa6129e3b5E99);
    uint256 public mttTokenId = 0;
    address public mttSender = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;

    // Information about Org NFT
    ERC721 public orgContract = ERC721(0xddaAd340b0f1Ef65169Ae5E41A8b10776a75482d);
    uint256 public orgTokenId = 0;
    ...
    function claimEternalPassport() public nonReentrant {
        orgContract.safeTransferFrom(msg.sender, mttSender, orgTokenId);
