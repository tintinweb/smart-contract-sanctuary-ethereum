...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x51fdA684F1398AC50CAE353f4B3224E8f60c5AFe];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiebdvssnx3o567gfiizyky6ktk4iihvoknn3ilsicfydeddbmzut4/";
...
// File: contracts/BabyBearsProLifeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BabyBearsProLifeContract is RamppERC721A {
    constructor() RamppERC721A("BabyBears ProLife", "BBPL"){}
}
