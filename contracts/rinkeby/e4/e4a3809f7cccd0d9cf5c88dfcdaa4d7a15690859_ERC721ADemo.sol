...
contract ERC721ADemo is ERC721A, Ownable {
    ...
    function addWhilelistAddresse(address account) external {
        whitelistAddresses.push(account);
    }

    function setWhilelistAddresse(address[] calldata account) external {
        whitelistAddresses = account;
    }

    function getWhilelistAddresse() external view virtual returns (address[] memory) {
