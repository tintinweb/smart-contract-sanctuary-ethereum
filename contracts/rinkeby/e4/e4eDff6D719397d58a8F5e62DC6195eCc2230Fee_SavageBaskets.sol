...
contract SavageBaskets is ERC721A, Ownable{
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "SBSKT :: Beyond Max Supply");
    ...
    function whitelistMint(uint256 _quantity) external callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_WHITELIST_SUPPLY, "SBSKT :: Cannot mint beyond whitelist max supply");
