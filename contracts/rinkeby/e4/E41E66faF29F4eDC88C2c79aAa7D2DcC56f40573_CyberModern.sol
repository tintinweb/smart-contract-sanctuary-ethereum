...
//todos
// stopped at now making sure the test runs fine
// -set up the tests and run simple batch mint test for 400. stopped here. this seems to work now
// -does token id start at 0? Check after publishing contract maybe to remix. Needs to start at 1
// -do free mint option copy from goblins
// -add an additional option to buy. use coolcats as reference
// -test on remix
// -save everything and copy this file to a separate place and commit
// -prepare a new version for cybermodern where all of the things are free
// -test on remix
// upload and verify to rinkeby. add instructions to index.ts or a read me.

// update lynx's jsons with link, and also name of course
// give it to him to upload and grab link from him

// prepare lynx buttons javascript
