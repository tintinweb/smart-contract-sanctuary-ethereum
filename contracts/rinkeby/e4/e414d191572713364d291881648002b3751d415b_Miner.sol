...
contract Miner is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  function withdrawAllERC20(address _tokenContract, uint256 _amount) public onlyOwner {
    ...
    function mint(uint256 amount) public payable nonReentrant {
        ...
        require(lbToken.approve(daoAddress, daoAmount), 'DaoAddress Approve failed.');
        lbToken.transferFrom(msg.sender,daoAddress,daoAmount); 
        require(lbToken.approve(teamAddress, teamAmount), 'TeamAddress Approve failed.');
        lbToken.transferFrom(msg.sender,teamAddress,teamAmount); 
