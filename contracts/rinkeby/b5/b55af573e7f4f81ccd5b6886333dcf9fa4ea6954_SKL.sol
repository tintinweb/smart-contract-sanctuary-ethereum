...
contract SKL is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  uint256 public maxFreeSupply = 5;
  ...
  function mint(uint256 _mintAmount) external payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(_mintAmount <= maxPerTx, "Max per TX reached.");
        }
