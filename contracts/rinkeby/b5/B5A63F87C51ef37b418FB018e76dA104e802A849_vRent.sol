...
import "./IPayment.sol"; 
import "./IvRent.sol";  
import "./vRentStorage.sol";  

contract vRent is IvRent, vRentStorage, ERC721Holder, ERC1155Receiver, ERC1155Holder, Initializable { 
    ...
    function initialize(
        ...
        _isNotZeroAddr(_beneficiary);
        _isNotZeroAddr(_admin);
     ...
     * - `_collateralAmounts` and `_dailyLeasePrices` should be between 9999.9999 and 0.0001
     */
    function lease(
   ...
   // verifys the NFT standard
    ...
    /**
     * convert the `dailyLeasePrices` and `collateralAmounts` from bytes4 into decimal
    */
    function _unwrapPrice(bytes4 _price, uint256 _scale)
        ...
        returns (uint256)
    {
        __isUnwrapablePrice(_price, _scale);
    ...
    */
    ...
    function __isUnwrapablePrice(bytes4 _price, uint256 _scale)
        private
        pure
    {
...
contract vRentStorage {
    IPayment internal payment;
    address internal admin;
    address payable internal beneficiary;
    uint256 internal leasingId = 1;
    ...
    mapping(bytes32 => LeasingRenting) internal leasingRenting;
