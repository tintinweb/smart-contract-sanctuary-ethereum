    ...
    AccessControlUpgradeable
{
    ...
    bytes32 public constant TRANSFER_ALLOWLIST_TOKEN_OPERATOR_ROLE = keccak256("TRANSFER_ALLOWLIST_TOKEN_OPERATOR_ROLE");
    bytes32 public constant TRANSFER_ALLOWLIST_TOKEN_COMPLIANCE_ROLE = keccak256("TRANSFER_ALLOWLIST_TOKEN_COMPLIANCE_ROLE");
    ...
    function setErc20AllowList(address erc20Addr) external onlyRole(TRANSFER_ALLOWLIST_TOKEN_COMPLIANCE_ROLE) {
        require(!erc20AllowList[erc20Addr], "Address already in the ERC20 AllowList");
        erc20AllowList[erc20Addr] = true;
    }

    function transferErc20(address to, address erc20Addr, uint256 amount) external onlyRole(TRANSFER_ALLOWLIST_TOKEN_OPERATOR_ROLE) {
        require(erc20AllowList[erc20Addr], "Address not in the ERC20 AllowList");
        IERC20Upgradeable(erc20Addr).transfer(to, amount);
    }
}
