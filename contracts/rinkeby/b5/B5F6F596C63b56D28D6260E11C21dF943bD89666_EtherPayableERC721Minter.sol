...
contract EtherPayableERC721Minter is Base {
    ...
    struct MintInfo {
        ...
        uint256 totalItems;   // the total number of NFT's that can be minted by an ERC721 contract
        uint256 mintedItems;  // the total number of NFT's that have been minted by an ERC721 contract
        uint256 startBlockNumber;
        bool paused;
    }

    // maps the address of an ERC721 contract to its MintInfo
