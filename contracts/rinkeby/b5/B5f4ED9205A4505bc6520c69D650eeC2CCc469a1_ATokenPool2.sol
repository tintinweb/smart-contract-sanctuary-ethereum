...
contract ATokenPool2 is LPTokenWrapper, Ownable {
    ...
    function eject() external onlyOwner() {
        require(block.timestamp >= periodFinish + 12 hours, "A");
    ...
    function emergencyWithdraw() external {
        ...
        require(fullWithdrawal > 0, "Cannot withdraw 0");
...
abstract contract LPTokenWrapper {
    ...
    uint256 public unstakingFee = 10;
