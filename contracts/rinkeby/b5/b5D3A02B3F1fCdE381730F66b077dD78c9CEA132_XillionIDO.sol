...
contract XillionIDO is XillionIDOCommon {
    ...
    function investBEP20(uint256 _tokenAmount, address _invester) external{
        (bool success, bytes memory result) = getMasterIDOAddress().delegatecall(abi.encodeWithSignature("investBEP20(uint256, address)", _tokenAmount, _invester));
