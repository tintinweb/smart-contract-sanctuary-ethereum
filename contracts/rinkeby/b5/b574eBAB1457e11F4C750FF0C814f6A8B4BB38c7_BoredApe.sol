...
function freeMint(uint256 _amount) 
    ...
    onlyAccounts
    {
        ...
        require(presaleM,                       "BongTown: Presale is OFF");
        require(!paused,                        "BongTown: Contract is paused");
        require(
            _amount <= presaleAmountLimit,      "BongTown: You can't mint so much tokens");
        require(
            _presaleClaimed[msg.sender] + _amount <= presaleAmountLimit,  "BongTown: You can't mint so much tokens");
