...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x30608202f4847C9CAd1613ee5E6d03397970C7aa];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmX5HVNmAEDjgQHaCoFTnrKxaAuJinfnUFGoDtCxaD8sty/";
...
// File: contracts/Nfttest1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Nfttest1Contract is RamppERC721A {
    constructor() RamppERC721A("NFTTEST1", "SNEK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/dEQ0TQJXM9B74Y1PLWMb/contract-metadata";
    }
}
