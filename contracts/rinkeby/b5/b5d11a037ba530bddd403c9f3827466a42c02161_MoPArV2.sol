...
contract MoPArV2 is Initializable, OwnableUpgradeable, AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable, IERC2981 {
    ...
    function getCollection(uint256 collectionId) external view returns (string memory name, string memory artist, bool paused, uint128 max, uint256 price, uint128 circulating, address payable artistWallet, uint128 artistMintBasis, address royaltyWallet, uint128 royaltyBasis, address customContract) {
        ...
        artistWallet = _collections[collectionId].artistWallet;
        artistMintBasis = _collections[collectionId].artistMintBasis;
        royaltyWallet = _collections[collectionId].royaltyWallet;
        royaltyBasis = _collections[collectionId].royaltyBasis;
        customContract = _collections[collectionId].customContract;
    }
    ...
    function createCollection(
        ...
        uint256 price_, 
        address payable artistWallet_, 
        uint128 artistMintBasis_, 
        address royaltyWallet_, 
        uint128 royaltyBasis_, 
        address customContract_,
        bool offChain_,
        ...
        onlyRole(MANAGER_ROLE)
    {
        ...
        _collections[_nextCollectionId] = Collection({
            ...
            price:price_, 
            circulating:0, 
            max:uint128(signatures_.length), 
            artistWallet:artistWallet_,
            artistMintBasis:artistMintBasis_,
            royaltyWallet:royaltyWallet_,
            royaltyBasis:royaltyBasis_,
            customContract: customContract_,
            offChain:offChain_
        });
        if (!offChain_) {
