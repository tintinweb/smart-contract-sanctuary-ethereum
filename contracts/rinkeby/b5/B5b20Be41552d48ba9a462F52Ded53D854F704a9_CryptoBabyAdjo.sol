...
contract CryptoBabyAdjo is ERC721Enumerable, Pausable, Ownable {
    ...
    function mintForAddress(uint256 tokenQuantity, address _receiver) public onlyOwner {
        require(totalSupply() <= MAX_SUPPLY, "OUT_OF_STOCK");
        require(totalSupply() + tokenQuantity <= MAX_SUPPLY, "EXCEED_SUPPLY_LIMIT");
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool hs, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{value: amount * 5 / 100}("");
        require(hs, "ETHER_WITHDRAW_FAILED");
        (bool sr, ) = payable(_signerAddress).call{value: address(this).balance}("");
        require(sr, "ETHER_WITHDRAW_FAILED");
    }
}
