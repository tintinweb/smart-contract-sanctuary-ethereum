    ...
    ERC721Royalty
{
    ...
    function safeMint(
        ...
        uint96 feeNumerator,
        uint256 nftId,
        SigMessage calldata sigMessage
    ) public payable returns (uint256) {
        require(
            verify(
                owner(),
                getSafeMintMessageHash(to, uri, feeNumerator, nftId, msg.value),
                sigMessage.r,
                sigMessage.s,
                sigMessage.v
            ),
    ...
    function exchangeNft(
        ...
        require(
            ...
            "amount must greater than royaltyamount"
        );
   ...
   */
    ...
    function getExchangeNftMessageHash(
        address from,
        address to,
        uint256 tokenId,
        uint256 amount,
