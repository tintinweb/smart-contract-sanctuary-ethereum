...
contract ClearingHouse is IClearingHouse, IncreOwnable, Pausable, ReentrancyGuard {
    ...
    /// @dev Once the insurance reserve exceed 10% of the tvl, governance can withdraw exceeding insurance fee
    /// @dev (10%)
    ...
    /// @param asset Token to be added to the vault
    /// @param amount Amount of token to be added to the vault. Might not have 18 decimals
    ...
    /// @notice Emitted when a liquidity is removed
    /// @param idx Index of the perpetual market
    /// @param liquidityProvider User who provides liquidity
    ...
    /// @param fundingPayments Funding payments received by the liquidity provider. 18 decimals
