...
contract WeirdPeople is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    string memory _hiddenMetadataUri
        ...
        _mint(0x8272A8223e9FbC9eD5e6C199aC25e707e787911e, 5);
        _mint(0x05cB80Ce8A7858bc011b85D76f7Dbe2eE7D0A214, 20);
        _mint(0x9025F0De302c257B9841EeE863C1577bA9f788B7, 1);
  ...
  function setWhitelistMintEnabled(bool _state) public onlyOwner {
    ...
    address DEVELOPER_1_WALLET = 0x8272A8223e9FbC9eD5e6C199aC25e707e787911e;
    ...
    function withdrawAmount(uint256 _amount) public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
        require(balance > 0, "NO FUNDS AVAILABLE");
        payable(FOUNDER_WALLET).transfer((_amount * 10)/100);
        payable(FOUNDER_2_WALLET).transfer((_amount * 10)/100);
        payable(DEVELOPER_1_WALLET).transfer((_amount * 10)/100);
        payable(ADVISOR_WALLET).transfer((_amount * 10)/100);
        payable(COLLAB_WALLET).transfer((_amount * 5)/100);
        payable(TREASURY_WALLET).transfer((_amount * 50)/100);
        payable(STAFF_WALLET).transfer((_amount * 5)/100);
    }
