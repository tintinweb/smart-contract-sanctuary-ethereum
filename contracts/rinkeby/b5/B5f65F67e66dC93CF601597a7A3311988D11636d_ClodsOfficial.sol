...
contract ClodsOfficial is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Clods Official", "CLD") {
    setHiddenMetadataUri("ipfs://Qma1WntHqVHToUKx2saJMZHWh3gTwm4RRorVamvP623k4Q/hidden.json");
  }
