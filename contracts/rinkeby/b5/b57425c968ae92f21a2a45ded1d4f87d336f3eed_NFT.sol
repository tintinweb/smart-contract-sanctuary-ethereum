...
contract NFT is ERC721{
    ...
    bool public rnd_can_mint = false;
    bool public eth_can_mint = true;
   ...
   function uint_to_str(uint256 _i) pure internal returns (string memory str){
    ...
    function eth_create_nft(string memory text) public payable{
    // function eth_create_nft(string memory svg,string memory json_url) public payable{
        ...
        string memory svg = create_img(create_morse(text));
    ...
    function rnd_create_nft(string memory text) public payable{
        require(msg.sender == tx.origin);
        require(can_mint == true);
        ...
        bool is_transfer = ERC20(rnd_contract).transferFrom(msg.sender,0x0000000000000000000000000000000000000001,150000000 ether);
