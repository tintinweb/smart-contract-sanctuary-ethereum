...
contract MaskedMicKillers is ERC721Enumerable, Ownable {
    ...
    bytes32 public merkleRoot = 0xd291a188604227d94b0abe9b1d415af81e10206c6f2b52a655710bbc4b25da5f;
    ...
    constructor(string memory baseURI) ERC721("MaskedMicKillers", "MMK") {
        setBaseURI(baseURI);
        setHiddenMetadataUri("https://mmk.mypinata.cloud/ipfs/QmSTUcPLWwtKy6ogzqVCDKCzwKBWsszXQz4hKrN3RtMhZ3");
        reserveNFTs(6);
    }
    ...
    function mintNFTs(uint256 _count) public payable {
        uint256 totalMinted = _tokenIdTracker.current();
        require(mintStep == 1 || mintStep == 3, "Public sale is not started!");
