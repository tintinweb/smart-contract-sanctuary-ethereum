...
contract CryptoBonsai is ERC721Enumerable, Ownable {
    ...
    function getFgAcc(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 20 && gt <= 30) { fgAcc = 1; }
        if (gt > 31 && gt <= 40) { fgAcc = 2; }
        if (gt > 41 && gt <= 50) { fgAcc = 3; }
        if (gt > 51 && gt <= 60) { fgAcc = 4; }
        if (gt > 61 && gt <= 70) { fgAcc = 5; }
        if (gt > 71 && gt <= 80) { fgAcc = 6; }
        if (gt > 81 && gt <= 90) { fgAcc = 7; }
        if (gt > 91 && gt <= 95) { fgAcc = 8; }
        if (gt > 96 && gt <= 100) { fgAcc = 9; }
    ...
    function getAccessories(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 1 && gt <= 10) { Accessories = 1; }
        if (gt > 11 && gt <= 19) { Accessories = 2; }
        if (gt > 20 && gt <= 29) { Accessories = 3; }
        if (gt > 30 && gt <= 39) { Accessories = 4; }
        if (gt > 40 && gt <= 50) { Accessories = 5; }
        if (gt > 51 && gt <= 60) { Accessories = 6; }
        if (gt > 61 && gt <= 70) { Accessories = 7; }
        if (gt > 71 && gt <= 80) { Accessories = 8; }
        if (gt > 81 && gt <= 85) { Accessories = 9; }
        if (gt > 86 && gt <= 90) { Accessories = 10; }
        if (gt > 91 && gt <= 95) { Accessories = 11; }
        if (gt > 96 && gt <= 100) { Accessories = 12; }
    ...
    function getPotAccessories(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 20 && gt <= 30) { potAcc = 1; }
        if (gt > 31 && gt <= 40) { potAcc = 2; }
        if (gt > 41 && gt <= 50) { potAcc = 3; }
        if (gt > 51 && gt <= 60) { potAcc = 4; }
        if (gt > 61 && gt <= 70) { potAcc = 5; }
        if (gt > 71 && gt <= 80) { potAcc = 6; }
        if (gt > 81 && gt <= 90) { potAcc = 7; }
    ...
    function getBgAcc(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 40 && gt <= 50) { BgAcc = 1; }
        if (gt > 51 && gt <= 60) { BgAcc = 2; }
        if (gt > 61 && gt <= 70) { BgAcc = 3; }
        if (gt > 71 && gt <= 85) { BgAcc = 4; }
        if (gt > 86 && gt <= 92) { BgAcc = 5; }
        if (gt > 93 && gt <= 100) { BgAcc = 6; }
