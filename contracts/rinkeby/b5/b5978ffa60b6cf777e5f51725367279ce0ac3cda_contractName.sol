...
contract contractName is ERC721A, Ownable {
    ...
    string public hiddenMetadataUri = "ipfs://QmTZfnwh9WnMNau7h4HYXmDuGNdec5njwAiu1zr37mVfu8/unrevealed.json";
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI, _tokenId.toString(), endPoint))
            : '';
    }
