...
contract HolyKitten is ERC721A, Ownable {
    ...
    uint public priceWL = 0 ether;
    uint public maxSupply = 10;
    uint public maxSupplyWL = 5;
    uint public maxTx = 15;
    uint public maxTxWL = 7;
    ...
    function _mintTo(address to, uint qty) internal {
        ...
        function _mintToWL(address to, uint qty) internal {
        require(qty + totalSupply() <= maxSupplyWL, "SUPPLY: Value exceeds totalSupply");
        _mint(to, qty);
    }
