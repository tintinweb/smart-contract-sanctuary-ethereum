...
contract UAPProposal is Ownable, IUAPProposal {
     ...
     */
    event Voted(address indexed voter, uint256 indexed proposalId, uint256 votes_yes, uint256 votes_no);
    ...
    function vote(uint256 proposalId, bool yes) external {
        ...
        emit Voted(msg.sender, proposalId, proposal.votes_yes, proposal.votes_no);
    }
