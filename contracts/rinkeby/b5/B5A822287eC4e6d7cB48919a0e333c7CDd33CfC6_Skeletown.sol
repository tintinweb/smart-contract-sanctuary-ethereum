...
contract Skeletown is ReentrancyGuard, Ownable, ERC721A{


    using Strings for uint256;
    using SafeMath for uint256;

    uint256 constant public maxNFT = 10000;
 
    address payable private addr1 = payable(0x0);  
    address payable private addr2 = payable(0x0);  
    address payable private addr3 = payable(0x0);  
    ...
    constructor(string memory _uri) ERC721A("Skeletown", "SKLTN", 5, 10000){
    ...
    function Mint(uint256 amount) public payable nonReentrant{
        ...
        require(active, "Mint not open");

        require(amount > 0 && amount <= 5, "bad amount");
        require(claimed[msg.sender] + amount <= 10, "too many claimed");
    ...
    function mintBatch(address[] memory _addrs, uint[] memory _amount) public onlyOwner{
    ...
    function withdraw() external onlyOwner {
       require(address(this).balance > 0, "No balance to withdraw");
        ...
        uint cut2 = address(this).balance.mul(30000).div(100000);
        uint cut3 = address(this).balance.mul(30000).div(100000);
    
        sendFund(addr2, cut2);
        sendFund(addr3, cut3);

        sendFund(addr1, address(this).balance);
    }
