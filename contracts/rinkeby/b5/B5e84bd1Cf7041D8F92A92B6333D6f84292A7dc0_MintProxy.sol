...
contract MintProxy is ERC721InteractProxy, IERC721Receiver {
    ...
    function _mintTo(address _to) public {
        _mint();
    ...
    function _mintToMany(address _to, uint256 _amount) public {
        _mintMany(_amount);
    ...
    function _mintMany(uint256 _amount) public {
        tokenContract.mintMany{value: (_amount * _originalTokenCost())}(
            _amount
        );
    }

    function _originalTokenCost() public view returns (uint256) {
...
abstract contract TokenContract is IERC721 {
    function mint() public payable virtual;

    function mintMany(uint256 _amount) public payable virtual;
