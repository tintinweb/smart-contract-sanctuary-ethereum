...
contract GatorNft is ERC721, Ownable {
    string public baseURI;
    uint256 MAX_SUPPLY = 4223;
    uint256 MAX_FREE_SUPPLY = 12;
    uint256 MAX_RESERVED_SUPPLY = 222;

    uint256 tokenPrice = 0.00005 ether;
    uint256 totalFreeSupply = 0;
    ...
    constructor() ERC721("Testnet", "T01") {
    }
    ...
    function mint(uint256 freeCount, uint256 paidCount) external payable {
        ...
        require (totalPublicSupply + paidCount  + freeCount< MAX_SUPPLY ,"All testnets have already been minted!");
