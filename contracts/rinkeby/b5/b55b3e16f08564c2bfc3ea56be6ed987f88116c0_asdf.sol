...
contract asdf is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("asdf", "asdf") {
        setBaseURI("https://api.artblocks.io/token/");
        ...
        returns (string memory)
    {
        ...
        return
            bytes(currentBaseURI).length > 0
                ? string(abi.encodePacked(currentBaseURI, (tokenId+78000000).toString()/*, ".json"*/))
                : "";
    }
