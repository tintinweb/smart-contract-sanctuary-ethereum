...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxWalletBalance = 2000000 * 10**_decimals;
        numTokensSellToAddToLiquidity = 100000 * 10**_decimals;
        _marketingWalletAddress = 0xAF69cC1ce829d80446B5e81B78B47EB56E50ffF7;
        _devWalletAddress = 0x95dB00039b85791bF00E23ED4471288C57df5796;
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate = _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_devWalletAddress] = _rOwned[_devWalletAddress].add(
            rDev
        );
        if (_isExcluded[_devWalletAddress])
            _tOwned[_devWalletAddress] = _tOwned[_devWalletAddress].add(
                tDev
            );
    }
