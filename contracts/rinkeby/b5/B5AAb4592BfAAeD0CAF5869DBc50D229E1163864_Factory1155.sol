...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new FortalezaNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        FortalezaNFTUser1155Token token = FortalezaNFTUser1155Token(address(addr));
...
contract FortalezaNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
