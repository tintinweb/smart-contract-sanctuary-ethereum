...
contract StakingSystem is Ownable, ERC721Holder {
    ...
    function getStakerInfo(uint256 _productId) public view returns(uint256[] memory tokenIds, uint256 stakeTime, uint256 expireTime, uint256 productId, uint256 balance) {
        Staker storage staker = stakers[_productId][msg.sender];
        return (staker.tokenIds, staker.stakeTime, staker.expireTime, staker.productId, staker.balance);
    }
