...
contract KahiruF is ERC721A, ReentrancyGuard, Ownable {
    ...
    function allowedMintCount(address minter) public view returns (uint256) {
        if (saleActive || whitelistActive || raffleActive) {
            return (max(allowedMintCountMap[minter], MINT_LIMIT_PER_WALLET) -
                mintCountMap[minter]);
        }
    ...
    bytes32 private _whitelistMerkleRoot =
        0xa55ed0edb0fc32171feb79ad2dc5b1551a4765612ce344057f1166c7ddcb7111;
    bytes32 private _whitelistNeutralMerkleRoot =
        0x52551a51441048412a12edf749d65363e41af37ba1969a62caba0e45e39792bf;
    bytes32 private _raffleMerkleRoot =
        0x420041bc817938d28f6ec183b5057d7189de1a99a5b6d3f6b33980a92b153d06;
    ...
    function mintWhitelist(bytes32[] memory proof, string memory _pass)
        public
        payable
        nonReentrant
    {
        ...
        require(
            ...
            "Key error"
        ); // Key verifying web3 call // Key que "Verifica" la llamada al contract desde la web3
        require(
            supply + quantity <= MAX_WL_SUPPLY,
            "Can't mint more than WL supply"
        );
        require(
    ...
    function mintRafflelist(bytes32[] memory proof, string memory _pass)
        public
        payable
        nonReentrant
    {
        ...
        require(
            supply + quantity <= MAX_SUPPLY - reserved,
            "Can't mint more than max supply"
        );
        require(
            msg.value == Raffle_price * quantity,
   ...
   /*  function ownerDetails(uint256 tokenId)
        external
        view
