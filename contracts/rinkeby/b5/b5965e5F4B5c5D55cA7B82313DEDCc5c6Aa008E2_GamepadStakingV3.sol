...
contract GamepadStakingV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, EmergencyWithdraw, DSMath {
   ...
   */
  function __GamepadStakingV3_init(
   ...
   */
  function setIcoProject(address _icoProject) external onlyOwner {
