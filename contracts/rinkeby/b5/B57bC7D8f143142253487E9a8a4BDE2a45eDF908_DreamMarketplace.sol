...
contract Buyback {
    ...
    address public devWalletAddress = 0xe94141618716A67435BcA4fAc0cC14FA5913F33f;
    ...
    function buybackDream() external {
        ...
        path[0] = WETH;
        path[1] = 0x8b17feA54d85F61E71BdF161e920762898AC53da;
...
contract DreamMarketplace is ReentrancyGuard, Ownable, WrappedETH, Buyback {
    ...
    address immutable public dreamNFTAddress;
    ...
    constructor(address _dreamNFTAddress, address _uniswapRouterAddress) {
    ...
    function changeDevWalletAddress(address new_devWalletAddress) external onlyOwner{
        devWalletAddress = new_devWalletAddress;
    }
    ...
    function UpdatebuybackResaleFee(uint _updateValue) external onlyOwner {
        buybackResaleFeePercentage = _updateValue;        
    }

    function UpdatebuybackMinterFee(uint256 _updateValue) external onlyOwner {
        buybackMinterFeePercentage = _updateValue;        
    }

    function UpdateartistFee(uint256 _updateValue) external onlyOwner {
        artistFeePercentage = _updateValue;        
    }

    function UpdatedevFee(uint256 _updateValue) external onlyOwner {
        devFeePercentage = _updateValue;        
    }

    function UpdatenextBidPricePercentage(uint256 _updateValue) external onlyOwner {
        nextBidPricePercentage = _updateValue;        
    }
