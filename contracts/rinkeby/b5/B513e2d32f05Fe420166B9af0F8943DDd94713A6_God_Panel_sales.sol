...
*/
    function bumpDiscount(address msgSender, uint256 numberOfCards)
        ...
        override
    {
        uint256 _presold = presold[msgSender];
        require(
            _presold + numberOfCards <= 5,
            "you have reached your presale limit"
        );
        presold[msgSender] = _presold + numberOfCards;
        ...
        )
    {
        ...
        bool _loveHeals = loveHeals.balanceOf(buyer) > 0;
        ...
        return (
            [_ec, _loveHeals, true],
            _final,
            _discountedClaimedPerWallet[buyer], // Public
            presold[buyer] // whitelist + EC 
        );
    }
...
*/
    ...
    function mint(uint256 numberOfCards) external payable {
        ...
        require(
            _discountedClaimedPerWallet[msg.sender] <= _discountedPerAddress,
