...
// File: contracts/PlanetToken.sol
...
contract Planet is ERC20 {
    ...
    // Min amount to liquify. (default 500 Planets)
    uint256 public minAmountToLiquify = 500 ether;
    // The swap router, modifiable. Will be changed to PlanetSwap's router when our own AMM release
    ...
    /**
     * @notice Constructs the PlanetToken contract.
     */
    ...
    /// @dev overrides transfer function to meet tokenomics of Planet
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        // generate the PlanetSwap pair path of token -> weth
    ...
    // To receive BNB from PlanetSwapRouter when swapping
