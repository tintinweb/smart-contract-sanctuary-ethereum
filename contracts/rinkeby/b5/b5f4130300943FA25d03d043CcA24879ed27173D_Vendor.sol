...
contract Vendor is Ownable {
    ...
    // a sellTokens() function:
    function sellTokens(uint256 tokenAmount) public {
        require(
            tokenAmount > 0,
            "invalid input, you must sell more then 0 tokens"
        );
        uint256 ethAmount = tokenAmount / tokensPerEth;
        require(
            yourToken.allowance(msg.sender, address(this)) >= tokenAmount,
            "Not allowed to withdraw that much"
        );
