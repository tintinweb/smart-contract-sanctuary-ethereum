...
contract finaltest2 is Ownable, ERC721A, ReentrancyGuard{
    ...
    constructor() public ERC721A("finaltest2", "ft2") {
    }
   ...
   function freemint(uint256 numberOfTokens) external onlyActive nonReentrant(){
        ...
        require(freeMintAmount<=4,"free mint is over");
    ...
    function reserve(uint256 numberOfTokens) external onlyActive onlyOwner() {
        require(numberOfTokens <= MAX_SUPPLY.sub(totalSupply()), "not enough nfts");
        _safeMint(msg.sender, numberOfTokens);
    }
