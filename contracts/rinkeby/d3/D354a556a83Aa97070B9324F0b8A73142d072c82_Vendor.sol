...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    ...
    require(balance >= amount, "amount exceeded reserve");
  ...
  function withdraw() public payable onlyOwner{
    (bool succeed, bytes memory data ) = msg.sender.call{value: address(this).balance}("");
  ...
  function sellTokens(uint256 _amount) public  {
   ...
   (bool success, bytes memory data) = msg.sender.call{value: ethToReturn}("");
...
contract YourToken is ERC20 {
    //address public frontEnd = 0x9e2a5d3De5389Bc84Cf230EbF98d334E851c829B;
