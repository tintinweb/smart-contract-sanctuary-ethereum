...
contract MerkleDemo is ERC721A, Ownable {
    ...
    function claim(bytes32[] calldata _proof, uint256 _mintNum) public payable {
        require(
        ...
        if (normalSaleIsActive) {
            ...
            _mint(msg.sender, _mintNum, "", false);
    ...
    //             "Incorrect merkle proof"
    //         );
    //         // console.log(merkleTree.verify(proof, _leaf, rootHash));
