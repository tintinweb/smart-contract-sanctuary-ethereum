...
// File contracts/MarketNFTAvatarDNA.sol


pragma solidity ^0.8.0;

contract MarketNFTAvatarDNA{
...
pragma solidity ^0.8.0;
contract MarketNFT is ERC721, ERC721Enumerable, MarketNFTAvatarDNA{
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    mapping(uint256 => uint256) public tokenDNA;

    constructor() ERC721("MarketNFT","OLVR"){
    }
