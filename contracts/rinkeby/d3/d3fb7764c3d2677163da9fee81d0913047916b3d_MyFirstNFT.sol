...
// File: IDE/contact test/contract test.sol
...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "ipfs://QmaQ82G2215tHQTz4CHdu9JFxJdeWniZrrnYvy6ohTvtwA"; // 這一行是 NFT 該去哪裡找你的 MetaData
    bool public paused = false; // 可以拿來暫停或者開啟 Mint
    uint256 public cost = 0 ether; // Mint 價格
    uint256 public maxSupply = 6666; // 只有五個 NFT
    uint256 public maxMintAmount = 10; // 一次最多只能 Mint 一個
