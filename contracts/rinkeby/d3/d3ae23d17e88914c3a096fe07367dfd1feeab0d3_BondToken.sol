    ...
    SuspendCompliant
{
    ...
    function burn(uint256 amount) external whenNotPaused {
        require(
            ...
            "BondToken: Address must not be suspended"
        );
        require(
            _verifyWhitelist(_msgSender()),
            "BondToken: Address must be whitelisted"
        );
    ...
    function operatorTransfer(
        ...
        require(
            ...
            "BondToken: Operator transfer not enabled"
        );
        require(
            !isSuspended(sender) && !isSuspended(recipient),
            "BondToken: Addresses must not be suspended"
        );
    ...
    function operatorTransferBatch(
        ...
        require(
            ...
            "BondToken: Mismatching argument sizes"
        );
    ...
    function operatorBurn(address account, uint256 amount)
        ...
        whenNotPaused
    {
        require(operatorBurnEnabled, "BondToken: Operator burn not enabled");
    ...
    function transferFrom(
        ...
        require(
            ...
            "BondToken: Addresses must be whitelisted"
        );
...
/// @notice Suspend compliance module for the bond token
...
/// @notice Whitelist compliance module for the bond token
