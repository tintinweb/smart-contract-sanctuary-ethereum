...
contract DRewards is Ownable, ChainlinkClient, VRFConsumerBaseV2 {
  	...
  	enum EContestState
   	{
		CONTEST_EMPTY,
	   	...
	   	CONTEST_RANDOM_AND_PROOF_REQUESTED, /* RANDOM REQUEST */
	   	CONTEST_RANDOM_DELIVERED, /* RANDOM DELIVERED */
	...
	*/
	function requestProofFromNode(string memory tweetID)
		public
		onlyOwner
	  	onlyContestStateGE(tweetID, EContestState.CONTEST_RANDOM_AND_PROOF_REQUESTED)
   	{
   	...
   	function requestRandomSeedAndProof(string memory tweetID) 
		external 
		onlyValidContest(tweetID) 
		onlyOwner
