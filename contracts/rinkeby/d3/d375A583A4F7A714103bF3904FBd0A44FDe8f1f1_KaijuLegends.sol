...
contract KaijuLegends is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    event UpdateMaxSupply(uint256 cryptoDotComMaxSupply, uint256 privateSaleMaxSupply_, uint256 partnerMaxSupply_);
     ...
     */
    function setMaxSupply(uint256 cryptoDotComMaxSupply_, uint256 privateSaleMaxSupply_, uint256 partnerMaxSupply_)
        external
        onlyTreasuryOrOwner
    {
        ...
        emit UpdateMaxSupply(cryptoDotComMaxSupply_, privateSaleMaxSupply_, partnerMaxSupply_);
    }

    /*
     * @notice: Set the new partnerMintContract address
     * @param: partnerMintContract_: The address of the new partner minting contract
     * @todo: Add the modifier `onlyTreasuryOrOwner`. This has been removed for now so bitkeep can test this
     */
    ...
    function _validateMint(
        ...
        require(
            (saleSupply + quantity_) <= saleMaxSupply,
            "KaijuLegends: Reached max supply"
        );
        require(
    ...
    function privateSaleMint(uint256 quantity_, bytes memory signature_)
        ...
        whenNotPaused
    {
        _validateMint(quantity_, privateSaleSupply, privateSaleMaxSupply);
        ...
        onlyPartner
    {
        ...
        _validateMint(quantity_, partnerSupply, partnerMaxSupply);
