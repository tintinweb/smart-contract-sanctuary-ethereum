...
contract Testing is Ownable, ERC721A, ReentrancyGuard {
    ...
    address private withdrawAddress = 0x820180d4F6C951Bb4D5D2aeb585eB2202D0FfbD6;
    ...
    constructor(string memory _initBaseUri) ERC721A("Testing", "$Test") {
