...
contract DappTutorial is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public pricewl = 0.04 ether;
    uint256 public price = 0.08 ether; 

    uint96 public royaltyFeesInBips;
    address public royaltyAddress =
        0xc94888E885736161991C8052E9b277F72d2CcDFe;

    uint256 private constant TotalCollectionSize_ = 552; // total number of nfts
    uint256 private constant MaxMintPerBatch_ = 3; //max mint per transaction
    ...
    constructor(uint96 _royaltyFeesInBips, string memory _uri)
        ERC721A(
            "DappTutorial",
            "DAPP",
            MaxMintPerBatch_,
    ...
    {
        setNotRevealedURI(
            "ipfs://QmRm7yEeqHnh5ebyXLTehYNVxLqC8RvQYmVcnyqeFbnTqA"
        );
        setBaseURI(_uri);
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        payable(0x04F38F1F7e86718c7135741d010DD6E2E8d16c1d).transfer(ceoBal);

        // Co Founder share
        uint256 cfBal = balance.mul(35);
        cfBal = cfBal.div(100);
        payable(0xc94888E885736161991C8052E9b277F72d2CcDFe).transfer(cfBal);

        // Project share
        uint256 proBal = balance.mul(20);
        proBal = proBal.div(100);
        payable(0x75c27f3AEF0a479C0C3B5EC1E62f6A8f086e2235).transfer(proBal);

        // Investor share
        uint256 inBal = balance.mul(10);
        inBal = inBal.div(100);
        payable(0x443999D7a5a6cf59f9C17f4cbE4f53622889952F).transfer(inBal);
    }
