...
contract Community is ICommunity {
        ...
        )
    {
        ...
        return (
            ...
            _communityProject.investmentNeeded,
            _communityProject.totalInvested
        );
    }
    ...
    function _unpublishProject(address _project) internal virtual override {
        ...
        _communityProject.investmentNeeded = _communityProject.totalInvested;
    ...
    function claimInterest(
        ...
        require(_invested > 0, "Community::Claim||!invest");
    ...
    ReentrancyGuardUpgradeable
{
     ...
     * Doing so, community cannot invest any more in the project (investmentNeeded = totalInvested).
     * The builder cannot change investmentNeeded (request for funding), until re published.
     * The old investments can be paid off by the builder
     * @dev modifier onlyBuilder
     *
     ...
     * @return _projectApr uint256 - interest rates with index relating to _projects
     * @return _investmentNeeded uint256 - amounts needed by projects before investment completes with index relating to _projects
     * @return _totalInvested uint256 - amounts by project total invested.
     */
    function projectDetails(uint256 _communityID, address _project)
        external
        view
