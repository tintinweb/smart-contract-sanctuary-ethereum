...
contract gNR is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize(IERC20 nr_) public initializer {
        ...
        __Ownable_init();
        nr = nr_;
        multipleToLockup[0] = 1;
        multipleToLockup[1] = 4 * 30;
        multipleToLockup[2] = 8 * 30;
        multipleToLockup[3] = 12 * 30;
        multipleToLockup[4] = 24 * 30;
    }
    ...
    function mint(
        ...
        if (
            ...
            tokenLockList.lockedList.push(
                TokenLock({nrAmount: amount, endDay: endDay})
            );
        }
    ...
    function massUnlockAll(address to) public {
        ...
        for (uint8 i = 1; i <= 4; i *= 2) {
            ...
            if (amount > 0) {
                ...
                totalgNRAmount = totalgNRAmount.add(amount.mul(i));
