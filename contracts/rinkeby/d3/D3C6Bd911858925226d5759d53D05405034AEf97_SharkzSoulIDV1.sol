...
contract SharkzSoulIDV1 is IVoteScore, Initializable, UUPSUpgradeable, AdminableUpgradeable, EIP712WhitelistUpgradeable, ERC4973SoulContainerUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setTokenImageName(uint256 _tokenId, string calldata _name) external virtual {
    ...
    function tokenURI(uint256 _tokenId) public virtual view override returns (string memory) {
        ...
        bytes memory output = abi.encodePacked(
            soulData.tokenMetaAndImage(_tokenId, _metaName, _metaDesc, _tokenCreationTime(_tokenId), tokenCustomNames[_tokenId]),
            '"attributes":[',
        ...
        return soulData.Base64Encode(output);
    }
...
interface ISoulData {
     ...
     */
    function tokenMetaAndImage(uint256 _tokenId, string calldata _metaName, string calldata _metaDesc, uint256 _creationTime, string calldata _name) external view returns (string memory);
