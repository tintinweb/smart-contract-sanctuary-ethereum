...
contract ERC721 is IERC721, ERC721Metadata {
    using Address for address;
    uint curr = 0;
    string public override name = "Chips";
    string public override symbol = "Chips";
    ...
    function mint() external {
        ...
        require(user != address(0), "mint to zero address");
        curr += 1;
        _balances[user] += 1;
        _owners[curr] = user;

        emit Transfer(address(0), user, curr);
    }
