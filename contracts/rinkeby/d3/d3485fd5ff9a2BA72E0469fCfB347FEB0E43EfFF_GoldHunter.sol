...
contract GoldHunter is ERC721, Ownable {
    ...
    uint constant public MINT_PER_TX_LIMIT = 3;

    uint public tokensMinted = 0;
    uint16 public phase = 1;
    uint16 public taxmanMinted = 0;
    //addon
    uint16 public res1Minted = 0;
    uint16 public res2Minted = 0;
    uint16 public res3Minted = 0;
    uint16 public com1Minted = 0;
    uint16 public com2Minted = 0;
    uint16 public com3Minted = 0;
    uint16 public rec1Minted = 0;
    uint16 public rec2Minted = 0;
    uint16 public rec3Minted = 0;
    ...
    //addon
    mapping(uint16 => bool) private _isRes1;
    mapping(uint16 => bool) private _isRes2;
    mapping(uint16 => bool) private _isRes3;
    mapping(uint16 => bool) private _isCom1;
    mapping(uint16 => bool) private _isCom2;
    mapping(uint16 => bool) private _isCom3;
    mapping(uint16 => bool) private _isRec1;
    mapping(uint16 => bool) private _isRec2;
    mapping(uint16 => bool) private _isRec3;
    ...
    constructor() ERC721("MetaCity", "MetaCity") {
...
//####################################################################################################taxmanminted: res1 minted toevoegen
...
//addon            
    ...
    function selectRecipient() internal returns (address) {
        ...
        address thief = treasureIsland.randomTaxmanOwner();
...
//addon
    function isRes1(uint16 id) public view returns (bool) {
        return _isRes1[id];
    }

    function isRes2(uint16 id) public view returns (bool) {
        return _isRes2[id];
    }

    function isRes3(uint16 id) public view returns (bool) {
        return _isRes3[id];
    }

    function isCom1(uint16 id) public view returns (bool) {
        return _isCom1[id];
    }

    function isCom2(uint16 id) public view returns (bool) {
        return _isCom2[id];
    }

    function isCom3(uint16 id) public view returns (bool) {
        return _isCom3[id];
    }

    function isRec1(uint16 id) public view returns (bool) {
        return _isRec1[id];
    }

    function isRec2(uint16 id) public view returns (bool) {
        return _isRec2[id];
    }

    function isRec3(uint16 id) public view returns (bool) {
        return _isRec3[id];
    }
...
//addon
    function setRes1Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isRes1[ids[i]] = true;
        }
    }

    function setRes2Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isRes2[ids[i]] = true;
        }
    }

    function setRes3Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isRes3[ids[i]] = true;
        }
    }

    function setCom1Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isCom1[ids[i]] = true;
        }
    }

    function setCom2Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isCom2[ids[i]] = true;
        }
    }

    function setCom3Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isCom3[ids[i]] = true;
        }
    }

    function setRec1Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isRec1[ids[i]] = true;
        }
    }

    function setRec2Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isRec2[ids[i]] = true;
        }
    }

    function setRec3Ids(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isRec3[ids[i]] = true;
        }
    }
