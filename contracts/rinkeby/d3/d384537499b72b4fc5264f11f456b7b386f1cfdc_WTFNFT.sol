...
contract WTFNFT is Ownable, ERC721A {
    ...
    uint256 public freeAmount = 5;
    uint256 public price = 1000000 gwei;
    string public baseURI = "https://cryptobums.mypinata.cloud/ipfs/QmNPhUifhmUaTcCXDiBYHAyxebW5iPrY3dT74yzxLdEdNt/";
    string public hideURI = "https://cryptobums.mypinata.cloud/ipfs/QmapUX8fxoAHWuG3obcDESRA66rmRkBwY2A3vMfrAGxUco";
    ...
    constructor() ERC721A("monk2 coll", "mckt2") {}
    ...
    function mint(uint256 quantity) external payable nonReentrant {
        ...
        require(minted + quantity <= MAX_TOKENS, "execcd total");
