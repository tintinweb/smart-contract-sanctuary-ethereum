...
//Constructor
    constructor(string memory _baseURI) ERC721("MyErc721", "Erc721"){
...
//Public and External
    ...
    function mint(uint _amountForMint) public payable{

        require(_amountForMint > 0, "Need to mint at least one token");
        require((_idForToken + _amountForMint) <= maxTokenMint, "No can mint more token");
        ...
        for( uint i = 0; i < _amountForMint; i++){
            ...
            _idForToken++;
            _mint(msg.sender,_idForToken);
            emit MINT(msg.sender, _idForToken);
        }
