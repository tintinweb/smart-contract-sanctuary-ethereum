...
import "./OwnCollectiblesNFT1155.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new CollectiblesNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CollectiblesNFTUser1155Token token = CollectiblesNFTUser1155Token(address(addr));
...
contract CollectiblesNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
