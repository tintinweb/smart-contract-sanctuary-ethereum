...
contract MiniLunaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniLunaInu";
    ...
    address payable private _marketingAddress = payable(0x2E7E1e10E4deea02AeeE428e5b8d21C800C31281);
    address payable private _deployWallet = payable(0x2E7E1e10E4deea02AeeE428e5b8d21C800C31281);
