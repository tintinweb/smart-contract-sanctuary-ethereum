...
contract CreativoTradeEngine is ReentrancyGuarded, Ownable
{
   ...
   function buyToken(uint256 _id, address _buyfrom, address _feeRecipient, address _creator, uint256 _adminFeePercent, uint256 _royaltyFeePercent, bytes calldata _data) public payable nonReentrant{
   ...
   function bid(uint256 _tokenid, bytes calldata _data ) external payable nonReentrant
    ...
    function claimTokenOnWin(uint256 _tid, uint256 _adminFeePercent, bytes calldata _data) public
    {
        ...
        uint256 adminfee = (auctionOf[_tid].highest_bid_value * _adminFeePercent) / 10000;
