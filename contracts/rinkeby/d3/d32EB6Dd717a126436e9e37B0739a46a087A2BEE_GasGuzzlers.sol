    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    /**
    @notice This function allows the owner to airdrop tokens to any address they wish 
    ...
    */
    ...
    @param _amount Amount of tokens to mint in one transaction   
    */
    function earlyAccessClaim(whitelist memory _whitelist, uint256 _amount) external payable nonReentrant {
    ...
    */
    ...
    /**
    @notice This function allows any user to mint   
    ...
    */
    function withdraw() external nonReentrant {
        require(msg.sender != address(0), "Withdrawal: invalid address");
    ...
    */
    ...
    /**
    @notice This function allows the owner to modify Early Access Sale conditions
    @param _startTime Time when the Sale begins
    @param _endTime Time when the Sale ends
    @param _buyLimit Maximum number of tokens a wallet may mint
    @param _maxAvailable Maximum number of tokens that may be sold in the Sale
    @param _mintPrice Price to mint one token
    */
    ...
    /**
    @notice This function allows the owner to modify Early Access Claim conditions
    @param _startTime Time when the Sale begins
    @param _endTime Time when the Sale ends
    @param _buyLimit Maximum number of tokens a wallet may mint
    @param _maxAvailable Maximum number of tokens that may be sold in the Sale
    ...
    */
    ...
    /**
    @notice This function allows the owner to modify Blacklist Sale conditions
    @param _startTime Time when the Sale begins
    @param _endTime Time when the Sale ends
    @param _buyLimit Maximum number of tokens a wallet may mint
    @param _maxAvailable Maximum number of tokens that may be sold in the Sale
    ...
    */
    ...
    /**
    @notice This function allows the owner to modify Public Sale conditions
    @param _startTime Time when the Sale begins
    @param _endTime Time when the Sale ends
    @param _buyLimit Maximum number of tokens a wallet may mint
    @param _maxAvailable Maximum number of tokens that may be sold in the Sale
