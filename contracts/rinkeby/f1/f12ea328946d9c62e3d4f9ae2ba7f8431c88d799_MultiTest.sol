...
contract MultiTest is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = updateMintPrice(totalSupply());
  uint256 public maxSupply = 444;
  uint constant initialCost = 0.05 ether;
  bool public paused = false;
  bool public revealed = true;
  bool public dynamicPrice = true;
  string public notRevealedUri;
 
  constructor() ERC721("Multi Test", "MCX") {
    }
  ...
  function _baseURI() internal view virtual override returns (string memory) {
   ...
   function updateMintPrice(uint256 _supply) internal returns (uint256 _cost) {
  ...
  function mint() public payable {
    ...
    require(msg.value >= updateMintPrice(supply), "Not enough funds!");
  ...
  function setDynamicPrice(bool _state)  public onlyOwner {
    dynamicPrice = _state;
  }
