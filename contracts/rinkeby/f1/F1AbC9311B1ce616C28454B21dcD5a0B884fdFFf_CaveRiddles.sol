...
contract CaveRiddles is ERC721, ERC721Enumerable, ERC2981, Ownable {
	...
	// function setRoyaltyInfo(address _receiver, uint96 royaltyBasisPoints_) public onlyOwner {
	// 	_setDefaultRoyalty(_receiver, royaltyBasisPoints_);
	// }
    ...
    //     return (_salePrice / 10000) * royaltyBasisPoints;
    // }
