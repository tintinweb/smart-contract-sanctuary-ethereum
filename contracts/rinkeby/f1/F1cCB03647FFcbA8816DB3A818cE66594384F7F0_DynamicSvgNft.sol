...
contract DynamicSvgNft is ERC721, Ownable {
    ...
    constructor(
        ...
        s_tokenCounter = 0;
        i_priceFeed = AggregatorV3Interface(priceFeedAddress); // AggregatorV3Interface üzerine belirli adres yollayarak, bu belirli adres için interface çalıştırılmış olur 
        // setLowSVG(lowSvg);
        // setHighSVG(highSvg);
    ...
    // base64 URL için returns(string memory)
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    // add prefix part, but for JSON Objects, // data:application/json;base64,
                )
            );
    }
