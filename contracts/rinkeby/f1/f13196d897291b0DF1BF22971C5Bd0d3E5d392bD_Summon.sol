...
contract Summon is AccessControlEnumerable, Pausable {
    ...
    mapping(address => uint256) private _summonHistory;
        ...
        whenNotPaused
    {
        ...
        require(
            _summonHistory[msg.sender] + delay <= block.timestamp,
            "Summon::mintHero: delay not yet passed"
        );
        ...
        _summonHistory[msg.sender] = block.timestamp;
        uint256 teamAmount = (_cost * 15) / 100;
        _confetti.transferFrom(msg.sender, _team, teamAmount);
        _confetti.burnFrom(msg.sender, _cost - teamAmount);
