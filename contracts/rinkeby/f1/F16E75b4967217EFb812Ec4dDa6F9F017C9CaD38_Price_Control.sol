...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/extensions/ERC20Pausable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/presets/ERC20PresetMinterPauser.sol
...
// File: contracts/Upwork simulation (Job 1)/Price_Control.sol
...
contract Price_Control is ERC20PresetMinterPauser {
    ...
    modifier OnlyDeployer {
        require(deployer == msg.sender, "You are not the deployer of this contract");
        _;
    }
    // Setting the OnlyDeployer modifier to the burn function
    // (Note pause and mint already have a modifier preset)
