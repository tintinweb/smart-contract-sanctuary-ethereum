...
contract GoonzPortal is ERC721, IERC721Receiver, Ownable, ReentrancyGuard, IERC2981 {
    ...
    constructor(string memory _initBaseURI, address _cryptoonGoonzContract) ERC721("GPTEST", "CGPTEST") {
        ...
        _worlds[0].isOpen = true;
        royaltiesAddress = 0x626D89Bf9637953d708456B0ebf1Ce62DCeb1499;
        _proxyRegistryAddress = 0xF57B2c51dED3A29e6891aba85459d600256Cf317;
        royaltiesBasisPoints = 750;
    ...
    function changeWorlds(uint256[] memory tokenIds, uint256 worldId) public {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            _passPortals[tokenIds[i]].currentWorld = uint64(worldId);
        ...
        )
    {
        ...
        worldCurrent = passportal.currentWorldStartTime == 0
            ? 0
            : uint256(block.timestamp - passportal.currentWorldStartTime);
        current = passportal.startTime == 0 ? 0 : uint256(block.timestamp - passportal.startTime);
    ...
    function onERC721Received(
        ...
        if (enteringPortal) {
            ...
            if (_passPortals[tokenId].currentWorld != worldId) {
                unchecked {
                    _passPortals[tokenId].currentWorld = uint64(worldId);
                }
            }
