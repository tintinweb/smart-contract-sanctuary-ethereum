...
contract BasicFunctions {
    ...
    // function (string memory _variable1, int variable2) public view/pure returns(bool) {} 
    ...
    // Update a mapping
    function addCoing(string memory _name, string memory _symbol, uint _supply) external {
