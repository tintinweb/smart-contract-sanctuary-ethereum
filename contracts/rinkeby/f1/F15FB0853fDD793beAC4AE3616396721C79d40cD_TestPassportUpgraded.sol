...
contract TestPassportUpgraded is Passport {
    function testAddedFunction() external pure returns (string memory) {
        return "passage!";
    }

    function passportVersion() public pure override returns (uint256) {
        return 1;
    }
}
