...
contract LabBunniesClub is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 1;
    uint256 MAX_MINT_AVALANCHE = 200;

    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("LabBunniesClub", "gg") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_AVALANCHE, "GG: Mint exceeds supply");
