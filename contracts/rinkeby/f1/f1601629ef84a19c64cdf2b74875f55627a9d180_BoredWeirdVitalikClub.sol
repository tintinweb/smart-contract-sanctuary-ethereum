...
contract BoredWeirdVitalikClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bored Weird Vitalik Club", "BWVC") {
    setHiddenMetadataUri("ipfs://QmbiuvLk2KxY9fgVKmHBp6SHerK3cx4FxjT5X5rmjrjJpj/hidden.json");
  }
