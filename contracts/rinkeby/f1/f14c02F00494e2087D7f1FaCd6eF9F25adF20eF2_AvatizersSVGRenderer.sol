...
contract AvatizersSVGRenderer is Ownable {
    ...
    function strArrRandPad(string[] memory strings, int256[] memory nums) public pure returns (string memory result) {
        require(strings.length - 1 == nums.length, "strArrRandPad: Incorrect lengths");
    ...
    function genColourPalette(uint256 length, bytes memory seed) public pure returns (string[] memory colourPalette) {
        require(length > 0, "Must request at least one colour.");
    ...
    function genShards(bytes memory seed) public pure returns (string memory svg) {
        int256[] memory nums = new int256[](7);
        {
            uint256[] memory temp = new uint256[](7);        
            uint256[7] memory limits = [uint256(360), 360, 360, 360, 360, 360, 360];
        ...
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Shards"><g transform="translate(115.15,582.4) rotate(';
            strings[1] = ')"><path class="st1" d="M-53.2-21.7l106.3,23l-84.1,20.4L-53.2-21.7z"/></g><path class="st6" d="M363.2,694.5l94.8-88.6l69.1,5.3L363.2,694.5z"/><path class="st9" d="M157.7,697.1l41.6,9.7l44.3,58.5L157.7,697.1z"/><g transform="translate(500.95,401.25) rotate(';
            strings[2] = ')"><path class="st11" d="M-35.8-16.9l71.7,27.5l-39,6.2L-35.8-16.9z"/></g><path class="st8" d="M472.1,651.9l88.1-29.1l-13.4,19.9L472.1,651.9z"/><g transform="translate(492.9,146.15) rotate(';
            strings[3] = ')"><path class="st13" d="M-20.6,26.5h31.8l9.4-53.1L-20.6,26.5z"/></g><g transform="translate(71.85,128.8) rotate(';
            strings[4] = ')"><path class="st5" d="M-26.6-3.5L2.5-46.7l24.2,93.4L-26.6-3.5z"/></g><g transform="translate(157.8,152.1) rotate(';
            strings[5] = ')"><path class="st12" d="M-12.4-49.3c4,0,24.8,15.4,24.8,15.4L6.6,49.3L-12.4-49.3z"/></g><g transform="translate(249.65,127.35) rotate(';
            strings[6] = ')"><path class="st14" d="M-19.5,32.8l38.9-44.1l-3.4-21.6L-19.5,32.8z"/></g><g transform="translate(526.8,251.85) rotate(';
            strings[7] = ')"><path class="st6" d="M-19.6-1.8L19.6-5L7.1,5L-19.6-1.8z"/></g></g>';
        }
    ...
    function genNeck(bytes memory seed) public pure returns (string memory svg) {
        ...
        string[] memory strings;
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Neck"><path class="st1" d="M214.1,522.7c0.2,15.8,64.7,215.7,64.7,215.7l78.5-109.6L214.1,522.7z" transform="translate(';
    ...
    function genDimples(bytes memory seed) public pure returns (string memory svg) {
        ...
        string[] memory strings;
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Dimples" ><g transform="translate(215.95,501.15)"><path class="st2" d="M-43.9-71.5c3.8,7.9,55.7,66.6,55.7,66.6l32.2,76.3l-58.9-41.3L-43.9-71.5z" transform="scale(0.';
    ...
    function genCheekbones(bytes memory seed) public pure returns (string memory svg) {
        ...
        string[] memory strings;
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Cheekbones"><g transform="translate(374.5,458.9)"><path class="st5" d="M-33.1-3.9l66.2-26.5L25.9,1.5l-30,28.9L-33.1-3.9z" transform="scale(0.';
    ...
    function genEyes(bytes memory seed) public pure returns (string memory svg) {
        int256[] memory nums = new int256[](2);
        {
            ...
            uint256[1] memory limits = [uint256(50)];
            int256[1] memory offsets = [int256(50)];
            temp[0] = limits[0];
            temp =  genPseudoRand(seed, temp);
            nums[0] = int256(temp[0]) + offsets[0];
            nums[1] = int256(temp[0]) + offsets[0];
        }
        string[] memory strings;
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Eyes"><g transform="translate(365.05,403.9136) scale(1,0.';
            strings[1] = ')"><path class="st6" d="M-28.4,7.7c0,0,18-13.6,26.9-17.4c10.8-4.6,30-4.9,30-4.9L20.3,2.6L-28.4,7.7z"/><path class="st7" d="M-28.4,7.7c0,0,18.2-7.6,25.8-8.7c9-1.4,22.9,3.6,22.9,3.6S7.2,13-0.5,14.4C-10.2,16.1-28.4,7.7-28.4,7.7L-28.4,7.7z"/></g><g transform="translate(254,403.9793) scale(1,0.';
            strings[2] = ')"><path class="st6" d="M-30.7-17.1l8.2,19.4l53.1,8.9c0,0-10.2-13.2-20-18C-0.9-12.5-30.7-17.1-30.7-17.1L-30.7-17.1z"/><path class="st7" d="M-22.4,2.3c0,0,14.4,12.4,22.9,14.3c10.7,2.4,30.2-5.4,30.2-5.4S13.6,2.1,5.1,0.5C-4.8-1.3-22.4,2.3-22.4,2.3L-22.4,2.3z"/></g></g>';
        }
        svg = strArrRandPad(strings, nums);
    }
    ...
    function genEyebrows(bytes memory seed) public pure returns (string memory svg) {
        ...
        string[] memory strings;
        {
            strings[0] = '<g id="Eyebrows"><g transform="translate(361.4,377.15) rotate(';
            strings[1] = ')"><path d="M-21.5-2.5c0.3,1.6-9.1,15.7-9.1,15.7L30.6-9.5l-7.2-3.8L-21.5-2.5z"/></g><g transform="translate(254.5,378.05) rotate(';
            strings[2] = ')"><path d="M-26.8-12.4l58.6,9.6l11.1,15.3L-42.9-7.8L-26.8-12.4z"/></g></g>';
        }
        svg = strArrRandPad(strings, nums);
    }

    function genNose(bytes memory seed) public pure returns (string memory svg) {
        int256[] memory nums = new int256[](1);
        {
            uint256[] memory temp = new uint256[](1);        
            uint256[1] memory limits = [uint256(99)];
            int256[1] memory offsets = [int256(0)];
            temp[0] = limits[0];
            temp =  genPseudoRand(seed, temp);
            nums[0] = int256(temp[0]) + offsets[0];
        }
        string[] memory strings;
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Nose" transform="translate(309.65,447.25) scale(0.';
            strings[1] = ',1)"><path class="st5" d="M0.5-55.8l-26.8,83.5l33.6,2.9L0.5-55.8z"/><path class="st2" d="M14,6l5.1,22.3l7.3-6.4L14,6z"/><path class="st2" d="M3.3,40.3l5.1,15.5L-1.3,54L3.3,40.3z"/></g>';
        }
        svg = strArrRandPad(strings, nums);
    }

    function genLips(bytes memory seed) public pure returns (string memory svg) {
        int256[] memory nums = new int256[](3);
        {
            uint256[] memory temp = new uint256[](2);        
            uint256[3] memory limits = [uint256(25), 100, 20];
            int256[3] memory offsets = [int256(75), 0, -10];
        ...
        string[] memory strings;
        { //Scoping to avoid stack too deep errors
            strings[0] = '<g id="Lips" transform="translate(309.2,521.25) scale(0.';
            strings[1] = ',0.';
            strings[2] = ') rotate(';
            strings[3] = ')"><path class="st6" d="M-18.3-4.5C-15.8-3.8,11.3,11,11.3,11L22.8-8.9L-18.3-4.5z"/><path class="st6" d="M-43.6,4.4l37-22.9L36.2-1.6L-43.6,4.4z"/><path class="st6" d="M-22.2,2.1l46.7-21L43.6-3.9L-22.2,2.1z"/><path class="st7" d="M-43.6,4.4c1.3,0.5,40.7,14.6,40.7,14.6L27.4,8L1.1,0.7L-43.6,4.4z"/><path class="st7" d="M-8.5,13.8l24.1-15l28-2.6L21,16.6L-8.5,13.8z"/></g>';
        }
        svg = strArrRandPad(strings, nums);
    }
    ...
    function genHair(bytes memory seed) public pure returns (string memory svg) {
        ...
        bytes32 hashedSeed = keccak256(abi.encodePacked(seed));
        {
            ...
            int256[17] memory offsets = [int256(-5), 0, -60, -90, 0, -20, -45, -90, -45, -20, 0, -15, -10, -130, 0, 0, 0];
        ...
        if (uint8(hashedSeed[0]) % 5 == 0) {
            ...
            svg = string.concat(
                svg,
                '<path id="Hairline" class="st6" d="M129.6,285.7l14.1,71.2l30.7,55l9-75.1l190.9-67.3l-1.3-13.6l55.7,109.4l-12.2-136.6L364,175l-94.8-18.1l-113.4,49.2L129.6,285.7z"/>'
            );
            if (uint8(hashedSeed[0]) % 3 != 0) {
                string[] memory strings;
                {
                    strings[0] = string.concat('<g id="Hair"><g visibility=', uint8(hashedSeed[0]) % 4 != 0 ? '"visible"' : '"hidden"','><g transform="rotate(');
                    ...
                    strings[17] = ',203.55,315.15)"><path class="st13" d="M154.1,357.9c3.8-3.1,77.2-85.5,77.2-85.5l21.7,13.9L154.1,357.9z"/></g></g></g>';
                }
                svg = strArrRandPad(strings, nums);
            }
        }
    ...
    function genStreaks() public pure returns (string memory svg) {
        svg = string.concat(
            '<g id="Streaks"><path d="M348.5,583.7c29.9-27,58.2-47.1,88.6-67.2c-34.7,19-65.8,43.8-95.5,69.9L348.5,583.7z"/>',
            '<path d="M380.6,565.4c13.2-12.6,27.7-22.6,42.1-33.5c-18,9.4-33.4,22.5-48.4,36L380.6,565.4z"/>',
            '<path d="M223.5,446.5c-23.1-13-39.3-34.6-53.6-56.4l-0.2,0.1c10.9,23.3,27.9,45.7,50.8,58.2L223.5,446.5L223.5,446.5z"/>',
            '<path d="M207.1,443.2c-29.5-23.5-47.1-54.4-56.3-85.8l-0.9,0.5c4.2,35.1,27.3,65,53.3,87.7L207.1,443.2L207.1,443.2z"/>',
            '<path d="M558.6,606.8c-47.7-9-97.1-9.6-145.6-7c47,0.9,94.3,1,140.7,10.1L558.6,606.8L558.6,606.8z"/>',
            '<path d="M367.2,325.2c-31.5-5.3-62.1-11.3-93.8-20.5l-0.2,0.1c28.4,12.2,59.7,17,89.7,23.4L367.2,325.2L367.2,325.2z"/>',
            '<path d="M386.8,335.8c-33.9-5.3-66.8-15.7-100.2-23.5l-0.2,0.1c13.1,6.4,28.8,9.9,42.8,13.7c18.6,4.6,34.3,11,53.2,12.8L386.8,335.8L386.8,335.8z"/>',
            '<path d="M198,742.8c-10.7,10.4-21.9,21.5-30.4,33.7c13.6-10.2,23.1-25.3,36.2-36.2L198,742.8L198,742.8z"/>',
            '<path d="M202.5,746.4c-17.8,16-32.9,34.7-46.9,53.9c17.1-18,32.2-39.4,51.1-55.7L202.5,746.4L202.5,746.4z"/>',
            '<path d="M550.2,596.2c-37.9-4.9-76.6-5.2-114.7-3.2c36.6,0.4,73.4,1.4,109.7,6.6L550.2,596.2L550.2,596.2z"/>'
        );
    }

    function generateFullSVG(bytes memory seed) public pure returns (string memory svg) {
        {
            svg = string.concat(
                '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 600 850" style="enable-background:new 0 0 600 850;" xml:space="preserve">',
                genStyleSheet(seed, genColourPalette(15, seed)),
