...
//   / __ \____  ____  _____     /  _/  / __ \(_)___/ /  /  _/ /_
//  / / / / __ \/ __ \/ ___/     / /   / / / / / __  /   / // __/
// / /_/ / /_/ / /_/ (__  )    _/ /   / /_/ / / /_/ /  _/ // /_  
// \____/\____/ .___/____( )  /___/  /_____/_/\__,_/  /___/\__/  
//           /_/         |/                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x74DC141988DA2Bbb0707926A747725a9475cE747];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZGNyqjjNMaRR6zYWRJB3Pg8Nba8iiecNQRR9ZqAMLTPm/";
...
// File: contracts/OopsIDidItContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OopsIDidItContract is RamppERC721A {
    constructor() RamppERC721A("Oops I Did It", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YCI0GEkTqJFUTzzp3MjN/contract-metadata";
    }
}
