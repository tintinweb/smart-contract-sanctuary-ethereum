...
// Part: smartcontractkit/[email protected].4.0/LinkTokenInterface
...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        usdEntryFee = 50 * (10**18); // it has 18 decimals
        lottery_state = LOTTERY_STATE.CLOSED;
        fee = _fee;
        keyHash = _keyHash;
    }

    // since we want to have an entrance fee then function needs to be payable
    ...
    function getETHPrice() public view returns (uint256) {
        ...
        return uint256(answer * (10**10)); // now it has 18 decimals
    }

    // // 1000000000
    // function getEntranceFeeInETH() public view returns (uint256) {
    //     uint256 ethPrice = getPrice();
    //     return usdEntryFee / ethPrice;
    ...
    function end() public onlyOwner {
        // next block is not a truly rand function given params
        // uint256(
        //     // not actual random
        //     keccak256(
        //         abi.encodePacked(
        ...
        // we can use CahinLink VRF, to generate a rand function
        ...
        override
    {
        ...
        latestWinner = players[_randomness % players.length];
