...
import "./OZ_forks/extensions/aNFTEnumerable.sol";
import "./OZ_forks/extensions/aNFTBurnable.sol";
import "./OZ_forks/extensions/aNFTPausable.sol";
import "./OZ_forks/extensions/aNFTURIStorage.sol";
    ...
    IMetaDungeon
{
    ...
    function setBaseURI(string memory newBaseTokenURI) public virtual override {
    ...
    function setTokenURIs(uint256 tokenId, string[] memory tokenURIs) external override {
        require(hasRole(MINTER_ROLE, _msgSender()));
        _setTokenURIs(tokenId, tokenURIs);
    }
     ...
     *
     * See {aNFTPausable} and {Pausable-_pause}.
     *
     * Requirements:
     *
     ...
     *
     * See {aNFTPausable} and {Pausable-_unpause}.
     *
     * Requirements:
     *
     * - the caller must have the `PAUSER_ROLE`.
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal virtual override(aNFT, aNFTEnumerable, aNFTPausable) {
    ...
    function _burn(uint256 tokenId) internal virtual override(aNFT, aNFTURIStorage) {
        super._burn(tokenId);
    }

    function tokenURI(uint256 tokenId) public view virtual override(IMetaDungeon, aNFT, aNFTURIStorage) returns (string memory) {
...
import "./extensions/IaNFTMetadata.sol";
...
contract aNFT is Context, ERC165, IaNFT, IaNFTMetadata {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return
            ...
            interfaceId == type(IaNFTMetadata).interfaceId ||
    ...
    /**
     * @dev See {IaNFTMetadata-tokenURI}.
     */
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/ERC721/extensions/aNFTEnumerable.sol)

pragma solidity ^0.8.0;

import "../aNFT.sol";
import "./IaNFTEnumerable.sol";
 ...
 * account.
 */
abstract contract aNFTEnumerable is aNFT, IaNFTEnumerable {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, aNFT) returns (bool) {
        return interfaceId == type(IaNFTEnumerable).interfaceId || super.supportsInterface(interfaceId);
    }

    /**
     * @dev See {IaNFTEnumerable-tokenOfOwnerByIndex}.
     */
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < aNFT.balanceOf(owner), "aNFTEnumerable: owner index out of bounds");
        return _ownedTokens[owner][index];
    }

    /**
     * @dev See {IaNFTEnumerable-totalSupply}.
     */
    ...
    /**
     * @dev See {IaNFTEnumerable-tokenByIndex}.
     */
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < aNFTEnumerable.totalSupply(), "aNFTEnumerable: global index out of bounds");
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/ERC721/extensions/aNFTBurnable.sol)
 ...
 */
abstract contract aNFTBurnable is Context, aNFT {
    /**
    ...
    function burn(uint256 tokenId) public virtual {
        //solhint-disable-next-line max-line-length
        require(_isApprovedOrBrain(_msgSender(), tokenId), "aNFTBurnable: caller is not owner nor approved");
        _burn(tokenId);
    }
}

// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/ERC721/extensions/aNFTPausable.sol)
 ...
 */
abstract contract aNFTPausable is aNFT, Pausable {
    /**
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "aNFTPausable: token transfer while paused");
    }
}
 ...
 */
abstract contract aNFTURIStorage is aNFT {
    using Strings for uint256;
    ...
    function _tokenURI(uint256 tokenId, uint256 version) internal view returns (string memory) {
        ...
        if (verLen > 0) {
            require(version < verLen, "aNFTURIStorage: version out of bounds");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "aNFTURIStorage: URI query for nonexistent token");
    ...
    function _setTokenURIs(uint256 tokenId, string[] memory tokenURIs) internal virtual {
        require(_exists(tokenId), "aNFTURIStorage: URI set of nonexistent token");
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/ERC721/extensions/IaNFTMetadata.sol)
 ...
 */
interface IaNFTMetadata is IaNFT {
    /**
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/ERC721/extensions/IaNFTEnumerable.sol)
 ...
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
interface IaNFTEnumerable is IaNFT {
    /**
