...
contract myNFT is ERC721, ERC721URIStorage {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmVbumrnkyPUVT8kjNJHeaymU7aMFfdaKMqHvsmRzbpUUt/";
    }
    ...
    {
        return string(
                abi.encodePacked("https://ipfs.io/ipfs/QmVbumrnkyPUVT8kjNJHeaymU7aMFfdaKMqHvsmRzbpUUt/", Strings.toString(_tokenId), ".json")
            );
    }
