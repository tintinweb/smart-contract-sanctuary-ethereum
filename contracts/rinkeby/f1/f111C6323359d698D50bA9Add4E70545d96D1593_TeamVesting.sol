...
contract TeamVesting is Ownable {  // AccessControl,
    ...
    function allowance(address _address) public view returns (uint256) {
        ...
        require(_allowed <= _account.allocation, "Cannot withdraw more than allocated");
        return _allowed;
    }
    ...
    function withdraw() public {
        require(accounts[msg.sender].paused == false, "Your withdrawals have been paused. Please contact admin");
        uint256 _allowance = allowance(msg.sender);
        accounts[msg.sender].withdrew += _allowance;
