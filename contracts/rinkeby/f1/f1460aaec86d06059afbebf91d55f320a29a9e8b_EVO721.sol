...
contract EVO721 is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function mint(address to_, uint256 tokenId_) public payable {
    ...
    /// @param amount_ amount that will be distributed
    /// @param to_ destinatary address ( royalties cases )
