...
import "./base/ERC721Extensions/MetawinERC721Vault.sol";
...
import "./ERC721Extensions/ERC721Timestamp.sol";               // ERC721 Enumerable with timestamps
...
*/
contract MetawinERC721 is ERC721Timestamp, uriStorage, BatchReveal, ERC2981, Ownable {
    ...
    * @param to Receiver's address
    */
    function mint(address to) external mintRequirements(0) {
    ...
    */
    function totalSupply() public view virtual override(BatchReveal, ERC721Enumerable) returns(uint256){
...
abstract contract MetawinERC721Vault is MetawinERC721 {
    ...
    * @dev If false, staking is blocked, but unstaking is always allowed.
    */
    bool public vault_allowed = false;
    /**
    * @notice Global switch variable to enable/disable the function "vault_transferWhileInVault"
    */
    bool public vaultTransfers_allowed = false;
    /**
    ...
    */
    ...
    /**
    * @notice Global switch to enable/disable vault staking (unstaking is always allowed).
    * @dev [Tx][External][Owner] Restricted to admin.
    */
    function vault_globalToggle() external onlyOwner {
        vault_allowed ? vault_allowed=false : vault_allowed=true;
    }
    ...
    */
    function vault_toggleVaultTransfers() external onlyOwner {
        vaultTransfers_allowed ? vaultTransfers_allowed=false : vaultTransfers_allowed=true;
    }
    ...
    */
    function vault_transferWhileInVault(
        ...
        require(vaultTransfers_allowed, "Currently disabled");
        require(ownerOf(tokenId) == _msgSender(), "Metawin: Only owner");
    ...
    */
    function vault_toggleStaking(uint256 tokenId) internal {
        ...
        if (start == 0) {
            require(vault_allowed, "Staking disabled");
 ...
 */
abstract contract ERC721Timestamp is ERC721Enumerable{
