...
contract OperationRise is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Operation Rise", "OPR"){
    
        uint256 _rewardsFee = 12;
        uint256 _marketingFee = 4;
        uint256 _liquidityFee = 2;
        uint256 _buybackFee = 0;
        uint256 _stakingFee = 2;
        feeDivisor = 100;
    	...
    	marketingWallet = address(0x7AFD4f6c96f337BB5d4528C3Fe4d2e24EB4Cc61D);
        liquidityWallet = address(0xFcD553399167ac1872ffaFdfEDB45F119eCb05E5); // liquidity will go to wallet to be locked
        stakingWallet = address(0x17b0BfDE54a0c7667D9Fa7285A81823407FaDF31); // set to a wallet for now, will be updated to a contract later. Rug Relief Fund
        ...
        dividendTracker.excludeFromDividends(address(0xFcD553399167ac1872ffaFdfEDB45F119eCb05E5));
        dividendTracker.excludeFromDividends(address(0x11EA9E27FbB2DEAd21B047e9ADdC72396d2992e4)); // will be final owner after everything is configured
        
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xFcD553399167ac1872ffaFdfEDB45F119eCb05E5), true);
        excludeFromFees(address(marketingWallet), true); // Marketing
        excludeFromFees(address(stakingWallet), true); // staking rewards 
        excludeFromFees(address(0x11EA9E27FbB2DEAd21B047e9ADdC72396d2992e4), true); // new owner
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(dividendTracker), true);
        excludeFromMaxTransaction(address(_uniswapV2Router), true);
        excludeFromMaxTransaction(address(0xFcD553399167ac1872ffaFdfEDB45F119eCb05E5), true);
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0xFcD553399167ac1872ffaFdfEDB45F119eCb05E5),
            block.timestamp
        );
    }
