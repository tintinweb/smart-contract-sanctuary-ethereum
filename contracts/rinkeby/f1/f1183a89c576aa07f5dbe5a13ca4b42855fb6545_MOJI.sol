...
contract MOJI is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint public constant MAX_MOJI_PURCHASE = 2000; // to save gas, some place used value instead of var, so be careful during changing this value
    ...
    // ############################# constructor #############################
    constructor() ERC721A("MOJI", "MOJI", 2000, 1000) { }
    ...
    function getDropedPrice(uint256 dropedPoint) internal pure returns (uint256)  {
    ...
    function mintPrice() public view returns (uint256) {
        ...
        if (elapsed >= saleDuration) {
            ...
            uint256 currentPrice = getDropedPrice(((numOfDropPoints * getRemainingSaleTime()) / saleDuration) + 1);
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens < 2001, "Can only mint 20 tokens at a time");
