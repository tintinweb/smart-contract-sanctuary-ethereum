...
contract DAOVerifier is OwnableUpgradeable {
    ...
    // @dev reset the verification threshold, can only set by owner
    // TODO: re audit ${_verifiedDaoIds}
    function setVerificationThreshold(uint256 verificationThreshold_) external onlyOwner {
        verificationThreshold = verificationThreshold_;
    }
    ...
    function stake(uint256 daoId_, uint256 amount_) external {
        ...
        amountByDaoIdAndAccount[daoId_][msg.sender] += amount_;
