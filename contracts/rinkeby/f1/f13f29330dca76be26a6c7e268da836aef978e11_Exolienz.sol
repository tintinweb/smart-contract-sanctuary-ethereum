...
contract Exolienz is Ownable, ERC721A {
    ...
    address constant internal DEV_ADDRESS = 0x92c39077Bf09cb8149B0222a27785f724EC3D27F;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Exolienz", "EXOS") { }
