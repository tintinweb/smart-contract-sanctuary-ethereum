...
contract LegacyLeadersGenesis is ERC721EnumerableChaos, Ownable, ReentrancyGuard, PaperVerification {
    ...
    constructor(address _paperKey) ERC721("Legacy Leaders Genesis", "LLG") PaperVerification(_paperKey)  {}
    ...
    */
    ...
    {   
        ...
        for (uint256 i = 0; i < _mintData.quantity; i++) {
            uint256 mintIndex = numTokensMinted;
            numTokensMinted++;
            _safeMint(_mintData.recipient, mintIndex);
        }
    }
