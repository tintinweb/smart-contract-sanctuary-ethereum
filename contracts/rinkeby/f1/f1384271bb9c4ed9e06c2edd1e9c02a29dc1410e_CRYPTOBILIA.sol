...
contract CRYPTOBILIA is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 5290;
	uint256 public PRESALE_NFT = 2500;
	uint256 public GIVEAWAY_NFT = 210;
	...
	uint256 public PRESALE_PRICE = 15 * 10**16;
	uint256 public SALE_PRICE = 17 * 10**16;
    ...
    constructor() ERC721P('CRYPTOBILIA', 'CRYPTOBILIA') {}
