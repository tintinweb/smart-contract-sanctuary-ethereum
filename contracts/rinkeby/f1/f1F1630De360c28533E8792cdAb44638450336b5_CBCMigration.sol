...
contract CBCMigration is Ownable {
    ...
    event Migration(address recepient, uint256 amount);
     ...
     */
    function migrate(uint256 _amount, uint256 _nonce, bytes memory _signature) external {
        ...
        address recovered = ECDSA.recover(keccak256(abi.encodePacked(_amount, _nonce, msg.sender)), _signature);
        ...
        require(
            ...
            "Admin doesn't have enough balance on new CBC contract"
        );
