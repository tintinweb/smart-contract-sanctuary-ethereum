    ...
    ILayerZeroUserApplicationConfig
{
    ...
    function lzEstimateFees(uint16 _dstChainId, address _userApplication, bytes calldata _payload, bool _payInZRO, bytes calldata _adapterParam) external view returns (uint nativeFee, uint zroFee) {
        return layerZeroEndpoint.estimateFees(_dstChainId, _userApplication, _payload, _payInZRO, _adapterParam);
    }
