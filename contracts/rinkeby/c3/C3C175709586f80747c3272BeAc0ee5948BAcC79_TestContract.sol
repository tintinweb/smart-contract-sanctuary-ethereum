...
contract TestContract is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmPN7vjEYovm1jpozKRrcFp3QcDjSmTZHrm9RHb2Hxw6N7/";  // <<<< CHANGE
    ...
    constructor() ERC721A("Another Test4", "TSTAGAIN4") {} // <<<<< CHANGE
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(saleStatus == SaleStatus.PUBLIC, "Sale not open");
