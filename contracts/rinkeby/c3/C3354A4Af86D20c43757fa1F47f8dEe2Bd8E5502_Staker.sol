...
contract Staker {
  ...
  function stake() public payable{
    require (deadline >= block.timestamp, "closed");
  ...
  function execute() public notCompleted{
    ...
    //require(address(this).balance > 0, "NO MONEY"); no longer nedeed with modifier
  ...
  function withdraw() public notCompleted{
    require(openForWithdraw==true, "withdraw close");
    require(balances[msg.sender]>0, "got 0");
