...
contract Staker {
    ...
    event Stake(address indexed staker, uint256 indexed stakeamount); 
  ...
  modifier notCompleted() {
      ...
      // Underscore - special character only used inside a () modifier and it tells Solidity to 
  ...
  function stake() public payable {
      ...
      console.log("balances address this", balances[address(this)]);
  ...
  function execute() public notCompleted {
      if (block.timestamp > deadline && address(this).balance >= threshold) {
          ...
          console.log("execute set openForWithdraw");
  ...
  function withdraw() payable public {
      require(openForWithdraw == true, "Not yet open for withdraw");
      uint256 withdrawAmount = balances[msg.sender];
      balances[msg.sender] = 0;
      payable(msg.sender).call{value: withdrawAmount, gas: 25000}("");
