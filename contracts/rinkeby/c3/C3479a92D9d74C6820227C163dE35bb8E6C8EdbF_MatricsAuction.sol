...
contract MatricsAuction is ERC1155Holder{
    ...
    modifier isAuctionNotStartedByOwner(
        ...
        if (
            ...
            require(
                IERC1155(_nftContractAddress).isApprovedForAll(nftContractAuctions[_nftContractAddress][_tokenId].nftSeller, msg.sender) == true,
    ...
    function _createNewNftAuction(
        ...
        _setupAuction(_nftContractAddress, _tokenId, _buyNowPrice, _nftCreator, _royalty);
