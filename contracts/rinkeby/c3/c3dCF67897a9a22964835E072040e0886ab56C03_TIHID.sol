...
contract TIHID is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    using SafeMath for uint256;

    uint256 public MAX_PER_Transaction = 5; // maximam amount that user can mint per transaction
    uint256 public MAX_PER_AddressWL = 2;
    uint256 public MAX_PER_Address = 10;

    uint256 public pricewl = 0.25 ether;
    uint256 public price = 0.3 ether; //0.08 WL price 0.1 eth public sale

    uint96 public royaltyFeesInBips;
    address public royaltyAddress;
    address public royaltyRecipient =
        0x04F38F1F7e86718c7135741d010DD6E2E8d16c1d;
    ...
    uint256 public whitelistSpots = 1000;
    ...
    {
        setNotRevealedURI(
            "https://tihidnft.mypinata.cloud/ipfs/QmPbuLvzCUHBme4vpLkE56pVHotAic7bVB4i5jYPDQgijj/Metadata/0000.json"
        );
        setBaseURI(
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        payable(0x75c27f3AEF0a479C0C3B5EC1E62f6A8f086e2235).transfer(ceoBal);

        // Co Founder share
        uint256 cfBal = balance.mul(35);
        cfBal = cfBal.div(100);
        payable(0x443999D7a5a6cf59f9C17f4cbE4f53622889952F).transfer(cfBal);

        // Project share
        uint256 proBal = balance.mul(20);
        proBal = proBal.div(100);
        payable(0x04F38F1F7e86718c7135741d010DD6E2E8d16c1d).transfer(proBal);

        // Investor share
        uint256 inBal = balance.mul(10);
        inBal = inBal.div(100);
        payable(0xc94888E885736161991C8052E9b277F72d2CcDFe).transfer(inBal);
    }
