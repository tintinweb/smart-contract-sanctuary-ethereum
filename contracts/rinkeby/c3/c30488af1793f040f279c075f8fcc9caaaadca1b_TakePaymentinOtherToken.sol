...
contract TakePaymentinOtherToken is ERC721A, Ownable, ReentrancyGuard {
  ...
  address public paymentTokenAddress = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709;
  ...
  function mintNFT(uint256 _numberOfTokens)
    ...
    nonReentrant
    {
     ...
     require( _numberOfTokens <= MAX_PER_TXN,"Max Owlz per TXN should not exceed");
      ...
      IERC20(paymentTokenAddress).transferFrom(msg.sender, address(this), tokenAmount*_numberOfTokens);
