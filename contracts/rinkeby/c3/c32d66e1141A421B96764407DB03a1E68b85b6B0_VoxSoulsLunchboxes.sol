...
contract VoxSoulsLunchboxes is ERC1155, Ownable, Pausable, ReentrancyGuard {
    address private importantAddress;
    ...
    string public name_ = "VoxSoulsLunchboxes";
    string public symbol_ = unicode"🍱";

    constructor(address _importantAddress) ERC1155("https://hostedsite.com/") {
    ...
    function mintLunchbox(
        ...
        currentLunchboxes = currentLunchboxes + 1;
    }
     ...
     * @param _contract The Vox contract address.
     * @param id The id of the Vox.
     * @param _type the type of lunchbox to mint.
     */
    function batchAdminMintLunchboxes(
        address[] calldata _contract,
        uint256[] calldata id,
    ...
    /**
     * @notice Withdrawl the balance from the contract.
     */
