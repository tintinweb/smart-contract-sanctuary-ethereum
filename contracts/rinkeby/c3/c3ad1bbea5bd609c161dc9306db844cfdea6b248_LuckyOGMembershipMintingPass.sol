...
contract LuckyOGMembershipMintingPass is Ownable, ERC721A  {
    ...
    constructor() ERC721A("Lucky OG Membership Minting Pass", "Lucky OG Membership Minting Pass") {}
    ...
    ///Mints Lucky OG Membership Passes
    function mintPass(bytes32[] calldata _merkleProof,uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        require(numberMinted(msg.sender) + _mintAmount <= maxMintAmountPerAccount, "Mint limit exceeded." );  
    ...
    function setMaxMintPerAccount(uint64 _maxMintAmountPerAccount) public onlyOwner {
