...
dP"""88""""""Y8,           ,dPYb,               ,dPYb,                                      dP"""88""""""Y8b,                                                                  
Yb,  88      `8b           IP'`Yb               IP'`Yb                                      Yb,  88       `8b,                                                                 
 `"  88      ,8P           I8  8I               I8  8I                gg                     `"  88        `8b  gg                                      gg                     
     88aaaad8P"            I8  8'               I8  8'                ""                         88         Y8  ""                                      ""                     
     88""""Yb,     ,ggg,   I8 dP        ,ggg,   I8 dP    ,g,          gg    ,ggg,,ggg,           88         d8  gg     ,g,       ,gggg,gg  gg      gg   gg     ,g,      ,ggg,  
     88     "8b   i8" "8i  I8dP   88gg i8" "8i  I8dP    ,8'8,         88   ,8" "8P" "8,          88        ,8P  88    ,8'8,     dP"  "Y8I  I8      8I   88    ,8'8,    i8" "8i 
     88      `8i  I8, ,8I  I8P    8I   I8, ,8I  I8P    ,8'  Yb        88   I8   8I   8I          88       ,8P'  88   ,8'  Yb   i8'    ,8I  I8,    ,8I   88   ,8'  Yb   I8, ,8I 
     88       Yb, `YbadP' ,d8b,  ,8I   `YbadP' ,d8b,_ ,8'_   8)     _,88,_,dP   8I   Yb,         88______,dP' _,88,_,8'_   8) ,d8,   ,d8I ,d8b,  ,d8b,_,88,_,8'_   8)  `YbadP' 
     88        Y8888P"Y8888P'"Y88P"'  888P"Y8888P'"Y88P' "YY8P8P    8P""Y88P'   8I   `Y8        888888888P"   8P""Y8P' "YY8P8PP"Y8888P"8888P'"Y88P"`Y88P""Y8P' "YY8P8P888P"Y888
                                                                                                                                     ,d8I'                                     
                                                                                                                                   ,dP'8I                                      
                                                                                                                                  ,8"  8I                                      
                                                                                                                                  I8   8I                                      
...
contract RebelsCoin is ERC1155, Ownable, ERC1155Burnable {
    ...
    // Payout addresses
    address team1 = 0xee4375C0E5D0b8Ca4b7F6EAE37A31899B335E556;
    address team2 = 0x5326d427bFcaD5576Fe4668eD95656eDA0F36B0f;
    address team3 = 0x3927e3c0299906fec7A5F5719239b77d669A3130;
    address team4 = 0x48CF361052534Ac426d1263AF9d847D54f85730b;
    address team5 = 0xc58667E7e3afF2121bC19e19C0534942f16cd490;
    address team6 = 0x75431e52B518Be2B6CD82441f3E01731b78d730a;
    address team7 = 0x123CC9A4017885369a04495A91c8A0eEC7FE3864;
    address team8 = 0xfc9BbDdD7D4c360145524773D16D13Fa3CA9980B;
    address team9 = 0x33698f9F6999619A5Bbc235D85842912a3061eE2;

    constructor(address _rebels721Contract, string memory _name, string memory _symbol)
        ERC1155("https://gateway.pinata.cloud/ipfs/QmYqYXcj3jD5EbAaAXEMWmy6TBXc9Y1BXUyjDrUBDK85cs/0")
    {
        name_ = _name;
        symbol_ = _symbol;
    ...
    function mint(uint256 _count) public payable {
        ...
        require(_count <= perTransaction, "Only 10 for whitelisted users");
        require(_count + amountMinted <= maxrebels, "Limit reached");

        _mint(msg.sender, 0, _count, "");
        amountMinted = amountMinted + _count;
    }
    ...
    // Mint function for only owner to mint other addresses. This will be used for special NFTs rewarded to the community
    function mintToAddress(address contractAddress, uint256 _count) public onlyOwner {
        _mint(contractAddress, 0, _count, "");
        amountMinted = amountMinted + _count;
    }
    ...
    function migrateToken(uint256 id) public {
        ...
        rebels721Contract.mintTransfer(msg.sender);
    }
