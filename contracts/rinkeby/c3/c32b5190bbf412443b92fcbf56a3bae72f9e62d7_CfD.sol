...
contract CfD {   
    ...
    // Bounty hunter fee for calling the Oracle price feed function.
    uint bountyHunterInvokeFee;
    ...
    timeLag = 5 minutes;
    cfdDeployerFee = 10000000000000000000;
    bountyHunterDifferenceFee = 10000000000000000000;
    bountyHunterInvokeFee = 10000000000000000000;
    marketOperatorInputFee = 10000000000000000000;
    gracePeriod = 30 days; */
    constructor (address payable _marketOperator, uint _tradingPeriod, uint _timeLag, uint _fees, uint _gracePeriod) {
        ...
        cfdDeployerFee = _fees; bountyHunterDifferenceFee = _fees; bountyHunterInvokeFee = _fees; marketOperatorInputFee = _fees;
