...
// TODO: Should sMINT be ERC20Burnable?
contract sShuffleMintERC20Token is Ownable, ERC20Permit('Staked Shuffle Mint') {
    ...
    // TODO: changed this from 10 ** 9, is that the right move?
    // TODO: might need to add another 1e6 to account for unit basis
    // TODO: maybe 2B here? since we dealing with WETH not DAI?
    ...
    constructor() ERC20('Staked Shuffle Mint', 'sMINT') {
        _totalSupply = INITIAL_FRAGMENTS_SUPPLY;
        _gonsPerFragment = TOTAL_GONS / INITIAL_FRAGMENTS_SUPPLY;
    }

    function initialize(address stakingContract_) external onlyManager {
