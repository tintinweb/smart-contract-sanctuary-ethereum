...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeA86c5597175629fefA97C62180C0cD8A47705dA];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUGuVVFG6eX2guTb6Yw5TDA236hPqSB4vvUwEJGMHRamt/";
...
contract TestProjectContract is RamppERC721A {
    constructor() RamppERC721A("Test Project", "TP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/pI0JnUd0Mx2388gUrhIr/contract-metadata";
    }
}
