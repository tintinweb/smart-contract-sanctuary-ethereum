    ...
    Treasury
{
    ...
    address[] private mintPayees = [
        0xaDC6A7985036531c394B6dF054666C51dE29b9a9, // Cnick
        0x76bf7b1e22C773754EBC608d92f71cc0B5D99d4B, // Artist
        0xBa4491E278CA6cCDbA68749673dEF8A0112C1F8f // Dev
    ];

    uint256[] private mintShares = [72, 25, 3];
    ...
    function allowListMint(uint256 numberOfTokens, uint256 temporaryWhitelist)
        external
        payable
    {
        require(!paused(), "Minting is paused");
        ...
        require(allowlistSigner != address(0), "Whitelist signer not set");
        ...
        // require(
        //     signer != address(0) && signer == allowlistSigner,
        //     "Invalid signature"
        // );

        require(temporaryWhitelist == 5, "Put 5 on third parameter");
    ...
    function setWhitelistSigner(address newWhitelistSigner) external onlyOwner {
        ...
        allowlistSigner = newWhitelistSigner;
    }
