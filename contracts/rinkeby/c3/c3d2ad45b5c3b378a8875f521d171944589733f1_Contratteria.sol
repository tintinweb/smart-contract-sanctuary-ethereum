...
// File: contracts/Contratteria.sol
...
contract Contratteria is Ownable, ERC721A, ReentrancyGuard {
  ...
  mapping(address => uint256) public allowlist;
    ...
    uint256 maxBatchSize_=1000;
    uint256 collectionSize_=100;
    uint256 amountForAuctionAndDev_;
    uint256 amountForDevs_;

  constructor(
  ) ERC721A("Contratteria", "CNTTR", maxBatchSize_, collectionSize_) {
