     ...
     ReentrancyGuard 
{
  ...
  string public hiddenMetadataUri = "ipfs://QmfMhcNhB1UrFiyzSE9Pq8LtLtP3Nbm6PXkyEZ7beeC2f2/hidden.json";  // add hidden metadata URL here
  string public arweaveBackupURI;
...
/// @dev === Owner Control/Configuration Functions ===
  ...
  function setArweaveBackupURI(string memory _arUri) public onlyOwner {
    arweaveBackupURI = _arUri;
  }
