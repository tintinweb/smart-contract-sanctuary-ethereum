...
contract Laster is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    string private _currentBaseURI;

    uint32 public MAX_SUPPLY = 5_555;
    uint32 public constant MAX_WL_SUPPLY = 200;
    ...
    uint256[] private _teamShares = [10, 90]; 
    address[] private _team = [
        0xE81f08cdB072b22435a0cfC54C95F0643806168C, 
        0x2E2Ccfe4c8b7FC10acc7a6344cfFadbBCEA3A47d 
    ];
    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress) ERC721A("Laster", "Laster") 
    ...
    function mint(uint256 count) external payable nonReentrant {
        require(!paused, "Laster: Contract is paused");
