...
contract GasRefund is Ownable {
    ...
    function refund(uint256 refundAmount, bytes32[] calldata proof) external {
        ...
        require(_verify(refundAmount, proof), "invalid proof");
    ...
    function _verify(uint256 amount, bytes32[] calldata proof) internal view returns (bool) {
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender, amount));
        return MerkleProof.verify(proof, refundMerkleRoot, leaf);
    }
