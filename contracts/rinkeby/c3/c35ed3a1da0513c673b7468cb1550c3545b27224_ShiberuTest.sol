...
contract ShiberuTest is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("SHIBERU TEST","ST", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        address wallet1 = payable(0x9A2c7b7B5E3cc2C2232341211f3F9F9D53b51D2E);
        
        bool success;
        (success, ) = wallet1.call{value: (sendAmount * 1000/1000)}("");
