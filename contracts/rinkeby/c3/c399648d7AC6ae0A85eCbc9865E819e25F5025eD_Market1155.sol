...
contract Market1155 is ERC1155Holder, ReentrancyGuard {
    ...
    function createMarketSale(
        ...
        require(amount > 0, "Amount must be above zero");
        require(itemId > 0, "Item Id must be above zero");
        ...
        require(
            msg.value == price * amount + listingPrice,
            "Please add the listing price in order to complete purchase"
        );
        ...
        //pay owner of contract the listing price //pay  contract the listing price
    }
