...
contract TuttiiMarketplace is Ownable {
    ...
    function buyListing(
        ...
        uint salePrice = listing.price * amount;
        require(
        ...
        transferRoyalties(tokenContract, tokenId, msg.sender, listing.seller, salePrice);
    ...
    function acceptOffer(address tokenAddress, uint tokenId, address buyer, uint amount) external {
        ...
        uint salePrice = offer.price * amount;
        require(
        ...
        transferRoyalties(tokenContract, tokenId, buyer, msg.sender, salePrice);
