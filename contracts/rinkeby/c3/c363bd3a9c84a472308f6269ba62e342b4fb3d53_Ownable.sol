...
contract MRGREEN$ is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x367C5E1f621266Ab67CecD51fdaA9519Fef45F9a);
    ...
    uint256 public _maxTxAmount = 25e9 * 10**9; //2.5%
    uint256 public _maxWalletSize = 5e10 * 10**9; //5%
    uint256 public _swapTokensAtAmount = 1000 * 10**9;
    uint256 public _minimumBuyAmount = 25e9 * 10**9 ; // 2.5%
