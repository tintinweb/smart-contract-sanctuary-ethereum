...
contract BlockAgentsMintPass is ERC721A, Whitelist {
    uint256 public constant MAX_SUPPLY = 500;
    uint256 public constant PRICE = 0.069 ether;

    string public baseUri;

    constructor() ERC721A("BlockAgentsMintPass", "BLOCKAGENTSMINTPASS") {
        baseUri = "https://TODO.com/";
    }
    ...
    function withdraw() external {
        // TODO addresses
        address owner = 0x745031de8713dD13305bC0Feb5599d9fd8D0E012;
        address dev = 0x745031de8713dD13305bC0Feb5599d9fd8D0E012;
        require(msg.sender == dev || msg.sender == owner, "not allowed");

        uint256 balance = address(this).balance;
        payable(owner).transfer((balance * 93) / 100);
        payable(dev).transfer((balance * 7) / 100);
    }
...
contract Whitelist is Ownable {
    ...
    function getWhitelistAmount(address addr) external view returns (uint256) {
