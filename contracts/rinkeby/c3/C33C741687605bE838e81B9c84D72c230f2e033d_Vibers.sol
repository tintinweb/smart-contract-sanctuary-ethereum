...
contract Vibers is Context, ERC721Enumerable, ERC721Burnable, ReentrancyGuardUpgradeable, Ownable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory _baseTokenURI) ERC721("Vibers", "VIBE") {
    ...
    */
     ...
     *
     */
    function mint(address to, uint amount) external payable noContract {
        //check sale start
        ...
        //check for overmint
        require(amount <= MAX_SUPPLY-numTokens,"Mint request exceeds current supply!");

        //check payment
        require(msg.value == PRICE * amount, "msg.value invalid");
    ...
    function whitelistMint(
      ...
      //check payment
      require(msg.value == PRICE * amount, "Vibers price mismatch");
    ...
    */
    ...
    /**
    * Start whitelist sale (cant be stopped later)
    */
    ...
    */
    ...
    function hasWhitelistMintOpen() external view returns (bool) {
