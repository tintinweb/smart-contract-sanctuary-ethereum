...
contract EDRT is ERC721A, Ownable {
    ...
    constructor() ERC721A("ETH Doomsday Raffle Ticket", "EDRT") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= maxPerTx, "Too much per tx");
    ...
    function cutSupply(uint256 _maxSupply) external onlyOwner {
		require(_maxSupply < maxSupply , "make it a RULE");
