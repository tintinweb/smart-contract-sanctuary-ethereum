...
//libreria para importar el contrato ERC721 de tokens

//libreria para importar contrato q ayuda a manejar numeros

//libreria para importar contrato q ayuda a manejar contadores

//libreria q pasa un string a base64

//libreria q administra el dna de cada nft

//para manejar strings

/*
npx hardhat compile , compilar proyecto
npx hardhat test, ejecutar el testing
npx hardhat run  scripts/deploy.js , correr local
npx hardhat run  scripts/deploy.js --network rinkeby , correr en la red de prueba rinkeby
npx hardhat flatten genera una version plana del contrato en un solo archivo para subirlo a etherscan po rejmplo
 */


contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    using Counters for Counters.Counter;
    using Strings for uint256; //que utilice la libreria string para todos los uint256
    ...
    function mint() public {
        ...
        _idCounter.increment();//si comento esta linea saca error desde las pruebas
    }
    ...
    function _paramsURI(uint256 _dna) internal view returns (string memory) {
        ...
        //solidity restringe el limite de memoria por cada bloque
        //aca se creo en un nuevo bloque, porq saco error al compilar del stack de memoria {}
        {
            params = string(
                abi.encodePacked(
                    "accessoriesType=",
        ...
        //agrega el parametro q faltaba al stack
