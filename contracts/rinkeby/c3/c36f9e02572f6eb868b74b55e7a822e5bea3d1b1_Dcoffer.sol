...
abstract contract Receiver is IERC721Receiver {
     function onERC721Received(
        address operator,
        address from,
        uint256 tokenId,
        ...
        return bytes4(keccak256("onERC721Received(operator,from,tokenId)"));
    }
}

/// @custom:security-contact [email protected]
contract Dcoffer is ERC721, ERC721URIStorage, ERC721Burnable, Ownable , Receiver{
