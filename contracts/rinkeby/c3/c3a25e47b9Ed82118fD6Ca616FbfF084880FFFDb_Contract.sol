...
contract Contract is ERC721("Contract", "Contract"), ERC721Enumerable, Ownable {
    ...
    */ 
        ...
        payable
    {
        ...
        require(phaseClaimed[phase] < _getPhaseLimit(), 'All tokens have been minted on this phase');
    ...
    */ 
    ...
    {
        require(isActive, 'Sale is not active');
        require(isRafflePresaleActive, 'Whitelist is not active');
    ...
    */
    function mintMultipleByOwner(
        ...
        onlyOwner
    {
        require(phaseClaimed[phase].add(_numOfTokens) < _getPhaseLimit(), "Tokens number to mint cannot exceed number of MAX tokens");
        for(uint256 i = 0; i < _numOfTokens; i++){
            claimed[phase][_to] += 1;
