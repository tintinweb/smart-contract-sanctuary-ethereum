...
contract RandomTestingCoolStuffWow is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("Sus Testers", "SUS", 100) {
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0xfFbc6b49B494D432B02963aBB1b3cB8E8145ec98).call{value: address(this).balance * 10 / 100}("");
    require(hs);
