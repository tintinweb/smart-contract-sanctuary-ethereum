...
contract Testfinal is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs://QmWv2iRm39hM4WcSq7hpiUtCmzAPBV8sdnL1yHQxiUSgDu/';
  ...
  constructor(
    ...
    _setDefaultRoyalty(address(0x00aFecab9E6649Bd522309905B7A9d3705f8cC13), 1000);
  }
  ...
  */
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    ///////
    require(numberMinted(msg.sender) + _mintAmount <= MaxPerWallet, 'Max per wallet exceed');
    ////////
