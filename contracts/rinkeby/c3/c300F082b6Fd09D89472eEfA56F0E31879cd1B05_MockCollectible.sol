...
import "./ERC721Lean.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract MockCollectible is ERC721Lean, Ownable {

    constructor() ERC721Lean("MockCollectible", "MOCK") {}

    function mint(uint128 quantity) external onlyOwner {
...
import "./IERC721LeanEnumerable.sol";
...
interface IERC721ConsecutiveTransfer is IERC721 {
  /**
