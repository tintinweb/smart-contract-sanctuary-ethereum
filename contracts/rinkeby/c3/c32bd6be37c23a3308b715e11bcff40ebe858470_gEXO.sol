...
interface IgEXO is IERC20 {
  ...
  function migrate( address _staking, address _sEXO ) external;
}

// File: interfaces/IsEXO.sol
...
contract gEXO is IgEXO, ERC20 {
    ...
    /**
     * @notice pull index from sEXO token
     */
    ...
    /**
        @notice converts gEXO amount to EXO
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts EXO amount to gEXO
        @param _amount uint
        @return uint
     */
