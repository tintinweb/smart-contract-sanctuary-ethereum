...
contract PopCult is ERC721AQueryable, Ownable, Pausable {
  ...
  uint256 public publicEtherCost = 0.01 ether;
  uint256 public publicUSDCCost = 100;

  uint256 public whitelistEtherCost = 0.001 ether;
  uint256 public whitelistUSDCCost = 10;

  bytes32 public whitelistMerkleRoot;
  uint256 public maxWhitelistTokens = 1000;
