...
contract HDMint is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    Counters.Counter private tokenId;

    event Mint(address indexed buyer, uint256 id, string uri);

    constructor() ERC721("HeeraDigital", "HD") {} // solhint-disable-line no-empty-blocks
