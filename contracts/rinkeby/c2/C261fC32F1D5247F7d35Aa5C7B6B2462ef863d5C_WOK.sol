...
contract WOK is Ownable, ERC721A, ReentrancyGuard {
    uint256 public perWalletLimitPublic = 1;
    uint256 public perWalletLimitPresale = 1;

    uint256 public perTxLimitPublic = 1;
