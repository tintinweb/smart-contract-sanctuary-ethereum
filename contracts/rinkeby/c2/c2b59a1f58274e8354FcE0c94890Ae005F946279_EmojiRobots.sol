...
contract EmojiRobots is ERC721Delegated, ReentrancyGuard {
  ...
  address private constant payoutAddress1 =
    0x417e19300536943a5D18c3e1e6aBF7fB3DEAecab;

  address private constant payoutAddress2 =
    0x278E213ae807613168396ddf4B8Ec0c968F12553;

  function withdraw() public nonReentrant {
    uint256 balance = address(this).balance;

    Address.sendValue(payable(_owner()), balance * 30 / 100);
