...
contract CasperPadTokenWhitelisted is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        require(block.timestamp > _launchTime + _lockTime || _isWhiteList(msg.sender), "not availble in lock time");
