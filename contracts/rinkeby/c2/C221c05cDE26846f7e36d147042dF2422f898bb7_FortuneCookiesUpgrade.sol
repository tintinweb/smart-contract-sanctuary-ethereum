...
contract FortuneCookiesUpgrade is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function initialize(
        ...
        __ERC721A_init('FortuneCookiesUpgrade', 'FTCK');
        __Ownable_init();
    ...
    // Upgrade test
    function newTokenURI(uint256 _tokenId) public view returns(string memory) {
        return string.concat(super.tokenURI(_tokenId), ".upgrade");
    }
