	...
	ReentrancyGuard
{
	 ...
	 */
	constructor(string memory __baseURI) ERC721A("FacePress", "FACEPRESS") {
		baseURI = __baseURI;
	}
	 ...
	 * @param _mintAmount amount to mint
	 * @param _merkleProof merkle proof to validate
	 */
	...
	{
		require(isWhitelistSaleOpen, "WHITE_LIST_CLOSED");
	...
	function mint(uint256 _mintAmount)
		...
		mintCompliance(_mintAmount)
	{
		require(isPublicSaleOpen, "SALE_CLOSED");
		_safeMint(_msgSender(), _mintAmount);
	}
