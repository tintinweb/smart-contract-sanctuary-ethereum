...
contract AmvNftStaker is Ownable {
    ...
    enum TimeLock { ZERO_DAY, THIRTY_DAYS, SIXTY_DAYS, NINETY_DAYS }
    ...
    function setMaxInputSize(uint256 _maxInputSize) public onlyOwner {
         ...
         */
        require(_maxInputSize <= allowedMaxInputSize, "Can not set MaxInputSize more than 100");
        /**
    ...
    function unstake(uint256[] calldata tokenIds) external {
        ...
        emit NFTUnstaked(msg.sender, tokenIds, block.timestamp,unStakingEventType); //emiting NFTUnstaked event.
    }
