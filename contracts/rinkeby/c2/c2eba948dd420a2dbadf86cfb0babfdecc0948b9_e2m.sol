...
contract e2m is ERC721Enumerable, Ownable {
  ...
  */
  ...
  function tokenIdForDomain(string memory domainName) external pure returns (uint256) {
  ...
  function mint(string memory domainName) external payable returns (uint256) {
    ...
    require(msg.sender == ens.ownerOf(tokenId),  "You are not the owner of this ENS domain");
