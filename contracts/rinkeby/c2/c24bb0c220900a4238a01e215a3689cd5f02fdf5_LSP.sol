...
contract LSP is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public MAX_NFT = 2000;
	uint256 public MAX_MINT_PRESALE = 50;
    ...
    constructor() ERC721P('LionShare Poker', 'LSP') {}
