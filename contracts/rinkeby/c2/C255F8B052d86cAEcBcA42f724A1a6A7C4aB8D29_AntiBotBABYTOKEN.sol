...
contract AntiBotBABYTOKEN is ERC20Upgradeable, OwnableUpgradeable, IAntiBotBabyToken {
  ...
  uint256 public tokenRewardsFee = 10;
  uint256 public liquidityFee = 2;
  uint256 public marketingFee = 3;
  uint256 public totalFees = 15;

  address public _marketingWalletAddress = 0x101Db50a6c23E9B3942845772008A13837cA67F5;
  ...
  constructor() {
    implementation = address(new BABYTOKENDividendTracker());
	  // __ERC20_init("INFINITYADA V2", "INFINITYADA2");
  }
