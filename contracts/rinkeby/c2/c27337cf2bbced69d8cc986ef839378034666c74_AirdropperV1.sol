...
import { IAirdropperV1 } from "../interfaces/IAirdropperV1.sol";
...
interface IAirdropperV1 {
    ...
    //function hashesBalance() external view returns (uint256);
    //function NFTbounty() external view returns (uint256);

    //function hashesOwnedByAirdropperV1() external view returns (uint256);
