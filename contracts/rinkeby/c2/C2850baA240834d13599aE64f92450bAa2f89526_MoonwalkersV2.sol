...
contract MoonwalkersV2 is ERC721A, Pausable, Ownable, ReentrancyGuard {
  ...
  function setBaseTokenURI(string memory _baseTokenURI) external onlyOwner metadataMutable {
    baseTokenURI = _baseTokenURI;
  }

  /// @dev Sets the base token URI suffix.
  function setExtensionTokenURI(string memory _extensionTokenURI) external onlyOwner metadataMutable {
