...
contract AmeliaSale is Ownable, ReentrancyGuard {
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1544401400;
    uint64 public immutable whitelistEndTime = 1744401700;
    uint64 public immutable publicSaleStartTime = 1544402000;
    uint64 public immutable publicSaleEndTime = 1744402300;
