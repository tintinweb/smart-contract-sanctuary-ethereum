...
contract boobies is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://24DEX1N2W57MM8XKSFAQVDQESI82Y62Z4A";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("boobaes", "BOOB") { }
