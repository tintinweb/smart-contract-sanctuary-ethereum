...
contract PixelSkull is AdminControl, ReentrancyGuard {
    ...
    constructor(address creator, uint256 _price,string[] memory hashes,address[] memory artists) {
        _creator = creator;
         contractData.isActive = true;
         collectionData.price = _price;
         collectionData.editions = 1;
         contractData.APIEndpoint = "ipfs://";
         setNftData(hashes,artists, true);
    }
        ...
        returns (uint256 tokenId)
    {
        ...
        bool sent = tokensData[index].artist.send(valueTransfer);       
        return newItemId;
    }
    ...
    function setNftData(string[] memory _tokensData, address[] memory _artists, bool reset)
        public
        adminRequired
    {
    ...
    function withdraw() public adminRequired nonReentrant {
