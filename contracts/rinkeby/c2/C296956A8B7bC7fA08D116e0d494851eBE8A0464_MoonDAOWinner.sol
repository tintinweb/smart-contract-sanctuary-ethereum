...
contract MoonDAOWinner is Ownable,VRFConsumerBaseV2 {
  ...
  uint public maxLen = 7972;
  uint16 requestConfirmations = 4;
  uint32 numWords =  1;  
  mapping(uint256 => uint256) s_requestIdToRequestIndex;
  mapping(uint256 => uint256) public winnerList;
  ...
  function fulfillRandomWords(
    ...
    uint winner= s_randomWord % maxLen;
    uint256 requestNumber = s_requestIdToRequestIndex[requestId];
    winnerList[requestNumber] = winner;
