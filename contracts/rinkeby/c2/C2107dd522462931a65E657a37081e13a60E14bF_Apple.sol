...
contract Apple is ERC1155Supply, IERC2981, Ownable, Pausable, ReentrancyGuard {
    /// @dev === CONTRACT META ===
    string public name = "Apple Token";
    string public contractURIstr =
        "ipfs://Qmb2cVWGDkRZyNEjJrvRgAn46PPkemL4V748eq9RkBBfyL/";
    ...
    constructor()
        ERC1155(
            "ipfs://QmZnDqcQMdHCALJuNfCjzGQFbLNJLxfkUBPsy4KZksJHWT/{id}.json"
        )
    {}
    ...
    modifier isCorrectAmount(uint256 numberOfTokens) {
        ...
        require(
            balanceOf(msg.sender, 1) + numberOfTokens <= maxPerWallet,
