...
contract LendPoolConfigurator is Initializable, ILendPoolConfigurator {
    ...
    function setLiquidationThresholdNow(uint256 val) external onlyEmergencyAdmin {
        ILendPool cachedPool = _getLendPool();
        cachedPool.setLiquidationThresholdNow(val);
    }
...
library ConfiguratorLogic {
    ...
    function executeInitReserve(
        ...
        cachePool.initReserve(input.underlyingAsset, bTokenProxyAddress, debtTokenProxyAddress, input.interestRateAddress, input.initExchangeRate);
