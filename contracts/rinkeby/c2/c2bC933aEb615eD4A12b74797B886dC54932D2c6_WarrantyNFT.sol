...
contract WarrantyNFT is ERC721 {
    ...
    function returnWarrantyPeriod() public returns (uint256) {
        return trackBuyers[msg.sender].warrantyPeriod;
    }

    function returnWarrantyStart() public returns (uint256) {
        return trackBuyers[msg.sender].startDate;
    }

    function returnWarrantyEnd() public returns (uint256) {
