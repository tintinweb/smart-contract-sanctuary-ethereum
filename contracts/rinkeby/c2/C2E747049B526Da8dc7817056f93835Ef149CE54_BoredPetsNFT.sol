...
import "Ownable.sol";
import {IMarketPalace} from "Marketplace.sol";
...
contract BoredPetsNFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function createCollectible(
        ...
        transferFrom(msg.sender, marketPlace, newTokenId);
        IMarketPalace(marketPlace).listNft(newTokenId, _price, address(this));
...
contract Marketplace is IMarketPalace, ReentrancyGuard, Ownable {
    ...
    // Buy an NFT
    function buyNft(uint256 _tokenId, address _nftContract)
        public
        nonReentrant
    {
