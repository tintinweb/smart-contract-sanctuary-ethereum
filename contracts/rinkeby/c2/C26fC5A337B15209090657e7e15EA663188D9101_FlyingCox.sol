...
contract FlyingCox is ERC721A, Ownable {
    ...
    uint256 private constant maxPerAddress = 10;
    uint256 private constant maxFreePerAddress = 1;

    uint256 public constant publicMintPrice = 0.069 ether;

    uint256 public saleStartDate = 1650639600;
    uint256 public freeStartDate = 1650639600;

    uint256 public freeMintCounter;
    uint256 public whitelistMintCounter;

    string private baseUri =
        "https://gateway.pinata.cloud/ipfs/QmfViVJxRunYCFLH8PP3MRLJbyTGvQiwzJuBUhhGToBEcG/";
    string private baseExtension = ".json";

    constructor(bytes32 hashes) ERC721A("FLYING COX", "COXRIDER") {
