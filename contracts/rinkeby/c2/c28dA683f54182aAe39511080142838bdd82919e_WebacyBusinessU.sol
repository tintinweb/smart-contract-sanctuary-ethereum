...
contract WebacyBusinessU is Initializable, AccessControlUpgradeable {
    ...
    function _hasPaidMembership(address _address) internal view {
    ...
    function _validateERC721SCNotExists(address contractAddress) internal view {
    ...
    function _validateERC20SCNotExists(address contractAddress) internal view {
    ...
    function _validateERC721CollectibleNotYetAssigned(address _contractAddress, uint256 _tokenId) internal view {
    ...
    function _validateTokenBeneficiaryNotExists(address _destinationAddress, address _contractAddress) internal view {
        require(
    ...
    function _validateBackupNotExists(address _backupAddress) internal view {
        require(backupWalletToMember[_backupAddress] == address(0), "Backup already exists");
    }

    function _validateERC20SCExists(address _contractAddress, address _owner) internal view {
    ...
    function _validateERC721SCExists(address _contractAddress, address _owner) internal view {
    ...
    function calculatePercentage(uint256 _amount, uint256 _fee) public pure returns (uint256) {
        _validateBasisPoints(_fee);
        return (_amount * _fee) / 100;
    }

    function _validateBasisPoints(uint256 _transferFee) internal pure {
