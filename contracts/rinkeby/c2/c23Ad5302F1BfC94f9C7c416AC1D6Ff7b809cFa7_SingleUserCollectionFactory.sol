...
/*   constructor (address _implementationContract) {
  ...
  function createSingleUserCollectionProxy(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) external returns (address) {
    ...
    SingleUserCollection(clone).initialize(name, symbol, contractURI, tokenURIPrefix, msg.sender);
    return clone;
  }
...
contract SingleUserCollection is Initializable, SingleCollection {
    ...
    function initialize(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address owner) public virtual initializer {
