...
//
//               __                             _           __ 
//   _________ _/ /______   ____  _________    (_)__  _____/ /_
//  / ___/ __ `/ __/ ___/  / __ \/ ___/ __ \  / / _ \/ ___/ __/
// / /__/ /_/ / /_(__  )  / /_/ / /  / /_/ / / /  __/ /__/ /_  
// \___/\__,_/\__/____/  / .___/_/   \____/_/ /\___/\___/\__/  
//                      /_/              /___/                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x08Da819c47Dd9d08D01E13940619d01400099589];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x08Da819c47Dd9d08D01E13940619d01400099589;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmewtAbfNV2KBzVpXL617vwNFe4eRaKvagdfc5QfbuvjzL/";
...
// File: contracts/CatsprojectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CatsprojectContract is RamppERC721A {
    constructor() RamppERC721A("cats project", "cats"){}
}
