...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE59072C5084eC2dc16E6BcDC3560802FFBafb5Cb];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmZGeqiPVPahDzfpVHSVmEbZAKgHWECrCXMghioujW5idj/";
...
// File: contracts/X10KuptestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X10KuptestContract is RamppERC721A {
    constructor() RamppERC721A("10K up test", "10k up"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/BBEXShs5ytagOvPigg58/contract-metadata";
    }
}
