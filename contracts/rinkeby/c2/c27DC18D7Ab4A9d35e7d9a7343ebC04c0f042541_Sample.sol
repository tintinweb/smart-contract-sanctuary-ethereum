...
contract Sample is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("Sample", "SAMPLE", 11, 10000) {}
    ...
    function getAllowListPrice(uint256 offset) public view returns(uint256){
        if (1001 - amountForAllowList - offset < 1){
            return 0.000000 ether;
        }
        return 0.020000 ether;
    }
    ...
    function getPuiblicSalePrice(uint256 offset) public view returns(uint256){
        if (1042 - amountForAllowList - offset < 1){
            return 0.000000 ether;
        }
        return 0.050000 ether;
    }
    ...
    // auction
    uint256 public amountForAuction = 111;
    uint256 public constant AUCTION_START_PRICE = 100.000000 ether;
    uint256 public constant AUCTION_END_PRICE = 0.000000 ether;
    uint256 public constant AUCTION_PRICE_CURVE_LENGTH = 100 minutes;
    ...
    uint256 public immutable auctionPerMint = 11;
