...
contract TheLostMeeble is ERC721A("The Lost Meeeeeeeble", "Meeble"), Ownable, ReentrancyGuard{
    ...
    function WhitelistFindMeeble(bytes32[] calldata _merkleProof) external nonReentrant {
        require(whitelistMintEnabled, "The meeble creatures is not ready to be found");
    ...
    function FindMeeble( uint256 _qty ) external payable nonReentrant {
        ...
        if (_FreeCount < TotalFreeMeeble && !whitelistClaimed[_msgSender()]){
  ...
  /*  function tokenURI(uint256 _tokenId)
    ...
    function WLstartfinding  () external onlyOwner {
