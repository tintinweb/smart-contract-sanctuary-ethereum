...
contract VexiDNA {
    ...
    // pure: No cuestan gas (solo retorno de datos)
        ...
        returns (uint256)
    {
        ...
        // keccak256 deterministic function / hash dificil de resolver de forma inversa
...
// File contracts/Vexi.sol


pragma solidity ^0.8.0;
contract Vexi is ERC721, ERC721Enumerable, VexiDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("Vexi", "PLPKS") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No Vexi NFT left :(");
