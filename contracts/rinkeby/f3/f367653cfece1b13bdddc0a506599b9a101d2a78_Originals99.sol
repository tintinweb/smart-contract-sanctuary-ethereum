...
contract Originals99 is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    uint256 private constant DURATION = 15 minutes;
    uint256 private constant DURATION_EXTENSION = 5 minutes;
    uint256 private constant DURATION_EXTENSION_ALLOWED_BEFORE_END = 5 minutes;
    ...
    // withdraw addresses
    address private constant FUNDS_RECEIVER_50 = 0x80C8e129A4Bb8B86837ED4935DB5720d63DcF987; // DAO wallet
    ...
    event AuctionBidPlaced(uint256 tokenId, address bidder, uint256 amount, uint256 endTime);
    event AuctionFinalized(uint256 tokenId, address winner);

    // ============ Methods ============

    constructor(address royaltiesReceiver, string memory baseURI_)
        ERC721("99 Originals", "99ORIG")
    {
        _setDefaultRoyalty(royaltiesReceiver, ROYALTIES_BPS);
        baseURI = baseURI_;
    }
    ...
    function finalizeAuction() external {
        require(auctionedTokenId != 0, "No Active Auction");
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 split1 = (address(this).balance / 100) * 50;
        uint256 split2 = (address(this).balance / 100) * 45;
        ...
        (bool success3, ) = FUNDS_RECEIVER_5.call{value: address(this).balance}("");
