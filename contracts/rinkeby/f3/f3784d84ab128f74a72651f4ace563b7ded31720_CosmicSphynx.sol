...
// File: contracts/CosmicSphynxLowGas.sol
...
contract CosmicSphynx is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cosmic Sphynx", "CSC") {
    setHiddenMetadataUri("ipfs://QmPzNwn9BWFfRiY5BRra9JDDzPkU6rYRTgzbaCz4QsM4g5/hidden.json");
  }
