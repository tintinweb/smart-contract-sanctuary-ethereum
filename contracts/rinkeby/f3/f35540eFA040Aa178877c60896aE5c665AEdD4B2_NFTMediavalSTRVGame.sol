...
contract NFTMediavalSTRVGame is BurningContract, Ownable, VRFConsumerBase {
    ...
    external returns (bool) {
        ...
        require(0 <= _gearToBurn && _gearToBurn < mintedTotal.length, "Gear to burn does not exists!");
        require(0 <= _gearToMint && _gearToMint < mintedTotal.length, "Gear to mint does not exists!");
