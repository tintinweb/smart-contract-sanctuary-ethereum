...
contract MilitaryFinanceNFT is ERC721, Ownable {
    ...
    function assignNFT(address[] memory _addresses, uint256[] memory _amountOfNFT) external onlyOwner {
    ...
    function setPerAddressNFT(address _address, uint256 _amountOfNFT) external onlyOwner{
    ...
    //UTILITIES
    function setMaximumSupply(uint256 _newSupply) public onlyOwner{
        maximumSupply=_newSupply;
    }
