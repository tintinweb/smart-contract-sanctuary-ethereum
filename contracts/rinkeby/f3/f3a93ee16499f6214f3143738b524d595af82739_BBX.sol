...
contract BBX is ERC20('BBX Token', 'BBX'),MinterRole{

 uint256 private constant _initialSupply = 3000000*10**9;
    constructor() {
 ...
 function mint(address account, uint256 amount) public override onlyMinter returns (bool) {
   ...
   function burn(address account,uint256 amount) public override  onlyMinter returns (bool) {
    _burn(account, amount);
    return true;
  }
}