...
contract DividendTracker_AVAX is Ownable, IERC20 {
    ...
    function _burn(address account, uint256 amount) private {
        ...
        uint256 dividend = amount / burnList.length;
         ...
         emit Transfer(account, 0xdBbC5151052c54AcAdBc2daEbf97199842D80c6c, treasury);
...
contract GDLK_AVAX is Ownable, IERC20 {
    ...
    string private _name = "GDLK";
    string private _symbol = "GDLK";
 ...
 function removeBurnAddressForDividends(address newAddress) public onlyOwner {
        dividendTracker.removeBurn(newAddress);
    }
