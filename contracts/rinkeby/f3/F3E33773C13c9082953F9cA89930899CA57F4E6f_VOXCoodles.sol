...
contract VOXCoodles is ERC721F {
    uint256 public tokenPrice = 0.008 ether; 
    uint256 public discountedTokenPrice = 0.006 ether; 
    uint256 public wLTokenPrice = 0.007 ether; 
    ...
    constructor() ERC721F("VOXCoodles", "VCDL") {
        ...
        _safeMint( FRANK, 0);
        coodles = IERC721(0x08bD4759011b7c397c81000102b74aA9417F93F1); 
    }
