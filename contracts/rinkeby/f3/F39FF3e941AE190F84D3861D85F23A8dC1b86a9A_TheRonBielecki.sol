...
contract TheRonBielecki is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    string namecontract = "TheRonBielecki";
    
    // Symbol of the NFT contract.
    string symboltoken = "TDC";
    string tokenname = "The Ron Bielecki Tornado Card";
    // The maximum number of tokens that can be minted in this collection.
    uint256 maxSupply = 5000;
    // Minting price per token.
    uint256 mintonePrice = 0.25 ether;
    uint256 minttwoPrice = 0.25 ether;
    uint256 mintfreePrice = 0.25 ether;
     // The maximum number of tokens the user can mint per transaction.
    uint256 tokensPerMint = 10;
    ...
    address public treasuryAddress = 0x7b36008476f3289F23E9840206a0671Eb13627D3;
    ...
    uint256 royaltiesBps = 1000;
    // Address for royalties
    address royaltiesAddress = 0x7b36008476f3289F23E9840206a0671Eb13627D3;
    ...
    constructor() ERC721(tokenname, symboltoken) {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafkreigi5suvqc3tp375sm3gnvikw5onlkrf34zsliqazyd33jtqa76p6u#";
    }
    ...
    function _mintTokens(address to, uint256 amount) internal {
     require(amount <= tokensPerMint, "Amount too large");
        ...
        uint256 mintprises;
       if(Supply <= 750) {
       mintprises =  mintonePrice;
       }
       if(Supply > 750) {
       mintprises =  minttwoPrice;
       }
       if(Supply > 2500) {
       mintprises = mintfreePrice;
       }

        require(
            msg.value >= amount * mintprises,
            "Payment too small"
        );
    ...
    royaltyAmount =
    (royaltiesBps * salePrice) /
    ROYALTIES_BASIS;
    }


    function oneprice() public view returns (uint256) {
        return mintonePrice;
    }
    ...
    function freeprice() public view returns (uint256) {
    return mintfreePrice;
    }

    function _receiver() public view returns (address) {
    return treasuryAddress;
    }

    function alsups() public view returns (uint256) {
    return Supply;
    }
