...
contract BustersSale is Ownable, ReentrancyGuard {
    ...
    uint256 public whiteListSaleStartTime = 1660204800; // 8/11 4pm
    uint256 public whiteListSaleEndTime = 1660320000; // 8/12 23:59pm
    uint256 public maxPurchaseQuantityPerTx = 5;
