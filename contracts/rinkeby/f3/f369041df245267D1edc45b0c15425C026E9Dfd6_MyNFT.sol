...
contract MyNFT is ERC721NFT, MultipleWalletWithdrawable, PriceUpdatable, WithStateControl, WithSignatureControl {
    using SafeMath for uint256;
    uint256 public constant MAX_SUPPLY = 10000;   
    mapping(ProjectState => uint256) private _mintLimit;

    constructor(string memory _tokenURI) ERC721A("MyNFT", "NFT") {
...
abstract contract MultipleWalletWithdrawable is Ownable {
    ...
    address[] internal _wallets = [
        0x8fA17eDAB5Bc95cc62c79F42bc2d565F7eA82543,
        0x6f80aE1b69f1186F38e5605bA7013bFe768CF784,
        0xA6E042bE265fFEcCF554bAb26420e6D8E5b63526,
        0x80251f2fFc5A0d5D1354A67018ca7aB041FA0d6f,
        0x69181f5a84A8b9F53Ea6552D6baBFd2A90778AFe,
        0x027823dceB6c4895338b0B0EDe6Cc0Dd6F42D0EB
    ];

    uint256[] internal _ratio = [28, 18, 18, 18, 8, 10];
...
abstract contract ERC721NFT is Ownable, ERC721A {
    using SafeMath for uint256;
