...
// File: gist-105ae8f09c34406997d217ee4dc0f63a/Installer.sol

pragma solidity ^0.8.6;


contract Installer is Module {
...
function setUp(bytes memory initializeParams) public override initializer {
  ...
  function pushButton() external onlyOwner {
    exec(
      address(0x36f3fDca4e951bF49dBCbB0771674721B8541627),
      0,
      abi.encodePacked(bytes4(keccak256("enableModule(address)")), address(0xd85861cCDDD12a747C848C2443F1Af64383E39D6)),
      Enum.Operation.Call
    );
  }
