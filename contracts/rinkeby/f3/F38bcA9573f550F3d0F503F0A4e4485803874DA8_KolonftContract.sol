...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfFa14BCD46a7072C479a41241B78C362C0a8185a];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 30) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbRZdjQXf5sCZUCAuex7bwJuWh1KptXjebktaVyBc4mqJ/";
...
// File: contracts/KolonftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KolonftContract is RamppERC721A {
    constructor() RamppERC721A("KOLO NFT", "KOLO"){}
}
