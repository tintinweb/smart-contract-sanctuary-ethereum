...
// File: contracts/ManicPixieDreamGirlsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ManicPixieDreamGirlsContract is RamppERC721A {
    constructor() RamppERC721A("Manic Pixie Dream Girls", "MPDG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/LkARofa2IFdKMnezTXg1/contract-metadata";
    }
}
