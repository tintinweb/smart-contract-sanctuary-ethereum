...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x372961e1f5c2b05Af64B2b216DB1A2491798c30C];
...
// File: contracts/MasterKeySeasideContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MasterKeySeasideContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Master Key SEASIDE";
    string public symbol = "MKSEA";
