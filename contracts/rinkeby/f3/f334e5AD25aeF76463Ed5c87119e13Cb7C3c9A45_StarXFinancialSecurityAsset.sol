...
contract StarXFinancialSecurityAsset is ERC1155Burnable {
    ...
    struct AssetInfo {
        bool isListed;
        address creator;
        StarXSecurityLib.AssetType assetType;
        uint256 supply;
    ...
    constructor(
        ...
        m_currentCustodyWallet = _custodyWallet;
    }
    ...
    // TODO: fn doc
    function listAsset(StarXSecurityLib.ListAssetRequest calldata _req)
        external
        modIsCelebDeployer
...
interface IStarXCelebrity is IERC165 {
    ...
    function mintNewSecurity(
        ...
        StarXSecurityLib.ListAssetRequest memory _req
