    ...
    Signature
{
    ...
    constructor(bool isPaying, uint256 deploymentPrice) ERC721A("gobby cats", "GC") payable {
        if(isPaying){
...
contract Signature is Ownable {
    ...
    bytes32 private immutable NAME = keccak256("gobby cats");
