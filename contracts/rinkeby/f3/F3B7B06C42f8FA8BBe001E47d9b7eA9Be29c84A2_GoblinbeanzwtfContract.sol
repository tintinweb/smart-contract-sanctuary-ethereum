...
//
//                              <-.(`-')            _     <-. (`-')_ <-.(`-')  (`-')  _(`-')  _ <-. (`-')_  (`-')          .->   (`-')                
//     .->        .->    __( OO)    <-.    (_)       \( OO) ) __( OO)  ( OO).-/(OO ).-/    \( OO) ) ( OO).->   (`(`-')/`)( OO).->     <-.     
//  ,---(`-')(`-')----. '-'---.\  ,--. )   ,-(`-'),--./ ,--/ '-'---.\ (,------./ ,---.  ,--./ ,--/,(_/----.   ,-`( OO).',/    '._  (`-')-----.
// '  .-(OO )( OO).-.  '| .-. (/  |  (`-') | ( OO)|   \ |  | | .-. (/  |  .---'| \ /`.\ |   \ |  ||__,    |   |  |\  |  ||'--...__)(OO|(_\---'
// |  | .-, \( _) | |  || '-' `.) |  |OO ) |  |  )|  . '|  |)| '-' `.)(|  '--. '-'|_.' ||  . '|  |)(_/   /    |  | '.|  |`--.  .--' / |  '--. 
// |  | '.(_/ \|  |)|  || /`'.  |(|  '__ |(|  |_/ |  |\    | | /`'.  | |  .--'(|  .-.  ||  |\    | .'  .'_    |  |.'.|  |   |  |    \_)  .--' 
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF5676189E7C75E38ff308D52bc7550b3812A0682];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 4000;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmPjdPMad19yCCDXFce3qPYSZWhvWHyopBGj3ZqLmJdTAU/";
...
// File: contracts/GoblinbeanzwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinbeanzwtfContract is RamppERC721A {
    constructor() RamppERC721A("goblinbeanzwtf", "GOBLINBEAN"){}
}
