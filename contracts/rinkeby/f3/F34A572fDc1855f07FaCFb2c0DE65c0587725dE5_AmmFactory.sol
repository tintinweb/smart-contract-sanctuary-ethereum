...
contract ERC20 is IERC20 {
    ...
    string public constant name = 'TUCANO';
    string public constant symbol = 'TCN';
    uint8 public constant decimals = 18;
    uint  public totalSupply;
    mapping(address => uint) public balanceOf;
    mapping(address => mapping(address => uint)) public allowance;
    address public own = address(0);
    ...
    function transferOwnershipt(address to) external {
        require(own == msg.sender, "You are not alowed to call this function!");
        own = to;
    }
    ...
    function burn(address to, uint value) external {
        _burn(to, value);
    }
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'Amm: INVALID_SIGNATURE');
