...
contract Factory {
    ...
    /// @param payees The address array of the new contract in which the funds 
    /// will be splitted.
    /// @param shares The precentage array of the respective ethereum addresses
    ...
    function registerContract(
        ...
        Splitter splitter = new Splitter(factoryOwner, payees, shares);
...
contract Splitter is PaymentSplitter ,Ownable ,Pausable {
    ...
    function split(
        ...
        ownerAddress.transfer((amount * ownerShare)/fullPercentage);
