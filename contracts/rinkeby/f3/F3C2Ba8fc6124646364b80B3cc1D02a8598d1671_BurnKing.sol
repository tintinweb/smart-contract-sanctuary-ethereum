...
contract BurnKing is ERC721Enumerable, Ownable {
    ...
    uint16 private DEADLINE_TIME = 1200;
    ...
    mapping (Pools => uint256) poolTypeToLimit;
   ...
   constructor(address _publicKey)ERC721("Burn King", "BK"){
    ...
    function transferNftFromPool(address _burner, Pools _poolType) internal {
     ...
     function burnEther(uint256 _usdCost, uint8 _poolType) external payable{
      ...
      emit BurnedEther(msg.sender, _usdCost, Pools(_poolType), 0);
     }
