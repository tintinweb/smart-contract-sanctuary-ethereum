...
contract ElderApez is ERC721("Elder Apez", "ELDER"), ERC721Enumerable, Ownable {
    ...
    ERC20 public ScrapV1 = ERC20(address(0)); //These will be hard coded on the deployed contract. Just placeholder for now
    IScrapV2 public ScrapV2 = IScrapV2(address(0));
    ERC721 public DystoApez = ERC721(address(0));
    ...
    function adminMint(uint256 amount) external onlyOwner {
        require (reservedSupply + amount <= MAX_SUPPLY, "Max supply exceeded");
    ...
    function reservedTokenOfOwnerByIndex(address user, uint256 index) public view returns (uint256) { //Change
    ...
    function reserveElderWL(uint256[] calldata tokenIds, bytes32[] calldata _merkleProof) public payable { //Change
        ...
        require(msg.value >= MINT_PRICE*reserveAmount, "Not enough ETH to complete this transaction");
        require((reservedSupply + reserveAmount) <= MAX_SUPPLY, "Max reserve supply exceeded");
    ...
    function reserveElderPublic(uint256[5] calldata tokenIds) public payable {
        ...
        require(msg.value >= MINT_PRICE, "Not enough ETH to complete this transaction");
        require(reservedSupply < MAX_SUPPLY, "Max reserve supply exceeded");
    ...
    function claimElderApe(uint256 tokenId) public {
        ...
        require(reserveAddress[tokenId] == msg.sender, "Address did not reserve this Elder Ape");
        require(totalSupply() < MAX_SUPPLY, "Max mint supply exceeded");
    ...
    function claimScrap() public {
        ...
        require(staked[msg.sender].length > 0, "Dysto Apez are no longer staked");
