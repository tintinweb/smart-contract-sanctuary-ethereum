...
contract NowlyCollection is ERC721, Ownable {
    ...
    /**
        ...
        *   @return string The URI origin to where to take the NFTs metadata.
        */
        ...
        returns (string memory) 
    {
        if(!isRevealed(tokenId)) {
            ...
            return string("https://ipfs.moralis.io:2053/ipfs/QmS6r8CF8PpbZZMKuwepaWM13Sv9NUfb891mjaES8RkqB3/metadata/avatar.json");
        }
    ...
    /**
        ...
        *   @notice Can only be executed by the Owner or an Authorized Address.
        */
    function setReveal(uint256 tokenId, bool _reveal)
        public
        onlyOwnerOrAuthorized
    {
