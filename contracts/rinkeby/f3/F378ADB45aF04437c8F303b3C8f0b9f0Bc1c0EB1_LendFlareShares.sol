...
// File contracts/LendFlareShares.sol
...
contract LendFlareShares is ReentrancyGuard {
    ...
    constructor(address _operator, address _token) public {
        operator = _operator;
        token = _token;
    }
    ...
    function addPartner(address _user, uint256 _amount) public nonReentrant {
    ...
    function addToken(uint256 _rewards) public nonReentrant {
        require(msg.sender == operator, "!authorized");
