...
contract TycoonLand is Ownable, ERC721A, ReentrancyGuard {
    using SafeMath for uint256;

    uint256 public immutable collectionSize = 10000;
    uint256 public immutable amountForDevs = 100;

    uint256 public allowlistPrice = 0.10 ether;
    uint256 public publicPrice = 0.12 ether;
    bytes32 public merkleRoot;
    bool public publicSaleIsOpen = true;
    bool public allowlistMintIsOpen = true;
