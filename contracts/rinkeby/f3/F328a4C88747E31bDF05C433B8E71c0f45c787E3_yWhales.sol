...
contract yWhales is ContextMixin, ERC721Enumerable, Ownable {
    ...
    struct Whale { 
      ...
      uint256 unsoldQty; 
      uint price; // in wei PRICE = 0.2ETH
      uint256 whaleId;
      bool transferable;
      bool saleable;
   }
    ...
    constructor() 
        ...
        addWhale('The Nick', 50, PRICE, true, true);
        addWhale('FOMO', 50, PRICE, true, true);
        addWhale('Stephan', 50, PRICE, true, true);
        addWhale('Gummy', 5, PRICE, true, true);
        addWhale('Archie', 50, PRICE, true, true);
        addWhale('Tupac', 5, PRICE, true, true);
        addWhale('Bombay', 50, PRICE, true, true);
        addWhale('Rare Pepe', 25, PRICE, true, true);
        addWhale('The Rock', 50, PRICE, true, true);
        addWhale('Ruby', 50, PRICE, true, true);
        addWhale('Krug Rose', 50, PRICE, true, true);
        addWhale('Lemon Drop', 50, PRICE, true, true);
        addWhale('Chilli', 50, PRICE, true, true);
        addWhale('Nehi', 50, PRICE, true, true);
        addWhale('Rick', 50, PRICE, true, true);
        addWhale('Solana', 50, PRICE, true, true);
        addWhale('DeFi', 50, PRICE, true, true);
        addWhale('Oz', 50, PRICE, true, true);
        addWhale('Fendi', 50, PRICE, true, true);
        addWhale('Hermes', 50, PRICE, true, true);
        addWhale('Dolce', 50, PRICE, true, true);
        addWhale('Bvlgari', 50, PRICE, true, true);
        addWhale('DeFi Degen', 50, PRICE, true, true);
        addWhale('Angra', 50, PRICE, true, true);
        addWhale('The 68', 50, PRICE, true, true);
        addWhale('Tamarillo', 50, PRICE, true, true);
        addWhale('Barbara', 50, PRICE, true, true);
        addWhale('David', 25, PRICE, true, true);
        addWhale('Penny', 50, PRICE, true, true);
        addWhale('Yin', 50, PRICE, true, true);
        addWhale('Yang', 50, PRICE, true, true);
        addWhale('Labyrinth', 50, PRICE, true, true);
        addWhale('Bling', 50, PRICE, true, true);
        addWhale('Mordor', 50, PRICE, true, true);
        addWhale('Krakatoa', 50, PRICE, true, true);
        addWhale('Topaz', 50, PRICE, true, true);
        addWhale('Kat', 1, 1 ether, true, true);
        addWhale('Cassia', 50, PRICE, true, true);
        addWhale('Euro', 50, PRICE, true, true);
        addWhale('Iridium', 50, PRICE, true, true);
        addWhale('Obsidian', 50, PRICE, true, true);
        addWhale('Blue Check', 50, PRICE, true, true);
        addWhale('Agean', 50, PRICE, true, true);
        addWhale('Barney', 50, PRICE, true, true);
        addWhale('Graphine', 50, PRICE, true, true);
        addWhale('Honey Baked', 50, PRICE, true, true);
        addWhale('The Thing', 50, PRICE, true, true);
        addWhale('The J', 50, PRICE, true, true);
        addWhale('Stealth', 50, PRICE, true, true);
        addWhale('Chewy', 50, PRICE, true, true);
        addWhale('Purple Haze', 50, PRICE, true, true);
        addWhale('Fruity Pebbles', 50, PRICE, true, true);
        addWhale('The Man', 50, PRICE, true, true);
        addWhale('The Yeti', 50, PRICE, true, true);
        addWhale('Oasis', 50, PRICE, true, true);
        addWhale('Oasis', 50, PRICE, true, true);
        addWhale('People Eater', 100, PRICE, true, false);
        addWhale('Burt', 100, PRICE, true, false);
        addWhale('Titan', 100, PRICE, true, false);
        addWhale('Rosey', 100, PRICE, true, false);
        addWhale('Dreamsicle', 100, PRICE, true, false);
        addWhale('Brunnera', 100, PRICE, true, false);
        addWhale('Hypatia', 100, PRICE, true, false);
    }
