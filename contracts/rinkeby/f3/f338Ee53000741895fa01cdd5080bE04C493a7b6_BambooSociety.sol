...
//                                            _,                                  
//
//                ,[email protected]@BBBgg,             ,[email protected][email protected]$,g        ,ggggpgg,_              
//
//            [email protected]@@@@@@@@@[email protected],    _,,[email protected]*  @@*]@@,_   [email protected][email protected]@@@@@[email protected]            
//
...
//           @@@@@@@@@@@@||'                                  %@@@@@@@@@          
//
//          "@@@@@@@@@P|F                                     "[email protected]@@@@@P          
//
//           "[email protected]@@@@@L|L                                        [email protected]@@P            
//
//              "[email protected]@@P|l             ,ggg,            ,,,,       '@`              
//
//                 ]@||             ,@@@@@@g        [email protected]@@@@b,      ]K              
//
...
//                ]@||L       ]@@@@@@@@@@@C         ]@@@@@@@@@-  ]@              
//
//                  @||l        %@@@@@@@@P-            "[email protected]@@@@C   ]@              
//
//                  [email protected]|L         "***"`       ,,ggg]g           ]@@              
//
//                  ]@@@|l,                    "[email protected]@@@"]         [email protected]               
//
//                   ""%@|gl,            ]        $-   P      [email protected]@@                
//
//                      ]@@[email protected],_         "*NmNN*".&*M"    [email protected]^ "                 
//
//                        P  "[email protected]@gL=,_               _,,[email protected]@P"                     
//
...
// File: contracts/BambooSociety.sol
...
contract BambooSociety is Ownable, ERC721A, ReentrancyGuard {

    //allows for 10 tokens to be minted for giveaways etc before pre and public sale
    uint256 public MAX_TEAM_RESERVES_PRESALE = 10;
    //allows for 150 tokens to be minted for giveaways etc after public sale
    uint256 public MAX_TEAM_RESERVES_POSTSALE = 140;
    //sets immutable value for total collection of 10k
    uint256 public immutable MAX_TOKENS;
    //sets immutable value for total presale reserved + presale + public = 9860 leaving 140 for postsale reserved
    uint256 public immutable MAX_PUBLIC_TOKENS;
    ...
    uint256 collectionSize_,
    uint256 maxTOKENS_,
    uint256 maxPUBLICTOKENS_
  ) ERC721A("BambooSociety","PANDA", maxBatchSize_,collectionSize_) {
    MAX_MINTS_PER_TX = maxBatchSize_;
    MAX_TOKENS = maxTOKENS_;
    MAX_PUBLIC_TOKENS = maxPUBLICTOKENS_;
    require(
    ...
    returns (TokenOwnership memory)
  {
    ...
    function withdrawMoney(uint256 amount) public payable onlyOwner nonReentrant {
        uint256 percent = amount / 100;
        // 50% Split evenly between 2 wallets
        require(payable(0x72c3CDf23d3749c66F7313062f3369a243390B71).send(percent * 50));
        require(payable(0x36b78c9EC503A402d2eE6abEF2266fcA0D484709).send(percent * 50));
    }
