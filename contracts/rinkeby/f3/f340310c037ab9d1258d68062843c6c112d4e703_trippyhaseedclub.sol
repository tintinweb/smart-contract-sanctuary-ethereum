...
contract trippyhaseedclub is Ownable, ERC721 {
    
    uint public tokenPrice = 10 ether;
    uint constant maxSupply = 112;
    uint public presale_price = 10 ether;
    ...
    constructor() ERC721("Trippy Haseed Club", "THC"){}
...
//this is buy presale function
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x90F470af71f41557252c6aF4f0E859B80203bDC6).transfer(_balance * 90 / 100); 
        payable(0x4AdE8BdBB4284D70c509700E16ABD637dfE65b92).transfer(_balance * 10 / 100); 
    }
