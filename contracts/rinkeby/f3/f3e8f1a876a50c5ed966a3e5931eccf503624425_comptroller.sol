...
contract NFT is PATRICIA, Ownable {
    ...
    uint256 constant public _MAX_TOKEN = 20;

    constructor() PATRICIA("Wrong 01", "w0w", 0x5c6B0f7Bf3E7ce046039Bd8FABdfD3f9F5021678)
    {
...
contract comptroller is NFT {
    ...
    uint256 public constant _PRICE = 5   *1e15;
    uint256 public constant _WHITE_PRICE = 1  *1e15;

    uint256 private _threshold = 20 * 1e18;
    address private immutable contributor;
    address private constant contributor2 = 0x17F6AD8Ef982297579C203069C1DbfFE4348c372;
    address private constant Asigner = 0x1234c3B62f46099EF3579CBFAa9E263DfB6Bf4A4;
    ...
    function regular() external payable {
        require(isOpen, "Closed");
        require(msg.value >= _PRICE, "Insufficient");
        _mintTo(msg.sender);
    }
