...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC1D3C5f9dA37108b9AfcE06e7aaA1D416C5A2Dd8];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVVfj4CEZJzhc7Je9YGPNDvTWWz6sLLjapZLdUPNhpL1t/";
...
// File: contracts/AlienusContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlienusContract is RamppERC721A {
    constructor() RamppERC721A("Alienus", "ALIEN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Fhzmdbmde0TPFjTMUmAY/contract-metadata";
    }
}
