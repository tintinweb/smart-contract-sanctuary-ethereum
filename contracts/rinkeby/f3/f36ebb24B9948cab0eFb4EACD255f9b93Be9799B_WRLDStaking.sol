...
import "./WRLDToken.sol";
import "./WRLDHorses.sol"; //tempory (hardhat test)
...
contract WRLDStaking is Ownable, IERC721Receiver {
    ...
    constructor(WorldHorses _nft, WRLDToken _token) {
        nft = _nft;
        token = _token;
    }
...
contract WRLDToken is ERC20, ERC20Burnable, Ownable {
