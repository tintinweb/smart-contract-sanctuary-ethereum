...
contract IPNft is ERC721, Ownable {
    ...
    constructor(
        ...
        int256 highValue
    ) ERC721("Dynamic IP NFT", "IPNFT") {
        s_tokenCounter = 0;
        s_lowImageURI = svgToImageURI(lowSvg);
        s_highImageURI = svgToImageURI(highSvg);

        //This dictates if clinical trial was successful
    ...
    /**
        overide ERC721 tokenURI function --need to encode JSON object into Base64 encoding
     */
    function tokenURI(
        uint256 /* tokenId */
