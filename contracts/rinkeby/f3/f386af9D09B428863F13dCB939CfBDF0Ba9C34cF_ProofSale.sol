...
contract ProofSale is Ownable, Context {
    ...
    constructor(
        ...
        uint256 amount = _token.totalSupply();
        _token.mint(msg.sender, amount);
    }

    function createTokenContract() internal returns (RECOT) {
        return new RECOT();
    }
    ...
    function buyTokens(address beneficiary) public payable {
        require(beneficiary != address(0), "Sale: Wallet is the zero address");
