...
contract ljbcfoo is ERC721A, ERC721ABurnable, ERC2981, Ownable {
    ...
    string public unrevealedMetadataURI;
    ...
    function devMint(uint256 _amount, address _toAddress) external onlyOwner {
        require(_totalMinted() + _amount <= collectionSize, "Quantity exceeds remaining mints");
    ...
    function setUnrevealedMetadataURI(string calldata _unrevealedMetadataURI) external onlyOwner {
        unrevealedMetadataURI = _unrevealedMetadataURI;
    }
    ...
    modifier mintAllowed(uint256 _amount) {
        ...
        require(
            _totalMinted() + _amount <= collectionSize - amountForDevs + _mintedByDevs,
            "Quantity exceeds remaining mints"
        );
        _;
     }
    // INTERNAL
