...
contract PBCitems is AbstractERC1155Factory  {
    ...
    ********************************************************************************/
    ...
    function purchasEarlyAccess(uint256 collectionId, uint256 amount, bytes32[] calldata merkleProof) external payable {
    ...
    ********************************************************************************/
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked(uri, "contract"));
    }
     */
