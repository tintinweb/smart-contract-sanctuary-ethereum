...
contract Moondles is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0 ether;
    uint256 public maxSupply = 7777;
    uint256 public maxFree = 1777;
    ...
    constructor() ERC721A("Moondles", "MDLS") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max Moondles per address exceeded");
		require(_mintAmount > 0, "Cannot mint 0 Moondles" );
		require(s + _mintAmount <= maxFree, "Cannot exceed Moondles supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cannot mint 0 Moondles");
        require(_mintAmount <= maxperAddressPublicMint, "Cannot mint more Moondles" );
        require(s + _mintAmount <= maxSupply, "Cannot exceed Moondles supply");
        ...
        onlyOwner
    {
        ...
        require(s + totalQuantity <= maxSupply, "Too many Moondles");
