...
contract Gh0stlyGh0sts is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("cc0Horses", "C0H") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "C0H: Max 2 NFTs per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_ETHEREUM, "C0H: Mint exceeds supply");
