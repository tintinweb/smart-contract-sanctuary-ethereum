...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    string baseUri = "ipfs://QmbYkqXCRU7dC4chmJXwcnHSXaE2b2WasFPQzeVB1HRyqy/";

    // metadata api before reveal
    string notRevealedUri = "ipfs://QmbYkqXCRU7dC4chmJXwcnHSXaE2b2WasFPQzeVB1HRyqy/unknown"; 
 ...
 contract WolfLady is ERC721, Ownable{
    IERC721 public token;

    uint256 public totalSupply = 0; // Total Minted Supply
    uint256 private constant totalSale = 10000; // total NFTs
    uint256 public constant reserved = 1000;  //  reserved for admin
    ...
    constructor(address _token) ERC721("WolfLady", "WL"){
