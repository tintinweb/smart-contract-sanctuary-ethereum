...
contract VimptoWorlds is Ownable, ERC721, ReentrancyGuard ,VerifySignature{
    ...
    function mintWorld(uint256 _price, MintPayload calldata _payload, bytes memory _signature) public nonReentrant returns (uint256)  {

        require(mintSupply > _tokenIds.current(), "All 10,000 NFT's have been minted.");
        require(_price == mintPrice, "Mint price incorrect");
