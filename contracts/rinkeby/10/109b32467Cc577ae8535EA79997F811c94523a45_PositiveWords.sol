...
// @title:  10000 POSITIVE WORDS
// @desc:   10000 POSITIVE, UPLIFTING AND MOTIVATING WORDS TO MAKE YOUR DAY
...
contract PositiveWords is ERC721, Ownable, ReentrancyGuard {
    ...
    string private unrevealedTokenURI = "ipfs://QmU92DbVwjsqz3K8vCTEWJpCMr2Ss8jAiJrMKcgXvN1Mhe/placeholder.json";
    uint256 public maxTokens = 10000;
    uint256 public maxPresaleTokens = 4000;
    uint256 public maxTokensPerWallet = 500;
    uint256 public maxMintPerTxPresale = 500;
    uint256 public maxMintPerTx = 500;
    ...
    constructor(string memory _ipfsCID)
        ERC721("10000 Positive Words", "POW")
    {
         ...
         */
        REVEAL_TIMESTAMP = block.timestamp + 3600 * 2;
    }
