...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x164413C5692b28a8E1718f8D85766dd4C703A2eA];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 1500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYUosvwotwwWjDYYsTXaK1yKgUTsC7eQj8Stusy6fEE2B/";
...
// File: contracts/AlphaFoxClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlphaFoxClubContract is RamppERC721A {
    constructor() RamppERC721A("Alpha Fox Club", "AFC"){}
}
