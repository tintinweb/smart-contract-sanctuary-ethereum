...
contract ERC721MadNftFactory is Ownable {
    ...
    event Create721MadNftProxy(address indexed proxy, string name, string symbol, uint salt);
    event Create721MadNftUserProxy(address indexed proxy, string name, string symbol, address[] operators, uint salt);
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, uint salt) external {
        ...
        emit Create721MadNftProxy(beaconProxy, _name, _symbol, salt);
    }
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators, uint salt) external {
        ...
        ERC721MadNftMinimal token = ERC721MadNftMinimal(address(beaconProxy));
        token.transferOwnership(_msgSender());
        emit Create721MadNftUserProxy(beaconProxy, _name, _symbol, operators, salt);
    }
 ...
 * {ERC721Enumerable}.
 */
contract ERC721UpgradeableMinimal is Initializable, ContextUpgradeable, ERC165StorageUpgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    using AddressUpgradeable for address;
 ...
 */
abstract contract ERC721PausableUpgradeableMinimal is Initializable, ERC721UpgradeableMinimal, PausableUpgradeable {
...
abstract contract ERC721LazyMinimal is IERC721LazyMint, ERC721UpgradeableMinimal, Mint721Validator, RoyaltiesUpgradeable, Royalties, ERC721URI {
