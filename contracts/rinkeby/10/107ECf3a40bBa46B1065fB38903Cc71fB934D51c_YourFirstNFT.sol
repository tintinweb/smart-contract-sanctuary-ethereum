...
contract YourFirstNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("Your First NFT", "YOURFIRSTNFT") {}
    
    uint256 public collectionSize = 5070;
    ...
    uint256 public amountForPublicSale = 5070;
