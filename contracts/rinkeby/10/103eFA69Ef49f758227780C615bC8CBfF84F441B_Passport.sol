...
contract Passport is AbstractERC1155Factory {

    uint256 constant MAX_SUPPLY = 1000;
    uint256 constant MAX_EARLY_ACCESS = 50;
    uint256 constant RESERVED_NUMBER = 100;
    uint256 public mintPrice = 0.001 ether;

    uint8 public maxPerTx = 2;
    uint8 public maxTxPublic = 3;
    uint8 public maxTxEarly = 2;
    mapping(address => uint256) public purchaseTxs;

    uint256 public earlyAccessWindowOpens = 1651334400;
    uint256 public purchaseWindowOpens    = 1652112000;
    uint256 public purchaseWindowCloses   = 1653840000;
    ...
    constructor(string memory _name, string memory _symbol, string memory _uri) ERC1155(_uri){
        name_ = _name;
        symbol_ = _symbol;
        _mint(msg.sender, 0, RESERVED_NUMBER, "");
    }
    ...
    */
    ...
    /**
    * @notice withdraw the ether from contract
    *
    * @param amount the amount of withdraw
    */
    function withdraw(uint256 amount) external onlyOwner {
        require(address(this).balance >= amount, "Withdrow: amount exceeded");
