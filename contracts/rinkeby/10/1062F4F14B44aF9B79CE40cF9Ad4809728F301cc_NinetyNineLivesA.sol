// contracts/NinetyNineLivesA.sol
...
contract NinetyNineLivesA is ERC721A, Ownable {
    using Strings for uint256;

    string baseURI;
    string public baseExtension = ".json";
    uint256 public maxSupply = 2299;
    uint256 public whitelistMintCost = 0.01 ether;
    uint256 public publicMintCost = 0.0001 ether;
    bool public paused = false;
    bool public startOperatorMinting = false;
    bool public startWhitelistMinting = false;
    bool public startPublicMinting = false;
    bool private revealed = false;
    string private notRevealedUri;

    address private elemintAddress = 0x9E365D4B257f63C21c4e7bDB9Ba2c4C9f1c01542;
    ...
    // Modifier
    modifier elemintOrOwnerOnly {
        require((msg.sender == owner()) || (msg.sender == elemintAddress));
        _;
    }
    ...
    // public
    function operatorMint(uint256 _mintAmount)
    external
    elemintOrOwnerOnly
    {
        uint256 supply = totalSupply();
        require(!paused, "Minting Paused");
        require(!startOperatorMinting, "Operator Minting not start yet.");
    ...
    isWhitelisted(msg.sender)
    {
        uint256 supply = totalSupply();
        require(!paused, "Minting Paused");
        require(!startWhitelistMinting, "Whitelist Minting not start yet.");
        require(supply + _mintAmount <= maxSupply, "Finished Supply");
    ...
    // Only Owner
    function setWhitelist(address _targetWhitelistAddress, bool _isWhitelist) public onlyOwner {
        whitelistedAddresses[_targetWhitelistAddress] = _isWhitelist;
    }
    ...
    function setStartOperatorMinting(bool _value) external onlyOwner {
        startOperatorMinting = _value;
    }
    ...
    function setStartWhitelistMinting(bool _value) external onlyOwner {
        startWhitelistMinting = _value;
    }
    ...
    function setProxy(address proxyAddress, bool value) external onlyOwner {
        proxyRegistryAddress[proxyAddress] = value;
    }
