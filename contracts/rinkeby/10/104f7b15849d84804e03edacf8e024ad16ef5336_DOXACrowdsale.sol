...
contract DOXACrowdsale is OwnableUpgradeable{
    ...
    IERC20Upgradeable public USDT = IERC20Upgradeable(address(0x5EdDd8b10CdE1909B4F046E8AbddeE762F384458));
    IERC20Upgradeable public DAI = IERC20Upgradeable(address(0xC4da211cD1d281651e7e56d311956F99b3B88a12));
    ...
    function buy() public payable icoShouldBeStarted icoShouldnotBeEnded {
     ...
     function payUsingTokens(uint8 tokenType, uint amount) public {
        if(tokenType == 0) {
            ...
            uint ethAmount = (amount *(10 ** 18))/usdttokenRate;
        ...
        if(tokenType == 1) {
            ...
            uint ethAmount = (amount *(10 ** 18))/daitokenRate;
    ...
    function processPayment(address account, uint amount) private {
        ...
        if(!Investors[account].purchased) {
            uint tokensToBuy =amount*(10**18/tokenRate);//1 000 000 000 000/
