...
contract RoborovskiTraits is Ownable {
    ...
    function _getTraits(Temp memory _temp)
        private
        view
        returns (string[] memory values)
    {
        values[0] = traitData[0][_byteToUint8(_temp.traitBytes[0])];
        values[1] = traitData[1][_byteToUint8(_temp.traitBytes[1])];
        values[2] = traitData[2][_byteToUint8(_temp.traitBytes[2])];
        values[3] = traitData[3][_byteToUint8(_temp.traitBytes[3])];
        values[4] = traitData[4][_byteToUint8(_temp.traitBytes[4])];
        values[5] = traitData[5][_byteToUint8(_temp.traitBytes[5])];
        values[6] = traitData[6][_byteToUint8(_temp.traitBytes[6])];
        values[7] = traitData[7][_byteToUint8(_temp.traitBytes[7])];
        values[8] = traitData[8][_byteToUint8(_temp.traitBytes[8])];
        values[9] = traitData[9][_byteToUint8(_temp.traitBytes[9])];
        values[10] = traitData[10][_byteToUint8(_temp.traitBytes[10])];
        values[11] = traitData[11][_byteToUint8(_temp.traitBytes[11])];
        values[12] = traitData[12][_byteToUint8(_temp.traitBytes[12])];
    }
        ...
        returns (string memory)
    {
        ...
        traits1 = string(
            abi.encodePacked(
                ...
                ",",
                _attributeForTypeAndValue(traitTypes[0], _temp.values[0]),
                ",",
                _attributeForTypeAndValue(traitTypes[1], _temp.values[1]),
                ",",
                _attributeForTypeAndValue(traitTypes[2], _temp.values[2]),
                ",",
                _attributeForTypeAndValue(traitTypes[3], _temp.values[3]),
                ",",
                _attributeForTypeAndValue(traitTypes[4], _temp.values[4]),
                ",",
                _attributeForTypeAndValue(traitTypes[5], _temp.values[5])
            )
        );
        ...
        traits2 = string(
            abi.encodePacked(
                _attributeForTypeAndValue(traitTypes[6], _temp.values[6]),
                ",",
                _attributeForTypeAndValue(traitTypes[7], _temp.values[7]),
                ",",
                _attributeForTypeAndValue(traitTypes[8], _temp.values[8]),
                ",",
                _attributeForTypeAndValue(traitTypes[9], _temp.values[9]),
                ",",
                _attributeForTypeAndValue(traitTypes[10], _temp.values[10]),
                ",",
                _attributeForTypeAndValue(traitTypes[11], _temp.values[11]),
                ",",
                _attributeForTypeAndValue(traitTypes[12], _temp.values[12])
            )
        );
        ...
        returns (bytes memory)
    {
        ...
        return
            abi.encodePacked(
                ...
                '","description": "Roborovski NFT Collection by SYA Concept. \n\nAn NFT project initiated by Hollywood-class enterprise SYA Concept & Caravan studio. Based on the character created by Dev Patel and Tilda Cobham-Hervey.","image": "',
                imagePrefix,
                _temp.ipfsHash,
