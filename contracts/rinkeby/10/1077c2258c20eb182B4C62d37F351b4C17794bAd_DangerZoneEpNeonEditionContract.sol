    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 7, 777) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.dangerzonedao.xyz/ep/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 777");
...
// File: contracts/DangerZoneEpNeonEditionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DangerZoneEpNeonEditionContract is RamppERC721A {
    constructor() RamppERC721A("Danger Zone EP Neon Edition", "DZEP"){}
}