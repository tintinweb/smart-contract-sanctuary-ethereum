...
interface ISouvenirCore {
    function createSouvenir(address _owner) external;
}
...
contract SouvenirCore is SouvenirERC721URIStorage, Ownable, ISouvenirCore {
    ...
    //MODIFY THIS TO DO IT IN BATCH
    function createSouvenir(address _owner) override external onlyOwner {
        _mintSouvenir(_owner, nextTokenId);
        nextTokenId++;
    }
