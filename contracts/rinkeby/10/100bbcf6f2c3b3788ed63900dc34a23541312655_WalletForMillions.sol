...
contract WalletForMillions {
 ...
 function sellTokens(uint256 amountIn, address tokenA, address tokenB) public {
 ...
 function buyTokens(uint amountOut, address[] calldata path, address to, uint deadline)
        external
        virtual
        ensure(deadline) 
        // payable
