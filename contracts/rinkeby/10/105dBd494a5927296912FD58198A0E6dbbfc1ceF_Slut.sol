...
contract Slut is Initializable,UUPSUpgradeable,ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    using SafeMathUpgradeable for uint256;
    address public treasury = 0x1111BA4BD4d530402Ee2dcabbE8472A4ec42b70C;
    uint256 public tax;
    mapping(address => bool) public whitelistedAddress;
   address public holder = 0x1111BA4BD4d530402Ee2dcabbE8472A4ec42b70C;
    ...
    function initialize(        
        ...
        ERC20Upgradeable.__ERC20_init("Slut DAO", "SLUT");
        ERC20PermitUpgradeable.__ERC20Permit_init("slut");
        ERC20VotesUpgradeable.__ERC20Votes_init_unchained();
        __Pausable_init_unchained();
        ERC20VotesCompUpgradeable.__ERC20VotesComp_init_unchained();
        _mint(holder, 6666666666666666666666666666666);
        tax=4;
    }
