...
contract AquaCultureNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    function createAsset(uint256 maxAllowed, string memory metadata, uint256 price) public onlyOwner {
        _assetIds.increment();
    ...
    function createAssetPublic(uint256 maxAllowed, string memory metadata, uint256 price) public {
        _assetIds.increment();
        uint256 newAssetId = _assetIds.current();
        assetInfo memory newAsset = assetInfo(
            msg.sender,
