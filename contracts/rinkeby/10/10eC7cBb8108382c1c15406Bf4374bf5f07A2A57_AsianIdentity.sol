    ...
    ReentrancyGuard
{
    ...
    address[] private _team = [
        0xdCcCaAC4f3f758E52d36Ead638217852cc8351F1,
        0x6bC27a0CD08347af44e53908742C1C535D9b0F61,
        0x453350Af3b4188fa866BD2DA399803bCBda809d5
    ];

    constructor()
        ERC721("Asian Identity", "AI")
    ...
    function giftMint(address[] calldata _addresses) external onlyOwner {
        require(
            ...
            "Asian Identityy: max total supply exceeded"
        );
    ...
    function presaleMint(uint256 _amount) external payable nonReentrant{
        require(presaleM, "Asian Identity: Presale is OFF");
        require(!paused, "Asian Identity: contract is paused");
        require(
            _amount <= presaleAmountLimit,
            "Asian Identity: You can't mint so much tokens"
        );
        require(
    ...
    function publicMint(uint256 _amount) external payable nonReentrant{
        require(publicM, "Asian Identity: Public is OFF");
