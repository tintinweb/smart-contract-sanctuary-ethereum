...
import './GameComicChapterOneBase.sol';
import './GameComicChapterOneSplits.sol';

/**
 * @title GameComicChapterOne
 */
contract GameComicChapterOne is GameComicChapterOneSplits, GameComicChapterOneBase {
    constructor()
        GameComicChapterOneBase(
            'GameComicChapterOne',
            'GCCO',
            'https://nftculture.mypinata.cloud/ipfs/QmcVzSFnbgRczDxwUERNzq1KsuBubC1EggBKsAJTWTB8w4/', // COMIC-reveal-rinkeby_METADATA_V1
            addresses,
            splits,
            0.01 ether
        )
...
/**
 * @title GameComicChapterOneBase
 * @author @NiftyMike | @NFTCulture
 * @dev ERC721a Implementation with @NFTCulture standardized components.
 */
abstract contract GameComicChapterOneBase is
    ERC721A,
    Ownable,
...
contract GameComicChapterOneSplits {
    address[] internal addresses = [
        0x000000000000000000000000000000000000dEaD // TODO: Set GameComicChapterOne Wallet(s)
    ];

    uint256[] internal splits = [100]; // TODO: Set GameComicChapterOne Split(s)
}
