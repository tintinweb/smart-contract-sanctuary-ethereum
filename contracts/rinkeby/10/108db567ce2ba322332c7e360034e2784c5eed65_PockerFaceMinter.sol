...
// File: contracts/PockerFaceMinter.sol
...
contract PockerFaceMinter is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using SafeMath for uint256;

    string internal _baseUri = "ipfs://";
    string internal tokenImageuri = "";
    // Contract global variables.
    uint256 public constant mintPrice = 5000000000000000; // 0.003 ETH.
    uint256 public constant maxMint = 10;
    uint256 public MAX_TOKENS = 10000;
    constructor() ERC721("PockerFaceMinter", "PFM") {}

    function safeMintWithUri(string memory uri) public payable
    {
    ...
    function setNFTImageUri(string memory uri) public returns (string memory) {
        tokenImageuri = uri;
