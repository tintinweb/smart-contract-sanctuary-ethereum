...
contract CoffeeCentral is ReentrancyGuard, Ownable, ERC721A{
    ...
    address payable private navi = payable(0x1215e48C797fde86A2A7fCE096D256517714f5b8);  //dev wallet for rinkeby
    ...
    constructor(bytes32 _merkleRoot) ERC721A("CoffeeCentral", "CoffeeCentral", 5, 3333){
    ...
    function PresaleMint(
        ...
        require(amount > 0 && amount <= 5 &&  msg.value ==  (amount * 0.025 ether), "Bad amount or invalid eth sent");
    ...
    function publicMint(uint256 amount) public payable nonReentrant{
        ...
        require(amount > 0 && amount <= 10 && msg.value ==  (amount * 0.035 ether), "bad amount or Invalid eth sent");
        require(totalSupply() + amount <= maxNFT, "Too many Claimed");
