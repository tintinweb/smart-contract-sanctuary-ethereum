...
contract UniswapBudgetApproval is CommonBudgetApproval, UniswapSwapper {
    ...
    function decodeWithResult(address to, bytes memory data, uint256 value, bytes memory _results) public returns (address, address, uint256, uint256) {
    ...
    function decode(address to, bytes memory data, uint256 value) public returns (address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut, bool estimatedIn, bool estimatedOut) {
        return UniswapSwapper.decodeUniswapData(to, data, value);
    }

    function getRequiredAmount(address to, bytes memory data, uint256 value) public override returns(bool isRequireToken, address requiredToken, uint256 requiredAmount) {
...
contract UniswapSwapper {
    ...
    function decodeUniswapData(address to, bytes memory _data, uint256 amount) internal returns (address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut, bool estimatedIn, bool estimatedOut) {
    ...
    function decodeUniswapData(address to, bytes memory _data, uint256 amount, bytes memory swapResult) internal returns (address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut, bool estimatedIn, bool estimatedOut) {
        if(to == UNISWAP_ROUTER) {
            // Uniswap Swap Router
    ...
    function _decodeUniswapRouter(bytes memory _data, uint256 amount) internal returns(address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut, bool estimatedIn, bool estimatedOut) {
        ...
        for(uint i=0; i < multicallBytesArray.length; i++) {
            ...
            // refundETH() 
                ...
                (bool success, bytes memory result) = address(this).call(multicallBytesArray[i]);
    ...
    function _decodeUniswapRouter(bytes memory _data, uint256 amount, uint256[] memory decodedResults) internal returns(address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut, bool estimatedIn, bool estimatedOut) {
        ...
        for(uint i=0; i < multicallBytesArray.length; i++) {
            ...
            // refundETH() 
                ...
                (, bytes memory callResult) = address(this).call(multicallBytesArray[i]);
    ...
    function exactOutputSingle(
        ...
        return (tokenIn, tokenOut, amountInMaximum, amountOut, true, false);
    }
    ...
    function exactInputSingle(
        ...
        return (tokenIn, tokenOut, amountIn, amountOutMinimum, false, true);
    }
