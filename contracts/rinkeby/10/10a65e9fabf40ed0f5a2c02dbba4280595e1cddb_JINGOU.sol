...
/// @title The Best in Automations Mint Tool!
/// @author wanfeng
...
contract JINGOU is ERC721, Ownable {
    ...
    function whitelistRenewToken(uint _tokenId) public payable noHaxxor {
        require(whitelistedAddresses[msg.sender], "Wallet is not whitelisted.");
        require(msg.value == whiteRenewalPrice, "Incorrect amount of ether sent.");
        require(_exists(_tokenId), "Token does not exist.");
    ...
    function changeWhiteRenewalPrice(uint256 _changedWhiteRenewalPrice) external onlyOwner {
        require(whiteRenewalPrice != _changedWhiteRenewalPrice, "Price did not change.");
        whiteRenewalPrice = _changedWhiteRenewalPrice;
    }
