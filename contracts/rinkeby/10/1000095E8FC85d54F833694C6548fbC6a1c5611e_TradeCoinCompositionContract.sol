    ...
    ReentrancyGuard
{
    ...
    function unitConversion(
        ...
        require(_previousAmountUnit == tradeCoinComposition[_tokenId].unit, "Invalid Match: unit");
    ...
    function decomposition(uint256 _tokenId, Documents memory _documents) external {
        ...
        notAtState(State.NonExistent, _tokenId)
    {
        ...
        uint256 newAmount = tradeCoinComposition[_tokenId].amount -
            _amountLoss;
        ...
        onlyInformationHandlerOrAdmin
    {
        ...
        require(length == _rootHash.length, 
            "Invalid Length"
        );
        ...
        for(uint256 _tokenId; _tokenId < length;){
            tradeCoinComposition[_tokenIds[_tokenId]].rootHash = _rootHash[_tokenId];
