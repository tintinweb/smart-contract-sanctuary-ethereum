...
contract WitchHearts is ERC721Delegated {
    ...
    /// @notice provenance hash for the nfts
    ...
    constructor(address baseFactory, address _covenContract)
        ERC721Delegated(
            ...
            ConfigSettings({
                royaltyBps: 2000,
                uriBase: "https://witch-base.isiain.workers.dev/",
                uriExtension: ".json",
    ...
    function setSaleEnabled(bool _saleEnabled)
        external
        onlyOwner
    {
    ...
    function ownsWitch(uint256 witchId) internal {
        require(
    ...
    function getCost(MintInfo[] calldata mintInfo) external returns (uint256) {
        uint256 cost = 0;
    ...
    function mintWithWitches(MintInfo[] calldata mintInfo) external payable {
        ...
        require(cost == msg.value, "wrong value");
