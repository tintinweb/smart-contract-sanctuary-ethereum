...
contract MerkleTest is Ownable, ERC721, ReentrancyGuard {
    ...
    function mint(uint256 _amount) public payable nonReentrant {
        ...
        require(_amount <= capPublic, "MerkleTest: Amount Limit");
        require(
    ...
    function _mint(uint256 _amount) internal {
        ...
        require(msg.value == nftPrice * _amount, "MerkleTest: Incorrect Value");
    ...
    function withdraw() public payable onlyOwner {
        ...
        require(t5tx, "MerkleTest: Transfer 5 Failed");

        (bool t4tx, ) = payable(TEAM4).call{value: (_balance * 5) / 100}("");
        require(t4tx, "MerkleTest: Transfer 4 Failed");

        (bool team3tx, ) = payable(TEAM3).call{value: (_balance * 5) / 100}("");
        require(team3tx, "MerkleTest: Transfer 3 Failed");
