...
contract BankAccount_Struct is Ownable {
    ...
    function getData(uint _x) public view returns(Account memory) {
        return myAccounts[msg.sender].items[_x];
    }
    function getName(uint _x)public view returns(string memory){
        return myAccounts[msg.sender].items[_x].accountName;
    }
    function getValue(uint _x)public view returns(uint){
        return myAccounts[msg.sender].items[_x].itemValue;
    }

    function getCountDataAccount()public view returns(uint){
        return myAccounts[msg.sender].itemsCount;
    }
}
