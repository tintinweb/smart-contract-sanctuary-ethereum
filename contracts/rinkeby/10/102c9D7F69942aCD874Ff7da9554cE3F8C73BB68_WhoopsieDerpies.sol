...
contract WhoopsieDerpies is ERC1155, Ownable {
    ...
    {
        contractUri = "ipfs://QmRLqs7bMe5oSHj7b77dFCm8LnBAH5kBzWMSkBV1arVSgt"; // json contract metadata file for OpenSea
    ...
    function setContractURI(string calldata _newURI) external onlyOwner {
        contractUri = _newURI; // updatable to change project info for marketplaces like OpenSea
    }
