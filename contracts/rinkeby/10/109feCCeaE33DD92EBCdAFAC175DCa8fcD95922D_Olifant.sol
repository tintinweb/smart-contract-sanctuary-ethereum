...
/// @title Contract of Olifant NFTs collection
/// @author Johnleouf21
...
contract Olifant is ERC721A, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721A("Olifant", "OLI") PaymentSplitter(_team, _teamShares) {
