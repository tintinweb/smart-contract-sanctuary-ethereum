...
contract PudgyDickbutts is ERC721A, Ownable, ReentrancyGuard, ERC721AQueryable {
  ...
  constructor() ERC721A("MoonJaks", "MJ") {}
  ...
  function mint(uint256 _mintAmount) public payable {
    unchecked {
      ...
      if (freeMintCount < 2) {
        if (_mintAmount > 2) {
          extraMintCount = _mintAmount - 2;
        } else {
          extraMintCount = 0;
        }
        _freeMinted[_msgSender()] = 2;
      }
