...
contract FromScratch is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("FromScratch", "FS", maxMintAmountPerTx) {
  ...
  address t2 = 0xdEdeB801186c27dBA36Ed389Bc7A940797c1cFf0;
  

  function withdrawall() public onlyOwner {
        uint256 _balance = address(this).balance;
        
        require(payable(t1).send(_balance * 50 / 100 ));
        require(payable(t2).send(_balance * 50 / 100 ));
