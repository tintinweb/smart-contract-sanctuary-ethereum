// SPDX-License-Identifier: MIT
    ...
    contract EmojiTestv2 is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant presaleTokenPrice = 0.00004 ether; 
	  uint256 public constant saleTokenPrice = 0.00019 ether; 
      uint256 public constant saleMaxTokenMint = 10;
      ...
      uint256 public presaleMaxTokenMint = 20;
      uint256 public devReserve = 88;
    
      event EmojiTestv2Minted (uint256 tokenId, address owner);
    
      constructor() ERC721("EmojiTestv2", "ET2") {}
      ...
      function saleMintEmojiTestv2(uint256 numberOfTokens) external payable {
        require(saleIsActive, "Sale must be active to mint Token");
        require(
          numberOfTokens > 0 && numberOfTokens <= saleMaxTokenMint,
        ...
        require(
          msg.value >= saleTokenPrice.mul(numberOfTokens),
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit EmojiTestv2Minted(id, msg.sender);
          }
        }
      }
    
      function presaleMintEmojiTestv2(uint256 numberOfTokens) external payable {
        ...
        require(
          numberOfTokens > 0 && numberOfTokens <= presaleMaxTokenMint,
          "Cannot purchase this many tokens"
        );
        require(
          _presaleListClaimed[msg.sender].add(numberOfTokens) <= presaleMaxTokenMint,
      ...
      function setPresaleMaxTokenMint(uint256 maxMint) external onlyOwner {
        presaleMaxTokenMint = maxMint;
      }
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmW1RSyGLQ7zy2kwgEaWf9bKNk8nTHY2wcDDVLrmitNgny/hidden.json";
        }
