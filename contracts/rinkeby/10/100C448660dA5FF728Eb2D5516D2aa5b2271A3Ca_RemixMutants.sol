...
contract RemixMutants is ERC721OffChainEnumerable, Pausable, ReentrancyGuard, AdminControl, Ownable {
  ...
  uint256 internal MAX_SUPPLY = 300;
  ...
  mapping(address => uint256) numberOfTokensMintedInAllowlistByAddress;
  ...
  function getStageStartTime(MintWindowType _stage) public view returns (uint256) {
    return stageStartTimes[_stage];
  }
  ...
  function setStageStartTimes(uint256[] calldata startTimes) public onlyAdmin {
    ...
    require(startTimes[1] > startTimes[0], "Stage 1 must start after Gold stage");
    require(startTimes[2] > startTimes[1], "Stage 2 must start after Stage 1");
    require(startTimes[3] > startTimes[2], "Stage 3 must start after Stage 2");
    require(startTimes[4] > startTimes[3], "Stage 4 must start after Stage 3");
    require(startTimes[5] > startTimes[4], "Any Stage must start after Stage 4");

    stageStartTimes[MintWindowType.GOLD] = startTimes[0];
    stageStartTimes[MintWindowType.STAGE_1] = startTimes[1];
    stageStartTimes[MintWindowType.STAGE_2] = startTimes[2];
    stageStartTimes[MintWindowType.STAGE_3] = startTimes[3];
    stageStartTimes[MintWindowType.STAGE_4] = startTimes[4];
