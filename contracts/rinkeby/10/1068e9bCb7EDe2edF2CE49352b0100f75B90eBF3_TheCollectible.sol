...
contract TheCollectible is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    ...
    constructor(uint256 maxSupply) ERC721("TheCollectible", "THE") EIP712("TheCollectible", "1") {
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        ...
        require(tokenId < MAX_SUPPLY, "no more available tokens");
