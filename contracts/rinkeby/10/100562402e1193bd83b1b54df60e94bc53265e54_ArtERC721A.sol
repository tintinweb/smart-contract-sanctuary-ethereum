...
contract ArtERC721A is Ownable, ERC721A {
    ...
    //The total amount in sale (minus gift)
    uint private constant MAX_PUBLIC_SALE = 9950;
    ...
    uint256 public saleStartTime = 1653235200; //22 may, 18h00 GMT + 2
    ...
    **/
    function publicSaleMint(address _account, uint _quantity) external payable mintIsEnabled callerIsUser {
        ...
        require(totalSupply() + _quantity <= MAX_PUBLIC_SALE, "Max supply exceeded");
