...
contract ERC1155 is Context, ERC165Storage, IERC1155, IERC1155Metadata, IERC1155MetadataURI {
     ...
     * @dev See {_setURI}.
     */
    constructor (string memory myName, string memory mySymbol, string memory myUri) {
        __name = myName;
        __symbol = mySymbol;
        _setURI(myUri);
    ...
    function metadata() external view returns(string memory _name, string memory _symbol) {
        _name = __name;
        _symbol = __symbol;
    }
