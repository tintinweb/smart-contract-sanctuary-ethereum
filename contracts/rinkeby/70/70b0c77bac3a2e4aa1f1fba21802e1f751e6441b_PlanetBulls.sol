    ...
    UUPSUpgradeable
{
        ...
        onlyOwner
    {
      ...
      /**
     @dev set maximum swapable fee amount.
     @param _maximumSwapableMarketingAmount updates the maximum swapable amount
     once the fee amount reached this limit it will call swapAndLiquify function
     */
    function setMaximumSwapableMarketingAmount(uint256 _maximumSwapableMarketingAmount)
        external
        onlyOwner
    {
        cappedSwapableMarketingAmount = _maximumSwapableMarketingAmount;
        emit CappedSwapableAmount(_maximumSwapableMarketingAmount);
    }
