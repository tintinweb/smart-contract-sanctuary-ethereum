...
contract ForeverBots is Ownable, ERC721 { 
    ...
    uint256 public cost = 0.0015 ether; // 0.15 in actual %%%%
    ...
    ) ERC721("ForeverBots", "BOTS") { // change name and symbol
    ...
    /**
     * @dev Reveals metadata.
     * @param _newBaseUri - base URI of revealed metadata (Example:   ipfs://cid/)
     */
    ...
    /**
     * @dev Set the status of the public sale to true. Sets preSaleStatus to false.
     */
    function switchPreToPublic() external onlyOwner {
        preSaleStatus = false;
