...
contract Ghost is Ownable, ERC721A {
    ...
    //Starting at 2 ether
    uint256 public DA_STARTING_PRICE = 0.2 ether; //change before commit
    ...
    //The quantity for DA.
    uint256 public DA_QUANTITY = 6; //change before commit
    ...
    uint256 public WL_STARTING_TIMESTAMP = DA_STARTING_TIMESTAMP + 900; //change before commit
    ...
    constructor() ERC721A("animeProject", "GHOST") {} //change before commit
    ...
    function setStartTime(uint256 startTime) public onlyOwner {
        ...
        WL_STARTING_TIMESTAMP = startTime + 900; //change before commit
    }
