...
contract Test is ERC721A, Ownable{
    ...
    string public PlaceholderHash = 'eeee';
    ...
    constructor() ERC721A("eeeeh", "eee") 
    {
        MerkleRoot[0] = 0x2e6686f039d40fc1bf661de5d52a24daa15a6ef8fefc9b721de9c7849c72bea9;
        MerkleRoot[1] = 0x2e6686f039d40fc1bf661de5d52a24daa15a6ef8fefc9b721de9c7849c72bea9;
        MerkleRoot[2] = 0x2e6686f039d40fc1bf661de5d52a24daa15a6ef8fefc9b721de9c7849c72bea9;
        MaxMintPerPhase = [3, 3, 3];
    }

    function devMint(uint256 _quantity, address _addr) public onlyOwner{
        require(_quantity.add(totalSupply()) <= MaxSupply, "sale very closed");
    ...
    function publicMint(bytes32[] calldata _merkleProof, uint256 _quantity) payable public {
        require(SaleOpen, "sale not open yet");
        require(msg.value == _quantity.mul(UnitPrice), "incorrect ether money number");
        require(_quantity.add(totalSupply()) <= MaxSupply, "sale very closed");
        require(_quantity <= MaxPublicMint, "too much number");
        
        if (!PublicSaleOpen) {
            require(MaxMintPerPhase[CurrentPhase] >= _quantity.add(WhitelistMinted[msg.sender][CurrentPhase]), "too much number");
            bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
            require(MerkleProof.verify(_merkleProof, MerkleRoot[CurrentPhase], leaf), "not allowed");
