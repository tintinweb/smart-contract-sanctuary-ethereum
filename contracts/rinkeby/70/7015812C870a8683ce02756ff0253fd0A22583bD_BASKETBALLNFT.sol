...
contract BASKETBALLNFT is ERC721AUpgradeable, OwnableUpgradeable {
        ...
        initializer
    {
        ...
        Set = ["Model Change Series", "Star Card Series"];
    ...
    /// @dev A player will be randomly selected from the Player as the NFT player attribute. If a player's NFT is exhausted, the player will be skipped.
        ...
        public
    {
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            transferFrom(msg.sender, address(this), payTokenIDs[i]);
        }
        transferFrom(msg.sender, address(this), payDropTokenID);
    ...
    function airdropToUser(AirdropUser[] calldata dropData) public onlyOwner {
        ...
        for (uint256 i; i < dropData.length; i++) {
            ...
            require(
                data.attributes.length == data.amount,
                "param error"
            );
