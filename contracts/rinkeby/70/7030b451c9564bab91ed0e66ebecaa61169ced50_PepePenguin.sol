...
contract LPBasic is Ownable, ERC20 {
    ...
    modifier locked() {
		...
		constructor() ERC20() {
				_mint(address(this), 1000000 * 10**9);
		...
		function _addLiquidity(uint256 tokenAmount, uint256 ethAmount) internal returns(uint256 tokenDeposit,uint256 ethDeposit) {
                ...
                console.log('called addLiquidityETH');
		}
		...
		function initializeLiquidityPool() public payable onlyOwner {
                ...
                console.log('start initializing lp pool');
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private constant _name = "PepePenguin";
    string private constant _symbol = "PepePenguin";
