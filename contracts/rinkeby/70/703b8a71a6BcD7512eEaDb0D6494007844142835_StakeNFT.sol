...
contract StakeNFT {
    ...
    function callStakeToken(address token, uint _tokenID) public {
        require(token == 0x09be586b0b6D79488D6Fe645a31784DE516Ad36e, "incorrect NFT to stake"); // hardcode the NFT smart contract to allow only specific NFT into staking, assume 0xd2...d005 as NFT contract address
