...
contract DiscoPunkzzz is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("DiscoPunkzzz", "DPZZZ", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant AUCTION_PRICE_CURVE_LENGTH = 1060 minutes;
