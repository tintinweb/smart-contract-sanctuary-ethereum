  ...
  ERC721AUpgradeable
{
  ...
  /// @notice Max token count.
  uint256 public constant LSG_MAX = 15_000;

  /// @notice Max genesis token count.
  uint256 public constant LSG_GENESIS = 5_000;

  /// @notice Max mints per transaction.
  uint256 public constant LSG_PER_TX = 3;
  ...
  function buy(uint256 amount) external payable {
    require(totalSupply() + amount <= LSG_GENESIS, "Max genesis supply exceeded");
    if (msg.sender != owner()) {
  ...
  function withdraw() external onlyOwner {
    address creatorAddress = 0x6F56d9B98f3bC169C6b8E4aA508db594Db689B53;
    address developerAddress = 0x5e182D3597481bFf497B0C6098eF74716e053e9D;

    uint256 creatorAmount = (address(this).balance * 875) / 1000;
    uint256 developerAmount = (address(this).balance * 125) / 1000;
