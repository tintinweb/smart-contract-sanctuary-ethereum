...
contract ZeroXBlock is Initializable, ERC20Upgradeable, OwnableUpgradeable, PaymentSplitterUpgradeable {
    ...
    */
    function swapExact0xBForToken(
        ...
        uint256 fee;
        uint256 amountInWithSellTax = amountIn - (amountIn * sellTax) / 100;
        (, fee) = _liqRouter.swapExact0xBForToken(
            sender,
            tokenAddr,
            amountInWithSellTax,
            amountOutMin,
...
contract LiquidityRouter is Initializable, PaymentSplitterUpgradeable {
    ...
    function swapExact0xBForToken(
        ...
        uint256 amountOut = getOutputAmount(false, outTokenAddr, amountIn - fee);
