...
contract DegenDisease is ERC721A,Ownable{
    ...
    uint public limitwl=2;
	bool unveil = false;
    bool openForMint=false;
    bool openForMintPublic=false;
    bool openForFree=false;
    bool openForFreePublic=false;
    bytes32 public merkleroot= 0xfd1a691b4f0d5df7407043a7ab12ad82f06491049dda6102a2ce793f2082f20a;
   ...
   // mapping(address => bool) public whitelistClaimed;
    ...
    function freeMintWL(uint amount,bytes32[] calldata _merkleProof) external payable {
        ...
        require(mintfree[msg.sender]+amount <= limitwl,"Free Token is claimed");
        mintfree[msg.sender]+=amount;
        _safeMint(msg.sender, amount);
    }

    function publicfreeMint(uint amount) external payable {
    ...
    function mintWL(uint amount) external payable {
        ...
        require(amount>0,"Cannot mint 0 or below 0");
         require(amount<=limitmint,"Mint over limit");
        _safeMint(msg.sender,amount);
    }
