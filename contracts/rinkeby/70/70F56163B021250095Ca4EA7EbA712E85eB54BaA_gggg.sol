...
contract gggg is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public MINT_PRICE = 0.0009 ether;
    uint256 public MAX_NFT_PER_TRAN = 20;
    ...
    constructor(string memory baseURI_) ERC721A("ggggg", "gg") {
        _baseURL = baseURI_;
    }
    ...
    function ownerhMintAirdrop(address[] calldata addresses)
        external
        onlyOwner
    {
