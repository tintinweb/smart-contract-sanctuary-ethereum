...
contract UnbcNft is MRC721 {
    ...
    //     //     //TODO
    //     //     //check this condition in a situation that to_address has already had this id but not now
    //     //     require(uniqueOwner[to] == tokenId, 'This tokenId is not transferable');
    //     // }
    //     require(nfts[tokenId].currentOwner == address(0), "This tokenId is not transferable");
    //     require(
    //         _isApprovedOrOwner(address(this), tokenId) ||
    //         _isApprovedOrOwner(_msgSender(), tokenId),
    //         // hasRole(TRANSFER_ROLE, _msgSender()),
    //         // _msgSender() == address(this),
    //         "UnbcNft: transfer caller is not owner nor approved"
    //     );
