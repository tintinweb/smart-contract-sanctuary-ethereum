...
contract Merkle is Ownable {
    ...
    constructor(bytes32 _freeClaim) {
...
contract MYCONTRACTMERKLE is ERC721A, ERC2981 , Ownable, Merkle, Pausable {
    using Strings for uint256;
    ...
    mapping(address => uint256) public preMintListsMerkle;
    ...
    function preMintMerkle(
        ...
        mintCheck(_mintAmount,  cost);
        require(presale, "Presale is not active.");
        require(_claimVerify(_claimLeaf(msg.sender, _maxCount), _proof), "You don't have Mint List");   // Mint Listに乗ってるか？
        require(preMintListsMerkle[msg.sender] + _mintAmount > _maxCount, "Over Mint Limit");    // 登録数は超えてないか？
        preMintListsMerkle[msg.sender] += _mintAmount;
        _safeMint(msg.sender, _mintAmount);
    }
