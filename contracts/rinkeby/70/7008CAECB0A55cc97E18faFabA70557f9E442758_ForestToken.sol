...
contract ForestToken is Initializable, ERC1155Upgradeable, AccessControlUpgradeable,
    ...
    struct TokenMetadata {
        string unit_size;
        uint256 conservation_time;
        uint256 monitoring_frequency;
        string monitoring_provider;
        string asset_type;
        string pyt_conservation_token_type;
        string total_area_conserved;
    }
    ...
    function initialize() initializer public {
        ...
        unit_size = "1 ha";
        property_name = "Surui";
        _contractUri = "https://ipfs.plantyourtree.com/ipfs/QmZXxCb8jKDhquu1iowsQEyiqw7RWnPiSF8yskMt6i3rMn";
    }
    ...
    function mint(
        ...
        uint256 _conservation_time,
        uint256 _monitoring_frequency,
        string memory _monitoring_provider,
        string memory _asset_type,
        string memory _pyt_token_type,
        string memory _total_area_conserved
    )
        public
        returns (uint)
    {
 ...
 * _Available since v3.1._
 */
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable {
...
abstract contract AccessControlUpgradeable is Initializable, ContextUpgradeable, IAccessControlUpgradeable, ERC165Upgradeable {
    ...
    function grantLandOwnerRole(address account) public {
        require(hasRole(PYT_ADMIN_ROLE, _msgSender()) || hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), 'Access Control: You do not have the required role for this function');
    ...
    function grantPYTAdminRole(address account) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), 'Access Control: You do not have the required role for this function');
    ...
    /**
     * @dev Public function to grant artist role
     * Can be called only by addresses with land owner role
     */
    function grantArtistRole(address account) public {
        require(hasRole(LAND_OWNER_ROLE, _msgSender()), 'Access Control: You do not have the required role for this function');

        _grantRole(ARTIST_ROLE, account);
    }

    /**
     * @dev Public function to revoke artist role
     * Can be called only by addresses with land owner role
     */
    function revokeArtistRole(address account) public {
        require(hasRole(LAND_OWNER_ROLE, _msgSender()), 'Access Control: You do not have the required role for this function');
