...
contract sdasdas is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbQW4v3qX4715rwekBnrXCRrhgg6JRzP";
    ...
    constructor(
    ) ERC721A("sdasdas", "sdasdas", 100, maxSupply) {
    }
