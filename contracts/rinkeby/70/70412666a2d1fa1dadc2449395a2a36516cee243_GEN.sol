...
contract GEN is ERC20, Ownable {
    ...
    uint256 genTokenPrice = 2; // wei  in eth 0.0050
    ...
    uint256 public  winnerCircleAmount;
    uint256 public areenaTokenAmount;
    uint256 public liquidityPoolAmount;
    uint256 public insuranceFundAmount;
    uint256 public treasuryAmount;
    uint256 public burnAmount;
    //uint256 public referalSystem;

    uint256 public addAllAmount;
    uint256 public addAllAmount1;
    ...
    function buy(uint256 _amount) external  {
      ...
      // require(msg.value == _amount * genTokenPrice, "Need to send exact amount of wei");
         ...
         winnerCircleAmount = calculateWinnerCirclePercentage(_amount);
         areenaTokenAmount = calculateAreenaTokenPercentage (_amount);
         liquidityPoolAmount = calculateLiquidityPoolPercentage (_amount);
         insuranceFundAmount = calculateInsuranceFundPercentage(_amount);
         treasuryAmount = calculateTreasuryPercentage(_amount);
         burnAmount = calculateBurnPercentage(_amount);
        // referalSystem = calculatereferalSystemPercentage(_amount);
        
        addAllAmount =  winnerCircleAmount + areenaTokenAmount + liquidityPoolAmount + insuranceFundAmount + treasuryAmount + burnAmount;
        _amount = _amount - addAllAmount;
        addAllAmount1 = _amount;
    ...
    function sell(uint256 _amount) external {
        ...
        payable(msg.sender).transfer(_amount * genTokenPrice);
    }
