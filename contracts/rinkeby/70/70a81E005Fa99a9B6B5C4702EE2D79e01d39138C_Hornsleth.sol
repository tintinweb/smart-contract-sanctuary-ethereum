...
contract Hornsleth is ERC721ABurnable, Ownable {
    ...
    uint256 public NFT_PER_ADDRESS_LIMIT = 10;
        ...
        payable
    {
        ...
        if (msg.sender != owner()) {
            if (_isPresale == true) {
                ...
                require(
                    ownerMintedCount + _mintAmount <= NFT_PER_ADDRESS_LIMIT,
    ...
    function crossmint(address to, uint256 _count) external payable {
        ...
        require(
            _count <= MAX_TOKEN_PER_TRANSACTION,
