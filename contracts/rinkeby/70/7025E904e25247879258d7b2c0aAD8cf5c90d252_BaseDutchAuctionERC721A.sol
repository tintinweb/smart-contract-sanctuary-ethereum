...
contract BaseDutchAuctionERC721A is ERC721A, LinearDutchAuction, ReentrancyGuard {
    ...
    uint256 private publicMaxMint;
    uint256 private totalPublicMint;
    constructor(
    ...
    function mintPublic(uint256 numberOfTokens) external payable {
        ...
        totalPublicMint += numberOfTokens;
        require(totalPublicMint <= publicMaxMint, "exceed amount");
