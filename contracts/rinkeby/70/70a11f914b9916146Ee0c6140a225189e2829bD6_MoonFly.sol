...
contract MoonFly is ERC721, Ownable {
  ...
  uint256 public price = 0.01 ether; // duckie detectives, this is not the real mint price
  uint256 public constant maxSupply = 10000;
  uint256 public constant mintPerAddressLimit = 2; // duckie detectives, this is not the real max mint amount
  uint256 public constant ownerMintLimit = 100; // duckie detectives, this is not the real owner max mint amount
  ...
  constructor() ERC721("MoonFly", "MF") {
    setBaseURI("http://100.27.2.85/metadata/json/"); // This is not the real URI, needs to be updated closer to mint
