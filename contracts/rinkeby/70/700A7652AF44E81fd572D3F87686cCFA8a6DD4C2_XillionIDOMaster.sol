...
contract XillionIDOMaster is XillionIDOCommon {
    ...
    function setInvestmentDetails(XillionIDOStructs.InvestmentDetails calldata investmentDetails_) external onlyOwner {
        ...
        // maxInvestmentBEP20AmountPerInvestor = investmentDetails_.maxInvestmentBEP20AmountPerInvestor;  //BEP20
        // minInvestmentPercentOfBEP20ForIDOCompletion = investmentDetails_.minInvestmentPercentOfBEP20ForIDOCompletion; //BEP20
        ...
        emit InvestmentDetailsUpdated(
            ...
            // investmentDetails_.maxInvestmentBEP20AmountPerInvestor,
            // investmentDetails_.minInvestmentPercentOfBEP20ForIDOCompletion
        );
...
contract XillionIDOCommon is OwnablePausable, ReentrancyGuard {
    ...
    */
    ...
    event InvestmentBEP20Updated(address investor, uint256 investment, uint256 totalInvestedTokenAmount, address _tokenAddress);
