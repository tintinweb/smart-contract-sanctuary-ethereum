...
contract TheLostMeeble is ERC721A("The Lost Meeeeeeeble", "Meeble"), Ownable, ReentrancyGuard{
    ...
    uint256 public MaxSavePerWallet = 50;
    uint256 public MeebleCreatures = 100;
    uint256 public TotalFreeMeeble = 3 ;
    ...
    constructor(){   
       ...
       //whitelistMint
    function WhitelistFindMeeble(bytes32[] calldata _merkleProof) public payable {
        require(!Paused,"The meeble creatures is not ready to be found");
        require(totalSupply() + 1 <= MeebleCreatures,"Max supply exceeded!");
        require(_MeebleCount[msg.sender] + 1 <= MaxSavePerWallet,"Wallet limit reached!");
    ...
    function FindMeeble( uint256 _qty ) external payable {
    ...
    // {
    //     require(totalSupply() + _mintAmount <= MeebleCreatures,"Max supply exceeded!");
    //     require(_numberMinted(msg.sender) + _mintAmount <= MaxSavePerWallet,"Wallet limit reached!");
    ...
    function TeamSaveMeeble() external onlyOwner {
        ...
        require(_FreeMeebleCount[msg.sender] <= 170 , "Team has already found Meeble");
  ...
  /* function updateURI(string memory NewMeebleURI) external onlyOwner {
        MeebleURI = NewMeebleURI;
    }*/
}
