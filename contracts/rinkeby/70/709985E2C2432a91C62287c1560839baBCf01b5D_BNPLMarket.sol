    ...
    IERC721Receiver
{
    ...
    */
    ...
    function execute(
        ...
        TokenType tokenType = _fetchTokenTypeFromOrderType(_basicOrderParameters.basicOrderType);
    ...
    internal returns (TokenType) {

        if( orderType >= BasicOrderType.ETH_TO_ERC721_FULL_OPEN &&
        orderType <= BasicOrderType.ETH_TO_ERC721_PARTIAL_RESTRICTED){
            return TokenType.ERC721; 
        }

         if( orderType >= BasicOrderType.ETH_TO_ERC1155_FULL_OPEN && 
