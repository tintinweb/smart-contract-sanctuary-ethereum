...
contract Coser is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint32 public publicMintStart = 1655035200;
    uint32 public whitelistMintStart = 1654776000;
    uint32 public whitelistMintEnd = 1654948800;
    ...
    modifier checkWhitListMint(bytes32[] calldata _merkleProof) {
    ...
    function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof)
        ...
        checkWhitListMint(_merkleProof)
    {
    ...
    function setWhitelistMintStart(uint32 timestamp) public onlyController {
        whitelistMintStart = timestamp;
    }

    function setWhitelistMintEnd(uint32 timestamp) public onlyController {
        whitelistMintEnd = timestamp;
    }

    function setPublicMintStart(uint32 timestamp) public onlyController {
