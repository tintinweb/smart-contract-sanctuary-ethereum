...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4C1C2077C13f40F3D368cC5d277e230E23D3ceBD];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 1200 ) {}
...
// File: contracts/BobsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BobsContract is RamppERC721A {
    constructor() RamppERC721A("bobs", "bobs"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/oW9zO0Kxr9UeVhg86OHK/contract-metadata";
    }
}
