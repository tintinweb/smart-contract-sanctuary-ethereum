...
contract svgManip {
    ...
    function breedProkaryote(uint256 tokenId, uint256 cell_generation) external view returns (uint256) {
        ...
        uint256 rand = _random(abi.encodePacked(Strings.toString(cell_generation), Strings.toString(block.timestamp), "BREED CELLS", _seed_phrase, Strings.toString(tokenId))) % 100;
    ...
    function breedEukaryotes(uint256 tokenId1, uint256 tokenId2, uint64 tokenGen1, uint64 tokenGen2) external view returns (uint256, uint256) {
        ...
        uint256 rand = _random(
            ...
            Strings.toString(tokenGen1), Strings.toString(tokenGen2), 
            Strings.toString(tokenId1), Strings.toString(tokenId2))
        ) % 10;
