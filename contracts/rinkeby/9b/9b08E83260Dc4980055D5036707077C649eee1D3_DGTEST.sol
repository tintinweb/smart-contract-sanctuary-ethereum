...
contract DGTEST is ERC721, ReentrancyGuard, PaymentSplitter, IERC2981, Ownable {
    ...
    function mintSaiyan(
        ...
        _internalMintDegenSaiyan(sender, amount);
    }

    function ownerMint(address to, uint256 amount) public onlyOwner {
        _internalMintDegenSaiyan(to, amount);
    }

    // Internal/Private
    function _internalMintDegenSaiyan(address to, uint256 amount) private {
        require(
