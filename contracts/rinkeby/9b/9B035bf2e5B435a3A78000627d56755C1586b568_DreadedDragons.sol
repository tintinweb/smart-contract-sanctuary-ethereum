...
contract DreadedDragons is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("DreadedDragons", "DD") {}
  ...
  function reserveDragons(uint256 quantity)
    external
    onlyOwner
  {
    require(totalSupply() + quantity < totalAvailable + 1, "sorry cannot reserve that many");
