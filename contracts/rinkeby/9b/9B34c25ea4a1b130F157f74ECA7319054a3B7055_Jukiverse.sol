...
contract Jukiverse is ERC721A, ERC2981, EIP712, Ownable {
    ...
    uint256 public constant WL_SUPPLY = 2222;
    uint256 public constant PUBLIC_SUPPLY = 1234;
    ...
    // public left = public-limit - totalsupply

    // whitelist left = wl-supply + (public-left)  - totalsupply() 
    // 1000, 234, 
    // 2222 + 100 - 1134 
