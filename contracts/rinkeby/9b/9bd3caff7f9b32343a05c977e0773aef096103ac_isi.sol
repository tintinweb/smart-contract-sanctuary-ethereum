...
contract nekomato_0408_2234 is ERC721{
...
//ここが名前
    constructor() ERC721("nekomato0408_2234" , "nkmt0408_2234" ) {
        //owner address
        //tonoshake
    ...
    function chengeForm(uint _id,string memory _uri) external{
        require(allowStoneList[_msgSender()],"not allowed address");
        tokenURIs[_id] = _uri;
    }
}
...
// contract nkmtInterface{
//     function chengeForm(address _address,uint _id,string memory _uri) external;
// }

contract isi is ERC721{
    
    constructor() ERC721("isi_20220407" , "isi_20220407" ) {
    ...
    nekomato_0408_2234 nkmt = nekomato_0408_2234(0xD61fDaD5E24A1F2F59Cb4caF171EA73b1f6FD2A7);
    ...
    function changeNKMTForm(uint _id)external{
