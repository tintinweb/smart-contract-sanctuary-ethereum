...
contract GameLootTreasure is Ownable, Pausable, IERC721Receiver {
    ...
    mapping(address => mapping(uint256 => address)) public lastOwner;
    ...
    function upChain(
        ...
        require(msg.sender == lastOwner[_token][_tokenID], "only person who topped up it");
        ...
        lastOwner[_token][_tokenID] = address(0);
    ...
    function topUp(
        ...
        lastOwner[_token][_tokenID] = msg.sender;
    ...
    function upChainBatch(
        ...
        for (uint256 i; i < _tokens.length; i++) {
            require(msg.sender == lastOwner[_tokens[i]][_tokenIDs[i]], "only person who topped up it");
    ...
    function topUpBatch(
        ...
        for (uint256 i; i < _tokens.length; i++) {
            lastOwner[_tokens[i]][_tokenIDs[i]] = msg.sender;
