...
import "./IERC721URIBasedMinter.sol";

contract NFTCollection is IERC721URIBasedMinter, ERC721PresetMinterPauserAutoId {
    ...
    constructor(
        ...
        uint256 maxItems
    ) public ERC721PresetMinterPauserAutoId(platformSettings, contractURIValue, name, symbol, baseURI) {
        _maxItems = maxItems;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "SKULLOIDS_TOKEN_PAUSED"
        );
    }

    /**
     * @dev Creates a new token for "to". Generates an ID for the token and maps it to the URI, of the 
     *  Metadata JSON file of the asset represented by the token to be minted
     * @param to The owner of the NFT 
     * @param tokenURI Points to the metadata JSON file of the asset represented by the token. 
     *  The JSON file should conform to the "ERC721 Metadata JSON Schema"
     */
    function mintByURI(address to, string memory tokenURI) public override onlyCustomMinter(_msgSender(), _minterRoleHash()) {
...
abstract contract ERC721PresetMinterPauserAutoId is Base, Context, ERC721Burnable, ERC721Pausable, IERC721Mintable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(address platformSettings, string memory contractURIValue, string memory name, string memory symbol, string memory baseURIValue) public Base(platformSettings) ERC721(name, symbol) {
...
interface IERC721URIBasedMinter {
    /**
     * @dev Creates a new token for "to". Generates an ID for the token and maps it to the URI, of the 
     *  Metadata JSON file of the asset represented by the token to be minted
     * @param to The owner of the NFT 
     ...
     *  The JSON file should conform to the "ERC721 Metadata JSON Schema"
     */
    function mintByURI(address to, string memory tokenURI) external;
}
