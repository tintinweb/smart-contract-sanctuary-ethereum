...
,,,,,,,,,,,,,,,,,,,,,,,,,O###############################O#E.#######O OO#####################O,,,,,,,,,,,,,,,,,,,,,,,,,,
,,,,,,,,,,,,,,,,,,,,,,,,O################################O##########OO#O#####################O,,,,,,,,,,,,,,,,,,,,,,,,,,
,,,,,,,,,,,,,,,,,,,,,,,,O##########NEVER_STOP_CODING######O#####OOOO####O#####################O,,,,,,,,,,,,,,,,,,,,,,,,,
,,,,,,,,,,,,,,,,,,,,,,,,O#################################O#######O#####O#####################O,,,,,,,,,,,,,,,,,,,,,,,,,
,,,,,,,,,,,,,,,,,,,,,,,O##################################O#(#####O#####O#####################O,,,,,,,,,,,,,,,,,,,,,,,,,
,,,,,,,,,,,,,,,,,,,,,,,O################O#################O((##,##O#####O#############O########O,,,,,,,,,,,,,,,,,,,,,,,,
 */
...
contract FACES_OF_REKT_CONTRACT is ERC721A, Ownable {
    ...
    string private _baseURIextended = "https://faces-api.onrender.com/for/metadata/"; // This one is used on OpenSea to define the metadata IPFS address

    bool private mint_paused = false; // in case someone tries to rekt our mint we can pause at will

    bool whitelist_mint = false;
    ...
    function setMintPrice(uint _mint_price) external onlyOwner() {
    ...
    function switch_Seat_mint(uint16 seats) external onlyOwner() {
        seatsLeft = seats;
        seatMint = !seatMint;
    }
   ...
   function giveExp (uint16 tokenId, uint32 xp_amount) external {
    ...
    function setMarketCapMultiplier (bytes32[] memory proof, uint8 _capMultiplier, uint8 whitelistID) external {
    ...
    function M_I_N_T(bytes32[] memory proof, address to, uint16 quantity) public payable {
        ...
        if(seatMint) {
            require(seatsLeft > 0, "No seats left on the bus.");
            seatsLeft--;
        }
    ...
    function levelUpStaking(uint16 tokenId) external {
        ...
        token_struct[tokenId].experience += ((block.timestamp - token_struct[tokenId].stake_date) * (token_struct[tokenId].level * capMultiplier));
    ...
    function level(uint16 tokenId) view public returns (uint) {
        ...
        if (token_struct[tokenId].is_staked) {
            for ( uint i = 0; i <= 100 ; i++) {
                if (
                    (((block.timestamp - token_struct[tokenId].stake_date) * (token_struct[tokenId].level * capMultiplier) + token_struct[tokenId].experience) < xp_to_level[i])
                ) {
                    return i;
                }
            }
    ...
    function check_Xp_Owned(uint16 tokenId)public view returns (uint256) {
        ...
        if (token_struct[tokenId].is_staked) {
            return ((block.timestamp - token_struct[tokenId].stake_date) * (token_struct[tokenId].level * capMultiplier));
        } else {
            return token_struct[tokenId].experience;
        }
    }
        ...
        require(!token_struct[startTokenId].is_staked, "staked transfer");
    }
