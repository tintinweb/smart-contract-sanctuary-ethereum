...
contract BabyGirl is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    event leveled(uint level, uint summoner);
    ...
    function level_up(uint _summoner) public onlyOwner {
          require(_isApprovedOrOwner(msg.sender, _summoner));
          uint _level = rand(_summoner);
          level[_summoner] = _level;
        emit leveled(_level, _summoner);
      }
