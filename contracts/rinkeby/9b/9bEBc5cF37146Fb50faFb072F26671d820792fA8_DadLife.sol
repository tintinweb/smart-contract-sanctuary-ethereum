...
contract DadLife is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address public royaltyRecipient =
        0x705c84Aa160e1e3ED43583108d0A6835DD19C6A0;
    ...
    constructor(string memory _uri, uint96 _royaltyFeesInBips) ERC721("Dad Life", "DAD") {
        setBaseURI(_uri);
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (onlyWhitelisted) {
                ...
                require(
                    supply + _mintAmount <= maxSupplyWL,
  ...
  function addWhitelistUsers(address[] calldata _users) public onlyOwner {
    ...
    function removeWhitelistUser(address _user) public onlyOwner {
        require(isWhitelisted(_user), "user is already not whitelisted");
