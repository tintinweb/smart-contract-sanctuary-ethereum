...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2EF134b775F98fc5721e0A119c1886765e5AF012];
...
// File: contracts/LeonardTheLionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract LeonardTheLionContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Leonard The Lion";
    string public symbol = "LTL";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/j3sHOf3IHL23LNk01qlz/contract-metadata";
    }
