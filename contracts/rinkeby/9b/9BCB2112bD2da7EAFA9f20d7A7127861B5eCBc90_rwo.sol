...
contract rwo is ERC721F {
    ...
    address private constant KARL = 0x48bD38fefa1605d32c81c106c9d7A6c2F8a7Fd0D;
    address private constant DENNIS = 0x6b96C9D43B8B4bD4Bb570BC8B53C44bB8289e896;
    address private constant KANAT = 0x666aB87ccd5ED3BAb22B781EEA21341f98AA1783;
    IERC721 rwo;

    event PriceChange(address _by, uint256 price);

    constructor() ERC721F("RWO", "RWOL") {
        setBaseTokenURI("ipfs://QmVy7VQUFtTQawBsp4tbJPp9MgbTKS4L7WSDpZEdZUzsiD/"); 
        _safeMint( KARL, 0);
        rwo = IERC721(0x9Fe317c29eC428CCD175473C16bFd383Fb892909); 
    }
    ...
    */
    ...
    function getSalePrice(uint256 numberOfTokens, address _address) public view returns (uint256) {
        ...
        if (preSaleIsActive && rwo.balanceOf(_address)>0 ){
    ...
    */
    function withdraw() public onlyOwner {
        ...
        _withdraw(KARL,(balance * 10) / 100);
        _withdraw(DENNIS,(balance * 20) / 100);
        _withdraw(KANAT,(balance * 10) / 100);
