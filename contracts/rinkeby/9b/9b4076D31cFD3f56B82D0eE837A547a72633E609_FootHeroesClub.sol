...
contract FootHeroesClub is ERC721, Ownable, ReentrancyGuard, PullPayment {
    ...
    // Constructor Inherits from ERC721 - > (Name Symbol)
    constructor() ERC721("FootHeroesClub", "Foot Heroes"){}

    function mintTo(address recipient, uint mintAmount) public payable
    {
        // @dev check sale state
