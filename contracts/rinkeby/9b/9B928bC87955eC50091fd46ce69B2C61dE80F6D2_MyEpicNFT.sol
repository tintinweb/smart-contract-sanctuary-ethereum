...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["BRAZILIANS", "AMERICANS", "ITALIANS", "ENGLISH", "GERMANS", "ARGENTINIANS", "PORTUGUESES", "MEXICANS", "RUSSIANS", "INDIANS", "CHINESE", "SPANISH", "FRENCH", "URUGUAYANS"];
  string[] secondWords = ["PIZZA", "BARBECUE", "PASTA", "ESFIHA", "SUSHI", "FEIJOADA", "MOUSSAKA", "WURST", "PARRILLADA", "LAMEN", "RATATOUILLE", "PAELLA", "HAMBURGUER"];
  string[] thirdWords = ["BEER", "WINE", "VODKA", "WHISKY", "CAIPIRINHA", "AGUARDENTE", "WATER", "MILK", "COCA", "JUICE", "TEA", "GIN", "SAKE", "SHOCHU", "CHAMPAGNE"];
  string[] colors = ["red", "#08C2A8", "black", "yellow", "blue", "green"];

  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721 ("CountryFoodBeerSquare", "CFBSQUARE"){
  ...
  function makeAnEpicNFT() public {
    ...
    string memory combinedWord = string(abi.encodePacked(first, "love", second, "and", third));
