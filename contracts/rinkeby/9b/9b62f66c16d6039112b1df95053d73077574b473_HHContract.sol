...
contract HHContract is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("HeroesHTEST", "HHSymbolTEST", maxBatchSize_, collectionSize_) {
    maxPerAddressDuringMint = maxBatchSize_;
    amountForTeam = amountForTeam_;
    require(
      amountForTeam_ <= collectionSize_,
...
function gift(address[] calldata receivers) external onlyOwner {
      require(totalSupply() + receivers.length <= collectionSize, "MAX_MINT");
  ...
  function reserveGiveaway(uint256 num, address walletAddress)
      ...
      onlyOwner
  {
      require(totalSupply() + num <= collectionSize, "Exceeds HH_TOTAL");
  ...
  function withdrawMoney() external onlyOwner nonReentrant {
    uint256 balance = address(this).balance;
      payable(0xE3Af2fb66c545b77BFD7Bfc10F5FaE3fEbdEeFC4).transfer((balance * 40) / 100);
      payable(0xE3Af2fb66c545b77BFD7Bfc10F5FaE3fEbdEeFC4).transfer((balance * 30) / 100);
      payable(0xE3Af2fb66c545b77BFD7Bfc10F5FaE3fEbdEeFC4).transfer((balance * 30) / 100);
  }
