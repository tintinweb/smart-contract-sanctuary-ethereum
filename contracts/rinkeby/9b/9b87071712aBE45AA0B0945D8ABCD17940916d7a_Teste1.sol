...
contract Teste1 is ERC4973 {
    ...
    function issue(address _issuee, string calldata code) external onlyOwner {
        _mint(_issuee, count, code);
        count += 1;
        xCode = string(abi.encodePacked(baseURI, code));
    }
