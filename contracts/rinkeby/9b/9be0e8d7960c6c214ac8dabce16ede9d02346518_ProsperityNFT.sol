...
contract ProsperityNFT is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transaction = 5; // maximam amount that user can mint per transaction
  uint256 public MAX_PER_Address = 10; // maximam amount that user can mint

  uint256 public  PRICE = 0.8 ether; //0.4 WL price 0.8 eth public sale
...
//   uint private reserveNFTs=88;
  ...
  uint public whitelistSpots=370;
  ...
  constructor() ERC721A("Prosperity","PROSPER", MaxMintPerBatch_, TotalCollectionSize_) {
    _baseTokenURI ="https://gateway.pinata.cloud/ipfs/QmeCBGNCtgb6zwJRVjmJ6CKX852Q8cPxJgtm3R5vD5i7cL/";
  }
  ...
  function withdrawMoney() external onlyOwner nonReentrant {
    (bool ambassadors, ) = payable(0x091ED113c74b28671Dd0B2363AF56ACf6099dd27).call{value: address(this).balance * 5 / 100}("");
    require(ambassadors, "Transfer failed.");
    (bool dev, ) = payable(0x134855a52C0668a51595C13F3049617B278f9Fb6).call{value: address(this).balance * 10 / 100}("");
    require(dev, "Transfer failed.");
    (bool investor, ) = payable(0x287f0e6935f5E7D3884c806779A35A73DcF87595).call{value: address(this).balance * 30 / 100}("");
    require(investor, "Transfer failed.");
