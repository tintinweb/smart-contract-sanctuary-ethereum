...
contract Mfers is ERC721A, Ownable, ReentrancyGuard{
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("3D Mfers", "Mfers") {
        PRICE = price;
    ...
    address private constant payoutAddress1 = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
