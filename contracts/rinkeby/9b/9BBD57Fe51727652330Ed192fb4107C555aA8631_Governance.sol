    ...
    GovernorTimelockControlUpgradeable
{
    ...
    function initialize(
        ...
        uint256 _proposalThreshold, // The number of votes required in order for a voter to become a proposer (common - 0)
        uint256 _votingDelay, //  Delay, in number of block, between the proposal is created and the vote starts. (1 -> 1 block)
        uint256 _votingPeriod, // Delay, in number of blocks, between the vote start and vote ends. (45818 -> 1 week)
        uint256 _quorumPercentage // Minimum number of cast voted required for a proposal to be successful.
    ) public initializer {
    ...
    IERC1155ReceiverUpgradeable
{
    ...
    mapping(uint256 => uint256) private _proposalIndexing;
    ...
    function proposalIndex() public view virtual returns (uint256) {
        return _proposalIndex;
    }

    function proposalIndexing(uint256 _index)
        public
        view
        virtual
        returns (uint256)
    {
        return _proposalIndexing[_index];
    }
    ...
    function propose(
        ...
        // _proposalIndexing[_proposalIndex] = ProposalView({
        //     id: proposalId,
        //     targets: targets,
        //     mvalues: values,
        //     calldatas: calldatas,
        ...
        // });
        _proposalIndexing[_proposalIndex] = proposalId;
        _proposalIndex += 1;
