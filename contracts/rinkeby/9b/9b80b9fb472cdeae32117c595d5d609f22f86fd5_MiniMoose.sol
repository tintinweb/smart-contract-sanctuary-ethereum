...
contract MiniMoose is ERC721Enumerable, Ownable {
    ...
    address private UnStakedMetaMooseMansion;
  ...
  function award (address _to) external  {
    ...
    require(
            msg.sender == address(UnStakedMetaMooseMansion),
  ...
  function setUnStakedMetaMooseMansion(address UnstakedMoose) public onlyOwner {
    UnStakedMetaMooseMansion = UnstakedMoose;
  }
