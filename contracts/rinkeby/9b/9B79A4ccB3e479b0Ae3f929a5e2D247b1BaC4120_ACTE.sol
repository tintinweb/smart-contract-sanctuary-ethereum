...
contract ACTE is AbstractERC1155Factory  {
    ...
    uint8 public maxAmountWhitelist = 1;
    uint private lastRandomNumber = 0;
    ...
    */
    ...
    function getRandomNumber(uint256 _upper) private returns (uint) {
        uint newRandomNumber = uint(keccak256(abi.encodePacked(block.timestamp, block.difficulty, lastRandomNumber, msg.sender))) % _upper;
    ...
    */
    ...
    function teamMint(uint256 id, uint256 amount) public onlyOwner {
