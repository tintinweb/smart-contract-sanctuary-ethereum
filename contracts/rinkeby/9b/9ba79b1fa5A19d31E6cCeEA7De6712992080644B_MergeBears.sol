...
contract MergeBears is ERC721A, Owner {
  ...
  // need both species & belly gene to determine
  ...
  function animationURI(uint256 tokenId) public view returns (bytes memory) {
    ...
    // Species-driven traits
    // Note: will be impacted by locale trait when added later
    // if (traitSpecies % 3 == 0) {
    //   // black
    //   arms = Arms.ARMS_AVERAGE;
    //   belly = Belly.BELLY_LARGE;
    //   feet = Feet.FEET_SMALL;
    //   head = IHead(headContract).getHead(0);
    // } else if (traitSpecies % 3 == 1) {
    //   // polar
    //   arms = Arms.ARMS_AVERAGE___POLAR;
    //   belly = Belly.BELLY_LARGE___POLAR;
    //   feet = Feet.FEET_SMALL_PANDA;
    //   head = IHead(headContract).getHead(1);
    // } else if (traitSpecies % 3 == 2) {
    //   // panda
    //   arms = Arms.ARMS_AVERAGE;
    //   belly = Belly.BELLY_LARGE___PANDA;
    //   feet = Feet.FEET_SMALL;
    //   head = IHead(headContract).getHead(2);
    // }

    // if (traitEyes % 4 == 0) {
    //   eyes = Eyes.EYES_DILATED_BLUE_EYES;
    // } else if (traitEyes % 4 == 1) {
    //   eyes = Eyes.EYES_NEUTRAL_BLUE_EYES;
    // } else if (traitEyes % 4 == 2) {
    //   eyes = Eyes.EYES_SQUARE_BLUE_EYES;
    // } else if (traitEyes % 4 == 3) {
    //   eyes = Eyes.EYES_SURPRISED_BLUE_EYES;
    // }

    // if (traitMouth % 8 == 0) {
    //   mouth = Mouth.MOUTH_ANXIOUS;
    // } else if (traitMouth % 8 == 1) {
    //   mouth = Mouth.MOUTH_BABY_TOOTH_SMILE;
    // } else if (traitMouth % 8 == 2) {
    //   mouth = Mouth.MOUTH_PINK_LIPSTICK;
    // } else if (traitMouth % 8 == 3) {
    //   mouth = Mouth.MOUTH_SAD_FROWN;
    // } else if (traitMouth % 8 == 4) {
    //   mouth = Mouth.MOUTH_SMILE;
    // } else if (traitMouth % 8 == 5) {
    //   mouth = Mouth.MOUTH_SMIRK;
    // } else if (traitMouth % 8 == 6) {
    //   mouth = Mouth.MOUTH_TONGUE_OUT;
    // } else if (traitMouth % 8 == 7) {
    //   mouth = Mouth.MOUTH_TOOTHY_SMILE;
    // }

    // if (traitNose % 3 == 0) {
    //   nose = Nose.NOSE_BLACK_NOSTRILS_SNIFFER;
    // } else if (traitNose % 3 == 1) {
    //   nose = Nose.NOSE_BLACK_SNIFFER;
    // } else if (traitNose % 3 == 2) {
    //   nose = Nose.NOSE_WIDE_BLACK_SNIFFER;
    // }
    ...
    return
      abi.encodePacked(
        ...
        Base64.encode(
          abi.encodePacked(
            '<html><head><style>body,html{margin:0;display:flex;justify-content:center;align-items:center;background:', getAssetBackground(getOptionBackground(dna)), ';overflow:hidden}.a{width:min(100vw,100vh);height:min(100vw,100vh);position:relative}.b{width:100%;height:100%;background:100%/100%;image-rendering:pixelated;position:absolute}.h{animation:1s ease-in-out infinite d}@keyframes d{0%,100%{transform:translate3d(-1%,0,0)}25%,75%{transform:translate3d(0,2%,0)}50%{transform:translate3d(1%,0,0)}}</style></head><body>',
              '<div class="a">',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.BELLY, getAssetBelly(getOptionSpecies(dna), getOptionBelly(dna))), ')"></div>',
                // '<div class="b" style="background-image:url(data:image/png;base64,', arms, ')"></div>',
                // '<div class="b" style="background-image:url(data:image/png;base64,', feet, ')"></div>',
                '<div class="b h">',
                  // '<div class="b" style="background-image:url(data:image/png;base64,', head, ')"></div>',
                  // '<div class="b" style="background-image:url(data:image/png;base64,', eyes, ')"></div>',
                  // '<div class="b" style="background-image:url(data:image/png;base64,', mouth, ')"></div>',
                  // '<div class="b" style="background-image:url(data:image/png;base64,', nose, ')"></div>',
                '</div>',
              '</div>',
            '</body></html>'
          )
