...
contract boobiesboobies  is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://UA76G5NQQSZFGEWFAIRD5MIC584KRRKYNW/";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("goblin boobies", "BOOB") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(quantity == 3, "Only #heretomatch free");
