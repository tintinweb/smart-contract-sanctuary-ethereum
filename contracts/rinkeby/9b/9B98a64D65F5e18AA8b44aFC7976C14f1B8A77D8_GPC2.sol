...
contract GPC2 is ERC721A, Ownable, ReentrancyGuard {
    ...
    IGPC GPC_CHEMISTRY_CONTRACT =
        IGPC(0x88B48F654c30e99bc2e4A1559b4Dcf1aD93FA656); //OS OpenStore Smart Contract Address

    string public contractURI; //link to metadata.json for contract info
    ...
    constructor() ERC721A("Gold Panda Club 2", "GPC2") {
        royaltyReceiver = msg.sender; //contract owner will be royalty receiver
    }
...
contract ERC721A is IERC721A {
    ...
    mapping(uint256 => bool) public mutantsIndexes;
    ...
    function _packedOwnershipOf(uint256 tokenId) private view returns (uint256) {
        ...
        unchecked {
            if (_startTokenId() <= curr)
                if (curr < _currentIndex || mutantsIndexes[curr]) {
    ...
    function _safeMint(
        ...
        uint256 startTokenId = tokenId != 0 ? tokenId: _currentIndex;
        ...
        unchecked {
            ...
            if (to.code.length != 0) {
                do {
                    ...
                    if(tokenId != 0){
                        mutantsIndexes[updatedIndex] = true;
                    }
            ...
            _currentIndex = tokenId != 0 ? _currentIndex : updatedIndex;
        }
