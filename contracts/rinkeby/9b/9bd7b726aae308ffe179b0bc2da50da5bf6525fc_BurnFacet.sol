...
contract BurnFacet is Base, IBurn {
    ...
    function _burn(
        ...
        if (_tokenId < s.nftStorage.startingTokenId || _tokenId > s.nftStorage.nextTokenId - 1) revert QueryNonExistentToken();
        ...
        s.nftStorage.balances[_from]--;
        s.nftStorage.burnCounter++;
        s.nftStorage.burnedTokens[_tokenId] = true;
