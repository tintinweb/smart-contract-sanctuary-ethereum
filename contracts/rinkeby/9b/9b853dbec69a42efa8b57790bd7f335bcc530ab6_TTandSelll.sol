...
contract TTandSelll is ERC721, Ownable, ReentrancyGuard {
    ...
    uint ts = 1;
    constructor() ERC721("TLandTerst", "TYLAND") {}
    ...
    function isSYHolder(address _claimer, bytes32[] memory _merkleProof) public view returns (bool){
