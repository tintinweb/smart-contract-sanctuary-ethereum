...
contract NowlyCollection is ERC721, Ownable {
    constructor(uint256 _totalSupply, string memory _baseUri, string memory _extension)
    ...
    {
        if(!reveal) {
            return string("https://firebasestorage.googleapis.com/v0/b/kimjo-chat.appspot.com/o/avatar.json?alt=media");
        }
    ...
    modifier onlyOwnerOrAuthorized() {
        require(isAddressAuthorized(msg.sender) == true || owner() == msg.sender, "Caller is not the Owner or Authorized");
        _;
    }
}
