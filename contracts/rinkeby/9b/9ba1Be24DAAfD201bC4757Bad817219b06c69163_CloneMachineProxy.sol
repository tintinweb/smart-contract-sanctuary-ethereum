...
contract CloneMachineProxy is IJuice, ReentrancyGuard, Ownable {
    ...
    function getCloneLevels(
        ...
        uint256[] memory d1Clones, 
        uint256 d1Counter, 
        uint256[] memory d2Clones, 
        uint256 d2Counter, 
        uint256[] memory d3Clones, 
        uint256 d3Counter
    )  {
        ...
        d1Clones = new uint256[](d1Counter);
        for (uint256 i = 0; i < d1.length; i++) {
            d1Clones[i] = d1[i];
        }

        d2Clones = new uint256[](d2Counter);
        for (uint256 i = 0; i < d2.length; i++) {
            d2Clones[i] = d2[i];
        }

        d3Clones = new uint256[](d3Counter);
