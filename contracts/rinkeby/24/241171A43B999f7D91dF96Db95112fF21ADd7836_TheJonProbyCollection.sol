...
//Thanks to Hashlips NFT for the instruction 
...
contract TheJonProbyCollection is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    // Mints & Shovels receives 10% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0x0948CBb6F90DBE952bBb5C88F72419dEf54b0eaa).call{value: address(this).balance * 5 / 100}('');
    require(hs);
    // =============================================================================
