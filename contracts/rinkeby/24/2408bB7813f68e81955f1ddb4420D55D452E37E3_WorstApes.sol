...
contract WorstApes is ERC721A, Ownable, ReentrancyGuard {
    ...
    // ********************************************
    // 下面这里填合约元数据json文件ipfs地址,格式如下
    // {
    //   "name": "合约名",
    //   "description": "合约信息",
    //   "image": "ipfs://项目头像",
    //   "external_link": "项目官网",
    //   "seller_fee_basis_points": 版税比例(例如5%则填500),
    //   "fee_recipient": "收款地址"
    // }

    string private _contractMetadataURI =
        "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
    // *********************************************
    ...
    constructor() ERC721A("Worst Apes", "WorstApes", 20, 10000) {
        // 这里填你的图片地址
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount <= maxPerMint, "TFB: Exceeds the single maximum limit.");
