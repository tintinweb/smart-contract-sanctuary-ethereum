...
contract SoulData is ISoulData, Adminable {
        ...
        returns (string memory) 
    {
        return string(abi.encodePacked('"attributes":[',
            ...
            _badgeTraits,
            '{"trait_type":"Score","value":', toString(_score), ',"display_type": "boost_number"}]}'
        ));
    }
...
interface ISoulData {
    ...
    /**
     * @dev Get token meta name, desc, and svg image
     */
