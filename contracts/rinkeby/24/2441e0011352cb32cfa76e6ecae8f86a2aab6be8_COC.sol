...
contract COC is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmUJqikxZmdhV2LnnDjpTgDKKKEqYdJ8TpwTGjbdxLvXG3";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmUJqikxZmdhV2LnnDjpTgDKKKEqYdJ8TpwTGjbdxLvXG3";
    ...
    address public teamWallet = 0x0d59183A3Cd2E840861215CdEC784e334DCC6434;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Jango man", "JNM") { }


   //reduce gas on first transaction
    ...
    function teamMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= 100, "Team mints after free");
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(quantity <= 10, "Only 10 max per transaction");
