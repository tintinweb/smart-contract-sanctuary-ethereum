...
contract TheWhitelist is MintpassValidator, ERC721Burnable, ERC2981, Ownable {
    ...
    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmamT5bLagpn1oH2jhHjDJXjrdZJ93qGmdBYiz5mpTiRao/";
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        ACE_WALLET = 0x8cbFE1c44CD58771e0b827868461925Ae0B45258;
        //Spart Gas
        totalSupply = 0;
    }
