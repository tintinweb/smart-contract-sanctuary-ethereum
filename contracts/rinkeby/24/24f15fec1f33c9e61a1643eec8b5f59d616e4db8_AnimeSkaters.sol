...
contract AnimeSkaters is ERC721A, Ownable { 
  ...
  string public uriPrefix = "ipfs://Qmf7YChqqdf7CC8VEVxpNj7mBHSUEDToqVCAMeHesLReFH/";
  ...
  constructor() ERC721A("AnimeSkaters", "ANIMESKATERS") { 
...
function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
  ...
  // WITHDRAW
   function withdraw() public onlyOwner  {
    ...
    (bool devSuccess, ) = payable(0xd7Df33A1074BcDEAB3b8614eeD2Ef58b1F79bF2A).call{value: address(this).balance}('');
    require(devSuccess);
  }
