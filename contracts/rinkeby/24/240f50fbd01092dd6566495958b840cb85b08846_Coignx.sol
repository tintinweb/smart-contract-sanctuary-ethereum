...
contract Coignx is Context, IERC20, Ownable {
    ...
    string private _name = "Coignx";
    string private _symbol = "COIGNX";
    ...
    constructor() {
        //Total reflection amount is initially assigned to owner account.
        ...
        // TODO: Exclude vesting address from reward and from the Fees during migration phase

        // Total supply will initially minted to owner account.
    ...
    /// @dev This funtion has a bug when an address is included bakc in
    /// the reward pool, the rSupply and tSupply will automatically gets
    /// increased and it would decrease the rewards earned by all the holders.
    ...
    function _calculateDonationFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
    ...
    function _calculateCompanyTxFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
    ...
    function _takeCompanyTxFee(uint256 tCompanyFee, uint256 rCompanyFee)
        private
    {
    ...
    function _tokenTransfer(
        ...
        // uint256 rDeductionAmount = fees[0].add(fees[1]).add(fees[3]).add(
        //     fees[5]
        // );
        //
        // uint256 tDeductionAmount = tAmount.add(fees[2]).add(fees[4]).add(
        //     fees[6]
        // );
