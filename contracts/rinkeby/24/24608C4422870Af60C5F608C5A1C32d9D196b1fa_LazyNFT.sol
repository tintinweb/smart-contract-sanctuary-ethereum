...
contract LazyNFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    event handleMint(string indexed status);
    event isCheckAddresses(
        address indexed signer,
        address indexed signerVerify
    );
    ...
    function mint(
        ...
        address signerVerify = _verify(tokenId, uri, signature);
    ...
    function _hash(uint256 tokenId, string memory uri)
        internal
        view
        returns (bytes32)
    {
    ...
    function _verify(
        ...
        bytes32 digest = _hash(tokenId, uri);
