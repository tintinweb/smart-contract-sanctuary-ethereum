    ...
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmZgty13wwbLieqSFzJsuNzJ3nrrjpeXHWVwSvfJiLQ32u/hidden.json";
    ...
    uint256[] private _teamShares = [100]; // 1 person gets all shares
    address[] private _team = [
        
        0xF6a610480f78C24D9dC7a0Bec945fE303e55B533 // VIP Account gets 100% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("Kitsune", "Kitsune")
