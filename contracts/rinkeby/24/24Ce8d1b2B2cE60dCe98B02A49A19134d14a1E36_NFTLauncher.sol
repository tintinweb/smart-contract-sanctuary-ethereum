...
contract NFTLauncher is VRFConsumerBase, ChainlinkClient {
    ...
    function purchasePack(
        ...
        if (projectP2.maxPurchaseAmountPerWallet > 0) {
            require(
                ...
                "3" //"You have already purchased this many packs"
            );
        }
        ...
        if (project.whitelisted) {
            ...
            require(project.whitelist[msg.sender] == true, "4"); //not whitelisted
        }
        (
            ,
            address paymentMethodAddress,
        ...
        require(
            ...
            "Please allow contract to spend your tokens!" // "Please allow contract to spend your tokens!"
        );
        token.transferFrom(
            msg.sender,
            address(this),
    ...
    function isValidCaller(uint256 projectrid)
        ...
        returns (bool validProject)
    {
        require(projects[projectrid].owner == tx.origin || tx.origin == owner, "Invalid caller");
        return true;
    }
