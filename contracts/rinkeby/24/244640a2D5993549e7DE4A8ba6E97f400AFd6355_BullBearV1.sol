...
contract BullBearV1 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, KeeperCompatibleInterface  {
...
"https://ipfs.io/ipfs/QmbKhBXVWmwrYsTPFYfroR2N7NAekAMxHUVg2CWks7i9qj?filename=simple_bear.json" ];
  ...
  // initialize an object that uses AggregatorV3Interface and connects to an aggregator contract on Rinkeby testnet
  // the aggregator is a proxy for the BTC/USD data feed
  constructor(uint _updateInterval) ERC721("Bull&Bear", "BBTK") {
