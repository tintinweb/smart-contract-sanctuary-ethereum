...
interface IMarketplaceCore {
    function getTrustedParty() external returns (address);
}
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function auctionOrder(
        ...
        matchAuctionOrder(orderLeft, orderRight);
    }
    ...
    */
    ...
    function getTrustedParty() external view override returns (address) {
