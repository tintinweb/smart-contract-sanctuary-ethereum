...
// Horizon... Initializing... Say goodbye to freedom and hello to "Mindlock"
...
contract SoulBound0927 is ERC721, Ownable {

    using Counters for Counters.Counter;
    Counters.Counter private _tokenSupply;

    RO private ro = RO(0xb858430ab3897b39CcD9208202b78E2BcBaac541); //rinkeby

    bool public claimIsActive = false;

    string private _baseTokenURI;

    constructor() ERC721("Soulbound 0927", "Bound0927") { }
    ...
    function _beforeTokenTransfer(address from, address to, uint256) pure override internal {
        require(from == address(0) || to == address(0), "These tokens cannot be transferred");
    }
    ...
    function claimPortrait(uint256 portraitToClaim) public {
        require(claimIsActive, "Claim is not active");
        require(ro.ownerOf(portraitToClaim) == msg.sender, "You do not own this token");
        
        if (_exists(portraitToClaim)){_burn(portraitToClaim);}
        _safeMint(msg.sender, portraitToClaim);
    }
