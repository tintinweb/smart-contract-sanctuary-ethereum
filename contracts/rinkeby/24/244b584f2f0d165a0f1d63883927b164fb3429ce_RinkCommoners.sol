...
contract Commoners is ERC721A {
    ...
    function _airdropTopTalents() internal {
        ...
        for (uint8 i = 1; i <= 4; i++) {
            ...
            /**
             * Catharine is 5 alchemy, 1 smithing, 1 cooking.
             * Rudy is 5 smithing, 1 alchemy, 1 cooking.
             * Charlie is 5 cooking, 1 alchemy, 1 smithing.
             * Pom is 4 to smithing, alchemy, and cooking.
             */
            if(i == 1) { // Catharine is 5 alchemy, 1 smithing, 1 cooking.
                commoners[topCommoner_].smithing = 1;
                commoners[topCommoner_].alchemy = 4;
                commoners[topCommoner_].cooking = 1;
            } else if(i == 2) { // Rudy is 5 smithing, 1 alchemy, 1 cooking.
                commoners[topCommoner_].smithing = 4;
                commoners[topCommoner_].alchemy = 1;
                commoners[topCommoner_].cooking = 1;
            } else if(i == 3) { // Charlie is 5 cooking, 1 alchemy, 1 smithing.
                commoners[topCommoner_].smithing = 1;
                commoners[topCommoner_].alchemy = 1;
                commoners[topCommoner_].cooking = 4;
            } else if(i == 4) { // Pom is 4 to smithing, alchemy, and cooking.
                commoners[topCommoner_].smithing = 4;
                commoners[topCommoner_].alchemy = 4;
                commoners[topCommoner_].cooking = 4;
            }
