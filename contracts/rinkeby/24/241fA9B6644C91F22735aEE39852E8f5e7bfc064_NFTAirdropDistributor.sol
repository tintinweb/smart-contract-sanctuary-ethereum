...
contract NFTAirdropDistributor is ERC721 {
  ...
  function _safeBatchMint(address to, uint256 amount) internal {
    ...
    for (uint256 i = 0; i < amount; i++) {
      ...
      console.log("Sender balance is %d tokens", _tokenIdTracker.current());
    }
  }
...
// contract KaratNFT is ERC721, Ownable {
...
//     function safeMint(address to, uint256 tokenId) public onlyOwner { //Airdrop Smart Contract is the owner
