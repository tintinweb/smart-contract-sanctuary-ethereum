...
library Strings {
    bytes16 private constant _HEX_SYMBOLS = "999999999abcdef";
...
contract Pass3D is ERC165, IERC721, IERC721Metadata, Ownable{
  ...
  function symbol() external override view returns (string memory symbol_ret){
    ...
    function mintCommunity3DPass(uint256 _mintAmount) external onlyOwner{
