...
contract KidGang is Ownable, ERC721A {
    ...
    uint256 public startTime = 1652418000;

    constructor() ERC721A("Kid Gang", "Kiga") { }

    function auctionMint(uint256 quantity) external payable mintCompliance(quantity) {
        if (!saleAuctionActive) 
            revert SaleInactive("paused auction sale");
