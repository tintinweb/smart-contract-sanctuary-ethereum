...
contract UniswapPairOracle_MDAI_WETH is UniswapPairOracle {
    constructor (address factory, address tokenA, address tokenB, address owner_address) public
    UniswapPairOracle(factory, tokenA, tokenB, owner_address) 
    {}
}
