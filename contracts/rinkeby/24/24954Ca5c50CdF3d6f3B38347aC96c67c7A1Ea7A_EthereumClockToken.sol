...
contract EthereumClockToken is IEthereumClockToken, Raffle, ERC721Tradable
{
     ...
     */
    constructor(string memory _pendingURI, address _chainLinkVRFCoordinator, address _linkTokenAddress, address _proxyRegistryAddress) ERC721Tradable("Ethereum Clock Token", "Eth-Clock", _proxyRegistryAddress) Raffle(_chainLinkVRFCoordinator, _linkTokenAddress) {
