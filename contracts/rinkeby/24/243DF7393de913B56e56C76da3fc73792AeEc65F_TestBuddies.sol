...
contract TestBuddies is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PURCHASABLE = 10;
    ...
    string public baseURIExtended =
        "https://gateway.pinata.cloud/ipfs/QmYMrhB8ihTvxrCJDARhnuSDttN6pkJu8nWwghTk67L4Kc/";
    string public extension = ".json"; // configurable extension
    bool public saleIsActive = false;
    bool public allowlistActive = false;

    // team wallet addresses
    // TODO: need full team wallet addresses
    address public a1 = 0x33A4622B82D4c04a53e170c638B944ce27cffce3; // catalyst digital
    address public a2 = 0x66aB6D9362d4F35596279692F0251Db635165871; // emo buddies wallet
        ...
        nonReentrant
    {
        ...
        require(
            numberOfTokens <= MAX_PURCHASABLE,
    ...
    //TODO: update with team percentages

    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        require(balance > 0, "Nothing to withdraw");

        _widthdraw(a1, balance.mul(5).div(100)); // cd 5%
        _widthdraw(a2, address(this).balance); // rest to owner (emobuddie's wallet as owner will be transferred)
    }
