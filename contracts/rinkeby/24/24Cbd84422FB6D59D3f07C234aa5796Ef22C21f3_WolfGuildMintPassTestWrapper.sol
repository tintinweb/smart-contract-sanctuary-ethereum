...
import "../WolfGuildMintPass.sol";

contract WolfGuildMintPassTestWrapper is WolfGuildMintPass {
    constructor (string memory _uri) WolfGuildMintPass(_uri) {}

    function freeMint(uint256 tokenId, uint256 amount) public {
