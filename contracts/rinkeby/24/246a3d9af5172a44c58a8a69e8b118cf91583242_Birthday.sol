...
contract Birthday is IBirthday, ERC721Pausable, ERC721Enumerable, ERC721Burnable, ERC721URIStorage, Ownable {
        ...
        string memory json = Base64.encode(
            bytes(string(
                abi.encodePacked(
                    ...
                    '"description": "NFT DOB is a collection of 20,000 Date of Birth NFTs; unique digital collectibles living on the Ethereum blockchain. Each DOB NFT is a unique date between 01-01-1970 and 03-10-2024. Once minited, the date is stored on the blockchain in ASCII art form with a supported SVG image.",',
                    '"external_link": "https://nftdob.com", "seller_fee_basis_points": 250, "fee_recipient": "HARDCODEWALLET"}'
                )
            ))
        );
    ...
    */
    function mint(uint tokenId, bool mdy) external payable override returns (string memory) {
        ...
        ownerToIds[msg.sender].push(tokenId);
    ...
    function getSvg(string memory imageData) private view returns (string memory) {
        ...
        string memory dayMonth = string(abi.encodePacked(substring(imageData, 124, 168), "</text><text x='180' y='68' >", substring(imageData, 171,215), "</text><text x='180' y='84' >", substring(imageData, 218,262), "</text><text x='180' y='100'>", substring(imageData, 265,309), "</text><text x='180' y='116'>", substring(imageData, 312,356)));
        string memory year = string(abi.encodePacked(substring(imageData, 453,497), "</text><text x='180' y='180'>", substring(imageData, 500,544), "</text><text x='180' y='196'>", substring(imageData, 547,591), "</text><text x='180' y='212'>", substring(imageData, 594,638), "</text><text x='180' y='228'>", substring(imageData, 641,685)));
        string memory md = substring(imageData, 782, 784);

        svg = string(abi.encodePacked(
            "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='288' width='360' viewBox='0 0 360 288' style='background-color:white' class='diagram' text-anchor='middle' font-family='monospace' font-size='13px'><g class='text'><text x='180' y='20'>............................................</text><text x='180' y='36'>............................................</text><text x='180' y='52' >", dayMonth, "</text><text x='180' y='132'>............................................</text><text x='180' y='148'>............................................</text><text x='180' y='164'>", year, "</text><text x='180' y='244'>............................................</text><text x='180' y='260'>............................................</text><text x='16' y='276'>", md ,"</text></g></svg>"
        ));
        return svg;
    } 
...
interface IBirthday is IERC721Enumerable {
