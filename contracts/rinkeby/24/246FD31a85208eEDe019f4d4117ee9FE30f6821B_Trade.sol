...
contract Trade {
    ...
    function tradingFee() external view virtual returns (uint8) {
    ...
    function tradeAsset(Order calldata order, Fee memory fee, address buyer, address seller) internal virtual {
        ...
        if(fee.tradingFee > 0) {
            transferProxy.erc20safeTransferFrom(IERC20(order.erc20Address), buyer, owner, (fee.tradingFee));
            transferProxy.erc20safeTransferFrom(IERC20(order.erc20Address), seller, owner, (fee.tradingFee));
        }
    }
