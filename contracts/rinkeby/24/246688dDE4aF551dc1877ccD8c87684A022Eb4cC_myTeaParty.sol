...
contract myTeaParty is Ownable, Pausable, ERC721A, ReentrancyGuard {
    ...
    // TODO: update to 0.25 and 0.35 before mainnet deployment 
    uint256 public constant _presalePrice = 0.1 ether;
    uint256 public constant _publicsalePrice = 0.15 ether;

    uint256 public ownershipSetCalls = 0;
    // uint256 public ownershipViewCalls = 0;
    ...
    function updateSaleTimestamp(
        ...
        // Set timestamp values in the contract 
    ...
    function getSaleStatus() public view returns (uint256) {
        /* Returns 
            0: before pre-sale
            1: pre-sale
            2: break after pre-sale (before public sale)
            3: public sale (before reveal)
            4: public sale (after reveal)
            5: invalid (timestamps not initialized)
        */
        if (
            revealTimestamp == 0 ||
        ...
        nonReentrant
    {
        ...
        // number minted here affects the numberMinted()
        require(!paused(), "The contract is paused"); 
        ...
        nonReentrant
    {
        ...
        ownershipSetCalls = ownershipSetCalls + 1;
