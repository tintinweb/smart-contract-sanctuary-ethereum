...
contract GangsterAllStarsOG is ERC721I, Ownable {
    constructor() ERC721I("Gangster All Stars OG", "GASOG") {}
    ...
    // Modifiers
    modifier onlySender { require(msg.sender == tx.origin, "No SC!"); _; }
    modifier migrator { require(migrationEnabled, "M false!"); _; }
    ...
    function isCreatedByGAS(uint256 tokenId_) public pure returns (bool) {
        return tokenId_ >> 96 == 0x000000000000000000000000077afa85c86ac799b04d0f7aab6c81bfe4186773;
    }
