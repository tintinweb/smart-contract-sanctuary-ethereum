...
contract WTDNFTMarket is ReentrancyGuardUpgradeable, NFTMarket, SendValueWithFallbackWithdraw {
    ...
    struct Listing {
        address nftContract; //0x50AC6428AE297B04E81cdeEc8A2901c899879453
        uint256 tokenId; // 6
        address payable seller; //0xa4a9AcaDb282C4bd5FcceC6160d3ED035180800f
        uint256 extensionDuration; //900
        uint256 endTime; // 1654018936
        address payable bidder; //0x0000000000000000000000000000000000000000
        uint256 amount; // startPrice //550000000000000000
        bool fixedPrice; //true
        uint256 minPercentIncrementInBasisPoints; //0
    }
    ...
    event ListingCreated(uint256 listingId, uint256 tokenId);
    ...
    function createListing(
        ...
        emit ListingCreated(listingId, tokenId);
    }
