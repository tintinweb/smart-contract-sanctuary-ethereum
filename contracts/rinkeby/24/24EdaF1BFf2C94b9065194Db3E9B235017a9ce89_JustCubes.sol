...
contract JustCubes is ERC721A, Ownable, ReentrancyGuard {
    ...
    //Mint limits
    uint256 public immutable ADDRESS_MAX_MINTS = 10;
    uint256 public immutable ADDRESS_OG_MAX_MINTS = 2;
    uint256 public immutable ADDRESS_WL_MAX_MINTS = 3;
    uint256 public immutable PUBLIC_MINT_PER_TX = 10;
    ...
    constructor() ERC721A("TribeX", "TRIBEX") {}
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        _withdraw(CC_ADDRESS, (contractBalance * 19) / 100);
    }
