...
contract XTOKEN is Ownable, IBEP20 {
    ...
    uint256 _totalSupply = 1000000 * (10 ** _decimals); //Set Supply
    ...
    uint256 public rewardsFee = 5; // Tax for Rewards -- Actual wallet split set below at "amountToRewards"
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 2000; //Amount to swap for Development/Marketing/Rewards -- Set to 0.2% or 2,000,000,000 currently.
    ...
    constructor() {
        ...
        developmentWallet = 0xDEfc7d8A921CED3fAc8eBB69B65dd98778B7Bec7; //Address for development costs
        marketingWallet = 0x8754e93Bac852BDa88Bca1431E6B8eddA20a060e; //Address for marketing fees
        rewardsWallet = 0x2bbe7A4ea4d8C64BdF85073A6Dbc81072ee5B75B; //Address for rewards
