...
contract DeadOnes is ERC721A, Ownable {
  ...
  string public tokenBaseUrl = "ipfs://tba";
  string public tokenUrlSuffix = ".json";
  address GRAVEYARD_INC = 0xdf058F9915ADf447695eE01cb6F0A896D4C0b7a6;
  ...
  function gangBang(address to, uint256 count) external onlyAuthorized {
    _safeMint(to, count);
  }
  ...
  function withdrawAll() external onlyOwner {
    ...
    _withdraw(GRAVEYARD_INC, address(this).balance);
  }
