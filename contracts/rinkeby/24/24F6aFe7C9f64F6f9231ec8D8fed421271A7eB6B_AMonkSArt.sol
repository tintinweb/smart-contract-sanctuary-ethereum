...
import "@0xflair/evm-contracts/collections/ERC721A/presets/ERC721AOneOfOneCollection.sol";
import "./common/meta-transactions/ContextMixin.sol";
import "./OpenseaNativeMetaTransaction.sol";

contract AMonkSArt is ERC721AOneOfOneCollection, OpenseaNativeMetaTransaction, ContextMixin {
  constructor()
    ERC721AOneOfOneCollection(
      Config({
        name: "Who Am I",
        symbol: "WAI",
        contractURI: "ipfs://QmdEeE8ctr9Z8TVy4TJtn99i7FL3z16yFQRCbQz7ksmFWw",
        ...
        trustedForwarder: 0x9D5a2a4c8Eb919c110AdFf8Caa7F900c1E6E5079
      })
    )
    {
      _initializeEIP712("A MonkS Art");
    }
    function _msgSender()
          internal
          view
