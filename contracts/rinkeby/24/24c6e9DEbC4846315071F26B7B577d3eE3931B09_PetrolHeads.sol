...
contract PetrolHeads is Ownable, Pausable, RandomlyAssigned, ERC721Enumerable {
    ...
    function giveawayByClaimCode(string memory claimCode, bytes32[] calldata _merkleProof) external payable {
        require(
            PRICE <= msg.value,
            "ETH amount is not sufficient"
        );		
