...
contract Podium is Ownable, ERC721R, ReentrancyGuard, Pausable {
	...
	ERC721R("Podium", "PODIUM", reservedQuantity_, collectionSize_, refundTimeIntervals_, refundIncrements_) {
    ...
    */
    ...
    /**
     * Remove team meber role with admin permissions
    */
  ...
  IERC721Enumerable
{
  ...
  // Mappring from token ID to purchase price and current
