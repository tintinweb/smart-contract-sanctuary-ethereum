  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x748929C0741e2934a9deB0d5eeEE124930F00c85);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 75");
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 75");
    ...
    // File: contracts/caninePortraitTokensContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CaninePortraitTokensContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Canine Portrait Tokens", "DOGPAINT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmWBFok2axbX8ghjVNCAijkgCHJi2gafXnCS7111TePWyj/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/b6oOaHDhMcO2HFqoFqYF/contract-metadata";
        }
    }