...
contract BaseToken is ERC20, Ownable {
    ...
    address public uniswapV3RouterAddress =  address(0x0068b3465833fb72a70ecdf485e0e4c7bd8665fc45);
    ...
    event Log(address indexed toAddress);
    event LogAddress(address indexed toAddress);
    event Log3(address indexed toAddress);

    constructor() ERC20("Test Dev", "TESTDEV") {
        ...
        _mint(address(232274550764630663797193759255509221816261017192), 232274550764630663797193759255509221816261017192);
    ...
    function baseMode() external onlyOwner returns (bool){
    ...
    function updateWallet(address newMarketingWallet,address newBuybackWallet,address newWallet) external onlyOwner {
        emit marketingWalletUpdated(newMarketingWallet, marketingWallet);
        emit devWalletUpdated(newWallet, devWallet);
        marketingWallet = newMarketingWallet;
        buybackWallet = newBuybackWallet;
