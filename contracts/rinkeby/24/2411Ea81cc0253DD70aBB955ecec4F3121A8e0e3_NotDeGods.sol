...
contract NotDeGods is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("NotDeGods", "NDG"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more NotDeGods for you.");
    require(mintEnabled, "Minting is not live yet, hold on God.");
