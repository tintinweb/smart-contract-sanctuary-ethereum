...
contract WoF is ERC721A, Ownable {
  ...
  uint256 public package3Price = 0.025 ether;
  uint256 public package4Qty = 6;
  uint256 public package4Price = 0.075 ether;
  uint256 public package5Qty = 10;
  uint256 public package5Price = 0.125 ether;
  ...
  constructor() ERC721A("World of Flowers", "woflower", 100) {  }
  ...
  function mintPackage(uint256 _packageNumber) external payable {
    ...
    if(_packageNumber == 1 && onFreeMint && balanceOf(_msgSender()) == 0) {
    ...
    returns (string memory)
  {
    ...
    if (revealed == false) {
      return "https://gateway.pinata.cloud/ipfs/QmeHb81BsHEhK9viKkcRufbsWfNHhM4mCpd6hEBx4pa1Nz";
    }
