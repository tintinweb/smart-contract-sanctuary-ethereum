...
contract BurNft is ERC721, Ownable {
    ...
    uint256 private price = 0.1559 ether;
    ...
    uint256 private gasCompensationSafeTransferNoDataPlusToZero = 8074;
    uint256 private gasCompensationSafeTransferNoDataPlusNotToZero = 7992;
    uint256 private gasCompensationSafeTransferWithDataPlusToZero = 8405;
    uint256 private gasCompensationSafeTransferWithDataPlusNotToZero = 8324;
    uint256 private gasCompensationTransferPlusToZero = 8030;
    uint256 private gasCompensationTransferPlusNotToZero = 7948;
    ...
    mapping(uint256 => uint256) public previousGasSpent;
    ...
    function changeGasSettings(uint256 setting, uint256 value) external onlyOwner {
        if (setting == 0) { price = value; return; }
