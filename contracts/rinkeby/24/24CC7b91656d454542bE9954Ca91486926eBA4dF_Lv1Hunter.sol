...
contract Lv1Hunter is ERC721A, Payable {
    ...
    uint256 public tokenPriceOGSale = 0.028 ether;
    uint256 public tokenPricePresale = 0.033 ether;
    uint256 public tokenPricePublicSale = 0.038 ether;
    ...
    function mintOGSale(uint256 quantity, bytes32[] calldata proof)
        ...
        payable
        noBots
        isContractState(ContractState.OGSALE)
        withinMintLimit(quantity)
    ...
    function setContractState(uint contractState_) external onlyOwner {
        ...
        if (contractState_ == 0) {
            ...
            contractState = ContractState.OGSALE;
        }
