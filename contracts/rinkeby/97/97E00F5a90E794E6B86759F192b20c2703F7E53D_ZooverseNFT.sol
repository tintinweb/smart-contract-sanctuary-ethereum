    ...
    AccessControl
{
    ...
    function whitelistMint(bytes32[] calldata _merkleProof) public payable {
        ...
        require(currentTokenLength < maxSupply);
    ...
    function adminMint() public payable onlyRole(DEFAULT_ADMIN_ROLE) {
        zooMint();
    }

    function zooMint() internal {
    ...
    function setPublicMint(bool _canMint) public onlyRole(DEFAULT_ADMIN_ROLE) {
        publicMintEnabled = _canMint;
    }
