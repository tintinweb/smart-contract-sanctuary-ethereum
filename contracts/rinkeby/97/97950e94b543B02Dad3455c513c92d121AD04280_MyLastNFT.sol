...
contract MyLastNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address payable internal team =
        payable(0x4e40323f48EfD139D4510D506d08D60BCDe6E72f);
    address payable internal dev =
        payable(0xfCe9aC0D325bfa31a0d39E0F6EFd56fCA3f93dC9);

    uint256 public constant MINT_COST = 0.009624 ether;
    uint256 public MAX_SUPPLY = 18; //6942;
    uint256 public RESERVED_SUPPLY = 10; //942
