...
contract KNTest is ERC721, ERC721Pausable, Ownable {
    ...
    uint public constant TOKEN_PRICE = 10000000000000000; //0.01 ETH

    uint public constant PROVENANCE_HASH = 0; // TODO: make this the final number
    ...
    constructor(string memory initialBaseURI, uint _maxReserve) ERC721("KNTest", "KNT") {
    ...
    function mint(address to, uint numberOfTokens) public whenNotPaused payable {
