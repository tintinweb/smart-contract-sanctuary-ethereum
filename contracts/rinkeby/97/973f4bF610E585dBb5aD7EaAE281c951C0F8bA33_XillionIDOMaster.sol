...
contract XillionIDOMaster is XillionIDOCommon {
    ...
    function finish() external nonReentrant {
        ...
        if (totalInvestedAmount >= idoValueCap * minInvestmentPercentForIDOCompletion / 100 && isSuccessfullyFunded) {
    ...
    function claimPoolTokens() external nonReentrant {
        ...
        uint256 idoBEP20Balance = BEP20Token.balanceOf(address(this));
     ...
     */
    function setInvestmentBEP20Details(XillionIDOStructs.BEP20IDOTokenDetails calldata investmentBEP20Details_) external onlyOwner {
