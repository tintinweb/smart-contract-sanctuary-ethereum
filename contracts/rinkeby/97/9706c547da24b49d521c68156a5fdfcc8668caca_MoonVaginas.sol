    ...
    PaymentSplitter 
{
    ...
    uint256 _price = 69690000000000000; // 0.06969 ETH

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [100]; 
    address[] private _team = [
        0xa90b10B23d5C0440C8a385ba1414D30A7C54B144 // Principale Account gets 100% of the total revenue
    ];
    ...
    onlyAccounts
    {
        ...
        require(
            ...
            "MoonVaginas: Max supply exceeded"
        );
        require(
