...
// File: contracts/bridge/ERC721Bridge2.sol
...
contract ERC721Bridge2 is Context, AccessControlEnumerable{
    ...
    // TODO Owner blacklist/whitelist
    ...
    function beginExportToken(address srcContr, uint256 srcTokenId, address srcOwner, uint256 dstChainId, address dstContr, address dstOwner) public virtual {
        ...
        _validateExport(srcContr, srcTokenId, srcOwner, dstContr, dstOwner);
    ...
    function _validateExport(address srcContr, uint256 srcTokenId, address srcOwner, address dstContr, address dstOwner) internal view virtual {

        // TODO validating destination chain ID or destination contract
    ...
    function _validateImport(address contr, address owner) internal view virtual {
    ...
    function addLocalTokenContracts(address[] memory contrs) public {
        // TODO Add contract validation or verification on types or ...
    ...
    /**
     * Only admin can deploy token contract using this function.
     * The deployed token contract would inherit OpenZeppelin `ERC721PresetMinterPauserAutoId` contract 
     */
