...
contract InfinityMintRandomNumber is IRandomNumber {
	constructor(uint64 seedNumber, address valuesContract)
		IRandomNumber(valuesContract)
	{
...
import "../InfinityMintRandomNumber.sol";

contract SeededRandom is InfinityMintRandomNumber {
	/**

     */
	constructor(uint64 seedNumber, address valuesContract)
		InfinityMintRandomNumber(seedNumber, valuesContract)
	{}
}