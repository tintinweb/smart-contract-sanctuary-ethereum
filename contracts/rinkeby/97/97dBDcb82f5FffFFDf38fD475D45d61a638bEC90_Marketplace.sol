...
contract Marketplace is Ownable {
    ...
    //mapping(uint256 => _order) internal openOrder;
    ...
    function fillOrder(uint256 _id, uint256 _quantity) public {
        ...
        require(balance[_buyer] >= amount, "You need more eth");
    ...
    function _orderBond(
        ...
        _order storage order = orders[_id];
        // place order
        balance[_buyer] = balance[_buyer] - _amount;
    ...
    function _orderCompleted(
        ...
        // place order
        balance[order.seller] = balance[order.seller] + _amount;
