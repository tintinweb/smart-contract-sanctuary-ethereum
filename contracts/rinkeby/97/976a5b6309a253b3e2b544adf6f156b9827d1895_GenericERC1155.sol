    ...
    ERC2981PerTokenRoyalties
{
    ...
    function createToken(bytes memory _tokenURI, uint256 _initialSupply)
        public
        OnlyAdmin
        returns (uint256 tokenId)
    {
        ...
        _tokenIds.increment();
        _mint(msg.sender, _tokenIds.current(), _initialSupply, _tokenURI);
    ...
    //     address _ownerAddr,
    //     uint256 quantity
    // ) public OnlyAllowedContract(marketplaceContractAddr) returns (bool) {
    //     string memory currTokenURI = tokenURI(_tokenId);
    //     _mint(_ownerAddr, _tokenId, quantity, bytes(currTokenURI));
    //     return true;
    // }
}
    ...
    GenericAccessControl
{
        ...
        returns (uint256)
    {
        ...
        _mint(signer, voucher.tokenId, voucher.quantity, bytes(voucher.uri));
