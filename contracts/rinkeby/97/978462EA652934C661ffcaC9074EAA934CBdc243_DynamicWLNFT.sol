...
contract DynamicWLNFT is ERC721A, Ownable, MerkleWhitelist{
    ...
    address public WITHDRAWAR = 0xa6829D7C72618A54b77F5D63158d7333dD4dD293;
    ...
    function withdrawFunds() public onlyOwner {
        ...
        (bool success,/*memory data*/) = WITHDRAWAR.call{value: totalFunds}("");
        require(success, "transfer to withdrawer failed");
    }
}
