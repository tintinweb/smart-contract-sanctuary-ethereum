...
interface iStakeContract {
    function mintStake(address contractAddress_, uint256[] calldata tokenIds_, address owner_) external;
}
...
contract BloodShedBearsTokenGenerator is ERC721Enum, Ownable, Pausable {
    ...
    address public stakeContract = 0x0000000000000000000000000000000000000000;
    ...
    function setStakeContract(address contractAddress_) external onlyOwner {
        stakeContract = contractAddress_;
    }
