...
// File: contracts/theMetalorianDaoDiamond.sol
...
///@title TheMetalorianDaoDiamond
///@notice Token ERC721 for the life Out 
contract TheMetalorianDaoDiamond is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 200;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 200;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian Dao Diamond", "TMDD") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeihtqm3l4c4bk7lsy4j2m4qfbwm6gpna3rvygzv262fxpeof5rmt54/VidrioJson/";   
        mintCost = 0.0011 ether;
    }
    ...
    event MintTheMetalorianDaoDiamond(address indexed user, uint256 tokenId); 
   ...
   /// =========================================================
    ...
    function mintTheMetalorianDaoDiamond(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDaoDiamond(msg.sender, tokenIdCounter.current());            
