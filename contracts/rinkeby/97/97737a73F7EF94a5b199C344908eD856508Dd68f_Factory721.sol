...
import "./RustNFTUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new RustNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        RustNFTUser721Token token = RustNFTUser721Token(address(addr));
...
contract RustNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
