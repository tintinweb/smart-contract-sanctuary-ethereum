...
contract AlphaCheetahClub is ERC721, Ownable {
    ...
    uint256 public constant SALE_START_DATE = 1653676923; //1659888000;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        // By default show the token URI after 7 days after the sale starts
        if(revealed == false || block.timestamp < SALE_START_DATE + 7 days) {
