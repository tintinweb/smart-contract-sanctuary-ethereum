...
// CONTRACT
contract CA_Name is Context, IERC20, Ownable {
    string private constant _name = "Test_N";
    ...
    address payable private constant initialLpReceiver =
        payable(0xFb67144EEEcdD15E0A1A5c2B233f398Ad78Df2de);
    ...
    uint256 public buyTax = 0; // Buy Tax = 0
    uint256 public sellTax = 666; // Sell Tax = 9% 

    uint256 public lpShare = 300; // Auto_LP = 3%
    uint256 public autoBurnShare = 300; // Auto_Burn = 3%
    uint256 public marketingShare = 300; // Marketing = 3%

    uint256 private constant _totalSupply = 6666666 * 10**_decimals; // Total Supply = 1,000,000
    uint256 public swapThreshold = 1000 * 10**_decimals;
    uint256 public maxTxAmount = 33333 * 10**_decimals; // Max_Tx = 0.5%
    uint256 public walletMax = 66666 * 10**_decimals; // Max_Wallet = 2%
