...
contract ERC721 is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function tokenURI(uint256 tokenId) external view override returns (string memory) {
        ...
        return string(abi.encodePacked("BASE URI/", tokenId.toString(), ".json")); //////////////////////////////////////////////////// base URI
    }
...
contract Contract is Ownable, IERC2981, ERC721 { /////////////////////////////////////////////////////////////////// change contract name

    bool private _mintingEnabled;

    constructor(address _openseaProxyRegistry) ERC721(_openseaProxyRegistry) { }
    
    function airdrop(uint amount, address to) external onlyOwner {
        require(amount + totalSupply <= 500); ///////////////////////////////////////////////////////////////////// set max supply
        _mint(amount, to);
    }

    function batchAirDrop(uint[] memory amount, address[] memory to) external onlyOwner {
        ...
        require(tokenId <= 500, "Exceeds Max Supply!"); ///////////////////////////////////////////////////////////////////// Set Max Supply
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount <= 20 && amount != 0, "Invalid request amount!"); /////////////////////////////////////////////////////////////// Set maximum per batch
        require(amount + totalSupply <= 10_000, "Request exceeds max supply!"); ///////////////////////////////////////////////////// set max supply
        require(msg.value == amount * 89e15, "ETH Amount is not correct!"); /////////////////////////////////////////////////////// set price
    ...
    function royaltyInfo(uint tokenId, uint salePrice) external view override returns(address receiver, uint256 royaltyAmount) {
        ...
        return(owner(), salePrice * 5 / 10000); ////////////////////////////////////////////////////////////////////// Set percentage, currently its set on 5%
    }
