...
contract PhysicalRedeemable is Ownable {
    ...
    uint256 public PhysicalItemTokenId = 4;
    ...
    function collect(
        ...
        bytes32 leaf = keccak256(
            abi.encodePacked(account, PhysicalItemTokenId, accountAmount)
        );
        ...
        require(
            requestedPhysicalItemsCount + PhysicalItemsClaimed[account] <=
                accountAmount,
            "cannot claim more then assigned"
        );

        // update claimed amount
        PhysicalItemsClaimed[account] += requestedPhysicalItemsCount;
    ...
    function handleReceive(
        ...
        // emite collected event
        emit Redeemed(_userAddress, _physicalIds, _physicalQuantities);
    }
