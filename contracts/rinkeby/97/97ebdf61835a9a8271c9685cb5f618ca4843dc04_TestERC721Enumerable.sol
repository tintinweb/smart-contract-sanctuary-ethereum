...
contract TestERC721Enumerable is ERC721Enumerable, Ownable, ERC721Burnable {
    using Strings for uint256;
    ...
    uint256 public maxSupply = 1948; // Max amount of NFTs that can be minted in total
    uint256 public mintableSupply = 1000; // Max amount of NFTs that can be minted in total
    uint256 public maxMintAmount = 2; // Max amount to be minted at once
    bool public paused = false; // Contract paused when deployed
    uint256 public nftPerAddressLimit = 50; // Maximum NFTs mintable on one wallet
    ...
    function mint(uint256 _mintAmount) public payable {
        uint256 supply = _tokenIdCounter.current() - 1;//totalSupply();        
