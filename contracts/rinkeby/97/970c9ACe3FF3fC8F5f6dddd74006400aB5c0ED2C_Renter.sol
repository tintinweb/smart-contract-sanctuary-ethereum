...
/**
 * @title Renter contract
 * @author Renter Blockchain Developer
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract Renter is ERC721Enumerable, Ownable {
    ...
    function publicMint() public payable {
        ...
        require(_mintedItems.add(_mintAmount) <= MAX_ITEMS, "exceeded max supply of Renter");
