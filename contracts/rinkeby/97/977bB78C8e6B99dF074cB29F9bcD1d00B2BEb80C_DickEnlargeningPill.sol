...
contract DickEnlargeningPill is
    Context,
    ...
    Ownable
{
    ...
    IDickManiac private collection;
    ...
    event PillUsed(uint256 dickId, uint256 pillId, address initiator);
    ...
    constructor(
        ...
        metaURI = _metaURI;
        collection = IDickManiac(_collection);
