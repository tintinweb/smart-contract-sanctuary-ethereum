...
contract LockToken is Ownable {
    ...
    modifier open(address from, address to) {
        require(isOpen || (msg.sender == owner()), "Not Open");
        _;
    }
...
contract HydraToken is Context, IERC20, LockToken 
{
    ...
    address payable public developmentAddress = payable(0xdb995a5e8564Af80C411374fAf951cE267558DAA);
    ...
    uint256 _saleDevelopmentFee = 75;
    uint256 _saleMarketingFee = 75;

    uint256 public _maxTxAmount = 2_000_000 * 10**18;
    uint256 private _minimumTokensBeforeSwap = 100_000 * 10**18;
