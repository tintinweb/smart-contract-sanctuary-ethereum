...
contract MoonopolyV2 is ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable
{
    // Initialization
    ...
    address constant proxy = 0x64DDe7825b5E79c4ac89CF2fF5895c06dAF74d43;
    ...
    *----------------------*/
    ...
    /**
     * @dev Moonopoly Combine Cards
     */
    function CombineCards() public nonReentrant
    {
        if(IERC1155Upgradeable(proxy).balanceOf(msg.sender, 1) > 0 && IERC1155Upgradeable(proxy).balanceOf(msg.sender, 2) > 0)
        {
            IERC1155Upgradeable(proxy).safeTransferFrom(msg.sender, address(0), 1, 1, "BURNED");
            IERC1155Upgradeable(proxy).safeTransferFrom(msg.sender, address(0), 2, 1, "BURNED");
        }
    }
    ...
    *----------------------*/
     ...
     */
    function __batchTransfer(address[] calldata recipients, uint256[] calldata tokenIDs, uint256[] calldata amounts) external 
    { 
    ...
    /**
     * @dev Mints Expansion Cards For Future Community Airdrops Outside Of The Core Collection :)
     */
    ...
    /**
     * @dev Reserves Cards For Marketing & Core Team
     */
