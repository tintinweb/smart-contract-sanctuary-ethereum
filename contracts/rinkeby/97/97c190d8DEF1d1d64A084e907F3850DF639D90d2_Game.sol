...
contract Game 
{
    ...
    {
        require( msg.sender == _player ,"You are not the owner of this address");
    ...
    {
        require(opponentAddress != msg.sender,"You are passing the same address as yourself");

        if( Match[msg.sender][opponentAddress] == true)
        {
            return true;
        }
        else
