...
contract Weqwe is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/709/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/709/contract-uri";
	...
	uint256 public pricePerToken = 100000000000000000000;
    uint256 public tokenfyPrice = 100000000000000000000;

    // presale settings
    address private signerAddress;
    mapping(address => uint256) public presaleMinted;
	uint256 public presaleMaxSupply = 10;
	uint256 public presaleMaxPerMint = 12;
	uint256 public presalePricePerToken = 100000000000000000000;
	...
	constructor(address _signerAddress) ERC721A("weqwe", "qeqw") {
