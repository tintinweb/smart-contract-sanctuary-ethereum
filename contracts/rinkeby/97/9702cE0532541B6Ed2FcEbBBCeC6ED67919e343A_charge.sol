...
contract charge is IERC20, protected, smart {
  ...
  // Exclusions
  mapping(address => bool) public isBalanceFree;
  mapping(address => bool) public isMarketMakerTaxFree;
  mapping(address => bool) public isMarketingTaxFree;
  mapping(address => bool) public isRewardTaxFree;
  ...
  uint8 public _stakeTax_one;
  uint8 public _stakeTax_two;
 ...
 function _transfer(address sender, address recipient, uint256 amount) private{
  ...
  mapping(address => mapping(uint256 => uint256)) public alreadyPaidShares;
 ...
 uint256 buyTax,
  ...
  function ControlSetShares(
    ...
    require(marketingTaxes <= 100);
    require(marketMakerTaxes <= 100);
    require(stakeTaxes_one <= 100);
    require(stakeTaxes_two <= 100);
  ...
  ///@dev Enable or disable landlord / tenant pool  for an address
