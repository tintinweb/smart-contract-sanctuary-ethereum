...
contract WagieCats is ERC721A, Ownable, ReentrancyGuard{
    ...
    uint256 public constant TOTAL_WAGIECATS = 10000;
    ...
    constructor() ERC721A("WagieCats", "WCATS") {
        maxPerAddressDuringMint = 8;
        amountForDevs = 500;
    }
    ...
    function publicMint(uint256 quantity) external payable callerIsUser {
        ...
        require(
            totalSupply() + quantity <= TOTAL_WAGIECATS,
            "reached max supply"
        );
        require(
