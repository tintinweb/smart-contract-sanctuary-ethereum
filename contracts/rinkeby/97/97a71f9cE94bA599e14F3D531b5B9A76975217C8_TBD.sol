...
//address
    ...
    address public marketingWallet = 0xd809e69C0382F78Ae6E3f57EC5E26AEB50069efD;
    address public lunaBurnWallet = 0x1C10CeEcFEEf27341c486Cd9d69568f26653345B;
 ...
 //uint
    ...
    uint256 public maxBuyTxAmount; // 2% tot supply (constructor)
    ...
    uint256 public marketingBuyFee = 7;
    ...
    uint256 public totalBuyFees = marketingBuyFee.add(liqBuyFee).add(burnBuyFee).add(LUNABurnBuyFee);
    uint256 public totalSellFees = marketingSellFee.add(liqSellFee).add(burnSellFee).add(LUNABurnSellFee);
...
//struct
 ...
 //event
    ...
    constructor() ERC20("TBD", "TBD") {
        uint256 _total_supply = 100_000_000 * (10**9);
        ...
        */
        ...
        maxBuyTxAmount =  _total_supply * 2 / 100; // 1%
        maxWalletAmount =  _total_supply * 4 / 100; // 4%
        // prepareForLaunch(); // used at deploy and never called anymore
    }
    ...
    function prepareForLaunch() private {
        LUNABurnBuyFee = 1;
        LUNABurnSellFee = 1;
        marketingBuyFee = 7;
        marketingSellFee = 7;
        ...
        liqBuyFee = 1;
        liqSellFee = 1;
        totalBuyFees = marketingBuyFee.add(liqBuyFee).add(burnBuyFee).add(LUNABurnBuyFee);
        totalSellFees = marketingSellFee.add(liqSellFee).add(burnSellFee).add(LUNABurnSellFee);
    }
    ...
    function setFees( uint256 _liq_buy, uint256 _marketing_buy,uint256 _liq_sell,uint256 _marketing_sell,
    ...
    function swapTokens(uint256 minTknBfSwap) private {
        ...
        uint256 swapBalance = minTknBfSwap - burnPart - (liqPart);
