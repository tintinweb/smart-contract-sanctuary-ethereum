...
contract NindoSale is Ownable, ReentrancyGuard {
    ...
    uint256 public immutable maxWhitelistAmount = 3600;
    uint256 public immutable maxWhitelistPerAmount = 2;
    uint256 public immutable maxPublicSalePerAmount = 30;
    uint256 public constant whitelistSalePrice = 0.077 ether;
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1649264400;
    uint64 public immutable whitelistEndTime = 1649268000;
    uint64 public immutable publicSaleStartTime = 1649268000;
    uint64 public immutable publicSaleEndTime = 1649278800;
    ...
    constructor() {
        ...
        nindoTokenAddress = address(0x25207F56fB9C4B656C70f005a4a5cc6D5b6F9C2A);
        whitelistMerkleRoot = 0x01e1a4d576ff03b5a239ea43203777aeddb62bcd5aeba25e2682d44a6a4c60e9;
    }
