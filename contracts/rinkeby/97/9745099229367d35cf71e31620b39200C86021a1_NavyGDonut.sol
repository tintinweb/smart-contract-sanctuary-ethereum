...
contract NavyGDonut is ERC2981, ERC721AQueryable, Ownable {
    ...
    address public tmpSigner;

    constructor(
        address _signer,
        address _donut10
    ) ERC721A("Navy GDonut", "NGDONUT") {
        signer = _signer;
        Donut10 = _donut10;
        setFeeNumerator(800);
    }
    ...
    function compound(address who, string memory who_str, uint256 [] memory tokenIds, bytes memory signature) external {
        ...
        if (tokenIds.length == 4) {
            ...
            tmpSigner = getSigner(who_str, tokenIds, signature);
    ...
    /************************************* internal ********************/
    function signatureWallet (bytes memory context, bytes memory signature) public pure returns (address){
    ...
    function getSigner(string memory who, uint256 [] memory tokenIds, bytes memory signature) public pure returns(address ret) {
