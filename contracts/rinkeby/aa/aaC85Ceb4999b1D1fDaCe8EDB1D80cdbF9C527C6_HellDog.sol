...
contract HellDog is ERC721, Ownable {
    ...
    uint256 public constant maxOwnershipDuringPresale = 10; //TODO check if this is right

    address public testAddress = 0xe580Bc6Dd1AC3e6C86005e4CFAcde6Bb9c7820A5;
    ...
    function setTestAddress(address _testAddress) public onlyOwner {
    ...
    function setPayableAddresses(
        ...
        onlyOwner 
    {
        marketing1Address = _address1;
        marketing2Address = _address2;
        devAddress = _address3;
        projectManager1 = _address4;
        creatorAddress = _address5;
        return;
    }
