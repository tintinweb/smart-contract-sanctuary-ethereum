...
contract TESTPLSWOPRK is Ownable, ERC721A {
    ...
    string private _baseTokenURI = "ipfs://Qmc7kPin6rgMjX33Ev3P8xmkFDvh4ghA7CTok5yZKBC3w5";

    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("TESTING", "BDRAGON") {
