...
contract MushGang is ERC721A, ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    function _publicMint(uint8 _amountOfMush) internal mintIsOpen {
        ...
        uint64 numMushMinted = _getAux(msg.sender) + _amountOfMush;
     ...
     */
    function getRedemptionsVipList() public view returns (uint32) {
     ...
     * See https://chiru-labs.github.io/ERC721A/#/erc721a?id=addressdata
     */
    function getRedemptionsMushList() public view returns (uint32) {
