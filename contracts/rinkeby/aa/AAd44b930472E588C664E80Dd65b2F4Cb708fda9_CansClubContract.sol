...
//*********************************************************************//
//
//   .oooooo.         .o.       ooooo      ooo  .oooooo..o        .oooooo.   oooo               .o8       
//  d8P'  `Y8b       .888.      `888b.     `8' d8P'    `Y8       d8P'  `Y8b  `888              "888       
// 888              .8"888.      8 `88b.    8  Y88bo.           888           888  oooo  oooo   888oooo.  
// 888             .8' `888.     8   `88b.  8   `"Y8888o.       888           888  `888  `888   d88' `88b 
// 888            .88ooo8888.    8     `88b.8       `"Y88b      888           888   888   888   888   888 
// `88b    ooo   .8'     `888.   8       `888  oo     .d8P      `88b    ooo   888   888   888   888   888 
//  `Y8bood8P'  o88o     o8888o o8o        `8  8""88888P'        `Y8bood8P'  o888o  `V88V"V8P'  `Y8bod8P' 
//  -.-. .- -. ...    -.-. .-.. ..- -...                                                                                                            -.-. --- -- -... .- - .. -. --.    .- .--. --- -.-. .- .-.. -.-- .--. - .. -.-.    -. .- - .. --- -. .- .-..    ... -.-. . -. .- .-. .. --- ... 
//                                                                                                                                                 
// ... --- ...          
//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x69d87e43dfE63615Ba4A6795A3CC5fb7C72315A6,0x1135C494d044c9512EA437e666Cb5c4e074C6381,0x1fa5f9735b49Fd7034211A5b1Cf4807E61132c36,0x8095CFb4b005Dbe869a87eAe81266f1672D8E024,0xB0F2b549d90479C1E04c6334Bd20C7d8c324811d];
  uint256[] public payableFees = [5,19,19,19,19,19];
  uint256 public payableAddressCount = 6;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.135 ether;
  uint256 public earlyMintTokenIdCap = 1150;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigvs42t64ayjiwhphwgxiohwtaalntcyzbpcwftdate2ru5qpoz5q/";
...
// File: contracts/CansClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CansClubContract is RamppERC721A {
    constructor() RamppERC721A("CANS Club", "CANS"){}
}