...
contract HookHookItems is ERC721A, Ownable, ReentrancyGuard {
	using Strings for uint256;

	uint256 public constant MAX_PER_PUBLICMINT_WALLET = 3;
	uint256 public maxSupply = 116;
	...
	function publicMint(uint256 mintAmount) external payable {
        ...
        require(mintAmount <= MAX_PER_PUBLICMINT_WALLET,"Exceeds max per transaction");
		...
		(bool success, ) = payable(0x61947a1BD885602A0Ac10F4a829c2011f1Dc2478).call{
            value: transferPool
        }("");
	}
	...
	function put() external payable onlyOwner {
