  ...
  ERC721PausableUpgradeSafe
{
  ...
  function supportsInterface(bytes4 id) public view virtual override(ERC165UpgradeSafe) returns (bool) {
    return (id == INTERFACE_ID_ERC721 ||
      id == INTERFACE_ID_ERC721_METADATA ||
      id == INTERFACE_ID_ERC721_ENUMERABLE ||
      id == INTERFACE_ID_ERC165);
  }
