...
contract BoredApe is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  string public notRevealedUri =
    'ipfs://QmNotcL5y1SeeQrPRMrSRpixH48m5c2hVkq9BBphii94t7/hidden.json';
  ...
  address[] private _team = [
    // Yuichiro Mac book pro Chrome
    0x39d2a424ace58205A9A6d709a0A34f7DFc35C32f, // Admin Account gets 25% of the total revenue
    // Yuichiro Mac book pro firefox 開発用のデバッグアカウント
    0x3B9f4AAA08a43e29CcfE2379162E99801957f06f, // Test Account gets 35% of the total revenue
    // Yuichiro Mac book pro firefox Hardhatテストアカウント
    0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 // VIP Account gets 40% of the total revenue
  ];
