...
contract Tokenstake {
    ...
    uint256[5] public Duration = [30 days, 60 days, 90 days, 180 days, 360 days];  // these are locking period of token we can also place  no of seconds here
    uint256[5] public Bonus = [12, 37, 72, 121, 505]; // these four bonus variable is related to duration and the amount will be multiply by 10 like we have to set 10 percent then put 100
