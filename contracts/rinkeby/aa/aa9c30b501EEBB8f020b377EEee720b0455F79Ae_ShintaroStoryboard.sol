...
contract ShintaroStoryboard is ERC1155Burnable, ERC1155Supply, Ownable {
  ...
  constructor() ERC1155("") {
    init(0, 1, new uint64[](0), 10, 1.25 ether, 1656453600, 1656540000, "ipfs://QmWGf2RLimHmPpkKjU5hwiAWsu2E2VdM54sfvGBXARVP4q");
    init(1, 1, new uint64[](0), 25, 0.7 ether, 1656453600, 1656540000, "ipfs://QmYb3aYeNgGCTSJmpAon71Cgqxbegx33P4FQj7sYpvJNZJ");
  }
