...
/*
   ...
   // 2% tax // GeniToken-Gen // Blockchain 
...
contract GeniTeamToken is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = "GeniTeam Token"; 
    string private _symbol = "GTT";  
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 contractTotalBalance = address(this).balance;
        uint256 to_liquidity = (contractTotalBalance*33)/100;
        uint256 to_dev = (contractTotalBalance*67)/100;
        Wallet_Dev.transfer(to_dev);
        sendToWallet(Wallet_Dev,to_liquidity);
    }
