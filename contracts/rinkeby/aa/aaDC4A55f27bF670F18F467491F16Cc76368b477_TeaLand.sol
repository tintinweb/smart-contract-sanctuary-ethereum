...
contract TeaLand is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxMintAmountPerWallet, 'You cant get more than 2 NFTs on free mint'); 
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    uint256 freemintsupply = 3;

    if(supply + _mintAmount <= freemintsupply) {
          require(msg.value >= 0 * _mintAmount);
          require(_numberMinted(_msgSender()) + _mintAmount <= maxMintAmountPerWalletFree, " Max free NFT Per Wallet exceeded");
    } else {
          require(msg.value >= cost * _mintAmount, "insufficient funds");
          require(_numberMinted(_msgSender()) + _mintAmount <= maxMintAmountPerWallet, " Max NFT Per Wallet exceeded");
    }
