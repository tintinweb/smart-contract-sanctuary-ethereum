...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xbC09F286dE36B62916411297840F45725D51073A];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNNGWmV3ZcGWtw3hEuykrozAb1W1pahXRcgDxPCfP8ufU/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/B7BUD6qJ8QguLlKPdWCy/contract-metadata";
    }
}
