...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQk8eNJE4XtJKN82KpYgGi7omBFa9msDTiKYxf5uDApaC/";
...
// File: contracts/OuttheworldDudesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OuttheworldDudesContract is RamppERC721A {
    constructor() RamppERC721A("Out the world Dudes", "OTWD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/cejEp9rBCmktmdO4G5Py/contract-metadata";
    }
}
