...
contract Delusion is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        SUPPLY_MAX = 10;
        SUPPLY_MAX_WHITELIST = 5;
        saleStartTime = 1660755600; // AUGUST 17 2022 5:00:00 PM GMT
    }
    ...
    {   
        ...
        bool inSupply = (whitelistMints + 1) < SUPPLY_MAX_WHITELIST;
