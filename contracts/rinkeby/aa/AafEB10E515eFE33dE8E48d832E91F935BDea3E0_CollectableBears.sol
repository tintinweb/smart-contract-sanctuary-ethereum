...
contract CollectableBears is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Collectable Bears", "CB") {
  setHiddenMetadataUri("ipfs://QmVLUXX9JYvGX8WqmxF2EfS3FoZjPzs5uvbMoTDDYXhTdq.json");
  }
