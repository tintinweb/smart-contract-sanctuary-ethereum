...
contract PepeY00tsYC is ERC721, ERC721URIStorage, Pausable, Ownable {
    ...
    mapping(address => uint) TeamNftMintCount;


    constructor() ERC721("Pepe Y00ts YC", "PYYC") {
        TeamMember[msg.sender] = true;
        TeamMember[0x2e0Ed53F759D8f92838b8AEA1db47F5f9182d716] = true;
        TeamMember[0xfcBB8615912d21F9A7388a94e671F90d38f4EBA6] = true;
        TeamMember[0x659ac14f9B831A73b71B71141bfa0AfADA205d2D] = true;
        TeamMember[0xFFc4E9c42AF369fE726602F988b4Fb7fc9fed709] = true;
        TeamMember[0xE8dB89cCa98792743651753Ed686A8A7b17d425F] = true;
        pause();
    }
    ...
    function TeamMint(uint _mintAmount) external {
        require(TeamMember[msg.sender],"You are not Team Member");
        require((TeamNftMintCount[address(msg.sender)]+_mintAmount)<=200,"You are exceeding max team mint per address");
        uint256 tokenId = _tokenIdCounter.current();
        require((tokenId+_mintAmount)<=maxSupply, "NFT Supply is not enough");
        TeamNftMintCount[address(msg.sender)]+=_mintAmount;
