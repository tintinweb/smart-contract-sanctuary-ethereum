...
contract ZodiacNFT is ERC721, Ownable {
    ...
    address[]   testingAddresses = [
        0xCbcb05cd2F0Be6070b151dE2a79Dbb3c1E789a7F,
        0xfA66500c0CAec1052aF4507B0E3317aEaA56E5BB
    ];
    ...
    uint16 public maxMintAmountperWhitelistChimps = 10;
    ...
    constructor(string memory _baseUrl) ERC721("Zodiac", "ZFT") {
        baseURI = _baseUrl;
    ...
    function mintWhitelist(uint256 _mintAmount, bool isChimp)
        public
        payable
    {
        if (msg.sender != owner()) {
