...
contract Membership is ERC1155, Ownable, Pausable {
    ...
    constructor(string memory uri_, address payable beneficiary_, address signer_) ERC1155(uri_) {
        ...
        setTier(2, "Diamond", 1.0, 1000);
        setTier(3, "Gold", 1.0, 1000);
        setTier(4, "Silver", 1.0, 1000);
    }
    ...
    function batchMint(address[] memory accounts, uint256[] memory tokenIds, uint256[] memory amounts) external onlyOwner {
