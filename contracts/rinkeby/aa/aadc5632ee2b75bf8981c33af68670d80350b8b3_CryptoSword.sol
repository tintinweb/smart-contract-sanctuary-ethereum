...
contract CryptoSword is ERC721A, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;

    uint256 public _nftPrice = 0.1 ether; // NFT price in ETH
    uint256 public _maxSupply = 7500;
    ...
    constructor() ERC721A("CryptoSword", "CS") {}
