...
// File: TheMillionaireProject.sol
...
contract TheMillionaireProject is ERC1155Supply, ContextMixin, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string private _collectionDataUri = "https://projectmill.s3.us-east-1.amazonaws.com/collectionInfo/collection.json";

    constructor() ERC1155('https://projectmill.s3.amazonaws.com/meteadata/{id}.json') {
        _tokenIds.increment();
    }
    ...
    function uri(uint256 _tokenId) override public view returns (string memory) {
        return string(
            abi.encodePacked(
                "https://projectmill.s3.amazonaws.com/meteadata/",
