...
contract C0FoNem is ERC721, Ownable {
  ...
  // constructor(address proxyRegistryAddress) ERC721("FoNem QA | CRYPT00PPS", "QA12") {  // FOR TESTING PURPOSES ONLY
  constructor() ERC721("FoNem QA | CRYPT00PPS", "QA12") {
    revealed = false;
    presale = true;
    price = 0.01 ether;
    uriSuffix = ".json";
    ...
    _shareholder02 = 0x2A4cfF63A74ac3aDBB2f31214F633458Eb319EAD; // rinkeby testnet

    _proxyRegistryAddress = 0xF57B2c51dED3A29e6891aba85459d600256Cf317; // rinkeby
