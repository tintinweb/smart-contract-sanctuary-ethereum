...
contract Estrella is ERC721,Ownable{
    ...
    uint256 public id_bill_100 = 500;
    uint256 public id_bill_50 = 400;
    uint256 public id_bill_20 = 300;
    uint256 public id_bill_10 = 200;
    uint256 public id_bill_5 = 100;
    uint256 public id_bill_1 = 0;
    ...
    event transaction_event(address, uint256);
    ...
    function ConvertDenom(uint256 _value) public payable returns(uint256 [] memory){
        ...
        emit transaction_event(msg.sender, _value);
        trans ++;
   ...
   function billetes_return () public view returns(uint256 [] memory){
    ...
    function ChangeStock(uint _100, uint _50, uint _20, uint _10, uint _5, uint _1) public onlyOwner returns(bool){
        ...
        require(_100 <= 99 && _50 <= 99 && _20 <= 99 && _10 <= 99 && _5 <= 99 && _1 <= 99 , "Exeding/Limit");
