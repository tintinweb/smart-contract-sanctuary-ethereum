...
/**
 * ETHumans Core 721 Contract
 */
contract ETHumans is ERC721Enumerable, AccessControl, Ownable {

    // Magic given to us by OpenZeppelin to help us keep track of tokenIds.
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    string _baseTokenURI = "https://api-ethumans.herokuapp.com/api/nft/";

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    address public upgradedToAddress = address(0);
    uint256 internal _cap = 500;
