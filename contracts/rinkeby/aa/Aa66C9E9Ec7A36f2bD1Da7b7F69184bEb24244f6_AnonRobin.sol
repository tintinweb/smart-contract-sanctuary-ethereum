...
contract AnonRobin is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	string public _unrevealedURI = "ipfs/QmRN3rBVVWUTu2ubHYPELxR7qvQCCj5VYCwLadrwi7Xjjy";
	string public _contractURI = "ipfs://QmQ1YYd3j925FyiSuN1Gi5Eor6eJaYEZgqEgShHra5RMz4";

	uint256 public maxSupply = 299; //tokens start from 0
	...
	/**
	 ...
	 @param qty - the quantity that a user wants to buy
	  */
	function publicBuy(uint256 qty) external payable nonReentrant {
