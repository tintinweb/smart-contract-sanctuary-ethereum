...
contract NftTrader {
    // Smart contract for selling tokens on the platform
    ...
    // Add sell offer: maxPrice decreases each day by dayPriceChange, until it reaches minPrice
    // Sell offer is created for token with contractAddr and tokenId inside that contract
    ...
    // For testing purposes: updates time when timed offer was created, affect current price of the offer
    // offsetSeconds - negative for earlier date, positive for future date
