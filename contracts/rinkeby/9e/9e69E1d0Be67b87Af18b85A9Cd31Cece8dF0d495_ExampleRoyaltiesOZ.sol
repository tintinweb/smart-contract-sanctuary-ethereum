...
contract ExampleRoyaltiesOZ is Ownable, ERC2981, ERC721A {
    ...
    mapping(uint256 => bool) public hasRefunded; // users can search if NFT has been refunded
    mapping(uint256 => bool) public isOwnerMint; // if NFT was freely minted by owner

    string private baseURI;

    constructor() ERC721A("ExampleRoyaltiesOZ", "ER") {
