    ...
    AccessControl
{
     ...
     */
    function setDesigner(address designer) external onlyRole(DESIGNER) {
        _designer = designer;
    }

    function setManager(address manager) external onlyRole(MANAGER) {
        _manager = manager;
    }
