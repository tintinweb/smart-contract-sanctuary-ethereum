...
contract MiamiNFT is ERC721A, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    bytes32 private immutable firstVipMerkleRoot;
    bytes32 private immutable secondVipMerkleRoot;
    ...
    uint256 public immutable firstVipDuration;
    uint256 public immutable secondVipDuration;
    ...
    modifier onlyPublicSale(uint256 _amount) {
        ...
        priceInWei = priceInWeiPublicSale;
    ...
    modifier onlyAllowListed(bytes32[] calldata _merkleProof, uint8 _amount) {
        ...
        if(block.timestamp >= start && block.timestamp <= firstVipEnd) {
            ...
            priceInWei = priceInWeiFirstPresale;
            ...
            priceInWei = priceInWeiSecondPresale;
        } 
        _;
    }
    ...
    constructor(
        ...
        require(_limits[3] <= totalLimit, "Ownable claim limit must not be bigger then total limit");
    ...
    function mintUnsold(address _to, uint256 _amount) external onlyOwner onlyInactive {
        ...
        require(totalMinted + _amount <= totalLimit, "Global limit amount reached");
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        startingIndex = randomness % totalMinted;
    ...
    function buyTokens(uint8 _amount) private onlyActive nonReentrant {
        ...
        uint256 mintPrice = priceInWei * _amount;
