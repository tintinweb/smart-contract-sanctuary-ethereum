...
contract Punks is ERC721, ERC721Enumerable, PunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("Punks", "PKN") {
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "Punks #',
                tokenId.toString(),
                '", "description": "This Punks are randomized Avataaars stored on chain to teach DApp development on Platzi", "image": "',
                image,
