...
error Lottery__UpkeepNotNeeded(uint256 currentBalance, uint256 currentPlayer, uint256 currentState);
...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    address payable private s_latestWinner;
    ...
    function fulfillRandomWords(uint256, uint256[] memory randomWords) internal override {
        ...
        address payable latestWinner = s_players[index];
