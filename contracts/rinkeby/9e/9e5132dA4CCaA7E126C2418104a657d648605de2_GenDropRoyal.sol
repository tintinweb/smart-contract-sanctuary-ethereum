...
contract GenDropRoyal is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
...
/// @notice Metadata extension
  string private baseExtension = "";

/// @notice Cost to mint
  uint256 private mintCost = 0.001 ether;

/// @notice Fixed supply of collection
  uint256 private maxSupply = 1000;

/// @notice Max mint amount per wallet
  uint256 private maxMintAmount = 3;

/// @notice Can pause functionality
  bool private paused = false;

/// @notice Add addresses to whitelist for special access
...
function mint(
    ...
    uint96 _percentageBasisPoints) public payable {
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            super._safeMint(_to, _tokenIdTracker.current());
            setRoyalties(_tokenIdTracker.current(), _royaltiesReceipientAddress, _percentageBasisPoints);
...
/**
  ...
  @dev If there is a BaseURI set it will append it via token ID : empty string
  @param tokenId Token Id to index
  */
