...
contract Land is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    //future
    function claimFutureLands(address recipient) external onlyOwner {
        claimFutureLandsWithAmount(recipient, MAX_MINT_PER_BLOCK);
    }

    function claimFutureLandsWithAmount(address recipient, uint256 maxAmount) public onlyOwner {
        require(maxAmount <= MAX_MINT_PER_BLOCK, "maxAmount cannot exceed MAX_MINT_PER_BLOCK");    
