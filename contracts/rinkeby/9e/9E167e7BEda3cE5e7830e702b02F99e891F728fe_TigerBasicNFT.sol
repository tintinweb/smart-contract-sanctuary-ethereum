...
contract TigerBasicNFT {
    ...
    event EtherWithdrawn(address indexed seller, uint indexed amount);
    ...
    // allow some to withdraw funds held by the contract
    // function withdrawFunds() public noReentrant {
    //     require(pendingWithdrawals[msg.sender] > 0, "No pending withdrawals for caller address");
