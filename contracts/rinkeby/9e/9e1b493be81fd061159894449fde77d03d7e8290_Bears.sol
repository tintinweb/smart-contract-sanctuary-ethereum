...
contract Bears is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Bears", "BERZ"){}
  ...
  function mint(uint256 numberOfTokens) external payable
  {
    ...
    require(msg.value == numberOfTokens * cost,"Please send the exact amount.");
    require(totalSupply() + numberOfTokens < maxSupply + 1,"No more bears");
    ...
    require( numberOfTokens < maxPerTx + 1, "Max per TX reached.");
