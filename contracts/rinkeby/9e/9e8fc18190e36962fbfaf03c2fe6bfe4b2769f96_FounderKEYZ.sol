 ...
 */
contract FounderKEYZ is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("founderKEYZ", "KEYZ") {}
     ...
     */
    function setPrice(uint256 _price) public lockable onlyOwner {
        price = _price;
    }
     ...
     */
    function setMaxPresaleMints(uint256 maxMints) public lockable onlyOwner {
     ...
     */
    function flipPublicSale() public lockable onlyOwner {
     ...
     */
    function presaleMint(uint256 amount, bytes memory signature) public payable nonReentrant {
    ...
    function _mint(uint256 amount) internal {
        if (totalSupply + amount > MAX_SUPPLY) revert InsufficientSupply();
