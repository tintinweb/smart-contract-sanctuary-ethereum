...
contract MockERC721 is ERC721URIStorage, Ownable {
    ...
    address private LaunchpadContract;
    ...
    function setTokenURIs(TokenURIBase[] calldata _tokenURIs)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < _tokenURIs.length; i++) {
            _setTokenURI(_tokenURIs[i]._tokenId, _tokenURIs[i]._metadata);
        }
    }
    ...
    function getExtensions() public view returns (address, address) {
        return (AuctionContract, LaunchpadContract);
    }
