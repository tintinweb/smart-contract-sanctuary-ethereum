...
// File: contracts/contrattino.sol
...
contract Contrattino is Ownable, ERC721A, ReentrancyGuard {
  ...
  mapping(address => uint256) public allowlist;
    ...
    uint256 maxBatchSize_=10000;
    uint256 collectionSize_=5000;
    uint256 amountForAuctionAndDev_;
    uint256 amountForDevs_;

  constructor() ERC721A("Contrattino", "TINO", maxBatchSize_, collectionSize_) {
