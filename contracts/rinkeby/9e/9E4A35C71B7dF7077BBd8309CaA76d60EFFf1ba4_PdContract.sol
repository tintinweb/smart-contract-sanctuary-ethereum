...
contract PdContract is ERC721Enumerable, Ownable {
    ...
    constructor(string memory initBaseURI, string memory initNotRevealedUri, string memory tokenName, string memory tokenSymbol, string memory contractURI)
