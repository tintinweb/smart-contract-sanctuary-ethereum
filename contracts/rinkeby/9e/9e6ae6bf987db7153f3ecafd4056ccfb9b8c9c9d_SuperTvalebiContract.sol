...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6217d29473b6f7d8b38256A5b059B0aB347bd6cA];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQkCQgoQREt784sWe5ifLiB8CqBZF2n6y5zjQ45EJ7kNN/";
...
// File: contracts/SuperTvalebiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SuperTvalebiContract is RamppERC721A {
    constructor() RamppERC721A("SuperTvalebi", "TV"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Ruru2AdBtv06PIUSmD4s/contract-metadata";
    }
}
