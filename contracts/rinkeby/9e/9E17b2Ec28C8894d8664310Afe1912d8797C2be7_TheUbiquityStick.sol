...
contract TheUbiquityStick is ITheUbiquityStick, ERC721, ERC721Burnable, ERC721Enumerable, ERC2981, Ownable {
  ...
  /// @notice ROYALTY URI for OpenSea
  ...
  constructor(string[] memory tokenURIs, string memory newContractURI) ERC721("The UbiquiStick", "KEY") {
  ...
  /// @notice SET contractURI, only allowed to minter
  /// @param newContractURI : contract URI containing json royalty for OpenSea
  function setContractURI(string memory newContractURI) public override(ITheUbiquityStick) onlyMinter {
