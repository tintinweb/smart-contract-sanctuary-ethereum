...
contract ADAMSTAKE {
    ...
    uint256[4] public APY = [800000,900000,1000000,11000];
    ...
    constructor() {
        ...
        stakeToken = IERC20(0xe0F7748032962F1E1288a4CACcA4C542e636b193);
        rewardToken = IERC20(0x76d397DccEaD2b3D465Cf4B961D36d3345a90260);
        minStake = 4000000000;
