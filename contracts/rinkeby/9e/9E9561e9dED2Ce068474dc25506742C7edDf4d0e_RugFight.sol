...
abstract contract RuglikeGameStudio {
...
//https://etherscan.io/address/0xb6c296b5d010452b1f6115cb4b87d1a0a0206587#code
...
contract RugFight is ERC721A, Ownable {
    ...
    uint256 private immutable heroCost = 0.1 ether;
    ...
    // function initOtherContract(address rgsAddr, address kfAddr0, address kfAddr1, address kfAddr2) public onlyOwner {
    //     rgs = RunlikeGameStudio(rgsAddr);
    //     kf_0 = KF0(kfAddr0);
    //     kf_1 = KF1(kfAddr1);
    //     kf_2 = KF2(kfAddr2);
    // }
    ...
    function ruglikeMint() public payable callerIsUser{
        ...
        // require(rgs.balanceOf(msg.sender) > 0 , "hold OG token to free mint");
        _safeMint(msg.sender, 11);
    ...
    function OGMint() public payable callerIsUser{
        ...
        // require(kf_0.balanceOf(msg.sender)+kf_1.balanceOf(msg.sender)+kf_2.balanceOf(msg.sender) > 0 , "hold OG token to free mint");
        _safeMint(msg.sender, 10);
    }

    function testBalanceOf(address account) public view returns(uint256){
        RuglikeGameStudio rgs = RuglikeGameStudio(0xE4c62020dd1C7f9deC880BCBF40B4cA29851dE0F);
        return rgs.balanceOf(account);
    }

    function getJSID(uint256 tokenId) public view returns(uint256){
        return jsIdList[tokenId];
    }
