...
contract UsdbLending is Ownable, ReentrancyGuard, ERC721Holder, ERC1155Holder, LendingCore {
    ...
    /// Borrowers transfer their nft as collateral to Vault and get paid from the lenders.
    ...
    function createLoan(
        ...
        loans[currentId] = Loan({
            ...
            endTime: block.timestamp + (_payload.duration * 86400),
    ...
    /// Lender can liquidate loan item if loan is not paid
    /// @param _loanId the id of loans
    ...
    /// Set onlyExistLoan by owner
    function setOnlyExitLoan(bool _value) external onlyOwner {
        onlyExitLoan = _value;
    }

    /// Standard method to send nft from an account to another
...
contract LendingCore is Ownable {
    ...
    string constant CURRENCY_NOT_EXIST = "CURRENCY_NOT_EXIST";
    string constant TOO_HIGH_PLATFORM_FEE = "TOO_HIGH_PLATFORM_FEE";
