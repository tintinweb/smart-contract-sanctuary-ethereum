...
contract Land is ExtendERC721, ChainlinkClient{
    AggregatorV3Interface internal priceFeed;
    using Chainlink for Chainlink.Request;
    event RequestVolume(bytes32 indexed requestId, uint256 volume);


    constructor() ExtendERC721("Metamars Land", "MML"){
        // BTC / USD
        ...
        // Oracle
        // https://market.link/jobs/1d6b1b8c-f65a-4ba7-bcfc-140674230f8a
        setChainlinkOracle(0xAE143B0f369Cf31eBcA724e473c9810A76aF80B5);
    }
    ...
    function getFromAPI() public returns (bytes32 requestId) {
        bytes32 jobId = "c637797f3e9a468489e88d5441a16a3e";
        uint256 fee = (1 * LINK_DIVISIBILITY) / 10; // 0,1 * 10**18 (Varies by network and job)
    ...
    function callback(bytes32 _requestId, uint256 _volume) public recordChainlinkFulfillment(_requestId) {
...
abstract contract ExtendERC721 is
    ERC721Enumerable, AccessControlEnumerable, Ownable {
