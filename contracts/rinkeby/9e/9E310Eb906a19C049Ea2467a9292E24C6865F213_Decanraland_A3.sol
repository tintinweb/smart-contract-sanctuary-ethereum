...
contract Decanraland_A3 is Ownable{
    ...
    constructor(address[] memory _restricted) {
    ...
    // function remContract(uint256 key) external onlyOwner{
    //     s.contAdd[key] = s.contAdd[s.contAdd.length-1];
    //     s.contAdd.pop();
    // }

    // function getContract(uint256 key) external view returns(address){
    //     return s.contAdd[key];
    // }
    
    
    // function checkAllowed(address contractAddress) internal view{
    ...
    //     //     }
    //     // }
    //     console.log("*********",s.contAdd.length);
    //     console.log(contractAddress);
    //     console.log(s.contAdd[0]);
    ...
    fallback() external payable{
        ...
        console.log(targ);
        //check restrictions
       require(!isRestriced[targ], "Restricted Address");
