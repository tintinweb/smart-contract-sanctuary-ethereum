...
contract StClone is Ownable, ERC721A, ReentrancyGuard {

    string public baseURI;
    uint256 public teamWS = 5000; // launch
    uint256 public constant price = 0.01 ether;
    uint8 public maxWLMint = 1;
    uint8 public maxMintPerAccount = 2;
    uint256 public maxPresaleSupply = 6000; // launch
    uint256 public maxWSsupply = 6000; // launch
    ...
    constructor(
        ...
        ERC721A("StClone", "StClone", 50, 6000)  {
