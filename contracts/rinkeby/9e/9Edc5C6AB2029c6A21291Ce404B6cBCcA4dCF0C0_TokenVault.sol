...
contract TokenVault is Ownable {
  ...
  event Withdrawal(address indexed recipient, uint256 amount, uint256 tax, uint256 nonce);
  ...
  function withdraw(
    ...
    require(
      _validateWithdrawalSignature(recipient, amount, tax, nonce, signature),
      'Invalid signature'
    );
  ...
  function _validateWithdrawalSignature(
    ...
    bytes32 dataHash = keccak256(abi.encodePacked(recipient, amount, tax, nonce));
