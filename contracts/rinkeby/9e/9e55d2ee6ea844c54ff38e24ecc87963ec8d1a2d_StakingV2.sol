...
contract StakingVerifier is EIP712Upgradeable {
    ...
    bytes32 private constant STAKE_REQUEST_TYPE_HASH =
        keccak256(
            "StakeRequest(uint256 id,address account,uint256 plots,uint256[] strainIds,uint256[] bredStrainIds)"
        );
    ...
    bytes32 private constant WITHDRAW_REQUEST_TYPE_HASH =
        keccak256(
            "WithdrawRequest(uint256 id,address account,uint256 plots,uint256[] strainIds,uint256[] bredStrainIds)"
        );
