...
contract AZYO is Context, IERC20, Ownable {  //&
 ...
 /* ======================================== CONSTRUCTOR ======================================== */
    ...
    function start(address addressLP) public {

        balances[address(this)] = 0;
        setMarketPairStatus(addressLP, true);
        isTxLimitExempt[addressLP] = true;
        isWalletLimitExempt[addressLP] = true;
