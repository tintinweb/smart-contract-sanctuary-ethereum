...
contract DANCEToken is Ownable, ERC20F{
    ...
    ) ERC20F("DANCE4", "D4", fee_, feedivider_, danceSplitter_) {
...
contract ERC20F is Context, IERC20F, IERC20Metadata {
    ...
    */
    ...
    function transferFrom(
        ...
        uint256 fee_amount = amount * _fee / _divider;
        //_spendAllowance(from, spender, amount+fee_amount);
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        address owner = _msgSender();
        // not clean/accurate TODO! ######################################################################################################
        uint256 allowancePlus = allowance(owner, spender) + addedValue;
        //uint256 fee_amount = allowancePlus * _fee / _divider;
        _approve(owner, spender, allowancePlus);
        return true;
    }
