...
// 0x9Ed9606Bd21220e437A0288be885EE3173638348

contract WizkidO2 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    uint256 public availableTickets = 5000;


    mapping (address=>uint256) public holderTokenIds;


    constructor() ERC721("WizkidO2", "WIZKID") {}
    ...
    function mint() public payable {
        ...
        require(tokenId <= maxTickets, "Tickets no longer available");

        string[3] memory svg;
        svg[0] = '<svg viewBox="0 0 404.76 404.76" xmlns="http://www.w3.org/2000/svg"><text y="50">';
        ...
        string memory json = Base64.encode(bytes
                (string
                    (abi.encodePacked
                        (
                        '{ "name": "WizkidO2 #', Strings.toString(tokenId),
                        '", "description": "WizkidO2 NFT Tickets", ', 
