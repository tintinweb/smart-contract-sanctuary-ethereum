...
contract CryptoCommandos is ERC721AQueryable, ERC721ABurnable, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        (bool s1, ) = dev.call{value: balance / 10}("");
        (bool s2, ) = blackArc.call{value: balance / 20}("");
        (bool s3, ) = treasury.call{value: balance / 70}("");
        require(s1 && s2 && s3, "Failed to send to treasury.");
    }
}
