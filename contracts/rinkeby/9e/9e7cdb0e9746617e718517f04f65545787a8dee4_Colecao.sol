...
contract Colecao is Ownable, ERC721AQueryable, ReentrancyGuard, IERC721ABurnable {
    using Address for *;
    string private _baseTokenURI;
    uint256 public immutable maxSupply = 5; // 🍀
    uint256 public immutable maxFree = 2;
    uint256 public reserved = 2;
    uint256 public immutable freeLimit = 2;
    uint256 public immutable buyLimit = 2;
    uint256 public immutable phase2price = 0.01 ether;
    string public contractURI; /// @dev collection metadata

    constructor() ERC721A("Colecao 2", "CLC2") {}
