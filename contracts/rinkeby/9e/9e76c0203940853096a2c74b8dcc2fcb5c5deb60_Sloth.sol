...
contract Sloth is ERC721, ERC721Enumerable, Ownable {
  ...
  // Constants
  uint256 constant public MAX_SUPPLY = 2022;//3
  uint256 public mintPrice = 0.001 ether;//mint 價格
  uint256 public whiteListPrice = 0.0005 ether;//白名單價格
  ...
  constructor() ERC721('LONGBAO', 'BAO') {}//token名字
