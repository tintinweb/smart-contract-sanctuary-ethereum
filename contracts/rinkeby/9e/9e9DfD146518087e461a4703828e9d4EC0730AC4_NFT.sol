...
contract NFT is ERC721, Ownable {
  ...
  constructor() ERC721("Name", "Symbol") {
    setHiddenMetadataUri("ipfs://QmPkzZpKaPjQaiH8Xo1Loeh1GSDH4opaqDrGnG1yy7twWw/hidden.json");
  }
 ...
 modifier mintCompliance(uint256 _mintAmount) {
  ...
  function mintAllowList(uint8 _mintAmount) external payable {
        ...
        require(ts + _mintAmount <= maxSupply, "Purchase would exceed max tokens");
