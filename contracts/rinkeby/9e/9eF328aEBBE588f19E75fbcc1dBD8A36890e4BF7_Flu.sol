...
contract Flu is Ownable, ERC721A, ERC2981, ReentrancyGuard {
    enum Phase {
        unavailable,
        available
    }

    Phase public PHASE = Phase.available;

    uint96 public ROYALTY_FEE = 750;
