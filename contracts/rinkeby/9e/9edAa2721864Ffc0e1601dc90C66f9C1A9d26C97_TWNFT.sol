...
contract TWNFT is ERC721Enumerable, ERC2981, Ownable {
    using Strings for uint256;

    uint256 public constant NUMBER_OF_DEFENDER = 14777;         // there are 14777 of Defenders
    uint256 public constant NUMBER_OF_CONQUEROR = 8888;         // there are 8888 of Conquerors
    uint256 public constant NUMBER_OF_RESERVED_CONQUEROR = 500;
    // uint256 public constant MAX_SUPPLY = 23665;                 // collection size
    ...
    uint256 public maxPerTx = 11;             // maxPerTx is 10
    uint256 public maxAllowedPerAddress = 6;  // max mints during presale per address is 5
    ...
    constructor(string memory _baseURI, address _proxyRegistryAddress, address _royaltyRecipient, address _adminSigner) ERC721("TokenName","TokenSymbol") {
    ...
    /// Set the ProxyRegistryAddress address
    ...
    function configureSalephase(SalePhase _phase, uint256 _newPriceDefender, uint256 _newPriceConqueror, uint256 _supplyLimitDefender, uint256 _supplyLimitConqueror) external onlyOwner {
        phase = _phase;
        mintPriceDefender = _newPriceDefender;
        mintPriceConqueror = _newPriceConqueror;
        supplyLimitDefender = _supplyLimitDefender;
	...
	/// Modifiers to validate Eth payments on payable functions
