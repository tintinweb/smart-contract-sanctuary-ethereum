...
struct DutchAuctionConfig {
  ...
  constructor(string memory initialBaseUri)
    ...
    presaleConfig = PresaleConfig({
      startTime: 1644585629, // Fri, 11 Feb 2022 13:18:45 GMT ~
      endTime: 1644838499, // Feb 15 2022 5pm
      supplyLimit: 8000,
    ...
    dutchAuctionConfig = DutchAuctionConfig({
      txLimit: 3,
      startTime: 1644838500, // Feb 15 2022 5pm
      bottomTime: 1644845831, // Feb 15 2022 8pm
