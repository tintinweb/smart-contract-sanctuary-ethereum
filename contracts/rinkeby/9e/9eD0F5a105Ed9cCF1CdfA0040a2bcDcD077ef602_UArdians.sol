...
contract UArdians is ERC721, Ownable {
  ...
  uint256 public supplyStage1 = 1;
  uint256 public supplyStage2 = 1;
  uint256 public supplyStage3 = 1;
  uint256 public supplyStage4 = 1;
  uint256 public supplyStage5 = 900;

  uint256 public maxMintAmountProject = 1;
  uint256 public releasePhase = 1;

  mapping(address => uint256) public mintBalances;

  constructor() ERC721("UArdians", "UA") {}
