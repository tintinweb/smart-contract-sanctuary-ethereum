...
contract Farming is Ownable {
    ...
    function add(
        ...
        emit LogPoolAddition(lpToken.length - 1, _allocPoint, _lpToken);
    }
    ...
    function changeLPToken(uint256 _pid, IERC20 _newToken) public onlyOwner {
        ...
        returns (uint256)
    {
        ...
        uint256 stakedSupply = lpToken[_pid].balanceOf(address(this));
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 reward =
            multiplier * rewardPerBlock * pool.allocPoint / totalAllocPoint;
        IMint(address(rewardToken)).mint(address(this), reward);
    ...
    // Deposit LP tokens to Farming contract for reward allocation.
