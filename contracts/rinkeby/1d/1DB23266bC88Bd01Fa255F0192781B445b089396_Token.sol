...
contract Token is ERC721Enumerable, Ownable {
    ...
    address public address1 = 0x544CA2710afB76726dE74cFF08Ce64aE760784B6; // should be updated
    address public address2 = 0xc303317684728BA39A43D82aa6d7D22a879312A9; // should be updated
    uint256 public firstWalletPercent = 80;
    uint256 public secondWalletPercent = 20;
    ...
    function withdrawToTwoAddress() public payable {
        require(payable(address1).send((msg.value * firstWalletPercent) / 100));
        require(
            payable(address2).send((msg.value * secondWalletPercent) / 100)
        );
    }
