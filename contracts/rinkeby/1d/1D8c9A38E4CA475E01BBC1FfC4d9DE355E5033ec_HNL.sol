...
contract HNL is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Hawkins National Laboratory", "HNL"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Cannot snipe for other people.");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"Supply Minted out");
