...
contract BoredMooseAssClub is ERC721A, Ownable {
  ...
  function publicMint() public callerIsUser{
    ...
    require(hasMinted[msg.sender] + 1 <= 5, "Max total mint amount reached");
    require(
  ...
  callerIsUser
  {
    ...
    require(hasMinted[msg.sender] <= 2, "Already minted max amount");
    require(hasMinted[msg.sender] + _quantity <= 2, "Already minted max amount");
    ...
    hasMinted[msg.sender] = hasMinted[msg.sender] + _quantity;
  }
  ...
  callerIsUser
  {
    ...
    require(hasMinted[msg.sender] <= 4, "Already minted max amount");
    require(hasMinted[msg.sender] + _quantity <= 4, "Already minted max amount");
    require(
      totalSupply() + _quantity <= collectionSize,
