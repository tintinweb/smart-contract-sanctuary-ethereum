...
/// @title TNC collection smart contract
contract TNC2 is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement {
    using Strings for uint256;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "TNC: total supply reached");
        _;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "TNC: tranfer is temporarily unavailable"
            );
        }
