...
contract Genesis is ERC721URIStorage, Ownable {
    ...
    function setIsAllowListActive(bool _isMintOpen) external onlyOwner {
    ...
    function createToken(string memory tokenURI) external payable {
    ...
    function tokenNotMinted(string memory tokenURI) public onlyOwner {
