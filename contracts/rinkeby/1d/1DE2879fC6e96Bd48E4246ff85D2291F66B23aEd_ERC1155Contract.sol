...
contract ERC1155Contract is ERC1155, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    function getClaimIneligibilityReason(address _addres, uint256 _quantity, uint256 _id) public view returns (string memory) {
        return tokenTypes[_id].saleIsActive && !tokenTypes[_id].preSaleIsActive ? "" : "NOT_LIVE";
    }
