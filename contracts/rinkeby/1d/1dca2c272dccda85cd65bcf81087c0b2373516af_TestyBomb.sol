 ...
 * @dev Extends BEP721 Non-Fungible Bombs Standard basic implementation
 */
contract TestyBomb is BEP721, Ownable {
    using SafeMath for uint256;
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 saleStart) BEP721(name, symbol) {
