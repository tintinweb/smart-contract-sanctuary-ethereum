...
contract zNFT_GG is ERC721A, Ownable, Pausable {
    using Strings for uint256;

    string public baseURI;
    uint256 public mintRate = 0.000001 ether;
    uint256 public MAX_SUPPLY = 41;
    bool public publicMint = true;

    constructor(string memory _initBaseURI) ERC721A("GG Test", "GG") {
