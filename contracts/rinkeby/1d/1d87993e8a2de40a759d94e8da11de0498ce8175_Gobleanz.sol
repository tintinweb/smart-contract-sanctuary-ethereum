...
contract Gobleanz is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public baseURI = "https://assets.abcde.fgh/";
    string private _contractURI;
    bool public isActive = false;

    address public royalties = 0xDA1213dED066553bBc72183eadA15Cde92aB09A0;
    ...
    function withdraw() public onlyOwner {
        payable(royalties).transfer(address(this).balance);
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address, uint256 royaltyAmount)
    {
        ...
        royaltyAmount = ((_salePrice * 750) / 100);
