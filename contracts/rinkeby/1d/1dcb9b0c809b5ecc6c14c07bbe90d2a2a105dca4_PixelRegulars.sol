...
// File: contracts/PixelRegulars.sol
...
pragma solidity ^0.8.0;
 ...
 contract PixelRegulars is ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    
    string public baseURI = "ipfs://QmXUemdvBZ7XnAc5sCwPDQ5suvC6mz1B5nfTVynqa6ALot";

    uint256 public constant TOTAL_FREE = 10;
    ...
    constructor() ERC721A("PixelRegulars", "PXGLS") { 
    }
