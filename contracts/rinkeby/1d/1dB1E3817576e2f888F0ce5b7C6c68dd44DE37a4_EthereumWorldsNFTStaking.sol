    ...
    EIP712Upgradeable
{
    ...
    uint256 private constant DEFAULT_MAX_TOKENS_IN_STAKE = 4388;
    ...
    uint256 public maxTokensInStake;
    uint256 public tokensInStake;

    IERC20Upgradeable public worldsToken;
    IERC721Upgradeable public towersContract;
    ...
    function initialize(
        ...
        worldsToken = IERC20Upgradeable(_worldsToken);
        towersContract = IERC721Upgradeable(_towersContract);
        serviceSigner = _serviceSigner;

        maxTokensInStake = DEFAULT_MAX_TOKENS_IN_STAKE;
        tokensInStake = 0;
        shutdown = false;
