...
contract PolarBearNFTContract is ERC2981, ERC721B, EIP712, AccessControl {

    using Strings for uint256;
    
    event MintedPolarBear(address indexed recipient, uint256 quantity);
    ...
    function setRoyalty(address _royaltyAddress, uint96 fee) external onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setupVerifyRole(address account) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function mint(
        ...
        emit MintedPolarBear(to, quantity);
    }
