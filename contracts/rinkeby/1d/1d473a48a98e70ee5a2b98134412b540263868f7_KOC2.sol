...
// File: contracts/KOC2-721a.sol

//SPDX-License-Identifier: MIT
pragma solidity 0.8.12;


contract KOC2 is ERC721A, EIP712, Ownable{
//    using Counters for Counters.Counter;
   ...
   // Counters.Counter private _tokenIds;
    ...
    constructor() 
    ERC721A("Knight Of Chain 2", "KOC2")
    EIP712("KOC2", "1.0.0")
    {}
 ...
 //       emit WhiteListMint(newTokenId, msg.sender);
    ...
    function updatePublicSale(bool publicSale) external onlyOwner {
