...
contract BullishAI is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://TBA/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.003 ether;
  uint256 public maxSupply = 696;
  ...
  constructor() ERC721("BullishAI", "BAI") {
    setHiddenMetadataUri("ipfs://QmNP5usgvrADXQG8S8ekrbTN4e66JwnRUD72iohRRsBQQR/");
  }
