...
contract TonicFactory is Initializable, ERC721Upgradeable, ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    function contractURI() public returns (string memory) {
        return "https://whitjack.me/tonic.json";
    }
    ...
    function setRoyalties(address reciever, uint96 feeNumerator) public onlyRole(ROYALTY_ROLE) {
