...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1653414960;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE5a052a15C77847D1A4B39F4633E334A182e3CbE];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNn6qLVJXB4a1bwXiUE29LgWZwFrjbX6UVHTa6DDghrMP/";
...
// File: contracts/AiboContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AiboContract is RamppERC721A {
    constructor() RamppERC721A(" Aibo", " Aibo"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qWlRWqJWAl49UokVBNN9/contract-metadata";
    }
}
