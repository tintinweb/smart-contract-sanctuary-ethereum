...
contract Axolotls is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Axolotls", "AXT") {
    setHiddenMetadataUri("ipfs://QmZ6VC9aJmBdxaMaaFsYGomPGexJGkzHEH5eNgDfMjbd21/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x340DDc8a72e504B46F37473eA35a1FE9a7AA5071).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
