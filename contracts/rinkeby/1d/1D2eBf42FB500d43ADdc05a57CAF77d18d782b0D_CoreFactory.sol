...
contract CoreFactory {
  ...
  event CollectionInitialized(string indexed _collectionid,string _collectionname,string _collectionsymbol,string _collectionbaseURI,uint256 _maxSupply);
    ...
    returns (address)
  {
    ...
    emit CollectionInitialized(_collection.id,_collection.name,_collection.symbol,_collection.baseURI,_collection.maxSupply);
    return coreCollection;
  }
}
