...
contract EcoNFT is ERC721, VRFConsumerBase, Ownable {
	...
	startIndex = 0;
	endIndex = 100;
	mintFeeETH = 0.01 * 10**18; //0.01 ETH
	mintFeeToken = 1000 * 10**18; //1000 ESG 
    ...
    //buy a lucky box
    function requestNewRandomNFTETH() public payable returns (bytes32) {
        require(
    ...
    function requestNewRandomNFTToken() public returns (bytes32) {
        require(
            LinkToken.balanceOf(address(this)) >= fee,
            "Not enough LINK"
        );
    ...
    function getNumberOfBoxSold() public view returns (uint256) {
        return boxSold; 
    }
    ...
    function tokenURI(uint256 tokenId) override public pure returns (string memory) {
        ...
        parts[0] = 'https://econft.net/nft/meta/';
