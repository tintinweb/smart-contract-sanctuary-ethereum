...
contract RichTokenStaking is Ownable, ReentrancyGuard {
    ...
    function poolInfo(address account) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        return (
            startStakingTs,
            canClaimTs,
            rewardAmount, 
    ...
    function userReward(address account) public view returns (uint256) {
        ...
        return (userStakedQty / totalStaked) * rewardAmount;
    }
