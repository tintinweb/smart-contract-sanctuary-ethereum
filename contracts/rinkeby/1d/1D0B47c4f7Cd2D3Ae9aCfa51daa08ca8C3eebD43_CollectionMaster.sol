...
contract CollectionMaster is Ownable, ERC721, ERC2981, SutterTreasury {
  ...
  address[] private mintPayees = [
    0xaDC6A7985036531c394B6dF054666C51dE29b9a9, //Instituição whindersson nunes
    0x76bf7b1e22C773754EBC608d92f71cc0B5D99d4B, //Distribuição do Tesouraria
    0x8b8AbE9CEC13CF5050517816B2E95722E711818e //Devs OmnesBlockchain
  ];
  ...
  constructor(string memory initialBaseUri)
    ERC721("Collection Whinderson Nunes", "WND")
    SutterTreasury(mintPayees, mintShares)
  {
    ...
    presaleConfig = PresaleConfig({ //configuração de inicio de pre sale
    ...
    royaltyPayees[0] = 0xaDC6A7985036531c394B6dF054666C51dE29b9a9; //Intiruição Winderson
    royaltyPayees[1] = 0x76bf7b1e22C773754EBC608d92f71cc0B5D99d4B; //Distribuição Tesouraria
