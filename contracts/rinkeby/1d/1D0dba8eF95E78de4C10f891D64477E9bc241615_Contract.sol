...
*/
    ...
    */
    ...
    payable
    {
        ...
        require(quantity <= OG_MAX_MINT, 'Cannot purchase this many tokens');
        require(claimed[msg.sender].add(quantity) <= OG_MAX_MINT, 'Purchase exceeds max whiteed');
    ...
    */
    ...
    payable
    {
        ...
        require(quantity <= FREE_MAX_MINT, 'Cannot purchase this many tokens');
        require(claimed[msg.sender].add(quantity) <= FREE_MAX_MINT, 'Purchase exceeds max whiteed');
        claimed[msg.sender] += quantity;
        freeClaimed += 1;
        _safeMint(msg.sender, quantity);
    ...
    */
    ...
    payable
    {
        ...
        require(quantity <= WHITELIST_MAX_MINT, 'Cannot purchase this many tokens');
        require(claimed[msg.sender].add(quantity) <= WHITELIST_MAX_MINT, 'Purchase exceeds max whiteed');
        require(NFTPrice.mul(quantity) == msg.value, "Ether value sent is not correct");
        claimed[msg.sender] += quantity;
        wlClaimed += 1;
        _safeMint(msg.sender, quantity);
    ...
    */
    ...
    payable
    {
        ...
        require(quantity <= RW_MAX_MINT, 'Cannot purchase this many tokens');
        require(claimed[msg.sender].add(quantity) <= RW_MAX_MINT, 'Purchase exceeds max whiteed');
        require(NFTPrice.mul(quantity) == msg.value, "Ether value sent is not correct");
        claimed[msg.sender] += quantity;
        rwClaimed += 1;
        _safeMint(msg.sender, quantity);
