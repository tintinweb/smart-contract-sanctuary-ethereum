...
contract SmulipFounders is ERC721, ERC721Enumerable, ERC2981, Ownable {
    using Counters for Counters.Counter;
    
    Counters.Counter private _tokenIdCounter;

    //need to verify maxSupply before launch
    uint256 public maxSupply = 20;
    bool public metadataLocked = false;
    
    //need to add prereveal metadata before launch
    string public baseURI = "ADD_PREREVEAL_URI_HERE";

    //need to change to smulips team wallet address
    address public teamWallet = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;

    event updatedURI (string oldURI, string newURI);
    event lockedURI (string finalURI);

    //need to check on name, symbol, and royalty fee before launch
    constructor() ERC721("SmulipFounders", "SMULF") {
        _setDefaultRoyalty(teamWallet, 500);
        batchMint(teamWallet, maxSupply);
    }
