    ...
    NFTOrders
{
        ...
        returns (uint256 profit)
    {
        ...
        bytes32 buyOrderHash;
        {
            ...
            sellOrderHash = sellOrderInfo.orderHash;
            buyOrderHash = buyOrderInfo.orderHash;
    ...
    /// @dev separate as an individual function to avoid "Stack too deep" error.
    /// @param sellOrder Order selling an ERC721 asset.
    /// @param sellOrder Order selling an ERC721 asset.
    /// @param sellOrderHash Order hash buying an ERC721 asset.
    /// @param buyOrderHash Order hash buying an ERC721 asset.
    function _emitMatch721OrderFilled(
        LibNFTOrder.ERC721Order memory sellOrder,
        LibNFTOrder.ERC721Order memory buyOrder,
        bytes32 sellOrderHash,
        bytes32 buyOrderHash
