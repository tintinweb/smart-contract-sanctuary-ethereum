...
contract TheNFTIslands is ITheNFTIslands, ERC721A, Ownable, AccessControl {
    ...
    uint256 private priceStd = 0.01 ether;
    uint256 private priceLrg = 0.015 ether;
    uint256 private pricePrm = 0.02 ether;
    ...
    uint256 private standardCurrentSupply;
    uint256 private largeCurrentSupply;
    uint256 private premiumCurrentSupply;

    uint256 private currentBundles;

    /*
     * Max mint per transaction per token type
     */
    uint256 private MAX_MINT_STD = 2;
    uint256 private MAX_MINT_LRG = 3;
    uint256 private MAX_MINT_PRM = 4;
    ...
    address internal constant project = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; //0x2da217E7518AA40767aE73C2872bba10807aab9d;
    ...
    constructor() ERC721A("The NFT Islands", "TNI") {
        ...
        shares[project] = 82;
        shares[shareHolder2] = 10;
        shares[shareHolder3] = 5;
        shares[dev] = 3;
    ...
    function currentSupplies() external view returns(uint256, uint256, uint256) {
      return (standardCurrentSupply, largeCurrentSupply, premiumCurrentSupply);
    }
    ...
    function intervalMint(uint256 quantityStd, uint256 quantityLrg, uint256 quantityPrm, bool stake, bool bundle) internal {
        ...
        if (bundle) {
          require(currentBundles < maxBundles, "T8");
    ...
    function setBaseURI(string calldata baseURI) external onlyOwner {
        require(!isUriFrozen, "URI has been frozen");
        _baseTokenURI = baseURI;
    }

    function freezeMetadata() external onlyOwner {
        require(!isUriFrozen, "URI already frozen");
        isUriFrozen = true;
    }
