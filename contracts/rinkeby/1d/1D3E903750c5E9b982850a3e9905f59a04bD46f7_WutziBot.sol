...
contract WutziBot is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public MAX_ELEMENTS = 5550;
    ...
    constructor(string memory baseURI, address DEV_ADDRESS) ERC721("WutziBot", "WutziBot") {
    ...
    function setDevAddr(address new_dev_addr) public onlyOwner{
        ...
        require(new_dev_addr != devAddress, "Already set");
