...
contract ArtivaToken is Ownable, ERC721 {
    IArtivaDescriptor descriptor;
    ISeeder seeder;
    ...
    constructor(
        IArtivaDescriptor _descriptor,
        ISeeder _seeder
    ) ERC721('Artiva', 'ARTIVA') {
    ...
    function tokenURI(uint256 tokenId) public override view returns (string memory) {
        require(_exists(tokenId), 'ArtivaToken: URI query for nonexistent token');
