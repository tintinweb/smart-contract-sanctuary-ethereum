...
contract NullAndVoid is ERC721URIStorage {
using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("NullAndVoid", "NULLVOID") {}
        ...
        returns (uint256)
    {
        ...
        if(newItemId == 0) {
            _setTokenURI(newItemId, "https://ipfs.io/ipfs/Qmd9JTC2MqZY9uvGMdmgf99WmoGVkcbgQcVyWfP37AdaS2/null.json");
        }
        else {
            _setTokenURI(newItemId, "https://ipfs.io/ipfs/Qmd9JTC2MqZY9uvGMdmgf99WmoGVkcbgQcVyWfP37AdaS2/void.json");
        }
