...
contract AmogTest is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 14;
  ...
  uint256 public constant MAX_MULTIMINT = 14;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 14 at a time");
