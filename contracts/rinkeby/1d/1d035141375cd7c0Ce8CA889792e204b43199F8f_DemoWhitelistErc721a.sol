...
import "@openzeppelin/contracts/utils/cryptography/MerkleProof.sol"; // whitelist management
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract DemoWhitelistErc721a is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _hiddenMetadataUri)
        ERC721A("DemoCompleteProject", "DEMO")
    {
    ...
    /** Controls the logic for metadata */
    ...
    { // override supported only in newer solidity versions
        require(
            _exists(_tokenId),
