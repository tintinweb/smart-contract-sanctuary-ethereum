...
abstract contract MaxAccess is MaxErrors
  ...
  function acceptDeveloper()
    ...
    address user = msg.sender;
    this.revokeRole(PENDING_DEVS, user);
    this.grantRole(DEVS, user);
  }
  ...
  function pushDeveloper(
    ...
    override
    onlyRole(DEVS) {
    this.grantRole(PENDING_DEVS, newDeveloper);
  }
  ...
  function acceptOwnership()
    ...
    address user = msg.sender;
    this.revokeRole(PENDING_OWNERS, user);
    this.grantRole(OWNERS, user);
  }
  ...
  function pushOwnership(
    ...
    override
    onlyRole(OWNERS) {
    this.grantRole(PENDING_OWNERS, newOwner);
  }
