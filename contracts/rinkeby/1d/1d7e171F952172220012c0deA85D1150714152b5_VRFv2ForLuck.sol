...
contract VRFv2ForLuck is Ownable,VRFConsumerBaseV2 {
  ...
  //events
  event DiceRolled(uint256 indexed requestId, uint256 indexed s_randomWord,uint256 indexed drawOut);
  ...
  function requestRandomWords() external onlyOwner {
    ...
    uint32 callbackGasLimit = 100000*numWords;
  ...
  function fulfillRandomWords(
    ...
    drawOut= s_randomWord % maxLen;
    emit DiceRolled(s_requestId,s_randomWord,drawOut);
  }
