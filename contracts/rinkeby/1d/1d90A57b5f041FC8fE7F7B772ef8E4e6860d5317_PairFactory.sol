...
contract PairFactory is Context, IPairFactory {
    ...
    function getInfoAdminFee() public view override returns (address, uint256, uint256) {
    ...
    function setSwapFee(uint256 adminFee, uint256 lpFee) external onlyManagerOrGovernance override {
...
interface IPairFactory {
    ...
    function getInfoAdminFee() external view returns (address, uint256, uint256);
