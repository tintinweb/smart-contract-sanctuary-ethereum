...
contract DaughterContract is Ownable {
    ...
    function howMuch() public view returns (uint256) {
        return allowance;
    }
}
...
contract SonContract is Ownable {
    ...
    function howMuchIsYourAllowance() public view returns (uint256) {
        return daughter.howMuch();
    }

    function howOldAreYou() public view returns (uint256) {
        return mom.getAge();
    }
}
