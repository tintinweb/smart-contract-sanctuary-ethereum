...
contract Zample is IERC20 {
    string public constant symbol = "ZAM";
    string public constant name = "Zample";
    ...
    function balanceOfERC20(address _tokenAddr) public view returns(uint balanceERC){
        balanceERC = IERC20(_tokenAddr).balanceOf(address(this));
        // return balanceERC;
    }

    function contractBalance()public view returns(uint _contractBalance){
    ...
    function withdrawTokens(address _tokenContract) external {
        ...
        uint256 _amount = IERC20(_tokenContract).balanceOf(address(this));
