 ...
 * @notice Interface for the Jio fee IFlashLoanReceiver. Modified from Aave's IFlashLoanReceiver interface.
...
library SwapUtils {
    ...
    // Max swap fee is 2% or 200bps of each swap
    uint256 public constant MAX_SWAP_FEE = 20**8;
     ...
     * @dev fee cannot be higher than 2% of each swap
     * @param self Swap struct to update
     * @param newSwapFee new swap fee to be applied on future transactions
     */
