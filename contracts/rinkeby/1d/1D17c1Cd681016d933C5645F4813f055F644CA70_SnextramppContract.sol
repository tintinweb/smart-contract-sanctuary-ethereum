...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xAC992dA07E0227D9E999E8a149945B3361Ba8043];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xAC992dA07E0227D9E999E8a149945B3361Ba8043;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmTVE2YAtkCESdaPVP9ePFigHb4NN6JutgPm7Fo5eqPE6G/";
...
// File: contracts/SnextramppContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SnextramppContract is RamppERC721A {
    constructor() RamppERC721A("SNEXT RAMPP", "SNEXT"){}
}
