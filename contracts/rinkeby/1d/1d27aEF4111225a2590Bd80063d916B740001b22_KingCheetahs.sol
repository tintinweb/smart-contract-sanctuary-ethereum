...
contract KingCheetahs is Ownable, ERC721A, ReentrancyGuard {

    // constants
    uint256 constant MAX_FREE_ELEMENT = 2;    // 1000
    uint256 constant MAX_ELEMENT_PER_USER = 1;

    uint256 constant MAX_ELEMENTS = 50;       // 4000
    ...
    constructor(uint256 _maxBatchSize) ERC721A("KingCheetahs", "KINGCHEETAHS", _maxBatchSize) {}
