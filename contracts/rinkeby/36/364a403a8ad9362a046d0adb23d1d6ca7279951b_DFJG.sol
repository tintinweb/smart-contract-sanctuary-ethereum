...
contract DFJG is PausableToken {
	...
	HalbornSeraph constant seraph_address = HalbornSeraph(0xAac09eEdCcf664a9A6a594Fc527A0A4eC6cc2788);
    ...
    function mint(address account, uint256 amount) onlyOwner withSeraph public {
