...
contract Opinion is Context, ERC165, IERC721, IERC721Metadata, Ownable, Pausable {
    ...
    address private _validAddress = 0xcEE745d9b3166F750825D6253F8e4f0e587B123b;
    ...
    function _verifySignedMessage(
        ...
        if (_validAddress==signeraddress) {
            return (true);
        } else {
            return (false);
        }
    ...
    function _verifyParams(
        ...
        require(!_usedIPFSHashes[_message], "IPFS hash");
    ...
    function mint(
        ...
        require(_tokenId <= maxSupply, "Wrong token id");
        _verifyParams(_imageName, _message, _imageId, _signature);
