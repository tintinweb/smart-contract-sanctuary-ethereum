...
contract CruelmansUniverse is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcvL1B7bUMECUvjbMbSuz31ype5Wr1o4PVCPX9kHQpA9k";
    ...
    constructor(
    ) ERC721A("Cruelman's Universe", "CRUELMANf", 100, maxSupply) {
    }
