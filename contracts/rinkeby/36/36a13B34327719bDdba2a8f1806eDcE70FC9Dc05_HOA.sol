...
contract HOA is ERC721URIStorage, Ownable {
    ...
    uint256 public opentimestamp = 1649863500;
    uint256 public publicPrice = 0.001 ether;
    uint256 public whitelistPrice = 0.0008 ether;
    ...
    function mintItem(address _to, uint _count) public payable {
      ...
      require(ownWallet[msg.sender] + _count <= 10, "Maxium is 10");
      require(msg.value >= _count * publicPrice, "Not match balance");
      require(_whitelistCnt.current() >= WL_ELEMENT, "You can't mint in presale period" );
    ...
    function setOpenTimestamp(uint timestamp) public onlyOwner {
    ...
    function isOpened() public view returns (bool) {
        return block.timestamp > opentimestamp;
    }
