...
contract StackFactory is Owned {
    ...
    event StackCreated(uint256 projectId, string stackType, IStack stack);
    ...
    function createProjectAndStack(
        ...
        string calldata stackType,
        string calldata stackName,
        string calldata stackSymbol,
        address projectAdminAndStackOwner,
        ...
        projectId = _createProject(projectMetadata, projectAdminAndStackOwner);
    ...
    function createStack(
        ...
        return _createStack(projectId, stackType, name, symbol, stackOwner);
    }
    ...
    function setProjectAdmin(uint256 projectId, address admin) external {
        if (projectAdmins[projectId] != msg.sender) revert NotProjectAdmin();
    ...
    function _createStack(
        ...
        stack.initialize(projectId, name, symbol, stackOwner);

        emit StackCreated(projectId, stackType, stack);
        return stack;
    }
}
