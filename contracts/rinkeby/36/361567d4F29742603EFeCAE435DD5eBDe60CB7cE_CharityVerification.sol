...
contract CharityVerification is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    /// @notice Change this in production
    function _baseURI() internal pure override returns (string memory) {
        return "https://kindblocks.xyz";
    }

    /// @dev Standard OpenZeppelin ERC720 template with one extra param
    /// @param to Gnosis safe address that is minting the NFT
    /// @param charityId Verified charity Id
    function safeMint(address to, string memory charityId, string memory uri) public onlyOwner {
