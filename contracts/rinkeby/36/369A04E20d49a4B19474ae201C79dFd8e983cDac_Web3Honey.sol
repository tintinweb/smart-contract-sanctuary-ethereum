...
contract Web3Honey is ERC721URIStorage,  Ownable {
    constructor()ERC721("web3honey's POF", "HONEY"){
      _tokenCount = 0;
      _metadataTypes = 12;
    ...
    function gacha(uint256 tokenId) public {
      require(!isGachad[tokenId], "You cannot do gacha twice");
      require(ownerOf(tokenId) == msg.sender, "You cannot do gacha");
