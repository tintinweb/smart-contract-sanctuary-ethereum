...
contract WebacyMembershipU is Initializable, AccessControlUpgradeable {
    ...
    function initialize(uint256 _amount, address _proxyFactoryAddress) public initializer {
    ...
    function removeFromWhitelist(address _address) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(whitelist[_address] == true, "address doesn't exists");
    ...
    function setWhitelistTokenContract(address _address) external onlyRole(DEFAULT_ADMIN_ROLE) {
