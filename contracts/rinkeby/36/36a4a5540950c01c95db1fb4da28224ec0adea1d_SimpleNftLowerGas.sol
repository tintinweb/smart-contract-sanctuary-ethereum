...
contract SimpleNftLowerGas is ERC721, Ownable ,RandomlyAssigned {
  using Strings for uint256;
  using Counters for Counters.Counter;
  ...
  function _mintLoop(address _receiver, uint256 _mintAmount) internal {
     require( availableTokenCount()+ _mintAmount >0, "No more tokens available");
