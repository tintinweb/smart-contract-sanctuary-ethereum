...
contract Shinjiro is Context, IERC20, Ownable {
    ...
    bool public swapTokensOnBuy = true;
    ...
    function setSwapTokensOnBuy(bool doEnable) external onlyOwner {
        swapTokensOnBuy = doEnable;
    }
    ...
    function setTaxFees(uint256 reflectionFee, uint256 buyFee, uint256 sellReflectionFee, uint256 sellFee, uint256 largeSellFee) external onlyOwner {
