...
bool public investingAssets = false;
...
constructor(
    ...
    ERC1155(initialParameters.uri) {
        ...
        setBRAQAddress(0x8c3241495D4145B957A0626Cfb034b8273d998d5);
    }
    //
    ...
    function newAsset(uint256 _id) public onlyOwner {
        require(!investingAssets, "The assets are locked and no more can be created"); 
    ...
    function mint(uint256 _id, uint256 amount) public payable{
        require(!investingAssets, "The assets are locked and no more can be minted"); 
        ...
        require(amount >= 1 && amount <= maxAllowed, "You are trying to mint more than is allocated"); 
