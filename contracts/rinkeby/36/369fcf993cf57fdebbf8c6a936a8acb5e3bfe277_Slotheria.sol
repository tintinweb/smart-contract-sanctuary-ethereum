...
contract Slotheria is ERC721, ERC721Enumerable, Pausable, Ownable {
...
// ======== 2. Lifecycle Methods  ========== //
    ...
    constructor() ERC721("Slotheria", "STA") {
        // Start token ID at 1
...
// ======== 4. Minting Functions ========== //
    ...
    function safeMint(address to) public payable  {
        require(totalSupply() < MAX_SUPPLY, "Boaa rubinho");
        require(msg.value >= MINT_PRICE, "Vaza paraiba");
...
// ======== 5. Other Functions ========== //
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmXWNWfnckjJcKUwUMkZX2QKRUe2U7JB6drsijLc6Aj1yV/";
    }
    function withdraw() public onlyOwner() {
        require(address(this).balance > 0,"no money fren");
