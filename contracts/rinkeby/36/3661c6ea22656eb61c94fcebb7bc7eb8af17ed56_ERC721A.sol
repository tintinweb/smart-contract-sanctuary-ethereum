...
contract SMILEZZZZ is Ownable, ERC721A {
    ...
    address constant internal DEV_ADDRESS = 0xa780e5F7E4bbF5130E18251F6bE90DE5ddC69fBA;
    ...
    constructor(string memory name, string memory _symbol, string memory _initbaseuri, string memory _hiddenMetadataUri ) ERC721A("SMILEZZZZ", "SMILE") { }
