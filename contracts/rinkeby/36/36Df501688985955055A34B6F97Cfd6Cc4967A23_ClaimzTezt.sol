...
contract ClaimzTezt is ERC721A, Ownable, ReentrancyGuard {
  ...
  address public v2Address = 0xB705B4E88974421ddfade4faA86399B5441A65a9;
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // 
    // =============================================================================
    (bool hs, ) = payable(0x6a80Ee76D9cba41a1Cc24A2fA39fed0b1e37AD99).call{value: address(this).balance * 4 / 100}('');
    require(hs);
    // =============================================================================
