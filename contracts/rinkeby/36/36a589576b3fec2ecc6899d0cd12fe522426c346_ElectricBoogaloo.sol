...
contract ElectricBoogaloo is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Electric Boogaloo", "EBOOG") {
    setHiddenMetadataUri("https://evolutionz.art/nft/hidden.json");

    setRooAddress(0x773C81bAeD8efFc60A8A6a718d2b74A4494A3046);
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    IERC721 token = IERC721(rooAddress);
    uint256 rooOwnerAmount = token.balanceOf(msg.sender);
    require(rooOwnerAmount >= 1, "You must own at least 1 RooTroop NFT");
