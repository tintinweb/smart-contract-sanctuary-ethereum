...
contract NftMinter is ERC721Enumerable, Ownable {
    ...
    // @params number of nft user want's to mint

    function mint(uint256 _amount) public payable {
        require(whiteListed[msg.sender] == true || msg.sender == owner());
        ...
        emit Mint(msg.sender, _amount, msg.value);
    }
    ...
    function setCost(uint256 _cost) public onlyOwner {
        require(_cost > 0, "Value less than 0");
        cost = _cost;
        emit SetCost(cost);
    }
    ...
    function checkWhiteListed(address whitelister) public view returns (bool) {
        return whiteListed[whitelister];
    }
