...
contract TheParrotBossAz1 is ERC721A, Ownable {
    ...
    constructor() ERC721A("TheParrotBossX1", "TPBX1") {}
    ...
    function withdraw() external onlyOwner {
        require(payable(0x6ABE0D01ecB287F4EC924b0593862700952b82bA).send(address(this).balance));
    }
