...
contract LambDuhPX is ERC721Enumerable, Ownable, nonReentrant {
    ...
    // uint256 public immutable MAX_PXLAMB = 6500;		// 6.5k supply
    ...
    uint256 public pxLambPrice = 1000000000000000; // 0.001 ETH TEST
    uint256 public constant maxPxLambPurchase = 20; // TEST

    uint256 public immutable MAX_PXLAMB = 50; // TEST
    // Reserve PX Lamb for team - Giveaways/Prizes etc
    uint256 public immutable MAX_PXLAMBRESERVE = 10; // total team reserves allowed
    ...
    function mint(uint256 _mintAmount) public payable reentryLock {
        require(saleState > SaleState.Presale, "public sale is not active");
    ...
    function mintPresale(
        ...
        require(
            MerkleRoot > 0x00 && saleState == SaleState.Presale,
