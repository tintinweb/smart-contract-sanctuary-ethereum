...
// todo maybe lower fee cause sudoswap shows price after fee so looks like a big discrepancy
// TODO discrepancy between tokenOfOwnerByIndex after mint...
...
contract Giza is Ownable, ERC721iEnumerable {
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        dev = msg.sender;
        sudoFactory = ISudoSwap(0xcB1514FE29db064fa595628E0BFFD10cdf998F33);
        multiplier = 4;
    }
    ...
    function mint() internal {
        ...
        emit ConsecutiveTransfer(
            totalSupply() == 0 ? 1 : totalSupply() - (multiplier - 1), //todo verify this
    ...
    function createPair() internal {
        address _sudoPair = sudoFactory.createPairETH(
            ...
            ICurve(0x3764b9FE584719C4570725A2b5A2485d418A186E), // Rinkeby linear curve //TODO change for mainnet
            payable(0x0), //   _assetRecipient .
            LSSVMPair.PoolType.TRADE, // pool type
            0, //delta
            50000000000000000, //fee
            50000000000000000, //starting price in eth
            new uint256[](0)
        );
