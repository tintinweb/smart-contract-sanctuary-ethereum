...
IERC20 public ethAddress;
   ...
   uint _cash=(tokenPrice );
   
   uint _amount=(amount )  *  ( _cash) ; // convert the eth token to the bmt token

       ethAddress.transferFrom(msg.sender,address(this),amount); // transfer eth to the walletto the contract
