...
contract LirnV3 is Initializable, ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function mintQuizNewV3(address _adr, uint256 _quiz) external {
    ...
    function adminMintQuiz(address _adr, uint256 _quiz) external onlyOwner {
        // removed onlyOwner for demo
    ...
    function communityBurn(address _adr, uint256 _id) external {
        _burn(_adr, _id, 1);
        supplyBalance[msg.sender][_id] -= 1;
    }
