...
contract Demo is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    modifier presaleActive() {
        require(isPresaleActive, "Presale sale is not open");
        _;
    }
    ...
    modifier maxTokensPerWallet(uint256 numberOfTokens) {
        require(
            ...
            "Public sale limit reached for this wallet"
        );
        _;
    }
    ...
    {   
        ...
        require(
            numAlreadyMinted + numberOfTokens <= PRESALE_LIMIT,
            "Presale limit reached for this wallet"
        );
        ...
        presaleMintCount[msg.sender] = numAlreadyMinted + numberOfTokens;
