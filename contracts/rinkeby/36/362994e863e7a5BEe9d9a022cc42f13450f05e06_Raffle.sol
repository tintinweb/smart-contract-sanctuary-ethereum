...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        i_enhanceFee = enhanceFee;
        i_coordinator = VRFCoordinatorV2Interface(vrfCoordinator);
        i_keyHash = keyHash;
        i_subscriptionId = subscriptionId;
        i_callbackGasLimit = callbackGasLimit;
        s_lastedTime = block.timestamp;
        i_interval = interval;
    }

    function enterRaffle() payable public {
        // require(msg.value >= i_enhanceFee, "");
        if (msg.value < i_enhanceFee) {
    ...
    //         NUM_WORDS
    //     );
    //     emit RequestedRaffleWiner(s_requestId);
    // }
    ...
    function checkUpkeep(bytes memory /* checkData */) public view override returns (bool upkeepNeeded, bytes memory /* performData */) {
        ...
        bool isTimeStamp = (block.timestamp - s_lastedTime) > i_interval;
        bool hasPlayers = s_players.length > 0;
        bool hasBalance = address(this).balance > 0;
        upkeepNeeded = (isTimeStamp && isOpen && hasBalance && hasPlayers);
    ...
    /* View/Pure function */
    function getEnhanceFee() public view returns (uint256){
        return (i_enhanceFee);
    }
