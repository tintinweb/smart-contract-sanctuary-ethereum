...
contract USDCManager is Ownable {
    address public immutable USDC = 0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b;
...
contract PolyMath is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 200;
    ...
    address payable marketingWallet =
        payable(0xF8b54Ef7a87c68e372BEE6a0d7c122e113D55A5C);
    ...
    constructor() ERC20("PolyMath.Finance", "PMF") {
    ...
    function changeLiquidityFee(uint256 _liquidityFee) external {
        emit LiquidityFeeChanged(liquidityFee, _liquidityFee);
        liquidityFee = _liquidityFee;
        totalFees = _liquidityFee + burnFees + marketingFees + devFees;
    }

    function changeBurnFee(uint256 _burnFee) external {
