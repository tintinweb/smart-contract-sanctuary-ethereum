...
contract WenWL is ERC1155Supply, Ownable{
    ...
    address public constant ADDRESS_1 = 0xCb583ace502f4F8b9f72309c56B1195606e68ad9; //OWNER
    ...
    modifier isSecured(uint8 mintType) {
        ...
        if(mintType == 2) {
            require(DIAMOND_IS_ACTIVE, "DIAMOND_MINT_IS_NOT_YET_ACTIVE");
        }
        _;
    }
    ...
    function mintDiamond() external onlyOwner {
        require(totalSupply(DIAMOND) <= DIAMOND_SUPPLY,"EXCEED_MINT_LIMIT");
        _mint(msg.sender, DIAMOND, DIAMOND_SUPPLY, "");
    }
    ...
    //Essential
    function setRubySaleStatus() external onlyOwner {
        RUBY_IS_ACTIVE = !RUBY_IS_ACTIVE;
    }

    function setDiamondSaleStatus() external onlyOwner {
        DIAMOND_IS_ACTIVE = !DIAMOND_IS_ACTIVE;
    }
    ...
    //Passed as wei
    function setDiamondPrice(uint256 _diamondPrice) external onlyOwner {
        DIAMOND_PRICE = _diamondPrice;
    }
