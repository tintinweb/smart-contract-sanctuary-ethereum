...
abstract contract Ownable is Context {
    ...
    contract Shrooms is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://yourmetadataherenick";
  ...
  bytes32 public whitelistMerkleRoot = 0x66097a72dcaa3275a3597c3fdb73300b981b8da4d91e15592c8a48209918c7c8;
  

  constructor() ERC721A("SHROOMS", "SHROOMS") {
  }
  ...
  function mint(uint8 _mintAmount) external payable  {
    ...
    require(_mintAmount <= maxMintAmountPerTx, "Exceeds max limit per transaction.");
...
if ( reveal == false)
{
 ...
 function setMaxFreeMintAmountPerWallet(uint8 _limit) external onlyOwner{
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external  payable{
     ...
     if(_txPerAddress >= maxFreeMintAmountPerWallet)
    {
    require(msg.value >= cost * _mintAmount, "Insufficient funds!");
    }
    else {
