...
//
//   _______                    ______                 
//  /_  __(_)___ ___  ___  ____/ / __ \_________  ____ 
//   / / / / __ `__ \/ _ \/ __  / / / / ___/ __ \/ __ \
//  / / / / / / / / /  __/ /_/ / /_/ / /  / /_/ / /_/ /
// /_/ /_/_/ /_/ /_/\___/\__,_/_____/_/   \____/ .___/ 
//                                            /_/      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1653354000;
...
// File: contracts/TimedDropContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TimedDropContract is RamppERC721A {
    constructor() RamppERC721A("TimedDrop", "TIME"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/aJRtR5qED7TuFhuzaUsZ/contract-metadata";
    }
}
