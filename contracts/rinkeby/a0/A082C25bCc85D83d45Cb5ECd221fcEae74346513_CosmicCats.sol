...
contract CosmicCats is ERC721A, Ownable, CosmicVoucherSigner {  
    ...
    // Team Addresses
    address public a1 = 0xc05e86d6aDdE29FC353764b8e116BcB669A96205; // Justin
    address public a2 = 0x3c564044123B2Ca6AB4dE20Af9Fa0E159783a2D5; // Dontblink
    address public a3 = 0x98067D7ABf4b4E3379AD9b784a46F1d74008BdAd; // Skelligore
    address public a4 = 0xCBF5224a8d43Ab3bb239Df5cE2E575C4c481B39D; // Community Wallet
    ...
    // 24% To Each Team Member - 24% To Community Wallet // 4% Buffer Incase of Solidity Rounding Error
        require(payable(a1).send(percent * 24));
        require(payable(a2).send(percent * 24));
        require(payable(a3).send(percent * 24));
        require(payable(a4).send(percent * 24));
    }
