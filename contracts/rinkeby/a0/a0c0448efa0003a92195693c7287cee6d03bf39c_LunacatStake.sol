...
contract LunacatStake is Ownable {
    ...
    function getAllPoolsAPY() public view returns(uint256[] memory){
        uint256[] memory APYarray;
        uint256 rarity = getRarityToApply();
    ...
    function testGetAllPoolsAPY() public view returns(uint256,uint256){
        ...
        */
        return (stakePoolArray.length,rarity);
    }
