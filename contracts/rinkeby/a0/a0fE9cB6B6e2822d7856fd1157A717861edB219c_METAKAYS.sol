...
contract METAKAYS is Ownable, ERC721A {
    struct Features {
    ...
    uint256 public constant AMOUNT_FOR_METACOUNCIL = 288;
    ...
    constructor()
    ERC721A("TESTINGKAWS", "8888", 4, 8888) {
    ...
    function customize(uint256 _itemID, uint8[] memory selection_, string memory _entryName) public {
  ...
  function devMint(uint256 quantity) external onlyOwner {
    require(totalSupply() + quantity <= AMOUNT_FOR_METACOUNCIL, "TOO MANY ALREADY MINTED!");
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    string memory _first= concatenate(
      ...
      svgBackgroundColor[feature.bodyColor],'<g transform="translate(0.000000,888.000000) scale(0.100000,-0.100000)"><text x="44188" y="-8800" font-size="4800px" font-family="impact" font-style="italic" font-weight="bold" dominant-baseline="middle" text-anchor="middle">',
      feature.customText,
      '</text></g><g transform="translate(0.000000,888.000000) scale(0.100000,-0.100000)"><text x="70888" y="-14488" font-size="2888px" font-family="impact" font-style="italic" font-weight="bold" dominant-baseline="center" text-anchor="end">', tokenIdString,//uint2str(_tokenId),
    ...
    string memory imageURI = string(abi.encodePacked("data:image/svg+xml;base64, ", Base64.encode(bytes(string(abi.encodePacked(_first, _last,features3.readHair(feature.hairStyle), svgBackgroundColor[feature.hairColor],'</g></svg>')))))); //'"/> </g></svg>'
        ...
        Base64.encode(
          bytes(
            abi.encodePacked(
              ...
              '", "description":"The first 100% ON-CHAIN + 100% CUSTOMIZABLE NFT. The beginning of the MULTIMETAVERSE. . .", "attributes":[{"trait_type" : "Finality", "value" : "', finality_ ,'"}], "image":"',imageURI,'"}'
            )
          )
        )
      )
