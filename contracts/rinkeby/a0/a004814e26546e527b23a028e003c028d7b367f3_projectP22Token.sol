...
contract projectP22Token is Ownable, ERC721A, ReentrancyGuard, IERC721Receiver, VRFConsumerBaseV2 {
    ...
    uint32 public goldenTicketTokenMaxAvailableIndex = 50;
    ...
    address public goldenTokenAddressOfGoldenTicket;
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        Erc721Contract erc721ContractInstance = Erc721Contract(goldenTokenAddressOfGoldenTicket);
