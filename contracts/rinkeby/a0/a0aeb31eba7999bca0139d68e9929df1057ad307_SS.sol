...
contract SS is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    string _baseUri = "ipfs://QmdGXMzXXkUGybG8kzGXkKp5qf2LLqutqdGGTkP434rmtT/";

    uint256 public constant MAX_SUPPLY = 6969;
    
    uint256 public tokenPricePresale = 0.003 ether;
    uint256 public tokenPricePublicSale = 0.005 ether;
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount + totalSupply() <= MAX_SUPPLY, "Not enough tokens left for minting");
        require(hasPublicSaleStarted || presalePurchased[msg.sender] + amount <= maxPresaleMint, 
          "Cannot mint more than the max tokens per whitelisted address");
        require(amount <= maxPerTransaction, "Max mint per transaction exceeded");
