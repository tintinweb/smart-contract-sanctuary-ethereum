...
//*********************************************************************//
//
//  _       __     __   _____              ___    __      __             ____                 
// | |     / /__  / /_ |__  /____ ___     /   |  / /___  / /_  ____ _   / __ \____ ___________
// | | /| / / _ \/ __ \ /_ </ __ `__ \   / /| | / / __ \/ __ \/ __ `/  / /_/ / __ `/ ___/ ___/
// | |/ |/ /  __/ /_/ /__/ / / / / / /  / ___ |/ / /_/ / / / / /_/ /  / ____/ /_/ (__  |__  ) 
// |__/|__/\___/_.___/____/_/ /_/ /_/  /_/  |_/_/ .___/_/ /_/\__,_/  /_/    \__,_/____/____/  
//                                             /_/                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd77AF5052dA24B35e3aB0553822fFCeF6639bA23];
...
// File: contracts/Web3MAlphaPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract Web3MAlphaPassContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Web3m Alpha Pass";
    string public symbol = "WMALPHA";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/BUCSudDTuaEoNUzProC2/contract-metadata";
    }
