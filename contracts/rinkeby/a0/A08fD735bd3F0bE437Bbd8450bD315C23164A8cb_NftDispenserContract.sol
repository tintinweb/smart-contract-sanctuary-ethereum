...
//  | \ | |  ____|__   __| |  __ \(_)                                   
//  |  \| | |__     | |    | |  | |_ ___ _ __   ___ _ __  ___  ___ _ __ 
//  | . ` |  __|    | |    | |  | | / __| '_ \ / _ \ '_ \/ __|/ _ \ '__|
//  | |\  | |       | |    | |__| | \__ \ |_) |  __/ | | \__ \  __/ |   
//  |_| \_|_|       |_|    |_____/|_|___/ .__/ \___|_| |_|___/\___|_|   
//                                      | |                             
//                                      |_|                             
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xFe370328DaD9fb000255c51AA19E52b5425DdbF0];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmebN5oXVvJqTkFF4kTzVvfiTkHoffpPPayFeybjDQEAwZ/";
...
// File: contracts/NftDispenserContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftDispenserContract is RamppERC721A {
    constructor() RamppERC721A("NFT Dispenser", "Icons"){}
}
