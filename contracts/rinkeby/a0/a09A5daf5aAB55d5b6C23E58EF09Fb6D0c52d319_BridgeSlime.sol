...
contract BridgeSlime is Ownable {
    ...
    function claim(
        ...
        uint256 finalAmount = ((amount * (10000 - taxPercent)) / 10000);
    ...
    /**
     * @dev Cancels all claims for oneself
     */
    ...
    /**
     * @dev Adjustable tax rate for the bridge
     */
     ...
     */
    function withdrawTokens(IERC20 erc20Address, uint256 amount)
        external
        onlyOwner
    {
        erc20Address.transfer(msg.sender, amount);
    }
}
