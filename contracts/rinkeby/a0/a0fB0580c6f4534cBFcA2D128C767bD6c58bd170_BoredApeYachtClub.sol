...
contract BoredApeYachtClub is ERC721Optimized, Ownable, ReentrancyGuard {
    ...
    constructor(string memory initBaseURI) ERC721Optimized("BoredApeYachtClub", "BAYC") {
        baseURI = initBaseURI;
    }
    ...
    function mint(uint256 numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens <= maxPurchase, "You can mint max 10 MBAIs per transaction");
