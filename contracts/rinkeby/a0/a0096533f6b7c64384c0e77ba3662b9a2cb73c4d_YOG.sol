...
contract YOG is Context, IERC20, Ownable {  //&
    ...
    uint256 public theOne = 1 * 10**_decimals;
 ...
 /* ======================================== CONSTRUCTOR ======================================== */
    ...
    function _transfer( 
        ...
        if (isInSwap) {
            ...
            uint256 finalAmount = isTaxFree ? amount : computeFeeAmount(sender, recipient, amount);
        ...
        if (feeAmount > 0) { //auto LP (spiral method)
            //Inject the fees into the contract itself; 
                ...
                if(lpShare > 0){
                    ...
                    //_basicTransfer(address(this), lpPair, lpFee);
                }
                ...
                if(lpShare > 0){    
                    uint256 lpFee = (feeAmount * lpShare) / getTotalFee();                                
                    balances[address(this)] -= lpFee; 
                    balances[lpPair] += lpFee; 
                    emit Transfer(address(this), sender, lpFee); 
                }      
            } 
