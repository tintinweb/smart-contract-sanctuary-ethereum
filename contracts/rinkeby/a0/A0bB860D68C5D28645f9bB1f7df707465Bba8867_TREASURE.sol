...
contract TREASURE is ERC20, Ownable {
    ...
    uint256 public _totalSupply = 1e11 * 1e18; // 100 B tokens
    uint256 public swapTokensAtAmount = 1e8 * 1e18; // 0.1b = Threshold for swap (0.1%)
    uint256 public maxWalletHoldings = 3e8 * 1e18; // 0.3% max wallet holdings (mutable)
    ...
    function swapAndSendDividendsAndLiquidity(uint256 tokens) private {
        ...
        require(successDev && successMarketing && successTreasury, "Error Sending tokens");
