...
||   ;        \  \       ╚═╝   ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝       ╚═╝╚══════╝       ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝
||===;        \  \
||   |         | |    1- HEXY IS A CONTRACT FOR TRUSTLESSLY POOLING 14 HEX STAKES LADDERED YEARLY WITH 5.555 PRECENT OF TOTAL HEX PLEDGED AND ONE FINAL STAKE WITH 22.23 PERCENT FOR THE 15TH YEAR.
...
|_ /    ||   |\\      5- HEXY IS A STANDARD ERC20 TOKEN, MINTED UPON HEX DEPOSIT AND BURNT UPON HEX REDEMPTION, AND AN EXTRA 5.555 PERCENT OF TOTAL HEX PLEDGED MINTED ON LAUNCH DATE TO PAY FOR NEW HEX HOLDERS AIRDROP, DEVELOPMENT, TRANSACTION FEES, AUDIT, AND MARKETING.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     *
     * NOTE: If `amount` is the HEXYmum `uint256`, the allowance is not updated on
...
contract YalaHex is ERC20, ERC20Burnable, ReentrancyGuard, Ownable {
    ...
    address constant HEX_ADDRESS = 0x78a52239383f4B772781276b3De36086A5a2169e;
