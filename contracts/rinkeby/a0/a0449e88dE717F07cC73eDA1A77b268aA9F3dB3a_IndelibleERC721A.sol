// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        constructor() ERC721A(unicode"Hirsch", unicode"HIRSCH") {
            TIERS[0] = [3,21,29,55,57,68,76,100,227,364];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Hirsch #");

            jsonBytes.appendSafe(
                abi.encodePacked(
                    _toString(_tokenId),
                    unicode"\",\"description\":\"Hirsch\","
                )
            );
