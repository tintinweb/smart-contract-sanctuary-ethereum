...
// File: contracts/ZBDubaiClub.sol
...
contract ZBDubaiClub is ERC721, Ownable {

    using SafeMath for uint256;
    uint public constant GIFT_ITEMS = 50;
    uint public constant PREADOPT_ITEMS = 2000;
    uint public constant TOTAL_ITEMS = 5001;
    uint public constant MAX_ITEMS_PER_MINT = 20;
    uint256 public constant preSaleitemPrice = 0.2 ether;
    uint256 public constant itemPrice = 0.3 ether;
    uint public giftItems = 0;
    uint public preSaleItems = 0;
    bool public saleIsActive = false;
    bool public preSaleIsActive = false;

    constructor() ERC721("ZB DUBAI CLUB", "ZBDC") {
    }

    function gift( address [] memory recipients ) public onlyOwner {
