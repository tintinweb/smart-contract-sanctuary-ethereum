...
//
//     ____                           __  ____       __                
//    / __ \___  ____ ____  ____     /  |/  (_)___  / /____  __________
//   / / / / _ \/ __ `/ _ \/ __ \   / /|_/ / / __ \/ __/ _ \/ ___/ ___/
//  / /_/ /  __/ /_/ /  __/ / / /  / /  / / / / / / /_/  __/ /  (__  ) 
// /_____/\___/\__, /\___/_/ /_/  /_/  /_/_/_/ /_/\__/\___/_/  /____/  
//            /____/                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 3323 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQPgF3mEECvtymkjerXJJw517zqaap1g7SjnA4PK4Vcxs/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3323");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3323");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3323");
...
// File: contracts/DegenMintersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DegenMintersContract is RamppERC721A {
    constructor() RamppERC721A("Degen Minters", "DM"){}
}
