  ...
  ERC1155HolderUpgradeable
{
  ...
  event AirdropCreated(address nftAsset, address airdropTokenAddress, uint256 airdropTokenType, uint256 claimType);
  ...
  */
  ...
  // user address => airdrop token address => id/amount
  mapping(address => mapping(address => bool)) public airdropClaimeds;
  ...
  function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal {
    vrfRandomWords[requestId] = randomWords;
    ...
    console.log("fulfillRandomWords", airdropId, randomWords[0]);
  }
  ...
  function createAirdrop(
    ...
    if (data.claimType == CLAIM_TYPE_RANDOM) {
    ...
    emit AirdropCreated(nftAsset, airdropTokenAddress, airdropTokenType, claimType);
