...
contract _CryptoRenaissance is ERC721("Crypto-Renaissance", "CrypRen") {
    ...
    uint256 constant MINT_FEE = 0.06 ether;

    uint256 constant MAX_GIVEAWAY_SUPPLY = 10;

    uint256 constant maxMintPerWallet = 100;

    uint256 constant MAX_SUPPLY = 2000;

    address constant REN_TEAM = address(0xA0c8041d9e225cba96089778C0cA3bf9fb7AFb7D); // change this to your address

    string constant unrevealedURI = "https://ipfs.io/ipfs/QmY2TWQRxGWe2uJ2kADu8MPQujjLVoRASeGxPRt5rFacix";
    ...
    function giveaway(address account, uint256 amount) external {
        ...
        // make sure only REN team can call this method
        require(msg.sender == REN_TEAM);
