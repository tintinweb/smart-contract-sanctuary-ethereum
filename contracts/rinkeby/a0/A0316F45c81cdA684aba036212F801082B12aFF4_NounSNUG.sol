...
contract NounSNUG is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    uint256 private maxMintsPerPS = 77;
    uint256 private maxMintsPerS = 7;
    ...
    constructor () ERC721A ("NounSNUG","NSNUG", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
    ...
    function publicMint(uint256 _amount) public payable nonReentrant onlySender {
        ...
        require(maxMintsPerS >= _amount, "publicMint: 7 max per tx");
        require(maxMintsPerS >= psMinted[msg.sender] + _amount, "You have no publicMint left");
