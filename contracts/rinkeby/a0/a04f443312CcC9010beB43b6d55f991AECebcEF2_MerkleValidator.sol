...
contract MerkleValidator {
    ...
    /// @param from The account to transfer the ERC721 token from â€” this token must first be approved on the seller's AuthenticatedProxy contract.
    /// @param to The account to transfer the ERC721 token to.
    /// @param token The ERC721 token to transfer.
    /// @param tokenId The ERC721 tokenId to transfer.
    /// @param root A merkle root derived from each valid tokenId â€” set to 0 to indicate a collection-level or tokenId-specific order.
    ...
    /// @param from The account to transfer the ERC1155 token from â€” this token must first be approved on the seller's AuthenticatedProxy contract.
