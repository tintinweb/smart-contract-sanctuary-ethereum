...
contract FortuneNFT is ERC721ABurnable, Ownable {
    // metadata
    ...
    uint256 public constant PER_WALLET_LIMIT = 2;
    ...
    function mint(uint256 count) public {
        ...
        require(count + _numberMinted(msg.sender) <= PER_WALLET_LIMIT, "Limit exceeded");
