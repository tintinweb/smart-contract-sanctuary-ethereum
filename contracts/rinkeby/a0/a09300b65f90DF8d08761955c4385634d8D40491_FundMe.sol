...
contract FundMe {
    ...
    address[] public funders; //help us keep tract of all our wonderfull donators
    mapping(address => uint256) public addressToAmountFunded; //keep tract of amount for each donator

    address public immutable i_owner; //i_owner  of this contract(Who deploy this contract)
    ...
    //This function receive fund from users
    ...
    function withraw() public onlyOwner {
        ...
        //resetting the array
        funders = new address[](0); //new array with 0 element
