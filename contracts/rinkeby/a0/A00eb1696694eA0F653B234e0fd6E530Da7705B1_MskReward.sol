...
contract MskReward is Context, Ownable {
    ...
    function setClaimInfo(uint32 _time, uint224 _amount) external {
        m_ClaimInfoList[_msgSender()] = ClaimInfo(_time, _amount);
    }

    function getClaimInfo() external view returns (ClaimInfo memory) {
        return m_ClaimInfoList[_msgSender()];
    }
