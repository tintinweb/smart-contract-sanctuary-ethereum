...
contract M13 is ERC721, Ownable, RandomlyAssigned {
  
  using Strings for uint256;
  string public baseURI = "https://ipfs.io/ipfs/Qmdw2i4BkBd89gRmvQi6eo1fDhj3tpRFNnvxqRHemPkdz2/";
...
constructor() 
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x9120019aa8BAF44F539A7dd5Dd4905508b0A7798).call{value: address(this).balance * 50 / 100}("");
    require(hs);
