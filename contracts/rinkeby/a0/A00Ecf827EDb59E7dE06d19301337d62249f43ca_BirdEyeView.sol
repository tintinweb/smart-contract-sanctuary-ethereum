...
contract BirdEyeView is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("Bird Eye View", "EN") {
    setHiddenMetadataUri("ipfs://QmWqyfW3eZkFkSjxGsgeb3jEifvMJFuAw8rG5Y75kjLwMv/hidden.json");
  }
