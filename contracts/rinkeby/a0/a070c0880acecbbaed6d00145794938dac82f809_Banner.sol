...
// File: banner_flat_flat.sol


// File: banner_flat.sol
...
contract Banner is ERC721Enumerable, Ownable {
    ...
    bool public _isMineSaleActive = false;
    ...
    function flipPublicSaleActive() public onlyOwner {
        ...
        function flipMineSaleActive() public onlyOwner {
        _isMineSaleActive = !_isMineSaleActive;
        mintPrice = 0 ether;
    }
