...
contract templatecontract is ERC721, Ownable, ReentrancyGuard {
    ...
    string public constant PROVENANCE_HASH = "PROVENANCE";
	...
	constructor(address _signerAddress) ERC721("Template", "Template") {
