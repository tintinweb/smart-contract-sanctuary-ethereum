...
contract NaughtyGiraffes is ERC721A, Ownable {
    ...
    uint256 private _publicStartTime = 1650767400; // Sunday, 24 April 2022 02:30:00 PM GMT (Sunday, April 24, 2022 10:30:00 AM GMT-04:00 DST)
    ...
    uint256 public maxPublicsaleSupply = 9700;
   
    constructor() ERC721A("Naughty Giraffes", "GIRAFFE") {
        _tokenBaseURI = "ipfs://QmQSrhWELz2yao4SdwKCitKZmPmqqpsbL9mgGgCe5PxpwC";
        withdrawalWalletAddress = 0xfAEe421084a4B3c2aaE524cB0dFAc8327E966A15;
    }
    ...
    function ownerMint() external onlyOwner {
        uint256 _numOfTokensToMint = 300;
        _safeMint(msg.sender, _numOfTokensToMint);
    }
    ...
    function setMaxMintPerAddress(uint256[] calldata _mintPerAddress) external onlyOwner {
