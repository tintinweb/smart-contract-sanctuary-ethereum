...
// FireUniFetch helps your migrate your existing Uniswap LP tokens to Fireswap LP ones
contract FireUniFetch {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'FireUniFetch: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'FireUniFetch: INSUFFICIENT_B_AMOUNT');
    }
