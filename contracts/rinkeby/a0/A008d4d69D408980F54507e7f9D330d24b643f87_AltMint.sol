...
/**
 * @title NFT ALT MINT I on Rinkeby, featured by Alt.
 *
...
contract AltMint is PackDropBase {
    /// @dev Rinkeby Mainnet constructor.
    /// See {https://docs.chain.link/docs/vrf-contracts/#rinkeby} for VRF parameters.
    constructor()
        PackDropBase(
            'ALT MINT I',
            6,                                                                  // Max 6 tokens per transaction
            6,                                                                  // Max 6 tokens per address
            0.01 * 10**18,                                                      // 0.35 ETH (subject to updates before the drop)
            0xC4c1359B7e48a9Add0356B8b26A69B8407151D23,                         // Signer Address for the Allow List - to be changed on mainnet
            0x247847f7E69eA62d2d86Ed22e54F0c8eBbD46660,                         // Alt Escrow Admin Multisig
            0x247847f7E69eA62d2d86Ed22e54F0c8eBbD46660,                         // Alt Minting Admin Multisig
            0xBAFF17A153fe3916c5Ff8118Ffb177489CbD50e2,                         // Alt Vault Proxy deployed on Rinkeby - to be changed on mainnet
            0x6168499c0cFfCaCD319c818142124B7A15E857ab,                         // VRFCoordinator on Rinkeby - to be changed on mainnet
            0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc, // Chainlink keyHash on Rinkeby - to be changed on mainnet
            5024                                                                // Chainlink v2 Subscription ID - to be changed on mainnet
        )
    {}
}
