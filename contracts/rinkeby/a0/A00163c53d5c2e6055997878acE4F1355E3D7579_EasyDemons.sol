...
contract EasyDemons is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant AUCTION_PERIOD = 2 minutes;

    uint256 public constant MAX_DEVMINT_SUPPLY = 5;
    uint256 public constant MAX_PUBLIC_SUPPLY = 10;
    ...
    function devMint(address to, uint256 tokenQuantity) external onlyOwner {
        ...
        require(totalSupply() <= TOTAL_SUPPLY, "all minted");
    ...
    function presaleMint(uint256 tokenQuantity, uint256 allowance, bytes32[] calldata proof) external payable onlySender nonReentrant {
        ...
        require(totalSupply() <= TOTAL_SUPPLY, "exceed sale alloc");
    ...
    function publicMint(uint256 tokenQuantity) external payable onlySender nonReentrant {
        ...
        require(totalSupply() + tokenQuantity <= TOTAL_SUPPLY, "exceed sale alloc");
    ...
    function claimRefund() external nonReentrant() {
        ...
        Address.sendValue(payable(msg.sender), _claimableAmount);
    }
