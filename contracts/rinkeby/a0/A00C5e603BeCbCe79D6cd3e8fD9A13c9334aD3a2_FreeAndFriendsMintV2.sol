...
contract FreeAndFriendsMintV2 is Ownable, Pausable {
    ...
    mapping(address => uint16) public originaAddressNumberMinted;
    ...
    function friendsAndFreeETHWalkersMiamiMint(uint8 numberOfTokens, address originAddressRedeemed) external whenNotPaused {
        ...
        require(originaAddressNumberMinted[originAddressRedeemed] <= ((ewalksMiami.balanceOf(_msgSender()) * 4) + (ewalksMintPass.balanceOf(_msgSender()) * 12)));
        ...
        originaAddressNumberMinted[originAddressRedeemed] += numberOfTokens;
    }
