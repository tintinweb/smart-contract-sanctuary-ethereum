...
interface IMint {
  function mintAddresses(address) external view returns (bool);
}
...
contract GAT_Royalty is Ownable, ReentrancyGuard{
  ...
  modifier withdrawCompliance(string calldata _salt) {
    ...
    require(mintContractaddress.mintAddresses(msg.sender) , "Non Mint address addresses cannot withdraw");    
    _;
  }
