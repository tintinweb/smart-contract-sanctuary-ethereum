...
contract PUTANGINANGYANAYAW  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI           = "ipfs://QmXXrB49TXRsBuR1DdWqVrnNSvazPyEW3hg1KEjTJpfgim/";
    uint   public price             = 0.005 ether;
    uint   public maxPerTransaction = 3;
    uint   public maxFreePerWallet  = 1;
    uint   public totalFree         = 6;
    uint   public maxSupply         = 12;
    bool   public mintEnabled       = false;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("POTAENAGAGUNA", "P0T3AN4"){}
    ...
    function NGMITESTLabDevMint(uint256 amt) external onlyOwner
    {
