...
contract DealerStaking is ERC721Holder, Ownable {
    ...
    constructor() {
        dealerContractAddress = _getDealerContractAddress();
        dealers = IPPADealers(dealerContractAddress);
    }

    function _getDealerContractAddress()
        internal
        view
        returns (address)
    {
        ...
        assembly {
            ...
            case 1 {
                // mainnet
                addr := 0x99120d128a5f7cb81c318a24fa1f60f66d9777d7
            }
            case 4 {
                // rinkeby
                addr := 0x7551dc208fdb308c52a27cae25e9ba8e76ef2733
            }
        }
        return addr;
    }
