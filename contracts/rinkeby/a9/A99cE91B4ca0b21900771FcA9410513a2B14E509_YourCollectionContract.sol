...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x63543b7D4Ed88d90e956324D079b6c621ce53c69];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmewjT1PjmtXg7aknk2vtps21TQwwCSZRG8eg2rGv4A6m7/";
...
// File: contracts/YourCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YourCollectionContract is RamppERC721A {
    constructor() RamppERC721A("Your Collection", "YC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/V2DNBZ9mIIfIA9Osqduj/contract-metadata";
    }
}
