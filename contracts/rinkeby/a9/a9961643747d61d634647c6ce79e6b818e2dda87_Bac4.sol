...
contract Bac4 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Broke Artists NFT Stamps", "bac4") {
    setHiddenMetadataUri("ipfs://QmQ187X6JPEqbeJwU7Xy2gRWFr4BX9wgPbPPeviogHQBWs/hidden.json");
  }
