...
contract NFTickets is ERC1155, Ownable {
...
// What else does this smart contract need to do, 
// it needs to have a price set for each of the nfts, by id, 
// the id, will be the id of the ticket, the id of the event will be stored in db, and each ticket
// type, GA, VIP will have a unique id associated,