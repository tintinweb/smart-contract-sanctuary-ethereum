...
contract CriNFT is ERC721A, Ownable { 

  using Strings for uint256; 

  bytes32 public merkleRoot; // Add MerkleRoot
  ...
  uint256 public publicMaxSupply = 7277; 
  uint256 public reservedMaxSupply = 500; 
  ...
  constructor() ERC721A("PLK", "CriNFT") { // Replace NAME and SYMBOL 
        setHiddenMetadataUri("ipfs://__CID__/hidden.json"); // Replace CID
        ownerMint(10); // Replace uint - Automatic Free Mint for the owner and team 
    } 
