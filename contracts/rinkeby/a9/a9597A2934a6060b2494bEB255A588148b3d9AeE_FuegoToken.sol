...
contract FuegoToken is ERC721A, Ownable {
  ...
  constructor() ERC721A("FuegoToken", "FUTOKEN"){
  }

  modifier callerIsUser() {
    require(tx.origin == msg.sender, "FUTOKEN; Cannot be called by another contract");
    _;
  }
  ...
  function mint() external payable callerIsUser {
    require(!isPaused, "FUTOKEN; Not active yet");
    require(totalSupply() + 1 <= MAX_SUPPLY, "FUTOKEN; Reached Max Supply");
    require(speakerTokensMinted[msg.sender] == 0, "FUTOKEN; Already minted");
