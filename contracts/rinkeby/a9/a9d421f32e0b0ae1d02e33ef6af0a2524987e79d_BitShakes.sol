...
contract BitShakes is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            require(ownerTokenCount + _mintAmount <= Wlperwallet, "max NFT per WL wallet exceeded");
        } else {
