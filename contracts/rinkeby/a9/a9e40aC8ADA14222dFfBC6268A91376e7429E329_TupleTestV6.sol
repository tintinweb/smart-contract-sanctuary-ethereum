...
contract TupleTestV6 {
    ...
    struct NestNestTuple {
        address tupleAddress;
        string tupleString;
        uint256 tupleUint256;
        NestTuple subNestTuple;
    }

    NestNestTuple public varNestNestTuple;
    ...
    function writeNestNestTuple(NestNestTuple memory _varNestNestTuple) public {
        varNestNestTuple = _varNestNestTuple;
    }

    function readNestNestTupleString() public view returns (string memory) {
        return varNestNestTuple.tupleString;
    }
