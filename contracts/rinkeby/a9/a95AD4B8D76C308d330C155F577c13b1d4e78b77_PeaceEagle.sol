    ...
    PaymentSplitter 
{
    ...
    uint256 _price1 = 70000000000000000; // 0.01 ETH
    uint256 _price2 = 75000000000000000; // 0.01 ETH

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [100]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0xBb6A97fCCc340A701cfaC6f2653215159718cC5C
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("PeaceEagle_Test", "PET")
