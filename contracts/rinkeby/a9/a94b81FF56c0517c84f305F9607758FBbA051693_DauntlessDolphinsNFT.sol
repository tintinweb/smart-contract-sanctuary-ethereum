...
contract DauntlessDolphinsNFT is ERC721, ERC721Enumerable, Ownable{
    ...
    uint256 public state = 0; //state of the co

    bool public normalMint; // whether we can normalMint

    mapping(address => mapping(uint256 => uint256)) public alreadyMinted; //nnumber of items minted by address
    ...
    function mint(uint256 qty) external payable{
        ...
        require(alreadyMinted[msg.sender][dropNumber] + qty <= MAX_MINT_AMMOUNT, "NFT Mint limit reached/exceeded");
