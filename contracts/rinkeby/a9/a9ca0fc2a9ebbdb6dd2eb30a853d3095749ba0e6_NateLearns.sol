...
// File: contracts/NateLearning.sol
...
/**
 * @title Nate Learning Smart Contracts
 * @author Nate Broughton - @nate_on_chain
 * @notice This contract is Nate learning how to make & deploy smart contracts - no allowlist
 */

 contract NateLearns is ERC721A, Ownable {
    ...
    /**
     * @notice Allow for minting of up to mintsAllowedPerAddress tokens
     */
    function mint(
        uint256 numTokens
    ) external payable {
