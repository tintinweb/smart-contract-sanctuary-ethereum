...
contract GenBeta is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;

    mapping (uint256 => string) private revealURI;
    string public unrevealURI = "https://gateway.pinata.cloud/ipfs/QmTQ6zLNEbqv4nsZqrsH6eb3XJKq24z65gjC3Lnf6jNxEJ";

    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 10000000000000000;
    ...
    constructor() ERC721("GenBeta NFT", "$GBS") {
    }
    ...
    function freeMint(uint256 _cnt) public payable onlyOwner {
        require(_cnt > 0);
        require(!pauseMint, "Paused!");
        require(tokenMinted < MAX_NFT_SUPPLY, "Sale has already ended");
