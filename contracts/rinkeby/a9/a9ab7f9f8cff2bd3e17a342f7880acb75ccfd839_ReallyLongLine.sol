...
contract ReallyLongLine is Ownable, ERC721 {
    ...
    uint256 public MINT_PRICE = 50000000000000000; // 0.05 ETH
    ...
    constructor() ERC721("ReallyLongLine", "LINESEGMENT") {}
    ...
    function safeMint(string memory _text, uint numberOfTokensMax5) public payable {
        ...
        require((totalSupply() + numberOfTokensMax5) < MAX_SUPPLY, "Exceeds max supply");
        ...
        for (uint i = 0; i < numberOfTokensMax5; i++) {
            ...
            _textMessages[_tokenIdCounter.current()] = _text;
