...
contract Aliens  is ERC721Enumerable, Ownable {
    ...
    bool public alien;
    IERC20 dmd = IERC20(address(0x0000000000000000000000000000000000000000));
    string baseURI;
    ...
    address private AlienAddress = 0x731897c08e6D7334f9b6826975ea206Ebc34Ad63;
 ...
 function mintDaddy(uint256 _amount) public onlyOwner {
    ...
    function mint(uint256 _amount) public payable {
        ...
        if (alien == true)
            require(
                dmd.balanceOf(msg.sender) > 1000000000000000000000 wei,
                "to buy NFT you need 1000 DMD in your address"
            );
        require(!paused);
        require(
