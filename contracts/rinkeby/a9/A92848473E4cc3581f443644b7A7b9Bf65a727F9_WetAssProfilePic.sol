...
/// @title WetAssProfilePic
/// @author @0xNeon and Nullpntr
/// @notice Easily create your own NFT!
contract WetAssProfilePic is ERC721URIStorage, Ownable {
    ...
    constructor(uint256 _price, string memory _base_URI) ERC721("WetAssProfilePic", "WAPFP") {
        price = _price;
        baseURI = _base_URI;
    }
