...
//         require(
//             keccak256(abi.encode(secrets[_hash])) == keccak256(abi.encode("")),
//             "Already revealed"
//         );

//         console.log(secrets[_hash]);
//         console.log("");
//         console.logBytes(abi.encode(secrets[_hash]));
//         console.logBytes(abi.encode(""));
//         console.logBytes32(keccak256(abi.encode(secrets[_hash])));
