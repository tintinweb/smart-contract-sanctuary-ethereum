...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4fb8b7C9a19E6e5DA054A9ea20308C90531652Ff];
...
// File: contracts/SecretSocietyOfDegensEntryContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract SecretSocietyOfDegensEntryContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Secret Society Of Degens Entry";
    string public symbol = "SSOD";
