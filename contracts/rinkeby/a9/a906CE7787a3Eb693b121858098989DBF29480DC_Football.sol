...
contract Football is IERC2981Upgradeable, ERC165StorageUpgradeable, OwnableUpgradeable, IERC1155MetadataURIUpgradeable, ERC1155Upgradeable
    ...
    */
    function initialize(string memory _name, string memory _symbol, string memory _tokenURIPrefix, address _royalty) public initializer {
