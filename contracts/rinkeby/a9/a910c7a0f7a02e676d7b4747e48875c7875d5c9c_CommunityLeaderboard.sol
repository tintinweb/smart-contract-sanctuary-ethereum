...
contract CommunityLeaderboard is Ownable, Pausable {
  ...
  event projectOwnerAdd(uint256 _projectId, address indexed _newOwner, bytes32 projectHashId);
  ...
  function addOwnerToProject(uint256 _projectId, address _newOwner, bytes32 projectHashId)
    public
    whenNotPaused
  {
    require(
    ...
    emit projectOwnerAdd(_projectId, _newOwner, projectHashId);
  }
