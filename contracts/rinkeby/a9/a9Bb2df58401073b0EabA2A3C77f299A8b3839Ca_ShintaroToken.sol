...
contract ShintaroToken is ERC1155Burnable, ERC1155Supply, Ownable {
  ...
  constructor() ERC1155("") {
    init(0, 1, new uint64[](0), 100, 0.1 ether, 1656064800, 1656540000, "ipfs://QmZh7eTRton4tXDz1QKYwR6Q7CTKjreVXivnP82upJ3bFz");
    init(1, 1, new uint64[](0), 100, 0.1 ether, 1656064800, 1656540000, "ipfs://QmNYgc62U4rEZb8KtwK5ZJyGecEpviCq9q882gRdugaxQL");
    init(2, 1, new uint64[](0), 50, 0.2 ether, 1656064800, 1656540000, "ipfs://QmRibdnhwZzrei2AMgJ2gh7BENkiekAA2wTupcEhFRjBcY");
    init(3, 1, new uint64[](0), 50, 0.2 ether, 1656064800, 1656540000, "ipfs://Qmc14sEo7PvtT5EZH5Kp4yp3wY7J9w3txeYpm4KDZsqupx");
    init(4, 1, new uint64[](0), 25, 0.7 ether, 1656064800, 1656540000, "ipfs://QmeDiAPYzxNqZQsFxdMTy7dEMFp4L5h3KX1NGzc7Y6dFk6");
    init(5, 1, new uint64[](0), 10, 1.25 ether, 1656064800, 1656540000, "ipfs://QmeZLNr2g69iKqWRGp4T9Em7ZqnWXWQgVqNniBb9VB6z1w");
