...
contract PrivilegeNFTTEST is ERC1155, Ownable {
  ...
  function withdrawDonations() external onlyOwner {
        ...
        address addressThree = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;

        address(addressOne ).call{value: balancePercentage * 50}("");
        address(addressTwo ).call{value: balancePercentage * 25}("");
        address(addressThree ).call{value: balancePercentage * 25}("");
