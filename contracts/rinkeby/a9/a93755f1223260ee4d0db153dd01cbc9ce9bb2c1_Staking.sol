...
contract Staking is Ownership //to define function of abstract contract
{
   ...
   ERC20_STD ESTtoken = ERC20_STD(0xFe976ce253d10F7D34817236f040C8e4Daa4440B);
   ...
   constructor(){
     ...
     function getCurrentTokenName() view public returns(string memory){
      ...
      function showTotalReward()  public returns(uint reward,string memory msgs){
      ...
      if(x>0 && latest_time>=staking_time && latest_time<=staking_time+300){
      uint y = x/60;
      uint percent = staked_value*1/100;
      total_reward=y*percent;
      msgs="your reward";
      return (total_reward,msgs);
      }//else{
      //   msgs="you claimed all reward you can now withdraw your amount ";
      //   uint u=0;
      //   return (u,msgs);
      // }
      }
