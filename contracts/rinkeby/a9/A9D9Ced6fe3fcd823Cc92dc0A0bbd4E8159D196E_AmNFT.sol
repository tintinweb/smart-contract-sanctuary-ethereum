...
contract AmNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint; //mam pocit ze treba
...
// pridat premennu na dlzku passu (90 days)
    uint passDuration = 90 days;
     ...
     */
    function mint() external whenNotPaused payable noHaxxor {
    ...
    function renewPass(uint _tokenId) public payable noHaxxor {
        ...
        if (block.timestamp > _currentExpiryTime) {
            expiryTime[_tokenId] = block.timestamp + passDuration;
        } else {
    ...
    function deleteWhitelistedUsers() public onlyOwner {
