    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        setNameToRealmId(0, "A");
        setNameToRealmId(1, "B");
        setNameToRealmId(2, "C");
        setNameToRealmId(3, "D");
        setNameToRealmId(4, "E");
        ...
        setImageToRealmId(
            1,
            "https://gateway.pinata.cloud/ipfs/QmTArHWTbjNjcbeuewQggfRPN2PV8jrW6NQiBW4keAcb2p/2.json"
        );
        setImageToRealmId(
            2,
            "https://gateway.pinata.cloud/ipfs/QmTArHWTbjNjcbeuewQggfRPN2PV8jrW6NQiBW4keAcb2p/3.json"
        );
        setImageToRealmId(
            3,
            "https://gateway.pinata.cloud/ipfs/QmTArHWTbjNjcbeuewQggfRPN2PV8jrW6NQiBW4keAcb2p/4.json"
        );
        setImageToRealmId(
            4,
            "https://gateway.pinata.cloud/ipfs/QmTArHWTbjNjcbeuewQggfRPN2PV8jrW6NQiBW4keAcb2p/5.json"
        );
    ...
    modifier mintCompliance(uint256 _mintAmount, address _user) {
        ...
        if (presale) {
            require(
                addressMintedBalance[_user] + _mintAmount <=
                    catsLimitPerAddress,
                    ...
                    Base64Upgradeable.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                "Nekotopia are great",
                                '", "image": "',
                                imageToRealmId[currentCat.realmId],
                                '"}'
                            )
                        )
                    )
    ...
    function mint()
        ...
        payable
        nonReentrant
        mintCompliance(1, _msgSender())
        isPublicSale
    {
        require(price * 1 >= msg.value, "Insufficient funds to mint !!");
