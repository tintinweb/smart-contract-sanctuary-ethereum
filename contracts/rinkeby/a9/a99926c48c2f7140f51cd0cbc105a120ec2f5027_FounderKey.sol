...
contract FounderKey is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "https://storage.googleapis.com/fractal-launchpad-public-assets/metaops-assets/founders/common.mp4";
    string public baseExtension = "";
     bool public paused = true;   
    
    constructor() ERC721A("FounderKey", "FK", MAX_MINTS, MAX_SUPPLY) {  
    }
