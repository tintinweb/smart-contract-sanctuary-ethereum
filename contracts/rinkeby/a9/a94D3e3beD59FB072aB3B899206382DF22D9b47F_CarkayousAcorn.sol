...
contract CarkayousAcorn is LushLinkCronosUnlimitedDrop {
    ...
    constructor(address _ownerAddress) LushLinkCronosUnlimitedDrop(
        "Carkayous Acorn",
        "ACORN",
        "https://www.develop-sr3snxi-telwwy7z25xi4.us-4.platformsh.site/contract/carkayous_acorn/nft",
        6,
        _ownerAddress
    ){
//        setMvpListCost(425 ether);
        setMemberCost(1 ether);
        setRegularCost(1 ether);
//        setDefaultRoyalty(0xfCafA1ED9daF2b620D3380acd59123c366944Ff4, 750);
//        setMvpListStartTime(1655154000);
    }
    ...
    function setTokenUri(uint _token, string memory _uri) external onlyOwner {
        require(_exists(_token), "nonexistent token");
        overrideIds[_token] = _uri;
    }

    function deleteTokenUri(uint _token) external onlyOwner {
        require(_exists(_token), "nonexistent token");
...
contract LushLinkCronosUnlimitedDrop is Pausable, ERC721Enumerable, Ownable {
