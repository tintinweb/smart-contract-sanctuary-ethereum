    ...
    OwnableUpgradeable
{
    ...
    function initialize(
        ...
        publicMintCount = 0;
        currentPrice = 1.0 ether;
        publicMintCeiling = 20000;
    }
    ...
    function claimOne(
        ...
        uint256 newRockId = totalSupply() + 1;
    ...
    function ownerOverwriteTokenOrigin(
        uint256 meteoroidTokenId,
        address originContractAddress,
        string memory originTokenId
    ) public onlyOwner {
        originClaimed[originContractAddress][originTokenId] = true;
        originByRockId[meteoroidTokenId] = OriginTokenInfo(
            originContractAddress,
            originTokenId
        );
    }
