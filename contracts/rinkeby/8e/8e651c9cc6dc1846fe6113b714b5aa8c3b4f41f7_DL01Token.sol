...
contract DL01Token     is  ERC721Enumerable, ReentrancyGuard
{
    ...
    mapping(string => bool)         public registeredDoolnyNames;
    ...
    //=============================================================================
    //=============================================================================
    function    getNftNames(uint256[] memory tokenIds) external view returns(string[] memory)
    {
    ...
    {
        string memory name = string(abi.encode("Doolny #", tokenId.toString()));

        registeredDoolnyNames[name] = true;
        doolnyNames[tokenId]        = name;

        emit onDoolnyName(name);
