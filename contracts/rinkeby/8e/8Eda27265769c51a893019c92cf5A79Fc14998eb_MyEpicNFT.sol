...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Inosuke", "Inoshu", "Imosh", "Imomoshuke", "Imo", "Inos"];
  string[] secondWords = ["Zenitsu", "Zen", "Zenit", "Seni", "Zennitsu", "Agatsuma"];
  string[] thirdWords = ["Tanjiro", "Tantaro", "Tansaburo", "Tantan", "Tan", "Tanj"];
