...
// WIP
contract MyFactory is IFactory, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using StringsUpgradeable for string;
    using SafeMathUpgradeable for uint256;

    address public proxyRegistryAddress;
    address public nftAddress;
    string constant internal baseMetadataURI = "https://kirin178hsu.wixsite.com/kilos-garden/_functions/";
    ...
    */
    ...
    function test0(uint256 op) public view returns(uint256) {
