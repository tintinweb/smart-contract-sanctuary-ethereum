    ...
    Constants
{
    ...
    function setRoyalties(uint256 _tokenId, address _royaltiesRecipientAddress)
        internal
    {
        _setTokenRoyalty(_tokenId, _royaltiesRecipientAddress, ROYALITY_BASIS_POINTS);
    }
    ...
    function updateCreatorPaymentAddresses(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            (address previousAddress,) = royaltyInfo(
                tokenId,
                0
            );
            require(
            ...
            _setTokenRoyalty(tokenId, newAddress, ROYALITY_BASIS_POINTS);
    ...
    /**
     * @notice Allows the wethio admin to update creator address and royality
     */
    ...
    ERC2981Upgradeable
{
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC2981Upgradeable, ERC165StorageUpgradeable, IERC165Upgradeable) returns (bool) {
        return
