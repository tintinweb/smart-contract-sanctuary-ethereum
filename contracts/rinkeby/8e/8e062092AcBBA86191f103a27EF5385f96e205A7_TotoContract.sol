...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1ccA21Af2b3d5Ec8aE071F20CD9260B3399e08d1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmY2tdfMHTSuPcqruVV4CVxeY3JLKxNVfJkxt7YZFDof2r/";
...
// File: contracts/TotoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TotoContract is RamppERC721A {
    constructor() RamppERC721A("TOTO", "TOTO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/70l4t4yuDVlTi9phwHj8/contract-metadata";
    }
}
