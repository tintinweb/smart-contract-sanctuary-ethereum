...
abstract contract FixinERC721Spender {
    ...
    function _transferERC721AssetFrom(
        ...
        require(token != address(this), "_transferERC721/CANNOT_SELF");
...
abstract contract NFTOrders is FixinEIP712, FixinTokenSpender {
    ...
    function _payEthFees(
        ...
        if (ethSpent > ethAvailable) {
            revert("_payEthFees/OVERSPENT_ETH");
        }
    }
...
abstract contract FixinTokenSpender {
    ...
    function _transferERC20Tokens(
        ...
        internal
    {
        require(address(token) != address(this), "_transferERC20/CANNOT_SELF");
