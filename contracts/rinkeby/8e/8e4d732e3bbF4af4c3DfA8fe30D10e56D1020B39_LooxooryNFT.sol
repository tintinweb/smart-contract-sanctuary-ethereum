...
contract LooxooryNFT is Ownable, EIP712, ERC721URIStorage {
    ...
    mapping(uint256 => NFTVoucher) public nftVouchers;

    constructor() ERC721("LooxooryNFT", "LNFT") EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION) {
    }
        ...
        returns (uint256)
    {
        ...
        metadataURIs[voucher.tokenId] = voucher.uri;
