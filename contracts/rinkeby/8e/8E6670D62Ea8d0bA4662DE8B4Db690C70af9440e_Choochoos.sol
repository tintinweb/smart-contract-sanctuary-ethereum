...
contract Choochoos is ERC721Royalty, Ownable, ReentrancyGuard {
  ...
  mapping(address => MintCount) public mintTracker;
  ...
  function preMint(uint256 _numberOfTokens) external nonReentrant {
    ...
    require(mintTracker[msg.sender].premint + _numberOfTokens <= presaleMaxMint, "CCNFT/pm-account-max-mint");
    ...
    mintTracker[msg.sender].premint += _numberOfTokens;
  ...
  function mintNFT(uint256 _numberOfTokens) external nonReentrant {
    ...
    require(mintTracker[msg.sender].publicMint + _numberOfTokens <= maxMint, "CCNFT/account-max-mint");
    ...
    mintTracker[msg.sender].publicMint += _numberOfTokens;
