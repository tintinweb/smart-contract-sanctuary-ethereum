...
contract Moonopoly is ERC1155, Ownable, Pausable, ReentrancyGuard
{
    ...
    function _drawRandomCard() internal virtual returns (uint256 ID) 
    {
        uint256 value = _pseudoRandom();
        for (uint256 i = 0; i < 10; i++) 
        {
            if (_canMint(value)) { return value; }
        }

        // If Pseudorandom Card Is Not Valid After 10 Tries, Draw From Top Of The Stack
    ...
    function _pseudoRandom() private returns (uint256) 
    {
