...
contract ContractName is Context, IERC20, IERC20Metadata, Ownable {
    ...
    //ico目标金额
    uint256 public icoTotal = 500 * 10**18; 
    //ico金额
    ...
    //回流钱包
    address backAddress = 0xFf8F48D83aed5b9080747037F3C2D9E6a1487293;
    //营销钱包
    address marketAddress = 0x5Aecf407c7b2B20A881f47D5D8a384D7821590Db;
    ...
    receive() external payable {
        ...
        require(icoAmount > icoAmount + payAmount);

        _mint(msg.sender, amount * icoPrice);
