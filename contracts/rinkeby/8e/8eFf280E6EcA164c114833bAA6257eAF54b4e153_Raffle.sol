...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
     ...
     * the followinf should be true in order to return true.
    ...
    function performUpkeep(
        ...
        uint256 requestId = i_vrfCoodinator.requestRandomWords(
            i_gasLane, // also called the keyHash
            i_subscriptionId,
    ...
    function fulfillRandomWords(
        ...
        // we will use module to select random number from 0 to 9 otherwise the random number could be more than 200 digits as well
