...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase {
    ...
    Character[] public characters; //store all the charaters we create
    ...
    internal override {
        // define create NFT here
        uint256 newId = characters.length;
        uint256 strength = (randomNumber % 100); // 0-99
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            ...
            "ERC721 shovan: transfer caller is not owner or approved"
        );
