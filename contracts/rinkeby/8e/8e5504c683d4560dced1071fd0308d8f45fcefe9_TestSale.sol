...
contract TestSale is Ownable {
    ...
    mapping(uint => uint) dutchDurationPerRound; // Time restant pour arriver au time suivant
    ...
    uint public constant DUTCH_AUCTION_MAX_ROUND = 9; // Round began to 0, there is 10
    ...
    function getTime() public view returns(uint) {
        return getRoundEndingTime() - block.timestamp;
    }
