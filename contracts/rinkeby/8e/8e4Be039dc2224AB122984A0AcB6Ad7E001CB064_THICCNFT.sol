...
contract THICCNFT is ERC721, Ownable {
    ...
    uint64 private _maxSupply = 1500;


    uint8 private _totalNftMinted = 155;
    uint8 private _reserve = 155;
    uint8 private _totalOwnerMinted;
    uint8 private _mintPerWhiteList = 3;
    uint8 private _mintPerUser = 5;
...
ipfs://QmVnb5cfKrt3pSUFmeBw96vQzK71Mx1v7tbGoK34yYDMYN/

*/
// Brian gifs
// ipfs://QmePWm5tw8vPxQWKujAmAAXMy1y6bt4DLpqmK1sedz9kzM/

// default NFT
// ipfs://QmbDQsvVBnGA6FRBvWRhjAkcfH8mUURF1UAcozj6ukzHM7
    ...
    uint256 public mintPriceForUser = 0.069 ether ;
    uint256 public mintPriceForWhiteListUser = 0.0420 ether ;
    ...
    constructor(string memory _initNotRevealedUri) ERC721("THICC NFT", "THICCNFT") {
        _owner = msg.sender;
    ...
    function totalMintNftByUser() external view onlyOwner returns(uint256){
