...
contract Assetha is ERC721B, Ownable, NonblockingReceiver {
    ...
    uint256 public maxPreMints = 200;
    uint256 public tokensPerWhitelistedAddress = 2;

    uint256 private nextToken = 1;
    uint256 private startIndex_ = 1;
    uint256 private endIndex_ = 2000;
    address _layerZeroEndpoint = 0x79a63d6d8BBD5c6dfc774dA79bCcD948EAcb53FA;
