...
library dexUtils {
    ...
    function checkQuoteAndBaseContracts(address makerContract, address takerContract, address[] memory _quoteContracts, address[] memory _baseContracts) internal pure returns(address, address) {
        ...
        if(_checkContractAddress(makerContract, _quoteContracts)) {
            ...
            if(_checkContractAddress(takerContract, _baseContracts)) {
                // All perfect!
            ...
            if(_checkContractAddress(makerContract, _baseContracts)) {
                // All perfect!
