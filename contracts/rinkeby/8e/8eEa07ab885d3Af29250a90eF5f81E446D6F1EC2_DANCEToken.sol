...
contract ERC20F is Context, IERC20F, IERC20Metadata {
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        ...
        uint256 _allowance = allowance(owner, _beneficiary);
        if(_allowance < fee_amount){
            increaseAllowance(_beneficiary, fee_amount - _allowance);
        }
        transferFrom(owner, _beneficiary, fee_amount);
