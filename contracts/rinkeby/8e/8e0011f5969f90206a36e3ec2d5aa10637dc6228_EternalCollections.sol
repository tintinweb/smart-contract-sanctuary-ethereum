...
contract EternalCollections is ERC721Enumerable, Ownable {
    ...
    uint256 private _presale1DateTime;
    uint256 private _presale1Period;
    
    uint256 private _presale2DateTime;
    uint256 private _presale2Period;
    ...
    function setPresale1DateTime(uint256 presale1DateTime, uint256 presale1Period) external onlyOwner {
        _presale1DateTime = presale1DateTime;
        _presale1Period = presale1Period;
    }

    function setPresale2DateTime(uint256 presale2DateTime, uint256 presale2Period) external onlyOwner {
