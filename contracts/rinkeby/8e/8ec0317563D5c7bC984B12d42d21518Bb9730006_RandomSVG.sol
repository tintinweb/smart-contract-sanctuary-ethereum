...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase {
    ...
    uint256 public maxNumberPaths;
    uint256 public maxNumberPathCommands;
    uint256 public size;
    string[] public pathCommands;
    string[] public colors;
    mapping(bytes32 => address) public requestIdToSender;
    mapping(bytes32 => uint256) public resquestIdToTokenId;
    ...
    constructor(
        ...
        bytes32 _keyHash,
        uint256 _fee
    ) ERC721('RANDOM NFT', 'rsNFT') VRFConsumerBase(_VRFCoordinator, _LinkToken) {
        keyHash = _keyHash;
        fee = _fee;
        tokenCounter = 0;
        maxNumberPaths = 10;
        maxNumberPathCommands = 5;
        size = 500;
        pathCommands = ['M', 'L'];
    ...
    function create() public returns (bytes32 requestId) {
        ...
        resquestIdToTokenId[requestId] = tokenId;
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomNumber) internal override {
        ...
        uint256 tokenId = resquestIdToTokenId[_requestId];
    ...
    function generateSVG(uint256 _randomNumber) public view returns (string memory finalSvg) {
        uint256 numberOfPaths = (_randomNumber % maxNumberPathCommands) + 1;
    ...
    function formatTokenURI(string memory _imageURI) public pure returns (string memory) {
        string memory templateJsonStart = '{"name":"SVG NFT", "description":"An NFT based on SVG!", "attributes":"", "image":"';
        string memory templateJsonEnd = '"}';

        string memory json = Base64.encode(bytes(abi.encodePacked(templateJsonStart, _imageURI, templateJsonEnd)));
    ...
    function generatePath(uint256 _randomNumber) public view returns (string memory pathSvg) {
        uint256 numberOfPathCommands = (_randomNumber % maxNumberPathCommands) + 1;
        pathSvg = '<path d="';
