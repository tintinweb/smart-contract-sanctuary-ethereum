    ...
    OwnableUpgradeable 
{
    ...
    */
    function mintAnomura(address _address) external payable nonReentrant onlyBowlContract(_address) 
    {
    ...
    We generate each part of the anomura, and store in the mapping to be view later
    */
    function mintMultiple(address _address, uint256 _quantity) external payable nonReentrant onlyBowlContract(_address) {
...
contract AnomuraData is IAnomuraData, Ownable 
{
    ...
    constructor()
    {
        ...
        headpiecesData.push("Royal Starfish-1");
