...
contract TestD is ERC721A, Ownable {
    string  public baseURI;
    uint256 public supplyD = 500;
    uint256 public maxD = 101;
    uint256 public giveAway = 10;
    uint256 public price   = 0.004 ether;
    mapping(address => bool) private walletCount;


    constructor() ERC721A("TestD", "TestD", 100) {
    }
    ...
    function mint(uint256 count) public payable {
        require(totalSupply() + count < supplyD, "Excedes maxsupply.");
        require(count < maxD, "Exceeds max per transaction.");
