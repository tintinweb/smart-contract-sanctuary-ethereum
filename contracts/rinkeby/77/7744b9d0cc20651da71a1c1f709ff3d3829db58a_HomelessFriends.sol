...
function mint(uint256 quantity) external payable callerIsUser {
    ...
    require(totalSupply() < 3000, "Pre Sale NFTs have been minted.");
    if(numberMinted(msg.sender) == 0) {
    require(quantity > 0,"Mint Quantity should be more than 0");
    require(quantity < 4,"One Address can mint upto 3 NFTs in Pre Sale");
    ...
    require(quantity > 0,"Mint Quantity should be more than 0");
    require(quantity < 3,"One Address can mint upto 3 NFTs in Pre Sale");
    require(totalSupply() + quantity <= collectionSize, "Reached max supply");
    require(msg.value >= PRICE * quantity, "Not enough ETH in your wallet");
    _safeMint(msg.sender, quantity); 
    }
    else if(numberMinted(msg.sender) == 2) {
    require(quantity > 0,"Mint Quantity should be more than 0");
    require(quantity < 2,"One Address can mint upto 3 NFTs in Pre Sale");
    require(totalSupply() + quantity <= collectionSize, "Reached max supply");
    require(msg.value >= PRICE * quantity, "Not enough ETH in your wallet");
    _safeMint(msg.sender, quantity); 
    }
    else{
    require(numberMinted(msg.sender) < 3,"One Address can mint upto 3 NFTs in Pre Sale");
    }
    }
    else{
    ...
    require(quantity > 0,"Mint Quantity should be more than 0");
    require(quantity <= MAX_PER_Transtion,"Max 5 NFTs can be minted in a single Trx");
    require(totalSupply() + quantity <= collectionSize, "Reached max supply");
    require(msg.value >= PRICE * quantity, "Not enough ETH in your wallet");
    _safeMint(msg.sender, quantity);  
    }
