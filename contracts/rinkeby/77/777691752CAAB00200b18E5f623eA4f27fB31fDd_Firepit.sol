...
contract Firepit is IERC721Receiver,Ownable{
    ...
    constructor (
        ...
        metamallowContract = Metamallows(_teste_1Address);
    }
...
contract Metamallows is ERC721A, Ownable {
    ...
    function updateMaxPreSupply(uint256 _newMaxPreSupply) external onlyOwner(){
    ...
    function setWhiteLists(address[] calldata _whitelistedWallets) external onlyOwner(){
        delete whitelisted;
