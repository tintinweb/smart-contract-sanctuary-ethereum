...
contract Spark is ERC721Holder, ReentrancyGuard, Ownable, Pausable {
    using SafeERC20 for IERC20;
	
    /* ========== STATE VARIABLES ========== */

    IERC20 public rewardsToken;
    //IERC721 public stakingToken; //ANY TOKEN
    ...
    constructor(
        //address _stakingToken, //ANY TOKEN
        address _rewardsToken
    ) {
        //stakingToken = IERC721(_stakingToken);  //ANY TOKEN
   ...
   /**
    ...
    function _transfer721(
        ...
        IERC721(tokenContract).safeTransferFrom(_from, _to, _tokId);
    }


    function stake(address tokenContract, uint256[] memory tokenIds) external nonReentrant whenNotPaused {
        ...
        for (uint256 i = 0; i < tokenIds.length; i += 1) {
            ...
            //tokenContract.safeTransferFrom(msg.sender, address(tokenContract), tokenIds[i]);
			_transfer721(tokenContract, msg.sender, address(this), tokenIds[i]);
