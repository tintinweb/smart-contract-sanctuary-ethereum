...
contract DummyDiamondImplementation {
    ...
    function editionsEnabled() external view returns (bool) {}

    function enableEditions() external {}

    function maxMintPerAddressEdition() external view returns (uint256) {}

    function maxMintPerTxEdition() external view returns (uint256) {}

    function maxSupplyEdition() external view returns (uint256) {}
    ...
    function priceEdition() external view returns (uint256) {}
