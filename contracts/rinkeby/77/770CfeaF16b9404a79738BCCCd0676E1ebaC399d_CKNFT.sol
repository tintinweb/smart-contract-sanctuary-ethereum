...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    constructor()
        ERC1155(
            "ipfs://QmT6PXF4eA5ZDQ6eWnVxyr9Jk2Rmbi4NpTEmmYPfyCP7Y6/{id}"
        )
    {
        contractUri = "https://ipfs.io/ipfs/QmTMkQoYfkztRFMKXKQRUVKZTjGuJ7i78o4JLB8SiECTEA?filename=continentOS.json"; // json contract metadata file for OpenSea
