...
contract VotationContract is Ownable {
    ...
    // Creamos un array donde todos los address que ya votaron seran registrados, para evitar que boten dos veces.
    ...
    function voting_start() public onlyOwner {
        ...
        require(
            proposalTime + 30 seconds < block.timestamp,
    ...
    function closeVotation() public onlyOwner {
        require(
            votationStartTime + 30 seconds < block.timestamp,
