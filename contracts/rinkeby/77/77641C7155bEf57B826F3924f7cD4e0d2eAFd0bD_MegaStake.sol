...
contract MegaStake is ERC20, AccessControl, ERC20Capped {
    ...
    uint256 public _Rewardperseconds;

    uint256 public _totalSupply;
    uint256 public _Time;
    uint256 public _Time1;
    ...
    mapping(address => uint256) public _MinReward;
    ...
    function stake(uint256 StakeAmount) public {
        ...
        if (_StakeHolder[msg.sender] == true) {
            ...
            _Time = _StakeTime[msg.sender];
            _Time1 = _StakeTime[msg.sender];
        }
    }

    function NowReward() public {
        require(_StakeHolder[msg.sender] == true, "Not yet staked");
        _StakeTime[msg.sender] = block.timestamp - _StakeTime[msg.sender];
        require(_StakeTime[msg.sender] > 1 seconds, "Minimum Time difference");
        _NowReward[msg.sender] +=
            (_StakeTime[msg.sender] * _StakeBalance[msg.sender] * 3) /
            100 /
            _timeInterval;
    ...
    function ClaimReward() public {
        ...
        require(
            block.timestamp >= _Time + _timeInterval,
    ...
    function MinReward() public {
        _Time1 = block.timestamp - _Time1;

        require(
            _Time1 >= 60 seconds,
            "After 60 seconds you can Unlock the Rewards;"
        );
        _Time1 = 60 seconds;
        _MinReward[msg.sender] +=
            (_Time1 * _StakeBalance[msg.sender] * 3) /
            100 /
            _timeInterval;
        _Reward[msg.sender] += _MinReward[msg.sender];
        _Time1 = block.timestamp;
    }
