...
contract NFL is ERC721Enum, Ownable, ReentrancyGuard{
    using Strings for uint256;
	
    uint256 public SALE_NFT = 2022;
	uint256 public GIVEAWAY_NFT = 200;
	
	uint256 public MAX_MINT_PRESALE = 2022;
	uint256 public MAX_MINT_SALE = 2022;
    ...
    constructor() ERC721P('Non Fungible League', 'NFL') {
	}
