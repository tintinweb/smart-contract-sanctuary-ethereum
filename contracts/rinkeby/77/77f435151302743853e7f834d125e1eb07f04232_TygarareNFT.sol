...
contract TygarareNFT is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transaction = 3; // maximam amount that user can mint
  ...
  uint public status = 2; //0-pause 2-whitelist 3-public

  bytes32 public merkleRoot = 0xcd0db5725384a34aee6aed8a68a29656d49100748090b4a85d3af5b063bdca36;
  uint public whitelistedSpots = 1296;
  uint public reserved = 30;

  constructor() ERC721A("Tygarare NFT","TygarareNFT", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeReveal = "";
  }
 ...
 function mint(uint256 quantity) external payable callerIsUser {
    ...
    require( ( numberMinted(msg.sender) + quantity <= MAX_PER_Address*4 ) , "Quantity exceeds allowed Mints" );
