...
contract GETPROMOCODE is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("GetPromoCode", "GPC") {}
    ...
    function mint(address to, string memory tokenURL) public onlyOwner {
        ...
        pages[totalMinted() + 1] = newPage;
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, tokenURL);
    }

    function setMessage(uint256 _tokenId, string memory _newMessage) public onlyOwner {
