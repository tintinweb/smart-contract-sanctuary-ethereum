...
contract chcNFT is NFTokenMetadata, Ownable {
 
  constructor() {
    nftName = "CyprusHungryCat";
    nftSymbol = "CHC";
  }
 
  function mint(address _to, uint256 _tokenId, string calldata _uri) external onlyOwner {
    require (_tokenId <= 1, "Can't mint more");
    super._mint(_to, _tokenId);
    super._setTokenUri(_tokenId, _uri);
  }
  function burn(uint256 _tokenId, address tokenOwner) external {
    require (tokenOwner == msg.sender, "Not to token Owner");
