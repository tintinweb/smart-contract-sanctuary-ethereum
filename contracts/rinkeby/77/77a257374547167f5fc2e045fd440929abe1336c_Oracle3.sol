...
contract Oracle3 is IERC20, IERC20Metadata, Ownable {
    ...
    string private constant _name = "Oracle3";
    string private constant _symbol = "OT3";
    ...
    function _takeBuyback(address sender, uint256 tBuyback) private {
        _rOwned[address(this)] = _rOwned[address(this)].add(tBuyback);
        emit Transfer(sender, buybackAddress, tBuyback);
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _takeBuyback(sender, tBuyback);
        _takeMarketing(sender, tMarketingFee);
