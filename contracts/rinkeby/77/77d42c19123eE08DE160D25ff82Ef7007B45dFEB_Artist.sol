...
contract Artist is ERC721Upgradeable, IERC2981Upgradeable, AccessManager {
    ...
    /// @notice Returns token URI (metadata URL). e.g. /api/metadata/[contractAddress]/[tokenId]/metadata.json
    ...
    /// @notice Returns contract URI used by Opensea. e.g. /api/metadata/[contractAddress]/storefront
    ...
    function _contractBaseURI() private view returns (string memory) {
        ...
        if (block.chainid == 1) {
            return string.concat('http://3.133.104.167:3000/metadata/', contractAddress, '/');
        } else {
