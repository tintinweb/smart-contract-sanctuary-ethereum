...
contract LoggingMap is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Vigilante", "Vigilante", maxBatchSize_, collectionSize_) {
  ...
  // function setAuctionPrice(uint256 start_price, uint256 end_price, uint256 auction_duration, uint256 drop_freq) external onlyOwner{
  //     AUCTION_START_PRICE = start_price;
  //     AUCTION_END_PRICE = end_price;
  //     AUCTION_PRICE_CURVE_LENGTH = auction_duration;
  //     AUCTION_DROP_INTERVAL = drop_freq;
  // }
