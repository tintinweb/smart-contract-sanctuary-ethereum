...
contract AnimeMetaverse is NFTokenMetadata, Ownable 
{
    ...
    bool public isMerkleActive      = false;
    ...
    // URI Data
    // OmegaM
    string private metaAddress = "https://stagingmint.animemetaverse.ai/metadata/";
    ...
    function mint(uint8 _mintNum, bytes32[] calldata _proof) public payable
    {
        ...
        require(current_minted + _mintNum <= maxNft, "Thousand apologies, not enough of those left in stock.");
