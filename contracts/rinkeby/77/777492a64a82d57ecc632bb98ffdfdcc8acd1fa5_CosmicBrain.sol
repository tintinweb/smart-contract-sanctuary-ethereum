...
contract CosmicBrain is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
...
//   mapping(address => bool) private whitelistedAddresses;
  ...
  constructor() ERC721A("AWE:Cosmic-Brain","COSMIC", MaxMintPerBatch_, TotalCollectionSize_) {
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmXqQFnkE7nN7DbqJZnaBwpaSbav6EVrJJsNW4SaTm3p3v/";
  }
...
//   }
  ...
  function withdrawMoney() external onlyOwner nonReentrant {
    ...
    require(dimitri);
    // (bool tolga, ) = payable(0xd54c21bf077a1a7241eb86188ae6b50dbf8899ec).call{value: address(this).balance * 15 / 100}("");
    // require(tolga);
