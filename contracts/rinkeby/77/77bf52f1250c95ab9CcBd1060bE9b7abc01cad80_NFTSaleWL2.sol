...
contract NFTSaleWL2 is Ownable, ReentrancyGuard, EIP712Whitelisting {
    ...
    function mintNFT(uint256 amount)
        ...
        require(
          addressMintCount[_msgSender()] + 1 <= maxMintPerAddress,
...
contract MCN is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, ERC2981ContractWideRoyalties {
    ...
    function mint(address _recipient) public onlyAdmin {
        require(totalSupply() + 1 <= MAX_NFT, "Purchase would exceed max supply of MCN");
    ...
    function setbaseURIMCN(string memory _baseURIMCN) public onlyOwner {
        baseURIMCN = _baseURIMCN;
    }
