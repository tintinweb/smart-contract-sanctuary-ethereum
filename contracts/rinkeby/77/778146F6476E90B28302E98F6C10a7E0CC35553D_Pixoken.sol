...
contract Pixoken is ERC721r, Ownable{
    ...
    uint public releaseDate = 1682993677; // Tue May 02 2023 02:14:37 GMT+0000
    bool public finalized = false;
    bool public stoppedEarlyMint = false;

    
    constructor(string memory _baseTokenURI,uint256 _totalSupply) ERC721r("Pixoken", "MWHK",_totalSupply)
     {
        ...
        payable
    {
        ...
        require(stoppedEarlyMint == false || block.timestamp <= releaseDate, "Early mint has ended");
        totalMinted += 1;
