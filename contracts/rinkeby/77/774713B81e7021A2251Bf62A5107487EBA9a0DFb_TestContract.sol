...
// @title:       A CONTRACT
// @desc:        ONE CONTRACT TO RULE THEM ALL
// @url:         URL
// @twitter:     URL
// @instagram:   URL
...
contract TestContract is ERC721,Ownable, ReentrancyGuard {
  ...
  mapping(uint256 => uint256) private _ownedTokensIndex;
    ...
    string private baseURI;                     //😀updatable 
    string private unrevealedTokenURI;          //😀updatable     
    uint256 public maxTokensPerWallet = 4;      //😀updatable     
    uint256 public maxMintPerTx = 4;            //😀updatable 
    bool public paused = true;                  //😀updatable 
    bool public allowAll = false;               //😀updatable 

    string public TEST_SYMBOL_PROVENANCE;       //😀updatable        
    uint256 public maxTokens;                   //😀updatable
    uint256 public maxPresaleTokens;            //😀updatable 
    uint256 public tokensReserved ;             //😀updatable
    
    uint256 public presalePrice = 0.07 ether;   //😭Hard Coded
    uint256 public price = 0.07 ether;          //😭Hard Coded

    bool public revealed = false;           //😲can be called only one time    
    bool public presaleActive = true;       //😲can be called only one time
    bool public publicSaleActive = false;   //😲can be called only one time



       
    
    address public whitelistSigner=  0x048E4a9C3eE288E4f3e05917a9531e7DC72b512E; //😀updatable   
    ...
    constructor() ERC721("TestContract", "TEST_SYMBOL"){}  
    ...
    returns (uint256[] memory)
  {
    ...
    */
    ...
    /*
    * set Max tokensReserved
    */
    function setTokensReserved(uint256 _tokensReserved)
        external
        onlyOwner
    {
    ...
    */
    ...
    function setProvenance(string memory _provenance) public onlyOwner {
        TEST_SYMBOL_PROVENANCE = _provenance;
    }
     ...
     * Mints Token
     */
    function mintToken(uint256 _amount, bytes memory signature) public payable {
        ...
        if (presaleActive) {
            ...
            require(
                maxPresaleTokens >= _amount + totalSupply,
