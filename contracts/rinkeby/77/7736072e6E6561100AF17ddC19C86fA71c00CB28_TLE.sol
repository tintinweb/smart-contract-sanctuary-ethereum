...
contract TLE is Ownable, ERC721Enumerable, NativeMetaTransaction, IRootERC721, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public constant MAX_TOKENS = 20; // maximum supply of tokens
