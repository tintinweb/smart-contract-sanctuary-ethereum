...
contract AllureStakeable is ERC20, ERC20Burnable, ReentrancyGuard {
    // Staker info
    struct Staker {
...
contract AllureToken is AllureStakeable, Ownable {
    constructor(string memory _name, string memory _symbol)
        AllureStakeable(_name, _symbol)
    {
