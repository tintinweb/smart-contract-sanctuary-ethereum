    ...
    ReentrancyGuard
{
    ...
    uint256 public publicSaleSupply  = 7666;
    ...
    */
    ...
    function withdraw(uint256 cryptotype) external onlyOwner {
        if(cryptotype == 0) {
            ...
            USDT.safeTransferFrom(address(this), msg.sender, USDT.balanceOf(address(this)));
        }else {
            USDC.safeTransferFrom(address(this), msg.sender, USDC.balanceOf(address(this)));
        }
    }
}
