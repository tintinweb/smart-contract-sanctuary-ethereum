// SPDX-License-Identifier: MIT
  ...
  contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
      ...
      uint256 private constant MAX_TOKENS = 1002;
      uint256 private constant NUM_LAYERS = 6;
      uint256[][NUM_LAYERS] private TIERS;
      string[] private LAYER_NAMES = [unicode"Eyeses", unicode"Nose", unicode"Head", unicode"Faces", unicode"Skins", unicode"Backgrounds"];
        
      uint256 public maxPerAddress = 100;
      uint256 public mintPrice = 0 ether;
      string public baseURI = "";
      bool public isMintingPaused = true;
      ContractData public contractData = ContractData(unicode"FirstTestTwo", unicode"First test collection in indelibles two", "", "", "", 0, "");

      constructor() ERC721A(unicode"FirstTestTwo", unicode"FTCTWO") {
        TIERS[0] = [8,36,83,97,181,255,340];
TIERS[1] = [96,104,148,260,394];
TIERS[2] = [9,11,14,17,18,19,21,23,30,34,39,39,45,54,70,129,143,287];
TIERS[3] = [6,12,15,16,19,22,28,34,35,35,49,54,81,91,118,385];
TIERS[4] = [23,191,786];
TIERS[5] = [7,30,42,59,69,80,81,106,134,188,204];
      }
