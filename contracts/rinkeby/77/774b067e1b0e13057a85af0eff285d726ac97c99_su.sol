...
//metadata
    ...
    constructor() ERC721("m_05291639" , "m_05291639" ) {
...
contract interface_0529_2000_test is ERC721{
    using strings for *;
...
//metadata
    ...
    m_05291639 mainContract = m_05291639(0x945A21267291421cBA13736A7C8D151f3D922b50);
    
    constructor() ERC721("interface_0529_2000" , "interface_0529_2000" ) {
    ...
    function sendMint(string memory _layerInfo,string memory _onlyLayerInfo)public payable{
        ...
        //24519134421 区切り文字
        {
            ...
            // Parts memory part;
            // {
            //     //bytes32 none = keccak256(abi.encodePacked(""));
            //     strings.slice memory none = "".toSlice();
            //     part.part1 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part1)) == none,"1");
            //     require(strings.equals(part.part1.toSlice(),none ),"1");
            //     part.part2 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part2)) == none,"2");
            //     require(strings.equals(part.part2.toSlice(),none ),"2");
            //     part.part3 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part3)) == none,"3");
            //     require(strings.equals(part.part3.toSlice(),none ),"3");
            //     part.part4 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part4)) == none,"4");
            //     require(strings.equals(part.part4.toSlice(),none ),"4");
            //     part.part5 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part5)) == none,"5");
            //     require(strings.equals(part.part5.toSlice(),none ),"5");
            //     part.part6 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part6)) == none,"6");
            //     require(strings.equals(part.part6.toSlice(),none ),"6");
            //     part.part7 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part7)) == none,"7");
            //     require(strings.equals(part.part7.toSlice(),none ),"7");
            //     part.part8 = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            //     //require(keccak256(abi.encodePacked(part.part8)) == none,"8");
            //     require(strings.equals(part.part8.toSlice(),none ),"8");
            //     part.image = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
            // }
            ...
            mintedCount++;
            mainContract._inMint(_msgSender(),parts[8],parts[0],parts[1],parts[2],parts[3],parts[4],parts[5],parts[6],parts[7]) ;
        //mainContract._inMint(_msgSender(),part.image,part.part1,part.part2,part.part3,part.part4,part.part5,part.part6,part.part7,part.part8) ;
        }
    }
    ...
    //         parts[i] = _layerInfo.toSlice().split( delimSTR.toSlice() ).toString();
    //         if(strings.equals( uintTo_StringNumToStringLayerName[i+1][su.str2uint(parts[i])].toSlice() ,"".toSlice() ) && i < 8){
    //             return string(abi.encodePacked("oop",su.uint2str(i),":",uintTo_StringNumToStringLayerName[0+1][su.str2uint(parts[0])]
    //             ,",",uintTo_StringNumToStringLayerName[1+1][su.str2uint(parts[1])]
    //             ,",",uintTo_StringNumToStringLayerName[2+1][su.str2uint(parts[2])]
    //             ,",",uintTo_StringNumToStringLayerName[3+1][su.str2uint(parts[3])]
    //             ,",",uintTo_StringNumToStringLayerName[4+1][su.str2uint(parts[4])]
    //             ,",",uintTo_StringNumToStringLayerName[5+1][su.str2uint(parts[5])]
    //             ,",",uintTo_StringNumToStringLayerName[6+1][su.str2uint(parts[6])]
    //             ,",",uintTo_StringNumToStringLayerName[7+1][su.str2uint(parts[7])] ) );
    //         }
    //     }
    //     }
