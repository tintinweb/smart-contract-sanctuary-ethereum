...
contract MultiTokenMinter is Ownable {
    ...
    function MintFor(uint256 id, uint256 amount, address[] memory accounts) external onlyOwner {
    ...
    function withdrawAllToken(address tokenContract, address to, uint256 amount) external onlyOwner {
