...
// File: contracts/Puffer Coin Copper Airdrop.sol
...
contract ThePufferCoinCopper is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ThePufferCoinCopper", "TPCC") {
    setHiddenMetadataUri("ipfs://QmTNtfAC4vtQfjMpN2QSwb3L61BQ6qsmW3xpMnqEPGcn7h/_metadata.json");
  }
