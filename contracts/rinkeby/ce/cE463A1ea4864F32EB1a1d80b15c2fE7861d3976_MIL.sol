...
contract MIL is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 1000000000000 * (10**16);
    uint256 public maxBuyTransactionAmount = 1000000000000 * (10**16);
    uint256 public swapTokensAtAmount = 50000 * (10**16);

    uint256 public marketingFee = 8;
    address payable  marketingWallet = payable(0x000000000000000000000000000000000000dEaD);
    ...
    constructor() ERC20("Mitary Finance Token", "MIL") {
        ...
        */
        _mint(owner(), 1000000000000 * (10**16));
    }
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MIL: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MIL: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MIL: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MIL: Automated market maker pair is already set to that value");
