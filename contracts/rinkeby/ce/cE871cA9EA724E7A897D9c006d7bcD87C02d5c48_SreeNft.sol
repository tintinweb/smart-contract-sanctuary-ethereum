    ...
    PaymentSplitter 
{
    ...
    // proxyRegistry address dipend on network(rinkybe, ropsten, mainnet)
    address proxyRegistryAddress;
    // total nft number
    uint256 public maxSupply = 100;

    string public baseURI; 
    string public notRevealedUri = "ipfs://QmWsS7a4DxWhFzUuSW6D2sSY5M7Yek7B2wgdAtsxYRxrbq/hidden.json";
    ...
    address[] private _team = [
       0x398caDa86c33460B174cb9AAD9789F24B38E9242 // Admin Account gets 25% of the total revenue
    ];
