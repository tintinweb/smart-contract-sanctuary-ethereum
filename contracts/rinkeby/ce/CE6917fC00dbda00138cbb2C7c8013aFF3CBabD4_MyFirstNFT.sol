...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/Qma7QMMpTS7gQcrzjpYum2k5Yox9d3chVc2jxWSTNtoj8L"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("MCU_0921", "test") payable {
        // 剛開始我們先自己 Mint 一個
