...
// Method: LINEAR
    ...
    */
    ...
    function depositFounderLinearTokensToInvestors(forFounder memory _f, bytes32 _symbol, uint _vestId, uint _tgeDate, uint _tgeFund, uint _vestingStartDate, uint _vestingMonths, investors[] memory _investors, uint _vestingMode) public {
        ...
        for(uint i = 0; i < _investors.length; i++){
            ...
            */
            ...
            for(uint j = 1; j <= _vestingMonths; j++){
                vestingDues[_vestId][_investor]._date[j] = _vestingStartDate + (j * _vestingMode * 1 days);
