...
contract Coco is ERC20Burnable, IERC721Receiver {
    ...
    constructor() ERC20("CocoV2", "COCO") {
        ...
        */
        ...
        multisig = 0x1B3FEA07590E63Ce68Cb21951f3C133a35032473;
    }

    function ownerMint(address _user, uint256 amount) external {
    ...
    function setWaveCatchersAddress(address _address) external {
        require(msg.sender == multisig, "only multisig can call this");

        waveCatchers = _address;
    }
    function setCocoV1Address(address _address) external {
        require(msg.sender == multisig, "only multisig can call this");
        cocov1 = _address;
    }
    ...
    function addLockupPeriods(uint16[] memory inDays, uint256[] memory emissions) external {
        require(msg.sender == multisig, "only multisig can call this");
