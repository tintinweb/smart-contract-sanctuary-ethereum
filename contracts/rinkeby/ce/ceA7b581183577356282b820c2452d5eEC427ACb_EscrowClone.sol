...
contract EscrowClone is ReentrancyGuard, Initializable {
    ...
    function withdrawERC20(uint256 _amount, IERC20 _tokenAddress) public onlyFreeflowOrClient nonReentrant {
        ...
        SafeERC20.safeTransferFrom(IERC20(_tokenAddress), address(this), dev, devShare);
        SafeERC20.safeTransferFrom(IERC20(_tokenAddress), address(this), freeflow, freeflowShare);
