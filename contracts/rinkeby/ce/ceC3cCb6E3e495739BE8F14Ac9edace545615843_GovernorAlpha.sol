...
contract GovernorAlpha {
    ...
    function changeAdmin(address _newAdmin) adminOnly() public { admin = _newAdmin; }

    function changeQuorumPercent(uint _newQuorum) adminOnly() public { quorumPercent = _newQuorum; }

    function changeThresholdPercent(uint _thresholdPercent) adminOnly() public { thresholdPercent = _thresholdPercent; }
    ...
    function _castVote(address voter, uint proposalId, bool support) internal {
        ...
        require(wsd.balanceOf(msg.sender) != 0, "GovernorAlpha::_castVote: voter has no votes");
