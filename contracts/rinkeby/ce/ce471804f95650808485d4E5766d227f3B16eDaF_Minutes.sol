...
contract Minutes is ERC721, Pausable, Ownable, ERC721Burnable, AllowlistSale, ReentrancyGuard {
    ...
    constructor() ERC721("minutes", "60M") {
        // setup allowlist mint
        _addSale(1, SaleConfig(1655913600, 0, 0, 2, 1, 0x6DeB3251ba099E8E4cf705a0e156D41A1d7618f6, false, true, true));

        // setup public mint
        _addSale(0, SaleConfig(1655913600, 0, 0, 0, 1, address(0), true, false, true));
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://api.minutes.degen.beauty";
    }
    ...
    *       equialent of a BigMac, we added this barrier to limit bots
    *       this project is ment to be a fun on-chain experience
    */
    ...
    function _mintMinuteToken(uint256 tokenId) internal {
        ...
        minuteTokens[tokenId] = MinuteToken(time, minuteValue, minuteMap[minuteValue].length);
