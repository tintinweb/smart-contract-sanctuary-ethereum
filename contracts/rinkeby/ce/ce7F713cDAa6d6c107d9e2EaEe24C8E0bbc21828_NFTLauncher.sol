...
contract NFTLauncher is VRFConsumerBase, ChainlinkClient, Ownable {
        ...
        )
    {
        ...
        (, basePaymentMethodAddress, , keep, , , ) = seapadPayments
            ...
            uint256 _paymentMethodID = paymentMethodID;
        return (
    ...
    function purchasePack(
        ...
        require(isValidProject(projectid) == true, "Invalid Project");
                // uint256 _paymentMethod = paymentMethod;
        ...
        doTheStuff(pb.projectID, _paymentMethod, feeAmountRemainingForSeapadFromOriginalPackPrice, remainingTokens, token);
        // (
        //     ,
        //     ,
        //     ,
        ...
        // ) = getProjectPaymentDetails(projectid, paymentMethod);
        // if(!keep) {
        //     swapAndTransferTo(paymentMethodAddress, uniswapV2Router.WETH(), owner(), feeAmountRemainingForSeapadFromOriginalPackPrice);
        // } else {
        //     token.transfer(owner(), feeAmountRemainingForSeapadFromOriginalPackPrice);
        // }

        // if(!isBasePayment) {
        //     swapAndTransferTo(paymentMethodAddress, basePaymentMethodAddress, projectOwner, remainingTokens);
        // } else {
