...
Buy and Sell tax: 5% Buy / 5% Sell tax.
*/
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "SMART 101";
    string private constant _symbol = "S102";
    uint8 private constant _decimals = 9;

    uint16 public tokensBuyFee = 500;
    uint16 public tokensSellFee = 500;
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        maxTxAmount = 5_000_000 * 10**9;
        maxWalletAmount = 5_000_000 * 10**9;
        tradingOpen = true;
