...
contract Test_Collection_by_Marty is IERC721, Ownable, Functional {
     ...
     */
    constructor() {
        _name = "Test Collection by Marty";
        _symbol = "TCBM";
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Test_Collection_by_Marty.onERC721Received.selector;
    }
