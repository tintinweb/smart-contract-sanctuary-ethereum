...
contract EtnMarket is Ownable{
    ...
    function getCost(uint256 _value) public view returns (uint){
        return _value.mul(basePrice.mul(totalSupply).div(1 ether).div(1000).add(basePrice)).div(1 ether);
//        return _value*_basePrice + _value*_basePrice*totalSupply/(1 ether)/1000;
    }
