...
// The Supreme Foodie Club v1.1

contract Foodies is ERC721A, Ownable, FoodieVoucherSigner {  
    ...
    ERC721A ("Foodies", "FOOD", maxBatchSize_, collectionSize_) 
    ...
    function mintPresale(uint256 _amount, FoodieVoucher.Voucher calldata v) public payable {
        ...
        require(claimedVouchers[v.voucherId] + _amount <= 2, "Max 2 During Presale");
        require(_amount <= 2, "Can't Mint More Than 2");
