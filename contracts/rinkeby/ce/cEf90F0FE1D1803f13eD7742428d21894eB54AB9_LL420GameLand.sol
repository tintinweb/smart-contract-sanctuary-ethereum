...
contract LL420GameLand is Ownable, ERC721, Pausable {
    ...
    uint256 public landPrice = 140 * DECIMAL_FACTOR;
    ...
    /**
     * @dev This function allows to batch mint Game land.
    ...
    function _mint(
        ...
        require(_exists(_id), "Already minted");
        require(_verify(_to, _id, _timestamp, _signature), "Not verified");

        ILL420Wallet wallet = ILL420Wallet(walletAddress);
        require(wallet.balance(_msgSender()) >= landPrice, "Not enough balance in game wallet");
        wallet.withdraw(_msgSender(), landPrice);
    ...
    function _verify(
        ...
        bytes32 signedHash = keccak256(abi.encodePacked(_to, keccak256("GameLand"), _id, MINT_AMOUNT, _timestamp));
