...
contract Juratopia is ERC721, IERC2981, Pausable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_PERMINT = 2;
  string public constant COLLECTION_NAME = "JURATOPIA";
  string public constant COLLECTION_SYMBOL = "JTP";
  uint256 public constant PUBLIC_LISTING_PRICE = 0.02 ether;
  uint256 public constant WL_LISTING_PRICE = 0.04 ether;
  uint256 public constant ROYALTY = 500;

  bytes32 public merkleRoot;
  uint256 public periodMaxSupply = 4;
  ...
  constructor(string memory baseURI, bytes32 _merkleRoot) ERC721(COLLECTION_NAME, COLLECTION_SYMBOL) {
    setBaseURI(baseURI);
