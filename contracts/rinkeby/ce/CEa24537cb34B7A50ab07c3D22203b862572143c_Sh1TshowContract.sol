...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address public erc20Payable = 0x8183e905E5818B2E9f8e01ab2AB6477De6001438;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmVcabf2WW9DTVmhq4XPBvUmEWVyp8fXJk8o1ZkYJtLet2/";
...
contract Sh1TshowContract is RamppERC721A {
    constructor() RamppERC721A("SH1TSHOW", "SH1TSHOW"){}
}
