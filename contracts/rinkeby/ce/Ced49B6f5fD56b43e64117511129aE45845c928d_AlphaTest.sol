...
contract AlphaTest is Ownable, ERC721A {
    ...
    constructor() ERC721A("Alpha Test", "ALTE", PUBLIC_MINT_LIMIT, MAX_SUPPLY) {}
    ...
    /** @notice
     * ALLOCATIONS:
     *  - Community Multisig: 30% (Signers: Bitquence, sOwner1, sOwner2, sMark, sDev1, sDev2 / 4 of 5 signatures)
     *  - Owners: 33.6%
     *  - Marketing: 11.3%
     *  - Developpers: 22.6%
     *  - Artist: 2.5%
    ...
    function withdraw() external onlyOwner {
        ...
        (bool sComm,) = address(0x217fAD637779D98966B77435c71982d1cc5E2F86).call{value: balanceDividend * 300}("");
        (bool sOwner1,) = address(0x217fAD637779D98966B77435c71982d1cc5E2F86).call{value: balanceDividend * 168}(""); // done
        (bool sOwner2,) = address(0x217fAD637779D98966B77435c71982d1cc5E2F86).call{value: balanceDividend * 168}("");
        (bool sMark,) = address(0xe8D1FCB2C6C8b4A5c281fC2fBFe8E2fC0fDF8eCb).call{value: balanceDividend * 113}("");
        (bool sDev1,) = address(0xe8D1FCB2C6C8b4A5c281fC2fBFe8E2fC0fDF8eCb).call{value: balanceDividend * 113}(""); // done
        (bool sDev2,) = address(0x96B3BfDa6f2ba9d1BB573C97530E82187267d26F).call{value: balanceDividend * 113}(""); // done
        (bool sArt,) = address(0x96B3BfDa6f2ba9d1BB573C97530E82187267d26F).call{value: balanceDividend * 25}("");
    }
}
