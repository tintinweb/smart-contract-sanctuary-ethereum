...
contract AltRepack is PackDropBase {
    /// @dev Rinkeby Testnet constructor.
    /// See {https://docs.chain.link/docs/vrf-contracts/#rinkeby} for VRF parameters.
    constructor()
        PackDropBase(
            'Alt Mint I',
            5,                                                                  // Max 5 tokens per transaction
            50,                                                                  // Max 50 tokens per address
            0.01 * 10**18,                                                      // 0.01 ETH (subject to updates before the drop)
            ...
            0x6ac470b1Fc9e3228d1cB37E33AFc716be1555574,                         // Alt Vault Proxy deployed on Rinkeby - to be changed on mainnet
