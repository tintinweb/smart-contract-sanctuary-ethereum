...
///@dev Using counters for Token IDs for the Mystery box NFTs.
 ...
 Counters.Counter private _tokenIds;
    ...
    function mintMysteryBox(uint amount) external {
        ...
        for (uint i = 0; i<amount; i++) {
           ...
           randomNumber[i] =
           uint(keccak256(abi.encodePacked(block.difficulty, block.timestamp, i, msg.sender, Users[msg.sender].userRandomness))) % 4;
 ...
 function _burn(uint256 tokenId) internal override(ERC721, ERC721URIStorage) {
    ...
    function withdrawThndr() public onlyOwner {
        thndrAddress.transfer(0x9C724542E87784faB7B6EfaD08E8Bc03e27fBabD, thndrAddress.balanceOf(address(this)));
    }
