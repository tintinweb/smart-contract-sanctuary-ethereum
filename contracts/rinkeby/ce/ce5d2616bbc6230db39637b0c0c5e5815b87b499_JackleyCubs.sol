...
//contact telegram:Jackley Cubs   help 
pragma solidity ^0.8.0;




contract JackleyCubs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mintNft(uint256 tokenQuantity) public payable {
        ...
        require(tokenQuantity <= maxMint, "Can only mint 30 token at a time");
