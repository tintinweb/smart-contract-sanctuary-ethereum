...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new ChapterXNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ChapterXNFTUser1155Token token = ChapterXNFTUser1155Token(address(addr));
...
contract ChapterXNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
