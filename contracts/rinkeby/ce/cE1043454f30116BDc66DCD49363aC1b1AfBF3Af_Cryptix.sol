...
contract Cryptix is ERC721, Ownable {
    ...
    address private mainWallet = 0x868bd39bBaC258f314b40dd0cC14D92489De5D6a;
    address private whitelistedWallet = 0x868bd39bBaC258f314b40dd0cC14D92489De5D6a;
    uint256 public constant NFT_STOCK = 10;
    uint256 public constant NFTS_PER_WALLET = 2;
    ...
    constructor(string memory tokenBaseURI, string memory mysteryURI) ERC721("Cryptix", "CRYPTIX") {
    ...
    function mint(
        ...
        if (msg.sender != whitelistedWallet) {
          require(addressMinted[msg.sender] + tokenQuantity <= NFTS_PER_WALLET, "EXCEEDS YOUR 2 CRYPTIX MAX");
        }
        require(totalSupply + tokenQuantity <= NFT_STOCK, "EXCEEDS SECOND SALE STOCK");
