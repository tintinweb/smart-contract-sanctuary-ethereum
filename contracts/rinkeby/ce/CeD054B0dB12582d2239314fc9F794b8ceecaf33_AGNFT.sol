...
contract AGNFT is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public AGNFT_MAX_SUPPLY = 1000;
    string public extension = ".json";
    uint256 private totalCommon = 504;
    uint256 private totalUncommon = 260;
    uint256 private totalRare = 134;
    uint256 private totalSuperRare = 68;
    uint256 private totalLegendary = 34;
    uint256[504] public commonId;
    uint256[260] private uncommon;
    uint256[134] private rare;
    uint256[68] private superRare;
    uint256[34] private legendary;
    bool[1000] private minted;
        ...
        returns (uint256)
    {
        ...
        require(total + 1 <= AGNFT_MAX_SUPPLY, "Max supply has been reached");
    ...
    function addEvolutionAddress(address _address) external adminOrOwner {
