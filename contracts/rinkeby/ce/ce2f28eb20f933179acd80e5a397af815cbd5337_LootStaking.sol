...
contract LootStaking is Ownable {
    ...
    /*///////////////////////////////////////////////////////////////
                             CONSTANTS
    // //////////////////////////////////////////////////////////////*/
    // ERC20 public constant AGLD = ERC20(0x32353A6C91143bfd6C7d363B546e62a9A2489A20);
    ...
    // TODO: REMOVE RINKEBY TEMPORARY
    ERC20 public constant AGLD = ERC20(0xf02b847FF664072c0241AA8dB32998Bbc51Bd984);
    ERC721 public constant LOOT = ERC721(0x84E3547f63ad6E5A1c4FE82594977525C764F0E8);
    ERC721 public constant MLOOT = ERC721(0xD991EafE6b2D36F786365e0cEB3b6Dbe61097c90);
    ...
    mapping(uint256 => mapping(uint256 => bool)) public stakedLootIdsByEpoch; // stakedLootIdsByEpoch[1][3351] = false
    mapping(uint256 => uint256[]) public epochsByLootId; // epochsByLootId[3351] = [1, 2, 4, 5]
    mapping(uint256 => uint256) public numLootStakedByEpoch; // numLootStakedByEpoch[1] = 500

    mapping(uint256 => mapping(uint256 => bool)) public stakedMLootIdsByEpoch; // stakedMLootIdsByEpoch[1][3351] = false
    mapping(uint256 => uint256[]) public epochsByMLootId; // epochsByMLootId[3351] = [1, 2, 4, 5]
    mapping(uint256 => uint256) public numMLootStakedByEpoch; // numMLootStakedByEpoch[1] = 500
    ...
    /// @param _nftWeights The bag to calculate rewards for.
