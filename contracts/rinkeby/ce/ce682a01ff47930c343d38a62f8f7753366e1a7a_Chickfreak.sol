...
contract Chickfreak is ERC721Enumerable, Ownable {
    ...
    string public baseTokenURI;
     ...
     constructor() ERC721("ChicFreak", "CF") {
         baseTokenURI="ipfs://QmZgypJ6vdN6ePU5LASbP42W68Y3L9qLu2jqNJh2bUF6ow/";
    }
    ...
    function reserveNFTs() public onlyOwner {
       ...
       // require(totalMinted.add(3) < MAX_SUPPLY, "Not enough NFTs left to reserve");
         require(totalMinted+3 < MAX_SUPPLY, "Not enough NFTs left to reserve");
        for (uint i = 0; i < 3; i++) {
            _mintSingleNFT();
        }
    }
   ...
   function getBaseURI() public onlyOwner view   returns (string memory){
    ...
    function mint(uint _count) public payable {
        uint totalMinted = _tokenIds.current();
       // require(totalMinted.add(_count) <= MAX_SUPPLY, "Not enough NFT left!");
       ...
       // require(msg.value >= PRICE.mul(_count), "Not enough ether to purchase NFT.");
               require(msg.value >= PRICE * _count, "Not enough ether to purchase NFT.");
