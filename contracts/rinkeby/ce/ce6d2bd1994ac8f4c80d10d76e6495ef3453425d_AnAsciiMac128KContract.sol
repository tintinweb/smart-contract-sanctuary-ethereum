...
// File: contracts/AnAsciiMac128KContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnAsciiMac128KContract is RamppERC721A {
    constructor() RamppERC721A("An Ascii Mac 128k", "ASCII"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/NGmd7DMDuccKuVEmjkSd/contract-metadata";
    }
}
