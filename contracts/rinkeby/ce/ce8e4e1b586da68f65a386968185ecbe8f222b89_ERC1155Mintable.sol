...
contract ERC1155Mintable is ERC1155Base {
    // mintingChargePerTokens in wei, Will be controlled by owner
    uint256 public mintingChargePerToken;

    // Method to set minting charges per NFT
    function setmintingChargePerToken(uint256 _mintingChargePerToken)
        public
        onlyOwner
    {
    ...
    function lazyMint(
        ...
        payable(to).transfer(price * amount);
    }
}