...
contract BrokeRobber is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    address public royaltyRecipient =
        0x316c0bdE20bb6fCC8a2e16bb5683c21039BB13Fc;

    uint256 private constant TotalCollectionSize_ = 10000; // total number of nfts
    uint256 private constant MaxMintPerBatch_ = 1000; //max mint per transaction
    ...
    constructor(uint96 _royaltyFeesInBips, uint256 _reserved)
        ERC721A(
            "Broke Robber",
            "BKR",
            MaxMintPerBatch_,
        ...
        )
    {
       ...
       _safeMint(msg.sender, _reserved);
    }
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity <= MAX_PER_Transaction, "cannot mint this many at once");
