...
error FundMe__CheapWithdrawFailed();
...
contract FundMe {
    ...
    // https://docs.soliditylang.org/en/develop/style-guide.html#order-of-functions
    // order of functions
    // 5.5.1. Constructor
    // 5.5.2. Receive Function (if exists)
    // 5.5.3. Fallback Function (if exists)
    // 5.5.4. External
    // 5.5.5. Public
    // 5.5.6. Internal
    // 5.5.7. Private
    ...
    // 5.5.2. Receive function
    // /**
    //  * @notice This is the receive function. It is called when ether is sent
    //  * to the contract.
    //  *
    //  * https://solidity.readthedocs.io/en/latest/contracts.html#receive-function
    //  *
    ...
    // // 5.5.3. Fallback function
    // /**
    //  * @notice This is the fallback function. It is called when no other function
    //  * is called.
    //  *
    ...
    function cheaperWithdraw() public payable onlyOwner {
        ...
        (bool callSuccess, ) = i_owner.call{value: address(this).balance}("");
        if (!callSuccess) {
            revert FundMe__CheapWithdrawFailed();
        }
    }
