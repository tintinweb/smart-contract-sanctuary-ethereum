...
// File contracts/IBurnableNFT.sol
...
// File @openzeppelin/contracts-upgradeable/utils/ContextUp[email protected]
...
// File contracts/IMaviaCreator.sol
...
// File contracts/OpenseaDelegate.sol
...
// File contracts/MaviaNFTLand.sol
...
contract MaviaNFTLand is MaviaNFT {
   ...
   * @param _pUri URI string
   */
  function initialize(string memory _pUri) external initializer {
