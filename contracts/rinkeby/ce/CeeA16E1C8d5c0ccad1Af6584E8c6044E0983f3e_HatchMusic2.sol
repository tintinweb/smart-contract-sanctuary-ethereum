...
contract HatchMusic2 is ERC1155, Ownable, ReentrancyGuard {
  ...
  function createTrackInternal(
    ...
    string[][] memory _artistsNames
      ...
      for (uint256 i = 0; i < _trackNames.length; ++i) {
        ...
        emit TracksCreated(track[currentTrackId], currentPackId, _artistsWallets[i]);       
      }
      existingPackId[currentPackId] = true;  
      emit PacksCreated(_packName, currentPackId, _artistsWallets, _artistsNames);
  }
  ...
  function updateTrack(
    ...
    uint256 _cost
      ...
      require(track[id].trackAdminWallet == msg.sender, "Not the admin of this track");
