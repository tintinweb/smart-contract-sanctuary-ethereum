...
contract Inerme is ERC721Enumerable, Ownable {
   ...
   string public notRevealedUri;
    ...
    address public partnerWallet1 = 0x01A0E4172C0450aF8f4D26aF92E02Dd76eCd4c01;   
     address public partnerWallet2 = 0xd21d7783c26EFA1C629D0f302Ec054b3182DD9Bc; 
    address public communityWallet = 0x317142125E033100f343831C8c41593bcA071C70;
    ...
    // }
 constructor(string memory baseURI,string memory _initNotRevealedUri) ERC721("INERME", "INM") {
        setBaseURI(baseURI);
...
function setRootHash(bytes32 updatedRootHash) public onlyOwner {
    ...
    function preSalemint( uint256 quantity) public payable {
        ...
        // require(totalSupply() + quantity <= preSaleSupply , "Quantity is greater than remaining Supply");
...
//SHOULD WE USE SEparate tokenID variable here ??
   function tokenURI(uint256 tokenId)
    public
    view
    virtual // should i use or not 
    override
    returns (string memory)
  {
    require(
