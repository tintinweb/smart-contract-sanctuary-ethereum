 ...
 */
contract NftBillionCollection is Ownable, ERC721Pausable {
    using SafeMath for uint256;
    ...
    constructor(string memory baseURI) ERC721("NftBillionCollection", "NBC") {  
        _setBaseURI(baseURI);
    }
    ...
    * Mints a PACK
    */
    function mintPack(string[] memory tokenURI, uint8 mintCount) public payable saleIsOpen () {
        ...
        // require(msg.value >= PRICE * mintedImg.length, "Low balance");
        ...
        for(uint8 j = 0; j < mintCount; j++) {
            ...
            _mintAnElement(msg.sender, tokenURI[j]);
        }
    }
