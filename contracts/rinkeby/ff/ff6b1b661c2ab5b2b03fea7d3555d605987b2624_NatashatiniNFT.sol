...
contract NatashatiniNFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public  PRICE = 0.18 ether; //0.18 ether presale , 0.23 eth public 
  ...
  constructor() ERC721A("Natashatini NFT","Natashanatini", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/Qma1QXa6GkWRGpYe9PKVpXYSrTbErFPq2pn3AA9veom8Ch";
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmRPDM5vBq5raekngxRKxemkyMkjCMHJCmCMfocx3rgDHn/";
  }
  ...
  function contractURI() public view returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Natashatini NFT", "description": "Collection of 10000 unique Natashatini NFTs", "seller_fee_basis_points": 800, "fee_recipient": "0xAbC1B608783249C79d8471fe2AA1d13c02575a95"}'))));
