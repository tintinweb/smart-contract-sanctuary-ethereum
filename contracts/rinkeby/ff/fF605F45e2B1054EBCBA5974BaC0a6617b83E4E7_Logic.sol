...
contract Logic is Initializable, OwnableUpgradeable {
    ...
    event SetLogic(string indexed _key, uint256 _value);
    ...
    function setLogic(string memory _key, uint256 _value) public {
        logic[_key] = _value;

        emit SetLogic(_key, _value);
    }

    function getLogic(string memory _key) public view returns (uint256) {
        return logic[_key] + number;
    }
}
