...
contract CommitmentCircuit is SchnorrSignature {
	...
	/**
	 * @dev Transfer commitment between users for any amount.
	 ...
	 * @param excessPubKey Recipient's public key.
	 ...
	 * @param amountComm of zkAsset to be deposited.
...
import "../interfaces/IRangeProofMath.sol";

contract RangeProofMath is EllipticCurve, IRangeProofMath {
