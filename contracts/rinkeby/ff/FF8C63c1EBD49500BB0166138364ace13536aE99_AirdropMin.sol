...
contract AirdropMin is ERC721, ERC721Enumerable, Ownable   {
    using Strings for uint256;

    // token
    uint256 public constant MAX_SUPPLY = 8888;   
    uint256 private constant MAX_PER_MINT = 20;
    string private baseURI_ = "ipfs://Qmbpazc1sFQikb8Dy1Qc46n6vJUYgctKoTso18FJeWwGtt/";

    constructor() ERC721("AirdropMin", "AIRDROP")  {}

    /**
        @notice for development only
    */
