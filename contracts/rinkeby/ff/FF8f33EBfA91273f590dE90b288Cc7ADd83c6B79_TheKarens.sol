...
contract TheKarens is ERC721A, Ownable {
  ...
  string private karensUri = "ipfs://lillopippoginocaronzio/";
  string public hiddenMetadataUri;
  
  uint256 public price = 0.04 ether; // 0.04 eth presale price - 0.069 public sale price
  ...
  constructor() ERC721A("TheKarens", "KRN$") {
  ...
  function setkarensUri(string memory _karensUri) public onlyOwner {
    karensUri = _karensUri;
  }
  ...
  // withdraw address
  address t1 = 0xdEdeB801186c27dBA36Ed389Bc7A940797c1cFf0; 
