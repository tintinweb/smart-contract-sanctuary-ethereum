  ...
  Ownable
{
  ...
  function mint() external payable override nonReentrant {
    ...
    require(msg.value == PRICE, "AHeavenInAWildFlower: Invalid value");

    uint256 tokenId = _mintedTokenIdList.length;
    require(tokenId <= TOTAL_SUPPLY, "AHeavenInAWildFlower: Sold out");
  ...
  function setBaseTokenURI(string memory baseTokenURI) external onlyOwner {
    require(!isMetadataFrozen, "AHeavenInAWildFlower: Metadata is frozen");
    _baseTokenURI = baseTokenURI;
  }
