...
contract LiquidPool is Initializable, UUPSUpgradeable, ERC20Upgradeable, PriceResolver, BudgetApprovalExecutee {
        ...
        public initializer
    {
        ...
        __PriceResolver_init(feedRegistry, baseCurrency);
...
contract PriceResolver is Initializable {
    ...
    function __PriceResolver_init(address feedRegistry, address _baseCurrency) internal onlyInitializing {
        registry = FeedRegistryInterface(feedRegistry);
    ...
    function assetBaseCurrencyPrice(address asset, uint256 amount) public view returns (uint256) {
        ...
        (, int price,,,) = registry.latestRoundData(asset, baseCurrency);
        if (price > 0) {
