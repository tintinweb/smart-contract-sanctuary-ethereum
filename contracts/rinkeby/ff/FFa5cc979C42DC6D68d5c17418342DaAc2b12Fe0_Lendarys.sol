...
contract Lendarys is Ownable, ERC721Enumerable ,ReentrancyGuard{
    ...
    address payable /* not for mainnet immutable */ public teamAddress;

    uint constant public MAX_SUPPLY   = 10000;
    uint constant public TOKEN_PRICE  = 0.01 ether;
    uint constant public WHITELIS_PRICE  = 0.01 ether;
    ...
    constructor(string memory _URI, address payable _teamAddress) ERC721("Lendarys", "LEND") {
        revealURI = _URI;
    ...
    function whitelistMint(uint _nb, bytes32[] calldata _proof) external payable nonReentrant {
        ...
        require(totalSupply() + _nb <= MAX_SUPPLY , "Exceed available supply");
    ...
    //ONLY FOR TESTNET CONTRACTs
    function changeTeamAddress(address payable _teamAddress) external onlyOwner {
        teamAddress = _teamAddress;
    }
