...
contract ValidateMint_PresaleAddresses is IValidateMint_PresaleAddresses_Functions, Ownable {
    ...
    function validate(
        ...
        revert("Target not eligible for pre-sale");
    }
...
interface IValidateMint_PresaleAddresses_Functions is IValidateMint {
    /// Store data for new generation
    /// @param _presale_addresses Array of addresses allowed to participate in pre-sale
