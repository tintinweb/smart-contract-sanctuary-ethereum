 ...
 * allowances. See {IERC20-approve}.
 */
contract EVERMERGE is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "EverMerge";
    string private _symbol = "EMERGE";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000; 
    uint256 public taxForLiquidity = 2;
    uint256 public taxForValidator = 3;
    uint256 public maxTxAmount = 20000000 * 10**_decimals; // 2%
    uint256 public maxWalletAmount = 20000000 * 10**_decimals; // 2%
    address public validatorWallet = 0x17A28dEB25ED44583C2C7321A4f6dc6c8D8297EC;
    // TOKENOMICS END ============================================================>
