...
contract TankPadGrimReaperNFT is ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public NFT_PRICE = 0.1 ether; //per token prise
    ...
    constructor() ERC721("TankPad Grim Reaper NFT ", "TNKG") {}
    ...
    function setGiveaway(address _to, uint256[] memory _tokenIds) external onlyOwner {
    ...
    // Function to airdrop (tokenIds should be below 100)
