...
/// @title LNC collection smart contract
contract LNC2 is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement {
    using Strings for uint256;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "LNC: total supply reached");
        _;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "LNC: tranfer is temporarily unavailable"
            );
        }
