...
contract OPATOKEN is BEP20, Ownable { // CT
    using SafeMath for uint256;
    ...
    constructor() BEP20("TESTTOKEN", "TST") { // 
        marketingWallet = payable(0x9E929e817363AD8386819D60999c84f89342BB78); // 
        devWallet = payable(0xd28cf0a802129EEeC6c0563bcc6Aa508f97993A2); // 
