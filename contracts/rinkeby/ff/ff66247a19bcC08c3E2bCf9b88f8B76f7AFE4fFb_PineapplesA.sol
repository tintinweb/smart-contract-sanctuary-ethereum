...
contract PineapplesA is WizardsERC721A {
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // The number of tokens minted preceeding _startTokenId.
    uint256 internal _preceedingCounter;
    ...
    // Mapping from token ID to preceeding mint flag
    mapping(uint256 => bool) private _preceedingMint;
    ...
    function _totalMinted() internal view returns (uint256) {
        ...
        unchecked {
            return _currentIndex - _startTokenId() + _preceedingCounter;
        }
    }
    ...
    function _exists(uint256 tokenId) internal view returns (bool) {
        ...
        return
            ((_startTokenId() <= tokenId && tokenId < _currentIndex) ||
                _preceedingMint[tokenId]) && !_ownerships[tokenId].burned;
    }
