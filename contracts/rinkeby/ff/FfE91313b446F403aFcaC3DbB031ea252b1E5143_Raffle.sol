// Raffle
// Enter the lottery(sending some amount of ETH)
// Pick a random winner(verifiably random)
// Winner selected automatically every X minutes
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // This is run on a trigger by the Chainlink Keepers
    // In order to be run the raffle we need 3 conditions to be met:
    // 1.Our time interval should have passed
    // 2. The lottery should have at least 1 player, and have some ETH in the balance(of the contract)
    // 3. Our subscription is funded with LINK
    // 4. Lottery should be in an "open" state (not waiting for the random number to come back)
    ...
    function performUpkeep(
        ...
        // Always check for the checkupkeep condition. Otherwise someone external could call this function instead of the keeper
