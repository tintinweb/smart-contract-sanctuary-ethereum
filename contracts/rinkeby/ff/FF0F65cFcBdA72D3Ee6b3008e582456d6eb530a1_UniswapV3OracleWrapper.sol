...
contract UniswapV3OracleWrapper is IUniswapV3OracleWrapper {
    ...
    function getLiquidityAmountB(uint256 tokenId)
    external
    view
    returns (int256 token0Amount, int256 token1Amount)
    {
        ...
        (token0Amount, token1Amount) = getLiquidityAmountFromPositionDataB(
            positionData
        );
    }
    ...
    function getLiquidityAmountFromPositionDataA(
        UinswapV3PositionData memory positionData
    ) public view returns (int256 token0Amount, int256 token1Amount) {
        (token0Amount, token1Amount) = LiquidityAmounts.newGetAmountsForLiquidity(
            TickMath.getSqrtRatioAtTick(positionData.currentTick),
            TickMath.getSqrtRatioAtTick(positionData.tickLower),
            TickMath.getSqrtRatioAtTick(positionData.tickUpper),
            int128(positionData.liquidity)
        );
    }
    function getLiquidityAmountFromPositionDataB(
        UinswapV3PositionData memory positionData
    ) public view returns (int256 token0Amount, int256 token1Amount) {
        (token0Amount, token1Amount) = LiquidityAmounts.newGetAmountsForLiquidity(
            TickMath.getSqrtRatioAtTick(positionData.currentTick),
