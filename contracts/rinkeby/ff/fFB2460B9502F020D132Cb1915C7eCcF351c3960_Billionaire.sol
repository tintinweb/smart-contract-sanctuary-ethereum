...
contract Billionaire is ERC721, PaymentSplitter, Ownable {
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("Halwa", "HAA") PaymentSplitter(_team, _teamShares) {
