...
// uint256 constant BECOME_ADULT_TIME = 1 hours;
...
struct dragon {
    ...
    // birth attributes TODO: ADD birthTime
...
contract Dragon is ERC721, Ownable {
    ...
    // TODO: delete this function ?¿ or make it private _createNewDragon ???
    function createNewDragon(
        ...
        address _owner
    ) public returns (uint256 dragonId) {
    ...
    // TODO: create a _birthNewDragon in  DragonReproduction.sol and make it private (returns a new dragon)
    function birthNewDragon(
        uint256 _motherId,
        uint256 _fatherId,
        address _owner
        ...
        uint256 _motherGeneration;
        bool _motherGender;
        uint8 _fatherColor;
        genes memory _motherGenes;
        genes memory _fatherGenes;
        ...
        (, , , , , , _fatherColor, , _fatherGenes, , , ) = getDragon(_fatherId);
    ...
    // TODO: change return struct instead
...
contract DragonEgg is ERC721, Ownable {
        ...
        returns (uint256 dragonId)
    {
        ...
        uint256 _hachingDate;
        uint256 _motherId;
        uint256 fatherId;
        (, _motherId, fatherId, _hachingDate) = getDragonEggs(_dragonEggId);

        require(
            _hachingDate <= block.timestamp,
            "Dragon's Egg is not ready to hatch"
        );

        uint256 _dragonId = dragonInterface.birthNewDragon(
            _motherId,
            fatherId,
            ownerOf(_dragonEggId)
        );

        // TODO: set this egg as hatched
        return _dragonId;
    }
}