...
contract RRCLONE_X is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 19310;
    ...
    string public CONTRACT_URI = "ipfs://4ZN1ZIMX6RA6Q53EIUMTVJPP13EGQ2DUFN";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("RRCLONE X - X TAKASHI MURAKAMI", "RRCLONEX") { }
