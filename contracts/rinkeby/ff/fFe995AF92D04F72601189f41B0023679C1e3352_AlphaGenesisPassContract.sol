...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xBBC33B3Bf3d0Ca572D45A1605A7e3a18Ad238701];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 1000000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmS9iyctsbcNi5CSc9YGxVXzPFTMmZofGkyQ6yoyi5qqKg/";
...
// File: contracts/AlphaGenesisPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlphaGenesisPassContract is RamppERC721A {
    constructor() RamppERC721A("Alpha Genesis Pass", "ALPHA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/bQ3ebUdkgRH2AVx4vPjJ/contract-metadata";
    }
}
