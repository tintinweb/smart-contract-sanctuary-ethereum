...
contract MarketingVestingMock is KeeperCompatibleInterface, ReentrancyGuard {
  /*==================================================== State Variables ====================================================*/
  VestingMock vesting;
  ...
  function checkUpkeep(
    ...
    for (uint256 i = 0; i < _users.length; i++) {
      ...
      for (uint256 k = 0; k < _indexes.length; k++) {
        uint256 withdrawableAmount = vesting.withdrawableTokens(_users[i],vesting.intToEnum(1),_indexes[k]);
  ...
  function performUpkeep(bytes calldata performData) external override nonReentrant {
    ...
    vesting.withdrawTokensAutomatically(_user, vesting.intToEnum(1), _index);
  }
}
