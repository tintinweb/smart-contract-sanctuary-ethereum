...
contract vSynpulseToken2021 is ERC20, Pausable {
    ...
    address mintTo = 0xb1Fc5675094Bd70859425E418fd247B7dc21472A; // Synpulse Vault (Testnet, to be changed to Synpulse Capital Vault)
    
    constructor(uint256 initialSupply)
        ERC20("Synpulse Token 2021_t3", "vSYN21_t3")
    {
        _mint(0xb1Fc5675094Bd70859425E418fd247B7dc21472A, initialSupply);
        masterContract = 0xb1Fc5675094Bd70859425E418fd247B7dc21472A; // Synpulse Vault (Testnet, to be changed to Synpulse Capital Vault)
        owner.push(0x965067c63dc2E70A905367E7915966079Ea5785B); // Wallet allowed to pause and unpause the contract (Testnet, to be changed to CFO)
