...
contract RoulettePot is Ownable, ReentrancyGuard {
    ...
    function getTokenUsdPrice(address tokenAddress) public view returns (uint256) {
        ...
        (uint256 Res10, uint256 Res11, ) = PLS_Token_Pair.getReserves();
        (uint256 Res20, uint256 Res21, ) = PLS_Token_Pair.getReserves();

        return (Res21 * Res11 * 10**usdtToken.decimals()) / Res20 / Res10;
    }
