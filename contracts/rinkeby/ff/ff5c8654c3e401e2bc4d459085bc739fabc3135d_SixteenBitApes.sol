...
contract SixteenBitApes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTYcLkTnk3c4xkWMMLggqTk13oVzjMECKhvMZqwGvCsN7";
    ...
    constructor(
    ) ERC721A("16 Bit Apes", "APES", 100, maxSupply) {
    }
