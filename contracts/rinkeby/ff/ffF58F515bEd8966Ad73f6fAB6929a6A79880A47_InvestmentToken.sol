 ...
 */
contract InvestmentToken is Ownable, Pausable, ERC20Burnable, ERC20AllowListableProxy, EmergencyWithdrawable {
    constructor(string memory name_, string memory symbol_, uint256 initialSupply_, address allowlistRegistry_) ERC20(name_, symbol_) {
