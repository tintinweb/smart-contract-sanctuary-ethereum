...
contract DinoTester is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable RESERVED_OGREX = 500;
    uint256 public constant MAX_BATCH = 100;
    uint256 public immutable MAX_MINT = 5;
    uint256 public OGREX_PRICE = 0.20 ether;
    ...
    constructor() ERC721A("JPunks: DinoTest", "DinoTest", MAX_BATCH) {
        state = State.Setup;
        baseURIString = "http://api.jurassicpunks.io/ogrex/token/";
        recipientWallet = address(0x63CaD9bF700d9a79b6b1E203F7B93A1896B10920);
