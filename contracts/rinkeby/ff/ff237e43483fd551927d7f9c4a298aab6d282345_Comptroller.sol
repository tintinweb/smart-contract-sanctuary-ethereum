...
contract Comptroller is AbstractComptroller {
     ...
     */
    function mintVerify(address marketToken, address minter, uint actualMintAmount, uint mintTokens) public {
     ...
     */
    function redeemVerify(address marketToken, address redeemer, uint redeemAmount, uint redeemTokens) public {
     ...
     */
    function borrowVerify(address marketToken, address borrower, uint borrowAmount) public {
