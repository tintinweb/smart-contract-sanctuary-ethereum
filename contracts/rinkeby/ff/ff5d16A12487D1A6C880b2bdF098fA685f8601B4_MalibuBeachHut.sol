...
contract MalibuBeachHut is ERC1155Supply, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        require(coin.allowance(_msgSender(), address(this)) >= 0, "You have not allowed this contract to spend your Malibu Coins");

        require(coin.balanceOf(_msgSender()) >= tokenPrice, "You do not own enough Malibu Coins to make this transaction");
