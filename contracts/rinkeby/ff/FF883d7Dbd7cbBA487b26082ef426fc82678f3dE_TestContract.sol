...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5124cE368842afB89De710871E748D900Af3D30a];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNezjEUXrRfYNTQC6wyNx1GcfjBaxZ1BAEuCM5Duu7rrq/";
...
contract TestContract is RamppERC721A {
    constructor() RamppERC721A("Test", "TSTT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sHS8MK9vhDKZfJxJCxB4/contract-metadata";
    }
}
