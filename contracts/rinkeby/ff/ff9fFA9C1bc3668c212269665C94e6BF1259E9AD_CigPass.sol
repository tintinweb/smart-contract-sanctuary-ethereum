 ...
 */
    ...
    function addWhiteList(address addr) public onlyOwner {
        ...
        whiteListAddressList.push(addr);
    }
 ...
 */
    ...
    function mintAirDropBatch(address[] memory addresses, string memory uri) public onlyOwner {
 ...
 */
    function badgeExchangePass(address to, string memory uri) public onlyOwner returns (uint256){
        checkTotalSupply();
 ...
 */
    ...
    function mintWithWhiteList(address to, string memory uri)
        public
        payable
        returns (uint256)
    {
 ...
 */
    ...
    function mintPublic(address to, string memory uri)
        public
        payable
        returns (uint256)
    {
