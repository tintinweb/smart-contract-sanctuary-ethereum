...
import "./CryptonMediaUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new CryptonMediaUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CryptonMediaUser1155Token token = CryptonMediaUser1155Token(address(addr));
...
contract CryptonMediaUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
