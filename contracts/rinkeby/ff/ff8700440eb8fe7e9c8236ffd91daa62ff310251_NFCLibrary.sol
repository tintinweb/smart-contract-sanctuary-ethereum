...
library NFCLibrary {
    ...
    function calculateIERC721Enumerable() public view returns (bytes4) {
        IERC721Enumerable i;
        return i.totalSupply.selector ^ i.tokenOfOwnerByIndex.selector ^ i.tokenByIndex.selector;
    }

    function calculateIERC721() public view returns (bytes4) {
        IERC721 i;
    ...
    function calculateIERC1155() public view returns (bytes4) {
        IERC1155 i;
    ...
    function check721EnumerableCompliancy(address _contract) public view returns (bool) {
        ...
        if (IERC165(_contract).supportsInterface(calculateIERC721Enumerable()) == false) {
            return false;
        }
