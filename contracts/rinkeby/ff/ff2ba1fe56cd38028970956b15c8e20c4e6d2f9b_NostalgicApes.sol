...
contract NostalgicApes is ERC721Enumerable, Whitelist {
    ...
    string private _baseTokenURI = "https://ipfs.io/ipfs/QmchYHgc4p5pw6jDk9pi9E8TQxv8PpZZq4DYBCkV5qkpFS/";
    ...
    constructor() ERC721("Nostalgic Apes", "Nacc") {
        royaltyAddress = payable(0xD911b333c88b31b014ef50a0C59F384a402953d9);
        royalties=3;
        maxApesMint=100;
     }
