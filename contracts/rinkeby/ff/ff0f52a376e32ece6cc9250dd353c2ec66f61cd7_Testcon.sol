...
contract Testcon is Ownable, ERC721A, NonblockingReceiver {
    ...
    bool public     IsSalesStart = false;
 ...
 constructor(
    ...
    uint256 currentIndex_,
    address _layerZeroEndpoint
  ) ERC721A("Testcon", "Testcon", maxBatchSize_, TotalToken_, currentIndex_, _layerZeroEndpoint) {
        MaxMintPerTx = maxBatchSize_;
        MAX_MINT_ETHEREUM = TotalToken_;
        _owner = msg.sender;
        endpoint = ILayerZeroEndpoint(_layerZeroEndpoint);
    }

    function seEndPoint(address _layerZeroEndpoint) external onlyOwner {
        endpoint = ILayerZeroEndpoint(_layerZeroEndpoint);
    } 
