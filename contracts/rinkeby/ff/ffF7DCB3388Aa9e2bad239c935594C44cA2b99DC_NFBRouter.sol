...
contract NFBRouter is Ownable, Pausable, ReentrancyGuard {
    ...
    /**
     * @dev Mints an NFT from the nfbBracket contract and updates the reward pool adding 80% of the funds, as the other 20% are sent to the DAO wallet.
        ...
        nonReentrant
    {
        ...
        uint256 twentyPercentFunds = nftPrice.div(5);
        uint256 rewardPoolFunds = twentyPercentFunds.mul(4);
        ...
        nfbRewardPool.updateRewardPool(rewardPoolFunds);
    ...
    function updateBracket(
        ...
        nfbRewardPool.updateRewardPool(nftUpdatePrice.div(5).mul(4));
