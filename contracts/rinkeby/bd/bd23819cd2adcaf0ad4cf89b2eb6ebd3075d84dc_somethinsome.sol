...
contract somethinsome is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://dsadhxkyjklvdsadasdasdsadas4f";
  uint256  public  maxSupply = 7777;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.00133 ether;
