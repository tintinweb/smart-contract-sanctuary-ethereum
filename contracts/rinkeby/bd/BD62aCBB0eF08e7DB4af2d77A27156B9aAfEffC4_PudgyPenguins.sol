...
contract PudgyPenguins is ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdTracker;

    uint256 public tokenPrice = 3 * 10**16;
    ...
    constructor() ERC721("PudgyPenguins", "PPG") {
        setBaseURI("https://ipfs.io/ipfs/QmWXJXRdExse2YHRY21Wvh4pjRxNRQcWVhcKw4DLVnqGqs/");
        pause(true);
    }
