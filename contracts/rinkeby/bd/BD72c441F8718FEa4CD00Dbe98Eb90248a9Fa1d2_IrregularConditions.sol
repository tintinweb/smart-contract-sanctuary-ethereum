...
contract IrregularConditions is ERC721A, IERC2981, Ownable {
    ...
    // START TEMP FUNCTIONS TO BE DELETED LATER

    function mintAll(uint256 quantity) public {
        _mintToken(quantity, msg.sender, false);
    }
    
    // END TEMP FUNCTIONS TO BE DELETED LATER
