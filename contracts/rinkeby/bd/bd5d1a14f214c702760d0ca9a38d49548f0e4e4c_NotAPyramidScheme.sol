...
contract NotAPyramidScheme is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs://QmRjS2GDvNKAU8aGkhtTz1eXVy3Dmnk3uaNhZ1T1tq2Y5q/';
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool os, ) = payable(owner()).call{value: address(this).balance}('0xFc392BE245fc9C6dd3dDaB66DA3fde7877ACfFcA');
    require(os);
    // =============================================================================
  }
