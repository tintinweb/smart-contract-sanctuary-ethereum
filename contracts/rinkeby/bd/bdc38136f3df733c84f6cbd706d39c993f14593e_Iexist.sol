...
contract Iexist is ERC721, Pausable, Ownable{
    ...
    uint public TotalMaxSupply = 221;
    ...
    function mint() public payable whenNotPaused {
        ...
        require(Token_Counter <= TotalMaxSupply, "reached max supply");
    ...
    function saveInfo(address _wallet, uint _count) private{
        MapMint[_wallet] = 1;
        Token_Counter = Token_Counter + _count;
    }
