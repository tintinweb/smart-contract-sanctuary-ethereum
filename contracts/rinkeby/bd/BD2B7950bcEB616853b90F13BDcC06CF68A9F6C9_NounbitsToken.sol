...
contract NounbitsToken is Ownable, ERC721A, ReentrancyGuard {
    ...
    function setPseudorandomHash() external onlyOwner {
        pseudorandomHash = blockhash(block.number - 1);
    }

    /**
     * @notice Lock the pseudorandom hash.
     * @dev This cannot be reversed and is only callable by the owner when not locked.
     */
...
//    address private constant payoutAddress = 0x0BC3807Ec262cB779b38D65b38158acC3bfedE10; nouns
    address private constant payoutAddress = 0x421D5672e1E4972B76dB632C31D751d7565e17fc;

    function withdraw() public onlyOwner {
        uint256 balance = address(this).balance;

        Address.sendValue(payable(msg.sender), balance / 2);
        Address.sendValue(payable(payoutAddress), balance / 2);
    }
}
