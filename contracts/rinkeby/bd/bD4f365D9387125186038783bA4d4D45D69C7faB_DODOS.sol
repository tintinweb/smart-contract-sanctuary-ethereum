...
contract DODOS is ERC721A, Ownable {
    ...
    //constructor args 
    constructor(string memory baseURI_, uint256 maxBatchSize_, uint256 collectionSize_) ERC721A("DODOS", "DODOS",maxBatchSize_,collectionSize_) {
        baseURI = baseURI_;
