    ...
    ReentrancyGuard
{
    ...
    uint256 public usdPrice = 12500000000;
    ...
    function getEthAmount() public view returns (uint256) {
        ...
        return default_decimal*usdPrice/eth_to_usd/(eth_usd_decimal);
    }
    ...
    */
    ...
    onlyAccounts
    {
        ...
        if(cryptotype == 0){
            ...
            require(usdPrice * _amount <= (coinamount*eth_usd_decimal) ,"Not enough usdt sent");
