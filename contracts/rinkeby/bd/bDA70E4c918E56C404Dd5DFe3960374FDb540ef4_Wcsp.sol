...
contract Wcsp is ReentrancyGuard, Ownable {
    ...
    // Events
    event ChallengeSubmitted(uint256 indexed streamerId, uint256 indexed challengeId);
    event ChallengeContributed(uint256 indexed streamerId, uint256 indexed challengeId, address sender, uint256 value);
    event ChallengePayoutRequested(uint256 indexed streamerId, uint256 indexed challengeId, address sender);
    event ChallengePayoutComplete(
        uint256 indexed streamerId,
    ...
    event ChallengeCancelBySubmitterRequested(uint256 indexed streamerId, uint256 indexed challengeId, address sender);
    ...
    event ChallengeCancelByOwnerRequested(uint256 indexed streamerId, uint256 indexed challengeId, address sender);
    event ChallengeCancelByOwnerIncompleteContributorPayment(uint256 indexed streamerId, uint256 indexed challengeId, uint256 index, uint256 payoutValue, uint256 contributorsFee);
    ...
    function getChallenge(uint256 _streamerId, uint256 _challengeId) public view returns (Challenge memory) {
        string memory key = genChallengeKey(_streamerId, _challengeId);
        return
        Challenge(
            key,
    ...
    // TODO: more tests
    function cancelChallengeByOwner(uint256 _streamerId, uint256 _challengeId, uint256 _cancellationFeePerContrib) external nonReentrant onlyOwner {
        // generate key
        string memory key = genChallengeKey(_streamerId, _challengeId);
