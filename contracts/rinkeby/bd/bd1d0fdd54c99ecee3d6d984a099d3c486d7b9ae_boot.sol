...
contract boot is ERC721A, MerkleDistributor, ReentrancyGuard, AccessControl {
    ...
    uint256 public constant MAX_RESERVE_SUPPLY = 5;
    ...
    constructor(address payable shareholderAddress_) ERC721A("boot", "BOOT") {
