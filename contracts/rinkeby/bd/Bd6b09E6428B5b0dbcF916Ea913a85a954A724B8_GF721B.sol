...
contract GF721B is Delegated, ERC721EnumerableLite, PaymentSplitter {
    ...
    address[] private payees = [
        0x0b741253a8e4FeE7B524133100f276477F5F6161,
        0xCF8e569A97C423952DdFf902375C7C76549A6A90,
        0xaEe7927D78498F32D054227Bb7Ef6a96E30a1D35
    ];

    uint256[] private splits = [325, 325, 350];

    constructor()
        ERC721B("Ghost Frens", "GHOSTFRENS")
        PaymentSplitter(payees, splits)
    {
        setBaseURI(
            "ipfs://__________________________________________________/"
        );
        setNotRevealedURI(
    ...
    function withdraw() external payable onlyOwner {
        uint256 devValue = (address(this).balance * 10) / 100;
        emit Withdraw(devWallet, devValue);
        (bool hs, ) = payable(devWallet).call{
