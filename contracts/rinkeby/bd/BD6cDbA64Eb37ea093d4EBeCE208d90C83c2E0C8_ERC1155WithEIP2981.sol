 ...
 */
contract ERC1155WithEIP2981 is ERC1155Core, EIP2981RoyaltyOverrideCore {

    constructor(string memory _name, string memory _symbol, string memory uri) ERC1155Core(_name, _symbol, uri) {}

    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Core, EIP2981RoyaltyOverrideCore) returns (bool) {
        return ERC1155Core.supportsInterface(interfaceId) || EIP2981RoyaltyOverrideCore.supportsInterface(interfaceId);
    }
    ...
    function setTokenRoyalties(TokenRoyaltyConfig[] calldata royaltyConfigs) external override  {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721Royalty: must have minter role to set token royalties");
    ...
    function setDefaultRoyalty(TokenRoyalty calldata royalty) external override {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC721Royalty: must have admin role to set default royalties");
 ...
 */
contract ERC1155Core is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
