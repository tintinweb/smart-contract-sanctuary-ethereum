...
/**
 * @notice ERC721-compliant contract with added
 *         function for minting new NFTs to addresses.
 */
contract MintableERC721Base is ERC721, ERC721Enumerable, IMintableERC721, AccessControl, Ownable {
   ...
   */
  uint256 public constant UID = 0xc63201c9d926a78efdc7c8c6ebd9a8f217a22eecdafe65052ef1527d051582dd;
  ...
  /**
   * @dev Returns the token URI for the provided token id using baseURI as base.
   *
   * @param _tokenId token Id for which we should return its URI.
   */
   ...
   * @inheritdoc IMintableERC721
   */
  function safeMint(address _to, uint256 _tokenId) public virtual onlyRole(MINTER_ROLE) {
  ...
  function supportsInterface(bytes4 _interfaceId)
    ...
    returns (bool)
  {
    return _interfaceId == type(IMintableERC721).interfaceId || super.supportsInterface(_interfaceId);
  }
