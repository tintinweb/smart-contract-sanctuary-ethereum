...
// OpenZeppelin Contracts (last updated v0.8.13) (token/common/ERC2981.sol)
...
contract Factory is Initializable, ContextUpgradeable, ERC165Upgradeable, AccessControlEnumerableUpgradeable {
  ...
  function deploy721Contract(
    ...
    require(hasRole(DEPLOYER_ROLE, _msgSender()) || publicDeployerEnabled, "must have minter role to deploy contract");
