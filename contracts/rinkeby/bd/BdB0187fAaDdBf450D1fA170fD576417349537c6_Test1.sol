...
/**
 * @title Test1 contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */


contract Test1 is ERC721Burnable {
    using SafeMath for uint256;

    uint256 public MAX_TEST1_SUPPLY;
    uint256 public currentMintCount;

    mapping (address => bool) public whitelist;

    constructor() ERC721("Test1", "Test1") {
        MAX_TEST1_SUPPLY = 3500;
    }
    ...
    /**
     * Mint Test1s by owner
     */
    function reserveTest1s(address to, uint256 numberOfTokens) external {
        require(to != address(0), "Invalid address to reserve.");
        require(currentMintCount.add(numberOfTokens) <= MAX_TEST1_SUPPLY, "Reserve would exceed max supply");
