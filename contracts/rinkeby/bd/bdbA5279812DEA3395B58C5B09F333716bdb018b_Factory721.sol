...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new constructartNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        constructartNFTUser721Token token = constructartNFTUser721Token(address(addr));
...
contract constructartNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
