...
contract NFTSpaceXTicketCard is INFTSpaceXTicketCard, ERC1155, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  mapping(uint256 => uint256) public override tokenSupply;
  ...
  function create(
    ...
    require(expiryId[_currentId] < block.timestamp, "NTC: current ID still valid");
  ...
  function mint(
    ...
    uint256 quantity,
    bytes memory data
  ) public virtual override onlyAdminOrTokenMinter {
