...
contract Deca711 is VRFConsumerBaseV2, Pausable, Ownable, ReentrancyGuard {
    ...
    function test(uint256 _new) public view returns (uint256) {
        return maxBetPercentage.mul(_new).div(100);
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide) external {
        ...
        require(_betAmount <= maxBetPercentage.mul(housePoolBalance.depositAmount.div(100)), "maxBet");
