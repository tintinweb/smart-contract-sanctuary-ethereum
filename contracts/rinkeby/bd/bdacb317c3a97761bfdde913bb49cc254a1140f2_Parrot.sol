...
contract Parrot is ERC20, Ownable {
    ...
    constructor() ERC20("Parrot", "Parrot") {
        ...
        uint256 totalSupply = 100000000000 * 1e18; // 100 Billion

        maxTransactionAmount = 1000000000 * 1e18; // 1% from total supply maxTransactionAmountTxn: i.e 1 Billion
        maxWallet = 2000000000 * 1e18; // 2% from total supply maxWallet: i.e 2 Billion
        ...
        taxWallet = address(0x73122a98538592C963A4Bb78966769eB8aB0bC4E); // set as tax wallet
