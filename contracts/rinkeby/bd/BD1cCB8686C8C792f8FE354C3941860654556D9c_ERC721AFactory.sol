...
contract ERC721AContract is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    function mint(uint _quantity, bytes32[] memory _proof) public payable nonReentrant {
        ...
        if(_preSaleIsActive) {
            ...
            if (preSalePhase == 1) {
                ...
                require(_quantity <= mintpass.balanceOf(msg.sender, mintpassId) * maxPerMintpass , "Exceeds wallet presale limit.");
    ...
    function claimTo(address userWallet, uint256 quantity) public payable nonReentrant onlyFiatMinter() {
