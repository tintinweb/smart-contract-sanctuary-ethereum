...
contract CitadelNFT is ERC721A, Ownable {
    ...
    uint256 public constant PRIVATE_PRICE_PER_TOKEN = 0.08 ether;
    uint256 public constant PUBLIC_PRICE_PER_TOKEN = 0.08 ether;
    ...
    ) ERC721A("TheCitadel", "CITADEL", maxBatchSize_, collectionSize_) {
       MAX_PUBLIC_MINT = maxBatchSize_;
