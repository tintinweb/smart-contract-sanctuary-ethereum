...
contract ERC5050 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxPerTransaction = 2; //10;
    uint256 public maxPerWallet = 5; //40;
    uint256 public maxTotalSupply = 20; //7000;
    uint256 public chanceFreeMintsAvailable = 10; //3500;
    uint256 public freeMintsAvailable = 5; //1500;
