...
contract CultofLaughter is ERC721Royalty, Ownable, AccessControl {
    uint256 public constant MAX_PUBLIC_MINT = 5 + 1; // max mints per tx (+1 intentional for gas checks)
    ...
    constructor(address payable receiverAddress_) ERC721("CultofLaughter", "COL") {
