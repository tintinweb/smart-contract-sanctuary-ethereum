...
contract GhxstsComic is ERC721Enumerable, Ownable, ReentrancyGuard, ERC721Burnable {
  ...
  function createChapter(
    ...
    // newChapter.merkleRoot = ""; // default
    newChapter.active = true;
    // newChapter.frozen = false; // default
    // newChapter.isSaleOpen = false; // default
    // newChapter.isPublicSaleOpen = false; // default
    newChapter.price = price;
    newChapter.discountPrice = discountPrice;
    // newChapter.supply = 0; // default
