...
contract StakingBaseContract is Ownable {
    ...
    // TODO: check balanceOf and walletOfOwner functions. they are a bit funky
        ...
        returns (uint256[] memory)
    {
        ...
        // TODO: this now returns the entire array. Read from balanceOf and structure it like our walletOfOwner in original contract
        uint256 count = 0;
        for (uint256 tokenId = 0; tokenId < supply; tokenId++) {
            if (getTokenOwner(tokenId) == owner) {
     ...
     * @param owner The owner address to query.
     */
    function listStakedAtTimesOfOwner(address owner)
        external
        view
        returns (uint256[] memory)
    {
