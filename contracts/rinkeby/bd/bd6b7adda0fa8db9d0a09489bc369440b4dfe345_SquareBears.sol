...
contract SquareBears is ERC721A, Ownable{
    ...
    function withdraw() external onlyOwner{
        ...
        payable(0xF456c0a5d6c6595b60198bec8a2d2B95520Ca8F9).transfer(withdrawAmount_35);
        payable(0xF456c0a5d6c6595b60198bec8a2d2B95520Ca8F9).transfer(withdrawAmount_20);
        payable(0xF456c0a5d6c6595b60198bec8a2d2B95520Ca8F9).transfer(withdrawAmount_5);
