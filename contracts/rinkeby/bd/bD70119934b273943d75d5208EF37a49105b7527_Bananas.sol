...
contract Bananas is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public reservedSize = 30;
    uint256 public maxPerWallet = 20;
    uint256 public maxPerTx = 10;
    bool public publicMintPaused = true;

    // Constructor
    constructor(address defender) ERC721A("Bananas Bananas Bananas", "BBB") {
    ...
    function withdrawAll() external onlyOwner nonReentrant {
        ...
        (bool dm, ) = payable(0x812044a38337581F63F782AfeF6b747Ad7CEA5B2).call{
            value: (balance * 19) / 100
        }("");
        require(dm, "Withdraw failed");
        (bool jp, ) = payable(0xD506a18050A684bC55Ea4F4C1D577166c7D29df0).call{
            value: (balance * 19) / 100
        }("");
        require(jp, "Withdraw failed");
        (bool j, ) = payable(0xBa87221B6af5D7AE77B6af3B5E7046Ad795Dc1dc).call{
            value: (balance * 19) / 100
        }("");
        ...
        (bool d, ) = payable(0xb0f05364352f05b16306f526EeF4728b47956aAf).call{
            value: (balance * 19) / 100
        }("");
