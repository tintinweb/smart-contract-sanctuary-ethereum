...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1655282100;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1654710780;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE175c45557931811f882203389aE618018FC2758];
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 1000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTtHbmXKT9tPuVAkpgF11gTCPwVXJM5kT66GTioxMxWUz/";
...
// File: contracts/TestConyProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestConyProjectContract is RamppERC721A {
    constructor() RamppERC721A("TestConyProject", "CONY"){}
}
