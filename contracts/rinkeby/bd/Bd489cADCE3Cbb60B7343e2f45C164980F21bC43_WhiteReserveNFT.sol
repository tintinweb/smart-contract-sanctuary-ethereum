...
contract WhiteReserveNFT is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
    ...
    event RoyaltyInfoChange(address _receiver, uint96 _feeNumerator);
    ...
    function MintAllowlist(uint256 _amount, bytes32[] memory _proof) public payable {
        ...
        require(isValid(_proof), "Invalid proof!");
    ...
    function setDefaultRoyalty(address _receiver, uint96 _feeNumerator) external onlyOwner {
        ...
        emit RoyaltyInfoChange(_receiver, _feeNumerator);
    }
