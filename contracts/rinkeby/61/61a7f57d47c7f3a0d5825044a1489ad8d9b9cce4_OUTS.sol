...
contract OUTS is ERC721AQueryable, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
    using Strings for uint256;

    string public baseURI = "ipfs://bafybeid55izsygpgo6w27a5nh4plwkkzhplz572wvzddgsuqacwtixfbbe/";
    string public baseExtension = ".json";
    string public notRevealedUri;
    uint256 public costWL = 0.01 ether;
    uint256 public costEarlyAccess = 0.02 ether;
    ...
    constructor() ERC721A("Outsource", "OTS") {}
        ...
        payable
    {
        ...
        if (msg.sender != owner()) {
            ...
            if (currentState == 1) {
				...
				require(
				    currentTime() >= saleStartTime,
					"EarlyAccess Sale has not started yet"
				);
