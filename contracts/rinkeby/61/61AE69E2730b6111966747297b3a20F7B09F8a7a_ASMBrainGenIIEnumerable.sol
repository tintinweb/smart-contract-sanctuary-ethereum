...
contract ASMBrainGenIIEnumerable is Crypto, AccessControl, ERC721Enumerable {
    ...
    constructor(address multisig) ERC721("ASMBrainGenIIEnumerable", "ASMBrainGenIIEnumerable") {
