...
/// @title Nether Protocol Simple Staking
/// @author @takez0_o
...
contract SimpleStaking is Ownable, ReentrancyGuard {
  ...
  uint256 public rewardsDuration = 30 days; // sync with epoch
  uint256 public lastUpdateTime;
  uint256 public rewardPerTokenStored;
  uint256 private unlockDuration = 0; // discuss (maybe for bonds?) - in epochs
