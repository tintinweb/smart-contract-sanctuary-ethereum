...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    setHiddenMetadataUri("ipfs://Qmf6CUD8FDjbg9Tkdvah7PAA4AYWYay58a42p8BeGoc1Sg/metadata_reveal.json");
    buildings.push(Building("Zero",0,0,0,0,0,0));
    buildings.push(Building("House",1,3,2,2,0,3));
    buildings.push(Building("Jimy house",2,5,4,10,0,6));
    buildings.push(Building("Gallery",1,6,2,10,0,0));
    buildings.push(Building("House",1,1,2,7,0,-7));
    buildings.push(Building("House",2,3,1,-9,0,-9));
  }
