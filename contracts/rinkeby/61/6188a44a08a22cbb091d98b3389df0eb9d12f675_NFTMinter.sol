...
// Add burn feature
// Check if locked
// edit event to show how many nfts were minted
...
contract NFTMinter is ERC721URIStorage, RoyaltiesV2Impl {
    ...
    modifier check(string memory unityName, uint256 numberOfNFT) {
        ...
        require(
            msg.value == packDetail.cost * numberOfNFT,
    ...
    ) public payable check(unityName, numberOfNFT) {
            ...
            return
                string(
                    abi.encodePacked(
                        ...
                        // //
                        // baseExtension
                        "https://ipfs.infura.io/ipfs/QmbNX4TvhqTN4rYViSHp71S4vPVVhmD1PMtSDdeTcMYzTu"
                    )
                );
        }
        //  If there is no base URI, return the token URI.
