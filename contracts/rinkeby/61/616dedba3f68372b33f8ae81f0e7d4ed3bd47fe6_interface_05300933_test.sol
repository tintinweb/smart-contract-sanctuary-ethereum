...
contract interface_05300933_test is ERC721{
    using strings for *;
...
//metadata
    ...
    m_05300933 mainContract = m_05300933(0x0729256592048D3239bDc57e955E37d8f14b813a);
    
    constructor() ERC721("interface_05300933" , "interface_05300933" ) {
    ...
    function setMainContruct(address _address)public onlyOwner{
        mainContract = m_05300933(_address);
    }
