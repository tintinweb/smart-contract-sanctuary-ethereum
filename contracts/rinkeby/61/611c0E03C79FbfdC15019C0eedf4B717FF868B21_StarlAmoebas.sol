...
contract StarlAmoebas is Ownable, ERC721 {
    ...
    constructor (address _devFeeRecipient, address _amoebaRecipient, uint256[] memory supplies, uint256 launchTime, address[] memory feeRecipients, string[] memory baseUrls, string memory extension) ERC721("StarlAmoebas", "STAM") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(artists[artistId].baseUrl, index.toString()));
    }
