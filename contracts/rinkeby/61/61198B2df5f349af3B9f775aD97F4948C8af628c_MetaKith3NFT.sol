...
contract MetaKith3NFT is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("MetaKith3", "KITH3") {
        setBaseURI(baseURI);
    }
    ...
    function safeTransferFromContract( address from, address to, address token, uint256 tokenId ) public virtual {
