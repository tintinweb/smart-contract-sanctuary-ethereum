...
contract SmashMarblesArenaV1 is SmashMarblesStorageV1 {
     ...
     *      tokencounter,maxNFTs and maxLimit
     */
    function initialize() public initializer {
        ...
        COMMUNITY_WALLET = 0xa7922e663a53CD9Ba16Fb6cb985c6A03d08c7a94; // community wallet
     ...
     *              only contract owner can call
     */
    function increaseMaxNFT(uint256 _value) external virtual onlyOwner {
        maxNFTs += _value;
    }
        ...
        returns (bool)
    {
        ...
        require(
            (MarbleBalance + noOfTokens) <= maxLimit,
    ...
    /**
     * @dev check address is black listed or not
     *
     * @param _address user's wallet address
     *
     * Return : -
     *          if black listed then return true
     *          else return false
     */
    function isBlacklistedAddress(address _address)
        external
        view
        virtual
        returns (bool)
     ...
     */
    function getMarblesBalance(address _address)
        public
        view
        virtual
    ...
    /**
     * @dev use to get arena balance of a user
     *
     * @param _address wallet address of user
     *
     * Return :-
     *        arena balance of user in integer form
     */
    function getArenaBalance(address _address)
        public
        view
        virtual
        returns (uint256 ArenaBalance)
    {
