...
contract GigaSpaceLand is ERC721, ERC721URIStorage, Ownable {
    ...
    uint256 internal constant MAP_SIZE = 10000;
     ...
     */
     function mintLand(address to, uint256 size, uint256 x, uint256 y) public payable {
    ...
    function _safeMint(address to, string memory uri) internal {
        ...
        require(msg.value >= PRICE, "The minting fee is 0.02 ETH, not enough ETH amount sent");
