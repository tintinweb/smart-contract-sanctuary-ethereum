...
contract PlotClaim is  Ownable {
    ...
    address public metaplot = address(0xF5d56c3F506EA5C0605fAd06784b5Fe7c498EbCe);  
    ...
    function backErc20( address _token ) external onlyOwner {
    ...
    function useDevs() external onlyOwner {
