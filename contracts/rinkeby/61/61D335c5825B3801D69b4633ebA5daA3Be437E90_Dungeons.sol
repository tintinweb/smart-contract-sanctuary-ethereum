...
contract Dungeons is HeroStakes {
     ...
     */
    function updateDungeon(uint256 _dailyReward, uint8 _force, uint8 _intelligence, uint8 _agility) external onlyOwner whenPaused {
        require(_dailyReward > 0, "legendz rate is zero");
        require(_force > 0 && _intelligence > 0 && _agility > 0, "1 or more attributes set to zero");
