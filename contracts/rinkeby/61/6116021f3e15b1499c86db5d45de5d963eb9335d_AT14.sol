...
contract AT14 is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public _totalSupply = 666;
    uint256 public currentSupply= 333;
  ...
  constructor(
  ) ERC721A("AT14", "AT14", mintLimit, _totalSupply) {
     tokenCount = 0;
  }
  ...
  function withdrawRevenueShare() external onlyOwner {
    ...
    address engineer = payable(0xB386B60a03bCc525eaA8BFD4c9ad2D028C65fca1); 
    address partner = payable(0xD60B66fce3E35C37Da8239Fbb61bf78D5f32e4e7); 
