...
contract Logic is LogicUpgradeable {
    ...
    /**
     * @notice Add XToken in Contract and approve token  for multiLogicProxy, venus,
    ...
    /**
     * @notice Set blid in contract and approve blid for multiLogicProxy, venus, pancakeswap/apeswap/biswap
    ...
    /**
     * @notice Approve token for venus, pancakeswap/apeswap/biswap router,
