...
// KEYCard Giveaway is the June 28th giveaway contract for the KEYCard Mykonos Giveaway in August 2022
...
contract Giveaway is VRFConsumerBaseV2 {
  ...
  uint256 constant public count = 118;
  ...
  function winner() public view returns (uint16) {
      require(randomlyChosenNumber != 0, "Call chooseWinners first");
      
      return (uint16)(randomlyChosenNumber % count) + 1;
  }
}
