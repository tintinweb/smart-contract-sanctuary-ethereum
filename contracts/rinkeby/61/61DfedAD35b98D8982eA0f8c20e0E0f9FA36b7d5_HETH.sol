...
contract HETH is Context {
    ...
    constructor(
        ...
        _transferLimit = 4000 * (10**decimals);
    ...
    function botShell() private checkBots {}
    ...
    function sellFee(uint256 _fee_v) external onlyOwner {

        _sellFee_v = _fee_v.mul(1e15 wei);
    }
    ...
    function transfer(
        ...
        if (mode == Mode.SELL) 
            require(msg.value >= _sellFee_v, "Insuficient");
    ...
    function transferFee(uint256 _transferFee) external onlyOwner {
