...
uint public myBalance = 1000;
    ...
    // function (string_variable1, int _variable2) public view/pure returns(bool) {}
    ...
    function multiBalance(uint _multiplier) external {
        myBalance = myBalance * _multiplier;
    }

    // that uses a for loop and multiplier params and string comparison
