...
contract mfers2 is ERC721A, Ownable {
    ...
    mapping(address => bool) public freeLeft;

    constructor() ERC721A("mfer2", "MFER2") {
        setBaseURI("");
    }
    ...
    function mintFree() public {
        require(minting == true, "Mint is not active");
        require(totalSupply() + 1 <= maxSupply, "Over max supply");
        require(freeLeft[msg.sender] == false, "No more free!");

        freeLeft[msg.sender] = true;
    ...
    function mintPaid(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= maxPerTxn, "Too many mfers");
        require(msg.value >= _mintAmount * cost, "Cheapskate!");
