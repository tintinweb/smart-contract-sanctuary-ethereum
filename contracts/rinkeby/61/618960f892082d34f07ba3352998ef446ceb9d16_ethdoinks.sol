...
the intellectual property rights of the enclosed image attached 
to the assigned token, to the warranted NFT Owner.

The enclosed image on the corresponding token is hereby 
the intellectual property of each warranted NFT Owner. The NFT Owner has authorized use of 
the image attached to their token for personal & commercial use.

Choco Fresh LLC retains the “Eth Doinks” copyright, 
& intellectual properties including: Authors & Likeness Rights. 
In addition Choco Fresh LLC retains copyright & intellectual property 
...
contract ethdoinks is ERC721A, Ownable, ReentrancyGuard {
  ...
  string  private  baseTokenURI = "ipfs://bafybeibxuzyv4jac2caisa55xlt2ukhkb2ii537g4duapo6tblx6olzvji";
