...
contract DEVILSS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    address private openSeaProxyRegistryAddress = 0xF2665bddbdbC37f6e52A35e5A1C9c05583f0177F;
    ...
    constructor(
    ) ERC721A("DEVILSS", "DDDE", 100, maxSupply) {
    }
