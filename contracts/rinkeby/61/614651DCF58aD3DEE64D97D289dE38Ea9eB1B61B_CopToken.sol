...
contract CopToken is ERC20Burnable, ERC20Permit, ERC20Votes, IToken {
  ...
  function mintTokens(
    ...
    require(false, "cannot mint tokens");
  }

  function burnTokens(address _owner, uint256 _amount) external override {
