...
contract SDPResolver {
	...
	IREVERSEREGISTRAR constant public ReverseRegistrar = IREVERSEREGISTRAR(0x6F628b68b30Dc3c17f345c9dbBb1E483c2b7aE5c); //mod
	...
	function name(bytes32 node) view public returns (string memory){
		uint256 tokenId = nodeToId[node];
		return string(abi.encodePacked(tokenId.toString(), ".", parentLabel, ".eth"));
	}
	...
	function setPrimary(string calldata _name) external {
