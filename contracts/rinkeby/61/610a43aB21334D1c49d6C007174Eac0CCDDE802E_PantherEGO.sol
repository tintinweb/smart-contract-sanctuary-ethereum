...
contract PantherEGO is ERC721A, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0xc85E952a1030f9e16847B4D03d45a3ECC8e38780).transfer((balance * 50) / 1000);
        payable(0xf91C5f663B7A1BF38E3c68340cFAbAB673decFAB).transfer((balance * 35) / 1000);
        payable(0xefD6E3CA81e56b02867c45026074f712dD0135bB).transfer((balance * 45) / 1000);
        payable(0x6cfd6b3ca3413a3f4BC93642C0B600823dAfbbB9).transfer((balance * 150) / 1000);
        payable(0x8ebAc12B75D14D173a1727DC3eEbA78A1A3E382c).transfer((balance * 720) / 1000);
    }
