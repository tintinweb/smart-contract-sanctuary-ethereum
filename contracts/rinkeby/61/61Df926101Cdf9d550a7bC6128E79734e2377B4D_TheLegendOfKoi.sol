...
contract TheLegendOfKoi is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Legend of Koi", "TLOK") {
    setHiddenMetadataUri("ipfs://QmcBWKi3amPUTw15cZT6fKBeRBHrCVvPHakpZm15WAurro/hidden.json");
  }
