...
contract WisefyNFT is ERC721PsiBurnable, Pausable, AccessControl, ReentrancyGuard {
    uint public constant TOTAL_SUPPLY = 100;
    ...
    constructor(
        ...
        emit NFTCollectionCreated(address(this)); //Will have more data in the future
    }
    ...
    function safeMint(address to, uint256 quantity) public onlyRole(MINTER_ROLE) nonReentrant {
    ...
    function _beforeTokenTransfers(
        ...
        override
    {
        require(quantity + _minted <= TOTAL_SUPPLY, "Total supply exceeded");
    ...
    function setBaseURI(string calldata _baseUri) public onlyRole(DEFAULT_ADMIN_ROLE) {
        baseUri = _baseUri;
        
        emit NFTCollectionChanged();
    }

    event NFTCollectionCreated(address tokenAddress);
    event NFTCollectionChanged();
}
