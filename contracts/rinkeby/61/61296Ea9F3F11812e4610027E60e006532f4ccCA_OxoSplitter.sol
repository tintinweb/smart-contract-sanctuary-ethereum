...
library SafeERC20 {
    ...
    /// @author MV
    /// @notice Payments splitter contract. Get, release, release ERC-20 functions.
...
contract Oxo is ERC721, Ownable {
    ...
    constructor() ERC721("testArt23", "TXT2") {
        totalSupply = 10000;
        reserve = 50;
        preSalePrice = 9000000000;
        publicPrice = 10000000000000000;
        tokenId = 0;
        publicSaleEvent = false;
        whitelistSaleEvent = true;
        baseUri = "https://tokens.0x0.art/";
        contractUri = "https://tokens.0x0.art/contract.json";
        baseExtension = ".json";
