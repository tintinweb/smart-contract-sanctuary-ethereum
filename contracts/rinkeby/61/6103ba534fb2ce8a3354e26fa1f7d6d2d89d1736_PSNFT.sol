...
contract PSNFT is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 677;
    ...
    constructor() ERC721P("pre-sundere.nft", "PSNFT") {}
	
    function _baseURI() internal view virtual returns (string memory) {
        return baseURI;
    }
	
	function mintReservedNFT(address _to, uint256 _count) public onlyOwner nonReentrant{
