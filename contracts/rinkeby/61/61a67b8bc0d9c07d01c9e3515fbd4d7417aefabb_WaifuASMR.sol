...
// WAIFU ASMR
    contract WaifuASMR is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    ...
    constructor() ERC721A("WaifuASMR", "WASMR") {setHiddenMetadataUri("ipfs://QmSJAyv9odhWHsVQAd14oXfKhqc4sEjkDhyiBrPxkdkF9P/hidden.json");}
