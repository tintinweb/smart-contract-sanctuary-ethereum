...
contract AlchemistAcademy is Initializable {
    ...
    event Chymed(address chyme, uint256 fees, uint256 approvalStatus, string symbol);
    event AlchemistForged(address indexed alchemist, address priceOracle, uint8 fees, uint8 ratioOfSteady);
        ...
        (address) 
    {
        ...
        require(ratioOfSteady >= chyme.minRatioOfSteady, "Need a higher ratio");
        ...
        emit AlchemistForged(alchemistDeployed, chyme.oracleAddress, chyme.fees, ratioOfSteady);
        return alchemistDeployed;
    }
//TODO: Add a function to modify ratio and fees once generated
    function createNewChyme
    (
        uint8 _decimals,
        uint8 _minRatioOfSteady,
        uint8 _fees,
    ...
    (
        ...
        (
            ...
            chymeList[_chyme].minRatioOfSteady,
