...
contract sweepingDeclaration is Ownable {
    ...
    /// @param  _declarer is the address calling the function.
    /// @param _declaration is the declaration.
    function declareDeclaration( address _declarer, string memory _declaration ) public {

        /// @notice Check to make sure that the address making the declaration is the same as the address calling the function.
        require ( msg.sender == _declarer, "Can't make a declaration for other address." );
