...
contract HBC is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 1200;
	uint256 public RESERVED_NFT = 327;
	
	uint256 public MAX_MINT_PRESALE = 1200;
	uint256 public MAX_MINT_SALE = 1200;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 1200;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 1200;
    ...
    constructor() ERC721P("Hey Bear Club", "HBC") {}
