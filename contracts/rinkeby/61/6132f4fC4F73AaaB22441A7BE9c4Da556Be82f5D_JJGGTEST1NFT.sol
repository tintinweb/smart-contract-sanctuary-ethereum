...
contract JJGGTEST1NFT is ERC721, Ownable {
  ...
  // To prevent they cannot mint more than maximum amounts
  ...
  function setMaxMintPerWallet(uint256 maxPerWallet_) public onlyOwner {
