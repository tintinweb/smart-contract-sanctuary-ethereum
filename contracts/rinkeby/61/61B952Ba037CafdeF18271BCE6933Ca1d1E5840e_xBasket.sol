...
interface IXToken {
    ...
    function culture() external pure returns(string memory);
}
...
contract xBasket is ERC20, Ownable {
    ...
    constructor(address _xWheat, address _xSoy, address _xCorn, address _xRice) ERC20("xBasket LandX Index Fund", "xBASKET") {
        xWheat = _xWheat;
        xSoy = _xSoy;
        xCorn = _xCorn;
        xRice = _xRice;
