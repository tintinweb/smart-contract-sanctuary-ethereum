...
import "contracts/TimedDrop.sol";
...
abstract contract AmberHardERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 2999 ) {}
    ...
    uint256 public PRICE2 = 0.1 ether;
...
// File: contracts/AmberHardContract.sol
...
contract AmberHardContract is AmberHardERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5KBCc1sAWV3PgpEdkm0v/contract-metadata";
    }
}
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1654536000;
...
abstract contract Withdrawable is Ownable {
    address public constant PAYABLE_ADDRESS = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
