...
contract BGT is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    //whitelists and max wallets
        ...
        uint256 public maxWhiteListLimit = 1;
    // end whitelists and max wallets    

    // prices =================
    uint256 public FirePriceWhiteList = 8 ether;
    uint256 public FirePrice = 8 ether;

    uint256 public GoldPriceWhiteList = 1.5 ether;
    uint256 public GoldPrice = 1.5 ether;
    // end prices==============
   ...
   // }
    ...
    constructor(address payable fundsTo_) ERC721("BGT", "BGT") {
        fundsTo = fundsTo_;
        ...
        teamTierLimits[Teams.Team1][GoldTier] = 975;
        teamTierLimits[Teams.Team2][GoldTier] = 975;
        teamTierLimits[Teams.Team3][GoldTier] = 975;
        teamTierLimits[Teams.Team4][GoldTier] = 975;
        teamTierLimits[Teams.Team5][GoldTier] = 975;
        teamTierLimits[Teams.Team6][GoldTier] = 975;
        teamTierLimits[Teams.Team7][GoldTier] = 975;
        teamTierLimits[Teams.Team8][GoldTier] = 975;
        teamTierLimits[Teams.Team9][GoldTier] = 975;
        teamTierLimits[Teams.Team10][GoldTier] = 975;
        teamTierLimits[Teams.Team11][GoldTier] = 975;
        teamTierLimits[Teams.Team12][GoldTier] = 975;
    ...
    function claimBalanceOwner() public onlyOwner {
    ...
    function getTeamTierMintCount(Teams team,uint256 tier) private view returns (uint256) {
        return teamTierMintCounts[team][tier];
    }
    
    function getTeamTierSupply(Teams team,uint256 tier) private view returns (uint256) {
    ...
    function tokenURI(uint256 id) public view virtual override returns (string memory) {
            return string(abi.encodePacked(baseURI, Strings.toString(id),"/", Strings.toString(mintTeam[id]),"/", Strings.toString(mintTier[id])));
    }
    ...
    function _safeMintLoop(address wallet, Teams team, uint256 tier, uint256 quantity) internal
    {
        for (uint256 i = 0; i < quantity; i++) {
            mintTeam[_tokenIdCounter.current()] = teamIDS[team];
            mintTier[_tokenIdCounter.current()] = tier;
            _safeMint(wallet, _tokenIdCounter.current());
    ...
    function mintVipFire(address wallet, uint256 quantity,Teams team) payable public {
        ...
        _safeMintLoop(wallet, team, FireTier, quantity);

    }

    function mintVipFireOwner(address wallet, uint256 quantity,Teams team) external onlyOwner {
        require(quantity != 0, "Requested quantity cannot be zero");
        require(isVipWallet(wallet,team,FireTier)>=quantity,"Wallet Not WhiteListed Or No Mint Quantity Available");
        require(getTeamTierMintCount(team,FireTier)+quantity<=teamTierLimits[team][FireTier],"Low Mint Supply for Whitelist");        
        reduceLimit(wallet,quantity, team, FireTier);
    ...
    function mintWhitelistFireOwner(address wallet, uint256 quantity,Teams team) external onlyOwner {
        require(whiteListSale, "Whitelist Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
        require(_isWhitelistAddress(wallet),"Wallet Not WhiteListed Or No Mint Quantity Available");
        require(getTeamTierMintCount(team,FireTier)+quantity<=teamTierLimits[team][FireTier],"Low Mint Supply for Whitelist");
    ...
    function mintFireNormalOwner(address wallet, uint256 quantity,Teams team) external onlyOwner{
        require(sale, "Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
        require(getTeamTierMintCount(team,FireTier)+quantity<=teamTierLimits[team][FireTier],"Low Mint Supply for Whitelist");
        require(minted[wallet]+quantity<=maxWallet,"Wallet Mint limit rached");
    ...
    function mintVipGold(address wallet, uint256 quantity,Teams team) payable public {
        require(vipSale, "VIP Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
        require(quantity * GoldPriceWhiteList <= msg.value, "Not enough ether sent");
        require(isVipWallet(wallet,team,GoldTier)>=quantity,"Wallet Not WhiteListed Or No Mint Quantity Available");
        require(getTeamTierMintCount(team,GoldTier)+quantity<=teamTierLimits[team][GoldTier],"Low Mint Supply for Whitelist");        
        reduceLimit(wallet,quantity, team, GoldTier);
        _safeMintLoop(wallet, team, GoldTier, quantity);

    }

    function mintVipGoldOwner(address wallet, uint256 quantity,Teams team) external onlyOwner {
        require(quantity != 0, "Requested quantity cannot be zero");
        require(isVipWallet(wallet,team,GoldTier)>=quantity,"Wallet Not WhiteListed Or No Mint Quantity Available");
        require(getTeamTierMintCount(team,GoldTier)+quantity<=teamTierLimits[team][GoldTier],"Low Mint Supply for Whitelist");        
        reduceLimit(wallet,quantity, team, GoldTier);
    ...
    function mintWhitelistGold(address wallet, uint256 quantity,Teams team) payable public {
        require(whiteListSale, "Whitelist Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
        require(quantity * GoldPriceWhiteList <= msg.value, "Not enough ether sent");
        require(_isWhitelistAddress(wallet),"Wallet Not WhiteListed Or No Mint Quantity Available");
    ...
    function mintWhitelistGoldOwner(address wallet, uint256 quantity,Teams team) external onlyOwner {
        require(whiteListSale, "Whitelist Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
        require(_isWhitelistAddress(wallet),"Wallet Not WhiteListed Or No Mint Quantity Available");
        require(getTeamTierMintCount(team,GoldTier)+quantity<=teamTierLimits[team][GoldTier],"Low Mint Supply for Whitelist");
    ...
    function mintGoldNormal(address wallet, uint256 quantity,Teams team) payable public {
        require(sale, "Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
    ...
    function mintGoldNormalOwner(address wallet, uint256 quantity,Teams team) external onlyOwner{
        require(sale, "Sale disabled");
        require(quantity != 0, "Requested quantity cannot be zero");
        require(getTeamTierMintCount(team,GoldTier)+quantity<=teamTierLimits[team][GoldTier],"Low Mint Supply for Whitelist");
        require(minted[wallet]+quantity<=maxWallet,"Wallet Mint limit rached");
