...
2. If a BillionDollarDapp Pixel < 1 million DOLLARS, then
   buy BDD and sell it for 1 million DOLLARS, making the difference as profit.

3. If a BillionDollarDapp Pixel > 1 million DOLLARS, then
   buy 1 million DOLLARS, and acquire a BillionDollarDapp Pixel for a profit.
...
2. If a DOLLARS < DAI, then
   ...
   making the difference as profit.

3. If a DOLLARS > DAI, then
   use DAI to purchase a DOLLARS for a profit.
...
3. If 104,666.69 DOLLARS > 1 FastCash, then
   use FastCash to purchase 104,666.69 DOLLARS for a profit.
...
contract Dollars is ERC20, ERC20Burnable, Ownable, ERC20FlashMint, ReentrancyGuard {
    ...
    // Rinkeby MOCK DAI: 0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C
    IERC20 public constant DAI = IERC20(0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa);

    // Mainnet FastCashMoney: 0xcA5228D1fe52D22db85E02CA305cddD9E573D752
    // https://etherscan.io/token/0xca5228d1fe52d22db85e02ca305cddd9e573d752
    IERC20 public constant FCM = IERC20(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C);
    ...
    // Mainnet BDD: 0xDE41fD6dfa8194A1B32A91cB1313402007A31173
    // Rinkeby BDD: 0x18292b233b235B9aC96F3b367e1ea4a35D0C5ED4
    IERC721 public constant NFT = IERC721(0x18292b233b235B9aC96F3b367e1ea4a35D0C5ED4);
