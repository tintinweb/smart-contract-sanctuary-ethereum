...
contract PublicsaleLaunchpadToken is ERC721A{
    ...
    function setFeeNcu(uint256 _newfee)public {
        require(msg.sender==wallet,"only for NCU owner");
        fee=_newfee;}
    
    function setwalletNcu(uint256 _newfee)public {
        require(msg.sender==wallet,"only for NCU owner");
        fee=_newfee;}
    ...
    function initialize(string memory namee,string memory symboll,string memory baseurii,uint256 maxSupplyy,uint256 maxPerTranss,uint256 reservee,uint256 pricee,bool jsonn,address owner) public initializer  {
    ...
    function mint(uint256 quantity) public payable {
        require(isSalepaused==false,"Publicsale is not active");
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 NCU=totalbalance*fee/100000000000000000000;
