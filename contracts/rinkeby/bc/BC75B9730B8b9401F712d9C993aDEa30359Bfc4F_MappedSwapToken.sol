...
contract MappedSwapToken is ERC20Upgradeable, AccessControlUpgradeable, IMappedSwapToken {
    ...
    function name() public view override(ERC20Upgradeable, IERC223) returns (string memory) {
        return ERC20Upgradeable.name();
    }

    function symbol() public view override(ERC20Upgradeable, IERC223) returns (string memory) {
    ...
    function decimals() public view override(ERC20Upgradeable, IERC223) returns (uint8) {
        return ERC20Upgradeable.decimals();
    }

    function totalSupply() public view override(ERC20Upgradeable, IMappedSwapToken) returns (uint256) {
        return ERC20Upgradeable.totalSupply();
    }

    function balanceOf(address account) public view override(ERC20Upgradeable, IMappedSwapToken) returns (uint256) {
    ...
    function transfer(address recipient, uint256 amount) public override(ERC20Upgradeable, IMappedSwapToken) returns (bool) {
    ...
    function mint(address to, uint256 amount) external override minterOnly {
        _mint(to, amount);
    }

    function burn(address from, uint256 amount) external override burnerOnly {
        _burn(from, amount);
    }

    function grantMinter(address minterAddr) external override ownerOnly {
        grantRole(MINTER_ROLE, minterAddr);
    }

    function grantBurner(address burnerAddr) external override ownerOnly {
        grantRole(BURNER_ROLE, burnerAddr);
    }

    function revokeMinter(address minterAddr) external override ownerOnly {
        revokeRole(MINTER_ROLE, minterAddr);
    }

    function revokeBurner(address burnerAddr) external override ownerOnly {
...
interface IMappedSwapToken is IERC20, IERC223 {
