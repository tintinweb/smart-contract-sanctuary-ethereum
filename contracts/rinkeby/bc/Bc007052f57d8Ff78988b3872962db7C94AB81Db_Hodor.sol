...
contract Hodor is ERC721A, Ownable, ReentrancyGuard {

    uint64 constant public MAX_TOKENS_PER_ACCOUNT_FOR_FREE = 2;
    uint256 constant public freeSupply = 1000;
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_) ERC721A(name_, symbol_) {
        ...
        super._safeMint(msg.sender, 100);
    }
    ...
    function freeMint(uint256 num) external callerIsUser mintStarting nonReentrant {
        require(totalSupply() + num <= freeSupply, "over free supply");
    ...
    function pausedSale() external onlyOwner {
        saleStarting = false;
    }
