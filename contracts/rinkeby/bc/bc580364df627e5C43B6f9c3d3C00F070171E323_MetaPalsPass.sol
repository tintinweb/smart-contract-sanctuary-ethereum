...
contract MetaPalsPass is Ownable, ERC721A, ReentrancyGuard {
  uint256 public maxPerAddressDuringMint = 500;
  uint256 public maxMintPerAddressPublic = 5;
  uint256 public publicPrice = 0.05 ether;
  uint256 public mintlistPrice = 0.001 ether;
  uint256 public maxBatchSize_ = 500;
  ...
  constructor()
    ERC721A("MetaPalsPass", "MPP", maxBatchSize_, collectionSize_) 
