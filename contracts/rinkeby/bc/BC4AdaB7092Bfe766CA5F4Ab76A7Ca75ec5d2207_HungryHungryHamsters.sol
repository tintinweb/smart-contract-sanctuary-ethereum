...
contract HungryHungryHamsters is ERC721Enumerable, Ownable
{
  ...
  string private constant HHH_PROVENANCE =                    "f43aab6b72d1b5ba2235dc440bb66bf1d27b64a75c90b78d5df20d31ab01fa2a";
  ...
  uint256 private constant SALE_START_TIMESTAMP =             1642273200;                                                               //Jan 15 2022 @ 7 P.M. UTC //1647694800, March 19 2022 @ 1 P.M.

  uint256 private constant PRESALE_START_TIMESTAMP =          1642273200;                                                               //48 hours before open sale
  ...
  function mintHamsters(uint256 numberOfTokens) public payable
  {
    ...
    require(block.timestamp > PRESALE_START_TIMESTAMP, "Wait until presale or open sale");
    ...
    if(block.timestamp <= SALE_START_TIMESTAMP)
    {
       ...
       * During Presale
       */
      require(isAddressWhitelisted(msg.sender), "You are not in the presale");
   ...
   */
  function setWhitelist(address[] calldata newWhitelistAddresses) public onlyOwner
  {
    delete whitelistAddresses;
    whitelistAddresses = newWhitelistAddresses;
  }
}
