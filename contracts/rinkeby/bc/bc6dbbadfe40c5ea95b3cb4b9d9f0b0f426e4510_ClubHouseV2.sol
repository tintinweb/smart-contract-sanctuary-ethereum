...
contract ClubHouseV2 is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    event createdNft(address user, uint256 referenceId, uint256 tokenId, uint256 price, uint256 sizeId);
        ...
        returns (bool)
    {
        ...
        emit createdNft(msg.sender, _order.id, tokenCounter, msg.value, _order.size_id);
