...
contract DynamicPrice is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 64;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(msg.value >= NeedToUpdateCost(supply) * _mintAmount, "Not enough Matic");
