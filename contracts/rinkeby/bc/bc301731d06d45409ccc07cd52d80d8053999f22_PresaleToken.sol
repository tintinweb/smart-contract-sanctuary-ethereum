...
contract PresaleToken {
    ...
    /// Fields:
    string public constant name = "INU Infinity";
    string public constant symbol = "INU Token";
    ...
    uint public totalSupply = 5000000000000000000; // amount of tokens already sold
