...
contract Mubies is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint64  private immutable maxMintAmountPerTx = 4;
    bool    private treasuryMint;
    ...
    function preMint(uint _q) private {
        ...
        require(totalSupply() + _q <= maxSupply, "Maximum supply exceeded");
    }

    function publicMint(uint256 _q) external payable {
