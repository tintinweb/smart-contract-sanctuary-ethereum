...
// File: contracts/ImfutureContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ImfutureContract is RamppERC721A {
    constructor() RamppERC721A("IM FUTURE", "IF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/v0nm55oodMAttB1WBZyL/contract-metadata";
    }
}
