...
contract IVxFactory is Ownable, ReentrancyGuard, ERC721Enumerable {
    ...
    uint256 public priceInWei = 1 ether;
    ...
    modifier transferSafeguard(uint256 tokenId) {
        require(_msgSender() == ownerOf(tokenId) || !redeemed[tokenId] || market == _msgSender(), 'Only the token owner can trade');
        _;
    }
        ...
        nonReentrant
    {
        ...
        require(msg.value == priceInWei, 'IVX: 1 ETH to mint');
