...
contract FAKEpelple is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("FAKEpelple", "fakepeople", 2, 16) {}
    ...
    uint256 public publicPrice = 0.000700 ether;
    uint256 public amountForPublicSale = 16;
