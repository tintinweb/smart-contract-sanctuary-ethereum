...
//*********************************************************************//
//
// â•”â•â•—â”Œâ”€â”â”Œâ”€â”  â•¦ â•¦â”Œâ”€â”â”Œâ”¬â”â”Œâ”€â”â”Œâ”â”Œ  â•”â•â•—â”¬  â”¬ â”¬â”Œâ”   â•”â•â•—â•”â•â•—â•¦ â•¦â•”â•â•—
// â• â•â•£â”œâ”€â”˜â”œâ”¤   â•‘â•‘â•‘â”‚ â”‚â”‚â”‚â”‚â”œâ”¤ â”‚â”‚â”‚  â•‘  â”‚  â”‚ â”‚â”œâ”´â”  â• â•â•£â• â•â•â•‘â•‘â•‘â•‘  
// â•© â•©â”´  â””â”€â”˜  â•šâ•©â•â””â”€â”˜â”´ â”´â””â”€â”˜â”˜â””â”˜  â•šâ•â•â”´â”€â”˜â””â”€â”˜â””â”€â”˜  â•© â•©â•©  â•šâ•©â•â•šâ•â•
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2890e7bCDAE991Ed2C6b0d4Af561882f1778A659,0x341Afbd33f4E96B5C10351A367a02dcF08dc7AB1,0x0cD96FCeA3ECBF72DCF68F92A40fa4295f7A719a];
  uint256[] public payableFees = [5,51,34,10];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 500, 9999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmW63UgmxXPU6XvARiXrYRFuzU3PWcA1AJb3dKLZvwoJgx/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 0.1 ether;
    
    uint256 public MAX_WALLET_MINTS = 1000;
...
// File: contracts/ApeWomenClubApwcContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ApeWomenClubApwcContract is RamppERC721A {
    constructor() RamppERC721A("Ape Women Club APWC", "APWC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GyB0oZc4wxzn8QZ07zF9/contract-metadata";
    }
}
