...
contract Deerpack is ERC721Enumerable, Ownable, nonReentrant {
    ...
    uint256 public PRESALE_PRICE = 50000000000000000; // 0.05 ETH

    uint256 public MAX_SUPPLY = 10000; // 10k supply
    uint256 public MAX_TEAMRESERVE = 100; // total team reserves allowed
    ...
    bytes32 public MerkleRoot =
        0x06261e8de9673cface2db1e6c6aa85065cb77683688a252352f1a6c1360cb507;
    ...
    function mint(uint256 _mintAmount) external payable reentryLock {
    ...
    function mintPresale(bytes32[] memory _proof, uint256 _mintAmount)
        ...
        reentryLock
    {
        require(saleState > SaleState.paused, "presale not active");
    ...
    /** @dev reserve function for team mints (giveaways & payments) */
