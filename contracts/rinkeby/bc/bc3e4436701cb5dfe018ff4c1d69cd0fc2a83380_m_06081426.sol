...
library metadataLib{
    ...
    function mergeTokenMetadata(LayerInfo memory _info)internal pure returns(string memory){
    ...
    // function getLayer(){
    //     if(_layer == 1){_layerInfo.Layer1 = property;}
    //     else if(_layer == 2){_layerInfo.Layer2 = property;}
    //     else if(_layer == 3){_layerInfo.Layer3 = property;}
    //     else if(_layer == 4){_layerInfo.Layer4 = property;}
    //     else if(_layer == 5){_layerInfo.Layer5 = property;}
    //     else if(_layer == 6){_layerInfo.Layer6 = property;}
    //     else if(_layer == 7){_layerInfo.Layer7 = property;}
    //     else if(_layer == 8){_layerInfo.Layer8 = property;}
    // }

    function setLayerProperty(LayerInfo memory _layerInfo , uint _layer , string memory property , string memory image)internal pure returns(LayerInfo memory){
        if(_layer == 1){_layerInfo.Layer1 = property;}
        else if(_layer == 2){_layerInfo.Layer2 = property;}
        else if(_layer == 3){_layerInfo.Layer3 = property;}
        else if(_layer == 4){_layerInfo.Layer4 = property;}
