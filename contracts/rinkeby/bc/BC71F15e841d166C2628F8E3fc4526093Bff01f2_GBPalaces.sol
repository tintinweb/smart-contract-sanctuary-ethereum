...
contract GBPalaces is Ownable, ERC721 {
    ...
    uint256 public constant PUBLIC_PRICE = 0.046 ether;
    uint256 public constant WHITELIST_PRICE = 0.037 ether;
    uint256 public constant RUGLIST_PRICE = 0.028 ether;
    ...
    ERC721("GrandBazaarPalace", "PALACE") {
        _baseTokenURI = "gateway.pinata.cloud/ipfs/QmQ2S2DexGfjLZ1z4tpN64UcfRvywvAoYCwj1YLgoPEN5Q/";
    }   

    //@dev sets public mint boolean state
    function setPublicMintActive(bool _setPublicMint) external onlyOwner{
        publicSaleActive = _setPublicMint;
    }


    //@dev sets ruglist mint boolean state
    function setRugListMintActive(bool _setRugListMint) external onlyOwner{
    ...
    external payable {
        ...
        require( msg.value >= PUBLIC_PRICE * numToMint, "Minting this NFT costs .046 ether per token for public minters" ); 
    ...
    external payable {
        ...
        require( totalMinted + numToMint <= 7777, "This NFT is sold out!" );
        require( msg.value >= RUGLIST_PRICE * numToMint, "Minting this NFT costs 0.028 ether per token for public minters" ); 
    ...
    external payable {
        ...
        require( totalMinted + numToMint <= 7777, "This NFT is sold out!" );
        require( uint8(balanceOf(msg.sender)) + numToMint < 50, "You are attemping to mint more tokens than you are able"); 
        require( msg.value >= WHITELIST_PRICE * numToMint, "Minting this NFT costs 0.037 ether per token for public minters" ); 
