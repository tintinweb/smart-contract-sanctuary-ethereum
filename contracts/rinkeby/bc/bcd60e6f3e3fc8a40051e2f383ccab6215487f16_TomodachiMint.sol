    ...
    PausableUpgradeable
{
    ...
    function ownerMint(uint256 _amount) external onlyOwner {
        ...
        require(
            _amount + ownerMinted <= MAX_SUPPLY,
        ...
        nonReentrant
    {
        ...
        require(
            reserveListMinted + 1 <= reserveListCap,
    ...
    function setReserveListCap(uint256 amount) external onlyOwner {
        reserveListCap = amount;
    }
