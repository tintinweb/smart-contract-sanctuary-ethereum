...
contract PreciousPass is Ownable, ERC721A, PaymentSplitter, ReentrancyGuard {
    ...
    uint public cost = 0.066 ether;
    uint public wLcost = 0.045 ether;
    uint public maxSupply = 3499;
    uint public initialMint = 100;
    ...
    constructor(
        ...
        _safeMint(msg.sender, initialMint);
    }
    ...
    **/
    function mint(uint256 _quantity) external payable nonReentrant{
        ...
        require(
            _quantity <= 4 && maxSupply >= totalSupply() + _quantity,
    ...
    **/
        ...
        nonReentrant
    {
        ...
        require(msg.value == _quantity * wLcost, "not enough ether");
        require(
            _quantity <= 2 && maxSupply >= totalSupply() + _quantity,
            "Max mint quantity reached"
        );
    ...
    **/
    ...
    /**
    * @notice Allows anyone to withdraw contract funds for team payment
    **/
