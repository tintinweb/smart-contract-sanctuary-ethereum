...
//TODO: - remove setQuantityMinted for production
//TODO: - remove testInit for propduction
//TODO: - transform back public to external setters for production
//TODO: - remove grantAdminRole for production
//TODO: - remove setMaxSupply for production

contract FutureQuest is ERC1155PS, ERC2981Base, AccessControl {
  using Strings for uint256;

  address public _couponSigner; // Address of the wallet that generated the coupons
  ...
  constructor(address couponSigner) ERC1155PS("") {
    ...
    _setupRole(ADMIN_ROLE, 0x74a8E8663DCd23cb46f9Fe3dBC9170870f9043C5);
   ...
   */
  function create(uint256 maxSupply) public onlyAdmin returns (uint256) {
  ...
  function setPublicMintActive(bool active) public onlyAdmin {
    _publicMintActive = active;
  }

  function setPresaleMintActive(bool active) public onlyAdmin {
  ...
  function testingInit() public {
    setPresaleMintActive(true);
...
contract $FutureQuest is FutureQuest {
    ...
    function $_isVerifiedCoupon(bytes32 digest,FutureQuest.Coupon calldata coupon) external view returns (bool) {
        return super._isVerifiedCoupon(digest,coupon);
    }
