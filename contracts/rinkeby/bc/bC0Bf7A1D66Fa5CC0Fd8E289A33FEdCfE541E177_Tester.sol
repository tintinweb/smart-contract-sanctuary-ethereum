...
contract Tester is Ownable, ERC721A, ReentrancyGuard {
  uint256 public immutable maxPerAddressDuringMint;
  uint256 public immutable amountForDevs;
  uint256 public immutable amountForAuctionAndDev;
  uint256 public immutable maxPerWhitelist;
  uint256 public immutable maxPerCollected;
  ...
  ) ERC721A("Testy Testies", "TSTS", maxBatchSize_, collectionSize_ ) {
