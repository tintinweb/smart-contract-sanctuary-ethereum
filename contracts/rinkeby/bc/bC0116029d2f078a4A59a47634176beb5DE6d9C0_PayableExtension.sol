...
abstract contract Allowlist is AdminControl {
    ...
    function quantityOf(
        ...
        bool[] memory interfaceIdsSupported = address(nft).getSupportedInterfaces(interfaceIds);
    ...
    function supportsOneInterface(address account, bytes4[] memory interfaceIds)
        ...
        returns (bool)
    {
        bool[] memory interfaceIdsSupported = account.getSupportedInterfaces( interfaceIds);
...
abstract contract AllowlistAddress is AdminControl {
    ...
    function setAllowlistAddress(bytes32 _merkleRoot) external adminRequired {
