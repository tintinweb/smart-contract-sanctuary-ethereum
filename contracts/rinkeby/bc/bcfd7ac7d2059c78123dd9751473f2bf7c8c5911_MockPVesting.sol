    ...
    ReentrancyGuardUpgradeable
{
    ...
    event Released(address indexed user, uint256 indexed balanceOf, uint256 totalCanCalimedAmount);
     ...
     */
    function released() public virtual returns (uint256) {
        uint256 balanceOf = IERC721Upgradeable(nftAddr).balanceOf(msg.sender);
        if(balanceOf == 0) {
            emit Released(msg.sender, 0, 0);
            return 0;
        }
        ...
        emit Released(msg.sender, balanceOf, totalCanCalimedAmount);
