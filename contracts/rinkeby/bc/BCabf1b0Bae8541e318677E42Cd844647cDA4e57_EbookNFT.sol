...
//EbookNFT main contract.

contract EbookNFT is ERC721URIStorage {
    ...
    constructor() ERC721("JeffBrownEbooksTest", "JBEBT") {
        owner = msg.sender;
    }
    ...
    function setEbookNFTAddress(address _ebookNFTHelperAddress)
        public
        onlyOwner
    {
        ebookNFTHelperAddress = _ebookNFTHelperAddress;
    }
    ...
    function _updateAccountBalances(uint256 tokenId) internal {
        ...
        //      msg.value - (booksInfo[tokenData[tokenId].isbn].transactionCut*(msg.value/100));
    ...
    function publishBook(
        ...
        booksInfo[_isbn].publisherAddress = payable(msg.sender);
    ...
    //function to actually consume the content  you've bought
