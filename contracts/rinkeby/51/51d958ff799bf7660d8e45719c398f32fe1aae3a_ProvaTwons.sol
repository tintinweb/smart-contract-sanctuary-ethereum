...
contract ProvaTwons is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ProvaTwons", "PTWONS") {
    setHiddenMetadataUri("ipfs://QmPxRV2LGLAC9evpkFiwpqsaW19qcjZN2oYoq5A1HyMRxw/1.json");
  }
