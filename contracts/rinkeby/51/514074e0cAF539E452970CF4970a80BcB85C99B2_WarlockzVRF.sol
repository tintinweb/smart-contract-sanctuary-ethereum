...
contract WarlockzVRF is VRFConsumerBaseV2 {
    ...
    uint256 public rewardPrice = 1000000000000000000;
    ...
    constructor(uint64 subscriptionId, address SACAddress)
        VRFConsumerBaseV2(vrfCoordinator)
    {
        COORDINATOR = VRFCoordinatorV2Interface(vrfCoordinator);
        s_owner = msg.sender;
        s_subscriptionId = subscriptionId;
        Sac = IBurn(SACAddress);
    }
    ...
    function threeDigitNum() private returns (uint256) {
    ...
    function mintRewardTotal() public {
        requestRandomWords();
        threeDigitNum();
        mintReward();
    }
...
contract Sacrifice is ERC20, Ownable {
    ...
    constructor(address warlockzAddress)
        ERC20("Sacrifice Utility Token", "SAC")
    {
    ...
    function updateReward(address from, address to)
        external
        onlyWarlockzContract
    {
        if (from != address(0)) {
