...
contract crypt0potamus is Delegated, ERC721EnumerableLite, PaymentSplitterMod {
    using Strings for uint;

    // General NFT Variables

    uint public maxTokens = 10000;
    uint public maxOrder = 20; // maximum order per transaction
    uint public price = 0.005 ether; // price during mint
     ...
     */
    function setMinMax(uint maxOrder_, uint maxTokens_) external onlyDelegates {
