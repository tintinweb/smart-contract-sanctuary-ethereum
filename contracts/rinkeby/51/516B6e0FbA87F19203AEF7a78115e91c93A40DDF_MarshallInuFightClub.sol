    ...
    Signed
{
    ...
    constructor() ERC721A("Marshall Inu Fight Club", "MRIFC", 10, 4444) {
        setPrivateSaleTime(1657969200, 1658012400); // 16 July 6am EST to 6pm EST
    }
        ...
        whenNotPaused
    {
        ...
        require(
            userMintBalance[_msgSender()].add(amount) <= maxTokenAddress,
    ...
    function setMaxAddress(uint256 amount) external onlyOwner {
        maxTokenAddress = amount;
    }
