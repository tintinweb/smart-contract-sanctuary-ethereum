...
// File contracts/GaxieInfinity.sol
...
contract GaxieInfinity is ERC721, ERC721Enumerable, adnx {
    ...
    constructor(uint256 _maxSupply) ERC721("GaxieInfinity", "GAXIE") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No Gaxies left :(");
