...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVmXPs5k5tGhhinp3zi1KJyJJY1m8hn898xPAGjbHAn3A/";
...
// File: contracts/PantheondesignsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PantheondesignsContract is RamppERC721A {
    constructor() RamppERC721A("pantheondesigns", "PD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/F2otsxxw8XLQEG7GSQKu/contract-metadata";
    }
}
