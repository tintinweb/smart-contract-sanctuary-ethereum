...
contract CrossChainNft is Ownable, ERC721Enumerable, NonblockingLzApp {
    ...
    mapping(uint256 => uint16) public tokenToDestChainId;
        ...
        payable
    {
        ...
        // Perhaps don't have to store the data onchain - this can be altered into event instead
        tokenToDestChainId[_tokenId] = _dstChainId;
    }
}
