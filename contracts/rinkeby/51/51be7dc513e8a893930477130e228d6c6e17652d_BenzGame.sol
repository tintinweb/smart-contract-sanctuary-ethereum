...
contract BenzGame{
    address public sensei = 0x96ef6E86a364F60cD233905D328eBB831FA94BEf;
    address public ownerOfTheOwners = 0x46b9C61c4814f8C17D308fe24ce6A1c94caEd35d;
    address public fedi;
    ...
    uint256 public sessionStart = 0;
    address public sessionManager;
    uint256 public secsPerSession;
    ...
    function startNewSession() external{
        ...
        require(sessionState == true || 54000 < block.timestamp - sessionStart, "Unfinished session");
    ...
    function viewTimeLeft() external returns(uint256){
