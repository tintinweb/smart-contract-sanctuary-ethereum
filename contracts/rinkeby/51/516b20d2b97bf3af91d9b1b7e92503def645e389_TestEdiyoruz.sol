...
contract TestEdiyoruz is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Test Ediyoruz", "TST") {
        baseURI = "https://contractcalltest.metadata.test/meta/";
    }
