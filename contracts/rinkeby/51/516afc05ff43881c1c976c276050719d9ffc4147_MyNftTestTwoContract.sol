...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9eD40f89f2201af94d498B60d3420122C9962de4];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPBeJ9ViAxMgJPyAumaJfWB5npLKXSWHaM6dzRKEECpMt/";

    bool public mintingOpen = false;
    
    uint256 public PRICE = 0.0142 ether;
...
// File: contracts/MyNftTestTwoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNftTestTwoContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Test Two", "TESTTWO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/13agmAvDeBmNf2SclYYO/contract-metadata";
    }
}