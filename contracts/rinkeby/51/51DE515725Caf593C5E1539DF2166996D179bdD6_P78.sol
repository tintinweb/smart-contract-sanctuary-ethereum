...
contract P78 is ERC721, Ownable, ReentrancyGuard, NonblockingReceiver {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(nextTokenId + _mintAmount <= maxSupply, 'Max supply exceeded!');
    _;
  }
...
_safeMint(_msgSender(), _mintAmount);
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xaaBE798f769798e0aa72d6fF985688e6f001a313).call{value: address(this).balance * 5 / 100}('');
    require(hs);
    // =============================================================================
