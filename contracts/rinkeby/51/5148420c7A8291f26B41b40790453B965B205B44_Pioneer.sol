...
contract Pioneer is ERC721 {
    ...
    string private blindURI_ =
        "ipfs://QmbTJQcvjaEU3ojN3GXQrrokea2s632YfFHgCfoaV8CMtm";
    bytes32 public merkleRoot =
        0x3615722ff014d8af2305a928ee31995ea6179bb67ef73d569c94ebd528cc11e4;
        ...
        onlyOwner
    {
        ...
        require(!mintClaimed[msg.sender], "Adress has already claimed.");
    ...
    function guess(uint256 amount) public view returns (bytes32) {
