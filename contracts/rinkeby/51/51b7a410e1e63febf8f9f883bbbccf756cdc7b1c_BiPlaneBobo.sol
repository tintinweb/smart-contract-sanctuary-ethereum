...
contract BiPlaneBobo is ERC721A, Ownable {
    ...
    // Mint functionality ------------------------------------------------------------------------
    // Validates a signature of an address padded to 32 bytes with a byte suffix of 0x01
    ...
    // Validates a signature of an address padded to 32 bytes with a byte suffix of 0x02
