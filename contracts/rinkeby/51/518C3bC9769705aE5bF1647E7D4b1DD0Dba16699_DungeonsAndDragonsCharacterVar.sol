...
contract DungeonsAndDragonsCharacterVar is ERC721, VRFConsumerBase, Ownable {
    ...
    event strengthUpdated(uint256 tokenId, uint256 strength);
    ...
    function setStrength(uint256 tokenId, uint256 strength) public {
        ...
        override
    {
        ...
        uint256 strength = (randomNumber % divisor);
        uint256 dexterity = ((randomNumber % (divisor * 10**2)) / 10**2 );
        uint256 constitution = ((randomNumber % (divisor * 10**4)) / 10**4 );
        uint256 intelligence = ((randomNumber % (divisor * 10**6)) / 10**6 );
        uint256 wisdom = ((randomNumber % (divisor * 10**8)) / 10**8 );
        uint256 charisma = ((randomNumber % (divisor * 10**10)) / 10**10);
