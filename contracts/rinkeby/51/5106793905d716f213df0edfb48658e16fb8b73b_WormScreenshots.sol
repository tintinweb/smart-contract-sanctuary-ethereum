...
contract WormScreenshots is Ownable, ERC721 {
    string public baseURI = "https://api.luke.cat/metadata/";
    ...
    function setPublicMint(bool newPublicMintActive) public onlyOwner {
        publicMintActive = newPublicMintActive;
    }
