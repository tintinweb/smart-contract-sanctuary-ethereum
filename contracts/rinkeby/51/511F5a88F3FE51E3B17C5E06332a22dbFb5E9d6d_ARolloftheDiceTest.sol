...
contract ARolloftheDiceTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("A Roll of the Dice Test", "AROTDT") {
    setHiddenMetadataUri("ipfs://Qmc2YfFj9BiCjucBgJKfWMqSBDjxJfa7isABe8NfVStjHh.json");
  }
