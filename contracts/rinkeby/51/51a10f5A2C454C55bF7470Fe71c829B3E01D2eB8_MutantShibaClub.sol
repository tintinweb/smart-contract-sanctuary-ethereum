...
contract MutantShibaClub is ERC721A, Ownable {
    ...
    uint256 public preSalePrice = 0.01 ether; // CHANGE
    ...
    // ======== GNOSIS ========
    address public constant GNOSIS_SAFE = 0x4C6d071117D1783773186d49a318919A52514fBF; // Change to actual gnosis

    // ======== FOUNDERS & TEAM ========    
    address public constant TEAM = 0x59006543e004F1F4E936D9fc4B8d65a81dBD24Bd; // CHANGE TO ACUTAL
    address public constant FOUNDER_BERRY = 0x48aCF7d9C94d3910ebbaAfb36EEbBaC308F99498; // Change to actual
    address public constant FOUNDER_GABA = 0x6Ee578ff0BCB7c24F2b60eB9A0976E1e80aff55C; // Change to actual
    address public constant FOUNDER_LORDSLABS = 0x46008B91Ab0654F78DbEBd0F10456C1423d588D9; // Change to actual
    address public constant FOUNDER_CRAZYJUMP = 0x824A11D758AEb2898c0aA8cC671Db560febF3c38; // Change to actual


    // ======== CONSTRUCTOR ========      
    constructor() ERC721A("ALMOST", "MST") {} // CHANGE NAME 
    ...
    function publicSaleMint(uint256 _quantity) external payable callerIsUser {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "MAX SUPPLY REACHED" );
        require(publicSaleMinted[msg.sender] + _quantity <= maxCommunityMint, "EXCEEDS MAX MINTS PER ADDRESS"); 
    ...
    function teamMint(uint256 _quantity, bool _founders) external onlyOwner {
        require(totalSupply() + _quantity <= MAX_SUPPLY, "MAX SUPPLY REACHED" );
        if (_founders) {
            // ======== FOUNDER MINT ========      
    ...
    */
    ...
    /**
     * @notice check amount minted from address
     */
    ...
    /**
     * @notice withdraw funds to gnosis wallet
     */
