    ...
    ISuper1155
{
  ...
  */
    function configureGroup(
        ...
        if (!itemGroups[_groupId].initialized) {
            ...
            if (
                itemGroups[_groupId].supplyType == SupplyType.Capped
            ) {
                require(
                    _data.supplyType == SupplyType.Capped,
            ...
            if (
                ...
                require(
                    _data.itemType == ItemType.Nonfungible,
                ...
                require(
                    _data.itemType == ItemType.Semifungible,
                    "Super1155: you may not alter nonfungible items"
                );

                // A fungible item may change type if it is unique enough.
            } else if (
                itemGroups[_groupId].itemType == ItemType.Fungible
            ) {
  ...
  */
        ...
        returns (uint256)
    {
        ...
        if (itemGroups[groupId].itemType == ItemType.Nonfungible) {
            ...
            itemGroups[groupId].itemType == ItemType.Semifungible
        ) {
            require(
  ...
  */
  function lockURI(string calldata _uri) external hasValidPermit(UNIVERSAL, LOCK_URI) {
        uriLocked = true;
        metadataUri = _uri;
...
/**
  ...
  August 12th, 2021.
*/
interface ISuper1155 is IERC1155{
  ...
  */
  function metadataUri () external view returns (string memory);
   ...
   /// Collection URI for retrieving additional metadata and royalties.
  ...
  */
  ...
  /**
    ...
    @param _data The `ItemGroup` data input.
  */
  function configureGroup (uint256 _groupId, ItemGroupInput calldata _data) external;
  ...
  */
  ...
  /**
    ...
    @param _uri The value of the URI.
  */
