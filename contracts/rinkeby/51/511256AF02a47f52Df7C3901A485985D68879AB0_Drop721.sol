...
contract Drop721 is CoreDrop721 {
    ...
    constructor() CoreDrop721(
        NftOptions({
            name: "FuzzyHat Drop Test 2",
            symbol: "FUZZYHATDROPTEST2",
            imnotArtBps: 0,
            royaltyBps: 1000,
            startingTokenId: 1,
            maxInvocations: 750,
            contractUri: "https://gateway.pinata.cloud/ipfs/QmXNYxzCTYVtx72zDrubR4F1Q71apbCxm88jRnN7y6KyYp"
        }), 
        DropOptions({
            metadataBaseUri: "https://api-staging.imnotart.com/",
            mintPriceInWei: 0.05 ether,
            maxQuantityPerTransaction: 10, // @todo(developer): set the max quantity per transaction
            autoPayout: false,
            active: false,
            presaleMint: true,
            presaleActive: true,
...
contract CoreDrop721 is Ownable, ERC721, INA721Standard, INA721DropStandard, AdminFunctions, DropFunctions, PresaleFunctions, IRaribleRoyaltiesV2 {
    ...
    // @TODO(IOLSON): REMOVE THIS AS THIS IS ONLY FOR DEVELOPMENT
