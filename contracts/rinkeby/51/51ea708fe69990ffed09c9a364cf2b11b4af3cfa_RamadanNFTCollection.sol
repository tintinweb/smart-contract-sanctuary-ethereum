...
contract RamadanNFTCollection is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ramadan NFT Collection", "RNFTC") {
    setHiddenMetadataUri("ipfs://QmSBkeN7ertGRtHfvGeYiePXB39PafE7LyF8fpzbQb29TJ/metadata/hidden.json");
  }
