 ...
 */
contract XillionIDOFactory is OwnablePausable {
     ...
     */ 
    // mapping(address => bool) moderatorToStatus;
     ...
     * @param votingFactoryAddress_ Address of votingFactory
     */
    constructor(address ownerAddr_, address masterIDOAddress_, uint256 xilToChainCurrencyAllocationSizeRatio_, 
    uint256 busdToChainCurrencyAllocationSizeRatio_, 
    address votingFactoryAddress_) {
        ...
        // votingFactoryAddress = votingFactoryAddress_;
    ...
    //     return moderatorToStatus[msg.sender];
    // }
...
contract XillionIDO is XillionIDOCommon {
     ...
     */
    function setPoolTokenSharePercentages(XillionIDOStructs.PoolTokenSharePercentage memory poolTokenSharePercentages_) public onlyModerator {
     ...
     */
    function setWalletAddresses(XillionIDOStructs.WalletAddress memory walletAddresses_) public onlyModerator {
     ...
     */
    function confirmIdo(IDOState idoState_) public onlyModerator {
     ...
     */ 
    function createVotingForIDO(uint256 targetVotes_, uint256 minVotingValue_, uint256 votingDuration_) public onlyModerator {
