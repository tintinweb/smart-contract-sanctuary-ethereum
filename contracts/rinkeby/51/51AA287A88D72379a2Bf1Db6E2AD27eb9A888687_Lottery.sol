...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
		...
		)
	{
		...
		bool hasPlayers = ticketHolders.length > 0;
	...
	function performUpkeep(
		...
		uint256 requestId = vrfCoordinator.requestRandomWords(keyHash, subId, REQUEST_CONFIRMATIONS, callbackGasLimit, NUM_WORDS);
	...
	function getTicketHolder(uint256 _index) public view returns (address) {
		return ticketHolders[_index];
	}
