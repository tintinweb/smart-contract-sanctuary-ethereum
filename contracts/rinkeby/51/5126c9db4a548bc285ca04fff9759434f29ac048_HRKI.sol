...
contract HRKI is ERC721A, Ownable {
    ...
    uint8 private constant _mintLimitPerWallet = 2;
    ...
    constructor() ERC721A("HRKI", "HRKI") {
        _mintERC2309(msg.sender,50);
        _mintERC2309(0x571C18e700cfed4FA1BE6e179770e643987475E0,50);
    }
    ...
    function viewPrice() external pure returns (uint256) {
        return 0;
    }

    function viewPerWalletLimit() external pure returns (uint8) {
        return _mintLimitPerWallet;
    }

    function viewPersalePerWalletLimit() external pure returns (uint8) {
        return 1;
    }
    ...
    function mint() external callerIsUser {
        ...
        if (_numberMinted(msg.sender) + 1 > _mintLimitPerWallet)
    ...
    function togglePublichSaleActive() external onlyOwner {
