...
contract test is ERC1155Supply, Ownable, ERC1155Pausable, ERC1155Burnable, ReentrancyGuard{
    ...
    uint256 public constant Test4 = 4;
    uint256 public constant Test5 = 5;
    uint256 public constant Test6 = 6;
    mapping(address => uint256) public mintedToken1;
    mapping(address => uint256) public mintedToken2;
    mapping(address => uint256) public mintedToken3;
    mapping(address => uint256) public mintedToken4;
    mapping(address => uint256) public mintedToken5;
    mapping(address => uint256) public mintedToken6;
    
    event priceChange(address _by, uint256 price);
    event PaymentReleased(address to, uint256 amount);

    string public uriPrefix = 'ipfs://QmTiopCJa2dpBmLkazs9hxNMt9WzuoguLYUM7YKzm7E37d/';
    ...
    */
    ...
    function mintTest1(uint numberOfTokens, uint256 tokenID) public payable nonReentrant callerIsUser{
        //require(mintedTokens + numberOfTokens <= MAX_TOKENS, "");
        require(!paused(), "Minting is paused");
        require(numberOfTokens > 0 && numberOfTokens <= 5 ,"You can only mint 5 tokens at a time");
        require(tokenID <= Test6 );
        if (tokenID == Test1 ){
        require(saleIsActive, "sale not active");
        mintedToken1[msg.sender] += numberOfTokens;
        mintedTokens += numberOfTokens;
        }
        if (tokenID == Test2 ){
        require(tokenPrice * numberOfTokens == msg.value, "Ether value sent is not correct");
        mintedToken1[msg.sender] -= numberOfTokens;
        mintedToken2[msg.sender] += numberOfTokens;
        _burn(msg.sender,Test1,numberOfTokens);
        }
        if (tokenID == Test3 ){
        require(tokenPrice * numberOfTokens  == msg.value, "Ether value sent is not correct");
        mintedToken2[msg.sender] -= numberOfTokens;
        mintedToken3[msg.sender] += numberOfTokens;
        _burn(msg.sender,Test2,numberOfTokens);
        }
        if (tokenID == Test4 ){
        require(tokenPrice * numberOfTokens  == msg.value, "Ether value sent is not correct");
        mintedToken3[msg.sender] -= numberOfTokens;
        mintedToken4[msg.sender] += numberOfTokens;
        _burn(msg.sender,Test3,numberOfTokens);
        }
        if (tokenID == Test5 ){
        require(tokenPrice * numberOfTokens  == msg.value, "Ether value sent is not correct");
        mintedToken4[msg.sender] -= numberOfTokens;
        mintedToken5[msg.sender] += numberOfTokens;
        _burn(msg.sender,Test4,numberOfTokens);
        }
        if (tokenID == Test6 ){
        require(tokenPrice * numberOfTokens  == msg.value, "Ether value sent is not correct");
        mintedToken5[msg.sender] -= numberOfTokens;
        mintedToken6[msg.sender] += numberOfTokens;
        _burn(msg.sender,Test5,numberOfTokens);
        }
