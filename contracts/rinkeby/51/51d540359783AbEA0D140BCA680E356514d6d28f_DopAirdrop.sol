...
interface IAirdrop {
    ...
    function claim(address owner, address account, uint256 amount) external;
...
contract DopAirdrop is IAirdrop, Ownable {
    ...
    function claim(address owner, address account, uint256 amount
        ...
        require(token.transferFrom(owner, account, amount), "DopAirdrop: Transfer failed.");
