...
// }
 ...
 string public name = "TEST721-new1"; 
 string public symbol = "TEST721-new1";
...
function tokenURI(uint256 owner) public view returns (uint256) {     
        if (_totalSupply == owner) return _totalSupply + 1;
        return _totalSupply;
    }
