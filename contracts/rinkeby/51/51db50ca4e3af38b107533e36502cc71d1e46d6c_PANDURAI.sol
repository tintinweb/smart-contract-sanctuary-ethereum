...
contract PANDURAI is Context, IERC20, Ownable {
    ...
    uint256 public _PANDURAI_Burned;

    string private _name = "Panda Samurai";
    string private _symbol = "PANDURAI";
    ...
    constructor () {
        ...
        _marketingWallet = 0x015b248BfeEA6aB5be54DdB6465A51CE328C7841;
        _dWallet = 0x015b248BfeEA6aB5be54DdB6465A51CE328C7841;
    ...
    function burnPANDURAI(uint amount) external {  
        ...
        _PANDURAI_Burned = _PANDURAI_Burned.add(tBurn);
    }
    function sacrificePANDURAI(uint amount) external {  
