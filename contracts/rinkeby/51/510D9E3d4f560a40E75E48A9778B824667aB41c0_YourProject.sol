...
contract YourProject is ERC721A, Ownable {
    ...
    constructor() ERC721A("Your Project", "ABC") {
        _safeMint(msg.sender, 10);
        setUriPrefix("ipfs://yourprojectWITHTHEFORWARDSLASH/");
    }
    ...
    function createPhabcs(uint256 count) external payable {
        uint256 cost = price;
