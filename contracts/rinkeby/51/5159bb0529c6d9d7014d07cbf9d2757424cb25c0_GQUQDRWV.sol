...
contract GQUQDRWV is ERC721ABurnable, Ownable, Pausable {
    ...
    constructor() ERC721A("GQUQDRWV", "GQUQDRWV") {
        _pause();
    }
    ...
    function mint(uint256 _quantity) external whenNotPaused {
        ...
        require(_numberMinted(msg.sender) + _quantity <= maxPerWallet, "INCORRECT_QUANTITY");
