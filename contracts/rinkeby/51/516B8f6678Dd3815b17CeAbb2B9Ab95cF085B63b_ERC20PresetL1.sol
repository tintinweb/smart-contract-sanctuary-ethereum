...
// File contracts/utils/rollup/RollupTypes.sol
...
// File contracts/utils/rollup/Settleable.sol
...
// File contracts/token/ERC20Settleable.sol
...
abstract contract ERC20Settleable is Settleable, AccessControl, ERC20 {
    ...
    {
        require(
            destResourceAddress == address(this),
            "invalid dest resource address"
        );
...
// File contracts/token/presets/ERC20PresetL1.sol

// : LGPL-3.0-only
pragma solidity ^0.8.0;


contract ERC20PresetL1 is ERC20Settleable, ERC20PresetMinterPauser {
    constructor(
        address bridgeAddress,
        string memory name,
        string memory symbol
    ) ERC20Settleable(bridgeAddress) ERC20PresetMinterPauser(name, symbol) {}
