...
contract Contract is ERC721Delegated, ReentrancyGuard {
  ...
  uint256 public constant MAX_MULTIMINT = 22;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 22 at a time");
  ...
  function tokenURI(uint256 tokenId) public view returns (string memory) {
    return string(abi.encodePacked(_tokenURI(tokenId), "8"));
  }
}
