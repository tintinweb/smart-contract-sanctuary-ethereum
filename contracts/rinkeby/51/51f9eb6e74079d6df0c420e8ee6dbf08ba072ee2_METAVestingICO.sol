...
function buy() public payable icoShouldBeStarted icoShouldnotBeEnded {
        ...
        // vesting.intermediateToBeClaimed += (intermediateAmountReleased[vesting.investorType] * __amount)/ 1000;
...
//vesting.intermediateToBeClaimed = (intermediateAmountReleased[vest[i].investorType] * _amount)/ 1000;
    ...
    function withdraw() external{
        ...
        if (initialAmountReleased[Investors[msg.sender].investorType] == 0 )
                 {
        ...
        else if (initialAmountReleased[Investors[msg.sender].investorType] == 0 && Investors[msg.sender].linearClaimed == 0 )
                {
    ...
    //     uint timeDifference;
    //    //uint[5] memory intermediateArray =[0,0,0,0,0];
    //     uint[5] memory intermediateArray = [0,globalStartTime + 0 minutes,globalStartTime + 0 minutes,globalStartTime + 0 minutes,globalStartTime + 0 minutes];// give Intermediate time
