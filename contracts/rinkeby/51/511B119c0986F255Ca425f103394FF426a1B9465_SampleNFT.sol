...
contract SampleNFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Sample NFT", "SAM") { }
    ...
    function Mint(uint256 tokenID, string memory tokenURI) public returns (uint256) {
        ...
        require(_exists(tokenID) == false, "Sample NFT: already exist");
        // mint new tokens
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal {
        require(_exists(tokenId) == true, "Storm of art: can't set token URI for non-exist token");
