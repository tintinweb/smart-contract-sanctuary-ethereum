...
contract AlienPunkCommunity is Ownable, ERC721Enumerable {

    DROOL private immutable drool;
    uint256 collectionSize = 0;
    string public baseURI = "";
    uint256 price = 500 ether;

    constructor(address _drool)
        ERC721("Alien Punk Community", "APC") {
        drool = DROOL(_drool);
    }
    ...
    function mint(uint quantity) external {
        ...
        require(totalSupply + quantity <= collectionSize, "Exceeds available supply");
