...
contract PresaleIDO is AccessControl, ReentrancyGuard {
    ...
    uint256 public immutable Price; // Price of one Crepe token in USDC
    ...
    function claimToken() external {
        ...
        uint256 share = (Users[msg.sender] / Price / 2) * 10**18;  
        Users[msg.sender] = 0;
    ...
    function finishCampaign(address _recipient) external {
        ...
        actualCrepeRemaining = (TotalCrepe * (Goal - TotalAccumulated)) / Goal + (TotalCrepe / 2);
