  ...
  IERC721Enumerable
{
   ...
   *
   * Tokens can be managed by th  eir owner or approved accounts via {approve} or {setApprovalForAll}.
   *
...
contract Web3TigersNFT is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.0029 ether;
    uint256 public MAX_SUPPLY = 1444;
    uint256 public MAX_MINTS = 100;
    string public baseURI = "https://filedn.eu/l9DcJX8i7vtpxhvDFTHqIOm/json/";
    string public baseExtension = ".json";
    bool public paused = false;
    
    constructor() ERC721A("Web 3 Tigers ", "Wb3N", MAX_MINTS, MAX_SUPPLY) {  
    }
