...
// @author Alexis Jbrt https://www.linkedin.com/in/alexis-jobart-9340a516b/details/experience/
...
contract SmileyWeb3ERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_PUBLIC = 650;
    ...
    uint public saleStartTime = 1653084003;
    ...
    //Constructor
    constructor(bytes32 _merkleRoot, string memory _baseURI) ERC721A("SmileyWeb3", "SW") PaymentSplitter(_team, _teamShare) {
    ...
    */
    ...
    /**
    * @notice Mint function for the Whitlist Sale
    *
    * @param _account Account wich will receive the NFT
    ...
    *
    * @param _account Account wich will receive the NFTs
    * @param _quantity Amount of NFTs the user wants to mint
    */
    ...
    * @param _quantity the amount of NFTs the owner wants to gift
    */
    function gift(address _to, uint _quantity) external payable onlyOwner {
    ...
    */
    function tokenURI(uint _tokenId) public view virtual override returns(string memory) {
        require(_exists(_tokenId), "URI qurery for nonexistent token");
    ...
    *
    * @param _isPaused true or false if we want to pause or unapuse the contract
    */
    ...
    */
    ...
    /**
    *
    * @notice Returns true if a leaf can be proved to be part of a Merkle tree defined by root
    *
    ...
    */
    ...
    /**
    *
    * @notice Check if an address is xhitelisted or not
    *
