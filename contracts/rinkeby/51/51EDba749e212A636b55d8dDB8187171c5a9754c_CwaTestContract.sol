...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656216000;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8eC508DEcA23Dc4BBfeDB566bAC09bf9Cef95C61];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 5;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 10) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaUfidCvmQYkz193nGQxi2XZC3DRqSmQj5oKmL9rGZRqu/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 10");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 10");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 10");
...
// File: contracts/CwaTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CwaTestContract is RamppERC721A {
    constructor() RamppERC721A("CWA Test", "CWATest"){}
}
