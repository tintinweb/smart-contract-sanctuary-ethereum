...
contract RektCollective is ERC721A, EIP712, Ownable{
    ...
    uint public DegenCharityLimit = 1;
    ...
    require(addressToFreeMinted[msg.sender] < DegenCharityLimit, "Already minted for free, wait for public sale.");
    ...
    function RugPullButton() external payable onlyOwner {
