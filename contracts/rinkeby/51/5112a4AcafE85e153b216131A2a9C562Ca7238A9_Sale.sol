...
contract Sale is Ownable, Whitelisted {
    ...
    mapping(address => mapping(uint256 => uint256)) private _allowListBuys;
    ...
    */
    ...
    function withdraw() external onlyOwner {
        ...
        sendToMarketing(payment);
        
        payment = address(this).balance / 4;
        require(payment > 0, "Empty balance");
    ...
    */
    ...
    onlyWhitelisted(msg.sender, address(this), proof) {
        ...
        require(numberOfTokens + _allowListBuys[user][tribeId] < maxPresaleMintsPerWallet + 1, "Exceeded max available to purchase");
        ...
        _allowListBuys[user][tribeId] += numberOfTokens;
    ...
    payable {
        ...
        require(numberOfTokens < maxMintsPerTxn + 1, "Exceeded max available to purchase");
        require(getSalesCounter() + numberOfTokens < maxSales + 1, "Purchase would exceed max tokens");
        require(msg.value > buyAmount - 1, "Ether value sent is not correct");
