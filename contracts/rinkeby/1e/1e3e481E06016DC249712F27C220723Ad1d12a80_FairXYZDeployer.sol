...
contract FairXYZDeployer is ERC721xyz, Pausable, Ownable{
        ...
        external onlyOwner
    {
        ...
        if(newRoyaltyValue != _secondaryRoyaltyValue || _secondaryRoyaltyReceiver != newSecondaryRoyaltyReceiver)
            _setDefaultRoyalty(_secondaryRoyaltyReceiver, _secondaryRoyaltyValue);
    }
        ...
        external
    {
        ...
        if(newRoyaltyPercentage!=_secondaryRoyaltyValue)
        {
            ...
            _setDefaultRoyalty(_secondaryRoyaltyReceiver, newRoyaltyPercentage);
