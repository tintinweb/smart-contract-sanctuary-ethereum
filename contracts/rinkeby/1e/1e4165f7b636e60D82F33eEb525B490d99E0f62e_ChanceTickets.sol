...
contract ChanceTickets is Ownable, ERC1155Pausable {
    ...
    function purchaseTicket(TicketOption _option, uint32 _quantity)
        public
        payable
        whenNotPaused
    {
        _purcahseTicketTo(msg.sender, _option, _quantity);
    }

    function _purcahseTicketTo(
        address _to,
        TicketOption _option,
        uint32 _quantity
        ...
        if (_option == TicketOption.Five) {
            tokenPrice = 0.3 ether;
        } else if (_option == TicketOption.Ten) {
