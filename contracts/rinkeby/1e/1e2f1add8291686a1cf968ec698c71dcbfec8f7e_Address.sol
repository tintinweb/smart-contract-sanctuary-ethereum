...
/*
 ...
 / / / / __ \/ / / / / /_/ / __ `/ ___/ ___/                                         
/ /_/ / / / / / /_/ / ____/ /_/ (__  |__  )                                          
\____/_/ /_/_/\__, /_/    \__,_/____/____/                                           
   __  __    /____/    _                                          ____           __  
  / /_/ /_  (_)____   (_)____   ____ _____  ____  ____  ____ _   / __/_  _______/ /__
 / __/ __ \/ / ___/  / / ___/  / __ `/ __ \/ __ \/ __ \/ __ `/  / /_/ / / / ___/ //_/
/ /_/ / / / (__  )  / (__  )  / /_/ / /_/ / / / / / / / /_/ /  / __/ /_/ / /__/ ,<   
\__/_/ /_/_/____/  /_/____/   \__, /\____/_/ /_/_/ /_/\__,_/  /_/  \__,_/\___/_/|_|  
                             /____/                                                  
...
contract OnlyPass is ERC721A, Ownable {
    ...
    address private constant TEAM_ADDRESS = 0x102A018Ce5D5a4Ce0E4Da034de3E26F73CB9C866;
    ...
    constructor() ERC721A("OnlyPass", "OP") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURI = _baseURI();
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, tokenId.toString(), "https://arweave.net/JaGfTbB9NI04ypVYI3Iwdc-rI19IB1AYBrKn7UBjIiU/")) : '';
    }
