...
contract Test{
    ...
    function uniswapTestingTokenforTokens(uint256 price, uint256 price2,address[] calldata path) external returns(uint256){
    ...
    function uniswapTestingTokensforEth(uint256 price, uint256 price2, address[] calldata path) external returns(uint256){
