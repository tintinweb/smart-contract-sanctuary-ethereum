...
contract TestSevenTwentyOneA is Ownable, ERC721A, ReentrancyGuard {
    uint256 private _earlyMintCost = 6900000000000000;
    uint256 private _mintCost = 10000000000000000;
    ...
    constructor(
        ...
        ) ERC721A("SevenTwentyOneATest", "SevenTwentyOneATest") {
    ...
    function setEarlyMintCost(uint256 cost) external onlyOwner {
        _earlyMintCost = cost;
    }
