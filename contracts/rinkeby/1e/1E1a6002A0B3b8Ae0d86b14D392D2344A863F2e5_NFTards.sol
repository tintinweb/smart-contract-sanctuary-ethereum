...
contract NFTards is ERC721A, Ownable, ReentrancyGuard {
  ...
  // public
    ...
    require(tokens > 0, "YOU NEED AT LEAST 1 NFTard");
    require(tokens <= maxpertx, "THE MAX IS 5 FOR A REASON, NFTard");
    require(supply + tokens <= freesupply, "TIME TO DEGEN ON SECONDARY");
    require(_numberMinted(_msgSender()) + tokens <= MaxperWallet, "YOU'RE TRYING OT MINT MORE THAN YOU'RE ALLOWED, MAX IS 5 NFTard");
