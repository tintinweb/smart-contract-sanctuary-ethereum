...
//Pool functionality in which user can deposit withdraw tokens and can also add members and remove it
//at a time more than 0 and less than 1 lakh tokens can be deposit
...
//Used to deposit amount and add new sender
    ...
    //It deposit the rewards to the users
    function depositRewards() public payable onlyRole(TEAM_MEMBER_ROLE) {
        // No rewards to distribute if the pool is empty.
        //supply should be greater than 0 and less than 1 lakh
        require((total > 0 && total<100000)); 
