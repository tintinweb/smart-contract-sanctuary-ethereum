...
contract GanjaGrow is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public notRevealedUri = 'ipfs://QmaZs1q3C11nqztVP7qVmMWrhF4KTtQQZ8roLYzM1HsJr6';
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(balanceOf(msg.sender) == 0, "Only 6 mint per account");
