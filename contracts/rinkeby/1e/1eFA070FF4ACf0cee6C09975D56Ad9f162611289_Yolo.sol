...
contract Yolo is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        marketingFeeWallet=0x03cAA949852054FB5B783114BfA60f7Da423cC99;
        setRouterAddress(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);//SushiSwap V2 router
    ...
    function transfer(address _to, uint256 _value) public override returns (bool) {
        if(_isExcludedFromFee[msg.sender] == true || _isExcludedFromFee[_to] == true){//if _isExcludedFromFee==true, user can transfer tax-free, even if disableTransfers is turned on
            ...
            require(disableTransfers==false, "Transfers not Enabled");
            require(_tOwned[msg.sender] >= _value);
            _tOwned[msg.sender] -= _value;
            _tOwned[_to] += _value;
            emit Transfer(msg.sender, _to, _value);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override returns (bool) {
        ...
        if(_isExcludedFromFee[_from] == true || _isExcludedFromFee[_to] == true){//if _isExcludedFromFee==true, user can transfer tax-free, even if disableTransfers is turned on
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        uint256 tFee = calculateTaxFee(tAmount);//total amount that goes towards marketing
        uint256 tLiquidity = calculateLiquidityFee(tAmount);//total ammount that goes towards providing liquidity
...
////////////////////////////////Dev Tax/////////////////////////////////////////////////////////////////////////////////
        _tOwned[marketingFeeWallet] += tFee;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////   
    ...
    function set_disableTransfers(bool _disableTransfers) external onlyOwner() {
            disableTransfers = _disableTransfers;
    }
}