...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/antiWhaleContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AntiWhaleContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Anti-Whale", "MOBY", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/azwvRc2S3sWk8O56QJZz/contract-metadata";
        }
    }