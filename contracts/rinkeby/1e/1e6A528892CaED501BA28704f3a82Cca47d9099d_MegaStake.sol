...
contract MegaStake is ERC20, AccessControl,ERC20Capped{  
   ...
   uint256 maxReward;
   uint256 TimeInterval = 5 seconds;
   uint256 _rewards;
   uint256 ClaimedRewards;
  uint256 _StakeTimeUpdated;
  uint256 _TimeUpdated;
  uint256 _StakeTimeNow;
    ...
    {   
        ...
        _mint(_Owner,_InitialSupply);
                            ...
                            { 
                                ...
                                _StakeTimeUpdated = _StakeTime[msg.sender];
                            ...
                            _StakeTimeNow = _StakeTime[msg.sender];
                        ...
                        require(block.timestamp >= _StakeTime[msg.sender] + TimeInterval ,"Time is not yet been completed");
                            _StakeTime[msg.sender] = block.timestamp ;
                            _Reward[msg.sender] += _StakeBalance[msg.sender] * 3/100;
                       
                        require(block.timestamp >= _StakeTimeUpdated + TimeInterval ,"Time is not yet been completed");
