...
contract mwmtest is ERC721A, Ownable {
    ...
    mapping(address => uint256) private publicSaleRedeemedCount;
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(
            publicSaleRedeemedCount[_msgSender()] + quantity <= maxMintPerWallet,"Exceed Public Sale Mint Limit");

        publicSaleRedeemedCount[_msgSender()] = publicSaleRedeemedCount[_msgSender()] + quantity;
