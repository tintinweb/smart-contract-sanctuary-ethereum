...
//    / | / /___ _____  ____ ___  (_)  / __ \/   | / __ \
//   /  |/ / __ `/ __ \/ __ `__ \/ /  / / / / /| |/ / / /
//  / /|  / /_/ / /_/ / / / / / / /  / /_/ / ___ / /_/ / 
// /_/ |_/\__,_/\____/_/ /_/ /_/_/  /_____/_/  |_\____/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x14379B525aF7597c93cAb35e0ce49D121aEAd411];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXoN7tuVRyySGUqeephDB1hWGauZ25gKwDsjE5SC4ULzr/";
...
// File: contracts/NaomiDaoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NaomiDaoContract is RamppERC721A {
    constructor() RamppERC721A("Naomi DAO", "NAOMI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/786P5Q2AKj3Lt0MFZOEc/contract-metadata";
    }
}
