...
contract GameToken is ERC20, Ownable {
   ...
   function TransferFromTokenHolder(IERC20 token, uint256 amount) public {
    ...
    function preSale(uint256 numberOftoken) external payable {
        require(presaleIsActive == true, "preSale is not active");
        require(msg.value >= numberOftoken * price, "Value sent is not correct");
        uint256 amountTransfer = numberOftoken * 10 ** 18;
