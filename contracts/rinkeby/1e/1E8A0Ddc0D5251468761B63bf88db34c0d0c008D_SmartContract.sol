...
/**
https://rinkeby.etherscan.io/address/0xEfFB334c3314B1C0c0CB180E20f81a83D07C276d#readContract
https://rinkeby.etherscan.io/address/0x8C0883F497321363d7bEa85F0E1cf6bd1253e9a5#readContract
2% auto liquidity 2% autoburn 2% auto reward 2 plus 6% dev
https://rinkeby.etherscan.io/address/0x99cAB70097EaD8C57634B2577cc6f5218d4e781C

https://rinkeby.etherscan.io/address/0x452b5A965212C70e3f0C3aD3CAaaCaF1CB46D705#writeContract


<=
https://rinkeby.etherscan.io/token/0x67b2918602f04651E6F80834d03F600D02A3615C#code
*/
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "new0";
    ...
    function triggerRewardsDistribution() public  returns(address[] memory,uint256 computedShareToken, uint256 totalRewardFromWallet){
        //distribute tokens
        ...
        if(_tOwned[rewardWallet] >= rewardWalletMaxToken){
            ...
            shareToken = _tOwned[rewardWallet]/countQualifiedAddress;
             for(uint j=0;j<finalQualifiedAddresses.length;j++){
                ...
                //else if(j == finalQualifiedAddresses.length){
