    ...
    VRFConsumerBase
{
    ...
    string public constant PROVENANCE =
        "fa0a30c08c8a6f63e7321c10500edade6ae4f4637551c26a4f664d8b4d6053af";
    ...
    function onERC1155Received(
        ...
        require(
            value <= maxSupply - _tokenIdCounter.current(),
            "Cannot buy that many"
        );
    ...
    function randomTokenId() internal returns (uint256) {
        uint256 remaining = maxSupply - _tokenIdCounter.current();
