...
contract PoochesClub is ERC721A, MerkleDistributor, ReentrancyGuard, AccessControl {
    ...
    constructor(address payable shareholderAddress_) ERC721A("Pooches Club", "POOCH") {
