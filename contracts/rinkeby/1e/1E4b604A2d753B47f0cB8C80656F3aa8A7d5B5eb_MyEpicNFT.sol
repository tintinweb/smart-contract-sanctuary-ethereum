...
contract MyEpicNFT  is ERC721URIStorage {
    ...
    string[] firstWords = ["funny", "big", "wooly", "happy", "flying", "lively", "wibbly", "ping", "super", "rocky", "wide", "tall", "short", "jolly", "rough"];
    string[] secondWords = ["fat", "ugly", "round", "little", "pasta", "square", "wobbly", "pong", "green", "long", "swaying", "slippery", "smiley", "pleasant", "smooth"];
    string[] thirdWords = ["cat", "hat", "jumper", "radio", "monster", "peg", "willy", "pang", "guitar", "icecream", "piano", "bicycle", "chap", "bottle", "mug"];
    ...
    constructor() ERC721 ("SquareNFT", "SQUARE") {
        console.log("Thank you. Most constructive");
    }
