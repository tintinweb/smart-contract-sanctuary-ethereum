  ...
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "LooksRareSingleAssetStrategyLiquidate::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    require(
      ...
      "LooksRareSingleAssetStrategyLiquidate::execute:: insufficient baseToken amount received"
    );
