...
contract ExampleFoo is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    ...
    constructor() ERC721A("Example Foo", "EXF") EIP712("Example Foo", "1.0.0") {
    }
    ...
    function _hash(address account) private view returns (bytes32) {
        return _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("Example Foo(address account)"),
                    account
                )
            )
        );
