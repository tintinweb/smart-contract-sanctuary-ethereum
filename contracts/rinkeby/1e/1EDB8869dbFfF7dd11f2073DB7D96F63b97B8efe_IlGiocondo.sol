...
contract IlGiocondo is Ownable,ERC721,ERC721Enumerable {
    ...
    function contractURI() public view returns (string memory) {
        ...
        Base64.encode(
            ...
            abi.encodePacked(
                '{"name":"',
                "Il Giocondo",
                '", "description":"The funniest NFT collection in the world", "external_link": "https://ilgiocondo.com", "image":"ipfs://QmTidhb59WymmQXgpUD2v2Jh2dYEWNCiRvWLoEBwofzbxu/3.png"}'
            )
            )
        )
        )
