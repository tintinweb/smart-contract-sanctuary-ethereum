...
contract NftMarketplace is ReentrancyGuard {
    ...
    modifier NotListed(address nftAddress, uint256 tokenId) {
        require(
            // `address(0)` is the address of the zero account (null address)
    ...
    function listItem(
        ...
        require(
            ...
            "Only the owner can list the item for sale!"
        );
    ...
    function buyItem(address nftAddress, uint256 tokenId)
        external
        payable
        nonReentrant // Prevents reentrancy attacks - from OpenZeppelin
    {
        Listing memory listing = s_listings[nftAddress][tokenId];

        require(listing.seller != address(0), "Item is not listed!");
        require(msg.value == listing.price, "Price is incorrect!");
        ...
        s_earnings[listing.seller] += msg.value;
    ...
    function updateListing(
        ...
        require(listing.seller != address(0), "Item is not listed!");
        require(listing.seller == msg.sender, "Only the seller can update!");
    ...
    function withdrawEarnings() external payable nonReentrant {
...
// Always change state before calling any external functions
