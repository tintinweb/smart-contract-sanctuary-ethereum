...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmP8NSLwMeEiRK9vHrWSaQWonU7FYbr2ePLszmiW8i8fcs/";
...
// File: contracts/UghContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UghContract is RamppERC721A {
    constructor() RamppERC721A("ugh", "UGH"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9JVLPdxfe1IklIar5SAg/contract-metadata";
    }
}
