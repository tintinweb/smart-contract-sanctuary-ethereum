    ...
    ILiqdRentalWallet
{
    ...
    ) external onlyOwner nonReentrant returns (bytes memory _result) {
        // todo: we need to check the call data if it's secure or not.
        // or further, we can integrate our rental wallet with safe external nft staking protocols to get some yields.
    }
