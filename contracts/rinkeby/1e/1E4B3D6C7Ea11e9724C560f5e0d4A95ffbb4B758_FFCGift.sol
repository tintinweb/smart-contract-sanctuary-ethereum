...
contract FFCGift is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Funky Faces Club Gift", "FFCG") {
    setHiddenMetadataUri("ipfs://QmY9rTRYhV2P76mAuQq4mZTWCWMPqXDJuWqr32PQ1HZGKW/hidden.json");
  }
