...
contract PoolyClub is ERC721, Ownable {
  ...
  function _getTierDescription(uint8 _tier) internal view returns (string memory) {
    if (_tier == 1 || _tier == 2)
      return
        "Pooly's is a special hangout for the OG Pooly supporters. Animation by Chuck Bergeron @chuckbergeron. 3d Pooly by @d_v_dsm. Original Pooly concept by @IrrelephantOops. [This original supporter won a random draw to have their Club Pooly upgraded to a higher rarity rank. Randomness pick screen recording here: ipfs://bafybeig4sktmwuci2a47uomgd2zuz6wgrry2kz7gx7ru24jfc4au2irovu]`";
    return
      "Pooly's is a special hangout for the OG Pooly supporters. Animation by Chuck Bergeron @chuckbergeron. 3d Pooly by @d_v_dsm. Original Pooly concept by @IrrelephantOops.";
  }
