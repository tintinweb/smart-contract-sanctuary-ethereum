...
contract ArcBlock {
    ...
    function renderImageById(uint256 id) public view returns (bytes memory) {
        string memory tokenId = toString(id);
        return render(tokenId);
    }

    function render(string memory tokenId) internal view returns (bytes memory) {
