...
contract EQLZ is ERC721r, ERC721rEnumerable, Ownable {     
    ...
    constructor(string memory name_, string memory symbol_, uint maxSupply_, address _client) ERC721r(name_, symbol_, maxSupply_) {
        client = _client;
    }
    ...
    function updateClient(address _client) external onlyOwner {
        client = _client;
    }
