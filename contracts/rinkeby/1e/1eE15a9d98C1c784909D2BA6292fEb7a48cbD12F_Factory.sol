...
import "./RareNFTUser721Token.sol";
...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new RareNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        RareNFTUser721Token token = RareNFTUser721Token(address(addr));
...
contract RareNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
