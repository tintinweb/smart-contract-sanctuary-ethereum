...
// File: contracts/CoolBestDigitalWords.sol
...
contract CoolBestDigitalWords is ERC721Enumerable, Ownable {
  using Strings for uint256;
  
  string[] public wordsValues = ["abounding","ample","bounteous","bountiful","copious","crawling with","cup runs over with","eco-rich","exuberant","filled","full","generous","heavy","lavish","liberal","lousy with","luxuriant","mucho","no end of","overflowing","plate is full of","plenteous","plenty","profuse","rich","rolling in","stinking with","sufficient","teeming"];
  ...
  constructor() ERC721("CoolBestDigitalWords", "CBDW") {}
