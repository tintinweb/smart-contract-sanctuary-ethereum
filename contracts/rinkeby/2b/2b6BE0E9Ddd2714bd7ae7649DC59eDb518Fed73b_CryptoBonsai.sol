...
contract CryptoBonsai is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[5] private potAccessoriesNames = ['','WAGMI Light','Wavey Orange','Borgor'];
    ...
    // // Inspired by OraclizeAPI's implementation and OCCFlowers - MIT license
