        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '<rect width="100%" height="100%" fill="#AA00FF" />',
                    '<foreignObject x="10" y="10" width="280" height="280">',
                    '<div xmlns="http://www.w3.org/1999/xhtml" style="display: flex;justify-content: center;align-items: center;font-size:x-large">',
                    "<p>Love and Peace</p>",
