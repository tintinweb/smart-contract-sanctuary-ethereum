...
contract CryptoGotchiNFT is ERC721Tradeable {
    ...
    bytes32 public root =
        0x0fa7fed96f3ad9cfe21824296091834ab90224c3720d9979a722971d07ecab34;
    ...
    function mintWhitelist(
        ...
        require(amount <= 20, "Can only mint 20 JesusCrypt at a time!");
    ...
    function mint(uint256 amount) internal {
        ...
        require(amount <= 20, "Can only mint 20 at a time!");
        require(
            supply + amount < maxSupply - reserved,
            "Mint will exceeded supply!"
        );
        require(msg.value >= priceToMint * amount, "Insufficient ETH sent!");

        if (whitelistActive) {
            uint256 nftInWallet = walletOfOwner(msg.sender).length;
            if (nftInWallet >= 20) {
                revert("Only 20 tokens in whitelist allowed");
            }
        }
