...
contract PLNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_RESERVE_TOKENS = 50;
    uint256 public constant MAX_TOKENS_PER_WALLET = 7; 
    
    uint256 public constant ROYALTY_PERCENTAGE = 5;
    // ================================================

    constructor(address _royaltyReceiverAddress)
        ERC721("Polywick NFT", "PLNFT")
    {
