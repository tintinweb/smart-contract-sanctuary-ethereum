...
// ____   _               _      ____         _        _         
//| __ ) | |  ___    ___ | | __ | __ )  _ __ (_)  ___ | | __ ___ 
//|  _ \ | | / _ \  / __|| |/ / |  _ \ | '__|| | / __|| |/ // __|
//| |_) || || (_) || (__ |   <  | |_) || |   | || (__ |   < \__ \
//|____/ |_| \___/  \___||_|\_\ |____/ |_|   |_| \___||_|\_\|___/
//
...
contract BlockBricks is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/87/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/87/contract-uri";
    ...
    uint256 public tokenfyPrice = 5000000000000000000000;
	...
	constructor(address _signerAddress) ERC721A("Block Bricks", "BRICK") {
