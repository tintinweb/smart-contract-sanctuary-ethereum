// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        constructor() ERC721A(unicode"Still Lifes", unicode"SL") {
            TIERS[0] = [100,400];
TIERS[1] = [15,20,20,30,32,32,33,34,34,250];
TIERS[2] = [15,30,35,35,40,40,40,40,41,41,43,100];
TIERS[3] = [40,40,40,40,40,40,45,45,170];
TIERS[4] = [15,15,23,30,30,35,35,35,35,35,42,170];
TIERS[5] = [10,15,30,40,50,355];
TIERS[6] = [50,450];
TIERS[7] = [500];
        }
