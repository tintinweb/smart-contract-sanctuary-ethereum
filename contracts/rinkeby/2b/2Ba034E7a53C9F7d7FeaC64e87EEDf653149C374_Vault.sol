...
contract Vault {
    ...
    uint256 private DEFAULT_DECIMALS = 30;

    // NOTE: Everything is in 30 decimal points
    ...
    function decreasePositionLeverageConstant(
        ...
        uint256 usdOut = _reduceCollateral(msg.sender, _collateralDelta, _sizeDelta, tokenPrice);
