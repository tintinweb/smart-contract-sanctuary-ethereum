...
pragma solidity ^0.8.0;
contract WeAreAllGoingBroke is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public freeMintCount = 5555;   
    uint256 public freeMintPerAddr = 5;   
    
    uint256 public price = 0.000 ether;

    string private _tokenBaseURI = "ipfs://QmQLNU5hZVacrhaiHJcKpKjoFnJZe6maMHJpHq2uFVW5Ac/";

    address private constant devAddr = 0xbBEFCa3D9DFc638c69686e19F59d6D2555DFD869;
    ...
    constructor() ERC721A("We Are All Going Broke", "WAGBROKE") {
    }
