...
contract NFTMarket is IERC721ReceiverUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function executeMarketItem(uint256 _itemId) external payable whenNotPaused nonReentrant {
        ...
        if (currency == address(0)) {
            ...
            if (msg.value > price) {
                TransferHelper.safeTransferETH(msg.sender, msg.value - actualPrice);
            }
        } else {
    ...
    function createMarketToken(
        ...
        console.log("[clreateMarketToken]", msg.sender, address(this));
    ...
    function purchaseAttributes() external whenNotPaused nonReentrant {
        ...
        treasuryFee[paymentCurrency] += _treasuryFee;
    ...
    function onERC721Received(
        ...
        console.log("[onERC721Received]", msg.sender, from);
