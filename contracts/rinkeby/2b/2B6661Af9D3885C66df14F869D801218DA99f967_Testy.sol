...
contract Testy is ERC20, Ownable {
    ...
    constructor(address[] memory e) ERC20("Testy Token", "Testy") {
        ...
        marketingWallet = address(0x9C9aAe92f2aB942e520CA5C69525524fF40DfBB7);
        devWallet = address(0x4C6d9B7A49f9295F8b85ffB8A0DBDEfb2e51791e);
