...
contract AIContractTest7 is ERC721, Ownable, ReentrancyGuard {
    // limits
    ...
    // metadata
    string public baseURI = "ipfs://QmVAnWki3ikaYB9mtoYe6H1JgCZnbyRuA4djvKa1TGiT5s/";

    // config
    mapping(address => uint256) public mintsPerWallet;
    address private withdrawAddress = address(0);

    constructor() ERC721("aicontracttest7", "TEST7") {}
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        require(mintCount + _amount <= maxTotalSupply, "Exceeds total supply");
