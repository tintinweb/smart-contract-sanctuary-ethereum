...
contract MNLToken is ERC20Interface {
    ...
    function transfer(address _to, uint256 _value) public validAddress(_to) override returns (bool success) {
    ...
    function approve(address _spender, uint256 _value) public validAddress(_spender) override returns (bool success) {
    ...
    function mint(address _account, uint256 _amount) external validAddress(_account) {
        ...
        _balance[_account] = _balance[_account].add(_amount);
