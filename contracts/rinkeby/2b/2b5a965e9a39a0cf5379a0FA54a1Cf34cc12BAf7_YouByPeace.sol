...
contract YouByPeace is Ownable, ERC721A {
    bytes32 public merkleRootFree = 0xd197bfc6e3a60bde63fb2155d22b024618c3f294ec5daff5c534ea62cb03566b;
    ...
    uint256 public freeListMax = 25;
    uint256 public allowListMax;
    ...
    */
    ...
    function allowListMint(uint256 quantity, bytes32[] memory proof) external payable mintCompliance(quantity) {
        ...
        require(quantity <= ALLOW_LIST_MINT_LIMIT, "User max WL mint limit");
