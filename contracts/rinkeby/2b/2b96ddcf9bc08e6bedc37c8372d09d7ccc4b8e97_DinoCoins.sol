...
contract DinoCoins is ERC1155 {
    ...
    /*function mint(uint256 _tokenId) override public pure returns (string memory) {
        return string(
            abi.encodePacked(
                "url/",
                Strings.toString(_tokenId),
