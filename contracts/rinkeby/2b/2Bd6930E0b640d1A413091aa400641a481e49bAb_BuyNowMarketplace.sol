...
contract BuyNowMarketplace is ReentrancyGuard {
    ...
    function makeItem(IERC721 _nft, uint _tokenId, uint _price) external nonReentrant {
        ...
        // increment itemCount
        uint256 newItemId = Counters.current(itemCount);
        // transfer nft
    ...
    function purchaseItem(uint256 _itemId) external payable nonReentrant {
        ...
        uint256 newItemId = Counters.current(itemCount);
        require(_itemId < newItemId, "item doesn't exist");
