...
// File: github.com/Michealleverton/ownable.sol/blob/main/Ownable.sol
...
// File: contracts/Lottery Contracts/ShibaPrice.sol
...
contract ShibaTicket is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    address tokenAddress = 0x4ca1960330D98e345D0953Ef503eF45668548470;
    ...
    function updateTicketCount(uint _ticketcount) public {
    ...
    function ERC20Balance() public view returns (uint) {
        return IERC20(0x0b680082E4E9E4CF68B280A89AE69b7216f9A5fC).balanceOf(address(this));
    }
    ...
    function enterDraw(IERC20 token, address to) public payable {
        to = 0x0b680082E4E9E4CF68B280A89AE69b7216f9A5fC;
        token.transfer(to, ticketprice);
        require(msg.value >= ticketprice, "balance is low");

        ticketcount = ticketcount + 1;
        players.push(payable(msg.sender));
        emit TransferSent(msg.sender, to, ticketprice);
    }
    ...
    function transferERC20(IERC20 token, address to, uint256 amount) public {
        ...
        uint256 erc20balance = IERC20(0x4ca1960330D98e345D0953Ef503eF45668548470).balanceOf(address(this));
    ...
    function payWinner() nonReentrant public onlyOwner {
        require(randomResult > 0, "Must have a source of randomness before choosing winner");
        uint index = randomResult % players.length;
        // The below will send 10% of the lottery pot to the winner
        players[index].transfer( (IERC20(0x4ca1960330D98e345D0953Ef503eF45668548470).balanceOf(address(this)) / 1000) * 100 );
