...
contract IrTest is Ownable, ERC721A, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 private constant TotalCollectionSize_ = 5; // total number of nfts
  ...
  constructor() ERC721A("Ir Test","IR-Test") {
  }
