...
constructor(IERC20 token_,address owner_){
    ...
    createNewLvl(0, 30*(10**18), 6, 200);
    createNewLvl(1, 70*(10**18), 5, 300);
    createNewLvl(2, 130*(10**18), 5, 350);
    createNewLvl(3, 50*(10**18), 6, 400);
    createNewLvl(4, 50*(10**18), 6, 450);
    createNewLvl(5, 50*(10**18), 8, 500);
    createNewLvl(6, 50*(10**18), 8, 550);
    createNewLvl(7, 50*(10**18), 9, 600);
}
...
//requier referal is exist and buy some lvl
