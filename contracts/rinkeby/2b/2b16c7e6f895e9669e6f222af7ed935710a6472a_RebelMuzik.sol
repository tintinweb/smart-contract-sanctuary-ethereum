  ...
  */
  ...
  // == SET SUPPLIES == //
    ...
    function withdraw() public onlyOwner {
      ...
      require(payable(ADDR1).send(currentBalance * 42 / 100), "withdraw failed"); // 42%
      require(payable(ADDR2).send(currentBalance * 23 / 100), "withdraw failed"); // 23%
      require(payable(ADDR3).send(currentBalance * 18 / 100), "withdraw failed"); // 18%
      require(payable(ADDR4).send(currentBalance * 9 / 100), "withdraw failed"); // 9%
      require(payable(ADDR5).send(currentBalance * 8 / 100), "withdraw failed"); // 8%
  }
