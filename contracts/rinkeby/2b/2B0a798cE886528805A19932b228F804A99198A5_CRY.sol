...
contract CRY is ERC721, Ownable, ReentrancyGuard {
    bytes32 whroot=0;
    bytes32 raroot=0;
...
constructor() ERC721("Cryptomus test #2", "CRY"){}
    ...
    function mintNFT(bytes32[] memory proof) external payable onlyMinter nonReentrant returns (string memory)
    {
	uint256 st=0;
	bytes32 leaf;
	bytes32 comp;
	...
	if ( a>1 )
	{
	    mm = string(abi.encodePacked(Strings.toString(currentTokenId+1),",",Strings.toString(currentTokenId+2) ) );
	} else {
	    mm = string(abi.encodePacked(Strings.toString(currentTokenId+1) ));
	}
    ...
    {
	return string(abi.encodePacked("mintpause:",Strings.toString(mintpause),";whitelist:",Strings.toString(whitelistmintopen), ";raffle:",Strings.toString(rafflemintopen), ";public:",Strings.toString(publicmintopen), ";maxminteditems:",Strings.toString(maxminteditems), ";mintprice:",Strings.toString(mintprice), ";currenttokenId:", Strings.toString(currentTokenId) ));
    }
