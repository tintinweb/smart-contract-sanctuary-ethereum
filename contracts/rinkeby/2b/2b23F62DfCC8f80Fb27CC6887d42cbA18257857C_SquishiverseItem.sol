...
error SquishiverseItem__NotBridgeContract();
...
contract SquishiverseItem is FiniteBurnableERC1155 {
    ...
    // Token maximum supply (only decreasable)
    ...
    modifier isBridgeContract() {
        if (bridgeContract != msg.sender) {
            revert SquishiverseItem__NotBridgeContract();
        }
        _;
    }
