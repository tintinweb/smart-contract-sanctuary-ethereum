...
// File: contracts/Convergents.sol
...
contract Convergents is ERC721A, Ownable, ReentrancyGuard {
    ...
    address payable private _convergentsAddress;
    ...
    function setPayableAddresses(address payable convergentsAddress, address payable devAddress) external onlyOwner {
        _convergentsAddress = convergentsAddress;
    ...
    //Constructor
    constructor() ERC721A("TheConvergents", "CVRG", 20, 2022) {
        _baseTokenURI = "https://api.convergents.io/";
        _contractMetadataURI = "ipfs://QmNRsUUzv6uypWrULBKCXGV5G9g4VWHRSm55CWQnDJ8pET";
    }
    ...
    // promoMint - this mint is for marketing ,etc, minted directly to the wallet of the recepient
    // for each item, a random character is chosen and minted. Max inclusing team mint is 200 (tracking reserved mint)
    // only approved team wallets
    function promoMint (address receiver, uint quantity) public nonReentrant {
    ...
    function whitelistMint (uint[10] calldata mintList, bytes32[] calldata proof) public payable nonReentrant {
        ...
        require (totalSupply() < MAX_MINT, "Sold Out" );
        ...
        uint convergentsAmount = paymentRequired - devAmount;
        ...
        // transfer amounts to convergents wallet
        (bool convergentsSuccess, ) = _convergentsAddress.call{ value:convergentsAmount, gas: PAYMENT_GAS_LIMIT }("");
        require(convergentsSuccess, "convergents payment failed");
