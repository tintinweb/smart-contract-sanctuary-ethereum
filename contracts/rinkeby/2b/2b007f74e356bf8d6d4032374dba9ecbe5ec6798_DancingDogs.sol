...
contract DancingDogs is ERC721A, Ownable {
    uint256 MAX_MINTS = 20;
    uint256 MAX_SUPPLY = 4444;
    uint256 public mintRate = 0.005 ether;
    string public baseExtension = ".json";
    string public baseURI = "ipfs://QmZK3ysoSWF5L8ZWJTgXPw42Y9BhamgqTZVM7non7t3sKP/";

    constructor(string memory _name, string memory _symbol) ERC721A("Dancing Dogs", "DDOGS") {}
