...
contract Vendor is Ownable {
    ...
    function sellTokens(uint256 _amount) public {
        uint amount_ETH = _amount / tokensPerEth;
        bool sold = yourToken.transferFrom(msg.sender, address(this), _amount);
        require(sold, "Failed to sell!");
        (bool sent, ) = payable(msg.sender).call{value: amount_ETH}("");
        require(sent, "Failed to sell!");
        emit SellTokens(msg.sender, amount_ETH, _amount);
    }
