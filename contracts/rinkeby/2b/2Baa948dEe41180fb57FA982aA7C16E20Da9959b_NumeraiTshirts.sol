...
contract NumeraiTshirts is ERC721, EIP712, Ownable {
  string public constant DOMAIN_NAME = "LazyNFT-Voucher";
  ...
  {
    _myBaseURI = "ipfs://bafybeie5sybkdcn3tuwmprlnuy7xebelb5qthkaknxua2el6iwvmfg3z2a/";
  }

  /// @notice This function is used by OpenSea to retrieve storefront-level metadata
  /// see: https://docs.opensea.io/docs/contract-level-metadata
  function contractURI() public pure returns (string memory) {
    return "ipfs://bafkreihikveeyu7dlcttlsdu2re7fvz2a6652phphizcs2lusersm6ua74";
  }
  ...
  function redeem(Voucher calldata voucher) external returns (uint256[] memory) {
  ...
  function _hash(Voucher calldata voucher) internal view returns (bytes32) {
    return
      _hashTypedDataV4(
        keccak256(
          abi.encode(
            keccak256(abi.encodePacked("Voucher(uint256[] tokenIds)")),
  ...
  /// @notice Mints tokenId to wallet address
  function mintToAddress(uint256 tokenId, address recipient) external onlyOwner returns (uint256) {
  ...
  function bulkMintToAddress(uint256[] calldata  tokenIds, address[] calldata recipients) external onlyOwner returns (uint256[] memory) {
