...
contract NotDemonz is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("NotDemonz", "DEMON"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more junkiez");
    require(mintEnabled, "Minting is not live yet, hold on junkiez.");
