...
contract EMOBUDDIES is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("EMO BUDDIES", "EMOBUDDIES") {
        ...
        onlyOwner
    {
        require(
            numberOfTokens > 0 &&
                numberOfTokens + tokenCounter.current() <= MAX_SUPPLY,
        ...
        nonReentrant
    {
        ...
        require(
            tokenCounter.current() < MAX_SUPPLY,
