...
// @author ianolson.eth
contract MintPasses is Ownable, ERC721 {
    ...
    address public artistPayoutAddress = address(0xC16f1eDAbfAEa8981F2Ba8D61401f7a76B1fDa50);
    address public imnotArtPayoutAddress = address(0x900C0c2FD84f7385ae36421499c7b3E99c8E058a);
    string public contractURI = "https://ipfs.imnotart.com/ipfs/QmSJtfsGBHn3owgrWkMM3EC24wtbFX8CrQjDo197Yg3E7F";
    string public metadataBaseUri = "https://ipfs.imnotart.com/ipfs/QmVAXPmFp7QxbJTWEKQ88ywpLhdS471uYV94vRYwnoyP3F/";
    ...
    constructor() ERC721("Through the Spectrum Pass", "SPECTRUMPASS") {
        ...
        isAdmin[address(0xC16f1eDAbfAEa8981F2Ba8D61401f7a76B1fDa50)] = true; // Artist Admin Address

        // Artist Proofs
        internalMint(address(0xC16f1eDAbfAEa8981F2Ba8D61401f7a76B1fDa50), 10);
    }
    ...
    function updateImNotArtPayoutAddress(address _payoutAddress) external onlyAdmin {
        imnotArtPayoutAddress = _payoutAddress;
    }

    // @dev Update the artist payout address.
    function updateArtistPayoutAddress(address _payoutAddress) external onlyAdmin {
