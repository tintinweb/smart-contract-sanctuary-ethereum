...
contract VampirestownNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    function checkCost(uint256 _supply) internal pure returns (uint256 _price){
        return _supply < 2500 ? 0 ether : 0.005 ether; // zjebane cos tui jest ja pierdole
    }
    ...
    // ================== Mint Function =======================
      ...
      function mint(address to, uint256 _mintAmount) public payable{
        ...
        //   require(msg.sender.balance >= checkCost(currentSupply) * _mintAmount, "Are your fangs too short, or you dont have enough funds?"); // ?? wywala blad? ??? msg.value zamienilem na msg.sender.balance
          // msg.value
          require(msg.value >= checkCost(currentSupply) * _mintAmount / 1 ether, "Are your fangs too short, or you dont have enough funds?"); // nie no to jak chuj jest zle chyba
