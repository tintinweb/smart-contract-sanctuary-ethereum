...
contract Perfidious is ERC721, Ownable {
    ...
    function presaleMint(bytes32[] memory proof) payable external {
    ...
    function _mintTokens(address to, uint256 numberToMint) internal {
        require(MAX_SUPPLY >= totalSupply + numberToMint, "Exceeds max supply");
    ...
    function clearMintTracker(address addr) external onlyOwner {
