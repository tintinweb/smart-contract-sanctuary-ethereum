...
contract FundMe {
    ...
    function fund() public payable {
        ...
        //checks if user sent minimum eth that equals to $50
        require(
    ...
    // converts sent ethAmount to usd
    ...
    //transfer keyword means to send x amount of eth to where it's being called on
