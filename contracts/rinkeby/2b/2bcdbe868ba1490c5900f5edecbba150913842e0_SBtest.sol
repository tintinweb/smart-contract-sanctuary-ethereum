...
contract SBtest is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("SBtest", "SBtest", maxBatchSize_, collectionSize_) {
  ...
  function setSaleConfig(
    ...
    require(totalSupply() + tierSupply <= collectionSize, "[tierSupply] reached max supply");
