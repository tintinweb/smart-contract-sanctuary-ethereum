...
// TODO: Change contract name to real one before mainnet deployment
contract Continuity is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    // TODO: Change contract name and symbol to real ones before mainnet deployment
    constructor(
    ...
    ) ERC721A("Continuity", "CONTINUITY") PaymentSplitter(_payees, _shares) payable {
