...
contract BTCLPMetaGamePassRoyalties is ERC1155, IERC2981, Ownable, ERC1155Supply, ContextMixin { 
    ...
    constructor(
        ...
        // string memory url
        ) ERC1155("https://ipfs.io/ipfs/QmZxiLeypDwpQ2aXw97GyiFvfZZT5rUJZJw2zrx3p8nxNa/") {
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "https://gateway.pinata.cloud/ipfs/QmUjiXWfpufcwYXPWTGv7qesoYXyVWa6foT17RhztwT6t8/"; // IPFS base for collection
