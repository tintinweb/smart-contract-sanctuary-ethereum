...
contract nft is ERC721, Ownable {
    ...
    uint private maxReservedMintsTeam = 100;
    uint private maxReservedMintsGiveaways = 115;
    
    //addresses of the different shareholders and owners
    address payable public shareholder1 = payable(0x74958115bCE003E512becB19f430B9f3Bb7fa72B);
    address payable public shareholder2 = payable(0x50De0755FD715F8a3B1Dda35d6581A9C9a360549);
    ...
    address private dummy = 0x74958115bCE003E512becB19f430B9f3Bb7fa72B;
    ...
    */
    ...
    function presaleMint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        ...
        require(msg.value >= mintCost(number), "Not sufficient Matic to mint this amount of NFTs");
    ...
    //reserved NFTs for creator
    function reservedMintGiveaways(address recipient) public onlyOwner {
