...
contract MemberNFT is ERC721URIStorage, Ownable {
    ...
    /**
     * @dev
     * - 誰にどのtokenIdをmintしたか記録する
     */
    event TokenURIChanged(address indexed sender, uint256 indexed tokenId);
     ...
     */
    function nftMint(address to, string calldata uri) public onlyOwner {
        _tokenIds.increment();
