...
contract BelleDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPcvLu7KiS4HXtzYg4A4qquNdHEVvEH795msP6EfdKdo2";
    ...
    constructor(
    ) ERC721A("BelleDAO", "BELLEDELPHINE", 100, maxSupply) {
    }
