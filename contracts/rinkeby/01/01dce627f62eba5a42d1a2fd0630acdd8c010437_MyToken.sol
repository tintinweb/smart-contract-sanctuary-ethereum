...
contract MyToken is ERC20{
    ...
    constructor() ERC20("PW4-Coin", "PW4"){
        _SUPPLY_CAP = 250000;
        _Owner = 0xf2C9b946d7afC0c35177915c1383CDf12245E730;
    }
    function mintToken(address account, uint256 amount) public returns (bool status) {
        require(account == _Owner, "Fehler");
