...
contract Love_Addicted_Girls is StellarBase {
    ...
    uint256 private constant _preSaleCount = 2000;
    uint256 private constant _publicSaleCount = 4000;
        ...
        payable
    {
        ...
        require(totalSupply() < _preSaleCount, "Can not mint");
        ...
        payable
    {
        ...
        require(totalSupply() < _publicSaleCount, "Can not mint");
    ...
    function publicSaleLimit()
        public
        pure
        returns(uint256)
    {
        return _publicSaleCount - _preSaleCount;
    }
