...
// Root file: contracts/DocNFTs.sol
...
contract Memes90 is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Memes90", "MM9") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFTs(uint _count) private {
        uint totalMinted = _tokenIds.current();
