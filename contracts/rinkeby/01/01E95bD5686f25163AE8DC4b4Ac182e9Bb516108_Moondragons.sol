...

{
    ...
    string public notRevealedUri = "ipfs://QmVep7UUuTcbktu69BhMr1JHLzHHByjvtgeYwSu7uWnUM9/hidden.json";
    ...
    address[] private _team = [
        0x640802A04CE9960FC62F410C88a38017461ff454 
    ];

    constructor(string memory uri, bytes32 merklerootWL, bytes32 merklerootFREE, address _proxyRegistryAddress)
        ERC721("Moondragons", "MDR")
    ...
    function setMerkleRootWL(bytes32 merklerootWL) 
    onlyOwner 
    public 
    {
        rootWL = merklerootWL;
