...
/// @title: Hostess Club NFT Contract (Free Mint)
/// @author: ???
/// @notice: For more information checkout ???.io
/// @dev: This is Version 1.0
//
//  __                            ,___ _       
// ( /  /       _/_              /   ///     / 
//  /--/ __ (   /  _  (   (     /    // , , /  
// /  /_(_)/_)_(__(/_/_)_/_)_  (___/(/_(_/_/_)                                                        
//
...
contract hostessClub is ERC721AQueryable, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_NFT_SUPPLY = 1000; //This is full collection should be 1000
    uint256 public MAX_NFT_WL = 100; // This should be 100 for WL
    ...
    constructor(string memory baseURI, uint256 mintTimestamp, uint256 wlTimestamp) ERC721A("Hostess Club", "HC") {
        setBaseURI(baseURI);
