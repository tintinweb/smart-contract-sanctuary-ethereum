...
abstract contract Ownable is Context {
    ...
    contract DoobyDoo is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmbtsWYRvbNXZFANSJYHkRehYoAVSZ23f5aj9NZqXV39Bh/" ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmYtrQDrKcZ4jdtTyGmedZkPgMTXg6fpXWWG8xYMSK2yGW";

  

  uint16 public constant maxSupply =300;
  ...
  constructor() ERC721A("Dooby Doo", "Dooby Doo") {
  }
...
if ( reveal == false)
{
 ...
 function setRevealed() external onlyOwner{
  ...
  uint _balance = address(this).balance;
     payable(0x5B702F9279485C8A0B131E83215c3019fF474A26).transfer(_balance ); 
