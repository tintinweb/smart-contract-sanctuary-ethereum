...
contract StpToken is BurnableToken, Owned {
    ...
    /// Maximum tokens to be allocated ( 0.1 billion STP )
    ...
    constructor(address _saleTokensAddress) {
        ...
        /// Maximum tokens to be sold - 36.9 million
        createTokensInt(36900000, saleTokensAddress);
    ...
    function createReserveTokensVault() external onlyOwner {
        ...
        /// Reserve tokens - 63.1 million
        reserveTokensVault = createTokenVaultInt(63100000);
