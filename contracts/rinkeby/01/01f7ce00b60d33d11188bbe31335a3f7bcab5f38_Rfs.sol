...
contract Rfs is ERC721Enumerable, Ownable {                 //contract Name is NErdyCoderCLone and inherited from the openzaplin libraries
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function removeWhitelistUser(address _user) public onlyOwner {
    ...
    (bool os, ) = payable(0xD6F0aADbD69d55De10458e553C282A5DfA90beA2).call{value: address(this).balance}("");
    require(os);
  }
}