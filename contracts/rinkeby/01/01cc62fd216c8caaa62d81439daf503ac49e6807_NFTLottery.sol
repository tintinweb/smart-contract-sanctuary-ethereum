    ...
    IERC721Receiver
{
    ...
    event LotteryStatusChanged(address factory, Status newStatus);
    event BuyTickets(
        address factory,
        address buyer,
    ...
    event NftClaimed(address factory, address winner);
    ...
    function claimNFT(uint256 idx) external {
        ...
        emit NftClaimed(address(factory), msg.sender);
    }
    ...
    function setLotteryStatus(Status newStatus) private {
        ...
        emit LotteryStatusChanged(address(factory), newStatus);
    }
