    ...
    ReentrancyGuard
{
    ...
    uint256 public constant MAX_PER_AL_WALLET = 2;
    uint256 public constant MAX_PER_OG_WALLET = 3;
    uint256 public alPrice = 0.035 ether;
    uint256 public ogPrice = 0.03 ether;
    uint256 public tokenPrice = 0.04269 ether;
    uint256 public royaltyPercentage = 75;
    ...
    ) ERC721("EARLY ONES - Genisis Membership Pass", "EARLY") {
        _w1 = w1;
    ...
    function alMint(uint256 _numberOfTokens, bytes32[] memory _merkleProof)
        ...
        whenHuman
    {
        require(MintActive, "minting is closed");
        require(
