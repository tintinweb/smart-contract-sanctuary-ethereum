...
contract Lottery is VRFConsumerBase, Ownable
        ...
        notZero(_numberOfEntries)
    {
        ...
        token.setApproval(msg.sender, address(this), (ticketPrice*_numberOfEntries));
        token.transferFrom(msg.sender, address(this), (ticketPrice*_numberOfEntries));
        ...
        notZero(_randomness)
    {
        ...
        transferPrize(300, latestWinner);
    ...
    function transferPrize(uint256 _winnerPrice, address winner) private{
        token.setApproval(address(this), winner, _winnerPrice);
        token.transfer(winner, _winnerPrice);
    }
