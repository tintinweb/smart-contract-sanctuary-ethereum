...
contract LodeERC20TokenUpgradeable is Initializable, ERC20Upgradeable, AccessControlEnumerableUpgradeable, PausableUpgradeable {
    ...
    function initialize(string memory name_, string memory symbol_) public initializer {
        ...
        super._grantRole(OWNER_ROLE, msg.sender);
    }

    function togglePause() external onlyRole(OWNER_ROLE) {
        if (paused()) {
            _unpause();
        } else {
            _pause();
