...
contract NFTSTemplate is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI, string memory _name , string memory _symbol, uint256 _maxTokenSupply) ERC721(_name, _symbol) {
    ...
    function batchMint(address[] memory recipients, uint256[] memory ids) external onlyOwner{
        ...
        require(totalSupply() + ids.length <= maxTokenSupply, "Minting would exceed max supply");
