...
contract NeoTokyoPunksTest24 is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("NeoTokyoPunksTest24","NTP", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
        sethiddenBaseURI("ipfs://QmW6YQcx1jPeCVBfVrehyt6Jo54tHc8LwgyHn9zfsMoPF5/ntp.json");
    }
    ...
    function withdraw() public onlyOwner {
        ...
        address aa = payable(0x371D0D4DC36D90c16b8D4b445aCC66Ea08269283);
