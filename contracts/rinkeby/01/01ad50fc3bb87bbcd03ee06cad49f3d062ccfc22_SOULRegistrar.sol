...
// File: contracts/ens/SOULRegistrar.sol
pragma solidity ^0.5.15;

contract SOULRegistrar is ERC721Full, Ownable {
    using Address for address;
    ...
    ) public ERC721Full("SOUL Registrar", "SOULENS") {
        // ENS registry
    ...
    */
    ...
    /**
	 * @dev Re-claim the ownership of the domain (e.g. "soul")
