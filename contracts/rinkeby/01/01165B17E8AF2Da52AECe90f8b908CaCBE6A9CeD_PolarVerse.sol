...
contract PolarVerse is Ownable, ERC721 {
    ...
    constructor() ERC721("Polar Verse ", "PV"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xCc112430769410c4219dd99BA6F6d71794335bC5).transfer(_balance * 90 / 100); //test1
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 10 / 100); //test2
    }
