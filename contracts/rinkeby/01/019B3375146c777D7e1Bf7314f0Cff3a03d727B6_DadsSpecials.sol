...
import { Collection } from "@mikker/contracts/contracts/Collection.sol";

contract DadsSpecials is Collection {
  constructor(address _royalties) Collection("Dads Specials", "DADSSPECIALS", _royalties, 750) {}
}
