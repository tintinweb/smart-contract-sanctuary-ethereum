...
contract FlammablePunks is ERC721 {
    ...
    function rescuePunks(uint256 _quantity) public payable returns (bytes32) {
        require(tokenCounter < 100, "All punks have been rescued!");
        require(
            tokenCounter + _quantity <= 100,
        ...
        returns (bytes32)
    {
        ...
        uint256 vitalsProb = randomNumber % 100;
        ...
        for (uint256 i = 0; i < _quantity; i++) {
            ...
            _setTokenURI(
                ...
                string(
                    abi.encodePacked(
                        "https://ipfs.io/ipfs/QmYBzuonKP1G1NcRw1gT5atKqM1QzrJd3QFkAJbhhf1JwX/",
    ...
    function withdrawBalance() public {
        require(
            ((msg.sender == 0x42FF331884882726573A6880409138E38dA78C3F) ||
                (msg.sender == 0x3d67b76CF3dcc881255eb2262E788BE03b2f5B9F)),
            "You are not authorised to withdraw from this contract."
        );
