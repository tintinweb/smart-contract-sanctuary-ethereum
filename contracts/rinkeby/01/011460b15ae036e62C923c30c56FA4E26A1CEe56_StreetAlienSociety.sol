...
// File: contracts/lowergas test.sol
...
contract StreetAlienSociety is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Street Alien Society", "SAS") {
    setHiddenMetadataUri("ipfs://QmfP2n2KpqNPobhj143yB7fjs4Q7JP8vLA2phPmbZ2WXvA/hidden.json");
  }
