...
contract EthBears is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("EthBears", "ebrs") {
  ...
  uint256 public constant PRICE = 5000000000000000;  //same as 0.005
