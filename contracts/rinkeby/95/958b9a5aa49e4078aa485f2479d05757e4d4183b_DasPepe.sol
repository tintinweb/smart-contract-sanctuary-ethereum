...
contract DasPepe is ERC721A, Ownable {
    ...
    string private baseTokenUri = "https://stfupals.mypinata.cloud/ipfs/QmQYcqWpqTQfUuTrVdHaM98w5VB1EbhLaz5ofXLgktrR5A/";
    ...
    function mint() external payable {
        ...
        require((totalSupply() + 1) <= MAX_SUPPLY, "Out Of Stock!");
        require(mintTime && publicMintTime, "It is not time to mint");
