...
contract MocGenesis is ERC721AQueryable, Ownable, MerkleProofWrapper {
    ...
    uint256 public _reserveCount = 0;
    ...
    function buy(uint256 _amount) public payable {
        ...
        require((maxAdminReserve + _mintCount + _freeMintCount + _amount) <= maxTotalSupply, "not enough tokens for buyer");
    ...
    function adminBuy(uint256 _amount,bytes32[] memory proof) public payable {
