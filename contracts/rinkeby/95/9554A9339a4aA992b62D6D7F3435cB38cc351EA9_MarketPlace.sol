...
contract MarketPlace is Ownable, Pausable, ReentrancyGuard {
    ...
    function _validateSellerSignature(
        ...
        bytes32 BUYORDER_TYPEHASH = keccak256(
            "BuyOrder(address seller,address contractAddress,uint256 tokenId,uint256 startTime,uint256 expiration,uint256 price,uint256 quantity,address paymentERC20)"
        );
