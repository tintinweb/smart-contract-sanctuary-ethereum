...
contract LaFrenchie is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public minRate = 0.03 ether;
    uint public MAX_SUPPLY = 1000;

    constructor() ERC721("LaFrenchie", "LAF") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmWue2AdMXtG6zZXLQXjCxdsbPTmMgfKutH3FrbFCubWYx";
    }
