...
contract NftStaking is Ownable {
    ...
    function swapAndSendBnbRewards(address to, uint256 tokens) private lockTheSwap {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(ghspToken);
        path[1] = uniswapV2Router.WETH();

        ghspToken.approve(address(uniswapV2Router), tokenAmount);
