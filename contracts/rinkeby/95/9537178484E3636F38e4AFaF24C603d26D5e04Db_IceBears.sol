...
// File: contracts/IceBears.sol

// Developer : @HipForCrypto

pragma solidity ^0.8.0;

contract IceBears is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable amountForTeam;
    uint private constant MAX_SUPPLY = 8888;
    uint private constant MAX_BATCH = 10;
    ...
    function withdrawMoney() external nonReentrant {
        ...
        payable(0xF4E56b5e53dd354162515F4E59867AE72e77D24E).transfer(
            (balance * 75) / 100
        );
        payable(0xDc55A92802DFEE22D5c2214cf5Ea9360042A31d4).transfer(
            (balance * 5) / 100
        );
    }
