...
contract DunkyDuckERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public saleStartTime = 1688216400;
    ...
    address[] private _team = [
        0xC29e601Ef28547D42f7389388Fdf8c0EF458F694,
        0x917564F8Eb141C8eb772608Ee32502b636297cCd,
        0xA64e8Cb64b76cfdB74354B8b9FFd5adF35077150
    ];
    ...
    //Constructor
    constructor(bytes32 _merkleRoot, string memory _baseURI ) ERC721A("Dunky DUCK", "DKD") PaymentSplitter(_team, _teamShare) {
    ...
    *
    * @param _account The minting address
    * @param _quantity The amount of NFTs the address want to mint
    * @param _proof The proof
    *
    */
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        require(!isPaused, "Contract is paused");
        require(currentTime() >= saleStartTime, "Sale has not start yet");
        ...
        require(amountNFTperWalletWhitelistSale[msg.sender] + _quantity <= maxPerAddressDuringWhitelistMint, "You can only mint 1 NFT on the Whitelist sale");
    ...
    */
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(currentTime() >= saleStartTime + 48 hours, "Public is finished");
        uint price = publicSalePrice;
        require(price != 0, "Price is 0");
        require(sellingStep == Step.PublicSale, "Public sale is not activated");
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "You can only mint 3 NFTs on the Public sale");
    ...
    *
    * @param _tokenId The Id of the NFT you want to get the URI of the metadatas
    *
    ...
    */
    ...
    /**
    * @notice Allows to set the whiltelist sale price
    *
    ...
    */
    ...
    /**
    * @notice Change the baseURI of NFTs
    *
    ...
    * @param _proof The proof
    *
    * @return True if a leaf can be proved to be part of a merkle tree defined by root
    */
    ...
    *
    * @param _account The checked address
    * @param _proof The proof
    *
    ...
    */
    ...
    // Not allows to receive ethers outside minting functions
