...
contract ThanksPunksSKAtest2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Thanks Punks SKA test2", "SKA") {
    setHiddenMetadataUri("ipfs://QmfVm3QRMwZ8T9cPdNSLatsy4u3dwj8TZEeWWLfXprrkph/hidden.json");
  }
