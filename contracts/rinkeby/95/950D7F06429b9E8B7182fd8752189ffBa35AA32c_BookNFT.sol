...
contract BookNFT is ERC721Enumerable, Ownable {
    ...
    uint256 private _priceextended = 300000000000000000;
    ...
    uint256 public MAX_MINT_COUNT = 3;

    constructor() ERC721("BOOKNFT", "BOOKNFT") {
    }
    ...
    function mintNFT(uint256 _cnt) public payable {
        ...
        if(!publicSale) {
            ...
            require(_cnt <= MAX_MINT_COUNT, "Exceded the Minting Count");
        }
    ...
    function setMaxMintCount(uint256 _MAX_MINT_COUNT) external onlyOwner() {
        MAX_MINT_COUNT = _MAX_MINT_COUNT;
    }
