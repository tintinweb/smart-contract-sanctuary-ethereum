...
// File: contracts/BappeBefLast.sol
...
contract BappeBefLast is ERC721A, Ownable, Pausable 
{
       
    uint256 private constant TRIO_PRICE = 0.15 ether; //Price of 3 on presale
    uint256 private constant PRESALE_LIMIT = 3 ;

    uint256 private mintPrice = 0.055 ether;
    uint256 private totalColSize = 55;
    ...
    function withdraw() external onlyOwner 
    {
        ...
        payable(0x156ec1173b5596A5442058282f85D698db1B3ceB).transfer(
             ((totalBalance * 3000) / 10000)
        );
        payable(0x1e1613a8F946128CdC06F6AdA9Ef843B9A4Fd294).transfer(
             ((totalBalance * 3000) / 10000)
        );
        payable(0x81F12f545B8c14B7c697F0e38eE36B14106F277D).transfer(
             ((totalBalance * 2000) / 10000)
        );
        payable(0x37734460Ee5A94c06161EdEdf1207710789F5791).transfer(
             ((totalBalance * 2000) / 10000)
        );
    }
