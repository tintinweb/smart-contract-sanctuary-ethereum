...
contract Ship is Property {
    ...
    function upgrade(uint256 tokenId, uint256 tier) public override {
        ...
        if (tier < 5) {
            ...
            traits.endurance = uint16(Random.inRange(params.minEndurance, params.maxEndurance, seed++) * 50);
    ...
    function _mintCore(uint256 tokenId) internal override {
        ...
        _traits[tokenId] = TraitSet({
            ...
            endurance: uint16(Random.inRange(params.minEndurance, params.maxEndurance, seed++) * 50),
            flags: 0,
            gilding: 0,
            sails: 0,
