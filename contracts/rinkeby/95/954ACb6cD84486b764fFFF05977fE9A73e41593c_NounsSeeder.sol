...
/// this Nouns Seeder has been modified
...
contract NounsSeeder is INounsSeeder {
     ...
     */
    // prettier-ignore
    function generateSeed(uint256 nounId, uint256 blockNumber, INounsDescriptorMinimal descriptor) external view override returns (Seed memory) {
        uint256 pseudorandomness = uint256(
            keccak256(abi.encodePacked(blockhash(blockNumber - 1), nounId))
        );
