...
contract KillerKangarooz is ERC721, Ownable {
    ...
    bool private hasMintedWhitelist;
    
    constructor() ERC721("Killer Kangarooz Test", "KKTEST") {
        ...
        payable
    {
        ...
        require(msg.value == price * amount, "Incorrect ETH value sent");
    ...
    function mintWhitelist(uint256 amount, bytes32[] calldata proof)
        ...
        payable
    {
        require(whitelistSaleIsActive, "Whitelist sale is not open");
        require(!hasMintedWhitelist, "User has already minted");
        require(msg.value == whitelistPrice * amount, "Incorrect ETH value sent");
        require(tokenCount + amount <= 5000, "Max limit exceeded");
        require(amount < 6, "Cannot mint more than 5");
        require(_verify(proof, whitelistMerkleRoot), "User is not whitelisted");

        hasMintedWhitelist = true;
