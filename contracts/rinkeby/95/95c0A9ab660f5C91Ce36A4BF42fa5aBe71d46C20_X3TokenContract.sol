...
// File: contracts/X3TokenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3TokenContract is RamppERC721A {
    constructor() RamppERC721A("3 TOKEN", "3T"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/8gdMUV9CHiZl1DTt3o3M/contract-metadata";
    }
}
