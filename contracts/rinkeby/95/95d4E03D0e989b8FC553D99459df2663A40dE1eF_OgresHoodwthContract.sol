...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x609e505827cbaBf618A08C58C3a36589888F18BA];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 20 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQfJpX3SkfUxiBp4wqGn3zutA5RSUzjkqJqT2Hr7W6csL/";
...
// File: contracts/OgresHoodwthContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OgresHoodwthContract is RamppERC721A {
    constructor() RamppERC721A("OgresHoodwth", "ogrh"){}

    function contractURI() public pure returns (string memory) {
      return "https://api.jsonstorage.net/v1/json/3e92f1f7-54ab-4060-b507-802ffa0bd0ea/3c6e1562-2677-4602-a8e4-b52e826e6eb5";
    }
}
