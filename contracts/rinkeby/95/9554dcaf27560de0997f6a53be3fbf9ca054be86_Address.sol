...
contract Ragnarok is ERC1155Pausable, Ownable {
    ...
    uint256 public constant DEFAULT_NFT_PRICE = 0.0001 * 1 ether;
    uint256 public constant DEFAULT_DECREASE_NFT_PRICE_AFTER_TIME_INTERVAL =
        0.000019 * 1 ether;
    uint256 public constant DEFAULT_TIME_INTERVAL = 7000 minutes;
    uint256 public constant MAX_DECREASE_ITERATIONS = 29;

    uint256 public dutchAuctionLastPrice = 0;

    uint256 public constant DEFAULT_INITIAL_PUBLIC_SALE = 0 hours;
    uint256 public constant DEFAULT_PIXELMINT_SALE = 0 hours;
    uint256 public constant DEFAULT_PILLMINT_SALE = 0 hours;
    ...
    constructor(
        ...
        defaultPlatformAddress = payable(0xad85B2c59071F837Fc210d1Fdf885529C5E0b75F);
        defaultPlatformMintingAddress = 0xad85B2c59071F837Fc210d1Fdf885529C5E0b75F;
        merkleRootOfPixelMintWhitelistAddresses = 0xddaac2f711d324e054766488df719ce30e72ef30e9d177ccb6e81ecdcf71ae71;
        merkleRootOfPillMintWhitelistAddresses = 0x0f2a7e1309a3a72f36ff779d697e0cfeb3e0a0526d54e9eb0217db4d3293c57f;

        _mintGenesisNFT();

        emit NewURI("https://protected-oasis-25936.herokuapp.com/nft/{id}.json", msg.sender);
