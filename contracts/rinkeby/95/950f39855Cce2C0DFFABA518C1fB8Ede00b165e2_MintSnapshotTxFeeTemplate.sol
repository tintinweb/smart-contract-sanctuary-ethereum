...
// File @openzeppelin/contracts/proxy/beacon/IBeacon[email protected]
...
}// File contracts/templates/MintSnapshotTxFeeTemplate.sol
...
contract MintSnapshotTxFeeTemplate is SnapshotFeature, TxFeeFeatureAlt, ERC20MintFeature {
    function initialize(
        string memory name_, 
        string memory symbol_, 
        uint8 decimals_, 
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, TxFeeFeatureAlt) {
