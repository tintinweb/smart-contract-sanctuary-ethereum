...
// File: contracts/NFTMarketplaceERC721UpgradableV2.sol
    ...
    ERC721PausableUpgradeable
{
    ...
    function __NFTMarketplaceUpgradableV2_init(
        ...
        __Pausable_init_unchained();
        __ERC721Pausable_init_unchained();
        __NFTMarketplaceUpgradableV2_init_unchained(
            name,
            symbol,
            baseTokenURI,
            rootAdmin
    ...
    function _setRoyalties(uint256 collectibleId, Royalties calldata royalties)
        internal
        virtual
    {
        require(
