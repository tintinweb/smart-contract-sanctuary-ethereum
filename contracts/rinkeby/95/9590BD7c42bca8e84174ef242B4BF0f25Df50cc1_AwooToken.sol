...
contract AwooToken is IAwooToken, ERC20, ReentrancyGuard, Ownable {
    ...
    function hashTransaction(address sender, uint256 amount) private pure returns (bytes32) {
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(
                ...
                keccak256(abi.encodePacked("As the owner of Ethereum address ", sender, " I authorize the spending of ", amount, " virtual $AWOO"))
            )
        );
        return hash;
    }
