...
contract Metashima is Initializable, ERC721Upgradeable {
    ...
    *
    * @param _time the unix timestamp
    */
    function setPresaleStart(uint256 _time) external onlyDevOrOwner {
        presaleOpens = _time;
    }

    /**
    * @notice set the timestamp of when the presale should end
    *
    * @param _time the unix timestamp
    */
    function setPresaleClose(uint256 _time) external onlyDevOrOwner {
        presaleCloses = _time;
    }
    ...
    * @param _time the unix timestamp
    */
    function setSaleStart(uint256 _time) external onlyDevOrOwner {
        saleOpens = _time;
    }

    /**
    * @notice set the timestamp of when the main sale should end
    *
    * @param _time the unix timestamp
    */
    function setSaleClose(uint256 _time) external onlyDevOrOwner {
        saleCloses = _time;
    }
