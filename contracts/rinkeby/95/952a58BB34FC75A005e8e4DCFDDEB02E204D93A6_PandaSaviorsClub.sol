...
contract PandaSaviorsClub is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if(onlyWhitelisted == true) {
            ...
            require(ownerMintedCount + _mintAmount <= nftWlPerAddressLimit, "Max NFT per address exceeded");
