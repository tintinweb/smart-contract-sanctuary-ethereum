...
contract SCV2 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    uint currentTokenId;
    ...
    function initialize() initializer public {
        ...
        propertyPrice[0] = 0.001 ether;
        propertyPrice[1] = 0.002 ether;
        propertyPrice[2] = 0.003 ether;
        propertyPrice[3] = 0.004 ether;
        MAX_SUPPLY = 50000;
        MAX_PER_WALLET = 5;
    ...
    function testCon() external pure returns (uint) {
        return 5;
    }
