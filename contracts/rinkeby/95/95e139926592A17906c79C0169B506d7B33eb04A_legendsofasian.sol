...
contract legendsofasian is ERC721Enumerable, Ownable {
...
//Index of Golden Goats
    ...
    constructor() ERC721("legndsofasians", "LofA") {
 ...
 function IsonSaleToken(uint256 tokenId) public view returns(bool status) {
    ...
    function tokenURI(uint256 tokenId) override public view returns(string memory) {
       ...
       string memory baseURI = "https://opensea-creatures-api.herokuapp.com/api/creature/";
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString())) : "";
    }
