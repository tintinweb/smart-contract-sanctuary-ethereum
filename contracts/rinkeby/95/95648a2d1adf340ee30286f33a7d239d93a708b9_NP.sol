...
// File: contracts/NP.sol

pragma solidity ^0.8.0;

contract NP is Ownable, ERC721A, ReentrancyGuard {
    ...
    function withdrawMoney() external nonReentrant {
        ...
        payable(0x54248805648A961D2ec3Beb69d042Ce3c6fE1f35).transfer(
            (balance * 20) / 100
        );
        payable(0x54248805648A961D2ec3Beb69d042Ce3c6fE1f35).transfer(
            (balance * 75) / 100
