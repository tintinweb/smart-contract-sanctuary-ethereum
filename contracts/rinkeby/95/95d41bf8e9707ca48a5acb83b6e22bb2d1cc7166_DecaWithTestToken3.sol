...
contract DecaWithTestToken3 is VRFConsumerBaseV2, Pausable, Ownable, ReentrancyGuard {
    ...
    function fulfillRandomWords(
        ...
        if (userWon) {
            userBankRollBalance[msg.sender].depositAmount = userBankRollBalance[msg.sender].depositAmount.add(winMoney);
            housePoolBalance.depositAmount = housePoolBalance.depositAmount.sub(winMoney);
        } else {
            userBankRollBalance[msg.sender].depositAmount = userBankRollBalance[msg.sender].depositAmount.sub(winMoney);
            housePoolBalance.depositAmount = housePoolBalance.depositAmount.add(winMoney);
        }
