...
contract ERC20_From_Scratch{
    ...
    // uint amount_require_toMint = 0.0000001 ether;
    
    // function _mint(address to, uint256 tokenId) public payable {
       
    //     require(msg.value >= amount_require_toMint, "You dont have enough amount to mint NFT.");
    //    // require(to != address(0), "ERC721: mint to the zero address");
    //     // Mapping owner address to token count
    //     //mapping(address => uint256) public _balances;
    //     balance_of[to] = balance_of[to] + 1;
