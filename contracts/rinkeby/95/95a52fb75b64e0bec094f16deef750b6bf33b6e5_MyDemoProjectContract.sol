...
// File: contracts/MyDemoProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyDemoProjectContract is RamppERC721A {
    constructor() RamppERC721A("My DEMO Project", "DEMO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SFhmtJRiNjgEoZg2CWkl/contract-metadata";
    }
}
