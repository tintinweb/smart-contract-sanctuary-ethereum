...
contract NFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public baseURI = "ipfs://QmPxAgreKuzuZLV7yTzsZ1ZLfFbKaJTVDZuw6MEvitVrzW/";
  ...
  */
  ...
  function devMint(uint256 count)
  public
  onlyOwner
  nonReentrant{
    require(totalSupply() + count <= _amountForDev, "Exceed max dev supply");
