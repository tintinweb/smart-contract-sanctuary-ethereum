...
contract MedievalDynastyTest is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Medieval Dynasty Test", "MDT")
  {
  ...
  function mint() public payable nonReentrant onlyOwner {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 0.005 ETH per item");
