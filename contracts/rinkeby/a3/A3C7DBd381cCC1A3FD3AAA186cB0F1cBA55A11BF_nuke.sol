...
contract nuke is ERC721, Ownable, ReentrancyGuard {
    ...
    function setPublicState(bool _state) public onlyOwner {
        publicSale = _state;
    }
    ...
    modifier mintConditions(
        ...
        if (!publicSale) {
            ...
            require(
                ...
                "Wallet cannot hold more or mint than 2  NFT in presale"
            );
        }
        _;
    }

    modifier setPriceOnConditions() {
        if (publicSale) {
            cost = 0.015 ether;
        }
    ...
    /// @dev might include multiple wallets and payment splitter later.
