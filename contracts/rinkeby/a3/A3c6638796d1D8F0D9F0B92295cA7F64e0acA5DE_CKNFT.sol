...
contract CKNFT is ERC1155, Ownable {
    ...
    uint256 public constant DERPIE_PRICE = 0.0001 ether;
    uint256 public constant MAX_TOKEN_ID_PLUS_ONE = 1; // 20 tokens numbered 0-19 inclusive
