// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Arm", unicode"Drone", unicode"Torso", unicode"Eyes", unicode"Ring", unicode"Head", unicode"Weapon", unicode"BodyArm", unicode"Body"];
        ...
        ContractData public contractData = ContractData(unicode"Random Dude", unicode"Something", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/0c8c977a-8041-449e-925b-c781fbf1d9d3", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/0c8c977a-8041-449e-925b-c781fbf1d9d3", "", 0, "0x1eD3D146cb5945e1C894A70013Ed83F95693EA22");

        constructor() ERC721A(unicode"Random Dude", unicode"RAND") {
            TIERS[0] = [23,102,193,283,368,375,389,434,688,753,786,993,1026,1779,1808];
TIERS[1] = [978,2646,6376];
TIERS[2] = [110,155,167,193,275,345,475,500,556,590,664,1013,1173,1453,2331];
TIERS[3] = [14,20,34,53,122,159,169,237,261,279,328,342,633,643,1321,1626,1769,1990];
TIERS[4] = [41,785,2031,2840,4303];
TIERS[5] = [10000];
TIERS[6] = [18,20,29,90,139,168,285,352,394,461,514,516,589,646,683,751,2020,2325];
TIERS[7] = [10000];
TIERS[8] = [10000];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Random Dude #");
