...
contract NFT is ERC721A, Ownable {
    ...
    string public baseURI = 'Cheese://sorryDetective/';
    bool public isMintActive = false;
    mapping(address => uint256) public MintsPerAddress;
    address public Wallet = 0x7CBFBb5a7439FdE68CEb3790723d62Aae01EC6e5;

    constructor() ERC721A("Baguette", "Baguette") {
    ...
    function mint(uint256 _quantity) external payable {
        ...
        , "Baguette: public mint is not active");
        // price check
        require(msg.value == _quantity * price
            , "Baguette: insufficient amount paid");
        // supply check
        require(_quantity + totalSupply() < MAX_SUPPLY
            , "Baguette: not enough remaining to mint this many");
        // Max Mint Check
        require(MintsPerAddress[msg.sender] + _quantity <= MAX_TOKENS_PER_MINT
            , "Baguette: max mints per address exceeded");
