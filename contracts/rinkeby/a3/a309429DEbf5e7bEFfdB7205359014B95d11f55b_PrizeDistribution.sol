...
contract PrizeDistribution is Ownable, ReentrancyGuard {
    ...
    mapping(uint32 => bool) public nonceToValidated;

    /// ECDSA verification recover key
    address public serverKey;

    /// Platform address to send prizes from 
   ...
   */
    function askPrize(
        ...
        require(recovered == serverKey, "PrizeDistribution.makeaskPrizePayment: Verification Failed");
