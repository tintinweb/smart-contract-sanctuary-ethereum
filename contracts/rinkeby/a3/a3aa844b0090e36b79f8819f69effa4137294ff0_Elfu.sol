...
contract Elfu is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor( uint256 _maxPerTx, uint256 collectionSize_,address _address)
   ERC721A("ELF Princess", "ELF",collectionSize_) {
