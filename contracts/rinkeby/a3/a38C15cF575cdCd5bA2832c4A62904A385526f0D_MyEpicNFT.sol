...
contract MyEpicNFT is ERC721URIStorage {
  ...
  // 3つの配列 string[] に、それぞれランダムな単語を設定しましょう。
    string[] firstWords = ["Big","Small","Marverous","Mysterious","Excellent","Awesome"];
    string[] secondWords = ["Red","Blue","Yellow","Green","White","Black"];
    string[] thirdWords = ["Cats","Dogs","Snakes","Tigers","Lions","Eagles"];
  ...
  function makeAnEpicNFT() public {
    ...
    require(_tokenIds.current() <= 10 ,"Token minting has already finished, the number of token is limited");
