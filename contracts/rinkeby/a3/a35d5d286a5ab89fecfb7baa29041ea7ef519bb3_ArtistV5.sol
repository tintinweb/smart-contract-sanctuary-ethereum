...
import {GoldenEgg} from './GoldenEgg.sol';
...
contract ArtistV5 is ERC721Upgradeable, IERC2981Upgradeable, OwnableUpgradeable {
    // ================================
    // TYPES
    // ================================
    ...
    struct Edition {
        ...
        // request ID for random number from chainlink (for golden egg)
    ...
    constructor() {
        ...
        goldenEgg = GoldenEgg(0x8E6C5feDB9205dD9131CDA8f5774A2Db204DBd7D);
    }
    ...
    function buyEdition(
        ...
        if (newNumSold == quantity) {
            uint256 requestId = goldenEgg.requestRandomNumber();
            editions[_editionId].randomNumRequestId = requestId;
        }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return
            'data:text/plain,{"name":"Gigamesh","description":"Giga who?","external_url":"https://www.sound.xyz/gigamesh/sound","image":"https://soundxyz.mypinata.cloud/ipfs/QmbLAwHPb6EU7td6FhyHafqpoEvTD9R9W9iEd3Ht6gwPRB","audio_url":"https://soundxyz.mypinata.cloud/ipfs/QmbMHGBz2HBcVNdfUMuaK5Cp376G1FgRPjvJoBk7RRqjKf","animation_url":"https://soundxyz.mypinata.cloud/ipfs/QmbMHGBz2HBcVNdfUMuaK5Cp376G1FgRPjvJoBk7RRqjKf","comment_wall_url":"https://soundxyz.mypinata.cloud/ipfs/QmWbgpCYeNjFqxi9xynj5fLe8uKrqMXwDAjW66N6p63sWG","attributes":[{"trait_type":"Sound","value":"Song Edition"},{"value":"Genesis"}]}';
...
/// @author sound.xyz
contract GoldenEgg is VRFConsumerBaseV2, Ownable {
