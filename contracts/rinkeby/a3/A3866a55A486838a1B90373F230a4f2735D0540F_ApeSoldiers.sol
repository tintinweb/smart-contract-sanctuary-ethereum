...
contract ApeSoldiers is ERC721, Ownable {
    ...
    using SafeMath for uint256;
        ...
        // Base URI
    string private _nftBaseURI = 'http://135.181.216.90:49374/api/meta/';
    ...
    constructor()ERC721("Ape Soldiers W", "APSW"){
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory uriEnding = (publicSaleActive && block.timestamp - publicSaleStartTimestamp > 7200) ? tokenId.toString() : 'screensaver';
