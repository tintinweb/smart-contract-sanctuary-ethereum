    ...
    ReentrancyGuard
{
    ...
    uint64 public rafflePrivateRedeemedCount;
    ...
    event PrivateRaffleMint(address indexed _minter, uint256 _amount, uint256 _price);
        ...
        whenNotPaused
    {
        ...
        privateRaffleRedeemed[msg.sender] = privateRaffleRedeemed[msg.sender] + amount;
        for (uint256 i = 0; i < amount; i++) {
