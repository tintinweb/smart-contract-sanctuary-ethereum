...
contract SocietyInitialArtSale is ERC721, IERC2981, IERC721Receiver, Ownable {
    ...
    IERC721 public immutable MEMBER_CONTRACT;
    ...
    function mintTo(address to) external {
        require(
            address(MEMBER_CONTRACT) == msg.sender,
        ...
        returns (bool)
    {
        ...
        if (address(MEMBER_CONTRACT) == operator) {
            return true;
        }
