...
contract LockToken is ModifiedOwnable {
    ...
    constructor(address _token) public {
        ...
        // Private sales timeline >>
        // Private sale period April 1-7, 2022
        // Payment period April 1-7, 2022
        // PIFI token distribution April-8-2022
        // PIFI 2-year lock ends April-8-2024
        // Token unlock timeline >>

        // #1 release April-8-2024 12.5%
        // 8/4/2024 0:00:00 GMT+07:00
        // Monday, April 8, 2024 12:00:00 AM GMT+07:00
        unlockSteps.push(1712509200);

        // #2 release July-8-2024 12.5%
        // 8/7/2024 0:00:00 GMT+07:00
        // Monday,July 8, 2024 12:00:00 AM GMT+07:00
        unlockSteps.push(1720371600);

        // #3 release October-8-2024 12.5%
        // 8/10/2024 0:00:00 GMT+07:00
        // Tuesday, October 8, 2024 12:00:00 AM GMT+07:00
        unlockSteps.push(1728320400);

        // #4 release January-8-2025 12.5%
        // 8/1/2025 0:00:00 GMT+07:00
        // Wednesday, January 8, 2025 12:00:00 AM GMT+07:00
        unlockSteps.push(1736269200);

        // #5 release April-8-2025 12.5%
        // 8/4/2025 0:00:00 GMT+07:00
        // Tuesday, April 8, 2025 12:00:00 AM GMT+07:00
        unlockSteps.push(1744045200);

        // #6 release July-8-2025 12.5%
        // 8/7/2025 0:00:00 GMT+07:00
        // Tuesday, July 8, 2025 12:00:00 AM GMT+07:00
        unlockSteps.push(1751907600);

        // #7 release October-8-2025 12.5%
        // 8/10/2025 0:00:00 GMT+07:00
        // Wednesday, Wednesday, October 8, 2025 12:00:00 AM GMT+07:00
        unlockSteps.push(1759856400);

        // #8 release January-8-2026 12.5%
        // 8/1/2026 0:00:00 GMT+07:00
        // Thursday, January 8, 2026 12:00:00 AM GMT+07:00
        unlockSteps.push(1767805200);

        unlockPercents[0] = (125 * PERCENT_PRECISION) / 10; // step 0 = 12.5%
        unlockPercents[1] = (125 * PERCENT_PRECISION) / 10; // step 1 = 12.5%
        unlockPercents[2] = (125 * PERCENT_PRECISION) / 10; // step 2 = 12.5%
        unlockPercents[3] = (125 * PERCENT_PRECISION) / 10; // step 3 = 12.5%
        unlockPercents[4] = (125 * PERCENT_PRECISION) / 10; // step 4 = 12.5%
        unlockPercents[5] = (125 * PERCENT_PRECISION) / 10; // step 5 = 12.5%
        unlockPercents[6] = (125 * PERCENT_PRECISION) / 10; // step 6 = 12.5%
        unlockPercents[7] = (125 * PERCENT_PRECISION) / 10; // step 7 = 12.5%
    }
    ...
    function claim(uint256 _step) external {
        require(_step < 8, "There can be eight step");
