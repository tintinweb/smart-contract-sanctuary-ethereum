...
contract BuffManaShield is BuffItemBase {
  ...
  string internal constant _NAME = "Mana Shield";
  string internal constant _SYMBOL = "MANA_SHIELD";
  uint private constant _LEVEL = 1;
  IItem.ItemType private constant _TYPE = IItem.ItemType.SKILL;
  string private constant _URI = "https://raw.githubusercontent.com/tetu-io/tetu-game-assets/master/skills/1/mana_shield.png";
