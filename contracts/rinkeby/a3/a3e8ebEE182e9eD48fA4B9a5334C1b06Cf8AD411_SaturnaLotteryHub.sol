    ...
    UUPSUpgradeable
{
    ...
    function _settleLotteryAndDeclareWinner() internal {
        ...
        require(_currentTime() >= s_lottery.endTime, "not ended");
        ...
        s_winners[s_lotteryId.current()] = winner;
    ...
    function _payWinnerAndHouse() internal {
        // address winner = s_lottery.winner;
        ...
        // require(
        //     s_winners[s_lotteryId.current()] != address(0),
        //     "winner cannot be zero"
        // );
        ...
        s_usdc.safeTransfer(
            s_winners[s_lotteryId.current()],
            s_usdc.balanceOf(address(this))
        );

        emit Events.WinnerPaid(
            s_winners[s_lotteryId.current()],
            balance - commision
        );
