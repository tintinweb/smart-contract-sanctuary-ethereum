...
contract GMT1 is ERC721, Ownable, ReentrancyGuard {
    
    using Counters for Counters.Counter;

    string public _baseTokenURI = "";
    bool public _paused = false;            //TODO REMOVE ONCE DONE AND SET TO TRUE
    uint256 public _maxTokens = 10;         //TODO REMOVE ONCE DONE AND SET TO 628
    Counters.Counter public _tokenIds;
    bytes32 public _merkleRoot = 0x8b733525d89893be4fa32acb4e4027cdebcae96b1069ba54440809abdfee85cc;
    mapping(address => uint256) public _walletMints;

    constructor() ERC721("GMT1", "GMT1") {}
