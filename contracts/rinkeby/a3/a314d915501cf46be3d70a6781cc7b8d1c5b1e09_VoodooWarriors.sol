...
contract VoodooWarriors is ERC721A, Ownable, Pausable {
    using Strings for uint256; 

    string public baseURI =
        "https://gateway.pinata.cloud/ipfs/QmfFJjA1nfTejYyQTJUmzmtn5BXNZWAoppGQiYoXmn1p2a/";
    string public revealURI = "https://gateway.pinata.cloud/ipfs/QmSqwLzcngaWSwXAKcwAB3ipttaAEi5HHvksrY4AQPgxXo/1.json";
    ...
    address[] public whitelistedUsers = [0x5B78a48569BF8CD5c894E6823716fb2E48Cd54cA,0xD109fc566401ca57445810b9A3C187876cf44544,0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2];

    mapping(address => uint256) public addressMintedBalance;

    constructor() ERC721A("Marvallous - Voodoo Warriors", "Voodoo") {
        _safeMint(msg.sender, 100);
        addressMintedBalance[msg.sender] = 100;
    }
    ...
    function setMaxMinPerAddress(uint256 _newMaxMint) external onlyOwner {
    ...
    function addWhitelistUser(address _address) external onlyOwner {
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused {
      ...
      if (msg.sender != owner()) {
        if(presale) {
            ...
            require(isWhiteList, "Voodoo Contract: Caller is not allowed to participate in presale");
            uint256 ownerMintedCount = addressMintedBalance[msg.sender];
            require(ownerMintedCount + _mintAmount <= maxMintPerAddress, "Voodoo Contract: max NFT per address exceeded");
            require(msg.value >= presale_price * _mintAmount, "Voodoo Contract: insufficient funds");
        } else {
            uint256 ownerMintedCount = addressMintedBalance[msg.sender];
