...
contract ClearanceCard001 is ERC721URIStorage, Ownable {
    ...
    uint256 public price = 0.00 ether; //0.4
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '"description":"Membership to the Seker Factory 001 DAO. Holding this card secures your membership status, it offers voting rights on certain proposals related to the 001 Los Angeles Factory. Level up this card to receive more perks and governance rights within the 001 DAO.",', 
                                '"properties": {"number": 1, "name": "Poolsuite - Executive Member"},',
                                '"attributes": ',
                                '[',
