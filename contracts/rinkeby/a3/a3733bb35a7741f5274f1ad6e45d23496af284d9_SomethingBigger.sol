...
// File: contracts/SB_Erc1155.sol
pragma solidity ^0.8.0;

contract SomethingBigger is ERC1155, Ownable {
    uint public max_public_mint = 10;
    ...
    // Nova Ukraine Wallet
    address payable public constant RECIPIENT = payable(0x12c546c89E4158b151597d761048A5C33C4f54CC);
    ...
    function mint(uint _type, uint _amount) external payable {
        ...
        require((mintPerAddr[msg.sender] +_amount) <= max_public_mint, "Cannot mint beyond max mint for this address");
    ...
    function mintBatch(uint[] memory _types, uint[] memory _amounts) external payable {
        ...
        require((mintPerAddr[msg.sender] + totalAmount) <= max_public_mint, "Cannot mint beyond max mint for this address");
    ...
    function setMaxMint(uint _max_public_mint) external onlyOwner {
