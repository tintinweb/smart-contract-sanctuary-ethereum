...
contract PixelBeanz is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  ERC721 CopeBeanzAddr = ERC721(0x3CCBc024E22fe27B121104AD7D97fa673b99B281);  //!!!! THIS IS RINKEBY ADDR MAKE SURE TO ADD THE REAL ONE !!! XDD
  ...
  function copeBeanzMint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE/2 * count, "Too little eth, 0.01 ETH per item"
    );

    for (uint256 i = 0; i < count; i++) {
      require(CopeBeanzAddr.balanceOf(msg.sender) > 0, "You don't own any copebeanz");
  ...
  address private constant devAddr = 0x048CFC397913DF69ddD728ED712d53C000487E77;
