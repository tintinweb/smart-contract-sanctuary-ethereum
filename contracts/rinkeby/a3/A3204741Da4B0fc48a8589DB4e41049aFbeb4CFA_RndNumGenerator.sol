...
contract RndNumGenerator is VRFConsumerBaseV2 {
  ...
  function fulfillRandomWords(
    ...
    uint256 _randomWord = s_randomWord;

    lottoNumbers[0] = ((_randomWord % 100) % 49) + 1;
    _randomWord = _randomWord / 100;
    lottoNumbers[1] = ((_randomWord % 100) % 49) + 1;    
  }

  function getRandomNumber() external view returns (uint256, uint256[] memory) {    
    return (s_randomWord, lottoNumbers);
  }
