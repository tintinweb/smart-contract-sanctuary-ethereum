...
contract LocalWeather is ERC721A, Ownable {
    ...
    function mint(
        ...
        require(balanceOf(msg.sender) <= maxPerWallet, "Address minted max amount");
        require(balanceOf(msg.sender) + amount <= maxPerWallet, "Amount requested is over max amount per wallet");
