...
contract MoonQuacks is ERC721A, Ownable{
    ...
    // CHANGE THIS
    address constant public TEAM_MULTISIG = 0x2E556e5661BB7F6bdA902995845Cff8AF465D267;

    uint256 public freeMax;
    uint256 public nonFreeMax;
    ...
    constructor() ERC721A("MoonQuacksV0.1", "MQ") {}
    ...
    // Elegant way to check payment and refund, lifted from @NftDoyler
    ...
    function withdraw() external onlyOwner {
        ...
        (bool succ,) = payable(TEAM_MULTISIG).call{
            value: balance
        }("");
        require(succ, "transfer failed");
    }
