...
contract TheFuckUpPill is ERC1155Supply, Ownable {
    ...
    uint256 public ecstasyMaxSupply = 1591;
    ...
    constructor(string memory _baseURI) ERC1155(_baseURI) {
        ...
        tokenUriSuffix[1] = ".gif";
        tokenUriSuffix[2] = ".jpg";
        tokenUriSuffix[3] = ".jpg";
        tokenUriSuffix[4] = ".jpg";
        tokenUriSuffix[5] = ".gif";

        hiddenMetadataUri = "https://thenft.mypinata.cloud/ipfs/QmU9VMPpbcDHtG5ekwaUbDGg5yYkpRB4oRYXjTmw7jvpvV";

        emit SetBaseURI(baseURI);
    }

    function mintBatch(address _userAddress, uint256[] memory ids, uint256[] memory amounts)
        external
        onlyOwner
    {
        ...
        for (uint256 i; i < ids.length; i++) {
            ...
            if (ids[i] == 2) {
                require(
                    totalSupply(ids[i]) + amounts[i] <= ecstasyMaxSupply,
    ...
    function setUriSuffix(uint256 _tokenId, string memory _uriSuffix)
        public
        onlyOwner
    {
        tokenUriSuffix[_tokenId] = _uriSuffix;
    }
    ...
    function burnPillForAddress(uint256 tokenId, uint256 _amount, address burnTokenAddress)
        external
    {
