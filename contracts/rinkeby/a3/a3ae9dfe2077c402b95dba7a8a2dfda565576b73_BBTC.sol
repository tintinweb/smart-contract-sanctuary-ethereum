...
contract BBTC is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Bulls and Bears Trade Club", "BBTC") {
        ...
        rarity_price[0] = 0.01 ether;//0.15 ether; // 1
        rarity_price[1] = 0.01 ether;//0.30 ether; // 2
        rarity_price[2] = 0.01 ether;//0.75 ether; // 5
        rarity_price[3] = 0.01 ether;//7.50 ether; // 50
