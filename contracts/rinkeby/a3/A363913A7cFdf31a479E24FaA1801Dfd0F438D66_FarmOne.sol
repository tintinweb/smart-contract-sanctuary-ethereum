...
contract FarmOne {
    ...
    SolidTokenOne solidTokenOne;
    RewardToken rewardToken;

    string public name = "Farm One";

    constructor(SolidTokenOne _solidTokenOne, RewardToken _rewardToken) {
        owner = msg.sender;
        blockPerDay = 1;
        rewardPerBlock = 50 * 10**18;
        solidTokenOne = _solidTokenOne;
    ...
    function stake(uint256 _amount) public {
        ...
        solidTokenOne.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstake() public {
        ...
        solidTokenOne.transfer(msg.sender, balance);
...
contract SolidTokenOne is ERC20 {
    constructor() ERC20("Solid Token One", "ST1") {
