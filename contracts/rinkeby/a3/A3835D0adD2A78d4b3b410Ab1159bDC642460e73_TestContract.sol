...
contract TestContract is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    /// @notice Constructor for the TestContract NFT
    ...
    function setMaxMintPerWallet(uint256 newMaxMintPerWallet) external onlyOwner {
        maxMintAmountPerTx = newMaxMintPerWallet;
    }
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(minted[msg.sender] + numTokens <= maxMintAmountPerTx, "limit per wallet reached");
        require(nextTokenId + numTokens <= maxMint, "Mint exceeds supply");
    ...
    /// @notice Burn TestContract on source chain and mint on destination chain
    ...
    function traverseChains(
        ...
        require(msg.sender == ownerOf(_tokenId), "Message sender must own the TestContract.");
