...
contract Omega is Ownable, Pausable {  
    ...
    function getUSDConversionFactor() external view onlyOwner whenNotPaused returns(uint256){
        return usdConversionFactor;
    }
    
    function getOmegaToTransfer(uint256 _amount) external view onlyOwner whenNotPaused returns(uint256){
    ...
    function getOmegaToken() external view onlyOwner whenNotPaused returns(IERC20){
        return omegaToken;
    }

    function getUSDTToken() external view onlyOwner whenNotPaused returns(IERC20){
        return usdtToken;
    }
