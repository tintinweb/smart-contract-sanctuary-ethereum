...
*/
    ...
    function mintFreeSecret(uint8 _mintCount) external nonReentrant returns (uint256) {
        ...
        require(mintStep == 0 && _mintCount > 0);
        ...
        emit Mint(msg.sender,
                    ...
                    addressFirstPresaleCountMap[msg.sender] + addressSecondPresaleCountMap[msg.sender],
    ...
    function getAccountStatus(address account) external view returns (uint8[] memory) {
        ...
        status[1] = addressFirstPresaleCountMap[msg.sender] + addressSecondPresaleCountMap[msg.sender];
