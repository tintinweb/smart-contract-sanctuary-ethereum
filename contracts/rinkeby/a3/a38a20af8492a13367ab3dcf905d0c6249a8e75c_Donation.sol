...
contract Donation
{
  ...
  function  donation()external payable
  {
   ...
   function updateManager(string memory _fullname, string memory _contactNo) public onlyOwner 
   {
    ...
    function RequestForBlood(string memory _CNIC,string memory _firstname,string memory _lastname,string memory _email,string memory _bloodtype,string memory _disease,string memory _adress,string memory _contact_No, string memory _status,uint _NoOfBottles,string memory _dateOfapprove )public
    {
