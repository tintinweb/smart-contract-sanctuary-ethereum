...
/**
 * @title DepositConfirmationAlpha 
 * @dev Implementation of the DepositConfirmationAlpha.
 */
 ...
 * @dev Implementation of DepositConfirmation "The deposit Proof"
 */
...
contract DepositConfirmation is ERC721, Ownable {
    ...
    event MintDeposit(address indexed _user, uint256 _id);
    event BurnDeposit(address indexed _user, uint256 _id);

    constructor ()  
    ERC721 ("Deposit proof",  "DPP"){
    }
    ...
    function burn(uint256 tokenId) internal {
        ...
        _burn(tokenId); 
        emit BurnDeposit(owner, tokenId);
    }
