...
contract DispencerContract {
  ...
  //this holds the mapping of approved doctors
   ...
   //this maps the approved drugs
   mapping(address=> mapping(uint256 => uint[]) ) public approvedDrugs;
   ...
   //this function can be used to view a patient drugs
    function viewPatientPrescription(address _patient) public onlyDoctors onlyPharmacist view returns (Prescription[] memory) {
