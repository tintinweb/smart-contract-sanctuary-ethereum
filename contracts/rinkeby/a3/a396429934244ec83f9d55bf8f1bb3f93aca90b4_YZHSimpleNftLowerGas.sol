...
// File: contracts/YZHSimpleNftLowerGas.sol
...
contract YZHSimpleNftLowerGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("YZHSimpleProject", "YSP") {
    setHiddenMetadataUri("ipfs://QmXKZthtHPqAms9FQLBmrsaxRjj6tZWTdnHZGG24A8exTT/hidden.json");
  }
