...
contract myfi_testnet is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable
{
    using SafeMath for uint256;
    using SafeMath for uint8;
    //uint256 public constant MAX_MYFI_PIECES = 10602;
    uint256 public constant MAX_MYFI_PIECES = 100;

    //actually ~100
    uint256 public constant EDUCATION_PIECES = 10;
    //uint256 public constant EDUCATION_PIECES = 100;
    uint256 public constant FRIENDS_FAMILY_PIECES = 10;
    //uint256 public constant FRIENDS_FAMILY_PIECES = 333; // or 444
    ...
    //use this for anti-collusion/sniping shit
    ...
    constructor(string memory initialURI) ERC721('myfi_testnet', 'MYFI')
    {
    ...
    //allows you to mint pieces from MyFi
    //XXX decide if connecting state is worth using...
    function connect(uint256 myfiPieces) public payable connectingState
    {
	//XXX verify the done thing works
