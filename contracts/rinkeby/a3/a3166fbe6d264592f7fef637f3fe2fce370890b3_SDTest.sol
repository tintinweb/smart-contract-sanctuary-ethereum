...
contract SDTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test SD Contract", "SD") {
    setHiddenMetadataUri("ipfs://QmP5UEsAV6SmnBqcgKDdrk8KvXrXYXeZfYTtRGagdVa2Hy/hidden.json");
  }
