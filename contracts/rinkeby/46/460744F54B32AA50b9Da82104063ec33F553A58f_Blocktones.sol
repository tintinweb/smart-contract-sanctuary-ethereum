...
contract Blocktones is ERC721Enumerable, Ownable {
    ...
    uint256 public priceReduced = 0.1 ether;
    uint256 public priceWL = 0.14 ether;
    uint256 public pricePublic = 0.16 ether;
    uint256 maxSupply = 10000;
    bytes32 public merkleRootReduced;
    ...
    function reducedMint(uint256 quantity, bytes32[] calldata proof) external payable {
        ...
        require(msg.value >= quantity * priceReduced, 'Not enough eth');
    ...
    function whitelistMint(uint256 quantity, bytes32[] calldata proof) external payable {
        ...
        require(mintedCount[msg.sender] + quantity < 3, 'Individual mint limit exceeded');
        require(quantity > 0, 'Invalid quantity entered');
        require(msg.value >= quantity * priceWL, "Not enough eth");
    ...
    function publicMint(uint256 quantity) external payable {
        ...
        require(quantity > 0, 'Invalid quantity entered');
        require(mintedCount[msg.sender] + quantity < 3, 'Individual mint limit exceeded');
        require(msg.value >= quantity * pricePublic, 'Not enough eth');
        mint(msg.sender, quantity);
    }
