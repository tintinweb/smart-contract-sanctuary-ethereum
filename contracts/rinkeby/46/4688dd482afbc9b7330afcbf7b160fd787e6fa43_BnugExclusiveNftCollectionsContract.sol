...
// File: contracts/BnugExclusiveNftCollectionsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract BnugExclusiveNftCollectionsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "BNUG Exclusive NFT Collections";
    string public symbol = "BENC";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/i6fAlUJHsgQjqmdDEnXf/contract-metadata";
    }
