...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("TestToken3 - TokenTest", "BCOIN") {}
    ...
    function mint(address stakingVestingContractAddress, 
                ...
                address preSalesContractAddress,
                address partnershipsVestingContractAddress) external onlyOwner {
        
        require(mintCompleted == false, "Mint already completed by owner");

        // Mint Staking Incentives Tokens with vesting over 10 years - 
        _mint(stakingVestingContractAddress, 10000000000000000000000000);
        ...
        _mint(marketingVestingContractAddress, 4000000000000000000000000);
        // _mint(xxxxxxxxxxxxxxxxxx,  4000000000000000000000000);
        ...
        _mint(preSalesContractAddress, 4000000000000000000000000);
        // _mint(xxxxxxxxxxxxxxxxxx,  4000000000000000000000000);
