...
contract TokenTwo is ERC721, Ownable, recovery {
    ...
    constructor(string memory tempURI, IRNG rng) ERC721("TokenTwo","TST2") {
...
// SPDX-License-Identifier: RIGHT-CLICK-SAVE-ONLY
pragma solidity ^0.8.7;
