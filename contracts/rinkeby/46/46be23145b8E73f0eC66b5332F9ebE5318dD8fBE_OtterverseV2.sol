...
contract OtterverseV2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Otterverse V2", "OV") {
    setHiddenMetadataUri("ipfs://QmdkWix2JvL4DwbbqrTiMFCeboQ5BcMfCeeRjrbG1FAJ97/");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    // (bool hs, ) = payable(Royalty address).call{value: address(this).balance * 5 / 100}("");
    // require(hs);
    // =============================================================================
