...
contract LostMindCollection is ERC721Delegated, ReentrancyGuard {
  using Counters for Counters.Counter;

  constructor(address baseFactory, string memory customBaseURI_)
    ERC721Delegated(
      baseFactory,
      "Lost Mind Collection",
      "LMC",
      ConfigSettings({
        royaltyBps: 1000,
  ...
  uint256 public constant MAX_MULTIMINT = 500;

  uint256 public constant PRICE = 53000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 500 at a time");

    require(
      msg.value >= PRICE * count, "Insufficient payment, 53 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x7786416EFcfb6a621077b50A4Dee05C0FAb45F97;
