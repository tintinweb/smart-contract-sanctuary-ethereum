...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function fulfillRandomness(
        bytes32 _requestId,
        uint256 _randomness ///override --> dice que sobreescribiremos la funcion
    ) internal override {
        require(
            lottery_state == LOTTERY_STATE.CALCULATING_WINNER,
            "lottery in not open"
        ...
        //rest lottery (reinicia loteria)
        players = new address payable[](0); ///vaciamos los jugadores
        lottery_state = LOTTERY_STATE.CLOSED;
        randomness = _randomness; ///registrodel ultimo numero aleatorio
    }
}
