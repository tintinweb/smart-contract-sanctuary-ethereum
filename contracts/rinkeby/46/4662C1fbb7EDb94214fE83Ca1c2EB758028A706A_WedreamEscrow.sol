...
contract WedreamEscrow is IERC721Receiver, Ownable {
    ...
    Counters.Counter private tokenRegistryId;
     ...
     */
    function withdrawalToken(uint256 _tokenRegistryId) public virtual {
        // require(
     ...
     */
    function setMinimumPrice(uint256 _tokenRegistryId, uint256 minimumPrice)
        external
    {
        require(
            tokenRegistry[_tokenRegistryId].tokenOwner == msg.sender,
     ...
     * @param _tokenRegistryId id in the token registry.
     */
    function adminWithdrawalToken(uint256 _tokenRegistryId)
        public
        virtual
        onlyOwner
    {
    ...
    function fulfillBid(
        ...
        require(
            false,
            "WedreamEscrow: Function not implemented yet"
        );
        require(
