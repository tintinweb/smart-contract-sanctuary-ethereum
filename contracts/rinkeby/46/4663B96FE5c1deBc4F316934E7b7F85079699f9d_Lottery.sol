...
contract Lottery is VRFConsumerBase, Ownable {
  ...
  event requestRendomness(bytes32 requestId);
  ...
  function startLottery() public onlyOwner {
    require(lottery_state==LOTTERY_STATE.CLOSE,"cannot start a new lottery yet!");
    lottery_state = LOTTERY_STATE.OPEN;
  }
  function endLottery() public onlyOwner {
   // require(lottery_state==LOTTERY_STATE.OPEN,"cannot end it!");
    /*
//bad way to choose a random number
uint256(
      keccack256(
        abi.encodePacked(
          nonce,
