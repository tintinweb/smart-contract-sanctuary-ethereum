...
contract TearSwap is Pausable, Ownable {
    ...
    ITearToken public tearContract;

    /// @notice Exchange rate for the swap
    mapping(IERC20 => uint256) exchangeableErc20;
    ...
    constructor(ITearToken tearContract_, IERC20 slimeContract_) {
        tearContract = tearContract_;
        exchangeableErc20[slimeContract_] = 1000e18;
        destinationAddress = 0xf722674c115792A7a99002220F16788600d717Ca;
    }
