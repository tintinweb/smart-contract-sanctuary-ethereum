...
contract RiggedRoll is Ownable {
  ...
  function withdraw(address _addr, uint256 _amount) public onlyOwner {
    require(_amount < address(this).balance, "INSUFFICIENT_FUNDS 0 123");
  ...
  function riggedRoll() public {
    require(address(this).balance >= 0.002 ether, "INSUFFICIENT FUNDS in contract, grab some funds");
    // console.log("skkkkk why this happening");
    // console.log(0.002 ether);
    // console.log(msg.value);
    // console.log("----------------------");
    // require(msg.value >= 0.002 ether, "INSUFFICIENT FUNDS 1 123");
