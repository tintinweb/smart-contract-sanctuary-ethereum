...
contract SkullBombs is ERC721Enumerable, Ownable {
  ...
  function whitelistUsers(address[] calldata _users) public onlyOwner {
   ...
   function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
  ...
  function calculatePrice() public view returns (uint256) {
        ...
        if (currentSupply >= 2000) {
            return 0.003 ether;
        } else if (currentSupply >= 1950) {
            return 0.003 ether;
        }  else if (currentSupply >= 1900) {
            return 0.003 ether;
        } else if (currentSupply >= 1850) {
            return 0.003 ether;
        } else if (currentSupply >= 1800) {
            return 0.003 ether;
        }  else if (currentSupply >= 1650) {
            return 0.003 ether;
