...
contract Bubble is Ownable, ERC721A, ReentrancyGuard {
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bubble #', Strings.toString(tokenId), '", "description": "The bubble shrinks over time. Each transfer will make it bigger.","image":"', Base64.encode(bytes(output)), '"}'))));
