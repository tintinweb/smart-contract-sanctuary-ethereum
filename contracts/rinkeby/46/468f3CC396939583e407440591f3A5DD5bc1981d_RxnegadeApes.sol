...
contract RxnegadeApes is IERC2981, ERC721A, Ownable, RxnegadeCollection {
    ...
    bool public PUBLIC_MINTING_ACTIVE = true;
    ...
    function mint(
        ...
        _setNextTokenId(_currentIndex);
    }

    /**
     * Mint Complimentary Boujee Token
    ...
    /**
     * Gift Boujee Tokens
     * @dev mints a token to the provided address, requires a signature from a message signed by the RXAPE Signer
     ...
     * @return the metadata location of the specified token ID
     */
...
abstract contract RxnegadeCollection {
    ...
    function _setNextTokenId(uint256 tokenId) internal {
        _nextTokenId = tokenId;
    }

    /**
     * @dev records the rx id used to mint a token
     */
     ...
     *
     */
    function _setRxContractAddress(address address_) internal {
        Rxnegades = IRxnegades(address_);
    }
}
