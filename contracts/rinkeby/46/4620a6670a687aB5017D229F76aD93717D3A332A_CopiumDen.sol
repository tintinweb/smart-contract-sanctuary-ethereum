...
//        payForSale(currentOffer, msg.sender);
    ...
    function MKT_getOfferStats(uint256 tokenId, address offerer, uint256 price, uint256 position) public view returns (bool, bool, bool, bool) {
        uint256 currentOffer = offers[tokenId][offerer];
        return (ownerOf(tokenId) == msg.sender, currentOffer != 0, currentOffer == price, msg.sender == offerAddressPositions[tokenId][position]);
    }
