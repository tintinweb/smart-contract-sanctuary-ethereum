...
// File: contracts/Testing1155.sol
...
contract Testing1155 is ERC1155, Ownable {
  ...
  constructor() ERC1155("") {
    name = "Testing1155";
    symbol = "TST";
    mint(msg.sender, 1, 25);
    setURI(1, "ipfs://QmW6LS83kgg5ZCrTBURhkHKKPd4wAYh2sNtBjqDHyVnWhF/hidden.json");
  }
