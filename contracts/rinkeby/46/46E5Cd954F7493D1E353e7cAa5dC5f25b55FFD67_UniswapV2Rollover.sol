...
contract UniswapV2Rollover is IUniswapV2Rollover, IUniswapV2Callee, BaseRollover {
  ...
  // _______HOOKS_______
  function uniswapV2Call(address initiator, uint256 amount0, uint256 amount1, bytes calldata data) external override {
...
abstract contract BaseRollover is IRollover, Ownable {
  ...
  function _repayLoan(
    ...
    require(contracts.assetWrapper.ownerOf(loanData.terms.collateralTokenId) == address(this), "collateral ownership");
  }
