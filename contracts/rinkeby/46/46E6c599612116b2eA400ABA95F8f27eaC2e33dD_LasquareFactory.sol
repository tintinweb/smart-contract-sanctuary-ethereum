...
pragma abicoder v2;
import "./LasquareOpenseaStore.sol";
...
contract LasquareFactory is Ownable {
    ...
    function newCollection(
        ...
        LasquareOpenseaStore NewCollection = new LasquareOpenseaStore(_name, _symbol,_proxyRegistryAddress,_tokenURI);
 ...
 */
contract LasquareOpenseaStore is AssetContract, ReentrancyGuard, RoyaltiesV2Impl {
    ...
    function mint(
        ...
        uint256 _quantity,
        bytes memory _data
    ) public nonReentrant creatorOnly(_id) returns(uint) {
    ...
    function batchMint(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            ...
            _saveRoyalties(_ids[i], _royalty);
        }
