...
contract ApelistController is ReentrancyGuard, Ownable, Pausable, PaymentSplitter {    
    bool public whitelistLive;
    bool public isSaleLive;

    uint256 public supply;
    
    IMerkle public whitelist = IMerkle(0xb1cD617fF7d7Ad3904232f3CD96873DD38ffE7A6);
    IMerkle public claim = IMerkle(0x8241dcF1aE8450e8E77A405E57E0d49c1712b05b);
    IApelist public nft;
    ...
    address[] _recipients = [0xf85A4FFB066e5886AeBB8eB6C9Fb1F02E67EA76f];
    uint256[] _shares = [100];

    constructor() PaymentSplitter(_recipients, _shares) {
    ...
    function mint(uint256 quantity) external payable whenNotPaused nonReentrant {        
        ...
        require(supply + quantity <= config.maxSupply, "Exceeds supply");
