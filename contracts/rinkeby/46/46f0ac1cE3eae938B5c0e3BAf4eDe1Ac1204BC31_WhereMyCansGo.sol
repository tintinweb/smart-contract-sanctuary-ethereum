...
contract WhereMyCansGo is ERC721Creator {
    ...
    // * CONSTANTS * //
    address public constant openseaSharedContract = 0x88B48F654c30e99bc2e4A1559b4Dcf1aD93FA656;
    ...
    mapping(uint256 => address) public oldTokenIdToAddress;
    mapping(uint8 => bool) public newTokenMinted;
    ...
    function setMerkleRoot(bytes32 _merkleRoot) adminRequired public { // Sets Merkle Root
    ...
    function sendToPurgatory(
        ...
        resurrect(msg.sender, oldTokenId, newTokenId, uri);
    }
