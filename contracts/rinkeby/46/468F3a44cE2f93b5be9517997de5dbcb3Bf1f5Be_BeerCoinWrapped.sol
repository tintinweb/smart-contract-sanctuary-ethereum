...
contract BeerCoinWrapped is ERC721, ERC721Enumerable, Ownable {

    event Wrapped(uint256 indexed pairId, address indexed owner);
    event Unwrapped(uint256 indexed pairId, address indexed owner);

    BeerCoinOrigContract bcContract = BeerCoinOrigContract(0x488648116627C3526B6ddde261FB8E1112d0Ad80);
    ...
    constructor() ERC721("BeerCoinWrapped", "BCW") {
