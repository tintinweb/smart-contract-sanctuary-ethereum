...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmXKcHR6KTLmE2kN3TZdTh9Cfgs6c7fcJ5zK1emYYzpTA1/";
...
contract TesttContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/X19dlBe5AQVitafAuSpy/contract-metadata";
    }
}