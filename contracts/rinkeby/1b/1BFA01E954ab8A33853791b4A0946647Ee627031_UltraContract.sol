...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAF4bf19AFA5120426744c209FAe560CD7d8643CC,0x68dF6DF7e68A068419E89af54bb3D6D30F0a13E5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfS9TgYKk9gepywth1rYM3oLtxaoUwWETZSffSYM7hyZi/";
...
// File: contracts/UltraContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UltraContract is RamppERC721A {
    constructor() RamppERC721A("ULTRA", "ULTRA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/PTh3HZaL3b34p9bkOBHT/contract-metadata";
    }
}
