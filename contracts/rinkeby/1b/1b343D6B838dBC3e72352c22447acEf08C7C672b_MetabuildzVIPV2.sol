...
contract MetabuildzVIPV2 is ERC721A, Ownable {
    // ======== SUPPLY ========
    ...
    // ======== CONSTRUCTOR ========
    constructor() ERC721A("Metabuildz VIP V.2", "MVIP") {
        setRoyaltyAddress(0xb941a64c32Edde737DB4cDb540C308ceF88273C9);
    }
    ...
    mintCompliance {
        ...
        require(_numberMinted(_msgSender()) < mintLimit, "Can't mint anymore as it exceed the mint limit.");
