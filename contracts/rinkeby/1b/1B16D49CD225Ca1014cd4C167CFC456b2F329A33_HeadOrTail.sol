...
contract HeadOrTail is VRFConsumerBaseV2 {
    ...
    event Result(address _player, uint256 _amount, uint256 _requestId, bool _win);
    ...
    function fulfillRandomWords(
        ...
        if(win){
            payable(bettor[_requestId]).transfer(1900 * amount_bet[_requestId] / 2000);
        }
        request_completed[_requestId] = true;
        history[_requestId] = win;
        emit Result(bettor[_requestId],amount_bet[_requestId],_requestId,win);
    }
