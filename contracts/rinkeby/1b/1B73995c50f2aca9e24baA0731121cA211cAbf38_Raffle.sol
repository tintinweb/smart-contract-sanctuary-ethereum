 ...
 * @author Artem Sedykh
 * @notice This contract is for ctreating an untamperable decentralized smart contract
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
  ...
  VRFCoordinatorV2Interface private immutable i_rfCoordinator;
  ...
  constructor(
    ...
    uint256 interval
  ) VRFConsumerBaseV2(vrfCoordinator2) {
    i_entranceFee = entranceFee;
    i_rfCoordinator = VRFCoordinatorV2Interface(vrfCoordinator2);
    i_gasLine = gasLane;
  ...
  /**
   * @dev This is the functions that the Chainlink keepers need call
    ...
    )
  {
    ...
    upkeepNeded = (isOpen && isTimePassed && hasPlayers && hasBalance);
  }
  ...
  function performUpkeep(
    ...
    uint256 requestId = i_rfCoordinator.requestRandomWords(
      i_gasLine,
      i_subscriptionId,
  ...
  function fulfillRandomWords(
    ...
    uint256 indexOfRandomWinner = randowmWords[0] % s_players.length;
