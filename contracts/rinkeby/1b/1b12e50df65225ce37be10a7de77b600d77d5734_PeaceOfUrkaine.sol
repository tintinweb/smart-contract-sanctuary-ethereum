...
contract PeaceOfUrkaine is ERC721, Ownable {
    uint16 public mintCount = 0;
    uint16 supply = totalSupply();

    uint256 public MAX_SUPPLY = 7200;
    uint256 public OWNER_RESERVED = 0;
    uint256 public MAX_ALLOWED = 7200;
    ...
    constructor(string memory baseURI) ERC721("Peace for Ukraine", "UKR") {
        setBaseURI(baseURI);
    }
