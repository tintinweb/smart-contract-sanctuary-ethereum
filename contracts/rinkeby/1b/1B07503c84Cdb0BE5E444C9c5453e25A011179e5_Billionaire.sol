...
contract Billionaire is Ownable,PaymentSplitter, ERC721A("WooA", "WA"){
 //To concatenate the URL of an NFT
    ...
    uint public max_mint_allowed_presale = 3;
    uint public max_mint_allowed_public =  2;
...
/**we c est vrai, apres k finis la minting dapp, j vais optimizer ce contract, enlever ERC721Enumerable parsque counter peut faire la mm chose et enlever d autre module si j ai le mm problem  */
    ...
    **/
    ...
    function presaleMint(bytes32[] calldata _proof, uint256 _ammount) external payable  {
        ...
        require(_ammount > 0 && nftsPerWallet[msg.sender] + _ammount <= max_mint_allowed_presale, "You can only get many per Presale");
    ...
    **/
    function saleMint(uint256 _ammount) external payable  {
        ...
        require(_ammount > 0 && nftsPerWalletSale[msg.sender] + _ammount <= max_mint_allowed_public, "You can only get many per Sale");
