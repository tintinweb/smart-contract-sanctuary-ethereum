...
contract ThePokerFace  is ERC721Enumerable, Ownable
{
    ...
    constructor() ERC721("The Poker Face Club", "TPFC")  {
        _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmSFzBvQypdvUpXdsm1ENwGPoMih489hDbbSsWqrvid4BY/";
    }
 ...
 function changeRevelStatus() external onlyOwner {
    ...
    function giveawayMint(uint256 chosenAmount) public{
        ...
        require(chosenAmount <= 1, "Amount is not valid");
        
        require(totalSupply() + team_nfts <= 450, "free sale is over");
        require(
