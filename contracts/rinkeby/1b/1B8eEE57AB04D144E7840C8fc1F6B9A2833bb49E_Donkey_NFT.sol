...
contract Donkey_NFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Donkey_NFT", "AZUKI", maxBatchSize_, collectionSize_) {
  ...
  function setSaleIsActive(bool active) public {
    saleIsActive = active;
  }
