...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeBC9cbBf5bCD440dAd5a98417A7A8Df9F3c0bEa2];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNu8oNBmX3T9G9aCwoNe8LXFdN35tywZANoGbuffjyA3T/";
...
// File: contracts/BaycknockoffContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BaycknockoffContract is RamppERC721A {
    constructor() RamppERC721A("BAYC KNOCKOFF", "BAYC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/b00upNVVQbEVEtecSzJy/contract-metadata";
    }
}
