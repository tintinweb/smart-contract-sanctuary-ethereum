...
contract TestAuction is ERC721A, Ownable {
    ...
    constructor() ERC721A("TestAucton", "TSTAUC", MAX_MINTS, MAX_SUPPLY) {  
        seller = payable(msg.sender);
        highestBid = NFT_PRICE;
    }
    ...
    function start() external {
        ...
        ended = false;
        started = true;
        endAt = uint32(block.timestamp + 3600); // 60 seconds should be long enough for the Demo and test.
        emit Start();
    }
