...
contract CCTATO is Ownable, ERC721A {
    ...
    uint256 constant public PUBLIC_MINT_LIMIT_WALLET = 5;


    

    string public revealedURI = "ipfs://bafybeibajytkcqdnstp7ye57alranmhmazmfr7nzofmvs2cjmslcoqrib4/";
    ...
    address public teamWallet = 0x8ff5fE2225BedD6C27CfD83c65003f64d2D3D3d2;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("CCTATO", "CCTATO") { }
