    ...
    PreAuthorization
{
        ...
        isMaxSupplyLimit(1)
    {
        ...
        emit TokenMinted(curTokenId, _metadataId, _msgSender());
    }
        ...
        isMaxSupplyLimit(_metadataIds.length)
    {
        ...
        for (uint256 i; i < _metadataIds.length; i++) {
            ...
            metadataIdToTokenId[_metadataIds[i]] = curTokenId;
            ...
            emit TokenMinted(curTokenId, _metadataIds[i], _msgSender());
        }
    }
