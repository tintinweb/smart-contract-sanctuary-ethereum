// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Head", unicode"Face", unicode"Eye", unicode"Nose", unicode"Mouth", unicode"Skin", unicode"Background"];
        bool private shouldWrapSVG = true;
        string private backgroundColor = "transparent";

        bool public isContractSealed;
        uint256 public constant maxSupply = 1002;
        uint256 public maxPerAddress = 50;
        uint256 public publicMintPrice = 0.050 ether;
        string public baseURI = "";
        bool public isPublicMintActive;
        
        ContractData public contractData = ContractData(unicode"FirstTestTwo", unicode"First test collection in indelibles two", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "", 0, "0x10EC407c925A95FC2Bf145Bc671A733D1fBa347E");

        constructor() ERC721A(unicode"FirstTestTwo", unicode"FTCTWO") {
            TIERS[0] = [9,11,14,17,18,19,21,23,30,34,39,39,45,54,70,129,143,287];
TIERS[1] = [2,2,7,16,26,32,38,38,47,57,63,69,83,84,174,264];
TIERS[2] = [26,55,66,86,122,191,456];
TIERS[3] = [96,104,148,260,394];
TIERS[4] = [1002];
TIERS[5] = [208,306,488];
TIERS[6] = [84,106,143,170,192,307];
        }
        ...
        function receive() external payable {
            mint(msg.value / publicMintPrice);
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"FirstTestTwo #");
