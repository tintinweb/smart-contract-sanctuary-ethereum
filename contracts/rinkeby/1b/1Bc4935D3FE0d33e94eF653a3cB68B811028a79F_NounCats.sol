...
contract NounCats is ERC721, ERC2981, Ownable {
  ...
  address public partner; // todo: remove
  ...
  constructor() ERC721("Noun Cats", "NOUNCATS") {
    _mint(msg.sender, 1); // todo: remove
  } // todo

  // constructor(address _partner) ERC721("Noun Cats", "NOUNCATS") {
  //   partner = _partner;
  //   _mint(msg.sender, 1);
  // }
  ...
  function burnAndReveal(uint256[] calldata _ids) external {
    ...
    // IInvisibles invis = IInvisibles(invisibles); // todo
    IInvisibles invis = IInvisibles(partner);
