...
// TODO:: Update constructor args, codename, payment splitter?
contract FriedmansRevenge is ERC721A, Ownable {
    ...
    // Tracking how many mints an address has done in pre-sale. Can mint up to 5
    ...
    // TODO: remove, a temporary address to get our valuable Rinkeby ETH back.
    ...
    constructor() ERC721A("Friedmans Revenge", "REVENGE") {
      withdrawAddress = msg.sender; // Temp, for testing
    }
    ...
    function presaleMint(bytes32[] calldata _merkleProof, uint _amount) external payable {
      ...
      // require(_amount < 6, "Can only mint 5");
    ...
    /// @notice Returns an array of ids for a specific wallet
