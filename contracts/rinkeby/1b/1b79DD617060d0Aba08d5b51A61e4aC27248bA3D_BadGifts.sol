...
contract BadGifts is ERC721, Ownable {
    ...
    mapping(uint256 => bool) private _giftMessagesChangeable;
    ...
    function mint(
        ...
        for (uint256 i; i < amount; i++) {
            ...
            _giftMessagesChangeable[tokenId] = true;
        }
    }
