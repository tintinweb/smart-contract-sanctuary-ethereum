...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAeac71d91d2251a8B5365d244Eaf20599Acc5506];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmdjrdtau4oaCmPZMhJC7FwvpGhtWDfQqVSr4xqAXwwSck/";
...
// File: contracts/PixietownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixietownwtfContract is RamppERC721A {
    constructor() RamppERC721A("pixietownwtf", "PIXIE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/hYCilA6C4pCe6lg1Jdx4/contract-metadata";
    }
}
