...
contract HeartsNFT is ERC721URIStorage, Ownable {
    ...
    function heartToImageURI(string memory _word, string[4] memory colorArray) private pure returns (string memory finalHeart) {
        ...
        finalHeart = combiner(partHeartOne,partHeartTwo,sixSVG);
