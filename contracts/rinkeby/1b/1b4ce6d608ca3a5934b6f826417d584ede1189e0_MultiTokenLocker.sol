...
contract MultiTokenLocker is Ownable {
    ...
    function receiveApproval(IBEP20 _token, uint256 _value, address _distributorContract, uint256 _lockingPeriod) external onlyWhitelisted returns(bool) {
    ...
    function withdrawThisToken(address _distributorContract, address _to, uint _lockId) public onlyOwner {
        ...
        IBEP20(rewardToken).safeTransfer(_to, amount);
    }
    ...
    // function to whitelist the _distributorContract (ie xShib/xDona/fFlame-FlameDistributor & SwapRewardDistributor contracts)
