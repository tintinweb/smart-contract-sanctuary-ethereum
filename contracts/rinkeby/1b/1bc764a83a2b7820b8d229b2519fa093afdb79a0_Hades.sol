...
contract Hades is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6f9753730fF956D2cdf66A6Bd69145f7a9fb633F);
    address payable private constant initialLpReceiver = payable(0x1D6eE36D23012660DfFd470e9142736E7d3F3C77);
    address private DAI = 0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C;
    ...
    function launch(uint256 _snipePenaltyBlocks, uint256 _sellPenaltyBlocks) external onlyOwner {
        ...
        require(balanceOf(address(DAI)) > 0, "Must have DAI on contract to launch");

        _approve(address(this), address(dexRouter), balanceOf(address(this)));
        _approve(address(this), address(dexRouter), balanceOf(DAI));

        dexRouter.addLiquidity{value: balanceOf(DAI)}(
            address(this),
            DAI,
