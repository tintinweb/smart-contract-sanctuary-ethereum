...
contract LazarusNFT is ERC721, Ownable {
  ...
  uint16 public immutable _totalSupply;
  ...
  constructor(string memory preRevealURI, string memory provenanceHash, uint16 totalSupply) ERC721 ("Lazarus: Disciples", "LAZD") {
    _couponSigner = owner();
    ...
    external
  {
    ...
    // require that the _totalSupply has not been reached
    require(_mintIndex < _totalSupply, "Minting limit reached.");
