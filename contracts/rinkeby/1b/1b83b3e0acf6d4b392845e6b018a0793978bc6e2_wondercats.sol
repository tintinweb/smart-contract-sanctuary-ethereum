...
contract ERC721A is IERC721A {
    ...
    // function seeTimestamp() public view virtual override returns (uint64 memory) {
...
contract wondercats is Ownable, ERC721A {
    ...
    uint64  public blockTimestamp               = 0;
    ...
    modifier mintCompliance() {
        ...
        require(blockTimestamp < block.timestamp, "Invalid timestamp!");
        _;
    }
    ...
    function setTimestamp(uint64 _newTimestamp) public onlyOwner {
        blockTimestamp = _newTimestamp;
    }
