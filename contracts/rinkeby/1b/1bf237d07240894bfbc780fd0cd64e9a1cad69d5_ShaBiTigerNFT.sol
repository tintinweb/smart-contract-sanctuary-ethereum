...
// File contracts/ShaBiTigerNFT.sol


pragma solidity ^0.8.7;

contract ShaBiTigerNFT is ERC721, Ownable {
...
abstract contract Revealable is ShaBiTigerNFT {
...
abstract contract Presaleable is ShaBiTigerNFT {
...
contract ShaBiTigerNFTPresaleReveal is ShaBiTigerNFT, Revealable, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        uint32 _totalSupply,
        bool _open
    ) ShaBiTigerNFT(_uri, _name, _symbol, _totalSupply, _open) {}
