...
/// @title: Poetry by RachelG.ETH / Poesie par RachelG.ETH
/// @author: manifold.xyz
...
//                                                                                     //
//                                                                                     //
//    ...=. POETRY BY RACHELG.ETH .=...                                                //
//    .=... POESIE PAR RACHELG.ETH ...=.                                               //
//    ...=. 2008 - 2022 .=...                                                          //
//         ,         ,                                                                 //
//         |\\\\ ////|                                                                 //
//         | \\\V/// |                                                                 //
...
//           \|===|/                                                                   //
//            '---'                                                                    //
//    .=... A POETRY BOOK BY RACHELG.ETH ...=.                                         //
//    ...=. UN LIVRE DE POESIE PAR RACHELG.ETH .=...                                   //
//                 ,   ,                                                               //
//                /////|                                                               //
//               ///// |                                                               //
//              |~~~|  |                                                               //
...
//              |===|/                                                                 //
//              '---'                                                                  //
//    ...=. WITH ALL TRANSLATIONS IN FRENCH BY RACHELG.ETH .=...                       //
//    .=... AVEC TOUTES TRADUCTIONS EN LE FRANCAIS PAR RACHELG.ETH ...=.               //
//                                                                                     //
//    IPFS MAIN DOWNLOAD:(cid addy)                                                    //
//          []=[]=[] MIRROR 1: (ADDY) []=[]=[]                                         //
//       []=[]=[]=[] MIRROR 2: (ADDY) []=[]=[]=[]                                      //
//    []=[]=[]=[]=[] MIRROR 3: (ADDY) []=[]=[]=[]=[]                                   //
//                                                                                     //
...
contract PRG is ERC721Creator {
    constructor() ERC721Creator("Poetry by RachelG.ETH / Poesie par RachelG.ETH", "PRG") {}
}
