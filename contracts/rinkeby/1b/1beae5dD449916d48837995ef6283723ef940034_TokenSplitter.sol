...
/**
 * @title TokenSplitter
 * @notice It splits RYLT to team/treasury/trading volume reward accounts based on shares.
 */
contract TokenSplitter is Ownable, ReentrancyGuard {
    ...
    // Total RYLT tokens distributed across all accounts
    ...
    /**
     * @notice Release RYLT tokens to the account
    ...
    function releaseTokens(address account) external nonReentrant {
        ...
        uint256 totalTokensReceived = ryltToken.balanceOf(address(this)) + totalTokensDistributed;
        ...
        ryltToken.safeTransfer(account, pendingRewards);
    ...
    /**
     * @notice Retrieve amount of RYLT tokens that can be transferred
     * @param account address of the account
     */
