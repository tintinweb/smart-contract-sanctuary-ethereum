...
contract ColorsWtf is ERC721Full {
                    ...
                    bytes(
                        abi.encodePacked(
                            '<svg width="500" height="500" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">'
                                ...
                                "</style>"
                                '<rect width="500" height="500" style="fill:rgb', rgbString, ';"/>'
                                '<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" class="normal">', rgbString, "</text>"
                            "</svg>"
                        )
                    )
                )
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(
                    "["
                        '{"trait_type":"rgb","value":"', rgbString, '"},'
                        '{"trait_type":"html","value":"', htmlColor, '"},'
                    "]"
                )
            );
    }
        ...
        returns (string memory rgbString)
    {
        ...
        return
            string(
                abi.encodePacked(
                    "(", Strings.toString(r), ", ", Strings.toString(g), ", ", Strings.toString(b),")"
                )
            );
    }
