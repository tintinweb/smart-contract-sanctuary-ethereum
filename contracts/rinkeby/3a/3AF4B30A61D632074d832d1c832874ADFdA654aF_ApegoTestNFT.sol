...
contract ApegoTestNFT is ERC721, ERC721Enumerable, Pausable, AccessControl {
    ...
    function rebirthShark(uint256 _sharkId, uint256 _genes)
        external
    ...
    function retireShark(uint256 _sharkId) external onlyRole(MINTER_ROLE) {
        _burn(_sharkId);
    ...
    function evolveShark(uint256 _sharkId, uint256 _newGenes)
        external
        onlyRole(MINTER_ROLE)
    {
