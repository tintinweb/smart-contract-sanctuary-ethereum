...
// File: contracts/AlphaSharks.sol
...
/**
 * Interface for SharkTokens
 */
interface ISharkTokens {
...
contract AlphaSharks is AccessControl, ERC721A, Ownable {
    ...
    ISharkTokens public SharkTokens;
        ...
        onlyRole(DAO_ROLE)
    {
        ...
        SharkTokens = ISharkTokens(_sharkToken);
        emit SetSharkTokens(_sharkToken);
    }

    uint256 public MAXIMUM_SUPPLY = 6969;
    string public BASE_URI =
        "ipfs://QmUHXQuEeMQNKPAgn6ykKA5GEG16w3jaPg6FfG2ZoLuQXi/";
