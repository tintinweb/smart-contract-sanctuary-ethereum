...
// Raffle
// Enter the lottery (with pay)
// Pick a random winner (must be from decentralized (oracle))
// Winner to be selected every x minutes/days/months etc (automated)
// Chainlink Oracle -> randomness, automation
...
/**
 * @title A practice raffle contract
 * @author Armin
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    enum RaffleState {
        OPEN,
        CALCULATING
    } // same as saying 0 = OPEN, 1 = CALCULATING
    ...
    function performUpkeep(
        ...
        emit RequestedRaffleWinner(requestId); // this is redundunt since the vrf coordinator already emits an event, this is just for demostration purposes
    }
     ...
     * 2. The lottery should have at least 1 player and have some ETH (contract has balance)
