...
contract DummyContract is ERC721, Ownable{
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter public tokenIdCounter;

    constructor() ERC721("Alchemy", "AC") {}

    uint256 public nftPrice = 0.001 ether;
    uint256 public totalSupply;
    uint256 public maxSupply = 100;
    address public withdrawAddress = 0x3e284cd6e463e8263E832F8390cE7E4c844D2b96;
    string public theBaseURI = "";

    function safeMint() public payable {
        require(msg.value >= nftPrice, "Error: Not enough funds were sent.");
        require(tokenIdCounter.current() < maxSupply, "Error: All NFTs are minted out");
