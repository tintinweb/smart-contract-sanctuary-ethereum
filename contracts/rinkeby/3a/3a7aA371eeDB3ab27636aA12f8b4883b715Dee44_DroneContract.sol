...
contract DroneContract is Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable , UUPSUpgradeable
{
  ...
  //// added in upgrade
    ...
    function store_value_1(uint256 newValue) public {
        value = newValue;
        emit ValueChanged(newValue);
    }
 
    // Reads the last stored value
    function retrieve_value_1() public view returns (uint256) {
        return value;
    }
