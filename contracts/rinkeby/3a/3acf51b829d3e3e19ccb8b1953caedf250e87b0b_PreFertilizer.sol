...
contract PreFertilizer is MintFertilizer {
    ...
    function _transfer(
        ...
        if (from == address(0)) return _mint(to, id, amount);
        ...
        _balances[id][to].amount += _amount;
    }
    ...
    function _mint(
        ...
        _balances[id][to].amount += uint128(amount);
    }
}
...
contract MintFertilizer is OwnableUpgradeable, ReentrancyGuardUpgradeable, Fertilizer1155 {
    ...
    address constant CUSTODIAN   = 0xA3D5F4042899a52f2ae7A0Cc58C079EFB62B9e43;
    ...
    function buyAndMint(uint256 buyAmount) external payable {
    ...
    function getMintId() public view virtual returns (uint256) {
        return 6074;
    }
