...
contract RevestCommuniSea is IOutputReceiverV3, Ownable, ERC165, IFeeReporter, ReentrancyGuard {
    ...
    uint public slots_remaining = 100;
    ...
    function depositToEscrow() external nonReentrant returns (uint fnftId) {    
        // Only supports 100 deposits
        require(slots_remaining > 0);
        slots_remaining--;
    ...
    function setSlotsRemaining(uint _slots) external onlyOwner {
        slots_remaining = _slots;
    }
