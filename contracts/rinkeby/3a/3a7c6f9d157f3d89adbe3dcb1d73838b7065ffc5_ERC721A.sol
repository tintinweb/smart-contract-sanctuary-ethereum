...
contract OtheRealms is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmW9Xb8ivnx1GDsQ9S2tik7c5N1j3K7AVCJtsQBmxghw7x/";
    ...
    constructor(string memory initBaseURI) ERC721A("OtheRealms", "OR") {
        baseURI = initBaseURI;
