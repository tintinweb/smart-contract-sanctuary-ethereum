...
contract MetaKith2NFT is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("MetaKith2", "KITH2") {
        setBaseURI(baseURI);
    }
    ...
    function safeTransferFromContract( address from, address to, uint256 tokenId ) public virtual {
        ERC721(to).safeTransferFrom(from, to, tokenId);
    }
