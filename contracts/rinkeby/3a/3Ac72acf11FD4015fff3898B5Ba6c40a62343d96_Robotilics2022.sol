...
contract Robotilics2022 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Robotilics 2022", "RBs") {
    setHiddenMetadataUri("ipfs://QmSwjtA5U2DB2s1tFxHtAYUE8ZnZbix1cojhTY3b41x3fb/hidden.json");
  }
