...
contract zhangsan is ERC721A, Ownable {
    enum Status {
        Waiting,
        Started,
        Finished,
    ...
    uint256 public  PRICE = 0.10000 ether;
    ...
    constructor(string memory initBaseURI, string memory initNotRevealeUri) ERC721A("zhangsan", "nh") {
        baseURI = initBaseURI;
