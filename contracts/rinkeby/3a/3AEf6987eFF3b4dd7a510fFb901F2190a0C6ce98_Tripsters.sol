    ...
    ERC2981ContractWideRoyalties
{
    ...
    function updateMaxSupply(uint256 _supply) external adminOrOwner {
        maxSupply = _supply;
    }
    ...
    function togglePioneerLive() external adminOrOwner {
        bool isLive = !pioneerLive;
        pioneerLive = isLive;
        emit PioneerLive(isLive);
    }

    function toggleOgLive() external adminOrOwner {
        bool isLive = !ogLive;
        ogLive = isLive;
        emit OgLive(isLive);
    }
