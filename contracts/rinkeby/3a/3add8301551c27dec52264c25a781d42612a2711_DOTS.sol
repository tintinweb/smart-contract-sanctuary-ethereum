...
contract DOTS is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = "ipfs://bafybeich3u5hegi7kme6nnej43zgmceu4kdtqcbvu7abruyl5pfjmez7l4";
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("DOTS", "DOTS") {
        setHiddenMetadataUri("");
    }

    uint256 public price = 0.0002 ether;
    uint256 public maxPerTx = 40;
    uint256 public maxPerFree = 40;    
    uint256 private maxFreeSupply = 0;
  ...
  bool public revealed = true;
    ...
    function mint(uint256 count) external payable {
        ...
        emit Minted(msg.sender, tokenURI(max_Supply), block.timestamp);
    }
