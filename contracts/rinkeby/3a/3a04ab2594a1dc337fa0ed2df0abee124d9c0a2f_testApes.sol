...
contract testApes is ERC721A("Dump Apes", "DAPS"), Ownable, ReentrancyGuard{
    ...
    string public uriPrefix = "https://bafybeiesnd7io7mwv2iy5mk7ilu2hrd6cva6ta5757vhksgospogs6mwe4.ipfs.nftstorage.link/";
    ...
    function TeamDumpApes() external onlyOwner {
        uint256 _AllDumpApes = totalSupply();
        require(_AllDumpApes+ 400 <= AllDumpApes, "Exceed Total DumpApes");
        require(_FreeDumpApesCount[msg.sender] <= 400 , "Team has already dumped apes");
        _FreeDumpApesCount[msg.sender] = 400;
        _safeMint(msg.sender, 400);
