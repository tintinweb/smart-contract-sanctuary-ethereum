...
contract ERC721AMerkle is Ownable, PaymentSplitter, ERC721A, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeMath for uint8;

    // uint256 public immutable MAX_SUPPLY = 9141;
    uint256 public immutable MAX_SUPPLY = 30;
    uint256 public constant PRICE = 10_000_000_000_000_000; // 0.01 ET
    ...
    constructor(
        ...
        ERC721A(name, symbol, _maxPublicTx, _amountForTeam)
        ...
        nonReentrant
    {
        ...
        require(
            _preSaleListCounter[msg.sender].add(quantity) <= maxPresale,
        ...
        callerIsUser
    {
        ...
        require(PRICE * quantity == msg.value, "Incorrect funds");
        require(quantity <= maxPublic, "exceeds max per transaction");
        require(
