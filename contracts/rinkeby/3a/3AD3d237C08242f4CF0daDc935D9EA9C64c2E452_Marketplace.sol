...
contract Marketplace is ERC721Pausable, AccessControl, Ownable {
    ...
    constructor() public ERC721('ViMarket', 'VSR') {
      ...
      function mint(address platform_owner, address seller, address miner, uint256 amount_to_miner, uint256 amount_to_platform_owner, uint256 amount_to_seller) public payable {
         require(msg.value >= (amount_to_platform_owner+amount_to_seller), 'Value below price');
        _mint(msg.sender, nextTokenId);
        transferToCommission(platform_owner, amount_to_platform_owner);
