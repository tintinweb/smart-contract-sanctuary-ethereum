...
contract KokalarSkull is ERC721A, Ownable{
    ...
    uint128 public constant Max_Mint_Quantity = 10008;
    uint128 public constant Max_Supply = 10008;
    ...
    constructor(string memory _NAME, string memory _SYMBOL, bytes32 _merkleRoot)
    ...
    function mintVaroni(uint32 _quantity, bytes32[] calldata merkleProof, uint256 maxAmount) external payable {
