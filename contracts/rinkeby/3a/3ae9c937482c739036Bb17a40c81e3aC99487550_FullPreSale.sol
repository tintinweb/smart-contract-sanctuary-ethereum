...
contract FullPreSale is ERC721Enumerable, Ownable
{
...
uint public maxQuantity;
bool public isPaused = true;
uint public preSaleSupply;
uint public maxPreSaleQuantity;
bool public isPreSalePaused=true;
 mapping (address => bool) public whitelistAddress;
    ...
    constructor(string memory baseURI,uint _basePrice,uint _baseSupply,uint _maxQuantity,uint _preSaleSupply,uint _maxPreSaleQuantity,string memory contractName,string memory contractSymbol) ERC721(contractName,contractSymbol)  {
        basePrice=_basePrice;
        baseSupply=_baseSupply;
        maxQuantity=_maxQuantity;
        preSaleSupply=_preSaleSupply;
        maxPreSaleQuantity=_maxPreSaleQuantity;
    ...
    function mint(uint chosenAmount) public payable   {
        ...
        require(baseSupply>=TotalSupply()+chosenAmount,"Quantity is greater than remainig base supply");
...
function addlist(address[] memory _enter) public onlyOwner{
      for (uint256 i = 0; i < _enter.length; i++) {
        whitelistAddress[_enter[i]] =true;
    }
// whitelistAddress [_enter]=true;//adress has been added to th 
}
    ...
    function preSaleMint(uint quantity)  public payable   {
        ...
        // require(numberOfTo <= _allowList[msg.sender], "Exceeded max available to purchase");
        require(whitelistAddress[msg.sender],"should be included in white list");
