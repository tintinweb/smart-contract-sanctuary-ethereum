...
contract LITNFT is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    /// @notice Returns a list of all LIT NFTs Token IDs assigned to an address.
    /// @param _address The owner whose LOST we are interested in.
    /// @dev This method MUST NEVER be called by smart contract code. First, it's fairly
    ///  expensive (it walks the entire LIT NFT array looking for cats belonging to owner),
    ///  but it also returns a dynamic array, which is only supported for web3 calls, and
    ///  not contract-to-contract calls.

    /// <3 Thank you cryptokitties
