...
contract Cult is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable,ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OFT{
    ...
    function initialize(        
        ...
        OFTInit("Cult DAO", "CULT", _lzEndpoint);
...
abstract contract OFT is OFTCore, ERC20Upgradeable, IOFT {

    function OFTInit(string memory _name, string memory _symbol, address _lzEndpoint) internal virtual {
         OFTCoreInit(_lzEndpoint);
         ERC20Upgradeable.__ERC20_init(_name, _symbol);
    }
    
    function supportsInterface(bytes4 interfaceId) public view virtual override(OFTCore, IERC165Upgradeable) returns (bool) {
...
abstract contract OFTCore is NonblockingLzApp, ERC165Upgradeable, IOFTCore {
    ...
    function OFTCoreInit(address _lzEndpoint) internal virtual {
        NonblockingappInit(_lzEndpoint);
    }
...
abstract contract NonblockingLzApp is LzApp {
    ...
    function NonblockingappInit(address _endpoint) internal virtual {
         LzAppInit(_endpoint);
    }
 ...
 */
interface IOFTCore is IERC165Upgradeable {
    /**
...
abstract contract LzApp is OwnableUpgradeable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    // }
    function LzAppInit(address _endpoint) internal virtual {
        lzEndpoint = ILayerZeroEndpoint(_endpoint);
    }
