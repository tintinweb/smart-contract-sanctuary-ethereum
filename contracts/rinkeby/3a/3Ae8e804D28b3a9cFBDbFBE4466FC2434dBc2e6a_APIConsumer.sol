...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
  ...
  function requestTempData() public returns (bytes32 requestId) {
    ...
    request.add("get", "https://api.openweathermap.org/data/2.5/weather?lat=13.75&lon=100.5176&appid=ee352928f39ded5df92b5f85fc1ff728&units=metric");
  ...
  function fulfill(bytes32 _requestId, uint256 _temp)
    public
