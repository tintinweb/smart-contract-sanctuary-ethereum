...
contract MyNFT is AccessControl, IERC721Receiver, ERC721Enumerable, ERC721Burnable  {

    using Counters for Counters.Counter;
    using Strings for uint256;
    Counters.Counter private _tokenIdCounter;

    string public baseUri = "ipfs://QmfLedgMMgXgvGo3kkerf83t9x9VoyG4rRtZ8foBUUiGm5/";
    string public uri_suffix=".json";
    bytes32 public constant MINT_ROLE = keccak256("MINT_ROLE");

    constructor() ERC721("Test", "My NFT") {
