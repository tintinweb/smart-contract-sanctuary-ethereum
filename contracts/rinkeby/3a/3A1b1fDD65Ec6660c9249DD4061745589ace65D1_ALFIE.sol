...
contract ALFIE is ERC721Tradable {
    ...
    // Max number of Alfies that can be purchased during presale mint
    uint256 public maxAlfiePurchasePresale = 2;

    // Max number of Alfies that can be purchased during Mint
    uint256 public maxAlfiePurchase = 5;

    uint256 public constant maxAlfies = 8;
    ...
    /** TODO: add recover erc20 function */
    ...
    function presaleMintAlfie(uint256 numberOfTokens, bytes32[] memory proof) public payable {
        ...
        require(merkleRoot != 0, 'Presale has not started yet');
