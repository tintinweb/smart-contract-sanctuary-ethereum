...
contract PaperBagGuyNFT is Ownable, RoyaltiesAddon, ERC2981 {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public MAX_ELEMENTS = 1449;
    ...
    constructor(string memory baseURI) ERC721("Paper Bag Guy NFT", "PBG"){
        setBaseURI(baseURI);
    }
