...
contract NineTalesTwo is ERC721A, Ownable, ReentrancyGuard {
  constructor() ERC721A("be2f3bcc13d1da04e444bd981ca7c272", "NT2TEST") {}

using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public NTT_PUBLIC_PER_USER = 2;
    uint256 public  NTT_WHITELIST = 12; //999
    uint256 public  NTT_GIFT = 3; //200
    uint256 public  NTT_PUBLIC = 5; //8800
    uint256 public constant NTT_MAX_SUPPLY = 20;
    ...
    address private _ownerAddress = 0xaE56e560153eCBC543385dD7BCB618E69b3554D0;
    ...
    // event PrintSignature(bytes32 hash);
    // event PrintToConsole(address addr, bytes signature, uint64 tokenQuan, uint256 limit);
    ...
    //This can save about 5-10k in gas for the first transaction
