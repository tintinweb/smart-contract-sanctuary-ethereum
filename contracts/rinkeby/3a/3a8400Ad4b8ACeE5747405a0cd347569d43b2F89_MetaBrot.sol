...
abstract contract ERC721TradableMetaBrot is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    uint256 public constant maximumPieces = 4000;
...
// TO-DO:
// Change community & metabrot wallets
// Create collection's JSON
// Remove ~200-300 pieces from the max that can be sold in the pre-sale
// 
...
contract MetaBrot is ERC721TradableMetaBrot {
    ...
    address constant public  MetaBrot_WALLET  = 0xB4EF72BeD4653a8100841BfF7E1Ad4dBEb5ebDC3;
    ...
    function contractURI() public view returns (string memory) {
        return strConcat(_theBaseURI,"collection.json");
    }
    ...
    modifier onlyDeployer() {
        require((owner() == _msgSender() || MetaBrot_WALLET == _msgSender()), "You are not MetaBrot!");
        _;
    }
