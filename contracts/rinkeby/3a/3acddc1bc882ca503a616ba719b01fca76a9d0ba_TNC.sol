...
// Dependency file: contracts/ERC721Tradable.sol
...
/**
 * @title TNC
 * TNC - a contract for my non-fungible TNCs.
 */
contract TNC is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("TNC", "TNC", _proxyRegistryAddress)
    {}
    ...
    function contractURI() public pure returns (string memory) {
        return "https://raw.githubusercontent.com/shazuio/metadata/main/metadata.json";
    }
}