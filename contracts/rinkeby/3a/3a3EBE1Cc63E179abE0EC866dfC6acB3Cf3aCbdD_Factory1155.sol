...
import "./RareNFTUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new RareNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        RareNFTUser1155Token token = RareNFTUser1155Token(address(addr));
...
contract RareNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
