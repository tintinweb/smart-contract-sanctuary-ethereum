...
import {SemVer} from "./interface/SemVer.sol";
...
contract MessageToken is ERC721Enumerable, AccessControl, Ownable, IERC2981 {
    ...
    bytes32 public constant SEMVER_UPDATER_ADMIN = keccak256("SEMVER_UPDATER_ADMIN");
    ...
    bytes32 public constant SEMVER_UPDATER_ROLE = keccak256("SEMVER_UPDATER_ROLE");
    ...
    // tokenId -> version
    mapping(uint256 => SemVer) public versions;

    // ====================================

    // ============= EVENTS ================
    event SemVerUpdated(uint256 indexed tokenId, SemVer latest);
    ...
    constructor(
        ...
        _setRoleAdmin(SEMVER_UPDATER_ADMIN, SEMVER_UPDATER_ADMIN);
        _setRoleAdmin(SEMVER_UPDATER_ROLE, SEMVER_UPDATER_ADMIN);
        ...
        _grantRole(SEMVER_UPDATER_ADMIN, _teamLabMultisig);
        ...
        _grantRole(SEMVER_UPDATER_ROLE, _teamLabMultisig);
    ...
    function setSemVer(uint256 _tokenId, SemVer calldata _version) external
        onlyRole(SEMVER_UPDATER_ROLE)
        onlyValidTokenId(_tokenId)
    {
        versions[_tokenId] = _version;
        emit SemVerUpdated(_tokenId, _version);
    }
