 ...
 *
 */
contract LL420Reveal is VRFConsumerBaseV2, Ownable, Pausable {
     ...
     *
     */
    function reveal(uint256 _id, uint256[] memory _ids) external whenNotPaused {
     ...
     */
    function setContracts(address _stakingAddress) external onlyOwner {
