...
contract VQ2 is ERC721, Ownable {
    // Token mint values
    uint256 public constant MAX_QUESTIONS = 8888;
    ...
    bool public _publicMintStatus = false;
    string public _baseTokenURI;

    // For bit manipulation
    uint256[] _allowListTicketSlots;
    mapping(address => uint256) vq1TicketList;
    ...
    function presaleListMintMultiple(
        ...
        require(currentId < MAX_QUESTIONS, "VQ2: Exceeds Supply");
    ...
    function reservedMint() external onlyOwner {
        ...
        require(_publicMintStatus == false, "VQ2: Reserved mint closed");
        require(reserved > 0, "VQ2: No more reserve mints left");

        for (uint256 i; i < 20; i++) {
            _mint(msg.sender, currentId++); // try ++currentId
        }
