...
contract MatchContract is Ownable {
    struct MatchData {
        ...
        uint256 tokenAmount;
        string location;
        uint8 team1CountryGoles;
        uint8 team2CountryGoles;
    ...
    function setAirdropAmount(uint256 _roundId, uint256 _amount)
        public
        onlyOwnerAndAdmin
    {
    ...
    function setMatchData(
        ...
        matchesInfo[_matchId] = MatchData({
            ...
            location: _location,
            team1CountryGoles:_team1CountryGoles,
            team2CountryGoles:_team2CountryGoles
        });
    ...
    function setAllMatchData() internal{
        ...
        team1CountryGoles :matchesInfo[i].team1CountryGoles,
        team2CountryGoles:matchesInfo[i].team2CountryGoles
        }) 
            );
        } 
