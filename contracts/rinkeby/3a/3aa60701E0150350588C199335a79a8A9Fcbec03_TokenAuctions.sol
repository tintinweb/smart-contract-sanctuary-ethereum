    ...
    RoyaltiesV2Impl
{
    ...
    event UpdatedMinimumBidThreshold(
        uint256 newMinimumBidThreshold,
        address updatedBy
    );
    ...
    function updateMinimumBidThreshold(uint256 newMinimumBidThreshold)
        external
        onlyOwner
        returns (bool)
    {
        minimumBidThreshold = newMinimumBidThreshold;

        emit UpdatedMinimumBidThreshold(newMinimumBidThreshold, msg.sender);
        return true;
    }
