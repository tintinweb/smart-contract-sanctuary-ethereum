...
contract JustASquareERC721A is ERC721A, Ownable {
	...
	uint256 private cost = 0.005 ether;
	uint256 private costFree = 0;
	uint256 public maxSupply = 2000;
	uint256 public maxSupplyFree = 10; //1000
 ...
 */
contract ERC721A is ERC165, IERC721A {
	 ...
	 */
	function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC721A) returns (bool) {
