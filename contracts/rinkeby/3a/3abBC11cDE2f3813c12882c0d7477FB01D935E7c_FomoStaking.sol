...
contract FomoStaking is Pausable, Ownable, AccessControlEnumerable {
  ...
  //input
  address public tokenAddress = 0xCD6D970ED9A4BEbf9f36dc06D420d446300a2Ffb;
  uint256 public interestRate = 1800; //18 Percent
  ...
  function deposit(uint256 _amount) external whenNotPaused {
    ...
    //        require(_amount <= token.balanceOf(_msgSender()), "not enough balance.");
