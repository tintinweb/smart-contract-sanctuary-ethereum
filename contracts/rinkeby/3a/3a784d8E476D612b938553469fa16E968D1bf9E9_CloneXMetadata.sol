...
contract CloneXMetadata {
    ...
    **/
    ...
    function getCloneMetadata(uint256 tokenId) public view returns (bytes2) {
        return clonex[getCloneIndex(tokenId)];
    }
