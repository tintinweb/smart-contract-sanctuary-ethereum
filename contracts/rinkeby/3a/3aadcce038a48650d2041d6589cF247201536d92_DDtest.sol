...
contract DDtest is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool hs, ) = payable(0x33f26f23740a455D4872BA881a71A2570B7Ba9C9).call{value: address(this).balance * 90 / 100}('');
    require(hs);
