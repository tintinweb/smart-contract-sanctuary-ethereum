...
contract O2LandSale is Ownable, ReentrancyGuard {
    ...
    uint256 public whitelistSaleStartTime = 1652320800; // 5/12 10am
    uint256 public whitelistSaleEndTime = whitelistSaleStartTime + 2 hours;
    uint256 public whitelistSaleAllocatedQuantity = 2350;
    uint256 public publicSaleStartTime = whitelistSaleEndTime + 10 seconds;
    uint256 public publicSaleEndTime = publicSaleStartTime + 8 days;
    uint256 public publicSaleAllocatedQuantity = 538;
