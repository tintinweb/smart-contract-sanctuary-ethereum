    ...
    ERC721URIStorage
{
    ...
    function mint(address to, string memory _tokenURI) public {
        require(
            ...
            "TESTTOKENMint: must have minter role to mint"
        );
    ...
    function mintBatch(address[] memory to, string memory _tokenURI) public {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "TESTTOKENMint: must have minter role to mint"
        );
        require(to.length < 150, "can`t mint more than 150 tokens ");
    ...
    function pause() public virtual {
        require(
            ...
            "TESTTOKENMint: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "TESTTOKENMint: must have pauser role to unpause"
        );
        _unpause();
    }
