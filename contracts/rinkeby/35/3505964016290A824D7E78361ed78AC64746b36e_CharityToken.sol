    ...
    ERC2981
{
    ...
    function withdrawalAll() external {
        require(
            ...
            "ERC1155PresetMinterPauser: must have admin role to withdrawal"
        );
    ...
    function registerTokenForSale(
        ...
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "ERC1155PresetMinterPauser: must have minter role to register new tokens for sale"
        );
