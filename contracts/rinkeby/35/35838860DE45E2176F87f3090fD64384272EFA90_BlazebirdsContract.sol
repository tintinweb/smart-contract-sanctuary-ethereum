...
//
//     ____  __                 __    _          __    
//    / __ )/ /___ _____  ___  / /_  (_)________/ /____
//   / __  / / __ `/_  / / _ \/ __ \/ / ___/ __  / ___/
//  / /_/ / / /_/ / / /_/  __/ /_/ / / /  / /_/ (__  ) 
// /_____/_/\__,_/ /___/\___/_.___/_/_/   \__,_/____/  
//                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xb6f18715b187453B36894598534219D3134EFD6A];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xb6f18715b187453B36894598534219D3134EFD6A;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 420;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmP44C1yJENC1BAAimmGd3or8XXY2Fsuk8ZBm2Yu483irj/";
...
// File: contracts/BlazebirdsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BlazebirdsContract is RamppERC721A {
    constructor() RamppERC721A("Blazebirds", "BBIRDS"){}
}
