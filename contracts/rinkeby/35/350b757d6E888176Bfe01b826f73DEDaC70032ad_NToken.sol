...
library Errors {
    ...
    string public constant PAYLATER_ORDER_DO_NOT_MATCH = "105"; //payLater ndoesn't match order.
    string public constant NO_PAYLATER = "106"; //payLater cannot be empty
    string public constant INVALID_PAYLATER_SIGNATURE = "107"; //invalid payLater signature.
