...
emit AFF4(commission, affiliate.shareValue, affiliate.walletAddress);
...
emit AFF_END();
    ...
    //=============================================================================
    function    renameDoolny(uint256 tokenId, string memory newName) external
    {
    ...
    //=============================================================================
    function    renameDoolnyByOwner(uint256 tokenId, string memory newName) external onlyOwner
    {
        doolnyNames[tokenId] = newName;
