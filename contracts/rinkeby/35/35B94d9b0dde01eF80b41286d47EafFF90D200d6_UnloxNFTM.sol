...
abstract contract NFTM is ReentrancyGuard, Ownable{
    ...
    function _centToWEI(uint256 centValue) internal view returns (uint256)
    {
        ...
        //receiveValue = 151840751810 = 151840.751810 cent

        //x wei = y cent
        //1 wei = 112.345678 / 10^18 cent
        //x/1 wei = y/(112.345678/10^18 cent)
        //x wei = (y * 10^18) / 112.345678

        //receiveValue = 112345678 = 112.345678 cent
        //1 eth = 1.12345678 usd
        //1 eth = 112.345678 cent
        //1 cent = 1/112.345678 eth
        //1 cent = (1/112.345678) * 10^18 wei
        //100 cent = 100 * ((1/112.345678) * 10^18) wei
        //returnValue = centValue * ((1/(112345678 / 10^6)) * 10^18) wei ******************
        //returnValue = centValue * 10^24/ethPrice
        //returnValue = 0.89010989813 * 10^18 wei
        uint256 pow = 10**24;
