...
contract HolyTokenTest is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint private maxSupply = 1000000000 * (10 ** 18); //1,000,000,000 ONE BILLION, Multiply base tokens by base decimals to get supply value
    uint256 private _totalSupply;
    uint8 public _decimals;
    string public _symbol;
    string public _name;

    address accessAuthority = 0xCf53CbE638CFE0Ba26B64dA7cd0f9617955Cfc83;
