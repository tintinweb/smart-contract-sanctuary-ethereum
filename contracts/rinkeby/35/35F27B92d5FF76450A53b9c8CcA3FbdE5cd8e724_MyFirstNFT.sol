...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmVDz7rA93dwsd14EWyqCzPGExdrfCWqUbKYzGPRBLu5Hi/"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("MCU_0114", "Wood") payable {
        // 剛開始我們先自己 Mint 一個
