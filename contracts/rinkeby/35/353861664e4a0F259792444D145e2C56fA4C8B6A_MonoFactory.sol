...
contract MonoFactory {
     ...
     * 
     * @param _name     The name of the token we want to deploy. 
     * @param _ticker   The ticker for the token we want to deploy.
     * 
     * @return address  The addresss of the proxy contract.
     ...
     *          3) Will transfer ownership of the proxyAdmin to governance
     *             address.
     */
    function deployMono(
        string memory _name, 
        ...
        TokenProxy monoProxy = new TokenProxy(address(impl), address(monoProxyAdmin), "");
        Mono monoProxied = Mono(address(monoProxy));
        monoProxied.initialize(_name, _ticker);
