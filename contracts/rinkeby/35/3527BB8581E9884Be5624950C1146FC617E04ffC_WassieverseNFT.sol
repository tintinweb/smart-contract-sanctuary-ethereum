...
abstract contract RandomnessBatches is Ownable {
...
abstract contract TokenURI is Ownable {
    ...
    /// Allows the owner to set a new URI for metadata containing animated assets
    ...
    function setAnimatedURI(string memory _animatedBaseURI) external onlyOwner {
    ...
    function commitAnimatedURI() external onlyOwner {
    ...
    ERC2981
{
    ...
    //
    // Pre-minting admin settings
    // Gm fellow crustacean auditors. This is where you can check we're not rug pulling you
    //
    ...
    function publicReveal(uint256 _batchIdx) external {
