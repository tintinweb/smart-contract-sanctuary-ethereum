...
// File: contracts/HarmonyDragons.sol
...
contract OscarSlaps is ERC721EnumerableLite, Ownable, PaymentSplitter {
    ...
    address[] private addressList = [0x506642b59690fee83578aB671991eB9376DAE141, 0x9baBaBD88cC643399eB98f20710E041F9E40323D, 0x7e5aa86d96f2F2f047afe6577033c0d6C093D924];

    uint256[] private shareList = [15, 40, 45];

    constructor() ERC721B("OscarSlaps", "SLAPS") PaymentSplitter(addressList, shareList) {}
    ...
    function freeMintsRemaining(address addr) public view returns (uint256 remaining) {
