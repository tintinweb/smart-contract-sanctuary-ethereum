...
contract DreamNftTokenV2 is Context, ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
...
function burnGen(uint256 tokenId) public virtual { 
    require(_msgSender() == callerAddress, 'Called from a wrong contract');
