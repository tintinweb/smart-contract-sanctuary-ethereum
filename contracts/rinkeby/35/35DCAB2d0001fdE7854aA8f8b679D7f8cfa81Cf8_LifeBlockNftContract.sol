...
//*********************************************************************//
//
//     __    _ ____     ____  __           __      _   ______________
//    / /   (_) __/__  / __ )/ /___  _____/ /__   / | / / ____/_  __/
//   / /   / / /_/ _ \/ __  / / __ \/ ___/ //_/  /  |/ / /_    / /   
//  / /___/ / __/  __/ /_/ / / /_/ / /__/ ,<    / /|  / __/   / /    
// /_____/_/_/  \___/_____/_/\____/\___/_/|_|  /_/ |_/_/     /_/     
//                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x7E1F8EA370c56062DeeAD8a01555b09D55e6ca6E];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x7E1F8EA370c56062DeeAD8a01555b09D55e6ca6E;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 100000000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmdcoihtoc2q74stFRqkMuCMk2ah3hiiWppBn45jLHqGLu/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 100000000");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 100000000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 100000000");
...
// File: contracts/LifeBlockNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LifeBlockNftContract is RamppERC721A {
    constructor() RamppERC721A("LifeBlock NFT", "RAMPP"){}
}
