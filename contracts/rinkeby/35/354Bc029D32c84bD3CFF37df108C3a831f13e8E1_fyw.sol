...
import "https://github.com/LayerZero-Labs/LayerZero/blob/main/contracts/interfaces/ILayerZeroUserApplicationConfig.sol";
...
contract fyw is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("fengyaoweiV2", "fywV2") { 
        _owner = msg.sender;
