...
contract TaraxiaVIPCard is Ownable, ERC721A , RoyaltiesV2Impl {
    ...
    bool public useCode = true;

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721A("Taraxia VIP Card", "Taraxia VIP Card") {}
    ...
    function mint(uint256 _mintAmount,string memory _code) public payable mintCompliance(_mintAmount) {
        require(!paused, "The contract is paused!");
        if(useCode == true){
            require(compareCodes(code,_code), "Wrong code!");
        }
    ...
    function compareCodes(string memory a, string memory b) public pure returns (bool) {
    ...
    function setCode(string calldata _code) external onlyOwner {
        code = _code;
    }
    ...
    function setUseCode(bool _state) public onlyOwner {
        useCode = _state;
    }
