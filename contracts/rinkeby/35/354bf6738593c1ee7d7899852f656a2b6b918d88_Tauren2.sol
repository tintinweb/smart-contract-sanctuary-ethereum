...
contract Tauren2 is ERC721A, Ownable {
    using Strings for uint256;
            ...
            return
                bytes(baseURI).length > 0
                    ? string(
                        abi.encodePacked(
                            baseURI,
                            "ipfs://QmeN3RL2GV2h63DXDA5jnJZp8D4UKT2KNoYoBtg9e9i93S/",
                            tokenId.toString(),
                            ".json"
                        )
                    )
            ...
            return
                bytes(notRevealedURI).length > 0
                    ? string(
                        abi.encodePacked(
                            notRevealedURI,
                            "ipfs://QmTgaUBwz2k2koi6Wb3qt3jUgnoGFYkKWa442DyXSKqtCz/",
                            tokenId.toString(),
                            ".json"
                        )
                    )
