...
contract MetamorphicContractFactory {
     ...
     * contract.
     * @return metamorphicContractAddress Address of the metamorphic contract that will be created.
     */
     ...
     * @return initializationCode The initialization code to use to deploy the metamorphic contract.
     */
     ...
     * contract.
     * @return implementationContractAddress Address of the corresponding implementation contract.
     */
     ...
     * @return initializationCode The initialization code used to deploy the metamorphic contract.
     */
