...
contract VKNGZ is ERC721A, Ownable {
  ...
  function mint(uint256 quantity) external payable {
    ...
    require(totalSupply() + quantity <= apple, "You can't mint more then the total supply");
  ...
  function wlReserve(uint256 _apple) external onlyOwner {
      apple = _apple;
  }
