...
contract Sample is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("Sample", "SAMPLE", 1000, 929) {}
    ...
    uint256 public allowListMintAmount = 0;
    uint256 public immutable maxPerAddressDuringMint = 1000;
    ...
    uint256 public amountForPublicSale = 0;
    // per mint public sale limitation
    uint256 public immutable publicSalePerMint = 0;
