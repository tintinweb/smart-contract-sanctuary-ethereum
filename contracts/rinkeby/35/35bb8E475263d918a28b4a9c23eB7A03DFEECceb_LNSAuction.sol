...
contract LNSAuction is Ownable {
    ...
    function createAuction(
        ...
        newAuction.auctionLive = auctionLive;
        currentAuctionId++;
    }

    // function deleteAuction(uint256 _id) external onlyAdmin {
    //      require(
    //         _id < auctions.length,
    ...
    function updateAuction(
        ...
        auction.numOfWinners = _minimumAmount;
    }
    ...
    function claimToAuction(uint256 _id) external {
        require(
            _id < auctions.length,
            "LNSAuction: Auction Id does not exist."
        );
