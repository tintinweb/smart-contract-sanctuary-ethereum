...
interface IUSDBNFT {
    function mint(address wallet, Bond memory Info) external payable returns(uint256);
...
contract UsdbNftBondDepository is Ownable, ReentrancyGuard{
    ...
    function deposit(
        ...
        uint tokenId = IUSDBNFT(UsdbNftAddress).mint{value: msg.value}(_depositor, info);
