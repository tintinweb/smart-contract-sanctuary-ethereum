...
contract PairFactory is Context, IPairFactory {
    ...
    function setFeeTo(address feeTo_) external onlyGovernance override {
        feeTo = feeTo_;
        emit ChangeFeeTo(feeTo_);
    }

    function setSwapFee(uint256 adminFee, uint256 lpFee) external onlyGovernance override {
    ...
    function setRouter(address router_) external onlyAdmin override {
        router = router_;
    }
