...
import "../contracts/ERC721F.sol";


contract ClaireChronicles is Ownable, ERC721F {

    uint256 public nextIndexToAssign = 0;

    constructor() ERC721F("ClaireChronicles", "CLAIRE") {}
...
contract ERC721F is Ownable, ERC721, ERC721URIStorage {
