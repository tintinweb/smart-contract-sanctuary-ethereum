...
contract WolfGuildMintPass is ERC1155Burnable, Ownable, Pausable, ReentrancyGuard {
    using ECDSA for bytes32;

    uint256[3] public MAX_SUPPLY = [
        7,   // Round Table
        25,  // Founder
        694  // OG
    ];
    ...
    function airdrop(uint256 tokenId, address to) public lockable onlyOwner {
        require(tokenId < MAX_SUPPLY.length, "Token ID out of range");
