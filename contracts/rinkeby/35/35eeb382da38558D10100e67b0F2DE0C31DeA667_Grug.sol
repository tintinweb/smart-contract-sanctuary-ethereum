...
contract Grug is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant OG_MINT_TIME = 0.1 days;
    uint256 public constant WHITELIST_MINT_TIME = OG_MINT_TIME + 0.2 days;
    ...
    constructor(uint256 _maxGrugs) ERC721("Grug", "Grug") {
        maxGrugs = _maxGrugs;
    }
