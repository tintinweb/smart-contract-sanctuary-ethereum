...
contract DanteNFT is ERC721Enumerable, ERC721Burnable, ERC2981, Ownable {
    ...
    uint256 public constant WHITELIST_CLAIM_WINDOW = 30 minutes;
    uint256 public constant PUBLIC_WINDOW = 30 minutes;
    ...
    constructor(address _dao, string memory _provenance) ERC721("DantesTest", "DANTESTEST") {
        dao = _dao;
