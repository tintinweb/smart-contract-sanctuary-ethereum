...
// interfaces minimalisttic view into anothwer contract
...
contract FundMe {
    ...
    function getPrice() public view returns (uint256) {
        ...
        return uint256(answer *10000000000) ; // mutiply to change from wei to gwei
...
//    }
    ...
    // modifier us used to change behavior of a function in a decclarative way
    modifier onlyOwner {
        require(msg.sender == owner);
        _;
    }
