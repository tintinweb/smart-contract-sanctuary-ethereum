...
contract testmaf is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.0159 ether;
  ...
  constructor() ERC721("testmafcontract", "mate") {
    setHiddenMetadataUri("ipfs://QmYDxRo99dhSzzjsbYPgEXQqqtJq5MK1MjbFUey4CP2GmX/hidden.json");
  }
