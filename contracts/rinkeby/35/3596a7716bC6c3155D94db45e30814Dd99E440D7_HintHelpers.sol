...
contract LiquityBase is BaseMath, ILiquityBase {
    ...
    uint constant public MCR = 1150000000000000000; // 115%

    // Critical system collateral ratio. If the system's total collateral ratio (TCR) falls below the CCR, Recovery Mode is triggered.
    uint constant public CCR = 1500000000000000000; // 150%

    // Amount of LUSD to be locked in gas pool on opening troves
    uint constant public LUSD_GAS_COMPENSATION = 30e18; //create override in contracts

    // Minimum amount of net LUSD debt a trove must have
    uint constant public MIN_NET_DEBT = 100e18; //$100
    // uint constant public MIN_NET_DEBT = 0; //During recovery mode

    uint constant public PERCENT_DIVISOR = 200; // dividing by 200 yields 0.5%

    uint constant public BORROWING_FEE_FLOOR = DECIMAL_PRECISION / 1000 * 5; // 0.005%
