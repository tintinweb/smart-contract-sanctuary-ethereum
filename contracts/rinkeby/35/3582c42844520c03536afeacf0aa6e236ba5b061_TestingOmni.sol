...
contract TestingOmni is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("TestingOmni", "TO") { 
        _owner = msg.sender;
