...
interface IERC165 {
    ...
    function updatePizzaList(uint256 pizzaId, address from, uint256 _pizzaId, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings, bool isRandom, bool unbaked, bool calculated, uint256 rarity) public {
    ...
    function randomBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings ) public returns (PizzasResponse memory){
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings ) public returns(PizzasResponse memory){
    ...
    // rebake pizza
    function rebakePizza( uint256 _pizzaId, string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings ) public onlyNFTOwner(_pizzaId) {
    ...
    // bake pizza and mint
    function bakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings) public returns(PizzasResponse memory){
        _nftIds.increment();
        uint256 _nftId = _nftIds.current();
        _mint(msg.sender, _nftId);
        _setTokenURI(_nftId, metadata);
