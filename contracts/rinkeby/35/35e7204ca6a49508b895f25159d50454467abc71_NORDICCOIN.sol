...
1Trillion Max Supply 1,000,000,000,000
Ability to mint, burn
10% tax on buying
10% tax on selling

0x42d61B0dA656ACA546eb7f7B808b2c34A5273291 // Buy Tax (Dev Fees) 
0x1de238A4EB6f5BaF8365AE3c512066B67d0E28C4 // Sell Tax (Treasury) 
*/
contract NORDICCOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NORDIC COIN", "$NRDC") {

        address newOwner = address(0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2); // Acc1
        ...
        maxTransactionAmount = 100000000000 * (10**18); // 1% maxTransactionAmountTxn
    	...
    	developmentWallet = address(0x42d61B0dA656ACA546eb7f7B808b2c34A5273291); // set as buy Wallet 
    	treasuryWallet = address(0x1de238A4EB6f5BaF8365AE3c512066B67d0E28C4); // set as sell wallet
