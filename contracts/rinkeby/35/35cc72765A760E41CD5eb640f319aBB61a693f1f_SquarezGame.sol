...
import "./SquarezNFT.sol";

contract SquarezGame is Ownable, SquarezNFT, RandomGameBoard, SportsDataAPIConsumer, AdAuction {
    ...
    constructor()
    SportsDataAPIConsumer(0x6dEF9CE80f5326737102F66f3b87ef8C2c88984D)
    AdAuction("Atlas Corp",0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
    {
    }
    ...
    function setBaseURI(string memory _URI) public override(SquarezNFT) onlyOwner {
        super.setBaseURI(_URI);
    }

    function startClaim() public override(SquarezNFT) onlyOwner {
        super.startClaim();
    }
...
contract SquarezNFT is ERC721, ERC721Enumerable  {
    ...
    constructor() ERC721("SquarezNFT", "SQUAREZ") {
...
contract SportsDataAPIConsumer is ChainlinkClient  {
    ...
    /**
     * Network: Rinkeby
     * Oracle: 0x6dEF9CE80f5326737102F66f3b87ef8C2c88984D (Atlas Chainlink Node) 
    ...
    constructor(address _oracleAddress){
        ...
        // Kovan
        jobId = "46acf9f83e334c42b7ccfb6b859c4666";

        dataFee = 0.1 ether; // (Varies by network and job)
    ...
    function requestScoreData(string memory _dataPath) private returns (bytes32 requestId) 
    {
        ...
        request.add("get", "https://api.sportsdata.io/v3/nfl/scores/json/ScoresByDate/23-JAN-2022?key=9eb7afcb0bd34d00a7d3273fccd83fb9");
...
contract AdAuction {
    ...
    constructor(string memory _initialDiamondSponsorAd, address _initialDiamondSponsor){
        ...
        platinumSponsorshipRate = 3;
        goldSponsorshipRate = 2;
        silverSponsorshipRate = 1;
