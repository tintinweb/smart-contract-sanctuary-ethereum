...
contract TemporaryHolding is AccessControl, Initializable,ReentrancyGuard {
        ...
        onlyRole(WITHDRAW_ROLE)
    {
        ...
        IERC20(IAdmin(Admin).YSL()).safeTransfer(recipient, IERC20(IAdmin(Admin).YSL()).balanceOf(address(this)));
        IERC20(IAdmin(Admin).xYSL()).safeTransfer(recipient, IERC20(IAdmin(Admin).xYSL()).balanceOf(address(this)));
    }
