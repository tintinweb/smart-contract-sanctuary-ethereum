...
contract MutantSoldiersNFT is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint private reserve = 30;

  uint public status = 0; //0-pause 1-whitelist 2-public

  mapping(address => bool) private whitelistedAddresses;

  constructor() ERC721A("MutantSoldiersNFT","MutantSoldiersNFT", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "";
  }
