...
contract BigBankTheory is ERC20, Ownable, VRFConsumerBaseV2 {
    // Basic units
    uint256 private constant ONE_HOUR = 60 * 20;
    ...
    address public RewardPool = 0x2c2c4D90D519c600A3BDB4b83A9Ab515b43cf009;
        ...
        VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab)
    {
        ...
        LizzieWizzieNFTs = ILizzieWizzie(
            0x57d6ed949A3Ae6d648799c7C25f5227513C6ec39
        );
    }
    ...
    function playWithChainlink(uint16 _percent, Move _hand) public {
        ...
        if (distributorGas > 0 && address(dividendDistributor).balance > 0 && LizzieWizzieNFTs.getTotalSupply() > 0) {
