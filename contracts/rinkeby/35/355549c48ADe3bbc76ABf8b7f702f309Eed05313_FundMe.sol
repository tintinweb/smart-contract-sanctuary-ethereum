...
contract FundMe {
    ...
    //creamos un objeto de tipo aggregator v3 interface llamado price feed
    AggregatorV3Interface public priceFeed;
    
    // the first person to deploy the contract is
    // the owner
    constructor(address _priceFeed) public {
        //en esta parte pasamos un address para que el aggregator pueda buscar el precio con chahinlink
