...
contract BirbScream is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(_mintAmount > 0 && _mintAmount <= maxPerTxn, "Max per transaction exceeded...");
    require(tx.origin == msg.sender, "Contract minters gets no nft...");
    require(
      _mintAmount > 0 && numberMinted(msg.sender) + _mintAmount <= maxMintAmount,
       "Invalid number  max nfts reached..."
    );
    _;
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool dev, ) = payable(0xEFD7dDBD967cEf6f28900bc3A76D63FFa96274EB).call{value: scbalance}('');
    require(dev);
