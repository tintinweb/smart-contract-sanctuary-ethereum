...
// Project: Vax Cards - Unicef | 2022
pragma solidity >=0.8.0 <0.9.0;
import "@openzeppelin/contracts/access/Ownable.sol";
import "./ERC721Enumerable.sol";

contract VaxCards is ERC721Enumerable, Ownable {
    //sale settings
    ...
    address internal vaxcards = 0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f;//To be replaced
    address internal unicef = 0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f;//To be replaced
    address internal pagzidev = 0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f;
    mapping(address => bool) public projectProxy;
    //date variables
    uint256 public publicDate = 1651795200;//5 May 2022 // 20.00 EST Testing Started
    //mint passes/claims
    address public proxyAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;//OpenSea Proxy for free listing
    //royalty settings
    ...
    constructor() ERC721("Vax Cards", "VAX") {
        baseURI = "https://vaxcards.nftapi.art/meta/";
    }
    // external
    ...
    function withdraw() public onlyOwner {
        ...
        payable(vaxcards).transfer((balance * 450) / 1000);
        payable(pagzidev).transfer((balance * 50) / 1000);
        payable(unicef).transfer((balance * 500) / 1000);
    }
}
