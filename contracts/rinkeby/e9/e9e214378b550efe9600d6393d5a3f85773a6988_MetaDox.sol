...
/*
* @title ERC721 token for MetaDox
* @author MetaDox
*/
contract MetaDox is ERC721, Ownable, ERC721Enumerable {
    ...
    */
    function mint(uint8 _quantity) external payable {
        ...
        require(publicSaleOpen || owner() == _msgSender(), "Can not mint");
    ...
    */
    function _collectAmount(uint8 _quantity, address _addr) internal {
    ...
    *
    * @param _ipfsURI the static base URI
    */
    ...
    */
    function _collectFeeAndMintToken(uint8 _quantity) internal {
		if(owner() != _msgSender()){
			_collectAmount(_quantity, _msgSender());
		}
