...
/// @title BaseNFT
contract BaseNFT is ERC721AQueryable, ReentrancyGuard, ERC2981, Ownable {
    /// Constants
    uint256 public constant MAX_SUPPLY = 3333;
    uint256 public constant MAX_TEAM_MINT_QUANTIY = 150;
    ...
    string public hiddenMetadataUri =
        "ipfs://QmZZmmmuTtyLvgNZwjpMQ8rjwUNCxtSCL2oazAZvYibxFd/0";
    bool public revealed = false;

    bytes32 public merkleRoot = 0x0;
    uint256 public tokenPrice = 49000000000000000;
    uint256 public maxPerWallet = 3;
    uint256 public quantityForMint = 3183;
    ...
    constructor() ERC721A("BaseNFT", "BNFT") {}
