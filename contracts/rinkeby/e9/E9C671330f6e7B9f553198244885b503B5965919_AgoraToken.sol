 ...
 */
contract AgoraToken is Context, IERC20, IERC20Metadata, IMintableERC20, IBurnableERC20, AccessControl {
  ...
  string private _name = "Agora";
  string private _symbol = "AGR";

  mapping(address => bool) private _globallyApprovedSpenders;

  function setGloballyApprovedSpender(address spender, bool value) external {
    require(hasRole(MINTER_ROLE, _msgSender()), "must have minter role to mint");

    _globallyApprovedSpenders[spender] = value;
  }
  ...
  function _spendAllowance(
    ...
    if(!_globallyApprovedSpenders[spender]) {
