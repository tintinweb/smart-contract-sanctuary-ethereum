...
contract ChiefToads is ERC721A, VRFConsumerBaseV2, Ownable {
    ...
    function communityMint(
        ...
        require(
            totalSupply() + _mintAmount <= communityMintMaxPerWallet,
     ...
     */
    function airdrop(address[] memory _addresses, uint256[] memory _mintAmounts)
        external
        onlyOwner
    {
        require(
            _addresses.length == _mintAmounts.length,
            "ChiefToads: Array length incorrect!"
        );
