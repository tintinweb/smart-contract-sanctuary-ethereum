...
contract test123 is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  uint256 public maxTierOneMintAmount = 10;
  ...
  constructor() ERC721A("test123", "TEST") {}
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    uint split = total * 1/2;
    Address.sendValue(payable(0x7Bc6AE55fa99600796A353075244a28e883A7a5F), split);
    Address.sendValue(payable(0xa6cB49fac360b09e61F129C21EE109d19797a6BE), split);
  }
