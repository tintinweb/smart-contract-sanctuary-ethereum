 ...
 */
contract provedDevV8 is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("provedDevV8", "PRV", _proxyRegistryAddress)
    {}
