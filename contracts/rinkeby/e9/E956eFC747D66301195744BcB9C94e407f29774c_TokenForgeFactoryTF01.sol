...
import "tf-nft-contracts/contracts/nft/TokenForge1155v3.sol";
...
contract TokenForgeFactoryTF01 is Context, AccessControlEnumerable {
    ...
    function createTokenForge1155v3(address signer, string memory baseUri) public returns (TokenForge1155v3) {
        TokenForge1155v3 instance = new TokenForge1155v3(signer, baseUri);

        _deployedContracts[_msgSender()].push(address(instance));
        _deployedContractTypes[address(instance)] = CONTRACT_TYPE_TokenForge1155v3;

        emit ContractDeployed(CONTRACT_TYPE_TokenForge1155v3, address(instance));
