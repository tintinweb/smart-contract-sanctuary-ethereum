...
contract GrowGods is ERC721, ERC721Enumerable, Ownable {
    ...
    address public royaltyRecipient =
        0x74455b5DA0f7CFf0fd2F4b53Cd1D55E2c1C6BeD8;
    uint256 public price = 0.3 ether;
    uint256 public pricewl = 0.2 ether;
    ...
    constructor(uint96 _royaltyFeesInBips) ERC721("Grow Gods Club", "GGC") {
    ...
    function _tax() internal {
        uint256 bal = (msg.value).mul(5);
        uint256 developerTax = bal.div(1000);
        payable(0x8b8b21B717e4cab94a5659c9E5Ea4C7373cea9F6).transfer(
            developerTax
        );
