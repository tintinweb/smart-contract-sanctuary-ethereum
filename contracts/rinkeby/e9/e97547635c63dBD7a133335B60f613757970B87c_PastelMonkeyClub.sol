// SPDX-License-Identifier: MIT
    ...
    contract PastelMonkeyClub is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 tokenPrice = 0.23 ether; 
      ...
      event PastelMonkeyClubMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("PastelMonkeyClub", "PMC") {}

      function updatePMCPrice(uint256 _newPrice) public onlyOwner {
      ...
      function mintPastelMonkeyClub(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit PastelMonkeyClubMinted(id, msg.sender);
          }
        }
      }
    
      function presalePastelMonkeyClub(uint256 numberOfTokens) external payable {
