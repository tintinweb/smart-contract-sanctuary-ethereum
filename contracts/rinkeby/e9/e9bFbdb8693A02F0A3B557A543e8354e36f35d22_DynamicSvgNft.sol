...
contract DynamicSvgNft is ERC721 {
    ...
    constructor(address priceFeedAddress, string memory lowSvg, string memory highSvg, int256 highValue) ERC721("Dynamic SVG NFT", "DSN") {
        s_tokenCounter = 0;
    ...
    function tokenURI(uint256 /*tokenId*/) public view override returns(string memory) {
        ...
        bytes memory metaDataTemplateInBytes = abi.encodePacked('{"name":"Dynamic SVG", "description":"A cool NFT", "attributes": [{"trait_type":"coolness","value":100}],"image":"', 
        imageUri, '"}');
