...
contract BTCLPMetaGamePassRoyalties is ERC1155, IERC2981, Ownable, ERC1155Supply, ContextMixin { 
    ...
    constructor(
        ...
        // string memory url
        ) ERC1155("https://ipfs.io/ipfs/QmTQThADSXWb5YWSMBw4nGHTYqs6x2vQoVmVNVFT9HZrWQ/") {
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        ...
        return string(abi.encodePacked(
            "https://ipfs.io/ipfs/QmTQThADSXWb5YWSMBw4nGHTYqs6x2vQoVmVNVFT9HZrWQ/",
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "https://ipfs.io/ipfs/QmTQThADSXWb5YWSMBw4nGHTYqs6x2vQoVmVNVFT9HZrWQ/"; // IPFS base for collection
