...
contract InitialDeployFacet is UpgradesFacet {
        ...
        onlyRunOnce(INITIAL_DEPLOY)
    {
        ...
        // }
        // need the following supportsInterface selectors:
        // 0x80ac58cd - ERC721
        // 0x5b5e139f - ERC721Metadata
        // 0x780e9d63 - ERC721Enumerable
        // 0xd9b67a26 - ERC1155
        // 0x0e89341c - ERC1155MetadataURI
        LibDiamond.diamondStorage().supportedInterfaces[0x80ac58cd] = true;
        LibDiamond.diamondStorage().supportedInterfaces[0x5b5e139f] = true;
        LibDiamond.diamondStorage().supportedInterfaces[0x780e9d63] = true;
        LibDiamond.diamondStorage().supportedInterfaces[0xd9b67a26] = true;
        LibDiamond.diamondStorage().supportedInterfaces[0x0e89341c] = true;
    }
