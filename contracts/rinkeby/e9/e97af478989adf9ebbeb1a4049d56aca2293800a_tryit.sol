...
contract tryit is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    string public Try_Provenance = "";
    ...
    constructor() ERC721("Tried aIt", "TRDAYIT") {
    }

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        Try_Provenance = _provenanceHash;
    }
