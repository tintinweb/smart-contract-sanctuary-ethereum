 ...
 */
 ...
 contract GGS is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, ERC2981PerTokenRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Gybsy General Storefront", "GGS") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x39d8D4b548575E087d61075d1b353Bb9D1351887);
          _setupRole(MINTER_ROLE, 0x39d8D4b548575E087d61075d1b353Bb9D1351887);
          _setupRole(MINTER_ADMIN_ROLE, 0x39d8D4b548575E087d61075d1b353Bb9D1351887);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x39d8D4b548575E087d61075d1b353Bb9D1351887);
     }
      ...
      */      
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "GGS/minter-role-required");
         _mint(to, tokenId);
