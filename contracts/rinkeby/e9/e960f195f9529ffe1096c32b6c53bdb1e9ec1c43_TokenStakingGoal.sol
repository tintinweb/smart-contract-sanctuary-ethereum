...
// File: contracts/TokenStakingGoal.sol
...
contract TokenStakingGoal is Ownable {
    using SafeMath for uint256;
    ...
    function changeLockTime(uint _durationInSeconds) external {
        lockTime = _durationInSeconds;

    }
    function seeLockTimeDuration() public view returns (uint) {
        return lockTime;
    }
