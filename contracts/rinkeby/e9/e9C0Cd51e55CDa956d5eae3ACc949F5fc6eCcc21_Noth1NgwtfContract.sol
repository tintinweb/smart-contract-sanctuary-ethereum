...
//    / | / /___   / /_/ /_ <  /___  ____ __      __/ /_/ __/
//   /  |/ / __ \ / __/ __ \/ / __ \/ __ `/ | /| / / __/ /_  
//  / /|  / /_/ // /_/ / / / / / / / /_/ /| |/ |/ / /_/ __/  
// /_/ |_/\____(_)__/_/ /_/_/_/ /_/\__, (_)__/|__/\__/_/     
//                                /____/                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656799200;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x00000024b9e00c88AB0668F4c1E9f792E61f2AA0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZFR2aeno257XBoyeFYdkEbBYs6cif5VfXHdV1MBFHMvN/";
...
// File: contracts/Noth1NgwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Noth1NgwtfContract is RamppERC721A {
    constructor() RamppERC721A("Noth1ngwtf", "NOTH1NGWTF"){}
}
