...
contract SquirrelTest is ERC721A, Ownable, ReentrancyGuard {
  ...
  function setRevealedNumber(uint256 _amount) public onlyOwner {
    revealedNumber = _amount;
  }
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    if (revealed == false || _tokenId > revealedNumber ) {
