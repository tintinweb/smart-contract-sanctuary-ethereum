...
contract Programs is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply, Lockable {
    ...
    constructor() ERC1155("https://nft.pickystudio.co.kr/share/{id}.json") {
    }
...
contract Lockable is Ownable {
    ...
    function lock(address to) public onlyOwner {
        require(to != owner(), 'address cannot be owner');
