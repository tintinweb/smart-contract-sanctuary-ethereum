...
contract BabyLander is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    string baseURI;
    ...
    constructor(uint256 maxSupply, string memory _initBaseURI, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("BabyLander", "BabyLander") {
        PRICE = 0.025 ether;
