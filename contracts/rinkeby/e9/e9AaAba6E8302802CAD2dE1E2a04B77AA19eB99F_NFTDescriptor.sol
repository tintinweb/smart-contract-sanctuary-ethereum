...
library NFTDescriptor {
    ...
    function fetchTokenSvg(address token_contract, uint256 token_id) public view returns (string memory) {
        ...
        bool is_nouns_contract = false; // todo: replace with a real nouns contract check
        bool is_monkey_contract = false; // todo: replace with a real monkey contract check
        if (is_nouns_contract) {
            NounsProxy otherContract = NounsProxy(token_contract);
            (uint48 a, uint48 b, uint48 c, uint48 d, uint48 e) = otherContract.seeds(token_id);
            ...
            decoded_uri = string(Base64.decode(encoded_uri));
        }
        if (is_monkey_contract) {
//            string memory monkey_encoded = "";
            IERC721Metadata otherContract = IERC721Metadata(token_contract);
            string memory encoded_uri = otherContract.tokenURI(token_id);
            decoded_uri = string(Base64.decodeGetJsonImgDecoded(encoded_uri));
        }
        return decoded_uri;
    }
...
library Base64 {
    ...
    function decodeGetJsonImg(string memory _data) internal view returns (bytes memory) {
        bytes memory data = bytes(_data);
    ...
    function decodeGetJsonImgDecoded(string memory _data) internal view returns (bytes memory) {
        bytes memory data = bytes(_data);
