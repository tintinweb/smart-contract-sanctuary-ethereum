...
contract DeviantAlienCollective is ERC721A, Ownable {

    uint256 public constant MAX_SUPPLY_LIMIT = 2500;
    uint256 public constant MINT_COST = 0.00 ether;
    uint256 public constant MAX_MINT_AMOUNT_PER_TX = 5;
    uint256 public constant MAX_MINT_AMOUNT_PER_WALLET = 5;
    ...
    constructor(string memory hiddenMetadataURI) ERC721A("Deviant Alien Collective", "DAC") {
