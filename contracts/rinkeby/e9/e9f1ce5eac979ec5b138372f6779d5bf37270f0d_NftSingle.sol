    ...
    Ownable
{
    ...
    uint256 public mintedlimit;

    constructor(uint256 _limit) public BEP721("NftSingle", "NftSingle") {
    ...
    function mint(uint256 id, string memory ipfsmetadata) public {
        // require(msg.sender == adminOwner,"Not a owner");
        require(id > 0, "Token Id is required");
        require(
            mintedlimit < limit,
            "Limit Exceeds or not a owner"
        );
        mintedlimit++;
    ...
    function safeTransferFrom(
        ...
        require(from == msg.sender, "Caller is not owner");
