...
contract TST is ERC721, Pausable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://n1s0qnr9zc.execute-api.eu-west-1.amazonaws.com/production/v1/";
    }
    ...
    function mint() public whenNotPaused whenSaleActive {
        safeMint(msg.sender);
    }
