...
// also the `tokenId = index+1` of tokenOfOwnerByIndex assumes that all the token between 1 and tokenId-1 are still owned by the _preMintReceiver. If any lower id has been transfered, then the function results are invalid.
