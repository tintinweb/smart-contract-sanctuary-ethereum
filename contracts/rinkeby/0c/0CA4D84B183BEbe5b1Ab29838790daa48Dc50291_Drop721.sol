...
contract Drop721 is CoreDrop721 {
    ...
    constructor() CoreDrop721(
        NftOptions({
            name: "FuzzyHat Testing Drop Contract",
            symbol: "FUZZYHATTESTDROP",
            imnotArtBps: 0,
            royaltyBps: 1000,
            startingTokenId: 0,
            maxInvocations: 20,
...
contract CoreDrop721 is Ownable, ERC721, INA721Standard, INA721DropStandard, AdminFunctions, DropFunctions, PresaleFunctions, IRaribleRoyaltiesV2 {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return StringsUtil.concat(
            StringsUtil.concat(metadataBaseUri, StringsUtil.address2str(address(this))),
                StringsUtil.concat("/", StringsUtil.uint2str(tokenId)));
    }
