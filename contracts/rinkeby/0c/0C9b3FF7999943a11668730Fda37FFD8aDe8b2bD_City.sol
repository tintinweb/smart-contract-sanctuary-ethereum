...
contract City is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    event CrimeCommitted(uint256 tokenId, uint256 location, uint256 reward, uint256[] copArray);
    ...
    function getDealershipCops() public view virtual returns (uint256[] memory){
        return dealershipStakedCops;
    }
