...
contract MemoriesInEther is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Memories In Ether", "MiE") {
    setHiddenMetadataUri("ipfs://QmX77bBSgtd4GpoUWhMjmn6bpGYq535toM753ftE5LcuEH/unrevealed.json");
  }
