...
contract Millionaire is Ownable, ERC721A, ReentrancyGuard {  
    ...
    enum SaleState{ Preparing, TeamSale}
    ...
    constructor() ERC721A("Millionaire", "$MILL") {
        uint256 _teamSaleStartTime = 1654095600;
    ...
    function setConfig( uint256 _teamSaleStartTime,
                        uint256 _teamSalePrice,
                        uint256 _teamSaleLimit ) public onlyOwner {
        saleConfig = SaleConfig(
            _teamSaleStartTime,
            _teamSalePrice,
            _teamSaleLimit
    ...
    function getSaleState() public view returns (SaleState) {
        ...
        if(nowTime >= saleConfig.teamSaleStartTime) {
    ...
    function setMerkleRoot(bytes32 _teamSaleMerkleRoot) external onlyOwner {
