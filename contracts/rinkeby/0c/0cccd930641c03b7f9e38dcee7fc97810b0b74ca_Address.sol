...
contract TroglodyteSociety is ERC721Enumerable, Ownable {
    ...
    uint256 public maxWhitelistLength = 2500;
    ...
    function preSaleMint(uint256 _mintCount) public payable onlyWhitelisted {
        ...
        require(_mintCount <= maxMintAmount,            string(abi.encodePacked('You can only mint ', maxMintAmount.toString(), ' NFTs in one transaction')));
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            require(msg.value >= pubprice * _mintAmount);
        }
