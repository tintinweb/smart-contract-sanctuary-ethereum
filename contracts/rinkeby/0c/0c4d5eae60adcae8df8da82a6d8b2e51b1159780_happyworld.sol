...
contract happyworld is ERC1155, Ownable {
    ...
    constructor() public ERC1155('https://ipfs.io/ipfs/QmXz3bCNT5W7fNSWA5etR6CNfj3Bt6ifjBiefKWKWfawQu/{id}.json') {
        name            =   "TVpunk";
        symbol          =   "TVpunk_symbol";
        cost            =   0.03 ether;
        maxSupply       =   5000;
        remainTokenAmount = 5000;   //may be != 11111 if you want to remain some NFT as your own  
        maxMintAmount   =    20;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            _nftcreator.call{value: msg.value}(""); 
        }
