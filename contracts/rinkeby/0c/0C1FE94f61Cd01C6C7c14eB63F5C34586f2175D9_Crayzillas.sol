...
// Creators: 0xInuarashi, 0xVinasaur
...
import "./ERCColorable.sol"; // move abstract contract into
...
{
    // Constructor
    constructor() payable ERC721I("Crayzillas", "CRAY") {} // TODO: update later

    // Project Constraints
    uint256 public mintPrice = 0.06 ether; // TODO: update later
    uint256 public maxSupply = 8888; // TODO: update later

    string public crayzillasProvenance;

    // Public Limits
    uint256 public maxMintsPerPublic = 2; // TODO: update later
    mapping(address => uint256) public addressToPublicMints;

    // Allowlist Limits
    uint256 public maxMintsPerAllowlist = 2; // TODO: update later
    mapping(address => uint256) public addressToAllowlistMints;

    // PubRaffle Limits
    uint256 public maxMintsPerPubRaffle = 2; // TODO: update later
...
/**
@dev Defines metadata field for trait properties
 */
