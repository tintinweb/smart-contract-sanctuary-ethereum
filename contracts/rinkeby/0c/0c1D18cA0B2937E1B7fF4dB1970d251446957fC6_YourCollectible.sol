...
contract YourCollectible is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() public ERC721A("ETHERHEARTS", "EHRT")  {
    // RELEASE THE LOOGIES!
  ...
  { 
      ...
      messages[id] = (uint8(predictableRandom[4]) % 32 );
      }
 ...
 */
contract ERC721A is IERC165, Context, IERC721, IERC721Metadata, IERC721Enumerable {
