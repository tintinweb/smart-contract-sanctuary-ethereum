...
contract FundMe {
    ...
    constructor() public{
     ...
     function fund() public payable {
         ...
         require(getConversionRate(msg.value)>= minimumUSD, "--------Spend More ETH Fool!!------");
    ...
    function getConversionRate(uint256 ethAmount) public view returns (uint256){
        ...
        //conversion of wei to usd
// 104.874000000000000000

    }
    modifier onlyOwner{
        require(msg.sender==owner, "The Fuck You Doin");
        _;
    }
