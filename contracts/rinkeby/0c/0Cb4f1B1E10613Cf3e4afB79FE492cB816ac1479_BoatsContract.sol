...
contract BoatsContract is ERC721Enumerable, Ownable, RoyaltiesV2Impl, Pausable {
    /******************************/
    /**    State Variables       **/
    /******************************/
    ...
    constructor(
        ...
        require(_secondary != address(0), "Boats: secondary is the zero address");
    ...
    function updateSecondary(address _newSecondary) external onlyOwner {
        require(_newSecondary != address(0), "Boats: new secondary is the zero address");
