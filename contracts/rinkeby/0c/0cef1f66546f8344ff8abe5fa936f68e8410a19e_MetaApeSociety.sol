...
contract MetaApeSociety is ERC721A, Ownable {
  ...
  uint256 public public_price = 80000000000000000; // 0.08 Ether
  ...
  function withdraw() public {
    address payable addr1 = payable(0x992B5C3b03d916A68575D860507076EC5f1fbCa7);
    address payable addr2 = payable(0x9A8d1E84e39b1f96e6Fe4534fEB89fa7583D9213);
    address payable addr3 = payable(0x212D8E2a0E968F71eB1cEB308615AF31ce7ab8dB);

    require(msg.sender == owner() || msg.sender == addr1 || msg.sender == addr2 || msg.sender == addr3, "access denied");

    uint256 balance = address(this).balance;
    uint256 value1 = balance / 5;
    uint256 value2 = balance / 20;
