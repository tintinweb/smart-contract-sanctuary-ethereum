...
contract BadKidz is ERC721A, ReentrancyGuard, Ownable, EIP712Whitelisting {
    ...
    uint256 public maxReserveSupply = 100;
    ...
    modifier callerIsDev() {
        require(msg.sender == 0x215De00630F5E89C3A219D2771e55dc49F28489f, "The caller is not Sage Labs");
        _;
    }
    ...
    /** RELEASE PAYOUT **/
    function release(address payable _account) public virtual onlyOwner callerIsDev {
