...
contract LookMyEyesERC721A is Ownable, ERC721A, PaymentSplitter {
	...
	uint private constant MAX_SUPPLY = 80;
	uint private constant MAX_GIFT = 5;
	uint private constant MAX_WHITELIST = 20;
	uint private constant MAX_PUBLIC = 55;
	...
	uint public saleStartTime = 1654293600;
	...
	/*
	* @notice This contract can't be colled by other contracts
	*/
	modifier callerIsUser() {
		require(tx.origin == msg.sender, "The caller is anothercontract");
		_;
	}
	...
	*/
	...
	/**
	* @notice Returns true if a leaf can be proved to be a part of merkle tree defined by root
	*
	* @param _leaf The leaf
	* @param _proof The merkle proof
	*
	* @return bool return true if a leaf can be proved to be a part of merkle tree defined by root
	*/
	...
	*
	* @param _account The checked account
	* @param _proof The merkle proof
	*
