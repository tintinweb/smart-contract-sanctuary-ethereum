...
contract OCMRenderingContract is Ownable {
    ...
    string[8][2] private bg_names = 
        [["bg1_0", "bg1_1", "bg1_2", "bg1_3", "bg1_4", "bg1_5", "bg1_6", "bg1_7"],
         ["bg2_0", "bg2_1", "bg2_2", "bg2_3", "bg2_4", "bg2_5", "bg2_6", "bg2_7"]]; 

    string[19][2] private fur_names = [["fur1_0", "fur1_1", "fur1_2", "fur1_3", "fur1_4", "fur1_5", "fur1_6", "fur1_7", "fur1_8", "fur1_9", "fur1_10", "fur1_11", "fur1_12", "fur1_13", "fur1_14", "fur1_15", "fur1_16", "fur1_17", "fur1_18"],
    ...
    string[23][2] private eyes_names = [["eyes1_0", "eyes1_1", "eyes1_2", "eyes1_3", "eyes1_4", "eyes1_5", "eyes1_6", "eyes1_7", "eyes1_8", "eyes1_9", "eyes1_10", "eyes1_11", "eyes1_12", "eyes1_13", "eyes1_14", "eyes1_15", "eyes1_16", "eyes1_17", "eyes1_18", "eyes1_19", "eyes1_20", "eyes1_21", "eyes1_22"],
    ...
    function getTraits(Monkey memory monkey) internal view returns (string memory) {
        ...
        return string(abi.encodePacked(str, '"},{"trait_type": "Type", "value": "', type_names[monkey.karmaType-1], '"}]'));
    }    
