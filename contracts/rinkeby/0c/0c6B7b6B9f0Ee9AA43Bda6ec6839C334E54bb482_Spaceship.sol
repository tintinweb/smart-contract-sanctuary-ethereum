...
import "../contracts/Spaceship.sol";

contract $Spaceship is Spaceship {
    uint24[][] public $v_uint24_;

    constructor(uint64 subscriptionId, address vrfCoordinator, bytes32 _keyHash) Spaceship(subscriptionId, vrfCoordinator, _keyHash) {}
    ...
    function $playfieldSize() external view returns (int56) {
        return playfieldSize;
    }

    function $unsignedPlayfieldSize() external view returns (uint56) {
        return unsignedPlayfieldSize;
    }
    ...
    function $g_fill_open_a() external view returns (string memory) {
        return g_fill_open_a;
    }

    function $g_fill_open_b() external view returns (string memory) {
        return g_fill_open_b;
    }

    function $g_fill_close() external view returns (string memory) {
        return g_fill_close;
    }

    function $rect_x() external view returns (string memory) {
        return rect_x;
    }

    function $x_y() external view returns (string memory) {
        return x_y;
    }

    function $y_width() external view returns (string memory) {
        return y_width;
    }

    function $w_height() external view returns (string memory) {
        return w_height;
    }

    function $h_rect() external view returns (string memory) {
        return h_rect;
    }

    function $s_frame_numbers() external view returns (uint24[] memory) {
        return s_frame_numbers;
    }

    function $s_wings_numbers() external view returns (uint24[] memory) {
        return s_wings_numbers;
    }

    function $s_body_numbers() external view returns (uint24[] memory) {
        return s_body_numbers;
    }

    function $s_extension_numbers() external view returns (uint24[] memory) {
        return s_extension_numbers;
    }

    function $s_cockpit_window_numbers() external view returns (uint24[] memory) {
        return s_cockpit_window_numbers;
    }

    function $s_cockpit_numbers() external view returns (uint24[] memory) {
        return s_cockpit_numbers;
    }
    ...
    function $_ownerships(uint256 arg0) external view returns (IERC721A.TokenOwnership memory) {
        return _ownerships[arg0];
    }

    function $fulfillRandomWords(uint256 requestId,uint256[] calldata seedArray) external {
        return super.fulfillRandomWords(requestId,seedArray);
    }

    function $moveGameOneDay() external {
        return super.moveGameOneDay();
    }

    function $unitsTestFormation() external {
        return super.unitsTestFormation();
    }

    function $getZoneRadius(uint56 day) external pure returns (uint56) {
        return super.getZoneRadius(day);
    }

    function $simulateUnitOnce(Spaceship.UnitData calldata unit) external pure returns (Spaceship.UnitData memory) {
        return super.simulateUnitOnce(unit);
    }

    function $simulateUnitOut(Spaceship.UnitData calldata unit) external view returns (Spaceship.UnitData memory) {
        return super.simulateUnitOut(unit);
    }

    function $getUnit(uint256 id) external view returns (Spaceship.UnitData memory) {
        return super.getUnit(id);
    }

    function $getAllUnits() external view returns (Spaceship.UnitData[69] memory) {
        return super.getAllUnits();
    }

    function $imageSection(uint arr,uint8 seed) external view returns (string memory) {
        return super.imageSection($v_uint24_[arr],seed);
    }

    function $abs(int56 x) external pure returns (int56) {
        return super.abs(x);
    }

    function $inCircle(int56 centre_x,int56 centre_y,int56 size,int56 x,int56 y) external pure returns (bool) {
        return super.inCircle(centre_x,centre_y,size,x,y);
    }

    function $random(uint256 seed) external pure returns (uint256) {
        return super.random(seed);
    }

    function $randomRange(uint256 seed,uint256 max) external pure returns (uint256) {
        return super.randomRange(seed,max);
    }

    function $randomHsl(uint8 seed) external pure returns (string memory) {
        return super.randomHsl(seed);
    }
