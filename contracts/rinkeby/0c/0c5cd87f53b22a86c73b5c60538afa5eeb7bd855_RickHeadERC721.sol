...
contract RickHeadERC721 is ERC721, Pausable, Ownable {
    ...
    uint64 private maxMintsPerAddress = 4;
    uint64 private maxPrivateMintsPerAddress = 2;
    uint64 private maxPresaleMintsPerAddress = 1;
    ...
    string private baseURI = "ipfs://QmRYH6DgaqXTkDdKLVcMcjtYB9QHa2sUtZGCZUfi8h2BH3";
