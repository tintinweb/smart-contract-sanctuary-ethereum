...
contract ElixirBottles is ERC721, Ownable {
    ...
    string collectionDescription = "The possibilities are endless. Unlock your own future.";
    string collecImg = "";
    ...
    ElixirMetadata public metadataStorage;
    ...
    **/
    ...
    function registerMetadataStorage(address _msAddy) public onlyOwner {
        metadataStorage = ElixirMetadata(_msAddy);
    }
...
abstract contract ElixirMetadata {
