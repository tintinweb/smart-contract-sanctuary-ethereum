...
contract CryptoGotchiNFT is ERC721Tradeable {
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 10000;
    uint256 public reserved = 500;
    string private strBaseTokenURI = "https://opensea.io";
    ...
    function mint(uint256 amount) internal {
        ...
        require(amount <= 20, "Can only mint 20 at time");
        require(
            supply + amount < maxSupply - reserved,
            "Mint will exceeded supply!"
        );
    ...
    function giveAway(address to, uint256 amount) external onlyOwner {
        require(amount <= reserved, "Reserve is empty");
