...
contract MadApes is ERC721Enumerable, Ownable {
    ...
    uint256 public max_apes = 3000;
    uint256 public collection_max = 10000;
    ...
    //AA contract address
    address public aa_contract = 0x65BC922Decc580C4A54b10B7271fC2C9D7Ce528C; //main net - 0x92b1289Ee1c70cB2e51fA63A448cEeF2734ec6FF

    //MadApesArmory contract address
    address public maa_contract = 0x8D403915886AE151e8c73cfe99e322a85A94670b;
    ...
    function _mintApes(uint256 num) private {
        ...
        require((nonreserved_minted_tokens + num) <= (max_apes - RESERVED_FOR_AA), "Requested mints exceed remaining supply");
    ...
    function setCollectionMax(uint256 _newCollectionMax) public onlyOwner{
        collection_max = _newCollectionMax;
    }
