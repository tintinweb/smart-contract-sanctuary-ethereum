...
contract GhostClub is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant WHITELIST_MAX_MINT_AMOUNT = 15;
    uint256 public constant WHITELIST_MAX_TX_MINT_AMOUNT = 15;
    uint256 public constant MAX_TX_MINT_AMOUNT = 15;
        ...
        mustPassChecks(_mintAmount)
    {
        ...
        emit NewSkullMinted(msg.sender, _mintAmount);
    }
    ...
    function airdrop(address[] calldata _users) public onlyOwner {
        ...
        for (uint256 i = 0; i < _users.length; i++) {
            ...
            emit NewSkullMinted(_users[i], 1);
        }
        marketingSupply -= _users.length;
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        //Team
        (bool successA, ) = payable(owner()).call{value: (balance / 100) * 55}(
            ""
        );
        //Dev
        ...
        (bool successC, ) = payable(0x608328a456D3205fFBAcD2E00AaFE2eE2471dd17)
            .call{value: (balance / 100) * 15}("");
        //Other
        (bool successD, ) = payable(0x7dB4Db09Ef17E01Cb3507CeAC0EDC0fEB99Ef0fD)
            .call{value: (balance / 100) * 15}("");
        require(
