...
contract KOPOKOMafia is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    //Maximum number of NFTs an address can mint
    uint public max_mint_allowed_presale = 500;
    ...
    address[] private _team = [
        0x31492229bFe8A76f60fFc5f56276efEf2BA242fd
    ];
    ...
    constructor() ERC721("KPKPROJECT I DROP", "KPDTest") PaymentSplitter(_team, _teamShares) {
    ...
    **/
    function presaleMint(bytes32[] calldata _proof) external payable nonReentrant {
        //Are we in Presale ?
