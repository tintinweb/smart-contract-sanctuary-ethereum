...
contract ElderApez is ERC721("Elder Apez", "ELDER"), ERC721Enumerable, Ownable {
    bool public isWLReservePhase;
    bool public isPublicReservePhase;
    bool public isBurnPhase;
    bool public isClaimPhase;
    bool public stakeLocked = true;
    uint256 internal maxSupply = 500;
    ...
    ERC20 public ScrapV1 = ERC20(0xFC74349A160BCa86709Ff8B71cf47E912A9dc573); //These will be hard coded on the deployed contract. Just placeholder for now
    IScrapV2 public ScrapV2 = IScrapV2(0xAffFfc6dd5bCE9358F89Ea368cf11752784C82c7);
