...
contract Spin is VRFConsumerBaseV2 {
    ...
    function ReadThewords() public view returns (uint256[] memory) {
        return s_randomWords;
    }

    function CheckNumbers() public view returns (uint256[] memory) {
        return s_requestIdToRandomWords[s_requestAddressforId[msg.sender]];
    }
