...
contract JackpotRoyaleSpecialEdition is ERC1155, Ownable {
    ...
    function getMintedTokenIds() public pure returns (uint256[] memory) {
        uint256[] memory nums;
        ...
        )
    {
        ...
        uint256 communityPrize = (balance / 100) * 50; // 50%
        uint256 firstWinnerPrize = (balance / 100) * 35; // 35%
        uint256 secondWinnerPrize = (balance / 100) * 10; // 10%
