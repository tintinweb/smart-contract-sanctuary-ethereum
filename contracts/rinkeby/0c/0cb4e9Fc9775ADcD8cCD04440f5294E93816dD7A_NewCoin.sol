...
contract NewCoin is IERC721, IERC165, IERC721Metadata, IERC721Enumerable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;

    string internal _name = "NewCoin";
    string internal _symbol = "NC";
    string private _baseURI = "ipfs://QmRgNQtUXk1W9b54URHcw4TVD3uZ8PnHtzEAbRxwKRnN8u/";

    uint256 internal totalMinted = 0;

    uint256 public constant MINTING_LIMIT = 150;
