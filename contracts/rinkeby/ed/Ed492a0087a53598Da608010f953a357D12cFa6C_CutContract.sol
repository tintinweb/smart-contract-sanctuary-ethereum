...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xec25C7539feC85caA8107b0fB07C7aAe0b30FEC9];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://pin.ski/3N75R2K/";
...
// File: contracts/CutContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CutContract is RamppERC721A {
    constructor() RamppERC721A("cut", "CUTIT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/UmEgYaDNOeEJmKEkdRBm/contract-metadata";
    }
}
