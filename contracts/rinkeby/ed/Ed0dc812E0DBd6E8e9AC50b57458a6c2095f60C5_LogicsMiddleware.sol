...
contract LogicsMiddleware is Middleware {
    ...
    constructor(address setup) {
        ...
        _methodsImplementations[ILogics(address(0x00)).setMsg.selector] = setup;
        _methodsImplementations[ILogics(address(0x00)).getMsg.selector] = setup;
    }
