...
contract mint is ERC721, Ownable {
    ...
    uint256 public constant supplyLimit = 5555;
    uint256 public constant mintLimit = 1;
    uint256 public mint = 0 ether;
    string private _baseTokenURI;
    bool public saleActive;

    constructor(string memory initBaseURI) ERC721("Tiff Murakami.FloweR", "Tiff FloweR") {
    ...
    function setMint_THM(uint256 newMint_THM) external onlyOwner {
        mint = newMint_THM;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(0xa01535D3148d02F78679cfc95c6428363C3469Ad).send((contractBalance * 100) / 100), "Withdraw failed");
    }
}