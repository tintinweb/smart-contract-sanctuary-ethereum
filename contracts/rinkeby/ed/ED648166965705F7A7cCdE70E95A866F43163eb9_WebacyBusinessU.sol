...
contract WebacyBusinessU is Initializable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < memberToERC20Contracts[msg.sender].length; i++) {
            ...
            if(currentAmount == 0 || memberToContractToTokenStatus[msg.sender][contractAddress].transferred == true) continue;
    ...
    function deleteStoredData(address _address) external onlyRole(MEMBERSHIP_ROLE) {
