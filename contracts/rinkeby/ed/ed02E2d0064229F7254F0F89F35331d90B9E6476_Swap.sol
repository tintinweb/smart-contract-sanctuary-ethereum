...
contract Swap is Initializable, OwnableUpgradeable, ChainlinkClientUpgradeable {
    ...
    uint256[] public rate = new uint256[](2);//0 index conotains buy and 1 coontains sell
    bytes32[] private chainlinkRequestId = new bytes32[](2);//0 index conotains buy and 1 coontains sell
    
    uint256 private fee;
    
    uint256[] lastTimeStamp = new uint256[](2);//0 index conotains buy and 1 coontains sell
    uint256[] lastPriceFeed = new uint256[](2);//0 index conotains buy and 1 coontains sell
    uint256 rateTimeOut;
