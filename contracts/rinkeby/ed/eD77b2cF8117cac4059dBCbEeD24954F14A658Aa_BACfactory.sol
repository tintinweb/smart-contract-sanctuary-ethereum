...
contract BACfactory {
    ...
    /// Address for implementation of BACtoken to clone
    address public implementation;

    /// Initializes factory with address of implementation logic
    /// @param _implementation BACtoken logic implementation contract to clone
    ...
    function createEdition(
        ...
        BACtoken(newContract).initialize(
            msg.sender,
            _name,
            _symbol,
            _description,
    ...
    /// @return BACtoken Edition NFT contract
