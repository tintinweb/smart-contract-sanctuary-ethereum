...
contract ContractSanta is ERC721A, Ownable {
    ...
    constructor() ERC721A("Santa", "SANTA") {}
    ...
    function mint(uint256 _amount) external {
        require(totalSupply() + _amount <= SUPPLY, "max supply reached");
        ...
        returns (string memory)
    {
        ...
        return
            bytes(_revealedBaseURI).length > 0
                ? string(abi.encodePacked(_revealedBaseURI, tokenId.toString()))
                : baseURI;
    }
}
