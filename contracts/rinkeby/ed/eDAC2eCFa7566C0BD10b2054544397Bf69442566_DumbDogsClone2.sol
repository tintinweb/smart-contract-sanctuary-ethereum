...
contract DumbDogsClone2 is ERC721A, Ownable {
  uint256 constant EXTRA_MINT_PRICE = 0.001 ether;
  uint256 constant MAX_SUPPLY_PLUS_ONE = 100;
  uint256 constant MAX_PER_TRANSACTION_PLUS_ONE = 6;

  string tokenBaseUri = "ipfs://QmULeVUhfgRZjgftpGvreTbcSKddtXiALLZf9M3JxhWXEF/";

  bool public paused = true;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("Dumb Dogs Clone 2", "DDC2") {}
