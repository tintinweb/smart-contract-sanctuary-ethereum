...
contract Pixelmon is ERC721, Ownable {
    ...
    /// How long between price jumps in the dutch auction
...
//===========================
    ...
    function auction(uint256 count) public payable { //(bool mintingTwo)
       ...
       // if(block.timestamp < auctionStartTime || block.timestamp > auctionStartTime + 1 days) revert AuctionNotStarted(); DECIDE if u want it to end after a day or not, probably better to leave it like that
