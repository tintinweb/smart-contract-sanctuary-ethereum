...
contract ThePokerFace  is ERC721Enumerable, Ownable
{
    ...
    uint public second_presale_price= 0.12 ether; 
    uint256 public public_price = 0.14 ether;
    ...
    constructor() ERC721("The Poker Face", "TPF")  {
 ...
 function changeRevelStatus() external onlyOwner {
    ...
    function mint(uint chosenAmount) public payable{
        ...
        require(chosenAmount <= 10, "Number of tokens can not be less than or equal to 0");
