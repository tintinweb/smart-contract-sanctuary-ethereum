...
abstract contract ZombieAttack is ZombieHelper {
        ...
        onlyOwnerOf(_zombieId)
    {
        ...
        require(
            _owners[_zombieId] != _owners[_targetId],
        ...
        emit Attacked(_zombieId, _targetId, _owners[_targetId], win);
    }
}
...
abstract contract ZombieHelper is ZombieFeeding {
    ...
    {
        Zombie[] memory ownerZombies = new Zombie[](_balances[_owner]);
        uint256 counter = 0;
...
abstract contract ZombieFactory is ERC721, Ownable {
    ...
    function createRandomZombie(string memory _name) public {
        require(_balances[msg.sender] == 0, "You already have a zombie");
