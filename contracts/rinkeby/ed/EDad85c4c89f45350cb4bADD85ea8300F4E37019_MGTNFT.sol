...
contract MGTNFT is ERC721, Ownable {
    ...
    mapping(address => uint64) public minted;
    ...
    function mint(uint64 amount) external payable callerIsUser {
        ...
        require(minted[msg.sender] + amount <= amountPerUser, "Exceed");
    ...
    function setUnRevealedBaseURI(string memory unRevealedBaseURI_)
        public
        onlyOwner
    {
