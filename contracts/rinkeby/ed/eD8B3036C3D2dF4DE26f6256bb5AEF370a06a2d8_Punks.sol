...
contract Punks is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = " ipfs://QmNZ44sgYAD9dQtMLhh9xEamaPm4C3x5kjha5oyjjNsADG/";
    ...
    constructor(
    ) ERC721A("CAP", "Cttt", 100, maxSupply) {
    }
