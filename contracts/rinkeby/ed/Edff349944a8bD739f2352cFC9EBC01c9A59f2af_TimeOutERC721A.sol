...
contract TimeOutERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public saleStartTime = 1651856400;
    ...
    uint private constant maxPerAddressDuringPublicMint = 1000;
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(currentTime() < saleStartTime + 168 hours, "Public Sale is finished");
