...
contract PugMoonNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public totalFree = 22;
  uint256 public maxMintAmountPerTx = 6;
  uint256 public maxPerFree = 2;
  uint256 public maxPerFreeWallet = 2;


  string public uriPrefix = 'ipfs://QmaGZDVmMjKKDbCGgvx7WeEXBNK99VZqaEa3LR4tMuCvwu/';
  string public uriSuffix = '.json';

  constructor() ERC721A("PugMoon", "PUG") {
  }
