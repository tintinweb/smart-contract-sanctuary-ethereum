...
/**
    TODO:
        - Check NFT name
        - Add any other withdrawal wallets
        - See if they want a reserve supply
        - Delete Comments
*/
...
/**
    TEST:
        - setSalePrice Invalid data error
*/
...
contract MetaWizards is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint16) private mintList;
    ...
    /*//////////////////////////////////////
                CONSTRUCTOR
    //////////////////////////////////////*/
    constructor(uint16 collectionSize_, uint16 reserveSupply_, uint32 mintData_) ERC721A("Test MW", "TESTMW") {  // "Meta Wizards", "MWIZ"
    ...
    */
        ...
        nonReentrant
    {
        ...
        if (mintStatus == MintStatus.PRESALE) {
            if (mintList[msg.sender] < 1) revert NotOnMintList();
            if (mintList[msg.sender] - _amount < 0) revert MintingTooMany();
    ...
    */
    function setPrice(uint256 _price, uint8 _saleType)
        external
        onlyOwner
    {
    ...
    */
    ...
    /**
        ...
        @return amount The amount of NFTs the address can still mint
    */
    ...
    /**
        ...
        @param _amount The amount of NFTs each whitelisted address can mint (up to maxWallet)
    */
    function addToMintList(address[] calldata _addr, uint16 _amount)
        external
        onlyOwner
    {
