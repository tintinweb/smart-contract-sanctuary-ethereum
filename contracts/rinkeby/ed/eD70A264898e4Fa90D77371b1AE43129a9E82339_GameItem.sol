...
/** 
 *  SourceUnit: /Users/nuttapol.w/SpeedStar/contracts/nfts/GameItem.sol
*/
...
contract GameItem is Ownable, ERC721URIStorage {
    ...
    function mints(
        ...
        for (uint256 index = 0; index < _receiver.length; index++) {
            mint(_receiver[index], _uri[index], _tokenId[index]);
        }
    }
