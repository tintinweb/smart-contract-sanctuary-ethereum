...
contract HyperfyCurated is ERC1155, Ownable {

    struct dropRestrictions {
        uint256 price;
        uint256 maxSupply;
        uint256 supply;
    }

    mapping(uint256 => dropRestrictions) public dropInfo;

    constructor() ERC1155("https://hyperfy.io/metadata/curated/{id}") {}

    function contractURI() public pure returns (string memory) {
        return "https://hyperfy.io/metadata/curated";
    }

    function createDrop(uint256 id, uint256 price, uint256 supplyAmt) public onlyOwner {
    ...
    function devMint(uint256 id, uint256 amount) public onlyOwner {
        ...
        require(dropInfo[id].supply + amount <= dropInfo[id].maxSupply, "Drop supply is full");
