...
contract StoicDAO is ERC721A, Ownable, ReentrancyGuard {
  ...
  function whitelistFreeMint(uint256 _amount, bytes32[] memory _proof) external payable callerIsUser mintCompliance(_amount) {
  ...
  /*///////////////////////////////////////////////////////////////
    ...
    function setFreesaleMaxLimit(uint256 _state) public onlyOwner {
    ...
    function setWalletFreeMaxLimit(uint256 _state) public onlyOwner {
