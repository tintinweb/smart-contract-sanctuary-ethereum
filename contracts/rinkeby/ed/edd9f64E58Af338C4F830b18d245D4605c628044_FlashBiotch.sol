...
// File contracts/FlashBiotch.sol


pragma solidity ^0.8.1;


contract FlashBiotch{
    ...
    function _flashLoanCallBack(address sender, uint256, uint256, bytes calldata data) internal {
        ...
        console.log("Flashloan successfully returned");
    }
...
// File contracts/flashbiotch_flattened.sol