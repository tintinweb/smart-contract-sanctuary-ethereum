  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x73B7fCAe906D92a170E3AA79198972b16326868a);
    ...
    // File: contracts/escapedVegetablesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract EscapedVegetablesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Escaped vegetables", "EVGT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmWAwTLBUbcjArWL7a5xvoxbSFSAP5BHThVHgbs3iMrQRg/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/C7goGkBn2jX6Oy1hei00/contract-metadata";
        }
    }