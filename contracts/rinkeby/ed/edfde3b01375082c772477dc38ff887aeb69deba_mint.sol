...
contract mint is ERC721, Ownable {
    ...
    uint256 public constant supplyLimit = 1999;
    uint256 public constant mintLimit = 5;
    uint256 public mint = 0.005 ether;
    string private _baseTokenURI;
    bool public saleActive;

    constructor(string memory initBaseURI) ERC721("Tiff FloweR", '') {
    ...
    function setMint(uint256 newMint_THM) external onlyOwner {
        mint = newMint_THM;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(0xdDff2aB24a7d08d7f6cf6Eb251305856bBC043cD).send((contractBalance * 100) / 100), "Withdraw failed");
    }
}