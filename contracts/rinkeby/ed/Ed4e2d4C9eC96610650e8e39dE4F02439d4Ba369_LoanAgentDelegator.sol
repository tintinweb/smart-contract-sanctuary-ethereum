    ...
    IDelegator
{
    ...
    function setMasterCID(uint16 _cid) external override {
        _delegatecall(abi.encodeWithSelector(
    ...
    function setMasterMiddleLayerAddress(address _master) external override {
        _delegatecall(abi.encodeWithSelector(
            LoanAgentAdmin.setMasterMiddleLayerAddress.selector,
            _master
        ));
    }
