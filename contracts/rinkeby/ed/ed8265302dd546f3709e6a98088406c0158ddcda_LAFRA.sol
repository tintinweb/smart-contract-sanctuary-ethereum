...
contract LAFRA is ERC20Interface, Context, Ownable, Pausable{
    ...
    mapping(address => mapping(address => uint256)) private reflection;
    mapping(address => bool) private isExcludedFromFee;
    mapping(address => bool) private isExluded;
    address[] private excluded;

 //   uint256 private constant MAX = ~uint256(0);
 //   uint256 private reflections = (MAX - (MAX % totalSupply));
    // allowed[0x1111....][0x22222...] = 100;

//    uint256 TAX = 8;
//    uint256 private previousTAX = TAX;
    ...
    function _transfer(address from, address to, uint tokens) internal {
        ...
        uint256 tokensToTransfer = tokens.sub(tokensToLock);
