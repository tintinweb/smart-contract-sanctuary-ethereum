...
// File: contracts/SpaceRidersX.sol

pragma solidity >=0.8.0 <0.9.0;

error TokenDoesntExist();

contract SpaceRidersX is ERC721A, Ownable {
    mapping(uint256 => string) private _tokenURIs;

    event NewSpaceRidersXMinted(address sender);

    constructor() ERC721A("Space Riders X", "SRX") {}
        ...
        onlyOwner
    {
        ...
        emit NewSpaceRidersXMinted(msg.sender);
    }
