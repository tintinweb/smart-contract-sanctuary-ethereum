...
contract ExcitedChimpsParadiseClub is ERC721A, Ownable {
    ...
    string internal baseURI;                            // image URI
    address payable withdrawWallet;                     // to retrive the funds
    ...
    constructor() ERC721A("Excited Chimps Paradise Club", "ECPC") {
       ...
       maxPerWallet = 3;
       baseURI = "ipfs://CID/";
       withdrawWallet = payable(0x381fD5769927063980Ab9Cea42E86Ab47D7081AF); // place wallet here ;
    }
