...
contract ExodusTreasury is ExodusAccessControlled, ITreasury {
    ...
    function deposit(
        ...
        // mint EXO needed and store amount of rewards for distribution
    ...
    /**
     * @notice allow approved address to burn EXO for reserves
     * @param _amount uint256
     * @param _token address
     */
    ...
    /**
     * @notice mint new EXO using excess reserves
     ...
     * or EXO from the treasury, using sEXO as collateral. This might allow an
     * sEXO holder to provide EXO liquidity without taking on the opportunity cost
    ...
    /**
     * @notice allow approved address to repay borrowed reserves with EXO
     * @param _amount uint256
     */
    function repayDebtWithEXO(uint256 _amount) external {
        require(permissions[STATUS.RESERVEDEBTOR][msg.sender] || permissions[STATUS.EXODEBTOR][msg.sender], notApproved);
    ...
    /**
     * @notice returns EXO valuation of asset
     * @param _token address
     * @param _amount uint256
