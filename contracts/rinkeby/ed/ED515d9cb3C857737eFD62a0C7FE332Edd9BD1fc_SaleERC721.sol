...
contract SaleERC721 is ERC721, Ownable, Ticketed {
    ...
    constructor(string memory baseURI, uint256 _maxSupply) ERC721("Sleepy Giant", "SLPG") {
    ...
    function isWhitelisted(bytes calldata _signature, uint256 spotId) public view returns (bool) {
        return _verify(keccak256(abi.encodePacked(msg.sender, spotId)), _signature);
    }
...
contract Ticketed {
    ...
    address public _signer = address(0);
