...
contract ShunaV2Staking_Admin is ShunaV2Staking_View, Ownable {
        ...
        onlyOwner
    {
        ...
        PoolsArr.push(
            PoolInfo(
                _tokenAddr,
                [0, _commonAmt, _rareAmt, _legendaryAmt, _mythicAmt]
            )
        );
...
contract ShunaV2Staking_View {
        ...
        returns (NFTRewardInfo memory)
    {
        ...
        if (ClaimsTable[_poolId][_nftId] == true)
            return NFTRewardInfo(_rwdToken, 0); // already claimed
        ...
        return NFTRewardInfo(_rwdToken, _nftRwd2);
    }
}
