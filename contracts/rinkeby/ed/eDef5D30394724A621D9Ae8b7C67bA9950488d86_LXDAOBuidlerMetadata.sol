...
contract LXDAOBuidlerMetadata is Ownable, ILXDAOBuidlerMetadata, Base58 {
    ...
    modifier onlyOwnerOrController() {
        require(
            ...
            "LXDAOBuidlerMetadata: caller is not the contract owner or token owner."
        );
        _;
    }
    ...
    function batchUpdate(
        ...
        require(
            ...
            "LXDAOBuidlerMetadata: the length of tokenIds is not equal to the length of metadataURIs."
        );
    ...
    // todo what will happen if no token in the tokenMetadataURIs
