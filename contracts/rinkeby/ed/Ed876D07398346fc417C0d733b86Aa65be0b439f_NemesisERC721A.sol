...
contract NemesisERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_SUPPLY = 99;
    uint private constant MAX_GIFT = 9;
    uint private constant MAX_WHITELIST = 6;
    uint private constant MAX_PUBLIC = 84;
    ...
    uint public saleStartTime = 1655649011;
    ...
    uint private constant maxPerAddressDuringPublicMint = 9;
    ...
    */
    ...
    /**
    * @notice Mint funtion for the Whitelist Sale
    *
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require (currentTime() < saleStartTime + 48 hours, "Sale is finished");
    ...
    */ 
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(currentTime() < saleStartTime + 144 hours, "Public sale is finished");
        uint price = publicSalePrice;
        require(price != 0, "Price is 0");
        require(sellingStep == Step.PublicSale, "Public sale is not activated");
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "You can only get 9 NFTs on the Public Sale");
    ...
    * @notice Allows to set the whitelist sale price
    *
    * @param _publicSalePrice The new price of one NFT during the whitelist sale
    */
    ...
    *
    * @param _saleStartTime The new starting timestampe of the whitelist sale
    */
    ...
    *
    * @param _isPaused true or fals if we want to pause or unpause the contract
    */
