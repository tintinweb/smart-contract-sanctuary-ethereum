...
contract NFTPortfolio is ERC721A, Ownable {
    string public baseURI = "ipfs://QmSKKdT5qJCZuGpKpM6BsUoGoVretRWE3yS2ey6xUN9W6K?";
    bool public saleStatus = true;

    // Price and supply definition
    uint256 constant public TOKEN_PRICE = 0.01 ether; 
    uint256 constant public TOKEN_MAX_SUPPLY = 99999;

    // Protection
    mapping (address => uint256) amountMinted;
    uint256 public mintLimit = 5;

    constructor () ERC721A("NFTPortfolio", "NFTP") {
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(totalSupply() + quantity <= TOKEN_MAX_SUPPLY, "No more NFT left");
