...
contract  Testverse  is ERC721Enumerable, Ownable
{
  ...
  uint public status = 0; //0-pause 1-Whitelist 2-PreSale 3-Public
    ...
    constructor() ERC721("Test Verse", "TV")  {
    _uriBeforeRevel = "";
    }
  ...
  function setBaseURI(string memory _baseURI) external onlyOwner {
    ...
    // modifier checkPrice(uint256 chosenAmount) {
    //     require(msg.value >= chosenAmount * price, "Sent ether value is incorrect");
    //     _;
    // }

    modifier checkLimit(uint256 chosenAmount) {
    ...
    function mint(uint chosenAmount) public payable checkLimit(chosenAmount) isSaleOpen{
        // require(status == 2 || status == 3 , "Sale is not active ");
        // require(totalSupply()+chosenAmount<=_TOTALSUPPLY-reserve,"Quantity must be lesser then MaxSupply");
        // require(status == 3 || totalSupply()+chosenAmount<=_PUBLICSUPPLY ,"Quantity must be lesser then PreSale MaxSupply");
        // require(chosenAmount > 0, "Number of tokens can not be less than or equal to 0");
   ...
   function setStatus(uint256 s)external onlyOwner{
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0xEbFEe5E962FB4c45504927B1dAeaFAc6051463ae).transfer(balance);
