...
contract HitchHikerOfStar is ERC721A, Ownable {
    ...
    uint256 public phaseOneMaxAmount;
    uint256 public phaseTwoMaxAmount;
    uint256 public phaseThreeMaxAmount;
    ...
    function freeMint(
        ...
        if (freeMinted > phaseOneMaxAmount) {
    ...
    function dutchAuctionMint(address to, uint256 amount) external payable {
        ...
        if (dutchAuctionMinted + amount > phaseTwoMaxAmount) {
            revert Error_MintExcessAllowance();
        }
    ...
    function whiteListMint(
        ...
        if (whiteListMinted + amount > phaseThreeMaxAmount) {
            revert Error_MintExcessAllowance();
        }
    ...
    ///           admin functions
    /////////////////////////////////////////////////////////////
    function setPhaseOneMaxAmount(uint256 amount) external onlyOwner {
        phaseOneMaxAmount = amount;
    }

    function setPhaseTwoMaxAmount(uint256 amount) external onlyOwner {
        phaseTwoMaxAmount = amount;
    }

    function setPhaseThreeMaxAmount(uint256 amount) external onlyOwner {
        phaseThreeMaxAmount = amount;
    }
