...
contract PremintCreatorKey is ERC721, ERC721Enumerable, Ownable, Pausable {
  ...
  constructor() ERC721("Premint Creator Key", "PREMINTKEY") {
    baseURI = "ipfs://QmYxBEF1CMZQF21ZnduYrEas8HQnvHgDhhYoQUprm9mdRk/";
  ...
  // @notice Mint function for the whitelisted users of the contract
  function whitelistMint(address to, uint256 amount) external whenNotPaused {
    require(_whitelisted[to] = true,"only whitelisted users can able to mint");
    _multimint(to, amount);
  }
