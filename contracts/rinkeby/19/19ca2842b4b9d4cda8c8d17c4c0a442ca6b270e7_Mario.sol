...
contract Mario is ERC721Enumerable, Ownable {
    ...
    uint256 public constant marioPrice = 100000000000000; //0.008 ETH

    uint public constant MAX_PER_USER = 3;
    ...
    function addWhitelistPrePay(Whitelist[] memory accounts) external onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
            ...
            require(whitelistPrePay[accounts[i].account] == 0, "cannot add the same user again");   ////// why not??
