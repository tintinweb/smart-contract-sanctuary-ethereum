...
/// @title Catheon Gaming Center ERC721A NFT Contract
/// @dev ERC721A - more security and gas optimized
/// @author @seiji0411
contract CGCNftERC721ACollection is ERC721A, Ownable {
    ...
    modifier mintPriceCompliance(uint256 _mintAmount) {
        if (_msgSender() != owner() && msg.value < mintPrice * _mintAmount)
            revert MintInsufficientFund();
        _;
    }
    ...
    function withdraw(address _to) external onlyOwner payable {
