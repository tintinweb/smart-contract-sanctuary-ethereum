...
contract BountyGamesR2 is ERC721, EIP712, Ownable {
    ...
    uint256 public startSalesTimestamp = 1661473886;

    uint256 public endSalesTimestamp = 1664152286;
...

    {
        ...
        _contractUri = "ipfs://QmRqF2hS14bMyXjGGi43kAoqEZWYRXV51BVMJyQTrA5zES";
    ...
    function getTurnInFee() public view returns (uint256) {
        ...
        return address(this).balance / 2 / 100 * 5;
    ...
    function arrest(uint256 tokenId) external payable {
        ...
        uint256 fee = getTurnInFee();

        require(msg.value >= fee, "ether sent is under turn in price, try again");
