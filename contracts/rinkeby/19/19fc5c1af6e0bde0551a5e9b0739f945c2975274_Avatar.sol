...
contract Avatar is IAvatar, ERC721, Ownable, Pausable {
    ...
    IAuthenticator internal immutable _authenticator;
    ...
    function mintAvatar(
        ...
        bytes32 digest = _authenticator.generateMintSignatureDigest(
            msg.sender,
            signatureExpiration,
            price,
        ...
        require(
            _authenticator.verifySignature(signatureAddress, digest, signature),
    ...
    function reserveAvatar(
        ...
        bytes32 digest = _authenticator.generateReservationSignatureDigest(
            msg.sender,
            signatureExpiration,
            price
        );
