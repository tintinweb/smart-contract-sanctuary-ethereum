...
contract GalacticBunny is Context, IERC20, Ownable {
    ...
    address public devWallet = 0xB7bFc608Be9356A049440a0E329681b90B76fF1c;
    address public marketingWallet = 0x51b41c4b63191B7638eAd1f43F29C088B374d942;
    ...
    constructor(address _newOwner) {
        ...
        _isExcludedFromAntiWhale[devWallet] = true;
        _isExcludedFromAntiWhale[marketingWallet] = true;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 tokensToSwap = liquidityTokens.add(devTokens).add(marketingTokens);
            ...
            uint256 liqEth = newBalance.mul(liquidityTokens).div(tokensToSwap);
