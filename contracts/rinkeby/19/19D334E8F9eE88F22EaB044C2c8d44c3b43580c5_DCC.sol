...
contract DCC is IDCC, AccessControlEnumerable, ERC721A, Ownable {
    ...
    string private baseImageURI = "https://dcc.nine-chronicles.com/pfp/";
    ...
    uint256 public constant MAX_QUANTITY_LIMIT = 4000;
    ...
    */
    ...
    constructor() ERC721A("DCC", "DCC") {
        ...
        TRAITS_ATTR[t] = ["", "bg1", "bg2", "bg3", "bg4", "bg5"];
        TRAITS_RARITY[t] = [0, 128, 50, 50, 50, 50];
        ...
        TRAITS_ATTR[t] = ["", "skin1", "skin2", "skin3", "skin4"];
        TRAITS_RARITY[t] = [0, 128, 50, 30, 10];
        for (uint a = 0; a < TRAITS_RARITY[t].length; a++) TRAITS_RARITY_SUM[t] += TRAITS_RARITY[t][a];
        ...
        TRAITS_ATTR[t] = ["",
            ...
            "et21", "et22", "et23", "et24", "et25", "et26", "et27", "et28", "et29", "et30",
            "et31", "et32", "et33", "et34", "et35", "et36", "et37", "et38", "et39", "et40",
            "et41", "et42", "et43"];
        TRAITS_RARITY[t] = [0,
            128, 128, 128, 128, 128, 128, 128, 128, 128, 128,
            128, 128, 128, 128, 128, 128, 128, 128, 128, 128,
        ...
        TRAITS_ATTR[t] = ["", "ac1", "ac2", "ac3", "ac4", "ac5", "ac6", "ac7", "ac8", "ac9", "ac10", "ac11", "ac12"];
        TRAITS_RARITY[t] = [0, 128, 128, 128, 128, 128, 128, 128, 128, 50, 50, 50, 16];
        for (uint a = 0; a < TRAITS_RARITY[t].length; a++) TRAITS_RARITY_SUM[t] += TRAITS_RARITY[t][a];
        TRAITS_HIDDEN[t] = 26;
        ...
        TRAITS_ATTR[t] = ["", "g1", "g2", "g3", "g4", "g5", "g6", "g7", "g8"];
        TRAITS_RARITY[t] = [0, 128, 128, 128, 128, 50, 50, 16, 16];
        for (uint a = 0; a < TRAITS_RARITY[t].length; a++) TRAITS_RARITY_SUM[t] += TRAITS_RARITY[t][a];
        TRAITS_HIDDEN[t] = 26;

        t = uint(TraitType.CAT);
        TRAITS_NAME[t] = "Cat";
        TRAITS_ATTR[t] = ["", "cat1", "cat2", "cat3", "cat4"];
        TRAITS_RARITY[t] = [0, 128, 50, 10, 2];
        for (uint a = 0; a < TRAITS_RARITY[t].length; a++) TRAITS_RARITY_SUM[t] += TRAITS_RARITY[t][a];
    ...
    function _imageURI(uint256 _tokenId) internal view returns (string memory) {
        ...
        if (isRevealed()) {
            ...
            for (uint i = 0; i < TRAITS_COUNT; i++) {
                ...
                string memory suffix = i < (TRAITS_COUNT - 1) ? '-' : '.png';
                output = string(abi.encodePacked(output, traitValue, suffix));
            }
        } else {
            output = string(abi.encodePacked(output, 'unknown.png'));
        }
