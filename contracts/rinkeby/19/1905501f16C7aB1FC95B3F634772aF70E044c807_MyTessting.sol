...
contract MyTessting is ERC721Enumerable, ReentrancyGuard , Ownable {
    ...
    uint256 public maxQtyPerTransaction = 10; //max per tx public mint   
    ...
    constructor(              
        ...
        ERC721("Operation Access Foundation", "OAF")        
    {
