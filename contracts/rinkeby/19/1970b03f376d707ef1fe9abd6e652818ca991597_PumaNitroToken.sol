...
contract PumaNitroToken is ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    // minting variables
    string public _baseTokenURI = "ipfs://QmbQ9VfrfrCiBchFZzud89YBJ9bALeDDWCpD2M5DrcVDkf/";
    Status public state;
    ...
    function snapshotClaim() external nonReentrant {
        ...
        require(amountClaimable > 0, "PUMA Nitro Token: Amount Claimable is 0");
        claimCount += amountClaimable;
        require(claimCount <= MAX_SUPPLY, "PUMA Nitro Token: Mint Supply Exceeded");
        holderSnapshot[msg.sender] = 0;
        _safeMint(msg.sender, amountClaimable);
    }
