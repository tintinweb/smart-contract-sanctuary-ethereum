...
contract Moonkeys is ERC721A, ReentrancyGuard, Ownable {
    ...
    function withdraw() external nonReentrant onlyOwner {
        ...
        (bool success1, ) = payable(0xCad572443FEd203De0445829Ec6bdd4D525A26C2)
            .call{value: wallet1Value}("");
        (bool success2, ) = payable(0xCad572443FEd203De0445829Ec6bdd4D525A26C2)
            .call{value: wallet2Value}("");
        (bool success3, ) = payable(0x4069afe7352fD6697759A8FEe011b8aD5E8E3806)
            .call{value: wallet3Value}("");
        (bool success4, ) = payable(0x13508f2931195630039b152Addde0b0B6b028C6d)
