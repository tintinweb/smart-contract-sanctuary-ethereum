...
contract Kono is ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction {
  ...
  constructor(
    ...
    tiers.push(Tier("Private", 0.07 ether, 99));
    tiers.push(Tier("Pre-sale", 0.08 ether, 199));
    tiers.push(Tier("Public Sale Tier 1", 0.09 ether, 1999));
    tiers.push(Tier("Public Sale Tier 2", 0.10 ether, 2999));
  }
