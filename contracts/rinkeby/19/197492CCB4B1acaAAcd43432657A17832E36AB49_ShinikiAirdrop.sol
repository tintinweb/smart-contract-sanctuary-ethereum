    ...
    PausableUpgradeable
{
    ...
    function initialize(IERC721Upgradeable _tokenShiniki, address _ownerToken, address signatureVerifier)
        external
        initializer
    {
        __Ownable_init();
    ...
    function claim(
        ...
        require(receiver == msg.sender, "ShinikiAirdrop: caller is not receiver");
        require(
            SIGNATURE_VERIFIER.verifyClaimAirdrop(receiver, tokenIds, nonce, signature),
