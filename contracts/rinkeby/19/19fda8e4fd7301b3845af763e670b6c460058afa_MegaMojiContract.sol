...
// File: contracts/MegaMojiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MegaMojiContract is RamppERC721A {
    constructor() RamppERC721A("MegaMoji", "MEGAM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/aVDklLOh8N8MGGCZdtRb/contract-metadata";
    }
}