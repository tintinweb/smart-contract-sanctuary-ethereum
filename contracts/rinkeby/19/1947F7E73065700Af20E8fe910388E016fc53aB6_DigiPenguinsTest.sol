...
import "./DigiPenguins.sol";

contract DigiPenguinsTest is
	DigiPenguins
{
	// Only development env.
	function setStartTime(uint256 _starttime) external onlyOwner {
		freeMintStartTime = _starttime;
		publicMintStartTime = freeMintStartTime + (60 * 60 * 50);
	}

	function setPublicMintedAmount(uint256 _amount) external onlyOwner {
		_publicMintedAmount = _amount;
	}
