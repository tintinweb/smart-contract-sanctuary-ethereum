...
// solhint-disable
contract Cawlt is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x100111db65B3492ee7A36B334Bb15ad86E632D98);
    address payable public devAddress =
        payable(0x100111db65B3492ee7A36B334Bb15ad86E632D98);
    address payable public liquidityAddress =
        payable(0x2502F5413CFCF8ea8BE2328BB26dFB906467247C);
    ...
    string private constant _name = "CAWLT";
    string private constant _symbol = "CWLT";
