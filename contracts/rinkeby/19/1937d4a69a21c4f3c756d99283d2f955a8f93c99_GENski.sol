...
// File: contracts/DEATHSKIGENSKI.sol
...
contract GENski is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("GENski", "GSKI") {
    setHiddenMetadataUri("ipfs://QmRPLXgHGWGiTDYYvncoroszr1UjxQafhRUq4nbyvjw97M");
  }
