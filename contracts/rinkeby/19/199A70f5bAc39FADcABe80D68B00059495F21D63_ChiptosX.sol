...
contract ChiptosX is ERC721A, Ownable {
    ...
    bool public isChipListActive;
    bool public freeIsActive;
    bool public saleIsActive;
    bool public preSaleIsActive;

    uint256 public constant MAX_SUPPLY = 30;
    uint256 public constant MAX_PUBLIC_MINT = 5;
    uint256 public PRICE_PER_TOKEN = 0.0000000000088 ether;
    ...
    constructor() ERC721A("Chiptos X", "CHIPTO") {
    }
    ...
    function setChipHolderFreeList(address[] calldata addresses, uint8 numHolderFreeAllowedToMint, uint8 numAllowedToMint) external onlyOwner callerIsUser{
...
// Holder Free
    function holderFree(uint8 numberOfTokens) external payable callerIsUser{
        ...
        require(freeIsActive, "Chiplist is not active");
