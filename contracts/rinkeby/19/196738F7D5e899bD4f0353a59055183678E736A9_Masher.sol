...
library MultiPartRLEToSVG {
  ...
  function generateSVG(
    ...
    string[] memory palette,
    uint8 distortionAmount
  ) internal view returns (string memory svg) {
    bool glitch = distortionAmount > 1;
    return
      string.concat(
        ...
        '<filter id="d">',
        '<feTurbulence type="turbulence" baseFrequency="0.01" numOctaves="5" result="dt"/>',
        '<feDisplacementMap in2="dt" in="SourceGraphic" scale="',
        Strings.toString(distortionAmount),
        '">',
        '<animate attributeName="scale" values="',
        glitch ? Strings.toString(distortionAmount) : "1",
        ";",
        glitch ? Strings.toString(distortionAmount + 1) : "1",
        '" dur="',
        glitch ? "0.15s" : "",
    ...
    returns (string memory svg)
  {
    ...
    for (uint8 p = 0; p < parts.length; p++) {
      if (parts[p].nothing == false) {
        console.log("making...", parts[p].name);
