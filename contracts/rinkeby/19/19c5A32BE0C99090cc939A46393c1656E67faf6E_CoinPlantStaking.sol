...
/* 
  ________  ________  ___  ________   ________  ___       ________  ________   _________        ________  _________  ________  ___  __    ___  ________   ________
 |\   ____\|\   __  \|\  \|\   ___  \|\   __  \|\  \     |\   __  \|\   ___  \|\___   ___\     |\   ____\|\___   ___\\   __  \|\  \|\  \ |\  \|\   ___  \|\   ____\
 \ \  \___|\ \  \|\  \ \  \ \  \\ \  \ \  \|\  \ \  \    \ \  \|\  \ \  \\ \  \|___ \  \_|     \ \  \___|\|___ \  \_\ \  \|\  \ \  \/  /|\ \  \ \  \\ \  \ \  \___|
  \ \  \    \ \  \\\  \ \  \ \  \\ \  \ \   ____\ \  \    \ \   __  \ \  \\ \  \   \ \  \       \ \_____  \   \ \  \ \ \   __  \ \   ___  \ \  \ \  \\ \  \ \  \  ___
   \ \  \____\ \  \\\  \ \  \ \  \\ \  \ \  \___|\ \  \____\ \  \ \  \ \  \\ \  \   \ \  \       \|____|\  \   \ \  \ \ \  \ \  \ \  \\ \  \ \  \ \  \\ \  \ \  \|\  \
    \ \_______\ \_______\ \__\ \__\\ \__\ \__\    \ \_______\ \__\ \__\ \__\\ \__\   \ \__\        ____\_\  \   \ \__\ \ \__\ \__\ \__\\ \__\ \__\ \__\\ \__\ \_______\
     \|_______|\|_______|\|__|\|__| \|__|\|__|     \|_______|\|__|\|__|\|__| \|__|    \|__|       |\_________\   \|__|  \|__|\|__|\|__| \|__|\|__|\|__| \|__|\|_______|
                                                                                                   \|_________|
 */
...
contract CoinPlantStaking is Ownable, ERC721Holder, ReentrancyGuard {
    IERC20 public pollenRewardsToken;
    IERC721 public coinPlantNft;

    // uint256 constant stakingTime = 24 * 3600 seconds;
    uint256 constant stakingTime = 60 seconds;
    uint256 constant rewardsAmount = 10e18;
    ...
    constructor(IERC721 _coinPlantNft, IERC20 _rewardsToken) {
        coinPlantNft = _coinPlantNft;
        pollenRewardsToken = _rewardsToken;
    }
    ...
    function initStaking() public onlyOwner {
        ...
        initialised = true;
        pollenRewardsToken.approve(address(this), 776900000 * 10**18);
    }
    ...
    function _stake(address _user, uint256 _tokenId) internal {
        ...
        require(
            coinPlantNft.ownerOf(_tokenId) == _user,
        ...
        // coinPlantNft.approve(address(this), _tokenId);
        coinPlantNft.safeTransferFrom(_user, address(this), _tokenId);
    ...
    function _unstake(address _user, uint256 _tokenId) internal {
        ...
        coinPlantNft.safeTransferFrom(address(this), _user, _tokenId);
    ...
    function updateReward(address _user) public {
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            if (
                ...
                staker.balance += rewardsAmount * stakedDays;
    ...
    function claimReward(address _user) public {
        ...
        pollenRewardsToken.transferFrom(
            address(this),
            _user,
    ...
    function emergencyWithdraw(uint256[] memory tokenIDs) public onlyOwner {
        ...
        for (uint256 i; i < tokenIDs.length; i++) {
            address receiver = tokenOwner[tokenIDs[i]];

            if (
                receiver != address(0) &&
                coinPlantNft.ownerOf(tokenIDs[i]) == address(this)
            ) {
                coinPlantNft.transferFrom(address(this), receiver, tokenIDs[i]);
            }
        }
    }
}
