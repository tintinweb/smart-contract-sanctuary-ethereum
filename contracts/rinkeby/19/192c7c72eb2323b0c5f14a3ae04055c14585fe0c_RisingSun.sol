...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable USDT = address(  0xcBC351B996E6d724a0d3D351AD5953990348cF40); //USDT
...
contract RisingSun is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000000000000000 * 10**18;
    ...
    address public _marketingWalletAddress = 0x82A4C9437C7aA6711b79e8916820a86761c43619;
    address public _donationWallet = 0xc662D568EECc9EaBB9BAF6e4225Ca628C82542D3;
    ...
    constructor() public ERC20("Rising Sun", "SUN") {
        ...
        */
        _mint(owner(), 100000000000000000000 * 10**18);
    }
...
contract RisingSunDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("RisingSun_Dividen_Tracker", "RisingSun_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10000000000 * 10**18; //must hold 10000000000+ tokens
    }
