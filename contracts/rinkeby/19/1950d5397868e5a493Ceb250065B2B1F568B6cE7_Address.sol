...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xA4a6DB60a345e40F389792952149b2d1255B9542); // Marketing Address
    ...
    uint256 private _tTotal = 42000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BabyDogeShadow";
    string private _symbol = "BabyDogeS";
