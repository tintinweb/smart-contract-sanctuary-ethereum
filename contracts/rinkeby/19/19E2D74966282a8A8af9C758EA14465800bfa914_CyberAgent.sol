    ...
    ERC2981
{
    ...
    constructor(
        ...
        uint96 _percentageRoyalty
    ) ERC721(name_, symbol_) {
        _setBaseURI(baseURI_);
        if (_receiverRoyalty != address(0)) {
            _setDefaultRoyalty(_receiverRoyalty, _percentageRoyalty);
        }
    }
    ...
    function setBaseURI(string memory baseUri_) external onlyOwner {
        string memory _oldUri = _baseURI();
        _setBaseURI(baseUri_);
        emit SetBaseURI(_oldUri, baseUri_);
    }

    /**
     *  @notice Replace tokenURI by new URI.
     *
     *  @dev    Only owner can call this function.
     */
    ...
    function mint(
        ...
        emit Minted(_tokenId, _owner, _uri);
    }

    /**
     *  @notice Mint nft with royalty fee.
     *
     *  @dev    Only owner can call this function.
     */
    function mintWithRoyalty(
        ...
        _mint(_owner, _tokenId);
        _setTokenURI(_tokenId, _uri);
        _setTokenRoyalty(_tokenId, _receiverRoyalty, _percentageRoyalty);
