...
contract CartV2 is Ownable, Pausable, ReentrancyGuard, IERC721Receiver, IERC1155Receiver {
    ...
    function buyOS(uint256 weth2Eth, MarketOrder[] memory marketOrders)
        external
        payable
        nonReentrant
        whenNotPaused
    {
        if (weth2Eth > 0) {
            weth.safeTransferFrom(msg.sender, address(this), weth2Eth);
