...
contract Adlunam is Ownable, ERC721, ReentrancyGuard {
    uint256 private _tokenIds;

    mapping(address => bool) private whitelist;

    constructor() ERC721("ADLUNAM NFTs", "ANFT") {}

    function addWhitelist(address addr) public onlyOwner {
        require(whitelist[addr] == false, "Address already whitelisted");
        whitelist[addr] = true;
    }

    function removeWhitelist(address addr) public onlyOwner {
        require(whitelist[addr] == true, "Address not whitelisted");
