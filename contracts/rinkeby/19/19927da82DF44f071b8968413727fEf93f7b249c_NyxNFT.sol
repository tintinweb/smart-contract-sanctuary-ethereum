...
contract NyxNFT is ERC1155Supply, Ownable
{
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 allowedWithdraw = totalWithdraw - alreadyWithdraw;
        // uint256 restWithdraw = address(this).balance - allowedWithdraw;
        uint256 restWithdraw = waveBalance[wave] - allowedWithdraw;
