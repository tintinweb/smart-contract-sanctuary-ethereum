...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 6601 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZbJsSbaEfCu37r9rXx5MASDqpRd9SehCy7BFJLzExAqs/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6601");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6601");
...
// File: contracts/PupanddumpContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PupanddumpContract is RamppERC721A {
    constructor() RamppERC721A("PUP AND DUMP", "PND"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/pbjv1KA2HDogOc93rMW5/contract-metadata";
    }
}
