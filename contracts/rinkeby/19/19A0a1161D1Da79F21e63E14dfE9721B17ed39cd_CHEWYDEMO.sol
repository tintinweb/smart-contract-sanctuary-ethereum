...
contract CHEWYDEMO is ERC721, ERC721Enumerable, Ownable,  ERC721Burnable, ERC721Royalty, EIP712Whitelist{
    ...
    address private constant WALLET_ADDRESS_1 = 0xD890d244a1cFd2212509EEa6ea43de620e2e30f7; 
    address private constant WALLET_ADDRESS_2 = 0xD890d244a1cFd2212509EEa6ea43de620e2e30f7;   

    uint96 private constant SELLER_FEE = 1000; //10%
    uint256 private constant REDEEM_STARTAT = 1577836800; //Wed Jan 01 2020
    
    bool public onSale = true; 
    string private baseURI_ = "ipfs://QmY1iN1WKeZF5nUStYheBCY13wur9ZWbydjLM2iruk6ffh/";
    ...
    constructor() ERC721("CHEWYDEMO", "CHEWY") {
    ...
    */
    function withdraw() external {
        ...
        payable(WALLET_ADDRESS_1).transfer(balance * 2/5);
        payable(WALLET_ADDRESS_2).transfer(balance);
    }
...
contract EIP712Whitelist is EIP712{
    address private constant SIGNER_ADDRESS= 0xD3F558B423A7e46C0e1EC982f09c863F09ad07c4;

    constructor()  EIP712("CHEWYDEMO","1"){}
