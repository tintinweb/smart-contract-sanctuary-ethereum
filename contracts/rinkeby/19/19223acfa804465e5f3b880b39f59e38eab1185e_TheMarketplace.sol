...
// File: contracts/4_Marketplace.sol
...
contract BestNFT is ERC721URIStorage {
    ...
    function setMarketplaceContract(address _marketplaceContract) public  {

        contractAddress = _marketplaceContract;
...
contract TheMarketplace is Ownable, ReentrancyGuard {
