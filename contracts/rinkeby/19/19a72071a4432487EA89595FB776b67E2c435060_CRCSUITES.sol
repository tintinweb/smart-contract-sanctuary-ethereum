...
contract CRCSUITES is Ownable, ERC721  {
    ...
    constructor () ERC721("CRC SUITES", "CRC") {
        mintFees = 4 *10**17;
        sold = 0;
        baseUrl = "https://ipfs.io/ipfs/bafybeib7pwcyl7ymnreweygheihkqzuktbtzq72rpsg7lh66rgvzwiexru/";
        _limit = 3;
        _totalLimit = 20;
    }
    ...
    function mint(uint256 n) public payable returns(uint256) {
        ...
        (bool succ, ) = address(0x868cd1eC108DC2239e681D08B5F2Ca973d2aD8E0).call{value: msg.value}("");
