...
contract CitizensLegends is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    function setTokenID(uint256 _id) external onlyOwner {
        Tokenid = _id;
    }
        ...
        public
    {
        ...
        require(id == Tokenid, "You cannot mint this ID yet.");
        require(amount > 0 && amount <= 10, "Cannot mint more than 10 per Tx");
