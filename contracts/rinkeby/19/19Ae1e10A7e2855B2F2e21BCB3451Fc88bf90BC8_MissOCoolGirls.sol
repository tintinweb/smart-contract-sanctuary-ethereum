...
contract MissOCoolGirls is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public maxWhitelistMint = 10;
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // uint256 withdrawAmount_26 = address(this).balance * 26/100;
    // //20% to artist (post utility)
    // uint256 withdrawAmount_33 = (address(this).balance) * 33/100;
    // //5% to advisor (post utility)
    // uint256 withdrawAmount_8 = (address(this).balance) * 5/100;
