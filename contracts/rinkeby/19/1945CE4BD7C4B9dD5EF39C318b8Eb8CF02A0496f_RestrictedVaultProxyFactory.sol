...
contract RestrictedVaultProxyFactory is RestrictedProxyFactory {
  ...
  function createProxyInstance (
    ...
    return address(new RestrictedVaultProxy(implementation, initdata));
  }
 ...
 * @dev TODO
 */
contract RestrictedVaultProxy is ERC1967Proxy {

  /**
   * @dev {RestrictedVaultProxy} contract constructor.
   * @param implementation {RestrictedToken} Implementation address.
   * @param initdata ABI encoded call data>
   */
  constructor (
    address implementation,
    bytes memory initdata
