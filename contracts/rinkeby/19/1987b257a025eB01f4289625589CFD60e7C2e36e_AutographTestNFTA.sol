    ...
    // AccessControlEnumerableUpgradeable
{
    ...
    /**
    * @dev sets the metadata _setTokenURI
    */
    ...
    /**
    * @dev gets the metadata tokenURI
    */
    function tokenURI
    (
        uint256 tokenId
    ...
    */
    ...
    {
        // uint256[] memory _tokensOfOwner;

        // IERC721Upgradeable token = IERC721Upgradeable(_token);
        // IERC721EnumerableUpgradeable etoken = IERC721EnumerableUpgradeable(_token);

        // uint256[] memory _tokensOfOwner = new uint256[](token.balanceOf(_owner));

        // for (uint256 i = 0; i < token.balanceOf(_owner); i++) {
        //     _tokensOfOwner[i] = etoken.tokenOfOwnerByIndex(_owner, i);
        // }

        // IERC721AUpgradeable token = IERC721AUpgradeable(_token);
        // uint256[] memory _tokensOfOwner = new uint256[](token.balanceOf(_owner));
