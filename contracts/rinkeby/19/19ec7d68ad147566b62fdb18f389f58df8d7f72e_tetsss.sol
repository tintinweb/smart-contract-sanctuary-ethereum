...
contract tetsss is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 5;
    

    uint256 public publicPrice = 0.005 ether;

    uint256 constant public PUBLIC_MINT_LIMIT_TXN = 1;
    uint256 constant public PUBLIC_MINT_LIMIT = 1;

    string private revealedURI = "ipfs://QmeuT4gPbu3xkz7FMrdEJUnuHTAw8FTFzFqUqn2VR3RV8t/";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string private CONTRACT_URI = "ipfs://8TQ8BGQR4K5R6WYRIT3R46X5R69URKSZ8D";
    ...
    address constant internal DEV_ADDRESS = 0xE597193154fA27DF53a1d88C4EdDBacfb69D110A;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("tetsss", "TESTE") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 1, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xE597193154fA27DF53a1d88C4EdDBacfb69D110A");
