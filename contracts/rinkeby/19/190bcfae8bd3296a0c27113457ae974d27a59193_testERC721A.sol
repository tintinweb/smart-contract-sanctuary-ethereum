...
contract testERC721A is ERC721A, Ownable, Pausable {
    ...
    constructor(string memory baseURI, string memory hiddenURI) ERC721A("test721a", "TST721a") {
        _contractBaseURI = hiddenURI;
    ...
    function reserveNFTs(uint256 quantity) external onlyOwner {
    ...
    function pause() public onlyOwner {
        _pause();
        //_contractBaseURI = _hiddenBaseURI;
        sale = false;
    }

    function unpause() public onlyOwner {
        _unpause();
        //_contractBaseURI = _originalBaseURI;
        sale = true;
    }
...
//needs to add originalBaseURI & if state for if revealed
    function updateBaseURI(string memory _updatedURI) public onlyOwner {
        _contractBaseURI = _updatedURI;
    }
    ...
    function unrevealed() public onlyOwner {
        revealed = false;
        _contractBaseURI = _hiddenBaseURI;
    }
