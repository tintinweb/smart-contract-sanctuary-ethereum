...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x28e58b76cf5Cd1d644fbCC0243231913a7FD3Ad9];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcTJTjLtp7BL5qkbNJQPrU5Thu4aujV4XwearMyfECeZn/";
...
// File: contracts/SkallzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SkallzContract is RamppERC721A {
    constructor() RamppERC721A("Skallz", "SKALLZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qVfbEax6cSA3U9n5ywqd/contract-metadata";
    }
}
