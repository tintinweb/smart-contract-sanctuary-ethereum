...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    constructor(
        ...
        uint256 mintFee
    ) VRFConsumerBaseV2(vrfCoordinatorAddress) ERC721("Random IPFS NFT", "RIN") {
    ...
    function getMinter(uint256 _requestId) public view returns (address) {
