...
contract MaidsMarketPlace is Ownable  {
  ...
  CryptoMaidsItem721 public Item721 = CryptoMaidsItem721(0x8341951350EF30Be5f9b468Aef6a3f57858A8691);
  ...
  function getTokenValue(address to) public view returns(uint256) {
    return Token.balanceOf(to);
  }
  function _mint(address to, uint256 id) public payable {
    Item721.mint(to,id);
  }
}
