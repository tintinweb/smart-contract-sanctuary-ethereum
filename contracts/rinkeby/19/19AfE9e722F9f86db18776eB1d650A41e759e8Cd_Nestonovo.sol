...
contract Nestonovo is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Nesto novo", "BICE") {
    setHiddenMetadataUri("ipfs://https://ipfs.io/ipfs/QmSiWEkDQmhg3GCqvXkfL5rkbxbiUpgKayxW2Kr6mEbK9g/hidden.json");
  }
