...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    event FarmGenerated(bytes32 indexed requestId, string plots_gend);
     ...
     */
    function setFarmAddress(address contractAddress) public onlyOwner {
        FarmAddress = contractAddress;
    }
    ...
    {
        emit FarmGenerated(_requestId, _plots);
        plots_gend = _plots;
    ...
    function testfulfill(bytes32 _requestId) public onlyOwner {
        address to = requests[_requestId];
        Farmer FarmContract = Farmer(FarmAddress);
        FarmContract.wrapLandtoFarmFul(to);
    }
