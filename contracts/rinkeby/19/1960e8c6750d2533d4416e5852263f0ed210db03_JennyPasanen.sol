...
// File: contracts/JenniPasanen_Test.sol
...
contract JennyPasanen is ERC721, ERC721Enumerable, Ownable {
    ...
    function setRoots(uint piece, bytes32 proof) external onlyOwner{
        merkleRoot[piece] = proof;
    }
    ...
    function safeMintPiece(
        ...
        //Verify Address MerkleProof
        //bytes32 node = keccak256(abi.encodePacked(msg.sender));
        //require(MerkleProof.verify(merkleProof, merkleRoot[piece], node), "Invalid Merkle-proof");
        ...
        //Verify Supply
        require(PC[piece] < 3, "This piece don't exist");
