...
contract test_CreatedByNFTGM is GMERC721A {
    ...
    address[]  _receivers  = [0xa59CbDD5ca38B1b9bA849947b856C981485dd8C3];
    uint256[] _basisPoints  = [100];
    ...
    constructor(
        ...
        unicode"test003",
        unicode"似懂非懂",
        "https://test-api.nftgm.art/api/v1/nftgm/metadata/rinkeby/62f4645f29b0443bb010a934/",
        10,
        0xa59CbDD5ca38B1b9bA849947b856C981485dd8C3,
        _preSaleInfo,
        _publicSaleInfo,
        _receivers,
        _basisPoints
