...
contract DogeRunners is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSD9CJUWR7McrDm3CzxHzLwFi94jkZtPQHrCBuWMkJn3r";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("DogeRunners", "DR", 100, MAX_SUPPLY) {
    }
