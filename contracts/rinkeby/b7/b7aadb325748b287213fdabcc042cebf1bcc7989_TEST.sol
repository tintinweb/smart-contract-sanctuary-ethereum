...
contract TEST is ERC721Enumerable, Ownable {
    ...
    //Dutch auction logic
    uint256 public startingPrice = 2000000000000000000; // 0.0002 eth testing only
    uint256 public decrease_interval = 300; // In seconds
    uint256 public decrease_per_interval = 10000000000000000; // 0.00001 eth
    uint256 public ending_price = 600000000000000000; // 0.00006 eth
    uint256 public starting_block;

    //Whitelist
    uint256 public whitelistPrice = 100000000000000000000; // 0.0001 eth
