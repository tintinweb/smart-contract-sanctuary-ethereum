...
contract BountyBestiesDogs is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 8; //  444 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 1;
    uint256 public constant ROYALTY_VALUE = 900; // 100 = 1%, 200 = 2% etc...  9% splited for this launchpad
    uint256 public constant MAX_EARLY_CLAIM = 1;
    uint256 public constant MAX_PUBLIC_CLAIM = 2;
    uint256 public constant NFT_PRICE = 0.05 ether; // 1.2 avax for this launchpad
    uint public startAt;
