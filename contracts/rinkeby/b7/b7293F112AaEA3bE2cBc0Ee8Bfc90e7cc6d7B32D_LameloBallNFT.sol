...
*/
    ...
    modifier discountActive() {
        require(setupTime, "notInitialised");
        require(
            block.timestamp >= discount_start && block.timestamp <= discount_end,
            "!D"
        );
        _;
    }
    ...
    function resetTime() public {
        ...
        discount_end=  discount_start + 1 hours;
        sale_start = discount_start + 1 hours;
        sale_end = discount_start+  2 hours;
        forge_start = discount_start+  2 hours;
        forge_end =  discount_start+  3 hours;
