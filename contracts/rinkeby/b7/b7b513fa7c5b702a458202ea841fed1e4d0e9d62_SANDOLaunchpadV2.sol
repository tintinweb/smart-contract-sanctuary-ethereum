    ...
    AccessControlUpgradeable
{
    ...
    function initialize(address _sandoAddress, address _usdcAddress)
        public
        initializer
    {
    ...
    function buy(uint256 _buyAmount) public nonReentrant whenNotPaused {
        ...
        uint256 _sandoAmount = (_buyAmount.mul(1 ether)).div(rate);
        ...
        usdcToken.safeTransferFrom(msg.sender, recipientWallet, _buyAmount);
        ...
        onlyRole(BROKER_ROLE)
    {
        ...
        uint256 rate = getSellType(currentSellType).tokenRate;
        uint256 _sandoAmount = (_fiatAmount.mul(1 ether)).div(rate);
