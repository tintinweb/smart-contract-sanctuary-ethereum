...
contract SHILLER_DRAGON is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("SHILLER DRAGON", "SD") {
        PRICE = price;
    ...
    function changeMaxSupply(uint newMaxSupply) external onlyOwner {
        require(newMaxSupply >= _currentIndex, "SHILLER_DRAGON: Invalid new max supply");
        require(newMaxSupply <= 10000, "SHILLER_DRAGON: Invalid new max supply");
        require(!MAX_SUPPLY_FROZEN, "SHILLER_DRAGON: You can't change max supply anymore");
