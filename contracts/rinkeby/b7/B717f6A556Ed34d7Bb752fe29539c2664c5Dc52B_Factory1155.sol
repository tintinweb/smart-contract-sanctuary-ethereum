...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new YouForgeNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        YouForgeNFTUser1155Token token = YouForgeNFTUser1155Token(address(addr));
...
contract YouForgeNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
