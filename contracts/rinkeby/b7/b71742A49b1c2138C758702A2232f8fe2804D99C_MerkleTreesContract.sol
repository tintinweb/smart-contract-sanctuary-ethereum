...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  */
  ...
  abstract contract Allowlist is Ownable {
    ...
    // File: contracts/merkleTreesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MerkleTreesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("MerkleTrees", "ROOT", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/AwnHECdtvX0Xtbf3hZY8/contract-metadata";
        }
    }