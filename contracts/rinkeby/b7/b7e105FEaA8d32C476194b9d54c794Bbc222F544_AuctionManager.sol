...
contract AuctionManager is IAuctionManager, AccessControl {
        ...
        returns (bool)
    {
        ...
        else if (bid < lowestWinningBid) return false;
     ...
     * @param bid TODO
     */
    function normalizeBid(uint104 bid) public view returns (uint104) {
        return (bid / bidConfig.sigFigs) * bidConfig.sigFigs;
    }

    /**
     * @notice TODO
     * @param _bidConfig TODO
     */
     ...
     * @param sender Account to increase the bid for
     */
        ...
        returns (uint104, uint104)
    {
        ...
        uint104 increase = normalizeBid(value);
        uint104 newBid = bids[id][sender] + increase;

        if (increase == 0 || newBid < auction.reservePrice) revert AuctionManager_InvalidBid();
