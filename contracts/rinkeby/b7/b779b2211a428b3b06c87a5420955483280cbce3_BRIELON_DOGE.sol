...
abstract contract MaxBuyDynamic is ERC20 {
    uint256 startMaxBuy;
    uint256 constant startMaxBuyPercentil = 3; // start max buy
    ...
    function startMaxBuyDynamic() internal {
        ...
        startMaxBuy = (_totalSupply * startMaxBuyPercentil) / 1000;
    }

    function checkMaxBuy(uint256 addingAmount) internal view {
...
abstract contract TradableErc20 is MaxBuyDynamic, DoubleSwapped, Ownable {
...
// File: contracts/BRIELON_DOGE.sol

pragma solidity ^0.8.7;



contract BRIELON_DOGE is TradableErc20, Withdrawable {
    constructor() TradableErc20("BRIELON DOGE", "BRIELON") {
    ...
    function getSupplyForMakeLiquidity() internal view override returns (uint256) {
        return _totalSupply;
    }
}