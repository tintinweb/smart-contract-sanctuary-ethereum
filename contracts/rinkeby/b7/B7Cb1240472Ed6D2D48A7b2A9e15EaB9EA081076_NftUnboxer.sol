...
contract NftUnboxer is NftBase, ReentrancyGuard {
    ...
    function mint(address to) public payable override onlyAllowList {
        require(false == true, "Mint disabled for unboxer, only unboxes are allowed");
    }
    ...
    function _isUnboxSuccessful() internal view virtual returns (bool) {
        return _randomPercentage() >= 50;
    }

    function _randomPercentage() internal view virtual returns (uint256) {
