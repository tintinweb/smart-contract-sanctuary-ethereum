        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                bytes(
                    "<svg viewBox='0,0,300,300' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg' version='1.1'><image width='300' href='https://ipfs.io/ipfs/QmUh1DAFsXk6nD7HUdMceZDtppmo6jADoSJeZVKdLC7Zh2'/><defs/><g id='Layer 1'><text x='0' y='0' text-anchor='middle' fill='#f6e29c' font-size='55' width='246.414' opacity='1' transform='matrix(1 0 0 1 111.384 132.403)'><tspan x='123.207' y='49' textLength='101.863'><![CDATA["
                ),
