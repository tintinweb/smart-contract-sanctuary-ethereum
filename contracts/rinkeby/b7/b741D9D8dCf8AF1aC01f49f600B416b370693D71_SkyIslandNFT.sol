...
contract SkyIslandNFT is ERC721Enumerable, Ownable, ReentrancyGuard, WhitelistChecker, IERC721Receiver {
    ...
    function ownerMint (address _owner, uint _tokenId) external onlyOwner {
        require (_tokenId <= 500,'!Allowed');
        _mint(_owner,_tokenId);
    }

    function mint(whitelisted memory whitelist) external nonReentrant payable isNotPaused {
        require (whitelist.tokenId <= 5000 && whitelist.tokenId > 500,'!Allowed');
