...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRK9KxMojALJojusFUfXLXsWezfVfuExChGuta6GFatnW/";
...
// File: contracts/KongzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KongzContract is RamppERC721A {
    constructor() RamppERC721A("Kongz", "Kongz"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/moP1zH3tezVkdBXTUDo1/contract-metadata";
    }
}
