...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x886E6910bf7A556E3Ad13FD38043e5da86005B67];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 6212 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://bape.com/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6212");
...
// File: contracts/ABathingApeSupremeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ABathingApeSupremeContract is RamppERC721A {
    constructor() RamppERC721A("A Bathing Ape SUPREME", "A Bathing"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/kdNMeXf5bSXz3JMFdgDw/contract-metadata";
    }
}
