...
contract InfectionNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    bool public isWhileListActive = false;
    ...
    function purchaseWhileList(uint256 index,address account, uint256 numberOfTokens, bytes32[] calldata merkleProof) external payable {
       ...
       // Verify the merkle proof.
        bytes32 node = keccak256(abi.encodePacked(index, account, numberOfTokens));
        ...
        require(_whileListClaimed[account] + numberOfTokens <= whileListMaxMint, "Purchase exceeds max whileed");
