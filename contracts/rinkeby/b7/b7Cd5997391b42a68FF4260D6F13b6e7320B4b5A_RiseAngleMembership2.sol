...
contract RiseAngleMembership2 is ERC721, ERC721Enumerable, Ownable {

    uint256 public MAX_RAMS = 10000;

    uint256 public PRE_SALE_PRICE = 0.07 ether;

    uint256 public PUBLIC_SALE_PRICE = 0.085 ether;
     ...
     */
    constructor(address _preBuyContract) ERC721("RiseAngle Membership v2", "RAMv2") {
        baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmaYMEVGUYWE1MesMj3QbY3cYFUERKtdKWd43vLeogpAKt/";
