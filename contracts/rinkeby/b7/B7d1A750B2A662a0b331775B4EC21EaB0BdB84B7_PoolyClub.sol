        ...
        abi.encodePacked(
          ...
          Base64.encode(
            bytes(
              string.concat(
                '{"name":', '"Club Pooly\'s",',
                '"description":"', "Pooly's is a special hangout for the OG Pooly supporters. Animation by Chuck Bergeron @chuckbergeron. 3d Pooly by @d_v_dsm. Original Pooly concept by @IrrelephantOops.",
                '", "attributes": [',
                '{"trait_type": "Rarity",',
                '"value": "', rarity,'"},',
                '{"trait_type": "Title",',
