  ...
  ERC1155HolderUpgradeable
{
  ...
  function onERC1155Received(address, address from, uint256 tokenId, uint256 amount, bytes memory) public virtual override(ERC1155HolderUpgradeable) returns (bytes4) {
    address tokenAddress = msg.sender;
