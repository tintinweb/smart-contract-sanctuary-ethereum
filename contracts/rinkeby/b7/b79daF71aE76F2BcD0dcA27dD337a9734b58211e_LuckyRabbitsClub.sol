...
//       |__|      |__|   \/   |__|     |__|
//
/// @title Lucky Rabbits Club https://www.luckyrabbitsclub.com/
/// @notice The Lucky Rabbits Club is a collection of 7,777 utility-enabled Lucky Rabbit NFTs designed to bring you good luck. Each unique digital collectible unlocks private club membership and access to adventure experiences, an IRL clubhouse in Fiji, and additional members-only benefits the longer you burrow, or hold, your NFT.
...
contract LuckyRabbitsClub is ERC721A, Ownable {
    ...
    /// @param _state the new state of the contract
