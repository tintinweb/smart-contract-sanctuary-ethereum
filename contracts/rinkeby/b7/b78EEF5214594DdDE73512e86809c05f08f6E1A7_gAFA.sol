...
contract gAFA is IgAFA, ERC20 {
    ...
    constructor(address _migrator, address _sAFA) ERC20('Governance AFA', 'gAFA', 18) {
     ...
     * @param _sAFA address
     */
    function migrate(address _staking, address _sAFA) external override onlyApproved {
        ...
        require(_sAFA != address(0), 'Zero address found');
        sAFA = IsAFA(_sAFA);
    }
    ...
    /**
     * @notice pull index from sAFA token
     */
    ...
    /**
        @notice converts gAFA amount to AFA
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts AFA amount to gAFA
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, 'gAFA::getPriorVotes: not yet determined');
