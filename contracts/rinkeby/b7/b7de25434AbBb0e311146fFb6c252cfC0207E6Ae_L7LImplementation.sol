...
import "./BaseNFT.sol";
import "../resolver/profile/ITextResolver.sol";
...
contract L7LImplementation is BaseNFT {
    ...
    function tokenURI(uint256 _id) public override(BaseNFT) view returns (string memory) {
        ...
        string memory _customAvatar = ITextResolver(_crs.resolver(_nodehash)).text(_nodehash, "L7L_IDENTITY_AVATAR");
...
abstract contract BaseNFT is ERC721, IBaseNFT {
    ...
    bytes4 constant public TOKEN_URI_SELECTOR = bytes4(keccak256("tokenURI(uint256,string)"));
