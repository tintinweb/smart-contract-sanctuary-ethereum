...
contract AutoDca is Ownable {
    ...
    {   
        canExec = need;
        execPayload = abi.encodeWithSelector(AutoDca.exec.selector, 0xd329365f5D1921B5cC04c91Ede020b92236B3264);
    }
    ...
    function exec(bytes calldata execPayload) external {
        ...
        swap(user, IUniswapV3Pool(0x7b2A5f8956fF62b26aC87F22165F75185e2aD639), 
        IERC20(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984), IERC20(0xc778417E063141139Fce010982780140Aa0cD5Ab), 100);
    }
