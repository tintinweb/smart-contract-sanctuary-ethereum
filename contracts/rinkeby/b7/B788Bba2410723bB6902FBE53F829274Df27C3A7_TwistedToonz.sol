...
contract TwistedToonz is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard {
  bool public          isMintActive;
  uint public          cost                    = 0.07 ether;
  uint public          totalAvailable          = 700;
  uint public          maxPerTx                = 3;
  uint public          maxPerAddressDuringMint = 9;
