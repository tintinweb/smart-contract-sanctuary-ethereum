...
contract TheBUNY is ERC721, Ownable {
  ...
  constructor(bytes32[] memory assetsForSale) ERC721("The BUNY Project", "BUNY") {
    setHiddenMetadataUri("https://buni.mypinata.cloud/ipfs/QmPif7uYfrKC9QhxPQmPbKzfZWAjpyAbBWQEGm8Y9cMzzT/");
  ...
  function withdraw() public onlyOwner {
    ...
    // Remaining balance to Buny Bank
    // =============================================================================
