...
contract UkrainianPostMark is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    constructor(uint96 _royaltyPercentageBasisPoints) ERC721("Ukrainian Post Mark", "UKRMARK") {
    ...
    function getNumMintedNyAddress(address _addr) public view returns (uint256) {
