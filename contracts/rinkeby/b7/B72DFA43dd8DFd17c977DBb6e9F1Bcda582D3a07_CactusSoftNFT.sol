...
contract CactusSoftNFT is ERC721, ERC721Enumerable {
    ...
    mapping(address => bool) private premiumMinters;
    ...
    function mint() public payable {
        ...
        if (presale) {
            require(premiumMinters[msg.sender], "Only available for premium minters during presale!");
        }
    ...
    function addPremiumMinter(address _minter) public onlyOwners {
        require(!premiumMinters[_minter], "This address is already a premium minter");
        premiumMinters[_minter] = true;
    }
