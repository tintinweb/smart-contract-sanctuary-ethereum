...
contract HAVEXTEST is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HAWEX GENESIS PASS", "HGP") {
    setHiddenMetadataUri("ipfs://QmWC3G73VqLEBFZg8VwCZ7gtZ5JaLZwkHdiGjgkeFPUzAA/1.json");
  }
