...
// File: web/node_modules/@openzeppelin/contracts/proxy/utils/Initializable.sol
...
// File: web/node_modules/@openzeppelin/contracts/proxy/Clones.sol
...
// File: web/solidity/nft-lottery-factory.sol
...
contract NFTLotteryFactory is INFTLotteryFactory, Initializable, Ownable {
    address private _owner;
    ...
    uint256 public fee = 100; // default 1%

    uint256 openLotteryReward = 0.0005 ether;

    event LotteryCreated(address creator, address pool);
    ...
    function createNFTLottery(
        ...
        LotteryInfo memory info;
        info.prizeAddress = prizeAddress;
        info.prizeId = prizeId;
        ...
        lottery.initialize(this, operator, fee, info);
        lottery.transferOwnership(msg.sender);
        IERC721(prizeAddress).safeTransferFrom(
            msg.sender,
            address(lottery),
            prizeId
        );
    ...
    function setFee(uint256 f) external onlyOperator {
