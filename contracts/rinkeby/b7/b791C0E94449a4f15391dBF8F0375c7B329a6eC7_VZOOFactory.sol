...
/// @author VZOO
/// Factory contract for ERC721 non-fungible token.
contract VZOOFactory is FactoryERC721, Ownable {
    ...
    string public baseURI =
        "https://bafybeibwzbe7qyqtkqdiafaz4k56gubsxw4unbf5fpnyxmhqm77fig7dsu.ipfs.nftstorage.link/contract-metadata/";
    ...
    constructor() {
        ...
        nftAddress = 0xf7fb8C26279058d623CFf2B64D28F90bb0c4d07F;
    ...
    function reclaimCollectionOwnership() public onlyOwner {
    ...
    /// @dev External function to set a new proxy registry address (just in case).
    ...
    function canMintAndOwn(address _toAddress) public view returns (bool) {
        ...
        if (_toAddress == owner()) {
            require(
                mintedBalance + 1 <= vzoo.mintPerAddressLimitTeam(),
        ...
        require(
            mintedBalance + 1 <= vzoo.mintPerAddressLimit(),
            "mint limit for address exceeded"
        );
        require(
            addressBalance + 1 <= vzoo.amountPerAddressLimit(),
    ...
    function vzooMaxSupply() public view returns (uint256) {
        VZOO vzoo = VZOO(nftAddress);
...
///     - *can transfer its ownership back to the factory contract owner
    ...
    Ownable
{
    ...
    function mintTo(address _to) public whenNotPaused onlyOwner {
        ...
        require(currentTokenId <= MAX_SUPPLY, "total supply limit reached");
    ...
    function transferOwnershipToFactoryOwner(address factoryAddress, address factoryOwner)
        public
        onlyOwner
    {
