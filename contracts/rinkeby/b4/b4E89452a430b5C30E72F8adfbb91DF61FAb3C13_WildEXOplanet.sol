...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierStartMintTimes = [1643731114, 1643732014];
    //Minting ending time in unix-epoch [phase 1 start, phase 2 start]
    uint256[] public tierMintEndTimes = [1643731414, 1643732314];
    //Minting tier fee
    ...
    uint256 public whitelistSaleDisableTime = 1643730814;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1643731714, 1643732614];
