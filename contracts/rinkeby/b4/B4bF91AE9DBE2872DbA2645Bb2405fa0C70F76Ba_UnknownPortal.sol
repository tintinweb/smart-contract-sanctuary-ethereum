...
* @author topcook
*/
contract UnknownPortal is AbstractERC1155Factory {

    uint256 constant MAX_SUPPLY = 10111;
    uint256 constant MAX_CLAIMABLE_AMOUNT = 1;
...
abstract contract AbstractERC1155Factory is Pausable, ERC1155Supply, ERC1155Burnable, Ownable {
    ...
    function getBaseURI() public view returns (string memory) {
        return string(abi.encodePacked(super.uri(0)));
    }   
