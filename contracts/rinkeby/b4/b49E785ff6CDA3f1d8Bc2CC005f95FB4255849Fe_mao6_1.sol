...
*    / / / / ____/ __ \/ __ \/ ____/ ___/                        
*   / /_/ / __/ / /_/ / / / / __/  \__ \    Pixel Heroes         
*  / __  / /___/ _, _/ /_/ / /___ ___/ /    Crypto Ninja         
...
contract mao6_1 is ERC721A, Ownable, ReentrancyGuard {

    uint256 public numberOfToken;
    uint256 public mintPrice = 0.0001 ether;
    uint256 private maxMints = 4;
    uint256 private maxPreMintsByWallet = 2;
    uint256 private maxPublicMintsByWallet = 4;
    uint256 private _totalSupply = 20;
    ...
    constructor () ERC721A ("mao6_1","mao", maxMints, _totalSupply) {
        numberOfToken = 0;
        setBaseURI("ipfs://QmdQDBoS1gmRYGcgwPRKuirekM5T16zUiTKUiDBv1Sz2Fv/");
    }
    ...
    function mint(uint256 _amount) public payable nonReentrant {
        require(pause, "Mint: Paused");
        require(maxMints >= _amount, "publicMint: 10 maxper tx");
        if(preSaleEnabled)
          require(maxPreMintsByWallet >= preSaleMinted[msg.sender] + _amount, "You have no preMint left");
        else
          require(maxPublicMintsByWallet >= publicSaleMinted[msg.sender] + _amount, "You have no publicMint left");
    ...
    function setMaxPreMintsByWallet(uint newMaxPreMintsByWallet) public onlyOwner {
        maxPreMintsByWallet = newMaxPreMintsByWallet;
    }

    function setMaxPublicMintsByWallet(uint newMaxPublicMintsByWallet) public onlyOwner {
        maxPublicMintsByWallet = newMaxPublicMintsByWallet;
    }

    function setPreSaleEnabled(bool bool_) external onlyOwner {
        preSaleEnabled = bool_;
    }

    function setPause(bool bool_) external onlyOwner {
        pause = bool_;
    }
