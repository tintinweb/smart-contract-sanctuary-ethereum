...
contract Myraid1155 is Initializable,BEP1155Upgradeable, OwnableUpgradeable, BEP1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        BEP1155Upgradeable.__BEP1155_init("", "MyRaid", "MyRaid");
        __Ownable_init();
        _tid = 1;
    ...
    function mint(uint256 value, uint256 royal, uint256 nooftoken, string memory ipfsmetadata) public {
        _tid = _tid.add(1);
    ...
    function mlmReward(address from, uint256 tokenId, uint256 nooftoken) public{
        _setApprovalForAll(from, msg.sender,true);
        saleTokenTransfer(from, tokenId, nooftoken);
    }
}