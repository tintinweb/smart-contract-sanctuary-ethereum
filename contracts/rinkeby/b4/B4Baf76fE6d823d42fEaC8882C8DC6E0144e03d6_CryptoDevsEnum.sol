...
contract CryptoDevsEnum is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    constructor(string memory _baseTokenURI, address whitelistContractAddress)
    ...
    function presaleMint() external payable onlyWhenNotPaused {
        require(
            presaleStarted && block.timestamp < presaleEndDate,
        ...
        require(tokenCount < maxTokenCount);
        require(msg.value == mintPrice, "Mint price is 0.01 ETH");
        tokenCount += 1;
