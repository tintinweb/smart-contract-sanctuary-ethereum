...
contract YK is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable maxWhitelistPerAmount = 3;
    uint256 public immutable maxPublicPerAmount = 3;
    uint256 public constant whitelistSalePrice = 0.0001 ether;
    uint256 public constant publicSalePrice = 0.00012 ether;
    ...
    // set time
    uint256 public immutable goldenTicketStartTime = 1544401400;
    uint256 public immutable goldenTicketEndTime = 1744401700;
    uint256 public immutable whitelistStartTime = 1544401400;
    uint256 public immutable whitelistEndTime = 1744401700;
    uint256 public immutable publicSaleStartTime = 1661082900;
    uint256 public immutable publicSaleEndTime = 1761083200;
    ...
    //[email protected]: init same as public sale start time
    uint256 public lastPublicSoldTime = 1661082900;

    constructor() ERC721A("YK", "YK") {}
    ...
    modifier canGoldenTicketMint(uint256 numberOfTokens) {
        ...
        require(
            ...
            "Purchase would exceed max golden ticket tokens"
        );
        _;
    }
    ...
    function getMaxSupply() public view virtual returns (uint256) {
        if (block.timestamp < publicSaleStartTime) {
            ...
            return MAX_SUPPLY - ((interval / 300) * 5);
        } else {
