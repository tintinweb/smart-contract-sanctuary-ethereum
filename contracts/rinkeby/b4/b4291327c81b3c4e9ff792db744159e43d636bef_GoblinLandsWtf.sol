...
contract GoblinLandsWtf is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmbn2UEQMzwvkvWGVGyGHDr8E6v7crLmiWje14fQuAox8y/";
    ...
    constructor(
    ) ERC721A("GoblinLandsWtf", "GoblinLandsWtf", 100, maxSupply) {
    }
