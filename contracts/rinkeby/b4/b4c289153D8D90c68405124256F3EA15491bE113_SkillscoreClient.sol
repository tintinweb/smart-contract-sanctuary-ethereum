...
contract SkillscoreClient is ChainlinkClient, Ownable {
    ...
    /// @param _assetId uint256 asset id which external adapter will use to retrieve ipfs data
    ...
    /// @param _assetId uint256 asset i
    /// @param _skillScore skillscore obtained by running external adapter against a particular asset
    ...
    function fulfillupdateSkillScore(
        ...
        assets.updateSkillScore(_assetId, _skillScore, _reportCID);
    }
}
