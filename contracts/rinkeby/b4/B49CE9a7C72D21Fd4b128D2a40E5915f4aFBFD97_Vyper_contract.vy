...
# @notice ERC-721 for PAC DAO Mock Congress project
...
contract_uri: public(String[128])
...
@external
def tokenOfOwnerByIndex(addr: address, val: uint256) -> uint256:
    return 0
