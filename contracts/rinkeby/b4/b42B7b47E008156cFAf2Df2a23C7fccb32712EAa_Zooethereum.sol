...
import "./meta-transactions/ERC721Tradable.sol";
...
contract Zooethereum is INFT, ERC721Tradable {
    ...
    mapping(string => uint256) public tokenTypeAmount;
    mapping(string => uint256) public tokenTypeMinted;
    mapping(string => uint256) public tokenTypePrice;
    ...
    function updateOperator(address _operatorAddress, bool _status)
        public
        onlyOwner
    {
    ...
    function mint(address _to, uint256 _tokenId) public override {
        require(
            _tokenId > 0 && _tokenId <= lastTokenId,
