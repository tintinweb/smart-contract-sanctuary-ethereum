...
contract wantd is ERC1155Supply, Ownable  {
    bool public saleIsActive = false;
    uint constant TOKEN_ID = 769;
    uint constant NUM_RESERVED_TOKENS = 10;
    uint constant MAX_TOKENS_PER_PURCHASE = 1;
    uint constant MAX_TOKENS = 110;
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(totalSupply(MAX_TOKENS) + numberOfTokens <= MAX_TOKENS, "Purchase would exceed max supply of tokens");
