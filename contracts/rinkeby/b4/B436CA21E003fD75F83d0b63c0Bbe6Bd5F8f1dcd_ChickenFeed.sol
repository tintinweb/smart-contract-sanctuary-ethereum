...
// CONSTRUCTOR
        ...
        )
    {
        ...
        superdrawContract = ISuperdraw(_superdrawContract);           // Superdraw Contract
...
// EVENTS
    ...
    event TicketsChanged(uint256 newNumberOfTickets);
...
// MODIFIERS
    ...
    modifier afterTarget() override {
        ...
        require(block.number > draw.target, "The draw deadline was not reached yet");
        _;
    }
    ...
    modifier withinTarget() override {
        Draw memory draw = draws[getCurrentDraw()];  // Shortcut accessor for the Draw
        require(block.number <= draw.target, "This draw has reached its deadline");
        _;
    }
    ...
    modifier drawComplete(uint256 drawIndex) override {
        ...
        require(block.number > draw.target,      "This draw is still open");
...
// PUBLIC FUNCTIONS
        ...
        withinTarget
    {
        ...
        emit TicketsAdded(priceToPay, numTickets);                                                  // Write an event to the chain
        if ( superDraw > 0 ) {
...
// ADMIN FUNCTIONS
        ...
        onlyOwner
    {
        if ( numTickets != 0 && 
            ...
            emit TicketsChanged(numTickets);
        }
    }
    ...
    function setSuperDrawContract(address superdrawContractAddress)
        ...
        onlyOwner
    {
        superdrawContract = ISuperdraw(superdrawContractAddress);            // Superdraw contract
        emit ContractAddressChanged("Superdraw Contract", superdrawContractAddress);
    }
        ...
        onlyOwner
    {
        ...
        emit PayoutStructureChanged(0, 0, 0, 0, superDraw);
    }
