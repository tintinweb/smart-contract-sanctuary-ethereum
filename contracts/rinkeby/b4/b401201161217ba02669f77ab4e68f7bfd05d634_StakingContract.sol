...
contract StakingContract {
    ...
    constructor(address _genToken, address _arenaToken, address _busdToken) {
        ...
        areenaBosterPrice = 200*1e18;      //200 usd
    }
    ...
    function JoinBattle(uint256 _amount, uint256 _battleId, address joinerReferalPerson) public {
        ...
        console.log("creatorAfterDeductedAmount: ", creatorAfterDeductedAmount);
        console.log("creatorDeductedAmount: ", creatorDeductedAmount);
        ...
        console.log("joinerDeductedAmount: ", joinerDeductedAmount);
        console.log("joinerAfterDeductedAmount: ", joinerAfterDeductedAmount);
        ...
        console.log("creator count: ",players[battle.creator].battleCount);
        console.log("joiner count: ",players[battle.joiner].battleCount);
        ...
        console.log("creator new count: ", stakeCount[battleId][battle.creator]);
        console.log("joiner new count: ", stakeCount[battleId][battle.joiner]);
        ...
        if(joinerReferalPerson != 0x0000000000000000000000000000000000000000){
           ...
           referalPerson[_battleId].joinerReferalAddress = joinerReferalPerson;
            ...
            console.log("sendJoinerDeductionAmount: ", sendJoinerDeductionAmount);
        ...
        if(referalPerson[_battleId].creatorRefered){
            ...
            console.log("creatorReferalAmount: ", creatorReferalAmount);
            ...
            console.log("sendCreatorDeductionAmount: ", sendCreatorDeductionAmount);
        ...
        console.log("creator]].amount: ", players[battle.creator].battleRecord[stakeCount[battleId][battle.creator]].amount);
        console.log("joiner]].amount: ", players[battle.joiner].battleRecord[ stakeCount[battleId][battle.joiner]].amount);        
    ...
    function LeaveBattle(uint256 count) public {
       ...
       Battle storage battle = battles[count];
        ...
        if(!battle.joined){
            ...
            console.log("Loser Token Amount: ", losertokenAmount);
            console.log("winner token Amount: ", winnertokenAmount);
            console.log("totalMinutes: ", totalMinutes);
            console.log("loserGenReward: ", loserGenReward);
            console.log("winnerGenReward: ", winnerGenReward);
            console.log("riskDeductionFromLoser: ", riskDeductionFromLoser);
            console.log("loserFinalGenReward: ", losertokenAmount);
            console.log("winnerAreenaReward: ", losertokenAmount);
            console.log("sendWinnerGenReward: ", losertokenAmount);
            console.log("sendLoserGenReward: ", losertokenAmount);
            ...
            console.log("winnerBattle count: ",players[battle.winner].battleCount);
            console.log("loserBattle count: ",players[battle.loser].battleCount);

            console.log("winnerBattle new count: ", stakeCount[battleId][battle.winner]);
            console.log("loserBattle new count: ", stakeCount[battleId][battle.loser]);
    ...
    function sell(uint256 amount) external {
        ...
        if(busdToken.balanceOf(busdWallet) > lowerMileStone && busdToken.balanceOf(busdWallet) <= uppermileStone){
                ...
                uint256 sendAmount = setAreenaBosterPrice();
    ...
    function setAreenaBosterPrice() public view returns(uint256){
        ...
        uint256 ABV = busdToken.balanceOf(busdWallet);
    ...
    function getAreenaPrice() external view returns(uint256 price){
