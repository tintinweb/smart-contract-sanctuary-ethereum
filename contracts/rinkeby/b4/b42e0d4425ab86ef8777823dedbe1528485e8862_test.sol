...
contract test is ERC721A, Ownable {
    ...
    uint256 public MINT_PRICE_M1 = 0.0001 ether; // 0.05
    uint256 public MINT_PRICE_M2 = 0.0005 ether; // 0.1
    uint256 public MINT_PRICE_M3 = 0.001 ether; // 0.2
    ...
    mapping(address => uint) MintCountPerAddress; // Whitelist max mint 6
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0);
        _withdraw(
            0xF65D08B58F86c81Cb2af70E13655D91010F0c88f,
