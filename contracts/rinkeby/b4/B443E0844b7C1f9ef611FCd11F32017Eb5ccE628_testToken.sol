...
contract testToken is ERC20PresetMinterPauser {
    constructor() ERC20PresetMinterPauser("EDtoken", "EDtoken") {}

    address public stakingAddress;

    function setStakingAddress(address _newAddress) public {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "ERC20PresetMinterPauser: must have pauser role to change address"
        );
