...
contract AscendtoResurrection is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmeyghUexPb1WQe3jd3p3SJXq2JjMuB7LA9nUuChBPDueZ/";
    ...
    constructor() ERC721A("Ascend to Resurrection", "ATR"){}
    ...
    function Ascend(address mintAddress, uint256 count) public onlyOwner {
