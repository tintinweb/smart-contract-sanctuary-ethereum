...
error NftMarketplace__PriceNotMet(
    ...
    uint256 tokenId,
    uint256 price,
    uint256 priceSubmitted
);
error NftMarketplace__NoFundsToWithdraw(address withdrawer, uint256 withdrawerEarnings);
...
contract NftMarketplace is ReentrancyGuard {
    ...
    // Seller Address => Marketplace Earnings
     ...
     * @ dev - We could have the contract hold the NFT, but we've chosen to allow approval
     *   rights on the contract address to afford the NFT holder continued possession of the
     *   token.
     */
        ...
        isListed(nftAddress, tokenId)
    {
        ...
        emit ItemPurchased(msg.sender, nftAddress, tokenId, listedItem.price);
    }
    ...
    function withdrawEarnings() external {
        ...
        if (earnings <= 0) {
            revert NftMarketplace__NoFundsToWithdraw(msg.sender, s_earnings[msg.sender]);
        }
...
//     2. `buyItem`: Buy NFTs listed ✔️
//     3. `cancelItem`: Cancel a listing ✔️
//     4. `updateListing`: Update Price ✔️
//     5. `withdrawProceeds`: Withdraw payments for NFTs ✔️
