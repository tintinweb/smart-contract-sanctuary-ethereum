...
//EE main wallet 
        payable(0x938cABbe7B6d1f5E4074f6d9f2CD87a5cFb1C1C5).transfer(_balance * 50 / 100);
//EE test wallet
        payable(0x0B024A5B095A85a641403cb0a19fCf23f4fDC139).transfer(_balance * 50 / 100);
