...
*/
contract AltavaNFTStakingUSDT is Ownable, Pausable {
    ...
    function Claim(uint256[] calldata _tokenIdArr) external whenNotPaused {
    ...
    function RetrieveToken() external onlyOwner returns (uint256){
        //TavaApprove();
    ...
    function ERC20TokenBalance() view public returns (uint256){
