...
contract TomorrowsWorldNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint16 public constant presaleSupply = 200;
    ...
    address public BenAddress = payable(0xa433979ac533fbBB8CDD718071fFB536540abC47);
    address public OmarAddress = payable(0x272be07205777975e7AE4a916e13c34ba62617Bd);
	...
	function sendFunds(uint256 _totalMsgValue) public payable {
		(bool s1,) = payable(BenAddress).call{value: (_totalMsgValue * 20) / 100}("");
		(bool s2,) = payable(OmarAddress).call{value: (_totalMsgValue * 20) / 100}("");
