...
abstract contract MintableV2 is Initializable, ERC721Upgradeable, OwnableUpgradeable, ConfigV2 {
    enum Sale {
        Closed,
        PreSale,
        Public
...
abstract contract ConfigV2 {
    uint256 public constant MAX_SUPPLY = 451;
