...
contract AnonRobinPasses is ERC1155Supply, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	bytes32 public root = 0x489bb5d081950fffe9ad35c8434371031a8428872ec49b7447b787c0a39263a6;

	string public _baseURI = "ipfs://QmZs3Bdfsi1Kw8VFy3AWZWqYjSpBKtRWvpZK3A8XqXVSah/";
	string public _contractURI = "ipfs://QmRkLjCgzgX6oLV4hDueeemCYxJn61xQ3CQzVStSYATj7x";

	uint256 public presaleStartTime = block.timestamp - 1; //1648303200 Saturday, March 26, 2022 2:00:00 PM
	uint256 public publicStartTime = block.timestamp - 1; //1648396800 Sunday, March 27, 2022 4:00:00 PM
	...
	constructor() ERC1155(_baseURI) PaymentSplitter(addressList, shareList) {
		maxSuppliesPresale[1] = 500; //TODO: UPDATE ME !
		maxSupplies[1] = 1035;
