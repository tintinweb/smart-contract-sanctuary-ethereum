...
contract PFE is ERC721A, Ownable {
    ...
    uint256 constant public TOKEN_PRICE = 0.01 ether;
    uint256 constant public TOKEN_MAX_SUPPLY = 6969;

    // Protection
    mapping (address => uint256) amountMinted;
    uint256 public mintLimit = 6969;

    constructor () ERC721A("PFE Test", "PFE") {
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= 69, "Max quantity is 69.");
    ...
    function airdrop(address account, uint256 quantity) external onlyOwner {
        ...
        require(quantity > 0, "Quantity should be more than zero.");
        require(quantity <= 100, "Max quantity is 5.");
        // Check total supply
