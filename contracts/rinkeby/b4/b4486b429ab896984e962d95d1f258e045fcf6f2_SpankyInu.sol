...
contract ERC20 is IERC20 {
    ...
    mapping(address => bool) public Excludecheck; 
     mapping(address => bool) public checkBlacklist;  
    ...
    */
    function _transfer(address from, address to, uint256 value) internal {
        ...
        require(!checkBlacklist[from],"From Address is Blocklisted");
        require(!checkBlacklist[to],"To Address is Blocklisted");
