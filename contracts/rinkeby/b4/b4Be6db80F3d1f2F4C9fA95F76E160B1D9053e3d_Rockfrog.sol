...
contract Rockfrog is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("rockfrog", "ROCKFROG", 5, 185) {}
    ...
    function getAllowListPrice(uint256 offset) public view returns(uint256){
        if (60 < 20 + amountForAllowList - offset){
            return 0.000000 ether;
        }
        return 0.010000 ether;
    }
    ...
    uint256 public amountForAllowList = 60;
    ...
    uint256 public publicPrice = 0.020000 ether;
    uint256 public amountForPublicSale = 100;
