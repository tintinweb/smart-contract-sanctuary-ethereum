...
contract HappyKoalas is ERC721Enumerable, Ownable {
    ...
    address public              founderPayoutAddress = 0x3A30bb9313604d67907C5C4236Abb8ebeC9eAf65; // rinkeby founder
    address public              developerPayoutAddress = 0xD1BeE08560C1bB023353245623b45303305DFD3B; //reminder: FF7
    address public              adminPayoutAddress = 0x039F90BcFf62C225264a53Cf97b039A1470600C8; // rinkeby FF8

    // TODO : change for launch
    bytes32 public              whitelistMerkleRoot = 0xc1754699bada7bf8a2a2f9df7ac758447a3e4d2db470e3ab9bb2d0c5b09aa739;
    ...
    function allocateHonoraryAndReserves() external onlyOwner {
        ...
        for(uint256 i; i < 54; i++) {
            _mint(0xc03f5D2725f1bB7bD599B9FFbA5a16f4A41b459B, i);
        } 
    }
    ...
    function whitelistMint(uint8 count, bytes32[] calldata _merkleProof) external payable {
        ...
        addressMintAmount[_msgSender()] = addressMintAmount[_msgSender()] + count; // count the total they have minted
    ...
    function withdraw() public onlyOwner {
        ...
        payable(founderPayoutAddress).transfer(amount1);
        payable(developerPayoutAddress).transfer(amount2);
        payable(adminPayoutAddress).transfer(amount3);
    }
