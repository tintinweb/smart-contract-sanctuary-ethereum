...
contract LOWGAS is ERC721A, Owneable {
    ...
    uint256 public constant Max_p_tx_FREE = 15;
    uint256 public constant FREE_MAX_SUPPLY = 25;
    ...
    constructor() ERC721A("LOW TEST 111", "LT1") {}
    ...
    function mint(uint256 _amount) external payable {
      ...
      if(FREE_MAX_SUPPLY >= totalSupply()){
            require(Max_p_tx_FREE >= _amount , "Excess max per free tx");
        }else{
            require(MAX_PER_TX >= _amount , "Excess max per paid tx");
