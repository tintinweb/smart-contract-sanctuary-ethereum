...
contract GUSHIES is ERC721, ERC721Royalty, ERC721Burnable, Pausable, Ownable {
    ...
    function startPreSale(uint256 _unitPrice, bool _toggle) external onlyOwner
    {
    ...
    function presaleMint(uint256 numTokens, bytes32[] calldata proof) external payable
    {
        ...
        require(!whiteListOn || _verify(_leaf(msg.sender), _presaleRoot, proof), "Invalid address for presale mint");
