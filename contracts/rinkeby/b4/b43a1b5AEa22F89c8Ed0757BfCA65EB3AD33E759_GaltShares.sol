...
contract GaltShares is ERC1155, Ownable, ERC1155Supply {
    constructor() ERC1155("https://nft.aqp.io/galt_shares/") {}

    /// @dev not required by ERC-1155 standard, but for OpenSea to display
    function name() public pure returns (string memory) {
        return "GALT Stock Certificate";
    }
    ...
    ///         e.g, https://nft.aqp.io/galt_shares/ instead of
    ///         https://nft.aqp.io/galt_shares/{id}.json
