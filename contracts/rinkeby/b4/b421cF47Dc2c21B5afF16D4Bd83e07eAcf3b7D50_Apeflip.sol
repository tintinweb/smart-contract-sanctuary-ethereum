...
contract Apeflip is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("Ape Flip", "AF") {}
    ...
    payable
  {
    ...
    for(uint256 ind = 0; ind < nMints; ind++) {
  ...
  function withdrawAll() external onlyOwner {
    ...
    function _beforeTokenTransfer(address from, address to, uint tokenId) internal virtual override(ERC721, ERC721Enumerable) {
        // require(from == address(0) || to == address(0), "NFT: soft cap not reached");
