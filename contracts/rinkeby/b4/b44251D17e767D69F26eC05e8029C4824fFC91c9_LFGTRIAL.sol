...
contract LFGTRIAL is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LFG TRIAL", "LFG ONE") {
    setHiddenMetadataUri("ipfs://QmdfMWB7RY7iaAKTB57AKVeParBJm24rRofh8HHYPoLSq8/hidden.json");
  }
