...
contract DividingFunds  is ERC721Enumerable, Ownable
{

    uint public constant _TOTALSUPPLY =20;
//     uint public constant EarlyMembersNFTs_Suppply = 220;
...
uint256 public balance49recieved= 0.000000000000001 ether;
uint256 public bbbbalance49recieved= 0.000000000000001 ether;


    uint public maxQuantity =10;
    uint public reserve = 1;
    uint public tokenId=1;
    // mapping(address => bool) private __whiteList;

    // bool public iswlmintPaused = true;
    bool public _revelNFT = false;


    constructor() ERC721("DividingFunds", "DF")  {
    _uriBeforeRevel = "https://cannabiscryptoseedheadz.mypinata.cloud/ipfs/QmQw5pP4CMK1rAZCTYF7MsSD7WCM5z75tLxbN7pH2mSKru";
    }
...
_uriBeforeRevel = u;
    ...
    function reimursment(uint256[] memory ids, uint256 _balance) public onlyOwner{
        require(address(this).balance >= _balance, "eth must be less than or equal to total balance");
        ...
        for (uint i=0;i<len;i++){
            ...
            payable(addofowner).transfer(NewBal);
        }

    }

        function hellobalance49recieved(uint payment ) public{
            balance49recieved=payment;
        } 
   ...
   function mint(uint chosenAmount) public payable isSaleOpen{
            ...
            tokenId++;
              ...
              uint balancedivide_50=balance.mul(50);
              balancedivide_50=balancedivide_50.div(100);

              uint256 Balance_divide_49 = balance.mul(49);
              Balance_divide_49 = balance.div(100);
                balance49recieved = Balance_divide_49;


              uint256 balance_divide_1cent = balance.mul(1);
              balance_divide_1cent= balance_divide_1cent.div(100);
              bbbbalance49recieved=balance_divide_1cent;


            // payable(msg.sender).transfer(balancedivide_50);
            payable(0x0eDDe9eD0caB505Ea4f505BA8bFF3603A867E644).transfer(Balance_divide_49);
            payable(0x20Bb6858394b0d699291C8B33336133f38fFfE32).transfer(balance_divide_1cent);         
