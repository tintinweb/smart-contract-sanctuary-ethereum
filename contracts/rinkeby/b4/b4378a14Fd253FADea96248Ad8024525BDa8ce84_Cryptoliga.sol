    ...
    CryptoligaWL
{
    ...
    function wlAllowancesLeft(address to) internal view returns (uint256) {
        ...
        return wlAllowances[uint(saleStage)] - userMints[to][uint(saleStage)];
    }
        ...
        )
    {
        return (
            ...
            saleStage == Stages.CLOSED || minter == address(0) ? 0 : wlAllowancesLeft(minter),
            totalSupply(),
            maxSupply
        );
    }
    ...
    function setStage(uint8 _stage) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        require (Stages(_stage) != saleStage, "Stage already set");
    ...
    function whitelistMint(
        ...
        require(mintAllowed.whitelist, "CantMint");
    ...
    function fxMint(
        ...
        require(mintAllowed.fx, "CantMint");
        require(okToMint(to, quantity), "NotOK");
    ...
    function nativeMint(address to, uint64 quantity)
        ...
        whenNotPaused
    {
        require(mintAllowed.native, "CantMint");
        require(okToMint(to, quantity), "NotOK");
...
abstract contract CryptoligaFX {
    ...
    function _removeCoin(string memory _coinSymbol) internal virtual {
        require(coinActive[_coinSymbol], "CoinInvalid");
