...
contract TheKingNFT is ERC721A, Delegated , ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs://QmesAF1YFvFwtA6TPQqW6RZWYkBtMRHQchY5ovvScBc1TU/';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri = "ipfs://QmUZ1mFcdNrV85frrZpXaTvhLEgQ4fxTzPr4qycWMLoaAg";
  uint256 public cost = .1 ether;
  uint256 public maxSupply = 1419;
  ...
  address public cardAddress= 0xdAb1a1854214684acE522439684a145E62505233;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    _safeMint(_msgSender(), _mintAmount);
       emit nftMinted(_msgSender(), _mintAmount);
