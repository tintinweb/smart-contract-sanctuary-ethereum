...
contract SharkSociety is ERC721, ERC721Enumerable, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0xCf169621846586E5807950A2F598eD75Abd5A488).transfer(balance.mul(500).div(1000));
        payable(0x6Df602103d7c8c0095bfAE6FC53dDF0ad96d5EfF).transfer(balance.mul(500).div(1000));
    }
