...
// File contracts/RaribleV1Royalties.sol
...
contract PILLHEADS is ERC721Burnable, ERC721Pausable, RaribleV1Royalties, ERC2981, AccessControl {
  ...
  uint256 public presale1ActivationTime = 1648742400;
  uint256 public presale2ActivationTime = 1648742401;
  uint256 public saleActivationTime = 1648742402;
  ...
  function setPresale1MerkleRoot(bytes32 newRoot) external onlyOwner {
    presale1Root = newRoot;
  }

  function setPresale2MerkleRoot(bytes32 newRoot) external onlyOwner {
  ...
  function royaltyInfo(uint256, uint256 _value, bytes calldata _data) external view override returns (address _receiver, uint256 _royaltyAmount, bytes memory _royaltyPaymentData) {
    return (paymentSplitter, _value / 10, _data); // 10%
  }
