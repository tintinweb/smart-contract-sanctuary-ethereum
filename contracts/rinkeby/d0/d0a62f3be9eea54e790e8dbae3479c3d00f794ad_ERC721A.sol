...
contract tst is ERC721A, Ownable {
    ...
    uint256 public price = 0.003 * 10**18;
    string public baseURI =
        "ipfs://bafybeic6eg47fyaihg6fk6kgaigdtkqjowdvubk6lw2zmpukhn45smdnyq/";

    constructor() ERC721A("ts", "tst") {}
    ...
    function mint(uint256 amount) external payable {
        require(onSale, "hold on, pharoah");
        require(amount <= MaxMintPerTx, "too many pharoahs for a signle txn");
        require(totalSupply() + amount <= maxSupply, "no more pharoahs");
