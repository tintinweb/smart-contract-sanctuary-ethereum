...
import "../ERC721/IERC721Partial.sol";
import "../ERC721/IERC721Metadata.sol";

contract MagicMirror is ERC165, IERC1155Receiver, IERC721Partial, IERC721Metadata, Ownable {
    ...
    modifier requireMinted(uint256 tokenId) {
        require(_ownerOf[tokenId] != address(0), "MagicMirror#requireMinted: TOKEN_DOES_NOT_EXIST");
        _;
    }
     ...
     * *** EXTERNAL ***
     *
     * @notice Ownership of this token, if minted, is bound to the ownership of `token`.
     *
     * @param tokenId | the token id
     *
     * @return address | the owner's address
     */
    function ownerOf(uint256 tokenId) external view override requireMinted(tokenId) returns (address) {
     ...
     *
     * @param tokenId | the token ids to mint
     *
     * Requirements:
     *
     * - must own EightBit token with `tokenId`
    ...
    function onERC1155Received(
        ...
        require(from == keyTokenAddress, "MagicMirror#onERC1155Received: ONLY_LOOT");
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC165, IERC165) returns (bool) {
        return
            interfaceId == type(IERC721Partial).interfaceId ||
            interfaceId == type(IERC721Metadata).interfaceId ||
            super.supportsInterface(interfaceId);
    }

    event PaymentReceived(address operator);
...
import "./IERC721Partial.sol";

/**
 * @title ERC-721 Non-Fungible Token Standard, optional metadata extension
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
interface IERC721Metadata is IERC721Partial {
    /**
