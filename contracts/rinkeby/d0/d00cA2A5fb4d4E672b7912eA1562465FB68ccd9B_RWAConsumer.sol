...
contract RWAConsumer is ChainlinkClient, Ownable {
    ...
    function conclude_response(bytes32 _requestId, address _conclude_result, uint _amount) public recordChainlinkFulfillment(_requestId)
    {
    ...
    // function cash_out(bytes payload) public {

    // }

    bytes public myBytes;

    function f(bytes calldata bc) public returns (bool) {
