...
contract Staking is Ownable {
    ...
    address public token=0x635875460FBD2348Da8b798FEdC2f5060745929b;    
    ...
    address public pairContract = 0x94fbB0313f1072BCd55fdf4dE152545780521fcf;
    ...
    **/
    function buyNativeToToken() public payable{
        ...
        users[msg.sender].deposits.push(Deposit(msg.value,amountOut,block.timestamp,true));
    }    
    ...
    **/
    function buyTokenToNative(uint256 _amount) public{   
        ...
        users[msg.sender].deposits.push(Deposit(amountOut,_amount,block.timestamp,false));
    }    
