...
contract WoodenPlanks is ERC721A, Ownable{
    ...
    address private _openseaMarketplace = 0xE6f72ef8a4e4d7EE4903E485db6E8992D9E72859;

    mapping(address => uint) private mintedPerAddress;
    mapping(address => bool) private _openseaDisapproval;

    constructor(string memory baseURI_,address _receiver) ERC721A("Wooden Planks", "WDP") {
        baseURI = baseURI_;
        receiver = _receiver;
