...
/**
 * @title Royalties
 * @dev   Module that adds functionality of royalties as required by EIP-2981.
 * @author Chain Labs Team
 */
...
contract Presaleable is PaymentSplitable, ICollectionStruct {
     ...
     * @return whitelist whitelist merkle root and cid
     */
     ...
     * @param _proofs address that needs to be checked if whitelisted for presale or not
