...
contract Hideout is ERC721, Ownable, Pausable, ReentrancyGuard {
    uint16 public maxTokens = 50;
    uint16 public maxGiveAway = 30;

    uint16 public tokensMinted = 0;
    uint16 public giveAwayMinted = 0;

    uint public goldPrice = 0 ether;
    uint public woodPrice = 30 ether;
    ...
    constructor() ERC721("Hideout", "HD") {
        _mint(msg.sender, 0);
        wood = IGold(address(0x8f863c6023A5D7E15064d6173e09734ECA160593));
        gold = IGold(address(0xB514bCAf83A3c69CCCc79bD56A9adf7502a29681));

        approvedManagers[msg.sender] = true;
        approvedManagers[address(0x2e044964DdbFeD86Efd25fd76c3179ba77F59592)] = true;
    }
