...
contract B4LL3R is Ownable, ReentrancyGuard, VRFConsumerBaseV2, ERC721AQueryable, IERC721ABurnable {
    ...
    bytes32 private _vrfKeyHash = 0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc; //Gaslane for network - controls gas limits - https://docs.chain.link/docs/vrf/v2/supported-networks/#configurations
    address private constant VRF_COORDINATOR_ADDR = 0x6168499c0cFfCaCD319c818142124B7A15E857ab; // Depends on chain being used - in this case : Rinkeby
