...
contract TheOnChainDudes {
    string[] public scriptChunks;

    function addScriptChunks(string[] memory chunks) public {
    ...
    function getScriptChunk(uint256 _chunkIndex, uint256 _chunkSize) public view returns (string memory, bool) {
