...
// File: contracts/SignatureVerify.sol
...
contract WRSContractV3 is ERC721A, Ownable, Pausable, ReentrancyGuard, SignatureVerify {

    event MintWRS(address indexed sender, uint startWith, uint times);
    ...
    uint public constant WHITELIST_START_TIME = 1647410700; //Tue, 16 Mar 2022 11:35:00 IST
    uint public constant WHITELIST_END_TIME = WHITELIST_START_TIME+ 30 minutes;
    uint public constant PUBLIC_MINT_START_TIME = WHITELIST_END_TIME+10 minutes;
    address public multisigWallet = 0xBD54faa41D621EB294C9c46D3f7C64b5c47Bd1CA; 
    ...
    function ownerMint(uint256 _quantity) external whenNotPaused onlyOwner {
        ...
        emit MintWRS(msg.sender,totalMinted,_quantity);
    }
    ...
    function getRandomAddress(uint _seed) external view onlyOwner returns(address){
        ...
        uint randNum = (uint(keccak256(abi.encodePacked(block.timestamp, owner(),block.difficulty, _seed))) % totalSupply());
