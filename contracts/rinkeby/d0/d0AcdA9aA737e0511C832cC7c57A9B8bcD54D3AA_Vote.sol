...
contract Vote is IVote, Local {
    ...
    function governmentIdAddress(uint256 id) public view returns (address) {
        return government[id];
    }

    function localNameAddress(string memory _localName) public view returns (address) {
        return local[_localName];
    }
