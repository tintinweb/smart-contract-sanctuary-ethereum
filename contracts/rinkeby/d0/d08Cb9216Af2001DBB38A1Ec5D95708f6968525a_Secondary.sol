...
contract Secondary is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl{
  ...
  function mint(uint256 _mintAmount, uint _tokenId) public payable mintCompliance(_mintAmount)  AllowMintPrice(_tokenId) AllowMintFor(_tokenId) { //mintPriceCompliance(_mintAmount) 
