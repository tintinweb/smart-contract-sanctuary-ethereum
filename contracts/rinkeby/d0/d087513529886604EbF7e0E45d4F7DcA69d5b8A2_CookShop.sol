...
contract CookShop is Ownable, ERC721Holder {
    ...
    mapping(uint256 => uint256) private _tokenIdToLastStakedTimestamp;
    // user address => tokenId => isStaked
    ...
    uint256 private _totalSteakingPeriodInSeconds;
        ...
        private
    {
        ...
        _tokenIdToLastStakedTimestamp[tokenId] = block.timestamp;
    }
        ...
        private
    {
        ...
        _stakedCount[staker] -= 1;
        _tokenIdToLastStakedTimestamp[tokenId] = 0;
    }

    /**
     * @dev TODO: description
     */
    ...
    function setSteakingRewardsParams(
        ...
        uint256 totalSteakingPeriodInSeconds_
    ) external onlyOwner {
        ...
        _totalSteakingPeriodInSeconds = totalSteakingPeriodInSeconds_;
    }
    ...
    function steakingRewardsBondingCurve(uint256 rarityMultiplier)
        ...
        returns (uint256)
    {
        // The rarity multiplier is formatted like `100` for `1x`,
        // `120` for 1.2x, etc. which is why we have to divide by 100 here.
    ...
    /**
     * @dev TODO: description
     * Function can be used for frontend to estimate future or hypothetical rewards
     */
    ...
    function steakingRewardsForTokenId(
        ...
        uint256 steakedDuration = _tokenIdToLastStakedTimestamp[tokenId] == 0
            ? 0
            : block.timestamp - _tokenIdToLastStakedTimestamp[tokenId];

        return steakingRewardsForRarity(rarityMultiplier, steakedDuration);
    }
    ...
    /**
     * @dev TODO: figure out if public vs external makes a difference
     */
