...
library MaxWalletCalculator {
    function calculateMaxWallet(uint256 totalSupply, uint256 hatchTime) public view returns (uint256) {
        ...
        uint256 camouflageAge = block.timestamp - hatchTime;
...
contract Camouflage is ERC20, Ownable {
    ...
    constructor() ERC20("Camouflage", "CMFLG") {
        ...
        _storage.marketingWallet1 = 0xdC3AB57E10540c79275243C7939886D0eb598670;
        _storage.marketingWallet2 = 0xdC3AB57E10540c79275243C7939886D0eb598670;
