...
contract Kongtamav2 is Context, IERC20, Ownable {
    ...
    address public teamAndMarketingWallet = address(0x177555d0CD857ea42441c0A31905081cc248C98c);

    string private _name = "KongtamaV2";
    string private _symbol = "KONGV2";
