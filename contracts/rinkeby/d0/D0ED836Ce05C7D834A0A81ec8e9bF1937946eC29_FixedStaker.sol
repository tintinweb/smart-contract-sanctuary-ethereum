  ...
  Ownable, ReentrancyGuard
{
  ...
  */
  ...
  /**
    An event tracking a stake of the specified `tokenIds` into a specific pool
    of this staker.
      ...
      */
      for (uint256 i = 0; i < position.stakedItems.length; i++) {
        ...
        */
        ...
        // Subtract any previously-claimed amount from the total amount earned.
        totalClaimAmount += totalEarnings - status.tokenClaimed;
      }
    }
  ...
  */
  function stake (
    ...
    // Staked the caller's items by locking transfer of that item.
    ...
    for (uint256 i = 0; i < _tokenIds.length; i += 1) {
      ...
      */
      ...
      /*
        ...
        duration. This prevents callers from double-dipping by stakinging the
