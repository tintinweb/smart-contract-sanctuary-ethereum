...
contract VoteChampion is Pausable, Ownable {
    ...
    function getUser(address _user) external view returns(uint _totalVote, uint[] memory _rankVoted, uint[] memory _rankVotedAmounts) {
        ...
        _rankVotedAmounts[2] = users[_user].rankVotedAmount[2];
    }
