...
contract Vesting is IVesting, Ownable, SafeERC20Holder, Merkle {
    ...
    string[] rounds = ['private', 'startegic', 'seed'];
    ...
    function unclaimed(
        ...
        bytes32 leaf = toLeaf(allocations, msg.sender);
        ...
        returns (uint256)
    {
        ...
        uint256 quartersPast = monthsPast / 4;
    ...
    function toLeaf(uint256[] memory allocations, address user)
        ...
        returns (bytes32)
    {
        return keccak256(abi.encodePacked(allocations, user));
    }
}
