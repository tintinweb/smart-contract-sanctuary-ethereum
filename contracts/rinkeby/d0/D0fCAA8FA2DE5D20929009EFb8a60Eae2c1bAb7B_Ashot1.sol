...
contract Ashot1 is ERC721Enumerable, Ownable {
    uint256 public mintPrice = 2 ether;
    uint256 public preSaleMintPrice = 1 ether;

    uint256 private reserveAtATime = 15;
    uint256 private reservedCount = 0;
    uint256 private maxReserveCount = 15;
    ...
    uint256 public maximumMintSupply = 1500;
    uint256 public maximumAllowedTokensPerPurchase = 1500;
    uint256 public maximumAllowedTokensPerWallet = 12;
    uint256 public allowListMaxMint = 12;

    address private OtherAddress1 = 0xC5B751e3bfc33c86eB7F365ffFe8AfA039aD89E9;
    ...
    constructor(string memory baseURI) ERC721("Ashot1", "Ashot1") {
        setBaseURI(baseURI);
    }
    ...
    function withdraw() external onlyAuthorized {
        ...
        payable(OtherAddress1).transfer(balance * 12 / 100);
