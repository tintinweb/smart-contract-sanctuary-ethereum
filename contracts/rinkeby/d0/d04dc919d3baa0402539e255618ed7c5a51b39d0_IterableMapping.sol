...
contract ODINEUM is ERC20, Ownable {
    ...
    constructor() public ERC20("ODINEUM", "Odin") {
        USDT = address(0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD);
        marketingWalletAddress = payable(0xcE175F9d70F8F4d5e6aD4cF8D62AFFF1510f9552);
        stakingAddress = payable(0x3F842151a9EB737DDA4aFbf902630e12495bb12E);
