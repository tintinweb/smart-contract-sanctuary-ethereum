...
contract ForgeV1 is Initializable, ERC721Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    event NewMint(address minter, uint256 token_id);
        ...
        whenNotPaused
    {
        ...
        emit NewMint(msg.sender, currentTokenId);
