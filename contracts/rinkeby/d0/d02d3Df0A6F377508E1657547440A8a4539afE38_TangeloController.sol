...
contract TangeloController is Ownable {
    ...
    /**
     * @notice store of officially supported market contracts
     */
    address[] private supportedMarkets;
    ...
    function _addSupportedMarkets(
        ...
        supportedMarkets.push(newMarketAddress);
    ...
    /**
     * @notice Getter function for supportedMarkets
     * @return list of officially supported NFT market contracts
     */
