...
contract NewMyETH1 is ERC721A,Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant tokenPrice = 10000000000000000; // 0.0019 ETH // 0.01 ether price;
  ...
  constructor() ERC721A("NewMyETH1", "NewMyETH1") {}
