...
contract Stake is Whitelist{
    ...
    mapping(address => bool) public isBlackListForUnstake;
    mapping(address => bool) public isBlackListForReinvest;
        ...
        public
    {
        ...
        if (_action == UserActions.DEPOSIT) {
            ...
            isBlackListForUnstake[_userAddress] = true;
        } else if (_action == UserActions.REINVEST) {
            isBlackListForReinvest[_userAddress] = true;
        ...
        public
    {
        ...
        if (_action == UserActions.DEPOSIT) {
            ...
            isBlackListForUnstake[_userAddress] = false;
        } else if (_action == UserActions.REINVEST) {
            isBlackListForReinvest[_userAddress] = false;
        } else if (_action == UserActions.ALL) {
            isBlackListForDeposit[_userAddress] = false;
            isBlackListForRefer[_userAddress] = false;
            isBlackListForHarvest[_userAddress] = false;
    ...
    function unstake(uint256 amountToWithdraw) public {
        ...
        require(!isBlackListForUnstake[msg.sender], "User is blacklisted");
    ...
    function reinvest() public {
        ...
        require(!isBlackListForReinvest[msg.sender], "User is blacklisted");
