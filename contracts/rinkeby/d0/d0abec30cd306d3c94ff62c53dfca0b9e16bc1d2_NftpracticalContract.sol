...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 21 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmatMXWeEYEKTMhfTkxKYeah3WhrcUb2zcLZyy8ZUYcCRQ/";
...
// File: contracts/NftpracticalContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftpracticalContract is RamppERC721A {
    constructor() RamppERC721A("nft practical", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qHfKANh0SVi4Oj603fYD/contract-metadata";
    }
}
