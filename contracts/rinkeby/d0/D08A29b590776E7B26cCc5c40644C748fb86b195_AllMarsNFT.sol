...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    uint256 public constant TOTAL_SUPPLY = 2450;
    ...
    function mintTo(address _to) public onlyOwner {
        require(_lastTokenId < TOTAL_SUPPLY, "Max supply reached");
        _lastTokenId++;
     ...
     * @param _to address of the future owner of the token
     */
    function batchMintTo(address _to, uint256 amount) public onlyOwner {
        require(_lastTokenId + amount <= TOTAL_SUPPLY, "Max supply reached");
        for (uint256 i = 1; i <= amount; i++) {
            _safeMint(_to, _lastTokenId+i);
        }
        _lastTokenId += amount;
    }
...
contract AllMarsNFT is ERC721Tradable, IERC2981, RoyaltiesV2, RoyaltiesV1 {
    ...
    constructor(address initialOwner) Ownable(initialOwner)
        ERC721Tradable("AllMarsNFT", "AMNFT", 0xF57B2c51dED3A29e6891aba85459d600256Cf317)
    {
    }

    string private _baseTokenURI = "ipfs://Qmcxh1mLgnV6XnaFbNyQsKh7Vf5jzsEwV8XfK1bqMN3eHC/";
    ...
    function setRoyalty(uint256 _share) public onlyOwner {
        require(_share <= 10000, "Royalty cannot exceed 100%");
        royalty = _share;
    }

    function setFeeWallet(address account) public onlyOwner {
        feeWallet = account;
    }
        ...
        returns (address, uint256)
    {
        ...
        return (feeWallet, royaltyAmount);
    }
