...
contract Thorgi is ERC20Burnable, Ownable {
    ...
    function checkAllRewardsFromCorgis() external view returns (uint256) {
        uint256 totalRewards = 0;
        uint256[] memory stakedBone = getStakedBone(msg.sender);
    ...
    function checkAllRewardsFromPups() external view returns (uint256) {
        uint256 totalRewards = 0;
        uint256[] memory stakedBone = getStakedBone(msg.sender);
    ...
    function checkAllRewards() external view returns (uint256) {
        uint256 totalRewards = 0;
        uint256[] memory stakedBone = getStakedBone(msg.sender);
