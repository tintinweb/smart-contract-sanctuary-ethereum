...
// Initialise Contract
  constructor() ERC721("FebTest", "FT") {
   
    setHiddenMetadataUri("https://ipfs.ballygangnft.io/hidden/hidden.json");

    setPayable(address(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)); 
    setDeveloper(msg.sender);

    _mintLoop(address(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2),10); //gets 10
    _mintLoop(address(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db),1);
    _mintLoop(address(0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB),2); //gets 2
    _mintLoop(address(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db),1);
