// SPDX-License-Identifier: MIT
  ...
  contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
      ...
      uint256 private constant MAX_TOKENS = 210;
      ...
      ContractData public contractData = ContractData(unicode"Still Lifes", unicode"Still Lifes", "", "", "", 0, "");

      constructor() ERC721A(unicode"Still Lifes", unicode"SL") {
        TIERS[0] = [40,170];
TIERS[1] = [5,7,10,13,13,13,13,13,123];
TIERS[2] = [6,16,16,16,16,16,16,16,16,18,18,40];
TIERS[3] = [14,16,16,16,16,16,18,18,80];
TIERS[4] = [6,12,12,12,12,12,14,14,16,20,80];
TIERS[5] = [20,20,20,150];
TIERS[6] = [30,180];
TIERS[7] = [210];
      }
