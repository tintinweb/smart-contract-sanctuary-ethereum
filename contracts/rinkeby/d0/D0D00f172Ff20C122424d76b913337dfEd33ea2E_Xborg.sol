...
contract Xborg is ERC721A, Ownable, AccessControl {
    ...
    // sale times
    uint256 private _whitelistSaleTime = 0x0;
    uint256 private _allowlistSaleTime = 0x0;
    uint256 private _publicSaleTime = 0x0;

    // token prices
    uint256 private _tokenPriceWhitelist = 0.0025 ether;
    uint256 private _tokenPriceAllowlist = 0.003 ether;
    uint256 private _tokenPricePublic = 0.0035 ether;
    ...
    address internal constant project = 0x64243A958656868385B99b9Ff6925132524792dA; // temporary
    address internal constant shareHolder2 = 0xF43621e9fB01c6632520B6D18d63196a0c2e1159;
    address internal constant shareHolder3 = 0x361aB56c220C2D6F50c2d4E6e356A105EC92f275;
