...
contract Omerta is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable,ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OFT{
    ...
    function initialize(        
        ...
        OFTInit("Family DAO", "OMERTA", _lzEndpoint);
        ERC20PermitUpgradeable.__ERC20Permit_init("omerta");
