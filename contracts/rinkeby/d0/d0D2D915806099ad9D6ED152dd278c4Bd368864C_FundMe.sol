...
contract FundMe {
    ...
    // 2. State Variables
    // The s_ syntax indicates that the variable will be added to storage and will cost alot of gas but is bad practice for production code. Make easier to use getter functions that grab the s_ storage variables for easier readability and API access
    ...
    */
    ...
    // This function is extremely gas expensive because it runs a for loop with a storage variable and reads from storage multiple times //
