...
contract HAWEXTESTNFTNOW is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HAWEX NFT GENESIS PASS NOW", "HNGPN") {
    setHiddenMetadataUri("ipfs://QmZtcQMWDpE2NEKXVozc8nG1MGHAWHuivHKPAGDsDXGnx1/1.json");
  }
