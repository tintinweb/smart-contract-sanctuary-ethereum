...
import "./interfaces/IRivermenEstate.sol";
    ...
    Ownable
{
    ...
    function tokenURI(uint256 tokenId)
        public
        view
        override(IRivermenEstate, ERC721)
    ...
    function mintWithSignature(
    ...
    ) external payable override(IRivermenEstate) _notContract whenNotPaused nonReentrant {
        ...
        bytes32 messageHash = getEthSignedMessageHash(
            keccak256(abi.encode(amount, tokenIds, recipient, nonce, block.chainid))
        );
    ...
    /* ADMIN ACTIONS */
    function grantMinter(address account) external override _onlyAdmin {
    ...
    function setNonce(uint256 newNonce) external override _onlyAdmin {
