...
contract KasuStakingV2 is GenericTokenStaking {
...
abstract contract GenericTokenStaking is OwnableUpgradeable {
    ...
    // // This is the method that actually pays the rewards from the penalty pool
    // function transferRewardsFromPenaltyPool(uint256 rewardsToPayToStaker) private {
    //     stakingToken.transfer(msg.sender, rewardsToPayToStaker);
    //     emit StakingRewardsPaid(msg.sender, rewardsToPayToStaker);
    // }
    ...
    // // This method returns the staked amount (substracting the penalty to pay for unstaking)
    // function transferStakedAmountSubstractingPenalty(uint256 amountToPayToStaker) private {
    //     stakingToken.transfer(msg.sender, amountToPayToStaker);
    //     //
