...
contract TruOld is ERC721, Ownable, Pausable {
    /**
        E#0: Sale is not active
        E#1: Sale has ended
        E#2: tokenId outside of the reserve
        E#3: Withdrawal unsuccessful
        E#4: You are not on whitelist
        E#5: You already minted your tokens with whitelist
    */
        ...
        checkTokenCounter
    {
        ...
        require(claimedTokensViaWhitelist[msg.sender] < 4, "E#5");
