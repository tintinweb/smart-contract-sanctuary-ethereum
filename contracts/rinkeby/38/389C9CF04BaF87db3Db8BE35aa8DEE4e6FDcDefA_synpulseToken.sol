...
contract synpulseToken is synERC777 {
    ...
    function setAdministrator(address administrator_to_set
        ...
        require(
            ...
            "The vaultContract cannot be the adminstrator"
        );
    ...
    function sendTokensToMultipleAddresses(
        ...
        require(
            ...
            "Sneaky, but not smart. Only the administrator or vault can perform this action!"
        );
        require(
    ...
    function operatorSend(
        ...
        require(
            ...
            "You're not the boss of me. You're not the boss of anyone. Only an operator can take funds from your colleagues."
        );
        require(
    ...
    function operatorBurn(
        ...
        require(
            ...
            "M.C. Hammer: Duh da ra-duh duh-da duh-da, Can't Touch This. You are not an operator."
        );
        require(
            account == vaultContract,
            "Don't be mean! An operator can only burn tokens in the vaultContract."
        );
        ...
        public
    {
        require(
            isOperatorFor(_msgSender(), _msgSender()),
            "Don't like them? Host your own party if you want to kick them out. You are not an operator."
        );
        for (uint256 i = 0; i < arr.length; i++) {
