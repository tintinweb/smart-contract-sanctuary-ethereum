...
// File: contracts/Arenamon/Arenamon.sol
...
contract Arenamon is ERC721Enumerable, Ownable {
    ...
    function setPaymentAddress() external onlyOwner {}
    ...
    function setMaxLimit(uint256 maxSupply, uint256 publicSupply) external onlyOwner {
    ...
    function mintPublic(address to, uint256 numberOfTokens) external payable {
    ...
    function mintWhitelist(address to, uint256 numberOfTokens, uint256 index, uint256 amount, bytes32[] calldata proof) external payable {
        require(totalSupply() + numberOfTokens <= PUBLIC_SUPPLY,"Purchase would exceed PUBLIC_SUPPLY");
