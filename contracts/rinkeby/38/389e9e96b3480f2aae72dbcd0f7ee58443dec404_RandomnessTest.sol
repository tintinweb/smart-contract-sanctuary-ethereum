...
contract RandomnessTest is ERC721, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    function setSeed() public lockable {
        // require(totalSupply == MAX_SUPPLY, "All tokens must be sold");
