...
contract FactMedia is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("FactMedia", "MD") {}
    ...
    /**
     * @dev Function for mint news in the form of nft token.
     * Only registered media have the right to mint.
     * @param uri Link to the news or news metadata.
     */
    function safeMint(string memory uri) public {
        (bool mediaAccreditation, , ) = FactManager.getMediaInfo(msg.sender);
        ...
        FactManager.addNewsToArchive(msg.sender, tokenIdCounter);
        tokenIdCounter++;
    }

    /**
     * @dev This is a function that provides the ability to change the news token uri.
     * @param tokenId token Id of the desired news.
     * @param uri new link to the news or news metadata.
     */
    function changeFakeNewsURI(uint256 tokenId, string memory uri)
        external
        onlyOwner
    {
