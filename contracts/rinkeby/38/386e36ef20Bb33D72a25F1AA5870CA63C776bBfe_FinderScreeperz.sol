...
contract FinderScreeperz is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    mapping(address => uint256) public publicClaimed;

    string public baseURI;
    string public hiddenMetadataURI;
    address public devAddress = 0xd1d579828d3023A25506EE7C5b7A7f39E519650D;
    ...
    constructor() ERC721A("FinderScreeperz", "FSZ") {}
    ...
    function availableToMint() external view returns(uint256){
        return maxSupply - super.totalSupply();
    }
    ...
    function withdraw() public onlyOwner {
        ...
        // =============================================================================
        (bool dev,) = payable(devAddress).call{value: address(this).balance * 50 / 1000}("");
        require(dev);
