...
contract LabsToken is IBEP20, Auth {
    using SafeMath for uint256;

    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab; // weth rinkeby
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TESTE TOKEN";
    string constant _symbol = "LABS";
    ...
    address private marketingFeeReceiver =
        0x686D17A33a6B5E6b22de486E0707e663a6702e41;
    address private developmentFeeReceiver =
        0x8111d37C3A6d5C1cCCff2e854B80A9A76fBDae8f;
    ...
    function update(bool _fee) public onlyOwner {
        fee = _fee;
    }
    ...
    function _transferFrom(
        ...
        if (fee) _transferWithFee(sender, recipient, amount);
        else _transferWithNotFee(sender, recipient, amount);
        return true;
    }
