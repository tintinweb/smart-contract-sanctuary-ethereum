...
contract NFT is ERC721PresetMinterPauserAutoId,ERC721URIStorage {
    ...
    // uint256 private lowCounter=1;
    // uint256 private medCounter = 5401;
    // uint256 private advCounter = 5701;

    // uint256 private lowMax = 5400;
    // uint256 private medMax = 300;
    // uint256 private advMax = 300;
    ...
    string private BaseUri = "https://subwayrats.io/api/rats/";

    constructor()ERC721PresetMinterPauserAutoId("CoinUp NFT", "CFT", "") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        nftInfo[1] = NFTInfo(5400,601,0.01 ether);
        nftInfo[2] = NFTInfo(300,301,0.02 ether);
        nftInfo[3] = NFTInfo(3,1,0.03 ether);
    }
    ...
    function safeMint(uint256 class,uint256 number) payable public {
    ...
    function changeUri(string memory uri) public onlyRole(MINTER_ROLE) {
