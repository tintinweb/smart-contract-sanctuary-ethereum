...
contract MultiSigWallet {
    ...
    function getConfirmationCount(uint256 transactionId) public returns (uint256 count) {
    ...
    function getTransactionCount(bool pending, bool executed) public returns (uint256 count) {
    ...
    function getConfirmations(uint256 transactionId) public returns (address[] memory _confirmations) {
