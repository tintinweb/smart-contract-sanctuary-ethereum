...
contract TheAbominableBunch is ERC721, IERC2981, ERC721Enumerable, EIP712Whitelisting, ReentrancyGuard {
    ...
    constructor(string memory _name, string memory _symbol, string memory _initNotRevealedUri) 
    ...
    /// @param interfaceId to check for.
