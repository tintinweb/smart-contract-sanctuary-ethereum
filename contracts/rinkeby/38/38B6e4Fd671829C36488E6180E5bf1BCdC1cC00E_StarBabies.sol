...
contract StarBabies is MRC721, Ownable {

    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    bytes32 public constant BULK_ROLE = keccak256("BULK_ROLE");
    bytes32 public constant WHITELIST_MINT_ROLE = keccak256("WHITELIST_MINT_ROLE");

	uint256 public maxSupply = 3333;
    uint256 public maxCap = 3000;
    uint256 public unitPrice = .001 ether;
    uint256 public maxPerUser = 20;
	...
	constructor(
    	...
    	"Star Babies",
    	"STAR",
        "https://starbabies-api.communitynftproject.io/"
    ){
    ...
    function _beforeMint(
        ...
        require(totalSupply() < maxSupply - 1, "> maxSupply");
    }

    function whitelistMint(address _to, uint8 _count) public payable onlyRole(WHITELIST_MINT_ROLE) {
    ...
    function bulktMint(address _to, uint _count) public payable onlyRole(BULK_ROLE) {
        require(_count + totalSupply() <= maxCap, "> maxCap");
        require(msg.value >= price(_count), "!value");
