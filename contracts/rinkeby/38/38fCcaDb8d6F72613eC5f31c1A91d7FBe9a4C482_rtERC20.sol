...
contract rtERC20 is Context, IERC20, Ownable {
  ...
  // TODO: update _rExcludedReward and _tExcludedReward when applicable
  ...
  function _takeLiquidity(address sender, uint256 tLiquidity) internal {
    uint256 currentRate = _getRate();
    uint256 rLiquidity = tLiquidity * currentRate;
    bool _contExcluded = _isExcludedReward[address(this)];
    if (_contExcluded) {
      _rExcludedReward -= _rOwned[address(this)];
      _tExcludedReward -= _tOwned[address(this)];
    }
  ...
  function _transferToExcluded(
    ...
    _rExcludedReward -= _rOwned[recipient];
    _tExcludedReward -= _tOwned[recipient];
    (
      uint256 rAmount,
      uint256 rTransferAmount,
      uint256 tTransferAmount,
  ...
  function _transferFromExcluded(
    ...
    _rExcludedReward -= _rOwned[sender];
    _tExcludedReward -= _tOwned[sender];
    (
      uint256 rAmount,
      uint256 rTransferAmount,
      uint256 tTransferAmount,
