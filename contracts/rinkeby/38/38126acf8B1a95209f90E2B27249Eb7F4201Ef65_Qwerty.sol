...
contract Qwerty is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public BALANCE_FREE = 5000;
    uint256 public BALANCE_RESERVED = 600;
    ...
    constructor() ERC721A("Qwerty", "QWERTY") {}
    ...
    function mint(uint8 numTokens) external payable callerIsUser {
        ...
        if (msg.value > 0) {
            ...
            require(BALANCE_FREE - BALANCE_RESERVED > 0, "Reached free mint supply");
            require(BALANCE_FREE - BALANCE_RESERVED - numTokens >= 0, "Reached free mint supply");
            ...
            BALANCE_FREE = BALANCE_FREE - numTokens;
            _safeMint(msg.sender, numTokens);
        }
    }
    ...
    function reservedMint(uint8 numTokens) external callerIsUser {
        require(totalSupply() + numTokens <= MAX_SUPPLY, "Reached max supply");
        require(BALANCE_RESERVED > 0, "Reached reserved mint supply");
        require(BALANCE_RESERVED - numTokens >= 0, "Reached reserved mint supply");
        ...
        BALANCE_RESERVED = BALANCE_RESERVED - numTokens;
        _safeMint(msg.sender, numTokens);
    }
