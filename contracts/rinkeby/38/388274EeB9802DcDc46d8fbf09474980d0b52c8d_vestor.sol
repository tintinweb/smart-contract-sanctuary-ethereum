...
contract vestor{
    ...
    external
    payable
    tokenstransferFromable(tokencontractaddress, msg.sender,addforamount(amountperinvestors)*vestingPeriod)
    {

        uint256 totalamount = addforamount(amountperinvestors)*vestingPeriod;
   ...
   require(timesclaimablebyinvestors[msg.sender][_contractid] >= 0," all of your tokens have been claimed");
   ...
   uint256 deduct = timesclaimablebyinvestors[msg.sender][_contractid] - amountofinvestorsbyindex[msg.sender][_contractid] ;

   timesclaimablebyinvestors[msg.sender][_contractid] = deduct; 
