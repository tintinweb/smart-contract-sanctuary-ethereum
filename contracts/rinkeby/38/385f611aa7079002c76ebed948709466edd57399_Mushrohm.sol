...
contract Mushrohm is ERC721Enumerable, Ownable {
    using Strings for uint256;
    uint256 public PRICE = 0 ether;
    
    uint256 public MAX_MUSHROHMS = 1500;
    uint256 public MAX_PER_MINT = 100;
    uint256 public MAX_MUSHROHMS_MINT = 100;
    address public constant founderAddress = 0xb4EC04756B0eF62581167663E9B33201Dfa169d8;
    uint256 public numshrohmsMinted;
    
    string public baseTokenURI = "https://mushrohms.mypinata.cloud/ipfs/Qmeir9woe1ojVDAHdxJA6nRNC3v6KcFDptY7rQTsGA2M26/";
