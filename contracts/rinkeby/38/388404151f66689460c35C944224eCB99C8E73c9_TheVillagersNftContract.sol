...
//*********************************************************************//
//
//  __      _______ _      _               _____ ______ _____   _____   _   _ ______ _______ 
//  \ \    / /_   _| |    | |        /\   / ____|  ____|  __ \ / ____| | \ | |  ____|__   __|
//   \ \  / /  | | | |    | |       /  \ | |  __| |__  | |__) | (___   |  \| | |__     | |   
//    \ \/ /   | | | |    | |      / /\ \| | |_ |  __| |  _  / \___ \  | . ` |  __|    | |   
//     \  /   _| |_| |____| |____ / ____ \ |__| | |____| | \ \ ____) | | |\  | |       | |   
//      \/   |_____|______|______/_/    \_\_____|______|_|  \_\_____/  |_| \_|_|       |_|   
//                                                                                           
//                                                                                           
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe7693f64624eF8A1B168e865fF4c91190988e6eF];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 8888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "null";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 0.03569 ether;
...
// File: contracts/TheVillagersNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheVillagersNftContract is RamppERC721A {
    constructor() RamppERC721A("The Villagers NFT", "VILLAGERS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/swqiaaTQAnktG5uD6Z96/contract-metadata";
    }
}
