...
contract Source is Ownable {
    ...
    /**
     * Set store of contract
     */   
    function setTokenStore(bool status) external onlyOwner onlyDeactive {
        tokenStore = status;
    }
...
contract OnChainMachinesMetadata is Source {
	...
	function getVector(uint256 token, address minter, uint256 timestamp) internal view returns (string memory) {
        return string(abi.encodePacked(
            ...
            string(abi.encodePacked(
                '<defs><pattern id="n" width="20" height="20" patternUnits="userSpaceOnUse" ><g stroke="#001e3c" opacity=".35" ><line x1="0" y1="0" x2="20" y2="20" /><line x1="20" y1="0" x2="0" y2="20" /></g></pattern><linearGradient id="d" x1="0" x2="0" y1="0" y2="100%"><stop offset="0%" stop-color="',
            ...
            '<g stroke-width="8" stroke="#001e3c" >',
