...
// File @openzeppelin/contracts/token/ERC721/extensions/IERC721Enumerable.s[email protected]
...
contract KEKW is ERC721A, Ownable {
    ...
    uint256 public constant FREE_ELEMENTS = 666;
    uint256 public constant MAX_FREE_PER_WALLET = 5;
    uint256 public constant MAX_PER_WALLET = 10;
    uint256 public premium = 0.004 ether;
    ...
    address artist = 0x5175034DeF63349CAC5fd8FE0E3f6Fc2394422F8;
    address dev = 0xEaC458B2F78b8cb37c9471A9A0723b4Aa6b4c62D;

    // constructor(string memory baseURI) ERC721A("KEKW", "KEKW") {
    //     setBaseURI(baseURI);
    // }
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount <= MAX_FREE_PER_WALLET, "Max amount");
    ...
    function withdraw() external {
        ...
        (bool toArtist, ) = artist.call{value: balance * 25 / 1000}("");
