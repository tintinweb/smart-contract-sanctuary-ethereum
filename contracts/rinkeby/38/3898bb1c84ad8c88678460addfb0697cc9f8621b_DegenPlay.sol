...
contract DegenPlay is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("DegenPlay", "DGNP"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more dgnp");
    require(mintEnabled, "Minting is not live yet, hold on dgnp.");
