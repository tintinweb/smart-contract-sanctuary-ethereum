...
contract TinyPlanet is Ownable, ERC721A, ReentrancyGuard
{
    ...
    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmcLAesSmnzxzzoZ4nejKCgwqSBX9Ndgr5E4CUAZbB6WKL";
    ...
    function devMint(uint256 _count) external onlyOwner
    {
        ...
        for(uint i = 0; i < _count; i++)
        {
            generatePlanetData(abi.encodePacked(msg.sender, _tokenCounter, i), _tokenCounter);
            _tokenCounter++;
        }
        _safeMint(msg.sender, _count);
    }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory)
    {
        ...
        if(_isRevealed)
        {
            ...
            bytes memory data2 = abi.encodePacked('{ "trait_type": "Gas Resources", "value": "', MetalsGasOrganic[planetsData[_tokenId].properties[2]] ,'" }, ',
            ...
            /*data = string(abi.encodePacked('{ "description": "', planetsData[_tokenId].desc, '",', 
                                            ' "image": "', string(abi.encodePacked(_baseTokenURI, '/', uint2str(_tokenId + 1), '.png')), '",',
                                            ' "name": "', planetsData[_tokenId].name, '", "attributes": [',
                                            '{ "trait_type": "Life Conditions", "value": "', LifeConditions[planetsData[_tokenId].properties[0]] ,'" }, ',
                                            '{ "trait_type": "Metal Resources", "value": "', MetalsGasOrganic[planetsData[_tokenId].properties[1]] ,'" }, ',
    ...
    function generatePlanetData(bytes memory _offset, uint256 _id) internal
    {
        ...
        planetsData[_id].properties[5] = 1;
