...
contract MockedTreasury is ITreasury {
    ...
    function get_tokens(uint reward, uint _amountBlxm, uint _amountToken, address to) external override returns (uint sentBlxm, uint sentToken) {
...
interface ITreasury {
    ...
    function get_tokens(uint reward, uint amountBlxm, uint amountToken, address to) external returns (uint sentBlxm, uint sentToken);
