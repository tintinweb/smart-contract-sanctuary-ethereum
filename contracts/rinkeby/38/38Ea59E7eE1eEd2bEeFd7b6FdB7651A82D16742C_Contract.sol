...
contract Contract is ERC721, Ownable {
  ...
  string public uriPrefix = "https://ipfs.io/ipfs/QmZmMc8xqyazQc9LBkFMCs8HMZ61W88ypGNr2PPzQcSkvM/";
  ...
  bytes32 public whitelistMerkleRoot = 0x66e95efe6f304532c65a5aa7183ae16d319ed24dd62519c3817f4adacccec44c;
  mapping(address => bool) public whitelistClaimed;

  constructor() ERC721("Whitelist Test", "WTST") {
  ...
  function whitelistMint(bytes32[] calldata _merkleProof) public payable {
    require(!whitelistPaused, "The contract is paused for whutelist mint!");
