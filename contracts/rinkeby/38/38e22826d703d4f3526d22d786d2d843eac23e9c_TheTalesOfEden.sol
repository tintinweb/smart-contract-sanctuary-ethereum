...
contract TheTalesOfEden is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string public hiddenURI = "ipfs://QmadMjuzE3SnV5KVRqEDSesftsjdoEsMoJaqPzCVeGvhs1/1.json";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 1555;
    ...
    constructor() ERC721A("TheTalesOfEden", "TE") {}
