...
contract NFTQ4C is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    string internal baseuri = "https://gateway.pinata.cloud/ipfs/QmeQqUJ1GgBYznKTj3hJUzEfjZj6BfNLhcvMtrg14vT1cJ/";
    
    constructor() ERC721("NFTQ4C", "Q4C") {
        NFTPrice = 0.01 ether;                    
        NFTMaxSupply = 1000;
        mint(5);
    }
    ...
    function mint(uint256 _countNfts) public payable whenNotPaused {
        ...
        if (msg.sender != owner()) {
            require(startSale == true, "NFT sale timings");
            require(msg.value >= NFTsPrice, "Please enter correct price");
        }
