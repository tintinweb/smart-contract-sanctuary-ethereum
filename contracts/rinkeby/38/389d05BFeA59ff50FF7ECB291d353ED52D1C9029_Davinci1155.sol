/** @notice The Davinci1155 contracts have the responceblity for Minting NFTs , transferring , burning NFTs from the wallets
    assign operators for NFTs, returning Ipfs target path(tokenURIs) of given tokenId,..etc
*/
...
//@title Davinci1155 having the nature of ERC1155 with splitRoyalty, Lazymint.
//@dev see{ERC1155Supply, ERC1155Burnable, Context, Counters, AccessControl}.

contract Davinci1155 is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
