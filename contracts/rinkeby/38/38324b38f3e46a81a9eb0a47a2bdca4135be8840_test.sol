...
contract test is ERC721A, Ownable {
  ...
  uint256 constant MAX_SUPPLY_PLUS_ONE = 4445;
  ...
  function mint(uint256 _mintAmount) external payable {
    ...
    require(_totalSupply + _mintAmount < MAX_SUPPLY_PLUS_ONE, "Exceeds supply");
    require(_mintAmount < MAX_PER_TRANSACTION_PLUS_ONE, "Exceeds max per tx");
