...
contract VeeFriendsV2 is ERC721, IERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_TOKEN_AMOUNT = 55555;
    ...
    function mintBatch(address buyer, uint256[] memory tokenIds)
        public
        onlyOwner
    {
        ...
        require(
            updatedIndex + tokenIds.length < MAX_TOKEN_AMOUNT,
