...
contract Jidori is Ownable, ERC721A, ReentrancyGuard {
    ...
    //bytes32 public rootHash = 0xbba8a5b27f133756c4af8d18f2237ee955461b68d318a10d2c8b7f6eaee1ea5b;
    //bool paused = false;
    //bool isPublicSale = false;
    //bool isPreSale = true;
    //uint256 private constant preSaleMaxMint = 1;
    //uint256 private constant publicSaleMaxMint = 2;
    //uint256 private constant publicSalePrice = 0.09 ether;
    //uint256 private constant preSalePrice = 0.065 ether;
    //uint256 private constant maxSupply = 2222;
    //uint256 private constant devMintAmount = 50;

    constructor() ERC721A("Jidori NFT", "JIDORI") {}
        ...
        payable
    {
        ...
        uint256 preSalePrice = uint256(config.preSalePrice);
        ...
        require(quantity <= preSaleMaxMint, "Exceeds the maximum mint amount when Pre-sale.");
        ...
        require(
            quantity * preSalePrice <= msg.value,
        ...
        require(
            addressMinted(msg.sender) + quantity <= preSaleMaxMint,
    ...
    function publicSaleMint(uint256 quantity) external payable {
        ...
        require(quantity <= publicSaleMaxMint, "Exceeds the maximum mint amount when Public-sale.");
