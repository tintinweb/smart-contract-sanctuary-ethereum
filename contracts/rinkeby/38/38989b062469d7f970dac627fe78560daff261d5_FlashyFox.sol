...
contract FlashyFox is ERC721A, Ownable {
	...
	constructor() ERC721A('FlashyFoxes', 'FFOX') {
    }
	...
	function mint(uint256 count) external payable {
		require(publicMintActive, 'FlashyFoxes: Sales are off');
		require(count <= MAX_PUBLIC_MINT_PER_WALLET,'FlashyFoxes: Exceeds NFT per transaction limit');
		require(_totalMinted() + count <= MAX_SUPPLY,'FlashyFoxes: Exceeds max supply');
