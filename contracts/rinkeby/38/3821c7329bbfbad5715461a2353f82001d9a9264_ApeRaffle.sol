...
contract ApeRaffle is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("ApeRaffle", "APERFL"){
    whitelist[0x6099381e17d4Ffb7a2717bb7Ee8067867442aA55].exists = true;
    whitelist[0x867Eb0804eACA9FEeda8a0E1d2B9a32eEF58AF8f].exists = true;
    ...
    function PresaleMint(uint256 numberOfTokens) public payable{
        ...
        require(numberOfTokens > 0 && tokensMinted + numberOfTokens <= ApeSup, "Purchase would exceed max supply of APERFL's");
        require(whitelist[msg.sender].presalemints + numberOfTokens <= 2,"This Wallet has already minted its 2 reserved APERFL's");
