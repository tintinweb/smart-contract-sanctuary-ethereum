...
contract KamiReborn is ERC721A, Shareholders {
    IERC721A public genesisContract = ERC721A(0x14C82e83490fE667cdDA3C31b3b9DB090899f87d); //mainnet address 0x14C82e83490fE667cdDA3C31b3b9DB090899f87d
    IERC721A public mainContract = ERC721A(0xA3332d74bBF2a4B93d2Cac74A5573e105aE268C4); //mainnet address 0xA3332d74bBF2a4B93d2Cac74A5573e105aE268C4
    using Strings for uint;
    string public _baseTokenURI; //need pre-reveal
    uint public maxPerPresaleMint = 2; //verify
    uint public maxPerMint = 3; //verify
    uint public maxPerWallet = 6; //verify
    uint public cost = 0.05 ether; //0.05
    uint public mainClaimPrice = 0.02 ether; //0.02
    uint public presaleCost = 0.05 ether; //0.05
    uint public maxSupply = 10000;  //10000
    uint public unclaimedGenesis = 2898; //2898
    uint public unclaimedMain = 4101; //4101
    bool public revealed = false;
    bool public presaleOnly = true;
    bool public claimActive = true;
    bytes32 public merkleRoot; //need merkle root
  ...
  constructor( 
      ...
      uint256[] memory newShares
        ...
        _mint(msg.sender, 50);
        changeShareholders(newShareholders, newShares); //need wallet addresses
    }
