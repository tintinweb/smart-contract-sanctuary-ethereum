...
contract SkulltoonsGenesis is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        specialListRoot = _specialListRoot;
    ...
    function preSaleMint(bytes32[] calldata _wlProof, bytes32[] calldata _slProof) external payable nonReentrant {        
        uint allowedCount = getAllowedMintCount(_wlProof, _slProof);
