...
contract MegaStake is ERC20, AccessControl,ERC20Capped{  
   ...
   uint256 maxReward;
   uint256 TimeInterval = 20 seconds;
   uint256 _rewards;
   uint256 ClaimedRewards;
    uint256 timeOfStake;
    uint256 timeToDistribute ;
    ...
    mapping(address => uint256) public newTime;
    ...
    {   
        ...
        _Owner = 0x89cbe8bd15Cb6dfCBF3c77650d7b107117bC353B;
        ...
        _mint(_Owner,_InitialSupply);
                            ...
                            { 
                                 _StakeTime[msg.sender] =   block.timestamp;                    // New Time
                                  _StakeBalance[msg.sender] += StakeAmount;
                            }
                           ...
                           _StakeTime[msg.sender] = block.timestamp ;                          // Old time 
                            ...
                            function ClaimReward() public  { 
                                ...
                                require( _StakeHolder[msg.sender] == true, "Error");
                                require(block.timestamp >=_StakeTime[msg.sender] + TimeInterval ,"Time is not yet completed");
                                
                                _StakeTime[msg.sender] = block.timestamp ;                                 
                                _Reward[msg.sender] += _StakeBalance[msg.sender] * 3/100;


    }
                     
                             function unstake() public  {
                             ClaimedRewards = _Reward[msg.sender];
                                 _StakeBalance[msg.sender] += ClaimedRewards;
                            }
