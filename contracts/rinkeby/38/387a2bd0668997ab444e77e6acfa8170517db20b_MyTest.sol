...
contract MyTest is Ownable, ERC721A {
    ...
    address constant internal Artist = 0xBdCb8F3e94fA4acb4977c94A9C6faE3C2D2Bb875;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Mytest", "myt") { }
