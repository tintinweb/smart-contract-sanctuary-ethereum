...
contract NMToken is ERC20 {
    ...
    constructor() ERC20("NMToken","NMT"){
        _SUPPLY_CAP = 100000;
        _OWNER = 0xcE8DD3A8eDa0728934138B2eEA529A33dD7a9988;
    }
    function mintToken(address account, uint amount) public{
        require(totalSupply() + amount <= _SUPPLY_CAP, "Max Supply reached");
        require(msg.sender == _OWNER, "Only Publisher can mint new Tokens");
    ...
    function burn(address account, uint amount) public{
        require(msg.sender == _OWNER, "Only Publisher can burn Tokens");
