...
contract MadeByApeTEST is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    address[] private _wallets = [
        0xE304c7BD022E348cF4E509E34C0b7B1e1856FBA2,
        0xB237877F242Fdf2Ce7224BF19C242e1878A7F000,
        0xf15d6d83F49302C9666A8d41B3096D7C6384dd8a,
        0x97e01923DdA072DdE263181dD27756d2557AD6A1,
        0x88594a7d68D81417Efb0ae893F84f9c473b756D4
    ];
    uint256[] private _walletShares = [40, 10, 20, 15, 15];
    ...
    ) ERC721A('Made By Ape-TEST', 'BYAPE-TEST') PaymentSplitter(_wallets, _walletShares) {
        baseURI = initBaseURI;
        _signer = signer;
    ...
    function spcMint() external payable callerIsUser eligibleToMint(1) {
        ...
        if (spcBalance > 0) {
            if (spcBalance > 0 && _spcMinted.current() + 1 <= partnerAllowance) {
    ...
    function mint(uint256 amount) external payable callerIsUser eligibleToMint(amount) {
        ...
        require(numberMinted(msg.sender) + amount <= maxPerWallet, 'Cannot mint that many');
