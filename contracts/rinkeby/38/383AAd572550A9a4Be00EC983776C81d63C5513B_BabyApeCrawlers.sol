...
contract BabyApeCrawlers is Ownable, ERC721, IERC721Metadata {
  using Counters for Counters.Counter;

  uint256 public constant MAX_SUPPLY = 888;
  uint256 public constant MAX_PUBLIC_MINT = 8;
  uint256 public constant PRICE_PER_TOKEN = 0.0888 ether;

  bool public saleIsActive;
  bool public whitelistIsActive;

  string private _name = "Baby Ape Crawlers";
  ...
  function mintWhitelist(uint8 numberOfTokens) external payable {
    ...
    if (PRICE_PER_TOKEN * numberOfTokens > msg.value)
  ...
  function setTokenURIs(uint256[] memory tokenIds, string[] memory tokenURIs)
    external
    onlyOwner
  {
