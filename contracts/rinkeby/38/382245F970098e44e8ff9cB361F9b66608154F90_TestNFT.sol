...
contract TestNFT is ERC721, Ownable {
    ...
    uint256 public redeemPrice = 0.001 ether;
    bytes32 public merkleRoot;
    string public baseURI; //same name as the original
    ...
    function setRedeemPrice(uint256 _redeemPrice) public onlyOwner {
    ...
    function whiteListMint(bytes32[] calldata _merkleProof) public payable {
        ...
        require(msg.value >= mintPrice, "Not enough funds");
        require(msg.sender == tx.origin, "Bot prevention");
        require(!whitelistClaimed[msg.sender], "Already claimed your whitelist");

        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));

        require(MerkleProof.verify(_merkleProof, leaf, merkleRoot), "Not whitelisted");
