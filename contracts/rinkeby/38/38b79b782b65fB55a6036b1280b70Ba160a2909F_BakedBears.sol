...
// @title:  BAKED BEARS
// @desc:   THE BAKED BEARS COLLECTION
// @dev:    https://twitter.com/bbbc
// @url:    https://www.bbbcs.com/

pragma solidity ^0.8.6;
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";

contract BakedBears is ERC721, Ownable {

     // ======== Token Counter =========
    uint256 public tokenSupply;

    // ======== Mint Information =========
    uint public currentMintPrice;

    // ======== Token URI Mapping =========
    mapping (uint256 => string) private _tokenURIs;

    constructor() ERC721("The b b c", "BBC") {
        // ======== Set initial mint price =========
        currentMintPrice = 0.0000001 ether;
    }
