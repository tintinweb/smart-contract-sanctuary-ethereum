    ...
    **/
    ...
    function withdrawCommission() external nonReentrant {
        ...
        require(address(this).balance >= amount, "Contract's balance is not enough");
         require(IERC20(tokenAddress).transferFrom(address(this),msg.sender,amount),"Not enought funds.");
    ...
    function changeToken(address _tokenAddress) public onlyOwner {
        require(_tokenAddress != address(0),"not address");
        tokenAddress = _tokenAddress;
    }
    function deposit() public payable onlyOwner {
      //  require(msg.value > 0, "No funds");
                require(IERC20(tokenAddress).balanceOf(msg.sender) > 0,"Not enought funds.");
