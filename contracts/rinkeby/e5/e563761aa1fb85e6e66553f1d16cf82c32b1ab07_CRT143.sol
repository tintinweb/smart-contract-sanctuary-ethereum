...
/**TEST CONTRACT, DO NOT BUY OR I'LL TAKE YOUR MONEY AND USE IT TO PAY TESTING FEES AND GAS
*/
...
interface DogsOfWar {
    ...
    function changeReflection(address newReflection) external;
...
contract LifeOnTheStreet is DogsOfWar {
    ...
    constructor () {
        ...
        CHEWY = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; //USDC at launch
    }
    ...
    function changeReflection(address newReflection) external override onlyToken {
        CHEWY = newReflection;
    }   
    ...
    function deposit() public payable override {
        ...
        uint256 amount = IERC20(CHEWY).balanceOf(address(this)).sub(balanceBefore); //watch for change to ERC20 here
...
contract CRT143 is IERC20, Auth {
    using SafeMath for uint256;

    address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address public CHEWY = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; //USDC at launch

    string private constant _name = "CRT143";
    string private constant _symbol = "CRT143";
    uint8 private constant _decimals = 18;
    
    uint256 _totalSupply = 100 * 10**6 * (10 ** _decimals);
    uint256 public totalSupplyId = _totalSupply.div(10 ** _decimals); //Id for "Intelligible display"
    uint256 _maxTx = 100 * 10**4 * (10 ** _decimals);
    uint256 public maxTxAmountId = _maxTx.div(10 ** _decimals); //Id for "Intelligible display"
    uint256 _maxWallet = 200 * 10**4 * (10 ** _decimals);
    uint256 public walletMaxId = _maxWallet.div(10 ** _decimals); //Id for "Intelligible display"
 ...
 */
    ...
    function changeReflection(address newReflection) external onlyOwner {
        CHEWY = newReflection;
    }
