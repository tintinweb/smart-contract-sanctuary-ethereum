...
contract VestingWallet is Context, Ownable {
    ...
    event ValueChanged(address newValue);

    function store(address newValue) external onlyOwner {
    ...
    constructor(
        ...
        require(value != address(0), "VestingWallet: beneficiary is zero address");
        _beneficiary = value;
