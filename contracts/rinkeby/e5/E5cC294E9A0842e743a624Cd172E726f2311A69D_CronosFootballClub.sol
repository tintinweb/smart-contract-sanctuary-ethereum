...
contract CronosFootballClub is ICronosFootballClub, ERC721Enumerable, Ownable, Pauseable, Withdraw {
     ...
     */
    constructor(IGOAL _goal, ITraits _traits, uint256 _maxTokens) ERC721("Cronos FC", 'CFC') {
        goal = _goal;
        traits = _traits;
       // _pause();
