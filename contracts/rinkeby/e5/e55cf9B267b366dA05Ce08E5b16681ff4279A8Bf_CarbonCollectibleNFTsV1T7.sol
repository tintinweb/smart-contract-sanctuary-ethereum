...
contract CarbonCollectibleNFTsV1T7 is Initializable, ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize(string memory _initBaseURI, address _initOwner) public initializer {
    __ERC721_init("CarbonCollectibleNFTsT7", "CCNT7");
    __Ownable_init();
