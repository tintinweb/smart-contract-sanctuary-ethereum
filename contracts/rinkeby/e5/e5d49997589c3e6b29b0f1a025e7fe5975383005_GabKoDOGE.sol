...
// GabKo DOGE (GABD)  standard token
...
/***********************************************************/
/* GabKoDOGE (GABD) STARTS HERE   */
/***********************************************************/

contract GabKoDOGE is Authorizable, TokenERC20 {
   ...
   /// no tokens can be ever issued when this is set to "true"
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    constructor() TokenERC20(0, "GabKo DOGE", "GABD", 18) {
        tokenSaleHardCap = 100000000 * 10**uint256(decimals); // Default Crowsale Hard Cap amount with decimals
        baseRate = 17857 * 10**uint256(decimals); // Default base rate Token) :1 eth amount with decimals
    }
