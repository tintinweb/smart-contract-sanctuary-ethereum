...
contract SongAlbumAddressRegistry is Ownable {
    bytes4 private constant INTERFACE_ID_ERC721 = 0x80ac58cd;

    /// @notice Artion contract
    address public artion;

    /// @notice SongAlbumAuction contract
    address public auction;

    /// @notice SongAlbumMarketplace contract
    address public marketplace;

    /// @notice SongAlbumBundleMarketplace contract
    address public bundleMarketplace;

    /// @notice SongAlbumNFTFactory contract
    address public factory;

    /// @notice SongAlbumNFTFactoryPrivate contract
    address public privateFactory;

    /// @notice SongAlbumArtFactory contract
    address public artFactory;

    /// @notice SongAlbumArtFactoryPrivate contract
    address public privateArtFactory;

    /// @notice SongAlbumTokenRegistry contract
    address public tokenRegistry;

    /// @notice SongAlbumPriceFeed contract
    ...
    /**
     @notice Update SongAlbumAuction contract
     @dev Only admin
     */
    ...
    /**
     @notice Update SongAlbumMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update SongAlbumBundleMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update SongAlbumNFTFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update SongAlbumNFTFactoryPrivate contract
     @dev Only admin
     */
    ...
    /**
     @notice Update SongAlbumArtFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update SongAlbumArtFactoryPrivate contract
     @dev Only admin
     */
