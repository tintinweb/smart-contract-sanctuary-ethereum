...
contract OkayCyberBears is ERC721A, Ownable {
    ...
    mapping(address => uint256) public NFTmintedbyAddress;

    uint public constant MAX_SUPPLY = 10000;
    uint public constant PRICE = 0.0088 ether;
    ...
    function reserveNFTs() public onlyOwner {
        require(_totalMinted() + 2 < MAX_SUPPLY, "Not enough NFTs left to reserve");
    ...
    function preSale(uint _count) public payable {
        ...
        uint preSaleMaxSupply = 2000;
        require(PresaleOpen ,"Presale minting is not open!");
        require(_totalMinted() + _count <= preSaleMaxSupply, "Not enough Presale NFTs left!");
