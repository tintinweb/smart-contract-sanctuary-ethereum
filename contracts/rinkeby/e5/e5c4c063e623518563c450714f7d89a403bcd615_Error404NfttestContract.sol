...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRuwPnDAmY3Ha2fh9QDqzk1GnBoYbAHu9uAuLvhPUCwP5/";
...
// File: contracts/Error404NfttestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Error404NfttestContract is RamppERC721A {
    constructor() RamppERC721A("Error 404 nft test", "error4"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/AgIBejYfp9QAr19KOAqL/contract-metadata";
    }
}
