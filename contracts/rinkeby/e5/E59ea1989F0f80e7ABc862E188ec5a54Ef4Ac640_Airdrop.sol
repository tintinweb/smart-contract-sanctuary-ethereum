...
// File: contracts/mpwrAirdrop.sol
...
contract Airdrop is Ownable {
     ...
     * @param _who The claimer address
    ...
    function claim(
        ...
        require(!isClaimed(_who), "Already claimed");
        require(verifyProof(_merkleProof, getMerkleRoot(), getNode(_who, _amount)), "Invalid claim");
        if(stake) {
            ...
            IERC20(getMPWR()).safeTransfer(_who, _amount);
        }

        _setClaimed(_who);
        emit Claimed(_who, _amount);
    }
