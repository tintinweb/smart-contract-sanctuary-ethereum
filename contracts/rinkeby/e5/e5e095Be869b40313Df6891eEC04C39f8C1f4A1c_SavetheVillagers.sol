...
contract SavetheVillagers is ERC721AQueryable, Ownable, ReentrancyGuard {
...
function waitlistMint(address account,uint256 _mintAmount, bytes32[] calldata _proof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) isValidMerkleProof(_proof) 
    onlyAccounts {
    // Verify presale requirements
