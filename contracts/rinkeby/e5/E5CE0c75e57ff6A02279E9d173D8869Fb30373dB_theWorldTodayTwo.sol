    ...
    recovery
{
    ...
    function mintBatchToOne(address recipient, uint256[] memory tokenIds) external  onlyAllowed {
    ...
    function mintBatchToOneR(address recipient, uint256[] memory tokenIds ) external  onlyAllowed {
    ...
    function mintBatchToMany(address[] memory recipients, uint256[] memory tokenIds) external  onlyAllowed {
    ...
    function mintBatchToManyR(address[] memory recipients, uint256[] memory tokenIds) external  onlyAllowed {
        uint256 len = tokenIds.length;
        uint256[] memory newTids = new uint256[](len);
    ...
    function mintReplacement(address user, uint256 tokenId) external onlyAllowed {
        _minty(user, tokenId);
    }
    ...
    function setRevealedBaseURI(string calldata thisURI) external onlyAllowed {
        _thisURI = thisURI;
    ...
    function setURI(uint256 tokenId, string memory replacement) external onlyAllowed {
