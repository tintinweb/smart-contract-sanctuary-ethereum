...
contract NOMRDC is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant maxNOMRDCSupply = 8814;
    uint256 public constant maxNOMRDCPerMint = 25;
    bool public mintLive = false;

    constructor(string memory _BaseURI, address _proxyRegistryAddress)
        ERC721A(
            "Not Okay Mutant Rektguy DAO Club",
            "NOMRDC",
            maxNOMRDCPerMint,
            maxNOMRDCSupply
        )
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= maxNOMRDCPerMint, "max mint exceeded");
        require(
            totalSupply() + _mintAmount <= maxNOMRDCSupply,
