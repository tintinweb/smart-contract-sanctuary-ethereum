...
// File: contracts/breakBarnabe.sol
...
contract Break is ERC721A, Ownable, Pausable {
    ...
    bytes32 public merkleRootWhiteListPhase1=0xff495a5daaa48f65813d65905c2611cad5d64108fa76c748dbfe619a4a230cef;
    bytes32 public merkleRootWhiteListPhase2=0xff495a5daaa48f65813d65905c2611cad5d64108fa76c748dbfe619a4a230cef;
    ...
    string private notRevealUrl="https://gateway.pinata.cloud/ipfs/QmSS7eWr8RQcgCigzLeWtRKVJEkMeB5UHYKwQtiex476Xr";
    ...
    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmSS7eWr8RQcgCigzLeWtRKVJEkMeB5UHYKwQtiex476Xr";
    }
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external {
     ...
     if(whiteListPhase1 == true && whiteListPhase2 == false && publicSale ==false){
      ...
      function freemint(uint256 quantity) external whenNotPaused {
