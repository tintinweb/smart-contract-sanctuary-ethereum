...
contract GGMfers is ERC721A, Ownable, ReentrancyGuard {
  ...
  function buildImage() public pure returns(string memory) {
    return Base64.encode(string(abi.encodePacked(
      '<svg width="560" height="560" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">',
      '<rect width="560" height="560" fill="#FFC925"/>',
      '</svg>'
    )));
  }
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    return string(abi.encodePacked(
      'data:application/json;base64,', Base64.encode(string(abi.encodePacked(
        ...
        _tokenId,
        '", "description":"',
        '"Are you winning son?" This is for when you do not.',
        '", "image": "',
