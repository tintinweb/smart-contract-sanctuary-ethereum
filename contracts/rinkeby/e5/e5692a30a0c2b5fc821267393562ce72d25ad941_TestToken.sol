...
contract TestToken is ERC20, Ownable {
    ...
    constructor (address newOwner, address router_)ERC20("TestToken",  "TestToken"){  

        _mint(newOwner, 1_000_000_000 * (10 ** 18));

        marketingWallet = 0x89e717B06f3568A7BfC26fC24482663554C7FBA2;// Address to collect marketing taxes in BNB

        maxTxn = totalSupply() / 50; // 2% of total supply
        maxWallet = totalSupply() / 20; // 5% of total supply
    ...
    function _addOperator(address _operator) external onlyOwner{
