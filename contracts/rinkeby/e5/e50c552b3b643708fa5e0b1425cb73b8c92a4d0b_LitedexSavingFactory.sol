...
contract LitedexSaving is Ownable {
    ...
    address public SAVING_FACTORY;

    IBEP20 public BEP20Interface;
    ...
    function initialize(
        ...
        require(msg.sender == SAVING_FACTORY, "Not factory");
    ...
    function _payTo(
        ...
        BEP20Interface = IBEP20(tokenAddress);
        BEP20Interface.safeTransferFrom(allower, receiver, amount);
        return true;
    }

    function _payDirect(address to, uint256 amount) private returns (bool) {
        BEP20Interface = IBEP20(tokenAddress);
        BEP20Interface.safeTransfer(to, amount);
        return true;
    }
    ...
    modifier _hasAllowance(address allower, uint256 amount) {
        ...
        BEP20Interface = IBEP20(tokenAddress);
        uint256 ourAllowance = BEP20Interface.allowance(allower, address(this));
