...
contract KaijuLegends is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    function _validateMint(
        ...
        uint256 saleMaxMintPerTx,
        uint256 saleMaxMintPerWallet,
        bool saleIsActive
    ) private {
        require(
            saleIsActive,
        ...
        require(
            quantity_ > 0 && quantity_ <= saleMaxMintPerTx,
            "KaijuLegends: Reached max mint per tx"
        );
        require(
            (_numberMinted(_msgSender()) + quantity_) <= saleMaxMintPerWallet,
    ...
    function privateSaleMint(uint256 quantity_, bytes memory signature_)
        ...
        whenNotPaused
    {
        _validateMint(quantity_, privateSaleSupply, privateSaleMaxSupply, maxMintPerTx, maxMintPerWallet, privateSaleActive);
        ...
        onlyPartner
    {
        ...
        _validateMint(quantity_, partnerSupply, partnerMaxSupply, partnerMaxMintPerTx, partnerMaxMintPerWallet, partnerSaleActive);
