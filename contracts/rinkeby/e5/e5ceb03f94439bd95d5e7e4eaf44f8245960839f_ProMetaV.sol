...
contract ProMetaV is ERC20, Ownable {
    ...
    constructor(address _privateSaleAddress, address _adminAddress , address _teamAddress, address _devAddress, address _marketingAddress) ERC20("Prometav", "PMV") {
        ...
        // Team Supply
        _mint(_teamAddress, teamSupply);
        // Partners & Advisors Supply
        _mint(address(this), partnersSupply);
        // In Game Rewards
        _mint(_adminAddress, gameRewards);
        // Company Reserves Supply
        _mint(address(this), companyReserves);
        // Marketing Supply
        _mint(_marketingAddress, marketingSupply);
        // Development Supply
        _mint(_devAddress, developmentSupply);
        // Private Sale Supply
