...
contract Error404 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public saleWalletLimit = 20;
    ...
    constructor(
        ...
        string memory _tokenUrl) ERC721A ("Error 404", "ERR4"){
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0x523Bbdc1461aFa5d7d772D43e8a893DFacB1B77F).transfer(balance);
