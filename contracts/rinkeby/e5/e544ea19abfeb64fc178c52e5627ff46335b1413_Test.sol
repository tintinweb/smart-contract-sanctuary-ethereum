...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 100000000000000e18; //1 million total supply
    ...
    uint256 public devFee = 0; //0 means 0% will send to charity
    
    
    address devAddress = 0x051D680858a3a06760E512B895e699d087273dED; // dummy address
