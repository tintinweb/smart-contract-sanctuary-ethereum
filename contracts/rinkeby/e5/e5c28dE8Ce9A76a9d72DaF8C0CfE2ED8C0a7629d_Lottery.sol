...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    //represented by numbers, 0 = open etc
    ...
    function getEntranceFee() public view returns(uint256) {
        ...
        // 50 usd and 2000 per eth
        // 50/2000 is 50usd in eth
        // solidity cant do that because no decimals.
        // so we do 50*1000000000 /2000
        uint256 adjustedPrice = uint256(price) * 10**10; //ethusd price feed has 8 decimals, so we add 10 to make it 18
