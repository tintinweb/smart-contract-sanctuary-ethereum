...
contract Aftrmrkt is ERC1155, Ownable, VRFConsumerBase {
	...
	//Premium Pack Limit
    uint256 public PPEliteCardLimit = 345;
	uint256 public PPRareCardLimit = 345;
    uint256 public PPFreshCardLimit = 345;
    uint256 public PPCommonCardLimit = 690;
    ...
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmdnRRLGUAJDzgcKHTd4HPFT8gH9wPzR6gRxCSEQgBKy6q") VRFConsumerBase(VRFCoordinator, LinkToken) {
	{
            elite.add(4);
            supplyOf[4] = 50;
    ...
    function buyStarterPack(uint256 count) external payable {
        ...
        require(
            msg.value >= StarterPackFee.mul(count) || msg.sender == owner(),
	...
	function mintBrianNFT(address beneficiary) external onlyOwner {
	   require(!paused, "the contract is paused");
