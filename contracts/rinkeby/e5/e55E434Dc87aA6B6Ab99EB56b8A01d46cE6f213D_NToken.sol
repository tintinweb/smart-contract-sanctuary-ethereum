    ...
    INToken
{
    ...
    bool public individualTokenPricing;


    function isIndividualTokenPricing() public view returns (bool) {
        return individualTokenPricing;
    }
    ...
    function initialize(
        ...
        if (underlyingAsset == 0xC36442b4a4522E871399CD717aBDD847Ab11FE88) {
            individualTokenPricing = true;
        }
