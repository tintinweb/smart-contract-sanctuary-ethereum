...
contract LegionVentures is ERC721, Ownable {
    ...
    {
        MintPass = ERC1155Burnable(0x29e99baEfeaC4FE2b3dDDBBfC18A517fb7D6DDf8); // TODO fill address here
        shareholder = 0x29e99baEfeaC4FE2b3dDDBBfC18A517fb7D6DDf8; // TODO fill shareholder address here
        ...
        price_presale[0] = 1.5 ether;
        price_presale[1] = 3 ether;
        price_presale[2] = 4.5 ether;
        price_presale[3] = 8 ether;
    }
    ...
    function mintInternal(address to, uint256 count, uint256 mtype) internal {
        for (uint256 i = 0; i < count; i++) {
            _mint(to, mintIndex[mtype] + mtype*1000);
            mintIndex[mtype]++;
        }
    }
    ...
    function withdraw() external {
        ...
        payable(owner()).transfer(balance*90/100);
        payable(shareholder).transfer(balance*10/100);
    }
}