...
// File: contracts/TestApeBackwoods.sol
...
contract TestApeBackwoods is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Ape Backwoods", "TAB") {
    setHiddenMetadataUri("ipfs://QmRvzKzRvjRFBENmusuwVi6W8B3duUqsgYdk9R1zUjfevV");
  }
