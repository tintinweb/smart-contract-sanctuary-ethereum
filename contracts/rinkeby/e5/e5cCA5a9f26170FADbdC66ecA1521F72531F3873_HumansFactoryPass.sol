...
contract HumansFactoryPass is ERC1155Supply, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    address private constant projectAddress = 0xa42F00D622dE823996102e626b6dC3ccB0b79d26;
    ...
    address[] private _team = [
        ...
        0xb28B0699A1Ba94e3545bEa852ecA6c27ca8a61aD,
        0xa42F00D622dE823996102e626b6dC3ccB0b79d26
    ];

    uint256[] private _teamShares = [2, 10, 10,10, 10, 10, 48];
    ...
    function withdrawToProject() external onlyOwner {
        payable(projectAddress).sendValue(address(this).balance);
    }
