...
contract KeltenoNFT is ERC721Enumerable, PullPayment, Ownable, ReentrancyGuard {
    ...
    function claim() external nonReentrant  {
        ...
        IERC721(address(this)).transferFrom(address(this), msg.sender, airdrops[nextAirdropId]);
        nextAirdropId++;
    }
    ...
    */
    function transferNFT(address NFTAddress, address receiver, uint256 tokenid) external onlyOwner {
