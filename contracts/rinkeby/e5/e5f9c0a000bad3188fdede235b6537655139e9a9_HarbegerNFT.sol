...
contract ERC721Harbeger is ERC721CustomURIStorage, ERC165Storage {
    ...
    mapping (uint256 => address) internal _tokenOwner; // OVERRIDEN TO INTERNAL
 ...
 */
abstract contract ERC721CustomURIStorage is ERC721Custom {
...
contract ERC721Custom is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        require(ERC721Custom.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
        require(to != address(0), "ERC721: transfer to the zero address");
