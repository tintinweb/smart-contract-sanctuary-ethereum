...
contract Daydreamers is ERC721A, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (totalSupply() + _quantity == COLLECTION_SIZE) {
            setInitialMetadataSequenceIndex(block.number);
        }
     ...
     */
    function setInitialMetadataSequenceIndex(uint256 finalMintedTokenBlockNumber) private {
        initialMetadataSequenceIndex = uint256(blockhash(finalMintedTokenBlockNumber)) % COLLECTION_SIZE;
    }
