...
contract VimptoWorlds is Ownable, ERC721Enumerable, ReentrancyGuard, VerifySignature, Pausable {
    ...
    function mintWhitelist(MintPayload calldata _payload, bytes memory _signature) external payable nonReentrant whenNotPaused {
        ...
        require(!mintedInwhitelist[msg.sender], "Whitelist minting limit reached for this address");
