...
contract Musess is ERC721, Ownable {
    ...
    */
    function fixWhitelist(bool _state) external onlyOwner {
    ...
    */
    function claimNFT(bytes32[] calldata _merkleProof) external {
        require((token_id_counter.current() + 1) <= SOFT_CAP, "Hard cap reached");
        ...
        require(whitelisted && !minted_whitelist[msg.sender], "Not whitelisted or minted yet");
    ...
    */
    function buyNFT(bytes32[] calldata _merkleProof) external payable {
        ...
        require(
            canMint && msg.value % minting_price == 0 && msg.value > 0,
