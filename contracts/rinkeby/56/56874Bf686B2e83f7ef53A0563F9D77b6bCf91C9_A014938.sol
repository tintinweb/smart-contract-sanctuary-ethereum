...
contract A014938 is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MINT_COST = 0.019 ether;
    uint256 public MAX_SUPPLY = 10; //9999;
    uint256 public MAX_PUBLIC = 4; //4000;
    uint256 public MAX_PER_WLT = 5;
    uint256 public RESERVED_SUPPLY = 3; //1700;
    ...
    constructor() ERC721("A014938", "A014938") {}
    ...
    function presaleMint(
        ...
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender, rootType));
