...
contract NiftyCloneFactory is NiftyPermissions {
    ...
    function cloneERC721(address implementation, address niftyRegistryContract_, string calldata name_, string calldata symbol_) external {
        ...
        IERC721Cloneable(clone).initializeERC721(name_, symbol_);        
