...
contract Staking is Ownable {
    ...
    function createStake(uint256 _stake, StakingPeriod _stakePeriod) public {
        ...
        if(stakes[msg.sender].amount == 0) {
            ...
            stakes[msg.sender] = stake(_stake, _stakePeriod, block.timestamp);
    ...
    function stakingPeriodOf(address _stakeholder) public view returns (StakingPeriod) {
        return stakes[_stakeholder].stakePeriod;
    }
