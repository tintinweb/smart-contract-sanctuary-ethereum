...
contract NFT is ERC721A, ERC721AQueryable, Ownable, PaymentSplitter {
    ...
    uint public saleStartTime = 1659366000;
    ...
    address[] private _team = [
        0xA1bE81543239dFb2dd1f0c2CDAc7e2f238Ca3d5e
    ];
    ...
    constructor(bytes32 _merkleRoot, string memory _baseURI) ERC721A("NFT Alyra", "NFTAly") PaymentSplitter(_team, _teamShares) {
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable whenNotPaused {
        ...
        require(amountNFTperWalletWhitelistSale[msg.sender] + _quantity <= MAX_PER_ADDRESS_DURING_WHITELIST_MINT, "You can only mint 1 NFT during the Whitelist Sale");
