...
contract WhitelightNFT is ERC721AQueryable, BaseTokenURI {
  ...
  uint256 public distribution1funds = 700; // 70%
  uint256 public distribution2funds = 300; // 30%
  ...
  function mint(uint256 _mintAmount) external payable {
    ...
    distributeFunds(distribution1address, costNative, distribution1funds);
    distributeFunds(distribution2address, costNative, distribution2funds);
  }
  ...
  function distributeFunds(
    address to,
    uint256 costNative,
    uint256 percentageFunds
  ) private {
    (bool success, ) = address(to).call{value: (costNative * percentageFunds) / FEE_DENOMINATOR}("");
