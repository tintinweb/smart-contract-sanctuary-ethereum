...
contract Lottery {
    ...
    function endLottery() public onlyOwner{
        ...
        payable(recentWinner).transfer(totalMoney);
        delete players;
        status=Status.End;
    }

    function checkTotalMoney() public view returns(uint256){
        return totalMoney;
    }

    function checkPlayerNumber() public view returns(uint){
