...
import "./QBM.sol";
import "./QBMLootBox.sol";

contract QBMFactory is FactoryERC721, Ownable {
    ...
    constructor(address _proxyRegistryAddress, address _nftAddress) {
        ...
        lootBoxNftAddress = address(
            new QBMLootBox(_proxyRegistryAddress, address(this))
        );
    ...
    function mint(uint256 _optionId, address _toAddress) public override {
        ...
        QBM openSeaCreature = QBM(nftAddress);
        if (_optionId == SINGLE_CREATURE_OPTION) {
            ...
            QBMLootBox openSeaCreatureLootBox = QBMLootBox(
                lootBoxNftAddress
            );
...
/**
 * @title QBM
 * QBM - a contract for my non-fungible creatures.
 */
contract QBM is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("QBM", "OSC", _proxyRegistryAddress)
    {}
 ...
 * @title QBMLootBox
 *
 * QBMLootBox - a tradeable loot box of Creatures.
 */
contract QBMLootBox is ERC721Tradable {
    uint256 NUM_CREATURES_PER_BOX = 3;
    uint256 OPTION_ID = 0;
    address factoryAddress;

    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("QBMLootBox", "LOOTBOX", _proxyRegistryAddress)
    {
