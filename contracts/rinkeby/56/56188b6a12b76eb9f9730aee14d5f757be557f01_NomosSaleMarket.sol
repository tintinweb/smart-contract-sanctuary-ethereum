...
contract NomosSaleMarket is ERC1155Holder {
    ...
    function sellNft(
        ...
        sellNft(saleId, tokenId, priceInWei, collectionContract, 1);
    }
    ...
    function buyNft(string memory saleId, uint256 amount) public payable {
        ...
        /* solium-disable */
        (bool success, ) = sales[saleId].seller.call{value: sales[saleId].priceInWei * amount}("");
    ...
    function buyNftWithToken (string memory saleId) public {
        ...
        erc20.transferFrom(msg.sender, sales[saleId].seller, sales[saleId].priceInWei);
