...
contract SongBitsTreasury is OwnableUpgradeable, IMetadata {
    ...
    function buy(
        ...
        require(calculatedCost == _amount, "insufficient funds");
        require(
        ...
        _takeMoneyFromSender(currency, msg.sender, _amount);

        _revenuePrimatySale(payable(metadata.artist), _amount);

        emit Buy(msg.sender, _metadataId, _amount, _bits);
    }
