...
contract BabyLander is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 maxSupply, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("BabyLander", "BabyLander") {
        PRICE = 0.025 ether;
