...
contract PartyPanda2 is ERC4883Composer, Colours, ERC721Holder {
    ...
    constructor()
        ERC4883Composer("Party Panda 2.0", "PP2", 0.000888 ether, 0x77737a65C296012C67F8c7f656d1Df81827c9541, 175, 4883)
    {}
    ...
    function _generateSVGBody(uint256 tokenId) internal view virtual override returns (string memory) {
        ...
        return string.concat(
            ...
            '<g stroke="black" stroke-width="11" stroke-linecap="round" stroke-linejoin="round">' '<g fill="',
            colourValue,
            '">'
    ...
    function _generatePartyValue(uint256 tokenId) internal view returns (string memory) {
        ...
        return Strings.toString((party % 100));
    }
