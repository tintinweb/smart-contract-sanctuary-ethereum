    ...
    Ownable
{
    ...
    */
    constructor(
        ...
        address _signer
    ) ERC721Base(_name, _symbol, _contractURI, baseURI_) {
        signer = _signer;
    ...
    function mint(
        ...
        require(
            keccak256(abi.encodePacked(address(this), _tokenId, msg.sender)).toEthSignedMessageHash().recover(_signature) == signer,
            "IkonicERC721Token.mint: Invalid signature"
        );
        _mint(msg.sender, _tokenId, royaltyRecipient, royaltyValue);
    ...
    function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC721Base, ERC721, IERC165, ERC721Enumerable) returns (bool) {
    ...
    ERC2981PerTokenRoyalties
{
    ...
    function _mint(
        ...
        require(_royaltyValue <= 10000, "Royalty value should not exceed 10000");
        require(_royaltyRecipient != address(0x0), "Royalty recipient should be present");
        require(_royaltyValue != 0, "Royalty value should be positive");
