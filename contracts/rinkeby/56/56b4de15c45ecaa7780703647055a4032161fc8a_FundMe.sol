...
contract FundMe {
    ...
    // State variables
    mapping(address => uint256) private s_addressToAmountFunded; // s_ stands for storage value
    address[] private s_funders;
    // Could we make this constant?  /* hint: no! We should make it immutable! */
    address private /* immutable */ i_owner; // i_ stands for immutable variable
    ...
    */
    ...
    function cheaperWithdraw() public payable onlyOwner {
        ...
        // mapping can't be saved in memoru
