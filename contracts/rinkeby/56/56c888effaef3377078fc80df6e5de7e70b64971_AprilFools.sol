...
contract AprilFools is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQbkosqitpvigvaGAo6rYKcXyzSzvwUiSoPQSZSZ77Auh";
    ...
    constructor(
    ) ERC721A("April Fools", "AF", 100, maxSupply) {
    }
