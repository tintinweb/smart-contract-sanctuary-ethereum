...
// File: contracts/collection.sol
    ...
    contract SampleContract is Ownable, ERC721A {
        ...
        function setMaxPublic(uint256 _maxSupply) public onlyOwner {
            maxPublic = _maxSupply;
        }

        function setMaxTeamSupply(uint256 _teamSupply) public onlyOwner {
        ...
        function reserveMint(address[] calldata _to, uint256 quantity) public onlyOwner{
            require(
            ...
            payable
        {
            ...
            if(_publicsaleMintCounter[msg.sender] + quantity > maxFreeMintAmount) {
