...
library Traits {
    ...
    function getTokenURI(Dungeon.RaidInventory memory _inventory, uint256 tokenId) external pure returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "Loot is randomized adventurer gear generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Loot in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '","attributes": [{"trait_type": "Shirt", "value": _inventory.shirt.name},{"trait_type": "Pants", "value": _inventory.pants.name},{"trait_type": "Head", "value": _inventory.head.name},{"trait_type": "Feet", "value": _inventory.feet.name},{"trait_type": "Chest", "value": _inventory.chest.name},{"trait_type": "Shoulders", "value": _inventory.shoulders.name},{"trait_type": "Ring", "value": _inventory.mainhand.name},{"trait_type": "Head", "value": _inventory.offhand.name},{"trait_type": "Head", "value": _inventory.artifact.name},{"trait_type": "Soul Score", "value": "0"}]}'))));
