...
contract StakingRewards {
    ...
    function averageUnlockTime(address addr) public view returns (uint256) {
        uint256 time = 0;
        ...
        return time / balances[addr];
    }

    function averageAPR(address addr) public view returns (uint256) {
        uint256 apr = 0;
        ...
        return (apr * 100 / balances[addr]) / 100;
    }
