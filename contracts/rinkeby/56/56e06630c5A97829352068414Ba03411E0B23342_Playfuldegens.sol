...
contract Playfuldegens is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(string memory _baseNFTURI) ERC721A("PlayfulDegens Test NFT", "DEGEN", MAX_MINT_SIZE, MAX_MINTS) {
    ...
    function claimPreSaleToken(uint256 numberOfTokens) public payable nonReentrant {
