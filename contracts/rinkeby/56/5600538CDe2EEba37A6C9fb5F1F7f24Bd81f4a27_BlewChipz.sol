...
contract BlewChipz is ERC721, ERC721Enumerable, Pausable, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 _amount) public nonReentrant {
        ...
        require(mintedBlewChips + _amount <= maxSupply);
    ...
    // update maxMints after certain time has passed to allow people more than 2
