...
// File: contracts/MillionTokenParcel.sol
...
contract MillionTokenParcel is ERC721, ERC721Enumerable {
...
// File: contracts/MillionTokenMarketplace.sol


pragma solidity ^0.8.0;


contract MillionTokenMarketplace {
  uint count;
  uint public offerCount;
  mapping (uint => _Offer) public offers;
  mapping (address => uint) public userFunds;
  mapping(uint => Seller) public sellers;
  MillionTokenParcel nftCollection;
  ...
  constructor(address _nftCollection) {
    nftCollection = MillionTokenParcel(_nftCollection);
  }
