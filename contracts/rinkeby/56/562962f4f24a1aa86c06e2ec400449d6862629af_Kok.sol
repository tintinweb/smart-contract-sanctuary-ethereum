...
contract Kok is ERC1155Pausable, Ownable {
    ...
    uint256 public constant DEFAULT_NFT_PRICE = 0.001 * 1 ether;
    ...
    uint256 public constant DEFAULT_INITIAL_PUBLIC_SALE = 1 minutes;
    uint256 public constant DEFAULT_PIXELMINT_SALE =  1 minutes;
    uint256 public constant DEFAULT_PILLMINT_SALE = 1 minutes;
    uint256 public constant DEFAULT_TEAMMINT_SALE = 1 minutes;
    ...
    event UpdatedSaleStartTime(uint256 saleStartTime, address updatedBy);
      address platformAddress = msg.sender;       
              address platformMintingAddress = msg.sender;
    uint256 public saleStartTime = block.timestamp;
//    string memory newURI = "https://protected-oasis-25936.herokuapp.com/nft/{id}.json";
    ...
    constructor(
        ...
        string memory newURI = "https://protected-oasis-25936.herokuapp.com/nft/{id}.json";
        defaultSaleStartTime = saleStartTime;
        defaultPlatformAddress = payable(0xeB2B7dbf1D37B1495f855aCb2d251Fa68e1202ce);
