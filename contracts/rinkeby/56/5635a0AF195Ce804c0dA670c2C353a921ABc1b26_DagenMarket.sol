...
contract DagenMarket is ReentrancyGuard, Ownable, ERC1155Holder {
  ...
  function removeMarketItem(IERC1155 nftContract, uint256 itemId) public payable nonReentrant {
  ...
  function adjustPrice(uint256 itemId, uint256 price) public payable nonReentrant {
  ...
  /**
   * @notice View on sale market items
   */
  ...
  /**
   * @notice View on sale market items with pagination
   * @param cursor: cursor
