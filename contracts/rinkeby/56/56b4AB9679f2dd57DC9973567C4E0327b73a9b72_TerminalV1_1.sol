...
import './abstract/DaliProject.sol';
  ...
  */
  ...
  function _takeFee(
    ...
    if (terminalDirectory.terminalOf(1) == this) {
      ...
      _terminal.pay{value: feeAmount}(feeProjectId, _beneficiary, _memo, false);
    }
  }
...
/** 
  @notice A contract that inherits from DaliProject can use Dali as a business-model-as-a-service.
...
*/
abstract contract DaliProject is IERC721Receiver, Ownable {
    ...
    */
    function pay(
        ...
        require(projectId != 0, "DaliProject::pay: PROJECT_NOT_FOUND");
        ...
        require(
            ...
            "DaliProject::pay: TERMINAL_NOT_FOUND"
        );
    ...
    */
    function _takeFee(
        ...
        require(projectId != 0, "DaliProject::takeFee: PROJECT_NOT_FOUND");
        ...
        require(
            _terminal != ITerminal(address(0)),
            "DaliProject::takeFee: TERMINAL_NOT_FOUND"
        );

        // There must be enough funds in the contract to take the fee.
        require(
            address(this).balance >= _amount,
            "DaliProject::takeFee: INSUFFICIENT_FUNDS"
        );
