...
contract CryptoBonsai is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("BONSAI TEST GARDEN GARDEN", "BNSI") Ownable() {}
    ...
    string[39] private allColors = ["#EAFB00","#F0CF61","#0E38B1","#EF3E4A","#FEDAC2","#B0D8DC","#B6CAC0","#C02A1B","#1FC8A9","#C886A2","#F9BDBD","#FEDCCC","#EBB9D4","#F2CB6C","#FF8FA4","#343B3F","#FF89B5","#D1BDFF","#9A008A","#7B76A6","#FB5408","#0B64FE","#FAAD58","#FF8B8B","#F2F2F2","#FFD3C2","#FDB90B","#FCA59B","#CDCDD0","#EEE9DC","#CDB670","#B3E0E0","#5C457B","#FDFF50","#FFCC4C","#19AAD1","#7A30CF","#189BA3","#EF303B"];
    ...
    function getTraits(cryptoBonsai memory bonsai) internal view returns (string memory) {
        ...
        parts[19] = '"}, {"trait_type": "Accessories","value": "';
        parts[20] = potAccessoriesNames[bonsai.potAccessories];
        parts[21] = '"}] ';
        ...
        string memory output = string(abi.encodePacked(parts[0], parts[1], parts[2], parts[3], parts[4], parts[5], parts[6], parts[7], parts[8]));
                      ...
                      output = string(abi.encodePacked(output, parts[16], parts[17], parts[18], parts[19], parts[20], parts[21]));
        return output;
    }
    ...
    function getAColor(uint256 tokenId, string memory seed) internal view returns (uint256) {
        return getNum(tokenId, seed, 0, 37);
    }
    ...
    function getAccessories(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 96 && gt <= 98) { Accessories = 8; }
        if (gt > 99 && gt <= 100) { Accessories = 9; }
    ...
    function whitelistInfoFor(address _addr) public view returns (bool isWhiteListed, uint256 numHasMinted) {
