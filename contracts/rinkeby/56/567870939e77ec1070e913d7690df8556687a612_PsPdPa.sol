...
contract PsPdPa is ERC721A, Owneable {

    string public baseURI = "";
    string public contractURI = "";
    string public constant baseExtension = "";
    address public constant proxyRegistryAddress = 0x00000000006c3852cbEf3e08E8dF289169EdE581;

    uint256 public constant MAX_PER_TX_FREE = 1;
    uint256 public FREE_MAX_SUPPLY = 1;
    uint256 public constant MAX_PER_TX = 5000;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public price = 0.001 ether;

    bool public paused = true;

    constructor() ERC721A("PsPdPa", "PPP") {}
