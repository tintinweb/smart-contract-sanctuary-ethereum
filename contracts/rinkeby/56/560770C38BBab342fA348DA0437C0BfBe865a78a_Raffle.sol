...
contract Raffle is KeeperCompatibleInterface, VRFConsumerBaseV2 {
    /* Lottery Variables */
    enum RaffleState {
        OPEN,
        CALCULATING
        ...
        )
    {
        ...
        bool enoughMoney = (address(this).balance > 0);
        upkeepNeeded = (timePassed && enoughPlayers && enoughMoney && isOpen);
    ...
    function fulfillRandomWords(
        ...
        address randomWinner = s_players[indexOfWinner];
        s_lastWinner = randomWinner;
        s_raffleState = RaffleState.OPEN;
