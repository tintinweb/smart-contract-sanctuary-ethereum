...
contract projectP22 is ERC1155, Ownable, IERC721Receiver, VRFConsumerBaseV2 {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        require(linkRequest.gId > 0, "Golden ticket not found");
        require(activeGoldenTickets[linkRequest.gId], "Golden ticket not active");
        require(balanceOf(linkRequest.userAddress, linkRequest.gId) > 0, "Don't have any ticket in user's account");
        ...
        _burn(linkRequest.userAddress, linkRequest.gId, 1);
    }
    ...
    function RedeemGoldenTicket(uint32 gId) external {
        require(activeGoldenTickets[gId], "Golden ticket not active");
        require(balanceOf(msg.sender, gId) > 0, "You don't have any ticket in your account");
