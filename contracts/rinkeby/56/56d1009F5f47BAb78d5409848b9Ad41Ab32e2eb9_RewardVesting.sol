...
contract RewardVesting is Ownable, ERC1155Receiver, IRewardVesting {
        ...
        onlyStakingcontract
    {
        if (rewardsInfo[account].isIntialized) {
            ...
            rewardsInfo[account] = Reward(false, 0, tokenAmount, 0, true);
        }
    }
    ...
    function depositHeros() external {
        require(
        ...
        if (rewardsInfo[msg.sender].isIntialized) {
            ...
            rewardsInfo[msg.sender] = Reward(true, 0, 0, block.timestamp, true);
        }
        heroAddress.safeTransferFrom(msg.sender, address(this), 1, 1, "");
    }
    ...
    function withDrawHeros() external {
        ...
        heroAddress.safeTransferFrom(address(this), msg.sender, 1, 1, "");
    }
