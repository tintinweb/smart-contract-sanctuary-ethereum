...
import {iNVerse20} from "./iNVerse20.sol";

contract NVerse20 is ERC20, Ownable, iNVerse20 {
    ...
    constructor(
        ...
        require(_cap > _premintAmount, "NVRS: Premint amount is greater than cap");
