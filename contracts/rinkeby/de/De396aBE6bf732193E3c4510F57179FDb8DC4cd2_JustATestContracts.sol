...
contract JustATestContracts is ERC721A, Ownable, ReentrancyGuard {
  ...
  // hidden Uri
  string public hiddenMetadataUri = "ipfs://QmdT5Vjq3dViRhYK4dxfR2qECbHnTHgcTcZJxLCFuiDx4E/hidden.json";
  ...
  modifier WLmintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= WLmaxLimitPerWallet, "Max mint 1 per WL wallet exceeded!");
    _;
  }
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid mint amount!');
    require(totalSupply() + _mintAmount <= maxSupply, 'Max supply exceeded!');
    require(balanceOf(msg.sender) + _mintAmount <= maxLimitPerWallet, "Max mint 2 per Public wallet exceeded! Or WhiteListed trying to be greedy ");
    _;
  }
