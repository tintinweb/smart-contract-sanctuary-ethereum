...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new AnathaNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AnathaNFTUser1155Token token = AnathaNFTUser1155Token(address(addr));
...
contract AnathaNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
