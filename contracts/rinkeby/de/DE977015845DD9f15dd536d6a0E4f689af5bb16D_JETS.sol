...
contract JETS is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable {
    ...
    string private constant _name = 'HARMONY JETS';
    ...
    function initialize() initializer public {
        __ERC1155_init("https://nft.harmony-jets.com/api/collection/v1");
        __Ownable_init();
        __Pausable_init();
