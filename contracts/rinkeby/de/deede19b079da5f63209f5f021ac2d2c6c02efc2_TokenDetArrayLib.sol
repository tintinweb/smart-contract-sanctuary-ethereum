...
contract BrokerV2 is ERC721Holder, BrokerModifiers {
    ...
    constructor(
        ...
        address payable _rewardDistributionAddress,
        ...
        erc20Allowed(_erc20Token)
    {
        ...
        // Calculate the funds and transfer
        {
            ...
            if (!isNotClubare) {
                ...
                royality = (royalities * _offer.amount) / 10000;
            }

            // uint256 brokerageAmount = (brokerage * _offer.amount) / 10000;
            uint256 brokerage1_Amount = (rewardDistributionPercentage *
                _offer.amount) / 10000;
            uint256 brokerage2_Amount = (platFormFeePercentage *
                _offer.amount) / 10000;
    ...
    function collect(
        ...
        if (!isNotClubare) {
            royalities = Token.royalities(tokenID);
            creator = Token.creators(tokenID);
            royality = (royalities * _auction.currentBid) / 10000;
        }
        ...
        flatSaleOnly(tokenID, _mintableToken)
    {
        ...
        if (!isNotClubare) {
            royalities = Token.royalities(tokenID);
            creator = Token.creators(tokenID);
            royality = (royalities * _auction.buyPrice) / 10000;
        }
