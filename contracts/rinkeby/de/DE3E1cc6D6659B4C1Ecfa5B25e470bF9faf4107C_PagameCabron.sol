...
contract PagameCabron {
    ...
    AggregatorV3Interface public pillaprecio;

    constructor(address _direccionObtenerPrecios) public {
        // la funcion Constructor se llama justo en el momento en el que el contrato es desplegado
        // aqui definimos el owner
        // y también pasamos al constructor la direccion de donde obtenemos precios (desde script deploy)
        pillaprecio = AggregatorV3Interface(_direccionObtenerPrecios);
    ...
    function pillaputoprecio() public view returns (uint256) {
        ...
        (, int256 puneteroprecio, , , ) = pillaprecio.latestRoundData();
