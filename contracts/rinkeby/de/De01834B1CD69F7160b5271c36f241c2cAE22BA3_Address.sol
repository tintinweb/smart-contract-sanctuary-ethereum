...
contract savingoil is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("saving oil", "so") {
    setHiddenMetadataUri("ipfs://QmYwShMYPiJmSrV5da5rDWFwajtCBbWfbnjEuiJqmKSQD/hidden.json");
  }
