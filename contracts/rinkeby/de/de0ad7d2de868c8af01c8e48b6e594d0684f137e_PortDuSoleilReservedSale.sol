...
contract PortDuSoleilReservedSale is Ownable, ERC721A, ReentrancyGuard {
  ...
  function setPDSAddress (address PDSAddressInput) external onlyOwner {
      PDSAddress = PDSAddressInput;
  }
...
//edit this to split funds with PDS
  ...
  function tradeToBuy(address from, uint256 tokenId) public {
