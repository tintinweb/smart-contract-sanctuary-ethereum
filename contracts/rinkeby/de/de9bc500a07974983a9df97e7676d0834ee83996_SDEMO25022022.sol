...
contract SDEMO25022022 is ERC721ABurnable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxSupply = 50; // Max amount of NFTs that can be minted in total
    ...
    uint256 public nftPerAddressLimit = 3; // Maximum NFTs mintable on one wallet
