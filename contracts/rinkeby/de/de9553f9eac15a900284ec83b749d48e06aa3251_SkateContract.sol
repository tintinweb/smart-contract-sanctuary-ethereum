    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint16 public auctionPeriodBlocks;
    ...
    mapping(address => uint256) public overbidBidsBalance;
    ...
    function initialize(
        ...
        __ERC721_init("Skate or DAO", "GNAR");
    ...
    function createBid(
        ...
        if (lastBidder != address(0)) {
            overbidBidsBalance[lastBidder] += _auction.amount;
        }
    ...
    function withdrawOverbidBids() external {
        require(
            _safeTransferETH(msg.sender, overbidBidsBalance[msg.sender]),
            "ETH transfer failed"
        );
        overbidBidsBalance[msg.sender] = 0;
    }
}
