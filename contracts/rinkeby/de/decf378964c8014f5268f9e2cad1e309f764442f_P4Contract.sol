...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x434C0a5C7bFD254126f67b8292141a578055dAc9];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQhgjUwtt29VQ8a1JZ6m4okz5cSjdEYaxom7nVUtREbWP/";
...
// File: contracts/P4Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract P4Contract is RamppERC721A {
    constructor() RamppERC721A("p4", "p8"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/7qVeanU365ukkMvlSfxe/contract-metadata";
    }
}
