...
contract WedreamEscrow is BidValidator, IERC721Receiver, Ownable {
     ...
     * - TODO
     *
     * @param acceptedBidSignature id in the token registry.
...
library LibBid {
    bytes32 private constant BID_TYPE =
        keccak256(
            "Bid(address winnerWallet,address tokenContract,uint256 tokenIdentifier,uint256 tokenRegistryId,uing256 amount)"
        );
