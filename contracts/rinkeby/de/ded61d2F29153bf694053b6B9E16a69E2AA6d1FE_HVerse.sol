...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    ...
    buildings.push(Building("House1",30,30,100,0,0,0));
    buildings.push(Building("House2",10,10,100,0,30,0));
    buildings.push(Building("House3",40,60,90,0,60,0));
    buildings.push(Building("House4",30,60,80,0,100,0));
