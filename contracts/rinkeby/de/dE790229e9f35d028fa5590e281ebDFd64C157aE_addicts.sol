...
contract addicts is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Addicts NFT", "TAN") {
    setHiddenMetadataUri("ipfs://QmSgKmBHSWypVzf69KmtfVVFqeoVHSKtiA9R4pdqNvVFM3/1.json");
  }
...
//EVENTUELL GIBS HIER PROBLEME wegen i = bla bla
    else {
...
//            require(ownerMintedCount + _mintAmount <= nftPerAddressLimitpre, "max NFT per address exceeded");
//        }
//        require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "max NFT per address exceeded");
//        require(msg.value >= cost * _mintAmount, "insufficient funds");
//    }
...
function _beforeTokenTransfer(
  ...
  function withdraw() public onlyOwner {
    // ETHER SPLITTER
    // =============================================================================
    (bool hs, ) = payable(0x2a03808240b1c967F89c38F4444616d4BFD9369a).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
    // =============================================================================
