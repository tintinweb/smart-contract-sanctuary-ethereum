...
contract DevWallet is AccessControlEnumerable {
    ...
    constructor (address _paymentToken, address[] memory founders, address devMultiSigWallet) {
        ...
        // Initial cap table
        createInitialFounder(founders[0], 1500); // Dan 15%
        createInitialFounder(founders[1], 1500); // Sarah 15%
        createInitialFounder(founders[2], 1500); // Chris 15%
        createInitialFounder(founders[3], 500); // John 5%
        createInitialFounder(founders[4], 2000); // Joe 20%
        createInitialFounder(founders[5], 3000); // Phil 30%
    }
