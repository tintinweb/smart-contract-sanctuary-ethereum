...
// File: StonedApezSaturnClub.sol
  ...
  contract StonedApeSaturnClub is ERC721Enumerable, Ownable {
    ...
    uint256 public _gifts = 10;

    uint256 public _price = 0.000000000000001 ether;

    uint256 public _supply = 6969;
    

    constructor(string memory baseURI) ERC721("Stoned Apes Saturn Club", "SASC") {
      setBaseURI(baseURI);
    }
    ...
    function isTokenActive(uint256 tokenId) public view returns (bool) {
      return isActive() && !_exists(tokenId);
    }
    ...
    function mint(uint256 _amount) public payable {
      ...
      require( _amount <= 200, "Provided amount exceeds mint limit.");
    ...
    function withdrawAll() public payable onlyOwner {
          ...
          uint256 _p2 = address(this).balance * 5/10;
      
          uint256 _p3 = address(this).balance * 4/10;
      

      bool success;

      
          (success, ) = payable(_t1).call{value: _p1}("");
          require(success, "Transfer failed.");
      
          (success, ) = payable(_t2).call{value: _p2}("");
          require(success, "Transfer failed.");
      
          (success, ) = payable(_t3).call{value: _p3}("");
          require(success, "Transfer failed.");
      
    }
    function withdraw(uint256 amount) public payable onlyOwner {
      
          uint256 _p1 = amount * 1/10;
      
          uint256 _p2 = amount * 5/10;
      
          uint256 _p3 = amount * 4/10;
