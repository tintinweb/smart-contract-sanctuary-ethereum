...
// File: contracts/Cute_Animal.sol
...
contract CuteAnimal is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cute Animal", "CA") {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    uint256 supplyy = supply.current();
    require(!paused, "The contract is paused!");
    require(msg.value >= needToUpdateCost(supplyy) * _mintAmount, "Insufficient funds!");
