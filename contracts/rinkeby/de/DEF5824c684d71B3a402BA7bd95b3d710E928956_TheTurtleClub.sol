...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract TheTurtleClub  is ERC721Enumerable,  Ownable {
    using Strings for uint256;
  ...
  uint8 public maxWLMintAmountPerOGWallet = 1; 
  ...
  bytes32 public whitelistMerkleRoot = 0xc3956b3de158d0d464960312844be3dfe476f517cdf23ecc13430627a7d8d8c7;
   bytes32 public OGMerkleRoot = 0xc3956b3de158d0d464960312844be3dfe476f517cdf23ecc13430627a7d8d8c7;

  constructor() ERC721("The Turtle Club", "TTC") {
 ...
 function setMaxTxPerOGAddress(uint8 _limit) external onlyOwner{
    maxWLMintAmountPerOGWallet = _limit;
   delete _limit;
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
    ...
    function OGMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
       ...
       require(_verify(leafnode ,   merkleProof , OGMerkleRoot  ),  "Invalid merkle proof");
       require (nftPerOGAddress[msg.sender] + _mintAmount <= maxWLMintAmountPerWallet, "Exceeds max tx per address");
      


    require(!OGpaused, "Whitelist minting is over!");
    require(msg.value == whiteListCost * _mintAmount, "Insufficient funds!");
    ...
    _mint(msg.sender , totalSupply + i);
      ...
      nftPerOGAddress[msg.sender] += _mintAmount;
      delete totalSupply;
      delete _mintAmount;
