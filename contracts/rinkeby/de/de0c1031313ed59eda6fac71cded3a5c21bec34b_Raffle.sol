...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function fulfillRandomWords(
        ...
        uint256[] memory randomWords // array of length NUM_WORDS. Contains Random Words // overrides the function of abstract class // will only be called internally, by VRFConsumerBaseV2
    ) 
    internal 
    override 
    {
