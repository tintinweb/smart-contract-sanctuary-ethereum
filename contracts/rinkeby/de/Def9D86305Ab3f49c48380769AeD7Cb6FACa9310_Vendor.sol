...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    uint256 amount_to_send = msg.value * tokensPerEth;
    require(amount_to_send > 0, "Send some ETH to buy tokens");
    yourToken.transfer(msg.sender, amount_to_send);
    emit BuyTokens(msg.sender, msg.value, amount_to_send);
...
contract YourToken is ERC20 {
    constructor() ERC20("Gold", "GLD") {
        //address frontEnd = address(0xe22e6582C252165759F3b5B0ebf6999126DFEB3C);
