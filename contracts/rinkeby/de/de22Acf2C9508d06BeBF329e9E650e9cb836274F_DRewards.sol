...
contract DRewards is Ownable, ChainlinkClient, VRFConsumerBaseV2 {
	...
	* @TODO: double request issue.
	*/
	function requestProofFromNode(string memory tweetID)
		public
		onlyOwner
	  	onlyContestStateGE(tweetID, EContestState.CONTEST_RANDOM_REQUESTED)
   	{
	...
	*/
		...
		onlyContestState(tweetID, EContestState.CONTEST_CREATED)
	{
		...
		contest[tweetID].contestState = EContestState.CONTEST_RANDOM_REQUESTED; // on chain.
