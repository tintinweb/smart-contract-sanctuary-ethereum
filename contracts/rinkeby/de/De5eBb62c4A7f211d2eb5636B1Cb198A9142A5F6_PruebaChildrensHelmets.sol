...
contract PruebaChildrensHelmets is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Prueba Childrens Helmets", "PCH") {
    setHiddenMetadataUri("ipfs://QmQvPqm3y6nJak8q1qD8JL5RbP9KeRDRweWrB6MFFbaz2n/hidden.json");
  }
