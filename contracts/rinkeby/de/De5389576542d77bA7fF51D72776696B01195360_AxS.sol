...
contract AxS is ERC721A, Ownable {
    uint256 public constant maxMintSupply = 8000;
    uint256 private mintPrice; // = 0.08 ether;
    uint256 private refundPeriod; // = 45 days;
    
    //Wallets
    address public AxSDAOWallet = 0xF23708f8f77Bb12607a70223658f6f449b3861d2;
    address public AxSCommunityWallet = 0xF23708f8f77Bb12607a70223658f6f449b3861d2;
    address public AxSCharityWallet = 0xF23708f8f77Bb12607a70223658f6f449b3861d2;
    address public AxSFounderWallet = 0xF23708f8f77Bb12607a70223658f6f449b3861d2;
    ...
    (
        uint256 __mintPrice,
        //uint256 __royaltyFee,
        //address __royAltyAddress,
        uint256 __refundPeriod,
        bytes32 __merkleRoot,
        string memory __baseURI,
        string memory __unrevealedURI,
        bool __presaleActive,
        bool __publicSaleActive
    ) 
    external
    onlyOwner 
    {
        mintPrice = __mintPrice;
        refundPeriod = __refundPeriod;
        refundAddress = msg.sender;
        merkleRoot = __merkleRoot;
        baseURI = __baseURI;
        unrevealedURI = __unrevealedURI;
        presaleActive = __presaleActive;
        publicSaleActive = __publicSaleActive;
    }
    ...
    function isWhiteListed(address owner, bytes32[] calldata proof) public view returns (bool) {
         return (_isAllowlisted(owner, proof, merkleRoot));
    }
...
*/
    ...
    function getMintInformation(bytes32[] calldata proof) public view returns (string memory) {
        string memory data = string(abi.encodePacked(
            "{",
               "\"isWhiteListed\":", _isAllowlisted(msg.sender, proof, merkleRoot) ? "true" : "false", ",",
                "\"presaleActive\":", presaleActive ? "true" : "false", ",",
                "\"publicSaleActive\":", publicSaleActive ? "true" : "false", ",",
                "\"balanceOf\":", Strings.toString(balanceOf(msg.sender)), ",",
                "\"maxUserMintAmount\":", Strings.toString(maxUserMintAmount), ",",
                "\"mintPrice\":", Strings.toString(mintPrice), ",",
                "\"maxMintSupply\":", Strings.toString(maxMintSupply), ",",
