...
//                                      //
//          PepeLottery                 //
//      POOR_PEPE - 1 ENTRY / NFT       //
//      NORMAL_PEPE - 5 ENTRY / NFT     //
//      RICH_PEPE - 12 ENTRY / NFT      //
//                                      //
//                                      //
//////////////////////////////////////////
...
contract PepeLottery is ERC1155, Ownable, VRFv2Consumer {
    ...
    uint256 public RP_PRICE = .015 ether;
    ...
    modifier checkSale(address sender, uint256 quantity) {
        require(tx.origin == sender, "No smart contracts");
        require(saleLive, "Sale is not live");
        require(!hasMinted[sender], "Address has already entered");
        require(quantity <= 15, "Exceeds max mint");
        _;
    }
...
//npx hardhat verify --network rinkeby 0xdeA7A375e10876258E2cCcFcE40657fF8E9233bf 4437 "0x6168499c0cffcacd319c818142124b7a15e857ab" "0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc"
