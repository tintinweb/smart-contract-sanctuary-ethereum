...
contract BoredApe is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    string public notRevealedUri =
        "https://zumbalabstest123123.mypinata.cloud/ipfs/QmY9GtVvos2HCJmoS3DNoY8SkodsC5CQM82ZpJRekyPKzh";
    ...
    address[] private _team = [
        0x45E3Ca56946e0ee4bf36e893CC4fbb96A1523212, // Admin Account gets 25% of the total revenue
        0x81726B547537b7f9F7322a590574681AA43E283C // Test Account gets 35% of the total revenue
    ];
        ...
        returns (string memory)
    {
        ...
        if (revealed == false) return getURI(notRevealedUri, tokenId);

        string memory currentBaseURI = _baseURI();
        return getURI(currentBaseURI, tokenId);
    }
