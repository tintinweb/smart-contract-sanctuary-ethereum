...
contract YunoMetaNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 private MAX_NFT_TYPES = 50;
  uint256 private MAX_LOOTBOX_TYPES = 25;
  uint256 private MAX_NFT_URI_GROUPS = 25;
  ...
  // 2 = Public Mint
    ...
    uint256 public Type1_metaFileId;
    uint256 public Type1_maxSupply; 
    uint256 public Type1_totalMinted; 
    uint256 public Type1_totalRevealedCount;
    uint256 public Type1_NFTSellingPrice;

    uint256 public Type2_metaFileId;
    uint256 public Type2_maxSupply; 
    uint256 public Type2_totalMinted; 
    uint256 public Type2_totalRevealedCount; 
    uint256 public Type2_NFTSellingPrice;

    uint256 public Type3_metaFileId;
    uint256 public Type3_maxSupply; 
    uint256 public Type3_totalMinted; 
    uint256 public Type3_totalRevealedCount; 
    uint256 public Type3_NFTSellingPrice;

    uint256 public Type4_metaFileId;
    uint256 public Type4_maxSupply; 
    uint256 public Type4_totalMinted; 
    uint256 public Type4_totalRevealedCount; 
    uint256 public Type4_NFTSellingPrice;

    uint256 public Type5_metaFileId;
    uint256 public Type5_maxSupply; 
    uint256 public Type5_totalMinted; 
    uint256 public Type5_totalRevealedCount; 
    uint256 public Type5_NFTSellingPrice;

    uint256 public Type6_metaFileId;
    uint256 public Type6_maxSupply; 
    uint256 public Type6_totalMinted; 
    uint256 public Type6_totalRevealedCount; 
    uint256 public Type6_NFTSellingPrice;


    uint256 public Type7_metaFileId;
    uint256 public Type7_maxSupply; 
    uint256 public Type7_totalMinted; 
    uint256 public Type7_totalRevealedCount; 
    uint256 public Type7_NFTSellingPrice;

    string public Type7_metaDataURI_Hidden;
    string public Type6_metaDataURI_Hidden;
    string public Type5_metaDataURI_Hidden;
    string public Type4_metaDataURI_Hidden;
    string public Type3_metaDataURI_Hidden;
    string public Type1_metaDataURI_Hidden;
    string public Type2_metaDataURI_Hidden;
  ...
  function initSmartContract() internal {
    ...
    Type1_metaFileId = 10000;
    Type1_maxSupply = 10;
    Type1_totalMinted = 0;
    Type1_totalRevealedCount = 10;
    Type1_NFTSellingPrice = 0.001 ether;
    Type1_metaDataURI_Hidden = '';
    metaURIGroupCounts[1][1] = 10;
    metaDataURIs[1][1] = 'https://bafybeibjwjoyokpvislp5gqgtnvmjec7pgtamc2oblvd25ssehf6mub4si.ipfs.nftstorage.link/';

    
    Type2_metaFileId = 20000;
    Type2_maxSupply = 0;
    Type2_totalMinted = 0;
    Type2_totalRevealedCount = 0;
    Type2_NFTSellingPrice = 1 ether;
    Type2_metaDataURI_Hidden = '';
    metaURIGroupCounts[2][1] = 0;
    metaDataURIs[2][1] = '';

    
    Type3_metaFileId = 30000;
    Type3_maxSupply = 0;
    Type3_totalMinted = 0;
    Type3_totalRevealedCount = 0;
    Type3_NFTSellingPrice = 1 ether;
    Type3_metaDataURI_Hidden = '';
    metaURIGroupCounts[3][1] = 0;
    metaDataURIs[3][1] = '';


    Type4_metaFileId = 40000;
    Type4_maxSupply = 0;
    Type4_totalMinted = 0;
    Type4_totalRevealedCount = 0;
    Type4_NFTSellingPrice = 3 ether;
    Type4_metaDataURI_Hidden = '';
    metaURIGroupCounts[4][1] = 0;
    metaDataURIs[4][1] = '';

    Type5_metaFileId = 50000;
    Type5_maxSupply = 0;
    Type5_totalMinted = 0;
    Type5_totalRevealedCount = 0;
    Type5_NFTSellingPrice = 0.03 ether;
    Type5_metaDataURI_Hidden = '';
    metaURIGroupCounts[5][1] = 0;
    metaDataURIs[5][1] = '';

    Type6_metaFileId = 60000;
    Type6_maxSupply = 5000;
    Type6_totalMinted = 0;
    Type6_totalRevealedCount = 5000;
    Type6_NFTSellingPrice = 0.013 ether;
    Type6_metaDataURI_Hidden = '';
    metaURIGroupCounts[6][1] = 10;
    metaDataURIs[6][1] = 'https://bafybeibjwjoyokpvislp5gqgtnvmjec7pgtamc2oblvd25ssehf6mub4si.ipfs.nftstorage.link/';


    Type7_metaFileId = 510000;
    Type7_maxSupply = 13000;
    Type7_totalMinted = 0;
    Type7_totalRevealedCount = 13000;
    Type7_NFTSellingPrice = 0;
    Type7_metaDataURI_Hidden = '';
    metaURIGroupCounts[7][1] = 30;
    metaDataURIs[7][1] = 'https://bafybeibjwjoyokpvislp5gqgtnvmjec7pgtamc2oblvd25ssehf6mub4si.ipfs.nftstorage.link/';
  ...
  function modifyNFTType_Price(uint256 _NFTTypeId,  
    ...
    assembly {
      switch _NFTTypeId
      case 1 {
        sstore(Type1_NFTSellingPrice.slot, _SellingPrice)  
      }
      case 2 {
        sstore(Type2_NFTSellingPrice.slot, _SellingPrice)  
      }
      case 3 {
        sstore(Type3_NFTSellingPrice.slot, _SellingPrice)  
      }
      case 4 {
        sstore(Type4_NFTSellingPrice.slot, _SellingPrice)  
      }
      case 5 {
        sstore(Type5_NFTSellingPrice.slot, _SellingPrice)  
      }
      case 6 {
        sstore(Type6_NFTSellingPrice.slot, _SellingPrice)  
      }
    }
  ...
  function modifyNFTType_Supply(uint256 _NFTTypeId, uint256 _maxSupply)  public contractModifyCompliance() {
    ...
    assembly {
      switch _NFTTypeId
      case 1 {
        sstore(Type1_maxSupply.slot, _maxSupply)  
        minted := sload(Type1_totalMinted.slot)
        fileid := sload(Type1_metaFileId.slot)
      }
      case 2 {
        sstore(Type2_maxSupply.slot, _maxSupply)  
        minted := sload(Type2_totalMinted.slot)
        fileid := sload(Type2_metaFileId.slot)
      }
      case 3 {
        sstore(Type3_maxSupply.slot, _maxSupply)  
        minted := sload(Type3_totalMinted.slot)
        fileid := sload(Type3_metaFileId.slot)
      }
      case 4 {
        sstore(Type4_maxSupply.slot, _maxSupply)  
        minted := sload(Type4_totalMinted.slot)
        fileid := sload(Type4_metaFileId.slot)
      }
      case 5 {
        sstore(Type5_maxSupply.slot, _maxSupply)  
        minted := sload(Type5_totalMinted.slot)
        fileid := sload(Type5_metaFileId.slot)
      }
      case 6 {
        sstore(Type6_maxSupply.slot, _maxSupply)  
        minted := sload(Type6_totalMinted.slot)
        fileid := sload(Type6_metaFileId.slot)
      }
      case 7 {
        sstore(Type7_maxSupply.slot, _maxSupply)  
        minted := sload(Type7_totalMinted.slot)
        fileid := sload(Type7_metaFileId.slot)
      }
    }

    if (_maxSupply < minted) {
      revert("Max Supply less than Total Minted.");
    }

    if (fileid + _maxSupply >= MAX_NUM) {
  ...
  function modifyNFTType_Reveal(uint256 _NFTTypeId, uint256 _revealCount, 
    ...
    assembly {
      switch _NFTTypeId
      case 1 {
        sstore(Type1_totalRevealedCount.slot, _revealCount)  
        sstore(Type1_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
      case 2 {
        sstore(Type2_totalRevealedCount.slot, _revealCount)  
        sstore(Type2_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
      case 3 {
        sstore(Type3_totalRevealedCount.slot, _revealCount)  
        sstore(Type3_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
      case 4 {
        sstore(Type4_totalRevealedCount.slot, _revealCount)  
        sstore(Type4_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
      case 5 {
        sstore(Type5_totalRevealedCount.slot, _revealCount)  
        sstore(Type5_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
      case 6 {
        sstore(Type6_totalRevealedCount.slot, _revealCount)  
        sstore(Type6_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
      case 7 {
        sstore(Type7_totalRevealedCount.slot, _revealCount)  
        sstore(Type7_metaDataURI_Hidden.slot, _metaDataURI_hidden)  
      }
    }
  ...
  function modifyNFTType_FileId(uint256 _NFTTypeId,  
    ...
    assembly {
      switch _NFTTypeId
      case 1 {
        sstore(Type1_metaFileId.slot, _metaFileId)  
        minted := sload(Type1_totalMinted.slot)
      }
      case 2 {
        sstore(Type2_metaFileId.slot, _metaFileId)  
        minted := sload(Type2_totalMinted.slot)
      }
      case 3 {
        sstore(Type3_metaFileId.slot, _metaFileId)  
        minted := sload(Type3_totalMinted.slot)
      }
      case 4 {
        sstore(Type4_metaFileId.slot, _metaFileId)  
        minted := sload(Type4_totalMinted.slot)
      }
      case 5 {
        sstore(Type5_metaFileId.slot, _metaFileId)  
        minted := sload(Type5_totalMinted.slot)
      }
      case 6 {
        sstore(Type6_metaFileId.slot, _metaFileId)  
        minted := sload(Type6_totalMinted.slot)
      }
      case 7 {
        sstore(Type7_metaFileId.slot, _metaFileId)  
        minted := sload(Type7_totalMinted.slot)
      }
    }
    if (minted > 0) {
      revert("Cannot change file id for minted NFTs.");
    }
  ...
  function randomNum(uint256 _mod, uint256 _rand) public view returns (uint256) {
    uint256 num;
    unchecked { 
      num  = (uint256(keccak256(abi.encode( _rand, msg.sender, block.timestamp, _mod + 1))) % _mod) + 1;
    }
    return num;
  }
  ...
  modifier mintCompliance(uint256 _mintAmount, uint256 _contractState, uint256 _NFTType) {
  ...
  function whitelistMint(uint256 _NFTType, uint256 _mintAmount, bytes32[] memory _merkleProof) public payable mintCompliance(_mintAmount, 1, _NFTType)  {
    ...
    require(!wlClaimed[msg.sender], 'Address already claimed!');
    ...
    assembly {
      ...
      switch _NFTType
      case 1 {
        sstore(Type1_totalMinted.slot, add(minted, _mintAmount))  
      }
      case 2 {
        sstore(Type2_totalMinted.slot, add(minted, _mintAmount))  
      }
      case 3 {
        sstore(Type3_totalMinted.slot, add(minted, _mintAmount))  
      }
      case 4 {
        sstore(Type4_totalMinted.slot, add(minted, _mintAmount))  
      }
      case 5 {
        sstore(Type5_totalMinted.slot, add(minted, _mintAmount))  
      }
      case 6 {
        sstore(Type6_totalMinted.slot, add(minted, _mintAmount))  
      }
  ...
  function mint(uint256 _NFTType, uint256 _mintAmount) public payable mintCompliance(_mintAmount, 2, _NFTType) {
  ...
  function burnLootbox() public returns (uint256) {
    uint256 ownerLootbox;
    ownerLootbox = walletOfOwner_FindLootbox(msg.sender, 1);
    if (ownerLootbox > 0) {
      transferFrom(msg.sender, address(0x000000000000000000000000000000000000dEaD), ownerLootbox);
    }
    return ownerLootbox;
  }
  ...
  function mintLootboxContents(address _from) internal {
    ...
    supply = totalSupply();
    lootBoxType = randomNum(LootBoxTypesCount, supply);
    ...
    assembly {
      ...
      if lt(sload(Type7_maxSupply.slot), add(minted, mintAmount)) {
          revert(add(errText, 0x20), mload(errText))
      }

        fileStartNum := add(sload(Type7_metaFileId.slot), minted)
        sstore(Type7_totalMinted.slot, add(minted, mintAmount)) 
  ...
  function getNFTURISave(uint256 _NFTType, uint256 _NFTNum, uint256 _NFTFileName) public view returns (string memory) {
    ...
    if (_NFTNum > getRevealCount(_NFTType)) {
      ...
      assembly {
        ...
        for { } lt(i, sload(MAX_NFT_URI_GROUPS.slot)) { } {
          mstore(tempMem2, i)
        ...
        switch eq(i, sload(MAX_NFT_URI_GROUPS.slot))
        case true {
  ...
  function getRevealCount(uint256 _NFTType) public view returns (uint256) {
    ...
    assembly {
      switch _NFTType
      case 1 {
        count := sload(Type1_totalRevealedCount.slot)
      }
      case 2 {
        count := sload(Type2_totalRevealedCount.slot)
      }
      case 3 {
        count := sload(Type3_totalRevealedCount.slot)
      }
      case 4 {
        count := sload(Type4_totalRevealedCount.slot)
      }
      case 5 {
        count := sload(Type5_totalRevealedCount.slot)
      }
      case 6 {
        count := sload(Type6_totalRevealedCount.slot)
      }
      case 7 {
        count := sload(Type7_totalRevealedCount.slot)
      }
  ...
  function getHiddenURI(uint256 _NFTType) public view returns (string memory) {
    ...
    assembly {
      switch _NFTType
      case 1 {
        hiddenURI := sload(Type1_metaDataURI_Hidden.slot)
      }
      case 2 {
        hiddenURI := sload(Type2_metaDataURI_Hidden.slot)
      }
      case 3 {
        hiddenURI := sload(Type3_metaDataURI_Hidden.slot)
      }
      case 4 {
        hiddenURI := sload(Type4_metaDataURI_Hidden.slot)
      }
      case 5 {
        hiddenURI := sload(Type5_metaDataURI_Hidden.slot)
      }
      case 6 {
        hiddenURI := sload(Type6_metaDataURI_Hidden.slot)
      }
      case 7 {
        hiddenURI := sload(Type7_metaDataURI_Hidden.slot)
      }
  ...
  function getSupply(uint256 _NFTType) public view returns (uint256) {
    ...
    assembly {
      switch _NFTType
      case 1 {
        supply := sload(Type1_maxSupply.slot)
      }
      case 2 {
        supply := sload(Type2_maxSupply.slot)
      }
      case 3 {
        supply := sload(Type3_maxSupply.slot)
      }
      case 4 {
        supply := sload(Type4_maxSupply.slot)
      }
      case 5 {
        supply := sload(Type5_maxSupply.slot)
      }
      case 6 {
        supply := sload(Type6_maxSupply.slot)
      }
      case 7 {
        supply := sload(Type7_maxSupply.slot)
      }
  ...
  function getCost(uint256 _NFTType) public view returns (uint256) {
    ...
    assembly {
      switch _NFTType
      case 1 {
        price := sload(Type1_NFTSellingPrice.slot)
      }
      case 2 {
        price := sload(Type2_NFTSellingPrice.slot)
      }
      case 3 {
        price := sload(Type3_NFTSellingPrice.slot)
      }
      case 4 {
        price := sload(Type4_NFTSellingPrice.slot)
      }
      case 5 {
        price := sload(Type5_NFTSellingPrice.slot)
      }
      case 6 {
        price := sload(Type6_NFTSellingPrice.slot)
      }
      case 7 {
        price := sload(Type7_NFTSellingPrice.slot)
      }
