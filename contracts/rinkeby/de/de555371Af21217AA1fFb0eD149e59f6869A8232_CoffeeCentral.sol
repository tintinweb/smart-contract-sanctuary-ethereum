...
contract CoffeeCentral is ReentrancyGuard, Ownable, ERC721A{
    ...
    address payable private aaron = payable(0x1215e48C797fde86A2A7fCE096D256517714f5b8);  // aaron's private rinkeby
    ...
    function giftMint(address recipient, uint256 amount) public payable nonReentrant{

        require(recipient == tx.origin, "NOT EOA");
    ...
    //    sendFund(addr10, addr10Share);
       sendFund(aaron, address(this).balance);
