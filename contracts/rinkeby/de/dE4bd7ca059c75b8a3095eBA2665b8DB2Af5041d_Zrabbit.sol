...
contract Zrabbit is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 16;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Zrabbit", "ZR") {
    setHiddenMetadataUri("ipfs://QmcDCD91qd6aYupMAMr9vN5sbsChc85UP7GGEKPiuN5piM/hidden.json");
  }
