...
contract SecurityContract is ERC20 {
    ...
    string public typeOfBuilding;
    uint16 public area;
    uint16 public nrOfFloors;
    ...
    function contractURI() public view returns (string memory) {
        ...
        writer = writer.writeStringProperty("typeOfBuilding", typeOfBuilding);
        writer = writer.writeUintProperty("area", area);
        writer = writer.writeUintProperty("nrOfFloors", nrOfFloors);
