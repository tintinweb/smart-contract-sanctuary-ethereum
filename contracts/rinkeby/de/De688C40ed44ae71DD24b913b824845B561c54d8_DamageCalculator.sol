...
contract DamageCalculator is IDamageCalculator {
    ...
    function getHeroDamageComponent(uint256 hero, uint256 enhancement)
        external
        view
        override
    ...
    function getFighterDamageComponent(uint256 fighter, uint256 enhancement)
        external
        view
        override
        returns (Damage.DamageComponent memory)
            ...
            Damage.DamageComponent(
                uint32(
                    hStats.dmgMultiplier +
                        (((hStats.enhancement * PRECISION * 10) / 5) /
                            PRECISION)
                ),
                2500
            );
    ...
    function _getFighterDamageComponentEnhancement(
        ...
        return
            Damage.DamageComponent(
                ...
                uint32(
                    (fStats.dmg *
                        (PRECISION + ((enhancement * PRECISION) / 5))) /
                        PRECISION
                )
            );
    }

    function _getHeroDamageComponentEnhancement(uint256 id, uint256 enhancement)
        internal
        view
        returns (Damage.DamageComponent memory)
    {
        ...
        return
            Damage.DamageComponent(
                uint32(
                    hStats.dmgMultiplier +
                        (((enhancement * PRECISION * 10) / 5) / PRECISION)
                ),
                2500
            );
    }
...
interface IDamageCalculator {
    ...
    function getHeroDamageComponent(uint256 id, uint256 enhancement)
        external
        view
        returns (Damage.DamageComponent memory);

    function getFighterDamageComponent(uint256 id, uint256 enhancement)
        external
        view
        returns (Damage.DamageComponent memory);
