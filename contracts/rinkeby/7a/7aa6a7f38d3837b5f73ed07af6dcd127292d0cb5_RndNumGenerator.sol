...
contract RndNumGenerator is VRFConsumerBaseV2 {
  ...
  //   uint256 _randomWord = randomWord;
  //   uint256 count = 0;
  //   uint256[] memory _finalResults;

  //   do {
  //     uint256 lottoNumber = _randomWord % 100;
  //     _randomWord = _randomWord / 100;

  //     if (lottoNumber > 0 && lottoNumber < 50) {
  //       bool duplicated = false;
  //       for (uint256 i = 0; i < _finalResults.length; i ++) {
  //         if (lottoNumber == _finalResults[i]) {
  //           duplicated = true;
  //         }
  //       }

  //       if (!duplicated) {
  //         _finalResults[count] = lottoNumber;
  //         count ++;
  //       }
  //     }
  //   } while (_finalResults.length == 6 || _randomWord == 0);
