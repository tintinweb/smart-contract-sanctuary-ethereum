...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5a0Ff66c3bE0D74a6159Bd37bDbF485DCf27F25d];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNgTTWFWFCPWZb4HEKuNHBPvYy9YciTnTzDFEmk3DBEFK/";
...
// File: contracts/DrugOnContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DrugOnContract is RamppERC721A {
    constructor() RamppERC721A("DrugOn", "DRGN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xwEeggUCoIg8MnuGw8RZ/contract-metadata";
    }
}
