...
event MintFinished();
  ...
  */
  ...
  function mint(uint256 amount) public canMint onlyOwner returns (bool) {
    require(_initialSupply.add(amount)<= _cap, "ERC20Capped: cap exceeded");
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    _initialSupply = _initialSupply.sub(amount);
