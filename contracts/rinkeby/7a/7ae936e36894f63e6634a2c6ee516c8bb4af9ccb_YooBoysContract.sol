...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf61EDDfa3EBF49d8e6D6f7E48da7f1A08C203CB6,0xf8881197CcAA3e930d67357D2eD8c71D72E91590];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 501 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmc3bkVyeYwX4AWz6dHTmGzBWXqTh2M3EVzXsw48ccT2cD/";
...
// File: contracts/YooBoysContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YooBoysContract is RamppERC721A {
    constructor() RamppERC721A("Yoo Boys", "YOOBOYS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/4q7BPaV1uCAcASDQ9KcK/contract-metadata";
    }
}
