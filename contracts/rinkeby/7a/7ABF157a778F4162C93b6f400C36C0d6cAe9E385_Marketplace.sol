...
function closeOrder(bytes32 _createdOrder) public returns(bool) {
...
function buyOneERC1155(bytes32 _saltOrder,uint _amount)public {
...
//enter amount 0 if target if ERC721
