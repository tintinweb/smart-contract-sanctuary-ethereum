...
contract Evoldinos is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("Evoldinos Club", "EVOLDINOS") {
        ...
        _baseTokenURI = 'ipfs://QmZ8gy1BB1wqPiACT1715qWqAJby7LxG8EE1k5RpSQ8AYS/';
        secondaryBeneficiaryAddress = payable(0xC496e76c8eB3507e3eB9dC8caa9696E5Ac9DA37B);
    }
    ...
    function mintTeamAllocation() public onlyOwner nonReentrant {
        require(!teamHasMinted,'Founding team has already minted their allocation');
