...
library Traits {
    ...
    function getTokenURI(Dungeon.RaidInventory memory _inventory, uint256 tokenId) external pure returns (string memory) {
        ...
        parts[14] = '<text x="85" y="30" class=';
        parts[15] = _inventory.shirt.tier;
        parts[16] = '>';
        parts[17] = _inventory.shirt.name;
        parts[18] = '</text><text x="285" y="30" class=';
        parts[19] = _inventory.shirt.tier;
        parts[20] = '>';
        parts[21] = Strings.toString(_inventory.shirt.value);
/*
