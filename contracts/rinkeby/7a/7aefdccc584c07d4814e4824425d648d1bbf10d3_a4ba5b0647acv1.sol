...
contract a4ba5b0647acv1 is ERC721, Ownable, ReentrancyGuard {
    ...
    function backgroundColor(uint256 tokenId) private view returns (string memory) {
      ...
      string[48] memory r;
      string[48] memory s = ["1", "6", "3", "9", "c", "4", "b", "d", "e", "8", "5", "0", "a", "f", "2", "7", "b", "7", "5", "1", "8", "d", "2", "a", "6", "c", "4", "f", "9", "0", "e", "3", "5", "8", "3", "1", "c", "d", "e", "a", "f", "0", "4", "b", "6", "7", "9", "2"];
      ...
      if (keccak256(bytes(m)) == keccak256(bytes(f))) {
        ...
        //   j = string(abi.encodePacked(r[5],r[11],r[7],r[4],r[10],r[15]));
          j = string(abi.encodePacked(r[2],r[7],r[18],r[29],r[34],r[46]));
      }
    ...
    function makeAttributes(uint256 tokenId) private view returns (string memory) {
        ...
        if (s == 7) {
            traits[2] = string(abi.encodePacked('{"trait_type":"Punk State:","value":"Hidden"}'));
        } else {
            traits[2] = string(abi.encodePacked('{"trait_type":"Punk State: #","value":"Visible"}'));
        }
