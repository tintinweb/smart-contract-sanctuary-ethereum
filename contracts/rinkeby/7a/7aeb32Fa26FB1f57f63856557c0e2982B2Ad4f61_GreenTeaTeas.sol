...
contract GreenTeaTeas is ERC721, Ownable, VRFConsumerBase {
    ...
    function requestRaffleWinner() public returns (bytes32 requestId) {
    ...
    function asd(uint256 r)public {
        bytes32 d;
        fulfillRandomness(d, r);
    }
