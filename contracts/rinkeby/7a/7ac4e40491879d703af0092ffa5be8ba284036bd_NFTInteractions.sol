...
contract NFTInteractions is FujiPriceAware, Initializable {
  ...
  function _getChainlinkEntropy() private view returns (uint256) {
    ...
    (,int numA,,,) = AggregatorV3Interface(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e).latestRoundData();
    (,int numB,,,) = AggregatorV3Interface(0x2431452A0010a43878bF198e170F6319Af6d27F4).latestRoundData();
