...
contract ConfigurableOracleMockFactory is AccessControl {
    ...
    function getOracleData(string memory tokenSymbol_) external view returns (string memory, address) {
        return (tokenOracles[tokenSymbol_].tokenSymbol, tokenOracles[tokenSymbol_].oracle);
    }
}
