...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xea9ceE999cbc983e7deca0802C62AbC2e5Eb22D6];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmcrLNA8vPuZQwsgkF7Yd8uxqB8B7yDHyorRA1HoZvRwta/";
...
// File: contracts/NeoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NeoContract is RamppERC721A {
    constructor() RamppERC721A("neo", "neo"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/1UWtKFKwqc67t11fWfMV/contract-metadata";
    }
}
