...
contract DiamondCo is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxPublicMintAmountPerWallet = 2;
  uint256 public maxWhitelist1MintAmountPerWallet = 2;
  uint256 public maxWhitelist2MintAmountPerWallet = 1;

  uint256 public publicMintCost = 0.2 ether;
  uint256 public whitelist1MintCost = 0.13 ether;
  uint256 public whitelist2MintCost = 0.15 ether;
  ...
  function ownerClaimed() internal onlyOwner {
