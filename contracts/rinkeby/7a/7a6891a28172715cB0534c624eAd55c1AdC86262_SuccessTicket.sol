...
contract SuccessTicket is ERC721URIStorage, Ownable {
    ...
    constructor(address _dataFeed, string memory _networkBaseURI) ERC721("Success Tickets", "0xRAWT") {
        ...
        ticket_price = (desired_price * 10 ** 18) / basePrice;
    }
    ...
    function updatePrice() external onlyAdmin {
        ...
        uint256 basePrice = uint(price);
        ticket_price = (desired_price * 10 ** 18) / basePrice;
        emit PriceUpdate(basePrice, ticket_price);
    }
    ...
    function mintTicket(uint _amount) external payable noReentrant {
        ...
        require(msg.value >= (ticket_price * _amount), "Not enough ether send to buy the desired tickets");
