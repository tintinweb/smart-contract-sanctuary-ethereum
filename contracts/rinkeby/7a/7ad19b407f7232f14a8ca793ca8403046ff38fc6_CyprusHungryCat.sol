...
contract CyprusHungryCat is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint public MAX_SUPPLY = 1;

    constructor() ERC721("CyprusHungryCat", "CHC") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmXaNbWk35RyjkseRRnMNavghsiynPCDngUcmZsFs2bpc2";
    }
