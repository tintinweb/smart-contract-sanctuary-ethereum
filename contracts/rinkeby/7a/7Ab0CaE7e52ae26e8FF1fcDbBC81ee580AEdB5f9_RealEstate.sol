...
contract RealEstate is Pausable, Ownable {
    ...
    uint256 agencyFee = 6; //in persent
    uint256 TicketTokenPrice = 5000; //fixed price
        ...
        )
    {
        ...
        _endAt = TICKET_TOKEN.TokenTransferTimestamp(_propertyId).add(1209600);
    ...
    function buyPropertyToken(
        ...
        require(
            TICKET_TOKEN.TokenTransferTimestamp(_propertyId).add(1209600) >=
                block.timestamp,
            "timeout"
        );
