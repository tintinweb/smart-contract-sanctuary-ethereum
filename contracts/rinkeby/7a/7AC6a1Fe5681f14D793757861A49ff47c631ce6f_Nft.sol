...
contract Nft is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    bool revealed = false;
    bool presale = true;
    bool private giftMintDone = false;
    ...
    constructor () ERC721("Nft", "NFT") ReentrancyGuard(){
        //TODO before deploy set the hidden metadata json link
        baseURI = "ipfs://";
        _pause();
    ...
    function mintLegendariesForGiveaway() external onlyOwner {
        require(!giftMintDone, "Legendaries mint is already done!");
        giftMintDone = !giftMintDone;
        mintLoop(11);
    }
    ...
    function giveaway(address[] calldata addresses, uint256[] calldata amounts) external onlyOwner {
        ...
        for(uint256 i = 0; i < addresses.length; i++) {
            ...
            require(amounts[i] + currentGivenAway <= 150, "All givean away");
