    ...
    UUPSUpgradeable
{
    ...
    function initialize(string calldata _defaultURI, string calldata _contractMetadataURI) public initializer {
    ...
    function safeMintGhostCloud(
        ...
        _safeMintMerkle(_amount, _price);
    }
    ...
    function _safeMintMerkle(uint256 _amount, uint256 _price) internal {
