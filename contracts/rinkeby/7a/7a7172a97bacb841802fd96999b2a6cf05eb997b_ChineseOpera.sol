...
// File: contracts/ChineseOpera.sol
...
contract ChineseOpera is ERC721, Ownable {
    ...
    constructor() ERC721("ChineseOpera", "COP"){}
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        require(count <= TOKENS_PER_TRAN_LIMIT, "ZeroCodeNFT: Number of requested tokens exceeds allowance (2)");
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            ...
            require(_mintedCount[msg.sender] + count <= TOKENS_PER_PERSON_PUB_LIMIT, "ZeroCodeNFT: Number of requested tokens exceeds allowance (2)");
