...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x694AF74b83507BA11c574F0D7e594991DF26E39f];
...
// File: contracts/GoblinFairiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract GoblinFairiesContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Goblin Fairies";
    string public symbol = "GFR";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/JmlbvaPyLseX2DdcT76Q/contract-metadata";
    }
