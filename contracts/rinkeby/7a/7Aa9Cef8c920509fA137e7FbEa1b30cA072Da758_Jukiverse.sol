...
contract Jukiverse is ERC721A, ERC2981, EIP712, ReentrancyGuard, Ownable {
    ...
    address private constant WALLET_A = 0x27c787DF0Cf23fCC8Ec5F1f943796dc3aB83C167;
    address private constant WALLET_B = 0x27c787DF0Cf23fCC8Ec5F1f943796dc3aB83C167;
    address private constant WALLET_C = 0x27c787DF0Cf23fCC8Ec5F1f943796dc3aB83C167;
    
    string public baseURI;
    string private contractURIMetadata;
    Stage public stage;
        ...
        EIP712("Jukiverse", "1.0.0")
    {
        ...
        contractURIMetadata = "ipfs://QmXaedWqZM1UZQFDLCap7HWqTBkwqsYhGQK2PNYqdr3SVU";
        _transferOwnership(0xb605A79518dDd964ec079223b4c93a11a1f6F016);
    }
    ...
    /// @notice set contract URI Collection metadata for opensea
    /// @param _uri uri of metadata
    function setContractURI(string calldata _uri)
        external
        onlyOwner
    {
        contractURIMetadata = _uri;
    }
