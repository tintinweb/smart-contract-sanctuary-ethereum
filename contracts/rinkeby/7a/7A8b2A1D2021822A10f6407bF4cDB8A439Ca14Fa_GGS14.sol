...
contract GGS14 is ERC721Enumerable, Ownable {
    ...
    constructor(/*string memory baseURI*/) ERC721("Greed God Society", "GGS")  {
        //Team members gets randomized first 3 mints!
        // _safeMint( w1, 0);
        // _safeMint( w2, 1);
        // _safeMint( w3, 2);
    }
    ...
    function buy(uint256 num) public payable{
        ...
        require( num < 51,                              "You cannot mint more than 50 at a time" );
