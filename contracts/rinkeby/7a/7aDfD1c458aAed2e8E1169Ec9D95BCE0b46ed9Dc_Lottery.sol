...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        ethUsdPriceFee = AggregatorV3Interface(_ethUsdPriceFee);
    ...
    function enter() public payable {
        ...
        require(
            ...
            "Not enough ETH (Need more than 50$)"
        );
    }

    function getEntranceFee() public view returns (uint256) {
        (, int256 price, , , ) = ethUsdPriceFee.latestRoundData();
        uint256 adjustedPrice = uint256(price) * (10**10); //18 decimals (USD/ETH already have 8)
        ...
        override
    {
        require(
            lottery_state == LOTTERY_STATE.CALCULATING_WINNER,
            "Lottery status does not Calculatin winner"
        );
