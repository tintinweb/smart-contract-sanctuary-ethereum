...
contract BTK is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("BTK", "BTK NFT") payable {
...
//     function _burn(uint256 tokenId) internal override(ERC721A, ERC721Royalty) {
//         super._burn(tokenId);
//   }
}