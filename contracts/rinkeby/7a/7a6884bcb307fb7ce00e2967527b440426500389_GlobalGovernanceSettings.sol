...
interface IGlobalGovernanceSettings {
    ...
    function minRequireVoterTurnoutRate() external returns (uint);

    function maxRequireVoterTurnoutRate() external returns (uint);
...
contract GlobalGovernanceSettings is IGlobalGovernanceSettings {
    address internal constant weth = 0xc778417E063141139Fce010982780140Aa0cD5Ab; // 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //
    address internal constant dai = 0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa; //0x6B175474E89094C44Da98b954EedeAC495271d0F;
    address internal constant usdc = 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926; //0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    address internal constant usdt = 0xD92E713d051C37EbB2561803a3b5FBAbc4962431; //0xdAC17F958D2ee523a2206206994597C13D831ec7; // 
    ...
    uint public override immutable minRequireVoterTurnoutRate;
    uint public override immutable maxRequireVoterTurnoutRate;
    ...
    constructor(address _owner) {
        ...
        minRequireVoterTurnoutRate = 100;
        maxRequireVoterTurnoutRate = 8000;
