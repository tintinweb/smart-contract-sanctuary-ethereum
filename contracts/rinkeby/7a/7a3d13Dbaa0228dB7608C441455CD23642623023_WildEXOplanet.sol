...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierStartMintTimes = [1645048800, 1647374400];
    //Minting ending time in unix-epoch [phase 1 start, phase 2 start]
    uint256[] public tierMintEndTimes = [1645135200, 1647460800];
    //Minting tier fee
    ...
    uint256 public whitelistSaleDisableTime = 1645041600;
    uint256 public whitelistSaleStartTime = 1644955200;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1645221600, 1647460800];
