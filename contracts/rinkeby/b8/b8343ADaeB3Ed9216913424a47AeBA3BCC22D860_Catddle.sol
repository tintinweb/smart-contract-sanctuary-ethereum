...
contract Catddle is IMinted, ERC721OSafeRemote {
    ...
    // Token will be locked when transfer to other chains, then transfer, burn and moveFrom actions will be frozen
    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        // include transfer, mint, and burn
        if (from != to && address(friendshipManager) != address(0x0)) {
            friendshipManager.resetFriendship(tokenId);
        }
    }
}
