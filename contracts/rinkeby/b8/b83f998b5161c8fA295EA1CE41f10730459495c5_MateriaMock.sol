...
contract MateriaMock is ERC1155Tradable {
    ...
    modifier canMint() {
        ...
        require(block.timestamp >= _start , "Minting not yet started");
    ...
    function mintMateria(uint256 antonymTokenId) external canMint {
    ...
    function mintPrimaMateria(uint256 antonymTokenId, bytes32[] calldata proof) external canMint {
    ...
    function getTimes() public view returns (uint64, uint64, uint256) {
        return (_start, _end, block.timestamp);
    }
