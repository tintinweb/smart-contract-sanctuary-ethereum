...
pragma solidity ^0.5.16;
    ...
    contract LitedexERC20 is ILitedexERC20 {
        ...
        function _burn(address from, uint value) internal {
            require(from != address(0), "Litedex: from is zero address");
        ...
        function _approve(address owner, address spender, uint value) private {
            require(owner != address(0), "Litedex: owner is zero address");
            require(spender != address(0), "Litedex: spender is zero address");
        ...
        function _transfer(address from, address to, uint value) private {
            require(from != address(0), "Litedex: from is zero address");
            require(to != address(0), "Litedex: to is zero address");
            balanceOf[from] = balanceOf[from].sub(value);
            balanceOf[to] = balanceOf[to].add(value);
    ...
    contract LitedexPair is ILitedexPair, LitedexERC20 {
        ...
        function burn(address to) external lock returns (uint amount0, uint amount1) {
            ...
            bool feeOn = _mintFee(_reserve0, _reserve1);
            uint _totalSupply = totalSupply; // gas savings, must be defined here since totalSupply can update in _mintFee
            require(_totalSupply != 0, "Litedex: Total Supply is 0");
