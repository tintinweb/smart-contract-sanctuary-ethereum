...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE05FAc373f63872548EF7d98cad915e1041238ce];
...
// File: contracts/SilksTesttContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract SilksTesttContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "SilksTestt";
    string public symbol = "silks";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/m0scBhWpJbc2SF78hR8Q/contract-metadata";
    }
