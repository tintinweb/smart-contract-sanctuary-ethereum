...
contract Boopies is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public onlyOwner {
    ...
    require(ownerMintedcount + _mintAmount <= nftPerAddressLimit, 'Max free supply exceeded!');
    addressMintedBalance[_msgSender()] = ownerMintedcount + _mintAmount;
    _safeMint(_msgSender(), _mintAmount);
  }
