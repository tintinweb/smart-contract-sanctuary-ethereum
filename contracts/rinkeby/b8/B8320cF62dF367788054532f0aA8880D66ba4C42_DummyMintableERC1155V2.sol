...
contract DummyMintableERC1155V2 is
	ERC1155,
	AccessControlMixin,
	...
	Ownable
{
	...
	constructor(
		...
		symbol = _symbol;
		_uri = uri_;
		_setupContractId("DummyMintableERC1155V2");
		_setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
		_setupRole(PREDICATE_ROLE, _msgSender());
		_initializeEIP712(uri_);
	}

	function setURIs(uint256[] calldata _ids, string[] calldata uri_)
		external
		onlyOwner
	{
	...
	function setURI(uint256 _id, string calldata uri_) external onlyOwner {
		nftURI[_id] = uri_;
	}
