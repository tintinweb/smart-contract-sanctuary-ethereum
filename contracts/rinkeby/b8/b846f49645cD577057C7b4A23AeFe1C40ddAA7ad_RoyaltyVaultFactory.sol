...
contract RoyaltyVaultFactory {
    ...
    event VaultCreated(address vault, address splitterProxy);
    event NewRoyaltyVaultPlatformFee(address vault, uint256 platformFee);
    event NewRoyaltyVaultPlatformFeeRecipient(address vault, address recipient);
        ...
        returns (address vault)
    {
        ...
        emit VaultCreated(vault, splitterProxy);
    ...
    function setPlatformFee(address _vault, uint256 _platformFee) external {
        ...
        emit NewRoyaltyVaultPlatformFee(_vault, _platformFee);
    }
    ...
    function setPlatformFeeRecipient(
        ...
        emit NewRoyaltyVaultPlatformFeeRecipient(_vault, _platformFeeRecipient);
    }
}
