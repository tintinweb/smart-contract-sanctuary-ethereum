...
contract MoaiFamily is Ownable, ReentrancyGuard, ERC721A {
    ...
    address public multisig = 0xB2957e8741DD5221214f3c67e2B904B7504758F5;
    ...
    string private _baseURIExtended = "https://metadata.moaifamily.io/dev/";
    ...
    constructor(address _minter, address _owner) ERC721A("Moai Family NFT", "MF") {
        minter = _minter;
