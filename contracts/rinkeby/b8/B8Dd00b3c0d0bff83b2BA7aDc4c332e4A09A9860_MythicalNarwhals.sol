...
contract MythicalNarwhals is ERC721, Ownable, VRFConsumerBase, ReentrancyGuard {
    ...
    function mint() public {
        ...
        require(balanceOf(msg.sender) == 0, "You have already minted a Mythical Narwhals NFT");
    ...
    function getLastRandomBlockNumber() external view returns (uint256) {
        return lastRandomFetchBlockNumber;
    }
    ...
    function _mint() internal nonReentrant{
        ...
        require(_mintedSupply.current() + 1 <= MAX_SUPPLY, "Not enough tokens left to mint that many");
    ...
    function fulfillRandomness(bytes32, uint256 randomness) internal override {
        ...
        lastRandomFetchBlockNumber = block.number;
    }
