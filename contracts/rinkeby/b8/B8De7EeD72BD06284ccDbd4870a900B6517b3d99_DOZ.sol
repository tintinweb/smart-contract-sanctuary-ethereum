...
contract DOZ is AccessControl, ERC721{
    ...
    mapping(address => uint256) private claimableGiveaway;
    ...
    */
    function registerGiveaways(address[] memory winners) public onlyOwner {
    ...
    */
    function presaleMint(uint64 numberOfToken) public payable onlyRole(whiteListedRole) {
    ...
    */
    function mint(uint64 numberOfToken) public payable {
    ...
    /**
        Mint a nft during the presale
    */
    function claimMyGiveaways() public {
        require(claimableGiveaway[msg.sender] > 0, "No giveaway to claim");
        require(totalSupply().add(claimableGiveaway[msg.sender]) <= maxSupply, "Claim would exceed max supply during presale");

        internalMint(msg.sender, claimableGiveaway[msg.sender]);
        claimableGiveaway[msg.sender] = 0;
    }
