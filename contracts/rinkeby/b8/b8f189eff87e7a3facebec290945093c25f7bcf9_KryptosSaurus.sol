...
// File: contracts/NFTT.sol





// File: contracts/KryptosSaurus.sol


pragma solidity ^0.8.17;

/**
 * @title KryptosSaurus contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract KryptosSaurus is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
constructor(
  ...
  /**
    ...
    */
    ...
    require(_mintAmount <= MAX_TOKENS_PER_PURCHASE, "Can only mint 20 tokens at a time");
    require(Supply + _mintAmount < MAX_TOKENS + 1, "Exceeds maximum tokens available for purchase");
  ...
  function setWhitelist(address[] calldata userList) public onlyOwner {
    require(userList.length > 0, "userList must be greater than 0");
