...
contract PNTokenSwap is IPNTokenSwap, ReentrancyGuard, Ownable {
    ...
    // v1 decimals: 9
    // v1 supply: 1e12 * 10**9;
    //            1,000,000,000,000.000000000
    //
    // v1 -> v2 conversion: 10,000.000000000000000000
    ...
    /**
     * @dev returns address of where swapped V1 tokens are sent.
     *
     * @return the address of the V1 token taker
     */
    ...
    /**
     * Set the V1 token taker.
     */
    function setV1TokenTaker(address _newTokenTaker) external override onlyOwner {
        v1TokenTaker = _newTokenTaker;
    }
    ...
    function allowSwap() external onlyOwner {
        require(v1TokenTaker != 0x0000000000000000000000000000000000000000, "Must setV1TokenTaker");
        swapActive = true;
    }

    /**
     * @return the number of V2 tokens to be swapped for V1
     */
