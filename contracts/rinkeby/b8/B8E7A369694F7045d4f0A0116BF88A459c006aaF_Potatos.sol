...
contract Potatos is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor(uint256 initSupply, address payable ownerWallet, bytes32 merkleRoot) ERC721("UglyPotaTrollz", "POTATROLLZ") {
    ...
    payable
    {
        ...
        require(MerkleProof.verify(proof,_whitelistMerkleRoot,keccak256(abi.encodePacked(to, _getTierLimitPerWallet(quantity)))),"Wallet not whitelisted.");
