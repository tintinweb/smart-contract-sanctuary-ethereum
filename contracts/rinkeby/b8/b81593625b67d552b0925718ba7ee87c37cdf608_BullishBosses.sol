...
contract BullishBosses is Ownable, ERC721A  {
    ...
    function freeMint(bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        require(MerkleProof.verify(_merkleProof, merkleRoot, leaf), "Not part of the whitelist.");
       
        _safeMint(msg.sender, _mintAmount);
        freeMintSlotsRemaining-=1;
    }
