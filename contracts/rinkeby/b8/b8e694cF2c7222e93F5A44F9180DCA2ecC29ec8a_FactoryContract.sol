...
contract FactoryContract{
    ...
    PandaEverSafeWallet[] public UserWalletAddress;
    function CreateNewWallet(address SignerWallet) public returns (address){
        PandaEverSafeWallet UserNewAddress = new PandaEverSafeWallet(msg.sender, SignerWallet, address(this));
        address newContractAddress = address(UserNewAddress);
        emit NewContractCreated(msg.sender, newContractAddress);
        UserWalletAddress.push(UserNewAddress);   
...
contract PandaEverSafeWallet is ReentrancyGuard {
    ...
    constructor(address users, address _signer, address Factory){
