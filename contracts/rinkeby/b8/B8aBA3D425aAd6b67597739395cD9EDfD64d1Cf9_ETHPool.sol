...
contract ETHPool is  Ownable {
    ...
    event DepositUser(address _sender, uint256 _amount);
    ...
    function depositUser() public payable{
        ...
        emit DepositUser(msg.sender, msg.value);     
    }
    ...
    function withdrawUser(uint256 _amounts) public {
        ...
        poolInfo[msg.sender] = Info(poolInfo[msg.sender].poolAmounts - _amounts, poolInfo[msg.sender].rewardTime);
