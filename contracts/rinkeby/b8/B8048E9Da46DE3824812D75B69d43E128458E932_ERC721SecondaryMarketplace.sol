...
contract ERC721SecondaryMarketplace is SecondaryMarketplace {
    ...
    /**
     * @dev Transfers the existing token to the buyer.
     */
...
abstract contract SecondaryMarketplace is Marketplace {
    ...
    /**
     * @dev Transfers the royalties to the creator, and transfers the total
     *     sale price minus the royalties and the commission to the reseller.
     */
