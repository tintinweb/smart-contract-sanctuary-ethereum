...
contract NotBoredApeYachtClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NotBored Ape Yacht Club", "NBAYC") {
    setHiddenMetadataUri("ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/1");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x27864fbBb4396DdFc4f23A408c6f95FF7C7c3c49).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
