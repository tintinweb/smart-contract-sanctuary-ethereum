 ...
 * Accessories.
 */
contract EightBitLootBox is ERC1155, ReentrancyGuard, Ownable {
    struct BoxOptions {
    ...
    mapping(uint256 => BoxOptions) public boxOptions; /* box id => box options */
    mapping(uint256 => uint256[]) public classTokens; /* class id => token ids */
