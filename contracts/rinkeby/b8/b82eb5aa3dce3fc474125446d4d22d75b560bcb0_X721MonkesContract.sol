...
//   / /__/ // / /|_/ / __ \/ __ \/ //_/ _ \/ ___/
//  / // __// / /  / / /_/ / / / / ,< /  __(__  ) 
// /_//____/_/_/  /_/\____/_/ /_/_/|_|\___/____/  
//                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdxuEQFeUUDcnrcsSpkMACpxTpTRJ2CG8iqbxfYiPzS4u/";
...
// File: contracts/X721MonkesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X721MonkesContract is RamppERC721A {
    constructor() RamppERC721A("721Monkes", "ERC721A"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/rD8zrfOMBvcg5PDTktXs/contract-metadata";
    }
}
