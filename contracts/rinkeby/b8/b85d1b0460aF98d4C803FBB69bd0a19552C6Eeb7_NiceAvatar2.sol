...
contract NiceAvatar2 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // Pay ExperienceAccount 5% of the initial sale.
    (bool hs, ) = payable(0x9Eef80819907f2cDf0A4fbd0C590147aBFa87dc7).call{value: address(this).balance * 5 / 100}('');
    require(hs);
