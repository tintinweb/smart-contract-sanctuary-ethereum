...
contract NFTCoin is ERC721, Ownable {
    ...
    constructor() ERC721("NFT Coin", "NFTC") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://token-test.hwhk.workers.dev/";
    }

    function setMintStatus(bool enabled) public onlyOwner {
        if (mintEnabled != enabled) {
            mintEnabled = enabled;
        }
    }
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity > 0, "Quantity must be greater than 0");
        require(msg.value >= MINT_PRICE * quantity, "Please pay the mint price");
