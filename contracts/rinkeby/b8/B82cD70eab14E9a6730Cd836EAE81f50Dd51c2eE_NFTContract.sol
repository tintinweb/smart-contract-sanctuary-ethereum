    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        if(whiteListSale && Phase1){
            ...
            if (!whiteListedAddress[msg.sender] && publicSale){
                ...
                require(whiteListSale, "NFTContract :: Minting is on Pause");
                require((totalSupply() + _quantity) <= MaxMintPhase2, "NFTContract :: Cannot mint beyond phase 1 supply");
                require((totalWhitelistMint[msg.sender] + _quantity)  <= MAX_WHITELIST_MINT, "NFTContract:: Cannot mint beyond whitelist max mint!");
                require(msg.value >= (WHITELIST_SALE_PRICE * _quantity), "NFTContract :: Payment is below the price");
                require(_quantity + balanceOf(msg.sender) <= MaxPerWhiteListWallet , "NFTContract :: You can not mint more than the maximum allowed per user.");
                require(whiteListedAddress[msg.sender], "NFTContract :: Sorry you are not white listed!");
            ...
            if (whiteListedAddress[msg.sender] && whiteListSale){
                require(whiteListSale, "NFTContract :: Minting is on Pause");
                require((totalSupply() + _quantity) <= MaxMintPhase3, "NFTContract :: Cannot mint beyond phase 1 supply");
                require((totalWhitelistMint[msg.sender] + _quantity)  <= MAX_WHITELIST_MINT, "NFTContract:: Cannot mint beyond whitelist max mint!");
                require(msg.value >= (WHITELIST_SALE_PRICE * _quantity), "NFTContract :: Payment is below the price");
                require(_quantity + balanceOf(msg.sender) <= MaxPerWhiteListWallet , "NFTContract :: You can not mint more than the maximum allowed per user.");
                require(whiteListedAddress[msg.sender], "NFTContract :: Sorry you are not white listed!");
            ...
            else if (!whiteListedAddress[msg.sender] && publicSale){
                require(publicSale, "NFTContract :: Not Yet Active.");
            ...
            if (whiteListSale){
                require(whiteListSale, "NFTContract :: Minting is on Pause");
                require((totalSupply() + _quantity) <= MAX_SUPPLY, "NFTContract :: Cannot mint beyond phase 1 supply");
                require((totalWhitelistMint[msg.sender] + _quantity)  <= MAX_WHITELIST_MINT, "NFTContract:: Cannot mint beyond whitelist max mint!");
                require(msg.value >= (WHITELIST_SALE_PRICE * _quantity), "NFTContract :: Payment is below the price");
                require(_quantity + balanceOf(msg.sender) <= MaxPerWhiteListWallet , "NFTContract :: You can not mint more than the maximum allowed per user.");
                require(whiteListedAddress[msg.sender], "NFTContract :: Sorry you are not white listed!");
