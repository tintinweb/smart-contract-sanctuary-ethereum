 ...
 * @dev This implements Chainlink VRF V2 and Keeper compatible.
 */
contract Raffle is VRFConsumerBaseV2, KeeperCompatible {
	...
	/**
	 * @dev This is the function that the Chainklink Keeper nodes call
	 * they look for the `unkeepNeeded` to return true.
	 * The following should be trye to return true:
