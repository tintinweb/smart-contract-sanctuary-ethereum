...
contract interactivenftt is ERC721A, Ownable{
    using Strings for uint256;
    ...
    string public _metaBaseUri = "www.littlebois.com/interactivenft/";
    
    // Public Functions
    
    constructor() ERC721A("Interactivenftt", "interactivenftt") {
