...
contract HackReentrancy is Ownable {
    ...
    IReentrance reentrancy;
    
    constructor(address reentrancyAddress) public Ownable() {
        reentrancy = IReentrance(reentrancyAddress);
    }

    function updateReentrance(address reentrancyAddress) public onlyOwner {
        reentrancy = IReentrance(reentrancyAddress);
    }
    ...
    // Call this with 0.001 ETH payable
