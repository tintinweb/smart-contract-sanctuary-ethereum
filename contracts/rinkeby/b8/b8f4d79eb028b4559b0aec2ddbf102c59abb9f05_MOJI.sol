...
contract MOJI is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint public constant MAX_MOJI_PURCHASE = 100; // to save gas, some place used value instead of var, so be careful during changing this value
    ...
    // ############################# constructor #############################
    constructor() ERC721A("MOJI", "MOJI", 100, 1000) { }
