...
import "./IStakeFuzzyToken.sol";

contract FuzzStaking is IERC721Receiver, Ownable {
    ...
    function stake(uint256[] calldata tokenIds) external {
        ...
        IStakeFuzzyToken(ERC1155_CONTRACT).whitelistMint(msg.sender, 1,tokenIds.length);
    }
    ...
    function unstake(uint256[] calldata tokenIds) external {
        ...
        IStakeFuzzyToken(ERC1155_CONTRACT).whitelistBurn(msg.sender, 1, tokenIds.length);
    }
}
