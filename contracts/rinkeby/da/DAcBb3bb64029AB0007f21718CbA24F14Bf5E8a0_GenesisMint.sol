...
contract GenesisMint is Ownable, Pausable {
	...
	*/
	...
	/**
	 * @notice Logic for purchasing
	 * @param _nftsToPurchase uint256 How many NFT's requested
	 */
	// ! NEED TO SUBTRACT FREE NFT ALLOCATION * NFTCOST FROM USDC TOTAL WITHDRAWN !
	function _purchase(uint256 _nftsToPurchase) internal {
		...
		uint256 usdc_total = (_nftsToPurchase.mul(info.price)).sub(info.credit);
