...
//        .\\)`;,|\'/(
//         ` `itz `(,
contract Funga is ERC721AQueryable, Ownable, ReentrancyGuard, PaymentSplitter {
	using Address for address;
	using Strings for uint256;
	using MerkleProof for bytes32[];

	bytes32 public root = 0x7f5a2e906a0c62c3abbd15c31251d50e31c7056dad4fcbb34031a299d544e146;
	bytes32 public root2 = 0x7f5a2e906a0c62c3abbd15c31251d50e31c7056dad4fcbb34031a299d544e146;

	string public _contractBaseURI = "ipfs://to_be_updated_later/";
	string public _unrevealedURI = "https://xxxxxxx/unrevealed.json";
	string public _contractURI = "https://xxxxxxxxxxxxyxx/contract_uri.json";
	...
	uint256 public presale1StartTime = block.timestamp - 1; // TODO: set it
	uint256 public presale2StartTime = presale1StartTime + 30 minutes; // TODO: set it
	...
	address[] private addressList = [
		0xdc6dbF9355aBF2F9911e544f0BdE08B6535db037,
		0x8E320f6269506FCEd3E66160B9DAE62e2eE08B37,
		0xBa5A400988A7c80683790a98a3328F550dA3b6F5
	];
	uint256[] private shareList = [25, 25, 50];
	...
	constructor() ERC721A("Funga", "FUNGA") PaymentSplitter(addressList, shareList) {}
	...
	function buildNumber3() internal view {}
}
