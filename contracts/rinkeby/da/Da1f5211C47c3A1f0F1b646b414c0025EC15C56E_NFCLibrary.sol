...
library NFCLibrary {
    ...
    function check1155Compliancy(address _contract) public view returns (bool) {
        ...
        return IERC165(_contract).supportsInterface(_INTERFACE_ID_IERC1155);
    }
    ...
    function check721Compliancy(address _contract) public view returns (bool) {
        ...
        if (IERC165(_contract).supportsInterface(_INTERFACE_ID_IERC721) == false) {
            return false;
        }
    ...
    function check721EnumerableCompliancy(address _contract) public view returns (bool) {
        ...
        if (IERC165(_contract).supportsInterface(_INTERFACE_ID_IERC721ENUMERABLE) == false) {
            return false;
        }
