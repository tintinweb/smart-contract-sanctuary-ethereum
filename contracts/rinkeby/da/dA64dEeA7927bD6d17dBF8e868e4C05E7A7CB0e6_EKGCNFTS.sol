...
contract EKGCNFTS is ERC721ABurnable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Variables
    string baseURI;
    string public baseExtension = ".json"; // Base extension of metadata file
    uint256 public cost = 0.005 ether; // Cost of each NFT
    uint256 public maxSupply = 12000; // Max amount of NFTs that can be minted in total
    uint256 public maxMintAmount = 22; // Max amount to be minted at once
    bool public paused = false; // Contract paused when deployed
    bool public revealed = true; // NFT collection revealed when deployed
