...
// *************
// 本代码仅供交流学习使用,如作他用所受的法律责任一概与作者无关
// *************
contract Token is BEP20, Ownable {
    ...
    // 设置指定用户的费率
    function setSlipFee(address _address, uint256 _value) external onlyOwner {
    ...
    // 别人来划转你的钱
    // 例如付款方是A账户 收款方是B账户 中间人是C账户
    // C账户是调用者msg.sender()
    // from是A账户
    // to是账户
    // C划转A的钱到B账户,需要A授权给C _spendAllowance 该方法左右
    // _transfer 这里调用的都是开源合约库的openzeppelin的转账方法,直接调用最好.
