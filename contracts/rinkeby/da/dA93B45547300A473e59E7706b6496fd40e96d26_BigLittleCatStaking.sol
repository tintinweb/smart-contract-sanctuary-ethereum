...
// Récupérer quel NFT a été stacké par tel wallet pour pouvoir l'afficher dans le front

contract BigLittleCatStaking {
        ...
        )
    {
        ...
        total = current + stakingStarted[tokenId];
    }
}
