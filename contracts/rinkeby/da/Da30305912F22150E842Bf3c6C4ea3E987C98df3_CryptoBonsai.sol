...
contract CryptoBonsai is ERC721Enumerable, Ownable {
    ...
    function getFgAcc(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 30 && gt <= 50) { fgAcc = 1; }
        if (gt > 51 && gt <= 60) { fgAcc = 2; }
        if (gt > 61 && gt <= 70) { fgAcc = 3; }
        if (gt > 71 && gt <= 80) { fgAcc = 4; }
        if (gt > 81 && gt <= 90) { fgAcc = 5; }
        if (gt > 91 && gt <= 95) { fgAcc = 6; }
