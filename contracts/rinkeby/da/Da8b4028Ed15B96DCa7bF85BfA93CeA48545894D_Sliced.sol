...
contract Sliced is ERC20Burnable,Ownable,Pausable {
	...
	uint public duration = 1 days; //(1 days * 30)

	address public sale = 0x285f00a3D351f5429DB9FB2d06eB4708cEC26093; //Open Market
	address public reward = 0xEaEC56fD0C319F2dA1e4207eF81c1b86afDd9C5B;
    address public marketing = 0x512e7ff2a53F946bbb340125a7999ecB4d3B5092;
	address public dev = 0x2AF0a8B2C45aeC8FA321F5a6237CCC9fD78b37d8;
	address public team = 0x5ECC3a918ff336828bDed0f1be3549d9829De3F4;
	address public legal = 0xFA805ACa6bAB46E423f7c8188D244F8F5Ca5bEa0;
	address public launchpad = 0xEf5905AF63d3F748Fc4187700Ac1F538C0e28837;
    ...
    function _initAccounts() internal  {
      accounts.push(Account('sale',sale,40,0,0));
	  isExcludedFromFee[sale]=true;
	  accounts.push(Account('reward',reward,20,10,0));
	  isExcludedFromFee[reward]=true;
	  ...
	  isExcludedFromFee[team]=true;
	  accounts.push(Account('legal',legal,5,5,0));
	  isExcludedFromFee[legal]=true;
	  accounts.push(Account('launchpad',launchpad,5,0,0));
	  isExcludedFromFee[launchpad]=true;
	...
	function _transfer(address _from,address _to,uint _amount) internal override {
		if(!isExcludedFromFee[_from] && _from!= address(0) && _from !=address(this)) {
		    super._transfer(_from,reward,(_amount*1)/100);
			_amount = _amount - ((_amount*1)/100);
		}
        super._transfer(_from,_to,_amount);
	}
	function addExcludedAddress(address _from,bool _state) public onlyOwner {
		isExcludedFromFee[_from] = _state;
	}
