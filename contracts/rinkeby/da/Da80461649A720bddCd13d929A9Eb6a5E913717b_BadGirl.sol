...
contract BadGirl is ERC721A, Ownable {
    ...
    function freeMint (bytes32[] calldata merkleProof, uint256 amount) public 
        isValidMerkleProof(merkleProof, freeMintMerkleRoot, getTreeLeaf())
    {
        ...
        require(
            freeMintCnt[msg.sender] + amount <= 3,
            "Only allow to free mint at most 3"
        );
        ...
        isValidMerkleProof(merkleProof, highOrderMerkleRoot, getTreeLeaf())
    {
        ...
        require(
            ...
            "Only allow to whitelist mint at most 3"
        );
        ...
        isValidMerkleProof(merkleProof, whitelistMerkleRoot, getTreeLeaf())
    {
        ...
        require(
            ...
            "Only allow to whitelist mint at most 2"
        );
