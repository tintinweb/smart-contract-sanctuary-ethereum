    ...
    ITransferManager
{
    ...
    function checkSignatureLeft(
        LibOrder.Order memory orderLeft,
        bytes memory signatureLeft
    ) public view returns (address) {
        return signatureRecover(orderLeft, signatureLeft);
    }

    function checkSignatureRight(
        LibOrder.Order memory orderRight,
        bytes memory signatureRight
    ) public view returns (address) {
        return signatureRecover(orderRight, signatureRight);
    }
