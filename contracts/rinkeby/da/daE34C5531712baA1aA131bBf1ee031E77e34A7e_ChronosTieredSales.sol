...
import "@flair-sdk/contracts/token/ERC1155/facets/sales/ERC1155TieredSales.sol";
import "./ChronosInventory.sol";

/**
 * @title Chronos - Tiered Sales
 * @notice Sales mechanism for Chronos ERC1155 NFTs with multiple tiered pricing, allowlist and allocation plans.
 *
 * @custom:type eip-2535-facet
 * @custom:category NFTs
 * @custom:provides-interfaces 0x79f33254 0x5ae18a74
 */
contract ChronosTieredSales is OwnableInternal, ERC1155TieredSales {
    using ERC1155TieredSalesStorage for ERC1155TieredSalesStorage.Layout;

    struct Layout {
        address investoryAddress;
    }

    bytes32 internal constant STORAGE_SLOT = keccak256("v1.chronos.contracts.storage.ChronosTieredSales");
    ...
    function setInventoryAddress(address inventoryAddress) external onlyOwner {
        layout().investoryAddress = inventoryAddress;
    }
    ...
    function mintByTier(
        ...
        ChronosInventory(layout().investoryAddress).gameMint(
            _msgSender(),
            ERC1155TieredSalesStorage.layout().tierToTokenId[tierId],
            count,
            ""
