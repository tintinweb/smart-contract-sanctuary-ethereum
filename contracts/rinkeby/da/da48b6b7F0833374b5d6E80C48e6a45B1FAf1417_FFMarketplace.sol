    ...
    AccessControl
{
    ...
    address public burnAddress = 0x000000000000000000000000000000000000dEaD; // lol
        ...
        onlyRole(MARKETPLACE_ADMIN)
    {
        ...
        console.log(WLVendingItem_.startTime, "start time");
        console.log(WLVendingItem_.endTime, "end time");
        ...
        onlyRole(MARKETPLACE_ADMIN)
    {
        ...
        if (_item.itemType == VendingItemType.ERC1155) {
            ...
            require(
                marketItem.balanceOf(address(this), _item.tokenId) > 0,
                "no more erc1155"
            );
            marketItem.safeTransferFrom(
                address(this),
    ...
    */
    ...
    {
        WLVendingItem memory _item = toWLVendingItems[index_];
        // maybe we need some extra info added for the future
    ...
    // accept only from verified contracts
    function _onERC1155Received(
        address from,
        uint256 id,
        uint256 value
    ) private {
        require(from == address(marketItem), "only marketplace item");
    } */
}
