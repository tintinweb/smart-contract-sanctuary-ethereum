...
//940958133523195480507866561284451015376505861017952

contract BHeroDetails {
  ...
  struct Details {
    ...
    function encode(Details memory details) public pure returns (uint256) {
    uint256 value;
    value |= details.id;
    ...
    function decode(uint256 details) public pure returns (Details memory result) {
