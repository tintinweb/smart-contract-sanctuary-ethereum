...
contract PlatziPunksDNA {
    ...
    // TODO: UTILIZAR: https://docs.chain.link/docs/vrf/v2/examples/get-a-random-number/
    ...
    public pure  returns (uint256) {
        ...
        bytes memory encodedParmas = abi.encodePacked(combineParams);
        bytes32 hashesParamas = keccak256(encodedParmas);
        return uint256(hashesParamas);
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    ...
    function mint() public {
        ...
        require(current < maxSupply, "No Platzi Punks Left :C");
...
params = string(abi.encodePacked(
            "accesoryType=",_getAccesoriesType(_dna),
            "&clotheColor=",
                    getClotheColor(_dna),
                    "&clotheType=",
                    getClotheType(_dna),
        ...
        //CAMBIO PARA EVITAR EL LLENADO DEL STACK
        return string(abi.encodePacked(params,"&mouthType=",
                    getMouthType(_dna),
                    "&skinColor=",
                    getSkinColor(_dna),
