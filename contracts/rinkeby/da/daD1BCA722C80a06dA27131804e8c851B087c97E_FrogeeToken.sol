...
contract FrogeeToken is Context, IERC20, Ownable {
    ...
    address private _FrogeeInvestmentFund = 0x424Ea8c2436613d81485cDaea0a28Dc79eb98268;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_FrogeeInvestmentFund] = true;
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_FrogeeInvestmentFund] = _rOwned[_FrogeeInvestmentFund].add(rDev);
        if(_isExcluded[_FrogeeInvestmentFund])
            _tOwned[_FrogeeInvestmentFund] = _tOwned[_FrogeeInvestmentFund].add(tDev);
    }
