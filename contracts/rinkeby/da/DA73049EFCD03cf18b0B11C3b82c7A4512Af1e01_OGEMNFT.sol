...
contract OGEMNFT is ERC721, IOGEMNFT, Ownable {
    ...
    function mint(address account) external payable override returns (uint256) {
        require(msg.value == fee, "ERC721: Not Enough Fee");
        ...
        returns (uint256[] memory)
    {
        ...
        require(msg.value == fee.mul(amount), "ERC721: Not Enough Fee");
        payable(feeWallet).transfer(msg.value);
