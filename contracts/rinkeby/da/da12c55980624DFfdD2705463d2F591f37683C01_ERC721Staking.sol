...
contract ERC721Staking is ReentrancyGuard {
    ...
    uint256 miniStakingTime = 260155;
    uint256 constant apy = 2;
    uint256 month = 2629743;
    uint256 cycle = 86400; //one-day
    ...
    function withdraw(uint256 _tokenId) external nonReentrant {
        ...
        require(
            block.timestamp - stakedTokens[_tokenId].timeOfLastUpdate <= 86400,
            "0x04"
        );
