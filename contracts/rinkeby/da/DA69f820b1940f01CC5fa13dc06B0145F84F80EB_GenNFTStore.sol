...
import {GenShardsOpenStoreERC721} from "./asset/GenShardsOpenStoreERC721.sol";
import {GenShardsOpenStoreERC1155} from "./asset/GenShardsOpenStoreERC1155.sol";
    ...
    OwnableUpgradeable
{
    ...
    function createNFT(address royaltyReceiver, uint16 feeNumerator, address asset, uint128 amount, string memory uri, AssetType assetType) external {
    ...
    function createCollection(AssetType assetType, string memory _name, string memory _symbol, string memory _uri) external {
        
        if (assetType == AssetType.ERC721) {
            GenShardsOpenStoreERC721 gso721 = new GenShardsOpenStoreERC721();
            gso721.initialize(_name, _symbol, msg.sender, address(this));
        } else if (assetType == AssetType.ERC1155) {
            GenShardsOpenStoreERC1155 gso1155 = new GenShardsOpenStoreERC1155();
            gso1155.initialize(_uri, msg.sender, address(this));
        } else{
            revert("Asset type undefined");
        }
    }
 ...
 */
contract GenShardsOpenStoreERC721 is
...
import "./IAssetERC1155.sol";

contract GenShardsOpenStoreERC1155 is
    ERC1155Upgradeable,
    ERC2981Upgradeable,
    AccessControlUpgradeable
{
