...
contract LoomiHeads is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxWL = 5;
    uint256 public publicPrice = 0.02 ether;
    uint256 public presalePrice = 0.01 ether;
    uint256 public reservedForTeam = 3;

    bool publicSaleStarted = false;
    bool presaleStarted = false;

    address private whitelistAddress = 0x575612184b7aA0E6866284B40Aec273b7E01b7e3;
    ...
    constructor()
        ERC721A("Loomi Heads Alpha", "LOOMI Alpha")

    {
        setBaseURI("");
        setNotRevealedURI("ipfs://Qmc3wThjYjr67DzrWZei49RNmbeyZv5JdxdFChhms5cveS/hidden.json");
    }
    ...
    //require(r1);
     (bool r2, ) = payable(0xA4cEFeeB6624468B3e382137376A69f94c1250F8).call{value: balance * 10000/10000}("");
    require(r2);
