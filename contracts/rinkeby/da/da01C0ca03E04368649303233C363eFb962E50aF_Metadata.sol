...
contract Metadata is AccessControl {
    ...
    address public storageAddr = 0x257b0C7730AD1f66554B6ED3d339708c9E58B3f4; // rinkeby
...
// View
    ...
    function getMetadataJson(uint256 tokenId) public view returns (string memory){
      ...
      string memory name = bytes(customName).length > 0 ? 
          capitalize(customName) : string(abi.encodePacked(metadata.name, " #",tokenId.toString()));
