...
error newtransferfailerror();
error raffle_notopen();
error raffleupkeepnotneeded(uint256 balance, uint256 playerslength, uint256 rafflestate);
...
contract raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    uint32 private constant c_num_words = 1;
    ...
    event rafflewinner(uint256 indexed request_id);
    event winnerpicked(address indexed winner);

    //***************************VRF COORDINATOR V2 INTERFACE *************************** *//
        ...
        )
    {
        ...
        bool timepass = ((block.timestamp - s_lasttimestamp) > i_timeinterval);
    ...
    //     );
    //   }
    //   // address consumer = address(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
    //   s_rafflestate = rafflestate.calculating;
    //   // i_vrfCoordinator.addConsumer(i_subscription_id, msg.sender);
    ...
    function getsubsid() public view returns (uint64) {
        return i_subscription_id;
    }

    function getvrf() public view returns (VRFCoordinatorV2Interface) {
