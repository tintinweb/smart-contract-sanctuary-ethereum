...
contract RelicPunks is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	constructor(
        ...
        punkNames = ["Pixel Perfect", "Amped Ape", "Teacher's Pet", 
                     ...
                     "Loud Mouth", "Surprise", "4609", "football", "gameboy", "mag", 
                     "ticked", "tiffany"];
    ...
    function ownerMint(uint256 punk) public nonReentrant onlyOwner {
        require(punk >= 0 && punk <= 35, "invalid punk ID");
    ...
    function generateDescription() private pure returns (string memory) {
        string memory description = "The Relic Punks are a 35 piece tribute to important cultural technology of the past."
