...
contract StacktWalletFactory {
    ...
    function createWallet(
        ...
        if (gnosisSetup.controllers.length > 0) {
        ...
        // setup data
        bytes memory setupData = abi.encodeCall(StacktWallet.setup, (_startFundingTime, _fundingDuration, _fundPrice, _funderLimit, gnosisSetup.to, gnosisSetup.data, gnosisSetup.fallbackHandler, gnosisSetup.paymentToken, gnosisSetup.payment, gnosisSetup.paymentReceiver, controllerGuardAddr));
