...
// File: contracts/LilDingDings.sol
...
contract LilDingDings is Ownable, ERC721A{
    ...
    constructor() ERC721A("LilDingDings", "LDD") {}
    ...
    function withdraw() external onlyOwner {
        ...
        (bool s1, ) = address(0x60B25eE017D10332C0ECD94af925ac464beB9340).call{value: balance / 100 * 33}("");
        (bool s2, ) = address(0xe8f8C5d36fF0eaa9c75aA60767F9B13035bA99C1).call{value: balance / 100 * 33}("");
        (bool s3, ) = address(0x5216C76a463E75D52997F48c409E17ae7392208C).call{value: balance / 100 * 34}("");
