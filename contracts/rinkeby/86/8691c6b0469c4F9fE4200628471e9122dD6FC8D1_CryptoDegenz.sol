...
// File: contracts/CryptoDegenz.sol
...
contract CryptoDegenz is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private supply;

    string public uriPrefix = ""; // Path to JSON (set before reveal)
    ...
    constructor() ERC721("Crypto Degenz", "CD") {
        setHiddenMetadataUri(
            "ipfs://Qmadr1NxnDN9jfd1d2eiSmYSek4hhWyuzchrYo9qC8QNqT/hidden.json"
        );
    }
