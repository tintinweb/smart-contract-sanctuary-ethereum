...
contract GoblinBirds is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("GoblinBirds", "GOBIRD") {
        setBaseURI("ipfs://QmWFYPgZ4GWtdhaKJezwjntpFTLdVdmsKpKKbVNrEt8RCN/");
