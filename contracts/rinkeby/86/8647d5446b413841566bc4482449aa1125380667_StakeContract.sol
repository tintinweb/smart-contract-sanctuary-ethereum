...
library SafeMath {
  ...
  //StakeWithAmd
   ...
   function withdrawInWolve(uint256 count) public {
        ...
        require(user.stakerecord[count].migrated != true,"You canot withdraw migrated stake from Wolverinu.");
    ...
    function extendStake(uint256 count,uint256 newplan) public {
       ...
       User storage user = users[msg.sender];
        ...
        require(user.stakerecord[count].migrated = true,"You canot extend migrated stake.");
