...
// | $$\  $$$| $$         | $$         | $$    $$| $$  | $$| $$  | $$| $$  \ $$ /$$  \ $$| $$      
// | $$ \  $$| $$         | $$         |  $$$$$$/|  $$$$$$/|  $$$$$$/| $$  | $$|  $$$$$$/| $$$$$$$$
// |__/  \__/|__/         |__/          \______/  \______/  \______/ |__/  |__/ \______/ |________/
//                                                                                                 
//                                                                                                 
//                                                                                                 
//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 10 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRipAmoZxsgBy6cu4DoSW5i4sY9UGNbTkcfnwwfMWX5SX/";
...
// File: contracts/NftCourseCryptoKittensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftCourseCryptoKittensContract is RamppERC721A {
    constructor() RamppERC721A("NFT Course Crypto Kittens", "NFTCKITTEN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/TyTk7MEzf3yzIhBHepYK/contract-metadata";
    }
}
