...
contract ThreeGMAIPFP is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmPezNm2TY145vbMA3W3yB9wdqacEmydzLUEhestQyTUCP/";
    ...
    function orderedMint(address[] calldata _to, uint256[] calldata _amount) external onlyOwner {
        require(_to.length == _amount.length, "DL");
