...
contract Sttest is ERC721, PullPayment, Ownable {
    ...
    constructor() payable ERC721("Sttest", "ST") {
        mintPrice = 0.02 ether;
        totalSupply = 0;
        maxSupply = 1000;
        maxPerWallet = 3;
        withdrawWallet = payable(0x2EFE9Ea81Ffd354648543e2a4CE519E954e11584);
    }
