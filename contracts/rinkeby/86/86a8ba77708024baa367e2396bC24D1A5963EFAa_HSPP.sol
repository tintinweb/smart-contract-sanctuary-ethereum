...
contract HSPP is ERC721Enumerable, Ownable  {
    ...
    uint256 public _maxperTX = 100;                    // Max per mint
    uint256 public _maxperWalletWaitList = 1;        // Waitlist max mint per wallet
    uint256 public _maxperWalletMint = 100;            // Mint max Mint per wallet
    ...
    constructor(string memory initbaseURI, address _fundWallet) ERC721(" Genesis", "HSPP")  {
