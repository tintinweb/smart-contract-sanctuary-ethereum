...
*/                                                                   
   ...
   */
  function mintForAddress(address _receiver,uint256 _mintAmount) public mintCompliance(_receiver) onlyOwner {
    _safeMint(_receiver,_mintAmount);
  }

  /**
   * Admin - Mint comic book pages to a specified address
   */
