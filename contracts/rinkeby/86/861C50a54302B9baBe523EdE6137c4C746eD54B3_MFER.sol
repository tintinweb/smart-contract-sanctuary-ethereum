...
contract MFER is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    //uint256 private maxCapPerWallet = 8;                 //per address holding 
    // address internal royaltyPayee;
    // uint256 internal royaltyFee = 995;
    bool private startSale = true;
    //bool private  isRoyalty = true;
    string internal baseuri = "https://gateway.pinata.cloud/ipfs/QmYc1ShmrR1fc6Vz6LycXiNq8oqjzaEw6thSwBdEfMSGx7/";
    
    constructor() ERC721("MFER FRIENDS", "MFRIENDS") {
        NFTPrice = 0.02 ether;                    
        NFTMaxSupply = 6666;
        //royaltyPayee = msg.sender;
    }
    ...
    // function setRoyaltyPayeeAndFees(address _royaltyPayee, uint256 _royaltyFee) public onlyOwner() {
    //     royaltyPayee = _royaltyPayee;
    //     royaltyFee = _royaltyFee;
    // }

    // function setIsRoyaltyOn() external onlyOwner {
    //         isRoyalty = !isRoyalty;
    // }
    ...
    // function updatemaxCapPerWallet(uint256 maxCap_) external onlyOwner {
    //     maxCapPerWallet = maxCap_;
    // }
    ...
    function mint(uint256 _countNfts) public payable whenNotPaused {
        ...
        // if (msg.sender != owner()){
        // require(balanceOf(to) + _countNfts <= maxCapPerWallet, "Max limit holding per wallet");       
        // }
    ...
    //     (bool success1, ) = payable(royaltyPayee).call{ value: _royaltyFee } ("");
    //     require(success1);
    // }
    ...
    function transferFrom(
        ...
        // require((balanceOf(to) + 1) <= maxCapPerWallet, "Max limit holding per wallet");       
        // }

        //Pay royality to payee
        // if (msg.value > 0 && isRoyalty){
