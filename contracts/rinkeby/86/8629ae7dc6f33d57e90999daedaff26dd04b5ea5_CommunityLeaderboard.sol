...
contract CommunityLeaderboard is Ownable {
...

    {
        ...
        return (
            ...
            leaderboard.timeRemaining,  //added
    ...
    function createLeaderboardNftRequired(uint256 _projectId, string memory _leaderboardName, uint256 _time, uint256 _timeRemaining, uint256 _nftsRequired) public {
        require(projectIdToProject[_projectId].owners[msg.sender] == true, "You are not an owner of this project.");
        ...
        newLeaderboard.timeRemaining = _timeRemaining; 
        newLeaderboard.nftRequired = true;
        newLeaderboard.numberOfNftsRequired = _nftsRequired;


        //get rid of time remaining 

        //Calculate remaining time and reset leaderboard once timer is over - added
        _timeRemaining = newLeaderboard.blockEnd - _time;

        projectIdToProject[_projectId].numberOfLeaderboards = projectIdToProject[_projectId].numberOfLeaderboards.add(1);

        emit createNftRequiredLeaderboard(_leaderboardName, _projectId, newLeaderboard.leaderBoardId, newLeaderboard.leaderboardCount, newLeaderboard.epoch, newLeaderboard.nftRequired, _nftsRequired);
    }

    function createLeaderboardOpen(uint256 _projectId, string memory _leaderboardName, uint256 _time, uint256 _timeRemaining) public {
        require(projectIdToProject[_projectId].owners[msg.sender] == true, "You are not an owner of this project.");
        ...
        newLeaderboard.blockStart = block.number;
        newLeaderboard.blockEnd = block.number + _time;
        newLeaderboard.timeRemaining = _timeRemaining;  //added
        ...
        emit createOpenLeaderboard(_leaderboardName, _projectId, newLeaderboard.leaderBoardId, newLeaderboard.leaderboardCount, newLeaderboard.epoch, newLeaderboard.nftRequired);
    }
