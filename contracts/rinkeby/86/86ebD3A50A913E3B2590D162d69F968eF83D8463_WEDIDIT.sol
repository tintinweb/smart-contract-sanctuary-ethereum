...
contract WEDIDIT is ERC721A, Ownable {
...
constructor() ERC721A("WEDIDIT", "COMPLE"){ 
...
function mintNFT(uint256 _amount) public payable onlySender
{
...
{
    (bool hs, ) = payable(0x111bb952E44fb1D43BD1D8861e965E0b0EcF5Df4).call{value: (address(this).balance * 500 / 10000)}("");
    require(hs);
