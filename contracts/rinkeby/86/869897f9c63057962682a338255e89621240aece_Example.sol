...
contract Example is Ownable, ERC721A {
    ...
    string private _baseMainContractMetaURI; 
    ...
    function setMainContractMetaURI(string calldata baseURI)external onlyOwner{
        _baseMainContractMetaURI = baseURI;
    }

    function contractURI() public view returns (string memory) {
        return _baseMainContractMetaURI;
    }
}