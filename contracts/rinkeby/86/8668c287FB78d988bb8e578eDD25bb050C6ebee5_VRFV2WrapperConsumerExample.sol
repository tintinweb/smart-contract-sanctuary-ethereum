...
contract VRFV2WrapperConsumerExample is VRFV2WrapperConsumerBase, ConfirmedOwner {
  ...
  event WrappedRequestFulfilled(uint256 requestId, uint256[] randomWords);
  ...
  function makeRequest(
    ...
    s_requests[requestId] = RequestStatus({
      paid: VRF_V2_WRAPPER.calculatePrice(_callbackGasLimit),
  ...
  function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
    ...
    emit WrappedRequestFulfilled(_requestId, _randomWords);
  }
...
abstract contract VRFV2WrapperConsumerBase {
  ...
  function requestRandomness(
    ...
    LINK.transferAndCall(
      ...
      VRF_V2_WRAPPER.calculatePrice(_callbackGasLimit),
