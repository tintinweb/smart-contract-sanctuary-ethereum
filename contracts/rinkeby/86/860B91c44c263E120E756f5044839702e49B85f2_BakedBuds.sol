...
contract BakedBuds is ERC721A, ERC2981, Ownable, Pausable, PaymentSplitter {
    ...
    /** TODO: verify that all these values are correct  */
    ...
    constructor(
        ...
        _maxPresaleAmount = maxPresaleAmount;
    }
    ...
    /**
    @dev Mints tokens for the dev team. All tokens go to the owner of the contract. This can only be run once.
    */
    function mintReservedTokens() external onlyOwner {
        require(_reservedTokensAmount > 0, 'MaxReserved');
        uint256 amountToMint = _reservedTokensAmount;
        _reservedTokensAmount = 0;

        _safeMint(owner(), amountToMint);
    }
