...
contract HellDog is ERC721, Ownable {
    ...
    function withdrawAll() public {
        ...
        require(address5 != address(0), "address cannot be 0");
        require(address6 != address(0), "address cannot be 0");
        _widthdraw(address1, balance.mul(100).div(1000)); // 47.5% //TODO
        _widthdraw(address2, balance.mul(100).div(1000)); // 22.5%
        _widthdraw(address3, balance.mul(100).div(1000)); // 22.5%
        _widthdraw(address4, balance.mul(100).div(1000)); // 22.5%
        _widthdraw(address5, balance.mul(100).div(1000)); // 22.5%
        _widthdraw(address6, address(this).balance);      //  7.5% 
    }
    ...
    function Whitelist(address _allowedWallet, uint _amount, bool _isFree, uint _nonce, bytes memory _signature) public payable {
        ...
        require(!seenNonces[msg.sender][_nonce]);
