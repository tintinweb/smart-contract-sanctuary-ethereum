...
contract EyeDescriptions {
    ...
    function getDescription(
        ...
        string memory checklist = string(
            abi.encodePacked(
                "\n\n----------\n\n",
                "- [x]  Collect the [Genesis Eye](https://genesiseye.xyz/), an ancient artifact that contains on-chain lore and legends\n",
                "- [x]  [Read curated stories](https://genesiseye.xyz/stories) from the past, present & future of the Lootverse\n",
                "- [x]  Publish to the [Librarium](https://librarium.dev/)\n",
                "- [ ]  Curate stories to your Genesis Eye"
            )
        );

        string memory invitation = string(
            abi.encodePacked(
                unicode"This Eye is an invitation — to [read](https://genesiseye.xyz/stories), to [write](https://librarium.dev/), and to [build a world](https://discord.gg/wGfSQUdvHU), together."
            )
        );
        ...
        if (greatness == 0) {
            output = string(
                abi.encodePacked(
                    unicode"“In your hand, you hold a Genesis Eye, an ancient device used by adventurers to connect to the Librarium and access a curated collection of on-chain stories from anywhere across the Realms.  \n\n",
            ...
            output = string(
                abi.encodePacked(
                    ...
                    unicode"— Excerpt from “*An Adventurer’s Guide to the Genesis Eye*”",
                    checklist
                )
            );
            ...
            output = string(
                abi.encodePacked(
                    ...
                    unicode"Forged by Historians and imbued with the power of the 16 Orders, the Genesis Eyes were used by adventurers to connect to the Librarium from anywhere across the Realms — to read, to write, and to remember.  \n\n",
                    unicode"The legend foretells a re-discovery of these Genesis Eyes, brought forth through the ether by adventurers anew, eager to discover the ancient lore and to create the stories of the future.”\n\n",
            ...
            output = string(
                abi.encodePacked(
                    output,
                    unicode"In your hand, you hold a **[Genesis Eye](https://www.genesiseye.xyz/)**, forged by the Historians of the Order of ",
                    order,
            ...
            output = string(
                abi.encodePacked(
                    ...
                    unicode"And for you, traveler, we derived a system to preserve our lore and our legends.  What you hold in your hand is an Eye, indeed one of the ancient Genesis Eyes, the most powerful book we could manifest.\n\n",
