...
pragma solidity >0.5.16 < 0.9.0;
 ...
 contract ShazTokenCappedCrowdsale is Crowdsale ,MintedCrowdsale,CappedCrowdsale{

        using SafeMath for uint256;

        //deliverTokens Params
        // address public _benificery;
   ...
   constructor(uint256 rate_, 
    ...
    function _updatePurchasingState(address beneficiary, uint256 weiAmount) internal override(Crowdsale,CappedCrowdsale) {
    }

    function _updadatePurchasingState(
