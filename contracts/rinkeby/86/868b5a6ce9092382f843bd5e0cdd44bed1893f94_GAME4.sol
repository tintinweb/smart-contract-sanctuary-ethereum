...
contract GAME4 is Ownable {
    ...
    function isPlayerOwner(address account) public view returns(bool) {
        return NFT(players[account].currentContract).ownerOf(players[account].currentNFTNumber) == msg.sender;
    } 
    ...
    function joinGame() public payable {
        ...
        require(isPlayerOwner(msg.sender) == true, "you do not own the nft registered to you, please clear your account and add a new nft");
