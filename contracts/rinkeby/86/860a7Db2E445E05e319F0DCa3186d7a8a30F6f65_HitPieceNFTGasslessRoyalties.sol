...
import "./extensions/IHPApprovedMarketplace.sol";
import "./extensions/IHPMarketplaceMint.sol";

import "hardhat/console.sol";

contract HitPieceNFTGasslessRoyalties is  ERC2771Context, ERC721URIStorage, ERC2981, Ownable, IHPApprovedMarketplace, IHPMarketplaceMint {
  ...
  event TracingUsers(address sender, address owner, address trustedForwarder);

  constructor(address hitpiecePlatformWallet, address _trustedForwarder) ERC2771Context(_trustedForwarder) ERC721("HitPieceNFT3.0", "HPT3.0") ERC2981() {
    trustedForwarder = _trustedForwarder;

    _setDefaultRoyalty(hitpiecePlatformWallet, 500);
  }
  ...
  function adminMint(
    ...
    emit TracingUsers(msg.sender, owner(), trustedForwarder);
...
interface IHPApprovedMarketplace {

  function setApprovedMarketplaceActive(address marketplaceAddress, bool approve) external;
