...
contract TigerToken is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(address initSigner, address initFZTAddress, uint256 maxAmountPerMint, uint256 maxCollection) ERC721A("TigerToken", "TTT", maxAmountPerMint, maxCollection) {

        signer = initSigner;
        
        FSToken = CatToken(initFZTAddress);
