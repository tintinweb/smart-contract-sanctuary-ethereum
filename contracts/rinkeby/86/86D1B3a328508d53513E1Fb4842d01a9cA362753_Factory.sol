...
contract Factory is Ownable {
    ...
    uint256 public increasePerInterval;
    INFT public nft;
    ...
    constructor(address _nft) {
        ...
        interval = 600;
        increasePerInterval = (endPrice - startPrice) / (36000 / interval);
    }
    ...
    function getCurrentPrice() public view returns(uint256) {
        uint256 passedIntervals = (block.timestamp - startBlock) / interval;
        uint256 price = startPrice + passedIntervals * increasePerInterval;
        if (price > endPrice) {
            return endPrice;
        }
    ...
    function mint(address _to, uint256 _numberOfTokens) external payable {
        ...
        require(currentPrice * _numberOfTokens == msg.value, "Ether value is not correct.");
