...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x981e43D118170225ba3E3D3c2C695b34075CA2C6;
...
contract LUNA20 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4f247c3805c1fA9099660B08D65F19ffd254a422;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Luna 2.0";
    string private _symbol = "LUN2";
