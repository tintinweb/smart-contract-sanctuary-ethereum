...
contract UnitedKredi is ERC1155Supply, Ownable   {


    address constant public KrediAddress = 0x23B68541E80983ce3eeab1557cbb61129cd8c35a;
    address constant public UnitedPunksUnionAddress = 0x4762A7559cB17c55Dd899c43F819f5A32e579148;
    address constant public BurnAddress = 0x000000000000000000000000000000000000dEaD;
    bool public saleIsActive = true;
    uint private _tokenId = 3;
    ...
    function totalAvailable(address ownwer) external view returns (uint) {
        uint value = KrediInterface(KrediAddress).balanceOf(ownwer);
        return value;
    }
    ...
    function mint(uint numberOfTokens) public  {
        ...
        uint valueHold = KrediInterface(KrediAddress).balanceOf(msg.sender);
        require(TOKEN_PRICE * numberOfTokens <= valueHold, "Value is not correct");
        uint punks = UnitedPunksUnion(UnitedPunksUnionAddress).balanceOf(msg.sender);
        require(punks > 0, "Value of punks is not correct");
        uint value = TOKEN_PRICE * numberOfTokens;
        KrediInterface(KrediAddress).transferFrom(msg.sender,BurnAddress,value);
