...
contract mypfp is ERC721Enumerable,Ownable{
    ...
    constructor(string memory uri) ERC721("TestAZUKI","TZUKI") {
        basicUri = uri;
    }
    receive() external payable{}
    fallback() external payable{}
    function setMaxPerMint(uint number) external onlyOwner {
        maxPerMint=number;
    }
    ...
    function mintInBatch() external{
        require(mintable,"you cannot mint for now");
        for(uint256 i = 0; i < maxPerMint; i++) {
