 ...
 */
contract WorldMetadataProxyV1 is ITokenURIProxy {
    string public constant SUFFIX = ".xr";
    ...
    function tokenURI(uint256, string memory _name, string memory _customImage) external pure returns (string memory) {
        ...
        string memory metadata = string(abi.encodePacked(
            "{",
                ...
                EncodeUtils.attributeNameAndValue("description", "Ownership deed of VeVerse world", false, false),
    ...
    */
    function _compileAttributes() internal pure returns (string memory) {
        string memory _type = "VeVerse World";
        return string(abi.encodePacked(
            "[",
