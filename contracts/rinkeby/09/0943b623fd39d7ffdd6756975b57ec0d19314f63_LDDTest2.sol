...
contract LDDTest2 is Ownable, ERC721AQueryable, ERC721ABurnable, EIP712 {
    ...
    ) ERC721A("LDDFrensTest2", "LDD") EIP712("LDDVoucher", "1") {
        require(_operator != address(0));
        signers[msg.sender] = true;
        signers[_operator] = true;
