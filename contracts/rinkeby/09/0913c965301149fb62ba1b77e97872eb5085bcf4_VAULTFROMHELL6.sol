...
contract VAULTFROMHELL6 is Ownable, IERC721Receiver {
    struct vaultInfo {
        IERC721 nft;
        string name;
    }
    ...
    function _stakeBGF(uint256[] calldata tokenIds) internal {
        ...
        addrTotalFamiliars[msg.sender] = IERC721(familiars).balanceOf(msg.sender);
    ...
    function _claim(uint256[] calldata tokenIds, bool _unstake) internal {
        ...
        uint256 userFamiliars = addrTotalFamiliars[msg.sender]; // IERC721(familiars).balanceOf(msg.sender);
