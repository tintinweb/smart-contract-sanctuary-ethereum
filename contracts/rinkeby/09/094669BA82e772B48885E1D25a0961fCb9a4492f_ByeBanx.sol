...
contract ByeBanx is Ownable, ERC721A, ReentrancyGuard {
    ...
    string public baseURI = "ipfs://QmRLy9NtUyUSs811q7MLD9N2Rt3K49wgRg92vBiznR6Nxz/";
...
// TODO: edit to support second group whitelist to mint 4 
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory){
        ...
        uint256 tkId = (tokenId % 7) + 1;
        return bytes(currentBaseURI).length > 0 ? string(abi.encodePacked(baseURI, tkId.toString(), ".json")) : "";
    }
