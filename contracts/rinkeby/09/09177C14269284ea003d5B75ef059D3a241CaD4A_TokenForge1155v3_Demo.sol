...
contract TokenForge1155v3 is ERC1155Burnable, ERC1155Supply, Ownable, AccessControlEnumerable {
    ...
    modifier tokenIsNotDefined(uint256 tokenId) {
        require(!isTokenDefined(tokenId), "TokenForge1155v3: token is already defined");
        _;
    }
...
contract TokenForge1155v3_Demo is TokenForge1155v3 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(TokenForge1155v3) returns (bool) {
        return super.supportsInterface(interfaceId);
    }
}