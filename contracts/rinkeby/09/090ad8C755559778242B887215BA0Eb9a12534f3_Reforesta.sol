...
contract Reforesta is ERC721A, Ownable, Pausable {
    ...
    address public reforestaWallet1;
    address public reforestaWallet2;

    uint256 public reforestaFeePercent1;
    uint256 public reforestaFeePercent2;
     ...
     * @param _reforestaWallet1 The reforesta wallet address
     * @param _reforestaWallet2 The reforesta wallet address
     */
    function setWallet(address _reforestaWallet1, address _reforestaWallet2)
        external
        onlyOwner
    {
        reforestaWallet1 = _reforestaWallet1;
        reforestaWallet2 = _reforestaWallet2;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(reforestaWallet1).transfer(
            (balance * reforestaFeePercent1) / totalFeeUnitPercent
        );
        payable(reforestaWallet2).transfer(
            (balance * reforestaFeePercent2) / totalFeeUnitPercent
        );
    }

    /**
     * @dev Set fund distribution percent
     * @param _reforestaFeePercent1 The reforesta fund percent
     * @param _reforestaFeePercent2 The reforesta fund percent
     * @param _totalFeeUnitPercent The total fee unit percent
     */
    function setFee(
        uint256 _reforestaFeePercent1,
        uint256 _reforestaFeePercent2,
        uint256 _totalFeeUnitPercent
    ) external onlyOwner {
        reforestaFeePercent1 = _reforestaFeePercent1;
        reforestaFeePercent2 = _reforestaFeePercent2;
