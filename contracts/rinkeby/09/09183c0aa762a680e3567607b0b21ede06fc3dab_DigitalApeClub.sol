...
contract DigitalApeClub is ERC721A, Ownable {
    ...
    uint private constant mintCost_ = 0.0007 ether;
    
    //maximum amount of mints allowed per person
    uint256 public constant maxMint = 4;
    ...
    uint private maxReservedMints = 150;
    ...
    constructor() ERC721A('Digital Ape Club', 'DAC') {
        maxTotalTokens = 7777;

        unrevealedURI = "ipfs://QmZN8fQJhHBBAAXQpfoPq1cRYrKarvwmoRgCdPweJKyZGb/";
    }
    ...
    */
    ...
    function presaleMint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        ...
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 0.065 ether each NFT)");
    ...
    function publicSaleMint(uint256 number) public payable {
        ...
        require(totalSupply() + number <= maxTotalTokens - (maxReservedMints - _reservedMints), "Not enough NFTs left to mint..");
        require(mintsPerAddress[msg.sender] + number <= maxMint, "Maximum 4 Mints per Address allowed!");
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 0.08 ether for each NFT)");
    ...
    function withdraw() public onlyOwner {
        ...
        _withdraw(payable(0x8d8bc9AbA71f929CE28cdEDDA5B829d919eA2BaC), balance); 
    }
