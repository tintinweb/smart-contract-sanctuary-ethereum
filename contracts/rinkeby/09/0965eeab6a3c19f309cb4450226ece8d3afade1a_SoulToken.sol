...
contract SoulToken is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    /// @return
    function pendingConfirmByIndex(address _party, uint256 index) public view virtual returns(bytes32) {
    ...
    /// @return
    function pendingConfirmIndexByHash(address _party, bytes32 _hashId) public view virtual returns(uint256) {
