...
//Developer Info:
//Written by Archaic Shell Babies (ArchaicSB)
//Instagram and Twitter: @ArchaicSB_
...
contract ArchaicShellBabiesNFT is Ownable, ERC721 {
    ...
    address public dev_wallet = 0x30d50d64A4788D8BD599a338EeC3E2F871727f71;

    string public baseURI;
    mapping(address => bool) private presaleList;
    constructor() ERC721("ArchaicShellBabiesNFT", "ArchaicSB"){}

   function mint(uint _count) public payable{
        require(_count > 0, "mint at least one token");
        require(_count <= 3, "Max of 3 Mints Per Wallet Allowed.");
   ...
   function mint_Presale(uint _count) public payable{
        require(_count > 0, "mint at least one token");
        require(_count <= 0, "Max 0 Allowed.");
        require(totalSupply + _count <= maxSupply, "Not enough tokens left");
        require(msg.value == tokenPrice * _count, "incorrect ether amount");
        ...
        require(pause_sale == true, "Sale is Paused.");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 100 / 100);
