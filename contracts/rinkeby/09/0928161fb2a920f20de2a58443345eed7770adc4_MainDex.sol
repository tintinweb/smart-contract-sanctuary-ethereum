...
contract MainDex is Ownable, DexStorage {
  ...
  function init() public {
    ...
    LPBNB=LPInterface(0x000C6843Be0b17FB61ed1a8465b2fA2bac0cFCb2); //LPETH
   ...
   emit CollectionsConfigured(0x326Cae76A11d85b5c76E9Eb81346eFa5e4ea7593, 0x5F2853FCC02c0c3366249aD120Af33eD77D31f00);
    BUSD = IERC20(0xD92E713d051C37EbB2561803a3b5FBAbc4962431);
    BNB= IERC20(0xc778417E063141139Fce010982780140Aa0cD5Ab);
    _supportNft[address(this)] = true;
    
    a = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
