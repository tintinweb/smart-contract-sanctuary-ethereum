...
contract OneWar is IOneWar, OneWarModifier, ERC721 {
    ...
    uint256 public MAX_SUPPLY = 10_000; // TODO: Change to constant before the mainnet deployment

    uint256 public constant SCOUTING_COST = 1 * 10**16; // TODO: Change this value before the mainnet deployment
    uint256 public constant SCOUTING_DURATION = 4;
    uint256 public constant MAX_SCOUTING_DURATION = 255;

    uint256 public constant AVERAGE_SANCTUARY = 1;
    uint256 public constant AVERAGE_TREASURE = 5000;
    uint256 public constant AVERAGE_MINERS = 100;

    uint256 public constant MINING_RATE = 4 * 10**16;
    ...
    uint32 public constant PREWAR_DURATION = 100;
        ...
        isLocationSettled(_defendingSettlement)
    {
        ...
        if (_soldiers > settlements[_defendingSettlement].soldiers) {
            ...
            settlements[_defendingSettlement].glory +=
                (attackerAssets.soldiers - _soldiers) *
                SOLDIER_COST + // attacker soldiers lost
                (attackerAssets.catapults - _catapults) *
                CATAPULT_COST; // attacker catapults lost
            settlements[_attackingSettlement].glory +=
                defenderAssets.soldiers *
                SOLDIER_COST + // defender soldiers lost
                defenderAssets.towers *
                TOWER_COST; // defender towers lost
            ...
            settlements[_defendingSettlement].soldiers -= _soldiers;
            settlements[_defendingSettlement].catapults += _catapults; // defender gets attacker's remaining catapults
    ...
    /**
     * Plaque inscribed with a particular Settlement's traits.
     */
    ...
    /**
     * Discover a particular Settlement's traits.
     */
    ...
    /**
     * Whether a voyager is a certain Settlement's
     * ruler or co-ruler.
     */
    ...
    /**
     * Whether a specific area has been settled or
 ...
 * The glory of settlements is measured in bloodshed.
 */
