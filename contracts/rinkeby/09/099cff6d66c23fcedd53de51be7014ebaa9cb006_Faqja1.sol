...
contract Faqja1 is ERC1155, Ownable, Pausable {
  ...
  constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmU92dJzigsjfr8vji7CUXMGguHFXB5qieNmnKWawZKyud/{id}.json") {
    name = "Faqja";
    symbol = "FQJA";
  }
  ...
  function uri(uint256 tokenId) public override view returns (string memory){
    return (
      string(abi.encodePacked(
        "https://gateway.pinata.cloud/ipfs/QmU92dJzigsjfr8vji7CUXMGguHFXB5qieNmnKWawZKyud/",
