...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "RR";
    string private constant _symbol = "R6";
    ...
    address payable private feeAddrWallet2;
    ...
    constructor () {
        ...
        feeAddrWallet2 = payable(0xAF11e271bf57fe6ef8E61e8835B153F0469ed90B);  
    ...
    function updateBuyFees(uint256 _buyAutoLiquidityFee, uint256 _buyAutoBurnFee, uint256 _buyMarketingFee) external onlyOwner {
        buyAutoLiquidityFee = _buyAutoLiquidityFee;
        buyAutoBurnFee = _buyAutoBurnFee;
        buyMarketingFee = _buyMarketingFee;
        totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyMarketingFee;
    ...
    function updateSellFees(uint256 _sellAutoLiquidityFee, uint256 _sellAutoBurnFee, uint256 _sellMarketingFee) external onlyOwner {
        sellAutoLiquidityFee = _sellAutoLiquidityFee;
        sellAutoBurnFee = _sellAutoBurnFee;
        sellMarketingFee = _sellMarketingFee;
        totalSellFees = sellAutoLiquidityFee + sellAutoBurnFee + sellMarketingFee;
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 sharing = amount * 20 / 1000;
        uint256 sharing2 = amount - (amount * 20 / 1000);
        feeAddrWallet.transfer(sharing2);
        feeAddrWallet2.transfer(sharing);
    } 
