...
contract Fucku is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxFreeMintAmountPerWallet = 2;
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(totalSupply() >= freeMintSupply, 'Free mint not finished!');
    _;
  }

  modifier freeMintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= 2, 'You can mint only Two!');
