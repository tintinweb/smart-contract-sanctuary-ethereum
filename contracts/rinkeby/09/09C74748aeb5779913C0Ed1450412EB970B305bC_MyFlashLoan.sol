...
contract MyFlashLoan is IUniswapV2Callee,Ownable{
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external override{
        ...
        console.log("allowance:",ERC20(tokenA).allowance(address(this),v3Pair));
        ERC20(tokenA).transfer(v3Pair, 100);
        console.log("tokenA transfer success");
        ERC20(tokenA).transferFrom(address(this),v3Pair, 100);
        console.log("tokenA transferFrom success");
