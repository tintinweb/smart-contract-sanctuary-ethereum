...
contract GutterArt is ERC1155Burnable, Ownable, ReentrancyGuard {
	...
	constructor(address _signerAddress) ERC1155(_baseTokenURI) {
		minter = msg.sender;
		signer = _signerAddress;

		// allow already existing arts minting
		setIDRangeAllowed(1, 32, true);
	}
	...
	function mint(
		...
		require(hashTransaction(msg.sender, nftID, quantity, nonce) == hash, "wrong hash");
