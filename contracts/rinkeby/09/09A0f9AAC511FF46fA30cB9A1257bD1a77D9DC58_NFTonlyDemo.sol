...
import "../contract-libs/MerkleProof.sol";
...
contract NFTonlyDemo is ERC721A, Ownable, MerkleProof, ReentrancyGuard {
    ...
    //
    // Check token from the wallet owner
    //
...
contract MerkleProof {
  ...
  // source : https://github.com/binodnp/openzeppelin-solidity/blob/master/contracts/cryptography/MerkleProof.sol
  // add manualy because can inherit the contract from openzeppelin
}
