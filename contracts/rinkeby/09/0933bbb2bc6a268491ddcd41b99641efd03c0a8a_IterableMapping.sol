...
contract Brn is ERC20, Ownable {
    ...
    BRNDividendTracker public dividendTracker;
    ...
    event BrnRoarChange(bool indexed newValue, bool indexed oldValue);
    ...
    constructor()  ERC20("BRN", "BRN") {
        liquidityWallet = address(0xC62a5571760dC41f00cE3b481983cdB32c0c9101);
    	marketingWallet = address(0x8deAe4978a84655721617b4BeA58Ad579442a3D6);
    	salaryWallet = address(0xb77ffdd85a08850D2Ab32A3EC5eE26b40a588c50);
    	buyBackWallet = address(0x04FC3f1f23977610b61F10Cb4FBda47652f4e7d1);
    	
    	dividendTracker = new BRNDividendTracker();
    ...
    function cancelLaunch() public onlyOwner {
        require(this.isInLaunch(), "BRN: Launch is not set");
    ...
    function setBrnRoar() public onlyOwner {
        require(!this.isInRoar(), "BRN: Roar is already set");
        require(isTradingEnabled, "BRN: Trading must be enabled first");
        require(!this.isInLaunch(), "BRN: Must not be in launch period");
        emit BrnRoarChange(true, false);
        _roarStartTimestamp = _getNow();
    }
    function cancelBrnRoar() public onlyOwner {
        require(this.isInRoar(), "BRN: Roar is not set");
        emit BrnRoarChange(false, true);
        _roarStartTimestamp = 0;
    }
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BRN: The dividend tracker already has that address");
        BRNDividendTracker newDividendTracker = BRNDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "BRN: The new dividend tracker must be owned by the BRN token contract");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BRN: Automated market maker pair is already set to that value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFee[account] != excluded, "BRN: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTransactionLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTransactionLimit[account] != excluded, "BRN: Account is already the value of 'excluded'");
        _isExcludedFromMaxTransactionLimit[account] = excluded;
        emit ExcludeFromMaxTransferChange(account, excluded);
    }
    function excludeFromMaxWalletLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxWalletLimit[account] != excluded, "BRN: Account is already the value of 'excluded'");
        _isExcludedFromMaxWalletLimit[account] = excluded;
        emit ExcludeFromMaxWalletChange(account, excluded);
    }
    function blacklistAccount(address account) public onlyOwner {
        uint256 currentTimestamp = _getNow();
        require(!_isBlacklisted[account], "BRN: Account is already blacklisted");
        if (_isLanched) {
            require(currentTimestamp.sub(_launchStartTimestamp) < _blacklistTimeLimit, "BRN: Time to blacklist accounts has expired");
        }
        _isBlacklisted[account] = true;
        emit BlacklistChange(account, true);
    }
    function unBlacklistAccount(address account) public onlyOwner {
        require(_isBlacklisted[account], "BRN: Account is not blacklisted");
        _isBlacklisted[account] = false;
        emit BlacklistChange(account, false);
    }
    function setLiquidityWallet(address newAddress) public onlyOwner {
        require(liquidityWallet != newAddress, "BRN: The liquidityWallet is already that address");
    ...
    function setMarketingWallet(address newAddress) public onlyOwner {
        require(marketingWallet != newAddress, "BRN: The marketingWallet is already that address");
        emit MarketingWalletChange(newAddress, marketingWallet);
        marketingWallet = newAddress;
    }
    function setBuyBackWallet(address newAddress) public onlyOwner {
        require(buyBackWallet != newAddress, "BRN: The buyBackWallet is already that address");
    ...
    function setSalaryWallet(address newAddress) public onlyOwner {
        require(salaryWallet != newAddress, "BRN: The salaryWallet is already that address");
    ...
    function setLiquidityFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnBuy != newvalue, "BRN: The liquidityFeeOnBuy is already that value");
    ...
    function setMarketingFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnBuy != newvalue, "BRN: The marketingFeeOnBuy is already that value");
    ...
    function setHolderFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnBuy != newvalue, "BRN: The holdersFeeOnBuy is already that value");
    ...
    function setBuyBackFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnBuy != newvalue, "BRN: The buyBackFeeOnBuy is already that value");
    ...
    function setSalaryFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnBuy != newvalue, "BRN: The salaryFeeOnBuy is already that value");
    ...
    function setLiquidityFeeOnSell(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnSell != newvalue, "BRN: The liquidityFeeOnSell is already that value");
    ...
    function setMarketingFeeOnSell(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnSell != newvalue, "BRN: The marketingFeeOnSell is already that value");
    ...
    function setHolderFeeOnSell(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnSell != newvalue, "BRN: The holdersFeeOnSell is already that value");
    ...
    function setBuyBackFeeOnSell(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnSell != newvalue, "BRN: The buyBackFeeOnSell is already that value");
    ...
    function setSalaryFeeOnSell(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnSell != newvalue, "BRN: The salaryFeeOnSell is already that value");
    ...
    function setUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BRN: The router already has that address");
        emit UniswapV2RouterChange(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }
    function setGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BRN: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BRN: Cannot update gasForProcessing to same value");
        emit GasForProcessingChange(newValue, gasForProcessing);
        gasForProcessing = newValue;
    }
    function setMaxTxAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxTxAmount, "BRN: Cannot update maxTxAmount to same value");
        emit MaxTransactionAmountChange(newValue, maxTxAmount);
        maxTxAmount = newValue;
    }
    function setMaxWalletAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxWalletAmount, "BRN: Cannot update maxWalletAmount to same value");
        emit MaxWalletAmountChange(newValue, maxWalletAmount);
        maxWalletAmount = newValue;
    }
    function setMinimumTokensBeforeSwap(uint256 newValue) public onlyOwner {
        require(newValue != minimumTokensBeforeSwap, "BRN: Cannot update minimumTokensBeforeSwap to same value");
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            require(isTradingEnabled, "BRN: Trading is currently disabled.");
            require(!_isBlacklisted[to], "BRN: Account is blacklisted");
            require(!_isBlacklisted[from], "BRN: Account is blacklisted");
            if (_isInLaunch && currentTimestamp.sub(_launchStartTimestamp) <= 300 && isBuyFromLp) {
                require(currentTimestamp.sub(_buyTimesInLaunch[to]) > 60, "BRN: Cannot buy more than once per min in first 5min of launch");
            }
            if (!_isExcludedFromMaxTransactionLimit[to] && !_isExcludedFromMaxTransactionLimit[from]) {
                require(amount <= maxTxAmount, "BRN: Buy amount exceeds the maxTxBuyAmount.");
            }
            if (!_isExcludedFromMaxWalletLimit[to]) {
                require(balanceOf(to).add(amount) <= maxWalletAmount, "BRN: Expected wallet amount exceeds the maxWalletAmount.");
            }
        }
    ...
    function _swapAndLiquify() private {
        ...
        uint256 tokensInBrnForLiquidity = _liquidityTokensToSwap.div(2);
        uint256 amountToSwapForBNB = contractBalance.sub(tokensInBrnForLiquidity);
        
        // initial BNB balance
        uint256 initialBNBBalance = address(this).balance;
        // Swap the Brn for BNB
        ...
        _addLiquidity(tokensInBrnForLiquidity, bnbForLiquidity);
        emit SwapAndLiquify(amountToSwapForBNB, bnbForLiquidity, tokensInBrnForLiquidity);
...
contract BRNDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("BRN_Dividend_Tracker", "BRN_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000 * (10**18); 
    }
    function _transfer(address, address, uint256) internal override {
        require(false, "BRN_Dividend_Tracker: No transfers allowed");
    }
    function withdrawDividend() public override {
        require(false, "BRN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BRN contract.");
    }
    ...
    function setTokenBalanceForDividends(uint256 newValue) external onlyOwner {
        require(minimumTokenBalanceForDividends != newValue, "BRN_Dividend_Tracker: minimumTokenBalanceForDividends already the value of 'newValue'.");
        minimumTokenBalanceForDividends = newValue;
    } 
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BRN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BRN_Dividend_Tracker: Cannot update claimWait to same value");
