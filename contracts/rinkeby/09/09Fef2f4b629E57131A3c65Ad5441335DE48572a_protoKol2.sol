...
contract protoKol2 is iProtoKol {
   ...
   */
    function createCampaign(
        ...
        console.log("Required Investment", _newCampaign.requiredInvestment);
   ...
   */
    function investInCampaign(
        ...
        if (campaigns[_campaignId].campaignData.preSaleToken != _USDT) {
            ...
            console.log("291: Investment", _investment);
            require(
   ...
   */
    function claimBackInvestmentByKOL(
        ...
        console.log("685: Investment ", _invest);
   ...
   */
    function _blackListedKOLFundsHandling(
        ...
        uint256 balance = campaigns[_campaignId].campaignData.enteredInvestmentAgainstMarketingBudget; //IERC20(preSale).balanceOf(address(this));
        if (balance < _reward) {
            // console.log(balance);
        ...
        if (campaigns[_campaignId].campaignData.preSaleToken != _USDT) {
            ...
            if (campaigns[_campaignId].tgeDetails.tgeAmount > 0 || campaigns[_campaignId].tgeDetails.isTGE) {
                ...
                console.log("Call From blacklisting, Balance of contract is", balance);
                if (balance < investedCampaignDetails[msg.sender][_campaignId].leftOverInvestment) {
                    ...
                    console.log("After Transferg, Balance of contract is", balance);
                }
            }
        }
