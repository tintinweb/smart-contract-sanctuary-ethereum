...
contract TestnetTwinesis is Twinesis {
    ...
    function name() public pure override returns (string memory) {
        return "Testnet Twinesis v0.6.3";
    }
}
 ...
 *          Goodlist pre sale
 *          Public minting
 *  @dev Inherits from @openzeppelin/contracts ERC721, Ownable and AccessControl
 *       Uses enums Rarity and Level (Types.sol)
 *       Ownable only for marketplaces customization purposes
 */
contract Twinesis is ERC721, Ownable, AccessControl {
    /// ---------------
    /// 1. Libraries
    /// ---------------
