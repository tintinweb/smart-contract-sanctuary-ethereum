...
contract RandomGenerator {
    ...
    mapping(address => BetValue) private bets;
    ...
    function PlaceBet() public payable {
        ...
        require(!IsDayFinished(), "The Day has already finished. Wait while we crown the winner.");
    ...
    function CrownWinners() public {
        ...
        if (users.length > 0){
            ...
            uint256 dividedValue = totalValueToSend / winners.length;
