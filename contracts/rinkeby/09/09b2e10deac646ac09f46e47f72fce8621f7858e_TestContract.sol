...
contract TestContract is ERC721A, ReentrancyGuard, Ownable {
  ...
  function mint(uint256 _count) public payable saleIsOpen {
    uint256 mintIndex = totalSupply();
     ...
     if (msg.sender != owner()) {
      ...
      require(_walletClaimed[msg.sender] + _count <= maximumAllowedTokensPerWallet, "Max holding cap reached.");
    }
  ...
  function preSaleMint(bytes32[] calldata _merkleProof, uint256 _count) public payable saleIsOpen {
    ...
    require(_walletClaimed[msg.sender] + _count <= presaleWalletLimitation, "Cannot purchase this many tokens");
