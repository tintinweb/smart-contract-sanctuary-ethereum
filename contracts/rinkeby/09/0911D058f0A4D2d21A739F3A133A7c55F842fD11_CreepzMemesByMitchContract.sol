...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x59510c6aaD72109aBd20B5d0794Bb069AE7e5A6e];
...
abstract contract hasWalletCap is Ownable {
    ...
    */
    ...
    function addTokenMints(uint256 _id, address _address, uint256 _amount) internal {
      walletMints[_address][_id] = SafeMath.add(walletMints[_address][_id], _amount);
    }
    ...
    */
    function canMintAmount(uint256 _id, address _address, uint256 _amount) public view returns(bool) {
        ...
        return SafeMath.add(currentMintCount(_id, _address), _amount) <= tokenWalletCap(_id);
    }
...
// File: contracts/CreepzMemesByMitchContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract CreepzMemesByMitchContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Creepz Memes By Mitch";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9ZVHVxM4pbQ0KTutDCOb/contract-metadata";
    }
