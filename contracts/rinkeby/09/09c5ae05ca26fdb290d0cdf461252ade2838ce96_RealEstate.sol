...
contract RealEstate {
    ...
    ************************************************/
    ...
    function requestForBuyProperty( 
        ...
        emit _request( _PropertyID );

    }

    event _request ( uint PropertyID );
    ...
    ************************************************/
    ...
    function isAcceptedforBuy( uint _PropertyID ) public view returns( bool[] memory _AcceptedForSell ) {
        return AcceptedforBuy[_PropertyID];
    }
