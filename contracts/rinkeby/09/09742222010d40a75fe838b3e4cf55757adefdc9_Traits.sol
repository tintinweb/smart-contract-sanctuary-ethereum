...
library Traits {
    ...
    function getTokenURI(Inventory.FallenInventory memory _inventory, uint256 soulScore, uint256 tokenId) external pure returns (string memory) {
        ...
        parts[2] = '<line x1="0" y1="32" x2="350" y2="32" stroke="#3f3f46" stroke-width="2"/><line x1="85" y1="0" x2="85" y2="350" stroke="#3f3f46" stroke-width="2"/><line x1="275" y1="0" x2="275" y2="350" stroke="#3f3f46" stroke-width="2"/><line x1="0" y1="318" x2="350" y2="318" stroke="#3f3f46" stroke-width="2"/>';
        
        parts[3] = '<text x="10" y="22" class="full">Class</text>';
        parts[4] = '<text x="10" y="64" class="e';
        parts[5] = Strings.toString(_inventory.head.status);
        parts[6] = '">Head</text>';
        
        parts[7] = '<text x="10" y="90" class="e';
        parts[8] = Strings.toString(_inventory.shoulders.status);
        parts[9] = '">Shoulders</text>';
        
        parts[10] = '<text x="10" y="116" class="e';
        parts[11] = Strings.toString(_inventory.chest.status);
        parts[12] = '">Chest</text>';
        
        parts[13] = '<text x="10" y="142" class="e';
        parts[14] = Strings.toString(_inventory.shirt.status);
        parts[15] = '">Shirt</text>';
        
        parts[16] = '<text x="10" y="166" class="e';
        parts[17] = Strings.toString(_inventory.pants.status);
        parts[18] = '">Pants</text>';

        parts[19] = '<text x="10" y="194" class="e';
        parts[20] = Strings.toString(_inventory.feet.status);
        parts[21] = '">Feet</text>';
        
        parts[22] = '<text x="10" y="220" class="e';
        parts[23] = Strings.toString(_inventory.ring.status);
        parts[24] = '">Ring</text>';

        parts[25] = '<text x="10" y="246" class="e';
        parts[26] = Strings.toString(_inventory.artifact.status);
        parts[27] = '">Artifact</text>';

        parts[28] = '<text x="10" y="272" class="e';
        parts[29] = Strings.toString(_inventory.mainhand.status);
        parts[30] = '">Mainhand</text>';

        parts[31] = '<text x="10" y="298" class="e';
        parts[32] = Strings.toString(_inventory.offhand.status);
        parts[33] = '">Offhand</text>';

        parts[34] = '<text x="10" y="340" class="e1">Overall</text>';
        
        parts[35] = '<text x="95" y="22" class="c';
        parts[36] = class;
        parts[37] = '">';
        parts[38] = race;

        parts[39] = '</text><text x="95" y="64" class="c';
        parts[40] = Strings.toString(_inventory.head.tier);
        parts[41] = '">';
        parts[42] = _inventory.head.name;
        parts[43] = '</text><text x="285" y="64" class="c';
        ...
        parts[79] = '</text><text x="95" y="194" class="c';
        parts[80] = Strings.toString(_inventory.feet.tier);
        parts[81] = '">';
        parts[82] = _inventory.feet.name;
        parts[83] = '</text><text x="285" y="194" class="c';
        ...
        parts[87] = '</text><text x="95" y="220" class="c';
        parts[88] = Strings.toString(_inventory.ring.tier);
        parts[89] = '">';
        parts[90] = _inventory.ring.name;
        parts[91] = '</text><text x="285" y="220" class="c';
        ...
        if(soulScore < 10){ parts[119] = '</text><text x="285" y="340" class="c1">'; }
        else if(soulScore < 25){ parts[119] = '</text><text x="285" y="340" class="c2">'; }
        else if(soulScore < 50){ parts[119] = '</text><text x="285" y="340" class="c3">'; }
        else if(soulScore < 100){ parts[119] = '</text><text x="285" y="340" class="c4">'; }
        else if(soulScore < 200){ parts[119] = '</text><text x="285" y="340" class="c5">'; }
        else if(soulScore < 500){ parts[119] = '</text><text x="285" y="340" class="c6">'; }
        else{ parts[119] = '</text><text x="285" y="340" class="c7">'; }
