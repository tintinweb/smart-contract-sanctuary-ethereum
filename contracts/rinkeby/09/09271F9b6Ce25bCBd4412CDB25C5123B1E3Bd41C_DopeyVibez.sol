...
contract DopeyVibez is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DopeyVibez", "DV") {
    setHiddenMetadataUri("ipfs://QmcWcHmHk7rVvePD7KmcGWSoT5VKx1sjmYEep5pDRiw6LT/Hidden.json");
  }
