...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa99f79e2565860bd2941CA545D0cd0CE6E7eE12D];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 4) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihlgmbb2jrjuxp4zef5rd2snmvzczsojqbg3v5gcjiqoexe6cvuhi/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4");
...
// File: contracts/GlassHouseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GlassHouseContract is RamppERC721A {
    constructor() RamppERC721A("Glass House", "GLASS"){}
}