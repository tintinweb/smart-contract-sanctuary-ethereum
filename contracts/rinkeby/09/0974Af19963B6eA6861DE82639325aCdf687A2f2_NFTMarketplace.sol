...
contract NFTMarketplace is ERC721URIStorage, ReentrancyGuard {
    ...
    constructor() ERC721("Beliverus Metaverse", "BNFT") {
   ...
   function getTokenPrice(address pairAddress, uint amount) public view returns(uint)
   {
    ...
    function updateListingPrice(uint _listingPrice) public payable isOwner{
    ...
    function transferFrom(
        ...
        idToMarketItem[tokenId].cancelled = false;
    ...
    /* Creates the Cancellation of a marketplace item */
    /* Transfers ownership of the itemback to seller */
    function createCancelSale(
      uint256 tokenId
      ) public nonReentrant{
      address seller = idToMarketItem[tokenId].seller;
      ...
      idToMarketItem[tokenId].owner = payable(msg.sender);
      idToMarketItem[tokenId].sold = false;
      idToMarketItem[tokenId].cancelled = true;
      idToMarketItem[tokenId].seller = payable(address(0));
