...
//*********************************************************************//
//
// ooooo          .oooooo.     .oooooo.   ooooooooooooo 
// `888'         d8P'  `Y8b   d8P'  `Y8b  8'   888   `8 
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmbtgqDs6UNsWAWYynhpnvYGeL7XUUBfm7hJN1QHNyDa9D/";
...
// File: contracts/TreasureLootContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TreasureLootContract is RamppERC721A {
    constructor() RamppERC721A("Treasure LOOT", "TLOOT"){}
}
