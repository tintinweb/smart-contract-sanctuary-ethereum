...
//
// __  __            __         _    _____             __
// \ \/ /___  __  __/ /______ _(_)  / ___/____  __  __/ /
//  \  / __ \/ / / / //_/ __ `/ /   \__ \/ __ \/ / / / / 
//  / / /_/ / /_/ / ,< / /_/ / /   ___/ / /_/ / /_/ / /  
// /_/\____/\__,_/_/|_|\__,_/_/   /____/\____/\__,_/_/   
//                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x60AC8b1BDB9f27553106D6c0981A777e062a57E4];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmfPMvUFyKXrjpyMMHHuY15a7C9nb6RRBeiGRij9fQVLG9/";
...
// File: contracts/YoukaiSoulContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YoukaiSoulContract is RamppERC721A {
    constructor() RamppERC721A("Youkai Soul", "SOULS"){}
}
