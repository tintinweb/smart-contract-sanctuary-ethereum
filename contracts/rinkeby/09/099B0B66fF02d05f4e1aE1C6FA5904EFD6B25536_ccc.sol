...
// File: @openzeppelin/contracts/security/ReentrancyGuard.sol
    ...
    */
    ...
    contract ccc  is ERC721A, Ownable, ReentrancyGuard {
        using Strings for uint256;
    
        constructor() ERC721A("ccc", "ccc") {}
        ...
        function mintWl(uint256 _mintAmount, bytes32[] memory _merkleProof)
            public
            payable
            mintCompliance(_mintAmount)
        {
        ...
        function mintForAddress(uint256 _mintAmount, address[] memory _receiver)
            public
            onlyOwner
        {
