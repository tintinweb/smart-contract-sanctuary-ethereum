...
contract Smiley_WRLD is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("S-Bot Degen", "SBD") {
    setHiddenMetadataUri("ipfs://QmRwY1oEv4tqwzsPnSsakybWqDLeffSY3GDrHVhxk2BR8T/1.json");
  }
