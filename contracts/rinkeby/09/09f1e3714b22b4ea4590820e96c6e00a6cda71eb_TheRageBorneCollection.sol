...
// File: contracts/RageBorneFT.sol
...
contract TheRageBorneCollection is ERC721Enumerable, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public WHITELIST_MAX_PER_MINT = 5;  

  uint256 public PRICE = 0.04 ether; // 40000000000000000

  uint256 public WHITELIST_PRICE = 0.04 ether; // 40000000000000000

  uint256 public WHITELIST_LIMIT = 498;
