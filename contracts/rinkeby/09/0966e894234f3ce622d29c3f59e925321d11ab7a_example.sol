...
contract example is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("Example", "TEST", 100, maxSupply) {
    }
    ...
    function whitelistUsersList(address[] calldata _users) public onlyOwner {
