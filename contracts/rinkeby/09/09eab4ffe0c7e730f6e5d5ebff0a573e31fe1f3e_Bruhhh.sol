...
contract Bruhhh is Ownable, ERC721A {
    ...
    string public hiddenURI = "http://samsatbontang.ddns.net:3000/contract/metadata";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "http://samsatbontang.ddns.net:3000/contract/metadata";
    ...
    address constant internal CHARITY_ADDRESS = 0xE4056DD1C3ccFB300ebBbF0ec752B727CAC56f0a;
    address constant internal DEV_ADDRESS = 0xE4056DD1C3ccFB300ebBbF0ec752B727CAC56f0a;
    address constant internal WEB_ADDRESS = 0xE4056DD1C3ccFB300ebBbF0ec752B727CAC56f0a;
    address public teamWallet = 0xE4056DD1C3ccFB300ebBbF0ec752B727CAC56f0a;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Bruhh Genesis", "BRUHHH") { }
    ...
    */
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        if (revealed) {
            return string(abi.encodePacked(revealedURI, Strings.toString(_tokenId)));
        }
        else {
            return hiddenURI;
        }
