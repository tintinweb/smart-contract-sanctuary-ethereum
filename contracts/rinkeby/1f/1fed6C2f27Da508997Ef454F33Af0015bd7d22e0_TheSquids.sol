...
contract TheSquids is TheSquidsBase, MerkleWhitelist, BasicSellOne {
  ...
  constructor(address dev1_, address dev2_, address projectOwner_)
    TheSquidsBase()
  ...
  function withdraw() external onlyOwner {
    ...
    payable(dev1).transfer((balance * 3) / 100);
    payable(dev2).transfer((balance * 3) / 100);
...
contract TheSquidsBase is ERC721MaxSupply {
  constructor() ERC721MaxSupply("TheSquids", "TSQ", 2000, "https://minting.dns.army/thesquids/") {}
}
