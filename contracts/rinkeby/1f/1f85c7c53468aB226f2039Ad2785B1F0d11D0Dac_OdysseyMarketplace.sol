    ...
    IERC1155Receiver
{
    ...
    function _cancelAuction(Listing memory _targetListing) internal {
        require(listings[_targetListing.listingId].tokenOwner == msg.sender, "caller is not the listing creator.");
        ...
        emit AuctionClosed(_targetListing.listingId, msg.sender, true, _targetListing.tokenOwner, address(0));
    }
