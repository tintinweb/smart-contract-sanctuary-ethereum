...
contract BlackBoxCollectiveAlphaClass is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint public MAX_ALPHA_CLASS = 500;
    uint256 public passPrice = 3.5 ether; //1.95 ETH
    string public baseURI;
    bool public saleIsActive = false;
    uint public constant maxPassTxn = 1;
    ...
    function reserveMintPass(uint256 reserveAmount, address mintAddress) public onlyOwnerOrManager {
        require(totalSupply() + reserveAmount <= MAX_ALPHA_CLASS, "Event Pass Sold Out");
    ...
    function mintEventPass(uint256 numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Event Pass");
        require(passPrice * numberOfTokens <= msg.value, "Ether value sent is not correct");
        require(numberOfTokens <= maxPassTxn, "You can only mint 5 Event passes at a time");
        require(totalSupply() + numberOfTokens <= MAX_ALPHA_CLASS, "Event Passes Sold Out");
