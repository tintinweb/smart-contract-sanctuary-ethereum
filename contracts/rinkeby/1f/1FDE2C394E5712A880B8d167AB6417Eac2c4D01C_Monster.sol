...
contract Monster is Ownable, ERC721A, ERC2981, ReentrancyGuard {
    ...
    Phase public CONTRACT_STATUS = Phase.disable;
    ...
    address public immutable SCIENTIST_CONTRACT =
        0xA3D54CEe35E217f1541915605a7f7B478838556D;

    function walletHoldsToken() public view returns (bool) {
        return getUserToken(msg.sender) > 0;
    }
    ...
    {
        require(CONTRACT_STATUS == Phase.open, "Not in public mint stage");
    ...
    function setStatus(Phase status) external onlyOwner {
