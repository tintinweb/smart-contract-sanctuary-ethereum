...
contract RichMamaContract is ERC721A, ReentrancyGuard, Ownable, Pausable {
    ...
    // TODO: change it to a empty wallet address
    address private signerAddress = 0xD6f04aA4797CEac65F7f0A744bb8897DfA663331;
    
    // TODO: change __CID__ to real ipfs CID
    constructor() ERC721A("RichMama Token", "RMT") {
        setUriPrefix("ipfs://__CID__/RichMama/TokenURI/");
    }
    ...
    function mint(
        ...
        unchecked {
            ...
            require(balanceOf(msg.sender) + _mintAmount <= _maxAllowedMints, "MINT_TOO_LARGE");
