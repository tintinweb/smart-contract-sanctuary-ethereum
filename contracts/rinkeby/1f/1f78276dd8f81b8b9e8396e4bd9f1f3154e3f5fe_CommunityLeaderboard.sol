...
contract CommunityLeaderboard is Ownable {
    ...
    function createLeaderboardNftRequired(uint256 _projectId, string memory _leaderboardName, uint256 _time, uint256 _timeRemaining, uint256 _nftsRequired) public {
        ...
        emit createNftRequiredLeaderboard(_leaderboardName, _projectId, newLeaderboard.leaderBoardId, newLeaderboard.leaderboardCount, _time, _timeRemaining, newLeaderboard.nftRequired, _nftsRequired);
    }
    ...
    function createLeaderboardOpen(uint256 _projectId, string memory _leaderboardName, uint256 _time, uint256 _timeRemaining) public {
        ...
        emit createOpenLeaderboard(_leaderboardName, _projectId, newLeaderboard.leaderBoardId, newLeaderboard.leaderboardCount, _time, _timeRemaining, newLeaderboard.nftRequired);
    }
