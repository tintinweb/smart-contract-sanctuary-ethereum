...
contract Kaori is ERC721A, Ownable {
    ...
    string private baseExtension = ".json"; // if your art metadata has extension eg. 1.json
    ...
    function setHiddenURL(string memory uri) external onlyOwner { //change to public if constructor need to call
        HiddenURL = uri;
    }
