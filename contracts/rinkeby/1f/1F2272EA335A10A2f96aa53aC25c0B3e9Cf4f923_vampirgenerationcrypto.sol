...
// File: contracts/vampirgenerationcrypto.sol
...
contract vampirgenerationcrypto is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("vampir crypto generation", "VCG") {
    setHiddenMetadataUri("ipfs://QmQUboyEUm6GzvLw5FAimDiPJtVhmnGMNpK82fDSxPPdA4/hidden.json");
  }
