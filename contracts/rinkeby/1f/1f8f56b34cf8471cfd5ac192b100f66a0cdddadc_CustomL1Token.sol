...
// File contracts/interfaces/arbitrum/IGatewayRouter.sol
...
// File contracts/interfaces/arbitrum/ICustomGateway.sol
...
// File contracts/interfaces/IArbitrumEnabledToken.sol
...
// File contracts/DummyERC20Token.sol
...
// File contracts/CustomL1Token.sol
...
contract CustomL1Token is DummyERC20Token, IArbitrumEnabledToken {
    ...
    function registerTokenOnL2(
        ...
        ICustomGateway(BRIDGE).registerTokenToL2{value: msg.value}(
            l2Address_,
            maxGas,
            gasPriceBid,
            maxSubmissionCost,
        ...
        IGatewayRouter(ROUTER).setGateway{value: msg.value}(
            BRIDGE,
            maxGas,
            gasPriceBid,
            maxSubmissionCost,
