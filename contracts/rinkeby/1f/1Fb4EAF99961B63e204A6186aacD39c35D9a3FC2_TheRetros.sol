...
contract TheRetros is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = "ipfs://QmbJJprAFtCPF6G3LFNrBJAryoBK9Gbaf6BcMtbgRDo8Mh/";
  ...
  function checkCost(uint256 _mintAmount)
    ...
    {
        if(_mintAmount > 1){
          return cost1 + (_mintAmount-1)*cost2;
        } else {
          return cost1;
        }
    }
