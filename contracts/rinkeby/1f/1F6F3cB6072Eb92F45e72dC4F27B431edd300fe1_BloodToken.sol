...
contract BloodToken is Ownable, ERC20("BloodToken", "BLD"), Pausable {
    ...
    uint256 public noUnStakeTax;
    uint256 public unStakeTax;
    uint256 public battleUnStakeTax;
...
//        _pause();
    ...
    function withdraw(uint256 amount_) external whenNotPaused {
        ...
        uint256 taxed = walletsBalances[msg.sender] * tax / 100;
        // check level amortization
        taxFunds += taxed;
        _mint(msg.sender, (amount_ - taxed)  *  ETHER);
