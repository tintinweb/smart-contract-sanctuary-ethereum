...
/**
 * @title Angels Wing artist token contract
 * @author Gabriel Cebrian (https://twitter.com/gabceb) for original MetaAngels contract.
 * @author Ethspresso (https://twitter.com/ethspresso) for adapting it to artist token use-case.
...
contract ArtistToken is ERC721A, ReentrancyGuard, Ownable, Pausable {
    ...
    function mint() external payable virtual nonReentrant {
        ...
        require(msg.value >= (price - 0.0001 ether) && msg.value <= (price + 0.0001 ether), "Invalid price paid");
