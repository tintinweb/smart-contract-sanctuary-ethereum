...
contract AdventNFT is ERC721A, Ownable {
    ...
    uint256 public Max_Per_Mint = 6;  //max per mint

    uint256 public WL_Max_Per_Mint = 3; // max per mint in wl
    uint256 price = 0.25 ether;  //price

    uint256 wl_price = 0.2 ether; // wl price
