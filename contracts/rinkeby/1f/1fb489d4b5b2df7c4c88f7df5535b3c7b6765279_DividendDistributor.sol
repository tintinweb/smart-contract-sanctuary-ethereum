...
contract DividendDistributor is IDividendDistributor {
    ...
    IDividendDistributor oldDistributor; 
    ...
    constructor (address owner, address token, address _rewardToken, address _oldDistributor) {
        _token = token;
        _owner = owner;
        RewardToken = _rewardToken;
        oldDistributor = IDividendDistributor(_oldDistributor);
    }
