...
contract TheLokals is ERC721A, ERC2981, Ownable {
    ...
    bytes32 private constant FIRST_WHITELIST_MERKLE_ROOT =
        0x77f0a438e8f83caea06b958decb482f5cda8296024fde0e00fefc07645c9f364;
    bytes32 private constant SECOND_WHITELIST_MERKLE_ROOT =
        0xedbaf21c5a0b9cfbc8ce02c3c7cdb8454a62aecbcdf500cde9461fca68e077b4;
        ...
        payable
    {
        ...
        if (totalSupply() + quantity > TOKEN_MAX_SUPPLY)
        ...
        uint256 finalTokenBalance = amountMinted(msg.sender) + quantity;
