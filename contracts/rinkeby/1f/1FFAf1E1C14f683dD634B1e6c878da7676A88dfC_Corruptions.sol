    ...
    OwnableUpgradeable
{
    ...
    /**
     * @dev
     * Internal Team  (100 supply)
     * Early List (8000)
     * White List (10k phase 1, 10k phase 2)
    ...
    uint256 public constant WHITELIST_SALE_PRICE = 0.125 ether;
    uint256 public MAX_WHITELIST_MINT;
    ...
    */
    ...
    modifier canWhiteListMint(uint256 _quantity) {
        require(
            ...
            "Not enough ether to mint WhiteList"
        );
        require(
            whiteListMintId + _quantity <= MAX_WHITELIST_MINT,
        ...
        isOrigin
    {
        ...
        anomuraContract.mintAnomura{value: msg.value}(msg.sender);
    ...
    */
    function setTeamListMerkleRoot(bytes32 _merkleRoot) external onlyOwner {
        ...
        emit UpdatedMerkleRootOfTeamMint(_merkleRoot, msg.sender);
    }
    ...
    */
    function setEarlyListMerkleRoot(bytes32 _merkleRoot) external onlyOwner {
        ...
        emit UpdatedMerkleRootOfEarlyListMint(_merkleRoot, msg.sender);
    }
    ...
    */
    function setAnomuraContractAddress(address _anomura) external onlyOwner {
        ...
        // still considering using the above require, accidentally we may put a wrong address and we cannot revert
