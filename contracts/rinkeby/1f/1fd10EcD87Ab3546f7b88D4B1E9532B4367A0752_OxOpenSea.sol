...
contract OxOpenSea is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    
    uint256 public PUBLIC_MINT_PRICE = 0.01 ether;
    uint256 private MAX_TOKENS_PER_TRANSACTION = 26;
    uint256 private MAX_FREE_TOKENS_PER_TRANSACTION = 10;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public PUBLIC_MINT_MAX_SUPPLY = 10000;
    uint256 private FREE_MINTS = 30;

    bool public revealed = false;
    bool public saleStatus = false;

    string private notRevealedUri = "ipfs://QmW83NUioFfvEsTrztPuVTr56gq5BQ47Q5vY8HpUt1yonE/";
    ...
    constructor() ERC721A("OxOpenSea", "OxOpenSea") {
    }
    ...
    function mint(uint256 _count) external payable {
        ...
        if (supply + _count < FREE_MINTS) {
            require(msg.value >= PUBLIC_MINT_PRICE * _count, "Ether amount sent is not correct.");
            require(msg.value >= MAX_FREE_TOKENS_PER_TRANSACTION * _count, "Only 10 free mints per transaction.");
        }
