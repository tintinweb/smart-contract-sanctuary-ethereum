...
contract AISummerTown is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmeg5eVEkSuRbD8MmipeEU1Bm75BHV7xZKDmAb5EMfLM2b/";
    ...
    uint256 public NUM_FREE_MINTS = 50;
    ...
    constructor(
    ) ERC721A("AISummerTown", "AiSumTown", 100, maxSupply) {
    }
