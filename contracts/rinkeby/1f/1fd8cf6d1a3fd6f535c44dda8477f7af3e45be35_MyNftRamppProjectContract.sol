...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x267d66C6F098e5d0497890A405D2F21395025C4F];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQA7TpzKYfmkhfccf3P5tnyQfRZJ4sDWEcgvRDuJDJCH1/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/X4iCkegAxyeDpVMOyJ5m/contract-metadata";
    }
}