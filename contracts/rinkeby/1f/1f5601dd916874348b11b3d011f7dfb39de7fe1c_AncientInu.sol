...
contract AncientInu is Context, IERC20, Ownable {
    ...
    **/
    ...
    constructor() payable {
        _feeAddrWallet1 = payable(0xA5653e43fec5F6DDD16Cb6E652058D5653391DD8);
    ...
    function getTransactionsCountMod() public view returns (uint256){
        return getTransactionsCount() / TRANSACTION_COUNT;
    }
    ...
    function _transfer(
        ...
        if (applyRestrictions) {
            ...
            if (from != owner() && to != owner()) {
                ...
                transactionsCount++;
                if(getTransactionsCountMod() >=1 && !transactionCountUsed[getTransactionsCountMod()]){
                    transactionCountUsed[getTransactionsCountMod()] = true;
