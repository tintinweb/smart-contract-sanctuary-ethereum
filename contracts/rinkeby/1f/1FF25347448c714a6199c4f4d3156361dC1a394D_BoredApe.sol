    ...
    PaymentSplitter 
{
    ...
    onlyAccounts
    {
        ...
        require(
            _amount <= publicsaleAmountLimit,      "Punks Paradise: You can't mint so much tokens");
        require(
            _publicsaleClaimed[msg.sender] + _amount <= publicsaleAmountLimit,  "Punks Paradise: You can't mint so much tokens");
