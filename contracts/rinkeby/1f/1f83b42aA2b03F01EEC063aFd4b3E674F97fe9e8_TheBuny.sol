...
contract TheBuny is ERC721, ERC2981PerToken,
  ...
  constructor(string memory _cid, address[] memory payees, uint256[] memory shares, address _marketplace) ERC721("The Buny", "BUNY")
...
function supportsInterface(bytes4 interfaceId)
 ...
 function mintRoyalties(
    ...
    function mintBatch(
        ...
        uint256 tokenId = nextTokenId;
        require(
            recipient.length == royaltyRecipients.length &&
                recipient.length == royaltyValues.length,
