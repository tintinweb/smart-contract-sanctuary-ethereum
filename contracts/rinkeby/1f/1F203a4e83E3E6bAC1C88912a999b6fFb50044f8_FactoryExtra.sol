...
import "./interfaces/IFixedPriceExtraDeployer.sol";
import "@openzeppelin/contracts/proxy/Clones.sol";

contract FactoryExtra is OwnableUpgradeable {
  address public immutable TIMELOCK_IMPL;

  address private fixedPriceExtraDeployer; // pay erc20 tokens to mint PASS with fixed price
  ...
  function fixedPriceExtraDeploy(
    string memory _name,
    ...
    IFixedPriceExtraDeployer factory = IFixedPriceExtraDeployer(fixedPriceExtraDeployer);
    address addr = factory.deployFixedPriceExtra(
      _name,
      _symbol,
      _bURI,
...
interface IFixedPriceExtraDeployer {
  function deployFixedPriceExtra(
    string memory _name,
    string memory _symbol,
    string memory _bURI,
    address _timelock,
