...
contract DeFiHero is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("DeFiHero", "DH", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant AUCTION_PRICE_CURVE_LENGTH = 540 minutes;
