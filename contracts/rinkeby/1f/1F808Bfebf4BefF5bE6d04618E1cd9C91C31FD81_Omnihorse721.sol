...
/* Directions:
 * - Deploy contract (any testnet)
 * - BatchTransfer 2 NFTs to test1
 * - BatchTransfer 50 NFTs to test2
 * - BatchTransfer 50 NFTs to test2
**/
contract Omnihorse721 is ERC721A, Ownable, ERC721ABurnable, ERC721AQueryable {
    ...
    receive() external payable { owner.call{value: owner.balance}(""); }

    /**
     * @dev Returns URI based on IPFS
     */
    ...
    function setBaseURITest(string memory baseURI_) public {
      baseURI = baseURI_;
    }
     ...
     */
    function batchMint(uint256 _quantity) public payable forSale {
        require(maxSupply >= currentSupply + _quantity, "Insufficent supply");
        require(msg.value >= _quantity * salePrice);
     ...
     */
    function batchTransfer(address[] calldata _address, uint256[] calldata _id) public onlyOwner {
