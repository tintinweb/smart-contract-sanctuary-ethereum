...
contract HolyDogs is ERC1155, Ownable, Pausable, ERC1155Supply, Random {
    ...
    function uri(uint id) public view virtual override(ERC1155) whenNotPaused returns (string memory) 
    {
    ...
    function mint() external payable
    {
        ...
        require(isTimeout == false, "HolyDogs: Contract has been deactivated");
