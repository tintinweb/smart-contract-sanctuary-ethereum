...
//*********************************************************************//
//
//  ____    _  _     ___    __  .______     ______   .___________.    _______.     ______   ______   .___  ___. 
// |___ \  | || |   |__ \  /_ | |   _  \   /  __  \  |           |   /       |    /      | /  __  \  |   \/   | 
//   __) | | || |_     ) |  | | |  |_)  | |  |  |  | `---|  |----`  |   (----`   |  ,----'|  |  |  | |  \  /  | 
//  |__ <  |__   _|   / /   | | |   _  <  |  |  |  |     |  |        \   \       |  |     |  |  |  | |  |\/|  | 
//  ___) |    | |    / /_   | | |  |_)  | |  `--'  |     |  |    .----)   |    __|  `----.|  `--'  | |  |  |  | 
// |____/     |_|   |____|  |_| |______/   \______/      |__|    |_______/    (__)\______| \______/  |__|  |__| 
//                                                                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeee1132cDc57c439191f7b683B69b95dF974e0D0];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 10) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmf6hJ4TZktcUPL3WaL3Syb5zCkf64qfTG4sg5p94DvWJU/";
...
// File: contracts/X3421BotscomContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3421BotscomContract is RamppERC721A {
    constructor() RamppERC721A("3421BOTSCOM", "3421BOTS"){}
}
