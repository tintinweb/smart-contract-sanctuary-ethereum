...
contract niubi is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("niubi", "niubi") {
  ...
  string private customContractURI =
    "ipfs://bafybeigzhbu7txrwnw5pn3dl4xqja4kfiegcfymytrsaohuxagb3m7rhbm";
