...
import './configuration/TOSParameterProvider.sol';

contract TheOtherSideV15 is ERC721EnumerableT, ITokenTransfer, ReentrancyGuard, TOSParameterProvider {
  ...
  /**
    ...
    */
  constructor()
    ERC721T("The Other Side v.15", "TOSV15"){
  }
...
/**
  * @dev Owner's account will be the only one who can withraw based on the amount.
  */
  ...
  /**
    * @dev mints token based on the number of qty and address recipient specified.
    */
  function mint_(uint[] calldata quantity, address[] calldata recipient) external payable onlyDelegates{
    require(isMintActive == true,"MOON: Minting needs to be enabled."); 
...
/**
  ...
  */
  ...
  /**
    ...
    */
    function transferToken(StakeState _stakeState,address _from, uint tokenId) external override{
 ...
 * @team:   TheOtherSide                *
 ****************************************
 *   TOS Configuration Parameter        *
 ****************************************/

 import '../Delegated.sol';
 import '../ITOSStake.sol';

 contract TOSParameterProvider is Delegated {
    ...
    ITOSStake internal stakingAddress;

    mapping(address => uint) public accessList;

  /**
    * @dev Owner/Delegate sets the whitelist address based on array of accounts and number of allowed accesslist.
    */
