...
interface IERC721AUpgradeable {
    ...
    /**
     * The total quantity of the collection cannot be zero.
     */
    error CollectionSizeZero();
...
contract ERC721AUpgradeable is ERC721A__Initializable, IERC721AUpgradeable {
    ...
    function __ERC721A_init_unchained(
        ...
        ERC721AStorage
            .layout()
            ._maxBatchSizePublicSale = maxBatchSizePublicSale_;
        ...
        unchecked {
            if (_startTokenId() <= curr)
                if (curr < ERC721AStorage.layout()._currentIndex) {
                    uint256 packed = ERC721AStorage.layout()._packedOwnerships[
                        curr
                    ];
                    // If not burned.
...
contract CustomERC721A1 is ERC721AUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init({
            name_: "Red Star OG Drippy Collection",
            symbol_: "RDS",
            pricePublicSale_: 0.07 ether,
            pricePreSale_: 0.04 ether,
            amountForPreSale_: 350,
            amountForPublicSale_: 350,
            amountForFreeSale_: 100,
            maxBatchSizePublicSale_: 100,
            maxBatchSizePreSale_: 100
        });
        __Ownable_init();
    }
    ...
    function preSaleMint(uint256 quantity) external payable {
        ...
        console.log(ERC721AStorage.layout()._preSaleCurrentIndex);
        console.log(ERC721AStorage.layout()._tokensBoughtPreSale[msg.sender]);
    }
