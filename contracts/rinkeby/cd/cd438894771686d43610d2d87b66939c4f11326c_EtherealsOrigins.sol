...
// File: contracts/EtherealsOrigins.sol
...
contract EtherealsOrigins is ERC721, Ownable, ReentrancyGuard, VRFConsumerBase {
  ...
  /// @notice Metadata assets will be offset by this value ensuring fair distribution
  ...
  /// @notice Set the token offset using Chainlink VRF
