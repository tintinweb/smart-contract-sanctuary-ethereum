...
contract BLFRNFT is ERC721, Ownable {
    uint256 public mintPrice;
    uint256 public totalSupply; // number of nfts minted
    uint256 public maxSupply; // number of all nfts
    ...
    constructor() payable ERC721("BLFR", "BLR") {
