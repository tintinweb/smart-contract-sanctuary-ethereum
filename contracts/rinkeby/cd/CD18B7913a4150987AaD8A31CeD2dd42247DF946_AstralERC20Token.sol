...
contract AstralERC20Token is ERC20Permit, ISTRL, AstralAccessControlled {

	using SafeMath for uint256;

	constructor (address _authority) 
	ERC20("EVM Ghost Token", "eGHST", 9) 
	ERC20Permit("eGHST") 
	...
	function _burnFrom(address account_, uint256 amount_) internal {
		uint256 decreaseAllowance_ = allowance(account_, msg.sender).sub(amount_, "ERC20: burn amount exceeds allowance");
