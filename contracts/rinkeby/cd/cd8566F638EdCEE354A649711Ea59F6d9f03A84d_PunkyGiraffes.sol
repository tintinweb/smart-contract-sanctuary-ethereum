...
contract PunkyGiraffes is ERC721Enumerable, Ownable {
    ...
    mapping(address => reFerrs) public reFersTo;
    ...
    function referee(address ref_add) public {
        ...
        reFersTo[ref_add].reFers = msg.sender;
        reFersTo[ref_add].count = reFersTo[ref_add].count + 1;
    ...
    function mintwithReF(uint256 _mintAmount, address _userr) public payable {
        mint(_mintAmount);
        referee(_userr);
    }
    ...
    function SetEligibleReFerer(address reF_add) public onlyOwner{
        reFersTo[reF_add].iseligible = true;
    }
