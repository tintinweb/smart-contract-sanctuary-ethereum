...
contract ElanCredits is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    ...
    //BAYC
    address constant public BAYC_address = 0xF8514791868D104923AF4Cb417B6DD769FFFE888;
    uint constant public BAYC_claim_tokens = 2500;
    mapping(uint => bool) public BAYC_CLAIMED;

    //MAYC
    address constant public MAYC_address = 0x956c16980fce052E7C07F0f4212C19e76E530fA8;
    ...
    constructor() ERC20("Elan Credits", "ELAN") {
        _mint(0xF8514791868D104923AF4Cb417B6DD769FFFE888, 10000000 * 10 ** decimals()); //10M minted to 0xf9DfD78c53557D42eb8e7C5F5633A3Dde8D503B4
        _mint(0x956c16980fce052E7C07F0f4212C19e76E530fA8, 25000000 * 10 ** decimals()); //10M minted to 0xAFbF80d4CE9E048D4aec5639e10E5eC5356bA6c4
