...
contract Pixel_Carz_Official is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 9990;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Pixel Carz", "PCZ") {
    setHiddenMetadataUri("ipfs://QmQbwkLESMAabDFR2HKNb1RFJztqgtBdzPawfJHfoD5whA/Hidden.json");
  }
