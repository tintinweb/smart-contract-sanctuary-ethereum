...
//      如果允许扣押带有“id”的物品，则返回“true”，否则返回“false”
//      */
...
contract ERC11554k is Context, Ownable, AccessControl, ERC1155Pausable {
    ...
    // First owners of items.物品的第一所有者
    mapping(uint256 => address) internal _originators;
    // Fees manager contract address. 费用经理合同地址
     ...
     */
    constructor(string memory uri,string memory _name) ERC1155(uri) {
        name = _name;
     ...
     * - the caller must have the `DEFAULT_ADMIN_ROLE`. 
     */
    function transferAllRoles(address newAdmin) external onlyOwner{
        // require(
        //     hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
