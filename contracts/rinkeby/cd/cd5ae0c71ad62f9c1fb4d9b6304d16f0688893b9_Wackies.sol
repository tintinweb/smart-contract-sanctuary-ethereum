...
contract Wackies is ERC721, Ownable {
    ...
    address private _signer = 0x7889cD973b678995cb992862a2b486D9f4eB24Ae;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xbB68F66f170F6093774dc96F9A1574DCC139ad01).transfer(currentBalance *  25 / 1000);
        ...
        payable(0x6B6881831314b33Fad2D470509A60692fd5B47C0).transfer(address(this).balance);
    }
