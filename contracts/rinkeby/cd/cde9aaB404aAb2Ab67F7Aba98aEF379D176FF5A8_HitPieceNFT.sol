...
contract HitPieceNFT is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721RoyaltyUpgradeable, ERC721PausableUpgradeable, OwnableUpgradeable, HPApprovedMarketplaceUpgradeable, IHPMarketplaceMint, NFTContractMetadataUpgradeable {
  ...
  address public mintEventEmitterAddress;
  ...
  function _mintTo(
    ...
    IHPMintEvent hpMintEventEmitter = IHPMintEvent(address(mintEventEmitterAddress));
    hpMintEventEmitter.emitMintEvent(
        to, 
        address(this),
        newItemId,
        trackId);
