...
contract TwentyfourTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TESTYPARROTS", "T24P") {
    setHiddenMetadataUri("ipfs://QmcBXU9WKTPpwGh1i1DmXD2qK8zA71jEdoM6pSbZfLW6K3/.json");
  }
