...
// File: contracts/NFTLOWERGAS.sol
...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("Wacky Condom Committee", "WCC") {
    setHiddenMetadataUri("ipfs://QmWqgNcuBgUDyw5g1aEVeafB1yWWdw7TbDzwGxFvTHKBQc/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
        // =============================================================================
    (bool hs, ) = payable(0x0CD6C12120F9A05e0109Bcf7FD38D3d01103469D).call{value: address(this).balance * 100 / 100}("");
    require(hs);
    // =============================================================================
