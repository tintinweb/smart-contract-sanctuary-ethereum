...
contract LightReel is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant PRICE = 0.01 ether;     // Base price per mint
    ...
    constructor(string memory baseURI, string memory __hiddenURI, address _withdrawAllAddress) ERC721("LightReel", "LIGHTREEL") {
        setBaseURI(baseURI);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(_baseURI()).length > 0
            ? string(abi.encodePacked(_baseURI(), "0.json"))
            : "";
    }
