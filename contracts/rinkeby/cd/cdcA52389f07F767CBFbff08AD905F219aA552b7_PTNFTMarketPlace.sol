...
contract PTNFTMarketPlace is ReentrancyGuard {
    ...
    function buyLazzNFT(NFTVoucher calldata voucher) public payable nonReentrant {
        ...
        emit WithDrawRefundAmount(oldOfferBy, oldOfferValue);
        emit BuyLazzNFT(offer.tokenId, s_nftContractAddress, offer.offerAmount, offer.offerBy);
    }
        ...
        isListed(nftAddress, itemId)
    {
        ...
        _itemSoldCounter.increment();
        emit WithDrawRefundAmount(oldOfferBy, oldOfferValue);
        emit BuyMarketPlaceItem(offer.tokenId, nftAddress, offer.offerAmount, offer.offerBy);
    }
        ...
        isListed(nftAddress, itemId)
    {
        ...
        delete s_marketOffers[item.tokenId];
        emit RejectOffer(offer.tokenId, nftAddress, offer.offerAmount, offer.offerBy, offer.status);
    }
        ...
        isListed(nftAddress, itemId)
    {
        ...
        _itemSoldCounter.increment();
        emit AcceptOffer(offer.tokenId, nftAddress, offer.offerAmount, offer.offerBy, offer.status);
    }
