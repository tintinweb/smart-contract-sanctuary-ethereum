...
// MMMMMMMMMMMMMMMMMMMMMMMMMM  MMMMMMM;     MMMM    +MMMM.MM1qMMMMMMMMMMMMMMMMMMMMMMMMMM
...
contract MadMouse is Ownable, MadMouseStaking, VRFBase {
    ...
    address _signerAddress = 0x0d61565960A8C5F6cEFfE3E78552427a6c20B455;
    // address _signerAddress = 0xA5225c1A21e23269371ff29D9b8390c300903be3;
    ...
    // string constant unrevealedURI = 'ipfs://QmZkbgKXvTSWztvfBXcug46eY43boupcsCJkhoT6JcdZ2H';
    string constant unrevealedURI = 'ipfs://UNREVEALED';
    string public imagesBaseURI;
    string public defaultBio = 'MadMouse Collection';
...
contract MadMouseMetadata {
    ...
    // ["Awkward", "Angry", "Bored", "Confused", "Grimaced", "Love", "Laughing", "Sad", "Shy", "Stupid", "Whistling"]
    bytes constant EXPRESSION =
        hex'41776b7761726400416e67727900426f72656400436f6e6675736564004772696d61636564004c6f7665004c61756768696e670053616400536879005374757069640057686973746c696e67';
    ...
    // ["Black", "White", "Blue", "Kimono", "Toge", "Cowboy", "Guard", "Farmer", "Napoleon", "King", "Jumper", "Sailor", "Pirate", "Mexican", "Robinhood", "Elf", "Viking", "Vampire", "Crocodile", "Asian", "Showman", "Genie", "Barong"]
    bytes constant BODY =
        hex'';
    ...
    // ["Pie", "Balloons", "Twisted", "Music Box", "Water Flow", "Puppets", "String", "Mime 1", "Mime 2"]
    bytes constant CLOWN_BODY_LEVEL_2 =
        hex'5069650042616c6c6f6f6e730054776973746564004d7573696320426f7800576174657220466c6f77005075707065747300537472696e67004d696d652031004d696d652032';
    ...
    // ["Pie+", "Balloons+", "Twisted+", "Music Box+", "Rainbow Flow", "Puppets+", "String+", "Frame 1", "Frame 2"]
    bytes constant CLOWN_BODY_LEVEL_3 =
        hex'5069652b0042616c6c6f6f6e732b00547769737465642b004d7573696320426f782b005261696e626f7720466c6f7700507570706574732b00537472696e672b004672616d652031004672616d652032';
    ...
    // ["Hatter", "Cards", "Wizard", "Pento", "Fortune", "Fantasy", "Majestic", "Prisoner"]
    bytes constant MAGICIAN_HAT =
        hex'4861747465720043617264730057697a6172640050656e746f00466f7274756e650046616e74617379004d616a657374696300507269736f6e6572';

    // ["Doves", "Cards", "Wand", "Rabbit", "Crystal", "Levitate", "Saw", "Handcuffed"]
    bytes constant MAGICIAN_BODY_LEVEL_2 =
        hex'446f7665730043617264730057616e6400526162626974004372797374616c004c65766974617465005361770048616e64637566666564';

    // ["Phoenix", "Cards+", "Wand+", "Rainbow", "Snow Globe", "Levitate+", "Grater", "Cement"]
    bytes constant MAGICIAN_BODY_LEVEL_3 =
        hex'50686f656e69780043617264732b0057616e642b005261696e626f7700536e6f7720476c6f6265004c657669746174652b004772617465720043656d656e74';

    // ["Blue Curtains", "Pink Poster", "Sky", "Hills", "Snow", "Space", "Factory", "Site"]
    bytes constant MAGICIAN_BACKGROUND_LEVEL_3 =
        hex'426c7565204375727461696e730050696e6b20506f7374657200536b790048696c6c7300536e6f7700537061636500466163746f72790053697465';
    ...
    // ["Balls", "Clubs", "Knives", "Hoops", "Spinning", "Bolas", "Diabolo", "Slinky"]
    bytes constant JUGGLER_BODY =
        hex'42616c6c7300436c756273004b6e6976657300486f6f7073005370696e6e696e6700426f6c617300446961626f6c6f00536c696e6b79';

    // ["Balls+", "Clubs+", "Knives+", "Hoops+", "Spinning+", "Bolas+", "Diabolo+", "Slinky+"]
    bytes constant JUGGLER_BODY_LEVEL_2 =
        hex'42616c6c732b00436c7562732b004b6e697665732b00486f6f70732b005370696e6e696e672b00426f6c61732b00446961626f6c6f2b00536c696e6b792b';

    // ["Balls++", "Clubs++", "Knives++", "Hoops++", "Spinning++", "Bolas++", "Diabolo++", "Slinky++"]
    bytes constant JUGGLER_BODY_LEVEL_3 =
        hex'42616c6c732b2b00436c7562732b2b004b6e697665732b2b00486f6f70732b2b005370696e6e696e672b2b00426f6c61732b2b00446961626f6c6f2b2b00536c696e6b792b2b';

    // ["Spotlight Top", "Manor", "Target", "Forest", "Spotlight Greenpink", "Desert", "Fireworks", "Shadow"]
    bytes constant JUGGLER_BACKGROUND_LEVEL_3 =
        hex'53706f746c6967687420546f70004d616e6f720054617267657400466f726573740053706f746c6967687420477265656e70696e6b004465736572740046697265776f726b7300536861646f77';
    ...
    // ["Light Whip", "Fire Hoop", "Bananas", "Rainbow Whip", "Uniwhip", "Bamboo", "Fish+", "Rainbow Hoop"]
    bytes constant TRAINER_BODY_LEVEL_3 =
        hex'4c696768742057686970004669726520486f6f700042616e616e6173005261696e626f77205768697000556e69776869700042616d626f6f00466973682b005261696e626f7720486f6f70';
    ...
    // ["Hula Hoop", "Rolla Bolla", "Monocycle", "Trapezist", "None", "Swing", "Dumbbells", "Trampoline"]
    bytes constant PERFORMER_SCENE =
        hex'48756c6120486f6f7000526f6c6c6120426f6c6c61004d6f6e6f6379636c650054726170657a697374004e6f6e65005377696e670044756d6262656c6c73005472616d706f6c696e65';
    ...
    // ["Hula Hoop+", "Tower", "Funambulist", "Trapezist Twins", "None", "Tap Dance", "Dumbbell Stand", "Cody"]
    bytes constant PERFORMER_SCENE_LEVEL_2 =
        hex'48756c6120486f6f702b00546f7765720046756e616d62756c6973740054726170657a697374205477696e73004e6f6e65005461702044616e63650044756d6262656c6c205374616e6400436f6479';
    ...
    // [87, 12, 12, 12, 5, 12, 12, 5, 12, 5, 12, 12, 5, 12, 12, 12, 12, 5]
    uint256 constant WEIGHTS_GLASSES = 0x0000000000000000000000000000050c0c0c0c050c0c050c050c0c050c0c0c57;
    ...
    function buildMouseMetadata(uint256 tokenId, uint256 level) public view returns (string memory) {
    ...
    function mouseMetadataJSON(uint256 tokenId, uint256 level) private view returns (string memory) {
        ...
        if (bytes(name).length == 0) name = string.concat('MadMouse #', tokenId.toString());
...
abstract contract MadMouseStaking is ERC721M, Ownable {
    ...
    uint256 constant BOOST_BONUS = 1000;
    ...
    function tokenBonus(uint256 userData) private view returns (uint256) {
        unchecked {
            ...
            if (block.timestamp <= boostEnd) return BOOST_BONUS;
            ...
            return (BOOST_BONUS * (boostEnd - lastClaimed)) / (block.timestamp - lastClaimed);
        }
    }
    ...
    function getUserStakeInfo(address user) external view returns (StakeInfo memory info) {
        ...
        info.tokenBoost = (block.timestamp < userData.boostStart() + TOKEN_BOOST_DURATION) ? BOOST_BONUS / 100 : 0;
...
abstract contract ERC721M {
    ...
    function _mintAndStake(
        ...
        unchecked {
            ...
            if (numMinted_ + quantity > maxPerWallet) revert MintMaxWalletReached();
