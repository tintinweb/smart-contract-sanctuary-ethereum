...
contract Techforce is ERC721A, Ownable, ReentrancyGuard, ContextMixin {
    // ===== Variables =====
    ...
    // ===== Public mint =====
    function publicMint(uint256 amount) external onlySender onlyAuthorized nonReentrant {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://raw.githubusercontent.com/KartikRajendran10126/OpenseaJs-SDK/master/contractdata.json";
    }
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // 0x1E525EEAF261cA41b809884CBDE9DD9E1619573A - For Rinkeby
        // 0xa5409ec958c83c3f309868babaca7c86dcb077c1 - For Mainnet
        // <<>> - For Polygon
