...
abstract contract Generic721 is ERC721Enumerable {
    ...
    function changeMintTime(
        ...
        CardType[_cardID].mintTime = SafeCast.toUint128(block.timestamp) + SafeCast.toUint128(3 minutes);
        CardType[_cardID].mintEndTime = SafeCast.toUint128(block.timestamp)+ SafeCast.toUint128(1 hours);
    }
