...
// File: contracts/SharpSharks.sol
...
contract SharpSharks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sharp Sharks", "SS") {
    setHiddenMetadataUri("ipfs://QmbzZayA6JNcaQcSGj3qEvYpLJhiizQtAc5THzFQRU7VCA/hidden.json");
  }
