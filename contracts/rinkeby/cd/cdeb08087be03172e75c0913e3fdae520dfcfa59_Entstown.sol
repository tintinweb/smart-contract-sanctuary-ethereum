...
contract Entstown is ERC721A, Ownable, Pausable 
{
    ...
    uint256 public walletMintLimit = 20;
    uint256 public txnMintLimit = 5;
    uint256 public txnWLMintLimit = 10;
    bytes32 public freeWLMerkleRoot = 0x70dac3333f0e4fb2c7c858abae1bd930c10e8acc325e8914328f144b0c02356e;
    ...
    function wlFreeMint(bytes32[] calldata _merkleProof, uint256 quantity)
        ...
        callerIsUser 
    {
        require(quantity <= txnWLMintLimit, "Up to 5 mints allowed per transaction");
        require(mintList[msg.sender] + quantity <= walletMintLimit, "Up to 20 mints allowed per wallet");
    ...
    function freeMint(uint256 quantity)
        ...
        callerIsUser    
    {
        require(quantity <= txnMintLimit, "Up to 5 mints allowed per transaction");
        require(mintList[msg.sender] + quantity <= walletMintLimit, "Up to 20 mints allowed per wallet");
        require(totalSupply() + quantity <= totalColSize, "EXCEED_COL_SIZE");
