...
contract Market is Context, ERC721Holder, Ownable {
  ...
  function createPrivateBidList(
    ...
    uint256 auctId = _getNextAndIncrementAuctionId();

    ReserveAuction storage act = auctionIdToReserveAuction[auctId];
    ...
    emit PrivateBidCreated(auctId, _msgSender(), nftId, reservePrice);
  }
