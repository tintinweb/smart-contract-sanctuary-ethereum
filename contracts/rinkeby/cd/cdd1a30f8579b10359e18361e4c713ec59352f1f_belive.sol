...
contract belive is Ownable, ERC721A, ReentrancyGuard {
  uint256 public immutable maxPerAddressDuringMint;
  
  uint256 price = 1500000000000000;


  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("haha", "xixi", maxBatchSize_, collectionSize_) {
    ...
    callerIsUser
  {
    ...
    if(numberMinted(msg.sender)<1){
      uint256 totalPrice = (quantity - 1) * price;
