    ...
    ReentrancyGuard 
{
    ...
    constructor() ERC1155("ipfs://QmNhwJjdSdkHrp3CUBn7KTeKvn7P26qh4yP94AWwAFyfRb/{id}.json") {
        RED_DWARF = 0;
        BLUE_DWARF = 1;
        CYBER_LIME = 2;
        GALACTIC_AMETHYST = 3;
        ...
        maxSupplies[RED_DWARF] = 3;
        maxSupplies[BLUE_DWARF] = 3;
        maxSupplies[CYBER_LIME] = 3;
        maxSupplies[GALACTIC_AMETHYST] = 3;
        maxSupplies[THERMAL_EMISSION] = 3;
        maxSupplies[COSMIC_RUBY] = 3;
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        return (
            string(abi.encodePacked(
                "ipfs://QmNhwJjdSdkHrp3CUBn7KTeKvn7P26qh4yP94AWwAFyfRb/",
