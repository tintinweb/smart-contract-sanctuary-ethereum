...
// forked from dom; use however you like
...
interface IDataChunkCompiler {
    ...
    // function compileN(address[] memory chunkAddresses)
    //     external
    //     view
    //     returns (string memory);
}
...
contract Renderer {
    ...
    IDataChunkCompiler public compiler;

    address[9] public threeAddresses;
    address[12] public ethersAddresses;
    ...
    function setEthersAddress(
        ...
        require(msg.sender == owner);
        ethersAddresses[0] = chunk1;
        ethersAddresses[1] = chunk2;
        ethersAddresses[2] = chunk3;
        ethersAddresses[3] = chunk4;
        ethersAddresses[4] = chunk5;
        ethersAddresses[5] = chunk6;
        ethersAddresses[6] = chunk7;
        ethersAddresses[7] = chunk8;
        ethersAddresses[8] = chunk9;
        ethersAddresses[9] = chunk10;
        ethersAddresses[10] = chunk11;
        ethersAddresses[11] = chunk12;
    }
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        ...
        // address[] memory eAddress = new address[](12);

        // eAddress[0] = ethersAddresses[0];
        // eAddress[1] = ethersAddresses[1];
        // eAddress[2] = ethersAddresses[2];
        // eAddress[3] = ethersAddresses[3];
        // eAddress[4] = ethersAddresses[4];
        // eAddress[5] = ethersAddresses[5];
        // eAddress[6] = ethersAddresses[6];
        // eAddress[7] = ethersAddresses[7];
        // eAddress[8] = ethersAddresses[8];
        // eAddress[9] = ethersAddresses[9];
        // eAddress[10] = ethersAddresses[10];
        // eAddress[11] = ethersAddresses[11];

        // string memory ethers = compiler.compileN(eAddress);
