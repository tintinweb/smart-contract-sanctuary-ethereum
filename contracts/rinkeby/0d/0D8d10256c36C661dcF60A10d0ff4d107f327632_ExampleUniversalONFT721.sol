...
contract ExampleUniversalONFT721 is UniversalONFT721 {
    constructor(address _layerZeroEndpoint, uint _startMintId, uint _endMintId) UniversalONFT721("UniversalONFT721", "ONFT721", _layerZeroEndpoint, _startMintId, _endMintId) {
        for(uint i; i < 25; i++) {
