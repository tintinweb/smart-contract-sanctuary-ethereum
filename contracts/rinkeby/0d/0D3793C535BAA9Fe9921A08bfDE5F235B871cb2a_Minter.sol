...
contract Minter is Ownable, ReentrancyGuard, IMinter {
    ...
    function purchase(
        ...
        // CHECKS
        uint256 gasPriceInWei = erc721CoreContract.getCollectionGasPriceInWei(collectionId);
        uint256 amountRequired = gasPriceInWei * numberOfTokens;
        require(msg.value >= gasPriceInWei * numberOfTokens, "Must send minimum value to mint!");

        // EFFECTS
        tokenIds = erc721CoreContract.mintBatch(to, collectionId, numberOfTokens);
    ...
    function purchaseWithErc20(
        ...
        // CHECKS
        uint256 erc20TokenPriceInWei = erc721CoreContract.getCollectionErc20TokenPrice(collectionId, erc20Token);
        uint256 amountRequired = erc20TokenPriceInWei * numberOfTokens;
        IERC20 erc20Contract = IERC20(erc20Token);

        require(erc20Contract.balanceOf(_msgSender()) >= amountRequired, "Not enough erc20 token");
        require(
            erc20Contract.allowance(_msgSender(), address(this)) >= amountRequired,
