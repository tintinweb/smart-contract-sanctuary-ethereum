    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
        ...
        initializer 
    {
        ...
        ogList1.price = 0.05 ether;

        ogList2.startTime = ogList1.startTime + 2 days;
        ogList2.endTime = ogList1.startTime + 4 days;
        ogList2.purchaseLimit = 1000;
        ogList2.remainingTokens = 1000;
        ogList2.price = 0.05 ether;
        ...
        pbList.startTime = wlList.startTime + 3 days;
        pbList.endTime = wlList.startTime + 6 days;
