...
import './YummyPair.sol';

contract SwapFactory is IUniswapV2Factory {
    address public feeTo;
    address public feeToSetter;
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(YummyPair).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(YummyPair).creationCode;
...
contract YummyPair is IUniswapV2Pair, SwapERC20 {
...
contract SwapERC20 is IUniswapV2ERC20 {
    ...
    string public constant name = 'Yummy-LP-Token';
    string public constant symbol = 'YUMMY-LP';
