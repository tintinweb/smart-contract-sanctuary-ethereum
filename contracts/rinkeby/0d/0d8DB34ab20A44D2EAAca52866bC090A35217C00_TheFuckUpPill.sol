...
contract TheFuckUpPill is ERC1155, Ownable {
    using Strings for uint256;

    address private theFuckUpPillsV2;
    ...
    function burnPillForAddress(uint256 typeId, address burnTokenAddress)
        external
    {
        require(msg.sender == theFuckUpPillsV2, "Invalid burner address");
    ...
    function uri(uint256 typeId) public view override returns (string memory) {
        require(validPillTypes[typeId], "URI requested for invalid serum type");
        return
