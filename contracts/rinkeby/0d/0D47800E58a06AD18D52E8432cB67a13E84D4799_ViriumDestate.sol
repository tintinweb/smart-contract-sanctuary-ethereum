...
contract ViriumDestate is IViriumDestate, AccessControl, ERC721Burnable, ERC721Lockable {
    ...
    constructor() ERC721Lockable("ViriumDestate", "VD"){
    ...
    function mint(address to) external onlyRole(MAINTAIN_ROLE) {
        require(_mintedCounter.current() < MAX_TOTAL_SUPPLY, "ViriumDestate: Mint would exceed max supply");

        _mintedCounter.increment();
        _mint(to, _mintedCounter.current());
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal view override(ERC721, ERC721Lockable) {
...
contract ERC721Lockable is ERC721, IERC721Lockable {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal view virtual override(ERC721) {
