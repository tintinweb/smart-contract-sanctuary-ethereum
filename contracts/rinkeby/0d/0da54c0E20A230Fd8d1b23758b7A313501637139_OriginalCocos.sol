...
contract OriginalCocos is ERC721Enumerable, Ownable {
    ...
    bool public ALOpen = true;
    bool public allowlistsale;
    uint256 public MAX_AL = 51;
    uint256 public priceInWeiAL = 0.01 ether;
    ...
    // add + 1 to each allowlist for LTE check
    ...
    function claimAllowList(address _ALister) external payable {
        ...
        require(ALCOUNTER.current() < MAX_AL,                                   "No more AL spots left"); 
    ...
    function mintAllowList(uint256 _numcocos) public payable {
        ...
        require(_numcocos * priceInWeiAL == msg.value,                      "Invalid funds provided");
    ...
    function mintPublic(uint256 _numcocos) public payable {
        uint256 supply = _owners.length;
        require(publicsale,                                                  "Public sale hasn't started");
        require(supply + _numcocos < MAX_SUPPLY,                             "Not enough cocos left");
        require(_numcocos * priceInWei == msg.value,                         "Invalid funds provided");
    ...
    function toggleALOpen() public onlyOwner {
        ALOpen = !ALOpen;
    }

    function toggleAllowListSale() public onlyOwner {
