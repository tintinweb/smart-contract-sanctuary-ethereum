...
contract NftCollection is ERC721A, ERC721AQueryable, ReentrancyGuard, Ownable, VRFConsumerBaseV2{
    ...
    // Max NFT per user
    uint256 public MAX_NFT_PER_USER = 50;
    ...
    ) ERC721A(_name, _symbol) VRFConsumerBaseV2(_chainlinkCoordinatorAddress) {
        baseURI = _baseURI;
...
//    function supportsInterface(bytes4 interfaceId) public view override(ERC721A, ERC721AQueryable) returns (bool){
