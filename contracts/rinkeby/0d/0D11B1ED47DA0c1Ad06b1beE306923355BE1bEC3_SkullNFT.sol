...
contract SkullNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    ) ERC721A("Skull NFT", "SKLNFT") {
        contractBaseURI = _metadataURI;
        isPublicSaleActive = false;
        isTokehandsClaimActive = false;
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked(contractBaseURI, "999"));
    }
    ...
    function setIsOpenSeaProxyActive() external onlyOwner {
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (
            address(this),
            SafeMath.div(SafeMath.mul(salePrice, royaltyPercent), 100)
        );
    }
}
