...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new AxerNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AxerNFTUser1155Token token = AxerNFTUser1155Token(address(addr));
...
contract AxerNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
