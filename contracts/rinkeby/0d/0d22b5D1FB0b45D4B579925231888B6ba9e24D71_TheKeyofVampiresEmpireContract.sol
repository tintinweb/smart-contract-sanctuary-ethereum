...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x619f54A08427BFb76704804979b79F5ad814A68D];
...
// File: contracts/TheKeyofVampiresEmpireContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TheKeyofVampiresEmpireContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "The Key of Vampires Empire";
    string public symbol = "VAMPKEY";
