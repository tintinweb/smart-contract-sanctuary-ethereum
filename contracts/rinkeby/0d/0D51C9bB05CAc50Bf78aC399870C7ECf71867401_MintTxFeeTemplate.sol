...
}// File contracts/templates/MintTxFeeTemplate.sol
...
contract MintTxFeeTemplate is ERC20Base, ERC20MintFeature, TxFeeFeatureAlt {
    function initialize(
        string memory name_, 
        string memory symbol_, 
        uint8 decimals_, 
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(TxFeeFeatureAlt) {
    }
