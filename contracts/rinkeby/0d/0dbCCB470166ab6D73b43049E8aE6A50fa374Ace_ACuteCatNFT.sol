...
contract ACuteCatNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("A Cute Cat NFT", "ACC") {}
    
    uint256 public collectionSize = 4981;
    ...
    uint256 public amountForAllowList = 1981;
    ...
    uint256 public publicPrice = 0.005200 ether;
    uint256 public amountForPublicSale = 3000;
