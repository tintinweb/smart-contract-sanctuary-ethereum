...
contract PresentMaterialsCurator is Ownable, ReentrancyGuard  {
    ...
    modifier tokenGateCheck() {
        require(IERC721(tokenGateAddress).balanceOf(msg.sender) > 0, "you do not own tokenGate NFT");
        _;
    }
    ...
    function setTokenGateAddress(address _newTokenGateAddress) onlyOwner external {
        // make this ownable
    ...
    function viewUserBalanceOfTokenGate(address _address) public view returns (uint256) {
    ...
    function addCurator(address _collection, address _newCurator) tokenGateCheck public {
    ...
    function removeCurator(address _collection, address _curatorToRemove) tokenGateCheck public {
