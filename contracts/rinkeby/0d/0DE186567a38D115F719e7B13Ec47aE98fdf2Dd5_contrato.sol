...
contract contrato is ERC721, ERC721Enumerable, Ownable {
    ...
    function uri(uint256 _tokenId) public view virtual returns (string memory) {
        return string(abi.encodePacked("ipfs://Qmej9Dj96A6nASqVsQisc3wc1v6ZMzEx7KzmM4WSrwDztz/", Strings.toString(_tokenId), ".json"));
    }
