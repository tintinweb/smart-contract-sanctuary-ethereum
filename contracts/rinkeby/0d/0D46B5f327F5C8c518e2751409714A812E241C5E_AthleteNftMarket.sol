    ...
    EtherReceiver
{
    ...
    constructor(
        ...
        // TODO: decide if we want to use upgradeable contract ('initialize' method instead of ctor)
...
// TODO: have re-entrancy guard here ?
contract SponsorshipCreation is AthleteSponsorshipMap, Ownable {
    ...
    function buildOnChainAthleteInitStruct(
        ...
        uint8 _ath_number,
        AthleteLib.BasketballPosition _ath_position
    ...
    function _sponsorCreatesOnChainAthlete(
        ...
        // TODO: checks for sender ?

        // TODO: refactor this method to take the args struct
    ...
    function _sponsorCreatesOnChainSponsorshipRound(
        ...
        //        console.log(
        //            "In[SponsorshipCreation::sponsorCreatesOnChainSponsorshipRound] _round_location[%s]",
        //            _args.location
        //        );

        // TODO: replace args here with struct?
    ...
    function sponsorSubmits(
        ...
        if (_init_audit.init_athlete || _init_audit.init_sponsorship_round) {
            // TODO: impl without msg.value arg?
            (
                ,
...
library SponsorshipCreationLib {
    ...
    struct AthleteInitArgs {
        ...
        AthleteLib.Sport sport;
        uint8 number;
        AthleteLib.BasketballPosition position;
    }
...
abstract contract IOriginNftUpgradeable is ERC721URIStorageUpgradeable {
...
contract AthleteSponsorshipMap is AthleteMap, SponsorshipRounds {
    ...
    // TODO: still needed? remove when ready
    // TODO: fn description
        ...
        returns (uint256)
    {
        ...
        // TODO: check sponsorship price is acceptable
...
contract AthleteMap {
    ...
    function _addBasketballAthleteToChain(
        uint256 _db_id,
        bytes32 _name,
        AthleteLib.Sport _sport,
        uint8 _player_number,
        AthleteLib.BasketballPosition _player_position
    ...
    // TODO: consolidate this and the above
    function addAthlete(
        uint256 _db_id,
        bytes32 _name,
        AthleteLib.Sport _sport,
...
contract SponsorshipRounds {
    ...
    // TODO: item 2 - front-end hooks (1. check the round status 2. close the round)
    ...
    // TODO: only contract owner can call
...
library AthleteLib {
    ...
    struct Athlete {
        bytes32 player_name;
        // TODO: assume sport = basketball (extend to all sports)
        // sport-specific info
        Sport sport;
        uint8 player_number;
        // TODO: do we want this to be an on-chain item?
        BasketballPosition player_position;
    }
}
