...
// @title:  10KSuperPosiWords
// @desc:   10KSuperPosiWords that will change your life if you implement...
...
contract TenKSuperPosiWords is ERC721, Ownable, ReentrancyGuard {
    ...
    string private unrevealedTokenURI = "ipfs://QmT4YaoKVDWxMWEj4sXbmm2dZP6hCE5xnfBqHURApUCy7L/placeholder.json";
    uint256 public maxTokens = 10000;
    uint256 public maxPresaleTokens = 4000;
    uint256 public maxTokensPerWallet = 2;
    uint256 public maxMintPerTxPresale = 2;
    uint256 public maxMintPerTx = 2;
    uint256 public tokensReserved = 9000;
    ...
    string public TKSPW_PROVENANCE;

    address a1 = 0xFAB1AD346828CFA0Af375042498648FEEFe6A56B;
    address a2 = 0xbEE2c4e66A987851d423e2e6203e532e8342f17f;

    event TokenMinted(uint256 tokenId);

    constructor(string memory _ipfsCID)
        ERC721("10K Super Posi Words", "TKSPW")
    {
        baseURI = string(abi.encodePacked("ipfs://", _ipfsCID, "/"));

        /*
         * Full reveal of the 10K Super Posi Words would be 1 hour after the deployment of the contract
         */
        REVEAL_TIMESTAMP = block.timestamp + 60*60;
    }
    ...
    /**
     * Mints Super Posi Words
     */
    function mintSuperWords(uint256 _amount) public payable {
