...
contract MiceliosTest is ERC721A, Ownable {
    ...
    string public prerevealURL = "ipfs://QmcPVk5yjtQmzTKr85jS3vmA7tEwJt2hps2oCPTf8Kw8yN/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("MiceliosTest", "BLOOM") {}
