...
contract NEWLINETESTFREERES6 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    if (msg.sender != owner()) {
      require(_mintAmount > 0 && _mintAmount <= maxAllowedTokensPerPurchase, 'Invalid mint amount!');
  ...
  function setFreeMaximumAllowedTokensPerWallet(uint256 _count) public onlyOwner {
