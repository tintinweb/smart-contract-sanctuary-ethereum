...
contract ZZZZ is Ownable, ERC721I, Security {
	...
	constructor() ERC721I("Z Z Z Z", "ZZZZ") {
        // _mintMany(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, 100);
    }

	function freeMint(uint256 quantity) external onlySender {
		require(mintIsActive, "Mint not ready");
		require(totalSupply < maxFreeMints, "No more free mints");
		require(quantity >= 1 && quantity <= 20, "Invalid Quantity");
		require(maxSupply > totalSupply, "Sold out");
		require(balanceOf[msg.sender] < 100, "Limit Reached");
