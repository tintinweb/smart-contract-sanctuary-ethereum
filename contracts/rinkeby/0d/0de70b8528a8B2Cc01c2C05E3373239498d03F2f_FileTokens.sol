...
contract Meta {
    ...
    function getMeta(uint token_id_) public view tokenExists(token_id_) returns(string memory){
        ...
        '{',
        '"name":"Stems Garden ',Strings.toString(token_id_),'",',
