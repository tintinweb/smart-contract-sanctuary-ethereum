...
contract MetaTestingNFT is BEP721Enumerable, Ownable {
    ...
    uint256 private _royaltiesPBEPentage; // royalty pBEPentage
    ...
    // set the royaly receiver and pBEPentage 
    function setRoyaltyInfo(address royaltiesReceiver, uint256 royaltiesPBEPentage) public onlyOwner (){
        _royaltiesReceiver = royaltiesReceiver;
        _royaltiesPBEPentage = royaltiesPBEPentage;
    }

    // show royalty receiver and pBEPentage
    function royaltyInfo(uint256 tokenId, uint256 salePrice) external view returns (address, uint256 royaltyAmount) {
        ...
        royaltyAmount = (salePrice / 10000) * _royaltiesPBEPentage;
