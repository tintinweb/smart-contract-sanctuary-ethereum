...
// File: contracts/Ogre_District.sol
...
contract OgreDistrict is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public maxPerTx = 10;
    uint256 public maxSupply = 4500;
    uint256 public freeMintMax = 4500; // Free supply
    uint256 public price = 0.0025 ether;
    uint256 public maxFreePerWallet = 1; 

    string private baseURI = "https://ogredistrict.mypinata.cloud/ipfs/QmV3S3jnoEq8RNrqHghzYVMCqpGMuXaK2n2wDXmDxFCwVK/";
    ...
    constructor() ERC721A("Ogre District", "OGRE") {}
