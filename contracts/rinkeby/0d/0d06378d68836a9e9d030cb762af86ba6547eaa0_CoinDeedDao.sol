    ...
    ICoinDeedDao
{
    ...
    function _claimDToken(
        ...
        uint256 tokenPrice = _tokenPrice(_tokenAddress);
        uint256 tokenPriceDecimals = IERC20MetadataUpgradeable(coinDeedAddressesProvider.stableCoinAddress()).decimals();

        uint256 amountTokenEx = _amount
            .mul(tokenPrice)
            .div(10**tokenPriceDecimals)
