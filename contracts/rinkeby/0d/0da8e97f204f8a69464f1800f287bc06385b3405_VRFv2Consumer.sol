...
// File: docs.chain.link/samples/VRF/WIP_VRFv2Consumer.sol
...
contract VRFv2Consumer is VRFConsumerBaseV2 {
  ...
  uint32 numWords = 1;
    ...
    function fulfillRandomWords(
        ...
        // why can't i call expand() here? expand writes the divided number array to storage
        ...
        returns (uint256[] memory expandedValues)
    {
        ...
        for (uint256 i = 0; i < n; i++) {
            expandedValues[i] =
                (uint256(keccak256(abi.encode(num, i))) % 100) + 1;
        }
