...
contract TrueTest is ERC721A, Ownable {
  ...
  uint256 public constant claimableTokensCount = 22;
  ...
  // MODIFIERS
  modifier isOgsale() {
    require(mintType == MintType.OG, 'Presale is not started!');
    _;
  }

  modifier isPresale() {
    require(mintType == MintType.ALLOWLIST, 'Presale is not started!');
    _;
  }

  modifier isPublicSale() {
    require(mintType == MintType.PUBLIC, 'Public is sale not started!');
    _;
  }
