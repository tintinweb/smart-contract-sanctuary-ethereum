...
contract CoinDeed is ICoinDeed, AccessControl {
    ...
    function edit(DeedParameters memory deedParameters_,
        ...
        uint256 wholesaleIdEmit = saleId_ == 0 ? saleId_ : wholesaleId;
        ...
        ICoinDeedFactory(coinDeedAddressesProvider.coinDeedFactory()).emitDeedEdited(manager, wholesaleIdEmit);
    }
