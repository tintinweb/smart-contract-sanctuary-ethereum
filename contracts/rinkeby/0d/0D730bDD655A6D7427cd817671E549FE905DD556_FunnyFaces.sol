...
contract FunnyFaces is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FunnyFaces", "FF") {
    setHiddenMetadataUri("ipfs://QmaP2UqAK2aFSdQhc4H3kaHsLXmvjTW6HxKdN7zGe9HYZ7/hidden.json");
  }
