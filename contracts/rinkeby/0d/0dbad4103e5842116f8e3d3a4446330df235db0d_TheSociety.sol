...
contract TheSociety is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_TOKENS = 1556;
  
  mapping(address => uint256) private allowance;
  string public baseURI;
    
  constructor() ERC721A("The Society", "SOCIETY") {
    setBaseURI("ipfs://QmadMj55t1SLhDKmibJ83aBsL2dB4w2mU1snQqquZbeemU/");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    uint256 payoutPayment1 = balance.mul(1).div(100);
