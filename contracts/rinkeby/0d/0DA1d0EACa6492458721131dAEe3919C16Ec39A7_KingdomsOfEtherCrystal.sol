...
contract KingdomsOfEtherCrystal is IERC1155MetadataURI, EIP712, ERC20, Ownable
{
    ...
    uint private constant PUBLIC_POOL_CAPACITY = 1000;
    ...
    function totalSupply() public pure virtual override returns (uint256) {
        return PUBLIC_POOL_CAPACITY + PRIVATE_POOL_CAPACITY;
    }
    ...
    function mintPublic() external returns (uint256 _tokenId) {
        ...
        return _mint(PUBLIC_POOL_ID, msg.sender);
    }
    ...
    function _mint(uint256 _pool, address _to) internal returns (uint256 _tokenId) {
