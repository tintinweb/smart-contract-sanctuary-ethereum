...
contract Blocktunes is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant TEAM_ALLOCATION = 15;

    mapping(address => uint256) public whitelist;
    string private uri;

    constructor() ERC721("blocktunes", "TUNES") {}
    ...
    function mint() external payable nonReentrant {
        ...
        if (whitelistIsActive) {
            require(
                ...
                "not whitelisted or already minted"
            );
    ...
    function setWhitelistIsActive(bool _whitelistIsActive) external onlyOwner {
