...
contract CHIMERATIVE is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    ...
    function ownerMint(address _address, uint256 _quantity) public onlyOwner {
        uint256 supply = totalSupply();
        require(_quantity > 0, "Mint amount cannot be zero");
        require(_quantity <= supply, "Requests in excess of total supply");
    ...
    // writing
    /**
     * @dev Change the status of a presale.
     */
    ...
    /**
     * @dev Change the status of a public sale.
     */
    ...
    /**
     * @dev Transfer all funds to project members.
     */
