...
contract NFTPickerPass is ERC721A, Ownable {
    ...
    // 0 - not started | 1 - wl mint | 2 - public mint
    // int256 public mintStage = 0;
    ...
    address COMPANY_WALLET = 0x9B33774c3fdC4FdA0f0253E0152b34D69533dFbD;
    ...
    function wlMint(uint256 numTokens) external payable onlyOrigin mintCompliance(numTokens) {
        ...
        require(2 > totalSupply(), "Whitelist minting Over, you can mint now in Public mint.");
        // check amount payed
    ...
    function mint(uint256 numTokens) external payable onlyOrigin mintCompliance(numTokens) {
        ...
        require(2 <= totalSupply(), "Whitelist minting is running, you can mint in Whitelist mint.");
