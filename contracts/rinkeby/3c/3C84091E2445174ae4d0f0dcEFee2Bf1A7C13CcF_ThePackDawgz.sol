...
// File: contracts/ThePackDawgz.sol

/**
 * @title ThePackDawgz contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract ThePackDawgz is ERC721, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    ...
    uint256 public maxToMint = 1000;
    uint256 public MAX_MINT_WHITELIST = 1000;
