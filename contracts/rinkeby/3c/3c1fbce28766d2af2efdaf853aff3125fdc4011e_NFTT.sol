...
contract NFTT is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        ERC721Upgradeable.__ERC721_init("SCOPEXNFT V5", "SXNFT");
        //setBaseURI("https://rh25q24tvf.execute-api.eu-west-2.amazonaws.com/dev/token?id=");
//        setBaseURI("https://nft.scopex.ai/metadata/tokens/");
        setBaseURI("ipfs://");
    ...
    function tokenMeta(uint256 _tokenId) public view returns (TokenMeta memory) {
        require(_exists(_tokenId));
        TokenMeta memory res = _tokenMeta[_tokenId];
        if (owner() != _msgSender()) {
            res.secret = "";
        }
        return res;
        ...
        returns (uint256)
    {
        ...
        TokenMeta memory meta = TokenMeta(newItemId, _price, _name, _tokenURI, _sale, _signature, _secret,_metaData);
