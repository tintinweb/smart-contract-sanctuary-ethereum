// SPDX-License-Identifier: MIT
    ...
    contract OG is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
        ...
        uint private constant MAX_FREEMINT = 2;
        uint private constant MAX_SALE = 2;
        ...
        uint public priceSale = 0.005 ether;
        ...
        constructor(string memory _theBaseURI, string memory _notRevealedURI) ERC721("OGtest", "TSTOG") PaymentSplitter(_team, _teamShares) {
        ...
        function gift(address _account) external onlyOwner {
            ...
            require(supply + 1 <= MAX_FREEMINT + MAX_SALE + MAX_GIFT, "Sold out");
