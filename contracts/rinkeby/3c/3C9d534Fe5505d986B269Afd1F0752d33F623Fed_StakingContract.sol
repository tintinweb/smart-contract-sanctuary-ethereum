...
// File: contracts/tokenStaken.sol
...
contract StakingContract is ERC20, Ownable {
    ...
    constructor(address _depositToken, address _rewardToken) ERC20("AnderToken", "ANT") payable {
    ...
    function modifyTokenBuyPrice(uint _newPrice) public onlyOwner {
