    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        address admin,
        address payable _monegraphAddress
    ...
    function mint(
        ...
        mint(tokenId, to, amount, _uri, data);

        emit NFTAttributes(tokenId, attributes, _uri);
    }
    ...
    function mint(
        ...
        doMint(tokenId, to, amount, _uri, data);
    }
...
import "../MonegraphERC1155.sol";

contract MonegraphERC1155V2 is MonegraphERC1155 {
    ...
    {
        doMint(context.tokenId, context.to, context.amount, context.uri, "0x");
