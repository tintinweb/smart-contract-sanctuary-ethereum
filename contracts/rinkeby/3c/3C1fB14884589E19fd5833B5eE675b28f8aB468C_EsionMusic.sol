...
contract EsionMusic is ERC1155, Ownable {
    ...
    string private ipfsPrefix = "https://infura-ipfs.io/ipfs/";
    string private ipfsCid;
    string private constant dataFormat = ".json";

    using Strings for uint256;

    constructor(string memory _ipfsCid) ERC1155(_ipfsCid) {
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(ipfsPrefix, ipfsCid, "/", _id.toString(), dataFormat));
    }
    ...
    function setIpfsPrefix(string calldata _ipfsPrefix) external onlyOwner {
        ipfsPrefix = _ipfsPrefix;
    }

    function setIpfsCid(string calldata _ipfsCid) external onlyOwner {
        ipfsCid = _ipfsCid;
    }
