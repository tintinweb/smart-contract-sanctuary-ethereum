...
contract HuskyDOG is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Husky DOG", "Gaia") {
  ...
  uint256 public constant MAX_SUPPLY = 149;
  ...
  {
    return string(abi.encodePacked(super.tokenURI(tokenId), "ipfs://bafybeic4np6ezcam4ice6rofn5qtnabf5zwttn3mu6ltq7bmppith3dray/{tokenId}.token.json"));
  }
