...
contract PresaleLaunchpadToken is ERC721AA {
    ...
    function initialize(string memory name_,string memory symbol_,string memory _baseuri,bytes32 root_,bool _jsonn,address _owner,uint256[7] memory info) public initializer {
        _name           =   name_;
        _symbol         =   symbol_;
        baseuri         =   _baseuri;
        _root           =   root_;
        ...
        isSalepaused=true;
        isPresalepPaused=true;}
    

    function mint(uint256 quantity) public payable {
        require(isSalepaused==false,"public sale is not active");
        ...
        payable
    {
        ...
        require(isPresalepPaused == false, "PresaleSale is not active");
        require(quantity <= maxPerTrans, "Chosen Amount exceeds MaxQuantity");
        require(
