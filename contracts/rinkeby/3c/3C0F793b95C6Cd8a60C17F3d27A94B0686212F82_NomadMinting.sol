...
contract NomadMinting {
  ...
  constructor(string memory _metaDataUri, address _nameWrapper) {
    _uri = _metaDataUri;
  ...
  function tokenURI(uint256 ensId) public view virtual returns (string memory) {
  ...
  function mint() public {
    ...
    NameWrapper(nameWrapper).setSubnodeOwnerAndWrap(
      parentNode,
      label,
      msg.sender,
      0
