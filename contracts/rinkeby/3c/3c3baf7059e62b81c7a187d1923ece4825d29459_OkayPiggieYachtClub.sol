...
// ERC721A Contracts v4.0.0
    ...
    string public baseURI = "ipfs://QmY8pYTTY4wrtvSG5BjpQbADmqNWiwUcMsg4dDPj1QMBNu/";
    string public constant baseExtension = ".gif";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("Okay Piggie Yacht Club test", "Piggie") {_safeMint(msg.sender, 20); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmUedMWEpcoGHXgrQkogqnc6VHTazNhsD1q2YiysJbNoXa");}
