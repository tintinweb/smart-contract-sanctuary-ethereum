...
contract LoopopTokenV2 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, ReentrancyGuard, Ownable {
    using Counters for Counters.Counter;
    address public validator;

    mapping(uint32 => bool) _isNonceUsed;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("LoopopTokenV2", "LTK") {}
    ...
    function publicMint(address to, uint256 price, uint32 nonce, string memory uri, bytes memory validatorSig) public payable nonReentrant {
        ...
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
        // payable(validator).transfer(price);
    }
