...
contract testedd is ERC721A, Ownable {
    ...
    constructor() ERC721A("testedd", "testedd") {}
    ...
    function mintTo(address to, uint256 count) external onlyOwner {
      ...
      uint256 price = 0;
      if(_totalMinted() + count <= freeSupply && _walletMintedCount[msg.sender] + count <= maxFreePerWallet) {
        price = 0;
      }
      else {
        price = mintPrice;
