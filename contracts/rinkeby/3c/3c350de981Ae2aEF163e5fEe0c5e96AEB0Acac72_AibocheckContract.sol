...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1653422760;
...
// File: contracts/AibocheckContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AibocheckContract is RamppERC721A {
    constructor() RamppERC721A("AIBO CHECK", "CHEK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HFw5s39s7qwJoqA05cWD/contract-metadata";
    }
}
