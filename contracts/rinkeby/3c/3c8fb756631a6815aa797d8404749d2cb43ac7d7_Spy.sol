...
contract Spy is ERC721AQueryable, Ownable, ERC2981 {
    ...
    uint16 public maxSupplyAmount = 8888;
    ...
    constructor(
    ) ERC721A("Crypto SPY Bubby", "Crypto SB") {
        signer = owner();
        setFeeNumerator(500);
    }
    ...
    address private wallet3 = 0x0ccd5eDceF37AD606BaCC37DB6ed87C8D9164dcA;
    address private wallet4 = 0x0ccd5eDceF37AD606BaCC37DB6ed87C8D9164dcA;
