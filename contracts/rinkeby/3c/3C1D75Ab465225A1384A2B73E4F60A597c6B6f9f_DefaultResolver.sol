    ...
    ProxyConfigResolver
{
     ...
     */
    function isDelegated(bytes32 node, address controller) internal override view returns(bool) {
...
abstract contract RoyaltiesResolver is IRoyaltiesResolver, BaseResolver {
    ...
    mapping(bytes32=>Royalties) private royalties;
    mapping(bytes32=>mapping(address=>Royalties)) private addressRoyalties;
