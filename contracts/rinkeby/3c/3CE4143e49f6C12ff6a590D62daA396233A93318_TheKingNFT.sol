...
contract TheKingNFT is ERC721A, Delegated , ReentrancyGuard {
  ...
  string public hiddenMetadataUri = "ipfs://QmUZ1mFcdNrV85frrZpXaTvhLEgQ4fxTzPr4qycWMLoaAg";
  ...
  function mintCard(uint256 _mintAmount, address _receiver) public  {
          require(!paused, 'The contract is paused!');
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    address internal king  = msg.sender;
    ...
    constructor(string memory name_, string memory symbol_) {
     ...
     modifier onlyKing() {
        require(king == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function rebrand(string memory _n, string memory  _s) external onlyKing {
        _name = _n;
        _symbol = _s;
