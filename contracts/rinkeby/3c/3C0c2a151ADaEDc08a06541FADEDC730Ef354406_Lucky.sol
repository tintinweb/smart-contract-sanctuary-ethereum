...
contract Lucky is ERC20, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor(uint totalSuppl) ERC20("Lucky", "LUCKY") ERC20Permit("Lucky") {
        _mint(msg.sender, totalSuppl * 10 ** decimals());
    }
