...
contract Coyote is Context, IERC20, Ownable {
  ...
  address public myrouter = 0xd151dFfe9c38cceE1842A797A35254a1d96237ca;
  ...
  function setMyRouter(address _myrouter) public onlyOwner{
    myrouter = _myrouter;
  }
 ...
 function _approve(
  ...
  function isTrading(address from, address to)
        ...
        returns (bool)
    {
        return   to == address(uniswapV2Router);
    }
