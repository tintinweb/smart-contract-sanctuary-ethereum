...
contract NFT is ERC721A, Ownable { // todo
    uint256 public constant presalePrice = 0.01e18; // 0.01 ETH
    uint256 public constant price = 0.015e18; // 0.015 ETH
    uint256 public constant SALE_TIME_START = 1650002400; // todo
    uint256 public constant PRESALE_TIME_START = 1649998800; // todo

    uint256 public constant MAX_NFT = 999;
    ...
    bytes32 public wlRoot = 0xa227e509ec86d98b1aa64ebcf0825b9e424eced7b7c042a137d1719335ef0703; // todo
    bytes32 public vipRoot = 0xa227e509ec86d98b1aa64ebcf0825b9e424eced7b7c042a137d1719335ef0703; // todo

    string public baseURI;

    constructor(address payable fundReceiver, string memory _baseUri) ERC721A("NFT", "NFT") { // todo
    ...
    function presaleMint(uint numberOfTokens, bytes32[] memory wlProof, bytes32[] memory vipProof) external payable {
        ...
        require(totalSupply() + numberOfTokens <= MAX_NFT, "Purchase would exceed max NFT supply");
