...
contract TokenFactory is NonblockingLzApp {
    ...
    function mintToken(
        ...
        _lzAction(payload, chId, gas, msg.sender);
    }
...
//                );
    ...
    function _lzAction(bytes memory pload, uint16 chId, uint256 gas, address gasTo) private {
    ...
    function _resAction(bytes memory payload, uint16 chId) private {
        _lzAction(payload, chId, 0, address(this));
    }
