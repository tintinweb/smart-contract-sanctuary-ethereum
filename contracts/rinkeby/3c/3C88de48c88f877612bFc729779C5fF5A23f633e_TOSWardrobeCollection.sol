...
/// T-O-S Wardrobe Collection
/// Fashionwear for the moonwalkers 
contract TOSWardrobeCollection is ERC1155, Ownable {
    ...
    string public constant name = 'TOS Wardrobe Collection';
    
    /// @notice The symbol of the token.
    string public constant symbol = 'TOSWC';
    ...
    string public uri_postfix = '.json';
