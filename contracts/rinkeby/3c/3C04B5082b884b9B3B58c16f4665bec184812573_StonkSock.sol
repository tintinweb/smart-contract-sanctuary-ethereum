...
contract StonkSock is ERC721Enumerable, Ownable, ERC721Pausable, ERC721URIStorage {
    ...
    address public constant devAddress = 0x68AfA499A37878C73c2C51456a315C098B74Bd83;
    ...
    function mintReserve(address _to, string[] memory URIs) public onlyOwner {
    ...
    function presaleMint(address _to, uint256 startId, string[] memory URIs) public payable presaleIsLive returns (uint256[] memory ids)  {
        ...
        require(balanceOf(_to) + _count <= MAX_MINT_PRESALE, 'PreSale Tokens Maxed');
        require(_totalSupply() + _count < PRESAL_LIMIT, "Max limit");
        require(_count < MAX_MINT_PRESALE, "No Presale Tokens Remaining");
