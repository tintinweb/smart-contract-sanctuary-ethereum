...
contract CoinToken is Context, IERC20, Ownable {
    ...
    function swapExactInputSingle(uint256 amountIn) external returns (uint256 amountOut) {
        ...
        TransferHelper.safeTransferFrom(address(this), msg.sender, address(this), amountIn);
        // _transfer(msg.sender, address(this), amountIn);
        TransferHelper.safeApprove(address(this), address(swapRouter), balanceOf(address(this)));
        // _approve(msg.sender, address(swapRouter), balanceOf(address(this)));
