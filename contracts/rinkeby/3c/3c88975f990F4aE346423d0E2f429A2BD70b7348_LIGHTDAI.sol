...
interface IDexRouter {
    ...
    function swapExactTokensForTokens(uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline) external payable;

    function swapTokensForExactTokens(uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline) external payable;
...
//SwapDAI2
    ...
    function swapTokensForDai4(uint256 tokenAmount) public {
     ...
     //DAI 5 return to another address
        function swapTokensForDai5(uint256 tokenAmount) public {
        // generate the uniswap pair path of token -> dai
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = DAI;
    ...
    //DAI 6 return to another address
        function swapTokensForDai6(uint256 tokenAmount) public {
        // generate the uniswap pair path of token -> dai
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = DAI;
    ...
    //DAI 7 return to another address
        function swapTokensForDai7(uint256 tokenAmount) public {
        // generate the uniswap pair path of token -> dai
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = DAI;
