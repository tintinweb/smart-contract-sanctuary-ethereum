...
contract TESTNFT is ERC721URIStorage {
    ...
    constructor(string memory _metadata) ERC721("test1","test1") {
    ...
    function publicMint() public {
        ...
        // require(TokenInterface(erc20Token).allowance(msg.sender, address(this)) >= cost, "not approved for purchase");
        // TokenInterface(erc20Token).transferFrom(msg.sender, address(this), cost);
        // TokenInterface(erc20Token).burn(cost);
        mint(msg.sender);
    }
}