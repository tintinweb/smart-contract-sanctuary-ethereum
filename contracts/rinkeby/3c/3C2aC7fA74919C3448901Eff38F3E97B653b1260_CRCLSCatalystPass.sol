...
contract CRCLSCatalystPass is ERC721A, ERC2981Royalties, Ownable, VRFConsumerBaseV2 {
    ...
    constructor(uint256 _price, uint256 royaltyPercentage, uint64 linkSubId, string memory baseTokenURI) ERC721A("CRCLS Catalyst Pass", "OG") VRFConsumerBaseV2(vrfCoordinator) {
        // EIP2987
