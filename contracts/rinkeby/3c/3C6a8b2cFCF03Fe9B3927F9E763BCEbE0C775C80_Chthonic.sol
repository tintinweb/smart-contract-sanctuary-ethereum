...
contract Chthonic is ERC721 {
    ...
    string _baseTokenUri; // `https://chtonic.xyz/meta/`.
    uint256 _maxTokenId; // `1000`.
    uint256 _nextTokenIdToMint;
    ...
    function createCollectible() public payable mintAllowed returns (uint256) {
