...
contract GovernorAlpha {
    ...
    string public constant name = "Governor Alpha Contract";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public pure returns (uint) { return 400000e18; } // 400,000 = 4% of ERC721 Token

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 200000e18; } // 200,000 = 2% of ERC721 holder
    ...
    /// @notice The address of the Governor Guardian /admin
