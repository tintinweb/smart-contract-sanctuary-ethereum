    ...
    Ownable
{
    ...
    bool public isWhitelistClosed = false;
    ...
    function setWhiteList(
        ...
        require(!isWhitelistClosed, "Cannot add whitelist anymore, already closed");
        ...
        for (
            ...
            whitelist.userlist.push(whitelistAddress[address_index]);
        }
    ...
    function _checkWhitelist(address user, uint256 quantity) private view {
    ...
    function _checkPricing(address tokenAddress, uint256 quantity) private view {
        require(price[address(tokenAddress)] > 0, "Price is not set for minting");
        require(
    ...
    function mintByToken(IERC20 token, uint256 quantity) public {
        ...
        bool success = token.transferFrom(msgSender(), address(this), quantity * _price);
    ...
    function closeWhitelisting(
        ...
        require(whitelist.userlist.length > 0, "Error cannot close, No Whitelist addresses added");
...
contract PuliRunners is PuliNFT {
    ...
    constructor(address proxyAddress)
        PuliNFT("Puli Runners", "PRNR", proxyAddress, 2010)
    {
