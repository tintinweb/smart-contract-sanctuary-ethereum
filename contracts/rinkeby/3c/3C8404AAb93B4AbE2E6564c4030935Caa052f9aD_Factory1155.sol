...
import "./BafDevUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new SokuNFTUser1155V2{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        SokuNFTUser1155V2 token = SokuNFTUser1155V2(address(addr));
