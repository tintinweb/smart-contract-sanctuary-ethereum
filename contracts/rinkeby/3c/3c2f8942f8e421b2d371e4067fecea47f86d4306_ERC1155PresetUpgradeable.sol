...
contract ERC1155PresetUpgradeable is Initializable, ContextUpgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155BurnableUpgradeable, ERC1155PausableUpgradeable {
    ...
    modifier onlyTrustedMinter() {
        require(_trustedMinterList[_msgSender()], "ERC1155Preset: caller is not trusted minter");
        _;
    }
    ...
    function initialize(
        ...
        __ERC1155Preset_init(name_, symbol_, uri_);
    }

    function __ERC1155Preset_init(
        string memory name_,
        string memory symbol_,
        string memory uri_
        ...
        __ERC1155Preset_init_unchained(name_, symbol_);
    }

    function __ERC1155Preset_init_unchained(
        string memory name_,
        string memory symbol_
    ) internal initializer {
        _name = name_;
    ...
    function updateBaseUri(string memory uri_) external virtual onlyOwner {
        _setURI(uri_);
        emit BaseUriUpdated(uri_);
    }

    function updateTokenUri(uint256 tokenId_, string memory tokenUri_) external virtual onlyOwner {
    ...
    function updateRoyaltyParams(address royaltyAddress_, uint256 royaltyPercent_) external virtual onlyOwner {
        require(royaltyPercent_ <= _100_PERCENT, "ERC1155Preset: invalid percent");
    ...
    function addToTrustedMinterList(address account_) external virtual onlyOwner {
        require(account_ != address(0), "ERC1155Preset: invalid address");
