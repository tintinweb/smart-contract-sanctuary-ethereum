...
contract Swarm is ERC2981, ERC721AQueryable, Ownable {
    ...
    event TheOne(address minter, uint32 amount);
    ...
    function mint(uint32 amount) external payable {
        ...
        require(_started, "Food is not ready");
        ...
        require(amount + publicMinted <= _publicSupply(), "Out of food");



        uint32 minted = uint32(_numberMinted(msg.sender));

        require(amount + minted <= _walletLimit, "You got enough gas");
        ...
        require(msg.value >= requiredValue, "We need more fuel");
