...
contract PandaPoolData is Ownable, ReentrancyGuard,IPandaPoolData {
    ...
    function _poolPushNft(uint256 _value) external override onlyAdmin {
        // poolNftMap.push(_value, poolSize);
        poolNftMap[poolSize] = _value;
        poolSize++;
    }

    function _getIdByIndex(uint256 _index) public override onlyAdmin returns(uint256) {
    ...
    function _poolRemoveNft(uint256 _index) external override onlyAdmin {
