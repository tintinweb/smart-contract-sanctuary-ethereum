// SPDX-License-Identifier: MIT
  ...
  contract MYNFTS is ERC721Enumerable, Ownable {
      /**
       * @dev _baseTokenURI for computing {tokenURI}. If set, the resulting URI for each
       * token will be the concatenati
       
      
       on of the `baseURI` and the `tokenId`.
       */
       ...
       */
      constructor (string memory baseURI, address whitelistContract) ERC721("My NFTs", "MNFT") {
      ...
      * @dev startPresale starts a presale for the whitelisted addresses
      ...
      function startPresale() public onlyOwner {
          ...
          presaleEnded = block.timestamp + 365 days;
      }
