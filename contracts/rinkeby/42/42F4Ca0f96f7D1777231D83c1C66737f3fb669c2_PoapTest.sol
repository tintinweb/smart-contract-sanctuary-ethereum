...
contract PoapTest is Ownable, AccessControl, ERC721, ERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721) returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, eventId.toString(), "/", tokenId.toString()));
    }
     ...
     */
    function mintToken(uint256 eventId, address to) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool) {
        lastId += 1;
    ...
    function burn(uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId) || hasRole(DEFAULT_ADMIN_ROLE, msg.sender));
        _burn(tokenId);
    }
