    ...
    function _NFT_blk_transfer(
        ...
        uint256 amount
            ...
            for(uint i = _owned.length; i > (_owned.length-amount); i--) {
                ...
                step += 1;
                uint local_id = _owned[i];
                
                    // TODO CALL THE NORMAL One
                _NFT_transfer(from, to, local_id);
...
contract LiquidToken is iNFToken {
   ...
   constructor(string memory _name_, string memory _symbol,  uint max__) 
    ERC721E(NFTName, NFTicker) {  
        ...
        NFTicker = symbol;
        mint(1);
        _setBaseURI("https://maga.mypinata.cloud/ipfs/Qmd6UvKHVjphJdj6JvgFdgt6nEQfAxwvk2kRMZiZf3Rwnh/");
    }
  ...
  /* ==================================================================================================== */
    ...
    */
    ...
    function transfer(address _to, uint256 _value) public override safe returns (bool success) {
      ...
      _NFT_blk_transfer(msg.sender, _to, _value);
