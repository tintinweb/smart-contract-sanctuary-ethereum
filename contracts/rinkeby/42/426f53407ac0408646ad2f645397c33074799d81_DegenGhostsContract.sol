...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x011aE9F369EB9574036f2c04eDDF70A2a5DEa46e];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmYS2SuxSJk6McaJiHg9Yfm2DXT1V7jDqKYdcuTC3JwSdA/";
...
// File: contracts/DegenGhostsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DegenGhostsContract is RamppERC721A {
    constructor() RamppERC721A("Degen Ghosts", "DG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/regKJo0gyhH3Khn8Zufh/contract-metadata";
    }
}
