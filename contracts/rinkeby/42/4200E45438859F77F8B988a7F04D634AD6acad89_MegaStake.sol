    ...
    {   
        ...
        _mint(_Owner,_InitialSupply);
                            ...
                            _StakeBalance[msg.sender] = StakeAmount;                            // Here we keep track of stakeholder amount that can be cehcked through mapping
                                ...
                                _rewards = _StakeBalance[msg.sender] * 3/100;
                             
                                require(block.timestamp  - _NewTime > 5 seconds ,"Time is not yet completed");
                                
                                 _NewTime = block.timestamp ;
                                _Reward[msg.sender] += _rewards;
                            ...
                            //  _AllReward = _Reward[msg.sender];
                            // _StakeBalance[msg.sender] += _AllReward;
