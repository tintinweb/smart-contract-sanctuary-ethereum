...
contract MadClownWL is ERC721A, Ownable {

    string public baseURI = "ipfs://QmeofeDMPsNc6S5RfdrokMFNabF828tmWW483Mma1CuWvj/";
    uint256 public constant MAX_SUPPLY = 333;
    uint256 public MINT_PRICE = 0.006 ether;
    uint256 public constant MAX_PER_TX_PAID = 2;
    bytes32 public root;

    constructor() ERC721A("MadClownWL", "MadClownWL") {
        root = 0x677dcba929c340bac7ea9c7dfb1ddb6fd822717f8e5eb9b57e729d6c087ee4a2;
    }
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    function safeMint(address to, bytes32[] memory proof, uint256 count) public {
