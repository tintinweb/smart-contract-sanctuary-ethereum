...
contract QEX2 is ERC721, RrpRequesterV0, Ownable {
    ...
    constructor(address _airnodeRrp) RrpRequesterV0(_airnodeRrp) ERC721("M1", "M1") {}
    ...
    function requestNewCharacter(uint256 size, uint256 numChars) external {
	...
	for (uint i = 0; i<numChars; i++) {
          ...
          bytes32 requestId = airnodeRrp.makeFullRequest(
            ...
            abi.encode(bytes32("1u"), bytes32("size"), size, numChars)
          );
          expectingRequestWithIdToBeFulfilled[requestId] = true;
    ...
    /// @param requestId Request ID
    /// @param data ABI-encoded response
    function fulfillUint256Array(bytes32 requestId, bytes calldata data, uint256 numPos)
        external
        onlyAirnodeRrp
    {
        require(
...
*/
        ...
        uint256 strength = (qrngUint256Array[numPos] % 100000000);
        uint256 intelligence = ((qrngUint256Array[numPos] % 100000000) / 10000000);
        uint256 mana = ((qrngUint256Array[numPos] % 100000000) / 1000000);
