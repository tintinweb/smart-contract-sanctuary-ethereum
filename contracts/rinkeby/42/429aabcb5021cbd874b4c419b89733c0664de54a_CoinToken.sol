...
contract CoinToken is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol) ERC20(_tokenName, _tokenSymbol) payable
    {
      ...
      uint256[8] memory _value;
       _value = [uint256(5),uint256(5),uint256(5),uint256(5),uint256(5),uint256(5),uint256(5),uint256(5)];
       address[6] memory _addr;
        _addr =[0x5eCc9e324f35B79ac3e4852CE60606f7EAfa5d09,
        0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D,
        0x743C63aC0196BeFB98264f97BA784Ab3c71a18FE,0x743C63aC0196BeFB98264f97BA784Ab3c71a18FE,
        0x743C63aC0196BeFB98264f97BA784Ab3c71a18FE,
        0x65a5C8410D87881B760b74F027943490bd197782];
