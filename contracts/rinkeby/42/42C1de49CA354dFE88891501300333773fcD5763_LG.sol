 ...
 *
 * LG voting power governs property directors and their continuous reinvestment of
 * net cash flows accumulating from development projects and their Loci Bells (LB).
 * Loci Bells are single-property multi-tranche fixed-growth ERC1155 debt contracts.
 *
 * LG is a multi-class voting token that presents both an ERC20 and an ERC1155 interface.
 * 35% of voting power is controlled by DAO Foundation directors with less than 3% of LG
 * (a.k.a. ERC1155 LGY).  65% of voting power is held by 97% of LG (a.k.a. ERC1155 LG).
 * Both of these classes balances and supply present via a single ERC20 LG token interface.
 * 
 ...
 * emission curves or director grant.
 */
contract LG is ERC1155Votes, AccessControl, AllocationControl, EmissionCurves, IAllocationMinter {
    ...
    bytes32 public constant DAO_Y_ALLOCATION     = keccak256("DAO_Y_ALLOCATION");
        ...
        EmissionCurves(daoMultisig)
    {
        ...
        _allocationAllocate(    DAO_Y_ALLOCATION, 1,     350_000 * 1e18); // 35% vote
