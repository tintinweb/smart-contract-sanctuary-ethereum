...
contract EthKun is ERC721A, Ownable {
    ...
    uint256 public steakingCurveDivisor = 4;
    ...
    function _canSpawnEthKunBaby(uint256 tokenId) private view returns (bool) {
        ...
        return 
            totalSteakingTime >= _getSecsSteakingRequiredToMintBaby()  // check staking time
    ...
    function setSteakingParams(uint256 _steakingMinDays, uint256 _steakingCurveDivisor) external onlyOwner {
    ...
    function _getSecsSteakingRequiredToMintBaby() private view returns (uint256) {
        ...
        // number of sec required to mint will be 2 + (0.25 days for each minted baby)
        uint256 daysFromBabiesMinted = numBabiesMinted/steakingCurveDivisor;
        uint256 daysMinSteaked = steakingMinDays + daysFromBabiesMinted;
        
        // convert days to seconds
        return daysMinSteaked * SECS_PER_DAY;
    }
