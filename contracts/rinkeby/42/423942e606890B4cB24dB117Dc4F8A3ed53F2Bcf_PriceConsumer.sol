    ...
    SuperAdminControl
{
    ...
    function addUsdPriceAggrigatorBulk(
        ...
        for (uint256 i = 0; i < _tokenAddress.length; i++) {
            ...
            allFeedContractsChainlink.push(_chainlinkFeedAddress[i]);
    ...
    // TODO: will uncommnet before mainnet
    // function getDexTokenPrice(
    //     address _stable,
    //     address _alt,
    //     uint256 _amount
    ...
    function getSUNTokenPrice(
        ...
        for (uint256 i = 0; i < lengthPegTokens; i++) {
            if (claimTokenData.pegTokens[i] == _sunToken) {
                sunTokenAddress = claimTokenData.pegTokens[i];
