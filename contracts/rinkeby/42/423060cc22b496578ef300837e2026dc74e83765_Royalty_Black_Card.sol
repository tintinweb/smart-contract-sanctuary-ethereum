...
contract Royalty_Black_Card  is ERC721Enumerable, Ownable
{
   ...
   uint private constant mint_quantity= 500;
    uint public mint_price= 0.0000005 ether;
    uint public wl_mint_price =0.0001 ether;
    uint public Early_Members_price =0.0001 ether;
    ...
    _uriBeforeRevel = "https://cannabiscryptoseedheadz.mypinata.cloud/ipfs/Qmf3McqCc7A32UDPzQwQh8P3x6Acdc4STKriM4zHRif4vu/";
    }
...
//     }
    ...
    // function flipwlmintStatus() public onlyOwner {
    //     iswlmintPaused = !iswlmintPaused;
    // }
    ...
    // function whitelist_mint(uint chosenAmount) public payable isSaleOpen{

    //             require(isWhiteListed(_msgSender()), "Not whitelisted");
    //             require(iswlmintPaused == false,"Pre sale not active");            
    ...
    // function singlepayout(uint256 amount, uint256 id) public onlyOwner{
    //     amount= amount*1000000000000000000;
    //     address ownerofid= ownerOf(id);
    //     payable(ownerofid).transfer(amount);
    // }

    // function allpayout(uint256 Newam) public onlyOwner{
    //     Newam= Newam*1000000000000000000;
    //     uint256 numberofowners= totalSupply();
