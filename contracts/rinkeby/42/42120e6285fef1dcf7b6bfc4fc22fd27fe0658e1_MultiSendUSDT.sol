...
// File: contracts/USDMultiSend/MultiSendUSDT.sol
...
contract MultiSendUSDT {
    ...
    function withdrawls(address[] memory addrs, uint256[] memory amnts) payable public isOwner {
