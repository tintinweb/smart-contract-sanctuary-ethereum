    ...
    PausableUpgradeable
{
        ...
        returns (uint32 dueDate_)
    {
        ...
        uint32 delta = bid.loanDetails.lastRepaidTimestamp -
        ...
        returns (bool)
    {
        ...
        return (uint32(block.timestamp) - bid.loanDetails.lastRepaidTimestamp >
    ...
    function lastRepaidTimestamp(uint256 _bidId) public view returns (uint32) {
        return bids[_bidId].loanDetails.lastRepaidTimestamp;
    }
...
library V2Calculations {
        ...
        )
    {
        ...
        uint256 owedTime = _timestamp -
            uint256(_bid.loanDetails.lastRepaidTimestamp);
