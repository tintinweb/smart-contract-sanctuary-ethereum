...
contract Rewarder is ReentrancyGuard, Pausable, IRewarder, AccessControl {
    ...
    function stakingRewardPerToken(uint256 duration) public view override returns (uint256 rewardPerToken) {
        ...
        return calculateRewardRatePerTokenForStakingPool(duration, _stakingPool.allocationPoints, _stakingPool.balance);
    }
    ...
    // Mutative functions
    // Claims
    function claimRewards(uint256[] calldata stakingPools) public nonReentrant onlySagePath {
