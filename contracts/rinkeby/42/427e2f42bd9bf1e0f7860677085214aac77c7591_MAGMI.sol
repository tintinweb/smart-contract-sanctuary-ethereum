...
contract MAGMI is ERC721Enumerable, Ownable {
    ...
    address t2 = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;
    address t3 = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db;
    address t4 = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;

    // Cool Cats are so cool they dont need a lots of complicated code :)
    // 9999 cats in total, cos cats have 9 lives
    constructor(string memory baseURI) ERC721("MAGMI", "MAGMI")  {
        setBaseURI(baseURI);
