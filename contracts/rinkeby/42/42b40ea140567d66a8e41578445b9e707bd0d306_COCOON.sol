...
contract COCOON is ERC721A, Ownable, ReentrancyGuard {
	...
	uint256 public maxSupply = 4750;
	uint256 public preMintSupply = 1554;
    ...
    function PreMint(uint256 mintAmount) external payable {
        ...
        require(_totalMinted() + mintAmount <= preMintSupply,"Exceeds Pre mint max supply");
        require(mintAmount <= MAX_PER_TX,"Exceeds max per transaction");
