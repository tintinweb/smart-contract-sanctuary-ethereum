...
contract DD is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public limitAmountPerWallet = 2;
  ...
  function freemint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= limitAmountPerWallet, "u wanna mint too many");
        require(mintedWallets[_msgSender()] <= 2, "exceed max free mint");
        require(!userMintedFree[_msgSender()], "User max free limit");
