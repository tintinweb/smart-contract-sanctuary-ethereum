...
contract TestElips is ERC721, Ownable, ERC721Enumerable {
    ...
    event ElipsMinted(uint256 supply);

    constructor() ERC721("Test Elips", "TEP") {}
    ...
    function mintElips(uint256 numberOfTokens) external payable {
    ...
    function presaleElips(uint256 numberOfTokens) external payable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns(string memory) {
        ...
        if( isRevealed == false ) {
            return "ipfs://QmPZGhLWCg5Ku4L1gHdJLUAs4sn6Ms9euthf9qZc4xLkUL/hidden.json";
        }
