...
///////////// Tout les mints | Mint Free -> Mint OG & Mint WL "normal" -> Public Sale
  ...
  function OGmint(uint8 mintAmount, address _account, bytes32[] calldata _proof) public payable UserOnly {
  ...
  function mintWl(uint8 mintAmount) public payable UserOnly {
    require(sellingStep == Steps.WLMints, "WLMints has not started yet.");
    require(totalSupply().add(mintAmount) <= MaxToken, "WLMints Sold Out");
    require(mintAmount <= 10, "You can not mint more than 10 NFT at the same time");
    require(mintAmount > 0, "At least one should be minted");
