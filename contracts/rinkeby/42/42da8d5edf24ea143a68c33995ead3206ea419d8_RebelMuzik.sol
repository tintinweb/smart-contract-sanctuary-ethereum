...
// === To Check Private and VIP total Supplies ===
  ...
  // == WALLETS == //
  address private constant ADDR1 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;
  address private constant ADDR2 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;
  address private constant ADDR3 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;
  address private constant ADDR4 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;
  address private constant ADDR5 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;
  ...
  constructor(string memory initBaseUri, uint256 reserveAmount, uint256 teamReserveAmount) ERC721A("RebelMuzik", "ONETIMELOVE") {
    ...
    ownerMint(ADDR5, teamReserveAmount);
  }
  ...
  */
  ...
  // == SET SUPPLIES == //
    ...
    function withdraw() public onlyOwner {
        ...
        payable(ADDR5).transfer(balance * 8 / 100);
  }
}