    ...
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmfTHZ1gcNB6VM91HNxjWnqpGJDuoWRC6Cxoz5doEr6Qn8/hidden.json";
    ...
    address[] private _team = [
        0x56f787D7624946dFD3F5db87099c3b184B14B1c3,
        0x4B898edF9d4C54f66b79190C74762333A2Bf2D52
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("SpaceZoo", "SPACE")
    ...
    onlyAccounts
    {
        ...
        require(!paused, "Space bunny rabbit: Contract is paused");
        require(_amount > 0, "Space bunny rabbit: zero amount");

        uint current = _tokenIds.current();

        require(
            current + _amount <= maxSupply,
            "Space bunny rabbit: Max supply exceeded"
        );
        require(
            _price * _amount <= msg.value,
            "Space bunny rabbit: Not enough ethers sent"
        );
