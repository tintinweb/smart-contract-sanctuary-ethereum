...
contract Xeno is Ownable, ERC721AQueryable {
  ...
  address _itemAddr;
  XenoItemInterface XenoItemContract = XenoItemInterface(_itemAddr);

  constructor() ERC721A("Xeno", "XENO") {
  }
