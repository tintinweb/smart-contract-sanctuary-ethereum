...
contract LoopopPrivatePass is LoopopTokenBase {

    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() LoopopTokenBase("Loopop Private Channel Pass", "LPCP") {
    }
    ...
    function safeLease(address to, string memory uri, uint64 expires) public onlyRole(MINTER_ROLE) {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
