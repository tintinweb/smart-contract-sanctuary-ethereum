...
contract PayForSuccess {
  ...
  event AssetReceived(address from, uint256 amount, address tokenAddress, EventFlags flag);
  //NFT issued
  event NFTIssued(address to, uint256 amount, address tokenAddress, string uri, EventFlags flag);
