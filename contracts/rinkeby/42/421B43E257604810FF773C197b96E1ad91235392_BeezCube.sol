...
import "./INFBeez.sol";
  ...
  contract BeezCube is ERC1155Supply, ERC2981, Ownable, ReentrancyGuard, QRNG {
      ...
      uint256 public maxAmounts = 220; //max amounts for each NFT token
      uint256 public maxDAOCube = 100; // Maximum amount of DAO Cubes
      ...
      /******** TODOs ********
      create a cap for DAO cube
      work in randomization
      add in royalties - test on epor
      change address to NFT
      change royalty setup
       */
    ...
    function setNewNFTMax(uint256 _newMax) external onlyOwner {
