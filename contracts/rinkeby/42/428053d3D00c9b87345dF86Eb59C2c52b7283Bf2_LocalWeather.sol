...
contract LocalWeather is ERC721A, Ownable {
    ...
    uint16 public constant totalNFTs = 8444;
    uint16 public constant totalBasicNFTs = 8000;
    uint16 public constant totalReservedNFTs = 444;

    //TODO: final value 0.1 ether
    ...
    function mint(
        ...
        require(nftsAmount + amount <= totalBasicNFTs, "Mint limit reached");
    ...
    function reserveNFT(address to, uint16 amount) public onlyOwner {
        require(reservedNFTsAmount + amount <= totalReservedNFTs, "Out of stock");
