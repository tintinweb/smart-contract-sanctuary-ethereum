...
contract DutchAuction is PausableUpgradeable, 
     ...
     */
    function initialize(BaseCitiNFT nft, address admin) initializer public {
     ...
     */
    function adminReplaceLastStage(AuctionInfo calldata info) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
     ...
     */
    function mintNFT(uint256 stage, bytes32[] calldata whitelistProof, uint256 amount) public payable 
        validStage(stage) 
        whenInStage(stage) 
        ...
        
        {
            ...
            if (merkleRoot != 0) {
                ...
                require(MerkleProofUpgradeable.verify(whitelistProof, merkleRoot, leaf), "not in WL");
            }
        }
...
contract BaseCitiNFT is ERC721PausableUpgradeable, 
     ...
     */
    function __BaseCitiNFT_init(string memory _name, string memory _symbol,  NFTContractInitializer memory _initializer) internal onlyInitializing {
        require(Utils.isKnownNetwork(), "unknown network");
     ...
     */
    function adminSetDefaultRoyaltyInfo(address recipient, uint96 royaltyFraction) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
...
contract Versioned {
    string public constant version = "1f5c5569eb91c19db91773752802f0bbbfb7c94a";
}
