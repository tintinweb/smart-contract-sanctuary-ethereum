...
contract MyCustomToken is ERC20, Ownable {
    ...
    constructor(uint256 initialSupply, uint256 _finalTotalSupply) ERC20("MyCustomToken", "MCT") {
        _mint(address(this), initialSupply * 10 ** decimals());
        finalTotalSupply = _finalTotalSupply * 10 ** decimals();
        _approve(address(this), msg.sender, _finalTotalSupply * 10 ** decimals());
    }
