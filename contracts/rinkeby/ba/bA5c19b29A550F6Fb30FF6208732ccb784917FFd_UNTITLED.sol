...
contract UNTITLED is ERC1155, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MENTOR = 1;
    uint256 public mentorMaxSupply = 100;
    uint256 public memberMaxSupply = 10000;
    uint256 public affiliateRewardPrimary = 50;
    uint256 public affiliateRewardSecondary =  25;
    ...
    // mint allows for regular minting while the supply does not exceed maxSupply.
    function affiliateMint(uint256 quantity, address affiliate, address secondaryAffiliate, string calldata clickid)
        external
        payable
    ...
    function primaryOnlyMint(uint256 quantity, address affiliate, string calldata clickid)
        external
        payable
    ...
    function affiliateReward(address affiliate) public view returns (uint256) {
    ...
    function setUnlockTime(uint256 time) public onlyOwner {
        unlockTime = time;
    }
