...
contract RL2022 is ERC721A, Ownable {
        ...
        validTxn(nMints)
    {
        ...
        if (msg.value != ALLOWLIST_MINT_PRICE * nMints)
            revert InsufficientAmountSent();
        if (_numberMinted(msg.sender) + nMints > MAX_ALLOWLIST_MINTS)
