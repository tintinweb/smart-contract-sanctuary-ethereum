    ...
    ISeaportAdapter
{
    ...
    /// @dev buy nft in seaport market place.
    function seaportBuy(
        ...
        (bool success, ) = seaport.call{value: value}(
            _calldata
        );
        ...
        _tranferToken(tokenType, tokenAddress, recipient, tokenId, amount);
    }

    /// @dev In case we can withdraw unexpectedly stucked tokens.
