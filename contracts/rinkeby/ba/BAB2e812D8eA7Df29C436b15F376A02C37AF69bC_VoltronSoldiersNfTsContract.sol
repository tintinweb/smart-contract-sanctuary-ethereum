...
//*********************************************************************//
//
//  _    __      ____                      _____       __    ___                   _   ______________    
// | |  / /___  / / /__________  ____     / ___/____  / /___/ (_)__  __________   / | / / ____/_  __/____
// | | / / __ \/ / __/ ___/ __ \/ __ \    \__ \/ __ \/ / __  / / _ \/ ___/ ___/  /  |/ / /_    / / / ___/
// | |/ / /_/ / / /_/ /  / /_/ / / / /   ___/ / /_/ / / /_/ / /  __/ /  (__  )  / /|  / __/   / / (__  ) 
// |___/\____/_/\__/_/   \____/_/ /_/   /____/\____/_/\__,_/_/\___/_/  /____/  /_/ |_/_/     /_/ /____/  
//                                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4e20267be44c1ef673c542110022070BA18692aE];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 6, 120 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmR84yBsHpE2ryzQGuqWiD1B3XrBTb6ph2V3eiuhW4d5jC/";
...
// File: contracts/VoltronSoldiersNfTsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VoltronSoldiersNfTsContract is RamppERC721A {
    constructor() RamppERC721A("Voltron Soldiers NFTs", "VSN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/CnOjnHb6vWX7zA8TxOlz/contract-metadata";
    }
}
