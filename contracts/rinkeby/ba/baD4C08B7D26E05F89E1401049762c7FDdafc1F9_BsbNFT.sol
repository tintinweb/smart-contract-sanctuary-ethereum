...
/**
    TODO:
        - Delete comments
        - Update presale and public price
*/
...
contract BsbNFT is ERC721A, Ownable, ReentrancyGuard { 
    ...
    // uint256 public maxAvailableSupply;       // collectionSize - reserveSupply
    // uint256 public reserveSupply;            // 300
    uint256 public maxPerTxn;                   // None
    uint256 public presalePrice = 0.165 ether;  // $250
    uint256 public salePrice = 0.198 ether;     // $300
    ...
    */
    ...
    function withdrawl() external onlyOwner {
        ...
        payable(mlWallet).transfer(totalBalance * 25 / 1000);
        uint remainingBalance = totalBalance * 915 / 1000;
        
        payable(msg.sender).transfer(remainingBalance);
        /*
        if (!feePaid) {
            if (remainingBalance >= owed) {
                payable(devWallet).transfer(owed);
