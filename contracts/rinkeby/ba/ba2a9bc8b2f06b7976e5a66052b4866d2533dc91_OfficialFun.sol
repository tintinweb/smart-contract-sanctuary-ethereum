...
/**
 * @dev Interface for the NFK Royalty Standard.
 *
 * A standardized way to retrieve royalty payment information for non-fungible knights (NFKs) to enable universal
 * support for royalty payments across all NFK marketplaces and ecosystem participants.
 *
...
contract OfficialFun is BEP721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI; 
    uint256 public publicPrice = 1000000000000000; 
    uint256 public whitelistPrice = 500000000000000;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(balanceOf(msg.sender) + _mintAmount <= maxKnightsInWallet, "Each address may only own five kngihts");       
