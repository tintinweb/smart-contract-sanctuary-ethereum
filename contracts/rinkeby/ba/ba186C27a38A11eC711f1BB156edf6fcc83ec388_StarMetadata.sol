...
contract StarMetadata is IStarMetadata, AdminControl {
    ...
    mapping(uint8 => StarLvminance) private _lvminanceRangeLookup;
    // Star type to star image URL
    mapping(uint8 => string) private _imageURLLookup;
    ...
    constructor(address creator) {
        ...
        _lvminanceRangeLookup[uint8(1)] = StarLvminance(5, 15);
        _imageURLLookup[uint8(1)] = 'https://arweave.net/O_sPATDPYba2igM9n3D-_1RiyWlWi3kLrbkQG4IaXbc';

        _defaultStarNameLookup[uint8(2)] = "Helium%20Star";
        _lvminanceRangeLookup[uint8(2)] = StarLvminance(5, 15);
        _imageURLLookup[uint8(2)] = 'https://arweave.net/DZz8l1fWQqYRmD2Oaba9H0R_1TxG4FqNj9ckyXN9l8E';

        _defaultStarNameLookup[uint8(3)] = "Bronzed%20Star";
        _lvminanceRangeLookup[uint8(3)] = StarLvminance(20, 40);
        _imageURLLookup[uint8(3)] = 'https://arweave.net/_pl8SDCRE48XXDDFbUmuGhXPy96rtDm0TE__uCO5sWo';

        _defaultStarNameLookup[uint8(4)] = "Silversmithed%20Star";
        _lvminanceRangeLookup[uint8(4)] = StarLvminance(20, 40);
        _imageURLLookup[uint8(4)] = 'https://arweave.net/n0FnfWaTiEKV5ZJoOXXgrD3BP9uJE8t6idwd6a6GdCA';

        _defaultStarNameLookup[uint8(5)] = "Black%20Titanium%20Star";
        _lvminanceRangeLookup[uint8(5)] = StarLvminance(20, 40);
        _imageURLLookup[uint8(5)] = 'https://arweave.net/mg-lcjcS5UAMZbGDAmz7Rtb0mCeJacvJYy6jtgUAEuk';

        _defaultStarNameLookup[uint8(6)] = "The%20Darkest%20Star";
        _lvminanceRangeLookup[uint8(6)] = StarLvminance(50, 150);
        _imageURLLookup[uint8(6)] = 'https://arweave.net/ZHqYjv3AMxyr260hBMxiQnFh9qB9ZUmXBoI57u2gOMc';

        _defaultStarNameLookup[uint8(7)] = "Fragile%20Star";
        _lvminanceRangeLookup[uint8(7)] = StarLvminance(50, 150);
        _imageURLLookup[uint8(7)] = 'https://arweave.net/s_SqCL_YIm3oXD0b7f7kJPPCpyhC410hlx2XnPfZp-I';

        _defaultStarNameLookup[uint8(8)] = "The%20Watcher";
        _lvminanceRangeLookup[uint8(8)] = StarLvminance(200, 400);
        _imageURLLookup[uint8(8)] = 'https://arweave.net/b7DD1rCSSox6B6MARhXTcJ5JijIwlJkjVWE2WZBSW9o';

        _defaultStarNameLookup[uint8(9)] = "The%20Hidden";
        _lvminanceRangeLookup[uint8(9)] = StarLvminance(200, 400);
        _imageURLLookup[uint8(9)] = 'https://arweave.net/S7dJmBAY7PZHF3gspDVI5QfnyD8U58MZmaTlBofcdMk';

        _defaultStarNameLookup[uint8(10)] = "Shiny%20Star";
        _lvminanceRangeLookup[uint8(10)] = StarLvminance(500, 1000);
        _imageURLLookup[uint8(10)] = 'https://arweave.net/6QHAUwMHwyTnXKrm-jhIJEzUCRJ-ewSSv0n7TyVmu9U';

        _defaultStarNameLookup[uint8(11)] = "Miners%20Star";
        _lvminanceRangeLookup[uint8(11)] = StarLvminance(1500, 2500);
        _imageURLLookup[uint8(11)] = 'https://arweave.net/T2ExZqLQyDi5yXtqJlgfyfKzENVLvQfmJMM5DrrLibE';

        _defaultStarNameLookup[uint8(12)] = "The%20One";
        _lvminanceRangeLookup[uint8(12)] = StarLvminance(5000, 5000);
        _imageURLLookup[uint8(12)] = 'https://arweave.net/frOcoUkOl2-rkZjFbpKUn8JXr-hsdbs45QUSihvktMU';
    }
    ...
    function setName(uint256 tokenId, string memory name) public {
        require(IERC721(_creator).ownerOf(tokenId) == msg.sender, "Only owner can change.");
     ...
     */
    function updateStar(uint8 starType, string memory name, string memory url, uint16 min, uint16 max) public adminRequired {
        _defaultStarNameLookup[starType] = name;
        _imageURLLookup[starType] = url;
        _lvminanceRangeLookup[starType] = StarLvminance(min, max);
    }

    function metadata(uint256 tokenId, IStar.StarInfo memory starInfo) public view virtual override returns (string memory) {
        // Use custom Star name if appliciable
        bool named = bytes(_overriddenStarNameLookup[tokenId]).length != 0;
        string memory starName = named
        ...
        uint256 lvminance = (
            ...
            % (_lvminanceRangeLookup[starInfo.starType].max - _lvminanceRangeLookup[starInfo.starType].min)
            + _lvminanceRangeLookup[starInfo.starType].min
        );
        ...
        return string(abi.encodePacked('data:application/json;utf8,',
            ...
            '","image_url":"', _imageURLLookup[starInfo.starType],
            '","attributes":[',
              '{"trait_type":"Type","value":"',  _defaultStarNameLookup[starInfo.starType], '"},',
              ...
              '{"trait_type":"Named","value":"', named ? 'Yes' : 'No', '"}',
            ']}'
        ));
    }
}
