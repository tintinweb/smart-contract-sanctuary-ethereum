...
contract GEANZ is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://geanz.mypinata.cloud/ipfs/QmUUefTjEyvuUE8VtAvTWaeEgk9QMyxso4F9wW3PGFbC1u/unrevealed.json";
    bool public reveal = false;

    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 80000000000000000;
    ...
    uint256 public constant MAX_NFT_SUPPLY = 11000;

    constructor() ERC721("GEANZ", "GAZ") {
    }
