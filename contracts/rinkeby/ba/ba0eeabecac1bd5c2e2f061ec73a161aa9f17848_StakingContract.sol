...
contract Task5Token is ERC20, Ownable {
    ...
    function buyToken(address receiver, uint256 amount) public payable {
        require (balanceOf(owner()) >= amount, "You do not have enought money to complete this transaction");
        amount = msg.value;
    ...
    function modifyBuyToken() public onlyOwner {

    }
}
// File: contracts/StakeingContract.sol
