...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 theAmount) public {
    require (yourToken.allowance(msg.sender, address(this)) >= theAmount, "Insufficient token allowance");
    require (address(this).balance >= theAmount / tokensPerEth, "Insufficient Eth funds");
