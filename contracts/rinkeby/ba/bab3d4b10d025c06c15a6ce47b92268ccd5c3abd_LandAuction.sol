...
contract LandAuction is ILandAuction, AccessControl, ReentrancyGuard {
    ...
    */
    ...
    function bidShiboshiZone(
        ...
        require(_hashMessage(msg.sender) == messageHash, "ERR_MESSAGE_INVALID");
        require(
            _verifyAddressSigner(messageHash, signature),
    ...
    function _verifyAddressSigner(bytes32 messageHash, bytes memory signature)
        private
        view
        returns (bool)
    {
