...
contract SpaceCoinICO {
    ...
    //totalClaimableContrib-- keep track per address with a map (only need to add to in phase 1/2)
    ...
    constructor(address _treasury) { 
        ...
        //using "ether" to represent 10^18, but this actually represents amount SPC, not ether
    ...
    //
    // phase/state control functions (onlyOwner)
    //
    ...
    //
    // whitelist control functions (onlyOwner)
    // based on https://github.com/ConsenSysMesh/openzeppelin-solidity/blob/master/contracts/crowdsale/validation/WhitelistedCrowdsale.sol
    //
    ...
    function invest() external payable {
        ...
        if (currentPhase == 3) {
            //nothing else to check, no need to keep track individually
    ...
    function claimToken() external {
        ...
        spaceCoin.transfer(msg.sender, amountSPCtoSend);
...
contract SpaceCoin is ERC20 {
    ...
    //override transfer and transferfrom functions that do something when transferTaxOn == true
