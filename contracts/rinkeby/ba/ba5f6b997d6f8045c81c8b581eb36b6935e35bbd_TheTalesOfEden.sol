...
contract TheTalesOfEden is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmadMjuzE3SnV5KVRqEDSesftsjdoEsMoJaqPzCVeGvhs1/hidden.json";
    ...
    address constant internal DEV_ADDRESS = 0x827C80270C7e5dedb0Be25d62a1F693CBAdB08E9;
    

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor(string memory _name, string memory _symbol, string memory _baseURI, string memory _hiddenMetadataUri) ERC721A("TheTalesOfEden", "TE") { }
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x827C80270C7e5dedb0Be25d62a1F693CBAdB08E9");
