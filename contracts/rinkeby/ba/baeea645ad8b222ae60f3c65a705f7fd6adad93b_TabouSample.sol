...
contract TabouSample is ERC721A,Ownable {
  ...
  constructor(string memory MetaUri , string memory CollectionName ,  string memory Symbol , uint256 max_Supply) ERC721A(CollectionName,Symbol) {
    ...
    function mint() public payable {
        ...
        require(totalSupply().add(1) < Max_Supply, "Insufficient supply");
