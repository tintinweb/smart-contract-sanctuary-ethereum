...
contract XSendMock {
    ...
    function xTransferFunds(address to, address asset, uint32 originDomain, uint32 destinationDomain, uint256 amount) external payable { // should later on be changed to onlyDao/ onlyKeeper
