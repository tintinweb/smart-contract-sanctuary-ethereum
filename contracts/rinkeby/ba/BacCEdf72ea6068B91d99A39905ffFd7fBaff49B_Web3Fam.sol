...
contract Web3Fam is ERC1155, Ownable {

    uint256 public constant Starter = 1;
    ...
    function mintStarter(uint256 _amount) public {
     //   require(_amount > 0, "Amount must be greater than zer0");
        _mint(msg.sender, Starter, _amount, "");
        supplyBalance[msg.sender][Starter] += _amount;
    }
