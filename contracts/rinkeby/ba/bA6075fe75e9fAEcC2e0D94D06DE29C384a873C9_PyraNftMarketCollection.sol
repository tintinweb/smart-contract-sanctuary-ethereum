...
// File: contracts/PyraNftMarketCollection.sol
...
interface PyraNftMarket {
    function getServiceFee() external view returns (uint256);

    function getServiceFeeWA() external view returns (uint256);

    function getOwner() external view returns (address);
}

contract PyraNftMarketCollection is ERC721, Ownable {
    event Approve(
    ...
    PyraNftMarket public PyraNftMarket721;
    ...
    constructor(
        ...
        PyraNftMarket _PyraNftMarket721 = PyraNftMarket(originalContract);
        PyraNftMarket721 = _PyraNftMarket721;
        tokentype[type1] = address1;
    }

    function getServiceFeeWA() public view returns (uint256) {
        return PyraNftMarket721.getServiceFeeWA();
    }

    function getServiceFee() public view returns (uint256) {
        return PyraNftMarket721.getServiceFee();
    }
    ...
    function _saleToken(
        ...
        uint256 serviceVal = PyraNftMarket721.getServiceFee();
    ...
    function _acceptBId(
        ...
        uint256 serviceVal = PyraNftMarket721.getServiceFee();
        if (keccak256(bytes(tokenAss)) == keccak256(bytes("ETH"))) {
            serviceVal = PyraNftMarket721.getServiceFeeWA();
        }
        address payable admin = payable(PyraNftMarket721.getOwner());
