...
contract SpaceMan is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory _SpaceMan, string memory SM) ERC721("Space Man", "SM") {}

    function _baseURI() internal pure override returns (string memory) {
        return "http://api.spaceman.com/tokens/";
    }
