...
contract DinoKidsClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Dino Kids Club", "DKC") {
    setHiddenMetadataUri("ipfs://QmYHb85dctqEA3xBbV9rcqu78AnSXmZcvbRFFbHBzVk98V/NotRevealed.json");
  }
