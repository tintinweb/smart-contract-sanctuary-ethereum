...
contract LOK666 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint public freeMintPerWallet = 1;
    ...
    function mint(uint256 amount) external payable
    {
        ...
        require(amount <= maxPerTx, "Exceed max per txn");
        require(msg.value == amount * cost,"Incorrect price");
        require(totalSupply() + amount <= maxSupply,"Sold out");
        require(numberMinted(msg.sender) + amount <= maxPerWallet,"Exceeds max per wallet");
    ...
    {
        require(totalSupply() + amount <= maxSupply,"Exceed batch mint over max supply");
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        require(success, "Error on fund transfer");
    }
}
