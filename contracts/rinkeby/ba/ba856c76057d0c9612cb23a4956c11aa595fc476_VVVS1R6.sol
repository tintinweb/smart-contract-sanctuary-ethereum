...
contract VVVS1R6 is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("vVv Season 1 Reward 6 months", "VVVS1R6") {
    }
    ...
    function freeMint(uint256 _cnt) external onlyOwner {
        ...
        for(uint256 i = 0; i < _cnt; i++) {
            ...
            _safeMint(stakingContractAddress, _tokenIdentifiers.current());
            tokenMinted += 1;
        }
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(to == stakingContractAddress || from == stakingContractAddress, "This token can't transfer to other address");
        require(msg.sender == stakingContractAddress || msg.sender == owner(), "Only transferable by staking or unstaking VVVS1");
        super._beforeTokenTransfer(from, to, tokenId);
    }
}