...
contract AgiraNFTSwap is ERC1155 {

    uint256 newItemId = 1;
    address public owner;

    struct Sign {
        uint8 v;  //max value 255
        bytes32 r; // i.e 0x7465737400000000000000000000000000000000000000000000000000000000
        bytes32 s; // // i.e 0x7465737400000000000000000000000000000000000000000000000000000000
    }
    ...
    function ownershipTransfer(address newOwner) public onlyOwner returns(bool){
