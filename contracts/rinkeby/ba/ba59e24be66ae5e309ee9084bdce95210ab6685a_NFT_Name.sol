...
contract NFT_Name is ERC1155{
    ...
    constructor() public ERC1155("https://nef1jipkomqy.usemoralis.com//{id}.json"){
    ...
    ///////////////phase1//////////////////////////////////////////
    mapping (address=>bool)phase1Contributer;

    function setPresale(uint256 _start, uint256 _end)public onlyOwner{
        Presales=Presale(_start, _end);
    }
    function phase1MintSingle(address _to, uint256 _ids, uint256  _amount)public {
        ...
        phase1Contributer[_to]=true;
    }
    function phase1MintBatch(address _to,uint256 [] memory _ids, uint256[] memory  _amounts)public {
        require(block.timestamp>=Presales.Start,"Presale is not start yet");
        require(block.timestamp<=Presales.End,"Presale is finished");
    ...
    /////////////phase2/////////////////////////////////////////////////
    function phase2MintSingle(address _to, uint256 _ids, uint256  _amount)public {
        require(phase1Contributer[_to],"You do not have permision");
            _mint(_to, _ids, _amount, "");  
        
    }
    function phase2MintBatch(address _to,uint256 [] memory _ids, uint256[] memory  _amounts)public {
        require(phase1Contributer[_to],"You do not have permision");
            _mintBatch(_to, _ids, _amounts, " ");
    ...
    ///////////////////////phase3////////////////////////////////////////////
    function phase3MintSingle(address _to, uint256 _ids, uint256  _amount)public {
        require(block.timestamp>=Presales.Start,"Presale is not start yet");
        require(block.timestamp<=Presales.End,"Presale is finished");
    ...
    function phase3MintBatch(address _to,uint256 [] memory _ids, uint256[] memory  _amounts)public {
        require(block.timestamp>=Presales.Start,"Presale is not start yet");
        require(block.timestamp<=Presales.End,"Presale is finished");
