...
import './jupiter/JupiterAllowList.sol';

contract StellaLuna is JupiterNFT, IStellaLuna, JupiterCappedMint, JupiterAllowList{
	...
	) JupiterNFT(proxyRegistryAddress, name, symbol, baseTokenURI, operators) JupiterCappedMint(cap) {
...
abstract contract JupiterAllowList is JupiterNFT {
