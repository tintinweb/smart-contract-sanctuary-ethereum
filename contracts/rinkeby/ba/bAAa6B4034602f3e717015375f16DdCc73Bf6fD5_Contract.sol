...
contract Contract is ERC721("Contract", "Contract"), ERC721Enumerable, Ownable {
    ...
    */
    ...
    uint256 private constant PHASE_1_LIMIT = 22;
    uint256 private constant PHASE_2_3_LIMIT = 33;
    uint256 private constant MAX_FREE_LIMIT = 100;
    uint256 public NFT1Price = 10000000000000000;  // 0.01 ETH
    uint256 public NFT2Price = 20000000000000000;  // 0.02 ETH
    uint256 public NFT3Price = 30000000000000000;  // 0.03 ETH
    ...
    mapping(uint256 => uint256) private phaseClaimed;
