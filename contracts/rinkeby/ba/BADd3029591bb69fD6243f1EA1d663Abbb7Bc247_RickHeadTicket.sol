...
contract RickHeadTicket is ERC721A, Pausable, Ownable {
    ...
    whenNotPaused
     {
        for (uint i = 0; i < idsRickHead.length; i++) {
            ...
            require(!getNftClaimed(idsRickHead[i]), "error: 002");
    ...
    /**
      * @dev getNftClaimed returns count mints by address
     *
     */
    function getNftClaimed(uint256 _id) public view returns(bool) {
        return NftClaimed[_id];
    }
