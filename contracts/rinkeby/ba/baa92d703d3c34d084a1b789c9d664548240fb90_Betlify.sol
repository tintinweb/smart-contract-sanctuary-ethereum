...
contract Betlify is VRFConsumerBaseV2, ReentrancyGuard {
  ...
  mapping (address => uint256) public lastWinningClaimedTime;
  ...
  mapping (address => uint256) public totalWinningsClaimed;
  ...
  */
  ...
  function autoStake(address _playerAddress, uint256 _amount) internal {
    if(userStakes[_playerAddress] == 0){
        lastRewardClaimedTime[_playerAddress] = block.timestamp;
    }

    userStakes[_playerAddress] += _amount;
    totalStakeLockedValue += _amount;
    lastStakeTime[_playerAddress] = block.timestamp;
  }
  ...
  function claimRewards() public nonReentrant {
    ...
    lastRewardClaimedTime[msg.sender] = block.timestamp;
  ...
  function claimWinnings() public nonReentrant {
    ...
    lastWinningClaimedTime[msg.sender] += claimableWinnings;
  ...
  */
  ...
  function setUserStake(uint256 _amount) public {
    ...
    function setRewardsClaimTime(uint _timestamp) public {
        lastRewardClaimedTime[msg.sender] = _timestamp;
    }

    function getElapsedTime() public view returns(uint256){
        uint256 reawardClaimedTime = lastRewardClaimedTime[msg.sender];
    ...
    function getUnclaimedRewards() public view returns(uint256){
        ...
        uint256 lapsedTime = (block.timestamp - lastRewardClaimedTime[msg.sender]) / 1 days;
