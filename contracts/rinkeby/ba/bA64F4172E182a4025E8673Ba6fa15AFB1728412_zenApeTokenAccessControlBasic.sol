...
interface iZenToken {
    ...
    function transferFrom(address from_, address to_, uint256 _amount) external view returns (bool);
}
...
contract zenApeTokenAccessControlBasic is Ownable {
    ...
    function enableFeature(uint256 tokenType_) external {
        ...
        if (tokenType_ == 1) {
            ...
            ZenToken.transferFrom(msg.sender, address(this), featurePrice);
            ZenToken.burn(ZenToken.balanceOf(address(this)));
        }
