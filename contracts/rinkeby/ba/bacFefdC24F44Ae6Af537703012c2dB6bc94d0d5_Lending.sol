...
contract Lending is ILending, Compounder, RateProvider, Ownable {
    ...
    /**
     * @dev Get all collateral belonging to a borrower
     */
    function getAllCollateral(address debitor) view external returns (Collateral[] memory) {
        return _collateral[debitor];
    }
    ...
    /**
     * @dev Get all loans belonging to a borrower
     */
    function getAllLoans(address debitor) view external returns (Loan[] memory) {
        return _loans[debitor];
    }
