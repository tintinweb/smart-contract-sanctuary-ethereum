...
contract TavaStakingClaim is ITavaStakingClaim, Ownable, ReentrancyGuard {
        ...
        external nonReentrant override
    {
        ...
        emit stakingClaim(IReceivedInfo(block.timestamp, _CurrentReceiveableToken), _ReceiveableDateIdx);
    }
}
...
interface ITavaStakingClaim {
    ...
    */
    ...
    event stakingClaim(IReceivedInfo _ReceivedInfo, uint256 _ReceiveableDateIdx);
