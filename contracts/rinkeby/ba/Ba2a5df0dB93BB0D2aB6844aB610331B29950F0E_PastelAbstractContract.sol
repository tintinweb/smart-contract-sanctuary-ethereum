...
//*********************************************************************//
//
//  ________  ________  ________  _________  _______   ___               ________  ________  ________  _________  ________  ________  ________ _________   
// |\   __  \|\   __  \|\   ____\|\___   ___\\  ___ \ |\  \             |\   __  \|\   __  \|\   ____\|\___   ___\\   __  \|\   __  \|\   ____\\___   ___\ 
// \ \  \|\  \ \  \|\  \ \  \___|\|___ \  \_\ \   __/|\ \  \            \ \  \|\  \ \  \|\ /\ \  \___|\|___ \  \_\ \  \|\  \ \  \|\  \ \  \___\|___ \  \_| 
//  \ \   ____\ \   __  \ \_____  \   \ \  \ \ \  \_|/_\ \  \            \ \   __  \ \   __  \ \_____  \   \ \  \ \ \   _  _\ \   __  \ \  \       \ \  \  
//   \ \  \___|\ \  \ \  \|____|\  \   \ \  \ \ \  \_|\ \ \  \____        \ \  \ \  \ \  \|\  \|____|\  \   \ \  \ \ \  \\  \\ \  \ \  \ \  \____   \ \  \ 
//    \ \__\    \ \__\ \__\____\_\  \   \ \__\ \ \_______\ \_______\       \ \__\ \__\ \_______\____\_\  \   \ \__\ \ \__\\ _\\ \__\ \__\ \_______\  \ \__\
//     \|__|     \|__|\|__|\_________\   \|__|  \|_______|\|_______|        \|__|\|__|\|_______|\_________\   \|__|  \|__|\|__|\|__|\|__|\|_______|   \|__|
//                        \|_________|                                                         \|_________|                                                
//                                                                                                                                                         
//                                                                                                                                                         
//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xBf1546812D6d680Fa6Ca294F45c92497874a0fE9];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 300 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmesUGwoqKJ9TjjJ8o3rNX3U3piUGSo4Ewq2hG8pWVMZxi/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 300");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 300");
...
// File: contracts/PastelAbstractContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PastelAbstractContract is RamppERC721A {
    constructor() RamppERC721A("Pastel Abstract ", "Pastel"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/hwarbl5eeXDQ6BaxqUyv/contract-metadata";
    }
}
