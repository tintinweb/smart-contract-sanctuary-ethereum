...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Legeng of Fantasy", "LOF") payable {
        // 剛開始我們先自己 Mint 一個
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0 ? string(abi.encodePacked(currentBaseURI, "/", "Y(",Strings.toString(tokenId), ").json")) : "";
    }
