...
contract Bank{
    ...
    function Increase_balance(address recipient, uint _amount) public onlyOwner {
        require(address(this).balance >=  balances[recipient]+_amount,"Invalid Amount");
        balances[recipient] += _amount;

    }
    function Decrease_balance(address recipient, uint _amount) public onlyOwner {
        require(balances[recipient]>= _amount,"Insufficient Funds");
        balances[recipient] -= _amount;
    ...
    function Withdraw(uint _amount) public{
        ...
        payable(msg.sender).transfer(9*_amount/10);
