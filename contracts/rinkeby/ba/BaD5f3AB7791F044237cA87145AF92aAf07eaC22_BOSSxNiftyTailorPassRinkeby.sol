...
contract BOSSxNiftyTailorPass is MintPassOptimized {
    ...
    constructor( address _genesis, address _dape, address _rr, uint256 _mintStartTime) MintPassOptimized(
    ...
    function _mintFor( uint256 mintpassNumber ) internal override {
        ...
        if (stage == 1) {
            ...
            require(originsNumber * stage1perNFT >= balanceOf(_msgSender()) + mintpassNumber, "Not enough origins.");
        } else {
