...
contract RRMAYC is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("RR/MAYC", "RR/MAYC", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("https://api.otherside.xyz/lands/", (tokenId+1).toString()));
    }
