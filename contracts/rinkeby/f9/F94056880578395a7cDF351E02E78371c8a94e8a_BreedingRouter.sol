...
contract BreedingRouter is Ownable, Pausable, ERC721Holder {
    ...
    uint256 public constant breedCostPerDay = 200 * 10**18;
    ...
    address public itemContractAdress;
    ...
    function lease(
        ...
        require(paymentToken == pillContractAddress, "please use pill token for rent cost");
        ...
        leaseMarket.nftContract = contractAddress;
        leaseMarket.owner = msg.sender;
        leaseMarket.paymentToken = paymentToken;
    ...
    function estimateBreedTimeAndCost(
        ...
        return (
            _getBreedingTime(bunnyId1, bunnyId2, useNyanKee),
            _getBreedingTime(bunnyId1, bunnyId2, useNyanKee).mul(breedCostPerDay)
        );
    }
