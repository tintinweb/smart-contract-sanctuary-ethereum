...
contract isi_202204090123 is ERC721{
    ...
    string nkmt_baseURI = "https://ipfs.io/ipfs/QmS33BcJ65nWPnrQrag7fBRZyyTDU48nLcsMV7iWLmsuDi/";
    ...
    function changeNKMTForm(uint _id)public{
        ...
        nekomato_0409_0220 nkmt = nekomato_0409_0220(0x9Fd129D188D7f5fa98F8C59561d5157Abb771dEb);
        //require(nkmt.getHaveTokens(msg.sender ) > 0);
        string memory uri = string(abi.encodePacked(nkmt_baseURI,Strings.toString(_id),".json") );
        nkmt.chengeForm(msg.sender,_id,uri);
    }
