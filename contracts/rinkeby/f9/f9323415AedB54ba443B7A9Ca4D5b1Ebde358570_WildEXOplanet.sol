...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    address WHITELIST_SIGNER = 0xCB585beeDb64a84dd22B60A4Fb5b33d6fa9B1274;
    ...
    uint256[] public tierStartMintTimes = [1644905924, 1644907724];
    //Minting ending time in unix-epoch [phase 1 end, phase 2 end]
    uint256[] public tierMintEndTimes = [1644906524, 1644908324];
    //Minting tier fee
    uint256[] public tierMintFees = [0.0025 ether, 0.007 ether, 0.011 ether, 0.015 ether, 0.025 ether];
    ...
    uint256 public whitelistSaleDisableTime = 1644905324;
    uint256 public whitelistSaleStartTime = 1644904724;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1644907124, 1644908924];
   ...
   ///@notice Mint the token to the address sent
    ...
    function claimWhitelistSale(bytes[] calldata _signature, address to, uint256[] calldata _nftIndex) external payable{
      ...
      for(uint256 i=0;i< _nftIndex.length; i++){
        ...
        realTokenIds[newTokenId] = tierRunningSupply[0];
