...
contract Orkswtf is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Orkswtf", "ORKS"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Orks");
    require(mintEnabled, "Minting is not live yet, hold on Orks.");
