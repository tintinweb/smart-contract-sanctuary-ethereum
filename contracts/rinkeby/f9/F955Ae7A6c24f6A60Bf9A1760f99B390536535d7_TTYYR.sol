...
contract TTYYR is ERC721A, Ownable, ReentrancyGuard {
  ...
  // function allowListMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
  //   require(allowList[msg.sender], "You are not on the allow list");
  //   _safeMint(_msgSender(), _mintAmount);

  // }
  // //external or internal? can all this function in script when whitelist open
  // function setAllowList(address[] calldata addresses) internal onlyOwner {
