...
contract TEG is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxSupply = 6400;

    bool public mintEnabled = false;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("GobTest", "GTS") {
        _safeMint(msg.sender, 30);
        setBaseURI("ipfs://QmPBRhc6Fbqa2hUtmm7qWbx9y8kMY2RGGefNwBD4kTswg1/");
    }
