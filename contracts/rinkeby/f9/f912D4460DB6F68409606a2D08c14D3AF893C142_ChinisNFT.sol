...
contract ChinisNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Chini NFT", "CN") {
    setHiddenMetadataUri("ipfs://QmNaLih8fkGUyp1qthcLXCTJUUGBrTRo3GfUZFyFVRXsf9/metadata.json");
  }
