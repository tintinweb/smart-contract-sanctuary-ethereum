...
contract TestDogs is LilOwnable, ERC721 {
    using Strings for uint256;

    uint256 public constant TOTAL_SUPPLY = 7777;
    uint256 public constant PRICE_PER_WHITELIST_MINT = 0.077 ether;
    uint256 public constant PRICE_PER_PUBLIC_MINT = 0.01 ether;
