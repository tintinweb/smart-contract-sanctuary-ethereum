...
contract GlowGuys is ERC721, Ownable {
    ...
    constructor(string memory tokenBaseURI, string memory mysteryURI) ERC721("Glow Guys", "GLOWGUYS") {
    ...
    function withdraw(uint256 percentage) external onlyOwner {
        uint256 currentBalance = address(this).balance;
        payable(wallet1).transfer((currentBalance * 500) / (percentage * 10));
        payable(wallet2).transfer((currentBalance * 500) / (percentage * 10));
    }
