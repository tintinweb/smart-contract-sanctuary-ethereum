...
contract SmartContract is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000000 * 10**_decimals; // 1m
    uint256 public maxTxAmount = 10000000000000000 * 10**_decimals; //10quad
    uint256 public _maxWalletSize = 10000000000000000 * 10**9; //10quad
    bool private _isTradingState = true;
    mapping (address => uint256) public _lastTrade;
    bool public coolDownEnabled = true;
    uint256 public coolDownTime = 69 seconds;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x3a2775eED458cef0f2C6cFa169Ff6f4E1ed17885; //0xe97C552e62D0E3129CC7E4E71853AA7B6FE384A8;
    ...
    string private constant _symbol = "FTF3";
