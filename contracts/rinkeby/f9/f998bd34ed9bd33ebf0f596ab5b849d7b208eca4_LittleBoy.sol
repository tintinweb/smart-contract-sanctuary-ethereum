...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x50a5315c5bAa65a041e6f85555751dCe900f3297;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 6528) { }
    uint8 public CONTRACT_VERSION = 1;
    string public _baseTokenURI = "ipfs://QmUKcaT9ueWKENmjUzT16BJbKRVBb3RNjFXtbiMp4JDtWo/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6464");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6464");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6464");
...
// File: contracts/LittleBoyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LittleBoy is RamppERC721A {
    constructor() RamppERC721A("LittleBoy", "LittleBoy"){}
}