...
import "./royalties/RoyaltyFeeGetter.sol";

contract Exchange is ExchangeEx {
    string public constant NAME = "ADASH Exchange";

    /**
     * @dev Initialize a Exchange instance
     * @param registryAddress Address of the registry instance which this Exchange instance will use
     */
    constructor(
        ProxyRegistry registryAddress,
        TransferProxy tokenTransferProxyAddress,
        RoyaltyFeeGetter royaltyFeeRegistryAddress
    ) {
...
contract ExchangeEx is ExchangeMain {
    /**
...
import "../registry/ProxyRegistry.sol";
import "../registry/AuthenticatedProxy.sol";
import "../royalties/interfaces/IRoyaltyFeeGetter.sol";
import "../TransferProxy.sol";

contract ExchangeMain is ReentrancyGuard, Ownable {
    bytes4 private constant ERC1155_SIGNATURE = 0x127217d6;

    /* User registry. */
    ProxyRegistry public registry;

    /* Token transfer proxy. */
    TransferProxy public tokenTransferProxy;

    /* Royalties */
    IRoyaltyFeeGetter public royaltyFeeRegistry;
    ...
    function atomicMatch(
        ...
        /* Must be matchable. */
        require(ordersCanMatch(buy, sell), "Exchange:: Order not matched");
