...
contract Punks is ERC721Optimized, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    string public uriPrefix = "https://gateway.pinata.cloud/ipfs/Qma52QnXzwZQhoDL1iUXxoHJNjRyGamsWwCCTndN34bBKJ/";
    ...
    uint256 public fMsupply = 50;
    uint256 public maxMPerx = 5;
    uint256 public maxFMPerx = 2;
    uint256 public maxFMPerW = 2;
    ...
    constructor() ERC721Optimized("Punks", "PS") {
    ...
    function PublicMint(uint256 numberOfTokens) public payable nonReentrant {
        ...
        if (supply < fMsupply) {
            ...
            require(mintedbalance[_msgSender()] + numberOfTokens <= maxFMPerW, "You will exceed max amount per transaction in free mint round!");
        } else {
            require(numberOfTokens <= maxMPerx, "Too many tokens per transaction");
            require(mintedbalance[_msgSender()] + numberOfTokens <= maxMPerx, "You will exceed max amount per transaction in free mint round!");
