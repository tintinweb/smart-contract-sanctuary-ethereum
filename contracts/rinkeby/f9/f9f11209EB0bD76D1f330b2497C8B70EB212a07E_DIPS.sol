...
contract DIPS is AccessControl, ERC20Capped, Pausable {
    ...
    //for max supply we do 1b 1,000,000,000
    constructor(uint256 totalSupply, uint256 initMint) ERC20Capped(totalSupply) ERC20("dip", "DIP") {

        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);

        //for initial supply we do 1m 1,000,000
        ERC20._mint(msg.sender, initMint);
    }
