...
contract HeroItem is IItem, ERC1155, Ownable, EIP712, AccessControl, IERC2981 {
  ...
  function claim(ClaimItemsVoucher calldata voucher) public payable {
    address signer = _verifyClaimVoucher(voucher);
    require(hasRole(MINTER_ROLE, signer), "Signature invalid or unauthorized");
    require(msg.value == voucher.price, "Invalid value amount");
  ...
  {
    return
      string(abi.encodePacked(metadataBaseURI, Strings.toString(_tokenId)));
  }
