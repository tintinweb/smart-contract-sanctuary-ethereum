...
contract OMGKirby is ERC721, Ownable {
  ...
  // Timestamps
  uint startTime;
  uint claimTimeLock = startTime + 15 minutes;
  ...
  constructor(address _genesisAddr, uint _startTime, address _dao) ERC721("OMGKirby", "OMG") {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
    ...
    require(addressClaimed[_msgSender()] + _mintAmount <= mintAmount, "Exceeds whitelist supply");
