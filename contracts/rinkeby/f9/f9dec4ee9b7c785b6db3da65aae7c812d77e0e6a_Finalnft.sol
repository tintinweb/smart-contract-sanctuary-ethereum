...
contract Finalnft is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 50; //  444 total for this launchpad
    ...
    uint256 public constant NFT_PRICE = 0 ether; // 1.2 avax for this launchpad
    uint public startAt;
