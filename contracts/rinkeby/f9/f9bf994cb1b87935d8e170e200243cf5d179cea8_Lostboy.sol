...
contract Lostboy is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RENAME_PRICE = 10000000000000000; // 0.01ETH
    ...
    function withdrawBalance() public onlyOwner {
      ...
      function changeNameAndDescription(uint numberoferc20Tokens,uint256 tokenId, string memory newName, string memory newDescription) public payable {
