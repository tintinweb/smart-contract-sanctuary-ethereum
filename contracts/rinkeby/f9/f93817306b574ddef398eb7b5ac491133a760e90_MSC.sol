...
contract MSC is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 9885;
	uint256 public GIVEAWAY_NFT = 115;
    ...
    constructor() ERC721P("Marikos Secret Club", "MSC") {}
