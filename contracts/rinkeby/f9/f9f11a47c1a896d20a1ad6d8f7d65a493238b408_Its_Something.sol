...
// File: contracts/its something.sol
...
contract Its_Something is Ownable, ERC721A {
    ...
    string private revealedURI = "ipfs://QmP1MRzw24n9q5ECxQ6CUYrTkxrC3VcuRPryJLN3AtxXLg/";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string private CONTRACT_URI = "ipfs://UGZQDC6P3N3WT4PBJ2P11B4BYFZ1H5DYRM";
    ...
    address constant internal DEV_ADDRESS = 0x76EaDc7615A2a42d5b4625a9dd5e8C34161eDE52;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("it's something.", "SOME") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 444, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x76EaDc7615A2a42d5b4625a9dd5e8C34161eDE52");
