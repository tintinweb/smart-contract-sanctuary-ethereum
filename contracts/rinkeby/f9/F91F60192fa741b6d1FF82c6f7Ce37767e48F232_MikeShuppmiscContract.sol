...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3F5602a8a9664817aBc95bf0280a5a9F621f0287];
...
// File: contracts/MikeShuppmiscContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MikeShuppmiscContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Mike Shupp misc";
    string public symbol = "MTS5";
