// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Extra", unicode"Frame", unicode"Eyes"];
        ...
        ContractData public contractData = ContractData(unicode"Nounish Glasses", unicode"Collection of glasses", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/4a3bd442-f4ee-4840-b4ea-ade2ac76f311", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/4a3bd442-f4ee-4840-b4ea-ade2ac76f311", "", 500, "0xBc3D20463320958Dc7DE604b5FdCE94d9A85CEB2");

        constructor() ERC721A(unicode"Nounish Glasses", unicode"NGLASSES") {
            TIERS[0] = [10,20,20,20,930];
TIERS[1] = [1,2,2,4,9,11,12,12,12,12,24,25,28,30,30,40,40,40,41,125,125,125,125,125];
TIERS[2] = [1,2,3,4,4,6,7,8,9,9,10,10,10,16,17,22,22,25,26,32,36,48,50,52,65,73,91,92,250];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Nounish Glasses #");
