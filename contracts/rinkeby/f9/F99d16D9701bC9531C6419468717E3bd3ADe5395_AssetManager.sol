            ...
            for(uint j = 0; j < strategyDetails.portfolioList.length; j++) {
                ...
                if(j == strategyDetails.portfolioList.length - 1) {
                    ...
                    _swap(
                        ...
                        _ERC20tokenId(tokenIn), 
                        _ERC20tokenId(tokenOut),
                        strategyDetails.amountIn * balanceOf(strategyDetails.portfolioList[j], _ERC20tokenId(tokenIn)) / strategyDetails.totalBalanceOfTokenIn,
                        strategyDetails.amountOut * balanceOf(strategyDetails.portfolioList[j], _ERC20tokenId(tokenIn)) / strategyDetails.totalBalanceOfTokenIn
                    );

                    strategyDetails.amountInLeft -= strategyDetails.amountIn * balanceOf(strategyDetails.portfolioList[j], _ERC20tokenId(tokenIn)) / strategyDetails.totalBalanceOfTokenIn;
                    strategyDetails.amountOutLeft -= strategyDetails.amountOut * balanceOf(strategyDetails.portfolioList[j], _ERC20tokenId(tokenIn)) / strategyDetails.totalBalanceOfTokenIn;
                }
            }
        }
