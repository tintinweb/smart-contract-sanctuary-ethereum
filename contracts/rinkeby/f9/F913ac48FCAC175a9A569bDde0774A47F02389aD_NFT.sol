...
contract NFT is ERC721Enumerable, Ownable {
  ...
  address public adminAddress = 0xAfFA080613F8955612573135e7A4c3A0257c6B58;
  uint256 public token_id = 0;

  mapping(address => bool) public mutex;



  constructor( ) ERC721("Soull Genezisss", "SL") {
    baseURI = "https://beethoven250.art/opnse/";
 ...
 // from ipfs support
  ...
  function setBaseExtension(string memory _newBaseExtension) public onlyOwner {
    ...
    address t1 = 0xE41F264e4cDa923f24bf671faCdB9a4820a8E046; //other

    address t2 = 0x76e9a5a40BbC607a79273Ada8A20711Fb0b4ee9A; //other

    address t3 = 0xeF9Fa37dA6b88475A2cf178CA47852C2e998ec43; //my

    address t4 = 0xAfFA080613F8955612573135e7A4c3A0257c6B58; //my
 
  function withdraw() public payable onlyOwner {

       uint256 _teem1 = address(this).balance * 24/100;
       uint256 _teem2 = address(this).balance * 23/100;
