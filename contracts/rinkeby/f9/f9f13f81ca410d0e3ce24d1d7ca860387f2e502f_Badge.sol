...
contract Badge is ERC721, Ownable {
  ...
  event OPCOsAdded(address indexed _op, uint256 indexed _lastCursor, address[] _opcos);
  event CitizensAdded(address indexed _opco, uint256 indexed _lastCursor, address[] _citizens);
  ...
  // function _deleteOPCO(address _adr) private onlyOP {
  //   uint256 delIndex; 
  //   for (uint256 i = _delIndex; i < OPCOs.length; i++) {
  //     if (OPCOs[_adr])
  //   }  
  // }
