...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x13143A1A776fA319e1c54C9E40644a0723FC0073];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 19 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPgSaFRq1zuRbR7cpDkjxfqXPcYhQo9WhdWUqdghJtt7t/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 19");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 19");
...
// File: contracts/WhathappenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WhathappenContract is RamppERC721A {
    constructor() RamppERC721A("what happen", "WHAEN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/B1oViDn4iHfFrxDpOb3K/contract-metadata";
    }
}
