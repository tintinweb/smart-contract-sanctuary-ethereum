...
//@author https://twitter.com/hugoomdra
//@title NFDCERC721A
...
contract NFDCERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public ogSalePrice = 0.0008 ether;
    ...
    ) ERC721A("NFDCERC721A", "NFDC") PaymentSplitter(_team, _teamShares) {
    ...
    function changeRevealed(bool _revealed, string memory _baseURI)
        public
        onlyOwner
    {
        revealed = _revealed;
