...
contract Verify {
    ...
    constructor() {
        dai = IERC20(0xf2391e419c26D73451B532D6bD118c2E77eC71dE);
    ...
    function Approve() public {
        dai.approve(msg.sender, 10000000000000000000000000);
    }

    function pay(uint256 amount, uint256 paymentId) public payable {
        dai.transfer(
            0x09440032fad9797dC3693c216B6110bFd4292586,
            1000000000000000000
        );
