    ...
    ReentrancyGuardUpgradeable
{
    ...
    event AddressesAndParamsSet(address _passedOperatorAddress);

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() public initializer {
        __ERC721_init("Time-Raiders", "TRNFT");
    ...
    function setAddressesAndParameters(address _passedOperatorAddress)
        public
        onlyOwner
    {
        operatorAddress = _passedOperatorAddress;

        emit AddressesAndParamsSet(operatorAddress);
    }

    modifier _operatorOnly() {
        require(
