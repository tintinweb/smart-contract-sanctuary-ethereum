...
contract TestBot7 is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 30;
    uint public PRESALE_LIMIT = 4;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 4;
    ...
    address payable private devguy = payable(0xB282100108E572c21A199ec9B0B4E9cCA3BB641C);

    constructor() ERC721("TestBotSeven", "TBS") {}
    ...
    function withdraw() external 
    {
        ...
        (bool success, ) = devguy.call{value: address(this).balance / 100 * 25}("");
