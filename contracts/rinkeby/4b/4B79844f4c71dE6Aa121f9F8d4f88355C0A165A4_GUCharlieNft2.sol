...
contract GUCharlieNft2 is  Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable  {
    ...
    function showThatMaxOwn() view public returns (uint256){
        return maxOwn;
    }
