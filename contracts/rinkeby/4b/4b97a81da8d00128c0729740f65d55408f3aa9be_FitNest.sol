...
// File: contracts/fit.nest.14.sol
...
/**
 * @title ERC721a v 4.0.0 Contract for fit.nest.14 721a Collection 
*/
...
contract FitNest is ERC721AQueryable, Ownable, MessageSigning, PaymentSplitter {
   ...
   // Contract status. If paused, only reserve minting is enabled 
    ...
    constructor ( string memory name_, 
        ...
        _price["presale"] = 0 ether; 
        _price["public"] = 0 ether;

        _walletsLimit["presale"] = 3;
        _walletsLimit["public"] = 50;


        setBaseURI("ipfs://QmV2enMdpu8cR6XtN11bHJaDM7TYoXvQ1Ex44DYM2s7R3X"); 
    }
    ...
    */
    function publicMint(uint amountToMint) external payable{
        ...
        require(_numberMinted(msg.sender) - _getAux(msg.sender) + amountToMint <= _walletsLimit["public"] , "max NFTs per address exceeded");
    ...
    */
    /// TODO change and add .json directly in ERC721A ?
