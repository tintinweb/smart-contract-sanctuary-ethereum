...
import {ERC2981Base, ERC2981ContractWideRoyalties} from
  ...
  Ownable
{
   ...
   * - When unpaused.
   *
   * @param root_ The new {root}.
   */
  function setRoot(bytes32 root_) external onlyOwner whenNotPaused {
    root = root_;
  }
    ...
    inStage(Stage.Closed)
  {
    ...
    unchecked {
      ...
      if (offset_ + totalSupply_ < offset_) offset -= totalSupply_;
    }
