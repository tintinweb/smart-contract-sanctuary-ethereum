 ...
 */
contract TaleOfTombs is ERC721, Ownable {
    using SafeMath for uint256;


    uint256 public MAX_tombs = 3000;
    ...
    */
    ...
    require(numClaimed >= 0 && numClaimed < 2300, "invalid claim");
    require(numberOfTokens <= 10, "You can only mint 10 tombs at a time");
