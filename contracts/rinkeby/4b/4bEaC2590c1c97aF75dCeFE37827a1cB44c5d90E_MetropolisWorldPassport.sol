...
contract MetropolisWorldPassport is ERC721Enumerable, AccessControl {
    ...
    uint32 public _mintLimit = 20001;
    uint16 public _maxAllowedPerWallet = 1000; //maximum allowed to mint per wallet
    string private _oddAvatar = "nomad";
    string private _evenAvatar = "citizen";
    string private _contractURI;
    uint256 public _navPrice = 0.2 ether;
    ...
    //set up functions
    constructor(address payable paymentContract, address imageContract, address admin) ERC721("Metropolis World Passport", "METWA") {
     ...
     */
    function setWLContractAddress(address winContract, address wlContract, address turiContract)external onlyRole(UPDATER_ROLE){
     ...
     * @param winContract The address of the win chances contract.
     * @param wlContract The address of the Whitelist Contract.
     * @param lotContract The address of the Lottery contract.
     * @param soft The address of the softClay contract. 
     * @notice Can only be called by wallets with UPDATER_ROLE 
     */
    function addTheRolesForContractCalls(address winContract, address wlContract, address lotContract, address soft)external onlyRole(UPDATER_ROLE){
    ...
    function setContractURI(
        ...
        string memory x = Base64.encode(
            abi.encodePacked(
                ...
                '", "fee_recipient": "',_paymentSplit,'" }' // Where seller fees will be paid to.}
            )
        );
        _contractURI = string(
