...
contract NFTStore is EIP712, Ownable {
	...
	function setMainSale(bool status) external onlyOwner {
		mainSaleOn = status;
	}
	...
	*/
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Mint with floor price / auction? incomplete ideas tbd
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
	function mintGetFloorPrice() {
		// get the floor price on a mintable
	}

	function mintWithFloorPrice() {
		// - register a bid price which means that you're establishing a floor price for a mintable
		// - do a mint
	}

	function bid(uint256 _item,uint256 _timeAfter,uint256 _timeRevert) public payable {
		// - store these facts :
		//		party: msg.sender
		//		thing: item you will pay for
		//		amount: amount...
		//		timeAfter: don't settle before this date
		//		timeRevert: allow revert after this date
	}

	function sell(uint256 _item) {
		// - look at existing bids
		// - if one matches then settle
	}
*/
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Minting
