...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract NewWorldCard  is ERC721Enumerable,  Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721("New World Card ", "NWC") {
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
       ...
       require (nftPerWLAddress[msg.sender] + _mintAmount <= maxWLMintAmountPerWallet, "Exceeds max tx per address");
