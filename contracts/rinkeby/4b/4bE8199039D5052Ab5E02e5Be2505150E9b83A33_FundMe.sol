...
/** @title this is a test fundme contract
    @author armin
...
contract FundMe {
    ...
    constructor(address priceFeedAddress) {
        ...
        console.log("constucting contract with owner: %s", msg.sender);
    }
    ...
    function fund() public payable {
        ...
        console.log("Funding %s from %s", msg.value, msg.sender);
    ...
    function test() public view returns (uint256) {
        return PriceConverter.getPrice(s_priceFeed); // <-- calling method from imported contract
    }
