...
contract Progressive is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 private constant PRICE_STEP = 20;
  uint256 private constant PRICE_STEP_DURATION = 1 days / 20;

  constructor(address artAddress_) ERC721("Progressive", "PROGRESSIVE") {
