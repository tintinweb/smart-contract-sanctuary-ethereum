...
contract TstGldieA is ERC721A, Shareholders {
    using Strings for uint;
    string public _baseTokenURI;
    uint public maxPerPresale = 500;
    uint public maxPerMint = 15;
    uint public maxPerWallet = 15;
    uint public cost = 0.05 ether;
    uint public presaleCost = 0 ether; 
  ...
  function mint(uint256 quantity) mintCompliance(quantity) external payable
    ...
    function goldlist(uint256 quantity, bytes32[] calldata proof) mintCompliance(quantity) external payable
    {
