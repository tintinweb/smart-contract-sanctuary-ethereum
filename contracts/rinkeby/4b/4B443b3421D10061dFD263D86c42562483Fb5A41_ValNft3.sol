...
contract ValNft3 is ERC721URIStorage, Ownable, ReentrancyGuard{
    string private _collectionURI;
    string public baseURI;

    /**
      * team mint are from 1-2 (2 max supply)
      * whitelist are from 3-10 (8 max supply)
      * public mint from 11 - 20 (10 max supply)
    **/

    uint256 immutable public maxGiftMintId = 2;
    uint256 public giftMintId = 1;

    uint256 immutable public maxWhitelistId = 8;
    uint256 public whitelistId = 3;
    uint256 public constant WHITELIST_SALE_PRICE = 0 ether;

    uint256 immutable public maxPublicMint = 10;
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("VALNFT", "VNFT") {
        setBaseURI(_baseURI);
