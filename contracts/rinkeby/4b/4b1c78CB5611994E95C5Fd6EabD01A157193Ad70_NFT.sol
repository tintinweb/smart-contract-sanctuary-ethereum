...
contract NFT is Ownable, ERC721A, PaymentSplitter {
    ...
    //The price for the whitelist & public sale
    uint public PWL;
    ...
    uint public constant DUTCH_AUCTION_DURATION = 340 minutes;
    ...
    **/
    function getPrice() public view returns(uint) {
        ...
        if (block.timestamp - auctionSaleStartTime >= DUTCH_AUCTION_DURATION) {
            return DUTCH_AUCTION_PRICE_END;
        } else {
            uint256 steps = (block.timestamp - auctionSaleStartTime) /DUTCH_AUCTION_DROP_INTERVAL;
