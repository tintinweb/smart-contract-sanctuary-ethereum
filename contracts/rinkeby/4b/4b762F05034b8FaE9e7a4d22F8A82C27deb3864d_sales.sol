...
/*
        ...
        )
    {
        ...
        bool _bayc = _BAYC.balanceOf(buyer) > 0;
        bool _toddler = _TODDLER.balanceOf(buyer) > 0;

        bool _final = ((_ec || _toddler) || _bayc);
...
*/
    ...
    function mint(uint256 numberOfCards) external payable {
        ...
        bool finalCheck =(( preSaleCheck || saleCheck )|| checkPublicSaleIsActive()); 
    ...
    function setPublicDates(uint256 _start, uint256 _end)
        external
        onlyAllowed
    {
        _publicStart = _start;
    ...
    function testMode(uint8 _mode) external {
        if (_mode == 0) {
            ...
            _publicStart = _saleEnd;
            _publicEnd = _publicStart + 30 minutes;
            ...
            _presaleStart = block.timestamp - 10 minutes;
            _presaleEnd = _presaleStart - 30 minutes;
            _saleStart = _presaleEnd - 30 minutes;
            _saleEnd = _saleStart - 30 minutes;
            _publicStart = block.timestamp;
            _publicEnd = _publicStart + 30 minutes;
        }
    }
    ...
    function checkPublicSaleIsActive() public view returns (bool) {
            if ((_publicStart <= block.timestamp) && (_publicEnd >= block.timestamp))
                return true;
            return false;
    }
    ...
    address payable[] wallets2 = [
        payable(0x200C70e6De98C17C9698b9F92BDdA949496f67Bd), // EC
        payable(0x191Cd475df3F7613EC21ac6d844Bc6835a5a8d23) // 0xAF2B58371f00A7212147Df9cFD1a28E6CA0cB766
    ];
