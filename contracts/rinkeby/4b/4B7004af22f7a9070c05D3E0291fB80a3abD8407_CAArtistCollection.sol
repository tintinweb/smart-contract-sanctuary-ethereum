...
contract CAArtistCollection is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    string private _preRevealURI = "QmRsNAoRQXd5L1CsCXGoTMxKXKUaKmjTznfEt2cmhM65nH";    // TODO switch for live
    ...
    constructor() ERC721("CAArtistCollection", "CAAC") {
        ...
        _preSalePhase = 2;
        _presaleContracts[0] = 0x1bEEf8EEc88F731daf1f39389618F67231EC19bf;
        _presaleContracts[1] = 0xA32222a3b57cb5542BECb57341D68A9dAd70523B;
    ...
    function mintNFT( uint _preSaleSlot, uint _passTokenId, uint _quantity, address _to ) public payable {
        ...
        if ( _preSalePhase != 0 ) {
            require( _preSaleSlot < _preSalePhase, "M10: Phase of minting not started" );
            require(
                IERC721(_presaleContracts[_preSaleSlot]).ownerOf(_passTokenId) == msg.sender,
                "M11: Invalid mint pass"
            );
        }
