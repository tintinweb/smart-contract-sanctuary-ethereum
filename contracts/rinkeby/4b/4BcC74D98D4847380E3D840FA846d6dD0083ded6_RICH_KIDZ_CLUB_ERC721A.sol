...
/* 	IERC20 public constant USDC = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
	...
	IERC20 public constant USDC = IERC20(0x241f38Ddfbbc78A5D7625e6ad4Bb4e011FA863b6);
	IERC20 public constant USDT = IERC20(0xf8748fdEBdc112A30eB432b860C589577272A286);

	IChainlinkPriceFeed public constant ETH_ORACLE = IChainlinkPriceFeed(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
	...
	function mint(
        ...
        _processPayment(currency, _config[phase].mintingFee * amount);
    ...
    function setPhaseConfig(Phase phase, PhaseConfig memory config) external onlyOwner {
    ...
    function setActivePhase(Phase phase) external onlyOwner {
        require(currentPhase != phase, "phase already active");
	...
	function amountOfCurrentlyMintableNfts() external view returns(uint256) {
		uint256 currentSupply = totalSupply();
		uint256 currentMaxSupply = _config[currentPhase].maxSupply;
