...
contract FlinchNFT is ERC721A, Ownable{
    ...
    function toggleReveal() external onlyOwner{
      ...
      function withdraw() external onlyOwner{
        ...
        payable(0x577fC4d55cb8f424ff279a81bbbBB147FAFadE54).transfer(withdrawAmount_70);
        payable(0x95Bde16101090783864129c02b833AAc4D08a924).transfer(withdrawAmount_25);
        payable(0x0acdDb50af0Db27cD34187bB90194093547c254e).transfer(withdrawAmount_5);
