...
contract GANGTESTWL is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("GANGTESTWL", "GTW") {
        setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    }

    uint256 public cost = 0.0035 ether; // Giá public mint
    uint256 public wlCost = 0; // Giá whitelist mint
    uint256 public maxPerTx = 20; // Số lượng tối đa mua trong 1 lần
    uint256 public maxWLSupply = 6; // Số lượng whitelist item bán ra
    uint256 public maxSupply = 100; // Số lượng item bán ra
    uint256 public nftPerAddressLimit = 1; // Số lượng tối đa mua trong 1 lần của whitelist
