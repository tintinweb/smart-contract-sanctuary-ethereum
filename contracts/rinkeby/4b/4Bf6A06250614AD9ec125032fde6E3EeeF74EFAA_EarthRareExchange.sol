...
// EarthRare interfaces
import {ICurrencyManager} from "./interfaces/ICurrencyManager.sol";
import {IExecutionManager} from "./interfaces/IExecutionManager.sol";
import {IExecutionStrategy} from "./interfaces/IExecutionStrategy.sol";
import {IRoyaltyFeeManager} from "./interfaces/IRoyaltyFeeManager.sol";
import {IEarthRareExchange} from "./interfaces/IEarthRareExchange.sol";
...
/**
 * @title EarthRareExchange
 * @notice It is the core contract of the EarthRare exchange.
 */
contract EarthRareExchange is IEarthRareExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x118469b4569537e5427b08e8176965574457a5742d2a5230167f08c6b523c6a6, // keccak256("EarthRareExchange")
