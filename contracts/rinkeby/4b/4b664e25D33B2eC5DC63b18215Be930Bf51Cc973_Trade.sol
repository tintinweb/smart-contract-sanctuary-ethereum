...
contract Trade is WhitelistChecker{
    ...
    */
    ...
    function createNFT(string memory uri, uint256 supply, uint96 fee, whitelisted memory sign) external payable{
        ...
        (uint256 tokenId, bool mint) = IERC1155(sign.nftAddress).mint(msg.sender, uri, supply, fee);
