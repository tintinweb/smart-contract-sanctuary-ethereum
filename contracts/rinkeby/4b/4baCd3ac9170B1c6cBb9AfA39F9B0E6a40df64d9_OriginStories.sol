...
contract OriginStories is PVERC721, PVAllowlist {
    ...
    uint256 public purchaseWindowOpensFD;
    uint256 public purchaseWindowOpensI2;    
    uint256 public purchaseWindowOpensPublic;    

    bytes32 public merkleRootFD;
    bytes32 public merkleRootI2;
    ...
    constructor(
        ...
        string memory _uri,
        bytes32 _merkleRootFD,
        bytes32 _merkleRootI2,
        uint256 _purchaseWindowOpensFD,
        uint256 _purchaseWindowOpensI2,    
        uint256 _purchaseWindowOpensPublic 
    ) PVERC721(_name, _symbol, _uri) {

        merkleRootFD = _merkleRootFD;
        merkleRootI2 = _merkleRootI2;

        purchaseWindowOpensFD = _purchaseWindowOpensFD;
        purchaseWindowOpensI2 = _purchaseWindowOpensI2;    
    ...
    /**
    * @notice edit the merkle roots for early access sale
    * 
    * @param _merkleRootFD the new merkle root for Founders DAO
    * @param _merkleRootI2 the new merkle root for issue 2 
    */
    function setMerkleRoot(bytes32 _merkleRootFD, bytes32 _merkleRootI2) external onlyOwner {
        merkleRootFD = _merkleRootFD;
        merkleRootI2 = _merkleRootI2;
    }   
    ...
    * @notice edit windows
    * 
    * @param _purchaseWindowOpensFD UNIX timestamp for Founders DAO early access opening time
    * @param _purchaseWindowOpensI2 UNIX timestamp for issue #2 early access opening time
    ...
    */
    function earlyAccessSale(
      ...
      whenInAllowlist(index, maxAmount, merkleProof, block.timestamp < purchaseWindowOpensI2 ? merkleRootFD : merkleRootI2) 
    {
        require(block.timestamp >= purchaseWindowOpensFD, "Early access: window closed");        
