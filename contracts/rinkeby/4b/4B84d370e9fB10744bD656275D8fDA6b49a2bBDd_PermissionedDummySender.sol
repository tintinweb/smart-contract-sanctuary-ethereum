...
contract PermissionedDummySender {
  ...
  function transferData(
    ...
    bytes4 selector = bytes4(keccak256('storeReceivedData((address,uint256,address,int56)[])'));
    ...
    XCallArgs memory xcallArgs = XCallArgs({params: callParams, transactingAssetId: _asset, amount: _amount, relayerFee: 0});
