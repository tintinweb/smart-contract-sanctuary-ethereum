...
contract Staking is Ownable, ERC721Holder {
    ...
    function updatePool() public {
        ...
        uint256 speedReward = multiplier
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        console.log("mint speed ", speedReward);
    ...
    function payReward(UserInfo storage _user) internal {
        ...
        console.log("_user.amount ", _user.amount);

        if (pending > 0) {
            uint256 rewardPerAmount = pending.div(_user.amount);
            uint256 normalizeReward;
            uint256 newPopularity;
            console.log("rewardPerBlock ", rewardPerAmount);
            // calculate horse reward and popularlity
            (
                uint256 reward,
                uint256 popularlity
            ...
            console.log("normalizeReward ", normalizeReward);
        ...
        horseLimitStaking
    {
        ...
        console.log("Deposit horse ", _horseTokenId);
        console.log("len", stable.horses.length);
        // update amount
    ...
    function withdrawHorseInStable(
        ...
        console.log("Remove horse Index ",stable.horseIndex[_horseTokenId]);
    ...
    function removeHorseFromList(Horse[] storage _horses,mapping(uint256 => uint256) storage _horseIndex, uint256 _tokenId)
        internal
    {
        if (_horses.length != 1) {
            // swap
            ...
            _horseIndex[_horses[_horseIndex[_tokenId]].tokenId] = _horseIndex[_tokenId];
        }
