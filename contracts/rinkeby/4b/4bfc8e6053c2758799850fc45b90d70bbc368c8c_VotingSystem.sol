...
// }
    ...
    function vote(uint proposal,uint voteType) external {
        require( proposals[proposal].startTime + 3 minutes >= block.timestamp,"Voting Period for this proposal is over");
        require(voteType==0||voteType==1||voteType==2,"Type Not Available");
