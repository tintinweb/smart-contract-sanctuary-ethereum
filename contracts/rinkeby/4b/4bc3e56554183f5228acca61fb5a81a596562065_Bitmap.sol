...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function _safeMint(address to, uint256 quantity, bytes memory _data)
        internal
    {
     ...
     * Emits a {Transfer} event.
     */
    function _mint(address to, uint256 quantity, bytes memory _data, bool safe)
        internal
    {
...
contract BitPackedMap {
    ...
    function _getFillFromSquare(uint256 square)
        internal
        pure
        returns (string memory)
    {
    ...
    function _getSquareFromMap(bytes32 bitmap, uint256 index)
        internal
        pure
        returns (uint256 square)
    {
        assembly {
    ...
    function _renderSvg(bytes32 bitmap) internal pure returns (string memory) {
        string memory svgString =
            '<?xml version="1.0" encoding="UTF-8" standalone="no"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 8 8">';

        string[8] memory pixelRow;

        uint256 y = 0;
        for (uint256 i; i < 64; i += 8) {
            pixelRow[0] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i)),
                    '" x="0" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[1] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 1)),
                    '" x="1" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[2] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 2)),
                    '" x="2" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[3] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 3)),
                    '" x="3" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[4] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 4)),
                    '" x="4" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[5] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 5)),
                    '" x="5" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[6] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 6)),
                    '" x="6" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
            ...
            pixelRow[7] = string(
                abi.encodePacked(
                    '<rect fill="',
                    _getFillFromSquare(_getSquareFromMap(bitmap, i + 7)),
                    '" x="7" y="',
                    _toString(y),
                    '" width="1" height="1" />'
                )
    ...
    // SOURCE: https://etherscan.io/address/0x8d04a8c79ceb0889bdd12acdf3fa9d207ed3ff63#code
    function _uintToHexString(uint256 a) private pure returns (string memory) {
        uint256 count = 0;
        uint256 b = a;
        while (b != 0) {
            count++;
