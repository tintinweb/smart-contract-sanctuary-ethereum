...
contract CheemsInu is IBEP20, Ownable
{
    ...
    uint8 private _startingSellTax = 30; //Starting sell tax, will change to _endingSellTax after taxChangeTime has been met.
    uint8 private _startingBuyTax = 30; //Starting sell tax, will change to _endingBuyTax after taxChangeTime has been met.
    uint8 private _startingTransferTax = 30; //Starting sell tax, will change to _endingTransferTax after taxChangeTime has been met.
