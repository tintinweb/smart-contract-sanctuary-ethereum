...
contract Standard is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxPreSalesMint = 20;
    ...
    */
    ...
    // ======== GNOSIS ========
    address public constant GNOSIS_SAFE = 0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1;

    // ======== FOUNDERS & TEAM ========    
    address public constant TEAM = 0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1;
    address public constant FOUNDER_BERRY = 0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1; 
    address public constant FOUNDER_GABA = 0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1; 
    address public constant FOUNDER_LORDSLABS = 0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1; 
    address public constant FOUNDER_CRAZYJUMP = 0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1; 


    // ======== CONSTRUCTOR ========      
    constructor() ERC721A("Standard", "NFT") {}
    ...
    function preSaleMint(uint256 _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(preSaleMinted[msg.sender] + _quantity <= maxPreSalesMint, "EXCEEDS MAX CLAIM"); 
    ...
    */
    function setStakeActive( bool isActive_ ) external onlyOwner {
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        if (!isRevealed) {
            ...
            return string(abi.encodePacked(_baseTokenURI, _tokenId.toString())); // NOTE: ammended from _tokenId.toString() to just _tokenId due to top part removing line "using Strings for uint256;" line 9
        }
    }
    ...
    */
    function _stake( address _user, uint256 _tokenId ) internal {
        ...
        transferFrom(_user,address(this), _tokenId);
    ...
    */
    function _unstake( address _user, uint256 _tokenId) internal {
        ...
        transferFrom(address(this),_user, _tokenId);
    ...
    *   @dev usable only if _array contains unique elements only
     */
    function _removeElement(address _user, uint256 _element) internal { // FIXME: maybe unstaking breaks down here for 721A
        Staker storage staker = stakers[_user];
    ...
    */
    function stake( uint[] calldata tokenIds ) external {
        ...
        for( uint i; i < tokenIds.length; ++i ){
            ...
            require(ownerOf(tokenIds[i]) == msg.sender, "MOON: Staking token that is not owned");
