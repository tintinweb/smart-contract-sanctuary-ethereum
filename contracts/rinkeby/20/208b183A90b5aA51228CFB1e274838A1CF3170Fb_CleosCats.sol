...
contract CleosCats is ERC721A, Ownable, ReentrancyGuard {
  ...
  bytes32 public merkleRoot = 0xdd3eb5b806f03806f5d4af5f26cd04331859fd85aff3ca191b91ae4fa00a17b8;



  constructor() ERC721A("Cleos Cats", "CLEO") {setHiddenMetadataUri("ipfs://QmcoHU3U7tm3D6ir7Byz4bRHr91Eyd1CGXEBWMf33EgQYo");}
...
//wl
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount)  {
    require(totalSupply() + _mintAmount <= WlSupply, "Whitelist MaxSupply exceeded!");
...
//normal sale
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(publicSale, "Public Sale is close");
    require(msg.value >= cost * _mintAmount, 'Insufficient funds!');
