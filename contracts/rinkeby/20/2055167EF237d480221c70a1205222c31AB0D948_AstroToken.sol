...
contract AstroToken is ERC20Detailed {
    ...
    constructor(address _router/*0x10ED43C718714eb63d5aA57B78B54704E256024E*/, address _usdc/*0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56*/) ERC20Detailed("Astro Token", "ASTRO1", uint8(DECIMALS)) {
        owner = msg.sender;
