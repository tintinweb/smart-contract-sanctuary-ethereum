...
/**
 * @title ClutchModule
 * @notice Single module for the Clutch wallet.
 */
contract ClutchModule is BaseModule, RelayerManager, SecurityManager, TransactionManager {

    bytes32 constant public NAME = "ClutchModule";
    ...
    */
    ...
    function getRequiredSignatures(address _wallet, bytes calldata _data) public view override returns (uint256, OwnerSignature) {
        ...
        if (methodId == TransactionManager.multiCall.selector ||
            ...
            methodId == ClutchModule.addModule.selector ||
...
// Copyright (C) 2021  Clutch Labs Ltd. <https://clutchwallet.xyz>
...
import "clutch-trustlists/contracts/interfaces/IAuthoriser.sol";
...
abstract contract SecurityManager is BaseModule {
    ...
    */
    ...
    function addGuardian(address _wallet, address _guardian) external onlyWalletOwnerOrSelf(_wallet) onlyWhenUnlocked(_wallet) {
        ...
        require(success, "SM: must be EOA/Clutch wallet");
