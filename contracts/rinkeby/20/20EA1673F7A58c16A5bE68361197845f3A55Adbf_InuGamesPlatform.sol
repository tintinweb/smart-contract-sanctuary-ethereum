/*
 ...
 |_   _|              / ____|
   ...
   | | | '_ \| | | | | | |_ |/ _` | '_ ` _ \ / _ \/ __|
  _| |_| | | | |_| | | |__| | (_| | | | | | |  __/\__ \
 |_____|_| |_|\__,_|  \_____|\__,_|_| |_| |_|\___||___/
  _____  _       _    __
 |  __ \| |     | |  / _|
 ...
 */
contract InuGamesPlatform is ERC20, WithdrawExtension {
    ...
    fallback() external payable {
        require(presaleActive, "InuGamesPlatform: Presale is not active");
        ...
        require(
            ...
            "InuGamesPlatform: Looks like you are trying to buy too many tokens"
        );
        require(
            _msgValue >= (1 * 10 ** 18) / 10,
            "InuGamesPlatform: Send at least 0.1 ETH"
        );
        require(_msgValue <= (1 * 10 ** 18), "InuGamesPlatform: Send max 1 ETH");
