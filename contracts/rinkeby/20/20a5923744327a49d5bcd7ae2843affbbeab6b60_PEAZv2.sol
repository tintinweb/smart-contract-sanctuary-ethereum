...
contract PEAZv2 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmaS86CFpU7DScqdjExuLEBB5RRNCyYu7hoSnYcER9wq8X";
    ...
    uint256 public NUM_FREE_MINTS = 3;
    ...
    constructor(
    ) ERC721A("PZ", "PEAZv2", 100, maxSupply) {
    }
