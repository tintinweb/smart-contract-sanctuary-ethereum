...
contract Test0220220523 is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        ERC721("Test1020220523", "Test1020220523")
    {
        baseURI = _baseURI;
    }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        //TODO add validations to make sure token is minted
        return baseURI;
    }
    ...
    function whitelistMint(uint256 count, bytes32[] calldata _merkleProof) public payable{
        require(block.timestamp >= 1653027000, "Public sale has not started.");
        ...
        require(addressToMinted[_msgSender()] + count <= MAX_PER_WALLET, "Exceeds max wallet supply");
