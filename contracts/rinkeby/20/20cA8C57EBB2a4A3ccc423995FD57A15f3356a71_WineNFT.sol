...
contract WineNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("WineNFT","WNE") {
        numberOfToken = 0;
    ...
    function mint(uint256 _amount) public payable nonReentrant {
        require(publicSaleEnabled, "mint: Paused");
        require(maxMints >= _amount, "mint: 5 max per tx");
        require(maxMints >= minted[msg.sender] + _amount, "You have no mint left");
