...
contract ION is ERC20, Ownable {
    ...
    uint256 public buySellTime = block.timestamp + 600; //change before deployment
    ...
    function _setEpochEndAmt() internal {
        epochEndAmt = (marketCap() * marketCapPer * getTokenPrice()) / (PCT_BASE * (10 ** 22));//change this as per USDC decimal (10 ** 6)
    }
