...
contract PawnShop {
    ...
    struct Bid {
        ...
        uint256 loanAmount;// the amount of wei the lender lend to the borrower
        ...
        bool isInterestProRated; // if the borrower pays sooner, then pays less interest
    }
    address public owner = 0x577fC4d55cb8f424ff279a81bbbBB147FAFadE54;
    address[] public _whiteListNFT;
    uint256 public _feeRate = 25000000000000000;
    uint256 public _totalNumberOfPawn = 100000;
    uint256 public _totalNumberOfBid = 100000;
