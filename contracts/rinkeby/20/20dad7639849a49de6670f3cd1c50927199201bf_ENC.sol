...
/// @title ENC collection smart contract
contract ENC is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement {
    using Strings for uint256;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "ENC: total supply reached");
        _;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "ENC: tranfer is temporarily unavailable"
            );
        }
