...
/// @notice
/// @dev
contract USPlusMinter is PausableUpgradeable, AccessControlUpgradeable {
    ...
    uint256 public constant EXPIRATION_TIME = 5760;
    ...
    function setProtocolManager(address protocolManager)
        external
    ...
    function setComplianceManagerAddr(address newComplianceManagerAddr)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(
    ...
    function setUSPlusAddr(address newUSPlusAddr)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
