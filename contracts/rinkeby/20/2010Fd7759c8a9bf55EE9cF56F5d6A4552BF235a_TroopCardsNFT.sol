...
contract TroopCardsNFT is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    address public proxyRegistryAddress;
    mapping(address => bool) public rewardDistributor;
    mapping(uint256 => bool) public nftStakeStatus;
    string public name = "Troop Cards";
    constructor(address proxyRegistryAddress_)
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/QmTsvWWVWp1DQPPEiZ4rvfL8Z8gK2vjNCQb9ozMadfTZW8/"
        )
    {
    ...
    function contractURI() external pure returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmcGF8So76oo9wNMyCKB8rmXiJVZC49U7HjNXqhxkFCWe5";
    }
