...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmV8ujFJjb7p8byrPjad7iwtBPNudYiJK1neNo8Lpt55p9/";
...
// File: contracts/QqqContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract QqqContract is RamppERC721A {
    constructor() RamppERC721A("QQQ", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/KIJY3cTsUmUXR9dbNmVZ/contract-metadata";
    }
}
