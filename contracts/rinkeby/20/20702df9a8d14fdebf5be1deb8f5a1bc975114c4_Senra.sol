...
contract Senra is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 private _nftEtherValue = 0.011 ether;
  uint256 private maxSupply = 1110;
  uint256 private maxMintAmount = 8;
  uint256 private _maxMintAmountAllowedPerWallet = 5;
  uint256 private _maxFreeMintAmountAllowedPerWallet = 3;
  ...
  bytes32 public root = 0x3d83d4ce1472a6cf84cb328f561beeccd5779e960379f06400d6b3cf8e889853; //Carteira senra, mais as minhas + paulo
  ...
  ) ERC721A("Senra Utility Pass", "SUP") {
