 ...
 * the owner.
 */
abstract contract OwnableUpgradeable is Initializable, ContextUpgradeable, SeraphProtected {
     ...
     */
    function _transferOwnership(address newOwner) internal virtual withSeraph{
...
contract ProductToken is ERC20Upgradeable, Escrow, OwnableUpgradeable {
  ...
  */
   ...
   *
  */
  function setBondingCurve(address _address) external virtual onlyOwner withSeraph{
   ...
   *
  */
  function launch() external virtual onlyOwner withSeraph {
...
contract ProductTokenV0 is ProductToken {
    ...
    function setupVoucher(address addr_, uint256 tokenId_) external virtual onlyOwner withSeraph{
        require(addr_ != address(0), 'invalid address');
        voucher.addr = addr_;
    ...
    function setSupplier( address wallet_) external virtual onlyOwner withSeraph {
