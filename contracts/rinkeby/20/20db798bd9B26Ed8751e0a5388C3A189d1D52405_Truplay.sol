...
contract Truplay is ERC721, Ownable {
    /**
        E#1: Sale has ended
        E#2: Message value not equal to nftPrice
    ...
    */
    ...
    uint256 public nftPrice = 1000000000000000; //0.001ETH
    uint256 public MAX_TOTAL_SUPPLY = 7000;
    uint256 public MAX_PUBLIC_SUPPLY = 6650; //350 NFTs reserved for the Truplay team
    ...
    function safeMint() public payable {
        require(
            _tokenIdCounter.current() < MAX_PUBLIC_SUPPLY,
            "E#1"
        );
        require(msg.value == nftPrice, "E#2");
    ...
    function setNftPrice(uint256 _newNftPrice) external onlyOwner {
