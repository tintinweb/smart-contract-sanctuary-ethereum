...
contract ShibaTicket is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    // Only the owner can call this function which will send amount from the balance to the owner
    function withdrawERC20(IERC20 token, address to, uint256 amount) public onlyOwner {
    ...
    function payWinner() nonReentrant public onlyOwner {
        ...
        players[index].transfer( (IERC20(tokenAddress).balanceOf(address(this)) / 1000) * 100 );
