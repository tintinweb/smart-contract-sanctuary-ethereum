...
contract NFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    //https://gateway.pinata.cloud/ipfs/QmSSHQvkA1pvvKDwXJB1TFfB7e6ZfJARJCyK2uVcHvL3UK/
    string public uriSuffix = ".json";

    uint256 public cost = 30000000000000000;
    uint256 public presaleCost = 10000000000000000;
    ...
    constructor() ERC721A("TVPunks", "TVP"){
    }
    ...
    function togglePresale(bool _toggle) public onlyOwner {
        presaleStatus = _toggle;
    }
    ...
    function presale(bytes32[] calldata merkleProof)
        public
        payable
        ...
        nonReentrant
    {
        require(presaleStatus, "Presale is ended");
        require(!claimed[msg.sender], "NFT is already claimed by this wallet");
        require(msg.value >= presaleCost, "TV Punks: Ether value sent is not sufficient");
    ...
    {
        require(!presaleStatus, "Presale is not ended");
        ...
        require(
            ...
            "TV Punks: Ether value sent is not sufficient"
        );
        ...
        returns (string[] memory)
    {
        ...
        while (
            ...
            if (currentTokenOwner == _owner) {
                ownedTokenURIs[ownedTokenIndex] = tokenURI(currentTokenId);
                ownedTokenIndex++;
            }
        ...
        returns (string memory)
    {
        require(
            _exists(_tokenId),
            "TV Punks: URI query for nonexistent token"
        );
