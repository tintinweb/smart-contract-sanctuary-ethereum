...
contract Shark is
    ...
    ERC20Burnable
{
    string constant private _name = "Shark";
    string constant private _symbol = "Shark";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "Shark/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "Shark/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "Shark/approve : Should not approve zero address"
        );
