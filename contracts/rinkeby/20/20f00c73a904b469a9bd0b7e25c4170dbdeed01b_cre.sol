...
contract cre is ERC20, Ownable {
    ...
    Pixel[1000000000000000000] public pixels; 
    ...
    function placePixel(uint256 _location, bytes32 _color) public {
        ...
        require(_location <= maxSize, "error2");
    ...
    function fetch100Rows(uint256 multiplier) public view returns (bytes32[] memory) {
        bytes32[] memory boardRow = new bytes32[](100);
        for (uint256 i = 0; i < 100; i++) {
            Pixel memory pixel = pixels[i+(multiplier*100)];
