...
contract NftMarketRouter is IERC721ReceiverUpgradeable {
    ...
    event PriceChange(address _collection, uint256 _tokenId, uint256 _oldPrice, uint256 _newPrice);
    ...
    function buyItem(address _collection, uint256 _tokenId) external payable {
        ...
        nftMarket.buyItemByRouter{value: msg.value}(msg.sender, _tokenId);
    }
