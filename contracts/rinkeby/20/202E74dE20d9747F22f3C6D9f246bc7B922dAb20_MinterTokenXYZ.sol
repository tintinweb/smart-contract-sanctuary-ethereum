...
contract MinterTokenXYZ is ERC721, Ownable, Pausable {
    ...
    mapping(uint256 => address) internal _tokenContractMap;
    ...
    constructor (address _interfaceAddress) payable ERC721("MTXYZ", "MinterTokenXYZ") {
        interfaceAddress = _interfaceAddress;
    }

    /**
     * @dev Add individual URI on a per-token basis
     */
     ...
     */
    function viewTokenContract(uint256 tokenId) external view returns(address)
    {
        return _tokenContractMap[tokenId];
    }
    ...
    {   
        ...
        _tokenContractMap[_mintedTokens] = contractAddress;
