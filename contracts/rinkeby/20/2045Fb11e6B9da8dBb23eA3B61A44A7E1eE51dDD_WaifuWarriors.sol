...
/**
 * @title Waifu Warriors ERC-721 Smart Contract
 */

contract WaifuWarriors is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {

    string public WAIFUWARRIORS_PROVENANCE = "";
    string private baseURI;
    uint256 public constant MAX_TOKENS = 3011;
    ...
    constructor() ERC721("Waifu Warriors", "WW") {}
    ...
    */
    ...
    function setProvenanceHash(string memory provenanceHash) external onlyOwner {
        WAIFUWARRIORS_PROVENANCE = provenanceHash;
    }
