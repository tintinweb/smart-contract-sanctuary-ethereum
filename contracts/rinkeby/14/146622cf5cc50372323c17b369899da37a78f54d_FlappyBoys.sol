...
contract FlappyBoys is ERC721A, Ownable {
    ...
    uint256 constant public maxMintPerAddress = 2;
    ...
    constructor() ERC721A("FlappyBoys", "FLAPPYBOYSTEST") {}
    ...
    function mint(uint256 quantity) external payable onlyOwner {
        ...
        require(totalSupply() + quantity <= maxSupply, "Max amount of tokens minted");
