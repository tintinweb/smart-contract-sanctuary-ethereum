...
contract AngrySquirrelClub is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 0.08 ether; //0.08 WL price 0.1 eth public sale
  ...
  uint private reserveNFTs=90;
  bool public _revelNFT = false;
  uint public whitelistSpots=1850;
  ...
  constructor() ERC721A("Angry Squirrel Club","ASC", MaxMintPerBatch_, TotalCollectionSize_) {
