...
contract CatCat369 is ERC721A, Ownable {
    using Strings for uint256;
    ...
    string public hiddenURI="ipfs://QmbRrm9APBQ7g1RbYnAcbkgSPHoV5ZgtQ82UESqLxiWjjA";
    ...
    constructor() ERC721A("CatCat369", "TN") {
...
function whiteListMint(bytes32[] calldata _merkleProof,uint256 count) external payable {
       ...
       bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        ...
        require(whiteList, "Minting is not live yet");
