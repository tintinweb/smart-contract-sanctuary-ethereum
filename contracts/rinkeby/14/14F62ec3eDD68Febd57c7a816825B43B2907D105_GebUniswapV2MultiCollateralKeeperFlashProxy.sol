...
// hevm: flattened sources of /nix/store/w54ffcaff569d68wka1kw3xkx527yc36-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/GebUniswapV2MultiCollateralKeeperFlashProxy.sol
pragma solidity =0.6.7 >=0.5.0 >=0.6.7 >=0.6.7 <0.7.0;

////// /nix/store/w54ffcaff569d68wka1kw3xkx527yc36-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/libraries/CollateralAuctionHouseLibrary.sol
...
////// /nix/store/w54ffcaff569d68wka1kw3xkx527yc36-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v2/interfaces/IUniswapV2Factory.sol
...
////// /nix/store/w54ffcaff569d68wka1kw3xkx527yc36-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v2/interfaces/IUniswapV2Pair.sol
/* pragma solidity ^0.6.7; */
...
////// /nix/store/w54ffcaff569d68wka1kw3xkx527yc36-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/GebUniswapV2MultiCollateralKeeperFlashProxy.sol
/* pragma solidity 0.6.7; */
...
abstract contract AuctionHouseLike_2 {
    ...
    function liquidationEngine() virtual public view returns (LiquidationEngineLike_5);
    function collateralType() virtual public view returns (bytes32);
}

abstract contract SAFEEngineLike_16 {
...
abstract contract CollateralJoinLike_3 {
    ...
    function collateral() virtual public returns (CollateralLike_5);
    function join(address, uint) virtual public payable;
    function exit(address, uint) virtual public;
    function collateralType() virtual public returns (bytes32);
}

abstract contract CoinJoinLike_4 {
    function safeEngine() virtual public returns (SAFEEngineLike_16);
    function systemCoin() virtual public returns (CollateralLike_5);
    function join(address, uint) virtual public payable;
    function exit(address, uint) virtual public;
}

abstract contract CollateralLike_5 {
...
abstract contract LiquidationEngineLike_5 {
    ...
    function safeEngine() view public virtual returns (SAFEEngineLike_16);
...
contract GebUniswapV2MultiCollateralKeeperFlashProxy {
    SAFEEngineLike_16          public safeEngine;
    CollateralLike_5          public weth;
    CollateralLike_5          public coin;
    CoinJoinLike_4            public coinJoin;
    IUniswapV2Pair_2          public uniswapPair;
    IUniswapV2Factory_2       public uniswapFactory;
    LiquidationEngineLike_5   public liquidationEngine;
    ...
    constructor(
        ...
        weth               = CollateralLike_5(wethAddress);
        coin               = CollateralLike_5(systemCoinAddress);
        uniswapFactory     = IUniswapV2Factory_2(uniswapFactoryAddress);
        coinJoin           = CoinJoinLike_4(coinJoinAddress);
        liquidationEngine  = LiquidationEngineLike_5(liquidationEngineAddress);
    ...
    function settleAuction(CollateralJoinLike_3 collateralJoin, uint auctionId) public {
        ...
        uint amountToRaise = CollateralAuctionHouseLibrary.getAmountToRaise(address(auctionHouse), auctionId); //Only compatible with increasing discount auction
