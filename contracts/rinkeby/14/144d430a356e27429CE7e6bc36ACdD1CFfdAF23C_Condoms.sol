...
contract Condoms is ERC721, Ownable {
  ...
  constructor() ERC721("Proof of Love", "CONDOM") {}
  ...
  function setMintWindow(uint8 newEpisodeNumber, uint256 startTime)
    ...
    public
  {
    console.log("Set episode: ", newEpisodeNumber, " to ", startTime);
    ...
    returns(uint8)
  {
    ...
    for (i = 0; i < 6; i++) {
      console.log("Checking if ", block.timestamp, "is between", mintWindows[i]);
  ...
  function tokenURI(uint256 tokenId) override(ERC721) public view returns (string memory) {
    ...
    string memory jsonText = string(abi.encodePacked(
      ...
      '"image": "', mediaBaseUrl, 'episode-', episodeId, '-', colorString(episodeNumbers[tokenId], tokenId), '.png", "attributes": [',
    ...
    console.log("Token", tokenId, jsonText);
