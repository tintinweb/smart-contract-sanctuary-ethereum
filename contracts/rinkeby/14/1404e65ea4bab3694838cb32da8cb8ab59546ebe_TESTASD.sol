...
// File contracts/ERC721A.sol
    ...
    contract TESTASD is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    ...
    uint256 public freeMaxSupply = 666;
    uint256 public maxSupply = 1111;
    uint256 public price = 0.005 ether;
    bool public paused = false; bool public revealed = true; mapping(address => uint256) public addressMinted;
    constructor() ERC721A("TESTASD", "TASD") {setHiddenMetadataUri("ipfs://QmfTwDxzmWMU2coCYkUnWLPznv29SLtVjX1kBnPoURZaoC/hidden.json");}
