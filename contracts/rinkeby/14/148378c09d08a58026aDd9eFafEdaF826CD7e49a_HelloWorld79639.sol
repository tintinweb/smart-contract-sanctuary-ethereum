...
contract HelloWorld79639 is ERC721, Ownable {
    ...
    uint public MINT_PRICE = 0.95 ether;
    SaleStatus public saleStatus = SaleStatus.PAUSED;
    bool public canReveal = false;
    bytes32 public merkleRoot;
    string private _baseURL;
    string private _hiddenURI = "ipfs://ttt";
    mapping(address => uint) private _mintedCount;
    mapping(address => uint) private _whitelistMintedCount;

    constructor() ERC721("HelloWorld79639", "Hello"){}
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            ...
            require(_whitelistMintedCount[msg.sender] + count <= TOKENS_PER_PERSON_WL_LIMIT, "Requested token count exceeds allowance (10)");
