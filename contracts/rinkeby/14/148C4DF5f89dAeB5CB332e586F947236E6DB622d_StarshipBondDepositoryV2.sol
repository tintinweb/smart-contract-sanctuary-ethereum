...
contract StarshipBondDepositoryV2 is IBondDepository, NoteKeeper {
    ...
    constructor(
        ...
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _star, _gstar, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _star.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of STAR due
        ...
        )
    {
         ...
         * price = quote tokens : star (i.e. 42069 DAI : STAR)
         *
         * 1e18 = STAR decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of STAR that the market can sell
        ...
        // purchased, and how much STAR has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // star decimals (9) + price decimals (9)
             ...
             * is 10,000 STAR. max payout would be 1,000 STAR (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in STAR or quote), initial price / STAR (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = star decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 STAR, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 STAR.
         */
        ...
        emit CreateMarket(id_, address(star), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in STAR decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of STAR to be paid in STAR decimals
     *
     * @dev 1e18 = star decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in STAR decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in STAR decimals
     */
...
abstract contract FrontEndRewarder is StarshipAccessControlled {
    ...
    IERC20 internal immutable star; // reward token
...
//    address internal immutable rock; //operator address
    ...
    constructor(IStarshipAuthority _authority, IERC20 _star, ITreasury _treasury) StarshipAccessControlled(_authority) {
        t = _treasury;
        star = _star;
//        rock = 0x3305D042BB7a0f9D21a9fEb0489397CbEBD48ac2;
    ...
    function getReward(uint256 _pct) external {
        ...
        star.transfer(msg.sender,reward);        
