...
contract DogeBall is ERC721, Ownable {
    ...
    function verify(string memory _message, bytes memory _signature, address _address) public returns (bool) {
        ...
        return recover(stringToBytes32(_message), _signature) == _address;
    }
