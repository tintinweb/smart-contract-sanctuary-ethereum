...
contract Testhat is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0x0B52790CfE8aefcea23f74b6EC043B0Ea300b1d4;
    ...
    constructor(string memory _baseURIextended) ERC721("Testhat", "HATR"){
