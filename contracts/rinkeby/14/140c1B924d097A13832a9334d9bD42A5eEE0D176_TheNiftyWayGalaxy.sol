...
contract TheNiftyWayGalaxy is ERC721, ERC721Enumerable, Ownable {
    ...
    // ! Set this before launch
    uint256 public constant MAX_PRESALE_MINT = 15;
    ...
    // ! Set this before launch
    uint256 public constant TEAM_NIFTIES = 150;

    // Numbers of Nifties the team will keep
    // ! Set this before launch
    uint256 private constant AIRDROP_NIFTIES = 15;
    ...
    // ? Should we use only one edditing toggle
    // ? in case of using both base and provenance hash lock checks?
    // ? Function locks
    bool public baseURILock = false;

    // ? Do we need to set provenance hash? We can pass it in the constructor
    bool public provenanceLock = false;
    ...
    */
     ...
     * ? Should get supply in the first line so totalSupply() only gets called once?
     * @param numberOfTokens Number of tokens to be minted.
     */
     ...
     * ? Should provenanceHash be set only in the constructor?
     * @param provenanceHash New provenance hash.
     */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        require(!provenanceLock, "Provenance hash editing is locked.");
        TNWG_PROVENANCE = provenanceHash;
    }
    ...
    function setBaseURI(string memory newBaseURI) public onlyOwner {
        require(!baseURILock, "Base URI editing is locked.");
        baseURI = newBaseURI;
    }

    /**
     * Sets baseURILock and provenanceLock to true.
     */
    function setFunctionLocks() public onlyOwner{
        baseURILock = true;
        provenanceLock = true;
    }
     ...
     * ? Should we change the function name?
     */
    function setSaleFlag(uint optionId) public onlyOwner{
        if(optionId == 0){
     ...
     * ? Should we use the public baseURI variable instead of this function?
     */
