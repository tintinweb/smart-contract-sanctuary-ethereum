    ...
    ERC721Holder
{
    ...
    // Add unique names for each collection
    constructor(
        address originalNFT,
        ...
        // console.log(
        //     "Deploying a CyanWrappedNFT of address: %s, to wrapped address : %s, with cyan vault address : %s",
        //     originalNFT,
        //     address(this),
        //     cyanVaultAddress
        // );
    ...
    function wrap(
        ...
        address to,
        uint256 tokenId
    ) public nonReentrant onlyRole(CYAN_PAYMENT_PLAN_ROLE) {
        // console.log(
        //     "Wrapping nft with tokenid: %s, to: %s, from: %s",
        //     tokenId,
        //     to,
        //     from
        // );
    ...
    function getOriginalNFTAddress() public view returns (address) {
        return _originalNFT;
    }

    function getCyanVaultAddress() public view returns (address) {
