...
contract TESTTESTTEST is ERC721A, Ownable {
    // ======== SUPPLY ========
    uint256 public constant MAX_SUPPLY = 105;
    uint256 public constant TEAM_RESERVED = 100;

    // ======== ROYALTY ========
    address private royaltyAddress = 0xee97D1b9d165Ff3152a4675a83B6F3f16cf9A122; //To update with actual address
    uint96 private royaltyBasisPoints = 1337; //13.37 * 100
    ...
    // ======== CONSTRUCTOR ========
    constructor() ERC721A("TESTTESTTEST", "TTT") {
        setNotRevealedURI("ipfs://QmQYTByy8hYRVKkevXXgPCy6wYd6DNSYbU1uf7CKsyP2NS/hidden.json"); // to update
        _mintERC2309(_msgSender(), TEAM_RESERVED); //Team Mint
    }
    ...
    // ======== MINTING ========
    function allowlistMint(bytes32[] memory _proof)
    external
    mintCompliance {
