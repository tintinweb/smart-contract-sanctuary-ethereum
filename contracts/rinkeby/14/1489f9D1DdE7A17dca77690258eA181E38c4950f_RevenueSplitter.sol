...
contract RevenueSplitter is Context, Ownable, AccessControl {
  ...
  event RegisterCollectionEvent(address indexed); //4d4043e7a371721850e5f172c165a26806afc6f2cc0f2b9dea455666189b6d8b
  event AddPayeeEvent(address indexed,address indexed,uint256); //9bb86ebdaeb25d50091c2c2d099b111750ac4e05fc421a44272d64bbb0ce8ad8

  // Token $$ Events
  event BuyEvent(address indexed,uint256,uint256); //2df3862cf7fc998a063a76deb7d62d101ba25f75f99a593b1f3ccb270403e31b
  event RoyaltyEvent(address indexed,uint256); //bd488fda61aa9abe34b23f2b9eb1217362c895a4c5834751a666303e2ff34911

  // Collaborator $$ Events
  event WithdrawEvent(address indexed,uint256); //d4c8ebb1edf94b410ac317c6c08c76f6e847b74da7370d0545569aedc42cab2a
  event DepositEvent(address indexed,address indexed,uint256); //6e05140b0ffc77e13e865d4ae60db865d74c32ace1a6085fefe599e48cf27484

  // Payout Events
  event SweepEvent(address indexed,address indexed,uint256); //560ca6a65de25b0ee91431b5b080f6d8b5055ff16f5653349ae4e3fc20a201c8
  event PayoutEvent(address indexed,uint256); //c3f74068ac89d452fac60b6d8dea3fb69b0edcc4dfb16bdf98dc5bb03a87544b
