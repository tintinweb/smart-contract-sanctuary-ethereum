...
contract Escrow is Ownable {
  ...
  */
  function deposit(address _payee) public virtual onlyOwner payable {
  ...
  */
  function withdraw(address _payee) public virtual onlyOwner {
...
abstract contract ConditionalEscrow is Escrow {
  ...
  * @param _payee The destination address of the funds.
  */
  function withdrawalAllowed(address _payee) public virtual view returns (bool);

  function withdraw(address _payee) override public {
...
contract RefundEscrow is Ownable, ConditionalEscrow {
   ...
   */
  function deposit(address _refundee) public override payable {
   ...
   */
  function withdrawalAllowed(address _payee) public override view returns (bool) {
 ...
 */
 abstract contract RefundableCrowdsale is FinalizableCrowdsale {
   ...
   */
  function finalization() override internal virtual{
    if (goalReached()) {
      escrow.close();
  ...
  function _forwardFunds()  virtual internal {
    ...
    //  escrow.deposit{value:}{msg{ . value: ...,sender: ... }}
    //  escrow.deposit"{ value:value, sender }"
...
contract DappTokenCrowdsale is Crowdsale,  CappedCrowdsale, TimedCrowdsale, RefundableCrowdsale  {
...
function finalization()  override internal {
    ...
    //   MintableToken _mintableToken = MintableToken(token);
      // Do more stuff....
    //   _mintableToken.finishMinting();mintableToken.finishMinting();
      // Unpause the token
