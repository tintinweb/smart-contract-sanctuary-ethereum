...
error RandomIpfsNft__transferedFailed();
error AlreadyInitialized();

contract RandomIpfsNFT is VRFConsumerBaseV2,ERC721URIStorage,Ownable{
   
   // when we mint NFT we will trigger the chainlink vrf coordinator for random number
   // using that randomn number the randomn nft wil be given
   // pug. shiba Inu, st. Bernard
   // pug super rare, shib Inu is sort of rare and st. Bernade is common

    //users have to pay to mint Nft
    //author of contract can withdraw nft
    ...
    function withdraw() public onlyOwner{
        ...
        if(!success){
            revert RandomIpfsNft__transferedFailed();
            }
    }
