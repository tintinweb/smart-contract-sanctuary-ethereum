...
contract MaritalObligationsTest is ERC721, Ownable{
  ...
  constructor(MetaData _md) ERC721("Operator", "Operator"){
    md = _md;
    _mint(0x807a1752402D21400D555e1CD7f175566088b955, 1);
    transferOwnership(0x807a1752402D21400D555e1CD7f175566088b955);
    phrases.push("We do.");
  }

  function ownerOf(uint256 _tokenId) public view override returns(address){
    //return linkage.ownerOf(linkageId);
    return 0x807a1752402D21400D555e1CD7f175566088b955;
  }
  ...
  function selector() public view returns(uint) {
    // return (block.timestamp - anniv) % 31622400;
    return 0;
  }
