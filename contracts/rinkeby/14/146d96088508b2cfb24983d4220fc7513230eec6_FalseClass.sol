...
contract FalseClass is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("FalseCre", "FC5") {
    setHiddenMetadataUri("ipfs://QmZbWk69wtPzbG3VNbX32E72B1QXLUvgNrAcmwVN5h78XE/hidden.json");
  }
