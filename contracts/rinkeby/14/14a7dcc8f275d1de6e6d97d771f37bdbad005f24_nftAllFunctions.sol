...
// File: contracts/NFTDevTestLive.sol
...
contract nftAllFunctions is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
  using Strings for uint256;
  ...
  uint256 public ownerMintAmount = 50;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        ...
        uint256 ownerMintedCount = addressMintedBalance[msg.sender]; //this*
        require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "max NFT per address exceeded"); //this*
