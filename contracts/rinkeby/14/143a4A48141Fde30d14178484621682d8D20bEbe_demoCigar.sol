...
contract demoCigar is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, ERC721Burnable {
    ...
    string internal baseuri = "https://gateway.pinata.cloud/ipfs/QmUeaq9knGvGdMrX8C8irPhaMwysFNbywEAMbV5jyN4i3E/";
    bool public revealed = false;
    string public notRevealedUri = "ipfs://QmdD58pRUEy7SvEz7y8KBJt7qEvr9oJ59xezKoJLyKqxy7";

    
    constructor() ERC721("DemoCigar", "DCG") {
        NFTPrice = 0.2 ether;                    
        NFTMaxSupply = 1111;        
        mint(5);
    }
    ...
    returns (string memory)
  {
    ...
    function mint(uint256 _countNfts) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(_countNfts <= maxCapPerMint, "Max limit minting per wallet");       
