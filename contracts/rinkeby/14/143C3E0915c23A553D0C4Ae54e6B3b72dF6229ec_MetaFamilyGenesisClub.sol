...
contract MetaFamilyGenesisClub is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint256 private teamReserveQuantity;
    ...
    uint256 public auctionMaxPurchasedQuantityPerTx;
    ...
    constructor() ERC721A("MetaFamilyGenesisClub", "MFGC") {
        // _safeMint(msg.sender, teamReserveQuantity);
    }
    ...
    function _joinFamilyWhiteList(
        ...
        require(remainingQuantity >= quantity, "first whitelist sold out");
        require(
