...
contract McNiftyNFT is ERC721, Ownable, LetsgoNFTBase {
  ...
  string public xname = "McNifty";
  string public xsymbol = "MCNF";
  ...
  constructor() ERC721(xname, xsymbol){
    ...
    url_revealedJSON = "ipfs://XXXXXXX/";
    url_collection = "https://XXXXXXXX/";

    cost_presale = 100000000000000000;
    cost_publicSale = 150000000000000000;

    limit_mintPresale = 3;
    limit_mintPublicSale = 3;
    limit_airdropClaims = 120;
  ...
  function check_whitelist(address _user) private view returns(bool){
    uint8 i = 0;
    while(i < list_whitelistAddresses.length){
        if(_user == list_whitelistAddresses[i]){
            return true;
        }
       i +=1; 
    }
