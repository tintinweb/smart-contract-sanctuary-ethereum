    ...
    Scorekeeper
{
    ...
    constructor( string memory _baseTokenURI, string memory _baseUnrevealedURI) ERC721A("Retro Rollers", "RR") {
    ...
    function setMintPrice(uint _mintPrice) public onlyOperator {
    ...
    function setRollScorePrice(uint64 _price) public onlyOperator {
        rollScorePrice = _price;
    }

    function setRollTokenAddress(address _rollAddress) public onlyOperator {
...
contract MDDA is Ownable {
    ...
    function initializeAuctionData(
        uint256 _DAStartingPrice, // 0.8 ETH
        uint256 _DAEndingPrice, // 0.08 ETH
        uint256 _DADecrement, // 0.02 ETH
        uint256 _DADecrementFrequency, // 10 min
        uint256 _DAStartingTimestamp, // 1651770000 (5/5/2022 @ 1PM EST)
        uint256 _DAMaxQuantity, // 2
        uint256 _DAQuantity // 2188
    ) public onlyOwner {
