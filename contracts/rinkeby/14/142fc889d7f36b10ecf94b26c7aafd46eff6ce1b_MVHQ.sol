    ...
    IERC1155Receiver
{
    ...
    ERC1155 public constant OSSF = ERC1155(0xbC606Ac8AA3cAB2D085ecC1b5ECd2A26c77272FE);
    /// @notice opensea Storefront ERC1155 MVHQ Token ID
    uint256 public constant OSMVHQ_TOKENID = 1;
    ...
    function claimKeys() external isRefunding {
        require(claimActive, "MVHQ: claiming not active");
    ...
    */
    ...
    modifier managed() {
        require(hasRole(MANAGER_ROLE, msg.sender) || hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "MVHQ: not authorized");
        _;
    }
}
