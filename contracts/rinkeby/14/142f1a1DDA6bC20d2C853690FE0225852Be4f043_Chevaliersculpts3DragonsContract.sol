...
//
//      _______ ____  _                                   
//    _/_/__  // __ \| |_________ _____ _____  ____  _____
//   / /  /_ </ / / // / ___/ __ `/ __ `/ __ \/ __ \/ ___/
//  / / ___/ / /_/ // / /  / /_/ / /_/ / /_/ / / / (__  ) 
// / / /____/_____//_/_/   \__,_/\__, /\____/_/ /_/____/  
// |_|           /_/            /____/                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf8f566AA1256959355c81396a50Eff46a1F14D51];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicxnheggjoucmrma6kjv2t54g36nhpoc6e5aqgch4znhwffeyds6y/";
...
// File: contracts/Chevaliersculpts3DragonsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Chevaliersculpts3DragonsContract is RamppERC721A {
    constructor() RamppERC721A("Chevalier sculpts 3Dragons ", "3DR"){}
}
