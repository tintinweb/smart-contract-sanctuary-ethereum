// denote the version of solidity we are using as the version changes frequently.
pragma solidity >=0.7.0 <0.9.0;

import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
import "./base64.sol";

// every code is denoted as contract
contract Kudos is ERC721 {

    // JVK shortform token name allocated to token string
    constructor() ERC721("kudos", "JVK"){

    }
    // mapping is like int where the whole combination act as datatype
    // Kudo[] will get list of kudos
    // allkudos is list of tokens
    ...
    function giveKudos(address who, string memory what, string memory comments) public {
        // global variable msg that etherium populate for you
    ...
    // getKudosAtIndex and getKudosAtLength are always defined together

    function getKudosAtLength(address who) public view returns(uint) {
    ...
    function getKudosAtIndex(address who, uint index) public view returns(string memory, address, string memory) {
        Kudo memory kudo = nfts[allKudos[who][index]];
...
Visualize data structure
    ...
    personA (0xjijkjkj0): [
        {
            what: "Web 3.0",
            giver: personB (0xjdnnkdnkfnds),
            comments: "good job on getting started"
        },
        {
            what: "Web 3.0",
            giver: personC (0xjdnnkdnkfnds),
            comments: "good job on getting started"
        }
    ]
...
2. Step II
    ...
    Query all kudos give from x to y?
    Query all the kudos recieved by Y?
    Query all kudos recieved for CSS?


   // How do we do this in MongoDB
    Kudos --> Document
        {
            who: (index),
            what: "",
