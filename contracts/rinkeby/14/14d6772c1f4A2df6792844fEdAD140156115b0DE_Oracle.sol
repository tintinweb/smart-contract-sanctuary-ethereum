...
interface IOracle {
    function getTargetValue() external view returns(uint256, uint256, uint16);
    function oracleDecimal() external pure returns(uint16);
}
...
contract Oracle is IOracle, Ownable {
    ...
    uint16 public override constant oracleDecimal = 6; 
    ...
    function getTargetValue() external view override returns(uint256, uint256, uint16) {
        return (targetPrice, updatedTime, oracleDecimal);
    }
}