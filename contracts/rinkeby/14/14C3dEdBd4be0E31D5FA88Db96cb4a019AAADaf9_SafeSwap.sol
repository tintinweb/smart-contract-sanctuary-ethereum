...
contract SafeSwap is IERC721Receiver, Ownable {
    ...
    function revokeOffer(uint _index) public payable {
        ...
        offeror.transfer(offer_record[_index].offerEth * 1 ether );
    ...
    function fulfillOffer(uint _index) public payable {
            ...
            offeror.transfer(offer_record[_index].reqEth * 1 ether );
            fulfiller.transfer(offer_record[_index].offerEth * 1 ether );
