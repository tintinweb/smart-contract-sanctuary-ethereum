...
contract PLSP is ERC20, Ownable {
    ...
    uint256 airdropInterval;
    uint256 totalAirdropAmount;
    uint256 totalTokenHolding;
    uint256 currentAirdropUserIndex;
    uint256 totalAirdropUserCount;
    ...
    function transfer(address to, uint256 amount) public override returns (bool) {
        _addToTokenHolders(_msgSender(), to); // Add to token holder list
    ...
    function transferFrom(
        ...
        _addToTokenHolders(from, to); // Add to token holder list
    ...
    function isUserAddress(address addr) public view returns (bool) {
        ...
        if (addr != owner() && addr != potContractAddr && addr != pairAddr) {
            return true;
        }
        return false;
    }
    ...
    function calculatePairAddress() public view returns (address) {
        address factory = uniswapV2FactoryAddr;
    ...
    function _continueAirdrop() internal returns (bool) {
        ...
        for (; i < currentAirdropUserIndex + 150; i++) {
            ...
            uint256 amount = (balanceOf(user) * totalAirdropAmount) / totalTokenHolding;
