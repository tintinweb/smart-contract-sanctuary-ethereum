...
contract KaijuLegends is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    event UpdatePrivateSaleMaxSupply(uint256 supply);
    ...
    /*
     * @notice: Set the new private sale max supply
     * @param: privateSaleMaxSupply_: The max supply for the private sale
     */
    function setPrivateSaleMaxSupply(uint256 privateSaleMaxSupply_)
        external
        onlyTreasuryOrOwner
    {
        privateSaleMaxSupply = privateSaleMaxSupply_;
        emit UpdatePrivateSaleMaxSupply(privateSaleMaxSupply_);
    }
