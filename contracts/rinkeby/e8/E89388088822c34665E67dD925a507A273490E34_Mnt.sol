...
library ErrorCodes {
    ...
    string internal constant EC_ACCOUNT_HAS_NO_AGREEMENT = "E429";
    string internal constant EC_INVALID_PROVIDER_REPRESENTATIVE = "E430";
    string internal constant EC_PROVIDER_CANT_BE_REPRESENTATIVE = "E431";
}
...
contract EmissionCommission is AccessControl {
    ...
    function isAgreementExpired(address account_) external view returns (bool) {
        ...
        return providersAgreement[account_].endBlock <= _getBlockNumber();
    }
