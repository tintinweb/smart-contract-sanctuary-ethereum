...
contract IllogicalLogicDev01 is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
  ...
  struct NType {
   ...
   uint256 public constant maxNtype = 6;  //initial array to support max number of NFT type
   NType[maxNtype] public nTypes;
...
/* Remove the modifier and move the check into the function
...
*/
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof, uint256 _nTypeIndex) public payable {
...
//override tokenURI() as required by ERC721storage
/*
