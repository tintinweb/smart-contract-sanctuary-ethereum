...
contract CryptoVault is Context, IERC20, Ownable {
 ...
 uint256 public reflectFeeSell = 4;
  ...
  address private _marketingWalletAddress = 0x700C20E24df0B577cb5C607d7A1929AB478cF4AD; //Affixed and created dynamically by the smart contract on construction time.
  ...
  constructor() {
    //XXX change address
      address _newOwner = 0x554bdB40d90779608b2Ff6b628A418B131435095;
    _rOwned[_newOwner] = _rTotal;

    IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
      0x12A950F7847257BA4A40880214393552fd47DDeE
