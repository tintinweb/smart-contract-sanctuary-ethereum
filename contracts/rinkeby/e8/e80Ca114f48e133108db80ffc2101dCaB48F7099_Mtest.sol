...
contract Mtest is ERC721, Ownable {
    string private baseURI;
    string public baseExtension = "";
    string public notRevealedUri;
    uint public MaxSupply = 15000;
    uint constant public TxLimit = 20;
    ...
    uint16 public nftPerAddressLimit = 3;
    ...
    function mint(uint _amount, bool _stake) public payable whenNotPaused {
        ...
        require(tokensMinted + _amount <= MaxSupply, "All tokens minted");
        require(_amount > 0 && _amount <= TxLimit, "Invalid mint amount");
        require(_availableTokens.length > 0, "All tokens for this Phase are already sold");
    ...
    function setBank(address _bucks) external onlyOwner {
        bank = IBank(_bucks);
    }
...
//["0x4395acD54A49fFeD19D78805937687A18A3c73A1","0xAF724C6679571DFBAF873F8465E91eBab5e2Cfba","0x7671EA820a85BD9dD23403975dCFBA8A3EAb6F58"]