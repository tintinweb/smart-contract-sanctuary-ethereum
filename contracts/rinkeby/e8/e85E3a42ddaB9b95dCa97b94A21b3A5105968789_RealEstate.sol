...
contract RealEstate is Pausable, Ownable {
    ...
    **************************************************/
    ...
    mapping ( uint => bool ) public DealAccepted;
    ...
    **************************************************/
    ...
    function burn_PROPERTY_TOKEN(uint256 tokenId) public virtual onlyAgency {
        PROPERTY_TOKEN.burn(tokenId);
    }

    function burn_TICKET_TOKEN(uint256 tokenId) public virtual onlyAgency {
        TICKET_TOKEN.burn(tokenId);
    }
