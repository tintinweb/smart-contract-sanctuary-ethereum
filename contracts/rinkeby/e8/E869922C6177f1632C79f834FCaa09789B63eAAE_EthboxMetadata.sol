...
contract EthboxMetadata is Ownable {
    ...
    returns (string memory)
  {
    ...
    if (len > 18) {
      ...
      return string(abi.encodePacked(round.toString(), ".", eRep.toString()));
    } else {
      uint256 diff = 18 - len;
      ...
      return string(abi.encodePacked(padding.toString(), eRep.toString()));
    }
  }
    ...
    return
      string(
        abi.encodePacked(
          ...
          Base64.encode(
            bytes(
              string(abi.encodePacked("<html><body>", svg, "</body></html>"))
            )
          )
        )
      );
  ...
  function buildMetadata(
    ...
    output = string(
      abi.encodePacked(
        ...
        Base64.encode(
          bytes(string(abi.encodePacked("<html><body>", svg, "</body></html>")))
        ),
        '"}'
      )
    );
