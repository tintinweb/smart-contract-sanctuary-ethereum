...
contract NaughtyGiraffes is ERC721A, Ownable {
    ...
    uint256 private _publicStartTime = 1652538600; // Thursday, 14 May 2022 02:30:00 PM GMT (Thursday, May 14, 2022 10:30:00 AM GMT-04:00 DST)
    ...
    uint256 public earlySalePrice = 0.002 ether;
    uint256 public maxEarlysaleSupply = 10;

    // Public Sale Attributes
    uint256 public maxMintPerAddressInPublicsale = 10;
    uint256 public publicSalePrice = 0.003 ether;
    uint256 public maxPublicsaleSupply = 15;
   
    constructor() ERC721A("Naughty Giraffes", "GIRAFFE") {
        _tokenBaseURI = "ipfs://QmQSrhWELz2yao4SdwKCitKZmPmqqpsbL9mgGgCe5PxpwC";
        withdrawalWalletAddress = 0x6201B5f51D3ba9aE95B98BE73717AB53ae05E1D0;
        lazyLionsAddress = 0x63469a444FCB646b282Ed171bb4eAF1afFD625A2;
        smilesssvrsAddress = 0x177EF8787CEb5D4596b6f011df08C86eb84380dC;
    }
    ...
    // Set whitelist contract addresses to verify
    function setWhitelistContractAddress(address[] calldata _whitelistAddress) external onlyOwner {
        lazyLionsAddress = _whitelistAddress[0];
        smilesssvrsAddress = _whitelistAddress[1];
    }

    // Owner mint
    function ownerMint() external onlyOwner {
        uint256 _numOfTokensToMint = 10;
        _safeMint(msg.sender, _numOfTokensToMint);
    }
