...
//     constructor() ERC721("KwikTrust", "KWT") {
//         setURI("ipfs://QmcdP9oQLRioFkgAF8MeapB61CpFJW86o3zNgra6ZyrMsZ/");
//     }
...
//     function bulkMint(address _to, uint256[] memory _ids) external {
...
//     function singleMint(address _to, uint256 length) external {
//         for (uint256 i = 0; i < length; i++) {
//             _mint(_to, tokenId);
//             tokenId += 1;
//         }
...
//     constructor() ERC721("F-Land Metaverse", "FLN") {
//     }
...
//     function Bmint(address _to, string memory _tokenUri) external returns (uint256)
//     {
...
//     function bulkMint( uint256[] memory _ids) external {
//         uint256 length = _ids.length;
...
//     if(revealed == false)
//     {
//        return string(abi.encodePacked(currentBaseURI, "ipfs://QmfBBAZ1A3DVWzApF4ezeCmzP6mVoYLcUBGJFoKLkHf6zp"));
//     }
...
contract Mint is ERC721URIStorage, Ownable, EIP712 {
        ...
        returns (address)
    {
        bytes32 digest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("LazyNFTVoucher(string uri)"),
    ...
    function safeMint(LazyNFTVoucher calldata voucher) public payable {
        ...
        tokenId++;
        _safeMint(msg.sender, tokenId);
        _setTokenURI(tokenId, voucher.name);
    }
}
