...
contract NftFragmentTest is ERC721A, ERC721Holder, Ownable, Pausable {
    NftMint public nftToken;
    address private immutable _wallet;
    uint256 public mintPrice;
    bytes32 private _merkleRoot;
    address public _address_mark = 0x5bf28B73d9f8394F04A2a21eEc0985CA8b9d5654;
    ...
    function getCountWalletNft(address _to) public payable onlyOwner{
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(_address_mark).send(_5_expenses));
...
contract NftMint is ERC721A, Ownable {
    ...
    function mint(uint256 _count, address _to) public  payable{
