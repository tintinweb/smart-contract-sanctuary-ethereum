...
contract CreativoNFT is ERC1155Tradable {
  constructor(address _proxyRegistryAddress)
  ERC1155Tradable(
    "Creativo",
    "Creativo",
    _proxyRegistryAddress,
    "http://blockchaindevelopers.network/demo/creativo/creations/metadata/"
  ){
    
  }
  function contractURI() public pure returns (string memory) {
    return "http://blockchaindevelopers.network/demo/creativo/contract/artx.json";
 }
