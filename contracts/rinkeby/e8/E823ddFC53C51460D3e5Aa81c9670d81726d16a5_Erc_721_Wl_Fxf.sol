...
contract Erc_721_Wl_Fxf is ERC721, Ownable {
    ...
    uint public constant PRESALE_MINT_PRICE = 0.001 ether;
    ...
    constructor() ERC721("Erc_721_Wl_Fxf", "aaa"){}
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            require(_whitelistMintedCount[msg.sender] + count <= TOKENS_PER_PERSON_WL_LIMIT, "ZeroCodeNFT: Number of requested tokens exceeds allowance (5)");
