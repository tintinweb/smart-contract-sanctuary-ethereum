...
contract pCNV is ERC20, Owned {
    ...
    uint256 public constant MAX_SUPPLY = 33300000000000000000000000;
    ...
    constructor(address _CNV)
        ...
        Owned(0x9D588E7A18b1c7354066617e89326607988364A7)
    {
        CNV = _CNV;
    }
    ...
    function mintBatch(address[] memory tos, uint256[] memory amounts)
        external
        onlyOwner
    {
        uint256 length = tos.length;
        require(length == amounts.length, "INVALID_LENGTH");
    ...
    function redeem(
        ...
        // Mint CNV
        if (amountOut > 0) ICNV(CNV).mint(_to, amountOut);
