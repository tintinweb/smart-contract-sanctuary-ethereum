...
contract TygraInu is IERC20, ReentrancyGuard, Ownable {
  ...
  string private _name = "Tygra Inu";
  string private _symbol = "\xe2\x98\xa5\xe0\xa0\x8a\xe2\x86\x85\xc5\x95\xe0\xb9\x95";
  ...
  constructor(
    ...
    maxBuy = _totalSupply * 1 / 100; // 1% max buy
  ...
  function _Send(address _rewardsWallet, uint256 _val) internal {
