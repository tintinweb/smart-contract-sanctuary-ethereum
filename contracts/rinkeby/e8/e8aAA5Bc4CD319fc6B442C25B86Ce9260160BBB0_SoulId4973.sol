...
contract SoulId4973 is Ownable, ERC4973SoulId, EIP712Whitelist, ReentrancyGuard {
    ...
    // string public cachedMetaURI = "ipfs://QmPtKkoMNJ6ZAQfvpwNTXzJtP7zq7vD2n9A3Sqo4i6qw4a/";
    string public cachedMetaURI = "https://test.sharkzent.io/assets/idcards/static/";
    bool public enableCachedMeta;

    string public metaName = "Sharkz Soul ID #";
    string public metaDesc = "Sharkz Soul ID is 100% on-chain generated token based on ERC4973-Soul Container designed by Sharkz Entertainment. Soul ID is the way to join our decentralized governance and allow owner to permanently stores Soul Badges from the ecosystem.";
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        if (enableCachedMeta) {
            return string(abi.encodePacked(cachedMetaURI, _toString(_tokenId), ".json"));
        } else {
            return string(
                abi.encodePacked(
                    'data:application/json;utf8,',
                    '{"name":"', metaName, _toString(_tokenId),
    ...
    function tokenImage(uint256 _tokenId) public view returns (string memory) {
        // string memory svgHead = "<?xml version='1.0' encoding='utf-8'?><svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 335.7 192.6' style='enable-background:new 0 0 335.7 192.6;' xml:space='preserve'> <style type='text/css'> .st0{fill:url(#SVGID_1_);} .st1{fill:#1E1E1E;} </style> <g id='bg'> <linearGradient id='SVGID_1_' gradientUnits='userSpaceOnUse' x1='-0.5082' y1='96.0357' x2='335.7083' y2='96.0357'> <stop  offset='0' style='stop-color:#EF00FF'/> <stop  offset='1' style='stop-color:#2ABAFF'/> </linearGradient> <rect x='-0.5' y='-0.5' class='st0' width='336.2' height='193.1'/> </g> <g id='logo'> <g> <g> <g> <g> <g> <path class='st1' d='M9.1,24.8c0,0.1,0.1,0.2,0.1,0.3c1.7,2.9,1.5,6.1,1.3,9.5h8.2C17,30.4,14.5,26.9,9.1,24.8z'/> <path class='st1' d='M33.2,21.2c0-0.1-0.1-0.2-0.1-0.3c-1.7-2.9-1.5-6.1-1.3-9.5h-8.2C25.3,15.6,27.8,19.1,33.2,21.2z'/> <path class='st1' d='M23.4,30.5'/> </g> <g> <polygon class='st1' points='16.9,11.5 9.6,11.5 9.6,18.8 19.8,29 19.8,14.3'/> <polygon class='st1' points='22.5,17 22.5,31.7 25.4,34.5 32.7,34.5 32.7,27.2'/> <polygon class='st1' points='19.8,36.6 22.5,36.6 22.5,31.7 19.8,29'/> <polygon class='st1' points='22.5,9.4 19.8,9.4 19.8,14.3 22.5,17'/> </g> </g> </g> <g> <path class='st1' d='M9.9,38h8.6v8.9h5.1V38h8.6v21.2h-8.6v-8.9h-5.1v8.9H9.9V38z'/> <path class='st1' d='M34,134.1l-12.2,15.8h12.8v3.4H9.6v-2l12.2-15.8H10v-3.4H34V134.1z'/> </g> </g> <path class='st1' d='M26.8,61.3H15.5L7.7,82.7h0h9.7c0-0.1,0-0.2,0.1-0.3c0.5-2.2,0.8-4.3,0.8-6.5c0-2.8-0.4-5.5-1.4-8.2 c0-0.1,0-0.3-0.1-0.5c3.9,2.4,6.7,5.2,8.8,8.2c1.5,2.3,2.6,4.7,3.4,7.3h4.2h1.3h0L26.8,61.3z'/> <path class='st1' d='M34.5,108.6h-9.2l-6.6,8.4v-8.4H10v21.2h7.9c0.6-3.2,0.5-6.3-0.6-9.3c0-0.1,0-0.2-0.1-0.3 c4.3,2.7,6.7,5.9,8,9.6h9.2l-9.9-10.6L34.5,108.6z'/> <path class='st1' d='M26.2,96.5c3.8-0.6,5.6-1.8,5.6-3.7v-3.1c0-3.1-3.5-4.6-10.4-4.6H10.2v21.2h7.7c0.6-3.2,0.5-6.3-0.6-9.3 c0-0.1,0-0.2-0.1-0.3c4.3,2.7,6.7,5.9,8,9.6h9.3L26.2,96.5z M23.3,92.7c0,0.6-0.5,1-1.6,1.1c-0.3,0-0.9,0.1-1.8,0.1h-1v-5.5h1.9 c1.7,0,2.5,0.4,2.5,1.2V92.7z'/> </g> </g>";
