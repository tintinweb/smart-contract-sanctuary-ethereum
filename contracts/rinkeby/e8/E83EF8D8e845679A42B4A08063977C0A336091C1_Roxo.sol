...
contract Roxo is ERC20,Ownable {
    ...
    uint256 public basePrice = 50000000000000;//should be this 0.0000700/70000000000000  Presale Base Price 
    address public usd = 0x11AB326f4D24Ee219DB119a4009FB44F64Fa2914;
    uint256 preSaleAmount = 200000000000 * 10 ** decimals();
    uint256 public investmentSecurityPercentage = 70;//by default 70%
    mapping(address => uint256) public _sercureBalances;
   
    event buyToken (uint256 fiatAmount,address user,uint256 tokenAmount);
    event sellToken (uint256 fiatAmount,address user,uint256 tokenAmount);



 constructor() ERC20("ROXO", "ROXO") {
        _mint(_msgSender(), 1000000000000 * 10 ** decimals());//One trillion Supply...
        super._transfer(_msgSender(),address(this),preSaleAmount);
    }
...
//_amount requires a usdt not a roxo
