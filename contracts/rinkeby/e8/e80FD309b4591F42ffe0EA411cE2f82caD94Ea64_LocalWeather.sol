...
contract LocalWeather is ERC721Enumerable, Ownable {
    ...
    uint16 public constant basicNFTs = 18000;
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        nftId = 1; // item 1-18000
        reservedNFTsId = basicNFTs + 1; // item 18001-18888
    }
    ...
    function mint(
        ...
        require(nftId + amount <= basicNFTs, "Mint limit reached");
