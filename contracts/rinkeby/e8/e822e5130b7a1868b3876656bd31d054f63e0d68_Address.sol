...
contract Test is ERC721, Ownable {
    ...
    constructor(string memory tokenURI_, string memory contractURI_) ERC721("Test", "Tst") {
        _tokenURI = tokenURI_;
        _contractURI = contractURI_;
    }

    modifier noContracts() {
        require(msg.sender == tx.origin, "Contract access restricted");
        _;
    }

    function publicMint() external payable noContracts {
    ...
    function whitelistMint() public payable noContracts {
        uint256 tokenIndex = _tokenIdCounter.current() + 1;
    ...
    function renewToken(uint _tokenId) public payable noContracts {
