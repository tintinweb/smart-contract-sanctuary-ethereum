...
contract ShibaNft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("MAD SHIBAS", "SHIBA") {
    setHiddenMetadataUri("ipfs://QmeSvXojXGpm1DhEQh6Hvef3abpTC6dXavcuC7dSvxtgm2/hidden.json");
  }
