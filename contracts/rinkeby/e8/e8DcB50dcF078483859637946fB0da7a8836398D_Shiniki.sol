    ...
    AcceptedTokenList
{
    ...
    function preSaleMint(
        ...
        require(price != 0, "Shiniki: price preSale not set");
        require(isTokenAccepted(token), "Shiniki: token payment not accept");
        require(
            isInWhiteList(msg.sender),
            "Shiniki: caller is not whiteList"
        );
        require(
    ...
    function privateMint(uint256 quantity) public onlyOwner {
        ...
        if (startIndexTYPE_2 == collectionSize / 2) {
            startIndexTYPE_2 = (collectionSize - quantity) / 2;
            currentIndex[TYPE_2] = startIndexTYPE_2;
        }
    ...
    function setPublicSaleConfig(
        ...
        saleConfig.publicSaleKey = _publicSaleKey;
        for (uint256 i = 0; i < _tokens.length; i++) {
            require(
                isTokenAccepted(_tokens[i]),
                "Shiniki: tokens is not accept"
