...
contract BidPixels1155 is Initializable,BEP1155Upgradeable, OwnableUpgradeable, BEP1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        BEP1155Upgradeable.__BEP1155_init("", "BidPixels NFT Marketplace", "BPXNFTM");
        __Ownable_init();
        _tid = 1;
    ...
    function mint(uint256 id_, uint256 value, uint256 nooftoken, uint256 royal, string memory ipfsmetadata) public {
        if(id_ == 0){
          _tid = _tid.add(1);
