...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Titas", "Paralamas do sucesso", "Ira", "Capital Inicial", "Camias de Venus", "Engenheiros do Hawai"];
  string[] secondWords = ["Cafe", "Pao de queijo", "Rocambole", "Goiabada", "Doce de Leite", "Queijo"];
  string[] thirdWords = ["Praca do Papa", "Parque das Mangabeiras", "Praca Raul Soares", "Praca Sete", "Parque Municipal", "Praca da Liberdade"];
