...
constructor(address initialRoyaltiesReceiver) ERC721("UNHUMAN COMPOSITIONS", "UNHMN") {
        _royaltiesReceiver = initialRoyaltiesReceiver;
        cupcakeBalances[address(this)] = 777;
    ...
    require(cupcakeBalances[address(this)] >= 1, "Not enough art in stock to complete this purchase");
    _safeMint(msg.sender, 777-cupcakeBalances[address(this)]);
    _setTokenURI(777-cupcakeBalances[address(this)], _uri);
    cupcakeBalances[address(this)] -= 1;
    cupcakeBalances[msg.sender] += 1;
    }

    function withdraw(uint amount) onlyOwner private returns(bool) {
