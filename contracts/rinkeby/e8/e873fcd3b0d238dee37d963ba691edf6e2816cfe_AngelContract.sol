...
// File: contracts/AngelContract.sol
...
contract AngelContract is ERC721, Ownable {
  ...
  constructor() ERC721("Angel", "AAA") {
    setHiddenMetadataUri("ipfs://QmZBTayZjWRvrC8qDbet94yjSR6SmmxtArqf2UHtYj4qpY/hidden.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(saleActive, "The contract is saleActive!");
  ...
  function mintGiveaway(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
  ...
  function editGiveaway(address[] calldata giveawayAddresses) external onlyOwner {
    for(uint256 i; i < giveawayAddresses.length; i++){
        giveawayList[giveawayAddresses[i]] = 1;
    }
  }
    
  function editGiveawaySingle(address[] calldata giveawayAddresses, uint256 amount) external onlyOwner {
    for(uint256 i; i < giveawayAddresses.length; i++){
  ...
  // This finds the token IDs of the owner when requested
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x47d08E1a3091194EB812fB3c393f4f5aD4459cD9).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
