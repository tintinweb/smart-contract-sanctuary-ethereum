...
contract ScopxWarrior is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  uint256 public cost = 0.0005 ether;
  string public baseURI = "https://ipfs.io/ipfs/bafybeic4dtvxvhjnp633x5wzboegmgq5kyg4imunusuw5lruu2kmxri7ai/";
  uint256 public maxMintAmount = 10;
  uint256[30]  mintedID = [uint256(951) ,952,953,954,955,956,957,958,959,960,961,962,963,964,965,966,967,968,969,970,971,972,973,974,975,976,977,978,979,980];

  constructor() 
    ERC721("ScopxWarrior", "SPXW")
