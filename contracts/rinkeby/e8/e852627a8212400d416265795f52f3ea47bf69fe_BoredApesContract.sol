...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC6eD210E8A584a3653FDB9aA7f353397B540Cb3A];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 200, 5000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "http://ipfs.io/ipfs/QmUHX8dYDem92p8oiHuhP449FQJyFLgpckGHaxq73bDxUt/";
...
// File: contracts/BoredApesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredApesContract is RamppERC721A {
    constructor() RamppERC721A("Bored Apes", "APE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/pY293n8ickHsHF5R9yNM/contract-metadata";
    }
}
