...
contract Vesting is Ownable, Pausable {
    ...
    uint256 constant dayForTest = 48;
    uint256 constant monthForTest = 48 * 30;
    uint256 constant dayForTest120 = 120;
    uint256 constant monthForTest120 = 120 * 30;
    ...
    function deposit(
        ...
        // uint256 totalRound = scheme.vestingDuration / monthForTest120;
        require(
            scheme.schemeType == SchemeType.member,
    ...
    function claim(uint256 subscriptionID) external whenNotPaused {
        ...
        if (scheme.schemeType == SchemeType.investor) {
            ...
            // subscription.nextTimeClaim += dayForTest120;
        ...
        returns (uint256 currentTotalDays)
    {
        ...
        // currentTotalDays = (endTime - nowTime) / dayForTest120 + 1;
    }
