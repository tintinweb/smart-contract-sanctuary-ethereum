...
contract z2 is ERC721A, ERC2981ContractWideRoyalties, RrpRequesterV0, Ownable, ReentrancyGuard {
    ...
    constructor(address _airnodeRrp) RrpRequesterV0(_airnodeRrp) ERC721A("Z2", "Z2") {}
    ...
    function isWinner(uint256 tokenId) external view returns (bool) {
      ...
      (win,a,b,c,d,e) = getRStats(tokenId);
      return win;
    }
