...
contract BeardedBuddies is 
    ...
    VRFConsumerBaseV2 {
        ...
        /** Events **/
        event BeardedBuddyGenerated(uint256 _requestbeardedBuddyId);
        event ethWithdrawn();
        ...
        */
        function fulfillRandomWords(    
            ...
            newTokenURI = string.concat("/",newTokenURI);
        ...
        */
        ...
        /**
        * Edit CallbackGasLimit for VRFV2
        * @notice             sends Ether from the NFT contract to the Multi-Sig Wallet
        */
        function editCallbackGasLimit(uint32 _newLimit) public onlyOwner {
