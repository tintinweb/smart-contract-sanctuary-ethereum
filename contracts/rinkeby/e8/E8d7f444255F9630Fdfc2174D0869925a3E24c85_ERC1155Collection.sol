...
contract ERC1155Collection is ERC1155, Ownable, Pausable, ERC1155Burnable {
    ...
    function mint(string memory tokenCID, uint256 amount, bytes calldata data)
        public
    ...
    function mintBatch(string[] memory tokenCIDs, uint256[] memory amounts, bytes calldata data)
        public
        onlyOwner
    {
