...
contract AsciiCyberKongz12 is ERC721A, Ownable, ReentrancyGuard {
  ...
  mapping(uint256 => uint256) public whiteListParentTokenIdClaimedCount;
  ...
  uint256 public maxTokenIdWhitelisted;
  ...
  function whitelistMint(uint256 _mintAmount, uint256 nftTokenIdWhitelisted) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    // Verify whitelist requirements
    require(whitelistMintEnabled, 'The whitelist sale is not enabled!');
    require(allowMultipleWhitelistMints || whiteListParentTokenIdClaimedCount[nftTokenIdWhitelisted]<maxMintPerWhiteListTokenId, 'NFT whitelisted already claimed, you reached the maximum mints allowed!');
    require(nftTokenIdWhitelisted>0 && nftTokenIdWhitelisted <= maxTokenIdWhitelisted, 'NFT Token is not Whitelisted');
    require(contractWhiteListAddress != address(0), 'Address of White List Contract is not set');
    ...
    whiteListParentTokenIdClaimedCount[nftTokenIdWhitelisted] = whiteListParentTokenIdClaimedCount[nftTokenIdWhitelisted] + 1;
