 ...
 */
contract NFTRoyalty is ReentrancyGuard {

  mapping(bytes32 => Offer) public offers;

  // https://royaltyregistry.xyz/lookup   Rinkeby
  IRoyaltyEngineV1 royaltyEngine = IRoyaltyEngineV1(0x8d17687ea9a6bb6efA24ec11DcFab01661b2ddcd);
  ...
  function buyNft(bytes32 offerHash) public payable nonReentrant {
    ...
    (address payable[] memory recipients, uint256[] memory amounts) =
      royaltyEngine.getRoyalty(address(offer.collection), offer.token_id, msg.value);
