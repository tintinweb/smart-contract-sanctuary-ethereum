...
contract VINYL is ERC1155PackedBalance, Ownable, ReentrancyGuard {
  ...
  */
  function mint(address to, uint mint_type) internal {
    ...
    // @SRB possible to move those  two mem allocs 
    // after first if to prevent instantiation of unnecessary ressources, case optimization

    // @SRB change from memory to storage to reduce gas
    // @SRB TODO calculate how much
  ...
  */
  // @SRB modifier seems unnecessary, since burn function does not use any external calls
  ...
  */
    ...
    public pure returns (uint256)
  {
    ...
    internal
    {
        ...
        // @SRB if we exclude SCs from minting,
        // @SRB we could remove this following part to save gas
        // and eliminate reentrancy
        // @SRB TODO calculate how much
