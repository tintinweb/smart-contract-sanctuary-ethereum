...
abstract contract ScotchBeneficiary is Ownable {
  ...
  // safe Approve for ERC-20 Token

  function safeApproveERC20(address tokenContract, address spender, uint256 amount) public {

    IERC20 hostTokenContract = IERC20(tokenContract);

    hostTokenContract.safeApprove(spender, amount);
