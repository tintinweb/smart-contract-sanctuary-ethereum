...
contract CoinPlants is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        mintToOwner(treasury_wallet, 5);
        mintToOwner(mavrek_wallet, 10);
        mintToOwner(cas_wallet, 10);
        mintToOwner(wuavo_wallet, 3);
         

    }

	address private mavrek_wallet = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    address private cas_wallet = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;
    address private treasury_wallet = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db;
    address private wuavo_wallet =  0xB28420176c240f0fa7C4Ce77F54aA65889373a1D;
   ...
   mapping(address => bool) public whitelistedAddress;
    function mint(uint256 _mintAmount) public payable {
        ...
        if (onlyWhitelisted == true) {
            require(whitelistedAddress[user],"User is not Whitelisted");
            require(_mintAmount > 0 && amountAddressMinted[user] + _mintAmount <= presaleMaxMintAmount,"Invalid Mint Amount");
            require(msg.value >= presaleCost *_mintAmount, "Not Enough ETH");
