...
// @title: SpartanClub.sol



contract spartanwarriorclub is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public tier3Price = 0.13 ether;
    uint256 public tier2Price = 0.14 ether;
    uint256 public tier1Price = 0.16 ether;
    uint256 public totalSupply;
    uint256 public MINT_CAP = 10;
    address public dev = 0xA1C524F667Db0879Eec3dF53beB0cD6903232dF5; //address to withdraw to test dev
    ...
    constructor(string memory _baseuri) ERC721("Spartan Warrior Club", "SWC") {
        // Base IPFS URI of the Baller Bears
        baseUri = _baseuri;   
        totalSupply = 0;     
    }

    function _mintSpartan(uint256 num) internal returns (bool) {
    ...
    function presaleSpartan(uint256 num) public payable returns (bool) {
        ...
        return _mintSpartan(num);
    }

    function publicsaleSpartan(uint256 num) public payable returns (bool) {
        uint256 currentSupply = totalSupply;
