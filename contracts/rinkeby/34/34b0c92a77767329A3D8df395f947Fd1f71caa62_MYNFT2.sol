...
contract MYNFT2 is ERC721URIStorage,ERC721Burnable,Ownable{
    ...
    function nftMint() public onlyOwner{
        ...
        string memory uri = string(abi.encodePacked('metadata',Strings.toString(newTokenId),'.json'));

        _setTokenURI(newTokenId,uri);
        emit TokenURIChanged(_msgSender(),newTokenId,uri);
    }
    function _baseURI() internal pure override returns(string memory){
        return "ipfs://bafkreidxzrg4uhuocn6h653tx2mcufdsg7vmdlxmbrkj5cyj6ufxwiyw7u/";
    }
