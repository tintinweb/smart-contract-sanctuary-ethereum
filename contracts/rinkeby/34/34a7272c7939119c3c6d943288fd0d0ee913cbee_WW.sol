...
contract WW is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public publicCost = 0.0059 ether;
    uint16 public maxSupply = 5555;
    uint256 private allowListLimit = 1111;
    uint256 allowlistCounter = 0;
    ...
    constructor() ERC721A("WW", "WW") {
        _mintERC2309(0xF4A265aE0845e903D155d3B4dB18cA6465049af2, 44);
    }
