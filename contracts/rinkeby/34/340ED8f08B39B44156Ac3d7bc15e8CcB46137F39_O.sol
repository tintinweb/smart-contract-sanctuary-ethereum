...
contract O is ERC721A, Ownable {
  ...
  address founder2 = 0x9A69D9343a136478BbEFD6255D01B85b210EE7fb;
  address founder3 = 0x9A69D9343a136478BbEFD6255D01B85b210EE7fb;
  address founder4 = 0x9A69D9343a136478BbEFD6255D01B85b210EE7fb;
  address founder5 = 0x9A69D9343a136478BbEFD6255D01B85b210EE7fb;
  ...
  function withdraw() external payable onlyOwner {
    uint256 treasuryAmount = address(this).balance / 2;
    uint256 founderAmount = (address(this).balance / 2) / 5;
    payable(treasuryWallet).transfer(treasuryAmount);
    payable(founder1).transfer(founderAmount);
    payable(founder2).transfer(founderAmount);
    payable(founder3).transfer(founderAmount);
    payable(founder4).transfer(founderAmount);
    payable(founder5).transfer(founderAmount);
  }
}
