...
contract PizzaCorner is ERC721A, Owned {
    ...
    address private _ownerWallet = 0x33380f6dCedeb824Db60ca320b1405bA86a4F49d;

    string public baseURI = "ipfs://QmdKNvyVdEW2d9nXoBWMx62Q5ESparkVgwMZDm2M3nzuLm/";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI_).length > 0 ? string(abi.encodePacked(baseURI, tokenId, ".json")) : "";
            ...
            return string(abi.encodePacked(baseURI_, "metadata.json"));
        }
    }
