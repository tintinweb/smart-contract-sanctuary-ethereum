...
contract Humanians is ERC721A, Payable {
    ...
    constructor() ERC721A("The Humanians", "HUMAN") {}
     ...
     */
    function diamondSince(uint256 tokenId) public view returns (uint256) {
...
contract Payable is Ownable, ERC2981, ReentrancyGuard {
    ...
    constructor() {
        ...
        // Payees
        _addPayee(0x0000000000000000000000000000000000000002, 50); // Team
        _addPayee(0x0000000000000000000000000000000000000003, 20); // Charity
        _addPayee(communityAddr, 15); // Community
        _addPayee(0x0000000000000000000000000000000000000004, 10); // Artist
        _addPayee(0x0000000000000000000000000000000000000005, 5); // Marketing
    }
