...
// File contracts/ui/interfaces/IUiPoolDataProviderV3.sol
...
// File contracts/interfaces/IOmniOracle.sol
...
// File contracts/interfaces/ICollaterizableERC721.sol
 ...
 **/
interface INToken is IERC721Enumerable, IInitializableNToken, IERC721Receiver {
    /**
     * @dev Emitted during the transfer action
     * @param from The user whose tokens are being transferred
     * @param to The recipient
...
// File contracts/ui/UiPoolDataProviderV3.sol
...
contract UiPoolDataProviderV3 is IUiPoolDataProviderV3 {
    ...
    // user owns BAYC #1, #5, #10
    //      owns PUNK #55, #77

    // user supply BAYC #1 and sets the collateral as true
    // user supply BAYC #10 and sets the collateral as false
    // user supply PUNK #77 and sets the collateral as true

    // getNTokenData(user.address, [nBAYC.address, nPUNK.address], [[1,5,10], [55, 77]]) =>
