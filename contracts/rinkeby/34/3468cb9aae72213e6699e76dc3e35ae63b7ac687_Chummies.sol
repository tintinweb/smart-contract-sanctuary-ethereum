...
contract Chummies is ERC721A, Ownable {
    ...
    constructor(address _happyKoalas) ERC721A("Koalaverse: Chummies", "CHUMMIES") {
        ...
        _mint(address(this), 369); // small batch size not needed
        _mint(founderAddr, 100);
        _mint(0x02Ae0F5625A383bb4094257e2feC80D849167aAD, 100); // FF9
    ...
    */
    ...
    address public  frontendDev   =   0x4E9f7618F72F3d497f4e252eBB6a731d715e7af5; // TODO : CHANGE TO YOURS
