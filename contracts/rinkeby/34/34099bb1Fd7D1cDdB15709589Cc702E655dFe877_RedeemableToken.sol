...
contract RedeemableToken is ERC1155, Ownable, ERC1155Burnable {    
    constructor() ERC1155("") {
        ...
        cloneWearableIds[0x31] = [5, 11];
        cloneWearableIds[0x32] = [12, 19];
        cloneWearableIds[0x33] = [20, 27];
        cloneWearableIds[0x34] = [28, 35];
        cloneWearableIds[0x35] = [36, 43];
        cloneWearableIds[0x36] = [44, 51];
        cloneWearableIds[0x37] = [52, 59];
        cloneWearableIds[0x38] = [60, 67];
    }
    ...
    function redeemBatch(address owner, address initialCollection, uint256[] calldata cloneXIds, uint256[] calldata wearableIds, uint256[] calldata amount) public payable {
        ...
        for(uint256 i = 0; i < cloneXIds.length; ++i) {
            ...
            if(wearableIds[i] >= 5 && wearableIds[i] <= 11) require(dna == 0x31, "Mismatch of wearable ID for Human DNA");
            else if(wearableIds[i] >= 12 && wearableIds[i] <= 19) require(dna == 0x32, "Mismatch of wearable ID for Robot DNA");
            else if(wearableIds[i] >= 20 && wearableIds[i] <= 27) require(dna == 0x33, "Mismatch of wearable ID for Demon DNA");
            else if(wearableIds[i] >= 28 && wearableIds[i] <= 35) require(dna == 0x34, "Mismatch of wearable ID for Angel DNA");
            else if(wearableIds[i] >= 36 && wearableIds[i] <= 43) require(dna == 0x35, "Mismatch of wearable ID for Reptile DNA");
            else if(wearableIds[i] >= 44 && wearableIds[i] <= 51) require(dna == 0x36, "Mismatch of wearable ID for Undead DNA");
            else if(wearableIds[i] >= 52 && wearableIds[i] <= 59) require(dna == 0x37, "Mismatch of wearable ID for Alien DNA");
            else if(wearableIds[i] >= 60 && wearableIds[i] <= 67) require(dna == 0x38, "Mismatch of wearable ID for Murakami DNA");
            else if(wearableIds[i] >= 68 && wearableIds[i] <= 72) require(isMurakamiDrip, "Mismatch of wearable ID for DRIP");

            // Check avail quantity 
            if(wearableIds[i] >= 1 && wearableIds[i] <= 4) require(wearableSupply[cloneXIds[i]][wearableIds[i]] + amount[i] <= 1, "Can't redeem more");
