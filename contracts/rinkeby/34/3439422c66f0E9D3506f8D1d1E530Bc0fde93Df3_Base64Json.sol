...
contract Base64Json is ERC721Enumerable
{
	struct Card {
		string beast;
		string action;
	...
	function tokenURI(uint256 tokenId) public view override returns(string memory) {
		...
		string memory json = string.concat(
			'{"name":"PureJson","description":"practicing to return a base64 encoded json string from the tokenURI method call","external_url":"https://austingriffith.com/portfolio/paintings/","image": "https://austingriffith.com/images/paintings/',
			card.beast,
