...
contract BasicFunctions {
    ...
    // function (string memory _variable1, int _variable) public view/pure returns(bool) {}
    ...
    // that users a for loop and multiplies params and string comparsion
