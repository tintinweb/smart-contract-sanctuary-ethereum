...
contract fartingpenguins is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("farting penguins", "FP") {
    setHiddenMetadataUri("https://cp1.awardspace.net/file-manager/www/metatest2/.json");
  }
