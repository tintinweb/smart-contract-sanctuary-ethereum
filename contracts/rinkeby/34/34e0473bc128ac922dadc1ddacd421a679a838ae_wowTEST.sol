...
contract wowTEST is ERC721, Ownable
{
    using Strings for uint256;
    ...
    function tokenURI(uint256 tId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tId.toString(),".json")) : "";
    }
}