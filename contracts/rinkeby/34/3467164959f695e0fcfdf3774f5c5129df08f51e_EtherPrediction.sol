...
contract EtherPrediction {
    ...
    function getDetails() public view returns (AggregatorV3Interface, Bet memory, int, int, uint, uint, bool){
        return(priceFeed, total, fetchedPrice, targetPrice, targetTime, deadline, obtainedPrice);
    }
