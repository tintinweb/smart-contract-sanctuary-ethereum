...
contract StakingMetaSkeletonForToken is Ownable {
    ...
    constructor(){
      stakingNft = IERC721(0xB99f9F3897E2B1339e360ED4b1Ab5A9E52BD8F09);
      rewardingToken = IERC20(0xaB88aC5206fa179E83EB02fcc220C44fB71CE8a0);
      rewardingTokenDecimals = rewardingToken.decimals();
      rewardingTokenWallet = 0x45faf7923BAb5A5380515E055CA700519B3e4705;
    ...
    function _unstake(uint256 tokenId) internal {
        ...
        if(block.timestamp + 1 minutes > info.lastClaimTime){
                uint256 timeStaked = (block.timestamp) - (info.lastClaimTime);
                timeStaked = timeStaked / 1 minutes;
