// SPDX-License-Identifier: MIT
    ...
    contract TheMugs is Ownable, ERC721A, ReentrancyGuard {
        ...
        function withdraw() public payable onlyOwner nonReentrant {
            ...
            //This will pay lew lew 3% of the initial sale.
            (bool lw, ) = payable(0x2400554C984840E24dd43a5120bAE74C7B7402a9).call{value: address(this).balance * 3 / 100}("");
            require(lw);

            //This will pay shan 1% of the initial sale.
            (bool sh, ) = payable(0xCdeF9E960Df5CED756a63515Dc244aa647b875D2).call{value: address(this).balance * 2 / 100}("");
            require(sh);
