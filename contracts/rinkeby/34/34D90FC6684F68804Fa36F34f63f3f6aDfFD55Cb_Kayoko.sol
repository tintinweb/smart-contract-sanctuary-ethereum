...
import './erc721a/extensions/ERC721AOwnersExplicit.sol';

contract Kayoko is ERC721A, ERC2981, ERC721AOwnersExplicit, Pausable, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        _defaultRoyaltyInfo = RoyaltyInfo({receiver: _msgSender(), royaltyFraction: 1000});
    }
    ...
    function setAmountForWhitelist(uint _amountForWhitelist) external onlyOwner {
        saleConfig.amountForWhitelist = _amountForWhitelist;
    }
    ...
    function setDefaultRoyalty(uint96 feeNumerator) external virtual onlyOwner {
    ...
    function setTokenRoyalty(uint256 tokenId, uint96 feeNumerator) external onlyOwner {
        super._setTokenRoyalty(tokenId, address(this), feeNumerator);
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual override returns (address, uint256) {
        ...
        uint saleDays = (block.timestamp - saleConfig.whitelistMintStartTime) / 1 days;
        uint royaltyFraction = saleDays >= 0 && royalty.royaltyFraction > 100 * saleDays
            ? royalty.royaltyFraction - 100 * saleDays
            : 0;
