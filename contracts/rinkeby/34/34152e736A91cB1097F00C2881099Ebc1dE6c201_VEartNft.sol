...
contract VEartNft is ERC721Enumerable, Ownable  {
    ...
    function _baseURI() internal pure  override returns (string memory) {
        return "https://opensea.mypinata.cloud/ipfs/QmdZzz5vtgXMeYKKfYi795hze1GdMfxbyP4CLDFy4MUXEz/";
    }
    ...
    function returnTokenUri(uint256 tokenId) internal view returns (string memory){
        ...
        if(tokenId >= 1 && tokenId <= 2500){
            ...
            return "https://americana-something-token.s3.us-west-1.amazonaws.com/2310";
            // 4
        }
    }
    ...
    function getTokenId(uint256 _type) internal  returns (uint256) {
        uint256 tokenId;
        if(_type == 1){
            require(rarity_1<= rarity_1_limit, "Maximum limit reach for this nft");
            tokenId = rarity_1;
            rarity_1++;
            return tokenId;
        }else if(_type == 2){
            require(rarity_2<= rarity_2_limit, "Maximum limit reach for this nft");
            tokenId = rarity_2;
            rarity_2++;
            return tokenId;
        }
        else if(_type == 3){
            require(rarity_3<= rarity_3_limit, "Maximum limit reach for this nft");
            tokenId = rarity_3;
            rarity_3++;
            return tokenId;
        }else{
            require(rarity_4<= rarity_4_limit, "Maximum limit reach for this nft");
            tokenId = rarity_4;
            rarity_4++;
            return tokenId;
        }
