 ...
 * The ownership is "delegated" to an external account (tempOwner) which can interact with those services.
...
abstract contract OwnableWithTempOwnership is Ownable {
     ...
     * This uses the Ownable.sol owner function instead of the overriden version which can return the tempOwner.
     * Temporary owners have no authority to perform owner-only functions.
     */
