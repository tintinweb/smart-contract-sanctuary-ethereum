...
contract NFT is ERC721, Ownable {
    ...
    uint256 public price = 800000000000;
    ...
    constructor() ERC721("Mr Pisi Test", "PISI") {
        //Base IPFS URI of the NFTS
        baseURI = "ipfs://QmeMapynHTin5JFptQoAY3TE828RVZz2CRSngD7GfwKJRM/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0xe1598710696F01466ECC2EA1fEB7Fd901AF6e094).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0xe1598710696F01466ECC2EA1fEB7Fd901AF6e094).call{value: balanceTwo}("");
