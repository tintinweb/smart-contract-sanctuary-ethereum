...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["DARIUS-", "RENEKTON-", "VOLIBEAR-", "GANGPLANK-", "WUKONG-", "RENGAR-"];
  string[] secondWords = ["SHACO-", "VI-", "RAMMUS-", "HECARIM-", "AMUMU-", "WARWICK-"];
  string[] thirdWords = ["AHRI-", "VEIGAR-", "YASUO-", "SYNDRA-", "MALZAHAR-", "AKALI-"];
    string[] fourthWords =  ["TRISTANA-", "CAITLYN-", "JHIN-", "JINX-", "ASHE-", "LUCIAN-"];
  string[] fifthWords =  ["JANNA", "ALISTAR", "LEONA", "BLITZCRANK", "MORGANA", "SONA"];
