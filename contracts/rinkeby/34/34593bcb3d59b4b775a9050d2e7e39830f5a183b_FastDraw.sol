...
contract FastDraw is VRFConsumerBase, Ownable, Pausable {
    ...
    uint256 landDistributed;

    // max LAND available to be distributed
    uint256 MAX_LAND;

    uint256 private randomResult;
    AggregatorV3Interface internal landUsdPriceFeed;
   ...
   function GetContractTokenBalance() public view returns(uint256){
    ...
    function placeBet(uint256 amount) public {
        ...
        // get randomNumber will alter the randomResult variable
        getRandomNumber();
