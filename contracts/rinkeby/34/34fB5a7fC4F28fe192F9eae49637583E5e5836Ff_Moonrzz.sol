...
contract Moonrzz is ERC721A, Ownable, ReentrancyGuard {
    address private constant _creator1 = 0x520Fdf81640f380015CB27d44EeA93729257d42F;
    address private constant _creator2 = 0x03b4F9E07Eb115390d590D81F8e383db54eFf547;
    address private constant _creator3 = 0xf02AdEa522455f985e261D99C34d657B8Cc200C2;
    ...
    uint256 private _discountPrice = 0.08 ether;
	bytes32 private _claimMerkleRoot;

    mapping(address => bool) private _mintedClaim;

    uint256 private MAX_MINTS_PER_TX = 100;
    uint256 private MINT_PER_FREE_TX = 1;
	
    uint256 public MAX_SUPPLY = 8888;
    uint256 public FREE_SUPPLY = 80;
	

    constructor() ERC721A("Moonrzz", "MEZz") {}
