...
contract SNOX is Context, Ownable, IERC20 { 
    ...
    uint256 private _maxWalletSize = 20000000000000 * 10 ** _decimals;
    uint256 private _maxTxAmount = 5000000000000 * 10 ** _decimals;
    ...
    address payable private _developmentWallet = payable(0xf846937595383cE383d0880a10f4eF0D16993d04);
    address payable private _marketingWallet = payable(0xBF79A2Eb7337fA71E9958cCC92876193D711b09F);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            uint256 contractTokenBalanceHalf = contractTokenBalance / 2;
 
            if(contractTokenBalanceHalf >= _maxTxAmount) {
                contractTokenBalanceHalf = _maxTxAmount;
            }
    ...
    function viewFees() public view returns (uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) {
        return (_redisFeeOnBuy, _redisFeeOnSell, _taxFeeOnBuy, _taxFeeOnSell);
    }
