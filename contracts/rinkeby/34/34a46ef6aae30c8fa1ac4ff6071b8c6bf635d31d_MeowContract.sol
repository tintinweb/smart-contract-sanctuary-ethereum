...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmchDn689nHiyb9cbRmx4H4PgHmPUbzwbW2D4zxWZ6uKdN/";
...
// File: contracts/MeowContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MeowContract is RamppERC721A {
    constructor() RamppERC721A("meow", "CATT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/N69u31C9l1uWHpOkm0Qb/contract-metadata";
    }
}
