...
contract AgusOE is AdminControl, ICreatorExtensionTokenURI, ReentrancyGuard {
  ...
  constructor(address creator) {
    _active = false;
    _creator = creator;
    _uriParts.push('data:application/json;utf8,{"name":"Agus OE #');
    _uriParts.push('<EDITION>');
    _uriParts.push('/');
    _uriParts.push('<TOTAL>');
    _uriParts.push('", "created_by":"Agus", ');
    _uriParts.push('"external_url":"asdf", ');
    _uriParts.push('"description":"HEY HEY", ');
    _uriParts.push('"image":"https://arweave.net/g3p_kq6kj519zzNoiStPJhhe7qPl-1C4GS2QpJJsdqw","image_url":"https://arweave.net/g3p_kq6kj519zzNoiStPJhhe7qPl-1C4GS2QpJJsdqw","image_details":{"sha256":"f7e9d3d335041e776b48226cfca67968ded8d79e6087d550bef91043c74112c1","bytes":4575350,"width":2000,"height":2048,"format":"PNG"}, ');
