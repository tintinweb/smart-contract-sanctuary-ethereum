...
contract women_CreatedByNFTGM is GMERC721A {
    ...
    constructor(
        ...
        unicode"women",
        unicode"GGGg1111111111111111111111111111111111111111111111111",
        "https://test-api.nftgm.art/api/v1/nftgm/metadata/rinkeby/62f3227531e860fcbaaaa267/",
        1000,
...
contract GMERC721A is ERC721A, Ownable {
    ...
    function mint(uint256 qty) external payable {
        ...
        uint256 publicMint = _numberMinted(msg.sender) - preSaleMint + qty;
