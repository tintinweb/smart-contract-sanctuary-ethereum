...
//*********************************************************************//
//
//     ____           _      _ __    __        ______                _ __     
//    /  _/___ _   __(_)____(_) /_  / /__     / ____/___ _____ ___  (_) /_  __
//    / // __ \ | / / / ___/ / __ \/ / _ \   / /_  / __ `/ __ `__ \/ / / / / /
//  _/ // / / / |/ / (__  ) / /_/ / /  __/  / __/ / /_/ / / / / / / / / /_/ / 
// /___/_/ /_/|___/_/____/_/_.___/_/\___/  /_/    \__,_/_/ /_/ /_/_/_/\__, /  
//                                                                   /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 1997 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmU43rNwKHqgV87zYzFWVXDi2DsgDSXDCmfbcs5abqzghN/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1997");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1997");
...
// File: contracts/InvisibleFamilyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InvisibleFamilyContract is RamppERC721A {
    constructor() RamppERC721A("Invisible Family", "IFA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/OxQQHmJwYBuMVmj4qXMV/contract-metadata";
    }
}
