...
import "./travel-bears/ERC721Collection.sol";
import "./travel-bears/extensions/ERC721Presale.sol";
import "./travel-bears/extensions/ERC721Sale.sol";

contract TravelBears is ERC721Collection, ERC721Presale, ERC721Sale {
...
abstract contract PurchaseLimiter is Ownable {
    ...
    uint256 public maxPresalePurchase = 3;
