...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1662480600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xcEf9f0b3B80FEAea7d698f2d06592339d6e7fAca];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xcEf9f0b3B80FEAea7d698f2d06592339d6e7fAca;
...
contract MyDressUpDarlingsContract is RamppERC721A {
    constructor() RamppERC721A("My Dress Up Darlings", "MDUD"){}
}
