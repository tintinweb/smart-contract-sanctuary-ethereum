...
contract BlewChips is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 _amount) public nonReentrant {
        ...
        // don't let contracts mint save gas by not calling _safeMint
