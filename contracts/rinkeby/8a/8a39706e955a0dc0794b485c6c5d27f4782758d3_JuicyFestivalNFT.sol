...
contract JuicyFestivalNFT is ERC721, Ownable, Whitelisted {
  using Strings for uint256;
  ...
  uint256 public cost = 0.54 ether;
  ...
  constructor() ERC721("Juicy Festival", "JUICY") Whitelisted(0x61D81fc1B6979BB9ABe8A0375f3AA43791236c60) {
    setHiddenMetadataUri("https://syndicure.mypinata.cloud/ipfs/QmVQjTuxnb3GQ8269XcvJBuVgd1QvuVYyjcfYWzHiWCs1t");
  }
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0xc60058A8838714b1B0b4AfB9191A79c2052808aE).call{value: address(this).balance * 80 / 100}("");
    require(hs);
