...
contract SoccerSucker_V2_Upgradeable is Initializable, ERC721Upgradeable, OwnableUpgradeable {
  ...
  function initialize(string memory _name, string memory _symbol, string memory _initBaseURI, string memory _initContractURI, string memory _initHiddenURI) public initializer {
    baseExtension = ".json";
    cost = 0.035 ether;
    maxSupply = 1000; 
  ...
  function setMaxMintAmountPerTx(uint256 _newmMaxMintAmountPerTx) public onlyOwner {
    maxMintAmountPerTx = _newmMaxMintAmountPerTx;
  }
