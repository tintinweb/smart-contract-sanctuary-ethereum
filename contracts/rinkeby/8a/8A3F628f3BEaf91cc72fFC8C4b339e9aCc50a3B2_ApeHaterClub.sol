...
contract ApeHaterClub is ERC721AQueryable, Ownable, ReentrancyGuard {    
    ...
    // Sale controllers
    bool public MutationPhase1 = false ; //free
    bool public MutationPhase2  = false ; //30$
    bool public MutationPhase3  = false ; //50$
    bool public PublicActive  = false ; //public
...
//FREE MUTATION MINT (PHASE 1)
    function MintMutationPhase1(uint256 amount) external payable {
        require(MutationPhase1, "Free Mutation is not active");
        ...
        require(bnno.balanceOf(msg.sender, 0) > 0,"Must own at least 1 Banano to mutate");
        require(bnno.balanceOf(msg.sender, 0) <= amount,"Must be at max the quantity of your Bananos");
        require(msg.value == amount * PRICE_PHASE1, "Invalid funds provided");

        //bacc.burnBanana(msg.sender); //HERE THEORICALLY ITS BURNED ONLY 1 BANANA. WE WANT TO BURN NUMAPES QUANTITY
