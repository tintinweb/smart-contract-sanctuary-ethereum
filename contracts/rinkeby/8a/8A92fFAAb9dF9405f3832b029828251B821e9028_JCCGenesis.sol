...
// File: contracts/JCCGenesis.sol
    ...
    {    
        ...
        constructor (address payable beneficiary, address payable royaltyReceiver)
            ERC721S("JCC Genesis", "JCCGENESIS")            
            PublicPrivateVoucherMinter(
        ...
        */
        function projectMint() external onlyOwner {
            ...
            _projectMint(0x2A3897FdC22f674A5f6a6Bb638D93beF513E79e5,  33, "for team member"); // TokenId  1 to  33
            _projectMint(0x2A3897FdC22f674A5f6a6Bb638D93beF513E79e5,  30, "for advisor");     // TokenId 34 to  63
            _projectMint(0x2A3897FdC22f674A5f6a6Bb638D93beF513E79e5,  17, "for giveaway");    // TokenId 64 to  80
            _projectMint(0x2A3897FdC22f674A5f6a6Bb638D93beF513E79e5, 100, "for treasury");    // ToeknId 81 to 180
        }
