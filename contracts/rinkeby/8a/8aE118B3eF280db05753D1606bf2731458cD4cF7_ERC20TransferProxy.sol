...
contract ERC20TransferProxy is IERC20TransferProxy, Initializable, OperatorRole {
    ...
    function erc20safeTransferFrom(IERC20 token, address from, address to, uint256 value) override external {
...
contract OperatorRole is OwnableUpgradeable {
    ...
    function getOperator(address operator) public view virtual returns (bool) {
