...
contract Test {
    ...
    function deleteStrings() public {
        delete strings ;
    }
    function addStrings(string[] memory _string) public {
        for (uint i=0; i < _string.length; i++) {
            strings.push(_string[i]);
        }
    }

    function withDelete(string memory _string) public{
        testString = _string ;
        delete strings ;
    }
    function withoutDelete(string memory _string) public{
        testString = _string ;
    }
}
