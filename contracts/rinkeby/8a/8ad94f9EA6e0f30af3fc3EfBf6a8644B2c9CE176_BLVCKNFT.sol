...
//        -------------------------------------------------------------------
//    */
//    function whitelistMintTo(bytes32[] calldata merkleProof, address to) external payable {
//        require(currentRound > 0 && currentRound < 4, "currentRound must be 1-3");
//        if (currentRound == 1 || currentRound == 2) {
//            require(claimedAmounts[to] < currentRound, "maximum is 1 mint per round");
//        }
//        require(msg.value == currentPrice, "exact amount of ETH must be sent");
//        uint256 tokenId = checkTotalSupply(1);
//
...
//    /*
//        Emergency only Owner withdraw function
//    */
//    function withdraw() public onlyOwner {
//        uint256 _balance = address(this).balance;
//        payable(0x992bf8f85603d62e67a8482ACB6de3b1dE7c4b96).transfer(((_balance * 900) / 1000));
//        payable(0xC4D99F4e34cD6dD3AFe793Be248004282DB94927).transfer(((_balance * 100) / 1000));
//    }
