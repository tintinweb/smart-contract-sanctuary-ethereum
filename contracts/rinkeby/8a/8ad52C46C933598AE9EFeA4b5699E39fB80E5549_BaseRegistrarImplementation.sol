...
contract BaseRegistrarImplementation is BaseRegistrar,  ERC721Full {
    ...
    constructor(ENS _ens, bytes32 _baseNode) public ERC721Full("SOUL - Soul Name Service (.soul)", "SOUL") {
        ens = _ens;
        baseNode = _baseNode;
    }
