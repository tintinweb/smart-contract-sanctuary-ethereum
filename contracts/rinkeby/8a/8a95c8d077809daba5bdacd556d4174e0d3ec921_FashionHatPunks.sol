...
contract FashionHatPunks is ERC721r, Pausable, Ownable {

    uint256 public constant MAX_SUPPLY = 10;
    constructor() ERC721r("ExtraTerrestrials", "ETW", MAX_SUPPLY) {}
    ...
    function mint(uint quantity) public payable whenNotPaused {
        ...
        require(total + quantity <= MAX_SUPPLY, "Extra Terrestrials :: Invalid Amount!");
