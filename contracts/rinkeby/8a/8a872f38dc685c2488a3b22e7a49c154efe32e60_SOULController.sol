...
// File: contracts/interfaces/ISOULRegistrar.sol

pragma solidity ^0.5.15;

contract ISOULRegistrar {
    /**
	 * @dev Allows to create a subdomain (e.g. "nacho.soul.eth"), set its resolver, owner and target address
...
// File: contracts/ens/SOULController.sol
...
contract SOULController is Ownable {
    ...
    // SOUL Registrar
    ISOULRegistrar public registrar;
     ...
     * @param _registrar - address of the SOUL registrar contract
	 */
    constructor(IERC20Token _acceptedToken, ISOULRegistrar _registrar) public {
