...
contract Bear_Squad is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public publicCost = 0.58 ether;
    ...
    constructor() ERC721A("Bear Squad", "BSQ") {}
    ...
    function mint(uint256 quantity) external payable nonReentrant {
        ...
        if(whitelistStatus) {
            require(whitelistAddresses[msg.sender], "You're not whitelisted");
        }
    ...
    function setPresaleCost(uint256 _newPrice) external onlyOwner {
        presaleCost = _newPrice;
    }

    function setAfterParty(bool _state) external onlyOwner {
        revealed = _state;
    }
    function setWhitelistStatus(bool _state) external onlyOwner {
        whitelistStatus = _state;
    }

    function setAfterPartyMetadata(string memory _URI) external onlyOwner {
