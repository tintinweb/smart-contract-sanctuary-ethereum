...
contract CreatureAccessory is ERC1155Tradable {
    constructor(address _proxyRegistryAddress)
        ERC1155Tradable(
            "HYM Creature Accessory 20220516",
            "HYMA",
            "https://cryptic-escarpment-21016.herokuapp.com/api/accessory/{id}",
            _proxyRegistryAddress
        ) {}

    function contractURI() public pure returns (string memory) {
        return "https://cryptic-escarpment-21016.herokuapp.com/contract/opensea-erc1155";
    }
}
