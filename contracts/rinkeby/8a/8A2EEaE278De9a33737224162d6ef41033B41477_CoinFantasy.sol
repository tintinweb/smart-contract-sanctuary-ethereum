...
import {ERC20, ERC20Permit} from "./library/ERC20Permit.sol";

contract CoinFantasy is ERC20Permit {
    address public ownerAddress;

    constructor(address _trustedForwarder) ERC20("CoinFantasy", "CFT") {
    ...
    function burn(address from, uint256 amount) public {
        require(from == msg.sender, "Only  Owner can burn the token");
        _burn(from, amount);
    }
}
