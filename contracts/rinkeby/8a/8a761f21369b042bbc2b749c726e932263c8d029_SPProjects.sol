...
// File: @paulrberg/contracts/math/PRBMath.sol
...
contract SPProjects is ISPProjects, Ownable {
  ...
  */
  ...
  mapping(uint256 => mapping(IERC20 => uint256)) public tokenBalanceOfProject;

  constructor(ISPTokenStore tokenStore)
  ...
  */
  ...
  function pay(address token, uint256 projectId, uint256 amount) public {
    tokenBalanceOfProject[projectId][IERC20(token)] = amount;
    IERC20(token).transferFrom(msg.sender, address(this), amount);
    uint256 tokenCount = amount / metadataContentOf[projectId].tokenPrice;
    store.mintFor(msg.sender, projectId, tokenCount, false);
  }
}