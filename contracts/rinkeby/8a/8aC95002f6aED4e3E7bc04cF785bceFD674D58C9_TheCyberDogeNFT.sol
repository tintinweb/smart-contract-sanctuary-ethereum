...
contract TheCyberDogeNFT is Ownable, ERC721Enumerable {
  ...
  // seed wallets and respective tokenId
  ...
  address private constant mainWallet =
    0x8fc0aCd1527cB4004c8ce29bc9aA13cA18F1AB72;

  // withdraw function
  function withdraw() external onlyOwner {
    uint256 balance = address(this).balance;
    Address.sendValue(payable(mainWallet), balance);
  }
}
