...
contract PurposefulPeople is ERC721A, ERC721AQueryable, ERC721ABurnable, Admin, SignatureRecover{
    ...
    uint256 public userQty = 900;
    uint256 public adminQty = 100;
    ...
    event Minted(address indexed sender, uint8 indexed type_mint, uint256 timestamp);
    ...
    //Admin Mint
    function adminMint(address[] memory _to, uint256[] memory _amount) external onlyAdmin{
        ...
        emit Minted(msg.sender, 1, block.timestamp);
    }
    ...
    function userMint(
        ...
        emit Minted(msg.sender, _type, block.timestamp);
    }
