...
contract RyuukoTsuka is Context, IERC20, Ownable {
    ...
    address public tsukaAddress = 0xbbf2F2b41B33949461170Ceae4b1C9f78F64FD09; //rinkeby
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _symbol = "RYUTSUKA TRACKER";
    uint8 private _decimals = 9;
    ...
    IERC20 public tsukaToken = IERC20(0xbbf2F2b41B33949461170Ceae4b1C9f78F64FD09);
    constructor() {
    }
