...
// File contracts/ProofOfGroove.sol


// https://docs.opensea.io/docs/metadata-standards
contract ProofOfGroove is Context, Ownable, ERC721 {
    ...
    ) ERC721("Proof of Groove Genesis", "PoG0") {
        __baseURI = "https://proofofgroove.com/";
    ...
    function startSet(uint256 startBlock_) public onlyOwner {
        ...
        require(
            _totalSupply % _groovesPerSet == 0,
            "Cannot start a new set if old set is not finalized."
        );
        require(
            _currentSet < _totalSets,
            "Cannot start a new set if all sets are sold out."
        );
    ...
    function finalizeSet() public {
        require(
            ...
            "Cannot finalize a set as long as it is not sold out."
        );
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '"}, { "trait_type": "Set", "display_type": "number", "value": ',
                    getTraitSet(tokenId),
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            '{"name": "Proof of Groove Genesis #',
                            tokenId.toString(),
                            '", "description": "Generative audio-visual grooves rendered in a subgraph",',
                            '"image": "',
                            _baseURI(),
                            "api/token/",
                            tokenId.toString(),
