...
import "./PawnVesting.sol";

contract MockPVesting is PawnVesting {
    ...
    function initialize(
        ...
        PawnVesting.initialize(_token, _nftAddr, _startTimestamp, _durationSeconds);
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function claim() public virtual whenNotPaused nonReentrant {
        require(getCurrentTime() > startTimestamp, "too early");
