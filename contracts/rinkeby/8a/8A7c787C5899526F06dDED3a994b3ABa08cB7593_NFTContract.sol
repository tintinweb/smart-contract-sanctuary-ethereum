...
contract NFTContract is Erc721Tradable, ERC721Enumerable, Ownable {
  ...
  function _burn(uint256 tokenId) internal override(Erc721Tradable,ERC721) {
        super._burn(tokenId);
    }
  ...
  function tokenURI(uint256 _tokenId) override(Erc721Tradable,ERC721) view public returns (string memory) {
  ...
  constructor(address _proxyRegistryAddress, string memory _recipientID, uint256 _saleSize, uint256 _mintingLimit,uint256 _mintingFees, string memory _BaseTokenURI )
        Erc721Tradable("BADMANSKULLGANG", "BMSG", _proxyRegistryAddress)
    {
...
abstract contract Erc721Tradable is ERC721, ContextMixin, NativeMetaTransaction,ERC721URIStorage {
    ...
    function tokenURI(uint256 _tokenId) override(ERC721, ERC721URIStorage) public view virtual returns (string memory) {
