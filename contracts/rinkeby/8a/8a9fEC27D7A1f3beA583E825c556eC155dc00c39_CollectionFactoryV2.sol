    ...
    CBRNFTDefault
{
    ...
    function initialize(
        ...
        CBRNFTDefault.initialize(name, symbol,_contractURI,tokenURIPrefix, _admin, _marketplace);
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __CollectionV2_init(_admin);
        __Pausable_init();
        __Ownable_init();
        _tokenIdCounter.increment();
    }

    function __CollectionV2_init(address _admin) internal  onlyInitializing {
    ...
    Royalties
{
    ...
    function initialize(
        ...
        __CBRNFTDefault_init(_marketplace);
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __Pausable_init();
    ...
    function __CBRNFTDefault_init(address _marketplace) internal onlyInitializing{
