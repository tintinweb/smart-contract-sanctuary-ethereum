...
contract KidTesting is Ownable, ERC721A {
    bytes32 public merkleRoot;
    using Strings for uint256;
    
    uint256 public constant SUPPLY = 6868;
    uint256 public WHITELIST_SUPPLY = 5000;
    uint256 public AUCTION_SUPPLY = 1000;
    ...
    uint256 public startTime = 1652787000;

    constructor() ERC721A("Kid Testing", "K Testing") { }
