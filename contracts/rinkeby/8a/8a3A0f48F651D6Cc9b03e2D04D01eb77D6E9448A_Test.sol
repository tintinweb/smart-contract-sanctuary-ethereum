...
contract Test is ERC721, ERC721Enumerable {

    bool public saleIsActive = false;
    string public _baseUri;
    bool public isSaleActive = false;
    uint public mint = 0.0069 ether;
    address public owner;

    constructor() ERC721("Invisible Phirends", "IPH") {
        owner = msg.sender;
    }
    ...
    function mintTokens(uint numberOfTokens) public payable {
        ...
        require(mint * numberOfTokens <= msg.value, "Ether value sent is not correct");
