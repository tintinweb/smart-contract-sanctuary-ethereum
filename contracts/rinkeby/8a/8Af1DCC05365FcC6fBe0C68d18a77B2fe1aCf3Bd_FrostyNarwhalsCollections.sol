...
contract FrostyNarwhalsCollections is ERC721A, Ownable {
    using SafeMath for uint256;

    uint256 public maxFrostyNarwhalsMintPerWallet = 10;
    ...
    constructor(address _companyWallet)
        ERC721A("Frosty Narwhals Collections", "NARWHALS")
    {
    ...
    function whitelistMint(
        ...
        require(
            ...
            "Sale must be active to mint FrostyNarwhals"
        );
        require(
            mintedRecord[msg.sender].add(numberOfTokens) <=
                maxFrostyNarwhalsMintPerWallet,
