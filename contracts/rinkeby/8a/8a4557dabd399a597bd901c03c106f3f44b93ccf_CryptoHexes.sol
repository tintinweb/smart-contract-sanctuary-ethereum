...
// File: contracts/CryptoHexes.sol
...
contract CryptoHexes is ERC721Enumerable, Ownable, Pausable {
  using Strings for uint256;
    ...
    string public notRevealedUri = "ipfs://QmYdaYPkuX875nuSwY29J479ESgdnDtaT3ZJy7N6T3UqGW/preview.png";
    ...
    function mint_max20(uint256 count) public payable whenNotPaused {
        uint256 totalSupply = totalSupply();
        require( count > 0 && count <= 20, "Incorrect mint amount" );
        require( msg.value == price * count,   "Incorrect ETH amount" );
    ...
    function setReaveal(bool revealStatus) public onlyOwner {
