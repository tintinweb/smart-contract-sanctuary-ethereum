...
contract BadgeToken is ERC721 {
    ...
    constructor(
        ...
        versos[0] = Verso({ verso: "lalala", autor:"lala", fuente: "lala" });
        versos[1] = Verso({ verso: "lelele", autor:"lele", fuente: "lele" });
        versos[2] = Verso({ verso: "lilili", autor:"lili", fuente: "lili" });
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[1] = versos[tokenId].verso; // Strings.toString(tokenId);
