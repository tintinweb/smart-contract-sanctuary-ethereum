    ...
    */
    ...
    function setRaffleWinnerStructure(
        ...
        if(_nftAddress == address(0x00)) {
            ...
            winnerStructure[_raffleId][_index] = winnerStructure[_raffleId][winnerStructure[_raffleId].length - 1];
    ...
    function _decideRaffle(bytes32 _requestId) internal {
        ...
        if (entries != 0) {
            ...
            _giveFunds(
                raffles[_raffleId].partnerAddress,
                raffles[_raffleId].tokenContract,
                raffles[_raffleId].partnerAmount
            );
        }
    }
