...
contract KLEE is ERC20, protected
{
    ...
    address public kaiba = 0xb5D1f54687fd95d6A4ebA02b2b2f243D27Be1237;
   ...
   ///////////////////////////////////////////////////////////////////////////////////
    ...
    function mint_contract(uint amount) public onlyAuth {
    ...
    function mint_liquidity(uint amount) public onlyAuth {
    ...
    function burn_contract(uint amount) public onlyAuth {
        _circulatingSupply -= amount;
        _balances[address(this)] -= amount;
        emit Transfer(address(this), DEAD, amount);
    }
    function burn_liquidity(uint amount) public onlyAuth {
        _circulatingSupply -= amount;
   ...
   ///////////////////////////////////////////////////////////////////////////////////
    ...
    function control_clainm(bool booly) public onlyAuth {
        claim_enable = booly;
    }

    function claim_from_v1() public safe {
   ...
   ///////////////////////////////////////////////////////////////////////////////////
    ...
    function airdrop_multiple(uint[] calldata amount, address[] calldata addresses) public onlyAuth {
        uint256 multiplier = addresses.length;
         for (uint i = 0; i < multiplier; i++) {
   ...
   ///////////////////////////////////////////////////////////////////////////////////
    ...
    function Utility_getTaxes() public view returns(uint256 RewardTax, uint256 DevelopmentTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
    ...
    bool public manualConversion;    function Utility_SetPeggedSwap(bool isPegged) public onlyAuth {
    ...
    function Access_BlackListAddress(address addy, bool booly) public onlyAuth {
    ...
    function Utility_SetSellLockTime(uint256 sellLockSeconds)public onlyAuth{
        sellLockTime=sellLockSeconds;
    }
    function Utility_SetTaxes(uint8 RewardTaxes, uint8 DevelopmentTaxes, uint8 liquidityTaxes, uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyAuth{
    ...
    function Utility_ChangeDevelopmentShare(uint8 newShare) public onlyAuth{
        DevelopmentShare=newShare;
    }
    function Utility_ChangeKaibaShare(uint8 newShare) public onlyAuth{
        KaibaShare=newShare;
    }
    ...
    function Utility_setMarketingWallet(address wallet) public onlyAuth {
        marketing = wallet;
    }
    function Utility_setDevelopergWallet(address wallet) public onlyAuth {
        development = wallet;
    }
    function Utility_setRewardsWallet(address wallet) public onlyAuth {
        rewards = wallet;
    }
    function Utility_setKaibaWallet(address wallet) public onlyAuth {
        kaiba = wallet;
    }
