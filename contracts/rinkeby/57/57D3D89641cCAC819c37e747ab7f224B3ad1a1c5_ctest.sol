...
contract ctest is ERC721A, EIP712, Ownable {
    ...
    function mintPresaleMerkle(address to, uint256 amount, bytes32[] calldata proof) external {
        require(maxSupply + amount < MAX_SUPPLY_PLUS_ONE, "Exceeds max supply");
    ...
    function mintPresaleHash(
        ...
        require(maxSupply + _passAmount < MAX_SUPPLY_PLUS_ONE, "Exceeds max supply");
        ...
        // for (uint256 i = maxSupply; i < _passAmount + maxSupply; i += 1) {
        //     _mint(msg.sender, i);
        // }
        ...
        emit ClaimPass(msg.sender, amount);
    }

    function mint(address to, uint256 amount) public onlyOwnerOrStore {
        require(maxSupply + amount < MAX_SUPPLY_PLUS_ONE, "Exceeds max supply");
        _safeMint(to, amount);
        maxSupply += amount;
    }
