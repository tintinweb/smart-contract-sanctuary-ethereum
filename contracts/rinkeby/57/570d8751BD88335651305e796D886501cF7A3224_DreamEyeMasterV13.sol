...
contract DreamEyeMasterV13 is IMasterContract, ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  function addSideCar(address _sideCarContract) public onlyOwner {
    ...
    sideCarsAddr.push(_sideCarContract);
  ...
  function removeSideCar(address _sideCarContract) public onlyOwner {
    ...
    if (sideCars.length > 1) {
      ...
      sideCarsAddr[index-1] = sideCarsAddr[sideCarsAddr.length-1];
      address scAddr = sideCarsAddr[sideCarsAddr.length-1];
      sideCarIndex[scAddr] = index;
    }
    sideCars.pop(); 
    sideCarsAddr.pop();
  }
