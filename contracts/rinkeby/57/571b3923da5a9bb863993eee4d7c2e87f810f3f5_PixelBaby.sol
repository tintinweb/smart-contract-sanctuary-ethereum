...
contract PixelBaby is ERC721A, Ownable, ReentrancyGuard {
  ...
  function freeMint(uint256 _mintAmount) external nonReentrant {
    ...
    require(_mintAmount > 0 && _freeMints[ms] + _mintAmount <= 1, "Free mint already claimed");
