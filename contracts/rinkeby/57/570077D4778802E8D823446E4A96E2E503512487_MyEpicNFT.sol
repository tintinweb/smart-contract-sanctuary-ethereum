...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Red", "Yellow", "Blue", "Green", "Purple", "Pink"];
  string[] secondWords = ["Apple", "Orange", "Lemon", "Banana", "Strawberry", "Grape"];
  string[] thirdWords = ["Lion", "Tiger", "Horse", "Cow", "Elephant", "Giraffe"];
