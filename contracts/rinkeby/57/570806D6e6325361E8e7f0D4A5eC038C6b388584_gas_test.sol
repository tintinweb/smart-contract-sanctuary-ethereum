...
uint256 immutable MAX_SUPPLY = 10;
    ...
    function tokenURI(uint256 _tokenId) override public view  returns (string memory) {
       return 'data:text/plain;charset=utf-8,.|.|.O..-.-.-.-.-.|.|.|.O.O.O.O..O.O.O.O.|.|.|.-.-.-.-.-..O.|.|.%0A|-.|.O|.O-.|..|.O-.O..|..-.O-.|..|.-O.-..|..O.-O.|..|.-O.|O.|.-|%0A..|-..|-.OO-..|...|..O-..O|..O-..-O..|O..-O..|...|..-OO.-|..-|..%0A';
    }
...
bytes prefix = "data:text/plain;charset=utf-8,";
    ...
    //     uint a = uint((keccak256(abi.encodePacked(id + 100))));
