...
contract AlAd is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintPerTransaction = 1111;
  ...
  string public notRevealedUri = "ipfs://QmTDCKWMxggSbZLdiw8XAfTgGnKv8sWAB3ezCvEYEGYN65/";
  ...
  constructor(address feeWallet, uint256 obfuscationOffset) ERC721("AlAd", "AA") {
 _feeWallet = feeWallet;
  ...
  function mint(uint256 n) payable public {
    ...
    require(msg.value >= n * cost, "Not enough ether sent");
  }
