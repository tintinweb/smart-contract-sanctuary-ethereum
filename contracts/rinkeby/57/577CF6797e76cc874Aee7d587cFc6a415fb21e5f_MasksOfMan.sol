...
contract MasksOfMan is ERC721Tradable, ERC2981ContractWideRoyalties {
    ...
    string private prefix = "x";
    address payable private payableAddress;
    uint256 public mintCost = 0.2 ether;
    ...
    function reveal(string memory prefix_) onlyOwner external {
        prefix = prefix_;
        revealed = true;
    }
    ...
    function mint(uint256 masksToMint) external payable {
        require(msg.value == mintCost * masksToMint, "Flawed Value");
    ...
    {
        if (!revealed) {
            return "ipfs://QmNsDy5tkYbc73EfpKiuqcHPozS32cz3dktcqbDbyrKZYN";
        } else {
