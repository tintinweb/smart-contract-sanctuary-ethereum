...
contract LotteryVRF is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    //Once we execute this the oracle gets the random and then triggers the fulfillRandomWords which the VRFCoordinator fills
    ...
    //Once checkUpkeep returns true it automatically triggers this function performUpkeep
