    ...
    OwnableUpgradeable
{
    ...
    function purchase() external payable returns (uint256) {
        ...
        require(balanceOf(msg.sender) < 5 || msg.sender == owner(), "Limit three passes per wallet");
     ...
     */
    function prePurchase(bytes32[] calldata proof) external payable returns (uint256) {
        ...
        require(MerkleProof.verify(proof, alMerkleRoot, leaf), "Needs to be on the allowlist.");
