...
// File: contracts/ERC721WithRandomly.sol
...
contract ERC721WithRandomly is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // using Counters for Counters.Counter;
  ...
  constructor() ERC721("NAME", "SYMBOL") RandomlyAssigned(maxSupply, 1) {
    mint(5);
  }
