...
contract FettyWapperz is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.01738 ether;
  uint public          maxPerTx          = 20;
  uint public          totalFree         = 800;
  uint public          maxSupply         = 1738;
  bool public          mintEnabled;

  constructor() ERC721A("FettyWapperz", "FW"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(amount < txMax + 1, "Max per TX reached");
