...
contract Lottery is VRFConsumerBaseV2, KeeperCompatible {
    ...
    // this function will not be called by users
    function performUpkeep(
        ...
        uint256 requestId = i_vrfCoordinator.requestRandomWords(
            ...
            REQUEST_CONFIRMATIONS, // how many confirmations the node should wait before respoding
    ...
    function fulfillRandomWords(uint256, uint256[] memory randomWords)
        ...
        override
    {
        // using modulo to get the random winner
