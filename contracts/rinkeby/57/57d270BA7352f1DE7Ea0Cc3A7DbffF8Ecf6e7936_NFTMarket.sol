...
contract NFTMarket is ReentrancyGuard{
  ...
  Counters.Counter private _itemsSold; //totalNumber of items sold

  address payable owner; //owner of the smart contract can receive commission
  uint256 listingPrice = 0.025 ether; //people have to pay to put their NFT on this marketplace 
  ...
  function createMarketItem(address nftContract, uint256 tokenId, uint256 price) public payable nonReentrant{
    ...
    idMarketItem[itemId] = MarketItem(
      ...
      nftContract,
      tokenId,
      payable(msg.sender), //address seller 
  ...
  function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant {
    ...
    idMarketItem[tokenId].owner = payable(msg.sender); //mark buyer as a new owner
