...
// File: contracts/LPP.sol

pragma solidity >=0.8.0;

contract LPP is ERC721A, Ownable, ReentrancyGuard {
  ...
  // mint config
  uint256 public cost = 0.003 ether; // 3000000 gwei
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(_mintAmount > 0 && _mintAmount <= maxPerTxn, "Max NFT per transaction exceeded");
    require(
