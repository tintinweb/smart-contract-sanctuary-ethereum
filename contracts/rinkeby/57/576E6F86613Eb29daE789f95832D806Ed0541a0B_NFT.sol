...
contract NFT is ERC721, PullPayment, Ownable {
    ...
    uint256 public mintStart = block.timestamp + 1 days; 

    /// @dev Base token URI used as a prefix by tokenURI().
    string public baseTokenURI;

    constructor() ERC721("NFTTutorial6", "NFT6") {
        baseTokenURI = "https://bafybeib26bor2j6osgle6mdxagbsdajdec2xdhf775y25dmjmj4g3misri.ipfs.nftstorage.link/metadata/1";
        //mintStart = _mintStart; uint256 _mintStart
        //merkleRoot = _merkleRoot; bytes32 _merkleRoot
    }
    ...
    /// @notice start minting process for addresses with proof. Dont use this if mint() is enabled
    ...
    function isWalletOnMintList(address recipient, bytes32[] calldata proof) public view returns (bool) {
