...
contract ILO is Ownable {
    ...
    function initialize(LiquidityManager _liquidityManager, AcaiToken _rewardToken, uint _rewardBalance, uint _startTime, uint _duration, uint _minimumAmount, uint _linearBonusCoefficient) external onlyOwner {
    ...
    function spawnPool() external isInitialized {
        ...
        liquidityManager.createPool{value: totalProvidedEth}(tokensNeededForLiquidity);
        poolCreated = true;
    }
