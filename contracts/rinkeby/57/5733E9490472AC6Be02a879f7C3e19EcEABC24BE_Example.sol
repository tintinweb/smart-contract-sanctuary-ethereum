...
contract Example is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    ...
    uint public publicSalesTimestamp = 1660239900;
    uint public whitelistSalesTimestamp = 1660239600;
    ...
    function mint(uint amount) external payable {
        ...
        require(amount + _totalNormalMintPerAccount[msg.sender] <= maxNormalMintPerAccount, "max 3 tokens per account");
    ...
    function whitelistMint(uint amount, bytes calldata signature) external payable {
        ...
        require(amount + _totalWhitelistMintPerAccount[msg.sender] <= maxWhitelistMintPerAccount, "max 2 tokens per account");
