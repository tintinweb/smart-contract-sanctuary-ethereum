// SPDX-License-Identifier: MIT
    ...
    contract NewWorld is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 0.0019 ether; 
      ...
      event NewWorldMinted (uint256 tokenId, address owner);
    
      constructor() ERC721("NewWorld", "NWD") {}
      ...
      function mintNewWorld(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit NewWorldMinted(id, msg.sender);
          }
        }
      }
    
      function presaleNewWorld(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmWN9AEn6NMqjhzKmeNzxKfFhpDxVyh4HEea3GUGqmTdV5/NFTComing.json";
        }
