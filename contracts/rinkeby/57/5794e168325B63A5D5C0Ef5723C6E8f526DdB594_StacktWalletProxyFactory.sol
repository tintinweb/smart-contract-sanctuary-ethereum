...
contract StacktWalletFactory {
    ...
    StacktWalletProxyFactory internal safeFactory = StacktWalletProxyFactory(0x5794e168325B63A5D5C0Ef5723C6E8f526DdB594);   ///
    ...
    function createWallet(
        ...
        // stackt wallet
        proxy = safeFactory.createProxy{value: msg.value}(stacktWalletSingletonAddress, setupData);
