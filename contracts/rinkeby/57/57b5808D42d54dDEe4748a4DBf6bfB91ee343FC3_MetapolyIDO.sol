...
contract MetapolyIDO is OwnableUpgradeable, ERC721Upgradeable {
    // uint tokenId;
    uint public mintPrice; // In ETH
    ...
    function initialize(
        ...
        uint _mintPrice, uint _maxSupply,
        string calldata baseURI_, address _signer
    ...
    function mint(uint tokenId, bytes calldata signature) external payable {
        // require(tokenId < maxSupply, "Max supply");
        require(msg.value == mintPrice, "Invalid price");
        // require(isMinted[msg.sender] == false, "Minted");
    ...
    //     _totalSupply = tokenId; // tokenId increment by 1 per mint
    // }
}
