...
import "./EclipseAccessUpgradable.sol";
import "./IEclipsePaymentSplitterV2.sol";
...
contract EclipseERC721 is
    ...
    EclipseAccessUpgradableUpgradable,
    IEclipseERC721
{
    ...
    function initialize(
        ...
        __EclipseAccessUpgradable_init(admin, artist);
    ...
    function _checkMint() internal view {
        require(_msgSender() == _minter, "only minter allowed");
    }
        ...
        returns (address, uint256)
    {
        return (
            _royaltyReceiver,
            ((
                IEclipsePaymentSplitterV2(_paymentSplitter)
     ...
     */
    function setRoyaltyReceiver(address receiver) public onlyEclipseAdmin {
     ...
     * @dev Set base uri
     */
    function setBaseURI(string memory uri) public onlyEclipseAdmin {
        _uri = uri;
    }
 ...
 */
abstract contract EclipseAccessUpgradableUpgradable is OwnableUpgradeable {
    mapping(address => bool) public admins;
    address public eclipseAdmin;

    function __EclipseAccessUpgradable_init(address admin, address owner)
        internal
        onlyInitializing
    {
        __EclipseAccessUpgradable_init_unchained(admin, owner);
    }

    function __EclipseAccessUpgradable_init_unchained(address admin, address owner)
        internal
        onlyInitializing
    {
...
interface IEclipsePaymentSplitterV2 {
