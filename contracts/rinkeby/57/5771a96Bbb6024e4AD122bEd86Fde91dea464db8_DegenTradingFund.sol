...
contract DegenTradingFund is ERC20, Ownable {
    ...
    constructor() ERC20("DTF", "Degen Trading Fund") {
        ...
        Treasury = address(0xBD82f1E919e759bd61F6d3d2d638BE1Dbc522DA3);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellFee > 0) {
                ...
                TokensForSwap += (fees * 4) / sellFee;
                TokensForBurn += (fees * 2) / sellFee;
            }
            // on buy
            else if (automatedMarketMakerPairs[from] && buyFee > 0) {
                fees = amount.mul(buyFee).div(100);
                TokensForSwap += (fees * 4) / buyFee;
                TokensForBurn += (fees * 2) / buyFee;
            }
