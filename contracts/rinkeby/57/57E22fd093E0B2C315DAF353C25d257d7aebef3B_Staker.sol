...
contract Staker {
    ...
    function stake() public payable {
        require(block.timestamp <= deadline, "Cannot stake after deadline");
    ...
    function execute() public notCompleted {
        require(block.timestamp >= deadline, "Deadline isn't reached yet");
    ...
    function withdraw() public payable notCompleted {
        require(timeLeft() == 0, "Cannot withdraw before deadline");
        require(threshold > address(this).balance, "Threshold reached");
