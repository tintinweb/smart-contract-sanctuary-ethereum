...
// File: contracts/mutanthapeprime.sol
...
contract MUTANTHAPEPRIME is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    // Claim Basic Variables
    string _baseTokenURI =
        "https://ipfs.io/ipfs/QmPUfpyNZJh2Rg2gwFV3xFh6zEsgQPoghWsnCYP6ZUEFND/";
    string hiddenURI =
        "https://ipfs.io/ipfs/QmdcBpUesawGrhwkWKkTLszpNGxjF92hfUsCerh2oLarKh/hidden.json";
    address PREMINT = 0x61892fEaF7dEEDb0888C36D1F89914455Ae0ce22;
    address CHARITY = 0x61892fEaF7dEEDb0888C36D1F89914455Ae0ce22;
    uint256 private constant MAX_ENTRIES = 5000;
    uint256 private constant PREMINT_ENTRIES = 100;

    // Set Prices following Tokenomics
    uint256 private OG_PRICE = 0.15 ether;
    uint256 private SALE_PRICE = 0.15 ether;
    uint256 private MAX_BUYABLE = 10;
    uint256 public price;

    // Set about the WhiteListed person
    mapping(address => bool) whitelisted;
    uint256 public whitelistAccessCount;
    uint16 private LIMIT_WL = 100;
    ...
    constructor() ERC721("MUTANT HAPE PRIME", "MHP") {
        // setBaseURI(baseURI);
    }
    ...
    function mint(uint256 amount) public payable {
        ...
        if ((block.timestamp - startTime) <= 0) {
            ...
            require(
                ...
                "In PRESALE Stage, you can buy ONLY 3 MHP!"
            );
        }
        ...
        require(msg.value >= price, "MHP : INCORRECT PRICE!");
        payable(CHARITY).transfer(((address(this).balance) * 10) / 100);
