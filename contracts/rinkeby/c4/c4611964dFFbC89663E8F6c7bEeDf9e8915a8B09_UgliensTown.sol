...
contract UgliensTown is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxPerWallet, "You have exceeded the mint limit per wallet.");
    _;
  }
  ...
  function claimFreeUglien() external nonReentrant {
    require(claimAvailable[msg.sender] < maxFree, 'Only one claim per wallet');
    ...
    require(balanceOf(msg.sender) + amount <= maxPerWallet, "You have exceeded the mint limit per wallet.");
