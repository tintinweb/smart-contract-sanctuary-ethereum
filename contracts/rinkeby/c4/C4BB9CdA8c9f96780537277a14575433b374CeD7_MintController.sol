...
contract MintController is Ownable {
	...
	bytes32 whitelistMerkleRoot = 0x9e2f71acf7e8ce351816b4f60136fa6fd665ddf3c29f2df49c90013599198f11;
	mapping (address => uint256) public whitelistClaimed;

	// Giveaway Merkle Proof
	bytes32 giveawayMerkleRoot = 0x9e2f71acf7e8ce351816b4f60136fa6fd665ddf3c29f2df49c90013599198f11;
	...
	function whitelistMint(bytes32[] calldata merkleProof_, uint256 amount_) public payable returns(bool) {
		...
		if(amount_ == discountThreshold) {
			...
			require(msg.value >= whitelistMintPrice, "Please check amount sent for whitelist mint.");
		}
