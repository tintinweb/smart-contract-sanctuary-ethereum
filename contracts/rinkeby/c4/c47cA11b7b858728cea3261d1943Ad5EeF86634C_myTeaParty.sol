...
contract myTeaParty is Ownable, Pausable, ERC721A, ReentrancyGuard {
    ...
    // string private notRevealedExtension;
    ...
    {   
        ...
        // TODO: double check if we need below check
        require(msg.value == _totalCost, "Invalid amount of ether sent!");
    ...
    // function _notRevealedURI() internal view override returns (string memory) {
    ...
    // function setNotRevealedExtension(string memory _newNotRevealedExtension)
    //     external
    //     onlyOwner
    // {
    //     notRevealedExtension = _newNotRevealedExtension;
    // }
