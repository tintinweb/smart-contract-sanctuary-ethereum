...
contract Test is ERC721, Ownable {
    ...
    uint256 public legendary=1451;
    uint256 public core=1601;

    uint256 public luckyminted=0;
    uint256 public legendaryminted=0;
    uint256 public coreminted=0;
    ...
    function luckyMint(uint256 _mintAmount) public payable{
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
            
            _safeMint(msg.sender, lucky + luckyminted);
            luckyminted++;
        }
    ...
    function legendaryMint() public payable{
        _safeMint(msg.sender, legendary + legendaryminted);
        legendaryminted++;
    }

    function coreMint(uint256  _token_id) public payable{
