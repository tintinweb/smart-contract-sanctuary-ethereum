...
// Part: chiru-labs/[email protected]/IERC721A
...
// Part: chiru-labs/[email protected]/ERC721A
...
contract Evinco is ERC721A, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    //private
    address private immutable _devAddr;
    ...
    function withdrawFunds() external onlyOwner {
        bool success = false;
        if (_devFee != 0) {
            uint256 devAmount = (address(this).balance * _devFee) / 100;
            (success, ) = payable(_devAddr).call{value: devAmount}("");
