...
contract DialerContract is BoringOwnable, BoringBatchable {
	...
	/// @notice Info of each Dialer user.
	...
	/// @notice Info of each Dialer pool.
	...
	/// @notice Address of the LP token for each Dialer pool.
	IERC20[] public lpToken;
	/// @notice Address of each `IRewarder` contract in Dialer.
	IRewarder[] public rewarder;

	/// @notice History of each Bonus.
	...
	/// @notice Returns the number of Dialer pools.
	...
	/// @notice Deposit LP tokens to Dialer for TELE allocation.
	/// @param pid The index of the pool. See `poolInfo`.
	...
	/// @notice Withdraw LP tokens from Dialer.
	/// @param pid The index of the pool. See `poolInfo`.
	...
	/// @notice Withdraw LP tokens from Dialer and harvest proceeds for transaction sender to `to`.
	/// @param pid The index of the pool. See `poolInfo`.
	/// @param amount LP token amount to withdraw.
