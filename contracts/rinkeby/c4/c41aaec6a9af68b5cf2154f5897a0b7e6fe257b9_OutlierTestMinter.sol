...
// OutlierTestMinter = Very simple contract converting mint() + value into FakeERC721.mint()
...
contract OutlierTestMinter {
    event OutlierTestMinted(address sender, uint256 tokenId);
    uint256 constant COST_OF_TEST = 0.001 ether;
    ...
    function mint() external payable {
        require(msg.value == COST_OF_TEST);
        uint256 tokenId = fakeERC721.mint(msg.sender);
        emit OutlierTestMinted(msg.sender, tokenId);
