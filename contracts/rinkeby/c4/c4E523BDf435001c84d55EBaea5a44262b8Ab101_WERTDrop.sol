...
//
//
//  ________  ________  ________  ________   ________  _____ ______   ___  ________   _________   
// |\   ____\|\   __  \|\   __  \|\   ____\ |\   ____\|\   _ \  _   \|\  \|\   ___  \|\___   ___\ 
// \ \  \___|\ \  \|\  \ \  \|\  \ \  \___|_\ \  \___|\ \  \\\__\ \  \ \  \ \  \\ \  \|___ \  \_| 
// \ \  \    \ \   _  _\ \  \\\  \ \_____  \\ \_____  \ \  \\|__| \  \ \  \ \  \\ \  \   \ \  \  
//   \ \  \____\ \  \\  \\ \  \\\  \|____|\  \\|____|\  \ \  \    \ \  \ \  \ \  \\ \  \   \ \  \ 
//    \ \_______\ \__\\ _\\ \_______\____\_\  \ ____\_\  \ \__\    \ \__\ \__\ \__\\ \__\   \ \__\
//     \|_______|\|__|\|__|\|_______|\_________\\_________\|__|     \|__|\|__|\|__| \|__|    \|__|
//                                  \|_________\|_________|                                       
//                                                                                                
...
contract WERTDrop is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
    using Counters for Counters.Counter;

    uint256 public constant MAX_SUPPLY = 1500;
    uint256 public constant MAX_PRESALE_SUPPLY = 1250;
    uint256 public constant MAX_SUPPLY_PER_WALLET = 10;
    ...
    Counters.Counter private redeemCounter;
    ...
    event nftMinted(address to, uint256 start, uint256 end);
    event redeemed(address to, uint256 status);

    constructor(
        uint256 _salePriceETH
    ) ERC721A("New VinylDrop", "NVD") {
    ...
    // Mint with WERT payment
    function publicSaleWithWERT(
        address to,
        uint256 qty
        ...
        require(
            quantityPerWallet[to] + qty <= MAX_SUPPLY_PER_WALLET,
        ...
        emit nftMinted(msg.sender, startTokenId, startTokenId + qty - 1);
    }
    ...
    function preSaleMint(
        uint256 qty, bytes32[] calldata _proof
    ) external payable nonReentrant onlyEOA{
        require(isActive, "Contract: Not Active");
    ...
    function redeem() external {
        require(redeems[msg.sender] == 1, "This wallet cant redeem");

        uint256 startTokenId = _nextTokenId();

        redeems[msg.sender] = 2;
        _mint(msg.sender, 1);
        
        emit nftMinted(msg.sender, startTokenId, startTokenId);
        emit redeemed(msg.sender, 2);
    }

    // Creating Redeem data
    function creatRedeem(address userWallet) external onlyOwner {
        redeems[userWallet] = 1;

        emit redeemed(userWallet, 1);
    }

    // Getting Redeem State
    function redeemState(address userWallet) public view returns (uint256) {
        return redeems[userWallet];
    }
