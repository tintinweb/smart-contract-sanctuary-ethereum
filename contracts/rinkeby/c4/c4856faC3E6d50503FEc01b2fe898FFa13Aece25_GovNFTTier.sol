...
contract GovNFTTier is IGovNFTTier, OwnableUpgradeable, SuperAdminControl {
        ...
        )
    {
        if (_tierLevel.isTraditional) {
            ...
            require(_tierLevel.traditionalTier == 0, "GTL: Can't set traditionalTier");
        }
    ...
    function getNftTierLevel(address _nftContract) external view returns(NFTTierData memory){
