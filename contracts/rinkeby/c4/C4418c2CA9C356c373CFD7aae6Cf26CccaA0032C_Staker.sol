...
contract Staker {
    ...
    function execute() public {
        ...
        require(
            !openForWithdraw && !exampleExternalContract.completed(),
    ...
    function stake() public payable {
        ...
        require(
            ...
            "this contract is not open for staking"
        );
    ...
    function withdraw() public payable {
        require(openForWithdraw, "this contract is not open for withdrawing");

        uint256 tempBalance = balances[msg.sender];
        balances[msg.sender] -= tempBalance;
        bool sent = payable(msg.sender).send(tempBalance);
    ...
    function timeLeft() public view returns (uint256) {
        ...
        uint256 tLeft = deadline - block.timestamp;
        return tLeft;
    }
