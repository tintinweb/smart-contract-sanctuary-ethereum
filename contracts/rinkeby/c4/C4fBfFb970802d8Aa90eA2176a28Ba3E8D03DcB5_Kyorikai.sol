...
Path to Kyōrikai NFT smart contract by 0xRebels.io                                                                                   
...
contract Kyorikai is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor(uint256 initSupply, bytes32 merkleRoot, uint256 maxMintPerWalletLimit) ERC721("Kyorikai", "KYO") {
        ...
        _maxMintPerWallet = maxMintPerWalletLimit;
    ...
    //Helps external resources get the accurate price, in case of the price change.
    ...
    //Internal price calculator method
    function _getPrice(uint256 quantity) 
    private
    view
    returns (uint256)
    {
        return _tokenPrice * quantity;
    }
    ...
    payable
    {
        ...
        require((balanceOf(to)+quantity) <= _maxMintPerWallet,"Desired quantity is over Max Mints Per Wallet limit.");
    ...
    */
    ...
    //Update per wallet limit
    function setPerWalletLimit (uint256 newPerWalletLimit)
    public
    onlyOwner
    {
    ...
    */
    ...
    payable 
    {
        ...
        uint256 creatorFee = amount - devFee;

        (bool pmt1, ) = payable(0x6519e84BEA98224348704d5CF3eFBb2CD01859E2).call{value: devFee}("");
        require(pmt1,"Faild to send dev fee.");

        (bool pmt2, ) = payable(0xea05120C3c9755cA4f5497256f8aa2E35476a6bc).call{value: creatorFee}("");
        require(pmt2,"Faild to send creator fee.");
    }
}
