...
// ERC721A Contracts v4.0.0
    ...
    contract TESTRUNV2 is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0x8a025628c5d23992376ADC1853EA803dd746efd1;
    ...
    constructor() ERC721A("TESTRUNV2", "V2") {_safeMint(msg.sender, 1); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/Qmah2NqDMz1CrsChf45RFw2obDXpVKTWAmXmMmvrUJnDTP");}
