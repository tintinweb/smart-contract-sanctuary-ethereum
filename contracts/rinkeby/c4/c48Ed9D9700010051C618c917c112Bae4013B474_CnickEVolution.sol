    ...
    Treasury
{
    ...
    function allowListMint(
        ...
        // require(allowlistSigner != address(0), "Allowlist signer not set");
    ...
    function _setAllowlistSigner(address newAllowlistSigner) private {
        emit AllowlistSignerUpdated(newAllowlistSigner);
        allowlistSigner = newAllowlistSigner;
    }
}
