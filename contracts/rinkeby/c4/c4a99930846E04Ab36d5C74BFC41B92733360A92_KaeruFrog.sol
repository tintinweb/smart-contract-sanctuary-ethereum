...
contract KaeruFrog is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 6006;
    uint256 Allremain = 6006;
    uint256 public mintRate = 0.003 ether; 
    uint256 MintForWallet = 6006;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = "ipfs://QmfZ4GSUCuMDFd5i7F7BcrYnvStZ7KihgxAhRJUQnr9JoG/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("Kaeru Frog", "KAEF") {}
