...
contract Asset is ERC721Enumerable, ERC721Burnable, ERC721Blacklisted, ERC2981, PausableOwned, Minterable {
  using Address for address;
  ...
  function _beforeTokenTransfer(
    ...
    address _to,
    uint256 _tokenId
  ) internal override(ERC721, ERC721Enumerable, ERC721Blacklisted) whenNotPaused {
