...
// File contracts/ERC721A.sol
    ...
    contract TEST300 is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    ...
    uint256 public freeMaxSupply = 20;
    uint256 public maxSupply = 50;
    uint256 public price = 0.001 ether;
    bool public paused = false; 
    bool public revealed = false;
    mapping(address => uint256) public addressMinted;
    constructor() ERC721A("TEST300", "T300") {setHiddenMetadataUri("ipfs://HIDDEN/hidden.json");}
