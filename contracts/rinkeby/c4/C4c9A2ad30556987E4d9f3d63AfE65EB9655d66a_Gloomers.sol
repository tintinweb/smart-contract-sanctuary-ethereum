...
contract Gloomers is ERC721A, Ownable, GloomersVoucherSigner {  
    ...
    // Minting Function
    function mintGloomers() external payable {
        require(msg.sender == tx.origin);
        require(saleActive, "Public Sale Not Active");
        require(claimedAddress[msg.sender] < MAX_MINT, "You've already claimed your free Gloomer, don't be greedy!");
        require(totalSupply() < MAX_SUPPLY, "All Gloomers have been minted!");
        claimedAddress[msg.sender] += 1;
        _safeMint(msg.sender, 1);
    }

    // Presale Minting
    function mintPresale(GloomersVoucher.Voucher calldata v) public payable {
        require(presaleActive, "Private Sale Not Active");
        require(claimedVouchers[v.voucherId] < MAX_MINT, "You can only claim 1 Gloomer during pre-sale.");
