...
contract TribeXMintPass is ERC721, Ownable, ReentrancyGuard {
	...
	address public CROSSMINT_ADDRESS = 0xdeF952AF6722e6b8af66Ceac00e0Bc1E1B32a447;
	address public TRIBEX_COLD_ADDRESS = 0xdeF952AF6722e6b8af66Ceac00e0Bc1E1B32a447;
	...
	function setTribexColdAddress(address newTribexColdAddress) public onlyOwner {
		CROSSMINT_ADDRESS = newTribexColdAddress;
	}
	...
	function withdraw() public payable onlyOwner nonReentrant {
		// ================This will pay 6%====================================
		(bool phunsuccess, ) = payable(TRIBEX_COLD_ADDRESS).call{value: (address(this).balance * 6) / 100}("");
		require(phunsuccess);
		// ====================================================================
