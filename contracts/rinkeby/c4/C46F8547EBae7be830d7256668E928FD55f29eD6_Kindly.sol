...
contract Kindly is ERC20, Ownable {
    ...
    address public kindlyNFT = 0x0ED353bbc26c4f582675320197b953f80A58Bc8c;
    // KindlyNFTInteraction private knft;
    // KindlyToken public kindlyToken;
        ...
        override(ERC20)
    {
        ...
        //updateKindlyHolderBalance(from, to, amount);
        // after transfer minting or ¿burning? the NFT of the holder is updated
        // KindlyNFT(kindlyNFT).updateKindlyOnHold(from, to, amount);
        KindlyNFTInterface(kindlyNFT).updateKindlyOnHold(from, to, amount);
        // knft.updateKindlyOnHold(from, to, amount);
    }
    ...
    function setKindlyNFTAddress(address kindlyNFTAddress) public {
        ...
        // KindlyToken(kindlyNFTAddress);
        // knft = KindlyNFTInteraction(kindlyNFTAddress);
    }
