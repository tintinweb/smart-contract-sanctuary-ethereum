...
contract BoatsContract is ERC721Enumerable, Ownable, RoyaltiesV2Impl, Pausable {
    ...
    modifier onlyWhenNotMaxSupplyReached() {
        require(totalSupply() + 1 <= MAX_SUPPLY, "Boats: Max Supply reached!");
        _;
    }
    ...
    constructor(
        ...
        require(
            ...
            "Boats: secondary is the zero address"
        );
    ...
    function updateEscrow(address _newEscrow) external onlyOwner {
        require(
            ...
            "Boats: new escrow is the zero address"
        );
    ...
    function updateSecondary(address _newSecondary) external onlyOwner {
        require(
            ...
            "Boats: new secondary is the zero address"
        );
    ...
    function proposeNewOwner(address _proposedOwner) external onlyOwner {
        require(
            ...
            "Boats: proposed owner is the zero address"
        );
    ...
    /// @dev mint new NFTs
    function mint() external payable whenNotPaused onlyWhenNotMaxSupplyReached {
        require(
            msg.value >= nftPrice,
            "Boats: Ether value sent is not correct"
        );
    ...
    {
        require(
            !discountClaimed[msg.sender],
            "Boats: Discount already claimed."
        );
    ...
    function safeOwnershipTransfer() external {
        require(
            ...
            "Boats: Caller is not the proposed owner"
        );
