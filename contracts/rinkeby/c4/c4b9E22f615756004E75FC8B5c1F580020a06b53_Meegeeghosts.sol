...
contract Meegeeghosts is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public notRevealedUri    = "https://meegeeghost-api.onrender.com/api/unrevealed";
    ...
    uint256 public mintState        = 1; // 1 : Member pre-sale, 0: Public-sale
