...
import "../../Beacon/JIMBeaconProxy.sol";
...
contract MarketplaceFactory is Initializable, UUPSUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    function initialize(address _erc721Beacon, address _erc721BeaconProxy, address _erc1155Beacon, address _erc1155BeaconProxy) public initializer {
    ...
    /**
     * @dev Creates an ERC721 token by the caller.
     *
     * @param _tokenName.
     * @param _tokenSymbol.
     * @param _baseUri.
        ...
        nonReentrant 
    {
        ...
        JIM_ERC721 token = JIM_ERC721(address(beaconProxy));
    ...
    /**
     * @dev Creates an ERC1155 token by the caller.
     *
     * @param _uri.
     * @param _salt.
     * 
        ...
        nonReentrant 
    {
        ...
        JIM_ERC1155 token = JIM_ERC1155(address(beaconProxy));
    ...
    {
        return abi.encodeWithSelector(JIM_ERC721(address(ERC721)).initialize.selector, _name, _symbol);
    }
    ...
    function getERC1155Data(string memory _uri) 
        ...
        returns(bytes memory)
    {
        return abi.encodeWithSelector(JIM_ERC1155(address(ERC1155)).initialize.selector, _uri);
    }
        ...
        returns (bytes memory) 
    {
        return abi.encodePacked(
            type(JIMBeaconProxy).creationCode, 
...
contract JIM_ERC1155 is Initializable, UUPSUpgradeable, ERC1155Upgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable {
