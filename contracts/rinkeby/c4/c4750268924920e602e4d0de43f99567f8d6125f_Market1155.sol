...
contract Market1155 is  ERC1155Holder, ReentrancyGuard {
    ...
    function createMarketGift(
        ...
        require(
            msg.sender ==  ownerItem || msg.sender ==  idMarketItem[itemId].seller,
    ...
    function fetchMarketItems() public view returns (MarketItem[] memory) {
        ...
        for (uint256 i = 0; i < itemCount; i++) {
            ...
            for (uint256 j = 0; j < ownerLength; j++) {
                if (payable(idMarketItem[i + 1].ownerArr[j]) == payable(address(0))) {
    ...
    function fetchMyNFTs() public view returns (MarketItem[] memory) {
        ...
        for (uint256 i = 0; i < totalItemCount; i++) {
            ...
            for (uint256 j = 0; j < ownerLength; j++) {
                ...
                if (payable(idMarketItem[i + 1].ownerArr[j])== payable(msg.sender) ) {
