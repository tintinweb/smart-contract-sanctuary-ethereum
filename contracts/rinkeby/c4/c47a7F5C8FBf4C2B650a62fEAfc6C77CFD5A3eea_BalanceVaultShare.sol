...
contract BalanceVaultShare is ERC721AQueryableUpgradeable, OwnableUpgradeable {
    ...
    function getImagePlainText(uint _tokenId) public view returns (string memory) {
        ...
        //    <image x="0" y="0" width="1080" height="1359" href="./b.svg"/>
        //    <rect width="585" height="104" rx="23" transform="translate(100 763)" fill="rgba(255,255,255,0.11)"/>
        //    <rect width="211" height="104" rx="23" transform="translate(100 895)" fill="rgba(255,255,255,0.11)"/>
        //    <rect width="240" height="104" rx="23" transform="translate(100 1025)" fill="rgba(255,255,255,0.11)"/>
        //    <rect width="585" height="104" rx="23" transform="translate(100 1155)" fill="rgba(255,255,255,0.11)"/>
        //    <text transform="translate(100 366)" class="h">Balance Vault Share</text>
        //    <text transform="translate(134 827)" class="b">Repayment: 2022/08/25 16:00</text>
        //    <text transform="translate(134 956)" class="b">APR: 10%</text>
        //    <text transform="translate(134 1085)" class="b">ROI: 0%</text>
        //    <text transform="translate(134 1219)" class="b">Deposited: 100,000.00 USDB</text>
        //    </svg>

        uint index = 0;
        string[] memory parts = new string[](length);
        parts[index++] = '<?xml version="1.0" encoding="UTF-8"?>';
        parts[index++] = '<?xml-stylesheet type="text/css" href="https://gateway.pinata.cloud/ipfs/QmNYb4F4Th5GChBQsS4urB7ScdARaTkgPcjmRzx14nvM2L/s.css" ?>';
        parts[index++] = '<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1359" viewBox="0 0 1080 1359">';
        parts[index++] = '<image x="0" y="0" width="1080" height="1359" href="https://gateway.pinata.cloud/ipfs/QmNYb4F4Th5GChBQsS4urB7ScdARaTkgPcjmRzx14nvM2L/b.svg"/>';
