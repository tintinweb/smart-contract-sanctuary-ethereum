...
contract NFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("TEST2", "TEST2", 30, 10000) {
    maxPerAddressDuringMint = 30;
    amountForAuctionAndDev = 10;
    amountForDevs = 10;
  }
    ...
    callerIsUser
  {
    ...
    require(msg.value >= quantity * publicPrice, 'need more eth.');
    _safeMint(msg.sender, quantity);
  }
  ...
  uint256 public constant AUCTION_END_PRICE = 0.0005 ether;
