...
contract Shinjiro is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHINJ";
    uint8 private _decimals = 9;
    bool private tradingOpen = false;
    address public uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public _maxBuyAmount = 10000000000000000000 * 10**9;
    ...
    uint256 public marketingSharePercentage = 70;
    uint256 public marketinFee;
    ...
    function setMarketingSharePercentage(uint256 marketingSharePercentage_) external onlyOwner {
        marketingSharePercentage = marketingSharePercentage_;
    }
    ...
    function sellTaxTokens() private {
        ...
        if (contractTokenBalance >= numTokensSellToAddToLiquidity && !inSwapAndLiquify && swapAndLiquifyEnabled) {
            ...
            uint256 marketingShareTokens = contractTokenBalance.mul(marketingSharePercentage).div(100);
            uint256 liquidityPoolTokens = contractTokenBalance.sub(marketingShareTokens);
            ...
            swapForMarketing(marketingShareTokens);
        }
    }
    ...
    function swapForMarketing(uint256 marketingShareTokens) private lockTheSwap {
        swapTokensForEth(marketingShareTokens);
