  ...
  GovernorVotesQuorumFraction
{
  constructor(IVotes _token)
    Governor("SkullxGovernor")
    GovernorSettings(
      1, /* 1 block - Delay since proposal is created until voting starts. */
      45818, /* 1 week - Length of period during which people can cast their vote. */
      1000e18 /* Minimum number of votes an account must have to create a proposal. */
    )
