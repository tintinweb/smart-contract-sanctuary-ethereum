...
// File: contracts\TokenSpySenatorCard.sol

// x
pragma solidity ^0.8.4;
contract TokenSpySenatorCard is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TokenSpy Senator Card", "SENATOR") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://meta.tokenspy.org/";
    }
