...
//╚══════╝░  ╚═════╝░░░░╚═╝░░░░╚════╝░
  ...
  constructor(ERC721Enumerable _SayreContract, SayreCurrency _token) { 
...
//╚═╝░░░░░░╚═════╝░╚═╝░░╚══╝░╚════╝░░░░╚═╝░░░╚═╝░╚════╝░╚═╝░░╚══╝╚═════╝░
  ...
  function rewardInfo(address account, uint256[] calldata tokenIds) external view returns (uint256[1] memory info) {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      require(staked.owner == account, "not an owner");
      uint256 stakedAt = staked.timestamp;
      calculateReward = 1000 ether * (block.timestamp - stakedAt) / 10000;
      earned = calculateReward / 1000;
...
contract SayreCurrency is ERC20, ERC20Burnable, Ownable {
  using SafeMath for uint256;
  uint256 constant maxAllowed=1000000*10**18;
  uint256 private _totalSupply;
  uint256 private max;
  mapping(address => uint256) private _balances;
  mapping(address => bool) operators;
  
  constructor() ERC20("Sayre", "SVC") { 
