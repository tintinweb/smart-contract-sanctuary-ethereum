 ...
 * {ERC721Enumerable}.
 */
contract ERC721_test is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    // Token name
    string private _name = 'Test_name';

    // Token symbol
    string private _symbol = 'Test_symbol';
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721_test.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(ERC721_test.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721_test.ownerOf(tokenId), to, tokenId);
    }
