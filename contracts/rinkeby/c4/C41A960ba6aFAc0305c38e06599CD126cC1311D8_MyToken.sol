...
contract MyToken is ERC721, ERC721Enumerable, ERC2981, Ownable {
    ...
    constructor(uint96 _royaltyFee,  string memory _initBaseURI) ERC721("BTS", "BT21") {
        ...
        returns (bool)
    {
     ...
     function setRoyaltyInfo(address _reciver, uint96 _royaltyFees) public onlyOwner{
        _setDefaultRoyalty(_reciver, _royaltyFees);
