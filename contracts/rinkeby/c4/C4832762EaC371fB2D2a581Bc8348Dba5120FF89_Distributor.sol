...
contract Distributor is IDistributor, FiscusAccessControlled {
    ...
    IsFISC private immutable sfisc;
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        // APY Halving
        uint256 circulatingSupply = sfisc.circulatingSupply(); 
        uint16 factor = uint16((circulatingSupply.sub(circulatingSupply.mod(10*10**6))).div(10*10**6));
        return fisc.totalSupply().mul(_rate).div(rateDenominator.mul(2**factor));
        // Original
