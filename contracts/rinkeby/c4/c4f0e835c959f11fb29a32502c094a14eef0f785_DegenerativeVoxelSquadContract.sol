...
//*********************************************************************//
//
//     ____                                        __  _               _    __                __   _____                       __
//    / __ \___  ____ ____  ____  ___  _________ _/ /_(_)   _____     | |  / /___  _  _____  / /  / ___/____ ___  ______ _____/ /
//   / / / / _ \/ __ `/ _ \/ __ \/ _ \/ ___/ __ `/ __/ / | / / _ \    | | / / __ \| |/_/ _ \/ /   \__ \/ __ `/ / / / __ `/ __  / 
//  / /_/ /  __/ /_/ /  __/ / / /  __/ /  / /_/ / /_/ /| |/ /  __/    | |/ / /_/ />  </  __/ /   ___/ / /_/ / /_/ / /_/ / /_/ /  
// /_____/\___/\__, /\___/_/ /_/\___/_/   \__,_/\__/_/ |___/\___/     |___/\____/_/|_|\___/_/   /____/\__, /\__,_/\__,_/\__,_/   
//            /____/                                                                                    /_/                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2386d3eB41BbB72DE74a632a60BE535e775124A5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdXRf69VPyCKaGye7NhNdbbB6oZxuiV8y1DGjvv9unXGV/";
...
// File: contracts/DegenerativeVoxelSquadContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DegenerativeVoxelSquadContract is RamppERC721A {
    constructor() RamppERC721A("Degenerative Voxel Squad", "DEGEN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/UkiEoinwkkPJEIMB166T/contract-metadata";
    }
}
