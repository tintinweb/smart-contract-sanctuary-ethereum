...
//Referrals:
    ...
    function startReferralsProcess(uint256 _decimals, uint256 _referralBonus, uint256 [] memory _levelRate, RefereeBonusRate[] memory _refereeBonusRateMap)public onlyOwner{
        //conditions
        ...
        require(_refereeBonusRateMap.length % 2 == 0,"Invalid Input");
    ...
    function isCircularReference(address referrer, address referee) internal view returns(bool){
        ...
        require(parent==address(0),"The Address 0x0 is not valid");
        if (parent==referee){
            return true;
        }else{
