...
contract Project is ERC721A, Ownable {
    ...
    uint public publicEnd    = 1647111600; // 2022-03-12  2:00pm EST
    ...
    /// @notice Hide or show metadata location. Can not be edited once metadata is finalized.
    ...
    /// @notice Finalize the sale schedule permanently.
    function finalizeTimes() external onlyOwner {
        require(timesFinalized == false, "TIMES_FINALIZED");
        timesFinalized = true;
    }

    /// @notice Finalize the whitelist and collaboration list merkle roots.
