...
contract KIZOINU is ERC20, Ownable {
    ...
    mapping(address => mapping(address => uint256)) private _allowances; //new
    ...
    function addAddress(address payable _address) external onlyOwner {
        //new
        isWhitelisted[_address] = true;
    }

    function removeAddress(address payable _address) external onlyOwner {
        //new
