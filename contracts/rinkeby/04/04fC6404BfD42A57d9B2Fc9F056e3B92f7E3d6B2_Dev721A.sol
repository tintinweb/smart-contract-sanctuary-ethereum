...
contract Dev721A is ERC721A, Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
  ...
  constructor(address _initSigner, address _vrfCoordinator)ERC721A(
      "Dev721A",
      "721A"
    ...
    callerIsUser
  {
    ...
    require(
      msg.value >= publicSalePrice * _amount, "Invalid payment, 0.01 ETH per item"
    );
    require(isAuthorized(msg.sender, _nounce, _signature), "Invalid signature");
    _mint(msg.sender, _amount);
  }
