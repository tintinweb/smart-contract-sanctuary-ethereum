...
contract CMCToken is Initializable, ContextUpgradeable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("Crypto Media Community Token", "CMCT");
        __Ownable_init();
    ...
    function updateBalance(address from, uint amount) public {
        _burn(from, amount);
    }
}
