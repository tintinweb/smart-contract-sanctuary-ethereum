...
contract Vvipmember is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint32 public preSaleStart = 1639702800;
  uint32 public vipSaleStart = 1639702800;
  ...
  mapping(address => uint256) public vipMintAmount;
  ...
  function setVIPSaleStart(uint32 timestamp) public onlyOwner {
  ...
  function setVIPSalePause(bool _state) public onlyOwner {
    vipSalePaused = _state;
  }

  function setVIPMintAmount(address _account, uint256 _amount) public onlyOwner {
    vipMintAmount[_account]=_amount;
  }
