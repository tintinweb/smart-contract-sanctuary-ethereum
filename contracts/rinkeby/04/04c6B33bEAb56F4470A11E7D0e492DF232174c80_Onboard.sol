...
contract Onboard is ERC1155, Ownable {
    ...
    string public Elements =  'ipfs://QmSGgqzw9LnBcwNoJgdFvZH8GjQ863NTqmcwahHm1PkiVZ/';  
    ...
    function mintToken(uint256 _amount) public {
     //   require(_amount > 0, "Amount must be greater than zer0");
        _mint(msg.sender, Bronze, _amount, "");
        supplyBalance[msg.sender][Bronze] += _amount;
    }

    function name() public pure returns (string memory) {
        return "1Hive Onboard";
    }
