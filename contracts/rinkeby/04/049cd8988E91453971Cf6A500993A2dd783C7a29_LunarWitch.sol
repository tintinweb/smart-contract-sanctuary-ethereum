...
/  __ \     | |         ___    /  __ \                           |  _  \    | | |      _ 
| /  \/_   _| |_ ___   ( _ )   | /  \/_ __ ___  ___ _ __  _   _  | | | |___ | | |___  (_)
| |   | | | | __/ _ \  / _ \/\ | |   | '__/ _ \/ _ \ '_ \| | | | | | | / _ \| | / __|    
| \__/\ |_| | ||  __/ | (_>  < | \__/\ | |  __/  __/ |_) | |_| | | |/ / (_) | | \__ \  _ 
 \____/\__,_|\__\___|  \___/\/  \____/_|  \___|\___| .__/ \__, | |___/ \___/|_|_|___/ (_)
                                                   | |     __/ |                         
                                                   |_|    |___/                          
 _                              _    _ _ _       _     
| |                            | |  | (_) |     | |    
| |    _   _ _ __   __ _ _ __  | |  | |_| |_ ___| |__  
| |   | | | | '_ \ / _` | '__| | |/\| | | __/ __| '_ \ 
| |___| |_| | | | | (_| | |    \  /\  / | || (__| | | |
\_____/\__,_|_| |_|\__,_|_|     \/  \/|_|\__\___|_| |_|
...
contract LunarWitch is ERC721A, Ownable, Pausable, PaymentSplitter {
    using SafeMath for uint256;

    // Variables
    uint256 public maxTokens = 6666;
    uint256 public tokenPrice = 0.066 ether;
    bool public publicMintActive = false;
    uint256 public maxTokenPurchase = 10;
    uint256 public tokenReserve = 150;
    bool public presaleMintActive = false;
    uint256 public constant presaleMintMax = 2;
    uint256 public constant presaleMintPrice = 0.05 ether;
    ...
    */
    ...
    address[] private teamWallets = [
        0xE6C4a47A90Dc0C2C8962440C94f59dec2a40cf73, // Charity *** RINKEBY ***
        0x14aC5a4EDC8bea89470403F89EDa4e5d6a003088, // Founder *** RINKEBY ***
        0xb335A50810923f30C21eC4Eb142eB4D962160E02, // Founder *** RINKEBY ***
        0x1f44597432C1C41083cF55169E2CfddbbE0Cd5C0  // Partner *** RINKEBY ***
    ];

    uint256[] private teamShares = [1500, 4000, 4000, 500];

    // Constructor
    //constructor()
    //    PaymentSplitter(teamWallets, teamShares)
    //    ERC721A("Cute & Creepy Dolls: Lunar Witch", "LUNARWITCH")
    //{}

    constructor()
        PaymentSplitter(teamWallets, teamShares)
        ERC721A("Fun Faces 32", "FF32")
    {}
    ...
    */
    function publicMint(uint _numberOfTokens) external payable {
        ...
        require(totalSupply() <= maxTokens, "MAX_SUPPLY_EXCEEDED");
        ...
        require(publicMintActive, "SALE_NOT_ACTIVE");
        require(totalSupply() + _numberOfTokens <= maxTokenPurchase, "MAX_TOKENS_EXCEEDED");
        require(_numberOfTokens <= maxTokens, "MAX_SUPPLY_EXCEEDED");
    ...
    */
    function presaleWhitelistMint(uint256 _numberOfTokens, bytes32[] calldata _merkleProof) external payable {
        ...
        require(totalSupply() + _numberOfTokens <= maxTokens, "MAX_SUPPLY_REACHED");
