...
contract FlypeTokenSale is Ownable{
    ...
    FlypeNFT public immutable Flype_NFT;
    ...
    constructor(FlypeNFT _FlypeNFT, IERC20 _USDC){
        Flype_NFT = _FlypeNFT;
        USDC = _USDC;
    }
    ...
    poolExist(pid)
    {
        ...
        require(pool.takenTickets[_msgSender()] < pool.maxTicketsPerUser, "User cannot buy more that maxTicketsPerUser");
        for(
            ...
            USDC.transferFrom(_msgSender(), address(this), pool.ticketPrice);
            pool.takenSeats++;
