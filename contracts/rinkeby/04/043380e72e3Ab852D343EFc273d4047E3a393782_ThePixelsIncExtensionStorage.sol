    ...
    ThePixelsDigitsUtility
{
    ...
    function disableVariant(uint256 extensionId, uint256 variantId)
        external
        onlyOwner
    {
        variants[extensionId][variantId].isDisabled = false;
    ...
    function enableVariant(uint256 extensionId, uint256 variantId)
        external
        onlyOwner
    {
        variants[extensionId][variantId].isDisabled = true;
        emitVariantChangeEvent(
            extensionId,
            variantId,
            variants[extensionId][variantId]
    ...
    function variantDetails(
        ...
        for (uint256 i; i < variantIds.length; i++) {
            ...
            statusses[i].supply = variant.supply;
            statusses[i].count = variant.count;
            statusses[i].isDisabled = variant.isDisabled;
    ...
    function _extend(
        ...
        require(!_variant.isDisabled, "This variant is disabled");
