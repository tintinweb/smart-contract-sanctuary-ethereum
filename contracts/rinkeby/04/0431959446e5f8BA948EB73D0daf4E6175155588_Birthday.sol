...
contract Birthday is IBirthday, ERC721, ERC721Pausable, ERC721URIStorage, PullPayment, Ownable {
    ...
    bytes[] numbers = [zer, one, two, thr, fou, fiv, six, sev, eig, nin, sls];
    ...
    */
    ...
    function draw(uint id, bool mdy) public view returns (string memory) {
        ...
        for(uint i = 0; i < rows; i++) {
            if (i < 5 || i > 20  || (i >= 10 && i <= 15)) {
                for(uint j = 0; j < ((i == (rows - 1) && !mdy) ? 48 : 50); j++) {
                    output[c] = 0x2E;
                    c++;
                }
                if (i == (rows - 1) && !mdy) {
                ...
                for(uint l = 0; l < ((i >= 16 && i < 21) ? 9 : 5); l++) {
                    output[c] = 0x2E;
                    c++;
                }
                if (i >= 16 && i < 21) {
                    uint k = i - 16;
                    for(uint j = (k * 8); j < ((k * 8) + 8); j++) {
                    ...
                    uint k = i - 5;
                    uint dm = mdy ? month : day;
                    uint md = mdy ? day : month;
                    for(uint j = (k * 8); j < ((k * 8) + 8); j++) {
                        uint day1 = (dm / 10);
                ...
                for(uint m = 0; m < ((i >= 16 && i < 21) ? 9 : 5); m++) {
                    output[c] = 0x2E;
                    c++;
                }
            }
