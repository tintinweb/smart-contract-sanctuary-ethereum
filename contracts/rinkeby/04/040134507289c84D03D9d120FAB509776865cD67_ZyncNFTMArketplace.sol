...
contract ZyncNFTMArketplace is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function createNFTListing(
        ...
        emit ListingCreated(lastListingId, block.number, msg.sender, _nftContractAddress, _tokenId, _price);
        lastListingId++;
    }
        ...
        isNotSettled(_listingId)
    {
        ...
        emit ListingSold(_listingId, block.number, msg.sender);
    }
        ...
        public
    {
        ...
        emit DelistListing(_listingId, block.number);
    }
    ...
    function createNFTAuction(
        ...
        emit AuctionCreated(lastAuctionId, block.timestamp, msg.sender, _price, block.timestamp + _expiry);
        lastAuctionId++;
    }
        ...
        nonReentrant
    {
        ...
        nftAuction[_auctionId].settled = true;
        ...
        emit AuctionSettled(_auctionId, lastBidder, nftAuction[_auctionId].currentPrice);
    }
