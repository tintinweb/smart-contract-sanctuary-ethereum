...
//*********************************************************************//
//
// Crypto Arbitro Smart Contract Deploy
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7BEfCFD6094bcA59ea2983Ec480e3fADfFFE8680];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 251 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNaXgqJiGxiVPkZUSks1cBdwUkx5CwaFDgaA3TwdpcVwX/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 251");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 251");
...
// File: contracts/OutofthisWorldDudesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OutofthisWorldDudesContract is RamppERC721A {
    constructor() RamppERC721A("Out of this World Dudes", "OTWD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/QGkrtk9YhHfBrT4Nrstm/contract-metadata";
    }
}
