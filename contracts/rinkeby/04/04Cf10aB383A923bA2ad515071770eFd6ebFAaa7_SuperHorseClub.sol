...
contract SuperHorseClub is ERC721, Ownable, ReentrancyGuard {
    ...
    string private baseURI; //update done
    string private unrevealedTokenURI; //update done
    uint256 public maxTokens = 10000;
    uint256 public maxPresaleTokens = 6000; //update done
    uint256 public maxTokensPerWallet = 2; //update done
    uint256 public maxMintPerTxPresale = 2; //update done
    uint256 public maxMintPerTx = 2; //update done
    ...
    constructor() ERC721("SuperHorseClub", "SHC") {}
    ...
    function updateMaxPresaleTokens(uint256 _maxPresaleTokens)
        external
        onlyOwner
    {
    ...
    /*
    * update Max Tokens limit Per Wallet
    */
    function updateMaxTokensPerWallet(uint256 _maxTokensPerWallet)
        external
        onlyOwner
    {
    ...
    /*
    * update Max Mint Per Tx pre sale
    */
    function updateMaxMintPerTxPresale(uint256 _maxMintPerTxPresale)
        external
        onlyOwner
    {
    ...
    /*
    * update Max Mint Per Tx public sale
    */
    ...
    */
     ...
     * Mints Super Horse
     */
    function mintSuperHorse(uint256 _amount) public payable {
