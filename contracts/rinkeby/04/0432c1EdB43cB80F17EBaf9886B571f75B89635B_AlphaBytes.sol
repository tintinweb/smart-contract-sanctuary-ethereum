...
import "./library/ERC165.sol";
import "./library/ERC721.sol";
import "./library/ERC721Enumerable.sol";
import "./library/IERC165.sol";
import "./library/IERC721.sol";
import "./library/IERC721Enumerable.sol";
import "./library/IERC721Metadata.sol";
import "./library/IERC721Receiver.sol";
...
contract AlphaBytes is ERC721Enumerable, Ownable {
  ...
  function gift(uint256 _tokenId, address _to) public onlyOwner {
    ...
    require(minted[_tokenId] == false, "NFT already minted");
