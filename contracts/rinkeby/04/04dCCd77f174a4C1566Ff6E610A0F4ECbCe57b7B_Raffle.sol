...
// Winner to be randomly selected every X minutes
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    enum RaffleState {
        OPEN,
        CALCULATING
    } // basically a uint256 0=OPEN, 1=CALCULATING
    /* State Variables */
     ...
     * they look for the `upkeepNeedded` to return true
    ...
    // can be pure function since it is in the byte code
