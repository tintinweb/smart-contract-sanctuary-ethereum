...
contract WINS is ERC721AQueryable, Payable {
    ...
    uint16 private allowancePlusOne = 2;
    ...
    constructor() ERC721A("Wolves in NFT St", "WINS") Payable() {} //FIXME Name
     ...
     * @dev Ensure the user allocation is valid.
     */
     ...
     */
    function mintReserved(uint16 numTokens, address mintTo) external onlyOwner {
        require((_totalMinted() + numTokens) < MAX_SALE_P1, "WINS: Exceeds available tokens");
     ...
     */
    function saleClaims(address owner) public view returns (uint256[5] memory) {
        return [
            uint256(saleState),
            MAX_SALE_P1 - 1,
            totalSupply(),
...
contract Payable is Ownable, ERC2981 {
    constructor() {
        // Set royalties
        _setRoyalties(0x0000000000000000000000000000000000000001, 1000); //FIXME
    }
