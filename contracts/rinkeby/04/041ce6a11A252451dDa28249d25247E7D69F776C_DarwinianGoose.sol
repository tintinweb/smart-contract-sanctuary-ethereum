...
// File: contracts/DarwinianGoose.sol
...
/*
  ...
  _____                      _       _                _____
 |  __ \                    (_)     (_)              / ____|
 | |  | | __ _ _ ____      ___ _ __  _  __ _ _ __   | |  __  ___   ___  ___  ___
 | |  | |/ _` | '__\ \ /\ / / | '_ \| |/ _` | '_ \  | | |_ |/ _ \ / _ \/ __|/ _ \
 | |__| | (_| | |   \ V  V /| | | | | | (_| | | | | | |__| | (_) | (_) \__ \  __/
 |_____/ \__,_|_|    \_/\_/ |_|_| |_|_|\__,_|_| |_|  \_____|\___/ \___/|___/\___|

*/

/**
 * @title DarwinianGoose contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract DarwinianGoose is
    ERC721AQueryable,
    ERC721ABurnable,
    Ownable,
    Pausable,
    ReentrancyGuard
{
    ...
    uint256 public constant FREE_MINT_QUANTITY = 1;
    ...
    {
        uint256 mintedQuantity = minted[_msgSender()];
        if (mintedQuantity + numberOfTokens <= FREE_MINT_QUANTITY) {
            require(msg.value == 0, "Ether value sent is not correct");
        } else if (mintedQuantity > FREE_MINT_QUANTITY) {
            require(
            ...
            require(
                price.mul(
                    mintedQuantity + numberOfTokens - FREE_MINT_QUANTITY
                ) == msg.value,
                "Ether value sent is not correct"
            );
        }
