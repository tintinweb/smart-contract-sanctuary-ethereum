...
contract EtherRoomDemo is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;

    bytes32 public wlMerkleRoot = 0x970a960079defa58ec59bc6bcb6effa7e1a57200b0da90a24bc430f28b170053;
    bytes32 public freeMerkleRoot = 0x970a960079defa58ec59bc6bcb6effa7e1a57200b0da90a24bc430f28b170053;
    ...
    uint256 private _salePrice = 0.001 ether;

    bool private _saleConcluded = false;

    string private _baseTokenURI = "https://etherroom.mypinata.cloud/ipfs/QmXvUffUHkHaPjEoBLGGkpyLwCTqA7yB91ku32z8JpfpGA/";
    ...
    constructor() ERC721A("EtherRoomDemo", "ERD") { }
    ...
    function freeSaleMint(bytes32[] calldata _merkleProof) external payable nonReentrant onlyEOA {
