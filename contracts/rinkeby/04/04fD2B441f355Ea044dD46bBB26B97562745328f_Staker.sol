...
contract Staker {
    ...
    /**
  * @notice update the user's balance 
    @notice kullanıcının bakiyesini güncelle
  */
    function stake() notCompleted public payable {
        ...
        if (contractBalance >= threshold) {
            //İşlemi tamamla. Daha sonraları butona kimse basamasın!
    ...
    function execute() public notCompleted deadlineReached(false) {
        ...
        // Sözleşmede yeterince bakiye olup olmadığını kontrol eden require komutumuz.
        require(contractBalance >= threshold, "You cannot reached thresold!");
    ...
    // withdraw() fonksiyonu ile kullanıcılardan eşiğe gelemeyenler paralarını geri alabilsin.
    function withdraw() public deadlineReached(true) notCompleted {
        ...
        //Fonksiyon sonucu başarılı sonuç dönmezse hata fırlatılır ve fonksiyon tamamlanmaz.
        require(sent, "Failed to send user balance back to the user");
    }

    // Add a `timeLeft()` view function that returns the time left before the deadline for the frontend
    //Ne kadar süre sonra bahis bitecek?
