...
contract EyeNft is ERC721, Ownable {
    ...
    constructor() ERC721("EyeNFT", "ENFT") {
    }
    ...
    function mintToken(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0, "Can only mint 5 tokens at a time");
        require(supply.add(numberOfTokens) <= maxSupply, "Purchase would exceed max supply of tokens");
