...
contract Juicebox1155 is ERC1155, Ownable, ERC1155Burnable {
    ...
    Juicebox721Contract public juicebox721Contract;

    constructor(address _juicebox721Contract, string memory _name, string memory _symbol)
        ERC1155("https://ipfs.io/ipfs/QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/3")
    {
        name_ = _name;
        symbol_ = _symbol;
        juicebox721Contract = Juicebox721Contract(_juicebox721Contract);
    }
    ...
    // set Juicebox ERC721 contract
    function setJuicebox721Contract(address _contract) public onlyOwner {
        juicebox721Contract = Juicebox721Contract(_contract);
    }
    ...
    function mint(uint256 _count) public payable callerIsUser {
        ...
        require(_count + amountMinted <= maxsupply, "Limit reached");
    ...
    function migrateBatch(uint256 _count) public {
        ...
        juicebox721Contract.mintTransfer(msg.sender, _count);
