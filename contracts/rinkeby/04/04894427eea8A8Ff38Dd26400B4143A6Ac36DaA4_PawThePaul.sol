...
contract PawThePaul is ERC721URIStorage, Ownable {
    ...
    function checkTokenCounter() external returns (uint256) {
        return tokenIdCounter.current();
    }

    // function uintToString(uint256 v) returns (string str) {
        ...
        override
    {
        ...
        _tokenURIs[tokenId] = string(abi.encodePacked(_tokenURI, ext));
    }
