...
contract Standard is ERC721A, Ownable {
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        if (!isRevealed) {
            ...
            return string(abi.encodePacked(_baseTokenURI, _tokenId)); // NOTE: ammended from _tokenId.toString() to just _tokenId due to top part removing line "using Strings for uint256;" line 9
        }
    }
