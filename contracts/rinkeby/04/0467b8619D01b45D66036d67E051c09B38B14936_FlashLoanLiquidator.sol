...
contract FlashLoanLiquidator is LiquidatorBase, IFlashLoanReceiver {
  ...
  function executeOperation(
    ...
    IERC20(params.debtAsset).approve(
    ...
    IERC20(params.collateralAsset).transfer(owner(), transferToOwner);

    // Approve the LendingPool contract allowance to *pull* the owed amount
    IERC20(assets[0]).approve(address(CONFIG._flashLoanPool()), amountOwing);
