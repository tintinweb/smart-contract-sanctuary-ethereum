...
// File: contracts/PiaBull.sol
    ...
    contract PiaBull is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public  tokenPrice = 1900000000000000; // 0.0019 ETH 
      ...
      uint256 public devReserve = 2000;
    
      event PiaBullMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("PiaBullNew", "PB") {}
      ...
      function mintPiaBull(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit PiaBullMinted(id, msg.sender);
          }
        }
      }
    
      function presalePiaBull(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmaYcNPSgDHmJcrJ8aCEwqKCnLcEttZyo488st1Mp7hYyB/hidden.json";
        }
