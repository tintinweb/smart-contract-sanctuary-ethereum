...
contract EIPAPlug is ERC1155Holder, Ownable, AccessControl {
    ...
    function _mint(uint tokenId, uint amount) internal {
        ...
        eipa.mintExtensionExisting(addresses, tokenIds, amounts);
    ...
    function initializeToken(address addr, uint amount) external onlyRole(SUPPORT_ROLE) {
      ...
      uris[0] = "";
      eipa.mintExtensionNew(to, amounts, uris);
    }
