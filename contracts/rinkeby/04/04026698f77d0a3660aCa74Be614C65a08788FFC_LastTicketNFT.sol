...
contract LastTicketNFT is ERC721, Ownable {
    ...
    function mint(uint256 quantity_) public payable {
        ...
        for (uint256 i = 0; i < quantity_; i++) {
            ...
            totalSupply++; // affect - change of any variable in storage - must occur before interaction to prevent re-entrancy attack
