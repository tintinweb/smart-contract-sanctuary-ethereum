...
contract PurrnelopesGrandmas is ERC721, Ownable, ERC721Enumerable, Iminter, ReentrancyGuard {
    using Counters for Counters.Counter;
    using SafeMath for uint256;
    using Strings for uint256;

    Counters.Counter private CurrentTokenId;
    address public AllowedAddress = 0x8494B9FD7c93c60b31695342AE49a9d7be95e878; //mainnet ticket - 0xDa7D42B6167f1497346D7B2336a6D7A603026Db1
    IERC721 public CatContractAddress = IERC721(0x1EC61E200d56F1fD46D24BDeB544F85e18B6D658); //mainnet cats - 0x9759226B2F8ddEFF81583e244Ef3bd13AAA7e4A1
    uint256 public MaxMintCount = 50;
    uint256 public MaxSupplyCount = 100;
    string public BaseURI;
    string private superSecretBaseURI;
    ...
    function updateCatContract(IERC721 _catContract) public onlyOwner{
        CatContractAddress = _catContract;
    }
    ...
    function isApprovedForAll(address account, address operator) public view virtual override(ERC721, IERC721) returns (bool) {     
    ...
    ///Duplicate setBaseURI method
    function setBaseURl(string calldata _uri) public onlyOwner{
        superSecretBaseURI = _uri; //nothing on the blockchain is secret.
    }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory alternate_super_secret_uri = bytes(baseURI).length > 0 ? string(abi.encodePacked(superSecretBaseURI, _tokenId.toString())) : "";
             
        return (ownerOf(_tokenId) == BurnAddress) ? BurnUri : isOwnerOfCat(_tokenId) ? alternate_super_secret_uri : uri;
    }

    //"random" number.... using chainlink for VRF is overkill
