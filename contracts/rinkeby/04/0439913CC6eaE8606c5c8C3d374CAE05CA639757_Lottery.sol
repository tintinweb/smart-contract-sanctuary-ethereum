...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
  ...
  uint256 private constant MIN_ENTER_AMOUNT = 10000000000000000;
  ...
  uint256 public immutable i_internal;
  ...
  constructor(uint64 subscriptionId, address vrfCoordinator, bytes32 keyHash, uint256 intervalSeconds) VRFConsumerBaseV2(vrfCoordinator) {
    COORDINATOR = VRFCoordinatorV2Interface(vrfCoordinator);
    i_owner = msg.sender;
    i_subscriptionId = subscriptionId;
    i_internal = intervalSeconds;
  ...
  function checkUpkeep(bytes memory /*checkData*/) public override view returns (bool upkeepNeeded, bytes memory) {
    ...
    upkeepNeeded = ((block.timestamp - s_lastTimeStamp) > i_internal) &&
