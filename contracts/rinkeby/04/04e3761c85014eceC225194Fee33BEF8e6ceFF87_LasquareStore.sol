 ...
 */
contract LasquareStore is RoyaltiesV2Impl, ERC721Upgradeable, OwnableUpgradeable {
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2 {
    function getLasquareV2Royalties(uint256 id) override external view returns (LibPart.Part memory) {
        return royalties[id];
    }
...
interface RoyaltiesV2 {
    ...
    function getLasquareV2Royalties(uint256 id) external view returns (LibPart.Part memory);
}