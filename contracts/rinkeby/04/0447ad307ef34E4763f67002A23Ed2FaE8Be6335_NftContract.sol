...
contract NftContract is ERC1155Supply,Ownable {
  ...
  function setMaxTokensPerUserPrivateSale(uint256 _maxTokensPerUserPrivateSale) public onlyOwner{
      maxTokensPerUserPrivateSale=_maxTokensPerUserPrivateSale;
  }
  function setMaxTokensPerMintPublicSale(uint256 _maxTokensPerMintPublicSale) public onlyOwner{
      maxTokensPerMintPublicSale=_maxTokensPerMintPublicSale;
  }
  function setMaxTokensPerMintPrivateSale(uint256 _maxTokensPerMintPrivateSale) public onlyOwner{
  ...
  function mint(uint256 id,uint256 numberOfTokens) public payable {
    ...
    function addPrivateSaleBuyer(address user)public onlyOwner{
