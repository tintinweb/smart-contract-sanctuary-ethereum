...
//  / /  / / /_/ / /_/ / / / /  / /|  /  __/ /__/ ,< (__  ) 
// /_/  /_/\____/\____/_/ /_/  /_/ |_/\___/\___/_/|_/____/  
//                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3d29190A803335F6Cf62215Ce73aE4AA73B9192C,0xB9d96dbc5083FEc4a29b7c493eC08Bf6aE75215f];
  uint256[] public payableFees = [5,25,70];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 5000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdRmes6e22Ak66WKFdmwPondVZ5TLb12rM7ysh4jMuWAE/";
...
// File: contracts/MoonNecksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoonNecksContract is RamppERC721A {
    constructor() RamppERC721A("Moon Necks", "Necks"){}
}
