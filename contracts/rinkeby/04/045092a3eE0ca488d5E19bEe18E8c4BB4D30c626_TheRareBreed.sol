...
Share 50% of all NFT resale royalties profits with holders. Original minters will receive royalties for life.
*/
...
contract TheRareBreed is Ownable, ERC721A, ReentrancyGuard {
    ...
    function reserveMint(uint256 quantity, address to) public onlyOwner {
        require(
