...
// File: contracts/SatoshiClubCollection.sol
...
contract Satoshi_Club_Collection is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 1333;
    uint public _price = 0.1 ether;
    uint256 public maxBuyPerTx = 1;
    bool public paused;
    

    constructor() ERC721A("Satoshi Club Collection", "SCC") {
        paused = true;
    }
    // Read the price
