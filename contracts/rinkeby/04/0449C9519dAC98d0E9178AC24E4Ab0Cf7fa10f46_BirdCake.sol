...
contract BirdCake is ERC721   {
    ...
    constructor(string memory name, string memory signal, address payable _reciever) ERC721 (name,signal){
        _creator = msg.sender;
        reciever = _reciever;
        tokenIds = 0;
    }
    ...
    function mintCollectable(
        ...
        string memory attributes
         ...
         nftHolderAttributes[tokenIds] = NFTAttributes({
            name: name,
            imageURI: image,
