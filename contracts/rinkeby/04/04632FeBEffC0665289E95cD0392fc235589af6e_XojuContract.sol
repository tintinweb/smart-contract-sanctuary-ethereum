...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5B663d856339D8077a2F35f8747F1A527EA05BB9];
...
// File: contracts/XojuContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract XojuContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "XOJU";
    string public symbol = "XOJU";
