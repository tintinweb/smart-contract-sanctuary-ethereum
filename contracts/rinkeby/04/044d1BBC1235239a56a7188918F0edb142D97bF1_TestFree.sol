// SPDX-License-Identifier: MIT
    ...
    contract TestFree is ERC721, Ownable, ERC721Enumerable {
      ...
      event FreelanceMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("TestFreelancer", "FREE") {}
      ...
      function mintFreelance(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit FreelanceMinted(id, msg.sender);
          }
        }
      }
    
      function presaleFreelance(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmX5VAMxKcXvLgY9gVfrfWXqGsqp2tuKndf5bwXWsGRX3f/Freelancer.png";
        }
