...
contract SpicerPhidiSpace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Spider Phidi Space", "SPS") {
    setHiddenMetadataUri("ipfs://QmdnKmcaLf7f3zE1Et6zmWYp1B4HZjVxix15XRbQkG6AQg/hidden.json");
  }
