...
contract MillionR_V1 is Initializable, ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function addVipMember(address _account) public payable {
        require(vipMembersBalance > 0, "Not more vip members");
        require(msg.value > 0.5 ether, "Not enough ether sent");

        _membership.set(vipMembersBalance, _account);
        _safeTransferFrom(address(this), _account, vipMembersBalance, 1, "");
