...
contract OSB721 is ERC721Enumerable {
    ...
    constructor(string memory _name, string memory _symbol, address _sale) ERC721(_name, _symbol) {
        sale = _sale;
    }
    ...
    function mint(uint256 _times) external returns(uint256[] memory) {
...
contract $OSB721 is OSB721 {
    constructor(string memory _name, string memory _symbol, address _sale) OSB721(_name, _symbol, _sale) {}
