...
contract BuybackDripper is AccessControl {
    ...
    /// @dev 730 is average amount of hours in month of a perfect year
    uint256 public nextPeriodDuration = 730;

    /// @notice Drip rate that will be used at next period start
    uint256 public nextPeriodRate;
    ...
    function resetPeriod(uint256 newStart) private {
        require(nextPeriodRate > 0, ErrorCodes.RATE_IS_NOT_SET);
