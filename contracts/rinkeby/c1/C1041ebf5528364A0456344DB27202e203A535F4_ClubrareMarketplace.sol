    ...
    EIP712Upgradeable
{
    ...
    function validateOrder(
        ...
        validateOrderParameters(order,amount);
    ...
    function validateOrderParameters(Order memory order, uint256 amount) internal pure returns (bool) {
        require(order.seller != address(0),"zero address");
        require(order.basePrice > amount,"amt");
        require(order.contractAddress != address(0),"zero contract address");
