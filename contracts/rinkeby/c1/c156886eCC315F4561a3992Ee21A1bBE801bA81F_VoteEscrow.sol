...
contract VoteEscrow is ERC20Votes, ReentrancyGuard, IVotingEscrow {
    ...
    uint256 public override lockedWTRsupply;
    ...
    // @dev get current ve balance based on voting power for account
    function balanceOf(address account) public view virtual override returns (uint256) {
        return votingPowerUnlockTime(locked[account].amount, locked[account].end);
    }
...
interface IVotingEscrow {
    ...
    function lockedWTRsupply() external view returns (uint256);
}
