...
contract CommunityLeaderboard is Ownable {
    ...
    //added
    function getProjectOwners(uint256 _projectId) external view returns (address) {
        return projectIdToProject[_projectId].ownersArr[_projectId];
    }
    ...
    function registerProject(address _nftContract, string memory _name) public {
        ...
        emit projectRegistser(_nftContract, _name);
    }
