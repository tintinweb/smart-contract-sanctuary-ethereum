...
contract PoolToken is Ownable {
    address public PL = 0x661B3a9297E8bee53602cA3E8140ff0555f725ED;
    struct UserInfo {
    ...
    function setAdmin(address account, bool allowance) external onlyAdmins {
    ...
    function claimToken(address recepient) external  {
        ...
        IERC20(PL).transfer(recepient, totalToken);
