...
contract StcV1 is Ownable, ERC721A, ReentrancyGuard {
    ...
    address watcherddress = 0xF9951627EcD7F94890A0b325C91C63FD963C011C;
    WatcherInterface watcherContract = WatcherInterface(watcherddress);


  constructor(
  ) ERC721A("StcV1", "Stc1", mintLimit, _totalSupply) {
     tokenCount = 0;
  }
  ...
  function _ModeC(uint256 tokenId) public{
    require(ownerOf(tokenId) == msg.sender, "You are not the holder of this token.");
