    ...
    Ownable
{
     ...
     */
    event Staked(address owner, address pass, uint256 tokenId, int64 stakedTS);

    /**
     * Emited when a new pass is staked.
     */
    event Unstaked(address owner, address pass, uint256 tokenId);

    /**
     * Emited when a rewards claimed.
     */
    event RewardsClaimed(address owner, uint256 tokenId, uint256 amount);
