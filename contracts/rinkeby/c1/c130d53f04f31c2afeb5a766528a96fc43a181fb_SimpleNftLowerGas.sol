...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("NOTOKIEBEAR", "NOKBEAR") {
    setHiddenMetadataUri("ipfs/QmSK8jptm3Y4z7b3eZ4msQDAfUWtNZNTMueXtj9bxRvRzm/_metadata.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x7C6db15B05465ffB013C9b81611DB3fD368c4a6A).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
