...
contract Staker {
  ...
  function stake() public payable {
    require(msg.value > 0, "Can't accept zero deposit!");
  ...
  function execute() public {
    if (timeLeft() == 0) {
      require(address(this).balance >= threshold, "Threshold isn't met yet!");
      openForWithdraw = false;
      exampleExternalContract.complete{value: address(this).balance}();
    }
    else {
      require(address(this).balance < threshold, "Balance is over the threshold");
  ...
  function withdraw() external {
    ...
    if (exampleExternalContract.completed() == false) {
      ...
      require(openForWithdraw == true, "Not allowed to withdraw yet!");
      require(balances[reciever] > 0, "You have nothing to withdraw!");
      reciever.transfer(balances[reciever]);
    }
    else if (exampleExternalContract.completed() == true) {
      require(balances[reciever] > 0, "You have nothing to withdraw!");
      exampleExternalContract.withdraw(reciever, balances[reciever]);
    }
    balances[reciever] = 0;
  }
