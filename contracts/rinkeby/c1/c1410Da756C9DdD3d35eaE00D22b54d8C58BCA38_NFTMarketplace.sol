...
// credit to https://github.com/CryptoUGuy/hackdays/blob/main/examples/contracts/nft-marketplace/SimpleNFTMarketplace.sol
...
contract NFTMarketplace {
    ...
    function publishItem(
        ...
        // validate
        // no fees :)
        require(_price >= 0, "Price must be nonzero");

        // increment and store item
