...
contract ERC721ANFT is ERC721A, Ownable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string private _baseTokenURI;
    string private _contractUri;
    string private name_ = "MrX";
    string private symbol_ = "XYZ";

    constructor() ERC721A(name_, symbol_) {
        // string memory name_, string memory symbol_
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
         _baseTokenURI = "https://theavenue-market.s3.amazonaws.com/MrX/NFT/";
         _contractUri = "https://theavenue-market.s3.amazonaws.com/MrX/contract.json";
    }
