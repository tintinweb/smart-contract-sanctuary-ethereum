...
contract vmfer is ERC721, Ownable {
    ...
    address public otherTokenAddress =
        0xCFf0C4698BbaB4d248dE08E55AB91881f2FaC38f;
        ...
        mintCompliance(_mintAmount)
    {
        ...
        uint256[] memory _otherTokenAddress = walletOfOwnerOfOtherContract(
            msg.sender,
            secondTokenAddress
        );
        ...
        if (givedAway >= 500) {
            ...
            if (ownedOtherToken.length > 0 || _otherTokenAddress.length > 0) {
