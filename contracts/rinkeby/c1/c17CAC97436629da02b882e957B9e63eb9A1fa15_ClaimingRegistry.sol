...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant VOTING_DURATION = 1 hours;
    uint256 internal constant PRIVATE_CLAIM_DURATION = 2 hours;
    uint256 internal constant VIEW_VERDICT_DURATION = 1 days;
    ...
    function votingDuration(uint256 index)
        public
        view
        override
        withExistingClaim(index)
    ...
    function validityDuration(uint256 index)
        ...
        returns (uint256)
    {
        return VOTING_DURATION.add(VIEW_VERDICT_DURATION);
    }
    ...
    function hasProcedureOngoing(address poolAddress)
        external
        view
        override
        onlyPolicyBooks
