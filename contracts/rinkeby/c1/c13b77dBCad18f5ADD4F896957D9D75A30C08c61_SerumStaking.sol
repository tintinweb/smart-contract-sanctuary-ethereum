...
contract SerumStaking is ERC1155, ISerumStaking, IERC721Receiver, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public timeToStakeForReward = 10;
        ...
        returns (string memory)
    {
        ...
        return bytes(_uri).length > 0 ? string(abi.encodePacked(_uri, SERUM.toString())) : _uri;
    }
