...
contract MintMyFiles is ERC721Enumerable, Ownable {
    ...
    event welcomeToMMF(uint256 indexed id);

    constructor(string memory baseURI) ERC721("Mint My Files", "MMF"){
        setBaseURI(baseURI);
    }
    ...
    function mint(string memory baseURI) public payable {
        setBaseURI(baseURI);
        uint256 total = totalToken();
        address wallet = _msgSender();
        _mintAnElement(wallet, total);
    }
