...
// File: contracts/TestTLS-after_reveal_problem2.sol
...
contract TheLittleSurfers is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdrawTotal() external onlyOwner {
        ...
        payable(address(0x00f4d015FE0730dE20c309de0D43A18AB191EEFF)).transfer(balance.mul(15).div(100));

        balance = address(this).balance;
        payable(address(0xdA4ebC00eA56e9795f5A97b722D822a9BEB5693F)).transfer(balance); // 27.5, rest of balance
    }
