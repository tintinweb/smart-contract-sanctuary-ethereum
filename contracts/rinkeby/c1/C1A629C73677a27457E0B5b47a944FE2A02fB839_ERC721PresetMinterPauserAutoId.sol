    ...
    ERC721Pausable
{
    ...
    uint256 public totalAllowedNFTs;
    ...
    function init(bytes memory _encodedData) external {
        ...
        (_name, _symbol, owner, baseURI, totalAllowedNFTs) = abi.decode(
            _encodedData,
    ...
    /**
     * Sets _baseURI for the NFTs.
     * It can only be set by admin.
     */
    function setBaseURI(string memory _baseURI) external {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "ERC721PresetMinterPauserAutoId: must have admin role to set URI"
        );
    ...
    function mint(address to) public virtual {
        require(_tokenIdTracker.current() < totalAllowedNFTs, "Toal number of NFTs minted");
        require(
