...
contract primotest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("primotest", "pt") {
    setHiddenMetadataUri("ipfs://QmZ1d7JYhW4Lo66AHQDnaEsTrNLjv95WmFCoQNMRByzgnt/hidden.json");
  }
