...
contract PGT29 is ERC721Enumerable, Ownable {
    // Qty
    ...
    constructor(string memory baseURI) ERC721("PlayGT29", "PGT29") {
    ...
    function auctionMint(uint256 _qty) external payable {
        ...
        uint timeElapsed = (block.timestamp - AUCTION_START_TIME) / 60 / 60;
        uint currentPrice;
