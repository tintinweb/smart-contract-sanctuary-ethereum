...
contract KokoroClubNFT is Ownable, ERC721A, ReentrancyGuard {
        ...
        isValidMerkleProof(merkleProof, whitelistMerkleRoot)
    {
        ...
        if (maxPerAddressDuringMint > 0) {
            require(whitelistAddressMintedCnt[msg.sender] < maxPerAddressDuringMint, "Address already mint");
        }
        whitelistAddressMintedCnt[msg.sender] = whitelistAddressMintedCnt[msg.sender] + 1;
    ...
    function publicSaleMint(uint256 quantity) external payable callerIsUser {
        ...
        if (maxPerAddressDuringMint > 0) {
            require(addressMintedCnt[msg.sender] < maxPerAddressDuringMint, "Address already mint");
        }
        addressMintedCnt[msg.sender] = addressMintedCnt[msg.sender] + 1;
        require(totalSupply() + quantity <= nowMaxSupply, "reached max supply");
        _safeMint(msg.sender, quantity);
