...
contract PixelBadzNFT is Initializable, OwnableUpgradeable, ERC721URIStorageUpgradeable, VRFConsumerBaseUpgradeable {
        ...
        initializer
    {
        ...
        merkleRoot = 0x9fa9fb63f4f4859b3dffe0c4103ba2756cf6597d09ea38b7f70e20916783499e;
        startingIndex = 0;
        maxWhitelistTokens = 3;
        isRedemptionActive = false;
        isSaleActive = false;
        provenanceUrl = "";
    }

    function redeemFromWhitelist(address account, uint256 tokenId, bytes32[] calldata proof)
    external payable
    {
        ...
        require(account == msg.sender, "Only owner of the account can redeem");
        require(userTokens[msg.sender] < maxWhitelistTokens, "User has exceeded redeption of whitelisted tokens");
    ...
    function getRandomStartingIndex() public onlyOwner returns (bytes32 requestId) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        uint256 d20Value = (randomness % maxTokens) + 1;
        startingIndex = d20Value;
    }
