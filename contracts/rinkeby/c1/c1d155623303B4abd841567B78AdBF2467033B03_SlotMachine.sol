...
contract SlotMachine is VRFv2Consumer, ReentrancyGuard, Ownable, Pausable {
    ...
    function calculateReward(
        ...
        if (firstRandom == 6 && secondRandom == 6 && thirdRandom == 6) {
            ...
            (firstRandom == secondRandom) || (firstRandom == thirdRandom) || (secondRandom == thirdRandom)
        ) {
            return rollPrice;
        } else {
            return 0;
    ...
    event Roll(uint256 first, uint256 second, uint256 third, uint256 reward, uint256 requestId);
