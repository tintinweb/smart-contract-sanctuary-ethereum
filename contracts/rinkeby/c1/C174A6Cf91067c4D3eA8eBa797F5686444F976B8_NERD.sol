...
contract NERD is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public ETH_PRICE = 500000000000000; // 0.0005 ETH
    uint256 public FOOD_PRICE = 500000000000000;
    ...
    function mintWithFoodToken(uint numberOfTokens) public {
        ...
        FOOD.transfer(address(this), numberOfTokens * FOOD_PRICE);
    ...
    function action_A(uint tokenId) public {
        require(tx.origin == msg.sender, "You dont own");
        ...
        require(FOOD.balanceOf(msg.sender) >= 5000000000, "FOOD token is not enough");

        FOOD.transfer(POOL, 5000000000);
