...
contract BlahNFT is BlahNFTScore {
    ...
    function uploadMetadata(BlahNFTTypes.City[] memory _cities) external onlyOwner {
        require(idToCities[MAX_CITIES].countryFaction == 0 || idToCities[MAX_CITIES - FOUNDERS_RESERVE_AMOUNT].countryFaction == 0, "All cities already have metadata uploaded");

        for(uint i = 0; i < _cities.length; i++) {
            //if there is no data for this city already but it has been minted
            if(idToCities[_cities[i].id].countryFaction == 0 && idToCities[_cities[i].id].id != 0) {
                idToCities[_cities[i].id].city = _cities[i].city;
                idToCities[_cities[i].id].country = _cities[i].country;
                idToCities[_cities[i].id].image = _cities[i].image;
                idToCities[_cities[i].id].points = _cities[i].points;
                idToCities[_cities[i].id].countryFaction = _cities[i].countryFaction;
            } else if(idToCities[_cities[i].id].id != 0) {  //has been minted
                //just update the contry faction
                idToCities[_cities[i].id].countryFaction = _cities[i].countryFaction;
            }
        }
    }
    ...
    string[] d = [
        "m41.924196 8h20v4h-20z",
        "m50.656487 8.917801h20v4h-20z",
        "m59.007135 11.631091h20v4h-20z",
        "m66.611176 16.021286h20v4h-20z",
        "m73.136278 21.896515h20v4h-20z",
        "m78.297262 29h20v4h-20z",
        "m81.868569 37.021286h20v4h-20z",
        "m83.694115 45.609805h20v4h-20z",
        "m83.694115 54.390196h20v4h-20z",
        "m81.868569 62.978714h20v4h-20z",
        "m78.297262 71h20v4h-20z",
        "m73.136278 78.103486h20v4h-20z",
        "m66.611176 83.978714h20v4h-20z",
        "m59.007135 88.368909h20v4h-20z",
        "m50.656487 91.082199h20v4h-20z",
        "m41.924196 92h20v4h-20z",
        "m33.191905 91.082199h20v4h-20z",
        "m24.841257 88.368909h20v4h-20z",
        "m17.237215 83.978714h20v4h-20z",
        "m10.712113 78.103486h20v4h-20z",
        "m5.551129 71h20v4h-20z",
        "m1.979822 62.978714h20v4h-20z",
        "m.154276 54.390196h20v4h-20z",
        "m.154276 45.609805h20v4h-20z",
        "m1.979822 37.021286h20v4h-20z",
        "m5.551129 29h20v4h-20z",
        "m10.712113 21.896515h20v4h-20z",
        "m17.237215 16.021286h20v4h-20z",
        "m24.841257 11.631091h20v4h-20z",
        "m33.191905 8.917801h20v4h-20z"
    ];

    string[] transform = [
        "matrix(0 -1 1 0 41.924195 61.924195)",
        "matrix(.20791169 -.9781476 .9781476 .20791169 37.366073 67.97886)",
        "matrix(.40673664 -.91354546 .91354546 .40673664 28.486783 71.127981)",
        "matrix(.58778525 -.80901699 .80901699 .58778525 17.00073 69.408383)",
        "matrix(.74314483 -.66913061 .66913061 .74314483 5.364094 61.766972)",
        "matrix(.8660254 -.5 .5 .8660254 -3.67041 48.301843)",
        "matrix(.95105652 -.30901699 .30901699 .95105652 -7.561873 30.298787)",
        "matrix(.9945219 -.10452846 .10452846 .9945219 -4.463314 10.054513)",
        "matrix(.9945219 .10452846 -.10452846 .9945219 6.407647 -9.48479)",
        "matrix(.95105652 .30901699 -.30901699 .95105652 24.575895 -25.208664)",
        "matrix(.8660254 .5 -.5 .8660254 48.32959 -34.368485)",
        "matrix(.74314483 .66913061 -.66913061 .74314483 74.953677 -35.054033)",
        "matrix(.58778525 .80901699 -.80901699 .58778525 101.138497 -26.538049)",
        "matrix(.40673664 .91354546 -.91354546 .40673664 123.49551 -9.428591)",
        "matrix(.20791169 .9781476 -.9781476 .20791169 139.093424 14.398324)",
        "matrix(0 1 -1 0 145.924195 42.075805)",
        "matrix(-.20791169 .9781476 -.9781476 -.20791169 143.220135 70.187019)",
        "matrix(-.40673664 .91354546 -.91354546 -.40673664 131.568578 95.296185)",
        "matrix(-.58778525 .80901699 -.80901699 -.58778525 112.805089 114.480364)",
        "matrix(-.74314483 .66913061 -.66913061 -.74314483 89.703906 125.772867)",
        "matrix(-.8660254 .5 -.5 -.8660254 65.518802 128.44429)",
        "matrix(-.95105652 .30901699 -.30901699 -.95105652 43.452837 123.075175)",
        "matrix(-.9945219 .10452846 -.10452846 -.9945219 26.147306 111.410068)",
        "matrix(-.9945219 -.10452846 .10452846 -.9945219 15.276346 96.020209)",
        "matrix(-.95105652 -.30901699 .30901699 -.95105652 11.315069 79.834703)",
        "matrix(-.8660254 -.5 .5 -.8660254 13.518802 65.622352)",
        "matrix(-.74314483 -.66913061 .66913061 -.74314483 20.114323 55.514195)",
        "matrix(-.58778525 -.80901699 .80901699 -.58778525 28.667322 50.649302)",
        "matrix(-.40673664 -.91354546 .91354546 -.40673664 36.55985 51.004426)",
        "matrix(-.20791169 -.9781476 .9781476 -.20791169 41.492785 55.435797)"
    ];

    function getCityImage(uint8 points) internal pure returns (string memory) {
        if(points < 7) {
            return 'https://gateway.pinata.cloud/ipfs/Qmag1V8oDcU9iUwqFkkgdV4ztAgioM9E1puUQivgEwXi9b';
        } else if(points < 15) {
            return 'https://gateway.pinata.cloud/ipfs/QmR6X7VACXFDo8q7g8ZB8fnUYBpxVgkuRu8CFedbo5hHiB';
        } else if(points < 22) {
            return 'https://gateway.pinata.cloud/ipfs/QmQ1k9rvNyYf9j44oKfVVwecqvh3kehZz68VFi1gjT4kS3';
        }
        return 'https://gateway.pinata.cloud/ipfs/QmR92VVsUDPzF8rc6qX8Eo19D3BrZ2oTp5vN5CWjTzHkr9';
    }

    function getPointsIndicator(uint8 points, string memory color) internal view returns (string memory) {
        ...
        string memory pointsStr = string(uintToByteString(points, 2));
        if(points < 10) {
            pointsStr = string(
                abi.encodePacked(
                    '0',
                    uintToByteString(points, 1)
                )
            );
        }
        return string(
            abi.encodePacked(
                '<g fill="#fff" fill-rule="evenodd" width="50px" height="50px" transform="translate(1750, 1750), scale(2)">',
                    '<text style="font-family: ',
                    "'system-ui'",
                    '; fill: #000; font-weight: 700;" transform="translate(42, 58)">',
                    pointsStr,
                    '</text>',
                    pathStr,
                '</g>'
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        string memory image = //Base64.encode(
            //bytes(
                string(
                    abi.encodePacked(
                        '<!DOCTYPE html><html><head><style>body { width: 2000px; height: 2000px; background-color: ',
                        factionToColor(city.countryFaction),
                        ';}</style></head><body><image src="',
                            city.image,
        ...
        string memory imageString = image;//string(abi.encodePacked('text/html;base64,', image));
    ...
    */
    ...
    function withdraw() external onlyOwner {
        ...
        (bool success3,) = address(0xF9b303919fB7152CC19aC529e0cED2EF6aCe2348).call{value: share}('');
        (bool success4,) = msg.sender.call{value: balance * 10 / 100}('');
        require(success1 && success2 && success3 && success4, "Withdrawal failed");
    }
}
...
contract BlahNFTScore is BlahNFTNFT {
    ...
    //TODO: add all of our countries here
    string[] countries = ["United States", "Japan", "Mexico", "China"];
    
    function hasUploadedMetadata(BlahNFTTypes.City memory city) internal pure returns (bool) {
        return keccak256(abi.encodePacked(city.image)) != keccak256(abi.encodePacked(''));
    }

    function setCountryWinningFaction(string memory _country, uint8 _faction) internal {
        for(uint i = 0; i < totalSupply(); i++) {
            uint id = tokenByIndex(i);
            ...
            if(keccak256(abi.encodePacked(city.country)) == keccak256(abi.encodePacked(_country))) {
                idToCities[id].countryFaction = _faction;
            }
        }
    }
...
contract BlahNFTNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    //TODO: figure out to do with tokenIDs 0
    ...
    function mint(uint256 _tokenId) internal {
        BlahNFTTypes.City memory city;
        city.id = _tokenId;
        city.cityFaction = getAddressFaction(msg.sender);
        addressToFaction[msg.sender] = city.cityFaction;

        _safeMint(msg.sender, _tokenId);
        idToCities[_tokenId] = city;
    }
...
interface BlahNFTTypes {
    struct City {
        ...
        uint8 countryFaction;     //1 red, 2 green, 3 blue
    }
