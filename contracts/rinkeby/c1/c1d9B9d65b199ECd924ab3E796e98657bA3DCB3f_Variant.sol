...
contract Variant is ERC721A, PaymentSplitter, Ownable {
	...
	address[] private addressList = [
        0xC5FEaAddD1f7c6186AB99c8e232970230F37FF14,
        0xD1FC01a85D6Fd598b2a13f76fE09578e20e1a91D,
        0x1b0405D94d81444E79281a8884f458aC59D624AF,
        ...
        0xcDd1448a3Bb8aB4fAbACf76dA5049A6b6e27E276,
        0xEf6eD6F1AD3157FDf4a64e4D88B161232684b6E2
	];
    ...
    uint256 public constant PRICE_PER_TOKEN = 0.08888 ether;
    uint256 public constant RESERVE_COUNT = 88;
    ...
    function presaleMint(address _address, bytes calldata _voucher, uint256 _tokenAmount) external payable {
    	...
    	require(allowedMintCountPresale(msg.sender) >= _tokenAmount,"You minted too many");
  		require(_tokenAmount <= maxMintPerTxPresale, "You can mnt max 2 tokens");
    ...
    //reserve
 	function reserve(uint256 _tokenAmount, address addr) public onlyOwner {
	    ...
	    require(s + _tokenAmount <= MAX_SUPPLY, "Mint less");
