...
/*
    Minting Contract for Ratking (https://twitter.com/ratkingnft)
    @authors 0xsku.eth (https://twitter.com/iamsku_) & gooltoe.eth (https://twitter.com/gooltoe)
*/
...
contract touchGrass is ERC721A, Ownable, PaymentSplitter {
    ...
    function mint(uint256 amount) external payable {
       ...
       if (totalSupply() + amount <= maxFree) {
            ...
            if(claimAvailable[msg.sender] > 0 && amount <= claimAvailable[msg.sender]) {
                cost = 0.01 ether;
            }
        }
    ...
    function checkElyGenesisBalance(address owner) public view returns (uint256) {
         return IERC1155(0xF723d4AE92E4F9758D6Fc9568A3fbC1c3d653D76).balanceOf(owner, 0) +
                IERC1155(0xF723d4AE92E4F9758D6Fc9568A3fbC1c3d653D76).balanceOf(owner, 1) +
                IERC1155(0xF723d4AE92E4F9758D6Fc9568A3fbC1c3d653D76).balanceOf(owner, 2) +
                IERC1155(0xF723d4AE92E4F9758D6Fc9568A3fbC1c3d653D76).balanceOf(owner, 3) +
                IERC1155(0xF723d4AE92E4F9758D6Fc9568A3fbC1c3d653D76).balanceOf(owner, 4);
    }
}
...
contract ERC721A is IERC721A {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, _toString(tokenId), _json)) : '';
    }
