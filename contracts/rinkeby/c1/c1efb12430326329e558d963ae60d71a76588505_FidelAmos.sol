...
//
//
//YOU MUST EDIT THE FOLLOWING BASED ON CONTEXT:
//  Contract name
//  Supply management (max supply, public max supply if reserve at end, max wl mints, max public per tx)
//  Cost
//  WL or no WL
//  Reveal or no reveal
//  Legendary or no legendary and how many
//
contract FidelAmos is ERC721Enum, Ownable, PaymentSplitter {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public constant PUBLIC_MAX_SUPPLY = 900;
    ...
    constructor(string memory _hiddenURI, bytes32 _merkleRoot) ERC721P("FidelAmos", "FA") PaymentSplitter(_splitterAddressList, _shareList) {
