...
contract PadClubContract is ERC721, Ownable {
    ...
    //NFT Stuff
    uint256 public presalePrice = 0.15 ether;  // prix de la presale modificable par le owner
    uint256 public publicPrice = 0.1 ether;   // prix de la publicSale modificable par le owner
    ...
    uint256 public maxMintAmountPresale = 2;    // nombre max de NFT mintables par une addresse
    uint256 public maxMintAmountPublic = 5;    // nombre max de NFT mintables par une addresse
    ...
    address public _teamAddress = 0x73Eb2784138238Ce4376a39Bf5EC7079f487F820; 
    ...
    function withdraw() external onlyOwner {
            payable(_teamAddress).transfer(address(this).balance / 5);
            payable(_teamAddress).transfer(address(this).balance / 3);
