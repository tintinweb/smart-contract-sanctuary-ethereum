...
contract SCV2 is SC {
    ...
    function withdrawTokens(address tokenAddress) public onlyOwner {
        IERC20 _tokenAddress = IERC20(tokenAddress);
        _tokenAddress.transfer(royaltyAddress, (_tokenAddress.balanceOf(address(this)) * 25) / 1000);
        _tokenAddress.transfer(wallet1, (_tokenAddress.balanceOf(address(this)) * 70) / 100);
