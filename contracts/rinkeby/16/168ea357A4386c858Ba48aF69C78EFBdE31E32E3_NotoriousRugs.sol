...
/*
 ...
 |_|\_\___/\__\___/_| |_\___/\_,_/__/ |_|_\\_,_\__, /__/
                                               |___/    
*/
//Contract written by Mikey Valet and Sal420
...
contract NotoriousRugs is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    // cost is set twice. 1st on 'yarn public-sale-open --network truffle' and if hasFreeMint and maxFreeMintSupplay is reached teh cost = paidMintCost
    uint256 public cost; 
