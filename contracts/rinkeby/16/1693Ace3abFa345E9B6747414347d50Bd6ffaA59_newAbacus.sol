 ...
 */
contract newAbacus is ERC721Enumerable, Ownable {
    using Strings for uint256;
   ...
   constructor(
    ...
    function setSalesState(bool _saleActiveState) public onlyOwner{
    ...
    function multiMint(uint256 numberOfMints) public payable virtual{
        ...
        if(totalSupply() + numberOfMints >= maxSupply){
         isSaleActive = false;
    }
    }
