...
contract HivePass is ERC1155, ERC1155Supply, Ownable
{
    ...
    uint public maxSupply = 200; // variable declares max supply limit for your project - But you are able to change this when you Change Sale Details (Line 118)
    uint public MAX_MINTS = 1;
    ...
    uint256 public constant FOUNDERS_PASS = 1;
    uint256 public constant ALPHA_PASS = 2;
    uint256 private maxFoundersPasses = 30;
    uint256 private maxAlphaPasses = 200;
    uint256 private currentFoundersPassCount = 0;
    uint256 private currentPassCount = 0;
    ...
    string public name = "Hive Alpha"; //Name of Collection
    ...
    constructor() ERC1155("ipfs://QmW3WU9zv2Jhr3HPLEqTRUEtPxJqVK7SS5Mp6cYa3trBHK/{id}") {} // this is your URI function which is inputed when contract is deployed, this is linked to the metadata share link that's uploaded on IPFS
    ...
    function mintToken(uint256 tokenId, uint256 amount) external payable //This function is for Public Mint Parameters and Error Messages
    {
        ...
        require(msg.value >= getPassPrice(tokenId), "Wrong amount of ETH"); //Error if not enough ETH to complete

        tokenId == FOUNDERS_PASS ? currentFoundersPassCount++ : currentPassCount++;

        _mint(msg.sender, tokenId, amount, "");
    }


    function mintReservedTokens(address to, uint256 tokenId, uint256 amount) external onlyOwner // This function is used to mint from your reserved tokens. This variable was set on line 25.
    {
