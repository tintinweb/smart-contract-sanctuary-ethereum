...
contract MetaDogs is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public        baseURI           = "ipfs://QmerFbGKNS91NnwQr9pXGi6S3iagHNzzTM97hRg1pnzBUE/";
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on Dog");
    require(totalSupply() + amount < maxSupply + 1,"No more MetaDogs");
