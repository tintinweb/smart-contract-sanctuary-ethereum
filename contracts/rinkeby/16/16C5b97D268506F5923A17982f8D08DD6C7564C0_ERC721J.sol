    ...
    Ownable
{
    ...
    function tokenMintPrice(address token) public view virtual returns (uint256) {
        return _tokenPrice[token];
    }

    //sets the Token Mint Price in Wei
    function setTokenMintPrice(address token, uint256 price) public virtual onlyOwner {
