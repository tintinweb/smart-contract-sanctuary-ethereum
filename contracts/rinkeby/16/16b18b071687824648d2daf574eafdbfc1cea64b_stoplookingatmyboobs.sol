...
contract stoplookingatmyboobs is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 5999;
    

    uint256 public publicPrice = 0.0035 ether;

    uint256 constant public PUBLIC_MINT_LIMIT_TXN = 20;
    uint256 constant public PUBLIC_MINT_LIMIT = 40;

    string public revealedURI;

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://9BS3PPEDM8CPC8WR6PNM3VEX6MRXEAPBVC/";
    ...
    address constant internal DEV_ADDRESS = 0xDAA0D11f57f41B148a041568aC66aBd4B625d0bA;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("stoplooking.wtf", "BOOB") { }
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xDAA0D11f57f41B148a041568aC66aBd4B625d0bA");
