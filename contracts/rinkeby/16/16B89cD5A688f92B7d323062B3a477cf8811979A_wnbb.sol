...
contract wnbb is ERC721, RrpRequesterV0, Ownable {
    struct GT {
        uint256 GWDF;
        bool GW;
    }
    ...
    constructor(address _airnodeRrp) RrpRequesterV0(_airnodeRrp) ERC721("MGTTT", "MGTTT") {}
    ...
    function getCharacterStats(uint256 tokenId) public view returns (bool, uint256) {
        return (
            gti[tokenId].GW,
            gti[tokenId].GWDF
        );
