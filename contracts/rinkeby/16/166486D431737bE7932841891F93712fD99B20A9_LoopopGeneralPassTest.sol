...
contract LoopopGeneralPassTest is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, ReentrancyGuard {
    ...
    bytes32 public constant USE_PASS_ROLE = keccak256("USE_PASS_ROLE");
    ...
    mapping(uint256 => bool) _isPassUsed;
    ...
    constructor() ERC721("LoopopGeneralPassTest", "LTK") {
        ...
        _grantRole(USE_PASS_ROLE, msg.sender);
    }
    ...
    function isPassUsed(uint256 tokenId) public view returns (bool isUsed){
        return _isPassUsed[tokenId];
    }

    function setPassUsed(uint256 tokenId) external onlyRole(USE_PASS_ROLE) {
        _isPassUsed[tokenId] = true;
    }
