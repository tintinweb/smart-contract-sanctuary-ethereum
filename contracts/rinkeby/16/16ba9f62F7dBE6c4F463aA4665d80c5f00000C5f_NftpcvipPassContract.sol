...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4Bca5255E5f1a99c93D8f86BCC7C03EAb5Cb44B3,0x01DdE9584710B7344d5d3959b0DE4289D22F8873,0x25062A2C0d1D6e66D44BD92099C92D3bC083e5bF];
  uint256[] public payableFees = [5,75,10,10];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 777 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qma9CeypBRt4gneh2FcVLQyxxCqJnkLiaynLWuuhBXH78j/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 777");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 777");
...
// File: contracts/NftpcvipPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftpcvipPassContract is RamppERC721A {
    constructor() RamppERC721A("NFTPC VIP Pass", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sfLghZt2uOdQcaL2rWe2/contract-metadata";
    }
}