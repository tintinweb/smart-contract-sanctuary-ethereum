...
contract Furychain is ERC721A, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    **/
    function presaleMint(address _account, bytes32[] calldata _proof, uint256 _ammount) external payable nonReentrant {
        ...
        require(nftsPerWallet[_account] + _ammount <= max_mint_presale, "You can't mint more than the limit");
    ...
    **/
    function saleMint(address _account, uint256 _ammount) external payable nonReentrant {
        ...
        require(nftsPerWallet[_account] + _ammount <= max_mint_allowed, "You can't mint more than the limit");
