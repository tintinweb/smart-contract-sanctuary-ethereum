...
contract FreakyApesClub is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmahSZDmTEi8e4KJkfMv9B3JPR6hWtxZNww5csWwJTyNzj/";

  constructor() 
    ERC721("Freaky Apes Club", "FAC")
    RandomlyAssigned(1010,1)
    {
      mint();
