...
contract Cowboy is ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    uint private _maxMintQuantity = 2;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(_baseURI).length > 0
            ? string(abi.encodePacked(_baseURI, tokenId.toString(), _uriSuffix))
            : "";
    }
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = Cowboy.ownerOf(tokenId);
    ...
    function _mint(
        ...
        require(currentIndex <= _maxSupply, 'No Cowboy left!'); // sold out
        require(currentIndex + quantity <= _maxSupply, 'Not enough Cowboy left to buy!'); // cannot mint more than maxIndex tokens
    ...
    function autoPayOut() public payable {
