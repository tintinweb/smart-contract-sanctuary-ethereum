...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x66707b95dFCC2C17f37CeeE0037A17078431814A];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZQKb5LB76KmBo1ecctBSGUoDGLksmVd6aShcBJZHzj2G/";
...
// File: contracts/WhatdahouseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WhatdahouseContract is RamppERC721A {
    constructor() RamppERC721A("Whatdahouse", "WDH"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/h0GxLwgrAsqXlfrnb5Ih/contract-metadata";
    }
}
