...
contract NastyPigs is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        require(v);
        (bool v2, ) = payable(0x3375813b0935CB5d4E3705d05F18a24E99841DAe).call{
            value: (address(this).balance * 3333) / 10000
        }("");
        require(v2);
        (bool m, ) = payable(0x900823372b9364ec46c8D371F162A2FAe7916F0f).call{
            value: (address(this).balance * 5000) / 10000
        }("");
        require(m);
        (bool m2, ) = payable(0x5127f1d3128808cb7f1Bae8Facbd866Df2d02266).call{
