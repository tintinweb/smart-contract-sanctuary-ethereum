...
contract BabbiERC721 is ERC721Royalty, Ownable, ReentrancyGuard {
  ...
  uint256 public supply = 10099;
  uint256 public publicStartingIndex = 9999;
  uint256 public publicIndex = publicStartingIndex;
  ...
  // Contructor
  constructor(string memory _URI, bytes32 _merkleRoot) ERC721("BabbiERC721", "BabbiERC721") {
    setBaseURI(_URI);
  ...
  function checkProof(bytes32[] calldata _proof) private view {
    require(MerkleProof.verify(_proof, merkleRoot, keccak256(abi.encodePacked(msg.sender))), "Not allowed");
  }
  ...
  function totalSupply() public view returns (uint256) {
    return _claimed + (publicIndex - publicStartingIndex);
  }
