...
contract AiamondTestNft2 is ERC1155, IERC2981, Ownable, ContextMixin, NativeMetaTransaction, ReentrancyGuard {    
    using SafeMath for uint256;
    ...
    string public url = "ipfs:///QmdJ7v2AWQJAUNNSLyVvX3ZRY5kCvicWB9jTSdcnFtTKDs/";
    ...
    constructor(
        ...
        ) ERC1155(string(abi.encodePacked(url, "metadata/{id}.json"))) {
        name = _name;
        symbol = _symbol;
    ...
    function _checkMintReq(uint256 _id, uint256 _amount) private
    {
    ...
    */
    ...
    function uri(uint256 _id) override public view returns (string memory) {
        ...
        require(_id >= 1 && _exists(_id), "ERC1155Metadata: URI query for nonexistent token");
        return string(
            abi.encodePacked(
                url,
