...
contract SimpleAuction is ERC20 {
    ...
    constructor(uint _biddingTime,address payable _beneficiary) ERC20("VRaboshchukToken", "VRBCHT"){
    ...
    function bid() public payable {
        ...
        require(userBidsCount[msg.sender] < 3, "Max bids for you are riched!");
    ...
    function tokenDistribution() public  {
        ...
        if (twentyAdresses.length == 1) {
            ERC20.transfer(twentyAdresses[0], ERC20.totalSupply() * 30 / 100);
        }

        if (twentyAdresses.length == 2) {
            ERC20.transfer(twentyAdresses[0], ERC20.totalSupply() * 20 / 100);
        }
    }
