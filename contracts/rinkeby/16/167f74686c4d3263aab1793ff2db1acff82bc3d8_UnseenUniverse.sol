...
contract UnseenUniverse is ERC721A, Ownable {
    ...
    uint256 public publicCurrentSupply = 0;
    ...
    function mintWhitelist(uint256 quantity, uint256 allowedQuantity, bytes32[] calldata proof) public payable callerIsUser {
        require(contractStatus == ContractStatus.Whitelist, "Private minting not available");
        require(msg.value >= price * quantity, "Not enough ETH sent");
        require(isWalletWhitelisted(msg.sender, allowedQuantity, proof), "Failed wallet verification");
    ...
    function withdraw() public onlyOwner {
        ...
        address uno = payable(0x27cB28B6A6874b494F2Ad476dE3F55349b55Ddf3);

        bool success;

        (success,) = uno.call{value : (sendAmount)}("");
