  ...
  */
  ...
  function price(uint256  _mintType) public view returns (uint256) {
    uint256 currentPrice;
     if (_mintType == 1) {
      // Normal type NFT
      currentPrice = _mintType * normal_car_price;
    } else if (_mintType == 2) {
      // Rare type NFT
      currentPrice = _mintType * rare_car_price;
    } else if (_mintType == 3) {
      // Super type NFT
      currentPrice = _mintType * super_car_price;
    } else if (_mintType == 4) {
      // Extra type NFT
      currentPrice = _mintType * extra_car_price;
    }
    return currentPrice;
  }
  ...
  function unclaimedSupply(uint256 _mintType) public view returns (uint256) {
    ...
    if (_mintType == 1) {
      // Normal type NFT
      currentSupply = normal_car_count;
    } else if (_mintType == 2) {
      // Rare type NFT
      currentSupply = rare_car_count;
    } else if (_mintType == 3) {
      // Super type NFT
      currentSupply = super_car_count;
    } else if (_mintType == 4) {
      // Extra type NFT
      currentSupply = extra_car_count;
    }
