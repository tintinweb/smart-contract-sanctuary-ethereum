...
contract OOOnimals is ERC721Enumerable, ERC2981, Ownable {
    ...
    uint256 public constant RESERVES = 2088;
    uint256 public priceInWei = 0.3 ether;
    ...
    function collectReserves() external onlyOwner {
        ...
        for (uint256 i; i < RESERVES; i++) _safeMint(simonoFromAccounting, i);
    }
    ...
    function publicMint(uint256 _amount) public payable {
        ...
        require(priceInWei * _amount <= msg.value, "Invalid funds provided.");
