...
contract TestFreeOSPx is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  uint256 public freeMintSupply = 30;
  uint256 public freeMaxPerTx = 5;
  ...
  address public proxyAddress = 0xF57B2c51dED3A29e6891aba85459d600256Cf317;
  ...
  //}
   ...
   function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
       ...
       if(freeMintSupply >= totalSupply()){
            ...
            require(maxMintAmountPerTx >= _mintAmount , "Too many in this transaction");
