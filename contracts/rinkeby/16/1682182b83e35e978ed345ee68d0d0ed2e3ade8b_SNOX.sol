...
/**
_______________ ______ ____  _______________ ___(_)_______ 
__  ___/__  __ \_  __ \__  |/_/_  ___/_  __ \__  / __  __ \
_(__  ) _  / / // /_/ /__>  <  / /__  / /_/ /_  /  _  / / /
/____/  /_/ /_/ \____/ /_/|_|  \___/  \____/ /_/   /_/ /_/ 
*/
...
contract SNOX is Context, Ownable, IERC20 { 
    ...
    uint256 private constant _tTotal = 100000000000000 * 10 ** decimals;
    ...
    uint256 public _maxTxAmount = 500000000000 * 10 ** decimals;
    uint256 public _swapTokensAtAmount = 1000000 * 10 ** decimals;
    ...
    address payable public marketingAddress = payable(0x1de4c2E2B9DdbDD8F2F07E603404c0B0a3aE5A49);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy >= 0 && redisFeeOnBuy <= 15, "Buy rewards must be between 0% and 15%");
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 15, "Buy tax must be between 0% and 15%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 15, "Sell rewards must be between 0% and 15%");
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
      if (maxWalletSize > 250000000000 * 10 ** decimals) {
           _maxWalletSize = maxWalletSize;
        }
    }

    function setMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
      if (maxTxAmount > 50000000000 * 10 ** decimals) {
           _maxTxAmount = maxTxAmount;
        }
    }

    function setMinSwapTokensThreshold(uint256 swapTokensAtAmount) public onlyOwner {
      if (swapTokensAtAmount < 5000000 * 10 ** decimals) {
