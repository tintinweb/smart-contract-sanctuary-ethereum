...
contract ZoraMarketplace is ERC721, IERC2981, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 count) public payable nonReentrant publicSaleActive {
        ...
        require(
            ...
            "Insufficient payment, 0.001 ETH per item"
        );
    ...
    address private constant payoutAddress1 =
        0x816eDa251829F0219D405E3112b1CCf31279f522;  // JR
