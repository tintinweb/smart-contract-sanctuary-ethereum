    ...
    ReentrancyGuard
{
    ...
    string private constant _placeholder = 'ipfs://QmbGF5d1Y4rm1HfXzSvkVQJpyTNsSLVaDUbp8wKaCb3Dns';
    uint96 private constant _royalty = 10;
    uint256 private _maxSupply;

    constructor(uint256 limit) ERC721('How am I not myself??', 'HAINM') {
        _setDefaultRoyalty(owner(), _royalty * 100);
        _maxSupply = limit;
    }

    function contractURI() public pure returns (string memory) {
        return "ipfs://QmZmtDdaP3Nbe1eSeebgHoV2iuk5kNhLMMu55GT8Yzfz38";
    }
    ...
    function mint() public nonReentrant whenNotPaused {
        ...
        require(balanceOf(msg.sender) < 1, 'Only one token is allowed per address!');
