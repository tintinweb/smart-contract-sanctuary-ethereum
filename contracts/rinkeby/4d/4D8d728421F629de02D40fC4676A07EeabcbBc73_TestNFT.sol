...
contract TestNFT is ERC721A, Ownable {
    ...
    string public baseURI = "https://us-central1-metacats.cloudfunctions.net/api/token/";

    error SaleNotActive();
    error IncorrectFunds();

    event PriceChange(address indexed owner, uint256 amount);
    event SaleStateChange(bool indexed saleState);
    ...
    function changePrice(uint256 price_) public onlyOwner {
        ...
        emit PriceChange(_msgSender(), price_);
    }
