...
contract PIXI is ERC20 {
     address public minter;
    constructor (string memory name_, string memory symbol_, uint amountToMint,address _minter) ERC20(name_, symbol_) public {
    ...
    function renounceMinter(address _newMinter ) external {
        require(msg.sender == minter, "caller is not the minter");
        minter = _newMinter;
    }
}
