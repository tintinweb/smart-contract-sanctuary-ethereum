...
contract WisherVodkaCocktailTest is ERC721Enumerable, Ownable {
	...
	uint256 public startIndexBlock = 0;
	...
	function reserve(uint256 quantity) public onlyOwner {
		...
		require(supply + quantity < MAX_SUPPLY, "Reserve amount would exceed max supply.");
	...
	function mint(address to, uint256 quantity) public payable {
		...
		require(fee * quantity <= msg.value, "Insufficient ETH to complete transaction.");
