    ...
    ReentrancyGuard
{
    ...
    uint256 public constant PUBLIC_PRICE = 0.005 ether;  // 0.005 first 
    uint256 public royalty = 66; 

    uint256 public constant NUMBER_RESERVED_TOKENS = 150; // Team Reverse 
    ...
    constructor( string memory _name, string memory _symbol) ERC721A("DeGen", "DGN"){}
