...
contract TheBestTokenProof is ERC721Delegated, ReentrancyGuard {
  using Counters for Counters.Counter;

  constructor(address baseFactory, string memory customBaseURI_)
    ERC721Delegated(
      baseFactory,
      "The Best Token Proof",
      "TBTP",
      ConfigSettings({
        royaltyBps: 0,
  ...
  {
    allowedMintCountMap[msg.sender] = 8;

    allowedMintCountMap[0x9D4209EaE88098EbF31cFE5c7E74a840604a2F25] = 2;
  }
  ...
  uint256 public constant MAX_TOKEN_ID = 7;
  ...
  address private constant payoutAddress1 =
    0x9D4209EaE88098EbF31cFE5c7E74a840604a2F25;
