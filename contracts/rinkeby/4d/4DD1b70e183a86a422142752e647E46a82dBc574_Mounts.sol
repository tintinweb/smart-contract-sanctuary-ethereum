...
contract Mounts is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getSuffix(uint256 tokenId) public view returns (string memory) {
        return Suffix[random("Suffix", tokenId, 0, 27)];
    }
    ...
    function contractURI() public pure returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Mounts (for Adventurers)", "description": "8000 generative on-chain Mounts for Adventurers in the Lootverse", "seller_fee_basis_points": 500, "fee_recipient": "0xbf32e731d86c34fc4143cd1f3d54f8516355ff33"}'))));
