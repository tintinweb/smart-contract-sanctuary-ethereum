 ...
 */
contract _8sian_ is ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public constant publicPrice = 0.077 ether;
    uint256 public constant holderPrice = 0.0626 ether;
    ...
    address private signerAddress = 0x8412C68B00DB36DD1fa17732d94ac651487b5bd1;
    ...
    function publicMint(
        ...
        require((1 <= merchNumber) && (merchNumber <= 9), "MERCH_NUMBER_INCORRECT");
    ...
    function mint(
         ...
         */
        require((isFreeMintActive && msg.value == 0 ether) || (msg.value >= ((holderPrice * mintNumber) - 0.0001 ether) && msg.value <= ((holderPrice * mintNumber) + 0.0001 ether)), "INVALID_PRICE");
