...
contract NewGameOnlineTestNft is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    string memory _openMetadataUri
  ) ERC721A(_tokenName, _tokenSymbol) {
    setCost(_cost);
    maxSupply = _maxSupply;
    setMaxMintAmountPerTx(_maxMintAmountPerTx);
    // setHiddenMetadataUri(_hiddenMetadataUri);
    setUriPrefix(_openMetadataUri);
  }
  ...
  //   for (uint256 i = _currentIndex; i < maxSupply; i++){
  //      // _tokenIdCounter.increment();
  //      _safeMint(_msgSender(), _currentIndex);
  //   }
  // }
