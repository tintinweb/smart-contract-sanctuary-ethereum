...
contract CyberPunkK9 is ERC721Enumerable, Ownable {
    ...
    uint256 public noOfFreeClaimsMinted = 0;
    ...
    function currentMinter() public view returns (string memory) {
        if (publicCanMint) return "PUB";
        else if (whitelistedCanMint) return "WL";
        else if (oGCanMint) return "OG";
        return "NAN";
    }

    // private
    function addFreeClaimMintNumber() private {
        noOfFreeClaimsMinted++;
    }
