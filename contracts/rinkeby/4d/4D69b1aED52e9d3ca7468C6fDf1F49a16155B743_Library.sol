...
contract Library {
    ...
    function check721Compliancy(address _contract) public view returns (bool) {
        require(IERC165(_contract).supportsInterface(0x80ac58cd), "No IERC721 implemented");
    ...
    function check721EnumerableCompliancy(address _contract) public view returns (bool) {
        ...
        require(IERC165(_contract).supportsInterface(0x780e9d63), "No IERC721Enumerable implemented");
