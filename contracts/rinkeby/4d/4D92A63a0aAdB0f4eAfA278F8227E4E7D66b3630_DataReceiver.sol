...
contract DataReceiver is IDataReceiver {
  ...
  function addObservation(IManualDataFeed.Data calldata _data) external {
    uint32 _blockTimestamp = _data.blockTimestamp;
    int24 _tick = _data.tick;
    uint128 _liquidity = _data.liquidity;
...
import {IManualDataFeed} from '../interfaces/IManualDataFeed.sol';
