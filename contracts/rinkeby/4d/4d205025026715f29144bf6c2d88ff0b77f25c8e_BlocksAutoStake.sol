...
contract BlocksAutoStake is IERC777Recipient, Ownable, ReentrancyGuard {
    ...
    uint256 public stakeOpenPeriod;
    ...
    constructor() {
        ...
        stakeOpenPeriod = block.timestamp + 182 days;
        lockTimePeriod = block.timestamp + 365 days;
        stakeRewardEndTime = block.timestamp + 547 days;
    ...
    function tokensReceived(
        ...
        if(from == owner()){
            ...
            require(block.timestamp < stakeOpenPeriod, "Open staking period has ended");
    ...
    function withdrawAll() external nonReentrant {
        require(block.timestamp >= lockTimePeriod, "Funds are currently locked.");
        require(userAccount[msg.sender].allocatedBalance > 0, "Balance must be > 0");
    ...
    function increaseClaimed(uint256 _delta) internal {
        totalClaimed = totalClaimed + _delta;
