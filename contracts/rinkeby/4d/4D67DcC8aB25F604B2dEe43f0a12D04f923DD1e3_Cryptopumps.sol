...
contract Cryptopumps is ERC721, Ownable {
    ...
    uint256 public NFT_MAX_SUPPLY = 10;
    ...
    constructor(
        ...
        _mysteryURI = _initNotRevealedUri;
    }
        ...
        onlyOwner
    {
        ...
        require(totalSupply < NFT_MAX_SUPPLY, "OUT_OF_STOCK");
        require(totalSupply + tokenQuantity <= NFT_MAX_SUPPLY, "EXCEED_STOCK");
