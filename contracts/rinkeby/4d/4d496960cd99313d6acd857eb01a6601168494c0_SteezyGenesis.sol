...
contract SteezyGenesis is ERC721Burnable, Ownable {
    ...
    bytes32 public whitelistRoot = 0x25c675dbb529b998276a34221a2900e1d25e0a353faf6d0e44eabb45dbb85cc2;
    ...
    constructor() ERC721("SteezyGenesis", "$TEEZ") {
        baseURI = "http://genesis.steezy.io/metadata/";
    }
    ...
    function reserveTokens(uint16 _amount) external onlyOwner {
        require(_amount + counter <= MAX_SUPPLY, "Maximum tokens minted");
    ...
    function mint(bytes32[] calldata proof) external payable {
        ...
        require(counter + 1 <= MAX_SUPPLY - 1, "Maximum tokens minted");
        require(!addressToMinted[msg.sender], "Wallet has minted already");
        require(msg.value == price, "Incorrent eth sent");
    ...
    function withdraw() external onlyOwner {
        ...
        address acct = 0x33A4622B82D4c04a53e170c638B944ce27cffce3;
