...
// File contracts/memosalinas7DNA.sol


pragma solidity ^0.8.0;

contract memosalinas7DNA {
...
// File contracts/memosalinas7.sol
...
contract memosalinas7 is ERC721, ERC721Enumerable, memosalinas7DNA {
    ...
    constructor(uint256 _maxSupply) ERC721("memosalinas7", "MS7") {
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "MS7 #',
                tokenId.toString(),
                '", "description": "MS7 are randomized NFTs stored on chain", "image": "',
                image,
                '"}'
            )
        );
