...
contract FundMe is Ownable {
  uint256 public constant MINIMUM_USD = 50 * 10**18; // 50 USD in 18 decimals
  ...
  function withdrawGasEfficient() public onlyOwner {
    address[] memory tmpFunders = funders;
    for (uint256 i = 0; i < tmpFunders.length; i++) {
      amounts[tmpFunders[i]] = 0;
    }
