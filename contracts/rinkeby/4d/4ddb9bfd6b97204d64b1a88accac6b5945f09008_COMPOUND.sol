...
contract COMPOUND is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) public whitelistAmtMinted;
        ...
        mintPriceCompliance(_mintAmount)
    {
        ...
        require(whitelistAmtMinted[_msgSender()] < maxMintPerWallet, "Minted max allocation");
