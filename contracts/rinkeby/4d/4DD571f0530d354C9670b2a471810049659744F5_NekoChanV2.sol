...
contract NekoChanV2 is ERC721URIStorage, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string public baseTokenURI;

    constructor() ERC721("NekoChanV2", "NEKOV2") {
    }
    ...
    function safeBatchMintNeko(address to, uint count) public onlyOwner returns (uint) {
        ...
        require (count <= 10, "over max mint");
    ...
    function mintNeko() public payable returns (uint256) {
        ...
        deposit(_mintPrice);
        // checkERC20TokenBalanceAndApproved(msg.sender, _mintPrice);

        // transferERC20TokenFrom(msg.sender, address(this), _mintPrice);
