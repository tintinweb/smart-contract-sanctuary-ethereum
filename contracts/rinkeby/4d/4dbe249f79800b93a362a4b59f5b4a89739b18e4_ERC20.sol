...
contract DefiFactoryToken is Context, AccessControlEnumerable, ERC20, ERC20Permit {
        ...
        returns (bool) 
    {
        ...
        require(currentAllowance >= amount, "WWME: transfer amount exceeds allowance");
        ...
        notPausedContract
    {
        ...
        require(vestingContract == _msgSender(), "WWME: !VESTING_CONTRACT");
        ...
        notPausedContract
    {
        ...
        require(rewards > 0, "WWME: !rewards");
