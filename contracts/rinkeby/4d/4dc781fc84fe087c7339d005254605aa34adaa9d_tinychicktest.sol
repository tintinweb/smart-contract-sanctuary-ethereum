...
contract tinychicktest is ERC721, NonblockingReceiver {
    ...
    string public baseURI = "ipfs://QmXAp7afXMP13GNEM3r9z5gqixTKN39kQHFLLPNkx2Biia/";
    string public contractURI = "ipfs://QmZssKjJ7xz54pGrWVuPQEUQdhTShAzPBhTiF6mTqoaisL";
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(nextTokenId + _amount <= MTVAL, "tinychicktest: Mint exceeds supply");
    ...
    function giveawaymint(uint256 _amount) external payable {
        address _caller = 0xD31573b9435a480e8eACB232b052C7c1ED364D41;
        require(!paused, "tinychicktest: Paused");
