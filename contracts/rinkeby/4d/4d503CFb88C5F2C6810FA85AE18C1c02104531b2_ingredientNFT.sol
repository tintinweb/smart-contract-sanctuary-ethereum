 ...
 abstract contract Ownable is Context {
    ...
    function purchaseIngredients( uint256[] memory _ingredientIds) public payable {
        ...
        for(uint256 i = 0; i < _ingredientIds.length; i++) {
            ...
            pricesArray[i] = ingredientDetail.price;
        ...
        for(uint256 i = 0; i < _ingredientIds.length; i++) {
            ...
            // tranfering the token the purchaser
            _safeBatchTransferFrom(owner(), msg.sender, _ingredientIds, pricesArray, "0x00");
            // _mint(msg.sender, _nftId);
            // _mint(msg.sender, _nftId, uint256 amount, bytes data)
