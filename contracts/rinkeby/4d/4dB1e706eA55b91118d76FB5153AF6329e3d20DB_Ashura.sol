...
contract Ashura is ERC721A, Ownable {
    ...
    //WL STORES 
    // devil
    bytes32 public devilRoot = 0x12a7f6f1726fff267056218fc294302cb4736e6c5af8e2eae05c187ea8747417;//TODO replace this once wl is finalised
    mapping(address => uint8) public devilStore;

    // demon
    bytes32 public demonRoot = 0x12a7f6f1726fff267056218fc294302cb4736e6c5af8e2eae05c187ea8747417;//TODO replace this once wl is finalised
    ...
    // ERC721 Metadata
    string private _baseURI_ = "ipfs://uri/"; //TODO replace this once art is live 
    ...
    function DevilMint(
        ...
        require(_saleState == SaleStates.WHITELIST_MINT, "Devil mint not active");
        require(amount_ > 0, "You must mint at least 1");
        require(devilStore[msg.sender] + amount_ <= DEVIL_MAX_MINT , "Amount is too large");
        require(
        ...
        require(msg.value >= amount_ * DEVIL_PRICE_REST, "Insufficient eth to process the order");
    ...
    function DemonMint(
        ...
        require(_saleState == SaleStates.WHITELIST_MINT, "Demon mint not active");
        require(amount_ > 0, "You must mint at least 1");
        require(demonStore[msg.sender] + amount_ <= DEMON_MAX_MINT , "Amount is too large");
        require(
            amount_ <= (MAX_SUPPLY - _adminMinted - totalSupply()),
            "Not enough supply"
        );
        ...
        require(msg.value >= amount_ * DEMON_PRICE, "Insufficient eth to process the order");
    ...
    function endMint() external onlyOwner {
        ...
        require(uint256(0) == MAX_SUPPLY - totalSupply(), "Must be sold out to end");
    ...
    function checkDevinMinted() public view returns( uint8 minted) {
    ...
    function setDemonRoom(bytes32 _merkleRoot) public onlyOwner {
