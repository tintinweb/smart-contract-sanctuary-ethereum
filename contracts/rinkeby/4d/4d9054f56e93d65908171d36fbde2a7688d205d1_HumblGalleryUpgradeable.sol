...
function initialize(uint96 commissionPercentage, address commissionReceiver) initializer public {
    ...
    function addOnSupply(address account, uint256 tokenId, uint256 quantity) public tokenMinterOnly(tokenId) whenNotPaused {   
    ...
    function burnSupply(address account, uint256 tokenId, uint256 quantity) public virtual tokenMinterOnly(tokenId) whenNotPaused {   
    ...
    /* executed through auction contract only*/
