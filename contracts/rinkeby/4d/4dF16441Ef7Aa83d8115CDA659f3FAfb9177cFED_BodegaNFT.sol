    ...
    ReentrancyGuard
{
    ...
    uint256 public usdPrice = 125*eth_usd_decimal;

    Counters.Counter private _tokenIds;

    constructor(string memory uri, bytes32 merkleroot)
        ERC721("BodegaNFT", "NFT")
        ReentrancyGuard() // A modifier that can prevent reentrancy during certain functions
    {
        root = merkleroot;
        USDT = IERC20(0x9B9252840fC6Be3Dc770084e5BAE23f97B66B4d7);
        USDC = IERC20(0xA6147f96ef95AFF8F5D786C264452C8Ac1207040);
    ...
    */
    ...
    onlyAccounts
    {
        ...
        if(cryptotype == 0){
            ...
            require(usdPrice * _amount <= (coinamount*eth_usd_decimal/USDC_DECIMAL) ,"Not enough usdt sent");
