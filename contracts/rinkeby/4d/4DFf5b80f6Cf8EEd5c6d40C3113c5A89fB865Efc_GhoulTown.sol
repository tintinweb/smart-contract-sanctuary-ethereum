...
contract GhoulTown is ERC721A, Ownable {
    ...
    uint256 public constant FREE_MINT_AMOUNT = 125;
    ...
    address payable public _safe =
        payable(0x22222614721c668c5bE31E833094FF759e149948);
     ...
     */
     function mint(uint256 _amount) external payable {
        ...
        require(supply + _amount < MAX_SUPPLY, "ghoultown: mint would exceed total supply");
        require(_amount > 0 && _amount <= MINT_LIMIT, "ghoultown: mint amount too high");
        require(msg.value >= (_price * _amount), "ghoultown: insufficient eth sent");
        currentSupply += _amount;
    ...
    function freeMint() external {
        ...
        require(supply < FREE_MINT_AMOUNT, "ghoultown: free mints exhausted");
        currentSupply += 1;
