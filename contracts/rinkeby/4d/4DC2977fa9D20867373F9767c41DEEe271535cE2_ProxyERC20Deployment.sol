...
contract ProxyERC20Deployment {
    address public owner;
    address public erc20ProxyAdmin;
    address public erc20Implementation;

    event TokenCreated(address token, string name, string symbol, uint256 decimal);

    constructor(address _erc20ProxyAdmin, address _erc20Implementation) {
        owner = msg.sender;
        erc20ProxyAdmin = _erc20ProxyAdmin;
    ...
    function createERC20Token(string calldata name, string calldata symbol, uint8 decimals) onlyOwner external returns (address) {
