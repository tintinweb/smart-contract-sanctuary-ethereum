...
abstract contract IEvents is Initializable {
    ...
    event TransferDebtLock(bool _locked);
    ...
    /**
     * Call to emit when community transfer debt is locked or unlocked
     * @dev modifier onlyCommunityContract
     *
     * @param _locked bool - the status of transferDebtLock
     */
    function transferDebtLock(bool _locked) external virtual;
    ...
    /**
     * Call to emit when a project is unpublished from an investment community for fund raising
     * @dev modifier onlyCommunityContract
     *
    ...
    /**
     * Call to emit when the ownership of a project's debt tokens are transferred
     * @dev modifier onlyCommunityContract
     *
     * @param _communityID uint256 - the uuid/ serial of the community the project is published in
     * @param _project address - the address of the deployed project contract tracked by the NFT
     * @param _investor address - the current owner who is sending the investment debt tokens
     * @param _to address - the new owner who is the recipient of the investment debt tokens
