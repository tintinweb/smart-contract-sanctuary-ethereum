...
contract MsscConfirmByCycle {
    ...
    // function allocationCompleted() public view returns (bool) {
    //     return false;
    // }
    ...
    function deposits(uint256 cycleId) public view returns (uint256) {
        return _deposits[msg.sender][cycleId];
    }
