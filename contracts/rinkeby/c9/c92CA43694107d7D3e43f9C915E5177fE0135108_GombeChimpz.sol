...
contract GombeChimpz is ERC721A, Ownable {
  using Strings for uint256;
    ...
    string public   placeholderTokenUri="ipfs://bafybeieyzt7heltje6uutsxpurwgdxk4f4wzobsaz6zw2wedx2qqqn44te/hidden.json";
  ...
  constructor(bytes32 _merkleroot) ERC721A("Gombe Chimpz", "GChimpz") {
  ...
  function withdraw() external onlyOwner{
        ...
        payable(0xFc391A4eAa3C97F3b3573305fe7AE5DD8c7B9Aca).transfer(withdrawAmount_10);
        payable(0xB3D34a4EcFCa69F50F17f4e5947dC5dbE9B3aA4C).transfer(withdrawAmount_10);
        payable(0xFe1393B4d70eB60CD54fFb17a8fE682Ed74ca5c7).transfer(withdrawAmount_5);
        payable(0x14967204562965e6Aa6095CDD0127482D9dc8Bf9).transfer(withdrawAmount_5);
        payable(0x5a02398f30b703Fe40DDAbc343Cc6ADDD68Dabbb).transfer(withdrawAmount_15);
        payable(0xDcaD686747D745Da1d3299593ed5B926D8A0435F).transfer(withdrawAmount_15);
        payable(0x11F07871f360442A0EF6d1962fCfa5C66a5797eA).transfer(withdrawAmount_20);
        payable(0xd26f7F6B3bDACF9B34AA3884962FF0d4F151c7B0).transfer(withdrawAmount_20);
