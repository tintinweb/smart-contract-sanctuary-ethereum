    ...
    LootItems
{
    ...
    function mintDailyStore(
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        if (!Settings.dailyStoreActive) revert ErrorCodes.PublicSaleInactive();
    ...
    /// @param mintAmounts: The amount respectivly of each token that the user is requesting to mint.
    //      example: [1,2,1] will mint token IDs [(TokenID: 1 Amount: 1), (TokenID: 2 Amount: 2),(TokenID: 3 Amount: 1)].
    /// @param networkName: The name of the network that this contract is on. Removes the ability for users to create a dummy contract on a test network
...
contract Roles is AccessControl {
    ...
    constructor() {
        ...
        // Roles also set in Settings.sol constructor
    }
}
...
contract Settings is AccessControl, Roles
{
    ...
    address public signerAddress    = 0x417bA3FaC3F0ED2B1c5424658DD549f742A6c196;

    // The address of the gnosis safe that is the intermidiary for interacting with the contract to ensure
    //  there are multiple people over interactions with the contract
    address public gnosisSafe       = 0x8bA7E412CbeE75fA447Ed86A239bA65238b141D0;
    ...
    constructor()
    {
        // Set Gnosis Safe Permissions
        _grantRole(Roles.ROLE_SAFE, gnosisSafe);
    ...
    // *                        ADMIN
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /// @dev Sets the gnosis safe address. This will be the only thing that can interact with the contract.
    /// @param newGnosisAddress: The new address that will be auto assigned the safe role and allowed to interact with the contract
    function setGnosisSafe(address newGnosisAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        // Remove the role for the previous gnosis safe
        _revokeRole(Roles.ROLE_SAFE, gnosisSafe);
        // Set the new gnosis safe
        gnosisSafe = newGnosisAddress;
        // Give the new gnosis safe the new role
        _grantRole(Roles.ROLE_SAFE, gnosisSafe);
    }
}
