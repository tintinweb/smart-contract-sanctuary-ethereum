...
contract TittyTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor(address _genesisAddr, uint _claimStartTime, uint _allowlistStartTime, address _dao) ERC721("TittyTest", "Tits") {
