    ...
    IERC721Upgradeable
{
    ...
    function mint(address _currency) external payable;
}
    ...
    ITokenERC721
{
    ...
    struct ExtraParam {
        string baseURI_;
        uint256 _price;
        uint256 _SALE_TIME_START;
        uint256 _SALE_TIME_END;
    }
    ...
    function initialize(
        ...
        baseURI = extraParam.baseURI_;
        price = extraParam._price;
        SALE_TIME_START = extraParam._SALE_TIME_START;
        SALE_TIME_END = extraParam._SALE_TIME_END;
    ...
    function mint(address _currency)
        external
        payable
        nonReentrant
    {
        require(
            SALE_TIME_START <= block.timestamp && SALE_TIME_END >= block.timestamp,
            "request expired"
        );
    ...
    function setTime(uint256 _SALE_TIME_START, uint256 _SALE_TIME_END) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function collectPrice(address currency) internal {
