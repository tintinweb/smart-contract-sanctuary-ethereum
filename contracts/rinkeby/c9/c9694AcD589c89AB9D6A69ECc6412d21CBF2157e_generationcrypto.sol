...
// File: contracts/generationcrypto.sol
...
contract generationcrypto is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("generation crypto ", "GTC") {
    setBaseURI("https://gateway.pinata.cloud/ipfs/QmWPzHgKZnXc3uoUNTcELCYovznEiod9enqbCMmfhGEyDj/");
    mint(msg.sender, 200);
  }
