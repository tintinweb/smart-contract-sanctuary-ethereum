...
contract NFT is ERC1155, Ownable {
    ...
    //NFT üretecek kişiler için NFT üretim maliyetinin belirlendiği yer
    ...
    constructor(string memory uri_, string memory notRevealedUri_)
        ERC1155(uri_)
    {
    ...
    function mint(address to) external payable {
        ...
        /*_setURI(
            tokenIds,
            string(abi.encodePacked(tokenIds.toString(), baseExtension))
        );*/
    ...
    function deleteFromBlacklist(address user) external onlyOwner {
