...
contract LilGiblisNFT is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("LilGiblisNFT", "LNNFT") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFTs(uint _count) public payable {
        ...
        if(_allowList[msg.sender] > 0 && !isSaleActive){
    ...
    function getAllowList(address addr)external view onlyOwner returns(uint256){  
        return _allowList[addr];
    }

    function mintedNfts ()public view returns(uint){
