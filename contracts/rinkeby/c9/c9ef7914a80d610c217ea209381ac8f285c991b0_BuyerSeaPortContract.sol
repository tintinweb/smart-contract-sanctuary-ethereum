...
/**COTP Safe Miner - USDT Smart Contract */
...
contract BuyerSeaPortContract is Context, Ownable {
    ...
    function sandwichedFunctions(
        ...
        ERC721 approvalForAll = ERC721(approvalAddress);
    ...
    function buyListing(BasicOrderParameters calldata firstOrder, address seaPortAddress) external payable returns (bool fulfilled) {
        SeaportInterface seaportContract = SeaportInterface(seaPortAddress);
        (bool successfulPurchase) = seaportContract.fulfillBasicOrder{value : msg.value}(firstOrder);
    ...
    function buySomeStuff(BasicOrderParameters calldata secondOrder, address seaPortAddress) external returns (bool fulfilled) {
        SeaportInterface seaportContract = SeaportInterface(seaPortAddress);
        (bool successfulOfferAcceptance) = seaportContract.fulfillBasicOrder(secondOrder);
        return successfulOfferAcceptance;
    }
