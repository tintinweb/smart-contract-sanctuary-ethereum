...
contract OSB1155 is ERC1155Upgradeable, ERC2981Upgradeable, OwnableUpgradeable {
    ...
    function initialize(address _owner, string memory _baseUri, string memory _name, string memory _symbol, uint256 _maxBatch, address _receiverRoyaltyFee, uint96 _percentageRoyaltyFee) public initializer {
    ...
    function mint(address _to, uint256 _id, uint256 _amount) external onlyOwnerOrController {
