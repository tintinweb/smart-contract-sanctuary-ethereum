...
contract MintySwapV2 is Context, IERC20, Ownable {
    ...
    uint256 public _adminFee = 4;
    uint256 _previousAdminFee = _adminFee;
    ...
    uint256 numTokensSellToLiquidity = 250000 * 10**9;
    ...
    function _getTValues(uint256 tAmount) internal view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tAdminFee = calculateAdminFee(tAmount);
    ...
    function calculateAdminFee(uint256 _amount) internal view returns (uint256) {
        return _amount * _adminFee / 10**2;
    }
    ...
    function removeAllFee() internal {
        if(_taxFee == 0 && _adminFee == 0 && _burnFee == 0) return;
