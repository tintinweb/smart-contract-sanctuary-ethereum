...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC8a865E21a597b5AEc6b4191821299f874b5DdFd,0xC125295e8324aabe1f9802C402b232b58e959B86];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaonw456o2t7ehs4gp3v4cf7e3577ffkq34eo5gx2imgjkbztjns4/";
...
contract MirrorDrePassContract is RamppERC721A {
    constructor() RamppERC721A("Mirror Dre Pass", "MDPS"){}
}
