...
contract newNFT is NFTokenMetadata, Ownable {
  ...
  constructor() {
    nftName = "JD NFT 4";
    nftSymbol = "UNCLE JD 4";
  }

  function mint() public virtual payable {
    require(_tokenIds.current() < 10000, "All available NFTs have been minted!");
    _tokenIds.increment();
  ...
  function transferBalance(address payable to, uint256 amount) public {
