...
contract HeroQuest is ERC721A, Ownable {  
    ...
    event Update(uint256 _id, uint256 _health, uint256 _damage, uint256 _experience, uint256 _level, uint256 _skillPoints, uint256 _charges);

    uint256 public nonce;
    function donate() external payable{}

    constructor(address _oracle, address _routerAddress, address _uniswapV2Pair, address _token, address _vault) ERC721A("HeroQuest", "Heroes") { 
    ...
    function updateCharacter(uint256 _id, uint256 _health, uint256 _damage, uint256 _experience, uint256 _level, uint256 _skillPoints, uint256 _charges) public {
        ...
        emit Update(_id, _health, _damage, _experience, _level, _skillPoints, _charges);
    }
    function updateTime(uint256 _id, uint256 _lastCheck) public {
        require(allowed[msg.sender], "Contract must be alllowed to interact"); 
        Time memory char = times[_id];      
