...
contract T3 is ERC721A, Ownable, ReentrancyGuard {
    ...
    // public minting
    function koalaMint(address _sendTo,uint256 _mintAmount) public payable nonReentrant {
        ...
        function koalaPresaleMint(address _sendTo,uint256 _mintAmount) public payable nonReentrant {
