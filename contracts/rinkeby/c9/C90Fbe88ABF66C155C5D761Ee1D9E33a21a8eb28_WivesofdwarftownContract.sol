...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe86289621F6355445190cc851c2918d6dfBC59BE];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVuZuqPVjJUdSAfx7GyrmzjETgVVwsRNLQER2c9YruTyJ/";
...
// File: contracts/WivesofdwarftownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WivesofdwarftownContract is RamppERC721A {
    constructor() RamppERC721A("WIVES OF DWARF TOWN", "DWARFWIVES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/a7tMLZTU1thEA09YKncX/contract-metadata";
    }
}
