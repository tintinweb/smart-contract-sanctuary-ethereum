...
contract Contract is ERC721A, Ownable {
  ...
  function OgMint(uint8 mintAmount, address _account, bytes32[] calldata _proof) public payable {
  ...
  function WlMint(uint8 mintAmount, address _account, bytes32[] calldata _proof) public payable {
    require(sellingStep == Steps.WLMints, "WLMints has not started yet.");
    require(totalSupply().add(mintAmount) <= MaxToken, "WLMints Sold Out");
  ...
  function AllowListMint(uint8 mintAmount, address _account, bytes32[] calldata _proof) public payable {
