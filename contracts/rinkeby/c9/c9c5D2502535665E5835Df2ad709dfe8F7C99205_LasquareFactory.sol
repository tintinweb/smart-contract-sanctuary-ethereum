...
contract LasquareFactory is Ownable {
    ...
    constructor(LasquareStore _impl, address _registry, address _exchange) {
        impl = _impl;
    ...
    function newCollection(
        ...
        LasquareStore(newCollection).initialize(_name, _symbol, _tokenURI, _proxyRegistryAddress, _exchangeAddress);
