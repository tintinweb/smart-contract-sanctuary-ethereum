...
contract TestWTF is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable maxPerWallet = 40;
    uint256 public immutable maxPerOgMint = 1;
    uint256 public immutable maxPerFreeMint = 5;

    uint256 public immutable freeMints = 1000;
    ...
    bool public ogListMintActive = false;
    ...
    function ogListMint(uint256 quantity, bytes32[] calldata _merkleProof) external callerIsUser {
        require(
        ...
        require(ogListMintActive, "free mint is not currently active");
        require(ogListAmount[msg.sender] + quantity <= maxPerOgMint, "you cant mint anymore dickList mints");
    ...
    function freeMint(uint256 quantity) external callerIsUser {
        ...
        require(freeListAmount[msg.sender] + quantity <= maxPerFreeMint, "you cant mint anymore dickList mints");
    ...
    function toggleOgMint() public onlyOwner {
        ogListMintActive = !ogListMintActive;
    }
