    ...
    PaymentSplitter 
{
    ...
    // Teams' wallet address if you need to share the revenue.
    uint256[] private _teamShares = [100]; // 1 PEOPLE IN THE TEAM
    address[] private _team = [
        0x4B4EaCa5629dd9cB13b757395ED7Ab58bE6f1C8C // 丫头 wallet Account gets 100% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("UPSETDown", "USD")
