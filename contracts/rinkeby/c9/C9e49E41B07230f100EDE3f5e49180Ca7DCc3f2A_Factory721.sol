...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new CXLDNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CXLDNFTUser721Token token = CXLDNFTUser721Token(address(addr));
...
contract CXLDNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
