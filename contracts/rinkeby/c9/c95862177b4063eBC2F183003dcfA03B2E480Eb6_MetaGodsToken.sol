...
contract MetaGodsToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    uint256 public spendingTaxFunds;

    uint256 public withdrawTax;

    uint256 public spendingTax;
    ...
    function spend(address wallet_, uint256 amount_) external authorised {
        ...
        spendingTaxFunds += amount_ * spendingTax / 100;
        walletsBalances[wallet_] -= amount_;
    }
    ...
    function withdrawSpendings(uint256 amount_) external onlyOwner {
        require(spendingTaxFunds >= amount_);
        _mint(msg.sender, spendingTaxFunds);
        spendingTaxFunds -= amount_;
    }
    ...
    function setSpendingHolding(uint256 newSpendingTax_) external onlyOwner {
        spendingTax = newSpendingTax_;
    }
