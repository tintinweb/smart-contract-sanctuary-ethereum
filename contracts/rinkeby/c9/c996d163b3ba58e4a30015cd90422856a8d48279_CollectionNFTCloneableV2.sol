 ...
 *        
 *        Will Ridge has modified the initialization function and internal logic 
 ...
 *
 *        To anyone that reads this code, my sincere apologies.
 *        I'm not a programmer, this was a passion project.
 */
...
interface ICollectionNFTTokenURIPredicate {
    function getTokenURI(uint256 _tokenId, uint256 _hashesTokenId) external view returns (string memory);
}
    ...
    ReentrancyGuard
{
     ...
     *                  function getTokenURI(uint256 tokenId, uint256 hashesTokenId) used to
    ...
    function draw(uint256 tokenId) public view returns (string memory) {
        ...
        return TokenURIPredicateContract.getTokenURI(tokenId, tokenCollectionIdToHashesIdMapping[tokenId].hashesId);
    } 
