...
contract BondDepository is ReentrancyGuard, Pausable, Ownable {
    ...
    struct Terms {
        uint256 principlePrice; // how many RPLC per one principle, 9 decimals 
    ...
    function deposit(
        ...
        uint256 value = (_amount * terms.principlePrice) / 10**IERC20Deci(principle).decimals();
        ...
        emit BondCreated(_amount, payout, terms.principlePrice);

        return terms.principlePrice;
    }
