...
contract GutterComics is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public _baseURIextended = "https://comicsapi.guttercatgang.com/metadata/comics/";
    string public _contractURI = "ipfs://xxxxxxxxxxxxxxx";

    uint256 public maxNormalSupplyID = 11999; //tokens start from 0
    uint256 public saleStopID = 8999;
    ...
    address public gutterCatNFTAddress =
        0x453dD40b9eF03dd1f87D1eb79F01d747510a6693;
    address public gutterRatNFTAddress =
        0xB3Bc2134C50B762370d86ea98307AB1E67b6dBF4;
    address public gutterPigeonNFTAddress =
        0xAD2b4547F83C558A67860383915dA028eEfEC17D;
    address public gutterDogNFTAddress =
        0xC96084e4DCA3D0701ADD8893F76aD0C3De6582d6;
        ...
        nonReentrant
    {
        ...
        require(lastMintedId + qty <= saleStopID, "out of stock");
