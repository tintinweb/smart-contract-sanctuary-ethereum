...
contract BR is ERC1155Supply, Ownable 
{
    ...
    string public name = "BR-Pass"; // Token name
    ...
    function mintToken(uint256 amount) external payable
    {
        ...
        require(
            totalSupply(activeBadgeId) + amount <= maxSupply - (NUMBER_RESERVED_TOKENS - reservedTokensMinted), 
    ...
    function changeSaleDetails(uint _activeBadgeId, uint _maxPerTransaction, uint _maxSupply) external onlyOwner 
    {
