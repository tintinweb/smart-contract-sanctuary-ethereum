...
contract StaticMarket {
    ...
    function anyERC1155FforMultiERC20Calls(
        ...
        (
            ...
            uint256[5] memory tokenIdAndNumeratorDenominator
        ...
        uint256 new_fill = SafeMath.add(uints[5], erc20Amounts[0]);
        ...
        require(
            SafeMath.mul(tokenIdAndNumeratorDenominator[2], erc20Amounts[0]) ==
                SafeMath.mul(tokenIdAndNumeratorDenominator[1], nftsAmount),
            "anyERC1155ForERC20: wrong ratio"
        );
