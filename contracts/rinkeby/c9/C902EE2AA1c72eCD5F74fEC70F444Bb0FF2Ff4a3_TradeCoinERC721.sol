    ...
    ReentrancyGuard
{
    ...
    function initiateCommercialTx(
        ...
        if(_payInFiat){
            require(_paymentInGWei == 0, "Not Fiat amount");
        }
        priceForOwnership[_tokenId] = _paymentInGWei * 1 gwei;
        ...
        nonReentrant
    {
        // When not paying in Fiat pay but in Eth
        if (!_payInFiat) {
            require((_paymentInGWei * 1 gwei) >= msg.value, "Can't be less than requested");
