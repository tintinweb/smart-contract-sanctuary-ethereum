...
contract marketplace is Ownable {
    ...
    constructor(address token_, address stakeAddress_, uint decimals_, address nft) {
        nftContractMain = nft;
        token = token_;
        decimals = decimals_;
    ...
    function buyItem(address nftContract, uint256 itemId, uint tokenId)
        external
    {
        require(IStake(stakeAddress).getLevel(tokenId) >= idToMarketItem[itemId].levelRequired && IERC721(nftContractMain).ownerOf(tokenId) == msg.sender,"Earn more xp to be able to buy this item");
        ...
        external
    {
        ...
        IERC20(token).transferFrom(msg.sender, idToMarketItem2[itemId].seller, idToMarketItem2[itemId].price);
        idToMarketItem2[itemId].stock -= amount;
        ...
        external
    {
        ...
        require(msg.sender == idToMarketItem2[itemId].seller, "Not yours");
