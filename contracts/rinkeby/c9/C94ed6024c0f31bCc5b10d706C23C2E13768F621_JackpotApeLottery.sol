...
contract JackpotApeLottery is ReentrancyGuard, IJackpotApeLottery, Ownable {
    ...
    mapping(uint256 => mapping(uint256 => mapping(uint256 => bool))) public _existLotteryNumberInTicket;
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < _ticketNumbers.length; i++) {
            ...
            for(uint256 j = 0; j < 6; j++) {
                uint256 lotteryNumber = thisTicketNumber % (100 ** (j+1));
        ...
        nonReentrant
    {
        ...
        for (uint256 _ticketId = _lotteries[_lotteryId].firstTicketId; _ticketId < _lotteries[_lotteryId].firstTicketIdNextLottery; _ticketId++) {
            ...
            _lotteries[_lotteryId].countWinnersPerBracket[count]++;
