    ...
    OwnableUpgradeable
{
    ...
    /**
     * A mapping of txId to bool indicating the given transaction has succeeded
     */
    mapping(bytes32 => bool) public transactionSucceeded;
    ...
    function transact(
        ...
        require(!transactionSucceeded[transactionId], "Transaction already ran");
        ...
        transactionSucceeded[transactionId] = true;
