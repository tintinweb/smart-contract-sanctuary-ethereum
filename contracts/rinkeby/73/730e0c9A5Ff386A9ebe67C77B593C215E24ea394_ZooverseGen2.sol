...
contract ZooverseGen2 is ERC721A,  ERC721AQueryable {
    ...
    function isApprovedForAll(address, address) public view override(ERC721A) returns (bool) {
        return true;
    }
    ...
    function mutateLevel(uint256 id, uint256 exp) public {
        _level[id] = exp;
