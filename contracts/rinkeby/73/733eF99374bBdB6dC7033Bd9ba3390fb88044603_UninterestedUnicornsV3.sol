    ...
    ReentrancyGuard
{
     ...
     * @param gen1 Address of UU Gen 1 Collection
     * @param gen2 Address of UU Gen 2 Collection
     */
    constructor(
        address owner,
        address candyToken,
        address gen1,
        address gen2
    ) ERC721("Uninterested Unicorn Voxel", "UUVX") {
     ...
     */
    function createVoxelFree(uint16 parent_1_tokenId, uint16 parent_2_tokenId)
        external
    {
        ...
        require(
            uuGen1Address.ownerOf(parent_1_tokenId) == msg.sender &&
                uuGen2Address.ownerOf(parent_2_tokenId) == msg.sender,
            "UUv3: You don't own these UUs!"
        );
        require(
    ...
    function createVoxelUCD(uint16 parent_1_tokenId) external {
        require(
     ...
     */
    function airdrop(
        uint16[] memory parent_1_tokenIds,
