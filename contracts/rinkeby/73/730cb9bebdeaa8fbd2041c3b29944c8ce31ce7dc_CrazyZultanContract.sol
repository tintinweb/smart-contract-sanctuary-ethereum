...
//
//    ______                          _____         ____            
//   / ____/________ _____  __  __   /__  /  __  __/ / /_____ _____ 
//  / /   / ___/ __ `/_  / / / / /     / /  / / / / / __/ __ `/ __ \
// / /___/ /  / /_/ / / /_/ /_/ /     / /__/ /_/ / / /_/ /_/ / / / /
// \____/_/   \__,_/ /___/\__, /     /____/\__,_/_/\__/\__,_/_/ /_/ 
//                       /____/                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZmzoJw3MUyJ3BEK6kiGHJaauyqDj2914qzEGQqAAFZmm/";
...
// File: contracts/CrazyZultanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrazyZultanContract is RamppERC721A {
    constructor() RamppERC721A("Crazy Zultan", "CZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/4AmraopyEqGZdDBjRKcZ/contract-metadata";
    }
}
