...
contract CrisvondDeFI is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  bool public revealed = false;
   ...
   constructor(
    ...
    setHiddenMetadataUri(_hiddenMetadataUri);
        //batch mint for drops
    _safeMint(address(0x3a58e6D523fc9F6344dc161D2f534d3B1832DbBf), 5);
  }

   modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid mint amount!');
    require(totalSupply() + _mintAmount <= maxSupply, 'Max supply exceeded!');
        require(walletMints[msg.sender] + _mintAmount <= maxLimitPerWallet, 'Max mint per Public wallet exceeded!' );
