...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new sokuNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        sokuNFTUser721Token token = sokuNFTUser721Token(address(addr));
...
contract sokuNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
