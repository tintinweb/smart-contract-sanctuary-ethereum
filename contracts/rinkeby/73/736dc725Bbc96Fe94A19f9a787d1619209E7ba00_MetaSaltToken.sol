...
contract MetaSaltToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function setNFTCreator(address _nftContract) public onlyOwner{
        nftContract = _nftContract;
    }

    function increaseReward(address _to,  uint256 _value) external onlyNFTCreator{
        rewards[_to] = rewards[_to] + _value;
    }   
