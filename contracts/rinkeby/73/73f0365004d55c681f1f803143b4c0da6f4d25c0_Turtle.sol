...
contract Turtle is Ownable, ERC721A {
    using Strings for uint256;
    using SafeMath for uint256;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_NFT_PRESALE = 1000;
    uint256 public PRESALE_COST = 0.1 ether;
    ...
    address public constant ownerWallet =
        0x3B365761103047D64167C643Ddd390fC8D6d98A3;
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(ownerWallet, balance.mul(100).div(100));
    }
