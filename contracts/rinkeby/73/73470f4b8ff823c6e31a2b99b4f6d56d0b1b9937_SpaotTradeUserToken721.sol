...
contract SpaotTradeUserToken721 is ERC721 {
    ...
    function createCollectible(string memory tokenURI, uint96[] memory fee, address[] memory receivers) external returns (uint256) {
