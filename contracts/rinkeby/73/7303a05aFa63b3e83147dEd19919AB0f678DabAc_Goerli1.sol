...
contract Goerli1 is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 555;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.005 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xf240eef6074137ca700c1f2aa17ed5de20afac96c06189f2d87af77c00148316;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri = "ipfs://hidden";

    constructor() public ERC721A("Goerlie1", "G1", 555, 555) {}
