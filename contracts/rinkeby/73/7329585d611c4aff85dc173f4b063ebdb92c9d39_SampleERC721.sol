...
contract SampleERC721 is SampleERC721Base {
    ...
    constructor(string memory name, string memory symbol, uint256 supply, uint256 genCount) SampleERC721Base(name, symbol, supply, genCount) {}
...
contract SampleERC721Base is ERC721Enumerable, Ownable {
