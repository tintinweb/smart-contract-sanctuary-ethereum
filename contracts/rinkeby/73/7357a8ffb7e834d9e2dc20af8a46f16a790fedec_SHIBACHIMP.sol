...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
...
contract SHIBACHIMP is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   SHIBACHIMPDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("SHIBACHIMP", "SHIBACHIMP") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 0;
		_buyMarketingFee = 4;
        _buyDevFee = 4;
        ...
        _maxWallet = 200000000 * (10**18);
        _maxBuy = 100000000 * (10**18);
        _maxSell = 100000000 * (10**18);
    	...
    	dividendTracker = new SHIBACHIMPDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0xE822f503f8551D1918e2E5d605C4d192EC2B7855);
        _devWallet = payable(0xD80ABC6C898777742e818142Cd1E97E165c635A4);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SHIBACHIMPDividendTracker newDividendTracker = SHIBACHIMPDividendTracker(payable(newAddress));
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "The router already has that address");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Account is already the value of 'blacklisted'");
    ...
    function setAutoBlacklist(bool _value) external onlyOwner{
        autoBlacklist = _value;
    }
}

contract SHIBACHIMPDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("SHIBACHIMP_Dividend_Tracker", "SHIBACHIMP_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, " claimWait must be updated to between 1 and 24 hours");
    ...
    function withdrawRemainingERC20Token(address token, address account) public {
        require(isAuth[msg.sender]);
