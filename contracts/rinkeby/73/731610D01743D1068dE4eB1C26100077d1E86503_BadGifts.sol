...
contract BadGifts is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string private _uri = "https://dev.badgifts.ciberchico.com/";
    ...
    function changeGiftMessage(uint256 tokenId, string memory newMessage)
        public
    {
        require(ownerOf(tokenId) == msg.sender, "Only owners can set messages");
        require(validMessage(newMessage), "Message would be too large");
        _giftMessages[tokenId] = newMessage;
    }
