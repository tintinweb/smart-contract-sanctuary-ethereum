...
contract BotXNFT is Pausable, Ownable, ERC721AQueryable, IBotXNFT {
    ...
    function mint(uint256 _nbTokens) external payable whenNotPaused {
        ...
        require(
            preSaleListPurchases[msg.sender] + _nbTokens <= preSaleMintLimit,
        ...
        require(
            mintListPurchases[msg.sender] + _nbTokens <= publicMintLimit,
    ...
    function merkleMint(
        ...
        require(
            !SaleStatus,
            "Pre-sale not running"
        );
        require(numberOfTokens <= preSaleTransLimit, "Exceeded presale translimit");
    ...
    function setPreSaleTransLimit(uint256 limit) external onlyOwner {
    ...
    function setPreSalePrice(uint256 _newPreSalePrice)
        external
        onlyOwner
    {
