...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7d9b85d88De6F1C6c0d91E87F633A32472f3336C];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNvWGsQ7DsYDfUtdjd7XNYw9CENXsE4ZGDpA1aJxPfXJ2/";
...
// File: contracts/MarbelousMindsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MarbelousMindsContract is RamppERC721A {
    constructor() RamppERC721A("Marbelous Minds", "MRBL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/F9TPzqLyWzUKS2KduQ8Y/contract-metadata";
    }
}
