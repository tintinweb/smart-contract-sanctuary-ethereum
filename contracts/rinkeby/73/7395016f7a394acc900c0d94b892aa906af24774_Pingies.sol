...
contract Pingies is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Pingies", "PING") {
    setBaseURI("ipfs://bafybeib2h4pedq7i7j5wnw2ocu3ojbqzz7oktulwlr2hziusht6ge3l5uu/");
  }
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    if(_numberMinted(_msgSenderERC721A()) >= FreeLimit) {
    ...
    returns (string memory)
  {
    ...
    return bytes(currentBaseURI).length > 0
        ...
        : "";
          ...
          string memory currentBaseURI = "ipfs://bafybeiairhdnkuh2ahrxrzwo45rccfgvtkeaovf3herfylgl36mv5vidgu/";
        return bytes(currentBaseURI).length > 0
        ? string(abi.encodePacked(currentBaseURI, _toString(tokenId), ".json"))
        : "";
    }
