...
contract  TEST_DRAGONS is  ERC721Enumerable,Ownable 
{
...
//     mapping (address => bool) public  accounts;
    ...
    constructor() ERC721("lodhi", "lodhi1")  {}




    //   function turn_on_whitelisting() public onlyOwner {
    //     isPaused  =!isPaused;
    // }
...
//returns totalsupply of tokens 
      function totalsupply() public view  returns (uint){
       ...
       function mint(uint quantity) public   {
           ...
           require(quantity > 0, "Number of tokens can not be less than or equal to 0");
           //require(quantity <=3,"Chosen Amount exceeds MaxQuantity");
           require(quantity+totalSupply()<= maxSupply,"public sale ended all tokens have been minted");
