...
contract NFTLauncher is VRFConsumerBase, ChainlinkClient, Ownable {
        ...
        )
    {
        ...
        uint256 FEE_TO_REMOVE = (FEE_PERCENTAGE_SAVED_USING_THIS_METHOD * _packPriceWithoutFeeRemoved) / 10000;
        uint256 REMAINDER_FEE_PERCENTAGE = PACK_SALE_BASE_FEE_PERCENTAGE - FEE_PERCENTAGE_SAVED_USING_THIS_METHOD;
        uint256 FEE_REMAINING_FOR_SEAPAD = (REMAINDER_FEE_PERCENTAGE * _packPriceWithoutFeeRemoved) / 10000;
        ...
        if (!isBasePayment) {
            uint256 result = seapadPayments.getEstimatedTokenNeededToRecieveOtherToken(
                    paymentMethodAddress,
                    basePaymentMethodAddress,
            ...
            _packPriceAfterFeeRemoved = result + ((result * slippage2) / 10000) - FEE_TO_REMOVE;
    ...
    function purchasePack(
        ...
        require(
            token.allowance(msg.sender, address(this)) >= pricePerPackInChoosenPaymentMethodAfterSavedFeeRemoved,
            "Please allow contract to spend your tokens!"
        );
        token.transferFrom(msg.sender, address(this), pricePerPackInChoosenPaymentMethodAfterSavedFeeRemoved);
        ...
        token.approve(paymentAddress, pricePerPackInChoosenPaymentMethodAfterSavedFeeRemoved);
        uint256 slippage2 = slippage;
        ...
        uint256 remainingTokens = pricePerPackInChoosenPaymentMethodAfterSavedFeeRemoved - tokensSpentFromOriginalBalanceToGetChainlinkToken - feeAmountRemainingForSeapadFromOriginalPackPrice;
