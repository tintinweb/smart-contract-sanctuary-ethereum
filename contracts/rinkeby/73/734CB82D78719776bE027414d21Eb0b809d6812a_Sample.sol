...
contract Sample is ERC1155, Ownable, ERC2981 {
    ...
    function purchaseTokens(uint256 _mintAmount) public payable {
        ...
        require(NFTPerWallet[msg.sender]<maxMintAmount,"This user limit exceeded");
    ...
    function uri(uint256 _tokenid) override public view returns (string memory) {
        return string(
            abi.encodePacked(
                metadataFolderIpfsLink,
                Strings.toString(_tokenid),baseExtension
            )
        );
    }
