...
contract ProjectP22 is ERC1155Upgradeable, OwnableUpgradeable, VestedAuctionUtils {
    string public name;
   ...
   modifier activePack(uint32 packId) {
    ...
    function addNewPack(
        ...
        PackDetails[newPackId] = PackDetail(true, _packName, _packType, _packDescription, _numOfTokensInPerPack, _maxPackSupply, 
                maxTokenSupply[_tokenContractAddress], maxTokenSupply[_tokenContractAddress] + (_numOfTokensInPerPack * _maxPackSupply) - 1,'', _tokenContractAddress);
        
        maxAvailableIndex[newPackId] = _maxPackSupply - 1;
        maxTokenSupply[_tokenContractAddress] = PackDetails[newPackId].endTokenId + 1;
    }
    ...
    function startPackSale(
        ...
        numOfDropPointsInPack[packId] = VestedAuctionUtils.getNumOfDropPoints(_packStartPrice);
    }
