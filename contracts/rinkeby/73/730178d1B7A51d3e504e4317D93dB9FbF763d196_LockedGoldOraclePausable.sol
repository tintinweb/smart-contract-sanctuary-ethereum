...
// The read checks if the contract is not paused and 
// the oracle value is always greater than the present circulation. In case either condition fails a ZERO value is returned
...
/***
 ...
 @dev CACHE Token Contract Mint return 0 when this function fails that requirement. 
