...
// File: contracts/INFWebsite.sol

// SPDX-License-Identifier: GPL-3.0

pragma solidity 0.8.0;

interface INFWebsite {

    function websiteURI() external view returns (string memory);
}

// File: contracts/NFWebsite.sol
...
contract NFWebsite is INFWebsite, ERC721URIStorage, ERC721Enumerable, AccessControlEnumerable, Ownable{
    ...
    function burn(uint256 tokenId) public virtual {
        require(ownerOf(tokenId) == _msgSender(), "WeMintArt: only current owner can burn!");
        _burn(tokenId); 
    }
    ...
    function websiteURI() external view virtual override returns (string memory) {
        return _tokenURI; 
    }
