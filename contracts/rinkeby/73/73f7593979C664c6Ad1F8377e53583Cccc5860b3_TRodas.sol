...
contract TRodas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Teen Rebel Ape TRoads", "TRODAS") {
    setHiddenMetadataUri("https://createtops.cards/teenrebelapeclub/troda/hidden.json");
  }
