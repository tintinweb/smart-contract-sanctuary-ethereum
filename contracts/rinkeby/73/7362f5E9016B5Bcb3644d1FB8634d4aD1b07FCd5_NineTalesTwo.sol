...
contract NineTalesTwo is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant NTT_MAX_SUPPLY = 80; // 4444
    uint256 public NTT_WHITELIST = 25; //3844
    uint256 public NTT_GIFT = 30; //100
    uint256 public NTT_PUBLIC = 25; //500
    
    uint256 public NTT_PUBLIC_PER_USER = 2;
    uint256 public NTT_WHITELIST_PRICE = 0.00008 ether; // 0.089
    uint256 public NTT_PUBLIC_PRICE = 0.00009 ether;  // 0.099
    ...
    constructor(
        address xOwnerAddress,
        address xSignerAddress,
        string memory xBaseTokenURI

    ) ERC721A("NTP1", "NIT") {
        _ownerAddress = xOwnerAddress;
        _signerAddress = xSignerAddress;
        _baseTokenURI = xBaseTokenURI;
    }
