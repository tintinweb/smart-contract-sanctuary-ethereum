...
contract Uncle_Chop_Chop is ERC721A, Ownable {
  using Strings for uint256;

 constructor() ERC721A("Uncle Chop Chop", "UCC")  {}

  //URI uriPrefix is the BaseURI
  string public uriPrefix = "ipfs://QmcW9p1kbBtU1nia96f1qegQa4XBfgZNibuQyzXkH1jz1n/";
  string public uriSuffix = ".json";

  uint256 public constant maxSupply = 10000; 
  uint256 public  Reserved = 200; 
  uint256 public Publiccost = 90 ether;
  uint256 public WLcost = 60 ether;
  uint256 public maxMintAmount = 10;
  bool public paused = false;
  bool public PublicSaleStarted = false;
  bytes32 public merkleRoot= 0x79de5daf7e60bdcb3db19ddb3c337142e00375c45845d19d85aaa1d3437ea648 ;


  modifier mintCompliance(uint256 _mintAmount) {
    require(totalSupply() + _mintAmount <= maxSupply - Reserved, "Max supply exceeded!");
    require(_numberMinted(msg.sender) + _mintAmount <= maxMintAmount , "Max mint Exceeds!");
  ...
  function mintPublic(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(PublicSaleStarted, "PublicSale Paused");
  ...
  function mintWL(uint256 _mintAmount, bytes32[] memory _merkleProof) public payable mintCompliance(_mintAmount) {
    ...
    require(!PublicSaleStarted, "The presale ended!");
  ...
  function setPublic_Cost(uint256 _Publiccost) public onlyOwner {
