...
contract BCChars is ERC721URIStorage, Ownable {
    ...
    function decantNewClone(uint _id) public {
        ...
        // // Conversion to uint8 is fine because 3 bits maxes at 7
        // TODO: Evaluate min balance
        // TODO: Add perk for low clones allowed or mortals with 0 respawns???
        characters.push(Character(
            // "Fred", // TODO: generate a random name, possibly a look/art (maybe in FE)
            // _smallIntBetweenVals(2, actionsCap, _sliceHashToSmallInt(finalHash, 3, 0)),
            _smallIntBetweenVals(2, healthCap, _sliceHashToSmallInt(finalHash, 3, 3)),
            _smallIntBetweenVals(2, carryCap, _sliceHashToSmallInt(finalHash, 3, 6)),
            ...
            0,
            _smallIntBetweenVals(0, maxClonesCap, _sliceHashToSmallInt(finalHash, 4, 24)),
            _smallIntBetweenVals(0, abilityCap, _sliceHashToSmallInt(finalHash, 4, 28)),
            _smallIntBetweenVals(0, flawCap, _sliceHashToSmallInt(finalHash, 4, 32)),
            false
        ));
    ...
    // function mintRandomCharacter() public payable {
    //     require(msg.sender == owner() || msg.value == mintCost);
    //     // Character memory newChar;
    //     characters.push(Character(
    //         "Fred", //TODO Random name generator
