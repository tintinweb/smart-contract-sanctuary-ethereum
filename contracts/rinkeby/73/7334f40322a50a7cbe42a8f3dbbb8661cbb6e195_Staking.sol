...
contract Staking is Ownable, Pausable {
    ...
    // it must implement IERC721Receiver.onERC721Received, which is called upon a safe transfer, and return the magic value
    // bytes4(keccak256("onERC721Received(address,address,uint256,bytes)")); otherwise, the transfer is reverted. Requires the msg.sender to be the owner, approved, or operator
