...
contract Blacklist is ERC721A, Ownable {
    ...
    uint256 public constant devReserve = 500;
    uint256 public constant maxMintPerCall = 20;
    uint256 public totalMints = 0;
    uint256 mintPrice = 0.07 ether;
    uint256 devMinted = 0;
    ...
    function withdraw() external onlyOwner {
        ...
        // payable().transfer(balance * 375 / 1000);
        // payable().transfer(balance * 10 / 1000);
        // payable().transfer(balance * 625 / 1000;
