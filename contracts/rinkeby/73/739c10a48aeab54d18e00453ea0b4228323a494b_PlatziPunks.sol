...
contract PlatziPunksDNA {
    ...
    // This pseudo random function is deterministic and should not be used deployed
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    ...
    function _paramsURI(uint8 _dna) internal view returns (string memory) {
    ...
    function imageByDNA(uint256 _dna) public view returns(string memory) {
        string memory baseURI = _baseURI();
        string memory paramsURI = _paramsURI(uint8(_dna));
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        string memory jsonURI = Base64.encode(abi.encodePacked(
            ...
            image,
            '", "external_url": "https://theholyones.io/" }'
        ));
