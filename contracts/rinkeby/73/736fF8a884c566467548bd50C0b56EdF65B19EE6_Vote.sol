...
contract Vote is BaseContract
{
     ...
     * Properties.
     */
    uint256 private _minimumVaultBalance;
     ...
     */
    function getInitiave(uint256 initiative_) external view returns (string memory, string memory, uint256, uint256, uint256, uint256)
    {
        return (
    ...
    function vote(uint256 initiative_, bool vote_) external
    {
        ...
        require(IVault(addressBook.get("vault")).participantBalance(msg.sender) >= _minimumVaultBalance, "Vault balance too low");
