...
// File: MetaFamilyGenesisClub.sol
...
contract MetaFamilyGenesisClub is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint256 public whiteListSaleStartTime = 1647055851;
    ...
    uint256 public auctionEndTime = auctionStartTime + 2 hours;
    uint256 public auctionTimeStep = 5 minutes;
    uint256 public totalAuctionTimeSteps = 12;

    uint256 public auctionStartPrice = 1.6 ether;
    uint256 public auctionPriceStep = 0.05 ether;
    uint256 public auctionEndPrice = 1 ether;

    uint256 public auctionPurchased;
    uint256 public auctionMaxPurchasedQuantityPerTx = 30;

    uint256 public remainingQuantity = 3600;
    address public minter;
    bytes32 public whiteListMerkleRoot;
    bytes32 public prepaidWhiteListMerkleRoot;

    mapping(address => uint256) public whiteListPurchased;
    mapping(address => bool) public prepaidWhiteListDelivered;
    ...
    constructor() ERC721A("MetaFamilyGenesisClub", "MFGC") {
        minter = 0xE3dE5a956Ce157d56522E88AfB92F63506918654;
    }
    ...
    function mintPrepaidWhiteList(
        ...
        prepaidWhiteListDelivered[receiver] = true;
        remainingQuantity -= quantity;
    ...
    function setWhiteListData(
        ...
        prepaidWhiteListMerkleRoot = _prepaidWhiteListMerkleRoot;
    }
