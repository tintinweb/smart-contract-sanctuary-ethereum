...
import "./IERC721EnumerableChaos.sol";
 ...
 * adds - enumerability of all the token ids owned by each account.
 * removes - enumerability of all the token ids in the contract and totalSupply function
 * WARNING: You have code your own totalSupply function
 */
abstract contract ERC721EnumerableChaos is ERC721, IERC721EnumerableChaos {
