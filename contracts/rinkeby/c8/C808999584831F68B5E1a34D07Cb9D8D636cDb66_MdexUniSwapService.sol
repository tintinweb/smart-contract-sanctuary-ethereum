...
contract MdexRoutingManagement is Ownable {
    ...
    function addTradingRoute(string calldata _name, IMdexService _routingAddress) external onlyOwner {
        tradingRoutes.push(Route({name: _name, enable: true, service: _routingAddress}));
    }
