...
contract PromoMinter is Initializable, UUPSUpgradeable, OwnableUpgradeable, ERC721AUpgradeable{
    ...
    function initialize(string memory _uri) public initializerERC721A initializer {
        __Ownable_init();
    ...
    function _authorizeUpgrade(address) internal override onlyAllowed {}
