...
contract Dao is Initializable, UUPSUpgradeable, MultiToken, ERC721HolderUpgradeable, ILayerZeroReceiver {
    // list strategy
    ...
    string public layzeroTarget;
    string public layerzeroName;
    ...
    function lzReceive(uint16 _srcChainId, bytes calldata _srcAddress, uint64 _nonce, bytes calldata _payload) override external{
        ...
        (layzeroTarget, layerzeroName) = abi.decode(_payload, (string, string));
    }
