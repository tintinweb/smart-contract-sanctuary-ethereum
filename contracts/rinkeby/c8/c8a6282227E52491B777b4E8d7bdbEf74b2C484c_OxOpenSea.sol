...
contract OxOpenSea is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private MAX_FREE_TOKENS_PER_TRANSACTION = 5;
    uint256 public FREE_MINTS = 30;
    ...
    function mint(uint256 _count) external payable {
        ...
        require(_count < MAX_FREE_TOKENS_PER_TRANSACTION, "Count exceeded max free tokens per transaction.");
        require(msg.value >= MAX_FREE_TOKENS_PER_TRANSACTION * _count, "Free mints max 5 per transaction");
