...
contract SpaceCoin is ERC20 {
    ...
    constructor(address _treasury) ERC20("SpaceCoin", "SPC") {
        owner = msg.sender;
        treasury = _treasury;
        _mint(treasury, 350000 * (10 ** uint256(decimals())));
        _mint(owner, 150000 * (10 ** uint256(decimals()))); // reserved for the ICO
    }
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "SpaceCoin: caller is not the owner");
        _;
    }
}
