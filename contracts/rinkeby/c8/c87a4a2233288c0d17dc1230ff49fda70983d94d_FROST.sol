...
contract FROST is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function setWhitelist(address minter) external onlyOwner {
        whitelist[minter] = true;
    }

    function unsetWhitelist(address minter) external onlyOwner {
