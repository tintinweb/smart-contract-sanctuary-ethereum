...
contract Escrow is Initializable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        // the Threescrow contract (so the Threescrow contract can pay this Escrow contract directly without being a participant)
        ...
        for (uint256 i = 0; i < _participants.length; i++) {
            ...
            require(
                _participants[i] != _judge &&
                    ...
                    _participants[i] != mainContractAddress,
        ...
        IThreescrow _mainContract = IThreescrow(mainContractAddress);
    ...
    modifier participantCheck() {
        require(
            blockNewParticipants == false ||
                ...
                msg.sender == mainContractAddress, // so the Threescrow contract can pay this Escrow contract directly without being a participant
