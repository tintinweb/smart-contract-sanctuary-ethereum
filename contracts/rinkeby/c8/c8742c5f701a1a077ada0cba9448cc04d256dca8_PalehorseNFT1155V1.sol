...
// File: contracts/1155ERCChnages.sol
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function _mint(address tokenOwner,uint256 tokenId, uint256 _supply, string memory _uri, uint256 _fee) internal {
        require(totalMintedPerToken[tokenId] + _supply <= maxSupplyPerToken[tokenId], "Max supply reached.");
        ...
        totalMintedPerToken[tokenId] += _supply;
...
contract PalehorseNFT1155V1 is ERC1155 {
    ...
    */
       ...
       if(nonceToTokenId[voucher.vNonce] == 0) 
        {
            ...
            maxSupplyPerToken[tokenCounter] = voucher.maxSupply;
    ...
    function getMessageHash( uint256 _nonce, uint256 minPrice, string memory tokenUri) public pure returns (bytes32) {
