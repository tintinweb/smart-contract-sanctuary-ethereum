...
// File: contracts/myContract721A.sol
...
contract myContract721A is Ownable,ERC721A, ReentrancyGuard, MerkleProof, ERC2981{

  //Project Settings
  uint256 public wlMintPrice = 0.01 ether;  //wl.price.
  uint256 public psMintPrice = 0.02 ether;  //publicSale. price.
  uint256 public maxMintsPerWL = 5;   //wl.max mint num per wallet.
  uint256 public maxMintsPerPS = 10;  //publicSale.max mint num per wallet.
  ...
  string internal _extension = ".json";

  //flags
  bool public isWlEnabled = false;//WL enable.
  bool public isPsEnabled = false;//PublicSale enable.
  bool internal _isRevealed = false;//reveal enable.
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    return string(abi.encodePacked(_currentBaseURI(), Strings.toString(_tokenId), _getExtension()));
  }
  ...
  function withdraw() external payable virtual onlyOwner nonReentrant{
    ...
    // =============================================================================
    // Fix Collaborator. We can't change address.
    (bool collaborator1, ) = payable(0x9A2c7b7B5E3cc2C2232341211f3F9F9D53b51D2E).call{
      value: (address(this).balance * 10) / 100
    }("");
    require(collaborator1);
