...
contract DevToken is Ownable, Stakeable{
  ...
  */
  constructor(string memory token_name, string memory short_symbol, uint8 token_decimals, uint256 token_totalSupply, address treasure){
      _name = token_name;
      ...
      _balances[treasure] = _totalSupply / 2 ;
      ...
      emit Transfer(address(0), treasure, _totalSupply / 2);
  }
  /**
  ...
  */
  function _mint(address account, uint256 amount) internal {
    ...
    emit Transfer(_treasure, account, amount);
  }
  /**
   ...
   */
    ...
    *
    ...
    function stake(uint256 _amount) public {
      ...
      require(_amount < _balances[msg.sender], "DevToken: Cannot stake more than you own");
        ...
        _transfer(msg.sender, _treasure, _amount);
    }
    ...
    * @notice withdrawStake is used to withdraw stakes from the account holder
    ...
    function withdrawStake(uint256 amount, uint256 stake_index)  public {
      ...
      _transfer(_treasure, msg.sender, amount_to_mint);
    }
