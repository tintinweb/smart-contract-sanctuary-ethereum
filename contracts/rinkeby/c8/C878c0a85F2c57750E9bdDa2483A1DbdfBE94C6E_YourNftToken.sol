...
contract YourNftToken is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    address public dc;
    address public constant OTHER_CONTRACT = 0xCBcBB8e246c63c0c0d8F9B22CB75BecF1e016b10;
    MainContract MainContractData = MainContract(OTHER_CONTRACT);
    ...
    function getBaseUriFromAnotherContract()
        public
        view
        returns (string memory)
    {
        // dc.call(bytes4(keccak256("setA(uint256)")), _val);
         string memory baseUriRes = MainContractData._baseURI();
         return baseUriRes;
    
    }

    function getAnotherContractAddress() public view returns (address) {
