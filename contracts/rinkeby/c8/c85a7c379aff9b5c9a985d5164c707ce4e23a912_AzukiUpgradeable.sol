...
// File: contracts/AzukiUpgradeableFactory.sol
...
contract AzukiUpgradeableFactory is Initializable, UUPSUpgradeable, OwnableUpgradeable
{
    address erc721Implementation;
    uint256 public fee;

    event ContractDeployed(address indexed erc721Implementation, address author);
    ...
    function initialize() public initializer  {
        ...
        erc721Implementation = address(new AzukiUpgradeable());
    }
    ...
    function create(string memory name_,
        ...
        string memory _uriPrefix,
        string memory _uriSuffix,
        uint256 startTokenId_) onlyOwner() payable public
    {
        address payable clone = payable(ClonesUpgradeable.clone(erc721Implementation));

        AzukiUpgradeable(clone).initialize(name_,
            symbol_,
            msg.sender,
            _uriPrefix,
            _uriSuffix,
