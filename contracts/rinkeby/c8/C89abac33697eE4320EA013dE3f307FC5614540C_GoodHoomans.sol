...
contract GoodHoomans is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant RESERVED_TOKENS = 100;
    uint256 public FOR_SALE_TOKENS = 5000 - RESERVED_TOKENS;
    address public constant RESERVED_TOKENS_ADDRESS = 0x29544A51b2a24165CdDCE86259aFa40447A4172c;
    ...
    uint256 public tokenPricePublicSale = 0.1 ether;

    uint256 public maxTokensPerAddressPresale = 3;
    uint256 public maxTokensPerAddress = 5;
    uint256 public maxTokensPerTransaction = 5;

    uint256 public presaleTotalLimit = 2000;

    bytes32 public whitelistRoot = 0x5cbb7b059a18f24e66ab9e16fce1ba1f309953713cee37b7f29bcf278d658db6;

    string public tokenBaseURI = "ipfs://QmRcgWCLki8JkaGq8vCge5sdAhxb2ZxYBHaDtrmpkZubc6/";

    uint256 public soldAmount = 0;
    mapping(address => uint256) public purchased;

    constructor() ERC721A("Good Hoomans", "GH") {
    ...
    function setCurrentForSaleLimit(uint256 _currentForSaleLimit) external onlyOwner {
