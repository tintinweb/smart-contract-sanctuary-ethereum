...
contract Miladys is ERC721, Ownable {
    ...
    function mintMiladyClone(string memory id) public payable {
        uint256 miladyPrice = 10000000000000000; //0.01 ETH
        require(miladyPrice <= msg.value, "Ether value sent is not correct");
