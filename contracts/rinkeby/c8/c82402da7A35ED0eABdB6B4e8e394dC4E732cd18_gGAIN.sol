...
contract gGAIN is IgGAIN, ERC20 {
    ...
    constructor(address _migrator, address _sGAIN)
        ERC20("Governance GAIN", "gGAIN", 18)
    {
     ...
     * @param _sGAIN address
     */
    function migrate(address _staking, address _sGAIN) external override onlyApproved {
        ...
        require(_sGAIN != address(0), "Zero address found");
        sGAIN = IsGAIN(_sGAIN);
    }
    ...
    /**
     * @notice pull index from sGAIN token
     */
    ...
    /**
        @notice converts gGAIN amount to GAIN
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts GAIN amount to gGAIN
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gGAIN::getPriorVotes: not yet determined");
