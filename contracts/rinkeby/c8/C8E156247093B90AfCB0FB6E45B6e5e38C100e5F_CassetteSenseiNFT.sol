...
contract CassetteSenseiNFT is ERC721, Ownable, ERC721Pausable, ERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (rounds[id].revealed == false) {
            ...
            Buffer.append(
                ...
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "CASSETTE SENSEI NFT Project is unique 888 collectible NFTs.", "image": "ipfs://QmXVFFubCRN1u2v74tHQDAZgyXgSPh5up6LdNaEBzVJiuz/", animation_url": "ipfs://QmegGHtKVe8CBdQjZJirCVd9RQa5MnmpZcMJcxvL9BeTmt/", external_url": "https://machinesensei.com/"}'
                    )
                )
            );
            ...
            // bytes
            //     memory TEMPLATE = 'data:text/plain,{"description": "CASSETTE SENSEI NFT Project is unique 888 collectible NFTs.", "external_url": "https://machinesensei.com/", "image": "ipfs://QmXVFFubCRN1u2v74tHQDAZgyXgSPh5up6LdNaEBzVJiuz/", "animation_url": "ipfs://QmegGHtKVe8CBdQjZJirCVd9RQa5MnmpZcMJcxvL9BeTmt/", "name": "CASSETTE SENSEI BOX" }';
