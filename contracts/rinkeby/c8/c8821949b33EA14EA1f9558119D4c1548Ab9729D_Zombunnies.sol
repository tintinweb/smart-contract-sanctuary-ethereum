...
abstract contract ERC721AEnumerable is ERC721A, IERC721AEnumerable {
     ...
     */
    // function totalSupply() public view virtual override(ERC721A, IERC721AEnumerable) returns (uint256) {
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        ...
        require(index < ERC721A.totalSupply(), "ERC721AEnumerable: global index out of bounds");
...
contract Zombunnies is ERC721AEnumerable, AccessControl, Ownable {

    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    string _baseTokenURI = "https://api.zombunnies.io/token/";

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    address public upgradedToAddress = address(0);
    uint256 internal _cap = 5000;// 3333 through burn, 1667 through mint
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721AEnumerable, AccessControl) returns (bool) {
