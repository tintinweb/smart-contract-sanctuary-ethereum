...
//    function getAmountIn(uint256 amountOut, uint256 reserveIn, uint256 reserveOut) internal view returns(uint256){
//        if (amountOut == 0) revert InvalidAmount();
//        if (reserveIn == 0 || reserveOut == 0) revert InsufficientReserves();
//
//        uint256 num = reserveIn * amountOut * FEE_MULTIPLE;
//        uint256 denom = (reserveOut - amountOut) * FEE_MULTIPLE_TAKE;
//
//        return (num / denom) + 1;
//    }
