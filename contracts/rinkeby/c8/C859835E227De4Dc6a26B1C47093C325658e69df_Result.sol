...
contract Result{
     ...
     function withDraw() public timeOver {
         require(block.timestamp > stopTime,"Staking time is not completed");
         token.transferFrom(address(this),msg.sender,arrstk[arrstk.length].stkAmount);
