...
contract cLoUdDuDeS is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public TotalSupplyForFree = 20;
    ...
    function _baseURI() internal view virtual override returns (string memory) {
 	...
 	function FreeMint(address wallet, uint256 _CloudsAmount) public onlyOwner {
  	    uint256 TotalCloudsForFree = totalSupply();
	    require(TotalCloudsForFree + _CloudsAmount <= TotalSupplyForFree, "You can't free mint Clouds more than Total Supply For Free! 0-0");
        require(_CloudsAmount < 1, "You can FREE mint only 1 Cloud!");
        require(_CloudsAmount > 1, "You can't mint 0 Clouds! LOL 0-0!");
