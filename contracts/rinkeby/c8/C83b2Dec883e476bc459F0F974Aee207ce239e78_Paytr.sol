...
contract Paytr is Ownable {
    ...
    event PayOutInfoErc20(address sender, uint256 interestAmount, address supplier, uint256 amount, bytes indexed paymentReference, uint dueDate, address tokenAddress);
