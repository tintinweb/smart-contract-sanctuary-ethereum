...
// File: contracts/funboriscontract.sol
...
contract FunBoris is ERC721, Ownable {

    using Strings for uint256;

    uint256 public constant MAX_TOKENS = 10000;
    uint256 private constant TOKENS_RESERVED = 5;
    uint256 public price = 800000000000000000;
    ...
    constructor() ERC721("FunBoris", "FBO") {
        //Base IPFS URI of the NFT's
        baseUri = "ipfs://bafybeibx3hxlvevqmijk5jutwqa4uborpnlixrb33gbdjz6b4e2zbfzphu/";
    ...
    function withdrawALL() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x7f2f649Aed65d127c62B7340085fEC4D13300d25).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x7f2f649Aed65d127c62B7340085fEC4D13300d25).call{value: balanceTwo}("");
