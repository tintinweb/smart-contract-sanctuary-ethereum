...
contract NFTProject is ERC721 {
    ...
    uint64 public TOKEN_PRICE = 0.1 ether;
    uint64 public MAX_TOKENS_PER_WALLET = 5;
    uint64 public totalTokens;

    uint64 public saleOpens = 0;
    uint64 public saleCloses = 253378267206;    
    uint64 public presaleOpens = 0;
    uint64 public presaleCloses = 253378267206;
    
    bytes32 public merkleRoot;

    string private BASE_URI = "https://enefte.info/nftproject/?token_id=";
    ...
    */
    function mint(uint64 _numberOfTokens) external payable  {
        ...
        ERC721._balances[msg.sender] += _numberOfTokens;
    ...
    */
    ...
    constructor() ERC721("NFTProject", "NFT") {
        _owner = msg.sender;
