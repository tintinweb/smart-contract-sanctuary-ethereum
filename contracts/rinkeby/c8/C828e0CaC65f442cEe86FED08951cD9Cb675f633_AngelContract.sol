...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1658943480;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1659116280;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe617103c05e2d8Cb4d5f90D03Cbbe5F6D932bE70];
...
contract AngelContract is RamppERC721A {
    constructor() RamppERC721A("Angel", "RAMPP"){}
}
