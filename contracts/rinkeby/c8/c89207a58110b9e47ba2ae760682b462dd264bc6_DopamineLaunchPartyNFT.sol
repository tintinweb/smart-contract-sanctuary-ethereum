...
contract DopamineLaunchPartyNFT is ERC721, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(address proxyRegistry_)
        ERC721("Dopamine Launch Party", "DOPELAUNCH")
    {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://dev-api.dopamine.xyz/launchparty/metadata/";
    }
