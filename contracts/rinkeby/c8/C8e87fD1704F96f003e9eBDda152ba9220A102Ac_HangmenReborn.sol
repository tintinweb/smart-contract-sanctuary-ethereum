...
contract HangmenReborn is ERC721A, Ownable, ERC2981{
    ...
    address public OLD_HANG = 0x7c146E2F2eA3dD022dC33d927bf28888f9Fd595c;
    ...
    function mint(uint256 _amount) external payable publicSaleActive {
        ...
        uint256 discounted_amount = _amount - max(0, (FREE_PER_ADDRESS - userMintsTotal));
        uint256 price = PRICE;
    ...
    /// The public sale should be active for this call to succeed
    function xchange() external publicSaleActive{
        require(tx.origin == msg.sender, "No contract minting");
