    ...
    ERC1820Implementer
{
    ...
    constructor() {
        //constructor den supported token schon mitgeben
    ...
    function buyItem(uint256 _index) public {
        ...
        IERC777(token).operatorSend(msg.sender, i.seller, i.price, "", "");
    }

    function getAllRewards() public view returns (Item[] memory) {
        return arr;
    }
