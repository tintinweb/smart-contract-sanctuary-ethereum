...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeFb522CF2e8D9631b8fb7588d4c65140D13D47c6];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 465 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaLN16MMihwME5d7HvwAQVhwvUjZ5QoAbhJ8G5F1Li2h3/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 465");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 465");
...
// File: contracts/DontHideMeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DontHideMeContract is RamppERC721A {
    constructor() RamppERC721A("Dont Hide Me", "DHM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/zBLIt9seMwurdNb5T34Q/contract-metadata";
    }
}
