...
contract AventorsNFT is Ownable, ERC721A, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public icPrice = 0.01 ether;
    ...
    function mintIC(uint8 quantity) external payable callerIsUser nonReentrant {
    ...
    function mintPreSale(uint8 quantity) external payable callerIsUser nonReentrant {
        require(_presaleActive, "Pre-sale is not active");
        require(quantity > 0, "Must mint more than 0 tokens");
    ...
    function mintPublicSale(uint256 quantity) external payable nonReentrant callerIsUser {
