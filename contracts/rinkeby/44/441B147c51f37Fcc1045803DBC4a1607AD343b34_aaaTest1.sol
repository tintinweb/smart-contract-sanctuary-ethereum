/*
KKKKKKKKKKKKKKKKKKKKKK-------BiletsClub-2D-------KKKKKKKKKKKKKKKKKKKK
KKKKKKKKKKKKKKKKKKKKKK-------BiletsClub-2D-------KKKKKKKKKKKKKKKKKKKK
...
/**
 * @title aaaTest1 Contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */

contract aaaTest1 is ERC721A, Ownable {
    ...
    string public contractURI =
        "https://bilet-web3-hazel.vercel.app/api/opensea_meta/";
    string public baseURI =
        "https://bilet-web3-hazel.vercel.app/api/opensea_meta/";

    constructor() ERC721A("aaaTest1", "MBLT") {}
    ...
    function setMaxSupply(uint256 _mintRate) public onlyOwner {
        require(
            _mintRate >= mintRate,
            "The mint rate must be higher than the previous one."
        );
