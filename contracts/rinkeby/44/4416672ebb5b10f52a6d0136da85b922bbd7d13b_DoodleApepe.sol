...
contract DoodleApepe is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("DoodleApepe", "Dpepe") {
        _mint(msg.sender,10);
        }
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        uint256 payoutDev = balance.mul(15).div(100);
        payable(0x4e41eA2aCD5B4691F41BAb84F20c416eD80A1bb9).transfer(payoutDev);
