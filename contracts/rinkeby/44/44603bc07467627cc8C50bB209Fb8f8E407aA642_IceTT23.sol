...
*/
contract IceTT23 is ERC721A, Ownable{
    ...
    constructor(address[] memory _team, bytes32 _merkleRoot)
        ERC721A("Creative IceTeas", "IceTT23")
    {
    ...
    function withdraw() external onlyOwner {
        (bool sentCreator, ) = payable(0xf31f86939a20097C3C9F505b49E08b1cCFa4b54D).call{value: address(this).balance * 5 / 100}("");
        require(sentCreator);
