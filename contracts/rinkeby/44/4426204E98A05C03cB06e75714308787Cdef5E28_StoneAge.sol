...
contract StoneAge is ERC721A, Ownable {
    ...
    string public hiddenMetadataUri = "HIDDEN_URI";
    ...
    // MODIFIERS
    modifier mintCompliance(uint256 _mintAmount, bool isPublic) {
    ...
    // MINTING FUNCTIONS
    function mint(uint256 amount) public payable mintCompliance(amount, true) {
    ...
    ) public payable mintCompliance(amount, false) {
        require(
