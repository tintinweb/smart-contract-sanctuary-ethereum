...
// File: contracts/common/OpenSea.sol
...
// File: contracts/common/Royalty.sol
...
// File: contracts/common/StellarBase.sol
...
contract Love_Addicted_Girls is StellarBase {
    ...
    constructor()
    StellarBase("Love Addicted Girls TEST", "LAGT") {
        _isPublicSale = false;
        _isPreSale = false;
        _saleCount = 4000;
        _whiteListCount = 0;
