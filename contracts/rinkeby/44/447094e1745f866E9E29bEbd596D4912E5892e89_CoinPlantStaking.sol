...
contract CoinPlantStaking is Ownable, ERC721Holder, ReentrancyGuard {
    ...
    address private treasuryWallet = 0x33b66102D8984940F2C9e0984eDB1d221A32eC47;
    ...
    function updateReward(address _account) public {
        ...
        staker.balance += _calculateRewards(_account);
    }
    ...
    function getClaimableReward(address _account)
        ...
        returns (uint256)
    {
        return stakers[_account].balance + _calculateRewards(_account);
    }

    function _calculateRewards(address _account)
        internal
        view
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            if (
                ...
                totalRewards += rewardsAmount * stakedDays;
            }
        }
