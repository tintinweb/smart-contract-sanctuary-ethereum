...
contract SammiesClub is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 6969;

    uint256 public constant MAX_PRE_SALE_MINTS = 2;
    uint256 public constant PRE_SALE_PRICE = 0.004 ether;

    uint256 public constant MAX_PUBLIC_SALE_MINTS = 3;
    uint256 public constant PUBLIC_SALE_PRICE = 0.004 ether;

    uint256 public constant MAX_RESERVE_TOKENS = 420;
    uint256 public constant MAX_TOKENS_PER_WALLET = 420; 
    
    uint256 public constant ROYALTY_PERCENTAGE = 8;
    // ================================================

    constructor(address _royaltyReceiverAddress)
        ERC721A("SammiesClub", "CLUB")
    {
