...
// File: contracts/imnium fork.sol
...
contract ImniumFork is ERC721A, Ownable, PaymentSplitter {
    using Strings for uint256;
    ...
    address[] private team_ = [
        ...
        0xb9010C97Aa2df37f39a1EC19a29C9C242CcB05f5,
        0x725AAF2347aadc1bA5AcaF4266Cfe3496A308008
    ];
    uint256[] private teamShares_ = [8000, 1000, 1000];

    constructor() ERC721A("ImniumFork", "IMN") PaymentSplitter(team_, teamShares_) {
        setBaseURI("");
        setNotRevealedURI("ipfs://QmPy3MYCG183SBKFeKYvwZFnZtCbSMZ7Vu91piviY7Xkd4");
    ...
    function presaleMint(
        ...
        require(
            ...
            "ImniumFork: Whitelist mint is not started yet!"
        );
        require(
            (publicStart > 0 && block.timestamp >= publicStart) ||
                tokensMinted[msg.sender] + amount <= max,
            "ImniumFork: You can't mint more NFTs!"
        );
        require(supply + amount <= maxSupply, "ImniumFork: SOLD OUT !");
        require(msg.value >= presalePrice * amount, "ImniumFork: INVALID PRICE");
    ...
    function publicSaleMint(uint256 amount) external payable whenNotPaused {
        ...
        require(
            publicStart > 0 && block.timestamp >= publicStart,
            "ImniumFork: public sale not started."
        );
        require(msg.value >= price * amount, "ImniumFork: Insuficient funds");
    ...
    function airdrop(address[] calldata addresses) external onlyOwner {
        ...
        require(
            ...
            "ImniumFork: You can't mint more than max supply"
        );
    ...
    function forceMint(uint256 amount) public onlyOwner{
        require(totalSupply() + amount <= maxSupply, "ImniumFork: You can't mint more than max supply");
