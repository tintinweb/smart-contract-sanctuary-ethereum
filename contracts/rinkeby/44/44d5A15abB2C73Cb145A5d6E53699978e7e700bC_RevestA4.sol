...
contract RevestA4 is IRevest, RevestAccessControl, RevestReentrancyGuard {
    ...
    function splitFNFT(
        ...
        //     require(newFNFT.split >= 0, "Amount must be greater than zero"); //Required Check from BlockSec
        //     newFNFT.split -= 1;
     ...
     */
     // TODO: Test edge-case for when an old FNFT has this called but doesn't have a smart wallet system
    function depositAdditionalToFNFT(
        ...
        if(fnft.asset != address(0)){
            ...
            IERC20(fnft.asset).safeTransferFrom(_msgSender(), smartWallet, quantity * amount);
        }
    ...
    function _withdrawFNFT(uint fnftId, uint quantity) private {
        ...
        // This code snippet auto-patches old output receivers to new ones 
        // Allows us to solve the problem of migrating token vaults for output receivers
