...
contract Wunks is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant FREE_TOKENS = 3;
  uint256 public constant MAX_FREE_PER_WALLET = 1;
  address public proxyRegistryAddress;
  mapping(address => uint256) private allowance;
  string public baseURI;
    
  constructor() ERC721("Wunks", "WUNKS") {
    setBaseURI("http://localhost:4000/api/wunks/token/");
  ...
  function withdraw() public onlyOwner {
    ...
    address payoutAddress3 = payable(0x9411f13ee54B3B65948783A999506b79048426c5);
    uint256 payoutPayment3 = balance.mul(25).div(100);
