...
contract Pablos is Ownable, ERC721A, ReentrancyGuard {
    ...
    bool private _isHoldersActive = false;
    bool private _isPublicActive = false;

    bool public isHoldersActive = _isHoldersActive;
    bool public isPublicActive = _isPublicActive;
    ...
    modifier onlyHoldersActive() {
        require(_isHoldersActive && totalSupply() < MAX_SUPPLY, 'not active');
        _;
    }

    modifier onlyPublicActive() {
        require(_isPublicActive && totalSupply() < MAX_SUPPLY, 'not active');
        _;
    }
    ...
    function freeMint(uint256 numberOfTokens) external payable onlyHoldersActive nonReentrant() {
        ...
        require(
            IERC721(0xD5B85679d6f0aF3a6777e58E39497960479389E5).balanceOf(msg.sender) >= 10 || IERC721(0x6b1fFdC4156be204306ce37b69dC9CfCE3bDD4d5).balanceOf(msg.sender) >= 20,
            "no nft"
        );
