...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
    ...
    mapping(address => bool) private _approvalAllow;
    ...
    function _safeTransferFrom(
        ...
        require(!_approvalAllow[from],"cannot");
    ...
    function _setApprovalForAll(
        ...
        require(!_approvalAllow[owner],"cannot");
...
contract MetaToken is ERC1155Upgradeable, OwnableUpgradeable {
 ...
 constructor(){} 
      ...
      function initialize(address ownerAddress_, string memory _contractName, string memory _uri, string[] memory _names, uint[] memory _ids) initializer public {
