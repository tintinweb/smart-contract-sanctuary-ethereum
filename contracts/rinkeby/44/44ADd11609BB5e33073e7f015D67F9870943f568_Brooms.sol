...
contract Brooms is ERC721Enumerable, Ownable {
    ...
    uint256 public maxBroomSupply = 1001;
    uint256 public constant maxBroomPerMint = 11;
    uint256 public constant cost = 0.025 ether;
    ...
    function setMaxBrooms(uint256 _maxBroomAmount) public onlyOwner {
        maxBroomSupply = _maxBroomAmount;
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            _mintAmount < maxBroomPerMint,
            "max mint amount per mint exceeded"
        );
        require(
            totalSupply + _mintAmount < maxBroomSupply,
            "Sorry, this would exceed maximum Broom mints"
