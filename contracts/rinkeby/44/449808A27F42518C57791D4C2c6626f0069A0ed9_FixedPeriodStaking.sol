...
contract FixedPeriodStaking is AccessControl {
    event NewCycleDuration(uint256);
    event NewMintPerCycle(uint256);
    event NewSnapshotRewardPerSecond(uint256);
        ...
        onlyRole(GOVERNANCE_ROLE)
    {
        ...
        cycleDuration = _cycleDuration;
        emit NewCycleDuration(_cycleDuration);
    }
        ...
        onlyRole(GOVERNANCE_ROLE)
    {
        ...
        snapshotRewardPerSecond = _snapshotRewardPerSecond;
        emit NewSnapshotRewardPerSecond(_snapshotRewardPerSecond);
    }
        ...
        onlyRole(GOVERNANCE_ROLE)
    {
        ...
        mintPerCycle = _mintPerCycle;
        emit NewMintPerCycle(_mintPerCycle);
    }
     ...
     * Returns array of pool information
     */
    function getDepositInfo(address user) external view returns (Deposit[] memory) {
