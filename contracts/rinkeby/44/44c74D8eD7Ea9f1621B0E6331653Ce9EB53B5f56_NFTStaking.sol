...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(B2DCollection _nft, B2DRewards _token) { 
    nft = _nft;
    token = _token;
  }
...
contract B2DCollection is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("BLOCKx Collection", "BLx") {}
        // internal
        function _baseURI() internal view virtual override returns (string memory) {
        return "ipfs://Qme7E8J5hGTTaFeZDoHjwbDomKQp9MZ7zgju5QvbxXRbrX/";
    }
        // public
