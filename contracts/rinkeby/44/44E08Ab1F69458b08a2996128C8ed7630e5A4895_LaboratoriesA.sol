...
contract LaboratoriesA is ERC721AQueryable, Ownable {
    ...
    // FIXME instead of _maxQuantity use walletLimit and the whitelist will contain only list of addresses
    ...
    modifier checkWhitelist(address _account, bytes32[] calldata _proof) {
        require(
