...
contract TestingERC721A is ERC721A, Administration {
    ...
    constructor(
        ...
        address,
        address
    ) ERC721A("TestingERC721A", "T") Administration(_msgSender()) {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721A, Administration)
        returns (bool)
    {
        return
