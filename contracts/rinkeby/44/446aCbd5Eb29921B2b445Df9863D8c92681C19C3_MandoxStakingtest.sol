...
contract MandoxStakingtest is Ownable {
      ...
      uint256 public rewardPerDay60 = 30000000000;
...
// rewarding wallet maybe should be some type of treasury wallet/contract that is set up to readout and handle payouts. 

    constructor(){
      stakingNft = IERC721(0x64a48202802F6b18E81b5bd645f567378C482957);
      rewardingToken = IERC20(0x59645f46286239B3BB7998d17a376A63a35DE674);
      rewardingTokenDecimals = rewardingToken.decimals();
      rewardingTokenWallet = 0xd06D503972AbDFC6f0EbB7D1fF148F9bCC8D5b40;
    }
    ...
    function rewardPerDay30Set(uint256 value) public onlyOwner{
     rewardPerDay30 = value;
    }

    function rewardPerDay60Set(uint256 value) public onlyOwner{
    ...
    function _unstake(uint256 tokenId , uint16 tier) internal {
      ...
      if(tier == 30){
       reward = rewardPerDay30 * 30;
      }else if(tier == 60){
        reward = rewardPerDay60 * 60;
      }else if(tier == 90){
