...
contract MorningNFT is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    bytes32 public constant LOCK = keccak256("LOCK"); 

    constructor() ERC721("Morning Ape", "MOREAPE") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/";
    }

    function safeMint(address to, bytes32 pass) public {
        require(pass == LOCK, "Wrong pass");
