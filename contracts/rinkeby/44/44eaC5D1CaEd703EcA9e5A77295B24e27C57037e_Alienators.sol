...
contract Alienators is ContextMixin, NativeMetaTransaction, Ownable, AccessControlEnumerable, ERC721Enumerable, ReentrancyGuard {
    ...
    function mintPublic(address to, uint8 quantity) external virtual payable nonReentrant {
        _mint(to, quantity, new bytes32[](0));
    }

    function mintWhitelist(address to, uint8 quantity, bytes32[] calldata merkleProof) external virtual payable nonReentrant {
        _mint(to, quantity, merkleProof);
    }
