...
contract BeerPong is protected {
    ...
    constructor(address d) {
        ...
        is_auth[owner] = true;
        devWallet = d;
        option_odds[1] = 1700000000000000000;
        option_odds[2] = 2500000000000000000;
        option_odds[3] = 10000000000000000000;
        option_odds[4] = 5000000000000000000;
        option_odds[5] = 3300000000000000000;
    ...
    function win(uint id) public onlyAuth {
        ...
        uint jackpot = bet[id].value * option_odds[bet[id].option];
