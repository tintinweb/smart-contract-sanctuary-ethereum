    ...
    ReentrancyGuard
{
    ...
    function setInventoryTypeConfig(
        ...
        uint256 numMinted = 0;
        bool isActive = false;
        if (inventoryTypeConfig[inventoryType].numMinted > 0) {
            numMinted = inventoryTypeConfig[inventoryType].numMinted;
            isActive = inventoryTypeConfig[inventoryType].isActive;
        }
