...
contract BBOYDAO is ERC721, ERC721Enumerable, Ownable {
        ...
        returns (string memory)
    {
        ...
        if(tokenId >= 0 && tokenId < 10) {
          tokenID = string(abi.encodePacked('000', (tokenId + 1).toString()));
        } else if(tokenId >= 10 && tokenId < 100) {
          tokenID = string(abi.encodePacked('00', (tokenId + 1).toString()));
        } else if(tokenId >= 100 && tokenId < 1000) {
          tokenID = string(abi.encodePacked('0', (tokenId + 1).toString()));
        } else if(tokenId >= 1000){
          tokenID = (tokenId + 1).toString();
        }
