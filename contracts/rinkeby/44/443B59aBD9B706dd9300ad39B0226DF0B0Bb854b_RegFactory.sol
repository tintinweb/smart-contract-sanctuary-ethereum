...
contract TBRegister is  Ownable {
    ...
    address public TBnft =  address(0xd9145CCE52D386f254917e481eB44e9943F39138);
   ...
   // address private init_address = address(0x3244C695758e077422DDB30Ec229595A6A92DC04);
    address payable public _poolWallet = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db;
    ...
    uint256 public _poolRewardRate = 250;
  ...
  //  uint[] public stageminted = [ 0, 0, 0, 0, 0 ] ;
   ...
   // Throws when msg.sender has already claimed the airdrop 
    ...
    function fee() public view returns(uint256 price)
    {
        return stagePrice[current_stage].mul(_poolRewardRate).div(_baseRate);
    }
    
    function registerNFT() public payable {

        //require(stagePrice[current_stage]+fee() <= msg.value, "Ether too small");
        //_poolWallet.transfer(fee());
