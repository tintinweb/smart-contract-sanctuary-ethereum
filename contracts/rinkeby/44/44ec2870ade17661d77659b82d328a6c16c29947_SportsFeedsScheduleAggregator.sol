...
contract SportsFeedsScheduleAggregator is ChainlinkClient {
    ...
    function decodeGames(bytes32 _requestId)
        internal
        view
    ...
    function triggerRound(bytes32 _requestId) internal {
        latestRoundId++;
        updateRoundAnswer(latestRoundId, decodeGames(_requestId));
    }
