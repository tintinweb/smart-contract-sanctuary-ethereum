...
interface IPassport {
    ...
    function claimWhitelist(bytes32[] calldata proof) external payable returns (uint256 tokenId);
    ...
    function updateWhitelistRoot(bytes32 _whitelistRoot) external;
...
interface ILoyaltyLedger {
    ...
    function tokens(uint256)
        ...
        returns (
            ...
            uint256 claimFee,
            uint256 claimAmount,
            uint256 whitelistClaimFee,
            bytes32 whitlistRoot
        );
    ...
    function updateWhitelistRoot(uint256 _id, bytes32 _whitelistRoot) external;
