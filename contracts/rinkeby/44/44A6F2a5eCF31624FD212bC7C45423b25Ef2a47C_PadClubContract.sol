...
// File: contracts/Pad_Club_v1_1.sol
...
contract PadClubContract is ERC721, Ownable {
    ...
    //NFT Stuff
    uint256 public presalePrice = 0.0001 ether;  // prix de la presale modificable par le owner
    uint256 public publicPrice = 0.010 ether;   // prix de la publicSale modificable par le owner
    uint256 public maxPublicSupply = 6000;    // nombre max de NFT pour le public
    uint256 public maxGiftSupply = 66;        // nombre max de NFT pour le marketing/cadeaux
    uint256 public maxPresaleSupply = 600;    // nombre max de NFT pour la presale/Whitelist
    uint256 public maxMintAmountPresale = 50000;    // nombre max de NFT mintables par une addresse
    uint256 public maxMintAmountPublic = 10;    // nombre max de NFT mintables par une addresse
    bool public revealed = false;

    // Sale Stuff
    bool public publicSaleOpen = false;       // vente publique fermee a la creation du contrat
    bool public presaleOpen = false;          // presale fermee a la creation du contrat
    bool public contract_LOCK = false;        // Locks contract data for ever
