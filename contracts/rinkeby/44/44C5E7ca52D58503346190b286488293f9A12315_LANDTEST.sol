...
contract LANDTEST is ERC721Enumerable, Ownable() {
    uint256 public price;
    uint256 public maxSupply;
    
    
    constructor() ERC721("NFT Tree Land Test","NFTREE") {

        price = 20 ether;
        _tokenURI = 'https://nftreevr.s3.us-west-1.amazonaws.com/json/';
    ...
    function buyToken(address _address, uint256 _count) public payable {
        ...
        require(_count <= 10, "ERROR: Exceeds 10");
    ...
    function changePricing(uint256 _newPrice) public onlyOwner {
        price = _newPrice;        
    }
