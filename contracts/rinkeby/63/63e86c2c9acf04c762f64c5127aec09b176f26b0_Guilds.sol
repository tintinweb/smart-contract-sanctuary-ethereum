...
contract Guilds is ERC1155Supply {
    ...
    function setNewGuild(uint256 _id, address _initiator, uint256 _guildMintRate) private {
        ...
        GuildsByAddress[_initiator].TokenId = _id;
        GuildsByAddress[_initiator].GuildMembers = [_initiator];
        GuildsByAddress[_initiator].Admin = _initiator;
        GuildsByAddress[_initiator].MintRate = _guildMintRate;
        GuildsByAddress[_initiator].GuildMods;
