...
contract PumpTokenERC20 is ERC20 { //, Stakeable {

    uint256 _maxStakeYield = 30000000;
    ...
    constructor() ERC20("Pump", "PMP") {
        _mint(_communityRewards, 30000000);
        _mint(_daoWallet, 30000000);
        _mint(_teamWallet, 10000000);
    }
