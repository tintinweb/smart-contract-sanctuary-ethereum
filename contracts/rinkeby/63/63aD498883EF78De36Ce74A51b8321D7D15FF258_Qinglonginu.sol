...
contract Qinglonginu is ERC721, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public apePrice = 500000000000000000; //0.5 ETH
    uint public maxApePurchase = 2;
    ...
    function setApePrice (uint256 apePrice_) public onlyOwner {
        apePrice = apePrice_;
    }

    function setMaxApePurchase (uint256 maxApePurchase_) public onlyOwner {
        maxApePurchase = maxApePurchase_;
    }
    ...
    function reserveApes(uint n) public onlyOwner {        
