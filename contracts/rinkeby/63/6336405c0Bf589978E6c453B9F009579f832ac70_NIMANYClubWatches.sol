...
contract NIMANYClubWatches is ERC721, Ownable {
  ...
  string private uri = "https://assets.nimany.club/watches/metadata/";
  ...
  */
  ...
  function _checkCanMint(uint num) internal {
    // Closed.
  ...
  function burnCforG(uint256 tokenId1, uint256 tokenId2, uint256 tokenId3, uint256 tokenId4, bytes memory signature)
    public
  {
