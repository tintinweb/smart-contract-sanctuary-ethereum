        ...
        if (_collection.exists) {
            return
                _collection.isExternal
                    ? IMetaCollection(_collection.externalContract).getMetadata(tokenId)
