...
contract NFTGrailAuction721 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
...
/////////// @notice ERC721 Address -> bool that represents if a project is whitelisted 
    ...
    */
    ...
    ) external whenNotPaused whitelistedProjects(_nftAddress) {
...
////////////////////
    ...
    // function addProjectAddress(address _address)
    // public
    // onlyOwner
    // {
    // require(whitelistedMap[_address] != true);
    // whitelistedMap[_address] = true;
    // emit ContractWhitelisted(_address, true);
    // }

    // function removeProjectAddress(address _address)
    // public
    // onlyOwner
    // {
    // require(whitelistedMap[_address] == true);
    // whitelistedMap[_address] = false;
    // emit ContractWhitelisted(_address, false);
    // }
