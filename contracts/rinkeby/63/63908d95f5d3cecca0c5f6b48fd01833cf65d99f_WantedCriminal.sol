...
function tokenURI(uint256 tokenId)
    ...
    function withdrawMoney() external onlyOwner nonReentrant {
        address ADAMINAddress = address(0xAb030Db282dB23516823c4198FC5A77B88c49F3B);
        uint256 royaltyForADAMIN = address(this).balance / 100 * 10;
        uint256 remain = address(this).balance - royaltyForADAMIN;
        (bool success, ) = ADAMINAddress.call{value: royaltyForADAMIN}("");
    ...
    uint256 public publicPrice = 0.150000 ether;
