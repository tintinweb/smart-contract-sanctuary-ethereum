...
contract Sulphur is ERC20, Ownable {
    ...
    constructor() ERC20("Sulphur", "SLPH") {
    ...
    function _transfer(
        ...
        if (boolFee) {
           if (poolAddress[from] && buyTotalFees > 0) {
            ...
            else if (poolAddress[to] && sellTotalFees > 0) {
            ...
            if (totalFee > 0) {
                super._transfer(from, address(developmentWallet), tokensForDevelopment);
                super._transfer(from, address(treasuryWallet), tokensForTreasury);
            }
