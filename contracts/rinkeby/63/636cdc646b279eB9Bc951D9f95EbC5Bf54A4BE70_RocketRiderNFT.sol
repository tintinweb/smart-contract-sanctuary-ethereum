 ...
 */
contract RocketRiderNFT is ERC721A, Ownable {
    ...
    function mint(uint256 quantity) external payable {
        require(quantity <= maxPerWallet, "Max amount per transaction exceeded!");
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return getFullMetadataUri(metadataUri, _tokenId);
    }
