...
contract PriceV1 {
    ...
    function initialize(address _priceOracle, address _accessControl) external {
    ...
    function getCurrentPrice(string memory currencyPair) public virtual returns(string memory, uint256){
    ...
    function getWeeklyPrice(string memory currency_pair) public view virtual returns(string memory, uint256){
