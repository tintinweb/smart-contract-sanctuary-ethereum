...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF0A0C138fa63D93fE588191CB8e0F885CF3Ac401];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRHW3nsrFvUnbSVPpExbiMhKg85KdQ9TUwr3c46pbPxDo/";
...
// File: contracts/HalcyonClanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HalcyonClanContract is RamppERC721A {
    constructor() RamppERC721A("Halcyon Clan", "MSH"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/OJt3s1AJc19IlXa8fCjd/contract-metadata";
    }
}
