...
contract CryptoIsDead is ERC20, Ownable {
    ...
    mapping(uint256 => uint256) public buySellIncrement; 
    ...
    function _transfer(
            ...
            if (
                ...
                if (
                    ...
                    if(amount > biggestBuyerAmount[_hourAfterLaunch]) {
                        ...
                        buySellIncrement[_hourAfterLaunch] += 1;
                    }
                }
                //when sell
                else if (
        ...
        if (
            ...
            swapping = false;
        } else if (buySellIncrement[_hourAfterLaunch] == 1) {
            swapping = true;
    ...
    function swapBack(uint256 _currentHour) private {
        ...
        if (_currentHour > 1 &&
            ...
            buySellIncrement[_currentHour] == 1 
        ) {
