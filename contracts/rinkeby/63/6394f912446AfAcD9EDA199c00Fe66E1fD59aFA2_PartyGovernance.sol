...
contract PartyGovernance is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    constructor(IVotes _token)
        Governor("PartyGovernance")
        GovernorSettings(1 /* 1 block */, 23 /* 5 minutes */, 1000e18)
    ...
    // This protocol has a delay period from when a proposal is submitted to when voting starts. 
    // During this time, you can set up your wallet for voting or change your delegation.
    // Why is this useful?
    // Once the voting period starts, it will not be possible to make any changes to your voting power. 
    // So be sure to change your delegation now if you need to make any adjustments.
