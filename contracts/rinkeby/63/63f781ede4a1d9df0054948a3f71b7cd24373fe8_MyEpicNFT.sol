...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Big", "Small", "Tall", "Dwarf"];
    string[] secondWords = ["Head", "Tummy", "Hand", "Leg"];
    string[] thirdWords = ["Dog", "Human", "Cat", "Mouse"];
    ...
    function pickRandomWord(
        ...
        uint256 rand = random(
            string(abi.encodePacked(to, Strings.toString(tokenId)))
        );
    ...
    function makeAnEpicNFT() public {
        ...
        string memory randomColor = pickRandomWord(
          newItemId,
          "COLOR",
          colors
        );
        ...
        string memory finalSvg = string(
            abi.encodePacked(baseSvg1, randomColor, baseSvg2,combinedWord, "</text></svg>")
        );
        console.log("\n--------------------");
