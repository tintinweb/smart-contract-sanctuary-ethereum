...
contract EtherPredictionFactory{
    ...
    function newEtherPrediction(address aggregator, uint targetTime, uint deadline) public returns (address){
        EtherPrediction e = new EtherPrediction(aggregator, targetTime, deadline);
...
contract EtherPrediction {
     ...
     */
    constructor(address aggregator, uint _targetTime, uint _deadline) {
