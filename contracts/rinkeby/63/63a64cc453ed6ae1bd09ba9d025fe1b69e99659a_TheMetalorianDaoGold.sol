...
contract TheMetalorianDaoGold is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 500;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 500;
    ...
    constructor() ERC721("The Metalorian Dao Gold", "TMDG") {
        ...
        baseURI = "ipfs://bafybeidg43vm3shhhbn6k3gdsva4kdev7kbvftrxnwdmqkj7dt2vvkjvqq/OroJson/";   
        mintCost = 0.0003 ether;
    }
