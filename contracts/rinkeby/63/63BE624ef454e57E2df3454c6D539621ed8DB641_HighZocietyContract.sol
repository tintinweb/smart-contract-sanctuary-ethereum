...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8D822faEE300d9e4d68B404b8638976C6b0ae311];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieyxno7qo4tvfc7f5rq6m2hlep5bcrg2efsbplbec74fref4yqpju/";
...
// File: contracts/HighZocietyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HighZocietyContract is RamppERC721A {
    constructor() RamppERC721A("High Zociety", "HIGH"){}
}
