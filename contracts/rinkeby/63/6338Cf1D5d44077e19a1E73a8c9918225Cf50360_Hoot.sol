...
contract Hoot is ERC721, Ownable, ReentrancyGuard {
    ...
    bytes32 public constant METADATAROOT =
        0x68ae17118ca5cc1e0c8aeb553831471fd51ea24fdcdd533559a15d0207f67042;
    ...
    function lockSoul(uint256 id) external {
        ...
        returns (string memory)
    {
        ...
        if (traits.length == 0) {
            string[6] memory parts2;

            parts2[0] = '<svg xmlns="http://www.w3.org/2000/svg"';
            ...
            parts2[3] = '14px; }</style> <rect width="100%" height="100%" ';
            parts2[4] = 'fill="black" />';
            ...
            output2 = string(
                abi.encodePacked("data:application/json;base64,", json2)
            );
            return output2;
        }
        ...
        parts[8] = toString(20);
        parts[9] = traits[0];
        parts[10] = ' class="base"></text>';

        parts[11] = '<text x="10" y=';
        parts[12] = toString(40);
        parts[13] = traits[1];
        parts[14] = ' class="base"></text>';

        parts[15] = '<text x="10" y=';
        parts[16] = toString(60);
        parts[17] = traits[2];
        parts[14] = ' class="base"></text>';

        parts[15] = '<text x="10" y=';
        parts[16] = toString(80);
        parts[17] = traits[3];
        parts[18] = ' class="base"></text>';

        parts[19] = '<text x="10" y=';
        parts[20] = toString(100);
        parts[21] = traits[4];
        parts[22] = ' class="base"></text>';

        parts[24] = '<text x="10" y=';
        parts[25] = toString(120);
        parts[26] = traits[5];
        parts[27] = ' class="base"></text>';

        parts[29] = '<text x="10" y=';
        parts[30] = toString(140);
        parts[31] = traits[6];
        parts[32] = ' class="base"></text>';

        parts[34] = '<text x="10" y=';
        parts[35] = toString(160);
        parts[36] = traits[7];
        parts[37] = ' class="base"></text>';
        parts[38] = "</svg>";
