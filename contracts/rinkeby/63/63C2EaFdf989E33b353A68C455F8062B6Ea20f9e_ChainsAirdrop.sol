...
contract ChainsAirdrop is ERC1155, Ownable {
  ...
  // TODO: set this with the real URI
  // see https://gateway.pinata.cloud/ipfs/QmT4qTqCArotow4KYtceZ2FHbMmya6Um6Tz7wbLmQxr7B6/{id} is a working example
  ...
  function mint(uint256 _ownerCount, bool _diamondMens, bool _goldMens, bytes calldata _signature) external {
    ...
    if (!isValidSignature(keccak256(abi.encodePacked(msg.sender, _ownerCount)), _signature)) revert invalidSignature();
