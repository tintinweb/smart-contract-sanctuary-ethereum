...
contract Membership is ERC1155, Ownable, Pausable {
    ...
    constructor(string memory _uri, address payable _beneficiary, address _signer) ERC1155(_uri) {
        require(_beneficiary != address(0), "Beneficiary must not be zero address");
        name = "Front Test Collection 2";
        symbol = "FTCF2";
    ...
    function setTier(uint256 id, string memory _name, uint256 _price, uint256 _max) public onlyOwner {
