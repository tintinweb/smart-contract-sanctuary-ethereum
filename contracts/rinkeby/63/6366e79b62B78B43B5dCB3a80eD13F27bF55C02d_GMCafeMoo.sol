...
contract GMCafeMoo is IERC165, IERC721, IERC721Metadata {
	...
	// migration
	function getMigratableTokens() public view returns (uint256[] memory tokens) {		
	...
	function isMigrationApproved() public view returns (bool) {
		return OPENSEA.isApprovedForAll(msg.sender, address(this));
	}
