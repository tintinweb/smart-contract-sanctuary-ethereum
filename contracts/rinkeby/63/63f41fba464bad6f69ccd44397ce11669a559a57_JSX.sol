...
// File: NowLoading/Stg_JSNowLoading.sol
...
// Contract
contract JSX is StandardERC721, Mintable {
  using SafeMath for uint256;
  ...
  function tokenURI(uint256 _tokenId) external view returns (string memory) {
    ...
    string memory baseURL = "https://raw.githubusercontent.com/js-nowloading/asset/master/metadata/";
