...
contract TrippyHedgehogz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Trippy Hedgehogz", "TH") {
    setHiddenMetadataUri("ipfs://QmRyofZhrZjfbSw1HTHWjdgci2c2wpeHSwRapZRybfWUPA/hidden.json");
  }
