...
contract ApprovingCorgiPups is Ownable, ERC721A {
    ...
    IERC721Enumerable public constant boneContract = IERC721Enumerable(boneAddress);
    ...
    modifier isSecured(uint8 mintType) {
        ...
        if(mintType == 1) {
            require(isPhase1Active, "PHASE_1_IS_NOT_YET_ACTIVE");
        } 
     ...
     * Breed Corgis
     */
    function breedCorgisP1(uint256 _parent1, uint256 _parent2) external isSecured(1) {
        uint256 supply = totalSupply();
        ...
        hatchDate[supply + 1] = block.timestamp + incubationPeriod;
        parents[supply + 1] = Genes(_parent1, _parent2);
