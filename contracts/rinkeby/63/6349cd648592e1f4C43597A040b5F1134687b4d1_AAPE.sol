...
// File: contracts/AAPE.sol

pragma solidity ^0.8.13;

contract AAPE is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;

    address public constant TEAM = 0x64bFcbE7A74B5645cFbbC466E7caBBC05eF4c376;
    uint256 public constant PRICE = 0.1 ether;
    uint256 public constant MAX_PRESALE_PURCHASES = 5; // maximum mints per wallet
    uint256 public constant MAX_SUPPLY = 2222; // maximum supply of tokens
    ...
    constructor() ERC721A("AAPE", "AAPE", MAX_BATCH_SIZE, MAX_SUPPLY) {
        _safeMint(msg.sender, 1); // Mint 1 NFT on deploy
    }
    ...
    modifier mintGuard(uint256 tokenCount) {
        ...
        require(totalSupply() + tokenCount <= MAX_SUPPLY, "Not enough supply");
        _;
    }
    ...
    function mintPresale(bytes32[] calldata proof, uint256 amount) external payable mintGuard(amount) {
        ...
        require(
            mintCount[msg.sender] + amount <= MAX_PRESALE_PURCHASES,
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseTokenURI, tokenId.toString(), BASE_EXTENSION));
    }
