...
contract NFT_B is IERC721 {
    ...
    string internal nftName = "NFT B";
    string internal nftSymbol = "NFTB";
    ...
    constructor(string memory _BaseURI,address _tokenA) {
    ...
    function MigrationNFT(uint256 _tokenID) external payable reentrancyGuard {
        IERC721(tokenA).transferFrom(msg.sender,address(0x000000000000000000000000000000000000dEaD),_tokenID);
        _mint(msg.sender);
    }
    ...
    /**
      ...
      */
    function toString(uint256 value1) internal pure returns (string memory) {
        if (value1 == 0) {
            return "0";
        }
        uint256 temp = value1;
    ...
    function burn(uint256 _tokenId) public override {
        address tokenOwner = idToOwner[_tokenId];
        require(tokenOwner == msg.sender, "Incorrect owner.");
