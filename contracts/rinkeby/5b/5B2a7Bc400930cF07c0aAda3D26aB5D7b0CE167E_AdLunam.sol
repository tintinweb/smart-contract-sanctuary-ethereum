...
contract AdLunam is ERC721A, ERC721AQueryable, Ownable {
	/**
	 * @param baseURI_ base uri for token
	 */
	constructor(string memory baseURI_) ERC721A("AdLunam", "ADLUNAM") {
		baseURI = baseURI_;
	}
	...
	/**
	 * @notice base uri getter
	 * @return baseURI returns baseURI
	 */
	...
	/**
	 * @dev https://nftchance.medium.com/the-gas-efficient-way-of-building-and-launching-an-erc721-nft-project-for-2022-b3b1dac5f2e1
	 */
