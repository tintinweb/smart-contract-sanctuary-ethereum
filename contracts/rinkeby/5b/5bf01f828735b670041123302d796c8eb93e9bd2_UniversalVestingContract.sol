...
//        setPauseStatus(true);
    ...
    function setThresholdTimeForVesting (uint startTime) external onlyOwner {
        ...
        intermediateVestingAmountWithdrawThresholdTime = [0,0,0,0,0,0,0,0,startTime + 5 minutes,0,0];
        linearVestingAmountWithdrawThresholdTime= [0,startTime+10 minutes,startTime + 1 minutes,startTime + 1 minutes,startTime + 1 minutes,startTime + 20 minutes,startTime + 10 minutes,startTime + 10 minutes,startTime + 60 minutes, startTime + 15 minutes,startTime + 1 minutes];
//        setPauseStatus(false);
    ...
    function intermediateVestStatus(address _userAddress) public view returns (uint,uint) {
        ...
        uint timeDifference;
        uint[11] memory intermediateArray = [0,0,0,0,0,0,0,0,globalStartTime + 5 minutes,0,0];// give Intermediate time
  ...
  uint256 public linearStart8=globalStartTime+5 minutes;
    function linearVestingDetails(address _userAddress) public view returns (uint) {

        uint lastClaimTime = Investors[_userAddress].lastClaimTime;
        uint timeDifference;
        // uint time= intermediateVestStatus(_userAddress);
        uint[11] memory linearTime = [0,globalStartTime+10 minutes,globalStartTime + 1 minutes,globalStartTime + 1 minutes,globalStartTime + 1 minutes,linearStart8 + 20 minutes,globalStartTime + 10 minutes,globalStartTime + 10 minutes,globalStartTime + 40 minutes, globalStartTime + 15 minutes,globalStartTime + 1 minutes];
