...
contract MGDCbreedHAPE is ERC1155, Ownable {
    string public constant name = "Ape Kid";
    string public constant symbol = "AKid";
    ...
    IERC721 public MGDC=IERC721(0x8dC25a623872b2C4C5Ae730C19292dDC0801936b);
    IERC721 public HAPE=IERC721(0x58F6B5A59eF78a6E3E1c4f062848B470CB2FD7e1);
    ...
    */
     ...
     payable
    {
        ...
        require(MGDC.ownerOf(idSecond)==msg.sender,"You don't own this HAPE nor this MGDC");
