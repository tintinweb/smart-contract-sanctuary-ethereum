...
import "../lib/ERC721Identity.sol";
import "../lib/EIP712Whitelist.sol";

contract NFT721Identity is ERC721Identity, EIP712Whitelist, ReentrancyGuard {
    ...
    modifier callerIsNFTOwner(address _addr) {
        require(nftContract != IERC721(address(0)), "nft contract is not set");
        require(nftContract.balanceOf(_addr) > 0, "caller is not linking NFT owner");
        _;
    }
...
contract ERC721Identity is Context, ERC165, IERC721, IERC721Metadata {
