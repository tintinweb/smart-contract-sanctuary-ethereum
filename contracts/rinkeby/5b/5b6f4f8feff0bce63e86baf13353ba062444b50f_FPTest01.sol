...
contract FPTest01 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {


    uint256 public constant PLUTO = 0;
    uint256 public constant MICKEY = 1;
    uint256 public constant DONALD = 2;
    ...
    function initialize() initializer public {
        ...
        _mint(msg.sender, PLUTO, 10, "");
        _mint(msg.sender, MICKEY, 20, "");
        _mint(msg.sender, DONALD, 30, "");
    }
