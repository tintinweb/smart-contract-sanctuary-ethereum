...
contract Floppynft is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Floppynft", "Floppy") {
 
    
    // _baseTokenURI = "ipfs://QmeTpcS4x6wzPyxzqpYvW1BDQphcwtVM8LxTcd3F3vUmQy/";  //tiger metadata url
    _baseTokenURI = "ipfs://QmaP6JeqVYi7SfxRd1NZfd5r9GafPm2vHCzAausA2BRYAi/";  //floppy hidden metadata url
