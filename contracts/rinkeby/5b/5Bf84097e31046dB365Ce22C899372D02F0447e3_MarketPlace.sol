    ...
    EIP712Upgradeable
{
    ...
    function finaliseFixedPriceAuction721(
        ...
        uint256 feeAmt = (otherParams[1] * feePercent) / (10000 + feePercent);
    ...
    function finaliseFixedPriceAuction1155(
        ...
        uint256 feeAmt = (totalAmount * feePercent) / (10000 + feePercent);
...
contract EhisabERC1155 is ERC1155AccessControl {
    ...
    function initialize(
        ...
        __NftFractionsAccessControl_init(signDomain, signVersion, _newBaseURI);
    }

    // function supportsInterface(bytes4 interfaceId)
    //     public
    //     view
    //     override(ERC1155AccessControl, ERC2981PerTokenRoyalties)
    //     returns (bool)
    // {
    //     return
    ...
    INftFractionsRepository
{
    ...
    function __NftFractionsAccessControl_init(
        string memory signDomain,
        string memory signVersion,
        string memory _newBaseURI
        ...
        __ERC1155_init_unchained(_newBaseURI);
        // _setURI(_newBaseURI);
    }
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        string memory _tokenURI = tokens[tokenId].tokenURI;
        string memory base = _baseURI();
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI)
        ...
        virtual
    {
        tokens[tokenId].tokenURI = _tokenURI;
    }
