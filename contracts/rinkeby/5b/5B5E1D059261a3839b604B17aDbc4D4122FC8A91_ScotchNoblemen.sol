...
import {MerkleProof} from "@openzeppelin/[email protected]/utils/cryptography/MerkleProof.sol";
...
contract ScotchNoblemen is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        (bool aa, ) = payable(0x6f8090B4372A6a854bD3E820C67740cB7f94046E).call{
            value: (contractBalance * 3250) / 10000
        }("");
        require(aa);

        (bool ab, ) = payable(0x3b9Ce2a3Cb8E1b4808E182939860790029942533).call{
            value: (contractBalance * 3250) / 10000
        }("");
        require(ab);

        (bool ac, ) = payable(0xc3e49b4E5314c1c59023e2bDd070B80C6a68C117).call{
            value: (contractBalance * 1500) / 10000
        }("");
        require(ac);

        (bool ad, ) = payable(0x01e255a800963e28a04b57B6701E367Ebf625b51).call{
            value: (contractBalance * 200) / 10000
        }("");
        require(ad);

        (bool ae, ) = payable(0x66241E1f9d20Cd34dDCCE098a4c7ea8BEDDaF7Eb).call{
            value: (contractBalance * 200) / 10000
        }("");
        require(ae);

        (bool af, ) = payable(0x9868c88F683C3548f05C5183873d7DcEFFEbDD21).call{
            value: (contractBalance * 200) / 10000
        }("");
        require(af);

        (bool ag, ) = payable(0xc8aDEC37BBE1053491D099dc23bD457da4D9D4b1).call{
            value: (contractBalance * 200) / 10000
        }("");
        require(ag);

        (bool ah, ) = payable(0xB7c6e2e943242AFB88F4135e129a0eBb6c423A54).call{
            value: (contractBalance * 200) / 10000
        }("");
        require(ah);

        (bool ai, ) = payable(0xF1cf4C808152484924a79149A855476C25478Bb4).call{
            value: (contractBalance * 200) / 10000
        }("");
        require(ai);

        (bool aj, ) = payable(0x7e31bBBa949a386FE6800E3EA91075113a949030).call{
