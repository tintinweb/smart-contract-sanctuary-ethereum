...
contract SoulData is ISoulData, Adminable {
    ...
    // 0 : data:application/json;utf8, token image data:image/svg+xml;utf8
    // 1 : data:application/json;base64, token image data:image/svg+xml;utf8
    // 2 : data:application/json;utf8, token image data:image/svg+xml;base64
