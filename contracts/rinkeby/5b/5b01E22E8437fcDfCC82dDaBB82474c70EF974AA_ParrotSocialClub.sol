...
// @@@@@@@@@@@@@@@#?7?JY5PGBB#&@@@@@@&?!!J&@@#!7&&[email protected]@@@@@@@P!!J@@[email protected]@[email protected]@@[email protected]@@@@@@@@@@@@@@@@
...
contract ParrotSocialClub is ERC721A, Ownable {
    ...
    uint256 public constant MAX_RESERVED_PARROTS = 0;
    ...
    uint256 public MAX_PAID_PARROTS = 4888;
