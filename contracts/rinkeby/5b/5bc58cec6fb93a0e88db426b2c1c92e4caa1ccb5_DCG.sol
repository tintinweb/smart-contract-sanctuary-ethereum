...
contract DCG is Ownable(), ERC721("DCG Mastermind","DCG") {
    ...
    constructor()  {
        saleAddress = 0x7cF196415CDD1eF08ca2358a8282D33Ba089B9f3;
        devAddress = 0x7cF196415CDD1eF08ca2358a8282D33Ba089B9f3;
        creatorAddress = 0x8Fac2C8dAfeb6bc93848C292772bfe68666a866a;
        _uri = "https://ipfs.io/ipfs/QmVjkYq7PinMFJSBMsMrnWvozgT5EH5UVB2ypGvtPqQUQR/";
    ...
    function buyDCGNFT(uint256 _id) payable public {
        ...
        payable(saleAddress).transfer(msg.value*92/100);
        payable(devAddress).transfer(msg.value*4/100);
        payable(creatorAddress).transfer(msg.value*4/100);
