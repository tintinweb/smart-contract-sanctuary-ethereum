    ...
    IERC721MetadataUpgradeable
{
    ...
    function getRoundAt(uint256 i) public view returns (uint64) {
        return ROUND[i];
    }

    function getAllRound() public view returns (uint64[] memory) {
        return ROUND;
    }
