...
contract DCG is Ownable(), ERC721("DCG Mastermind","DCG") {
    ...
    mapping(address => bool) public memberlist1;
    mapping(address => bool) public teamlist2;
    mapping(address => bool) public oglist3;
    mapping(address => bool) public elitelist4;
    mapping(address => bool) public lifetimelist5;
    ...
    function addWhitelistAddress(address[] memory addresses,uint256 whiteliseNumber) public onlyOwner{
        for(uint256 i=0; i<addresses.length; i++){
            if(whiteliseNumber == 1){
                memberlist1[addresses[i]] = true;
            }else if(whiteliseNumber == 2){
                teamlist2[addresses[i]] = true;
            }else if(whiteliseNumber == 3){
                oglist3[addresses[i]] = true;
            }else if(whiteliseNumber == 4){
                elitelist4[addresses[i]] = true;
            }else if(whiteliseNumber == 5){
                lifetimelist5[addresses[i]] = true;
            }
        }
    }
    ...
    function removeWhitelistAddress(address[] memory addresses, uint256 whiteliseNumber) public onlyOwner{
        for(uint256 i=0; i<addresses.length; i++){
            if(whiteliseNumber == 1){
                memberlist1[addresses[i]] = false;
            }else if(whiteliseNumber == 2){
                teamlist2[addresses[i]] = false;
            }else if(whiteliseNumber == 3){
                oglist3[addresses[i]] = false;
            }else if(whiteliseNumber == 4){
                elitelist4[addresses[i]] = false;
            }else if(whiteliseNumber == 5){
                lifetimelist5[addresses[i]] = false;
            }
        }
    }
    ...
    function choosePrice(uint256 _tokenId) internal returns(uint256){
        updateId(_tokenId);
        if (_tokenId < 50) {
            if(lifetimelist5[msg.sender]){
              return 0;
            }
          return 5 ether;
        }   
        else if (_tokenId >= 50 && _tokenId < 200) {
            if(elitelist4[msg.sender]){
                return 0;
            }
          return 3 ether;
        } 
        else if (_tokenId >= 200 && _tokenId < 400) {
            if(oglist3[msg.sender]){
              return 0;
            }
          return 1 ether;
        }
        else if (_tokenId >= 400 && _tokenId < 650) {
            if(teamlist2[msg.sender]){
              return 0;
            }
          return 0.5 ether;
        } 
        else if (_tokenId >= 650) {
          if(memberlist1[msg.sender]){
              return 0;
          }
          return 0.1 ether;
        } 
