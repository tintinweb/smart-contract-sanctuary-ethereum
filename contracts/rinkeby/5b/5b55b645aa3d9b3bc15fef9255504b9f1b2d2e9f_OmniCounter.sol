...
contract OmniCounter is NonblockingLzApp {
    ...
    address _lzEndpoint = 0x79a63d6d8BBD5c6dfc774dA79bCcD948EAcb53FA;
    ...
    function incrementCounter(address _receiver, uint256 _data) public payable {
        ...
        lzEndpoint.send{value: messageFee}( // {value: messageFee} will be paid out of this contract!
            10011, // destination chainId
            abi.encodePacked(_receiver), // destination address of PingPong contract
