...
contract MyTokendn is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, ERC20FlashMintUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
        constructor() {
                _disableInitializers();
                    }
                        ...
                        function initialize() initializer public {
                                __ERC20_init("MyTokendn", "MTdjdjjdK");
                                        __ERC20Burnable_init();
                                                __ERC20Snapshot_init();
                                                        __Ownable_init();
                                                                __Pausable_init();
                                                                        __ERC20Permit_init("MyTokendn");
                                                                                __ERC20Votes_init();
                                                                                        __ERC20FlashMint_init();

                                                                                                _mint(msg.sender, 473883378893 * 10 ** decimals());
                                                                                                    }
