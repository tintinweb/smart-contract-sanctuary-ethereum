 ...
 */
contract GenesisClaim is Ownable, Pausable {
	// ========== DEPENDENCIES ========== //
	...
	IERC20 public usdc;
	IGenesisClaim721 public whitelistMinter;
	...
	*/
	...
	constructor(
		...
		// IGenesisClaim721(_whitelistMinter).setDefaultRoyalty(royaltyWallet, _defaultRoyalty);
		whitelistMinter = IGenesisClaim721(_whitelistMinter);
		usdc = IERC20(_usdc);
	...
	function setMinterContract(address _minter) external onlyOwner {
		whitelistMinter = IGenesisClaim721(_minter);
	}
