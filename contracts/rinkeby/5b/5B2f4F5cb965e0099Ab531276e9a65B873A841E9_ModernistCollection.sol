...
contract ModernistCollection is ERC721, AccessControl {
    ...
    function mintTo(address to, uint256 tokenId) external {
        ...
        require(tokenId > 0 && tokenId <= TOTAL_SUPPLY, "Invalid token");
        require(_tokenIdCounter.current() < TOTAL_SUPPLY, "All tokens minted");
