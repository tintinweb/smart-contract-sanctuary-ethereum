...
contract XXXRRRRRR is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("XXXRRRRRR", "XXXRR"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Okay Bear Zuki available");
    require(mintEnabled, "Minting is not live yet.");
    require(numberMinted(msg.sender) + amt <= maxPerWallet,"Too many per wallet!");
    require( amt < maxPerTx + 1, "Max per TX reached, MAX 10.");
