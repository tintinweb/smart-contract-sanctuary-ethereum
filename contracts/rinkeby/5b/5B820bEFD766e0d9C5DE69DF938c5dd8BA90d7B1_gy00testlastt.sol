...
contract gy00testlastt is ERC721A, Ownable {
    ...
    constructor(string memory initBaseURI) ERC721A("gy00testlastt", "GYTestt") {
        baseURI = initBaseURI;
    }
    ...
    function mint(uint256 count) external payable {
        ...
        uint256 cost = (msg.value == 0 && (_mintedFreeAmount[msg.sender] + count <= maxFreeMintPerWallet)) ? 0 : mintPrice;
