...
// Code Generator: New ABI decoder which supports structs and arbitrarily nested arrays
...
contract RequestList {
    ...
    // get the number of family member
    ...
    function getFamilyRequestsAndRewards(uint256 _familyId)
        public
        view
        returns (RequestAndReward[] memory)
    {
        return familyIdToRequestAndReward[_familyId];
    }
}
