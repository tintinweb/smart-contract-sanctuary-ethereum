...
import { IBBBS_Functions } from "./IBBBS.sol";

///
contract BBBS is Pausable, IBBBS_Functions {
    string constant public partner = "partner02";
...
interface IBBBS is IBBBS_Variables, IBBBS_Functions {
