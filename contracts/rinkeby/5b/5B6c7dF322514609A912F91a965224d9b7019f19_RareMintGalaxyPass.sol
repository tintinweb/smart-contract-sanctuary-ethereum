...
contract RareMintGalaxyPass is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, Whitelist, ReentrancyGuard {
    ...
    uint256 public price = 2.5 ether / 10; // default price = 0.25 ETH
     ...
     */
    function safeMintUser() public payable nonReentrant {
        ...
        if (paymentToken == address(0)) {
            require(msg.value == price, "ETH sent does not match price");
        } else {
 ...
 * @dev Provides counters that can only be incremented, NOT decremented, NOT reset. This can be used e.g. to track the number
