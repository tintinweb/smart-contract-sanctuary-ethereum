...
contract RewardSharks is Ownable, ReentrancyGuard {
    ...
    function returnOwnerAllSharkData(address _address) external view returns (Sharks[] memory,Boosts[] memory, uint256[] memory, uint256[] memory) {
        ...
        // Available Boosts
        uint256[] memory _availableBoosts = availableBoosts[_address];

        return (_shark, _boosts, _tokenDetails, _availableBoosts);
    }
