// contract where the tokenID can be one of 3 random dogs
...
contract AdvancedCollectible is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    uint64 s_subscriptionId; // that i get from the vrf2 subscription manager
    ...
    uint256 public randomNumber; // TODO test if i get this

    mapping(uint256 => Breed) public tokenIdToBreed;
    mapping(uint256 => address) public requestIdToSender;
    // It's best practice to emit events when mappings are updated
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords)
        ...
        override
    {
        Breed breed = Breed(randomWords[0] % 3); // get a random breed
        uint256 newTokenId = tokenCounter;
        tokenIdToBreed[newTokenId] = breed; // map random breed to tokenID
