...
contract TankPadGrimReaperNFT is ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant RESERVE_NFT = 100;
    uint256 public constant PUBLIC_NFT = 1900;  //  maximum public NFT for mint
    uint256 public constant NFT_PRICE = 0.1 ether; //per token prise

    uint256 public constant PRESALE_PURCHASE_LIMIT = 5; //maximum NFT for whitelist user
    uint256 public constant MAINSALE_PURCHASE_LIMIT = 10; //Per user limit
    uint256 public publicTotalSupply; //current total minted token
    ...
    //constructor
    constructor() ERC721("TankPad Grim Reaper NFT ", "TNK") {
    }
    ...
    // Function to set giveaway users (tokenIds should be below 100)  
