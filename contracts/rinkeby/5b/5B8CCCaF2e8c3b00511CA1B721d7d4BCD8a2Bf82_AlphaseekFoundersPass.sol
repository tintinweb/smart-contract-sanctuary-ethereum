...
// import "@openzeppelin/contracts/access/AccessControlMintable.sol";
    ...
    IMintableERC721
{
    ...
    uint256 public constant MINTABLE_TOKENS = 1000;
    uint256 public constant PROMOTION_TOKENS = 111;
    ...
    function mint(address to, uint256 amount) public nonReentrant onlyMinter {
        ...
        require(
            totalSupply() < MINTABLE_TOKENS + PROMOTION_TOKENS,
            "Not enough supply"
        );
    ...
    /**
    @dev Sets the token uri the contract metadata for marketplaces
    ...
    @notice The artwork is the same for all passes
     */
