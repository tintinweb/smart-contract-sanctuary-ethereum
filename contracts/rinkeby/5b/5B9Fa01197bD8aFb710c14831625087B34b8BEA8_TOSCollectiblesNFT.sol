...
contract TOSCollectiblesNFT is ERC721EnumerableT, Delegated {
  ...
  string private _tokenURIPrefix = "ipfs://QmSXtZwumsES8S87AE9A5mMeWnUd16XUeHSJe1YmcBr2n9/";
  string private _tokenURISuffix =  ".json";

  constructor()
  ERC721T("TOS Friends v1", "TOSFRD1"){
  }
  ...
  //onlyDelegates
  function teamMint(uint[] calldata quantity, address[] calldata recipient) external payable onlyDelegates{
    require(isMintActive == true,"MOON: Minting needs to be enabled.");
