...
contract FiftyFiftyLottery is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    // when called it returns the current ticket count which can also be used
    // for a ticket number if added to an array with other data
