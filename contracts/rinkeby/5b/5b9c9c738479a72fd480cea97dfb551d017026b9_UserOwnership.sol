...
contract UserOwnership is ContextUpgradeSafe, GSNRecipientUpgradeSafe {
    ...
    function takeOwnership(address addNewUser) public isUser {
        OwnershipTransferred(owner, addNewUser);
        owner = addNewUser;
    }
