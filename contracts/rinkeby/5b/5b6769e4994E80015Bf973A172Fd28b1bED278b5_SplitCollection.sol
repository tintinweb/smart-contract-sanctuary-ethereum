...
contract SplitCollection is ERC721, AccessControl {
    ...
    function checkQuadrant(uint256 tokenId) external view returns (bool) {
        return _exists(tokenId);
    }

    function mintQuadrantsTo(address to, uint256[] memory quadrants) external {
        // Only the minter contract is allowed to mint
