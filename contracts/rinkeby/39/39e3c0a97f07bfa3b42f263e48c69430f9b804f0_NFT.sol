...
contract NFT is ERC721AQueryable, Ownable, ReentrancyGuard {
	...
	string public tokenName = "nft";
	string public tokenSymbol = "nft";
    uint256 public maxSupply = 5000;
	uint256 public maxTeamReserve = 1000;
	...
	uint256 public cost = 2 ether;//easier for testing purposes 
    uint256 public whitelistCost = 1 ether;//easier for testing purposes 
  ...
  function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable nonReentrant{
        ...
        require(totalSupply() + _mintAmount <= (maxSupply - maxTeamReserve), 'Max supply exceeded!');
	}
  ...
  //Team should mint reserve first
  function mintTeamReserve( address _receiver) public onlyOwner {
		require((totalSupply() + maxTeamReserve) <= maxTeamReserve, 'Max supply exceeded!');
        
    _safeMint(_receiver, maxTeamReserve);
  }
  ...
  function setmaxTeamReserve(uint256 _newmaxTeamReserve) public onlyOwner {
    require(_newmaxTeamReserve <= (maxSupply - totalSupply()));
    maxTeamReserve = _newmaxTeamReserve;
  }
