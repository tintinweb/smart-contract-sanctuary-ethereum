...
contract PamperedPoultryEggDoodles2022 is ERC721, Ownable, IERC2981, RoyaltiesV2Impl {
  ...
  function setRoyalties(uint _tokenId, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints) public onlyOwner {
        LibPart.Part[] memory _royaltiesA = new LibPart.Part[](1);
        _royaltiesA[0].value = _percentageBasisPoints;
        _royaltiesA[0].account = _royaltiesReceipientAddress;
        _saveRoyalties(_tokenId, _royaltiesA);
    }
