...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("NAME", "SYMBOL") {
    triangles.push(Triangle("ZERO", 0,0,0));
    triangles.push(Triangle("T1", 1,1,1));
    triangles.push(Triangle("T2", 2,2,2));
    triangles.push(Triangle("T3", 3,3,3));
  }
