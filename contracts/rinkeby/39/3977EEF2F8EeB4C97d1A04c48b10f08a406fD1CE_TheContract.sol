...
/**
 * TheContract ASCII art goes here
 */

import "./ITheContract.sol";
    ...
    TokenRescuer
{
    ...
    uint256 public constant MAX_SUPPLY = 3200; // TODO

    /// The maximum number of token mints per transaction.
    uint256 public constant MAX_MINT_PER_TX = 25; // TODO

    /// The maximum number of presale+whitelist token mints per address.
    uint256 public constant MAX_PRESALE_PER_ADDRESS = 5; // TODO

    /// The price per token mint.
    uint256 public constant PRICE = 0.08 ether; // TODO
