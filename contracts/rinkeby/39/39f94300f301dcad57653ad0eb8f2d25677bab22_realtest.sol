...
contract realtest is ERC721, MerkleWhitelist, Ownable{

    // Constructor
    constructor() ERC721("realtest", "REAL") {}

    // Project Constraints
    uint16 immutable public maxTokens = 1000;
