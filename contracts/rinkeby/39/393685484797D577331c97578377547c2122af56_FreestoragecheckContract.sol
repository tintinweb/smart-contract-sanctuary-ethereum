...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4B0263E5DD975B38DCFD8a4B2319bb2F94775573];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihinbwfjrzrrlckqxy7tpwefrp2yrf6dfvqqnsnh663lw2f3xrnci/";
...
// File: contracts/FreestoragecheckContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FreestoragecheckContract is RamppERC721A {
    constructor() RamppERC721A("Free storage check ", "PSG"){}
}
