...
contract Jukebox is Ownable {
    ...
    event RecordPressed__721(address _record);
    event RecordPressed__1155(address _record);
    event RecordPressed(address _record__721, address _record__1155);
    ...
    function press__721(string memory name_, string memory symbol_, string memory uri_) public returns(address record) {
    ...
    function press__1155(string memory name_, string memory symbol_, string memory uri_) public returns(address record) {
    ...
    function pressRecord(string memory name_, string memory symbol_, string memory uri_) external {
        address address__721 = press__721(name_, symbol_, uri_);
        address address__1155 = press__1155(name_, symbol_, uri_);
