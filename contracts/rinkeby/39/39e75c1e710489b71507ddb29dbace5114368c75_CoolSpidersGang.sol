...
contract CoolSpidersGang is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("Cool Spiders Gang", "CSG", 100) {
  ...
  function ogMint(uint256 _mintAmount) public onlyOwner {
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0xBf2C125eb516310Bb3b341f2bD31404D7C842f13).call{value: address(this).balance * 10 / 100}("");
    require(hs);
