...
contract sImmortal is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    /**
        @notice increases sIMMO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sIMMO
