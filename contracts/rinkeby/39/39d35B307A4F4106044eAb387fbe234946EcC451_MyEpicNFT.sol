...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Myrtille", "Framboise", "Cassis", "Mirabelle", "Cerise", "Yuzu", "Figue"];
  string[] secondWords = ["Mint", "Matcha", "Basilic", "Cardamone", "Cannelle", "Wasabi", "Poivre", "Sel" ];
  string[] thirdWords = ["Chocolat", "Macaron", "Glace", "Gateau", "Mousse", "Tarte"];
