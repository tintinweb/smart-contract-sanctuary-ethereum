...
contract TestiCle2 is ERC721, Ownable {
    ...
    constructor() ERC721("TestiCle", "TWO") {
        mint(500);
    }
    ...
    function kNIGHTlistMint(bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable {
