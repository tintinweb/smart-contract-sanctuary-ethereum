...
contract MagicNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    function setMaxNFTsInTOTALCollection(uint256 _maxNFTs) external onlyOwner {
        maxNFTs = _maxNFTs;
    }
    ...
    function setPUBLIC_SALE_PRICEinEther(uint256 _PUBLIC_SALE_PRICE) external onlyOwner {
        PUBLIC_SALE_PRICE = _PUBLIC_SALE_PRICE/*ether*/;
    }
    
    function setALLOW_LIST_SALE_PRICEinEther(uint256 _ALLOW_LIST_SALE_PRICE) external onlyOwner {
        ALLOW_LIST_SALE_PRICE = _ALLOW_LIST_SALE_PRICE/*ether*/;
    }
