...
/**
    TODO:
        - Check NFT name
        - Maybe hide withdrawal wallets
        - Add Reentrancy Guard
        - Delete Comments
        - Add other withdrawal wallet
*/
...
contract ZomNft is ERC721A, Ownable, ReentrancyGuard { 
    ...
    uint256 public maxAvailableSupply;  // collectionSize - reserveMints
    ...
    ) ERC721A("Test Z", "TESTZ") {  // "Zom Nft", "ZOM"
    ...
    */
    ...
    function withdrawl() external onlyOwner {
        ...
        payable(partnerWallet).transfer(totalBalance * 80 / 1000);
        payable(msg.sender).transfer(totalBalance * 885 / 1000);
    }
}
