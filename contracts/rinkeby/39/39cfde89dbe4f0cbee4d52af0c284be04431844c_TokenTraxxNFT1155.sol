...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155Upgradeable.s[email protected]
...
// File @openzeppelin/contracts-upgradeable/access/IAccessCont[email protected]
    ...
    IERC2981
{
    ...
    event TraxxMinted(address indexed creator, address indexed to, uint256 tokenId, string tokenURI, uint256 amount);
