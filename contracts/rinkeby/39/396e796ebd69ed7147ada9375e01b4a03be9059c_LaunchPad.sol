    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    function balanceStakableToken(uint256 _pid)public view returns(uint256){
       return (poolInfo[_pid].poolStakableAmount - totalContributedAmountInPool[_pid]);
    ...
    */
        ...
        whenNotPaused
    {
        ...
        if (transferStatus) {
            ...
            balanceContributableAmount[_pid] = poolInfo[_pid].poolStakableAmount - totalContributedAmountInPool[_pid];
            require(block.timestamp < poolInfo[_pid].endTime,"Staking ended");
            require((totalContributedAmountInPool[_pid] + _amount) <= poolInfo[_pid].poolStakableAmount,"Total Amount must be less than stakable amount");
