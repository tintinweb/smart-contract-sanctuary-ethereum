...
contract Pandimensionals is ERC721Base {
    ...
    function __Pandimensionals_init(uint256 _maxTotalSupply) external initializer {
        __ERC721Base_init(
            ...
            "PAN",                                                      // symbol
            "ipfs://Qme78HvfuhEHsnek7xbBY6FoQiQGbL2N2xeA81r9VNTHwR",    // initialBaseURI
            "ipfs://QmaABoBbNbgSAif1EY5JSL85HtJhHixDpYfyhVGdkykiK1/contract-level-metadata.json",    // contractURI NEW
            5 * 10 ** 16,                                               // initial token (mint) price - 0.05 ether
            250,                                                        // team reserve
            _maxTotalSupply                                             // maxTotalSupply
        );
        endOfPublicSale = block.number + 1000;
        endOfPresale = block.number + 100;
...
UUPSUpgradeable
{
    ...
    // TODO REMOVE THESE AFTER FINAL TESTING
    bytes4 public constant INT_ID_IACCCTRL = type(IAccessControlUpgradeable).interfaceId;
    bytes4 public constant INT_ID_IERC721META = type(IERC721MetadataUpgradeable).interfaceId;
    bytes4 public constant INT_ID_IERC165 = type(IERC165Upgradeable).interfaceId;
    bytes4 public constant INT_ID_IERC721 = type(IERC721Upgradeable).interfaceId;
    bytes4 public constant INT_ID_IERC721ENUM = type(IERC721EnumerableUpgradeable).interfaceId;
