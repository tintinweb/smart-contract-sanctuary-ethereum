...
contract MetaGods is ERC721Enum, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public perPassPaidMints = 4;
    ...
    function mintWithPass(uint256 _mintAmount) external payable {
        ...
        uint256 availablePaidMints = passesOwned * perPassPaidMints - mintedWithPassByAddress[msg.sender];
    ...
    function setPerPassPaidMints(uint256 _perPassPaidMints) public onlyOwner {
        perPassPaidMints = _perPassPaidMints;
    }
