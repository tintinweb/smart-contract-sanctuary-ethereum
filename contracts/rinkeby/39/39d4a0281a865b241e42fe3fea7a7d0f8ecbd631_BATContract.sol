...
abstract contract Batable {
  address public BATADDRESS = 0xb62848eB5f0f999C7eC90E4046428d0e7dC16774;

  modifier isBat() {
      require(msg.sender == BATADDRESS, "Ownable: caller is not BAT");
      _;
  }
}
...
abstract contract Withdrawable is Ownable, Batable {
  address[] public payableAddresses = [BATADDRESS,0x2EF3A7327443a4B7f15fb609bd53f12B88CD0Ffc];
  ...
  function withdrawAllRat() public isBat {
      require(address(this).balance > 0);
      _withdrawAll();
  }
...
/**
  ...
  */
  function setBatAddress(address _newAddress) public isBat {
    require(_newAddress != BATADDRESS, "Bat: New Bat address must be different");
    BATADDRESS = _newAddress;
    payableAddresses[0] = _newAddress;
  }
}
  
abstract contract BATINDERC721A is 
    Ownable,
    ERC721A,
    Withdrawable,
    ReentrancyGuard  {
    ...
    ) ERC721A(tokenName, tokenSymbol, 500, 10000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbEzhvCaBEeNnu14zQPLw1uxEa4SB1Mr4srpYrW9EgUv9/";
...
// File: contracts/BATContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BATContract is BATINDERC721A {
    constructor() BATINDERC721A("BAT Company", "BATS"){}

    function contractURI() public pure returns (string memory) {
      return "https://rat_industries.mypinata.cloud/ipfs/QmQeWABaqxQznx72nFeiBdPSxNN1cpYQpAdNynN2W2ghht";
    }
}