...
contract core is ERC721, Ownable {
    ...
    uint16 private constant mMintLimit = 20;
    uint256 private constant mPriceW = 0.001 ether;
    uint256 private constant mPrice = 0.0018 ether;
    ...
    function minttest(uint256 _i) public {
    ...
    {
        return (mMintCount, mStartTime, mWhiteCount);
    }
}