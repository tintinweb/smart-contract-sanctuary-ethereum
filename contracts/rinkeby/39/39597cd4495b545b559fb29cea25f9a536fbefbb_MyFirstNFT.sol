...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmbK8SoqWrdsZoARYfAZvuPuN8VhdXhjVAR4WjeNpmgSm9/"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("mcu_1064", "OwO") payable {
        // 剛開始我們先自己 Mint 一個
