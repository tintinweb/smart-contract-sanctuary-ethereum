    ...
    EIP712Upgradeable
{
    ...
    function hashToSign(Order memory order) public view returns (bytes32) {
     ...
     function verifyAddress(Order memory order, uint8 v,bytes32 r,bytes32 s) public view returns(address)
    {
        return ecrecover(hashToSign(order),v,r,s);
    }

    function verifyAddrs(Order memory order, uint8 v,bytes32 r,bytes32 s) public view returns(address)
    {
        return ecrecover(hashOrder(order),v,r,s);
    }
