...
// File: CheddarVerse2/Whitelisted.sol
...
// File: CheddarVerse2/SwampverseERC721.sol
...
// File: CheddarVerse2/Swampverse.sol
...
contract Swampverse is SwampverseERC721 {
  ...
  function setCheeseAddress(address cheese) public onlyOwner {
    Cheese = ICheese(cheese);
  }
  ...
  {
    require(address(Cheese) != address(0), "No token contract set");
    ...
    Cheese.burn(msg.sender, UPDATE_NAME_PRICE);
    ...
    onlyTokenOwner(tokenId)
  {
    ...
    Cheese.burn(msg.sender, UPDATE_DESCRIPTION_PRICE);
    ...
    nonReentrant
  {
    ...
    if (address(Cheese) != address(0)) {
      Cheese.update(from, to);
    }
