...
contract TygrNFT is Ownable, ERC721A, ReentrancyGuard {
    uint256 constant RESERVE_MINTS = 5; // Reserve for Vault
    uint256 constant FREE_MINTS = 10;
    uint256 constant LEV1_MINTS = 20;
    uint256 constant LEV2_MINTS = 30;
    uint256 constant LEV3_MINTS = 40;
    uint256 constant LEV4_MINTS = 50;
    uint256 constant LEV5_MINTS = 60;
    uint256 constant LEV6_MINTS = 70;
    uint256 constant LEV7_MINTS = 80;
    uint256 constant LEV8_MINTS = 90;
    uint256 constant LEV9_MINTS = 100;
    ...
    constructor() ERC721A("TYGR CUB ALLIANCE: TESTNET", "TYGRt") {
        _baseTokenURI = "https://metadata.tygrnft.com/";
        MINT_START = 1649211865; // Launch Time
        WITHDRAW_ADDRESS = 0xfe24AD72Bcf125518c80D967f98Fb95C3fD91E20;
    ...
    function userMintLeft() public view returns (uint256) {
        ...
        if(userBalance > levelMintCap) return 0;
