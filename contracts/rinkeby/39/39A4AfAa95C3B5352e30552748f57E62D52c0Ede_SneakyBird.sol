...
contract SneakyBird is ERC721URIStorage, Ownable, VRFConsumerBase {
  ...
  function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
    ...
    if (material == Material.GOLD && goldToken < 6) {
      tokenUri = 'https://sneakybird.infura-ipfs.io/ipfs/QmYsZDrvTGzG459ykFzR7RscH9Pg34EaMKtGZoSvZHysm4';
      goldTokenOwnersList[newItemId] = payable(mushroomOwner);
      goldToken + 1;
    } else {
      tokenUri = 'https://sneakybird.infura-ipfs.io/ipfs/QmXGCgFBcRwY33CPGga6aS73jM5gkj5eYn9EbEuxpzewY6';
    }
