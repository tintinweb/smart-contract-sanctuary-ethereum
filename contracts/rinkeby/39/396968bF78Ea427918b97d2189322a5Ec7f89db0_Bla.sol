...
contract Bla is ERC721A, ERC721AQueryable, Ownable {
  ...
  bool private _reveal = true;
  uint256 private _seed;

  constructor() ERC721A("Bla", "BLA") {
    _seed = uint256(
      keccak256(
        abi.encodePacked(
          msg.sender,
          ...
          abi.encodePacked(
            ...
            Base64.encode(
              abi.encodePacked(
                ...
                (tokenId).toString(),
                '...","description":"Unrevealed","image":"ipfs://QmTBgvAvbYFM5S3UK2VLCLSFiBbvAvto6hERNmQghXSENR"}'
              )
            )
          )
        );
