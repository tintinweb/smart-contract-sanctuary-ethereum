...
contract Master {
    string public gID;
    uint256 public age;
    ContractBet public betContract;
    address public ContractBetAddress;
    ...
    function createBet(string memory _gameID) public {
        gID = _gameID;
        ContractBetAddress = address(new ContractBet(gID));
    ...
    function enterGameMatch(gameMatch memory _inputGameMatch) public {
        gameMatches[_inputGameMatch.gameID] = _inputGameMatch;
    }
}
...
contract ContractBet is ChainlinkClient {
     ...
     * Fee: 0.1 LINK
     */
    constructor(string memory _gameId) {
