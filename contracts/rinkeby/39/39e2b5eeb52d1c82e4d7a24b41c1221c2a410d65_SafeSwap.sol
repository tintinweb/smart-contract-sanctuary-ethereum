...
contract SafeSwap is IERC721Receiver, Ownable {
    ...
    address payable public feeReceiver = payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    uint tradeCounter = 0;
    uint public createOfferFee = 10000000000000000; //0.01 eth
    uint public revokeOfferFee = 10000000000000000; //0.01 eth
    uint public fulfillOfferFee = 10000000000000000; //0.01 eth 
    struct TradeOffer {
        address offeror;
