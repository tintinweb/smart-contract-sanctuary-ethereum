...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1653951900;
...
// File: contracts/SImpleProjeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SImpleProjeContract is RamppERC721A {
    constructor() RamppERC721A("SImple Proje", "SIMPLE"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/Kky2ENSCtpNjNzPpdA1n/contract-metadata";
    }
}