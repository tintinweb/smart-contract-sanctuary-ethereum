...
contract MysteryBox is Ownable, ReentrancyGuard, ERC721Enumerable {
    ...
    function mint (address to, uint256 amount) public payable nonReentrant {
        ...
        if (block.timestamp < mintStart + (24 * 60 * 60)) { 
            ...
            require(msg.value >= (amount * mintFee * 75) / 100, "insufficient minting fee");
            require(amount <= 5, "amount exceed");
        }
        //allow second 24 hours for only white members to mint
            ...
            require(amount <= 2, "amount exceed");
            require(msg.value >= amount * mintFee, "insufficient minting fee");
        }
        else {
            require(amount == 1, "amount exceed");
