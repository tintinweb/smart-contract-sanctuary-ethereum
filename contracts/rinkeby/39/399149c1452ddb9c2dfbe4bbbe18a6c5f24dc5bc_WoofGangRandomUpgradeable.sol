...
import "./Abstract_WoofGangUpgradeable.sol";

contract WoofGangRandomUpgradeable is Abstract_WoofGangUpgradeable{
    ...
    function uri(uint id) public view virtual override(ERC1155Upgradeable)  returns (string memory) 
    {
    ...
    function airDrop(address[] calldata account) external override onlyOwner whenNotPaused {
    ...
    function mintRemainingToOwner(uint256 amount) external override onlyOwner whenNotPaused 
    {
        ...
        require(MAX_SUPPLY > totalSupply, "WoofGang: Maximum supply is exceed");
        require(amount <= MAX_SUPPLY-totalSupply , "WoofGang: Amount is more than remanining tokens");
...
contract RandomUpgradeable is Initializable  {
    ...
    function __Random_init(uint256 _pendingCount) internal onlyInitializing {
        __Random_init_unchained(_pendingCount);
    }

    function __Random_init_unchained(uint256 _pendingCount) internal onlyInitializing {
...
interface IWoofGangUpgradeable {
...
import "./IWoofGangUpgradeable.sol";


abstract contract Abstract_WoofGangUpgradeable is ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, RandomUpgradeable, IWoofGangUpgradeable {
