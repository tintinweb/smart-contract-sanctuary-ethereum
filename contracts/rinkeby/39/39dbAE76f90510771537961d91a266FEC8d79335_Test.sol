...
contract Test{
    ...
    function uniswapTestingTokenforTokens(uint256 price, uint256 price2, uint256 deadline, address[] calldata path) external returns(uint256){
    ...
    function uniswapTestingTokensforEth(uint256 price, uint256 price2,  uint256 deadline,address[] calldata path) external returns(uint256){
