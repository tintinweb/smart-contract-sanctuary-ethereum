...
contract MOV3_M1 is ERC721, Ownable { // TODO: contract & token name/symbol
    ...
    constructor(uint maxSupply, uint reserved, uint _MintPrice, uint _DiscountedMintPrice) ERC721(unicode"MOVΞ M1", "M1") {
        MaxSupply = maxSupply;
        Reserved = reserved;
