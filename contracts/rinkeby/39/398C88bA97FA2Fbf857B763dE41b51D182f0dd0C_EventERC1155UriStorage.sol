...
contract EventERC1155UriStorage is 
    ...
    function setTokenUri(uint256 _tokenId, string memory _uri) public onlyEventOwner(_tokenId) {
    ...
    function createEvent(address eventOwner, string memory _name, string memory _description, string memory email, string memory _eventUri) override external {
    ...
    function getIsEventNftsMinted(uint256 _eventId) external view returns (bool isEventMinted) {
