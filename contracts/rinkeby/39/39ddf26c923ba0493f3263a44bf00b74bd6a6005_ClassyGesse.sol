...
contract ClassyGesse is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    string private baseURI = "ipfs://QmSAt5ipfQe2Hy8XwStBKnM7HpMVsFE7eDGPr47sThokky/";
    ...
    constructor(string memory name, 
        ...
        ERC721A(name, symbol, 20, maxSupply) 
    {}
