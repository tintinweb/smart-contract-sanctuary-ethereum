...
contract TestNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    function privateMint(uint256 quantity, bytes32[] calldata merkleProof)
        ...
        nonReentrant
    {
        require(!privateMintLive, "TEST: Private mint not live");
    ...
    function publicMint(uint256 quantity)
        ...
        nonReentrant
    {
        require(!publicMintLive, "TEST: Public mint not live");
        _safeMint(msg.sender, quantity);
    }

    function togglePrivateMint() external onlyOwner {
        privateMintLive = !privateMintLive;
    }
    ...
    modifier mintCompliance(uint256 quantity) {
        ...
        require(
            ...
            "TEST: No tokens left to mint"
        );
        require(msg.value >= mintPrice * quantity, "TEST: Insufficient funds");
        _;
    }
}
