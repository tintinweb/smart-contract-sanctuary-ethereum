...
contract Startans is ERC721A, ERC721AQueryable, Ownable, ReentrancyGuard {
...
// ================== Constructor Start =======================
  ...
  constructor(string memory _uri, address _proxyRegistryAddress) ERC721A("Startans", "STRTN") {
    setBaseURI(_uri);
