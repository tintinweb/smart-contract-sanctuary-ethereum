...
contract LNSAuction is Ownable {
    ...
    modifier onlyAdmin() {
        require(admins[_msgSender()], "LNSAuction: Caller is not the admin");
        _;
    }
    ...
    function createAuction(
        ...
        require(
            block.timestamp >= startTimeStamp && startTimeStamp <= endTimeStamp,
        ...
        )
    {
        ...
        uint256[] memory auctionData = new uint256[](6);
