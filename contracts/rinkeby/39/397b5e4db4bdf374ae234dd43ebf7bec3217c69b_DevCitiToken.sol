...
contract DevCitiToken is DevToken {
    ...
    function initialize() initializer public {
        __DevToken_init("CitiToken", "CITI");
    }
}
...
contract DevToken is BaseToken {
     ...
     */
    function __DevToken_init(string memory _name, string memory _symbol) internal onlyInitializing {
        require(!Utils.isMainnet(), "mainnet not allowed");
        __BaseToken_init(_name, _symbol);
    }
