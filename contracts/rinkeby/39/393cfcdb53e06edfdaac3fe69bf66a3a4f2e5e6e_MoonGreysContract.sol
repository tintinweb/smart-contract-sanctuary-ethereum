...
//
//     __  ___                     ______                    
//    /  |/  /___  ____  ____     / ____/_______  __  _______
//   / /|_/ / __ \/ __ \/ __ \   / / __/ ___/ _ \/ / / / ___/
//  / /  / / /_/ / /_/ / / / /  / /_/ / /  /  __/ /_/ (__  ) 
// /_/  /_/\____/\____/_/ /_/   \____/_/   \___/\__, /____/  
//                                             /____/        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2Ef055Bd25ce4Cdb28a278b636fE954603845ef0,0x0AD52bC1Bca8fa85775A1e3296a92Da1ac60a9e2];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUw41NVLYPPe1km62zsHuhGPrq5iJXUt51kYRanGYGHR5/";
...
// File: contracts/MoonGreysContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoonGreysContract is RamppERC721A {
    constructor() RamppERC721A("Moon Greys ", "Moons"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/OdUzce0qPTA1KhVvBl2w/contract-metadata";
    }
}
