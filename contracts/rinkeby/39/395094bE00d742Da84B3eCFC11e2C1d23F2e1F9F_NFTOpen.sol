  ...
  Ownable
{
   ...
   */
  constructor(string memory _nftName, string memory _nftSymbol) public {
    nftName = _nftName;
  ...
  function batchMinting(address _to, uint256[] calldata token_id, string calldata _uri, string calldata _payload) external {
