...
contract HolaGigMint is ERC721A, ReentrancyGuard, Ownable{
     ...
     */
    constructor(address payable _wallet) ERC721A("HolaGig Mint", "HOLAGIG") {
        collector = _wallet;
    }
    /**
    ...
    function PayableMint(uint256 quantity) external payable returns (uint256 _tokenId) {
        require(msg.value >= 0, "HOLAGIG: Balance not enough");
        tokenId++;
