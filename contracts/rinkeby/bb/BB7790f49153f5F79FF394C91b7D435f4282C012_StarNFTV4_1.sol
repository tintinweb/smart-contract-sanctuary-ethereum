 ...
 * {ERC721Enumerable}.
 */
contract StarNFTV4_1 is Ownable, ERC165, IERC721, IERC721Metadata, IStarNFT {
    ...
    // Array of all tokens storing the cid.
    uint256[] private _cids = [0];

    // Array of all tokens storing the owner's address
    address[] private _tokens = [address(0x0)];
