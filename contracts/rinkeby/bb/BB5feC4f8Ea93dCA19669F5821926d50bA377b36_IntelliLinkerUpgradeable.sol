 ...
 * @author Basil Gorin
 */
contract IntelliLinkerUpgradeable is UpgradeableAccessControl {
	/**
	...
	function postConstruct(address _ali, address _personality, address _iNft) public virtual initializer {
		...
		nextId = 0x1_0000_0000; // iNFT ID space up to 0xFFFF_FFFF (uint32 max) is reserved for the sales
	 ...
	 */
	function whitelistTargetContract(address targetContract, bool whitelist) public virtual {
		// verify the access permission
