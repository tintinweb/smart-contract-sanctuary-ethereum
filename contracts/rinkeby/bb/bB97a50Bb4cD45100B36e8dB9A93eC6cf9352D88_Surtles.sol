...
contract Surtles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Surtles", "SurT") {
    setHiddenMetadataUri("ipfs://QmRskzkJkQmBoLRCBSBrqX5f5L21eMCsgV77Mzpr6SAWrT/Hidden.json");
  }
