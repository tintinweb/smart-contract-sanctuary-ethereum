...
contract FarmThree {
    ...
    SolidTokenThree solidTokenThree;
    RewardToken rewardToken;

    string public name = "Farm Three";

    constructor(SolidTokenThree _solidTokenThree, RewardToken _rewardToken) {
        owner = msg.sender;
        blockPerDay = 1;
        rewardPerBlock = 20 * 10**18;
        solidTokenThree = _solidTokenThree;
    ...
    function stake(uint256 _amount) public {
        ...
        solidTokenThree.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstake() public {
        ...
        solidTokenThree.transfer(msg.sender, balance);
