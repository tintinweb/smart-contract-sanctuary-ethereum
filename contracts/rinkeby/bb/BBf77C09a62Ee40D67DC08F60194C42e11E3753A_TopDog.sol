...
contract TopDog is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Topper", "IDK") {
    setHiddenMetadataUri("ipfs://QmVRidsM3ZLZaq1vvQy9TsfmFK9dxQZ4tqMeGHzPs4R9sm/hidden.json");
  }
  ...
  /**
    ...
    function withdraw() external onlyOwner {
        ...
        require(os, "Failed to withdraw payment");
    }
