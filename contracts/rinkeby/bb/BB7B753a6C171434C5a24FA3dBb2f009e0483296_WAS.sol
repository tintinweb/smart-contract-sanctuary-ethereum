...
contract WAS is ERC20, Airdrop, Ownable, IERC721Receiver {
    ...
    */
    ...
    returns (bytes4) {
        ...
        address ownerOfTheNft = IWASNFT(_wasNFTSmartContract).ownerOf(satoshiId);
        emit incomingNftOwner(ownerOfTheNft);//was ut sc or was os hell wallet?
    ...
    */
    ...
    onlyOwner
    {
        _isContractActive = !_airdropEnabled;
    }
