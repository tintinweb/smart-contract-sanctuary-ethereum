...
contract TimeOutERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public publicSalePrice = 0.00015 ether;

    uint public saleStartTime = 1651877640;
    ...
    address[] private _team = [
        0x28fA60279d8205372dE3D030e64577eA90E40EBd,
        0xdAe2FB66b31653602ccbFC696203FcDac34B3533
    ];
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(currentTime() < saleStartTime + 24 hours, "Public Sale is finished");
