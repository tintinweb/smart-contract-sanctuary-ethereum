...
contract FACES_OF_REKT_CONTRACT is ERC721A, Ownable {
    ...
    function give_Exp (uint16 tokenId, uint256 xp_amount) external {

        require(msg.sender == interacter_address || msg.sender == owner(), "Not an interacter");
        face_of_rekt[tokenId].experience += xp_amount;
    ...
    function _beforeTokenTransfers(
        ...
        require(!face_of_rekt[startTokenId].is_staked, "staked transfer"); // this is to prevent sale while staking
