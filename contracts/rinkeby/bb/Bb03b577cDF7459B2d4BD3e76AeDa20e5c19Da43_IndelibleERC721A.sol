// SPDX-License-Identifier: MIT
  ...
  contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
      ...
      string[] private LAYER_NAMES = [unicode"Mouth", unicode"Beard", unicode"Cheeks", unicode"Ears", unicode"Emotion", unicode"Eyes", unicode"Face", unicode"Hair", unicode"Neck", unicode"Nose", unicode"Sex", unicode"Teeth"];
      ...
      ContractData public contractData = ContractData(unicode"CryptoPunks5000", unicode"5k CryptoPunks", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/80606388-f2b9-4025-b0e2-e8f03524d339", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/80606388-f2b9-4025-b0e2-e8f03524d339", "https://punks.xyz", 0, "0xC5d13db602a4cAD5c9c8c8bd8B6FCfc1A3259f9D");

      constructor() ERC721A(unicode"CryptoPunks5000", unicode"PUNKS") {
        TIERS[0] = [185,673,799,1099,2244];
TIERS[1] = [23,32,59,85,212,242,284,333,417,477,692,734,1410];
TIERS[2] = [272,4728];
TIERS[3] = [1075,3925];
TIERS[4] = [469,834,3697];
TIERS[5] = [48,52,65,129,151,162,181,222,228,389,427,482,715,1749];
TIERS[6] = [29,207,4764];
TIERS[7] = [6,22,27,33,38,43,47,53,99,112,122,131,136,141,201,210,220,268,290,303,343,441,491,600,623];
TIERS[8] = [116,120,4764];
TIERS[9] = [20,4980];
TIERS[10] = [15,20,69,300,1047,1049,2500];
TIERS[11] = [15,4985];
      }
          ...
          returns (string memory)
      {
          ...
          jsonBytes.appendSafe(unicode"{\"name\":\"CryptoPunks5000 #");
