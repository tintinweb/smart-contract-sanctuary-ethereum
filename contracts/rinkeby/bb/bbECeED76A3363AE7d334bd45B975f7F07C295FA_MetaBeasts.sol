...
contract MetaBeasts is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    uint256 public MB_TEAM_RESERVE = 500;
    uint256 public MB_PUBLIC = 1500;
    uint256 public MB_PRIVATE = 500;
    uint256 public MB_MAX = MB_TEAM_RESERVE + MB_PUBLIC + MB_PRIVATE;
    uint256 public MB_PRICE = 0.001 ether;
    uint256 public MB_PER_WALLET = 5;
    uint256 public MB_PER_MINT = 50;
    mapping(address => uint256) public P_MINTERS;

    address private PRIVATE_SIGNER = 0x717aD60d9de30F63Bf75df899155C332e4552CF2;
    ...
    address public teamWallet = 0x2007261e1c354C71cC1FC9597871D5F898339126; // should be changed
    ...
    function privateBuy(uint256 quantity, bytes memory signature) external payable notContract {
        require(privateLive, "MINT_CLOSED");
        require(privateChestsMinted + quantity <= MB_PRIVATE, "EXCEED_PRIVATE");
        require(P_MINTERS[msg.sender] + quantity <= MB_PER_WALLET, "EXCEED_PER_WALLET");
    ...
    function privateBuyAndOpenChest(uint256 quantity, bytes memory signature) external payable notContract {
        require(privateLive, "MINT_CLOSED");
        require(privateChestsMinted + quantity <= MB_PRIVATE, "EXCEED_PRIVATE");
        require(P_MINTERS[msg.sender] + quantity <= MB_PER_WALLET, "EXCEED_PER_WALLET");
        require(matchAddresSigner(signature), "DIRECT_MINT_DISALLOWED");
    ...
    function totalBalanceOf(address addressToCheck) public view returns (uint256) {
        uint256 total = 0;
    ...
    function withdraw() external onlyTeam {
        ...
        Address.sendValue(payable(0x11111F01570EeAA3e5a2Fd51f4A2f127661B9834), currentBalance * 525 / 10000);
        Address.sendValue(payable(0x2007261e1c354C71cC1FC9597871D5F898339126), address(this).balance);
    }
