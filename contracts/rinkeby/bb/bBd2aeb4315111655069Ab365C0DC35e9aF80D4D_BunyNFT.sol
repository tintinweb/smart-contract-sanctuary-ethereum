    ...
    Ownable
{
    ...
    uint256 public startPresaleDate = 1653249600; // May 22, 6 pm EST
    uint256 public endPresaleDate = 1653318000; // May 23, 11 am EST

    uint256 public startFreeSaleDate = 1653235200; // May 22, 12 pm EST
    uint256 public endFreeSaleDate = 1653336000; // May 23,  4 pm EST

    uint256 public startPublicMintDate = 1653321600; // May 23, 12 pm EST

    uint256 public constant MAX_GIFTS = 333;
    ...
    function getHash() internal view returns (bytes32) {
        return keccak256(abi.encodePacked("BUNY", msg.sender));
    }
    ...
    function magicMint(uint256 numTokens) external onlyOwner {
        ...
        require(
            ...
            "Machine can dispense a minimum of 1, maximum of 20 tokens"
        );
