...
/** 
 *  SourceUnit: d:\OrionSolidified\cat\codebase\testbed\contracts\Otherworlds.sol
*/
...
contract Otherworlds is ERC721, Ownable {
    ...
    address d1; //change on production
    address d2; //change on production
    address d3; //change on production
    address d4;  //change on production


    constructor() payable ERC721('Otherworlds', 'WRLDS') {
        mintPrice = 0.15 ether; 
        totalSupply = 0;
        maxSupply = 10; //Change to 100 at production
        maxPerWallet = 2;
        maxAllowedPerWallet = 1;
        withdrawWallet = 0xc9aD265650816C6590b19219f27089366f2Cc306;
        setHiddenMetadataUri("ipfs://QmadYYYDZRgPHTvaVHuJ7rWDuKb2xNAdEnpm3EtoXUrrMz/"); 
        isRevealed = false;
        WRLDS_PROVENANCE = "to be calculated";

        d1 = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2; //change on production
        d2 = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4; //change on production
        d3 = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db; //change on production
        d4 = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;  //change on production
    ...
    string private customContractURI = "ipfs://QmdNkS5vHb2KMV8b9V1i8g9GjxXwmBMZr1oVi7b2EzDLGd/";
