...
contract NativeToken1155Market is ReentrancyGuard, Ownable, ERC1155Receiver {
    ...
    function batchListItem(
        ...
        for (uint256 i = 0; i < nftContractLength; i++) {
            ...
            _activeIds.add(itemId);
            _usersTotalListings[msg.sender].add(itemId);
            IERC1155(nftContract[i]).safeTransferFrom(msg.sender, address(this), tokenId[i], 1, "");
    ...
    function cancelListing(
        ...
        IERC1155(item.nftContract).safeTransferFrom(address(this), msg.sender, item.tokenId, 1, "");
