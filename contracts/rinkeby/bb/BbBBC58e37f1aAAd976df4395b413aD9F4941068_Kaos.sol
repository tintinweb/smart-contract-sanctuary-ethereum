...
contract Kaos is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Kaos", "KAO") {
    setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/Qmci7MPRgBG2j9M7pVa2fU8Yug5SRyLjPTP4LoWTFEzjkm/dsadsadsa.json");
  }
