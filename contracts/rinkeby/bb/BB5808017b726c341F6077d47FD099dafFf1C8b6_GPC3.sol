...
contract GPC3 is ERC721A, Ownable, ReentrancyGuard {
    string public contractURI = "https://giftshop.goldpandaclub.com/contractmetadata.json"; //link to metadata.json for contract info
    ...
    string public baseURI = "https://giftshop.goldpandaclub.com/api/panda3/metadata/";
...
contract ERC721A is IERC721A {
    ...
    mapping(uint256 => bool)  mintedIndexes;
    ...
    function _packedOwnershipOf(uint256 tokenId) private view returns (uint256) {
        ...
        unchecked {
            if (_startTokenId() <= curr)
                if (curr < _currentIndex || mintedIndexes[curr]) {
        ...
        unchecked {
            ...
            if (to.code.length != 0) {
                do {
                    ...
                    if(tokenId != 0){
                        mintedIndexes[updatedIndex] = true;
                    }
