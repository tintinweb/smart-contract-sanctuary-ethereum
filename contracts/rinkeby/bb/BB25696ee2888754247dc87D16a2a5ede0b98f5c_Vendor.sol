...
contract MentoraWellPlayedToken is ERC20, ERC20Burnable, ERC20Permit, ERC20Votes, ERC20Capped, Pausable, AccessControl   {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("Mentora Wel", "MWP") ERC20Capped(110000000000000000000000000) ERC20Permit("Mentora Well Played")  {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
