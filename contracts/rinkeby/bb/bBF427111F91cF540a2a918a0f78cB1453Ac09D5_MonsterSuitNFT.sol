...
contract MonsterSuitNFT is ERC721A, Ownable
{
    ...
    {
        require(preSaleIsActive || saleIsActive, "Sale is not active");
        ...
        require(amount > 0 && amount <= PER_ADDRESS_LIMIT, "Max NFTs per transaction");
    ...
    function verify(bytes32[] memory proof) internal view returns (bool) 
    {
        ...
        return MerkleProof.verify(proof, rootA, leaf) || MerkleProof.verify(proof, rootB, leaf) || MerkleProof.verify(proof, rootC, leaf);
    }
