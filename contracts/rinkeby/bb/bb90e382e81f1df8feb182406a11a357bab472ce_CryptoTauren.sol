...
contract CryptoTauren is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _initcoverURI, string memory _initbaseURI)
        ERC721A("CryptoTauren", "TAUREN")
    {
        coverURI = _initcoverURI;
    ...
    function mint(uint256 tokens) external payable {
        ...
        require(tokens <= maxMintAmount, "SARU: Cannot purchase this many tokens in a transaction");
        require(totalSupply() + tokens <= maxSupply, "SARU: Exceeded supply");
    ...
    function ownerMint(address to, uint256 tokens) external onlyOwner {
        require(totalSupply() + tokens <= maxSupply, "SARU: Minting would exceed max supply");
