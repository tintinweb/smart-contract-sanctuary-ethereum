...
contract PACIFIQUEAVANTGARDE is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.3 ether;
    uint256 public MAX_SUPPLY = 1111;
    uint256 public MAX_MINTS = 1;
    string public baseURI = "ipfs://QmevqU3TLX9y3iyFaT1r74wTpWvtALfGtgPmy2S8Eb88h5/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("PACIFIQUEAVANTGARDE", "PHC", MAX_MINTS, MAX_SUPPLY) {  
    }
