...
contract NFT is ERC721A, Ownable {
    ...
    uint256 public constant maxTotal = 666;
    ...
    function setBlindUse() public onlyOwner {
        useBlind = !useBlind;
    }//设置使用盲盒

    function setBlindURI(string memory _blindTokenURI) public onlyOwner {
        blindTokenURI = _blindTokenURI;
    }//设置盲盒URI
   
    function setBlindBoxOpene() public onlyOwner {
        blindBoxOpen = !blindBoxOpen;
    }//设置开盲盒

    function withdraw() public onlyOwner {
        uint one = address(this).balance;
