...
contract Testcon is Ownable, ERC721B, NonblockingReceiver {
 ...
 constructor(
  ...
  ) ERC721B("Testcon", "Testcon", maxBatchSize_, startIndex_, endIndex_) {
    ...
    function upgrade(address owner,  uint256 tokenId, uint256 newtokenId) public returns (bool) {
