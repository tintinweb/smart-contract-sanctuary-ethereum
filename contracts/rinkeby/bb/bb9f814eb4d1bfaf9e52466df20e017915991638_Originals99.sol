...
// File: contracts/Originals99.sol
...
contract Originals99 is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    address private mintingFundsReceiver;
    ...
    constructor(
        ...
        address mintingFundsReceiver_,
        string memory baseURI_
    ) ERC721("99 Originals", "99ORIG") {
        require(royaltiesReceiver != address(0), "Royalties Receiver Is Mandatory");
        require(mintingFundsReceiver_ != address(0), "Minting Funds Receiver Is Mandatory");

        _setDefaultRoyalty(royaltiesReceiver, ROYALTIES_BPS);
        mintingFundsReceiver = mintingFundsReceiver_;
        baseURI = baseURI_;
    }
    ...
    function placeBid() external payable onlyActiveAuction nonReentrant {
        ...
        if (winningBidder != address(0)) {
            ...
            require(success, "Returning Escrow Funds Failed");
        }
    ...
    function withdraw() external onlyOwner {
        ...
        (bool success, ) = mintingFundsReceiver.call{value: address(this).balance}("");
