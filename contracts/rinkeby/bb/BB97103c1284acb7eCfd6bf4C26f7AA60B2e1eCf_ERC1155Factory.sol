...
contract ERC1155Factory is Factory, IERC1155Factory {
        ...
        whenNotPaused
    {
        ...
        emit ERC1155CollectionMinted(address(collection), msg.sender);
    }
}
...
abstract contract Factory is AccessControl, Pausable, ReentrancyGuard {
    ...
    /**
     * @dev Returns the marketplace.
     */
    function marketplace() public view virtual returns (address) {
        return _marketplace;
    }
}
...
interface IERC1155Factory {
    function mintCollection() external;

    event ERC1155CollectionMinted(
        address collection,
        address creator
    );
}
    ...
    ERC2981
{
    ...
    {
        //Mint to receiver
        _mint(tokenReceiver, tokenId, amount, data);
...
contract Collection is AccessControl, ReentrancyGuard {
