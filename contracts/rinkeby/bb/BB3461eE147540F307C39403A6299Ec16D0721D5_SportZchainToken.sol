...
contract SportZchainToken is Ownable, ERC20Pausable, ERC20Burnable, AccessControl 
{
     ...
     */
    function burn(uint256 _amount) public onlyBurner override (ERC20Burnable) 
    {
        super.burn(_amount);
    }
     ...
     * @param _amount = token amount to burn
     */
    function burnFrom(address account, uint256 _amount) public onlyBurner override (ERC20Burnable) 
    {
