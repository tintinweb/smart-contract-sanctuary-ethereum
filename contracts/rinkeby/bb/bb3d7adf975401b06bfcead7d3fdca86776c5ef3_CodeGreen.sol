...
contract CodeGreen is ERC1155Supply, Ownable, Pausable {
    ...
    function determineMintId(uint256 nonce) private view returns (uint256) {
        ...
        // 7/256, aka 2.73% probability (0xF9 is 249, and max number is 255 0xFF, so 255-248 == 7 possibilities out of 256 from 0x00 to 0xFF)
     ...
     */
    function preSaleMint(bytes32 messageHash, bytes calldata signature) external {
