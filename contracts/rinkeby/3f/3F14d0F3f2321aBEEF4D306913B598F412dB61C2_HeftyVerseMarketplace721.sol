...
contract HeftyVerseMarketplace721 is EIP712Upgradeable, BasicMetaTransaction {
    bytes32 public constant HEFTYVERSE_SELLER_HASH = 0xeed8a7e8d361fc920ee866071cac2f63f3b80897573e97f272330f009d42a586;
    bytes32 public constant HEFTYVERSE_BUYER_HASH = 0x0e42830da655cec06be01a49988331f7f7fa8855308a366c6036d7932846b294;
     ...
     */
    function initialise(address _owner, address _marketWallet, address _token, address _treasury) external initializer {
    ...
    /**
     * @notice This is the internal function used to verify signatures for secondary sale of NFT
    ...
    /**
     * @notice This is the internal function used to verify signatures for primary sale of NFT
     * @param buyer is a HeftyVerseBuyer describing the NFT to be bought
     * @param _voucher is a NFTvoucher describing an unminted NFT
     */
    function verifyPrimary(HeftyVerseBuyer memory buyer, Voucher.NFTvoucher memory _voucher) internal view {
        address signerBuyer = _verifyBuyer(buyer);
        require(buyer.buyer == signerBuyer,"invalid buyer");
    ...
    function withdrawStuckToken(address _token) public {
        require(msg.sender == admin,"not admin");
        uint _amount = IERC20Upgradeable(_token).balanceOf(address(this)); 
