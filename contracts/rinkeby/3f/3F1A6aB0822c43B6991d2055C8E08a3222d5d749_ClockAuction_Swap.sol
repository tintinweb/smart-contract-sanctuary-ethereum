...
contract ClockAuction_Swap is Ownable {
    ...
    address public auction_addr = 0x4A585B182Dc8cA3e40B429a20b9716E55981f95B;
    ...
    //    function bid(address _nftAddress, uint256 _tokenId) external payable {
    //        IAuction(auction_addr).bid{value : msg.value}(_nftAddress, _tokenId);
    //        IERC721(_nftAddress).safeTransferFrom(address(this), address(msg.sender), _tokenId);
    //    }
    //
    //    function getAuction(address _nftAddress, uint256 _tokenId) external view returns (address seller, uint256 startingPrice, uint256 endingPrice, uint256 duration, uint256 startedAt){
    ...
    //    function cancelAuction(address _nftAddress, uint256 _tokenId) external
    //    {
    //        IAuction(auction_addr).cancelAuction(_nftAddress, _tokenId);
    //        IERC721(_nftAddress).safeTransferFrom(address(this), address(msg.sender), _tokenId);
    //    }
    ...
    //        uint256 _tokenId
    //    ) external {
    //        IAuction(auction_addr).cancelAuctionWhenPaused(_nftAddress, _tokenId);
    //        IERC721(_nftAddress).safeTransferFrom(address(this), address(msg.sender), _tokenId);
    //    }
