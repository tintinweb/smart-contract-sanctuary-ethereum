...
contract WeinerzTest is ERC721, Ownable {
    ...
    function mint(address _to) public payable {
        ...
        require(mintIndex <= MAX_SUPPLY, "All the Weinerz are gone! Sorry you missed it!");
    ...
    function updateMaxMints(uint256 newMax) public onlyOwner {
        MAX_MINT_PER_WALLET = newMax;
    }
    ...
    // NOT MEANT FOR PRODUCTION. DELETE THIS CONDIMENT
    function adminMint(uint256 numberOfTokens) public onlyOwner {

        uint256 totalMinted = tokenSupply();

        require( (totalMinted + numberOfTokens) <= MAX_SUPPLY, "Exceeds max supply");
