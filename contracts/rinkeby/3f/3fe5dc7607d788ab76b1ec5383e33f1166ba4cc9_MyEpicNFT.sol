...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Bernardo", "Marcos", "Theo", "Daniel", "Rafael", "Jorge", "Henrique", "John", "Noah", "Jayme", "Octavio", "Caio", "Liam", "Noah", "Miguel", "Caique", "Henrico", "Vicente"];
  string[] secondWords = ["Isabella", "Maria", "Gabriela", "Sarah", "Antonella", "Catarina", "Fernanda", "Marcia", "Magaly", "Fabiola", "Renata", "Marina", "Valentina", "Anastasia", "Mikaela", "Bella", "Eduarda", "Winter", "Summer"];
  string[] thirdWords = ["Joshua", "Zachary", "Angelina", "Esther", "Pablo", "Bento", "Gabriel", "Peter", "Killian", "Julia", "Benjamin", "Nikolai", "Jessica", "Bianca", "Patricia", "Amanda", "Joaquim"];

  
  string[] colors = ["red", "#08C2A8", "black", "yellow", "blue", "green", "pink", "purple", "orange", "darkblue"];
  
  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721 ("ChavesNFT", "CHAVO") {
    console.log("Contrato de NFT do Pai");
  }
