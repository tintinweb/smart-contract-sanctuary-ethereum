    ...
    CustomPaymentSplitterUpgradeable
{
      ...
      initializer 
    {
      ...
      __Royalties_init_unchained(royaltyRecipient, royaltyValue);
        ...
        onlyWhitelisted(uint8(Stage.Whitelist), msg.sender, proof_)
    {
        ...
        require(whitelistReserved - amount_ >= 0, "Not enough reserved for whitelist");
