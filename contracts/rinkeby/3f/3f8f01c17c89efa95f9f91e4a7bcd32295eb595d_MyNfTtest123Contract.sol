...
//*********************************************************************//
//
// Test header mark*disclamer test* NFTtest is not responsible for any bla bla bla
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x00C87DAF3B13c172CFDDE0BF44aE6F34c8965690];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmYJQD4dbYKFvtYdVDwMMkSn3RLTQhiwu6ZDPsTLoQvsYu/";
...
// File: contracts/MyNfTtest123Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNfTtest123Contract is RamppERC721A {
    constructor() RamppERC721A("My NFT test 123", "NFTtest"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/BMQS9jTNbKCyGJRjqU7u/contract-metadata";
    }
}
