...
contract LiquidityProvider is IERC721Receiver {
        ...
        )
    {
        ...
        TransferHelper.safeApprove(AddressToken0, nonfungiblePositionManager_, amountToken0ToMint);
        TransferHelper.safeApprove(AddressToken1, nonfungiblePositionManager_, amountToken1ToMint);
