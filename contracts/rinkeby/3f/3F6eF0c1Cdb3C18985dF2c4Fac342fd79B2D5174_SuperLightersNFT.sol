// SPDX-License-Identifier: MIT
    ...
    contract SuperLightersNFT is ERC721, Ownable, ERC721Enumerable {
      ...
      event SuperLighterMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("SuperLightersNFT", "SLN") {}
      ...
      function mintSuperLighter(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit SuperLighterMinted(id, msg.sender);
          }
        }
      }
    
      function presaleSuperLighter(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://Qmdq8jw7TVE6FUBb5aYDMy28DojZoVjE8gxSnSRYY6WZEw/hidden_metadata.json";
        }
