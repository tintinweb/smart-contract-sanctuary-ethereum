...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string baseSvg = "<svg  xmlns='http://www.w3.org/2000/svg'  preserveAspectRatio='xMinYMin meet'  viewBox='0 0 350 350'>  <defs>    <linearGradient id='Gradient1'>      <stop class='stop1' offset='0%'/>      <stop class='stop2' offset='50%'/>      <stop class='stop3' offset='100%'/>    </linearGradient>  </defs>  <style>    .base {      fill: purple;      font-family: serif;      font-size: 25px;      color: #FFF;    }    .stop1 { stop-color: purple; }    .stop2 { stop-color: black; stop-opacity: 0; }    .stop3 { stop-color: gray; }      </style>  <rect width='100%' height='100%' fill='url(#Gradient1)' />  <text    x='50%'    y='50%'    class='base'    dominant-baseline='middle'    text-anchor='middle'  >";
  ...
  string[] firstWords = ["WEB3", "BLOCKCHAIN", "NFT", "TOKEN", "WALLET", "TRANSACTION"];
  string[] secondWords = ["DAO", "DEFI", "MARKETPLACE", "", "DEX", "CONTRACT"];
  string[] thirdWords = ["economy", "solidity", "javascript", "deploy", "node", "web3dev"];

    constructor() ERC721 ("WOLFNFT", "WOLF"){
      console.log("Esse eh meu contrato de NFT! WOLFNFT");
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combinedWord,
                        '", "description": "NFT WOLF collection.", "image": "data:image/svg+xml;base64,',
