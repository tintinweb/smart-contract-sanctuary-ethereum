...
contract Aureus is ERC20, Ownable {
    ...
    //address public USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;  //Ethereum mainnet
    address public USDC = 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926;  //Rinkeby Testnet
    address public devWallet = 0x5F9368460537e25D95FB355BC667a02FcC94cD93;
    address public marketingWallet = 0xBfF3cEa811d58db60597B405B140c5594F0260d6;
    ...
    // uint256 public _usdcBalance;
    // uint256 public _usdcForDev;
    // uint256 public _usdcForMarketing;
    // uint256 public _usdcForDividends;
    ...
    constructor() ERC20("Aureus", "AUREUS") {
    	usdcDividendTracker = new USDCDividendTracker();

        minTransactionTier = 1000000 * (10**18);
        maxTransactionTier = 10000000 * (10**18);
    ...
    function afterPreSale() external onlyOwner {
        ...
        buyMarketingFeeMin = 5;
        buyMarketingFeeNormal = 4;
        buyMarketingFeeMax = 3;

        sellMarketingFeeMin = 4;
        sellMarketingFeeNormal = 6;
        sellMarketingFeeMax = 10;

        buyUSDCDividendRewardsFeeMin = 5;
        buyUSDCDividendRewardsFeeNormal = 4;
        buyUSDCDividendRewardsFeeMax = 2;

        sellUSDCDividendRewardsFeeMin = 4;
        sellUSDCDividendRewardsFeeNormal = 6;
        sellUSDCDividendRewardsFeeMax = 10;

        swapTokensAtAmount = 5000000 * (10**18);
        maxBuyTransactionAmount = 50000000 * (10**18);
        maxSellTransactionAmount = 50000000 * (10**18);
        maxWalletToken = 50000000 * (10**18);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && canSwap) {
                ...
                uint256 usdcForDev = usdcBalance.div(4);
                uint256 usdcForMarketing = usdcBalance.div(4);
                uint256 usdcForDividends = usdcBalance.div(2);

                // _usdcBalance = usdcBalance;
                // _usdcForDev = usdcForDev;
                // _usdcForMarketing = usdcForMarketing;
                // _usdcForDividends = usdcForDividends;

                IERC20(USDC).transfer(devWallet, usdcForDev);
                IERC20(USDC).transfer(marketingWallet, usdcForMarketing);

                transferDividends(USDC, address(usdcDividendTracker), usdcDividendTracker, usdcForDividends);
    ...
    function swapTokensForUSDC(uint256 _tokenAmount) private {
...
contract USDCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    ...
    //0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 - ETH mainnet
    //0xeb8f08a975Ab53E34D8a0330E0D34de942C95926 - Rinkeby Testnet
    constructor() DividendPayingToken("USDC_Dividend_Tracker", "USDC_Dividend_Tracker", 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926) {
    	claimWait = 86400;
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0x909eC21E5d07adA807651AA1A6ec2865f92ba1AB, "Only owner can change dividend contract address");
      dividendToken = newToken;
  }
