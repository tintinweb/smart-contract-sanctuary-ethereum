    ...
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmTEd2tmw7AoGbLEUL4JKphwztLkNK986iqUDqH36Zi63P/hidden.json";
    ...
    uint256[] private _teamShares = [25, 35, 39, 1]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0xF7504cd652a1c9A8aD3fC7Fed4cE59d7ADAb5C7E, // Admin Account gets 25% of the total revenue
        0x41E5bCa1bb441a39FB6202258FDe5BfC752C81e9, // Treasury Fund
        0x794E579b2EF556036103D279A05cd02e1D16b05a, // Dev Account
        0x67Dfc902716C2BA05Eb2752236F35028A9ab4407 // Founders Fund
    ...
    function newSetBaseURI(string memory _tokenBaseURI) public onlyOwner {
