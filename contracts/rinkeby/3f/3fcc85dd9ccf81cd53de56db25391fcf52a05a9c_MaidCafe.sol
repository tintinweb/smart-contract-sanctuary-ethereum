...
contract MaidCafe is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI = "https://bafybeihqiwqdh2mrd2fk3opcypseffq5ku7x6rc4d5tjgwjw3qtp2j4ifu.ipfs.nftstorage.link/";
  ...
  constructor() ERC721A("MaidCafe", "MCF"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Waifus");
