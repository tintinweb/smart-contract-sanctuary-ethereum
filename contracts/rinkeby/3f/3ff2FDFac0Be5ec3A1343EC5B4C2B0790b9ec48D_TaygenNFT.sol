    ...
    ERC721PausableUpgradeable
{
    ...
    */
    ...
    function _baseURI(uint _tokenId, uint _USDCBalance, uint _tUSDCAmount, uint _conversionRate, uint _usdcFee, uint _withdrawTime) internal pure returns (string memory output) {
        ...
        return output = string(abi.encodePacked('data:application/json;base64,', json));
    }
