...
contract MoonWolfs420 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount){
    ...
    if(WalletMint[msg.sender] < freeMint&&(totalSupply()+1)<=freeMaxSupply) 
        {
           require(msg.value >= (_mintAmount - freeMint) * cost,"Notice MW420:  Claim Free NFT");
            WalletMint[msg.sender] += _mintAmount;
           _safeMint(msg.sender, _mintAmount);
        }
        else
        {
           require(msg.value >= _mintAmount * cost,"Notice MW420:  Fund not enough");
            WalletMint[msg.sender] += _mintAmount;
           _safeMint(msg.sender, _mintAmount);
        }
  }
