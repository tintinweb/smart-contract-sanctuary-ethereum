...
contract CRTEST is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public THEMINTPRICE = 0.01 ether; // Presale 0.12, Public 0.15
    uint public WALLETLIMIT = 20; // Presale 2 , Public 10 
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account( 200, 0, 1 ); // CR 200
        accounts[teamclaim[1]] = Account( 25, 0, 1 );  // G1 25
        accounts[teamclaim[2]] = Account( 25, 0, 1 );  // G2 25
        accounts[teamclaim[3]] = Account( 25, 0, 1 );  // G3 25
        accounts[teamclaim[4]] = Account( 22, 0, 1 );  // G4 22

        RESERVEDNFTS = 297;  
        // Does not count: (1) airdrop special IDs #1-50 to team
