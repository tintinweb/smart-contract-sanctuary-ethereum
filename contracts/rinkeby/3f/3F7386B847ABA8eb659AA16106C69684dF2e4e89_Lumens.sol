...
contract Lumens is ERC721A, Ownable, PaymentSplitter {
    ...
    address[] private payees = [0xE021ABEaD374B2029CFE987D58341915F50CBdD5, 0x978bA3B945e7Af3E5cbF7eB3726b0a12904d6575];

    //The below percentages are for example purposes only. Please modify them.
    uint256[] private payeesShares = [75, 25];
    ...
    function _internalMint(address to, uint8 amount, uint8 stage) internal {
