...
import "./CollectibledUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new CollectibledUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CollectibledUser1155Token token = CollectibledUser1155Token(address(addr));
...
contract CollectibledUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
