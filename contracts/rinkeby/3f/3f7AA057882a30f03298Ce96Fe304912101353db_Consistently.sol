...
contract Consistently is Ownable{
    ...
    string private tokenURI = "0x0";
     
    uint8 public minimumDays  = 21;
    uint8 public maximumDays =  255;
    uint32 public timeLapse =  86400; // This is the checkin interval
    struct Intention {
        uint8 noOfDays;
    ...
    constructor() { 
        aavePool = IPool(0xc803d8504E88cf3d301393D405254b0E1d85178c);
    ...
    event IntentionRegistered(address userAddress, uint256 weiDeposited, string ipfsPath, uint256 timeRegistered, bool active);
    ...
    function register(string memory _ipfsPath, uint8 _days) external payable {
        require(msg.value >= .01 ether, "Minimum Amount of .1 Eth");
        require(_days >= minimumDays, "Minimum of 21 days Acceptable");
        require(_days <= maximumDays, "Maximum of 255 days Acceptable");
        require(userIntentions[msg.sender] == 0, "A habit quest is running");
        uint256 currentTime = block.timestamp;
        
        Intention memory intent = Intention(_days, msg.value,  _ipfsPath, msg.sender, true);
        ...
        emit IntentionRegistered(msg.sender, msg.value, _ipfsPath, currentTime, true );
    }
    ...
    */
    function redeem()
      ...
      {
          require(keccak256(abi.encodePacked(tokenURI)) == keccak256(abi.encodePacked("0x0"))); // The ipfs path to the NFT should have been set.
