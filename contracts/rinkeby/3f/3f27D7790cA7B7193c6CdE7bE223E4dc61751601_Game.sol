...
contract Game is VRFConsumerBaseV2, Ownable  {
    ...
    uint8 public constant width = 21;
    uint8 public constant height = 21;
    ...
    bool public requireContract = true;
    ...
    uint8 public attritionDivider = 25;
    ...
    function dropHealth(uint256 firstRandomNumber, uint256 secondRandomNumber) public {
        require(msg.sender == keeper, "ONLY KEEPER CAN CALL");
    ...
    function dropGold(uint256 firstRandomNumber, uint256 secondRandomNumber) public {
        require(msg.sender == keeper, "ONLY KEEPER CAN CALL");
