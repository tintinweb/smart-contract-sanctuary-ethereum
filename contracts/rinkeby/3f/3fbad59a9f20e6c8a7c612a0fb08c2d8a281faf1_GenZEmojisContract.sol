...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE87e0e64bae242b885B711F7b8704a8dC80EbF61];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmP47W2tcXsMkH6joizZ1CwHPhGF92xnq13khgMZwYsvug/";
...
// File: contracts/GenZEmojisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GenZEmojisContract is RamppERC721A {
    constructor() RamppERC721A("Gen Z Emojis", "GENZE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ZHAMPC2Vq1G9jKVYYRwi/contract-metadata";
    }
}