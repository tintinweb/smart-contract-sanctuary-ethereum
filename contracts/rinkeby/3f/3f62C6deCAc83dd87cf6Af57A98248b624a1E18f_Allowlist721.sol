...
contract Allowlist721 is MintpassValidator, ERC721A, ERC2981, Ownable {
    ...
    function getLatestPrice() public view returns (uint256) {
        ...
        return uint256((publicMintUSDPrice / price) * (1 ether));
    }

    /**
     * Returns the latest price
     */
    function getLatestPriceRaw() public view returns (int256) {
        (
            /*uint80 roundID*/,
            int256 price,
            /*uint startedAt*/,
     ...
     * Returns the latest price
     */
    function getLatestPriceMintUint() public view returns (uint256) {
        (
            /*uint80 roundID*/,
            int256 price,
            /*uint startedAt*/,
        ...
        return uint256(publicMintUSDPrice / price);
    }

    /**
     * Returns the latest price
     */
    function getLatestPriceMintInt() public view returns (int256) {
        (
            /*uint80 roundID*/,
            int256 price,
            /*uint startedAt*/,
        ...
        return publicMintUSDPrice / price;
    }
