...
contract RedCandleHeros is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Red Candle Hero's", "COOMER") {
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        ;if(currentIndex + numberOfTokens > 998){
...
*/
    ...
    function withdrawAll() public payable onlyOwner {
        uint256 _kingcoom = address(this).balance * 80/100;
        uint256 _lilcoom = address(this).balance * 10/100;
        uint256 _bigcoom = address(this).balance * 10/100;
