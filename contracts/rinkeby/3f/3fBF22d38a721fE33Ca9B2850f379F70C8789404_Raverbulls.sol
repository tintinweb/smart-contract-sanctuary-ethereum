...
contract Raverbulls is ERC721, Ownable, CantBeEvil, ReentrancyGuard {
  ...
  constructor() ERC721("Testi", "RVB") CantBeEvil(LicenseVersion.CBE_ECR) {
    _mint(owner(), 0);
  }
  ...
  address private constant payoutAddress1 = 0xd56995A017969BFc4c934dDcA9Fa9fbf6E5b1eC2;
  address private constant payoutAddress2 = 0xd56995A017969BFc4c934dDcA9Fa9fbf6E5b1eC2;
  address private constant payoutAddress3 = 0xd56995A017969BFc4c934dDcA9Fa9fbf6E5b1eC2;

  function withdraw() public nonReentrant {
    uint256 balance = address(this).balance;

    Address.sendValue(payable(owner()), balance * 25 / 100);
