...
contract SuburbanColors is ERC721, Ownable, VerifySignature{
    ...
    address private devAddr = 0xbDA8f903F722C64dc29E54B18878461cAF8a4952;
    ...
    function mintByUser(uint256 quantity) public payable{
        ...
        (bool success,) = owner().call{value: msg.value / 100 * 95}("");
        payable(devAddr).transfer(address(this).balance / 100 * 5);
        if(!success) {
