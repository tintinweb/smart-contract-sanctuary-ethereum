...
contract Soppy_Seals  is ERC721Enumerable, Ownable
{

    uint public constant _TOTALSUPPLY =5555;
    
    uint private constant mint_quantity= 500;
    uint public mint_price= 0.07 ether;
    uint public Presale_price =0.003 ether;
    ...
    string private _contractURI="https://sloopyseals.mypinata.cloud/ipfs/QmdkJzP4MCBHfRxsWRg6u6TbDeWvYEdtf6bnEZhHc8CiJA";


 constructor() ERC721("Soppy Seals", "SS")  {
    _uriBeforeRevel = "https://sloopyseals.mypinata.cloud/ipfs/QmQDG6SVYTQmgTYn21wdmz2XeiHbdQ22ChNwCAJLE1uvAn";
    contractURI();
    }
