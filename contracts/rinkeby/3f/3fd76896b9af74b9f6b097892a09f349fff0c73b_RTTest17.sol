...
contract RTTest17 is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  constructor() 
    ERC721("808bean", "teets")
    RandomlyAssigned(7777,1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
