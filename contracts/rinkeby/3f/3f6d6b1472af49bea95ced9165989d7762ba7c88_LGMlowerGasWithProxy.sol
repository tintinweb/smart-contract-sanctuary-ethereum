...
// File: contracts/LGMlowerGasWithProxy.sol
...
contract LGMlowerGasWithProxy is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  constructor() ERC721("another test contract", "atc") {
    ...
    _initializeEIP712("another test contract");
  }
  ...
  // Comment: Test gas usage of this function... TBD
  ...
  function setRevealed(bool _state) public onlyOwner { revealed = _state; }
    ...
    // Comment !!! I believe setCost will be in WEI !!! not ETH !!!
  ...
  function withdraw() public onlyOwner {
    // Pay owner 5% of the initial sale.  0x37c2349eB90D5E702dBA7480B11Cf9f944ac164F
    (bool hs, ) = payable(0x37c2349eB90D5E702dBA7480B11Cf9f944ac164F).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // Transfer remaining contract balance to owner.
