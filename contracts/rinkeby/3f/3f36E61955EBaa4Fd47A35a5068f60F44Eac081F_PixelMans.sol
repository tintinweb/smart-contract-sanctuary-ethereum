...
contract PixelMans is ERC721A, Pausable, Ownable {
    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant MAX_FREE_MINTS_PER_TX = 1;
    ...
    constructor() ERC721A("PixelMans", "PIXMAN") {}
    ...
    function freeMint() external whenNotPaused {
        ...
        require(MAX_FREE_MINTS_PER_TX + _totalMinted() <= MAX_SUPPLY, "Quantity unavailable.");
        freeMinters[msg.sender] = true;
        freeMintsAvailable -= MAX_FREE_MINTS_PER_TX;
        _safeMint(_msgSender(), MAX_FREE_MINTS_PER_TX);
