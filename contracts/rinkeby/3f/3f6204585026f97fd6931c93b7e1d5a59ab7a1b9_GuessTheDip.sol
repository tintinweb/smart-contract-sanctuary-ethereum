...
// File: contracts/GuessTheDip.sol
...
contract GuessTheDip is  ERC721A, Ownable {
    ...
    function mint( uint256 amount, bytes32[] calldata merkleProof) external {
        require(block.timestamp > openTime, "Sale hasn't started yet");
        require(amount < 11, "Maximum 10 is allowed");
    ...
    function setOpenTime(uint256 newOpenTime) public onlyOwner {
