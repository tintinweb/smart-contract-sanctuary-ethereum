...
//origin heroes
contract OriginHeroes is ERC721AQueryable, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	string public _unrevealedURI = "https://xxxxxxxxxxxxxxx/unrevealed.json";
	...
	constructor() ERC721A("Origin Heroes", "FHC") PaymentSplitter(addressList, shareList) {}
	...
	function adminMint(address to) external onlyOwner {
		require(totalSupply() <= 1, "no more than 1");
		_mint(to, 1);
	}
	...
	function buildNumber2() internal view {}
}
