...
// File: contracts/FusionFramesv2.sol
...
contract FusionFramesv2 is ERC721URIStorage, ERC1155Holder, Ownable {

    constructor() ERC721("Fusion Frames v2", "FFRAMESv2") {}
    ...
    function _getSeriesArray(uint256[] memory ids) public pure returns (uint256) {
