...
contract MyERC20UpgradebleV1 is Initializable, ERC20Upgradeable, ReentrancyGuardUpgradeable,OwnableUpgradeable {
    ...
    uint256 public holdingTime = 160;
    ...
    function initialize(address _rewardsToken,address _stakingToken) public initializer{
      ...
      function balanceUser(address account) external view  returns (uint256) {
    ...
    //   function updateRewardsToken(address _rewardsToken) external onlyOwner{
    //      rewardsToken = _rewardsToken;
    // }

    //  function updateRewardsToken(address _stakingToken) external onlyOwner{
    ...
    function withdraw(uint256 amount) public  nonReentrant updateReward(msg.sender) {
        require(amount > 0, "Cannot withdraw 0");
         require(block.timestamp.sub(userLastStackedTime[msg.sender]) > holdingTime);
