...
contract testGameLogic is  Ownable, IERC721Receiver, rarityCheck, Initializable, Pausable {
    ...
    uint public MINIMUM_TO_EXIT = 10 minutes;
    uint public INJURY_TIME = 10 minutes;
    ...
    uint public rewardCalculationDuration = 10 minutes;
    ...
    // owedExp * 100
    uint[] public yetiMultiplier = [100, 120, 150]; // new introduced
    ...
    function addManyToPalace(address account, uint[] memory tokenIds, uint8 activityId) external {
        ...
        for (uint i = 0; i < tokenIds.length; i++) {
            ...
            stakedToken[msg.sender].push(tokenIds[i]);
            tokenToPosition[tokenIds[i]] = stakedToken[msg.sender].length-1;
