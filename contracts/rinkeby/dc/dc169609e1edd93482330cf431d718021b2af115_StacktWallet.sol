    ...
    StacktGuardManager
{
    ...
    event RefundCalculation(uint256 indexed gas, uint256 indexed gasprice); ///
    ...
    function execTransaction(
        ...
        /* -------------------------------- execution ------------------------------- */
        {
            ...
            if (refundGas) {
                ...
                emit RefundCalculation(gasUsed + PAYMENT_GAS_COSTS + MISC_GAS_COSTS + msg.data.length * DATA_BYTE_GAS_COSTS, tx.gasprice); ///
