// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint public constant maxSupply = 5500;
        ...
        ContractData public contractData = ContractData(unicode"Be Yourself", unicode"Be yourself. Everyone else is dumb. Not your average pixel project. 100% on-chain, Be Yourself is a lifestyle.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/36521a0d-67cf-4eb3-bbd0-f526433d19bc", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/36521a0d-67cf-4eb3-bbd0-f526433d19bc", "https://www.beyourselfnft.com/", 500, "0x97faF1fe826A87b7f8e3e56843b36f367A940A23");

        constructor() ERC721A(unicode"Be Yourself", unicode"BEYOU") {
            TIERS[0] = [2,2,2,2,2,2,2,5486];
TIERS[1] = [15,30,47,48,100,140,150,175,185,196,253,273,279,280,316,320,351,457,505,530,850];
TIERS[2] = [4,10,25,50,60,65,73,75,75,79,96,97,100,100,100,101,106,123,125,125,127,140,147,150,150,150,150,175,200,200,210,225,225,250,250,250,287,300,325];
TIERS[3] = [5,20,30,30,40,40,50,51,54,61,66,68,80,84,85,97,105,110,116,132,133,145,152,171,188,202,215,224,240,269,270,300,338,389,400,540];
TIERS[4] = [86,114,116,120,153,268,270,335,407,445,558,578,644,650,756];
TIERS[5] = [40,40,45,50,60,60,60,60,75,80,85,90,100,100,100,120,120,125,125,125,125,125,125,130,130,140,140,140,140,140,140,145,150,150,150,160,160,165,170,175,175,190,275,300];
TIERS[6] = [25,50,75,150,200,250,500,500,500,550,550,650,700,800];
TIERS[7] = [200,200,300,400,500,500,600,650,650,700,800];
        }
