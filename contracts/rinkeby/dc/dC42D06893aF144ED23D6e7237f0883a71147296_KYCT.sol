...
contract KYCT is ERC721URIStorageUpgradeable, AccessControlUpgradeable {
    ...
    /**
     * Message: "AccessControl: from address is not a minter"
     * Reason: Trying to revoke minter from an address that is not a minter
     */
    string public constant FROM_ADDRESS_NOT_A_MINTER = "ERR0";

    /**
     * Message: "AccessControl: msg.sender is neither an admin nor a minter"
     * Reason: Only a minter can transfer minter role from one address to other. Admin can also do it.
     */
    string public constant SENDER_NOT_MINTER_NOR_ADMIN = "ERR1";
    ...
    function transferMinting(address from, address to) external {
        ...
        require(hasRole(MINTER_ROLE, from), FROM_ADDRESS_NOT_A_MINTER);
        ...
        if (
            ...
            revert(SENDER_NOT_MINTER_NOR_ADMIN);
        }
    }
