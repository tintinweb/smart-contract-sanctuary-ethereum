...
contract ZZZ is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 2e10 * 10**9; //0.5% - 5000000000
    uint256 public _maxWalletSize = 4e10 * 10**9; //1.5%
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            // Set Fee for Sells
            // TAX SELLERS 4% WHO SELL WITHIN 8 HOURS (3% development + 1% holders redistribution)
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
