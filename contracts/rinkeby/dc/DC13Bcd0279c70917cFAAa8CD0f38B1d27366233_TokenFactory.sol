...
contract TokenFactory is NonblockingLzApp {
    ...
    constructor(address _lzEndpoint) NonblockingLzApp(_lzEndpoint)  {
        //        endpoint = ILayerZeroEndpoint(address(0x4D747149A57923Beb89f22E6B7B97f7D8c087A00)); // 0x79a63d6d8BBD5c6dfc774dA79bCcD948EAcb53FA Rinkeby
        _contractChainId = 10001;
        _owner = msg.sender;
        _baseAsset = IERC20(address(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b));
    ...
    function mintToken(
        ...
        uint16 version = 1;
        uint gasForDestinationLzReceive = 10000000;
