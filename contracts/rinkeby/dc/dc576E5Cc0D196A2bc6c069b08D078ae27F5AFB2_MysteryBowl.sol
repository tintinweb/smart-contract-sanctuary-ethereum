    ...
    OwnableUpgradeable
{
    ...
    uint256 public constant SALE_PRICE = 0.00000125 ether;
    uint256 public constant MAX_PER_WALLET = 1500;
    ...
    */
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64Upgradeable.encode(
            bytes(
                string(abi.encodePacked("{\"name\": \"Mystery Bowl #", StringsUpgradeable.toString(_tokenId), "\", \"image\":\"", bowlImage, "\", \"attributes\": [{\"trait_type\":  \"Can Summon Anomura\",\"value\":\"", bowls[_tokenId] == true ? "true" : "false","\"}]""}"))
                )
        );
