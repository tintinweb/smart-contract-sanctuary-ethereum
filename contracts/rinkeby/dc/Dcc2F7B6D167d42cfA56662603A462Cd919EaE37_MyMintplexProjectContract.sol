...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664019180;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x01c3aeECAC9e2E056DA9166ee64650119167039b];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x01c3aeECAC9e2E056DA9166ee64650119167039b;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 33;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaw3hacwvjaxckvbvfvrk2xz2gac2omgutz7mgp4eys7lx4hbg43e/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 333");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 333");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 333");
...
contract MyMintplexProjectContract is RamppERC721A {
    constructor() RamppERC721A("My Mintplex Project", "MINTPLEX"){}
}
