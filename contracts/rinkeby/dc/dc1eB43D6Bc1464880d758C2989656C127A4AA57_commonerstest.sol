...
// File: contracts/Common test.sol
...
contract commonerstest is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmSB9rdsSny67by6DRKDXtxSYQwoetgtK64xQxPmUPsW7z";
    
    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmSB9rdsSny67by6DRKDXtxSYQwoetgtK64xQxPmUPsW7z";
    ...
    constructor() ERC721A("Bunner", "burn") { }
    ...
    */
    ...
    function teamMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= 5, "Team mints after free");
