...
contract FreeMint is ERC721URIStorage, Ownable {
    ...
    */
    ...
    function _setMaxPerTx (uint256 newMaxPerTx)
    public
    onlyOwner 
    {
        _maxMintPerTx = newMaxPerTx;
    }

    function _setMaxMintPerWallet (uint256 newPerWalletLimit)
    public
    onlyOwner 
    {
        _maxMintPerWallet = newPerWalletLimit;
    }
