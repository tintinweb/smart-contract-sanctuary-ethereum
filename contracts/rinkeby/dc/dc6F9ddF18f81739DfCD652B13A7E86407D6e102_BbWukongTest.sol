...
contract BbWukongTest is ERC721, Pausable, Ownable {
    using SafeMath for uint256;

    uint16[11] public ids;
    uint16 private index;
    uint256 public WL_PRICE = 0.088 ether;
    uint256 public constant MAX_PER_MINT = 1;
    string public baseTokenURI;
    // uint256 private freeMintStart = 1659916800;
    // uint256 private normalWhiteListStart = 1659960000;
    // uint256 private reservedWhiteListStart = 1660003199;
    // uint256 private endTime = 1660175999;
    uint256 private freeMintStart = 1659345406;
    uint256 private normalWhiteListStart = 1659349006;
    // uint256 private reservedWhiteListStart = 1659352606;
    ...
    constructor(string memory baseURI) ERC721("BbWukongTest", "BW") {
        setBaseURI(baseURI);
    }
    ...
    function _freeMint() private {
        require(block.timestamp > freeMintStart, "Time of mint hasn't begun!");
