...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new BluebitNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BluebitNFTUser721Token token = BluebitNFTUser721Token(address(addr));
...
contract BluebitNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
