...
contract SomeNewToken4 is ERC721A, Ownable, ReentrancyGuard {
  ...
  bool public multipleClaimsPerWallet = false;
...
//  }
  ...
  function setMultipleClaimsPerWallet(bool _state) public onlyOwner {
    multipleClaimsPerWallet = _state;
  }
