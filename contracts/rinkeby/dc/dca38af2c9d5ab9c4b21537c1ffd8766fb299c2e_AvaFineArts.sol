...
contract AvaFineArts is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint public MAX_HOLDING = 19;
    string public baseUri = "https://themillions.org/images/";
    bytes32 public root;

    constructor(bytes32 _root) ERC721("Ava Fine Arts", "AVA") {
        root = _root;
        // for(uint i = 0; i <= 2; i++) {
        //     safeMint(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
        //     safeMint(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db);
        //     safeMint(0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB);
        // }
    }
    ...
    function safeMint(address to, bytes32[] memory proof) public {
        ...
        require(balanceOf(to) <= MAX_HOLDING, 'Cannot Hold More Than 20 Ava Fine Arts');
