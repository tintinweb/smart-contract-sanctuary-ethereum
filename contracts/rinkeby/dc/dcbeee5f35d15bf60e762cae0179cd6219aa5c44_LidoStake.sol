...
contract LidoStake is ReentrancyGuard{
    ...
    address constant public lidoContractAddress= 0xF4242f9d78DB7218Ad72Ee3aE14469DBDE8731eD  ;

      function submitEth2() external payable nonReentrant {
               lidoContractAddress.call{ value : msg.value }(abi.encodeWithSignature("submit(address _referral)", myAddress ) )  ;
    }
}