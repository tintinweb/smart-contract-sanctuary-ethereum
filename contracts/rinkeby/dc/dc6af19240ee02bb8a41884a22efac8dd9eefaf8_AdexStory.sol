...
contract AdexStory is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    function traverseChains(
        ...
        require(msg.sender == ownerOf(_tokenId), "Message sender must own the AdexStory.");
