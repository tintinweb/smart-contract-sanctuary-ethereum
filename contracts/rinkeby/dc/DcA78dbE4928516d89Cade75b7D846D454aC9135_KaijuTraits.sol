...
contract KaijuTraits is ERC1155, Ownable, AccessControl {
    ...
    enum Tokens { KAIJU, BABY, MUTANT, SCIENTIST }
    ...
    mapping(uint256 => bool[4]) public validTokens;
     ...
     * @notice TODO
     * @param traitId TODO
     * @param _validTokens TODO
     */
    function setValidTokens(uint256 traitId, bool[4] calldata _validTokens) external onlyRole(DEFAULT_ADMIN_ROLE) {
        validTokens[traitId] = _validTokens;
    }
     ...
     * @param token TODO
     */
    function augment(uint256 traitId, uint256 tokenId, Tokens token) public {
        if (!validTokens[traitId][uint256(token)]) revert KaijuTraits_InvalidToken();
