...
contract DepositManager is OwnableUpgradeable, UUPSUpgradeable {
    ...
    uint256 public initialStorageSize;
    ...
    * @param _initialStorageSize value
    */
    function setInitialStorageSize(uint256 _initialStorageSize) public onlyOwner {
        initialStorageSize = _initialStorageSize;
    }
    ...
    */
    function changeCostOfStorage(uint256 newCost) public ManagerorOwner {
    ...
    */
    ...
    function updateStorage(
        ...
        if (!storageList[user].isKnownUser) {
            _updateAvailableStorage(user, initialStorageSize);
