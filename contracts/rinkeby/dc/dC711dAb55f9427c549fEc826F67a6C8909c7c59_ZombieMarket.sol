...
contract ZombieFactory is Ownable,ERC721URIStorage{
  ...
  function _createZombie(
    ...
    uint256 _defend,
    uint256 _save,
    uint256 _lucky) internal {
    zombies.push(Zombie(_id,_speed, _shoot, _defend, _save,_lucky,1,"null","null","null",false));
  }
  ...
  function createZombie() public{
    ...
    uint256 randSpeed = _generateRandomDna(49,100,newItemId,"Speed");
    uint256 randShoot = _generateRandomDna(49,100,newItemId,"Shoot");
    uint256 randDefend = _generateRandomDna(49,100,newItemId,"Defend");
    uint256 randSave = _generateRandomDna(49,100,newItemId,"Save");
    uint256 randLucky = _generateRandomDna(49,100,newItemId,"Lucky");
    _createZombie(newItemId,randSpeed,randShoot,randDefend,randSave,randLucky);
  ...
  function randomVocation(uint256 _id,string memory _str) public {
    zombies[_id].vocation = _str;
  }

  function randomRlevel(uint256 _id,string memory _str) public {
    zombies[_id].rlevel = _str;
  }

  function randomURI(uint256 _id,string memory _str) public {
    zombies[_id].tokenURI = _str;
  }
