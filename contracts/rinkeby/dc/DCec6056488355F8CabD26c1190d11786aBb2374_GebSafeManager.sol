...
// hevm: flattened sources of /nix/store/q8si6nn8xqgp2xvmmsxryaxadnp7m3l9-geb-safe-manager/dapp/geb-safe-manager/src/GebSafeManager.sol
pragma solidity =0.6.7;

////// /nix/store/q8si6nn8xqgp2xvmmsxryaxadnp7m3l9-geb-safe-manager/dapp/geb-safe-manager/src/GebSafeManager.sol
...
contract SAFEHandler {
    constructor(address safeEngine) public {
        SAFEEngineLike_12(safeEngine).approveSAFEModification(msg.sender);
    }
}
...
contract GebSafeManager {
    ...
    function modifySAFECollateralization(
        ...
        SAFEEngineLike_12(safeEngine).modifySAFECollateralization(
    ...
    function transferCollateral(
        ...
        SAFEEngineLike_12(safeEngine).transferCollateral(collateralTypes[safe], safes[safe], dst, wad);
    ...
    function transferCollateral(
        ...
        SAFEEngineLike_12(safeEngine).transferCollateral(collateralType, safes[safe], dst, wad);
        emit TransferCollateral(
            msg.sender,
            collateralType,
            safe,
    ...
    function transferInternalCoins(
        ...
        SAFEEngineLike_12(safeEngine).transferInternalCoins(safes[safe], dst, rad);
    ...
    function quitSystem(
        ...
        (uint lockedCollateral, uint generatedDebt) = SAFEEngineLike_12(safeEngine).safes(collateralTypes[safe], safes[safe]);
        int deltaCollateral = toInt(lockedCollateral);
        int deltaDebt = toInt(generatedDebt);
        SAFEEngineLike_12(safeEngine).transferSAFECollateralAndDebt(
            collateralTypes[safe],
            safes[safe],
            dst,
            deltaCollateral,
    ...
    function enterSystem(
        ...
        (uint lockedCollateral, uint generatedDebt) = SAFEEngineLike_12(safeEngine).safes(collateralTypes[safe], src);
        int deltaCollateral = toInt(lockedCollateral);
        int deltaDebt = toInt(generatedDebt);
        SAFEEngineLike_12(safeEngine).transferSAFECollateralAndDebt(
            collateralTypes[safe],
    ...
    function moveSAFE(
        ...
        (uint lockedCollateral, uint generatedDebt) = SAFEEngineLike_12(safeEngine).safes(collateralTypes[safeSrc], safes[safeSrc]);
        int deltaCollateral = toInt(lockedCollateral);
        int deltaDebt = toInt(generatedDebt);
        SAFEEngineLike_12(safeEngine).transferSAFECollateralAndDebt(
    ...
    function protectSAFE(
        ...
        LiquidationEngineLike_3(liquidationEngine).protectSAFE(
            collateralTypes[safe],
            safes[safe],
            saviour
        );
