...
contract ERC1155TokenBMP is ERC1155, BaseERC1155Burnable, BaseERC1155Mintable, BaseERC1155Pausable {
...
contract ERC1155Token is ERC1155 {
    ...
    constructor(
        ...
        require(owners_.length == tokenIds_.length, 'Lengths of owners and tokenIds is not equals');
        require(tokenIds_.length == amounts_.length, 'Lengths of tokenIds and amounts is not equals');
        for (uint8 i = 0; i < owners_.length; ++i) {
            _mint(owners_[i], tokenIds_[i], amounts_[i], '');
        }
    }
...
abstract contract BaseERC1155Burnable is ERC1155Burnable {
