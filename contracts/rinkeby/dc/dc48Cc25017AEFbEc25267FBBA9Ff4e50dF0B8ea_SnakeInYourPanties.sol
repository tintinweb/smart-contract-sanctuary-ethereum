...
contract SnakeInYourPanties is ERC2981, ERC721A, Ownable {
    using Address for address payable;
    using ECDSA for bytes32;
    using Strings for uint256;

    uint32 public immutable _freeMintAmount = 1;
    uint256 public immutable _freeMintTime = 1 minutes;
    uint256 public immutable _mintPrice = 1 ether;
    uint32 public immutable _txsssssLimit = 10;
    uint32 public immutable _maxSsssssssupply = 10000;
    uint32 public immutable _giftSssssssupply = 500;
    uint32 public immutable _walletLimit = 10;

    bool public _sssssssssstarted;
    string public _metadataURI =
        "https://gateway.pinata.cloud/ipfs/QmRs8QdgzGxFqtU5hsLVpEwYTxoRbYJdhJjXWLLAKg58PB/";
    ...
    constructor() ERC721A("SNAKOO", "SNKO") {
        ...
        payable
    {
        ...
        require(
            _amount + _totalMinted() <= _maxSsssssssupply - _giftSssssssupply,
            "Max supply exceeded"
        );
