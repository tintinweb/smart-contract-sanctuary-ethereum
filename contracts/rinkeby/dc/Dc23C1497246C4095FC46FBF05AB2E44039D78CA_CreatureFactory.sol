...
contract Creature is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("HYM Mermaid 20220701", "HYMC", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://cryptic-escarpment-21016.herokuapp.com/api/creature/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://cryptic-escarpment-21016.herokuapp.com/contract/opensea-creatures";
    }
}
...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://cryptic-escarpment-21016.herokuapp.com/api/factory/creature/";
    ...
    function name() override external pure returns (string memory) {
        return "HYMCreature Item Sale 20220701";
    }
...
contract CreatureLootBox is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("HYMCreatureLootBox", "HYMLBOX", _proxyRegistryAddress)
    {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://cryptic-escarpment-21016.herokuapp.com/api/box/creature/";
    }
