...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("Love Sex Robots", "LSR") {}
    ...
    function mint() public payable {
        require(_totalSupply < NUMBER_OF_TOKENS, "All tokens minted");
        require((msg.sender == owner()) || (msg.value >= priceForMe()), "Insufficient funds");

        _safeMint(msg.sender, _getRandomIndex());
        ++_totalSupply;
