...
//        uint256[] memory howBased_
        ...
        ERC721StorageProto(storageLayerAddress).registerTopLevel(name_, symbol_, description_, image_);

        setStorageLayer(storageLayerAddress);
...
//        storageLayer.storage_safeMint(msg.sender, to, quantity);
//    }
//
//    function safeMint(address to, uint256 quantity, bytes memory _data) internal {
//        storageLayer.storage_safeMint(msg.sender, to, quantity, _data);
//    }
//
//    function mint(address to, uint256 quantity) internal {
//        storageLayer.storage_mint(msg.sender, to, quantity);
//    }

    function tokenURI(uint256 tokenId) public view returns (string memory) {
        return storageLayer.storage_tokenURI(address(this), tokenId);
    }
...
abstract contract ERC721StorageProto {
    ...
    function storage_tokenURI(address collection, uint256 tokenId) public view virtual returns (string memory);
