...
contract PresaleFactory is Ownable {
    ...
    uint256 public minCap                                           = 625 * 10 ** 2 * 10 ** 18;
    uint256 public maxCap                                           = 125 * 10 ** 3 * 10 ** 18;
    uint256 public pTokenPrice_USDC                                 = 8 * 10 ** 15;
    uint256 public pTokenPrice_AVAX                                 = 954996 * 10 ** 10;
    ...
    function presale(uint256 _amountToken, uint cType) external payable {
        ...
        if (cType == 0) {                               // buy using AVAX
            ...
            usdcAddress.transferFrom(msg.sender, presaleOwnerAddress, _amountToken / 10 ** 18 * pTokenPrice_USDC);
        }
