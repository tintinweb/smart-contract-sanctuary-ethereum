        ...
        string memory json = Base64.encode(
            bytes(string(
                abi.encodePacked(
                    ...
                    '"image_data": "', attributes[tokenId].imageURI, '",',
                    '"attributes": [{"trait_type": "Contact", "value": ', Strings.toString(attributes[tokenId].contact), '},',
                    '{"trait_type": "Power", "value": ', Strings.toString(attributes[tokenId].power), '},',
                    '{"trait_type": "Base Running", "value": ', Strings.toString(attributes[tokenId].run), '},',
                    '{"trait_type": "Throwing", "value": ', Strings.toString(attributes[tokenId].throwing), '},',
                    '{"trait_type": "Defence", "value": ', Strings.toString(attributes[tokenId].defence), '},',
                    ']}'
                )
            ))
        );
