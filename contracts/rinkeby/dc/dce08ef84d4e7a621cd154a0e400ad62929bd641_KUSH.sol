...
contract KUSH is ERC20 {
    ...
    KUSHDividendTracker public dividendTracker;

    address public liquidityWallet;
    address payable public marketingAddress = 0xaa7C432Df1503B8CD4fF85ada7b89301d67116FE;
    ...
    constructor() public ERC20("KUSH", "KUSH") {
    	...
    	dividendTracker = new KUSHDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        KUSHDividendTracker newDividendTracker = KUSHDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the KUSH token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "KUSH: Account is already the value of 'excluded'");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "KUSH: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue != gasForProcessing, "KUSH: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(
            ...
            uint256 MarktingTokens = contractTokenBalance.mul(MarketingFee).div(totalFees);
            sendETHToWallets(MarktingTokens);
...
contract KUSHDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("KUSH_Dividend_Tracker", "KUSH_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "KUSH_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "KUSH_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main KUSH contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "KUSH_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "KUSH_Dividend_Tracker: Cannot update claimWait to same value");
