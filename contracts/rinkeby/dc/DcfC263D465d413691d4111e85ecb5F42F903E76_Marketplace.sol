...
contract Marketplace is AccessControl {
    ...
    function getPlayerInfo(address _player) public view returns (PlayerInfo memory, uint256[] memory, uint256[] memory){
        return (playerInfo[_player], playerInfo[_player].addOns, playerInfo[_player].oldNFTs);
    } 
