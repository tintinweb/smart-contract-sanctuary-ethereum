...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xcdc6a7b20E757D68345C31cEb10511675A013d26];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmScA2dEoxXVwZD7dXjxHbvJvxe89J4qYfDeCRH47rjn4X/";
...
// File: contracts/TestsdogContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestsdogContract is RamppERC721A {
    constructor() RamppERC721A("tests dog", "tdog"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/1d0DVR90Ss59Ka6tXjyE/contract-metadata";
    }
}
