...
contract DD is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public freeMint = 0 ether;
  ...
  function mint(uint256 _mintAmount) public payable {
      ...
      if (totalSupply()+_mintAmount <= maxFreeMint){
          require(!paused, 'The contract is paused!');
          require(_mintAmount > 0, 'Invalid mint amount!');
          require(msg.value >= freeMint + _mintAmount, "Insufficient funds!");
          require(addressToMintedAmount[msg.sender] + _mintAmount <= maxFreeMint, "DoodleDoge: Exceeded mint per wallet");
        }
