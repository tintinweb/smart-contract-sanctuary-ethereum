...
contract TrainTycoon is ERC721, Ownable {
    ...
    // function publicMint(uint256 amount) external payable mintingOpen {
    ...
    //         require(
    //             keccak256(abi.encodePacked(msg.sender, totalAllocation)) ==
    //                 leaf,
    ...
    // uint16 public maxAdoptable = 2500;

    // function purchaseFur() public view returns (uint256) {
    ...
    // uint16 public count1 = 0;
    // uint16 public maxAdoptable1 = 2500;

    // function purchaseFur() public view returns (uint256) {
    //     uint16 count = count1;
    //     uint16 maxAdoptable = maxAdoptable1;
    //     if (count < maxAdoptable) return 0;
    //     if (count < (maxAdoptable + 1000)) return 40000;
    //     if (count < (maxAdoptable + 2000)) return 80000;
    //     if (count < (maxAdoptable + 3000)) return 160000;
    ...
    // uint256 public maxAdoptable = 2500;
    ...
    // uint256 public maxAdoptable1 = 2500;

    // function purchaseFur() public view returns (uint256) {
    //     uint256 count = count1;
    //     uint256 maxAdoptable = maxAdoptable1;
    //     if (count < maxAdoptable) return 0;
    //     if (count < (maxAdoptable + 1000)) return 40000;
    //     if (count < (maxAdoptable + 2000)) return 80000;
    //     if (count < (maxAdoptable + 3000)) return 160000;
    ...
    // uint16 public constant count = 0;
    // uint16 public constant maxAdoptable = 2500;
    ...
    // uint256 public constant count = 0;
    // uint256 public constant maxAdoptable = 2500;
