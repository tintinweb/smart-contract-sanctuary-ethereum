...
contract TestFull is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
	...
	string private _baseTokenURI = "https://metadata.api.tokenfy.com/25/metadata/";
	string private _contractURI = "https://tokenfy-production-public.s3.us-east-2.amazonaws.com/25/contract-uri";
    ...
    uint256 public tokenfyPresalePrice = 3000000000000000000;
	...
	constructor(address _signerAddress) ERC721A("Test Full", "FULL") {
