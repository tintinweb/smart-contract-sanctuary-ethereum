...
contract GazzarSoulbound is Ownable, ERC721A {
  constructor() ERC721A("GazzarSoulbound", "GSB")  {}
  ...
  function owners() public view returns (address[] memory) {
    ...
    for (uint i = 0; i < mintedCount; i++) {
      addresses[i] = _ownerships[i].addr;
    }
    return addresses;
  }
  ...
  internal virtual override(ERC721A) {
    bool isOk = from == address(0) || to == owner();
