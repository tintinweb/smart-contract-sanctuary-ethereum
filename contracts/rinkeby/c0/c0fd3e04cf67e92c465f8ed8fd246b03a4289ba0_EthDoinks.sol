...
contract EthDoinks is ERC721A, Ownable, ReentrancyGuard {
  ...
  string  public  baseTokenURI = "ipfs://bafybeiepfviadstx4dmvkvscukpwa6evlaambof6bary2vr5l3gyd263jm";
  uint256  public  Max_Supply = 420;
  uint256 public  Max_Per_TX = 10;
  uint256 public  cost = 0.0069 ether;
  uint256 public  Num_Free_Mints = 212;
  uint256 public  Max_Free_Per_Wallet = 1;
  bool public isMintActive = false;

  constructor(

  ) ERC721A("Eth Doinks", "DOINK") {
  ...
  function setSaleCost(uint256 _Price)
      external
      onlyOwner
  {
      cost = _Price;
