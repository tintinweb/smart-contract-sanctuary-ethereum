    ...
    RefundEnabled
{
    ...
    modifier requiresActiveSale() {
        require(saleActive, "AFFC: Sale is not active");
        _;
    }
    ...
    function mint() external payable requiresActiveSale {
        // solhint-disable-next-line reason-string
        require(
            totalSupply() + 1 <= MAX_SUPPLY,
            "AFFC: Almost Fancy Founders Passes have been sold out"
        );
        // solhint-disable-next-line reason-string
        require(
        ...
        RefundEnabled.refundIfOver(mintPrice);
    }
