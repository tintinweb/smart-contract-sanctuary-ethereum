...
contract TasteTimonials is Ownable, ERC721, Pausable {
    ...
    uint256 public constant TOTAL_SUPPLY = 33;
    uint256 public constant PUBLIC_MINT_PRICE = 0.02 ether;
    uint256 public constant PRESALE_MINT_PRICE = 0.015 ether;
    string public baseURI;

    uint256 public currentTokenId;
    bool public isPublicMint;

    mapping(address => bool) internal isPublicMinted;
    ...
    function setWhitelist(address[] calldata _address, bool[] calldata _status) external onlyOwner {
      require(_address.length == _status.length, 'UNMATCH');
