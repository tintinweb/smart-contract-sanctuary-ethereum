...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8644A3A38f907F570e31E8f1d150ACfc639AeE23];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 1234 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdB8r1FktkV26UGrYxsBTFqYHhadUkKWs3keB7WnwmWFy/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1234");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1234");
...
// File: contracts/CummcheeseNftsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CummcheeseNftsContract is RamppERC721A {
    constructor() RamppERC721A("Cummcheese Nfts", "CUMM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/WmHDdr3bSDADFATZgGqm/contract-metadata";
    }
}
