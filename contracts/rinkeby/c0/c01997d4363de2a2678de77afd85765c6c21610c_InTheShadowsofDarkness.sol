...
contract InTheShadowsofDarkness is Ownable, ERC721A, ReentrancyGuard {

    bool public publicSale = false;

    uint256 public maxPerTx = 2;
    uint256 public maxPerAddress = 3;
    uint256 public maxFreePerAddress = 5;
    uint256 public maxToken = 5000;
    uint256 public price = 0.01 ether;

    string private _baseTokenURI;

    bool private freeMints = true;
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        if(freeMints){
            if(freeMinted[msg.sender] >= maxFreePerAddress){
    ...
    function setMaxFreePerAddress(uint256 newMaxFreePerAddress) external onlyOwner {
        maxFreePerAddress = newMaxFreePerAddress;
    }
    ...
    function swutchFreeMints() external onlyOwner {
        freeMints = !freeMints;
    }
