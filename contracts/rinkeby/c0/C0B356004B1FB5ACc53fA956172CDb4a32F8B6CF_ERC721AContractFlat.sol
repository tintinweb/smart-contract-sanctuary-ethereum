...
contract ERC721AContractFlat is ERC721A, ReentrancyGuard, Ownable {
    ...
    address payable private wentMintAddress = payable(0xb0D8fC9663eE085A664309a631c2EdaA7458682a);
    uint8 private wenmintShare = 10;
