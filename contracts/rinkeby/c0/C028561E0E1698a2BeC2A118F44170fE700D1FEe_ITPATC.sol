...
interface IERC20 {
	...
	function transferFrom(address _from, address _to, uint256 amount) external returns (bool success);
}
...
abstract contract ERC20 is IERC20 {
    ...
    function _burn(address from, uint amount) internal {
        ...
        require(amount <= _balances[from], "burn amout exceeds balance");
...
contract ITPATC is ERC20 {
	constructor() ERC20("ITPAT Coin","ITPATC") {
