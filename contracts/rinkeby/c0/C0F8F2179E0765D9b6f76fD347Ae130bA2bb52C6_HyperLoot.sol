...
contract HyperLoot is ERC721, IERC2981, ReentrancyGuard, Ownable{
	...
	// Loot Contract
	address private lootAddress = 0xCb224B1058fbF86cf420C059fab0B8f59A545820;
	LootInterface lootContract = LootInterface(lootAddress);

	// More Loot Contract
	address private mlootAddress = 0xab57df3ab4cE6fe5FB3dFeA16cd10e3710fC3fEf;
	MLootInterface mlootContract = MLootInterface(mlootAddress);

	// Genesis Adventurer Contract
	address private gaAddress = 0xD9f80D8e99980e3D1610d3f3743F1c69CC7a06BD;
	...
	constructor() ERC721("HyperLoot", "HYPER") {}
