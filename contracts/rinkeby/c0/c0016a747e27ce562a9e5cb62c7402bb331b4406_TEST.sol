...
contract TEST is Context, IERC20, Ownable {
	...
	uint256 private _maxWallet= 100000000000000 * 10**9;
	...
	function LIFTMAXTXN(uint256 amount) public onlyOwner{
