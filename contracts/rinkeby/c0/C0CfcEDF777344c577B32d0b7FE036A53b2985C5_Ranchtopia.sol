...
contract Ranchtopia is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) {
    ...
    uint256 mintedCount = whitelistMintedBalance[msg.sender];
    require(mintedCount + _mintAmount <= maxMintAmountPerTx, "Max Ranchtopians Minted"); 
