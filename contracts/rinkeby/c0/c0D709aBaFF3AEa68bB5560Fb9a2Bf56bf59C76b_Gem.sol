...
contract Gem is Context, IERC20, Ownable {
    ...
    string private constant _name = "xGEMx";
    string private constant _symbol = "xGEMx";
    ...
    address payable private _developmentAddress = payable(0x00D6f8286443d43671Ab2e42402CB81178fA6E5f); 
    address payable private _marketingAddress = payable(0x00D6f8286443d43671Ab2e42402CB81178fA6E5f);
    ...
    uint256 public _maxTxAmount = _tTotal.mul(1).div(100); //1%
    uint256 public _maxWalletSize = _tTotal.mul(2).div(1000); //4.20%
    uint256 public _swapTokensAtAmount = _tTotal.mul(2).div(1000); //0.2%
    ...
    constructor() {
        ...
        _isExcludedFromFee[0x71B5759d73262FBb223956913ecF4ecC51057641] = true;//pinklock
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 11, "Buy tax must be between 0% and 11%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 0, "Sell rewards must be between 0% and 0%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 11, "Sell tax must be between 0% and 11%");
