...
contract Meta is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public cost = 0.047 ether; // CHANGE ME LATER
    uint256 public maxSupply = 2977; // CHANGE ME LATER 
    uint256 public PRESALE_LIMIT = 1000; //SET LATER
    bool public saleIsActive = true; // CHANGE ME LATER
    ...
    function safeMint(uint numberOfTokens) external payable {
        ...
        require(totalSupply() + (numberOfTokens) <= PRESALE_LIMIT, "Purchase would exceed max supply of this Metaspace Dudes batch");
