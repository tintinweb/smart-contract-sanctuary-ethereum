...
contract GenTT is Pausable, ERC721URIStorage, Ownable {
    ...
    function whitelistMint(bytes32[] calldata _merkleProof, uint256 amount) public payable{
        require(purchaseTxs[msg.sender] < maxPerTx , "max tx amount exceeded");
    ...
    function _purchase(uint256 amount) private {
        ...
        require(supply.current() + amount <= MAX_SUPPLY, "Purchase: Max supply reached");
    ...
    if (!revealed) {
      return "https://gateway.pinata.cloud/ipfs/QmendDTwzukUDoTkPXaJL7Q5f2gmqXRtbcTPhCbtJ96t77";
    }
