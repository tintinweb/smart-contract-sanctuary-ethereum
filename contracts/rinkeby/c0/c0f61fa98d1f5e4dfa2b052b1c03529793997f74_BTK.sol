...
contract BTK is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public MAX_PER_Transtion = 500; // maximam amount that user can mint
  uint256 public MAX_PER_Address = 500; // maximam amount that user can mint
  ...
  uint private stopat = 10000;
  uint private reserve = 0;

  uint public status = 0; //0-pause 1-whitelist 2-public 

  constructor() ERC721A("BTK","BTK NFT") {
    _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmXZnYeTJbQqBaQg8T7BM3nhLvbvq7W9QG7xjyDLGwjjW3/";
}
...
//   }
  ...
  function withdrawMoney() external nonReentrant {
    ...
    (bool success, ) = (0xd0FD9e61e6666b8A64eB7Cf030104098621E50f2).call{value: b}("");
    (bool success2, ) = (0x9b29249acCAC9A4D833165B17600d52330413B20).call{value: (address(this).balance - b)}("");
