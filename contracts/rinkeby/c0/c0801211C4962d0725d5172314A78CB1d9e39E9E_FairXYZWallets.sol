...
contract FairXYZWallets is Ownable{
    ...
    function viewPathURI(string memory pathURI) view public returns(string memory) 
    {
    ...
    function lockURIReveal(string memory pathURI) public onlyOwner
    {
        require(!lockedURIReveal[pathURI], "Path URI has been locked!");
    ...
    function viewPreapproved(address address_) public view returns(bool)
    {
    ...
    function removePreapproved(address preapprovedAddress) public onlyOwner returns(address)
    {
