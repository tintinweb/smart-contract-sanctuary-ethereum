...
IERC20 public ethAddress;
    ...
    function swapeth1toBmT(uint amount) public {
       ...
       uint _amount=(amount *  tokenPrice ) *10**18;
       ethAddress.transferFrom(msg.sender,msg.sender,amount);
    ...
    function swapBmTToEth(uint amount) public {
        ...
        uint _amount=(amount/(tokenPrice  *10**18)) *10**18;
        token.transferFrom(msg.sender,address(this),amount);
        ethAddress.transfer(msg.sender,_amount);
