...
contract Staking is Ownable {
    ...
    function _stake(address _ref) public {
        
    }

    // msg.value = stakeAmounts + (Fee: 5% stakeAmounts)
    function stakeUsdt(address _ref) public {
    ...
    function stakeEth(address _ref) public payable {
        require(inputToken == TokenType.eth, "You should stake with usdt");
        require(_ref != address(0), "you should have referral address");
