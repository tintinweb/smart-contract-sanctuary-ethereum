...
contract ShibCoOpPETCollection is IERC721Metadata, ERC721Enumerable, Ownable {
    ...
    string private contractMetaUri = "ipfs://QmcUQaERtHpErpvurJnRdCWYQq8ockQUrKWep286p2XPXp";
    ...
    constructor() ERC721("Final PET TEST", "TEST") {
    }
    ...
    function presaleShib() public qtyAvailable(1) {
        ...
        shibToken.transferFrom(_msgSender(), address(this), 100000 * 10 ** 18);
