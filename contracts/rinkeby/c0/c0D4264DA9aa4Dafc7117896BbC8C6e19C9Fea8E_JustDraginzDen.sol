...
contract JustDraginzDen is ERC721, Ownable, ProxyRegistry, RandomlyAssigned {
  ...
  ERC721("Just Draginz Den", "JDD") 
  RandomlyAssigned(maxSupply,1) // Max 7777 NFTs available; start counting from 1
  {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= presaleAmountLimit, "Invalid mint amount!");
 ...
 function walletOfOwner(address _owner)
  ...
  function teamMint() external onlyOwner{
    require(!teamMinted, "Just Draginz Den :: Team Already Minted!");
    teamMinted = true;
    _safeMint(msg.sender, 1111);
  }
