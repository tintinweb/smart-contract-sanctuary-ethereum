...
contract ConcreteJungle is ERC721, Ownable {
    ...
    constructor() payable ERC721("ConcreteJungle", "COJU") {
        mintPrice = 0.001 ether;
        totalSupply = 0;
        // set withdraw address owner;
    ...
    function setWithdrawAddress(address payable _withdrawWallet)
        external
        onlyOwner
    {
