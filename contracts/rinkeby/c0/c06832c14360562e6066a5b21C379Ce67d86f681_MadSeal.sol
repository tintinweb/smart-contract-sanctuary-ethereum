...
contract MadSeal is ERC721A,Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Mad Seal","MST",maxPerWallet,MAX_SUPPLY) {
    }
    ...
    function Mint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(totalSupply() + quantity <= 7000, "Purchase would exceed max supply");
