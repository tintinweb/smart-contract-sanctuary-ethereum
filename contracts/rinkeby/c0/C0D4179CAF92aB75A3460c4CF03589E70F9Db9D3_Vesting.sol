...
contract Vesting is Ownable {
    ...
    function _init() internal virtual {
        rounds.push(
            Round({
                name: 'private',
                lockPeriod: 0,
                amountOnUnlockX10000: 7_00,
                cliffPeriod: 30 days,
                linearUnit: 1 weeks,
                amountPerUnitX10000: 2_50
            })
        );
        rounds.push(
            Round({
                name: 'public',
                lockPeriod: 5 days,
                amountOnUnlockX10000: 3_50,
                cliffPeriod: 30 days,
                linearUnit: 30 days,
                amountPerUnitX10000: 5_00
            })
        );
    }
    ...
    function start() external onlyOwner {
        require(startTimestamp > block.timestamp, 'Already strated');
    ...
    function claim(uint256[] calldata allocations, bytes32[] calldata proof)
        external
        isStarted
    {
