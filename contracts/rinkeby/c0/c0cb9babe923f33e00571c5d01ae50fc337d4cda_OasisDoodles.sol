...
contract OasisDoodles is Ownable, ERC721 {
    
    uint public tokenPrice = 0.01 ether;
    uint constant maxSupply = 3333;
    uint public presale_price = 0.01 ether;
    ...
    constructor() ERC721("Oasis Doodles", "Odoodles"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xCc112430769410c4219dd99BA6F6d71794335bC5).transfer(_balance * 90 / 100); 
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 10 / 100); 
    }
