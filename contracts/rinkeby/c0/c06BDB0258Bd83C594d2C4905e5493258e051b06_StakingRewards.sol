    ...
    ReentrancyGuardUpgradeable
{
    ...
    /// @inheritdoc IStakingRewards
    function pendingYieldFor(address _who, uint256 _tokenId) external view virtual returns (uint256) {
        return stakedBonds[_who][_tokenId].earnedYield(yieldPerToken());
    }

    /// @inheritdoc IStakingRewards
    function pendingRevDisFor(address _who, uint256 _tokenId) external view virtual returns (uint256) {
