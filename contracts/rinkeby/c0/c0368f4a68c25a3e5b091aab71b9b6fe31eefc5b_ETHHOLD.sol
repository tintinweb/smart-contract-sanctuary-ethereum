...
contract ETHHOLD is ERC20, Ownable {
    ...
    ) ERC20("ETHHOLD", "ETHHOLD") Ownable(msg.sender) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        // checks if contractTokenBalance >= 1000 ETHOLD and swaps it for ETH inside _swap function
        ...
        uint256 send = amount;  // i.e: 1000 ETHOLD 
        uint256 reflect;
        uint256 marketing;
