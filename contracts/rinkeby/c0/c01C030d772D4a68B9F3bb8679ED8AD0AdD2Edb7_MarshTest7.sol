...
contract MarshTest7 is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    string private _baseTokenURI = "https://lolprodstorage.blob.core.windows.net/mm-metadata-revealed/";
    bytes32 root;
    ...
    constructor(address _lolTestAddress, address[8] memory _addresses, uint256[8] memory _shares) ERC721A("MarshTest7", "MT7") {
