...
contract TrueTest is ERC721A, Ownable {
  ...
  uint256 public constant claimableTokensCount = 60;
  uint256 public partnerReserve = 50;
  uint256 public teamReserve = 19;
  ...
  address public teamAddress = 0x44E9eC3E7c578fd2E1a662E05837Eae6997d8Cb9;
  address private partnerAddress = 0x5d6788c1609f06A2C895a198e82cFc7a15Ca0dc5;

  constructor(bytes32 _allowlistMerkleRoot, bytes32 _ogMerkleRoot, string memory _coverURI) 
    ERC721A("True Test", "TRUETEST") {
      coverURI = _coverURI;
  ...
  // MODIFIERS
  modifier isOgsale() {
    require(ogSale, 'Presale is not started!');
    _;
  }
  ...
  modifier isPublicSale() {
    require(publicSale, 'Public is sale not started!');
    _;
  }
  ...
  // FUNCTIONS SETTERS
   function setOgSale(bool _status) external onlyOwner {
    ogSale = _status;
  }
  ...
  function setPublicSale(bool _isRevealed) external onlyOwner {
    publicSale = _isRevealed;
  }
