...
contract UniswapV3LiquidityChanger {
    ...
    function getAmount0(address npm, uint256 tokenId) public view returns (uint256 amount0) {
        console.log('getAmount0 %s', tokenId);
         ( , , , , ,
            int24 tickLower,
            int24 tickUpper,
            uint128 liquidity, , , ,
    ...
    function getAmount1(address npm, uint256 tokenId) public view returns (uint256 amount1) {
        ( , , , , ,
            int24 tickLower,
            int24 tickUpper,
            uint128 liquidity, , , ,
    ...
    function getAmounts(address npm, address poolAddress, uint256 tokenId)
        ...
        console.log('getAmounts %s', tokenId);
        (
            uint160 sqrtPriceX96, , , , , ,
