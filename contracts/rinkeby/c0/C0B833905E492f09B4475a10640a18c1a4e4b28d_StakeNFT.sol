...
contract StakeNFT {
    ...
    //State variabble
    uint private _stakingId = 1;
    address private NFTToken = 0x9ae993e859f45Fd7FE80bF2f89da7807B8FA7E62;
    address private REWARDToken = 0xE794d1D8ff4B4337d95F55b6b9c345F8942a713f;
    ...
    function callStakeToken(address token, uint _tokenID) public {
        require(token == 0x9ae993e859f45Fd7FE80bF2f89da7807B8FA7E62, "incorrect NFT to stake"); // hardcode the NFT smart contract to allow only specific NFT into staking, assume 0xd2...d005 as NFT contract address
