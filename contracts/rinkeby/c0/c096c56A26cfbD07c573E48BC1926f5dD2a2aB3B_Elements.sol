...
contract Elements is ERC721Enumerable, Ownable {
   ...
   // uint32 basicElementFreeMintCap = 24;
   ...
   // mapping(address => uint256) public freeMintAddresses;
    ...
    constructor() ERC721("Elements", "Elements") {
         ...
         bytes memory description=abi.encodePacked("basic element");
         elements["1"] = Element({name: "Fire", parents:  _parents,supply: 0,supplyMass:0, tier:0, description:description});
         elements["2"] = Element({name: "Water", parents:  _parents,supply: 0, supplyMass:0, tier:0, description:description});
         elements["3"] = Element({name: "Air", parents:  _parents,supply: 0,supplyMass:0, tier:0, description:description});
         elements["4"] = Element({name: "Earth", parents:  _parents,supply: 0,supplyMass:0, tier:0, description:description});
         /*
         preMintAddresses[0x61A891BD354dA4A63c24e62E254EFF0671aEFf44] = basicElementPreMintCap;
         preMintAddresses[0x7E381e51Dcb355C3eaE7003F1666F863eeE5B50a] = basicElementPreMintCap;
        ...
        elements["M"] = Element({name: "M Creature", parents: _parents2,supply: 0,supplyMass:0, tier:1, description:"test"});
        ...
        elements["L"] = Element({name: "L Creature", parents: _parents3,supply: 0,supplyMass:0, tier:1, description:"test"});
        elementIds.push(bytes1('L'));

        bytes1[] memory _parents4=new bytes1[](2);
        _parents4[0]=bytes1('2');
        _parents4[1]=bytes1('4');
        elements["E"] = Element({name: "E Creature", parents: _parents4,supply: 0,supplyMass:0, tier:1, description:"test"});
        ...
        elements["D"] = Element({name: "D Creature", parents: _parents5,supply: 0,supplyMass:0, tier:1, description:"test"});
        ...
        elements["F"] = Element({name: "F Creature", parents: _parents7,supply: 0,supplyMass:0, tier:2, description:"test"});
        ...
        elements["O"] = Element({name: "O Creature", parents: _parents8,supply: 0,supplyMass:0, tier:2, description:"test"});
        elementIds.push(bytes1('O'));

        bytes1[] memory _parents9=new bytes1[](2);
        _parents9[0]=bytes1('D');
        _parents9[1]=bytes1('2');
        elements["J"] = Element({name: "J Creature", parents: _parents9,supply: 0,supplyMass:0, tier:2, description:"test"});
        elementIds.push(bytes1('J'));

        bytes1[] memory _parents10=new bytes1[](2);
        _parents10[0]=bytes1('E');
        _parents10[1]=bytes1('1');
        elements["H"] = Element({name: "H Creature", parents: _parents10,supply: 0,supplyMass:0, tier:2, description:"test"});
        elementIds.push(bytes1('H'));

        bytes1[] memory _parents11=new bytes1[](2);
        _parents11[0]=bytes1('E');
        _parents11[1]=bytes1('D');
        elements["C"] = Element({name: "C Creature", parents: _parents11,supply: 0,supplyMass:0, tier:2, description:"test"});
        elementIds.push(bytes1('C'));

        bytes1[] memory _parents12=new bytes1[](2);
        _parents12[0]=bytes1('M');
        _parents12[1]=bytes1('L');
        elements["G"] = Element({name: "G Creature", parents: _parents12,supply: 0,supplyMass:0, tier:2, description:"test"});
        elementIds.push(bytes1('G'));

        bytes1[] memory _parents13=new bytes1[](2);
        _parents13[0]=bytes1('C');
        _parents13[1]=bytes1('G');
        elements["N"] = Element({name: "N Creature", parents: _parents13,supply: 0,supplyMass:0, tier:3, description:"test"});
        elementIds.push(bytes1('N'));

        bytes1[] memory _parents14=new bytes1[](2);
        _parents14[0]=bytes1('O');
        _parents14[1]=bytes1('H');
        elements["K"] = Element({name: "K Creature", parents: _parents14,supply: 0,supplyMass:0, tier:1, description:"test"});
        elementIds.push(bytes1('K'));

        bytes1[] memory _parents15=new bytes1[](2);
        _parents15[0]=bytes1('F');
        _parents15[1]=bytes1('J');
        elements["I"] = Element({name: "I Creature", parents: _parents15,supply: 0,supplyMass:0, tier:1, description:"test"});
        elementIds.push(bytes1('I'));

        bytes1[] memory _parents16=new bytes1[](2);
        _parents16[0]=bytes1('N');
        _parents16[1]=bytes1('K');
        elements["A"] = Element({name: "A Creature", parents: _parents16,supply: 0,supplyMass:0, tier:1, description:"test"});
        elementIds.push(bytes1('A'));

        bytes1[] memory _parents17=new bytes1[](2);
        _parents17[0]=bytes1('N');
        _parents17[1]=bytes1('I');
        elements["B"] = Element({name: "B Creature", parents: _parents17,supply: 0,supplyMass:0, tier:1, description:"test"});
    ...
    function fusion (uint256[] memory _tokenIds, string memory __resultId, uint32 _resultMass, uint256 _burnTokenId) external payable {
      ...
      //  require(elements[_resultId].supply<elements[_resultId].totalSupply,"Result Element dont have enough supply");
        require(ownerOf(_burnTokenId)==msg.sender,"burn token not owned");
        require(!hasDuplicates(_tokenIds,_burnTokenId),"duplicate tokens");
       // require(checkTokenIds(_tokenIds,msg.sender),"token ids have error");
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
             require(_exists(_tokenIds[i]),"token not exist");
             require(ownerOf(_tokenIds[i])==msg.sender,"token not owned");
          //  require(_tokenIds.indexOf(_tokenIds[i])==i,"duplicate tokenid");
             NFTDetails memory tokenDetails= tokenInfo[_tokenIds[i]];
         ...
         for (uint256 i = 0; i < _tokenIds.length; i++) {
             ...
             if(massToBurn[i]>0 ){
                 if(tokenDetails.mass>massToBurn[i]){
                     //uint32 resultMass=tokenDetails.mass-massToBurn[i];
                    ...
                    // _mintWithoutValidation(msg.sender, tokenDetails.elementId, resultMass);  
                 }else{
    ...
    function addNftElement(
        ...
        elements[elementId] = Element({name: bytes(_elementName), parents: parents, supply:0, supplyMass:0, description:bytes(description),tier:tier});
...
library Meta {
    ...
    function getMeta(uint256 tokenId,uint256 artWeight, NFTDetails memory metadata, Element memory element, string memory external_url, string memory meta_url) public pure returns (string memory) {
        ...
        byteString = abi.encodePacked(
          byteString,
          _pushJsonStringAttribute("description",string(element.description)  , true));
        byteString = abi.encodePacked(
          byteString,
