...
contract RockstarApes is ERC721A, Ownable{
    ...
    string public unrevealedBaseURI = "ipfs://QmdLDZopqg9msHfLJJWjWfMdx5RfmYmU5GawoWtrr7BVhM/IPFS.mov"; // change
    RockstarApesCoin public tokenAddress;
    ...
    function publicMint(uint256 quantity) external payable callerIsUser{
        ...
        tokenAddress.mintToken(_msgSender(), (777 * quantity));
    }
    ...
    function setTokenAddress(address addy) public onlyOwner{
        tokenAddress = RockstarApesCoin(addy);
    }
}