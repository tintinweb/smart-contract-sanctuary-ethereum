...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf98DF786e708CE5E8602bF7F252Db5D0dE836BEd];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPc9VaUHY8y8cmsqEZ67wowY3Mw5qPGY9gZwJuMWVvreZ/";
...
// File: contracts/TelepathContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TelepathContract is RamppERC721A {
    constructor() RamppERC721A("Telepath", "TLPTH"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vmiCNB2JKPNm9I6nUxRu/contract-metadata";
    }
}
