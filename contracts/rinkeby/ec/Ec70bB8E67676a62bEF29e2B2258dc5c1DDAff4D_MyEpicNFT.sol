...
contract MyEpicNFT is ERC721URIStorage {
    ...
    constructor() ERC721("Pokemon master", "SQUARE") {
        console.log("pokemon minter");
    }
    ...
    string[] colors = ["red", "yellow", "blue", "green", "black", "purple", "orange"];
    ...
    function makeAnEpicNFT() public {
        ...
        require(mintedSoFar <= 50, "you have minted too many NFTs");
