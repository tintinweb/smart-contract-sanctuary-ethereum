...
contract MerkleProofUnoClaim is IMerkleProofUnoClaim, Ownable, ReentrancyGuard {
    ...
    function airdropUNO(
        ...
        require(userInfo[_account].claimedAmount <= _amount, "UnoRe: Claimed amount overflow");
