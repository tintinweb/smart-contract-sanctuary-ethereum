...
contract MetaCubes is ERC721, IERC2981, Ownable, ReentrancyGuard {
  using Strings for uint256;

  string public PROVENANCE_HASH;

  uint256 constant MAX_SUPPLY = 12;
  uint256 constant MAX_AMOUNT = 10;
  ...
  function mintCubes(
    ...
    require(amount <= MAX_AMOUNT - _alreadyMinted[sender], "Insufficient mints left");
