...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    pragma solidity ^0.8.7;
    contract WildLand is ERC721Enumerable,  Ownable {
    using Strings for uint256;


   string private uriPrefix = "" ;
  string private uriSuffix = ".json";
  string public revealURL = "ipfs://QmTZo6y3tGRb3tJqXuASxRaXfbrMATExdf2seTrMRXvUVF";
 ...
 uint [] public tokens;
  ...
  constructor() ERC721("WildLand", "WILD LAND") {
    
    
  }

  
    function addArray(uint a) public onlyOwner {
        tokens.push(a);
    }

    function addArrayAutomate() public onlyOwner {
        for(uint i ; i < 1000 ; i++)
       { tokens.push(i);}
    }

       function add10ArrayAutomate() public onlyOwner {
        for(uint i ; i < 10 ; i++)
       { tokens.push(i);}
    }

          function add100ArrayAutomate() public onlyOwner {
        for(uint i ; i < 100 ; i++)
       { tokens.push(i);}
    }
