...
contract BraveBears is ERC721, Ownable, PaymentSplitter {
    using Strings for uint256;
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(supply.current() + _amount <= maxSupply, "Not enough supply");
    ...
    function ownerMint() external onlyOwner {
        ...
        require(supply.current() + 10 <= maxSupply, "Not enough supply");
