    ...
    ICreatorMintableERC721
{
    ...
    uint256 private immutable _supplyLimit;
        ...
        onlyMinter
    {
        ...
        if (_supplyLimit != 0 && totalSupply() >= _supplyLimit)
    ...
    /**
     * @dev Sets the token cid the contract metadata for marketplaces
     */
    ...
    /**
     * @dev Returns the supply limit
     */
    function supplyLimit() public view returns (uint256) {
        return _supplyLimit; // total supply is one less than next id
    }
    ...
    /**
     * @dev Returns the number of token supply remainings to be minted
     */
    function totalRemaining() public view returns (uint256) {
        return _supplyLimit - totalSupply();
    }
