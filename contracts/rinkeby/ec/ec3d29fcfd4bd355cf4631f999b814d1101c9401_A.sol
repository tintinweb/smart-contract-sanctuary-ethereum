...
contract A {
    ...
    // Read
        function readLikesPizza() public view returns(uint) {
        return LikePizza;
    }

    function readDislikesPizza() public view returns(uint) {
        return DislikePizza;
    }

    function readLikesHamburger() public view returns(uint) {
        return LikeHamburger;
    }

    function readDislikesHamburger() public view returns(uint) {
        return DislikeHamburger;
    }
}