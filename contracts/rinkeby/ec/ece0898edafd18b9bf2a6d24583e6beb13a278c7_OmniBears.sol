...
contract OmniBears is Ownable, ERC721, NonblockingReceiver {
    ...
    // FIRST 100 NFTs FOR FREE THEN FOR 0.05 ETH ( MAX 3 NFT PER WALLET)
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_BSC, "Mint exceeds supply");
        if (nextTokenId + numTokens > 2) {
            require(
