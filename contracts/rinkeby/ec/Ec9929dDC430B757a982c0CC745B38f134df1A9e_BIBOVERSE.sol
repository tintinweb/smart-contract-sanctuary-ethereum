...
contract BIBOVERSE is Ownable, EIP712, ERC721A, ERC721AQueryable {
	...
	string private _baseTokenURI = "http://api.biboverse.com/Metadata/";
	...
	// Whitelist functions
	// ------------------------------------------------------------------------
	function mintWhitelist(uint256 quantity, uint256 maxQuantity, bytes memory SIGNATURE) external payable{
