...
/*
______________________ ____________________  ____________  ________
...
contract Test123 is ERC721, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("Test123", "T123") {
    setHiddenMetadataUri("ipfs://QmQVVD5h3KTPE4YJVkJXTrSbDwuddeXxQUiwyC8EPRAsve/hidden.json");
  }
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    _mintLoopPresale(msg.sender, _mintAmount);
  }
  ...
  function _mintLoopPresale(address _to, uint256 _mintAmount) internal {
    for (uint256 i = 0; i < _mintAmount; i++) {
      supply.increment();
