...
contract Execatives is ERC721A, Ownable, Pausable {
    ...
    constructor(string memory baseURI) ERC721A("Execatives", "EXECATIVE") {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://execatives.com/opensea/contract_metadata.json";
    }
