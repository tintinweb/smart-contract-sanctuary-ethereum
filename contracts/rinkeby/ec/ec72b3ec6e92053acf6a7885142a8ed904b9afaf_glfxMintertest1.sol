...
// do i really need this?
    ...
    function tokenCheck(address creator,uint256 series) internal view returns (uint256, uint16){
        ...
        if(statusCheck == 0){ return (series, statusCheck);}
        ...
        if (random3 > (0.5078125*128)){ series = 7;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}

        if (random3 <= (0.5078125*128)){ series = 6;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}

        if (random3 <= (0.25*128)){ series = 5;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}

        if (random3 <= (0.125*128)){ series = 4;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}

        if (random3 <= (0.0625*128)){ series = 3;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}

        if (random3 <= (0.03125*128)){ series = 2;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}

        if (random3 == (0.015625*128)){ series = 1;
            if(_totalSupply[creator][series]+1 <= _maxSupply[creator][series]){return (series, statusCheck);}
            else{tokenCheck(creator,series);}}
