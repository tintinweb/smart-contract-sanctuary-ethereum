...
import "./interfaces/ERC721AURIStorageUpgradeable.sol";
    ...
    AccessControlUpgradeable
{
    ...
    function mintCustomURI(address to, string[] memory uris)
        public
        onlyRole(MINTER_ROLE)
    {
        ...
        for (uint256 i = 0; i < quantity; i++) {
            ...
            emit MintNFT(to, address(this), startTokenId + i, uris[i]);
        }
    }
    ...
    function _burn(uint256 tokenId)
        internal
        override(ERC721AUpgradeable, ERC721AURIStorageUpgradeable)
    {
        super._burn(tokenId);
    }
 ...
 */
abstract contract ERC721AURIStorageUpgradeable is
    Initializable,
    ERC721AUpgradeable
{
    function __ERC721AURIStorage_init() internal onlyInitializing {}

    function __ERC721AURIStorage_init_unchained() internal onlyInitializing {}
        ...
        virtual
    {
        require(
            _exists(tokenId),
            "ERC721AURIStorage: URI set of nonexistent token"
        );
