...
contract ilayerzero is ERC721A, Ownable, NonblockingReceiver {
    ...
    uint256 public constant PAID_SUPPLY = 4500;
    uint256 public constant MAX_SUPPLY = FREE_SUPPLY+PAID_SUPPLY;

    uint gasForDestinationLzReceive = 350000;

    constructor() ERC721A("ilayerzero", "ilz", MAX_TXN) {
        saleEnabled = false;
        price = 0.01 ether;
    }
    ...
    IERC721Enumerable
{
    ...
    function _safeMintSpecific(address to, uint256 tokenId) internal virtual {
        _safeMint(to, tokenId, "");
    }

    /**
     * @dev Mints `specific` token and transfers them to `to`.
     *
     * Requirements:
     *
     * - `to` cannot be the zero address.
