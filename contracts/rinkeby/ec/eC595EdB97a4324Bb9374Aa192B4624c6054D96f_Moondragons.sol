...

{
    ...
    uint256 FreemintAmountLimit=10;
    ...
    uint256 _priceWL = 4000000000000000; // 0.04 ETH
    ...
    address[] private _team = [
        0x640802A04CE9960FC62F410C88a38017461ff454 // VIP Account gets 40% of the total revenue
    ];
    ...
    onlyAccounts
    {
        ...
        require(
            _freemintClaimed[msg.sender] + _amount <= FreemintAmountLimit,  " You can't mint so much tokens");
    ...
    onlyAccounts
    {
        ...
        require(_amount > 0, " zero amount");
         require(
            _amount <= publicAmountLimit,      " You can't mint so much tokens");
        require(
            _publicClaimed[msg.sender] + _amount <= FreemintAmountLimit,  " You can't mint so much tokens");
