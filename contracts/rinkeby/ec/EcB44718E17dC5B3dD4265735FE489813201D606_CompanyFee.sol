...
contract CompanyFee is Ownable {
    ...
    function pay(address agent, uint256 amount) public payable returns (bool) {
        ...
        SellaTokenContract.transfer(agent, amount);
        ...
        SellaTokenContract.transfer(_owner, amount);
