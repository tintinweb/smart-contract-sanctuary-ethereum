...
contract cityTour is Ownable, ERC721A {
    ...
    bytes32 public inkedProof = 0x254175d102abc7f6170f87e85d23e33719d8503931c85cbcdd3dd16129ae80d1; //mercle
   ...
   function buy(uint _count) public payable{
    ...
    function buyPreMint(bytes32[] calldata _merkelProof, uint _count) public payable {
        ...
        // check wl 
        require(MerkleProof.verify(_merkelProof, inkedProof, senderHex), "Sender not dicked!");
