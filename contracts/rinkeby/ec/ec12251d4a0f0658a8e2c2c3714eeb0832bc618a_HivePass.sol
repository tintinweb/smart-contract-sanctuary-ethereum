...
contract HivePass is ERC1155Supply, Ownable
{
    ...
    function changeSaleDetails(uint tokenId, uint _price, uint _maxSupply) external onlyOwner  //This is the function allowing you to changeSaleDetails in remix prior to flipping the sales state to active and allowing people to mint
    {
