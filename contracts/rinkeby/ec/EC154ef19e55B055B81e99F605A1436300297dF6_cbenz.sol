...
contract cbenz is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("cbenz", "cbz") {
  ...
  uint256 public constant MAX_SUPPLY = 1444;
  ...
  {
    return (address(this), (salePrice * 669) / 10000);
  }
