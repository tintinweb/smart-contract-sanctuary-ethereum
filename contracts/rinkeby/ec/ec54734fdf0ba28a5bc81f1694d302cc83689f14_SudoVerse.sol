...
// SudoVerse is a fully on chain game played directly from SudoSwap.xyz UI that aims to explore Sudo's boundries.
...
contract SudoVerse is Ownable, ERC721iEnumerable {
    ...
    {
        string
            memory descr = "SudoVerse is an on chain ponzi game played directly from SudoSwap.xyz UI that aims to explore Sudo's boundaries.";
