...
contract MineNations is ERC721URIStorage, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, string memory _initBaseURI, string memory _initNotRevealedURI, string memory _specialURI) ERC721(_name, _symbol) {
      baseURI = _initBaseURI;
      notRevealedURI = _initNotRevealedURI;
      specialURI = _specialURI;
      mintItem(msg.sender, 5);
    }
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      else if(revealed == false && special){
    ...
    function sendToCommunity() public onlyOwner {
    ...
    function startSpecial() public onlyOwner {
        special = true;
    }
