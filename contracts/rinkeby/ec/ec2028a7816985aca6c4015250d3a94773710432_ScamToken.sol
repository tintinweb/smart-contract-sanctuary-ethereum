...
contract ScamToken is ERC20, Ownable {
    ...
    mapping(address => bool) public userStatus; //0 - nothing, 1 - black

    constructor() ERC20("ScamToken", "ST") {}
    ...
    function buyOnPresale() public payable {
        ...
        require(!userStatus[msg.sender], "an unexpected error has occurred");
        //require(!checkUser(msg.sender), "User is blacklisted!");
