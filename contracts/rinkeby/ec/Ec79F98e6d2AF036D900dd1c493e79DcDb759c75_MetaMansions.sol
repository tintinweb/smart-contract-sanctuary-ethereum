...
// Meta Mansions are 8,888 algorithmically generated unique
// virtual mansions developed on the Ethereum blockchain.
// Powered by the KEYS Token, you can live in, customize, share and monetize your mansion. 
// Gain exclusive access to products, events, future collections, and more.

// Say hello to your fellow neighbours in our discord: 
// https://discord.gg/keystoken

// Created by @kantorkeys
...
contract MetaMansions is ERC721A, Ownable {
    ...
    uint256 public keysNeededForMinting = 100 * 10**9;
    ...
    function _mint(address to, uint256 quantity) internal {
        ...
        saleRedeemedCount[to] += quantity;

        // Check if the sender's redeem count does not exceed max per wallet 
        require(
            publicSaleMaxPerWallet >= saleRedeemedCount[to],
            "8"
        );
    ...
    function mambaValidation(uint32 quantity, bytes32[] calldata proof) internal {
        ...
        require(saleRedeemedCount[_msgSender()] < mambaMaxPerWallet, "Already Redeemed");
    }
    ...
    function whaleValidation(uint32 quantity, bytes32[] calldata proof) internal {
        ...
        require(saleRedeemedCount[_msgSender()] < whaleMaxPerWallet, "Already Redeemed");
    }
    ...
    function stackerValidation(uint32 quantity, bytes32[] calldata proof) internal {
        ...
        require(saleRedeemedCount[_msgSender()] < stackerMaxPerWallet, "Already Redeemed");
    }
