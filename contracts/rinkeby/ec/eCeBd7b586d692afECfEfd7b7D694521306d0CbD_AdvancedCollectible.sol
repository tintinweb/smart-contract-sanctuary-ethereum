...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    function createCollectible() public returns (bytes32) {
        ...
        // we need a way to pass the msg.sender to the fulFillRandomness function since the chainlink node gonna call that function and the msg.sender will not be the actual user
