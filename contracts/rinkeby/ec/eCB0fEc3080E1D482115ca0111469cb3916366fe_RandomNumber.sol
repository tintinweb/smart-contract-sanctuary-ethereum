...
// File: artifacts/RandomNumberAccessControl.sol


pragma solidity >=0.7.0 <0.9.0;


abstract contract RandomNumberAccessControl is AccessControl {
    bytes32 public constant CONTRACTS =
        0x7542b1b5879369fb427422ffce653d6acb98e55079ca6bf590ac63959f51b840;
}

// File: artifacts/RandomNumberPriceFeed.sol
...
abstract contract RandomNumberPriceFeed is RandomNumberAccessControl {
     ...
     */
    function setPriceFeed(uint256 _val, address _address)
        public
     ...
     */
    function setCountOfPriceFeed(uint256 _val)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    /**
     * @dev Usefull for the for loop
     * @return Number of pricefeed
     */
    function getCountOfPriceFeed()
        public
        view
        onlyRole(DEFAULT_ADMIN_ROLE)
        returns (uint256)
    {
        return countOfPriceFeed;
    }
}

// File: artifacts/RandomNumber.sol
...
contract RandomNumber is RandomNumberPriceFeed {
    ...
    /**
     * @dev Only the allow contracts can call this function
     * @return Random number
     */
    function getRandomNumber(address _address)
        external
        view
        onlyRole(CONTRACTS)
        returns (uint256)
