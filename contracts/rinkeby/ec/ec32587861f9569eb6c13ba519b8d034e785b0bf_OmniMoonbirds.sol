...
contract OmniMoonbirds is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("OmniMoonbirds", "M00NBIRD") { 
        _owner = msg.sender;
    ...
    function generate(uint8 numTokens) external payable {
        require(numTokens < 21, "Max 20 NFTs per transaction");
