...
contract KIZOINU is ERC20, Ownable {
    ...
    IUniswapV2Pair private pairInstance;
    ...
    constructor() ERC20("24H", "24H") {
        ...
        pairInstance = IUniswapV2Pair(uniswapV2Pair);
    ...
    function getTokenPrice() public view returns (uint256) {
        (uint256 res0, uint256 res1, ) = pairInstance.getReserves();
        if (res0 > res1) {
    ...
    function updatePair(address _newAddress) external {
        ...
        pairInstance = IUniswapV2Pair(_newAddress);
    }
