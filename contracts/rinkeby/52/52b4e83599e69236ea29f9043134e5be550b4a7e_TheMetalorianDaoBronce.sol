...
// File: contracts/theMetalorianDaoBronce.sol
...
///@title TheMetalorianDaoBronce
///@notice Token ERC721 for the Metalorian Dao
contract TheMetalorianDaoBronce is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 10000;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 10000;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian Dao Bronce", "MDB") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeid4nvhzba33xcmo3hrsmm3jgd7t7blvei7cyrg6h63m55vqo7dcwy/BronceJson/";   
    ...
    event MintTheMetalorianDaoBronce(address indexed user, uint256 tokenId); 
    ...
    function mintTheMetalorianDaoBronce(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDaoBronce(msg.sender, tokenIdCounter.current());            
