...
// pragma solidity ^0.8.0; //version of the Solidity compiler 

// import "hardhat/console.sol"; //magic by hardhat that allows console logginc in our contract. Useful for debugging.
...
//      // Get the current tokenId, this starts at 0. Return the new mint's unique identifier
//     uint256 newItemId = _tokenIds.current(); 

//      // Actually mint the NFT to the sender using msg.sender.
//     _safeMint(msg.sender, newItemId);

//     // Set the NFTs data. It's literally us setting the actual data that makes the NFT valuable. In this case, we're setting it as "blah" which....isn't that valuable ;).
//     // _setTokenURI(newItemId, "https://jsonkeeper.com/b/EW2R");
...
//     console.log("An NFT w/ ID %s has been minted to %s", newItemId, msg.sender); //logs when the NFT is minted and to who
...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Hundred"];
  string[] secondWords = ["Steaks", "Pizzas", "Sushis", "Burgers", "Sandwitches", "Dumplings"];
  string[] thirdWords = ["PLZ!!!!"];
  ...
  function makeAnEpicNFT() public {
    uint256 newItemId = _tokenIds.current();
    require(newItemId <= 50, "Only 50 NFTs can be minted, and it has exceeded the limit!");
