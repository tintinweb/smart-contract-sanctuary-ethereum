...
contract _contract is ERC721A, Ownable {
    ...
    constructor(
        ...
        setBaseURI('ipfs://QmSwstuQQNJKmZeNo15qvWPNkU8XQa8tBgEyFbHXUBmLHH');
    }
    ...
    function ownerMint(address[] calldata _airdropAddresses , uint256[] memory _UserMintAmount) public onlyOwner{
        uint256 supply = totalSupply();
