...
contract BrokenClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private MAX_TOKENS_PER_TRANSACTION = 5;
    uint256 private MAX_SUPPLY = 100;
    uint256 private PUBLIC_MINT_MAX_SUPPLY = 20;
    uint256 private FREE_MINTS = 10;
    // uint256 public PUBLIC_MINT_PRICE = 0.05 ether;
    // uint256 public WL_MINT_PRICE = 0.03 ether;
    // uint256 private MAX_TOKENS_PER_TRANSACTION = 100;
    // uint256 private MAX_SUPPLY = 6263;
    // uint256 private PUBLIC_MINT_MAX_SUPPLY = 4262;
    // uint256 private FREE_MINTS = 1000;
    bool public revealed = false;
    bool public whitelistEnabled = false;
    bool public saleStatus = true;

    string private notRevealedUri = "ipfs://QmPTkbyaFGEaXgMSJxzjZH7MH5jYQot96QFrcDb96y1FQN";
    ...
    function setNotRevealedURI(string calldata _newNotRevealedURI) view external onlyOwner {
        _newNotRevealedURI = _newNotRevealedURI;
    }
    ...
    function spend(uint256 amount) public {
        require(address(BrokenToken) != address(0), "No token contract set");
        BrokenToken.redeem(amount);
    }
