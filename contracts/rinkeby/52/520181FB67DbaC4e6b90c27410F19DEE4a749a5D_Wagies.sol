...
contract Wagies is
    ...
    Withdrawable
{
    uint256 public constant TOTAL_MAX_QTY = 4232;
    uint256 public GIFT_MAX_QTY = 0;
    uint256 public constant PUBLIC_MAX_QTY_PER_MINTER = 3;
    uint256 public fPublicSalesPrice = 0 ether;
    ...
    {
        uint256 price = fPublicSalesPrice;
        require(
