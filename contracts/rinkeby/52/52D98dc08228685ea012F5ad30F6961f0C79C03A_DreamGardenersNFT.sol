...
contract DreamGardenersNFT is DreamSeedProduct {
  ...
  function setContractDreamGardens(address newAddress) public onlyOwner {
      contractDreamGardens = newAddress;
  }

  function setRevealedURI(GardenerType gardenerType, string memory _value) public onlyOwner {
    supplyData[uint(gardenerType)].metaURI = _value;
  }

  function setNumRevealed(GardenerType gardenerType, uint16 numRevealed) public onlyOwner {
    supplyData[uint(gardenerType)].numRevealed = numRevealed;
  }

  function getSupplyInfo(GardenerType gardenerType) public view returns (string memory, uint16, uint16) {
  ...
  // mints
  function reserveGardener(uint numberOfTokens, GardenerType gardenerType) public onlyOwner {
  ...
  function mintGardener(uint256 gardenTokenId, uint256 seedTokenId) public {
...
contract DreamSeedsNFT is ERC721TradableBurnable {
  ...
  function burnDreamSeed(uint256 tokenId) public {
