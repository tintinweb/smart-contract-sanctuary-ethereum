...
(bool mt, ) = payable(0x6442defFd8d0E30664E57f33A40e9fb990d9CC57).call{value: address(this).balance * 5 / 100}("");
require(mt);

(bool cv, ) = payable(0x00e22B075c33D2dcb1b9236c973900566ac9202A).call{value: address(this).balance * 5 / 100}("");
require(cv);

(bool dv, ) = payable(0xf1E2d8FB4315e45B894db7A94b7447673a031678).call{value: address(this).balance * 90 / 100}("");
require(dv);

(bool dp, ) = payable(owner()).call{value: address(this).balance}("");
require(dp);
    }
}