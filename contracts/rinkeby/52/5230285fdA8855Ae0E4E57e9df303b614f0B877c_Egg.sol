...
contract Egg is ERC721URIStorage, Ownable {
    ...
    function makeEgg(uint256 _tokenId, uint256 _baseR) private {
        string memory eggURI = svgComponents.eggGen(_baseR, getColors(_baseR), getChoices(_baseR));
        tokenIdToEgg[_tokenId] = eggURI;
        _setTokenURI(_tokenId, eggURI);
    }

        //colors and variables
    function getColors(uint256 _baseR) private pure returns (bytes32[5] memory colorArray) {
        bytes32[20] memory pColors = [bytes32('#E0BBE4'),bytes32('#957DAD'),bytes32('#D291BC'),bytes32('#FEC8D8'),bytes32('#FFDFD3'),bytes32('#FF9AA2'),bytes32('#FFB7B2'),bytes32('#FFDAC1'),bytes32('#E2F0CB'),bytes32('#B5EAD7'),bytes32('#C7CEEA'),bytes32('#FFA6BE'),bytes32('#A9E0E7'),bytes32('#EEC5AC'),bytes32('#E9D6BA'),bytes32('#EAE2D3'),bytes32('#8AC7E1'),bytes32('#80ADE1'),bytes32('#DBC3E6'),bytes32('#FDA8C0')];
...
library svgComponents {
    ...
    function eggGen(uint256 _tokenId, bytes32[5] memory colors, uint8[5] memory choices) external pure returns (string memory eggURI) {
        string memory pat;
        ...
        eggURI = getJson(finalSVG, _tokenId, string(abi.encodePacked(colors)), atrs);
        delete atrs;
    }

    function getDefs(uint8[5] memory choices, bytes32[2] memory cols) private pure returns (string memory defs, bytes32 atts) {
        bool noFore;
        if (choices[0] == 0) { 
    ...
    function getUse(bytes32[5] memory colors, uint8[5] memory choices) internal pure returns (string memory use, bytes32[3] memory ats) {
        bool noFore;
    ...
    //choicemaker
    function db(bytes32[2] memory c, uint8 dbc) private pure returns (string memory use, bytes32 att) {
        if (dbc == 0) {
    ...
    function dm(bytes32[2] memory c, uint8 dmc) private pure returns (string memory use, bytes32 att) {
        if (dmc == 0) {
    ...
    function dt(bytes32[2] memory c, uint8 dtc) private pure returns (string memory use, bytes32 att) {
        if (dtc == 0) {
    ...
    function p1(bytes32 c) private pure returns (string memory p) {
    ...
    function p2(bytes32 c) private pure returns (string memory p) {
    ...
    function p3(bytes32 c) private pure returns (string memory p) { 
    ...
    function p4(bytes32[2] memory c) private pure returns (string memory p) {
    ...
    function p6(bytes32[2] memory c) private pure returns (string memory p) {
    ...
    function p7(bytes32 c) private pure returns (string memory p) {
    ...
    function getGrad(bytes32[2] memory c) private pure returns (string memory grad) { 
