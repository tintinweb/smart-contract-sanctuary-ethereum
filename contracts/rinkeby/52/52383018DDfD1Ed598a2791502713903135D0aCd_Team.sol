...
contract Team is AccessControl {
    ...
    function approve20(
        ...
        require(amount > 0, "Team: The amount must more than 0!");
        require(spender != address(0), "Team: spender address must not be 0x0!");
    ...
    function approve1155(
        ...
        require(operator != address(0), "Team: operator address must not be 0x0!");
