...
contract OmniChainNFT is ERC721, Ownable, ILayerZeroReceiver, NonblockingReceiver {
    ...
    uint256 public mintGreedMultiplier;
    ...
    function mint(uint8 quantity_) public payable {
        ...
        uint256 calcMintFee = walletMints[msg.sender] + quantity_ <= maxFreePerWallet ? quantity_ * 0.0 ether : (maxFreePerWallet - walletMints[msg.sender] - quantity_) * mintPrice;
