...
contract BaoSociety is ERC721A, Ownable {
    ...
    uint256 public constant whitelistPrice = 0.088 ether;
    uint256 public constant WHITELIST_PURCHASE_LIMIT = 3;

    mapping(address => mapping(uint256 => bool)) public whitelistClaimed;

    address private _signerAddress = 0xA5225c1A21e23269371ff29D9b8390c300903be3;

    constructor() ERC721A('Bao Society', 'BAOSOC', MAX_SUPPLY, 1) {
