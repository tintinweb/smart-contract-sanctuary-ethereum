...
contract CollateralManagerState is Owned, State {
    ...
    function incrementLongs(bytes32 synth, uint256 amount)
        ...
        onlyAssociatedContract
    {
        totalIssuedSynths[synth].long = totalIssuedSynths[synth].long.add(
            amount
        );
    }
    ...
    function decrementLongs(bytes32 synth, uint256 amount)
        ...
        onlyAssociatedContract
    {
        totalIssuedSynths[synth].long = totalIssuedSynths[synth].long.sub(
            amount
        );
    }
    ...
    function incrementShorts(bytes32 synth, uint256 amount)
        ...
        onlyAssociatedContract
    {
        totalIssuedSynths[synth].short = totalIssuedSynths[synth].short.add(
            amount
        );
    }
    ...
    function decrementShorts(bytes32 synth, uint256 amount)
        ...
        onlyAssociatedContract
    {
        totalIssuedSynths[synth].short = totalIssuedSynths[synth].short.sub(
            amount
        );
    }
    ...
    function getShortRateAt(bytes32 currency, uint256 index)
        internal
        view
        returns (uint256)
    {
    ...
    function getShortRatesLength(bytes32 currency)
        public
        view
        returns (uint256)
    {
    ...
    function shortRateLastUpdated(bytes32 currency)
        internal
        view
        returns (uint256)
    {
