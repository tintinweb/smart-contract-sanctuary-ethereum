...
contract Merkle_Address  is Governance { //} is ERC721 {
  ...
  function checkProof(address _wallet, bytes32[] calldata _proof)
      public
      view
      returns (bool)
    {
  ...
  function mintAllowList(uint256 _tokenId, bytes32[] calldata _proof) external {
      require(checkProof(msg.sender, _proof), "You are not on the allowlist");
