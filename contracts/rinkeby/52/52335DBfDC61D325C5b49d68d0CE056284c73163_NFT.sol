...
contract NFT is ERC721Enumerable, Ownable {
    ...
    function burn(uint256 _tokenId1, uint256 _tokenId2) public {
        require(!burnPaused, "Burning is paused");
        require(ownerOf(_tokenId1) == msg.sender, "You dont own this nft");
        require(ownerOf(_tokenId2) == msg.sender, "You dont own this nft");
        _burn(_tokenId1);
        _burn(_tokenId2);
    }
