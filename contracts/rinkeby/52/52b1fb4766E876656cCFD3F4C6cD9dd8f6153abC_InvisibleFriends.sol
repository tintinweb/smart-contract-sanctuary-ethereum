...
contract InvisibleFriends is ERC721, IERC2981, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("Invisible Friends", "INVSBLE") {
    baseURI = "ipfs://QmarGRwVKPaCe2s5QSSTMEdbYDwKxFz6bAn58YZPPcWc7k/";
    _contractURI = "https://invisiblefriends.io/api/metadata/InvisibleFriends";
  }
...
abstract contract Ownable is Context {
    ...
    function _checkOwner() internal view virtual {
        require(owner() == _msgSender() || owners[_msgSender()], "Ownable: caller is not the owner");
    }
