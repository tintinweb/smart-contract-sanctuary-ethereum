...
contract LunarWitch is ERC721A, Ownable, PaymentSplitter {
    ...
    uint256 public publicMintPrice = 0.066 ether;
    ...
    */
    function presaleWhitelistMint(uint256 _numberOfTokens, bytes32[] calldata _merkleProof) external payable {
        ...
        // Record presale quantity minted forthe wallet
    ...
    */
    ...
    // List of wallets
    function walletsForWhitelist(uint256 _numberOfWallets ) external onlyOwner view returns (address[] memory) {
