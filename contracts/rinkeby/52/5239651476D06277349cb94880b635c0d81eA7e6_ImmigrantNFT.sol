...
contract ImmigrantNFT is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint16 public immutable MAX_SUPPLY_PRESALE = 4;
    ...
    constructor() ERC721A('The Immigrant', 'TIM', 5, 4000) {
        saleConfig = SaleConfig(0, 0.015 ether, 0.025 ether, 5);
    ...
    function setPublicSalePrice(uint64 _publicSalePrice) external onlyOwner {
