...
//
//     __  __           ____  __          ____                         
//    / / / /__  ____ _/ / /_/ /_  __  __/ __ )__  ______  ____  __  __
//   / /_/ / _ \/ __ `/ / __/ __ \/ / / / __  / / / / __ \/ __ \/ / / /
//  / __  /  __/ /_/ / / /_/ / / / /_/ / /_/ / /_/ / / / / / / / /_/ / 
// /_/ /_/\___/\__,_/_/\__/_/ /_/\__, /_____/\__,_/_/ /_/_/ /_/\__, /  
//                              /____/                        /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xcCBD219148e2Ea0Dbd627D56471252E2764E6c5B];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 4000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXWxfkVbzEAE8KkroyteNXSiPxPdbXoypuwt5d2fuRqXj/";
...
// File: contracts/HealthyBunnyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HealthyBunnyContract is RamppERC721A {
    constructor() RamppERC721A("HealthyBunny", "HBNFT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/7ArfD6n5k5QYu7LMe5Qe/contract-metadata";
    }
}
