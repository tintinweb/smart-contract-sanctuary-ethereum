...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nutra 2";
    string private constant _symbol = "Bio 2";
    ...
    constructor () {
        ...
        uint16 _buyAutoBurnFee = 300;
        uint16 _buyMarketingFee = 200;
        uint16 _sellAutoBurnFee = 700;
        uint16 _sellMarketingFee = 800;
