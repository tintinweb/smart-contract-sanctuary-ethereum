...
contract MandoXStaking is Ownable, IERC721Receiver, Pausable {
    ...
    function addManyToRegistery(uint256[] calldata tokenIds) external {
    ...
    */
    function claimManyFromRegistery(uint256[] calldata tokenIds, bool unstake) external whenNotPaused _updateEarnings {
        uint256 rewards = 0;
        for (uint i = 0; i < tokenIds.length; i++) {
