...
contract FATTIES is ERC721A, PaymentSplitter, Ownable {
    ...
    constructor(
        ...
        ERC721A("FATTIES", "FATTIES")
        PaymentSplitter(payees, shares) {
        authorizedSigner = voucherSigner;
        _baseUri = baseUri;
     ...
     * FATTIES.
     */
    function frenMint() external {
        require(totalSupply() < MAX_SUPPLY, "Sale ended");
        require(totalSupply() + MAX_MINT_PER_FREN <= MAX_SUPPLY, "Not enough supply for quantity");
        require(_frensList[msg.sender] != 0, "Need to be listed as a FREN");
        require(_frensList[msg.sender] != MAX_MINT_PER_FREN, "Max FREN mint limit reached");
        _frensList[msg.sender] = MAX_MINT_PER_FREN;

        _safeMint(msg.sender, MAX_MINT_PER_FREN);
    }
