...
contract NotInVain is ERC721, Ownable, ERC721Burnable, ERC2981 {
    ...
    /*
    //should I do a claim for the session
    // creating mapping for used tokens
    function claimSession() external {
        //read the token of the wallet

        //add token to mapping of used

        //create event of claim
        //require not paused
        require(!pause, "Contract Paused");
        ...
        for (uint256 i = 0; i < balance; i++) {
            if (sender == ownerOf())  //<<< figure the logic
