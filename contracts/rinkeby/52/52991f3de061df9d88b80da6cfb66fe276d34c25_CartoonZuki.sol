...
contract CartoonZuki is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI = "ipfs://QmV8vHiWNP1pnJme7DyTx3V6kwbBrRaFReaB97RQfGxr2i/";
  ...
  constructor() ERC721A("CartoonZuki", "CTZ"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more toonzs");
    require(mintEnabled, "Minting is not live yet, hold on toonzs.");
