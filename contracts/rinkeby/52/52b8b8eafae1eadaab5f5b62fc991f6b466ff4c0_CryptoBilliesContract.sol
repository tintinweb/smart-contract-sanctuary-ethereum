...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x02599Df75c35Dface882a1b29ba3AC01847eb929,0x0Cb3Dd2D550737490c3628248184D0aDE4709381];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmX5GaEva3AFXVWVp6QJM6SB688YcEisagS3EeDLPkX746/";
...
contract CryptoBilliesContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/uab617LSlJ2EJEv5Jt9h/contract-metadata";
    }
}
