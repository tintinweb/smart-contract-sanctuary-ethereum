...
contract MakeWorldPeace is Initializable, ERC20Upgradeable,ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    uint private latestMintedTime;
    uint private maxSupplyWithinTimeInterval;
    uint private timeIntervalSeconds;      
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal whenNotPaused virtual override {
        super._beforeTokenTransfer(from, to, amount);
    }

    function _authorizeUpgrade(address newImplementation) internal onlyOwner override {}

    function burn_supply (uint256 amount) public onlyOwner  {
