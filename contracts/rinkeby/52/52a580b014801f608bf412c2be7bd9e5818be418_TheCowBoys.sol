...
contract TheCowBoys is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
      ...
      _safeMint(0x102E911fDeeE71776545b76E7856ea8d32D7c5F7, 2);
      _safeMint(0xF068AFaDF27f4e8Df4A93446F5D7c5488F879422, 2);
      _safeMint(0xe178fdF5d0821b75059F274c8aE2B9F543DC84Af, 2);
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool dev, ) = payable(0x102E911fDeeE71776545b76E7856ea8d32D7c5F7).call{
        value: (contractBalance * 33) / 100
    }("");
    (bool founder, ) = payable(0xe178fdF5d0821b75059F274c8aE2B9F543DC84Af).call{
        value: (contractBalance * 34) / 100
    }("");
    (bool artist, ) = payable(0xF068AFaDF27f4e8Df4A93446F5D7c5488F879422).call{ 
        value: (contractBalance * 33) / 100
    }("");
     require(dev && founder && artist, "Withdraw failed");
  }
