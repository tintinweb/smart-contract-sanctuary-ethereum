// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"L-1", unicode"L0", unicode"L1", unicode"L2", unicode"L3", unicode"L4", unicode"L5", unicode"BG"];
        ...
        constructor() ERC721A(unicode"Still Lifes", unicode"SL") {
            TIERS[0] = [80,420];
TIERS[1] = [15,15,20,30,30,30,30,30,300];
TIERS[2] = [10,23,25,25,30,35,39,40,40,43,45,45,100];
TIERS[3] = [20,20,20,35,35,45,45,80,200];
TIERS[4] = [30,30,30,32,38,50,60,60,70,100];
TIERS[5] = [60,60,60,320];
TIERS[6] = [60,440];
TIERS[7] = [500];
        }
        ...
        function hashFromRandomBytes(
            ...
            bytes memory hashBytes = DynamicBuffer.allocate(NUM_LAYERS * 10);
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(
                abi.encodePacked(
                    _toString(_tokenId),
                    unicode"\",\"description\":\"Still Lifes\","
                )
            );
