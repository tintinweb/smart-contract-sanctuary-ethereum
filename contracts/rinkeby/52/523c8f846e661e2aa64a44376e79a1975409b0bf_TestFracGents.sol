...
// File: contracts/TestFracGents.sol
...
contract TestFracGents is ERC721A, Ownable {
    uint256 public constant TOTAL_SUPPLY = 20; //* set to 20 for testing purposes
    ...
    constructor(uint256 _devMintAmount) ERC721A("TestFracGents", "TFG") {
    ...
    function airdrop(
        ...
        require(
            totalSupply() + totalAmountToAirdrop <= TOTAL_SUPPLY,
