...
contract Farmverse is ERC721Ao, Payable {
    ...
    uint16 private constant MAX_PER_TRANS_PLUS_ONE = 11;

    // Presale
    mapping(address => bool) public farmlistClaimed;
     ...
     */
    modifier noBots() {
        require(msg.sender == tx.origin, "Farmverse: No bots");
        _;
    }
     ...
     */
    modifier withinTxLimit(uint16 numTokens) {
        require(numTokens < MAX_PER_TRANS_PLUS_ONE, "Farmverse: Exceeds transaction limit");
        _;
    }
     ...
     */
    function mintFarmlist(bytes32[] calldata proof) external payable isSaleActive withinMintLimit(4) {
        require(msg.value == tokenPrice * 3, "Farmverse: Invalid Ether value");
        require(!farmlistClaimed[msg.sender], "Farmverse: Already claimed");
        bytes32 leaf = keccak256(abi.encode(msg.sender));
        require(verify(merkleRoot, leaf, proof), "Farmverse: Not a valid proof");
        farmlistClaimed[msg.sender] = true;
