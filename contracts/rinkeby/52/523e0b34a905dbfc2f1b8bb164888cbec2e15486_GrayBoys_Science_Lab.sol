...
contract GrayBoys_Science_Lab is ERC1155, AccessControl {
    ...
    bytes32 private constant EXPERIMENT_CONTRACT_ROLE =
        keccak256("EXPERIMENT_CONTRACT_ROLE");
    ...
    function mint(uint256 _typeId, uint256 _quantity)
        external
        onlyRole(OWNER_ROLE)
    {
    ...
    ) external onlyRole(EXPERIMENT_CONTRACT_ROLE) {
    ...
    {
        return
            interfaceId == type(IGrayBoys_Science_Lab).interfaceId ||
