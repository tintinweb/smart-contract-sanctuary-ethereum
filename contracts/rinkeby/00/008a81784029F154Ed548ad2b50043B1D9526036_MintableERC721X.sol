...
/**
 * @notice ERC721Χ-compliant contract with added
 *         function for minting new NFTs to addresses.
 */
contract MintableERC721X is ERC721X, IMintableERC721X, AccessControl, Ownable {
   ...
   */
  uint256 public constant UID = 0xc63201c9d926a78efdc7c8c6ebd9a8f217a22aecdafe65053ef1527d051582dd;
   ...
   * @inheritdoc IMintableERC721X
   */
  function safeMint(address _to, bool _amount) public virtual {
   ...
   * @inheritdoc IMintableERC721X
   */
  function mint(address _to, bool _ammount) public virtual {
    // Delegate to internal OpenZeppelin function
    _mint(_to, _ammount);
  }
   ...
   */
  function supportsInterface(bytes4 _interfaceId) public view override(ERC721X, AccessControl) returns (bool) {
    return _interfaceId == type(IMintableERC721X).interfaceId || super.supportsInterface(_interfaceId);
  }
}
