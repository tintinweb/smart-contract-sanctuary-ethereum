...
contract KootyKat is ERC721A, Ownable {
    using Strings for uint256;

    /// @dev KootyKat NFT max supply
    uint256 public immutable MAX_SUPPLY;

    /// @dev KootyKat NFT Royalty 2.5%
    uint256 public immutable ROYALTY;

    /// @dev TokenId of revealting tokenURI
    uint256 public revealURITokenId;

    /// @dev KootyKat NFT Base Token URI
    string public baseURI;

    /// @dev Royalty receiver address
    address public royaltyReceiver;

    /// @dev KootyKat minter addresses
    ...
    /// @dev Set KootyKat Royalty receiver
