...
contract HackJack2 is ERC721URIStorage {
  ...
  function newGame() public payable {
    ...
    Hand memory hand = Hand(new uint8[](0), msg.value, false, false);
    ...
    emit NewGame(_gameId, msg.sender, msg.value, playerCard1, playerCard2);
  }
