...
contract AutisticIntelligence is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public starttime = 1649196360;
    uint256 public wl_duration = 1 hours;
    bool public is_enabled_by_dev = false;
    bool public is_public_enabled_by_dev = false;
        ...
        if(isWlMinting()) {
            ...
            if(remainingWassiesInAccount > 0) {
                ...
                // minting free ones + wl
                    ...
                    require(wl[msg.sender] == true, "not on whitelist or already minted");
