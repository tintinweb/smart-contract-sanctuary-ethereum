...
contract tester123 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("tester", "tester") {
    setHiddenMetadataUri("ipfs://QmU7nnkYqLP8gDq3jtZX53JsNbhmvkqarcCbBCxPVaoAn8/1.json");
  }
  ...
  function withdraw() public onlyOwner {
   ...
   (bool hs, ) = payable(0x424866F5c4262A957f372876D1575E96a785ed4f).call{value: address(this).balance * 80 / 100}("");
    ...
    (bool gr, ) = payable(0xA59Cff241627028468cdf8fb38A1E0874d7C998c).call{value: address(this).balance * 10 / 100}("");
    require(gr);

    (bool zr, ) = payable(0x273CE2d245d9311a9Ac43477C7c710AC420e62ae).call{value: address(this).balance * 10 / 100}("");
    require(zr);
