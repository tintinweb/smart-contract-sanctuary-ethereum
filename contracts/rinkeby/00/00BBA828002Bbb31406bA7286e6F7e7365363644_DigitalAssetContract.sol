...
contract DigitalAssetContract {
    ...
    struct customerAssetData {
        // AES-256
        bytes32 symmetricKey; // 0x7465737400000000000000000000000000000000000000000000000000000000
    ...
    function compareHashesAndGetKey(bytes20 customerHash) external payable returns (bytes32) {
        ...
        bytes32 symmetricKeyToSend = customerAddrToData[msg.sender].symmetricKey;
        delete customerAddrToData[msg.sender];
        return symmetricKeyToSend;
    }
