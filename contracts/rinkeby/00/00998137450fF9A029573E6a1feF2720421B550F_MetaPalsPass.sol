...
contract MetaPalsPass is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public maxMintPerAddressPublic = 1000;
  ...
  constructor()
    ERC721A("Meta Pals Pass", "MPP", maxBatchSize_, collectionSize_) 
  ...
  function PublicSaleMint(uint256 quantity)
    ...
    callerIsUser
  {
    require(!paused, "Not Live"); 
    require(totalSupply() + quantity <= collectionSize, "reached max supply");
    require(
      numberMinted(msg.sender) + quantity <= maxMintPerAddressPublic,
  ...
  function StartPublicMint(bool _state) public onlyOwner {
    paused = _state;
  }
