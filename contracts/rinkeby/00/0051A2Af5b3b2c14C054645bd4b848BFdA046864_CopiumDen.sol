...
//    event OfferStats(bool _arg1, bool _arg2, bool _arg3, bool _arg4);
//    event OfferStatComponents(address _arg1, address _arg2, uint256 _arg3, uint256 _arg4, uint256 _arg5, uint256 _arg6, address _arg7, address _arg8);
//
//    function MKT_getOfferStats(uint256 tokenId, address offerer, uint256 price, uint256 position) public {
//        uint256 currentOffer = offers[tokenId][offerer];
//        emit OfferStats(ownerOf(tokenId) == msg.sender, currentOffer != 0, currentOffer == price, offerer == offerAddressPositions[tokenId][position]);
//        emit OfferStatComponents(ownerOf(tokenId), msg.sender, currentOffer, 0, currentOffer, price, offerer, offerAddressPositions[tokenId][position]);
//    }
