...
contract FakemeLowergas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FakemeLowergas", "Fm") {
    setHiddenMetadataUri("ipfs://QmWdXPebusmKmXfDp2RGZbirgiqyJJxSTAqzixXAYxKHpc/hidden.json");
  }
