...
contract UEPlots is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	function getWhitelist() public view returns (address[] memory _adds, uint256[] memory _tokenIDs) {
		...
		for(uint i = 0; currentAddress != GUARD; i++){
	...
	function getFromWhitelist(address add)
		public
		view
		returns (uint256)
	{
	...
	function mintForAddress(address _receiver) public payable mintCompliance() mintPriceCompliance() onlyOwner {
