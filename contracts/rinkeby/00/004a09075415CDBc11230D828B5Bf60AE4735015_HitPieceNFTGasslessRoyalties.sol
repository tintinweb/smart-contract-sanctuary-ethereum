...
contract HitPieceNFTGasslessRoyalties is  ERC721URIStorage, ERC2981, Ownable, HPApprovedMarketplace, IHPMarketplaceMint {
  ...
  constructor(address _mintAdmin) ERC721("HitPieceNFT3.0", "HPT3.0") ERC2981() {
