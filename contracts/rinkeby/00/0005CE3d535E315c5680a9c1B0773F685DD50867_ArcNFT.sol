...
contract ArcNFT is ERC721, ERC2981, Ownable {
    Pyxis pyxis;
    ...
    function setBatchCount(uint256 _batchCount) external onlyOwner {
        require(
            _batchCount < MAX_SUPPLY - RESERVED_SUPPLY - tokenId.current(),
    ...
    function airdropToken(address to) public onlyOwner returns (bool) {
        require(
        ...
        )
    {
        ...
        require(_isValidBatch(meta.batchCode), "Batch is sold out"); // ?????? suggest message
