...
contract EventPool {
    ...
    payable {
        ...
        ETHUSDPrice =  getLatestPrice() * 1e10; //8 decimal places of the return value
        uint256 ticketPrice = msg.value * ETHUSDPrice;
        uint256 fixedPrice = allEvents[_eventId].price * 1e18; //ticket set price for the event
        require(ticketPrice >= fixedPrice); //checks that enough eth
