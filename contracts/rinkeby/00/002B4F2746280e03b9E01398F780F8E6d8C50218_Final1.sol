...
contract Final1 is ERC721, Ownable, RandomlyAssigned {                                     // ----------change after tests-------------
  
  using Strings for uint256;
  string public baseURI = "https://ipfs.io/ipfs/QmTL7ZL39w6cP8zu1cMYxTfJFDXwg4WdQtEj4Yd1YWVBBe";
  string public baseExtension = ".json";
  uint256 public maxSupply = 50;                                                        // ----------change after tests-------------
  uint256 public maxMintAmount = 20;  
  uint256 public cost = 0.001 ether;                                                    // ----------change after tests-------------
  uint256 public currentSupply = 0;
  bool public paused = true;

constructor() 

    ERC721("Final1", "Final1")
