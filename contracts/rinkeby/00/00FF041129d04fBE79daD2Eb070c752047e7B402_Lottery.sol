...
contract Lottery is VRFConsumerBase, Ownable{
    ...
    AggregatorV3Interface internal ethPriceUsdFeed;
    enum LOTTERY_STATE {
        OPEN,
        CLOSED,
        CALCULATING_WINNER
    ...
    constructor(address _priceFeedAddress, address _vrfCoordinator, address _link, uint256 _fee, bytes32 _keyhash)
        ...
        ethPriceUsdFeed = AggregatorV3Interface(_priceFeedAddress);
    ...
    function getEntranceFee() public view returns(uint256) {
        (,int price,,,) = ethPriceUsdFeed.latestRoundData();
        // this api returns 8 decimals.
