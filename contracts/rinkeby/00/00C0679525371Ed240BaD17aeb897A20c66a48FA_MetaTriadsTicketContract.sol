...
contract MetaTriadsTicketContract is Ownable {
    ...
    uint256 public phaseOneStartTime = 1647289800 - marginOfSafety;
    uint256 public phaseOneDuration = 30 minutes;
    uint256 public phaseTwoStartTime = 1647291600 - marginOfSafety;
    uint256 public phaseTwoDuration =  30 minutes;
    ...
    uint256 public startTimeOpen = 1647293400 - marginOfSafety;
    ...
    bytes32 public merkleRoot = 0xe5e8db5610721823a4c941a633935f7ce2af808ac9faa84e85aeb81e17398ab8;
    ...
    /**
     * @dev Caculates the Triads left from phase one sale
     */
    ...
    /**
     * @dev Calculates the Traids left from phase two sale
     */
    ...
    /**
     * @dev Calculates the supply of public sale based 
     * on what's left from phase one and phase two.
     */
    ...
    /**
     * @dev Calculates the Triads left from public sale
     */
