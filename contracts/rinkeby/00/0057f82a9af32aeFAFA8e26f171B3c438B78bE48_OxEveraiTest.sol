...
contract OxEveraiTest is Ownable, ERC721A, ReentrancyGuard {
    uint256 mintCost = 3000000000000000;
    uint256 collectionSize = 7777;
    bool publicMintActive = false;
    address private paymentAddress = 0xcF32bC9f4878FAe1d1f9B9212db64b8E5695FbB6; // @TODO: update
    address private paymentAddressDev = 0xcF32bC9f4878FAe1d1f9B9212db64b8E5695FbB6; // @TODO: update

    constructor() ERC721A("0xEveraiTest", "0xEveraiNFTTest") {} // @TODO: update
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        // return string(abi.encodePacked(_baseTokenURI, "/", string(abi.encodePacked(lastDigit)), ".json"));
    }
