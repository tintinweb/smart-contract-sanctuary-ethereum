...
contract Crypto3dTest is ERC721, Pausable, Ownable, ERC721Burnable {
        ...
        whenNotPaused
    {
        ...
        if (msg.sender != owner()) {
            if (_quantity == 1) {
                require(
                    msg.value >= amountInEthers[Round][0],
                    "Not enough ethers"
                );
            } else if (_quantity == 2) {
                require(
                    msg.value >= amountInEthers[Round][1],
                    "Not enough ethers"
                );
            } else if (_quantity == 3) {
                require(
                    msg.value >= amountInEthers[Round][2],
                    "Not enough ethers"
                );
            } else if (_quantity == 4) {
                require(
                    msg.value >= amountInEthers[Round][3],
                    "Not enough ethers"
                );
            } else if (_quantity == 5) {
                require(
                    msg.value >= amountInEthers[Round][4],
                    "Not enough ethers"
                );
            } else if (_quantity == 10) {
                require(
                    msg.value >= amountInEthers[Round][5],
                    "Not enough ethers"
                );
            }
        }
            ...
            if (_quantity == 1) {
                require(
                    ERC20(CryptoCurrencies[token]).balanceOf(msg.sender) >=
                        amountInCryptoCurrency[token][Round][0],
                    "Not enough Tokens"
                );
                ...
                require(
                    ERC20(CryptoCurrencies[token]).balanceOf(msg.sender) >=
                        amountInCryptoCurrency[token][Round][1],
                    "Not enough Tokens"
                );
                ERC20(CryptoCurrencies[token]).transferFrom(
                    msg.sender,
                ...
                require(
                    ERC20(CryptoCurrencies[token]).balanceOf(msg.sender) >=
                        amountInCryptoCurrency[token][Round][2],
                    "Not enough Tokens"
                );
                ERC20(CryptoCurrencies[token]).transferFrom(
                    msg.sender,
                ...
                require(
                    ERC20(CryptoCurrencies[token]).balanceOf(msg.sender) >=
                        amountInCryptoCurrency[token][Round][3],
                    "Not enough Tokens"
                );
                ERC20(CryptoCurrencies[token]).transferFrom(
                    msg.sender,
                ...
                require(
                    ERC20(CryptoCurrencies[token]).balanceOf(msg.sender) >=
                        amountInCryptoCurrency[token][Round][4],
                    "Not enough Tokens"
                );
                ERC20(CryptoCurrencies[token]).transferFrom(
                    msg.sender,
                ...
                require(
                    ERC20(CryptoCurrencies[token]).balanceOf(msg.sender) >=
                        amountInCryptoCurrency[token][Round][5],
                    "Not enough Tokens"
                );
                ERC20(CryptoCurrencies[token]).transferFrom(
                    msg.sender,
