...
contract svgManip {
    ...
    function breedProkaryote(uint256 tokenId, uint64 tokenGen) external view returns (uint256) {
        ...
        uint256 rand = _random(abi.encodePacked(Strings.toString(tokenGen), Strings.toString(block.timestamp), "BREED CELLS", _seed_phrase, Strings.toString(tokenId))) % 100;
    ...
    function breedEukaryotes(uint256 tokenId1, uint256 tokenId2, uint64 tokenGen1, uint64 tokenGen2) external view returns (uint256, uint256) {
        ...
        uint256 rand = _random(
            abi.encodePacked("BREED EUKARYOTE CELLS", Strings.toString(tokenId1), Strings.toString(tokenId2), 
            _seed_phrase, Strings.toString(tokenGen1), Strings.toString(tokenGen2))
        ) % 100;
