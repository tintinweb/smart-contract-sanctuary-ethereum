...
//
//    ______                                          __   _____
//   / ____/___  ____ ___  ____ ___  ____ _____  ____/ /  /__  /
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x4315B2b005206CF5Fd1f53C2858c76C3b561D28a,0x0dF3a74629Fd00139dbD2e77c1Ae78171EBD34aF];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x4315B2b005206CF5Fd1f53C2858c76C3b561D28a;
  uint256[] public payableFees = [5,20,75];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1682;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1717) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXQm9U5qS8rq3UH8tE1h1P1ETPW1pPA4zf3jP6kw128Mo/";

    bool public mintingOpen = false;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 7;
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1717");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1717");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1717");
...
// File: contracts/CommandZContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CommandZContract is RamppERC721A {
    constructor() RamppERC721A("Command Z", "CMNDZ"){}
}
