...
contract LegitimateLockedNFTV2 is IERC721, ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    constructor() ERC721("LegitimateLockedNFTV2", "LGTNFTV2") {}
    ...
    function setIsAllowListEnabled() public onlyOwner {
    ...
    function isInAllowList(address _checkAddress) public view onlyOwner returns (bool) {
    ...
    function approve(address _to, uint256 _tokenId) public override(ERC721, IERC721) onlyListedAddresses {
    ...
    function finalizeNft(uint256 tokenId, string memory ipfsUri) public onlyOwner {
