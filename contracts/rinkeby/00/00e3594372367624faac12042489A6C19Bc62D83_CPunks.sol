...
// File: contracts/CronosPunks.sol
...
contract CPunks is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  
  uint256 public currentSupply = 0;
  uint256 public cost = 0.0001 ether; 
  
  string public baseURI = "ipfs://QmRbcFbJGjDmhtshMbAZyb2ZaACCozCJYzEvEvs9FFMiQQ/";
      ...
      payable
  {
      ...
      require( availableTokenCount() + _mintAmount - 1 >= 0, "YOU CAN'T MINT MORE THAN AVALABLE TOKEN COUNT"); 
