...
contract KeyGateway is IKeyGateway, Ownable {
    ...
    mapping(address => bool) nftsContracts;

    modifier isNftContract() {
        require(
            nftsContracts[msg.sender] == true,
    ...
    function updateNftContractStatus(address _contract, bool _active)
        external
        onlyOwner
    {
        nftsContracts[_contract] = _active;
    }

    function updateCollectionStatus(address _contract, bool _active)
        external
        onlyOwner
    {
