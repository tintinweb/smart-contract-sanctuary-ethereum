...
contract AzukiTest1 is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("AzukiTest1", "AuzkiTest1", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant AUCTION_START_PRICE = 0.011 ether;
