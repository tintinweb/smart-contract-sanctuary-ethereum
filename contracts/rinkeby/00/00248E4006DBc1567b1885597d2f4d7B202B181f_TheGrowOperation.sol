...
contract TheGrowOperation is Ownable, IERC721Receiver, ReentrancyGuard {
	...
	uint256 public DAILY_TOKE_RATE = 7499 ether;
	...
	// there will only ever be (roughly) 2.4 billion $TOKE earned through staking
	uint256 public constant MAXIMUM_GLOBAL_TOKE = 2400000000 ether;
	...
	// start of stake time
	uint256 public stakeStartTime = block.timestamp - 1; // TODO: change to real;
