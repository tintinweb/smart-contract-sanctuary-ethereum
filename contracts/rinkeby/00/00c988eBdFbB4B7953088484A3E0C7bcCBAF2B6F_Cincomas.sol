...
contract Cincomas is ERC721, Ownable {
    ...
    address private constant KoalaMintDevAddress = 0x28ce592CcA596E3030b9697420917470833231FF;
    address private constant CreatorAddress = 0x5D9B989e4DD1cf08268DCA928Dbe5A29681457BE;
    address private constant SignerAddress = 0x28ce592CcA596E3030b9697420917470833231FF;
    ...
    constructor(string memory _baseURIextended) ERC721("CINCOMAS", "CINCOMAS"){
    ...
    function signatureSignerMint(address _to, string memory _tokenURI, uint256 _timestamp, uint value, uint8 v, bytes32 r, bytes32 s) public view virtual returns (address){
        return ECDSA.recover(keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", keccak256(abi.encode(_to, _tokenURI, _timestamp, value)))), v, r, s);
    }
    ...
    function mint(address _to, string[] memory _tokensURI, uint256 _timestamp, uint8 v, bytes32 r, bytes32 s) public payable {
        ...
        address signerMint = signatureSignerMint(_to, _tokensURI[0], _timestamp, msg.value, v, r, s);
