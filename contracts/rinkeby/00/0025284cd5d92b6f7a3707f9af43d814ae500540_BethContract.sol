...
//-------------END DEPENDENCIES------------------------//
  ...
  */
  ...
  abstract contract Allowlist is Ownable {
    ...
    bool public onlyAllowlistMode = true;
     ...
     */
    function updateOGMerkleRoot(bytes32 _newMerkleRoot) public onlyOwner {
      require(_newMerkleRoot != OGmerkleRoot, "Merkle root will be unchanged!");
      OGmerkleRoot = _newMerkleRoot;
    }

    function updateWLMerkleRoot(bytes32 _newMerkleRoot) public onlyOwner {
      require(_newMerkleRoot != WLmerkleRoot, "Merkle root will be unchanged!");
      WLmerkleRoot = _newMerkleRoot;
    }

    function updateFreeMintMerkleRoot(bytes32 _newMerkleRoot) public onlyOwner {
      require(_newMerkleRoot != FreeMintmerkleRoot, "Merkle root will be unchanged!");
      FreeMintmerkleRoot = _newMerkleRoot;
    }
     ...
     */
    function OGisAllowlisted(address _to, bytes32[] calldata _merkleProof) public view returns(bool) {
      require(OGmerkleRoot != 0, "Merkle root is not set!");
      bytes32 leaf = keccak256(abi.encodePacked(_to));

      return MerkleProof.verify(_merkleProof, OGmerkleRoot, leaf);
    }

    function WLisAllowlisted(address _to, bytes32[] calldata _merkleProof) public view returns(bool) {
      require(WLmerkleRoot != 0, "Merkle root is not set!");
      bytes32 leaf = keccak256(abi.encodePacked(_to));

      return MerkleProof.verify(_merkleProof, WLmerkleRoot, leaf);
    }

    function FreeMintisAllowlisted(address _to, bytes32[] calldata _merkleProof) public view returns(bool) {
      require(FreeMintmerkleRoot != 0, "Merkle root is not set!");
      bytes32 leaf = keccak256(abi.encodePacked(_to));
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1657897860;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656691200;
...
abstract contract Withdrawable is Ownable{
  address[] public payableAddresses = [0xb4a9391C658bc1d5a4fd7928c5306d16046141f8];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0045 ether;
  uint256 public earlyMintTokenIdCap = 2;
  bool public usingEarlyMintIncentive = true;

  uint256 public OG_MINT_PRICE = 0.0045 ether;
  uint256 public OGMintTokenIdCap = 1;
  bool public usingOGMintIncentive = true;

  uint256 public FREE_MINT_PRICE = 0 ether;
  uint256 public FreeMintTokenIdCap = 7;
  bool public usingFreeMintIncentive = true;

  string public _activeMinter = "OG";
  uint256 public MintTokenIdCap = 15;

  function activeMinter() public view returns(string memory) {
  ...
  function enableOGMintIncentive() public onlyOwner {
    usingOGMintIncentive = true;
  }

  function disableOGMintIncentive() public onlyOwner {
    usingOGMintIncentive = false;
  }

  function enableFreeMintIncentive() public onlyOwner {
    usingFreeMintIncentive = true;
  }

  function disableFreeMintIncentive() public onlyOwner {
    usingFreeMintIncentive = false;
  }
  ...
  */
  ...
  function setOGMintTokenIdCap(uint256 _newTokenIdCap) public onlyOwner {
    require(_newTokenIdCap <= collectionSize, "Cannot set incentive tokenId cap larger than totaly supply.");
    require(_newTokenIdCap >= 1, "Cannot set tokenId cap to less than the first token");
    OGMintTokenIdCap = _newTokenIdCap;
  }

  function setFreeMintTokenIdCap(uint256 _newTokenIdCap) public onlyOwner {
    require(_newTokenIdCap <= collectionSize, "Cannot set incentive tokenId cap larger than totaly supply.");
    require(_newTokenIdCap >= 1, "Cannot set tokenId cap to less than the first token");
    FreeMintTokenIdCap = _newTokenIdCap;
  }
  ...
  */
  ...
  function setOGIncentivePrice(uint256 _feeInWei) public onlyOwner {
    OG_MINT_PRICE = _feeInWei;
  }

  function setFreeIncentivePrice(uint256 _feeInWei) public onlyOwner {
    FREE_MINT_PRICE = _feeInWei;
  }
  ...
  */
  ...
  function getPrice(uint256 _count) public view returns (uint256) {
    ...
    if(
      ...
      currentTokenId() > OGMintTokenIdCap ||
      currentTokenId() > FreeMintTokenIdCap
    ) {
      return PRICE * _count;
    }
    ...
    } else if (endingTokenId  <= OGMintTokenIdCap) {
      return OG_MINT_PRICE * _count;
    } else if (endingTokenId  <= FreeMintTokenIdCap) {
      return FREE_MINT_PRICE * _count;
    }
    ...
    if (keccak256(abi.encodePacked(activeMinter()))  == keccak256(abi.encodePacked("WL"))){
        uint256 WLincentiveTokenCount = earlyMintTokenIdCap - currentTokenId();
        uint256 WLoutsideIncentiveCount = endingTokenId - earlyMintTokenIdCap;

        return (EARLY_MINT_PRICE * WLincentiveTokenCount) + (PRICE * WLoutsideIncentiveCount);   

    } else if (keccak256(abi.encodePacked(activeMinter()))  == keccak256(abi.encodePacked("OG"))){
        uint256 OGincentiveTokenCount = OGMintTokenIdCap - currentTokenId();
        uint256 OGoutsideIncentiveCount = endingTokenId - OGMintTokenIdCap;  

        return (OG_MINT_PRICE * OGincentiveTokenCount) + (PRICE * OGoutsideIncentiveCount);  

    } else if (keccak256(abi.encodePacked(activeMinter()))  == keccak256(abi.encodePacked("FM"))){
        uint256 FMincentiveTokenCount = FreeMintTokenIdCap - currentTokenId();
        uint256 FMoutsideIncentiveCount = endingTokenId - FreeMintTokenIdCap; 

        return (FREE_MINT_PRICE * FMincentiveTokenCount) + (PRICE * FMoutsideIncentiveCount);  
    }
...
abstract contract BethERC721A is 
    Ownable,
    ERC721A,
    Withdrawable,
    ReentrancyGuard 
    ...
    , TimedDrop
{
  constructor(
    ...
    */
    function mintToAL(address _to, bytes32[] calldata _merkleProof) public payable {
        ...
        require(WLisAllowlisted(_to, _merkleProof), "Address is not in Allowlist!");
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5000");
        require(canMintAmount(_to, 1), "Wallet address is over the maximum allowed mints");
        require(msg.value == getPrice(1), "Value needs to be exactly the mint fee!");
    ...
    function mintToOG(address _to, bytes32[] calldata _merkleProof) public payable {
        require(onlyAllowlistMode == true && mintingOpen == true, "Allowlist minting is closed");
        require(OGisAllowlisted(_to, _merkleProof), "Address is not in Allowlist!");
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5000");
        require(canMintAmount(_to, 1), "Wallet address is over the maximum allowed mints");
        require(msg.value == getPrice(1), "Value needs to be exactly the mint fee!");
        require(allowlistDropTimePassed() == true, "Allowlist drop time has not passed!");
    ...
    function mintToFM(address _to, bytes32[] calldata _merkleProof) public payable {
        require(onlyAllowlistMode == true && mintingOpen == true, "Allowlist minting is closed");
        require(FreeMintisAllowlisted(_to, _merkleProof), "Address is not in Allowlist!");
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5000");
        require(canMintAmount(_to, 1), "Wallet address is over the maximum allowed mints");
        require(msg.value == getPrice(1), "Value needs to be exactly the mint fee!");
        require(allowlistDropTimePassed() == true, "Allowlist drop time has not passed!");
    ...
    * @param _amount number of tokens to mint
    */
    function mintToMultipleOG(address _to, uint256 _amount, bytes32[] calldata _merkleProof) public payable {
    ...
    function mintToMultipleFM(address _to, uint256 _amount, bytes32[] calldata _merkleProof) public payable {
  ...
  function setActiveMinter(string memory ACMinter) external onlyOwner {
    _activeMinter = ACMinter;
  }
...
// File: contracts/BethContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BethContract is BethERC721A {
    constructor() BethERC721A("BATANG BATA", "BB"){}
}