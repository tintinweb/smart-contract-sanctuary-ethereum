...
contract HODLArcadeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x528e20CB9890343Eaa34c44A0c1022D901DC2F3b); // Marketing Address
    ...
    string private _name = "HODL Arcade Token";
    ...
    uint256 public _liquidationThreshold = 50000 * 10**18;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D //Quickswap Router address
        );
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        uint256 marketingShare = contractTokenBalance;
    ...
    function _removeSniper(address account) external onlyOwner {
        require(
            ...
            "We can not blacklist Quickswap"
        );
