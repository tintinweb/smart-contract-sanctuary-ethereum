...
contract SendToken {
    ...
    // function SednEther(address receiver,uint256 amount) external {
    //     addrees(this).call{value: amount}("");
    ...
    function sendTokens(uint _amount,address to) external {
        _token.transferFrom(msg.sender, to, _amount);
    ...
    // function swapTokensForExactTokens( uint256 amountOut, uint256 amountInMax,  address receiver) external {
    //     address[] memory path = new address[](2);
    //     path[0] = TokenOut;
    //     path[1] = TokenOut;
