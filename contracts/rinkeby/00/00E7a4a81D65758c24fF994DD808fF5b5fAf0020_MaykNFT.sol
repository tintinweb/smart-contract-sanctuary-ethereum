...
contract MaykNFT is ERC721, ERC721Royalty, ContextMixin, Ownable {
    ...
    // Mint tokenId to address specified
    // @param ownerAddress address to send the NFT to.
    // @param royaltyAddress address for creator royalties
    ...
    function mint(
        ...
        _setTokenRoyalty(tokenId, royaltyAddress, _feeDenominator() / 10);
