...
contract Membership is ERC1155, Pausable, AccessControlEnumerable {
    ...
    constructor(string memory _uri, address payable _beneficiary, address _signer) ERC1155(_uri) {
        ...
        setTier(5, "Royal", 1.0, 100);
        setTier(4, "Black", 1.0, 100);
        setTier(3, "Diamond", 1.0, 1000);
        setTier(2, "Gold", 1.0, 1000);
        setTier(1, "Silver", 1.0, 1000);
    }
