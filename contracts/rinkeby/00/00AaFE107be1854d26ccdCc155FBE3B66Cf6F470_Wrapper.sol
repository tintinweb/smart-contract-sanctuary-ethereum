...
contract Wrapper is Ownable, IERC721Receiver, ERC1155Holder {
    ...
    event GotERC1155(address from, address operator, uint256 id);
    ...
    function onERC721Received(
        ...
        require(operator == fivelines, "Token is not from the Five Lines collection");
    ...
    function onERC1155Received(
        ...
        //require(operator == openstore, "ERC1155 not from Opensea's shared contract");
        emit GotERC1155(from, operator, id);
    ...
    function onERC1155BatchReceived(
        ...
        //require(operator == openstore, "ERC1155 batch not from Opensea's shared contract");
