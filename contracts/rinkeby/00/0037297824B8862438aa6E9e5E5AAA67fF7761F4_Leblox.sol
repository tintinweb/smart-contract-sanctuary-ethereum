...
contract Leblox is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable {
  using Counters for Counters.Counter;

  Counters.Counter private _tokenIDsCount;

  constructor() ERC721('Leblox', 'LBX') {}
  ...
  function mint(string memory uri) public returns (uint256) {
    ...
    uint256 tokenID = _tokenIDsCount.current();
