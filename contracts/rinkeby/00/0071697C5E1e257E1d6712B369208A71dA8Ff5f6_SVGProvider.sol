  ...
  function generateScreen() internal pure returns (bytes memory) {
    return
      bytes.concat(
        ...
        '<rect x="700" y="815" width="116" height="33"/>',
        "</g>",
        "</g>",
        "</g>"
      );
  ...
  function generateTitle(
    ...
    return
      bytes.concat(
        ...
        "</g>",
        "<g>",
        abi.encodePacked('<text class="colB" style="font-size:32px;font-weight:bold;font-family: \'Courier New\',monospace;" text-anchor="middle" transform="translate(758,840)">', Combine.generateTokenId(_tokenId), "</text>"),
        "</g>",
        "</g>",
        "</g>"
      );
