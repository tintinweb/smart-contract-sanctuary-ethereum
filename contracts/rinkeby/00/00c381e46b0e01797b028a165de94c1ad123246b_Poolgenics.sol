...
contract Poolgenics is ERC20, Ownable {
    ...
    uint256 public currentFeeDecay = 0;
    ...
    constructor() ERC20("Poolgenics", "PLGN2") {
        	
    	marketingWallet = 0xd7d7174D325CEC315C7Ac03Fd22c85C9127969b9; 
    	usdcDividendToken = 0xC8963B3768c75465f39F90fA46645054d98E6CaB; 
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), usdcDividendToken);
    ...
    function handleSell(uint256 amount) public returns (uint256) {
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            fees = tmpMarketingRewardPercent.add(tmpUsdcDividedRewardsInContract)
                            .add(tmpLpRewardInContract); // Total number of tokens to take
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        uint256 initialBalance = IERC20(usdcDividendToken).balanceOf(address(this)).sub(usdcDividedRewardsInContract);
 
        swapTokensForUSDC(half);
 
        uint256 newBalance = IERC20(usdcDividendToken).balanceOf(address(this)).sub(initialBalance).sub(usdcDividedRewardsInContract);
    ...
    function addLiquidity(uint256 tokenAAmount, uint256 tokenBAmount) private {
        ...
        _approve(usdcDividendToken, address(uniswapV2Router), tokenBAmount);
    ...
    function swapAndSendUsdcDividends(uint256 tokens) public {
