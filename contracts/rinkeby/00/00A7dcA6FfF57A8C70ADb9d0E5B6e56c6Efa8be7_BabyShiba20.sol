...
contract BabyShiba20 is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 private maxTotalTokens = 50;
    ...
    address private dummy = 0x2dB6569D44F5DEb488EF6288Ecd45bC57c11c2fe;
	address public constant account1 = 0x548e60F9694D90a26c27aB5f05FD3b52e8210B06;
    ...
    constructor() ERC721A("BabyShiba20", "BS"){
        unrevealedURI = "ipfs://.../";
    }
