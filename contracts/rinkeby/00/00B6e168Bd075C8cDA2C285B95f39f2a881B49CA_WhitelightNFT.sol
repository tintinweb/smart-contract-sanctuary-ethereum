...
contract WhitelightNFT is ERC721AQueryable, BaseTokenURI {
  ...
  uint256 public distribution1Percentage;
  uint256 public distribution2Percentage;
  ...
  constructor(
    ...
    uint256 _mintPrice,
    uint256 _distribution1Percentage,
    uint256 _distribution2Percentage,
    ...
    require(
      _distribution1Percentage + _distribution2Percentage == FEE_DENOMINATOR,
      "Percentages must add up to FEE_DENOMINATOR"
    );
    mintPrice = _mintPrice;
    distribution1Percentage = _distribution1Percentage;
    distribution2Percentage = _distribution2Percentage;
  ...
  function mint(uint256 _mintAmount) external payable {
    ...
    distributeFunds(distribution1address, costNative, distribution1Percentage);
    distributeFunds(distribution2address, costNative, distribution2Percentage);
  }
  ...
  function setDistributionPercentage(uint256 _distribution1Percentage, uint256 _distribution2Percentage)
    external
    onlyOwner
  {
    require(
      _distribution1Percentage + _distribution2Percentage == FEE_DENOMINATOR,
      "Distribution percentages must add up to FEE_DENOMINATOR"
    );
    distribution1Percentage = _distribution1Percentage;
    distribution2Percentage = _distribution2Percentage;
  }
