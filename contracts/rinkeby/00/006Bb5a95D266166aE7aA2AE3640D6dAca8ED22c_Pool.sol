...
contract Pool is Ownable, IERC721Receiver, Pausable {
     ...
     */
    function claimManyFromPool(address collection, uint16[] calldata tokenIds, bool unstake)
        external
        whenNotPaused
    {
        require(tx.origin == _msgSender());
    ...
    function setCollectionData(CollectionData memory _collectiondata) public onlyOwner {
        collectionDataMap[_collectiondata.collection] = CollectionData(
            ...
            _collectiondata.totalNFTStaked,
            _collectiondata.minimumToExit,
            _collectiondata.collection,
            _collectiondata.isStakable
            );
