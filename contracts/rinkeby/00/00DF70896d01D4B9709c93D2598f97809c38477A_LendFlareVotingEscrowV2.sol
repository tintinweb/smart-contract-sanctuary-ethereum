    ...
    ILendFlareVotingEscrow
{
    ...
    function _depositFor(
        ...
        uint256 oldTotalSupply = totalLockedSupply;
        ...
        totalLockedSupply = totalLockedSupply.add(_amount);
        ...
        emit TotalSupply(oldTotalSupply, totalLockedSupply);
    }
    ...
    function withdraw() public nonReentrant {
        ...
        totalLockedSupply = totalLockedSupply.sub(lockedAmount);
