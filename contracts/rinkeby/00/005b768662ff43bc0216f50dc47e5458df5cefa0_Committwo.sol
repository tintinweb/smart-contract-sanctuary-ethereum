...
contract Committwo is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Commit two", "CM2") {
        setBaseURI("ipfs://QmXxU5fbqHQCA5f7BoLucSXP4rsjQNSiHoF9X6sQTXxJva/");
