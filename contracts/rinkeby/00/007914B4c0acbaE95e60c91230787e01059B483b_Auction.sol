...
contract Auction is AccessControl, Pausable {
    ...
    constructor(address daoMultisig, IAllocationMinter token_, bytes32 allocationRole_, uint secondsPerAuction_, address payable destAddress_) {
        ...
        _grantRole(AUCTIONEER_ADMIN_ROLE, daoMultisig);
