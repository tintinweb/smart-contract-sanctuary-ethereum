...
contract PresaleFactory is Ownable {
    ...
    uint256 public minCap                                  = 500 * 10 ** 18;
    uint256 public maxCap                                  = 1000 * 10 ** 18;
    uint256 public pTokenPrice_USDC                        = 8 * 10 ** 15;
    uint256 public pTokenPrice_AVAX                        = 954996 * 10 ** 8;
    ...
    function presale(uint256 _amountToken, uint cType) external payable {
        ...
        pAstro.transferFrom(address(this), msg.sender, _amountToken);
