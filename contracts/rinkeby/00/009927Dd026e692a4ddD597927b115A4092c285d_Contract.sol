...
contract Contract is ERC721, Ownable {
  ...
  string public uriPrefix = "ipfs://QmSxfWHT5Kxvc13ZEZGj1kHRwSMjVo4iCQTn2kDFsb29N7/";
  ...
  bytes32 public whitelistMerkleRoot = 0x6d2a9212c578089f4acb26e1c619a4529d2eec0a4ccfd2946c15d7005aadfa86;
  mapping(address => bool) public whitelistClaimed;


  constructor() ERC721("Fortune Cookies of Fortune Genesis Collection", "FCOF") {
  ...
  function whitelistMint(bytes32[] calldata _merkleProof) public payable {
    require(!whitelistPaused, "The contract is paused for whitelist mint!");
