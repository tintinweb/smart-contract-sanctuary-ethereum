...
contract SplitManagerTrue is BaseGovernanceWithUserUpgradable, ISplitManager {
    ...
    function __SplitManagerTrue_init(ILock _lock, address governanceAddress) internal initializer {
        __BaseGovernanceWithUser_init(governanceAddress);
        __SplitManagerTrue_init_unchained(_lock);
    }

    function __SplitManagerTrue_init_unchained(ILock _lock) internal initializer {
