...
contract TestDrc is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  // ERC721 params
  string private _name = "TestDrc";
  string private _symbol = "TestDrc";
  string private _baseTokenURI = "";

  // Collection params
  uint256 public TOTAL_SUPPLY = 20;
  uint256 public total_supply = TOTAL_SUPPLY;
  uint256 public presale1_supply = 5;
  uint256 public presale2_supply = 5;

  uint256 private price = 0.09 ether;
  uint256[4] private MAX_PER_STATUS = [0, 2, 3, 10];
  ...
  modifier qtyValidation(uint256 _qty) {
    ...
    require(total_supply > 0, "Collection is sold out");
    require(_qty <= total_supply, "Not enough NFTs available");
    ...
    )
  {
    ...
    if (status == MintStatus.PUBLIC) {
      return ("PUBLIC", maxStatus, _price, total_supply);
      ...
      return ("CLOSED", _remainingToMint, _price, total_supply);
    }
  }
