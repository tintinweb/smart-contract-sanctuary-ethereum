...
contract tanjiro is Context, IERC20, Ownable {
    ...
    uint256 private _liqFee = _liqFeeOnSell;
    ...
    address payable private _marketingAddress = payable(0x77EF6C8E5EA1D6a5Bf4d483f8B6687d92419011F);  //payable(0x782f303d1fE1aaAa44798d0B3c8A26CF63ae4034);
    ...
    constructor(address tokenOwner) {
        ...
        _tokenTransfer(_msgSender(), tokenOwner , _tTotal, false);
    ...
    function removeAllFee() private {
        if (_redisFee == 0 && _taxFee == 0 && _liqFee == 0) return;
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            }  else if (to == uniswapV2Pair && from != address(uniswapV2Router)) { //Set Fee for Sells
