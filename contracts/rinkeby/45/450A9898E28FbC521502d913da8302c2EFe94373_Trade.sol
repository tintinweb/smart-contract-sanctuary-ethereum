...
contract Trade is AccessControl {
    ...
    */
        ...
        returns (bool)
    {
        ...
        Fee memory fee = order.directPay ? getFees(msg.value, order.nftType, order.nftAddress, order.tokenId)
                                         : getFees(order.amount, order.nftType, order.nftAddress, order.tokenId);
        ...
        tradeAsset(order, fee, buyer, order.seller, order.directPay);
    ...
    */
        ...
        returns (bool)
    {
        ...
        tradeAsset(order, fee, order.buyer, seller, false);
    ...
    */
    ...
    function tradeAsset(
        ...
        directPay ? payout(seller, fee.assetFee)
            : transferProxy.erc20safeTransferFrom(
                IERC20(order.erc20Address),
                buyer,
                seller,
