  ...
  IERC721Enumerable
{
  ...
  uint256 private  price_A = 0.08 ether; //0.18 ether presale , 0.23 eth public 
  uint256 private  price_B = 0.11 ether; //0.18 ether presale , 0.23 eth public 
  uint256 private  price_C = 0.20 ether; //0.18 ether presale , 0.23 eth public 
  ...
  function typeAPrice() public view returns (uint256) {
    return price_A;
  } 

  function typeBPrice() public view returns (uint256) {
    return price_B;
  } 

  function typeCPrice() public view returns (uint256) {
    return price_C;
  } 
  ...
  function _price_A(uint256 price) internal {
    price_A=price;
  } 
  function _price_B(uint256 price) internal {
    price_B=price;
  } 
  function _price_C(uint256 price) internal {
    price_C=price;
  } 
...
contract NatashatiniNFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor() ERC721A("BP NFT","BP NFT BP", MaxMintPerBatch_, TotalCollectionSize_) {
