...
contract ApeInForUkraine is ERC721URIStorage, Ownable {
    ...
    ERC721("ApeInForUkraine", "APEUA"){
        ...
        _collections[1] = Collection(1, 0, 1000, "");
        _collections[2] = Collection(1, 0, 1000, "");
        _collections[3] = Collection(1, 0, 1000, "");
    }
    ...
    function mint(uint count, uint collectionId) external payable {
        ...
        require(_tokenIds.current() + count <= collection.size, "APEUA: Number of requested tokens will exceed limit");
