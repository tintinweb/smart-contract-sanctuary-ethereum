...
contract XDA13 is IERC20, Auth {
	string constant _name = "XDA13";
	string constant _symbol = "X Da 13";
	...
	function _openTrading() internal {
		...
		settings.maxTxAmount     = 25 * _totalSupply / 10000 + 10**_decimals; 
		settings.maxWalletAmount = 50 * _totalSupply / 10000 + 10**_decimals;
		settings.taxRateBuy = 7;
		settings.taxRateSell = 15;
		settings.taxRateTransfer = 7; 
		_tradingOpen = true;
	}
