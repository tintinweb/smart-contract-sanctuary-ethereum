...
// File: contracts/wtfnothingtown.sol
...
contract WTFNothingTown is ERC721A, Ownable {

    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant MAX_MINTS = 3;
    uint256 public constant MAX_SUPPLY = 444;
    uint256 public constant MAX_FREE_SUPPLY = 333;
    uint256 public mintRate = 0.003 ether;

    bool public paused = true;

    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    string public baseURI = "ipfs://QmV3QwxRJTe1cJ6ZmaGaJmkKLk6htonPZxLwkT6vgcktWK/";
    string public constant baseExtension = ".json";

    // Mapping owner address to address data
    mapping(address => AddressData) private _addressData;

    constructor() ERC721A("WTFNothingTown", "WNT") {}
