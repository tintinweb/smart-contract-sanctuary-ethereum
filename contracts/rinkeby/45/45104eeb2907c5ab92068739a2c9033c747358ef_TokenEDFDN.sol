...
contract TokenEDFDN is ERC721, Ownable {
	...
	string public baseURI = "ipfs://QmUrGxiahsVHnYFAvbm5Ua8aKN4Fnd7BYEiUZpq62fePfv/";
	...
	uint256 public constant MINT_PRICE = 0.00004 ether;

	bool private _locked = false; // for re-entrancy guard

	// Initializes the contract by setting a `name` and a `symbol`
	constructor() ERC721( "6Match number #64. Final. Lusail Stadium (First category)" , "LSFCSF" ) {
		_supply.increment();
