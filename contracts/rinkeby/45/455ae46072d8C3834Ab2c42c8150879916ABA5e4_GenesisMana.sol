...
contract GenesisMana is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  using strings for strings.slice;
   ...
   uint32 private _currentLostGenesisMana = 0;
    ...
    constructor(address lootContractAddress) ERC721("Genesis Mana", "GMANA") Ownable() {
        _lootContract = LootInterface(lootContractAddress);
    }
      ...
      onlyOwner
    {
        ...
        require(
            _currentLostGenesisMana < 2167,
            "NO_GM_LEFT_FOR_TYPE"
        );

        _claim(0, inventoryId, suffixId, _msgSender());
        _currentLostGenesisMana++;
    }
