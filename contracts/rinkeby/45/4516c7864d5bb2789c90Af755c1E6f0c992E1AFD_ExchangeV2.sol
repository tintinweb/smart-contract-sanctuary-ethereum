    ...
    ITransferExecutor
{
    ...
    function transfer(
        ...
        if (asset.assetType.assetClass == LibAsset.ETH_ASSET_CLASS) {
            ...
            ERC20TransferProxy(proxies[LibAsset.ERC20_ASSET_CLASS])
            ...
            TransferProxy(proxies[LibAsset.ERC721_ASSET_CLASS])
            ...
            TransferProxy(proxies[LibAsset.ERC1155_ASSET_CLASS])
