...
contract RarelandWTF is ERC721m, Pausable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 internal constant MAX_SUPPLY = 5000;
    uint256 internal constant MAX_MINT_AMOUNT_PER_TX = 2;
    uint256 internal constant MAX_MINT_AMOUNT_PER_ADDRESS = 2;
    
    constructor() ERC721m("RarelandWTF", "RAREW") {}
