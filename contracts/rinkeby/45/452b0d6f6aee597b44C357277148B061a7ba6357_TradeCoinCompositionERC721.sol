    ...
    ReentrancyGuard
{
    ...
    struct TradeCoinComposition {
        ...
        uint256 cumulativeAmount; // in grams
        bytes32 unit;
        State state;
    ...
    event AddInformationToCompositionEvent(
        uint256 indexed tokenId,
        address indexed functionCaller,
        bytes32 indexed docHashIndexed,
        bytes32[] docHash,
    ...
    function createComposition(
        ...
        uint256 totalAmount;
        bytes32 unitOfTC;
        for (uint256 i; i < _tokenIdsOfTC.length; i++) {
        ...
        for (uint256 tokenId; tokenId < _tokenIds.length; tokenId++) {
            ...
            TradeCoinComposition memory short2 = TradeCoinComposition({
                ...
                transformations: tradeCoinComposition[_tokenIds[tokenId]]
                    .transformations,
                cumulativeAmount: 0,
                unit: tradeCoinComposition[_tokenIds[tokenId]]
                    .unit,
                rootHash: ""
            });
            require(
            ...
            // create temp struct
            cumulativeAmount += tradeCoinComposition[_tokenIds[tokenId]]
                .cumulativeAmount;
        ...
        onlyInformationHandlerOrAdmin
    {
        ...
        for(uint256 _tokenId; _tokenId < _tokenIds.length; _tokenId++){
            ...
            emit AddInformationToCompositionEvent(
                _tokenIds[_tokenId],
                msg.sender,
                _documents.docHash[0],
                _documents.docHash,
    ...
    function mintAfterSplitOrBatch(
        ...
        emit MintAfterSplitOrBatch(id, msg.sender);
    }
