...
contract MegaStake is ERC20, AccessControl, ERC20Capped {
    ...
    constructor() ERC20("MegaStake", "MST") ERC20Capped(2100000000 * (10**18)) {
        ...
        _setupRole(MINTER_ROLE, 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    ...
    require(_StakeHolder[msg.sender] == true);
    uint256 TimeDifference = block.timestamp - _Time;
    uint256 nowReward = (TimeDifference * _StakeBalance[msg.sender] * 3) /
                100 /
                _timeInterval;
      return nowReward;    
    }
    ...
    function ClaimReward() public {
        require(
            block.timestamp >= _StakeTime[msg.sender] + _timeInterval,
            "Time is not yet been completed"
        );
        _StakeTime[msg.sender] = block.timestamp - _StakeTime[msg.sender];
        _Reward[msg.sender] +=
                (_StakeTime[msg.sender] * _StakeBalance[msg.sender] * 3) /
    ...
    function unstake() public {
        _claimedRewards = _Reward[msg.sender];
        _StakeBalance[msg.sender] += _claimedRewards;
    }
