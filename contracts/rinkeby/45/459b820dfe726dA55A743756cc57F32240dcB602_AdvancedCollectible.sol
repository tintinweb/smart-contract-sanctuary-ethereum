...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    //emit events when updating mappings
    ...
    //tokenURI still unknown
    function createCollectible() public returns (bytes32) {
        bytes32 requestId = requestRandomness(keyhash, fee);
        //in mint function, msg.sender would be VRF call. Map owner (original msg.sender) to mint function instead.
        ...
        override
    {
        ...
        // random breed has to be mapped to tokenId
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        //we need 3 tokenURIs
        //only owner of tokenId can update tokenURI
        //isApprovedOrOwner is OpenZeppelin function and checks owner of tokenId
        require(
