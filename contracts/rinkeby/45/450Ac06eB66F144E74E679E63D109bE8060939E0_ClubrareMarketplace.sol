    ...
    EIP712Upgradeable
{
        ...
        onlyApproved(order.contractAddress, order.tokenId, order.seller)
    {
        ...
        uint256 amt = _amount;
        address taker = buyer;
        require(validateAcceptOrder(digest, _order, _bid, taker, _order.signature, amt),"invalid order");
    ...
    function settlement(
        ...
        _executeExchange(_order, msg.sender, taker, sellerEarning, _tokenId);
