...
contract PillarDAO is IPillarDAO {
    using SafeMath for uint;
    ...
    constructor(
        ...
        require(stakingToken_ != address(0), "Invalid staking contract");
        require(stakeAmount_ > 0, "Invalid staking amount");
    ...
    function deposit(uint amount) override external {
        require(amount == stakeAmount, "Invalid staked amount");
        ...
        balances[msg.sender] = Deposit({depositAmount: amount, depositTime: block.timestamp});
