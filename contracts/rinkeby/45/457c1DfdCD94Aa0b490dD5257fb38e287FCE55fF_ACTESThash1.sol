...
contract ACTESThash1 is ERC721, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(MerkleProof.verify(_merkleProof, merkleRoot, leaf) || _toyboogers.balanceOf(msg.sender) > 0, "You're not on the Allow List!");
