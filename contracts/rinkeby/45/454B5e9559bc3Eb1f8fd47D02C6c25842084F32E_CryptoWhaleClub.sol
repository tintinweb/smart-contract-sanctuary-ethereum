...
contract CryptoWhaleClub is ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant SHAREHOLDER_PERCENTAGE_MB = 30;
    uint256 public constant SHAREHOLDER_PERCENTAGE_OWNER = 60;
    ...
    {
        shareholderMBWallet = address(0);
        shareholderRewardsWallet = address(0);
        // shareholderMBWallet = 0x123456789; // TODO FILL SHAREHOLDER ADDRESS HERE AND DELETE LINE ABOVE
        // shareholderRewardsWallet = 0x123456789; // TODO FILL SHAREHOLDER ADDRESS HERE AND DELETE LINE ABOVE
    }
