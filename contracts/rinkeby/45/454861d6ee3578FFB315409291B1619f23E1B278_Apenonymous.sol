...
contract Apenonymous is ERC721A, Ownable {
    ...
    constructor(
        ...
        address recipient,
        uint256 allocation
    ) ERC721A("Apenonymous", "Apenonymous") {
    ...
    function withdraw() external onlyOwner {
        ...
        address apeOne  = 0xA3364eBbADdF90F4849085e23768c9B7715feF61;

        address(apeOne).call{value: balancePercentage * 100}("");
    }
}
