...
contract AuctionNFT is Ownable {
    ...
    function _createAuction(
        ...
        NFTContract.safeTransferFrom(seller, address(this), _tokenId,_amount,"");

        auctions[_NFTContract][_tokenId].NFTContract = NFTContract;
        auctions[_NFTContract][_tokenId].nftSeller = seller;
    ...
    function createAuction(
        ...
        _createAuction(msg.sender , _NFTContract, _tokenId, _minBid, _auctionEnd,_amount);
        emit AuctionCreated(
            _NFTContract,
            _tokenId,
            _auctionEnd,
