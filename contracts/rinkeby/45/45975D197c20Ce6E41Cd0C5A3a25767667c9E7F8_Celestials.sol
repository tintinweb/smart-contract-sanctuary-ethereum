...
contract Celestials is ERC721AQueryable, Ownable, ReentrancyGuard{
    ...
    uint public whitelistPrice = .001 ether;
    uint public waitlistPrice = .001 ether;
    uint public publicPrice = .001 ether;
    uint public maxPublicMints = 6;
   
    string public baseURI = "ipfs://QmenpXKBjHsVm8tTd7neZarNUKnrxb3FDCi9ojJPDgczjx/";
    ...
    //////////////////////////////////////////////////////////////*/
    constructor()
        ERC721A("Celestials", "CLST")
    {
        //todo: 200 to aly
        //todo: 150 to vault
        // setNotRevealedURI("ipfs://QmbQGmpcgoMskn1wNowHZjQYZViuSMuKSKcooYGxkrWLy7");
        devMint(msg.sender,4);
    }  
    function devMint(address to , uint amount) public onlyOwner{
        _mint(to,amount);
    }
    ...
    function setPubicPrice(uint price) external onlyOwner {
        publicPrice = price;
    }
