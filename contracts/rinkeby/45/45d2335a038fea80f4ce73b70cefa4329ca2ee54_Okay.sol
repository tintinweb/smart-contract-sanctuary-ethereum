...
contract Okay is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI="https://ipfs.io/ipfs/QmRBQHFRH122AfmRsQve5bDDT7XEUJTNJqkaZts2wh4Scg/";
  string public baseExtension= ".json";
  uint public          price             = 0.0077 ether;
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more okay ");
    require(mintEnabled, "Minting is not live yet, hold on okay .");
