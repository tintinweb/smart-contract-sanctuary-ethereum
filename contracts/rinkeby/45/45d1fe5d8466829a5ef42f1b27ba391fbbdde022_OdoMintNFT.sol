...
contract OdoMintNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI, uint256 _maxSupply) ERC721("ODONFT", "ODONFT") {
        setBaseURI(_initBaseURI);
        mint(msg.sender, _maxSupply);
    }


    function buyItem(uint256 _tokenId) payable external {
      require(_tokenId <= maxMintAmount, "Token does not exists");
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        // uint256 totalAmount = cost * _mintAmount;
        // token._transfer(msg.sender, "0xc1BBf67b90951be8b1AE852cB45E2175a15CabE8", totalAmount);
