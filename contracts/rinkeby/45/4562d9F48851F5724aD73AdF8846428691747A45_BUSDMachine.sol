...
contract ERC20 is IERC20 {
    ...
    address busd = 0xD92E713d051C37EbB2561803a3b5FBAbc4962431; // TUSDT
...
contract BUSDMachine is Token {
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // N
        ADV_1 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // 0         
        ADV_2 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // E        
        ADV_3 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // o 
        ADV_4 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // au    
        FIN_1 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // S   
        FIND_1 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9; // ll
        MAR_1 = 0xcBB061e0C77142e66B174828f8AFd61d2ffDBab9;  // DESB      
