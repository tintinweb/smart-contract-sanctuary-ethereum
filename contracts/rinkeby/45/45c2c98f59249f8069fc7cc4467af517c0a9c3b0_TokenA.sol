...
contract TokenA is Context, IERC20, Ownable {
    ...
    string private _symbol = "TOKEN_A";
    ...
    function transferFrom(
        ...
        console.log("allowance: %s", _allowances[sender][_msgSender()]);
        _approve(
            sender,
            _msgSender(),
    ...
    function _approve(
        ...
        console.log("_approve - _allowances[owner][spender] : %s", _allowances[owner][spender]);
    ...
    function _transfer(
        ...
        console.log("contractTokenBalance : %s", contractTokenBalance);
        ...
        if (
            ...
            console.log("_transfer - forDevelopment : %s", forDevelopment);
    ...
    function _tokenTransfer(
        ...
        removeAllFee();
        console.log("_tokenTransfer - takeFee : %s", takeFee);

        if (takeFee) {
            require(block.number > lastBlock, "One transfer per block");

            lastBlock = block.number;
            console.log("uniswapV2Pair address : %s", uniswapV2Pair);
    ...
    function _transferStandard(
        ...
        console.log("_transferStandard - tTransferAmount: %s", tTransferAmount);
