...
contract Coinage is Ownable, ERC1155Supply, ReentrancyGuard {
    ...
    event networkMintSuccess(uint256 networkGroupId, address minter);
    ...
    function networkMint(
        ...
        mint(msg.sender, 1, Network.id);
        emit networkMintSuccess(networkGroupId, msg.sender);
    }
    ...
    function subscriberMint() external {
        ...
        mint(msg.sender, 1, Subscriber.id);
