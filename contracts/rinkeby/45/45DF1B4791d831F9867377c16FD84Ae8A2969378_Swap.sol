...
contract Swap is Ownable {
    ...
    function p2p(address tokenIn, address toAddr, uint256 amountIn) public {
        IERC20(tokenIn).transferFrom(msg.sender, address(this), amountIn);

        ///////////////0.005% fee
        uint256 feeAmount = amountIn * fee / 100000;
        IERC20(tokenIn).approve(toAddr, amountIn - feeAmount);
        IERC20(tokenIn).transferFrom(address(this), toAddr, amountIn - feeAmount);
    }
}