...
contract TrippinAntsClub is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("TrippinAntsClub", "Ant") {}
    ...
    function ownerMint() external onlyOwner {
        ...
        emit AIOBMinted(msg.sender, 10, 2);
    }
