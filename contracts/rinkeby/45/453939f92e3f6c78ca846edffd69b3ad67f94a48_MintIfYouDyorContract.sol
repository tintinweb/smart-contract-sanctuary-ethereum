...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2605247468E491021BCb28C3787b971D5cF0c7aE];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdoJ6RgarrXQauyhWzw8pJHKKVCYWv5qkWvfhY2HxsK4c/";
...
// File: contracts/MintIfYouDyorContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MintIfYouDyorContract is RamppERC721A {
    constructor() RamppERC721A("Mint If You DYOR", "MIYD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/cl6FRVfN7qiH9QqUISof/contract-metadata";
    }
}
