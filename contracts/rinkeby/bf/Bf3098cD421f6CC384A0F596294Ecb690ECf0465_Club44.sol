...
contract Club44 is ERC721, ERC2981, Ownable {
    ...
    // get total market supply for the collection
    ...
    function crossMint(address _to) public payable {
        require(_msgSender() == 0xdAb1a1854214684acE522439684a145E62505233,
