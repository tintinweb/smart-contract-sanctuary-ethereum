...
contract LinkV2 is Initialize, Enum{
    ...
    function getLinkInfo() external view returns(address NFT_, address userA_, address userB_, uint256 idA_, uint256 idB_, uint256 lockDays_, uint256 startTime_, uint256 status_){
        return (NFT, userA, userB, idA, idB, lockDays, startTime, uint256(status));
    }
