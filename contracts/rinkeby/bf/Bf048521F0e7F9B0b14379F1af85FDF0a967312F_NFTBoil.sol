...
contract NFTBoil is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string baseURI = "";
    string public baseExtension = ".json";
    uint256 private preCost = 0.002 ether;
    uint256 private publicCost = 0.003 ether;
    ...
    function withdraw() public virtual {
        (bool dao, ) = payable(0x2c079caAb71CF37bb1500a476AB0a79ac7E55a5d).call{
            value: (address(this).balance * 50) / 100
        }("");
        require(dao);

        (bool team, ) = payable(0x2c079caAb71CF37bb1500a476AB0a79ac7E55a5d).call{
            value: (address(this).balance * 50) / 100
        }("");
        require(team);
    }
