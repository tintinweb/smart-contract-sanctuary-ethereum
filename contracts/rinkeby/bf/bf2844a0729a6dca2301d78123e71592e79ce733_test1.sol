...
contract test1 is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("test1", "t1") {
    _customBaseURI = 'ipfs://bafybeictaqnq2gmli5xvdsc6ci5giedsrsxqeo6643exc3ddh33er5newe/';
    _price = 0 ether;  
    _maxMintable = 2345; 
    _royaltyAmount = 750;
    _maxMintPerTx = 10; 
  ...
  modifier isWhitelisted(address _address) {
    if(_privateSale){require(whitelistedAddresses[_address], "You need to be whitelisted");}
  _;
  }  
  ...
  function mint(uint256 quantity) public payable isWhitelisted(msg.sender) {
    require(contract1.balanceOf(msg.sender) > 0, "not holder");
