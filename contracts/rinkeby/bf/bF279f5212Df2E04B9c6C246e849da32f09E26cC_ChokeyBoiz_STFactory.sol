...
import "./ChokeyBoiz_ST.sol";
import "./ChokeyBoiz_STLootBox.sol";

contract ChokeyBoiz_STFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://chokeboizst.herokuapp.com/assets/factory/";
    ...
    /*
     * Three different options for minting ChokeyBoiz_STs (basic, premium, and gold).
     */
    ...
    constructor(address _proxyRegistryAddress, address _nftAddress) {
        ...
        lootBoxNftAddress = address(
            new ChokeyBoiz_STLootBox(_proxyRegistryAddress, address(this))
        );
    ...
    function name() external pure override returns (string memory) {
        return "OpenSeaChokeyBoiz_ST Item Sale";
    }
    ...
    function mint(uint256 _optionId, address _toAddress) public override {
        ...
        ChokeyBoiz_ST openSeaChokeyBoiz_ST = ChokeyBoiz_ST(nftAddress);
        if (_optionId == SINGLE_CREATURE_OPTION) {
            openSeaChokeyBoiz_ST.mintTo(_toAddress);
            ...
            ChokeyBoiz_STLootBox openSeaChokeyBoiz_STLootBox = ChokeyBoiz_STLootBox(
                    lootBoxNftAddress
                );
            openSeaChokeyBoiz_STLootBox.mintTo(_toAddress);
        }
    }
    ...
    function canMint(uint256 _optionId) public view override returns (bool) {
        ...
        ChokeyBoiz_ST openSeaChokeyBoiz_ST = ChokeyBoiz_ST(nftAddress);
        uint256 creatureSupply = openSeaChokeyBoiz_ST.totalSupply();
        ...
        if (_optionId == SINGLE_CREATURE_OPTION) {
            ...
            numItemsAllocated = openSeaChokeyBoiz_STLootBox.itemsPerLootbox();
        }
...
/**
 * @title ChokeyBoiz_STLootBox
 *
 * ChokeyBoiz_STLootBox - a tradeable loot box of ChokeyBoiz_STs.
 */
contract ChokeyBoiz_STLootBox is ERC721Tradable {
    uint256 NUM_CREATURES_PER_BOX = 3;
    uint256 OPTION_ID = 0;
    address factoryAddress;

    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("ChokeyBoiz_STLootBox", "LOOTBOX", _proxyRegistryAddress)
    {
    ...
    function baseTokenURI() public pure override returns (string memory) {
        return "https://chokeboizst.herokuapp.com/assets/_bong/";
    }
