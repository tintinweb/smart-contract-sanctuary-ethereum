...
contract WaveCatchers is Ownable, ERC721A, PaymentSplitter, ReentrancyGuard {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares) PaymentSplitter(_payees, _shares) ERC721A("WaveCatchers", "WC", 10) {}
