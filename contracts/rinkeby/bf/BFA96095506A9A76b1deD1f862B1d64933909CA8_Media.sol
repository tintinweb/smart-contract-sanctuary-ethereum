 ...
 */
contract Media is IMedia, ERC721Burnable, ReentrancyGuard, ERC721URIStorage {
     ...
     */
    constructor(address marketContractAddr, address tokenContractAddr) public ERC721("XYZ", "XYZ") {
...
interface IMarket {
    ...
    event AskCreated(uint256 indexed tokenId, uint256 ask);
    event AskRemoved(uint256 indexed tokenId, uint256 ask);
    ...
    function configureStakingPool(address stakingPoolAddress) external;	
