...
contract DaGeese is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("DaGeese", "DAGEESE") { }

    function mint() public payable nonReentrant returns (uint256) {
        require(saleStarted, "MINT_NOT_STARTED");
        require(_totalMinted() <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
        require(msg.value == MINT_PRICE, "INVALID_ETH_SENT");
