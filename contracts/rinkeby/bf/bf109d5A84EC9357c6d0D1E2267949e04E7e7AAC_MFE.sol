...
import './TFCBase.sol';
import './MFESplitsTestnet.sol';

/**
 * @title MFE wrapper contract
 */
contract MFE is MFESplitsTestnet, TFCBase {
    constructor()
        TFCBase(
            'MFE',
            'MFE',
            'https://nftculture.mypinata.cloud/ipfs/QmcpxfH2GzuHEk7KtSDCLauEi6WXKXteu7ZqYjERBHeJ48/', // TODO
            addresses,
            splits
        )
    {
        // Implementation version: 1
        // Contract MFE Rinkeby V1 deployed to address: [0xEfa386D24D2BC901781E101852B473Bc08bAD49A].
        // Contract MFE Rinkeby V2 deployed to address: [0xB5B47e40C4e866642002F6C9B87deDF1C03C0F49].
        // Contract MFE Rinkeby V3 deployed to address: [0xbf109d5A84EC9357c6d0D1E2267949e04E7e7AAC].
    }
    ...
    AuxHelper16
{
    ...
    uint256 private constant MAX_NFTS_FOR_PRESALE = 5000;
    ...
    uint256 private constant AVAILABLE_PRESALE_QUANTITY = 20;
    uint256 private constant AVAILABLE_PUBLIC_QUANTITY = 20;
    ...
    constructor(
        ...
        // TODO Fix prices
        FourPhaseAlternateMint(0.001 ether, 0.005 ether, 0.005 ether, 0.005 ether)
    {
        baseURI = __baseURI;
    }
        ...
        isPresale1
    {
        ...
        if (newBalance > AVAILABLE_PRESALE_QUANTITY) revert ExceedsAvailablePresaleMints();
    ...
    function _presale1Tokens(
        ...
        _internalPresaleTokens(minter, count);
    }
    ...
    function _internalPresaleTokens(address minter, uint256 count) internal {
        if (_totalMinted() + count > MAX_NFTS_FOR_PRESALE) revert ExceedsMaxSupply();
...
contract MFESplitsTestnet {
    address[] internal addresses = [
        0x05Ed4cf991c4ed7606930AB54dDbF27836C1f590 // TODO
    ];
