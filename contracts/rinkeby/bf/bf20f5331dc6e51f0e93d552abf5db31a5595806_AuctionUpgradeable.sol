...
contract AuctionUpgradeable is OwnableUpgradeable {  
    ...
    function hashOfAuction(AuctionPayload memory auction) public view returns(bytes32) {
        return keccak256(
            abi.encode(
                auction.tokenId,
                auction.tokenURI,            
    ...
    function bid(AuctionPayload memory _bid) public view returns(bytes32) {     
        return hashOfAuction(_bid);  
    }
    function addOnAuction(AuctionPayload memory auction) public view returns(bytes32){ 
