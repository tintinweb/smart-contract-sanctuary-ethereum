...
contract KindredSpiritsGen0 is CustomERC721Metadata {
    ...
    function addProject(string memory _projectName, address _artistAddress, uint256 _pricePerTokenInWei, bool _dynamic, uint256 _maxSupply) public onlyWhitelisted {
        require(_maxSupply < TEN_THOUSAND);
        ...
        projects[projectId].maxInvocations = _maxSupply;
        if (!_dynamic) {
