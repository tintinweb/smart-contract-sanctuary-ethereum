...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA{
    ...
    function mint() public{
        ...
        require(current < maxSupply, "No quedan mas PlatziPunks.");
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory){
        require(_exists(tokenId), "ERC721 Metadata: URI query for nonexistent token. Debe existir el token");
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "PlatziPunks #',
                tokenId,
                '", "description": "Descripcion del NFT unike vvbla vvbla...", "image": "',
                image,
                '"}'
            )
        );
