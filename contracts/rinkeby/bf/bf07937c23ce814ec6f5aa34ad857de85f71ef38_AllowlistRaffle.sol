...
import "./AllowlistRaffleBase.sol";
...
contract AllowlistRaffle is AllowlistRaffleBase {
     ...
     */
    function setFee(uint256 _fee) public lockable onlyOwner {
        fee = _fee;
    }

    function pay(uint256 amount) internal override {
        RWASTE.burn(_msgSender(), fee * amount);
    }
}
 ...
 */
abstract contract AllowlistRaffleBase is Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
     ...
     */
    function setDrawScriptURI(string calldata uri) public lockable onlyOwner {
        drawScriptURI = uri;
    }
    ...
    function draw() public onlyOwner {
        ...
        lockFunction(this.setDrawScriptURI.selector);
    }
