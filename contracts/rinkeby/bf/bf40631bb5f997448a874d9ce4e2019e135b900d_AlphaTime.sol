...
contract AlphaTime is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    bool saleActive;
    string private contractUri = "http://alphatime.io/metadata/contract.json";
    ...
    constructor(bool _saleActive, bytes32 _root) ERC1155(BASE_URI) {
...
*/
    ...
    function updateBaseUri(string memory base_uri) public onlyOwner {
        BASE_URI = base_uri;
    }
