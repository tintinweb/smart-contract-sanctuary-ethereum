    ...
    ERC721BurnableUpgradeable
{
    ...
    uint256[] public REDEEMED_NFTS;

    address public discountTokenAddress;
    string public NFTActivatedURL;
    ...
    function initialize(
        ...
        string memory _nftActivatedUrl
    ) public initializer {
        ...
        NFTActivatedURL = _nftActivatedUrl;
    ...
    function setAvailableNFT(
        ...
        AVAILABLE_NFTS.push(AVAILABLE_NFT(price, reward, metadata));
    }
    ...
    function redeemNFT(uint256 _token) public whenNotPaused {
        require(REDEEMED_NFTS[_token] == 0);
        require(msg.sender == ownerOf(_token), "OO");
        
        _setTokenURI(_token, NFTActivatedURL);
        REDEEMED_NFTS[_token] = 1;
