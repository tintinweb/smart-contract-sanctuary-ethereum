...
// File: contracts/TigerbobNFTConceptsAndMyths.sol
...
contract TigerbobNFTConceptsAndMyths is ERC1155Supply, Ownable {
    ...
    modifier checkSupply(uint256 _amount) {
        require(totalSupply(tokenId) + _amount <= supply, "exceeds total supply for token");
        _;
    }
    ...
    function mint() public payable contractCheck checkSaleActive checkSupply(1) checkTxnValue checkAlreadyMinted {
