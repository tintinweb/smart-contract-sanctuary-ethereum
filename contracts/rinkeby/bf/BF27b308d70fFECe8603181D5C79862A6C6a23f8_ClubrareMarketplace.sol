    ...
    EIP712Upgradeable
{
    ...
    function settlement(
        ...
        _executeExchange(_order, msg.sender, taker, sellerEarning, _tokenId, true);
    ...
    function validateOrder(
        ...
        /* Not done in an if-conditional to prevent unnecessary 
        ecrecover evaluation, which seems to happen even though it should short-circuit. */
