...
// @title:  10000 SUPER POSITIVE WORDS
// @desc:   10000 SUPER POSITIVE, UPLIFTING AND MOTIVATING WORDS TO MAKE YOUR DAY
...
contract SuperPosiWords is ERC721, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    Counters.Counter public totalSupply;

    mapping(address => bool) whitelist;
    mapping(address => bool) presaleWhitelist;
    mapping(address => bool) allowedWalletAddresses;
    ...
    uint256 public tokensReserved = 300;
    ...
    constructor(string memory _ipfsCID)
        ERC721("10000 Super Posi Words", "SPO")
    {
