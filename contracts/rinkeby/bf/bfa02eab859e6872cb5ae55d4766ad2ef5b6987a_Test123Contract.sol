...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x67dd786b50E5603Aa9538aF296b38dEd6a062e98];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = " ipfs://exampleContentIDtest123/";
...
// File: contracts/Test123Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Test123Contract is RamppERC721A {
    constructor() RamppERC721A("Test123", "Test123"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/t4AjU4M0So9Vvpx5cBRC/contract-metadata";
    }
}
