...
contract Samurai is ERC721A {
    ...
    string public baseURI = "https://bafybeifqmgyfy4by3gpms5sdv3ft3knccmjsqxfqquuxemohtwfm7y7nwa.ipfs.dweb.link/metadata.json";
    ...
    function freeMint(uint256 quantity_) external payable {
        require(_timeMint);
