...
// File: contracts/GhostedOkayBearsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract GhostedOkayBearsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Ghosted Okay Bears";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/24WdjuU78DQ4piFpgTs6/contract-metadata";
    }
