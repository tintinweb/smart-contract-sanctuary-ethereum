...
contract MintingRouter is Ownable, ReentrancyGuard, EIP712Whitelisting {
     ...
     * @param signingName The name of the NFT token.
     * @param version The version of the project.
     */
    constructor(
        INFT nftContract,
        string memory signingName,
        string memory version
    ) EIP712Whitelisting(signingName, version) {
     ...
     * @return The number of tokens left for the running sale round.
     */
...
contract EIP712Whitelisting {
  ...
  constructor(string memory signingName, string memory version) {
    // This should match whats in the client side whitelist signing code
