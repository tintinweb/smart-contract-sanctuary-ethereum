...
contract NFTCarbon is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor()
        ERC721("NFTCarbon NFT", "NFTCarbon")
    {
    ...
    function whitelistMint(uint256 amount) public {
        ...
        require(_tokenIds.current() + amount <= maxNFTs, "Too much to mint");
        require(whitelistMintable() >= amount && amount != 0, "Over minting limit");
    ...
    function _mintLogic(uint256 amount, bool fromWhitelist) internal nonReentrant {
