...
/**
 * @title SBS Card Actions ERC1155 Smart Contract
 * @dev Extends ERC1155 
 */
...
contract SBSCardActions is ERC1155, ERC1155Supply, ERC1155Burnable, Ownable, ReentrancyGuard {
    ...
    // local
    address public tokenContract = 0x5FbDB2315678afecb367f032d93F642f64180aa3;
    // rinkeby
    //address public tokenContract = 0xc081A745384EbCC39e69666050D0ce926eE7265a;
    ...
    */
    function mintAction(uint256 tokenId, uint256 qty) external nonReentrant {
        ...
        require(apeBalance >= actions[tokenId].tokenPrice * qty, "Not enough $APE.");
