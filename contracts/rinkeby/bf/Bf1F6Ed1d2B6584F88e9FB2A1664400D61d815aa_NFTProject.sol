...
abstract contract NFTProjectInterface {
 ...
 * @title NFTProject
 */
contract NFTProject is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    struct WhitelistSaleConfig {
        uint64 mintQuota;                   // 1
                                            // https://time.is/Unix%20time%20converter
        uint256 startTime;                  // 1652320800 = Thu May 12 2022 10:00:00 UTC+0800 (Singapore Standard Time)
        uint256 endTime;                    // 1656604799 = Thu Jun 30 2022 23:59:59 UTC+0800 (Singapore Standard Time)
        bytes32 merkleRoot;                 // 0x4a11e14e4f064ba9de588c626834726172609eb3baf87e8fa6eb0ba30485e807
        uint256 price;                      // 10000000000000000 = 0.01ETH
    }
    ...
    struct RevealConfig {
        uint64 startTime;
        address nftProjectContractAddress;
    }
    ...
    constructor(string memory baseURI_, WhitelistSaleConfig memory whiteSaleConfig_) ERC721A("NFT Project", "NFTP") {
        baseURI = baseURI_;
    ...
    function reveal(uint256 tokenId_) external callerIsUser nonReentrant returns (uint256) {
        ...
        _burn(tokenId_);
        NFTProjectInterface nftProjectContract = NFTProjectInterface(revealConfig.nftProjectContractAddress);
        uint256 cheerUpTokenId = nftProjectContract.mint(_msgSender(), tokenId_);
    ...
    function isRevealEnabled() public view returns (bool) {
        return revealConfig.startTime > 0 &&
            ...
            revealConfig.nftProjectContractAddress != address(0);
    }
