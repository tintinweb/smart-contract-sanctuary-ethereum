...
contract DunkingDucksNFT is ERC721Enumerable, Ownable, Pausable {
    ...
    uint32 private constant MAX_PURCHASE = 10;
    uint256 private constant MAX_RESERVE = 200;
    ...
    constructor(
        ...
        bytes32 _merkleRoot
    )  Ownable() Pausable() ERC721("DunkingDuck", "DunkingDuck") {
    ...
    function reserve(
        ...
        require(totalSupply() <= MAX_RESERVE, "DunkingDucksNFT#reserve: Over reserve amount limit.");
