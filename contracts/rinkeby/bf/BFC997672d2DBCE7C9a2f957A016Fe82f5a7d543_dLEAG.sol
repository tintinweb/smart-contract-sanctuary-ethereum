    ...
    UUPSUpgradeable
{
     ...
     */
    function initializeToken(string memory name, string memory symbol)
        public
        initializer
    {
    ...
    function setWhitelisted(address _whitelisted, bool _isWhitelisted)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        override(ERC20Upgradeable, ERC20PresetMinterPauserUpgradeable)
    {
        ...
        ERC20PresetMinterPauserUpgradeable._beforeTokenTransfer(
            from,
            to,
            amount
        );
