...
contract WrestlingSuperstars is Ownable, ERC721A {
  ...
  constructor(uint _whitelistStartTime) ERC721A("BackOut", "BackOut") {
  ...
  function whitelistMint(bytes32[] calldata _merkleProof) public {
    require(addressClaimed[_msgSender()] + 1 <= 1, "Exceeds wallet mint amt");
  ...
  function teamClaim() external  onlyOwner{
    require(teamClaimed = false, "Team has already calimed!");
