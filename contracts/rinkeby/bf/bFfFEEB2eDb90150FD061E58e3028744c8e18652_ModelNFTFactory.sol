...
contract ModelNFTFactory is Ownable {
     ...
     */
    function createModelNFT(string memory modelName, string memory modelID, address designer, uint256 mintLimit) external {
        require(mintLimit > 0,  "Incorrect mint limit.");

        _modelNFT = new ModelNFT(modelName, modelID, mintLimit, _royaltyRate, designer, _royaltyReceiver);
    ...
    AccessControlEnumerable
{
    ...
    function mint(
        ...
        // set token uri
        _setTokenURI(_currentIndex, uri);
