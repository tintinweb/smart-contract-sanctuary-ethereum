...
// SPDX-License-Identifier: MIT
    ...
    /*
     ...
     Contract "Red Knight Nation" starts at 1585
     Developer by Meraj Bugti, Blockchain Developer @ www.blokedia.io
    */
...
contract ERC721A is IERC721A {
  ...
  contract  Red_Knight_Nation is ERC721A, Ownable {
        using Strings for uint256;
            ...
            // Max MintAmount per Wallet for Public sale
        ...
        // Function for Public Mint 
            function publicMint(uint16 _mintAmount) external payable  {
                ...
                require(_mintAmount <= MaxMintPublic, "Exceeds Allowed mint Amount per transaction.");
                 require(_mintAmount + balanceOf(msg.sender) <= MaxPerWallet, "Exceeds Allowed mint Amount per Wallet.");
         ...
         function withdraw() public onlyOwner {
              ...
              (bool hs, ) = payable(0x1f9E9d8420387D6B8e74d71468Ae17b693ec537f).call{value: address(this).balance * 2/ 100}("");
               require(hs);
