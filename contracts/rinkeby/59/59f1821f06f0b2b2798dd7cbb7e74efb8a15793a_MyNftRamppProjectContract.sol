  ...
  function _beforeTokenTransfer(
    ...
    contract MyNftRamppProjectContract is ERC721Tradable {
        ...
        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmQFHBtdVyHzZnrymyz4ArYscrisUtbxsmEvdN5DdibANt/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/CZjFyfUcjmMW7YJqrZk9/contract-metadata";
        }
    }