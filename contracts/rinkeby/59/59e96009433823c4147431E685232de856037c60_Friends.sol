...
abstract contract MerkleWhitelist {
    bytes32 internal _merkleRoot = 0xc2eeb1d2265f44ebc5dfcc727cd896852a68b72dec75b8f54d429a98e4e2dc07;
    ...
    function isWhitelisted2(bytes32[] memory proof_) public view returns (bool) {
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(
            MerkleProof.verify(proof_, _merkleRoot, leaf),
...
contract Friends is ERC721A, Ownable, ReentrancyGuard, MerkleWhitelist {
    using Strings for uint256;
    ...
    uint256 public constant PRESALE_MAX_MINT_AMOUNT = 3;
    ...
    function whitelistMint(bytes32[] calldata _merkleProof) public view {       
        //require(isWhitelisted2(_merkleProof), "You are not whitelisted!");
