 ...
 */
contract NFT is Ownable, ERC721A, VRFConsumerBase {
        ...
        VRFConsumerBase(_LINK_VRF_COORDINATOR_ADDRESS, _LINK_TOKEN)
    {
        ...
        MAX_PER_TRANSACTION_PRESALE_2 = 10;
    ...
    function presaleMint3(bytes32[] calldata _merkleProof, uint256 _mintAmount)
        external
        payable
        correctValue(_mintAmount)
    {
        presaleMint(merkleRoot3, _merkleProof, _mintAmount);
    }
    ...
    function setWhitelist3(bytes32 _merkleRoot3) external onlyOwner {
        merkleRoot3 = _merkleRoot3;
    }
}
