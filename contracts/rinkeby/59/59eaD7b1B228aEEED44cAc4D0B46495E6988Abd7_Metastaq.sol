...
/// @dev The Contract use Markle Proof for Whitelist minting, The Markle Proof mint limit is max allowed per user. All function calls are currently implemented without side effects
    ...
    ReentrancyGuard
{
     ...
     * it will validate the proof against root and user leaf
