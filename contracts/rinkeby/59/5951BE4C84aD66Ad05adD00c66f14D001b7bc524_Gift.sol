...
contract Gift is ERC1155, Ownable, Pausable {
    string public name;
    ...
    address public constant goldTestAddress =
        0x5Ab14860090AD01d4f248B6c59ED1F9FfB3f1813;
    ...
    bytes32 public goldRoot =
        0x6628419ab5ce4a5099b2c85135c994758539c67f3bc6ca84f85c5c94723982a1;
    ...
    constructor()
        ERC1155(
            "https://ipfs.io/ipfs/QmZrpr9kaUyPpjbhB9AKsxUAid3YcxLKzomrgRWjqbWhuH/"
        )
    {}
        ...
        returns (uint256)
    {
        ...
        bytes32 leaf = keccak256(
            abi.encodePacked(0x6f65c1900dcAbbC789B0aF0bf8616d42293Ed943)
        );
    ...
    function mint(bytes32[] calldata _merkleProof)
        ...
        whenNotPaused
    {
        console.log("Holder Checking:", checkNftHolder(_merkleProof));
    ...
    // function getCurrentSupply(uint256 tokenId) public pure returns (uint256) {
    //     return 9999;
    // }
}
