...
contract NFTBigEye3008 is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  */
  ...
  modifier mintAllowlistCompliance(uint256 _mintAmount) {
    require(_totalMinted() + _mintAmount <= maxAllowlistSupply, 'Max Allowlist supply exceeded!');
    _;
  }
