...
contract nft is ERC721A, Ownable {
    ...
    uint private mintCostPresale = 0.045 ether;
    uint private mintCostPublicSale = 0.075 ether;
    ...
    constructor() ERC721A("H&V's Holy & Victorious Women", "HVW", 3, 10000){
    ...
    */
    ...
    function presaleMint(uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        ...
        require(totalSupply() < collectionSize - (maxReservedMints  - _reservedMints), "Not enough NFTs left to mint..");
        require(mintsPerAddress[msg.sender] < 1, "Maximum 1 Mint per Address allowed!");
        require(msg.value >= mintCost(), "Not sufficient Ether to mint this amount of NFTs (Cost = 0.045 ether each NFT)");
    ...
    function publicSaleMint(uint256 number) public payable {
        ...
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 0.075 ether for each NFT)");
    ...
    function retrieveFunds() public onlyOwner {
        ...
        _withdraw(payable(0x61cC8Aee8285dB176586A5B823FF79b720ab9945), (balance * 20) / 100); 
        _withdraw(payable(0x912ED778D51DB0C6c6517d8ECcB0129BB13B1739), (balance * 40) / 100);
        _withdraw(payable(0x2dAE8B4D82317083547391a67dc99a7339d0B8eb), (balance * 40) / 100); //to avoid dust eth
