...
contract Donkey_Kong is ERC721A, Ownable, ReentrancyGuard {
    ...
    function whitelistMint(uint256 _mintAmount, bytes32[] calldata merkleProof)
        ...
        mintPriceCompliance(_mintAmount, whiteListMintPrice)
    ...
    function publicMint(uint256 _mintAmount)
        ...
        payable
        mintCompliance(_mintAmount)
        mintPriceCompliance(_mintAmount, publicMintPrice)
    {
    ...
    function setWhiteListPrice(uint256 _whiteListMintPrice) public onlyOwner {
        whiteListMintPrice = _whiteListMintPrice;
    }
    ...
    function withdrawAll() public onlyOwner nonReentrant {
        require(
            payable(0xC6400346d25ED61EeBF7391365e07E85858Bcc7D).send(
                (address(this).balance * 12) / 100
            )
        );
