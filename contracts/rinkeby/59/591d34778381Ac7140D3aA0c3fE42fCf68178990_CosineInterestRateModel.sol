...
contract CosineInterestRateModel is InterestRateModelBase {
    ...
    uint256 public immutable zeroRate;

    /// @notice Interest rate at full utilization (as 18-digit decimal)
    uint256 public immutable fullRate;
    ...
    uint256 public immutable kinkRate;

    /// @notice Internal value N used for rate calculation
    int256 internal immutable n;
    ...
    function getBorrowRate(
        ...
        int256 theta = util <= kink.toInt256() ? int256(0) : ONE;
        int256 cosX = util == 0
            ? ONE
