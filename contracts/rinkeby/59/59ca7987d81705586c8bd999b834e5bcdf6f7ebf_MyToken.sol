...
contract MyToken  is ERC721Holder, Ownable {
    IERC721 public nft;
    ...
    mapping(uint256 => stakeInformation) public vault;     // uint256 public EMISSION_RATE = (50 * 10 ** decimals()) / 1 days;
    ...
    function stake(uint256 tokenId) external {
        ...
        vault[tokenId] = stakeInformation({
        owner: msg.sender,
    ...
    // function totalstakedtokenbyME() public view returns(uint256  [] memory)
    // {
    ...
    function unstake(uint256 tokenId) external {
        ...
        for (uint256 i = 0; i < stakers[msg.sender].stakedTokens.length; i++) {
            if (
                stakers[msg.sender].stakedTokens[i].tokenId == tokenId 
                && 
    ...
    function totalNFTStaked() public view returns(uint256 tokens) {
            return totalstaked;
