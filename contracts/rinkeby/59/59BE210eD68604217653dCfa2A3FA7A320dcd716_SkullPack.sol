...
contract SkullPack is ERC721, Ownable {
    ...
    constructor() payable ERC721("SkullPack", "SP") {
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(msg.value == quantity_ * mintPrice, "Incorrect mint price");
        require(totalSupply + quantity_ <= maxSupply, "Sold out!");
        require(
            walletMints[msg.sender] + quantity_ <= maxPerWallet,
            "Exceeded maximum mints!"
        );
