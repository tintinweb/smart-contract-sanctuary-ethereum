...
// File @aave/aave-stake/contracts/interfaces/[email protected]
...
// File @aave/aave-stake/contracts/lib/[email protected]
...
// File @aave/aave-stake/contracts/utils/[email protected]
...
// File @aave/aave-stake/contracts/stake/[email protected]
...
contract AaveDistributionManager is IAaveDistributionManager {
    ...
    function _getAssetIndex(
        ...
        uint256 currentTimestamp = block.timestamp > _getDistributionEnd()
            ? _getDistributionEnd()
            : block.timestamp;
...
contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager {
    ...
    {
        require(
            REWARD_TOKEN == STAKED_TOKEN,
            "REWARD_TOKEN_IS_NOT_STAKED_TOKEN"
        );

        uint256 rewardsClaimed = _claimRewards(
            msg.sender,
            address(this),
            amount
        );
    ...
    function exchangeRate() public view override returns (uint256) {
        ...
        return
            STAKED_TOKEN.balanceOf(address(this)).mul(1e18).div(currentSupply);
    }
    ...
    function _claimRewards(
        ...
        stakerRewardsToClaim[from] = newTotalRewards.sub(
            amountToClaim,
            "INVALID_AMOUNT"
        );
        REWARD_TOKEN.safeTransferFrom(REWARDS_VAULT, to, amountToClaim);
    ...
    function _stake(
        ...
        if (accruedRewards != 0) {
            ...
            stakerRewardsToClaim[to] = stakerRewardsToClaim[to].add(
                accruedRewards
            );
        }
    ...
    function _redeem(
        ...
        uint256 underlyingToRedeem = amountToRedeem.mul(exchangeRate()).div(
            1e18
        );
...
// File contracts/stake/StakedAaveV3.sol