    ...
    ReentrancyGuard 
{
    ...
    address[] private _member = [
        0xf70A19b87c9b19F1D2CCeE8A198399626002EeFF,
        0xa30922Ee1f75d26CcEFb5666CDf22afDEF375115,
        0x31231Dd398eCB2C0297E27e2524E29DBafb08A96
    ];

    uint256[] private _memberShares = [
        70,
        20,
        10
    ];
    ...
    ) ERC721("NFTRevealCollectible", "NFTRC") PaymentSplitter(_member, _memberShares) {
