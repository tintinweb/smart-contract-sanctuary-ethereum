...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["SPORTS", "LEARNNING", "LIKE", "FUN", "GOOD", "NICE"];
  string[] secondWords = ["NFT", "CHAIN", "UNCHAIN", "DATA", "ITEM", "CONNECT"];
  string[] thirdWords = ["METAMASK", "ID", "DECONTERIZE", "APPLE", "GOOGLE", "START"];
