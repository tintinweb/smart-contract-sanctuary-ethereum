...
contract moongoblin is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmcEMSggw41inug3KoqUuWeu2wxEyFhU32BrRTqJiRaHxL";
  ...
  ) ERC721A("moongoblin.wtf", "MOONGOBLIN") {
