...
contract KosherKit is ERC721Enumerable, Ownable {
    ...
    function authenticate(uint _tokenId) public view returns (bool) {
        return(
            _exists(_tokenId) &&
            idToExpirys[_tokenId] > block.timestamp
        );
    }
