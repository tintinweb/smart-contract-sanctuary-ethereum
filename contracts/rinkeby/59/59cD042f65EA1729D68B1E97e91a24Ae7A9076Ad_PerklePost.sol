...
import "./IPerklePost.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/utils/Address.sol";

contract PerklePost is IPerklePost {
    ...
    function supportsInterface(bytes4 interfaceId) external pure override returns (bool) {
        return interfaceId == type(IPerklePost).interfaceId || interfaceId == type(IERC165).interfaceId;
    }
 ...
 */
interface IPerklePost is IERC165, IERC721Metadata {
    /**
    ...
    /**
     * @dev Mints a post and writes metadataUrl to storage.
     *
