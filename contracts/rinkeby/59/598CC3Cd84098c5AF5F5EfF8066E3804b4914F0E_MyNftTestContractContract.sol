...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xdEA980A8c94dafee88F34C6065018fEE768673e8];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://www.IPFS.com/MNTC_V1/";
...
// File: contracts/MyNftTestContractContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNftTestContractContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Test Contract", "MNTC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/QtbzpMqRHvkxEC1ej3B0/contract-metadata";
    }
}
