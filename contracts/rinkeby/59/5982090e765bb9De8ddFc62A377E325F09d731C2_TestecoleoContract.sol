...
//
//    __            __                     __           /\//     
//   / /____  _____/ /____     _________  / /__  ______//\/_____ 
//  / __/ _ \/ ___/ __/ _ \   / ___/ __ \/ / _ \/ ___/ __ `/ __ \
// / /_/  __(__  ) /_/  __/  / /__/ /_/ / /  __/ /__/ /_/ / /_/ /
// \__/\___/____/\__/\___/   \___/\____/_/\___/\___/\__,_/\____/ 
//                                             /_)               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xDd81e7Ed7a053e3f9CA74A85c882A8b78e730243];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 17, 5000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif5xnnhukekm4s3ahnzx5inrxjuu2jz7eran3ywfridwjqly23wum/";

    bool public mintingOpen = false;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 17;
...
// File: contracts/TestecoleoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestecoleoContract is RamppERC721A {
    constructor() RamppERC721A("teste coleo", "tcol"){}
}
