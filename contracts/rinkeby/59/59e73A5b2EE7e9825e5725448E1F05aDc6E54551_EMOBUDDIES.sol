...
contract EMOBUDDIES is ERC721A, Ownable, ReentrancyGuard {
    ...
    address a1 = 0x48c6E159FBB077e17A875648d7ac42A6591B1454; // plug
    address a2 = 0x3d7F15c8f375091cF94f69F7b52752866Dea38bd; // lauren
    ...
    function withdraw() external onlyOwner {
        ...
        _widthdraw(a3, balance.mul(20).div(100)); // rusty 10%
        _widthdraw(a4, balance.mul(20).div(100)); // cd 5%
        _widthdraw(a5, balance.mul(20).div(100)); // maddi 2%
        _widthdraw(a6, balance.mul(20).div(100)); // wen 4%
        _widthdraw(a6, address(this).balance); // rest to chase - 44%
    }
