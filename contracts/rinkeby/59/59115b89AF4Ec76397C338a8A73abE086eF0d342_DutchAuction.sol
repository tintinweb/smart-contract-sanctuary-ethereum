   ...
   /*  modifier auctionOngoing(address nftContractAddress, uint256 tokenId) {
    ...
    modifier doesBidMeetBidRequirements(
        ...
        uint256 bidIncreaseAmount = (nftContractAuction.nftHighestBid *
            (10000 + nftContractAuction.bidIncreasePercentage)) / 10000;
 ...
 */
    //============== INITIALIZE ==============
    function initialize(
        uint32 defaultBidIncreasePercentage_,
        uint32 MaxEtraBidPercentages_,
        ...
        __IsPausable_init();
        defaultBidIncreasePercentage = defaultBidIncreasePercentage_;
        MaxEtraBidPercentages = MaxEtraBidPercentages_;
   ...
   /*  function createNewNftAuction(
    ...
    ) external payable whenNotPaused isWhitelistedToken(erc20Token) {
        require(
            bidIncreasePercentage >= minExtraBidPercentages &&
                bidIncreasePercentage <= maxExtraBidPercentages,
            "Bid Increase Percentage should be between range"
        );
        _auctionTimePayment(auctionBidPeriod);
        _setupAuction(
            nftContractAddress,
            tokenId,
            erc20Token,
    ...
    function _setupAuction(
        ...
        nftContractAuction.startTime = startTime;
        nftContractAuction.endTime = endTime;
        nftContractAuction.startPrice = startPrice;
        nftContractAuction.reservedPrice = reservedPrice;
        nftContractAuction.bidIncreasePercentage = defaultBidIncreasePercentage;
        ...
        internal
    {
        ...
        nftContractAuction.bidIncreasePercentage = 0;
        ...
        nftContractAuctions[nftContractAddress][tokenId].startTime = 0;
        nftContractAuctions[nftContractAddress][tokenId].endTime = 0;
        nftContractAuctions[nftContractAddress][tokenId].startPrice = 0;
        nftContractAuctions[nftContractAddress][tokenId].reservedPrice = 0;
        //nftContractAuctions.auctionEnd = auctionBidPeriod + block.timestamp;
    }
