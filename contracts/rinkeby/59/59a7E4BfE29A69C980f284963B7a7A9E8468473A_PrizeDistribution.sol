...
contract PrizeDistribution is Ownable, ReentrancyGuard {
    ...
    mapping(uint32 => bool) private nonceToValidated;
   ...
   */
    function askPrize(
        ...
        require(!nonceToValidated[_backendNonce], "PrizeDistribution.maskPrizeakePayment: this nonce was already used");
        ...
        require(recovered == signingKey, "PrizeDistribution.makeaskPrizePayment: Verification Failed");
    ...
    **/
    function setIsPaused(bool _isPaused) onlyOwner external {
        isPaused = _isPaused;
    }
