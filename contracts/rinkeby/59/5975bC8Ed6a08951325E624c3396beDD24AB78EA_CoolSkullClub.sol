...
contract CoolSkullClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private constant HIDDEN_URI = 'ipfs://QmUW9Yr5kGGYW4jQCWAnj9PS9ZFMJicuzu9eiWBzeRFhb5/metadata.json'; // Start of hidden meta data uri
    ...
    function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof, uint8 _collabType) public payable {
        require(!PAUSED, "COOL SKULL CLUB : This contract is paused!");
        ...
        require(_numberMinted(msg.sender) + _mintAmount < MAX_PER_WALLET, string(abi.encodePacked("COOL SKULL CLUB : You cannot mint more than ", MAX_PER_WALLET.toString(), " tokens!")));
