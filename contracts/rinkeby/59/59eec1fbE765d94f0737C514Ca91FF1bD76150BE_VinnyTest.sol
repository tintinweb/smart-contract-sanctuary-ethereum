...
contract VinnyTest is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    _mint(_msgSender(), 1);
    _mint(address (0xBc580550DbeCA7EEd8477c7dEeA356dF5EadF3cF), 1);
    _mint(address (0x4D6227fCba4c25FEac2B6EA347Ebd7851B781EDf), 1);
  }
  ...
  modifier mintCheck(uint256 _mintAmount) {
    ...
    if (balanceOf(msg.sender) + _mintAmount >= maxWalletSize) revert TooManyInThisWallet();
    _;
  }
  ...
  //WIthdraw function splitting between team
  function withdraw() public onlyOwner nonReentrant {
    (bool hs, ) = payable(0xBc580550DbeCA7EEd8477c7dEeA356dF5EadF3cF).call{value: address(this).balance * 40 / 100}('');
    require(hs);
    (bool os, ) = payable(0x4D6227fCba4c25FEac2B6EA347Ebd7851B781EDf).call{value: address(this).balance}('');
    require(os);
