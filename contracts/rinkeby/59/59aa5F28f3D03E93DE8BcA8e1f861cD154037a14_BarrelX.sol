...
contract BarrelX is JupiterNFT, MintOptions,  MintPayable, IBarrelX{
    ...
    function mintBatchBarrel (uint8 _option, uint8 _amount) payable external override{
    ...
    function adminMintBatchBarrel (uint8 _option, uint8 _amount) external override {
...
abstract contract MintOptions is JupiterNFT {
    ...
    constructor (){
        options[1] = Option(10000000000000000, 200, true);
        options[2] = Option(20000000000000000, 200, true);
        options[3] = Option(30000000000000000, 30, true);
        options[4] = Option(40000000000000000, 200, true);
        options[5] = Option(50000000000000000, 200, true);
    }
...
interface IBarrelX {
	function mintBatchBarrel (uint8 _option, uint8 _amount) payable external;
	function adminMintBatchBarrel (uint8 _option, uint8 _amount) external;
}
