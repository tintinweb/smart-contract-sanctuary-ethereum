...
contract UniswapCustom is Ownable {
  ...
  address internal constant UNISWAP_ROUTER_ADDRESS = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    ...
    IERC20 ercToken = IERC20(0xEd0eb2bF914975B50F725e5DbbAde2026101e8d4);
    ...
    returns (bool status) 
  {
    ...
    uniswapRouter.swapExactTokensForETH(amountIns, amountOutMins, getPathForTokentoETH(), to, deadline);      
    uniswapRouter.swapExactTokensForETH(amountInsFees, amountOutMinsFees, getPathForTokentoETH(), address(this) , deadline);      
    
    _takeFees(address(this).balance);
