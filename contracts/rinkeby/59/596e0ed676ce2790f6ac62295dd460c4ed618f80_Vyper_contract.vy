...
def __init__():
    ...
    """
    self.symbol = "DSP"
    self.name = "Death Spiral Party"

    self.owner = msg.sender
    self.minter = msg.sender
    
    self.base_uri = (
        "ipfs://bafybeicj2gymf324clpqtbnns3yrplto2emj7kuhsoqrhzg6ru6k3wjy7e/"
    )
    self.contract_uri = (
        "ipfs://bafkreidnchchwguoj3os4p633voxdu3y6ex2owiqpweyn52p65defwf5q4"
    )
