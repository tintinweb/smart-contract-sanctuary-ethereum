...
contract EthboxMetadata is Ownable {
    ...
    constructor() {
        ...
        desc = "On-chain Ethereum messaging system backed by an ERC721 token assigned to all addresses to display your public ethbox.";
