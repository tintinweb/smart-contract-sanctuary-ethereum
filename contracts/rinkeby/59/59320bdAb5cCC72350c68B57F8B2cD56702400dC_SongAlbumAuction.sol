 ...
 */
contract SongAlbumAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event SongAlbumAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "SongAlbumAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit SongAlbumAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        ISongAlbumMarketplace marketplace = ISongAlbumMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            ISongAlbumMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
