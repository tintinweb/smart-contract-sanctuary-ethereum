...
contract RetroBobos is ERC721A, Ownable {
    ...
    constructor(string memory baseURI) ERC721A("Retro Bobos", "247Bobos") {
        baseUri = baseURI;
    }
    ...
    function publicMint(uint256 amount) public {
        ...
        if (_numberMinted(msg.sender) + amount > MAX_MINT_PER_ADDR)
