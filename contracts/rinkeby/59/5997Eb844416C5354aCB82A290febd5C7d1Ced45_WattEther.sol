...
contract WattEther is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mint(uint256 _quantity) external payable {
        ...
        require(msg.value >= nftPrice * _quantity, "Vous n'avez pas assez d'ETH"); // Il faut que l'on envoie le nombre d'eth requis (nftPrice * la quantité d'NFT que l'on veux mint)

        // Si on passe tout ces require et que tout est OK :
        _safeMint(msg.sender, _quantity); // on apelle la fonction _safeMint qui va effectuer le mint
