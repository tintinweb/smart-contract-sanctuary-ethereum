...
contract guochanliangxin is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("guochanliangxin", "gclx") {
    setHiddenMetadataUri("iipfs://QmbyUfWA5fuedutDAJ5CPs4ujVAfhPhn2Hi1URhAPwYJM7/hidden.json");
  }
