...
import "../../admin/interfaces/ITierLevel.sol";
...
contract NetworkLoan is
    NetworkLoanBase, PausableImplementation, SuperAdminControl
{
    ...
    function setloanActivateLimit(uint256 _loansLimit) public onlySuperAdmin(AdminRegistry, msg.sender) {
    ...
    function setWhilelistAddress(address _lender) public onlySuperAdmin(AdminRegistry, msg.sender) {
    ...
    */
    ...
    function getMaxLoanAmount(uint256 collateralInBorrowed, address borrower)
        ...
        returns (uint256)
    {
        TierData memory tierData = TierLevel.getTierDatabyGovBalance(
            borrower
        );
    ...
    /**
     * @dev Returns all loan offer ids for a borrower
     */
    ...
    function getAltCoinPriceinStable(
        ...
        if (
            PriceConsumer.isChainlinFeedEnabled(
            ...
            collateralAmountinStable =
                collateralAmountinStable +
                (
                    PriceConsumer.getDexTokenPrice(
                        _stableCoin,
                        PriceConsumer.WETHAddress(),
                        _collateralAmount
                    )
