...
contract Web69Test is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Web69";
    string private constant _symbol = "WEB69";
    ...
    address payable private _developmentAddress = payable(0x87650554FE2F681444BA920Ed9A8a40cEcDD4ecD); 
    address payable private _marketingAddress = payable(0x87650554FE2F681444BA920Ed9A8a40cEcDD4ecD);
