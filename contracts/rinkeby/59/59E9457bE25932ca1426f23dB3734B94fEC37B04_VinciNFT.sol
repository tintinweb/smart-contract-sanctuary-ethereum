...
contract VinciNFT is ERC721Royalty, Ownable {
    ...
    constructor(address receiver) ERC721("VinciNFT", "VNFT") {
        ...
        _setDefaultRoyalty(receiver, 950);
        baseURI = "https://nft.thedigitalrenaissance.io/v1/";
        collectionContractURI = "https://gateway.pinata.cloud/ipfs/QmTtqKHPJvfsWzUt6Rq1hwRzbDbZn9F7YSZXWxowwbUSGj";
    }
    ...
    function mintBatchTo(uint[] memory tokenIds, address _to) public onlyOwner {
        require(tokenIds.length < 51, "max 50 tokenIds per patch");
