    ...
    ERC1155HolderUpgradeable
{
    ...
    function initialize(InitializeParam memory _param) public initializer {
        factory = msg.sender;
        stakingParams = _param;

        _rewardPerTimestamp = _param
            .apr
        ...
        onlyFactoryOwner
    {
        ...
        require(
            stakingParams.startTime > block.timestamp,
        ...
        uint256 prevTokenAmount = getDepositTokenAmount(
            stakingParams.stakeNftPrice,
            stakingParams.maxStakedNfts,
            stakingParams.apr,
            prevPeriod
        );
        uint256 newTokenAmount = getDepositTokenAmount(
            stakingParams.stakeNftPrice,
            stakingParams.maxStakedNfts,
            stakingParams.apr,
            newPeriod
        ...
        if (newTokenAmount > prevTokenAmount) {
            ...
            if (stakingParams.rewardTokenAddress == address(0x0)) {
                ...
                IERC20Upgradeable governanceToken = IERC20Upgradeable(
                    stakingParams.rewardTokenAddress
                );
                require(
        ...
        onlyFactoryOwner
    {
        ...
        if (endTimestamp_ > stakingParams.endTime) {
            ...
            uint256 withdrawTokenAmount = getDepositTokenAmount(
                stakingParams.stakeNftPrice,
                stakingParams.maxStakedNfts,
                stakingParams.apr,
                period
        ...
        onlyFactoryOwner
    {
        ...
        uint256 prepareTokenAmount = getDepositTokenAmount(
            stakingParams.stakeNftPrice,
            stakingParams.maxStakedNfts,
            stakingParams.apr,
            period
        ...
        onlyFactoryOwner
    {
        ...
        stakingParams.stakeNftPrice = stakeNftPrice_;
        _rewardPerTimestamp = stakingParams
            .apr
            .mul(stakeNftPrice_)
            .div(PERCENTS_DIVIDER)
            .div(YEAR_TIMESTAMP);
        ...
        returns (uint256)
    {
        ...
        if (stakingParams.rewardTokenAddress == address(0x0)) {
            ...
            uint256 tokenBalance = IERC20Upgradeable(
                stakingParams.rewardTokenAddress
            ...
            IERC20Upgradeable(stakingParams.rewardTokenAddress).safeTransfer(
                _to,
                _amount
            );
            return _amount;
    ...
    function pendingRewards(address account_) public view returns (uint256) {
        ...
        uint256 fromTimestamp = user.lastRewardTimestamp <
        ...
        whenNotPaused
    {
        ...
        if (amountToStake > 0 && stakingParams.depositFeePerNft > 0) {
            ...
            address adminFeeAddress = INFTStakingFactory(factory)
                .getAdminFeeAddress();
    ...
    function withdraw(
        ...
        if (amountToWithdraw > 0 && stakingParams.withdrawFeePerNft > 0) {
            require(
                msg.value >=
                    amountToWithdraw.mul(stakingParams.withdrawFeePerNft),
