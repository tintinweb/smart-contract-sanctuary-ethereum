...
contract YourFirstNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("Your First NFT", "YOURFIRSTNFT") {}
    ...
    // allowList mint
    uint256 public allowListMintPrice = 1.000000 ether;
    // default false
    ...
    function getPublicSalePrice(uint256 offset) public view returns(uint256){
        if (4700 < 40 + amountForPublicSale - offset){
    ...
    uint256 public amountForPublicSale = 4700;
