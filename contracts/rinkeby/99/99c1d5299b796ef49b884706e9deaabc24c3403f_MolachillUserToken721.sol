...
interface IERC721 is IERC165 {
    ...
    function royaltyFee(uint256 tokenId) external view returns (address[] memory receiver, uint256[] memory royaltyAmount);
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    function royaltyFee(uint256 _tokenId)
        external
        view
        virtual
        override
...
contract MolachillUserToken721 is ERC721 {
    ...
    function createCollectible(string memory tokenURI, address[] memory receivers, uint256[] memory fee) public returns (uint256) {
