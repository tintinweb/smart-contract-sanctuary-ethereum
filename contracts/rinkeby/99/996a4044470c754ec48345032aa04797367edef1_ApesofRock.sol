...
contract ApesofRock is Ownable, ERC721 {
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 50 / 100); //test1
        payable(0xc1Efbb6ad2AfD85cA419CfC69b79fA6C4A847C95).transfer(_balance * 50 / 100); //test2
    }
