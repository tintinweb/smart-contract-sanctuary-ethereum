...
contract MixTapeHeadz_Ukraine_vol1 is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint16 public maxSupply = 20;
    string private _baseTokenURI = 'ipfs://QmUHJDoL9n4ibEFmwi8RGRpj49CqozHsdLS1hjpCbobPwf/';
    string public baseExtension = ".json";
    
    uint256 public _freemintStartDate = 1630080000;
    uint256 public _freemintStopDate = 1630211232;
    uint256 private currentPrice = 0.01 ether;
    uint256 private currentMintLimit = 20;
    uint256 private maxMintAccount = 20;
    
    uint256 public _mintForAllStartDate = 1647059444;
    

    constructor() ERC721("MixTape Headz Ukraine Vol. 1", "MTHZ_UA1") {
    }
