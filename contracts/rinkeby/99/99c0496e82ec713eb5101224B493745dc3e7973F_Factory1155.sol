...
import "./paradoxNFT1155UserToken.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new paradoxNFT1155UserToken{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        paradoxNFT1155UserToken token = paradoxNFT1155UserToken(address(addr));
...
contract paradoxNFT1155UserToken is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
