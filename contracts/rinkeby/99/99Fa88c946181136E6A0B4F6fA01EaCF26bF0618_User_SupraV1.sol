...
contract User_SupraV1 {
    ...
    **/
    ...
    // +  ++++++++++++++++
    function currentPrice(address _impl_contract, string memory currencyPair) public view returns(string memory, uint256){
       return IOracleContract(_impl_contract).getCurrentPrice(currencyPair); 
    } 
