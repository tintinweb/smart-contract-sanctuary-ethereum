...
contract SDPResolver {
	...
	ReverseRegistrar constant private reverseregistrar = ReverseRegistrar(0x6F628b68b30Dc3c17f345c9dbBb1E483c2b7aE5c); //mod
...
*/
	function setPrimary(uint256 tokenId) public authorised(tokenId) {
		reverseregistrar.setName(tokenId.toString());
	}
