...
contract TestingThings is ERC721A, Ownable {
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(totalSupply() + quantity <= maxSupply, "You're trying to mint too many");
        require(msg.value == price * quantity, "Did not send appropriate funds");
