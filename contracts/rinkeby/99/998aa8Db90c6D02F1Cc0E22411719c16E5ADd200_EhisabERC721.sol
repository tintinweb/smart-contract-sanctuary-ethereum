    ...
    ERC2981PerTokenRoyalties
{
    ...
    function initialize(
        ...
        __EhisabAccessControl_init(_whitelistAddresses);
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721Upgradeable, ERC2981PerTokenRoyalties)
        returns (bool)
    {
        return
...
contract ERC721AccessControl is Initializable, ContextUpgradeable {
    ...
    function __EhisabAccessControl_init(address[] memory _whitelist)
        internal
        initializer
    {
