...
/// @title Catheon Gaming Center ERC721 NFT Contract
/// @dev NFT collection for marketplace (self create and mint)
/// @author @seiji0411
contract CGCNftERC721Collection is ERC721URIStorage, Ownable {
    // ******************  Errors  *****************************
    error TokenURIEmpty();
    error TokenExist();
    error TokenNotExist();
    ...
    function burn(uint256 _tokenId) external {
        ...
        if (!_isApprovedOrOwner(msg.sender, _tokenId)) revert BurnNotApproved();
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     *
     * This internal function is equivalent to YYe}, and can be used to e.g.
