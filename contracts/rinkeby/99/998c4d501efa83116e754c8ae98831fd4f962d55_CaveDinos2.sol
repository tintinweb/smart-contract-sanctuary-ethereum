...
// File: contracts/BBD/CaveDinos2.sol
...
contract CaveDinos2 is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _baseUrl, address _eggContract) ERC721A("CaveDinos2", "CD") {
        baseApiURI = _baseUrl;
        eggBase = IERC20(_eggContract);
        egg = IEGG(_eggContract);
    }
    ...
    function _verify(
        ...
        return MerkleProof.verify(proof, wlRoot, _leafNode);
    }
    ...
    function mintWhitelist(
        ...
        uint256 _mintAmount
                ...
                uint256 eggBalance = eggBase.balanceOf(msg.sender);
                //verification
                require(
                ...
                require(
                    eggBalance >= (whitelistCost * _mintAmount),
                    "Insuffient funds"
                );
                ...
                //Mint
                egg.burnFromExtentionContract(msg.sender, (whitelistCost * _mintAmount));
    ...
    function mint(uint256 _mintAmount) public {
        if (msg.sender != owner()) {
            ...
            require(eggBalance >= cost * _mintAmount, "Insuffient funds");
        }
        egg.burnFromExtentionContract(msg.sender, (cost * _mintAmount));
        _mintLoop(msg.sender, _mintAmount);
    }
