...
contract Oracle is TellorVars {
    // Storage
    uint256 public reportingLock = 10 hours; // amount of time before a reporter is able to submit a value again
    ...
    uint256 public minimumtip = 10e18; //minimum tip which is upgradable
    ...
    // Events
    //set a way to change minimum tip
    ...
    function tipQuery(
        ...
        require(_tip > minimumtip, "Tip should be greater than 1");
        require(
    ...
    function setMinimumtip(uint256 value) external {
        require(
            msg.sender == 
                IController(TELLOR_ADDRESS).addresses(_GOVERNANCE_CONTRACT),
...
contract TellorVars is TellorVariables {
    ...
    address constant TELLOR_ADDRESS =
        0xC98DD68Be9B718D1abfCA9ebB7334A659863aAcC; // Address of main Tellor Contract
        //todo change address
