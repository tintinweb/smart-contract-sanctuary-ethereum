...
contract NFT is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    mapping(uint256 => address) private _owners; // TODO: check whether using uint32 saves gas
    // Mapping owner address to token count
    mapping(address => uint256) private _balances;
    // Mapping from token ID to approved address
    mapping(uint256 => address) private _tokenApprovals;
    // Mapping from owner to operator approvals
    mapping(address => mapping(address => bool)) private _operatorApprovals; // TODO: understand what this is

    constructor() {
        _baseTokenURI = "www.default-token-uri.com/tokenID=";
        _name = "Crazy Cowards";
        _symbol = "CC";
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        require(msg.sender != operator, "NFT: approve to caller");
    ...
    {
        // TODO: only if tokenId is not 256 bit... and we need to cast
        // require(tokenId < TOTAL_SUPPLY, "ERC721Metadata: Invalid tokenId");
        require(
            (_exists(tokenId)),
