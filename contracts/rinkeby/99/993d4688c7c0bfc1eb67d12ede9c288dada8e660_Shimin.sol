...
contract Shimin is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("SHIMIN", "SHIMIN", maxMintAmountPerTx) {
    setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmdajswFbmAJb8MhsmofxAZH9PzCeQAJuzwXfULj1e3PUm/hidden.json");
  }
