...
contract VertexContract is ERC721Enumerable, PaymentSplitter, Ownable {
    using Strings for uint256;
    ...
    uint256 public preSaleMaxSupply = 6767;
    uint256 public maxMintAmountPresale = 5;
    uint256 public maxMintAmount = 10;
    uint256 public nftPerAddressLimitPresale = 5;
    uint256 public nftPerAddressLimit = 10;
    uint256 public preSaleDate = 1647597937;
    uint256 public preSaleEndDate = 1648116337;
    uint256 public publicSaleDate = 1648116337;
    bool public paused = false;
    bool public revealed = false;
    mapping(address => bool) whitelistedAddresses;
    mapping(address => uint256) public addressMintedBalance;
    
    mapping (uint256 => string) public nonRevealUri;
    bytes32 public merkleRoot;
    

    uint256 public commonTokens = 2254;
    uint256 public rareTokens = 5;

    address[] private team_ = [0x8b0eF90C71ed8b18786AaB55B0d41cE093724fA6,
                            0x40E5c1f59E3308613E44C314abbfa1dD8FdC0606];

    uint256[] private teamShares_ = [9500, 500];

    constructor() ERC721("Vertex Contract Test", "VCT") PaymentSplitter(team_, teamShares_) {
        nonRevealUri[1] = "https://gateway.pinata.cloud/ipfs/Qmb8pzg2CL5DzNw6dGkcvS169PhAXrMqygVeBo5fQoK1mC";
        nonRevealUri[2] = "https://gateway.pinata.cloud/ipfs/QmSSXzhYQMiaatP4dfmUG346hxkSSpBiVYkx2ePtERYtTV";
        nonRevealUri[3] = "https://gateway.pinata.cloud/ipfs/QmQkt5syP2XL3YqtaHBppSpPfQzi8DBBXEmJRVVLf1q6P5";
        nonRevealUri[4] = "https://gateway.pinata.cloud/ipfs/QmToZb24XaBEfJJict9iuJhhVd16btwRopDhBVBHmGix9r";
        nonRevealUri[5] = "https://gateway.pinata.cloud/ipfs/QmbC1cJ4fGFhFZ1y6jfktmFoEpWns2Eaa18xuq7nZyEPGA";
        nonRevealUri[6] = "https://gateway.pinata.cloud/ipfs/QmPATpLXKf9XVxQeTtfLLerfxnS7rfNibWHPPfYUdakAnV";
    }
    ...
    //Presale MINT
    function presaleMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) external payable notPaused saleStarted minimumMintAmount(_mintAmount) {
        ...
        require (block.timestamp < publicSaleDate, "presale ended");
    ...
    function mint(uint256 _mintAmount) public payable notPaused saleStarted minimumMintAmount(_mintAmount) {
        ...
        //Do some validations depending on which step of the sale we are in
        require (block.timestamp < publicSaleDate, "public sale not started");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed && tokenId/commonTokens <= 2) { //common token
            return nonRevealUri[tokenId/commonTokens];
        }else if(!revealed && tokenId/commonTokens > 2) { //rare token
            uint256 rareNum = tokenId - (commonTokens * 3);
            return nonRevealUri[rareNum/rareTokens + 3];
        }
         else {
    ...
    function setNonRevealURI(string memory _notRevealedURI, uint256 _index) public onlyOwner {
        require(_index <= 6, "_index should be less than 6");
        nonRevealUri[_index] =  _notRevealedURI;
    }
