...
contract TASTIES is ERC721A, Ownable {
    ...
    bytes32 private merkleRoot = 0x05bdb6310b7a3f0e8ee0b40d7986f0c5f73303acda884249e60db9a001271f8d;
    ...
    function toggleSweetMint() public onlyOwner {
    ...
    function teamAllocation(address[] memory addrs) public onlyOwner {
        require(
            addrs.length > 0 &&
                _saleMints[msg.sender] + addrs.length <=
                5000,
            "airdrop above limit"
        );
    ...
    function mintItem(uint256 _quantity)
        public
        payable
        callerIsUser
