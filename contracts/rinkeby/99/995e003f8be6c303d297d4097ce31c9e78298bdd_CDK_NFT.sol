...
contract CDK_NFT is ERC721Enumerable, Ownable, RandomlyAssigned {
    ...
    uint256 public presaleMints = 10;
    ...
    function mint(uint _amount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (supply + _amount <= presaleMints){
    ...
    function setPresaleMints(uint256 _newPresaleMints) public onlyOwner {
        presaleMints = _newPresaleMints;
    }
