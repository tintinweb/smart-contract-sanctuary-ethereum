...
contract SpecialKGlass is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    setMAX_PER_WALLET(_MAX_PER_WALLET);
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= MAX_PER_WALLET, 'Per Wallet Limit Reached');
