...
// | $$       /$$__  $$  /$$__/  | $$  | $$      | $$      | $$_____/ /$$__  $$| $$      
// | $$$$$$$$|  $$$$$$$ /$$$$$$$$|  $$$$$$$      | $$$$$$$$|  $$$$$$$|  $$$$$$$| $$      
// |________/ \_______/|________/ \____  $$      |________/ \_______/ \_______/|__/      
//                                /$$  | $$                                              
//                               |  $$$$$$/                                              
//                                \______/                                               
//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7320b34Fd7Cfb4ee7d4DAB004A166f97D0659CEf];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 4321 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWTtbejsfvaf69xUc3XC6cW76FpnuQgh3AHXsVMZDJiKg/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4321");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4321");
...
// File: contracts/LazyLeafContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LazyLeafContract is RamppERC721A {
    constructor() RamppERC721A("Lazy Leaf", "LZY"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/VmekxKTSf1f4pYwYTNQa/contract-metadata";
    }
}
