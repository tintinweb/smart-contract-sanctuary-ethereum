...
*/
    ...
    uint8[] traitVals = [9,9,4,4,4,5,4,4,8,8,6,4,5,6,9];
    ...
    function hash(
        ...
        for (uint8 i = 0; i < 15; i++) {
            ...
            uint8 numTraitVals = traitVals[i];
            ...
            else if (bstyle == 1 && i == 12) randDigit = pindex + 1;
    ...
    function mintInternal() internal {
        ...
        _safeMint(msg.sender, thisBankerId);
    }
    ...
    function outputFullSVG(string memory _hash) public view returns (string memory) {
        ...
        for (uint8 i = 0; i < 15; i++) {
            ...
            if (thisTraitIndex != 0 || i < 6) svgString = string(abi.encodePacked(svgString, drawTrait(traitData[i][thisTraitIndex])));
        }
