...
contract Birthday is IBirthday, ERC721, ERC721Pausable, ERC721URIStorage, PullPayment, Ownable {
    ...
    */
    ...
    function getSvg(string memory imageData) private view returns (string memory) {
        string memory svg = "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='1080' width='1080' viewBox='0 0 360 405' style='background-color:white' class='diagram' text-anchor='middle' font-family='monospace' font-size='13px'><g class='text'>";
