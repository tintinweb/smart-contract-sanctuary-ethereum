...
contract BridgeController is Ownable {
    ...
    function swap(
        ...
        bytes calldata paylaod //Flexibal for use another services
    ) public {
        ...
        _bridge(amount, _chainId, paylaod);
    }
    ...
    function _bridge(
        ...
        IERC20(stableCoin[_chainId]).approve(addressBridge[_chainId], amount);
        IBridgeToken(addressBridge[_chainId]).bridge(amount, payload);
    }
}
