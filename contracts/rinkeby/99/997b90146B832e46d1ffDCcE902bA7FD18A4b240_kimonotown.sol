...
contract kimonotown is ERC721A, Ownable {
    
    uint256 public MAX_SUPPLY = 100;
    uint256 public MAX_FREE_SUPPLY = 10;

    uint256 public MINT_PRICE = 0.00001 ether;

    uint256 public MAX_MINT_PER_TX = 100;

    uint256 public MAX_FREE_MINT_PER_WALLET = 20;
    ...
    constructor(string memory initBaseURI) ERC721A("kimonotown", "KTN") {
        baseURI = initBaseURI;
    }
