 ...
 *
 */
contract NFTERC721 is ERC721A, AccessControl, Ownable {
     ...
     * @dev METADATA
     */
    string public baseURIString = "https://NFT.io/metadata/";
    string public preRevealBaseURIString = "https://NFT.io/metadata/";
    ...
    constructor(address _openseaProxyRegistryAddress)
        ERC721A("NFT", "MTG", maxMintPerTransaction)
        Ownable()
    {
