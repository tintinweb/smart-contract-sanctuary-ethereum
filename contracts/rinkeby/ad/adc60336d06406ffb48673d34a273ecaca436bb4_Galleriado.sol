...
contract Galleriado is ERC721Metadata {
  ...
  constructor(string memory baseURI_)
    ERC721Metadata("Galleriado", "Gal", baseURI_)
  {}
  ...
  function mint(address to, uint256 tokenId) external {
    require(msg.sender == initialSeller, "Galleriado: not authorized");
    _totalSupply += 1;
    _mint(to, tokenId);
  }
}