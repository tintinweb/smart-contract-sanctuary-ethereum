...
contract PiratePalsV2Test is Mintable, PaymentSplitterUpgradeable, IERC2981Upgradeable, UUPSUpgradeable {
    ...
    bool private _isUpgraded;
    string public someValueFromUpgrade;
    string public someOtherValueFromUpgrade;
    ...
    function contractURI() external pure returns (string memory) {
        return "ipfs://QmcawhRrzSRf9d9LKusHVCMVv9uun6ZkM3zeeZGP79qfG6";
    }
    ...
    /**
     * Initializer for the current upgrade
     */
    function initializeUpgrade1() public onlyOwner {
        require(!_isUpgraded, "Upgrader: already upgraded");
        _isUpgraded = true;
        someValueFromUpgrade = "value from upgrade 1";
    }

    /**
     * This new function can only be called when upgrade has been initialized
     */
    function someMethodFromUpgrade() external view checkVersion returns (string memory) {
        return "upgraded once";
    }

    /**
     * Check that the contract is upgraded to the latest version
     */
    modifier checkVersion() {
        require(_isUpgraded, "Upgrader: not upgraded");
        _;
    }
