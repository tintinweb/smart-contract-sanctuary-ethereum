...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function setVal() public{
            ...
            _addressData[msg.sender].balance++;
...
contract BakedBlueJays is ERC721A, Ownable {
    ...
    uint private constant maxPerPresaleMint = 10;
    uint private constant maxPerMint = 20;
    uint private constant maxPerWallet = 100;
    uint public cost = 100000000000000000;//amount in wei
...
////Public Functions
    ...
    function publicMint(uint256 quantity) external payable
    {
        ...
        require(_totalMinted() + quantity < 10001, "Not Enough Left");
        require(tx.origin == msg.sender, "No contracts!");
        require(msg.value > quantity * 99999999999999999, "Not Enough ETH");
       
        _mint(msg.sender, quantity,"",true);
        
    }

    function preSaleMint(uint256 quantity, ECRecoverLib.ECDSAVariables memory wlECDSA) external payable
    {
        // overflow checks here
        require(_totalMinted() + quantity <10001, "Not Enough Left");
        require(msg.value > 99999999999999999 * quantity, "Not Enough ETH");
        require(tx.origin == msg.sender, "No contracts!");
