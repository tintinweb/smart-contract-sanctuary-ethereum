...
contract PhoenixContract is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public preSaleDate = 1648317011;
    uint256 public preSaleEndDate = 1648662611;
    uint256 public publicSaleDate = 1648662611;
    ...
    constructor() ERC721("Phoenix NFT Collection", "PNC") {
        setNotRevealedURI("");
    }
