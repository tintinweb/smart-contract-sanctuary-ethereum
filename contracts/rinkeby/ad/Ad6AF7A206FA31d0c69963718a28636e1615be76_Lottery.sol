...
import "AggregatorV3Interface.sol"; // For getting ethereum latest price from outside the BC in decentralized way
import "SafeMathChainlink.sol"; // for using safe math for big calculations
import "Ownable.sol"; // for only owner modifiers
import "VRFConsumerBase.sol"; // for getting random number from outside the BC in decentralized way
