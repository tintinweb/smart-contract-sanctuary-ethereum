...
contract RiserToken is  ERC20Burnable { 

    constructor(uint256 initialSupply) ERC20("RiserToken", "RST") public { 
    ...
    function whitelistAddress(address _addr , bool val) public {
        whitelist[_addr] = val  ; 
    }
