...
Token allocation: 100% UNISWAP LIQUIDITY 

Tax: 7/7 buy and sell. 

Tokenomics: 
1% AUTO BURN / 1% AUTO BUYBACK&BURN. / 1% AUTO LIQUIDITY. 
2% MANUAL BUY BACK AND BURN UNDER MARKETING FUNDS. / 2% DEV. 
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sample2";
    string private constant _symbol = "Ssm2";
    ...
    uint256 private _tTotal = 1000000000 * 10**9; // 1B
    uint256 private maxWalletAmount = 10000001 * 10**9; //1%
    uint256 private maxTxAmount = 10000001 * 10**9; // 1%%
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xB3d7Be96e10A98B8eC929799e3cc01acb81fc19c); 
        marketingAddrWallet = payable(0x3D3466276b2018c57e83d149bc1F1315cBcfE674);
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        maxWalletAmount = 10000001 * 10**9; // 1%
        maxTxAmount = 10000001 * 10**9; // 1%
        tradingOpen = true;
