...
contract NtentArt is ERC721A {
    ...
    function _exists(uint256 tokenId) internal override view returns (bool) {
        ...
        return tokenId < ((projectId * ONE_MILLION) + projects[projectId].invocations);
    }
    ...
    function mint(address _to, uint256 _projectId, uint256 quantity, address _by) external returns (uint256 _tokenId) {
        ...
        uint256 tokenId = _mintToken(_to, _projectId, quantity);

        return tokenId;
    }

    function _mintToken(address _to, uint256 _projectId, uint256 quantity) internal returns (uint256 _tokenId) {
        ...
        _safeMint(_to, tokenIdToBe, quantity);
