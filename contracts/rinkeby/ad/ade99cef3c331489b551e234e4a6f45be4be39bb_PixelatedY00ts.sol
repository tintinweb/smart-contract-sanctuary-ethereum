...
contract PixelatedY00ts is ERC721A, Ownable, ReentrancyGuard {
    ...
    // mint config
    uint256 public cost = 0.001 ether; // 1000000 gwei
    uint256 public maxSupply = 2222;
    uint256 public maxMintAmount = 10;
    uint256 public maxPerTxn = 10;
    uint256 public maxFreeAmt = 1; // 1 free per wallet
    uint256 public constant MAX_FREE = 1000; //max to be minted
