...
//
//   ________            _____                                  
//  /_  __/ /_  ___     / ___/_________  _____
//   / / / __ \/ _ \    \__ \/ ___/ __ \/ ___/
//  / / / / / /  __/   ___/ / /__/ /_/ / / 
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663189140;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1663178340;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xEC14c11c573bBDA3DE569a1B72b0914ACE91BF4F,0x5B67b5d2D0B4E48A2694b4e5989976385058faEa];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xEC14c11c573bBDA3DE569a1B72b0914ACE91BF4F;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeics6lzf3jmpxhslihucdhndrugbzd3rmf45cihlzvrlmehzm4toqy/";
...
// File: contracts/ScorTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ScorTestContract is RamppERC721A {
    constructor() RamppERC721A("SCOR Test", "SCORT"){}
}