...
contract CreativeNFTPOC is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    event NewCityNFTMinted(uint256 tokenId, bytes32 seed);

    constructor() ERC721("CreativeNFTPOCv3", "POC3") {
        baseURI = "ipfs://QmVZQDy39eziPWZKEx8NnBhKmdX4JKwTRttC7yBnJKkzWC/";
    }
    ...
    function mint(bytes32 _seed, string memory uri)
        public
    {
        // Get current tokenId
        ...
        // Return current token Id and seed for frontend to form metadata
        emit NewCityNFTMinted(newItemId, _seed);
    }
