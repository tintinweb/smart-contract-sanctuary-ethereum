...
contract Test is Ownable {
    ...
    function filter(string memory s) public view returns (uint24[] memory) {
        return IEmoji(emoji).filter(decode(s), true);
    }

    function validate(string memory s) public view {
