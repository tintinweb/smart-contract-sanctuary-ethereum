...
contract AlienBees is ERC721A, Ownable{    
    ...
    constructor(address[] memory whiteListedAddress, uint256 _limitPerWallet, uint256 _MAX_SUPPLY, string memory _baseURI, string memory name_, string memory symbol_ ) ERC721A(name_, symbol_){
