...
contract AirdropHouses is ERC721Enumerable, Ownable {
    ...
    uint256 private _saleMode = 0; // 0 - nothing, 1 - presale 2-public sale
    ...
    string private _strBaseTokenURI =
        "https://airdrophouses.mypinata.cloud/ipfs/QmdxPeaozds7ffoMmLskML8DatdZ1CatYdzDfpkzBKVYAm/";
    ...
    constructor() ERC721("AirDropHouses-test-3", "ADH-3") {
        _merkleRoots[1][
            10
