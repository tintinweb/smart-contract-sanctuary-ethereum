...
contract KeltenoNFT is ERC721Enumerable, PullPayment, Ownable, ReentrancyGuard {
    ...
    constructor(bool firstDeploy) ERC721("SuperTest", "NFT") {
...
//////////////////
    ...
    function _formatToEther(uint input) private pure returns (uint){
        return  input  / 10000000000000000000;
    }
    ...
    function buyKltnFromContr(uint256 tokenId) external payable nonReentrant {
        require(tokenSellEnabled, "Token Sale Paused");
        require(forSale[tokenId].isExist, "This Token Does not Exist or Not For Sale");
        require(msg.value >= forSale[tokenId].price, string(abi.encodePacked("Insufficient Payment: This Token Costs ", Strings.toString(_formatToEther(forSale[tokenId].price)))));
