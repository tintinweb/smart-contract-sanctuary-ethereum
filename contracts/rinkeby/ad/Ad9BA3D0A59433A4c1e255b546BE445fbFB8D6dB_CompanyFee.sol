...
contract CompanyFee {
  address public constant OTHER_CONTRACT = 0x1D062a69c7D55b5beA30F8574d885b484E34191E;
  SellaTokenInterface SellaTokenContract = SellaTokenInterface(OTHER_CONTRACT);

  function testCall() public view returns (uint256) {
    //This is example and not related to your contract
    uint256 greet = SellaTokenContract.totalSupply();
    return greet;
  }
}
