...
contract DEGENS is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    //cant mint at once in per transaction
    require(_mintAmount <= maxMintAmountPerTx,'Sorry you cant mint this amount at once');
    //per address quota exceeted
    require(_mintAmount + _numberMinted(msg.sender) <= maxSupply, 'Exceeded the limit');
