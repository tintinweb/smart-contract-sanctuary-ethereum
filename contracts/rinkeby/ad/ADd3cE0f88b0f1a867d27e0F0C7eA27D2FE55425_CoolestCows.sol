...
contract CoolestCows is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("CoolestCows", "CCCCC") {
        isOpen = false;

        _allowlistPrice = 0.085 ether;
        _publicPrice = 0.095 ether;

        _maxMintPerAllowlist = 3;
        _maxMintPerTxn = 5;

        _teamAddress = 0xfF3C7d4E5304a9bE9072C95a78c5D169A957Ebd8;
        _baseTokenURI = "https://cool.cool/";
    }

    function mintAllowlistTokens(bytes32[] calldata merkleProof, uint256 quantity) external payable mintGatekeeperBase(quantity) mintGatekeeperPresale(merkleProof, msg.sender, quantity) {
