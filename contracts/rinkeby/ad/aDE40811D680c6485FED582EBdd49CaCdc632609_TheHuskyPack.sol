    ...
    ReentrancyGuard
{
    ...
    function ogMint(uint256 _amount, bytes32[] calldata _proof) public payable {
        ...
        require(
            _amount < 3 || (_amount > 2 && msg.value >= (_amount - 2) * price),
            "1"
        );
        ...
        payable
    {
        ...
        require(
            _amount < 2 || (_amount > 1 && msg.value >= (_amount - 1) * price),
            "1"
        );
        require(addressToMinted[_msgSender()] + _amount < maxPerWallet, "3");
    ...
    function mint(uint256 _amount) public payable {
        require(_amount < maxPerWallet + 1 && isPublicMintActive, "99");
