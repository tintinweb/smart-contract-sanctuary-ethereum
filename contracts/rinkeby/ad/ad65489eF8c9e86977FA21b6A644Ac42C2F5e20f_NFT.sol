 ...
 */
abstract contract ERC721Tradable is ERC721, ContextMixin, EIP712Base, Ownable {
...
contract NFT is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Jade Rabbit 4", "jaderabbit4", _proxyRegistryAddress)
    {}

    /** IPFS URI of form ipfs://<contractCID> is strongly encouraged */
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafkrmihiv4aqg5ozsejdqcloctuydhkluhshn2tvhwohj54vok5gyiqgdy";
    }
}