...
contract BetSlips is IBetSlips, Initializable, OwnableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(uint256 betSlipsCount) public initializer {
        _betSlipsCount = betSlipsCount;
