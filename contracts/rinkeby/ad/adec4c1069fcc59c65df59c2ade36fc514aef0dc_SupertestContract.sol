...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNpzUwNay5w8hWunfADjDNsBs6gEAwzQteuav7vQ2gtgQ/";
...
// File: contracts/SupertestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SupertestContract is RamppERC721A {
    constructor() RamppERC721A("super test", "BRENN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/3f3RTe2AC3VtZi9S9fRC/contract-metadata";
    }
}
