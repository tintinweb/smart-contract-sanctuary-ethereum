...
_;
    ...
    function presaleMint(address account, uint256 _mintAmount, bytes32[] calldata _proof)
    external
    payable
...
function publicSaleMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) onlyAccounts {
