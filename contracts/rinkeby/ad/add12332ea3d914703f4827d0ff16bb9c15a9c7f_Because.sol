...
contract Because is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public constant FREE_MINT_SUPPLY = 4444;
    uint256 public INSTANT_FREE_MINTED = 1;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Because", "BCUZ") {
        baseURI = initBaseURI;
