...
contract LilBubble is ERC721A, MerkleDistributor, ReentrancyGuard, AccessControl {
    ...
    constructor(address payable shareholderAddress_) ERC721A("Lil Bubble", "LILBUBBLE") {
