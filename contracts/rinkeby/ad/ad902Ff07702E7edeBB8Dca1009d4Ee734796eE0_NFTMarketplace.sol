        ...
        returns (string memory)
    {
        string memory output = string(
            abi.encodePacked(
                ...
                '<rect width="450" height="450" x="25" y="25" rx="25" fill="" stroke="#000" />',
                '<rect width="50" height="450" x="25" y="25" fill="" stroke="#000" />',
                '<g font-family="serif" font-size="38px" text-anchor="middle">This is a kind of drill<text x="275" y="450">',
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Object #',
                        Strings.toString(tokenId),
                        '", "description": "Various Objects is a collection generated and stored on chain.", "image": "data:image/svg+xml;base64,',
