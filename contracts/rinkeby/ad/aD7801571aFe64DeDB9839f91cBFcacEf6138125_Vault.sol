 ...
 */
contract Vault is ERC1155PausableUpgradeable, Supply, Royalty, IVault {
...
contract Supply is Roles, ISupply {
    ...
    function _setMaxSupply(uint256 supply, uint256 tokenId) internal {
        require(
            ...
            'Alt Vault: current supply exceeds new max supply'
        );
...
contract Royalty is Roles, ERC2981Base, IRoyalty {
    ...
    function setDefaultRoyalty(uint16 value) external onlyVaultAdmin {
        require(value < 10001, 'Alt Vault: Dafault Royalty too high');
    ...
    function setRoyaltyReceiver(address newReceiver) external onlyVaultAdmin {
        require(
            ...
            'Alt Vault: Cannot update receiver to address 0'
        );
    ...
    function _setTokenRoyalty(
        ...
        require(value < 10001, 'Alt Vault: Royalties too high');
...
interface IRoyalty is IERC2981 {
    ...
    event DefaultRoyaltyChanged(uint16 oldRoyalty, uint16 newRoyalty);
