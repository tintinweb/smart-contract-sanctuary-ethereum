...
contract Ciao is Ownable, ERC721A {
 ...
 /**
    function refundIfOver(uint256 _publicCost) private {
        ...
        if (msg.value > _publicCost) {
            payable(msg.sender).transfer(msg.value - _publicCost);
        }
    }
 */
