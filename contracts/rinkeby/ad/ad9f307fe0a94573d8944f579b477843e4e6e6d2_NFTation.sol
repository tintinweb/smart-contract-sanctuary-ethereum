    ...
    NFTationStorage
{
    ...
    function initialize() public initializer {
        __ERC721_init_unchained("NFTation", "NFTAT");
        __UUPSUpgradeable_init();
        __Ownable_init_unchained();
        __NFTation_init_unchained();
    }

    function __NFTation_init_unchained() internal onlyInitializing {
        royaltyPercent = 10;
    }
    ...
    function mint(string memory uri) public {
        ...
        _setRoyalty(tokenId, _msgSender(), royaltyPercent);

        //external call
        _safeMint(_msgSender(), tokenId);
        super._setTokenURI(tokenId, uri);

        emit TokenCreated(_msgSender(), tokenId, uri, royaltyPercent);
    }
    ...
    function setRoyaltyPercent(uint8 _RoyaltyPercentage) external onlyOwner {
