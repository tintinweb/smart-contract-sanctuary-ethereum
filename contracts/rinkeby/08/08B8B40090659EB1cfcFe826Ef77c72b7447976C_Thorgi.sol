...
contract Thorgi is ERC20Burnable, Ownable {
    ...
    function checkAllRewardsFromCorgis(address _address) public view returns (uint256) {
        uint256 totalRewards = 0;
        uint256[] memory stakedBone = getStakedBone(_address);
        uint256[] memory corgis = corgiTokenIds[_address];
    ...
    function checkAllRewardsFromPups(address _address) public view returns (uint256) {
        uint256 totalRewards = 0;
        uint256[] memory stakedBone = getStakedBone(_address);
        uint256[] memory pups = pupTokenIds[_address];
