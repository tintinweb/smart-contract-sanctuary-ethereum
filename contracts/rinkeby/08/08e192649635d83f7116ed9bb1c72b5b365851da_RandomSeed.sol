...
contract RandomSeed is VRFConsumerBaseV2, AccessControl {
     ...
     */
    function requestRandomWords(uint32 _chainId, address _contractAddress) external onlyRandomRequesterRole { // TODO - update access rights !!
    ...
    // Chainlink VRF will call this function to deliver the random number
