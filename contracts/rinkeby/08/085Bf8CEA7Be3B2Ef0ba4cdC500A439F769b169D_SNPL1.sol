...
contract SNPL1 is Context, IBEP20, Ownable {
    ...
    function afterDeploy(address charity, address dev, address lottery) public onlyOwner {

        if (_charity == address(0) && _dev == address(0) && _lottery == address(0)) {
