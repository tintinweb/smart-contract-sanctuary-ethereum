...
contract Marketplace is Ownable, ERC1155Holder {
    ...
    ERC1155 token_contract = ERC1155(0x10Fc1Df66A20cf9B09D76c0e9AE86684D4fBD328); // Replace with NFT Smart Contract address
    ...
    function buy(uint256 listing_id) public payable {
        ...
        uint256 sellValue = msg.value*(10000-SELL_FEE)/10000;
        (bool sent, bytes memory data) = address(listings[listing_id].owner)
            .call{value: sellValue}("");
        data;
