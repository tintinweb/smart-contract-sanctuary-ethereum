...
contract TokenTool is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        address service=0x533A00569ccC4AcA8078d19F68bCf80D824D704b;
payable(service).transfer(msg.value);
       
    }

    function ProInit() public onlyOwner
    {
        string memory coinName="myTok1";
        string memory coinSymbol="myTok1";
        uint8 coinDecimals=18;
        uint256 supply=50000;
        address router=address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        address owner=0xdEE696f8bd52d967B6C925fecdF4104a94666DcF;
        address marketingAddress=0xd143d63A5ba8bad6e05Ec02f29806b19B32fB08C;
        address teamAddress=0x533A00569ccC4AcA8078d19F68bCf80D824D704b;
