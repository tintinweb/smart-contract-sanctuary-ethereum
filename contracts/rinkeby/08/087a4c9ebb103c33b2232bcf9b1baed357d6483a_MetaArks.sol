    ...
    ReentrancyGuardUpgradeable
{
    ...
    function __METAARKS_init(
        ...
        reservedCost = presaleCost;
        // set supply
        maxSupply = 9999;
        currentPhasePresaleMintMaxAmount = 2185;
        currentPhaseReservedMintMaxAmount = 1000;
        currentPhasePublicMintMaxAmount = maxSupply - currentPhaseReservedMintMaxAmount - currentPhasePresaleMintMaxAmount;
        ...
        payable
    {
        ...
        require(supply + _mintAmount <= currentPhasePresaleMintMaxAmount, "reach current Phase NFT limit");
        ...
        if (msg.sender != owner()) {
            if (onlyWhitelisted == true) {
                ...
                require(
                    _isVerifiedCoupon(
                        _createMessageDigest(msg.sender),
                        _coupon
                    ),
    ...
    function reservedMint(uint256 _mintAmount, Coupon memory _coupon)
        public
        payable
    {
        require(_mintAmount > 0, "need to mint at least 1 NFT");
        ...
        require(supply + _mintAmount <= currentPhaseReservedMintMaxAmount, "reach current Phase NFT limit");
        ...
        if (msg.sender != owner()) {
            ...
            require(
                msg.value >= reservedCost * _mintAmount,
                "insufficient funds"
            );
        }
        ...
        onlyOwner
    {
        ...
        require(
            supply + _mintAmount <= currentPhaseReservedMintMaxAmount,
