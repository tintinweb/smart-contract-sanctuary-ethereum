...
contract DoodleRooms3DModels is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable DOODLE_ROOMS_3D_MODELS_SUPPLY = 9999;
    ...
    modifier canClaim3DModels(address addr, uint256 [] memory tokenIds) {
    ...
    ) ERC721A("Doodle Pets 3D Models", "DP3DM", 9999) {
        openSeaProxyRegistryAddress = _openSeaProxyRegistryAddress;

        //        doodleRooms = DoodleRooms(0x5426C860C9e660145Ad09d3FB26427e5Fd4569E9);

        // DOODLE_ROOMS_3D_MODELS_SUPPLY = doodleRooms.totalSupply();

        baseURI = "ipfs://QmZzeyfwQLc6bLdxTB9bvw7q497b3g8qEBraRU3vXwNdRq";
    }

    function claim3DModels(uint256 [] memory tokenIds)
    external
    nonReentrant
    publicSaleActive
...
//            tokenIds[i] = doodleRooms.tokenOfOwnerByIndex(addr, i);
            tokenIds[i] = i;
        }
