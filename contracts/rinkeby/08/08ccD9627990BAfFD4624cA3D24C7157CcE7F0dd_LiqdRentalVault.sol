    ...
    ERC1155Holder
{
    ...
    constructor(address _dao, address _rentalImplementation)
        Ownable()
        ReentrancyGuard()
    {
        dao = _dao;
    ...
    function totalRentalIdsByLender(address lender)
        external
        view
        returns (uint256)
    {
    ...
    function totalRentalIdsByBorrower(address borrower)
        external
        view
        returns (uint256)
    {
    ...
    function setPlatformFeeByCurrency(address _currency, uint16 _platformFee)
        external
        onlyOwner
    {
    ...
    /// @notice borrwer creates rental request
