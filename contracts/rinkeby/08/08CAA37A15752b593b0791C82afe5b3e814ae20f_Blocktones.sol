...
contract Blocktones is ERC721Enumerable, Ownable {
    ...
    */
    ...
    function withdraw() public onlyOwner {
        ...
        // todo: finalise the splits for the team on withdrawals
        (bool success, ) = payable(msg.sender).call{ value: total * 50 / 100 }("");
        require(success, "eth withdraw 1 failed");
        (bool success2, ) = payable(0x04FCabe91362983Fc73886F79a2Aa2c02698524e).call{ value: total * 50 / 100 }("");
        require(success2, "eth withdraw 2 failed");
    }
}
