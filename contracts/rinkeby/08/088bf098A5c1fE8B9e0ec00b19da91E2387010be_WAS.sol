...
contract WAS is ERC20, Airdrop, Ownable, IERC721Receiver {
    ...
    // Mapping of all Satoshis currently in hell / heaven
    ...
    //WAS NFT Smart contract
    address private _wasNFTSmartContract;

    

    constructor(uint256 maxTokenSupply) ERC20("WAS Utility Token", "WAS") public {
        maxSupply = maxTokenSupply * 1000000000000000000;
        ...
        _wasNFTSmartContract = 0x3D13BFE69EE3357AA93a52fD27e56ab55f2471C7;
    }
    ...
    public
    {
        ...
        require(maxSupply >= (_totalSupply + claimableAmount),"Invalid claim operation would exceed max token supply limit.");
    ...
    returns (uint256)
    {
        uint256 remainingTokens = maxSupply - _totalSupply;
    ...
    function resurrectHellPublic(uint256 satoshiId,address from)
    public
    {
        ...
        wasNFTContract.safeTransferFrom(from, msg.sender, satoshiId);
...
contract Airdrop {
    mapping(address => uint256) private _airdrop;
	constructor() {
        _airdrop[0x35246183CAC7081048c88eDF87453713A707987e] = 20000000000000000000000;
        _airdrop[0x70224f4E69f0FE6084cD9719fAc5fE46CEB3E9e0] = 50000000000000000000000;
        _airdrop[0x2e3f86a333438f8deAf408340828ABF92a2d021A] = 50000000000000000000000;
        _airdrop[0xD3600d3A5cbEE1589cf390A14741E3A32126Ebbb] = 50000000000000000000000;
	}
