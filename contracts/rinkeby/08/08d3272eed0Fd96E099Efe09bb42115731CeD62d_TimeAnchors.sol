...
contract TimeAnchors is ERC721A, ERC2981, Ownable {
  ...
  */
  ...
  /**
  * @notice Allows the Timeline Transit Company to send achievement payouts at various stages of the game
  * See our whitepaper for more info
  */
  function claimAchievement(address _address, uint256 _amount) external onlySystemAddress { // todo: test is this in gwei or eth and what value do we send here?
    require(address(this).balance >= _amount, "Add more ETH to contract");
