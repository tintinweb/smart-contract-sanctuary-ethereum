...
contract WeRjapaneseTest01 is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri = "ipfs://Qmb9wfrWq7Puhhx8rsTsPvgvgpu5QrFQePoLsjgggNrZuU/1.json"; 
  ...
  ) ERC721A("WeRjapaneseTest01", "WRJT1") {
