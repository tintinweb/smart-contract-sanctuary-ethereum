...
contract QNMinter is Ownable {
    ...
    //test
    iToken public Token = iToken(0x0b0FAf2e311C5B82652955A9bB5519475628Cd89); 
    iNFT public NFT = iNFT(0x9EfC705Af7a48E3b61DDFAe9368b821dF4e7ff61);
    
    //honban
    //iToken public Token = iToken(0xced7c61617aD24b076729Af8EE607A4b30CBf2E4); 
    //iNFT public NFT = iNFT(0x9CE4f6FDC1bf735329d1dDeD7EbD706C3c9452a1);
    uint256 public yieldStartTime = 1658325600;//21/07/22 00:00:00
    uint256 public yieldEndTime = 1816092000;//21/07/27 00:00:00
    uint256 public yieldRatePerToken = 1000 ether;
