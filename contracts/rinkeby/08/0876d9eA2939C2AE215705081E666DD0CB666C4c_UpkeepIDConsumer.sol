...
// UpkeepIDConsumer.sol imports functions from both ./KeeperRegistryInterface.sol and
...
interface KeeperRegistrarInterface {
  function register(
    ...
    uint96 amount,
    uint8 source
  ) external;//0x61787d7543c074ebfaf2baf2d83ca6129b1238ce
}
...
contract UpkeepIDConsumer {
  ...
  uint256 public keepID;//only testing
