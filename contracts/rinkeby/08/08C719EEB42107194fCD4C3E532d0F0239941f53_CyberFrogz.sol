...
contract CyberFrogz is ERC721, EIP712, Ownable {
    ...
    function redeem(NFTVoucher calldata voucher, bytes memory signature) external payable {
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            ...
            require(voucher.numberOfTokens <= 2, "Max 2 tokens per transaction");
            require(_whitelistMintedCount[voucher.redeemer] < 2, "You've already minted all tokens available to you");
            ...
            require(voucher.numberOfTokens == 1, "Max 1 token per transaction");
            require(_mintedCount[voucher.redeemer] < 1, "You've already minted all tokens available to you");
