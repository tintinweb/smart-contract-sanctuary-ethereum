...
error Lottery__NotNeeded(uint256 currentBalace, uint256 numParticipants, uint256 lotteryState);

/**@title A sample Lottery Contract
 * @author me
 * @notice This contract is for creating a sample  decentralized lottery contract
...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // Chainlink Oracle - to get  Randomness, Automated Execution (Chainlink Keeper)
     ...
     * They expect to `upkeepNeeded` to return true
     * The following should be true in order to return true
     * 1. Time interval should have passed
     * 2. The lottery should have at least one participant
        ...
        )
    {
        ...
        // block.timestamp  return current time stamp of blockchain
