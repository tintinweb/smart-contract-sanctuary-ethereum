...
contract Moondickbuttbirds is ERC721A, Ownable {
	using Strings for uint256;
    ...
    address address1 = 0x02f637b0B40b9e40E950Fa2bf90B4757709c47b6;
    address address2 = 0x02f637b0B40b9e40E950Fa2bf90B4757709c47b6;

    mapping(address => bool) public mintlist;

	constructor() ERC721A("Moondickbuttbirds", "MDBB") {}
    ...
    function claim() public {
        require(status, "Sale inactive" );
        require(msg.sender == tx.origin, "No contracts!");
        require(minted < maxFreeSupply, "Would excced free supply" );
        //require(mintlist[_wallet] != true, "Already claimed!");
        require(canClaim(msg.sender), "Already claimed");
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(address1).send(_share * 50));
        require(payable(address2).send(_share * 50));
    }
