...
contract WewyWoos is ERC721A, Ownable, Pausable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  uint64  public  immutable _maxSupply = 5555;
  uint64  public            _mintPrice = 0.1 ether;
  uint64  private immutable _maxMintAmountPerTx = 1;
  ...
  address public constant xFounder = 0x370f75a63F438186DbfECfD27cD75a5023bEa737;

  mapping(address => uint) public addressMintBalance;

  constructor() ERC721A("WewyWoos", "WW") {}
