 ...
 * local test networks
 */
contract KindlyNFT is Ownable, ERC721 {
  ...
  // events
  event KindlyOnHoldChanged(address _holder, uint256 balance);
  event StakedKindlyChanged(address _holder, uint256 balance);
  event RewardsFromStakingChanged(address _holder, uint256 balance);
  event ChildDonationsMade(address _holder, uint256 balance);
  event AnimalDonationsMade(address _holder, uint256 balance);
  event TreeDonationsMade(address _holder, uint256 balance);
  ...
  function updateKindlyOnHold(address previousHolder, address newHolder, uint256 newBalance) public  { // TODO: add modifier ownable only kindly erc20 contract
    if (previousHolder != address(0)){
      ...
      emit KindlyOnHoldChanged(previousHolder, mappingAddressDeeds[previousHolder].kindlyTokensOnHold);
    }
    if (newHolder != address(0)){
      ...
      emit KindlyOnHoldChanged(newHolder, mappingAddressDeeds[newHolder].kindlyTokensOnHold);
    }
  }
  ...
  function addKindlyChildDoantions(address _holder, uint256 balance) public {
    ...
    emit ChildDonationsMade(_holder, mappingAddressDeeds[_holder].feedChild);
  }
  ...
  function addKindlyAnimalDoantions(address _holder, uint256 balance) public {
    ...
    emit AnimalDonationsMade(_holder, mappingAddressDeeds[_holder].feedRescuedAnimal);
  }
  ...
  function addKindlyTreeDoantions(address _holder, uint256 balance) public {
    ...
    emit TreeDonationsMade(_holder, mappingAddressDeeds[_holder].plantTree);
  }
  ...
  function addStakedkindly(address _holder, uint256 balance) public {
    ...
    emit StakedKindlyChanged(_holder, mappingAddressDeeds[_holder].stakedKindly);
  }
  ...
  function updateRewardsFromStakedKindly(address _holder, uint256 balance) public {
    ...
    emit RewardsFromStakingChanged(_holder, mappingAddressDeeds[_holder].rewardsFromStaking);
  }
