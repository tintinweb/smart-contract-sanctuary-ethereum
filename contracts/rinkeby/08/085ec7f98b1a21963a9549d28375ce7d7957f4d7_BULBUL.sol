...
contract BULBUL is ERC721A, ERC721AQueryable, Owned {
  uint256 constant EXTRA_MINT_PRICE = 0 ether;
  uint256 constant MAX_SUPPLY_PLUS_ONE = 10001;
  uint256 constant MAX_PER_TRANSACTION_PLUS_ONE = 11;

  string tokenBaseUri = "ipfs://QmaznXoK8peMcXZo23zwUfVsZFJXW5WJdKHvtQZL6z7BXA/";

  bool public paused = true;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("BULBUL", "BL") Owned(msg.sender) {}
