...
contract Bifi is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint public constant freePerWallet = 2;
    uint public constant maxPerWallet = 2;
    ...
    function mint(uint amt) external nonReentrant {
        ...
        require(MAX_SUPPLY >= totalSupply() + amt, "Exceeds max supply");
        require(amt > 0 && amt <= maxPerWallet,"Not more than 2");
        require(_numberMinted(msg.sender) + amt <= maxPerWallet,"Not more than 2!");
  ...
  */
   function withdraw() external onlyOwner {
    ...
    function deactivate(bool _pause) external onlyOwner {
        pause = _pause;
    }
    ...
    function activate(bool _live) external onlyOwner {
        live = _live;
    }
