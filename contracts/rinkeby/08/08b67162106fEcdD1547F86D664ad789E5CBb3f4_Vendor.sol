...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        ...
        bool sent = yourToken.transfer(address(msg.sender), amountToBuy);
        require(sent, "Buy token failed");

        emit BuyTokens(address(msg.sender), msg.value, amountToBuy);
    }
