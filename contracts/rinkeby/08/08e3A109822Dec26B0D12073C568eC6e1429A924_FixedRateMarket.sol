...
contract FixedRateMarket is Initializable, ERC20, IFixedRateMarket {
  ...
  function borrow(
    ...
    uint amountFV = Interest.PVToFV(APR, amountPV, block.timestamp, _maturity);
  ...
  function borrowFV(
    ...
    uint amountPV = Interest.FVToPV(APR, amountFV, block.timestamp, _maturity);
  ...
  function _processLoan(
    ...
    if(quote.quoteType == 0){ // Quote is in PV terms
      ...
      if(amountPV > quote.cashflow - _quoteFill[quote.signature]){
        ...
        amountFV = Interest.PVToFV(quote.APR, amountPV, block.timestamp, _maturity);
      }
      ...
      if(amountFV > quote.cashflow - _quoteFill[quote.signature]){
        ...
        amountPV = Interest.FVToPV(quote.APR, amountFV, block.timestamp, _maturity);
      }
...
library Interest {
  ...
  function PVToFV(
    ...
    uint interest = PV * APR * elapsed / QConst.MANTISSA_APR / QConst.YEAR;
  ...
  function FVToPV(
    ...
    uint num = FV * QConst.MANTISSA_APR * QConst.YEAR;
    uint denom = QConst.MANTISSA_APR * QConst.YEAR + APR * elapsed;
