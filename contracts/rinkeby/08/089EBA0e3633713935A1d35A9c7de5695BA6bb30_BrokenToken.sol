...
contract BrokenToken is ERC20, Ownable, ReentrancyGuard {
    ...
    function withdrawBrokenTokens(address _to, uint256 _amount) external onlyOwner nonReentrant {
        transfer(_to, _amount);
    }

    function withdrawTokens(address _tokenContract, uint256 _amount) external onlyOwner nonReentrant {
