...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xaf1A4dE858FC103e2310677e70CE4d8EF142fa78];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://bafybeiftn7w3sh43tfj7chlbnapnsgy5csxntkzs3pcwlunoej33b5xnuy/9.png/";
...
// File: contracts/L3TtuContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract L3TtuContract is RamppERC721A {
    constructor() RamppERC721A("L3ttu", "L3ttu"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9cw7DHsDykkLxdHa910h/contract-metadata";
    }
}
