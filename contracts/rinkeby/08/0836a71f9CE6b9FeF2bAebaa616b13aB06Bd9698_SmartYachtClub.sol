...
/**
 * @title SmartYachtClub contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract SmartYachtClub is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("SmartYachtClub", "BYC") {
        MAX_APES = 2;
        REVEAL_TIMESTAMP = 1619820000 + (86400 * 9);
    }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmYhJF8Eo87qYpTq3ozpseBcghLiZ5Ub6U8aVy8cJP2Wr2";
    }
    ...
    function mintApe(uint256 numberOfTokens) public payable {
        ...
        //require(msg.value >= numberOfTokens, "Ether value sent is not correct");
