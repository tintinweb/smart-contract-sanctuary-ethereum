    ...
    NFTCollectionBurnable
{
    constructor()
        NFTCollection(
            "TestSerum", // Name
            "TS2", // Symbol
            "https://notrevealed.com/", // Base URI
            0.009 ether, // Cost to mint
            8888, // Max supply
            5, // Max mint amount per tx
            0xbc4601D8d7497bB6cA80D5700B64cF37C32D5Ce5 // Contract owner
        )
        NFTCollectionWhitelistReserved(
            3899, // total reserved for whitelist
            0x65e3176066bb8c805771109a05c3865074a33d48da6219c3110828e7932c51bf, //merkle root
            5 // Total mint amount per wallet
        ) // For the team
        NFTCollectionRoyalties(0x308b6BEF34c0b9cf147A407C7aB3249beB7837f3, 750) // 7,5% royalties
    {
