...
contract GenesisRobotsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Genesis Robots";
    string public symbol = "PRZL";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GPDKmdJDtXXhUlQv1X10/contract-metadata";
    }
