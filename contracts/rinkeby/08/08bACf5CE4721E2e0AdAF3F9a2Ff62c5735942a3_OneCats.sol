...
contract OneCats is ERC721A, Ownable {
    ...
    uint256[] public WL_SUPPLY_MAX = [333, 333, 333];
    ...
    constructor() ERC721A("One Cats TEST", "ONECATSTEST") payable {
        presaleConfig = PresaleConfig({
            startTime: 1651939200, // Mon May 6 2022 10AM GMT // CHANGE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
            endTime: 1654531200, //	Mon June 6 2022 4PM GMT
            whitelistPrice: 0.4 ether
        });
        publicSaleStartTime = 1654531200; // Mon June 6 2022 4PM GMT
        publicSaleEndTime = 1654617600; // Wed, June 7, 2022 4PM GMT
    }
        ...
        payable
    {
        ...
        if (whitelistTotalSupply + 1 > currentMaxSupply(WL_SUPPLY_MAX)) revert OutOfSupply();
        ...
        payable
    {
        ...
        if (walletMints[msg.sender][CURRENT_PHASE]) revert AlreadyMinted();
        if (totalSupply() + 1 > currentMaxSupply(SUPPLY_MAX)) revert OutOfSupply();

        unchecked { walletMints[msg.sender][CURRENT_PHASE] = true; }
    ...
    function batchAirdop(address[] calldata addresses, uint256[] calldata quantities) external onlyOwner {
        uint32 i;
    ...
    function configurePresale(uint32 _startTime, uint32 _endTime, uint256 _price) external onlyOwner {
