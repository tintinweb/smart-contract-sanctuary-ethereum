...
contract MarketPlace is ReentrancyGuard {
    ...
    function updateListingFee(uint _fee) public payable {
    ...
    function getListedItem(uint tokenId) public view returns (Listing memory) {
    ...
    function buyItem(uint tokenId) public payable nonReentrant {
    ...
    function cancelListedItem(uint tokenId) public {
        Listing storage listing = _listings[tokenId];
