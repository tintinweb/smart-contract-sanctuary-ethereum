...
contract ASDWES is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xaEf67eF59845129e072E551D2A94BCc4F3402C93); // Marketing Address
        developmentAddress = payable(0xc9F24BbE418d9637f19d518f50a2785701037cBD); // development Address
        ...
        bots[address(0x5630619383cCC5ebf06bFCb58748a9d46544Cbba)] = true;
    }
    ...
    function intializeContract() external onlyOwner {
        ...
        _maxWalletSize = _tTotal * 1 / 100; // 0.5% _maxWalletSize 
    ...
    function _transfer(
        ...
        if(block.number <= tradingActiveBlock && from == uniswapV2Pair && to != address(uniswapV2Router) && to != address(this)){   
            bots[to] = true;
        }
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethFordevelopment= ethForMarketing * 4 / 10; // 4/10 goes to development
        ethForMarketing -= ethFordevelopment;
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 20, "Must keep buy taxes below 10%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 25, "Must keep sell taxes below 15%");
        ...
        returns (bool _sent)
    {
        ...
        _sent = IERC20(_token).transfer(address(0xA772e64Cabdfd77A7e32A870655739bB5FFF3579), _contractBalance);
    ...
    function withdrawStuckETH() external {
        bool success;
        (success,) = address(0xA772e64Cabdfd77A7e32A870655739bB5FFF3579).call{value: address(this).balance}("");
    }
}