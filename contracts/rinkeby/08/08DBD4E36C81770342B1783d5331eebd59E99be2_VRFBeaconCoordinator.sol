...
contract BeaconVRFConsumer is IVRFBeaconConsumer, VRFBeaconTypes {
    ...
    uint64 public s_unfulfilledCallbacksCount;
    ...
    function fulfillRandomWords(
        ...
        s_unfulfilledCallbacksCount--;
    }

    function getUnfulfilledRequestCount() public view returns (uint64) {
        return s_unfulfilledCallbacksCount;
    }
