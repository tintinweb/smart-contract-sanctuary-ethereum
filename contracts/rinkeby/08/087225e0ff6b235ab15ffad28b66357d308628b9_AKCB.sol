...
contract AKCB is ERC721, Ownable {
	...
	uint32 public constant MAX_TOKENS = 100;
	uint32 public constant MAX_EACH_TYPE = 5;
	uint32 private constant TOTAL_MALES = 4;
	uint32 private constant TOTAL_FEMALES = 1;
