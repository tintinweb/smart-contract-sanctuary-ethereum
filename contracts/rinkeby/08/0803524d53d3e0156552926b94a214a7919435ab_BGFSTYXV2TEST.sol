...
contract BGFSTYXV2TEST is Ownable, IERC721Receiver {
    ...
    function spendBalanceFamiliars(address _address, uint256 _amount) public {
        ...
        require(bank[_address] >= _amount, "Not Enough $STYX.");
    ...
    function decrStyxBalance(address _address, uint256 _amount)
        public
        onlyOwner
    {
        require(bank[_address] >= _amount, "Not Enough $STYX.");
    ...
    function setStyxBalance(address _address, uint256 _amount)
        public
        onlyOwner
    {
        bank[_address] = _amount;
