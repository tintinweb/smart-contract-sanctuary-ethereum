...
contract GaiaD is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("GaiaDog", "Gaia") {
  ...
  {
    return string(abi.encodePacked(super.tokenURI(tokenId), "https://gateway.pinata.cloud/ipfs/QmdRMGcd1zoHJJot16JxeeLAHXfWzojv9GkxH3XfBY4uHt/husky.json"));
  }
