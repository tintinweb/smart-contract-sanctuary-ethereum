...
contract plagueNFT_V0 is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
contract plagueToken_V0 is ERC20Stakeable, Ownable {
...
contract plagueNFTStaking_V0 is Ownable, IERC721Receiver {
  ...
  plagueNFT_V0 nft;
  plagueToken_V0 token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(plagueNFT_V0 _nft, plagueToken_V0 _token) { 
    nft = _nft;
    token = _token;
  }
