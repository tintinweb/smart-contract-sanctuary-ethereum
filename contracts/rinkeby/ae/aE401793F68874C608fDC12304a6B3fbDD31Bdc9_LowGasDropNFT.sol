...
contract LowGasDropNFT is Ownable, ERC721V2 {
    ...
    function mintBatch(address _user, uint256 _amount)
    external onlyOwner
    {
        uint256 total = _owners.length;

        require(total + _amount <= maxTotalSupply, "Exceeded limit");
