...
contract ERC721Staking is ERC721Holder, ReentrancyGuard, Ownable, Pausable {
    ...
    /* ========== CONSTRUCTOR ========== */
    // 0xa9597A2934a6060b2494bEB255A588148b3d9AeE Parent
    constructor() {
        stakingToken = IERC721(0xa9597A2934a6060b2494bEB255A588148b3d9AeE);
        isPaused = false;
    }

    function stake(uint256 _tokenId, uint256 _amount) external nonReentrant whenNotPaused {
