...
contract CyberSnails is ERC721A, Ownable, ReentrancyGuard, Pausable {
    ...
    function whitelistMint(uint256 count, uint256[] memory tokenIds, bytes32[] memory proof) external payable nonReentrant {
