...
contract Raffle is Ownable, TicketStorage, ERC1155Holder, ERC721Holder, PullPayment, VRFConsumerBaseV2 {
    ...
    function verifyERC1155PresenceBeforeStart() external {
    ...
    function transferERC1155ToOwnerIfCancelled(address contractAddress, uint256 tokenId) external {
        require(_state == State.Cancelled, "Must be in Cancelled");
    ...
    function transferERC1155ToWinnerIfCompleted() external {
