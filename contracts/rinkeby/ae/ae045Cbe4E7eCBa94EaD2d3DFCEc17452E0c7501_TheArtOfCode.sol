...
contract TheArtOfCode is ERC721A, Ownable, ReentrancyGuard {
    ...
    string  public baseTokenURI = "https://bafybeicpspjsj5syp54rdqghr2oskpbc2frcsampuoj2qjwowzhtjxuiiy.ipfs.nftstorage.link/metadata";
    uint256 public codes = 1000;
    uint256 public MAX_CODES_PER_TX = 3;
    uint256 public MAX_CODES_PER_WALLET = 3;
    uint256 public CODE_PRICE = 0.005 ether;
    uint256 public MAX_FREE_CODES_PER_WALLET = 1;
    bool public itsAlive = true;
    bool public isCodeTranslated = false;

    mapping(address=>uint256) public codesCounter;
    ...
    function mint(uint256 numberOfTokens) external payable
    {
        ...
        uint256 codesOfSender = codesCounter[msg.sender];
        ...
        bool alreadyMintedAFree = codesOfSender > MAX_FREE_CODES_PER_WALLET;

        if (alreadyMintedAFree) {
            require(msg.value > 0, "You already minted a free code");
            require((CODE_PRICE * numberOfTokens - 1) == msg.value, "Don't try hack the contract, dev");
        }
        ...
        codesCounter[msg.sender] += numberOfTokens;
