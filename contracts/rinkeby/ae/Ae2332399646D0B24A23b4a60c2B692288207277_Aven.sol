...
contract Aven is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xE1c089D5311C09722E3bFCDf26962896c350C30E);
    address payable private Wallet_Team = payable(0xE1c089D5311C09722E3bFCDf26962896c350C30E);
    ...
    */
    ...
    string private _name = "Aven"; 
    string private _symbol = "Aven";  
    uint8 private _decimals = 18;
    uint256 private _tTotal =  10**18;  // 10 billion
    ...
    address private USDC_ADDRESS = address(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b);
    ...
    */
    ...
    // Update main wallet
    function Wallet_USDC_ADDRESS(address USDC) public onlyOwner() {
        USDC_ADDRESS = USDC;
    }
