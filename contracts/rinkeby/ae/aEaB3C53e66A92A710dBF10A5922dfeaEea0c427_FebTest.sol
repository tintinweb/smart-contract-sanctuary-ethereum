...
contract FebTest is ERC721, Ownable {
  using Strings for uint256;
...
// Initialise Contract
  constructor() ERC721("Bally Gang", "BALLYG") {
    ...
    setPayable(address(0x35d134cF8c0b0a7Ac4d4A26f63568e179092b27D));                    //Lowkee's Payment Wallet   0x779a516cC09E7Fb12daA2eA4fE961916A4B2e177
    
    setDeveloper(msg.sender);                                                           //Kunal's Developer Wallet  0xDFE5629Aa0e766F7214E9b970468a56a2bC5441c

    //INITIALISE MINT LOGIC AT DEPLOYMENT
    //MINT BALLYG[1-10] -> STATIC 1:1 TOKENS
    _mintLoop(address(0xcAa7252F09e3eFE52656D849828f55A1ad07CFef),10);                  //Lowkee's NFT Wallet       0x15023dFD0c33859B5Ace6665eEe7a3d524d65C42

    //MINT BALLYG[11-388] -> GENERATIVE TOKENS
    _mintLoop(address(0xcAa7252F09e3eFE52656D849828f55A1ad07CFef),378);                  //

    //AIRDROPS FOR ARTISTS/INFLUENCERS/GIVEAWAYS/WINNERS
    _mintLoop(address(0xDFE5629Aa0e766F7214E9b970468a56a2bC5441c),10);                  //gets 10
    //
    /*
...
_mintLoop(address(0xCC9608701a6d6ae40a09172d4e842557D30f3a41),1);
_mintLoop(address(0x16C316b881caCb56b941C971F6415634C84fb9eb),1);
_mintLoop(address(0x3DAdEc226FF72FbEdA4d6E28E598DB88e49Ff225),1);
_mintLoop(address(0x137F256479034436817e697A989B8971b335Db96),1);
_mintLoop(address(0xc5Ef80045f865F914c5B986c8C91851FBe56d438),1);
_mintLoop(address(0x14078793dd4524D5000411DBB5c5B0b50565D574),1);
_mintLoop(address(0x5853E96A4b2817cd73913181eFf6e1Fb5B37EE07),1);
_mintLoop(address(0x2C2e287DC919Fa661a2eACf7798BED998A6e9670),1);
_mintLoop(address(0xB0Cdf4f8bD6de36649b9a99b9fEdacDda79cD07F),1);
_mintLoop(address(0xdB9Cb8d025286609FE33377A5667933f52beB4d9),1);
_mintLoop(address(0x4674FD4cc9b21C4AF24602e17658b3f66dDaB888),1);
_mintLoop(address(0x4674FD4cc9b21C4AF24602e17658b3f66dDaB888),1);
_mintLoop(address(0x49F7F6859ab3E4d5384D0d9CC72693Ceb6C9740B),1);
_mintLoop(address(0x82278Bf3c7139282C6dec17f9D3F40755cF0edb2),1);
_mintLoop(address(0x3479D00eF0A6bd8f16e6a658AD53dcdE12521163),1);
_mintLoop(address(0x7C75cC2de244E9D355684aEB7ed20f9ABdEB63db),1);
_mintLoop(address(0xe357fA4E2Bc97A4B9C5dE869853A7aB2f703559E),1);
_mintLoop(address(0xC642fb42182038b4a4fB97830C3Db72B45e4e332),1);
_mintLoop(address(0xCF7782245D94824c5892212291125CEc41cD4E67),1);
_mintLoop(address(0x7f0a4D5db91Fa96C57CF8753c2536B8482E9101D),1);
_mintLoop(address(0x819e2d64A7E5DD0a480f42ecdc13c962636e8F6e),1);
_mintLoop(address(0xd0dFb9E8A6F693db52ECBd11d195f59Af1850c61),1);
_mintLoop(address(0x8a2aaB6298c0Ee8BA28684113A30Cc1F7b2e3468),1);
_mintLoop(address(0x780138A5804452D1692775133E3EDBA9914656a0),1);
_mintLoop(address(0xc35a066b855f356Bc7238ccBA117002011DA9983),1);
_mintLoop(address(0xbc5C66567e5F4BdBeDAE0dB4AC3de3c6A2F7eE8C),1);
_mintLoop(address(0x23b7159E4A584cC9d5337D53BE6826F5a2922576),1);
_mintLoop(address(0x2927C319Ce32130390A362Ab12376Bbc6D5B0Ee2),1);
_mintLoop(address(0x8F260bF0B358Af8106ABe7Fc784697048e8eaF2C),1);
_mintLoop(address(0x9d20ca555aDE4A3372E6A15BAF6ABE362e68C82b),1);
...
//add in batch to the whitelist -- kunal
