...
contract ZzoopersGift is ERC1155, Ownable {
    string public name;
    string public symbol;
    mapping(uint256 => string) private _uris;

    constructor(string memory name_, string memory symbol_) ERC1155("") Ownable(){
        name = name_;
        symbol = symbol_;
    }

    function mint(address to_, uint256 id_, uint256 amount_) public onlyOwner{
