...
contract GodsOfEgypt is ERC721A, VRFv2Consumer, ERC2981ContractWideRoyalties {
    ...
    string public baseURI = "ipfs://QmaPdamgfjpbvKsuBARpY1cScBhjRkoSam4boE6scH4esS?"; // TODO: change to GOE ipfs
    ...
    address constant public ROYALTY_RECIPIENT = 0x2bdB46441007C395bcC5B97df3941FDfb9d5D78D; // TODO: change to royalty recipient addy
    address constant public DEV_TEAM = 0x2bdB46441007C395bcC5B97df3941FDfb9d5D78D; // Novem Wallet Address
    uint256 constant public ROYALTY_PERCENTAGE = 500; // TODO: change % of royalty

    // Protection
    mapping (address => uint256) amountMinted;
    mapping (uint256 => string) gods;
    uint256 public mintLimit = 1; // TODO: change to mint limit

    address private _adminSigner = 0xdc6504F73dFE85628be17f715567907522faeA23; // TODO: change to adminSigner addy
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory bURI = bytes(gods[tokenId]).length > 0 ? gods[tokenId] : _baseURI();
    ...
    function withdrawFunds() public onlyOwner {
        ...
        payable(0x1BEAe2eF143f7f974eb734b9e8369781Db08F0CC).transfer(balance*22/100);
        ...
        payable(0x4e9f2E50395350928ef2e9C5C0036895fa269b4a).transfer(balance*1/100);
        ...
        payable(0x9EFC6C6243965FE6288d3712b9c595855B1D6EE6).transfer(balance*22/100);
        ...
        payable(0xc95857fcC5a13BDebda5E3A61a5647912eCa7C71).transfer(balance*1/100);
        ...
        payable(0x3bAE9D1a0D5CeB9Df403DD6F0c088ca086C49A01).transfer(balance*2/100);
        payable(0x8f973f7bAE949Eb900233299FF6A5F2a09ef5168).transfer(balance*20/100);
