...
contract ExchangeChallenge is IExchangeChallenge, Ownable{
    ...
    uint256 public YAAS_FEES = 5e18;// marketplace token peer challenge token
    ...
    function addChallenge(
        ...
        uint256 airdropEndAt)external override returns (uint256){
            ...
            challenges[_challengeIdCounter.current()] = Challenge(
                seller, 
                collection, 
                assetId, 
                amount, 
            ...
            emit AddChallenge(_challengeIdCounter.current(), seller, collection, assetId, amount, allowResell, saleEnd, airdropStartAt, airdropEndAt);
...
interface IExchangeChallenge {
     ...
     */
    function addChallenge(address seller, address collection, uint256 assetId, uint256 amount, bool allowResell, uint256 saleEnd, uint256 airdropStartAt, uint256 airdropEndAt) external  returns (uint256);
