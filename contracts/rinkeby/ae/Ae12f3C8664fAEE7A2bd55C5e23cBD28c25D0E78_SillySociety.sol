...
contract SillySociety is 
    ...
    uint256 public constant TOTAL_SUPPLY = 300 - GIFT_SUPPLY;
    ...
    function gift(address receivers, uint256 _mintAmount) external onlyOwner nonReentrant {
        require(!paused, "Paused!");
        require(totalGift +  _mintAmount <= GIFT_SUPPLY, "Gift Maxed!");
        totalGift += _mintAmount;
