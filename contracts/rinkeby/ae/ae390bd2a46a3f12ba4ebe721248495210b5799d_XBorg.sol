...
contract XBorg is Ownable, IERC2981, ERC721X, ReentrancyGuard, TokenStake {
    ...
    uint256 public NFT_PRICE = 0.008 ether; // 10000000000000000000
    ...
    constructor(uint32 SetpublicSaleKey, uint32 SetWL_Class) ERC721X("XBorg", "XBORG", MaxBatchSize, MaxSupply) {
        ...
        WithDrawWallet1 = 0x592d4aE36dB7D196E0caD2c3083431B392f95e78;
        WithDrawWallet2 = 0xC0c464514d6397b7b529A3650697Fd5967b5A892;
    }
    ...
    function ConfigParam(uint256 _MaxMint, uint256 _NFTPrice) public onlyOwner {
