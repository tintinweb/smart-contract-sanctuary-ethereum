...
contract NaffitiLaunchPadSign721 is
    ...
    Pausable,
    Ownable,
    EIP712("NaffitiLaunchPadSign721", "v1.1.0")
{
    ...
    function mint(
        ...
        if (oldSupply + _mintAmount > _maxMintPerPeriod) revert InvalidMintAmountPerPeriod();

        mintedAmount[_recipient] += _mintAmount;
        if (mintedAmount[_recipient] > _maxMint) revert InvalidMintAmount();
