...
*/
    ...
    function hash(
        ...
        for (uint8 i = 0; i < 15; i++) {
            ...
            if (bstyle == 1 && i == 4) pindex = randDigit; // keep track of pants colors for members
            else if (bstyle == 1 && i == 12) randDigit = pindex;
    ...
    function outputFullSVG(string memory _hash) public view returns (string memory) {
        ...
        for (uint8 i = 0; i < 15; i++) {
            ...
            if (thisTraitIndex != 0) svgString = string(abi.encodePacked(svgString, drawTrait(traitData[i][thisTraitIndex])));
        }
