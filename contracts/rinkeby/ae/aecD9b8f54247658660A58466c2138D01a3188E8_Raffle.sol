...
contract Raffle is VRFConsumerHelper, Ownable {
    IERC721Enumerable public cuntster;
    uint256 index;
    ...
    function fulfillRandomness(bytes32, uint256 randomness) internal override {
        uint256 max = cuntster.totalSupply();
        ...
        address owner = cuntster.ownerOf(chosen);
    ...
    function updateCuntsters(IERC721Enumerable _cuntster) external onlyOwner {
        cuntster = _cuntster;
    }
}
