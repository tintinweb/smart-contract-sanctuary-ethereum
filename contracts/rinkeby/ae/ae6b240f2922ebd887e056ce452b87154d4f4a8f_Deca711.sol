...
contract Deca711 is VRFConsumerBaseV2, Pausable, Ownable, ReentrancyGuard {
    ...
    function bet(uint256 _betAmount, uint256 _faceSide) external {
        ...
        require(_betAmount <= maxBetPercent.mul(housePoolBalance.depositAmount).div(100), "maxBet");
    ...
    function fulfillRandomWords(
        ...
        record.headOrTail = playerPredict <= 50;
        record.resultHeadOrTail = sortedFace <= 50;
