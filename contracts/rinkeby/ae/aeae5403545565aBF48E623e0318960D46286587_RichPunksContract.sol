...
//*********************************************************************//
//
//     ____  ____________  __   ____  __  ___   ____ _______
//    / __ \/  _/ ____/ / / /  / __ \/ / / / | / / //_/ ___/
//   / /_/ // // /   / /_/ /  / /_/ / / / /  |/ / ,<  \__ \ 
//  / _, _// // /___/ __  /  / ____/ /_/ / /|  / /| |___/ / 
// /_/ |_/___/\____/_/ /_/  /_/    \____/_/ |_/_/ |_/____/  
//                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3F3979931Dd96F7395D4b207A78987683E4aae9d];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiafdx4csmvphhxjwzaitv2nir7hrzvq5mrtdajupagam2276bojh4/";
...
// File: contracts/RichPunksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RichPunksContract is RamppERC721A {
    constructor() RamppERC721A("Rich Punks", "RICH"){}
}
