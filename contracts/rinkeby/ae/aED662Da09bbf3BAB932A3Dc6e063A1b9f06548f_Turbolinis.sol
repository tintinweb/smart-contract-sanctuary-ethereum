...
contract Turbolinis is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public supplyLimit = 8888;
  ...
  function setfreeMintSale(bool _freeMintStatus) public onlyOwner {
    freeMintSale = _freeMintStatus;
  }
