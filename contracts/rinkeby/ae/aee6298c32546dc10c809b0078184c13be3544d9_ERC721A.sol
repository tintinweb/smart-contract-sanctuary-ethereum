...
// File: LAUNCH_flat_flat_flat.sol


// File: LAUNCH_flat_flat.sol
...
contract PIXELRENGA is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private baseURI = "ipfs://Qmf1PA8mePnUyMB7h9H7MWBUhzQXGWskYg14wtUGRmpXrL/";
    uint256 public constant MAX_MINT_PER_ADDR = 10;
    uint256 public constant MAX_FREE_MINT_PER_ADDR = 0;
    ...
    constructor(string memory initBaseURI) ERC721A("Pixel Renga", "PXRG") {
        baseURI = initBaseURI;
