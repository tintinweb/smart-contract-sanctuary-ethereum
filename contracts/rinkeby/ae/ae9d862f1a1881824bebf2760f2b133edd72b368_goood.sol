...
contract goood is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;
    string  public baseTokenURI = "ipfs://QmNX5zK2NtA3EdEkCRg9PPdVYcD7dresn49foyMWF5fKYT/";
    uint256 public MAX_SUPPLY = 103;
