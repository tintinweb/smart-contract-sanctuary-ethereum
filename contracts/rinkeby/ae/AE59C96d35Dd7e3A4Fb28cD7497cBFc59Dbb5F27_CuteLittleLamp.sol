...
contract CuteLittleLamp is ERC721Tradable, ReentrancyGuard {
    ...
    function contractStatus() public view returns (uint256, uint256, salesRound, salesStatus, salesType ) {
        return (totalSupply(), currentPrice(), currentSalesRound, currentSalesStatus, currentSalesType);
    }
