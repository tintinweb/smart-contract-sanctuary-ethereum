...
contract TrapMonkie is ERC721A, Ownable, ReentrancyGuard {
    ...
    */
    ...
    address GNOSIS_VAULT = 0xbd3Aaa7a8ed2850E415E888a28fef47F53e24c1d;
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        payable(FOUNDER_WALLET).transfer((balance * 32)/100);
        payable(GNOSIS_VAULT).transfer((balance * 20)/100);
    ...
    function withdrawAmount(uint256 _amount) public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
        require(balance > 0, "NO FUNDS AVAILABLE");
        payable(FOUNDER_WALLET).transfer((_amount * 32)/100);
        payable(GNOSIS_VAULT).transfer((_amount * 20)/100);
