...
contract TestSploogers is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  /**
     * @dev Enter Splooge cleanup fee: (.0069 per 1 NFT); Enter amount: (1,2,3,etc.); Enter Merkleproof: Found on offical Minting website
     */
