...
modifier onlyOrchestrator() {
 ...
 receive() external payable {
  ...
  function whitelistMint(address account, uint256 tokenAmount, bytes32[] calldata _merkleProof) public payable isValidMerkleProof(_merkleProof) onlyAccounts {

 }

  function publicSale(uint256 tokenAmount) public payable onlyAccounts {
    require(publicMint, 'Sale is not Enabled' );
  ...
  function withraw() external onlyOwner nonReentrant{
