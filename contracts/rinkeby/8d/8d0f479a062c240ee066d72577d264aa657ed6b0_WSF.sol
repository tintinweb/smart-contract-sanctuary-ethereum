...
contract WSF is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply, ReentrancyGuard {
    ...
    function mint(uint256 tokenId, uint256 amount) public payable {
        ...
        // the price is right
        require(msg.value >= amount * tokenInfo.price, "not enough ether sent");
    ...
    function addToken(uint256 tokenId, uint256 maxSupply, uint256 price) public onlyOwner {
        ...
        tokenInfos[tokenId] = TokenInfo(true, maxSupply, price); 
    }
    ...
    function guardResources(address[] memory _accounts, uint256[] memory _ids) public view returns (uint256[] memory) {
