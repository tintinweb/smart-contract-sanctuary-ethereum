...
contract TestC is ERC721URIStorage, Ownable {
    ...
    uint public presaleTokenPrice = 0.1 ether;
    uint public whitelistTokenPrice = 0.1 ether;
    uint public publicTokenPrice = 0.1 ether;
    uint256 public tokenLimitCount = 300;
