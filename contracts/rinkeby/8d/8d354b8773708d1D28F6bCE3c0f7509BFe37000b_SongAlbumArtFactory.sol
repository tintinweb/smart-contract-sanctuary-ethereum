...
import "./SongAlbumArtTradable.sol";

contract SongAlbumArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new SongAlbumArtTradable contract
        ...
        returns (address)
    {
        ...
        SongAlbumArtTradable nft = new SongAlbumArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
...
/**
 * @title SongAlbumArtTradable
 * SongAlbumArtTradable - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract SongAlbumArtTradable is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
