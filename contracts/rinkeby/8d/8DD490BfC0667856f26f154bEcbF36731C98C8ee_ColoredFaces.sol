// SPDX-License-Identifier: MIT
    ...
    contract ColoredFaces is ERC721, Ownable, ERC721Enumerable {
      ...
      event FacesMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("ColoredFacesNew", "ENC") {}
      ...
      function mintFaces(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit FacesMinted(id, msg.sender);
          }
        }
      }
    
      function presaleFaces(uint256 numberOfTokens) external payable {
