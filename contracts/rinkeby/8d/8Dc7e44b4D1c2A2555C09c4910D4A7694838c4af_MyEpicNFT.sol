...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["The", "Heavy", "Wing", "Pull", "My", "Strings", "Black", "Summer", "Holliday", "In", "Cambodia", "Solace", "Of", "You", "Modern", "Love", "Temple", "Whole", "Lotta", "Rosie"];
  string[] secondWords = ["Starman", "Mexicola", "After", "Hours", "Think", "Again", "Get","Back","Ballad","Bilbo","Baggins","Charlie","Brown","Parents","Cancao","Pra","Voce","Viver","Mais","Mandalorian"];
  string[] thirdWords = ["Dreams", "Clair", "De", "Lune", "Money", "Uma", "Casa","Portuguesa","Symphony","Destruction","Adults","Are","Talking","Lives","Time","Is","On","Side","Spread","Wings"];
