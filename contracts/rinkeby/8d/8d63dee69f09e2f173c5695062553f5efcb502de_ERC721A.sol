...
contract SolKittie is ERC721A
{
    ...
    constructor(string memory defaultBaseURI) ERC721A("SolKittie", "SLKT", maxMintAmount) {
        owner = msg.sender;
        baseURI = defaultBaseURI;
        maxSupply = 3333;
        maxMintPerTransaction = 100;
        cost = 0.025 ether;
        podiumAwardsCount = 10;
    }
