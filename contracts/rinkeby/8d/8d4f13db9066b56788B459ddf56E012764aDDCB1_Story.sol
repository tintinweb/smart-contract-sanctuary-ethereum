...
contract Story is ERC721A, Ownable, ReentrancyGuard  {
  ...
  constructor() payable ERC721A('Story Block', 'STORY') {
    ...
    startingPrice = 333 ether / 1000000;
    discountRate = 11562500000;
  ...
  function multiMint( string memory _tokenText, uint _amount) public payable {
    uint256 newTokenId = totalSupply();
    for (uint i = newTokenId; i < (newTokenId + _amount); i++) {
      setStory(i, _tokenText, 0);
    }
