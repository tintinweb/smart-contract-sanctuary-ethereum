    ...
    ERC721CreatorExtension
{
    ...
    function setBaseTokenURI(string calldata uri) public adminRequired {
        IERC721CreatorCore(_creator).setBaseTokenURIExtension(uri);
    }
    function setTokenURIExtension(uint256 tokenId, string calldata uri)  public adminRequired {
