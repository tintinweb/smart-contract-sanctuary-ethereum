...
contract NFT is ERC721Enumerable, Ownable, Pausable {
    ...
    function whitelist(address _addresses) public onlyOwner {
        whitelistUsers[_addresses] = true;
    }
    ...
    function removeWhitelistedUsers(address _addresses) public onlyOwner {
        whitelistUsers[_addresses] = false;     
    }
