...
contract Messages is Ownable {
    ...
    // block number where each message is published
    uint256[] public messagesBlocks;
    ...
    function writeMessage(string calldata _message) public {
        ...
        // save the block in which the message was written
        messagesBlocks.push(block.number);
