...
contract NFTStackTest is ERC721Enumerable, Ownable {
  ...
  constructor(string memory baseURI) ERC721("NFTStackTest", "NFTST") {
    setBaseURI(baseURI);
  }
  ...
  function setIsSellOpenActive(bool _isSellOpen) external onlyAuthorized {
