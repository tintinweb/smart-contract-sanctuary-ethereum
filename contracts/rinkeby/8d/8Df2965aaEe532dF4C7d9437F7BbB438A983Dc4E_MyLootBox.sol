...
contract MyFactory is IFactory, Ownable, ReentrancyGuard {
  ...
  string constant internal baseMetadataURI = "https://cryptic-escarpment-21016.herokuapp.com/api/";
  ...
  function name() external view returns (string memory) {
    return "HYM Collectible Pre-Sale 20220528";
  }
...
contract MyCollectible is ERC1155Tradable {
  ...
  ERC1155Tradable(
    "HYMCollectible 20220528",
    "HYMCB",
    _proxyRegistryAddress
  ) public {
    _setBaseMetadataURI("https://cryptic-escarpment-21016.herokuapp.com/api/creature/");
  }
