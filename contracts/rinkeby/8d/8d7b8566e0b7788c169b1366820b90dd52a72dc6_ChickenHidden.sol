...
// File: contracts/ChickenHidden.sol
...
contract ChickenHidden is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ChickenHidden", "CHDN") {
    setHiddenMetadataUri("ipfs://QmfN37fwwi4tH8uP9qAC2YFfhSSQMGoRHP2xinAzctfKKV/hidden.json");
  }
