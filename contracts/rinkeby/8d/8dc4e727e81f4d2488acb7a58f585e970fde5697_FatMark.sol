...
contract FatMark is ERC721 {
    ...
    constructor() ERC721("Fat Cat Mark", "FCM") {
        admin = msg.sender;
    }

    

    string private allTokenURI = "https://gateway.pinata.cloud/ipfs/QmXDNfg6vbbrZC2rSUNLZms9e4JG3VvrEw13WDykEXzWFU";


    function mint() public payable virtual {
        require(msg.value == 80000000000000000 , "Need 0.08 ETH to mint Fat Mark.");
