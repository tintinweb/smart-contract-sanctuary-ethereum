...
// File wyvern/library/Ownable.sol
...
// File wyvern/registry/Proxy.sol
...
// File wyvern/registry/OwnedUpgradeabilityStorage.sol
...
// File wyvern/registry/OwnedUpgradeabilityProxy.sol
...
// File wyvern/registry/OwnableDelegateProxy.sol

pragma solidity ^0.4.26;

contract OwnableDelegateProxy is OwnedUpgradeabilityProxy {
    constructor(address owner, address initialImplementation, bytes calldatas) public {
...
// File wyvern/registry/ProxyRegistry.sol
...
// File wyvern/library/TokenTransferProxy.sol
...
// File wyvern/library/SafeMath.sol
...
// File wyvern/library/SaleKindInterface.sol
...
// File wyvern/library/TokenRecipient.sol
...
// File wyvern/registry/AuthenticatedProxy.sol
...
contract AuthenticatedProxy is TokenRecipient, OwnedUpgradeabilityStorage {
     ...
     */
    function proxy(address dest, HowToCall howToCall, bytes calldatas) public returns (bool result) {
        require(
     ...
     * @param calldatas Calldata to send
     */
    function proxyAssert(address dest, HowToCall howToCall, bytes calldatas) public {
        require(proxy(dest, howToCall, calldatas));
    }
}


// File wyvern/library/ArrayUtils.sol
...
// File wyvern/exchange/ExchangeCore.sol
...
contract ExchangeCore is ReentrancyGuarded, Ownable {
     ...
     */
    function staticCall(address target, bytes memory calldatas, bytes memory extradata) public view returns (bool result) {
    ...
    function hashOrder(Order memory order, uint256 nonce) internal pure returns (bytes32 hash)
    {
        ...
        index = ArrayUtils.unsafeWriteBytes32(index, keccak256(order.calldata2));
    ...
    returns (uint256)
    {
        ...
        if (sell.feeRecipient != address(0)) {
            ...
            // 卖家设置的对方承担的平台费用要小于等于买家设置的最大可承担的费用
            ...
            if (sell.feeMethod == FeeMethod.SplitFee) {
                ...
                if (sell.makerRelayerFee > 0) {
                    ...
                    if (sell.paymentToken == address(0)) {
                        ...
                        // 如果是代币先把卖价在上面全部转入卖家，然后这里再把平台费用从卖家扣除
                        transferTokens(
                            sell.paymentToken,
                            sell.maker,
                            sell.feeRecipient,
                ...
                // 如果支付方式不是 splitFee，用指定的代币支付RelayerFee
                /* Charge maker fee to seller. */
                // 卖家支付makerRelayerFee费用
                chargeProtocolFee(
                    sell.maker,
                    sell.feeRecipient,
    ...
    function atomicMatch(
        ...
        require(ArrayUtils.arrayEq(buy.calldata2, sell.calldata2));
        ...
        // 计算卖家买家的费用以及各种平台服务费，并执行费用transfer
        uint256 price = executeFundsTransfer(buy, sell);

        /* Execute specified call through proxy. */
        // nft转移
        require(proxy.proxy(sell.target, sell.howToCall, sell.calldata2));
        ...
        if (buy.staticTarget != address(0)) {
            require(
                staticCall(buy.staticTarget, sell.calldata2, buy.staticExtradata)
            );
        }

        /* Handle sell-side static call if specified. */
        if (sell.staticTarget != address(0)) {
            require(staticCall(sell.staticTarget, sell.calldata2, sell.staticExtradata));
        }
...
// File wyvern/exchange/Exchange.sol
...
// File wyvern/WyvernExchangeWithBulkCancellations.sol
