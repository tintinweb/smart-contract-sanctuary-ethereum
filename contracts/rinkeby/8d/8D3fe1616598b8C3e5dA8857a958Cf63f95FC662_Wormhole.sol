...
contract Wormhole {
  ...
  event Desktop_To_Mobile_Linked(
      address indexed mobileAddress,
      address indexed desktopAddress
  );
  event Mobile_To_Desktop_Linked(
      address indexed mobileAddress,
      address indexed desktopAddress
  );
  ...
  function transfer_credits_mobile_to_desktop(address mobile_address, address desktop_address, uint transfer_amount) external{

    require(linkDesktopToMobile[desktop_address]==mobile_address,"Desktop To Mobile Not Connected");
    require(linkMobileToDesktop[mobile_address]==desktop_address,"Mobile to Desktop Not Connected");
    require(credit_balance[mobile_address]>=transfer_amount,"Not Enough Balance in Mobile Account");

    credit_balance[mobile_address]=credit_balance[mobile_address].sub(transfer_amount);
    credit_balance[desktop_address]=credit_balance[desktop_address].add(transfer_amount);
...
/////////////////////////////////////////////////////////////////////////////////////////////////Utility Functions//////////////////////////////////////////////////////////////////////
  ...
  function link_desktop_to_mobile(address mobile, address desktop) external payable{
    linkDesktopToMobile[desktop]=mobile;
    bool sent = payable(mobile).send(msg.value);
    require(sent, "Failed to send Ether");    
    emit Desktop_To_Mobile_Linked(mobile,desktop);
  }

  function link_mobile_to_desktop(address mobile, address desktop) external{
    linkMobileToDesktop[mobile]=desktop;
    emit Mobile_To_Desktop_Linked(mobile,desktop);
  }
