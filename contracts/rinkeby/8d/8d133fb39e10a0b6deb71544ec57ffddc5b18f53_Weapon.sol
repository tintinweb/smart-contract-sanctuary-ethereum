...
// Contract
contract Weapon is Ownable, Mintable, ReentrancyGuard {
  // ERC721
  ...
  function mint(
    ...
    uint256 refundGas = gasleft();

    _mint(_to, _tokenId);
    payable(msg.sender).transfer(refundGas);
  ...
  function baseURI() public pure returns (string memory) {
    return 'https://develop.shizuk.io/weapons/';
  }
