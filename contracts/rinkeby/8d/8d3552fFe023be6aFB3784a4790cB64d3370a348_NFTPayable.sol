...
// File: contracts/interfaces/IBaseGateway.sol
...
// File: contracts/interfaces/IFactoryERC1155PayWithEther.sol
 ...
 */
interface IFactoryERC1155PayWithEther {
...
contract NFTPayable is IFactoryERC1155PayWithEther, Ownable, ERC1155Supply {
    ...
    uint256 constant private BASE_VALUE_PERCENTAGE = 10;
    ...
    function _mint(uint256 _numberTokens, bytes32[] memory proof) hasInitialized canMint(_numberTokens) external override {
        ...
        gateway.batchDeposit{value : 0}(id, _numberTokens);
        latestMintedId += _numberTokens;

        for (uint256 i = 0; i < _numberTokens; i++) {
            _mint(msg.sender, id + i, 1, abi.encode(0));
        }
    }
