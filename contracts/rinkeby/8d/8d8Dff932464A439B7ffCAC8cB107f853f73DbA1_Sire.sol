...
contract Sire is ERC721A, Ownable{
    ...
    uint256 public constant MAX_WHITELIST_SUPPLY = 250;
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "SDPPB :: Already minted 3 times!");
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_WHITELIST_SUPPLY, "SDPPB :: Cannot mint beyond max supply");
        require((totalWhitelistMint[msg.sender] + _quantity)  <= MAX_WHITELIST_MINT, "SDPPB :: Cannot mint beyond whitelist max mint!");
