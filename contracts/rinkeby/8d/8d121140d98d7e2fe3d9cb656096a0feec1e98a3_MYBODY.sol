...
// File: contracts/Demonsplayin.sol
...
contract MYBODY is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmTcr48HjNSo2uP3gFAsReMLCYSzHD4se68sxMZHA92sHu/";
    uint256 public constant MAX_MINT_PER_ADDR = 5;
    uint256 public constant MAX_FREE_MINT_PER_ADDR = 2;
    uint256 public PUBLIC_PRICE = 0.005 * 10**18;
    uint256 public constant MAX_SUPPLY = 3333;
    uint256 public constant FREE_MINT_SUPPLY = 1333;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("My Body", "YDOM") {
        baseURI = initBaseURI;
