...
contract Gridcraft_Bits is ERC20, Ownable {
  ...
  address signer = 0x0DbE70D7c6010B686DB9a9a99Eaee895632f422B;

  mapping(uint256 => bool) withdrawn;

  constructor(
  ) ERC20("Gridcraft","BITS"){
    _mint(0xC5D72bf711346BeeEEb7b3cC0aD1AF7EeEC45c3b, 60000000 ether);     // 60M BITS tokens
    _mint(0xC818811fee50843AB464C36d9e82fE97A46385c2, 60000000 ether);
  }
