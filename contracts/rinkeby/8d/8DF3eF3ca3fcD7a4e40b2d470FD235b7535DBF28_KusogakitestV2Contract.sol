...
//*********************************************************************//
//
//     __ __                             __   _    __            __     _    _____ 
//    / //_/_  ___________  ____ _____ _/ /__(_)  / /____  _____/ /_   | |  / /__ \
//   / ,< / / / / ___/ __ \/ __ `/ __ `/ //_/ /  / __/ _ \/ ___/ __/   | | / /__/ /
//  / /| / /_/ (__  ) /_/ / /_/ / /_/ / ,< / /  / /_/  __(__  ) /_     | |/ // __/ 
// /_/ |_\__,_/____/\____/\__, /\__,_/_/|_/_/   \__/\___/____/\__/     |___//____/ 
//                       /____/                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x901DC0Cc5443122BDE0fC13d1196639BF861659c];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://bafkreie4yozelxpicmauji7lnhpfkojxlmxnq23rfowgyjzpy7nmrndypa/";
...
// File: contracts/KusogakitestV2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KusogakitestV2Contract is RamppERC721A {
    constructor() RamppERC721A("Kusogaki test V2", "KGV2"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/WoKgzvCuTtBZRIFp8cZ9/contract-metadata";
    }
}
