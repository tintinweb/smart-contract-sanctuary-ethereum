...
contract TestContract is ERC721, ReentrancyGuard, VRFConsumerBase, Ownable {
    ...
    uint256 public constant TEAM_RESERVE = 3;
    ...
    function whitelistMint(uint256 amount_, Coupon memory coupon_)
        ...
        nonReentrant
    {
        require(amount_ + addressToMints[msg.sender]._numberOfMintsByAddress <= MAX_PER_MINT_WHITELIST, 'Exceeds number of presale mints allowed.');
