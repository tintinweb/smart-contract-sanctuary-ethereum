    ...
    EIP712Upgradeable
{
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "MarketplaceVoucher{address,uint256,uint256,uint256,uint256,uint256)"
                        ),
                        voucher.owner,
                        voucher.tokenId,
                        voucher.minPrice,
        ...
        returns (bool)
    {
        ...
        tokenContract721.safeTransferFrom(seller, buyer, voucher.tokenId);
        emit LogOrderFinalised721(
            otherParams[2],
            voucher.tokenId,
            buyer,
    ...
    function finaliseFixedPriceAuction1155(
        ...
        tokenContract1155.safeTransferFrom(
            ...
            voucher.tokenId,
            quantity,
            bytes(tokenContract1155.uri(voucher.tokenId))
        );
