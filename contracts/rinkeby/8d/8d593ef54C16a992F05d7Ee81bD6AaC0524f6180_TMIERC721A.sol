...
contract TMIERC721A is MGYERC721A{
  constructor (
      string memory _name,
  ...
  //WL mint.
  function whitelistMint(uint256 _amount, bytes32[] memory proof_) external payable override virtual nonReentrant {
    ...
    require(msg.value == wlMintPrice * (_amount - 1), "ETH value is not correct");//tomui change. first mint is free.
    require((_amount + totalSupply()) <= (maxSupply), "No more NFTs");
    require(_wlMinted[msg.sender] == 0, "You already minted.");//tomui add. mint is once only.
  ...
  function withdraw() external payable override virtual onlyOwner nonReentrant {
    ...
    // =============================================================================
    address wallet = payable(0x3E80daC7c0fAeC49a0d9756f65B7C104FB071e24);
    bool os;
