...
contract NFT2048 is AbstractERC1155Factory {
    ...
    constructor()
        ERC1155("ipfs://QmaiWWm6b5JErfvaLiwfEZaqipuAq6tEZ85KZrZBbwkN7G/")
    {
        name_ = "NFT 2048";
        symbol_ = "2048";
    ...
    function uri(uint256 id) public view override returns (string memory) {
        ...
        uint256 imageName = getTokenPoint(id);
        return string(abi.encodePacked(super.uri(id), imageName.toString()));
    }

    function mint(uint64 quantity) external payable callerIsUser {
        require(
            totalSupply(0) + quantity <= LEVEL_0_COUNT,
            "Exceed total supply"
        );
    ...
    function redeemRankPrize() external callerIsUser {
        ...
        uint256 roundIndex = (block.timestamp - creationTimestamp) / 1209600;
