...
contract LessGasNft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Less Gas NFT", "lsn") {
    setHiddenMetadataUri("ipfs://Qmb2kdngYuCW8GrLCoYg7WB5b4kg9BpRv2fYJPGnPopDL3/hidden.json");
  }
