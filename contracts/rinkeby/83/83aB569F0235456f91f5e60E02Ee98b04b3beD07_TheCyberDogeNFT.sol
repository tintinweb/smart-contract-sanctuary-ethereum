...
contract TheCyberDogeNFT is Ownable, ERC721Enumerable {
  ...
  function walletClaimable(address _address) public view returns (uint256) {
    require(_walletQuantity[_address] == 1, "no allocations left");
    return (_walletTokenId[_address]);
  }
  ...
  address private constant mainWallet =
    0xB2B3F4aB24239F1Fe0bDD97535e51a1B2a9e1a24;
