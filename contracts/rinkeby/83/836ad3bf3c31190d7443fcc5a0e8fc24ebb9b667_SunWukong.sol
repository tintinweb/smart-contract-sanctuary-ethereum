...
contract SunWukong is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmXdAySgzaLFgSU7uX6n8pyKZaHJMR7iXTEsUSDeB4112S";
    ...
    constructor(
    ) ERC721A("SunWukongSunWukong", "SunWukong", 100, maxSupply) {
    }
