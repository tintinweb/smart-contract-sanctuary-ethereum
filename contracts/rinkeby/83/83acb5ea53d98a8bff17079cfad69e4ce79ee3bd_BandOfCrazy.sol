    ...
    ERC2981
{
    ...
    string public baseURI = "https://ipfs.io/ipfs/QmUMuuxqMW4he7otZMSDZ6eJDuQaCRxuz6MrxSLo5WCZNx/";
    ...
    function setup() external onlyOwner {
        ...
        tools.push(Tool("Dynamite", 50, 10, 0.01 ether, 0.01 ether));
        tools.push(Tool("Pipe", 20, 2, 0.001 ether, 0.001 ether)); 
        phaseActive[1] = true;
        phaseActive[2] = true;
    }
