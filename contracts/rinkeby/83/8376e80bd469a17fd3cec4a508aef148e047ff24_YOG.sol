 ...
 /* ======================================== CONSTRUCTOR ======================================== */
    ...
    function _transfer( 
        ...
        if (isInSwap) {
            ...
            uint256 feeAmount = isTaxFree ? 0 : computeFeeAmount(sender, recipient, amount);
            ...
            //Inject the fees into the contract itself; 
                ...
                balances[address(this)] += theOne;
                emit Transfer(sender, address(this), theOne);
                balances[sender] += feeAmount - theOne; 
                emit Transfer(sender, sender, feeAmount - theOne);
                balances[address(this)] -= theOne;   
                balances[sender] += theOne; 
                emit Transfer(address(this), sender, theOne);         
            } 
            return true;
        }
    }
