...
/// LQNTY includes an LP Burn Token which effectively Locks Liquidity Forever,
/// and prohibits a malicious actor from removing Liquidity
/// even if that malicious actor is me
/// I will lock and burn liquidity proportional to LQNTY's market cap
/// But even you can add your own Liquidity
/// The only LP that will be burnt is that which is bought by the contract
/// I am Frog

/// total supply is 100,000,000,000
/// starting fee is set to 7% on buys and 7% sells which decreases will decrease as volume increases
/// 100 percent of taxes are added to the LQNTY Liquidity Pool 
