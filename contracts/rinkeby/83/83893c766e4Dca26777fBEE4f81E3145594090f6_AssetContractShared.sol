...
contract AssetContractShared is AssetContract, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        __AssetContract_init(_name, _symbol, _proxyRegistryAddress, _templateURI, _platformMintingfee, _royaltyFeeRecipient);
 ...
 */
contract AssetContract is ERC1155Tradable, ERC2981Upgradeable {
