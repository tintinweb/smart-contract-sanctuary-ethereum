...
contract MyEpicGame is ERC721 {
    ...
    constructor(
        ...
        console.log(
            "Done initializing Boss %s w/ Hp %s, imageURI %s",
            bigBoss.name,
            bigBoss.hp,
            bigBoss.imageURI
        );
    ...
    function attackBoss() public {
        ...
        console.log(
            "\nPlayer Name: %s, Hp: %s, AttackDamage: %s",
            player.name,
            player.hp,
            player.attackDamage
        );
        console.log(
            "Boss Name: %s, Hp: %s, AttackDamage: %s",
            bigBoss.name,
            bigBoss.hp,
        ...
        console.log("Player attacked boss: Boss HP: %s", bigBoss.hp);
