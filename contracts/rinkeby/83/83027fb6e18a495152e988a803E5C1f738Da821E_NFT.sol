...
contract NFT is ERC721, Ownable {
  ...
  constructor() ERC721("ta2nb", "TA2NB") {}

  function mintToken(string calldata name, string calldata description, string calldata source) external onlyOwner() {
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    bytes memory bytesImage = abi.encodePacked(
      '"image":"data:image/svg+xml;base64,', _source[tokenId], '"'
    );
