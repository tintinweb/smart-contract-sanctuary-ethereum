...
contract CryptoBonsai is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public founderLimit = 300;
    ...
    function addToFounderList(address[] calldata founder) onlyOwner external {
    ...
    function mint(address destination, uint256 amountOfTokens) private {
        ...
        if(founderMints) {
            ...
            require(_founderPurchases[msg.sender] + amountOfTokens <= founderLimit);
