...
contract ItemFactory is ERC1155SupplyCC, AccessControl {
    ...
    function setMilkContractAddress(address milkContractAddress) external {
        _milkContractAddress = milkContractAddress;
    }

    function claim(address claimer, uint256 entropy) external {

        require(block.timestamp - _lastUpdate[_msgSender()] > 60 * 60 * 24, "Can claim once per day");
        ...
        uint256 randRarity = _randomNum % _legendaryRoll;
        ...
        // handle MILK or ITEMS
            ...
            // MILK or ITEMS.
            rewardType = _randomNum % uint256(EType.BOX);
        ...
        _lastUpdate[_msgSender()] = block.timestamp;
    }
