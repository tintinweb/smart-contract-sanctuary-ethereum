...
contract JomoDao is ERC1155, Helper {

    string public name = "JomoDao";
    ...
    constructor() ERC1155("https://storageapi.fleek.co/e64b9171-c423-4d06-90fd-2384927f4ce6-bucket/jomodao/{id}.json"){
        batchMint(msg.sender,100);
    }
...
//    override
//    {
//        if (pause && from != address(0) || to != address(0)) { //To ensure that minting with not be affect
//
//        }
