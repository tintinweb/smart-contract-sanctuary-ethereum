...
contract Llamafrens is ERC721Enumerable, Ownable {
    ...
    uint256 public immutable MAX_SUPPLY_PLUS1 = 2001;
    uint256 public immutable MAX_PRESALE_PLUS1 = 1501;
    uint256 public immutable MAX_PER_TXN_PLUS1 = 4;
    ...
    string public unrevealedURI = "ipfs://<unrevealed>";
    bool public isRevealed;

    constructor() ERC721("Llamafren", "LF") {
        uint i = 0;
        for ( ; i < 26 ; ) {
