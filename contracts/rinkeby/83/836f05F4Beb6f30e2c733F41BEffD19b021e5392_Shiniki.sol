    ...
    ShinikiTransfer
{
    ...
    function initialize(
        ...
        __ERC721_init("Shiniki", "SHINIKI", collectionSize_, maxBatchSize_);
        __Ownable_init();
        __ShinikiTransfer_init();
    ...
    function preSaleMint(
        ...
        require(totalMint <= maxBatchSize, "Shiniki: quantity to mint is less than maxBatchSize");
     ...
     */
    function privateMint(address receiver, uint256 quantityType1, uint256 quantityType2)
        public
        override
        onlyOwner
        whenNotPaused
    ...
    function caculatorQuantity(
        ...
        for (uint8 i = 0; i < typeMints.length; i++) {
            ...
            if (typeMints[i] == TYPE_1) {
                ...
                require(
                    quantities[i] + totalSupply(typeMints[i]) <= collectionSize,
    ...
    function lock(uint256[] memory tokenIds) public override {
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(
                ...
                "Shiniki: transfer caller is not owner "
            );
...
interface IShiniki {
    ...
    function privateMint(address receiver, uint256 quantityType1, uint256 quantityType2) external;
    ...
    PausableUpgradeable
{
    ...
    function __ShinikiTransfer_init() internal onlyInitializing {
        __ShinikiTransfer_init_unchained();
    }

    function __ShinikiTransfer_init_unchained() internal onlyInitializing {}
    ...
    IERC721MetadataUpgradeable
{
    ...
    function __ERC721_init(
        ...
        __ERC721_init_unchained(name_, symbol_, collectionSize_, maxBatchSize_);
    }
