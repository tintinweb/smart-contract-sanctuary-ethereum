  ...
  /* ==================================================================================================== */
    ...
    */
    ...
    function transfer(address _to, uint256 _value) public override safe returns (bool success) {
      ...
      // REVIEW Ensure that it transfers a corresponding number of NFTs
...
contract FluidFactory {
    ...
    constructor(string memory name__, string memory ticker__, 
    ...
    function emit_a_different_token(string memory _name, string memory _ticker,  uint __max__) 
