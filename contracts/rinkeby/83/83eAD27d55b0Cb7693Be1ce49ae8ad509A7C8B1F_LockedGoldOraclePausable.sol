...
// Read from an external contract - Chainlink Proof Of Reserves and return the information to the CACHE Token Contract
// The read checks if the contract is not paused and that 
// the oracle value is always greater than the present circulation.
// The owner is a multisig deployed by CACHE
...
/***
 @dev Requires the Proof of Reserves amount emitted to be lower than token circulation amount emitted by CACHE Token Contract. 
      CACHE Token Contract Mint should be paused when this function fails that requirement.
 */
