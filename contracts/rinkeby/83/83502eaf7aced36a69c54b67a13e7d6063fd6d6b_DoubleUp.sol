...
contract DoubleUp is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public tierThreePrice = 0.02 ether;
  uint256 public tierFourPrice = 0.02 ether;
    ...
    payable
  {
    ...
    require(supply + _mintAmount <= 2, "The allocated free supply has been minted out. Please mint on a different tier function");
    ...
    payable
  {
    ...
    require(supply + _mintAmount <= maxSupply, "the supply has been minted out.");
    require(!paused, "Contract must be unpaused before minting");
    require(supply + _mintAmount <= 4, "No more in this tier");
    ...
    payable
  {
    ...
    require(supply + _mintAmount <= maxSupply, "the supply has been minted out.");
    require(!paused, "Contract must be unpaused before minting");
    require(supply + _mintAmount <= 6, "No more in this tier");
    ...
    payable
  {
    ...
    require(supply + _mintAmount <= maxSupply, "the supply has been minted out.");
    require(!paused, "Contract must be unpaused before minting");
    require(supply + _mintAmount <= 8, "No more in this tier");
