...
import "./lib/GranularRolesUpgradeable.sol";
import "./lib/Base64.sol";
import "./lib/Config.sol";

// ERC721Upgradeable,
contract ERC721UpgradeableCustom is
    ERC721URIStorageUpgradeable,
    GranularRolesUpgradeable
{
    ...
    // uint256 internal primaryRoyaltyBps;
    ...
    function initialize(
        ...
        __ERC721_init_unchained(deploymentConfig.name, deploymentConfig.symbol);
        ...
        // if (deploymentConfig.primaryRoyaltyEnabled) {
        //     isPrimaryRoyalty = deploymentConfig.primaryRoyaltyEnabled;
        //     primaryRoyaltyBps = deploymentConfig.primaryRoyaltyBps;
        // }
    ...
    // TODO: Update royalty addresses and shares
    ...
    function mintToCaller(address caller, string memory tokenURI)
        ...
        returns (uint256)
    {
        //TODO: Generate token Id from Counter contract
        ...
        // TODO: Event for mint should be created
        return tokenId;
    }
    ...
    function whitelistedMint(
        ...
        // TODO: msg.value and deduce this basis points
    ...
    // function calculatePercentage(uint256 value_) private returns (uint256) {
    //     return
    //         SafeMath.div(
    //             SafeMath.mul(SafeMath.div(value_, 1e3), primaryRoyaltyBps),
    //             10
    //         );
    // }
...
abstract contract GranularRolesUpgradeable is AccessControlUpgradeable {
    // using StringsUpgradeable for Strings;
