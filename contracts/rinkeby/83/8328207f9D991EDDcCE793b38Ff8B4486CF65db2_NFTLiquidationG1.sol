...
contract NFTLiquidationG1 is NFTLiquidationV1Storage, NFTLiquidationInterface {
     ...
     */
    function liquidateWithSingleRepayV2(address payable borrower, address cTokenCollateral, address cTokenRepay, uint256 repayAmount, uint256[] memory _seizeIndexes) external payable nonReentrant {
        require(borrower != address(0), "invalid borrower address");
    ...
    function liquidateWithSingleRepayFresh(address payable borrower, address cTokenCollateral, address cTokenRepay, uint256 repayAmount, uint256[] memory _seizeIndexes) internal {
