...
contract NFTAlvaro is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Alvxaro", "Xaro") {
    setHiddenMetadataUri("ipfs://QmWWdjML2F2eKKGMeiTmy5x6ZriJaTTEjVs5yDhVUndVaq/0.json");
  }
