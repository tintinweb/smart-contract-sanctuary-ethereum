...
contract Metakami is ERC721A, Ownable {
    ...
    /// @notice Allowlist mint for allowlisted addresseses when allowlist sale is active
    ...
    function mintReserve(uint256 nMints) external onlyOwner validTxn(nMints) {
        ...
        unchecked {
            for (uint256 i; i < nMints / MAX_BATCH_SIZE; ++i) {
    ...
    function withdrawAll() external onlyOwner {
        ...
        _withdraw(address(0x428Fb1351419871318B06fA64af241481D075a0E), (contractBalance * 15) / 100);
        _withdraw(address(0xFd14bec844f980dA98Aa24B10e2cb92902E0ec18), (contractBalance * 21) / 100);
        _withdraw(address(0xc03F22E569Bf637Bcd155D1DAF4463afD91240cc), address(this).balance);
    }
