...
contract GameItems is ERC1155, Ownable, RandomNumber {
    ...
    function mintPack() public {
        ...
        safeTransferFrom(address(this), msg.sender, randomVals[0], 1, "0x00");
        safeTransferFrom(address(this), msg.sender, randomVals[1], 1, "0x00");
        safeTransferFrom(address(this), msg.sender, randomVals[2], 1, "0x00");
    }
