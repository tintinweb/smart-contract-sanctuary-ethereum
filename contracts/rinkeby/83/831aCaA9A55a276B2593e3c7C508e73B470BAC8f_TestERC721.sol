...
contract TestERC721 is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("Test ERC721", "TERC") {
    setBaseURI("http://localhost:4000/api/test-erc721/token/");
