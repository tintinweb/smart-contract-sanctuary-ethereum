...
contract Creation is ERC1155, Pausable {
    using Counters for Counters.Counter;
    Counters.Counter private id;

    event Mint(address indexed _to, uint256 _id, uint256 _amount);
    event Burn(address indexed _from, uint256 _id, uint256 _amount);
