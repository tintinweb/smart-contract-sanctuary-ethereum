...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xCAC229768715a75E282550A4A08504b2434710E8];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmakMMH1be2LsJ2C3YqB72yZnbRV6T3DJ96vDkGUob6gZy/";
...
// File: contracts/CattestingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CattestingContract is RamppERC721A {
    constructor() RamppERC721A("Cat testing", "CAT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/iwI8FLGBk90t4h6j8dXq/contract-metadata";
    }
}
