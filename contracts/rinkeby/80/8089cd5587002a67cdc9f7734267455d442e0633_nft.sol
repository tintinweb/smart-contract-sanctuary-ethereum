...
contract nft is ERC721, Ownable {
    ...
    uint private _reservedMintsGiveaways = 0;
    
    //the maximum amount of reserved mints allowed for creator and giveaways
    uint private maxReservedMintsTeam = 250;
    uint private maxReservedMintsGiveaways = 115;
    
    //addresses of the different shareholders and owners
    address payable public shareholder1 = payable(0xee5deeb10535c0b417B66E6619b4F66dB521260C);
    address payable public shareholder2 = payable(0xee5deeb10535c0b417B66E6619b4F66dB521260C);
    address payable public shareholder3 = payable(0xee5deeb10535c0b417B66E6619b4F66dB521260C);
    address payable public shareholder4 = payable(0xee5deeb10535c0b417B66E6619b4F66dB521260C);
    address payable public shareholder5 = payable(0xee5deeb10535c0b417B66E6619b4F66dB521260C);
    ...
    constructor() ERC721('FlyBoy!', 'FB!') {
        numberOfTotalTokens = 0;
        maxTotalTokens = 1903;

        unrevealedURI = "ipfs://QmdQJpwZBYDUWCXSgJaWrGhzq5bMK4WMtMpdzXmEhgcFfJ/";
    }
    ...
    function openPublicSale() public onlyOwner {
        require(saleState() != State.PublicSale, 'Sale is already Open!');
    ...
    */
    ...
    //reserved NFTs for creator
    function reservedMintGiveaways(uint number, address recipient) public onlyOwner {
        require(_reservedMintsGiveaways < maxReservedMintsGiveaways, "Not enough Reserved NFTs left to mint..");

        for (uint i = 0; i < number; i++) {
            _safeMint(recipient, tokenId());
            mintsPerAddress[recipient] += 1;
            numberOfTotalTokens += 1;
            _reservedMintsGiveaways += 1;
        }   
    }
    ...
    //to see the total amount of reserved mints left 
    function reservedMintsLeftGiveaways() public onlyOwner view returns(uint) {
        return maxReservedMintsGiveaways - _reservedMintsGiveaways;
    }
