...
/**
 * @title CreathNFTTradable
 * CreathNFTTradable - ERC721 contract that whitelists an address, and has minting functionality.
 */
contract CreathNFTTradable is ERC721URIStorage, Ownable {
     ...
     */
    function mint(address  _to, string[] calldata _tokenUris) external{
        for (uint i = 0; i < _tokenUris.length; i = i + 1) {
            ...
            emit Minted(newTokenId, _to, _tokenUris[i], _msgSender());
        }
    }
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Creath marketplace contracts for easy trading.
