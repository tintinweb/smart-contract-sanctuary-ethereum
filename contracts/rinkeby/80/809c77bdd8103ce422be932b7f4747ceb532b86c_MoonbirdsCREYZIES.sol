...
// File: github/chiru-labs/ERC721A/contracts/MoonbirdsCreyzies.sol
...
contract MoonbirdsCREYZIES is ERC721A, Ownable {
    struct SendData {
        address receiver;
        uint256 amount;
    }
    ...
    constructor() ERC721A("Moonbirds CREYZIES", "MoonbirdsCREYZIES") {}
     ...
     * metadata URI
     */
    string private _baseURIExtended = "ipfs://abacde/";
