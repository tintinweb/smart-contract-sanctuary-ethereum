...
contract JaguarsPension is Ownable, Multicall
{
    ...
    uint256 public fusingCost    = 400 ether;
    uint256 public breedingCost  = 600 ether;
    uint256 public breedingDelay = 30 days;
    uint256 public viagraCost    = 600 ether;
    ...
    modifier onlyTokenOwner(uint256 tokenId) {
        require(jaguar.ownerOf(tokenId) == msg.sender, "caller must be owner");
        _;
    }
    ...
    constructor(IERC20Burnable _gang, Jaguars _jaguar)
    {
        gang   = _gang;
        jaguar = _jaguar;
    }
    ...
    {
        jaguar.burn(tokenId1);
        jaguar.burn(tokenId2);
        jaguar.mint(
            msg.sender,
