...
contract Humanians is ERC721AEnumerable, Payable {
    ...
    uint256 private constant PRESALE_CAP = 500;
    ...
    function mintPresale(uint256 quantity, bytes32[] calldata proof)
        ...
        withinMintLimit(quantity + PRESALE_CAP)
        correctValue(tokenPrice * quantity)
    {
    ...
    function setTxLimit(uint256 txLimit) external onlyOwner {
        ...
        require(txLimitPlusOne_ < txLimitPlusOne, "Humanians: Can only reduce supply");
...
contract Payable is Ownable, ERC2981 {
    constructor() {
        address communityAddr = 0x0000000000000000000000000000000000000001;
        // 6.5% royalties
        _setRoyalties(communityAddr, 650);
    }
