...
// File: contracts/ClassyDogs.sol


//created by ClassyDogs
...
contract ClassyDogs is ERC721A, Ownable {
    ...
    modifier MintCompliance(uint256 quantity) {
        ...
        require(totalSupply() + quantity <= CurrentMaxSupply, "total supply will exceed Max supply");
        _;
    }
    ...
    modifier WhiteListMintCompliance(uint256 quantity) {
        ...
        require(whiteListed[msg.sender] + quantity <= 10, "you have exceeded the number of tokens that can be minted by one user");
    ...
    function setmaxSupply(uint256 _updatedMaxSupply) external onlyOwner {
        require(_updatedMaxSupply > CurrentMaxSupply,"The new max Supply of tokens is less than the previous Max Supply");
        require(_updatedMaxSupply <= ExpectedAmountOfTokens,"The max Supply should be limited to 10000 for the ClassyDogs collection");
        CurrentMaxSupply = _updatedMaxSupply;
    }
