...
contract RavenTown is ERC721A, Ownable, ReentrancyGuard {

    using Strings for uint256;

    mapping(address => uint) public freeMint;
    string internal baseUri;
    uint256 public mintCost = 0.0031 ether;
    ...
    constructor() ERC721A("RavenTown", "RT") {}
    ...
    function mintFree(bytes32[] memory proof) external nonReentrant {
        ...
        require(freeMint[msg.sender] < 1, "You've already minted your Free RavenTown.");
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        require(msg.value >= mintCost * _amount, "One RavenTown costs 0.0031 Ether.");
