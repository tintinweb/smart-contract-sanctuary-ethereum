...
contract GoblinBob is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 public mintMany2Price = 0.01 ether;
  uint256 public mintMany2Qty = 4;
  uint256 public mintMany3Price = 0.02 ether;
  uint256 public mintMany3Qty = 10;


  uint256 public maxSupply = 8888;
  uint256 public maxFreeMint = 888;
  uint256 public freeMintPerWallet = 9;
  uint256 public oneFreeX = 0;

  string public baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmRW6527FD89rJBXPGVZMuT39TNgXZtG5YzXJBpDZk9Hkc/";
  ...
  constructor() ERC721A("GoblinBOB NFT Genesis", "goblinbobnft", 100) {  }
