...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRXoHWCJvL1aiwCvpqfuYx4d2cWon8F7sJahT5BUphJUX/";
...
// File: contracts/CoCoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoCoContract is RamppERC721A {
    constructor() RamppERC721A("CoCO", "COCO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/QmQR27WPIgm3LaEwRSbI/contract-metadata";
    }
}
