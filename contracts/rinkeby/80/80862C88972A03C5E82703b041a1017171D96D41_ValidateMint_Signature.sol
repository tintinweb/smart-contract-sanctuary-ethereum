...
contract ValidateMint_Signature is IValidateMint_Signature_Functions, Ownable, ReentrancyGuard {
    ...
    function validate(
        ...
        uint256 tokenId,
        bytes memory auth
    ) external virtual override nonReentrant returns (bool passed) {
...
interface IValidateMint_Signature_Functions is IValidateMint {
...
interface IValidateMint_Signature is IValidateMint_Signature_Functions, IValidateMint_Signature_Variables, IOwnable {
