...
contract NFTRingSpace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NFThing Ring", "NFTHR") {
    setHiddenMetadataUri("ipfs://QmcPrruntwv9LXuoPadmhgVCkfwqPdLLMZLwCEMvQQGvQ8/Ring.json");
  }
