...
contract Contract is ERC721Enumerable, Ownable {
  ...
  uint256 public Price = 0.0006 ether;
  uint256 public PricePS = 0.0005 ether;
  uint256 public MaxToken = 1000;

  constructor(string memory name, string memory symbol, string memory _initBaseURI,string memory _initnotRevealURI)
    ERC721(name, symbol) { setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI); }
