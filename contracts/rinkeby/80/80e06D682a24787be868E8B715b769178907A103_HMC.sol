...
contract HMC is ERC721Enumerable, Ownable {
    ...
    address public constant creator1Address = 0x6a0F6b1269660C991B11356E3907e16E526632ad;
    ...
    function mint(uint256 _tokenAmount) public payable saleIsOpen {
        ...
        require(_tokenAmount <= 3, "User cannot mint more than 3 NFT");
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(founder, balance.mul(percent).div(100));
