...
contract Test is Ownable, ERC721 {
    ...
    mapping(address => bool) public hasMintedPresale;
    ...
    constructor() ERC721("Test", "test") {
        ...
        dutchAuctionConfig = DutchAuctionConfig({
            txLimit: 10,
            startTime: 1644363519, // Thu Jan 20 2022 23:30:00 GMT+0000
            bottomTime: 1644364119, // Fri Jan 21 2022 03:30:00 GMT+0000
        ...
        payable
    {
        ...
        require(!hasMintedPresale[msg.sender], "User has already minted");
        require(msg.value == presalePrice * amount, "Insufficient payment");
        require(totalSupply + amount <= 440, "Max limit exceeded");
        require(amount < 6, "Transaction limit exceeded");
        require(_verify(proof, whitelistMerkleRoot), "Invalid proof");

        hasMintedPresale[msg.sender] = true;
    ...
    function mintPublicSale(uint256 amount)
        ...
        payable
    {
        require(totalSupply + amount <= 10000, "Max limit exceeded");
