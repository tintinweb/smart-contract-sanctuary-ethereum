...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Cardene", "Sun", "Mercury", "Venus", "Earth", "Mars"];
  string[] secondWords = ["Jupiter", "Saturn", "Uranus", "Neptune", "Eris", "Haumea"];
  string[] thirdWords = ["Makemake", "Ceres", "Pluto", "Aries", "Taurus", "Gemini"];
