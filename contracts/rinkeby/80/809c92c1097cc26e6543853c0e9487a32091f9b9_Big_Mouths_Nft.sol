...
contract Big_Mouths_Nft is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public constant MAX_MINT_PER_ADDR = 35;
    ...
    constructor(string memory _revealed) ERC721A("Big Mouths Nft", "BGMTH") {}
