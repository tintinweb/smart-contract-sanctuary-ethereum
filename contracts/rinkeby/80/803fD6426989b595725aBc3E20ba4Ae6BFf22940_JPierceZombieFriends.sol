...
contract JPierceZombieFriends is IERC721A, Ownable {
    ...
    bool public gated = false;
    uint16 public constant maxZombies = 10000;

    uint16 public accountMax = 10;
    ...
    mapping (address => uint8) public totalPerAccount;
    ...
    constructor() {
     ...
     function mint(uint8 _count, address _to, uint256 code) public payable {
        ...
        if(gated) {
          ...
          // this is wear code verification goe
    ...
    */
    function getMessageHash(
        ...
        return keccak256(abi.encodePacked(_amount, _nonce, _to));
    }
