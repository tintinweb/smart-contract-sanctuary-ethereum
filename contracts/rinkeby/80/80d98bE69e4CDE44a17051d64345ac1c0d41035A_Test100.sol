...
contract Test100 is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Test 100", "Test") {
  ...
  function mint() public payable nonReentrant onlyOwner {
