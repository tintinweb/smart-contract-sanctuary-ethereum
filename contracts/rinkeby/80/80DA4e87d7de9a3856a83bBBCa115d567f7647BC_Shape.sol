...
// Contract 0x80DA4e87d7de9a3856a83bBBCa115d567f7647BC
contract Shape is ERC721, ERC721URIStorage, Ownable {
    ...
    function mint(address to, string memory _shape, string memory _color, string memory _size ) public  {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _attributes[tokenId] = Attributes(_shape, _color, _size);
        emit MintData(tokenId, block.timestamp);
    }
