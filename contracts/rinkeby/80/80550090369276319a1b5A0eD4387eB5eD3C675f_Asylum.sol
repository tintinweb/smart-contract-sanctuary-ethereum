...
contract Asylum is ERC721A, Ownable, ReentrancyGuard {
    ...
    bool public murderWindow = false;
        ...
        mintCompliance(_mintAmount)
    {
        ...
        require(minted <= 0, "you already minted, 1 per crazy");

        _safeMint(_msgSender(), _mintAmount);
    }

    function redrum(uint256 tokenId) public {
        require(!murderWindow, "Murder window isn't open redrum!");
        murderCount++;
        _burn(tokenId);
    }
