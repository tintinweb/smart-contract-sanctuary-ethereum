  ...
  function _beforeTokenTransfer(
        ...
        Ownable
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x75577668800af85A99ad2A92f851C76ebdf67E27);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 5000");
      ...
      require(mintingOpen == true, "Minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 5000");
    ...
    contract MyNftRamppProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My NFT Rampp Project", "RAMPP", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/ushTJiyVhmrifjTi9iJt/contract-metadata";
        }
    }