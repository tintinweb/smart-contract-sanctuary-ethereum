...
// THIS CONTRACT HOLDS DATA FOR HUNDREDELEVEN METADATA. OWNERS OF HUNDREDELEVEN NFTS CAN CHANGE THEIR ACTIVE METADATA ANY TIME THEY WANT
...
contract MetaCollection is Ownable {
    ...
    function getMetadataForCollection(uint256 tokenId, uint256 collection)
        external
        view
        returns (string memory)
    {
    ...
    constructor(address _MetaChess) {
        addCollection("NUMZ",false,address(0),"https://berk.mypinata.cloud/ipfs/QmRxgzGAKD2Uyt69nLQLMxd4WS4iXWVW2b1641G6EfKJCa/");
        addCollection("FreqBae",false,address(0),"https://berk.mypinata.cloud/ipfs/QmSUAi1rPKmpB1vmJXaS3jWLeLpiXecitXFARkQg8LwsY8/");
        addCollection("ri-se[t]",false,address(0),"https://berk.mypinata.cloud/ipfs/QmXixySr7dR2acqcfYxQvTwFheFPo29zYhQevvMEjyfq3k/");
        addCollection("ATAKOI",false,address(0),"https://berk.mypinata.cloud/ipfs/QmYyg7pVrxYev76NqgnMsGKJ4dAwENcEcsFeMPYqBn7cMw/");
        addCollection("MELLOLOVE",false,address(0),"https://berk.mypinata.cloud/ipfs/Qma11q5BBiEcPAcrvbL5QHWrjJYwxEfyYLYy4bmAAkMbhD/");
