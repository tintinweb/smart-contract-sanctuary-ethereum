...
/**
 * @title Kapital DAO KAP Staking Pool
 * @author Playground Labs
 * @custom:security-contact [email protected]
 * @notice Staking pool for Kapital DAO members to stake KAP tokens
 */
contract KapStaking is Staking, IKAPSource {
    constructor(
        uint256 rewardsStart,
        address asset, // KAP token address
         ...
         * In the 1st 52 weeks, 1% of total supply(10,000,000) will be distributed as base rewards.
         * And up to 1% of total supply will be distributed as boost rewards(boost factor is 1).
         * Actual boost rewards amount will depend on the users' activity of restaking and claiming rewards.
         */
        _addRewardsRule(1e7 ether / uint256(52 weeks), 52 weeks);
    }

    /**
     * @notice Used to determine voting weight
     * @param voter The address voting on the governance proposal
     * @return KAP weight of `voter`
     */
