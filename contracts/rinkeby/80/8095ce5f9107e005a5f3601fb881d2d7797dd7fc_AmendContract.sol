...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVMWZCpcPkiBhPxuoybU6K3YdwrBjjCZ2sXfWThewFW5f/";
...
// File: contracts/AmendContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AmendContract is RamppERC721A {
    constructor() RamppERC721A("Amend", "AMD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/0EV0CoRoJd5QCkifQINo/contract-metadata";
    }
}
