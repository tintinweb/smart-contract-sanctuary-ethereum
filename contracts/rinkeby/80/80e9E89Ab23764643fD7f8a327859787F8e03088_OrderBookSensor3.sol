    ...
    ERC1820Implementer
{
    ...
    uint256 public streamingDuration = 180; //here the streaming duration can be defined in seconds 1800
    uint256 public streamingInterval = 60; //here the streaming payout Intervall can be defined in seconds 180
