...
contract JONXSWORLDMEMBERCLUB is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("JONXSWORLD MEMBERCLUB", "JXMT")
  {
  ...
  function withdraw() public nonReentrant {
    ...
    Address.sendValue(payable(payoutAddress1), balance * 30 / 100);
  }
