...
contract EFDONAUY is Ownable, ERC721A {
    ...
    string public baseUri = "https://gateway.pinata.cloud/ipfs/EFDONAUY/"; // REPLACE !!!
    uint96 private royaltyBasisPoints = 750; // REPLACE !!!
    ...
    constructor() ERC721A("EFDONAUY", "EFDONAUY") {}
    ...
    function freeMint(uint _quantity) external {
        ...
        require(_quantity + amountNFTsperWalletFreeMint[msg.sender] <= maxFreeNFTPerWallet, "You can only get 1 NFT on the Whitelist Sale");
    ...
    function mint(uint _quantity) external payable {
        ...
        require(_quantity + amountNFTsperWallet[msg.sender] <= maxNFTPerWallet, "You cannot have more NFT for this transaction");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory filename = revealed ? Strings.toString(tokenId) : "hidden-cozy";
