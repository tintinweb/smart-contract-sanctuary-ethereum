...
contract Astronauts is ERC721A, Ownable {

    string public baseURI = "ipfs://QmRzctucz73cgasoyGKY1QHr7XKU6fDAUPKx3dZiZTRCJD/";
    ...
    uint256 public constant FREE_AMOUNT = 5;

    constructor() ERC721A("Astronauts", "Astronauts") {
    }
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    function publicMint(uint256 count) external payable {
        ...
        require(totalSupply() + count > 100 ? count <= MAX_PER_TX_PAID : count <= MAX_PER_TX_FREE, "Exceeds max per transaction.");
