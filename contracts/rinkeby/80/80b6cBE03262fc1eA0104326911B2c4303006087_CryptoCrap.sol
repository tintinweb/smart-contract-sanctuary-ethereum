...
// File contracts/CryptoCrapDNA.sol

pragma solidity ^0.8.0;

contract CryptoCrapDNA {
...
// File contracts/CryptoCrap.sol

pragma solidity ^0.8.0;

contract CryptoCrap is ERC721, ERC721Enumerable, CryptoCrapDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("CryptoCrap", "CRPTCRP") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "There is no more crap :)");
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                ...
                tokenId.toString(),
                '",',
                '"description": "Crap stored in Ethereum Blockchain",',
                '"image": "',
                image,
                '"',
                "}"
