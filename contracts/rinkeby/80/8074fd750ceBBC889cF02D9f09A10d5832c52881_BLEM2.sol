...
contract BLEM2 is ERC721, RrpRequesterV0, Ownable {
    ...
    function getRandoms(uint256 size) external {
	...
	for (uint i = 0; i<qrngUint256Array.length; i++) {
        ...
        uint256 strength = (qrngUint256Array[i] % 100000000);
        uint256 intelligence = ((qrngUint256Array[i] % 100000000) / 10000000);
        uint256 mana = ((qrngUint256Array[i] % 100000000) / 1000000);
