...
contract HootyOwlsTreehouseNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintQuantity) public payable mintPaused mintQuantityCheck(_mintQuantity) nonReentrant {
  ...
  function promoMint(uint256 _mintQuantity) public payable mintQuantityCheck(_mintQuantity) nonReentrant {
    ...
    require(freeMintQuantity <= maxFreeMintQuantityPerTx, 'Sender trying to avail too many free mints in transaction!');
