...
contract Dailypsychos is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    string public baseTokenURI;
     ...
     constructor() ERC721A("Daily Psychos", "DP",10,10000) {
         baseTokenURI = "ipfs://Qmc78aUM6L4YW2j3peH59cuvSat9WanQnTxZ4W3WPdShuY/";
     }
    ...
    function setPrice(uint256 price_) external onlyOwner {
      ...
      function getCurrent() public onlyOwner view returns (uint){
