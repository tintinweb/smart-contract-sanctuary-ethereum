...
contract Wsb is ERC721A, Ownable, ReentrancyGuard {
    ...
    function publicMint(uint256 numberOfTokens, address _owner) external isSecured(2) payable {
        ...
        _safeMint(_owner, numberOfTokens);
    }
