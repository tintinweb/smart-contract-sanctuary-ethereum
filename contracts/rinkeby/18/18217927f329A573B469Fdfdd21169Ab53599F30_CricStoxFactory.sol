...
contract CricStoxFactory is Ownable {
    ...
    function createPlayerStox(string memory name_, string memory symbol_, uint8 decimals_, address cricStoxDividendsAddress, uint256 dividendsPool) external onlyOwner {
        PlayerStoxToken playerStox = new PlayerStoxToken(name_, symbol_, decimals_, cricStoxMasterAddress, cricStoxDividendsAddress, dividendsPool);
