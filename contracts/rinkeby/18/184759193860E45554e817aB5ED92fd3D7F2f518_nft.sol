...
contract nft is ERC721Enumerable, Ownable {
    ...
    uint private _mintCost = 0.00000777 ether;
    ...
    address public shareholder1 = 0x318cBF186eB13C74533943b054959867eE44eFFE; //André
    address public shareholder2 = 0xAC5bECB84A3F732150D2333992339dd0E45F48cE; //Gnosis Safe
    address public marketingWallet = 0xB0620844045a1C3c74817372B3eB60d84C83C61e;
    ...
    */
    ...
    function presaleMint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) external payable {
        ...
        require(mintsPerAddress[msg.sender] + number <= maxMints, "Only 3 Mints are allowed per Address");
    ...
    function withdrawAll() public onlyOwner {
        ...
        withdraw(payable(shareholder1), ((balance * 4) / 100));
        withdraw(payable(shareholder2), ((balance * 86) / 100));
        withdraw(payable(marketingWallet), ((balance * 10) / 100));
    }
    ...
    // see the maimum number of mints allowed
    function maxMintsPerAddress() public view returns(uint) {
        return maxMints;
    }
