...
contract UTWEAPONFACTORYTEST is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 1000;
    uint256 public MAX_MINTS = 100;
    string public baseURI = "https://unknown-tournament.ru/json/testnft/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("UTWEAPONFACTORYTEST", "UTWFT", MAX_MINTS, MAX_SUPPLY) {  
    }
