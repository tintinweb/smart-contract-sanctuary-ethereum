...
contract BeersNFT is ERC721A, Ownable 
{
    ...
    address payable private devgirl = payable(0x7570E128e00229dE6a3BFC242C95e9bA9829c0C7); 
    address payable private wallet1 = payable(0x1605FEe885eEcEdfDa497BA2B2f88126b2b6A894); 
    address payable private wallet2 = payable(0x1605FEe885eEcEdfDa497BA2B2f88126b2b6A894); 

    constructor() ERC721A("BeersNFT", "BEERSNFT") {}
    ...
    function withdraw() external 
    {
        ...
        uint part2 = address(this).balance / 10000 * 3133;
        uint part3 = address(this).balance / 10000 * 3133;
        devgirl.transfer(part1);
        wallet1.transfer(part2);
        wallet2.transfer(part3);
