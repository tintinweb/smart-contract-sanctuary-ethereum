...
// File: contracts/RobotPunksNFT.sol
...
contract RobotPunksNFT is ERC721, Ownable{
    ...
    constructor() payable ERC721("RobotPunks", 'RP'){
        ...
        maxSupply = 1000;
        maxPerWallet = 3;
        withdraWallet = payable(0x2c6Fb2aa935b4aFeA5860D64f43Fdd698c04480E);
    }
    ...
    function tokenURI(uint tokenId_) public view override returns (string memory){
       //we are overriding it so that nft markets can point to the right token uri
        require(_exists(tokenId_), "Token does not exist");
        //placing id behind the base token uri and attaching json
    ...
    function mint(uint quantity_) public payable{
        require(isPublicMintEnabled, "Minting isn't enabled");
