 ...
 * */
 ...
 contract Kibashitama is Context, IERC20, Ownable {
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xa7841B88e26473A52F5847426aaeeD1A2184D7bd);
         _feeAddrWallet2 = payable(0xa7841B88e26473A52F5847426aaeeD1A2184D7bd);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xa7841B88e26473A52F5847426aaeeD1A2184D7bd), _msgSender(), _tTotal);
     }
