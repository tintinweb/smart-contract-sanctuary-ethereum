...
contract Equator is ERC721, Ownable, ERC721Enumerable, ERC2981PerTokenRoyalties {
    ...
    // team address
    address private teamAddr = 0xcBa05CC80b537abB5535d5a8DBa3c3AC514C464e;


    constructor(string memory __baseURI, address payable _receiver, address payable _devAddr) ERC721("EquatorNFT","ENFT"){
    ...
    function _mintSingleNFT() private{
        ...
        _setTokenRoyalty(_tokenIds.current(), teamAddr, 100);
    ...
    function flipSaleActive() public onlyOwner {
     ...
     //only operator can set sale price
