...
contract FullDigiHLA is Ownable, ERC721A, MerkleWhitelist {
    ...
    //   uint256 public DA_STARTING_PRICE = 5 ether;

    // //Ending at 0.1 ether
    // uint256 public DA_ENDING_PRICE = 1 ether;

    // //Decrease by 0.05 every frequency.
    // uint256 public DA_DECREMENT = 1 ether;

    //decrement price every 180 seconds (3 minutes).
    uint256 public DA_DECREMENT_FREQUENCY = 180;

    //Starting DA time (seconds).
    uint256 public DA_STARTING_TIMESTAMP = 1648882800;
    ...
    uint256 public publicWLStartTime = 1649149200;
    uint256 public miceWLStartTime = 1649149200;
    ...
    function mintDutchAuction(uint8 quantity,bytes32[] memory proof) public payable onlyPublicWhitelist(proof){
        //Require DA started
        require(
            block.timestamp >= DA_STARTING_TIMESTAMP,
            "DA has not started!"
