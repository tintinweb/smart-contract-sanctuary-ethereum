...
// File: contracts/PhotoPresetsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract PhotoPresetsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Photo Presets";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/rZC2eSsspNLjN3YJ8MG2/contract-metadata";
    }
