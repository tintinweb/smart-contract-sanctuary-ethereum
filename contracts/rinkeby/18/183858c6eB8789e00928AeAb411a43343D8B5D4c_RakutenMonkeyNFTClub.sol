...
contract RakutenMonkeyNFTClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public secondWhiteListSaleEndTime = 1648699200; // 3/31 12pm
    uint256 public secondWhiteListSaleRemainingCount = 40;

    uint256 public publicSaleStartTime = 1648785600; // 4/1 12pm
    uint256 public publicSaleEndTime = 1649304000; // 4/7 12pm
    ...
    constructor()
        ERC721A("Rakuten Monkey NFT Club", "RMNC")
    {
    ...
    function mint(bytes32[] calldata proof, uint256 numberOfTokens)
        ...
        nonReentrant
    {
        require(totalSupply() + numberOfTokens <= maxTotalSupply, "exceeds max total supply");
