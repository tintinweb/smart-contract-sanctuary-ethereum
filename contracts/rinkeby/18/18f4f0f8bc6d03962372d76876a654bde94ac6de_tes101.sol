...
contract tes101 is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
modifier whenNotPaused() {
    ...
    modifier whenPaused() {
        require(transferpaused, "Wait tranfer is available ");
           _;    
    }
  ...
  function _transfer(address from, address to, uint256 tokenId) internal whenNotPaused override {
