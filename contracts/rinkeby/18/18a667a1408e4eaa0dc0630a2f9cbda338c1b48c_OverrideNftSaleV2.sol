...
contract OverrideNftSaleV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address _nftContract, 
        ...
        // NOTE: Transfer to owner of NFT instead of deployer (multisig gnosis safe)
        // NOTE: we don't do this for the NFT initially due to OpenSea management requirements
    ...
    function withdrawETH() external onlyOwner {
        //TODO:compbow ask Kiwi if we need the KGF version? is it just extra error handling?
