...
contract SmokersLastDayOnEarth is ERC721A, Ownable {
    ...
    string public baseURI =
        "ipfs://QmeSGCunPDn2JeD22YQL4BH9TEo61zesJZa1YEoRrZ5ePw/";

    constructor() ERC721A("SmokersLastDayOnEarth", "SLDOE") {}
    ...
    function mint(uint256 amount) external payable {
        require(totalSupply() + amount <= maxSupply, "sale is over");
