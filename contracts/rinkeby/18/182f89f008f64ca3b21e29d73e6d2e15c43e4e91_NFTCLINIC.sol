...
contract NFTCLINIC is ERC721A, ReentrancyGuard, Ownable {
  ...
  uint256 public Bronze_price =    0.09 ether; // 0.09 Ether
  uint256 public Bronzewl_price = 0.08 ether; // 0.08 Ether
  uint256 public Silver_price =    0.18 ether; // 0.18 Ether
  uint256 public Gold_price =     0.46 ether; // 0.46 Ether
  uint256 public Platinum_price = 0.92 ether; // 0.92 Ether
