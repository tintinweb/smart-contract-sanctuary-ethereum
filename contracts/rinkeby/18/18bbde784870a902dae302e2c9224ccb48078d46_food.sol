...
contract food{
    ...
    function PizzaLoverF() public returns(uint){
        ++pizzaLovers;
    }
    function PizzaHaterF() public returns(uint){
        ++pizzaHaters;
    }
    function HambugerLoverF() public returns(uint){
        ++hambugLovers;
    }
    function HambugerHaterF() public returns(uint){
        ++hambugHaters;
    }
