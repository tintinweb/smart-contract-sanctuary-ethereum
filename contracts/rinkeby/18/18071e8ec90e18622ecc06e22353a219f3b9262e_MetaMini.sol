...
contract MetaMini is ERC721A, Ownable {
  ...
  constructor() ERC721A("MetaMini", "MMC") {
  ...
  //2 Additional Free Mints

   function freeMint() public {
    // require(!paused, "Contract paused"); //Not Paused
    ...
    //     emit mint(_msgSender(), saleDetails.totalMinted+1, 1);
