...
contract KostbarFinalV1 is ERC721A, Ownable {
    uint256 public presaleStart = 1658824500;
    uint256 public presaleEnd = 1658824800;

    uint256 public maxSupply = 6100;
    uint256 public maxPerTx = 10;
    uint256 public presalePrice = 0.0005 ether;
    uint256 public publicPrice = 0.0008 ether;
    ...
    constructor(string memory _baseTokenURI, bytes32 _root)
        ERC721A("KostbarFinalV1", "KTFV1")
    {
