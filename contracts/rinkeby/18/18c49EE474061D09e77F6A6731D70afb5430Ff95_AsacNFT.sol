...
/**
    TODO:
        - Test new feature where devMint will increase maxAvailableSupply
        - Test new OGLISt
        - Test functions to add and remove from OGList
        - Test Mint with OGList Wallet on merkle presale and regular mint function
        - Test new way to start/stop reveal
        - Test claim function
        - Update NFT name in constructor
*/
...
contract AsacNFT is ERC721A, Ownable, ReentrancyGuard { 
    ...
    ) ERC721A("Test", "TESTA") { // "Anti Social Anime Club", "ASAC"
    ...
    */
    ...
    function withdrawl() external onlyOwner {
        ...
        payable(devWallet).transfer(totalBalance * 50 / 1000);
        payable(msg.sender).transfer(totalBalance * 950 / 1000);
    }
}
