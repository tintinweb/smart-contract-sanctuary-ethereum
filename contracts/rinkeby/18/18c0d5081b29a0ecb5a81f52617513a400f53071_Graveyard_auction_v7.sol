...
contract Graveyard_auction_v7 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable { /* Contract inherits from ERC1155 spec */
    ...
    function getBid(uint256 auction_id, uint256 bid_id) public view returns(
        ...
        BidLink memory bidLink = auction.bids[bid_id];
