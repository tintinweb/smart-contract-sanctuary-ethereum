...
contract BurnToken is ERC20Burnable, Ownable {
    uint256 constant INITIAL_SUPPLY = 1 * (10**12) * (10**18); // 1 trillion tokens, 18 decimals
    ...
    uint256 maxWalletSize = (INITIAL_SUPPLY * 15) / 10000; // .15% of totalsupply
    uint256 maxTransactionSize = (INITIAL_SUPPLY * 15) / 100000; // .015% of totalsupply
    uint256 swapThreshold = (INITIAL_SUPPLY * 30) / 10000; // .3% of totalsupply
    ...
    constructor(
        ...
        _mint(msg.sender, (INITIAL_SUPPLY * 14) / 100); // 14% for deployer
        _mint(msg.sender, (INITIAL_SUPPLY * 5) / 100); // for liquidity pool

        _mint(teamWallets[0], (INITIAL_SUPPLY * 15) / 10000); // .15% for team 1
        _mint(teamWallets[1], (INITIAL_SUPPLY * 15) / 10000); // .15% for team 2
        _mint(teamWallets[2], (INITIAL_SUPPLY * 15) / 10000); // .15% for team 3
        _mint(teamWallets[3], (INITIAL_SUPPLY * 15) / 10000); // .15% for team 4
        _mint(teamWallets[4], (INITIAL_SUPPLY * 10) / 10000); // .1% for team 5
        _mint(teamWallets[5], (INITIAL_SUPPLY * 10) / 10000); // .1% for team 6
        _mint(teamWallets[6], (INITIAL_SUPPLY * 10) / 10000); // .1% for team 7
        _mint(teamWallets[7], (INITIAL_SUPPLY * 10) / 10000); // .1% for team 8
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        (sent, data) = _treasuryWallet.call{value: treasuryEth}("");
