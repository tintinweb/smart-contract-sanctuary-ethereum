...
contract Elmunstro is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw(uint256 _giftPercent) public onlyOwner nonReentrant {
        require(totalSupply() >= maxSupply);
        (bool giftOs, ) = payable(ultimateGiftAddress).call{
            value: (address(this).balance * _giftPercent) / 100
        }("");
        require(giftOs);
