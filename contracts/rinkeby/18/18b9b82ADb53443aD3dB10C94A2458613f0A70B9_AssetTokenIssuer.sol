...
contract AssetTokenIssuer is AccessControlUpgradeable {
    ...
    function setName(string memory _name) external requireAdmin {
        name = _name;
    }
    ...
    function freezeContract() external requireAdmin {
        _getAssetTokenData().freezeContract(assetTokenAddress);
    }

    function unfreezeContract() external requireAdmin {
        _getAssetTokenData().unfreezeContract(assetTokenAddress);
    }
