...
contract CoolFrens is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    ...
    */
    ...
    modifier onlyValidAccess(uint8 _v, bytes32 _r, bytes32 _s) {
        require( isValidAccessMessage(_v,_r,_s) );
        _;
    }
  ...
  function mintWL(uint256 quantity, uint8 _v, bytes32 _r, bytes32 _s) external payable onlyValidAccess(_v, _r, _s){
