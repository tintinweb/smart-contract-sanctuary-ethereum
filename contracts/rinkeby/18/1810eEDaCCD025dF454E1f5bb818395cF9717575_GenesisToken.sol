...
/**
Learn more about our project on bowline.app
**/
 ...
 *
 * GenesisToken is a ERC721 Contract that supports Burnable.
 * The minting process is processed in a public and a whitelist
 * sale.
 */
contract GenesisToken is MintpassValidator, ERC721Burnable, ERC2981, Ownable {
    ...
    // _baseTokenURI serving nft metadata per token
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        SIGNER_WALLET = 0xC97E12D5D123626931460f499A80a1938376BF9E;
        setBaseURI(string(abi.encodePacked("https://meta.bowline.app/", address(this), "/")));
    }
     ...
     * @param mintpassSignature issued by thewhitelist.io and signed by SIGNER_WALLET
     *
     * Requirements:
    ...
    function freeMint(
        ...
        require(
            ...
            "GenesisToken: Minting is not Enabled"
        );
        require(
            mintpass.minterAddress == msg.sender,
            "GenesisToken: Mintpass Address and Sender do not match"
        );
        require(
            mintpassRedemptions[mintpassSignature] + quantity <=
                mintpass.amount,
            "GenesisToken: Mintpass already redeemed"
        );
        require(
            mintpass.minterCategory == 99,
            "GenesisToken: Mintpass not a Free Mint"
        );
    ...
    function mintWhitelist(
        ...
        require(
            ...
            "GenesisToken: Whitelist Minting is not Enabled"
        );
        require(
            mintpass.minterAddress == msg.sender,
            "GenesisToken: Mintpass Address and Sender do not match"
        ...
        require(
            ...
            "GenesisToken: Insufficient Amount"
        );
        require(
            boughtWhitelistAmounts[mintpass.minterAddress] + quantity <=
                whitelistMintLimitPerWallet,
            "GenesisToken: Maximum Whitelist per Wallet reached"
        );
    ...
    function mint(uint256 quantity) public payable {
        require(
            ...
            "GenesisToken: Public Minting is not Enabled"
        );
        require(
        ...
        require(
            ...
            "GenesisToken: Maximum per Wallet reached"
        );
        ...
        virtual
    {
        require(
            ...
            "GenesisToken: Token Limit reached"
        );
     ...
     * Learn more about the SIGNER_WALLET on our Roadmap.
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "GenesisToken: URI query for nonexistent token"
        );
