...
contract Pandayyds is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("pandayyds", "pands") {
    setHiddenMetadataUri("ipfs://QmW64Apd9qLj98mYqXCJNG2QaNG6Py9FzxHw3pUZAyCJnR/hidden.json");
  }
