...
contract eyeballtest323 is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmNQuHa8tJ9i7Nfjyu4oCGrb2suEzqsSx6j963eXQew9x4/";
    uint   public price             = 0.00003 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 323;
    uint   public maxSupply         = 323;
    bool   public mintEnabled;
    uint   public totalFreeMinted = 0;

    mapping(address => uint256) public _mintedFreeAmount;

    constructor() ERC721A("eyeball test 323", "EYEGOO323"){}
