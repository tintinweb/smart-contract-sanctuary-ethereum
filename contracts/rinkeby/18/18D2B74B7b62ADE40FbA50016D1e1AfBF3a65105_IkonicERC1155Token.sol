...
contract IkonicERC1155Token is ERC1155Base {
     ...
     * @param _contractURI URI of contract ex: https://api-mainnet.ikonic.com/contractMetadata/{address}
    ...
    */
    ...
    function mint(
        ...
        _mint(_tokenId, _supply, _uri, royaltyRecipient, royaltyValue);
    }
    ...
    ERC2981PerTokenRoyalties
{
    ...
    function _mint(
        ...
        require(creators[_tokenId] == address(0x0), "Token is already minted");
        require(_supply != 0, "Supply should be positive");
        require(bytes(_uri).length > 0, "uri should be set");
        require(royaltyValue <= 10000, "Royalty value should not exceed 10000");
        require(royaltyRecipient != address(0x0), "Royalty recipient should be present");
        require(royaltyValue != 0, "Royalty value should be positive");
        ...
        emit Mint(_tokenId, _supply, royaltyRecipient, royaltyValue);

        // Transfer event with mint semantic
        emit TransferSingle(msg.sender, address(0x0), msg.sender, _tokenId, _supply);
    ...
    function burn(
        ...
        require(
            _owner == msg.sender || isApprovedForAll(_owner, msg.sender) == true,
    ...
    function _setTokenURI(uint256 _tokenId, string memory _uri) override virtual internal {
        require(creators[_tokenId] != address(0x0), "_setTokenURI: Token should exist");
