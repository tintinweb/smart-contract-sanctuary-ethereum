...
contract SignArtGateway is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721HolderUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, ERC2981Upgradeable {
    ...
    string constant pending = "PENDING";
    string constant closed = "CLOSED";
    ...
    event newTransfer(string _assetId, string _recipient);
    ...
    function safeMint(address _to, string memory _uri, string memory _wavesAssetId) public onlyOwner {
    ...
    function lock(uint256 _evmAssetId, string memory _recipient) public isAppRunning {
        ...
        emit newTransfer(wavesAssetId, _recipient);
    }
