...
contract just is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address dev = 0xDE3EAaD4894F1eE3a6aA91B0964b8407194C991C;
    address admin1 = 0xDE3EAaD4894F1eE3a6aA91B0964b8407194C991C;
    address admin2 = 0xDE3EAaD4894F1eE3a6aA91B0964b8407194C991C;
    uint256 private constant MAX_ENTRIES = 3333;
    uint256 private constant PREMINT_ENTRIES = 100;

    // Set Prices following Tokenomics
    uint256 private OG_PRICE = 0.02 ether;
    uint256 private SALE_PRICE = 0.01 ether;
    uint256 private MAX_BUYABLE = 5;
