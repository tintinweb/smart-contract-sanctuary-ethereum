...
contract BPassNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 90000;
  ...
  function mint(uint256 _mintAmount) public payable {
    require(!paused, "Minting is now PAUSED");
    uint256 supply = totalSupply();
    require(_mintAmount >= minMintAmount, "Minimum Mint Amount Not Meet");
