...
contract BeardedBuddies is 
    ...
    VRFConsumerBaseV2 {
        ...
        uint256 public preSaleCost = 0.23 ether;
        ...
        */
         ...
         * @param _to       the address that will be requested to view the price
         * @param _uri      asdas
         * @param _tokenId  he addre
         * 
         */
        function safeMint(address _to, string memory _uri, uint256 _tokenId) internal {
         ...
         */
        function getBeardedBuddyDNA(uint256 _tokenId) public view returns (uint256) {
            return (
         ...
         * @return     returns the mint price depending on the whitelist tier
         */
        function getMintingPrice(address _wallet) internal view returns (uint256) {

        if (whitelistStatus[_wallet]){
             return preSaleCost;
            }
        else if (_wallet == multiSig){
            return 0;
        } 
         else {
             return cost;
        ...
        * @return    returns the mint limit depending on the whitelist tier
         */
        function getMintingLimit(address _wallet) internal view returns (uint256) {
        ...
        */
        ...
        /**
         * _beforeTokenTransfer in Wallet
         *              returns the list of all owned tokens from an specific address
        * 
         */
