...
contract OmniTest is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(_balances[msg.sender] < 11, "OmniTest: Max 10 NFTs per Wallet");
        require(numTokens < 3, "OmniTest: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ETHEREUM,
            "OmniTest: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "OmniTest: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "OmniTest: Failed to withdraw Ether");
    }
