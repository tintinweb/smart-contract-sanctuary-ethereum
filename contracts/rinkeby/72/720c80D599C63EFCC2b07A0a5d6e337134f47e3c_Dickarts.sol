...
contract Dickarts is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    ...
    uint256 public collectionSize = 2300;
    uint256 public whitelistMintMaxSupply = 300;
    uint256 public reservedSize = 70;
    ...
    // ===== Constructor =====
    constructor() ERC721A("Dick Arts Testing", "DAC", 10) {}
    ...
    {
        return
            string(abi.encodePacked(baseTokenURI, Strings.toString(tokenId), baseExtension));
    }
