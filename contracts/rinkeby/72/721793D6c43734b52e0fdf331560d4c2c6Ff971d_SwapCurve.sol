...
contract SwapCurve is ISwapper, Initializable, AccessControlUpgradeable {
    ...
    IERC20Upgradeable internal ustToken;
    IERC20Upgradeable internal usdcToken;

    address internal ustPoolSwapAddress;
    ...
    function swapToken(
        ...
        require(
            IERC20Upgradeable(_from).balanceOf(_msgSender()) >= _amount,
            "SwapCurve: Caller does not have enough balance."
        );
