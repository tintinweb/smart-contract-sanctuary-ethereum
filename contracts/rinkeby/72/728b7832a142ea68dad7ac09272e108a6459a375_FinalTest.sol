...
contract FinalTest is ERC721, Ownable {
  ...
  address public constant syncAddress = 0x72568149E90A332479d1e77Af674a538014b5467;
  ...
  constructor(string memory baseURI) ERC721("Final Test", "FT") {
    setBaseURI(baseURI);
 ...
 function reserveNft() public onlyAuthorized {
  ...
  function setUpPresale() external onlyOwner {
        require(workflow == WorkflowStatus.Before, "PunkedApes: Unauthorized Transaction");
  ...
  function preSaleMint(uint256[] memory _ownedTokenIDs) public payable saleIsOpen {
      // Get Sync Addres
