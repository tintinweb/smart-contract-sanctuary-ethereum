...
contract Hedgeys is ERC721Enumerable {
     ...
     * @notice This only accepts WETH, does not accept ETH
     ...
     * @param _holder is the buyer and minter of the NFT
    ...
    */ 
    function _redeemNFT(address payable _holder, uint _id) internal {
    ...
    event NFTCreated(uint _i, address _holder, uint _amount, address _token, uint _unlockDate);
    event NFTRedeemed(uint _i, address _holder, uint _amount, address _token, uint _unlockDate);
}
