...
contract HIGH is ERC20, Ownable {
    ...
    constructor() ERC20("HIGH", "HIGH") {
        ...
        penaltyFee = 25;  //25% SELL TAX FOR JEETS
        ...
        walletDumpPercent = 50; //SELL TAX VOID IF SELLING ONLY 50% OF WALLET
        ...
        marketingWallet = address(0xeb8d10835f9a02d24D7D8A67AA7d53e8434901d9); // set as dev wallet
