...
contract nuke is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("nuke-8888", "nuke") {}
    ...
    function setPriceOnConditions() internal {
        ...
        if (IndexOfMint.current() < 5 && cost != 90000000000000000) {
            cost = 0.009 ether;
        }
        if (IndexOfMint.current() > 4 && cost != 10000000000000000) {
            cost = 0.01 ether;
        }
    }
