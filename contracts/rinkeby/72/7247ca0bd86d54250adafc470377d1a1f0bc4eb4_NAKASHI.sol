...
contract NAKASHI is ERC721URIStorage, RoyaltiesV2Impl {
    ...
    modifier check(string memory unityName) {
        ...
        require(msg.sender.balance >= returnCost, "Check: Low Balance!");
        require(!paused, "Check: NFT contract is paused");
        require(
            currentBalance < maxMintAmount + 1,
    ...
    function mint(string memory unityName)
        public
        payable
        check(unityName)
    {
    ...
    function setRoyalties(uint256 _tokenId) internal {
        ...
        _royalties[0].account = payable(
            address(0xD8DC962FbF743c384bE9de9fB378283C8e10e303)
        );
    ...
    function returnComic() external payable{
        ...
        require(msg.value == returnCost, " Return Comic: You need to pay ether to pay for return fees!");
    }
