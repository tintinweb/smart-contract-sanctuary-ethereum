...
contract MainTesting is ERC721A, Ownable {
    ...
    uint256 public maxQtyPerWalletAddress = 10; //max total for public mint
    ...
    constructor(       
        ...
        ERC721A("ERC721A testing", "721A", _amountForTeam, _maxQtyPerTransaction)        
    {
    ...
    function setMaxQtyPerWalletAddress(uint256 maxMints_) public onlyOwner {
        maxQtyPerWalletAddress = maxMints_;
    }            
    ...
    // public mint
    function companyMintsForRaffles(uint256 quantity) external payable callerIsUser onlyOwner
    {        
    ...
    function publicSaleMint(uint256 quantity) external payable callerIsUser
    {
        ...
        require(_publicCounter[msg.sender] + quantity <= maxQtyPerWalletAddress, "Exceeds max per address");
        require(totalSupply() + quantity <= maxSupply, "No more NFTs left");
