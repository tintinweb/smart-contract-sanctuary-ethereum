...
//*********************************************************************//
//
//  / __ \________  / /_/ /___  __   / __ \___  ____  ____ ___  __(_)___  _____
//   / /_/ / ___/ _ \/ __/ __/ / / /  / /_/ / _ \/ __ \/ __ `/ / / / / __ \/ ___/
//  / ____/ /  /  __/ /_/ /_/ /_/ /  / ____/  __/ / / / /_/ / /_/ / / / / (__  ) 
// /_/   /_/   \___/\__/\__/\__, /  /_/    \___/_/ /_/\__, /\__,_/_/_/ /_/____/  
//                         /____/                    /____/                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1A425a72Cf29127c0CC481523301AFBccBe947e7];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4000) { }
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaUro3ksSbEm2YgBuN6vPRwYWc18SQkRat4rzzGGQTniU/";
...
// File: contracts/PrettyPenguinsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PrettyPenguinsContract is RamppERC721A {
    constructor() RamppERC721A("Pretty Penguins", "PPENGU"){}
}
