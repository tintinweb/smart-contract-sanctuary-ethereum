// \\\    ///   .-.        .-.   \\\  ///     ___    wWw        \\\  ///  oo_    
// ((O)  (O)) c(O_O)c    c(O_O)c ((O)(O))    (___)__ (O)_   /)  ((O)(O)) /  _)-< 
//  | \  / | ,'.---.`,  ,'.---.`, | \ ||     (O)(O)  / __)(o)(O) | \ ||  \__ `.  
//  ||\\//||/ /|_|_|\ \/ /|_|_|\ \||\\||     /  _\  / (    //\\  ||\\||     `. | 
...
contract MoonBeans is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    uint256 public maxPublicMint = 19950;
    uint256 public publicMintId = 0;
    uint256 public constant PUBLIC_SALE_PRICE = 0.015 ether;


   

    constructor(string memory _baseURI, string memory collectionURI) ERC721("MoonBeans NFT", "MnBNS") {
        setBaseURI(_baseURI);
