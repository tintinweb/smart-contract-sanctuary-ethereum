    ...
    OnChainManagerVerifier
{
        ...
        whenNotPaused
    {
        ...
        emit RequestFulfilled(request.id);
    }
...
contract OnChainManagerVerifier is EIP712Upgradeable {
    ...
    modifier onlyIfPending(uint256 requestId) {
        require(_requestStatuses[requestId] == RequestStatus.Pending, "Request already fulfilled");
        _;
    }
    ...
    function _markRequestAsFulfilled(uint256 requestId) internal {
        _requestStatuses[requestId] = RequestStatus.Fulfilled;
    }

    function _markRequestAsCancelled(uint256 requestId) internal {
