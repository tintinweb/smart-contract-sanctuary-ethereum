...
contract ViriumStake is Initializable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    mapping(address => uint256) private _userLastUpdateTime;
    ...
    function earned() public view returns (uint256) {
        uint256 lastUpdateTime = _userLastUpdateTime[msg.sender];
    ...
    modifier updateReward() {
        ...
        _userLastUpdateTime[msg.sender] = block.timestamp;
        _;
    }
