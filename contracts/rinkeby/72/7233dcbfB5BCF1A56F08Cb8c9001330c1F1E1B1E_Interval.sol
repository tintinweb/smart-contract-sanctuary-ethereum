...
contract Interval is VestingWallet {
	uint256 private _released;
	mapping(address => uint256) private _erc20Released;

	uint256 public intervalTime = 3 minutes;
	...
	function release() public override {
		uint256 currentInterval = block.timestamp - lastReleased;

		require(currentInterval > intervalTime || lastReleased == 0, "Nope you can't release yet brotha");
