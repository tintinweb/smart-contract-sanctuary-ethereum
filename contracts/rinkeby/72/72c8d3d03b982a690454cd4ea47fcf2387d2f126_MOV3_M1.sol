...
contract MOV3_M1 is ERC721, Ownable { // TODO: contract & token name/symbol
    ...
    constructor(uint maxSupply, uint reserved, uint mintPrice) ERC721(unicode"MOVΞ M1", "M1") {
        MaxSupply = maxSupply;
        Reserved = reserved;
        MintPrice = mintPrice;
    }
    ...
    address signer = address(0); // M1:0x69A7531007856630689AC14303178b24b9D2c63a  M2:0x6f7afe995910295B246e5aBF0AAd1e695FbD37b1
    ...
    function withdraw() external onlyOwner {
        payable(address(0) /* TODO: add dev address */).transfer(address(this).balance * 3 / 100);
