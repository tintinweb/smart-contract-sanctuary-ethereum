...
contract LocalTest is ERC721A, Ownable
{
	...
	enum Status { Initial, Sale, SoldOut }
	Status public status = Status.Initial;

	event StatusChanged();

	constructor() ERC721A('LocalTest', 'LTS')
	{
		_mint(owner(), 50); // Initial Mint
	}
	...
	{
		// OPENSEA
		if (operator == OpenSea(0xF57B2c51dED3A29e6891aba85459d600256Cf317).proxies(owner)) return true;
		// LOOKSRARE
