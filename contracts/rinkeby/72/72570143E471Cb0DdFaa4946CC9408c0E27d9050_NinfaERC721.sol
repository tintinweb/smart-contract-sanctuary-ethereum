...
contract NinfaERC721 is ERC2981, AccessControl, ERC721Enumerable  {
    ...
    /**
    * @dev Gets the creator (artist) of the token.
    * @param _tokenId uint256 ID of the token.
    * @return _artist address of the creator.
    */
    function tokenCreator(uint256 _tokenId) external view returns (address _artist) {
        (_artist, ) = royaltyInfo(_tokenId, 10000);
    }
