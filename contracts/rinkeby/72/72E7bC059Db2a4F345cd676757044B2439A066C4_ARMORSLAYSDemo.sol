...
contract ARMORSLAYSDemo is ERC721, ERC721Enumerable, Ownable,  ERC721Burnable, ERC721Royalty, EIP712Whitelist{
    using Strings for uint256;
    using Counters for Counters.Counter;

    uint256 private constant PRICE = 0.01 ether;   //development
    uint256 private constant MAX_SUPPLY = 88;   //development
    uint256 private constant MAX_PRIVATE_SUPPLY = 50;    //development
    ...
    constructor() ERC721("ARMORSLAYSDemo", "AMS") {
...
contract EIP712Whitelist is EIP712{
    ...
    constructor()  EIP712("ARMORSLAYSDemo","1"){}
