...
contract PlantParadeToken is ERC721Enumerable, WithLimitedSupply, ERC2981, Ownable {
    using SafeMath for uint;
    using Strings for uint256;
    using Counters for Counters.Counter;

    uint public constant MAX_SUPPLY = 10000;
    uint public constant MAX_RESERVE_TOKEN = 200;
    ...
    function nextToken() internal override ensureAvailability returns (uint) {
        uint maxIndex = _totalSupply - tokenCount();
