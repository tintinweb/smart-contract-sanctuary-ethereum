...
contract Modernist is ERC721, ERC721Enumerable, PullPayment, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    uint256 public constant TOTAL_SUPPLY = 9_600;
    ...
    function mintTo(address to) public payable onlyOwner returns (uint256) {
