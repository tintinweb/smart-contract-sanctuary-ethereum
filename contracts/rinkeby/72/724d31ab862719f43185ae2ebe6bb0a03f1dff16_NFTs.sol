...
contract NFTs is ERC721, Ownable {
    ...
    /*
    */
    function sendWinners(address[] memory addresses) public onlyOwner{
          require(totalSupply().add(addresses.length) <= maxNFTs, "All NFTs have been minted!");

        for (uint i = 0; i < addresses.length; i++) {
            if (totalSupply() < maxNFTs) {
                _safeMint(addresses[i], i);
            }
        }
    ...
    */
    function uploadnftImage(bytes calldata s) external onlyOwner {}
    ...
    Credits to @0xmons // for more info: https://blog.0xmons.xyz/79081566310
    */
    function uploadnftAttributes(bytes calldata s) external onlyOwner {}
