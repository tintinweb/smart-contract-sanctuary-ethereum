...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/introspection/IERC165.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC721/extensions/IERC721Metadata.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC721/extensions/ERC721URIStorage.sol
...
// File: contracts/QFIV1_Dev_2.sol


pragma solidity ^0.8.1;
//includes get all nfts
//qfi>>
...
contract Qfi_dev is ERC721URIStorage {
    ...
    constructor() ERC721("QFI TOKENS", "QFIT") {
    ...
    function updateListingPrice(uint256 _listingPrice) public payable {
        require(
            owner == msg.sender,
            "Only admin owner can update listing price."
        );
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private {
        require(price >= 0, "Price must be at 0 wei or greater");
        require(
