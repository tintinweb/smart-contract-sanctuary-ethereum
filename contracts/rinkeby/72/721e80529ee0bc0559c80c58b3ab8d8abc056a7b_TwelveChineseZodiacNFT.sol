...
contract TwelveChineseZodiacNFT is ERC721, Ownable {
	...
	//from presale & fighter
    bool public revealed = false;
	address[] public whitelistedAddresses;
    uint256 public whitelistAmount;
    string public hiddenMetadataUri = "http://www.etownol.biz/eth/ERC721/FBA/hidden.json";


    constructor(string memory _baseUrl) ERC721("TwelveChineseZodiac", "TCZ") {
        baseURI = _baseUrl;
    ...
    function toggleWhiteSale() public {
    ...
    function whitelistUsers(address[] calldata _users) public payable {
        require(msg.value >= whitelistfee, "Insuffient fee!");
        delete whitelistedAddresses;
        whitelistedAddresses = _users;         
		whitelistAmount=whitelistedAddresses.length;
    }
