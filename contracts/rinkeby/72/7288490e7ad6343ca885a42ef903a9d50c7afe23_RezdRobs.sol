...
contract RezdRobs is ERC721A, Ownable {
    ...
    uint256 public maxFreeAmount = 200;
    ...
    constructor(string memory _uriBase, string memory _uriHidden) ERC721A("RRTESTV2000", "RRT") {
       ...
       if (msg.sender != owner()) {
            ...
            if (freeCount + quantity >= maxFreeAmount) {
...

                {
                    ...
                    freeCount += quantity; //Hier war difference drin



                    if(freeCount > maxFreeAmount)

                        freeCount = maxFreeAmount;
