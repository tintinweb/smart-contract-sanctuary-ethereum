...
contract ThePokerFace  is ERC721Enumerable, Ownable
{
    ...
    uint256 private __maxMintPerAddress=20;
    ...
    uint256 public public_mint=0;
    

    string private _contractURI="https://gateway.pinata.cloud/ipfs/QmNQXddefRhQjqFDmVJZwXhMYDnpxxiygjifA2CsVsdhou/contract%20level%20metadata.json/";

    constructor() ERC721("The Poker Face Club", "TPFC")  {
 ...
 function changeRevelStatus() external onlyOwner {
    ...
    function mint(uint chosenAmount) public payable{
        require(balanceOf(_msgSender()) + chosenAmount < 31, "You can't Mint More than 20 nfts");
        ...
        require(chosenAmount <= 30, "Number of tokens can not be less than or equal to 0");
