...
contract TestIcolo is ERC721A, Ownable {
  using Strings for uint256;

  string private uriPrefix = "ipfs://QmZ75wHtn9vEByP6Gv4VaPLX28tLDDVJXTLnTmtMWBWFhb/";
  ...
  constructor() ERC721A("TestIcolo", "TI", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmbpPHttnT48pcb7V54eE8LpfX3XjHivPhADQQE78xmEJt");
  }
  ...
  function withdrawall() public onlyOwner {
        ...
        require(payable(t1).send(_balance * 15 / 100 ));
