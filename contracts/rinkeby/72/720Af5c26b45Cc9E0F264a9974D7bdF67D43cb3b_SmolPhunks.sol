 ...
 *      Contract template sourced from CyberPhunks by middlemarch.eth
 *   
 *   
...
contract SmolPhunks is Ownable, ERC721A {
    ...
    bytes constant tokenDescription = "One of 10,000 tokens in the OC SmolPhunks collection, an on-chain transformation of the original CryptoPhunks.";
    ...
    constructor(address punkDataContractAddress, address extendedPunkDataContractAddress)
        ERC721A("OC SmolPhunks", "SMOLPHUNK") {
