...
// File: contracts/goblini_test1.sol
...
//replace ABC with your collection name in PascalCase
contract GOBLINIS is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public hiddenMetadataUri = "ipfs://CID/hidden.json";
  
  // change your price by changing the value of 1 , for example: 5 ether etc... 
  uint256 public Publicprice = .0999 ether;
  uint256 public WLprice = .0999 ether;
  
  // change 10000 with your actual collection size
  uint256 public maxSupply = 1462;
  
  // change the limit with what you want for per transaction 
  uint256 public PublicmaxMintAmountPerTx = 5;
  uint256 public WLmaxMintAmountPerTx = 15;

  //  change the limit with what you want for per wallet
  uint256 public PublicmaxLimitPerWallet = 10;
  uint256 public WLmaxLimitPerWallet = 10;
  
  
  // is used to pause/unpause the contract
  bool public paused = false;
  
  // is used to enable/disable wl sale
  bool public formersSaleON = false;
  ...
  address public J48BAFORMS = 0xb3Cb2F8075331B5619c2e9C999349E517f3F54c3;
  address public TRINKETS = 0x27d4eC1589AeC9b8aDB1Bee1C8aDECFd8297F48B;
  address public SUDOBURGER = 0x5B526B8A9301f227356Fe9bb1D29E03d3B405e14;

  // collection addresses #phase 2
  address public BastardGans = 0xB8431d6153F20c4fB10d41e60Cb55346Fb15B609;
  address public TubbyCats = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
  address public MiladyMaker = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
  address public MetalMons = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
  address public Dropicall = 0x25a1ED4Cd73C775D41CaC72b08fBDFAD6Ea551B6;
  address public Gradis = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
  address public Adworld = 0xDd6c8254242D89a50eBF747F58C7A3c571fae9d5;
  ...
  // wl - 1 mint 
  function FORMIES(uint256 _mintAmount) public payable{
    require(!paused, 'The contract is paused!');
    require(formersSaleON, 'Formies Presale is not open yet');
    ...
    require(holderCol >= 1, "You don't hold require nfts" );
  ...
  function FRIENDLIES(uint256 _mintAmount) public payable{
    ...
    uint256 holderCol;
    if(Col4.balanceOf(msg.sender) >= 1) {
  ...
  function PublicMint(uint256 _mintAmount) public payable{
    require(!paused, 'The contract is paused!');
    require(!formersSaleON, 'Formies Presale is going down, Please wait for public sale to open');
    require(!friendliesSaleON, 'Friendlies Presale is going down, Please wait for public sale to open');
    require(PublicSaleON, 'Public Sale hasnt started');
    require(_mintAmount > 0 && _mintAmount <= PublicmaxMintAmountPerTx, 'Invalid mint amount!');
    require(balanceOf(msg.sender) + _mintAmount <= PublicmaxLimitPerWallet, 'Max mint per wallet exceeded!');
    require(totalSupply() + _mintAmount <= maxSupply, 'Max supply exceeded!');
...
// PublicmaxLimitPerWallet
  function setPublicmaxLimitPerWallet(uint256 _PublicmaxLimitPerWallet) public onlyOwner {
...
// formersSaleON
  function setformersSaleON(bool _state) public onlyOwner {
    formersSaleON = _state;
  }
