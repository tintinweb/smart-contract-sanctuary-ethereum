...
abstract contract ERC721URIStorage is ERC721 {
    ...
    function makeArt(string memory emotion) public view virtual returns (string memory){
        ...
        if (keccak256(bytes(emotion)) == keccak256(bytes("happy"))) {
            texts = '<svg height="500" width="500" xmlns="http://www.w3.org/2000/svg"><defs><filter id="f1" x="-40%" y="-60%" width="800%" height="800%"><feGaussianBlur in="SourceGraphic" stdDeviation="30" /></filter><filter id="f2" x="-100%" y="-150%" width="800%" height="800%"><feGaussianBlur in="SourceGraphic" stdDeviation="15" /></filter><filter id="f3" x="-100%" y="-90%" width="12000%" height="12000%"><feGaussianBlur in="SourceGraphic" stdDeviation="20" /></filter></defs><rect width="100%" height="100%" fill="#00FF00" /><circle cx="250" cy="250" r="230" fill="#FFFF00" filter="url(#f1)" /><circle cx="180" cy="200" r="35" fill="#FF00FF" filter="url(#f3)" /><circle cx="180" cy="200" r="28" fill="#5A00FF" filter="url(#f2)" /><circle cx="320" cy="200" r="35" fill="#FF00FF" filter="url(#f3)" /><circle cx="320" cy="200" r="28" fill="#5A00FF" filter="url(#f2)" /><path d="M160,300 C200,380 300,380 340,300" fill="none" stroke="#FF0000" stroke-width="40px" stroke-linecap="round" filter="url(#f2)"/></svg>';
            return  texts;
        }
        else if (keccak256(bytes(emotion)) == keccak256(bytes("sad"))) {
            texts = '<svg height="500" width="500" xmlns="http://www.w3.org/2000/svg"><defs><filter id="f1" x="-40%" y="-60%" width="800%" height="800%"><feGaussianBlur in="SourceGraphic" stdDeviation="30" /></filter><filter id="f2" x="-100%" y="-150%" width="800%" height="800%"><feGaussianBlur in="SourceGraphic" stdDeviation="15" /></filter><filter id="f3" x="-100%" y="-90%" width="12000%" height="12000%"><feGaussianBlur in="SourceGraphic" stdDeviation="20" /></filter></defs><rect width="100%" height="100%" fill="#00FF00" /><circle cx="250" cy="250" r="230" fill="#FFFF00" filter="url(#f1)" /><circle cx="180" cy="200" r="35" fill="#FF00FF" filter="url(#f3)" /><circle cx="180" cy="200" r="28" fill="#5A00FF" filter="url(#f2)" /><circle cx="320" cy="200" r="35" fill="#FF00FF" filter="url(#f3)" /><circle cx="320" cy="200" r="28" fill="#5A00FF" filter="url(#f2)" /><path d="M170,350 C200,290 300,290 330,350" fill="none" stroke="#FF0000" stroke-width="40px" stroke-linecap="round" filter="url(#f2)"/></svg>';
            return  texts;
        }
        texts = '<svg height="500" width="500" xmlns="http://www.w3.org/2000/svg"><defs><filter id="f1" x="-40%" y="-60%" width="800%" height="800%"><feGaussianBlur in="SourceGraphic" stdDeviation="30" /></filter><filter id="f2" x="-100%" y="-150%" width="800%" height="800%"><feGaussianBlur in="SourceGraphic" stdDeviation="15" /></filter><filter id="f3" x="-100%" y="-90%" width="12000%" height="12000%"><feGaussianBlur in="SourceGraphic" stdDeviation="20" /></filter></defs><rect width="100%" height="100%" fill="#00FF00" /><circle cx="250" cy="250" r="230" fill="#FFFF00" filter="url(#f1)" /><circle cx="180" cy="200" r="35" fill="#FF00FF" filter="url(#f3)" /><circle cx="180" cy="200" r="28" fill="#5A00FF" filter="url(#f2)" /><circle cx="320" cy="200" r="35" fill="#FF00FF" filter="url(#f3)" /><circle cx="320" cy="200" r="28" fill="#5A00FF" filter="url(#f2)" /><rect x="190" y="300" width="120" height="40" fill="#FF0000" rx="25" filter="url(#f2)"/></svg>';
        return  texts;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        jsonSlot.artData = makeArt(_faces[tokenId]);
    ...
    function _setFace(uint256 tokenId, string memory _emotion) internal virtual {
...
constructor(address initialRoyaltiesReceiver) ERC721("SOFT_FACES", "SFTFCS") {
    ...
    function mint(string memory emotion) external payable {
