...
contract BoonkbotsSunrise is ERC721A, ERC2981, Ownable {
  ...
  bytes32 public merkleRootMintlist = 0x34b035c9e23fc8c39a3029d40972bba0ad79ffe88b4845b8bd6a9c990267d585;

  mapping(address => uint256) public _boonklistClaimed;
  mapping(address => uint256) public _mintlistClaimed;

  constructor(string memory baseURI) ERC721A("Boonkbots Sunrise", "BOONKBOTSSUNRISE") {
    setBaseURI(baseURI);
  }
