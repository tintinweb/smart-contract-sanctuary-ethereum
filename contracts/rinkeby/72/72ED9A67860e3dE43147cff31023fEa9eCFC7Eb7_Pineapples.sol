...
import "../token/WizardsERC721.sol";
...
contract Pineapples is WizardsERC721 {
    ...
    function swapPrice(uint256 swapPrice_) public isAdmin {
        _swapPrice = swapPrice_;
    }
    ...
    Administration
{
    ...
    function mint(address to, uint256 tokenId) external isMinter whenNotPaused {
        _mint(to, tokenId);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721, ERC2981Base, Administration)
        returns (bool)
    {
        return
