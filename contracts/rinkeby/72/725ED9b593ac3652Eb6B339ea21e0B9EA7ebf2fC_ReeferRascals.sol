...
contract ReeferRascals is ERC2981,Ownable, ERC721A, ReentrancyGuard {
  ...
  // Variables
    ...
    uint256 public maxMintAmountPerTxPreSale = 5;
    uint256 public maxPerWalletPreSale = 5; 
  ...
  ERC721A(_name, _symbol)
    ...
    //Set royalty fee to 500 for a 5%.
  ...
  function whitelistMint(uint256 quantity, bytes32[] calldata _merkleProof) external payable{
    ...
    require(balanceOf(msg.sender) + quantity <= maxPerWalletPreSale,"Exceeds wallet limit for presale");
