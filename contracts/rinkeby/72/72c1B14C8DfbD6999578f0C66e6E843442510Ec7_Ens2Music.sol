...
//        require(msg.sender == ens.ownerOf(hashKey),  "You are not the owner of this ENS domain.");
    ...
    function setMetadata(string memory domainName, string memory metadataURI) public onlyMember {
        require(getPurchaseStatus(domainName) == NFTPurchaseStatus.PURCHASED,  "This domain name hasn't been purchased.");
    ...
    function redeemMusicNFT(string memory domainName) external payable {
        ...
        require(getPurchaseStatus(domainName) == NFTPurchaseStatus.SONGIFIED,  "Please wait for your music NFT to be songified.");
