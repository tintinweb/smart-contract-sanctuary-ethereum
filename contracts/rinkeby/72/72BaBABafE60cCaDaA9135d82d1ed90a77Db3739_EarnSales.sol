...
contract EarnSales is Context, ReentrancyGuard {
    ...
    event ItemSold(address indexed seller, address indexed buyer, address indexed nft, uint256 tokenId, uint256 price);
    event ItemUpdated(address indexed owner, address indexed nft, uint256 tokenId, uint256 newPrice);
    ...
    function listItem(
        ...
        listings[_nftAddress][_tokenId] = Listing(_msgSender(), _quantity, _pricePerItem, _startingTime);
        emit ItemListed(_msgSender(), _nftAddress, _tokenId, _quantity, _pricePerItem, _startingTime);
    }
    ...
    function buyItem(address _nftAddress, uint256 _tokenId) external payable nonReentrant {
        Listing memory listedItem = listings[_nftAddress][_tokenId];
        IERC721 nft = IERC721(_nftAddress);
