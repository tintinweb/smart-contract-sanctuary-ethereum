...
contract Metabows_Official is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Metabows Official", "MBW") {
      setBaseURI("ipfs://QmXtAaWj5x4P34cbiA4bfXQNNdCSF96Lhs9CcibUejiepg/");
    ...
    function freeMint(uint256 _mintAmount) public payable {
      ...
      if (msg.sender != owner()) {
        require(!paused, "The contract is paused!");
        require(addressMintedBalance[msg.sender] + _mintAmount <= nftPerAddressLimitFree, "Only 2 free mints allowed per wallet.");        require(maxFreeSupply > 0, "public free supply sold out.");
