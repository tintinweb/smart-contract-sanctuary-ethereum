...
contract Flokimooni is ERC721, Ownable {
  ...
  constructor(string memory baseURI) ERC721("Flokimooni", "FM") {
    setBaseURI(baseURI);
  }
  ...
  function getMaxReserve() external view returns (uint256) {
 ...
 function reserveNft() public onlyAuthorized {
    require(balanceOf(msg.sender) <= maxReserveCount, "Max Reserves taken already!");
