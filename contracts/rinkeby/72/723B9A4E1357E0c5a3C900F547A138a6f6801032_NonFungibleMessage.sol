...
contract NonFungibleMessage is ERC721, Ownable {
    ...
    function safeMint(address to, string calldata _msg) public onlyOwner {
        _safeMint(to, supply);
        makers[supply] = msg.sender;
        blocks[supply] = block.number;
        messages[supply] = _msg;
        supply = supply + 1;
    }
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '<foreignObject x="100" y="100" width="800px" height="800px"><div  style="display:flex;justify-content:center;align-items:center; width:100%;height:100%;font-family: Verdana, sans-serif;font-size: 2.5em;" xmlns="http://www.w3.org/1999/xhtml"><![CDATA[',
                    bytes(message),
                    " ]]></div></foreignObject>",
