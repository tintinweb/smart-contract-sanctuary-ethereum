...
contract LoveU is ERC721A, Ownable {
    ...
    uint256 public constant MAX_PER_WL_MINT_ADDRESS = 1;
    ...
    constructor(string memory baseURI) ERC721A("LoveU", "LoveM") {
    ...
    modifier mintCompliance(uint256 quantity) {
        ...
        require(
            _numberMinted(_msgSender()) + quantity <= MAX_PER_ADDRESS,
