    ...
    function _saleToken(
        ...
        if (
            ...
            (
                ...
                uint256 char,
                uint256 netamount
            ) = calc(amount, _royal[tokenId], serviceValue, _charity[tokenId]);
            require(
                msg.value == _adminfee.add(roy.add(netamount.add(char))),
            ...
            require(
                approveValue >=
                    (_adminfee.add(roy.add(netamount.add(char)))).div(
                        10**Tokendecimals
                    ),
                "Insufficient Balance"
            );
