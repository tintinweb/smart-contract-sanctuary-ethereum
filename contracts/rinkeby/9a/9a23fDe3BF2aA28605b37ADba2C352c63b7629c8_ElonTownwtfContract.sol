...
//    / ____/ /___  ____/_  __/___ _      ______  _      __/ /_/ __/
//   / __/ / / __ \/ __ \/ / / __ \ | /| / / __ \| | /| / / __/ /_  
//  / /___/ / /_/ / / / / / / /_/ / |/ |/ / / / /| |/ |/ / /_/ __/  
// /_____/_/\____/_/ /_/_/  \____/|__/|__/_/ /_(_)__/|__/\__/_/     
//                                                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbuHEhVro8tfTEpG9uAb9jogr1JicXzCba1DwKChTwA7n/";
...
// File: contracts/ElonTownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ElonTownwtfContract is RamppERC721A {
    constructor() RamppERC721A("ElonTownwtf", "ET"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sYmVmocDh2PUtrA7Zo9i/contract-metadata";
    }
}
