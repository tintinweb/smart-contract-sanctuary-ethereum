...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  */
  ...
  abstract contract Allowlist is Ownable {
    ...
    // File: contracts/merkleMeBbyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MerkleMeBbyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("MerkleMeBby", "MERKLE", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://rampp.com/merkle/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/6fsazuuTv7574cskuNFL/contract-metadata";
        }
    }