...
contract TheClubsI is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() payable ERC721A("The Club(s) I", "TCTI") {}
    ...
    function mintOne(bytes32[] calldata _merkleProof) public payable nonReentrant {
        _checkPaused();
        _checkCanMint(1);
    ...
    function mint(uint256 _qty) public payable nonReentrant {
        _checkPaused();
        _checkCanMint(_qty);
        if (owner() != msg.sender) {
