...
Keep your panties on bois, only a test yet. 
...
contract TestGoDz is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TGDZ", "TestGoDz") {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
        ...
        require(newAmount <= totalSupply() * 30 / 1000, "Swap amount cannot be higher than 3% total supply.");
