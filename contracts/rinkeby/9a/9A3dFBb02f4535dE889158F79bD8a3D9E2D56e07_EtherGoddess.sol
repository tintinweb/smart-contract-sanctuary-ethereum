...
contract EtherGoddess is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint256 public totalStakedNFTCount = 0;
    ...
    function claimRewards() public {
        ...
        totalRewardClaimed[msg.sender] += rewards[msg.sender];
    }
        ...
        returns (uint256)
    {
        return
            (stakedBalance[_user] *
                RATE *
                (block.timestamp - lastUpdateTimestamp[_user])) / 86400; // seconds in a day
    }
