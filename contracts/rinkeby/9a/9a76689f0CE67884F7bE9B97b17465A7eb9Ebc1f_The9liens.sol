...
contract The9liens is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  address public theOwner = 0x65543f550aCdC1b63f0b4f3f31326a7c2C03E69C;
  ...
  //     require(freeClaimed[msg.sender] < freePerWallet , 'You have already claimed all your allocated free mints!');
  //   } else {
