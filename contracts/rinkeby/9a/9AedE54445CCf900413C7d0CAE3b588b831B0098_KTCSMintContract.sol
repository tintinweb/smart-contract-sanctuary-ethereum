...
contract KTCSMintContract is ERC721A, Ownable {
    ...
    uint256 public reserve = 10; // set reserve supply if any for management
    ...
    //TODO Allow other LIMITs on Some WALLETS
    ...
    constructor(
        ...
        devShare = 10; //Dev Fee
        ownerWithdrawAddress = 0x44845A1a1244eFc6a37B209526Ba4727F4Cc5119;//TEST
        //ownerWithdrawAddress = 0x24Fc44b101869cbD374065bfa64a3211c32e2F76;//Owner
    }

    //***************************************************************************************************
    //Mint reserve for management
    //***************************************************************************************************
    ...
    function gift(address _address, uint256 __count) external onlyOwner {
        ...
        _safeMint(_address, supply + __count);
    }
