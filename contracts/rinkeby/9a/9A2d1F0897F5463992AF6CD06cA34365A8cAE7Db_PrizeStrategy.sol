...
import "../vault/VaultManagerInterface.sol";
    ...
    PausableUpgradeable
{
    ...
    {
        console.log("Get winners Calling", _vaultId, winners.length);
        ...
        console.log("Get winners Calling middle", _vaultId, winners.length);
        ...
        console.log("Get winners", _vaultId, winners.length);
    }
