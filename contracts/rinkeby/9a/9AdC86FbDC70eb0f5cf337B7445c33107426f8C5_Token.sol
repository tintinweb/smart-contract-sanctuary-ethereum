...
contract Token is BaseContract, ERC20Upgradeable
{
    ...
    function mint(address to_, uint256 quantity_) external {
        ...
        //_log(string(abi.encodePacked("Tokens minted ", toString(to_), toString(quantity_))));
    }
    ...
    function setTax(uint256 tax_) external onlyOwner
    {
        ...
        //_log(string(abi.encodePacked("Token tax updated ", toString(tax_))));
    }
    ...
    function setDevTax(uint256 devTax_) external onlyOwner
    {
        ...
        //_log(string(abi.encodePacked("Token dev tax updated ", toString(devTax_))));
    }
    ...
    function setVaultTax(uint256 vaultTax_) external onlyOwner
    {
        ...
        //_log(string(abi.encodePacked("Token vault tax updated ", toString(vaultTax_))));
    }
    ...
    function setPumpAndDumpTax(uint256 pumpAndDumpTax_) external onlyOwner
    {
        ...
        //_log(string(abi.encodePacked("Token pump and dump tax updated ", toString(pumpAndDumpTax_))));
    }
    ...
    function setPumpAndDumpRate(uint256 pumpAndDumpRate_) external onlyOwner
    {
        ...
        //_log(string(abi.encodePacked("Token pump and dump rate updated ", toString(pumpAndDumpRate_))));
    }
