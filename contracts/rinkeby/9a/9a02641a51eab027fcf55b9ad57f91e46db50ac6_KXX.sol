...
// File: Documents/NFTs/KXX/ERC721A.sol
...
// File: Documents/NFTs/KXX/KXX.sol
...
contract KXX is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant MaxSupply = 1007;
    uint256 public  QtyPerPublicMint = 1;
    uint256 public  QtyPerWhitelistMint = 1;
    uint256 public  MaxPerPublicWallet = 1;
    uint256 public  MaxPerWhiteListWallet = 1;
    uint256 public  PublicSalePrice = 0.2 ether;
    uint256 public  WhitelistSalePrice = 0.2 ether;

    uint256 public MaxMintPhase1 = 200;
    uint256 public MaxMintPhase2 = 200;
    uint256 public MaxMintPhase3 = 200;
    ...
    constructor() ERC721A("KXX WORLD TEST", "KXX"){

    }

    modifier callerIsUser() {
        require(tx.origin == msg.sender, "KXX :: Er1");
        _;
    }
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        if(whiteListSale || publicSale && Phase1){
            ...
            if (!whiteListedAddress[msg.sender] && publicSale){
                require(publicSale, "KXX :: Er2");
                require((totalSupply() + _quantity) <= MaxMintPhase1, "KXX:: Er3");
                require((totalPublicMint[msg.sender]  +_quantity) <= QtyPerPublicMint, "KXX :: Er4");
                require(msg.value >= (PublicSalePrice * _quantity), "KXX :: Er5");
                require(_quantity + balanceOf(msg.sender) <= MaxPerPublicWallet , "KXX :: Er6");
                ...
                require(whiteListSale, "KXX :: Er2");
                require((totalSupply() + _quantity) <= MaxMintPhase1, "KXX :: Er3");
                require((totalWhitelistMint[msg.sender] + _quantity)  <= QtyPerWhitelistMint, "KXX:: Er4");
                require(msg.value >= (WhitelistSalePrice * _quantity), "KXX :: Er5");
                require(_quantity + balanceOf(msg.sender) <= MaxPerWhiteListWallet , "KXX :: Er6");
                require(whiteListedAddress[msg.sender], "KXX :: Er7");
            ...
            if (!whiteListedAddress[msg.sender] && publicSale){
                require(publicSale, "KXX :: Er2");
                require((totalSupply() + _quantity) <= MaxMintPhase2, "KXX :: Er3");
                require((totalPublicMint[msg.sender]  +_quantity) <= QtyPerPublicMint, "KXX :: Er4");
                require(msg.value >= (PublicSalePrice * _quantity), "KXX :: Er5");
                require(_quantity + balanceOf(msg.sender) <= MaxPerPublicWallet , "KXX :: Er6");
            ...
            if (!whiteListedAddress[msg.sender] && publicSale){
                require(publicSale, "KXX :: Er2.");
                require((totalSupply() + _quantity) <= MaxMintPhase3, "KXX :: Er3");
                require((totalPublicMint[msg.sender] +_quantity) <= QtyPerPublicMint, "KXX :: Er4");
                require(msg.value >= (PublicSalePrice * _quantity), "KXX :: Er5");
                require(_quantity + balanceOf(msg.sender) <= MaxPerPublicWallet , "KXX :: Er6");
            ...
            if (!whiteListedAddress[msg.sender] && publicSale){
                require(publicSale, "KXX :: Er2");
                require((totalSupply() + _quantity) <= MaxSupply, "KXX :: Er3");
                require((totalPublicMint[msg.sender] +_quantity) <= QtyPerPublicMint, "KXX :: Er4");
                require(msg.value >= (PublicSalePrice * _quantity), "KXX :: Er5");
                require(_quantity + balanceOf(msg.sender) <= MaxPerPublicWallet , "KXX :: Er6");
            ...
            require(!pause, "KXX :: Er2");
        }
    }

    function teamMint() external onlyOwner{
        require(!teamMinted, "KXX :: Er8");
        teamMinted = true;
...
//REVEALED??????
    ...
    //3% to utility/investors wallet CHANGE TO WITHDRAW
    function withdraw() external onlyOwner{
        uint256 withdrawAmount = address(this).balance * 8/100;
        payable(0xC2860104e1dDBb385131b1300145f32a25F7eFE1).transfer(withdrawAmount);
