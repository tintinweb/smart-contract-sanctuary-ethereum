...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase {
    ...
    bytes32 public keyHash; //TODO: should be internal
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        uint256 strength = (randomNumber % 100); // from 0 to 99
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            _isApprovedOrOwner(_msgSender(), tokenId), "ERC721: transfer caller is not owner or approved"
        );
