...
contract BNFNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function setMaxPresaleToken(uint _amount) public onlyOwner {
    ...
    /// @dev Presale mint
    function presaleMint(uint _numTokens, bytes32[] calldata merkleProof) public payable nonReentrant {
        ...
        require(presaleReservations[msg.sender] <= MAX_PRESALE_TOKENS_PER_WALLET, "Whitelisted buying exceeded");
