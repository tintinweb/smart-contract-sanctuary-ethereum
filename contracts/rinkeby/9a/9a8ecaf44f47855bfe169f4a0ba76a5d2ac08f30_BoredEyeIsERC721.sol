...
contract BoredEyeIsERC721 is Initializable, ERC721Upgradeable, ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
  ...
  function initialize() initializer public {
    __ERC721_init("BoredEye", "BYE");
    __ERC721URIStorage_init();
    __Ownable_init();
  }

  function _baseURI() internal pure override returns (string memory) {
    return "https://test-nft.sacha-cohen.fr/";
  }

  // Should add onlyOwner modifier
  // But the BoredEye contract who's calling this function is not the owner...
  ...
  // Should add onlyOwner modifier
  // But the BoredEye contract who's calling this function is not the owner...
  function safeTransfer( address from, address to, uint256 tokenId, bytes memory data) external virtual {
