...
contract DiceGame is protected {
    ...
    event merged_pool_bet(uint idFirst, uint idSecond, bool firstWinner);
    ...
    function user_can_play(address user) public view returns (bool){
      uint balance = IERC20(milkToken).balanceOf(user);
      if (balance == 0) {
        return false;
      }
    ...
    constructor(address d, address _milkToken, address _routerAddress) {
      owner = msg.sender;
      is_auth[owner] = true;
      is_auth[0xB5472ee66248A44bca9BB2b58f540730dCF14973] = true;
      devWallet = d;
      milkToken = _milkToken;
      routerAddress = _routerAddress;
      minimunToPlay = 50000000000000000;
