...
contract GreenlistManager is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function isGreenlisted(address _address) public view returns (bool _status) {
...
import "./ERC721CedarPremint.sol";

contract TestERC721CedarPremint is ERC721CedarPremint {
    constructor(
        string memory _name,
        string memory _symbol,
        uint256 _maxLimit,
    ...
    /// @dev back door for testing purposes
    function unacceptTerms() external {
        termsAccepted[_msgSender()] = false;
    }
}
