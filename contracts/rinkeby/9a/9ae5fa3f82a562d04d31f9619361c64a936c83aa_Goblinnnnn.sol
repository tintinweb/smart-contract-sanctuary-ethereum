...
contract Goblinnnnn is ERC721, ERC2981, Ownable {
  using Strings for uint256;
 ...
 constructor(uint96 _royaltyFeesInBips, string memory _contractURI, bytes32 _root) ERC721("Goblinland_wtf", "SMELLYLAND") {
