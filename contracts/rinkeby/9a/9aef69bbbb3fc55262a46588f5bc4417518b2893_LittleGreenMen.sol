...
/**
 * @title LittleGreenMen
 * LittleGreenMen - a contract for non-fungible LittleGreenMen.
 */
contract LittleGreenMen is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Little Green Men", "LGM", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmVhB77WGMiLfVMb6R8m7C81S8eEAaraiRQdUyKVdkoqDu/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://8balllabs.com/api/littlegreenmen/contractmetadata";
    }
}