...
contract SkinnyDAOracle is AccessControl, EIP712 {
  ...
  function setPoolFees(
    ...
    require(mintFee < 10**18 && burnFee < 10**18);
...
interface IVestingVault {
   ...
   */
  function release(address _beneficiary, uint256[] calldata _ids) external;
   ...
   */
  function allocationSummary(address _beneficiary, uint256 _id)
    external
    view
    returns (
