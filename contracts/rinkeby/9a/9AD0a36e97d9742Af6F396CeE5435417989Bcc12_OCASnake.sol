...
contract OCASnake is Ownable, ERC721A, ERC2981, ReentrancyGuard, OCASnakeArt {
    ...
    function snakeNameSave(
        ...
        uint256 adjectiveIndex = uint256(
            generateAppleSeed(tokenId, 420 + seed) % wackyAdjectives.length
        );

        uint256 supremeIndex = uint256(
            generateAppleSeed(tokenId, 69 + seed) % supremeAdjectives.length
        );

        string memory snakeName = snakes[snakeNameIndex];
        string memory randomAdj = wackyAdjectives[adjectiveIndex];
...
// @@@@@@@@@@@@&BB&@@@@@@@@@@@@@@@#BBGPPPPPPPPGBB#@@@[email protected]@@@@@&&&@@@&&&@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@#55B&&&&&&@@@@@@@&&[email protected]@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@#[email protected]@@@@@[email protected]@@PPPPPPJ????[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@&&&#PPPPPPBB#@@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@&PPPPPPPPP&&&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@&&#PPPPPPPPPPPPPPPPPPPP5B&&#[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
...
contract username_list is Ownable, ReentrancyGuard {
    ...
    string[10] internal supremeAdjectives = [
        "Degen",
        "NGMI",
        "GMI",
        "Apeing",
