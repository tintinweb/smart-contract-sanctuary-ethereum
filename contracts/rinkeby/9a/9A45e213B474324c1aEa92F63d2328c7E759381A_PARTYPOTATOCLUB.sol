...
// File: PARTYPOTATOCLUB.sol

contract PARTYPOTATOCLUB is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

  string private uriPrefix = "";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  string public POTATO_PROVENANCE = "";
  
  uint256 public publicSaleCost = 0.085 ether;
  uint256 public presaleCost = 0.065 ether;
  uint256 public maxSupply = 8888;
  uint256 public maxMintAmountPerTx = 3;
  uint256 public maxPublicWalletLimit = 3;
  ...
  constructor() ERC721A("PARTY POTATO CLUB", "PARTY") {
      setHiddenMetadataUri("https://ipfs.io/ipfs/QmUs1S2qWkGHLAF5GHUSnB2eQEBcZMrZTa2JnLDY7yXEFk/hidden.json");
  }
  ...
  function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        POTATO_PROVENANCE = provenanceHash;
    }
