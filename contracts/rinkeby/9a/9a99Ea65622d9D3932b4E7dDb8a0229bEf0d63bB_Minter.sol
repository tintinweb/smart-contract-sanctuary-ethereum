...
contract Minter is Ownable, ReentrancyGuard {
    ...
    uint256 public discountedPercentagePrice;
    ...
    function transferFunds(uint256 qty, bool isDicounted) private {
        ...
        uint256 priceETH = !isDicounted ? TOKEN_PRICE_ETH : (TOKEN_PRICE_ETH * discountedPercentagePrice) / 10_000;
        uint256 priceUSDC = !isDicounted ? tokenPriceUSDC : (tokenPriceUSDC * discountedPercentagePrice) / 10_000;
    ...
    function mintDiscount(bytes32[] calldata merkleProof, uint amount) public payable 
        isSaleActive()
