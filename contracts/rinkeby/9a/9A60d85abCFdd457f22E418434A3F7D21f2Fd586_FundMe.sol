...
// 779,466
// 759924 gas
// NatSpec is useful to automatically generate documentation for other developers to interact with protocol
...
contract FundMe {
    ...
    mapping(address => uint256) private s_addressToAmountFunded; // 0xa2adEE2b744B90DD9C22b1634cBB9F6A93a89D8d - 36000000000000000 Wei
    ...
    constructor(address priceFeedAddress) {
        ...
        // console.log(s_priceFeed);
        // Within EVM, s_priceFeed is running as contract matching priceFeedAddress; outside of EVM for example in Hardhat javascript environment s_priceFeed == priceFeedAddress
    ...
    // @param  abc the address of the funder
    //  @return abc amount funded
    ...
    function cheaperWithdraw() public payable onlyOwner {
        ...
        require(callSuccess, "Call failed");
        // Now, we have saved our storage variable into a memory variable, we can read and write from this memory variable much much cheaper
        // Then, update the storage when we are all done

        // mappimgs can't be in memory
    }
...
// - forked hardhat network  - talk about this soon

// Staging tests / Integration tests are done on a test net (LAST STOP!!)
