...
contract Reef is ERC721A, ERC721ABurnable, Ownable {
    ...
    function whitelistMint(uint256 _quantity, bytes calldata signature) external payable{
        ...
        require(_numberMinted(msg.sender) < presaleConfig.maxPerWallet, "This exceeds the amount you can mint in WL sale");
        // ECDSA magic :o
    ...
    function userUsedWl() public view returns(bool) {
        return _numberMinted(msg.sender) >= presaleConfig.maxPerWallet;
    }
    // locator
    ...
    function withdrawAll() public onlyOwner{
        ...
        _widthdraw(0xe2f35Fa533066723Fd94Af3cE7C34B30b84105B9, balance); // change upon recieving team addresses
    }
}