...
contract MyPetMonkey is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://bafkreih4t4m2nm2hxenn5t3zyk5ewxgbv6wyukdtw6hetxfeiits44xndm";

  uint256 public  maxSupply = 455;
  ...
  ) ERC721A("My Pet Monkey", "MPM EVOLVE") {
