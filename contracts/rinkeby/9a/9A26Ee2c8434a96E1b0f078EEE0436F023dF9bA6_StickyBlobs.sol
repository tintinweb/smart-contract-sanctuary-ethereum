...
contract StickyBlobs is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint private mintCostPresale = 0.001 ether;
    uint private mintCostPublicSale = 0.001 ether;

    //max number of mints per transaction in public sale
    uint private maxMintPerTX = 43;
    ...
    constructor() ERC721A("StickyBlobs", "S-Blobs"){
        
        unrevealedURI = "ipfs://QmNr5CmHtcL3TrubAvQbyRpyEeox2hUqfmFYvNoDnbLKtC";
    }
