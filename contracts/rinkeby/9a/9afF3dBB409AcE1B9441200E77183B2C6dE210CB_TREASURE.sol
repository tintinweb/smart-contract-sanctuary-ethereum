...
contract TREASURE is ERC20, Ownable {
    ...
    uint256 public _totalSupply = 1e9 * 1e18; // 100 B tokens
    uint256 public swapTokensAtAmount = 1e6 * 1e18; // 0.1b = Threshold for swap (0.1%)
    uint256 public maxWalletHoldings = 3e7 * 1e18; // 3% max wallet holdings (mutable)
