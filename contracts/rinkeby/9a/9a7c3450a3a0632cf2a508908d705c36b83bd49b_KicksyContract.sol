...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmdAeK1EzCYcXuehWxZprNNkFX4gx7Hbjyu7U5YYJQ5gXu/";
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 20");
    ...
    // File: contracts/kicksyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract KicksyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("KICKSY", "KY", _proxyRegistryAddress)
        {}
