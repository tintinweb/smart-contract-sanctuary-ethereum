...
contract TheGoodDogClubLLC is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint8 private LIMIT_FREE_MINT_COUNT = 5;
    uint8 private LIMIT_PRE_SALE_COUNT = 5;
    uint8 private LIMIT_PUBLIC_SALE_COUNT = 5;

    // Minting Limitation
    uint16 public normalFreeMintLimit = 750;
    uint16 public preSaleNormalLimit = 1500;
    uint16 public totalLimit = 7500;
    ...
    uint256 public mintPricePublicSale = 0.08 ether;

    // BaseURI (real, placeholder)
    string private realBaseURI = "https://tgdcalllen.mypinata.cloud/ipfs/QmbdqD7o6Cbrr9LRyGgFvixsFsxwHVWeLFzLH7ihA9VSe9/";
    ...
    constructor() ERC721A("TheGoodDogClubLLC", "TGDC") {
        teamWalletPercent[teamWalletList[0]] = 68; // The Good Dog Club LLC percent
        teamWalletPercent[teamWalletList[1]] = 30; // community wallet percent
        teamWalletPercent[teamWalletList[2]] = 1; // Adam's wallet 3 percent
        teamWalletPercent[teamWalletList[3]] = 1; // Artist Wallet 4 percent
    }
