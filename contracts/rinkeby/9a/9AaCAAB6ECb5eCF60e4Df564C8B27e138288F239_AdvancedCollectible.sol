...
import "ERC721URIStorage.sol"; // This import this changed from ERC721 due to _setTokenURI not being present in ERC721.
...
contract AdvancedCollectible is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    mapping(uint256 => PPTYPE) public tokenIdToPP;
    ...
    {
        PPTYPE pptype = PPTYPE(_randomWords[0] % 12);
        uint256 newTokenId = tokenCounter;
        tokenIdToPP[newTokenId] = pptype;
