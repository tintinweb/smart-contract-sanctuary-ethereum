...
contract StarName is IStarName, AdminControl {
    ...
    function getDefaultName(IStar.StarInfo memory starInfo) public view virtual override returns (string memory) {
        return _defaultStarNameLookup[starInfo.starType];
    }
}
...
interface IStarName is IERC165 {
     ...
     */
    function getDefaultName(IStar.StarInfo memory starInfo) view external returns(string memory);
