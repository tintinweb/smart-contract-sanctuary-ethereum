...
contract NFTMarketplace is Pausable, FeeManager, ERC721Holder {
    ...
    function orderTokensOfOwner(address _owner)public view returns(uint[]memory OrderId)
    {
        Order memory order ;
       ...
       function auctionTokensOfOwner(address _owner)public view returns(uint[]memory AuctionId)
    {
        AuctionData memory auctionData;
