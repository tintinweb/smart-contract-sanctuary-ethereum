...
contract CryptoCriminals is ERC721, Ownable, ReentrancyGuard {
  ...
  uint public constant maxMintsPerTransaction = 15; // remove?
  uint public constant reservedAmount = 100; // TODO change to final value
  uint public constant salePrice = 0.001 ether; // TODO change to final value
  uint public constant presalePrice = 0.001 ether; // TODO change to final value
