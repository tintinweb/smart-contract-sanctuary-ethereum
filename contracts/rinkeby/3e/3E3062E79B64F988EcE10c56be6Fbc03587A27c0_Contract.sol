...
contract Contract is ERC721Enumerable, Ownable {
  ...
  constructor(string memory _CollectionName, string memory _CollectionSymbol, string memory _initBaseURI,string memory _initnotRevealURI)
    ERC721(_CollectionName, _CollectionSymbol) { setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI); }
