...
contract PhidiUpdateTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PhidiUpdateTest", "PUT") {
    setHiddenMetadataUri("ipfs://QmeN3oqswUuG6PWv8WHZk12UsDyDK13XHnqhaZkkwVqgoi.json");
  }
