...
contract MyEpicNFT is ERC721URIStorage {
  ...
  // escolha as suas palavras divertidas, nome de personagem, comida, time de futebol, o que quiser! 
    // Eu crio tres listas, cada uma com seu grupo de palavras aleatorias
  // escolha as suas palavras divertidas, nome de personagem, comida, time de futebol, o que quiser! 
  string[] firstWords = ["Orion", "Sirius", "Altair", "Vega", "Lira", "Aquilla", "Alalcomeneu", "Bathin", "Cailleach", "Lestat", "Edite", "Heimdall", "Hercules"];
  string[] secondWords = ["Draconis", "Hiperboreo", "Lemuriano", "Atlantis", "Polaris", "Nephila", "Alain", "Beag", "Cainhame", "Alucard", "Eon", "Hastur", "Trismegisto"];
  string[] thirdWords = ["Nimrod", "Navutan", "Samyaza", "Pleiades", "Alcione", "Reptilianos", "Akysha", "Bogan", "Cagliostro", "Dannas", "Enoch", "Gorgona", "Isaias"];
  ...
  constructor() ERC721 ("1Sefirot1#NFT", "SIGUL") {
    console.log("Minha primeira colecao NFT c SmartContract e OpenZeppelin");
  }
