...
contract bcTest is ERC721A, Ownable {
    ...
    function finalizeMetadata() public onlyOwner {
        isMetadataFinal = false;
    }

	function reveal(string memory url) public onlyOwner {
        require(!isMetadataFinal, "Metadata is finalized");
		_baseURL = url;
	}

    function mintedCount(address owner) public view returns (uint) {
	...
	function airdrop(address to, uint count) public onlyOwner {
		require(
