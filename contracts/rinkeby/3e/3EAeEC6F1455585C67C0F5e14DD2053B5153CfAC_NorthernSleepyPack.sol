...
contract NorthernSleepyPack is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Northern Sleepy Pack", "NSP") {}
  ...
  function mint() public payable {
    ...
    Word memory newWord = Word(
        string(abi.encodePacked('Northern Sleepy Pack #', uint256(supply + 1).toString())), 
        "Northern Sleepy Pack is a limited 1000 NFT Collection of sleepy northern creature.",
