...
contract Vault is Initializable, PausableUpgradeable, AccessControlUpgradeable {
    // 💥 This contract is upgradable, add new variables at the end.
    // Take extra care if you are inheriting. Also, do not swap parents.
    ...
    constructor() {
        ...
        // 💥 Use this function if not initialization is needed for the proxy
        // 💥 It is not allowed to use either selfdestruct or delegatecall in your upgradable contracts.
        _disableInitializers();
    }

    // 🔨 Real constructor in Upgradable contracts
    function initialize() public initializer {
        ...
        // Setting a default percentage
        // This is way to assign default values in upgradable contracts
        // rather than in the variable declaration
    ...
    function sweep(address _token) public whenNotPaused {
        require(
