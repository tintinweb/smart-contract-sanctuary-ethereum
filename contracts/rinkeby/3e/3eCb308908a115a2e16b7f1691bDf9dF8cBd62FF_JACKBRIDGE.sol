...
contract JACKBRIDGE is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("JACKBRIDGE", "JACK")
  {
  ...
  uint256 public constant PRICE = 32000000000000000;
  ...
  string private customContractURI =
    "QmPHxbCgaq1V9nDY16twtP1x3wzMHseWgMXYvz2ocRJww5";
