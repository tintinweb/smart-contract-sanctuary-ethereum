...
contract TRANSLOOT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private legs = [
        "Blue & White Thigh-Highs",
        "Pink & White Thigh-Highs",
        "Purple & White Thigh-Highs",
        "Yoga Pants",
        "Skirt (Go Spinny)",
        "Skinny Jeans",
        "Pajama Pants"
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="base" fill="#7ACBF5">';
    ...
    constructor() ERC721("Starter Kit (For Trans Girls)", "TRANSLOOT") Ownable() {}
}
