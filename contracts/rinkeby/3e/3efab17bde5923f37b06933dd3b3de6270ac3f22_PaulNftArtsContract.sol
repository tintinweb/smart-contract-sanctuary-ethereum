...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3148E6752D15845Dc20F456c68cBBa5cD0E0A08e];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 20 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZZ6v5KihNsUPQoMYu6WfowEfX3keYvGVGvrfDdFXJgfN/";
...
// File: contracts/PaulNftArtsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PaulNftArtsContract is RamppERC721A {
    constructor() RamppERC721A("Paul Nft Arts", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/JxZZs6a5vSTU2ZiwAAsp/contract-metadata";
    }
}
