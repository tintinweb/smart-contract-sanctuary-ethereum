...
contract Marketplace {
    ...
    function _setupAuction(
        ...
        if (_erc20Token != address(0)) {
            auctions[_contractAddress][_tokenId].ERC20Token = _erc20Token;
        }
        auctions[_contractAddress][_tokenId].buyNowPrice = _buyNowPrice;
        auctions[_contractAddress][_tokenId].minPrice = _minPrice;
        auctions[_contractAddress][_tokenId].nftSeller = msg.sender;
    }
