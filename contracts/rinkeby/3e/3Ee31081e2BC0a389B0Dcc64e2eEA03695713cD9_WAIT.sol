                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "image":"',
                                string(abi.encodePacked(genSLSVG(), '", "animation_url": "ipfs://ipfs://QmSFsJE2fvm9PxaUVzSAZySJqmALZLK4EtD67PBmv5wB8t/skylight-chrome-2000x2000.mp4')),
                                '"}'
                            )
                        )
                    )
