...
//|_   _|  ___  ___ | |_    / \     __ _   __ _dd __    / _ \ / | / _ \ / |
//  | |   / _ \/ __|| __|  / _ \   / _` zc_/ |_| \___/ |_|
//                                 |___/
//
...
contract Testagain0101 is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/81/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/81/contract-uri";
	...
	constructor(address _signerAddress) ERC721A("TestAgain 0101", "BRICK") {
