    ...
    IsPausable
{
    ...
    function _doesBidMeetBidRequirements(
        ...
        uint32 _bidIncreasePercentage = nftContractAuctions[_nftContractAddress]
    ...
    {
        uint256 _extraFee = (_minPrice * (10000 + defaultExtraFeePercentages)) /
            10000 -
            _minPrice;
            
        if (_auctionBidPeriod != 0){
            require(_auctionBidPeriod < 604800, "Bid Period should be in range");
            require(_bidIncreasePercentage <= MaxEtraBidPercentages, "Bid Increase Percentage should be 50% maximum");
            nftContractAuctions[_nftContractAddress][_tokenId]
            ...
            require(_bidIncreasePercentage <= MaxEtraBidPercentages, "Bid Increase Percentage should be 50% maximum");
            nftContractAuctions[_nftContractAddress][_tokenId]
            .feeRecipients = _getFeeRecipient(_nftContractAddress, _tokenId);
            _createNewNftAuction(
                _nftContractAddress,
                _tokenId,
                _erc20Token,
