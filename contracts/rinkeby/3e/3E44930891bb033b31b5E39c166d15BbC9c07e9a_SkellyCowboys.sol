...
contract SkellyCowboys is ERC721A, Ownable {
    ...
    uint256 public constant PUBLIC_SUPPLY = 900;
    uint256 public constant MAX_SUPPLY = PRIVATE_SUPPLY + PUBLIC_SUPPLY;

    mapping(address => bool) public presalerList;
    mapping(address => uint256) public presalerListPurchases;
    uint256 public constant PRESALE_PURCHASE_LIMIT = 1;

    constructor() ERC721A("Skelly Cowboys", "SLCB") {
        saleEnabled = false;
        price = 0.1 ether;
    }
