...
contract TronWars is ERC721, Ownable, WithdrawFairly, ReentrancyGuard {
    ...
    constructor(string memory baseURI, address _signAddress) ERC721("TronWars", "TRON") WithdrawFairly() {
        ...
        setSale("PRESALES", Sale(1644091200, 1644177599, 2, 2, 0.15 ether, false));
        setSale("COMMUNITY",Sale(1644091200, 1644177599, 100, 100, 0.15 ether, false));
        setSale("PUBLIC",   Sale(1644177600, 1991332800, 3, 3, 0.15 ether, false));
    }
    ...
    function communityMint(uint16 _count) public payable canMint("COMMUNITY", _count) nonReentrant {
        ...
        require(_msgSender() == address(0xDfd143aE8592e8E3C13aa3E401f72E1ca7deAED0), "Bad community wallet address");
