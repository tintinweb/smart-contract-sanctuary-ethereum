...
contract TokenVesting is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public totalTokensAvailableToAssig;
    ...
    address tokenAddress; // Address of Token´s Smart Contract
    ...
    constructor(
        ...
        totalTokensAvailableToAssig = 1000000000;
     ...
     */
    function setTotalTokensToAssign(uint256 _totalTokensAvailableToAssig)
        public
        onlyOwner
    {
        totalTokensAvailableToAssig = _totalTokensAvailableToAssig;
    }
    ...
    function assignTokensToWallet(
        uint256 cantidadBBCNAAsignar, // Cantidad de tokens que se le asignarán a una wallet
        address walletUsuario, // Wallet en que se asignarán los tokens
        uint256 _firstClaimDate, // Fecha en que se realizará el primer Claim (UNIX TIMESTAMP)
        uint256 _cooldownTimePerWallet // Tiempo que transcurrirá entre Claims (UNIX TIMESTAMP)
        ...
        //HAY UN CASO QUE PUEDDE TENER PROBLEMAS
        ...
        tokensRestantes = totalTokensAvailableToAssig - totalTokensAssigned;
