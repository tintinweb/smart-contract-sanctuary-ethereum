...
contract Febrero is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Febrero", "BDS") {
    setHiddenMetadataUri("ipfs://QmcH81wmpitDbPtKn2pxF2GxC6E8Eyo1vQ1Et4vMQ2CSSk/Erc721_Data_3.json");
  }
