...
// File: contracts/PixelGuizWhitelist.sol
...
contract PixelGuiz is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 0.05 ether;  //цена за минт 1 нфт
  ...
  bool public paused = true; //функция которая отвечает за паузу минта, если хотите поставить на паузу напишите true вместо false
