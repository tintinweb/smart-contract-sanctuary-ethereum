...
contract POQDAOAsset is ERC1155Supply, Ownable {
    ...
    function setPrice(uint256 tokenId, uint256 amount) public onlyOwner {
        priceMapping[tokenId] = amount;
    }
    ...
    function mintAsset(uint256 collectionId, uint256 amount) external payable {
        ...
        IERC20(erc20Token).transferFrom(
            msg.sender,
            address(this),
            amount * priceMapping[collectionId]
        );
