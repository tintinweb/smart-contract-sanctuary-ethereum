    ...
    ThePixelsDigitsUtility
{
    ...
    {
        uint256[] memory costs = new uint256[](variantIds.length);
        bool[] memory claimedStatusses = new bool[](variantIds.length);
        bool[] memory collectionOwnership = new bool[](variantIds.length);
