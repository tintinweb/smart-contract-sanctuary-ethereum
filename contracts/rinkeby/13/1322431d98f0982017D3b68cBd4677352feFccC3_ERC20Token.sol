...
contract ERC20Token is Context, IERC20, Initializable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 private _totalSupply;
    uint256 MaxToken = 6000000;
    string private _name = "Beture";
     ...
     */
    function initialize(uint8 decimals, uint256 amount, address _teamWallet) public onlyOwner initializer {
        _decimals = decimals;
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 feeamount = amount.mul(3).div(10**2);
        uint256 txamount = amount.sub(feeamount);
