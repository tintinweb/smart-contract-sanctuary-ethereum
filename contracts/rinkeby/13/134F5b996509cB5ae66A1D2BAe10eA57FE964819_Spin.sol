...
contract Spin is VRFConsumerBaseV2 {
    ...
    function Reset(address ad) internal {
        s_requestAddressforId[ad] = 0;
    }

    function ReadThewords() public returns (uint256) {
        uint256 thereturn = s_requestAddressforId[msg.sender];
        Reset(msg.sender);
        return thereturn;
    }
