...
contract ClaimReward is Ownable {
    ...
    event Claim(address user, uint256 maxCount);
    ...
    function setAlreadyClaimed(address user) external onlyOwner {
        delete alreadyClaimed[user];
    }
}