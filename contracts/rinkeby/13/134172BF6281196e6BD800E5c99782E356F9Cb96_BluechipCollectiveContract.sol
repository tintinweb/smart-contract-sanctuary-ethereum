...
//*********************************************************************//
//
//   ____  __                __    _          ______      ____          __  _          
//    / __ )/ /_  _____  _____/ /_  (_)___     / ____/___  / / /__  _____/ /_(_)   _____ 
//   / __  / / / / / _ \/ ___/ __ \/ / __ \   / /   / __ \/ / / _ \/ ___/ __/ / | / / _ \
//  / /_/ / / /_/ /  __/ /__/ / / / / /_/ /  / /___/ /_/ / / /  __/ /__/ /_/ /| |/ /  __/
// /_____/_/\__,_/\___/\___/_/ /_/_/ .___/   \____/\____/_/_/\___/\___/\__/_/ |___/\___/ 
//                                /_/                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1655049600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1654961400;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD7206f6E0990C37285898b888976D79fB583B074];
...
abstract contract RamppERC721A is 
    ...
    ERC721A,
    Withdrawable,
    ReentrancyGuard , Allowlist , TimedDrop {
    constructor(
        string memory tokenName,
        string memory tokenSymbol
    ) ERC721A(tokenName, tokenSymbol, 1, 2000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcHuuG7kaAtsaZEGDsyaPHJSsc4bG2FosgNz9i9EDfwfH/";
...
// File: contracts/BluechipCollectiveContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BluechipCollectiveContract is RamppERC721A {
    constructor() RamppERC721A("Bluechip Collective", "CHIP"){}
}
