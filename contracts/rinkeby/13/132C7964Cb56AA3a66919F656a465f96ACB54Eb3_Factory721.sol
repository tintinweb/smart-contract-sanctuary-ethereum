...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new TokenAimUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TokenAimUser721Token token = TokenAimUser721Token(address(addr));
...
contract TokenAimUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
