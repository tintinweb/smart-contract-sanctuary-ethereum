...
contract Fairy is Ownable, ERC721Enumerable {
    using Strings for uint256;
    ...
    uint256 public constant RESERVED_COUNT = 100;
    ...
    constructor() ERC721("Fairy", "FAIRY") {}
    ...
    function mintFairies(uint256 count)
        external
        payable
    {
    ...
    function setBaseURI(string memory newBaseURI)
        ...
        onlyOwner
    {
        require(!baseURIFreezed, "BaseURI is Freezed!");
        baseURI = newBaseURI;
    }
    ...
    function mintReserved(address account, uint256 tokenId)
        external
        onlyOwner
    {
