...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x82050d1b8F013F210acd99ED8121fe2215a6B50F];
...
// File: contracts/ProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ProjectContract is RamppERC721A {
    constructor() RamppERC721A("Project", "PRO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/JeDugbCN7uiG7ROXBzi8/contract-metadata";
    }
}
