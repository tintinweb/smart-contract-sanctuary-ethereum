...
// developed by Ian Cherkowski https://twitter.com/IanCherkowski
    ...
    Ownable
{
    ...
    string public baseURI = "https://ipfs.io/ipfs/QmP2gYuMEkgYLoApoGrKR6FQQ4WEmifu12Mtq6kaYNg2oS/";
    uint256 public maxMint = 20;
    uint256 public presaleLimit = 500;
    uint256 public prePrice = 0.08 ether;
    uint256 public mintPrice = 0.1 ether;
    uint256 public maxSupply = 3500;
    uint256 public presale = 14315634;
    uint256 public mainSale = 14316447;
	...
	function mint(uint8 _mintAmount) external payable nonReentrant {
        ...
        require(block.number > presale, "Wise: Minting not started yet");
        ...
        if (block.number < mainSale) {
            ...
            require(msg.value >= prePrice * _mintAmount, "Wise: Must send eth of cost per nft");
