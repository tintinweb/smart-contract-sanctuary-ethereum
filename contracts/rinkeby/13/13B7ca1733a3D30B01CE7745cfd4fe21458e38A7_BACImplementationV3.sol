...
contract BACImplementationV3 is ERC721A, AccessControl, VRFConsumerBaseV2 {
    ...
    uint256 constant public TOKENS_PER_WALLET = 1000;
    ...
    function setSubscriptionId(uint64 subscriptionId) public onlyRole(OPERATOR_ROLE) {
        s_subscriptionId = subscriptionId;
    }

    function setupRandom(address _coordinator, address _link, bytes32 _keyHash) public onlyRole(OPERATOR_ROLE) {
    ...
    function getMaxPerTransaction() external pure returns (uint256) {
        return TOKENS_PER_TX;
    }

    function getMaxPerWallet() external pure returns (uint256) {
