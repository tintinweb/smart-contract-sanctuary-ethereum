...
contract CloudHeadzGangDeployer is ERC721, Ownable {
    ...
    uint256 public MAX_FREE_MINT = 10;
    uint256 public MAX_MINT_PER_TXN = 1;
    bool public IS_SALES_ACTIVE = true;

    constructor() ERC721("Cloud Headz Gang", "CHG") {
        _contractUri = "ipfs://QmXkbaMD99zkRBN2hZuMsqKnYRr7d4mkTvEKMiP8RAiBd4";
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(totalSupply() + quantity <= MAX_SUPPLY, "ALL CLOUD HEADZ HAVE BEEN SOLD");
