...
contract beijingfood is ERC721A, Ownable {
    
    using Strings for uint256;


    uint256 FREE_MINT_LIMIT_PER_WALLET = 17;
    uint256 MAX_MINTS = 17;
    uint256 MAX_SUPPLY = 17;
    bool private paused = false;
    uint256 MAX_FREE = 17;
    uint256 public mintRate = 0.5 ether;

    string public baseURI = "https://ipfs.io/ipfs/QmanW9atUu1dJJuNF7H81CtmUj8uEcDs8mrn2YyKMPpBVn";

    mapping(address => uint256) private freeMintCountMap;
    

    constructor() ERC721A("beijingfood", "BJF") {}
