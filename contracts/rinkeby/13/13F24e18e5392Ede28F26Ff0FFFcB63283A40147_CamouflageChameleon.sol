...
contract CamouflageChameleon is ERC721ACustom, Ownable {
    ...
    function mint (
        ...
        function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
            ...
            return bytes(baseTokenURI).length > 0 ? string(abi.encodePacked(baseTokenURI)) : string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmeHCx4advM2pJU4XbSwRKV3BuG3NxfkhHVvy1iBrNSNVC"));
        }
