...
// TODO: add royalty on sales
// TODO: add getBalance()
// TODO: add split to withdraw()
// TODO: add gift() function
// TODO: add more auth, test for auth
// TODO: add more tests

// TODO: protect from smart contracts minting
// TODO: solidity security
...
contract EthLlamasNFT is ERC721, Pausable, Ownable, ReentrancyGuard {
    ...
    // Full ipfs path to project json files
    //  expected format is "ipfs://<cin>/"
    ...
    // TODO: owner and DAO wallets for withdraw split

    constructor() ERC721("EthLlamasNFT", "ELNFT") {
        // TODO: 100x mints for give aways
    ...
    function safeMint(address _to, uint256 _mintAmount) external virtual whenNotPaused payable nonReentrant {
        ...
        require(_mintAmount > 0, "mintAmount needs to be greater than 0.");
        require(_mintAmount <= maxMintAmount, "mintAmount needs to be less than or equal to maxMintAmount");
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            // _setTokenURI(mintIndex, string(abi.encodePacked(Strings.toString(mintIndex), '.json')));
        }
    }
    ...
    function withdraw(uint amount) external onlyOwner {
        require(amount <= address(this).balance, "amount needs to be less than or equal to contract balance");
