...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4cA88A9E6AB74D220585D3F8b2bDd32D0575A8ea];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmaWWNdtgopCbZ1kic93GKeZs9XLPCkdVazTRaDV2gh1q4/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Upu9orp5RlAAadLd8CQf/contract-metadata";
    }
}
