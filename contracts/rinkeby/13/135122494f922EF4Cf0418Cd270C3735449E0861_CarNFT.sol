...
contract CarNFT is ERC721, Ownable {
    ...
    constructor(uint256 _supply, address _openSeaProxyRegistryAddress) ERC721('Car', 'CARR') {    
        MAX_SUPPLY = _supply;
     ...
     * Mint
     */
    function mint(uint256 _numberOfTokens, address _to) external onlyOwner {
        ...
        // Set the starting index block if this is the last saleable token
