...
contract WLClassicMint is BaseWhitelist {
    ...
    function hasCMMintStarted() public view returns (bool) {
        return
    ...
    function setTokenQuantity(uint256 quantity) public onlyOwner {
    ...
    function setMaxMintTx(uint256 maxMintTx) public onlyOwner {
