...
contract nekomato_04142327 is ERC721{
...
//ここが名前
    constructor() ERC721("nekomato_04142327" , "nekomato_04142327" ) {
        //owner address
        //tonoshake
    ...
    function dovMint(uint256 _tokenID)external callerIsUser owners{
        //require(_tokenID < max);
        //require(_tokenID >= min);
        //require(minted[_tokenID] == false);
        //_safeMint( msg.sender , nftid);
    ...
    function setTokenURI( uint targetnftid ,string memory _uri ) public owners{
