...
contract CuteAfTestOnly is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 5;
    uint256 public immutable supply = 20;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x6EcEeF2bfA5Ca942b786b39581F0857036cFb3EB];
    uint256[] public withdrawPercentages = [5, 95];

    bytes32 public merkleRoot = 0x434624a7ce8effe1719a6db0a5b6b7248c0806dbaea983063e5c9dafcd7cd617;
