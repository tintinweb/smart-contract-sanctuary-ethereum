...
contract Buffer is Initializable {
    ...
    mapping(address => mapping(uint16 => address)) public _creatorInfo;
    ...
    function initialize(
        ...
        for (uint8 i = 0; i < _partnersGroup.length; i++) {
            partnersGroup[i] = _partnersGroup[i];
        }

        for (uint8 i = 0; i < _creatorsGroup.length; i++) {
    ...
    function updateCreatorPairInfo(
        ...
        for (uint16 i = 0; i < creators.length; i++) {
    ...
    receive() external payable {
        ...
        for (uint16 i = 0; i < partnersGroup.length; i++) {
        ...
        for (uint16 i = 0; i < creatorsGroup.length; i++) {
