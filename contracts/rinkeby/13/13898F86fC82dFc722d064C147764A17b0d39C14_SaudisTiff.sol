...
|  $$$$$$  |____  $$| $$  | $$ /$$__  $$| $$ /$$_____/| $$   | $$| $$$$    | $$$$    
 ...
 /$$  \ $$ /$$__  $$| $$  | $$| $$  | $$| $$ \____  $$| $$   | $$| $$      | $$      
|  $$$$$$/|  $$$$$$$|  $$$$$$/|  $$$$$$$| $$ /$$$$$$$/| $$   | $$| $$      | $$      
 \______/  \_______/ \______/  \_______/|__/|_______/ |__/   |__/|__/      |__/      
...
contract SaudisTiff is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() initializerERC721A initializer public {
        __ERC721A_init('SaudisTiff', 'SAUDISTIFF');
        __Ownable_init();
    ...
    function mint(uint256 quantity, bytes32[] memory _proof) external payable nonReentrant {
        ...
        require(quantity > 4, "SaudisTiff mint at least 5");
