...
contract liuyueshijiu is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("liuyueshijiu", "shijie", 10, 30) {}
    ...
    uint256 private allowListMintAmount = 10;
