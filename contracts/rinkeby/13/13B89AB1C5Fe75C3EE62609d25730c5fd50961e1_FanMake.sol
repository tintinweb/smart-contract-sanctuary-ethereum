...
contract FanMake is ERC721, EIP2981RoyaltyOverrideCore {
    ...
    function supportsInterface(bytes4 interfaceId_) public view virtual override(ERC721, EIP2981RoyaltyOverrideCore) returns (bool) {
        return ERC721.supportsInterface(interfaceId_) || EIP2981RoyaltyOverrideCore.supportsInterface(interfaceId_);
    }

    function setTokenRoyalties(TokenRoyaltyConfig[] calldata royaltyConfigs_) external override isCreator {
        _setTokenRoyalties(royaltyConfigs_);
    }

    function setDefaultRoyalty(TokenRoyalty calldata royalty) external override isCreator {
