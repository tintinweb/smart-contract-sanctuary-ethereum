...
error NftMarketplace__NoBalanceToWithdraw(address);
...
contract NftMarketplace is ReentrancyGuard {
     ...
     * but this implementation means people can still hold their NFTs when listed
     */
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        // check if the the marketplace contract is approved to sell the given tokenId
    ...
    function withdrawProceeds() external nonReentrant {
        ...
        if (balance <= 0) {
            revert NftMarketplace__NoBalanceToWithdraw(msg.sender);
        }
