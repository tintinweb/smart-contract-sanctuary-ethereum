...
contract PlayDamsel is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PLAY PLAY PLAY", "PDAM") {
    setHiddenMetadataUri("ipfs://QmbfkZS2fkzJYcCn1ac5dX6sTJB1Ho9FFq1N2ZtVb3QL6o/Minting%20Now.json");
  }
