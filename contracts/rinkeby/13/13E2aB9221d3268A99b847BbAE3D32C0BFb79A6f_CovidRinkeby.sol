...
import './CovidRinkebyBase.sol';
import './CovidRinkebySplits.sol';

/**
 * @title CovidRinkeby
 */
contract CovidRinkeby is CovidRinkebySplits, CovidRinkebyBase {
    constructor()
        CovidRinkebyBase(
            'CovidRinkeby',
            'CVR',
            'https://nftculture.mypinata.cloud/ipfs/Qm00000000000000000000000000000000000000000000/', // TODO: Set CovidRinkeby Base URI
            addresses,
            splits,
            0.069 ether
        )
...
contract CovidRinkebySplits {
    address[] internal addresses = [
        0x000000000000000000000000000000000000dEaD // TODO: Set CovidRinkeby Wallet(s)
    ];

    uint256[] internal splits = [100]; // TODO: Set CovidRinkeby Split(s)
}
