...
contract GrandApeGang is ERC721A, Ownable {
        ...
        whenPublicSaleStarted
    {
        ...
        if(freeMinted[msg.sender]){
            require(msg.value >= publicSalePrice * quantity, "Fund amount is incorrect");
        }else{
            require(msg.value >= (publicSalePrice * quantity) - publicSalePrice, "Fund amount is incorrect");
