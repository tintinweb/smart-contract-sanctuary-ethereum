    ...
    Ownable
{
    ...
    function _mint() internal {
        ...
        tokenWidth[nextMint] = rand(((nextMint%6)+1)*250) + 550 ;
    ...
    function claimTokenByPunkId(uint256 id) external nonReentrant callerIsUser {
        ...
        // this address check gives me authority to airdrop people their Puuunk, 
        ...
        tokenList[id] = true;
        tokenWidth[id] = rand(((id%6)+1)*250) + 550 ;
        ...
        returns (string memory)
    {
        ...
        // get the punk SVG
        string memory punkSVG = "data:image/svg+xml;utf8,<svg EXAMPLE";// cryptoPunksData.punkImageSvg(uint16(tokenId));
       ...
       // get punk attributes which come in as a string like "Male 1, Smile, Mohawk"
        ...
        string memory trait = string.concat('","attributes": [{"trait_type": "Tyyype","value": "', attrParts[0] , '"}');
