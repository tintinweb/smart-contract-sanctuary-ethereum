...
contract penileImplant is ERC721A, Delegated , ReentrancyGuard {

  using Strings for uint256;

  bytes32 public merkleRoot;
  string public uriPrefix = 'sdfag';
  ...
  uint256 public expenseAmount = 1 ether;
  ...
  address public ronnie1 =  0x99990Ab0E073Ecf018ad5d6C4D1D0815Aa3D33A1;
  address public ronnie2 = 0x99990Ab0E073Ecf018ad5d6C4D1D0815Aa3D33A1;
  address public ronnie3 = 0x99990Ab0E073Ecf018ad5d6C4D1D0815Aa3D33A1; 
  address public nftBrands = 0x99990Ab0E073Ecf018ad5d6C4D1D0815Aa3D33A1;
  ...
  function withdrawExpenses() public onlyDelegates nonReentrant {
     /// can only be called once 
        ...
        require(address(this).balance >= 10 ether , "not enough yet...");
          ...
          (bool nftb, ) = payable(0x99990Ab0E073Ecf018ad5d6C4D1D0815Aa3D33A1).call{value: expenseAmount}('');
          require(nftb);
          expensed = true;
