...
contract MyTEST1 is Ownable, ERC721A, ReentrancyGuard {
    uint256 public constant MAX_SUPPLY = 100;
    uint256 public constant maxPerAddressDuringMint = 3;
    bool public isPreSaleRunning = false;
    bool public isPublicSaleRunning = false;
    uint256 private _preSalePrice = 0.0001 ether;
    uint256 private _salePrice = 0.0002 ether;
    mapping(address => uint256) public preSaleList;

    event NewMint(address indexed _from, uint256 _quantity);

    constructor() ERC721A("MyTEST1", "MT1") {}
