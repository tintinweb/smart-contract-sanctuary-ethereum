...
/**
    ...
    @dev Firepit contract receives and transfers MetaMallows {ERC721A} tokens. Rewards users when staking with LOVE tokens 
*/
...
contract teste_2 is IERC721Receiver,Ownable{
    ...
    /**  
        @dev set the LOVE contract reference
    */
    function setTeste_3Address(address _teste_3TokenAddress) external onlyOwner{
        teste_3Token = teste_3(_teste_3TokenAddress);
    }
    /**  
        @dev staking MetaMallows function to the Firepit
        @param _tokenIds array with MetaMallows ids to be staked
    */
    ...
    /**  
        @dev Claming reward function, can also unstake the {_tokenId} if {_unstake} is true
        @param _tokenIds array with MetaMallows ids to be claimed
        @param _unstake bool array when "true" the {_tokenId} in that position will be unstaked from the Firepit 
    */
    ...
    /**  
        @dev view total rewards function
        @param _tokenIds array with MetaMallows ids
    */
    ...
    /**  
        @dev view the staking details for the {_tokenId}
    */
    function viewfirepit (uint256 _tokenId) external view returns (stakedInfo memory){
        return firepit[_tokenId];
    }
    /**  
        @dev check if the {_owner} staked the respective {_tokenIds} in the Firepit
    */
    ...
    /**  
        @dev activate or deactivate the staking functions
    */
