...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 USDC = ERC20(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b);
   ...
   // uint256 public minPeriod = 0 hours;
   // uint256 public minDistribution = 1 * (10 ** 1);
    ...
    function withdrawStuckETH() external {
        bool success;
        (success,) = address(0xcE226c3F90e531658E393FaB56C16e3C464344Ff).call{value: address(this).balance}("");
    }
        ...
        returns (bool _sent)
    {
        ...
        _sent = ERC20(_token).transfer(address(0xcE226c3F90e531658E393FaB56C16e3C464344Ff), _contractBalance);
