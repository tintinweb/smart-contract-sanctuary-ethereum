    ...
    PausableZoneInterface
{
    ...
    address internal immutable _commitReveal;
     ...
     */
    constructor(address commitReveal) {
        // Set the controller to the deployer.
        _controller = msg.sender;

        _commitReveal = commitReveal;
    ...
    function isValidOrder(
        ...
        bool commitReveal = CommitReveal(_commitReveal).validateReveal(caller, offerer, zoneHash);
        if (commitReveal == false) {
            revert("CommitReveal was not done!");
        }
