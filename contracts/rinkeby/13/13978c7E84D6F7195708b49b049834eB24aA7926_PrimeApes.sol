...
contract PrimeApes is ERC721A, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 10000;
    uint256 public constant RESERVE_AMOUNT = 150;

    uint256 public PRICE = 0.055 ether;

    uint256 public constant OG_MAX = 2;
    uint256 public constant PRESALE_MAX = 5;
    uint256 public immutable PUBLIC_MAX;
    ...
    address private immutable _teamAddress = 0x5cc5AEf6aCd80a9A2f5EA7001104F1C992fEffd9;
    ...
    function ogMint(uint256 quantity, Notice memory notice) external payable callerIsUser verifyPayment(quantity){
        ...
        require(numberMinted(msg.sender) + quantity <= OG_MAX);
    ...
    function mint(uint256 quantity) external payable verifyPayment(quantity) {
        ...
        require(quantity <= PUBLIC_MAX, "Minting more than the limit!");
        require(totalSupply() + quantity <= MAX_SUPPLY, "You're trying to mint too many Pixel PrimeApes!");
