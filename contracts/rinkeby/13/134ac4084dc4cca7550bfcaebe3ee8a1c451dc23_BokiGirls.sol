...
contract BokiGirls is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
		...
		require(_mintAmount > 0, "Cant mint 0 BokiGirls" );
		require(s + _mintAmount <= maxFree, "Cant exceed BokiGirls supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 BokiGirls");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more BokiGirls" );
        require(s + _mintAmount <= maxSupply, "Cant exceed BokiGirls supply");
