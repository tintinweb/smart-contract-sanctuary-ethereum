...
//
//             ____        __    __                           
//    / __ )____ _/ /___/ /____        _  ____  ______
//   / __  / __ `/ / __  / ___/       | |/_/ / / /_  /
//  / /_/ / /_/ / / /_/ (__  )  _    _>  </ /_/ / / /_
// /_____/\__,_/_/\__,_/____/  (_)  /_/|_|\__, / /___/
//                                       /____/       
//     
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9346f1d460cBC0fcA01997F1E5940fD55675173d];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qma5YhE5CUpidTx8qJz9VhFb9cnzXfRyA9aQApMkhhKS6F/";
...
contract BaldsxyzContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Yz65cOhVANm92Chgc4GT/contract-metadata";
    }
}
