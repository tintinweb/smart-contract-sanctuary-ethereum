...
contract SketchyPruebas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sketchy Pruebas", "SP") {
    setHiddenMetadataUri("ipfs://QmcRsSUcq9vGJuPaYFCXEQpMpEQCBmGaKZ2Jwmcr7PP1yQ?preview=1.json");
  }
