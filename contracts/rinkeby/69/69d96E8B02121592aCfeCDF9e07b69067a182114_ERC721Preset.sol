...
contract ERC721Preset is ERC721Base, PaymentSplitter, Ownable, AccessControl, Pausable, ReentrancyGuard {
    ...
    ) ERC721Base(tokenURI_, "ERC721PresetBase", "ERC721PB", MAX_SUPPLY, royaltyReceiver_, royaltyFraction_)
