...
contract Vester is Ownable, IClaimable {
    ...
    address public immutable MON = 0xcA1114115892085692411CF518CcA89085aa2d2e; // 0x0b3E2EaCA41fcC50fFFCCEc467c9f7d2479Af709; MON (Ethereum)
    ...
    constructor(uint256 _totalVestingAmount) {
        ...
        finalPoint = 1e18; // From 0 to 1e18 of precision
    }
