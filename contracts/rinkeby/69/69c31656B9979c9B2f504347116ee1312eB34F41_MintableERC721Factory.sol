...
contract MintableERC721Factory is AccessControl {
    ...
    constructor(address tokenImplementation_, address operatorAddress_) {
      ...
      address owner_
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeWithSelector(
              MintableERC721(address(0)).initialize.selector,
              name_,
              symbol_,
              owner_,
              operatorAddress
