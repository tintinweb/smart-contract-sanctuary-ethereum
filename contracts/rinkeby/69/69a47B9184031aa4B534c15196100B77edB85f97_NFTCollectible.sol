...
contract NFTCollectible is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("BoredBears", "BOBE") {
        setBaseURI(baseURI);
    }

    //onlyownerという修飾子を関数に適用することで、関数の使用をコントラクトの所有者に限定することができる
    ...
    function mintNFTs(uint _count) public payable {
        ...
        for (uint i = 0; i < _count; i++) {
            //全てのチェックが終わったら、_count個のNFTをユーザーにMintする
            _mintSingleNFT();
        }
    }
    ...
    //特定のアカウントが所有するNFTについての情報を取得可能な関数
