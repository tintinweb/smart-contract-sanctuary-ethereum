...
// File: contracts/ChainUp_NFT.sol
...
contract ChainUpNft is ERC721A, Ownable {
  using Strings for string;
  using Address for address;

  uint256 public constant TOTAL_SUPPLY = 100;

  string public baseURI_ = "https://nftstorage.link/ipfs/bafybeiczrqfw5zileb2glmm3gakcccd2zauasv5lsof5urmornbtbenilu"; 

  constructor() ERC721A("ChainUp Beep", "CUB") Ownable() {}
