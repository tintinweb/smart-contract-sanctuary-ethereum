...
contract OneDollarTicket is VRFConsumerBase, ReentrancyGuard, Ownable, Pausable {
    ...
    function enterDraw() whenNotPaused() public payable {
    ...
    function finalizeFunds() whenPaused() public payable {
        require(msg.sender == owner);
        payable(msg.sender).transfer(address(this).balance);
    }

    // when called the balance of the contract or percentage of balance is send to winner
    function payWinner() whenNotPaused() nonReentrant public onlyOwner {
