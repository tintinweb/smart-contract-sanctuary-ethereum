...
contract UniV3NftLoan is IERC721Receiver, ReentrancyGuard {
    ...
    IERC20 public constant lendingMoney =
        IERC20(0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735);
        ...
        returns (bool)
    {
        ...
        // bool success = lendingMoney.transferFrom(lender, address(this), 100);

        TransferHelper.safeTransfer(
            0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735,
            0x6Db7787De4FF0C9500720d8eA22e2031C51a5f90,
            1
        );
