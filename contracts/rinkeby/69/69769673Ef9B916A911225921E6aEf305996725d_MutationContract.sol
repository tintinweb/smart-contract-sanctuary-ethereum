...
contract MutationContract is ERC1155, Ownable {
    ...
    address private approvedContract;
    ...
    function setContractAddress(address _address)
        external
        onlyOwner
    {
        approvedContract = _address;
    }

    function burnForAddress(uint256 _id, address _address)
        external
    {
        require(msg.sender == approvedContract, "Invalid burner address");
