...
contract CryptoonGoonzOriginals is ERC721ABurnable, IERC2981, Ownable {
    ...
    function mint() public onlyOwners {
        _mintTo(msg.sender);
    }

    function mintTo(address _recipient) public onlyOwners {
        _mintTo(_recipient);
    }

    function _mintTo(address _recipient) private {
    ...
    modifier onlyOwners() {
        require(owner() == _msgSender() || minter == _msgSender(), "caller is not the contract or store owner");
        _;
    }
