...
contract DiceGame is Initializable, RandomNumber {
    ...
    event RequestId(uint256 requestId, address indexed user, uint256 dateTime);
    ...
    function playGame(
        ...
        emit RequestId(requestId, msg.sender, block.timestamp);
    }
        ...
        )
    {
        ...
        multiplier = ((MAX_NUMBER - s_houseEdge) * BP) / winningChance;
        ...
        returns (uint256 winningChance)
    {
        ...
        uint256 winningChanceBeforeRounding = (((MAX_NUMBER - s_houseEdge) *
            BP) * BP) / multiplier;
    ...
    function getMaxMultiplier() public view returns (uint256 maxMultiplier) {
        maxMultiplier = (MAX_NUMBER - s_houseEdge) * BP;
    }
    ...
    function getMinMultiplier() public view returns (uint256 minMultiplier) {
        minMultiplier =
            ((MAX_NUMBER - s_houseEdge) * BP) /
            (MAX_NUMBER - (s_houseEdge + 1));
    }
        ...
        returns (uint256 maxWinningChance)
    {
        ...
        maxWinningChance = MAX_NUMBER - leftOver;
    }
...
contract RandomNumber is OwnableUpgradeable, VRFConsumerBaseV2Upgradeable {
    ...
    VRFCoordinatorV2Interface public s_coordinator;
