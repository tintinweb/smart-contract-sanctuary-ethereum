...
contract ScotchNFT is ScotchBeneficiary, ERC721URIStorage {
  ...
  function createAutoNFTs(uint count, string memory baseURI, string memory extension) public payable

  {
...

    {
      ...
      _setTokenURI(id,  string.concat(baseURI, Strings.toString(i), extension));
