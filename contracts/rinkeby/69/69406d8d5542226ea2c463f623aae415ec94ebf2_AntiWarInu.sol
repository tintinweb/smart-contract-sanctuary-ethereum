...
Anti-War Inu - Supporting Ukraine One Block At A Time
 
https://t.me/AntiWarETH
https://antiwarinu.io
...
contract AntiWarInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anti-War Inu";
    ...
    uint256 public _sellMarketingFee = 9300;
    ...
    constructor() {
        ...
        marketingAddress = payable(0x75F9cB1eE6cbcb6F38d783a4b28CFA89b3A96B5A); // Marketing Address
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 9500, "Must keep sell taxes below 20%");
