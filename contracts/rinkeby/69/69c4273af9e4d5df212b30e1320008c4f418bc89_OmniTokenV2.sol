 ...
 * @author Omni, inspired by the OpenZeppelin Initializable contract
...
// File contracts/token/OmniTokenV2.sol
...
/**
 * @notice implementation of the OMNI token contract
 * @author Omni
 */
contract OmniTokenV2 is VersionedInitializable, ERC20 {
    using SafeMath for uint256;

    string internal constant NAME = "Omni Token";
    string internal constant SYMBOL = "OMNI";
