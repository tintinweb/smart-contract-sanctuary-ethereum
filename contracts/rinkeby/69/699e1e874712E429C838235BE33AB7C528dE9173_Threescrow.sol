...
/**
 * @title Threescrow Contract
 * @author [email protected]
 * @notice This contract shall be the prime Threescrow NFT contract for creation of contracts in the Metaverse!
 */
contract Threescrow is NFT, EscrowFactory, ReentrancyGuard {
    /**
     * @notice Constructor function for the Threescrow Contract
     * @dev Constructor function for the Threescrow ERC721 Contract
     * @param name_ Name of the Threescrow artifact Collection
     * @param symbol_ Symbol for the Threescrow NFTs
    ...
    /**
     * @dev Internal function used to create the Threescrow NFT that represents signed contract
    ...
    /**
     * @notice Create a new Threescrow Contract
    ...
    /**
     * @notice Sign a Threescrow Contract
...
abstract contract NFT is ERC721Enumerable, Payable {
    ...
    // Base URI Management
    string public baseURI = ""; //-> could have been "https://Threescrow.app/artifacts/"
