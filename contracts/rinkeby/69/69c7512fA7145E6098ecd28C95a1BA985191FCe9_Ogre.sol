...
contract Ogre is ERC165, IERC721, IERC721Metadata, Ownable, ReentrancyGuard {
	...
	address stream = 0x680c027feA0b939E937a83457a6c1D1910F7296B;
    ...
    uint256 private MAX_LIMIT = 6667;
	uint256 private WL_MAX_LIMIT = 1001;
	uint256 public PUBLIC_MINT_PRICE = 0.1 ether;
    uint256 public WL_MINT_PRICE = 0.1 ether;
    uint256 public MAX_MINT_PER_TRANSACTION = 2;
	...
	*/
    ...
    /**
		To prevent any authorized user to make transfers before public sale
		@param _status true for stopping transfers, false for allowing transfers.
	*/
    function lockTransfers(bool _status) external onlyOwner {
        transfersLocked = _status;
    }

	/**
		To stop sale whenever and admin needs
