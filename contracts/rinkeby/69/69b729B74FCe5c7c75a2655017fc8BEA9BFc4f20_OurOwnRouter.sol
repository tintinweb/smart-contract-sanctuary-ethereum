                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"31d028218d64e2082677f7de473dca94988e2c31a66c1e6c6c1054c47b1fe91c" // init code hash
                        )
                    )
                )
            )
...
library SafeMathUniswap {
    function add(uint256 x, uint256 y) internal view returns (uint256 z) {
    ...
    function mul(uint256 x, uint256 y) internal view returns (uint256 z) {
