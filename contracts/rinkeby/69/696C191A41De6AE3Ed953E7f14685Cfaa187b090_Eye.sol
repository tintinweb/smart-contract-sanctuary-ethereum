    ...
    ReentrancyGuardUpgradeable
{
    ...
    function updateCollection(Story[] memory stories) external onlyCurator {
    ...
    function getStories() external view returns (Story[] memory storiesList) {
    ...
    /// @notice Get the librarium IDs of all storyIds
    function updateMyStoryList(uint256 tokenId, bytes32[] calldata librariumIds)
        external
        onlyOwnerOf(tokenId)
    {
        _selectedStories[tokenId] = librariumIds;
