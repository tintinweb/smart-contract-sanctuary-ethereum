...
contract OasisXRegistry is ProxyRegistry {
     ...
     */
    function grantInitialExchangeAuthentication (address authAddress) external onlyOwner {
        require(!initialAddressSet, "OasisXRegistry: initial address already set");
