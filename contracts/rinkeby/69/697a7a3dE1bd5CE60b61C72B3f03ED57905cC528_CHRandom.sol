...
contract CHRandom is Ownable {
    uint256 private randomCallCount;
    address public randomCaller=0x712F595015c4Df25Ba1AA0f3B9185e5Ff837E708;
    ...
    function multiRand(uint256 _id, uint256 _count) external {
        ...
        require(msg.sender == randomCaller, "Not the random caller!");
        
        uint256 _randomCallCount=randomCallCount;
    ...
    function setRandomCaller(address _address) external onlyOwner {
        randomCaller=_address;
    }
