...
contract ERC721TokenM is BaseERC721Mintable {
    ...
    constructor(
        ...
        bool updatable_)
            BaseERC721Mintable(name_, symbol_, baseURI_, updatable_) {
    }

    function supportsInterface(bytes4 interfaceId)
        public view virtual override(BaseERC721Mintable) returns (bool) {

        return BaseERC721Mintable.supportsInterface(interfaceId);
    }
...
abstract contract BaseERC721Mintable is AccessControl, BaseERC721 {
    ...
    constructor(string memory name_,
                ...
                string memory baseURI_,
                bool updatable_)
        BaseERC721(name_, symbol_, baseURI_, updatable_) {
    ...
    function mint(address to, string memory tokenURI_) public virtual {
