...
contract PRUEBA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x984D51Da1b0648425F2F4742921C669F10B7076d); // Marketing Address
    ...
    string private _name = "PRUEBA TOKEN";
    string private _symbol = "PUBT";
    ...
    uint256 public maxWalletToken = 250000 * (10**18);
    ...
    function Multisend (address[] calldata addresses, uint amount) public onlyOwner {
