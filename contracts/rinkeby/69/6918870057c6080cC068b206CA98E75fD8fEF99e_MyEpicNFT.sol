...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Ar", "Agua", "Fogo", "Gelo", "Raio", "Terra"];
  string[] secondWords = ["Yugi", "Goku", "Deku", "Dennis", "Shurato", "Seiya"];
  string[] thirdWords = ["Brasao", "Escudo", "Faca", "Cartas", "Espada", "Comida"];
