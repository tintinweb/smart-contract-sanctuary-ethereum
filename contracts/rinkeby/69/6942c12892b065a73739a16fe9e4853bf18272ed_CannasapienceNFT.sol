 ...
 */
contract CannasapienceNFT is ERC721Tradable {
    using Counters for Counters.Counter;

    constructor() ERC721Tradable("Cannasapience", "CNSP", address(0x1E525EEAF261cA41b809884CBDE9DD9E1619573A)) {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "http://cann-nft.zelbov.work/nft_assets/";
    }
    ...
    function setPresaleStartTime(uint256 time) private onlyOwner {
        ...
        PRESALE_START = time;
        PRESALE_END = PRESALE_START + 86400;
    ...
    function mintTokens(uint256 numOfTokens) public payable {
        ...
        if(isPresale()) {
            require(
                ...
                "Mint limit per transaction during presale is 1"
            );
            ...
            require(
                ...
                string(abi.encodePacked(
                    "Direct minting tokens amount exceeded limit of 9 at pre-sale. ",
            ...
            require(
                ...
                "Mint limit per transaction during presale is 3"
            );
            require(
                balanceOf(msg.sender) <= MAX_PUBLIC_SALE_TOKENS_MINT - numOfTokens,
                string(abi.encodePacked(
                    "Direct minting tokens amount exceeded limit of 21 at public sale. ",
                    "Requested ", Strings.toString(numOfTokens), " while got ", Strings.toString(currentBalance)
                ))
            );
