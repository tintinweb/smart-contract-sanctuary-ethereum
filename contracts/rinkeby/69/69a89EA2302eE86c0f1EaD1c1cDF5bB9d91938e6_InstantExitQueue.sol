...
contract TempleStaking is Ownable {
    ...
    function unstake(uint256 _amountOgTemple) external {      
        ...
        SafeERC20.safeIncreaseAllowance(TEMPLE, address(this), unstakeBalanceTemple);
        //  Removed InstantExitQueue
        SafeERC20.safeTransferFrom(TEMPLE, address(this), address(msg.sender), unstakeBalanceTemple);
