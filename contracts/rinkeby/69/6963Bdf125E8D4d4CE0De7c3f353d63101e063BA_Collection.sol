...
contract Collection is ICollectionStruct, Affiliable, ContractMetadata {
    event CollectionSetupComplete(address indexed collectionAddress);
    ...
    function _setup(
        ...
        emit CollectionSetupComplete(address(this));
    }
}
...
contract Presaleable is PaymentSplitable, ICollectionStruct {
    ...
    function setupPresale(
        ...
        if (_presaleStartTime != 0) {
            ...
            emit PresaleSetup(
                _presaleReservedTokens,
                _presalePrice,
                _presaleStartTime,
                _presaleMaxHolding,
                _presaleWhitelist.root,
                _presaleWhitelist.cid
            );
        }
    }
