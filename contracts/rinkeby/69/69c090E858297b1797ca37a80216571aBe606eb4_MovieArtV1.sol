    ...
    MovieArtPausableUpgradeable
{
    ...
    */ 
    ...
    function __MovieArt1155_init(string memory tokenMetadataURI, string memory contractMetadataURI) public initializer {
        __MovieArt1155_init_unchained(tokenMetadataURI, contractMetadataURI);
    }

    function __MovieArt1155_init_unchained(string memory tokenURI, string memory contractURI_) internal initializer {
    ...
    function mintLDAToUser(address user, uint256 ldaID, bytes calldata data) public onlyOwner whenNotPaused {
    ...
    /**
    @dev New added
    @dev Compose a tierID and tokenID to ldaID
     */
    function composeLDA_ID(
        uint128 tierID,
        uint128 tokenID
    ) public pure virtual returns (uint256 ldaID){
        require(tierID != 0 && tokenID != 0, "Invalid ldaID");
        ldaID = uint256(tierID * 2**128) + tokenID;
        return ldaID;
    }
...
contract MovieArtPausableUpgradeable is
    ...
    function __MovieArtPausableUpgradeable_init_unchained() internal initializer {
        __Pausable_init();
        __Ownable_init();
    }
