...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string constant baseURI = "ipfs://QmbwHUGyYs8nfhg5jJV1ZNa7zYjSVPvAMVTi8m7C3Hxk2f/";
    string constant uriSuffix = ".json";

    /*
     * Enforce the existence of only 100 OpenSea creatures.
     */
    uint256 CREATURE_SUPPLY = 420;
    ...
    function tokenURI(uint256 _optionId) override external pure returns (string memory) {
        return string(abi.encodePacked(baseURI, Strings.toString(_optionId),uriSuffix));
    }
...
contract Creature is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("MultiTest", "MTT", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "ipfs://QmQanbuVYFP8pCmWmcSmaA7kJHBp19PjmsaAabn2JhWd8e/";
    }

    function contractURI() public pure returns (string memory) {
        return "ipfs://QmQanbuVYFP8pCmWmcSmaA7kJHBp19PjmsaAabn2JhWd8e/1.json";
    }
}
