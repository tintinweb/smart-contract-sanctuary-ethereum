...
contract RoboPunksNFT is ERC721, Ownable {
    ...
    function setMaxSupply(uint256 maxSupply_) external onlyOwner {
        require(totalSupply == maxSupply, 'NFT not sold out!');
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(walletMints[msg.sender].add(quantity_) <= maxPerWallet, 'exceed max wallet');
        require(totalSupply.add(quantity_) <= maxSupply, 'sold out');
