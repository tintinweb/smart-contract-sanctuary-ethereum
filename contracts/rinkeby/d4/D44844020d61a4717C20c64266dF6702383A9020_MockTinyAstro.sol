...
contract MockTinyAstro is ERC165, IERC721, IERC721Metadata {
    ...
    function airdrop(address to, uint8 quantity) external {
    ...
    function airdrop2(address[] calldata wallets) external {
        require(msg.sender == _owner, "Caller is not the owner");
