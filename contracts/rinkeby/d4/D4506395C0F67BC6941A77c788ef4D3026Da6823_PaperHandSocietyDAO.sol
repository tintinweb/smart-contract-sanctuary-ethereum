...
contract PaperHandSocietyDAO is ERC721AEnumerable, Payable {
    ...
    // Public
    uint256 public constant PUBLIC_ALLOWANCE_P1 = 6;

    // Presale
    uint256 public constant PRESALE_ALLOWANCE_P1 = 11;
     ...
     */
    function allowance(address addr) public view returns (uint256) {
        if (contractState == ContractState.PRESALE) {
            return PRESALE_ALLOWANCE_P1 - _numberMinted(addr) - 1;
        } else if (contractState == ContractState.PUBLIC) {
            return PUBLIC_ALLOWANCE_P1 - _numberMinted(addr) - 1;
        }
        return 0;
    }
}
