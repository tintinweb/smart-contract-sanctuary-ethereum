...
contract RuneApes is ReentrancyGuard, Ownable, ERC721A{
    ...
    address payable private navi = payable(0x1215e48C797fde86A2A7fCE096D256517714f5b8);  // navi private rinkeby
    ...
    constructor(bytes32 _merkleRoot) ERC721A("RuneApes", "RuneApes", 10, 1000){
        ...
        _prefixURI = "ipfs://QmT7bKDvXKcfA8RMfB2J1uPNoPDo4WsxvWPLLMqvbrZBJG/";
    }
    ...
    function withdraw() external onlyOwner {
       ...
       sendFund(navi, address(this).balance);
