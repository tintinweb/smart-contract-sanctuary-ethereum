    ...
    ERC721EnumerableUpgradeable
{
    ...
    modifier onlyMintable(uint256 quantity) {
    ...
    function mint(uint256 quantity) public payable onlyMintable(quantity) {
    ...
    function _purchaseMint(uint256 quantity, address to) internal {
