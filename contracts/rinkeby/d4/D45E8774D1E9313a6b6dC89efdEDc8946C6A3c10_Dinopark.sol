 ...
 * {_setRoleAdmin}.
 *可以通过 {grantRole} 和 {revokeRole} 函数动态授予和撤销角色。
 每个角色都有一个关联的管理员角色，只有拥有角色管理员角色的帐户才能调用 {grantRole} 
 和 {revokeRole}。默认情况下，所有角色的管理员角色都是“DEFAULT_ADMIN_ROLE”，
 这意味着只有具有该角色的帐户才能授予或撤销其他角色。
 使用 {_setRoleAdmin} 可以创建更复杂的角色关系。
...
contract Dinopark is ERC20, AccessControl {
    ...
    */
    string public constant NAME = 'DINOPARK';
    string public constant SYMBOL = 'Saur';
    uint8 public constant DECIMALS = 18;
    uint public constant MAX_SUPPLY = 230000000*(10**DECIMALS);
    ...
    */
    ...
    // *******************************************************
    function approve(address spender, uint256 amount) public virtual override returns (bool) {      
        require(!isBlacker(spender), "The spender is in Blacklist, cannot approve");
        return super.approve(spender, amount);
    }
    function increaseAllowance(address spender, uint256 addedValue) public virtual override returns (bool) {
        require(!isBlacker(spender), "The spender is in Blacklist, cannot increaseAllowance");
        return super.increaseAllowance(spender,addedValue);
    }
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual override returns (bool) {
        require(!isBlacker(spender), "The spender is in Blacklist, cannot decreaseAllowance");
...
// *********************************************
    ...
    */
    function changeAdmin(address newadmin)
        ...
        virtual
    {
        // require(newadmin != address(0), "CANNOT change admin to ZERO address");
    ...
    */
        ...
        virtual
    {
        ...
        // require(preSupply >= MAX_SUPPLY, "Mint stop by over max supply");
        require(preSupply <= MAX_SUPPLY, "Mint stop by over max supply");
    ...
    */
    function addBlacklist(address account) external virtual {
    ...
    */
    function removeBlacklist(address account) external virtual {
    ...
    */
    function isBlacker(address account) public virtual view returns (bool) {
