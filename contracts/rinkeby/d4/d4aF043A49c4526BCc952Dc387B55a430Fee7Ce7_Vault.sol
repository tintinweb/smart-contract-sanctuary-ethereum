...
contract Vault is ReentrancyGuardUpgradeable,OwnableUpgradeable {
  ...
  struct Staker {
    ...
    function Stake(uint256 amount) external {
        ...
        require(Crucible(TOKEN).transferFrom(msg.sender, address(this), amount),'Unable to transfer your tokens to this contract');
        ...
        Crucible(REWARD_TOKEN).mint(stakers[msg.sender].addr,amount);
