    ...
    BaseCollection
{
        ...
        nonReentrant
    {
        ...
        require(amount >= auction.reservePrice, "Lower than reserve price");
        require(
            auction.startedAt == 0 ||
        ...
        if (
            auction.startedAt.add(auction.duration).sub(block.timestamp) <
            timeBuffer
        ) {
        ...
        nonReentrant
    {
        ...
        Address.sendValue(payable(auction.creator), auction.amount - fees);
