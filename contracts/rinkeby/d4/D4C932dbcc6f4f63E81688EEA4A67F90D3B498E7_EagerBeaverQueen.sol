...
contract EagerBeaverQueen is ERC721Enumerable, Ownable {
    ...
    bytes32 public _merkleRoot =
        0x9caa96130f927aa2ea98eb9ed715b878b1c88dbb67408d22db56996b7ec60b53;
    ...
    string _unrevealedURI =
        "https://gateway.pinata.cloud/ipfs/QmRqwMoAArWmrCjrQYJJ6T6t5dGkXaNMrGaNhybNBGxygo/EB0322_hidden.json";
    ...
    // max number of EagerBeaverQueens
    uint256 public maxTokenIds = 500;

    // timestamp to keep track of if presale started
    uint256 public timeToStartPresale = block.timestamp + 3 minutes;

    // timestamp for when presale would end
    uint256 public timeToEndPresale = block.timestamp + 10 minutes;
     ...
     * name in our case is `EagerBeaverQueen` and symbol is `EB`.
     */
        ...
        onlyWhenHasNotMintedForCreators
    {
        ...
        _safeMint(0x0c1416fD78d2575Ee5758B1932c9C6Cc62E5181e, tokenId);
    }
        ...
        returns (uint256)
    {
        ...
        require(
            ...
            "Exceeded maximum Eager Beaver supply"
        );
        require(
