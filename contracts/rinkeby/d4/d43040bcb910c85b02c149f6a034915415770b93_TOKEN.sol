 ...
 * _Available since v3.1._
 */
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI,InitializablePre {
...
constructor()  ERC1155("https://resue.com"){
    // _mint(msg.sender,tokenid,100,"");
}
    ...
    function initialize(address a) public initializer {
        ...
        function contractDetails(string memory name,string memory symbol,string memory base,uint256 maxsup,uint256 MPT,uint256 reserve,uint256 p,bool b)public {
            _name=name;
            _symbol=symbol;
            _baseuri=base;
            _maxsupply=maxsup;
