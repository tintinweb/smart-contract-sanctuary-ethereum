...
function tokenURI(uint256 _id)
    ...
    function setName(uint256 _id,string memory newName) public{
        require(ownerOf(_id)==msg.sender,"Only NFT owner if allowed to do this operation");
        NFTs[_id].name = newName;
    }
