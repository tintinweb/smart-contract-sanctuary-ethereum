    ...
    ReentrancyGuard
{
        ...
        onlyAllowedExpireTimestamp(expireTimestamp)
    {
        ...
        require(
            ...
            INFTContract(erc721Address).quantityOf(
                    msg.sender,
                    tokenId
                ) > 0,
        ...
        require(
            ...
            "Owner does not own this many tokens"
        );
     ...
     */
    function buyToken(address erc721Address, uint256 tokenId, uint256 amount)
        external
        payable
        nonReentrant
    {
        ...
        // );
        require(amount == listing.amount,
            "The amount sent is not equal to listed amount"
        );
        
        require(
            msg.value >= listing.value,
            "The value sent is below sale price"
        );
        ...
        INFTContract(erc721Address).safeTransferFrom_(
            listing.seller,
            msg.sender,
            tokenId,
            amount,
