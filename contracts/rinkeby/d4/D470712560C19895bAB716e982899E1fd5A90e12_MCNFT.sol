...
contract MCNFT is ERC721Psi, VRFConsumerBaseV2, ReentrancyGuard, EIP712Whitelisting, ERC2981ContractWideRoyalties {
    ...
    uint256 public privatePrice = 0.08 ether; // 0.08 ether; mainnet
    uint256 public publicPrice = 0.098 ether; // 0.098 ether; mainnet
    uint256 public airdropAmount = 200;
    uint256 public airdropMinted = 0;
    uint private maxMintPerAddress = 2; // 2; mainnet
    ...
    // TODO update hash sha256 on mainnet
