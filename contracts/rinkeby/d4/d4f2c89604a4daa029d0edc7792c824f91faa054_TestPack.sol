...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://QmeiJqwrrVK3pe5gjGhiH4BqUcpUijzkTrLy2n57Bk2GmU/"; // IPFS base for ParkPics collection
...
contract TestPack is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmfWTtBxxE4cd14LNtvQ2cZn1hc7WxkUbiiZML4M3Scw4x"; // Contract-level metadata for ParkPics
    }
}