...
contract ThePotatoz is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        uint256 _maxFreeMintPerAddr,
        uint256 _maxFreeMintSupply,
        string memory __hiddenURI,
        string memory __baseURI
    ) ERC721A("The Potatoz", "PTT") {
        maxSupply = _maxSupply;
        mintPrice = _mintPrice;
        maxMintPerTx = _maxMintPerTx;
        maxFreeMintPerAddr = _maxFreeMintPerAddr;
    ...
    function setMaxFreeMintPerAddr(uint256 amount) external onlyOwner {
        maxFreeMintPerAddr = amount;
    }

    function setFreeAmount(uint256 amount) external onlyOwner {
        maxFreeMintSupply = amount;
    }
