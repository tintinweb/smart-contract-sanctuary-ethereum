...
contract NoName is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 50_000 * 10**18;
    ...
    constructor() {
        _marketingWalletAddress = payable(
            0xC5D46410882beB369dadDCf1719890A25615DaA0
        );
        _triggerWhitelistManager = 0xC5D46410882beB369dadDCf1719890A25615DaA0;
    ...
    function _tokenTransfer(
        ...
        if (takeFee == true && recipient == uniswapV2Pair) {
            _taxFee = _sellTaxFee;
        ...
        if (takeFee == true && recipient == uniswapV2Pair) restoreAllFee();
    }
