 ...
 *
 */
contract EsportsToken is ERC20Mintable, AntiBotHelper, FeeHelper {
...
contract AntiBotHelper is Ownable {
    ...
    uint256 public _txLimit = 100000 ether;
    uint256 public _holdLimit = 10000000 ether;
 ...
 *
 */
contract ERC20Mintable is ERC20, Operatable {
    constructor(string memory name_, string memory symbol_)
        ERC20(name_, symbol_)
    {}
    ...
    function mintTo(address account, uint256 amount) external onlyOperator {
