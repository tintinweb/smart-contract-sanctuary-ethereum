...
contract New is ERC1155 {

  enum SaleStatus { CLOSED, PRESALE, PUBLIC }
  uint256 public premiumcost = 0.08 ether;
  uint256 public platinumcost = 0.4 ether;
  ...
  modifier mintable(uint256 _id) {
    require(_id < 3, "Invalid token ID");
    require(amountsLeft[_id - 1] > 0, "All tokens with this ID were already minted");
    _;
  }

  function mintPresale() external onlyExternal mintable(1) {
