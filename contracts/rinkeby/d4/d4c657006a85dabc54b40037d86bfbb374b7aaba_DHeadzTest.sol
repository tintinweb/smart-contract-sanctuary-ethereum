...
contract DHeadzTest is ERC721A("DHeadz-test1", "DHz1"), Whitelist, RewardDistributor {
  ...
  uint immutable public LOCK_7d = 3 minutes;
  uint immutable public LOCK_6mo = 5 minutes;
  uint immutable public LOCK_12mo = 7 minutes;
