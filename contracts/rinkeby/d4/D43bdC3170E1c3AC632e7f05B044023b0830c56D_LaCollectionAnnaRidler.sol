 ...
 */
contract LaCollectionAnnaRidler is ERC721URIStorage, Pausable, LaCollectionAccess {
    ...
    constructor() ERC721("LaCollection-AnnaRidler", "LCAR") {
    }
    ...
    function setTokenURI(string memory _tokenURI) external whenNotPaused onlyMinter {
        super._setTokenURI(1,  _tokenURI);
    }
    
    //  function burn(uint256 tokenId) public override whenNotPaused onlyMinter {
    //      super._burn(tokenId);
    //  }
