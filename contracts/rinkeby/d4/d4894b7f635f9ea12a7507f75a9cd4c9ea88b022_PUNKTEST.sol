...
contract PUNKTEST is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public FREE_HOLDERS_ALLOWED = 1; // maximam amount that user can mint/Transaction
  uint256 public TOKEN_NUMBER = 4444; // maximam amount that user can mint/Transaction
  ...
  uint256 private FirstPhaseCollectionSize_ = 4444; // total number of nfts

  uint256 public PRICE = 0.06 ether; 
  string private _baseTokenURI;
  string private second_baseTokenURI;

  uint public status = 0; //0-pause 1-Free 2-Whitelist 3-Public 4-Phase2nd
 
  constructor() ERC721A("PUNK TEST","PT") {
  ...
  function mint(uint256 quantity) external payable callerIsUser {
    ...
    require(totalSupply() + quantity <= FirstPhaseCollectionSize_, "reached max supply");
  ...
  function airdrop(address sendTo, uint quantity)public onlyOwner{
    ...
    uint256 private TotalWLavailable = 4444; // total number of nfts
    ...
    // function FREEpurchaseWhiteListTokens(uint256 _howMany) external payable {
