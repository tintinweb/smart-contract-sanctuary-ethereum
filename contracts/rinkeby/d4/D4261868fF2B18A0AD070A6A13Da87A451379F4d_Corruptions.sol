    ...
    OwnableUpgradeable
{
    ...
    */
    ...
    modifier canWhiteListMint(uint256 _quantity) {
        ...
        require(isPublicSale == false, "Sale is in public");
        _;
    }
        ...
        isOrigin
    {
        ...
        // call anomura mint() from Anomura Contract
        anomuraContract.mintMultiple{value: msg.value}(msg.sender, _tokenArray);
    ...
    */
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64Upgradeable.encode(
            bytes(
                string(abi.encodePacked("{\"name\": \"Bowl #", StringsUpgradeable.toString(_tokenId), "\", \"image\":\"", bowlImage, "\", \"Can Summon Anomura\":\"", bowls[_tokenId], "\"}"))
                )
        );
