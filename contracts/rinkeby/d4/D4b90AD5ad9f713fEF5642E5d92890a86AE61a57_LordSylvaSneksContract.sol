...
//    / /   ____  _________/ /  / ___/__  __/ /   ______ _   / ___/____  ___  / /_______
//   / /   / __ \/ ___/ __  /   \__ \/ / / / / | / / __ `/   \__ \/ __ \/ _ \/ //_/ ___/
//  / /___/ /_/ / /  / /_/ /   ___/ / /_/ / /| |/ / /_/ /   ___/ / / / /  __/ ,< (__  ) 
// /_____/\____/_/   \__,_/   /____/\__, /_/ |___/\__,_/   /____/_/ /_/\___/_/|_/____/  
//                                 /____/                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x137138dE276F9b72045Db1ACec1925Cd07216c99];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmeAjZBdBFXc7N1w1j1Jv6ooToWxtt9snd6ERgt3UszZZc/";
...
// File: contracts/LordSylvaSneksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LordSylvaSneksContract is RamppERC721A {
    constructor() RamppERC721A("Lord Sylva Sneks", "SNEKS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/X4Ug1VJxqHxFxWFbtyAg/contract-metadata";
    }
}
