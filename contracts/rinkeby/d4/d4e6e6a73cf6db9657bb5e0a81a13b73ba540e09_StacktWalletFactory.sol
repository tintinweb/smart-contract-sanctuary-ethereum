...
import "./proxies/StacktWalletProxyFactory.sol";
...
contract StacktWalletFactory {
    ...
    StacktWalletProxyFactory internal proxyFactory = StacktWalletProxyFactory(0xec8A2EeB4D6ce0021a45221f797347f1106F42B1);   ///
    address constant stacktWalletSingletonAddress = 0xB5502dA32c60E28ECd828Ff8B9fbF15EF0BC2Dd4; ///
    ...
    function createWallet(
        ...
        // setup data
        bytes memory setupData = abi.encodeCall(StacktWallet.setup, (
            StacktWallet.StacktWalletSetup({
                ...
                fundPrice: fundPrice, 
                funderLimit: funderLimit
            }), 
            stacktSetup.to, 
            stacktSetup.data, 
            stacktSetup.fallbackHandler, 
            stacktSetup.paymentToken, 
            stacktSetup.payment, 
            stacktSetup.paymentReceiver, 
            controllerGuardAddr
        ));
    ...
    StacktGuardManager
{
    ...
    struct StacktWalletSetup { string name; string description; string profilePicture; address msgSender; uint256 startFundingTime; uint256 fundingDuration; uint256 fundPrice; uint256 funderLimit; }
    ...
    function setup(
        ...
        profilePicture = stacktSetup.profilePicture;
    ...
    function setProfilePicture(string calldata _profilePicture) external authorized {
