...
contract TurfShop is ERC1155, ERC1155Supply, Ownable, AccessControl, ReentrancyGuard {
  ...
  */
  ...
  function setIsOpenSeaProxyActive(bool isOpenSeaProxyActive_) external onlyAdmin {
    isOpenSeaProxyActive = isOpenSeaProxyActive_;
  }

  function setOpenSeaProxyProxyAddress(address addr) external onlyAdmin {
