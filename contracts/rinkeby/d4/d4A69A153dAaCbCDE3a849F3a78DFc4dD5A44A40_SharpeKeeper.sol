...
contract SharpeKeeper is KeeperCompatibleInterface{
    ...
    address public keeper = 0x409CF388DaB66275dA3e44005D182c12EeAa12A0;

    constructor(uint updateInterval) public{
        interval = updateInterval;
        lastTimeStamp = block.timestamp;
    }
    //parsing arguments into a function creates a kind of field to input value or values
    //leaving the argument bracket empty removes the input field and just runs the function code
    function addcount(uint256 value) internal{
    ...
    function performUpkeep(bytes calldata performData) external override{
        lastTimeStamp = block.timestamp;
        addcount(13);
        // (rebalance.call(abi.encodeWithSignature("addcount(uint256)", 3));
    }    
