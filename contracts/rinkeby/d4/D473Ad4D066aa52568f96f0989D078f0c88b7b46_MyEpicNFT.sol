...
contract MyEpicNFT is ERC721URIStorage {
   ...
   string[] firstWords = ["compromise", "tin", "loud", "earthwax", "dose", "include", "grand", "wrap", "evaluate", "frown"]; 
   string[] secondWords = ["cruelty", "agent", "texture", "tired", "registration", "shortage", "reconcile", "musical", "blow", "harass", "endure"];
   string[] thirdWords = ["variant", "slippery", "breakfast", "soldier", "liberty", "perceive", "coat", "ambiguous", "care"];
