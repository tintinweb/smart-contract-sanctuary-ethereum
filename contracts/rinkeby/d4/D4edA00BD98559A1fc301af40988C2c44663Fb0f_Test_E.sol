...
//TODO: remove all testing methods added for fixing price and urls.
/**
 * @title Test_E
 */
contract Test_E is ERC721, Ownable {
        ...
        returns (string memory)
    {
        if (is_collection_revealed == true) {
            ...
            // https://ipfs.io/ipfs/Qm....../ + 0 + .json
            return string(abi.encodePacked(contract_base_uri, _tknId, ".json"));
        } else {
            // https://ipfs.io/ipfs/Qm...../unrevealed.json
    ...
    function revealCollection(bool reveal) public onlyOwner {
        is_collection_revealed = reveal;
    }
    ...
    */
    function buyNFT(address recipient,bytes32[] calldata _merkleProof) public payable {
        ...
        require(
            ...
            string(abi.encodePacked("Amount should be at least 1 and must be less or equal to ", Strings.toString(MAX_AMOUNT)))
        );
        require(balanceOf(recipient) < MAX_AMOUNT ,'user nft minted limit exceeded error');
     ...
     /*
        This method will allow owner to fix the not revealed nft address
    */
    function fixNotRevealednft(string memory newNFT) external onlyOwner {
        require(!is_collection_locked, "Collection locked");
