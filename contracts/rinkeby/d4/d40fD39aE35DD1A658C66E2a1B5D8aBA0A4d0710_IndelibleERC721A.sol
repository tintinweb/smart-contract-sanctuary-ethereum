// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint256 private constant NUM_LAYERS = 2;
        uint256 private constant MAX_BATCH_MINT = 20;
        uint256[][NUM_LAYERS] private TIERS;
        string[] private LAYER_NAMES = [unicode"Skin", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Test", unicode"Test", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/43a0b451-1ccd-4803-b9f7-1f9bed79da55", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/43a0b451-1ccd-4803-b9f7-1f9bed79da55", "", 0, "0xEA208Da933C43857683C04BC76e3FD331D7bfdf7");

        constructor() ERC721A(unicode"Test", unicode"TEST") {
            TIERS[0] = [137,138,725];
TIERS[1] = [3,16,21,24,29,42,53,62,71,78,293,308];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Test #");
