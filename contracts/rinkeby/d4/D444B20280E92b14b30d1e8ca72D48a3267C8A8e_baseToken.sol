...
contract baseToken is ERC20, ReentrancyGuard, Ownable {
    ...
    function getUserBalance(address user) public view returns (uint256) {
        return (stakingSource.getAccumulatedAmount(user) + depositedAmount[user] - spentAmount[user]);
    }
    ...
    function transferBaseToken(address to, uint256 amount) public nonReentrant whenNotPaused {
    ...
    function spendBaseToken(address user, uint256 amount) external onlyAuthorised nonReentrant {
    ...
    function depositBaseTokenMulti(address[] memory user, uint256[] memory amount) public onlyAuthorised nonReentrant {
    ...
    function depositBaseToken(address user, uint256 amount) public onlyAuthorised nonReentrant {
    ...
    function mintBaseTokenFor(address user, uint256 amount) external onlyAuthorised nonReentrant {
    ...
    function claimBaseTokenTax(address user, uint256 amount) public onlyAuthorised nonReentrant {
