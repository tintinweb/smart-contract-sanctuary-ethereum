...
contract MikeTest4 is ERC721A, Ownable, ReentrancyGuard {
  ...
  bool public phase3AllowListEnabled = false;
  ...
  function allowListMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    // Verify allowlist requirements
		if (phase3AllowListEnabled) {
			require(!phase3AllowListClaimed[_msgSender()], 'Address already claimed!');
			bytes32 leaf = keccak256(abi.encodePacked(_msgSender()));
			require(MerkleProof.verify(_merkleProof, phase3MerkleRoot, leaf), 'Invalid proof!');
			
			phase3AllowListClaimed[_msgSender()] = true;
		} else if (phase2AllowListEnabled) {
  ...
  function setPhase1MerkleRoot(bytes32 _merkleRoot) public onlyOwner {
	...
	function setPhase3MerkleRoot(bytes32 _merkleRoot) public onlyOwner {
    phase3MerkleRoot = _merkleRoot;
  }
  ...
  function setPhase1AllowListMintEnabled(bool _state) public onlyOwner {
	...
	function setPhase3AllowListMintEnabled(bool _state) public onlyOwner {
    phase1AllowListEnabled = false;
    phase2AllowListEnabled = false;
    phase3AllowListEnabled = _state;
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
		...
		// Split account 1
    (bool success1, ) = payable(0x888716d80fE8A91d17D25D8fb3aC6B258f136F15).call{value: beforeBalance * 5 / 100}('');
    require(success1);

		// Split account 2
    (bool success2, ) = payable(0x504b36e24ce938e86fF1A671dAdED0020f225d6b).call{value: beforeBalance * 5 / 100}('');
    require(success2);
