...
// File: nft.sol
    ...
    contract TESTXOXO is Ownable, ERC721A {
    uint256 public maxSupply                    = 10;
    uint256 public maxFreeSupply                = 4;
    uint256 public maxPerTxDuringMint           = 2;
    uint256 public maxPerAddressDuringMint      = 5;
    uint256 public maxPerAddressDuringFreeMint  = 2;
    uint256 public price                        = 0.002 ether;
    bool    public saleIsActive                 = true;

    address constant internal TEAM_ADDRESS = 0x0Ec08145F8f6E413efb56AFf12333D117a1e3b3f;

    string private _baseTokenURI;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("TEXTXOXO", "TXOXO") {_safeMint(msg.sender, 2);}
