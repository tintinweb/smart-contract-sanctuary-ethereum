...
contract RockyInu is ERC721Enumerable, Ownable {
    ...
    uint64 public cost = 0.005 ether; // to be updated
    uint64 public maxSupply = 10000;
    uint256 public maxMintWhitelisted = 2;
    ...
    //Constructor
    constructor() ERC721("Rocky Inu", "ROCKY") {
        _safeMint(msg.sender, 1);
        _ownerTokens[msg.sender].push(1);
    }
    ...
    function mintNFT(uint256 _mintNum) public payable {
        ...
        if (normalSaleIsActive) {
            ...
            require(
                _isWhiteListed[msg.sender] - _mintNum >= 0,
    ...
    function giveAway(address _user, uint256 _mintNum) public onlyOwner {
        ...
        for (uint256 i = 1; i <= _mintNum; i++) {
            ...
            _ownerTokens[_user].push(supply + i);
        }
    }
