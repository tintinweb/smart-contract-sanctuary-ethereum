...
contract TAKTIKQQQ is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TAKTIKQQQ", "TKTQ") {
    setHiddenMetadataUri("ipfs://QmW41PkipYZGirAz7b63toPyBDgYb2dfZRMXtUU2rczCdm/unreveal.json");
  }
