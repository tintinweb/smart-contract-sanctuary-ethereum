...
contract ApeKidsFC is ERC721, Ownable {
  ...
  uint256[] public stagePrice = [0, 0.16 ether, 0.16 ether, 0.08 ether,0.08 ether, 0.16 ether];  //price for each stage
  uint256[] public stageLimit = [0, 2000, 2000, 11999, 11999, 11999];    //mint limit for each stage
  ...
  //withdraw
  address[] fundRecipients = [address(0x261D83Bb62b54B4eBEAe76195b13d190e292e22f), address(0xe778d58088967D9F62874f493Dd374266Dba248D)];
