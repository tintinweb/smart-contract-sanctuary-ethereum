...
contract RYU is ExtendedReflections {
    ...
    uint256 private _highTaxCooldown = 24 hours;

    uint32 private _taxDecimals = 0;
    uint32 private _decimals = 18;

    uint256 private _minTokensBeforeSwap = 10_000_000_000 * (10 ** _decimals);

    uint256 private _maxBuyAmount = 5_000_000_000_000 * (10 ** _decimals);
    uint256 private _maxSellAmount = 3_000_000_000_000 * (10 ** _decimals);
    uint256 private _maxWalletAmount = 10_000_000_000_000 * (10 ** _decimals);
    ...
    constructor (address _marketingAddress) ExtendedReflections("Ryutest", "RYU", _decimals, _tokenSupply) {
