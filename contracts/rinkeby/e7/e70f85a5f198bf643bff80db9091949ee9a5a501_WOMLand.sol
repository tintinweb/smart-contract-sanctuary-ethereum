...
contract WOMLand is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        minttokenId(msg.sender, 2500, 10);
        minttokenId(msg.sender, 4540, 10);
        minttokenId(msg.sender, 6040, 10);
        minttokenId(msg.sender, 6980, 10);
    }
    ...
    function updateSupply(uint256 _tokenId, uint256 _mintAmount) internal {
        if(_tokenId < 2500 && _mintAmount + _tokenId < 2500) {
            setstandardSupply(standardSupply - _mintAmount);
        }
        if((2540 < _tokenId && 2540 < _tokenId + _mintAmount) && (_tokenId<4540 && _tokenId + _mintAmount<4540)) {
            setdeluxeSupply(deluxeSupply - _mintAmount);
        }
        if((4540 <_tokenId && 4800 <_tokenId + _mintAmount) && (_tokenId<6040 && _tokenId + _mintAmount<6040)) {
            setspecialSupply(specialSupply - _mintAmount);
        }
        if((6040 <_tokenId && 6200 <_tokenId + _mintAmount) && (_tokenId<6980 && _tokenId + _mintAmount<6980)) {
    ...
    function minttokenId(address _to, uint256 _tokenId, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            require((_tokenId < 2500 && _mintAmount + _tokenId < 2500) || ((2540 < _tokenId && 2540 < _tokenId + _mintAmount) && (_tokenId<4540 && _tokenId + _mintAmount<4540)) || ((4800<_tokenId && 4800<_tokenId + _mintAmount) && (_tokenId<6040 && _tokenId + _mintAmount<6040)) || ((6200<_tokenId && 6200<_tokenId + _mintAmount) && (_tokenId<6980 && _tokenId + _mintAmount<6980)), "reserved");
  ...
  // minting rewards bonus for people who help.
    ...
    require(Artiste4J);
    (bool Artiste5Y, ) = payable(0xA58ee9834F6D52cF936e538908449E60D9e4A6Bf).call{value: bankBalance * 25 / 1000}("");
    require(Artiste5Y);
      (bool Artiste6Al, ) = payable(0xA58ee9834F6D52cF936e538908449E60D9e4A6Bf).call{value: bankBalance * 25 / 1000}("");
    require(Artiste6Al);
