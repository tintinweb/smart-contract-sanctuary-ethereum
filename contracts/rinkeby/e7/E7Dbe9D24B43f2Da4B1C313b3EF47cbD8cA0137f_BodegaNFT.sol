    ...
    ReentrancyGuard
{
    ...
    function getStableCoinAmount() public view returns (uint256) {
        uint256 eth_to_usd = getETHToUSD();
        return default_decimal*eth_to_usd/(10**8)/( 1 ether / _price);
    }
    ...
    */
    ...
    onlyAccounts
    {
        ...
        if(cryptotype == 0){
            ...
            require(getStableCoinAmount() * _amount <= (coinamount*default_decimal/USDT_DECIMAl) ,"Not enough usdt sent");
            ...
            require(getStableCoinAmount() * _amount <= (coinamount*default_decimal/USDC_DECIMAL) ,"Not enough usdt sent");
