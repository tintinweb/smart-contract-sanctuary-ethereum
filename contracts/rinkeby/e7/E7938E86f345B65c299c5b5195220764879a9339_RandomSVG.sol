...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase {
    ...
    event CreateUnfinishedRandomSVG(uint256 indexed tokenId, uint256 indexed randomNumber);
    ...
    constructor(address _VRFCoordinator, address _linkToken, bytes32 _keyHash, uint256 _fee)
     ...
     ERC721("RandomSVG","rSvg") {
        ...
        size=500;
        pathCommads=["M","L"];
        pathColors=["red","blue", "green", "yellow"];
    ...
    function generateSVG(uint256 _randomNumber) public view  returns (string memory finalSVG) {
        ...
        finalSVG = string("<svg xmlns='http://www.w3.org/2000/svg' height='500' width='500'>");
    ...
    function generatePath(uint256 _randomNumber) public view returns (string memory pathSvg) {
        ...
        pathSvg = string(abi.encodePacked(pathSvg,"style='fill:'",color,"'/>"));
    }


    function generatePathCommands(uint256 _randomNumber) public view returns (string memory pathCommand) {
        pathCommand = pathCommads[_randomNumber % pathCommads.length];
    ...
    function formatTokenURI(string memory _imageURI) public pure  returns (string memory) {
       ...
       Base64.encode(bytes(abi.encodePacked('{"name": "Random SVF NFT", "description": "Description of my Random generate NFT", "attributes":"", "image":"',_imageURI,'"}')))));
    }
