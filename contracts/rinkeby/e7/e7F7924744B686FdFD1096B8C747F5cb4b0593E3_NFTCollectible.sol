...
contract NFTCollectible is ERC721Enumerable, Ownable {
    ...
    mapping(bytes => address) public signatureToAddress;
    ...
    function preSale(
        ...
        require(
            _count > 0 &&
                _count <= (preSaleMaxMint - NFTmintedbyAddress[msg.sender]),
        ...
        require(
            signatureToAddress[signature] == address(0) ||
                signatureToAddress[signature] == msg.sender
        );
    ...
    function publicMintNFTs(uint256 _count) public payable {
        uint256 totalMinted = _tokenIds.current();
