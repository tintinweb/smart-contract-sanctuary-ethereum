...
contract Robots is Ownable, ERC721 { 


    uint256 public totalSupply;
    uint256 public maxSupply = 7; // 5000 in actual %%%%%

    uint256 public cost = 0.00001 ether; // 0.15 in actual %%%%
    ...
    ) ERC721("Robots", "BOTS") { // change name and symbol
