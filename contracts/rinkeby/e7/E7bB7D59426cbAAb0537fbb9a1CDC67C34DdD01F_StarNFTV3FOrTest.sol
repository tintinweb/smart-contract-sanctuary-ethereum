...
contract StarNFTV3FOrTest is ERC721, IStarNFT, Ownable {
    /* ============ Events ============ */
    ...
    /* ============ External Functions ============ */
    function mint(address account, uint256 cid) external override onlyMinter returns (uint256) {
        _starCount++;
    ...
    function burnBatch(address account, uint256[] calldata ids) external override onlyMinter {
        for (uint256 i = 0; i < ids.length; i++) {
