...
contract CryptoPunks is ERC721, Ownable, ReentrancyGuard {
  ...
  uint256 public FREE_MINTS_UNTIL = 500;
  uint256 public MAX_FREE_MINTS_PER_WALLET = 10;
  bool public PAUSED = false;
  bool public REVEALED = false;

  constructor(
    string memory hiddenMetadataUri
  ) ERC721("CryptoPunks", "CPUNKS") {
