...
contract BIT is ERC721ARoyalty, Ownable, ReentrancyGuard {
    ...
    function isPublicSaleValid(bytes calldata sig)
        internal
        view
        returns (bool)
    {
        ...
        onlyEOA
    {
        ...
        require(
            msg.value == salePriceETH * qty,
            "PublicSale: Insufficient ETH"
        );
    ...
    function setMintList(bytes32 merkleRootHash) external onlyOwner {
        require(
            ...
            "MintList MerkleRoot is Already Set the Same!"
        );
        merkleRoot = merkleRootHash;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        require(
            balance > 0 || balanceAPE > 0,
            "Withdraw: Insufficient ETH or APE"
        );
        bool success;
        if (balance > 0) {
    ...
    // set RoyaltyFee
    function setTokenRoyaltyFee(uint256 value) external onlyOwner {
