...
//*********************************************************************//
//
//    _____ __ ____  ____    __    _________________
//   / ___// //_/ / / / /   / /   / ____/_  __/ ___/
//   \__ \/ ,< / / / / /   / /   / __/   / /  \__ \ 
//  ___/ / /| / /_/ / /___/ /___/ /___  / /  ___/ / 
// /____/_/ |_\____/_____/_____/_____/ /_/  /____/  
//                                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x75FA1F64D15ee2969236b6908E09257f17282D85];
...
// File: contracts/SkulletsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SkulletsContract is RamppERC721A {
    constructor() RamppERC721A("SKULLETS", "SKLLTS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/PiOALE0sfpjlqrbtZpgR/contract-metadata";
    }
}
