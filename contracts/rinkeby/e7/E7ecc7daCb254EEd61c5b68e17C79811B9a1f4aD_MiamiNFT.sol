...
contract MiamiNFT is Context, ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    ) ERC721(name, symbol) VRFConsumerBase(vrf.coordinator, vrf.linkToken) {
    ...
    function mintUnsold(address _to) external onlyOwner onlyInactive {
        uint toMint = totalLimit - totalMinted;
        toMint = toMint > 120 ? 120 : toMint;
