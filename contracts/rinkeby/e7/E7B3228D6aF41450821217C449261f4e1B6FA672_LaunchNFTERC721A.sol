...
contract LaunchNFTERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_GIFT = 1;
    ...
    uint public wlSalePrice = 0.005 ether;
    uint public publicSalePrice = 0.001 ether;

    uint public saleStartTime = 1659736306;
    ...
    uint private constant maxPerAdressDuringWhitelistMint = 1;
    uint private constant maxPerAdressDuringPublicMint = 3;
    ...
    */
    modifier callerIsUser () {
        require(tx.origin == msg.sender, "The call is another contract");
        _;
    }
    
    /**
    * @notice Mint function for the WL sale
    ...
    */
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require(amountNFTperWalletWhitelistSale[msg.sender] + _quantity <= maxPerAdressDuringWhitelistMint, "You can only get 1 NFT on the Whitelist Sale");
    ...
    */
    ...
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAdressDuringPublicMint, "You can only get 3 NFT on the public Sale");
    ...
    * @return the token URI of an NFT buy his Id
    */
    ...
    /**
    * @notice Allows to set the withelist sale price
    ...
    * @param _saleStartTime The starting timestamp of the withelist sale
    */
    ...
    */
    ...
    /**
    * @notice Check if an address is Wl or not
    * @param _account The account checked
    * @param _proof The Merkle Proof
    * @return bool return true if the address is WL, false otherwise
    */
    ...
    /** 
    * @notice  Release the gain an every accounts
    */
