...
contract Tsunami is ERC20, ERC20Burnable, Ownable {
    IERC20 public busd;
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0) && to != holder) {
            ...
            require(senderRealBalance >= amount, "Tsunami: not enough non-frozen tokens");
        }
    }
