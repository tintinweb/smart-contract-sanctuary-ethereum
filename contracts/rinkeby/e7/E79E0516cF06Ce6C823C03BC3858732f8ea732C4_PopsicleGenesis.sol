...
contract PopsicleGenesis is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable, IERC2981 {
    uint256 public presaleMaxSupply = 577;
    uint256 public maxSupply = 777;
    uint256 public publicPrice = 0.99 ether;
    ...
    function mintPresale(bytes32[] calldata proof, uint256 quantity) public payable {
        require(quantity + _totalMinted() <= presaleMaxSupply, "max presale supply reached");
    ...
    function isPresaleActive() public view returns (bool) {
        return _isPresaleActive && _totalMinted() < presaleMaxSupply;
    }
    ...
    function withdraw() external onlyOwner {
        (bool incubatorSuccess, ) = incubator.call{ value: (address(this).balance * 3) / 100 }("");
    ...
    function setPresaleMaxSupply(uint256 newPresaleMaxSupply) external onlyOwner {
        ...
        require(_totalMinted() != presaleMaxSupply, "presale max supply already reached");
