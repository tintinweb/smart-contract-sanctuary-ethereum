...
contract MDJKIOP is ERC1155, Ownable {
    uint256 TOKEN_ID = 1;
    uint256 GOLD_TOKEN_ID = 2;
    bytes32 public merkleRootHash=0xbcfc42a30c8dde4971b29079a6efee74771d3f3abf5a9205bbbccbd2fa8c689c;
    string public BASE_URI = "https://gateway.pinata.cloud/ipfs/QmWXPzuwxe8aNzEM3EktGv37qt7bojq5WqHnnLch5GE5CG/";
    string public name = "MDJKIOP";
    string public symbol = "MDJK";
    ...
    function setMaxSupply(uint256 _max_supply) external onlyOwner{
        require(_max_supply > total_supply,"can't set to less than current total_supply");
    ...
    function mintDaoNFT(bytes32[] calldata _merkleProof) public {
        ...
        require(total_supply<MAX_SUPPLY,"MAX SUPPLY REACHED");
