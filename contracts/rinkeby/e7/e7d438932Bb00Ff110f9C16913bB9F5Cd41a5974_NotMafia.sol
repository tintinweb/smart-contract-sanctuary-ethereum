...
contract NotMafia is ERC721A, Ownable, ReentrancyGuard {
    ...
    // Public
    function verifyWhiteList(bytes32[] calldata __proof)
        public
        view
        returns (bool)
    {
    ...
    function verifyAllowList(bytes32[] calldata __proof)
        public
        view
        returns (bool)
    {
    ...
    function whiteListMint(bytes32[] calldata __proof)
        ...
        mint
    {
        if (!verifyWhiteList(__proof)) revert NotWhiteListed();
    ...
    function freeMint(bytes32[] calldata __proof) external nonReentrant mint {
        ...
        if (!verifyAllowList(__proof)) revert NotAllowListed();
