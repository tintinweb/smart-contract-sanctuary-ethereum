...
contract gt4 is ERC721, RrpRequesterV0, Ownable {
    ...
    mapping(address => bool) private GTMintedF;
    mapping(uint256 => bool) private GTUsed;

    mapping(bytes32 => bool) public expectingRequestWithIdToBeFulfilled;
    mapping(bytes32 => address) requestToSender;
    mapping(bytes32 => uint256) requestToTokenId;

    constructor(address _airnodeRrp) RrpRequesterV0(_airnodeRrp) ERC721("GT4", "GT4") {}
