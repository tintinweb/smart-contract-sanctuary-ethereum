...
contract NftStake is IERC721Receiver, ReentrancyGuard {
  IERC721 public _nftToken = IERC721(0x06DbA8AfCa38e30fEAFfc1397AD7C9c26dc7B588);    // PLACE OWL TOKEN ADDRESS HERE
    IERC20 public _erc20Token = IERC20(0x8A95D8644804F29c1e162fA4F0563C9E39D3c029);   // PLACE HOOT TOKEN ADDRESS HERE
    ...
    function _harvest(uint256 tokenId) public nonReentrant onlyStaker(tokenId) requireTimeElapsed(tokenId) {
