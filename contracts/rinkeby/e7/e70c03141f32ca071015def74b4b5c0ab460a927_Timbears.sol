...
contract Timbears is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0x95cc77a2c37Fd7e1A603e9c879A3A8f08B02F755).call{value: artistPayment}('');
    require(artistSuccess);

    (bool marketerSuccess, ) = payable(0x11428f4647F93c559DA4717f75bA05C95c5De9E3).call{value: marketerPayment}('');
