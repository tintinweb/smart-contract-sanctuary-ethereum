...
contract TestERC721 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_TOKENS_PER_MINT = 1000;
  uint256 public constant MAX_TOKENS_PER_WALLET = 1000;
  ...
  constructor(address _signer) ERC721A("Test", "TEST") {
    signer = _signer;
  }
