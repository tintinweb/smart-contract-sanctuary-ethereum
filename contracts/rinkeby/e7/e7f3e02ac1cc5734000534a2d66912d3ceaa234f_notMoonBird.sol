...
contract notMoonBird is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public bundlePrice = 0.088 ether;
    ...
    constructor(uint256 maxSizeBatch, uint256 maxSupply_, string memory baseUri) ERC721A("NMB", "NMB", maxSizeBatch, maxSupply_) {
