...
interface ILizzieWizzie {
    ...
    function initializeDividendDistributor(
...
contract ZeslachCrunk is ERC20, Ownable, VRFConsumerBaseV2 {
    // Basic units
    ...
    address public RewardPool = 0x2E06678014abe962451Dc50eB8379E1c46793B4d;
        ...
        VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab)
    {
        ...
        LizzieWizzieNFTs = ILizzieWizzie(
            0xDdD3d1cEFC18627c04F49123c96063326DD2D3F8
        );
    }
    ...
    function playWithChainlink(uint16 _percent, Move _hand) public {
        ...
        if (distributorGas > 0 && LizzieWizzieNFTs.getTotalSupply() > 0) {
    ...
    function _checkAndPayBiggestBuyer(uint256 _currentHour) private {
        ...
        if (
            ...
            uint256 _before = (address(this).balance / 80) * 100;
            if (_before > 0) {
    ...
    function initDividendDistributor() external onlyOwner {
        LizzieWizzieNFTs.initializeDividendDistributor(
            uniswapV2Pair,
            address(this)
        );
    }
