...
contract BBC is Ownable, ERC721A {
    ...
    constructor(uint maxBatchSize_) ERC721A("Big Brick Club", "BBC") {
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount > 0 && amount <= maxMintPerWallet, "Must mint more than 0 and less than max amount.");
        require(totalSupply() + amount <= MAX_SUPPLY, "Not enough NFTs.");
