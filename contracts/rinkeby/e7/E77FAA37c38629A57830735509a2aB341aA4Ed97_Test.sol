...
contract Test is ERC721A, Ownable {
  ...
  // uint256 public maxPresaleSupply = 440;
  ...
  constructor() ERC721A("Test", "T") {
    notRevealedURI = "ipfs://QmRSaaJiypncde1W3DAqGVBeRfPMcN2TUBGrUyaYDqWQEG/hidden.json";
  }
  ...
  // function setMaxPresaleSupply(uint256 amount) external onlyOwner {
  //   maxPresaleSupply = amount;
  // }
