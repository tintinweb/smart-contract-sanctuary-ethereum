...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase{
    ...
    uint256 public maxNumPaths;
    uint256 public maxNumCommands;
    uint256 public size;
    ...
    function generatePath(uint256 randomNumber) public view returns(string memory pathSvg){
        uint256 numOfPathCommands = (randomNumber % maxNumCommands) +1;
        pathSvg = "<path d='";
        for(uint i = 0; i< numOfPathCommands; i++){
    ...
    function generatePathCommand(uint256 randomNumber) public view returns(string memory pathCommand){
        ...
        pathCommand = string(abi.encodePacked(pathCommand, " ", uint2str(param1), " ", uint2str(param2)));
