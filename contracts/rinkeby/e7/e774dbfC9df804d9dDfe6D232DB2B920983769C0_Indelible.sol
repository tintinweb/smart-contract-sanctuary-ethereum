// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Lasers", unicode"Mouth", unicode"Eyes", unicode"Nose", unicode"Shirt", unicode"Skin", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"OnChainKevin", unicode"Testing", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/f2de7141-0ac3-4e5c-b14f-4bcf02ec8467", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/f2de7141-0ac3-4e5c-b14f-4bcf02ec8467", "", 0, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");

        constructor() ERC721A(unicode"OnChainKevin", unicode"DERP") {
            TIERS[0] = [65,77,77,114,341,365,961];
TIERS[1] = [20,63,107,145,175,228,244,314,343,361];
TIERS[2] = [78,93,165,285,287,323,769];
TIERS[3] = [81,111,313,377,464,654];
TIERS[4] = [9,24,24,26,52,101,106,118,126,144,148,154,169,185,271,343];
TIERS[5] = [50,464,1486];
TIERS[6] = [30,48,55,59,94,110,112,121,141,143,1087];
            LINKED_TRAITS[0][4] = [5,2];
LINKED_TRAITS[0][5] = [5,2];
LINKED_TRAITS[0][6] = [5,2];
        }
