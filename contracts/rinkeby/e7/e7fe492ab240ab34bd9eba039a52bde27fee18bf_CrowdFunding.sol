...
contract CrowdFunding {
    ...
    */
    ...
    function getFunderData(uint256 campaignID, uint256 funderID) public view returns(address, uint256){
        Campaign storage c = campaigns[campaignID];
        return (c.funders[funderID].addr, c.funders[funderID].amount);
    }

    function getFunderEvent (uint256 campaignID, uint256 funderID) public {
        Campaign storage c = campaigns[campaignID];
