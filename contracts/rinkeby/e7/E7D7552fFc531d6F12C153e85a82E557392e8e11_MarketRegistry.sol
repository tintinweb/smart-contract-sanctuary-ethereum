    ...
    TellerASResolver
{
    ...
    event UpdatedMarketOwner(uint256 marketId, address newOwner);
    event UpdatedMarketFeeRecipient(uint256 marketId, address newRecipient);
        ...
        ownsMarket(_marketId)
    {
        ...
        emit UpdatedMarketOwner(_marketId, _newOwner);
    }
        ...
        ownsMarket(_marketId)
    {
        ...
        emit UpdatedMarketFeeRecipient(_marketId,_recipient);
    }
