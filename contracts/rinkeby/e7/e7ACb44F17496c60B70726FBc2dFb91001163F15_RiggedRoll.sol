...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() public payable {
        ...
        bytes32 prevHashTwo = blockhash(block.number - 1);
        bytes32 hashTwo = keccak256(abi.encodePacked(prevHashTwo, address(diceGame), diceGame.nonce()));
        uint256 rollTwo = uint256(hashTwo) % 16;
        

        uint ValueToSend = 0.002 ether;
          console.log("THE ROLLTwo IS ",rollTwo);  
