    ...
    ERC721BurnableUpgradeable
{
    ...
    modifier tokenExists(uint256 tokenId) {
        require(tokenId <= _supplyLimit, "Token surpasses supply limit.");
        _;
    }

    modifier IDWasNotUsed(uint256 tokenId) {
        require(usedId[tokenId] == false, "Token ID has been used.");
        _;
    }
