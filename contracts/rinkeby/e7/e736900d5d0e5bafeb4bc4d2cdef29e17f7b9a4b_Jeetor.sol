...
contract Jeetor is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Jeetor";//
    string private constant _symbol = "Jeetor";//
    ...
    uint256 private _liqFeeOnBuy = 6;
 
    //Sell Fee
    uint256 private _redisFeeOnSell = 0;//
    uint256 private _taxFeeOnSell = 8;//
    uint256 private _liqFeeOnSell = 6;
    ...
    address payable private _marketingAddress = payable(  0xE9D6C98eBF6222186D7B516922286c1185E6363E);
