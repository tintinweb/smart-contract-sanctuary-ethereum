...
contract RecBuds is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Recreational Buds", "RECBUDS") {
    setHiddenMetadataUri("ipfs://QmbJkKaLau9DKPHUgvzTECM51EA8z22FoEqqJSCbifxp6k/hidden.json");
  }
