...
contract TestF is ERC721A, Ownable {
    ...
    function wmint(bytes32[] calldata proof) public callerIsUser {
    ...
    function setMerkleRootAndFlag(bytes32 merkleRoot) public onlyOwner {
        root = merkleRoot;
    }
