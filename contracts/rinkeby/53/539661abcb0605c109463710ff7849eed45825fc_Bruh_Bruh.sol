...
contract Bruh_Bruh is Ownable, ERC721A {
    ...
    string public revealedURI = "ipfs://QmXd8zZj1hsD1PaUFTBRMDhyx7Bj71Kmehgmq2iWZ59Tod/";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://BIQD91HS4EIXUFNX5IMPY8APAZRSBD53EW";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Bruh Bruh", "BRUH") { }
