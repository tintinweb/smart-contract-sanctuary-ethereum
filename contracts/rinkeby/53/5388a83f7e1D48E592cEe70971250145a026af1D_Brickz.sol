...
contract Brickz is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE_PUBLIC_SALE = 0.1 ether;
    uint256 public constant MAX_PER_MINT = 3;
    uint256 public constant PRESALE_MAX_MINT = 3;
    uint256 public constant MAX_NFTS_MINT = 3;
    uint256 public constant RESERVED_NFTS = 3;
    ...
    constructor(string memory baseURI) ERC721("Brickz Mint", "BRICKZ") {
