...
contract CollectiveStrangers is ERC721, IERC2981, Ownable {
    ...
    function setGlobalState(uint256 _state) external onlyOwner {
        require(
            _state == 0 || _state == 1,
            "Pass a _state that's either 0 or 1"
        );
        globalState = _state;
    }
    ...
    function setImageURI(string calldata uriOne, string calldata uriTwo)
        external
        onlyOwner
    {
        imageURI[0] = uriOne;
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                tokenId.toString(),
                                '", ',
                                '"description": "Descirption goes here", ',
