...
contract OmniyaLandSaleToken is ERC721A, IOmniyaLandSaleToken, Ownable, ReentrancyGuard {
    ...
    // ======== Constructor =========
    constructor(string memory baseURI) ERC721A ("OmniyaLandSaleToken", "OMNLSTK") {
        setBaseURI(baseURI);
    }
