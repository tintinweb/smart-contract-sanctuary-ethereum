...
// USDC/BUSD: 0x0F442e514A3F96bb260e719A88523B082eB7498c
// This: 0x533811465318C365E288CaA38B4bE82D77c65982
...
library NEWSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'0466ee3dc11c11f46453e84a6a53d166b72b75b70de271eeb375c1db8b4ee145' // init code hash
            ))));
    }
