...
contract zlru is ERC721Enumerable, Ownable {
    string public baseTokenURI;

    uint256 public price = 0.001 ether;
    uint256 public priceExtra = 0.002 ether;
    ...
    constructor(string memory baseURI) ERC721("zlru", "zlru") {
        setBaseURI(baseURI);
    }
    ...
    function _mintNFT(uint256 _hash)
        private
    {
        _safeMint(msg.sender, _hash);
    }
