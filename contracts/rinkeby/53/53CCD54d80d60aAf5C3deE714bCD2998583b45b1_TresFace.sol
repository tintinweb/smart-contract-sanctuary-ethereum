...
contract TresFace is TresFaceSplits, TresFaceBase {
    constructor()
        TresFaceBase(
            'TresFace',
            'TRF',
            'https://3face.mypinata.cloud/ipfs/', // IMPORTANT: IPFS Gateway only.
            //'https://outland-3face.mypinata.cloud/ipfs/', // IMPORTANT: IPFS Gateway URI only.
            addresses,
            splits,
            0.2 ether,
            0.1 ether,
        ...
        )
    {
        ...
        // string[] memory natureFragments = new string[](4);
        // natureFragments[0] = 'QmVWprCwio8i21hau1iwZT6PmfKxLiX5E6XPMRMqdF5owL'; // Change
        // natureFragments[1] = 'QmXf4BpJLzKdHGaCvSjPax3vTvGigCQTk25VHbDHMDnqaL'; // Structure
        // natureFragments[2] = 'QmXFzg47rmSJNGGhi8FPtueQh8psnpHDe7jcnykHS7R6yK'; // Belonging
        // natureFragments[3] = 'QmQHeP6JKd4DjMGBS3ahCkeEKrxDQXJfAPwQbdC7HpkbKq'; // Transcendence
        ...
        string[] memory natureFragments = new string[](4);
        natureFragments[0] = 'QmP9cq5865YBTVFYiUmUv9ehyTSWAF9NkmdoNhwC1kxoBH/nature0'; // Change
        natureFragments[1] = 'QmP9cq5865YBTVFYiUmUv9ehyTSWAF9NkmdoNhwC1kxoBH/nature1'; // Structure
        natureFragments[2] = 'QmP9cq5865YBTVFYiUmUv9ehyTSWAF9NkmdoNhwC1kxoBH/nature2'; // Belonging
        natureFragments[3] = 'QmP9cq5865YBTVFYiUmUv9ehyTSWAF9NkmdoNhwC1kxoBH/nature3'; // Transcendence
    ...
    DigiSigHelper
{
    ...
    uint256 private constant MAX_NFTS_FOR_PRESALE_1 = 1677;
    ...
    function maxPresale1() external pure returns (uint256) {
    ...
    function mintSet(uint256 sets) external payable nonReentrant isPublicMinting {
        if (0 >= sets || sets > MAX_MINT_BATCH_SIZE) revert ExceedsReserveBatchSize();
