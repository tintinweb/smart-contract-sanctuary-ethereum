...
contract TrippinBear is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI = "ipfs://QmVEpPBfC7YYKMVbjjQVMPm7s2Aykbg49cqH8M91akefKL/";
  uint public          price             = 0.01 ether;
  uint public          maxPerTx          = 20;
  uint public          totalFree         = 20;
  uint public          maxSupply         = 40;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = false;

  constructor() ERC721A("Trippin Okay Bear", "TOB"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Trippin.");
