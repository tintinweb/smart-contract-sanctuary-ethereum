...
function waitlistMint(address account,uint256 _mintAmount, bytes32[] calldata _proof) public payable mintCompliance(_mintAmount) 
mintPriceCompliance(_mintAmount) 
isValidMerkleProof(_proof) 
onlyAccounts {
    // Verify presale requirements
    require(waitlistM, 'The presale sale is not enabled!');
...
function toggleWaitlist() public onlyOwner {
    waitlistM = !waitlistM;
}
