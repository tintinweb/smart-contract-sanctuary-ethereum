...
contract FungibleTokenUpgradeable is Initializable, ERC777Upgradeable, OwnableUpgradeable {
   ...
   function mint(address to, uint256 amount, bytes memory userData, bytes memory operatorData) external {
