...
contract BabyPool {
    ...
    function Calculate_Winner() public {
     ...
     payOut(winner_address, winner_amount);
     }
    ...
    function payOut (address payable _winner_address, uint256 _winner_amount) public payable {
      address payable winner_address = _winner_address;
      uint256 winner_amount = _winner_amount;
      winner_address.transfer(winner_amount);
    }
