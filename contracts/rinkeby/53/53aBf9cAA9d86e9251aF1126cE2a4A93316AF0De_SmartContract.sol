...
//set contractbalance = swapatamount
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500000000000001 * 10**_decimals; //500T
    ...
    uint256 public coolDownTime =  0 seconds; // study this one
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;  //uniswap v2

    string private constant _name = "New7";
    string private constant _symbol = "New7";
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
      ...
      function setRatios(uint16 burn, uint16 liquidity, uint16 marketing, uint16 ctrbuyback, uint16 dev) external onlyOwner {
        _ratios.burn = burn;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.ctrbuyback = ctrbuyback;
        _ratios.dev = dev;
        _ratios.total = burn + liquidity + marketing + ctrbuyback + dev;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (lpPairs[to]) { 
            ...
            bool canSwap = contractTokenBalance >= swapTokensAtAmount; //tax 12 percent >= 10000
