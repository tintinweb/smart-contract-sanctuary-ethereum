...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    //Minting start time in uinx-epoch [phase 1 start, phase 2 start] [1645048800, 1647374400];
    uint256[] public tierStartMintTimes = [1645048800, 1647374400];
    //Minting ending time in unix-epoch [phase 1 start, phase 2 start] [1645135200, 1647460800];
