...
contract DaftRaptor is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable {
    ...
    function initialize() initializer public {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, 0xA3AABe7162049d0fbDe886330D0a708e01FA9357);
        _grantRole(PAUSER_ROLE, 0xA3AABe7162049d0fbDe886330D0a708e01FA9357);
        _grantRole(MINTER_ROLE, 0xA3AABe7162049d0fbDe886330D0a708e01FA9357);
    }
