    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                // A. No STAND to distribute, they are added to the amount to withdraw to treasury address
            } else {
        ...
        // Transfer STAND to address null
        standToken.safeTransfer(address(0), amountToWithdrawToTreasury);
