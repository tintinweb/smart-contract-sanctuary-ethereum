...
contract NFTProj is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("NFT Project", "NFTP"){
        unrevealedURI = "ipfs://.../";
    }
    ...
    */
    ...
    function pauseSale() public onlyOwner {
        State saleState_ = saleState();
        require(saleState_ != State.NoSale, "Public Sale in not open yet!");
        publicSaleLaunchTime = 0;
		presaleLaunchTime = 0;
    }
