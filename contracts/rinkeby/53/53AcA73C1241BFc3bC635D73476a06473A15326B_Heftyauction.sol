...
/** 
 *  SourceUnit: c:\Users\datta\OneDrive\Desktop\dehidden\MF HUSSAIN DROP- HEFTY\contracts\Heftyauction.sol
*/
...
contract Heftyauction is Initializable, OwnableUpgradeable,UUPSUpgradeable  {
    ...
    mapping(address => bool)whitelistedbidaddress; 
    ...
    function createAuction(address _assetAddress,
        ...
        ERC721Upgradeable asset = ERC721Upgradeable(_assetAddress);
       ...
       ERC721Upgradeable(_assetAddress).transferFrom(msg.sender,address(this),_assetId);
    ...
    function bid(uint256 auctionIndex) public payable returns (bool) {
        ...
        if(ispublic ==true){
            ...
            require(whitelistedbidaddress[msg.sender] == true);
    ...
    function claimAsset(uint256 auctionIndex) public {
        ...
        ERC721Upgradeable asset = ERC721Upgradeable(auction.assetAddress);
    ...
    function whitelistaddress(address _address) public onlyOwner{
        ...
        function whitelistbidderaddress(address[]memory _address) public onlyOwner{
            for(uint256 i = 0;i < _address.length;i++){
        whitelistedbidaddress[_address[i]] = true;
            }
    }

        function Ispublic(bool _bool) public onlyOwner{
        ispublic =_bool;
    }
