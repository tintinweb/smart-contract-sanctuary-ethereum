...
contract Lottery is VRFConsumerBase, Ownable {
  ...
  function getEntranceFee() public view returns (uint256) {
    ...
    uint256 adjustedPrice = uint256(price) *
      10**(uint256(18 - ethUsdPriceFeed.decimals()));
    // $50, $2,000
    // we want to do 50 / 2000
    // instead we have to do 50* 10**8 / 2000
  ...
  function endLottery() public onlyOwner {
    ...
    // Bad way to get a random number:
    // uint256(
    //   keccak256(
  ...
  function fulfillRandomness(bytes32, uint256 randomNum) internal override {
    require(
      lotteryState == LotteryState.CALCULATING_WINNER,
      "Not in correct state for randomness"
    );
