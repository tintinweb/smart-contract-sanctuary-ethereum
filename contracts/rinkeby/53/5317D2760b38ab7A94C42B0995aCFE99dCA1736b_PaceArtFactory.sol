...
contract PaceArtFactory is OwnableUpgradeable {
    ...
    function initialize(PaceArtStore _impl, address _registry, address _exchange) initializer public {
        impl = _impl;
