 ...
 */
    ...
    function remainAmount() public pure returns (address) { return 0x8B56a1475c8E8961c8468dF53e237eD2278989bc;}
...
// File: CosmicCharlieNFT.sol


pragma solidity ^0.8.4;

contract CosmicCharlieNFT is ERC721A, Ownable {
    using Strings for uint256;
    
    string public uriPrefix = "ipfs://QmaAx9nTMwQq2kH7xiBrCoP7keZMnUJJMqS4PDrLfZbogR/";
    string public uriSuffix = "";

    uint256 MAX_MINTS = 100;
    uint256 MAX_SUPPLY = 11111;
    uint256 maxMintAmountPerTx = 25;
    uint256 public mintRate = 0.005 ether;
    bool public paused = false;
    Manager manager;

    constructor() ERC721A("Cosmic Charlie NFT", "COSMICCHARLIE") {
        manager = new Manager();
    }
