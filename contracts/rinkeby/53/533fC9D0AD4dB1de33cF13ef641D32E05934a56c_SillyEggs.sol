    ...
    ReentrancyGuard
{
    ...
    address public treasuryAddress = 0xe71b5bB7480df907375dfc20A1C6deEF8511a753; // multisig wallet
    bool public isRevealed;
    uint16 public collectionSize = 50000;
    uint16 public maxQtyPerBatchMint = 20;

    string private _baseTokenURI;
    string private _contractURI =
        "ipfs://QmXVwpoWfYSKvWLjZKCyvVecsRpHkECveYkv9LuLnVztB4/contracts/contract_uri";
    string private _defaultTokenURI =
        "ipfs://QmfL8LXf7R5efMP1ZACi3XEPTDnTX2JH57mRV2T212LQPc/contracts/default_uri";

    constructor() ERC721A("SillyEggs", "SillyEggsNFT") {
        // init configs
        publicSaleConfig = PublicSaleConfig({
            startTime: 1661847335,
            price: 0.01 ether
        });
        whitelistSaleConfig = WhitelistSaleConfig({
            merkleRoot: 0x29ac0dc785bb3fdc1c5ebbeb061d8c99207a826ff26ab1646b290aceb19e2225,
            startTime: 1659883500,
            price: 0.001 ether,
            maxPerAddress: 5
        });
    }
    ...
    function _delBuildNumber8() internal pure {} // etherscan trick
