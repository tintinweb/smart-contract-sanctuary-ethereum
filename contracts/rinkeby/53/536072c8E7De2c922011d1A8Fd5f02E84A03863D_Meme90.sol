...
// Root file: contracts/NFTCollectible.sol
...
contract Meme90 is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    
    Counters.Counter private _tokenIds;
    
    uint public constant MAX_SUPPLY = 652;
    uint public constant PRICE = 0.002 ether;
    uint public constant MAX_PER_MINT = 2;
    
    string public baseTokenURI;
    
    constructor(string memory baseURI) ERC721("Meme90", "MM9") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFTs(uint _count) public payable {
        ...
        require(totalMinted.add(_count) <= MAX_SUPPLY, "Not enough Meme90s left!");
        require(_count >0 && _count <= MAX_PER_MINT, "Cannot mint specified number of Meme90s.");
        require(msg.value >= PRICE.mul(_count), "Not enough ether to purchase Meme90s.");
    ...
    function _mintSingleNFT() public payable {
