...
//    /  |/  /____   / ___/____ _/ /_  ___  ___  ____/ /  / __ \____ _____ ___  ____  ____ 
//   / /|_/ / ___/   \__ \/ __ `/ __ \/ _ \/ _ \/ __  /  / /_/ / __ `/ __ `__ \/ __ \/ __ \
//  / /  / / /      ___/ / /_/ / / / /  __/  __/ /_/ /  / _, _/ /_/ / / / / / / /_/ / /_/ /
// /_/  /_/_/      /____/\__,_/_/ /_/\___/\___/\__,_/  /_/ |_|\__,_/_/ /_/ /_/ .___/ .___/ 
//                                                                          /_/   /_/      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfc0512FcfA4Fa41Fd98E327C65BCAFC002dd316f];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbaexrExhj17g2zSZnsG5d9fq33Pvy6JQosKq8SYnaDKt/";
...
// File: contracts/MrSaheedRamppContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MrSaheedRamppContract is RamppERC721A {
    constructor() RamppERC721A("Mr Saheed Rampp ", "Sahees"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/73ovKryvSECgsaG2KMpW/contract-metadata";
    }
}
