...
contract Spaceship is ERC721EnumerableUpgradeable, NonblockingReceiverUpgradeable, IMelaxyEventsAndErrors {
    ...
    function getMergeResult(uint scale, address user, bytes32 seed, bytes32 transactionHash) private returns (bool) {
        uint mod = 10000;
    ...
    function getCardIdBySeed(uint[] storage cardIds, address user, bytes32 seed, bytes32 transactionHash, uint index) private returns (uint) {
