...
contract Photosynthesis is ERC721A, Ownable, ReentrancyGuard, Percentages {
    ...
    constructor(
        ...
        uint256 _price,         // 99000000000000000 Wei
        uint256 _alPrice,       // 88000000000000000 Wei
        uint256 _maxSupply,     // 8888
        string memory _uri,     // https://ipfs.io/ipfs/{hashvalue}/tokenid
        address PN,             // 0xB9aEcB63908c13b6167aD2eab9bAcD7e0DaBa78A
        address payout1,        // Receives 8% pay split
        address payout2         // Receives 92% pay split
    ) 
