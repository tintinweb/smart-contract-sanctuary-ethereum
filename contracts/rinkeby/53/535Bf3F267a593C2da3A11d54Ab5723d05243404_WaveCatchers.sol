...
contract WaveCatchers is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public collectionSize = 3335; // Real size is 3334 but 1 is added to save gas on checks
    ...
    // Mint Magic
    // @Todo Add payable and require statement for msg.value (disabled for testing purposes)
    function mint(uint256 _amount) external {
        ...
        require(
            totalSupply() + _amount < collectionSize - 334,
            "Exceeds max supply"
        );
    ...
    // Merkle Magic
    function setMerkleRoot(bytes32 _merkleRoot) external { // @todo add onlyOwner (disabled for testing purposes)
