...
contract MyContract {
    ...
    function _getMonth() public view returns (uint32) {
        return DateTime.getMonth(block.timestamp + 32400);
    }

    function _getDay() public view returns (uint32) {
        return DateTime.getDay(block.timestamp + 32400);
    }
