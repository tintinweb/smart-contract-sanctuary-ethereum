...
contract FuzzyFightersMinim is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant TOTAL_COLLECTION_QTY = 10;
    uint256 public constant PRESALE_MAX_QTY = 4; // public 22-(5)- 5 -3 -1= 8
    uint256 public constant AIRDROP_MAX_QTY  = 3; // gift + reserved
    uint256 public constant RESERVED_MAX_QTY  = 2;
    ...
    // ===== Constructor =====
    constructor(bytes32 _whitelistMerkleRoot, bytes32 _reservedListMerkleRoot) ERC721A("Fuzzy Fighters Minim", "FuzzyFightersMinim") {
    ...
    function reservedMint(bytes32[] memory proof) external onlySender nonReentrant {
        require(status == Status.ReservedSale, "The reserved mint not active.");
