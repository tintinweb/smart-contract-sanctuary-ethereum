...
contract Feeltwo is ERC721A, Ownable, Pausable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  uint64  public  immutable _maxSupply = 6765;
  ...
  address public constant omsoc     = 0x908C2430Cfb10999651308621F616b82d95BEE65;
  ...
  function withdraw()
    ...
    nonReentrant
  {
    Address.sendValue(payable(omsoc), address(this).balance);
  }
