...
contract GlowGuys is ERC721, Ownable {
    using Strings for uint256;

    address private wallet1 = 0x868bd39bBaC258f314b40dd0cC14D92489De5D6a;
    address private wallet2 = 0xFe2Cb7fff1926aDc45d06c3dC831Ed03c4Ff4172;
    uint256 public constant NFT_STOCK = 20;
    uint256 public constant NFTS_PER_MINT = 3;
    ...
    constructor(string memory tokenBaseURI, string memory mysteryURI) ERC721("TEST", "TESTTEST") {
    ...
    function mint(
        ...
        require(totalSupply <= NFT_STOCK, "OUT OF STOCK");
        require(tokenQuantity > 0, "INVALID TOKEN QUANTITY");
        require(NFT_PRICE * tokenQuantity <= msg.value, "INSUFFICIENT ETH");
        require(tokenQuantity <= NFTS_PER_MINT, "EXCEEDS MINT AMT PER TRANSACTION");
    ...
    function withdraw(uint256 amount) external onlyOwner {
        require(amount <= address(this).balance, "EXCEEDS CONTRACT AMT");
        payable(wallet1).transfer((amount * 500) / 10000);
        payable(wallet2).transfer((amount * 500) / 10000);
    }
