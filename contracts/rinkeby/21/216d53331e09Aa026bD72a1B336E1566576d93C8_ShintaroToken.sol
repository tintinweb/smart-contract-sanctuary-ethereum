...
contract ShintaroToken is ERC1155Burnable, ERC1155Supply, Ownable {
  ...
  constructor() ERC1155("") {
    ...
    init(5, type(uint64).max, new uint64[](0), 10, 1.25 ether, 0, 10000000000, "ipfs://QmZqbQDjDZTBEuTqDqRCWbtz2TmxRwFczhbTT5H796xRZ1"); // change start time, end time and uri

    uint64[] memory counters = new uint64[](1);
    counters[0] = 7;
    // PROD: 1655676000, 1655762400
    init(6, type(uint64).max, counters, type(uint64).max, 0 ether, 1655676000, 1655762400, "ipfs://QmZqbQDjDZTBEuTqDqRCWbtz2TmxRwFczhbTT5H796xRZ1"); // change start time, end time and uri

    counters[0] = 6;
    // PROD: 1655676000, 1655762400
    init(7, type(uint64).max, counters, type(uint64).max, 0 ether, 1655676000, 1655762400, "ipfs://QmR714TzFBpfQgmMmJSsYY1VZ1hftG6wAj2QnoQ96TLKU3"); // change start time, end time and uri
  }
