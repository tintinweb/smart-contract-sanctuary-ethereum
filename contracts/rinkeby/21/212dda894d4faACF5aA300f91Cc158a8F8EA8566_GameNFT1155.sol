...
contract GameNFT1155 is ERC1155PresetMinterPauser {
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        require(
            ...
            "GameNFT1155: URI query for non-existent token"
        );
        return
            string(
                abi.encodePacked(
    ...
    function getOwnedTokens(
        ...
        require(fromIndex <= lastIndex, "GameNFT1155: invalid query range");
    ...
    function setBaseTokenURI(string memory baseTokenURI_) external {
        require(
            ...
            "GameNFT1155: caller is not an admin"
        );
