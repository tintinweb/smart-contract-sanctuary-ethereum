...
/**
   ...
   Shibies Wrapped TREATS Testnet
   
   Testnet without redistribution
...
contract ShibiesTestWrappedTreats is Context, IERC20, IAnyswapV3ERC20 {
    ...
    address public treats = 0x9DC4fD40f0D8329B81aE535446F2a17ba8280b90;
    ...
    string private _name = "Shibies Test Wrapped Treats";
    ...
    constructor() {
        vault = 0xCFb4615b8110636045b59D0d7370Fd351aD4D46D;
    ...
    function mint(address to, uint256 amount) external onlyAuth returns (bool) {
        require(amount <= IERC20(treats).totalSupply().sub(_tTotal), "Amount must be less than total supply!");
        _mint(to, amount);
        return true;
    }
