// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accesories", unicode"Hair", unicode"Brows", unicode"Eyes", unicode"Nose", unicode"Mouth", unicode"Face", unicode"Body", unicode"Back", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"OnchainKidz", unicode"OnchainKids on your block!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/19248f32-93db-43a6-91fa-7f0080267c11", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/19248f32-93db-43a6-91fa-7f0080267c11", "notrtfkt.xyz", 600, "0x06E14b037650E6d7c5e6a8eB329E1b44E2D7650C");

        constructor() ERC721A(unicode"OnchainKidz", unicode"OCK") {
            TIERS[0] = [2,6,14,19,31,62,64,81,96,99,140,152,192,198,203,237,247,271,369,477,811,1229];
TIERS[1] = [37,87,106,182,219,291,367,577,620,810,1704];
TIERS[2] = [10,23,23,56,188,294,514,631,1208,2053];
TIERS[3] = [4,15,40,41,52,67,89,194,224,234,247,250,251,251,256,258,531,611,692,693];
TIERS[4] = [4,7,51,57,209,234,239,306,310,311,319,341,495,637,1480];
TIERS[5] = [15,20,41,54,64,67,82,93,97,101,108,148,200,204,233,239,309,364,540,2021];
TIERS[6] = [791,1290,2919];
TIERS[7] = [30,50,57,688,1142,1378,1655];
TIERS[8] = [50,50,4900];
TIERS[9] = [28,190,361,449,501,518,1112,1841];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"OnchainKidz #");
