...
contract AutoCoinageSnapshot is AutoCoinageSnapshotStorage, DSMath {
        ...
        )
    {
        ...
        uint256 index = _lastSnapshotId(accountBalanceSnapshots[layer2][account].ids);
        snapShotBalance = accountBalanceSnapshots[layer2][account].balances[index];
        snapShotRefactoredCount = accountBalanceSnapshots[layer2][account].refactoredCounts[index];
        snapShotRemain = accountBalanceSnapshots[layer2][account].remains[index];
    }
        ...
        )
    {
        ...
        uint256 index = _lastSnapshotId(totalSupplySnapshots[layer2].ids);
        snapShotBalance = totalSupplySnapshots[layer2].balances[index];
        snapShotRefactoredCount = totalSupplySnapshots[layer2].refactoredCounts[index];
        snapShotRemain = totalSupplySnapshots[layer2].remains[index];
    }
        ...
        )
    {
        ...
        uint256 index = _lastSnapshotId(factorSnapshots[layer2].ids);
        snapShotFactor = factorSnapshots[layer2].factors[index];
        snapShotRefactorCount = factorSnapshots[layer2].refactorCounts[index];
    }
