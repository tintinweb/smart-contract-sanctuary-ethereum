    ...
    CommonModifiers
{
     ...
     */
    function borrow(uint256 borrowAmount) external payable virtual override nonReentrant {
...
abstract contract LoanAgentAdmin is ILoanAgent, LoanAgentModifiers {
    function setPUSD(
        address newPUSD
    ...
    function setMasterMiddleLayerAddress(
        address _master
    ) external override onlyOwner() {
        masterMiddleLayer = _master;
    }
}
