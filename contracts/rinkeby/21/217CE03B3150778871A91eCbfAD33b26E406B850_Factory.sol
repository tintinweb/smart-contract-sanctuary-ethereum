...
import "./CollectibledUser721Token.sol";
...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new CollectibledUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CollectibledUser721Token token = CollectibledUser721Token(address(addr));
...
contract CollectibledUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
