...
contract CustomERC721A is ERC721A, Ownable, RoyaltiesV2Impl, ReentrancyGuard {
    ...
    uint256 constant _MINT_PRICE = 0.35 ether;
    uint256 constant _WHITELIST_MINT_PRICE = 0.25 ether;

    uint256 constant _MAX_SUPPLY = 7000;
    uint256 constant _WHITELIST_MAX_SUPPLY = 4000;

    uint256 constant _MAX_TOKENS_PER_TX = 10;
    uint256 constant _MAX_TOKENS_PER_WHITELIST_WALLET = 12;
    ...
    mapping(address => bool) private _hasClaimedPublic;
    ...
    constructor() ERC721A('NAME', 'TOKEN') {}
        ...
        publicOpen
    {
        ...
        require(
            _mintAmount > 0 || !_hasClaimedPublic[msg.sender],
            'You have already claimed your free token'
        );
        ...
        if (!_hasClaimedPublic[msg.sender]) {
            _safeMint(msg.sender, 1, '');
            _hasClaimedPublic[msg.sender] = true;
        }
    }
    ...
    function getWhitelistMaxSupply() public pure returns (uint256) {
        return _WHITELIST_MAX_SUPPLY;
    }
    ...
    function getMaxTokensPerWhitelistTx() public pure returns (uint256) {
        return _MAX_TOKENS_PER_TX;
    }
