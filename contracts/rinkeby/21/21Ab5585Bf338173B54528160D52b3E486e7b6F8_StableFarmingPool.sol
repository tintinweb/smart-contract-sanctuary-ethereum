...

{
    ...
    event StableFarmingPoolCreated(uint256 indexed poolId, uint256 APR);
    ...
    modifier onlyWhiteList(uint256 _poolId) {
        FarmingWhiteList storage whitelistData = farmingWhiteList[
            _poolId
        ];
        require(
     ...
     */
    function __StableFarmingPool_init()
        public
        initializer
    {
    ...
    function stableFarmingAddPool(
        ...
        emit StableFarmingPoolCreated(stableFarmingPoolInfo.length - 1, _APR);
    }
        ...
        onlyWhiteList(_poolId)
    {
        ...
        emit StableFarmingDeposit(_poolId, account, _amount);
    }
        ...
        stableFarmingValidatePoolById(_poolId)
    {
        ...
        if (stakingData.reward > 0) {
            ...
            emit StableFarmingRewardsHarvested(_poolId, account, reward);
        }
        ...
        if (pool.delayDuration == 0) {
            ...
            emit StableFarmingWithdraw(_poolId, account, _amount);
            return;
        }
