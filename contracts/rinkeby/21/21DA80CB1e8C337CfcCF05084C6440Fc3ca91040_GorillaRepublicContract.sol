...
//*********************************************************************//
//
//    ______           _ ____         ____                   __    ___     
//   / ____/___  _____(_) / /___ _   / __ \___  ____  __  __/ /_  / (_)____
//  / / __/ __ \/ ___/ / / / __ `/  / /_/ / _ \/ __ \/ / / / __ \/ / / ___/
// / /_/ / /_/ / /  / / / / /_/ /  / _, _/  __/ /_/ / /_/ / /_/ / / / /__  
// \____/\____/_/  /_/_/_/\__,_/  /_/ |_|\___/ .___/\__,_/_.___/_/_/\___/  
//                                          /_/                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xdfDe8db2034c8FbAC8ab255B6e5B247107d2b7A0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmb3ePRKCmzinJCkUiEothbu9KunfAFbsdFEGL6u7sQ9A6/";
...
// File: contracts/GorillaRepublicContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GorillaRepublicContract is RamppERC721A {
    constructor() RamppERC721A("Gorilla Republic", "GR"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/2dlc9I4nXXVveuRvvnyY/contract-metadata";
    }
}
