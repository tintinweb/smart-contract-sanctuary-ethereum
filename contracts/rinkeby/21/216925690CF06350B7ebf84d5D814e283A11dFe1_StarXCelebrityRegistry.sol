...
contract StarXCelebrityRegistry is Ownable {
    ...
    // TODO: get/update function(s) where applicable
    // use enumerable map for mapping functionality + other utilities
    uint256 m_celebCount;
    mapping(address => uint256) m_celebToIndex;
    mapping(uint256 => address) m_celebToIndexRev;
    // TODO: not needed; remove when ready
    address m_starXAddressRegistry;

    //---------------------------------- v1 - member vars - finish ------------------------------------

    //    function initialize(address _starXAddressRegistry) public initializer {
    ...
    //        //                _msgSender()
    //        //            ),
    //        //            "StarXCelebrityRegistry can only be deployed by registered StarXAdmin"
    //        //        );
    //        // init parent
    //        __Ownable_init();
