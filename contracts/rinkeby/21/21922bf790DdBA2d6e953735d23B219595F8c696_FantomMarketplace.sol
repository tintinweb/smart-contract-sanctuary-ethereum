...
contract FantomMarketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @notice Platform fee
    uint16 public platformFee = 20;

    /// @notice Platform fee receipient
    address public ladr = address(0x25dF2107A2308101F5Ca48C2B65614467fB8ccd2);
    address payable public feeReceipient = payable(ladr);
    //address payable public feeReceipient = address(0x25dF2107A2308101F5Ca48C2B65614467fB8ccd2);
