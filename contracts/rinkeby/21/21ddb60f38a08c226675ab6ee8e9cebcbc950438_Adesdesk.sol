...
contract Adesdesk is ERC20, Ownable {
    constructor() ERC20("Adesdesk", "ADK") {
    ...
    function mintMinerReward(address to, uint256 amount) public onlyOwner {
        _mint(to, amount);
    }
