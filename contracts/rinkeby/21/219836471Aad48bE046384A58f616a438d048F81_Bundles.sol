...
contract Bundles {
    ...
    function createBundle(uint256[14] memory _prices) public returns(bool){
        require(msg.sender == owner,'Not Owner');
        ...
        lastcreated = block.timestamp;
        b.endtime = SafeMath.add(block.timestamp,5 minutes);
        b.stakingends = SafeMath.add(block.timestamp,2 minutes);
