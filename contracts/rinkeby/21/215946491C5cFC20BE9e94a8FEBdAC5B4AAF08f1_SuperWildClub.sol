...
/// @author cd33
contract SuperWildClub is Ownable, ERC721A, ERC721AQueryable, ERC2981 {
    enum Step {
        Before,
        WhitelistSale,
        PublicSale
    ...
    address private constant recipient = 0xD9453F5E2696604703076835496F81c3753C3Bb3;
        // 0xbE72550633Cfa5c173df131AaA155A7F9e8A7B92; // le bon wallet

    Step public sellingStep;

    uint8 public whitelistLimitBalance = 2;
    uint8 public publicSaleLimitBalance = 4;
    uint16 public MAX_SUPPLY = 6530;
    uint256 public whitelistSalePrice = 0.002 ether; // 0.2
    uint256 public publicSalePrice = 0.0025 ether; // 0.25
    ...
    mapping(address => uint8) public amountNftPublicSalePerWallet;
    ...
    constructor(bytes32 _merkleRoot, string memory _baseURI)
        ERC721A("SuperWildClub", "SWC")
    {
        merkleRoot = _merkleRoot;
        baseURI = _baseURI;
        _setDefaultRoyalty(recipient, 700);
    }
    ...
    function publicSaleMint(uint8 _quantity) external payable callerIsUser {
        ...
        require(
            amountNftPublicSalePerWallet[msg.sender] + _quantity <=
                publicSaleLimitBalance,
            "Limited number per wallet"
        );
     ...
     * @dev Changes the percentage and the receiver of the royalties.
     * @param _receiver Address of receiver.
     * @param _feeNumerator Amount of royalty.
     **/
