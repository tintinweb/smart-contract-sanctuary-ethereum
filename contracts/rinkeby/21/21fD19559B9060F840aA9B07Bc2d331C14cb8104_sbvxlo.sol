...
contract sbvxlo is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 9969;
    uint256 public MINT_COST = 0.02 ether;
    uint256 public LOYALTY_MINT_COST = 0.01 ether;
    uint256 adCount = 1;
    ...
    address public sbvtestZContract = 0xD353328D59dC284f3B696F95f6aA83b0DA8D2F99;
    address public sb721Contract = 0xf1Dd745faC306cc90aa84E7ab135cC7B44c69824;
    ...
    constructor() ERC721A("sbvxlo", "SBLO") {
        saleIsActive = false;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(totalSupply() + _mintAmount <= MAX_SUPPLY, "Not enough SuperBLOX3D remaining.");
    ...
    function loyaltyMint(uint256 _mintAmount) public payable {
        ERC721A _sbvtestZContract = ERC721A(sbvtestZContract);
        ERC721A _sb721Contract = ERC721A(sb721Contract);

        require(loyaltyMintIsActive, "Loyalty mint not active.");
        require(_sbvtestZContract.balanceOf(msg.sender) > 0 || _sb721Contract.balanceOf(msg.sender) > 0);
        require(hasLoyaltyMinted(msg.sender) == false);
        require(_mintAmount <= 5);
        require(totalSupply() + _mintAmount <= MAX_SUPPLY, "Not enough tokSuperBLOX3Dens remaining.");
    ...
    function airdropSB(uint256 _qty) public onlyOwner {
        ...
        _safeMint(_sbvtestZContract.ownerOf(adCount),1);
        adCount = adCount + 1;
        }

    }

    function setsbvtestZContract(address _sbvtestZContract) public onlyOwner {
        sbvtestZContract = _sbvtestZContract;
    }

    function setsb721Contract(address _sb721Contract) public onlyOwner {
        sb721Contract = _sb721Contract;
    }
