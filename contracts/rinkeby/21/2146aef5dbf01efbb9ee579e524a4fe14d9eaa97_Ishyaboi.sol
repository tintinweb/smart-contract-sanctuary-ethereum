...
contract Ishyaboi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ish Ya Boi";
    string private constant _symbol = "ITS";
    ...
    address payable private _developmentAddress = payable(0x43EB13ae0A2258C65cCe719EC63d7640BBB2e976); 
    address payable private _marketingAddress = payable(0xA5519f55d95Dc81480109066cCC0F041B0e77100);
