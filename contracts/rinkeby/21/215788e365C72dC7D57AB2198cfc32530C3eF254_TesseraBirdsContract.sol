...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xa5Dc3e5F058A23Ef625A6243Ec4bAf41a86B30ec];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xa5Dc3e5F058A23Ef625A6243Ec4bAf41a86B30ec;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicqzjfiozyyabknf7ezvflfwlom66tyqifsdydruysmsh2fqvschy/";
...
// File: contracts/TesseraBirdsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TesseraBirdsContract is RamppERC721A {
    constructor() RamppERC721A("Tessera Birds", "TESB"){}
}
