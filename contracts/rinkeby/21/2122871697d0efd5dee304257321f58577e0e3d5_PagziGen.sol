...
contract PagziGen is ERC721Enumerable, Ownable, ReentrancyGuard {
    
    bytes32 public merkleRoot;
    mapping(address => uint256) public claimed;
    uint256 public costPre = 0.0001 ether;
    uint256 public maxMintPre = 5;
    uint256 public preDate = 1654501223;
    ...
    uint256 public publicDate = 1654502223;
    ...
    constructor() ERC721("PagziGen", "PGEN") {
        baseURI = "https://contractcalls.nftsite.art/meta/";
    }
    ...
    function mintPass(uint256 count) external payable checkLimit(count)  checkPrePrice(count) checkPreDate  {
        uint256 totalSupply = _owners.length;
