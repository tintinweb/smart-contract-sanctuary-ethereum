...
contract TestFinal is ERC721PresetMinterPauserAutoId, ERC721URIStorage, ReentrancyGuard, Ownable, PaymentSplitter {

    // Import Counter
    using Counters for Counters.Counter;

    // Init _tokenIdCounter
    Counters.Counter private _tokenIdCounter;

    // Define custom structs for presale and sale window
    ...
    // Define team breakdown
    uint256[] private _teamBreakdown = [9425, 425, 150];
    address[] private _team = [
        0xcDED63173D96D7E493A65EC28A48e708E4fa915B,
        0xf6065375a80Cd85B1F4B549D0CE042B5E07e7B31,
        0x49996A70a88523Ebf0a7D16794099FFab371d7cd
    ];

    // Define enumeration for contract state
    enum ContractState {
        BeforePresale,
        Presale,
        Sale,
    ...
    // Init ContractState enumeration
    ...
    // Init Contract
    constructor() 
    ERC721PresetMinterPauserAutoId("TestFinal", "TF", "")
    ...
    function publicMint(uint256 amount) external payable nonReentrant {
        ...
        require(totalTokenCounter + amount <= maxTokens, "No more tokens to mint.");
