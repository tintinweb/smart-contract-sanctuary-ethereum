...
// File contracts/PlatziPunksToken.sol
...
contract PlatziPunksToken is ERC20, ERC20Spendable {
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA, Ownable {
     ...
     */
    function mintingPrice() external view onlyOwner returns (uint256) {
     ...
     */
    function setMintingCurrency(ERC20Spendable newMintingCurrency) internal {
