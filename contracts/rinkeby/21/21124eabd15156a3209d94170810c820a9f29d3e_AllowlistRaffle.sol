...
contract AllowlistRaffle is OpenAllowlistRaffleBase {
 ...
 */
abstract contract OpenAllowlistRaffleBase is Ownable, Pausable, VRFConsumerBaseV2 {
    ...
    function enter(uint256 amount) public virtual payable whenNotPaused {
        ...
        emit EntriesPurchased(_msgSender(), amount);
    }
