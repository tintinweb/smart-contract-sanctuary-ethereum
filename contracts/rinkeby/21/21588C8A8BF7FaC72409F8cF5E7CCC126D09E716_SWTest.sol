...
contract SWTest is ERC721Enumerable, Ownable {
    ...
    address a1 = 0x11096Ba75D47D513addf786FCb5A1250eE06E4aa;
    address a2 = 0x11096Ba75D47D513addf786FCb5A1250eE06E4aa;
    address a3 = 0x11096Ba75D47D513addf786FCb5A1250eE06E4aa;
    address a4 = 0x11096Ba75D47D513addf786FCb5A1250eE06E4aa;

    constructor(string memory baseURI, bytes32 merkleRoot) ERC721("SWTest", "SWT") {
    ...
    function withdrawFixed() external payable onlyOwner {
    ...
    function withdrawTeam() external payable onlyOwner {
        ...
        (bool p4, ) = payable(0x11096Ba75D47D513addf786FCb5A1250eE06E4aa).call{value: balance * 15 / 100}("");
        require(p4, "transaction_failed");

        (bool p5, ) = payable(0x11096Ba75D47D513addf786FCb5A1250eE06E4aa).call{value: balance * 3 / 100}("");
