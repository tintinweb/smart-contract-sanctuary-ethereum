 ...
 */
abstract contract ERC721A is Context, ERC165, IERC721Metadata {
...
contract XANALand is ProxyBaseStorage, IERC721, ERC721AQueryable, Ownable, ReentrancyGuard, Storage {
 using Strings for uint256;
 using Address for address;
    constructor(
        string memory _name,
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) checkLockUp(tokenId) public virtual override {
