...
//*********************************************************************//
//
//     â–ˆâ–ˆâ–ˆâ–ˆ      â–ˆâ–ˆ          â–ˆâ–ˆâ–ˆâ–ˆ            â–ˆâ–ˆâ–ˆâ–ˆ          â–ˆâ–ˆâ–ˆâ–ˆ
//        ████      ██          ████            ████          ████
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 1 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQMewo7cNLKvSeaHomSapaAeEgPR7TdrXeWD6u49ZjFH9/";
...
contract TestsContract is RamppERC721A {
    constructor() RamppERC721A("Tests", "TESTS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/6cf4mMMgS03iEuXKzkJ1/contract-metadata";
    }
}