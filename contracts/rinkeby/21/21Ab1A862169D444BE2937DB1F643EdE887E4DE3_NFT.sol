...
contract NFT is IERC721Metadata, IERC721Enumerable, Ownable, VRFConsumerBaseV2(0x271682DEB8C4E0901D1a1550aD2e64D568E69909), IERC721W{
  ...
  function openBox() external allowOpen onlyOwner {
      require(_boxOffset >= maxTotalSupply && totalSupply() == maxTotalSupply, "Cat:not sold out or is open");
      //ETH-mainnet
      VRFCoordinatorV2Interface(0x271682DEB8C4E0901D1a1550aD2e64D568E69909).requestRandomWords(0x8af398995b04c28e9951adb9721ef74c74f93e6a478f39e7e0777be13527e7ef,1847,3,300000,1);
      //BSC-testnet
      //VRFCoordinatorV2Interface(0x6A2AAd07396B36Fe02a22b33cf443582f682c82f).requestRandomWords(0xd4bb89654db74673a187bd804519e65e3f71a52bc55f11da7601a13dcf505314,1847,3,300000,1);
  }
