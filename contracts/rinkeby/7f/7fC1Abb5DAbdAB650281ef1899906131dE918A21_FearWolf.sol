...
contract FearWolf is FearWolfBase, ERC721Enumerable, AccessControl, Pausable, OpenSeaCompatible, VRFConsumerBase, IMRC721Metadata {
    ...
    */
    ...
    uint64 private constant MAIN_CHAINID = 80001; // FIXME !! put '1' for Ethereum
    ...
    */
    ...
    // FIXME: REMOVE THIS FUNCTION !!! (it's for testing purposes only or minting on chains without Chinlink VRF [which we don't use])
