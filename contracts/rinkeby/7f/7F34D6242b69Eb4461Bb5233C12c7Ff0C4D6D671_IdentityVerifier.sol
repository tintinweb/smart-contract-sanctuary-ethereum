...
contract IdentityVerifier is AdminControl, IIdentityVerifier {
    ...
    mapping(uint => mapping(address => uint)) public _alreadyMintedPerPerson;
     ...
     */
    function onAllowList(address claimer, bytes32[] memory proof, uint listingId) public returns(bool) {
    ...
    function verify(uint40 listingId, address identity, address, uint256, uint24, uint256, address, bytes calldata data) external override returns (bool) {
