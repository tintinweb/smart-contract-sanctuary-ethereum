...
contract DemonNFT is ERC721A, Ownable, PaymentSplitter {
    ...
    uint256 private constant MAX_WHITELIST = 2222;
    uint256 private constant MAX_PUBLIC = 1333;

    uint256 private constant PRICE_WHITELIST = 0.05 ether;
    uint256 private constant PRICE_PUBLIC = 0.09 ether;

    uint256 public saleStartTime = 1660942128;
    ...
    uint256 private constant MAX_PER_ADDRESS_DURING_WHITELIST = 3;
    uint256 private constant MAX_PER_ADDRESS_DURING_PUBLIC = 5;
    ...
    function whitelistMint(
        ...
        require(
            ...
            "You can only mint 3 NFTs during the whitelist sale"
        );
        require(
    ...
    function publicMint(address _account, uint256 _quantity) external payable {
        ...
        require(
            ...
            "You can only mint 5NFTs during the public sale"
        );
        require(
    ...
    function getStep() public view returns (Step actualStep) {
        ...
        if (
            block.timestamp >= saleStartTime + 2 hours &&
