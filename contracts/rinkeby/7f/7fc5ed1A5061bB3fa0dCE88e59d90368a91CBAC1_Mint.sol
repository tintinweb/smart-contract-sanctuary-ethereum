...
contract Mint is ERC1155, AccessControl, Pausable, ERC1155Burnable {
    ...
    constructor(uint256 price_, uint256 supply_, bool onlyWhitelist_, string memory uri_, uint256 maxPerAddress_) ERC1155("") {
    ...
    {
        return string(
            abi.encodePacked(uri(1), "/", "1", baseExtension)
        );
