...
contract GalacticApes is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "https://galacticapes.mypinata.cloud/ipfs/QmRDdnGJYQhPjq8ebxtsea8cptCUkgZwgBMnq1grW8mWJr/";
    string public baseExtension = "";
     bool public paused = true;   
    
    constructor() ERC721A("GALACTICAPES", "GAPES", MAX_MINTS, MAX_SUPPLY) {  
