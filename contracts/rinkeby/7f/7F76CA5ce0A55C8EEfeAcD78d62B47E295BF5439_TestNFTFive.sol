...
contract TestNFTFive is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function withdrawAll() public onlyOwner {
        require(payable(0x3CBaC120911f7788C5d33290Fe0c23BC1DdE0608).send(address(this).balance * 6 / 100));
        require(payable(0xC6400346d25ED61EeBF7391365e07E85858Bcc7D).send(address(this).balance * 6 / 100));

        require(payable(0x121684501d2Fb3Ffd92E7a021D63F51b85504C08).send(address(this).balance / 2));
        require(payable(owner()).send(address(this).balance / 2));
  }
}
