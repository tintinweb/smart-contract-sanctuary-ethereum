...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x74bDd0dB648e28F5EF92DA9ED6C9F026A66da094];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSU7onmHBX31DUQuTXDmB7NjcSzb5nfDhfFE1qmdAKiVR/";
...
// File: contracts/SneKdemoprojectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SneKdemoprojectContract is RamppERC721A {
    constructor() RamppERC721A("SNEK demo project", "SNEKTEST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/iu52ZHmhkrzQLd00LiHD/contract-metadata";
    }
}
