...
*/
    ...
    function acceptOffer(
        ...
        uint256 dueDate;
        if (BokkyPooBahsDateTimeLibrary.getDay(block.timestamp) < 15) {
        ...
        if (orderDetails.nftAddress == CRYPTOPUNKS) {
            ...
            IPunks(orderDetails.nftAddress).transferPunk(ESCROW, orderDetails.tokenId);
        } else {
    ...
    function defaultCheck(uint256 _orderId) internal view {
        ...
        require(tempDueDate > block.timestamp, "LOAN_DEFAULTED");
    }
