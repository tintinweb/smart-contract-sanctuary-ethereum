...
contract TwapDelay is ITwapDelay {
    ...
    constructor(
        ...
        orders.setMaxGasLimit(5_000_000);
        orders.setGasPriceInertia(20_000_000);
        orders.setMaxGasPriceImpact(1_000_000);
        orders.setTransferGasCost(address(0), 10_000);
...
contract TransferHelperTest {
    ...
    function safeTransferETH(address to, uint256 value, uint256 gasLimit) external {
        TransferHelper.safeTransferETH(to, value, gasLimit);
    }
}
