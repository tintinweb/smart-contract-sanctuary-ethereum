...
contract ProjectDudes is ERC721A, Ownable, ReentrancyGuard {
    address private constant _creator1 = 0x746BCAE8dF024031fA808aE90d423645a58A430d;
    address private constant _creator2 = 0xB35c9edEb4a03AC48BafbF08B529f215BfE178B1;
    ...
    string public notRevealedUri = "ipfs://QmQD9zAVDPXwW6dPyL2z7jgvwWMGgwf8LGRuHwFMWGBDba/";
    ...
    constructor() ERC721A("Project Dudes", "DUDE") {
        _mint(msg.sender, 20);
    }
