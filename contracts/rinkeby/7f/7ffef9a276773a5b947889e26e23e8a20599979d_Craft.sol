...
contract Craft is ERC721, Ownable {
    ...
    function viewGeneralSaleTargetLength() external view onlyOwner returns (uint256) {
        return generalSaleTargetCount;
    }

    function viewPreSaleTargetLength() external view onlyOwner returns (uint256) {
        return preSaleTargetCount;
    }
