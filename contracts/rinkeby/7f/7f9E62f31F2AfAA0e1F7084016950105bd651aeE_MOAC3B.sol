...
contract MOAC3B is ERC721Psi, Ownable, ReentrancyGuard {    
    ...
    constructor() ERC721Psi("MOTHEROFALLCONTRACTS3B", "MOAC3B") {}
    ...
    ////====RESERVE====//// 
    function setTokensReserved(uint256 _tokensReserved) external onlyOwner {
        tokensReserved = _tokensReserved;
    }
    ...
    function mintToken(uint256 _amount) public payable {
            ...
            require(
                maxTokens >= _amount + totalSupply() + tokensReserved,
