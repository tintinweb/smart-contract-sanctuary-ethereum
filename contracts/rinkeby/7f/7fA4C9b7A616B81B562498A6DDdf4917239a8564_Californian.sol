...
contract Californian is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public constant PRICE = 5 * 10**15; // .005 eth
    uint256 public constant MAX_BY_MINT = 5;
    //uint256 public constant LAUNCH_TIMESTAMP = 1632355200; // some timestamp
...
string[] private cities = [
    ...
    function mint(address _to, uint256 _count) public payable {
        ...
        require(total <= MAX_ELEMENTS, "All are sold out");
    ...
    constructor() ERC721("Californian3", "CALI4LIFE3") Ownable() {}
}
