...
contract AventorsNFT is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mintPreSaleTokens(uint8 quantity) external payable callerIsUser nonReentrant {
    ...
    function publicSaleMint(uint256 quantity) external payable nonReentrant callerIsUser {
