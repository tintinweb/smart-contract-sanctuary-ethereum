...
contract JupiterNFT is ERC721Enumerable, IERC2981, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("JupiterNFT", "JTNFT") {
    ...
    function setSensor(uint256 _tokenId, uint256 field1, uint256 field2, uint256 field3, uint256 field4) public {
        require(ownerOf(_tokenId) == msg.sender);
        sensors[_tokenId].field1 = field1;
        sensors[_tokenId].field2 = field2;
        sensors[_tokenId].field3 = field3;
        sensors[_tokenId].field4 = field4;
    }
