...
abstract contract ERC721Basic is ERC165Upgradeable {
  ...
  function getApproved(uint256 _tokenId)
    ...
    public view  virtual returns (address _operator);
...
abstract contract ERC721Upgradeable is  ERC721EnumerableUpgradeable, ERC721MetadataUpgradeable {
...
abstract contract ERC721BasicToken is ERC165Support, ERC721Basic {
...
abstract contract  EstateEvents{
...
abstract contract LANDRegistry {
  ...
  function decodeTokenId(uint value) external pure virtual  returns (int, int);

  function updateLandData(int x, int y, string memory  data) external virtual ;

  function setUpdateOperator(uint256 assetId, address operator) external virtual ;

  function setManyUpdateOperator(uint256[] memory  landIds, address operator) external virtual;
...
contract EstateRegistry is  EstateEvents,ERC721Token, ERC721ReceiverUpgradeable, EstateStorage {
  ...
  */
  ...
  function _supportsInterface(bytes4 _interfaceId) internal pure  override returns (bool) {
