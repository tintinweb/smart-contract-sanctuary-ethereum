...
// Source Video: https://www.youtube.com/watch?v=VPrSnLdE-A0&ab_channel=CodePulse
...
contract WorldsOfTrains is ERC721Upgradeable, PullPaymentUpgradeable, OwnableUpgradeable {
    ...
    // Constants
    uint256 public constant TOTAL_SUPPLY = 11_111;
    uint256 public constant MIN_MINT_PRICE = 0.1 ether;

    //constructor() ERC721("WorldsOfTrains", "WOFT") {}

    function initialize() initializer public {
        __ERC721_init("WorldsOfTrains", "WOFT");
        __PullPayment_init();
        __Ownable_init();
    }
        ...
        returns (uint256)
    {
        ...
        //require(msg.value >= MIN_MINT_PRICE, "Transaction value is lower then minimum mint price");
