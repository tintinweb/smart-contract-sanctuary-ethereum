...
// File: contracts/BullAndBear.sol
...
contract BullAndBear is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, KeeperCompatibleInterface, VRFConsumerBaseV2 {
    ...
    */
    ...
    constructor(uint updateInterval, address _priceFeed, address _vrfCoordinator, uint64 subscriptionId) ERC721("Bull&Bear", "BBTK") VRFConsumerBaseV2(_vrfCoordinator) {
