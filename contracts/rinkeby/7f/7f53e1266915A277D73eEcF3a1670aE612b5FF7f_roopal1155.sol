...
// SPDX-License-Identifier: MIT// File: @openzeppelin/contracts/utils/Strings.sol
...
contract roopal1155 is ERC1155Supply, Ownable {
    ...
    uint [] mintednfts;
    uint maxSupply=17;
    uint256 public nftPrice=200000000000000000 wei; //0.2 ETH
   ...
   function _baseURI()  internal view returns(string memory) {
    ...
    function mint(uint256 id, uint256 amount)public payable{
        ...
        require(!exists(id),"Token Id already minted");
        require(_checkCassette(msg.sender) , "Cannot mint more than 1 cassette");
        require(id >=1  && id <=17,"Token Id must be between 1-17");
        require(nftPrice<=msg.value, "Ether value sent is incorrect.Need 0.2 ETH for each NFT");
        require(mintednfts.length < maxSupply,"Collection sold out");
