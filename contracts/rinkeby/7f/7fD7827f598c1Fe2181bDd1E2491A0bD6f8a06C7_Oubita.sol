...
// File: contracts/NFToubitaRInkeby.sol
...
contract Oubita is ERC721, Ownable {
   ...
   //uint256 public NFTperAddressLimit= 20;
    ...
    uint public costMatic_Whitelist = 1000000000000000000;
    uint public costMatic_Special = 5000000000000000;
    uint public costMatic_Normal = 10000000000000000;
    ...
    function multiTokensTransfer(address _to, uint _type, uint _amount, uint _counter, uint _pago) public payable{
        if(_type == 1){
            if(onlyWhitelisted == true){
                ...
                require(msg.value >= costEth_Whitelist * _amount, "You dont have enough balance");
            }else if(_counter < specialSale){
                
                require(msg.value >= costEth_Special * _amount, "You dont have enough balance");
            }else if(_counter >= specialSale){
                
                require(msg.value >= costEth_Normal * _amount, "You dont have enough balance");
            }
