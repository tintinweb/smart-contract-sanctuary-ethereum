...
contract TheII is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public saleCost = 0.2 ether;
  ...
  constructor() ERC721A("THEII", "THEII") {
    setUriPrefix("");
    setHiddenMetadataUri("https://ipfs.io/ipfs/QmQ6PyFPyLVpUNTs1GqdJEozndwafKogo3vsTE1YZjrc3q/hidden.json");
  }
