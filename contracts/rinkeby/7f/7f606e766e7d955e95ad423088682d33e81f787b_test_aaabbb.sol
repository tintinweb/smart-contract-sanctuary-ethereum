...
contract test_aaabbb is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 private allowListMintAmount = 5;
    ...
    function allowListMint(uint256 quantity, bytes32[] memory proof) external payable {
        ...
        require(totalSupply() + quantity <= allowListMintAmount, "reached max supply");
    ...
    function mint(uint256 tokenQuantity) public payable {
        require(
            totalSupply() + tokenQuantity <= MAX_SUPPLY - Geshu,
    ...
    function mintowner(uint256 tokenQuantity) public payable onlyOwner {
        ...
        require(tokenQuantity <= MAX_SUPPLY, "Can only mint 1 tokens at a time");
    ...
    function setGeshu(uint256 _Geshu) public onlyOwner {
        Geshu = _Geshu;
    }
