...
contract LL420BudStaking is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// bud id => bonus id
    mapping(uint256 => bool) private _startBonus;
     ...
     */
    function _withdrawGameKey(uint256[] memory _ids) internal onlyStarted {
    ...
    function setTHC(uint256[] calldata _ids, uint256[] calldata _thc) external {
        ...
        require(revealContractAddress == _msgSender(), "LL420BudStaking: Only able to call from reveal contract");
