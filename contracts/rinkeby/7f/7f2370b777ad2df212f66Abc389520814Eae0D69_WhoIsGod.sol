...
contract WhoIsGod is ERC721A {
    ...
    uint256 public price = .006 ether;

    string public cid = "QmSZqi78RjWsk6MGVbJGoeVfb8t8FzXasgGypuzbF6hMLb";
    ...
    {
        if (!reveal)
            return string(abi.encodePacked("ipfs://", cid, "/prereveal.json"));
        else
            return
                string(
                    abi.encodePacked(
