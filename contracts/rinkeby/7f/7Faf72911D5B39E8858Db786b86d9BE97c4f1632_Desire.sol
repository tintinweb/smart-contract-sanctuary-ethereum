...
contract Desire is DesireBase {
    ...
    uint256 public constant _preserveTokenIdStart = 1;
    ...
    function _safeMintWrapper(address to, uint256 tokenId) internal {
        // check totalSupply
        require(mintedAmount < totalSupply, "no remaining");
    ...
    //         _safeMintWrapper(receivers_[i], start_ + i);
    //     }
    //     emit Airdrop(receivers_, start_);
    // }
