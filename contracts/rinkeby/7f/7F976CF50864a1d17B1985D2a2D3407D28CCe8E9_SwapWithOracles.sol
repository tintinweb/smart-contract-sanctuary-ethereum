...
contract SwapWithOracles is OwnableUpgradeable, ERC2771ContextUpgradeable {
    ...
    function swap(bytes32 pairHash, uint256 fromAmount, uint80 oracleRoundId, bytes32 operationId) external pairHashExist(pairHash) {
        ...
        uint256 toAmountFromPrimary = (fromAmount * 10 ** decimals) / uint256(answer);
        ...
        pair.fromToken.operateTransferFrom(_msgSender(), _platform, (fromAmount / COMMISSION_EXPONENT) * pair.commission);
