...
contract Escrow {
  ...
  function transaction(address _seller, uint _tx_id) external view returns (uint256, address) {
    return ( balances[_seller][_tx_id].amount, balances[_seller][_tx_id].buyer );
  }
