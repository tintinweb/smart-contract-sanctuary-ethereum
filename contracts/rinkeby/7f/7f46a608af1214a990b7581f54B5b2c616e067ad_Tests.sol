...
contract Tests is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.0035 ether;
  uint public          maxPerTx          = 2;
  uint public          totalFree         = 3;
  uint public          maxSupply         = 7777;
  bool public          mintEnabled       = true;

  constructor() ERC721A("Test Title", "TST"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on zombie");
    require(totalSupply() + amount < maxSupply + 1,"No more zombies");
