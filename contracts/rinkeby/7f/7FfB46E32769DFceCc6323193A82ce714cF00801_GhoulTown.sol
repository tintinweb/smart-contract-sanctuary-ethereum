...
contract GhoulTown is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public salePriceETH = 0.0035 ether;      // the amount of ETH per token
    ...
    constructor() ERC721A("GhoulTown", "GHOUL") {}
