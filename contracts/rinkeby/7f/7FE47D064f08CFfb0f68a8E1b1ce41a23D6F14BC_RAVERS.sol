...
contract RAVERS is Context, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Random Ravers", "RAVERS") {
        _nftPrice = 20000 * 10 ** 12;
        WHITELIST_SIGNER = address(0xbd1E20093875748A8CF0a2839C8Ef3B21465Ac45);
    }
