...
contract TEST is Ownable, ERC721, NonblockingReceiver {
 ...
 function getFeatureColors(uint256 _tokenId, uint256 index) public view returns(uint256) {
 return features[_tokenId].colors[index];
 }

 function getFeatureColorSelectors(uint256 _tokenId, uint256 index) public view returns(uint256) {
 return features[_tokenId].colorSelectors[index];
 }
