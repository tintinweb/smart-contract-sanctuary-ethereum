...
contract ScotchNoblemen is  Initializable, ERC721AUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, uint256 _maxMints,uint256 _maxSupply,string memory _baseUri) public initializer {
   ...
   function _authorizeUpgrade(address) internal override onlyOwner {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(mintRate > 0, "NFT price not set");
