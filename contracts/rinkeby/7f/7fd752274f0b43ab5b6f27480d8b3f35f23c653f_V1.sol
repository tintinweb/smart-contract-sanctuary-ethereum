...
contract V1 is ERC721A, ReentrancyGuard {
    ...
    uint public constant PRICE_FOR_BAYC_HOLDERS = 0.05 ether;
    ...
    function mint(uint256 _quantity) external payable nonReentrant {
        ...
        if(IERC721(BAYC_CONTRACT_ADDRESS).balanceOf(msg.sender)>0){
            require(msg.value>=PRICE_FOR_BAYC_HOLDERS * _quantity,"BAYC holders need to pay 0.05 eth per NFT");
        }
