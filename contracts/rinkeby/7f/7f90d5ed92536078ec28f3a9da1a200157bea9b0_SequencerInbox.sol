...
contract SequencerInbox is ISequencerInbox, Cloneable {
    ...
    function postUpgradeInit() external {
        ...
        //
        // reddit local & staging settings
        // isSequencer[0xcc81BD08e069c2c6796E76880628b11a40d51f16] = true;
        // maxDelayBlocks = 3000;
        // maxDelaySeconds = 45000;
        //
        // reddit rinkeby settings
        isSequencer[0xB55aAa698240d5467848975262cEF9996F604792] = true;
        maxDelayBlocks = 100000;
        maxDelaySeconds = 1500000;
    }
