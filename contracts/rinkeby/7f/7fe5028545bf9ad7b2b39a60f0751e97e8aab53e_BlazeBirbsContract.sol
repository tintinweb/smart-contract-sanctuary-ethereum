...
//
//     ____  __                    ____  _      __            
//    / __ )/ /___ _____  ___     / __ )(_)____/ /_  _____    
//   / __  / / __ `/_  / / _ \   / __  / / ___/ __ \/ ___/    
//  / /_/ / / /_/ / / /_/  __/  / /_/ / / /  / /_/ (__  )     
// /_____/_/\__,_/ /___/\___/  /_____/_/_/  /_.___/____/      
//                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3Df35905D51282fe19Cc2ee7626Adb0575ebB3bF];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmavszw74crUZSTHAU5GqhWrkotVaELFhzRB43s9kFtFio/";
...
// File: contracts/BlazeBirbsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BlazeBirbsContract is RamppERC721A {
    constructor() RamppERC721A("Blaze Birbs", "BIRB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/aZvFRsPoeZlJkcfM6IVM/contract-metadata";
    }
}
