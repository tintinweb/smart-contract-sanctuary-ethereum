...
contract Originals99 is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    uint256 private constant DURATION = 3 minutes;
    uint256 private constant DURATION_EXTENSION = 2 minutes;
    uint256 private constant DURATION_EXTENSION_ALLOWED_BEFORE_END = 2 minutes;
