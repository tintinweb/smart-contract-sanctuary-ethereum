...
contract ERC721PresetMinterPauserAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Pausable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol, maxBatchSize>1?maxBatchSize:1, collectionSize>1?collectionSize:1) {       _baseTokenURI = baseTokenURI;
    ...
    // tokenofownerbyindex is not used in this contract but we have to override this to solve inheritace contract
      function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override(ERC721, ERC721Enumerable) returns (uint256){
...
contract boredcryptoapes is ERC721PresetMinterPauserAutoId {
    ...
    constructor() ERC721PresetMinterPauserAutoId("Dave Starbelly", "https://storage.googleapis.com/opensea-prod.appspot.com/puffs/3.png", "https://openseacreatures.io/3") {}
