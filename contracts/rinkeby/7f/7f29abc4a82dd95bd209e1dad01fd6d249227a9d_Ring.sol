...
contract Ring is ERC721, Ownable, ERC721Enumerable {
    ...
    event RingMinted(uint256 tokenId, address owner);

    constructor() ERC721("Ring", "RG") {}
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
        {
            ...
            if (isRevealed == false) {
                return
                "ipfs://QmWEPK9jjLhSckNX3UJvAsKZLhT95YPCSrmJhvzBTF4V82/ringgif500.json";
                }
