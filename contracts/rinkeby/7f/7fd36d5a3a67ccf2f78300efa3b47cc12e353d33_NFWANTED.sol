...
contract NFWANTED is ERC721A, Ownable, ERC2981 {
    uint256 public price = 0.002 ether;
    uint256 public presalePrice = 0 ether;
    uint256 public constant publicPrice = 0.002 ether;
    uint256 public maxPerWallet = 60;
    uint256 public maxPerTransaction = 10;
    uint256 public presaleMaxPerWallet = 60;
    ...
    address[] public withdrawAddresses = [0x0d66dd415bA734a98b743156589560f24995E3a7];
    ...
    function mint(uint256 qty) external payable {
        ...
        if (presaleSupply > totalSupply()) {
            ...
            if ((qty + totalSupply()) > presaleSupply) revert NotEnoughFreeMintsLeft();
        ...
        }else{ if (presaleSupply <= totalSupply()) {
            if (saleState != SaleState.OPEN) revert SaleInactive();
            if (_currentIndex > maxSupply) revert SoldOut();
