...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant ANONYMOUS_VOTING_DURATION_CONTRACT = 3600;
    uint256 internal constant ANONYMOUS_VOTING_DURATION_EXCHANGE = 3600;

    uint256 internal constant EXPOSE_VOTE_DURATION = 3600;
    uint256 internal constant PRIVATE_CLAIM_DURATION = 10800;
