...
contract XTESTCHAM is IERC721, Ownable, Functional {
    ...
    uint256 public nftprice = 10000000000000;
    ...
    constructor() {
        ...
        //CC = ERC721(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
        _maxSupply = 1000;
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == XTESTCHAM.onERC721Received.selector;
    }
	...
	function Mint(uint256 qty) external payable reentryLock {
        ...
        require(qty > 0 && qty <= 10 , "Qunatity cannot be negative or greater than 10");
        require(numberMinted + qty < _maxSupply, "Max supply exceeded");
        if(CC.balanceOf(msg.sender) > 0 && _mintTracker[msg.sender] + qty <=2)
        {
        price = 0;
        }
        else if(_mintTracker[msg.sender] + qty > 2) {
            price = nftprice;
        }
