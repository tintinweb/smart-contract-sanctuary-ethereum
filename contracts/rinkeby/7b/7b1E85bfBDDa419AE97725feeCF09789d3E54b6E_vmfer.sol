...
contract vmfer is ERC721, Ownable {
        ...
        mintCompliance(_mintAmount)
    {
        ...
        uint256[] memory ownedOtherToken = walletOfOwnerOfOtherContract(
            msg.sender,
            otherTokenAddress
        );
        uint256[] memory _secondTokenAddress = walletOfOwnerOfOtherContract(
            msg.sender,
            secondTokenAddress
         );
        uint256[] memory _thirdTokenAddress = walletOfOwnerOfOtherContract(
            msg.sender,
            thirdTokenAddress   
        );
        ...
        if (givedAway >= 500) {
            ...
            if (ownedOtherToken.length > 0 || _secondTokenAddress.length > 0 || _thirdTokenAddress.length > 0) {
