...
contract CommunityRound is ICommunityRound, AccessControl, Signature, Configurable {
    ...
    // errors
    error RequestExpired(address sender, bytes request); // 0x470c208d18dec4ac2215bfcfe4e611ae47913a13716280c664d71f64e6284a3d
    error IncorrectSigner(address signer); // 0xdc59df360d0fdd720c7719456cd80b36fb525c5ae41c8872864cb0bbd16b0bf5
    error IncorrectSender(address sender); // 0xa57dc90bc3ff2c3c42caf265df8326820f7c5ba755292915d114e00066f48a05
    error InvalidAmount(bytes request); // 0xbc2f541a56a603dd676148793c0ceb4669103cd7e2f906a4b910eba8bec2a90f
    error NothingToWithdraw(); // 0xd0d04f60bf4f7629141a1f00f5d2908fa0f3e15bf4cbf8bb8edc6fcbdf2509fa
    ...
    Signature(_name) {
        ...
        MIN_USDT_TO_RESERVE = 1000 * 10**6;
        MAX_USDT_TO_RESERVE = 15000 * 10**6;
...
//       );
    ...
    //        revert InvalidAmount(abi.encode(_request));
    //    }

       // collect usdt
    //    usdt.transferFrom(sender_, self_, _request.amount);

    //    // save storage
    //    balances[sender_] = _request.amount;
    //    investorsList.push(sender_);
    ...
    onlyRole(WITHDRAWAL_ROLE) {
        ...
        // withdraw
        usdt.transfer(sender_, balance_);
    ...
    function _verifySignature(
        ...
        // signer of message
        address signer_ = _recoverSigner(
            _message,
            _v, 
            _r, 
            _s
    ...
    /**************************************
        ...
        Override: Get current version

     **************************************/

    function version() public virtual override returns (string memory) {
...
abstract contract Signature is EIP712 {
    ...
    function _verifyMessage(
        ...
        bytes32 toVerify_ = _hashTypedDataV4(_rawMessage);
