...
contract TestERC721 is ERC721, Pausable, Ownable {
    ...
    uint64 private constant maxMintsPerAddress = 4;
    uint64 private constant maxPrivateMintsPerAddress = 2;
    uint64 private constant maxPresaleMintsPerAddress = 1;
    ...
    function mint(uint64 amount, Coupon memory coupon)
        ...
        if (phase == SalePhase.Private) {
            ...
            require(
                ...
                "you can only mint NFTs during Private sale"
            );
