...
contract PocketDimension is ERC721A, Ownable, Pausable, ReentrancyGuard, IERC2981 {
    ...
    uint256 public constant MAX_INTERNAL_SUPPLY = 700;
    ...
    constructor(string memory _baseContractURI, string memory _tokenSuffixURI, uint256 _saleStartTime) ERC721A("DevTest", "dete") {
        ...
        privatesaleEndsAt = saleStartsAt + 0 minutes; // End of Day 1, April 17, 2022 08:59:59 am PST
        publicsaleStartsAt = saleStartsAt + 11 minutes;  // Start of Day 2, April 17, 2022 09:00:00 pm PST
        publicsaleEndsAt = saleStartsAt + 20 minutes;  // End of Day 2, April 18, 2022 08:59:59 am PST
    }
