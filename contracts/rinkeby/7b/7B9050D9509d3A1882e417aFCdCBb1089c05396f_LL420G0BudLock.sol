...
contract LL420G0BudLock is Ownable {
    ...
    mapping(uint256 => uint256) _playerBurntAmount;
     ...
     * @param _key The id of the game key
     */
    function burnG0Buds(
        uint256 _male,
        uint256 _female,
     ...
     *
     * @param _key Game key id
     */
    function burntAmount(uint256 _key) external view returns (uint256) {
        return _playerBurntAmount[_key];
    }
