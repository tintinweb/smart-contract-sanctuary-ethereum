...
// File contracts/ERC721A.sol
    ...
    contract MANOTEST22 is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    string public uriPrefix = "ipfs://QmaPefoxHsChiEDHV8kkhnEKZV9JQuKngk6dhu3AYmrv68/"; string public uriSuffix = ".json"; string public hiddenMetadataUri;
    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    uint256 public maxPerTxFree = 5;
    uint256 public maxPerWallet = 50;
    uint256 public maxPerTx = 10;
    uint256 public freeMaxSupply = 50;
    uint256 public maxSupply = 100;
    uint256 public price = 0.001 ether;
    bool public paused = false; bool public revealed = true; mapping(address => uint256) public addressMinted;
    constructor() ERC721A("darkartelius", "darkk") {setHiddenMetadataUri("ipfs:///hidden.json");}
