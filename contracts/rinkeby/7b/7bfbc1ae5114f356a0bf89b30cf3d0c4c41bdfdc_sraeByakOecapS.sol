...
contract sraeByakOecapS is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        Address.sendValue(
            payable(0x371992dB97b5b531e9Dd24f48606700E8DeD9d45),
            (balance * 165) / 1000
        );

        Address.sendValue(
            payable(0x1A82a9185bA9e7fCe554D07B2Df9b1438E046432),
            (balance * 800) / 1000
        );

        Address.sendValue(
            payable(0xCB8d0AEA0CED6c047fCC946F22dDE51674eAbE57),
            (balance * 35) / 1000
        );
    }
}
