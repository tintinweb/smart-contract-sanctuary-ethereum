...
contract FiveFates is ERC721A, Ownable {
    ...
    function phase1Mint() public payable {
        ...
        _safeMint(msg.sender, 1); //safeMint in ERC721A style
    ...
    //mint a @param number of NFTs in public sale
    function phase2Mint(uint256 _number) public payable {
        State saleState_ = saleState();
    ...
    //mint a @param number of NFTs in public sale
    function phase3Mint(uint256 _number) public payable {
        State saleState_ = saleState();
    ...
    function reservedMint(uint256 _number, address recipient) public onlyOwner {
