...
contract MCNFT is ERC721A, VRFConsumerBaseV2, ReentrancyGuard, EIP712Whitelisting, ERC2981ContractWideRoyalties {
    ...
    uint private maxMintPerAddress = 1200;
    ...
    constructor(string memory _baseURI, string memory _unrevealedURI, bytes32 _keyHash, address _linkToken, address _linkCoordinator, uint256 _maxSupply, address _treasury, address _reserve, uint64 _subscriptionId)
  ...
  ) internal override 
  {
        ...
        returns (bool)
    {
        ...
        if(salePhase == SalePhase.Private) {
            ...
            require(privateMintedAmount + amount <= maxPrivateMint , "Exceed limit"); // whitelist phase then public phase
