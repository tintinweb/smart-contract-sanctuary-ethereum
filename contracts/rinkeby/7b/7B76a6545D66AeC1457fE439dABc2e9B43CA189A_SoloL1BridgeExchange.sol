...
contract SoloL1BridgeExchange is PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    */
    function finalizeSellOrder(
        ...
        require(
            msg.value >= _price,
            "L1BridgeExchange: Insufficient ETH amount sent with transaction."
        );

        require(
            // ERC-721 identifier
            ERC165CheckerUpgradeable.supportsInterface(_l1ERC721, 0x80ac58cd),
            "L1BridgeExchange: L1 ERC721 must support the EIP-165 ERC721 interface."
        );
        
        require(
            IL1CancellationRegistry(l1CancellationRegistry).getCancelledOrderBlockNumber(_seller, _l1ERC721, _tokenId) < _createdAtBlockNumber,
        ...
        uint256 sellerPayout = _price - royaltyPayout;
