...
contract PiratePalsV2Test is Mintable, PaymentSplitterUpgradeable, IERC2981Upgradeable {
    ...
    uint256 public constant CONTRACT_VERSION = 1; // Original is 0
    uint256 private _contractVersion;
    ...
    modifier upgrader(uint256 version) {
        require(_contractVersion == version - 1, "Upgrader: invalid version");
        _contractVersion = version;
        _;
    }

    modifier contractUpToDate() {
        require(_contractVersion == CONTRACT_VERSION, "Upgrader: not up to date");
        _;
    }

    function initializeUpgrade1() public onlyOwner upgrader(1) {
        someValueFromUpgrade = "value from upgrade 1";
    }

    function someMethodFromUpgrade() external view contractUpToDate returns (string memory) {
...
abstract contract Config {
    ...
    string public constant UNREVEALED_URI = "ipfs://QmXAAj4AHgLBKf6pXmytMjs9PUHk4LQzL7BJm7Epihmc23";
