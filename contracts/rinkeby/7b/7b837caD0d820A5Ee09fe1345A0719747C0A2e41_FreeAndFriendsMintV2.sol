...
contract FreeAndFriendsMintV2 is Ownable, Pausable {
    ...
    constructor() {
        address EwalksMiamiAddress = 0xB37BCD515567bbAF0b3e9F205858b8C4d591F9b9; //0xD56814B97396c658373A8032C5572957D123a49e;
        ewalksMiami = ETHWalkersMiami(EwalksMiamiAddress);
        address ETHWalkersMintPassAddress = 0xc0712497b9029673e938864cF52843087cAcAf33; //0x7eCa22913103e4a9D92b1FfD892b86d1906093E5;
    ...
    function friendsAndFreeETHWalkersMiamiMint(uint8 numberOfTokens, address originAddressRedeemed) external whenNotPaused {
        ...
        require(originAddressNumberMinted[originAddressRedeemed] < ((ewalksMiami.balanceOf(originAddressRedeemed) * 4) + (ewalksMintPass.balanceOf(originAddressRedeemed) * 12))+1, "Not enough left to claim");
