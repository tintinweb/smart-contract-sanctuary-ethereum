...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Fantastic", "Bombastic", "Terrible", "Fancy", "Posh", "Gnarly"];
    string[] secondWords = ["Pizza", "Milkshake", "Smoothie", "Pancake", "Blueberry", "Muffin"];
    string[] thirdWords = ["Goku", "Sasuke", "Naruto", "Killua", "Hisoka", "Kurapika"];
