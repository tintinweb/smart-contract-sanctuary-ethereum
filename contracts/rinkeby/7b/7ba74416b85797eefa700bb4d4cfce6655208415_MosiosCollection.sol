...
contract MosiosCollection is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NAMosios Hard CollectionME", "MHC") {
    setHiddenMetadataUri("ipfs://QmaiGbYPr8139FxaZDmq6FU3xkKay7quLVfkWP5LwvkE4K/hidden.json");
  }
