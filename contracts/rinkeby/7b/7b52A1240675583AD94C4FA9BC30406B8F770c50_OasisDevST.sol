...
contract Token is IToken, AgentRoleUpgradeable, TokenStorage {
     ...
     *  @param _valuation the initial valuation of the property we are issuing tokens for
    ...
    function pricePerToken() external view returns(uint256) {
        uint numTokens = _totalSupply / (10 ** tokenDecimals);
        return valuation / numTokens;
    }
}
...
contract TokenStorage {
    ...
    uint internal valuation;
    uint internal initSupply;
