...
contract Renderer {
    ...
    function render(uint256 _tokenId) public view returns (string memory) {
        return string.concat(
            '<svg width="320" height="320" viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges" style="border-radius:10px">',
            svg.el(
                'defs',
                utils.NULL,
                svg.linearGradient(
