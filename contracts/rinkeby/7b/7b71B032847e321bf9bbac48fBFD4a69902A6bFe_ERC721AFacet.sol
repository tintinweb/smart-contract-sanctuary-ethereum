...
contract ERC721AFacet is Context, Initializable, Modifiers {
    ...
    function totalSupply() external view returns (uint256) {
        return LibAppStorage.diamondStorage().erc721Contracts[address(this)].totalSupply();
    }
    ...
    function balanceOf(address owner) external view returns (uint256) {
        return LibAppStorage.diamondStorage().erc721Contracts[address(this)].balanceOf(owner);
    }
    ...
    function ownershipOf(uint256 tokenId) internal view returns (TokenOwnership memory) {
        return LibAppStorage.diamondStorage().erc721Contracts[address(this)].ownershipOf(tokenId);
    }
    ...
    function getApproved(uint256 tokenId) external view returns (address) {
        return LibAppStorage.diamondStorage().erc721Contracts[address(this)].getApproved(tokenId);
    }
    ...
    function setApprovalForAll(address operator, bool approved) external {
        ...
        LibAppStorage.diamondStorage().erc721Contracts[address(this)].
    ...
    function isApprovedForAll(address owner, address operator) public view virtual returns (bool) {
        return LibAppStorage.diamondStorage().erc721Contracts[address(this)].isApprovedForAll(owner, operator);
    }
    ...
    function _mint(
        ...
        LibAppStorage.diamondStorage().erc721Contracts[address(this)]._mint(msg.sender, to, quantity, _data, safe);
    }
    ...
    function _transfer(
        ...
        LibAppStorage.diamondStorage().erc721Contracts[address(this)]._transfer(msg.sender, from, to, tokenId);
    }
    ...
    function _burn(uint256 tokenId) internal virtual {
        LibAppStorage.diamondStorage().erc721Contracts[address(this)]._burn(tokenId);
    }
    ...
    function _approve(
        ...
        LibAppStorage.diamondStorage().erc721Contracts[address(this)]._tokenApprovals[tokenId] = to;
