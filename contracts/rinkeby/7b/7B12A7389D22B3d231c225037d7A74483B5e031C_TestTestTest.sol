...
contract TestTestTest is ERC721ATradable, Ownable, ReentrancyGuard {
     enum Status {
        Pending,
        PreSale,
        PublicSale,
    ...
    ) ERC721A("TestTestTest", "TTT") ERC721ATradable(_proxyRegistry) {
        baseURI = initBaseURI;
...
/// @dev Important issue: https://github.com/chiru-labs/ERC721A/issues/40#issuecomment-1024861728
