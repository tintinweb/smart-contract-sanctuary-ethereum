...
// File: contracts/ProspectorsNFTstaking.sol
...
contract ProspectorsNFTstaking {
    ...
    function callStakeToken(address token, uint _tokenID) public {
        require(token == 0x33359aA6A1215120647b8B07cF3F6759CF498e2C, "incorrect NFT to stake"); // hardcode the NFT smart contract to allow only specific NFT into staking
