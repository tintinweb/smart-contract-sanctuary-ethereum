...
import "erc721a/extensions/ERC721AQueryableUUPSUpgradeable.sol";
import "erc721a/extensions/ERC721ABurnableUUPSUpgradeable.sol";
import "erc721a/extensions/ERC721AGoverenedUUPSUpgradeable.sol";
    ...
    ERC721AGoverenedUUPSUpgradeable
{
    ...
    function mintTo(address receiver_, uint256 quantity_) external isRefunding onlyRole(MINTER_ROLE) {
        require(receiver_ != address(0), "SneakyGenesis: cannot mint to zero address");
    ...
    */
    ...
    function unflagPass(uint256 tokenId_) external managed {
        require(_exists(tokenId_), "SneakyGenesis: token does not exist");
    ...
    */
    ...
    modifier managed() {
        require(hasRole(MANAGER_ROLE, msg.sender) || hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "SneakyGenesis: not authorized");
        _;
    }
}
