...
contract Boredpeep is ERC721A, Ownable {
  string _baseTokenURI;
  string public _notrevaleduri;
  ...
  constructor(string memory baseURI) ERC721A("Bored Kingz", "BK") {
    setBaseURI(baseURI);
  }
