...
// File: contracts/Copy_Numberz.sol
     ...
     ReentrancyGuard 
{
  ...
  bytes32 public merkleRoot = 0xf761de1c36a2836f391bc5cf2bd486e7100bb5f635041df962aaa1bae2e1b039;
  mapping(address => bool) public addressClaimed; // An address can mint only once

  string public uriPrefix = '';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri = "ipfs://QmVeRtmqCahQ1TvCsuVo2DVxtU2aKCvEoux6kTNeot4Ew2/hidden.json";  // add hidden metadata URL here
  
  uint256 public cost = 0.01 ether;
  uint256 public maxSupply = 4; // +1 to save on gas cost of <= vs <

  bool public paused = false;
  bool public revealed = false;

  constructor() 
  ERC721A("Numberz", "NUMBERZ") {
...
//IERC2981 Royalty Standard
        ...
        external view override returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (owner(), (salePrice * 500) / 10000); // 500 is 5%
    }                                                
