...
contract Test is Ownable, ReentrancyGuard, ERC721A {
    using Strings for uint256;

    uint256 public publicPrice = 0.005 ether;
    uint64 public publicPerWallet = 20;
    uint64 public maxSupply = 10000;

    bool public isPublicSaleActive;
    mapping(address => uint256) public minted;

    constructor() ERC721A("Test", "GL") {
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "ipfs://QmQkVnnXvkqLFwVhctacBqvXfG5zZojHyK9VM2XGASNUGe";
    }
