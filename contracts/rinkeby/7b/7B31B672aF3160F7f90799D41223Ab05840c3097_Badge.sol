...
contract Badge is ERC721, Ownable, AccessControl {
  ...
  event UpdatedOpCoMinterRoot(address _opCo, bytes32 _minterRoot, address[] _minterAdresses);
  ...
  function updateMinterRoot(
    ...
    emit UpdatedOpCoMinterRoot(msg.sender, _minterRoot, _minterAddresses);
