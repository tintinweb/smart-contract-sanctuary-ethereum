...
//  import "IUniswapV2Pair.sol";
 ...
 import "Itest_flash.sol";



contract test_flash is Itest_flash {

  //uniswap factory address
  address public factory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f ;
  function adrs() public view returns(address){
      return factory;
  }
  function trade(address token0, address token1, uint amount0, uint amount1) external override{
  ...
  function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) external {
    ...
    //   token.approve(address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506), amountTokenBorrowed);
...
interface Itest_flash {
    function trade(address token0, address token1, uint amount0, uint amount1) external;
