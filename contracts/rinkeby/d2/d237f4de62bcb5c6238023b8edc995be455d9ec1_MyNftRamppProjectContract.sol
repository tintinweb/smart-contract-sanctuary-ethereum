  ...
  function _beforeTokenTransfer(
    ...
    contract MyNftRamppProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My NFT Rampp Project", "RAMPPETH", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://something.com/token/";
        }

        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/YUOSd2NopiA5ka4Sog2M/contract-metadata";
        }
    }