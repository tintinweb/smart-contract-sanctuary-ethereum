...
contract NoWarNFT is ERC1155Supply, Pausable, Ownable {
    ...
    mapping(uint256 => iAsset) private _tokenContract;
    ...
    function setURIContract(uint256 _id, iAsset _contract) public onlyOwner {
    ...
    {
        if(_tokenContract[_id] == iAsset(address(0x0))) return "";
        return
            string(
                abi.encodePacked(
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        ...
        if(_tokenContract[_id] != iAsset(address(0x0))) {
