...
contract Originals99 is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    uint256 private constant DURATION = 86400; //15 minutes;
    uint256 private constant DURATION_EXTENSION = 900; //5 minutes;
    uint256 private constant DURATION_EXTENSION_ALLOWED_BEFORE_END = 900; //5 minutes;
