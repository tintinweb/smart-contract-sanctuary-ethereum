...
// File: contracts/marketplace/market.sol
...
contract Marketplace {
  ...
  ERC1155 token_contract = ERC1155(0x4e4604B8EedAbD452f2106A31fd11dbb6fB23d2a); // Replace with NFT Smart Contract address

  function addListing(uint price) public
  {
    listings[listing_count] = Listing(msg.sender, true, price);
  ...
  function buy(uint listing_id) public payable
  {
    ...
    listings[listing_id].is_active = false;
    token_contract.safeTransferFrom(address(listings[listing_id].owner), msg.sender, 1, 1, "");
