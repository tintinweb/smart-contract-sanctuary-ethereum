...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    event Lottery_State(uint256 lottery_state);
    ...
    constructor(
        ...
        usdEnteryFee = 50 * 10**18; //Wei Standard
    ...
    function enter() public payable {
        ...
        require(msg.value >= getEnteranceFee(), "Not Enought Eth...");
        players.push(payable(msg.sender));
    }

    function getEnteranceFee() public view returns (uint256) {
        (, int256 price, , , ) = ethUsdPriceFeed.latestRoundData(); //8 decimals
        //$50 , 3486.36 usd per Eth
    ...
    function getLotteryState() public {
        emit Lottery_State(uint256(lottery_state));
    }

    function startLottery() public onlyOwner {
        require(
            lottery_state == LOTTERY_STATE.CLOSED,
            "cant open a lottery yet !!"
        );
    ...
    function endLottery() public onlyOwner {
        ...
        bytes32 requestId = requestRandomness(keyhash, fee); //retuns a requestid and creates a variable in local scope
        ...
        override
    {
        ...
        //send all the moola in this contract to the recent winner
