...
contract MerkleDemo is ERC721Enumerable, Ownable {
    ...
    //Constructor
    constructor(bytes32 _root, string memory _initBaseURI)
        ERC721("Dolphin", "DNFT")
    {
    ...
    function createNFT(bytes32[] calldata _proof, uint256 _mintNum)
        public
        payable
    {
