...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierStartMintTimes = [1644868048, 1644868948];
    //Minting ending time in unix-epoch [phase 1 end, phase 2 end]
    uint256[] public tierMintEndTimes = [1644868348, 1644869248];
    //Minting tier fee
    ...
    uint256 public whitelistSaleDisableTime = 1644867748;
    uint256 public whitelistSaleStartTime = 1644867448;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1644868648, 1644869548];
