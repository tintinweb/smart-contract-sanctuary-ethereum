...
contract TestBuddies is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public baseURIExtended =
        "https://gateway.pinata.cloud/ipfs/QmUfc5Fi6E3ftyZkrCcpMMHUFfRteUo8dRJh9YmuY9yn5b/";
    ...
    address public a3 = 0xA356D9Ab9086Bbe509846BC4B4cF87EC2f05cbBB; // broby wallet
    ...
    function withdraw() external onlyOwner {
        ...
        _widthdraw(a3, balance.mul(5).div(100)); // broby 5%
