...
contract cigarLife is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    string internal baseuri = "ipfs://QmSXk8QBzCTrEKKt15Tnr9SS7otMSMMvDucC72D3cm4WLq/";
    string internal notRevealeduri = ""; //not reveal uri not provided yet
    bool public revealed = false;

    
    constructor() ERC721("Cigar Life", "CGRLF") {
        NFTPrice = 0.2 ether;                    
        NFTMaxSupply = 1111;
        mint(2);
        _pause();
    ...
    returns (string memory)
  {
    ...
    //setting reveal or unreveal

    function setRevealed() external onlyOwner {
        revealed = !revealed;
    }

    //function to remover addresses from white list
    ...
    function mint(uint256 _countNfts) public payable whenNotPaused {
        ...
        require(_countNfts <= 2, "max mint limit per transaction is 2 NFTs");
        require(totalSupply() + _countNfts <= NFTMaxSupply, "NFT: Max Supply");
        require(_countNfts > 0, "NFT: No of NFTs must be greater then zero");
        require(msg.value == NFTsPrice || msg.sender == owner(), "Please enter correct price");
    ...
    //function to tansfer balance of contract to owner
