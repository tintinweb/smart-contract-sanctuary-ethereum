...
contract SRSimple is ERC721A, Ownable
{
    using Strings for string;

    uint16 public constant MAX_TOKENS = 5;
    uint256 public PRICE = 0.0000001 ether; 
    uint16 public perAddressLimit = 4;
    bool public saleIsActive = false;

    string private _baseTokenURI;
    mapping(address => uint16) public addressMintedBalance;

    constructor() ERC721A("SRSimpleV2", "SRS2") {}
