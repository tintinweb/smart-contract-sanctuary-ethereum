...
contract DegenDisease is ERC721A,Ownable,WhitelistMint{
    ...
    function mintdisease(uint amount) external payable onlyMinter {
    ...
    function freeMint(uint amount) external payable onlyMinter  {
        require(amount>0,"Cannot mint 0 or below 0");
   ...
   function devMint(uint256 amount) external onlyOwner{
    ...
    function setSupply(uint amount) external onlyOwner{
