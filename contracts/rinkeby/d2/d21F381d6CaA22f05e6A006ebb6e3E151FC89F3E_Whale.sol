 ...
 */
contract Whale is ERC1155Tradable {
    constructor(
        address _proxyRegistryAddress,
        string memory _initialMetadataURI
    ) public ERC1155Tradable("Global Whales", "GW", _proxyRegistryAddress) {
        _setBaseMetadataURI(_initialMetadataURI);
    }
}
...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    function uri(uint256 _id) public view returns (string memory) {
        ...
        return Strings.strConcat(baseMetadataURI, "{id}.json");
    }
    ...
    /**
     * @dev Creates and mints a batch of new items with a supply of 1 for all.
     * @param _initialOwner address of the first owner of the token
     * @param _size size of batch to create
     */
