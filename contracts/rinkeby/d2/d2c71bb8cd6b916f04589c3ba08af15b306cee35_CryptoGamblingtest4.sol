...
contract CryptoGamblingtest4 is ERC721A {
    using Strings for uint256;

    uint public maxSupply = 10000;
    address public owner;

    constructor() ERC721A("CryptoGamblingtest4", "CGT") {
        owner = msg.sender;
        _mint(msg.sender, 10);
    }
...
//URI_______________________________________________________________________
    string metadataPrefx = "ipfs://QmT7YVpUyBcxJKEfbyg6LyVE4kHnersftag1BeQeYEbmXe/";
