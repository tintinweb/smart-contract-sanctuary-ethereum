...
// File: contracts/TheMiningBee.sol
...
contract TheMiningBee is ERC721Enumerable, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _maxSupply, uint256 _currentPrice, uint256 _saleStartTime, string memory _contractURI, string memory _baseURI) ERC721(_name, _symbol) {
      maxSupply = _maxSupply;
      currentPrice = _currentPrice;
      saleStartTime = _saleStartTime;
      currentContractURI = _contractURI;
      baseURI = _baseURI;
    }
