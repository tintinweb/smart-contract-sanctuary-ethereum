...
contract TestPunksMarket is ERC721 {
    ...
    constructor(string memory ipfsHash_) ERC721("TestPunks", "PUNK") {
    ...
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        address owner_ = punkIndexToAddress[tokenId];
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        // return string(abi.encodePacked("ipfs://QmPQJ76NDu8ss8xjLQtc4PcgQsgdKfSaityTAYJaarrVoH/", Strings.toString(tokenId), ".json"));
    }

    function _exists(uint256 tokenId) internal view virtual override returns (bool) {
        return punkIndexToAddress[tokenId] != address(0);
    }
}
