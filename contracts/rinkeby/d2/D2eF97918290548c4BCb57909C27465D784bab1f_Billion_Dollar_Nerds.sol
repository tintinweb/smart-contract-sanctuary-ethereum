...
// File: contracts/Billion Dollar Nerds.sol
...
contract Billion_Dollar_Nerds is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Billion Dollar Nerds", "BDNS") {
    setHiddenMetadataUri("ipfs://bafybeienhetx4nmhewl4k4alfxduyv65suobeiho3tr74hou3mjg2oe26y/hidden.json");
  }
