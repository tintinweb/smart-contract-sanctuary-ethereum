// SPDX-License-Identifier: GPL-3.0
    ...
    contract CharacterMint is ERC721, ERC721URIStorage, Ownable {
        ...
        */
        ...
        /**
        * @dev Buy a ticket. An emit will be emitted once the ticket is bought. 
        *      The sender needs to sent enough ether to cover the ticketPrice, that is initially
        ...
        */
        function buyTicket(int amount) external payable {
            ...
            require(amount > 0, "Minimum 1 ticket");
        ...
        */    
        function mintCharacter(string memory characterURI) external {
            require(_tickets[msg.sender] >= 1, "Not enough tickets bought");
        ...
        /**
        * @dev Withdraws the ETH contained in the Smart Contract to the owner account
        */
