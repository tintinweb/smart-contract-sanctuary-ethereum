...
contract TestSmartContract is ERC721A, Ownable  {
  using SafeMath for uint256;
	...
	uint256 public PRICE2 = 0.003 ether;
	uint256 public PRICE3 = 0.005 ether;
    uint256 public SLOT1 = 5;
    uint256 public SLOT2 = 10;
	...
	address private wallet1 = 0x7a29d9a21A45E269F1bFFFa15a84c16BA0050E27; // Company Wallet
    ...
    function whitelistMint(uint256 numberOfTokens, bytes32[] calldata merkleProof ) payable external callerIsUser {
        uint256 index = totalSupply().add(numberOfTokens);
        uint256 wl_price = index < SLOT1 ? PRICE1 : ((index >= SLOT1  && index < SLOT2) ? PRICE2 : PRICE3);
    ...
    function setSlots(uint256 _slot1, uint256 _slot2) public onlyAuthorized {
        SLOT1 = _slot1;
        SLOT2 = _slot2;
    }
