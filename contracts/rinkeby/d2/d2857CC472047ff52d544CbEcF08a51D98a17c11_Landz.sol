...
contract Landz is ERC721A, Pausable, Ownable {
  ...
  */
  ...
  event WithdrawnPayment(uint256 landzBalance, uint256 comissionBalance);
  ...
  **/
    ...
    verifyCoupon(coupon, couponType)
  {
    ...
    //check total maxSpply mintable per nft type (hq 450, museum 1350, mansion 4500)
    Library.checkSupply(
      hqIndex,
      museumIndex,
      mansionIndex,
    ...
    if (phase != DataLibrary.SalePhase.Phase04 && phase != DataLibrary.SalePhase.Phase05) {
      ...
      internVar.hqPrice = 0.65 ether;
      internVar.museumPrice = 0.45 ether;
      ...
      if (phase == DataLibrary.SalePhase.Phase04) {
        ...
        require(internVar.mintsWalletCount < 11 //maxMints_BeforePhase05_PerAddress 10
          , "009");
      ...
      //phase 05 public sale
        ...
        internVar.hqPrice = 0.75 ether;
        internVar.museumPrice = 0.55 ether;
  ...
  **/
  ...
  function withdraw() external {
    require(msg.sender == DataLibrary.landzAddress || msg.sender == DataLibrary.comissionAddress, "012");
    uint256 balanceComissionAddress;
    unchecked {
      balanceComissionAddress = address(this).balance * 1000 / 10000;
    }
    (bool success, ) = payable(DataLibrary.comissionAddress).call{ value: balanceComissionAddress }("");
    require(success, "013");
    uint256 balanceLandz = address(this).balance;
    (success, ) = payable(DataLibrary.landzAddress).call{ value: balanceLandz }("");
    require(success, "014");
    emit WithdrawnPayment(balanceLandz, balanceComissionAddress);
  }
...
library DataLibrary {
 enum SalePhase {
  ...
  address public constant _adminSigner = 0x07b106007b133f0F6fC3eD6AC77A447Db5E0b25e; 
  address public constant crossMintAddress = 0xdAb1a1854214684acE522439684a145E62505233;
  address public constant landzAddress = 0x1826A1f1b13ddC2C382c53B9A2598D77e5af6f3B;
  address public constant giveAwayAddress = 0x2C7EA2163d120Bd1B1813Bb7f9A27d6c57402Fb2;
  address public constant comissionAddress = 0x3ef29e7F075fd837be9EA3cCCD6f74149e5bac7D;
  address public constant advisorAddress = 0x8E5A504d6eaB715dEB796Fb33662cdCF40de6a25;
}
