...
contract XMAST is IERC721, Ownable, Functional {
    ...
    constructor() {
        _name = "0xMAST";
        _symbol = "0xMN";
        _baseURI = "http://localhost:3000/0xChams/metadata/";
        
        //CC = ERC721(0x0A477143E70fe357Ea38387316C28aCb3547bbBD);
        CC = ERC721(0x5fa1B71633DD8aaBbD5E7365B67f4d9Cc7E61846);

        price = 100000000000000; // Replace leading value with price in finney
        _maxSupply = 100;
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == XMAST.onERC721Received.selector;
    }
    ...
    function burn(uint256 tokenID) external {
        ...
        (CC).transferFrom(msg.sender, address(this), tokenID);
    }
