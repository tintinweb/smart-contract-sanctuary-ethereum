...
contract ChestClub is ERC721Enumerable, IERC721Receiver, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("ChestClub", "FLAT") {
        mint(5);//Premint
    }
   ...
   function mint(uint256 _mintAmount) public payable {
       if (msg.sender != owner()) {
            ...
            require(msg.value >= mintCost * _mintAmount);
            require(_mintAmount <= 10, "Can't mint more than 10");
        }
        uint256 supply = totalSupply();
        require(supply + _mintAmount <= maxSupply,"Max supply already reached");
        require(_mintAmount > 0, "Need more than 0");
