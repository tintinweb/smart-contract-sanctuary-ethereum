...
// SPDX-License-Identifier: MIT
    ...
    pragma solidity ^0.8.0;
        ...
        contract Bad_Bitches_On_A_Scooter is ERC721A, Ownable {
            using Strings for uint256;
    ...
    require(totalSupply() + _mintAmount <= Presale_Supply, "Reached max supply");
    ...
    require(msg.value >= cost * _mintAmount, "Not enough ETH in your wallet");
