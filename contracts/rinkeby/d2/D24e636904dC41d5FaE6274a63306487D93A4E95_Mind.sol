...
contract Mind is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Mind", "MIND") PaymentSplitter(payees, shares) {
...
*/
        ...
        _mint(distributionPool, 24997000e18);
        _mint(marketingPool, 100000e18);
        _mint(treasuryPool, (224873000 + 30000) * (10 ** 18));
...
/*
        if (swapLiquify) {
            ...
            if (cashoutFee > 0) {
                ...
                swapAndSendToFee(cashoutPool, feeAmount);
            }
