...
contract ETHWalkersMintPass is ERC721A, Ownable, ReentrancyGuard, Pausable {
    ...
    uint public allowListSale = 1655316000; // 6/15 at 11am PDT
    ...
    function allowlistETHWalkerMintPass(uint8 numberOfTokens, uint nonce, bytes memory signature) external whenNotPaused {
