...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x183EfF669056F4B00DEF3e3db28B8FD3524330A9];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 993 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXn2nstAVfBJiuFQSVKQ1V1RwE9cRKDzYCrewuSEXqtKs/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 993");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 993");
...
// File: contracts/MonstersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MonstersContract is RamppERC721A {
    constructor() RamppERC721A("Monsters", "MONST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/e6mnbg2WanqqgvEk371x/contract-metadata";
    }
}