...
contract FeltZineDelights_test10 is 
    ERC721A, 
    IERC2981, 
    ReentrancyGuard, 
    Ownable 
{
    ...
    bytes32 public merkleRoot =
        0x7c65f678ae5c9519b6727d268234870d229cacd46cee3087278009a5caa9e872;
    ...
    string public contractURI =
      "ipfs://Qma94vpv21LwkABX6t2648LQWBqVRzS4GBXXen5VAn3zKF";
    ...
    modifier canMintTokens(uint256 quantity) {
        require(quantity + _totalMinted() <= MAX_SUPPLY, "TOO MANY");
    ...
    constructor(string memory baseURI_) ERC721A("Garden of Felt Zine Delights", "GFZD") {
        baseURI = baseURI_;
   ...
   function withdrawTokens(IERC20 token) public nonReentrant onlyOwner {
        ...
        token.transfer(payoutAddress2, balance * 25 / 100);
      
        token.transfer(payoutAddress3, balance * 25 / 100);
   }   
