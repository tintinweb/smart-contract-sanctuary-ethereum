...
contract TDME is IERC721, Ownable, Functional {
    ...
    ERC721 PARTNER; ///Define interaction contract
    ...
    constructor() {
        ...
        //PARTNER = ERC721(0xFD3C3717164831916E6D2D7cdde9904dd793eC84); //Chameleon Collective
        PARTNER = ERC721(0x857608B7D4BEebCD9A0E48754e0D860ED60Ddd49); //Champotion Testnet

        price = 500 * (10 ** 15); // Replace leading value with price in finney

        reservedTokens = 60; // uncomment to reserve tokens for the owner or other purposes
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == TDME.onERC721Received.selector;
    }
    ...
    function mint() external payable reentryLock {
        ...
        require(_whitelist[_msgSender()] == true, "Private Mint Only");
    ...
    function setPartner(address discountContract) external onlyOwner {
        PARTNER = ERC721(discountContract);
    }
