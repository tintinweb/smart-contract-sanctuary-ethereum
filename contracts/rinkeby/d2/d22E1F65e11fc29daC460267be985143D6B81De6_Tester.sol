...
contract Tester is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    address[] private _team = [
        0xE0e9d95a41187F468aDcF3747E60D37D463433a3, // wallet #1 
        0x2E2Ccfe4c8b7FC10acc7a6344cfFadbBCEA3A47d //  wallet #2
    ];
    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress) ERC721A("Tester", "TEST") 
    ...
    function mint(uint256 count) external payable nonReentrant {
        require(!paused, "Tester: Contract is paused");
