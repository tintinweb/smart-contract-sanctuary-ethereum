...
contract PhunkForce1V2 is Ownable, ERC721A {
    ...
    IERC20 private v2punks = ERC20(0x85252f525456D3fCe3654e56f6EAF034075e231C);

    
    mapping(address => bool) private _allowList;
    address[] private whiteList;

    constructor() ERC721A("PHUNK FORCE 1 V2 by TEJI", "CPLVN") {}
    ...
    function whiteListMint() external {
        ...
        require (counter < 450, "No mints remaining");
    ...
    function publicMint(uint _amount) public payable {
        ...
        require (_amount + counter <= 450, "No mints remaining");
        
        if (
            // tejiverse.balanceOf(msg.sender) > 0 ||
