...
contract PandaVinciLabsNFT_TEST is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint16 public maxSupply = 10000;
    string private _baseTokenURI = 'ipfs://Qmbe5T2fwDpPnthpU3H4BF4XiFLvUTUDVWZ4EAHMiFQ2We/';
    string public baseExtension = ".json";
    
    uint256 public _freemintStartDate = 1630008000;
    uint256 public _freemintStopDate = 1630051200;
    uint256 private currentPrice = 0.001 ether;
    uint256 private currentMintLimit = 20;
    uint256 private maxMintAccount = 20;
    
    uint256 public _mintForAllStartDate = 1630080000;
    

    constructor() ERC721("PandaVinci Labs1", "PVL1") {
    }
