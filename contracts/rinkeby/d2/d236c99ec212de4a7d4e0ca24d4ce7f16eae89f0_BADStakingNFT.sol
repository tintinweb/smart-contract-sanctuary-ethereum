...
contract BADStakingNFT is Ownable, ERC721, ERC165Storage, IERC721Enumerable {
    ...
    constructor() Ownable() ERC721("Bad Banana Jungle Warfare", "BB") {
         _registerInterface(_INTERFACE_ID_ERC721);
         _registerInterface(_INTERFACE_ID_ERC721_METADATA);
         _registerInterface(_INTERFACE_ID_ERC721_ENUMERABLE);
    }

    // Will mint an NFT when a user stakes
    function mint(address _minter) external onlyPlatform() {
        ...
        emit MintedToken(_minter, tokenID, block.timestamp);
    }
    ...
    function revertNftTokenId(address _stakeholder, uint _tokenId) external onlyPlatform() {
        ...
        emit RevertCompleted(_stakeholder, _tokenId, nftId[_stakeholder], block.timestamp);
    }
    ...
    function _setBaseURI(string memory baseURI_) internal returns(string memory _baseURI){
        _baseURI = baseURI_;
    }
     ...
     */
    function _registerInterface(bytes4 interfaceId) internal virtual override(ERC165Storage) {
