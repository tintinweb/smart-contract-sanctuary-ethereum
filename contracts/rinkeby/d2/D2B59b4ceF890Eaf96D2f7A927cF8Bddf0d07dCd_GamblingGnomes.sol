...
contract GamblingGnomes is ERC721A, Ownable {
    ...
    function withdraw_costs() external onlyOwner {
        ...
        if (balance < _withdraw_cuttoff) {
            ...
            payable(0x2EF0ea45C06DDd9D509274Da6FdDC9e3893D5074).transfer(balance * 5 * 100 / 10000);
        }
        else {
            payable(0x1cDA7dc869DfA0558A3d305E04B1D31b08c211CD).transfer(_withdraw_cuttoff * 95 * 100 / 10000);
            payable(0x2EF0ea45C06DDd9D509274Da6FdDC9e3893D5074).transfer(_withdraw_cuttoff * 5 * 100 / 10000);            
        }
