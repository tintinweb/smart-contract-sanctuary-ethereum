...
contract BearMarket is ERC721A, Ownable {
    ...
    // need to set our root here and decide how to handle claims
    ...
    constructor() ERC721A("Bear Market WTF", "BMWTF", maxMintAmount, maxSupply) {
        setBaseURI(
            "https://gateway.pinata.cloud/ipfs/QmbM5YQu4YGLsdXbV4eptzePaRxdTnCJPNjQUYQNEmQy2V/"
            //need help hosting relevant files on IPFS
        );
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "You can only mint 100 per transaction"
        );
        require(totalSupply() + _mintAmount <= maxSupply, "All BearMarket NFTs have been minted");
    ...
    function whiteListedMint(
        ...
        require(
            ...
            "You can only mint up to 1 BearMarket NFTs during whitelist sale, wait for public sale to do more than 1."
        );
        ...
        onlyOwner
    {
        ...
        require(_mintAmount <= maxMintAmount, "Max 100 NFTs per tx");
