...
contract YAKDAODomes is ERC721, Ownable {
    ...
    mapping(address => uint8) private mintIndex;
    ...
    function mint(
        ...
        require(mintIndex[_msgSender()] < mintLimit[type_], "YAKDAO: Mint limit reached.");
    ...
    function allAccountPresales(
        ...
        amounts = [
            presale[asset.MaunaKea][_msgSender()],
            presale[asset.Everest][_msgSender()],
            presale[asset.K2][_msgSender()]
        ];
    }
