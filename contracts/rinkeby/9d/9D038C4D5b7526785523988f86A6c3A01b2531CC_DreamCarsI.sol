...
contract DreamCarsI is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor()
        ERC721A("Dream Cars Collection I", "DCI")
    {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "DCI: Caller is not the admin");
        _;
    }
        ...
        returns (string memory)
    {
        ...
        string memory baseURI = baseTokenURIs[(tokenId / 15000)];
        return
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "DCI: Max limit");
