...
contract FunkyFlies is Context, IERC20, LockToken {
    ...
    address public stakingAddress = address(0x78A276D94354dA15B690A1e15228F2200b45Fc6a); // Staking wallet address.
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if(burnTokens > 0)
        {
            ...
            if(stackingTokens > 0)
        {
            _transferStandard(sender, stakingAddress, stackingTokens);
        }    
        restoreAllFee();
    ...
    external onlyOwner() 
    {
        ...
        _stackingFee = stakingFee;
        _previousStackingFee = stakingFee;
