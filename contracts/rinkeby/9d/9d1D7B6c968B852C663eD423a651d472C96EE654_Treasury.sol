...
contract PaymentSplitter is Context {
    ...
    uint256 internal _numberOfPayees;
    ...
    function increaseShares(address account, uint256 addedShares_) public {
        if(msg.sender != authorizedCaller) revert("Unauthorized!");
        _shares[account] += addedShares_;
        _totalShares = _totalShares + addedShares_;
