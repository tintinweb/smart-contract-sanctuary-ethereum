...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierStartMintTimes = [1643734814, 1643737514];
    //Minting ending time in unix-epoch [phase 1 start, phase 2 start]
    uint256[] public tierMintEndTimes = [1643735714, 1643738414];
    //Minting tier fee
    ...
    uint256 public whitelistSaleDisableTime = 1643733914;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1643736614, 1643739314];
