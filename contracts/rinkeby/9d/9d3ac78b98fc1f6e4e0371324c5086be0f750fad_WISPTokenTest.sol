...
contract WISPTokenTest is ERC20, ERC20Burnable, Ownable, ERC20Permit, ERC20Votes {
    constructor()
        ERC20("WISP Token test", "WISPT")
        ERC20Permit("WISP Token test")
    {
