...
contract Market is IMarket, Ownable {
    ...
    modifier onlyValidCaller(address caller) {
        require(
            caller == msg.sender ||
                ICollection(collectionContractAddress).validMedia(msg.sender),
    ...
    function bidForTokenBidder(
        ...
        return _tokenBids[tokenAddress][tokenId][bidder];
    }
    ...
    function currentAskForToken(address mediaContract, uint256 tokenId)
        ...
        returns (Ask memory)
    {
        return _tokenAsks[mediaContract][tokenId];
    }
    ...
    function setAsk(
        ...
        public
        override
        onlyApprovedOrOwner(mediaContract, tokenId)
    ...
    function setBid(
        ...
        Bid memory bid,
        address spender
    ) public override onlyExistingToken(mediaContract, tokenId) {
        ...
        Bid storage existingBid = _tokenBids[mediaContract][tokenId][
            bid.bidder
        ];
        ...
        _tokenBids[mediaContract][tokenId][bid.bidder] = Bid(
    ...
    function removeBid(
        ...
        Bid storage bid = _tokenBids[mediaContract][tokenId][bidder];
        ...
        emit BidRemoved(mediaContract, tokenId, bid);
        delete _tokenBids[mediaContract][tokenId][bidder];
    ...
    function acceptBid(
        ...
        onlyValidCaller(tokenOwner)
    {
        Bid memory bid = _tokenBids[mediaContract][tokenId][expectedBid.bidder];
    ...
    function _finalizeNFTTransfer(
        ...
        Bid memory bid = _tokenBids[mediaContract][tokenId][bidder];
        ...
        IERC721(mediaContract).safeTransferFrom(
            tokenOwner,
            bid.bidder,
            tokenId
        );
        ...
        emit BidFinalized(mediaContract, tokenId, bid);
    }
