...
contract RedEnvelop is Ownable {
    ...
    event Create(uint256 indexed money);
    event Open(uint256 indexed money);
    event Drawback(uint256 indexed money);
    ...
    // WIN TOGETHER
    address public creptoPassAddress;
