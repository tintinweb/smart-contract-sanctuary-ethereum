...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    event RaffleWon(address indexed player, uint256 amount);
    ...
    function enterRaffle() public payable {
        require(s_state == RaffleState.OPEN, "Raffle is not open");
        require(
        ...
        )
    {
        ...
        bool isEnoughTimeIsPassed = block.timestamp - s_lastTimestamp >=
            i_interval;
    ...
    function fulfillRandomWords(
        ...
        (bool isWinnerPaid, ) = winner.call{value: winningAmount}("");

        require(isWinnerPaid, "Winner did not receive the winning amount");

        s_state = RaffleState.OPEN;

        emit RaffleWon(winner, winningAmount);
    }
