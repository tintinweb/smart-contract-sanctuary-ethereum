...
contract BapeNFT is ERC721,ReentrancyGuard,Ownable {
    struct NFTMinter{
    ...
    uint256 public whitelistedPrice = 0.18 ether;
    uint256 public staffPrice = 0;
    ...
    constructor() ERC721("Bape NFT", "BNFT") {
    }
    ...
    function setPrice(uint256 _newPrice) public onlyOwner{
        require(price!=_newPrice,"New price cannot be same with previous price");
        price = _newPrice;
    }

    function setWhitelistedPrice(uint256 _newPrice) public onlyOwner{
        require(whitelistedPrice!=_newPrice,"New price cannot be same with previous price");
        whitelistedPrice = _newPrice;
    }

    function setStaffPrice(uint256 _newPrice) public onlyOwner{
        require(staffPrice!=_newPrice,"New price cannot be same with previous price");
        staffPrice = _newPrice;
    }
}