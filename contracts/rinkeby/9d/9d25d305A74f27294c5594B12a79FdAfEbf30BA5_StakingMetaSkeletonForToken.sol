...
contract StakingMetaSkeletonForToken is Ownable {
      ...
      event Unstake(address indexed unstaker , uint256 tokenId);
      event Claim(address indexed staker, uint256 tokenId);
    ...
    constructor(){
      stakingNft = IERC721(0xDC500ce5504B491241D609F18496b1847EBdf989);
      rewardingToken = IERC20(0xAAa19bCaA7dD9CdcFDea4314F7523EE7B16082aB);
      rewardingTokenDecimals = rewardingToken.decimals();
      rewardingTokenWallet = 0x49A61ba8E25FBd58cE9B30E1276c4Eb41dD80a80;
