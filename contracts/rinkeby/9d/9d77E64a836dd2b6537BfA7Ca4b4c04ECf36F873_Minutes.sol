...
contract Minutes is ERC721, Pausable, Ownable, ERC721Burnable, AllowlistSale, ReentrancyGuard {
    ...
    constructor() ERC721("minutes", "60M") {
        _addSale(1, SaleConfig(1655913600, 0, 20000000000000000, 2, 1, 0x6DeB3251ba099E8E4cf705a0e156D41A1d7618f6, false, true, true));
    }
    ...
    @notice yoloooooo
    */
    function allowlistMint(bytes calldata saleKey) external nonReentrant {
        verify(1, saleKey, 1);
