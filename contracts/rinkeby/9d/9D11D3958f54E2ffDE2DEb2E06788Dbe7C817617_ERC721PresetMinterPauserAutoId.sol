...
import "./IERC165.sol";
import "./exchange/Initializable.sol";
...
/**
 * @dev {ERC721} token, including:balanceOf
 *
 ...
 */
contract ERC721PresetMinterPauserAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage {
    ...
    function mint(address to, string memory _tokenURI) public virtual {
        ...
        _updateTokenCreator(_tokenIdTracker.current(), payable(_msgSender()));
     ...
     * Emits a {Transfer} event.
     */
    function _burn(uint256 tokenId) internal virtual override(NFT721Creator, ERC721URIStorage) {
        super._burn(tokenId);
 ...
 */
abstract contract ERC721Burnable is Context, NFT721Creator {
    /**
 ...
 * account.
 */
abstract contract ERC721Enumerable is NFT721Creator, IERC721Enumerable {
 ...
 */
abstract contract ERC721URIStorage is NFT721Creator {
    using Strings for uint256;
