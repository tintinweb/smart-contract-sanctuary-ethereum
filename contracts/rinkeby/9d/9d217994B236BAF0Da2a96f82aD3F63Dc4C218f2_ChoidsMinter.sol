    ...
    ICreatorMinterERC721
{
    ...
    function mint(
        ...
        if (tokenContract.totalRemaining() == 0) revert InsufficentSupply();
     ...
     * @notice turn off allow list checks
     */
    ...
    /**
     * @dev Get the total tokens minted from the mintable contract
     * @notice See {ICreatorMintableERC721-totalRemaining}
     */
    function totalRemaining() external view returns (uint256) {
        return tokenContract.totalRemaining();
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlAdmin, ICreatorMinterERC721)
        returns (bool)
    {
        return
...
interface ICreatorMintableERC721 {
...
interface ICreatorMinterERC721 {
