...
contract NFT is ERC721A, Ownable, ERC721URIStorage {
    ...
    function mint(address _to, string memory _url) external payable returns (address, string memory) {

        //require(msg.value >= (mintRate * _quantity), "NOt enouth ether");
