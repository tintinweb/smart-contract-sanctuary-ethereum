...
contract DevToken is Ownable, Stakeable{
  ...
  */
  ...
  address private treasure = 0xFb4e03DC6463c84A1c7A50771de992d9842bAb81;
  ...
  */
  function _mint(address account, uint256 amount) internal {
    ...
    emit Transfer(treasure, account, amount);
  }
  /**
    ...
    */
     ...
     */
      function calculateStakeReward(Stake memory _current_stake) internal view returns(uint256){
          ...
          return (((block.timestamp - _current_stake.since) / 3600 hours) * _current_stake.amount) / rewardPerHour;
      }
