...
contract VotingApp{
    ...
    // enumeration of different available status of the voting process
    enum VotingStatus {
        VotingPreparation, 
    ...
    function getCandidateId(uint256 _candidateID) onlyRegisteredVoter onlyDuringVoting public view returns (string memory candidate_){
