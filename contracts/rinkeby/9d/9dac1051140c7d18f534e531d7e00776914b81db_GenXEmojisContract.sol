...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWEtBxTs9bDkUXWvccoa3nJQqRw2YubboPFqwySACLwEB/";
...
// File: contracts/GenXEmojisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GenXEmojisContract is RamppERC721A {
    constructor() RamppERC721A("GenX Emojis", "GXEMOJI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/VZUdKso30Dq4jbYGdTLW/contract-metadata";
    }
}