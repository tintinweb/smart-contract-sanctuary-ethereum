    ...
    Signature
{
     ...
     * @param _startDate new start staking time
     * @param _endDate new end staking time
     */
    function stableFinanceUpdatePool(uint256 _poolId, uint256 _startDate, uint256 _endDate)  
        external
        onlyRole(ADMIN) {
        ...
        pool.startJoinTime = _startDate;
        pool.endJoinTime = _endDate;
