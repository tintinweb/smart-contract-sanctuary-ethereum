...
contract famouspeopleintheworld is ERC721A, Ownable {
    
    using Strings for uint256;


    uint256 FREE_MINT_LIMIT_PER_WALLET = 84;
    uint256 MAX_MINTS = 84;
    uint256 MAX_SUPPLY = 84;
    bool private paused = false;
    uint256 MAX_FREE = 84;
    uint256 public mintRate = 0.5 ether;

    string public baseURI = "https://ipfs.io/ipfs/QmcsdWyNNDxTUYw2z1T1nUqv49ijBQHRWsW9tocoWABEuT";

    mapping(address => uint256) private freeMintCountMap;
    

    constructor() ERC721A("famouspeopleintheworld", "FPITW") {}
