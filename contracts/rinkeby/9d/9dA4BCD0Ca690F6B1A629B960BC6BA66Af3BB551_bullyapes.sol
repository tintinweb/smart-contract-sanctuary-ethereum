...
contract bullyapes is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;
    uint256 public price = 555555; 
    uint256 public constant maxSupply = 5555; //total NFTs available
    address public royaltyAddress = 0xcFA5f7FD8970Eb2CDB500d5AD285F432B3553Fb6; //need to update before deploying
    uint96 public royaltyFee = 1000; //10% royalty
    string public _baseTokenURI = "ipfs://QmSaUV5wW7Yj5qe6uKrfSCHoLdJHxkSjDdHM1bYV5qdSPM/"; // IPFS link
