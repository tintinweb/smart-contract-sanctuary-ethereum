...
contract CosmoGang is ERC721, Ownable {
    address public constant MAIN_ADDRESS = 0x9C21c877B44eBac7F0E8Ee99dB4ebFD4A9Ac5000;
    uint256 public constant MAX_SUPPLY = 10000;
    string public constant PLACEHOLDER_URI = "https://infura-ipfs.io/ipfs/QmP1c2YSBYPmLNGSeC7S91u9isPi1RUt3PP4QVjphaEpJX";
    ...
    constructor() ERC721("CosmoGang", "CG")
    {
    }
    ...
    function updateTokenURI(uint256 tokenId, string memory tokenURI, Faction faction)
        public onlyOwner
    {
        require(_exists(tokenId), "ERC721URIStorage: URI set of nonexistent token");
