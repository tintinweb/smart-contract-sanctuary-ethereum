    ...
    EIP712Upgradeable
{
    ...
    function getFeeAmounts(uint256 amount, uint256 tokenId)
        public
        view
        returns (
            uint256,
        ...
        )
    {
        ...
        uint256 receiveAmount = amount - royaltyFeeAmount - platformFee;

        return (receiveAmount, platformFee, royaltyFeeAmount, creator);
    }
