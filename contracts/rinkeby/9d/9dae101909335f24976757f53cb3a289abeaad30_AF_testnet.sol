...
contract AF_testnet is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Royalty, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    string private _contractURI;
    uint256 public burned;

    constructor(string memory contractURI_, uint96 feeNumerator) ERC721("C0ntr4ctN4m3", "AF_TN") {
