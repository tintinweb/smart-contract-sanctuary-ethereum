...
contract JackpotApeLottery is ReentrancyGuard, IJackpotApeLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        require((_numberFreeTicketsPerLotteryId[_lotteryId][msg.sender] + _ticketNumbers.length) <= _freeTickets, "Insufficient free tickets");
        ...
        nonReentrant
    {
        ...
        require((_ticketNumbers.length - _extraFreeTickets) > 0, "You have to purchase a paid token at least");

        // Calculate number of TICKET to this contract
        uint256 amountTicketPrice = _calculateTotalPriceForBulkTickets(
