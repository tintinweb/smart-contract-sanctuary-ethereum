...
contract SkyVerseStaking is ReentrancyGuardUpgradeable, OwnableUpgradeable, IERC721ReceiverUpgradeable, SkySigner {
    ...
    function initialize(address _token, address _nft, address _designatedSigner) public initializer {
    ...
    function stakeNFTs(uint[] memory _tokenIds) external nonReentrant{
        ...
        for(uint i = 0; i < length; i++) {
            ...
            require(tokenRarity[_tokenIds[i]] != 0,"Rarity not initialized");
    ...
    function claimRewardsAndUnStakeNFTs(uint[] memory _tokenIds) external nonReentrant{
...
contract SkySigner is EIP712Upgradeable{
    ...
    string private constant SIGNING_DOMAIN = "SkyVerse-Staking";
