    ...
    TellerASResolver
{
    ...
    function revokeBorrower(
        ...
        bytes32 uuid = markets[_marketId].borrowerAttestationIds[_borrowerAddress];
    ...
    function _isVerified(
        ...
        if (_attestationRequired) {
            isVerified_ = tellerAS.isAttestationActive(_stakeholderAttestationIds[_stakeholderAddress]);
