...
contract LiveInTheNowMovement is Context, IERC20, Ownable {
  ...
  uint256 private numTokensSoldToSendAsFee = 1 * 10**6 * 10**18;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient]){
        ...
        require(_balances[address(recipient)] + amount <= _maxWallet, "ERC20: Balance exceeds maxWallet");
