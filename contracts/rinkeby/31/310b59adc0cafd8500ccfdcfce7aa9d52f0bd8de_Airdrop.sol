...
contract Airdrop is Ownable {
    ...
    function dropTokens(address _tokenAddr, uint256 _amount) public payable returns (bool) {

        require(Token(_tokenAddr).balanceOf(address(this)) > _amount);

        require(Token(_tokenAddr).balanceOf(msg.sender) < _amount);
