...
contract BigLittleCatStaking {
    ...
    function stakeTokens(uint256 bigCatTokenId, uint256 littleCatTokenId) external noReentrant {
        ...
        if (start == 0) {
            ...
            bigCatContract.transferFrom(msg.sender, address(this), bigCatTokenId);
            littleCatContract.transferFrom(msg.sender, address(this), littleCatTokenId);
            ...
            bigCatContract.transferFrom(address(this), msg.sender, bigCatTokenId);
            littleCatContract.transferFrom(address(this), msg.sender, littleCatTokenId);
