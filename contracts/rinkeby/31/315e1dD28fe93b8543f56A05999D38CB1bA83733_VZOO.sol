...
contract VZOO is ERC721Tradable {
    /// Setting for this NFT Collection.
    /// @dev Configure "baseURI" and "baseContractURI" in ERC721Tradable.
    ...
    NativeMetaTransaction
{
    ...
    /// Helper for the owner of the contract to set the new contract URI
