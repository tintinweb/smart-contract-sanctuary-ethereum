...
contract hammBearMarketBears is hammbones {
    constructor(
...
import "./hammsteaks.sol";
import "../common/interfaces/Ihammbones.sol";
import "../common/interfaces/Icollection.sol";
import "../common/interfaces/Ihamm.sol";

contract hammbones is Ihammbones, hammsteaks, Ownable {
    struct TokenStatus {
    ...
    constructor(
        ...
        uint256 _stakeRate
    ) hammsteaks(_targetAddress, _stakeRate) {
    ...
    function _claim(address _owner, uint256[] memory _tokenIds) internal {
        ...
        Ihamm(rewardAddress).mint(_owner, rewardAmount);
    }
