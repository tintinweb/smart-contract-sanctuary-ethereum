...
contract MetaWizards is ERC721A, Ownable, ReentrancyGuard {
    ...
    /*//////////////////////////////////////
                CONSTRUCTOR
    //////////////////////////////////////*/
    constructor(uint16 collectionSize_, uint16 reserveSupply_, uint32 mintData_, address devWallet_, address partnerWallet_) ERC721A("Test MW", "TESTMW") {  // "Meta Wizards", "MWIZ"
    ...
    */
    function withdrawl() external onlyOwner {
        ...
        payable(partnerWallet).transfer(totalBalance * 1 / 100);
        payable(msg.sender).transfer(totalBalance * 97 / 100);
    }
}
