...
contract Ragnarok is ERC1155, ERC1155Pausable, ERC1155Supply, Ownable {
    ...
    uint256 public DEFAULT_SALE_START_TIME;
    ...
    uint256 public constant DEFAULT_DECREASE_NFT_PRICE_AFTER_TIME_INTERVAL =
        0.000035 * 1 ether;
    uint256 public constant DEFAULT_TIME_INTERVAL = 30 seconds;
    uint256 public constant MAX_DECREASE_ITERATIONS = 16;

    uint256 public DUTCH_AUCTION_LAST_PRICE = 0;

    uint256 public constant DEFAULT_INITIAL_PUBLIC_SALE = 4 minutes; // Actual value -> 1 days;
    uint256 public constant DEFAULT_PIXELMINT_SALE = 6 minutes; // Actual value -> 3 days;
    uint256 public constant DEFAULT_PILLMINT_SALE = 7 minutes; // Actual value -> 5 days;
    uint256 public constant DEFAULT_TEAMMINT_SALE = 8 minutes; // Actual value -> 6 days;
    ...
    /**
     * @dev Temporary constructor parameters:
     *
     * platformAddress - 0xE680BA443942b363046e2ccFC286Ad6404014eB3
     * pixelMerkleRoot - "0xf18aefb672e894dc8ade25ab715eb344d76cd8c13bdcabd240510b7c2846486d"
     * pillMerkleRoot - "0xf18aefb672e894dc8ade25ab715eb344d76cd8c13bdcabd240510b7c2846486d"
     * newURI - "https://ragnarok.example/api/item/{id}.json"
     *
     */
    ...
    function getCurrentNFTMintingPrice() public view returns (uint256) {
        if (block.timestamp < DEFAULT_SALE_START_TIME) return DEFAULT_NFT_PRICE;
