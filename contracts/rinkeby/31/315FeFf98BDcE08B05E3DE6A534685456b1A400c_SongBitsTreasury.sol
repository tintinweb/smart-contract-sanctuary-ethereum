...
contract SongBitsTreasury is Ownable {
    ...
    function getFanInventory() public view onlyOwner returns (uint256) {
        return _fanInventory;
    }

    function getSongbidsBank() public view onlyOwner returns (uint256) {
    ...
    function getFactory() public view onlyOwner returns (address) {
        return _factory;
    }
