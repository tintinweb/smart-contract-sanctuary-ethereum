...
contract TheTestingClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(bytes32 _initWhitelistRootHash,string memory _initBaseURI, string memory _initPreviewURI) ERC721A("The Testing Club", "TTC"){
    ...
    function whitelistMint (bytes32[] calldata _merkleProof, uint256 _mintAmount) external payable callerIsUser {
        ...
        require(MerkleProof.verify(_merkleProof, whitelistRootHash, keccak256(abi.encodePacked(msg.sender))), "You are not whitelisted");
