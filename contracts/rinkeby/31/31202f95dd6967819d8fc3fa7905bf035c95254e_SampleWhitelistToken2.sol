...
contract SampleWhitelistToken2 is ERC20, Ownable {

    uint256 public immutable finalTotalSupply = 1000 * 10 ** decimals();
    uint256 public tokenPrice = 0.05 ether; 

    mapping(address => uint8) public usersWhitelist; // 0 - null, 1 - whitelist

    constructor() ERC20("SampleWhitelistToken2", "SWT2") {}

    function isWhitelisted(address _user) public view returns (bool) {
        if (usersWhitelist[_user]==1) return true; else return false;
    }

    function buyOnWhiteListed() public payable {
