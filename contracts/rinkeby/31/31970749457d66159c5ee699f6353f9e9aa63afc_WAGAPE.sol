...
contract WAGAPE is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("We Are All Going to Ape", "WAGAPE"){
...
function tokenURI(uint256 _tokenId)
  ...
  {
    uint cost = freeprice;
    require(totalSupply() <= freeSupply, "No more free.");
    require(totalSupply() + amount <= maxSupply,"too many!");
    require(msg.value >= amount * cost,"Please send the exact amount.");
    require( amount <= maxPerTx, "Max per TX reached.");
