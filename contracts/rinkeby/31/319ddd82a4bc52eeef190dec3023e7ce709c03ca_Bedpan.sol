...
// File: contracts/bedpan.sol
pragma solidity ^0.8.0;




contract Bedpan is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Bedpan", "BEDPAN") {
        _safeMint(_msgSender(), 100); // Mints for team, setup OS and giveaways
