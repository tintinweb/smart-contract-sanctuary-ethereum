...
contract SongAlbumPriceFeed is Ownable {
    /// @notice keeps track of oracles for each tokens
    mapping(address => address) public oracles;

    /// @notice SongAlbum address registry contract
    ...
    function registerOracle(address _token, address _oracle)
        ...
        onlyOwner
    {
        ISongAlbumTokenRegistry tokenRegistry = ISongAlbumTokenRegistry(
            ISongAlbumAddressRegistry(addressRegistry).tokenRegistry()
        );
