...
{   
        ...
        external
    {
        ...
        require(collections[collectionId].userAddress==msg.sender,"Only owner of collection can edit.");
    ...
    {
        uint256 tokenId = _tokenIdCounter.current();
        require(_nftbuyerAddress==msg.sender,"Address mismatch");
        _tokenIdCounter.increment();
        _safeMint(_nftbuyerAddress, tokenId);
        _setTokenURI(tokenId, uri);
    }
        ...
        public
    {
        ...
        require (msg.sender == auctions[tokenId].highestBidder
        ...
        returns (bool)
    {
        ...
        {
            require((auctions[tokenId].highestBidder == address(0))
            || (block.timestamp < auctions[tokenId].auctionEndTime),"Bidding in Process" );
