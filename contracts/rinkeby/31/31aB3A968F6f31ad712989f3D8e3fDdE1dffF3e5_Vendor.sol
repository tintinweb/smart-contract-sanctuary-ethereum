...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 NrOfTokens) public {
    uint256 ethToTransfer = NrOfTokens / tokensPerEth;
    require(address(this).balance >= ethToTransfer, "Not enough ETH in the treasury.");
    yourToken.transferFrom(msg.sender, address(this), NrOfTokens);
    (bool sent, ) = msg.sender.call{value: ethToTransfer}("");
    require(sent, "Failed to withdraw Ether.");
    emit SellTokens(msg.sender, ethToTransfer, NrOfTokens);
  }
