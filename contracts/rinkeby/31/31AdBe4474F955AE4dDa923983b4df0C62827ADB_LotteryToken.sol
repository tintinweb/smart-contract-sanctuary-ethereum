...
contract LotteryToken is ILotteryToken, Ownable, ERC20 {
    ...
    /// @param _addressTyler address where initial supply will be minted
    constructor(address _lotteryGame, address _addressTyler)
        ERC20("Lotto", "LOTTO")
    {
        lotteryGame = ILotteryGame(_lotteryGame);

        // 2,000,000,000 allocate for all
        _mint(_addressTyler, TOTAL_ALLOCATED * PRECISION);
    ...
    /// @param _winnerAddress address of winner
    /// @param _marketingAddress marketing address
    /// @param _winningPrizeValue amount of winning prize in tokens
        ...
        returns (Lottery memory finishedLotteryGame)
    {
        ...
        uint256 winnerBalance = balanceOf(_winnerAddress) + _winningPrizeValue;
