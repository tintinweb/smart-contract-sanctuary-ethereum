...
contract BYRDOV is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 100 * (10**18);
    uint256 public maxWalletToken = 100 * (10**18);
    ...
    address payable public liquidityWallet = payable(0xa4FD8D8b1389318A92998929383680882A11eFdC);

    address payable public treasuryWallet = payable(0x128c12373D7d0C790A9d7773D4993A8B62c85FC2);
    address payable public marketingWallet = payable(0xB6d3e63AD6D9598724f547Edf6417b8eD31BD0B4);
    address payable public devWallet = payable(0x4E5DEC3759dbEaaC1A0E7A7530fb3E044F15b3D5);
    ...
    constructor() ERC20("Byrdov", "BYRDOV") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Byrdov: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Byrdov: The UniSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Byrdov: Automated market maker pair is already set to that value");
   ...
   function updateSellTotalTax(uint256 _sellTotalFees) public onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // Handle liquditiy first
        uint256 previousContractETHBalance = address(this).balance;
        console.log("previousContractETHBalance is %s", previousContractETHBalance); 
