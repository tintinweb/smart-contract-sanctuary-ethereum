...
contract MondaiAnome is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("Mondai Anome","MondaiAnome", MaxMintPerBatch_, TotalCollectionSize_) {
