...
contract N1LAB_Phygital_S1 is LilOwnable, ERC721, ReentrancyGuard {
    ...
    string private initImg = "ipfs://bafybeidslidx2ads6z7zcb7mimhapyyvbqoo7iuylujcdoqztaqrnswiym";
    string private baseImg ;

    string private initAnim = "ipfs://bafybeievfej252ptar7d5g6dgyttocidn7v6mcwudsm5hm7dchtdyqpbz4";
    string private baseAnim ;

    string private initURI = "ipfs://bafkreiapudxv2rwyhc2y6badjyzeh5rm5scw4javrznbs2i7hk7ll2kihu";
