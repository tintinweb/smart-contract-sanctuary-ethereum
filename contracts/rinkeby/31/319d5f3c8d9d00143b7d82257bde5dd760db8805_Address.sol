...
// File contracts/CryptoFrens.sol
...
contract CryptoFrens is ERC721, Ownable {
    ...
    uint32 public totalSupply = 10000;
    bool public open = false;
    mapping(address => uint256) internal addressMintedMap;

    uint32 private commission = 50; // 5%
    address private author = 0x9aAB4907AAD1840c12677e6E83a43AA73C700084;
    ...
    modifier preMintChecks(uint32 count) {
        ...
        require(msg.value >= cost * count, "Not enough funds.");
...
abstract contract Revealable is CryptoFrens {
...
abstract contract Presaleable is CryptoFrens {
...
contract CryptoFrensPresaleReveal is CryptoFrens, Revealable, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) CryptoFrens(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
