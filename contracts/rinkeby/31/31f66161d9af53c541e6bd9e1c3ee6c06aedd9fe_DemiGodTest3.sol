...
// Author: Gulshan Jubaed Prince - [email protected]
...
contract DemiGodTest3 is ERC1155, AccessControl, ERC1155Supply {
    ...
    function transferEther(address payable to, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE){
        to.transfer(amount);
    }
