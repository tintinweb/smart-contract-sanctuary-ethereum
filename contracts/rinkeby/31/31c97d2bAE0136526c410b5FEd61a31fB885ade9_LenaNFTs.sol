...
contract LenaNFTs is
    ...
    Withdrawable
{
    uint256 public constant TOTAL_MAX_QTY = 5000;
    uint256 public constant GIFT_MAX_QTY = 150;
    ...
    constructor() ERC721("LenaNFTs", "LENA") Whitelist("LenaNFTs", "1") {}
