...
contract TimelessWarriors is ERC721, ERC2981, Ownable {
    ...
    function burn(uint256 tokenId) public { 
        ...
        // require(_exists(tokenId), "TW: operator query for nonexistent token");
        // address owner = ERC721.ownerOf(tokenId);
        // require(_msgSender() == owner || getApproved(tokenId) == _msgSender()/* || isApprovedForAll(owner, _msgSender()*/, "TW: Not approved to burn.");
        _burn(tokenId);
        unchecked {
            burned++;
        }
    ...
    function isApprovedForAll(address owner, address operator) public view override returns (bool) {
        ...
        // if ((address(proxyRegistry.proxies(owner)) == operator) || proxyToApproved[operator]) {
        //     return true;
        // }
