...
// File: constract/ERC721A_demo.sol
...
contract ERC721ADemo is ERC721A, Ownable {
    ...
    function addNumberArray(uint256[] calldata _number) external {
        data = _number;
    }

    function getNumber() external view virtual returns (uint256[] memory) {
        return data;
    }
}