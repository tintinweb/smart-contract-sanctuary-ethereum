...
1% AUTO BURN
1% AUTO BUYBACK&BURN.
2% MARKETING FOR MANUAL BUY BACK AND BURN
2% DEV. 
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOD1";
    string private constant _symbol = "GOD1";
    ...
    constructor () {
        ...
        marketingAddrWallet = payable(0xe7E8586D4EDCb99939d9DE05B2637ECa5570617f);
        ...
        totalBuyFees =  buyAutoBurnFee + buyAutoBuyBackandBurnFee + buyMarketingFee + buyDevFee;
        
        sellAutoBurnFee = _sellAutoBurnFee;
        sellAutoBuyBackandBurnFee = _sellAutoBuyBackandBurnFee;
        sellMarketingFee = _sellMarketingFee;
        sellDevFee = _sellDevFee;
        totalSellFees = sellAutoBurnFee + sellAutoBuyBackandBurnFee  + sellMarketingFee + sellDevFee;   
