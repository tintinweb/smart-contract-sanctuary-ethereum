...
contract x0x0x is ERC721,ERC721Enumerable,Ownable{
   ...
   function setPriceForPublicMint(uint256 newPrice)private contractIsActive onlyOwner {
    ...
    function whiteListMint(uint256 mintAmount,bytes32[] memory proof) public payable contractIsActive {
        ...
        require(totalSupply() + mintAmount <= maxSupply - amountForAirdrops, "On addition of the amount you are about to mint , it would exceed the total suppl.");
        ...
        mintPerfomedInWhitelistMint[msg.sender] += mintAmount;
    ...
    function isWhiteListed(bytes32[] memory proof) view internal returns(bool) {
