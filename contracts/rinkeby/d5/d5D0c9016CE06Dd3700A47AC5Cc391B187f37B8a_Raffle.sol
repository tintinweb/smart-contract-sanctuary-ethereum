// Raffle
// Enter the lottery
// Pick a random winner (verifiably random winner)
// Winner to be selected every x minutes -> should be automated
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
        ...
        )
    {
        ...
        bool timePassed = (block.timestamp - s_lastTimeStamp) > i_updateInterval;
