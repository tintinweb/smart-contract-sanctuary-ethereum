...
pragma solidity >=0.6.0 <0.8.0;
/**
 * @title NTFContractTest contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract NTFContractTest is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint public constant maxTokenPuchase = 20;
    ...
    */
    function mintToken(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxTokenPuchase, "Can only mint 20 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_TOKENS
, "Purchase would exceed max supply of Tokens");
        ...
        if (startingIndexBlock == 0 && (totalSupply() == MAX_TOKENS
