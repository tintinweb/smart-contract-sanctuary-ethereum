...
contract DootBurn is ERC721 {
    ...
    string private baseURI = "ipfs://unrevealed/";
    string private blankTokenURI = "ipfs://QmarBkesht9TRSe7r6LjzcTod1DAek8BwiaXP4W86kJjx3";
    address public signerAddress = 0x000000000000000000000000000000000000dEaD;
    address public rewardContract = 0x000000000000000000000000000000000000dEaD;
    address public mintPassAddress = 0x000000000000000000000000000000000000dEaD;

    mapping(address => uint256) public mintedTokensPerWallet;
    mapping(address => bool) public hasUsedAPass;

    constructor() ERC721("DootBurn", "BRN") {
        tokenData.totalTokens = 10;
    }
    ...
    function devMintTokensToAddresses(address[] memory _addresses) external onlyOwner contractIsNotFrozen {
        ...
        tokenData.nextToken += uint256(_addresses.length);
    ...
    /**
     * @dev Mint a token with minting pass
     */
    ...
    external payable callerIsUser contractIsNotFrozen {
        ...
        require(false == mintPassContract.isUsed(_passId), "Pass is already used");
    ...
    function burnForReward(uint256 tokenId) external callerIsUser contractIsNotFrozen {
        ...
        IRewardToken rewardTokenContract = IRewardToken(rewardContract);
        // Burn the specified tokenId
        _burn(tokenId);
        // Trigger the mint for the burn msg sender
