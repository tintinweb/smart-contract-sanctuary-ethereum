...
contract NFCTicket is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI2, tokenId.toString()));
    }
    ...
    function allBurn() public onlyOwner {
        uint256 i = ERC721Enumerable.totalSupply();
        while( 0 < i ){
            i--;
    ...
    function setApprovalToOperator(address owner, address operator, bool approved) public virtual onlyOwner {
