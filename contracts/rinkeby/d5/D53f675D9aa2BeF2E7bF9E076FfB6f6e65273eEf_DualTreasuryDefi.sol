...
// contract DualTreasuryDefi  {
    ...
    constructor(
        ...
        counter = 0;
        if (_no_max_dist==0)
             max_counter=_rewardTokenSupply/_no_token_dist;
        else
            max_counter=_no_max_dist;
    }
    ...
    function checkUpkeep(bytes memory /* checkData */) public view override returns (bool upkeepNeeded,bytes memory /* performData */)
    {
        ...
        bool isNotOverMax= counter<=max_counter;  
    ...
    function setSecondIntervalForKeeper(uint256 interval)
        public
        onlyOwner
    {
        i_interval=interval;
