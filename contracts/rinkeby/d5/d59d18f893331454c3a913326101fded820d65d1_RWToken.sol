...
contract RWToken is Context, IERC20, LockToken {
    ...
    uint256 private _tTotal = 1e13 *10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "RWToken";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1e10 *10**9;
    ...
    function setFeePercent(uint256 taxFee, uint256 MarketingFee, uint256 liquidityFee, uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
        _marketingFee = MarketingFee;
        _liquidityFee = liquidityFee;
        _burnFee = burnFee;
        require(_taxFee + _marketingFee + _liquidityFee + _burnFee <= 11, "Buy Fee should be 11% or less");
    }
