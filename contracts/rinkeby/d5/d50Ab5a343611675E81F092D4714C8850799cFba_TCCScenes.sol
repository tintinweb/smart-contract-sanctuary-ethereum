...
contract TCCScenes is ERC721A, CollaborativeOwnable, ReentrancyGuard {
  ...
  constructor(address _proxyRegistryAddress) ERC721A("The Collectors Club Scenes", "TCCS") {
  ...
  function whitelistMint(bytes32[] calldata merkleProof) external nonReentrant {
    ...
    require(!whitelistMinted[_msgSender()], "already");

    bytes32 leaf = keccak256(abi.encodePacked(_msgSender()));
    require(MerkleProof.verify(merkleProof, whitelistMerkleRoot, leaf), "whitelist");
