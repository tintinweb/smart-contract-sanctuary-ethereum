...
contract WolfGuildVestingMintPass is ERC1155, AccessControl, Ownable {
    bytes32 public constant TWGNFT_CONTRACT_ROLE = keccak256("TWGNFT_CONTRACT_ROLE");
     ...
     * @param id TODO
     */
    function mint(address to, uint256 id) public onlyRole(TWGNFT_CONTRACT_ROLE) {
        _mint(to, id, 1, "");
    }
     ...
     * @param id TODO
     */
    function burn(address from, uint256 id) public onlyRole(TWGNFT_CONTRACT_ROLE) {
        _burn(from, id, 1);
    }
