...
import "https://github.com/manifoldxyz/creator-core-extensions-solidity/blob/main/contracts/dynamic/DynamicArweaveHash.sol";
...
contract AnnoOxypetalum is DynamicArweaveHash, IERC721CreatorExtensionApproveTransfer {
    ...
    function approveTransfer(address, address, uint256) public override returns (bool) {
        ...
        emit GetCurrentSeason(_seasonOnLastTransfer);
        return true;
    }
