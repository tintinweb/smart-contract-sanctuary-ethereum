...
contract Stake {
    ...
    enum UserActions{DEPOSIT, REFER, HARVEST, WITHDRAW}
    ...
    function deposit(uint256 amountToStake) public {
        ...
        if (
            ...
            require(cmnReferral(referralAddress).payReferral(msg.sender, msg.sender, 0, amountToStake), "Can't pay referral");
    ...
    function depositWithReferral(uint256 amountToStake, bytes3 referralCode) public {
        ...
        if (
            ...
            require(cmnReferral(referralAddress).setUserReferral(msg.sender, referral), "Can't set user referral");

            require(cmnReferral(referralAddress).setReferralAddressesOfUsers(msg.sender, referral), "Can't update referral list");
    ...
    function depositUSDTWithReferral(uint256 amountToStake, bytes3 referralCode) public {
        ...
        if (
            ...
            cmnReferral(referralAddress).payReferral(msg.sender, msg.sender, 0, amountToStake.div(1e8).div(cmnRate));
        }
