...
contract BTCBusTickets is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BTC Bus Tickets", "BTCBus") {
    setHiddenMetadataUri("ipfs://QmXG48QXgmSMzEDvsDtATyweSaJkhLg7931Vpk98LcB6wp/hidden.json");
  }
