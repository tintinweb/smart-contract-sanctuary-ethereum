...
contract sbvxtest5 is ERC721A, Ownable {
    ...
    address public sbContract = 0xf1Dd745faC306cc90aa84E7ab135cC7B44c69824;
 
    bool public saleIsActive;
    bool public revealed;

    constructor() ERC721A("sbvxtest5", "SBvxt5") {
        saleIsActive = false;
        revealed = false;
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(totalSupply() + _mintAmount <= MAX_SUPPLY, "Not enough Sbvxtest5 remaining.");
