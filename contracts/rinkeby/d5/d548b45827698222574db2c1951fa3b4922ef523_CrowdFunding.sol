...
contract CrowdFunding {
    ...
    event funderEvent(address addr, uint256 amount);
    ...
    */
    ...
    function getFunderData(uint256 campaignID, uint256 funderID) public returns(address, uint256){
        Campaign storage c = campaigns[campaignID];
        emit funderEvent(c.funders[funderID].addr, c.funders[funderID].amount);
