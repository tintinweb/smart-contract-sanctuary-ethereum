...
contract Collectible is ERC721 {
    ...
    uint256 public collectionSize = 11;
    ...
    constructor() ERC721("TestoE", "TEST") {
        ...
        baseTokenURI = "https://gateway.pinata.cloud/ipfs/Qmc4nhqYy4AsG1EP5GVvQK9th77jJa8jucXvdrBfefNd7E/"; // ONLY FOR TESTING
    }

    function publicSaleMint(uint256 quantity) external payable callerIsUser
    {
        require(tokenCounter + 1 <= collectionSize, "reached max supply");
