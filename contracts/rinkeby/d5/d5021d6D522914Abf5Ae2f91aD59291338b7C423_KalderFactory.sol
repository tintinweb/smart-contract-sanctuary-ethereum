...
contract KalderFactory {
    ...
    /// @param extraBurnCredit_          Amount of extra credit received towards tier for burning `tokbrandToken_`
    /// @param renewalPrice_             Amount of `brandToken_` needed to renew `membershipNFT_`
    /// @param renewalLength_            Length of time renewing `membershipNFT_` will recieve
