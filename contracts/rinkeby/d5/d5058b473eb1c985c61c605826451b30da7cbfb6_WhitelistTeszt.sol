...
contract WhitelistTeszt is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public pubCost = 0.06 ether;
  ...
  function publicMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(!paused, "Public mint is not live yet!");
    require(!whitelistedOnly, "Public mint is not live yet!");
  ...
  function wlMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
...
function isWhitelisted(address _user) public view returns (bool) {
  ...
  function setPublicCost(uint256 _pubCost) public onlyOwner {
    pubCost = _pubCost;
  }
