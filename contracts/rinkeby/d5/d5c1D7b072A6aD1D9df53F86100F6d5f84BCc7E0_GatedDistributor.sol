...
abstract contract RequestGuildRole is ChainlinkClient {
    ...
    function requestAccessCheck(
        ...
        Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.testCheckRole.selector);
    ...
    function testCheckRole(bytes32 requestId, uint256[] memory returnedArray)
        external
        checkRole(requestId, returnedArray)
    {}
