...
contract Marimo is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public constant ETH_PRICE = 0.001 ether;
    ...
    function publicMint() external payable returns(uint256) {
      require(ETH_PRICE == msg.value, "Incorrect ETH sent; check price!");
      _tokenIds.increment();
        ...
        returns (string memory)
    {
...

      {
        ...
        json = abi.encodePacked(
          '{"name": "',
          Strings.toString(1111),
          "hoge",
          Strings.toString(tokenId),
          '", "description": "Hold On for Dear Life", "created_by": "a", "image_data": "data:image/svg+xml;base64,',
          Base64.encode(svg),
          '","attributes":[{"display_type": "number", "trait_type": "a", "value": "',
          Strings.toString(1),
          '"}]}'
        );
      }
