...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xdB060e6832980fFaa5b60De4cb24371d004FB715];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 7447) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihrzgvpiqq2roh4ey6s4lkmvnejtqxfn7ydjnlcy3vc5i5v65aavq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 7447");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 7447");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 7447");
...
// File: contracts/TopGearTitansContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TopGearTitansContract is RamppERC721A {
    constructor() RamppERC721A("TopGear Titans", "TGT"){}
}