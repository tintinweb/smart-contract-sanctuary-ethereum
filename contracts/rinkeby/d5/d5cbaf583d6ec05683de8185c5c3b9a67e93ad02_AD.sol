...
contract AD is ERC721A, ERC2981, Ownable {
    //events
    ...
    constructor(string memory __name, string memory __symbol,string memory initialURI,address _RoyaltyReceiver, uint96 _royaltyAmount)  ERC721A(__name, __symbol)  {
        URI = initialURI;
    ...
    function setTokenInfo(string memory __name, string memory __symbol) public onlyOwner {
        _Tokenname = __name;
        _Tokensymbol = __symbol;
    }
