...
contract TTT is Context, IERC20, Ownable {
    ...
    string private _symbol = "$T444";
    string private _name = "T444";
    ...
    constructor(address _anonxContractAddress, address _opsWallet) {
        ...
        emit Transfer(address(0), _opsWallet, presale);
        emit Transfer(address(0), _msgSender(), lp);
        emit Transfer(address(0), _anonxContractAddress, anonx);
    }
    ...
    function applyExternalTransactionTax(
        ...
        _reserveTokenBalance[anonxContractAddress] = _reserveTokenBalance[
            anonxContractAddress
        ].add(reserveValues.reserveTransferAmountAnonx);
        emit Transfer(sender, anonxContractAddress, transactionValues.anonxTax);
        _reserveTokenBalance[royaltyAddress] = _reserveTokenBalance[
            royaltyAddress
        ].add(reserveValues.reserveTransferAmountAnonxRoyalty);
        emit Transfer(sender, royaltyAddress, transactionValues.anonxRoyalty);
    }
    ...
    function _transferToExcluded(
        ...
        if (!taxx) {
            if (recipient == tokenPairAddress) {
                _reserveTokenBalance[recipient] = _reserveTokenBalance[
                    recipient
        ...
        returns (TransactionValues memory)
    {
        ...
        transactionValues.netTransferAmount = transferAmount
            ...
            .sub(transactionValues.anonxTax)
            .sub(transactionValues.anonxRoyalty);
    ...
    function _getRValues(
        ...
        reserveValues.reserveTransferAmountAnonx = transactionValues
            .anonxTax
            .mul(currentRate);
        reserveValues.reserveTransferAmountAnonxRoyalty = transactionValues
            .anonxRoyalty
            .mul(currentRate);
        reserveValues.reserveTransferAmount = reserveValues
            .reserveAmount
            .sub(reserveValues.reserveFee)
            .sub(reserveValues.reserveTransferAmountAnonx)
            .sub(reserveValues.reserveTransferAmountAnonxRoyalty);
