  ...
  ReentrancyGuard
{
  ...
  address public combineContract;
  ...
  function combine(uint256 recipeId) public payable virtual whenNotPaused {
    ...
    address[] memory addresses = new address[](requiredTokenIds.length);
    ...
    // transfer tokens to contract for trade-in
    ...
    emit Combined(msg.sender, recipeId);
  }
