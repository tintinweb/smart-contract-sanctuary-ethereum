...
contract StakingToken is ERC20("CitaDAO Staking Token", "xKNIGHT") {
    ...
    function enterFor(uint256 _amount, address recipient) public {
        _enter(_amount, recipient);
    }

    // Enter the bar. Pay some KNIGHTs. Earn some shares.
    // Locks Knight and mints xKnight
    function _enter(uint256 _amount, address recipient) internal {
