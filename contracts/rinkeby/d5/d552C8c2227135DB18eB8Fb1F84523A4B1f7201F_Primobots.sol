...
contract Primobots is ERC721A, Ownable {
    ...
    uint256 public constant HARD_CAP = 75;
    ...
    uint256 public constant ROYALTY_HUNDRED_PERCENT = 100000;
    uint256 public constant SEVEN_POINT_FIVE_PERCENT = 7500;
    ...
    constructor(
        ...
        royaltiesValue = SEVEN_POINT_FIVE_PERCENT;
    ...
    */
    ...
    /*
        This method will transfer x tokens from remaining tokens to an address after sale have ended
    */
    ...
    */
    function updateWhitelist(string memory _whitelistHash, bytes32 root)
        external
        onlyOwner
    {
        require(!is_collection_locked, "Collection locked");
