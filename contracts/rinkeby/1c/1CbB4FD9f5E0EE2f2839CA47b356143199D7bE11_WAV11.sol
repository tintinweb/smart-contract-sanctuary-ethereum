...
contract WAV11 is Ownable, ERC721A, ReentrancyGuard, ERC2981{
    uint256 public tokenCount;
    uint256 public batchSize = 100;
    uint256 private wLMintPrice = 0.003 ether;//本番でここを書き換える
    uint256 private mintPrice = 0.005 ether;//本番でここを書き換える
    uint256 public MintLimit = 3;
    uint256 public _totalSupply = 20;//本番でここを書き換える
  ...
  constructor(
  ) ERC721A("WAV11", "W11",batchSize, _totalSupply) {
     tokenCount = 0;
  }
  ...
  function withdrawRevenueShare() external onlyOwner {
    ...
    address artist = payable(0xb3c897C51957b2f8c7B051b61045C2E56Db67788); //本番でここを書き換える
    address engineer = payable(0x2aE5393CFE777a65f30692dBf0aE9Aaa20352b40); //本番でここを書き換える
    address marketer = payable(0x7a1824E35FFb5c76AFd06984700957C5DF26cC93);//本番でここを書き換える
    address manager = payable(0x2901f5FdAe6f75f0e1f0D6fD3905D3096ced3E86); //本番でここを書き換える
    bool success;
