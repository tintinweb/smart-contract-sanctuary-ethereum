...
contract CuddlesMintPass is Ownable, ERC721A, ReentrancyGuard {
  ...
  bool public isFreeMintOn = false;
  ...
  function mint(uint256 numberOfTokens) external payable {
    ...
    require(
      isFreeMintOn,
      "The free mint is not turned on."
    );

    require(
      balanceOf(msg.sender) < maxPerMint,
  ...
  function fillAddresses(address[] memory addresses, uint8 amountOfNFTs) external onlyOwner {
  ...
  function setWeiPrice(uint256 newWeiPrice) external onlyOwner {
