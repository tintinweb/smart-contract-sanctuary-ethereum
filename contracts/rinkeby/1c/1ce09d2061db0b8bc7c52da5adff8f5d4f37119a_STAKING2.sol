...
contract STAKING2 is Ownable {
    ...
    mapping(address => uint256) public _unstakeTime;
    ...
    function stake(uint256 _amount) public {
        ...
        if( totallock[msg.sender] == 0){
               _unstakeTime[msg.sender] += lockTimePeriod;
        }
    ...
    function Unstake() public {
        require(_unstakeTime[msg.sender]< block.timestamp," next unstake time is not over");
        require(
        ...
        for (
            ...
            if (
                ...
                _unstakeTime[msg.sender] =  _stakeDetail[msg.sender].lockedTime[msg.sender][i + 1 ];
...
totallock[msg.sender]-=AvailableForClaim[msg.sender];
        ...
        returns (uint256[] memory, uint256[] memory)
    {
       ...
       function _totalStakedbyUser() public view returns (uint256) {
        return  _stakeDetail[msg.sender].totalStaked;
    }
}