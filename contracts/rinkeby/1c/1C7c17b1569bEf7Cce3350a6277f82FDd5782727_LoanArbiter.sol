...
contract LoanArbiter is Ownable {
    ...
    function createLoanCampaign(
        ...
        require(balance >= amount, "Not enough funds in account"); /// This does not in rinkeby June 16, 2022
...
contract LoanProvider is Ownable {
    ...
    /// @notice the address of the loan orchestrator
...
contract LoanOrchestrator {
    ...
    /// @param _loanId The ID of the loan
    /// @param _bids The loan bids that the borrower is applying against their loan
...
contract LoanAuction is Ownable {
    ...
    event LoanAuctionBidCreated(uint256 loanBidId);
