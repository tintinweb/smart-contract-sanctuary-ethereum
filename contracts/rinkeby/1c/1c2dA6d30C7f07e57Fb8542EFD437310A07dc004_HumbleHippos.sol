...
contract HumbleHippos is ERC721Enumerable, Ownable {
  ...
  uint256 public PricePS = 0.05 ether;
  uint256 public MaxToken = 9999;

  constructor(string memory _initBaseURI,string memory _initnotRevealURI)
    ERC721("Humble Hippos", "HH") { setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI); }
