...
contract DiceGame {
    ...
    function rollTheDice() public payable {
        ...
        console.log("Block no %s: ", block.number);
...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public onlyOwner {
        require(address(this).balance >= _amount, "Not enough ETH to widhdraw");
        (bool success, ) = _addr.call{value: _amount}("");
        require(success, "Faild to withdraw");
    }

    //Add riggedRoll() function to predict the randomness in the DiceGame contract and only roll when it's going to be a winner
    function riggedRoll() public {
        require(address(this).balance > 0.002 ether, "Not enough ETH to play");
        ...
        uint256 roll = uint256(hash) % 16;
        require(roll < 3, "You are not gonna win");
