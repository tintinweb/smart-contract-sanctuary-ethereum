...
contract MetaSkulls is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    using ECDSA for bytes32;

    address private _signer;
    address[] private _wallets = [0x5Ab97a42DC7a0BB297E88286d193844773615E97];
    uint256[] private _walletShares = [100];
    ...
    ) ERC721A("MetaSkulls", "SKULL") PaymentSplitter(_wallets, _walletShares) {
        _signer = signer;
        baseURI = initBaseURI;
        maxMint = _maxMint;
