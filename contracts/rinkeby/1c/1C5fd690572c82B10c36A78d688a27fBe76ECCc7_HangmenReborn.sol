...
contract HangmenReborn is ERC721A, Ownable, ERC2981{
    ...
    string public contractURIString = "https://bafkreicbnqjnohiiwwxkordaabbyfppq2vvynpi2kdaywpiecgfc74pwny.ipfs.nftstorage.link/";
    ...
    function mint(uint256 _amount) external payable publicSaleActive callerIsUser {
    ...
    /// The public sale should be active for this call to succeed
    function xchange() external burnActive callerIsUser {
    ...
    function ogAirdrop() external onlyOwner {
        require(ogAirdropped == false, "OGs already received their airdrop");
        _safeMint(0xf17A57CC21b2d9Bbe8E2da1fa6a0F14a8c85FF1F, 1); 
        _safeMint(0x96612D11511D57DBa6705d43381dBbF6662783Eb, 1);
        _safeMint(0xaDFF354cfA10AD48C6898511BC3f7845aedB7Fb4, 1);
        _safeMint(0x9b7015Ea9466371d23391319D78Fa20C280B3B02, 1);
        _safeMint(0xE2416008F80c575DcA8281E3e600016023C5c105, 1);
    ...
    function airdrop(uint256 _amount, address _user) external onlyOwner {
        require(totalSupply() + _amount <= MAX_SUPPLY, "Not enough mints left");
