...
contract MFContract is ERC721, Ownable {
  ...
  uint public maxPerTransaction = 10;  //Max Limit Per TX
  uint public maxPerWallet = 10; //Max Limit Per Wallet
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxPerTransaction, "MAx Per Transaction Is 10");
    require(balanceOf(msg.sender) + _mintAmount <= maxPerWallet, "10 Tokens Per Wallet Allowed!");
 ...
 function addWhitelistUser(address _user) public onlyOwner {
  ...
  function removeWhitelistUser(address _user) public onlyOwner {
   ...
   function withdraw(uint amount_in_wei) public onlyOwner {
        uint256 balance = address(this).balance;
       require(balance > amount_in_wei); 
