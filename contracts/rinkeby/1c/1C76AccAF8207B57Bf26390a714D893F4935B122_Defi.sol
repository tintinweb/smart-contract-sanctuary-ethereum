...
contract Defi is Ownable {
    ...
    function setRate(uint256 rate) external onlyOwner {
        firstToSecondTokenRate = rate;
        secondToFirstTokenRate = 10**18/rate;
    }
    ...
    function exchange(uint256 _amount, TokenInterface sendToken, TokenInterface receiveToken, uint256 rate) private {
        require(_amount > 0, "You need to exchange at least some tokens");
        ...
        require(outPutValue <= receiveToken.balanceOf(address(this)), "Not enough money in the pool");
