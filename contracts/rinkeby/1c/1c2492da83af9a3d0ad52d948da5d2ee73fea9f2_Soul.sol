 ...
 *
 * Soulbound: Only contract owner can transfer.
 */
...
// File: Soulbound/Soul.sol


pragma solidity ^0.8.4;


contract Soul is ERC721S{
    ...
    /**
     * set NFT name, only called once when deploy.
     */
    ...
    /**
     * set NFT symbol, only called once when deploy.
     */
     ...
     * Minter mint NFT.
     */
    function _mint(address to) external onlyMinter {
        _safeMint(to, 1, '');
    }
    ...
    function removeMinter(address minter) external onlyOwner {
        require(minters[minter], "Minter not exist");
