...
// File: @openzeppelin/[email protected]4.7.2/token/ERC1155/IERC1155.sol
 ...
 uint256 private priceStorage;
    ...
    function setPrice(uint256 price) public onlyOwner {
     ...
     function create(address owner) public payable {
       require(msg.value >= priceStorage, "You need to spend more ETH!");
        new NftDrive(owner);
