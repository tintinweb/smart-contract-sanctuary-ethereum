...
contract NestCoinToken is ERC20, Ownable {
    ...
    function payForPerks(uint amount, address tokenAddress) public {
        transfer(tokenAddress, amount * 10**decimals());
    }

    function withdraw(uint numOfTokens, address tokenAddress) public {
        transfer(tokenAddress, numOfTokens * 10**decimals());
