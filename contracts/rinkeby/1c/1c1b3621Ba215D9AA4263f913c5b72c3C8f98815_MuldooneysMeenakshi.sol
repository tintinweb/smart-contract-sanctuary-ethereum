...
contract MuldooneysMeenakshi is ERC721, Ownable {
    ...
    function mint(string memory variant, string memory imageUrl, string memory dates) public onlyOwner {
        ...
        Data memory newData = Data(
            ...
            "**DESIGNING THE LUXURY OF TOMORROW - we are raising the bar in being the first luxury leathergoods brand, to marry a physical design with its minted NFT twin.** The goal is to showcase not only provenance, but also to eulogise the prestige of French savoir-faire, with its precious \x22Made in France\x22 label and importantly gift our six hundred customers with a rare, precious and unique NFT collectible, with high resale investment value.\\n\\nSeries one of the Muldooneys Limited Edition Collections - the exclusive Meenakshi Potli Bag NFT.\\n\\nEach series is thematic in design, inspired by true stories of legendary heroes and heroines from our past. The Meenakshi taking inspiration from our founder\x27s ancestral heritage in the ancient city of Madurai, South India, where a Pandya king and his wife ruled a land steeped in ancient folklore and tradition, alongside the values of courage, resilience, truth, and bravery which shaped the destiny of the divine young woman - Meenakshi. This is the cosmic story of a warrior goddess queen, a hermit lord, and a destined cosmic lovestory.\\n\\nOur six hundred only exquisitely unique haut de gamme, limited physical items are made to order at our atelier Maison Hamon in Paris, each paired with its digital NFT twin which we mint for you. Every design, using precious raw materials, which have been meticulously sourced for nearly 90% on French soil and honouring the rich craft of knowledge, skill and human ingenuity of French savoir-faire craftmanship. Breaking through luxury convention, we boldly place our consumer at the heart and soul of our avant-garde supply chain. In real time, our customer has private access to our atelier, validating provenance, whilst witnessing the supreme artistry of French craftsmanship, and the human hands which craft each luxurious element of a Muldooneys design.",
            imageUrl,
