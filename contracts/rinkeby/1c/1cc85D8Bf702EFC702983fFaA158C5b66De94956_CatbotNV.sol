...
contract CatbotNV is ERC1155Supply, Ownable, ReentrancyGuard, IERC2981 {
    ...
    uint32 public redeemStart;              // May 20 5/20 9am EST
    uint32 public redeemEnd;                // June 3 06/03 9am EST
    ...
    uint256 public constant NV2_PUBLIC_PRICE = 60000000000000000;   // 0.06 ETH and I ould prefer this read NV2_PUBLIC_PRICE
	uint256 public constant NV2_PRIVATE_PRICE = 80000000000000000;	// 0.08 ETH for Private sale NV2_PRIVATE_PRICE
