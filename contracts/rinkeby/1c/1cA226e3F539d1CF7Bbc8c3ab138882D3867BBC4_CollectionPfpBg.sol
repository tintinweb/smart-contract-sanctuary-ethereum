...
contract CollectionPfpBg is Ownable, DestroyLockable {
    ...
    constructor(address stringUtilsContract, address _pfpContract, address owner, address _pfpBgContract, address _pfpAdapterContract, string memory _name) {
        stringUtils = IStringUtilsV2(stringUtilsContract);
        pfp = IERC721(_pfpContract);
        pfpContract = _pfpContract;
    ...
    function getImage(uint256 tokenId) public view returns(bytes memory) {
        ...
        address pfpOwner = pfp.ownerOf(tokenId);
