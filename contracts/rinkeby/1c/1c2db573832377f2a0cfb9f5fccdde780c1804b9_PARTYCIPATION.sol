...
interface ERC721TokenReceiver {
  // When an ERC721 token is transferred to said contract this function
  // is called. Any return value other than the magic value should
  // result in the transaction being reverted. 
...
contract PARTYCIPATION {
  ...
  // Name of the token.
  string private constant _name = "PARTYCIPATION";
