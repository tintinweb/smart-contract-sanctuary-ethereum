...
contract MaidsMarketPlace is Ownable {
  ...
  CryptoMaidsItem721 public Item721 = CryptoMaidsItem721(0xa7259Ccb3E851f8d639e79C28ac82B7Ee4B3C678);
  ...
  function createMarketSale (
    ...
    Item721.mint(msg.sender,itemId);
...
contract CryptoMaidsTest is ERC721A, AccessControl {
  uint256 public constant MAX_ELEMENTS = 10000;
  string public defaultURI;

  event UpdateDefaultURI(string defaultURI);

  constructor() ERC721A("CryptoMaidsTest", "CMT") {
    defaultURI = "";
  }
