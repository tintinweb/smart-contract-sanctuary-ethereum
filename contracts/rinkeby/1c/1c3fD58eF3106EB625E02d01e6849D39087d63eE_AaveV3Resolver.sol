...
contract AaveV3Helper is DSMath {
    ...
    function getPendingRewards(
        ...
        IAaveProtocolDataProvider aaveData = IAaveProtocolDataProvider(IPoolAddressesProvider(getPoolAddressProvider()).getPoolDataProvider());
    ...
    ) internal view returns (AaveV3UserData memory) {
    ...
    function getV3Token( address token)
        internal
        view
        returns (AaveV3Token memory tokenData)
    {
    ...
    function userCollateralData( address token)
        internal
        view
    ...
    function getUserTokenData(
        address user,
        address token
    ) internal view returns (AaveV3UserTokenData memory) {

        IAaveProtocolDataProvider aaveData = IAaveProtocolDataProvider(IPoolAddressesProvider(getPoolAddressProvider()).getPoolDataProvider());
        // console.log(IPoolAddressesProvider(getPoolAddressProvider()).getPoolDataProvider());
