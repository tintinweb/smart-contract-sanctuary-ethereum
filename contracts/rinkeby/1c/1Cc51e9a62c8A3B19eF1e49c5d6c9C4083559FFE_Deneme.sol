...
contract Deneme is ONFT721 {
    uint public nextMintId;
    uint public maxMintId;
    
    string BASE_URI;
    bool public SALE_MODE = true;

    uint constant maxTokenPerTx = 10;
    uint constant maxTokenPerWallet = 20;

    mapping (address => uint) addressToMintCount;
    
    constructor(address _layerZeroEndpoint, uint _startMintId, uint _endMintId) ONFT721("Deneme", "dnm", _layerZeroEndpoint) 
    {
    ...
    internal 
    {
        require(nextMintId <= maxMintId, "ONFT721: max mint limit reached");
    ...
    onlyAccounts
    {
        require(SALE_MODE, "Sale haven't started");
        require(numberOfTokens <= maxTokenPerTx, "Too many requested");
        require((nextMintId + numberOfTokens) - 1 <= maxMintId, "Exceeds total supply");
