...
/**
 * @title Test2 contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */


contract Test2 is ERC721Burnable {
    using SafeMath for uint256;

    uint256 public MAX_TEST2_SUPPLY;
    uint256 public currentMintCount;

    mapping (address => bool) public whitelist;

    constructor() ERC721("Test2", "Test2") {
        MAX_TEST2_SUPPLY = 3500;
    }
     ...
     * Mint Test2
     */
    function reserveTest2(address to, uint256 numberOfTokens) external {
        require(to != address(0), "Invalid address to reserve.");
        require(currentMintCount.add(numberOfTokens) <= MAX_TEST2_SUPPLY, "Reserve would exceed max supply");
