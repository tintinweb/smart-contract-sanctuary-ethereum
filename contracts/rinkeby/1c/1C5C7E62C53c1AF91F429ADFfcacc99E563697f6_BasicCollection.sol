...
contract BasicCollection is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(address _proxyRegistryAddr) ERC721('BasicCollection 19/02/22', 'BC') {
        proxyRegistryAddr = _proxyRegistryAddr;
        setHiddenMetadataUri('ipfs://QmfBuAhK9Ccunnm9VKhw1KDpbWebNEH4TSYWuA9PKc6cAQ/hidden.json');
    }
