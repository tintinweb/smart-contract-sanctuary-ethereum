...
//////////////////////////////////////Merkle Tree Root Address  - Gas Optimisation
  ...
  constructor() ERC721A("TestContract", "TC") {
    setPlaceHolderUri("ipfs://QmZN7wTK9b9ji3WcXf1wsdtK9b5jfn6H5453fb6KTyp6EN/hiddengif.json");
  }
...
//////////////////////////////////////public
    ...
    modifier isValidMerkleProof(bytes32[] calldata merkleProof, bytes32 leaf) {
        require(MerkleProof.verify(merkleProof,leaf,keccak256
	(abi.encodePacked(msg.sender))),"Address does not exist in list");
        _;
    }
