...
contract MetaMultiSigWallet {
    ...
    mapping(address => bool) public IsAllowedToTransferFunds;
    ...
    constructor(uint256 _chainId, address[] memory _owners, uint _signaturesRequired) {
        ...
        for (uint i = 0; i < _owners.length; i++) {
            ...
            isOwner[owner] = true;
            IsAllowedToTransferFunds[owner] = true;
    ...
    function transferFunds(address payable to, uint256 amount) public onlySelf {
        //require(!IsAllowedToTransferFunds[newSigner], "addSigner: owner not unique");
