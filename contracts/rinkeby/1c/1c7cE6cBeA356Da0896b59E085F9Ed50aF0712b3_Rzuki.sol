...
contract Rzuki is Ownable, ERC721A, ReentrancyGuard {
    ...
    function setAllowListMintAmount(uint256 newAllowListMintAmount) external onlyOwner {
        require(newAllowListMintAmount >= 0, "AllowList amount must be greater than zero");
        require(newAllowListMintAmount <= collectionSize, "AllowList amount must be greater than collectionSize");
        allowListMintAmount = newAllowListMintAmount;
    }
    ...
    function setAmountForPublicSale(uint256 newAmountForPublicSale) external onlyOwner {
        require(newAmountForPublicSale >= 0, "Public sale amount must be greater than zero");
        require(newAmountForPublicSale <= collectionSize, "Public sale amount must be greater than collectionSize");
        amountForPublicSale = newAmountForPublicSale;
    }
