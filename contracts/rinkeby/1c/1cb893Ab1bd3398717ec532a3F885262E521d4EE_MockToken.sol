...
contract MockToken is BEP20 {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "BSW::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "BSW::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "BSW::getPriorVotes: not yet determined"
        );
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(
            ...
            "BSW: _addMinter is the zero address"
        );
    ...
    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(
            ...
            "BSW: _delMinter is the zero address"
        );
