...
contract HivePass is ERC1155Supply, Ownable
{
    ...
    constructor() ERC1155("ipfs://QmW9KTELZDn1JWXX1Qj3W7muGR4vVyFac6HtTUHs7Sup6n/{id}") {} // this is your URI function which is inputed when contract is deployed, this is linked to the metadata share link that's uploaded on IPFS
    ...
    function mintReservedTokens(address to, uint256 tokenId, uint256 amount) external onlyOwner
    {
