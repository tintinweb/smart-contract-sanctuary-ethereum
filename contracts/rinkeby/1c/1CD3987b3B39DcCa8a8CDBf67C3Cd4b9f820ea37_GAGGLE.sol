...
address public tokenPairAddress;
    ...
    address private  psWallet;
    address private cmoAddress;
    ...
    constructor(address _teamAddress, address _treasuryAddress, address _cmoAddress, address  _psWallet)  {   
    ...
    function applyExternalTransactionTax(
        ...
        _reserveTokenBalance[teamAddress] = _reserveTokenBalance[teamAddress].add(reserveValues.reserveTransferAmountTeam);
        _reserveTokenBalance[treasuryAddress] = _reserveTokenBalance[treasuryAddress].add(reserveValues.reserveTransferAmountMarketing);
