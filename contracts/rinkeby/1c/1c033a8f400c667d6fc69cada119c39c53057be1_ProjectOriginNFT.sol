...
contract ProjectOriginNFT is ERC721Enumerable, Whitelist {
  ...
  string private baseURI="https://kspdvsd.elb.cisinlive.com/";
  bool public isSaleStarted=false;
  string public notRevealedUri="https://kspdvsd.elb.cisinlive.com/";
  ...
  string _name = "MYProjectNFT";
  string _symbol = "MNF";

  constructor() ERC721(_name,_symbol) payable{
  }
