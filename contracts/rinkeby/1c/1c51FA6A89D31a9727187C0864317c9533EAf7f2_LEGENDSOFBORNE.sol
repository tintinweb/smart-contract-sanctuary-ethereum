...
//  ∰∰∰Ω     爪ρρρρρρρρρρρρρρρρ☤☤☤☤LGENEDS☤☤☤☤☤ρρρρρρρρρρρρρρρρ爪     Ω∰∰∰∰
//  ∰∰∰Ω     爪ρρρρρρρρρρρρρ☤☤☤☤☤☤☤☤☤☤OF☤☤☤☤☤☤☤☤☤☤ρρρρρρρρρρρρρ爪     Ω∰∰∰∰
//  ∰∰∰Ω     爪ρρρρρρρρρρρρ☤☤☤☤☤☤☤☤☤BORNE☤☤☤☤☤☤☤☤☤☤ρρρρρρρρρρρρ爪     Ω∰∰∰∰
//  ∰∰∰Ω     爪ρρρρρρρρρρρρ☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤☤ρρρρρρρρρρρρ爪     Ω∰∰∰∰
...
contract LEGENDSOFBORNE is ERC721A, Ownable{
    using Strings for uint256;
    ...
    constructor() ERC721A("LEGENDS OF BORNE", "LOB"){

    }

    modifier callerIsUser() {
        require(tx.origin == msg.sender, "LEGENDS :: Cannot be called by a contract");
        _;
    }

    function mint(uint256 _quantity) external payable callerIsUser{
        require(publicSale, "LEGENDS :: Not Yet Active.");
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "LEGENDS :: Beyond Max Supply");
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "LEGENDS :: Already minted 3 times!");
        require(msg.value >= (PUBLIC_SALE_PRICE * _quantity), "LEGENDS :: Below ");
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        require(whiteListSale, "LEGENDS :: Minting is on Pause");
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "LEGENDS :: Cannot mint beyond max supply");
        require((totalWhitelistMint[msg.sender] + _quantity)  <= MAX_WHITELIST_MINT, "LEGENDS :: Cannot mint beyond whitelist max mint!");
        require(msg.value >= (WHITELIST_SALE_PRICE * _quantity), "LEGENDS :: Payment is below the price");
        //create leaf node
        bytes32 sender = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, merkleRoot, sender), "LEGENDS :: You are not whitelisted");
    ...
    function teamMint() external onlyOwner{
        require(!teamMinted, "LEGENDS :: Team already minted");
        teamMinted = true;
