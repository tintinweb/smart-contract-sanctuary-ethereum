...
contract ContentGuild is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, EIP712, ERC721Votes {
    ...
    function updateURI(uint256 tokenId, string memory uri) public onlyRole(UPDATE_URI_ROLE) {
        _setTokenURI(tokenId, uri);
    }

    function burnMembership(uint256 tokenId) public onlyRole(BURN_MEMBERSHIP_ROLE) {
        _burn(tokenId);
    }    
