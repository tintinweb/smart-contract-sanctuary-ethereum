...
contract ERC721A is
    ...
    IERC721Enumerable
{
    event Mint(address owner, uint256 tokenId, uint256 mintType);
    ...
    function _safeMint(
        ...
        _safeMint(to, quantity, "", mintType);
    }
    ...
    function _safeMint(
        ...
        _mint(to, quantity, _data, true, mintType);
    }
    ...
    function _mint(
        ...
        unchecked {
            ...
            for (uint256 i; i < quantity; i++) {
                emit Mint(to, updatedIndex, mintType);
