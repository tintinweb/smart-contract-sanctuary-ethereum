    ...
    Withdrawable
{
    ...
    uint256 public currentNftType = 1;
    // old supply + new supply
    uint256 public currentMaxQuantity = 100;
    ...
    function mint(address sender) internal {
        ...
        idToNFTType[newTokenId] = currentNftType;
    ...
    {
        require(
            typesQuantity[currentNftType] + 1 <= currentMaxQuantity,
        ...
        typesQuantity[currentNftType] += 1;
        publicSalesMinterToTokenQty[msg.sender] += 1;
        publicSalesMintedQty += 1;
        mint(msg.sender);
    }

    function changeCurrentMaxQty(uint256 maxQty) external onlyOwner {
        currentMaxQuantity = maxQty;
    }
    
    function changeCurrentNFTType(uint256 nftType) external onlyOwner {
