...
contract BookNFT1155 is ERC1155, Ownable, AccessControl, ERC2981PerTokenRoyalties {
    ...
    function _verify(NFTVoucherERC1155 calldata voucher) internal pure returns (address) {
    ...
    function _sendFunds(address _beneficiary, uint256 _value) internal returns (bool) {
        ...
        (bool success2, ) = payable(_beneficiary).call{value: _value - feeAmount}('');
