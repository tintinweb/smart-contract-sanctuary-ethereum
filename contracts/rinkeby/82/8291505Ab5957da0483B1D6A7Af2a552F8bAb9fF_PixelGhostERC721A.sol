...
// @author PixelGhost https://twitter.com/PixelGhost
...
contract PixelGhostERC721A is Ownable, ERC721A, PaymentSplitter 
{
    ...
    uint private constant MAX_PUBLIC = 2400;
    ...
    uint public saleStartTime = 1650837600; 
    ...
    */
    ...
    /**
    * @notice Mint funtion for the Public Sale
    *
    * @param _account Account which will receive the NFT
    * @param _quantity Amount of NFTs the user wants to mint
    */
    ...
    */
    ...
    /**
    * @notice Get the token URI of an NFT by this ID
    *
    * @param _tokenId The ID of the NFT you want to have the URI from the metadatas
    *
    * @return the token URI of an NFT by this ID
    */
    ...
    */
    ...
    /**
    * @notice Allows to change the starting time (timestamp) of the whitelist sale 
    *
    ...
    */
    ...
    /**
    * @notice Release the gains of every accounts
    */
    ...
    //Not allowing receiving ETH outside minting functions
