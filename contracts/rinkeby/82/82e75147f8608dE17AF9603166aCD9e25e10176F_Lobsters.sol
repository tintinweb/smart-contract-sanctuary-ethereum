...
contract Lobsters is ERC721, Ownable {
    ...
    // Constructor
    constructor(string memory baseURI) ERC721("The Lobsters", "LOBS") {
        setBaseURI(baseURI);
    }
    ...
    function _mintNFTs(uint256 _count) public payable {
        ...
        require(
            _count > 0,
            "NFTs to mint shud be greater then 0"
        );
