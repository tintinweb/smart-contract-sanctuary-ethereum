...
contract Staker {
    ...
    function withdraw() public notCompleted {
        require(!executed || openForWithdraw, "you have staked!");
        if (balances[msg.sender] == 0) {
            revert Withdraw_BalanceZero();
        } else {
            uint256 userBalance = balances[msg.sender];
            console.log("withdrawing balance is: ", balances[msg.sender]);
