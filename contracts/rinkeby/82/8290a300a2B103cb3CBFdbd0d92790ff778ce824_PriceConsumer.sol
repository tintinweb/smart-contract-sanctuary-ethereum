...
contract PriceConsumer is IPriceConsumer, OwnableUpgradeable, SuperAdminControl{
    ...
    IProtocolRegistry govProtocolRegistry;
    IClaimToken govClaimTokenContract;
    ...
    /// @param _AdminRegistry the contract address of the gov admin registry
    /// @param _swapRouterv2 uniswap V2 router contract address
    /// @param _govProtocolRegistry address of gov protocol registry
    /// @param _govClaimToken address used for getting the price of the SUN ERC20 token 
    function initialize(
        ...
        govProtocolRegistry = IProtocolRegistry(_govProtocolRegistry);
        govClaimTokenContract = IClaimToken(_govClaimToken);
    ...
    */
    ...
    ///@dev get multiple token prices in array
    /// @param priceFeedToken array of price feed token addresses
    ...
    function getSUNTokenPrice(
        ...
        uint256 lengthSunTokens = claimTokenData.sunTokens.length;
        for (uint256 i = 0; i < lengthSunTokens; i++) {
