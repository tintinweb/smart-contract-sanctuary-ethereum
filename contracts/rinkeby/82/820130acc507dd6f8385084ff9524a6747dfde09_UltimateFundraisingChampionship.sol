...
The Champion ERC-20 Token fighting for good causes via the power of smart contracts.

https://t.me/UFC_Portal
https://ufctoken.org
...
contract UltimateFundraisingChampionship is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 1e12 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "UltimateFundraisingChampionship";
    string private constant _symbol = "UFC";
    ...
    uint256 public _buyMarketingFee = 1000;

    uint256 public _sellTaxFee = 0;
    uint256 public _sellLiquidityFee = 200;
    uint256 public _sellMarketingFee = 1000;
    ...
    uint256 private gasPriceLimit = 420 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 51 / 10000; // 0.51% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xD28A437bC20eCbf87E69eCd1d1cF7c2D67267157); // Marketing Address
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (_tTotal * 1 / 1000)/1e9, "Cannot set maxTransactionAmount lower than 0.1%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 3000, "Must keep sell taxes below 30%");
