...
contract PandaNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 private constant AUCTION_START_PRICE = 0.04 ether;
  ...
  uint256 private _auctionMaxSupply = 10000;
  uint256 private _marketingSupply = 200;
  uint256 private _salePrice = 0.04 ether;
  ...
  constructor(address verifier) ERC721A("My Pandaverse NFT", "PANDANFT") {
    _verifier = verifier;
  }
