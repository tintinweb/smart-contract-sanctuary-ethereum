...
contract PruebaRepticenzStaking is ERC721Enumerable, Ownable {
    ...
    uint256 cost = 0.06 ether; //Costo de cada NFT en Token nativo de la blockchain
    uint256 public maxSupply = 20;
    uint256 public maxMintAmount = 5;
    bool public paused = false;

    constructor() ERC721("PruebaStakingRepticenz", "RPT") {}
    ...
    return "ipfs://QmQbnBYBWhhGsSzZS3zeg2FzfMaMcWTYhY8fp91x9FZdF7/"; //Metadata
