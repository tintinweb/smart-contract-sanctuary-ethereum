    ...
    Ownable
{
    ...
    mapping(uint256 => bool) public mintedTokenList;
    uint256 nextMint = 0;
    ...
    function _mint() internal {
        bool found = false;
        while(found==false){
            if(mintedTokenList[nextMint]!=true){
                found=true;
            } else{
                unchecked{
                    nextMint = nextMint + 1;
    ...
    // I guess people might try to time this to get a rare one,
    // but so be it, I don't want to mint them out of sequence
