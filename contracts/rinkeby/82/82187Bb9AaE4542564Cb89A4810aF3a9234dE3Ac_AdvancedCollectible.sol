...
// the "doggie", "dog" and tokenCounter is needed for Erc721
// vrfcoordinator, linktoken, keyhash and fee is needed for vrfconsumerbase
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    // this mapping is to allow for the original caller of the createcollectible function to be saved and used
        ...
        override
    {
        ...
        // we need this owner inorder to call safemint function;
        _safeMint(owner, newTokenId);
        tokenCounter = tokenCounter + 1;
    }

    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        // pug, shiba inu, st bernard, doge
        require(
            _isApprovedOrOwner(_msgSender(), tokenId),
            "ERC721: caller is not owner or not approved"
        );
        _setTokenURI(tokenId, _tokenURI);
        // _isApprovedOrOwner and _msgSender are imported from openzeppenlin
        // for this project we will create our own seturi function
        // a challenge: make it more decentralized and have the fulfillrandomness decide what the token uri is;
    }
}