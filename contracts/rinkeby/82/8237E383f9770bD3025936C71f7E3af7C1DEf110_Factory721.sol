...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new AxerNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AxerNFTUser721Token token = AxerNFTUser721Token(address(addr));
...
contract AxerNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
