...
import "./ParadoxUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new ParadoxUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ParadoxUser721Token token = ParadoxUser721Token(address(addr));
...
contract ParadoxUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
