...
abstract contract TimedDrop is Ownable {
  ...
  */
  ...
  uint256 public allowlistDropTime = 1657368000;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb4a9391C658bc1d5a4fd7928c5306d16046141f8];
...
// File: contracts/BatangmatabaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BatangmatabaContract is RamppERC721A {
    constructor() RamppERC721A("BATANG MATABA", "MATABA"){}
}
