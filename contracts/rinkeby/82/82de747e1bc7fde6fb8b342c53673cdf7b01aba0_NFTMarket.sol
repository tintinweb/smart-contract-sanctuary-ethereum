...
contract NFTMarket is ReentrancyGuard {
  ...
  function removeNFTFromMarketPlace(uint marketId) public {
      MarketItem memory marketItemRequested = idToMarketItem[marketId];
      require(marketItemRequested.seller == msg.sender, "Not authorized  to Unlist from Marketplace");
      IERC721(marketItemRequested.nftContract).transferFrom(address(this), marketItemRequested.seller, marketItemRequested.tokenId);
      delete idToMarketItem[marketId];
  }
