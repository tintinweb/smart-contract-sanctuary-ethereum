...
contract PartyPanda is ERC721PayableMintableComposableSVG, NamedToken {
    ...
    constructor()
        ERC721PayableMintableComposableSVG(NAME, "PANDA", 0.001 ether, 88, 888, 0)
        NamedToken(NAME)
    {}
        ...
        returns (string memory)
    {
        ...
        string
            memory description = "PartyPanda NFT.";
    ...
    function _generatePartyValue(uint256 tokenId)
        ...
        returns (string memory)
    {
        return Strings.toString(((tokenId % 23) + 8) / 3);
    }
    ...
    function _renderPart1(string memory colourValue) private view returns (string memory) {
        return string.concat(
                            '<g>'
                '<path d="M97.5 183.5C74.6216 172.252 65.9569 172.657 60.5 189.5C61.7965 206.417 64.4896 211.212 71.5 '
                '214.5C81.677 219.386 109.921 212.591 142.5 208C188.364 213.702 218.201 217.828 224 214.5C232.506 209.093 '
                '235.972 204.713 235 189.5C226.847 177.739 221.84 172.899 209 180L193 171.5L97.5 183.5Z" fill="', colourValue, '" '
                'stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M115 205.5L110.5 164.5H167.5V209.5C150.995 214.952 133.639 219.09 115 205.5Z" fill="#FFFFFF" '
                'stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M124 215C117.592 216.507 90.858 227.135 85 211C85.4188 199.475 86.3637 189.441 88.6471 '
                '179.5C92.0535 164.671 98.4388 150.05 110.5 131C138.227 148.26 151.273 144.3 179 131.5C191.01 148.587 198.173 '
                '163.474 198.093 176C198.066 180.215 199.095 184.615 198.093 189.5C198.093 189.5 196.5 199 196.5 211C196.5 223 '
                '164 226.5 160.5 211C157 195.5 159.224 203.088 164 176C149.423 173.017 139.68 173.288 120.5 176C123.345 '
                '180.885 130.408 213.493 124 215Z" fill="', colourValue, '" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M160.5 71.5C178.621 62.5062 177.714 71.2718 177 92L160.5 71.5Z" fill="', colourValue, '" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M108 85.5C105.124 67.9781 109.048 63.7832 126 69L108 85.5Z" fill="', colourValue, '" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M177 91.9999C159.5 56.5 125 56.5 106.5 88.9999C97.8342 112.757 97.2981 122.968 110.5 131C137.857 '
                '149.75 151.837 147.44 179.5 131C183 125.5 185.999 106.081 177 91.9999Z" fill="#FFFFFF" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
        );
    }

    function _renderPart2(string memory colourValue) private view returns (string memory) {
        return string.concat(
                '<path d="M131.5 125.5C140.601 129.374 141.74 128.997 149.5 125.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M129 111.5C133.5 107 146 109 148 112.5C143 117.5 134 116.5 129 111.5Z" fill="', colourValue, '" stroke="black"'
                'stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<path d="M125 87C130.099 92.5842 127.743 92.4853 129.5 96C124.515 96.6247 120.656 99.9901 112 111C110.828 '
                '107.681 110.529 107.515 109 102.5C107.471 97.4855 119.901 81.4158 125 87Z" fill="', colourValue, '" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<circle cx="119" cy="98" r="4" fill="black"/>'
                '<path d="M162.5 85C155.836 87.9964 153.053 90.4772 150 96.5C158.04 100.952 162.128 104.876 168.5 115L174 '
                '107.5C171.537 96.0404 169.54 90.4268 162.5 85Z" fill="', colourValue, '" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
                '<circle cx="159" cy="99" r="4" fill="black"/>'
                '</g>'
        );
    }
        ...
        returns (string memory)
    {
        ...
        return
            string.concat(
                ...
                _renderPart1(colourValue),
                _renderPart2(colourValue),
