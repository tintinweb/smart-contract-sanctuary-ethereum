...
contract MetazedOnChainSale is AccessOperatable {
  ...
  uint256 public whitelistSaleEnd = 253404860400; //JS: new Date(9999, 12, 31).getTime() / 1000

  // 現在の供給量
  uint256 public maxSupply = 5000;
  uint256 public maxByMint = 20;

  // ホワイトリストミントセールと普通のセールの価格を別にしておく
  uint256 public whitelistSalePrice = 5 * 10**14;
  uint256 public salePrice = 5 * 10**14;
