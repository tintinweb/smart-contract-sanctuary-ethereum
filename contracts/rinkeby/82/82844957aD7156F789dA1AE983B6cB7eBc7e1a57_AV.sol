...
contract AV is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("AV", "AVT") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 35;
  ...
  uint256 public constant MAX_SUPPLY = 3747;
