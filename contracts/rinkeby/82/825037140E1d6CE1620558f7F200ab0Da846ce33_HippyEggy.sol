...
contract HippyEggy is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HippyEggy", "HE") {
    setHiddenMetadataUri("ipfs://QmSBbmsDKy8mMVSikBa5hEhcixgYg9hv4wi4T9fMmQVsRf/469.json");
  }
