...
contract Test_States is ERC721Enumerable, Ownable, ReentrancyGuard {
    uint256 private Supply_Per_Address = 5; // How many token an address can mint
    uint256 private Max_Total_Supply = 10; // No of total token
    uint256 private Unit_Price = 0.1 ether;
    string private BaseURI;
    string private OpenseaUrl;
