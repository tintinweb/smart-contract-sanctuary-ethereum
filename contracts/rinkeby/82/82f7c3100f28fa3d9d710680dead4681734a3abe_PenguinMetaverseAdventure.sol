...
contract PenguinMetaverseAdventure is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public FinalMaxSupply = 3000;
...
//下列两行是设置了梯度MINT设置，CurrentMaxSupply 可设置开放多少NFT数量mint,mint数量完成后再开放设置
