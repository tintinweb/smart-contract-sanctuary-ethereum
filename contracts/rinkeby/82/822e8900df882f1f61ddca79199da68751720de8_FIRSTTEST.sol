...
// File contracts/ERC721A.sol
    ...
    contract FIRSTTEST is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    ...
    uint256 public freeMaxSupply = 4;
    uint256 public maxSupply = 20;
    uint256 public price = 0.001 ether;
    bool public paused = false; 
    bool public revealed = false;
    mapping(address => uint256) public addressMinted;
    constructor() ERC721A("FIRSTTEST", "FT") {setHiddenMetadataUri("ipfs://QmSJAyv9odhWHsVQAd14oXfKhqc4sEjkDhyiBrPxkdkF9P/hidden.json");}
