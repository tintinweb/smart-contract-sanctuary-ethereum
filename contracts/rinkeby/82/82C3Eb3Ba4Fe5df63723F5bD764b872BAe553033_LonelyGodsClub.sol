...
contract LonelyGodsClub is ERC721Enumerable, Ownable {
    ...
    uint256 public pubSaleCost = 90000000000000000;
    uint256 public prvSaleCost = 70000000000000000;
    ...
    function mint(uint256 numberOfTokens) external payable {
        ...
        require(SafeMath.add(totalSupply(), numberOfTokens) <= MAX_SUPPLY, "Exception: All was minted.");
        require(SafeMath.add(totalSupply(), numberOfTokens) <= PUBLIC_SUPPLY, "Exception: The public supply has been minted out.");
        require(SafeMath.add(mintedPerAddress[msg.sender], numberOfTokens) <= maxMintAmount, "Exception: Reached the limit for each user. You can't mint no more");
        require(SafeMath.mul(getCost(), numberOfTokens) <= msg.value);
        ...
        mintedPerAddress[msg.sender] = SafeMath.add(mintedPerAddress[msg.sender], numberOfTokens);
    }
