...
// File: contracts/PropertyContract.sol
...
contract PropertyContract{
    ...
    function changePropertyPricePerHr(string calldata _propertyName, uint _newPricePerHr) external onlyOwner{
        IlandBaronstorage(landBaronStorageContract).updatePricePerHr(_propertyName, _newPricePerHr);
    }

    function addProperty(string calldata _propertyName, uint _propertyPricePerHr) external onlyOwner{
    ...
    function updateReservableStatus(string calldata _propertyName, uint _oneOrZero) external onlyOwner{
