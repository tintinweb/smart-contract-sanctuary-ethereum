...
contract NDZ is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 1000;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1000 at a time");
