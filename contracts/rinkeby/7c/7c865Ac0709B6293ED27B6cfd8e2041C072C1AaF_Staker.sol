...
contract Staker {
  ...
  modifier deadlineReached (bool requireReached) {
    ...
    if (requireReached) {
      require(timeRemaining <= 0, "Deadline isn't reached!");
    } else {
...
function stake() public payable deadlineReached(false) stakingNotCompleted {
  ...
  function withdraw() public deadlineReached(true) stakingNotCompleted {
    require(openForWithdraw, "Not open for withdraws!");

    uint256 userBalance = balances[msg.sender];

    require (userBalance > 0, "User didn't deposit any amount.");
