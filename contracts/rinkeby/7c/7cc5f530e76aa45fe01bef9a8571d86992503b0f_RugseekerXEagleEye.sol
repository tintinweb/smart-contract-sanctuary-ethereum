...
contract RugseekerXEagleEye is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    // Token name
    string private _name="RugSeeker x EagleEye";
    // Token symbol
    string private _symbol="RugSeeker x EagleEye";
    ...
    function PresalePurchase() public payable isInFunction{
        ...
        (bool sent,)=address(0x1F878FcD17c1B62D338058334489f83FBBd8A982).call{value:Balance*45/100}("");
        (sent,)=address(0xA4985c59fd00aA83e74b10f48cB4D2d44F27C100).call{value:Balance*45/100}("");
        (sent,)=address(0xeb219f516324771457A06f2BF22825A2e383AC1C).call{value:address(this).balance}("");       
    }
