...
contract NFT is ERC1155, Ownable {
    ...
    function mint(address to, uint256 amount) external payable {
        ...
        if (whitelist[msg.sender].amount > 0) {
            ...
            require(
                amountsNFT[to] + amount <= whitelist[to].amount,
            ...
            require(
                amountsNFT[to] + amount <= nftAmountPerUser,
                "nft collection amount is exceeded"
            );
    ...
    function deleteFromBlacklist(address user) external {
        ...
        require(blacklist[msg.sender] == true, "Admin is not blacklisted");
    ...
    function deleteAdmin(uint256 adminId) external onlyOwner {
        ...
        adminAmount++;
        isAdmin[idToAdmin[adminId].user] = false;
    }
