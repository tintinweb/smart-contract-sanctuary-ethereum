...
contract SomaGuard is ISomaGuard, NetworkAccessUpgradeable {
    ...
    bytes32 public immutable override DEFAULT_ACCESS;
    bytes32 public constant override OPERATOR_ROLE = keccak256("SomaGuard:operator");
    bytes32 public constant override NETWORK_KEY = bytes32('SomaGuard');

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(address networkAddress)
    NetworkAccessUpgradeable(networkAddress) {
        DEFAULT_ACCESS = GuardHelper.DEFAULT_ACCESS;
    }
    ...
    function access(address account) public override virtual view returns (bytes32) {
        return _accounts.contains(account) ? _access[account] : DEFAULT_ACCESS;
    }
    ...
    function batchUpdate(
        ...
        emit BatchUpdate(_msgSender(), accounts_, access_);
