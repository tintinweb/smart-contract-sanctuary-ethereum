...
//"Fiona through a kid's eyes"  - Fiona a través de los ojos de un niño

contract FionaThroughKidsEyes is ERC721A, Ownable, ERC2981 {

    uint256 public constant MAX_SUPPLY = 10035;
    uint256 public constant PUBLIC_SALE_PRICE = 0.001 ether; // fix price 0.015
    ...
    constructor(uint96 _royaltyFeesInBips, address _royalty, string memory _URI) ERC721A("WildFlower", "PRFIONA") {
