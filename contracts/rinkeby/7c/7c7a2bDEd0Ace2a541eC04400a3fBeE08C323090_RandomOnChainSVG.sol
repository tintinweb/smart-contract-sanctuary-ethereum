...
contract RandomOnChainSVG is ERC721URIStorage, ERC721Enumerable, VRFConsumerBase, Ownable {
    ...
    //SVG Params
    uint256 public immutable maxPaths = 15;
    uint256 public immutable maxPathCommands = 10;
    uint256 public immutable size = 1000;
    string[] public pathCommands = ["M", "L"];
    string[] public colors = ["red", "green", "blue", "black", "white", "purple", "orange", "brown", "pink", "cyan", "magenta"];
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
     ...
     //required function overrides for ERC721, ERC721URIStorage, and ERC721Enumerable
