...
// TODO: finish withdraw functionality
contract NounCatsInvisibles is ERC721, Ownable {
    ...
    // We go one over actual max supply because < is cheaper than <= gas-wise.
    uint256 public constant MAX_SUPPLY = 10_001;

    // Tracking which nonces have been used from the server
    mapping(string  => bool) public usedNonces;

    // Tracking which addresses have minted their 1 free Noun Cat
    ...
    // The Merkle tree root for minting a free Noun Cat to certain addresses
    ...
    // Tracking whether we've minted out 50 Noun Cats yet
    ...
    /// @notice Mint up to 20 Noun Cats in a transaction
    ...
    /// @notice Allows the team to mint Noun Cats to a destination address
    ...
    /// @notice Allows the team to do a one-time mint of 50 cats for events, giveaways, collabs, fun future things, etc. We like surprises.
    ...
    function withdraw() external payable onlyOwner {
      address a1 = 0x9c74d98552D8A94E946833Fd4D294A4BD7E1c5BD;
      (bool sent, ) = a1.call{value: address(this).balance}("");

      // NOTE: Please audit the below

      // TODO: replace these with the real addresses
      // address a1 = 0x17F6AD8Ef982297579C203069C1DbfFE4348c372;
      // address a2 = 0x5c6B0f7Bf3E7ce046039Bd8FABdfD3f9F5021678;
      // address a3 = 0x03C6FcED478cBbC9a4FAB34eF9f40767739D1Ff7;
      // address a4 = 0x1aE0EA34a72D944a8C7603FfB3eC30a6669E454C;
      // address a5 = 0x0A098Eda01Ce92ff4A4CCb7A4fFFb5A43EBC70DC;

      // uint balance = address(this).balance;
      // uint256 smallBal = balance * 50/1000;
      // uint256 largeBal = balance * 425/1000;

      // (bool sent, ) =  a1.call{value: smallBal}("");
      // require(sent, "a1 Send failed");
      // (bool sent2, ) = a2.call{value: smallBal}("");
      // require(sent2, "a2 Send failed");
      // (bool sent3, ) = a3.call{value: smallBal}("");
      // require(sent3, "a3 Send failed");
      // (bool sent4, ) = a4.call{value: largeBal}("");
      // require(sent4, "a4 Send failed");
      // (bool sen5, ) =  a5.call{value: largeBal}("");
      // require(sen5, "a5 Send failed");
    }
