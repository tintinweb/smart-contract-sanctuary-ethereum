...
contract Block is ERC20Upgradeable, Delegatable, IBlock {
  ...
  uint256 public constant MAX_CIRCULATION = 5 * 10**8 * 10**18;
  ...
  */
  ...
  function claim(
    ...
    require(
      totalSupply() + amount <= MAX_CIRCULATION,
      "Circulation limit exceeded"
    );
