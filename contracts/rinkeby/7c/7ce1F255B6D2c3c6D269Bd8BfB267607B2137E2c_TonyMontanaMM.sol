...
contract TonyMontanaMM is ERC721A, Ownable, PaymentSplitter {
    ...
    uint256 public PRICE_PER_TOKEN_OG = 0.001 ether;
    ...
    function setOgList(address[] calldata addresses, uint16 numAllowedToMint)
        external
        onlyOwner
    {
    ...
    function setIsFreeOgMintActive(bool _isFreeOkMintActive) external onlyOwner {
