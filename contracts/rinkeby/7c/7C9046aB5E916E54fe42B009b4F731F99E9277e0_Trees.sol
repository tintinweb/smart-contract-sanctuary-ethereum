...
contract Trees is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable maxPerTx;

    constructor(uint256 maxBatchSize_, uint256 collectionSize_)
        ERC721A("Trees", "TREES", maxBatchSize_, collectionSize_)
    {
    ...
    uint256 public devPoolRemaining = 2;
