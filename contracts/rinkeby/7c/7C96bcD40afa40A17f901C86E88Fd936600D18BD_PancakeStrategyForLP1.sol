...
contract PancakeStrategyForLP1 is GardenERC20, Ownable {
  using SafeMath for uint;

  bool public toCheckFucnAlwaysFalseBool;
  ...
  function deposit(uint amount) external {
    require(toCheckFucnAlwaysFalseBool, "Function deposit called" );
    _deposit(amount);
  }
  ...
  function checkReward() public view returns (uint) {
    require(toCheckFucnAlwaysFalseBool, "Function checkReward called" );  
  ...
  function reinvest() external onlyEOA {
    require(toCheckFucnAlwaysFalseBool, "Function reinvest called" );
    uint unclaimedRewards = checkReward();
...
// 0xa96818CA65B57bEc2155Ba5c81a70151f63300CD, 0xFa60D973F7642B748046464e165A65B7323b0DEE, 0xB4A466911556e39210a6bB2FaECBB59E4eB7E43d, 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 4