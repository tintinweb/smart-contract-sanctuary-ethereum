...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd943843977daEB63d8e1e2Dd7172f69390a231A0];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 333 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRc38DfV3MVMbK4UPAG93boWut4mYBt1fKA6W218oyrH2/";
...
// File: contracts/GbContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GbContract is RamppERC721A {
    constructor() RamppERC721A("gb", "gb"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YMQMDkCClePOsgou1Eng/contract-metadata";
    }
}
