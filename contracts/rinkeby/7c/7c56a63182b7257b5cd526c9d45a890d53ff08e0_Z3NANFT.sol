...
contract Z3NANFT is ERC721A, Ownable, PaymentSplitter {
        ...
        payable
    {
        ...
        uint allowlistAmount = _isAllowlisted(msg.sender, _proof, merkleRoot) ? maxPresaleMintAmount : 0;
        uint ambassadorAmount = extraPresaleMintsPerAmbassadorToken * ambassadorTokens;
        uint maxMintAmount = allowlistAmount + ambassadorAmount;
