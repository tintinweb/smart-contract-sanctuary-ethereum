...
contract Testing is ERC721A, Ownable {
    ...
    address private ADDR1 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;    
    address private ADDR2 = 0xe9D1e9AE86E681b73bd3430b2c7bbE9192fB29Eb;

    mapping(address => uint256) private publicMintTracker;
  ...
  SaleState public saleState = SaleState.OFF;
    ...
    function mint(uint256 quantity) external payable {
       ...
       require(
        ...
        require(
           publicMintTracker[msg.sender] + quantity <= maxPerWallet,
            "Too many tokens for one wallet"
        );
        _safeMint(msg.sender, quantity);
        publicMintTracker[msg.sender] = publicMintTracker[msg.sender] + quantity;
    }

    function withdraw() public onlyOwner {
        uint balance = address(this).balance;
        payable(ADDR1).transfer(balance * 60 / 100);
        payable(ADDR2).transfer(balance * 40 / 100);
    }
