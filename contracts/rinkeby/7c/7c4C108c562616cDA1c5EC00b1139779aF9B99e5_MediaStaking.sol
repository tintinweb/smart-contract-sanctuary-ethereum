...
contract MediaStaking is Ownable, Pausable {
    ...
    constructor() {
        address _nuggs = 0x9697b4eE6Ae1c23a12709356569d920CB2A3F6aC; // 0x39b037F154524333CbFCB8f193E08607B241A44C; // ToDo: PRODUCTION address
        address S1MediaAddress = 0x073eEF397EA05c567a139a5d75e00c2B8E285f27; // 0xEA3670f81b7ccE94477B214185D9DD49298FE932; // ToDo: PRODUCTION address
        nuggs = NUGGS(_nuggs);
