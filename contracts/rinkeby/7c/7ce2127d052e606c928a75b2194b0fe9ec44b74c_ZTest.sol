...
contract ZTest is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZTEST14";
    string private constant _symbol = "ZTEST14";
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                if(_winnersAmountToBePaid[from] != 0){
                    ...
                    if(amountAfterTx >= _minBuyPrize){
                        ...
                        if(_lastBuyer == from && _timer != 0 && newAmountToBePaid < _winnersAmountToBePaid[from].add(_prizeAmount)){
                            //Not participating anymore
                            _lastBuyer = address(0);
                            _timer = 0;
                        }
    ...
    function payWinners() public{
        ...
        address[] memory _winnersCopy = _winners;
