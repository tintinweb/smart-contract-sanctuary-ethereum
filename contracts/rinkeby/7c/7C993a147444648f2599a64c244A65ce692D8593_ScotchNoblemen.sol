...
contract ScotchNoblemen is  Initializable, ERC721AUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol,uint256 _maxSupply,string memory _baseUri,
    uint256 _maxMintLimit) public initializer {
   ...
   function _authorizeUpgrade(address) internal override onlyOwner {}
    ...
    function mint() external payable {
        ...
        require(quantity >= 1 && quantity <= maxMintLimit , "The number of quantity is not between the allowed nft mint range.");
    ...
    function updateMaxMintLimit(uint256 _maxMintLimit) public onlyOwner{
        require(_maxMintLimit > 0,"Invalid max mint value.");
        maxMintLimit = _maxMintLimit;
    }
