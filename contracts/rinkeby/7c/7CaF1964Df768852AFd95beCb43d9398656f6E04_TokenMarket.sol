...
contract TokenMarket is TokenMarketBase, PausableImplementation {
    ...
    uint256 public multiCollateralLimit;
        ...
        whenNotPaused
    {
        ...
        uint256 collateralTokenLength = loanDetails
            ...
            .length;
        require(collateralTokenLength <= multiCollateralLimit, "GLM: Collateral Length Exceeded");
    ...
    function setAllowedMultiCollateralLimit(uint256 _collateralLimit) external onlySuperAdmin(msg.sender) {
        require(_collateralLimit > 0, "GTM: zero value provided");
        multiCollateralLimit = _collateralLimit;
    }
