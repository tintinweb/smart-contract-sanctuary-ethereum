...
import "contracts/market/pausable/PausableImplementation.sol";
    ...
    SuperAdminControl
{
    ...
    function set1InchAggregator(address _1inchAggregatorV4) external onlySuperAdmin(AdminRegistry, msg.sender) {
