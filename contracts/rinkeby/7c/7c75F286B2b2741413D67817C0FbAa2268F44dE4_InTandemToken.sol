...
contract InTandemToken is IntandemERC1155 {
    ...
    bytes32 private merkleRootHash = 0x2b14666aa3cccc8088f5a7515491af8fb83ecc05051ff49798ded3cb31267796;
    uint8 private whitelist_check=1;
    ...
    constructor(address _admin, string memory _firstTokenURI) ERC1155("https://base_uri/"){
        name_ = "INTDM";
        symbol_ = "INT";
        mtCounter.increment();
        _grantRole(DEFAULT_ADMIN_ROLE, _admin);
        addMintToken(_firstTokenURI);
    }
    ...
    function addMintToken(
        ...
        _update_mt(mt, _ipfsMetadataLink);
        mtCounter.increment();
    ...
    function editMintToken(
        ...
        _update_mt(mintTokens[_tokenIndex], _ipfsMetadataLink);
    }
    ...
    function airdrop(uint _tokenID, uint _amount, address _addr) external onlyOwner {
        if(_addr == 0x0000000000000000000000000000000000000000) revert AirdropToNull();
