...
contract Unicorns is Ownable, ERC721AQueryable, ERC721ABurnable {
    // ============ State Variables ============
    ...
    function mint(uint256 quantity) external payable onlyWhenNotPaused callerIsUser {
        require(_totalMinted() + quantity <= maxTokenIds, "Not enough supply");
    ...
    function nftsMinted(address userAddress) public view returns (uint256) {
