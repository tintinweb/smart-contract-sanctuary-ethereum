    ...
    NFTOrders
{
        ...
        returns (bool[] memory successes)
    {
        require(
            ...
            sellOrders.length == callbackData.length,
            "ERC1155OrdersFeature::batchBuyERC1155sWithMaxNumber/ARRAY_LENGTH_MISMATCH"
        );
        successes = new bool[](sellOrders.length);
        ...
        if (revertIfIncomplete) {
            ...
            require(maxNFTs > 0, "ERC1155OrdersFeature::batchBuyERC1155sWithMaxNumber/maxNFTs_CANNOT_BE_ZERO");
            for (uint256 i = 0; i < sellOrders.length; i++) {
