...
/**
888 messages floating in the ocean awaiting their beholder. 
Rumor has it inside are quests, heroes, villains, maps, and maybe even treasure.
*/
...
// File: contracts/MessageInABottle.sol
...
contract MessageInABottle is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmRfgBtpe99xuJ3BiBiq6gM6jH9YraLTf2RCpPzwcTN4Cw/";
  ...
  ) ERC721A("MessageInABottle", "OpenMe") {
