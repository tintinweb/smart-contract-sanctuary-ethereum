...
contract ceshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ceshi";
    string private _symbol = "ceshi";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC7204bAc8918c39a605545908C67c2aE15F35566));
        marketingWalletAddress = payable(address(0xC7204bAc8918c39a605545908C67c2aE15F35566));
