...
contract PkSvgNft is ERC721 {
    ...
    uint256 public testPaymentAmount;
    address public testPaymentFromAddress;
    ...
    // Only for testing purposes.  Want to make sure payment can be received the way I believe that it can
    function testReceivePayment() external payable {
        // uint256 public testPaymentAmount;
        // address public testPaymentFromAddress;
        testPaymentAmount = msg.value;
        testPaymentFromAddress = msg.sender;
    }
}
