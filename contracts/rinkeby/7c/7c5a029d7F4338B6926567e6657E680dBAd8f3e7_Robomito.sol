...
contract Robomito is ERC721A, Ownable, ReentrancyGuard {
    address private constant creator1 =
        0xC5c3F1f563fD647111044b32feAa2D5E90f72635;
    address private constant creator2 =
        0x6bB523A20Fd447bF62f2ec8b5E688F1dC9947A32;
    address private constant creator3 =
        0x097499995f5A7219b335A8Ed660E87b5F4Fa6567;
    address private constant creator4 =
        0x6ED405B1CF44276ebE04De1D4715b8d887B6A742;
	...
	uint256 private _reservedSupply = 50;
    ...
    uint256 private MAX_MINTS_PER_WHITELIST = 5;
    ...
    function getMaxMintPerWhiteList()
        external
        view
        returns (uint256)
    {
        return MAX_MINTS_PER_WHITELIST;
    }
