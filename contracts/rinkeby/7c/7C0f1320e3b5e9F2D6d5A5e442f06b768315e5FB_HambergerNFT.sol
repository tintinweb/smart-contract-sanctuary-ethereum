...
contract HambergerNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        string memory description = "There are ";

        string memory svg = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 400 400\" preserveAspectRatio=\"xMinYMin\">"
                                "<style>"
                                    ".circle {"
                                        "cx: -25;"
                                        "r: 25;"
                                ...
                                "<circle cy=\"25\" fill=\"pink\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"6s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"75\" fill=\"red\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"5s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"125\" fill=\"white\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"10s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"175\" fill=\"brown\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"4s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"225\" fill=\"yellow\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"3s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"275\" fill=\"blue\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"1s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"325\" fill=\"green\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"8s\" repeatCount=\"indefinite\"/>"
                                "</circle>"

                                "<circle cy=\"375\" fill=\"orange\" class=\"circle\">"
                                    "<animate attributeName=\"cx\" values=\"-5%;105%;\" dur=\"3s\" repeatCount=\"indefinite\"/>"
                                "</circle>"
                            "</svg>";
