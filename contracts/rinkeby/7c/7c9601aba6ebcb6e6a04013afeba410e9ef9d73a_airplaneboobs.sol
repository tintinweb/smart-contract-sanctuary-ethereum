...
// File: contracts/airplanesboobs.sol
...
contract airplaneboobs is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://3E5UHAFUBG4XMAZ2FJ8J49BR1BIXMBSQZY";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("airplaneboobs", "BOOB") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 20, "Not enough free supply");
