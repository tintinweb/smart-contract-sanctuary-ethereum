...
// File: contracts/NotAScamTokenWithPresale.sol
...
contract NotAScamTokenWithPresale is ERC20, Ownable {
    ...
    constructor() ERC20("NotAScamTokenWithPresale", "TSTP") {}

    function buyOnPresale() public payable {

        uint256 cost = getCurrentPresalePrice();
    ...
    function getCurrentPresalePrice() public view returns(uint256) {
        require(
            stage == 1 || stage == 2,
            "Presale has not started yet or has already ended!"
        );

        return stage == 2 ? presaleCost2 : presaleCost1;
    }
