...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    //["0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2","0x2260fac5e5542a773aa44fbcfedf7c193bc2c599","0x6b175474e89094c44da98b954eedeac495271d0f","0xdac17f958d2ee523a2206206994597c13d831ec7","0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"]
...
import '../interface/IERC20Uniswap.sol';
import '../interface/IUniswapV2Factory.sol';
...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        require(balance0 <= uint112(int112(-1)) && balance1 <= uint112(int112(-1)), 'UniswapV2: OVERFLOW');
    ...
    function mint(address to) external lock returns (uint liquidity) {
        ...
        if (_totalSupply == 0) {
            ...
            if (msg.sender == migrator) {
                ...
                require(liquidity > 0 && liquidity != uint256(int256(-1)), "Bad desired liquidity");
            } else {
...
import '../library/SafeMathUniswap.sol';

contract UniswapV2ERC20 {
    using SafeMathUniswap for uint;

    string public constant name = 'ParadisSwap LP Token';
