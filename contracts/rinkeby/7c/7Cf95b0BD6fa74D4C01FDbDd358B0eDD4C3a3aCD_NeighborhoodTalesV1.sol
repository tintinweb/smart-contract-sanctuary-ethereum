...
contract NeighborhoodTalesV1 is
    Initializable,
    OwnableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        __ERC721A_init(" Neighborhood Tales", "TALES");
        __Ownable_init();
    ...
    modifier isNotBot() {
        require(tx.origin == _msgSender(), "User is a bot or a contract");
        _;
    }
    ...
    // Admin only
    function giftNfts(address _receiver, uint256 _mintAmount) public onlyOwner {
        require(
            claimedReserved <= reservedNfts,
    ...
    function setMaxNftPetTx(uint256 _newLimit) public onlyOwner {
