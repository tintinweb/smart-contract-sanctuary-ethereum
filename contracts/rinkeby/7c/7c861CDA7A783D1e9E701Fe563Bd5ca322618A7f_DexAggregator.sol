...
address public SWAP_ROUTER_02= 0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45;
  ...
  function poolandamountcheck(address pool, address token,uint amountIn ) view internal returns(bool pass){
 ...
 return true;   
  ...
  function getRates(
    ...
    uint256 amountIn,
    uint8 flag
  ) public view returns (uint256[] memory, uint8,uint24 ) {
  ...
  function bestrateswap(
    ...
    (, flag,fees) = getRates(tokenIn, tokenOut, amountIn, 2);

    if (flag == 1) {
      swapuniv3(tokenIn, tokenOut, amountIn, amountOutMin,fees, to);
