// SPDX-License-Identifier: MIT
    ...
    contract UkrainianMfers is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 24000000000000000; // 0.0019 ETH 
      uint256 public constant maxTokenPurchase = 24;
      uint256 public constant MAX_TOKENS = 2402;
      ...
      uint256 public presaleMaxMint = 24;
      uint256 public devReserve = 32;
    
      event EmojiMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("UkrainianMfers", "UKRM") {}
