    ...
    PaymentSplitter
{
    ...
    string public constant TOKEN_NAME = "Grim"; // TBD
    string public constant TOKEN_SYMBOL = "GRIM"; // TBD

    string private constant SIGNING_DOMAIN = "gblsts"; // TBD (the user readable name of signing domain, i.e. the name of the DApp or the protocol.)
    string private constant SIGNATURE_VERSION = "1.0.0"; // TBD (the current major version of the signing domain. Signatures from different versions are not compatible.)

    address[] payees = [0x0d0F15B7FF1F02EDBAF333A0176440cF73A887F0]; // TODO: TBD
    uint256[] payeesShares = [100]; // TODO: TBD

    string public GRIM_PROVENANCE;

    string public tokenBaseUri;

    uint256 public constant MAX_SUPPLY = 2009; // TODO: TBD
