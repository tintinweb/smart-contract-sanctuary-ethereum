...
contract Sale is ReentrancyGuard, Ownable, Pausable {
    uint256 public IMPACT_FANTASY_PRICE_PRESALE;
    uint256 public IMPACT_FANTASY_PRICE_PUBLICSALE;
    ...
    event Mint(string indexed round, uint256 indexed price);
    ...
    constructor(
        ...
        impactFantasy = _impactFantasy;
        IMPACT_FANTASY_PRICE_PRESALE = _presalePrice;
        IMPACT_FANTASY_PRICE_PUBLICSALE = _publicSalePrice;
        _pause();
    }
    ...
    function presaleBuy(uint256 _amount, bytes32[] calldata _proof)
        ...
        isPayEnough(IMPACT_FANTASY_PRICE_PRESALE, _amount)
        nonReentrant
    {
        require(
        ...
        require(
            impactFantasy.balanceOf(_msgSender()) + _amount <=
    ...
    function publicSale(uint256 _amount)
        ...
        isInformationSet
        isPresaleStart
        isPayEnough(IMPACT_FANTASY_PRICE_PUBLICSALE, _amount)
        nonReentrant
    {
        require(
            block.timestamp > InformationSale.timeEnd,
