...
contract TheGoodDogClubLLC is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private placeholderBaseURI = "https://tgdcalllen.mypinata.cloud/ipfs/QmbdqD7o6Cbrr9LRyGgFvixsFsxwHVWeLFzLH7ihA9VSe9/";

    constructor() ERC721A("TheGoodDogClubLLC", "TGDC") {
        teamWalletPercent[teamWalletList[0]] = 66; // The Good Dog Club LLC percent
        ...
        teamWalletPercent[teamWalletList[4]] = 1; // Artist Wallet 4 percent
        teamWalletPercent[teamWalletList[5]] = 1; // Artist Wallet 4 percent
    }
