...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC72[email protected]
...
contract PlatziPunks is PlatziPunksDNA, ERC721, ERC721Enumerable{
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory){
        ...
        string memory jsonURI = Base64.encode(abi.encodePacked(
            ...
            '"description": "Platzipunks description bla bla bla.", ',
            '"image": ', image,
            '}'
        ));
