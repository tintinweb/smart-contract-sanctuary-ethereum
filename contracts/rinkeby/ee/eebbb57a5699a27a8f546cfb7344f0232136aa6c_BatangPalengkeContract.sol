...
//
//     ____        __                       ____        __                 __      
//    / __ )____ _/ /_____ _____  ____ _   / __ \____ _/ /__  ____  ____ _/ /_____ 
//   / __  / __ `/ __/ __ `/ __ \/ __ `/  / /_/ / __ `/ / _ \/ __ \/ __ `/ //_/ _ \
//  / /_/ / /_/ / /_/ /_/ / / / / /_/ /  / ____/ /_/ / /  __/ / / / /_/ / ,< /  __/
// /_____/\__,_/\__/\__,_/_/ /_/\__, /  /_/    \__,_/_/\___/_/ /_/\__, /_/|_|\___/ 
//                            /____/                            /____/            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Bataable {
  address public BATAADDRESS = 0x17Ca3D67b7AD32a3c83bAd88b509AE3D8C8371c4;

  modifier isBata() {
      require(msg.sender == BATAADDRESS, "Ownable: caller is not BATA");
      _;
  }
}
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1654012800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1653710400;
...
abstract contract Withdrawable is Ownable, Bataable {
  address[] public payableAddresses = [BATAADDRESS];
  ...
  function withdrawAllBata() public isBata {
      require(address(this).balance > 0);
      _withdrawAll();
  }
  ...
  /**
  * @dev Allows Bata wallet to update its own reference as well as update
  * the address for the Bata-owed payment split. Cannot modify other payable slots
  * and since Bata is always the first address this function is limited to the Bata payout only.
  * @param _newAddress updated Bata Address
  */
  function setBataAddress(address _newAddress) public isBata {
    require(_newAddress != BATAADDRESS, "BATA: New Bata address must be different");
    BATAADDRESS = _newAddress;
...
abstract contract BataERC721A is 
    Ownable,
    ERC721A,
    Withdrawable,
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 777 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVPhCbwkJ8VJuHLJQF8mHt7ysUEYGpFWSinfp1CTVzB1E/";
    ...
    */
     ...
     * This is a convenience function for the Bata user
     */
...
// File: contracts/BatangPalengkeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BatangPalengkeContract is BataERC721A {
    constructor() BataERC721A("Batang Palengke", "BASURA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/TOAZXTDd71WiFlajZSS5/contract-metadata";
    }
}