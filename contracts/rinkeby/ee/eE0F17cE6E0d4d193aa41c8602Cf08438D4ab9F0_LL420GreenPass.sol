...
contract LL420GreenPass is ERC1155, ReentrancyGuard, Ownable {
	...
	uint256 public constant GREEN_PASS_FEE = 0.0142 ether; // TO CHANGE IN PRODUCTION
		...
		onlyStarted
	{
		require(
			...
			"LL420GreenPass: Can't mint 0 or more than 3"
		);
		require(
	...
	// MINT OG pass -> only owner, QTY

	function minOGPasses(uint256 _amount) public onlyOwner {
		_mint(msg.sender, OG_TOKEN_ID, _amount, "");
	}
}
