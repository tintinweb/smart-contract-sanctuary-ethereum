...
//
//                                           __       
//   __  ________________ _____  ____ ______/ /___  __
//  / / / / ___/ ___/ __ `/ __ \/ __ `/ ___/ __/ / / /
// / /_/ / /  (__  ) /_/ / /_/ / /_/ / /  / /_/ /_/ / 
// \__,_/_/  /____/\__,_/ .___/\__,_/_/   \__/\__, /  
//                     /_/                   /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9faC985001D0D38079e9C6e264407ECB45a919DD];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 6464) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbrdMK3SvqdkRoj3gJWsQEFJFzF9thiDsu9EdPLsBGzrA/";
...
// File: contracts/UrsapartyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UrsapartyContract is RamppERC721A {
    constructor() RamppERC721A("ursaparty", "URSA"){}
}