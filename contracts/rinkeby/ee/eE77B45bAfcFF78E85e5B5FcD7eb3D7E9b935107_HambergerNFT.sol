...
contract HambergerNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor(ISuperfluid host) ERC721("HambergerNFT", "HMT") {
        ...
        treasuryAddress = address(new Treasury(address(this)));
    ...
    function mint(uint tokenId, uint new_nft_value) public nonReentrant {
        require(
...
contract Treasury {
    ...
    constructor(address _parentContract) {
        ...
        console.log("Parent Address: ", parentContract);
    }
}
