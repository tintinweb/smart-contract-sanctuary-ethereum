...
contract TravelToucans is ERC721A, Ownable {
    ...
    uint256 public presaleUpgradePrice = 0.03 ether;

    uint256 public price = 0.04 ether;
    uint256 public upgradePrice = 0.05 ether;
    ...
    function publicMint(uint256 amount, bool upgrade) public payable {
        ...
        if (upgrade) {
            require(msg.value >= amount * upgradePrice, "ETH incorrect");
        } else {
    ...
    function presale(uint256 amount, bool upgrade, bytes memory signature) public payable {
        ...
        if (upgrade) {
            require(msg.value >= amount * presaleUpgradePrice, "ETH incorrect");
        } else {
