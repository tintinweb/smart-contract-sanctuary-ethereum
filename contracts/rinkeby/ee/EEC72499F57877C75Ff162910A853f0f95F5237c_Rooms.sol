...
contract Rooms is ERC721AQueryable, ERC721ABurnable, Ownable {
    ...
    uint256 public maxMintGuestList = 3;
    uint256 public maxMintVip = 2;
    ...
    bytes32 public vipListMerkleRoot;
    mapping(uint256 => mapping(address => uint256)) public vipMintCount;

    string private baseURI;
    string public notRevealedUri;
    string public baseExtension = ".json";

    constructor(string memory _name, string memory _symbol, string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A(_name, _symbol) {
    ...
    function mintVip(uint256 quantity, bytes32[] calldata merkleProof)
        ...
        withinMintableSupply(quantity)
    {
        uint256 netMinted = (vipMintCount[mintRound][
            msg.sender
        ] += quantity);
     ...
     */
    function setMaxMintLimit(uint256 guestListLimit)
        external
        onlyOwner
    {
