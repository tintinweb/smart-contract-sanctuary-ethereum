...
import "./GenerativeCollection.sol";
import "@openzeppelin/contracts/finance/PaymentSplitter.sol";

contract GenerativeCollectionWithPaymentSplitter is
  ...
  PaymentSplitter
{
  ...
  receive() external payable override(GenerativeCollection, PaymentSplitter) {
