...
contract MadTesst is ERC721A, MerkleDistributor, Ownable, ReentrancyGuard {
    using Strings for string;
    
    uint256 public mintPrice = 900000000000000; ///change before test rinkbey 15
    uint256 public maxSupply = 3333;
    uint256 public maxReserve = 666;
    uint256 public maxDev = 333;
    uint256 public maxAllow = 1000;
    uint256 public maxPublic = 60;
    uint256 public maxVip = 333;

    mapping(address => uint256) public vipWalletMints;
    address payable private founderWallet = payable(0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB);
    address payable private artistWallet = payable(0x17F6AD8Ef982297579C203069C1DbfFE4348c372);
    ...
    constructor() ERC721A('Mad Tesst','MT') {}
    ...
    modifier isVipSaleOver() {
        require(saleOver, 'Public sale is not active');
        _;
    }
    /**
     * allow list
    ...
    function withdraw() external nonReentrant
    {
        ...
        (bool success, ) = founderWallet.call{value: address(this).balance / 100 * 80}("");
        (bool success2, ) = artistWallet.call{value: address(this).balance / 100 * 50}(""); 
