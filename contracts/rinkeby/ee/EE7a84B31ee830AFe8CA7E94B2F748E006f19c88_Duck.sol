...
contract Duck is IDuck, ERC721Enumerable, Ownable, Pausable {
   ...
   */
  constructor(address _egg, address _traits, uint256 _maxTokens) ERC721("The Duck U Club", 'DUC') { 
    egg = EGG(_egg);
...
function mintToAdmin(uint256 amount) public onlyOwner {
   ...
   * @return the address of the recipient (either the minter or the Duck thief's owner)
   */
