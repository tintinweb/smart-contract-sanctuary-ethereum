...
contract Goat is Context, IERC20, Ownable {
    ...
    constructor () public payable {
        _name = "GREATEST OF ALL TIME"; 
        _symbol = "GOAT"; 
        _decimals = 18; 
        _tTotal = 10_000_000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _taxFee = 0; //set to 0 to disable reflection for now
        _liquidityFee = 3; 
        _previousTaxFee = _taxFee; 
        _owner = 0xE269e61B62B40cc7895fEB9A8A3B7428D41FCAe2; //owner address
        _devWalletAddress = 0xE269e61B62B40cc7895fEB9A8A3B7428D41FCAe2; //dev address
		
		_devFee = 4; 
		_previousDevFee = _devFee;
        _previousLiquidityFee = _liquidityFee;
        _maxTxAmount = (_tTotal * 5 / 1000) * 10 ** _decimals; // 0.5%
        numTokensSellToAddToLiquidity = (_tTotal * 5 / 10000) * 10 ** _decimals; // 0.5%
