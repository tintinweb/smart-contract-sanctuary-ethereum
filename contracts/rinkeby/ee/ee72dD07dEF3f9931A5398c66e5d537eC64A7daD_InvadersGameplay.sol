...
contract InvadersGameplay is ReentrancyGuard {
  InvadersData data;
  PixelglyphPlanets planets;

  constructor(address dataAddress, address planetsAddress) {
    data = InvadersData(dataAddress);
    planets = PixelglyphPlanets(planetsAddress);
  }
  ...
  function pirate(
    ...
    require(planets.forceFields(planetId) == false, "Planet has forcefield");
    data.pirate(shipId, planetId, msg.sender, quotedPrice);
  }
  ...
  function stopMining(uint256 shipId, bool risky) public {
    data.stopMining(shipId, msg.sender, risky);
  }
  ...
  function repair(uint256 shipId) public {
    data.repair(shipId, msg.sender);
  }
