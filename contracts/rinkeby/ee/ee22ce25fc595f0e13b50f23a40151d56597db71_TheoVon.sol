...
contract TheoVon is ERC721, Ownable {
  ...
  constructor() ERC721("THEO", "VON") {
    ...
    setWhitelistMerkleRoot(0x1d947ad84898bf9cd180dfc55b5c24324898a249a87882ece946b8aadb79d8a3);
    setFreeMintMerkleRoot(0x74f8d5f14bae996522a70ca1c9355184fff5d950d04800209af060f26ed0832f);
    airdropAddresses = [0x1baD375bf12aB60C297274fD7C41555f61486bA3,
                        0x83Ad673b6A84AE7dF6cf720c8b538d28af43154d,
                        0x63234Cfa7D3D3f6324Ac5E3B4b9630f5B030F5cc,
                        0x6e0a0A204BD5C3C8f335CF046fc233bf43CbC891,
                        0x05a49FC8BC3e9B50c728f1da119139799eF20F42,
                        0x97A33c4c04c5faC124eE815565f5E5BD2A030E6d,
                        0x503686ff3f4D2b50cF8188C006A4d376F37847eE,
                        0x0ed5468f0a9278637a2eF59c765349001f0D4632,
                        0x7A7D05b55066Ce2B2F1473E4f463e286466DE202,
                        0xd6E463bfF985156F3C31B1cD057Ba472afA5c2f5,
                        0x1AD16B3F6b856f07B0006E62ab34433D210248d0,
                        ...
                        0x8CC9e33E485e688df1626aFBfCc675d794AAE55a,
                        0x467d94EdE1cE658162c8D8803249F62F478580F6,
                        ...
                        0xC7838F7225C4Ce7A1cfCC41ABaBD92e1339f394D,
                        0x007b0eCCA1c7668B107B278796bDC098AEAd2B4B,
                        0x15E9E61871AE5aAF73acFc11B55B0aB4DA95406c,
                        0x712788B926919542EFad7C0735eEa83120D9261d,
                        0x542D2098E7b8f00F377BBdbaA11F4462db9456e0,
                        0x6736D2bD8D4a65c33E02aC0867303A6a5e3b93BC,
                        0x689699635cC0d09fCeB6a07200a0159e9e199Cd6,
                        0x47314B045d0C61114805dA9b182BBCB1bC49c179,
                        0xC856dec8607C47e8355ce090C9Cf20A1F42f4161,
                        0x0776D3D61b825FFA8BD60f762da425595033F326,
                        0x3556520cC239236078e1d65864f4eAe070a48f15,
                        0x05012f437dEe5276AC13eE90A10438468c07d6DF,
                        0xaC786DA9A9739Acf17BCE9837cf9444de98C9D8D,
                        0x6ae3200d50BfE10F0F57b17C6067eAEF4f4c964A,
                        0x5ea0fa9ec290be90A5AdF3E4410aF625836EB12D,
                        0x651e4FaE590283EE46479F8b74554E0772aBed54,
                        0x524D7a3E4530B89A769a566101A9bcFbE1216F11,
                        0x8978f819DaF9b248B7F84B9664bF200DD878b353,
                        0xc85EE5d609C07B8A8a5E35865Da59Cd497c7dE6A,
                        0x1dE1A6ae33772932B99d6a2937977A47fFfB7CB7,
                        0x82059a09fdcAa41BD2228704d8de2633DF98267B,
                        ...
                        0x6f4fC2406C22F83c4D28720bF23C873F42a93D16,
                        0xC7be24E12B81830A759E67C2934370670E8f8830,
                        0x698613a5761DE25d33Ed75dFB287e6C1F16d4244,
                        0x78f0803235057a902373e915C0C833C4AA154E13,
                        0x111499A459627Ac006E3F3b96ea90f57502Ae71F,
                        ...
                        0x49eB43380F242a013cdAA2058D514017Bed3A663,
                        0x78bA0fF17C1720F4A997c8C78AB9f9DA3B774046,
                        0x2C7579b5879cBe24908C27E0A1922015c66afa92,
  ...
  function airdropTo(uint256 _start, uint256 _end) public onlyOwner {
    airdropAddresses = [0x7e43D524C09C8Cb9C7c37AE27AAF7333967A2C1b, 0xE0D48f01D10D68bd043EFe60BE3446C789d8F7b7, 0xf2cC5B9843B620272B983925b8040A81c09a2375, 0xbee0BE721ecC397EE988FCd402082D02beD12aA0, 0xC01F5C42C78e8Ea996C7e28F6A28bfC4c6C73BF2];
  
    for (uint256 i = _start; i < _end; i++) {
      mintForAddress(1, airdropAddresses[i]);
    }
  }
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) {
    ...
    IERC721 shapezToken = IERC721(shapezContract);
    uint256 shapezTokenOwned =  shapezToken.balanceOf(sender);    
    require(!paused, "The contract is paused!");
    require(msg.value >= cost * _mintAmount, "Insufficient funds!");

    if (shapezTokenOwned == 0) {
      require(isValidWhiteList(_merkleProof), "Account is not whitelisted");
    }
  ...
  // check if whitelist wallet hash is valid
  function isValidWhiteList(bytes32[] memory _merkleProof) public view returns (bool) {
  ...
  function setShapezContract(address _newAddress) public onlyOwner {
    ...
    // sets new merkle Root for WL
  function setWhitelistMerkleRoot(bytes32 _newRoot) public onlyOwner {  
  ...
  //set airdrop adresses
  function setAirdropAddresses(address[] calldata _addresses) public onlyOwner {
