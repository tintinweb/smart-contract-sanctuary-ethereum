...
// File: contracts/ELITE_CLAN_NFT.sol
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  constructor(
    ...
    teamMint(msg.sender, teamReserve);
  }
  ...
  function publicMint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
      require(onlyWhitelisted == false, "Public not live");
  ...
  function teamMint(address _to, uint256 _mintAmount) public payable onlyOwner(){
    uint256 supply = totalSupply();
    require(!paused);
    require(_mintAmount > 0);
    require(supply + _mintAmount <= maxSupply);
