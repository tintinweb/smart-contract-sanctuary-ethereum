...
// File: contracts/AppleBeetle.sol

pragma solidity ^0.8.6;



contract AppleBeetle is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public constant MAX_SUPPLY = 15;
    uint256 public constant PRESALE_MAX_SUPPLY = 10;
    uint256 public constant MAX_MINT_PER_TX_PRESALE = 3;
    uint256 public constant MAX_MINT_PER_TX = 3;
    uint256 public constant PRESALE_PRICE = 0.12 ether;
    uint256 public constant PRICE = 0.2 ether;

    string public baseURI = "ipfs://QmPCjTzfQni4sL5VrR6324Qq8GM5GZzqYH4DSKuwhaZxFj/hidden.json?id=";
    ...
    constructor() ERC721("Apple Beetle", "APBTL") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "Apple Beetle: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "Apple Beetle: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Apple Beetle: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Apple Beetle: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficientPresale(uint256 amount) {
        require(
            ...
            "Apple Beetle: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
    ...
    modifier isAllowList() {
        require(
            ...
            "Apple Beetle: You're not on the list for the presale."
        );
        _;
    }
