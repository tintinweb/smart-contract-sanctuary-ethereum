...
contract Nouneys is ERC721A, Ownable {
    ...
    uint256 public saleMaxPerWallet;
    ...
    constructor() ERC721A("Nouneys", "Nouneys") {
    ...
    function mint(uint256 quantity, bytes32[] calldata proof) external payable {
        ...
        require(
            presaleMaxPerWallet >=
                presaleRedeemedCount[_msgSender()] + quantity,
            "Max Minted"
        );
        require(
            MerkleProof.verify(
        ...
        presaleRedeemedCount[_msgSender()] =
            presaleRedeemedCount[_msgSender()] +
            quantity;
    ...
    function setSaleMaxPerWallet(uint256 maxPerWallet) external onlyOwner {
        saleMaxPerWallet = maxPerWallet;
    }
