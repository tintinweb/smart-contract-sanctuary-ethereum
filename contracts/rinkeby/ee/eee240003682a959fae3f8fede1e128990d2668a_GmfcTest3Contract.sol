...
// File: contracts/GmfcTest3Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GmfcTest3Contract is RamppERC721A {
    constructor() RamppERC721A("GMFC Test3 ", "GMFC3"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/fGtSbqhVRNupq0z3Axzx/contract-metadata";
    }
}
