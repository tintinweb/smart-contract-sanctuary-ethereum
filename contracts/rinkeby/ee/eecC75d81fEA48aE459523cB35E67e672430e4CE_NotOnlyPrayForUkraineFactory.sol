...
contract NotOnlyPrayForUkraineFactory is FactoryERC721, Ownable {
    ...
    string public constant NAME = "Not Only Pray for Ukraine - Sale";
    string public constant SYMBOL = "NOPFUS";

    address public proxyRegistryAddress;
    address public nftAddress;
    string public baseURI = "ipfs://bafybeicuzqfj7flbg5ryu3ojie3tuljl2neuuilbtoda4biuuaftmd2poi/";

    uint256 NOPFU_SUPPLY = 9999;

    uint256 NUM_OPTIONS = 2;
    uint256 SINGLE_NOPFU_OPTION = 1;
    uint256 SECOND_NOPFU_OPTION = 2;
...
//        if (_optionId == SINGLE_NOPFU_OPTION) {
