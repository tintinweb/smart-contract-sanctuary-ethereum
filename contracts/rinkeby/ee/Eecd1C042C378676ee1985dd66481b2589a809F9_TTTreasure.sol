...
contract TTTreasure is ERC721, Ownable {
  ...
  function publicMint(uint256 _mintAmount) public payable {
    ...
    require(!paused);
    require(publicSaleOpen, "TTTreasure: Public Sale is not open");
    require(_mintAmount > 0, "TTTreasure: Please mint atleast one NFT");
    require(s + _mintAmount <= maxSupply, "TTTreasure: Total mint amount exceeded");
    require(addressToMintedAmount[msg.sender] + _mintAmount <= maxMintPerWallet, "TTTreasure: Exceeded mint per wallet");
    require(msg.value == cost * _mintAmount,"TTTreasure: not enough ether sent for mint amount");

      // forward amount to treasury wallet
      (bool successT, ) = treasury.call{ value: msg.value}(""); 
      require(successT, "TTTreasure: not able to forward msg value to treasury");
      delete successT;
