...
contract readers{
    ...
    function seeProposalInfo(uint _dealId, uint _proposalId) internal  view returns(uint256, uint256, uint16, string memory, uint256, uint256, bool){
    ...
    function seeProposalCount(uint _dealId) internal  view returns(uint256){
