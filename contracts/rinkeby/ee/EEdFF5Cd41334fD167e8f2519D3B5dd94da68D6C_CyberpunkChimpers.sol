 ...
 */
contract CyberpunkChimpers is ERC721A, Ownable, ReentrancyGuard {
    
    string private __baseURI = "https://ipfs.io/ipfs/QmaP49q8T54wJNcuyqXaiVdgapcqQCHJiD6u6neAd5fHgM/";

    uint256 private _max_mint = 4;

    uint256 private _price = 0; 

    mapping(address => uint256) _account_mint;

    constructor() ERC721A("Cyberpunk Chimpers", "CC", 22, 4444) {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(msg.value >= quantity * _price, "not enough price");
