...
//   _________                      ________   _____  ________       .___.__        
//  /   _____/ ____   ____   ______ \_____  \_/ ____\ \_____  \    __| _/|__| ____  
//  \_____  \ /  _ \ /    \ /  ___/  /   |   \   __\   /   |   \  / __ | |  |/    \ 
//  /        (  <_> )   |  \\___ \  /    |    \  |    /    |    \/ /_/ | |  |   |  \
// /_______  /\____/|___|  /____  > \_______  /__|    \_______  /\____ | |__|___|  /
//         \/            \/     \/          \/                \/      \/         \/

// 3333 free mint, mint from contract, 1 mint per wallet.
// To mint, go to "Write Contract" on ethersacn, use the "3. mint" function, input 0 at mint, 1 at numberOfTokens (uint256). 
// Website: sonsofodin.xyz
// Twitter: https://twitter.com/SonsOfOdinNFT
// The gates of Valhalla await you...
...
contract Test is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxperAddressPublicMint = 0;
    bool public isPaused;


    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("SonsOfOdin", "SOO") {
        setBaseURI("ipfs://QmZhqNRkgVamcfveX9BVQLvfCaE334CnQ57wbBiYUypt44/");
