...
contract Mansoor is Ownable, ERC721A {
  using Strings for uint256;

  //URI uriPrefix is the BaseURI
  string public uriPrefix = "ipfs://QmUjJM3ptfb567whp5NPUJwqBCsXK4UMDxACxN576JLxba/";
  string public uriSuffix = ".json";

  // hiddenMetadataUri is the not reveal URI
  string public hiddenMetadataUri= "ipfs://QmSxbVEmUcxz69DGk4JgcEimQCWhLp7vGxLCccfnPxPFU1/";
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxMintAmount , "Already minted Max mint!");
