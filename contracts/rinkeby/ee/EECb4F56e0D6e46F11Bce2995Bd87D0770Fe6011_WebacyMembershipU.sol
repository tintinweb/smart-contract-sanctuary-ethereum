...
contract WebacyMembershipU is Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    // For testing only
    function updateStoredAssetsVersion(address _member) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(membershipPaid[_member], "Sender is not a member");
        business.updateStoredData(_member);
    }
}
