...
abstract contract AbstractRoyalties {
    ...
    LibPart.Part internal royaltyForAll;
    ...
    function _saveRoyaltyForAll(LibPart.Part memory _royalty) internal {
        require(_royalty.account != address(0x0), "Recipient should be present");
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2 {
    ...
    function getRaribleV2Royalties(uint256 id) override external view returns (LibPart.Part[] memory) {
        // Return royalties info for token id
        // return royalties[id];

        // Return global royalties info
        LibPart.Part[] memory _royalties = new LibPart.Part[](1);
        _royalties[0].value = royaltyForAll.value;
        _royalties[0].account = royaltyForAll.account;
        return _royalties;
    }
...
contract UkrainianMark is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    function setRoyaltiesForAll(address payable _royaltiesRecipientAddress, uint96 _percentageBasisPoints) public onlyOwner {
        ...
        _saveRoyaltyForAll(_royaltyForAll);
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
        ...
        // Return global royalties info
        return (royaltyForAll.account, (_salePrice * royaltyForAll.value) / 10000);
    }
