    ...
    ERC2981PerTokenRoyalties
{
    ...
    uint256 public maxMintForTx = 2;
    uint256 public maxMintsForAddress = 2;
  ...
  */
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "ERROR: You cant mint that many bulls"
        );
        ...
        require(
            ...
            "ERROR: Not enough bulls left to mint!"
        );
        ...
        if (!live) {
            if (preSaleAddresses[msg.sender]) {
                require(
                    ...
                    "ERROR: Need More Avax for the PRESALE"
                );
