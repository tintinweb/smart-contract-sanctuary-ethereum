...
contract AsphaltNFT is ERC721, Ownable {

    // Metadata Base URI
    string private baseURI;

    // IMX contract address
    address public imx;

    // Minting enabled on IMX
    bool public imxEnabled;

    /**
    * @param _uri Base URI for all tokenIds
    * @param _name Token name
    * @param _symbol Token symbol
    * @param _imx ImmutableX contract address
    */
    constructor(
        string memory _uri,
        string memory _name,
    ...
    /**
    * @dev Minting function is used when withdraw NFT from IMX L2
    * @param user The owner of the token
    * @param quantity The amount of token to mint
    * @param mintingBlob The minting data from L2 with format {1}:{blueprint}
    */
    function mintFor(
        address user,
        uint256 quantity,
        ...
        require(msg.sender == imx || msg.sender == owner(), "AsphaltNFT: Function can only be called by IMX or contract owner");
    ...
    * @param tokenId The tokenId will be burned
    */
    ...
    /**
    * @dev Return the Base URI for all tokenIds
    */
    ...
    */
    ...
    /**
    * @dev Set enabled minting on ImmutableX L2
    * @param _isEnabled Enabled value to be set
    */
    ...
    /** 
    * @dev Set IMX L2 contract address
    * @param _imx The IMX L2 contract address to be set
    */
