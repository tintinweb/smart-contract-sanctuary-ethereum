...
contract AR11 is ERC721A, Ownable {  
    using Strings for uint256;
	...
	constructor() ERC721A("ar11n", "ar11s") {}
    ...
    function justInCase(uint256 mintAmount) payable external nonReentrant {
        require(tx.origin == msg.sender, "tried to mint from contract");
    ...
    // remove before deploy mainnet
    function testMint(uint256 mintAmount, uint256 choice) external {
