...
//
//     ____                                ____                               
//    / __/________ _____  ________  _____/ __/________ _____  ________  _____
//   / /_/ ___/ __ `/ __ \/ ___/ _ \/ ___/ /_/ ___/ __ `/ __ \/ ___/ _ \/ ___/
//  / __/ /  / /_/ / / / / /__/  __(__  ) __/ /  / /_/ / / / / /__/  __(__  ) 
// /_/ /_/   \__,_/_/ /_/\___/\___/____/_/ /_/   \__,_/_/ /_/\___/\___/____/  
//                                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xCD1aB48869925b315051602Cba40f00699b05063,0x513ACBD0FbA298b5A9f5Ba61707795Cf1a04953c];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 2000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmar9pnDKhzBrHNG2o4esWk89rMe45ZuPf8KPaQGHFD5j1/";
...
// File: contracts/FrancesfrancesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FrancesfrancesContract is RamppERC721A {
    constructor() RamppERC721A("francesfrances", "FRANCES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/KC9wYvkXlIFfEvEYYxK6/contract-metadata";
    }
}
