...
contract HellDog is ERC721, Ownable {
    ...
    // TODO: nonce 
    function Whitelist(address _allowedWallet, uint _amount, bool _isFree, bytes memory _signature) public payable {
        ...
        require(balanceOf(msg.sender) <= maxPerAddress, "Attempted to mint too many tokens");
