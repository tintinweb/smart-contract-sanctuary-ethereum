...
contract MasksOfMan is ERC721Tradable, ERC2981ContractWideRoyalties {
    ...
    function setPayableAddress(address payable newPayableAddress) onlyOwner external {
        _setRoyalties(newPayableAddress, 500);
        payableAddress = newPayableAddress;
    }

    function mint() external payable {
        require(msg.value == mintCost, "Flawed Value");
        _tokenIds.increment();
    ...
    {
        if (!revealed) {
            return "ipfs://QmSv8djhee5MWmiXYUDQ3GamHVpe5bnbxPKtLBv3Sjzjpw";
        } else {
