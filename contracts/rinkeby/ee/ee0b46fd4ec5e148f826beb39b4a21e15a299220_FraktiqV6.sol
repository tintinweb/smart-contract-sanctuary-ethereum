    ...
    ERC1155SupplyUpgradeable
{
    ...
    uint256 public eachAddressMaximumAllowedMints;
    ...
    function initialize3(IERC20 _payment_token) public reinitializer(3) {
        payment_token = _payment_token;
    }

    function initialize4() public reinitializer(4) {
        amount_collected = 0;
        totalMintsPerAddress[0x933Fb2676FF19128C82e9cFb9F80aD83FF04c2D7] = 1;
        totalMintsPerAddress[0x7953A5D6893c711a6c522986B2Ed3761C71445A4] = 2;
        totalMintsPerAddress[0xCCF501a30E0d78A5227A8cD4dE43E786198cE6Bb] = 100;
        isPublicSaleActive = false;
        eachAddressMaximumAllowedMints = 10;
    }
    ...
    function setEachAddressMaximumAllowedMints(
        uint256 _eachAddressMaximumAllowedMints
    ) public onlyOwner {
        require(
            eachAddressMaximumAllowedMints != _eachAddressMaximumAllowedMints,
            "NEW_STATE_IDENTICAL_TO_OLD_STATE"
        );
        eachAddressMaximumAllowedMints = _eachAddressMaximumAllowedMints;
    }
    ...
    function mint(
        ...
        require(
            totalMintsPerAddress[msg.sender] + amount <= maximumAllowedMints,
            "MINT_TOO_LARGE"
        );
        require(
        ...
        totalMintsPerAddress[msg.sender] += amount;
        amount_collected += (price * amount);

        _mint(msg.sender, id, amount, data);
    }

    function publicMint(uint256 amount, bytes memory data)
        external
        whenNotPaused
    {
        ...
        require(
            totalMintsPerAddress[msg.sender] + amount <=
                eachAddressMaximumAllowedMints,
            "MINT_TOO_LARGE"
        );
    ...
    function mintToAddress(
        ...
        totalMintsPerAddress[toAddress] += amount;
        amount_collected = amount_collected + (price * amount);

        _mint(toAddress, id, amount, data);
    }
}
