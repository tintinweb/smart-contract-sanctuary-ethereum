...
contract LinkedCollectorsPass is ERC721A, Ownable, Pausable {
    ...
    constructor(
        ...
        address signer,
        uint256 maxSupply
    ) ERC721A("LinkedCollectorsPass", "LINKCP") {
    ...
    function tokensPrice(address collector) public view returns (TokensPrice memory) {
        ...
        if (price.minQuantity == 0) {
            return TokensPrice(tokenPrice, 1);
        }
        return price;
    }
    ...
    /**
     * Add Tokens Price
     * @dev add price details for a specific address ahead of minting
     * @param collector the address of the collector
    ...
    function withdraw() public onlySafe {
        ...
        payable(SAFE_ADDRESS).transfer(address(this).balance);
    }
