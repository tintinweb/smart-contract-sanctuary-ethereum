...
contract SimpleStaking is SeraphProtected {
    ...
    function setTimestamp(uint256 _timePeriodInSeconds) public onlyOwner timestampNotSet  withSeraph {
        timestampSet = true;
    ...
    function transferAccidentallyLockedTokens(IERC20 token, uint256 amount) public onlyOwner noReentrant withSeraph {
