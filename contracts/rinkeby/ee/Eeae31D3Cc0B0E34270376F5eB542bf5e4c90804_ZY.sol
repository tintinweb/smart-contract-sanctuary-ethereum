...
contract ZY is ERC721A, Ownable {
    uint public constant MAX_PER_WALLET_FREE = 3;
    uint public constant MAX_PER_TX = 10;
    uint public MAX_SUPPLY = 5000;
    uint public price = 0.002 ether;
    string public baseURI;
    string public constant baseExtension = ".json";
    string public notRevealedUri = "ipfs://QmbCZN6RStd1UdBcirht5E9xBchmxZ9aWTce9dMfjhUvSn";
    ...
    function goMint(uint256 _amount) external payable {
        ...
        require(_live, "Sale is Not live!");
