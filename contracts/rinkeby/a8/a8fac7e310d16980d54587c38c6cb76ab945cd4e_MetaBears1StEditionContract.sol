...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa750a0E058f838ec0Bf79418728dF351fC3A9ea3];
...
// File: contracts/MetaBears1StEditionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MetaBears1StEditionContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Meta Bears 1st Edition";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Uwfu6tz36PTSnZnxBzds/contract-metadata";
    }
