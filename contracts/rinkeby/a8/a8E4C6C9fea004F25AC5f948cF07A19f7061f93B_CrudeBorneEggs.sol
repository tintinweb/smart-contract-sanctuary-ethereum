...
contract CrudeBorneEggs is ERC721, Ownable {
    ...
    uint256 private maxOwnerAllowedMints;
    ...
    constructor(
        ...
        maxOwnerAllowedMints = _maxOwnerAllowedMints;
    ...
    function preMint() public onlyOwner {
        ...
        require(totalSupply() + maxOwnerAllowedMints*10 <= maxPossibleSupply, "m");
//        _safeMint(address(0), to, amount);
        for (uint i = 0; i < 10; i++) {
            _safeMint(true, address(0), msg.sender, maxOwnerAllowedMints);
        }
    }
