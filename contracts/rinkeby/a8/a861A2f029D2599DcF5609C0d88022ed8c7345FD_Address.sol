...
contract GalacticSnakeSociety is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Galactic Snake Society", "GSS") {
    setHiddenMetadataUri("ipfs:///QmTyoGvtybTm9yewzXPHM5mPzVNCeNRjnfG3co4RAxRLGc/Hidden.json");
  }
