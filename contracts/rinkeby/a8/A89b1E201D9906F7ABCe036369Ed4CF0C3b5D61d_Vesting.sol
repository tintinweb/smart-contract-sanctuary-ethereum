...
contract Vesting {
    ...
    function setMultiSigAdminAddress(address payable _multiSigAdmin)
        external
        onlyOwner
    {
        ...
        returns (uint256 _amountVested)
    {
        ...
        uint256 vestingPeriod = 300 days;
        ...
        if (
            ...
            vestedPercent =
                10 +
                (block.timestamp - firstVestingPoint).mul(90).div(
                    vestingPeriod
                );
