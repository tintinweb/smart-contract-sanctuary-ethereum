...
contract Marketplace is OwnableUpgradeable {
    ...
    function changeMarketplaceBeneficiaryFee(
        uint256 _marketplaceBeneficiaryFee
    ) external onlyOwner {
        require(_marketplaceBeneficiaryFee < 10000, "MP: Wrong amount");
        marketplaceBeneficiaryFee = _marketplaceBeneficiaryFee;
    }
    ...
    function transferWithFees(
        ...
        transfer(position.owner, position.currency, price);
