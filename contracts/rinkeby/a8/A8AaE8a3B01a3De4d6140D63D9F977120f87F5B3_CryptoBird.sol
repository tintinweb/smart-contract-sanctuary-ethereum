...
contract CryptoBird is ERC721Enumerable {
    ...
    mapping(address => uint) countByAddress;
    uint MAX_SUPPLY = 11;
    ...
    function mint() public payable {
        require(_msgValue() == .01 ether, 'Mint amount is 0.01 eth');
        require(totalSupply() < MAX_SUPPLY, 'MAX_SUPPLY reached');
        require(countByAddress[_msgSender()] == 0, 'Only 1 mint allowed per wallet');
        _safeMint(_msgSender(), 1);
        countByAddress[_msgSender()] += 1;
    }
...
import "./interfaces/IERC721Metada.sol";
...
contract ERC721 is Context, IERC721, IERC721Metadata, ERC165 {
    ...
    * @dev See {IERC165-supportsInterface}.
    ...
    function _safeMint(
        ...
        _mint(to, quantity);
        require(
            _checkOnERC721Received(address(0), to, _currentIndex, ""),
