...
contract TheIndians is ERC721A, Ownable {
  ...
  function whitelistMint(uint256 _nonce, bytes32[] memory _merkleProof, uint256 quantity) external payable {
