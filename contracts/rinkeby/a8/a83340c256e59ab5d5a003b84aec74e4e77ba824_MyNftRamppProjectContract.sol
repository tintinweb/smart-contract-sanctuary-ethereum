  ...
  IERC721Enumerable
{
  ...
  function getNextTokenId() public view returns (uint256) {
      return SafeMath.add(currentIndex, 1);
  }
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x12CD5fFa020D5Ecd0DE45342535f0660F7D67dfB];
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/f1r0zTTjKLMBOqBE4zDJ/contract-metadata";
    }
}