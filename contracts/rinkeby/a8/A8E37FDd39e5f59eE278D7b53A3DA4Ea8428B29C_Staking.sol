...
// rewardmath = 1000 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  // this is a function created to recieve funding from owner of the contract
  
  function GoFundMe(uint _amount) public payable onlyOwner {

  }

  function Getpayment(address payable _to, uint256 _amount) external payable {
