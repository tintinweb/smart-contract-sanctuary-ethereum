...
contract ERC1155Lockable is ReentrancyGuard, ERC1155 {
     ...
     * acceptance magic value.
     */
    function mint(address to, uint256 amount, NftType N_type, bytes calldata uri, bytes calldata key) external virtual payable nonReentrant {
        _mint(to, id, amount, "");
        _tokenUri[id] = uri;
        _Nft_type[id] = N_type;
        keys[to] = key;
