...
contract NFTImpact2022 is ERC721, ERC2981ContractWideRoyalties, Ownable, RoyaltiesV2Impl {
    /*                                                                                                                                    
              @@@@@@@                                                                                                                                 
           @@@@@@@@@@@@@                                                                                                                              
         @@@@@@@@@@@@@@@@@                                                                                                                            
 ...
 @@@@@@@@    @@@@@@@@                     @@@@       @@@@@@@@@@    @@@@%@@@@@@@@@@@@# @@@@    @@@@  @@@@   @@@@@@@@ @@@@@@@@@@@@ @@@@@    @@@@    @@@@
  @@@@@@@@    @@@@@@@    @@@@@@@          @@@@@     @@@@@ @@@@@    @@@@ @@@@          @@@@    @@@@  @@@@@      @@@@ @@@@         @@@@@    @@@@    @@@@
    ...
    NFT Impact 2022 is a smart contract handcrafted by OpenGem, the standard for secure NFTs.
    ...
    */
    ...
    string public constant ARTIST_WALLET = "BOOYASAN.eth";
    ...
    function mint(bytes32[] calldata merkle) public {
        ...
        _setRaribleRoyalties(tokenIdCounter.current(), payable(royaltyWallet), ROYALTY_PERCENTAGE);
