...
contract Erc721SalesforceV1 is Erc721Basic {
    ...
    */
    function addPayoutSplitter(address payable payoutSplitter_, uint96 totalRoyalty_) public onlyRole(DEPLOYER_ROLE) {
    ...
    */
    function toggleSaleState() external onlyRole(DEPLOYER_ROLE) {
    ...
    */
    function revealSale(string memory baseURI_) external onlyRole(DEPLOYER_ROLE) {
    ...
    */
    function reserveTokens(uint256 tokenCount_) external onlyRole(MINTER_ROLE) {
