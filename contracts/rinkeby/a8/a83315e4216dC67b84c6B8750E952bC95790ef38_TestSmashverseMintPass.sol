...
import "../SmashverseMintPass.sol";

contract TestSmashverseMintPass is SmashverseMintPass {
    constructor(
        string memory name_,
    ...
    ) SmashverseMintPass(name_, symbol_, sourceChainId_, collectorContractAddress_, lzEndpoint_, transferDeadline_) {}
