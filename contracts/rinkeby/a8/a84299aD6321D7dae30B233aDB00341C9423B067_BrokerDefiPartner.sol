...
contract BrokerDefiPartner is ERC721, Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => uint256) public totalEscrowPeriod;
    ...
    */
    ...
    function showEscrowPeriod(uint tokenId) public view returns(uint) {
        return escrowPeriod[tokenId] + totalEscrowPeriod[tokenId];
    }
    ...
    function deEscrow(uint tokenId) public {
        ...
        require(ERC721._exists(tokenId), "escrowing non existent token");
        require(ERC721.ownerOf(tokenId) == msg.sender, "Not your token");
        totalEscrowPeriod[tokenId] += escrowPeriod[tokenId];
    ...
    function transferFrom(
        ...
        require(escrowPeriod[tokenId] == 0, "BrokerDefi: transfer while escrow not allowed");
