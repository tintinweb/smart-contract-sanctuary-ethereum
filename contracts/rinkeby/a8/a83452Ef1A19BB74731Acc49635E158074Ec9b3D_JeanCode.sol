    ...
    ReentrancyGuard
{
    ...
    uint64 public constant RAFFLE_SUPPLY = 3;
    uint64 public constant WHITELIST_SUPPLY = 3;
    uint64 public constant GIFT_SUPPLY = 3;
    ...
    address[] private team_ = [
        ...
        0xb848A5aC740a6C76C102B161a88e847d88a69e91,
...
contract PaymentSplitter is Context {
   ...
   */
  function changePayeeShare(address account, uint256 shares_) public {
    require(msg.sender == owner);
    require(_shares[account] != 0, "PaymentSplitter: account have no shares");
