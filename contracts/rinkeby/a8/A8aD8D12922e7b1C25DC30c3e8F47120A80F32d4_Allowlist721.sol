 ...
 * sale.
 */
contract Allowlist721 is MintpassValidator, ERC721A, ERC2981, Ownable {
    ...
    bool public seasonActive = false;
    ...
    constructor(string memory name, string memory symbol) ERC721A(name, symbol) {
        _setDefaultRoyalty(msg.sender, 2000);
         priceFeed = AggregatorV3Interface(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e); // RINKEBY ETH/USD
         COMISSIONER_WALLET = 0xb07Ac792939FA6bcc22287Ae23a6F0b0a21D70B1;
    }
    ...
    function allowlistMint(
        ...
        require(
            ...
            "Allowlist721: Allowlist Minting is not Enabled"
        );
        require(
            balanceOf(mintpass.wallet) <= allowlistMintLimitPerWallet,
            "Allowlist721: Allowlist Limit is 4 Tokens per Wallet"
        );
        ...
        //     "Allowlist721: Maximum Allowlist per Wallet reached"
        // );
     ...
     */
    function convertFiatToEth(int256 fiatPrice) internal view returns (uint256) {
        (
            /*uint80 roundID*/,
            int256 price,
            /*uint startedAt*/,
        ...
        return uint256((fiatPrice * 1000000000 / price * 1000000000) * (1 wei));
    }
     ...
     *
     * @param _seasonActive true/false
     */
    function setSeasonActive(
        bool _seasonActive
    ) public virtual onlyOwnerOrComissioner {
        seasonActive = _seasonActive;
    }
     ...
     */
    function setComissionerWallet(
        address _commissionerWallet
    ) public virtual onlyOwner {
    ...
    */
    function _beforeTokenTransfers(
        ...
        require(
            inSeasonTransferPermit[_tokenId] || !seasonActive,
            "Allowlist721: Transfers are not allowed during Season"
        );
        require(
    ...
    */
    function _afterTokenTransfers(
        ...
        inSeasonTransferPermit[_tokenId] = false;
    }
    ...
    modifier onlyOwnerOrComissioner() {
        require(owner() == _msgSender() || COMISSIONER_WALLET == _msgSender(), "Allowlist721: caller is not the owner or comissioner");
        _;
    }
...
abstract contract MintpassValidator is EIP712 {
    constructor() EIP712("The 5th Dimension", "1") {}
