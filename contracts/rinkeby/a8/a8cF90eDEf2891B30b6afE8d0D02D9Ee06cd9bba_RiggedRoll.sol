...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) onlyOwner public {
        ...
        require(address(this).balance >= _amount, "Amount should be greater than balance");
        (bool success, ) = payable(_addr).call{value: _amount}("");
        require(success, "was not able to withdraw");
    }
    ...
    // This will allow us to fund the RiggedRoll contract from the faucet which is required for our contract to call the rollTheDice() function.
    receive() external payable { }
