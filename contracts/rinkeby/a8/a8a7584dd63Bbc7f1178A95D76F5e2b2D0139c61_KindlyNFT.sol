...
contract KindlyNFT is Ownable, ERC721 {
  ...
  function updateKindlyOnHold(address previousHolder, address newHolder, uint256 newBalance) public  { // TODO: add modifier ownable only kindly erc20 contract
    // if previous holder is address 0 then the tokens have been minted
    //uint256 previousHolderBalance = mappingAddressDeeds[previousHolder].kindlyTokensOnHold;
    //uint256 newHolderBalance = mappingAddressDeeds[newHolder].kindlyTokensOnHold;
  ...
  function getDeedsFromHolder(address _holder) public view returns (uint256, uint256, address){
    return (mappingAddressDeeds[_holder].kindlyTokensOnHold, mappingAddressDeeds[_holder].id, mappingAddressDeeds[_holder].holder);
  }
  ...
  function createNFT() public {
    ...
    mappingAddressDeeds[msg.sender] = Deeds(kindlyOnWallet, newId, msg.sender);
