...
contract Crucible is  MinterRole, ERC20Snapshot, ERC20Votes , ERC20Capped, ERC20Burnable,Ownable,Pausable,ERC20FlashMint {
    ...
    constructor(string  memory name, string memory symbol) public ERC20(name,symbol) ERC20Capped(caps) ERC20Permit(name) {
    }
     ...
     function _mint(address account, uint256 amount) internal virtual override(ERC20, ERC20Votes,ERC20Capped) {
