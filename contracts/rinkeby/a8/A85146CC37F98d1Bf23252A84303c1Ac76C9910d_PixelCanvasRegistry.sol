...
contract PixelCanvasRegistry is IPixelCanvasRegistry, Ownable {
    ...
    function deployRegistry() override public view returns (IDeployRegistry) {
        return _privateDeployRegistry;
    }
    ...
    function _requireValidPixel(address pixelContract, bool allowsZero) private view {
        bool hasPixel = deployRegistry().has(PixelCanvasApplicationType.PIXEL, pixelContract);
