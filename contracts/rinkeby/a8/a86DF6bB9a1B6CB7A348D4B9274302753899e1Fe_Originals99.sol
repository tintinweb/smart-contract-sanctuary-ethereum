...
contract Originals99 is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    uint256 private constant DURATION = 15 hours;
    ...
    address private constant ROYALTIES_RECEIVER = 0x3AE81647d41704FA6c2ce3e8Ce70de4f76a7F675;

    // withdrawal accounts
    address private constant FUNDS_RECEIVER_50 = 0xC0afEC07c5E0851CaD1c8a30640ea20d6a174ca6; // DAO wallet
    ...
    function setBaseURI(string memory baseURI_) public onlyOwner {
        require(bytes(baseURI_).length > 0, "Base URI is mandatory");
    ...
    function finalizeAuction(string memory tokenURI_) external onlyActiveAuction onlyOwner {
        ...
        tokenURIs[auctionedTokenId] = tokenURI_;
        currentPrice = 0;
        auctionedTokenId = 0;
