...
/* 
    _____  ___    ______   ___      ___     ______    
    (\"   \|"  \  /" _  "\ |"  \    /"  |   /    " \   
    |.\\   \    |(: ( \___) \   \  //   |  // ____  \  
    |: \.   \\  | \/ \      /\\  \/.    | /  /    ) :) 
    |.  \    \. | //  \ _  |: \.        |(: (____/ //  
    |    \    \ |(:   _) \ |.  \    /:  | \        /   
    \___|\____\) \_______)|___|\__/|___|  \"_____/    
                                                   
    NingenCrypto Monsters All Rights Reserved 2022
...
contract NingenCryptoMonsters is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint16 public collectionSize = 2022;
    uint256 public whitelistSaleTokenPrice = 0.005 ether;
    uint256 public publicSaleTokenPrice = 0.008 ether;
    
    uint8 constant public MAX_TOKENS_WHITELIST_SALE = 255;
    uint8 constant public MAX_TOKENS_PUBLIC_SALE = 255;

    uint32 public whitelistSaleStartTime = 1653242400;
    uint32 public publicSaleStartTime = 1653249600;

    address private _creatorPayoutAddress = 0x4E98bd082406e99A0405EdAAD0744CB2A1c4EeBA;

    bytes8 private _hashSalt = 0x563c624e7d352224;
    address private _signerAddress = 0x037D3e8Db886Af91Afd18ecC5676fca29b493ABA;
    ...
    constructor() ERC721A("NingenCrypto Monsters", "NCMO") {}
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmamyFu3BA9FoDLpp88GQA4p1mgzWDJ8DoTFePSikLBkHc";
    }
    ...
    string private _baseTokenURI = "ipfs://QmYRsUDDThEg438JkPB8ffLVTe1NBVuXWtPKdnvbcxTQo5/";
