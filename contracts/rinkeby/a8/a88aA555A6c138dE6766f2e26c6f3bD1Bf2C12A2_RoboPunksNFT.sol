...
contract RoboPunksNFT is ERC721, Ownable {
  ...
  constructor() payable ERC721('RoboPunksCM', 'RPCM') {
    mintPrice = 0.02 ether;
    maxSupply = 5;
    baseUri = 'ipfs://QmXbcMo91MJ4qYD3FUQNqE5oVxw8gmLQ2iGjCBTaExaMoq/';
    _crossmintAddress = 0xdAb1a1854214684acE522439684a145E62505233;

    // start the token counter at 1 (begins with 0 index)
  ...
  function mint() public payable isCorrectPayment isAvailable {
  ...
  function crossmint(address _to) public payable isCorrectPayment isAvailable {
    require(
