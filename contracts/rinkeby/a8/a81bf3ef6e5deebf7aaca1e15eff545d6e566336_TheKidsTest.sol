...
contract TheKidsTest is ERC721A, Ownable {
  ...
  constructor() ERC721A("TheKidsTest", "KIDS") {
    setHiddenMetadataUri("ipfs://QmWzFwjnbFzkFkur9ZaS3BCzNqg4skkzAF3N5gEmoU9z3c/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    (bool JNR, ) = payable(0x105eACA612cbbC3f06440CFF55b6cf96C346b2e7).call{value: address(this).balance * 12 / 100}("");
    require(JNR); // KID JNR
    (bool CYRUS, ) = payable(0x953B47Da0C39f09dED52A6a20B87ad8e25cA8047).call{value: address(this).balance * 12 / 100}("");
    require(CYRUS); // KID CYRUS
    (bool CHILL, ) = payable(0x0E10C63d269fF168211F92a2a7295cA4a605CeFc).call{value: address(this).balance * 12 / 100}("");
    require(CHILL); // KID CHILL
    (bool CACHE, ) = payable(0xd553570446565E7cf98a0a7eAccD4A5828cd1D52).call{value: address(this).balance * 12 / 100}("");
    require(CACHE); // KID CACHE
    (bool CHUBB, ) = payable(0x957d54114FDCD8826938ad174D5347ADFD52684B).call{value: address(this).balance * 1 / 100}("");
    require(CHUBB); // JNR CHUBB
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory)
  {
    ...
    if (revealed == false) {
      return hiddenMetadataUri; // if hidden show hidden metadata
    }
