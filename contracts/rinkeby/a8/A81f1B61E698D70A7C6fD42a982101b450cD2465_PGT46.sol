...
contract PGT46 is ERC721AB, Ownable {
    ...
    constructor(string memory baseURI) ERC721AB("PlaygroundTestV46", "PlaygroundTestV46") {
...
contract ERC721AB is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return _tokenMetadata[tokenId].toString();
