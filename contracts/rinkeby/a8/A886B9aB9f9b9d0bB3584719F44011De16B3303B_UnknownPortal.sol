...
contract UnknownPortal is AbstractERC1155Factory {
    ...
    */
    ...
    function renounceAddWhitelist(bool _canAddWhitelist) external onlyOwner {
        canAddWhitelist = _canAddWhitelist;
    }

    function renounceChangeMetadata(bool _canChangeMetadata) external onlyOwner {
        canChangeMetadata = _canChangeMetadata;
    }
    ...
    */
    function mint(uint256 amount) external payable whenNotPaused {
        ...
        require(amount == MAX_CLAIMABLE_AMOUNT, "Mint: Should mint only one.");
        require(totalSupply(0) + amount <= MAX_SUPPLY, "Mint: Max supply reached");
        require(msg.value == amount * mintPrice, "Mint: Incorrect payment");
