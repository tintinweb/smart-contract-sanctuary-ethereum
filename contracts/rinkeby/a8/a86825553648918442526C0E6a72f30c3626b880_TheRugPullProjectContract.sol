...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1654718400;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAbccf90c35CBC7D0478B24B7c0171C934A803B6b];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qme1BQecS2QaNfXicwAinYJT6Y5e7MdAdav5GTaLVWku2J/";
...
// File: contracts/TheRugPullProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheRugPullProjectContract is RamppERC721A {
    constructor() RamppERC721A("The Rug Pull Project", "RP"){}
}
