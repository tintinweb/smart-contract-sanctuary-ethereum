...
contract NineFT is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmaXHgGoh5nHLtMeJaLiGknBiwd9ThYJMNfwm1iDKMCRSt/";
...
function setIsPresale(bool _state) public onlyOwner {
  ...
  function isWhiteListed(address _userAddress)public view returns(bool my) {
  ...
  function setMaxSupply(uint256 _newTotalSupply) public onlyOwner {
