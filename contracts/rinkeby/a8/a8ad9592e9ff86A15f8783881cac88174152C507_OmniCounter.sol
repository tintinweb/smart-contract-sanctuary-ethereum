...
contract OmniCounter is Ownable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function estimateFees(uint16 _dstChainId, address _ContractAddress) external view returns (uint nativeFee, uint zroFee){
        return endpoint.estimateFees(_dstChainId, _ContractAddress,  bytes(""), false, bytes(""));
    }
