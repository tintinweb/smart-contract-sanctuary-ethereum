...
contract CryptoRambo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xBEFab98Ae067779b629c5253B5603e9ee382046D); 
    ...
    uint256 public totalFees = BUSDRewardsFee.add(liquidityFee).add(marketingFee).add(developmentFee);
    ...
    constructor() public ERC20("CryptoRambo", "CRT") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "CryptoRambo: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CryptoRambo: Account is already the value of 'excluded'");
    ...
    function setBUSDRewardsFee(uint256 value) external onlyOwner{
        ...
        totalFees = BUSDRewardsFee.add(liquidityFee).add(marketingFee).add(developmentFee);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "CryptoRambo: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "CryptoRambo: Automated market maker pair is already set to that value");
