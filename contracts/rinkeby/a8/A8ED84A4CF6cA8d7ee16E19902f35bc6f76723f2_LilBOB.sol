...
contract LilBOB is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFT = 10; //This is full collection should be 1111
    uint256 public constant MAX_NFT_WL = 4;
    uint256 public MAX_NFT_VIP = 2; // This is for VIP should be 68
    uint256 public constant MAX_NFT_GIVEAWAY = 3; // This is for giveaways should be 143
    ...
    function mintNFTTokens(uint256 _count) public payable {
        ...
        require(
            _tokenId.current() + _count <= MAX_NFT - MAX_NFT_GIVEAWAY,
    ...
    function random(uint256 timestamp, uint256 tokenId) public view returns (uint256) {
        ...
        uint256 newTokenId = (uint256(keccak256(abi.encodePacked(timestamp))) + tokenId) % (MAX_NFT - MAX_NFT_VIP);
