...
contract TechnoFeudal is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_RESERVE_TOKENS = 150;
    uint256 public constant MAX_TOKENS_PER_WALLET = 11; 
    
    uint256 public constant ROYALTY_PERCENTAGE = 5;
    // ================================================

    constructor(address _royaltyReceiverAddress)
        ERC721("Techno-Feudal Citizens-v3", "TFCv3")
    {
