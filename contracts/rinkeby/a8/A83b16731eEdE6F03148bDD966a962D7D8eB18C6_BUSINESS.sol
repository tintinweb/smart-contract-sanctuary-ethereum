...
contract BUSINESS is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    uint currentTokenId;
    ...
    constructor() ERC721("FARMS", "NFM") {
        propertyPrice[0] = 0.01 ether;
        propertyPrice[1] = 0.02 ether;
        propertyPrice[2] = 0.03 ether;
        propertyPrice[3] = 0.04 ether;
        propertyNumber["TIER 1"] = 0;
        propertyNumber["TIER 2"] = 1;
        propertyNumber["TIER 3"] = 2;
        propertyNumber["TIER 4"] = 3;
        propertyCount = 4;
        MAX_SUPPLY = 5000;
        MAX_PER_WALLET = 5;
    }
    ...
    function updatePrice(uint _tier1, uint _tier2, uint _tier3,uint _tier4) public onlyOwner {
        propertyPrice[0] = _tier1;
        propertyPrice[1] = _tier2;
        propertyPrice[2] = _tier3;
        propertyPrice[3] = _tier4;
    }
