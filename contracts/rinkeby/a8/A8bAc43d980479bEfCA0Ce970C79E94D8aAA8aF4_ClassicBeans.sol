...
contract ClassicBeans is ERC721A, Ownable {
    ...
    string public hiddenURI = "ipfs://QmVqWN5v7JimuToJngyWskH15RxFeoLdHXVHLRshvvHbfJ";

    // Returns the hidden URI instead of the unrevealed URI if set to false
    bool public revealed = false;

    constructor() ERC721A("Classic Beans", "CLASSIC_BEANS") {
        //mintAll();
    }

    function mintAll() internal {
        // Iterate over all characters and mint them all
