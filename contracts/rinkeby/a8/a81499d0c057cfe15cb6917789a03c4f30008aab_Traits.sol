...
library Traits {
    ...
    function getTokenURI(Inventory.FallenInventory memory _inventory, uint256 soulScore, uint256 tokenId) external pure returns (string memory) {
        ...
        parts[3] = '<text x="10" y="27.25" class="e1">Class</text>';
        ...
        parts[35] = '<text x="95" y="27" class="c';
        parts[36] = class;
        parts[37] = '">';
        parts[38] = race;
        ...
        if(soulScore < 10){ parts[119] = '</text><text x="285" y="334.25" class="c1">'; }
        else if(soulScore < 25){ parts[119] = '</text><text x="285" y="334.25" class="c2">'; }
        else if(soulScore < 50){ parts[119] = '</text><text x="285" y="334.25" class="c3">'; }
        else if(soulScore < 100){ parts[119] = '</text><text x="285" y="334.25" class="c4">'; }
        else if(soulScore < 200){ parts[119] = '</text><text x="285" y="334.25" class="c5">'; }
        else if(soulScore < 500){ parts[119] = '</text><text x="285" y="334.25" class="c6">'; }
        else{ parts[119] = '</text><text x="285" y="334.25" class="c7">'; }
