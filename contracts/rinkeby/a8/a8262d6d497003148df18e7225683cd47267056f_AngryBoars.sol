...
contract AngryBoars is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(address _metabitsContractAddress,string memory _BaseURI) ERC721A("Angry Boars","BOARS"){
        ...
        onlyOwner
    {
        ...
        for (uint256 i = 0; i < _reserveAmount; i++) {
            ...
            metabits.updateTimeForMetaKidz(supply + i);
            }
    ...
    function mintBoar(uint numberOfTokens) public payable {
        ...
        for (uint i = 0; i < numberOfTokens; i++) {
            if(metabitsContractAddress != 0x000000000000000000000000000000000000dEaD){
            metabits.updateTimeForMetaKidz(totalSupply());
            }
    ...
    function setBaseURI(string memory baseURI_) external onlyOwner {
      ...
      function transferFrom(address from, address to, uint256 tokenId) public override nonReentrant  {
        if(metabitsContractAddress != 0x000000000000000000000000000000000000dEaD){
        metabits.updateTimeForMetaKidz(tokenId);
        }
