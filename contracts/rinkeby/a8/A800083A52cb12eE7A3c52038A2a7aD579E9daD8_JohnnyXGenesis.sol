    ...
    ERC2981ContractWideRoyalties
{
    ...
    constructor(string memory baseURI)
        ERC721("JohnnyX NFT Collection", "NFTC")
    {
        setBaseURI(baseURI);
    }
    ...
    function reserveNFTs() public onlyOwner {
        require(
            _tokenIds.current().add(10) <= MAX_SUPPLY,
    ...
    function mintNFTs(uint256 _count) public payable {
        require(
            _tokenIds.current().add(_count) <= MAX_SUPPLY,
    ...
    /// @return returns a uint256 array of tokenIdentifiers
