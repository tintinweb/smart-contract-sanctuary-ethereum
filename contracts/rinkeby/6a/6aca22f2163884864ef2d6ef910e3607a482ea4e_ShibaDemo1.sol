...
contract ShibaDemo1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shy Demo";
    string private constant _symbol = "SDEMO";
    ...
    function getBotWalletStatus(address botwallet)
        external
        view
        returns (bool)
    {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liquHalf = contractTokenBalance.sub(convertQuota).sub(
            burnQuota
        );
