...
contract V2Token is Context, IERC20, Ownable {
    ...
    string private _name = "Staking test coin";
    string private _symbol = "MDXSTK";
    ...
    function emergencyPauseTrades()external onlyOwner() {
        canTrade = false;
    }
