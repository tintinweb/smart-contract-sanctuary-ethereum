...
contract CryptoTest is ERC2981, ERC721AQueryable, Ownable {
    ...
    constructor(uint256 _maxSupply, uint256 _freeSupply, uint256 _teamSupply, uint256 _walletLimit, uint256 _price) ERC721A("cryptotest", "CRYPTO") {
    ...
    function mint(uint256 amount) external payable {
        console.log("teamMint:", msg.sender);
        ...
        if (
            publicMinted <= freeSupply && amount + publicMinted > freeSupply
        ) {
