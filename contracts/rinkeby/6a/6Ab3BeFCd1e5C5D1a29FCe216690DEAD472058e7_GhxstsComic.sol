...
contract GhxstsComic is ERC721Enumerable, Ownable, ReentrancyGuard, ERC721Burnable {
   ...
   */
  function togglePublicSale(uint256 _id) external chapterExists(_id) onlyOwner {
    Chapter memory chapter = getChapter(_id);
    require(!chapter.frozen, "Chapter frozen.");
  ...
  function allowListMint(
    ...
    discountMinted[msg.sender] = discountMinted[msg.sender] + discountAmount;
