...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x22DE8d35cCEfB98875EeB33999179E96F87A3276];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZ1eWRLjRABWNKbUMqCkFFmjBB7qREQvWPCsXaQkwhRZJ/";
...
// File: contracts/IamfutureContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IamfutureContract is RamppERC721A {
    constructor() RamppERC721A("I AM FUTURE ", "IAF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/fL23GzX61eyDOGtskHaW/contract-metadata";
    }
}
