...
contract Bonuses is AragonApp {
    ...
    */
    ...
    /// Events
    event BonusesDistributionAdded(uint256 bonusesDistributionId, uint256 totalBonusesForClaim); /// Emitted when a new reward is created
    ...
    ) public auth(ADD_BONUSES_ROLE) returns (uint256 bonusesDistributionId)
    {
        ...
        emit BonusesDistributionAdded(bonusesDistributionId, _totalBonusesForClaim);
    }
