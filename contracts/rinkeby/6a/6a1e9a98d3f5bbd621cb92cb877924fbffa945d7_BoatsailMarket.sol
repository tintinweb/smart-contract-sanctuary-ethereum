...
contract BoatsailMarket is Ownable, ERC721Holder {
	...
	function initialize(address _adminAddress) external onlyOwner {
		adminAddress = _adminAddress;
        createCollection("Boatsail", "https://ipfs.io/ipfs/QmRxreUQ3uxJAxdK8DyabzFxjSZgx8eFCtEBA3dem3227J", true);		
	}   
    ...
    function buy(uint256 _id) external payable {
		...
		if (pairs[_id].tokenAdr == address(0x0)) { //BNB
			...
			governanceToken.transferFrom(msg.sender, adminAddress, totalAmount.mul(feeAdmin).div(PERCENTS_DIVIDER));			
