        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                bytes(
                    "<svg viewBox='0 0 500 400'><style>.mytext {font: bold 20px sans-serif;} </style><filter id='blurMe'><feGaussianBlur stdDeviation='1'/></filter><image width='500' href='https://ipfs.io/ipfs/QmbXUiGUuXEf3h1hoRy6MzVmQgXyJwCzLaDJLXs8NmVfBB'/><text class='mytext' x='270' y='170' transform='skewX(-50)' filter='url(#blurMe)'>"
                ),
                bytes(toString(currentBTC)),
                bytes(
                    "<animate attributeName='x' values='270;275;270' dur='1s' repeatCount='indefinite'/></text></svg>"
                ),
                bytes('", "attributes": []}')
            )
        );
