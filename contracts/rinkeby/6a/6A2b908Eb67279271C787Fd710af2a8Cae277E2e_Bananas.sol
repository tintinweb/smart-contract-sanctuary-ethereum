...
contract Bananas is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;

    string public baseTokenURI;
    uint256 public mintPrice = 0.03 ether;
    uint256 public collectionSize = 1100;
    ...
    // ===== Constructor =====
    constructor() ERC721A("Bananas Bananas Bananas", "BBB") {}
    ...
    function mint() external payable onlySender nonReentrant {
    ...
    function withdrawAll() external onlyOwner nonReentrant {
        ...
        (bool dm,) = payable(0x4405def8038a339a82d05E8Da94D0F5DB4Bc99CB).call{value : balance * 15 / 100}("");
        require(dm, "You need to send at least 15% of your balance to the contract");
        (bool jp,) = payable(0xD506a18050A684bC55Ea4F4C1D577166c7D29df0).call{value : balance * 15 / 100}("");
        require(jp, "You need to send at least 15% of your balance to the contract");
        (bool j,) = payable(0xBa87221B6af5D7AE77B6af3B5E7046Ad795Dc1dc).call{value : balance * 20 / 100}("");
        require(j, "You need to send at least 20% of your balance to the contract");
        (bool z,) = payable(0x4af26427aDB27ed0ab0f6DdB6CB890786e01E044).call{value : balance * 20 / 100}("");
        require(z, "You need to send at least 20% of your balance to the contract");
        (bool d,) = payable(0xb0f05364352f05b16306f526EeF4728b47956aAf).call{value : balance * 20 / 100}("");
        require(d, "You need to send at least 20% of your balance to the contract");
    ...
    function walletOfOwner(address address_) public virtual view returns (uint256[] memory) {
        ...
        for (uint256 i = 0; i < _loopThrough; i++) {
            ...
            if (_exists) {
                if (ownerOf(i) == address_) {_tokens[_index] = i;
                    _index++;}
            }
