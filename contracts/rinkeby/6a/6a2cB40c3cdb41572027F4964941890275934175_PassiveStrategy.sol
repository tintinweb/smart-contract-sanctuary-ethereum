...
contract PassiveStrategy is IStrategy {
    ...
    UpbotVault public immutable vault;
    ...
    constructor(
        ...
        IUniswapV3Pool _pool = UpbotVault(_vault).pool();
        int24 _tickSpacing = _pool.tickSpacing();

        vault = UpbotVault(_vault);
        pool = _pool;
