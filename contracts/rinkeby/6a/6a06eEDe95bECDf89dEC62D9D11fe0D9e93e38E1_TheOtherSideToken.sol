...
contract TheOtherSideToken is ERC20, ERC20Burnable, Delegated {

    bytes32 private merkleRoot;
    constructor() ERC20("The Other Side Token V4", "MOONZV4") {
    ...
    function burn(address to, uint256 amount) external onlyDelegates {
        _burn(to, amount);
    }
    ...
    function whitelistMint(uint256 qty, bytes32[] calldata _merkleProof) public {
