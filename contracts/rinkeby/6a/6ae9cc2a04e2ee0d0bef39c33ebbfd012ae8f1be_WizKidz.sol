...
contract WizKidz is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 6666;
	uint256 public PRESALE_NFT = 2000;
	uint256 public GIVEAWAY_NFT = 222;
	
	uint256 public MAX_MINT_PRESALE = 2000;
	uint256 public MAX_MINT_SALE = 6666;
	...
	uint256 public SALE_PRICE = 85 * 10**15;
    ...
    constructor() ERC721P('Wiz Kidz', 'Wiz Kidz') {}
