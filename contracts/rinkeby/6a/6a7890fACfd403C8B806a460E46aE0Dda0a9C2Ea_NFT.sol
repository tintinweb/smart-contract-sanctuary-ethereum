...
contract NFT is ERC721, Ownable, ERC2981 {
  ...
  uint256 public constant maxGoldSupply = 25; //377
  uint256 public constant maxSupply = 50; //10000
  uint256 public constant maxMintAmountPerTx = 5;
  uint256 public constant maxClaim = 25; //1000
  ...
  bytes32 public merkleRoot = 0x135fbf10252d2a0b705325bd3434f51bccc9d816a0e9e8b6afcdc2c0027945f0;

  // Changable variables
  string public uriPrefix = "https://ipfs.io/ipfs/QmToHpH9rec7NVktCRq7enXYDYzgNpKvM6u7DCfh2NztzR/"; //BaseURI
  uint256 public leftOverGoldSupply = maxGoldSupply;
  uint256 public cost = 0.0099 ether; //0.0099
  bool public paused = true;
  uint256 public currentClaim = 0;

  address private w1 = 0xB2f354eEA06D56A491C7cfa8Ed7964f4D37EaF68;
  address private r1 = 0xB2f354eEA06D56A491C7cfa8Ed7964f4D37EaF68;

  constructor() 
    ERC721("Test991199", "Tp") { 
      setDefaultRoyalty(r1, 1000); //10%
    }
