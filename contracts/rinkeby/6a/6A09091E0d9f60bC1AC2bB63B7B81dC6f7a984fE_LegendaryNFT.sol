...
contract LegendaryNFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    ...
    maxBatchSize = 5;
    collectionSize = amountForDevs = amountForSaleAndDev = 777;
    saleConfig.publicPriceWei = 69 ether / 1000;  // 0.069 ETH
    require(
