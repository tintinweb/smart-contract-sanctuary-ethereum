...
contract PVerse is ERC721, Ownable {
  ...
  constructor() ERC721("PVerse", "PVE") {
    ...
    buildings.push(Building("Gouse",1,1,2,7,0,-7));
    ...
    buildings.push(Building("Thrrry",2,6,1,-10,0,4));
    ...
    buildings.push(Building("Jeff",3,2,2,-3,0,-2));
   }
