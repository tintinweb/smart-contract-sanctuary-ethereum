...
contract dragotest2 is ERC721A, Ownable {
    ...
    string public uriPrefix = "ipfs://QmWhje31eEUVTVAoKTiQ343Why48ZB9VXcXNwBMoSn9GqG/";
    ...
    constructor() ERC721A("dragotest.wtf", "DTW") {
        publicSaleOpen = false;
        freeSaleOpen = false;
    }

    function setUriPrefix(string memory _uriPrefix) public onlyOwner {  //new
