...
contract VeeFriendsV2Sales is Ownable, ReentrancyGuard {
    string private baseUri;

    constructor() {}

    function submitOrder(uint256 orderId) public payable {
    ...
    event OrderSubmitted(uint256 indexed orderId, address buyer, uint256 price);
}
