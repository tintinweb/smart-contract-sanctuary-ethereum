...
//*********************************************************************//
//
//      _____ _______ _____ _____ _  __ _____ 
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x99591630af104d220785B06e3f35CB32aDEba6cA];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://bafybeifax46uhp2pmyp2fwjesoekxavmhjpmq3cecfkyrerbyu2sdajwhq/";
...
// File: contracts/SticksEverydayEverywhereContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SticksEverydayEverywhereContract is RamppERC721A {
    constructor() RamppERC721A("Sticks Everyday Everywhere", "SEE"){}
}
