...
contract TradeCoinERC721 is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, RoleControl {
    ...
    event productPending(address indexed creator, uint indexed tokenId);
    ...
    function addTransformation(
        ...
        emit transformation(_msgSender(), _tokenId, stringToBytes32(_docHash), _docType, _rootHash, newWeight, _transformationCode);
    }
    ...
    function updateRootHash(uint _tokenId, string memory _docHash, string memory _rootHash) public onlyInformationHandlerOrAdmin {
        ...
        emit rootHashUpdate(_tokenId, stringToBytes32(_docHash), stringToBytes32(_rootHash));
    }
