...
contract TopWolves is ERC721, Ownable {
    using Strings for uint256;
    ...
    address public constant creatorAddress= 0x7f1fdc50B39D28C1D0C1574892D46dbA4e06A381;
    ...
    bool public eight_hour_restrict = true;

    string public baseUri;
    string public baseExtension = ".json";

    constructor(string memory _baseuri) ERC721("Top Wolves", "TWN") {
    ...
    function presaleAftp(uint256 num) public payable returns (bool) {
        ...
        if(eight_hour_restrict) {
            require((balanceOf(msg.sender) == 0 && num == 1), "Presale limit is 1 during 8 hours.");
        }
    ...
    function set_eight_hour_restrict() public onlyOwner {
        eight_hour_restrict = !eight_hour_restrict;
    }
