...
contract Pawned is ERC721A, Ownable {
    ...
    uint256 public OGSupply = 500;
    uint256 public bonusSupply = 2000;
    ...
    bool public isPublicBonusOpen = false;
    bool public isOGBonusOpen = true;
    bool public isWhitelistOpen = true;
    bool public isGAOpen = false;
    bool public isOGOpen = false;

    constructor() ERC721A("PAWNED", "PAWNED") {}
