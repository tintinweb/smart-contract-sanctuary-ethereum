...
contract OddBots is Ownable, ERC721 {
   ...
   function buy(uint _count) public payable{
        ...
        require(_count <= maxPerTransaction, "max per transaction 8");
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 30 / 100); 
