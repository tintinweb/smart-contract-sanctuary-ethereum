...
contract Token is ERC20 {
    ...
    function sellTokens(uint256 amountToSell) public {
        ...
        require(address(this).balance >= amountOfEthToTransfer, "not enough Eth in Vendors Account");
        bool sent = this.transferFrom(msg.sender, address(this), amountToSell);
        require(sent, "Failed to send TCoin to contract");
