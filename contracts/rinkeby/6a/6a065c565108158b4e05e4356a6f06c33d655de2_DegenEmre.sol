...
contract DegenEmre is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Degen Emre", "DGM") {
    setHiddenMetadataUri("ipfs://QmTT5SyPjztuwxGtR4NtHi82MbcZQ9dFKTBL1xnGyENHoJ/unreveal.json");
  }
