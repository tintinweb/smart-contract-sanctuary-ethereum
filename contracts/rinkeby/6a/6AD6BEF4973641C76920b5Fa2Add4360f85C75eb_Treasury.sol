...
import "contracts/MugenERC20.sol";
...
contract Treasury {
    modifier onlyOwner() {
        require(owner == msg.sender, "Not Treasury Owner");
        _;
    }
    ...
    function deposit(
        ...
        require(contains(_token) == true, "Not a depositable token");
        IERC20(_token).safeTransferFrom(msg.sender, address(this), _amount);
        _mint.mint(msg.sender, _amount);
    }
    ...
    function contains(IERC20 _token) public view returns (bool) {
