...
contract WeL01 is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("WeL01", "WeL01", mintLimit, _totalSupply) {
     tokenCount = 0;
  }
  ...
  function withdrawRevenueShare() external onlyOwner {
    ...
    address creator = payable(0x951fee0E018E51cB0Ca84680833700F27965bB46); 
    address engineer = payable(0xB386B60a03bCc525eaA8BFD4c9ad2D028C65fca1); 
    address partner = payable(0x35e9474a710962c7f4B4D93C26fDB2C188C978ff); 
