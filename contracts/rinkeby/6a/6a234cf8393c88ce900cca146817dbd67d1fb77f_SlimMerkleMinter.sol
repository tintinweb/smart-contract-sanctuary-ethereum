...
contract SlimMerkleMinter is Ownable{
    ...
    * @param _bonusNFTMultipliers multipliers of bonus NFTs (length must match IDs) 100% is 10^18
    ...
    function setHasPurchased(address _who, bool _to) external onlyAdmin{
    ...
    */
    ...
    /*function setMaxReferrals(uint _new) external onlyAdmin{
        maxReferrals = _new;
    }*/
    ...
    /*function addToReferrerWhitelist(address[] memory _list) external onlyAdmin{
    ...
    function removeFromeReferrerWhitelist(address[] memory _list) external onlyAdmin{
        for(uint i = 0; i < _list.length; i++){
    ...
    * @param _new is the new address
    ...
    /*
    function changeIncrease(uint256 _new) external onlyAdmin{
        priceIncrease = _new;
    }*/
