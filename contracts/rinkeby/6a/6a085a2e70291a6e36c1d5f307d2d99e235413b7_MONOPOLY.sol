...
contract MONOPOLY is ERC20, Ownable {
    ...
    constructor() ERC20("Monpoly", "MONOPOLY") {
        ...
        maxTransactionAmount = 38400000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 38400000 * 1e18; // 1% from total supply maxWallet
		...
		charityWallet = address(0x78FB1937D5604d128cE3A0F9fAC41e49D1E93de3); // set as charity wallet
        marketingWallet = address(0xd34F9a240930faedC6b80F2bE21627e1D437C28f); // set as marketing wallet
        devWallet = address(0x78FB1937D5604d128cE3A0F9fAC41e49D1E93de3); // set as dev wallet
