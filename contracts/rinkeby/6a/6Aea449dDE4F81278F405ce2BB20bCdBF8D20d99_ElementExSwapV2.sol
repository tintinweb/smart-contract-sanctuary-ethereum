...
abstract contract Aggregator is IAggregator, ReentrancyGuard, FixinTokenSpender {
    ...
    address private constant ELEMENT = 0x8D6022B8A421B08E9E4cEf45E46f1c83C85d402F;

    uint256 private constant WETH_MARKET_ID = 999;
    address private constant WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab;

    // markets.slot == 0
    // markets.data.slot == keccak256(markets.slot) == 0xbc36789e7a1e281436464229828f817d6612f7b477d66591ff96a9e064bcc98a
    uint256 private constant MARKETS_DATA_SLOT = 0xbc36789e7a1e281436464229828f817d6612f7b477d66591ff96a9e064bcc98a;
