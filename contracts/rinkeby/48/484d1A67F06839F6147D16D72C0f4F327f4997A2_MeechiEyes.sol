...
contract MeechiEyes is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 constant maxPerWallet = 5;
    ...
    *@dev function to set MerkleRoot
    ...
    function tokenURI(uint256 _tokenID) public view override returns (string memory) {
        ...
        return bytes(_tokenURI).length > 0 ? string( abi.encodePacked(baseURI, "/", _tokenID.toString(), ".", baseURI_EXT) ) : "";
    }
 ...
 *@dev Withdrawal Functions
  */
    ...
    modifier maxMeechiesPerWallet(uint256 numberOfTokens) {
        require(numberOfTokens <= maxPerWallet,"Max of 4 tokens per Wallet");
        require(
            walletMints[msg.sender] + numberOfTokens <= maxPerWallet,
