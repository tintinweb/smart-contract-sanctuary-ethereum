...
contract SVGNFT is ERC721URIStorage {
    ...
    function svgToImageURI(string memory _svg) public pure returns (string memory) {
        // Every token have a base url before the encode data of the svg
        string memory baseURL = "data:image/svg+xml;base64,";
        // And this is the encode for the svg image
        string memory svgBase64Encoded = Base64.encode(bytes(string(abi.encodePacked(_svg))));
        // Finally we concatenate the encoded svg with the base url and again encode them 
        ...
        return string(
            ...
            Base64.encode(
                bytes(abi.encodePacked(
                    '{"name": "Jake the dog", ',
                    '"description": "Cartoon Network Character!", ',
                    '"attributes": "", ',
                    '"image": "', _imageURI, '"}'
                )
                )   
