...
contract SecretVerseNFTDistributor is AccessControl {
    ...
    uint256 public tokenPrice = uint256(1 * 10**15); // = 0.001 ETH
    ...
    // events
    event whiteListed(address[] whiteList);
    event blackListed(address user, bool flag);
