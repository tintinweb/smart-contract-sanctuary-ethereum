...
contract Deca is VRFConsumerBaseV2, Pausable, Ownable {
    ...
    function withdrawBankroll(uint256 _amount) external {
        address userAddress = msg.sender;
        require(
            userBankRollBalance[userAddress].depositAmount >= _amount,
            "exceed amount"
    ...
    function withdrawHouse(uint256 _amount) public {
        // lock 처리해야함
        address userAddress = msg.sender;
    ...
    function claimTreasury(uint256 _amount) external onlyTreasury {
    ...
    function claimTreasuryAll() external onlyTreasury {
        bool flag;
