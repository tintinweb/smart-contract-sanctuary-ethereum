...
contract VQ2 is ERC721, Ownable {
    // Token mint values
    uint256 public constant MAX_QUESTIONS = 10000;
    ...
    function publicMint(uint256 amount) external payable {
        uint256 currentId = _tokenSupply;
        require(msg.sender == tx.origin, "VQ2: Only EOAs");
        require(_publicMintStatus == true, "VQ2: Minting closed");
        ...
        internal
    {
        ...
        unchecked {
            ...
            offsetWithin256 = ticketNumbers[0] % 256;
        }
