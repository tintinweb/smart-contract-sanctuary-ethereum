...
contract Hacktivists is ERC721A, Ownable{
    ...
    uint256 public constant MAX_TEAM_MINT = 1;
    uint256 public constant PUBLIC_SALE_PRICE = .002 ether;
    uint256 public constant WHITELIST_SALE_PRICE = .001 ether;
    uint256 public constant TEAM_SALE_PRICE = 0 ether;
    uint256 public constant MAX_TEAM_TOTAL_SUPPLY = 3;

    //Whitelist
    uint256 public curTeamTotalSupply = 0;
    uint256 public maxWhiteListTotalSupply = 5;
    ...
    constructor() ERC721A("Hacktivists", "Hack"){
        baseTokenUri = "https://ipfs.io/ipfs/QmVHGMb19L6kFagP8SFJ8Fh1EvZ2LHhLKiXSoYymj6nr4T/0.json";
        merkleRoot = 0x5433638c11c2b778e05fbcb94ff0f9d1f98453a9cdd802f8e0e98aef026e71dc;
    }
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "NFTs are sold out!");
        require((totalWhitelistMint[msg.sender] + _quantity) <= MAX_WHITELIST_MINT, "Only 1 mint per whitelist allowed!");
        require(msg.value >= (WHITELIST_SALE_PRICE * _quantity), "You need to spend more ETH!");
        require(curWhitelistTotalSupply + _quantity <= maxWhiteListTotalSupply, "All whitelist NFTs are sold out!");
        //Check Merkle Proof
    ...
    function teamMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require((totalTeamMint[msg.sender] + _quantity)  <= MAX_TEAM_MINT , "Only 1 mint per team member allowed!");
