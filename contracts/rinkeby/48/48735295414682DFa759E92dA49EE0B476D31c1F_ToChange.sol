...
contract ToChange is ERC721A, Ownable {
    ...
    string public baseURI =
        "ipfs://QmW4uut1QLtq1htV1hY9KgyT4UgCqHvZfde6Jcwp4JfttZ/";

    constructor() ERC721A("ToChange", "ToChange") {}

    function numberMinted(address owner) public view returns (uint256) {
        return _numberMinted(owner);
    }

    function ownerMint(uint256 amount) external payable {
        require( 
            msg.sender == 0xf3717e3B1Fb855531C2f43762f6a750b99ee074b ||
                msg.sender == 0x2F627bcf4b610C0E754Cc7903F6E665fD038a7D7 ||
                msg.sender == 0xC3B2fBDD93cbE0aD6d8db03d6438C8D89EC986E8,
            "not owner"
        );
    ...
    function mint(uint256 amount) external payable {
        ...
        if (numberMinted(msg.sender) < MaxFreePerWallet) {
            count = numberMinted(msg.sender) + amount - MaxFreePerWallet;
        }
        if (count < 0) {
            count = 0;
        }
