...
// File: contracts/SampleERC721.sol
    ...
    contract Chocolate is Ownable, ERC721A {
    ...
    constructor() ERC721A("Chocolate", "CHOCO!") {_safeMint(msg.sender, 1); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/fefefefef");}
