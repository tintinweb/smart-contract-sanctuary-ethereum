...
contract TrackTheMythPassSale is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(TrackTheMythPass _token, bytes32[] memory merkleRoots, address newOwner) {
     ...
     */
    function mint(bytes32[] memory proof) public payable whenNotPaused nonReentrant {
    ...
    */
    ...
    function _mint(address receiver, PHASE memory _currentPhase) internal  whenNotPaused{
