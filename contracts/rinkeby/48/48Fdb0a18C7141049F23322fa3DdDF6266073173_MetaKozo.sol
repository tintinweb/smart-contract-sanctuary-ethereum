...
contract MetaKozo is ERC721A, Pausable {
    ...
    address public team = 0x2253C0DAaEf01465fC0EC67CF8FCb72b77650b27;

    // Collection sale information
    uint16 constant COLLECTION_SIZE = 1500;
    ...
    function ownerMint(uint256 _quantity) public callerIsUser onlyOwner {
        require((totalSupply() + _quantity) <= COLLECTION_SIZE, "Mint amount over");
    ...
    function commonSaleValidation(uint256 _quantity, uint256 _cost) private view {
        // require(!pause, "Sale is currently suspended");
        _requireNotPaused();
