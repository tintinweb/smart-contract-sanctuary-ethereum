...
contract YuaVerse is ERC721Y, Ownable {
    ...
    uint256 public YUA_PRICE = 0;

    string public baseURI;
    bytes32 public merkleRoot;
    
    bool public giftState = false;
    ...
    function mintFree(uint256 allowance, bytes32[] calldata proof) external {
        ...
        require(!isMintedForFree[msg.sender], "You already minted your allowance!");

        for(uint i; i < allowance; i++) { 
            _mint(_msgSender(), totalSupply + i);
        }
        isMintedForFree[msg.sender] = true;
    }
    ...
    function teamReserve() public onlyOwner {
        ...
        uint256 totalSupply = _owners.length;
        require(totalSupply + RESERVE < YUA_SUPPLY, "Damn!");
