...
contract ERC1155Factory is OwnableUpgradeable {
  ...
  function initialize(address _handlerAddress) public initializer {
    ...
    erc1155Implementation = address(new ERC1155Upgradable());
    ERC1155Upgradable(erc1155Implementation).initialize();
  }
  ...
  function createClone(address _newOwner) public onlyOwner returns (address clone){
    ...
    ERC1155Upgradable(_clone).initialize(); // owned by this contract
    ERC1155Upgradable(_clone).registerContract(handlerAddress, 3); // register handler on erc1155
    ERC1155Upgradable(_clone).transferOwnership(_newOwner); // transfer to newOwner
...
import "./SafeMath.sol";
import "./IERC1155Upgradable.sol";
import "./IHandlerCallback.sol";
import "./IsSerializedUpgradable.sol";


contract ERC1155Upgradable is ERC165Upgradable, IERC1155Upgradable, IERC1155MetadataURI, IsSerializedUpgradable {
 ...
 */
interface IERC1155Upgradable is IERC165 {
    /**
 ...
 */
abstract contract ERC165Upgradable is IERC165 {
    /*
    ...
    // }
    function intializeERC165() internal {
        _registerInterface(_INTERFACE_ID_ERC165);
    }
    /**
