...
contract BEE is Ownable, ERC721A, ReentrancyGuard {
    ...
    string private baseURI = "https://dabunny.mypinata.cloud/ipfs/QmQouL4k87QAEfKSGKyVH5Qn4ZgcUMajTaoSHKZn5UQ2so";
    ...
    function adoptBunny(uint256 _quantity) public payable {
