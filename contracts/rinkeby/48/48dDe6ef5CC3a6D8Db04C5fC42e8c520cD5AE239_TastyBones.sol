...
contract TastyBones is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(
        ...
        ERC721A("Tasty Bones", "TASTYBONES", 50, 5050)  {
    ...
    function mintFreeWithBone(
        ...
        require(totalSupply() + 1 <= maxFreeMintSupply, "EXCEEDS_FREE_MINT_SUPPLY" );
    ...
    function mintFreeWL(
        ...
        require(totalSupply() + numberOfTokens <= maxFreeMintSupply, "EXCEEDS_FREE_MINT_SUPPLY" );
    ...
    function mintPresale(uint256 numberOfTokens, bytes32[] calldata proof) external payable isSecured(2) {
        ...
        require(mintedTBforPresale[msg.sender] + numberOfTokens <= maxMintPerAccount, "EXCEEDS_MAX_PRESALE_MINT" );
        require(totalSupply() + numberOfTokens <= maxPresaleSupply, "EXCEEDS_MAX_SUPPLY" );
    ...
    function mintRaffle(bytes32[] calldata proof) external payable isSecured(3) {
        ...
        require(mintedTBforFreeMintAddress[msg.sender] < 1, "NOT_ALLOWED_TO_MINT" );
        require(mintedTBforPresale[msg.sender] < 1, "NOT_ALLOWED_TO_MINT" );
