...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xA6c1f4f4340564fea489990d2c99Bf0508305D45];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 2222;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmbWzsyY4gRoeQCPFXeT3V6vRJjr9uun3QWaEe53tvD4io/";
...
// File: contracts/PxSTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PxSTestContract is RamppERC721A {
    constructor() RamppERC721A("PxS Test", "PxS"){}
}
