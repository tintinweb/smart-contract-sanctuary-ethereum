...
abstract contract ERC721EnumerableUpgradeableOptimized is Initializable, ERC721UpgradeableOptimized, IERC721EnumerableUpgradeable {
    ...
    //uint256[] private _allTokens; //<- NOT NEEDED AFTER OPTIMIZATIONS

    // Mapping from token id to position in the allTokens array
    //mapping(uint256 => uint256) private _allTokensIndex; // <- ALSO NOT NEEDED AFTER OPTIIMIZATIONS
     ...
     * - @dev -- Omitted BeforeTransfer as _allTokens is not needed
     ...
     * @dev Omitted as allTokens is not needed
     * 
    ...
    //     _allTokensIndex[tokenId] = _owner.length;
     ...
     * @dev Omitted as _Before_transfer doesn't need to be explictly checked
     **/
     ...
     * @dev ommited as no need to update _all tokens
     **/
...
contract ERC721UpgradeableOptimized is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    //BECOMES
    //side note; array is fixed length, so we can fix later
