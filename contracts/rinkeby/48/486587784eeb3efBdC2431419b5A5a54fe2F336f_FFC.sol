...
contract FFC is Ownable, ERC721A {
    ...
    uint16 public devAmount = 100; // Need to update
    uint16 public presaleAmount = 8645; // Need to update
    ...
    modifier isPriceValid(uint16 numToMint) {
        ...
        require(numberMinted(msg.sender) < 1, "Has minted before"); // cant have minted before
        _;
    }
