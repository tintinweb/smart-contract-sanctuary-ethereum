...
contract testContract0001 is ERC721, Ownable, ERC2981, ReentrancyGuard {
    ...
    function setRoyalty(address primaryReceiver, uint96 primaryFee) public onlyOwner {
        RoyaltyReceiver = primaryReceiver;
        RoyaltyFee = primaryFee;
