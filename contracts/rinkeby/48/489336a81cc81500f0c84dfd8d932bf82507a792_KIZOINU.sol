...
contract KIZOINU is Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        if (automatedMarketMakerPairs[from] && not_excluded) {
        ...
        if (automatedMarketMakerPairs[to] && not_excluded) {
        ...
        bool should_swap_and_liquify = overMinTokenBalance && !inSwapAndLiquify 
            && automatedMarketMakerPairs[to] && swapAndLiquifyEnabled;
        ...
        if (not_excluded) {
            ...
            bool selling_early = automatedMarketMakerPairs[to] && span <= 24 hours;
            ...
            bool buying_first_24_hrs = automatedMarketMakerPairs[from] && (block.timestamp - creation_time) <= 24 hours;
