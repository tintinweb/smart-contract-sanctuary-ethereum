...
contract LiqBootstrap is Ownable, ReentrancyGuard, IClaimable {
    ...
    event UpdateCredit(address indexed account, uint256 lastShareIndex);
    ...
    function deposit() external payable nonReentrant {
        ...
        recipients[msg.sender].shares = newShares;
        uint256 _totalShares = totalShares + (newShares - prevShares);
        totalShares = _totalShares;

        emit EditRecipient(msg.sender, newShares, _totalShares);
    ...
    function _updateCredit(address account) internal returns (uint256 credit) {
        ...
        emit UpdateCredit(account, _shareIndex);
    }
