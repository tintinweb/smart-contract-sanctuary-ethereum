...
// File: https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol
...
// File: contracts/StableCoinStaking.sol
...
contract StableCoinStaking is Ownable, ReentrancyGuard {
    ...
    IERC20 public stakedStableCoin;
    ...
    function initializeStaking(
        IERC20 _rewardERC20Token,
        IERC20 _stakedStableCoin,
    ...
    function depositInPool (uint _amount) external {
        ...
        IERC20(stakedStableCoin).transferFrom(msg.sender, address(this), _amount);
    ...
    function withdrawFromPool(uint _amount) external {
        ...
        IERC20(stakedStableCoin).transferFrom(address(this), msg.sender, _amount);
    ...
    function _updateUserInfo() internal {
        ...
        if (pendingReward > 0) {
            IERC20(rewardERC20Token).transferFrom(address(this), msg.sender, pendingReward);
