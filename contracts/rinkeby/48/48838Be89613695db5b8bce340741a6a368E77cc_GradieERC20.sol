...
contract GradieERC20 is Ownable, ERC20 {
    ...
    constructor() ERC20("Gradie Token", "$GG") {
        parentNFT = IERC721(0xd9145CCE52D386f254917e481eB44e9943F39138); // Change it to your NFT contract addr
    }
    ...
    function onERC721Received(
        ...
        return
            bytes4(
                keccak256(
                    "onERC721Received(address,address,uint256,uint256,bytes)"
                )
            );
    }
}
