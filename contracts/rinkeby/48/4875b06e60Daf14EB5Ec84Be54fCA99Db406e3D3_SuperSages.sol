...
contract SuperSages is ERC721A, Ownable {
    ...
    constructor(bool isPaying, uint256 deploymentPrice) ERC721A("Super Sages", "ss") payable {
        if(isPaying){
    ...
    /**
     * @dev use this to mint free NFTs to specified address
     */
