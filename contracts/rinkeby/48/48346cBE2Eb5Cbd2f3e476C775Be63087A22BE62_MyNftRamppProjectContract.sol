...
//
//                                       
//  _      ______ _____ __________  ____ 
// | | /| / / __ `/ __ `/ ___/ __ \/ __ \
// | |/ |/ / /_/ / /_/ / /  / /_/ / /_/ /
// |__/|__/\__,_/\__, /_/   \____/\____/ 
//              /____/                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd0f45944a2c2d86B86DBcF29dddaa90669a5f887];
...
// File: contracts/MyNftRamppProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MyNftRamppProjectContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My NFT Rampp Project";
    string public symbol = "RAMPP";
