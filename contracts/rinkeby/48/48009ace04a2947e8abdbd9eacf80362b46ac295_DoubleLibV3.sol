...
/** 
 *  SourceUnit: /Users/wangjiahui/wwj_workspace/double-hardhat/contracts/lib/DoubleLibV1.sol
*/
...
contract DoubleLibV3 is Initializable{

    function initialize() public initializer {
    
    }

    function getSingleNftOwner(address nftAddr, uint256 nftId) public view returns (address owner){
        owner = address(0);
    ...
    function getNftsOwner(address nftAddr, uint256[] memory nftIds)
        public
        view
    ...
    {   
        ...
        for(uint i=0;i<nftIds.length;i++){
             owners[i] = getSingleNftOwner(nftAddr, nftIds[i]);
        }
        return owners;
    ...
    // function addAFunction() public pure returns(bool) {
    //     return true;
