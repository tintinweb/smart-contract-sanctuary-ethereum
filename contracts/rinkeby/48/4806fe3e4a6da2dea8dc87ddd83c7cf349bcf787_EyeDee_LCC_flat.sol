...
contract EyeDee_LCC_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("EyeDee LCC", "EDL") {
    setHiddenMetadataUri("ipfs://QmYmszjUmMCmR8Dk7qFHybwEQBLQXvd167vAfY3FJq4vyv/Hidden_Metadata.json");
  }
