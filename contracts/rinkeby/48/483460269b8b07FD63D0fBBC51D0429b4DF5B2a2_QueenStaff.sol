...
contract QueenStaff is IQueenStaff, Pausable, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        _developer = _developerAddress;
        queeneDAO = _daoAddress;
     ...
     */
    function isOnImplementation() external view returns (bool) {
    ...
    /**
     * @notice Require that message sender is either owner or developer.
     */
