...
contract Crowdsale  {
    ...
    /**ShazTokenCrowdsale.test.js:20:41
...
contract MinterRole is Context {
    ...
    function addMinter(address account)  internal onlyMinter {
        _addMinter(account);
    }
 ...
 */
  contract MintedCrowdsale is Crowdsale,ERC20Mintable {
    // /**
...
abstract contract CappedCrowdsale is Crowdsale {
     ...
     */
    function _preValidatePurshase(address beneficiary, uint256 weiAmount) internal virtual  {
        super._preValidatePurchase(beneficiary, weiAmount);
...
abstract contract WhitelistCrowdsale is Crowdsale ,WhitelistedRole {
     ...
     */
    function _preValidatePurchase(address _beneficiary, uint256 _weiAmount) internal view override virtual {
        require(isWhitelisted(_beneficiary), "WhitelistCrowdsale: beneficiary doesn't have the Whitelisted role");
        super._preValidatePurchase(_beneficiary, _weiAmount);
    }
}

// File: contracts/ShazTokenCrowdsale.sol
...
pragma solidity >0.5.16 < 0.9.0;
 ...
 contract ShazTokenWhitelistCrowdsale is  Crowdsale,CappedCrowdsale,TimedCrowdsale,WhitelistCrowdsale,MintedCrowdsale{

        using SafeMath for uint256;

       

        //Minimum and Maximum contribution of investor
        uint256 public investorMinCap = 2000000000000000; // 0.002 ether
        uint256 public investorHardCap = 50000000000000000000; // 50 ether
        mapping(address => uint256) public contributions;


   //Constructor of this contract and Inherited contract for Crowdsale
   constructor (
       uint256 rate_, 
       address payable wallet_, 
       IERC20 token_,
       ...
       string memory symbol_
        ...
        MintedCrowdsale(rate_,wallet_,token_,name_,symbol_)
    ...
    function _updatePurchasingState(address _beneficiary, uint256 _weiAmount) internal override(Crowdsale) 
    {

    }
     
    function _preValidatePurchase(address beneficiary,uint256 weiAmount) internal view override(Crowdsale,TimedCrowdsale,WhitelistCrowdsale){

    }

    
    function _deliverTokens( address beneficiary, uint tokenAmount) internal  override(Crowdsale,MintedCrowdsale){
