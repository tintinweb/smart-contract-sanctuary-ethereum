...
// File: contracts/6_escrow1.sol


pragma solidity 0.8.16;


contract Peer2Pirate {
  ...
  function accept(uint _tx_id, address _buyer, IERC20 _token,  uint256 _amount) external returns (uint256) {
    token = _token;
  ...
  // current state of transaction in escrow
  ...
  // seller acknowledges fiat payment receipt.
