...
contract SteppIn is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("SteppIn", "STPN"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Be yourself, enjoy the ride.");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more sneakers");
    require(mintEnabled, "Minting is not live yet, hold on SteppIner.");
