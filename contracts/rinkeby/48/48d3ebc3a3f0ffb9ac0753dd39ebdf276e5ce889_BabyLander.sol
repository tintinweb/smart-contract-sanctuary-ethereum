...
contract BabyLander is Ownable, ERC721A {
    uint256 public MAX_FREE_MINT = 2;
    uint256 public MAX_PUBLIC_MINT = 8;
    uint256 public MAX_SUPPLY = MAX_FREE_MINT + MAX_PUBLIC_MINT;
    uint256 public mintRate = 0.038 ether;
    ...
    constructor(string memory _initBaseURI) ERC721A("BabyLander", "BL") {
    ...
    function updateFreeMint(uint256 _quantity) public {
        MAX_FREE_MINT -= _quantity;
    }

    function updatePublicMint(uint256 _quantity) public {
    ...
    function setMaxFreeQtyPerWallet(uint256 _quantity) external onlyOwner {
        maxFreeQtyPerWallet = _quantity;
    }
