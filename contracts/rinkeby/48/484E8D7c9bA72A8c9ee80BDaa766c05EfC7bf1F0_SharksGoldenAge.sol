...
contract SharksGoldenAge is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string public _contractBaseURI = "https://xxxxxxxxf/metadata/";
	string public _contractURI = "ipfs://QmPrXTqZWrUXa5DvMaLJRQL1PnuH7ahVawp2DwaZYpK3AW";
	...
	//reserving the first 20 tokens for marketing
	function adminMint20() external onlyOwner {
	...
	function changeOwnership(uint256[] memory ids, address[] memory accounts) external onlyOwner {
