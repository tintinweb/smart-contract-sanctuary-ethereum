...
// File: contracts/AnimatedAlienPunkz.sol
    ...
    contract AnimatedAlienPunkz is Ownable, ERC721A {
...
// File: contracts/StakeAlienPunkz.sol
...
contract StakeAlienPunkz is Ownable, IERC721Receiver {
  ...
  AnimatedAlienPunkz nft;
  AnimatedPunkzRewards token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(AnimatedAlienPunkz _nft, AnimatedPunkzRewards _token) { 
    nft = _nft;
    token = _token;
  }
