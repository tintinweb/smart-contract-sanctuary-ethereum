...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 1000");
    ...
    // File: contracts/sandalContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SandalContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Sandal", "SAND", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmTQzqPB4SbcMAVhH8t8poCspAmMm5LFxsRa3qaZjQZw16/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/6RRqacgi6TB38vDv8zCg/contract-metadata";
        }
    }