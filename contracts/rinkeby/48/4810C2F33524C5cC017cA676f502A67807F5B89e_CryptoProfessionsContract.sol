...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x02817EEb6cD6ce8eD4010e424C4f3a11e6c64B0C];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigbypvd3qz77encukk4njlh3qtb6xwc5zlmrzvvpoqxotlxvyhgxa/";
...
// File: contracts/CryptoProfessionsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoProfessionsContract is RamppERC721A {
    constructor() RamppERC721A("Crypto Professions", "CP"){}
}
