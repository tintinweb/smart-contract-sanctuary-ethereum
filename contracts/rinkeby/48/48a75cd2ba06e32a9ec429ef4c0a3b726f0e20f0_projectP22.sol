...
contract projectP22 is ERC1155, Ownable {
    ...
    function OpenPack(uint32 packId) external {
        ...
        uint randomNumber = getRandomNumber(maxAvailableIndex[packId] - lastSelectedIndex[packId] + 1);
        ...
        tokenContract.Mint(numOfTokensInPerPack[packId], msg.sender, tokenStartIndex, randomNumber);
