...
contract Subarashiies1 is Ownable, ERC721r, PaymentSplitter {
    ...
    uint256 private constant MAX_SUPPLY = 112;
    uint256 private constant MAX_GIFT = 12;
    uint256 private constant MAX_PRESALE_SUPPLY = 20;
    uint256 private constant MAX_SALE_SUPPLY = 80;
    uint256 private constant MAX_NFTS_PER_WALLET_ON_PRE_SALE = 10;

    uint256 public preSalePrice = 0.0007777 ether;
    uint256 public salePrice = 0.0008888 ether;

    uint256 public preSaleStartTime = 1652486400;
    uint256 public saleStartTime = 1653696000;
    uint256 public soldOutStartTime = 1656115200;
    uint256 public soldOutEndTime = 1656720000;
    ...
    ) ERC721r("SubaPreprod 1", "SP512", 1_12) PaymentSplitter(_team, _teamShares) {
        baseURI = _baseURI;
