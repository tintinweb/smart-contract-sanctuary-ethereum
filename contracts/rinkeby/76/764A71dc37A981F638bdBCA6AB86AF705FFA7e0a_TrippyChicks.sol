...
contract TrippyChicks is ERC721A("Trippy Chicks Club", "TCC"), ERC721ABurnable{
    uint256 saleActiveTime = 1648036800; 

    uint256 constant maxSupply = 10000;
    uint256 mintableSupply = 9000;
    uint256 itemPrice = 0.98 ether;
    string baseURI;
    ...
    ///////////////////////////
    // TrippyChicks Presale  //
    ///////////////////////////

    uint256 presaleActiveTime = 1647691200; 
    uint256 itemPricePresale = 0.49 ether;
    ...
    function purchaseTokensPresale(uint256 _howMany, bytes32[] calldata _proof) external payable {
        ...
        require(totalSupply() <= mintableSupply, "Try mint less");
        require(tx.origin == msg.sender, "The caller is a contract");
        require(_howMany >= 1 && _howMany <= 5, "Mint min 1, max 5");
