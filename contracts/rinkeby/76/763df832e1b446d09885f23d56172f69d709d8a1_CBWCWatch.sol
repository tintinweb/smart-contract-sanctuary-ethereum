...
contract CBWCWatch is CBWCBase {
   ...
   /// Array of unique string used to prevent signature hijacking
    ...
    function forge(
        ...
        bool success = cbwcPieces.burnPieces(cbwcPiecesTokenIds_, msg.sender);
        require(success, "CBWCW: could not burn pieces");
    ...
    function setCBWCPieces(address cbwcPieces_)
        external
    ...
    function _isValidSignature(
        ...
        bytes32 msgHash = keccak256(
            abi.encodePacked(cbwcPiecesTokenIds_, nonce_, deadline_)
        );
