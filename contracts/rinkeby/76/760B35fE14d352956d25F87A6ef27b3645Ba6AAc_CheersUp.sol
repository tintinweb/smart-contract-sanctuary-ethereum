...
contract CheersUp is ERC721, Pausable, Ownable, ReentrancyGuard, Crypto {
    ...
    constructor() ERC721("Cheers UP", "CHEERSUP") {
    }
    ...
    function setTokenHash(uint256 tokenId_, bytes32 tokenHash_) public {
        _tokenHashes[tokenId_] = tokenHash_;
    }
    function batchSetTokenHash(uint256[] calldata tokenIds_, bytes32[] calldata tokenHashes_) external {
