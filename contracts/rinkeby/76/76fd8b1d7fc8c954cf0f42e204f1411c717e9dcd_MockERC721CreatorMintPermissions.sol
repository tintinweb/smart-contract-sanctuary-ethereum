 ...
 */
abstract contract ERC721CreatorMintPermissions is
    ERC165,
    AdminControl,
...
contract MockERC721CreatorMintPermissions is
    Context,
    AccessControlEnumerable,
    ERC721CreatorMintPermissions
{
    ...
    constructor(address creator_, address admin)
        ERC721CreatorMintPermissions(creator_)
    {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC721CreatorMintPermissions)
        returns (bool)
    {
        return
            ERC721CreatorMintPermissions.supportsInterface(interfaceId) &&
            super.supportsInterface(interfaceId);
    }
}