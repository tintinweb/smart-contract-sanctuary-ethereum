...
contract NFsporT is ERC721Batch, Delegated, PaymentSplitter {
  ...
  address private _withdraw1 = 0x97EF605Ff1A1527b9239Bb009D7D1B004a5Ef384;
  address private _withdraw2 = 0x2B7952c3F442Eb8BaA069f90bF692Facb52890a9;

  address[] private _addressList = [_withdraw1, _withdraw2];
  uint[] private _shareList = [50, 50];
  ...
  function mint( uint256 quantity ) external payable {
    ...
    require( supply + quantity < _maxSupply, "Invalid Token Id" );
    require( msg.value >= _price * quantity, "ETH Sent Is Incorrect." ); //convert gWEI to WEI
  ...
  function setMaxSupply ( uint256 newMaxSupply ) public onlyOwner { 
    require(totalSupply() < newMaxSupply, "Max supply is too low.");
