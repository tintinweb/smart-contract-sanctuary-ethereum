...
contract InvincibleKids is ERC721, Ownable, PullPayment {
    ...
    constructor(string memory baseTokenURI, uint mintPrice) ERC721("InvincibleKids", "INKIDS") {
    ...
    function publicMint(uint quantity) external payable {
        ...
        require(quantity <= MAX_BATCH_SIZE, "Quantity too high.");
        _safeMint(quantity);
    }
    ...
    function _safeMint(uint quantity) private {
