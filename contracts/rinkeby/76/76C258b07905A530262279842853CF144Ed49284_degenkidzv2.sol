    ...
    ReentrancyGuard
{
    ...
    // Token Data
    uint256 public constant RESERVED_TOKENS = 555;
    uint256 public constant AIRDROP_TOKENS = 518;

    uint256 public totalReserved = 0; // Track total tokens reserved
    uint256 public totalAirdropped = 0; // Track total tokens airdropped
        ...
        onlyOwner
    {
        ...
        require(
            totalAirdropped + numberOfTokens <= AIRDROP_TOKENS,
            "This would exceed max airdrop of Tokens"
        );

        _safeMint(to, numberOfTokens);

        // update totalAirdropped
        totalAirdropped = totalAirdropped + numberOfTokens;
    }
