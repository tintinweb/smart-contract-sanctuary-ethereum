...
contract KoiosNFT is ERC721Enumerable, Ownable {
    ...
    uint256[] public _tokenIdsMinted;
    ...
    function claim(bytes32[] calldata _merkleProof, uint256 tokenID) public {
        require((totalSupply() + 1) <= _maxSupply, "Max Supply of NFTs reached!");
