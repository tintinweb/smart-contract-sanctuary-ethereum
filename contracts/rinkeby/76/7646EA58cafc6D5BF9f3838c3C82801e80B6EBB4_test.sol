...
contract test is ERC721, Ownable {
    ...
    string public baseExtension = ".json";
        ...
        constructor() ERC721("Test", "SYMBOL") {
            ...
            baseUri = "ipfs://QmVLi2sx3pL5hBcghL3MpRsRJbe2EARx2vVRVfBEYs6f5T";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _numTokens <= 10, "You can only mint 5 per wallet.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0xdc0Bc58def582d5A20372cef71F1A67Ce4e9B13D).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0xdc0Bc58def582d5A20372cef71F1A67Ce4e9B13D).call{value: balanceTwo}("");
