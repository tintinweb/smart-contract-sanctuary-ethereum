...
//set tokenURI to one of the 3 different dogs
//randomly selected
...
contract AdvanceCollectable is ERC721URIStorage,VRFConsumerBase{
    ...
    constructor(address _VRFCoordinator, address _linkToken, bytes32 _keyhash, uint _fee) public VRFConsumerBase(_VRFCoordinator,_linkToken) ERC721("doggie","dog")
       {
           tokenCounter=0;
           keyhash=_keyhash;
           fee=_fee;
