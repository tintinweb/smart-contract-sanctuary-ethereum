...
contract GREENLIGHT is ERC721URIStorage, ERC2981Base {
    uint256 public tokenCounter;
    uint256 public _completionTimestamp;
    RoyaltyInfo private _royalties;
    address public constant ownerAddress = 0x922F2985a6DFAeACCed19047D366998336617c91;

    event Mint(uint256 indexed tokenId);

    constructor() ERC721('GREENLIGHT NFT', 'greenNFT') {
    ...
    function mint() public {
        ...
        _setRoyalties(payable(ownerAddress), 100);
        emit Mint(tokenCounter);
    }
    ...
    function generateSVG() public view returns (string memory) {
        ...
        if (_completionTimestamp > block.timestamp) {
            ...
            value = 260 - ((120 * timeRemainingPercent) / 100);
        }
