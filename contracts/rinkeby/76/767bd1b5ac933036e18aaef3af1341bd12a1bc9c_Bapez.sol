...
contract Bapez is ERC721A, Ownable, Pausable 
{
    ...
    uint256 public bapezFreeWLLimit = 2 ;
    ...
    bytes32 public bapezFreeWLMerkleRoot = 0xb74db926026b33fb31a4a4566fe24589d4f92fc845b3d3db8019104d6756ad53;
    ...
    function bapezFreeMint(bytes32[] calldata _merkleProof, uint256 quantity)
        external
        payable
        ...
        callerIsUser 
    {
        ...
        require(freeMintList[msg.sender] + quantity <= (MerkleProof.verify(_merkleProof, bapezFreeWLMerkleRoot, leaf)
                ? bapezFreeWLLimit : bapezFreeLimit ), "Mint Limit Exceeded");
