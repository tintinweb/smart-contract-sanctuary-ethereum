...
contract PropertyAllowList is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ReentrancyGuard {
    ...
    constructor() ERC721("PropertyAllowList", "PAL") {}
    ...
    function safeMint() payable public {
        ...
        require(balanceOf(msg.sender) < 1, "Address already holds this token");
