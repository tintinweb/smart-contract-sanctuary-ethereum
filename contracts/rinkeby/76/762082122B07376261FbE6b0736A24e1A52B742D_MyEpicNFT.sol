...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["my:", "our:", "miss>", "mr?", "[email protected]", "crypt:"];
  string[] secondWords = ["Favorite!", "Dislike#", "Sweet$", "Heavy%", "Softly;", "Melty&"];
  string[] thirdWords = ["Rain+", "+xxx+", "*Wood*", "+++**", "--==--Noun", "Samething"];
...
event NewEpicNFTMinted(address sender, uint256 tokenId);
  ...
  //現在のmint数を返します。
  function n_minted() public view returns(uint256){
      return _tokenIds.current();
  }
  function n_mintmax() public view returns(uint8){
      return _mint_max;
  }
  ...
  function makeAnEpicNFT() public {
    ...
    //上限を決めます。
    require(newItemId < _mint_max ,"mint max over");
