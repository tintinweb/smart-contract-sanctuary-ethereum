...
/*   constructor (address _implementationContract) {
  ...
  function createSingleUserCollectionProxy(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) external returns (address) {
    ...
    SingleUserCollection(clone).__SingleUserCollection_init_unchained(name, symbol, contractURI, tokenURIPrefix, msg.sender);
    return clone;
  }
...
contract SingleUserCollection is Initializable, SingleCollection {
    ...
    function __SingleUserCollection_init_unchained(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address owner) public virtual initializer {
        // require(!initialized, "already initialized");
        // initialized = true;
        __SingleCollection_init_unchained(name, symbol, contractURI, tokenURIPrefix, owner);
    }
...
abstract contract HasSecondarySaleFees is ERC165Storage {
    ...
    function __HasSecondarySaleFees_init_unchained() external initializer {
