...
contract MagicBones7 is ERC721A, Ownable {
    ...
    string public prerevealURL = "ipfs://QmYw49Y5L6fmAe4paaiSL156aEmKUADyD2ZXFoG6ARej7j/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("MagicBones", "BONES") {}
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity<=3 , "Sorry, there are only 10 items allowed for each minting.");
