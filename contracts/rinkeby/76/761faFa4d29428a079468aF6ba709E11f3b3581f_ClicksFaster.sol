...
contract ClicksFaster is ERC721A, Ownable 
{
    ...
    string private _baseTokenURI = "ipfs://QmSdK8jvH7nEFyRWtLf63kJZv3eYyXEXDCWnqFZ72NyCPb/";
    string public notRevealedUri = "ipfs://QmehpoixFpU76gDtaoheU9omuwymbEY4uRTm3qnCkLCPP9/hidden.json";
    bytes32 root = 0x14a5fcc272140b493e9019653a01f9de0a1fecdf734e9757a548824239e6a933;
    mapping(address => uint) public addressMintedBalance;

    address payable private devgirl = payable(0xaB2cf090AbEbBbc964506E70A1660cA22e660D48); //ganache test address dev index 1

    constructor() ERC721A("Click's Faster", "CF") {}
    ...
    function withdraw() external 
    {
        ...
        uint part1 = address(this).balance / 10000 * 600;
