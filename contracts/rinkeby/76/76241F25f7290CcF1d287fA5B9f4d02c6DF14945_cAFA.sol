...
contract cAFA is ERC20Permit, IAFA {
    ...
    constructor(uint256 _initSupply) ERC20('Contributor AFA', 'cAFA', 9) ERC20Permit('Contributor AFA') {
        _mint(msg.sender, _initSupply);
        owner = msg.sender;
    }

    function setOwner(address _newOwner) external onlyOwner {
        require(_newOwner != address(0), 'null owner');
        owner = _newOwner;
    }
