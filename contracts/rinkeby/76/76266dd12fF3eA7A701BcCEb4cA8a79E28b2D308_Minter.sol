...
contract Minter is Ownable, ReentrancyGuard {
    ...
    function transferFunds(uint256 qty, bool isDicounted) private {

        uint256 priceETH = !isDicounted ? tokenPriceETH : tokenPriceETH_Discount;
        uint256 priceUSDC = !isDicounted ? tokenPriceUSDC : tokenPriceETH_Discount;
