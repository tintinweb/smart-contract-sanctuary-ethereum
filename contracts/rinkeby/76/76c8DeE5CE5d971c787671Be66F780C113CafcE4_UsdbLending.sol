...
contract UsdbLending is Ownable, LendingCore, ERC721Permit("USDBMarketplace", "USMT") {
    ...
    **/
    function createLoan(address nftAddress, uint256 nftTokenId, uint256 deadline, bytes memory signature) external {
        _permit(msg.sender, nftTokenId, deadline, signature);
        transferNFT(msg.sender, address(this), nftAddress, nftTokenId);
    }
}
...
contract LendingCore is TokenTransfer {
    ...
    event EditLoan(
        ...
        uint256 loanAmount,
        uint256 amountDue,
        uint256 installmetnAmount,
        uint256 assetValue,
        uint256 frequencyTime,
        uint256 frequencyTimeUint
    );
    ...
    struct Loan {
        ...
        uint256[2] startEndTime; // startEndTime[0] = loan start date, startEndTime[1] = loan end date
