...
contract LandAuction is ILandAuction, AccessControl, ReentrancyGuard {
    ...
    uint16 public constant N = 193;
    uint16 public constant M = 198;

    /*
        x: -95 to 97
        y: -98 to 99
        -95,-98 gets mapped to 1,1
         97, 99 gets mapped to 193,198
        transform: +96, +99
    */
    int16 public constant xLow = -95;
    int16 public constant xHigh = 97;
    ...
    int8[N + 1][M + 1] private _categoryBIT;
    ...
    function isShiboshiZone(int16 x, int16 y) public pure returns (bool) {
        bool xInRange = x >= 13 && x <= 49;
        bool yInRange = y >= -98 && y <= -64;
    ...
    ) external payable nonReentrant onlyStage(Stage.Bidding) {
        require(
    ...
    {
        return (uint16(x + 96), uint16(y + 99));
    }
