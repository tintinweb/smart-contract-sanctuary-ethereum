...
contract MacroVesting is Ownable {
    ...
    function nextClaimDate() public view returns (uint256) 
    {
        ...
        if (lastClaimed[msg.sender] == 0) {
            ...
            // Find how many quarters they have claimed so far 
            uint256 quartersClaimed = (lastClaimed[msg.sender] - userDatas[msg.sender].startDate) 
                / userDatas[msg.sender].vestingCadence;

            // Find their next 90 day claim date
            claimDate = userDatas[msg.sender].startDate + (quartersClaimed * userDatas[msg.sender].vestingCadence) 
                + userDatas[msg.sender].vestingCadence;
        }
    ...
    function _claimableTokens() private view returns (uint256) {
        ...
        /* If it hasn't been 180 days (about 6 months) 
          since their start date, they have 0 claimable coins at the current moment */
        ...
        private view returns (uint256) 
    {
        ...
        uint256 quartersPassed = time / userDatas[account].vestingCadence;
        // Every 90 days, a contributor can claim 90/1080 (1/12) of their total allocation 
