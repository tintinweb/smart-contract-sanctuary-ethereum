...
contract TechforceNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        // Ownable._owner = owner_;
    }

    function mint(uint256 qty) public onlyAuthorized {
        require((totalSupply() + qty) <= collectionSize, "Sold out!");
        _safeMint(owner(), qty);
    }

    function mintTo(address _to, uint256 qty) public onlyAuthorized {
        require((totalSupply() + qty) <= collectionSize, "Sold out!");
        _safeMint(_to, qty);
    }
        ...
        returns (bool isOperator)
    {
        ...
        // opnesea mainnet - 0xdD54D660178B28f6033a953b0E55073cFA7e3744
        // rarrible mainnet - 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE
        if (
            _operator == address(0xd47e14DD9b98411754f722B4c4074e14752Ada7C) ||
            _operator == address(0x7d47126a2600E22eab9eD6CF0e515678727779A6)
        ) {
            return true;
        }
