...
contract CoolSheep is Ownable, ERC721 {
    ...
    ERC721 AlienFrens = ERC721(0xf01558B41f87a7dCc57Aee9552BB1E9510326528);
    ERC721 CoolDogs = ERC721(0x7F02e94Fb8394Fdf5A9d4C5E2252B69c21CCa878);
    ERC721 CoolCats = ERC721(0x3f07E37d937E60CC2D8C4F00541fb80A5bf4eC23);
    ERC721 BabySpookles = ERC721(0xc10D37997582e81308cD52a1C32dD430E469984f);
    ERC721 GenesisSpookles = ERC721(0xaf27d8e112954C820e082a0E18DadAE88CeF4951);
    ...
    function gift() public mutualCheck{
        ...
        require(CoolCats.balanceOf(msg.sender) > 0 || CoolDogs.balanceOf(msg.sender) > 0 || AlienFrens.balanceOf(msg.sender) > 0 || BabySpookles.balanceOf(msg.sender)> 0 || GenesisSpookles.balanceOf(msg.sender) > 0 || ERC721(referenceContract).balanceOf(msg.sender) > 0, "You are not into WL");
        // require(ERC721(referenceContract).balanceOf(msg.sender) > 0, "You are not into WL");
        require(balanceOf(msg.sender) < maxPerWalletPresale, "One token per wallet for holders");
