...
//metadata
    ...
    m_0530 mainContract = m_0530(0x708e47B7a001b6b3fC00d82905f449Fa749e84b5);
        ...
        //24519134421 区切り文字
        {
            ...
            for (uint i = 0; i < 9 ; i++) {
                ...
                if(strings.equals( uintTo_StringNumToStringLayerName[i+1][su.str2uint(parts[i])].toSlice() ,"".toSlice() ) && i < 8){
                    missList[_msgSender()]++;
                    require(false,string(abi.encodePacked("check",su.uint2str(i),uintTo_StringNumToStringLayerName[i+1][su.str2uint(parts[i])],parts[i] )) );
                }
            }
