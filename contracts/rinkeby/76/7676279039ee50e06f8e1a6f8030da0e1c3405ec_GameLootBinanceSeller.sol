...
contract GameLootBinanceSeller is Ownable, IERC721Receiver {
    ...
    event ClaimFirst(address equipment, uint256 tokenID, uint256 bnTokenID, address user);
    event ClaimSecond(address equipment, uint256 tokenID, uint256 bnTokenID, address user);
    ...
    function changeFirstBNFT(address bnft_1) external onlyOwner {
        require(bnft_1 != address(0),"invalid address");
        binanceNFTFirst = IERC721(bnft_1);
    }

    function changeSecondBNFT(address bnft_2) external onlyOwner {
        require(bnft_2 != address(0),"invalid address");
        binanceNFTSecond = IERC721(bnft_2);
    }
