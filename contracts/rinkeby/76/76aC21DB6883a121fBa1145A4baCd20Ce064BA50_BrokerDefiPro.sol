...
contract BrokerDefiPro is ERC721, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function publicMintPartner(address to, uint amount, uint code) public payable nonReentrant {
    ...
    function publicMintPro(address to, uint amount, uint code) public payable nonReentrant {
        require(saleIsActive && nftPrice > 0 && treasury != address(0), "Config not done yet");
        require(msg.value >= (nftPrice * amount), "Not enough balance");
        if (code > 0) {
