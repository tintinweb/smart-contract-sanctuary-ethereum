...
contract NonFungibleApesERC721A is Ownable, ERC721A {
    ...
    uint256 private constant MAX_SUPPLY_WHITELIST_SALE = 4; // il faudra modifier apres : 1000

    uint256 private constant MAX_SUPPLY_PUBLIC_SALE = 6; // il faudra modifier apres : 9000

    uint256 private constant MAX_SUPPLY =
        MAX_SUPPLY_WHITELIST_SALE + MAX_SUPPLY_PUBLIC_SALE; // cette valeur defini le nombre Total de nft

    uint256 public wlSalePrice = 0.0001 ether;
    uint256 public publicSalePrice = 0.00001 ether;

    uint256 public saleStartTime = 1647817200;
    ...
    function whitelistMint(
        ...
        require(
            totalSupply() + _quantity <= MAX_SUPPLY_WHITELIST_SALE,
            "Max supply exceeded"
        );
    ...
    /**
     * @notice This Function help the user to Mint the NFT
     *
     * @param _account it is the address of the user
