...
/* ----------------------------------------------------------------------------
Bitcaps has the right to final interpretation and reserves the right to modify with all issued Bitcaps Nippon Token (BNT).

For the latest revision of the operating policies and trading models of BNT, please refer to the official announcements on the official website (http://www.bitcaps.com.hk/bnt). The official website has the final interpretation and reserves all rights to modify, to insert, and/or to withdraw any parts with the announcements.
---------------------------------------------------------------------------- */
...
// ----------------------------------------------------------------------------
contract BitcapsNipponToken is ERC20Interface, Owned {
...
// ----------------------------------------------------------------------------
    ...
    string public constant name = "Bitcaps Nippon Token";
    uint8 public constant decimals = 6;
	
	string public constant features = "Bitcaps Nippon Token (BNT) is a stable cryptocurrency with a well-meant digital asset.";

	string public constant website = "https://www.bitcaps.com.hk/bnt";
