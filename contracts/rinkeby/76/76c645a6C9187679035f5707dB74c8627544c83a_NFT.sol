...
contract Marketplace is Ownable, ReentrancyGuard {
  ...
  function isListedForSale(uint256 tokenId_) public view returns (bool) {
    return nfts[tokenId_].isListedForSale;
  }

  function isAlreadySold(uint256 tokenId_) public view returns (bool) {
    return nfts[tokenId_].isAlreadySold;
  }
  ...
  function addOrder(uint256 tokenId_, uint256 price_) public returns (bool) {
    ...
    NFTStatus storage tokenStatus = nfts[tokenId_];
    tokenStatus.isListedForSale = true;
  ...
  function cancelOrder(uint256 orderId_) public returns (bool) {
    ...
    NFTStatus storage tokenStatus = nfts[_tokenId];
    tokenStatus.isListedForSale = false;
    ...
    returns (bool)
  {
    ...
    delete orders[orderId_];
    NFTStatus storage tokenStatus = nfts[order.tokenId];
    tokenStatus.isAlreadySold = true;
