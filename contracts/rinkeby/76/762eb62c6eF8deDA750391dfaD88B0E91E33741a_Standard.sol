...
contract Standard is ERC721A, ReentrancyGuard, Delegated {
    ...
    address public constant GNOSIS_SAFE =
        0xAfb47EaB7532fDD91aBB5f660Ba225a613689bE1;
    ...
    function preSaleMint(
        ...
        require(
            preSaleMinted[msg.sender] + _quantity <= _maxQuantity,
            "Exceeds max claim"
        );
        require(
    ...
    function publicSaleMint(uint256 _quantity) external payable callerIsUser {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "Max supply reached");
        require(
            publicSaleMinted[msg.sender] + _quantity <= maxPublicSaleMint,
    ...
    /**
     * @dev For converting address to hash
     */
