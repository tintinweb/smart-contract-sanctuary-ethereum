...
contract AzukiNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Azuki NFT", "ANFT") {
    setHiddenMetadataUri("ipfs://QmQS8dtYZmcsdqmvjcvENDoGeL4g4gJan4mZiYL64aRSjR/hidden.json");
  }
