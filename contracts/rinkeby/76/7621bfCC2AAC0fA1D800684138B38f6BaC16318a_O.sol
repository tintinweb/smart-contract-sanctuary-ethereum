...
contract O is ERC721A, Ownable {
  ...
  function withdraw() external payable onlyOwner {
    ...
    payable(treasuryWallet).transfer((balance * 50) / 100);
    payable(founder1).transfer((balance * 10) / 100);
    payable(founder2).transfer((balance * 10) / 100);
    payable(founder3).transfer((balance * 10) / 100);
    payable(founder4).transfer((balance * 10) / 100);
    payable(founder5).transfer((balance * 10) / 100);
