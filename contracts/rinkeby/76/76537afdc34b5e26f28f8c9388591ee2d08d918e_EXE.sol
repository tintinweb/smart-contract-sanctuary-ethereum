...
contract EXE is ERC721, Ownable, ERC721Enumerable, ReentrancyGuard {
    using Strings for uint256;
	...
	uint256 public MAX_MINT_SALE = 6060;
    ...
    constructor() ERC721('EXEVERSE', 'EXE') {}
