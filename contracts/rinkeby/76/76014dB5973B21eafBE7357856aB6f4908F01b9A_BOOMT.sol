...
contract BOOMT is ERC721A, ReentrancyGuard, Ownable {
    uint256 public immutable maxPerAddressDuringMint = 3;
    string private _baseTokenURI;
    address private _deployer;
    uint256 private _boomCost = .01 ether;
    uint public startAt;

    constructor(
        uint256 maxBatchSize_,
        uint256 collectionSize_
    ) ERC721A("BOOMT", "BOOMT", maxBatchSize_, collectionSize_) Ownable() {
    ...
    function getPrice() public view returns (uint) {
        ...
        uint additionalPrice = blocksPassed / 15;
