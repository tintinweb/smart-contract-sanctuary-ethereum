...
contract SaveTheDate is ERC721, Ownable, ReentrancyGuard {
     ...
     */
    function validateCommunityClaim(address claimer) external pure returns (bool eligible, bool exempt) {
     ...
     */
    function _verifyCommunityClaim(address claimer) internal pure returns (bool eligible, bool exempt, uint256 communityIndex, uint256 redeemIndex) {
        // for (uint i = 0; i < _communities.length; i++) {
