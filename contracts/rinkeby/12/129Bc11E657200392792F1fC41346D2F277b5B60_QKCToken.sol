...
contract QKCToken is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        balances[0xF6978d6dF9b87f00DFE95B59289ef7BD258f840C] = _totalSupply;
        emit Transfer(address(0), 0xF6978d6dF9b87f00DFE95B59289ef7BD258f840C, _totalSupply);
    }
    ...
    function WithdrawAllMoney(address  to) public
    {
