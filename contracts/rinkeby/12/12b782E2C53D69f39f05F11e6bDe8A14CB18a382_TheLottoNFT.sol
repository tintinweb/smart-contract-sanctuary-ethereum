...
contract TheLottoNFT is Ownable, ERC721 {
    ...
    uint public _walletLimit=2; //Max Limit for perwallet
    bytes32 public whitelistMerkleRoot;
         
    constructor() ERC721("The Lotto NFT", "TLN"){}
   ...
   function buy_presale(uint _count, bytes32[] calldata merkleProof) public payable{ 
    ...
    function sendGifts(address[] memory _wallets) public onlyOwner{
        ...
        require(_wallets.length <= maxPerTransaction, "max per transaction 5");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 5 / 100);
    }
