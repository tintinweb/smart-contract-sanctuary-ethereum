...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 120 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYgYZXbdNxyhzjB2UDvyF29zZBKo5Wt85NkrZvKv8BNBt/";
...
// File: contracts/myApesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyApesContract is RamppERC721A {
    constructor() RamppERC721A("My Apes", "AP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/AXPJDjtriSaV2wy3oPzB/contract-metadata";
    }
}