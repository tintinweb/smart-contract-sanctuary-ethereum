...
contract PRINGLES is Context, IERC20, Ownable {
  ...
  address payable public treasuryWallet =
    payable(0x86C7Da50bF7c39Dab20859c748E180eA100799a3);
  ...
  uint256 public rewardsClaimTimeSeconds = 60 * 5; // 6 hours
  ...
  string private constant _name = 'PRINGLES';
  ...
  address public buybackTokenAddress = 0x98e964624970d2252C7158AF7bF21Da74603620b;
  ...
  function setRewardsClaimTimeSeconds(uint256 _seconds) external onlyOwner {
    require(_seconds >= 0 &&_seconds <= 60 * 60 * 48, 'claim time delay must be greater or equal to 0 seconds and less than or equal to 24 hours');
    rewardsClaimTimeSeconds = _seconds;
  }
  
  // TAX CAN ONLY BE RAISED TO BUY 10 / SELL 20
  ...
  function setFeeSellMultiplier(uint256 multiplier) external onlyOwner {
    require(
      ...
      'must be greater than 0 and less than or equal to 2'
    );
  ...
  function getLasClaim(address user) public view returns (uint256) {
    return _rewardsLastClaim[user];
  }
