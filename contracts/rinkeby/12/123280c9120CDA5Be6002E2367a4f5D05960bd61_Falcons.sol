...
contract Falcons is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxPublicSaleWalletLimit = 2;
  ...
  constructor() ERC721A("420 Falcons", "420F") {
      setHiddenMetadataUri("https://ipfs.io/ipfs/QmUbXX2DK53SjSRPLQW5kh74Vbby5KFZvaHrVus2j16Dc3/hidden.json");
  }
