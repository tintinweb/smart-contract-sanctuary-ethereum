...
contract FancyBearStaking is Ownable, AccessControlEnumerable, IERC721Receiver {
    ...
    IFancyBearHoneyConsumption honeyConsumptionContract;
    ...
    constructor(
        ...
        IFancyBearHoneyConsumption _honeyConsumptionContract,
    ...
    function _stakeFancyBear(address _sender, uint256 _tokenId) internal {
        ...
        require(
            honeyConsumptionContract.honeyConsumed(_tokenId) >=
