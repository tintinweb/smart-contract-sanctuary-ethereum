...
contract EZSC_Presale_Reveal is ERC721A, Ownable { 
...
function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
  ...
  function setWlCost(uint256 _wlCost) public onlyOwner {
   ...
   function setWHITELIST_MAX_MINT_AMOUNT(uint256 _WHITELIST_MAX_MINT_AMOUNT) public onlyOwner {
    require(_WHITELIST_MAX_MINT_AMOUNT <= maxSupply, "Exceed total amount");
  ...
  // WITHDRAW
    function withdraw() public onlyOwner {
        ...
        (success, ) = payable(0x41Cb566727d7531658E5993cd61Dd75581716851).call{ // Replace with clients address
            value: (97 * contractBalance) / 100 // if needed, add address and adjust the number accordingly 
        }("");
        require(success, "Transfer failed");

        (success, ) = payable(0x44230C74E406d5690333ba81b198441bCF02CEc8).call{ // Replace with our address
