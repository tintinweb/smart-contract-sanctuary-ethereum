...
contract Genesis is ERC721URIStorage, Ownable {
    ...
    string public tokenURI = "https://ipfs.io/ipfs/QmZDTG3JRs34fKZNFtr7ufJLPGxm4P2Jsf6456rfWxvW1g?filename=genesis.json";
    ...
    function createToken() external payable {
        ...
        require(addressToIsMinted[msg.sender] == false, "This address has already mint the token.");
        require(tokenCounter <= maxSupply, "All token have already been minted.");
