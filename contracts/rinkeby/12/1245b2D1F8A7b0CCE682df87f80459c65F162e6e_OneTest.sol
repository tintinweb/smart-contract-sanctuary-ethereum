...
contract OneTest is Ownable, ERC721A, ReentrancyGuard {
    ...
    address private constant ONE_TEAM = 0x2B7860015A6B49460a577d675BF8CD13dB990189;
    ...
    constructor() ERC721A("One Test", "OT", MAX_BATCH_SIZE, MAX_PALS) {
    }
    ...
    function withdraw() external onlyOwner {
        payable(ONE_TEAM).transfer(address(this).balance);
    }
}