...
contract MetFlix is ERC20, VaultOwned {
    ...
    uint256 public buyTreasureChestFee;
    
    uint256 public sellTotalFees;
    uint256 public sellDevelopmentFee;
    uint256 public sellLiquidityFee;
    uint256 public sellTreasureChestFee;
    
    uint256 public tokensForDevelopment;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTreasureChest;
    ...
    constructor() ERC20("METFLIX", "MFLX", 18) {
        ...
        uint256 _buyTreasureChestFee = 1;
        ...
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% of circulating supply

        buyDevelopmentFee = _buyDevelopmentFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyTreasureChestFee = _buyTreasureChestFee;
        ...
        excludeFromFees(treasureChestWallet, true);
		excludeFromFees(developmentWallet, true);
        
        excludeFromMaxTransaction(newOwner, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(treasureChestWallet, true);
    ...
    function disableTrading() external onlyOwner {
        require(tradingActive, "Error: Trading already disabled!");
    ...
    function setBuyFees(uint256 _developmentFee, uint256 _liquidityFee, uint256 _treasureChestFee) external onlyOwner {
    ...
    function setTreasureChestWallet(address newWallet) external onlyOwner {
        emit treasureChestWalletUpdated(newWallet, treasureChestWallet);
        treasureChestWallet = newWallet;
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on sell
                ...
                tokensForTreasureChest += fees * sellTreasureChestFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForTreasureChest += fees * buyTreasureChestFee / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForDevelopment + tokensForTreasureChest;
        ...
        uint256 ethForTreasureChest = ethBalance * tokensForTreasureChest / totalTokensToSwap;
        
        
        uint256 ethForLiquidity = ethBalance - ethForDevelopment - ethForTreasureChest;
        
        
        tokensForLiquidity = 0;
        tokensForDevelopment = 0;
        tokensForTreasureChest = 0;
        ...
        // keep leftover ETH for treasureChest
        (success,) = address(treasureChestWallet).call{value: address(this).balance}("");
    }
    
    // useful for buy backs or to reclaim any BNB on the contract in a way that helps holders.
