...
contract Cryptoliga is ERC2981, ERC721, Pausable, AccessControl, CryptoligaFX, CryptoligaWL {
        ...
        )
    {
        if (saleStage == Stages.CLOSED || minter == address(0)) {
            return (
                0, 
                0, 
                saleStage < Stages.PRIVATE ? mintPrice : presalePrice,
                totalSupply(), 
                maxSupply);
        }
    ...
    function whitelistMint(
        ...
        if (!_checkValidity(_merkleProof)) {
