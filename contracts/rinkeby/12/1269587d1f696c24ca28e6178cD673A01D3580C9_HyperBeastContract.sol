...
abstract contract Withdrawable is Ownable {
  address[] public payableAddresses = [0xb3C4eCcb0E76ec1cc0372aD243BB5566347fF9ae];
...
abstract contract HyperBeastERC721A is 
    Ownable,
    ERC721A,
    Withdrawable,
    ReentrancyGuard   {
...
contract HyperBeastContract is HyperBeastERC721A {
    constructor() HyperBeastERC721A("HyperBeast", "HpBe"){}

    function contractURI() public pure returns (string memory) {
      return "HyperBeastContract";
    }
}