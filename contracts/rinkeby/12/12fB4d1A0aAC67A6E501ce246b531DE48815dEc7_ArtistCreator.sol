...
/// @notice This contract is used to deploy artist (Artist.sol) contracts, and manage upgrades via a beacon contract (BeaconProxy.sol).
contract ArtistCreator is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    /// @notice Gets signer address from signature
    ...
    /// @notice Sets admin for artist deployment authorization
    ...
    /// @notice Prevents non-owners from upgrading contract
