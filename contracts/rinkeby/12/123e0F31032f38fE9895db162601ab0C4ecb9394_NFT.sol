...
contract NFT is ERC721, Ownable {
    ...
    // description: The Genesis RSS3 Avatar NFT is a collection of 10,000 unique avatars meticulously designed to identify RSS3 community members. We will release 1000 avatars in the first round. Correspondingly there will be 1000 unique addresses grant the minter roles to mint the first 1000 avatars and each address is only allowed to mint once.
    constructor(
        string memory _name,
