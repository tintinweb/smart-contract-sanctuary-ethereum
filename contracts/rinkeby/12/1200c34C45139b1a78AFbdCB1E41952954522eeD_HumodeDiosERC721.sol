...
contract HumodeDiosERC721 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    // Address
    ...
    // Requires that the recipient is approved
    ...
    //         _safeMint(_to, _nextTokenIdNumber++);
