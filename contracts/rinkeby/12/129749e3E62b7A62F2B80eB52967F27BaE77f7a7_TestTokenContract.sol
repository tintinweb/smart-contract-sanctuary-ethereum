...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x099c6C50dA4Be054733cf2338c0Cd80ebeb6567A];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 3 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbJ5QyR2rvTkNe1C2Q8ywvVtxMkZZTbKEfZP6LHfg8G72/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3");
...
// File: contracts/TestTokenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestTokenContract is RamppERC721A {
    constructor() RamppERC721A("Test Token", "TT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GEi3OePmPk1qMcaUnL3M/contract-metadata";
    }
}
