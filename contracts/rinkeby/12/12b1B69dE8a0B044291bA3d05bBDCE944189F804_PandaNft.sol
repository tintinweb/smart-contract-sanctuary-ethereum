...
contract PandaNft is ERC721, Ownable {
    ...
    // presale mint
    function presaleMint(address account) public payable {
        ...
        if (balanceOf(account) >= maxPerAccountPresale) {
    ...
    // public sale mint
    function mint(address account, uint256 count) public payable {
        if (count == 0) {
        ...
        if (balanceOf(account) + count > maxPerAccount) {
