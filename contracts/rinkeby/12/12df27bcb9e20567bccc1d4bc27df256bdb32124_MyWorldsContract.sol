  ...
  function _beforeTokenTransfer(
        ...
        Ownable
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x4Cf1C873ca21024FD944c00692Eb5D37FACB7ABA);
    ...
    // File: contracts/myWorldsContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MyWorldsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My Worlds", "MWX", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmfHDFE6brdJPVUmkZBaLWt6Uzvbv2v5EkxY4sJnCCfFKK/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/dI6sDXb5ZH5ycScv62qM/contract-metadata";
        }
    }