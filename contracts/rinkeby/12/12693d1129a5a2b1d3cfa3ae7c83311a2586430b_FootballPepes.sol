...
contract FootballPepes is Ownable, ERC721A {
  string public baseURI = "https://ipfs.io/ipfs/QmUqvJM2oEfHDqf8aA4nnxPhuDQLmr8o4MEW9TZNj2hwdk?filename=hidden.json/";

  bool public isMintOpen = false;

  uint256 public immutable unitPrice = 0.0025 ether;

  uint256 public immutable maxSupply = 6400;

  uint256 public immutable maxWalletSupply = 20;

  uint256 public immutable maxWalletFreeSupply = 1;

  constructor(uint256 _mintCntToOwner) ERC721A('Football Pepes', 'FPS') {
