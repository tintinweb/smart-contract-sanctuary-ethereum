...
contract LibertasSpaceWar is ERC721, Ownable {
    ...
    ERC721 private constant LibertasSpectrum = ERC721(0xBBEcd6C14e85a2A55FCF699f99EA487ea6B94910);
    ...
    */
    ...
    function whitelistMint(uint num) public payable OnlyWhitelist{
        require(saleIsActive, "Sale must be active to mint");
