...
contract GemSwap is SpecialTransferHelper, Ownable, ReentrancyGuard {
    ...
    //genosisproxy.sol 0x085062cC7BD9A108917e096ECF8eECA98BE8171b
    address public constant GOV = 0x085062cC7BD9A108917e096ECF8eECA98BE8171b;
    ...
    function setUp() external onlyOwner {
        ...
        // wrappedcryptopunk.sol 0x76c0266263bf129929A4c3DDFe3fECEa4C62853D
        IWrappedPunk(0x76c0266263bf129929A4c3DDFe3fECEa4C62853D).registerProxy();
        punkProxy = IWrappedPunk(0x76c0266263bf129929A4c3DDFe3fECEa4C62853D).proxyInfo(address(this));

        // approve wrapped mooncats rescue to Acclimated​MoonCats contract
        // mooncatswrapped.sol 0xE23F92348DBe4CafD46e692E352CD97BE8f69877    acclimatedmooncats.sol 0x56934F237163Cf0D68c5372B5fe19E1658775C88
        IERC721(0xE23F92348DBe4CafD46e692E352CD97BE8f69877).setApprovalForAll(0x56934F237163Cf0D68c5372B5fe19E1658775C88, true);
    }
    ...
    function _transferFromHelper(
        ...
        for (uint256 i = 0; i < erc721Details.length; i++) {
            // accept CryptoPunks
            // cryptopunk.sol 0x142c65eA70d0B99694c985617A60D0E7B8D85e87
            if (erc721Details[i].tokenAddr == 0x142c65eA70d0B99694c985617A60D0E7B8D85e87) {
                _acceptCryptoPunk(erc721Details[i]);
            }
            // accept Mooncat
            // mooncatrescue.sol 0x228828eB0865a1E2A37470C5feBAceb90B69e475
            else if (erc721Details[i].tokenAddr == 0x228828eB0865a1E2A37470C5feBAceb90B69e475) {
