...
contract MentholNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address internal immutable founders = 0x8500C52ca27f326D3a64B792aA215B1166503076;
    address public proxyAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    mapping(address => bool) public projectProxy;
    uint256 public publicDate = 1652085893;
    //MINTPASSFEATURE
    ...
    constructor() ERC721("Menthol NFT", "MNT") {
        baseURI = "https://hazardrun.metadata.test/meta/";
    }
    ...
    //MINTPASSFEATURE
    function mintPass(uint256 count) external payable checkLimit(count)  {
        uint256 totalSupply = _owners.length;
