...
contract CryptoQueenz is Ownable, ERC721, ERC2981, Treasury {
  ...
  address[] private mintPayees = [
    0xAAc3216bA26C719c395AaC9Ff9Bcd0Fd215EF2FC // Account1
  ];
  ...
  uint256 _CRYPTO_QUEENZ_SUPPLY
    ...
    NFTRevealTime = 1645883721; // 03 March 8pm GMT
    ...
    presaleConfig = PresaleConfig({
      startTime: 1645797367, // 01 March 8pm GMT
      endTime: 1677343504, // 02 March 7:59:59pm GMT
      mintPrice: 0.13 ether,
      supplyLimit: 80
    });

    dutchAuctionConfig = DutchAuctionConfig({
      startTime: 1645883767, // 02 March 8pm GMT
    ...
    royaltyPayees[0] = 0xECbDA933ab47011c14d204D1726B681f96545791; // Account1
