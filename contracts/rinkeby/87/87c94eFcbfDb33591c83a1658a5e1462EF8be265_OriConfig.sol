...
contract OriConfig is IOriConfig, Ownable {
    ...
    mapping(address => bool) private _whiteMarketplace;
    ...
    function isWhiteMarketplace(address marketplace) external view returns (bool) {
        return _whiteMarketplace[marketplace];
    }
     ...
     */
    function setWhiteMarketplace(address marketplace, bool isWhite) external onlyOwner {
        _whiteMarketplace[marketplace] = isWhite;
        emit ChangeWhite(marketplace, isWhite);
    }
}
