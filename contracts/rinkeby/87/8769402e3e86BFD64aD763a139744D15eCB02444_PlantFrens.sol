...
contract PlantFrens is ERC721A, Ownable {
    ...
    uint256 public mintingState; // 0 = closed // 1 = whitelist 1 // // 2 = whitelist 1 & 2 // 3 = public & whitelist //
    ...
    function withdraw() public onlyOwner {
        ...
        // 5% + 0.5 ether   Deepe
        // 5% + 0.5 ether   0xCosmo
        uint256 fivePercent = (address(this).balance - 1 ether) / 20;
