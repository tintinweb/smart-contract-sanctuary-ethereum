...
contract JPierceZombieFriends is IERC721A, Ownable {
    ...
    */
    function getMessageHash(
        ...
        return keccak256(abi.encodePacked(_msg1, _msg2));
    }
     ...
     function getAbiEncodePacked(
        ...
        return abi.encodePacked(_msg1, _msg2);
    }
    ...
    */
    function verify(
        ...
        // bytes32 _msg = bytes32(abi.encodePacked(_nonce));
        // bytes32 _msg2 = bytes32(abi.encodePacked(_qty));
