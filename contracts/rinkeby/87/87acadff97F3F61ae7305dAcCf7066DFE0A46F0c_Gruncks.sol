...
function balanceOf(address _address) external returns (uint);
  ...
  address public FPASSaddress =0x8E688483ce6b8398c5f38A69e7D522B8917DAa3b;

  IFPASS FPASS = IFPASS(FPASSaddress) ;
  
   address public Discountaddress = 0x2935dF20B4AEa3271169378349468e3a6E8BEB83;
   IDiscount discount = IDiscount(Discountaddress);

  uint256 public cost = 0.0066 ether;
uint public discountcost = 0.0055 ether;


  uint16 public constant maxSupply = 666;
  uint8 public maxMintAmountPerTx = 20;
  uint16 public discountsale;
  uint16 public maxdiscountsale = 5;
