...
contract WarDogs is ERC721, Ownable {
  ...
  function mintDogs(uint256 _amount) external payable {
    ...
    require(_amount <= 2, "Cannot mint more than 2 Dogs");
    require(balanceOf(msg.sender) <= 2, "Only 2 dogs per wallet");
    require(tokenCount + _amount <= maxSupply, "Exceeds max supply");
