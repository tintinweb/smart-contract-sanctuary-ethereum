...
contract test_CreatedByNFTGM is GMERC721A {
    ...
    uint256[] _basisPoints  = [500, 100];


    constructor(
    ) GMERC721A(
        unicode"test",
        unicode"ttttttttttttaaaaaaaaaaaaaaaaaaaaaaaa",
        "https://test-api.nftgm.art/api/v1/nftgm/metadata/rinkeby/62f47ea8d73656da7ba5389a/",
        22,
