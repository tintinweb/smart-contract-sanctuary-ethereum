...
contract Airdrop is ERC721A, Ownable {
    ...
    function contractURI() public view returns (string memory) {
     ...
     function airDropToken(address[] calldata receivers, string[] calldata  uris, uint256 intended_first_token_id) external onlyOwner  {
        ...
        require(_tokenIdTracker.current() + receivers.length == _tokenIdTracker.current() + 20, "exceed_tx_limit");
        require(_tokenIdTracker.current() + receivers.length <= _maxSupply, "exceed_limit");
