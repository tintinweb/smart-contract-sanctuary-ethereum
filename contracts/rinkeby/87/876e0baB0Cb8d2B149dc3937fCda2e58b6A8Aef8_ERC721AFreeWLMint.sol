...
// Developed By Tibbs https://github.com/TTibbs
...
contract ERC721AFreeWLMint is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("FreeWLMint", "WL3M") {
      setBaseURI("ipfs:///");
    ...
    // Whitelist only minting function
