...
contract StakingBNB {
    ...
    function stakeBnb() public payable isRegisteredUser {
        ...
        // uint256 lastIndex = userFundDetails[msg.sender].length;
        ...
        // stakedBalance[_user].lastDepositTs = block.timestamp;
    ...
    function _updateRefBalance(uint256 _amount) internal {
        ...
        for (uint256 i = 0; i < MAXIMUM_REFERRAL_STACK; i++) {
            // UserDetails storage _userDetails = userDetails[_referredBy];
            // UserBalance storage _stakedBalance = stakedBalance[_referredBy];
            ...
            // console.log("_referredBy: ", _referredBy);
            // console.log("_curLvlBalance: ", _curLvlBalance);
            // console.log("_lastTs: ", _lastTs);
            // console.log("_rate: ", _rate);
            // console.log("_timeDiff: ", _timeDiff);
            // console.log("_earnings: ", _earnings);
            // console.log("_totalRefEar: ", _totalRefEar);
        ...
        returns (uint256 _earnings)
    {
        ...
        // for (uint256 i = 0; i < uf.length; i++) {
        //     uint256 _time = block.timestamp - uf[i].lastWithdrawal; // in seconds
        //     uint256 _rate = getDailyEarningsRate(uf[i].balance);
        //     _dailyEarnings +=
        //         ((uf[i].balance * _rate * _time) / 10000) *
        //         24 *
        //         3600;
        //     uf[i].lastWithdrawal = block.timestamp;
        // }
        ...
        // console.log("_lastBalance: ", _lastBalance);
        ...
        returns (uint256)
    {
        // check earnings rate
        address _user = msg.sender;
        // uint256[5] memory _refEarnings = userDetails[_user]
        //     .referrals
        //     .referralEarnings;
    ...
    function withdrawBalacne(uint256 _amount) public {
        ...
        // console.log("_grossOwnEarnings: ", _grossOwnEarnings);
        // console.log("_grossRefEarnings: ", _grossRefEarnings);
    ...
    // function _universalFeesDeduction(uint256 _amount) internal {
    //     // deduct 10% and transfer between referals, SC and admin
    //     uint256 amountToDeduct = _amount / 10; // 10%
    //     uint256 adminTransfer = amountToDeduct / 2; // 50% of 10%
    //     payable(treasury).transfer(adminTransfer);
    //     payable(owner).transfer(adminTransfer);
    // }
