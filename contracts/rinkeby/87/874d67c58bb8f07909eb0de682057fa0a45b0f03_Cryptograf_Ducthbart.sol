...
contract Cryptograf_Ducthbart is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cryptograf Ducthbart", "CD") {
    setHiddenMetadataUri("ipfs://QmT1CCTY2DXPJyG5Dxoaaz6b8rNRpXL4YHpXnXsLdbz4gx/hidden.json");
  }
