...
contract APE303 is ERC721, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x685c50143402f1e2D50c00f531f52fddBf990d03).call{value: address(this).balance * 1 / 100}("");
    require(hs);
    // =============================================================================
