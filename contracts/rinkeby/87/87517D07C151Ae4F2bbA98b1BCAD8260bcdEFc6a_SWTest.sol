...
contract SWTest is ERC721Enumerable, Ownable {
    ...
    address a2 = 0xb13280E2a670037C34bDCCd0dcF7835ebA8F1225;
    address a3 = 0xb13280E2a670037C34bDCCd0dcF7835ebA8F1225;
    address a4 = 0xb13280E2a670037C34bDCCd0dcF7835ebA8F1225;
    ...
    function withdrawTeam() external payable onlyOwner {
        ...
        (bool p4, ) = payable(0xb13280E2a670037C34bDCCd0dcF7835ebA8F1225).call{value: balance * 15 / 100}("");
        require(p4, "transaction_failed");

        (bool p5, ) = payable(0xb13280E2a670037C34bDCCd0dcF7835ebA8F1225).call{value: balance * 3 / 100}("");
