...
contract MyToken is ERC721Preset {
    ...
    function buyByGr(uint256 _optionId, uint256 _id) public {
        ...
        uint256 tokenId = 1;
        optionUsers[_id] = OptionUser(_id, _optionId, tokenId, options[_optionId].price,options[_optionId].expirationAmount, options[_optionId].endDateAt);
    }
