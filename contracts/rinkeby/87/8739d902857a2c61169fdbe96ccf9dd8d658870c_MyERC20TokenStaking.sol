...
contract MyERC20TokenStaking is Ownable {
    ...
    function getAllowance(address owner, address spender) public view returns(uint256) {
        uint256 allowance = MyERC20Token.allowance(owner, spender);
        return allowance;
    }

    function setAllowance(address spender, uint256 amount) public returns(uint256) {
        MyERC20Token.approve(spender, amount);
        uint256 allowance = MyERC20Token.allowance(msg.sender, spender);
        return allowance;
    }
}