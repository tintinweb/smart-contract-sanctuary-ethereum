...
contract Lengtu is Ownable, ERC721A, ReentrancyGuard {
    ...
    function getAllowListPrice(uint256 offset) public view returns(uint256){
        if (100 < 10 + amountForAllowList - offset){
            return 0.000000 ether;
        }
        return 0.100000 ether;
    }
    ...
    function getPuiblicSalePrice(uint256 offset) public view returns(uint256){
        if (100 < 10 + amountForPublicSale - offset){
            return 0.000000 ether;
        }
        return 0.100000 ether;
    }
    ...
    // auction
    uint256 public amountForAuction = 100;
    uint256 public constant AUCTION_START_PRICE = 1.000000 ether;
    ...
    uint256 public immutable auctionPerMint = 1;
