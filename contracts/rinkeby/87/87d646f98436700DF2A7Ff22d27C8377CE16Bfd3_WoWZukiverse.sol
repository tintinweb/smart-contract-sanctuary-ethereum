...
contract WoWZukiverse is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 price,
        ...
        uint32 maxMintPerTx,
        address signer) ERC721A("WoWZukiverse", "WOWZ") {
        PRICE = price;
    ...
    0x814BbbbFb837B5a7318BacB6702B6f2829D55Ddd;

    address private constant payoutAddress2 =
    0x0fD105F5262d3114ab1a3D52877C4b295c2FE223;

    address private constant payoutAddress3 =
    0x4a9171794e3b11a12F3D781adDDb0B308DD0B66D;

    address private constant payoutAddress4 =
    0xc5A51039527183103B7A4941154F93245e755C8f;
