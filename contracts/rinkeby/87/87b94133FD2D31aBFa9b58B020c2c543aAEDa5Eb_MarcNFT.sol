...
contract MarcNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Marc NFT", "MARCNFT") {}
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(addressClaimed[_msgSender()] < MAX_MINT, 'You have exceeded the token limit');
