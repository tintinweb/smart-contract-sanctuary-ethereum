...
contract Coinage is Ownable, ERC1155Supply, ReentrancyGuard {
    ...
    uint256 public maxNetworkGroupCount = 250;
    ...
    TokenType Network = TokenType(1, 0.675 ether, 1000);
    TokenType Caucus = TokenType(2, 0.15 ether, 9000);
    ...
    function subscriberMint() external {
        ...
        mint(msg.sender, Subscriber.id, 1);
