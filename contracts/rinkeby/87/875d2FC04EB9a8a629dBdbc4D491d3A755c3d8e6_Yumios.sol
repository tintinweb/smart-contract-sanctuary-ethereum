...
abstract contract ERC721PresetMinterPauserAutoId is Base, Context, ERC721Burnable, ERC721Pausable, IERC721Mintable {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view returns (uint256) {
        ...
        // Counter overflow is impossible as the loop breaks when uint256 i is equal to numMintedSoFar.
        unchecked {
        ...
        // return 0 if no token could be found because 1 is the starting token id 
        return tokenId;
    }
