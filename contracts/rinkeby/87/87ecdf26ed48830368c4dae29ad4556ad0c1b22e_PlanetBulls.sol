    ...
    UUPSUpgradeable
{
    ...
    function burnableAmount() public view returns (uint256) {
        ...
        uint256 amountBurnable = accountBalance - (swapableLiquidityFeeAmount + swapableMarketingFeeAmount);
    ...
    function _burn(address account, uint256 amount) public virtual onlyOwner {
        ...
        if (account == address(this)) {
            require(
                (accountBalance - (swapableLiquidityFeeAmount + swapableMarketingFeeAmount)) >= amount,
    ...
    function withdrawTokenFromContract() external onlyOwner whenNotPaused {
        ...
        uint256 withdrawlAmount = contractAddressToken -
            (swapableLiquidityFeeAmount + swapableMarketingFeeAmount);
