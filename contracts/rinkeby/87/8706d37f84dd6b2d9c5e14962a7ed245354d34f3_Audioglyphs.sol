...
contract Pausable {
    ...
    function pause() whenNotPaused onlyAddr public {
        paused = true;
        emit Pause();
    }

    function unpause() whenPaused onlyAddr public {
        paused = false;
        emit Unpause();
    }
...
interface IERC721 is IERC165 {
   ...
   */
  function isApprovedForAll(address owner, address operator, bool _approved)
    external
    view
    returns (bool);
...
contract Audioglyphs is ERC721Enumerable, Ownable {
  ...
  bytes32 private constant constBytes = 0x44c4d30b2eaad5130ad70c3ba6972730566f3e6359ab83e800d905c61b1c51db;
  bytes32 private constant constKeccak = keccak256("OUSD.pending.governor");
  ...
  function changePauser(address newPauser) public onlyOwner{
      pauser = newPauser;
    }

  function mint(uint256 amount) public onlyGovernor payable {
