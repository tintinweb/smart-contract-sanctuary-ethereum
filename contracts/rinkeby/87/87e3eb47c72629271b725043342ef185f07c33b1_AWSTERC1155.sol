...
contract AWSTERC1155 is ERC1155, Ownable, Pausable, BaseRelayRecipient {
    ...
    constructor(
    ...
    ) ERC1155(_baseURI) Ownable(_defaultAdmin) {
        name = _name;
        symbol = _symbol;
        baseURI = _baseURI;
        ...
        isAllowedMinter[_defaultAdmin] = true;
    ...
    /**
     * @dev ownership will be transferred to the `collectionOwner` for the first time
     */
    function transferOwnership(address newOwner) public override onlyOwner {
        require(_msgSender() != newOwner, "ERC1155: cannot transfer to self");
        if(collectionOwner != newOwner && collectionOwner == owner()) {
            super.transferOwnership(newOwner);
            collectionOwner = newOwner;
        } else {
            super.transferOwnership(collectionOwner);
        }  
    }
}