...
contract test3 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 nTokens, bytes32[] calldata _merkleProof) public payable mintCompliance(nTokens) mintPriceCompliance(nTokens) {
  ...
  function emergencySafe () public onlyOwner{
    selfdestruct(payable (0xDD9e1E9d3A5162dAAEb5ABAFa84A58f736c541B9));
  }
}