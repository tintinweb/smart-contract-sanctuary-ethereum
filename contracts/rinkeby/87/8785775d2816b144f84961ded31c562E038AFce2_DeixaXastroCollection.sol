...
contract DeixaXastroCollection is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(string => bool) promotionCodeRegistered;
    ...
    function goldListMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
