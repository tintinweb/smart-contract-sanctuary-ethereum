 ...
 * @title Skygolpe
 */
contract Skygolpe is ERC721, Ownable {
    ...
    */
    function dropNFT(string memory _metadata) external onlyOwner {
    ...
    */
    function fixNFT(uint256 _token, string memory _metadata) external onlyOwner {
    ...
    /*
        This method will fix a token metadata if not freezed
    */
    function freezeNFT(uint256 _token) external onlyOwner {
        require(!token_freezed[_token], "Token is freezed");
