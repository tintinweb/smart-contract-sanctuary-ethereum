...
/*==================================================== Modifiers ==========================================================*/
    ...
    modifier isStarted() {
        require(started == true, "Drop has not started yet!");
        _;
    }
...
/*==================================================== State Variables ==========================================================*/
    ...
    AggregatorV3Interface ernOracleAddr;

/*==================================================== Constructor ==========================================================*/

    constructor(IERC20 _ern, AggregatorV3Interface _ernOracle) {
        ern = _ern;
...
/*==================================================== External Functions ==========================================================*/
    ...
    */
    function setStart(bool _condition) external onlyAdmin {
        started = _condition;
    }
...
/*==================================================== Internal Functions ==========================================================*/
    ...
    */
    function _setCollection(
        ...
        if (_tier == Tiers.TierOne) {
            require(firstDeck.length <= 499, "More than Tier Limit!");
            ...
            require(firstDeck.length <= 149, "More than Tier Limit!");
            ...
            require(firstDeck.length <= 49, "More than Tier Limit!");
