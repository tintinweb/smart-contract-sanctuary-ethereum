...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://token.com/";
...
contract TestingContract is RamppERC721A {
    constructor() RamppERC721A("Testing", "TestMe"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/4fgV68ZWV56IWhNIIN4U/contract-metadata";
    }
}