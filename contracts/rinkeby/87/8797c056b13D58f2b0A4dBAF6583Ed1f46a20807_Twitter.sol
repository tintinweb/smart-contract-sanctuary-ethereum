...
contract Twitter {
    ...
    // function getMyDetails() public view returns(address, string, uint256, uint256){
    //     return (users[msg.sender], users[msg.sender].username, users[msg.sender].following.length, users[msg.sender].followers.length);
    // }
