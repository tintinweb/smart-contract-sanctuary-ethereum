...
//                       '0RK    BRBBH   [RB~                              
//                       '0RN    BBRRH   [BB~                              
//      0BBRRRRBBM       '0BRBB        [RRBB~                              
//   '0RRBB    0BRRRRB,   ^"[BBBB    0RBRB""     .[BRRRRRRRRBB             
// 'BRRBN          [BRBB,     [BB    0BK     '0BBRRBB      [BRRB,          
// '0RL              lRB,     [BB    0BK     ,0RN            lBBRRH        
// '0R"              !RRR0RRRRRBRRRRRRRRRRRRRRRBM              `BRH        
// '0R"      BRRRH [RRBRRBb `                 0RRRB  BRRRH      BRH        
// '0R"      BBRBRRRRB                          0BRRRBBBBH   'BRBBH        
// '0R"      ``0BM                                  `BR``    !BBL`         
// '0RRRH    BRRRH                                   BBRRH [RRBB~          
// ,ff0RRBRRBBB `                                     `BBBRRBBF"           
//    `````fFBR         BRRRRRRRRRR                    0RRRKf`             
//        JRRRB      'RBBR       RRRRRRRRRRRRRRBH      ` 0RK               
//        [BB"`      !BR         RRRR         0RRBB      0BK               
//        [RB      [RRRR         RR             [RR      0BRBB             
//        [RB      [RB           RR             [RR      ``[BK             
//        [BB      [RK    [email protected]@@@  RR    |@@@@    [RR        [RK             
//        [[email protected]@    [BK    0RRRR  RR    [RRRB    [RR        [RK             
//        ^[email protected]@@@[email protected]@[email protected]@@@[email protected]@@@[email protected]@H [RK             
//        [email protected]@RRRRM````````````````````````````````````[email protected]@0RK             
//      @@@RBFF"`    [email protected]@         @@@@~                 F"""[[email protected]@,          
//      0BRF"        !RR         F`0BH                     '`]BB~          
//      0RR          '[email protected]@         ""                      [@@RB~          
//      [email protected]@@         "[email protected]@@@@@@@@                    #@@@@BBFF           
//      FF3RR#####@p    F""""""""""         #####@#####RRNFFFF             
//        "[email protected]@@@@@@@@@@@@@@@@@@@@@@@BREFFFFFFFFFF"                 
...
contract Tejiverse is Ownable, ERC721K {
    ...
    IERC721 private tejiverse = ERC721(0x9D93EdcDeC06576be9F68b8440818B5b847e8bd8);
    IERC721 private rrt = ERC721(0x61595E3A3d4eb9B56bD14a49b10160741944C7c1);
