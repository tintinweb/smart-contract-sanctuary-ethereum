...
contract DevFierceCrowd is ERC721, ERC721URIStorage, ERC2981, Pausable, Ownable, RandomlyAssigned {
    ...
    string baseURI = "";
    string public hiddenBaseURI = "ipfs://QmfL8hyQVDqiUbk42rdF58fvJvX9Qr2qYMioFHr91bsxDD/";
    string public contractURI = "ipfs://QmdcRxWwFhiKBcWjoSHgcdqqX6P5WCsFCSTBcsqs8pNJ41";
    string public baseExtension = ".json";
    string public hiddenExtension = ".json";
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721, ERC721URIStorage) returns (string memory){
        ...
        if(revealed) {
            ...
            return string(abi.encodePacked(hiddenBaseURI, "hidden", hiddenExtension));
        }
    }
