...
contract CockyDogNFT is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.0009 ether;
    uint256 public MAX_SUPPLY = 2000;
    uint256 public MAX_MINTS = 100;
    string public baseURI = "https://filedn.eu/l9DcJX8i7vtpxhvDFTHqIOm/CockyDogNFT/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Cocky Dog Nft", "CDN", MAX_MINTS, MAX_SUPPLY) {  
    }
