...
contract CrowdFunding {
    ...
    */
        ...
        returns (bool reached)
    {
        ...
        c.amount = 0;
        c.beneficiary.transfer(amount); //填寫回beneficiary的address
        return true;
    }
//以下是自寫的
    function read(uint256 campaignID) 
        public 
        returns (address addr2, uint256 amount2)
    {
        Campaign storage c = campaigns[campaignID];
        addr2=c.funders[campaignID].addr;
        amount2=c.funders[campaignID].amount;
