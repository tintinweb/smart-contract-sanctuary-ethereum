...
contract WhiteLink is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function minttokenId(address _to, uint256 _tokenId, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            require(_tokenId < 3213 || (3780<_tokenId && _tokenId<5803) || (6160<_tokenId && _tokenId<6755) || (6860<_tokenId && _tokenId<6979), "reserved");
