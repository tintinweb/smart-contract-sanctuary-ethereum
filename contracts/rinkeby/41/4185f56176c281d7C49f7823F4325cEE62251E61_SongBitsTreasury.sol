...
contract SongBitsTreasury is OwnableUpgradeable, IMetadata {
    ...
    function buy(string memory _metadataId, uint256 _bits) public payable {
        ...
        require(calculatedCost == msg.value, "insufficient funds");
        require(
