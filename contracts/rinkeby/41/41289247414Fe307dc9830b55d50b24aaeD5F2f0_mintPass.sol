...
contract mintPass is ERC721, Ownable {
    ...
    mapping (address => uint) addressToMintCount; // how many mint passes do i have
    ...
    */
    ...
    onlyAccounts
    {
        ...
        require(balanceOf(msg.sender) < NUMBER_OF_TOKENS_ALLOWED_PER_ADDRESS, "Exceeds allowance");
        mintPrivate();
