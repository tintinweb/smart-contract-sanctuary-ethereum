...
contract RottenBananos is ERC1155, Ownable {
    ...
    function MintWhitelistPhase2(uint256 amount) public payable {
        ...
        require (DVDA.balanceOf(msg.sender)>0 || GHN.balanceOf(msg.sender)>0 || AHC.balanceOf(msg.sender)>0 || BNNO.balanceOf(msg.sender,0) > 0, "Require at least 1 NFT from GodHatesNFTees ecosystem (1 GodHates or 1 Ape or 1 Banano or 1 DVDA)");
