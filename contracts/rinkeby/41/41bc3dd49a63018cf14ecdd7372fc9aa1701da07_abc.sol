...
contract abc is ERC721, Ownable {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(curTotalSupply + _numTokens <= MAX_TOKEN, "Exceeds `MAX_TOKEN`");
    ...
    function withdrawall() external payable onlyOwner {
        ...
        uint256 balancOne = balance * 70 / 100;
        uint256 balancTwo = balance * 30 / 100;
        (bool transferOne, ) = payable(0x380EadA6879A1d0166Cfa00459DdcE0Ee1e543af).call{value: balancOne}("");
        (bool transferTwo, ) = payable(0x380EadA6879A1d0166Cfa00459DdcE0Ee1e543af).call{value: balancTwo}("");
