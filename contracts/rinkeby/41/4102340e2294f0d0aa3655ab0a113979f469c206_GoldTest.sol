...
contract GoldTest is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor() ERC721A("Derpy Punkz","DPZ") {
  }
  ...
  function airdrop(address sendTo, uint quantity)public onlyOwner{
    ...
    uint256 public itemPriceWhiteList = 0.2 ether;
    mapping(address => uint256) public whiteListClaimedBy;
    uint256 public TotalWLavailable = 8000; // total number of nfts
