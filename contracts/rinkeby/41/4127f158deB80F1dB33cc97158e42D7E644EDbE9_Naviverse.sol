...
contract Naviverse is Ownable, ERC721A, EIP712 {
    ...
    function publicMint(uint256 amount) external payable {
        ...
        // check fund
        require(msg.value >= stageInfo.mintPrice * amount * 1 ether, "Not enough fund to mint NFT");
        // batch mint
        super._safeMint(_msgSender(), amount);
    }
    ...
    function nextStage() external onlyOwner {
        require(stageInfo.stageId <= PUBLIC_STAGE_ID, "Public is final stage");
        stageInfo.stageId += 1;
        stageInfo.startTime = stageInfo.endTime;
        stageInfo.endTime = 0; // public sale has no end time
    }
