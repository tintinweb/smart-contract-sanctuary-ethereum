...
contract CrowdsaleDigitalUYS {
    ...
    constructor () public {
        _rate = 200;
        _wallet = 0x123F802fdecD074669CDefb29105f0824a6029DB;  // Your wallet address
        _token = IERC20(0x00b5717b0ecd4b2041fb66216a662fe87d87927a61);  // Digital UYS contract address
        owner = msg.sender;
    }
