...
contract MetaverseSimple is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public maxSupply = 683;
    ...
    address a1 = 0x234FD60E54E6580fb6951f3ce974aA57E1bEd3dE;
    address a2 = 0x3B283f7f6675829Aa8B470FaA08b1170ddBd04c8;
    address va = 0x1027567959e12Fe4dEe061f7e8F70bA6e46C3B2c;

    constructor(string memory _initBaseURI) ERC721P("Metaverse", "META") {
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        sendEth(a1, percent * 40);
        sendEth(a2, percent * 40);
