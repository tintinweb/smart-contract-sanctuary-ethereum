...
contract TonicGuildCard is Initializable, ERC721Upgradeable,ERC721RoyaltyUpgradeable,ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function pauseAllowListMint() public onlyOwner {
        _allowListActive = false;
    }

    function activateAllowListMint() public onlyOwner {
    ...
    function adminMint(address to) public onlyOwner {
        require(totalSupply() + 1 <= maxSupply, "Purchase would exceed max tokens");
        _mintAndIncrement(to);
    }
    ...
    // Royalty: feeNumerator / 10000
    function setRoyalties(address reciever, uint96 feeNumerator) public onlyOwner {
    ...
    function setAllowList(address[] calldata addresses, uint8 limit) external onlyOwner {
    ...
    function allowListMint(uint8 quantity) external payable {
        ...
        require(supply + quantity <= maxSupply, "Purchase would exceed max tokens");
