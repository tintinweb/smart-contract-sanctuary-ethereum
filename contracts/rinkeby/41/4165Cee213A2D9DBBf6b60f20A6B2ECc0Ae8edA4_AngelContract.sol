...
contract AngelContract is ERC721, Ownable {
  ...
  // This is the normal mint function
  ...
  function mintPresale(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(reserved < 1, "This address is not authorized for presale");
