...
contract LoopopPrivatePassTest is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, ReentrancyGuard {
    ...
    constructor() ERC721("LoopopPrivatePassTest", "LTK") {
    ...
    function setRole(address to, bytes32 role) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _grantRole(role, to);
    }
