...
contract NFTCollection is ERC721, Ownable {
    string public constant VERSION = "1.0.22";
    ...
    // function testMintPrice() public view returns (uint256) {
    //     // uint256 cMintPrice = uint256(2000000) * 10**12;
    //     // uint256 cPrice = uint256(153040315505);
    //     uint256 factor = 10**18;
    //     return (2000000 * factor / 153040315505) % factor;
    // }

    function getMintPrice() public view returns (int) {
        (, int price, , , ) = priceFeed.latestRoundData();
        int factor = 10**18;
        return (int(mintPrice) * factor / price) % factor;
    }
    ...
    // onlyOwner returns (ContractInfo memory info) {
    ...
    function _mintTokens(address to, uint256 amount) internal {
        // require(
        //     amount <= tokensPerMint,
        //     "Maximum amount per transaction exceeded"
        // );
        require(msg.value >= mintPrice * amount, "Payment too small");
