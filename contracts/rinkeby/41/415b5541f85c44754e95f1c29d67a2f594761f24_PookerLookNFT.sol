...
contract PookerLookNFT is Ownable, ERC721Enumerable {
    ...
    uint256 public privateSupply = 2000;
    uint256 public privatePrice = 0.01 ether;
    uint256 public publicPrice = 0.04 ether;
    address adminWallet = 0x5eacBb8267458B6bAC84D4019Bb64CC1a35b248E;
    address devWallet = 0x5eacBb8267458B6bAC84D4019Bb64CC1a35b248E;
    uint256 devFee = 10; // 10%
    uint256 public maxMintNumber = 20;
    uint256[50000] private _availableTokens;
    uint256 private _numAvailableTokens = 50000;
    ...
    function changePublic() external onlyOwner {
        isPublic = !isPublic;
    ...
    function setMaxMintNumber(uint256 _maxMintNumber) external onlyOwner {
    ...
    function changePrivate() external onlyOwner {
        isPrivate = !isPrivate;
    ...
    function publicMint(uint256 _number) public payable {
    ...
    function mint(uint256 _number) internal {
        ...
        uint256 devAmount = msg.value.mul(devFee).div(100);
        uint256 adminAmount = msg.value.div(devAmount);
