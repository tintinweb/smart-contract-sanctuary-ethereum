...
import {ControllableUpgradeable} from "../root/ControllableUpgradeable.sol";
import {OwnableUpgradeable} from "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
...
contract ReverseRegistrarUpgradeable is
    Initializable,
    ...
    UUPSProxy
{
     ...
     */
    function initialize(ENS ensAddr, NameResolver resolverAddr)
        public
        initializer
    {
        ens = ensAddr;
        ...
        ReverseRegistrarUpgradeable oldRegistrar = ReverseRegistrarUpgradeable(
