...
contract CodStomach is Ownable, ERC721A, ReentrancyGuard{

    //Contract URI
    string public CONTRACT_URI =
        "ipfs://QmQHxsSMZUm2a2zj73Kgu4zVirxTAbMhJufa8J4Vh6YrUV";   //should link to the contract.json file //TODO: upload to ipfs and update then update this row

    //Token to token price data
    mapping(address => bool) public userToHasMinted;

    bool public REVEALED;
    string public UNREVEALED_URI = "ipfs://QmdFmPdarpg5JHkV5Dj8P7oCHhjba2zfWMA2fZKZ5qzbJU";  //TODO: set this, hardcoded (saves gas) here with no way to update the unrevealed URI later
    ...
    constructor() ERC721A("CodStomach", "CODSTOMACH") {}
        ...
        callerIsUser
    {
        ...
        require(
                ...
                "Must send enough eth for public mint"
            );
