...
contract TheKidsTest is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 public MAX_SUPPLY = 1000; //change this to 9001 for real mint
  ...
  uint256 public MAX_OG_WHITELIST_MINT_AMOUNT = 2;
  uint256 public MAX_PUBLIC_MINT_AMOUNT = 4;
  uint256 public MAX_AMOUNT_PER_WALLET = 4;
  ...
  constructor() ERC721A("TheKidsTest", "KIDS") {
    setHiddenMetadataUri("https://kids.mypinata.cloud/ipfs/Qmb88HfoL759udukJxkUGEAD1KdQpgvzmxE6mhxJUbFKGp/");
  }
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public mintModifier(_mintAmount) onlyOwner {
  ...
  function setCoolKidsMintState(bool _state) public onlyOwner {
