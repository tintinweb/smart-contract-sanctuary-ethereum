...
contract IsekaiBattleSeeds is ERC1155Burnable, AccessControlEnumerable, Ownable, IIsekaiBattleSeeds {
    ...
    function uri(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            'Seed Lv',
            info.level.toString(),
            '","description": "A collection of Seeds that can be obtained in the fully on-chain game \\"Isekai Battle\\".  \\nThey can be used for powering up characters and can be fused together.  \\n  \\nIsekai Battle (https://isekai-battle.xyz/)","image": "',
            info.image,
