...
contract NotReallyPeople is AccessControl, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;
    Counters.Counter public nextTokenId;

    uint256 public immutable MAX_SUPPLY;

    constructor (string memory name, string memory symbol, uint256 max, address admin)
        ERC721(name, symbol)
    {
        nextTokenId.increment(); // Start collection at 1
        MAX_SUPPLY = max;
    ...
    function mint(string memory _tokenURI) public onlyAdmin {
        ...
        require(currentTokenId <= MAX_SUPPLY, "all tokens have been minted");
