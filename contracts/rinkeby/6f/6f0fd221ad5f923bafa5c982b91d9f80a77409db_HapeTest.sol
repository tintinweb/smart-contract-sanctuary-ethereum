...
contract HapeTest is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "https://meta.hapeprime.com/";
  string public uriSuffix = "";
  string public hiddenMetadataUri ="https://ipfs.io/ipfs/QmayFQRFagNC4QfgwW5K7SLepgKsUEEyD2zPPs32Luh3KG?filename=HNP.png";
