...
/*
*          The official BabyShiba2 ERC-721 Smart Contract
*/
...
// File: contracts/BabyShiba2.sol
pragma solidity ^0.8.0;

contract BabyShiba2 is ERC721, Ownable, Pausable {
	using Counters for Counters.Counter;
	using Strings for uint256;

	address 								_address_for_withdrawal = 0xaE4ccDCD4b6df1F355064058fE52A974703B7656;
	...
	uint256 private 						_mint_supply = 50;
	uint256 private 						_mint_reserved = 48;
	uint256 private 						_mint_limit = 4;
	uint256 private 						_mint_limit_whitelist = 3;
	string private 							_base_url = 'ipfs://QmbCQus7FguT2Fj79erfiVmuo8UjQ8gqyZ4C3TPHwf3R2h/';
	bool private							_is_whitelist_only = true;
	bool private							_mint_limit_by_addy = true;

	//construct
	constructor() ERC721('BabyShiba2','BS') {
