...
contract MutateActor is Initializable, OwnableUpgradeable {
    struct RuleEntry {
        address origin;
        address catalyst;
        address outcome;
    ...
    mapping(bytes32 => bool) private _checkMutated; // keccak256(origin_address, outcome_address, origin_id, outcome_id) => is_mutated_flag
    ...
    function checkMutated(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(origin, outcome, originId, outcomeId)
        );
