...
// File: whatever_erc721r/ERC721r.sol
...
// File: whatever_erc721r/whateeeeeever_erc721r.sol


pragma solidity ^0.8.15;
// no ascii art...whateeeeeever...



contract whateeeeeever is ERC721r, Ownable {
    uint256 public constant i_can_mint_this_amount = 99;
    uint256 public constant u_can_mint_this_amount = 9;
    uint256 public constant pretty_reasonable_price = 0.00001 ether;
    bool public lie_flat = true;
    constructor() ERC721r("whateeeeeever", "whateeeeeever", 10000) {}
    function get_up(bool please_lie_flat) public onlyOwner {
        lie_flat = please_lie_flat;
    }
    ...
    function icanMint(uint256 quantity) external onlyOwner {
        require(tx.origin == msg.sender, "shit...i can't call the contract");
        require(totalSupply() + quantity <= _maxSupply, "that's all");
        require(balanceOf(msg.sender) + quantity <= i_can_mint_this_amount, "too greedy whatever");
        _mintRandom(msg.sender, quantity);
    }
    function mint(uint256 quantity) public payable {
        require(tx.origin == msg.sender, "shit...u can't call the contract");
        require(lie_flat, "i didn't get up...");
        require(msg.value >= pretty_reasonable_price * quantity, "u don't even pay me for 0.00001 eth?!");
        require(totalSupply() + quantity <= _maxSupply, "enough...enough");
        require(balanceOf(msg.sender) + quantity <= u_can_mint_this_amount, "don't be greedy...");
        _mintRandom(msg.sender, quantity);
    }
    function withdraw(address payable recipient) external onlyOwner {
        uint256 balance = address(this).balance;
        (bool success, ) = recipient.call{value: balance}("");
        require(success, "0.1 eth is all i deserve...");
    }
}
// ......