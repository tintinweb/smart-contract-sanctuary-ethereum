...
contract Dcoffer is ERC721A {
  ...
  treasury router = treasury(0x833C6933c92c7723EB8c019a04C1Fdd3536D7C0E);

  constructor(uint256 _price, uint256 _admin_fee, uint256 openAmount)ERC721A("Dcoffer", "Dcoffer",10000) {
    info[0][1] = _price;
    info[0][2] = _admin_fee;
    info[0][4] = openAmount;
    owner = msg.sender;    
