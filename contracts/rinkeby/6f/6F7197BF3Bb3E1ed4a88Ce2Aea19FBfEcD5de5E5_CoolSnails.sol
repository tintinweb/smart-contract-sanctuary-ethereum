...
/*
Snails_new.sol
Contract by @NoMatterWho
thanks to @NftDoyler
*/

contract CoolSnails is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 10;
    uint256 public TEAM_MINT_MAX = 3;
    ...
    string public CONTRACT_URI = "https://nftstorage.link/ipfs/bafkreihlbceuiom5qeydjwmbbn22mddgpbxo2hfxoi5unaofcppezxq3lu";

    bool public paused = true;

    address public teamWallet = 0x7D6f126AbB499b03128fB89D4146F8aEF6C78E2D;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Cool Snails", "SNLZ2") { }
