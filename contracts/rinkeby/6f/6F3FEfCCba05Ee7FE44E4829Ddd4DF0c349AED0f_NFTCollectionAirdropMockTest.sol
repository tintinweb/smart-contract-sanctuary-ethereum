...
import "./NFTCollection/mocks/NFTCollectionAirdropMock.sol";

contract NFTCollectionAirdropMockTest is NFTCollectionAirdropMock {
    constructor()
        NFTCollectionAirdropMock(
...
contract NFTCollectionAirdropMock is NFTCollectionAirdrop {
    constructor(
        string memory _name,
