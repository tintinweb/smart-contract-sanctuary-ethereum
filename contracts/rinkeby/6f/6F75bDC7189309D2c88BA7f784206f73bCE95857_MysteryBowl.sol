    ...
    OwnableUpgradeable
{
    ...
    */
    ...
    /**
    * @dev Keep track of last summoned block number
    */
    mapping(uint256 => uint256) public bowlSummonedAtBlock;
        ...
        returns (uint256 anomuraId)
    {
        ...
        bowlSummonedAtBlock[_tokenId] = block.number;
    ...
    */
    ...
    override(ERC721Upgradeable, ERC721EnumerableUpgradeable)
    {
        ...
        require(block.number - bowlSummonedAtBlock[_tokenId] > 12, "Bowl just summoned cannot trade"); // ~ 3mins
        save(_tokenId);
    }
