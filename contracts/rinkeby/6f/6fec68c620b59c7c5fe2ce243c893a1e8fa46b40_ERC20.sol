...
// File: contracts/raxovile.sol


pragma solidity ^0.8.7;	


contract raxovile is ERC20 {
    uint256 _SUPPLY_CAP;
    address private _owner;

    constructor() ERC20 ("raxo", "RX") {
        _SUPPLY_CAP = 250000;
        _owner = 0x5c19bFf82147d17C7897b39C54fa624DaFb3bE2d;
    }

    function mintToken(address account, uint256 amount) public  {
        require(totalSupply() + amount <= _SUPPLY_CAP, "Total supply is reached");
        require(msg.sender == _owner, "Only Owner can mint Token");
      
        _mint(account, amount);
    }

    function SUPPLY_CAP() public view returns (uint256) {
      return _SUPPLY_CAP;
    }

    function BURN (address account, uint amount) public  {
        require(msg.sender == _owner, "Only Publischer can Burn Tokens");
