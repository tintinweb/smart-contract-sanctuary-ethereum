...
// File: GraphiteWariorsLowGas.sol
...
contract GraphiteWariorsLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Graphite Warriors", "GW") {
    setHiddenMetadataUri("ipfs://QmepBbgh13qramHLHFXUiNkECfqQAAEvQr6BaQSCyqLmkU/Hidden_metadata.json");
  }
