...
contract BigBankTheory is ERC20, Ownable, VRFConsumerBaseV2 {
    // Basic units
    uint256 private constant ONE_HOUR = 60 * 10; // 10 minutes for testing
    ...
    uint256 public maxBuy = (PERCENT_DENOMENATOR * 2) / 100; // 1%
        ...
        VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab)
    {
        ...
        LizzieWizzieNFTs = ILizzieWizzie(
            0xb08917Cc78a50673d479B4aA9E6298AA0e728de7
        );
    }
