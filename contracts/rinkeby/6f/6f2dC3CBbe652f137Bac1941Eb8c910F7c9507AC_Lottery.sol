...
contract Lottery is VRFConsumerBaseV2{
    ...
    function startLottery(uint256 _totalAllowedPlayers, uint256 _lotteryPrice) public payable onlyLotteryManager {
        LOTTERY_DATA.addLotteryData(lotteryId.current(),_lotteryPrice);
        lotteryId.increment();
