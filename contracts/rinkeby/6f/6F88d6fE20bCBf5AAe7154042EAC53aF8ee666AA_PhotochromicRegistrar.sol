...
contract PhotochromicRegistrar is ERC721Enumerable, Ownable {
    ...
    /// Mapping from tokenId to hashes.
    ...
    function isUserIdAvailable(uint256 userId) public view returns (bool) {
        uint256 subnode = uint256(keccak256(abi.encodePacked(baseNode, bytes32(userId))));
    ...
    function register(
        ...
        uint256 id = uint256(keccak256(abi.encodePacked(userId)));
