...
contract ThugsTown is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("ThugsTown", "TST"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(saleIsActive, "Minting is not live yet, hold on");
