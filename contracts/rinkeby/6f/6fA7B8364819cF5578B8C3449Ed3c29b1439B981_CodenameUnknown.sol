/*
.̸̠͙̟́́̈́.̸̻͔̀̚͘.̴͓͍̈́͘͜z̵̢̫̫̓̐̔z̵̢̪̝͒̓̈́z̴̪̝͔̈́͛͘.̴̪͙͔̀͘͝.̴͍͙̙́͑.̴̺͖͊͐z̵̡̡̟̓͋̀z̴̝̺̐̀̓͜z̴̢̢̪̒̀͋.̵̢͕̼͛̕̚.̸̡̪͆̐͝.̸̞͎͉͌̚͝z̴͎͎͛̚̚͜ź̵͕̙̻͋́z̸̦̼͕̐͒̚
.̴̪͖͔͐͑̕.̸̺̘͔̿͘͠.̵̝͍͔̈́͘t̸͇̻̺̓͒̀ë̵̡̠̻́̕s̸͙͇̝̿̔͑t̴͖͖͇̒͆̈́i̵̼̟̠̾̕͝n̴̡̝̘̽̈́̔g̴̘̞̞̿͋͋.̴̺̼̫͐͐.̸͙͓͚̐̈́͊.̸̙͇͑̈́͝
´´´´´´´´´´´´´´´´´´´´´´´$¶´´´´´¶´´´´´¶¢
´´´´´´´´´´´¶¶¶¶¶¶¶´´´´´´´¶¢´´´¶´´´ø¶
´´´´´´´´´´¶¶´´´´ø¶¶¶´´´´´´oø´´ø´´øo
´´´´´´´´´´¶7´´´´´´´¶¶¶´´´´´´1´´´1´´´´1o
...
´´´´´¶¶¶¶¶¶¶¶¶¶¶¶´
´´´´´´´¶¶¶¶¶¶¶¶
.̵̠͎͉̾͒̈́.̵̻͔͊̈́͛͜.̴̞͖̿͌̕͜v̸̝̼̔͆̚a̴͇̞̠̾̾͝l̴͙̙͕͌̐͑ḧ̵̪͇͔́͘͝a̸͔͙͙̔̓͝l̴̪͔͊͛͝l̸̝̪̈́̾͜͠a̸̪̝̓̔͋.̸̼̦̝͑̕͝.̴͚͙̼͋̽͘.̸̘͖͚̈́̔̔
.̸̠͙̟́́̈́.̸̻͔̀̚͘.̴͓͍̈́͘͜z̵̢̫̫̓̐̔z̵̢̪̝͒̓̈́z̴̪̝͔̈́͛͘.̴̪͙͔̀͘͝.̴͍͙̙́͑.̴̺͖͊͐z̵̡̡̟̓͋̀z̴̝̺̐̀̓͜z̴̢̢̪̒̀͋.̵̢͕̼͛̕̚.̸̡̪͆̐͝.̸̞͎͉͌̚͝z̴͎͎͛̚̚͜ź̵͕̙̻͋́z̸̦̼͕̐͒̚
*/
...
contract CodenameUnknown is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private _maxtokensperwallet = 9;
    ...
    function mint(uint256 amount) public payable nonReentrant {
        ...
        require((totalMinted).add(amount) <= _maxtokens, "max tokens minted'");

        require(msg.value >= (_price).mul(amount), "not enough eth sent");

        require((wallets[msg.sender]).add(amount) <= _maxtokensperwallet, "minted amount exceeds max tokens per wallet");
    ...
    function mint_to(address to, uint256 amount) public onlyOwner nonReentrant {

        uint totalMinted = totalSupply();
        require((totalMinted).add(amount) <= _maxtokens, "minted amount exceeds max tokens'");
    ...
    function setmaxtokens(uint __maxtokens) public onlyOwner {
        _maxtokens = __maxtokens;
    }
    ...
    function seturiprefix(string memory __uriprefix) public onlyOwner {
        _uriprefix = __uriprefix;
    }
    ...
    function setactive(bool _value) public onlyOwner {
        _active = _value;
    }
