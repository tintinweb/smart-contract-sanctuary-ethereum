...
contract Beta is ERC721A, Ownable {
    ...
    // bool public PresalistActive = false;
    ...
    // Pre Sale On/Off
    function setPresaleActive(bool value) public onlyOwner {
        presaleActive = value;
    }
    ...
    function emergencyWithdraw() public onlyOwner {
        uint256 balance = address(this).balance;
        payable(address4).transfer(balance);
    }

    // Minting Functions

    function publicMint(uint256 amount) external payable {
        require(publicActive, "Public sale not live");
