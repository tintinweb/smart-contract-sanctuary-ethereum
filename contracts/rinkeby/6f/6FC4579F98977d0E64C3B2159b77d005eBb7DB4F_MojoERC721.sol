...
contract MojoERC721 is PlanetMojoERC721Base {
    constructor(address _owner, address _openSeaProxyRegistryAddress, string memory _baseUri)
        PlanetMojoERC721Base(_owner, _openSeaProxyRegistryAddress, _baseUri) {
    }
}
 ...
 */
abstract contract PlanetMojoERC721Base is ERC721MintManagement, CustomRoyalties {
    /**
    ...
    constructor(address _owner, address _openSeaProxyRegistryAddress, string memory _baseURI)
        ERC721Tradable("Mojo", "Mojo", _openSeaProxyRegistryAddress) {
        baseURI = _baseURI;
...
abstract contract ERC721MintManagement is ERC721Tradable, IMintable {
     ...
     */
    function setMinters(address[] memory _minters, bool[] memory trusted) public {
