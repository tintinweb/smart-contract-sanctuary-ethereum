    ...
    Signature
{
    ...
    constructor(bool isPaying, uint256 deploymentPrice) ERC721A("max Presale Mints", "MPM") payable {
        if(isPaying){
    ...
    function mintPresale(uint256 count, bytes calldata signature)
        external
        payable
...
contract Signature is Ownable {
    ...
    bytes32 private immutable NAME = keccak256("max Presale Mints");
    ...
    /**
     * @dev set whitelist signing address to enable whitelist
     */
