 ...
 */
   ...
   /*  function createNewNftAuction(
        ...
        isWhitelisted(erc20Token)
    {
        ...
        uint256 deadlineTime = (block.timestamp + endTime);
        ...
        uint256 diff = (deadlineTime - launchTime);
    ...
    function _setupAuction(
        ...
        nftContractAuction.startTime = startTime + block.timestamp;
        nftContractAuction.endTime = endTime + block.timestamp;
        ...
        internal
    {
        ...
        nftContractAuction.startTime = 0;
