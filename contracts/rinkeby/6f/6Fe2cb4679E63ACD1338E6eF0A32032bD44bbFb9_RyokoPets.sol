...
contract RyokoPets is ERC721A, ERC2981, Ownable, ReentrancyGuard, Options{
    ...
    function getClaimedStatus(address _address) public view returns (bool){
        return claimedTokens[_address];
    }
    function getWlMintStatus(address _address) public view returns (bool){
        return wlTokens[_address];
    }
    function getHoldersMintStatus(address _address) public view returns (bool){
        return holdersMinted[_address];
    }
    //Only Owner
...
contract Options{
    ...
    modifier privateSaleStep() {
        require(step == Steps.PrivateSale, "Private sale off");
        _;
    }
