...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.13 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 2000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZG4cSfiTMmoL9jtRj9wWGYm2YbdHY1oGYyJLrMoBdMzP/";

    bool public mintingOpen = true;
    
    
    uint256 public MAX_WALLET_MINTS = 50;
...
contract GoodluckpugNftContract is RamppERC721A {
    constructor() RamppERC721A("Goodluck pug Nft", "GLP"){}
}
