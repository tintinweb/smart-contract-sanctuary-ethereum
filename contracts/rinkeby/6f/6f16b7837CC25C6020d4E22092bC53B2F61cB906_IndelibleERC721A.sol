// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint256 private constant MAX_TOKENS = 2000;
        uint256 private constant NUM_LAYERS = 9;
        uint256 private constant MAX_BATCH_MINT = 20;
        uint256[][NUM_LAYERS] private TIERS;
        string[] private LAYER_NAMES = [unicode"Lasers", unicode"Mouth", unicode"Head", unicode"Face", unicode"Eyes", unicode"Nose", unicode"Shirt", unicode"Skin", unicode"Background"];
        ...
        constructor() ERC721A(unicode"OnChainKevin", unicode"DERP") {
            TIERS[0] = [39,105,150,232,243,273,958];
TIERS[1] = [46,100,106,124,128,143,149,215,468,521];
TIERS[2] = [9,14,23,31,43,54,54,61,64,74,84,95,105,134,143,187,350,475];
TIERS[3] = [3,6,12,14,29,35,64,64,83,88,103,103,105,108,166,224,793];
TIERS[4] = [3,52,119,251,300,386,889];
TIERS[5] = [83,131,358,525,903];
TIERS[6] = [25,26,28,30,45,55,65,67,84,125,154,205,218,260,294,319];
TIERS[7] = [76,888,1036];
TIERS[8] = [27,35,60,124,176,180,206,239,244,317,392];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"OnChainKevin #");

            jsonBytes.appendSafe(
                abi.encodePacked(
                    _toString(_tokenId),
                    unicode"\",\"description\":\"First on-chain Kevin derivative.\","
                )
            );
