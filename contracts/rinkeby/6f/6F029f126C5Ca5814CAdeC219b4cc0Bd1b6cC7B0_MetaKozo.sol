...
contract MetaKozo is ERC721A, Pausable {
    ...
    uint8 public preMaxPerAddress = 5;
    ...
    // Pre Mint
    function preMint(uint256 _quantity, bytes32[] calldata _merkleProof) public payable callerIsUser {
        ...
        require(
            whiteListClaimed[msg.sender] + _quantity <= preMaxPerAddress,
            "Already claimed max"
        );
