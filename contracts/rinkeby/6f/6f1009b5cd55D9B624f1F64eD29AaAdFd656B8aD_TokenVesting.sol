...
contract TokenVesting is ReentrancyGuard, Ownable {
    ...
    function claimVestedTokens() external {
        ...
        require(token.transfer(vestingSchedule.recipient, amountVested), "no tokens");
    ...
    function removeVestingSchedule(uint256 _vestingId) external onlyOwner {
        ...
        require(token.transfer(recipient, amountVested), "transfer failed");
    ...
    function initializeAllocation(uint256 startTime) external onlyOwner {
        ...
        addVestingSchedule(0x6AB0a3F3B01653295c0DC2eCeD5c4EaD099c3f9D, startTime, 5960000 * 10**18, 50, 0);
        addVestingSchedule(0x6AB0a3F3B01653295c0DC2eCeD5c4EaD099c3f9D, startTime, 5960000 * 10**18, 50, 0);
        ...
        addVestingSchedule(0x1856D5e4767737a4051ae61c7852acdF8DFFb27b, startTime, 2980000 * 10**18, 104, 12);
        ...
        addVestingSchedule(0xb9FeCf6dC7F8891721d98825De85516e67922772, startTime, 2980000 * 10**18, 104, 12);
