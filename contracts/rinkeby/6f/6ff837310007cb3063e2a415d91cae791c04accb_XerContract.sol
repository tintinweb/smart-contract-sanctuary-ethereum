...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb494c1bb7b61eb4046EDCf94DEFE8d9a1ED22031];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://exampleContentID/";
...
// File: contracts/XerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract XerContract is RamppERC721A {
    constructor() RamppERC721A("xer", "xertoken"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ivVYEprnyaBdmoxbbb8Y/contract-metadata";
    }
}
