...
contract HimeverseGiftContract is ERC721A, Ownable{
    ...
    mapping(address => bool) internal admin_list;  //address allowed to mint.

    // We are only inheriting ERC721A straight.
    constructor() ERC721A("Himeverse Gift", "HVG"){}
    ...
    // See admin address.
    function seeAdmin(address admin) external view onlyOwner returns(bool) {
        return admin_list[admin];
    }
