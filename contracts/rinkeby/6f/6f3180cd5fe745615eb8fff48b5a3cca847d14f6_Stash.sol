    ...
    ERC721Stashable
{
    ...
    uint256 constant PRICE_PER_TOKEN = 0.025 ether; // TODO
    ...
    function initialize() public initializer {
        __ERC2981_init();
        __ERC721Psi_init("Stash", "Stash"); //TODO
        __Ownable_init();

        signer = address(0xDe1736B2F811a1e43EF92f6A707b198B6C09FAa8);

        _setDefaultRoyalty(msg.sender, 1000); //TODO receiver, feeNumerator (1000 => 10%)
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return "https://tbstash.nftapi.art/meta/";
    }
