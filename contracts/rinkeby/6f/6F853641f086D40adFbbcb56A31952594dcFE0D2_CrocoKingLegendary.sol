...
contract CrocoKingLegendary is ERC721Enumerable, Ownable {
  ...
  uint256 unitPrice = .03 ether;
  uint256 maxPerUser = 3;

  constructor() ERC721("Croco King Legendary", "CKL")  {
  }
  ...
  function mint(address _to, uint _count) public payable {
    ...
    require(totalSupply() + _count + reservedAmount <= MAX_SUPPLY, "> MaxSupply");
