...
contract TheStables is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor(address _openSeaProxyRegistryAddress, uint256 _maxTokens)
        ERC721("TheStables", "STBL")
    {
