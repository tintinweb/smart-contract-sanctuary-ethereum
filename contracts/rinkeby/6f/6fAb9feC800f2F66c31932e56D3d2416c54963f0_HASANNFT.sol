...
// File: stacking-contract/ERC721S.sol
...
// File: stacking-contract/ERC721Enum.sol
...
// File: stacking-contract/erc721.sol
...
contract HASANNFT is ERC721Enum, Ownable, PaymentSplitter, Pausable,  ReentrancyGuard {

	using Strings for uint256;
	string public baseURI;
	 string public baseExtension = ".json";
	uint256 public cost = 0.001 ether;
	uint256 public maxSupply = 63;
	...
	constructor() ERC721S("HASAN NFT", "HNFT") PaymentSplitter( addressList, shareList){
	    setBaseURI("");
	}
