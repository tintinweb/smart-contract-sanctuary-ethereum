...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x98eC2adD4bb92B313ca07DFFdE76c6027Fb049fa];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 21, 5000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZDTi5GA5yJPHPsoPKSiP1FKCun8ipkMoPp8HCHtrkQWC/";
...
// File: contracts/HuskyX3Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HuskyX3Contract is RamppERC721A {
    constructor() RamppERC721A("Husky X3", "HX3"){}
}
