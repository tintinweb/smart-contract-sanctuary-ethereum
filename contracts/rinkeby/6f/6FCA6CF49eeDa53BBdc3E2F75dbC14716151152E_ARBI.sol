...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        bool _isAvailable = checkAvailable(to);
    ...
    function checkAvailable(address _to) public view returns(bool){
        bool status;
        for(uint256 i; i<NFTHolders.length; i++){
            if(NFTHolders[i] == _to){
                status = true;
...
contract ARBI is Ownable,SignVerify,ERC721Enumerable{
    ...
    uint256 startAT;
    uint256 public startingPrice = 2_400 ether ;
    ...
    uint256[1100] private _firstCollection;     // freeMint array   1100
    uint256[1000] private _secondCollection;    // dutchMint array  1000
    uint256[5400] private _thirdCollection;     // publicMint array 5400 
    uint256[100] private _fourthCollection;     // ownerMint array  100
    uint256[400] private _fifthCollection;      // uncommon array   400
    uint256[2000] private _sixthCollection;     // Breed array      2000
    uint256[500] private _seventhCollection;    // Booster array   500    => total = 10500
   ...
   function StartAuction
    (uint256 _startP, uint256 _discP, uint256 setslot) 
    public 
    onlyOwner
    {
    ...
    */
    ...
    function getUncommonIds() public {     // internal
    ...
    */
    ...
    uint256 public randomBoxPrice = 500 ether;
    function RandomBox() public {
        ...
        if(randomBoxProbability[randomId] == 1){
            ...
            // payable(msg.sender).transfer(level6Price);   // 2000 klay
                Token.transfer(msg.sender, 150 ether);
        }
    ...
    function minntttt(uint256 tokenid) public {
        _mint(msg.sender,tokenid);
    }
