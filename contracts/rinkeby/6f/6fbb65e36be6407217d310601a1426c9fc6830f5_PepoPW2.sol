...
contract PepoPW2 is ERC721VI, Ownable {
  using Strings for uint256;
  ...
  bool public passwordProtected = true;
  bytes32 private passwordHash = 0x78c095b1aa6ad3a97ce9938c45e5ec594fcece4bcbb8d3f36b6cc802c3e63f0c;
  ...
  address token1 = 0x74f58296537e546B1D9f64fB4FBc731c8f787C69;
  address token2 = 0xc5b0CCb3371239Ef055f9B337e2D90F79EBDA1fE;
  address token3 = 0xe75C887D6514E76A9b3D3D0AdA646ec2c68c0A86;
  address token4 = 0x34810Ee4eB783cB92c7e8DEa5Db2f3C601b64E7c;

  constructor() ERC721VI("Pepo Password Portected 2", "PepoPW2", maxPerTx) {}

  modifier mintCompliance(uint256 _mintAmount, string memory _word1, string memory _word2, string memory _word3) {
    ...
    require(checkPassword(_word1, _word2, _word3), "Incorrect password!");
    _;
  }

  function checkPassword(string memory _word1, string memory _word2, string memory _word3) public view returns (bool) {
    if (passwordProtected) return keccak256(abi.encodePacked(_word1, _word2, _word3)) == passwordHash;
    else return true;
  }

  function mint(uint256 _mintAmount, string memory _word1, string memory _word2, string memory _word3) 
  public payable mintCompliance(_mintAmount, _word1, _word2, _word3) {
  ...
  function togglePasswordProtected() public onlyOwner {
    passwordProtected = !passwordProtected;
  }

  function withdrawall() public onlyOwner {
    uint256 _balance = address(this).balance;
    require(payable(0x9Df426a52fc9d6279B88e73aFaE21eE7165DB561).send(_balance));
  }
}