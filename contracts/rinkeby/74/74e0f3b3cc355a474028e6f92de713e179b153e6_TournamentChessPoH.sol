...
contract TournamentChessPoH{
    ...
    function registration() public payable{
        ...
        require (!complete, "The tournament is over");
    ...
    function payWinnersBurner (address payable _first, address payable _second, address payable _third) external restricted {
        ...
        complete = true; //end the tournament
    ...
    /** @dev Get status of the tournament.
     *  @return status.
     */
    function getStatus () public view returns (string memory){
        if (!complete) 
            return "The tournament is open, you can register";
        else 
            return "The tournament is closed";
    }
