...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new ZEDXIONUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ZEDXIONUser1155Token token = ZEDXIONUser1155Token(address(addr));
...
contract ZEDXIONUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
