...
contract tinydoggies is Ownable, ERC721, NonblockingReceiver {
    ...
    // mint function
    // you can choose to mint 20 max
    // mint is free, but payments are accepted
    function mint(uint8 numTokens) external payable {
        require(numTokens < 21, "tiny doggies: Max 20 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ETHEREUM,
            "tiny doggies: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "tiny doggies: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "tiny doggies: Failed to withdraw Ether");
    }
