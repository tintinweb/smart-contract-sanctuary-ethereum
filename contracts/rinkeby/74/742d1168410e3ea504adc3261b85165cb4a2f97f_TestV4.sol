    ...
    ERC721BurnableUpgradeable
{
    ...
    event MintBridgeEvent(address owner, string uri, uint256 tokenId);
    event MintAvatarEvent(address owner, string uri, uint256 tokenId);
    event BurnBridgeEvent(address owner, uint256 tokenId);
    ...
    function setNewURI(uint256 tokenId, string memory _hash)
        public
        onlyRole(MINTER_ROLE)
    {
        require(
    ...
    function mintBridge(
        ...
        require(
            verify(owner, uri, tokenId, chainId, _counterBridge, signature),
            "Wrong signature"
        );
    ...
    function burnBridge(uint256 tokenId) public {
        require(
    ...
    function getMessageHash(
        ...
        return
            keccak256(
                abi.encodePacked(to, uri, tokenId, chainId, _counterBridge)
            );
    }
