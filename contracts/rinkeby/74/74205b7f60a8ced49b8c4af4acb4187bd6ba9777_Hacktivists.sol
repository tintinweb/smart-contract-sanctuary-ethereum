...
contract Hacktivists is ERC721A, Ownable{
    ...
    //Whitelist
    uint256 public maxWhiteListTotalSupply = 2;
    uint256 public curWhitelistTotalSupply = 0;

    function resetWhiteListSupply(uint256 newMaxWhiteListTotalSupply) external onlyOwner{
        curWhitelistTotalSupply = 0;
        maxWhiteListTotalSupply = newMaxWhiteListTotalSupply;
    }
    ...
    constructor() ERC721A("Hacktivists", "Hack"){
        baseTokenUri = "https://gateway.pinata.cloud/ipfs/QmVHGMb19L6kFagP8SFJ8Fh1EvZ2LHhLKiXSoYymj6nr4T/0.json";
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require(curWhitelistTotalSupply + _quantity <= maxWhiteListTotalSupply, "Not enough whitelist mints available!");
        //create leaf node
    ...
    function withdraw() external onlyOwner{
        payable(0x4fc6E3f07BD64010e1F763579f886Ee345aBFeF0).transfer(address(this).balance);
    }
}