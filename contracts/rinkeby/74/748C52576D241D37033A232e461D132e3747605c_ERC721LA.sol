 ...
 */
contract ERC721LA is IERC721LA, LAInitializable, AccessControl {
    /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     *                               LIBRARIES
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    function royaltyRegistryAddress() public view returns (address) {
        ERC721LAState storage state = _getERC721LAState();
    ...
    function _transferCore(
        ...
        ERC721LAState storage state = _getERC721LAState();
        (, uint256 tokenIdBatchHead) = _ownerAndBatchHeadOf(
            tokenId
        );
