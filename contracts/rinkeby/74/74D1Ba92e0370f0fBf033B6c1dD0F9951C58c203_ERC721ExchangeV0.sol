...
abstract contract BaseExchange is ReentrancyGuardInitializable, IBaseExchange {
    ...
    function cancel(Orders.Ask memory order) external override {
        require(order.signer == msg.sender || order.proxy == msg.sender, "ODYSSEY: FORBIDDEN");

        bytes32 hash = order.hash();
        require(bestBid[hash].bidder == address(0), "ODYSSEY: BID_EXISTS");
        ...
        returns (bool executed)
    {
        ...
        require(askHash == bidOrder.askHash, "ODYSSEY: UNMATCHED_HASH");
        require(bidOrder.signer != address(0), "ODYSSEY: INVALID_SIGNER");
    ...
    function bid(
        ...
        require(askOrder.proxy == address(0), "ODYSSEY: FORBIDDEN");
    ...
    function _bid(
        ...
        require(canTrade(askOrder.token), "ODYSSEY: INVALID_EXCHANGE");
        require(bidAmount > 0, "ODYSSEY: INVALID_AMOUNT");
        uint256 _amountFilled = amountFilled[askHash];
        require(_amountFilled + bidAmount <= askOrder.amount, "ODYSSEY: SOLD_OUT");
        ...
        if (
            ...
            require(
                ...
                "ODYSSEY: FAILED_TO_TRANSFER_FUNDS"
            );
    ...
    function _validate(Orders.Ask memory askOrder, bytes32 askHash) internal view {
        require(!isCancelledOrClaimed[askHash], "ODYSSEY: CANCELLED_OR_CLAIMED");

        require(askOrder.signer != address(0), "ODYSSEY: INVALID_MAKER");
        require(askOrder.token != address(0), "ODYSSEY: INVALID_NFT");
        require(askOrder.amount > 0, "ODYSSEY: INVALID_AMOUNT");
        require(askOrder.strategy != address(0), "ODYSSEY: INVALID_STRATEGY");
        require(askOrder.currency != address(0), "ODYSSEY: INVALID_CURRENCY");
        require(ITokenFactory(factory()).isStrategyWhitelisted(askOrder.strategy), "ODYSSEY: STRATEGY_NOT_WHITELISTED");
    }
...
abstract contract ReentrancyGuardInitializable is Initializable {
    ...
    modifier nonReentrant() {
        ...
        require(_status != _ENTERED, "ODYSSEY: REENTRANT");
...
library Signature {
    ...
    function verify(
        ...
        if (Address.isContract(signer)) {
            ...
            require(recover(digest, v, r, s) == signer, "ODYSSEY: UNAUTHORIZED");
        }
    }
}
...
contract NFT721V0 is BaseNFT721, BaseExchange, IERC2981, INFT721 {
    ...
    function _setRoyaltyFeeRecipient(address royaltyFeeRecipient) internal {
        require(royaltyFeeRecipient != address(0), "ODYSSEY: INVALID_FEE_RECIPIENT");
    ...
    function _setRoyaltyFee(uint8 royaltyFee) internal {
        if (_royaltyFee == type(uint8).max) {
            require(royaltyFee <= _MAX_ROYALTY_FEE, "ODYSSEY: INVALID_FEE");
        } else {
            require(royaltyFee < _royaltyFee, "ODYSSEY: INVALID_FEE");
        }
...
abstract contract BaseNFT721 is ERC721Initializable, OwnableInitializable, IBaseNFT721 {
    ...
    {
        require(_exists(tokenId) || _parked(tokenId), "ODYSSEY: INVALID_TOKEN_ID");
    ...
    function parkTokenIds(uint256 toTokenId) external override {
        require(owner() == msg.sender || _factory == msg.sender, "ODYSSEY: FORBIDDEN");
    ...
    function burn(
        ...
        require(ownerOf(tokenId) == msg.sender, "ODYSSEY: FORBIDDEN");
    ...
    function permit(
        ...
        require(block.timestamp <= deadline, "ODYSSEY: EXPIRED");

        address owner = ownerOf(tokenId);
        require(owner != address(0), "ODYSSEY: INVALID_TOKENID");
        require(spender != owner, "ODYSSEY: NOT_NECESSARY");
    ...
    function permitAll(
        ...
        require(block.timestamp <= deadline, "ODYSSEY: EXPIRED");
        require(owner != address(0), "ODYSSEY: INVALID_ADDRESS");
        require(spender != owner, "ODYSSEY: NOT_NECESSARY");
...
contract ERC721Initializable is Initializable, ERC165, IERC721, IERC721Metadata {
    ...
    function balanceOf(address owner) public view virtual override returns (uint256) {
        require(owner != address(0), "ODYSSEY: INVALID_OWNER");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ODYSSEY: INVALID_TOKEN_ID");
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(to != owner, "ODYSSEY: INVALID_TO");

        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "ODYSSEY: FORBIDDEN");
    ...
    function transferFrom(
        ...
        //solhint-disable-next-line max-line-length
        require(_isApprovedOrOwner(msg.sender, tokenId), "ODYSSEY: NOT_APPROVED_NOR_OWNER");
    ...
    function safeTransferFrom(
        ...
        require(_isApprovedOrOwner(msg.sender, tokenId), "ODYSSEY: FORBIDDEN");
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
        require(_checkOnERC721Received(from, to, tokenId, _data), "ODYSSEY: INVALID_RECEIVER");
    }
    ...
    function _setApprovalForAll(
        ...
        require(operator != owner, "ODYSSEY: INVALID_OPERATOR");
    ...
    function _parkTokenIds(uint256 toTokenId) internal virtual {
        ...
        require(toTokenId > fromTokenId, "ODYSSEY: INVALID_TO_TOKEN_ID");
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(_checkOnERC721Received(address(0), to, tokenId, _data), "ODYSSEY: INVALID_RECEIVER");
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        require(to != address(0), "ODYSSEY: INVALID_TO");
        require(!_exists(tokenId), "ODYSSEY: ALREADY_MINTED");
    ...
    function _burn(uint256 tokenId) internal virtual {
        address owner = ERC721Initializable.ownerOf(tokenId);
        require(owner != address(0), "ODYSSEY: INVALID_TOKEN_ID");
    ...
    function _transfer(
        ...
        require(ERC721Initializable.ownerOf(tokenId) == from, "ODYSSEY: TRANSFER_FORBIDDEN");
        require(to != address(0), "ODYSSEY: INVALID_RECIPIENT");
    ...
    function _checkOnERC721Received(
        ...
        if (to.isContract()) {
            try IERC721Receiver(to).onERC721Received(msg.sender, from, tokenId, _data) returns (bytes4 retval) {
                ...
                if (reason.length == 0) {
                    revert("ODYSSEY: INVALID_RECEIVER");
                } else {
                    // solhint-disable-next-line no-inline-assembly
                    assembly {
...
abstract contract OwnableInitializable is Initializable, IOwnable {
     ...
     */
    modifier onlyOwner() {
        require(_owner == msg.sender, "ODYSSEY: FORBIDDEN");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual override onlyOwner {
        require(newOwner != address(0), "ODYSSEY: INVALID_NEW_OWNER");
...
contract NFTLockable is OwnableInitializable, INFTLockable {
    ...
    modifier ensureUnlocked(address from) {
        require(msg.sender == owner() || from == owner() || !locked, "ODYSSEY: LOCKED");
        _;
    }

    function setLocked(bool _locked) external override onlyOwner {
        if (_locked) {
            require(!_wasLocked, "ODYSSEY: FORBIDDEN");
            _wasLocked = true;
        }
        locked = _locked;
...
contract NFT1155V2 is NFT1155V1, INFT1155Metadata {
    ...
    function setName(string calldata _name) external override onlyOwner {
        require(bytes(name).length == 0, "ODYSSEY: NAME_ALREADY_SET");
...
contract ERC1155Initializable is Initializable, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        require(account != address(0), "ODYSSEY: INVALID_ADDRESS");
    ...
    {
        require(accounts.length == ids.length, "ODYSSEY: LENGTHS_NOT_EQUAL");
    ...
    function safeTransferFrom(
        ...
        require(to != address(0), "ODYSSEY: INVALID_ADDRESS");
        require(from == msg.sender || isApprovedForAll(from, msg.sender), "ODYSSEY: FORBIDDEN");
    ...
    function _transfer(
        ...
        require(fromBalance >= amount, "ODYSSEY: INSUFFICIENT_BALANCE");
    ...
    function safeBatchTransferFrom(
        ...
        require(ids.length == amounts.length, "ODYSSEY: LENGTHS_NOT_EQUAL");
        require(to != address(0), "ODYSSEY: INVALID_ADDRESS");
        require(from == msg.sender || isApprovedForAll(from, msg.sender), "ODYSSEY: FORBIDDEN");
    ...
    function _setApprovalForAll(
        ...
        require(account != operator, "ODYSSEY: NOT_ALLOWED");
    ...
    function _burn(
        ...
        require(accountBalance >= amount, "ODYSSEY: INSUFFICIENT_BALANCE");
...
abstract contract DividendPayingERC20 is ERC20Initializable, IDividendPayingERC20 {
    ...
    receive() external payable {
        if (msg.value > 0) {
            require(dividendToken == TokenHelper.ETH, "ODYSSEY: UNABLE_TO_RECEIVE_ETH");
            sync();
        }
    }
    ...
    function sync() public payable override returns (uint256 increased) {
        ...
        require(_totalSupply > 0, "ODYSSEY: NO_SUPPLY");

        uint256 balance = dividendToken.balanceOf(address(this));
        increased = balance - totalDividend;
        require(increased > 0, "ODYSSEY: INSUFFICIENT_AMOUNT");
...
contract ERC20Initializable is Initializable, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "ODYSSEY: INSUFFICIENT_ALLOWANCE");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "ODYSSEY: ALLOWANCE_UNDERFLOW");
    ...
    function _transfer(
        ...
        require(sender != address(0), "ODYSSEY: INVALID_SENDER");
        require(recipient != address(0), "ODYSSEY: INVALID_RECIPIENT");

        _beforeTokenTransfer(sender, recipient, amount);

        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount, "ODYSSEY: INSUFFICIENT_BALANCE");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "ODYSSEY: INVALID_ACCOUNT");
    ...
    function _approve(
        ...
        require(owner != address(0), "ODYSSEY: INVALID_OWNER");
        require(spender != address(0), "ODYSSEY: INVALID_SPENDER");
...
library TokenHelper {
    ...
    function safeTransfer(
        ...
        if (token == ETH) {
            ...
            require(success, "ODYSSEY: TRANSFER_FAILURE");
        } else {
...
contract TokenFactory is ProxyFactory, Ownable, ITokenFactory {
    ...
    modifier onlyDeployer {
        require(isDeployerWhitelisted[address(0)] || isDeployerWhitelisted[msg.sender], "ODYSSEY: FORBIDDEN");
        _;
    }
    ...
    function setProtocolFeeRecipient(address protocolFeeRecipient) external override onlyOwner {
        require(protocolFeeRecipient != address(0), "ODYSSEY: INVALID_FEE_RECIPIENT");
    ...
    function setOperationalFeeRecipient(address operationalFeeRecipient) external override onlyOwner {
        require(operationalFeeRecipient != address(0), "ODYSSEY: INVALID_RECIPIENT");
    ...
    function setOperationalFee(uint8 operationalFee) external override onlyOwner {
        require(operationalFee <= MAX_OPERATIONAL_FEE, "ODYSSEY: INVALID_FEE");
    ...
    function setStrategyWhitelisted(address strategy, bool whitelisted) external override onlyOwner {
        require(strategy != address(0), "ODYSSEY: INVALID_ADDRESS");
    ...
    function deployNFT721AndMintBatch(
        ...
        require(bytes(name).length > 0, "ODYSSEY: INVALID_NAME");
        require(bytes(symbol).length > 0, "ODYSSEY: INVALID_SYMBOL");
        require(owner != address(0), "ODYSSEY: INVALID_ADDRESS");
    ...
    function deployNFT1155AndMintBatch(
        ...
        require(owner != address(0), "ODYSSEY: INVALID_ADDRESS");
        require(tokenIds.length == amounts.length, "ODYSSEY: LENGTHS_NOT_EQUAL");
        nft = _createProxy(
...
contract ProxyFactory {
    function _createProxy(address target, bytes memory initData) internal returns (address proxy) {
        ...
        if (initData.length > 0) {
            ...
            require(success, "ODYSSEY: CALL_FAILURE");
        }
    }
...
contract PaymentSplitter is Initializable, IPaymentSplitter {
    ...
    function initialize(
        ...
        require(_payees.length == _shares.length, "ODYSSEY: LENGTHS_NOT_EQUAL");
        require(_payees.length > 0, "ODYSSEY: LENGTH_TOO_SHORT");
    ...
    function _addPayee(address account, uint256 _shares) private {
        require(account != address(0), "ODYSSEY: INVALID_ADDRESS");
        require(_shares > 0, "ODYSSEY: INVALID_SHARES");
        require(shares[account] == 0, "ODYSSEY: ALREADY_ADDED");
...
contract FixedPriceSale is IStrategy {
    function canClaim(
        ...
        require(price > 0, "ODYSSEY: INVALID_PRICE");
        require(startedAt < deadline, "ODYSSEY: INVALID_STARTED_AT");
...
contract EnglishAuction is IStrategy {
    function canClaim(
        ...
        if (proxy == address(0)) {
            ...
            require(startPrice > 0, "ODYSSEY: INVALID_START_PRICE");
            require(startedAt < deadline, "ODYSSEY: INVALID_STARTED_AT");
...
contract DutchAuction is IStrategy {
    function canClaim(
        ...
        require(startPrice > endPrice, "ODYSSEY: INVALID_PRICE_RANGE");
        require(startedAt < deadline, "ODYSSEY: INVALID_STARTED_AT");
