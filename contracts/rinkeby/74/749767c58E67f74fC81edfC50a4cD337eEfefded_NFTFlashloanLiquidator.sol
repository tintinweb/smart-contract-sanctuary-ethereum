...
abstract contract ParaspaceAdaptor is LiquidatorBase, IERC1271 {
  /**
...
// File contracts/nftSellAdaptors/CryptoPunkAdaptor.sol
  ...
  CryptoPunkAdaptor
{
  ...
  /**
   * @dev use CryptoPunksMarket contract to flashloan liquidate WPUNKS
   */
  function liquidateCryptoPunks(LiquidateCryptoPunksParams calldata params)
    public
    onlyExecutor
  {
    bytes memory _paramsBytes = abi.encode(MarketType.CRYPTOPUNKS, params);
    _flashLoanAndExecute(
      params.liquidateParams,
      params.flashLoanParams,
      _paramsBytes
  ...
  function _executeOperationForCryptoPunks(
    ...
    super.acceptBidForPunk(params.liquidateParams.collateralAsset, params.bid);
    console.log("CryptoPunks acceptBidForPunk");
