...
contract BearXNFTStaking is OwnableUpgradeable {
    ...
    function initialize() public initializer{
        ...
        BearXNFTAddress = 0x232044105e9F530aD568ddBCd597f87BdB4c7Cf3;
        ROOTxTokenAddress = 0x67983CdAc9d990Dd7F096896bDeb5B572285eAFF;
        SROOTxTokenAddress = 0xD53cE773891085bB5A17ba811EA6b25d935144C6;
        totalStakes = 0; 
    ...
    function claimOf(address _addr) public returns (uint256, uint256, uint256 )
    {
        ...
        if (sumofgenesisbear >= 5) {
            ...
            if (flag && stakes[_addr].length != 0) {
                RootX_Store = RootX_Store.add(10*10**18);
