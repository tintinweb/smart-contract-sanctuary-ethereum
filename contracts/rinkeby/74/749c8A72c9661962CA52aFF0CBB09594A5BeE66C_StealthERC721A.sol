...
contract StealthERC721A is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant maxFreeMint = 6;
    uint256 public constant totalFreeMint = 5;
    string private _tokenBaseURI;
    address private constant admin = 0x8e5B61EB5AE0D8746f0E790c8646EDefA914049B;    
    bool public paused = true;
    mapping(address => uint256) public mintedOwnerQuantity;

  constructor() ERC721A("TestNNNN 001", "T01") {}
