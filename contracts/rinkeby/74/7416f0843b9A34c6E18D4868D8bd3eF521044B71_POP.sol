...
contract POP is ERC721, Ownable, ReentrancyGuard {
  ...
  address public constant xLili      = 0x1E6092FEdF02415DEBb09199713Aade3981e8C05;
  address public constant xRiogerz = 0xa54d079D79576Ca00a7b1dc877E9367690e33479;
  address public constant xAisa    = 0xf2B0F07D22046d085bf0F4FE31269680A5AbbBeF;
  address public constant xCmondeja    = 0x5cC062989bA04ba2E136259eb836C0B69590D436;
  address public constant xCheily    = 0xb7d0E822E82d6A6fF1080F332f0fCe0aE84e6840;
  address public constant xAnna    = 0x901d2CfCB44B865Db8D6d4457BBb4Bf39f36a0bb;
    ...
    nonReentrant
  {
    ...
    uint Lili = total * 3 / 100;
    uint Aisa = total * 3 / 100;
    uint Cmondeja = total * 3 / 100;
    uint Cheily = total * 3 / 100;
    uint Anna = total * 3 / 100;
    Address.sendValue(payable(xLili), Lili);
    Address.sendValue(payable(xAisa), Aisa);
    Address.sendValue(payable(xCmondeja), Cmondeja);
    Address.sendValue(payable(xCheily), Cheily);
