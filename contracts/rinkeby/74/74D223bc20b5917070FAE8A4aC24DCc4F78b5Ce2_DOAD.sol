...
contract DOAD is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public MAX_ELEMENTS = 6969;
    ...
    uint256 public HIDE_TO = 6969;
    string public sampleTokenURI;

    address public constant creatorAddress =
        0x15695C8882c08f58Aad4154da990430C6d010eb1;
    ...
    constructor(string memory baseURI) ERC721("DoadNFT", "DOAD") {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _tokenAmount) public payable saleIsOpen {
        ...
        require(_tokenAmount <= 3, "User cannot mint more than 5 NFT");
