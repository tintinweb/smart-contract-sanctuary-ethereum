...
//*********************************************************************//
//
// NFT Poker Club - VIP Pass Collection
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeD9E96fa9f265a69a29B7A968641dCAc878F1667,0x25062A2C0d1D6e66D44BD92099C92D3bC083e5bF,0xE30600AF4e194bA44F4789CDd7ae6F232339B471];
  uint256[] public payableFees = [5,80,5,10];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmXdhi4m3ERMXcZaG971zZYZxd449VyDiAhar6fGts3gNS/";
...
// File: contracts/NftPokerClubVipPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftPokerClubVipPassContract is RamppERC721A {
    constructor() RamppERC721A("NFT Poker Club  VIP Pass", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Fnn7tpz5T90DVouOZ1x6/contract-metadata";
    }
}
