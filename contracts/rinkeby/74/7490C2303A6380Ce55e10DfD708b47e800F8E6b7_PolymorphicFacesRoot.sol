...
import "../base/PolymorphV2/IPolymorphRoot.sol";
    ...
    IPolymorphicFacesRoot
{
    ...
    IPolymorphRoot public polymorphV2Contract;
        ...
        )
    {
        ...
        polymorphV2Contract = IPolymorphRoot(params._polymorphV2Address);
    ...
    function mint(uint256[] memory tokenIds) external virtual nonReentrant {
        ...
        require(tokenIds.length <= 20, "Can't claim more than 20 faces in one tx");
    ...
    function setPolyV2Address(address newPolyV2Address) external onlyDAO {
        polymorphV2Contract = IPolymorphRoot(newPolyV2Address);
...
interface IPolymorphRoot is IERC721 {
    ...
    function burnCount(address userAddres) external returns(uint256);
}
    ...
    TunnelEnabled
{
    ...
    uint256 constant private TOTAL_ATTRIBUTES = 13;
