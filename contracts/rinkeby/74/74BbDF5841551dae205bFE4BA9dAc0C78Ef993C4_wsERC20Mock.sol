...
contract ERC20Mock is ERC20 {
    ...
    constructor(
        ...
        decimals_ = _decimals;
        _mint(_initialAddress, _initialAmount);
    }
...
// mock class using ERC20
contract wsERC20Mock is ERC20Mock, IwsTT {
    ...
    ) payable ERC20Mock(name, symbol, _decimals, msg.sender, initialAmount) {
        index = 1e9;
    ...
    function unwrap(uint _amount) external returns ( uint ) {
        ...
        stakedToken.safeTransfer(msg.sender, value);
        return value;
    }
    ...
    function wOHMTosOHM(uint _amount ) public view returns ( uint ) {
        return (_amount * index * 10**9) / (10 ** decimals());
    }
    ...
    function sOHMTowOHM( uint _amount ) public view returns ( uint ) {
        return ((_amount * 10**decimals()) / index) * 10**9;
    }
}