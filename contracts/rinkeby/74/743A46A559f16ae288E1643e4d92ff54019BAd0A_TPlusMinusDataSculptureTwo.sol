...
/// @title: T+/- Data Sculpture #2 by Refik Anadol
/// @author: manifold.xyz
...
contract TPlusMinusDataSculptureTwo is Proxy {
    uint16 constant GROUP_0_SIZE = 100;
    uint16 constant GROUP_1_SIZE = 350;
    uint16 constant GROUP_PADDING = 20;
    ...
    constructor(address creator, address signingAddress) {
        ...
        Address.functionDelegateCall(
            ...
            abi.encodeWithSignature("initialize(address,uint16,uint256,uint16,uint16,uint256,uint16,address,bool)",
              creator,
              GROUP_0_SIZE + GROUP_1_SIZE + GROUP_PADDING, // purchaseMax aka totalSupply
              10000000000000000000000000000000,            // purchasePrice
              1,                                           // purchaseLimit
              1,                                           // transactionLimit
              10000000000000000,                           // presalePurchasePrice
