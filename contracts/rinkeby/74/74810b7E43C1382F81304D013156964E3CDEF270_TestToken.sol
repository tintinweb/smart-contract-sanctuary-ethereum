...
contract TestToken is ERC20, AccessControl {
    ...
    function setupMintRole(address mint) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _grantRole(MINT_ROLE, mint);
    }

    function mint(address _to, uint256 _amount) public onlyRole(MINT_ROLE) {
