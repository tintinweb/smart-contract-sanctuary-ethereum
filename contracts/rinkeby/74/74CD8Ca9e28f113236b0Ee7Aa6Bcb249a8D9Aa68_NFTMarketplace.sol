...
error NFTMarketplace__TransferFaied();
...
contract NFTMarketplace is ReentrancyGuard {
    ...
    // mapping of nftAddress => tokenId => Listing
    mapping(address => mapping(uint256 => Listing)) private s_listings;

    // mapping of seller to proceeds from listings
    ...
    function withdrawProceeds() external {
        ...
        if (!success) revert NFTMarketplace__TransferFaied();
    }
