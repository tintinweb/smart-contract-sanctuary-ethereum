...
// File: contracts/ChunkyChimpers.sol
...
contract ChunkyChimpers is ERC721A, ReentrancyGuard, Ownable {
    string private baseURI;
    uint256 public maxSupply = 3333;
    uint256 private presalePrice = 0.004 ether;
    uint256 private publicPrice = 0.004 ether;
    ...
    constructor() ERC721A("ChunkyChimpers", "ChunkyChimpers") {}
    ...
    function mint(uint256 amount) public payable nonReentrant {
        ...
        if (NFTcount < 666) {
            require(mintOG[sender] + amount <= 20, "Max 20 NFT per wallet during mint");
            mintOG[sender] += amount;
            _safeMint(sender, amount);
        } else if (666 <= NFTcount && NFTcount < 3333) {
            require(
                NFTcount + amount <= maxSupply - reserved,
    ...
    address private payoutAddress = 0x9d68fCb5514e5d760De141D2B57F7B2Ba80F34f6;
