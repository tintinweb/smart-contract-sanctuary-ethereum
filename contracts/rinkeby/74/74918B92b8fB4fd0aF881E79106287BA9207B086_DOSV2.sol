...
// File: contracts/DOSV2.sol

pragma solidity ^0.8.0;

contract DOSV2 is ERC721, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        require(walletCap[msg.sender] + numberOfTokens <= maxPerWallet, "Purchase would exceed max number of NFTs per wallet.");
