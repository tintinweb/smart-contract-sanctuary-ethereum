...
contract TokenCutter is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory tokenName, string memory tokenSymbol, uint256 initialSupply, address owner, address reflectionToken
        ...
        swapThreshold = initialSupply * 1 / 1000;
        ...
        totalFee = devFee.add(reflectionFee);
        totalFeeIfSelling = devFeeOnSell.add(reflectionFeeOnSell);         

        require(totalFee <= 12, "Too high fee");
        require(totalFeeIfSelling <= 15, "Too high fee");

        tokenOwner = owner;
        devWallet = payable(0xaEf67eF59845129e072E551D2A94BCc4F3402C93);
    ...
    function launch() external onlyFactory {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 960 hours;
        tradingStatus = true;
    ...
    function setDevAddress(address payable newDevWallet) external onlyOwner {
