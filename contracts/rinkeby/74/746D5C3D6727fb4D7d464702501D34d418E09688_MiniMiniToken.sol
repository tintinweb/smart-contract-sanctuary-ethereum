...
contract MiniMiniToken is Context, AccessControlEnumerable, ERC721Tradeable {
  using SafeMath for uint256;
  using Counters for Counters.Counter;

  constructor(address _proxyRegistryAddress) ERC721Tradeable("MiniMiniToken", "MMMP", _proxyRegistryAddress) {
  }
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://bafybeigdkckwr2hlpuxii3nscrdmfomtfttgejfbxzsrmo7fb375eqylfi.ipfs.nftstorage.link/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://bafybeib64hlimwcshtfvlk35mbcd2quktw3a64duporicshkrbfu32zujm.ipfs.nftstorage.link/ipfs/bafybeib64hlimwcshtfvlk35mbcd2quktw3a64duporicshkrbfu32zujm/contract-metadata.json";
    }
}
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  uint256 internal constant MAX_SUPPLY = 1237;
  uint256 internal constant MAX_PER_TX = 5;
  uint256 internal constant MAX_PER_WALLET = 50;
