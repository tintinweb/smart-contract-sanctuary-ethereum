...
contract JurasickPets is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint64 constant limitAge2 = 600; // Test
    uint64 constant limitAge3 = 1200; // Test
    uint64 constant limitAge4 = 1800; // Test
    uint64 constant limitAge5 = 2400; // Test 10 min par stage
    // uint64 constant limitAge2 = 259200; // Prod : 3j = 3 * 24 * 60 * 60 = 259_200
    // uint64 constant limitAge3 = 2851200; // Prod : 3 j+ 30j = 259_200 + 30 * 24 * 60 * 60 = 259_200 + 2_592_000 = 2_851_200
    ...
    function checkWL(
        ...
        // console.log("Address recovered :", recovered, wlSigner);
