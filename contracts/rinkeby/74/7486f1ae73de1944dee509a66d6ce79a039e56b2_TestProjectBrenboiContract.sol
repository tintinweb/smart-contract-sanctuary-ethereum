...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x992654Bfc53576Eed8926f3eBD284c89baEA8c91];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXToNhQnEpjLppkFBUFxUvxW6uaSk7gKD5JEXpduHK3Qd/";
...
// File: contracts/TestProjectBrenboiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestProjectBrenboiContract is RamppERC721A {
    constructor() RamppERC721A("Test Project Brenboi", "BRENBOI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/UtA5DFn4LqS5HIYUUdHs/contract-metadata";
    }
}
