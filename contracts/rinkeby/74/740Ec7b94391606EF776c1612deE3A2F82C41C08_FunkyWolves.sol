...
//-----------------------
//> transaction hash:    0x25908a54d4f5cfd29d4d5b57e6d5120e2ac6929df2e76522b61cd36450463455
//> Blocks: 1            Seconds: 17
//> contract address:    0x740Ec7b94391606EF776c1612deE3A2F82C41C08
//> block number:        10459377
//> block timestamp:     1649282170
//> account:             0x5C308eD4B4349A05fc71D93647Fff3874D4AB70f
//> balance:             1.088261069047807527
//> gas used:            5148018 (0x4e8d72)
//> gas price:           1.000000028 gwei
//> value sent:          0 ETH
//> total cost:          0.005148018144144504 ETH
//
//Pausing for 2 confirmations...
//
//-------------------------------
//> confirmation number: 1 (block: 10459378)
//> confirmation number: 2 (block: 10459379)
//> Saving artifacts
//-------------------------------------
//> Total cost:     0.005148018144144504 ETH
//
...
//=======
//> Total deployments:   1
//> Final cost:          0.005148018144144504 ETH
...
contract FunkyWolves is ERC721A, Ownable, PaymentSplitter {
    ...
    address public vipPass = 0xe76c4cDC426E2f3ae529F2Ae710f4b82dE1F7A81; //replace with pass address (or set via setter?)
    ...
    function mintWolves(uint _mintAmount) public payable {
        ...
        require(balanceOf(msg.sender) + _mintAmount <= saleConfig.maxTokensPerAddress, "Max tokens per address exceeded");
    ...
    function redeemPass(uint _passId) public {
        require(saleConfig.state != 0, "Sale is not active");
        require(IERC721(vipPass).ownerOf(_passId) == msg.sender, "Pass owners only");
