...
contract SolidGuardManager is Initializable, OwnableUpgradeable {
     ...
     */
    function initialize() public initializer returns (bool success) {
        __Ownable_init();
    }
     ...
     */
    function deposit(address[] memory dApps, uint[] memory pauses) external payable returns (bool success) {
