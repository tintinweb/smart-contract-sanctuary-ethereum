...
contract TheMintersCash is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  constructor() 
    ERC721("The Minters", "MINTERS")
    RandomlyAssigned(1000,1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
