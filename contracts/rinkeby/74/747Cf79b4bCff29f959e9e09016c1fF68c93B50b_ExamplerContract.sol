...
//*********************************************************************//
//
// 888888 Yb  dP    db    8b    d8 88""Yb 88     888888 88""Yb 
// 88__    YbdP    dPYb   88b  d88 88__dP 88     88__   88__dP 
// 88""    dPYb   dP__Yb  88YbdP88 88"""  88  .o 88""   88"Yb  
// 888888 dP  Yb dP""""Yb 88 YY 88 88     88ood8 888888 88  Yb
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xED2557d43c04abB74A4B37554a3389a7E13A7b2D];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 5000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSihKpEmFvHuhJavtPD7y1pD1ZNvXBjwtVNFiH4LJijbG/";
...
// File: contracts/ExamplerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ExamplerContract is RamppERC721A {
    constructor() RamppERC721A("exampler", "exam"){}
}
