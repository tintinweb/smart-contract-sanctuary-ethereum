...
contract Harakai is ERC721A, Ownable {
    ...
    uint8 private constant _boughtAlAmount = 30;
    ...
    mapping(address => bool) private boughtAl;

    constructor() ERC721A("Harakai", "HRKI") {
        _baseURIextended; // instant Reveal
        ...
        callerIsUser
    {
        ...
        if (ts + 1 > maxSupply - _boughtAlAmount)
