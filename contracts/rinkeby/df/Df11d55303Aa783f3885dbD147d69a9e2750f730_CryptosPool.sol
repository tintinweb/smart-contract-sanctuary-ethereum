...
import "contracts/interfaces/ICryptosVault.sol";
...
contract CryptosPool is Ownable, Pausable {
    ...
    //block last compounded interest was yielded.
    ...
    /**
     * @notice Set Last Compound Block
     * @dev Only callable by the Vault Contract 
     */

    function setLastCompoundBlock(uint256 _lastCompoundBlock) external onlyVault {
        lastCompoundBlock = _lastCompoundBlock;
        emit NewCompoundBlock(lastCompoundBlock);
    }

    function getLastCompoundBlock() external view onlyVault returns (uint256) {
        return lastCompoundBlock;
    }
   ...
   /**
    ...
    /**
     * @notice Withdraw all funds from the Cryptos Pool.
     */
