...
contract ERC1155Wrapper is INFTWrapper {
   ...
   *
   * @param from - Address of the current owner of the NFT
  ...
  function transferNFT(
    ...
    // Warning:
    // Since we permit ERC1155s in their entirety, the given tokenId may represent a fungible token (amount > 1),
