...
contract OxLoot is ERC721A, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="Yellow" /><text x="10" y="20" class="base">';
    ...
    function paidMint(uint256 quantity) external payable {
        ...
        require(quantity <= maxFreePerTransaction, "max 5 per transaction");
        require(msg.value > cost * quantity, "0.01 per");
    ...
    uint256 maxBatchSize_,
    uint256 collectionSize_
    ) ERC721A("OxLoot", "OXLOOT", maxBatchSize_, collectionSize_) {
