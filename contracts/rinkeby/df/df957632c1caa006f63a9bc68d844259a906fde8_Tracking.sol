...
contract Tracking is ERC721URIStorage {
    ...
    event RegisterTrackingSent(address addressWallet, uint256 tokenId, uint256 timestmap);
    event RegisterTrackingOpen(address addressWallet, uint256 tokenId, uint256 timestmap);
    event RegisterTrackingRead(address addressWallet, uint256 tokenId, uint256 timestmap);
    event RegisterTrackingFinished(address addressWallet, uint256 tokenId, uint256 timestmap);
    ...
    function mint(address walletAdrress, string memory _urlMetaData) payable public returns(uint256) {
        ...
        emit RegisterTrackingOpen(walletAdrress, id, block.timestamp);
