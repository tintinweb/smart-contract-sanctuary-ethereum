...
contract RedManAlert is ERC721, Ownable {
    ...
    // SECONDS IN 72 hours
    uint256 public constant PRICE_CHANGE_TIMEOUT = 259200;

    // Date of release; 
    uint public releaseTimestamp = 1644699600; 
    ...
    uint256 public constant presalePrice = 200000000000000000;
    ...
    constructor()ERC721("RedManAlert", "RMA"){
    ...
    function getCurrentPrice() public view returns (uint256) {
         if(preSaleActive && block.timestamp < 300){
           return presalePrice;
         }else{
           return tokenPrice;
         }
    ...
    function buyTokensOnPresale(uint256 tokensNumber, bytes calldata signature) public payable {
      ...
      require(_mintedTokens[msg.sender].add(tokensNumber) <= 100, 'You cannot purchase more then 100 tokens on Presale');
