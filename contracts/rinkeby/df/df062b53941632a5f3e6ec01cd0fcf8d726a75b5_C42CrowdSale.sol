...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    uint256 public whitelist_ends = 1657809766;
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        require((block.timestamp>whitelist_ends || whitelist[beneficiary]), "You are not on the white list which is required at this time");
