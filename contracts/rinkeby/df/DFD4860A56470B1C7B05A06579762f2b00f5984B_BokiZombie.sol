...
// File: contracts/BokiZombieTest.sol
...
contract BokiZombie is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 amount) external payable{
    ...
    bool isFree = ((totalSupply() + amount < totalFree + 1) && (_mintedFreeAmount[msg.sender] + amount <= maxFreePerWallet));
