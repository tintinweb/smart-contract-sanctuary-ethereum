...
contract NotInVain is ERC721, Ownable, ERC721Burnable, ERC2981 {
    ...
    constructor(uint96 _royaltyFeesInBips, string memory _URI, address _royalty, address _fee) ERC721("It was not in Vain", "VAIN") {
    ...
    function mint() external payable {
        ...
        require(msg.value >= tokenPrice, "Insufficient value");
    ...
    function distribute(address to, uint256 _amount) external onlyOwner {
        require(!pause, "Contract Paused");
    ...
    function withdraw() external onlyOwner {
        ...
        (bool success, ) = payable(fee).call{value: withdrawAmount_5}("");
