...
import "./TIMEAccessControl.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/utils/Address.sol";
import "@openzeppelin/contracts/security/Pausable.sol";

contract TIMEERC721test is Ownable, ERC721A, Pausable, TIMEAccessControl, ReentrancyGuard {
    // Type Declarations
    // Variables
...
abstract contract TIMEAccessControl {
    struct RoleData {
    ...
    // Events
    event RoleAdminChanged(bytes32 indexed role, bytes32 previousAdminRole, bytes32 adminRole);
    event RoleGranted(bytes32 indexed role, address account, address byAccount);
    event RoleRevoked(bytes32 indexed role, address account, address byAccount);
