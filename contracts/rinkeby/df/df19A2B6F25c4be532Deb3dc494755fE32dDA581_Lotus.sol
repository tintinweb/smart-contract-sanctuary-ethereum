...
contract Lotus is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint16 public constant MAX_SUPPLY = 2500;
    uint8 public immutable erc20Decimals;
    uint16 private _reserved = 500;
    ...
    constructor(
        ...
        erc20PerToken = _erc20PerToken * (10**erc20Decimals);
        currentSaleState = SalesConfig.NOT_YET;

        // mint reserve to the treasury
        _safeMint(_treasuryAddress, _reserved);
    }
    ...
    function withdrawMoney() external onlyOwner nonReentrant {
        (bool txState, ) = msg.sender.call{value: address(this).balance}("");
        require(txState, "Something went wrong.");
    }
}
