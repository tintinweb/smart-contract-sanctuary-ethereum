...
contract gfds is ERC721A, Ownable {
	constructor() ERC721A("sdfg", "sdfg") {}
    ...
    function makingobblin(uint256 tittles) external payable {
        bool nugobblens = howmanygobblins[msg.sender] < 1;
        require(byebye);
        require(tittles < 16);
        require(totalSupply() + tittles < gobtits);
        require(msg.sender == tx.origin);
    	require(nugobblens || msg.value == 0.0069 ether * tittles);
        if(nugobblens) howmanygobblins[msg.sender] += 1;
