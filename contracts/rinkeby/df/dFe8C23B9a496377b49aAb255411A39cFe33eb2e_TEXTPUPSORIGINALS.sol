...
contract TEXTPUPSORIGINALS is ERC721, Ownable {
  using Strings for uint256;
  ...
  function royaltyInfo(uint256 _price) external view returns (address receiver, uint256 royaltyAmount) {
