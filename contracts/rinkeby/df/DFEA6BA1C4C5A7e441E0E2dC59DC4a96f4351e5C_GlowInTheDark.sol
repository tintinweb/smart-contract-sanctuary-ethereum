...
// Includes all relevant special data and rendering? for the glow in the dark watchface.
// contains color data.
// contains the special mood and glasses.
// passes over color data to main renderer for bezel and face / css var generation.
