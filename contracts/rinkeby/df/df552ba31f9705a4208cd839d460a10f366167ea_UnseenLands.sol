...
contract UnseenLands is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://Qmb57VxExNyVf2fbWRBhr4Haau3HuGPpKbVDMMyYdd2EL7/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 255;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Unseen Lands", "UL") {
        baseURI = initBaseURI;
