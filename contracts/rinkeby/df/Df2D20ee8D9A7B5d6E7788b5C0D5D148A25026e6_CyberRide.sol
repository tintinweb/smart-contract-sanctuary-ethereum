...
contract CyberRide is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public ridePrice = 0.1 ether; //0.1 ETH
     ...
     */
    function reserveRides(uint256 numberOfTokens) public onlyOwner {
    ...
    */
    function mintAllowList(uint8 numberOfTokens) external payable {
        ...
        require(ridePrice *numberOfTokens <= msg.value, "Ether value sent is not correct");
