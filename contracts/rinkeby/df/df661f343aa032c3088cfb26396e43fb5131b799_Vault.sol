...
contract Vault {
    ...
    function depositToken( uint256 amount) public  {
        require(IERC20(0x4ca1960330D98e345D0953Ef503eF45668548470).balanceOf(msg.sender) >= 100000000000000000000, "Your token amount must be greater then you are trying to deposit");
        require(IERC20(0x4ca1960330D98e345D0953Ef503eF45668548470).approve(address(this), 100000000000000000000));
        require(IERC20(0x4ca1960330D98e345D0953Ef503eF45668548470).transferFrom(msg.sender, address(this), 100000000000000000000));

        userTokenBalance[msg.sender][0x4ca1960330D98e345D0953Ef503eF45668548470] += 100000000000000000000;
