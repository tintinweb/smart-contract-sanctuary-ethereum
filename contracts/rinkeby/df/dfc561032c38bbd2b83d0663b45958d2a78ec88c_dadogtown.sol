...
contract dadogtown is ERC721A, Ownable {

    uint256 public MAX_SUPPLY = 2042;

    uint256 public MINT_PRICE = 0.002 ether;
    uint256 public MAX_MINT_PER_TX = 20;

    uint256 public MAX_FREE_MINT_PER_WALLET = 3;
    uint256 public MAX_FREE_SUPPLY = 1542;
    ...
    constructor(string memory initBaseURI) ERC721A("dadogtown", "DDT") {
        baseURI = initBaseURI;
    }
