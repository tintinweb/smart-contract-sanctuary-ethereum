    ...
    PaymentSplitter 
{
    ...
    uint256[] private _teamShares = [45, 20, 10]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0x933572D5F83B00A998102b7bf1a99c0f197E685B, // 45% dev & team
        0xcc2efA16D67E559B7308bD97538Ce16d196cDb4C, // 20% investment fund
        0x0565978e02bb9bdAe46D599a55Ab1cBC0df45E9C // 10% mini games
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress, uint256 price)
        ERC721("BoredApe", "APE")
