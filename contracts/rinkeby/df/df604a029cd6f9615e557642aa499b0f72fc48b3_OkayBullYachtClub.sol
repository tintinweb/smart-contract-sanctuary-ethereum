...
contract OkayBullYachtClub is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 4550;
  uint256 public maxMintAmountTX = 2;
  ...
  ) ERC721A("Okay Bull Yacht Club", "OBYC") {
 ...
 function setmaxMintAmountTX(uint256 _newmaxMintAmount) public onlyOwner {
    maxMintAmountTX = _newmaxMintAmount;
  }
