...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xbAa55168bF56f1C404fa2C6e5959F2662f010aB0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSZ7CnbDhnSyQ2K67QVkUYfQpHhXkANdVcLBFDRhPdZHM/";
...
// File: contracts/MintingPracticalContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MintingPracticalContract is RamppERC721A {
    constructor() RamppERC721A("Minting Practical", "MP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/RH6EeIjjn4GlY2TP26t2/contract-metadata";
    }
}
