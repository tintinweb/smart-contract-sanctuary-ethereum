...
contract KidNextDoor is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmaU2HpikaMr7TjDuX5cAhL48BZGVJyCG4NrkgYzNjWHjm/";
    ...
    constructor(string memory initBaseURI) ERC721A("Kid Next Door", "KD") {
        baseURI = initBaseURI;
