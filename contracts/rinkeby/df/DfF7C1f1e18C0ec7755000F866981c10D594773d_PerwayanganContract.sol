...
//    / | / /__ _      __   / / / /___ _/ /_  (_) /_____ _/ /______
//   /  |/ / _ \ | /| / /  / /_/ / __ `/ __ \/ / __/ __ `/ __/ ___/
//  / /|  /  __/ |/ |/ /  / __  / /_/ / /_/ / / /_/ /_/ / /_(__  ) 
// /_/ |_/\___/|__/|__/  /_/ /_/\__,_/_.___/_/\__/\__,_/\__/____/  
//                                                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9Ab6c76362cf5bD58f4EBeA36553BB416D6a899b];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmb13eEGC5hLShhLeeuC2NqfSkrw1NVQgvGpFuNwFGh7kj/";
...
// File: contracts/PerwayanganContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PerwayanganContract is RamppERC721A {
    constructor() RamppERC721A("Perwayangan", "crz"){}
}
