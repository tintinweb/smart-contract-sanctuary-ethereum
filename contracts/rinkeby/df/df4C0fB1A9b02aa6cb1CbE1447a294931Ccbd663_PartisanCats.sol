    ...
    ReentrancyGuard
{
    ...
    uint256 public immutable maxSupply = 9999;
    uint256 public mintRate = 0.05 ether; //0.25 ether;
    uint256 public whitelistMintrate = 0.025 ether; //price for whitelisted buyers
    uint256 public maxMintAmountWhiteList = 5;
    uint256 public maxFreeMintAmount = 5;
