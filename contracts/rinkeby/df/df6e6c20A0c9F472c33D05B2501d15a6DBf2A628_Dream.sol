...
contract Dream is ERC721A, ReentrancyGuard, Ownable {
    uint256 public TOTAL_SUPPLY = 8888;
    uint256 public RESERVED_SUPPLY = 500; // reserved for free mint
    ...
    function presaleMint(
        ...
        require(
            _quantity + _numberMinted(msg.sender) <= _maxQuantity,
