...
contract ForzaCars is ERC1155, Ownable, ReentrancyGuard {
    ...
    function mintBatchBaseCar(uint256[] memory carIds) public {
        uint256 index;
        if(carIds.length == 0){
    ...
    function airdropBaseCar(uint256 carId, address to) public {
    ...
    function updateValidCars(uint256[] memory carIds, bool[] memory status) public {
