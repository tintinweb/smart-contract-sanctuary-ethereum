 ...
 */
contract LaLukaERC20 is ERC20Upgradeable , ERC20PausableUpgradeable, Ownable, Blacklistable, Rescuable, IERC677  {
   ...
   */
    function transferAndCall(address recipient, uint256 value, bytes memory data) 
        ...
        returns (bool) 
    {
        bool result = transfer(recipient, value);
     ...
     */
    function mint(address to, uint256 amount) public whenNotPaused onlyOwnerOrBridge {
        _mint(to, amount);
    }
     ...
     */
    function burn(uint256 amount) public whenNotPaused onlyOwnerOrBridge {
     ...
     * @param trustedForwarder Thhe address of trusted forwarder
     */
