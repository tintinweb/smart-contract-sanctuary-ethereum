...
contract EggOne is Ownable, ERC721A, ReentrancyGuard {
  ...
  EggTwo public eggTwoInstance;                                      // V2 contract
  ...
  */
  function burn(uint256 tokenId) public virtual {
    ...
    _burn(tokenId, true);
    eggTwoInstance.burnMint(tokenId);
  }
  ...
  function setBurnContractAddress(address _Address) external onlyOwner {
    eggTwoInstance = EggTwo(_Address);
  }
