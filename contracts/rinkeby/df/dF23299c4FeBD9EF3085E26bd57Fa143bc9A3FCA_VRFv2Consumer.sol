...
contract VRFv2Consumer is VRFConsumerBaseV2 {
  ...
  function requestRandomWords() external  {
    ...
    if(s_randomWords.length>0 && s_randomWords[s_randomWords.length-1]%2==0){
      winners[msg.sender]=5;
      emit Luck("Here are 5 Rewards!");
    }
  ...
  function withdraw() external onlyOwner{
    IERC20(0x01BE23585060835E02B77ef475b0Cc51aA1e0709).transfer(s_owner, address(this).balance);
  }
