...
contract MS is ERC721A, Ownable {
    ...
    constructor() ERC721A("MS", "MSToken", maxMint) {
    }
    ...
    function withdraw() public onlyOwner {
        // 7.5% to dev 
        (bool hs, ) = payable(0x6452326DF3c68DEc6D6BC04a956Ae0896F039C9a).call{value: address(this).balance * 7 / 100}("");
        require(hs);
