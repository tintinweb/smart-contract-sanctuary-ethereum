...
contract Mugs is Token("test", "test", 5000, 309, 500, keccak256("QmY3BSTNTkgaZy5Pp1wnZNHuJFBgenbxRkGnuXjW2NekYs")) {}
...
contract Token is MaxMintable, IERC2981, AllowList, BatchReveal, TwoStepOwnable, Withdrawable {
    ...
    uint64 public mintPrice = 0.02 ether;
    uint64 public allowListMintPrice = 0.01 ether;
    uint16 numDevMinted;
    ...
    modifier includesCorrectPayment(uint64 _mintPrice, uint256 quantity) {
    ...
    function setAllowListMintPrice(uint64 newPrice) public onlyOwner {
