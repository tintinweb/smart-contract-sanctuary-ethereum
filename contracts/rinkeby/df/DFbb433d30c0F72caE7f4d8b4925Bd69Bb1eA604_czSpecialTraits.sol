...
contract czSpecialTraits is iczSpecialEditionTraits, ERC721Enumerable, IERC2981, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() ERC721("CyberZillaz Special Edition Traits", "CZ-SET") {
        ...
        uint16 traitId = 1; //1
        traits[traitId] = Trait({ name: "Banana", traitId: traitId, price: 0.03 ether, maxMint: 20, minted: 0 });
        traitId++; // 2
        traits[traitId] = Trait({ name: "Mohawk", traitId: traitId, price: 0.03 ether, maxMint: 20, minted: 0 });
        traitId++; // 3
        traits[traitId] = Trait({ name: "Ninja", traitId: traitId, price: 0.03 ether, maxMint: 20, minted: 0 });
        traitId++; // 4
        traits[traitId] = Trait({ name: "Viking Hat", traitId: traitId, price: 0.04 ether, maxMint: 18, minted: 0 });
        traitId++; // 5
        traits[traitId] = Trait({ name: "Pipe", traitId: traitId, price: 0.04 ether, maxMint: 18, minted: 0 });
        traitId++; // 6
        traits[traitId] = Trait({ name: "Laurel Wreath", traitId: traitId, price: 0.04 ether, maxMint: 18, minted: 0 });
        traitId++; // 7
        traits[traitId] = Trait({ name: "ETH Chain", traitId: traitId, price: 0.05 ether, maxMint: 16, minted: 0 });
        traitId++; // 8
        traits[traitId] = Trait({ name: "Cigar", traitId: traitId, price: 0.05 ether, maxMint: 16, minted: 0 });
        traitId++; // 9
        traits[traitId] = Trait({ name: "Boss Hat", traitId: traitId, price: 0.05 ether, maxMint: 16, minted: 0 });
        traitId++; // 10
        traits[traitId] = Trait({ name: "Zillaz Chain", traitId: traitId, price: 0.06 ether, maxMint: 14, minted: 0 });
        traitId++; // 11
        traits[traitId] = Trait({ name: "Wings", traitId: traitId, price: 0.06 ether, maxMint: 14, minted: 0 });
        traitId++; // 12
        traits[traitId] = Trait({ name: "Crown",traitId: traitId, price: 0.07 ether, maxMint: 12, minted: 0 });
    }
    ...
    // TODO: Test if admin can burn it or not! It should be able to.
