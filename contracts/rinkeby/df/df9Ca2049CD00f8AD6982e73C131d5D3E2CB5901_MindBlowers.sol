...
contract MindBlowers is ERC721A, Ownable {
    ...
    uint256 public constant RESERVE_NUMBER = 300;
    ...
    uint256 public RESERVED_NFTS = 0;
    ...
    function mint(uint256 amount) external payable whenPublicSaleActive noContract {
        ...
        require(totalSupply() + RESERVE_NUMBER <= MAX_SUPPLY, 'EXCEEDS_MAX_SUPPLY');
        ...
        noContract
    {
        ...
        require(msg.value == whitelistPrice.mul(amount).div(100), 'INCORRECT_VALUE');
        require(totalSupply() + RESERVE_NUMBER <= MAX_SUPPLY, 'EXCEEDS_MAX_SUPPLY');
    ...
    function giveAway(uint256 _number, address _account) external onlyOwner {
        require((RESERVED_NFTS = RESERVED_NFTS + _number) <= RESERVE_NUMBER, 'EXCEED_RESERVED_NUMBER');
        _mint(_account, _number);
    }
