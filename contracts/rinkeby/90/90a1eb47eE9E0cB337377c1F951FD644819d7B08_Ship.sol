...
import "../Property.sol";
import "../../Random.sol";
import "./ShipMetadataBuilder.sol";
import "./TraitSet.sol";
...
contract Ship is Property {
    ...
    ShipMetadataBuilder private _metadataBuilder;
    ...
    function setMetadataBuilder(address address_) external onlyOwner {
        _metadataBuilder = ShipMetadataBuilder(address_);
    }
...
abstract contract ShipMetadataBuilder is Ownable {
    struct Artwork {
        address[] addresses;
        uint256 map;
    }
