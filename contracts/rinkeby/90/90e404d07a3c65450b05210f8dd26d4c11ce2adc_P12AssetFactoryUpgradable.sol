...
contract P12Asset is ERC1155(""), Ownable {
    ...
    function create(uint256 amount_, string calldata uri_)
        public
        onlyOwner
        returns (uint256)
    {
    ...
    function mint(
        ...
        require(
            amount + supply[id] <= maxSupply[id],
            "P12Asset: exceed max supply"
        );
...
// File contracts/P12V0FactoryStorage.sol
// License-Identifier: MIT
...
// File contracts/P12AssetFactoryUpgradable.sol
    ...
    UUPSUpgradeable
{
    ...
    modifier onlyDeveloper(string memory gameId) {
        require(
            P12V0FactoryStorage(p12factory).allGames(gameId) == msg.sender,
    ...
    modifier onlyCollectionDeveloper(address collection) {
        require(
            P12V0FactoryStorage(p12factory).allGames(registry[collection]) ==
                msg.sender,
            "P12Asset: not game developer"
        );
        _;
    ...
    ) public onlyDeveloper(gameId) returns (address) {
