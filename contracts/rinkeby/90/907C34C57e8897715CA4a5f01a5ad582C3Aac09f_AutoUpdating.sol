...
contract AutoUpdating is VRFConsumerBaseV2, KeeperCompatible {
    ...
    function fulfillRandomWords(
        ...
        uint256 _temperature = randomWords[0] % 100;
        uint256 _humidity = randomWords[1] % 100;
        uint256 _airQuality = randomWords[2] % 100;
    ...
    function getIotStatsArray() public view returns (IotStats[] memory) {
        return s_iotStatsArray;
    }
