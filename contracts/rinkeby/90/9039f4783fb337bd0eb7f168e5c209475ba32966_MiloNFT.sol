...
contract MiloNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant PRICE_PUB_TOKEN = 0.08 ether;

    constructor() ERC721("MiloNFT", "MiloNFT") {}
        ...
        isValidMerkleProof(merkleProof, saleMerkleRoot)
    {
        ...
        require(
            balanceOf(msg.sender) + numberOfTokens <= MAX_BALANCE,
