...
contract Lengtu is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("lengtu", "LENGTU", 2, 15) {}
    ...
    // allowList mint
    uint256 private allowListMintPrice = 0.200000 ether;
    // default false
    bool private allowListStatus = false;
    uint256 public allowListMintAmount = 5;
    ...
    uint256 public amountForPublicSale = 5;
    ...
    // auction
    uint256 public amountForAuction = 5;
