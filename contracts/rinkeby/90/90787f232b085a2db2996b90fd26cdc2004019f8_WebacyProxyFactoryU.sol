...
contract WebacyProxyFactoryU is IWebacyProxyFactory, Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    address public webacyMembership;
    ...
    function initialize() public initializer {
        ...
        _setupRole(EXECUTOR_ROLE, webacyMembership);
    }
    ...
    function createProxyContract(address _memberAddress) external override onlyRole(EXECUTOR_ROLE) whenNotPaused {
        ...
        require(!(webacyMembership == address(0)), "WebacyMembership needs to be set");
    ...
    function updateMembershipAddress(address _webacyMembershipAddress) external override onlyRole(DEFAULT_ADMIN_ROLE) {
        revokeRole(EXECUTOR_ROLE, webacyMembership);
        grantRole(EXECUTOR_ROLE, _webacyMembershipAddress);
        webacyMembership = _webacyMembershipAddress;
    }

    function setWebacyAddress(address _webacyAddress) external override onlyRole(DEFAULT_ADMIN_ROLE) {
...
interface IWebacyProxyFactory {
    ...
    function updateMembershipAddress(address _webacyMembershipAddress) external;
...
contract WebacyProxy is IWebacyProxy, AccessControl, Pausable {
    ...
    function updateExecutorRole(address _address) external override onlyRole(DEFAULT_ADMIN_ROLE) {
...
interface IWebacyProxy {
    ...
    function updateExecutorRole(address _address) external;
