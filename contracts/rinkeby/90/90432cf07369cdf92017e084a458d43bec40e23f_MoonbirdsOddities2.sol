...
contract MoonbirdsOddities2 is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmfL9yMHjiPtCEhiWey2D2oYJZnyLkoTLimCdBAu3177mh/";
    ...
    constructor(string memory initBaseURI) ERC721A("Moonbirds Oddities2", "MO") {
        baseURI = initBaseURI;
