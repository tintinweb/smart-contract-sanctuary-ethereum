...
import "contracts/mocks/libraries/PancakeLibrary.sol";
import "contracts/mocks/interfaces/IPancakeRouter01.sol";
import "contracts/mocks/interfaces/IPancakeFactory.sol";
import "contracts/mocks/interfaces/IERC20.sol";
import "contracts/mocks/interfaces/IWETH.sol";
...
import "./SafeMath.sol";
import "contracts/mocks/interfaces/IPancakeFactory.sol";
import "contracts/mocks/interfaces/IPancakePair.sol";
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"8317c19e1c04996e616ff5ce3001478da498318be3f238c52d0c7e6bc9e2fc1a" // init code hash
                    )
                )
            )
        );
