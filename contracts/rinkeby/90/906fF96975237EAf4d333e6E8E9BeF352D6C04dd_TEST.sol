...
contract TEST is ERC721A, Ownable {
    ...
    uint public constant COLLECTION_SIZE = 20;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xC10B6fE83cBf8fe435d6cd11931c9a4603E23dA8).transfer((balance * 5000)/10000);
         payable(0xC10B6fE83cBf8fe435d6cd11931c9a4603E23dA8).transfer((balance * 5000)/10000);
    }
    ...
    function mint(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        require(count <= TOKENS_PER_TRAN_LIMIT, " Number of requested tokens exceeds allowance (10)");
