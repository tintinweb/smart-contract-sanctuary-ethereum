...
contract SnowMonkey is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    uint PRESALE_THRESHOLD = 10;

    // uint PRESALE_PRICE = 300000000000000000;
    // uint SALE_PRICE = 400000000000000000;
    uint PRESALE_PRICE = 300000000000000; // 3000000000000000;
    uint SALE_PRICE = 400000000000000; // 4000000000000000;
    ...
    function mint(uint count) public payable returns (uint) {
        ...
        require(balanceOf(msg.sender) == 0, "User can mint monkeys only once");
        uint256 currentId = _tokenIds.current();
    ...
    function redeem(uint256 _tokenId, string memory _tokenURI) public payable {
