...
contract ETH_TO_FIAT4 {
    ...
    function makeRoomEth(
        ...
        require(_maxLimit > _lowLimit && msg.value > _maxLimit, "Incorrect limits");
...
library RoomStruct {
    ...
    function getRoomDynamic(RoomNumber storage self) internal view returns(
        bool,
        bool,
        bool,
        uint256,
    ...
    function getRoomStatic(RoomNumber storage self) internal view returns(
        address,
        uint256,
        uint64,
        uint256,
