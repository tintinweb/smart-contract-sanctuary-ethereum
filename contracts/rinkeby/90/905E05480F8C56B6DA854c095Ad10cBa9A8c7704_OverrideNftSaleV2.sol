...
contract OverrideNftSaleV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public treasuryTotalSupply = 0;
    ...
    function treasuryMint() public onlyOwner {
        ...
        require(
        currentSupply + MAX_TREASURY_SUPPLY <= MAX_SUPPLY,
        ...
        treasuryTotalSupply = MAX_TREASURY_SUPPLY;
    ...
    function saleMint(uint256 quantity) external payable nonReentrant callerIsUser {
        ...
        require(currentSupply + quantity <= MAX_SUPPLY, "Sold out! Sorry!");
