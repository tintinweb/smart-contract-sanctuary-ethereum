...
contract FuckToken is ERC20("fucktoken", "FKTOKEN"), Ownable, IDragonToken, Pausable {
    ...
    function _calculateRewards(address _account) internal view returns(uint256) {
        ...
        if (delta > 0) {
            ...
            */
            ...
            uint256 pendingLegendary = legendaryOwned[_account] * (DAILY_LEGENDARY_BONUS * delta / 8);
            uint256 bonus = _calculateBonus(_account) * delta / 86400;
    ...
    function setDystoApez(address _dragons) external onlyOwner {
        require(_dragons != address(0), "ADDRESS_ZERO");
        dragons = IERC721(_dragons);
    }
