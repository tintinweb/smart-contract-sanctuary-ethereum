...
abstract contract BaseBuildingBlock is SmartLZBase {
    ...
    function setNativeRouter(bytes memory _data) public {
    ...
    function setBridge(address newSgBridge) external {
...
abstract contract SmartLZBase is OwnableUpgradeable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig  {
    ...
    */
    function setRemote(bytes memory actionData) public onlyOwner() {
        (uint16 chainId, bytes memory remoteAddress) = abi.decode(actionData, (uint16, bytes));
