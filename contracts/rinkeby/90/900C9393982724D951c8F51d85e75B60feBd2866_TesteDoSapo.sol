...
contract TesteDoSapo is ERC721A, Ownable {
    ...
    string public prerevealURL = "ipfs://QmfZ4GSUCuMDFd5i7F7BcrYnvStZ7KihgxAhRJUQnr9JoG?filename=hidden.json" ;
    bool public start = true;

    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("Teste do Sapo", "TDS") {}
