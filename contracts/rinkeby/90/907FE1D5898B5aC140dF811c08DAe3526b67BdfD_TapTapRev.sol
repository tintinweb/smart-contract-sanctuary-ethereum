  ...
  ERC721AQueryable 
{
  ...
  */
  ...
  uint256 public immutable reserveAmount = 150;

  uint256 public constant ogMaxSupply = 400;
  uint256 public constant ogPrice = 0.15 ether;

  uint256 public constant allowlistMaxSupply = 8300 + ogMaxSupply;
  uint256 public constant allowlistPrice = 0.2 ether;

  uint256 public constant addressMintMax = 3;
  uint256 public constant publicMintPrice = 0.25 ether;

  uint256 public ogMintDuration = 24 hours;
  uint256 public ogMintStartTime = 0; // Must be EPOCH

  uint256 public allowlistMintDuration = 24 hours;
  uint256 public allowlistMintStartTime = 0; // Must be EPOCH

  uint256 public publicMintDuration = 48 hours;
  ...
  * Token.
  */
  uint256 private constant ttrIdDigits = 32;
  uint256 private constant ttrIdModulus = 10 ** ttrIdDigits;
  string private tokenSaltBase;
  ...
  */
  ...
  /*
  * Set contract URI for meta data.
  */
  ...
  */
  function ogMint() external payable callerIsUser onlyMintOpen {
    ...
    require(totalSupply() + 1 <= ogMaxSupply, "Max OG TTR's Minted");
  ...
  */
  function allowListMint(uint256 quantity) external payable callerIsUser onlyMintOpen {
    ...
    require(totalSupply() + quantity <= allowlistMaxSupply, "Allowlist Supply Reached");
  ...
  */
  function publicMint(uint256 quantity) external payable callerIsUser onlyMintOpen {
    require(block.timestamp >= publicMintStartTime, "Allowlist Mint not yet started.");
