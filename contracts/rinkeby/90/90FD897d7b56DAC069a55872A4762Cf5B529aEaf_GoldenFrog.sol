...
contract GoldenFrog is ERC721, ERC721Enumerable, Pausable, AccessControl, Ownable {
    ...
    constructor() ERC721("GoldenFrog", "GFT") {
    ...
    function safeMint(address to) public onlyRole(SUPPORTER_ROLE) {
    ...
    function setBaseURI(string memory _baseTokenURI) public onlyRole(SUPPORTER_ROLE) {
        baseTokenURI = _baseTokenURI;
    }

    function setStartURIID(uint256 _startTokenURIID) public onlyRole(SUPPORTER_ROLE) {
    ...
    function setPrice(uint256 newPrice) public onlyRole(SUPPORTER_ROLE) {
        price = newPrice;
    }

    function setPresalePrice(uint256 newPrice) public onlyRole(SUPPORTER_ROLE) {
    ...
    function setWhitelistMerkleRoot(bytes32 _newMerkleRoot) external onlyRole(SUPPORTER_ROLE) {
    ...
    function preSale(bytes32[] memory proof, uint256 amount) external payable {
        ...
        require(
            MerkleProof.verify(proof, _whitelistMerkleRoot, keccak256(abi.encodePacked(msg.sender, amount))),
