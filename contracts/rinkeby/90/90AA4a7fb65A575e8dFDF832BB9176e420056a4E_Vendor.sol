...
contract Vendor is Ownable {
  ...
  function buyTokens() payable public {
    ...
    require(tokensAmount <= yourToken.balanceOf(address(this)));
  ...
  function sellTokens(uint256 _amount) public{
    ...
    require(yourToken.balanceOf(msg.sender)>0, "You don't have any tokens!");
    require(address(this).balance>0, "Contract doesn't have any funds!");
