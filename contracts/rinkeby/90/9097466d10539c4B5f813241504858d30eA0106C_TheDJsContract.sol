...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x79f1F5402E77a8Cb4c52653388Ef303e5fD101A9];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x79f1F5402E77a8Cb4c52653388Ef303e5fD101A9;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigxhhiyyrzfzgraz6i37heiy6y4c25ttlkvfom5b3al356r3i2boi/";
...
// File: contracts/TheDJsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDJsContract is RamppERC721A {
    constructor() RamppERC721A("The DJs", "THEDJS"){}
}
