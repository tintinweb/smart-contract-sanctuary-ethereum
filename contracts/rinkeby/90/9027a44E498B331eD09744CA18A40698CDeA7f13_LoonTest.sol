...
contract LoonTest is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;
  mapping(address => bool) public alreadyMinted;

  // This is the provenance record of all Taggerz XL artwork in existence
  string public constant taggerzXLProvenance = 'PUT-IN-HASH';
  ...
  function mint() public totalSupplyCompliance(1) {
