...
contract MferMobile is ERC721A, Ownable {
    ...
    constructor() ERC721A("MferMobile", "MM") {
        _mfersContract = IERC721(0x2a6C7e11ccd90B20fBBed922Dd5fbb8Bc1D9DD05);
    }
    ...
    function holderMint(uint256 mferTokenId) external payable callerIsUser {
    ...
    {
        require(!_freeMinted[msg.sender], "Already free minted");
        _holderMint(mferTokenId);
    ...
    function withdraw() public onlyOwner {
        ...
        // 90% to creators
        _withdraw(msg.sender, ((balance * 90) / 100));
        // 10% to unofficialmfers.eth
        _withdraw(
