...
contract MyLastNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_SUPPLY = 10; //6942;
    ...
    function presaleMint(
        ...
        if (rootType == 1) freeMint = _verify(leaf, proof, freeMintMerkleRoot);
        else almostFreeMint = _verify(leaf, proof, almostFreeMintMerkleRoot);

        require(freeMint || almostFreeMint, "Invalid proof");
        ...
        bool hasFreeMint = freeMint && addressToMinted[msg.sender] == 0;
