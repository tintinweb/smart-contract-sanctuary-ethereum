...
interface ILightAgora {

    function mintTokens(address generatorAddress) external;
...
contract ProductContract {
    ...
    function changeDuration(uint8 newNumberOfBlocks) external {
        address owner = IERC721(factoryAddress).ownerOf(tokenId);
        require(msg.sender == owner, "Only owner");
        serviceDuration = newNumberOfBlocks;
    }
    ...
    function buyProduct(string[3] memory rgbString) external payable {
        ...
        blockNumLimit = blockNumLimit + serviceDuration;
