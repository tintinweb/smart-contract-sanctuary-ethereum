...
contract RoboHeadsNFT is ERC721, Ownable {
    ...
    constructor() payable ERC721('RoboHeads', 'RH') {
    ...
    function tokenURI(uint tokenId_) public view override returns (string memory) {
        require(_exists(tokenId_), "Token ID does not exists!");
    ...
    function mint(uint quantity_) public payable {
        ...
        require(walletMints[msg.sender] + quantity_ <= maxSupply, 'Limit reached!');
