...
//contract TierToken is ERC1363, ERC20Burnable, Pausable, AccessControl, TokenRecover {
    contract TierToken is ERC20, ERC20Burnable, Pausable, AccessControl, TokenRecover {
        //contract TierToken is ERC20, ERC20Burnable, Pausable, AccessControl, TokenRecover {
    ...
    uint    private constant INITIAL_SUPPLY = 10000000000 * (10**18);
    ...
    */
    function _mint(address to, uint256 amount) internal override onlyRole(MINTER_ROLE) {
