...
contract testI is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("testI", "TI") {}

    function becomeChosen() external {
        ...
        _safeMint(msg.sender, walletLimit);
    ...
    function sacrifice(uint256[] calldata tokenIds) external nonReentrant {
        ...
        if (!IoeSacrificed[msg.sender]) {
            ...
            IoeSacrificed[msg.sender] = IoeSacrificed[msg.sender];
        }
    }
