...
contract Vault721C is Vault721 {
    ...
    function setVaultCoolTime(CoolTimeMode _mode, uint256 _coolTimeByDayOrRatio) external onlyCollectionOwner {
    ...
    function mintWNft(
        ...
        // CoolTime settings
        if (vaultCoolTime.mode != CoolTimeMode.Disabled || lenderCoolTime[_lender].mode != CoolTimeMode.Disabled) {
            uint256 _duration = 0;
            ...
            coolTimes[_tokenId].push(CoolTime({mode: _mode, starts: _expires, expires: _expires + _duration}));
