...
import "@prollinson/mintout-library/contracts/eip/ERC2981.sol";
...
contract VVDealersChoice is ERC721, ERC721Enumerable, ERC2981, AdminControl, Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        _setRoyalties(_splitterAddress, 10);
    ...
    */
    ...
    function setRoyaltyInfo(address _royaltyAddress, uint256 _percentage) external onlyAdmin {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721, ERC721Enumerable, AdminControl, IERC165)
        returns (bool)
    {
