...
contract EthBridge is IERC721Receiver, Ownable, Pausable {
    using ECDSA for bytes32;

    ISmolBirb public immutable smolBirb;

    address public signer = address(0x21dfea78442657c9c61802b879B5B2d4A2783f66);
    ...
    constructor(ISmolBirb _smolBirbAddress) {
        smolBirb = _smolBirbAddress;
    }
    ...
    function withdraw(
        ...
        // require(!nonceUsed[_nonce], "Nonce already used");
        require(
            keccak256(abi.encodePacked(chainId, msg.sender, tokenIds))
