...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://wicked.mypinata.cloud/ipfs/QmdpR2ZiqYzoQTKdqXn43wuNU78dBDBwwCPvNy8qDPM3pD/";
...
// File: contracts/KillerSquadContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KillerSquadContract is RamppERC721A {
    constructor() RamppERC721A("Killer Squad", "KLW"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/DV9yWiGbCYBbUGDIY8Bs/contract-metadata";
    }
}
