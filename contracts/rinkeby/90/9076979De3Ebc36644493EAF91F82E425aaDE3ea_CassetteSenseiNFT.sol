...
contract CassetteSenseiNFT is ERC721, Ownable, Pausable {
    ...
    Counters.Counter[4] _tokenIdTrackerByRound;
    ...
    function getRoundInfo(uint256 id) public view returns (string memory) {
        ...
        string memory output = string(
            abi.encodePacked(
                ...
                ",",
                Strings.toString(_tokenIdTrackerByRound[id].current()),
                ",",
    ...
    function redeemPublic() external payable {
        ...
        require((_tokenIdTrackerByRound[id].current() + 1) <= rounds[id].maxSupply, "Sold out");
        ...
        _tokenIdTrackerByRound[id].increment();
    ...
    function getCurrentId() public view returns (uint256) {
        uint256 id = _roundIdTracker.current();
        return _tokenIdTrackerByRound[id].current();
    }
