...
contract my100kPFP is ERC721, PaymentSplitter, Ownable {

    using Counters for Counters.Counter;
    Counters.Counter private _tokenSupply;

    // Variables
    uint256 public maxTokens = 3333;                              // Total token supply
    uint256 public tokenPrice = 50000000000000000;                // 0.05 ETH Token price
    bool public publicMintActive = false;
    uint256 public maxTokenPurchase = 10;                         // Maximum number of tokens that can be purchased in a single transaction
    uint256 public tokenReserve = 50;                             // Reserved up front for the teams effort and for giveaways/promotional activity
    string public baseTokenURI;
    
    // Withdraw Addresses
    address[] private teamWallets = [
        0xE6C4a47A90Dc0C2C8962440C94f59dec2a40cf73, // Developer *** RINKEBY ***
        0x14aC5a4EDC8bea89470403F89EDa4e5d6a003088, // Project Wallet *** RINKEBY ***
        0xb335A50810923f30C21eC4Eb142eB4D962160E02, // Artist *** RINKEBY ***
        0x1f44597432C1C41083cF55169E2CfddbbE0Cd5C0  // Founder *** RINKEBY ***
    ];

    uint256[] private teamShares = [500, 1000, 2500, 6000];

    // Constructor
    // ERC721("My 100k PFP", "100kPFP")
    constructor()
        PaymentSplitter(teamWallets, teamShares)
        ERC721("Test Faces 170501", "FACES170501")
