...
contract ERC1155Sale is ReentrancyGuard, Ownable {
    ...
    function buy(
        ...
        require(isCurrencyAcceptable(_token, _orderId, _tokenId, _currencyId), "ERC1155Sale.buy: Buying currency is not acceptable");
    ...
    function verifySignature(
        ...
        require(
            keccak256(abi.encodePacked(token, tokenId, price, currencyId, amount, nonce))
