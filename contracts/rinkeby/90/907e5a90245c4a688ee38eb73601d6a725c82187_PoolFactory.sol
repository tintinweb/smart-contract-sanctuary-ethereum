...
contract PoolFactory {
    ...
    event PoolCreated( address indexed token0,address indexed token1, uint256 indexed fee,address pool);

    event FeeAmountEnabled(uint256 indexed fee);
    ...
    function deploy(address factory, address token0,address token1,uint256 fee) internal returns(address pool) {
    ...
    function getPoolInfo(address _poolCreater) public view returns (address, address, address , uint256) {
