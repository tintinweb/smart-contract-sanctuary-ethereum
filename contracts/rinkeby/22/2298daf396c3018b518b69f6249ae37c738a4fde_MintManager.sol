...
contract MintManager is Initializable, OwnableUpgradeable {
    ...
    function mintByCustomToken(uint amount, uint8 tokenIndex) external {
        ...
        IERC20(supportedToken[tokenIndex].tokenAddress).transferFrom(msg.sender, address(this), basedBalance);
    ...
    function mint() external payable {
        ...
        if (address(this).balance >= podtownBalance) {
            payable(podtownAddress).transfer(podtownBalance);
        }
