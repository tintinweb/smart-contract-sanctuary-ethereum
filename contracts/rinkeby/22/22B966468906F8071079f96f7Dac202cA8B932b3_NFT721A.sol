...
contract NFT721A is ERC721A, Ownable {
    ...
    uint256 public firstPrice = 2000000000000000;
    uint256 public lastPrice = 3000000000000000;
    uint256 public individualMintLimit = 3;
    uint256 public separateLine = 4000;
    ...
    function resetMintCount(address _address) public onlyOwner {
        mintCountMap[_address] = 0;
    }
    //******END SET UP******
