...
contract FinalCatTest is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint256 public maxTotalSupply = 10;
    ...
    constructor() ERC721A("FinaCatTest", "CATTES") {}

    function EngineerDigitalCC0Genome(uint256 _amount) external nonReentrant {
        require(isPublicLive, "Aclysmic Event Has Not Begun");
        require(_amount > 0, "At least 1 Cataclysmic Needed");
        require(totalSupply() + _amount <= maxTotalSupply, "Aclysmic Event Clone Process Complete");
