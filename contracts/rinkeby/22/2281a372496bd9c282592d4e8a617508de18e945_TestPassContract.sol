...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x87B23553aFfAFe941715C2387f221f660d84B394];
...
// File: contracts/TestPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TestPassContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Test Pass";
    string public symbol = "ALOHAPASS";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/hCylJqU6rL8LLeNzz7J8/contract-metadata";
    }
