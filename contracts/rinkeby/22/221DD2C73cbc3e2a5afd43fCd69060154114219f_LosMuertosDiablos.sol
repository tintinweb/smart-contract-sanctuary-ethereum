...
contract LosMuertosDiablos is ERC721A, Ownable {
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        // TODO: Discuss if we need max per mint
    ...
    function mintWithPass(uint256 amount) public mintCompliance(amount) {
        ...
        // This call will revert if amount is larger than the msg.sender balanceOf
        // https://github.com/OpenZeppelin/openzeppelin-contracts/blob/74738721dc9cfa820687f6b700d2583b16a21c0d/contracts/token/ERC1155/ERC1155.sol#L347
        mintPassContract.burnOnMint(msg.sender, amount);
        _safeMint(msg.sender, amount);
    }

    // After mintWithPass deadline passes, people will be allowed to mint based on a Merkle Tree
    // - as many as they had staked at the moment of the snapshot
