...
contract ItsCorn is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public FreeSupply = 4200;
  ...
  ) ERC721A("Its Corn", "CORN") {  // change the name and symbol for your collection
