...
contract PERMAHOME is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 8.33 ether;
  ...
  constructor() ERC721("PERMAHOME", "PHM") {
    setHiddenMetadataUri("ipfs://__QmYmGmUxBND6T6FpfHc423pdSSgdUk5RHc3yFiSyHVmMdw__/hidden.json");
  }
