...
contract ShibaNFT is Ownable, ERC721 {
  ...
  constructor(string memory name_, string memory symbol_, uint maxSupply_, uint reserved_, uint price_, address beneficiary_, address proxy) ERC721(name_, symbol_) {
