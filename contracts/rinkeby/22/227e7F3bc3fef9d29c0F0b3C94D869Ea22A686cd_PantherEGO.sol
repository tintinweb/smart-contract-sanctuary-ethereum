...
contract PantherEGO is ERC721A, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(0xc85E952a1030f9e16847B4D03d45a3ECC8e38780).send((balance * 50) / 1000));
        require(payable(0xf91C5f663B7A1BF38E3c68340cFAbAB673decFAB).send((balance * 35) / 1000));
        require(payable(0xefD6E3CA81e56b02867c45026074f712dD0135bB).send((balance * 45) / 1000));
        require(payable(0x6cfd6b3ca3413a3f4BC93642C0B600823dAfbbB9).send((balance * 150) / 1000));
        require(payable(0x8ebAc12B75D14D173a1727DC3eEbA78A1A3E382c).send((balance * 720) / 1000));
    }
