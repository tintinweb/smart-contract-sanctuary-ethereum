...
contract MasterBridge is Ownable {
    address[] public listOfBridges;
    uint256 public totalBridges;
    address public treasury;

    event BridgeCreated(address _address, uint256 _when);
    event ERC20Transfer(
        address _token,
        address _to,
        uint256 _howmuch,
    ...
    function createBridge(
        ...
        listOfBridges.push(address(_bridge));
        totalBridges = totalBridges + 1;
        emit BridgeCreated(address(_bridge), block.timestamp);
    }
