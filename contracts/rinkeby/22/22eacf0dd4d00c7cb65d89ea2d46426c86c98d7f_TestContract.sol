...
contract TestContract is ERC721A, Ownable {
    ...
    constructor(address _ethSigner) ERC721A("TestContract", "AVA") {
        ...
        payable
    {
        ...
        require(_mintAmount > 0, "Dutch:: Mint amount must be at least 1");
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(startingBlock > 0, "Dutch:: Dutch has not been set.");
            require(startingBlock < block.timestamp, "Dutch:: Dutch has not started.");
            require(
