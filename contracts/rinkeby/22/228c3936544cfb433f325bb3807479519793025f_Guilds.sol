...
contract AccessControl is Ownable {
    ...
    mapping(bytes32 => mapping(address => mapping (uint256 => bool))) public roles;
...
contract Guilds is ERC1155Supply {
        ...
        payable
    {
        ...
        tokenURI[_id] = _uri;
        emit URI(_uri, _id);
        _grantAdminRole(msg.sender, _id);
    }


    function _grantAdminRole(address _account, uint256 _id) private {
        _grantRole(ADMIN, _account, _id);
    }
