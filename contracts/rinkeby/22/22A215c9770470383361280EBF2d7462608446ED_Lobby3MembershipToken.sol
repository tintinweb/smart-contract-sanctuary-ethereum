    ...
    Ownable
{
  ...
  /**
    ...
    */
  function turnOnStandardSaleState() external onlyOwner {
    _standardETHOpen = true;
  }

  /**
    * @dev Allows to disable minting of sale.
    */
  function turnOffStandardSaleState() external onlyOwner {
    _standardETHOpen = false;
  }
  ...
  function mintStandardETH(address to, uint256 numTokens) external payable {
    require(_standardETHOpen, "Standard Token sale period has not started or is over");
    require(
