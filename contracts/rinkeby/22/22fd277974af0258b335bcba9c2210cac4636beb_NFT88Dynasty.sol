...
contract NFT88Dynasty is ERC721A, Ownable, whitelistChecker, ReentrancyGuard {
    ...
    uint public CAP = 68;
    uint public VAULT_CAP = 8;
    uint public PRESALE_CAP = 40;
    uint public WHITELIST_PRICE = 0.008 ether;
    ...
    uint internal _ownerMinted = 0;
    uint internal _presaleMinted = 0;
    ...
    function whitelistMint(
        ...
        require(WHITELIST_START_TIME <= block.timestamp && block.timestamp <= WHITELIST_START_TIME + 600, "whitelist: outside time window");
        ...
        if (whitelist.listType == 1) {
            ...
            require(_presaleMinted + amount <= PRESALE_CAP, "free list: exceeding presale cap");
        ...
        // type == 2: Lucky list
            ...
            require(_presaleMinted + amount <= PRESALE_CAP, "lucky list: exceeding presale cap");
    ...
    function publicMint(
	    ...
	    require(_presaleMinted == PRESALE_CAP || WHITELIST_START_TIME + 600 < block.timestamp, "public mint: not started yet");       
    ...
    function setBaseURI(
        ...
        require(bytes(baseURI_).length > 0, "88Dynasty.setBaseURI: base URI invalid");
