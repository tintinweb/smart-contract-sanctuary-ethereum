...
contract EachCupTest is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("EachCupTest", "EachCup") {
      setBaseURI("");
      setStartTime(block.timestamp + 10 minutes);
    }
    ...
    function mintColors(uint _count) public payable {
      ...
      require(
        block.timestamp >= mintStartTime, "Mint has not started yet."
      );
