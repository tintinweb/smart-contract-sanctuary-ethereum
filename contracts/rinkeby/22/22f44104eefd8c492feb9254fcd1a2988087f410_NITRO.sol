...
contract NITRO is Context, Ownable, IERC20, IERC20Metadata { 
    string private constant _name = "NITRO";
    string private constant _symbol = "NOX";
    uint8 private constant _decimals = 9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 100000000000000 * 10 ** _decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _redisFeeOnBuy = 1;
    uint256 public _redisFeeOnSell = 1;
    ...
    uint256 public _maxTxAmount = 250000000000 * 10 ** _decimals;
    ...
    address public vbAddress = 0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B;
    address payable public communityWallet = payable(0x1de4c2E2B9DdbDD8F2F07E603404c0B0a3aE5A49);//to be changed
    ...
    function sendETHToFee(uint256 amount) private {
        communityWallet.transfer(amount);
    }
 
    function manualswap() external {
        require(_msgSender() == communityWallet);
    ...
    function setcommunityWallet(address payable newWallet) public onlyOwner {
