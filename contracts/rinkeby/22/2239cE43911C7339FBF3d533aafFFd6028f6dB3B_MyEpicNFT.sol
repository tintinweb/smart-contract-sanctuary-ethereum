...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["BLAH", "BLUH", "BLOH"];
    string[] secondWords = ["duh", "dih", "doh"];
    string[] thirdWords = ["OUCH", "FUCH", "CUCH"];
    ...
    function makeAnEpicNFT() public {
        require(_tokenIds.current() < 10, "The maximum NFT has been reached!");
