...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     * @return bool whether the call correctly returned the expected DOGE value
     */
...
// File: contracts/tld/strings.sol
...
// File: contracts/tld/IDOGETLDFactory.sol
...
// File: contracts/tld/DOGETLD.sol
...
contract DOGETLD is ERC721, Ownable, ReentrancyGuard {
  ...
  uint256 public nameMaxLength = 3000; // max length of a domain name
  string public description = "DOGE chain Domains digital identity. Visit https://DOGEdomains.dog/";
