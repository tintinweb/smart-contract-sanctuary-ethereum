...
contract sweepingDeclaration is Ownable {
    ...
    function confirmDeclaration ( uint256 _declarationID ) public {
        ...
        /// @notice Variable to store the address which made the confirmation.
        address _confirmer = msg.sender;
        ...
        require ( alreadyConfirmed = true, "Can't confirm the same declaration twice." );
        ...
        require ( isOwnDeclaration = true, "Can't confirm your own declaration." );
        ...
        /// @notice Increment number of confirmers if confirmer of declaration has no previous confirmations.
        if ( numberOfConfirmationsForConfirmer[_confirmer] == 0 ) {

            totalNumberOfConfirmers++;

        }

        /// @notice Storing index of declaration
        uint256 declarationIndex = _declarationID - 1;

        /// @notice Increment number of confirmations on the declaration.
        declarations[declarationIndex].numberOfConfirmationsOnDeclaration++;
    ...
    /// @param _declarationID is the ID of the declaration.
    function denyDeclaration ( uint256 _declarationID ) public {
        ...
        /// @notice Variable to store the address which made the deny.
        address _denier = msg.sender;
        ...
        /// @notice Check if confirmer already confirmed the declaration,
        require ( alreadyDenied = true, "Can't deny the same declaration twice." );
        ...
        /// @notice Check if confirmer owns the declaration,
        require ( isOwnDeny = true, "Can't deny your own declaration." );
        ...
        /// @notice Increment number of deniers if denier of declaration has no previous denies.
        if ( numberOfDeniesForDenier[_denier] == 0 ) {

            totalNumberOfDeniers++;
        ...
        /// @notice Increment number of confirmations on the declaration.
        declarations[declarationIndex].numberOfDeniesOnDeclaration++;
