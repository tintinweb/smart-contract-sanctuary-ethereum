...
contract JustDraginzDen is ERC721, Ownable, RandomlyAssigned {
  ...
  function publicSaleMint(uint256 _mintAmount) public payable ensureAvailability() mintCompliance(_mintAmount) {
    require(!paused, 'The contract is paused!');
    require(publicM, 'The whitelist sale is not enabled!');
    require(!mintClaimed[_msgSender()], 'Address already claimed!');
    _mintLoop(msg.sender, nextToken());
