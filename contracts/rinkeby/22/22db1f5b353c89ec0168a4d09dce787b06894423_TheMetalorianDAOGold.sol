...
// File: contracts/theMetalorianDAOGold.sol
...
///@title TheMetalorianDAOGold
///@notice Token ERC721 for the Metalorian DAO 
contract TheMetalorianDAOGold is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 1000;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 1000;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian DAO Gold", "TMDG") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeidcbitqcg2ojm3hwqkwto6iaitqihunof67vmi4bulg4q7fayfmru/GolgMetadata/";   
        mintCost = 0.0004 ether;
    }
    ...
    event MintTheMetalorianDAOGold(address indexed user, uint256 tokenId); 
    ...
    function mintTheMetalorianDAOGold(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDAOGold(msg.sender, tokenIdCounter.current());            
