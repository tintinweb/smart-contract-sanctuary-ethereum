...
contract StarLedgerNFT is ERC721, Ownable, Pausable {
    /**
    ...
    function _callMint(uint256 amount) internal {
        ...
        require(mintCount + amount <= MAX_COUNT, "Not enough tokens to mint");
        for (uint256 i = 1; i <= amount; i++) {
            uint256 nextTokenId = mintCount + i;
