...
contract EventUnlockSchedule is BaseGovernanceWithUserUpgradable, KeeperCompatibleInterface {
    ...
    function initialize(ILock lock, bytes calldata data) public initializer {
        ...
        __EventUnlockSchedule_init(lock, _lockStartTime, _lockEndTime, _conditions, _offsetPrices, _amounts, /*_tknAddrBase, _tknAddrQuote,*/ _feedAddress, governanceAddress, _isOwnerAsBen);
    }

    function __EventUnlockSchedule_init(ILock _lock, uint256 _lockStartTime, uint256 _lockEndTime, uint256[] memory _conditions, int256[] memory _offsetPrices, uint256[] memory _amounts, /*address _tknAddrBase, address _tknAddrQuote,*/ address _feedAddress, address governanceAddress, bool _isOwnerAsBen) internal onlyInitializing {
        __BaseGovernanceWithUser_init(governanceAddress);
        __EventUnlockSchedule_init_unchained(_lock, _lockStartTime, _lockEndTime, _conditions, _offsetPrices, _amounts, /*_tknAddrBase, _tknAddrQuote,*/ _feedAddress, _isOwnerAsBen);
    }

    function __EventUnlockSchedule_init_unchained(ILock _lock, uint256 _lockStartTime, uint256 _lockEndTime, uint256[] memory _conditions, int256[] memory _offsetPrices, uint256[] memory _amounts, /*address _tknAddrBase, address _tknAddrQuote,*/ address _feedAddress, bool _isOwnerAsBen) internal onlyInitializing {
    ...
    function unlockedAmount(uint256 _initialAmount) external view returns (uint256) {
        // if(block.timestamp >= lockEnd() && isOwnerAsBen) {
        //     return amountsUnlocked;
        // }
        return _initialAmount * amountsUnlocked / EXP;
        //return amountsUnlocked;
    }
    // function ifOwnerAsBen() external view returns (bool){
    //     return isOwnerAsBen;
    // }
