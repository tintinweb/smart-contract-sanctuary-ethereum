...
interface IExquisiteGraphics {
    ...
    /// @param data Binary data in the .xqst format.
    /// @return string the <svg>
    function drawUnsafe(bytes memory data)
        external
        pure
    ...
    function drawPixels(bytes memory data)
        external
        pure
        returns (string memory);
...
contract ExquisiteGenesis is ERC1155, Ownable, ReentrancyGuard {
    ...
    constructor(bytes memory data) ERC1155("") {
    ...
    function uri(uint256 id) public view override returns (string memory) {
        ...
        bytes memory metadata = abi.encodePacked(
            ...
            '", "description": "64x64 in 256 Colors. This is one of the toughest images for Exquisite Graphics to render. It ensures that anyone will be able to render high resolution on-chain art with Exquisite Graphics."',
