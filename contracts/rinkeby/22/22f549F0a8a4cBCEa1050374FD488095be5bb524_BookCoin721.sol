...
/// @title BookCoin's Metalibrary Card NFT
/// @author audie.eth
/// @notice ERC721 for BookCoin Metalibrary Cards
/// @dev Mint windows coded into contract. Each Merkle Root contains the previous mint window's tree.
...
contract BookCoin721 is ERC2981, ERC721, Ownable {
    ...
    // fixed properties
    uint256 public supply = 1111; // TODO:
    ...
    function setGroupOneRoot(bytes32 newPreSaleRoot) public onlyOwner {
        _rootPreSale = newPreSaleRoot;
    }
    ...
    function setGroupTwoRoot(bytes32 merkleRoot) public onlyOwner {
        _rootGroup2 = merkleRoot;
    }
