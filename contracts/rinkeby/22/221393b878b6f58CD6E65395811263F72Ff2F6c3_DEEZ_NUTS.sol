...
contract DEEZ_NUTS is ERC721A, IERC2981, Ownable  {
    ...
    // Pricing
    uint256 public royaltyPercentage = 44;
    // Supply 
    ...
    constructor() ERC721A("DEEZ NUTS", "ZNUTS") IERC2981() {}

    function freeMint() external payable {
        require(isMintEnabled, "Minting Not Enabled");
        require(_numberMinted(msg.sender) < maxPerWallet, "Mint Limit Reached");
        require(totalSupply() + 1 < maxSupply, "Out Of Supply");
        _mint(msg.sender, 1);
    }
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmeAzbjEaZoGjnBqhoe6dECU6tHo2V7nVLcBytHvmSJ6pB?filename=";
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual override(IERC2981) returns (address, uint256) {
        ...
        uint256 fee = _salePrice * royaltyPercentage / 10;
        return (owner(), fee);
    }
