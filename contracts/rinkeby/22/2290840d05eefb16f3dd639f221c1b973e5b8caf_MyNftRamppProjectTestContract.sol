...
// File: contracts/MyNftRamppProjectTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNftRamppProjectTestContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project  Test", "TEST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/dIooFRZvSi8nKOFynDKP/contract-metadata";
    }
}
