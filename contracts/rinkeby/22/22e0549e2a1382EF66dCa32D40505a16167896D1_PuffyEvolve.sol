...
contract PuffyEvolve is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Puffy Puff Evolve", "Evolve") {
    setHiddenMetadataUri("ipfs://Qma91qtonroTAWq1z3RGzw7VUJyxPJX4wAp2qZktRA76ud/egg.json");
  }
