...
contract FreeMint is Context, ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public FreeMintPerAddressLimit = 3;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    //_numAvailableTokens = totalSupply();
    ...
    //        require(ownerMintedCount + _mintAmount <= FreeMintPerAddressLimit, "max Free Mint per address exceeded");
    //    }
    //}
    ...
    //_balances[msg.sender] += _mintAmount;
  }
