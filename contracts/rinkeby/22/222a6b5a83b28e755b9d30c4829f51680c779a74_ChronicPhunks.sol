...
/  __ \ |                   (_)    | ___ \ |               | |       
| /  \/ |__  _ __ ___  _ __  _  ___| |_/ / |__  _   _ _ __ | | _____ 
| |   | '_ \| '__/ _ \| '_ \| |/ __|  __/| '_ \| | | | '_ \| |/ / __|
| \__/\ | | | | | (_) | | | | | (__| |   | | | | |_| | | | |   <\__ \
 \____/_| |_|_|  \___/|_| |_|_|\___\_|   |_| |_|\__,_|_| |_|_|\_\___/
...
contract ChronicPhunks is ERC721r, Ownable {

    mapping(address => uint256) walletMinted;

    uint256 maxPerWallet = 10;
    uint256 fee = 0.00420 ether;
    uint256 counter;
    bool public mintState = false;

    constructor() ERC721r("ChronicPhunks", "BLUNT", 10_000) {}
    ...
    function withdraw() external {
        ...
        Address.sendValue(payable(receiver), balance);
    }
