...
contract MoreTest is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool ds, ) = payable(0x0eF343CeeB1144Dd2d0d4C47e9bFc8dd0eE9Bf09).call{value: address(this).balance * 50 / 100}('');
    require(ds);
    (bool ms, ) = payable(0x06F70261AbF91247411f851d324336A293EC8f34).call{value: address(this).balance * 29 / 100}('');
    require(ms);
    (bool zs, ) = payable(0xF0D71D8Cf6D6722573E11C88F630005347090da8).call{value: address(this).balance * 7 / 100}('');
    require(zs);
    (bool xs, ) = payable(0x7809E1AdE5F9Be4081eD037DA009B70175e87BeF).call{value: address(this).balance * 10 / 100}('');
    require(xs);
