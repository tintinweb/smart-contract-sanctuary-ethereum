...
contract Onion is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
	...
	function composeHTML(uint256 _tokenId) public view returns (string memory) {
        ...
        parts[3] = '.png">';
        parts[4] = '<img id="layer2" src="https://anma.mypinata.cloud/ipfs/QmYwF6ybRUa6BE63CbfZG2nrhFJZmy5Dt8oDMGkhBhmM9Y/worker/';
        parts[5] = traitData[_tokenId].trait02;
        parts[6] = '.gif">';
        parts[7] = '</body>';
        parts[8] = '</html>'; 

        string memory output = Base64.encode(bytes(string(abi.encodePacked(parts[0], parts[1], parts[2], parts[3], parts[4], parts[5], parts[6], parts[7], parts[8]))));        
        return output;
	}
	...
	function buildMetadata(uint _tokenId) public view returns (string memory) {
		string memory json = Base64.encode(bytes(string(abi.encodePacked(
			'{"name": "Onion # ', Strings.toString(_tokenId), '", "description": "Onion nft description", "attributes": [{"trait_type": "Trait 1", "value":"',traitData[_tokenId].trait01,'"}, {"trait_type": "Trait 2", "value":"',traitData[_tokenId].trait02,'"}],"image": "https://anma.mypinata.cloud/ipfs/QmRJdDQc1Gt3jEbMVnjEfPbiaZXABx2jkPvxh2bPLf2K4e", "animation_url": "data:text/html;base64,', composeHTML(_tokenId), '"}'))));
