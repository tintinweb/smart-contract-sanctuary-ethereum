...
// Example of https://www.pinksale.finance/#/launchpad/0x9F4A2B740691e53ddD41d70e2cbEbc6Ab2b32E8F?chain=BSC
...
contract Koko is Context, IERC20, Ownable {
    ...
    string private _name = "Yuli";
    string private _symbol = "YUL";
    ...
    // Others
    //address public rewardAddress = 0x0000000000000000000000000000000000000000;
    address public rewardAddress = 0xF59c53f00780a6B9f8aA12ad3E9E0D06DdA36d2F;
    ...
    address private PancakeSwapV2RouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    bool private isTradingEnabled = false;
    
    constructor() {
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(PancakeSwapV2RouterAddress);
    ...
    function setAutomatedMarketMakerPair(address pair, bool takeFee) public onlyOwner {
		require(pair != uniswapV2Pair, "Error: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
		_setAutomatedMarketMakerPair(pair, takeFee);
	}
