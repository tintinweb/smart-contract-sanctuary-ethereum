...
/**
 * Final Rinkeby test for CR contract.
 * 7-28-22. 
 */
...
contract CRTEST is Ownable, ERC721A, PaymentSplitter {
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account( 50, 0, 1 );  // CR 50
        accounts[teamclaim[1]] = Account( 28, 0, 1 );  // CR 28
        accounts[teamclaim[2]] = Account( 25, 0, 1 );  // G1 25
        accounts[teamclaim[3]] = Account( 25, 0, 1 );  // G2 25
        accounts[teamclaim[4]] = Account( 25, 0, 1 );  // G3 25
        accounts[teamclaim[5]] = Account( 22, 0, 1 );  // G4 22
        // [Others may be added post-deploy.]
