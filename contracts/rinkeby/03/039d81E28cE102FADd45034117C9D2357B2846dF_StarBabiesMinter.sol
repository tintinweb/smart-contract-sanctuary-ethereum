...
contract StarBabiesMinter is Ownable {
    ...
    uint256 public whitelistStartDate = 1664197332;
    uint256 public publicStartDate = 1664197332;
    ...
    function _mint(address _to, uint8 _count) private {
        for(uint i = 0; i < _count; i++){
        uint256 newItemId = _tokenIds.current();
        nftContract.mint(_to, newItemId);
        _tokenIds.increment();
        }
    }
