    ...
    ERC1155HolderUpgradeable
{
     ...
     */
    function withdrawToWallet() external nonReentrant {
        require(walletContractAddress != address(0), "Wallet Address is not set yet.");
        ...
        WALLET_CONTRACT.deposit(_msgSender(), user.reward);

        emit WithdrawToWallet(_msgSender(), user.reward);
    ...
    function setWalletContractAddress(address _address) external onlyOwner {
        require(_address != address(0), "LL420BudStaking: Wallet contract address can't be zero ");
