...
contract cuksSmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "MyCuks";
    string private constant _symbol = "CUKS";
    ...
    uint256 private sellMarketingFee = 200;
    uint256 private totalsellFees = sellMarketingFee + sellAutoBurnFee;
    ...
    constructor (address payable feeAddrWallet) {
        ...
        totalsellFees = sellMarketingFee + sellAutoBurnFee;
        swapEnabled = true;
