...
contract EXERAD is Ownable, ReentrancyGuard {
	...
	IERC721 public EXERADNFT = IERC721(0x56C32a0D43ed453D7E8dc665b9dB3Eb7901176c6);
	address public sender = address(0x760c5A41b67BE0b8E208Da61c9654d5aad1e92f2);
	
	mapping (address => User) public users;
	
	function mintPreSaleNFT(uint256 _count, bytes32[] calldata merkleProof) external nonReentrant{
