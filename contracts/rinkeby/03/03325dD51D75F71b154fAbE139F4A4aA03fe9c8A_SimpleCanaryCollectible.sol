...
// File: SimpleCanaryCollectible.sol

contract SimpleCanaryCollectible is ERC721, Ownable {
    uint256 public tokenCounter;
    string private constant name_ = "Canary NFT";
    string private constant symbol_ = "CAN";
