...
// SPDX-License-Indeitifer: UNLICENSED
...
// File: contracts/ogclub.sol

pragma solidity ^0.8.4;

contract OGClubReal is ERC721A, ERC721AQueryable, Owned {
  uint256 public FIRST_MINT_PRICE = 0.015 ether;
  uint256 constant EXTRA_MINT_PRICE = 0.03 ether;
  ...
  function mint_540(uint256 _quantity) external payable {
    unchecked {
      ...
      require(_quantity < MAX_PER_TRANSACTION_PLUS_ONE, "MAX PER TRANSACTION IS 5");
