...
// File contracts/DigiFunkosDNA.sol
...
contract DigiFunkosDNA{
    ...
    function deterministicPseudoRandomDNA(uint256 _tokenId, address _minter) public  pure returns(uint256){	
            ...
            bytes memory encodedParams = abi.encodePacked(combinedParams);	// to convert bytes
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {	
        ...
        string memory jsonURI = Base64.encode(	
            abi.encodePacked(	
                ...
                '", "description": "DigiFunkos  customized Avataaars stored on chain to teach DApp development on PinaDev", "image": "',	
                image,	
