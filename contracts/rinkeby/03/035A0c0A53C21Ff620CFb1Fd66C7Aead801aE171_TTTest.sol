...
contract TTTest is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public population = 10000;
    uint256 public weWillSee = 1000;
    ...
    constructor() ERC721A("TTTest", "TTT") {}
    ...
    function nowWeKnow(uint256 _newSupply) external onlyOwner {
