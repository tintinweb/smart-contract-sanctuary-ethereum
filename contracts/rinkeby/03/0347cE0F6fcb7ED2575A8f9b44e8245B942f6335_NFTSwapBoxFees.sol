...
contract NFTSwapBoxFees is Ownable,INFTSwap {
    ...
    uint256[] public contractFee = [0.0001 ether, 0.0002 ether, 0.0003 ether, 0.0004 ether, 0.0005 ether];
    uint256 public defaultNFTSwapFee = 10 ether;
    ...
    function _checkCreatingBoxFees(
        ...
        return elementCount * contractFee[0];
    }
