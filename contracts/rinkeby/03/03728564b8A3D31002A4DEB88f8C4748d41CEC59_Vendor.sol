...
contract Vendor is Ownable {
  ...
  uint256 public tokenPrice = 100000 gwei;  //  0.0001eth
  ...
  constructor() {
    yourToken = Token(0xD27D5390F6aecc27E8410250745200aC49903681);
  }
  ...
  function buyTokens(uint256 numberOfTokens) payable public {
    ...
    uint256 priceOfTokens = tokenPrice * numberOfTokens;

    uint256 tokenBalance = yourToken.balanceOf(address(this));

    
    require(msg.value >= priceOfTokens, "Not enought tokens");
