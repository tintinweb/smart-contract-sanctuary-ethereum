...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 _theAmount) public {
    yourToken.transferFrom(msg.sender, address(this), _theAmount);
    (bool sent,) = msg.sender.call{value: _theAmount / tokensPerEth}("");
  }
}
