...
contract MyEpicNFT is ERC721URIStorage {
    ...
    //OpenZeppelin がtokenIdsを簡単に追跡するために提供するライブラリを呼び出しています。
    ...
    string[] firstWords = ["rat", "dog", "tiger", "rion", "crocodile", "hippo"];
    string[] secondWords = ["carrot", "cucumber", "tomato", "leek", "potato", "eggplant"];
    string[] thirdWords = ["japan", "america", "china", "france", "india", "australia"];
    ...
    //pickRandomFirstWord関数をは、最初の単語を選びます。
    function pickRandomFirstWord(uint256 tokenId) public view returns (string memory) {
        //pickeRandomFirstWord関数のシードとなるrandを作成します。
    ...
    //pickRandomFirstWord関数をは、2番目に表示される単語を選びます。
    ...
    //pickRandomFirstWord関数をは、3番目に表示される単語を選びます。
    ...
    function makeAnEpicNFT() public {
        ...
        console.log("--------------------\n");
        //msg.sender を使ってNFTを送信者にMintします。
