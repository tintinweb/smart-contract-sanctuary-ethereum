...
contract JuniorNFT is IJuniorNFT, ERC721A, Ownable, ReentrancyGuard {
    ...
    address _contract = 0x0Aa219060f32594c8A33cBF08BcAf6CDEc98A4C1;

    constructor(string memory baseURI_, string memory _defaultURI)
    ...
    function getRandomNumber() external onlyOwner nonReentrant {
