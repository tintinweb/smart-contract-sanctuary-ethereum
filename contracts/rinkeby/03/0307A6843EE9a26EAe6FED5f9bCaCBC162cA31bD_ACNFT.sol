...
contract ACNFT is ERC721, AccessControlEnumerable, IACNFT, Ownable {
    ...
    constructor() ERC721("Anonymous Club NFT", "ACNFT") {
    ...
    modifier onlyMinter() {
        require(
            ...
            "ACNFT: must have minter role to mint"
        );
        _;
    }
    ...
    /**
     * @dev Base Extension for computing {tokenURI}.
     */
