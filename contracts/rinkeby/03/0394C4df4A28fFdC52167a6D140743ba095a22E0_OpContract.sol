...
//
//                      ____        __      ____                                  
//                     / __ \____  / /_  __/ __ \____ ___________                 
//                    / / / / __ \/ / / / / /_/ / __ `/ ___/ ___/                 
//                   / /_/ / / / / / /_/ / ____/ /_/ (__  |__  )                  
//     ____          \____/_/ /_/_/\__, /_/    \__,_/____/____/____           __  
//    / __ \________  ____  ____ _/____/__     / /_____     / ____/_  _______/ /__
//   / /_/ / ___/ _ \/ __ \/ __ `/ ___/ _ \   / __/ __ \   / /_  / / / / ___/ //_/
//  / ____/ /  /  __/ /_/ / /_/ / /  /  __/  / /_/ /_/ /  / __/ / /_/ / /__/ ,<   
// /_/   /_/   \___/ .___/\__,_/_/   \___/   \__/\____/  /_/    \__,_/\___/_/|_|  
//                /_/                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xD660A257b8D4bC07722d611BFB233DD434279182];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xD660A257b8D4bC07722d611BFB233DD434279182;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 700;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 1000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUX1RSGT3w8RshJiRRbQ2pm3u8rGGQ4PpaKQKKeBN1iHv/";
...
// File: contracts/OpContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OpContract is RamppERC721A {
    constructor() RamppERC721A("OP", "OP"){}
}
