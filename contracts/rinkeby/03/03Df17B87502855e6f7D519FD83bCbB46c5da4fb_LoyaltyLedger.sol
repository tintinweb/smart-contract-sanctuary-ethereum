...
interface IPassageRegistry {
    ...
    function getLoyaltyData(address loyalty) external view returns (bool managed);

    function getPassportData(address passport) external view returns (bool managed);
    ...
    function isTrue() external pure returns (bool);
