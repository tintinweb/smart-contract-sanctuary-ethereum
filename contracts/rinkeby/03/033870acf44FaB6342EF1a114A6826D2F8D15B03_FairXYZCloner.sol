...
contract FairXYZCloner {
    ...
    function _clone(uint256 maxTokens, uint256 nftPrice, string memory name, string memory symbol, bool burnable, 
                    uint256 maxMintsPerWallet, bytes memory signature, uint256 nonce) external {
        ...
        IFairXYZDeployer(identicalChild).initialize(msg.sender, maxTokens, nftPrice, name, symbol, burnable, maxMintsPerWallet, 
                                                    interfaceAddress);
