...
contract MotoDEXnft is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    mapping(uint256 => uint256) healthForId;

    mapping(uint8 => string) uriForType;
    ...
    constructor(uint256 networkId, address _gameServer) ERC721("motoDEXnft", "MOTO") {
        gameServer = _gameServer;
        players = [RED_BULLER,ZEBRA_GRRR,ROBO_HORSE,METAL_EYES,BROWN_KILLER,CRAZY_LINE];
        setupType(RED_BULLER, 0.5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/RedBuller");
        setupType(ZEBRA_GRRR, 0.7 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/ZebraGrrrr");
        setupType(ROBO_HORSE, 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/RoboHorse");
        setupType(METAL_EYES, 2 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/MetalEyes");
        setupType(BROWN_KILLER, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/BrownKiller");
        setupType(CRAZY_LINE, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/CrazyLine");
        setupType(MAGIC_BOX, 2 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/MagicBox");

        setupType(TRACK_LONDON, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/London");
        setupType(TRACK_DUBAI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Dubai");
        setupType(TRACK_ABU_DHABI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/AbuDhabi");
        setupType(TRACK_BEIJIN, 50 ether, 300, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Beijing"); // TODO - change back
        setupType(TRACK_MOSCOW, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Moscow");
        setupType(TRACK_MELBURN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Melburn");
        setupType(TRACK_PETERBURG, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Peterburg");
        setupType(TRACK_TAIPEI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Taipei");
        setupType(TRACK_PISA, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Pisa");
        setupType(TRACK_ISLAMABAD, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/Islamabad");

        setupType(HEALTH_PILL_5, 0.5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/HealthCapsule5");
        setupType(HEALTH_PILL_10, 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/HealthCapsule10");
        setupType(HEALTH_PILL_30, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/HealthCapsule30");
        setupType(HEALTH_PILL_50, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/HealthCapsule50");
    ...
    function setHealthForId(uint256 tokenId, uint256 health) public {
        require(msg.sender == gameServer,'MotoDEXnft: only server account can change health');
    ...
    function _safeMintType(address to, string memory uri, uint8 typeNft, bool needURI) private {
        ...
        if (limitForType[typeNft] > 0) require(counter + 1 < limitForType[typeNft], "MotoDEXnft: counter reach end of limit");
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
    ...
    event Purchase(address indexed from, uint256 value, uint8 typeNft, uint8 finalTypeNft);

    function purchase (uint8 typeNft, address referral) payable public {
        require(msg.value > valueInMainCoin(typeNft).sub(100000), "MotoDEXnft: wrong value to send");
        ...
        emit Purchase(msg.sender,msg.value,typeNft,finalTypeNft);
    }


    function purchaseBatch(uint8[] memory typesNft, address referral) payable public {

        uint256 totalValueToPay;
        for(uint256 x=0;x<typesNft.length;x++) {
            totalValueToPay = totalValueToPay + valueInMainCoin(typesNft[x]);
        }
        require(msg.value >= totalValueToPay.sub(100000), "MotoDEXnft: wrong value to send");
        ...
        for(uint256 y=0;y<typesNft.length;y++) {
            ...
            _safeMintType(msg.sender, "", finalTypeNft, false);
            emit Purchase(msg.sender,msg.value,typesNft[y],finalTypeNft);
        }
    ...
    function _checkTypeHealth(uint256 tokenId) view private {
    ...
    function addHealthMoney(uint256 tokenId) payable public nonReentrant {
        uint256 healthDiff = getPriceForType(getTypeForId(tokenId)).sub(getHealthForId(tokenId));
        if (healthDiff < msg.value) healthForId[tokenId] = getPriceForType(getTypeForId(tokenId)); // fill to full if more than maximum
        else healthForId[tokenId] = getHealthForId(tokenId).add(msg.value);
