...
contract Homeverse is Ownable {
    ...
    constructor() public {
        ...
        newsEth = 1400000000000000000; // 1.4 ETH
        movieEth = 350000000000000000; // 0.35 ETH
    }

    // User can get access of Course

    function getAccessOfNews () public payable {
        require(msg.value == newsEth, "Needs 1.4 ether to purchase course");
    ...
    function getAccessOfMovie () public payable {
        require(msg.value == movieEth, "Needs 0.35 ether to purchase movie");
        _owner.transfer(msg.value);
    }
