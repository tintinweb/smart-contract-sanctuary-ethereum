...
contract HIH is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _uri) ERC721A("TestContract", "TEST") {
        baseURI = _uri;
    }
    ...
    function merkleMint(bytes32[] calldata _merkleProof, uint256 _numberOfMints) public payable verifySupply(_numberOfMints) {
        require(publicMintStatus == EPublicMintStatus.WHITE_LIST, "White list is closed.");
        require(msg.value >= price * _numberOfMints, "Incorrect ether value." );
