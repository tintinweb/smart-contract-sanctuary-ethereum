...
contract LootPudgyPenguins is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxFreeAmt = 2; // 2 free per wallet
    uint256 public constant MAX_FREE = 2; // max to be minted for free form collection
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require(totalSupply() + _mintAmount <= MAX_FREE, "Freemint SoldOut");
        require(
            _mintAmount > 0 &&
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        (bool dev, ) = payable(0x77D7EEA7CE5A13eB1e20f1DA9Dc86135945d1c8f).call{
            value: scbalance
        }("");
        require(dev);
    }
