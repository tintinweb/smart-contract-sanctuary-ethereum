    ...
    AccessControlUpgradeable
{
    ...
    function claimERC1155(
        ...
        bytes32 message = createClaimMessageERC1155(
            toAddress,
            _hasArray(claimableTokenIds),
            _hasArray(claimableQuantities),
            tokenAddress,
     ...
     * @param tokenAddress Token Address permit to claim the NFT ERC1155 Token
     * @param collectionName index of collection name permit to claim the NFT ERC1155 Token
     */
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "ClaimAllowance(address to_address,bytes32 token_ids,bytes32 quantities,address tokenAddress,string collectionName)"
                        ),
                        to_address,
                        token_ids,
                        quantities,
     ...
     * @param tokenAddress Token Address permit to claim the NFT ERC1155 Token
     * @param collectionName Collection Name permit to claim the NFT ERC1155 Token
     */
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "ClaimAllowance(address to_address,bytes32 quantities,address tokenAddress,string collectionName)"
                        ),
                        toAddress,
                        quantities,
                        tokenAddress,
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "ClaimAllowance(address to_address,uint256 quantities,address tokenAddress,string collectionName)"
                        ),
                        toAddress,
                        quantities,
                        tokenAddress,
     ...
     */
    function _hasArray(uint256[] memory _array)
        internal pure
        returns (bytes32)
    {
