...
interface ISuLiquidation is ISuLiquidationDiscount {
    ...
    function swapSuUsdToStablecoin(address stablecoinToken, uint256 amount) external;
}
...
contract SuLiquidation is SuLiquidationDiscount, ISuLiquidation {
    ...
    function swapSuUsdToAsset(
        ...
        // calculate the price of asset in worth of USD
        // TODO: is it correct that 1 SuUSD equals 1 USD here?
        uint256 priceE18 = SU_ORACLE.getUsdPrice1e18(asset);
        ...
        ) = _prepareLiquidationParams(asset, owner, priceE18, stablecoinAmountE18, minAssetAmountEDecimal);
    ...
    function swapStablecoinToAsset(
        ...
        // calculate the price of asset in worth of stablecoins
        // TODO: rename
        uint256 priceE18 = _calculatePrice(asset, stablecoinToken);
        ...
        SafeERC20.safeTransferFrom(
            ...
            msg.sender,
            address(this),
            stablecoinsToRepaymentE18 + stablecoinsToFoundationE18
        );
        ...
        SU_MANAGER.liquidate(asset, owner, msg.sender, stablecoinsToRepaymentE18, assetAmountE18);
    }

    /// @notice Swaps SuUSD to stablecoins from the whitelist
    /// @dev This is a second step of two
    /// @param stablecoinToken The address of the stablecoin token
    /// @param stablecoinAmountE18 The amount of stablecoins
    function swapSuUsdToStablecoin(
        ...
        // reduce an amount of deferred stablecoins by "stablecoinAmountE18"
        ...
        SafeERC20.safeTransfer(IERC20(stablecoinToken), msg.sender, stablecoinAmountE18);
    }

    /// @notice Returns parameters for future liquidation
    /// @param asset The address of the collateral token
    /// @param owner The owner of the collateral
    /// @param priceE18 The price of collateral in worth of stablecoins
    /// @param stablecoinAmountE18 The amount of stablecoins for the collateral buyout
    /// @param minAssetAmountEDecimal The minimum amount of collateral which the liquidator desires to obtain
    ...
    function _calculateLiquidationAssetAmount(
        ...
        uint256 collateralValueE18 = priceE18 * collateralEDecimal / 1e18;

        console.log("CALC_BONUS collateral(amount * price = assetValue):", collateralEDecimal, priceE18, collateralValueE18);
        ...
        // including bonus
        uint256 assetAmountEDecimal = stablecoinAmountWithBonusE18 * 1e18 / priceE18;
        return (assetAmountEDecimal, stablecoinAmountE18);
    }

    /// @notice Calculates the price of asset in worth of the stablecoins
    /// @param asset The address of the collateral token
    /// @param stablecoinToken The address of the stablecoin token
    function _calculatePrice(address asset, address stablecoinToken) internal view returns (uint256) {
        uint256 assetPriceE18 = SU_ORACLE.getUsdPrice1e18(asset);
        uint256 stablecoinPriceE18 = SU_ORACLE.getUsdPrice1e18(stablecoinToken);

        console.log("CALC_PRICE (asset, stablecoin): ", assetPriceE18, stablecoinPriceE18);

        return (assetPriceE18 * 1e18 / stablecoinPriceE18);
    }
