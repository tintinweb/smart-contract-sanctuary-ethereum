...
contract StoboxSoulboundIDAlpha is ERC1155Supply, AccessControl {       
    ...
    string public logo = "https://vacuflo.pl/wp-content/uploads/2021/08/gniazdo_ssace_slim_odkurzacz_centralny-1-350x350.jpg";
    uint256 private STOBOX_SOULB_ID_ALPHA = 1000;
    ...
    constructor() ERC1155("") {
        ...
        createSoulb(msg.sender, false, "UA", "https://drive.google.com/file/d/1q434KuotXE-H_ZThMbGkvHecYJsR6U_k/view?usp=sharing");       
    }
     ...
     * @param _soulbURI The link to the proper json-file of this Soulb NTT.
     */
    function createSoulb(
        address _to, 
        bool _hasKYC, 
        string memory _country, 
        string memory _soulbURI) public onlySuperAdmin returns (SoulbMeta memory) {            
            mint(_to, currentCounter, 1, "");
            string memory prefix = "AA-";
            string memory ID = STOBOX_SOULB_ID_ALPHA.toString();
            string memory counter = currentCounter.toString();
            string memory currentSoulbID = string.concat(prefix, ID, counter);
    ...
    /**
     * @notice Returns an HTTP or IPFS URL 
     *         It's important for OpenSea to have the opportunity to read metadata. 
     *         OpenSea uses this function to get data.
     * @param _uintSoulbId Uint ID of the Soulb NTT.
     */
    function uri(uint256 _uintSoulbId) public view override returns (string memory) {
        return uintSoulbIdToMetadata[_uintSoulbId].URI;
    }

    function changeLogo(string memory _newLogo) external onlySuperAdmin {
        logo = _newLogo;        
    }
     ...
     * @param _id ID of burnt NTT_token.
