...
contract GlieseZombiesNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 5555;

  bool public paused = true;
  bool public revealed = true;

  constructor() ERC721("Gliese Zombies", "GZNFT") {
    setHiddenMetadataUri("ipfs://QmS2c7DQoXb9ZkSaUZcKvXdoJvED8hr2yjzLcvVARorSiU/hidden.json");
  }
