...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1657522800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1657501200;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9E3c137ab108A34f81bFe7d9aB32C67878C8b86B];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 5021) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmec11fhWdinBQAVra2VV7vRnELoQELQFvA2FwjPGB7z9a/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 5021");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5021");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 5021");
...
// File: contracts/CandyconytownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CandyconytownContract is RamppERC721A {
    constructor() RamppERC721A("CANDYCONYTOWN", "CANDY"){}
}
