...
contract PresaleNft is ERC721PresetMinterPauserAutoId
{
     ...
     */
    function setTreasury(address address_) external admin
    {
        treasury = address_;
    }
     ...
     */
    function setFurioToken(address address_) external admin
    {
     ...
     */
    function setPresaleOneStart(uint256 start_) external admin
    {
     ...
     * @param start_ New start timestamp.
     */
    function setPresaleTwoStart(uint256 start_) external admin
    {
     ...
     * @param start_ New start timestamp.
     */
    function setPresaleThreeStart(uint256 start_) external admin
    {
     ...
     * @param max_ New max.
     */
    function setPresaleOneMax(uint256 max_) external admin
    {
        presaleOneMax = max_;
    }
     ...
     * @param max_ New max.
     */
    function setPresaleTwoMax(uint256 max_) external admin
    {
        presaleTwoMax = max_;
    }
     ...
     * @param max_ New max.
     */
    function setPresaleThreeMax(uint256 max_) external admin
    {
     ...
     */
    function setPresaleOnePrice(uint256 price_) external admin
    {
     ...
     * @param price_ New price.
     */
    function setPresaleTwoPrice(uint256 price_) external admin
    {
     ...
     * @param price_ New price.
     */
    function setPresaleThreePrice(uint256 price_) external admin
    {
     ...
     */
    function setPresaleOneSupply(uint256 supply_) external admin
    {
     ...
     * @param supply_ New supply.
     */
    function setPresaleTwoSupply(uint256 supply_) external admin
    {
     ...
     * @param supply_ New supply.
     */
    function setPresaleThreeSupply(uint256 supply_) external admin
    {
     ...
     */
    function setPresaleOneValue(uint256 value_) external admin
    {
     ...
     * @param value_ New value.
     */
    function setPresaleTwoValue(uint256 value_) external admin
    {
     ...
     * @param value_ New value.
     */
    function setPresaleThreeValue(uint256 value_) external admin
    {
