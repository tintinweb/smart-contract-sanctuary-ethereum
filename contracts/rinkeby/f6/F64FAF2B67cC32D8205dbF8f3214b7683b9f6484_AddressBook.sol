...
contract AddressBook is BaseContract
{
     ...
     */
    mapping(bytes32 => address) private _addressBook;
     ...
     */
    function set(bytes32 name_, address address_) external onlyOwner
    {
     ...
     */
    function unset(bytes32 name_) external onlyOwner
    {
     ...
     */
    function get(bytes32 name_) external view returns (address)
    {
