...
contract DeworkTasksV2 is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function mint(address to, uint256 tokenId, bool verified_) public virtual onlyOwner {
        super._mint(to, tokenId);
        setVerified(tokenId, verified_);
    }
