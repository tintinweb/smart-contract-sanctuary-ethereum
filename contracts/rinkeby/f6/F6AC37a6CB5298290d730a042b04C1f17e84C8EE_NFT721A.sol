...
contract NFT721A is Adminable, IScore, ERC721A, ERC4907A, ERC721ABurnable, EIP712WhitelistTyped, MintSetup {
    ...
    constructor() ERC721A("PFP NFT Test", "TEST") EIP712WhitelistTyped() {
        ...
        isFreeMintActive
    {
        ...
        require(_numberMinted(msg.sender) + _qty <= mintConfig.freeMintBySoulIdPerWallet, "Reached minting limit per wallet");
        ...
        checkWhitelist(_signature,"freemint")
    {
        ...
        // we assumed the free mint is the first phase of sales, so the total number minted represent free minted qty
        require(_numberMinted(msg.sender) + _qty <= mintConfig.freeMintByWLPerWallet, "Reached minting limit per wallet");
        _mint(msg.sender, _qty);
    }
