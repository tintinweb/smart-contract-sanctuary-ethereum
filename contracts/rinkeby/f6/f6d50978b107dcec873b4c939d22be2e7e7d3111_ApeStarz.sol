...
contract ApeStarz is ERC721Enumerable, Ownable {
  ...
  address[] public whitelistedAddresses = [0xf40D690550e3a244F5127494259227d32CAbd6D4,0x8fB24B307aaFE1BF02977934936487C06Ae8C1a0];
  address[] public freeMintAddresses = [0x8fB24B307aaFE1BF02977934936487C06Ae8C1a0];
  ...
  function mint(uint256 _amount) public payable {
    ...
    if ( onlyWhitelist ==true && eligibleFreeMint(msg.sender) == true){
      cost = 0 ether;
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelist == true) {
            ...
            require(mintCount + _amount <= nftPerAddressLimit, "max NFT per address exceeded");
            if (eligibleFreeMint(msg.sender) == true){
