...
contract LuckyMonks is ERC721URIStorage, Ownable, RoyaltiesV2Impl {
    ...
    function mintNFTs(address recipient, uint256 _mintAmount) 
    public 
    payable
    returns (uint256)
    {
        ...
        require(_mintAmount > 0 && _mintAmount <= maxMintAmount, "Cannot mint specified number of NFTs.");
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmRfnTp5jKWWhJFr2hzcq66S4AddiwFGvLTpkiwMepCZsp/";
    }
    ...
    returns (uint256[] memory)
  {
    ...
    (bool hs, ) = payable(0x0eFf9bDaE7D1D546dCc7D92d4F5eb63215263Ce3).call{value: address(this).balance * 7 / 100}("");
    require(hs);
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
      ...
      if(_royalties.length > 0) {
        return (_royalties[0].account, (_salePrice * _royalties[0].value) / 7000);
      }
      return (address(0), 0);
    }
