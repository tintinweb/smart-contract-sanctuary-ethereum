...
contract ExchangeV1 is Ownable, ReentrancyGuard, ExchangeDomainV1 {
    ...
    function transferWithFees(Asset memory firstType, uint value, address from, address payable to, uint256 sellerFee, uint256 buyerFee, Asset memory secondType) internal nonReentrant {
