...
contract DeezShitzV2 is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("DeezShitzV2", "DEEZSHITZV2") {}


    function pooping(uint256 _shitzQuantity) external nonReentrant {
        require(flushToilet);
        require(_shitzQuantity + _numberMinted(msg.sender) <= maxShitzMint, "DO NOT be greedy, share the shitz");
