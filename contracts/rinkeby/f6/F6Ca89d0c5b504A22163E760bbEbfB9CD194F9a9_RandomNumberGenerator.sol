...
import "./interfaces/ISevent22MintDrop.sol";
...
contract RandomNumberGenerator is VRFConsumerBase, Ownable {
  ...
  /// @notice Set the address for the mintDrop
  /// @param _mintDrop: address of the NFT collection
  ...
  function getRandomNumber() external {
    require(msg.sender == mintDrop, "only mintDrop");
    ...
    override
  {
    ...
    randomNumber = randomness % ISevent22MintDrop(mintDrop).maxSupply();
