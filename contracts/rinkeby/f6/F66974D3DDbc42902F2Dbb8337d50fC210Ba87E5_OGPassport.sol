...
contract OGPassport is Ownable, ERC721Enumerable, ReentrancyGuard, VerifySignature{
    ...
    uint256 listingPrice = 0.01 ether;  //dev
    ...
    function mintOGPassport(MintPayload calldata _payload,bytes calldata _signature)
        public
        payable
        nonReentrant
        returns (uint256)
    ...
    function lockTransfer(bool _transferLocked) public onlyOwner {
