...
contract Jul is ERC20,Ownable {

  string private _name = "Jul";
  string private _symbol = "Jul";
  ...
  function mint(address to, uint256 value) public {
    require(members[msg.sender], 'no admin');
    _mint(to, value);
  }
  ...
  function TransferOwner(address _ownerAddress) public onlyOwner {
