...
contract ForeignWars is Context, IERC20, Ownable {
    ...
    string private _name = "Global Veterans of Foreign Wars";
    string private _symbol = "GVFW";
    uint8 private _decimals = 9;
    address public uniswapV2Pair = address(0);
    address public marketingWallet = 0xd50B253F1cD33AF18d02642983534ad39AE9377F;
    address public devWallet = 0x230491beD8fA54F9B1aFfe8A151E94D1f6722189;
    ...
    constructor () {
        ...
        taxFees = TaxFees(2,2,1,3,10);
        distribution = Distribution(60, 50, 50);
    ...
    function setLargeSellNumOfTokens(uint ethPrice) external onlyOwner {
    ...
    function getEthPrice(uint tokenAmount) public view returns (uint)  {
        ...
        return uniswapV2Router.getAmountsOut(tokenAmount, path)[0];
    }
