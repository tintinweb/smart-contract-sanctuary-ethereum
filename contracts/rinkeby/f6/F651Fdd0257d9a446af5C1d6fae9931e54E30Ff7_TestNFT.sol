...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, Ownable {
    ...
    function mintTo(address _to ) payable public virtual {
        require(balanceOf(msg.sender) <= 8,"Only eight NFT Mint Per Address");
    ...
    function _presale(address _to) payable public virtual{
         require(balanceOf(msg.sender) <= 1,"Only Three NFT Mint Per Address");
        //  require(block.timestamp <= 1643620870);
