...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd05112043eA6A3B5208c21b6E7161cc805C11151;
...
contract GooDex is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd05112043eA6A3B5208c21b6E7161cc805C11151;
    ...
    uint256 private totalLiquidityFees = liquidityBuyFee.add(liquiditySellFee);
    uint256 private totalDevFees = devBuyFee.add(devSellFee);
    uint256 private totalTaxFee = marketingBuyFee.add(charitySellFee);
    
    uint256 private _liquidityFee = totalLiquidityFees;
    uint256 private _developmentFee = totalDevFees;
    uint256 private _taxFee = totalTaxFee;
