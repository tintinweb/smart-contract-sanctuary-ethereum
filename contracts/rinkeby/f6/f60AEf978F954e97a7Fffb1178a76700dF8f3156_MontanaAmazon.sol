...
contract MontanaAmazon is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(uint96 _royaltyFeesInBips) ERC721("Montana Amazon Redux Stills", "MARS") {
