...
contract KYCRECORDS is Ownable {
    ...
    uint256 public certificateindex;
    ...
    function AddCertificate(
        ...
        if (_userId == users[_userId].user_id) {
            UpdateCertificate(_userId, _certificatename, _certificate);
        } else {
    ...
    function UpdateCertificate(
      ...
      /*
     * To get Certificates of Address
     */
    function GetMedicalReports(uint256 _userid)
        public
        view
