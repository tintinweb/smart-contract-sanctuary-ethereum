...
// File: contracts/CoolKidsClub.sol
...
contract CoolKidsClub is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    address payable private _artistAddress = payable(0x72b07Be94Fb9c02051869E78D440a877C8b107a9); // to set prior to deployment
    address payable private _devAddress = payable(0x72b07Be94Fb9c02051869E78D440a877C8b107a9); // to set prior to deployment

    // Other minting variables
    bool public isPublicSaleOpen;
    uint public discountedMints = 190;
    uint public mintPrice = 79000000 gwei;
    uint private constant PAYMENT_GAS_LIMIT = 5000;


    constructor() 
        ERC721A("TestCCKC", "TCCKC") {
            _baseTokenURI = "ipfs://QmVrKLwEWPSh5MW2LsHbzC737AWSRU2pN2KL3mhwyDTZBh/"; // to set prior to deployment
            _contractMetadataURI = "ipfs://QmVrKLwEWPSh5MW2LsHbzC737AWSRU2pN2KL3mhwyDTZBh"; // to set prior to deployment
