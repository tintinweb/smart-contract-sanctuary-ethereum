...
contract SleepySniperSociety is ERC721A {
    ...
    string public contractURI = "ipfs://QmeyqrXjyQqFpCWT7m5HP4B7XeVnSjQFJ6CWWmeZ73L45a";
    ...
    function setPublicSalePrice(uint publicSalePriceParam) external onlyAdmin {
    ...
    /// @notice Reveal
    /// @param URI String of new baseURI
    function reveal(string calldata URI) external onlyAdmin {
