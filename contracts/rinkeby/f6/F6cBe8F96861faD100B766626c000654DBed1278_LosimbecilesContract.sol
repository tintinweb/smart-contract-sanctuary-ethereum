...
//
//     __              _           __              _ __         
//    / /___  _____   (_)___ ___  / /_  ___  _____(_) /__  _____
//   / / __ \/ ___/  / / __ `__ \/ __ \/ _ \/ ___/ / / _ \/ ___/
//  / / /_/ (__  )  / / / / / / / /_/ /  __/ /__/ / /  __(__  ) 
// /_/\____/____/  /_/_/ /_/ /_/_.___/\___/\___/_/_/\___/____/
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc67F1809f77B5B037dE769874f2F68e1264Ca315];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 13, 5000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNaHCt3PhPw46yfHUkxju2V5TVAZgmpwsPXN21TtF2oJk/";
...
// File: contracts/LosimbecilesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LosimbecilesContract is RamppERC721A {
    constructor() RamppERC721A("Los imbeciles", "IMBIS"){}
}
