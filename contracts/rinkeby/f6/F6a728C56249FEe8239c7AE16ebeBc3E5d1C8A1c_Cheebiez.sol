...
contract Cheebiez is ERC721A, Pausable, Ownable {
    ...
    // struct for efficiently packing time stamp data for public sale, cheeblist and mintpass
    struct SaleConfig {
        uint16 maxMint;
        uint16 maxEntries;
    ...
    constructor() ERC721A("Cheebiez", "CHEEBZ") {
        ...
        // Set the timestamps for mintpass, cheeblist and public sales
        setSaleConfig(1652641200, 10000, 20);
    ...
    */
     ...
     * @param amount number of NFTs minted (Max is 2)
     */
        ...
        callerIsUser
    {
        ...
        // require user is minting 3 or less cheebs
        require(amount < 4, "Can't mint more than 3 Cheebs from the Cheeblist!");
    ...
    */
    function setSaleConfig(uint64 startTime, uint16 newMaxEntries, uint16 newMaxMint)
        public
        onlyOwner {
        saleConfig.cheeblistStart = startTime;
        saleConfig.cheeblistEnd = startTime + 6 hours;
        saleConfig.maxEntries = newMaxEntries;
