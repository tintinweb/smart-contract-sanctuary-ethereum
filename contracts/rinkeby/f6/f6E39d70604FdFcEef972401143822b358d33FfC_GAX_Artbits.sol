...
contract GAX_Artbits is Singleton, ERC20Upgradeable {
    ...
    function updateArtbitPercentage(uint256 _dex_rp, uint256 _p2p_rp)
        public
        onlyNFT
        returns (bool)
    {
...
contract GAX_FNFT is ERC721Upgradeable {
    ...
    function updateArtbitPercentage(uint256 _nftAssetId, uint256 _dex_rp, uint256 _p2p_rp)
        external
        onlyAdmin
    {
        GAX_Artbits artbitInstance = getArtbitInstance(_nftAssetId);
        artbitInstance.updateArtbitPercentage(_dex_rp, _p2p_rp);
    }
