...
contract BullAndBear is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, KeeperCompatibleInterface, VRFConsumerBaseV2 {
    ...
    address _vrfCoordinatorV2, uint64 _subscriptionId, 
    bytes32 _keyHash, uint32 _callbackGasLimit) ERC721("Bull&Bear", "BBTK") VRFConsumerBaseV2(_vrfCoordinatorV2){
        // Sets the keeper update interval
        interval = updateInterval;
        lastTimeStamp = block.timestamp;  

        // set the price feed address to BTC/USD - 0xECe365B379E1dD183B20fc5f022230C044d51404
        // or the mock price feed contract address.
    ...
    function fulfillRandomWords(
        ...
        if(latestPrice < currentPrice){
            // bear
            updateAllTokenUris("bear", (randomWords[0] % 3));
        } else {
            // bull
            updateAllTokenUris("bull", (randomWords[0] % 3));
        }
