...
*/
contract AfterXXX is ERC721A, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public constant TOTAL_MAX_SUPPLY = 404;
    uint256 public constant TOTAL_FREE_MINTS = 40;
    uint256 public constant MAX_FREE_MINT_PER_WALLET = 1; 
    uint256 public constant MAX_PUBLIC_MINT_PER_WALLET = 2;
    ...
    constructor() ERC721A("AfterXXX", "AGR") {}
