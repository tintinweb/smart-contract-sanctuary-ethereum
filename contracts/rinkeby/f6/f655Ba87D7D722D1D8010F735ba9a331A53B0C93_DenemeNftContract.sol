...
//
//       _ _ _ _____ _____
//    __| | ___ _ __ ___ _ __ ___ ___| \ | | ___|_ _|
//   / _` |/ _ \ '_ \ / _ \ '_ ` _ \ / _ \ \| | |_ | |  
//  | (_| | __/ | | | __/ | | | | | __/ |\ | _| | |  
//   \__,_|\___|_| |_|\___|_| |_| |_|\___|_| \_|_| |_|  
//                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5D9A31547848B36ec0b8aDF7438F22Bb66747d5A];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmTXMNJpmRHzhRgYMTDF3jaxoEwzZxWg5TGBvAiJ1bBsiL/";
...
// File: contracts/DenemeNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DenemeNftContract is RamppERC721A {
    constructor() RamppERC721A("denemeNFT", "DNFT"){}
}
