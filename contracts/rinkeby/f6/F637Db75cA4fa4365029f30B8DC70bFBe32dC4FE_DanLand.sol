...
contract DanLand is ERC721, ERC721Enumerable, EIP712, IERC2981, Ownable, AccessControlEnumerable, Pausable, ERC721Burnable {
    ...
    function withdrawWnk(uint256 quantity) external onlyOwner {
    ...
    function mintByOwner(WalletNfts[] calldata nftsToMint) external onlyOwner {
    ...
    function modifySigner(address oldSigner, address newSigner) external onlyOwner {
        _revokeRole(SIGNER_ROLE, oldSigner);
        _grantRole(SIGNER_ROLE, newSigner);
    }

    function setWnkTokenAddress(address wnkAddress) external onlyOwner {
        WNK_TOKEN = IERC20(wnkAddress);
    }
    ...
    function setRoyaltyPct(uint256 royaltyPct) external onlyOwner {
