...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x53d73E9A17EA689891ab8ca0f7971dD7bA2E0388];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPp1QM5msKXBGQCzkZvzxfk6GReRUtFYYTzycRh6Drybn/";
...
// File: contracts/PudgysContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PudgysContract is RamppERC721A {
    constructor() RamppERC721A("0xPudgys", "0xPudgys"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/m50E06NGVvnEFTTLZaVX/contract-metadata";
    }
}
