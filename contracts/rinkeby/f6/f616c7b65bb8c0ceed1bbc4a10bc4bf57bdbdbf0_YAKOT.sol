...
contract YAKOT is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "YAKOT";
    string private constant _symbol = "YAKOT";
    ...
    address payable private _developmentAddress = payable(0x861D6102A08dd2e45c6B2F952E49B1F460D90cd6);//1.5% staking Gen1
    address payable private _development2Address = payable(0x834b998C85dF5a245881FC02d78965A5fcdc5C4E);//0.5% staking gen2
    address payable private _marketingAddress = payable(0x4A9Ae921756F70bE8c627A6B1229d3092300E6a5);//7% yako
    address payable private _marketing2Address = payable(0x86E18e64506FFa58Fc9e6d0d407Bd51603A689E9);//1% collective
