...
contract WuKingdom is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public MAX_PER_Transtion = 1000; // maximam amount that user can mint
  uint256 public MAX_PER_Address = 1000; // maximam amount that user can mint
  ...
  constructor() ERC721A("WuKingdom","WuKingdom NFT") {
    _beforerevealURI = "https://bafybeienl3ywudhx2usfxty6t2dixxowt623e227jhkykoflhij6kz72ea.ipfs.nftstorage.link/We%20imetadata_before_reveal.json";
}
