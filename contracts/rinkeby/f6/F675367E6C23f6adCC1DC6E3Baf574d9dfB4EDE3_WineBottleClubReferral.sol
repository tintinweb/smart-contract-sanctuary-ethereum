...
contract WineBottleClubReferral is Ownable, Pausable, ReentrancyGuard {
    ...
    function referralMint(
        ...
        require(
            address(this).balance >= _kickback * count + _mintPrice * count,
            "!reserve"
        );
    ...
    {
        return
            int256(_genesis.balanceOf(referrer)) -
            int256(_referredCount[referrer]);
    }
