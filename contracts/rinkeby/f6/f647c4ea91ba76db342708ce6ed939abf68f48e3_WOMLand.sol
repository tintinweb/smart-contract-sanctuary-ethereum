...
contract WOMLand is ERC721Enumerable, Ownable {
    ...
    uint256 public standardSupply = 250;
    uint256 public deluxeSupply = 200;
    uint256 public specialSupply = 150;
    uint256 public supremeSupply = 100;
    ...
    function updateSupply(uint256 _tokenId, uint256 _mintAmount) internal {
        if(_tokenId < 25 && _mintAmount + _tokenId < 25) {
    ...
    function minttokenId(address _to, uint256 _tokenId, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            require((_tokenId < 25 && _mintAmount + _tokenId < 25) || ((24 < _tokenId && 24 < _tokenId + _mintAmount) && (_tokenId < 35 && _tokenId + _mintAmount < 35)) || ((44 <_tokenId && 44 <_tokenId + _mintAmount) && (_tokenId<44 && _tokenId + _mintAmount<44)) || ((45 < _tokenId && 45 < _tokenId + _mintAmount) && (_tokenId < 60 && _tokenId + _mintAmount < 60)), "reserved");
