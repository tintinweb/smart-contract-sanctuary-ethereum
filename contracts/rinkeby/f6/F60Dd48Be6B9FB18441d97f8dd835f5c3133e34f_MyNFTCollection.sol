...
contract MyNFTCollection is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public RANGE_MIN_TOKEN_FOR_FREE_MINT = 5;
    uint256 public RANGE_MAX_TOKEN_FOR_FREE_MINT = 40;
    uint256 public MAX_TOKEN_MINT_ON_FREE_MINT = 5;
    uint256 public PRICE = 0.025 ether;
    address public CREATOR = 0x9dA5f33954292782C95D92a61b34981766846a62;

    constructor() ERC721("My NFT", "MNFT") {}

    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmWYYprQxfSHTq5Yj3e2F5qBSfQTpPznQjPPZtAYGFzntB/";
    }
    ...
    function safeMintCount(uint256 _count) public {
        uint256 supply = totalSupply();
        for (uint256 i = 0; i < _count; i++) {
