...
contract JustAFish is ERC721F {
    ...
    constructor() ERC721F("JustAFish", "FISH") {
        ...
        updateMerkleRoot(0xce2e88a1134e6aed1f506e50f1b7e6955f393ab803ab03871e8f9b0ad0755e78);
    ...
    function withdraw() public onlyOwner {
        ...
        _withdraw(0xD37B441828Af470746b06E5500a6fbd6b92ffeAb, (balance * 30) / 100);
        _withdraw(0x5409CfdF149d8BA163a58B25901C050d4DF8A122, (balance * 30) / 100);
        _withdraw(0x0b1B7DaAAD3912DDC1534f88ABE04679C51679c0, (balance * 40) / 100);
    }
}
