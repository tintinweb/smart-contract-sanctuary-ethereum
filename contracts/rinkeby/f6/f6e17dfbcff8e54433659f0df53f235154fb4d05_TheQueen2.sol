...
contract TheQueen2 is ERC1155, ERC2981, Ownable {
    ...
    string public _metadataURI = "https://swarm.topparts.com.my/swarm/metadata/";
    ...
    function uri(uint256 id) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, "swarm.json"));
