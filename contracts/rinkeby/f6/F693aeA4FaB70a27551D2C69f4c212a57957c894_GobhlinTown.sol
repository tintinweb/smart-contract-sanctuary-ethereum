...
contract GobhlinTown is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public littlegobblins = 1;
    ...
    //mint goblins
    function hatchgobblin() external nonReentrant {
        uint256 totalgobnlinsss = totalSupply();
        require(halt, "Minting Paused");
        require(
            totalgobnlinsss + littlegobblins <= goblins,
        ...
        _safeMint(msg.sender, littlegobblins);
        howmanygobblins[msg.sender] += littlegobblins;
    }

    //gift goblinss
    function handoutgobblins(address lords, uint256 _goblins) public onlyOwner {
        uint256 totalgobnlinsss = totalSupply();
    ...
    // how many goblins can a person mint
