...
$$ |     $$ |  $$ |$$   ____|$$ |\$$$ |$$ |  $$ |$$ |  $$ |$$   ____|$$  __$$ |$$ |  $$ |
$$$$$$$$\\$$$$$$$ |\$$$$$$$\ $$ | \$$ |\$$$$$$  |$$ |  $$ |\$$$$$$$\ \$$$$$$$ |\$$$$$$$ |
\________|\____$$ | \_______|\__|  \__| \______/ \__|  \__| \_______| \_______| \_______|
         $$\   $$ |                                                                      
         \$$$$$$  |                                                                      
          \______/                                                                       
*/
...
contract EyeNoHead is Ownable, ERC721A, ReentrancyGuard {  
    ...
    constructor() ERC721A("EyeNoHead", "$ENH") {
        uint256 _preSaleStartTime = 1654866000;
    ...
    function mintNFT(bytes32[] calldata _proof, uint256 _quantity) public payable {
        ...
        require(_saleState != SaleState.Preparing || _saleState != SaleState.PublicSale, "Not ready to mint.");
