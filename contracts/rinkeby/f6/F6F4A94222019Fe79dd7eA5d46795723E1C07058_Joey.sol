...
contract Joey is ERC721A, Ownable, ReentrancyGuard {
     ...
     */
    function mint(uint64 _quantity, bool _autoIncubate) public payable nonReentrant {
    ...
    function _beforeTokenTransfers(
        ...
        if (amount == 1 && _isIncubating(uint64(tokenId))) _unincubate(uint64(tokenId));
    }
