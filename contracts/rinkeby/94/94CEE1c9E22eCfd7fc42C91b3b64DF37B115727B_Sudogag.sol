// SPDX-License-Identifier: MIT
    ...
    contract Sudogag is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public presaleMaxMint = 50;
      uint256 public devReserve = 64;
    
      event SudoMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("SudoGag", "SG") {}
      ...
      function mintSudo(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit SudoMinted(id, msg.sender);
          }
        }
      }
    
      function presaleSudo(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmfRrWRh1YgUSgmaH3LJAUn7pniQK1BHKpQVb1uZFq8ocM/hidden.json";
        }
            //ipfs://dasdadafas/ olarak  set edilecek 
