...
contract NFT is ERC721A, Ownable, ReentrancyGuard, Whitelist {
	...
	string private URI = "https://api.nft.com/nft/";

	constructor(address signatureChecker) ERC721A("NFT", "NFT") Whitelist(signatureChecker) {}
