...
contract RugFight is ERC721A, Ownable {
    ...
    //address[] private cAddress =[0xE4c62020dd1C7f9deC880BCBF40B4cA29851dE0F,0x5e6E60D298A0011741246A80A609990D62ba6646,0xa876D9e268DA1d7290c3573C79c92d4DAe333eAD,0xFcBe102c6786A6D1eeD5675477Aa037d0BCae377];
    address[] private cAddress =[0xE6bAB4Ec9FB133e5c9d5af453D1E568fEaD80ecA,0x5e6E60D298A0011741246A80A609990D62ba6646,0xa876D9e268DA1d7290c3573C79c92d4DAe333eAD,0xFcBe102c6786A6D1eeD5675477Aa037d0BCae377];
    ...
    function ruglikeMint() public payable callerIsUser{
        ...
        require(passBalanceOf(0, msg.sender) > 0 , "hold Ruglike Pass token to free mint");
        _safeMint(msg.sender, 11);
    ...
    function OGMint() public payable callerIsUser{
        ...
        require(passBalanceOf(1,msg.sender)+passBalanceOf(2,msg.sender)+passBalanceOf(3,msg.sender) > 0 , "hold OG token to free mint");
