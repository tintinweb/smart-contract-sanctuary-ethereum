...
contract NftMarketplace is ReentrancyGuard {
    ...
    /*
     * @notice Method for listing the NFT on the mmarketplace
     ...
     */
    // making it external coz no internal function would be calling or external contracts would be calling
    function listItem(
        address nftAddress,
        uint256 tokenId,
        uint256 price
