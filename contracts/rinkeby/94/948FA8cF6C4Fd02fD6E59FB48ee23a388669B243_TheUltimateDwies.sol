...
contract TheUltimateDwies is 
    Ownable,
    ERC721A,
    ReentrancyGuard
     {
    constructor() ERC721A("THUGGS", "TheTHUGGieS", 10, 7500 ) {}
    using SafeMath for uint256;

    string public _baseTokenURI = "https://ipfs.io/ipfs/QmYRgNo7jHtKebAzDizuSgnatDHYUU85mzdjZkcxeM5keN/";

    bool public mintingOpen = false;
    uint256 mintPrice = 0.001 ether; 
    uint256 wlPrice = 0.0008 ether; 
    ...
    */
    ...
    function _widthdraw(address _address, uint256 _amount) external onlyOwner {
...
import "./openzep/Context.sol";
import "./openzep/ERC165.sol";
import "./openzep/IERC721.sol";
import "./openzep/IERC721Metadata.sol";
import "./openzep/IERC721Receiver.sol";
import "./openzep/IERC721Enumerable.sol";
import "./openzep/Address.sol";
import "./openzep/Strings.sol";
