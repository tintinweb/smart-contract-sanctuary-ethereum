...
contract Luistest2 is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_TOKENS = 13;
  address public proxyRegistryAddress;
  string public baseURI;
    
  constructor() ERC721("Luis test 2", "luistest2") {
    setBaseURI("https://blam-staging.fly.dev/api/luis-test-2-SIWEdRY/token/");
