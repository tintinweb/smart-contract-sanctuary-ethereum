...
contract AxS is ERC721A, Ownable {
    ...
    constructor() ERC721A("AxS Founder", "ERC721R") {
...
*/
    ...
    function getMintInformation(bytes32[] calldata proof) public view returns (MintInfo memory) {
//    function getMintInformation() public view returns (MintInfo memory) {
        bool _isWhiteListed = _isAllowlisted(msg.sender, proof, merkleRoot);
        uint256 _balanceOf = balanceOf(msg.sender);

        MintInfo memory newMintInfo = MintInfo(
        {
