...
// Dependency file: contracts/interfaces/ITNC.sol
...
// Dependency file: contracts/NFTSale.sol
...
// import "contracts/interfaces/ITNC.sol";
    ...
    WithdrawalElement
{
    ...
    uint256 internal NUM_OF_BATCHES = 100;
    uint256 internal ELEM_IN_BATCHES = 100;
    ...
    event UpdateTNCAddress(address TNCAddress);
    ...
    function _calculateRound() internal {
        ...
        if (
            ...
            Round storage newRound = rounds[lastRoundIndex];
            newRound.supply += (round.supply - round.collected);
        }
    }
    ...
    function _status(uint256 _roundIndex) internal view returns (STATUS) {
        ...
        if (
            ...
            if (round.collected == round.supply) {
    ...
    function _processWithRandomness(
        uint256 _requestId,
        RandomnessRequestData memory _data
    ) internal {
        ...
        uint256 tokenId = batch * NUM_OF_BATCHES + supply;

        ITNC(TNCAddress).mint(user, tokenId);
    ...
    */
    ...
    function updateTNCAddress(address _TNCAddress) external onlyOwner {
        TNCAddress = _TNCAddress;
        emit UpdateTNCAddress(_TNCAddress);
    }
...
// Root file: contracts/tests/NFTSaleMock.sol


pragma solidity ^0.8.9;

// import "contracts/NFTSale.sol";

contract NFTSaleMock is NFTSale {
    constructor(address _vrfCoordinator, address _linkTokenAddress)
        NFTSale(_vrfCoordinator, _linkTokenAddress)
    {}
