...
contract NftMarketplace is Ownable {
    ...
    mapping(address => Listing) private ERC20Listing;
    ...
    function listItemERC20(
        ...
        ERC20Listing[tokenAddress] = Listing(price, msg.sender);
    ...
    function buyItemERC20(
        ...
        require(msg.value >= amount * price, "You don't have enough money");
        ...
        tokenERC20Listing -= amount;
        emit ERC20Sold(tokenAddress, msg.sender, amount);
    }
