...
// ERC721A Contracts v4.0.0
    ...
    contract OkayPiggieYachtClub is Ownable, ERC721A {
    uint256 public maxSupply                    = 9999;
    uint256 public maxFreeSupply                = 9999;
    ...
    address constant internal TEAM_ADDRESS = 0xf0a614D3639547654cC5EF221f441269b3164d9F;
    string public baseURI = "";
    string public constant baseExtension = "";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("OkayPiggieYachtClub", "PIGGIE") {_safeMint(msg.sender, 1); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmPcqwGE8hTNg1Hm2YwH6dKCZa33U2YDpT4EDmwBuxZ3he");}
