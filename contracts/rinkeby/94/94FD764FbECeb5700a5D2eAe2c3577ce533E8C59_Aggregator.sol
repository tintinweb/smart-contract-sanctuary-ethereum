...
contract Aggregator {
  ...
  IERC20 constant internal weth = IERC20(0x5C24d78A59b5DF6aa392517C836251c2546705DE);
  IERC20 constant internal target = IERC20(0xa936fbD92b2366FB5264eD7bcF2371BB23acE71b);

  IUniswapV2Exchange constant internal exchange = IUniswapV2Exchange(0xA987b94DF2D9F81A4EAC944E9041445e729ae6a5);
  ...
  function swap(
    ...
    uint256 amount,
    uint256 minReturn
  ) public payable lock admin returns(uint256 returnAmount) {
