...
contract JoyFactory is ContextUpgradeable, AuthorizableU {
    ...
    function mintGovToken(address tokenAddress, address mintAddress, uint256 mintAmount) public onlyAuthorized {
        JoyToken joyToken = JoyToken(tokenAddress);
        joyToken.manualMint(mintAddress, mintAmount);
    }    
}
