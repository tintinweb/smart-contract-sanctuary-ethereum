...
*/
contract YKPartsOfLife is ERC721A, IERC2981, Ownable {
  ...
  constructor(
    ...
    _setRoyalties(_royaltySplitterAddress, 650);
  }
  ...
  // begin section ROYALTIES

  // @dev Set token royalties
  // @param recipient recipient of the royalties
  // @param value percentage (using 2 decimals - 10_000 = 100, 0 = 0)
  function _setRoyalties(address newRecipient, uint24 amount)
  internal
  {
    require(newRecipient != address(0), "Royalties: new recipient is the zero address");
    require(amount <= 10_000, 'Royalties: Too high');
    royalties = RoyaltyInfo(newRecipient, amount);
  }

  // @notice Set token royalties
  // @param recipient recipient of the royalties
  // @param value percentage (using 2 decimals - 10_000 = 100, 0 = 0)
  function setRoyalties(address newRecipient, uint24 amount)
  external
  onlyOwner
  {
  ...
  // end section ROYALTIES
}

/* Support OpenSea Proxy for easy trading
 * see https://github.com/ProjectOpenSea/opensea-erc1155/blob/master/contracts/ERC1155Tradable.sol
 */
