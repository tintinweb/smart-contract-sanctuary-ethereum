...
// Developed By Vermont Defi.  John Anderson (802) 787-9494
// Twitter https://twitter.com/vermontdefi
// http://vermontdefi.com
/**
...
contract CryptoPixelNFT is IERC2981, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    // public
    function setMintPrice(uint32 _mintPrice) public onlyOwner{
          mintPrice = _mintPrice;
    
    }
    function mint(uint32 _mintAmount, bytes memory _signature) public payable {
        require(msg.value == mintPrice * uint(_mintAmount), "Ethereum amount sent is not correct!");
        ...
        require(totalSupply() + _mintAmount < 16_750, "Request will exceed max supply!");
        _mintLoop(msg.sender, _mintAmount);
    }
