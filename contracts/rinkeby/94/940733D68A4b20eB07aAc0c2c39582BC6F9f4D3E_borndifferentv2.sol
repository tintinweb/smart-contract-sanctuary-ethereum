...
// File: contracts/Born different 2.sol
...
contract borndifferentv2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("born different v2", "BD") {
    setHiddenMetadataUri("ipfs://QmPgtrvYjRFoxXhCQwp92ndTAsxA41gPHfgJyRc5qCJd3v/hidden.json");
  }
