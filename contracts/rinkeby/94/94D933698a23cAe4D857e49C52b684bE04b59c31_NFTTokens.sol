...
contract NFTTokens is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("NFT Tokens", "NFT") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFTTokens(uint256 _count) public payable {
        ...
        require(
            _count > 0 && _count <= 20,
            "Min 1 & Max 20 NFTTokens can be minted per transaction"
        );
        require(
    ...
    function tokensMinted() public view returns (Counters.Counter memory) {
        return (_tokenId);
    }
