...
contract InWriting is ERC721{
    ...
    function change_start(string memory str1) public onlyOwner {
        start = str1;
    }
    ...
    function change_url(string memory url) public onlyOwner {
        external_url = url;
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = string(abi.encodePacked(
            ...
            '",\n\t"string": "', Base64.encode(bytes(get_string(tokenId))),
            '",\n\t"external_url": "', external_url, tokenID,
            '",\n\t"description": "', description,
            '",\n\t"tokenId": "', tokenID,
            '",\n\t"image_data": "', string(abi.encodePacked(start, tokenId.toString())), '"\n}'));  // format the json
