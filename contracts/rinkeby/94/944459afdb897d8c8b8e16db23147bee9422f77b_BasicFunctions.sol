...
contract BasicFunctions {
    ...
    // Structure of function = function (string memory _variable, int -variable2) public view/pure returns(bool) {}
    ...
    // Fxn that can only be called externally
