...
// File: contracts/wacky-chilli.sol
...
contract WackyChilli is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Wacky Chilli Collection", "WCC") {
    setHiddenMetadataUri("ipfs://QmShb1zpE8vD1bcWSMjC6QchWnj6BJeLDK2p9N6sk3y48v/hidden.json");
  }
