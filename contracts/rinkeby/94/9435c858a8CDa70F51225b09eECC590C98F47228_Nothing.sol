...
contract Nothing is ERC721, ReentrancyGuard, AccessControl, Ownable, TestNumbers {
    ...
    uint256 public constant ONE_YEAR = 60;
    ...
    function setColor(uint256 index, string memory value) public onlyRole(DEFAULT_ADMIN_ROLE) {
        colours[index] = value;
    }

    function enableAttestation() public onlyRole(DEFAULT_ADMIN_ROLE) {
