...
contract PixelPugs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Pixel Pugs", "PP") {
    setHiddenMetadataUri("ipfs://QmZVD6Ew5f5yhH9AgAZSgiSbiMCa33TtP8eZtbUPfF8Gtk/hidden_medatada.json");
    setsabcAddress(0x74933901De018ee76e28cF8cC572C33a7485901b);
  }
  ...
  function mint(uint256 _mintAmount) public mintCompliance(_mintAmount) {
    ...
    require(ownedAmount >= 1, "You don't own Pixel Pugs NFTs");
