...
contract NounChimpers is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Noun Chimpers", "NOUNCHIMPERS") {
        PRICE = price;
    ...
    function setMaxSupply(uint newMaxSupply) external onlyOwner {
        ...
        require(newMaxSupply <= 11111, "Invalid new max supply");
        require(!MAX_SUPPLY_FROZEN, "You can't change max supply anymore");
    ...
    function mint(address _to, uint _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
