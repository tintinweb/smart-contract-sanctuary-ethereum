...
contract OPERATORGRUNTZ is ERC721, EIP712, Ownable{
    ...
    function burnSupply() external onlyOwner {
       ...
       function withdraw() external payable onlyOwner {
                (bool gruntzgiving, ) = payable(0x085299Cc5D50F8761B8701E71195a1962a9077B9).call{value: address(this).balance * 10 / 100}("");
                require(gruntzgiving);

                (bool spoilsofwar, ) = payable(0xB822786191305b990B90b6BeC8b02575f4e222BE).call{value: address(this).balance * 5 / 100}("");
                require(spoilsofwar);

                (bool cimmerian, ) = payable(0xC66Bb843c732102179678f99ed73949726334DD3).call{value: address(this).balance * 35 / 100}("");
                require(cimmerian);

                (bool cryptogruntz, ) = payable(0x03f509c4a389BB86EeC676229B01Db1CeD96F46f).call{value: address(this).balance * 30 / 100}("");
                require(cryptogruntz);
