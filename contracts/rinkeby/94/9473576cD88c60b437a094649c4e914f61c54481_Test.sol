...
contract Test is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/610/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/610/contract-uri";
    ...
    uint256 public tokenfyPrice = 1000000000000000;

    // presale settings
    address private signerAddress;
    mapping(address => uint256) public presaleMinted;
	uint256 public presaleMaxSupply = 3;
	uint256 public presaleMaxPerMint = 2;
	...
	constructor(address _signerAddress) ERC721("Test", "TEST") {
