...
contract VVVS1R is ERC721Enumerable, Ownable {
    ...
    function freeMint(uint256 _cnt) public onlyOwner {
        require(_cnt > 0);
        require(tokenMinted + _cnt < MAX_NFT_SUPPLY, "Sale has already ended");
    ...
    function _beforeTokenTransfer(
        ...
        require(msg.sender == stakingContractAddress, "Only transferable by staking or unstaking VVVS1");
        super._beforeTokenTransfer(from, to, tokenId);
