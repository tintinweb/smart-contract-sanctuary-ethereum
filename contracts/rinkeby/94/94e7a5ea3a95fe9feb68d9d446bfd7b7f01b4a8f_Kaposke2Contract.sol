...
// File: contracts/Kaposke2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Kaposke2Contract is RamppERC721A {
    constructor() RamppERC721A("Kaposke2", "PUTZGRILA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GTILiKv6HRstYyImSUWK/contract-metadata";
    }
}
