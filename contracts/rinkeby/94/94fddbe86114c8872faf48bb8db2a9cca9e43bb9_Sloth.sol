...
contract Sloth is ERC721, ERC721Enumerable, Ownable {
  ...
  // Constants
  uint256 constant public MAX_SUPPLY = 3;//總量
  uint256 public mintPrice = 0.02 ether;//mint 價錢
  uint256 public whiteListPrice = 0.01 ether;//白名單價錢
  ...
  constructor() ERC721('KSU', 'KSUDAO') {}//token名字
