...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
 ...
 contract Youdie01 is Ownable, ERC721A, ReentrancyGuard {
    struct Config {
        uint256 maxSupply;
        uint256 reserved;
    ...
    Config public config= Config(20, 0, 10, 0.005 ether, 5, "");
    bool public isMintStarted= false;
    uint256 public maxFreeMintAmountPerTx=3;
    uint256 public maxMintAmountPerTx=5;
    constructor() ERC721A("You die 01", "yd01") 
    {
