...
contract Asset is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
  ...
  function mint(
    ...
    require(hasRole(MINTER_ROLE, _msgSender()) || publicMintingEnabled, "Asset: must have minter role to mint");
    require(_assetType < assetEnumCounter, "Can't mint with an invalid type");
  ...
  function pause() public virtual {
    require(hasRole(PAUSER_ROLE, _msgSender()), "Asset: must have pauser role to pause");
    _pause();
  }
  ...
  function unpause() public virtual {
    require(hasRole(PAUSER_ROLE, _msgSender()), "Asset: must have pauser role to unpause");
    _unpause();
  }

  function addAssetType(string memory _enumType) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "must have admin role to add enum type");
  ...
  function addSaleRole(address _account) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Asset: must have admin role to add sale contract");
    grantRole(SALE_CONTRACT_ROLE, _account);
  }

  function revokeSaleRole(address _account) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Asset: must have admin role to remove sale contract");
    revokeRole(SALE_CONTRACT_ROLE, _account);
  }

  function addMinterRole(address _account) public {
    require(hasRole(MODERATOR_ROLE, _msgSender()), "Asset: must have moderator role to add minter");
    _setupRole(MINTER_ROLE, _account);
  }

  function revokeMinterRole(address _account) public {
    require(hasRole(MODERATOR_ROLE, _msgSender()), "Asset: must have moderator role to remove minter");
    revokeRole(MINTER_ROLE, _account);
  }

  function addModeratorRole(address _account) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Asset: must have admin role to add moderator");
    grantRole(MODERATOR_ROLE, _account);
  }

  function revokeModeratorRole(address _account) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Asset: must have admin role to remove moderator");
  ...
  function setURI(string memory _uri) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Asset: must have admin role to change uri");
    ERC1155._setURI(_uri);
  }

  function enablePublicMinting() public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Asset: must have admin role to enable public minting");
