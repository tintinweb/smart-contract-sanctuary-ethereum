...
// File contracts/ERC721A.sol
    ...
    contract GTEST200 is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    ...
    uint256 public freeMaxSupply = 5;
    uint256 public maxSupply = 10;
    uint256 public price = 0.001 ether;
    bool public paused = false; 
    bool public revealed = false;
    mapping(address => uint256) public addressMinted;
    constructor() ERC721A("GTEST200", "GT200") {setHiddenMetadataUri("ipfs://QmWrX4cCtnQZPbDDVH1WMibnLYQNyW68WrEVHeAPF7u8VP/hidden.json");}
