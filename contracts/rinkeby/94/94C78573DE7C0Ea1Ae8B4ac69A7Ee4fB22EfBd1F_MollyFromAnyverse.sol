...
import "./includes/Creators.sol";
import "./includes/RG.sol";
import "./includes/Signable.sol";
...
contract MollyFromAnyverse is ERC721Enumerable, Ownable, Creators, RG, Signable {
    ...
    constructor() ERC721("MFAN V3", "MFAN")
    {
    ...
    function buy(uint256 amount, bytes calldata signature) public payable priceRequest(price * amount) {
        _buy(amount, signature);
    }

    function _buy(uint256 amount, bytes calldata signature) private lock {
...
abstract contract Creators {
    ...
    address internal constant evolution = 0x989619ced3E3651Ab4361bEeB50Aa9c6af4bA164;
    ...
    address internal constant ceo = 0xAFFee832705270a73CDC21FE907a1D08d750Ff7E;
