...
contract Withdraw is Ownable {
    ...
    constructor(){
        parts.push(Part(0x4680405a51a4315C1b242Ef86DD66041776974E4, 200));
        parts.push(Part(0x5305a37f1745a89Bb4eA1dF8342Ff460b46108d0, 200));
    }
...
contract CronosFootballClub is ICronosFootballClub, ERC721Enumerable, Ownable, Pauseable, PaymentSplitter {
    ...
    // mint price
    uint256 public MINT_PRICE = 400 gwei;
     ...
     */
    constructor(IGOAL _goal, ITraits _traits, uint256 _maxTokens, address[] memory payees, uint256[] memory shares) ERC721("Cronos FC", 'CFC') PaymentSplitter(payees, shares){
        goal = _goal;
        traits = _traits;
       // _pause();
   ...
   */
    function mintCost(uint256 tokenId) public view returns (uint256) {
        ...
        if (tokenId <= PAID_TOKENS + 1) return 2000 ether;
        if (tokenId <= PAID_TOKENS + 5) return 3000 ether;
        if (tokenId <= PAID_TOKENS + 10) return 4000 ether;
        if (tokenId <= PAID_TOKENS + 15) return 5000 ether;
