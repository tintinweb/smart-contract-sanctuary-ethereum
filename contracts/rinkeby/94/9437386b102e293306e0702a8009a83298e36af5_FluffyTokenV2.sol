...
// solhint-disable
contract FluffyTokenV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public devAddress =
        payable(0x68Abe9e0320660fDfD9D96bE91457Cb016192644);
    address payable public liquidityAddress =
        payable(0x367d3Eef94EbCB5FD8d5B31048cbBb410F36B60f);
    address payable public treasuryAddress =
        payable(0x7A149c99d09577d1379277A547e4F296E4f9E86B);
    address payable public marketingAddress =
        payable(0xa0F549eEfc27420723041756033d67B5C854e0a9);
    ...
    uint256 private constant _tTotal = 10_000_000_000 * 1e9; // 10 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Fluffy Token V2";
    string private constant _symbol = "FLUFFV2";
