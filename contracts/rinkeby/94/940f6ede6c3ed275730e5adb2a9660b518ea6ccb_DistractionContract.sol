...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUVoxxhtf3Yo3Y6eLa5fyrMcLF9b8u7AwnyM87Yt83Mwz/";
...
// File: contracts/DistractionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DistractionContract is RamppERC721A {
    constructor() RamppERC721A("Distraction", "DN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/4OD9ETuMexJnpZEv3lRF/contract-metadata";
    }
}
