...
contract PunksofPepes is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxperAddressPublicMint = 22;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("PunksofPepes", "POP") {
        setBaseURI("ipfs://QmcaUNAzKTzcXaWLkDX7cf16rcHxo6Htvipdz6GnhEKW34/");
