...
contract Eggos is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Eggos", "EGGOS") {
    setHiddenMetadataUri("ipfs://QmTeoVJX52yUeoKvRaTmwywptCT9X5XvgmwCUYdCTbUyzV/hidden.json");
