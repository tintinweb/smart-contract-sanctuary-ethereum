...
contract DiceWar is ERC20, Ownable {
    constructor() ERC20("DiceWar", "DIWA") {
    ...
    function burn(address _addr, uint amount) external admin {
        _burn(_addr, amount);
    }

    function balanceOfToken (address _addr) external view returns(uint) {
