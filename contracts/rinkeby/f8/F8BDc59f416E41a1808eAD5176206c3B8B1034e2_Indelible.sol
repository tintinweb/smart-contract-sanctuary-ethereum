// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Eyes", unicode"Mouth", unicode"Body Type", unicode"Skin", unicode"Foreground", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Silly Pepe", unicode"coming soon", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/0d51e7ab-ccc5-416d-8824-281d26a7b1a7", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/0d51e7ab-ccc5-416d-8824-281d26a7b1a7", "", 500, "0x97faF1fe826A87b7f8e3e56843b36f367A940A23");

        constructor() ERC721A(unicode"Silly Pepe", unicode"PEPEPEPE") {
            TIERS[0] = [100,100,100,100,100,100,100,100,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200];
TIERS[1] = [200,200,200,200,200,200,200,200,200,200,250,250,250,250,250,250,250,250,250,250,250,250];
TIERS[2] = [300,300,300,300,300,300,300,300,300,300,400,400,400,400,400];
TIERS[3] = [31,91,224,227,298,348,432,503,771,882,1193];
TIERS[4] = [200,200,200,200,200,200,200,200,200,200,200,200,200,300,300,300,300,300,300,300,300];
TIERS[5] = [115,131,140,148,149,206,271,313,340,412,521,603,781,870];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Silly Pepe #");
