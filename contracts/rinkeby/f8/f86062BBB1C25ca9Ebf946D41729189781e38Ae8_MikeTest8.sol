...
contract MikeTest8 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    require(success2);
		...
		// Split account 3 - 1%
    (bool success3, ) = payable(0xfb5d7FE39fb1dc1fb38B756225321DDD418f5E91).call{value: beforeBalance * 1 / 100}('');
    require(success3);

		// Split account 4 - 49.5%
