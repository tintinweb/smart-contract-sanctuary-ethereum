...
//   \  $$$/  | $$  | $$| $$\  $ | $$| $$        | $$  | $$  \ $$| $$         | $$  | $$  | $$| $$$/ \  $$$| $$\  $$$
//    \  $/   | $$  | $$| $$ \/  | $$| $$       /$$$$$$| $$  | $$| $$$$$$$$   | $$  |  $$$$$$/| $$/   \  $$| $$ \  $$
//     \_/    |__/  |__/|__/     |__/|__/      |______/|__/  |__/|________/   |__/   \______/ |__/     \__/|__/  \__/
//                                                                                                                   
//                                                                                                                   
//                                                                                                                   
//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1654219500;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA0585787de7B810744d2e5d958D20FaDd6c2bb01];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 6666 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://exampleContentID/2333123/";
...
// File: contracts/VmpContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VmpContract is RamppERC721A {
    constructor() RamppERC721A("vmp", "vpm"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/7e53rwcRVgVbpW5N8o7p/contract-metadata";
    }
}
