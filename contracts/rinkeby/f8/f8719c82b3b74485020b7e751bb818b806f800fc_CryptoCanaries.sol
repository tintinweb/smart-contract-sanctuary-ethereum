     ...
     ReentrancyGuard 
{
  ...
  string public hiddenMetadataUri = "QmVeRtmqCahQ1TvCsuVo2DVxtU2aKCvEoux6kTNeot4Ew2/hidden.json";  // add hidden metadata URL here
  
  uint256 public cost = 0.001 ether;
  uint256 public maxSupply = 6; // +1 to save on gas cost of <= vs <
...
//Modifiers help to reduce amount of code we have to type every time
...
//This function allows to check an address for multiple NFT IDs it holds
