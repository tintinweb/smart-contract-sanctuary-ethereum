...
contract IIIIIII is Context, IERC20, Ownable {
    ...
    string private constant _name = "IIIIIII";
    string private constant _symbol = "IIIIIII";
    ...
    function setBuyLimit(uint256 amount) public onlyOwner {
        maxAmountCanBuy = _tTotal * amount / 1000;
    }
