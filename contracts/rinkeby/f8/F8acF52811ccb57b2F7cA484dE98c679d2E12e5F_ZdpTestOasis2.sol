...
contract ZdpTestOasis2 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function calculateRevenue() public {
    uint256 _revenue = (address(this).balance - refundPool - withdrawPool);
    withdrawPool = withdrawPool + (_revenue / 2);
    refundPool = refundPool + (_revenue / 2);
  }
