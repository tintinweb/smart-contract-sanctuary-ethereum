...
// File: DubairichNFT.sol

pragma solidity >=0.7.0 <0.9.0;


contract DubairichNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 2775;
  uint256 public maxMintAmountPerTx = 1;
  uint256 public maxPresaleMintAmountPerTx = 1;
  uint256 public maxWalletLimit = 2;
  ...
  constructor() ERC721("Dubairich NFT ", "DRN") {
    setUriPrefix("");
    setHiddenMetadataUri("https://ipfs.io/ipfs/QmeBS3G9JWhc8PkzY9kpeXSdBPco5gQzbEhiXNhC4LBHA9/hidden.json");
  }
