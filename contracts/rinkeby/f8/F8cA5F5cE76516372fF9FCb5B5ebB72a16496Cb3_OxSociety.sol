...
contract OxSociety is ERC1155, ERC2981Base, Ownable {
  ...
  uint256 private _currentTokenID = 0; // Used to keep track of the number of different NFTs
  uint256 _maxIdPlusOne = 51;
  uint256 public _price = 0.01 ether;
  bool public _paused = true;
  string public _baseURI =
    "ipfs://QmX2nD8d3JnMrHSLQEQktaybb3Ncxp21WkHehvSr9CVKwQ";
  ...
  // modifier mintSupplyCompliant() {
  //   require(_currentIndex < _maxIdPlusOne, "NFT max supply has been reached");
  //   _;
  // }
  /**
  ...
  // function mintOnBehalf(address _to)
  //   external
  //   onlyOwner // mintSupplyCompliant
  // {
  //   mint(_to);
  // }
  ...
  function setMaxIdPlusOne(uint256 maxIdPlusOne) external onlyOwner {
    _maxIdPlusOne = maxIdPlusOne;
  }
  ...
  {
    require(id <= _maxIdPlusOne, "Invalid id");
  ...
  //   require(currentIndex < _maxIdPlusOne);
...
contract $OxSociety is OxSociety {
    ...
    function $_maxIdPlusOne() external view returns (uint256) {
        return _maxIdPlusOne;
    }
