...
contract LooxooryNFT is ERC721URIStorage, EIP712, AccessControl, Ownable {
    ...
    event RedeemEvent(address redeemer,string ipfs,uint256 minValue,uint256 tokenId,address signer);
        ...
        returns (uint256)
    {
        ...
        emit RedeemEvent(redeemer,voucher.uri,voucher.minPrice,voucher.tokenId,signer);
