...
contract DEX {
    ...
    function price(uint256 xInput, uint256 xReserves, uint256 yReserves) public pure returns (uint256 yOutput) {
        uint256 feeAmount = 0.3*10**18;
        uint256 xInputWithFee = xInput*feeAmount;
     ...
     * mapping variable being public and having a getter as a result. This is left though as it is used within 
     * the front end code (App.jsx).
     */
