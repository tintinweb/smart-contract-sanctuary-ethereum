...
// That is because we want to wait
// Why we want to wait?
// Everyone who hold the governance token has to pay 5 tokens
// TimeLock gives time to users to "get out" if they don't want to pay
