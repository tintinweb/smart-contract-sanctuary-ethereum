...
contract FairXYZDeployer is ERC721xyzUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function mint(
        ...
        uint256 phaseLimit
    ) external payable whenNotPaused saleIsOpen returns (uint256) {
     ...
     */
    function mintNoSignature(uint256 numberOfTokens) external payable whenNotPaused saleIsOpen returns (uint256) {
    ...
    IERC721MetadataUpgradeable
{
    ...
    function _mint(address to, uint256 numberOfTokens) internal virtual {
        ...
        mintData[to].balance += uint128(numberOfTokens);

        mintData[to].mintsPerWallet += uint128(numberOfTokens);
