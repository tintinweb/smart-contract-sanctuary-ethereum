...
contract Parcel is ERC721Token, Ownable {
  ...
  function tokenURI(uint256 _tokenId) public view returns (string) {
    return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmNg1N2nWv3cPH7hN5ETW4ge4cm87qdwtYqy7bKwEXvkhU/", uint2str(_tokenId), ".json"));
  }
