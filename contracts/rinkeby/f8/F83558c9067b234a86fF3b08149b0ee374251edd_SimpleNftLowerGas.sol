...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("Mya Parker (1/1s)", "MYA") {
    setHiddenMetadataUri("ipfs://QmPM4rapsbNVwbEaA8ErfUAV3JQ9mA7qfLYZ46DNvfdU44/hidden.json");
  }
 ...
 function setMerkleRoot(bytes32 _merkleRoot) public onlyOwner {
  ...
  function withdraw(address _withdrawToAddress) public onlywhitelistClaimed {
    (bool os, ) = payable(_withdrawToAddress).call{value: address(this).balance}("");
    require(os);
  }
