...
contract Royalty_GAT is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Royalty GAT ", "RGAT") {
    setHiddenMetadataUri("ipfs://QmXcLZytPxhTrQg9ZUSKo98exUHkmiXusJuuoMyz1ZNhrB/hidden.json");
  }  
  modifier onlyUser(){
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) external onlyUser {
    ...
    //require(totalGods + _mintAmount <= maxSupply);
