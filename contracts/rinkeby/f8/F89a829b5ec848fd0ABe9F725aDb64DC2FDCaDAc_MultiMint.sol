...
contract MultiMint is ERC721, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (balanceOf(msg.sender)+_mintAmount < maxMintPerUser){
  ...
  function withdraw() public onlyOwner {
    (bool multimint, ) = payable(0x4719877629C1EA3eeb65103C6bfDF1f64A5ca18d).call{value: address(this).balance * 5 / 100}("");
    require(multimint);
