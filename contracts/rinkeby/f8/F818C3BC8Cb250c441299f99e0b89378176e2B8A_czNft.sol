...
contract czNft is iczNft, ERC721Enumerable, IERC2981, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() ERC721("TREASURY", "TSRY") {
        _pause();
    }
    ...
    /** PUBLIC VARS */
    // max number of tokens that can be minted 7,777
    uint256 public override maxTokens = 7_777;
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721) returns (string memory) {
        ...
        return string(abi.encodePacked(_tokenRevealedBaseURI, Strings.toString(tokenId), ".json"));
    }
    ...
    function setMaxTokens(uint256 amount) external onlyOwner {
        require(amount <= 7_777, "NFT: Cannot inflate the supply");
        maxTokens = amount;
    }
