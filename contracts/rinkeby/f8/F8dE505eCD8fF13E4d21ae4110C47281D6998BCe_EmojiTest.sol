...
contract EmojiTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Emoji", "FREE") {
    setHiddenMetadataUri("ipfs://QmQLhkHjK1F1D7cmhWTpUdrZvPVUxUgongRBoUrsak1SeW/hidden_image_full.png");
  }
