...
contract OCASnake is Ownable, ERC721A, ERC2981, ReentrancyGuard {
    ...
    string internal permimentApple = "Different";
        ...
        returns (bytes memory)
    {
        ...
        for (uint256 i = 0; i < randomSnakeLength; i++) {
            svgData = abi.encodePacked(
                ...
                createPixel(
                    selectedColors[
                        generateAppleSeed(tokenId, 420, true) % uint256(19)
                    ],
                    250 * i,
                    325
                )
        ...
        return
            funkPictureCreator(
                [
                    selectedColors[
                        generateAppleSeed(tokenId, 69, true) % uint256(19)
                    ],
                    selectedColors[
                        generateAppleSeed(tokenId, 23, true) % uint256(19)
                    ],
                    selectedColors[
                        generateAppleSeed(tokenId, 7, true) % uint256(19)
                    ],
                    selectedColors[1],
                    selectedColors[
                        generateAppleSeed(tokenId, 143, true) % uint256(19)
                    ],
                    selectedColors[
                        uint256(generateAppleSeed(tokenId, 1337, true)) %
                            uint256(19)
                    ],
                    string(svgData),
    ...
    function getVariantSize(uint256 tokenId) internal view returns (uint256) {
        ...
        callerIsSender
    {
        ...
        tokenInfoList[tokenId].variant = uint16(variant);
    }
        ...
        returns (bytes memory)
    {
        ...
        string[3] memory metadataVars = [
            ...
            string(image_funk(tokenId, userConfigList[tokenOwner].variant)),
            Strings.toString(tokenId)
        ];
