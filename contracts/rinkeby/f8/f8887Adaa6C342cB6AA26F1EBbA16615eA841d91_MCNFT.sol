...
contract MCNFT is ERC721A, VRFConsumerBaseV2, ReentrancyGuard, EIP712Whitelisting, ERC2981ContractWideRoyalties {
    ...
    uint private maxMintPerAddress = 1;
    uint256 public revealBlock = 0;
    uint256 public seed = 0;
    uint256 public maxSupply = 1200;
    uint256 public privatePrice = 0.0008 ether; // 0.08 ether;
    uint256 public publicPrice = 0.00098 ether; // 0.098 ether;
    uint256 public airdropAmount = 200;
    uint256 public airdropMinted = 0;
    uint256 public maxPrivateMint = 500;
    uint256 public privateMintedAmount = 0;
    bool public randomseedRequested = false;
    bool public hasSaleStarted = false;

    address public vrfCoordinator = 0x6168499c0cFfCaCD319c818142124B7A15E857ab;
    bytes32 public s_keyHash = 0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc;
    ...
    string public constant MCNFT_PROVENANCE = "7d99f0f387c5aa02bae12d469a8ea36fe6f07bab0bb3aea492dd742cc6bc3e0d";
  ...
  // Assumes the subscription is funded sufficiently.
        ...
        returns (bool)
    {
        ...
        if(salePhase == SalePhase.Private) {
            ...
            require(privateMintedAmount + amount <= maxPrivateMint , "Exceed private sale limit");
            ...
            privateMintedAmount = privateMintedAmount + amount;
        }
