...
contract Test_wusanling is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("sanshihao", "shijie", 10, 30) {}
    ...
    uint256 private allowListMintAmount = 8;
    ...
    function allowListMint(uint256 quantity, bytes32[] memory proof) external payable {
        ...
        require(quantity<=maxMint, "zuiduolia");
    ...
    uint256 public amountForPublicSale = 10;
