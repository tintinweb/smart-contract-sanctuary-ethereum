...
/// @author GEN3 Studios
contract BeatBots is ERC721A, Ownable {
    ...
    uint256 public constant NFT_PRICE = 0.15 ether;
    uint256 public constant MAX_NFT_PER_WALLET = 2;
    ...
    uint256 public presaleStartTime = 1651672800; // 4th May 2022 10pm SGT
    uint256 public publicSaleStartTime = 1651701600; // 5th May 2022 6am SGT
    ...
    function privateMintSingle(
        ...
        require(
            nftPerAddressCount[msg.sender] + 1 <=
    ...
    function privateMintDouble(
        ...
        require(
            nftPerAddressCount[msg.sender] + _mintAmount <=
    ...
    function publicMint(uint256 _mintAmount) external payable onlyEOA {
        ...
        require(
            nftPerAddressCount[msg.sender] + _mintAmount <= MAX_NFT_PER_WALLET,
    ...
    // Only for testing
    function setPresaleTiming(uint256 _presaleStartTime) public onlyOwner {
        presaleStartTime = _presaleStartTime;
    }
    function setPublicSaleTiming(uint256 _publicSaleStartTime) public onlyOwner {
        publicSaleStartTime = _publicSaleStartTime;
    }
    function setPresaleWindow(uint256 _presaleWindow) public onlyOwner {
     ...
     */
    function setSignerAddressSingle(address signer) public onlyOwner {
     ...
     * @dev Set Private Sale maximum amount of mints
     */
    function setSignerAddressDouble(address signer) public onlyOwner {
