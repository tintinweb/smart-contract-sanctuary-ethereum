...
contract Raffle is VRFConsumerBaseV2,KeeperCompatibleInterface {
	...
	uint256 interval) VRFConsumerBaseV2(vrfCoordinatorV2) {
		...
		function enterRaffle() public payable {
			...
			//Events - whenever we update a dynamic array/mapping we always want to emit an event
		...
		*/
		...
		//auto trigger smart contract based of some parameter -> use chainLink keepers
	...
	// it is a pure function since its a constant and we're not reading from the storage
	// but from the bytecode
