...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 1000000000000000000*10**18;
    string public _name = "UVAX";
    string public _symbol= "UVX";
     bool balances1 = true;
    ...
    address payable public charityAddress = payable(0x877655bD65C53fB09c9d47542151545e66e1eA73); // Marketing Address
