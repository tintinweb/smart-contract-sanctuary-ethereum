...
contract Token is ERC20 {
    ...
    constructor () ERC20("TriToken", "TRT") {
...
contract NFTToken is ERC721 {
    ...
    constructor () ERC721("Martketplace", "MARK") {
        nameNFT = "Market";
        nameSymbol = "MARK";
...
contract NFTMarketPlace {
    ...
    function buyToken(uint256 amountTobuy) payable public {
        amountTobuy = msg.value;
        uint256 tokenBalance = token.balanceOf(address(this));
        require(amountTobuy > 0, "You need to send some Ether");
        //require(msg.value == amountTobuy * tokenPrice, 'Need to send exact amount of wei'); 
    ...
    function nftSell(uint256 _tokenId, bool forSale) external {
        require(msg.sender == NFT.ownerOf(_tokenId),"Only owners can change this status");
        //require(price > 0, "Price must be at least 1 TRT");
    ...
    function nftBuy(uint256 _tokenId) public {
        ...
        uint256 nftPrice = NFT.tokenIdToValue(_tokenId);
