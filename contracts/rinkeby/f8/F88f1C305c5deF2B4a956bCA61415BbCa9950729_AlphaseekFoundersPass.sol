    ...
    IMintableERC721
{
    ...
    uint256 public constant TOKEN_SUPPLY = 1111;
    ...
    constructor(
        ...
        uint96 _feeBasisPoints
    ) ERC721(_name, _symbol) AccessControlMintable() {
        _contractURI = contractURI_;
        _tokenURI = tokenURI_;
        _grantRole(DEFAULT_ADMIN_ROLE, _administrator);
        _grantRole(DEFAULT_ADMIN_ROLE, _developer);
        _setDefaultRoyalty(payable(_royaltyReceiver), _feeBasisPoints);
     ...
     */
    function mint(address to, uint256 amount) public nonReentrant onlyMinter {
    ...
    /**
     * @dev set royalty info for market places See {ERC2981-_setDefaultRoyalty}
     */
