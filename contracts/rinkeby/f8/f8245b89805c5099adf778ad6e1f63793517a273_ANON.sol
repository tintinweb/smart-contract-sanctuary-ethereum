...
contract ANON is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmT7FsKmtjwdASsBJ3NWNPQ2nHeXENyWdisPoZcyzcDoAg";
    ...
    constructor(
    ) ERC721A("???ANON???", "ANON", 100, maxSupply) {
    }
