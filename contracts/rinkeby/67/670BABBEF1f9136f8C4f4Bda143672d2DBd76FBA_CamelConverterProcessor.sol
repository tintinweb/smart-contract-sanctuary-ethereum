...
contract CamelConverterProcessor is Ownable {
    ...
    function processFunds() external {
        ...
        if (teamWallet != address(0) && marketingWallet != address(0) && address(this).balance > 0) {
            (bool sent1, ) = teamWallet.call{value: address(this).balance / 2}("");
...
contract CamelCoin is ERC20Burnable, Pausable, AccessControl {
    ...
    function setFees(
        ...
        require(_feeConverter <= 1000 && _feeConverter >= 0, "feeConverter must be less than 10%");
