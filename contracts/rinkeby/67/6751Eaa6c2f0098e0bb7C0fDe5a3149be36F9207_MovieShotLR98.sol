...
contract MovieShotLR98 is ERC721AQueryable, IERC2981, AccessControl, ReentrancyGuard {
    ...
    function mint(uint256 quantity)
        ...
        nonReentrant
    {
        require(msg.value >= publicSalePrice * quantity, "Not enough eth sent");
        require(
        ...
        if (msg.value > publicSalePrice) {
            (bool success, ) = payable(msg.sender).call{
                value: msg.value - (publicSalePrice * quantity)
            }("");
        ...
        nonReentrant
    {
        ...
        require(msg.value >= presalePrice * quantity, "Not enough eth sent");
        require(
        ...
        if (msg.value > presalePrice) {
            (bool success, ) = payable(msg.sender).call{
                value: msg.value - (presalePrice * quantity)
            }("");
            require(success, "Withdraw failed");
        }
