    ...
    PaymentSplitter 
{
    ...
    uint256 public maxSupply = 100; // Change to whatever your supply is

    string public baseURI = "ipfs://QmaeucxxVfUKCkf7VKhbr5nxrA4b77PGG8wCPYmaGb6zj9/1.json";
    string public notRevealedUri = "ipfs://QmVrT9JVd2JDX8fBQdSuNC8vW6y3FWBMCQjf1MJjqDHPFf/hidden.json";
    ...
    onlyAccounts
    {
        ...
        require(
            _amount <= presaleAmountLimit,      "CryptoPunks: You can't mint so many tokens");
        require(
            _presaleClaimed[msg.sender] + _amount <= presaleAmountLimit,  "CryptoPunks: You can't mint so many tokens");
        ...
        require(
            ...
            "CryptoPunks: Not enough ether sent"
        );
        ...
        returns (string memory)
    {
        ...
        // enter 'ipfs://CID/ -- might not need the /1.json ...
        return
