...
contract TheFryingPan is Ownable, IERC721Receiver, ReentrancyGuard {
	...
	function delBuildNumber34() internal pure {} //etherscan trick
	...
	function upgradeHideoutStakingLevel() external nonReentrant {
		...
		uint256 upgradeCost = 10000 * 2 ** (currStakingLevel.hideoutLevel++);
	...
	function upgradePoliceStationStakingLevel() external nonReentrant {
		...
		// get next upgrade requirements
		uint256 upgradeCost = 10000 * 2 ** (currStakingLevel.policeStationLevel++);
		upgradeCost = upgradeCost * 10 ** 18;
