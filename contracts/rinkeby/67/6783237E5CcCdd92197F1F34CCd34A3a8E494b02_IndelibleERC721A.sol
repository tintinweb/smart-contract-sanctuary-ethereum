// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint256 private constant MAX_TOKENS = 99;
        uint256 private constant NUM_LAYERS = 1;
        uint256 private constant MAX_BATCH_MINT = 20;
        uint256[][NUM_LAYERS] private TIERS;
        string[] private LAYER_NAMES = [unicode"1"];
        ...
        function hashFromRandomBytes(
            ...
            bytes memory hashBytes = DynamicBuffer.allocate(1024 * 128);
