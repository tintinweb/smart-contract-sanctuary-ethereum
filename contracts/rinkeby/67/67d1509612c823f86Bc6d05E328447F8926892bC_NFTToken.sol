...
contract NFTToken is ERC721, ERC721Enumerable, Ownable {
    ...
    */
    function getRandomNumber(uint256 _minNum, uint256 _maxNum)
        public
        view
        returns (uint256)
    {
    ...
    function _mintOne(address _to) private {
        ...
        uint256 _randomIdx = getRandomNumber(firstTokenId, _remainingAmt);
    ...
    function updatePresaleTime(uint256 _presaleEndTime) external onlyOwner {
        presaleEndTime = _presaleEndTime;
    }
