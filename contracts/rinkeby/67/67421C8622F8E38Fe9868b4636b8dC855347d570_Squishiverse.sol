...
contract Squishiverse is ERC721A, Ownable {
    ...
    constructor() ERC721A("Squishiverse", "SQUISHI") {}
     ...
     * Withdrawal
     */
    address private constant payoutAddress1 = 0xb95FD2042D75dEd4FCA1223d6ca552e59f92306b;

    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        Address.sendValue(payable(payoutAddress1), (balance * 100) / 100);
        // @todo add all other contributors & treasury
    }
}
