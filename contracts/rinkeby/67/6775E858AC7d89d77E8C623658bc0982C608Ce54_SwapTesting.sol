...
contract SwapTesting {
    ...
    string public name = "SwapTesting";
    ...
    function swapTokenForEth(address token, uint256 tokenAmount) external {
        require(IERC20(token).balanceOf(msg.sender) >= tokenAmount, "Token insufisant ");
