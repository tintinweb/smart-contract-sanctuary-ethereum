...
contract Primobots is ERC721A, Ownable {
    ...
    string public notrevealed_nft = "https://somewhere.com/";
    string public contract_base_uri = "https://somewhere.com/";
    ...
    */
    function dropNFT(address _to, uint256 _amount, uint256 _mintQuantity) public onlyOwner {
        uint256 reached = totalSupply() + _amount;
    ...
    */
    function buyNFT(bytes32[] calldata _merkleProof, uint _mintQuantity) public payable {
