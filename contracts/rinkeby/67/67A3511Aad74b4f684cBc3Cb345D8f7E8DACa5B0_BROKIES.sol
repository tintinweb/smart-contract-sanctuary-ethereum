...
contract BROKIES is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("No Brokies", "BROKIES") {
            ...
            if (
                ...
                if (transferDelayEnabled){
                    if (to != owner() && to != address(uniswapV2Router) && to != address(uniswapV2Pair)){
                        require(_holderLastTransferTimestamp[tx.origin] + 2 < block.number, "_transfer:: Transfer Delay enabled.  Only one purchase per block allowed.");
    ...
    function noBrokies() external onlyOwner returns (bool) {
