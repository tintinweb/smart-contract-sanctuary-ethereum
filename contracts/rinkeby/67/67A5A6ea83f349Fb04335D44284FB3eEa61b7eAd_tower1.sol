...
contract tower1 is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 2000;
  ...
  uint256 public constant MAX_MULTIMINT = 2000;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 2000 at a time");
