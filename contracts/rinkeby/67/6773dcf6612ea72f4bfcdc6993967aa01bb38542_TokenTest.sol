...
contract TokenTest is ERC721, Ownable {
    ...
    bytes32 public freeMintRoot =  0x709bdfeac823cfee30902e483e5bd2ab7599825b4e156dc233e6c2be1a44d1a3;
    bytes32 public whitelistRoot = 0xa79b47c1e2a8f0a10f8b36ab73384be4acb1b5ef97e1fc133cedc3ebc9b221ab;

    mapping(address => uint256) public whiteListTx;

    enum ChessPiece { Pawn, Knight, Bishop, Rook, Queen, King, Special }

    constructor() ERC721("testName", "tkn") {
        baseURI = "http://ibis.canuckstudios.com/metadata/";
    ...
    function reservePieces(uint256 amount) external onlyOwner {
        // TODO:// get random number for reserves
        uint256 nonce = 0;
        uint256 rand;
    ...
    function withdraw() public onlyOwner {
        ...
        // test acct
        address testAcct = 0x1e98513257fEFD5cB5d9574fBC49623c83cFac96;
        // address acct1 = 0x20Fcb3b59f0c0161A05b9BAFF5afA9741a8650bd;
        // address studio = 0xf0F39ADb1C2454f2f77394d4Da66b2DD510C6615;

        uint256 acct1_share = balance / 100 * 100;
        // uint256 studio_share = balance / 100 * 15;

        // transfer eth to addresses
        payable(testAcct).transfer(acct1_share);
