...
// Ik word hier zo gvd tyves moe van
...
contract FINALROUND is ERC721Enumerable, Ownable {
  using Strings for uint256;
     ...
     uint256 public totalSupply_ = 100;
  ...
  // public
    ...
    function freeMint(uint256 numberOfTokens) public {
        ...
        require(totalSupply_ + numberOfTokens <= maxFreeMint, "Only the first apes were free. Please use mint function now ;)");
        require(totalSupply_ + numberOfTokens <= 100, "Purchase would exceed max supply of tokens");
        
        for (uint256 i = 0; i < numberOfTokens; i++) {
            uint256 mintIndex = totalSupply_ + 1;
            if (totalSupply_ < maxFreeMint) {
