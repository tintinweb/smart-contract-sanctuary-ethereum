...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory _nm, string memory _sym, INFT _NFTContract) {
        _name = _nm;
        _symbol = _sym;
        _Owner = msg.sender;
...
contract ROOTx is ERC20 {
    constructor(INFT NFTContract) ERC20("ROOTx", "ROOTx", NFTContract) {
        _mint(msg.sender, 650000000 ether); // 
