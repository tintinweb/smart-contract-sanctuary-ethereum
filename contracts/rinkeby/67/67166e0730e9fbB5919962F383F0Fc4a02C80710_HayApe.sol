...
contract HayApe is ERC721, Ownable {
    ...
    bool public whitelistMintintOpen = false;
    ...
    function mintTo(address recipient, uint256 count) public payable {
        require(
            publicMintingOpen == true && whitelistMintintOpen == false,
    ...
    // Mint token only when whitelistMintintOpen = true
    function whitelistMintTo(
        ...
        require(
            publicMintingOpen == false && whitelistMintintOpen == true,
            "whitelistMintintOpen minting is not open right now!"
        );
