...
contract Oubita is ERC721, Ownable {
   ...
   //uint256 public NFTperAddressLimit= 20;
    ...
    //Cost in MATIC
    uint costMatic_Whitelist = 190000000000000;
    uint costMatic_Special = 1400000000000000;
    uint costMatic_Normal = 1900000000000000;
    ...
    returns (string memory)
  {
    ...
    // --- set TOKEN NATIVO PRICE 

    function price_MaticWhitelist (uint _cost)public onlyOwner{
        costMatic_Whitelist = _cost;
    }

    function price_MaticSpecial(uint _cost)public onlyOwner{
        costMatic_Special = _cost;
    }

    function price_MaticNormal(uint _cost)public onlyOwner{
        costMatic_Normal = _cost;
    }
