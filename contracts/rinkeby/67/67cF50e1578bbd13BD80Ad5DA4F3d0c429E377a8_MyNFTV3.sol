...
contract MyNFTV3 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    freeMintListRoot = 0x156f5563c155ae78821d77c9652db4b2912ac5fb1bdaee6f05756d0e0b469bc8;
    whitelistMerkleRoot = 0x27eb9d1e427ae2758462f8dad7b8f8a255615a0da053da15135b156d3ce92db5;
    specialFreemintListRoot = 0x8dab0fac5c8f03cf89c4338376e55e02a039638ac4fb610e5c6e0aeedc82f0b8;
  }
...
///////////whitelist mint
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(_whitelistmintCounter[msg.sender] <= maxMintAmountPerTx, "You are going over your maximum mint count!");
  ...
  function freeMint(uint256 _mintAmount, bytes32[] calldata _merkleProof)
        ...
        mintPriceCompliance(_mintAmount)
    {
      ...
      // Verify freemintlist requirements
        ...
        require(MerkleProof.verify(_merkleProof, freeMintListRoot, leaf) || MerkleProof.verify(_merkleProof, specialFreemintListRoot, leaf), 'Invalid proof!');
