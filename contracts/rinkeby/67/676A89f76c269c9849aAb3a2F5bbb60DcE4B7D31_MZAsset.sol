...
contract MZAsset is Admin, ERC721 {
  // Metadata base URI
  string public _tokenURI;

  constructor(address moderator, string memory baseURI) ERC721("MetaKey powered by MetaZone","METAKEY-METAKAMP") {
  ...
  function mintTo(address to, uint256 tokenId) public onlyAdmins {
    _safeMint(to, tokenId);
  }
