...
contract HYFI_Presale is Initializable, AccessControlUpgradeable {
    ...
    function _buyWithHYFIToken(
        ...
        _buyWithERC20(
            calc.getTokenData("HYFI").tokenAddress,
            HYFItokenPayment
        );
    }
    ...
    {
        require(
            IERC20Upgradeable(tokenAddress).balanceOf(msg.sender) >= priceTotal,
            "Buyer does not have enough funds to make this purchase"
        );
        IERC20Upgradeable(tokenAddress).safeTransferFrom(msg.sender, collectorWallet, priceTotal);
    }
    ...
    function _buyWithCurrency(
        ...
        payable(collectorWallet).call{gas: 200_000, value: priceTotal}("");
    }
        ...
        addressNotZero(recipient)
    {
        ...
        payable(recipient).call{gas: 200_000, value: amount}("");
        ...
        returns (bool)
    {
        ...
        IERC20Upgradeable(tokenAddress).safeTransferFrom(address(this), recipient, amount);
