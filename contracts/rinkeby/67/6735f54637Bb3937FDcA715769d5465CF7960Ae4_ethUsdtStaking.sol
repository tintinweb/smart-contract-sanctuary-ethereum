...
contract ethUsdtStaking is Ownable {
    ...
    **/
    ...
    function acceptTokenRequest(address _useraddress, address _tokenAddress) public onlyOwner{
        ...
        if(_tokenAddress == token){
            ...
            users[_useraddress].totalTokenAmount -= users[_useraddress].withdrawableAmount;   
            ...
            users[_useraddress].totalTokenAmount2 -= users[_useraddress].withdrawableAmount2;   
    ...
    */
    function convertNativeToToken(uint256 _amount) public view returns(uint256  amounts){        
        ...
        t[0] = wNative;
        t[1] = token;
        uint[] memory _amounts=uniswapV2Router.getAmountsOut(_amount,t);
        return _amounts[0];        
    }
    ...
    */
    function convertUSDTToToken(uint256 _amount) public view returns(uint256  amounts){        
        ...
        t[0] = USDT;
        t[1] = USDTxETH;
        uint[] memory _amounts=uniswapV2RouterUSDT.getAmountsOut(_amount,t);
        return _amounts[0];        
    }
