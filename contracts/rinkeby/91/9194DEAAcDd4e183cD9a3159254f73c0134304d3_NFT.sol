...
contract NFT is ERC721ABurnable, AccessControlMixin{
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    return string(abi.encodePacked(BASE_TOKEN_URI, tokenId.toString()));
  }

  function withdrawAll() public payable only(OWNER_ROLE) {
