...
contract GOMR is ERC721AQueryable, Ownable {
    ...
    function withdraw() onlyOwner public {
        ...
        require(payable(0x4eA96bFB265A47C4485a8A164917a4e8487De928).send((balance * 9500) / 10000));
        require(payable(0xe7e085E4A469AC08b12c1231f5C37410d9B12bFd).send((balance * 500) / 10000));
    }
