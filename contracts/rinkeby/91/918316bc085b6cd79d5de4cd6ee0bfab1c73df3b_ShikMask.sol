...
contract ShikMask is ERC721, Ownable, ERC721Enumerable {
    ...
    event ShikMaskMinted(uint256 tokenId, address owner);

    constructor() ERC721("ShikMask", "Mask") {}
    ...
    function mintShikMask(uint256 numberOfTokens) external {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit ShikMaskMinted(id, msg.sender);
            }
        }
    }

    function presaleShikMask(uint256 numberOfTokens) external {
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
        {
            ...
            if (isRevealed == false) {
                return
                "ipfs://QmXciw6ToZcjr2vSwMWbWgZivCHUKm5Ar8pRE7UNjbU13m/reveal.json";
                }
