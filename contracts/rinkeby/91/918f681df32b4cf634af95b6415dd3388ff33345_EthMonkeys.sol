...
contract EthMonkeys is ERC721F {
    ...
    constructor() ERC721F("EthMonkeys", "ETHM") {
        ...
        _safeMint(DEV, 0);
        updateMerkleRoot(0x0ae83551dc516a0b802cf0e0552386a138ff899fecc852540e1ff68fb6f883ad);
    }
     ...
     */
    function mint(uint256 freeTokens, uint256 numberOfTokens, bytes32[] memory merkleProof) external payable{
        if(preSaleIsActive) {
            ...
            require(freeTokens == 0, "Presale is finished" );
    ...
    function withdraw() public onlyOwner {
        ...
        _withdraw(DEV,(balance * 5) / 100);
        _withdraw(0x5409CfdF149d8BA163a58B25901C050d4DF8A122, (balance * 45) / 100);
        _withdraw(0x0b1B7DaAAD3912DDC1534f88ABE04679C51679c0, (balance * 55) / 100);
    }
}