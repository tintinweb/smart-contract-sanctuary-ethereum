...
contract WhoMag is ERC1155, ReentrancyGuard, Ownable {
    ...
    constructor() ERC1155("") {
        ...
        symbol = "WMMN";
        _releases[0] = "https://ipfs.io/ipfs/QmW86GskymZjNN63VdpLZJ8KCB5Bzc85tx79QpR2ENixq8/";
        _supplies[0] = 3333;
        _prices[0] = .03 ether;
        _minted[0] = 0;
    }
    ...
    // Input for mint batch, must be enclosed in [], since it expects an array. These are not calculated as part of the totalSupply, 
    // but will be transparent for marketplaces, use with care.
