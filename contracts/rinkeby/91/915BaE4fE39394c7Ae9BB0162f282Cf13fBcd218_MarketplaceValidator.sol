    ...
    EIP712Upgradeable
{
    ...
    //Order Struct Hash
    bytes32 internal constant _ORDER_TYPEHASH = 0xa186554f1b9ac0496ea358983bbc85a39c1dce3ee41ae9ea72202058877fd76e;
    //Bid Strcut Hash
    ...
    function verifySeller(Order calldata order) public view returns (bool) {
     ...
     */
    function validateOrder(Order calldata order, uint256 amount) public view returns (bool validated) {
    ...
    function checkTokenGate(Order calldata _order) public view {
        if (_order.isTokenGated) {
            require(INFT(_order.tokenGateAddress).balanceOf(msg.sender) > 0, "not nft holder");
        }
    }
}
