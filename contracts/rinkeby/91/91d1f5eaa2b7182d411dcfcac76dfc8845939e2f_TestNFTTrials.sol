...
contract TestNFTTrials is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test NFT Trials", "TNT") {
    setHiddenMetadataUri("ipfs://QmPMvdiUi64irBHW2cdbzthuMYZHdhgNKNimKz9yuA7UVA/hidden.json"); 
  }
  ...
  function withdraw() public onlyOwner {
    ...
    (bool hs, ) = payable(0x8677663bEd540962c00E5f8beb8e94F0A6B66672).call{value: address(this).balance * 20 / 100}("");
    require(hs);
    // =============================================================================
