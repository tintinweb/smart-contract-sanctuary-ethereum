...
contract GalacticGhostGang is ERC721A, Ownable {
	...
	uint private CURR_ROUND_SUPPLY = 1000;
	...
	constructor() ERC721A("GalacticGhostGang", "GalacticGhostGang") {
		setBaseURI("ipfs://QmbMXLthgNvHXRENri5nXNYYZFxwPj9m5xSe9cjf9iVJiz/");
	}
