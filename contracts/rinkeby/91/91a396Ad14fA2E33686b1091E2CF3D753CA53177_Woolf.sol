...
contract Woolf is IWoolf, ERC721EnumerableLite, Ownable, Pausable {
  ...
  constructor(address _wool, address _traits, uint256 _maxTokens) ERC721B("Wolf Game", "WGAME") { 
    ...
    aliases[1] = [1, 2, 4, 0, 5, 6, 7, 9, 0, 9];
    // eye
    rarities[2] = [221, 100, 181, 140, 224, 147, 84, 228, 140, 224];
    aliases[2] = [1, 2, 5, 0, 1, 7, 1, 8, 5, 8];
    // hat
    rarities[3] =  [255, 30, 60, 60, 150, 156];
    aliases[3] = [0, 0, 0, 0, 0, 0];
    // mouth
    rarities[4] = [80, 225, 227, 228, 112, 240, 64, 160, 167, 217];
    aliases[4] = [1, 2, 3, 8, 2, 8, 8, 9, 9, 0];
    // tail
    rarities[5] = [243, 189, 133, 133, 57, 95, 152, 135, 133];
    aliases[5] = [1, 7, 0, 0, 0, 0, 0, 8, 0];
    // alphaIndex
    rarities[6] = [255];
    aliases[6] = [0];
    ...
    // clothes
    rarities[8] = [75, 180, 165, 120, 60, 150, 105, 195, 45, 225];
    aliases[8] = [1, 9, 0, 0, 0, 0, 0, 0, 0, 4];
    // eye
    rarities[9] = [135, 177, 219, 141, 183, 225, 147, 189, 231, 135];
    aliases[9] = [1, 2, 3, 4, 5, 6, 7, 8, 8, 3];
    // hat
    rarities[10] =  [255, 30, 60, 60, 150, 156];
    aliases[10] = [0, 0, 0, 0, 0, 0];
    // mouth
    rarities[11] = [239, 244, 249, 234, 234, 234, 234, 234, 234, 234];
    aliases[11] = [1, 2, 8, 0, 8, 9, 8, 7, 9, 8];
    // tail 
    rarities[12] = [175, 100, 40, 250, 115, 100, 185, 175];
    aliases[12] = [3, 0, 4, 6, 6, 7, 8, 8];
    // alphaIndex
