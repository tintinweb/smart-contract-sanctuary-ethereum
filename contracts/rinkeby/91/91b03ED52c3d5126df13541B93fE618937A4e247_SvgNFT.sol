...
import "./libraries/MyStrings.sol";
...
contract SvgNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory svgFormat = generateSVG(svg, tokenId);
        ...
        returns (string memory svg)
    {
        ...
        string memory shortedFileHash = svnParam.fileHash.shorten(20);
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    unicode"存证哈希：",
                    "</text>",
                    '<text class="cls-5" transform="translate(203.07 485.28)">',
                    '<a xlink:href="https://ipfs.io/ipfs/',
                    fileHash,
                    '" target="_blank">',
                    shortedFileHash,
                    "</a>"
                    ...
                    unicode"文章作者：",
                    "</text>",
                    '<text class="cls-5" transform="translate(203.07 518.15)">',
                    author,
                    "</text>",
                    '<text class="cls-5" transform="translate(130.43 551.02)">',
                    unicode"存证时间：",
                    "</text>",
                    '<text class="cls-5" transform="translate(203.07 551.02)">',
                    date,
                    "</text>",
