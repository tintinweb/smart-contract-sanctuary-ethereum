...
// File contracts/ERC721A.sol
    ...
    contract TEST1000 is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    string public uriPrefix = "ipfs://QmboBkgcq5UfKkRoQ3pM2PWU6ksDaGVmDHgcdVNkbmmmvU/"; string public uriSuffix = ".json"; string public hiddenMetadataUri;
    ...
    constructor() ERC721A("TEST1000", "T100") {setHiddenMetadataUri("ipfs:///hidden.json");}
