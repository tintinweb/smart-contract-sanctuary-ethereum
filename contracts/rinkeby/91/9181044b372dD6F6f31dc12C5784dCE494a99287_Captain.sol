...
*
* This is the main contract that mints the Captain NFT.
* 
...
contract Captain is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    ...
    string public contractBaseURI = "http://api.bottomupnft.io/metadata/collections/captain.json";
    ...
    constructor(bool _isWhitelistLive) ERC721A("Captain", "CPTN") { 
        ...
        _setDefaultRoyalty(updaoVaultAddress,royaltyFeesInBips);
    }
