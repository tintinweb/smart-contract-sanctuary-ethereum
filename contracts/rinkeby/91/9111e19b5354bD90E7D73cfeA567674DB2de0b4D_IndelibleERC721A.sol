// SPDX-License-Identifier: MIT
  ...
  contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
      ...
      string[] private TRAIT_INDEX_NAME = ["Lasers", "Mouth", "Head", "Face", "Eyes", "Nose", "Shirt", "Skin", "Background"];
      uint256 public maxPerAddress = 100;
      uint256 public mintPrice = 0 ether;
      string public baseURI = "";
      bool public isMintingPaused = true;
      bool public useBaseURI = false;
      constructor() ERC721A("OnChainKevin", "DERP") {
          TIERS[0] = [61,159,180,196,280,403,721];
...
TIERS[8] = [27,35,60,124,176,180,206,239,244,317,392];
      ...
      function hash(
          ...
          for (uint8 i = 0; i < NUM_LAYERS; i++) {
              ...
              if (HelperLib.parseInt(rarity) < 10) {
                  hashBytes.appendSafe(
                      abi.encodePacked("0", rarity)
                  );
              } else {
          ...
          returns (string memory)
      {
          ...
          svgBytes.appendSafe('<svg class="style-on-chain-kevin" width="1200px" height="1200px" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style>.style-on-chain-kevin{background-image:url(');
          ...
          returns (string memory)
      {
          ...
          for (uint8 i = 0; i < NUM_LAYERS; i++) {
              ...
              if (i == NUM_LAYERS - 1) {
                  metadataBytes.appendSafe(abi.encodePacked("]"));
              } else {
                  metadataBytes.appendSafe(abi.encodePacked(","));
              }
          }
          ...
          returns (string memory)
      {
          ...
          if (useBaseURI) {
              return string(abi.encodePacked(baseURI, Strings.toString(_tokenId), "?dna=", tokenHash));
          }
                      ...
                      bytes(
                          string(
                              abi.encodePacked(
                                  ...
                                  '","description":"First on-chain Kevin derivative.","image_data":"',
                                  hashToSVG(tokenHash),
                                  '","attributes":',
