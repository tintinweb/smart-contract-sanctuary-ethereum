...
contract Cat is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Catpocalypse", "CAT") {}
    ...
    function presaleMint(bytes memory _signature, uint8 _amount)
        external
        callerIsUser
    {
        if (
    ...
    function setChainId(uint256 _newChainId) external onlyOwner {
        ERC721A.chainId = _newChainId;
    }

    function getChainId() external view returns (uint256) {
        return ERC721A.chainId;
    }
