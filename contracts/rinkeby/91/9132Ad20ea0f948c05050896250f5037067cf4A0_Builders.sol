...
contract Builders is ERC721Enumerable, Ownable {
    ...
    constructor(
    ) payable ERC721("For the Builders", "BUILDER") {
        setMetadataURI();
    }
    ...
    //only owner
    function setMetadataURI() public onlyOwner {
        metadataURI = 'https://peanuthub.s3.amazonaws.com/gen0/';
    }
    ...
    function setMaxMintAmountPerRequest(uint256 _newMaxMintAmountPerUser) public onlyOwner {
        maxMintPerUser = _newMaxMintAmountPerUser;
    }
    ...
    function mintPublic(uint256 numTokens) external {
        require(totalSupply() + numTokens <= maxSupply, "EXCEEDS_SUPPLY");
