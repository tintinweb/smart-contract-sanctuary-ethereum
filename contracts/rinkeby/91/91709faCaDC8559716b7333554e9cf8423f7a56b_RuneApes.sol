...
contract RuneApes is ReentrancyGuard, Ownable, ERC721A{
    ...
    function withdraw() external onlyOwner {
       ...
       uint addr0Share = address(this).balance.mul(51500).div(100000);
       uint addr1Share = address(this).balance.mul(16500).div(100000);
