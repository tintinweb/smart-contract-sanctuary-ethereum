...
contract nftestERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_SUPPLY = 25000;
    uint private constant MAX_GIFT = 100; //pour faire des cadeaux
    uint private constant MAX_WHITELIST = 25000;
    ...
    uint private constant maxPerAddressDuringWhitelistMint = 2000;
    uint private constant maxPerAddressDuringPublicMint = 3000;
    ...
    uint[] private _teamShares = [
        700,  //70% pour la première adresse etc
        295,
        5
    ];
