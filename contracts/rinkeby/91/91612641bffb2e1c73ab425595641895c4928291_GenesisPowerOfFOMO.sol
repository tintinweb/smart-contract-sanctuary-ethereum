...
contract GenesisPowerOfFOMO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmToZzvVJzVYt232jqGjysVqAzLWjwQDMiDpFeeKGwBGK8";
    address private openSeaProxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    bool private isOpenSeaProxyActive = true;

    uint256 public constant MAX_MINTS_PER_TX = 4;
    ...
    constructor(
    ) ERC721A("Genesis: Power Of FOMO", "FOMO", 100, maxSupply) {
    }
