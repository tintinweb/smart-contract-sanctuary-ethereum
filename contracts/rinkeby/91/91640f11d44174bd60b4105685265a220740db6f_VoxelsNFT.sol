  ...
  ReentrancyGuardUpgradeable
{
  ...
  function presaleMint(uint256 amount, uint256 max, bytes32[] memory proof) 
    ...
    nonReentrant
  {
    require(userData[msg.sender].presale + amount <= max, "Exceeds supply");
    userData[msg.sender].presale += amount;
    ...
    whenNotPaused
  {
    ...
    emit GenesisMint(msg.sender, _genesisTokenId, genesisWires);
    _genesisTokenId += 1;
  }
