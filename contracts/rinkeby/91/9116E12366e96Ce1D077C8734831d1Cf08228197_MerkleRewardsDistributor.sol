...
contract MerkleRewardsDistributor is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        routerContract = _initialRouterAddress;
    ...
    function _swap(
        ...
        // TODO: Are we sure there'll always exist a swap path between _amountIn token and $XYZ ?

        IERC20(_tokenIn).approve(routerContract, _amountIn);

        uint256[] memory amounts = IUniswapV2Router02(routerContract).swapExactTokensForTokens(
            _amountIn,
            _amountOutMin,
            path,
            address(this),
    ...
    function swapMultiple(
        ...
        //     //     value: msg.value
        //     // }(_amountsOutMin[0], path, address(this), block.timestamp);

        //     (bool success, ) = routerContract.call{value: msg.value}(
        ...
        for (uint256 i = 0; i < tokensToBeSwappedLen; ++i) {
            ...
            require(
                totalTokensAttributed[currentTokenToSwap] >= 0,
                "Not enough amount attributed"
            );
            _swap(
                currentTokenToSwap,
                totalTokensAttributed[currentTokenToSwap],
    ...
    function setRouterContract(address _newRouterContractAddress)
        ...
        onlyOwner
    {
        routerContract = _newRouterContractAddress;
    }
