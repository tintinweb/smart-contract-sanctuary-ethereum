...
contract NFT is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => uint256) public tokenid_to_cars;
    ...
    constructor(
        ...
        address eth_usd
    ) public VRFConsumerBase(_VRF, _LINK) ERC721(_name, _symbol) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness)
        ...
        override
    {
        randomResult = randomness % 3; // 3 cars
        tokenid_to_cars[tokenid] = randomResult;
        _safeMint(id_to_owner[tokenid], tokenid);
        tokenid += 1;
    }
