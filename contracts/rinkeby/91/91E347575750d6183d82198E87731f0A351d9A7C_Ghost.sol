...
contract Ghost is ERC721A, Ownable, Pausable {
    uint256 public mintPrice = 0 ether;
    uint256 public maxGhosts = 25000;
    uint256 public maxMint = 1000;
    string public baseURI;
    mapping (address => bool) public whitelist;

    constructor() ERC721A("Ghost", "GHOST", 1000) {
        setBaseURI("");
        _pause();
    }
    ...
    function mint(uint256 amount) external payable whenNotPaused {
        ...
        require(mintPrice * amount >= msg.value, "exact amount needed");
        require(amount <= maxMint, "max 1000 at once");
        require(totalSupply() + amount <= maxGhosts, "out of stock");
