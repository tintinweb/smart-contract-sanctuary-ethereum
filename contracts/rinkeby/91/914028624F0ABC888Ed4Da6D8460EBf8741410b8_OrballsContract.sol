...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656907200;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xDdbb9bD759feFf6b6ce24d5f177288A8361e3a7e];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQ6maPL5XDHCDPYMRvDAMsmnhoBMpARNubCb7oWv7z79P/";
...
// File: contracts/OrballsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OrballsContract is RamppERC721A {
    constructor() RamppERC721A("Orballs", "ORBALLS"){}
}
