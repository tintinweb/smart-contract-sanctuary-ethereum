...
contract MoonBlushies is ERC721, Ownable {
  ...
  uint256 public startingIndexBlock;
    ...
    uint256 public constant moonuhtorPrice = 90000000000000000; //0.09 ETH

    uint public constant maxmoonuhtorPurchase = 20;

    uint256 public MAX_Moonuhtors;
    ...
    returns (string memory)
  {
    ...
    return bytes(currentBaseURI).length > 0
        ...
        : "ipfs://QmUE5j67A9F7ngFvCyLhJHvVQ2FEMVaCngEPEeGSeeuaKd/";
  }
