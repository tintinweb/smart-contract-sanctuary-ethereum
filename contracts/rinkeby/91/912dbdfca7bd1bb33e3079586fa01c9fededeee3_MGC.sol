...
contract MGC is ERC721Enum, Ownable, ReentrancyGuard{
    using Strings for uint256;
	
    uint256 public SALE_NFT = 8666;
	uint256 public GIVEAWAY_NFT = 222;
	...
	uint256 public PRESALE_PRICE = 0.088 ether;
    ...
    constructor() ERC721P('MVP Goat Club', 'MGC') {
	}
	...
	function burnFromBabyGoat(uint256 tokenId) external {
	   require(_exists(tokenId), "Nonexistent token");
	   require(_msgSender() == babyGoat, "Incorrect Request");
	   _burn(tokenId);
	}
	
	function setBabyGoatAddress(address newAddress) external onlyOwner {
