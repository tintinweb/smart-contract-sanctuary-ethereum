...
contract KaijuLegends is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    function privateSaleMint(uint256 quantity_, bytes memory signature_)
        ...
        whenNotPaused
    {
        _validateMint(quantity_, privateSaleSupply, privateSaleMaxSupply, privateSaleActive);
        ...
        onlyPartner
    {
        ...
        _validateMint(quantity_, partnerSupply, partnerMaxSupply, partnerSaleActive);
