...
ERC1155URIStorage
{
    ...
    ) ERC1155("ipfs://QmYay6nKHdg9HoKr59gDChoSyYoDG4BHnZefUjs4BAA3G2/") {
    ...
    // standard erc1155 stuff {{{
    // TODO: better uri and setURI that takes super.uri(_tokenId) into account (if it has been set).
    //      !! Maybe I just need a mapping like revealed::(id=>boolean),
    //      although this will cost more gas and i would rather be more proud of this project 💪🏽 
