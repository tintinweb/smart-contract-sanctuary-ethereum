...
contract TradeCoinCompositionSales is ReentrancyGuard {
    ...
    event FinishCommercialTxEvent(uint256 tradeCoinTokenID, address financer);
    ...
    function finishCommercialTx(
        ...
        emit FinishCommercialTxEvent(_tradeCoinTokenID, msg.sender);
    ...
    function completeSale(
        ...
        emit CompleteSale(_tradeCoinTokenID, msg.sender);
    }

    function reverseSale(uint256 _tradeCoinTokenID) external nonReentrant {
        require(
        ...
        delete pendingSales[_tradeCoinTokenID];
        emit ReverseSale(_tradeCoinTokenID, msg.sender);
    }
}
    ...
    ReentrancyGuard
{
    ...
    function batchProduct(
        ...
        uint256[] memory tempArray = new uint256[](length + 1);
        ...
        tempArray[length] = _tokenIdCounter;
