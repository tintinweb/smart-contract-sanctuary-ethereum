...
contract BeepBoop is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BeepBoop", "BB") {
    setHiddenMetadataUri("ipfs://QmU668QgXPkWp464Da3BujBa1Tc6wmeT2vdMyzhSwtKjJN/hidden.json");
  }
