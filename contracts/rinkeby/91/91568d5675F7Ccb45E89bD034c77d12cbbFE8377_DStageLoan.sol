...
/**
  ...
  *         particular NFT. Fifth, the borrower calls DStageLoan.beginLoan() to
  ...
  *         DStageLoan.payBackLoan() and pay back the loan plus interest at any time,
  ...
  *         paid back yet, a lender can call DStageLoan.liquidateOverdueLoan(), in
...
contract DStageLoan is DStageAdmin, DStageSigningUtils, ERC721 {
  ...
  /**
    ...
    *         DStageLoan.beginLoan(), which can only occur after both the lender
    *         and borrower have approved their ERC721 and ERC20 contracts to
    *         use DStage, and when they both have signed off-chain messages that
    ...
    *         address by transferring the DStage ERC721 token that they
  ...
  /**
    ...
    *         borrower when they are first signing off-chain DStage orders.
    *         These nonces can be any uint256 value that the user has not
    *         previously used to sign an off-chain order. Each nonce can be
    *         used at most once per user within DStage, regardless of whether
    ...
    *         DStageLoan.cancelLoanCommitmentBeforeLoanHasBegun(), which marks the
  ...
  /**
    ...
    *         they are first signing off-chain DStage orders. These nonces can
    ...
    *         user within DStage, regardless of whether they are the lender or
  ...
  function beginLoan(
  ...
  ) public whenNotPaused nonReentrant returns (Loan memory) {
    ...
    // uint256 value that they have not used yet for an off-chain DStage
    // signature).
    require(
  ...
  /**
    ...
    *         DStageLoan.liquidateOverdueLoan() at any time after the loan has
    ...
    *         if a lender has called DStageLoan.liquidateOverdueLoan() before a
    *         borrower could call DStageLoan.payBackLoan(), the borrower will get
  ...
  /**
    ...
    *         first signing off-chain DStage orders. These nonces can be any
    ...
    *         within DStage, regardless of whether they are the lender or the
  ...
  // TODO: Add interface IERC1155Receiver
  /**
...
contract DStageAdmin is Ownable, Pausable, ReentrancyGuard {
  ...
  /**
    ...
    *         This parameter is used to limit the risk that DStage faces while
  ...
  /**
    ...
    *         active loans, used to limit the risk that DStage faces while the
...
contract DStageSigningUtils {
  ...
  /**
    * @notice This function is called in DStageLoan.beginLoan() to validate the
