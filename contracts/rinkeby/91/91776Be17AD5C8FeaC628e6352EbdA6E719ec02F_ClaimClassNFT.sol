...
contract ClaimClassNFT is Pausable, Ownable {
    ...
    function claim(uint256 glitch, uint256 tokenId, address receiver, bytes memory signature) external {
      require(!hasClaimed[glitch], "Already claimed");
      require(_isApprovedOrOwnerOtStaked(msg.sender, glitch), "Not approved");
    ...
    function _isApprovedOrOwnerOtStaked(address operator, uint256 glitch) internal view virtual returns (bool) {
