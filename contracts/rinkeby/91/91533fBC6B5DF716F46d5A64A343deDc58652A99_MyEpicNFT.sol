...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string baseSvg = "<svg  xmlns='http://www.w3.org/2000/svg'  preserveAspectRatio='xMinYMin meet'  viewBox='0 0 554 554'>  <defs>    <linearGradient id='Gradient1'>      <stop class='stop1' offset='100%'/>      <stop class='stop2' offset='50%'/>      <stop class='stop3' offset='100%'/>    </linearGradient>  </defs>  <style>    .base {      fill: white;      font-family: serif;      font-size: 48px;      color: #FFF;    }    .stop1 { stop-color: black; }    .stop2 { stop-color: black; stop-opacity: 0; }    .stop3 { stop-color: black; }      </style>  <rect width='100%' height='100%' fill='url(#Gradient1)' />  <text    x='50%'    y='50%'    class='base'    dominant-baseline='middle'    text-anchor='middle'  >";
  ...
  string[] firstWords = ["Crazy", "Obsessed", "Strange", "Made", "Rave", "Observing", "Zabumba", "Roket", "Gps", "Lost"];
  string[] secondWords = ["Fight", "Dingy", "Fuck", "Paradigm", "Search", "Breasts", "The", "For", "To", "James"];
  string[] thirdWords = ["Pussy", "Jungle", "Radioactive", "Bad", "Good", "Pods", "Pure", "Life", "Wanderer", "Drink"];
  event NewEpicNFTMinted (address sender, uint256 tokenId);

  constructor() ERC721 ("Broken", "Brok") {
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "The Broken Collection NFT.", "image": "data:image/svg+xml;base64,',
