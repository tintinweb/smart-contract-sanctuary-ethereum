...
//  | |\/| | | '_ \| __| |  _/ _ \| '__/ _` |/ _ \
//  | |  | | | | | | |_  | || (_) | | | (_| |  __/
//  \_|  |_/_|_| |_|\__| \_| \___/|_|  \__, |\___|
//                                      __/ |     
//                                     |___/                                                                                            

// Developer Information
// Name: Mint Forge
// Website: MintForge.app
// Mint Your NFT's Today With Our Platform
...
contract MFContract is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint public whitelist_cost = 0.0001 ether;
  ...
  function _baseURI() internal view virtual override returns (string memory) {
   ...
   function checkWhiteList(address wl) public view returns(bool){
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount, "Max 100 Mint In A Single Transaction!");
        require(balanceOf(msg.sender) + _mintAmount <= maxMintAmount, "No Max Mint");
  ...
  function setCost(uint256 _newCost) public onlyOwner() {
    ...
    function whitelistCost(uint256 _newCost) public onlyOwner() {
