...
contract KingsStake is Ownable, ReentrancyGuard {
    ...
    uint256[] _unstakePenaltyArray = [2,2,2];
    uint256[] _claimFrequencyArray = [30,60,90];
    
    constructor() {
        
        address _createrAddress = msg.sender;
        ...
        /*
        address _baseTokenAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138; 
        address _rewardTokensAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138;
        */
    ...
    function unstake(uint256 _stakeId) nonReentrant unpaused external returns (bool){
        ...
        userStakeDetails.nextClaimTime = 0;
    ...
    function setLastClaimedDay(uint256 _stakeId, uint256 _days) public onlyOwner{
        userStake memory userStakeDetails = userStakesById[_stakeId];
         uint256 stakePoolId = userStakeDetails.stakePoolId;

        stakePool memory stakePoolDetails = getStakePoolDetailsById(stakePoolId);

        userStakeDetails.lastClaimedTime = _days * 1 days;
        userStakeDetails.nextClaimTime = userStakeDetails.lastClaimedTime + (stakePoolDetails.claimFrequency * 1 days);
    ...
    function setUnlockTime(uint256 _stakeId, uint256 _time) public onlyOwner{
        userStake storage userStakeDetails = userStakesById[_stakeId];
        
        userStakeDetails.unlockTime = _time;
