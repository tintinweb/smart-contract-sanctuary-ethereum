...
interface IGasVault   {
    ...
    event withdrawn(address targetAddress, address to, uint256 amount);
...
contract DummyContract is Initializable, OwnableUpgradeable, UUPSUpgradeable, IImplementation {
    ...
    function initialize(address _orchestrator, address _steer, uint256 _tokenId, bytes calldata params) public initializer {
