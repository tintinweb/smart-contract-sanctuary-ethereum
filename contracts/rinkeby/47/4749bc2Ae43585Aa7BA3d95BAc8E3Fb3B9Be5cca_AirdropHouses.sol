...
contract AirdropHouses is ERC721, Ownable {
    ...
    constructor() ERC721("AirDropHouses - Test - 1", "RADH-1") {
        _merkleRoots[1][
            10
    ...
    function getLeftPresale() public view returns (uint256) {
        ...
        return
            _sheetsPerPrice *
            batchNum -
            (_tokenIdCounter.current() % _sheetsPerPrice);
    }
    ...
    function price() public view returns (uint256) {
        ...
        uint256 countLevel = _tokenIdCounter.current() / _sheetsPerPrice;
        ...
        returns (string memory)
    {
        ...
        return
            bytes(baseURI).length > 0
                ? string(
                    abi.encodePacked(baseURI, (tokenId + 1).toString(), ".json")
                )
                : "";
    }
    ...
    function payToWhiteMint(
        ...
        require(
            _tokenIdCounter.current() < _sheetsPerPrice * 3,
