...
import "./Royalty.sol";
import "./ERC721AEnumerableDedicated.sol";
import "./OwnablePausable.sol";

contract ERC721ARareCirclesDedicated is
    Context,
    AccessControl,
    OwnablePausable,
    ERC721ADedicated,
    ...
    Royalty
{
    ...
    constructor(
        ...
        uint256 maxSupply_
    ) Mint721AValidator("Rarecircles", "1") ERC721ADedicated(_name, _symbol) {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721ADedicated, ERC721AEnumerableDedicated, AccessControl)
        returns (bool)
    {
        return
    ...
    function tokenURI(uint256 tokenId)
        ...
        view
        virtual
        override(ERC721ADedicated, ERC721AURI)
    ...
    function totalSupply()
        ...
        view
        virtual
        override(ERC721AEnumerableDedicated, ERC721ADedicated)
        returns (uint256)
    {
        return ERC721AEnumerableDedicated.totalSupply();
    }
    ...
    function placeholderURI() public view override(ERC721AURI) returns (string memory) {
    ...
    function _beforeTokenTransfers(
        ...
        uint256 quantity
    ) internal override(ERC721ADedicated, ERC721AEnumerableDedicated) {
...
contract Mint721AValidator is EIP712 {
    ...
    function getValidator(bytes32 structHash, bytes memory signature) internal view returns (address signer) {
        bytes32 encodedHash = _hashTypedDataV4(structHash);
        signer = ECDSA.recover(encodedHash, signature);
    }
}
...
import "./ERC721ADedicated.sol";

/**
 * @title ERC721 Burnable Token
 * @dev ERC721 Token that can be irreversibly burned (destroyed).
 */
abstract contract ERC721AURI is Context, ERC721ADedicated {
 ...
 * account.
 */
abstract contract ERC721AEnumerableDedicated is
    ERC721ADedicated,
    IERC721Enumerable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165, ERC721ADedicated)
        returns (bool)
    {
        return
            interfaceId == _INTERFACE_ID_ERC165 ||
    ...
    {
        require(
            index < ERC721ADedicated.balanceOf(owner),
    ...
    function tokensOfOwner(address owner)
        ...
        returns (uint256[] memory)
    {
        uint256 tokenBalance = ERC721ADedicated.balanceOf(owner);
        require(
            tokenBalance > 0,
            "ERC721Enumerable: owner has no tokens"
        );
    ...
    function totalSupply()
        ...
        view
        virtual
        override(ERC721ADedicated, IERC721Enumerable)
        returns (uint256)
    {
        return ERC721ADedicated.totalSupply();
    }
    ...
    {
        require(
            index < ERC721AEnumerableDedicated.totalSupply(),
    ...
    function _addTokenToOwnerEnumeration(
        ...
        for (uint256 index = 0; index < quantity; index++) {
            ...
            uint256 length = ERC721ADedicated.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(
        ...
        for (uint256 index = 0; index < quantity; index++) {
            ...
            uint256 lastTokenIndex = ERC721ADedicated.balanceOf(from) - 1;
 ...
 */
contract ERC721ADedicated is Context, IERC721, IERC721Metadata {
