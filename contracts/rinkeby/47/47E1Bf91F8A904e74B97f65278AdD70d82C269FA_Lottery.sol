...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    function getAllocation(address _prtspnt, uint256 _share) internal onlyContract {
    ...
    */
    ...
    function expand(uint256 randomValue, uint256 n) internal view onlyContract returns(uint256[] memory expandedValues) {
    ...
    function transferFunds(uint256 _lvl, uint256 _index) internal onlyContract {
    ...
    function participantsIteration(uint256 _number) public pure returns(uint256) {
    ...
    Ownable 
{
    ...
    */
    ...
    function calculateShare(uint256 _bal, uint256 _day) public view contractOrLottery returns(uint256) {
            /*
