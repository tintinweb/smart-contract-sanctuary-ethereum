...
// File: contracts/nft测试网测试/nft测试2.sol
...
//这里就填写json文件在ifps的cid
  string  public  baseTokenURI = "ipfs://QmcBzvymLjLuKs5Cej55dNbFYK3S6Vndzy3hQbyWe3ft6E//";
  uint256  public  maxSupply = 9;// 最大发行量pbS
  uint256 public  MAX_MINTS_PER_TX = 4;//这个是不是单个钱包最大付费mint数量老哥
  uint256 public  PUBLIC_SALE_PRICE = 0.015 ether;//mint价格
  uint256 public  NUM_FREE_MINTS = 2;// 这是不是最大freemint数量老哥
  uint256 public  MAX_FREE_PER_WALLET = 1;// 最大freemint
  uint256 public freeNFTAlreadyMinted = 0;// 这是已经freemint 的数量吗老哥
  bool public isPublicSaleActive = true;
// 合约名称、代币简称
  constructor() ERC721A("fafafa", "thm") {
  }
