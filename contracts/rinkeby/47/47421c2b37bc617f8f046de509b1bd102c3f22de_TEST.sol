...
contract TEST is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNqUtjuLH2th8pdM39d9AfL2YrqWdaTkSimkUMt7uoXoj/KittyCat";
    ...
    constructor(
    ) ERC721A("TEST", "TEST", 100, maxSupply) {
    }
