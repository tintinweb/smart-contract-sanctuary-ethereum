...
contract Rektguy is ERC721,Ownable,ReentrancyGuard{
    ...
    */
    ...
    function setInitialBaseURI(string calldata newBaseTokenURI) public onlyOwner{
        URI = newBaseTokenURI;
    }

    function setFinalBaseURI(string calldata newBaseTokenURI) public onlyOwner{
        FINAL_URI = newBaseTokenURI;
    }
