...
contract CollectionFactoryV2 is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function createCollection(
        ...
        CollectionV2 collection = new CollectionV2();
        collection.initialize(name, symbol, _contractURI, tokenURIPrefix, msg.sender, marketplace);
 ...
 * @dev Upgradable NFT contract to create Upgradeable collection
 */
    ...
    CBRNFTDefault
{
    ...
    function initialize(
        ...
        __CollectionV2_init(name, symbol, _contractURI, tokenURIPrefix, _admin, _marketplace);
    }

    function __CollectionV2_init(
        string memory name,
        string memory symbol,
        string memory _contractURI,
        string memory tokenURIPrefix,
        ...
        __CBRNFTDefault_init(name, symbol, _contractURI, tokenURIPrefix, _admin, _marketplace);
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __Pausable_init();
        __Ownable_init();
        _tokenIdCounter.increment();
        __CollectionV2_init_unchained(_admin);
    }

    function __CollectionV2_init_unchained(address _admin) internal onlyInitializing {
    ...
    Royalties
{
    ...
    function __CBRNFTDefault_init(
        ...
        __CBRNFTDefault_init_unchained(_marketplace);
    }

    function __CBRNFTDefault_init_unchained(address _marketplace) internal onlyInitializing {}
    ...
    function burn(uint256 tokenId) public override(ERC721BurnableUpgradeable) whenNotPaused {
        _burn(tokenId);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable, Royalties)
        returns (bool)
    {
