...
contract Academy is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    ...
    uint256 tokenPrice = 1000000 wei;
    // uint256 storePrice = 10 wei;
    address ownerContract;
    mapping(string => uint256) public store;

    constructor() ERC20("Academy4", "AC4") ERC20Permit("Academy4") {
    ...
    function ico() public payable{
        ...
        _burn(ownerContract, total * 10 ** decimals());
    }

    function redeemStore() public {
        _burn(msg.sender, 10 * 10 ** decimals());
    }

    function answerToEarn(uint256 _answer) public {
         if(_answer == 100){
            this.transferFrom(ownerContract, msg.sender, 1 * 10 ** decimals());
         }
    }
