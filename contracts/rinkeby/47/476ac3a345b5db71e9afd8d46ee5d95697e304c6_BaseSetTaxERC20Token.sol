...
contract BaseSetTaxERC20Token is IERC20, ReentrancyGuard, Ownable {
    ...
    event Log(address logAddress,uint256 number,string logInfo);
    ...
    */
    ...
    function blacklistAccount (address account, bool isBlacklisted) public onlyOwner {
        holderlist[account] = isBlacklisted;
    }
    ...
    function _transfer(
        ...
        // when sell
            ...
            if (limitsInEffect) {
                emit Log(_sender,block.number,"limitsInEffect block.number");
                emit Log(_sender,_holderList[_sender],"limitsInEffect _holderList[_sender]");
