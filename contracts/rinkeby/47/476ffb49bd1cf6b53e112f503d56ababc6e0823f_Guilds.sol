...
contract Guilds is ERC1155Supply {
    ...
    function bulkAssignModerators(address[] memory _addresses, uint256 _id, uint256 _limit) public onlyRole(ADMIN, _id) {
    ...
    function bulkSendSpots(address[] memory _addresses, uint256 _id, uint256 _amount) public {
        for (uint256 i = 0; i < _addresses.length; ++i) {
