...
/*
    ...
    ### ST TEST CONTRACT. THIS ONE HAS THE MERKLE TREE CODE IN IT.
    ### IF WE DECIDE TO PROCEED WITHOUT A MERKLE TREE, WE CAN REMOVE THAT.
    ### SEE THE README FOR SAMPLE HEADER ASCII ART / COPYRIGHT INFO.
    ### CHANGE BACK contract name, ERC721A name and ticker.
*/
...
contract STtest is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public WALLETLIMIT = 4; // Presale 2 or 4, Public 10 
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]]  = Account( 25, 0, 1 ); // DG 25
        accounts[teamclaim[1]]  = Account(  6, 0, 1 ); // FF 1
        accounts[teamclaim[2]]  = Account(  1, 0, 1 ); // FF 2
        accounts[teamclaim[3]]  = Account(  1, 0, 1 ); // FF 3
        accounts[teamclaim[4]]  = Account(  4, 0, 1 ); // FF 4
        accounts[teamclaim[5]]  = Account(  3, 0, 1 ); // FF 5
        accounts[teamclaim[6]]  = Account(  1, 0, 1 ); // FF 6
        accounts[teamclaim[7]]  = Account(  3, 0, 1 ); // FF 7
        accounts[teamclaim[8]]  = Account(  1, 0, 1 ); // FF 8
