...
contract NFTRaffle is Ownable {
    ...
    function approve(address to, uint256 tokenId, address nftTokenContract) internal {
        // approve can only be called by the owner of the NFT
        IERC721(nftTokenContract).approve(to, tokenId);
    }
    ...
    */
    ...
    function approveNFT(uint tokenId, address nftTokenContract) external {
        approve(address(this), tokenId, nftTokenContract);
    }
