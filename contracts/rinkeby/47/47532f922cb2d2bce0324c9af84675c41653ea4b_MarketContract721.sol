...
// File: contracts/MarketContract721.sol
...
contract MarketContract721 is ERC721, Ownable {
    ...
    // ********************************** Breaking changes **********************************
    // * Instead of feeding the royalty percentage and calculating royalty value in smart contract now 
    //   we directly feed the royalty cut to the smart contract.
    //
    // * Service fee is mutable only by the contract owner.
    ...
    modifier HasTransferApproval(address tokenAddress, uint256 tokenId) {
        ...
        //console.log("tokenContract.getApproved(tokenId): ", tokenContract.getApproved(tokenId));
    ...
    constructor() ERC721("CreativeVault 721", "VLT") {
        ...
        //console.log("Deployed the marketplace to :", _contractOwner);
    }

    function setServiceFee(uint96 _serviceFee) public onlyOwner  {
        serviceFee = _serviceFee;
         //console.log("Deployed the marketplace to :", serviceFee);
    }
    ...
    function addItemToMarket(uint256 tokenId, address tokenAddress, uint256 askingPrice,string memory collection,string memory uri) OnlyItemOwner(tokenAddress, tokenId) HasTransferApproval(tokenAddress, tokenId) external returns(uint256) {
        ...
        //console.log("itemforsale length :", itemsForSale.length);
        //console.log("item id :", itemsForSale[newItemId].id);
    ...
    function changePrice(uint256 id, uint256 tokenId, address tokenAddress, uint256 newPrice) OnlyItemOwner(tokenAddress, tokenId) external returns(uint256) {
        ...
        //console.log("old price :", itemsForSale[id].askingPrice);

        itemsForSale[id].askingPrice = newPrice;

        //console.log("new price :", itemsForSale[id].askingPrice);
    ...
    function buyItem(uint256 id, address creator, uint256 royalty) payable external ItemExists(id) IsForSale(id) HasTransferApproval(itemsForSale[id].tokenAddress, itemsForSale[id].tokenId) {
        ...
        //console.log("id: ",itemsForSale[id].id);
        ...
        //console.log("Service fee", serviceFee/ 100,"%");
        //console.log("Total", itemsForSale[id].askingPrice);
        //console.log("Royalty",royalty);
        //console.log("Contract owners cut", itemsForSale[id].askingPrice * serviceFee / 10000);
        //console.log("Sellers cut", itemsForSale[id].askingPrice - ((itemsForSale[id].askingPrice * serviceFee / 10000) + royalty));
        ...
        if (msg.value > itemsForSale[id].askingPrice) {
            ...
            //console.log("resend",msg.value - itemsForSale[id].askingPrice );
        }
