...
contract LowerFeeContractS is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LowerFeeContractS", "LFWS") {
    setHiddenMetadataUri("ipfs://QmeazuDEPxThAv1b5LRHPjyKUQmy3BoptxEQfATtWKp3t1/hidden.json");
  }
