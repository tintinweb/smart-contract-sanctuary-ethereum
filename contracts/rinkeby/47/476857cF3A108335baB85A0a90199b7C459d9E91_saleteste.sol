...
contract saleteste is IBEP20, ReentrancyGuard, ERC721Holder, Context, Ownable {
    ...
    address marketingwallet = 0x15Ff0D4C7759350347344625142F4bbE8A467acB;
   ...
   function stake(uint256 tokenId, uint256 cargo) external {
    ...
    function unstake(uint256 tokenId, uint256 cargo) external {
        ...
        if(cargo == 1){
            ...
            _transfer(address(this), marketingwallet, burnfees); // fees
    ...
    function refRewards() public {
        require(_convidados[msg.sender] >= 1, "Voce nao possui bonus para clamar");
        uint256 valorfinal = _convidados[msg.sender] *50;
		_transfer(address(this), msg.sender, valorfinal);
        _convidados[msg.sender] = 0;
