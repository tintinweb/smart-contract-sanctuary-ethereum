...
contract ERC721MadNft is ERC721Base {
    ...
    function __ERC721MadNft_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) external initializer {
    ...
    function __ERC721MadNft_init_unchained(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) internal {
        _setBaseURI(baseURI);
...
abstract contract ERC721Base is OwnableUpgradeable, ERC721DefaultApproval, ERC721BurnableUpgradeable, ERC721Lazy, HasContractURI {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165StorageUpgradeable, ERC721Lazy) returns (bool) {
...
abstract contract ERC721BurnableUpgradeable is Initializable, ContextUpgradeable, ERC721Upgradeable {
    ...
    function burn(uint256 tokenId) public virtual {
        if(!_exists(tokenId)) {
            address owner = address(uint160(uint256(tokenId >> 96)));
...
import "./ERC721Upgradeable.sol";
import "../royalties/RoyaltiesImpl.sol";
import "../royalties/RoyaltiesUpgradeable.sol";
import "../lazy-mint/erc-721/IERC721LazyMint.sol";
import "../Mint721Validator.sol";

abstract contract ERC721Lazy is IERC721LazyMint, ERC721Upgradeable, Mint721Validator, RoyaltiesUpgradeable, RoyaltiesImpl {
    ...
    function _mint(address to, uint256 tokenId) internal virtual override {
        ...
        address minter = address(uint160(uint256(tokenId >> 96)));
 ...
 */
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165StorageUpgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, IERC721EnumerableUpgradeable {
...
contract RoyaltiesImpl is RoyaltiesBase, IRoyalties {
