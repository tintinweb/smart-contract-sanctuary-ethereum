...
contract MetaTest is ERC721Enumerable, Ownable {
  ...
  uint256 public discountprice = 0.001 ether; 
  ...
  function mint(uint256 _mintAmount) public payable {  // public check etherscan
    ...
    require(_mintAmount > 0, " Min 1 MetaTest");
    require(_mintAmount <= maxMintAmount, "max mint amount per session exceeded");
    require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");

    if (msg.sender != owner()) {
        uint256 ownerMintedCount = addressMintedBalance[msg.sender];
        require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "max MetaTest per address exceeded");
  ...
  address t1 = 0x32A2feA9F63feb642D76A2F0AB1e2948695f3820; 
  address t2 = 0x9621fCdB6da91fC017BB047680736c2cfFD807F9; 
  //address t3 = 
  //address t4 = 
  //address t5 = 
