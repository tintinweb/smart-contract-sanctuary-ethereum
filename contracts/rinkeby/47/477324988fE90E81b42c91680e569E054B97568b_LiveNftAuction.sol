...
contract LiveNftAuction is ReentrancyGuard, Ownable {
    ...
    // 0.01 ETH -- Will use price feed oracle at some point
    ...
    function listNftForAuction(
        ...
        // Transfers listing fee to auction owner
    ...
    function checkNftStatus() external onlyOwner {
        ...
        // Gets token position id from array
    ...
    function setAuctionNft() public onlyOwner {
        // Utilizes helper function to find the next NFT for auction.
    ...
    function _winNft(address _tokenFactoryAddr, uint256 _tokenId) private {
        ...
        if (bidLeader == address(0)) {
            ...
            deleteListing(_tokenFactoryAddr, _tokenId);
        } else {
            IERC721(_tokenFactoryAddr).transferFrom(
                address(this),
                bidLeader,
            ...
            // Subtracts amount bid from NFT winner
            balances[bidLeader] -= nftFinalPrice;
            // Adds amount bid from NFT winner to the seller
    ...
    function deleteListing(address _tokenFactoryAddr, uint256 _tokenId)
        private
    {
