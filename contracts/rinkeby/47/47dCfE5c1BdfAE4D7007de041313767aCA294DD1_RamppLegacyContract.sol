...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/ramppLegacyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract RamppLegacyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("RamppLegacy", "LEGACY", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/LtgEcxIVRUZWzGBm2DSD/contract-metadata";
        }
    }