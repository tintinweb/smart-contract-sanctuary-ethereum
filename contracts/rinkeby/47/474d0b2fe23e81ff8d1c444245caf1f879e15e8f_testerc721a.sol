...
contract testerc721a is ERC721A, Ownable {
    ...
    uint256 private RESERVED_OWNER = 500;
    

    bool public paused = true; 
    bool public revealed = false;

    string public baseURI = "ipfs://QmdrY8fMKeP7GFL2aa11b3qVw1YtLr3UrhMDnUx2SQwmWv/";
    string public notRevealedBaseUri = "ipfs://QmbBmqFvEonwse2aH8VqgtWUCCe59EGNZ9wyTwChyAXown/";
    string public baseExtension = ".json";

    address[] public whitelistedAddresses;

    constructor() ERC721A("Not Alone", "NTALN") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        if(msg.sender != owner()){
            ...
            require(totalSupply() + quantity <= MAX_SUPPLY - RESERVED_OWNER, "Not enough tokens left");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (revealed == true){
            ...
            currentExtension = "reveal";
        }else{
            currentBaseUri = notRevealedBaseUri;
            currentExtension = "hidden";
        }
    ...
    function setReservedOwner(uint256 _mintAmount) public onlyOwner {
        RESERVED_OWNER = _mintAmount;
    }
