...
contract OGBirds is ERC721, Pausable, Ownable {
    using Strings for uint256;

    constructor(
    ) ERC721("OGBirds", "OGBIRDS") {
        _prependURI = "-";
        _appendURI = ".json";
        ...
        _maxSupply = 10000;
        _maxTokensPerTransactionPlusOne = 101;
    ...
    function safeMint(uint256 _amount) public onlyGang {
        _safeMint(_amount);
    }

    function _safeMint(uint256 _amount) internal {
        require(
