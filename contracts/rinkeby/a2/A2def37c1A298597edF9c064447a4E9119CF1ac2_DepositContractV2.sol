...
import "./TokenPaymentSplitterV2.sol";
contract DepositContractV2 is Initializable, OwnableUpgradeable, TokenPaymentSplitterV2 {
...
abstract contract TokenPaymentSplitterV2 {
    ...
    // テスト用
    function release() public view returns (uint256) {
        return releaseTime;
    }
