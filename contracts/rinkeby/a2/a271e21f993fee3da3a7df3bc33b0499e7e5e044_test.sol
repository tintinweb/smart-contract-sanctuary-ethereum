...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _DeployGoodbye(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployGoodbye(creator, initialSupply);
    }
}

contract test is ERC20Token {
    constructor() ERC20Token("testsimple", "testsiimple", msg.sender, 1000000 * 10 ** 18) {
    }
}