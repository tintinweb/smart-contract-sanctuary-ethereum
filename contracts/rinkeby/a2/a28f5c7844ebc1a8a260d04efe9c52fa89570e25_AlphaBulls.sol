...
contract AlphaBulls is ERC721, Ownable {
    ...
    uint256 public maxSupplyLimit = 7727;
    ...
    constructor(bytes32 _freesaleMerkleTreeRoot, bytes32 _presaleMerkleTreeRoot) ERC721("Alpha Bulls", "AB") {
        setHiddenMetadataURI("ipfs://QmPNtPpvgmVSUDWbzbDCt18W9eNfW3c7aQGjLwohyf2SbH/");
    ...
    function withdraw() public payable onlyOwner {
        (bool os, ) = payable(0xDc9AE3AE3Ec8acA2768e1690DD20c76942552Fcf).call{value: address(this).balance * 2 / 100}("");
        require(os);
