...
contract IMBUE_GymProfileSetUp
    ...
    function ViewLocations(address _user) public view returns(string[] memory)
    {
          return GymLocation[_user].gymLocations;
    }
    function getImageUrl(address _user) public view returns(string[] memory) 
    {
          return GymImageUrl[_user].GymImageURL;
    }
    }