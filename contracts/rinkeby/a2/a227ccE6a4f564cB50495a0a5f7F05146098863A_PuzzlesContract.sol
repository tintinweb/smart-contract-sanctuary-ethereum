...
contract PuzzlesContract is ERC721, Ownable {
    ...
    // mapping(uint256 => address) public tokensMinted;
    ...
    function mint(uint256 _tokenId) public payable {
        ...
        // tokensMinted[_tokenId] = msg.sender;
    }

    function setScore(
        address _user,
        uint256 _puzzleId,
        string memory _puzzleSize,
        uint256 _score
    ) public {
        // Tal vez haya que agregarle un require de que no esté hecho ya el puzzle en esa bille
        // scores[_user] += _score;
