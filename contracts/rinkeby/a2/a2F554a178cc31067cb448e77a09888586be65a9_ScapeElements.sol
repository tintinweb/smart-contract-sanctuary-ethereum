...
contract ScapeElements is ERC721A, Ownable {
    ...
    constructor(address archiveAddress_) ERC721A("Scape Traits", "TRAITS") {
 ...
 * from parent (Ownable).
 */
abstract contract WithArchiveMaster is Ownable {
    ...
    function acceptOwnership() external {
        ...
        require(pendingOwner() == sender, "Archiver: caller is not the new owner");
