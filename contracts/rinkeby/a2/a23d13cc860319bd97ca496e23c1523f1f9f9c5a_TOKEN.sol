...
contract TOKEN is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                _TeamAmt = amount.mul(_teamFee).div(10000);    //3
                _liquidityAmt = amount.mul(_liquidityFee).div(10000);     //5
                _burnAmt = amount.mul(_burnFee).div(10000);          //2
            }
        } else {
            _TeamAmt = 0;
            _liquidityAmt = 0;
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        _totalSupply += Amount;       //test with decimals?
