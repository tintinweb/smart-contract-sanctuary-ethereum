...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc9BC1df06f5dD9878361b54656c30afe3b996EF4];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 40 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qma2cdTMMc15wBPtdxkVVanisG8gxi8LTt5eQahY3ofBD4/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 40");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 40");
...
// File: contracts/wallOfFamesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WallOfFamesContract is RamppERC721A {
    constructor() RamppERC721A("Wall of Fames", "WOF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/8KKu8TWJ2N4R1K9VZFNf/contract-metadata";
    }
}