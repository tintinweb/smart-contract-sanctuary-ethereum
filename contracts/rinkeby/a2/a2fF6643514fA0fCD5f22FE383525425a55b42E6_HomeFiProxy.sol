 ...
 */
contract HomeFiProxy is Initializable {
    /*******************************************************************************
     * -------------------------PUBLIC STORED PROPERTIES-------------------------- *
     *******************************************************************************/

    /// @notice Owner of HomeFiProxy
    address public owner;

    /// @notice address of HomeFiProxy Proposed Owner
    address public proposedOwner;

    /// @notice timestamp of Last HomeFiProxy Owner Replacement Proposal
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "Proxy::!Owner");
        _;
    }
    ...
    modifier noChange(address _oldAddress, address _newAddress) {
        ...
        require(_oldAddress != _newAddress, "Proxy::!Change");
        _;
    }
    ...
    {
        require(proposedOwner == msg.sender, "Proxy::!ProposedOwner");
        require(
            block.timestamp >= ownerProposalTimestamp + ONE_DAY,
            "Proxy::too soon"
        );
        // Replace owner
        owner = proposedOwner;
