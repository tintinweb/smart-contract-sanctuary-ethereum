...
contract DynamicSvg is ERC721, Ownable {
    uint private s_tokenCounter;
    string private i_lowImageUri;
    string private i_highImageUri;
    string private constant c_base64EncodedSvgPrefix =
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(c_base64EncodedSvgPrefix, svgBase64Encoded)
            );
    }
    ...
    //I think its gets called automatically when you call any mint function on ERC721 contract (like mint) but I'm not sure.
    ...
    function getLowTokenUri() public view returns (string memory) {
        return i_lowImageUri;
    }

    function getHighTokenUri() public view returns (string memory) {
        return i_lowImageUri;
    }
    ...
    function mintNft(int highValue) public {
        ...
        emit createdNFT(msg.sender, s_tokenCounter, highValue);
        s_tokenCounter++;
    }
