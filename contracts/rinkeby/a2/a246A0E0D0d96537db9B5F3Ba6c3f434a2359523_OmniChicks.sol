...
contract OmniChicks is ERC721, Ownable, NonblockingReceiver {
    ...
    string public baseURL = "ipfs://Qmcu89CVUrz1dEZ8o32qnQnN4myurbAFr162w1qKLCKAA8/";
    uint public nextId;
    uint public counter;
    ...
    ERC721("OmniChicks", "OOC")
    {
        endpoint = ILayerZeroEndpoint(endpoint_);
        beneficiary = address(0x060BCa0eAeF80Ea9A5fEB9081456aC4d4d5fa42d);
        nextId = startId_;
        MINT_PRICE = mintPrice_;
        UPPER_BOUND = upperBound_;
        // beneficiary = beneficiary_;

        // _mintTokens(msg.sender, 2);
    }
