...
// File: contracts/AzuraLowGas.sol
...
contract AzuraFinalTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bored Ukhtie Punks Club", "BUPC") {
    setHiddenMetadataUri("ipfs://URL/1.json");
  }
