...
// File: contracts/g89-eth.sol

pragma solidity ^0.8.7;

contract g89 is Ownable, ERC721, NonblockingReceiver {
    ...
    function free_mint(uint8 numTokens) external {
        ...
        require(numTokens <= maxMintTx, "g89: max 5 per transaction");
        require(
            numTokens + balanceOf(msg.sender) <= maxMintWallet,
            "g89: max wallet limit reached"
        );
        require(
            nextTokenId + numTokens <= MAX_MINT_ETH,
            "g89: mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "g89: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "g89: Failed to withdraw Ether");
    }
