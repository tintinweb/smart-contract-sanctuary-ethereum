...
contract MooniePunks is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => bool) public membershipMinted;
    ...
    uint256 public remainingMembershipMints = 130;
    uint256 public remainingPromoMints = 20;
    ...
    modifier membershipCompliance(
        ...
        /// @notice Members cannot use redemption functions until the public sale begins.
        require(publicMintEnabled, "Public sale is not active.");
        require(!checkMembershipToken(_tokenId), "Already claimed");
    ...
    {
        membershipMinted[_tokenId] = true;
        remainingMembershipMints -= _mintAmount;
    ...
    {
        return membershipMinted[_tokenId];
    }
    ...
    function setColdStorage(address _coldStorage) public onlyOwner {
        coldStorage = payable(_coldStorage);
    }

    function withdraw() public onlyOwner nonReentrant {
        bool success;
        (success, ) = coldStorage.call{value: address(this).balance}("");
