...
contract FounderFarmPass is ERC1155Supply, Ownable 
{
    ...
    uint256 public constant PRICE = 0; //0.25
    uint public reservedTokensMinted = 0;
    
    string public contractURIstr = "";
    string public name = "Founder Farm Pass";

    mapping(uint => string) public tokenURI;

    constructor() ERC1155("https://ipfs.io/ipfs/QmWxRhYz3WEPMknLD2DB6G2wySA2Sazm9ggKrwnga88Fwp/{id}.json") {}
