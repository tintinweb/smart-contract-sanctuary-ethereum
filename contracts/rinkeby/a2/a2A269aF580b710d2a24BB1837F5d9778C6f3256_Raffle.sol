...
// importing chainlink verifiable random number and keepers
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // State Variables
    uint256 private immutable i_entranceFee; // immutable -> only setting once
    address payable[] private s_players; // payable -> when a player wins, we need to pay them
    ...
    // couldve tracked state as such but isnt as good as enums
    ...
    constructor(
        address vrfCoordinatorv2, //contract - may need to deploy a mock!
        uint256 entranceFee,
        bytes32 keyHash,
    ...
    function enterRaffle() public payable {
        ...
        s_players.push(payable(msg.sender)); // type cast msg.sender from address into payable address
