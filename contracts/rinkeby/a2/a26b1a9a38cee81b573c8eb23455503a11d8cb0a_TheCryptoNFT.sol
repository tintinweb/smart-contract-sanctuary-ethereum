...
pragma solidity ^0.8.0;
contract TheCryptoNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public constant TOKENS_PUBLIC = 3000;
	uint256 public constant TOKENS_TEAM = 350;
	uint256 public constant TOKENS_PUBLIC_PRESALE = 1350;
    uint256 public constant PURCHASE_LIMIT = 50;
	uint256 public constant PURCHASE_LIMIT_PRESALE = 50;
    uint256 public constant PRICE = 200_000_000_000_000; // 0.002 ETH
    ...
    constructor() ERC721("The Crypto", "THE") {
        ...
        onlyOwner
    {
        require(
            ...
            "Purchase would exceed TOKENS_TEAM"
        );
    ...
    function purchaseAllowList(uint256 numberOfTokens) external payable nonReentrant {
        ...
        require(PRICE * numberOfTokens <= msg.value, "BNB amount is not sufficient");
        require(
            _publicTotalTokens.current() < TOKENS_PUBLIC,
