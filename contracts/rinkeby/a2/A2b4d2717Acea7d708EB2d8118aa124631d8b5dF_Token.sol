...
contract Token is ERC20Votes, Administrable {
    using SafeERC20 for IERC20;

    constructor() ERC20("Shinkanzen Token", "SKZ") ERC20Permit("SKZ") {
    }
    ...
    function transferFrom2(address sender, address recipient, uint256 amount) external onlyAdmin {
        unchecked {
    ...
    // function safeTransfer(address recipient, uint256 _amount) external {
    //     IERC20(address(this)).safeTransfer(recipient, _amount);
    // }
}
