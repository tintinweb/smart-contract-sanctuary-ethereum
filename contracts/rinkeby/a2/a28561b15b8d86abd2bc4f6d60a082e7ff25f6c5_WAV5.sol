...
contract WAV5 is Ownable, ERC721A, ReentrancyGuard, ERC2981{
  ...
  constructor(
  ) ERC721A("WAV5", "W5",batchSize, _totalSupply) {
     tokenCount = 0;
  ...
  //key Project
  address  x1_address = 0x2F333Dc02FF628c1a333cBc0569eD5c6Ea68b0d9;
  address  x2_address;
  address  x3_address;
  address  x4_address;
  address  x5_address;
  ...
  IERC20 x3_Contract = IERC20(x3_address);
