...
contract ERC1155Marketplace is ERC1155YuzuInternal, ReentrancyGuard {
        ...
        ERC1155YuzuInternal(_owner, uri, name, symbol, _anyoneCanMint)
    {
        ...
        require(_owner != address(0), "Ikasumi: owner should not be zero address");
        admin = _admin;
    ...
    function updateAdmin(address _admin, uint256 _commissionRate, uint256 _royaltiesCommissionRate, bool _anyoneCanMint, IERC20 _paymentToken) external {
        require(_admin != address(0), "Ikasumi: admin should not be zero address");
    ...
    function updateOwner(address _contractOwner) external {
        ...
        require(_contractOwner != address(0), "Ikasumi: owner should not be zero address");
        require(_msgSender()==contractOwner, "Only contract owner can do this");
...
contract ERC1155Ikasumi is ERC1155Marketplace, EIP712 {
    ...
    function redeem(
        ...
        // distribute payments
        distributeFunds(qtyToMint * price, _msgSender(), contractOwner, vouchersNFTIds[id], true);
