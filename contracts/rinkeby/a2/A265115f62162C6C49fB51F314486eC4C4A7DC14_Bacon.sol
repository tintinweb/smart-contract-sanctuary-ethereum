...
contract Bacon is IBacon, ERC721Enumerable, Pausable, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	//the merkle root
	bytes32 public root = 0xfe86d24e4caf0679459216e019accc1db21394264b9f6d50b52c0e525359856f;

	uint256 public whitelistStartTime = block.timestamp - 1; //change to real;
	uint256 public publicSaleStartTime = block.timestamp - 1; //change to real;
	
	// max mint qty
	uint16 public MAX_MINT_QTY = 20;
	// mint price
	uint256 public MINT_PRICE = .001 ether; // TODO: change to actual mint price
	// max number of tokens that can be minted - 50000 in production
	uint256 public MAX_TOKENS = 5000; // TODO: change to 50000
	// number of tokens that can be claimed for free - 20% of MAX_TOKENS
	uint256 public PAID_TOKENS = 1000; // TODO: change to 10000
	...
	uint256[] private shareList = [1, 99]; //put 95, 5!!! TODO:!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	constructor() ERC721("Bacon Game!", "BGAME") PaymentSplitter(addressList, shareList) {
		devWallet = msg.sender;
	}

	function delBuildNumber24() internal pure {} //etherscan trick
	...
	function mintCost(uint256 tokenId) public view returns (uint256) {
		...
		if (tokenId <= (MAX_TOKENS * 2) / 5) return 200 ether; // TODO: change to 20,000
		if (tokenId <= (MAX_TOKENS * 4) / 5) return 400 ether; // TODO: change to 40,000
		return 800 ether; // TODO: change to 80,000
	}
