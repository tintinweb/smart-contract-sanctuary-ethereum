...
contract HAWEXTESTNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HAWEX NFT GENESIS PASS", "HNGP") {
    setHiddenMetadataUri("ipfs://QmWfmDkKARvNmPBR8AYwCqyeLMa6y8ZFrSukXWaga2iVnK/metadata1.json");
  }
