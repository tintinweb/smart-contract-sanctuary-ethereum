...
contract FayreMarketplaceChild is FayreMultichainBaseUpgradable {
    ...
    */
    ...
    event ExecuteSale(uint256 indexed saleId, MultichainTransactionData multichainTransactionData, uint256 timestamp, uint256 blockNumber);
    event ExecuteFreeOffer(uint256 indexed bidId, MultichainTransactionData multichainTransactionData, uint256 timestamp, uint256 blockNumber);
    ...
    function _executeSale(FayreMultichainMessage memory fayreMultichainMessage) internal {
        ...
        emit ExecuteSale(multichainTransactionData.saleId, multichainTransactionData, block.timestamp, block.number);
    }
    ...
    function _executeFreeOffer(FayreMultichainMessage memory fayreMultichainMessage) internal {
        ...
        emit ExecuteFreeOffer(multichainTransactionData.bidId, multichainTransactionData, block.timestamp, block.number);
    }
