...
contract NFT is ERC721A, Ownable {
    ...
    constructor() ERC721A("Azuki", "AZUKI") {
        setBaseURI(
            "https://ipfs.io/ipfs/QmSKZyD25PFP1zzMhwoWy9y9RgsdZiV3EnymfNczeDjDhD"
        );
        setPreRevealURI(
            "https://ipfs.io/ipfs/QmSKZyD25PFP1zzMhwoWy9y9RgsdZiV3EnymfNczeDjDhD"
        );
    ...
    function mint_sale(uint256 _count) public payable {
        if (_isPreSaleActive || _isPublicSaleActive) {
            require(_count > 0, "At least one should be minted");
            ...
            if (_isPreSaleActive) {
                ...
                require(
                    balanceOf(msg.sender) + _count <= MAX_PER_ADDRESS,
                    "Exceeds balance"
                );
