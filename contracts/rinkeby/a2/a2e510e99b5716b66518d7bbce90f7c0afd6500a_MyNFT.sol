...
contract MyNFT is ERC721,Ownable {
    ...
    string private _baseURIextended = "ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/";
    ...
    function mintMultiple(uint n, address _to) public onlyOwner {
        for (uint i = 0; i < n; i++) {
            mint(_to);
        }
    }
