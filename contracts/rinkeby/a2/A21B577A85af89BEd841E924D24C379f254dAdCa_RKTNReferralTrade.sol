...
contract RKTNReferralTrade is  Ownable {
    ...
    constructor(){
        ...
        tokenAddress = address(0x73cd3806621670540a0Eb83C9A60B6b6f4f9B59F);

        devWallet = address(0x78Ed704597BC9462eaBec07df9494158954D1920);

        communityWallet = address(0x78Ed704597BC9462eaBec07df9494158954D1920);
