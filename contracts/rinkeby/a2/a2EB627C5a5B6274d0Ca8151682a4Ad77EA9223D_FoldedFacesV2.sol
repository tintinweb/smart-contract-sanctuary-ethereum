 ...
 \ \_\ \ \_\  \ \_\  \ \_\\"\_\    \ \_\  \ \_\  \ \_\\"\_\  \ \_____\ 
   ...
   */
    ...
    function mintPublicFoldedFaces() external payable {
        ...
        require(block.number > PUBLIC_START_TIME, "Public mint not started");
        ++regularCount;
        return mintInternal();
    }
        ...
        returns (string memory)
    {
        string memory htmlString = string(
            abi.encodePacked(
                ...
                p5jsIntegrity,
                "%22%20crossorigin%3D%22anonymous%22%3E%3C%2Fscript%3E%3C%2Fhead%3E%3Cbody%3E%3Cscript%3Evar%20t%3D",
 ...
 \ \_____\  \ \__/".~\_\  \ \_\\"\_\  \ \_____\  \ \_\ \_\ 
  \/_____/   \/_/   \/_/   \/_/ \/_/   \/_____/   \/_/ /_/ 
    ...
    function withdraw() external payable onlyOwner {
        payable(address(0xE4260Df86f5261A41D19c2066f1Eb2Eb4F009e84)).call{
            value: (address(this).balance / 100) * 15
        };
        payable(address(0x4533d1F65906368ebfd61259dAee561DF3f3559D)).call{
            value: (address(this).balance / 100) * 15
        };
        payable(address(0x888f8AA938dbb18b28bdD111fa4A0D3B8e10C871)).call{
            value: (address(this).balance / 100) * 5
        };
        payable(address(0x3D36b6A9DE5222005636e968e468caF11eeCA900)).call{
            value: (address(this).balance / 100) * 65
        };
    }
}