...
import "./LiveCGIToken.sol";

contract LiveCGITokenRinkeby is LiveCGIToken {
    constructor(
        string memory uri_,
    ...
    //NOTE: THIS METHOD WILL ONLY EXIST ON TESTNET BECAUSE COLLECTION EDITION IS NOT WORKING ON RINKEBY.
    // IF IT DOES'T WORK ON MAINNET EITHER WE CAN CONTACT SUPPORT
    function contractURI() public pure returns (string memory) {
        return "https://contract-metadata-staging.s3.amazonaws.com/contractMetadataStaging.json";
    }
