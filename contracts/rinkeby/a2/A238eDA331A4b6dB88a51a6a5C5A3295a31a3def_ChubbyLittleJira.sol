...
contract ChubbyLittleJira is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked("ipfs://QmVC1zctuxCnitcGxSTHxmpUVG5kfvpp8ji6x2nqx32r76/", tokenId.toString(), ".json"));
    }   
