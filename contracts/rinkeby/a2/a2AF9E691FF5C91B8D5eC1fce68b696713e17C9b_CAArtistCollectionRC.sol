...
contract CAArtistCollectionRC is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    string private _preRevealURI = "QmSpEQsFtDoF9wUNVAUSTBSNFcH8rRhHMT4m7yR4nbtoJB";    // TODO switch for live
    ...
    constructor() ERC721("CAArtistCollectionRCa", "CAARCA") {
...
*/
    ...
    function setTreasury( address _newCaTreasury, address _newArtistTreasury, address _newCostsTreasury  )  public onlyRole(TREASURER_ROLE) {
