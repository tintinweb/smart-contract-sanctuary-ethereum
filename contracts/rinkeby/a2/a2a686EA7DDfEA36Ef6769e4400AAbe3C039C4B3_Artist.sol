...
contract Artist is ERC721Upgradeable, IERC2981Upgradeable, AccessManager {
    // ================================
    // STORAGE
    // ================================
    ...
    /// @notice Returns token URI (metadata URL). e.g. https://arcadia.music/api/metadata/[contractAddress]/[tokenId]/metadata.json
    ...
    /// @notice Returns contract URI used by Opensea. e.g. https://arcadia.music/api/metadata/[contractAddress]/storefront
    ...
    function soundRecoveryAddress() public view virtual returns (address) {
        return 0x4309717c2D26b4B0Bf1D03dB7C429aae5E46B4bc;
    }
...
/// @title AccessManager
/// @author OpenZeppelin & ArcadiaMusic (@bright)
