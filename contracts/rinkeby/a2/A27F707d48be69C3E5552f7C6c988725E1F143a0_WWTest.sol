...
abstract contract ERC721MultiMetadata is ERC721, Ownable {
    ...
    function setTokenState(uint256 token, uint256 state) external onlyOwner {
...
// File: contracts/WWTestContract.sol
...
contract WWTest is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, Pausable, ERC721MultiMetadata {

    // Address to send balance to
    address payable public payoutAddress;

    constructor(
        string memory zeroURI,
        address payable _payoutAddress
    ) ERC721("Test Mint Pass Drop", "TestMintPass") ERC721MultiMetadata(zeroURI) {
        payoutAddress = _payoutAddress;
        _pause();
    }

    /**
     * @notice Allow for airdropping of tokens to a range of addresses up to the supply limit
     */
