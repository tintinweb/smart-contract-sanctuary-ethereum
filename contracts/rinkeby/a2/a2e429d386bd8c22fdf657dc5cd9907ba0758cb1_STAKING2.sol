        ...
        for (
        ...
        )
         {
            ...
            if (
                ...
                __unstakeTime[msg.sender] = _unstakeTime[msg.sender][i];
            }
...
totallock[msg.sender]-=AvailableForClaim[msg.sender];
        ...
        returns (uint256[] memory, uint256[] memory)
    {
       ...
       function _totalStakedbyUser(address addr) public view returns (uint256) {
        return  _stakeDetail[addr].totalStaked;
    }

function unstakeAmount(address addr) public view returns (uint256) {
        return  _stakeDetail[addr].totalStaked;
    }
