...
contract animalMain is  ERC721,Ownable {
  ...
  function createAnimal() payable public {
      ...
      //TO DO
      //使用亂數來產生DNA, 星級, 動物種類
        dna = keccak256(abi.encodePacked(block.coinbase,
        ...
        else if(range_of_star < 65){star = 3;}
        else if(range_of_star < 65){star = 4;}
        else {star = 5;}
