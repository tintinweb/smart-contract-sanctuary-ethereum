...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAd3fb6Eaf0EED20fDED5C32B05f2E4e2eE2B2A71];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPNwafSwMzw8bmdYbzRW1eH6nWkx2j7ZUczqzoteJtan8/";
...
contract TestContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/LqZFBMARLaMRiTCXxGPS/contract-metadata";
    }
}
