...
contract Programmer is ERC721Enumerable, Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 constant public MAX_FREE_TOKEN = 300;
    uint256 public TEAM_KEEP = 300;
    ...
    uint64 constant public MAX_TOKENS_PER_ACCOUNT_FOR_FREE = 5;
    uint64 constant public MAX_TOKENS_PER_ACCOUNT_FOR_SALE = 10;
