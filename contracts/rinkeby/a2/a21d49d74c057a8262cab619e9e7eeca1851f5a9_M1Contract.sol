...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xba2424F64Ad3d172645bc3661383323e17C507a1,0x0193667F994e82b7fFDd7e3268E5a8FA683394eB];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmcLah48MWzK4nC4kwBrXvbv1VHSWHvbz5mR5SYZ73UEF4/";
...
// File: contracts/M1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract M1Contract is RamppERC721A {
    constructor() RamppERC721A("m1", "mvc2323"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ZfCjAcrWIwsdVSEJDiTn/contract-metadata";
    }
}
