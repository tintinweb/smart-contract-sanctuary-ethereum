...
abstract contract Config {
    ...
    uint256 public constant MAX_SELLABLE_SUPPLY = MAX_SUPPLY - RESERVED_TOKENS;
    ...
    Config
{
    ...
    modifier checkSellableSupply(uint256 count) {
        require(
            _tokenIdCounter.current().add(count) <= MAX_SELLABLE_SUPPLY,
            ERROR_MAX_SUPPLY
        );
        _;
    }
