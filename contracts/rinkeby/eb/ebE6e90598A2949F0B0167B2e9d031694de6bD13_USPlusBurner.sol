...
/// @notice 
/// @dev 
contract USPlusBurner is PausableUpgradeable, AccessControlUpgradeable {
        ...
        returns (bool isRequestPlaced)
    {
        ...
        require(IERC20Upgradeable(USPlusAddr).balanceOf(msg.sender) >= amount, "NOT_ENOUGH_BALANCE");
        ...
        emit BurnRequestUSPlus(msg.sender, refId, redeemerContractAddress, redeemerPerson, fedMemberID, amount);
    ...
    function executeBurn(
        ...
        IFluentUSPlus(USPlusAddr).burnFrom(redeemerContractAddress, ticket.amount);
