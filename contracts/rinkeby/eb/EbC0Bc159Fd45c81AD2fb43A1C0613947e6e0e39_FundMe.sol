...
library PriceConverter {
        ...
        returns (uint256)
    {
        ...
        // AggregatorV3Interface priceFeed = AggregatorV3Interface(     //we no longer need this hardcode of the specific feed we want, because it will be in parameter of getPrice
    ...
    function getConversionRate(
        uint256 ethAmount,
        AggregatorV3Interface priceFeed // we add priceFeed here
