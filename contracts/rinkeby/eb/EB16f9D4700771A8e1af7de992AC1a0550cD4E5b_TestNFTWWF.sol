...
contract TestNFTWWF is ERC721, Ownable {
    ...
    constructor() payable ERC721("Test NFT WWF", "TNFT") {
        baseURI = "ipfs://No Sniping Allowed!!!/";
        notRevealedURI = "ipfs://bafybeihizf6zuq3g67u4ftrezjmk642zaff36yqxbmcqoraa3s6evo77te/hidden.json";
        baseExtension = ".json";
        communityWallet = owner();
        charityWallet = owner();
        mintPriceWL = 0.02 ether;  // Replace with 8 ether for WW
        mintPricePS = 0.03 ether; // Replace with 12 ether for WW 
        totalSupply = 0;
        maxSupply = 50;   // Replace with 3500 for WW 
        maxPerWalletWL = 3;
        maxMintAmountPS = 10;
        percentCharity = 0;
        percentCommunity = 0;
