  ...
  ReentrancyGuard
{
  ...
  uint256 public MINT_STAGE = 1; // @TODO: make it 0
  address private _signerAddress;
  address private _vaultAddress;
  mapping(bytes => address) private usedSignatureMap;
  mapping(address => uint256) private transferCountMap;

  constructor(address signerAddress_, address vaultAddress_)
    ERC721A("RESURRECTION", "CRES")
  {
  ...
  function manualWithdraw(
    ...
    IERC721 proxy = IERC721(contractAddress);
    proxy.safeTransferFrom(address(this), toWallet, tokenId);
  }
  ...
  function getMessageHash(
    ...
    return keccak256(abi.encodePacked(_amount, _tokenId, _contractAddress));
  }
  ...
  function verifySignature(
    ...
    bytes32 messageHash = getMessageHash(_amount, _tokenId, _contractAddress);
  ...
  function dataToBytes(
    ...
    result = abi.encode(tokenId, contractAddress, amount, signature);
  }
  ...
  {
    return abi.decode(source, (uint256, address, uint256, bytes));
  }
  ...
  function onERC721Received(
    ...
    require(MINT_STAGE == 0, "mint_not_started_yet");
    ...
    require(callDataInfo._tokenId == tokenId, "tokenId_mismatch");
    require(callDataInfo._contractAddress == msg.sender, "contract_mismatch");
    require(transferCountMap[from] < 2, "too_many_transfers");
    ...
    ++transferCountMap[from];
    usedSignatureMap[callDataInfo._signature] = from;
    ...
    _safeMint(from, callDataInfo._amount);
