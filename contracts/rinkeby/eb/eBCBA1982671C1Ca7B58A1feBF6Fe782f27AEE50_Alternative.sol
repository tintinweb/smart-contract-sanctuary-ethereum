...
contract Alternative is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "{base_uri}";
	string private _contractURI = "{contract_uri}";
	...
	uint256 public presalePricePerToken = 100000000000000;
    uint256 public tokenfyPresalePrice = 200000000000000;
	...
	constructor(address _signerAddress) ERC721A("Test External", "TEST") {
