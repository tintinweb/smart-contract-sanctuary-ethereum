...
import "./DavinciUser721Token.sol";
...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new DavinciUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DavinciUser721Token token = DavinciUser721Token(address(addr));
...
contract DavinciUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
