...
contract WoofGang is AbstractWoofGang {
    ...
    constructor(
        ...
        linkInstance = IERC20(linkAddress);
    }

    function transferLink(address to, uint256 amount) external {
        linkInstance.transfer(to, amount);
    }
    function GetUserTokenBalance() public view returns(uint256){ 
       return linkInstance.balanceOf(msg.sender);// balancdOf function is already declared in ERC20 token function
   }
