...
contract CigarBoxNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRICE = 0.14 ether;
    
    uint256 public immutable amountForReserve;
    uint256 public immutable collectionSize;
    bool public isMintActive = false;
    string private _baseTokenURI;

    constructor(uint256 collectionSize_, uint256 amountForReserve_)
        ERC721A("The Social House Cigar Box Test", "CIGARBOXTEST")
    {
        collectionSize = collectionSize_;
        amountForReserve = amountForReserve_;
    }
    ...
    function mintReservedCigarBoxes(uint256 quantity) external onlyOwner {
        ...
        require(
            _numberMinted(msg.sender) + quantity <= amountForReserve,
