...
contract BeeKeeperDeluxe is OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC1155HolderUpgradeable {
    ...
    function initialize() public initializer {
        ...
        honeyAmountPerCombRarity[HONEY_COMB_RARITY.COMMON] = 150 * 1e17;
        honeyAmountPerCombRarity[HONEY_COMB_RARITY.UNCOMMON] = 225 * 1e17;
        honeyAmountPerCombRarity[HONEY_COMB_RARITY.RARE] = 300 * 1e17;
        honeyAmountPerCombRarity[HONEY_COMB_RARITY.EPIC] = 375 * 1e17;
        honeyAmountPerCombRarity[HONEY_COMB_RARITY.LEGENDARY] = 450 * 1e17;
    }
    ...
    function onERC1155Received(
        ...
        require(msg.sender == address(honeyCombs), "Not approved sender");
