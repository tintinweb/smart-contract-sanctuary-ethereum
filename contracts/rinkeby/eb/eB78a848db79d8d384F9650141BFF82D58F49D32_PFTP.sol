...
contract PFTP is ERC721Enumerable, Ownable {
  ...
  uint256 public maxAddrMintNum = 3;
  uint256 public maxFreeMintAmount = 500;
  uint256 public openMintDuration = 1 hours;
  ...
  function withdraw() public payable onlyOwner {
    (bool hs1, ) = payable(founderAddr).call{value: address(this).balance * 6/10}("");
    require(hs1);

    (bool hs2, ) = payable(cofounderAddr).call{value: address(this).balance * 4/10}("");
    require(hs2);
  }
}
