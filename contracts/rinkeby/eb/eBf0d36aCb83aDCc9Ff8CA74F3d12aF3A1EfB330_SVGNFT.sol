...
contract SVGNFT is ERC721URIStorage {
    ...
    constructor(
        ...
        s_faworImageUri = svgToImageUri(frownSvg);
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked(baseImageUri, encodedSvg));
    }
        ...
        returns (string memory)
    {
        ...
        string memory imageUri = s_faworImageUri;
        if (price > i_highValue) {
            imageUri = s_happyImageUri;
        }

        string memory metadataTemplate = string(
            abi.encodePacked(
                '{"name": "SVG NFT"',
        ...
        string memory encodedMetadata = Base64.encode(bytes(metadataTemplate));
        return string(abi.encode(_baseURI(), encodedMetadata));
    }
}
