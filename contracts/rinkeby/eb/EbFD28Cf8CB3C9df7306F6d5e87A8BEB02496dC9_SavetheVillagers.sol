...
contract SavetheVillagers is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    setCost(_cost);
    _setDefaultRoyalty(0x07fF610fA2C583FcE13B2c898a37002f9cf661c3, 1000); // 10%
...
function presaleMint(uint256 _mintAmount, bytes32[] calldata _proof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) isValidMerkleProof(_proof){
