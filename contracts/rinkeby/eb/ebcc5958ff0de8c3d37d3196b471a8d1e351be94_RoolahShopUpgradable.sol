    ...
    OwnableUpgradeable
{
    ...
    /**
     * The merkle root with which to verify listings exist.
     */
     ...
     * @param proof - the merkle proof that will verify all of the listing data.
     */
    function transact(
        bytes32 listingId,
        ...
        require(
            supply >= unitsSold[listingId] + quantity,
            "Exceeds global max"
        );
        require(
     ...
     */
    function burnRoos(uint256[] calldata tokenIds) public {
    ...
    /**
     * Updates the Merkle root, effectively updating listings.
     * @dev owner only.
     *
    ...
    function _verifyListing(
        ...
        bytes32 leaf = keccak256(packed);

        return verify(_merkleRoot, leaf, proof);
    }
}
