...
contract OceanaNFT is ERC1155Oceana, Ownable, ERC2981 {
    ...
    event CreateNFT( address indexed to, uint256 indexed collectionId, uint256 indexed tokenNumber, uint256 amount, uint256 royalty );
 ...
 */
interface IERC1155ReceiverOceana is IERC165Oceana {
    /**
 ...
 */
abstract contract ERC165Oceana is IERC165Oceana {
    /**
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterfaceOceana(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return interfaceId == type(IERC165Oceana).interfaceId;
    }
}
 ...
 * _Available since v3.1._
 */
interface IERC1155MetadataURIOceana is IERC1155Oceana {
    /**
