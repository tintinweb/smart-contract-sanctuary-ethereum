...
contract TestVal2 is Context, IERC20, Ownable {
    ...
    uint256 private _sellFourFee = 0;
    ...
    string private constant _name = "TestVal2";
    string private constant _symbol = "Testval2";
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 5e5 * 10**9;
        _maxSellAmount = 5e5 * 10**9;
        _maxWalletAmount = 1e7 * 10**9;
        swapTokensAtAmount = 5e5 * 10**9;
        tradingOpen = true;
