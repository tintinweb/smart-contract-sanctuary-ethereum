...
contract MetapolyIDO is Ownable, ERC721A, BaseRelayRecipient {
    ...
    constructor(
        ...
        uint _phase1Start, uint _phase2Start,
    ...
    function _mint(bytes calldata signature) private {
        ...
        require(block.timestamp > phase1Start, "Haven't start");
    ...
    function setMintTimestamp(uint _phase1Start, uint _phase2Start) external onlyOwner {
