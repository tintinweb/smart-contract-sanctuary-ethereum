...
abstract contract Erc721BaseV3 is ERC721, ERC721Royalty, ERC721Pausable, RoleV3 {
  ...
  /**
        @param interfaceId The interfaceId supported by the Contract
    */
  function supportsInterface(bytes4 interfaceId) public view override(ERC721, ERC721Royalty, RoleV3) returns (bool) {
    return super.supportsInterface(interfaceId);
  }
