...
contract YonkoNft is ERC721AQueryable, Ownable {

  uint256 public MAX_Supply = 1001; // maximum supply is 1001.
  ...
  constructor(string memory baseUri_, string memory unrevealedUri_, address feeReceiver_) ERC721A("Yonko Official", "YONKO") {
    baseUri = baseUri_;
