...
contract Meme is Ownable, ERC721A, ReentrancyGuard {    
    uint256 constant MAX_ELEMENTS = 10; // 1000
    uint256 constant PUBLIC_PRICE = 0.009 ether;
    ...
    constructor() ERC721A("Meme", "MEME", 1) {}
