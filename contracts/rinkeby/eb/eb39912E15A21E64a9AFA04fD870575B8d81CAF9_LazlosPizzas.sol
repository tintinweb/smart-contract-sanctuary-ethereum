...
contract LazlosPizzas is ERC721U, Ownable {
    ...
    function bake(address baker, Pizza memory pizzaData) external returns (uint256) {
        require(msg.sender == ingredientsContractAddress, 'Only the ingredients contract can bake pizza.');
    ...
    function rebake(address baker, uint256 pizzaTokenId, Pizza memory pizzaData) external {
        require(msg.sender == ingredientsContractAddress, 'Only the ingredients contract can bake pizza.');
