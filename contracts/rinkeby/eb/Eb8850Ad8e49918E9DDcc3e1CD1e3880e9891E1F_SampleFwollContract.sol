    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 28) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmY3PJzkqGsotj2B5SQyD1dBctZzvNqcYkzxDdix7j39fH/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 28");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 28");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 28");
...
// File: contracts/SampleFwollContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SampleFwollContract is RamppERC721A {
    constructor() RamppERC721A("SampleFwoll", "SFLL"){}
}
