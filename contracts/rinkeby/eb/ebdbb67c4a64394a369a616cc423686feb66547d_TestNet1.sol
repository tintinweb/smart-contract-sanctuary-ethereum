...
contract TestNet1 is ERC721, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 MAX_SUPPLY = 10000;
    constructor() ERC721("TestNet1", "TNT") {}

    function safeMint(address to) public {
        string memory BASE_URI = "ipfs://QmfBrrnzjuFnx5RCc5YkQRn45fBKvVckhsfJpyqKmmogu1";
