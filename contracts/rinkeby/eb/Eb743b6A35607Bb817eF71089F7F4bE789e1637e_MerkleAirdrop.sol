...
contract MerkleAirdrop {
    ...
    event AddressClaim(address addr, uint256 itemId, uint256 amount);
    

    constructor(address _tokenAddress, address _reserve){
    ...
    function claimForAddress(
        ...
        token.transferFrom(reserve, msg.sender, _amount);
