...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x102A018Ce5D5a4Ce0E4Da034de3E26F73CB9C866];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x102A018Ce5D5a4Ce0E4Da034de3E26F73CB9C866;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintOwnershipCap = 2;
  ...
  */
  ...
  function getPrice(uint256 _count) public view returns (uint256) {
    ...
    if(
      usingEarlyMintIncentive == false ||
      _numberMinted(msg.sender) > earlyMintOwnershipCap
    ) {
      return PRICE * _count;
    }

    uint256 endingTokenQty = _numberMinted(msg.sender) + _count;
    ...
    uint256 incentiveTokenCount = earlyMintOwnershipCap - _numberMinted(msg.sender);
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 5555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQbXwVN6jWLqttJmwQJYPs7ryHh1XnyEePLdLNzubMLQr/";
...
// File: contracts/HouseofApesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HouseofApesContract is RamppERC721A {
    constructor() RamppERC721A("House of Apes", "HoA"){}
}
