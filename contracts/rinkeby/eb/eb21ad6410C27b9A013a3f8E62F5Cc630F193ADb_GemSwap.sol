...
contract GemSwap is SpecialTransferHelper, Ownable, ReentrancyGuard {
    ...
    address public constant GOV = 0x8C2055A440a880aE667Aa99a7EE17c90DF1E3BBe;
    ...
    constructor(address _marketRegistry) {
        ...
        converter = 0x97Fb625482464eb51E8F65291515de1F68526337;  // Gem converter
        guardian = 0x8C2055A440a880aE667Aa99a7EE17c90DF1E3BBe;
        baseFees = 0;
        openForTrades = true;
    ...
    function _trade(
        ...
        for (uint256 i = 0; i < _tradeDetails.length; i++) {
            ...
            if (_proxy == 0x00000000006c3852cbEf3e08E8dF289169EdE581) { // seaport
