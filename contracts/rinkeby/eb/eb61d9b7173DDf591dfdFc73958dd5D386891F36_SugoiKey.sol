...
contract SugoiKey is Satoshigoat {
	...
	Plug constant public thePlug = Plug(0x169254eb380fDbF0b1cC017E267509c7a78cA667);//rinkeby

	uint256 constant VANGUARD_LAST_ID = 887;//first 888 are vanguard

	mapping(uint256 => string) internal _tokens;//tid -> ipfs hash

	string [3] _hashes = ["QmeRLXAm3p8sQuWpJ99944iPJwqXNwvMZJR3PYtAKchb85",//STILL WRONG
						  "QmZ5cybBXyhvmEYVmc3bcNRqVWmyGCsgbPi4VT4WSYoKCz",
						  "QmVz3uxZC6EcrgPhdxHq5CT2qwRABTcr9z19cVaDZf1zfg"];
	string [3] _vanguardHashes = ["QmZNFmkUzMKU8pdx2Lqhy6k4A2k9X5nyV2wgmXsYvdqpkn",//STILL WRONG
...
contract Satoshigoat is ERC721A, SquadOwnable, ReentrancyGuard {
    	...
    	ERC721A(name_, symbol_)
    {
    	...
    	_contractURI = "ipfs://QmP2du63New2dN48CPhNgc1fjcWGkAczLcPGmN89s4BV3v";
