...
contract SevenTwentyOne is ERC721, Ownable {
    ...
    string public OPENSEA_STORE_METADATA =
        "ipfs://QmVfufsJLYassT6MfvnfWJgSAVtRd6a2fUwz2b2QszPJHQ";

    uint256 public constant PER_TOKEN_PRICE = 0;
     ...
     * - `saleStart` when the token sale starts, + (86400 * 5)
     *
     */
    constructor(
        string memory name,
    ...
    /**
     *  @dev Mint token for community member
     */
