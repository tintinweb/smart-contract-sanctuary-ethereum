...
contract Staking is Ownable, ERC721Holder {
    ...
    function updatePool() public {
        ...
        uint256 speedReward = multiplier
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        console.log("update pool:mint speed", speedReward);
    ...
    function pendingSpeed(address _user) public view returns (uint256) {
        PoolInfo storage pool = poolInfo;
    ...
    function payReward(UserInfo storage _user) internal {
        uint256 pending = pendingSpeed(msg.sender).sub(_user.rewardDebt);
    ...
    function withdrawHorseInStable(
        ...
        console.log(
            "Remove horse Index ",
            stableHorseIndex[_stableTokenId][_horseTokenId]
        );
        removeHorseFromList(
            stable.horses,
