...
abstract contract ERC165 is IERC165 {
     ...
     */
    function supportsInterface(bytes4 interfaceId) internal view virtual  returns (bool) {
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) internal view virtual override(ERC165) returns (bool) {
        return
...
contract BNBNFT is ERC721URIStorage, Ownable {
    constructor() ERC721("BNB NFT", "BNFT") Ownable(msg.sender){
  ...
  struct FixedPrice{
    ...
    uint256 public newCreateNFTPrice=1;
    mapping(uint256 => FixedPrice) public Fixedprices; // tokenId => tokenId fixed Price
    mapping(uint256 => Bidding) internal biddingInfo; // tokenId => Is tokenId already bidded
