...
contract HawexPfpAvatar is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HAWEX PFP AVATAR", "HPA") {
    setHiddenMetadataUri("ipfs://QmQYqHJBCe3VrRmLfjvhSRx9hhmr8Sm5GFDigTQvUa7JFR/1.json");
  }
