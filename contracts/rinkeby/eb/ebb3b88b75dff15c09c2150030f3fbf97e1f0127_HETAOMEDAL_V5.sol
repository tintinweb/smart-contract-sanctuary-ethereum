...
contract HETAOMEDAL_V5 is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Strings for uint256;
    //Legendary, 30
    //Epic, 150
    //Rare, 750
    ...
    uint256 private start_free = 4680;
    ...
    constructor() ERC721("HETAOTESTV5", "HTTV5") {
        pause();
    }
    ...
    function mint(address _user) public {
        ...
        if (whitelisted_legendary[_user]) {
            ...
            require(tokenId < start_free, "max NFT limit exceeded");
