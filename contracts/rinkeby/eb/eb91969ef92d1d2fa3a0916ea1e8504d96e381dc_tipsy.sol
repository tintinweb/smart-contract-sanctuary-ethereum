...
contract tipsy is Ownable, ERC721A {
 uint256 constant public MAX_SUPPLY = 7777;
 uint256 public TEAM_MINT_MAX = 50;

 uint256 public publicPrice = 0.005 ether;

 uint256 constant public PUBLIC_MINT_LIMIT_TXN = 12;
 uint256 constant public PUBLIC_MINT_LIMIT = 24;
 uint256 constant public FREE_MINT_LIMIT_TXN = 6;
 uint256 constant public FREE_MINT_LIMIT = 6;
 ...
 string public hiddenURI = "ipfs://QmceHYTKBCRYp4vCnZeUBBZLEMVAFutTnDmXsAoFSeCMcn";

 // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
 string public CONTRACT_URI = "ipfs://QmceHYTKBCRYp4vCnZeUBBZLEMVAFutTnDmXsAoFSeCMcn";
 ...
 require(totalSupply() >= 2500, "Team mints after free");
 ...
 require(quantity <=FREE_MINT_LIMIT_TXN, "only 6 per transaction");
 ...
 require(newSupply <= 2500, "Not enough free supply");
