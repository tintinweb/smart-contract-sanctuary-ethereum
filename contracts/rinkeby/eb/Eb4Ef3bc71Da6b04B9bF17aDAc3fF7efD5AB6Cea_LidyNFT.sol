...
// File: contracts/LidyNFT_Lazy_Mint.sol
...
contract LidyNFT is  Ownable, ERC2981, ERC721Enumerable {
  ...
  function whitelistMint(uint256 mintAmount_) external payable {
  ...
  function isWhitelisted(address addressToQuery) external view returns (bool) {
