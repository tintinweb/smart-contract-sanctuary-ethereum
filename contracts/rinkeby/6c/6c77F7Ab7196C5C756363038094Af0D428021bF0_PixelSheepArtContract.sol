...
// File: contracts/PixelSheepArt.sol
...
// /\  _`\   __               /\_ \     /\  _`\ /\ \                               /\  _  \       /\ \__   
// \ \ \L\ \/\_\   __  _    __\//\ \    \ \,\L\_\ \ \___      __     __   _____    \ \ \L\ \  _ __\ \ ,_\  
//  \ \ ,__/\/\ \ /\ \/'\ /'__`\\ \ \    \/_\__ \\ \  _ `\  /'__`\ /'__`\/\ '__`\   \ \  __ \/\`'__\ \ \/  
//   \ \ \/  \ \ \\/>  <//\  __/ \_\ \_    /\ \L\ \ \ \ \ \/\  __//\  __/\ \ \L\ \   \ \ \/\ \ \ \/ \ \ \_ 
//    \ \_\   \ \_\/\_/\_\ \____\/\____\   \ `\____\ \_\ \_\ \____\ \____\\ \ ,__/    \ \_\ \_\ \_\  \ \__\
//     \/_/    \/_/\//\/_/\/____/\/____/    \/_____/\/_/\/_/\/____/\/____/ \ \ \/      \/_/\/_/\/_/   \/__/
//                                                                          \ \_\                          
//                                                                           \/_/                         
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable {
  address[] public payableAddresses = [0x61D88bb0A99c1cB910a4d73314EE381978490F33];
  ...
  function withdrawAllERC20(address _tokenContract, uint256 _amount) public onlyOwner {
    ...
    for(uint i=0; i < payableAddressCount; i++ ) {
        tokenContract.transfer(payableAddresses[i], _amount);
    }
  }
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih55j4wo5phzfvvitbctiihbyzfuiagmmm2tbtnta2wup2gxiw66y/";
...
// File: contracts/PixelSheepArtContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelSheepArtContract is RamppERC721A {
    constructor() RamppERC721A("Pixel Sheep Art", "PXSA"){}
}