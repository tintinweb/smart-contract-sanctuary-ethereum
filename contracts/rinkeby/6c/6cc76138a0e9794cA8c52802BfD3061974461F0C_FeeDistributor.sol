    ...
    Ownable
{
    ...
    uint256 public constant WEEK = 60;
    uint256 public constant TOKEN_CHECKPOINT_DEADLINE = 60;
    ...
    constructor(address _veDefedAddress,address _mainFeeToken,address _feeVault) public{
        ...
        // defedCollector = _defedCollector;
    ...
    //     veDEFED = IVeDefed(address(0xf8e81D47203A594245E36C48e151709F0C19fBe8));
    //     // defedCollector = _defedCollector;
    //     mainFeeToken = address(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
    //     feeVault = address(0xd9145CCE52D386f254917e481eB44e9943F39138);
    //     uint256 t = (block.timestamp / WEEK) * WEEK;
    //     startTime = t;
    //     lastDistributeTime = t;
    //     timeCursor = t;
    ...
    function _distribute() internal {
        // uint256 amount = IERC20(token).balanceOf(defedCollector);
        // if (amount > 0) {
    ...
    */
        ...
        returns (uint256,uint256)
    {
        ...
        uint256 _lastDistributeTime = lastDistributeTime;
        ...
        for (uint256 i = 0; i < 52; i++) {
            ...
            return (weekCursor,roundedTimestamp);
    ...
    function claim() external  nonReentrant returns (uint256) {
        ...
        if (amount != 0) {
            ...
            FeeVault(mainFeeToken).claim(_sender,amount);
