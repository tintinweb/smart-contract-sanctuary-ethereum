...
contract Qaz is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmaSDygwuPRzNdCdmMHMDensyU8KQhmECaBN17DVEPuxXZ/";
    uint   public price             = 0.02 ether;
    uint   public maxPerTx          = 2;
    uint   public maxPerFree        = 2;
    uint   public totalFree         = 6;
    uint   public maxSupply         = 6;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Qaz", "QaZ"){}
