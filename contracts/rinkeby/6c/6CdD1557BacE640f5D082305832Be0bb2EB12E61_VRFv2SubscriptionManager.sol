...
contract VRFv2SubscriptionManager is VRFConsumerBaseV2 {
  ...
  function requestRandomWords() external onlyOperators returns(uint256){
  ...
  modifier onlyOperators() {
    require(msg.sender == s_owner || msg.sender == operators[0] || msg.sender == operators[1]);
    _;
  }

  function setOperators(address _obelisk, address _land) external onlyOwner {
    operators[0] = _obelisk;
    operators[1] = _land;
  }
}
