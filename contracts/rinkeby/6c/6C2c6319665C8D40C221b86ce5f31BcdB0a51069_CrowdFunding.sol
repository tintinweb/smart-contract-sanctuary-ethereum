...
contract CrowdFunding {
    ...
    mapping(uint256 => bool) paymentCompleted;
    bool[] arrayPaymentCompleted;
    ...
    function getPaymentStatus() public returns (bool[] memory) {
        for (uint256 i = 0; i < noOfAskers; i++)
            arrayPaymentCompleted.push(paymentCompleted[i]);
        return arrayPaymentCompleted;
    }
