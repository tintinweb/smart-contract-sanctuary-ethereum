...
Tokenomics
Buy Tax: 10%
2% Reflection in R3TRN | 3% Marketing wallet | 5% Buyback wallet

Buy Tax: 40%
5% Reflection in R3TRN | 5% Marketing wallet | 30% Buyback wallet
...
contract TURNAROUND is Context, IERC20, Ownable {
  ...
  uint256 private _tTotal = 100 * 10**9 * 10**9; // 100 Billion Tokens
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tFeeTotal;
  uint256 public maxWalletAmount = _tTotal.mul(200).div(10000); // 0.1%
  ...
  uint256 private numTokensSellToAddToLiquidity = 400000000 * 10**9;
  ...
  constructor() {
      address _newOwner = 0xEeE24561F7CF7675D99c505C11e7f12Ce9B88d87;
 ...
 function setSellFees() private {
  ...
  function setnumTokensSellToAddToLiquidity(uint256 newValue) external onlyOwner {
    numTokensSellToAddToLiquidity = newValue * 10**9;
  }
