...
contract Kiwami is Ownable, ERC721A, MerkleWhitelist {
    ...
    uint256 public DA_DECREMENT_FREQUENCY = 60;

    //Starting DA time (seconds).
    uint256 public DA_STARTING_TIMESTAMP = 1648808000;

    //The final auction price.
    uint256 public DA_FINAL_PRICE;

    //The quantity for DA.
    uint256 public DA_QUANTITY = 20;
    ...
    address public TEAM_USA_ADDRESS =
        0x6D64E5604e148B8450fAfC08041cd939CDA8AfB8;
    address public TEAM_JAPAN_ADDRESS =
        0x9840b1aA16829684Fc08e6678C2F5CEE82c2e6A3;
    address public MULTISIG_ADDRESS =
        0xb6317bf914ac0009852E76A682e1535e184e5752;
    ...
    uint256 public publicWLStartTime = 1648808000;
    uint256 public miceWLStartTime = 1648808000;
      ...
      //  onlyPublicWhitelist(proof)
    {
        ...
        require(totalSupply() + 1 <= 30, "Max supply of 30!");
       ...
       // onlyMouseWhitelist(proof)
    {
        ...
        //Require max supply just in case.
        require(totalSupply() + 1 <= 40, "Max supply of 10,000!");
    ...
    function teamMint(uint256 quantity, address receiver) public onlyOwner {
        //Max supply
        require(
            totalSupply() + quantity <= 40,
            "Max supply of 40 total!"
        );
