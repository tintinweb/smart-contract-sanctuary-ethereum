...
contract TyeNFTCollections is Owned, ERC721URIStorage {
    ...
    function mint(
        ...
        ) = ITyeNFTTemplate(owner).getCollectionDetailsFromTemplate(
                address(this)
            );
        require(
...
contract TyeNFTTemplate {
    ...
    function createCollection(
        ...
        address _collectionAddress = address(
            new TyeNFTCollections(otherdatas[0], otherdatas[1], deployerAddress)
        );
    ...
    {
        return (collectionsList[collAddress]);
    }
}