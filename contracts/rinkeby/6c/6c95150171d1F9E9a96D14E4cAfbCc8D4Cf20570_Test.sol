...
contract Test is ERC20Capped, Ownable {

    // Long name + shortname  and max supply 4 000 000 000 GALEON
    constructor() ERC20("stak3", "STAK3") ERC20Capped(8000000000 * 10 ** decimals())  {
        _mint(msg.sender, 2000000000 * 10 ** decimals());
        // _mint(0x3334a0Fd143184A536eE71CE8b6c43Feb3E907b5, 2000000000 * 10 ** decimals());
    }
