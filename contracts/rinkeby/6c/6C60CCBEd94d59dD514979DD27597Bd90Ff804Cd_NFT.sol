...
contract NFT is ERC721Tradable{
    ...
    constructor(address _eventContract) ERC721Tradable("DummyNFT", "DFT",0x1E525EEAF261cA41b809884CBDE9DD9E1619573A,"https://creatures-api.opensea.io/api/creature/", 0x25D31dDe6585E353197035eb3b687fF74ca5E3fD, 500, _eventContract) {
 ...
 */
contract ERC721PresetMinterPauserAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable,ERC2981, Ownable {
    ...
    constructor(string memory name, string memory symbol, string memory baseTokenURI, address royaltiesReceiver,
        uint96 royaltiesFeeNumerator, address _eventContract) ERC721(name, symbol, _eventContract) {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControlEnumerable, ERC721, ERC721Enumerable,ERC2981) returns (bool) {
...
interface NFTevents{
    function mintEvent(address _to, uint256 _tokenId) external;
    function burnEvent(address _from, uint256 _tokenId) external;
    function transferEvent(address _from, address _to, uint256 _tokenId) external;
    function approvalForAllEvent(address _owner, address _to, bool _approved) external;
    function approvalEvent(address _owner, address _to, uint256 _tokenId) external;
}
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        ...
        eventContract.approvalForAllEvent(_msgSender(), operator, approved);
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        eventContract.mintEvent(to, tokenId);
    }
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        eventContract.burnEvent(owner, tokenId);
    }
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        ...
        eventContract.transferEvent(from, to, tokenId);
    }
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        eventContract.approvalEvent(ERC721.ownerOf(tokenId), to, tokenId);
    }
...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId {
    ...
    ) ERC721PresetMinterPauserAutoId(_name, _symbol,_baseURI, royaltiesReceiver, royaltiesFeeNumerator, _eventContract) {
