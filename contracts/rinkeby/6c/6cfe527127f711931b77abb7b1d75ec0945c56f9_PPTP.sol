...
// POCKETPUNKTIMEPIECES : Le Grand Tempus Edition ERC721 

// Calling mint mints a random  Le Grand Tempus until 2022 have been minted
// Mint costs 0.05 Ether
// 10 Kept for artists, developer & giveaways

contract PPTP is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  constructor() 
    ERC721("Le Grand Tempus", "PPTP")
    RandomlyAssigned(2022,1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
