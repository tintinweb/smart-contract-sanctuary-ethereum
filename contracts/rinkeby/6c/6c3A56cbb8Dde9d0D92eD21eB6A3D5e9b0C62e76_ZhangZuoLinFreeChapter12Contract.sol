    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 170) { }
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 170");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 170");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 170");
...
// File: contracts/ZhangZuoLinFreeChapter12Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZhangZuoLinFreeChapter12Contract is RamppERC721A {
    constructor() RamppERC721A("Zhang Zuo Lin Free Chapter 12", "ZZLFC12"){}
}