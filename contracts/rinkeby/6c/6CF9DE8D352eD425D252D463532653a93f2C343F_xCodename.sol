...
.̴̪͖͔͐͑̕.̸̺̘͔̿͘͠.̵̝͍͔̈́͘x̴͖͔͊͘̕L̵̫͚̓̀͋F̴̢͚̫̿͒̚G̵̙͇͉̓͘x̴͍͕͇̾͑̕4̸̡̞̺̓͊2̴̠̙̙̈́͋͝x̴͉̻̟͊͑͊4̸̡͕̽̓̚͜2̵̡̫͓̈́͐̚x̸͓̠͆̒͝4̵͎̺̼̒̒͘2̵̡̘͎͆̈́̕x̴͕͚̫͊͒̒.̴̺̼̫͐͐.̸͙͓͚̐̈́͊.̸̙͇͑̈́͝
´´´´´´´´´´´´´´´´´´´´´´´$¶´´´´´¶´´´´´¶¢
´´´´´´´´´´´¶¶¶¶¶¶¶´´´´´´´¶¢´´´¶´´´ø¶
´´´´´´´´´´¶¶´´´´ø¶¶¶´´´´´´oø´´ø´´øo
´´´´´´´´´´¶7´´´´´´´¶¶¶´´´´´´4´´´2´´´´o
...
´´´´´¶¶¶¶¶¶¶¶¶¶¶¶´
´´´´´´´¶¶¶¶¶¶¶¶
.̵̠͎͉̾͒̈́.̵̻͔͊̈́͛͜.̴̞͖̿͌̕͜ẍ̸͙͇͖́̾͝4̵͎̦̫͋̿͘2̴͇̞͍͒͌̕x̴̦̪͒͛v̵̝͖̙̓͑̾a̵͚͕͖͊̓͑l̴̢̡͓͛́̚x̴̺̦͍̾͑͝h̴̢̪͚̽͛̿ä̵̢̻̫́̀͑l̵̫̘͆̓͋l̴̼͙͒͋͝ä̸͕̝͓́̔̈́x̵͔̘͉̀̽̀4̴̡̫͔͒͛͒2̸̠͙͔͛̀͑ẍ̴̦́̔̾͜.̸̼̦̝͑̕͝.̴͚͙̼͋̽͘.̸̘͖͚̈́̔̔
...
contract xCodename is ERC721A, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    string private _uriprefix = '';
    string private _urisuffix = '.42';
    string private _unrevealeduri;

    uint256 private _maxtokens = 4242;
    ...
    function mint(uint256 _quantity) public payable nonReentrant {
        ...
        require((totalMinted).add(_quantity) <= _maxtokens, "max tokens minted'");
        require(msg.value >= (_price).mul(_quantity), "not enough eth sent");

        if(_checkperwallet) {
            require((wallets[msg.sender]).add(_quantity) <= _maxtokensperwallet, "minted quantity exceeds max tokens per wallet");
        }
        
        wallets[msg.sender] = (wallets[msg.sender]).add(_quantity);
        _safeMint(msg.sender,_quantity);

    }

    function mint_to(address to, uint256 _quantity) public onlyOwner nonReentrant {

        uint totalMinted = totalSupply();
        require((totalMinted).add(_quantity) <= _maxtokens, "minted quantity exceeds max tokens'");
    ...
    function walletamountminted() public view virtual returns (uint256) {
