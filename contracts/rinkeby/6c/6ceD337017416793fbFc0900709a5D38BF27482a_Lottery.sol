 ...
 * @notice This contract is for creating an unteamperable decentralized smart contract
 * @dev This implements Chainlink VRF v2 and Chanlink Keepers
 */
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    event UpkeepNeededChecked(
        bool indexed timePassed,
        bool indexed hasPlayers,
        bool indexed hasBalance
    );
     ...
     * The fallowing should be true in order to return true;
        ...
        )
    {
        ...
        // emit UpkeepNeededChecked(timePassed, hasPlayers, hasBalance);
