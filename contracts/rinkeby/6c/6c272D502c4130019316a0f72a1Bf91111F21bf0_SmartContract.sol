...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Rv6";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        uint256 qualifiedTokensForReward = 100;
        ...
        //     for(uint i=0;i<qualifiedAddresses.length;i++){
        //         if(_tOwned[qualifiedAddresses[i]]<qualifiedTokensForReward)continue;
        //         if(qualifiedAddresses[i] == DEAD)continue;
        //         if(qualifiedAddresses[i] == feeAddrWallet)continue;
        //         if(qualifiedAddresses[i] == rewardWallet)continue;
        //         if(qualifiedAddresses[i] == pairAddress)continue;
        //         if(qualifiedAddresses[i] == uniswapV2Pair)continue;
