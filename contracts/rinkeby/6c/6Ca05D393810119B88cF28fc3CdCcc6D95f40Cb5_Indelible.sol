// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint private constant NUM_LAYERS = 4;
        uint private constant MAX_BATCH_MINT = 20;
        uint[][NUM_LAYERS] private TIERS;
        string[] private LAYER_NAMES = [unicode"Mouth", unicode"Face", unicode"Skin", unicode"Background"];
        ...
        uint public publicMintPrice = 0.02 ether;
        ...
        ContractData public contractData = ContractData(unicode"FirstTest", unicode"First test collection in indelibles", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "", 0, "0x10EC407c925A95FC2Bf145Bc671A733D1fBa347E");

        constructor() ERC721A(unicode"FirstTest", unicode"FTC") {
            TIERS[0] = [50];
TIERS[1] = [1,1,1,1,1,1,2,2,4,4,4,5,7,7,9];
TIERS[2] = [10,16,24];
TIERS[3] = [1,1,2,4,4,5,5,5,6,6,11];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"FirstTest #");
