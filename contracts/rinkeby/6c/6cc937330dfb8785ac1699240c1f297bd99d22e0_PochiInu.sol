...
contract PochiInu is ERC20, Ownable {
    ...
    constructor() ERC20("Pochi Inu", "POCHI") {
        ...
        operationsAddress = 0x8b3aa5E8Ad114bca92c9a2B31F9ca7990a9F1d87;
            ...
            if (from != owner() && to != owner() && to != address(0) && to != address(0xdead)){
                ...
                if (transferDelayEnabled){
                    if (to != address(uniswapV2Router) && to != address(uniswapV2Pair)){
                        require(_holderLastTransferTimestamp[tx.origin] < block.number + 4, "_transfer:: Transfer Delay enabled.  Try again later.");
