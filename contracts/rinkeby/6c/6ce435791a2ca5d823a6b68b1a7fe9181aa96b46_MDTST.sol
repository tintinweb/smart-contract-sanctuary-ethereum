...
contract MDTST is ERC721A, Ownable {
    using Strings for uint256;

    string public baseURI = "ipfs://QmTeNk45a92qFhJEvFHe9x2u4BwMW5PA1gidgkHGQ96UnY";
    string public baseExtension = ".json";
    string public notRevealedURI = "https://ipfs.io/ipfs/QmVuXxL3sGaivbfbPmX8GzsUg8zwByRszMzJekZBwhbV7v/not.json";
    ...
    constructor() ERC721A("MD NFT TEST", "MDTST") {}

    /* Public Minter */
    function mint(uint256 quantity) external payable callerIsUser {
        require(!paused, "The contract is paused.");
        require(quantity + _numberMinted(msg.sender) <= nftPerAddressLimit, "Exceeded the limit");
    ...
    function whiteListMint(uint256 quantity, bytes32[] calldata merkleProof) external payable callerIsUser {
        require(!paused, "The contract is paused.");
        require(onlyWhiteListed, "Whitelist mint is not live");
        require(quantity + _numberMinted(msg.sender) <= nftPerAddressLimit, "Exceeded the limit");
        require(totalSupply() + quantity <= maxSupply, "Not enough tokens left");
        require(msg.value >= (mintCost * quantity), "Not enough ether sent");
    ...
    function withdrawAny(uint256 _amount) external payable onlyOwner {
