...
contract AHeavenInAWildFlower is
  ...
  Ownable
{
  uint256 public constant MAX_SUPPLY = 200; // TODO: 「MAX_SUPPLY」の方が良い
  ...
  constructor(string memory baseTokenURI, address artistAddress)
  ...
  function mint(uint256 quantity) external payable override nonReentrant {
    ...
    require(
      nextTokenId + (quantity - 1) <= MAX_SUPPLY,
    ...
    for (uint256 i = 0; i < quantity; i++) {
      ...
      _safeTransfer(_artistAddress, _msgSender(), tokenId, "");
    }
  }

  // TODO: owner mintはどうする？
