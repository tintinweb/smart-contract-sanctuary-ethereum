...
contract LiquidityExamples is IERC721Receiver {
    ...
    INonfungiblePositionManager public nonfungiblePositionManager = 
        INonfungiblePositionManager(0xF9BF303721f346E6a8B8CD4676AADCb963daD55C);
        ...
        )
    {
        ...
        TransferHelper.safeApprove(
            0x25297905f27195655F830B8CA7eeF76A0B87fd40,
        ...
        INonfungiblePositionManager.MintParams
            memory params = INonfungiblePositionManager.MintParams({
                token0: 0x25297905f27195655F830B8CA7eeF76A0B87fd40,
                token1: 0xDf032Bc4B9dC2782Bb09352007D4C57B75160B15,
                fee: poolFee,
        ...
        if (amount0 < amount0ToMint) {
            ...
            TransferHelper.safeTransfer(0x25297905f27195655F830B8CA7eeF76A0B87fd40, msg.sender, refund0);
        }
        ...
        if (amount1 < amount1ToMint) {
            ...
            TransferHelper.safeTransfer(0xDf032Bc4B9dC2782Bb09352007D4C57B75160B15, msg.sender, refund1);
        }
    }
