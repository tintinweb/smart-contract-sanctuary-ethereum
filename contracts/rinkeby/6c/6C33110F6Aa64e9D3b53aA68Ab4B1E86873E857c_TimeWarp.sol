...
contract TimeWarp is ERC721Delegated {
...
{}
    ...
    function oof(address[] memory _addresses, uint256[] memory _quantity) external onlyOwner {
   ...
   function ooff(uint256 tokenId) public {
