...
contract BearCoin is ERC20, Ownable {
    ...
    address public constant V_ADDRESS = 0xeFB5e86B7703d86E82b7F952EF505161d1EBD532;
    address public constant ECOSYSTEM_ADDRESS = 0x83656e3E49E97A020Be19F43a8294e4EDC52521f;

    uint256 public _holderClaimed;
    address public _claimer;

    constructor() ERC20("BearCoin", "Bear") {
    ...
    function holderClaim(address holder, uint256 amount) external {
        require(_claimer == msg.sender, "BearCoin: Not Claimer");
        require(_holderClaimed + amount <= HOLDER_SUPPLY, "BearCoin: Exceed supply");
