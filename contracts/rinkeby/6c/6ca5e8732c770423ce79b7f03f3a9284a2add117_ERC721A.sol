...
contract ERC721A is Context, ERC165, IERC721A,Ownable {
    ...
    function whitelistmint(uint256 _mintAmount, bytes32[] memory proof)public payable{ 
        ...
        require( whitelistmintperwalletcounter[msg.sender]+_mintAmount <=whitelistmintperwalletlimit,"cant mint above whitelistmintperwalletlimit");
    ...
    function mint(uint256 _mintAmount)public payable{ 
      ...
      function setwhitelistmintperwalletlimit(uint256 _limit) public onlyOwner {
        whitelistmintperwalletlimit = _limit;
    } 
     ...
     function setitelistmintcost(uint256 _newCost) public onlyOwner {
