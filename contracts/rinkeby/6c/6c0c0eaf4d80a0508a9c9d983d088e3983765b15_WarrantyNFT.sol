...
// File: contracts/WarrantyNFT.sol
...
contract WarrantyNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("WarrantyNFT", "WNFT") {
        interval = 16743307675; // extreme date -> Thursday, 29 July 2500 6:47:55 AM
    ...
    function safeMint(address to, uint256 quantity, uint256 _interval) public onlyOwner {
        lastTimeStamp = block.timestamp;
        interval = _interval;
