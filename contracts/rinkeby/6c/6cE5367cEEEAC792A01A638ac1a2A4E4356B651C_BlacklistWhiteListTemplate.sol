...
// File contracts/templates/BlacklistWhiteListTemplate.sol



contract BlacklistWhiteListTemplate is ERC20Base, BlacklistFeature, PausableWithWhitelistFeature {
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(BlacklistFeature, PausableWithWhitelistFeature) {
