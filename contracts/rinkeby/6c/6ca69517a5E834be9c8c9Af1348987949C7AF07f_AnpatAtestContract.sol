...
// U  /"\  u   | \ |"|    U|  _"\ u U  /"\  u   |_ " _|  U  /"\  u      
//  \/ _ \/   <|  \| |>   \| |_) |/  \/ _ \/      | |     \/ _ \/       
//  / ___ \   U| |\  |u    |  __/    / ___ \     /| |\    / ___ \       
// /_/   \_\   |_| \_|     |_|      /_/   \_\   u |_|U   /_/   \_\      
//  \\    >>   ||   \\,-.  ||>>_     \\    >>   _// \\_   \\    >>      
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE6f94469Ac0168b54f114A5193CAb1A220C26017];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 30) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmbf8tDgYAM4itDBPvkn7tj9Hs8KNcQWCRgr9r7LpwzFXM/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 30");
...
// File: contracts/AnpatAtestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnpatAtestContract is RamppERC721A {
    constructor() RamppERC721A("ANPATAtest", "APTtest"){}
}
