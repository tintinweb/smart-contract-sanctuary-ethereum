...
contract BrainDrizzle is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    constructor() ERC721("BrainDrizzle", "BRZ") {
       isWhitelisted[msg.sender] = true;
    }

    // constructor(address _randomizerContract) ERC721("BrainDrizzle", "BRZ") {
    //   isWhitelisted[msg.sender] = true;
    ...
    function setProjectStartingIndex(uint256 _projectId) public {
        ...
        projectIdToStartingIndex[_projectId] = 10025480 % projects[_projectId].maxInvocations;
