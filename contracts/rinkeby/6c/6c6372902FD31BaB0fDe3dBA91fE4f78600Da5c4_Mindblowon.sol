    ...
    Withdrawable
{
    ...
    uint256 public constant PRIVATE_SALES_MAX_QTY_PER_MINTER = 2;
    uint256 public constant DA_SALES_START_PRICE = 0.69 ether;
    uint256 public DA_LAST_PRICE = DA_SALES_START_PRICE;
    uint256 public constant priceDropDuration = 1800; // 15 mins
    ...
    //     require(
    //         DATokenIdToPrice[tokenId] > DA_LAST_PRICE,
    //         "Refund Not Eligible"
    //     );
    //     require(ownerOf(tokenId) == msg.sender, "Not NFT Owner");
    //     // Check if buyer
    //     require(
    //         DATokenIdToAddress[tokenId] == msg.sender,
    //         "Owner Not Eligible"
    //     );
    //     DATokenIdToPrice[tokenId] = DA_LAST_PRICE;
    //     payable(msg.sender).transfer(DATokenIdToPrice[tokenId] - DA_LAST_PRICE);
    // }
    ...
    function getPrice() public view returns (uint256) {
        ...
        if (isDASalesActivated()) {
            uint256 dropCount = (block.timestamp - DASalesStartTime) /
                priceDropDuration;
            // It takes 11 dropCount to reach at 0.14 floor price in Dutch Auction
            return
                dropCount < 11
    ...
    //     );
    //     require(
    //         publicSalesMinterToTokenQty[msg.sender] + 1 <= 2,
    //         "Exceed max mint per minter"
    //     );
    //     require(msg.value >= price, "Insufficient ETH");
    //     require(tx.origin == msg.sender, "Contracts not allowed");
