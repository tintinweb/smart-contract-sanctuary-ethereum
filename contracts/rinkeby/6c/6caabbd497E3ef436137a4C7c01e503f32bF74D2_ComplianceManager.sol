...
contract ComplianceManager is IComplianceManager,Initializable, AccessControlUpgradeable{
 ...
 */
    ...
    bytes32 public constant FEDMEMBER_INPUT_ROLE = keccak256("FEDMEMBER_INPUT_ROLE");
    ...
    //ERC20 allowList for transfer tokens from this contract to another address
    ...
    function initialize() public initializer{
     ...
     function addBlockList(address addr) external onlyRole(FEDMEMBER_INPUT_ROLE) {
    ...
    function removeFromBlockList(address addr) external onlyRole(FEDMEMBER_INPUT_ROLE) {
