...
contract SeeX1 is ERC20, Ownable {
    ...
    constructor(uint256 _initialSupply, address _routerAddress, address _treasury) ERC20("SEEX1", "SEEX1") {
        treasury = _treasury;
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uint256 fee = amountETH.mul(feeOnSell).div(100);
        uint256 finalAmount = amountETH - fee;
     ...
     * @param _tokenAddress The contract address of the token to be recovered
     * @param _tokenAmount  Number of tokens to be sent to the function caller
     */
