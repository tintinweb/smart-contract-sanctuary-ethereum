...
//*********************************************************************//
//
//     __ ___ _ ______________ ____________    
//    / |/ /_ __ / | / / ____/_ __/ / ____/_ __/____
//   / /|_/ / / / / |/ / /_ / / / __/ / / / ___/
//  / / / / /_/ / / /| / __/ / / / /___ / / (__)
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x03D2aF6FEABa803274C92D3483203662CeB02489];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x03D2aF6FEABa803274C92D3483203662CeB02489;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 5500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUEXoiCcGYqVsSg6BQQdcjaB6WL11AY4R6t7KM5C9poMq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 5500");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5500");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 5500");
...
// File: contracts/MyNfteTsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNfteTsContract is RamppERC721A {
    constructor() RamppERC721A("My NFT ETs", "METS"){}
}
