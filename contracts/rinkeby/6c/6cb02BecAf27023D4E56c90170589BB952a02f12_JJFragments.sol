    ...
    Ownable
{
    ...
    uint256 public constant MAX_SUPPLY = 7000;           // +1 to save on gas cost of <= vs <
    ...
    uint256 public constant PRESALE_ETH_PRICE = 0.5 ether;
    ...
    constructor() ERC721("JJFragments", "JJFragments") {
        //_pause(); // start paused
