    ...
    EIP712Upgradeable
{
    ...
    modifier AuctionTimeIsOver(uint256 auctionId) {
        AuctionDetails memory auctionDetails = auctions[auctionId];
        require(
    ...
    function createAuction(
        ...
        auctions[_auctionIds.current()] = AuctionDetails({
            owner: _owner,
            tokenId: _tokenId,
            minPrice: _minPrice,
    ...
    function finaliseFixedPriceAuction721(
        ...
        AuctionDetails memory auctionDetails = auctions[_auctionId];
        require(
        ...
        MarketplaceVoucher memory voucher = MarketplaceVoucher({
            ...
            minPrice: auctionDetails.minPrice,
        ...
        uint256 feeAmt = (auctionDetails.minPrice * feePercent) /
            (10000 + feePercent);
        uint256 netSalePrice = _deduceRoyalties721(
            voucher.tokenId,
            auctionDetails.minPrice,
            _msgSender()
        );
    ...
    function finaliseERC721Auction(
        ...
        AuctionTimeIsOver(_auctionId)
        returns (bool)
    {
        AuctionDetails memory auctionDetails = auctions[_auctionId];
        require(
            auctionDetails.auctionType == 2 || auctionDetails.auctionType == 3,
    ...
    function finaliseFixedPriceAuction1155(
        ...
        require(
            quantity <= auctionDetails.quantityLeft,
        ...
        auctionDetails.quantityLeft -= quantity;
        auctions[_auctionId] = auctionDetails;
    ...
    function finaliseERC1155Auction(
        ...
        uint256 bidAmount,
        uint256 quantity
    ) public OnlySeller(_auctionId) AuctionTimeIsOver(_auctionId) {
        AuctionDetails memory auctionDetails = auctions[_auctionId];
        require(
            auctionDetails.auctionType == 2 || auctionDetails.auctionType == 3,
            "Only Unlimited and Timed Auctions can be Finalised"
