...
contract XulpFactory is ERC721AQueryable, ERC2981, Ownable {

    bool saleState;
    // address private GLIXTOKEN_ADDRESS = 0x4e09d18baa1dA0b396d1A48803956FAc01c28E88; // mainnet
    address private GLIXTOKEN_ADDRESS = 0x25Ae3D3003ac04923038145f759f6FBb049BE409; // rinkeby
    ...
    function editSale(uint price, uint supply, uint _maxMintPerTx) public onlyOwner {
        glixPrice = price;
        totalXulps = supply;
