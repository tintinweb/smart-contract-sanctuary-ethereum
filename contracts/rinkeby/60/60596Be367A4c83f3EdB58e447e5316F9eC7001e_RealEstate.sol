...
contract RealEstate is Pausable, Ownable {
    ...
    function createTicket(uint256 _propertyId)
        public
        onlyAgency
    {
    ...
    function acceptingDeal(uint256 _propertyId) public onlyAgency {
        ...
        buyerInfo[_propertyId].buyerAddress = properties[_propertyId].currentOwner;
        buyerInfo[_propertyId].fullName = properties[_propertyId].fullName;
        buyerInfo[_propertyId].phoneNumber = properties[_propertyId].phoneNumber;
