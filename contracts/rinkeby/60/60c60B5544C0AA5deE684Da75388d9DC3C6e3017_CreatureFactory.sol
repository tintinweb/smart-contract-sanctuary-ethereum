...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        Cubeman openSeaCreature = Cubeman(nftAddress);
    ...
    function tokenURI(uint256 _optionId) override external view returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, string(abi.encodePacked(string(abi.encodePacked('cube', Strings.toString(_optionId))), '.gif'))));
    }
...
contract CreatureLootBox is ERC721Tradable {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://cubex.mypinata.cloud/ipfs/QmfC1VS9AG3ZT5zAEKYxDkmdPemj9cNVBp3MXijtW68bAN/";
    }
...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    function tokenURI(uint256 _tokenId) override public pure returns (string memory) {
        return string(abi.encodePacked(baseTokenURI(), string(abi.encodePacked(string(abi.encodePacked('cube', Strings.toString(_tokenId))), '.gif'))));
    }
