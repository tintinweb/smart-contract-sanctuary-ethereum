...
/**
 * @notice Represents MetaSaviorsERC721 Smart Contract
 */
...
/**
 * @title MetaSaviorsPreSaleContract.
 *
 * @author KG Technologies (https://kgtechnologies.io).
 *
 * @notice This Smart Contract can be used to sell any fixed amount of NFTs where permissioned
 * wallets are allowed to buy with the option of a public sale. Buying is limited to a certain time period.
 *
 * @dev The primary mode of verifying permissioned actions is through Merkle Proofs
 * which are generated off-chain.
 */
contract MetaSaviorsPreSaleContract is Ownable {
     ...
     * @dev MINT DATA 
     */
    uint256 public maxSupply = 8004 - 150;
    uint256 public minted = 0;
    uint256 public limitOpen = 30;
    uint256 public mintPriceOpen = 0.18 ether;
    ...
    event setMintPriceOpenEvent(uint256 indexed price);
    ...
    function buyOpen(uint256 amount) 
        ...
        require(minted + amount <= maxSupply, "MINT AMOUNT GOES OVER MAX SUPPLY");
        require(msg.value >= mintPriceOpen * amount, "ETHER SENT NOT CORRECT");
    ...
    /**
     * @notice Change the mint limit per wallet on public sale.
     *
    ...
    /**
     * @notice Change the price of the public sale.
     *
     * @param price. The new price.
     */
    function setMintPriceOpen(uint256 price) external onlyOwner {
        mintPriceOpen = price;
        emit setMintPriceOpenEvent(price);
    }

    /**
     * @notice Change the state of the public sale.
     *
