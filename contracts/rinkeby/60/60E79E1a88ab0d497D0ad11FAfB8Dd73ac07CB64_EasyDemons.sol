...
contract EasyDemons is ERC721A, Ownable, ReentrancyGuard, PullPayment {
    ...
    function setWalletA(address wallet_) external onlyOwner {
        walletA = wallet_;
    }

    function setWalletB(address wallet_) external onlyOwner {
        walletB = wallet_;
    }

    function setWalletC(address wallet_) external onlyOwner {
        walletC = wallet_;
    }
}
