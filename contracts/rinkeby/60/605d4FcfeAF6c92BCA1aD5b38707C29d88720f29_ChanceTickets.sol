...
contract ChanceTickets is Ownable, ERC1155Pausable {
    ...
    modifier onlyRedempion() { 
        require(msg.sender == redempionAddress,"Only Redempion contract can call this.");
        _;
    }  

    function burn(address from, uint256 id, uint256 amount) external onlyRedempion {
        require(balanceOf(from, uint256(TokenOptions.Token)) > 0 ,"Tokens: No tokens to be burnt");
