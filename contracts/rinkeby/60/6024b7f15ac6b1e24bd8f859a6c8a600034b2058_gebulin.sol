...
contract gebulin is ERC2981, ERC721A, Ownable {
    using Address for address payable;
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public immutable _mintPrice = 0.0069 ether;
    uint32 public immutable _txLimit = 5;
    uint32 public immutable _maxSupply = 100;
    uint32 public immutable _walletLimit = 5;

    bool public _started;
    string public _metadataURI = "ipfs://QmdwrgNsFsQuijQgvkLzWWDybQFR9MdR7Zfy3n5v8nrJq8/";

    constructor() ERC721A("gebulin", "GBL") {
