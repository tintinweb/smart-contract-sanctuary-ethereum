...
contract MetaborgStars is ERC721Upgradeable {
    ...
    */
    function getUserGroup(address _address) public view returns(uint){
        ...
        if(IERC1155Upgradeable(ERC1155Address).balanceOf(_address, METABORG_DIAMOND_ID) > 0 || IERC1155Upgradeable(ERC1155Address).balanceOf(_address, METABORG_GOLD_ID) > 0 || IERC1155Upgradeable(ERC1155Address).balanceOf(_address, METABORG_ORIGINAL_ID) > 0) {
