...
contract BlockchainBureauNFT is ERC721, Ownable{
    ...
    constructor() payable ERC721('BlockchainBureau', 'BB'){
        mintPrice = 0.02 ether;
        totalSupply = 0;
        maxSupply = 69;
        maxPerWallet = 2;
        //set withdraw wallet address
        withdrawWallet = payable(0x525c5E80523C7fb1253f86bd209A8515FE398559);
    }
