...
contract MyEpicNFT is ERC721URIStorage {
  ...
  // mint数を制限する
  function restrictMinting(uint256 tokenId) public view returns (bool) {
  ...
  function makeAnEpicNFT() public {
    ...
    bool limitedMint = restrictMinting(newItemId);
    console.log("limitedMint");
    console.log(limitedMint);
    if(limitedMint == true) {
      console.log("Already full minted");
      return;
    }
