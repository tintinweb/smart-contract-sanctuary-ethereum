...
contract TestMST is ERC721A, Ownable  {
  using SafeMath for uint256;
    ...
    uint256 constant public MAX_SUPPLY_S1= 20;
	uint256 constant public MAX_SUPPLY_S2= 50;
	uint256 constant public MAX_WL_SUPPLY = 10;
    ...
    function mint(uint256 numberOfTokens) external payable callerIsUser {
        require(saleIsActiveS1 || saleIsActiveS2, "Sale must be active to mint");
