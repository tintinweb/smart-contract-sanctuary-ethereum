...
contract TroopCardsNFT is ERC1155, Ownable, ERC1155Burnable {
    ...
    function contractURI() external pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmcGF8So76oo9wNMyCKB8rmXiJVZC49U7HjNXqhxkFCWe5";
    }
    ...
    {
        return string(abi.encodePacked(super.uri(id), _uint2str(id), ".json"));
    }
