...
contract Test is ERC721Enumerable, Ownable {
    ...
    uint256 public PASS_PUBLIC = 100;
    uint256 public PASS_GIFT = 50;
    uint256 public PASS_MAX = PASS_GIFT + PASS_PUBLIC;
    uint256 public PASS_PRICE = .001 ether;
    uint256 public constant PASS_PER_MINT = 25;
    string private _tokenBaseURI = "http://ipfs.io/ipfs/QmaHujtt6Uxd8t4rKDiNW92tyzdHLjNa2m783UYYeJQLDB";
    ...
    function reserveGiveaway(uint256 numPass) public onlyOwner {
        ...
        for (index = 0; index < numPass; index++) {
            _safeMint(0xE3Af2fb66c545b77BFD7Bfc10F5FaE3fEbdEeFC4, currentSupply + index + 1);
        }
    }
    ...
    function withdrawTeam() external onlyOwner {
        ...
        payable(0xE3Af2fb66c545b77BFD7Bfc10F5FaE3fEbdEeFC4).transfer((balance*100)/100);
    }
