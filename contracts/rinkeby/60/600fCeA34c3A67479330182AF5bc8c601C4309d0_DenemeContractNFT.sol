...
contract DenemeContractNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Deneme NFT", "DNFTD") {
    setHiddenMetadataUri("ipfs://QmRuyDsLLm8ig1fpeb43uhTGgRprGxSbZp1bTw2qnCjjjg/1.json");
  }
