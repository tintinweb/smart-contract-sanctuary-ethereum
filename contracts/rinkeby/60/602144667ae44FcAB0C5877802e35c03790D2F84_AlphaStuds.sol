...
contract AlphaStuds is ERC721Enumerable, Ownable 
{
    ...
    address payable private fusionaryDev = payable(0xdae50618ca32030EB213C032313229a79F67c697);

    address deadZone = address(0x000000000000000000000000000000000000dEaD); //burn adress
    
    constructor() ERC721("AlphaStuds_1.0.0", "AlphaStud_1.0.0") {}
