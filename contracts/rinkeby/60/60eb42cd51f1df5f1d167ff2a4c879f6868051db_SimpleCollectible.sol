...
contract SimpleCollectible is ERC721A, Ownable {
    ...
    uint256 public _presalePrice = 10000000000000000; //.00 ETH
    uint256 public _salePrice = 20000000000000000; // .05 ETH
    ...
    uint256 public _maxPerTx = 26; //25 
    ...
    constructor () ERC721A ("DesignerPunk Kids","DP", 1, 5555)  {
