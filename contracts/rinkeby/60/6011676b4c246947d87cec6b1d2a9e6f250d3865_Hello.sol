...
contract Hello is ERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 50000000000000000000; //max tx amount
    bool public _taxActive = true;
    bool public _maxTxActive = true;
    ...
    function transferFrom(address from, address to, uint256 amount) public virtual override returns (bool) {
      ...
      if(_maxTxActive && !_whitelists['from'][from] && !_whitelists['to'][to]){
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
      ...
      if(_maxTxActive && !_whitelists['from'][owner] && !_whitelists['to'][to]){
        require(amount <= _maxTxAmount);
      }
