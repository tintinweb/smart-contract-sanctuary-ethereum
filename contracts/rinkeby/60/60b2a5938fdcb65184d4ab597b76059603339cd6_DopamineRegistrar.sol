...
contract DopamineRegistrar is ERC1155B, IERC1155Receiver, IPNFTRegistrar {
    ...
    /// @param hash The EIP-191 hash of the message.
    ...
    /// @dev Ensures Registrar is an authorized operator for all transfers.
    /// @inheritdoc ERC1155B
    ...
    function claim(
        ...
        bytes32 r,
        bytes32 s
    ) public onlyChip(chip, hash, v, r, s) {

        uint256 chipId = _id(chip);

        address owner = _ownerOf[chipId];
        _ownerOf[chipId] = msg.sender;
        emit TransferSingle(msg.sender, owner, msg.sender, chipId, 1);

        _transferPNFTBalance(chip, owner, msg.sender);
    }
    ...
    function onERC1155Bind(
        ...
        return IERC1155PNFTRegistrar.onERC1155Bind.selector;
    }
    ...
    function onERC1155Unbind(
        ...
        return IERC1155PNFTRegistrar.onERC1155Unbind.selector;
    }
    ...
    function onERC721Bind(
        ...
        return IERC721PNFTRegistrar.onERC721Bind.selector;
    }
    ...
    function onERC721Unbind(
        ...
        return IERC721PNFTRegistrar.onERC721Unbind.selector;
    }
