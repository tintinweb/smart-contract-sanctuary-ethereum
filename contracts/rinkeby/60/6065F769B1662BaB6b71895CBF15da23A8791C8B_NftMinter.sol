...
contract NftMinter is ERC721Enumerable, Ownable {
    ...
    uint256 internal maxSupply = 50;
    string internal baseExtension = ".json";
    string internal baseURI;
    bool public revealed = false;
    string public notRevealedUri;
    uint256 public mintIndex = 3;
    ...
    function airdropMint() external onlyOwner {
        ...
        for(uint256 i = 0; i < airdropAddresses.length; i++){
            ...
            for(uint256 j = 0; j < airdropList[airdropAddresses[i]]; j++){
                ...
                // }
                if(mintIndex.add(1) == 30 || mintIndex.add(1) == 40){
    ...
    function publicMint(uint256 _amount) external{
        ...
        if (msg.sender != owner()) {
            ...
            require(publicNftMintCount <= 10,"Public nft Minted");
        }
    ...
    function reserveMint(uint _amount) external {
        ...
        require(!emergencyStop, "Contract is paused");
        require(_amount > 0, "Value less than 0");
        require(reservedNftMintCount.add(_amount) <= 5,"Reserved nft minted");
        ...
        for (uint256 i = 1; i <= _amount; i++) {
            ...
            //     reserveMintIndex = 40;
            // }
            if(reserveMintIndex.add(1) > 3 && reserveMintIndex.add(1) <= 29 ){
                reserveMintIndex = 29;
            }else if(reserveMintIndex.add(1) > 30 && reserveMintIndex.add(1) <= 39){
                reserveMintIndex = 39;
            }
