...
contract Kekistan is Ownable, ReentrancyGuard, ERC721A {
    using Strings for uint256;

    uint256 public publicPrice = 0.002 ether;
    uint128 public freePerTxn = 2;
    uint128 public freeSupply = 700;
    uint128 public publicPerTxn = 20;
    uint128 public maxSupply = 3333;
    string private baseURI;

    constructor(string memory baseURI_) ERC721A("Kekistan", "KEK") {
        baseURI = baseURI_;
    }
