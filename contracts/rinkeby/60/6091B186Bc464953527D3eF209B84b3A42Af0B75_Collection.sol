...
contract Collection is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    uint256 public MAX_MINT_SUPPLY = 2;
    // whitelist
    ...
    constructor() ERC721("Collection", "MYC") {
    ...
    require(_mintAmount <= MAX_MINT_SUPPLY);
