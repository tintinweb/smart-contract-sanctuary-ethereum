...
contract TreasuryVester {
    ...
    function setRecipient(address recipient_) public {
        require(recipient_ != address(0), "Zero address, Invalid!");
        require(
    ...
    function claim() public {
        ...
        if (block.timestamp >= vestingEnd) {
            amount = ISteerToken(steertoken).balanceOf(address(this));
        } else {
        ...
        ISteerToken(steertoken).transfer(recipient, amount);
    }
}
