...
contract multiSig {
    ...
    function createProposal(
        ...
        console.log("proposal length", proposals.length);
        proposals.push(
        ...
        onlyApprover
    {
        ...
        if (proposals[id].approvals >= quorum) {
            ...
            if (functionId == 0) {
                ...
                console.log("address to add", proposals[id].addr);
...
contract BruPool is BruAdmin, IBruPool, UUPSUpgradeable {
    ...
    function repay(
        ...
        console.log("totalPayablePrice", totalPayablePrice);
    ...
    function upgradeInterest(string memory nftId) public {
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < bonds.length; i++) {
         ...
         console.log("Withdrable Balance", withdrawableBalance);
        return withdrawableBalance;
    }

    function addToInactiveBonds(address userAddress) public {
        // console.log("In add to inactive bonds");
        BondDetails[] memory arr = userInfo[userAddress].activeBonds;
        for (uint256 k = 0; k < arr.length; k++) {
            if (
                ...
                // console.log("Found a expired bond");
                ...
                // console.log("Removing the bond from active bond list");
                removeActiveBond(k, userAddress);
                // console.log("Removed the bond from active bond list");
            }
        }
    }
        ...
        for (uint256 i = 0; i < bonds.length; i++) {
            if (tokenAmount == 0) {
                ...
                if (bonds[i].bondAmount > tokenAmount) {
                    ...
                    IERC20(bonds[i].tokenAddress).transfer(
                        userAddress,
                        tokenAmount
                    );
                    break;
    ...
    function redeemInterestToken(
        ...
        IERC20(requiredTokenAddress).transfer(userAddress, tokenAmount);
    }
    ...
    function removeFromInactiveBond(uint256 index, address userAddress) public {
        if (index == userInfo[userAddress].inactiveBonds.length - 1) {
            ...
            // console.log(index, userInfo[userAddress].inactiveBonds.length);
            for (
                uint256 i = index;
...
contract BruAdmin is IBruAdmin {
    ...
    uint256 public nonWithdrawFees;
    ...
    function changeLockPeriod(uint256 time) public override onlyAdmin {
        require(time > 0, "Day should be greater than zero");
        lockPeriod = time;
    }
