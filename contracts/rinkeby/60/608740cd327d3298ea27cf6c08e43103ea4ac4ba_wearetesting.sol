...
contract wearetesting is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public constant maxPerMint = 6;
    ...
    constructor(string memory initBaseURI) ERC721A("wearetesting", "waret") {
        baseURI = initBaseURI;
    ...
    function mint(uint256 quantity) external payable nonReentrant {
        ...
        require(
            numberMinted(msg.sender) + quantity <= maxPerMint,
