...
In the eastern saying, of all Chinese descendants, we are all the dragon descendants which empower us with braveness, wisdom and integrity. 
...
contract DragonKing is IERC20, ReentrancyGuard, Ownable {
  ...
  string private _symbol = unicode"\xe9\xbe\x99\xe7\x8e\x8b";
