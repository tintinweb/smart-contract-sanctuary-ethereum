...
// File: contracts/TestApes20Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestApes20Contract is RamppERC721A {
    constructor() RamppERC721A("Test Apes 20", "TESTAPE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/nwoNt3JvCPocd2Hr6RyU/contract-metadata";
    }
}
