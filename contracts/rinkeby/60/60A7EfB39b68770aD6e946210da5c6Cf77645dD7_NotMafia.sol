...
contract NotMafia is ERC721A, Ownable, ReentrancyGuard {
    ...
    function whiteListMint(bytes32[] calldata __proof)
        external
        nonReentrant
        mint
    {
        ...
        if (balanceOf(msg.sender) > 0) revert AlreadyMintedMaxInPhase();
    ...
    function freeMint(bytes32[] calldata __proof) external nonReentrant mint {
        ...
        mint
    {
        ...
        uint256 amountMinted = hasMintedPublic[msg.sender];
        ...
        unchecked {
            ...
            hasMintedPublic[msg.sender] = amountMinted + __amount;
        }
        _safeMint(msg.sender, __amount);
    }
