...
contract Mortgage is UpgradeablePausable, IMortgage {
  ...
  function initializeContract(
  ...
  ) public override onlyHouseHoldPool initializer {
    require(address(config) != address(0) && address(borrower) != address(0), "Config/borrower invalid");
    ...
    accounting = Accounting({
      ...
      termEndTime: 0,
      nextDueTime: 0,
      interestAccruedAsOf: 0,
      lastFullPaymentTime: 0,
    ...
    mortgageTerms = MortgageTerms({
      ...
      late_fee: late_fee,
      mortgage_default: mortgage_default
    });
  }
