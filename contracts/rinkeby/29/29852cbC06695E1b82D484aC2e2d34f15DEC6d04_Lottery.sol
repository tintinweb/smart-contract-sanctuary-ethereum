...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function enter() public payable {
        ...
        require(msg.value >= getEntranceFee(), "Not more ETH!");
        players.push(msg.sender);
    }

    function getEntranceFee() public view returns (uint256) {
        // The price let's, say, is $3000 for 1 Eth.
    ...
    function endLottery() public onlyOwner {
        // uint256(
        //     // The keccak256 is the hashing algorithm.
        //     keccak256(
        //         abi.encodePacked(
        //             nonce, // Nonce is predictable (also known as, transaction number).
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        // Let's, say, we have 7 players. Our random number is 22. 22 % 7 = 1. 1 is index of the winner.
