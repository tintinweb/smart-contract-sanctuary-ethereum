...
contract Artlab is ERC721A, Ownable {    
    ...
    ) ERC721A("Testlab", "TLAB") {        
        setUriPrefix(_uriPrefix);
        setSignerAddresses(_ehSignerAddress, _amSignerAddress);
        setWallet(_wallet);
        setCost(0.05 ether);
    ...
    function setSignerAddresses(address _ehSignerAddress, address _amSignerAddress) public onlyOwner {
