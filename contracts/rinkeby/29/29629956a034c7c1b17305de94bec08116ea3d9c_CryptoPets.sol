...
contract CryptoPets is ERC721, VRFConsumerBase {
    ...
    mapping(uint => PetType) public tokenIdToPetType;
    ...
    ERC721("CryptoPets", "CTPS") {
        keyHash = _keyhash;
        fee = 0.1 * 10 ** 18; // 0.1 LINK
        tokenCounter = 0;
    }
    
    function createCollectible(string memory _tokenURI) public returns(bytes32) {
    ...
    function fulfillRandomness(bytes32 requestId, uint randomNumber) internal override {
       ...
       PetType typOfPet = PetType(randomNumber % 2);
       tokenIdToPetType[newItemId] = typOfPet;
