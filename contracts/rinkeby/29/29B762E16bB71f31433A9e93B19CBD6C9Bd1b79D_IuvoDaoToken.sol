...
Community owned philanthropy: IuvoDAO aims to become the new age of decentralized charity
giving the community power to choose when & where support is given.

Website: https://iuvodao.com
Twitter: https://twitter.com/iuvodao
Telegram: https://t.me/iuvodao
***************************************************/
...
contract IuvoDaoToken is ERC20, Ownable {
  ...
  function _processFees(uint256 amountETH, uint256 amountLpTokens) private {
    ...
    // just send the remaining contract balance to the dao here
    _sendDao(address(this).balance);
  }
