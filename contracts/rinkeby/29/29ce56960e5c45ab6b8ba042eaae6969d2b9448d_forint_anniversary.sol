...
contract ERC721A is IERC721A {
    ...
    constructor(string memory name_, string memory symbol_, bool soulbound_, address contractOwner_) {
        _name = name_;
        _symbol = symbol_;
    ...
    function soulbound() public view virtual override returns (bool) {
        return _soulbound;}
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        require(!_soulbound, "Soulbound Item");
    ...
    function _burn(uint256 tokenId, bool approvalCheck) internal virtual {
        require(_msgSenderERC721A() == _contractOwner, "Not Owner of the contract");
        uint256 prevOwnershipPacked = _packedOwnershipOf(tokenId);
...
abstract contract Ownable is Context, ERC721A {
...
contract forint_anniversary is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public forintAddress = 0x6A9865aDE2B6207dAAC49f8bCba9705dEB0B0e6D;//0x5CEeBB0947d58Fabde2fc026Ffe4B33ccFE1bA8B;

    mapping(address => uint) public minted;
    mapping(address => uint) public balanceForint;
    ...
    function setSoulbound(bool _soul) public onlyOwner {
        _soulbound = _soul;}

    function forintBalance() public view returns(uint256){
        return ERC20(0x6A9865aDE2B6207dAAC49f8bCba9705dEB0B0e6D).balanceOf(_msgSender());}
    ...
    function mint(uint256 _mintAmount) public mintCompliance(_mintAmount) {
        ...
        balanceForint[_msgSender()] =  forintBalance();
        require(balanceForint[_msgSender()] > 0, "You don't have 4INT");
