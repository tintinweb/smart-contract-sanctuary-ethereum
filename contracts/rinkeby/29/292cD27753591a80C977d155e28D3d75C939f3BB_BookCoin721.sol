...
contract BookCoin721 is ERC2981, ERC721, Ownable {
    ...
    uint256 private _groupOneStartTime;
    uint256 private _groupTwoStartTime;
    uint256 private _publicMintStartTime = 1713053203;

    // counter for incrementing tokenID
    Counters.Counter private _nextTokenId;

    // map of addresses to tokenIDs
    ...
    function setGroupOneStartTime(uint256 newGroupOneStart) public onlyOwner {
        require(newGroupOneStart > _preSaleStartTime, "Set time greater than presale time");
    ...
    function setGroupTwoStartTime(uint256 newGroupTwoStart) public onlyOwner {
        require(newGroupTwoStart > _groupOneStartTime, "Set time greater than group one time");
    ...
    function setPublicMintStartTime(uint256 newPublicMintStart) public onlyOwner {
        require(newPublicMintStart > _groupTwoStartTime, "Set time greater than group two time");
