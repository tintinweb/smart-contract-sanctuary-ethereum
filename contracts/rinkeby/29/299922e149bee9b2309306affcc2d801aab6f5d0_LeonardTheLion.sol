...
contract LeonardTheLion is Ownable, ERC721A, Pausable, ReentrancyGuard {
  bool public isRevealed = true;
  uint256 public collectionSize = 703;
  uint256 public mintrate = 0 ether;
  uint64 public defaultMaxPerAddress = 3;
  ...
  string private _baseTokenURI = "ipfs://QmNrZano4buemX14Aw9FwgrQ1WajuV6wV8HtJw8kWTQnVC";
  string private _defaultTokenURI = "ipfs://QmNrZano4buemX14Aw9FwgrQ1WajuV6wV8HtJw8kWTQnVC";

  constructor() ERC721A("Leonard The Lion", "LTL") {}
  ...
  */
  ...
  function publicSaleMint(uint64 quantity)
    ...
    nonReentrant
  {
    uint256 price = mintrate;
    uint64 maxPerAddress = defaultMaxPerAddress;
