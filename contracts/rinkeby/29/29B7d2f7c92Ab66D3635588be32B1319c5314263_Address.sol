...
contract DegenIslandReveal is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Degen Island Reveal", "DGR") {
    setHiddenMetadataUri("ipfs://QmYNtAqsHR6d5K2y4NaYkgvUNNHtkWETjQKna5d1sGWmSZ/hidden.json");
  }
