...
contract DoxdTokenCollection is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC721BurnableUpgradeable {
    ...
    function initialize(address _paymentAddress) public initializer {
        __ERC721_init("Doxd Badge", "DOXDB");
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        PAYMENT_ADDRESS = payable(_paymentAddress);
        MINT_PRICE = 0.3 ether;
        CONTRACT_METADATA_URI = "https://TheNFTySetup.com/samples/ERC-721-contract-metadata.json";
        COLLECTION_BASE_URI = "https://TheNFTySetup.com/samples/ERC-721-token-metadata/";
    }
    ...
    function setPaymentAddress(address payable newPaymentAddress)
        external
        onlyOwner
    {
        PAYMENT_ADDRESS = newPaymentAddress;
    }
...
contract DoxdTokenCollectionUpgradeTest is DoxdTokenCollection {
