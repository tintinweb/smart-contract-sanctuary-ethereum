...
contract FundMe {
    ...
    function gweiToUsd() public view returns (uint256) {
        uint256 etherToUsd = getConversionRate(1);
        uint256 gweiInOneEth = (50 / (etherToUsd / 1000000000));
