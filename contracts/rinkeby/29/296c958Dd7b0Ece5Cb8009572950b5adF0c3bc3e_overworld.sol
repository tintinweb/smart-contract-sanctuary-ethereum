...
// OVERWORLD Contracts v0
// Creator: Duncan Wilson
pragma solidity 0.8.13;

import "./erc721ar.sol";


contract overworld is ERC721A {
    uint256 public _numAvailableTokens;
    uint256 public _maxSupply;
    uint256 immutable pricePerPiece = 11100000000000000; //0.0111 for test net
    ...
    constructor(string memory name_,
                ...
                uint maxSupply_) ERC721A(name_, symbol_) {
        _maxSupply = maxSupply_;
        _numAvailableTokens = maxSupply_;
    }
    function mint(uint256 quantity) external payable {
        require(msg.value == quantity * pricePerPiece,"must send in correct amount");
    ...
    // Code adapted from 721R which was from CryptoPhunksV2
...
contract ERC721A is Context, ERC165, IERC721A {
    ...
    function _ownershipOf(uint256 tokenId) internal view returns (TokenOwnership memory) {
        ...
        //TODO come back here and make sure the burned stuff works
            // require(ownership.addr != address(0x0), "ERC721: owner query for nonexistent token");
            return ownership;
            }
