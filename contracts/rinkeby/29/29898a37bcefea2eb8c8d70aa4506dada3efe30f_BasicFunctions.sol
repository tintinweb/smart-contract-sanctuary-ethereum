...
//function(string memory_variable1, int_variable2) public view/pure returns(bool) {}
...
function multiplyBalance(uint _multipler) external
{
    myBalance = myBalance * _multipler;
}
// that uses a for loop and multipliers params and string comparison
