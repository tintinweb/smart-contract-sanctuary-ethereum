...
contract StorageV2 is LogicUpgradeable, PausableUpgradeable {
    ...
    {
       BoostInfo storage userBoost = userBoosts[msg.sender];
       userBoost.blidDeposit = 0;
       userBoost.rewardDebt = 0;
       totalSupplyBLID = 0;
       accBlidPerShare = 0;
       lastRewardBlock = 0;
    }
    ...
    function updateAccBlidperShare() public {
        ...
        accBlidPerShare = accBlidPerShare + (passedblockcount * blidPerBlock / 1e18);
        lastRewardBlock = block.number;
    }
    ...
    function getBoostingClaimableBLID(address user) external view returns (uint256) {
        ...
        return (userBoost.blidDeposit * _accBLIDpershare) - userBoost.rewardDebt;
    }    
