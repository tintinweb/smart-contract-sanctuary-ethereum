...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, Ownable {
    ...
    // function ActivePresale(bool presaleactive) public  onlyOwner {
    //      activepresale = presaleactive ; 
    // }
    ...
    function Presale(address _to) payable public virtual{
        // require(activepresale,"Presale not enable");
         tokenlimit[msg.sender].a += 1;
    ...
    // function presaleEnable()  public view returns(bool) {
