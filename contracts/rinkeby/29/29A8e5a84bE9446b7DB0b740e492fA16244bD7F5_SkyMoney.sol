...
constructor(IERC20 token_,address owner_){
    ...
    createNewLvl(3, 180*(10**18), 6, 400);
    createNewLvl(4, 200*(10**18), 6, 450);
    createNewLvl(5, 220*(10**18), 8, 500);
    createNewLvl(6, 250*(10**18), 8, 550);
    createNewLvl(7, 325*(10**18), 9, 600);
}
