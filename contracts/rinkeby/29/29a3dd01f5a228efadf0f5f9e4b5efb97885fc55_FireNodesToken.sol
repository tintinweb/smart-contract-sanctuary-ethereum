...
/**
Token Name: Fire Nodes
Token Symbol: $FND
Total Supply: 1,000,000,000
Decimals: 18

Tax 6% to treasury - (0x449B31D1d1F7E973eD6a107c276Ddb9FbE5801ab)
3% development and marketing - (0x3CF449d6547f005fcdEA10ca6aaEDABDaD6559D1)
3% reflections to holders

*/

contract FireNodesToken is Context, IERC20, Ownable {
    ...
    string private _name = "Fire Nodes";
    ...
    uint public _TreasuryFee = 6;
    address public TreasuryWallet = 0x449B31D1d1F7E973eD6a107c276Ddb9FbE5801ab;

    uint256 public _DevelopmentFee = 3;
    address public DevelopmentWallet = 0x3CF449d6547f005fcdEA10ca6aaEDABDaD6559D1;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 marketingAmt = amount.mul(_DevelopmentFee).div(100);
        ...
        _transferStandard(sender, DevelopmentWallet, marketingAmt);
