...
contract MyEpicNFT is ERC721URIStorage, Ownable, NativeMetaTransaction {
    uint256 public currentSupply;
    uint256 nftPrice = 0.005 ether;
    uint256 maxPerUser = 30;
    address deployer;
    ...
    function mint()
        public payable
    {
      require(totalSupply() + 1 <= maxPerUser, "You mint the max limit");
      require(msg.value >= nftPrice, "not enough funds");
