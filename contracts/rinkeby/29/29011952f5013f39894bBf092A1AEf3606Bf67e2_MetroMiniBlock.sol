...
contract MetroMiniBlock is ERC721AMultiMint, Controllable, IMetroBlockInfo {
    ...
    uint256 public constant MET_PRICE_MAX_DELTA = CEIL_MET_PRICE - FLOOR_MET_PRICE;
    ...
    function resumtMetSale() public onlyOwner {
        metSaleActive = true;
    }
    ...
    function setAccountExtraOf(address owner, uint64 extra) public onlyController {
        _setAux(owner, extra);
    }
    ...
    function setTimestampOf(uint256 tokenId, uint40 timestamp) public onlyController {
        _ownerships[tokenId].startTimestamp = timestamp;
    }
    ...
    function _mintBlocks(uint256 amount, uint64 extra) internal {
        _mint(msg.sender, amount, '', false);
        _setAux(msg.sender, extra);
    }    
    ...
    {
        return tokensOfOwnerInRange(owner, _startTokenId(), _startTokenId() + totalMinted() - 1);
    }
...
contract ERC721AMultiMint is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Optimization - mint types to use in child contract
