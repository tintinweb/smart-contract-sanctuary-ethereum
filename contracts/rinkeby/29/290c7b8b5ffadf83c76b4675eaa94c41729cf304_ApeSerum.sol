...
contract ApeSerum is Ownable, ERC721A, ReentrancyGuard {
  ...
  modifier callerIsUser() {
    ...
    function ClaimFree() public {
        uint256 owned = IERC721Enumerable(0xd9145CCE52D386f254917e481eB44e9943F39138).balanceOf(msg.sender);
        uint count=0;
        require(owned > 4, "Require at least 5 unclaimed Baby Doodle Apes");
        for (uint256 index = 0; index < owned; index++) {
            if(!tokenIdClaimed[IERC721Enumerable(0xd9145CCE52D386f254917e481eB44e9943F39138).tokenOfOwnerByIndex(msg.sender, index)]){
                count++;
                tokenIdClaimed[IERC721Enumerable(0xd9145CCE52D386f254917e481eB44e9943F39138).tokenOfOwnerByIndex(msg.sender, index)]=true;
            }
        }
        require(count > 5,"Not eligiable for free claims, buy from Opensea");
