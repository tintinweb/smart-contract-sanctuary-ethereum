...
contract MetabillionaireAirdropERC721A is  Ownable, ERC721A  {
    ...
    ERC721A("Metabillionaire Airdrop", "METAB") {
        baseURI = _baseURI;
    }
    ...
    function setBaseUri(string memory _baseURI) external onlyOwner {
     ...
     function burn(uint256 tokenId) virtual external onlyOwner {
        _burn(tokenId);
    }
}
