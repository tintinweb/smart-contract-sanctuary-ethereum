    ...
    UUPSUpgradeable
{
    ...
    function mintGetter(address owner)
        external
        view
        returns (
            uint64 teamCount_,
            uint64 keySupporterCount_,
            uint64 publicWhiteListCount_
        )
    {
        teamCount_ = teamPlayersCount[owner];
        keySupporterCount_ = keySupporterCount[owner];
        publicWhiteListCount_ = publicWhiteListCount[owner];
    }
        ...
        nonReentrant
    {
        ...
        require(teamPlayerSaleIndex < 71, "team players all minted");
        ...
        nonReentrant
    {
        ...
        require(publicWhiteListSaleIndex < 1394, "whitelist all minted");
        require(_count < 6, "whitelist mint balance over");
        require(mintFee * _count <= msg.value, "!enough mintFee");

        console.log("Total balance", balanceOf(_msgSender()) + _count < 6);
        console.log("Total balance < 6 ", balanceOf(_msgSender()) + _count < 6);
