...
mapping(address =>uint256) public addressMintedBalance;
  ...
  constructor() ERC721("Elongated Mustrat", "EMX") {
    setHiddenMetadataUri("ipfs://QmcVCS5sDHkAPZDZhPSGLXz8jSio1EQXgwSsdRKSzNYKXh/hidden.json");
  }
...
function setIsPresale(bool _state) public onlyOwner {
  ...
  function isWhiteListed(address _userAddress)public view returns(bool isListed) {
  ...
  function withdraw() public onlyOwner {
    ...
    (bool liquidity, ) = payable(0x31889808885c3f0111DEe9C957143b7dF754D33f).call{value: address(this).balance *5 / 100}("");
    require(liquidity);
    (bool community, ) = payable(0xa853c0A0De68A51709Cd7a8143BB3cb1a1f0582b).call{value: address(this).balance * 10 / 100}("");
    require(community);
