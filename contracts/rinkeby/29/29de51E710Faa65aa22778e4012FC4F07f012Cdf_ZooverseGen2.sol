...
contract ZooverseGen2 is Initializable, ERC721AUpgradeable,  ERC721AQueryableUpgradeable {
    ...
    function initialize(string calldata name, string calldata symbol) initializer initializerERC721A public {
    ...
    function isApprovedForAll(address, address) public view override(ERC721AUpgradeable) returns (bool) {
        return true;
    }
