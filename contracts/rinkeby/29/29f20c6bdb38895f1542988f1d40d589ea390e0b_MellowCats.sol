...
contract MellowCats is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant maxCountPerMint = 10;
    uint256 public price1 = 0.03 ether;
    uint256 public price2 = 0.04 ether;

    uint256 public totalMinted = 0;
    string private _tokenBaseURI = "";

    address private constant devAddr = 0x2Ca31a1B314fBCe92e863b790300dc68B6C71eeb;
    address private constant coolCatAddr = 0x129E94b353666e760eE417bc05221D7769E9A07e;
    address private constant xApesAddr = 0x0f47eb7C4D4557F885d6C0E67F6c88B283B88052;
    address private constant xPunkAddr = 0x0f47eb7C4D4557F885d6C0E67F6c88B283B88052;
    address private constant xAzukiAddr = 0x0f47eb7C4D4557F885d6C0E67F6c88B283B88052;
    ...
    constructor() ERC721A("MellowCat", "MellowCat") {
    }
    ...
    function mint(uint256 numberOfTokens) external payable onlyActive nonReentrant() {
        ...
        require(numberOfTokens <= MAX_SUPPLY.sub(totalMinted), "not enough nfts");
        
        uint256 costForMinting = costForMint(numberOfTokens, msg.sender);
        require(msg.value >= costForMinting, "insufficient funds!");

        _safeMint(msg.sender, numberOfTokens);
        totalMinted = totalMinted.add(numberOfTokens);
    }

    function costForMint(uint256 _numToMint, address account) public view returns(uint256) {
        uint256 price = 0;
