...
import "@xillion/token/contracts/XIL_BSC.sol";

/**
 * @title Test XIL_BSC token
 * @dev This contract is purely for testing purposes. The real token will be deployed.
 */
contract XillionTokenBSC is XIL_BSC {}
