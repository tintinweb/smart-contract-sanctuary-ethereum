...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/antiWhalingContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AntiWhalingContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Anti-Whaling", "AWHALE", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://whale.com/tokens/";
        }

        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/LW5mE7w5QRdJynOBKfK0/contract-metadata";
        }
    }