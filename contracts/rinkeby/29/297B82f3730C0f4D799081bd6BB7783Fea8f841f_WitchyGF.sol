...
contract WitchyGF is ERC721A, AccessControl {
    ...
    IERC721 DEEBIES_CONTRACT; // = IERC721(0x1a5264e5b317729D6e12B6b22A16Fa1af21fcFcF);


    uint256 public constant MAX_SUPPLY = 6789;
    uint256 public constant MINT_PRICE = 0.000678 ether;
    ...
    constructor(string memory name, string memory symbol, string memory baseURI_, address ownerAddress_, address devAddress_, IERC721 deebiesAddress) ERC721A(name, symbol) {
        ...
        DEEBIES_CONTRACT = deebiesAddress;

        saleState.price = 0.000678 ether;
    }
    ...
    function vipMint(address[] calldata to) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(to.length + _totalMinted() < MAX_SUPPLY, "Mint count exceeds max supply");
        ...
        returns (uint256, uint256)
    {
        ...
        require(used < mintablePresale, "Exceeds alowed mints");
    ...
    function withdrawAll() public payable onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        uint256 dev_balance = balance - ((balance / 100) * 88);
