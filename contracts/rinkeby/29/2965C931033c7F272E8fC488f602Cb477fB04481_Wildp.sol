...
contract Wildp is ERC721, Ownable, ReentrancyGuard, ERC721Enumerable {
    ...
    function airdropTeam(uint256 tokenID, address address_to) 
        external 
        nonReentrant
        onlyOwner
    ...
    function mintOne(uint256 tokenID) 
        external 
        payable
        nonReentrant
        callerIsUser
