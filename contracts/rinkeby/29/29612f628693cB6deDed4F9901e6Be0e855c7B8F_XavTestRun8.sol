...
// File: contracts/xavtestrun7.sol
...
contract XavTestRun8 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("XTR8", "XTR") {
    setHiddenMetadataUri("ipfs://QmSfoCuSp49RxqgcxqbPFCcWRCoEypfbSxDJmLBRMjC17C/hidden.json");
  }
