...
contract DungeonsAndDragonsCharacter is ERC721PresetMinterPauserAutoId, VRFConsumerBaseV2 {
    ...
    function requestNewRandomCharacter(
        ...
        requestToCharacterName[s_requestId] = name;
    ...
    internal override
    {
        ...
        characters.push(
            Character(
                ...
                charisma,
                experience,
                requestToCharacterName[s_requestId]
            )
        );
        _safeMint(requestToSender[s_requestId], newId);

        emit FulfillRandomness(s_requestId,randomWords);
    }
