...
contract Username3 is ERC721ABurnable, Ownable, ReentrancyGuard {
  ...
  mapping (string => UsernameData) public usernamesData;



  constructor() ERC721A("U3", "U3") {

  }


  function mint(string memory username) public {
    UsernameData storage data = usernamesData[username]; 
    data.tokenId = 0;
    data.data["test"] = "https://test";
