...
contract LotteryDrop is Ownable {
    ...
    // IERC20 internal usdc = IERC20(0x55d398326f99059fF775485246999027B3197955); //usdt address on BNB main net
    ...
    function buyTicket(uint256 _amount) public isState(LotteryState.Open) {
        ...
        require(allowance >= _amount*10**usdc.decimals()*110/100, "Check the token allowance"); //allowance should include 10% fee
        usdc.transferFrom(_buyer, address(this), _amount*10**usdc.decimals()); //pay to LD contract
        usdc.transferFrom(_buyer, owner(), _amount*10**usdc.decimals()*10/100); //owner's cut
