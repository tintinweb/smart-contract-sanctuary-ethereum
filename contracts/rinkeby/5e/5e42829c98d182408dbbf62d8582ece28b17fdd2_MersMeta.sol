...
contract MersMeta is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, PaymentSplitterUpgradeable, IMersMeta {
    ...
    {
        require(mintPrice[id] != 0 , "MersMeta: Can't mint token as token ID is not active yet!!");
    ...
    {
        require(mintPrice[id] != 0 , "MersMeta: Can't airdrop token as token ID is not active yet!!");
    ...
    {
        require(account != address(0), "MersMeta: transfer to the zero address");
