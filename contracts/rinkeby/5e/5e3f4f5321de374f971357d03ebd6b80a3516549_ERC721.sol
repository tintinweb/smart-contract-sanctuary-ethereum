...
contract ERC721 is IERC721, ERC721Metadata {
    ...
    uint currindex = 1;
    string public override name = "ticket";
    string public override symbol = "ticket";
    ...
    function setnotReveralBaseURI(string calldata _setnotReveralBaseURI) external {
        notRevealedURI = _setnotReveralBaseURI;
    }
    ...
    function mint() external {
        ...
        _owners[currindex] = msg.sender;
       
        emit Transfer(address(0), msg.sender, currindex);
        currindex++;
    }
