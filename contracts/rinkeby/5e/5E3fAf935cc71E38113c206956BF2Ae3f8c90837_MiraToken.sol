...
contract MiraToken is ERC1155 {
    uint256 public constant PEACHES_CREAM = 1;
    uint256 public constant EARL_GREY = 2;
    uint256 public constant LEMON_CAKE = 3;
    uint256 public constant STRAWBERRIES_CHOCOLATE = 4;
    uint256 public constant LEMON_CREAM = 5;

    constructor() ERC1155("https://ipfs.io/ipfs/bafybeie5h3xdwah2rp44k7divno6o2byhqmqtq2iyujs4lk5lsmmv6gxfe/{id}.json") {
        _mint(msg.sender, PEACHES_CREAM, 1, "");
        _mint(msg.sender, EARL_GREY, 1, "");
        _mint(msg.sender, LEMON_CAKE, 1, "");
        _mint(msg.sender, STRAWBERRIES_CHOCOLATE, 1, "");
        _mint(msg.sender, LEMON_CREAM, 1, "");
    }
}
