...
contract MiauCatsClub is ERC721, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x00fA5C38f2c78092ab7d9b74cC075a38125FC11F).call{value: address(this).balance * 25 / 100}("");
    require(hs);
    // =============================================================================
