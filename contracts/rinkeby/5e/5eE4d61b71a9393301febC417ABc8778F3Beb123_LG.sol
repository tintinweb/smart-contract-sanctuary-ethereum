...
contract LG is ERC1155Votes, AccessControl, AllocationControl, EmissionCurves, IAllocationMinter {
        ...
        EmissionCurves(governor)
    {
        ...
        _allocationAllocate(        INVESTOR_ALLOCATION, 0,  31_500_000 * 1e18);
        ...
        _allocationAllocate(DAO_FOUNDATION_Y_ALLOCATION, 1,     350_000 * 1e18); // 35% vote

        // Blockchain Launch

        _allocationAllocate(       LAUNCH_C4_ALLOCATION, 0,  20_700_000 * 1e18); // LP Rewards
