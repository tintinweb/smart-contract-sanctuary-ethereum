...
contract ERC721AFacet is ERC721A {
    ...
    function setSymbol(string calldata _symbol) public onlyOwner {
        s.symbol = _symbol;
    }

    function setTokenURI(string calldata tokenURI) public onlyOwner {
...
import {Modifiers} from "../libraries/Modifiers.sol";
import {LibDiamond} from "../libraries/LibDiamond.sol";
import {AppStorage, TokenApprovalRef, Edition} from "../libraries/LibAppStorage.sol";
