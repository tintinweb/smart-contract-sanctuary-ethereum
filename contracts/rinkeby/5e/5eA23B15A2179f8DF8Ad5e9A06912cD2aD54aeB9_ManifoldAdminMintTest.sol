...
contract ManifoldAdminMintTest {

    address private _core = 0x3a5a55Af177d117C1C47c4580Cdd8a6fAD6f4cb6;
    ...
    function mint(uint tokenId) public {
      ...
      IERC1155CreatorCore(_core).mintBaseExisting(to, tokenIds, amounts);
    }
}
