...
contract Sy5t3m5 is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "";
  uint256  public  MAX_SUPPLY = 1070;
  uint256 public  MAX_MINTS_PER_TX = 20;
  uint256 public  price = 0.005 ether;
  uint256 public  NUM_FREE_MINTS = 535;
  ...
  function setMAX_SUPPLY(uint256 _MAX_SUPPLY)
      external
      onlyOwner
  {
