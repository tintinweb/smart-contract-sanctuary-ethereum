...
contract CryptoVault is Context, IERC20, Ownable {
 ...
 uint256 public reflectFeeSell = 4;
  ...
  address private _marketingWalletAddress = 0x3c65AbcAead8e187adc522f15b30ECF97dd7a4A1; //Affixed and created dynamically by the smart contract on construction time.
  ...
  constructor() {
      address _newOwner = 0x134Aa20ABC5CA90dbBc1680228f5a45595EEef36;
