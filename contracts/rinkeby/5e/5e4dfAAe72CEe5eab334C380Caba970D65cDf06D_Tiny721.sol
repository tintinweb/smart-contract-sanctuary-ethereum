...
contract OnChainMeta {
    ...
    function _buildName(uint256 _tokenId) internal view returns (string memory) {
      ...
      return string(abi.encodePacked("GLASS #", id.toString()));
    }
...
library NFTSVG {
  ...
  function _generateSVGPaths(SVGParams memory params) private view returns (string memory svgPaths) {
    ...
    string memory pathB = _genPath(40, 540, 290, 290, params.tokenId+1, params.owner);
    string memory pathC = _genPath(290, 290, 580, 290, params.tokenId+2, params.owner);
