...
contract WhiteSandsParcelPass is ERC721, DeveloperAccessControl, Pausable, ReentrancyGuard {
  ...
  address constant PAYOUT_ADDRESS = address(0xAdC530A7eC7541ECB936aea46B66769365777c10);
  ...
  uint128 constant DEFAULT_PRICE = 0.01 ether;
  ...
  function getPresaleAddr() external returns (IPresaleAccessControlHandler){
    return state.acl; 
  }
