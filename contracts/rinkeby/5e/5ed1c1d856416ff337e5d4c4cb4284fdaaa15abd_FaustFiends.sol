...
contract FaustFiends is ERC721, Ownable {
  ...
  modifier whitelistMintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerWhitelistTx, "Invalid mint amount!");
  ...
  function mint(uint256 _mintAmount) public payable publicMintCompliance(_mintAmount) {
  ...
  function mintExistingHolders() public onlyOwner {
