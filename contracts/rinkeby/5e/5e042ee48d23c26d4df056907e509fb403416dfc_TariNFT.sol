 ...
 */
abstract contract ERC1155Supply is ERC1155,IERC2981 {
    ...
    string private _symbol = "TEST1155";
...
contract TariNFT is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply{
    ...
    function mint(address creator, string memory uri, uint256 supply, uint96 fee)  public returns(uint256, bool){
        require(msg.sender == Operator,"ERC1155: caller doesn't have operator Role");
        require(!isDuplicate(uri), "Minting: Duplicate Minting");
        usedURIs[uri] = true;
        ...
        override(ERC1155, ERC1155Supply)
    {
     ...
     function isDuplicate(string memory uri) internal view returns(bool){
        return usedURIs[uri];
    }
