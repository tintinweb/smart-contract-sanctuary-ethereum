    ...
    Ownable
{
    ...
    uint256 public reservePriceUSD = 50000;
        ...
        nonReentrant
    {
        ...
        require(
            uint256(msg.value) >= auction.reservePrice,
    ...
    function _createAuction() internal {
        try IR3C.auctionMint() returns (uint256 r3CurveID) {
            ...
            uint256 reservePrice = reservePriceUSD / getLatestPrice();
    ...
    function _settleAuction() internal {
        ...
        if (uint256(auction.amount) < auction.reservePrice) {
        ...
        if (_auction.amount > 0) {
            _safeTransferETHWithFallback(r3cursiveDAO, _auction.amount);
        }
...
/// @title Interface for r3cursive Auction Houses

pragma solidity >=0.8.2 <0.9.0;

interface IR3CursiveAuctionHouse {
    struct Auction {
        // ID for the r3curve (ERC721 token ID)
        uint256 r3CurveID;
        ...
        uint256 endTime;
        // The reservePrice for the current auction,
    ...
    event AuctionExtended(uint256 indexed r3CurveID, uint256 endTime);
    ...
    function createBid(uint256 r3CurveID) external payable;
...
contract ETHPriceGrabber {
    ...
    function getLatestPrice() internal view returns (uint256) {
        ...
        require(ethprice > 0, "Chainlink Oracle is malicious");
