...
contract AIContractTest4 is ERC721, Ownable, ReentrancyGuard {
    ...
    // metadata
    string public baseURI = "ipfs://bafybeicap2xjuhyvjoribhsonf34rskfuikocqd2virqxkovqi4vl3rdza";

    // config
    mapping(address => uint256) public mintsPerWallet;
    address private withdrawAddress = address(0);

    constructor() ERC721("aicontracttest4", "TEST4") {}
