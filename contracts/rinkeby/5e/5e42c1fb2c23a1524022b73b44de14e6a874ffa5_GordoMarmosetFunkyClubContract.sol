...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3bd32324df56A585D05Ed9f3955379b745203DF3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qma3CphvFJJF5pqp5MxTHkRnQBgNtcNfM6DN9zGLkEafL3/";
...
// File: contracts/GordoMarmosetFunkyClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GordoMarmosetFunkyClubContract is RamppERC721A {
    constructor() RamppERC721A("Gordo Marmoset Funky Club", "GMFC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qcgK1jKQrdAtLfVhcgC2/contract-metadata";
    }
}
