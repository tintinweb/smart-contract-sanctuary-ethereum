...
contract NFTStaking {
    ...
    function getStakingStartTime(uint256 _tokenId) external view returns(uint48) {
        Staking memory thisStake = NFTsStaked[_tokenId];
        uint48 stakingStartTime = thisStake.stakingStartTime;
