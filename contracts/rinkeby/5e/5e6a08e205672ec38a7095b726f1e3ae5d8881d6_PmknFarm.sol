...
contract PmknFarm {
    ...
    string public name = "PmknTokenFarm";
    ...
    function stake(uint256 amount) public {
        require(
            ...
            "You cant stake 0 amount"
        );
        // why this if block.
        if (isStaking[msg.sender] == true) {
            uint256 toTransfer = calculateYieldTotal(msg.sender);
            // pmkn just for rewrds
            pmknBalance[msg.sender] += toTransfer;
        }
        //address(this) refers to the address of the instance of the contract
