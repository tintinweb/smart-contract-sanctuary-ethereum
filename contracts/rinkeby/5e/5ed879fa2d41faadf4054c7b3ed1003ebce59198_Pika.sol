...
// The contract is used for both Pika and EsPika.
// Pika is a transferable token, and EsPika is a non-transferable token which can be linearly vested to PIKA token via vesting contract.
