...
contract myNFT is ERC721, ERC721URIStorage {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://bafybeif6iuokmmcuwj7jgscybx3gvlcwkb6ybspwcduivl7mbqmgmmxubi.ipfs.dweb/link/";
    }
    ...
    {
        return string(
                abi.encodePacked("https://bafybeif6iuokmmcuwj7jgscybx3gvlcwkb6ybspwcduivl7mbqmgmmxubi.ipfs.dweb/link/", Strings.toString(_tokenId), ".json")
            );
    }
