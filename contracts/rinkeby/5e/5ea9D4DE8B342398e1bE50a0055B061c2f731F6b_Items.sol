...
// File: contracts/new_item_collection721.sol
...
contract Items is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;
    uint256 public balanceUnit  = 0.00000000000000001 ether;
    uint256 public tokenPrice   = 0.00000000000000001 ether;
...
function openChest(uint256 _chestId,uint256 amount) public payable  returns(bool success)  {
    ...
    function buyToken(uint256 numberOfTokens) public payable returns(bool success) {
        ...
        tokenContract.transferFrom(tokenStorage,_msgSender(), numberOfTokens * balanceUnit);
    ...
    return true;
     ...
     function mintItem(address account, uint256 _chestId)
        public onlyOwner
    {
