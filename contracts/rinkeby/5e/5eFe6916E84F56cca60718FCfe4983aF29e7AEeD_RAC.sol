...
contract RAC is ERC721APausable, Ownable, ReentrancyGuard {
    ...
    bool public publicSaleOpen = false;
     ...
     address public creatorAddress = 0x6d221aC824a6D086cb379679796CC268d2bF8ffE;
    ...
    modifier underWalletMintLimit(uint256 quantity) {
        require(addressMintedBalance[msg.sender] + quantity <= nftPerAddressLimit);
        _;
    }
    ...
    function mintRAC(uint256 quantity) 
        public 
        payable 
        underMaxSupply(quantity)
    {
        if (msg.sender != owner()) {
            ...
            require(addressMintedBalance[msg.sender] + quantity <= nftPerAddressLimit);
            /*require(
                    msg.value >= RETRO_PRICE * quantity,
                    "insufficient funds"
                );*/
