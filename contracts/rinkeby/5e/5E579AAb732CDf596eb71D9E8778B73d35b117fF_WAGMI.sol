...
* @author Niftydude
*/
contract WAGMI is PvERC1155, PVAllowlist, PaymentSplitter  {

    uint256 constant MAX_SUPPLY = 20000;
    uint256 constant MINT_PRICE = 0.2 ether;
    uint256 constant MAX_PER_TX = 20;
    ...
    */
    function publicMint(uint256 amount) external payable {
        ...
        require(amount < MAX_PER_TX, "max amount exceeded");
        require(msg.value == amount * MINT_PRICE, "Purchase: Incorrect payment"); 
    ...
    */
    ...
    function ownerMint(address _receiver, uint256 _amount) external onlyOwner {
        require(totalSupply(0) + _amount <= MAX_SUPPLY, "Purchase: Max supply reached");

        _mint(_receiver, 0, _amount, "");        
    }     
