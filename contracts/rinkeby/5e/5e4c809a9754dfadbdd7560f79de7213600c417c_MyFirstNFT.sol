...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmR1SCmveKYbjS4HaWctcEhxSiMMaQpd4pgNJ6FnHMQdfK/"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("mcu_0841", "Test1") payable {
        // 剛開始我們先自己 Mint 一個
