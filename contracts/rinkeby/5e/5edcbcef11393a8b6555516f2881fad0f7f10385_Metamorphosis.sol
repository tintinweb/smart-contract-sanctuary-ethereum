...
contract Metamorphosis is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://Qmf1pXpxskD59Z7Bj8DGpr2Hmo4AmTqTAmrD8XK2DF4pS4/hidden.json";
  string  public  MorphTime = "6 hours is all it takes to realise your true form!";
