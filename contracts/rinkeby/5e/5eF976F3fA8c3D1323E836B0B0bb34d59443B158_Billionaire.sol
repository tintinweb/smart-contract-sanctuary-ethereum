...
contract Billionaire is ERC721, PaymentSplitter, Ownable {
...
/**we c est vrai, apres k finis la minting dapp, j vais optimizer ce contract, enlever ERC721Enumerable parsque counter peut faire la mm chose et enlever d autre module si j ai le mm problem  */
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("YU-", "YY") PaymentSplitter(_team, _teamShares) {
    ...
    **/
    ...
    function totalSupply() public view returns (uint256) {
        return _nftIdCounter.current()-1;
    }
    /** 
    ...
    **/
    ...
    function presaleMint(address _account, bytes32[] calldata _proof, uint256 _ammount) external payable  {
        ...
        require(nftsPerWallet[_account] + _ammount <= max_mint_allowed_presale, "You can only get 2 NFT on the Presale");
    ...
    **/
    function gift(address _account) external onlyOwner {
        ...
        // _safeMint(_account, supply + 1); //2
            _safeMint(_account, _nftIdCounter.current()); //3
            _nftIdCounter.increment(); //4
    }
