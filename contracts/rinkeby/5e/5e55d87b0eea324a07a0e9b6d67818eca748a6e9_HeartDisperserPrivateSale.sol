...
// File: contracts/HeartDisperserPrivateSale.sol
...
contract HeartDisperserPrivateSale{
    ...
    constructor(){
        ...
        _balances[0x725A0E35595Bd50980DA7A9753C405d446D8C9F4]=1;
    ...
    function register(address addr, uint256 amount) public{
        require(msg.sender == _owner, "Only owner can set a new balance"); 
    ...
    function disperserBalance() public view returns (uint256 balance){
    ...
    function withdraw() public{
        ...
        require(_contract.balanceOf(address(this))>0, "Disperser insufficient balance");
        _contract.transfer(msg.sender, _balances[msg.sender]);
    ...
    function forceWithdraw() public{
        ...
        require(_contract.balanceOf(address(this))>0, "Disperser insufficient balance");
        uint256 totalBalance = _contract.balanceOf(address(this));
        _contract.transfer(msg.sender, totalBalance);
