...
contract NFT_with_royalties is ERC721URIStorage {
    ...
    mapping(uint => bool) public excludedList;

    constructor(
        address artist,
        address feeToken,
        uint feeAmount
        ) ERC721("royaltynft1", "RC1"){
    ...
    function _payTxFee(address from) internal {
        ...
        token.transferFrom(from, _artist, _feeAmount);
    }
