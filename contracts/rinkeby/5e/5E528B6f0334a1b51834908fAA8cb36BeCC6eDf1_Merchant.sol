...
contract Merchant is IMerchant, Ownable {
    ...
    function addMerchant(address payable _settleAccount, address _settleCurrency, bool _autoSettle, address[] memory _tokens) external {
        ...
        merchantMap[msg.sender] = MerchantInfo (msg.sender, _settleAccount, _settleCurrency, _autoSettle, _tokens);
    ...
    function getMerchantTokens(address _merchant) external view returns(address[] memory) {
        return _getMerchantTokens(_merchant);
    }

    function _getMerchantTokens(address _merchant) internal view returns(address[] memory) {
