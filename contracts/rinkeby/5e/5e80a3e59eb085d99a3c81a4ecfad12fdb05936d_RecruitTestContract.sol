...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xed443b1EC80208712899658eBF5485DcbF1E95dd];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVTHKo9WsDnZMP2q4HYCcqSoTj95iGnumNEC9HjjEKn8D/";
...
// File: contracts/RecruitTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RecruitTestContract is RamppERC721A {
    constructor() RamppERC721A("Recruit Test", "RT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/eLM4jtlgAtY5oWrEDf1i/contract-metadata";
    }
}
