...
contract Ship is ERC721, Managable, ERC721Burnable, ERC721Enumerable {
    ...
    constructor(
        ...
        require(_tokenOffset <= 1000000, "too high TO");        
    ...
    function tokensOfOwner(address owner) public view returns (uint256[] memory) {
        ...
        uint256[] memory ships = new uint256[](balance);

        for(uint256 i = 0; i < balance; i++) {
            uint256 ship = tokenOfOwnerByIndex(owner, i);
            ships[i] = ship;
        }
