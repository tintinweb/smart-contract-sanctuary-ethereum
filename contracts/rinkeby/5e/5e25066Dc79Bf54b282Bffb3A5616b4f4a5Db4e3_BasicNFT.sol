...
contract BasicNFT is ERC721, Ownable {
    ...
    int256 private startValue = 1500;
    uint8 private dayCounter = 0;
    uint256 private s_tokenCounter = 0;
    uint256 public lastTimestamp = block.timestamp;
    int256[3] public valuesToAverage = [startValue, startValue, startValue];
        ...
        returns (string memory)
    {
        ...
        int256 average = (valuesToAverage[0] +
            valuesToAverage[1] +
            valuesToAverage[2]) / 3;
        if (ethPriceUSD >= average) {
    ...
    function performUpkeep() public {
        ...
        require((block.timestamp - lastTimestamp) > 60 seconds);
        (, int256 price, , , ) = i_priceFeed.latestRoundData();
        int256 ethPriceUSD = price / 100000000;
        valuesToAverage[dayCounter] = ethPriceUSD;
        dayCounter++;
        if (dayCounter > 2) {
            dayCounter = 0;
        }
    ...
    function getDayCounter() public view returns (uint8) {
        return dayCounter;
    }
