    ...
    PausableModifiers
{
    ...
    function releaseAll() public onlyOwner whenNotPaused {
        PaymentSplitterLib.releaseAll();
    }

    function releaseAllToken(IERC20 token) public onlyOwner whenNotPaused {
        PaymentSplitterLib.releaseAllToken(token);
    }
}
