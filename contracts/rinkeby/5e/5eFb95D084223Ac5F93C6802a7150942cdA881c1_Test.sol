...
contract Test is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public cost1 = 0 ether; //Airdrop
  uint256 public cost2 = 0.004 ether; //Whiteliste
  uint256 public cost3 = 0.004 ether; //Pre-sale
  uint256 public supplyLimitPhase1 = 1000;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 10000;  //change it to your total NFT supply
  ...
  uint256 public maxMintAmountPerTxPhase3 = 1;
