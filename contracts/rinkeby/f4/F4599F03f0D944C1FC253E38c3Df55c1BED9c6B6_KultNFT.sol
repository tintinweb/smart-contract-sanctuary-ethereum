...
contract KultNFT is ERC721A, Ownable {
    string public baseURI = "ipfs://QmPa22qMjWbP5An429gQ8B153gh9U26WjTRJE6xC72fzHi?";
    bool public saleStatus = true;

    // Price and supply definition
    uint256 constant public PRICE_PRESALE = 0.7 ether;
    uint256 constant public PRICE_PUBLICSALE = 0.88 ether;
    uint256 constant public TOKEN_MAX_SUPPLY = 8888;
    uint256 constant public TOKEN_PRESALE_SUPPLY = 1000;
    ...
    constructor () ERC721A("KULT Social Society", "KULT") {
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= 20, "Max quantity is 20.");

        uint256 tokenPrice = PRICE_PUBLICSALE;
        if (isPresale) {
            tokenPrice = PRICE_PRESALE;
            require(totalSupply() + quantity <= TOKEN_PRESALE_SUPPLY, "No more presale");
        }
    ...
    function airdrop(address account, uint256 quantity) external onlyOwner {
