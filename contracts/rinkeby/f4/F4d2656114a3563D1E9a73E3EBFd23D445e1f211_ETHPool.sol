...
// Ekonomia challenge of a pool contract 
pragma solidity ^0.8.7;
import "hardhat/console.sol";
import "@openzeppelin/contracts/access/AccessControl.sol"; //https://docs.openzeppelin.com/contracts/3.x/api/access#AccessControl
    ...
    contract ETHPool is AccessControl {
        ...
        uint256 public total; //I'm not using balance to prevent attacks -> https://swcregistry.io/docs/SWC-132
        ...
        function depositRewards() public payable onlyRole(TEAM_MEMBER) {
            require(total > 0); // I'll not distribute any rewards if the pool is empty.
