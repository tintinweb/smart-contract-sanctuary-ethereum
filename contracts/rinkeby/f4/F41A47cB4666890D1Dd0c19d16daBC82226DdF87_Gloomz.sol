...
contract Gloomz  is ERC721A , Ownable{
  ...
  uint256 public constant MAX_PER_TX_PUBLIC = 30;
  uint256 public constant SUPPLY_CAP = 100;
  uint256 public constant AMOUNT_FREE_MINTS = 50;
  ...
  function mintGloom(uint256 amount) external payable  {
    ...
    uint256 supplyCAp = SUPPLY_CAP+amount-reserve;
    require(ts<=supplyCAp);
