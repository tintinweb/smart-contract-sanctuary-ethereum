...
library Traits {
    ...
    function getTokenURI(Inventory.FallenInventory memory _inventory, uint256 soulScore, uint256 tokenId) external pure returns (string memory) {
        ...
        parts[2] = '<line x1="5" y1="32" x2="345" y2="32" stroke="#3f3f46" stroke-width="2"/><line x1="85" y1="5" x2="85" y2="345" stroke="#3f3f46" stroke-width="2"/><line x1="275" y1="5" x2="275" y2="345" stroke="#3f3f46" stroke-width="2"/><line x1="5" y1="318" x2="345" y2="318" stroke="#3f3f46" stroke-width="2"/>';
        
        parts[3] = '<text x="10" y="22" class="e1">Class</text>';
