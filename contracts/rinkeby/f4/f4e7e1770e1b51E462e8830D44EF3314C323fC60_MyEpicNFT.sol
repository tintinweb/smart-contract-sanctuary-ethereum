...
contract MyEpicNFT is ERC721URIStorage{
    ...
    function makeNFT() public {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combinedWord,
                        '", "description": "Random aot wild names nft", "image": "data:image/svg+xml;base64,',
        ...
        emit NewEpicNFTMinted(address(msg.sender), uint256(newItemId));
    }
