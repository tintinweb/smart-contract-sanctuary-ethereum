...
contract PiggyERC20 {
	...
	function allowed(address owner, address spender) public view returns (uint256 remaining) {
		return allowance[owner][spender]; //允许spender从owner中转出的token数
	}

	function balance() public view returns(uint balanceRemained) {
