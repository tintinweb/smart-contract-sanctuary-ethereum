...
contract MyFirstNFTs is ERC721Enumerable, Ownable {
    using SafeMath for uint;
    
    string baseURI;
    string public contractURI;
    
    uint public constant MAX_NFTS = 30;
    uint public constant MAX_SALE = 20;
    uint public constant MAX_PRESALE = 0;
    ...
    constructor(string memory baseURI_, string memory contractURI_) ERC721("My First NFT", "MFN") {
        price = 0.001 ether;
        saleAddress = 0xce5b8Df3Ee1cfB0484726B4E28c2Feb6d5FcFc71;
        devAddress = 0xce5b8Df3Ee1cfB0484726B4E28c2Feb6d5FcFc71;
        baseURI = baseURI_;
    ...
    function mint(uint _quantity) external payable  {
        ...
        require(totalSupply().add(_quantity) <= MAX_NFTS, "Sold out.");
    ...
    function withdrawAll() external onlyOwner {
        ...
        require(totalBalance > 0, "ETH balance is 0");
