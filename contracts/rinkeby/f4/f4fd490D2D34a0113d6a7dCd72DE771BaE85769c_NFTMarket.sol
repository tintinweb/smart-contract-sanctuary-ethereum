...
contract NFTMarket {
     ...
     * @param tokenId - ID of the published NFT
     */
    function executeListing(address contractAddress, uint256 tokenId)
        external
        payable
    {
        require(contractAddress.isContract(), "INVALID_NFT_CONTRACT_ADDRESS");
        ...
        require(listing.seller != address(0), "INVALID_SELLER");
        require(listing.seller != sender, "SENDER_IS_SELLER");
