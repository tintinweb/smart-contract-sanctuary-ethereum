...
contract VZOOFactory is FactoryERC721, ReusableFactory, Ownable {
    ...
    constructor() {
        ...
        nftAddress = 0xDC0EcCcf167781B786Cf06DE0c9463407893f5A2;
    ...
    function reclaimCollection() public onlyOwner {
        ...
        require(vzoo.supportsReclaimableCollectionInterface(), "collection must support reclaimable collection interface");
    ...
    function setNFTAddress(address _newNFTAddress)
        external
        onlyOwner
    {
