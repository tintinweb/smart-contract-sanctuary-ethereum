...
contract InvisibleBones is ERC721A, Ownable {
    ...
    uint256 public constant FREE_MINT_SUPPLY = 1;
    ...
    function ibMint(uint32 amount) external payable {
        ...
        if (totalMinted < FREE_MINT_SUPPLY) {
            require(userMinted + amount == 1, "InvisibleBones: you can only mint 1 for free");
        ...
        require(userMinted + amount <= WALLET_LIMIT, "InvisibleBones: exceed wallet limit");
