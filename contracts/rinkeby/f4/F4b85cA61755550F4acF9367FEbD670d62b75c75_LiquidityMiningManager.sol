...
contract LiquidityMiningManager is ReentrancyGuard, TokenSaver {
    ...
    IERC20 public immutable reward; // address of the token used for rewards
    ...
    uint256 public immutable totalRewards; // Maximum amount rewards assigned to be distributed to all the pools
    ...
    // Allows the admin to distribute a percent of the total rewards to all the pools
    // _percent: percentage of the totalRewards to be distributed
