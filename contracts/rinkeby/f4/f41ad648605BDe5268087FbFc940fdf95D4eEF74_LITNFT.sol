...
contract LITNFT is ERC721A, RoyaltiesV2Impl, Ownable, ReentrancyGuard {
    using Strings for uint256;

    mapping(address => uint256) shares;

    string baseURI = "https://api.litnfts.io/api/nft/";
    ...
    function withdrawlBalance() external onlyOwner nonReentrant {
