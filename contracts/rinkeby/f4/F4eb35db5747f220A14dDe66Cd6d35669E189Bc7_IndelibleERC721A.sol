// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Face", unicode"Eyes", unicode"Skin", unicode"Background"];
        ...
        constructor() ERC721A(unicode"FirstTest", unicode"FTC") {
            TIERS[0] = [6,12,15,16,19,22,28,34,35,35,49,54,81,91,118,385];
TIERS[1] = [8,36,83,97,181,255,340];
TIERS[2] = [23,191,786];
TIERS[3] = [7,30,42,59,69,80,81,106,134,188,204];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(
                abi.encodePacked(
                    _toString(_tokenId),
                    unicode"\",\"description\":\"First test collection in indelibles\","
                )
            );
