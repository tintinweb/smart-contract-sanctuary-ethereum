...
contract Ghostcolor is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_SUPPLY = 5800;
    uint private constant MAX_GIFT = 100;
    uint private constant MAX_WHITELIST = 5800;
    uint private constant MAX_PUBLIC = 5800;
    ...
    uint public saleStartTime = 1660947364; //2022-08-20 - 00.17 am
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof,string memory _baseURIgreen, string memory _baseURIblue, string memory _baseURIred) external  callerIsUser{
    ...
    * @param _baseURIgreen 
    **/
    function publicMint(address _account, uint _quantity, string memory _baseURIgreen, string memory _baseURIblue, string memory _baseURIred) external callerIsUser {
        require(!isPaused, "Contract is Paused");
