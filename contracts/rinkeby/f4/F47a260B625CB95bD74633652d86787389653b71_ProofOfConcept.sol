...
contract ProofOfConcept is ERC1155Supply, Ownable, Pausable, ReentrancyGuard {
    string public name;
    ...
    constructor(string memory _baseUri, bytes32 _freeMerkleRoot, bytes32 _allowlistMerkleRoot) ERC1155(_baseUri) {
        ...
        phases[Phase.DEV] = PhaseConfig(1650186000, 21600); // 1650207600
        phases[Phase.FREE] = PhaseConfig(1650186000, 14400); // 1650200400
        phases[Phase.ALLOWLIST] = PhaseConfig(1650191400, 9000); // 1650200400
        phases[Phase.PUBLIC] = PhaseConfig(1650200400, 7200); // 1650207600
    }
