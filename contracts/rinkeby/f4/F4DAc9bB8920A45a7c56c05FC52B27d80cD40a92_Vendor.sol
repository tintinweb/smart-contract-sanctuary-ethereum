...
contract Vendor is Ownable{
  ...
  function withdraw() public {
    ...
    require(success,"Ether was not withdraw");
  }
  // ToDo: create a sellTokens() function:
  function sellTokens(uint amount) public {
    bool transferSuccess = yourToken.transferFrom(msg.sender, address(this), amount);
    require(transferSuccess, "Something went wrong");
    uint etherToPaid = amount / tokensPerEth;
    (bool success,) = msg.sender.call{value: etherToPaid}("");
    require(success, "Paid not executed");
    emit SellTokens(msg.sender,amount,etherToPaid);
  }
}
