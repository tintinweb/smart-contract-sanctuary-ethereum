...
feeMap[feeType]=FeesCollectors({
    ...
    function claimHexmarket() public isOwner {
uint totalAmount=(feeMap[COLLECTORTYPES.HEXMARKET].amount);
   ...
   claimHedronFlow();
       ...
       function claimBonus() public isOwner {
  ...
  function claimBuyBurn() public isOwner {
    ...
    function claimBuyDistribute() public isOwner {
