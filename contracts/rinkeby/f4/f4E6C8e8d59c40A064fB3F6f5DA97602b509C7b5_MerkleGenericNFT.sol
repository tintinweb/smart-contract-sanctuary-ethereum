...
/*
  ...
  /$$$$$$  /$$$$$$$$ /$$   /$$ /$$$$$$$$ /$$$$$$$  /$$$$$$  /$$$$$$        /$$   /$$ /$$$$$$$$ /$$$$$$$$
 /$$__  $$| $$_____/| $$$ | $$| $$_____/| $$__  $$|_  $$_/ /$$__  $$      | $$$ | $$| $$_____/|__  $$__/
| $$  \__/| $$      | $$$$| $$| $$      | $$  \ $$  | $$  | $$  \__/      | $$$$| $$| $$         | $$   
| $$ /$$$$| $$$$$   | $$ $$ $$| $$$$$   | $$$$$$$/  | $$  | $$            | $$ $$ $$| $$$$$      | $$   
| $$|_  $$| $$__/   | $$  $$$$| $$__/   | $$__  $$  | $$  | $$            | $$  $$$$| $$__/      | $$   
| $$  \ $$| $$      | $$\  $$$| $$      | $$  \ $$  | $$  | $$    $$      | $$\  $$$| $$         | $$   
|  $$$$$$/| $$$$$$$$| $$ \  $$| $$$$$$$$| $$  | $$ /$$$$$$|  $$$$$$/      | $$ \  $$| $$         | $$   
 \______/ |________/|__/  \__/|________/|__/  |__/|______/ \______/       |__/  \__/|__/         |__/ 
...
contract MerkleGenericNFT is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    constructor(address[] memory distro, uint[] memory distro_shares, address[] memory nftreserve)
        ERC721("Generic NFT", "GenNFT")
        PaymentSplitter(distro, distro_shares)
    {
        METADATAURI = "ipfs://IPFSURL/";

        accounts[msg.sender] = Account( 0, 0, true);

        // ReservedNFTs
        accounts[nftreserve[0]] = Account( 5, 0, true); //
        accounts[nftreserve[1]] = Account( 10, 0, true); //
        accounts[nftreserve[2]] = Account( 15, 0, true); //
    ...
    function setMaxSupply(uint _maxSupply) external onlyOwner {
        require(_maxSupply <= maxSupply, 'Error: New max supply cannot exceed initial maxSupply.');
    ...
    function mint(uint _amount) external payable noReentrant {
        ...
        require(_isSaleLive, 'Error: Sale is not active.');
        ...
        require(msg.value >= (mintPrice * _amount), 'Error: Ether value sent is not correct');
    ...
    // Merkle tree:
    function whitelistMint(bytes32[] calldata _merkleProof, uint _amount) external payable noReentrant {
        require(_isPresaleLive, 'Error: Whitelist Sale is not active.');
        require(totalSupply() + _amount <= (maxSupply - _reserved), 'Error: Purchase would exceed max supply.');
        require((_amount + accounts[msg.sender].mintedNFTs) <= walletLimit, 'Error: You would exceed the wallet limit.');
        require(!isContract(msg.sender), 'Error: Contracts cannot mint.');
        require(msg.value >= (mintPrice * _amount), 'Error: Not enough ether sent.');
        require(!whitelistClaimed[msg.sender], 'Error: You have already claimed all of your NFTs.');

        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, whitelistMerkleRoot, leaf), 'Error: You are not whitelisted.');
