...
contract Billionaire is ERC721A, PaymentSplitter, Ownable {
    ...
    uint public max_mint_allowed_public =  3;
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721A("CHhwa", "CHA") PaymentSplitter(_team, _teamShares) {
    ...
    function presaleMint(address _account, bytes32[] calldata _proof, uint256 _ammount) external payable  {
        ...
        require(nftsPerWallet[_account] + _ammount <= max_mint_allowed_presale, "You can only get 4 NFT on the Presale");
    ...
    function saleMint(uint256 _ammount) external payable  {
        ...
        require(nftsPerWalletSale[msg.sender] + _ammount <= max_mint_allowed_public, "You can only get 2 NFT on the Sale");
    ...
    //         _safeMint(_receiver, _nftIdCounter.current());
    //         _nftIdCounter.increment();
