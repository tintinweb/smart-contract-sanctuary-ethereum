...
contract DourDarcels is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint public constant MAX_SUPPLY = 4888;
    uint public constant RESERVE_SUPPLY = 0;
    uint public constant MAX_ALLOWLIST_MINT = 2;
    uint public constant MAX_PUBLIC_MINT = 2;
    uint public constant PRICE_PER_TOKEN = 0.048 ether;

    mapping(address => uint) private _allowListNumMinted;

    constructor() ERC721("Dour", "Darcels") {
    }
