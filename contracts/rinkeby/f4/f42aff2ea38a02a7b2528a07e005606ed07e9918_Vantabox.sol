...
contract Vantabox is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(string memory baseURI, address _owner) ERC721A("Vantabox", "VANTABOX") {
    ...
    function mintVantabox(address _referrer) external payable {
        ...
        require(balanceOf(_referrer) > 0, "Invalid referrer");
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    mapping(uint256 => address) public referrer;
    ...
    function _safeMint(address to, uint256 quantity, address _referrer) internal {
        _safeMint(to, quantity, _referrer, '');
    }
    ...
    function _safeMint(
        ...
        _mint(to, quantity, _referrer, _data, true);
    }
    ...
    function _mint(
        ...
        unchecked {
            ...
            referrer[startTokenId] = _referrer;
