...
// File: contracts/fakeapeyachtclub.sol
...
contract FakeApeYachtClub is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Read Functions Start =======================
  ...
  function price() public view returns (uint256 correctPrice){
         if (totalSupply() < 1000) {
             correctPrice = cost1;
          return correctPrice;
          }
