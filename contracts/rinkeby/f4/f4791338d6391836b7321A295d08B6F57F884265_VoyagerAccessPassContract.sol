...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc41CEDbb650595e4CbdAc25815C3C2f4075F1494];
...
// File: contracts/VoyagerAccessPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract VoyagerAccessPassContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Voyager Access Pass";
    string public symbol = "VCPASS";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SZCYE0PZJRCje3AiSViq/contract-metadata";
    }
