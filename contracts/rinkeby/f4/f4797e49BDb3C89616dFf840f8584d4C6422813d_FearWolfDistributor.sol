...
contract FearWolfDistributor is AccessControl, Pausable, Withdrawable, ReentrancyGuard {
    ...
    */
    event DatesChanged(uint256 whitelistedPresaleStart, uint256 affiliatedPresaleStart, uint256 publicPresaleStart, uint256 saleStart);
    /**
    ...
    * Please note: it is preferable to call buyWolves() function to buy precise amount of wolves.
    ...
    */
    ...
    function setDates(uint256 _whitelistedPresaleStart, uint256 _affiliatedPresaleStart, uint256 _publicPresaleStart, uint256 _saleStart) external onlyRole(MANAGER_ROLE) {
        ...
        require(block.timestamp < _whitelistedPresaleStart 
                ...
                && block.timestamp < _saleStart, "Cannot set timestamps to the past");
        require(_whitelistedPresaleStart < _affiliatedPresaleStart
                && _affiliatedPresaleStart < _publicPresaleStart
                && _publicPresaleStart < _saleStart, "Wrong timestamps order");
        ...
        emit DatesChanged(whitelistedPresaleStart, affiliatedPresaleStart, publicPresaleStart, saleStart);
    }
