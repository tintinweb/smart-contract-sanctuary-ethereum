...
contract Utya is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint256 public constant totalSupplyCount = 2000;
    uint256 public constant transactionLimit = 50;
    uint256 constant baseMintPrice = 0.07 ether;
    uint256 constant smallDiscountPrice = 0.06 ether;
    uint256 constant bigDiscountPrice = 0.05 ether;
