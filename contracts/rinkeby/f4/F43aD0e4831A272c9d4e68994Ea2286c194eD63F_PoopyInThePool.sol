...
contract PoopyInThePool is ERC721Enumerable, Ownable {
  ...
  uint16 public constant FREE_MINT_LIMIT = 999;
  ...
  constructor(
    ...
    // _setRoyalties(payoutAddress, 250); 
  }
  ...
  function mintPoop(uint8 numberOfTokens) public payable {
      ...
      for(uint8 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < maxPoops) {
            ...
            emit Mint(mintIndex);
            //   setRaribleRoyalties(mintIndex, payoutAddress, 250);
          }
      }
  }

//   function setRaribleRoyalties(uint _tokenId, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints) internal {
...
//       // i dont know what these values really are but I merged the two methods together yolo
//       if(interfaceId == LibRoyaltiesV2._INTERFACE_ID_ROYALTIES || interfaceId == type(IERC2981Royalties).interfaceId) {
//           return true;
//       }
