...
/**
* @title - Implementation of ERC20 token for HydroLink Application Suite
*/
...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Initializes contract - deployer as the initial owner.
     */
    constructor() {
...
interface IERC20 {
    ...
    /**
     * @dev sets name, symbol, total supply and decimal.
     */
...
contract HydroLink is Ownable, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply = 100000000 * (10 ** _decimal); // @Dev sets supply at 100 million HLNK
    ...
    /**
     * TeamWallet is set to Owner and can be changed later
     */
