...
contract AverageTVTEST12 is ERC1155, ERC1155Burnable, Ownable {
  ...
  modifier claimCompliance() {
    ...
    require(claimedList[msg.sender] != _week, "Wallet already claimed.");
    _;
  }
