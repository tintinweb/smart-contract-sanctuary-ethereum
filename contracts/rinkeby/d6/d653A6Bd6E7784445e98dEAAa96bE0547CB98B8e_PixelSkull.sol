...
contract PixelSkull is AdminControl, ReentrancyGuard {
    ...
    mapping(string => NFTDataAttributes) public tokensData;
        ...
        returns (uint256 tokenId)
    {
        ...
        if (contractData.isPresaleActive) {
            require(
                tokensData[imageHash].presaleSale,
                "Presale Artist is locked"
            );
    ...
    function setIsPresaleActive(bool _isActive, uint _price) public adminRequired {
