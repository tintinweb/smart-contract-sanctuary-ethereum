...
contract ThePlague is ERC721A, Ownable {
    uint256 public constant MAX_SUPPLY = 11300;
    ...
    constructor() ERC721A("The Plague", "PLAGUE") {}
    ...
    modifier withinMaxPerWallet(uint256 _quantity) {
        require(
            _quantity > 0 &&
                addressMintCount[msg.sender] + _quantity <= maxPerWallet,
     ...
     */
    bytes32[2] public tieredWhitelistMerkleRoot;
    ...
    /**
     * @dev Set the NFT maximum supply
     */
    function setMintableSupply(uint256 _supply) external onlyOwner {
        require(_supply <= MAX_SUPPLY, "Above absolute maximum");
    ...
    address private constant address1 =
        0x3C5c1BC206575f4e2A819895c8cA792002311ca1;
