...
contract Billionaire is ERC721A, PaymentSplitter, Ownable  {
...
/**we c est vrai, apres k finis la minting dapp, j vais optimizer ce contract, enlever ERC721Enumerable parsque counter peut faire la mm chose et enlever d autre module si j ai le mm problem  */
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721A("Shuan Jo", "SJ") PaymentSplitter(_team, _teamShares) {
