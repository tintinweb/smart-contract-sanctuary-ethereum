...
contract gameSession is Ownable
{
    ...
    event GameCreated(bytes16 _GameID, bytes16 _GameTypeID, Status _GameStatus);
    event GameJoined(address _player);
    ...
    function createGame(bytes16 _GameID, uint256 _bidAmount, bytes16 _gameTypeId) public
    {
        ...
        emit GameCreated(_GameID, gameByID[_GameID].gameType.gameTypeId, gameByID[_GameID].status);
    }
