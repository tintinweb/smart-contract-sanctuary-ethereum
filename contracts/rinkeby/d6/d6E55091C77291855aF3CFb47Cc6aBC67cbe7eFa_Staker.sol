...
contract Staker {
  ...
  State public state = State.Stake;
  ...
  function stake() public payable validState(State.Stake) beforeDeadline {
    balances[msg.sender] += msg.value;
    emit Stake(msg.sender, msg.value);
  }

  function execute() public validState(State.Stake) afterDeadline {
  ...
  function withdraw() public validState(State.Withdraw) afterDeadline {
