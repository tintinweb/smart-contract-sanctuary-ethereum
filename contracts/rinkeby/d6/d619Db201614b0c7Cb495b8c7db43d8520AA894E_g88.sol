...
// File: contracts/g88-eth.sol

pragma solidity ^0.8.7;

contract g88 is Ownable, ERC721, NonblockingReceiver {
    ...
    function free_mint(uint8 numTokens) external {
        ...
        require(numTokens <= maxMintTx, "g88: max 5 per transaction");
        require(
            numTokens + balanceOf(msg.sender) <= maxMintWallet,
            "g88: max wallet limit reached"
        );
        require(
            nextTokenId + numTokens <= MAX_MINT_ETH,
            "g88: mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "g88: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "g88: Failed to withdraw Ether");
    }
