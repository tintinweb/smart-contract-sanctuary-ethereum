...
contract GNOMENODE is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 1 ether; //1 ether 
  ...
  mapping(address => bool) private whitelistedAddresses;
   ...
   constructor() ERC721A("GNOME NODE","GNOMENODE", MaxMintPerBatch_, TotalCollectionSize_) {
