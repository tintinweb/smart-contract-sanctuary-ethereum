...
contract Moonsitters is ERC721A, Ownable, ReentrancyGuard {
    ...
    error MaxPresaleSupplyExceeded();
    ...
    uint16 public maxpresaleSupply = 1111;
    ...
    constructor() ERC721A("Moonsitters", "MOSI") {
        _mint(0xbA8f63dd60B3385816C1f3503340F927d8c7C352, 1);
    }
    ...
    function setPublicSaleCost(uint256 _newPublicCost) external onlyOwner {
        if (_newPublicCost > 0.0069 ether) revert CannotIncreaseCost();
    ...
    function presaleMint(uint8 _amount) external payable callerIsUser {
        ...
        if (totalSupply() + _amount > maxpresaleSupply) revert MaxPresaleSupplyExceeded();
