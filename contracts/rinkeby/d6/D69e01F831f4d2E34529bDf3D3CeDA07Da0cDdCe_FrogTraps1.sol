...
contract FrogTraps1 is ERC721A, Ownable, ReentrancyGuard {
...
//struct for w count
  ...
  constructor(
    ...
    setphase2MetadataUri(_phase3MetadataUri);
    setphase2MetadataUri(_phase4MetadataUri);
    //setphase2MetadataUri(_phase5MetadataUri);
    // setphase2MetadataUri(_phase6MetadataUri);
  }
