...
contract NFTMinting is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public constant w1 = 0xFCb31b17eaB846e337138eA8964B76A5f02E71e0;
    address public constant w2 = 0x54944829363e1dEE06db70D338Dc25B23b6E5C1e;
    address public constant w3 = 0x1BB6c7e604EF11746517b673E437D6095C47cea4;

    uint8 public constant percentW1 = 25;       // wallet1 will receive 25%
    uint8 public constant percentW2 = 30;       // wallet2 will receive 30%
    uint8 public constant percentW3 = 45;       // wallet3 will receive 45%
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmRiNsuRoYQmSAnvziBHSY4xHN43BHxgjvnoDxKyQQQ8Un/";
    bytes32 public merkleRoot;

    constructor() ERC721A("NFT Minting Contract Using ERC721A", "NMCUEA", 20) {
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        if (isRevealed) {
            ...
            return
                string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmQPrJkT8cX72rasGdoMnWq713DwTGniMxxPadjVzgxmbG/", "symbol.json"));
        }
    }
    ...
    function isInWhitelist(bytes32[] memory merkleProof) public view returns (bool) {
    ...
    function mintPresale(uint256 tokens, bytes32[] memory merkleProof) external payable {
        require(!_msgSender().isContract(), "Contract can't mint");
        require(presaleStarted, "Presale has not started");
        require(isInWhitelist(merkleProof), "You are not eligible for the presale");
        ...
        require(totalSupply() + tokens + reserveAmount - tokensReserved <= MAX_TOKENS, "Minting would exceed max supply");
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(w1, ((balance * percentW1) / 100));
        _widthdraw(w2, ((balance * percentW2) / 100));
  ...
  IERC721Enumerable
{
  ...
  function _safeMint(
    ...
    for (uint256 i = 0; i < quantity; i++) {
      ...
      tokenIdTime[updatedIndex] = block.timestamp + delayTime;
      updatedIndex++;
    }
