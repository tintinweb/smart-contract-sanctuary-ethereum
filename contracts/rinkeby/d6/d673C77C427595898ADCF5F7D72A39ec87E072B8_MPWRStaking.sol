...
contract MPWRStaking is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function withdrawAll() external whenNotPaused nonReentrant {
        ...
        uint256 amountToTransfer = stakers[_msgSender()].amount + stakers[_msgSender()].reward + pendingRewards;
        ...
        emit Withdraw(_msgSender(), amountToTransfer, stakers[_msgSender()].reward + pendingRewards);
    }
