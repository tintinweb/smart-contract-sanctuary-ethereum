...
contract EndGame is Ownable, Pausable, ReentrancyGuard, MimeticMetadataBase, ERC721A {
    ...
    constructor(uint256 _startTimestamp, string memory _initialBaseUri)
        MimeticMetadataBase(_initialBaseUri)
        ERC721A("LOOK LABS End Game", "EG")
    {
    ...
    function publicMint(uint256 _quantity) external whenNotPaused callerIsUser nonReentrant {
        ...
        require(publicMintTrack[msg.sender] + _quantity <= PUBLIC_MAX_LIMIT, "Max reached");
