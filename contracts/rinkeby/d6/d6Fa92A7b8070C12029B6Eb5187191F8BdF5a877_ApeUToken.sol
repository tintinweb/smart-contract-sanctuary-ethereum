...
contract ApeUToken is ERC721A, Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        saleConfig.maxMintAmountPerTx = 5;
    }
    ...
    modifier mintCompliance(uint256 _mintAmount, uint256 _total) {
        require(
            _mintAmount > 0 && _mintAmount <= saleConfig.maxMintAmountPerTx,
            "Invalid mint amount!"
        );
    ...
    function auctionMint(uint256 _mintAmount)
        ...
        whenNotPaused
        callerIsUser
        mintCompliance(_mintAmount, amountForAuction)
    {
        uint256 _saleStartTime = uint256(saleConfig.auctionSaleStartTime);
        require(
    ...
    function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof)
        ...
        callerIsUser
        whenNotPaused
        mintCompliance(_mintAmount, maxSupply)
    {
