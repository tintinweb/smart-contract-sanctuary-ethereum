...
contract PackWoodERC1155V1 is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
       __ERC1155_init("https://assets.monsterbuds.io/Packwood-serum-uri/{id}-token-uri.json");
       _before = "https://assets.monsterbuds.io/Packwood-serum-uri/";
    ...
    function buyToken(Order memory order, bytes memory signature) payable external returns(bool){
        ...
        require(totalPrice * amount == msg.value, "PackWoodERC1155: Price is incorrect");
        ...
        _safeTransferFrom(owner(), msg.sender, order.tokenIds[0], order.random[0], "");
        _safeTransferFrom(owner(), msg.sender, order.tokenIds[1], order.random[1], "");
        _safeTransferFrom(owner(), msg.sender, order.tokenIds[2], order.random[2], "");   
