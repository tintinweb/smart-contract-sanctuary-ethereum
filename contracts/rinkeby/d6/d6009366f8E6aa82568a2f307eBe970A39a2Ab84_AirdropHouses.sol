...
contract AirdropHouses is ERC721Enumerable, Ownable {
    ...
    uint256 private _batchDuration = 15 minutes;
    ...
    constructor() ERC721("AirDropHouses-test-5", "ADH-5") {
        _merkleRoots[1][
            10
        ] = 0x96acecf251fdbb6eef35fde352b9afa11bdb198444de51d20aa190be3da3498f;
        _merkleRoots[1][
            7
        ] = 0xf45563d140b2f28102755980ec9e98d1fa35a83720a38bbd0616d4e3016030a4;
        _merkleRoots[1][
            1
        ] = 0x86b477c107683bf6bcb4fc7da646b68bbeb71ac92d3e509fac621e0f8179561c;
        _merkleRoots[2][
            5
        ] = 0x76871e49c2fb1d6cbcc657139c829cb7e7187b370ddddeaeb90ef60450f151e1;
        _merkleRoots[2][
            6
        ] = 0x7fe1f522b96df4e466cbe9dba168ef6be4722a57ecbb7afb85e4f251a671dc90;
        _merkleRoots[3][
            7
        ] = 0xf7e14cb1df408269baef2f9dac5873cf0df451bd989680601f5b99b97fa5de4b;
    }
    ...
    function price() public view returns (uint256) {
        ...
        if (_saleMode == 200 || _saleMode == 299) {
