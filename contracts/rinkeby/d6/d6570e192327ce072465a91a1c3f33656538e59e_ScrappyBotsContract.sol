...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xcCaE392f62554023D70C5b3B2b6daeD1f7F6F329];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfP8GhPZGTuQSLgczTnQi8nnHjQ3j2ps2wWdWU7DuWsGK/";
...
// File: contracts/ScrappyBotsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ScrappyBotsContract is RamppERC721A {
    constructor() RamppERC721A("Scrappy Bots", "SB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/B2TIPMt7UHzBmcth4TVu/contract-metadata";
    }
}
