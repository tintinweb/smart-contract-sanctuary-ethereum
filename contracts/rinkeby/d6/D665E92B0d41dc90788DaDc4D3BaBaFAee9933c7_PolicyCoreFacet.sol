...
contract PolicyCoreFacet is
    ...
    IPolicyTypes,
    PolicyFacetBase,
    IPolicyTreasuryConstants,
    ReentrancyGuard,
    IMarketObserverDataTypes,
    IMarketFeeSchedules,
    Child
{
    ...
    ) external override assertCanCreateTranche assertCreatedState {
    ...
    function _cancelTrancheMarketOffer(uint256 _index) private {
