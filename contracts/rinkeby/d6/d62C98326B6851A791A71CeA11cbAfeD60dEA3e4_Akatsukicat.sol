...
contract Akatsukicat is ERC20, Ownable {
    ...
    constructor() payable ERC20("Akatsukicat", "AKA") {
        ...
        swapTokensAtAmount = (totalSupply * 5) / 1000000000; // 0.05 %
        ...
        operationsAddress = address(0xF8A496176672092523b08523e43e9F1Fd225f21C);
