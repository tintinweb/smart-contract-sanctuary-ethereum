...
contract PokerGene is ERC721, Ownable {
    ...
    function publicMint(uint256 _count) external payable {
        ...
        require(balanceOf(msg.sender) <= MAX_PER_WALLET, "too many per wallet");
        require(msg.value >= PUBLIC_SALE_PRICE.mul(_count), "not enough ETH");
    ...
    function setMaxMintPerTime(uint256 _newMaxMints) external onlyOwner {
        MAX_PER_PUBLIC_MINT = _newMaxMints;
    }
