...
contract TimeLockPool1V2 is Initializable, BasePool, ITimeLockPool {
    ...
    uint256 public constant MIN_LOCK_DURATION = 0; // 7 days
...
abstract contract BasePool is IBasePool, AccessControlEnumerableUpgradeable {
    ...
    function __BasePool_init(
        ...
        __Context_init(); // TODO: Not required
        __AccessControlEnumerable_init(); // TODO: Not required
    }
