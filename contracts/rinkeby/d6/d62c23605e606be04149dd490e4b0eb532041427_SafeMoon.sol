...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9; // 100 M total supply
    ...
    uint256 public _taxFee = 5; // tax fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 5; // auto add liquidity fee
    ...
    uint256 public _maxTxAmount = 5000000 * 10**6 * 10**9; // max amount in one tx
