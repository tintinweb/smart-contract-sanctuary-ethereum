...
contract VirtuosoNFT is ERC721, Ownable  {
    using SafeMath for uint256;

    mapping(address => bool) whitelistedAddresses;
    // 7000 NFT MAX
    // 5000 WL  1800 PUBLIC  200 TEAM  (5 per person in team  + 150 extern)
    bool public whitelistSale = false;

    //DAO/community wallet  => 200 ETH   team => 100 ETH    Project dev => 280 eth& 
    string public BAYC_PROVENANCE = "";

    //royalties  50% virtuoso fund   25% project developement/app    25% team
    ...
    uint256 public WHITE_TIMESTAMP;
    ...
    * Mints Bored Apes
    */
    function mintVirtuoso(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Virtuoso");
        require(whitelistSale, "Whitelist sale must be active to mint Virtuoso");
