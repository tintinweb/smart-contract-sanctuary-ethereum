...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function enter() public payable {
        require(lottery_state == LOTTERY_STATE.OPEN, "Not open now");
    ...
    function getEthPrice() public view returns (uint256, uint256) {
        ...
        uint256 decimals = price_feed.decimals();
    ...
    function getEntranceFee() public view returns (uint256){
        ...
        uint256 adjusted_price = uint256(price) * 1 ** (18 - decimals);

        return (usd_entry_fee * 1e18) / adjusted_price;
    }
    ...
    function endLottery() public onlyOwner {
        ...
        emit RequestRandomness(reqId);
    }

    function fulfillRandomness(bytes32 request_id, uint256 _randomness) internal override {
