...
contract MyEpicNFT is ERC721URIStorage {
    ...
    function makeAnEpiccccccNFS() public {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combinedWord,
                        '", "description": "A highly acclaimed collection of squares.", "attributes": [{"trait_type: "Reputation","value": "first"}], "image": "data:image/svg+xml;base64,',
