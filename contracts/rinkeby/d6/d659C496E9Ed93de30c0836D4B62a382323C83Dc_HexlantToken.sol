...
import "@seongeun/standard-contract/contracts/ethereum/erc20/features/ERC20Burnable.sol";
...
contract HexlantToken is ERC20, ERC20Burnable, ERC20Freezable, Ownable, ERC20Pausable, ERC20Lockable, ERC20BatchTransferable {
    constructor() ERC20("HexlantToken", "HEX") {
        _mint(msg.sender, 100000 * 10 ** decimals());
        _setAccess(Access.OWNABLE);
        FeatureType[] memory _features = new FeatureType[](6);
        _features[0] = FeatureType.BURNABLE;
        _features[1] = FeatureType.FREEZABLE;
        _features[2] = FeatureType.PAUSABLE;
        _features[3] = FeatureType.MINTABLE;
        _features[4] = FeatureType.LOCKABLE;
        _features[5] = FeatureType.BATCH_TRANSFERABLE;
