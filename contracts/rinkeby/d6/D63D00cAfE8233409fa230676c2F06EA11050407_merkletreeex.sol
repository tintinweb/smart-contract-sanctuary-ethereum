...
contract merkletreeex is Ownable, ERC721A {
  using Strings for uint256;

  string public uriPrefix = "ipfs://QmdXzhM1SL8rNM4DGhDTQZrohBcQy86J8awUuoxyN1VvVk/";
  ...
  constructor() ERC721A("merkle tree ex", "MTE")  {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(!onlyWhitelisted, "The presale didn't started!");
    if (!freeSupply) {
