...
contract KamiPass is ERC1155, Ownable, ERC1155Supply {
    ...
    string public name = "Kami Pass";
    string public symbol = "KPS";
    ...
    bytes32 public whitelistMerkle =
        0x042f26df8c955780c3dd76b16fc2f0542bac13f43928490aaea4fae83719868a;
    ...
    function mint(bytes32[] calldata _merkleProof) public payable {
        ...
        // minting has ended
        require(minted < 100, "Minting has ended");
    ...
    modifier isAtMax(uint256 amount) {
        require(
            balanceOf(msg.sender, 1) + amount <= maxPerWallet,
