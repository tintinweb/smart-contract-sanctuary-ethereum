...
contract NftCollection is BaseCollection {
    ...
    {
        require(_presaleActive, "Presale Not active: 3");
    ...
    function mint(uint256 numberOfTokens)
        ...
        onlyMintable(numberOfTokens)
    {
        require(_saleActive, "Minting is not active right now. Check back later.");
        require(!_presaleActive, "Warning: Presale Active! Presale minting only. Please use the presale minting function instead.");
