...
// File: contracts/NFToubitaRInkeby2.sol
...
contract Oubita is ERC721, Ownable {
   ...
   //uint256 public NFTperAddressLimit= 20;
    ...
    uint public specialSale = 50;
    uint public whitelist = 20;
    ...
    address public paidmentAddress;
    ...
    address pagos = 0xece6fFFF5Ad61A2dC2e2DcF94a46554c0933d549;


    constructor(

    )ERC721("Out of the Flame Club","OUBITA") payable {
        contrato = address(this);
        ownerContract = msg.sender;
        tokenContract = 0x1955D59b648489E1B431c7684706F33d68d7adA8;
    ...
    function mint(uint tipo, uint _mintAmount,uint _pago) public payable{
        ...
        if(msg.sender != owner()){
            ...
            if(onlyWhitelisted == true){
                    ...
                    multiTokensTransfer(pagos, tipo, _mintAmount, counter, _pago);
    ...
    function multiTokensTransfer(address _to, uint _type, uint _amount, uint _counter, uint _pago) public payable{
        if(_type == 1){
            if(onlyWhitelisted == true){
            
                require(msg.value >= _pago * _amount, "You dont have enough balance");
            }else if(_counter < specialSale){
    ...
    returns (string memory)
  {
    ...
    function setSpecialPrice(uint256 _supply)public onlyOwner{
        specialSale = _supply;
    }

    function setToken(address _tokens)public onlyOwner  {
...
/*["0xf65A9bf1aDedd3680a7b1A71CC60C6d3E4a23FA4"] */
