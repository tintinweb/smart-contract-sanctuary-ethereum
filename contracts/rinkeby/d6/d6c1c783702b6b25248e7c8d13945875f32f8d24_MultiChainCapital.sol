...
-You buy on Ethereum, we farm on multiple chains and return the profits to $MMM holders.

Tokenomics:
10% of each buy goes to existing holders.
10% of each sell goes into multi-chain farming to add to the treasury and buy back MMM tokens.
...
pragma solidity ^0.6.12;
    ...
    contract MultiChainCapital is Context, IERC20, Ownable {
        ...
        address payable public _MMMWalletAddress;
        ...
        constructor (address payable MMMWalletAddress, address payable marketingWalletAddress) public {
            _MMMWalletAddress = MMMWalletAddress;
        ...
        function sendETHToTeam(uint256 amount) private {
            _MMMWalletAddress.transfer(amount.div(2));
        ...
        function _setMMMWallet(address payable MMMWalletAddress) external onlyOwner() {
            _MMMWalletAddress = MMMWalletAddress;
        }
