...
contract xzxzxzxzx is ERC1155,  Ownable, ERC1155Supply {



    bool public revealed = false;
    uint maxPerWallet=  1;
    uint maxTransaction = 1;
    uint price= 1 ;
    string public name;
    string public symbol;


    constructor( string memory CollectionName, string memory CollectionSymble
      ) ERC1155("ipfs://wwwcom/") {
    name = CollectionName;
    ...
    function mint(uint256 id, uint256 amount)
        public     limitPerWallet(id, amount)    limitPerTrx(amount)
    {  
