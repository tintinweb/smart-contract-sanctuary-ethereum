...
contract InterestRate is IInterestRate {
    ...
    function calculateInterestRates(
        ...
        return calculateInterestRates(reserve, availableLiquidity, totalVariableDebt, reserveFactor, totalReserve);
    }
    ...
    function calculateInterestRates(
        ...
        if (availableLiquidity < totalReserve) {
            availableLiquidity = totalReserve;
        }
        vars.utilizationRate = vars.totalDebt == 0 ? 0 : vars.totalDebt.rayDiv(availableLiquidity + vars.totalDebt - totalReserve);
