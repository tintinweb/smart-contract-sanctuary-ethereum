...
contract Metadata is AccessControl {
    ...
    address public jobsAddr = 0x3bbc725Bd91C086Ef31a3BAF0621FAA94cF53bC9;    //rinkeby 
...
// Global Admin
    ...
    function setFullImage(string memory image_full_uri, string memory full_image_extension) public onlyRole(MINTER_ROLE) {
      metadata.image_full_uri = image_full_uri;
...
// View
    ...
    function getMetadataJson(uint256 tokenId) public view returns (string memory){
      ...
      meta = string(
        abi.encodePacked(
          meta,',\n"image-full": "', metadata.image_full_uri, tokenId.toString(), metadata.image_full_extension
        )
      );
