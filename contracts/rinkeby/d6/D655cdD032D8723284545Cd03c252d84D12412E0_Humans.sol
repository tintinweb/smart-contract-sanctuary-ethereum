...
contract Angels is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Demonica Angels", "DMNANGL", MAX_BATCH_SIZE, MAX_TOKENS) {
        _safeMint(msg.sender, 1);
        isEligibleForFreeMint[0x4d8dd3fcCA3820F3E02Df2e4c3134b1286178C26] = true;
        isEligibleForFreeMint[0x4DA1BB8F9c525512728BF05AfD82C1c5f3D8A727] = true;
        isEligibleForFreeMint[0x4a22db474aa401024beD520b05DcBB193A748430] = true;
...
contract Humans is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Demonica Humans", "DMNHMN", MAX_BATCH_SIZE, MAX_TOKENS) {
        _safeMint(msg.sender, 1);
        isEligibleForFreeMint[0x4d8dd3fcCA3820F3E02Df2e4c3134b1286178C26] = true;
        isEligibleForFreeMint[0x4DA1BB8F9c525512728BF05AfD82C1c5f3D8A727] = true;
        isEligibleForFreeMint[0x4a22db474aa401024beD520b05DcBB193A748430] = true;
