...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
    ...
    // File: contracts/usingOldWlContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract UsingOldWlContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Using Old WL", "OLDWL", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://token.com/token/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/hlwEgHnbk8qOJByt4aaL/contract-metadata";
        }
    }