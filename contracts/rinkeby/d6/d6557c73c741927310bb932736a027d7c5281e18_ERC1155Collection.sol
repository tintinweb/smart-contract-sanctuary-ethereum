    ...
    RolesManager
{
    ...
    function multipleMinting(
        ...
        if (
            ...
            require(isUserVIP(msg.sender), "ERC1155: VIP user minting only");
            require(
                msg.value >= _collection.priceForVIP*editions.length,
                "ERC1155: Insufficient amount transferred."
            );
        }
        // Check if collection is in whitelisted minting phase:
            ...
            require(
                msg.value >= _collection.priceForWhitelisted*editions.length,
                "ERC1155: Insufficient amount transferred."
            );
        } else {
            require(
                msg.value >= _collection.price*editions.length,
                "ERC1155: Insufficient amount transferred."
            );
        ...
        _mint(toAddress, tokenIdIndex, 1, "");
