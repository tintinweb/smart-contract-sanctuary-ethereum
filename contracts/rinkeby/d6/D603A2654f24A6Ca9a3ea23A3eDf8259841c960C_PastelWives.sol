...
contract PastelWives is ERC721, Ownable {
    ...
    uint256 public wivePrice = 7 * 10 ** 16;
    ...
    uint256 public wiveReserve = 20;

    string private newBaseURI;

    mapping(address => bool) private whiteList;

    constructor() ERC721("Pastel Wives", "PW") {}
    ...
    function mintWive(uint256 numberOfTokens) public payable {
        ...
        require(
            balanceOf(msg.sender).add(numberOfTokens) <= MAX_PURCHASE_LIMIT,
