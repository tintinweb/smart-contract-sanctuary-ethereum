...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1440C3237444793a3f50E75ADcD36b2Dd7c1ae0F];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 98 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTqfZxjbJg8faJ9T1nyoF4NMfdnTpZ35gXd4zGGzf6fs1/";
...
// File: contracts/MataroboContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MataroboContract is RamppERC721A {
    constructor() RamppERC721A("Matarobo", "MTRBO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qyICKb0ZZSbJRIvizHXG/contract-metadata";
    }
}
