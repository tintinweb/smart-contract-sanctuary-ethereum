...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmTyLvxzkRK64yFnSVXi3eCprAr2rnmThwy3CDWQ9j8vYD/";
...
// File: contracts/NewAmendContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NewAmendContract is RamppERC721A {
    constructor() RamppERC721A("New Amend", "NAMD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xjHD64giiFo9S1xt9c5j/contract-metadata";
    }
}
