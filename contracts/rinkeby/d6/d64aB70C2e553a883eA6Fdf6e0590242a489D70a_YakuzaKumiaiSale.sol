...
contract YakuzaKumiaiSale is AccessControl {
    ...
    uint256 constant public preSale1Start = 1648914800; // 4.3, 12 pm JST
    ...
    bytes32 public merkleRootWL1 = 0xe439dab86d5ef2bf918fef17c78bacfe7eb144c411c092ff1cdd076e79b1d032;
    ...
    function withdrawToFounders() public payable onlyAdmin {
        ...
        wallet2.transfer(total * 189 / 1000);
        wallet3.transfer(total * 278 / 1000);
        wallet4.transfer(total * 278 / 1000);
        wallet5.transfer(total * 230 / 1000);
        wallet6.transfer(total * 26 / 1000);
    }
