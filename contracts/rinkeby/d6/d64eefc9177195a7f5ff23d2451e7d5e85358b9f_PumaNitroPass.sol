...
contract PumaNitroPass is ERC721A, Ownable {
    ...
    /// Minting Variables
    string public baseURI = "https://puma-blackbox-dev.heroku.com/api/pass/";
    Status public state;
    uint256 public mintCount;
    uint256 public NitroTokensBurned;
    uint256 public NitropassesBurned;
    ...
    function burnNitroPassAndMintForeverPhysical(uint256[] memory NitroPassIds) external {
        ...
        PumaPhysical(PhysicalContract).mint(msg.sender, mintCounter);
        PumaForever(ForeverContract).mint(msg.sender, mintCounter);
    }
    ...
    function oneHourMint(uint256 _mintAmount) external payable {
        require(tokenAmountBurnedByAddress[msg.sender] > 0, "PUMA Nitropass: Did not burn any tokens during 48 hour window");
        ...
        tokenAmountBurnedByAddress[msg.sender] -= _mintAmount;
