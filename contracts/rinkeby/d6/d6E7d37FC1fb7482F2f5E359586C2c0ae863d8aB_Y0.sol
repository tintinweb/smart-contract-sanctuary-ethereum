...
contract Y0 is ERC1155, Ownable {
  ...
  */
  ...
  //     // Only owner can have more than 3 token
  //     if (to != owner() && from == address(0)) {
  //         for (uint256 i = 0; i < ids.length; i++) {
  //             // Limit to 3 tokens per wallet
  //             require(
  //                 balanceOf(to, ids[i]) + amounts[i] <= MAX_TOKEN_PER_WALLET,
  //                 "ERC1155: account can't have more than 3 token"
  //             );
  //         }
  //     }
