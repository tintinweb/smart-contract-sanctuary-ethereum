...
contract CounterFacet is OwnableInternal {
    bytes32 internal constant NAMESPACE = keccak256("com.wtf.counter");
    struct Storage {
        uint256 count;
    }
    ...
    function getSelectors() external pure returns (bytes4[] memory) {
        ...
        selectors[0] = CounterFacet.inc.selector;
        selectors[1] = CounterFacet.dec.selector;
        selectors[2] = CounterFacet.count.selector;
        return selectors;
    }
}
