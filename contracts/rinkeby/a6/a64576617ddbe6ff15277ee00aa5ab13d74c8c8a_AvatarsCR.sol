...
// File contracts/AvatarsCRDNA.sol



pragma solidity ^0.8.0;

contract AvatarsCRDNA {
...
contract AvatarsCR is ERC721, ERC721Enumerable, AvatarsCRDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("AvatarsCR", "ACR") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No AvatarsCR left :(");
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "AvatarsCR #',
                tokenId.toString(),
                '", "description": "AvatarsCR son Avataaars aleatorios almacenados en cadena para practicar el desarrollo de DApp", "image": "',
                image,
                '"}'
            )
        );
