...
contract EralorSeriesOne is ERC721, Ownable {
    ...
    uint256 public claimable = 3; //todo: set to 125
    uint256 public constant PURCHASE_LIMIT = 3; //todo: set to 3
    FCContract public _FCContract; 
    string private _placeholderURI;
    string private _baseTokenURI;
    bytes32 private _byoRoot = 0x148e7708df150738129b1a4f9b2e75b8926467b95cdd06367afc6544cad2b5e6;
    bytes32 private _freeRoot = 0x148e7708df150738129b1a4f9b2e75b8926467b95cdd06367afc6544cad2b5e6;

    mapping(address => uint256) private _nrMinted;
    mapping(address => uint256) private _nrClaimed;
...
//price
  function getPrice(uint256 quantity, address sender) public view returns (uint256) {
    ...
    function isAllowed(address sender, bytes32[] memory proof) public view returns(bool) {
        ...
        return MerkleProof.verify(proof, _byoRoot, leaf); //TODO test if passing correct root is gassy
    }
   ...
   function toggleIsActive() external onlyOwner {
    ...
    function byoMint(bytes32[] calldata proof) external {
        ...
        require(_nrMinted[msg.sender] == 0, "Already minted BYO");
    ...
    function claim(bytes32[] calldata proof) external {
        ...
        require(_nrClaimed[msg.sender] == 0, "Already Claimed");
        require(isAllowed(msg.sender, proof), "Not on claim List");
         uint256 newTokenId = totalSupply + 1;
         _safeMint(msg.sender, newTokenId);
        _nrClaimed[msg.sender] += 1;
        totalSupply++;
        claimable--;
    }
