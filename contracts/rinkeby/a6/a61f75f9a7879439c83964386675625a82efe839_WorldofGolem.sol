...
contract WorldofGolem is ERC721A, Ownable {
    ...
    // Constant variables
    // ------------------------------------------------------------------------
    uint256 public constant MAX_SUPPLY = 9500; // Total amount of WorldofGolem
    ...
    uint256 public PRICE = 0.0006 ether; // Price of a WorldofGolem
    uint256 public PRESALE_PRICE = 0.0003 ether; // Presale Price of a WorldofGolem
