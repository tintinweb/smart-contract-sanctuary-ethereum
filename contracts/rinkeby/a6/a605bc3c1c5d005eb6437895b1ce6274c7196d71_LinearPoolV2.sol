    ...
    PausableUpgradeable
{
        ...
        linearValidatePoolById(_poolId)
    {
        ...
        // mint HYBEX token
        IERC20Mintable(linearPoolInfo[_poolId].linearRewardToken).mint(
            address(this),
            _amount
        );
    ...
    // TODO: function set exchange price for HYBEX and EKTA, default is 1-1
}