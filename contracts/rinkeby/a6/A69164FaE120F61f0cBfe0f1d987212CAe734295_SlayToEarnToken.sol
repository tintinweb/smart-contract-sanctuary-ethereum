...
contract SlayToEarnToken is Context, Ownable, IERC20, IERC20Metadata {
    ...
    */
    ...
    function runMaintenance() public {
        ...
        _doTransferDevFee(devTokens);
        _doBlockifyBuyback(buyBackTokens);
    }

    function _doTransferDevFee(uint256 tokensToSell) internal {
    ...
    function _doBlockifyBuyback(uint256 tokensToSell) internal {
