...
contract ERC721Receiver {
    ...
    event ShowVal2(address indexed _addr, uint256 indexed _value);
    event ShowData(address indexed _addr, bytes _data);
    event ShowData2(address indexed _addr, bytes _data);
...
//        address(this).call(interfaceBar);
    ...
    function bar(uint256 _val) external {
        emit ShowVal2(address(this), _val);
        emit ShowData2(msg.sender, msg.data);
    }
