...
// File: https://github.com/Fredohu/Brain/blob/main/Brain.sol
...
contract Brain is ERC20, ERC20Burnable, Ownable {
...
contract ZombieStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, Brain _token) { 
    nft = _nft;
    token = _token;
  }
...
// rewardmath = 1000 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  function earningInfo(address account, uint256[] calldata tokenIds) external view returns (uint256[] memory info) {
     uint256 tokenId;
     uint256 earned = 0;
     uint256 rewardmath = 0;

     info = new uint256[](tokenIds.length);
