...
contract HDPass is ERC1155, Ownable, ERC1155Supply {
    ...
    function setFreeMintStatus(bool _status) public onlyOwner {
    ...
    function mint(bytes32[] calldata _merkleProof) public {
        require(freeMintActive || publicMintActive, "Minting is not active");
        // minting has ended
        require((minted + 1) <= maxSupply, "Minting has ended");
        if (publicMintActive) {
    ...
    /// @notice Withdraw accidental transfers to contract
