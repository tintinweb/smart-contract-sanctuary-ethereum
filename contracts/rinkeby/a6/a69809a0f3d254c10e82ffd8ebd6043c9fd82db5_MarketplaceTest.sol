...
contract MarketplaceTest is ERC1155, Ownable {
    uint[] public supplies = [50,50,50,50,50,50,150];
    uint256[] public minted = [0,0,0,0,0,0,0];
    mapping(uint256 => mapping(address=>bool)) public member;

    constructor() ERC1155("ipfs://QmYFWy6rbvv3Ndf4nVaYsgNdYa5ZgzGTR3n8sR8eHQQxhT/{id}.json")
    {
    }
    ...
    function uri(uint256 _tokenId) override public view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                "ipfs://QmYFWy6rbvv3Ndf4nVaYsgNdYa5ZgzGTR3n8sR8eHQQxhT",
    ...
    function mint(uint256 _tokenId) public {
        require (!member[_tokenId][msg.sender], "You have already claim NFT");
        require (_tokenId <supplies.length-1, "NFT does not exist");
