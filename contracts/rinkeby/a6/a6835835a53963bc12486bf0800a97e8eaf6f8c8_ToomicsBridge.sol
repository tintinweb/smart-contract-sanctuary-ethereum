    ...
    ReentrancyGuardUpgradeable
{
    ...
    function lock(
        ...
        lockFunds(msg.sender, _recipient, afterLock - beforeLock, _chainName);
    }
        ...
        validatorPrecheck(sigV, sigR, sigS)
    {
        ...
        unlockFunds(_recipient, owner(), _amount, _fee, _interchainTX);
    }
...
contract BaseBridge {
    ...
    function unlockFunds(
        ...
        IERC20(tooAddr).safeTransfer(_recipient, _amount - _fee);
        IERC20(tooAddr).safeTransfer(_owner, _fee);
        ...
        emit LogUnlock(_recipient, _amount - _fee, _interchainTX);
        emit LogUnlockFee(_owner, _fee, _interchainTX);
    }
