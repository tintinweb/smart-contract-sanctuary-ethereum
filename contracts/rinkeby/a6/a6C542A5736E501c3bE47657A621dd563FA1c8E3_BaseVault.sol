...
contract BaseVault is IBaseVault, MerkleBase, Multicall {
    ...
    /// @notice Address of NFTReceiver plugin contract
    ...
    /// @param _receiver Address of the Plugin contract for NFTReceiver hooks
        ...
        returns (bytes4[] memory selectors, address[] memory plugins)
    {
        ...
        (plugins[0], plugins[1], plugins[2]) = (receiver, receiver, receiver);
        (selectors[0], selectors[1], selectors[2]) = (
            INFTReceiver(receiver).onERC721Received.selector,
            INFTReceiver(receiver).onERC1155Received.selector,
            INFTReceiver(receiver).onERC1155BatchReceived.selector
        );
    }
