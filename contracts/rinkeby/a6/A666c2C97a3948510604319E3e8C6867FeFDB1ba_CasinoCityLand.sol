...
import "./CasinoCityNFT.sol";

contract CasinoCityLand is CasinoCityNFT {
    using SafeMathUpgradeable for uint256;
    using CountersUpgradeable for CountersUpgradeable.Counter;

    CountersUpgradeable.Counter _nextTokenId;
}
...
contract CasinoCityNFT is ERC721Upgradeable,
...
//        _initializeEIP712(name);
        _setDefaultRoyalty(royaltiesReceiver, royaltyFeeInBpp);
    }
//    constructor(
//        string memory name,
//        string memory symbol,
...
//    }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://casinocity.qublixaws.com/api/plots/metadata/";
    }
