...
import "Ownable.sol";
 ...
 contract Lottery is VRFConsumerBaseV2, Ownable
 {
    ...
    constructor(address _pricefeed, address _vrfCoordinator, 
    uint64 subscriptionId, bytes32 _keyhash)
    VRFConsumerBaseV2(_vrfCoordinator)
    {
        ...
        createOrGetSubscription(subscriptionId); 
        keyHash = _keyhash;
    }
    ...
    function createOrGetSubscription(uint64 subscriptionId) private 
    {
