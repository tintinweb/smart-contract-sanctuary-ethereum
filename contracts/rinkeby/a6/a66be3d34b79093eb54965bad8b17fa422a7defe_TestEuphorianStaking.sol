...
contract TestEuphorianStaking is Ownable, IERC721Receiver {
  
  uint256 public yeild = 10000 ether;
  uint256 public totalStaked;
  address public nftAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138;
  address public tokenAddress = 0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B;
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      rewardmath = yeild * (block.timestamp - stakedAt) / 86400 ;
  ...
  function setYeild(uint256 _yeild) public onlyOwner {
      yeild = _yeild;
  }
