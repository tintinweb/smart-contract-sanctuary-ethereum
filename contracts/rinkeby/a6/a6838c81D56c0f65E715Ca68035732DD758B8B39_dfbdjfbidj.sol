...
//  / _` ||  _|| || | / _` ||  _|| || '_ \ | | / _` ||  _|| '_ \ 
// | (_| || |  | || || (_| || |  | || |_) || || (_| || |  | |_) |
//  \__,_||_|  |_|| | \__,_||_|  |_||_.__/ | | \__,_||_|  |_.__/ 
//               _/ |                     _/ |                   
//              |__/                     |__/                    
...
contract dfbdjfbidj is ERC721, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

    uint256 public totalSupply = 0;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/589/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/589/contract-uri";
	...
	constructor(address _signerAddress) ERC721("dfijdfibjdfb", "VDI") {
