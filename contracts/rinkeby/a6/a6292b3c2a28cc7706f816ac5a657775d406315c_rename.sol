...
contract rename is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    ...
    constructor() ERC721A("rename", "symbol") {}
    ...
    function FreeMint(uint256 amount) external payable nonReentrant {
        require(publicSaleActive, "Public mint is not live");
        ...
        require(addressMinted[msg.sender] <= freemaxMint, "Max Mint per wallet is 10");
    ...
    function changefreemaxMint(uint56 _new) external onlyOwner {
        freemaxMint = _new;
    }
