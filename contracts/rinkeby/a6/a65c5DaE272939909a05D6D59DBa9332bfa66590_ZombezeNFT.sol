...
contract ZombezeNFT is ERC721A, Ownable, ReentrancyGuard {
    using MerkleProof for bytes32[];

    // ===== Variables =====
    uint16 constant devSupply = 100;
    uint16 constant presaleSupply = 200;
    ...
    // ===== Constructor =====
    constructor() ERC721A("Contract", "Token") {}
