...
contract  testkostas  is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI) ERC721("test kostas", "TK")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint chosenAmount) public payable {
        ...
        require(totalSupply()+chosenAmount<=phase,"Quantity must be lesser then MaxSupply");
