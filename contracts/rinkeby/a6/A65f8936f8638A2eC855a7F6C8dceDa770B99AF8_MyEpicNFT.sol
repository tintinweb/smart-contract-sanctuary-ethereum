...
contract MyEpicNFT is ERC721URIStorage{
   ...
   string[] firstWords = ["Rap","Cerva","Erva","Larica"];
   string[] secondWords = ["Vinho","Cerveja","Whisky","Vodka"];
   string[] thirdWords = ["Tokio","Rio","Denver","Professor"];

   constructor() ERC721 ("Cazuza", "NFTCazuza"){
   ...
   function makeAnEpicNFT() public{
      ...
      string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "',combinedWord,'",  "description": "Uma colecao aclamada e famosa de NFTs maravilhosos.", "image": "data:image/svg+xml;base64,',Base64.encode(bytes(finalSvg)),'"}'))));
