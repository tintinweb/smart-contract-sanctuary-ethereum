...
contract USDCSwap {
  ...
  function donateNativeCoin(uint256 _usdAmount, uint256 _orderId) public payable returns(bool){ //swapEthToToken
  ...
  function donateUSDC(address _sender, uint256 _amount, uint256 _orderId, uint256 _usdAmount) public returns(bool){ //swapTokenToEth
