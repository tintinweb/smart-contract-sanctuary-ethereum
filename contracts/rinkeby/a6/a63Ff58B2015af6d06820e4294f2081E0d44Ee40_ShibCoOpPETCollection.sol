...
contract ShibCoOpPETCollection is IERC721Metadata, ERC721Enumerable, Ownable {
    ...
    string private contractMetaUri = "ipfs://QmbooPMoPgbokYxde5Pr7kWYUxLfp6SWG4QfPgfAE2penE";
    ...
    function presaleMint(address _to) public payable qtyAvailable(1) {
        require(_presaleList[_to], 'Address Not Whitelisted');
        require(msg.value >= 0.002 ether, "Insufficient Funds For Mint");
    ...
    function mint(address _to) public payable saleIsLive qtyAvailable(1) {
        require(msg.value >= PRICE, "Insufficient Funds For Mint");
    ...
    function setBaseURI(string memory baseURI) public onlyOwner contractEditable {
    ...
    function freeze() public onlyOwner contractEditable {
        frozen = true;
    }
