...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF935DE13EB5e939aa7045537a932AC414F425599];
...
// File: contracts/SocketContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract SocketContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Socket";
    string public symbol = "socket";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/JrOspQRkV4NyyUT3n7Jf/contract-metadata";
    }
