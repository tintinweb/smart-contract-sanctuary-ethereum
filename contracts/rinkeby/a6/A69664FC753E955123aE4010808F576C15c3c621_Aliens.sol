...
contract Aliens is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI;
    string public baseExtension = "";
    string public hiddenMetadataUri;

    uint256 constant public cats = 3000;
    ...
    constructor() ERC721A("cat", "cat") {
        _safeMint(msg.sender, 1);
    }

    modifier mintCompliance() {
        require(saleIsActive, "Sale is not active yet."); 
        require(tx.origin == msg.sender, "Wrong Caller"); _;
    }

    function buildNew(uint256 _amount, uint256 _check) external nonReentrant mintCompliance{
        require(_check == 3385666812, "Please don't use bots.");
        require(totalSupply() + _amount <= cats, "over  supply");
        require(_amount <= maxBuy);
      
        require(howmanybuycats[msg.sender] < maxBuy);
