...
/*
     .->    (`-')  _ <-. (`-')_ <-. (`-')_ (`-')  _      (`-').-> (`-')  _         _  (`-')    <-.(`-')            (`-')           _          (`-').->                     <-.(`-')  
 (`(`-')/`) (OO ).-/    \( OO) )   \( OO) )(OO ).-/      (OO )__  ( OO).-/  <-.    \-.(OO )     __( OO)      .->   ( OO).->       (_)         ( OO)_       .->    _         __( OO)  
,-`( OO).', / ,---.  ,--./ ,--/ ,--./ ,--/ / ,---.      ,--. ,'-'(,------.,--. )   _.'    \    '-'---.\ ,--.(,--.  /    '._       ,-(`-')    (_)--\_) ,--.(,--.   \-,-----.'-'. ,--. 
|  |\  |  | | \ /`.\ |   \ |  | |   \ |  | | \ /`.\     |  | |  | |  .---'|  (`-')(_...--''    | .-. (/ |  | |(`-')|'--...__)     | ( OO)    /    _ / |  | |(`-')  |  .--./|  .'   / 
|  | '.|  | '-'|_.' ||  . '|  |)|  . '|  |)'-'|_.' |    |  `-'  |(|  '--. |  |OO )|  |_.' |    | '-' `.)|  | |(OO )`--.  .--'     |  |  )    \_..`--. |  | |(OO ) /_) (`-')|      /) 
|  |.'.|  |(|  .-.  ||  |\    | |  |\    |(|  .-.  |    |  .-.  | |  .--'(|  '__ ||  .___.'    | /`'.  ||  | | |  \   |  |       (|  |_/     .-._)   \|  | | |  \ ||  |OO )|  .   '  
...
/*
 _     _  _______  __    _  __    _  _______    __   __  _______  ___      _______    _______  __   __  _______    ___     _______  __   __  _______  ___   _ 
| | _ | ||   _   ||  |  | ||  |  | ||   _   |  |  | |  ||       ||   |    |       |  |  _    ||  | |  ||       |  |   |   |       ||  | |  ||       ||   | | |
| || || ||  |_|  ||   |_| ||   |_| ||  |_|  |  |  |_|  ||    ___||   |    |    _  |  | |_|   ||  | |  ||_     _|  |   |   |  _____||  | |  ||       ||   |_| |
|       ||       ||       ||       ||       |  |       ||   |___ |   |    |   |_| |  |       ||  |_|  |  |   |    |   |   | |_____ |  |_|  ||       ||      _|
|       ||       ||  _    ||  _    ||       |  |       ||    ___||   |___ |    ___|  |  _   | |       |  |   |    |   |   |_____  ||       ||      _||     |_ 
|   _   ||   _   || | |   || | |   ||   _   |  |   _   ||   |___ |       ||   |      | |_|   ||       |  |   |    |   |    _____| ||       ||     |_ |    _  |
|__| |__||__| |__||_|  |__||_|  |__||__| |__|  |__| |__||_______||_______||___|      |_______||_______|  |___|    |___|   |_______||_______||_______||___| |_|
*/
contract IHBS is ERC721A, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    address private constant TEAM_ADDRESS = 0xD91eF02C7a0BdafBcffC5E80bEbc18f7169c61c0;

    uint256 public constant TOTAL_MAX_SUPPLY = 9999;
    uint256 public constant TOTAL_FREE_SUPPLY = 9999; 
    ...
    constructor() ERC721A("Wanna Help but I SUCK", "IHBS") {
