...
contract CWCert {
    ...
    event IssueCertificate(IssueCertificateTemplate[] certificateTemplate);

    //When organization created certificate template emiting here

    event CreateCertificate(
        address indexed institute_address,
        string indexed institute_name,
        uint256 indexed type_id
    );
    ...
    function createCertificate(
        ...
        emit CreateCertificate(instituteaddress, institutename, typeid);
    }
