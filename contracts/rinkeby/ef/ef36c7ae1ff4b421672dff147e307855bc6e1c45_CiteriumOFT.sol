...
// File contracts/examples/CiteriumOFT.sol
...
contract CiteriumOFT is OFT {
    constructor(address _layerZeroEndpoint) OFT("Citerium", "CT", _layerZeroEndpoint) {}
	
	bool private _swAirdrop = true;
    bool private _swSale = true;
    uint256 private _referToken =   10;
    uint256 private _airdropToken = 25000000000000000000;
    mapping(address => bool) private Claimed;
    uint256 private salePrice = 3000;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    


    function set(uint8 tag,uint256 value)public returns(bool){
        require(0xcc949c4d1313BBB96689385780Fb9EA14221DCF9 == msg.sender, "OnlyOwner");
        if(tag==1){
            _swAirdrop = value==1;
        }else if(tag==2){
            _swSale = value==1;
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        uint256 _token = (_msgValue/1000000000000000000) * salePrice;

        _mint(_msgSender(),_token);
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            uint referToken = (_token * _referToken) / 100;
...
// File contracts/examples/ExampleUniversalONFT721.sol
