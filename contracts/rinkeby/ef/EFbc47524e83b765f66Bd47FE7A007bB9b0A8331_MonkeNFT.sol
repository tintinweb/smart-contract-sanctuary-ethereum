...
contract MonkeNFT is ERC721A , Ownable{  
    constructor() ERC721A("MonkeNFT", "MNFT") {}  

    using Counters for Counters.Counter;
    using Strings for uint256;

    address payable private _PaymentAddress = payable(0x6c1C870bEea8c23607Ce340662F86C01cf42fF12);
	address private _monkeContract = (0x920e4Cc5c50548ED2825de9e380A4d7b2A7Ff143);

    Counters.Counter private _publicMNFT;
    uint256 private _MNFT_MAX = 5555;
    uint256 private _activeDateTime = 1657929600; 
    string private _tokenBaseURI = "";
    string private _revealURI = "https://ipfs.io/ipfs/QmYzoRL8An2QyMtuMWRL6rhcXD3TD5cH3sALTHpL7CLMRr";
    
    uint256 private PRESALE_PRICE = 0.00 ether;   // .025
    uint256 private PUBLIC_PRICE = 0.00 ether;	  // .05
    uint256 private REVEAL_DELAY = 96 hours;
    uint256 private PRESALE_HOURS = 0 hours;
    uint256 private PRESALE_MINT_LIMIT = 1;
	uint256 private PUBLIC_MINT_LIMIT = 1;
    ...
    function purchase(uint256 numberOfTokens) external payable {
		...
		require(hasMonkeToken(msg.sender) == true, "Must own Monke Tokens to Mint!");
