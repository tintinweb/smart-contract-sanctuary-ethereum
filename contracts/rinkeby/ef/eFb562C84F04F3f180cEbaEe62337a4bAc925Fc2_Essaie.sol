...
contract Essaie is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public priceSale = 0.02 ether ;
    ...
    address[] private _team = [
        0xDDD61A6170Be30DF8255E0d899b81f56B218F7f0, //Adress Team
        0xBc5222fe4602b2E075e838E1F51c8684EB11eCF6, // Adress Hugo+Robin
        0xd008E851E84a2377aF5018C60a45EB6930e42966,//Moi 
        0x39Fa2f5B998a75bFfF6850d52146e56d9D93335F,//Gary
        0xABaB1D9ccd91cE5830D32eC1C70DaD024CCDB851,//Maxime
        0x42056EE6060AB779124Be04ae124ee87Dd7eA99b,//Brian
        0xf1024162E10CB53130904fFE432a63277b5a65c7//Lilian
    ];
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("Basketball Player", "BP") PaymentSplitter(_team, _teamShares) {
    ...
    **/
    function presaleMint(address _account, bytes32[] calldata _proof) public payable nonReentrant {
        //Are we in Presale ?
