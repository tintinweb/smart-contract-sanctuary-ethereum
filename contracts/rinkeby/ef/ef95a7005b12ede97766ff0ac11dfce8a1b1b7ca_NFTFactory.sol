 ...
 */
contract FRC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = FRC721.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(FRC721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(FRC721.ownerOf(tokenId), to, tokenId);
    }
...
abstract contract FRC721Enumerable is FRC721, IERC721Enumerable {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, FRC721) returns (bool) {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < FRC721.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < FRC721Enumerable.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = FRC721.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = FRC721.balanceOf(from) - 1;
...
contract FNFT is FRC721Enumerable, Pausable {
    using Strings for uint256;
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "FRC721Pausable: token transfer while paused");
    }
}
...
contract NFTFactory {
    ...
    function createNewNFT(
        ...
        FNFT nft = new FNFT(owner, baseURI, name, symbol);
