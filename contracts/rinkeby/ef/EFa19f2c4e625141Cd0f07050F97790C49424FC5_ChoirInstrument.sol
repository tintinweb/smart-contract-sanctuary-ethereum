...
import "./Tiny721Adjustable.sol";

/**
  @title A contract for Choir Instrument notes.
  @author Liam Clancy
  @author Tim Clancy

  This is the contract for Choir Instrument notes. It is a thin veneer of a
  contract used to control the contract display name on Etherscan.

  May 2nd, 2022.
*/
contract ChoirInstrument is
  Tiny721Adjustable
{
  ...
  */
  constructor (
    ...
    uint256 _cap
  ) Tiny721Adjustable(_name, _symbol, _metadataURI, _cap) {
  }
}
...
/**
  ...
  This variant of SuperFarm's `Tiny721` item contract has an adjustable cap that
  may be increased by an administrator.

  June 1st, 2022.
*/
contract Tiny721Adjustable is
  ERC165, IERC721, IERC721Metadata, Ownable
{
  ...
  */
  ...
  /**
    This function allows the original owner of the contract to increase the
    supply cap of the item. This is used to provide a safety valve for
    collections intended to issue more items into a collection over time.

    @param _newCap The new supply cap to specify.
  */
