...
contract iEARNTimerLock is TimelockController {
...
contract Treasury is Ownable {
    ...
    function withdrow(address _user, uint256 _amount) external onlyOwner {
        iEARN.safeTransfer(_user, _amount);
    }
}
...
contract iEARN is ERC20, ERC20Permit, ERC20Votes, AccessControl {
    bytes32 public constant UPDATER_ROLE = keccak256("UPDATER_ROLE");
    bool public updateStatus;

    constructor(address _treasury) ERC20("iEARN", "XIE") ERC20Permit("iEARN") {
        _mint(_treasury, 30000000 * 10**decimals());
    ...
    function setUpdateStatus() external onlyRole(UPDATER_ROLE) {
        updateStatus = true;
    }
}