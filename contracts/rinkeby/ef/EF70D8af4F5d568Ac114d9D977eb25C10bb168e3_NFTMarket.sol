...
//C:\Users\Wenyx\ReactTruffleToken1\my-app\node_modules\@openzeppelin
//my-app\node_modules\@openzeppelin
...
//contract MyFucking_NFT is ERC721URIStorage, ERC721Enumerable{
contract Token is ERC721URIStorage{

    // adicionar totalsupley é bom para API fazer pesquisa
    ...
    function createTokens() public returns (uint) {
        _tokenIds.increment(); // vai começar em 1 pelo incremento.
        uint256 newItemId = _tokenIds.current();

        _mint(msg.sender, newItemId);
        _setTokenURI(newItemId, t());
        // aprova o contractAddress para negociar seus NFTs..
...
contract NFTMarket is ReentrancyGuard,Ownable{
    ...
    uint256 fees = 5;// usar ether ou wei
    ...
    //recupera o item com a struct se exitir
    ...
    function SendBack(address nftContract,uint256 tokenId)external payable nonReentrant{
        ...
        uint val = (idToMarketItem[tokenId].price * fees) / 100;
        require(msg.value >= val,"Need Pay 5% fees");
        IERC721(nftContract).transferFrom(address(this), msg.sender, tokenId);
        reset(tokenId);
        //delete getMarketItem(tokenId); // getMarketItem
    ...
    // mecher aqui adicionar Owner do openzeplin..
