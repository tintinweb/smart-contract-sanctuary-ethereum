...
contract Demo is ERC721A, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 _mintAmount) external payable nonReentrant mintRequirements(_mintAmount) {
        ...
        if(saleState == SaleState.OG_SALE){
            ...
            require(amountMinted[msg.sender] < publicMaxPerWallet, "Mint amount fir wakket exceeded");
        }
        else if(saleState == SaleState.PUBLIC_SALE && totalSupply() > 4444){
            ...
            require(amountMinted[msg.sender] < maxPerWalletAfter4444, "Mint amount for wallet exceeded");
        }
