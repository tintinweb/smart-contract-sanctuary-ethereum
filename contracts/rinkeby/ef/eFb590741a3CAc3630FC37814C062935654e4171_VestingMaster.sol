...
// File contracts/IVestingMaster.sol
...
// File contracts/VestingMaster.sol
...
contract VestingMaster is IVestingMaster, ReentrancyGuard, Ownable {
    ...
    // MAX token, or may be other token
    ...
    function lock(address account, uint256 amount) public override onlyOwner {
