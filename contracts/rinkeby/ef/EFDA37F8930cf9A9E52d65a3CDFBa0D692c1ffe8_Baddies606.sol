...
contract Baddies606 is CoreDrop721 {
    ...
    constructor() CoreDrop721(
        NftOptions({
            ...
            startingTokenId: 1,
            maxInvocations: 606,
            contractUri: "" // @todo(developer): set contract uri
        }), 
        DropOptions({
            metadataBaseUri: "https://api.imnotart.com/",
            mintPriceInWei: 0.05 ether, // @todo(developer): set the price per token
            maxQuantityPerTransaction: 10,
            autoPayout: false,
            active: true, // @todo(developer): update this to false when going to mainnet
            presaleMint: true,
            presaleActive: true,
            presaleDifferentMintPrice: true,
            presaleMintPriceInWei: 0.05 ether, // @todo(developer): set the price per token during presale
