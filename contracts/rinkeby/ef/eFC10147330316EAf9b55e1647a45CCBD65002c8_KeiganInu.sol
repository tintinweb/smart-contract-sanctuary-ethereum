...
contract KeiganInu is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public supplyLimitPhase1 = 20000;  //change to your NFT supply for phase1
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("KEIGAN INU", "KEI")  { //change this line to your full and short NFT name
    seturi(_uri);
...
// ================== Mint Functions Start =======================
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x15649044C369f75120067dc5b67ac7a51A7C774f).call{value: address(this).balance * 20 / 100}("");
    require(hs);
