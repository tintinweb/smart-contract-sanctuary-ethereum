...
contract FourHundredDrums is ERC721A, Ownable {
    ...
    function devMint(uint256 _quantity) external payable {
    ...
    function withdraw() public payable onlyOwner {
      ...
      (bool wallet1, ) = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2).call{value: balance * 15 / 100}(""); // 14%
      (bool wallet2, ) = payable(msg.sender).call{value: address(this).balance}(""); // remaining
