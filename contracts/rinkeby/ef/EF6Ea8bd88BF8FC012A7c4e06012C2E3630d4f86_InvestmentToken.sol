...
import "../extensions/ERC20AllowListable.sol";
import "../extensions/EmergencyWithdrawable.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC20/extensions/ERC20Burnable.sol";

contract InvestmentToken is Ownable, ERC20Burnable, ERC20AllowListable, EmergencyWithdrawable {
    constructor(string memory name_, string memory symbol_) ERC20(name_, symbol_) {
    }

    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        address owner = _msgSender();
        bool _isAllowListed = isAllowListed[to] && isAllowListed[owner];
        require(_isAllowListed, "ERC20AllowListable: account is not allowlisted");
     ...
     *
     * See {ERC20AllowListable-_addAllowList}.
     *
     * Requirements:
     *
     * - the caller must be owner.
     */
    function addAllowList(address account) public onlyOwner {
        _addAllowList(account);
    }

    /**
     * @dev Remove address from allowlist.
     *
     * See {ERC20AllowListable-_removeAllowList}.
     *
     * Requirements:
     *
     * - the caller must be owner.
     */
    function removeAllowList(address account) public onlyOwner {
        _removeAllowList(account);
    }
    ...
    //     address to, 
    //     uint256 amount
    // ) internal virtual override(ERC20, ERC20AllowListable) {
    //     super._beforeTokenTransfer(from, to, amount);
    // }
}

// SPDX-License-Identifier: Unlicense
// TokenX Contracts v1.0.0 (extensions/ERC20AllowListable.sol)
pragma solidity ^0.8.0;

abstract contract ERC20AllowListable {
    ...
    /**
     * @dev Emitted when new account has removed from allowlist.
     */
     ...
     */
    function _addAllowList(address account) internal virtual {
     ...
     * @dev Add `account` to allowlist.
     */
    function _removeAllowList(address account) internal virtual {
        isAllowListed[account] = false;
    ...
    //     bool _isAllowListed = isAllowListed[from] && isAllowListed[to] && isAllowListed[msg.sender];
    //     require(_isAllowListed, "ERC20AllowListable: account is not allowlisted");
