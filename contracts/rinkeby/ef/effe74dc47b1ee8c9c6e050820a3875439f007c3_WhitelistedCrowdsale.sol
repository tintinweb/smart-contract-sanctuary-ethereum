...
// File: contracts/CappedCrowd.sol
 ...
 */
abstract contract CappedCrowd is Crowdsale {
  using SafeMath for uint256;
...
contract CappedCrowdsale is Crowdsale, CappedCrowd  {
  ...
  */
  function _preValidatePurchase(
    ...
    internal
    override(CappedCrowd, Crowdsale)
   pure
  {
 ...
 */
abstract contract TimedCrowd is Crowdsale {
  using SafeMath for uint256;
...
// File: contracts/Whitelistcrowd.sol
...
contract WhitelistedCrowdsale is Crowdsale, TimedCrowd, WhitelistedCrowd, CappedCrowd {
  ...
  */
  function _preValidatePurchase(
    ...
    internal
    override(Crowdsale,TimedCrowd , WhitelistedCrowd, CappedCrowd)
    pure
  {
    super._preValidatePurchase(_beneficiary, _weiAmount);
    // uint256 _existingContribution = contributions[_beneficiary];
