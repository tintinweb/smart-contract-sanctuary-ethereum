...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe429987fdD0cDBDEB4a98c426463D8CE56B07127];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 2500 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qma66mdQjvWcNm7J9KvLN91957Aq6vJUXNgtPRV9WH9fDi/";
...
// File: contracts/Error404Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Error404Contract is RamppERC721A {
    constructor() RamppERC721A("Error 404", "ERR4"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GffTRjiQJZgxrgd1jVGD/contract-metadata";
    }
}
