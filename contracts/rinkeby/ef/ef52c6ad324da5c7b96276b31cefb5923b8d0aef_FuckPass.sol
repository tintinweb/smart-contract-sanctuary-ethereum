...
contract FuckPass is ERC721A, Ownable {
    ...
    function fuckingMint(uint8 mintList, bytes32[] calldata _merkleProof) external payable //mintList = 0 for OG, 1 for FuckList, 2 for Reserve List
    {
    ...
    function publicFuckingMint() external payable
    {
        require(msg.sender == tx.origin, "You need to be a fucking human");
