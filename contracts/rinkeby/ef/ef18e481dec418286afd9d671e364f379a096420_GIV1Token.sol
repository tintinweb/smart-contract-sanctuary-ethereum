...
contract GIV1Token is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "TheGivingPool";
    string private constant _symbol = "GIV1";
    ...
    address payable private _marketingAddress = payable(0x5c1Ca37f6B354559e71F8B133cCa3789CFBF65e7);
    ...
    function _tokenTransfer(
        ...
        takeFee = false;  // remove for fee in transaction
