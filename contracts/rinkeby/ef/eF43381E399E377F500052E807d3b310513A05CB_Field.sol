...
contract Field is Ownable, IERC721Receiver, Pauseable {
 ...
 //   mapping(uint => address) public ownerPlayer;
 //   mapping(uint => address) public ownerGoal; 
 ...
 //   mapping(address=> mapping(uint16 => uint16)) ownerPlayer;
 //   mapping(address=> mapping(uint16 => uint16)) ownerGoal;
        ...
        for (uint i = 0; i < tokenIds.length; i++) {
            ...
            if (isPlayer(tokenIds[i])) {
            ...
            else
             {
               ...
               // ownerGoal[msg.sender][goalCount[msg.sender]] = tokenIds[i];
