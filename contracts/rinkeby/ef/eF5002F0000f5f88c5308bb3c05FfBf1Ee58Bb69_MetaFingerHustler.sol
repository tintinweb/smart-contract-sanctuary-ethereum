...
// File: contracts/MetaFingerHustler.sol
...
contract MetaFingerHustler is ERC721Enumerable, Ownable {
    //  Accounts
    address private constant creator0Address =
        0x3dfd00CaD5a6772321da9da1756cE18D435A61C5;
    ...
    constructor() ERC721("MetaFingerHustler", "MFH") {}
        ...
        payable
    {
        ...
        require(
            balanceOf(msg.sender) + _count <= maxWlPurchase,
            "Exceeds the account's quota"
        );
        require(totalSupply() + _count <= maxSupply, "Exceeds max supply");
        require(
        ...
        require(
            mintCounts[msg.sender] + _count <= maxWlPurchase,
            "Exceeds the account's quota"
        );
    ...
    function setMaxWlPurchase(uint256 _maxWlPurchase) external onlyOwner {
        maxWlPurchase = _maxWlPurchase;
    }
