...
contract isi is ERC721{
    ...
    nekomato_0407_2215 nkmt = nekomato_0407_2215(0x961a1d65aC821C0dDc88D5Bd8dA76cb52Afff762);
    ...
    function changeNKMTForm(uint _id)external{
        require(hadTokens[_msgSender()] > 0);
       // require(nkmt.hadTokens[msg.sender] > 0);
