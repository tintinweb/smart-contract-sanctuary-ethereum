...
contract AstroX is ERC721A, Ownable, Pausable {
    ...
    uint public constant maxSupply = 50;
    uint public constant _price = .0032 ether;
    uint public constant _preprice = .0012 ether;
    uint public constant MaxPerMint = 6;
    uint public constant AirDropSupply = 20;

    string public _contractBaseURI;

    constructor(string memory baseURI) ERC721A("AsterixTest", "ASTERIX") {
