...
// File: GS_NFT_Contracts/GenNFTMarketplace.sol
...
contract GenNFTMarketplace is ReentrancyGuard {
  ...
  /* Updates the listing price of the contract */
    function updateListingFee(uint _listingFee) public {
  ...
  function createMarketSale(
    ...
    payable(marketowner).transfer(listingFee);//GS cut
    item.seller.transfer(msg.value - listingFee);
