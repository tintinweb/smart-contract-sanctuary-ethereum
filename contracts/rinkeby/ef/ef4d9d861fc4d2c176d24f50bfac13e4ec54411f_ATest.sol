...
contract ATest is ERC721, ERC2981, Ownable {

    uint256 public price = .05 ether;
    uint256 public maxPerAddress = 10;
    bool public isPublicSaleActive = false;
    address public royaltyAddress= 0x6CB164bA5863eeF9A68296dBBE25DE03FB7dE357;
    uint96 public royaltyFee = 500;
    address public teamwallet1 = 0x6CB164bA5863eeF9A68296dBBE25DE03FB7dE357;
    uint96 public teamFee1 = 80;
    address public teamwallet2 = 0x6CB164bA5863eeF9A68296dBBE25DE03FB7dE357;
    uint96 public teamFee2 = 16;
    ...
    constructor() ERC721("ATest", "ATest") {
    ...
    function withdraw() external onlyOwner {
        ...
        uint teamShare2 = balance - (teamShare1 + devShare);
    ...
    /**
     * @notice Allow owner to update the Team fee
     */
    function setTeamFee1(uint96 fee) external onlyOwner {
        teamFee1 = fee;
    }
   ...
   /**
     * @notice Allow owner to update the Team fee
     */
    function setTeamFee2(uint96 fee) external onlyOwner {
        teamFee2 = fee;
    }
    ...
    /**
     * @notice Allow owner to update the Dev fee
     */
    function setDevFee(uint96 fee) external onlyOwner {
        devFee = fee;
    }

    /**
     * @notice Allow owner to update the Dev address
     */
