...
// ERC721A Contracts v4.0.0
    ...
    address constant internal TEAM_ADDRESS = 0xE641ceeB80423b707ceA64cd7F156B6B4F6a70C6;
    string public baseURI = "";
    string public constant baseExtension = "";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("test3", "TST3") {_safeMint(msg.sender, 1); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmQEoof7LNDqKTg5QXSHjUW56hGNEfVB2Bt9cFRoAMuGr3");}
