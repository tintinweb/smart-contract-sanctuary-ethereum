...
contract BPunkT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BPunkT", "BPT") {
    setHiddenMetadataUri("ipfs://QmUtFqULKo28rxw5ozVpMyrVaTM853UsvLDMDSuCAfae5R/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xac4d778832bD87F63F4aa3D29804A4D15b77a9E7).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
