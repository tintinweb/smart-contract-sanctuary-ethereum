...
library LiquidationLogic {
    ...
    function executeLiquidationCall(
        ...
        (
            vars.collateralPToken,
            vars.collateralPriceSource,
            vars.debtPriceSource,
            vars.liquidationBonus
        ) = _getConfigurationData(collateralReserve, params);

        vars.userCollateralBalance = vars.collateralPToken.balanceOf(
            params.user
        );
        ...
        if (vars.liquidationProtocolFeeAmount != 0) {
            vars.collateralPToken.transferOnLiquidation(
                params.user,
                vars.collateralPToken.RESERVE_TREASURY_ADDRESS(),
                vars.liquidationProtocolFeeAmount
            );
        }
    ...
    function _liquidatePTokens(
        ...
        uint256 liquidatorPreviousPTokenBalance = IERC20(vars.collateralPToken)
    ...
    {
        IPToken collateralPToken = IPToken(collateralReserve.xTokenAddress);
...
library ValidationLogic {
    ...
    function validateWithdrawERC721(
        ...
        require(sender == tokenOwner, Errors.NOT_THE_OWNER);
