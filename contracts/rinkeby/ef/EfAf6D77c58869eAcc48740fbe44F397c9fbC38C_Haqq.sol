...
contract Haqq is ERC721A, Ownable, Pausable {
    ...
    uint public constant MAX_RESERVE_SUPPLY = 12;

    string public _contractBaseURI;

    constructor(string memory baseURI) ERC721A("Haqq Demo", "HAQQ") {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://haqqdemo.mypinata.cloud/ipfs/QmXVaoSgrXwgpJKWhjUctjUV7pzfwZL8wvSgVntJfUPZzv";
    }
