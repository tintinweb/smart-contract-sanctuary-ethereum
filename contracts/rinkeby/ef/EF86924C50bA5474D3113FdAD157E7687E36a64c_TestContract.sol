...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD7a0e9E952BDe41bE1fdaE1dAd0Aba1F84239079];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUxF7pPuFt8FQjg7LWymb1UZPceb5xouEQoeKt2uszfXs/";
...
contract TestContract is RamppERC721A {
    constructor() RamppERC721A("test", "ts"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Xm9eyksmSIYHtTPKKBb5/contract-metadata";
    }
}
