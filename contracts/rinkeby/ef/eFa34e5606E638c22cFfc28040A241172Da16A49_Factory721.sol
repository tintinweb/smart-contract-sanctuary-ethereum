...
import "./OwnCollectiblesNFT721.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new CollectiblesNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CollectiblesNFTUser721Token token = CollectiblesNFTUser721Token(address(addr));
...
contract CollectiblesNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
