...
contract GoonzPortal is ERC721, IERC721Receiver, ERC721Enumerable, Ownable {
    ...
    function enterPortal(uint256 tokenId) public {
        require(cryptoonGoonzContract.ownerOf(tokenId) == msg.sender, "Must be the owner of this token");
        cryptoonGoonzContract.safeTransferFrom(msg.sender, address(this), tokenId);
    }
