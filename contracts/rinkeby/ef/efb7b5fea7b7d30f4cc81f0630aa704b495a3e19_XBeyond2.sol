...
contract XBeyond2 is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(string memory name, string memory symbol, string memory _uri, address _erc20) ERC721(name, symbol) {
        baseURI = _uri;
        erc20 = IERC20(_erc20);
    }
    ...
    function mintAndRedeem(uint256 collectionId, uint256 tokenId, bool isBend, bytes32[] calldata proof) external {
    ...
    function setMintConfig(uint _mintPrice, uint _redeemPrice, uint _wlMintPrice, uint _wlRedeemPrice) external onlyOwner  {
