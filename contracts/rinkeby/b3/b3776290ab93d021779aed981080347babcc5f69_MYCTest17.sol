...
/**
    Contract developer will not take the responsibility for any legal issues. 
    The contract deployer is entirely responsible for the legal issues.
*/
...
contract MYCTest17 is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("MYCTest17","MYC", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
        sethiddenBaseURI("ipfs://QmYnDvN5MfELYiw2L2NfJ9fxJymsKCR2o7u4hM2z2gvfKv/hidden.json");
    }
    ...
    //    _withdraw(a1, ((balance * 75) / 100));
    //    _withdraw(a2, ((balance * 25) / 100));
    //}
    ...
    function withdraw() public onlyOwner {
        ...
        address a1 = payable(0x371D0D4DC36D90c16b8D4b445aCC66Ea08269283);
        address a2 = payable(0xE0ddFa115aE17CFac2a9FCb0A59E8239b1c073a9);

        bool success;

        (success, ) = a1.call{value: (sendAmount * 750/1000)}("");
        require(success, "Failed to withdraw Ether");

        (success, ) = a2.call{value: (sendAmount * 250/1000)}("");
        require(success, "Failed to withdraw Ether");
    }
