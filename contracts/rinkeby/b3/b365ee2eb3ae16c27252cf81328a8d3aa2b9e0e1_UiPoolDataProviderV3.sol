...
contract UiPoolDataProviderV3 is IUiPoolDataProviderV3 {
    ...
    function getDebtTokenAddress(IPoolAddressesProvider provider, address reserveTokenAddress)
       public
       view
       returns (address stableDebtTokenAddress, address variableDebtTokenAddress)
    {
        ...
        return (baseData.stableDebtTokenAddress, baseData.variableDebtTokenAddress);
    }
