...
contract MOAA is ERC721Delegated, SignedAllowance {
        ...
        )
    {
            ...
            _saleState = 2; //1 = closed - only admin can mint, 2 = public sale - no checks for WL, 3 = private sale - checks for WL
    ...
    address private payout = 0xE0cC9B6dDD98F699427C2FF5aCb870062D610E0B;
...
////////////////////////////////////////
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        ...
        string memory pmImage = string(abi.encodePacked("ar:///hash/"));
        string memory automatonImage = string(abi.encodePacked("ar:///hash/"));
        string memory memoriaImage = string(abi.encodePacked("ar:///hash/"));
        string memory json;
        if(tokenId == 0) {
            json = string(
            abi.encodePacked( 
                '{"name": "Project 5301 #0/0",',
                '"description": "",',
            ...
            abi.encodePacked( 
                ...
                '"attributes":[',
                '{"trait_type":"Artist","value":"NYX"},{"trait_type":"Artist","value":"SECONDSTATE"},{"trait_type":"Music","value":"DannyWithThreeBrains"}',
                "]}"
            )
            ...
            json = string(
            abi.encodePacked( 
                '{"name": "Memoria #', Strings.toString(tokenId), '/300",',
