...
//        string memory _initNotRevealedUri
    ...
    function _giveawaysetter(address[] memory _addList) internal onlyOwner returns(uint256) 
    {
        _getOwnidlist();
    ...
    function mintOne(string memory _tokenURI) public onlyOwner mintCompliance(1) {
        
        _mintLoop(msg.sender, 1);
        SetEachURI(supply.current(), _tokenURI);
    }
