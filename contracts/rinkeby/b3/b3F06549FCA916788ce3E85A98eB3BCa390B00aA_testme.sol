...
contract testme is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://bafybeiamyjwytgu4zoaoeii33ityd2mncgdozwy3sdku3rdp4jh4y75veu";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://bafybeiamyjwytgu4zoaoeii33ityd2mncgdozwy3sdku3rdp4jh4y75veu";
    ...
    address public teamWallet = 0x048df755A02633943a26b29cBfEFB139803c2535;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("TESTFULLNAME", "TEST") { }
    ...
    */
    ...
    function teamMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= 0, "Team mints after free");
