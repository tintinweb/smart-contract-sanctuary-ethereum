...
contract Escrow is IERC721Receiver {
    ...
    function depositNFT(uint256 _loanId) public {
    ...
    function cancelAtNFT(uint256 _loanId)
        public
        inLoanState(_loanId, LoanState.nftDeposited)
    ...
    modifier onlyLender(uint256 _loanId) {
        require(msg.sender == loans[_loanId].lenderAddress);
        _;
    }
    ...
    modifier inLoanState(uint256 loanId, LoanState _state) {
        require(loans[loanId].loanState == _state);
        _;
    }
