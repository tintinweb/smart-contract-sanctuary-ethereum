...
contract ERC721PrimaryMarketplace is PrimaryMarketplace {
    ...
    /**
     * @dev Mints and then transfers the token to the buyer.
     */
...
abstract contract PrimaryMarketplace is Marketplace {
    ...
    /**
     * @dev Transfers the total sale price minus the commission to the creator.
     */
        ...
        override
    {
        uint256 commissionAmount = (
            msg.value * commissionNumerator()
        ) / commissionDenominator();

        message.seller.transfer(msg.value - commissionAmount);
    }
}
...
import "../ERC721/ERC721Collection.sol";
    ...
    ReentrancyGuard
{
    ...
    /* Types */
    /*********/
    bytes32 public constant ERC721_TOKEN_TYPE = keccak256("ERC721");
    bytes32 public constant ERC1155_TOKEN_TYPE = keccak256("ERC1155");
    ...
    uint16 private _commissionDenominator;
        ...
        EIP712(name, version)
    {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
         ...
         _commissionDenominator = commissionDenominator_;
    }
    ...
    /**
     * @dev Purchases a fixed price token.
     */
    ...
    /**
     * @dev Sets the commission denmerator.
     */
    function setCommissionDenominator(uint16 commissionDenominator_)
        external
        nonReentrant
    ...
    /**
     * @dev Sets the commission numerator.
     */
    ...
    /**
     * @dev Returns the commission denominator.
     */
    function commissionDenominator() public view returns (uint16) {
        return _commissionDenominator;
    }

    /**
     * @dev Returns the commission numerator.
     */
    ...
    /**
     * @dev implement this method in the concrete subclass to pay the creator
     *     (and reseller) of the token.
     */
    function _transferPayment(TransactionMessage calldata message)
        internal
        virtual;
    ...
    /**
     * @dev Implement this method in the concrete subclass to transfer the
     *     token to the buyer (minting it first if needed).
     */
    function _transferToken(TransactionMessage calldata message)
        internal
        virtual;
    ...
    /**
     * @dev Get the address that was used to sign the given message and
     *     signature.
     * @notice If the message and/or signature have been tampered with, a
     *     random address will be returned as the signer.
     */
    function _getSigner(
        TransactionMessage calldata message,
        bytes calldata signature
    ...
    /**
     * @dev Validates the message and the signature.
     */
...
interface IMarketplace {
    ...
    function setCommissionDenominator(
        uint16 commissionDenominator_
    ) external;
