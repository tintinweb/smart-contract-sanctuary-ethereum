    ...
    ReentrancyGuard
{
    ...
    function setBeneficiary(address beneficiary) external onlyOwner {
        require(beneficiary != address(0), "beneficiary must not 0");
...
contract BlockBasedSale is Ownable {
    ...
    uint256 public privateSaleCapped = 6666;
    uint256 public totalPrivateSaleMinted = 0;
    uint256 public privateSalePrice = 150000000000000000;
    ...
    uint256 public discountBlockSize = 100;
    uint256 public lowerBoundPrice = 100000000000000000;
    uint256 public publicSalePrice = 700000000000000000;
