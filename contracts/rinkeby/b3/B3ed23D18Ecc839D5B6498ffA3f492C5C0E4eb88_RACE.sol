...
// Equivalent to loan proposal 
    struct Order {
        ...
        // Timestamp(in Unix ie 23 Oct 2302 MM::HH::SS) for which NFT is considered for loan  ie final Repaymnet duration of loan
...
*/
    ...
    function withdrawActiveOffer(uint256 _orderId, uint256 _offerId) public nonReentrant {
        ...
        emit OfferWithdrawn(_orderId,_offerId, msg.sender, orders[_orderId].NFT_address, orders[_orderId].tokenId);
    }
