...
contract Waifer is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        marketingWalletAddress = 0x6eCAD13bFf29A0Adcb8C4C2Cc4BCEe3466E689d5;
        marketingFee = 2;
        ...
        minimumTokensBeforeSwap = 10 * 10 ** 18;
    ...
    function testAntiwhaleBot(uint256 amount) external view returns (uint112, uint256) {
        (uint112 reserve0, ,) = IUniswapV2Pair(uniswapV2Pair).getReserves();
        uint256 liquidityToken = (reserve0 * antiwhaleFee) / 10**2;
    ...
    function getTValues(uint256 amount) internal view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount - tFee - tMarketingFee - tLiquidityFee;
