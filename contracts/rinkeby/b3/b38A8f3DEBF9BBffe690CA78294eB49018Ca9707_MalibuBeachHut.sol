...
contract MalibuBeachHut is ERC1155Supply, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 amount, uint256 id)
        public
        nonReentrant
    {
        ...
        if(coin.allowance(_msgSender(), address(this)) == 0) {
            coin.approve(address(this), coin.maxSupply());
        }
    ...
    function adminMint(address account) public onlyOwner {
