...
contract Gift is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint64 public constant MAX_TOKEN = 999;
    string public baseURI;

    WPSInterFace Stake_Contract;

    constructor(string memory baseURI_, address Stake_contract_address_) ERC721A("Gens", "GEN") {
