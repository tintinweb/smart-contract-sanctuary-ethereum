...
contract TestNFT is ERC721Tradable{
    ...
    constructor(
        ...
        "ARCADM", "ARC",
         0x465cD41394Eb35931f39fdd8507A230FF362f986,
         0xE1Cd6315D6fC9D5048EbeCa611Ce75f3840a67BF,
        "https://gateway.pinata.cloud/ipfs/Qmcrnu7D3q14XDBjUNA3TsHFAxyiRGdz7fgLSkZWNXm7VG/",
         mainsale_price,
         presale_price,
         whitelist_price,
         total_supply,
...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, Ownable {
    ...
    constructor(
        ...
        _whitelistprice=whitelist_price;
    ...
    modifier restricted() {
        require(hasRole(Owner_Role, msg.sender),"This function is restricted to the contract's owner");
        _;
    }
    function PresalePrice(uint256  Presale_Price ) public restricted   {
        // require(hasRole(Owner_Role,msg.sender),"You are not a owner");
         _presalePrice = Presale_Price; 
    }

     function PresaleSupply(uint256  Presale_Supply ) public restricted  {
        //  require(hasRole(Owner_Role,msg.sender),"You are not a owner");
    ...
    function Whitelistsale(address _to) payable public virtual{
        require(hasRole(Whitelist_Role, msg.sender),"You are not whitelisted");
        tokenlimit[msg.sender].a += 1;
          require( tokenlimit[msg.sender].a < 10,"Only Two NFT Mint Per Address");
          require(totalSupply() <= _maxSupply,"All Tokens Mint");
          require(msg.value >= _whitelistprice,"Not Enough Ether");
          payable(_sendeth).transfer(msg.value);
         _tokenIdTracker.increment();
           _mint(_to, _tokenIdTracker.current());
    }
    ...
    function OwnerPresale(address _to,uint256 tokens) public restricted {
        // require(hasRole(Owner_Role,msg.sender),"You are not a owner");
         require(totalSupply() <= _maxPresaleSupply);
    ...
    function addusertowhitelist(address[] memory _whitelist) public restricted {
        // require(hasRole(Owner_Role,msg.sender),"You are not a owner");
