...
contract Abc is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public hiddenMetadataUri = "ipfs://QmWYd2A5e95abXsP8ntHt5SPJ14rQYtAMFar2Cq18Q9Dsn/Hidden.json";
  ...
  function MassAirdrop(address[] memory _addresses)public onlyOwner {
    uint256 totalSupply;
