...
contract SatelliteCounter is ICounterDeployment, ReentrancyGuard {
    ...
    constructor(
        ...
        emit DebugEventWithNum("Satellite: constructor() called", int256(msg.value));
        masterChainId = _masterChainId;
        masterCounterBytesAddress = abi.encodePacked(_masterCounterAddress);
        endpoint = ILayerZeroEndpoint(_endpoint);
        emit DebugEventWithNum("Satellite: constructor() complete", int256(msg.value));
    }
    ...
    function updateCount(
        ...
        emit DebugEventWithNum("Satellite: updateCount() called", _value);
        ...
        emit DebugEventWithNum("Satellite: updateCount() complete", _value);
    }
    ...
    function getCount(
        ...
        emit DebugEventWithNum("Satellite: getCount() called", count);
        bytes memory payload = abi.encode(
            Function.GET_COUNT,
            int256(0),
            Operation(0),
        ...
        emit DebugEventWithNum("Satellite: getCount() complete", count);
    ...
    function send(
        ...
        emit DebugEventWithNum("Satellite: send() called", int256(msg.value));
        ...
        emit DebugEventWithNum("Satellite: send() complete", int256(msg.value));
    }
    ...
    function lzReceive(
        ...
        emit DebugEvent("Satellite: lzReceive() called");
        (
            int256 count,
        ...
        emit DebugEventWithNum("Satellite: lzReceive() complete", count);
    }
}