...
contract UtherTrunks is MRC1155 {
    ...
    constructor(
        ...
        "Uther Trunks Test",
        "TUT",
        "https://uther-trunks.communitynftproject.io/{id}.json"
    )
    {
    ...
    function Mint(
        ...
        require(amount <= maxPerUser, 'Exceeds per user');
        require(amount + totalSupply(MALE) + totalSupply(FEMALE) <= maxCap, 'Exceeds maxCap');
    ...
    function _beforeMint(
        ...
        require(totalSupply(MALE) + totalSupply(FEMALE) <= MAX_SUPPLY, "Exceeds maxSupply");
    }
