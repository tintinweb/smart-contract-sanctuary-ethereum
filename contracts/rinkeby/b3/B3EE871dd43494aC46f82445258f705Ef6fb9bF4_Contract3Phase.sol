...
contract Contract3Phase is ERC721A, Ownable, ReentrancyGuard {
    ...
    function publicMint(uint256 _quantity) external payable {
        ...
        require(_quantity > 0 && _quantity <= MAX_PER_TX && balanceOf(msg.sender) + _quantity <= MAX_TX, "Invalid mint amount!");
        if (msg.sender != owner()) {
            require(
        ...
        payable
    {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "Sold out!");
        require(_quantity > 0 && _quantity <= MAX_PER_TX && balanceOf(msg.sender) + _quantity <= MAX_WL_TX, "Invalid mint amount!");
