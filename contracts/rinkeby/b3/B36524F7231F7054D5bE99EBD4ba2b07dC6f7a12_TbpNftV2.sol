...
contract TbpNftV2 is ERC721AQueryable, Ownable, ReentrancyGuard {

  // serve para poder usar funções de String em números, por ex, .toString()
  ...
  // calldata é um argumento readonly
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    return bytes(currentBaseURI).length > 0
        // basicamente isso concatena strings
