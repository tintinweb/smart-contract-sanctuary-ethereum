...
//   | $$\  $$ | $$_____/| $$_____/| $$ | $$ | $$| $$  | $$| $$\  $$  /$$__  $$  /$$__/  | $$    //
//   | $$ \  $$|  $$$$$$$|  $$$$$$$| $$ | $$ | $$|  $$$$$$/| $$ \  $$|  $$$$$$$ /$$$$$$$$| $$    //
//   |__/  \__/ \_______/ \_______/|__/ |__/ |__/ \______/ |__/  \__/ \_______/|________/|__/    //
//                                                                                               //
//                                                                                               //
///////////////////////////////////////////////////////////////////////////////////////////////////
...
contract KeemoKazi is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public MAX_ELEMENTS = 3000;
    uint256 public NFTPerAddress = 5;
    uint256 public PRICE = 0.28 ether;
    ...
    event NewNFTPerAddress(uint256 limit);

    constructor(string memory baseURI) ERC721("KeemoKazi", "KK"){
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _tokenAmount) public payable saleIsOpen {
        ...
        require(_tokenAmount <= NFTPerAddress, "Max limit a wallet");
        require(ownWallet[msg.sender] + _tokenAmount <= NFTPerAddress, "Max Wallet limit");
    ...
    function setNFTPerAddress(uint16 _newNFTPerAddress) public onlyOwner{
        NFTPerAddress = _newNFTPerAddress;
        emit NewNFTPerAddress(NFTPerAddress);
    }
