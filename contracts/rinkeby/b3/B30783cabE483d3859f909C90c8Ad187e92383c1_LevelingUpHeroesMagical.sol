...
contract LevelingUpHeroesMagical is BaseFixedPriceAuctionERC721A {
    ...
    function _hashRegisterForWhitelistWithAmount(string memory _prefix, address _address, uint256 amount) internal pure returns (bytes32) {
...
contract BaseFixedPriceAuctionERC721A is ERC721A, ReentrancyGuard, Ownable {
    ...
    function mintReserved(address receiver, uint256 quantity)
        external
        onlyOwner
    {
