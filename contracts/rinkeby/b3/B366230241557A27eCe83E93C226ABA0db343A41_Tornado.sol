...
contract Tornado {
    ...
    // uint256 constant START_EPOCH = 210555; //for 0xBTC contract on mainnet
    //contract address 0xb6ed7644c69416d67b522e20bc294a9a9b405b31
    
    uint256 constant START_EPOCH = 3740; //for testnet 0xBTC contract on rinkeby fail
    // uint256 constant START_EPOCH = 374; //for testnet 0xBTC contract on rinkeby pass
    //address 0x244aA29426fb6524760bD9AcbB66ad53C5EB32CA  
    ...
    function mint(uint256 amount) external {    
        require(IERC918(mineableToken).epochCount() >= START_EPOCH,     "sale not started");
