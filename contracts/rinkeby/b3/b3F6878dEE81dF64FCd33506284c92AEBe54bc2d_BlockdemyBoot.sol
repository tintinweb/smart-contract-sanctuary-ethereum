    ...
    PaymentSplitter 
{
    ...
    uint256 _price = 15000000000000000; // 0.015 ETH
    ...
    address[] private _team = [
       0x086242c22dFcea2C65c678e1Bc29754FEC427f98, // Admin Account gets 50% of the total revenue
       0x8492d1B3d2aa49cAba5488b86Ded68c1ecDbA5b4, // Test Account gets 20% of the total revenue
       0x2Ec5681B702b632ACA5Cdcf3d1399D13a4dc2dbB // VIP Account gets 30% of the total revenue 
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("BlockBoot", "BBoot")
