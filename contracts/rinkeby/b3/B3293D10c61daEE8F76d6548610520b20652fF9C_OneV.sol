 ...
 */
contract OneV is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable {
    // for whitelist server signatures
    ...
    // max total supply oneV's
    uint256 public constant supplyLimit = 25;
    // max whitelist supply oneV's
    uint256 public constant whitelistSupplyLimit = 10;
    // max mints per whitelisted address
    uint256 public constant maxWhitelistMintAmount = 3;
    // max public sale mints per address
    uint256 public constant maxPublicSaleMintAmount = 5;
    ...
    function initialize() initializer public {
        ...
        saleState = 1;
        cost = 0.12 ether; // 120000000000000000 Wei
        supply = 0;
        adminWalletAddress = 0xE7559cF3e8868A12De5d3C728B58ecb83830d5f2;
        _nextTokenId = 0;
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://ipfs.io/ipfs/bafkreifkigqejtkz4aknfzh5a2lv4wzagrdgqt6yxmlogwwu752xkam2g4";
    }
    ...
    function enableWhitelistState() public {
        saleState = 0;
        cost = 0.11 ether;
    }
    ...
    function enablePublicSaleState() public {
        saleState = 1;
        cost = 0.12 ether;
    }
    ...
    function publicMint(uint8 numberOfTokens) public payable _requirePublicSaleState {
        ...
        require(
            ...
            "You may mint up to 5 NFTs on the public list sale."
        );
