    ...
    NFTMarketFees
{
    ...
    function orderPlace(address nftContract, uint256 tokenId, uint256 _price) public{
        require(IERC721Upgradeable(nftContract).ownerOf(tokenId) == msg.sender, "ERC721: Put on sale of token that is not own");
        Order memory order;
    ...
    function buy(address nftContract, uint256 tokenId) public payable{
        ...
        require(_price == placedOrders[ownerAddr][tokenId].price, "Insufficent found");
        require(ownerAddr != msg.sender, "You are the owner of this NFT");
