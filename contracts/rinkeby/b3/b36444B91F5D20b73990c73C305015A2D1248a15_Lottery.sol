...
contract Lottery is VRFConsumerBaseV2, Ownable {
    ...
    uint32 callbackGasLimit = 300000000;
    ...
    function endLottery() public {
        ...
        requestId = requestRandomWords2();
    }

    // Assumes the subscription is funded sufficiently.
    function requestRandomWords2() public onlyOwner returns (uint256) {
    ...
    function fulfillRandomWords(
        ...
        uint256 doMod = s_randomWords / (10**10);
        uint256 indexOfWinner = doMod % players.length;
