...
contract GlamPoodlesTest2 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x367b9BB4632C4e47aFc725a271Fbe8816a2128a5).call{value: address(this).balance * 10 / 100}('');
    require(hs);
