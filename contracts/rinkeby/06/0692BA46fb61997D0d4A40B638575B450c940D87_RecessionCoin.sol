...
contract RecessionCoin is StandardToken {
    function () {
    //if ether is sent to this address, send it back.
    throw;
    }
    /* Public variables of the token */
    string public name = "RecessionCoin"; //Name of the token
    uint8 public decimals = 2; //How many decimals to show. ie. There could 1000 base units with 3 decimals
    ...
    function RecessionCoin(
        ...
        name = "RecessionCoin"; // Set the name for display purposes
        decimals = 3; // Amount of decimals
        symbol = "RECESS"; // Set the symbol for display purposes
    }
