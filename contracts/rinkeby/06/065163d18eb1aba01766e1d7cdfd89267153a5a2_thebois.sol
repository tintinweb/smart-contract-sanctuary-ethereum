...
contract thebois is ERC721, Ownable {
  ...
  constructor(
    ...
    string memory _initBoiTownUri
  ) ERC721(_name, _symbol) {
    setBoiURI(_initBoiURI);
    setBoiTownURI(_initBoiTownUri);
  }
  ...
  function setBoiTownURI(string memory _BoiTownURI) public onlyOwner {
    BoiTownUri = _BoiTownURI;
  }
