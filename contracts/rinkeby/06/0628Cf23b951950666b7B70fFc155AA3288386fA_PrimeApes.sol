...
contract PrimeApes is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable RESERVE_AMOUNT = 150;

    uint256 public PRICE = 0.055 ether;

    uint256 public OG_MAX = 2;
    uint256 public PRESALE_MAX = 5;
    uint256 public PUBLIC_MAX;
    ...
    //@dev Check that the notice was signed by our enforcer address
    ...
    function presaleMint(uint256 quantity, Notice memory notice) external payable callerIsUser verifyPayment(quantity){
        ...
        require(numberMinted(msg.sender) - numberMintedFE(msg.sender) + quantity <= PRESALE_MAX, "Max of 2 PPAs during First Edition Mint!");
