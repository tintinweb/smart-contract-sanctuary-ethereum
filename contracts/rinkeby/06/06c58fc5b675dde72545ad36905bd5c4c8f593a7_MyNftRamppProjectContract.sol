...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x63dA92Ed27F288260d506fcB6E64997bEFdC56ef];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfBVBikCk3rS8W8WGAztaVXgdztcu8HgDvBUAf3FfTEdZ/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/JWxsJVmQ0qzsanOJcytJ/contract-metadata";
    }
}
