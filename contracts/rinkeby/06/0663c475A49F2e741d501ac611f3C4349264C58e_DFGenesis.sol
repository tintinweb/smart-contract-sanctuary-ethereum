...
contract DFGenesis is ERC721A, Ownable, ReentrancyGuard, ProxyRegistry {
  ...
  function isApprovedForAll(address owner, address operator) override public view returns (bool) {
    ...
    function withdraw() external onlyOwner nonReentrant{
        //8% sent in total to team, 5% sent to MNFT
        uint256 withdrawAmount_2 = address(this).balance * 2/100;
        uint256 withdrawAmount_5 = address(this).balance * 5/100;
        payable(0xEF2516Da8c41296c5A1910cb582f4D7312c3Dc95).transfer(withdrawAmount_2);
        payable(0x5bE7215E8F890872ef925baE7Ea60BCf0b7BF656).transfer(withdrawAmount_2);
        payable(0xA352Fc712e5aEc5e38E3E7F34968D74c28E989c7).transfer(withdrawAmount_2);
        payable(0xda4E0cC9C55Be015Ce799E80cCf8960A98C994dC).transfer(withdrawAmount_2);
        payable(0x2d8BF72C9b731E455F27b06570FD4962f4C01559).transfer(withdrawAmount_5);
