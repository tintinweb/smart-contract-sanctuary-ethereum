...
interface IERC721 is IERC165 {
    ...
    function tokensOfOwner(address owner) external view returns (uint256[] memory); //# dvda token ids
...
contract RottenBananos is ERC1155, Ownable {
    ...
    // Mappings
    mapping(uint256 => bool) public dvdaTokenIDBlacklisted; //DVDA TOKEN BLACKLISTED TO NOT MINT IN WL (PAPERHAND)
    mapping (uint256 => bool) public AlreadyClaimedDVDA; //DVDA TOKEN CLAIMED


    IERC721 DVDA = IERC721(0xBbeEf64AB0EE1b4ec13DF6259ADa8417ecCf360A); //rinkeby
    IERC721 GHN = IERC721(0xAc193170027F642aaE45d0F3CfcB11A42f150606); //rinkeby
    IERC1155 BNNO = IERC1155(0xA003F59C2BBF9fE5cAD5Ab5512f1b2771B378614);//rinkeby
    IERC721 AHC = IERC721(0x2f66585d9644565236A5f611114E1e2CeD4eE582);//rinkeby

    
    //DVDA contract 0xC084a29DD0C9436568435938B1C6c5af4F5C035f (ETH)
    //GODHATES contract 0xE6d48bF4ee912235398b96E16Db6F310c21e82CB (ETH)
    // BANANO contract 0x50BEfFd8A0808314d3cc81B3cbF7f1AFA3A6B56c (ETH)
    // APEHATERCLUB contract 0x9370045CE37F381500ac7D6802513bb89871e076 (ETH)
   ...
   function MintAdmin(uint256 amount) external onlyOwner  {
    ...
    function withdrawMoney() external onlyOwner {
     ...
     function withdrawMoneyTo(address payoutAddress) public payable onlyOwner {
