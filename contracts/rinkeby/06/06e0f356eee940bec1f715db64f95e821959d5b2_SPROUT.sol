...
contract SPROUT is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 8588;
	uint256 public GIVEAWAY_NFT = 300;
    ...
    constructor() ERC721P('Sprout House', 'SPROUT') {}
