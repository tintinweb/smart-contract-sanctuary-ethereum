...
contract Playfuldegens is Ownable, ERC721A {
    uint256 public constant PRICE = 0.001 ether;            // Price of the single degens
    uint256 public constant MAX_MINT_SIZE = 10;             // Max degens allowed in one mint
    uint256 public constant MAX_MINTS = 40;               // Maximum degens count
    uint256 public constant MAX_TOKENS_PUBLIC_MINT = 30;  // Maximum degens count for public sale
    uint256 public RESERVED_MINTS_AVAILABLE = 10;          // Reserved degens count
    ...
    bool public isPreSaleActive = false;             //Sale for whitelisted accounts only
    ...
    //Main Mint function which is used to mint the degens for whitelisted accounts
    function claimPreSaleToken(uint256 numberOfTokens) public payable {
        ...
        //validation to check per wallet degens
