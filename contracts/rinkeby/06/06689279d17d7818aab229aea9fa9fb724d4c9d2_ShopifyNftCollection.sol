...
*/
contract ShopifyNftCollection is ERC1155, Ownable, ERC1155Metadata_URI {
    bytes4 private constant INTERFACE_SIGNATURE_URI = 0x0e89341c;
    string _contractUri;
    string _baseUri;

    constructor(string memory contractUri, string memory baseUri) public {
        ...
        returns (uint256 firstTokenId)
    {
        ...
        uint256[] memory _ids = new uint[](_tokensCount);
