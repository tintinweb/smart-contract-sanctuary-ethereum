...
contract RoyalGorillas is ERC721A, Ownable {
    //  Contracts
    ...
    address private constant creator2Address =
        0x1eA3A4f1b89F3aDA30e7110e87b74a58fC1D33c3;
    address private constant creator3Address =
        0xA286fee51f2FAAdDC79f921AaF8a559BBa77ce66;

    // Jungle Bank
    address public constant JUNGLE_BANK =
        0x423c8646C235b08d8578A4Ec9B78DA589097Aa08;

    // Minting Variables
    uint256 public maxSupply = 8888;
    uint256 public mintPrice = 0.22 ether;
    uint256 public mintJungleCoinPrice = 450 ether;
    ...
    // Contract
    constructor(address jungleTokenAddress) ERC721A("The Royal Cubs", "TRC") {
        ...
        payable
    {
        ...
        require(
            mintCounts[msg.sender] <= maxRafflePurchase,
    ...
    function mintWithJungle(uint256 _count) external payable {
        require(publicSaleActive, "Sale must be active");
        require(_count <= maxPurchase, "exceeds maximum purchase amount");
        require(
            balanceOf(msg.sender) + _count <= maxPurchase,
    ...
    function claim(uint256 _count, bytes32[] calldata _proof) external {
    ...
    function setMintJungleCoinPrice(uint256 _mintJungleCoinPrice)
        external
        onlyOwner
    {
