...
function claimAllowedForTokens (uint256[] calldata _claimingTokenIDs) public returns (bool){
     bool hasClaim = true;
...
function claimAllowedForToken (uint256 _claimingTokenID) public returns (bool){
