...
contract DynamicNft is AccessControl, IDynamic {
    ...
    uint256 public genesisPrice = 2000;
    uint256 public subscriptionPrice = 1000;
    ...
    function mintGenesis(address _to, bytes32[] calldata _merkleProof) public payable {
        ...
        require(msg.value >= genesisEthPrice, "INSUFFICIENT MINTING VALUE");
        ...
        genesisHolder[_id] = Genesis({tokenId: _id, owner: _to, ethPayed: msg.value});
    ...
    function cap3TreasuryFundShare(uint256 _amount) internal {
        ...
        // _setTreasuryLimit(newLimitInEth);
