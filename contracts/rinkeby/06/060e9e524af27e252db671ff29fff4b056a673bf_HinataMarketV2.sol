    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        require(
            hinataStorage_ != address(0),
            "MarketV2: INVALID_HINATA_STORAGE"
        );
    ...
    function setAcceptPayToken(address _payToken, bool _accept)
        external
        onlyOwner
    {
    ...
    function setMarketFee(uint256 _marketFee) external onlyOwner {
        require(_marketFee <= 10000, "MarketV2: INVALID_FEE");
    ...
    function _acceptPayment(
        ...
        if (fee > 0) {
            IERC20Upgradeable(payToken).safeTransferFrom(buyer, feeTo, fee);
        }
