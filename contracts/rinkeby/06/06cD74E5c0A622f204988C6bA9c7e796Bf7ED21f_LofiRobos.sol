...
contract LofiRobos is Ownable, ERC721A {
    using Strings for uint256;

    uint256 public immutable maxSupply = 70; //4000
    uint256 public immutable maxFreeSupply = 50; //250
    uint256 public maxTokensPerTx = 10;
    uint256 public price = 0.005  ether;

    uint32 public saleStartTime = 1650092400; // 1651154400
    ...
    function freeMint(uint256 quantity) external {
        ...
        require(quantity > 0 && quantity <= maxTokensPerTx, "sale transaction limit exceeded");
        uint256 remaining = remainingFree();
        ...
        emit MintedFree(msg.sender, remainingFree());
    }
    ...
    function remainingFree() public view returns(uint256) {
        return (maxFreeSupply - totalSupply());
    }
