...
contract CryptoNight is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 7777;
    uint256 public TEAM_MINT_MAX = 277;
    ...
    address public teamWallet = 0xa65F2EA58488ad486e18050235Fe70a9245b3f12;

    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("CryptoNight", "CN") { }
