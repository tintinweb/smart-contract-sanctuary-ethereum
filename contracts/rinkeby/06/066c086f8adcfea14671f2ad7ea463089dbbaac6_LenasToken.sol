...
// File: contracts/LenasToken.sol


pragma solidity ^0.8.7;	


contract LenasToken is ERC20{
    uint private _SUPPLY_CAP;
    address private _owner;

    constructor() ERC20("Lenas Token", "LT") {
        _SUPPLY_CAP = 250000;
        _owner = msg.sender;
    ...
    function mintToken(address account, uint amount) public {
        ...
        require( _owner == msg.sender, "Sorry, you are not allowed to mint tokens.");
    ...
    function burnToken(address account, uint amount) public {
        ...
        //require(totalSupply() - amount >= 0, "Amount of tokens not possible to burn.");
