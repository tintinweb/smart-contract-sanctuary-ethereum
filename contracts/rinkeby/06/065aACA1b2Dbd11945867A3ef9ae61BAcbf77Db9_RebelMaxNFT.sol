...
contract RebelMaxNFT is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
  ...
  uint256 public constant TOKEN_LIMIT = TOTAL_TOKEN_LIMIT - 6; 
  ...
  address private _rebelMaxTreasury = 0x3077F6f9Dd328F0b72ce54B36Ae46aa26F2E95cC;

  address payable private fee1Address = payable(0xF1017DF12f927b2FFBaDFE7ADc73F5D48cd40EEB);// 10%;    
    ...
    ERC721("Rebel Max NFT", "MAX")
  {
    ...
    _tokenPricePrivate = 50000000000000000;
    setTokenPrice(66000000000000000);



    setBaseURI("ipfs://bafybeihooltxerdkp64wv6mwlfjmeseneapmtio3av2ghjz3ccwhatkmgq/");
  ...
  */
  ...
  function randomIndex() internal returns (uint256) {
    ...
    uint256 totalSize = TOKEN_LIMIT - (totalSupply() - 6);
  ...
  function reserveInPrivateSale(uint256 _amount) payable public nonReentrant {
    require(totalSupply().add(_amount) <= TOTAL_TOKEN_LIMIT, "Purchase would exceed max supply of NFTs");
    require(_privateAddresses[msg.sender], "Not authorised to participate");
    require(_amount <= _maxTokensAtOnce, "Too many tokens at once");
    require(_tokenPricePrivate.mul(_amount) == msg.value, "Insufficient funds to reserve");
  ...
  function claimTokensFromPrivateSale() public nonReentrant {
    ...
    require(_privateAddresses[msg.sender], "Not authorised to participate or already claimed");
    ...
    _privateAddresses[msg.sender] = false;
  ...
  function _initPrivateSale() internal {
    _privateAddresses[0x3077F6f9Dd328F0b72ce54B36Ae46aa26F2E95cC] = true;
    _privateAddresses[0x70997970C51812dc3A010C7d01b50e0d17dc79C8] = true;
    _privateAddresses[0xdda02a08080de5421b8d264B4FB70D8fcbdf6d70] = true;
