...
contract BruneSauvageStudio is ERC20, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor()
        ERC20("Brune Sauvage Studio", "BRS")
        ERC20Permit("Brune Sauvage Studio")
    {
