...
contract DecaWithTestToken3 is VRFConsumerBaseV2, Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 minBet = 1;
    uint256 betAmount = 1;
    uint256 public calculatedFee = 1;
    ...
    function claimTreasury(uint256 _amount) external onlyTreasury nonReentrant {
        ...
        treasuryPoolBalance.withdrawAmount.add(_amount);
    ...
    function fulfillRandomWords(
        ...
        uint256 _fee = betAmount * fee  / 100;
        treasuryPoolBalance.depositAmount += _fee;
//        uint256 winMoney = betAmount;
//        if (userWon) {
//            userBankRollBalance[msg.sender].depositAmount += winMoney;
//            housePoolBalance.depositAmount -= winMoney;
//        } else {
//            userBankRollBalance[msg.sender].depositAmount -= winMoney;
//            housePoolBalance.depositAmount += winMoney;
//        }
    ...
    function handleFee(uint256 amount) external {
