// SPDX-License-Identifier: MIT
    ...
    contract BeardedBuddies is 
        ...
        /** Events **/
        event BeardedBuddyGenerated(uint256 requestbeardedBuddyId);
        event ethWithdrawn();
        event createdBeardedBuddy(string message);
        ...
        /*
            Public function for creating a new Bearded Buddy.
        */
        function requestCreation(uint32 _numberOfBeardedBuddies ) public payable {
            ...
            require(_numberOfBeardedBuddies <= maxMint, "you cant mint that many bearded buddies at once");
            
            for(uint i = 0; i < _numberOfBeardedBuddies; i++) {
                if (totalSupply() < maxSupply) {
                generateBeardedBuddy();
                emit createdBeardedBuddy("Bearded Buddy has been minted");
                }
            }

        }
        function safeMint(address to, string memory uri, uint256 _tokenId) internal {
    ...
    /*
        Returns the BeadedBuddies's DNA
    */
        function getBeardedBuddyDNA(uint256 tokenId) public view returns (uint256) {
            return (
            beardedBuddies[tokenId].dna
            );
        }
        ...
        */
        function fulfillRandomWords(    
            ...
            // Should I use .json here?
            string memory newTokenURI =  string.concat(Strings.toString(tokenId), ".js");
         ...
         * @notice             For the given token ID, retrieve the random number and break it down into a BeardedBuddy
         */
	    function generateBeardedBuddy() public onlyOwner {
            ...
            emit BeardedBuddyGenerated(requestId);
        ...
        * @param wallet       the address that will be requested to view the limit
        * @return MINT_LIMIT  returns the mint limit depending on the whitelist tier
         */
