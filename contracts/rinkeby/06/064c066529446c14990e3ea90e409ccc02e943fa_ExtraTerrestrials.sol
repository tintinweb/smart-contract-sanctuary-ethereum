...
contract ExtraTerrestrials is ERC721r, Pausable, Ownable {
    ...
    constructor() ERC721r("Extra Terrestrials", "ETW", MAX_SUPPLY) {}
     ...
     function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmRT9TsLRV76dvaVZXHWBZNvFYpJAqJSjUb8TX1AmT8dXg";
    }

    function mint(uint _quantity) public payable whenNotPaused {
        uint256 total = totalSupply();
        require(total + _quantity <= MAX_SUPPLY, "Extra Terrestrials :: Invalid Amount!");
