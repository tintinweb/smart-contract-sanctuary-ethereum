...
contract OctavMembershipBeta is ERC721A, Ownable, ReentrancyGuard {
    address constant USDC_ADDRESS = 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926; //0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 MAINNET
    address constant DAI_ADDRESS = 0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa; // 0x6B175474E89094C44Da98b954EedeAC495271d0F MAINNET
    ...
    constructor() ERC721A("OctavBeta", "OCTB") {
        saleConfig.usdcPrice = 250000000; //todo
        saleConfig.daiPrice = 250 ether; //todo
        saleConfig.maxSupply = 100; //todo
        saleConfig.startTime = 1664596800; // todo october 1
        saleConfig.endTime = 1675227600; //todo feb 1
    }
