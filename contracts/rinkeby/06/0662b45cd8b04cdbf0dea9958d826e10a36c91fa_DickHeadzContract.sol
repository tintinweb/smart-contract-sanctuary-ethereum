...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 420 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYEdtKmqEZE99j4s4yfEC1amuJuBMKwb4TzF7Wyetqcbd/";
...
// File: contracts/DickHeadzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DickHeadzContract is RamppERC721A {
    constructor() RamppERC721A("DickHeadz", "DCKHDZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ip80FgNvbc09oRUfCWlz/contract-metadata";
    }
}
