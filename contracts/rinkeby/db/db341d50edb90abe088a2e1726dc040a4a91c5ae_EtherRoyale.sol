...
contract EtherRoyale is ERC721A, Ownable, ReentrancyGuard {
    ...
    bytes32 public presaleMerkleRoot = 0xbdbb20452ec30f66000b1b5d3650eb90f862d1b9044f5bfba8ea34d4fe63be9a;
    ...
    function withdraw() public onlyOwner {
        ...
        (bool trags, ) = payable(0xea068799096AfE357BC6bc999531751F365e24f0).call{value: tragv}("");
        require(trags);

        uint256 balance = address(this).balance;
        payable(0x51f2F9B6b76fB255f2D089Efaf33a44E3e0Ce1F0).transfer(balance);
    }
