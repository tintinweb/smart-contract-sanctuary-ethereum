...
contract KOC2 is ERC721, EIP712, Ownable{
    ...
    function mint() external payable {
      ...
      require(runningSupply < MAX_SUPPLY, "NFT: Cannot mint more!");
    ...
    function claimNFT(bytes calldata _signature, uint256 _nftIndex) external {
      ...
      require(_verify(_hash(msg.sender, _nftIndex), _signature, false), "NFT: Invalid Claiming!");
    ...
    function claimWhitelistSale(bytes calldata _signature, uint256 _nftIndex) external payable{
      ...
      require(_verify(_hash(msg.sender, _nftIndex), _signature, true), "NFT: Invalid Claiming!");
