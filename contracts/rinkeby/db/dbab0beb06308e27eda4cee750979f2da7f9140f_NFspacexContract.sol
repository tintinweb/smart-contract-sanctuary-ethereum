...
//
//     _   ________                                 
//    / | / / ____/________  ____ _________    _  __
//   /  |/ / /_  / ___/ __ \/ __ `/ ___/ _ \  | |/_/
//  / /|  / __/ (__  ) /_/ / /_/ / /__/  __/ _>  <  
// /_/ |_/_/   /____/ .___/\__,_/\___/\___(_)_/|_|  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xcfDd56E14F0CC78251bccB0AcA933801C996D26A];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmX1ZeoQRHGbuCYadktj5gwvGr2U8ev7nSQt2yDiFXQXV8/";
...
// File: contracts/NFspacexContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NFspacexContract is RamppERC721A {
    constructor() RamppERC721A("NFspacex", "nfxpaceX"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wcFzcYjB1sTRdEaaJia6/contract-metadata";
    }
}
