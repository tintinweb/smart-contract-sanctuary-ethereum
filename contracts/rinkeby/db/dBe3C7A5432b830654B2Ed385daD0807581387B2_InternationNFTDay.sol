...
contract InternationNFTDay is ERC721A, ReentrancyGuard {
    address owner;
    uint256 _tokenIds = _startTokenId();

    bool public publicMintActive = false;
    bool public burnProfileActive = false;
    uint64 public maxSupply = 2009;
    string public baseURI;
    uint256 private currentSupply = 1;
    ...
    constructor() ERC721A("Happy International NFT Day", "NFT-DAY") {
    ...
    function mintNft() public {
        ...
        require(
            balanceOf(_msgSenderERC721A()) < 1,
            "Max limit is only one per User"
        );
        ...
        _safeMint(_msgSenderERC721A(), itemId);
