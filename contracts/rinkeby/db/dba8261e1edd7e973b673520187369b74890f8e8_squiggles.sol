...
contract squiggles is protected, smart {
    ...
    function propose(bytes32 name, bytes32 side_1, bytes32 side_2,
                     bytes32 url_1, bytes32 url_2, bytes32 url_description) public safe {
    ...
    function get_description(bytes32 name) public view returns(bytes32 description) {
