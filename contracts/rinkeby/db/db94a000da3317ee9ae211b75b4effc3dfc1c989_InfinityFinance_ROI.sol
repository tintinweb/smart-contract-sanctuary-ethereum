...
contract InfinityFinance_ROI {
    ...
    constructor() {
        ...
        uint16 tarifPercent = 1200;
        for (uint8 tarifDuration = 80; tarifDuration <= 200; tarifDuration++) {
            tarifs[tarifDuration] = Tarif(tarifDuration, tarifPercent);
            tarifPercent+= 1;
        }

        POTENT = IERC20(0x69D6495CA68484a0664C676Cd2d021Cf0F15fcb9);
    }
    ...
    function deposit(uint8 _tarif, address _upline, uint256 amount) external {
        ...
        require(amount >= 5 ether, "Minimum deposit amount is 5 POTENT");
