...
contract  AllFunctionsContract  is ERC721Enumerable, Ownable
{
    ...
    address public royalties = 0x61a192f8B39c33a6368fBcDCeb9865D5b3eFb93D;
    ...
    constructor(string memory baseURI) ERC721("Naked Metas", "METAS")  {
        setBaseURI(baseURI);
    }
    ...
    function mintById(uint _tokenid) public payable{
        require(isPaused == false, "Sale is not active at the moment");
        require(_tokenid > 0 && _tokenid < maxSupply, "Token ID invalid");
    ...
    function withdrawWithRoyalties() public onlyOwner {
        uint totalbalance = address(this).balance;
        uint256 ownerBalance = totalbalance * 95 / 100;
        uint256 royatiesBalance = totalbalance * 5 / 100;
        payable(msg.sender).transfer(ownerBalance);
        payable(royalties).transfer(royatiesBalance);
    }
