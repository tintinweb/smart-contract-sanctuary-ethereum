...
contract DopAirdrop is IAirdrop, Ownable {
    ...
    function getRemainAddresses() external view returns(uint256) {
        return remainAddresses;
    }

    function getRemainDops() external view returns(uint256) {
        return remainDops;
    }
    ...
    function claim(uint256 amount, bytes32[] calldata merkleProof, uint256 comptrollerIndex, uint256 cTokenIndex) external override {
