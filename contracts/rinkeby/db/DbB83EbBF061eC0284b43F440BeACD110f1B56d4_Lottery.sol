...
contract Lottery is AccessControl, ReentrancyGuard, RequestValidator {
    ...
    modifier entryChecks(uint256 _numberOfEntries, uint256 _expiryTime) {
    ...
    modifier verifyPurchaseRequest(
        uint256 _numberOfEntries,
        uint256 _expiryTime,
        bytes memory _signature
    ) {
    ...
    constructor() {
        ...
        operator = 0xa0274B3f6D61Ba4188Af7D938666Cf4b048ceFFA;
        defaultAdmin = 0xAE2573d714D4df7DB925776aCF90065BBc12531A;
        Ammolite = ERC20(0xA755E32F785AC02e48604a59a1e855965aba00d0);
    ...
    function enterDraw(
        ...
        external
        nonReentrant
        entryChecks(_numberOfEntries, _expiryTime)
        verifyEntryRequest(
            _lotteryId,
            _numberOfEntries,
            _expiryTime,
