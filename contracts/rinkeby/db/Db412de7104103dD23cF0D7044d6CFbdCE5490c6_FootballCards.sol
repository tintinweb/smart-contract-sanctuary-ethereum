...
contract FootballCards is ERC721, VRFConsumerBase, Ownable {
    ...
    playerCard[] public players_array;
        ...
        override
    {
        ...
        uint256 speed = (randomNumber % 30) + 60;
        uint256 acceleration = ((randomNumber / 1000) % 30) + 60;
        uint256 pass = ((randomNumber / 1000000) % 30) + 60;
        uint256 shooting = ((randomNumber / 1000000000) % 30) + 60;
        uint256 defence = ((randomNumber / 1000000000000) % 30) + 60;
        uint256 control = ((randomNumber / 1000000000000000) % 30) + 60;
