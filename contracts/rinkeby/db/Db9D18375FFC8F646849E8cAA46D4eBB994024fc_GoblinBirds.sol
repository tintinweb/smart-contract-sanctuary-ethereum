...
contract GoblinBirds is ERC721A, Ownable {
    ...
    uint256 public freeGB;
    uint256 public maxPerTxn = 100;
    uint256 public wL = 3000;
    ...
    function mint(uint256 count) public payable {
        ...
        require(totalSupply() + 1  > freeGB, "Free mint !");
    ...
    function freemint() public payable {
        require(totalSupply() + 1 <= freeGB, " not free now");
        require(!walletCount[msg.sender], " max 2 free mint");
        if ( totalSupply() >= (wL + 200) )
        { 
    ...
    function setfreeGB(uint256 _newfreeGB) public onlyOwner {
        freeGB = _newfreeGB;
    }
