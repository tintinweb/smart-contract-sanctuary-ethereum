...
// File: contracts/SammiesClub.sol
...
pragma solidity ^0.8.15;
	...
	contract SammiesClub is ERC721A, Ownable, ReentrancyGuard {
	...
	function mint(bytes32[] memory _proof, uint256 quantity) external payable nonReentrant {
		require(
	...
	function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address, uint256 royaltyAmount) {
		...
		royaltyAmount = (_salePrice / 100) * 8;
