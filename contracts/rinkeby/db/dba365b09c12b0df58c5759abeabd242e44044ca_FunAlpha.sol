...
contract FunAlpha is ERC1155, Ownable, ERC1155Supply, ReentrancyGuard {
    ...
    uint16 public maxSupply = 655;
    uint16 public maxFree = 222;
    ...
    constructor() ERC1155("ipfs://QmerHKcZLVTxN3Y7S7P2vo2XfN7dGHZnYDQcsrvubvHJKM") {
        ...
        freeMintTrees[1] = 0xa64f5203aad325de97620da01755677260166452b2c1b342046f71a9488ec5fc;
    ...
    function mint(bytes32[] calldata _merkleProof) public payable nonReentrant {
        ...
        if (saleActive) { 
            ...
            require(paidSupplyLeft > 0, "FunPass: Exceeds available supply.");
    ...
    function freeMint(uint8 _count, bytes32[] calldata _merkleProof) public nonReentrant {
        ...
        require(freesaleActive, "FunPass: The free mint has not started.");
        //Check allowed to mint the requested amount.
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, freeMintTrees[_count], leaf), "FunPass: Invalid proof (not on whitelist?).");
        //Check not already claimed.
        require(!_freeMinted[msg.sender], "FunPass: You have already claimed your free mint.");
        //Check remaining supply. Shouldn't fail ever.
        require(freeSupplyLeft > 0, "FunPass: There is insufficient remaining free supply.");
