...
contract AQONE1 is ERC721Enumerable, ReentrancyGuard, Ownable {
    
    uint256 public price = 100000000000000000; //0.1 ETH

    constructor() ERC721("AQONE1", "AQONE1") {}
