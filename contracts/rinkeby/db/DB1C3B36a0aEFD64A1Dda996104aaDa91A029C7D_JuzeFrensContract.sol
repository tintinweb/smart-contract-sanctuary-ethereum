...
//*********************************************************************//
//
// #       _ _   _ _______   ___ ___ ___ _  _ ___ 
// #    _ | | | | |_  / __| | __| _ \ __| \| / __|
// #   | || | |_| |/ /| _|  | _||   / _|| .` \__ \
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1655555520;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB70B9da6f63a906d411BdA1f4E10A0f77bADC962];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://ipfs://QmcLPQUsJNFauoDB1xkBGqEB2o25p8sSdV3mFNZg2pJg3J//";
...
// File: contracts/JuzeFrensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JuzeFrensContract is RamppERC721A {
    constructor() RamppERC721A("Juze Frens", "JuzFr"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/CstGRU6QyXD43yfOUz2G/contract-metadata";
    }
}
