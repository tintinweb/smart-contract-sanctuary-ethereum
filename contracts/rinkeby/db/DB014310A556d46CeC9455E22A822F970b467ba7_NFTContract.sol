...
contract NFTContract is ERC721, Ownable, PullPayment {
  ...
  function buyMint(address recipient) public payable {
    require(buyTokenId <= 1000, "Max buy supply reached");
  ...
  function ownerMints() public onlyOwner {
    require(ownerTokenId <= 2000, "Max owner supply reached");

    for (uint256 i = ownerTokenId; i < 2000; i++) {
