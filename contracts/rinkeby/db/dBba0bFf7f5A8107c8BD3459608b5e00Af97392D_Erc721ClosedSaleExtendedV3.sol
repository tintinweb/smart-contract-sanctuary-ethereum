...
///        The Owner will be able to protect the integrity of the project by being able to pause Transfer of Tokens.

contract Erc721ClosedSaleExtendedV3 is Erc721ClosedSaleV3 {
  constructor(ClosedSaleParams memory params_) Erc721ClosedSaleV3(params_) {}
}
...
abstract contract Erc721SaleV3 is Erc721BaseV3 {
...
contract Erc721ClosedSaleV3 is Erc721BaseV3 {
    ...
    */
    function addPayoutSplitter(uint96 totalRoyalty_, address[] memory payees_, uint256[] memory shares_) 
        ...
        PayoutSplitterV3 payoutSplitter = new PayoutSplitterV3(
            payees_,
            shares_
        );
