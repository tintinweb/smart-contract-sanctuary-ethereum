...
uint256 private counter_minted_per_event; // How many tickets have been minted for the specific event ID
...
//https://gateway.pinata.cloud/ipfs/QmWWduVRyPCFxfxo3DKReKoSqQnSuvWx4LzGpZqer2Xk6r/1.jpg
...
function IsTicketForSale(uint256 Ticketid) external view 
    ...
    {   
        require (Ticketid <= Event_ID*1000 + counter_minted_per_event, 'This ticket has not been minted!');
        if (tickets_for_sale[Ticketid].price > 0 ) forsale = true;
        else forsale = false;
