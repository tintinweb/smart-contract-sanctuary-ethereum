...
uint256 constant SECONDS_IN_DAY = 86400; // 24 * 60 * 60
    ...
    ERC2771ContextUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        _checkSignatureValidity(_newMemberAddr, _hash, _signature, 1); // must be new member
        ...
        whenNotPaused
    {
        ...
        require(_apr < PPT_DIVISOR, "Community::invalid apr");
        ...
        isPublishedToCommunity(_communityID, _project)
    {
        ...
        uint256 _lenderFee = (_lendingAmount * _projectInstance.lenderFee()) /
            (_projectInstance.lenderFee() + PPT_DIVISOR);
        ...
        _currency.safeTransferFrom(_sender, homeFi.treasury(), _lenderFee);

        // Transfer _amountToProject to _project from lender account
        _currency.safeTransferFrom(_sender, _project, _amountToProject);
        ...
        whenNotPaused
    {
        ...
        // check signatures
        _checkSignatureValidity(_lender, _hash, _signature, 0); // must be lender
        _checkSignatureValidity(_builder, _hash, _signature, 1); // must be builder
        _checkSignatureValidity(_agent, _hash, _signature, 2); // must be agent or escrow
    ...
    {
        uint256 _memberCountLength = _communities[_communityID].memberCount;
        ...
        )
    {
        ...
        uint256 _noOfDays = (block.timestamp -
            _communityProject.lastTimestamp) / SECONDS_IN_DAY;
