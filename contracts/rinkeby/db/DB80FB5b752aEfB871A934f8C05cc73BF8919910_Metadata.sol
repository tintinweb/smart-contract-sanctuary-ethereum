...
contract Metadata is AccessControl {
    ...
    address public storageAddr = 0x9be0136247771abb869b4B2BF5062b9d7Baa7E12; // rinkeby
    address public namesAddr = 0xe3BdC2943a2F3F035191BE0353591446b25B66AD;//rinkeby
    ...
    struct Metadata {
      ...
      string image_full_uri;
      string image_full_extension;
      string image_s3;
      string image_full_s3;
      address fee_recipient;
      uint seller_fee_basis_points;
    }
...
// constructor
    ...
    constructor() {
      ...
      Metadata memory _metadata = Metadata({
        ...
        image_base_uri : "ipfs://QmafmyYdhY6SgFZEQgqdJR7uuaNR8QWbkkSFfdwENi5rjm",
        image_extension : ".jpg",
        image_full_uri : "ipfs://add-ipfs-address/",
        image_full_extension : ".png",
        image_s3 : "https://regulars-nft.s3.eu-west-1.amazonaws.com/med/med_cc_0001.jpg",
        image_full_s3 : "https://regulars-nft.s3.eu-west-1.amazonaws.com/full/fullRes_cc_0001.png",
        fee_recipient : 0xBfa535720AE2E08860597d4E4bd8D0f72A4337C8,
...
// View
    ...
    function getMetadataJson(uint256 tokenId) public view returns (string memory){
      ...
      string memory name = bytes(customName).length > 0 ? 
          customName : string(abi.encodePacked(metadata.name, " #",tokenId.toString()));
      ...
      string memory part2 = string(
        abi.encodePacked(
          '\n,"image": "', metadata.image_base_uri, tokenId, metadata.image_extension,
          '\n, "seller_fee_basis_points" : "', metadata.seller_fee_basis_points,
          '\n, "fee_recipient" : "', metadata.fee_recipient
        )
      );

      string memory meta = string(abi.encodePacked(part1, part2));
