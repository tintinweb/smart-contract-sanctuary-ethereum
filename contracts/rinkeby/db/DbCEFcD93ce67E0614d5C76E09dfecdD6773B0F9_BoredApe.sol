...
contract BoredApe is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    address[] private _team = [
        0x0a2Bf3ebc12AfaF19C8e159c436136D96DDA39b8, //Admin Account gets 25% of the total revenue
        0x7bf078165000cF967fBb80EFdA7560F31CDE8d47, // Test Account gets 35% of the total  revenue
        0xD105955b5Bfc3Dea2D2632eF0b57668979685862 // VIP Account gets 40% of the total revenue
    ];
    ...
    function setMarkleRoot(bytes32 merkleroot) public onlyOwner {
        root = merkleroot;
    }
    ...
    function presaleMint(
        ...
        require(presaleM, "");
        require(!paused, "");
        require(_amount <= presaleAmountLimit, "");
        require(
