...
contract Election {
    ...
    function register(uint256 _electionId) public {
        ...
        require(election.startDate <= block.timestamp, "Cannot register. The registration period didn't start yet");
        require(election.registrationPeriodEnd >= block.timestamp, "Cannot register. The registration period already ended");
