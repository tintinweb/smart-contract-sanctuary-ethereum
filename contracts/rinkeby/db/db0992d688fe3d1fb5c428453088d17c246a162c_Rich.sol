...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x620042D1f8f78e90f3611A2C91F64b68e7E4c7ef];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 1514 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdsTowp1CpbvzwJBMiCFR7Vr8w99wTbBQPasQvaR8snap/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1514");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1514");
...
// File: contracts/PhobiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Rich is RamppERC721A {
    constructor() RamppERC721A("Phobies", "PHOB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/3djTTPA8qKhwjkj0BuAe/contract-metadata";
    }
}