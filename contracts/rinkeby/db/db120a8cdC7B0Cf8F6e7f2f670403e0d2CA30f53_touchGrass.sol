...
contract touchGrass is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {

    string public baseURI;
    uint public price = 0.002 ether;
    uint public maxPerTx = 5;
    uint public maxPerWallet = 10;
    uint public maxSupply = 5500;
    uint public maxFree = 5;
    ...
    mapping(address => uint256) claimAvailable;
    mapping(address => bool) snapshot;

    function mint(uint256 amount) external payable {
        uint cost = price;
        uint genesisBalance = checkElyGenesisBalance(msg.sender);
    ...
    function checkElyGenesisBalance(address owner) public view returns (uint256) {
         return IERC1155(0x599C45ce43dF6D71E631a718BbEbb2BcD8fF0353).balanceOf(owner, 0);
    }
}
