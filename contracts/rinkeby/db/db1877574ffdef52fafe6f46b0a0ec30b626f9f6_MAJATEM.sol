...
contract MAJATEM is ERC721, Ownable {
    ...
    string public uriPrefix =
        "ipfs://QmQhKaWt4pYSGwGGsRybSqQMhUwBNMUvL3FAX7edCKGmqb/";
        ...
        returns (string memory)
    {
        ...
        string memory editionId = _getTokenEdition(_tokenId);

        return
            bytes(currentBaseURI).length > 0
                ? string(abi.encodePacked(currentBaseURI, editionId, uriSuffix))
                : "";
    }
    ...
    function _getTokenEdition(uint256 _tokenId)
        internal
        view
        returns (string memory)
    {
