...
contract TheChasmerize is ERC721, ERC721Enumerable, Ownable {
	...
	string private _baseURIExtended = "ipfs://QmXHDUHAK2szMUeNHtX6BpkKLCq1Au1tbZCsJ3r3tR4t88/";
	...
	constructor(address _proxyRegistryAddress) ERC721("TheChasmerize", "TCHA") {
	...
	function presaleMint(bytes32[] calldata proof) public payable {
		...
		require(!presaleMinted[_msgSender()], "Already minted");
