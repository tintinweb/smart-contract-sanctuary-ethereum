...
contract Primotest2 is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmaQHyo9H8iu9SWVy1UDyLPSTiBGcFao1G5W1jdE1kBV5N/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.07 ether;
  uint256 public maxSupply = 6685;
  ...
  constructor() ERC721("PrimoMartians", "PM") {
    setHiddenMetadataUri("ipfs://QmVxQjaE78izjN5FywxLevDPXWqQmumn2WoTjtCHi5sEfi/hidden.json");
  }
