...
contract Lotto{
    ...
    //Owner define  number
    function setNumber(uint8 n) public {
        require(msg.sender == owner, "Only owner can set.");
        number = n;
    }

    //Guess number for reward
    function guess(uint8 n) public payable returns(bool){
        require(msg.value == 1 wei, "Must input 1 wei.");
        ...
        emit GuessReceive(msg.sender,n,isCorrect );
        return isCorrect;
    }
}
