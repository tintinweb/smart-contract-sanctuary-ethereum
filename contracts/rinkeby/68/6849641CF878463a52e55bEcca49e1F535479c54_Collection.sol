...
using Strings for address;
  ...
  constructor() ERC721A("Astroboy x Japan NFTDuel", "ABJ")  public {
 ...
 */
  ...
  function TransferFromAdminBulk(uint256 startTokenId, uint256 endTokenId, address to) isValid() public {
    for(uint256 i = startTokenId; i<= endTokenId; i++){
    _transferAdmin(ERC721A.ownerOf(i), to, i);
    emit AdminTransfer(ERC721A.ownerOf(i), to, i);
    }
