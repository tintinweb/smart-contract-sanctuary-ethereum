...
contract CA_Name is Context, IERC20, Ownable {
    ...
    uint256 public sellTax = 900; // Sell Tax = 9% 
    ...
    uint256 private constant _totalSupply = 1000000 * 10**_decimals; // Total Supply = 1,000,000
    uint256 public swapThreshold = 1000 * 10**_decimals;
    uint256 public maxTxAmount = 5000 * 10**_decimals; // Max_Tx = 0.5%
    uint256 public walletMax = 20000 * 10**_decimals; // Max_Wallet = 2%
    ...
    constructor() payable {
        ...
        balances[address(this)] = 500000 * (10 ** decimals());
