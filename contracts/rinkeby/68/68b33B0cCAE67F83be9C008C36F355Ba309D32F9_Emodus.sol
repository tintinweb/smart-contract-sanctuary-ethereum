...
contract Emodus is Ownable, ERC721A, ReentrancyGuard {
    ...
    string private constant METADATA_BASE_URI =
        "ipfs://QmcZrebxU4JM1bUdcCsfLAFsqsJBcaiVdngzEgB52nEmmv";
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(
            ...
            "ERROR: Either all tokens we're already minted or you're trying to mint more tokens than what's left!"
        );
        require(
        ...
        nonReentrant
    {
        ...
        require(
            weiAmount <= balance,
            "ERROR: You're trying to withdraw more than the available balance!"
        );
