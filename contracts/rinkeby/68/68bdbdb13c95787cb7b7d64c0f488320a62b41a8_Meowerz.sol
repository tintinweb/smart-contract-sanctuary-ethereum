...
contract Meowerz is ERC721A, Ownable {
    ...
    constructor() ERC721A("Maybe", "RUN") {
        setHiddenMetadataUri("ipfs.io/ipfs/Qmd6p5iBBipxriwRvS65Q8waK7hRYkAGDN47D69MpnkS2m");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count < maxSupply + 1, "No more Meowerz");
