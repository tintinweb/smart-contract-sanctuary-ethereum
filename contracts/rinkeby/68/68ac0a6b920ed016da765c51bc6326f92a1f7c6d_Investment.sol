...
contract Investment {
    ...
    constructor(address _absAddr, address _defaultRefer, address[2] memory _feeReceivers) public {
        abs = IERC20(_absAddr);
    ...
    function deposit(uint256 _amount) external {
        abs.transferFrom(msg.sender, address(this), _amount);
    ...
    function withdraw() external {
        ...
        abs.transfer(msg.sender, withdrawable);
        uint256 bal = abs.balanceOf(address(this));
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        abs.transfer(feeReceivers[0], fee.div(2));
        abs.transfer(feeReceivers[1], fee.div(2));
