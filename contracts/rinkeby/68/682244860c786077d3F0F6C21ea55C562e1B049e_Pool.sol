...
contract Pool is VersionedInitializable, PoolStorage, IPool {
    ...
    function liquidationERC721(
        ...
        LiquidationLogic.executeERC721LiquidationCall(
            ...
            _reservesList,
            _usersConfig,
            DataTypes.ExecuteERC721LiquidationCallParams({
                reservesCount: _reservesCount,
...
library Errors {
    ...
    string public constant NOT_EOA = "93"; // caller is not eoa.
...
library LiquidationLogic {
    ...
    function executeERC721LiquidationCall(
        ...
        (, vars.userGlobalTotalDebt, , , vars.healthFactor, ) = GenericLogic
    ...
    function _burnCollateralNTokens(
        ...
        tokenIds[0] = vars.actualCollateralToLiquidate;
        ...
        )
    {
        ...
        uint256 globalDebtPrice = (userGlobalTotalDebt / vars.debtAssetPrice) *
        ...
        if (vars.liquidationProtocolFeePercentage != 0) {
            ...
            return (vars.collateralDiscountedPrice, 0, globalDebtPrice);
        }
    }
}
...
library ValidationLogic {
    ...
    function validateERC721LiquidationCall(
        ...
        bool liquidatingERC721 = params.assetType == DataTypes.AssetType.ERC721;

        if (liquidatingERC721) {
            require(
        ...
        vars.isCollateralEnabled =
            ...
            (
                liquidatingERC721
                    ? ICollaterizableERC721(params.xTokenAddress)
    ...
    function validateFlashClaim(
        ...
        require(!caller.isContract(), Errors.NOT_EOA);
        require(
