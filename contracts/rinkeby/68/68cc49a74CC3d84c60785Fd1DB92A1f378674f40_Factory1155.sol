...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new OwnHarvestUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        OwnHarvestUser1155Token token = OwnHarvestUser1155Token(address(addr));
...
contract OwnHarvestUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
