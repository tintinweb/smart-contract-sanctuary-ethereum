...
//
//     ____             __             __           __        
//    / __ \__  _______/ /____  ______/ /_  _______/ /____  __
//   / / / / / / / ___/ //_/ / / / __  / / / / ___/ //_/ / / /
//  / /_/ / /_/ / /__/ ,< / /_/ / /_/ / /_/ / /__/ ,< / /_/ / 
// /_____/\__,_/\___/_/|_|\__, /\__,_/\__,_/\___/_/|_|\__, /  
//                       /____/                      /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9dd872D24A59748fF81f0Ae10c8f2d09A61faAb1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 105 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmV6mfvT55sZ9hP13Qh11Ge2anuEWnnKMxKD4CgRbE6Ru8/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 105");
        _safeMint(_to, 1);
    }
...
// File: contracts/DuckyduckyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DuckyduckyContract is RamppERC721A {
    constructor() RamppERC721A("Duckyducky", "DUCK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/PwHbhxPLhXOyLkotPtqD/contract-metadata";
    }
}
