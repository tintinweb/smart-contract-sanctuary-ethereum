...
contract HBKongs is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // sale settings
    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant TEAM_SUPPLY = 99;
    uint256 public constant PRESALE_MINT_FEE = 0.03 ether;
    uint256 public constant SALE_MINT_FEE = 0.05 ether;
    uint256 public constant MAX_PRESALE_MINT = 10;
    uint256 public constant MAX_SALE_MINT = 10;
    ...
    constructor() ERC721("Happy Birthday Kongs", "HBK") {}
    ...
    function mint(uint256 _mintAmount) external payable nonReentrant {
        ...
        require(msg.value >= SALE_MINT_FEE * _mintAmount, "ETH amount below price");
    ...
    function mintPresale(uint256 _mintAmount, bytes32[] calldata _merkleProof) external payable nonReentrant {
        ...
        require(totalSupply + _mintAmount <= _publicSupply(), "The requested amount exceeds the remaining supply");
        require(msg.value >= PRESALE_MINT_FEE * _mintAmount, "ETH amount below price");
