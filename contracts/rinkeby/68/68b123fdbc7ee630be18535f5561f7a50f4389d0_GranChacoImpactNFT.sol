...
contract GranChacoImpactNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public TIER1_PRICE = 0.0343 ether;//3.43 ether;
    uint256 public TIER2_PRICE = 0.0396 ether;//3.96 ether;
    uint256 public TIER3_PRICE = 0.0729 ether;//7.29 ether;
    uint256 public TIERX_PRICE = 0.0019 ether;//0.19 ether;
    ...
    address public COST_WALLET;
    address public COMMUNITY_WALLET;
    address public NATIVE_ARTISTS_WALLET;
    address public CAMINNOS_WALLET;
    address[] public NFT_ARTISTS_WALLET;
    ...
    constructor() ERC721("Gran Chaco Impact", "GCI") {
        COST_WALLET = 0x51A3a443166989C5DdDb9D412c848695d9752706;
        COMMUNITY_WALLET = 0x767a9A1dB045f24e9Badbedf6E24F58b0Ebf7727;
        NATIVE_ARTISTS_WALLET = 0x45ee18Ae7aDCCf368cAA2Dbf83A318CbBa76e07F;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(COMMUNITY_WALLET).transfer(balance * COMMUNITY_EARN_PERCENT / 10000);
        payable(NATIVE_ARTISTS_WALLET).transfer(balance * NATIVE_ARTISTS_EARN_PERCENT / 10000);
        payable(CAMINNOS_WALLET).transfer(balance * CAMINNOS_EARN_PERCENT / 10000);
        
        for (uint256 i = 0; i < NFT_ARTISTS_WALLET.length; i++) {
            payable(NFT_ARTISTS_WALLET[i]).transfer(balance * NFT_ARTISTS_EARN_PERCENT / 10000 / NFT_ARTISTS_WALLET.length);
        }
    }
}