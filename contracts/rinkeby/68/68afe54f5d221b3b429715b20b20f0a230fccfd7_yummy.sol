...
contract yummy is Context, IERC20, Ownable {
    ...
    string private constant _name = "5";
    string private constant _symbol = "5";
    ...
    uint256 public _maxWalletSize = 100000000000 * 10**9; //2% of total supply
    uint256 public _swapTokensAtAmount = 40000000000 * 10**9; //0.1% 
