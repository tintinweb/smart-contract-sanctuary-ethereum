...
// File: contracts/ArbitestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArbitestContract is RamppERC721A {
    constructor() RamppERC721A("Arbitest", "ARBI"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/KrSrk0pKOEKsyBJPtWhd/contract-metadata";
    }
}
