...
contract WTFNFT is Ownable, ERC721A{
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmSRt6UHLonhSoL8EcZTY7j5kdCAJaBVoqvFkJ9R29sQs6/1";
    ...
    // swither
    bool public hideImages = false;

    constructor(address _USDC) ERC721A("WTF NFT", "WTF") {
        USDC = _USDC;
    }
    ...
    function mint(uint256 quantity) external nonReentrant {
        ...
        require(minted+quantity < MAX_TOKENS, "All NFTs are minted");
        minted+=quantity;
        IERC20(USDC).safeTransferFrom(msg.sender, address(this), quantity * price*1e18);
