...
contract AZNFT is ERC721, ERC721Enumerable, PullPayment, Ownable {
        ...
        returns (string memory)
    {
        ...
        return
            ...
            revealed ? NOT_REVEALED_TOKEN_URI : string(abi.encodePacked());
    }
    ...
    function setNotRevealedTokenURI(string memory _notRevealedURI)
        public
        onlyOwner
    {
        NOT_REVEALED_TOKEN_URI = _notRevealedURI;
    }
    ...
    function getWhiteListedAdrrs() public view returns (address[] memory) {
        return whitelistAddr;
    }

    function countWhitelisted() public view returns (uint256) {
