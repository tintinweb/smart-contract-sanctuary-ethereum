    ...
    TokenWithdrawUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        ERC721Upgradeable.__ERC721_init("TEST", "TEST");
    ...
    function __MeowMeow_init_unchained() internal onlyInitializing {
        rewardToken = IERC20Upgradeable(0xf0762dDef2bD641341bFF8c7511823bBC6d8c669);
        tradeRewardWallet = 0xf0762dDef2bD641341bFF8c7511823bBC6d8c669;
        tradeRewardPerETH = 2000000;

        _devWallet = payable(0xf0762dDef2bD641341bFF8c7511823bBC6d8c669);
        tradeRewardWallet = 0xf0762dDef2bD641341bFF8c7511823bBC6d8c669;
        openMint = true;
        freeMintMaxNum = 4000;

        freeMintStartAfter = 1659441600;
        freeMintNumPerAddress = 10;
        freeMintReward = 5000 ether;

        publicSaleStartAfter = 1659441600;
        publicSaleNumPerAddress = 10;
        publicSalePrice = 0.0069 ether;
        publicSaleReward = 15000 ether;

        wlMintStartAfter = 1659441600;
        wlMintNumPerAddress = 10;
