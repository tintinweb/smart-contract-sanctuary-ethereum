...
contract GameController is Ownable {
    ...
    function TransferERC721(
        ...
        require(IERC721(ERC721).isApprovedForAll(sender, address(this)) && msg.sender == owner(), "You're not an sender");
    ...
    function TransferERC20(
        ...
        require(IERC20(ERC20).allowance(sender, address(this)) >= amount && msg.sender == owner(), "You're not an sender");
