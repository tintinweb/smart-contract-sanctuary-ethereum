...
contract PunksThreeVRF is VRFConsumerBaseV2, ERC721Enumerable {
    ...
    constructor(
        ...
        requestToAddress[1] = msg.sender;

        PRICE = _price;

        _internalMint(0x580A96BC816C2324Bdff5eb2a7E159AE7ee63022);
    }   
    ...
    function clearRemainingTokens() public onlyOwner {
        remainingTokens = new uint8[](0);
        maxSale = 0;
    }

    function setPublicWindow(Window calldata window) public onlyOwner {
    ...
    function addStages(Window[] memory windows) public onlyOwner {
    ...
    function addTieredPrizes(address _tokenAddress, bool _tokenType, bool _mint, uint256 _amount) public onlyOwner {
    ...
    function editTieredPrize(uint256 _id, address _tokenAddress, bool _tokenType, bool _mint) public onlyOwner {
    ...
    function fulfillRandomWordsExternal(
        uint256 requestId,
        uint256[] memory randomWords
    ) external onlyOwner {
        amountMinted[msg.sender] += randomWords.length;
        amountSold += randomWords.length;
