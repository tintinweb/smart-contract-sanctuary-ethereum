...
// File: contracts/MetaversePunksV3.sol
...
contract MetaversePunks is Ownable, ERC721A, PaymentSplitter, ReentrancyGuard {
 ...
 // Modifier
  ...
  constructor(
    ...
    ERC721A("MPTest", "Ms", maxBatchSize_, collectionSize_) {
...
//Whitelist Mint
  function allowListMint(bytes32[] calldata _merkleProof) external payable callerIsUser {
    ...
    uint256 privateSaleStartTime = uint256(config.privateSaleStartTime);
    require(
      isPrivateSaleOn(price, privateSaleStartTime),
      "The private/whitelist sale has not yet begun."
    );
    ...
    require(price * 1 == msg.value, "Wrong ETH amount");
...
//Public Mint
  function publicSaleMint(uint256 quantity) external payable callerIsUser {
    ...
    require(
      ...
      "The public sale has not yet begun."
    );
