...
contract Pixoken is ERC721r, Ownable{
    ...
    uint public releaseDate = block.timestamp;
    ...
    // random number generated through chainlink vrf
    uint internal rng;

    
    constructor(string memory _baseTokenURI,uint256 _totalSupply) ERC721r("Pixoken", "PXKN",_totalSupply)
     {
        ...
        payable
    {
        ...
        require((totalMinted + 1) <= TOTAL_SUPPLY);
        require(stoppedEarlyMint == false, "Early mint has ended");
        totalMinted += 1;
