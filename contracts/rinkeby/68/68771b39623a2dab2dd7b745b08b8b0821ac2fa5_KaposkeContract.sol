...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3c324ec2a3464fD8c4ac215c40a3D75036a3342C,0x2caA0B85C7e6EB3183ed5B7CA8463bCBA91D2950,0x3bd32324df56A585D05Ed9f3955379b745203DF3,0x70cD517b65249960dC5F06A72ab8173336cC43b6,0x9937ed7416DDF5408a9ED97Bda1F1d0c14ae3141,0x295A7e4299E8Ca12BC9955B0f5aCf98e5c0EcEFC,0xBa1e9519b1885A94B5c97E16782855156a204BFf];
  uint256[] public payableFees = [5,5,15,15,15,15,15,15];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10000, 10000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVHJ5UYv1stbrw8BnPs1aAfNUxescwN7scqmqWdXhd7ZJ/";
...
// File: contracts/KaposkeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KaposkeContract is RamppERC721A {
    constructor() RamppERC721A("Kaposke", "Kaposke"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/OwGbsGPdtAmOg4UrLrop/contract-metadata";
    }
}
