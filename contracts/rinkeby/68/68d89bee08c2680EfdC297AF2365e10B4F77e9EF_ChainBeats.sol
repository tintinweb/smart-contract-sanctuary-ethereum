    ...
    ILayerZeroUserApplicationConfig
{
    ...
    constructor(
        ...
        birthChainGenesisBlockHash = birthChainGenesisBlockHash;
    }
    ...
    {
        (birthChainSeed, tokenIdSeed) = getTraversableSeeds(tokenId);
