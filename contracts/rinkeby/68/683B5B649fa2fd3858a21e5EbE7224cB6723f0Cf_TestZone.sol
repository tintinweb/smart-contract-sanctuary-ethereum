...
import "./INFBeez.sol";
      ...
      Setup payment and payment wallets - diifferent payouts
      DAO Bee cube creators in an array - possible
       */
  ...
  contract TestZone is ERC1155Supply, ERC2981, Ownable, ReentrancyGuard, QRNG {
    ...
    */
    ...
    function withdraw() external onlyOwner{
        ...
        (bool success, ) = (artist).call{value:  withdrawAmount_20}("");
        require(success);
        (bool sent, ) = (beezSafe).call{value: withdrawAmount_20}("");
        require(sent);
        (bool don, ) = (donation).call{value: withdrawAmount_5}("");
        require(don);
