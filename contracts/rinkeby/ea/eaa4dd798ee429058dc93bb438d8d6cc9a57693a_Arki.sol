...
contract Arki is Ownable, ERC721A, ReentrancyGuard {
  address public constant ARKIPELPASS_CONTRACT = 0x84BF2a3F9237CcE167f618AD16b55A4e2eaBf680;
  ...
  function burnArkipelPass(address owner, uint256 qty) external {
    ArkipelPassContract.burn(owner, 1, qty);
  }
