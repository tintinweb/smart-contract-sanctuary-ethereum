...
//call contract the same as .sol file
contract Queermageddon is ERC721, Ownable {
  using Strings for uint256;
  ...
  //change these for the new mint cost / supply / max Txn
  ...
  constructor() ERC721("Queer", "QUEER") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    //change everything after "ipfs://" to reflect the new URI
  }
//Mint limiter
...
contract queerWL is Queermageddon {
