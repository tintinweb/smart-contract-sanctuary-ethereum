...
// File: contracts/UkrainianMark.sol
...
contract UkrainianMark is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI) ERC721("Ukrainian Mark", "UKRMARK") {
