...
contract edoge is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 2000000000000;
    uint256 public maxBuyTranscationAmount = 200000000000;
    string private _name = "Evmos Doge";
    ...
    address public marketingWallet = 0xF589F3A0C8927371cbE19a745CBcA7B496018325;
    ...
    uint256 private numTokensSellToAddToLiquidity = 20000000000;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xf164fC0Ec4E93095b804a4795bBe1e041497b92a, 'We can not exclude Pancake router.');
