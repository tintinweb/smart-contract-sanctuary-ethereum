...
contract HangoverWolves is ERC721, ERC721Enumerable, Ownable {
    ...
    address public royaltyRecipient =
        0x4f47dA9e06BE81DAAff5af054D6bD285F7Bb77cc;
    uint256 public presalePrice = 0.06 ether;
    uint256 public price = 0.08 ether;
    uint256 public maxSupply = 10000;
    uint256 public maxSupplyWL = 2000;
    ...
    constructor(uint96 _royaltyFeesInBips) ERC721("Hangover Wolves", "WOLVES") {
        setBaseURI("ipfs://QmWYTr8FjqUhhQnNHJ6JcuDtrEbkBywB8EZBahj17GgaXG/");
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (onlyWhitelisted == true) {
                ...
                require(
                    allTokens + _mintAmount <= maxSupplyWL,
                    "max supply for whitelist exceeded"
                );
