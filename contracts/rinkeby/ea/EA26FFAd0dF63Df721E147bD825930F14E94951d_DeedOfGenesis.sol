...
/**
 @title Deed Of Gensis
 @author Jeffrey Lin, Justa Liang
 */
contract DeedOfGenesis is
    Initializable,
    UUPSUpgradeable,
    ERC721AUpgradeable,
    EIP712Upgradeable,
    ...
    PaymentSplitterUpgradeable
{
    ...
    function initialize(
        ...
        __ERC721A_init("DeedOfGensis", "DOG");
        __EIP712_init("DeedOfGensis", "1");
        __Ownable_init();
        ...
        view
    {
        ...
        require(
            owner() == ECDSAUpgradeable.recover(digest, signature),
