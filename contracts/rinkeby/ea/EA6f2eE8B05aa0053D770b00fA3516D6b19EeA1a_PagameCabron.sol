...
// correcto esto de abajo aunque lo subraye el editor, los contratos se compilan correctamente
import "AggregatorV3Interface.sol";
import "SafeMathChainlink.sol";

contract PagameCabron {
    ...
    constructor(address _direccionObtenerDatos) public {
        ...
        // aqui dentro definimos el owner,
    ...
    function dinerillo() public payable {
        ...
        //obtengo la cifra pagada por una dirección dada
        ...
        returns (uint256)
    {
        ...
        uint256 etherendolares = (preciodeeth * cantidadethercillos) /
            1000000000000000000;
    ...
    function cogerTasaEntrada() public view returns (uint256) {
        ...
        return (minimoUSD * precision) / precio;
    }

    modifier SoloPuedoYo() {
        // sólo dejamos hacer cosas al dueño del contrato
        require(
    ...
    function retiralapasta() public payable SoloPuedoYo {
