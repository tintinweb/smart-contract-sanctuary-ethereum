...
contract RFOXNFTSignaturePresale1155 is RFOXNFTSignatureSale1155, BaseRFOXNFTPresale1155
{
    ...
    {
        require(_isValidSignature(keccak256(abi.encodePacked(msg.sender, salt)), signature), "Invalid signature");
    ...
    ERC1155Supply
{
    ...
    function _updateTokenSettings(
        TokenStructs.TokenDataStandard memory tokenData
    ) internal {
        ...
        // TODO: Need to check the maxSupply --> should not be less than the current token totalSupply.
