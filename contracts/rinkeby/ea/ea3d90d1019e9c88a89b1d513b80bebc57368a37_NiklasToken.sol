...
// File: contracts/NiklasToken.sol


pragma solidity ^0.8.7;


contract NiklasToken is ERC20{
    uint private _SUPPLY_CAP;
    address private owner;
    constructor() ERC20("NiklasToken","XXX"){
        _SUPPLY_CAP = 250000;
        owner=0x84B783C297577b4b4de40FbbFb5419dE5AcBE294;
        
    }
    function mintToken(address account, uint amount) public{
        require(account == owner, "You are no the owner");
        require(totalSupply() + amount <= _SUPPLY_CAP,"Max Supply reached");
        _mint(account, amount);  
    }
    function burnToken(address account, uint amount) public{
        require(account == owner, "You are no the owner");
        require(totalSupply() - amount > 0,"Minimum exceed");
