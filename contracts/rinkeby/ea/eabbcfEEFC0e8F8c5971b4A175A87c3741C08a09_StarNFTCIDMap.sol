...
contract StarNFTCIDMap is Ownable {

    /**
     * @dev Star NFT CID map
     */
    mapping(uint256 => uint256) private _cids;

    /**
     * @dev Set the cid of a star.
     */
    function batchSet(uint256[] calldata nft_ids, uint256 cid) external onlyOwner {
        assert(nft_ids.length > 0);
