...
contract TPSCATAGW is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    //   require(totalSupply() + _mintAmount <= 4, 'Max supply exceeded!'); // set free mint amount during presale
    // }
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(!(addressClaimed[_msgSender()] <= 2), 'Address already claimed!');
