...
contract gutterjuices is Ownable, ERC721A, ReentrancyGuard {
    ...
    GutterConfig public gutterConfig;

    constructor() ERC721A("Gutter Juices", "GUTTERJUICES") {
        initConfig( 
    ...
    function initConfig(
        ...
        gutterConfig.rootHash = rootHash;
        gutterConfig.paused = paused;
        gutterConfig.isPublicSale = isPublicSale;
        gutterConfig.isPreSale = isPreSale;
        gutterConfig.preSaleMaxMint = preSaleMaxMint;
        gutterConfig.publicSaleMaxMint = publicSaleMaxMint;
        gutterConfig.publicSalePrice = publicSalePrice;
        gutterConfig.preSalePrice = preSalePrice;
        gutterConfig.maxSupply = maxSupply;
        gutterConfig.devMintAmount = devMintAmount;
        gutterConfig.freeSlots = freeSlots;
    }
    ...
    function preSaleMint(uint256 quantity, bytes32[] calldata proof)
        ...
        payable
    {
        GutterConfig memory config = gutterConfig;
    ...
    function flipSaleStatus() public onlyOwner {
        gutterConfig.isPreSale = !gutterConfig.isPreSale;
        gutterConfig.isPublicSale = !gutterConfig.isPublicSale;
    }

    function setPaused(bool _state) public onlyOwner {
        gutterConfig.paused = _state;
    }

    function setRootHash(bytes32 _hash) public onlyOwner {
        gutterConfig.rootHash = _hash;
    }

    function setFreeSlots(uint256 _slots) public onlyOwner {
        gutterConfig.freeSlots = _slots;
    }
