...
contract AaveGateway is ERC20Burnable, Ownable, Math {
    ...
    function _utilizationRatio() public view returns (uint256) { // totalBorrowed / totalDeposit
        return getExp(totalBorrowed, totalDeposit);
    }

    function _interestMultiplier() public view returns (uint256) {  // interestMultiplier = (fixedAnnuBorrowRate - baseRate) / u
