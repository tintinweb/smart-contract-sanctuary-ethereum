...
contract WukongEP is ERC1155, ERC1155Supply, ERC1155Burnable, Ownable {
    ...
    uint[] public priceArr = new uint[](MAX_NFTS); 
    uint[] public supplyArr = new uint[](MAX_NFTS); 
    ...
    */
    function createNewTrack(uint256 numerator, uint denominator, uint individualSupply, uint256 maxSupply) external onlyOwner {
        ...
        priceArr[CURRENT_TOKEN_ID-1] = numerator/denominator  * (1 ether);
    ...
    */
    function massMint(uint256 count) external onlyOwner {
        _mint(0xa18383E2BF2482A821464680f0b6F06f3234e421,PHOENIX_RAVE, count, "");
        massDeductCount(PHOENIX_RAVE, count);
        _mint(0xa18383E2BF2482A821464680f0b6F06f3234e421,LEGEND_OF_WFH, count, "");
    ...
    */
    function massMintToken(uint256 count, uint256 tokenId) external onlyOwner {
        _mint(0xa18383E2BF2482A821464680f0b6F06f3234e421,tokenId, count, "");
    ...
    * @param denominator denomiator for price
    */
    function _setTokenPrice(uint256 tokenId, uint numerator, uint denominator) external onlyOwner{
        priceArr[tokenId-1] = numerator/denominator * (1 ether);
    }
