...
contract Contract is ERC721Enumerable, Ownable {
  ...
  uint256 public MaxToken = 30000;

  constructor(string memory CollectionName, string memory CollectionSymbol, string memory _initBaseURI,string memory _initnotRevealURI)
    ERC721(CollectionName, CollectionSymbol) { setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI); }
