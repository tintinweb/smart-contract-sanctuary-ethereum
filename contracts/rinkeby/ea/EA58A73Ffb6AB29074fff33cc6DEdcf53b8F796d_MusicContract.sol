...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x855A1282D4a5033798f11945981b8fB95DAb30D6];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x855A1282D4a5033798f11945981b8fB95DAb30D6;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 10) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://ibninglor.stream/dzep/nft/";
...
// File: contracts/MusicContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MusicContract is RamppERC721A {
    constructor() RamppERC721A("Music", "MUSIC"){}
}