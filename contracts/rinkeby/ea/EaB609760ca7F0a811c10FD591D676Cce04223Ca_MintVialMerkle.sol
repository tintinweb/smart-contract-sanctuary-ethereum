...
contract MintVialMerkle is ERC1155, ERC1155Burnable, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(address payable owner) ERC1155("ipfs://QmYoeae1rQgtR25aKEuNBzbmqzpNh4TryrbdmviGHABuo5") {
        ...
        listsData[1] = listParameters(0x0357a7cc631a700827724ce79355ecca939d0951d58ab2886ad560bc2e49b785, 0.05 ether, 3333);
        listsData[2] = listParameters(0x0, 0.05 ether, 800);
        listsData[3] = listParameters(0x0, 0 ether, 3333);
        listsData[4] = listParameters(0x0, 0.15 ether, 0);
    }
    ...
    function getAvailableTokensByRound(uint _round) public view returns(uint)
    {
        return listsData[_round]._available;
    }
