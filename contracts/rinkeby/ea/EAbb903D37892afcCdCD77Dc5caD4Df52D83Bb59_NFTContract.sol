...
uint public mintRate = 0.003 ether;
...
uint public maxSupply = 5000;
 ...
 struct  BuyerData {
    ...
    string public baseURI = "ipfs://QmeZa2YCdcHYHh65m9upmQ81wEyzj8GXEEM1T9Xqct7SPA/";
    


constructor() ERC721A("Crocodiles", "CROCS") public { }



function mintingSale1(uint256 _quantity)external payable{
    require(totalSupply()+_quantity <= maxSupply, "Not enough tokens left");
    require(msg.value == (mintRate * _quantity), "Please send full ethereum payment");
