...
import "./AccessManagment.sol";

contract BRToken is ERC20, Ownable, AccessManagment {
    /* using SafeMath for uint256; */

    /**
     * @dev BrToken constructor
     */
    constructor() ERC20("Brtoken Brazilian Real", "BRT") {}
    ...
    /**
     * @dev Exchanges balance from one address to another
     */
    function exchangeBalance(address _from, address _to) public onlyOwner {
        ...
        require(nAmount != 0, "The balance of from address is zero.");
    ...
    /**
     * @dev Mints tokens on the _investor address
     */
    function invest(address _investor, uint256 _amount)
        public
        onlyAllowedAddress
    {
        // Ensures investor address isnt zero
        require(_investor != address(0), "Investor is empty");

        // Ensures amount isnt zero
        require(_amount != 0, "Amount is zero");

        // mints tokens to the investor account
...
/**
 * @dev AccessManagment limits access to owner allowed addresses
 **/
contract AccessManagment is Ownable {
