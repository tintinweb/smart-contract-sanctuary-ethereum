...
// File: contracts/NftEcomBlock.sol
...
contract NftEcomBlock is ERC721URIStorage, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _name, string memory _symbol, string memory _nftUri)
    ...
    function mint(uint8 _mintAmount) public payable {
      ...
      _safeMint(msg.sender, tsupply);
      _setTokenURI(tsupply,nfturi);
