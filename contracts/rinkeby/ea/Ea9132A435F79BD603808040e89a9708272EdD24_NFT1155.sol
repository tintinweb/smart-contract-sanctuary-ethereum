...
contract NFT1155 is ERC1155, AccessControl {
    ...
    constructor() ERC1155("https://csharp-dev.bloxmith.com/nft/{id}.json") {
    ...
    /**
     * @dev mint NFT for someone
     *
     * @param to The person who will get the token
     * @param tokenId The unique token id
     * @param amount The amount of token will be mint
     */
    function safeMint(
        address to,
        uint256 tokenId,
