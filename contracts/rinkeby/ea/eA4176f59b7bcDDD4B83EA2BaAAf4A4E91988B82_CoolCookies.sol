...
contract CoolCookies is ERC721, Ownable {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool cs, ) = payable(0xeac62E27285DF9abCE7d8e12005690a23674ceB3).call{value: address(this).balance * 20 / 100}("");
    require(cs);
    // =============================================================================

    // This will put 20% of sales in dev wallet.
    // =============================================================================
    (bool ds, ) = payable(0xf4ca3774096d639A7bBaaf5DFf3604428704F9f6).call{value: address(this).balance * 20 / 80}("");
    require(ds);
    // =============================================================================
