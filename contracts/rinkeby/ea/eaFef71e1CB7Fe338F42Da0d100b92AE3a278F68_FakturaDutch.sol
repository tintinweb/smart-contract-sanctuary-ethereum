...
UUPSUpgradeable
{
    ...
    function safeMint(address to) public payable limited {
        require(mintAllowed[msg.sender] < maxMintPerAddress, "One address can mint 10 tickets.");
        require(getPrice(1) == msg.value, "Mint price is not correct.");
        _safeMint(to, _tokenIdCounter.current());
        _tokenIdCounter.increment();
        mintAllowed[msg.sender]++;
    }
    ...
    function safeBatchMint(address to, uint256 amount) public payable {
        ...
        require(mintAllowed[msg.sender] + amount <= maxMintPerAddress, "One address can mint 10 tickets.");
