...
contract Itm is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    function mint(uint256 amount) public {
        _mint(msg.sender, 0, amount, "0x00");  // i wanna know 0x0O
    }
    ...
    */
    function redeemCardForOther(uint256 cardIdToRedeem, uint256 amount) external {
        _burn(msg.sender, cardIdToRedeem, amount);
        _mint(msg.sender, cardIdToRedeem+1, amount, "0x00");
        emit RedeemedForCard(cardIdToRedeem, cardIdToRedeem+1, msg.sender, amount);
    }
