 ...
 */
contract SingleCollection is Initializable, Ownable, ERC721Base, ERC721Burnable, SignerRole {
    ...
    function __SingleCollection_init_unchained(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) initializer public {
        __ERC721Base_init_unchained(name, symbol, contractURI, tokenURIPrefix);
 ...
 */
contract SingleUserCollection is Initializable, SingleCollection {
    uint public maxTokenId;

    // constructor() initializer {}

    //slither-disable-next-line reentrancy-no-eth
    function __SingleUserCollection_init_unchained(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) initializer public {
        // require(!initialized, "already initialized");
        // initialized = true;
        __SingleCollection_init_unchained(name, symbol, contractURI, tokenURIPrefix, msg.sender);
    }
 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Initializable, Context, ERC165Storage, IERC721, IERC721Metadata {
    ...
    function __ERC721_init_unchained(string memory name_, string memory symbol_) initializer public {
        _name = name_;
        _symbol = symbol_;
    }   
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721Base is Initializable, HasSecondarySaleFees, HasContractURI, HasTokenURI, ERC721Enumerable {
    ...
    */
    ...
    function __ERC721Base_init_unchained(string memory _name, string memory _symbol, string memory contractURI, string memory _tokenURIPrefix) initializer public {
...
contract HasTokenURI is Initializable {
    ...
    function __HasTokenURI_init_unchained(string memory _tokenURIPrefix) initializer public {
...
contract HasContractURI is Initializable, ERC165Storage {
    ...
    function __HasContractURI_init_unchained(string memory _contractURI) initializer public {
