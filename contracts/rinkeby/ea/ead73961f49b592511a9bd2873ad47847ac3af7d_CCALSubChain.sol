...
contract CCALSubChain is BaseContract {
    ...
    function lzReceive(
        ...
        Console.log("address(layerZeroEndpoint)", address(layerZeroEndpoint));
        Console.log("_srcAddress", _srcAddress);
        Console.log("remotes[_srcChainId]", remotes[_srcChainId]);
