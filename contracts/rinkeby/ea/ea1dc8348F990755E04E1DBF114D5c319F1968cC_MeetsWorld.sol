...
contract MeetsWorld is Ownable, ERC721 {
    ...
    // tokenId => rarityLevel
    mapping (uint256 => uint256) public assignedCategory; // 0 = Basic, 1 = Normal, 2 = Rare, 3 = Epic ,4=Exclusive
    ...
    function explicitAssignCategory(uint256 _assignNumber) public onlyOwner{
       //require(_tokenIds.current()>0,"no tokenIds to assign categories.");
       for(uint256 i=0;i<_assignNumber;i++){
