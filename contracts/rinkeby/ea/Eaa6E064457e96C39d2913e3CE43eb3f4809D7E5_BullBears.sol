...
contract BullBears is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private _baseTokenURI = "ipfs://Qmf5TePnasktmxDGxqZ9TcFvhLBWxe6pnHmoeU4MgdVRXe/";
    ...
    function setReady(bool _state) public onlyOwner {
        isReady = _state;
    }
    ...
    function mint(uint256 _quantity) external payable nonReentrant callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "Cannot mint more");
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_MINT, "Already minted 5");
