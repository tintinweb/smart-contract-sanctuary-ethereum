...
contract Timescape is ERC721Enumerable, Ownable {
    ...
    address public _w1 = 0x8c209E7a039fb146C8d9e63d951b44F541448BA7;
    address public _w2 = 0x71bE18F05F388EA80e9d44EA81567627e82F39E7;

    constructor() ERC721("Time Scape", "TIMESCAPE") {
        setBaseURI("https://timescape.art/metadata/");
    }

    event SignatureEvent(bytes32 hashSignature);
    ...
    function _isValidSignature(bytes32 hash, bytes memory signature) internal returns (bool) {
        ...
        emit SignatureEvent(signedHash);
