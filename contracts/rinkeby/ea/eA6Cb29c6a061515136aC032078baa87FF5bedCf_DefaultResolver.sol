 ...
 * address.
 */
contract DefaultResolver is Multicallable, AddressResolver, ContentHashResolver, NameResolver, TextResolver {
    ICRS crs;
 ...
 */
interface IResolver is ISupportsInterface, IAddressResolver, INameResolver, ITextResolver, IContentHashResolver {
