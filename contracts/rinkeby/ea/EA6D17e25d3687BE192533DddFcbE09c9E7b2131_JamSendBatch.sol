...
contract JamSendBatch is Ownable {
    ...
    modifier onlyOperators() {
        require(_operators[msg.sender], "JamSendBatch: caller is not operator");
        _;
    }
    ...
    function sendBatchERC20(
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            require(success, "JamSendBatch: failed to send ERC20 tokens");
        }
        emit ERC20BatchSent(recipients, tokens, amounts);
    }
    ...
    function sendBatchERC721(
        ...
        emit ERC721BatchSent(recipients, tokens, tokenIds);
    }
    ...
    function sendBatchERC1155(
        ...
        for (uint256 i = 0; i < recipients.length; i++)
            IERC1155(tokens[i]).safeBatchTransferFrom(
                ...
                tokenIds[i],
                quantities[i],
                abi.encodePacked("Send batch ERC1155")
            );
        emit ERC1155BatchSent(recipients, tokens, tokenIds, quantities);
    }
}
