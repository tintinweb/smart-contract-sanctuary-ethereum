...
contract Auction is IAuction, ERC721Upgradeable, OwnableUpgradeable {
    ...
    /// @notice Internal function that starts auction for a pool
    /// @param poolAddress Address of the pool
    function _startAuction(address poolAddress, uint256 amount) internal {
