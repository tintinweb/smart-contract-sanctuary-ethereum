...
contract OMGMasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public constant MASTERCHEF_OMG_PER_BLOCK = 40 * 10 ** 18;
...
contract OMG is Ownable, ERC20 {
    ...
    modifier onlyManager {
        require(msg.sender == owner() || msg.sender == treasuryAddress);
        _;
    }

    constructor(address _router) ERC20("Omnichain Governance", "OMG") {
