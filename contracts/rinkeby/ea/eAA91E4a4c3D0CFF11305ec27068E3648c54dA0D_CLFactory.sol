...
contract CLFactory {
    ...
    event evtHouseCreation( eventType typeEvent, address houseAddr, string houseName, uint houseId );
        ...
        returns( address )
    {
        ...
        emit evtHouseCreation( eventType.houseCreation, adrCLH, _houseName, houseId );
 ...
 * TODO:
 * 
 * - Generate event for rejected proposal
 * - Separate typeEvent and typeProposal
 * 
*/ 
