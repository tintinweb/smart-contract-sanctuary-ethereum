...
contract Universal_Stipend is Context, IERC20, Ownable {
	...
	string private constant _name = "Universal Stipend";
	string private constant _symbol = "US";
	uint8 private constant _decimals = 9;

	uint256 public _taxFeeOnSale = 2;
	...
	uint256 public numTokensSellToAddToLiquidity = 500 * 10**9;
	...
	constructor () {
		...
		WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // testnet DAI
	...
	function setMinimumNumber (uint256 _min) public onlyOwner {
		numTokensSellToAddToLiquidity = _min * 500** 9;
	}
