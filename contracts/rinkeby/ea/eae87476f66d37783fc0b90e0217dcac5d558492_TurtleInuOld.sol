...
contract TurtleInuOld is ERC20, Ownable {
    ...
    constructor() payable ERC20("Turtle Old", "TINUOLD") {
        ...
        _createInitialSupply(address(this), (totalSupply * 93) / 100); // Tokens for liquidity
