...
contract MetabillionaireAirdropERC1155 is Ownable, ERC1155 {
    ...
    string public baseURI = "https://themetatribes.mypinata.cloud/ipfs/QmSBnbvjG9PBXKTY6TyLCUmcu8gPinbPUZfYZ3ZFDx9zha/";

    constructor(
        address[] memory platinumAddress,
        address[] memory goldAddress
       // address[] memory silverAddress
        ...
        // for(uint i = 0 ; i < silverAddress.length ; i++) {
        //     _mint(silverAddress[i], Silver, 1, "");
        // }
    }
