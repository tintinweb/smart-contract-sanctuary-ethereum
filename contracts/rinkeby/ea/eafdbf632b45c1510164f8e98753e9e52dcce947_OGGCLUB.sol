...
contract OGGCLUB is ERC721A, ERC721AQueryable, Owned {
uint256 public FIRST_MINT_PRICE = 0.02 ether;
  uint256 constant EXTRA_MINT_PRICE = 0.035 ether;
  ...
  constructor() ERC721A("NEWOGG", "NUOGG") Owned(msg.sender) {}

  // Rename mint function to optimize gas
  function mint_540(uint256 _quantity) external payable {
    unchecked {
      require(!paused, "MINTING PAUSED");
      require(_totalMintedCount[msg.sender] + _quantity < MAX_PER_WALLET_PLUS_ONE, "MAX PER WALLET IS 4");
      ...
      require(
        msg.value == (payForCount * EXTRA_MINT_PRICE + payForFirstMint * FIRST_MINT_PRICE),
