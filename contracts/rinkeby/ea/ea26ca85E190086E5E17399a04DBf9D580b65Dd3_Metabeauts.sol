 ...
 */
contract Metabeauts is Ownable, ERC721x {
        ...
        isPaused
    {
        ...
        require(
            _mintAmount + balanceOf(msg.sender) <= MAX_PER_WALLET_PRESALE,
    ...
    function getRandomAvailableTokenId(
        ...
        uint256 randomIndex = (randomNum - 1) % (updatedNumAvailableTokens + 1);
    ...
    function getAvailableTokenAtIndex(
        ...
        uint256 tokenId = _availableTokens[indexToUse] == 0
            ? indexToUse
            : _availableTokens[indexToUse];

        uint256 value = _availableTokens[updatedNumAvailableTokens] == 0
            ? updatedNumAvailableTokens
            : _availableTokens[updatedNumAvailableTokens];

        _availableTokens[indexToUse] = value;

        if (_availableTokens[updatedNumAvailableTokens] != 0) {
            delete _availableTokens[updatedNumAvailableTokens];
        }
