...
contract RDRPunks is ERC721F,AllowList {
    ...
    constructor() ERC721F("RDRPunks", "RDRP") {
    ...
    */
    ...
    /**
     * Mint your FREE tokens here.
     */
    function freeMint() external onlyAllowList {
        require(freeSaleIsActive,"Free Sale NOT active yet"); 
...
contract AllowList is Ownable {
    ...
    */
    function addAdresses(address[] memory _address) external onlyOwner {
         for (uint i=0; i<_address.length;) {
            allow(_address[i]);
            unchecked{i++;}
         }
    }
    ...
    */
    function removeAllow(address _address) public onlyOwner {
