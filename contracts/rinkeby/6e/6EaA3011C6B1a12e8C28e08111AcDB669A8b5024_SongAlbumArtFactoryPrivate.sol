...
import "./SongAlbumArtTradablePrivate.sol";

contract SongAlbumArtFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice SongAlbum marketplace contract address;
    address public marketplace;

    /// @notice SongAlbum bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new SongAlbumArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        SongAlbumArtTradablePrivate nft = new SongAlbumArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing SongAlbumArtTradable contract
    ...
    /// @notice Method for disabling existing SongAlbumArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title SongAlbumArtTradablePrivate
 * SongAlbumArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract SongAlbumArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // SongAlbum Marketplace contract
    address marketplace;
    // SongAlbum Bundle Marketplace contract
    ...
    {
        // Whitelist SongAlbum marketplace, bundle marketplace contracts for easy trading.
