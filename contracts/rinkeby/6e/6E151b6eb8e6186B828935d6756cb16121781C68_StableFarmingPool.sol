...

{
     ...
     */
    function stableFarmingDepositSpecifyReceiver(
        uint256 _poolId,
        uint256 _amount,
        address _receiver
    ) external nonReentrant stableFarmingValidatePoolById(_poolId) {
        StableFarmingPoolInfo storage pool = stableFarmingPoolInfo[_poolId];
        _stableFarmingDeposit(_poolId, _amount, _receiver);
        ...
        emit StableFarmingDeposit(_poolId, _receiver, _amount);
    }
