...
contract aaa is ERC721A,Ownable,Pausable {
    ...
    function mint(uint256 _quantity) external callerIsUser payable whenNotPaused  {
        ...
        if (msg.value>0) {
            Address.sendValue(payMentPotatoz, msg.value/100*5);
        }
    ...
    function allowListMint(bytes32[] calldata merkleProof, uint256 _quantity) external callerIsUser payable whenNotPaused {
