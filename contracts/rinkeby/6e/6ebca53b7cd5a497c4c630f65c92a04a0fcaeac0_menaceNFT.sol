...
// File: menace_contract.sol


// disregarding any supply constraints as this collection can expand at the discretion of the team

pragma solidity ^0.8.7;



contract menaceNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public initialMintToDev = 1;
    ...
    constructor(
        ...
        mint(msg.sender, initialMintToDev);
    }
