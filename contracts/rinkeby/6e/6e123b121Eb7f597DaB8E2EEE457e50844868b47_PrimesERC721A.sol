...
contract PrimesERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 private constant MAX_GIFT = 76;
    uint256 private constant MAX_SUPPLY_MINUS_RESERVED = 1500;
    uint256 private constant MAX_WHITELIST = 750;
    uint256 private constant MAX_PUBLIC = 750;

    uint256 public wlSalePrice = 0.003 ether; // 1 ETH = $ 1800
    uint256 public publicSalePrice = 0.006 ether;

    uint256 public saleStartTime = 1655791680; //1655762400; 21/06/22 00:00 // 1655791680 21/06/22 08:08:00
    ...
    uint256 private constant maxPerAddessDuringWhitelistMint = 5;
    uint256 private constant maxPerAddessDuringPublicMint = 5;

    bool public isPaused;

    uint256 private teamLength;

    address[] private _team = [0x0dD2E9C2dcCddF616a4A460E804EB9189819B766];
    ...
    function whitelistMint(
        ...
        require(currentTime() < saleStartTime + 24 hours, "Sale is finished"); // impact publicMint()
