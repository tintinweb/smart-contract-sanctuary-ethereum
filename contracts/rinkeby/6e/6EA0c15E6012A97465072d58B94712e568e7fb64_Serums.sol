...
contract Serums is ERC1155, Ownable {
  ...
  uint[4] private  maxAmounts = [900,200,3093,7];
  uint[4] private  wlPrices = [.0005 ether, .0005 ether, .0005 ether, .0005 ether];
  uint[4] private publicPrices = [.0005 ether,.0005 ether,.0005 ether, .0005 ether];
  ...
  function batchClaim(uint[] memory serumIds, uint[] memory claimAmounts, bytes memory signature) external  {
    ...
    for(uint i; i< serumIds.length; i++){
        if(serumIds[i]>3) revert InvalidTokenId();
