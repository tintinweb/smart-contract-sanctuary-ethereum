...
contract Sale1v4Merkle is ERC721A, IERC2981, Ownable {
    ...
    function openWhitelistMint(uint256 _whitelistMintRemains, bool _isPrivateWhitelistMint, bytes32 _merkleRoot) public onlyOwner{
    ...
    function mintToken(uint numberOfTokens, bytes32[] calldata merkleProof) public payable  {
        ...
        if(whitelistMintRemains > 0 && (!isPrivateWhitelistMint || MerkleProof.verify(merkleProof, merkleRoot,keccak256(abi.encodePacked(msg.sender))))  && numberMinted(msg.sender) <= 0){
