...
// Modification of OpenZeppelin Contracts (last updated v4.5.0) (governance/extensions/GovernorVotesQuorumFraction.sol)
...
abstract contract GovernorVotesQuorumFraction is GovernorVotes {
    ...
    {
        return
            (token.totalSupply(tokenId) * quorumNumerator()) /
            quorumDenominator();
    }
