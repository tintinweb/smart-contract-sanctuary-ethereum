...
contract dds is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        require(PreSale || publicSale, "SALE_HAS_NOT_STARTED_YET");
    ...
    function setmaxToken(uint256 _maxTokenInWEI) external onlyOwner {
        maxToken = _maxTokenInWEI;
    }
