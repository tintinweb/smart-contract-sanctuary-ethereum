...
contract Sarutana is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant MAX_TOKENS = 8888;
    uint256 public constant price = 0.10 ether;
    ...
    bytes32 public merkleRoot = 0xaa3551d3fcdc80fe5b88d49c19e9451fb970229152495fc8b1924703324fb087;

    constructor() ERC721A("testings", "TESTTOKEN", 2) {
    }
    ...
    function whitelistMint(uint256 tokens, bytes32[] calldata merkleProof) external payable {
        ...
        require(tokens <= maxMint, "SARU: Exceeded allowed max mint limit");
        require(_whitelistClaimed[_msgSender()] + tokens <= maxMint, "SARU: Max amount of Sarutamas have been minted by this wallet");
        require(tokens > 0, "SARU: Please mint at least 1 Sarutama");
    ...
    function mint(uint256 tokens) external payable {
        ...
        require(tokens <= maxMint, "SARU: Cannot purchase this many tokens in a transaction");
    ...
    // Owner mint has no restrictions
