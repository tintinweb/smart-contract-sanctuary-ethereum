...
// File contracts/supply/SupplyTreasuryFund.sol
...
contract SupplyTreasuryFund is ReentrancyGuard {
    ...
    function getUtilizationRate() public view returns (uint256) {
        uint256 totalBal = getSelfBalance().add(frozenUnderlyToken);
    ...
    function setBaseRate(uint256 _v) external onlyOwner {
    ...
    function setX1(uint256 _v) external onlyOwner {
    ...
    function setY1(uint256 _v) external onlyOwner {
    ...
    function setY2(uint256 _v) external onlyOwner {
