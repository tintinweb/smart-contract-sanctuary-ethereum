...
contract NFTcontract is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function setMaxPublicMint(uint256 _maxmint) internal onlyOwner {
    ...
    function setPublicSalePrice(uint256 _publicSalePrice) internal onlyOwner {
        PUBLIC_SALE_PRICE = _publicSalePrice;
    }

    function setCollectAddress(address _collectAddress) internal onlyOwner {
