...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xca76b4446f86f8f3eFBCe365B1E8EBC9f271DC08];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 777;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 7, 1499) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmejsAF8bT8fotEY3NVeaGJjpV1ry2LHP3Mtx9EAtdFXsk/";

    bool public mintingOpen = true;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 28;
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1499");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1499");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1499");
...
// File: contracts/TrippyVegetablesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TrippyVegetablesContract is RamppERC721A {
    constructor() RamppERC721A("Trippy Vegetables", "Vegetables"){}
}
