...
contract rabbibt is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Rabbit777", "RBTT") {
    setHiddenMetadataUri("ipfs://ipfs://QmNZ44sgYAD9dQtMLhh9xEamaPm4C3x5kjha5oyjjNsADG/_metadata.json");
  }
