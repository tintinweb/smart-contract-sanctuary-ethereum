...
contract FrankSecondNFT is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;
  ...
  constructor() ERC721("Frank Second Testing", "FST") {
    setHiddenMetadataUri("ipfs://QmTt2eZ6wJjeVRA61etYsFbMuP3Ybc3AbZPzNu11ZSSb8R/hidden.json");
  }
