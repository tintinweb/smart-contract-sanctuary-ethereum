...
contract RICCON is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SKETCHY OFK2-18B", "H") {
    setHiddenMetadataUri("ipfs://QmYWXpfJsYj6K2WdJtmsxSRs5u8Ja2PVN7J67CPkiWQ9qN/hidden.json");
  }
