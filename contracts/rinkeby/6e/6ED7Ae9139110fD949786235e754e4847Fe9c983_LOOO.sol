...
contract LOOO is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("LOOO", "HTB") {
  ...
  string private customContractURI =
    "ipfs://QmUDcoH226ev8Gj5QznRRUhkCuEQX1L1gTnDXdzSfPLjcz/%7BtokenId%7D.json";
