...
interface IAnomuraData
{
    ...
    function getClaws() external view returns (string[] memory);
    function getBodies() external view returns (string[] memory);
    function getLegs() external view returns (string[] memory);
    function getShells() external view returns (string[] memory);
    function getHeadPieces() external view returns (string[] memory);
    function getBackgrounds() external view returns (string[] memory);
    function getPrefixes() external view returns (string[] memory);
    function getSuffixes() external view returns (string[] memory);
    function getUnique() external view returns (string[] memory);
    function getBackgroundPrefixes() external view returns (string[] memory);
...
contract AnomuraData is IAnomuraData, Ownable 
{
    ...
    function getClaws() external view returns(string[] memory claws){
        claws = clawData;
    }

    function getBodies() external view returns(string[] memory bodies){
        bodies = bodyData;
    }

    function getShells() external view returns(string[] memory shells){
        shells = shellData;
    }

    function getLegs() external view returns(string[] memory legs){
        legs = legData;
    }

    function getHeadPieces() external view returns(string[] memory headpieces){
        headpieces = headpiecesData;
    }

    function getBackgrounds() external view returns(string[] memory backgrounds){
        backgrounds = backgroundData;
    }

    function getPrefixes() external view returns(string[] memory prefixes){
        prefixes = prefixesData;
    }

    function getBackgroundPrefixes() external view returns(string[] memory backgroundPrefixes){
        backgroundPrefixes = backgroundPrefixesData;
    }

    function getSuffixes() external view returns(string[] memory suffixes){
        suffixes = suffixesData;
    }

    function getUnique() external view returns(string[] memory unique){
        unique = uniqueData;
    }
