    ...
    Treasury
{
    ...
    address[] private mintPayees = [
        0xBa4491E278CA6cCDbA68749673dEF8A0112C1F8f, // Cnick
        0x8f3aD89b9708e756a15ecd8C4ed72f45C5b43a15, // Artist
        0xe36dD405db649d056EB974Fc75f5e5a9c4d4FDC3 // Dev
    ];
        ...
        Treasury(mintPayees, mintShares)
    {
        ...
        for (uint256 i = 0; i < operators.length; i++) {
            setApprovalForAll(operators[i], true); // Rinkeby Opensea
        }
    }
    ...
    function setCurrentSupply(uint256 _currentMaxSupply) public onlyOwner {
        currentMaxSupply = _currentMaxSupply > MAX_SUPPLY ? MAX_SUPPLY : _currentMaxSupply;
    }
    ...
    function allowListMint(uint256 numberOfTokens, uint256 temporaryAllowlist)
        public
        payable
    {
        require(!paused(), "Minting is paused");
        ...
        require(temporaryAllowlist == 5, "Put 5 on third parameter");
