...
contract BearCartel is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public constant MAX_PRESALE_SUPPLY = 666;
    uint256 public constant MAX_PUBLIC_SUPPLY = 3778;
    uint256 public constant MAX_SUPPLY = MAX_PRESALE_SUPPLY + MAX_PUBLIC_SUPPLY;
    uint256 public constant MAX_PRESALE_MINT_PER_TX = 4;
    uint256 public constant MAX_PUBLIC_MINT_PER_TX = 6;
        ...
        callerIsSender
    {
        ...
        require(PRESALE_MINT_PRICE <= msg.value, "INCORRECT_ETHER_VALUE");
        ...
        callerIsSender
    {
        ...
        require(amount > 0, "MINIMUM_MINT_NOT_REACHED");
        require(amount <= MAX_PUBLIC_MINT_PER_TX, "MINT_LIMIT_REACHED");
        require(
            PUBLIC_SALE_MINT_PRICE * amount <= msg.value,
