    ...
    NativeMetaTransaction
{
    ...
    function transferRoyalty(Order memory sell, uint256 price) internal returns (uint256) {
        if (sell.royaltyData.length > 0) {
            ...
            require(
                ...
                Errors.ROYALITY_DATA_LENGTH_NOT_EQUAL
            );
    ...
    function atomicMatch(
        ...
        require(size > 0, Errors.TARGET_NOT_CONTRACT);
...
library Errors {
  ...
  string public constant ROYALITY_DATA_LENGTH_NOT_EQUAL = "29"; //Royality data length must be equal
  string public constant INVALID_CASHBACK_AMOUNT = "30"; //Royality data length must be equal
  }
