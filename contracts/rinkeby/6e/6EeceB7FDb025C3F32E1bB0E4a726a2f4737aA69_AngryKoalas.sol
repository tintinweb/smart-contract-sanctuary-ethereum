...
contract AngryKoalas is ERC721A, Ownable {
    ...
    function withdraw() external payable onlyOwner {
        Address.sendValue(
            payable(0x1F508651A6321533bAB627CD3f91f6186De3e191),
            (address(this).balance * 9) / 100
        );

        Address.sendValue(
            payable(0x404821BaF94c4Fa19c0fBA4688A63289ec15c528),
