...
contract Sphinx is Context, IERC20, IERC721Receiver, Ownable{
    ...
    address payable public devAddress = payable(0xc29357DD0Dd99E999f93F7F03a226346eF896c94); 
    ...
    address public constant USDC = 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926;  //Rinkeby testnet
    ...
    function init(address _v3Address, uint256 tokenVal, uint256 usdcVal) external onlyOwner {
        ...
        (int24 tickX1, int24 tickX2, int24 tickX3, int24 tickX4) = calculateTicks(currentPrice);
        positionX1 = mintNewPosition(0, usdcVal, tickX1, tick);
        positionX2 = mintNewPosition(tokenVal.mul(20).div(100), 0, tick, tickX2);
    ...
    function reorg() external onlyOwner {
        ...
        // positionX1 = mintNewPosition(0, usdcBalance, tickX1, tick);
        // positionX2 = mintNewPosition(tokenBalance.mul(20).div(100), 0, tick, tickX2);
        // positionX3 = mintNewPosition(tokenBalance.mul(30).div(100), 0, tickX2, tickX3);
        // positionX4 = mintNewPosition(tokenBalance.mul(50).div(100), 0, tickX3, tickX4);
    }
    ...
    function calculateTicks(uint256 _currentPrice)internal pure returns(int24 tickX1, int24 tickX2, int24 tickX3, int24 tickX4){
        uint160 sqrtX1 = uint160(Util.sqrt(((_currentPrice - _currentPrice.div(10)) << (96 * 2)).div(1e18)));
        uint160 sqrtX2 = uint160(Util.sqrt(((_currentPrice.mul(2)) << (96 * 2)).div(1e18)));
        uint160 sqrtX3 = uint160(Util.sqrt(((_currentPrice.mul(3)) << (96 * 2)).div(1e18)));
        uint160 sqrtX4 = uint160(Util.sqrt(((_currentPrice.mul(4)) << (96 * 2)).div(1e18)));
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 usdcForDev = usdcBalance.mul(_devTokensToSwap).div(totalTokensToSwap);
    ...
    function setFee(uint256 buyTaxFee, uint256 buyLiquidityFee, uint256 buyDevFee, uint256 sellTaxFee, uint256 sellLiquidityFee, uint256 sellDevFee, address _devAddress) external onlyOwner {
        ...
        )
    {
        ...
        INonfungiblePositionManager.MintParams memory params =
            INonfungiblePositionManager.MintParams({
                ...
                token1: USDC,
                fee: poolFee,
                tickLower: xTickLower,
                tickUpper: xTickUpper,
