...
contract Genesis is MultisigOwnable, ERC721A, ERC721ABurnable, ERC721AQueryable, PaymentSplitter {
    ...
    uint public WLSaleDate = 1663620300; //1663675200
    uint public ALSaleDate = 1663620900; //1663696800
    uint public SaleDate = 1663621500; //1663700400
    uint public EndSaleDate = 1663622100; //1663711200

    string public baseURI;
    string public unrevealedURI;

    uint private constant METADATAS_LENGTH = 3333; //3333
    uint private constant MAX_TEAM = 333; //333
    uint private constant MAX_SUPPLY_AL = 3200; //3200
    ...
    function winterPublicMint(address _to, uint _quantity) external payable callerIsUser {
        require(block.timestamp > SaleDate - 1, "Public sale is not activated");
        require(block.timestamp < EndSaleDate, "Sale is done");
        require(totalSupply() + _quantity < maxSupply + 1, "Max supply exceeded");
        require(msg.value == _quantity * salePrice, "Wrong payment");
    ...
    function setRandomness(uint256 _randomness) external onlyOwner {
        // TOTO JUST FOR TEST require(randomness == 0, "Already a randomness");
