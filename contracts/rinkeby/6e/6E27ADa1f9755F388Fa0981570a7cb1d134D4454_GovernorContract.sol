...
contract GovernorContract is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCountingSimpleUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable, GovernorTimelockControlUpgradeable, OwnableUpgradeable, UUPSUpgradeable,UUPSBaseContract {
...
// contract GovernorContractV2 is GovernorContract {

//     event AddProposerRole (
//         address proposerRoleAddress
//     );

//     function grantProposerRole(address proposerAddress, address _timelock) public onlyOwner virtual {
//         TimeLock timelock = TimeLock(payable(_timelock));
//         timelock.grantRole(timelock.PROPOSER_ROLE(),proposerAddress);
//         emit AddProposerRole(proposerAddress);
//     }
// }
