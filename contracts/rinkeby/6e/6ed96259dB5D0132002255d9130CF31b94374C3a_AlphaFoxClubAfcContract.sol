...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1657728000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1657641600;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 1500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNWyEmKmeUMXzoezm7fh4WhoB8MenMp7RNLU4QSyxHEJD/";
...
// File: contracts/AlphaFoxClubAfcContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlphaFoxClubAfcContract is RamppERC721A {
    constructor() RamppERC721A("Alpha Fox Club  AFC", "AFC"){}
}
