...
// | $$  | $$ /$$__  $$| $$  | $$| $$_  $$ | $$_  $$ | $$  \ $$| $$  | $$| $$| $$                | $$_____/  | $$ /$$| $$  | $$
// | $$$$$$$/|  $$$$$$$| $$  | $$| $$ \  $$| $$ \  $$| $$  | $$|  $$$$$$/| $$| $$       /$$      |  $$$$$$$  |  $$$$/| $$  | $$
// |_______/  \_______/|__/  |__/|__/  \__/|__/  \__/|__/  |__/ \______/ |__/|__/      |__/       \_______/   \___/  |__/  |__/
//                                                                                                                   
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x19C6f06D3ca908F1B276c13e0e0166bD830D992c];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPzRiro1x8T51Yrdmy8T9Njk3qa3j1ScXuXBG4wzqVGDK/";
...
// File: contracts/BankkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BankkContract is RamppERC721A {
    constructor() RamppERC721A("bankk", "bankk"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/plyGEUjtG1vHfBdaDMBI/contract-metadata";
    }
}