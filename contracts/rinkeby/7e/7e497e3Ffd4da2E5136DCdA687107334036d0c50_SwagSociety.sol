    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    function initialize(
        ...
        whiteListMint.startTime = block.timestamp; // T = NOW FOR TESTING
        whiteListMint.endTime = whiteListMint.startTime + 24 hours;
        whiteListMint.buyLimitPerWallet = 1;
        whiteListMint.remainingTokens = 944;
        whiteListMint.mintPrice = 0 ether;

        publicListMint.startTime = block.timestamp; // T = NOW FOR TESTING
        publicListMint.endTime = publicListMint.startTime + 24 hours;
        publicListMint.buyLimitPerWallet = 3;
        publicListMint.remainingTokens = 936;
        publicListMint.mintPrice = 0.005 ether;

        treasury = 0xfd6C0EDf95eafCf42457e565BF07c38C4fC17a14;
    }
    ...
    */
        ...
        checkSupply(_amount)
    {
        ...
        require(msg.value == _amount * whiteListMint.mintPrice, "WhiteList: Pay exact fees");
    ...
    */
    function publicMint(uint256 _amount) external payable whenNotPaused nonReentrant checkSupply(_amount) {
        require(msg.sender == tx.origin, "PublicMint: Only wallets allowed");
        require(
            block.timestamp > publicListMint.startTime && block.timestamp <= publicListMint.endTime,
            "PublicMint: Sale Closed"
        );
        require(
            _amount + publicMintTracker[msg.sender] <= publicListMint.buyLimitPerWallet,
            "PublicMint: Individual Cap exceeding"
        );
        require(msg.value == _amount * publicListMint.mintPrice, "PublicMint: Pay exact fees");

        publicMintTracker[msg.sender] += _amount;
        publicListMint.remainingTokens -= _amount;
        _mint(msg.sender, _amount);
    ...
    */
    function withdraw() external onlyOwner nonReentrant {
        ...
        address payable receiver = payable(treasury);
    ...
    /**
    @notice Public function to get available funds of msg.sender  
    @return uint256 Available funds in contract of a msg.sender  
    */
    ...
    */
    ...
    /**
    @notice This function is used to set public sale start time    
    @param _time New public sale time       
    */
    function setPublicStartTime(uint256 _time) external onlyOwner {
        publicListMint.startTime = _time;
    }

    /**
    @notice This function is used to set public sale end time  
    @param _time public sale end time     
    */
    function setPublicEndTime(uint256 _time) external onlyOwner {
        publicListMint.endTime = _time;
    }

    /**
    @notice This function is used to set public mintLimitPerWallet   
    @param _cap New public mintLimitPerWallet       
    */
    function setPublicMintLimitPerWallet(uint256 _cap) external onlyOwner {
        publicListMint.buyLimitPerWallet = _cap;
    }

    /**
    @notice This function is used to set public mint supply cap  
    @param _cap New public mint supply cap   
    */
    function setPublicMintSupplyCap(uint256 _cap) external onlyOwner {
        publicListMint.remainingTokens = _cap;
    }

    /**
    @notice This function is used to set public mint price    
    @param _newPrice New public mint price       
    */
    function setPublicMintPrice(uint256 _newPrice) external onlyOwner {
        publicListMint.mintPrice = _newPrice;
    }
    ...
    */
    ...
    /**
    @notice This function is used to set treasury address   
    @param _address New whiteList list supply cap    
    */
...
contract Whitelist is EIP712Upgradeable {
    string private constant SIGNING_DOMAIN = "SwagSociety";
    ...
    @notice This is initializer function is used to initialize values of contracts  
    */
    function __SwagSocietySigner_init() internal initializer {
