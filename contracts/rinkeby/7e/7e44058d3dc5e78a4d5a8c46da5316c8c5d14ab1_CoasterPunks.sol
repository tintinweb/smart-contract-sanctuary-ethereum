...
contract CoasterPunks is ERC721, Ownable {
  ...
  address cp = 0x3f93cf7335c167861EbDd2d5224438907A8BE0a5;
  address dreamydesign = 0x04FE9F8f92AC03D463a9809b7badeB19A76457e2;
...
*/
  ...
  function withdraw() external onlyOwner {
        ...
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(cp).transfer((balance * 990) / 1000);
        payable(dreamydesign).transfer((balance * 5) / 1000);
        payable(dreamydev).transfer((balance * 5) / 1000);
    }
