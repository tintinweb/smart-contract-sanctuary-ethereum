...
contract TestEdf is Ownable, ERC721B {

    using Strings for uint256;

    uint256 public constant AGC_MAX = 10000;
    uint256 public constant AGC_PRICE = 0.00 ether;
    ...
    constructor() ERC721B("Tester", "EDFY") { }
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(supply + tokenQuantity <= AGC_MAX, "EXCEED_MAX_SALE_SUPPLY");
