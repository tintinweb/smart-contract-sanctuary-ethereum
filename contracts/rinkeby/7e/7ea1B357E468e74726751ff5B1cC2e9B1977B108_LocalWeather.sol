...
contract LocalWeather is ERC721A, Ownable {
    ...
    uint16 public constant TOTAL_NFTS = 1800;
    ...
    function batchAirdrop(address[] memory addresses, uint8[] memory quantities) public onlyOwner {
        require(addresses.length <= MAX_BATCH_AMOUNT, "Batch is greater then max amount");
        ...
        require(_totalMinted() + totalQuantity <= TOTAL_NFTS, "Not enough left to airdrop batch");
