...
contract LegengOfFantasy is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    
    string public baseURI = "ipfs://QmUdDD9Si1mELCY1nk7mfxFBwwonfED1CMiDkE17cMQskt"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("Legeng Of Fantasy", "LegengOfFantasy") payable {
        // 剛開始我們先自己 Mint 一個
