...
contract MoonBird420 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxFreeMint = 100;
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount){
    if(msg.sender != owner()){
      ...
      if (totalSupply()+_mintAmount > maxFreeMint){
        ...
        require(addressMintedBalance[msg.sender]+_mintAmount <= maxMintAmountPerWallet, "Max Mint Per Wallet");
      }
    }
