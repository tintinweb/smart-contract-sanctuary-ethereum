...
contract WHIM is ERC721Psi, Ownable {
  using Strings for uint256;
  ...
  constructor(bytes32 merkleroot) ERC721Psi('WHIM', 'WHIM') {
    root = merkleroot;
  }
  ...
  function mint(bytes32[] calldata _proof) external {
    ...
    function adminMint(uint amount) public {
    ...
    returns (string memory)
  {
    ...
    if (!revealed)
      return
        'https://arweave.net/45lpkjha6Yi1NtDtE5ZmaWJybBEOjtFCZ_2Swr5_jig/3.json';
