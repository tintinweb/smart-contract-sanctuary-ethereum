...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    ...
    buildings.push(Building("House4",1,1,2,7,0,-7));
    buildings.push(Building("House5",2,3,1,-9,0,-9));
    buildings.push(Building("House6",1,3,3,-4,0,2));
    buildings.push(Building("House7",2,5,2,-2,5,0));
    buildings.push(Building("House8",2,6,1,-10,0,4));
    buildings.push(Building("House9",4,1,4,5,0,0));
    buildings.push(Building("House10",3,1,3,-4,0,-5));
    buildings.push(Building("House11",2,2,3,-10,0,0));
    buildings.push(Building("House12",3,2,2,-3,0,-2));
  }
