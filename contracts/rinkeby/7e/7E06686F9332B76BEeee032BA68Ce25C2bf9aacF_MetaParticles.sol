    ...
    ERC1155Supply
{
    ...
    function setRevealed(bool _state) public {
        require(
            ...
            "Must have admin role to reveal colelction"
        );
        revealed = _state;
    }
    ...
    function setCost(uint256 _cost) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "Must have admin role to set cost"
        );
        cost = _cost;
    }
    ...
    function setMaxMintAmountPerTx(uint256 _maxMintAmountPerTx) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "Must have admin role to set max mint amount per transaction"
        );
        maxMintAmountPerTx = _maxMintAmountPerTx;
    }
    ...
    function setHiddenMetadataUri(string memory _hiddenMetadataUri) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "Must have admin role to set hidden metadata uri"
        );
    ...
    function setMerkleRoot(bytes32 _merkleRoot) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "Must have admin role to set merkle root"
        );
    ...
    function setWhitelistMintEnabled(bool _state) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "Must have admin role to enable whitelist mint"
        );
