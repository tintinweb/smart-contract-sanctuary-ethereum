...
contract AmazingPandaverse is Ownable, ERC721, VRFConsumerBaseV2 {
  ...
  function adminMint(address to, uint16 numberOfTokens) public {
    bool isAdmin;
    ...
    require(isAdmin, "adminMint: msg.sender is not admin address");
  ...
  function buyPublic(uint16 numberOfTokens) public payable {
    ...
    require(publicMinted[msg.sender] + numberOfTokens <= 3, "Mint limit exceeded");
    ...
    publicMinted[msg.sender] = publicMinted[msg.sender] + numberOfTokens;
  ...
  // function setAdmins(address[] memory members) public onlyOwner {
