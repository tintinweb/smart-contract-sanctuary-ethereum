  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xF328EA4510bBC085C1267134980C5F35F2c1aCe9);
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 2");
    ...
    // File: contracts/valentinePassContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ValentinePassContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("VALENTINE PASS", "VDAY", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmXiw2Ao8gc6bsLYiK7kcYpUKUwZMYbyfduieDbVcDcVBz/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/nFlNdP9gr2MdktuYWvFd/contract-metadata";
        }
    }