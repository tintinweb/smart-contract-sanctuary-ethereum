...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        Ownable
    {
        ...
        string private IPFSTokenURI = "ipfs://QmWdtfUhNk3sziLQhEQp1SFfgEA7X2Ty3HVHKDrrMaFmzJ/";
        ...
        constructor(
            ...
            payableAddresses.push(0xc274F2e0969704fA509A09203f6349449525fD9F);
      ...
      require(mintingOpen == true, "Minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 100");
    ...
    // File: contracts/TestdemoContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract TestdemoContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("test demo", "SNEK", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/DKgyefeK1R3YofUAUg23/contract-metadata";
        }
    }