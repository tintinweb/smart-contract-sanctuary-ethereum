...
abstract contract Withdrawable is Ownable {
  address[] public payableAddresses = [0x8aeAf56799F6001e69bDf66F490cf7693c514CDE];
...
abstract contract ERC721A is 
    ...
    ) ERC721Contract(tokenName, tokenSymbol, 1, 3333 ) {}
...
contract OgresHoodwtfContract is ERC721A {
    constructor() ERC721A("OgresHoodwtf", "OGRE"){}
