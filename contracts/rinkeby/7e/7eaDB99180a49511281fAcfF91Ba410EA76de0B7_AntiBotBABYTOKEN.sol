...
contract AntiBotBABYTOKEN is ERC20Upgradeable, OwnableUpgradeable, IAntiBotBabyToken {
  ...
  constructor() {
    ...
    // uint256 totalSupply_ = 560000000;
    // swapTokensAtAmount = totalSupply_.mul(2).div(10**6); // 0.002%

    // address temp = address(new BABYTOKENDividendTracker());
    // implementation = temp;

    // dividendTracker = BABYTOKENDividendTracker(payable(Clones.clone(temp)));
    // dividendTracker.initialize(rewardToken, 55000);
    ...
    // _marketingWalletAddress = 0x101Db50a6c23E9B3942845772008A13837cA67F5;
    // // exclude from receiving dividends
    // dividendTracker.excludeFromDividends(address(dividendTracker));
    // dividendTracker.excludeFromDividends(address(this));
    // dividendTracker.excludeFromDividends(0x9C63417d9408DCc6c082bBbe8338Edb54791c8Fb);
    // dividendTracker.excludeFromDividends(address(0xdead));
    // dividendTracker.excludeFromDividends(address(_uniswapV2Router));
    // // exclude from paying fees or having max transaction amount
    // excludeFromFees(0x9C63417d9408DCc6c082bBbe8338Edb54791c8Fb, true);
    ...
    //     */
    // _mint(0x9C63417d9408DCc6c082bBbe8338Edb54791c8Fb, totalSupply_);
    // transferOwnership(0x9C63417d9408DCc6c082bBbe8338Edb54791c8Fb);
  }
