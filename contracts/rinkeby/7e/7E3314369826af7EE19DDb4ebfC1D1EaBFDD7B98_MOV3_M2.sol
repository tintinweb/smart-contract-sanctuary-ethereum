...
contract MOV3_M2 is ERC721, Ownable { // TODO: contract & token name/symbol
    ...
    constructor(uint maxSupply, uint reserved, uint _MintPrice, uint _DiscountedMintPrice) ERC721(unicode"MOVΞ M2", "M2") {
        MaxSupply = maxSupply;
        Reserved = reserved;
    ...
    // TODO: set mint price & total public/reserved mints
    ...
    uint public immutable Reserved;

    /// Cost per public/whitelist mint
    uint public immutable MintPrice;

    /// Cost per whitelist mint that is discounted
    uint public immutable DiscountedMintPrice;
    ...
    address signer = 0x871dFcF21512f398d6a6EA7748a10D66578efd94; // M1:0x871dFcF21512f398d6a6EA7748a10D66578efd94  M2:0x82F257B66120F3F9e9C822609502BBB29417AA61
    ...
    function withdraw() external onlyOwner {
        (bool success,) = address(0) /* TODO: add dev address */.call{ value: address(this).balance * 3 / 100}("");
        require(success, "Could not send funds to dev");

        (bool success1,) = msg.sender.call{ value: address(this).balance }("");
        require(success1, "Could not send funds to owner");
    }
