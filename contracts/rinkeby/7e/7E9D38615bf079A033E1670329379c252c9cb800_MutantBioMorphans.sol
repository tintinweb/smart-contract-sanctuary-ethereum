...
contract MutantBioMorphans is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard, IERC2981 {
  ...
  uint256 public constant SALE_PRICE = 1500000000000000; // 0.065 ETH
  uint256 public constant EVOLVE_PRICE = 250000000000000; // 0.025 ETH
  uint8 public constant MINT_BATCH_LIMIT = 5; // Max number of Tokens minted in a single txn
  uint8 public constant RESERVED_GIVEAWAYS = 2; // Tokens reserved for giveaway list
  ...
  uint16 public constant MAX_TOKENS = 10; // Max number of token sold in sale
  ...
  function evolve(uint256 tokenId) payable public {
  ...
  function advanceStage() onlyOwner public {
  ...
  function setRedeemMerkleRoot(bytes32 _root) public onlyOwner {
  ...
  */
  ...
  function withdrawTokens(address _tokenContract) public nonReentrant onlyOwner {
