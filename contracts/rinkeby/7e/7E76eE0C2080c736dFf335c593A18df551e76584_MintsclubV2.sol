...
contract MintsclubProxy is ERC1155Upgradeable, UUPSUpgradeable, OwnableUpgradeable
{
    ...
    // constructor(string memory _name)ERC1155Upgradeable("") 
    // {
    //     setName(_name);
    // }
    ...
    function _setURI(uint256 tokenId , string memory tokenURI) internal virtual
    {
        ...
        emit URI(uri(tokenId), tokenId); // iska event kahan ha  ?
    }
    ...
    function mintBatch(address to, uint256[] memory amounts, string[] memory tokenUris, bytes memory data)public
    {
        ...
        for (uint i = 0; i < amounts.length; i++){
         ...
         _mintBatch(to, tokenId, amounts, data);
