...
contract FundMe {
    ...
    //address for price Feed for the aggregator
    AggregatorV3Interface priceFeed;

    // the first person to deploy the contract is
    // the owner
    constructor(address priceFeed_address) public {
        owner = msg.sender;
    ...
    //0x8A753747A1Fa494EC906cE90E9f37563A8AF630e address for rinkeby chain
