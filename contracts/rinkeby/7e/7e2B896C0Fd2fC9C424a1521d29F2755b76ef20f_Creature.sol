...
contract Creature is ERC721URIStorage, Ownable {
    ...
    constructor(uint256 _fee) ERC721("Creature", "CRE") {
        maxSupply = 5000;
        fee = _fee;
    }

    function mintCreature(string memory tokenURI) public payable {
        require(msg.value >= fee, "Not enough ETH");

        require(_tokensCounter.current() < maxSupply, "Token not available");
