...
///    Reentrancy in MiniMeToken.approve(address,uint256) (gnx.sol#314-335):
///    	External calls:
///    	- assert(bool)(Controller(controller).onApprove(msg.sender,_spender,_amount)) (gnx.sol#326)
///    	State variables written after the call(s):
///    	- allowed[msg.sender][_spender] = _amount (gnx.sol#332)
///    Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#reentrancy-vulnerabilities-1
    ...
    function approve(address _spender, uint256 _amount) returns (bool success) {
        ...
        allowed[msg.sender][_spender] = _amount; // 'allowed' is the only parameter that has write permssion ('controller'=read only). Can 'allowed' set new 'msg.sender' as '_spender' and control '_amount'?. One strategy is to make the external call to 'assert(Controller)' and update the contract state before call is finished. 
