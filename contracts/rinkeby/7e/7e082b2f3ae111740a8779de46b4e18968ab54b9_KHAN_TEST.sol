...
contract KHAN_TEST is NFTokenMetadata, Ownable {
  ...
  address fee1 = 0x44D393C81d3bc2Fd6e3DfE44C8232EB83608aa2f;
  address fee2 = 0x44D393C81d3bc2Fd6e3DfE44C8232EB83608aa2f;
  address fee3 = 0x44D393C81d3bc2Fd6e3DfE44C8232EB83608aa2f;
  address fee4 = 0x44D393C81d3bc2Fd6e3DfE44C8232EB83608aa2f;
...
function mintNFT(address _to, uint256 qty) payable public safe {
    ...
    require(_lastTokenId + qty <= 3000, "Sold out"); //here the total number of nft
