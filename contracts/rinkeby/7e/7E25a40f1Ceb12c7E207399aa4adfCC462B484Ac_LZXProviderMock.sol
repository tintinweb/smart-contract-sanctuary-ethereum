...
interface IXProviderMock {
  ...
  function xSend(uint256 _value) external payable; // sending a (permissioned) value crosschain.
  ...
  function xTransfer(address to, address asset, uint32 originDomain, uint32 destinationDomain, uint256 amount) external payable; // transfer funds crosschain.
