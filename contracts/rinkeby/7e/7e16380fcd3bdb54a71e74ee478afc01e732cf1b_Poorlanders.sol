...
contract Poorlanders is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmaGB3PQAtrDXLFuJPJDwSUvAyu1wmLmy3gwXsTUp7PPwT";
    ...
    constructor(
    ) ERC721A("PL", "Poorlanders", 100, maxSupply) {
    }
