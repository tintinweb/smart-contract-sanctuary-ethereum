...
// PlaySide Contracts
import "./PetsSettingsG2.sol";
import "../PetsErrorCodes.sol";
import "../PetsEvents.sol";


contract BeansPetsGen2 is 
	ERC721APausable, 
	Ownable, 
	PetsSettingsG2 {
    ...
    function mintPurchase(uint256 _mintAmount) public payable whenNotPaused {
        ...
        if (PetsSettingsG2.publicMintActive == false) { 
            revert PetsErrorCodes.PublicMintNotActive();
		}
        ...
        if (amountMinted + _mintAmount > PetsSettingsG2.maxMintPerWallet)
            revert PetsErrorCodes.MaxAmountMinted(
                PetsSettingsG2.maxMintPerWallet,
        ...
        // Fire event to track for analytics
        emit PetsEvents.PetPurchased(msg.sender, _mintAmount, msg.value);
    }

    /// @dev Checks all of the requires in order to allow a user to mint a token.
    function CheckRequires(uint256 mintAmount) internal view {
        // Total Supply
        uint256 supply = _totalMinted();

        // Check Not Sold Out
        if (supply + mintAmount > PetsSettingsG2.maxSupply) {
            revert PetsErrorCodes.SoldOut();
		}

        // Check price of this message
        if (msg.value < (mintCost * mintAmount)) { 
            revert PetsErrorCodes.InsufficientFunds(mintCost, msg.value);
		}
    }
...
contract PetsSettingsG2 is AccessControl, Roles {
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // *                        DYNAMIC
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    string public hiddenURI =
        "https://s3.us-west-1.amazonaws.com/dwtd.playsidestudios-devel.com/pets_gen2/hidden_M914YzdVevjh1R9EgKLf4Q/GNKehLmAU2NSBPCOWcwVGw/HiddenPet.json";
