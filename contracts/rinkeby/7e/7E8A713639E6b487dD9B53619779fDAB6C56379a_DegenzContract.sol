...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8A796ABAAD3861E741abA53684286440F7081434];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRpbwHheBwdnRjJo8EvrfZuZNdpr6omCRbTChqaaiWo7m/";
...
contract DegenzContract is RamppERC721A {
    constructor() RamppERC721A("Degenz", "RAMPP"){}
}
