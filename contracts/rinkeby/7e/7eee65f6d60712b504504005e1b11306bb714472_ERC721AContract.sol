...
contract ERC721AContract is ERC721A, Ownable {
    ...
    // }
    address private OWN_ADDRESS = address(0x0C44649da465B93D3CB1faeceaB225fc078C27bF);

    constructor(
    ) ERC721A("GMBH Token", "GMBH")
    {
        launchpassId = 1;
        uri = "https://google.com.sg";
        maxSupply = 8888;
        maxPerWallet = 88;
        maxPerTransaction = 8;
        preSalePrice = 1;
        pubSalePrice = 1;
        transferOwnership(OWN_ADDRESS);
    }
