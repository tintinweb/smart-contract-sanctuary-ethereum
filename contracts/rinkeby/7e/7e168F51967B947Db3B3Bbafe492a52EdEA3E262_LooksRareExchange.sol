...
library SignatureChecker {
    ...
    function verify(
        ...
        console.log("Inside signatureChecker, verify");
        ...
        if (Address.isContract(signer)) {
            ...
            bytes32 stuff = IERC1271(signer).isValidSignature(digest, abi.encodePacked(r, s, v));
            emit Check(hash, signer, v, r, s, domainSeparator, stuff);
