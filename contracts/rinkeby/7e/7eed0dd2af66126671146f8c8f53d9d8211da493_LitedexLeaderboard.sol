...
contract LitedexLeaderboard is TimeCrowdsale{
    ...
    modifier isNotZeroAddress {
        require(msg.sender != address(0), "Litedex: address is zero address");
        _;
    }
    ...
    function alreadyClaim(address account) public view isNotZeroAddress returns(bool){
    ...
    function getCustomerData(address account) public view isNotZeroAddress returns(bytes3 referralId,
        uint totalReferred,
        uint totalReferredUsd,
        uint usdPurchased,
        uint tokenPurchased,
    ...
    function getId(address account) public view isNotZeroAddress returns(bytes3 id){
        (bytes3 rid, , , , , , ) = litedexico.accounts(account);
        return rid;
    }
    function getTotalReffered(address account) public view isNotZeroAddress returns(uint){
        (, uint totalReferred, , , , , ) = litedexico.accounts(account);
        return totalReferred;
    }
    function getTotalRefferedUsd(address account) public view isNotZeroAddress returns(uint ){
        (, , uint totalReferredUsd, , , , ) = litedexico.accounts(account);
        return totalReferredUsd;
    }
    function getTokenPurchase(address account) public view isNotZeroAddress returns(uint){
        (, , , , uint tokenPurchased, , ) = litedexico.accounts(account);
        return tokenPurchased;
    }
    function getUsdToConverted(address account) public view isNotZeroAddress returns(uint ){
    ...
    function getBnbToConverted(address account) public view isNotZeroAddress returns(uint){
    ...
    function getPoint(address account) public view isNotZeroAddress returns(uint point){
