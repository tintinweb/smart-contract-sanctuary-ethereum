...
import "../interfaces/Precog/ICampaign.sol";
import "../interfaces/IStakBank.sol";
import "./PrecogCampaign.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/math/SafeMathUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/utils/PausableUpgradeable.sol";

contract PrecogCampaignFactory is OwnableUpgradeable, PausableUpgradeable {
    ...
    function registerCampaign(
        ...
        bytes memory bytecode = type(PrecogCampaign).creationCode;
...
contract PrecogCampaign is ReentrancyGuard, Pausable, PrecogTierSystem, Blacklist {
        ...
        returns (uint256 etherToTokenAmount)
    {
        ...
        etherToTokenAmount = _weiAmount * tokenPrice / ethPrice;
    }
