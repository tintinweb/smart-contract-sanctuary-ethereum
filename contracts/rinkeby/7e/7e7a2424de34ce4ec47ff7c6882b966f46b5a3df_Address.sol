...
// File: https://github.com/FrankNFT-labs/ERC721F/blob/v1.0.2/ERC721F.sol
...
contract WhatDoesTheFoxSay is ERC721F {
    ...
    address private constant FRANK = 0xf6a58384109AFb23522D3b9A068C64f9850C91C3;
    
    constructor() ERC721F("What does the fox say?", "FOXY") {
        setBaseTokenURI("0xf6a58384109AFb23522D3b9A068C64f9850C91C3"); 
        _safeMint(FRANK, 0);
    }
     ...
     */
    function mintTo(address to,uint numberOfTokens) public onlyOwner {    
