...
contract FryHeadsNft is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    // We give 20% to all charity proportionnaly to what people have choosen
    uint256 payableToCharity = address(this).balance / 100 * 20;
    ...
    if (donationCount > 0) {
      ...
      for (uint i = 0; i < 6; i++) {
        ...
        uint256 toPay = 0;
        toPay = payableToCharity / 100 * (donationCount / 100 * charities[i].count);
