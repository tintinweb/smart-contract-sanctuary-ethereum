...
contract Snake is ERC721, ERC2981, Ownable {
    ...
    ICalculator public calculator = ICalculator(0xDDDFb40273703045259788d6C8d8EdF5b61c442E);
    ...
    constructor() ERC721("Snake", "SNAKE") {
        _setDefaultRoyalty(address(this), 200);
        setDiscount(80);
    ...
    /**
     * Takes an array of numbers from 1-5. length
     */

    function buySnake(uint[] memory schemeIds) public payable { // length of schemeIds is the number of token to mint
        ...
        require(tokenSupply.current() + totalMints <= maxSupply, "at limit");
...
library SnakeLib {
    ...
    function getStyle(ColorScheme memory scheme) internal pure returns(string memory ) {
        ...
        bytes memory styleOne = abi.encodePacked(
        ...
        bytes memory styleTwo = abi.encodePacked( 
            ...
            return string(abi.encodePacked(styleOne, styleTwo));
