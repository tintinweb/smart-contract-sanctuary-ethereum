...
contract FishChips is ERC20Capped, Ownable {
    ...
    uint256 private _startTime = 1640995200; //2022.01.01-00:00 Zulu
    ...
    function getGenesisFishAddress() public view returns (address) {
    ...
    function claimOne(uint256 tokenId) private {
        ...
        require(claimableTokens > 0, "No tokens to claim"); //TODO: Required?
