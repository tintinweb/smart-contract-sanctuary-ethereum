...
contract StarBlockProxyRegistry is ProxyRegistry {
    ...
    // function setAuthenticationProxy() onlyOwner public 
    // {
    //     require(delegateProxyImplementation == address(0));
    //     // delegateProxyImplementation = addrs;
    // }
...
contract NewOwnedUpgradeabilityStorage {
...
contract AuthenticatedProxy is TokenRecipient, NewOwnedUpgradeabilityStorage {
