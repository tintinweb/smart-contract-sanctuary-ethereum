...
contract Red is ERC20, Ownable {
    ...
    uint256 public cliffLpSellFee;
    
    uint256 public totalBuyFees;
    uint256 public rewardsBuyFee;
    uint256 public operationsBuyFee;
    uint256 public liquidityBuyFee;
    uint256 public cliffLpBuyFee;
    
    uint256 public tokensForRewards;
    uint256 public tokensForOperations;
    uint256 public tokensForLiquidity;
    uint256 public tokensForCliffLp;
    ...
    event CliffWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("Red", "RED") {
        ...
        maxWallet = totalSupply * 7 / 1000; // 0.7% Max wallet

        rewardsBuyFee = 20;
        operationsBuyFee = 30;
        liquidityBuyFee = 20;
        cliffLpBuyFee = 10;
        totalBuyFees = rewardsBuyFee + operationsBuyFee + liquidityBuyFee + cliffLpBuyFee;
        
        rewardsSellFee = 40;
        operationsSellFee = 60;
        liquiditySellFee = 40;
        cliffLpSellFee = 20;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee + cliffLpSellFee;

    	dividendTracker = new DividendTracker();
    	
    	operationsWallet = 0xDca8e1042361514C1C517B0728775A8fe473f0b6; // set as operations wallet
        cliffWallet = 0x81ed317154E4C6E829B0358F59C5578719E95ccB; // set as Cliff LP Wallet
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _cliffLpFee) external onlyOwner {
        operationsBuyFee = _operationsFee;
        rewardsBuyFee = _rewardsFee;
        liquidityBuyFee = _liquidityFee;
        cliffLpBuyFee = _cliffLpFee;
        totalBuyFees = operationsBuyFee + rewardsBuyFee + liquidityBuyFee + cliffLpBuyFee;
        require(totalBuyFees <= 200, "Must keep fees at 20% or less");
    }
    
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _cliffLpFee) external onlyOwner {
        operationsSellFee = _operationsFee;
        rewardsSellFee = _rewardsFee;
        liquiditySellFee = _liquidityFee;
        cliffLpSellFee = _cliffLpFee;
        totalSellFees = operationsSellFee + rewardsSellFee + liquiditySellFee + cliffLpSellFee;
    ...
    function updateCliffWallet(address newCliffWallet) external onlyOwner {
        require(newCliffWallet != address(0), "may not set to 0 address");
        excludeFromFees(newCliffWallet, true);
        emit CliffWalletUpdated(newCliffWallet, operationsWallet);
        cliffWallet = newCliffWallet;
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on sell
                ...
                tokensForCliffLp += fees * cliffLpSellFee / totalSellFees;
            }
            ...
            // on buy
                ...
                tokensForCliffLp += fees * cliffLpBuyFee / totalBuyFees;
            }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForRewards + tokensForCliffLp;
        ...
        uint256 ethForCliff = ethBalance.mul(tokensForCliffLp).div(totalTokensToSwap - (tokensForLiquidity/2));
        
        uint256 ethForLiquidity = ethBalance - ethForOperations - ethForRewards - ethForCliff;
        ...
        (success,) = address(cliffWallet).call{value: ethForCliff}("");
