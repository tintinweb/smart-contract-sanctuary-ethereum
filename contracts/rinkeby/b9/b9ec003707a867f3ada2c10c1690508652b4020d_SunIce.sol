...
contract SunIce is ERC721Enumerable, Ownable  {
  ...
  function whitelistMint(bytes32 _merkleRoot, bytes32[] calldata _merkleProof, uint256[] calldata _position, uint256 _mintAmount) public payable whitelistMintCompliance(_mintAmount){
