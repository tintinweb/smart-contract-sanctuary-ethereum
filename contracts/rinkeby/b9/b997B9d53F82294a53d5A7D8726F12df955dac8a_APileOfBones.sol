...
contract APileOfBones is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard {
...
// ~~~~~~~~~~~~~~~~~~~~ Burn Functions ~~~~~~~~~~~~~~~~~~~~
  ...
  // Burn user chosen token. 
/*   function burnTokenId(uint _tokenId) public {
    require(ownerOf(_tokenId) == _msgSender(), 'You do not own this token');
