...
**/
contract cujotest is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("cujotest", "CUJO") {
  ...
  uint256 public constant PRICE = 20000000000000000;  //0.02e
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value == PRICE * count, "Too little eth, 0.03 ETH per item"
    );
