...
contract StableLP is Ownable, ReentrancyGuard {
     ...
     */
    function createMALPByUSDT(uint256 _amount) external payable nonReentrant {
    ...
    function createMALPByUSDC(uint256 _amount) external payable nonReentrant {
        uint256 fee = (_amount * feeMalp) / 10**18;
        uint256 MALPAmount = _amount - fee; // it will be calculated by current liquidity ratios
    ...
    function createMALPByDAI(uint256 _amount) external payable nonReentrant {
        uint256 fee = (_amount * feeMalp) / 10**18;
        uint256 MALPAmount = _amount - fee; // it will be calculated by current liquidity ratios
     ...
     */
    function redeemMALPByUSDT(uint256 _amount) external payable nonReentrant {
        uint256 fee = (_amount * feeMalp) / 10**18;
    ...
    function redeemMALPByUSDC(uint256 _amount) external payable nonReentrant {
        uint256 fee = (_amount * feeMalp) / 10**18;
    ...
    function redeemMALPByDAI(uint256 _amount) external payable nonReentrant {
        uint256 fee = (_amount * feeMalp) / 10**18;
     ...
     */
    function USDTtoUSDC(uint256 _amount)
        public
        payable
        minSwap(_amount)
        nonReentrant
    ...
    function USDTtoDAI(uint256 _amount)
        public
        payable
        minSwap(_amount)
        nonReentrant
    ...
    function DAItoUSDT(uint256 _amount)
        public
        payable
        minSwap(_amount)
        nonReentrant
    ...
    function DAItoUSDC(uint256 _amount)
        public
        payable
        minSwap(_amount)
        nonReentrant
    ...
    function USDCtoUSDT(uint256 _amount)
        public
        payable
        minSwap(_amount)
        nonReentrant
    ...
    function USDCtoDAI(uint256 _amount)
        public
        payable
        minSwap(_amount)
        nonReentrant
