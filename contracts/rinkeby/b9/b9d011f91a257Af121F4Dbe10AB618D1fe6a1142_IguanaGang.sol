...
contract IguanaGang is ERC721A, Ownable, ReentrancyGuard {  
    ...
    uint public MAX_SUPPLY_PLUS_ONE = 5556; // TODO
    uint public MAX_WL_PLUS_ONE = 4; 
    uint public MAX_TX_LIMIT_PUBLIC_PLUS_ONE = 3; // TODO
    uint public MAX_PER_ADMIN_MINT_PLUS_ONE = 101; // TODO
    ...
    function mintIguanas(uint256 _amount) external payable {
        ...
        require(_amount > 0 && _amount < MAX_TX_LIMIT_PUBLIC_PLUS_ONE, "Max per TX is 5");
    ...
    function adminMint(uint256 _amount) external onlyOwner {
        uint256 supply = totalSupply();
        require(supply + _amount < MAX_SUPPLY_PLUS_ONE, "Not Enough Supply");
        require(_amount > 0 && _amount < MAX_PER_ADMIN_MINT_PLUS_ONE, "Max per TX is 50");
        _safeMint(msg.sender, _amount);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 dev = (balance * 2) / 100;
        payable(0xBeE49bbFd1555bfDd0e6c1d139E797d2d484278F).transfer(dev);
