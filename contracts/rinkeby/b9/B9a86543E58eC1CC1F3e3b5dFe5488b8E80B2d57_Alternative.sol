...
*/
contract Alternative is Ownable, ERC721, IERC2981 {
    /* -------------------------------------------------------------------------- */
    /*                                   Config                                   */
    /* -------------------------------------------------------------------------- */
    ...
    /**
     * @dev Initializes the Alternative contract by
    ...
    function claim(
        ...
        address whitelistedAddress = whitelistedClaimer;
        if (
            numberOfTokensAllowedToClaim < 1 ||
            (msg.sender != whitelistedAddress &&
        ...
        if (currentTokenId + (numberOfTokensAllowedToClaim - 1) > maxSupply)
