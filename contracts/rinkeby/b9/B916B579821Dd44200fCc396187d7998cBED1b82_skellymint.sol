...
// File: contracts/testskellymint/skellymint.sol
...
contract skellymint is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Skellymint", "SMT") {
    setHiddenMetadataUri("ipfs://QmPB9eAwuScntWTrP5sDXmuC9cwHhgxd1H4UmpmM5RUvgc/hidden.json");
  }
