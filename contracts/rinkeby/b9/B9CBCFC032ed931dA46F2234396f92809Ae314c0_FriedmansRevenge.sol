...
// TODO:: Update constructor args, codename,
contract FriedmansRevenge is ERC721AQueryable, Ownable { // PaymentSplitter {
    using ECDSA for bytes32;

    // Real supply is 9,999. Adds 1 to use < to save gas.
    uint256 public constant MAX_SUPPLY = 10_000;

    // TODO: update with real price
    uint256 public price = 0.001 ether; // For testing, update to real price
    ...
    // TODO: Update ERC721A values
    constructor() ERC721A("Friedmans Revenge", "REVENGE") { // PaymentSplitter(_payees, _shares) {
    }
    ...
    /// @notice Only for testing, public mint without signature verification
    // TODO: remove
    function debugPublicMint(uint _amount) external payable {
      _mint(msg.sender, _amount, "", false);
    }
    ...
    // Reserves 100 for the team for marketing, giveaways, etc.
    function teamMint() external onlyOwner {
      require(!teamMinted, "Already minted");
      require(totalSupply() + 100 < MAX_SUPPLY, 'Exceeds max supply');

      _mint(msg.sender, 100, "", false);
      // `teamMinted` updated after the mint in case _mint gasses out
      teamMinted = true;
    }
