...
contract ShibaTicket is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    function enterDraw(IERC20 token, address to, uint256 amount) public payable {
    ...
    function payWinner() nonReentrant public onlyOwner {
        ...
        // The below will send 90% of the lottery pot to the winner
        players[index].transfer( (address(this).balance / 1000) * 900 );
