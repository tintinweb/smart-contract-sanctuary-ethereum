...
contract NFTStake is TheTok20 {
    // string name = "Yield Farming / Token dApp";
    TheTok20 public thetok;
    ...
    constructor(TheTok20 _thetok) public payable {
        thetok = _thetok;
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        thetok.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        thetok.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public onlyOwner{
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                thetok.transfer(recipient, balance);
            }
        }
    }

    //customAPY airdrop
    function customRewards() public onlyOwner{
        // require(msg.sender == owner, "Only contract creator can redistribute");
    ...
    function claimTst() public {
        ...
        uint256 TTK = 1000000000000000000000;
        uint256 balance = TTK;
        thetok.transfer(recipient, balance);
    }
}
