...
contract MarketV2 is OwnableContract, ReentrancyGuardUpgradeable, IMarketV2 {
    ...
    address originalNftAddress,uint256 originalNftId) internal{
        ...
        lending.createTime = uint40(block.timestamp);
    ...
    function createLendOrder(
        ...
        (uint256 originalNftId,
            ...
            uint16 nonce,
             ,
            uint40 dEnd) = IDoNFTV2(doNftAddress).getDoNftInfo(doNftId);
        ...
        Lending memory lending = Lending(_owner,maxEndTime,nonce,doNftAddress,minDuration,orderType,
        doNftId,paymentToken,uint40(block.timestamp),privateOrderRenter,pricePerDay);
