...
contract Sloth is ERC721, ERC721Enumerable, Ownable {
  ...
  // Constants
  uint256 constant public MAX_SUPPLY = 15;//總量
  uint256 public mintPrice = 0.005 ether;//mint 價錢
  uint256 public whiteListPrice = 0.005 ether;//白名單價錢
  bool public iswhitelist = true;
  uint256 public maxwhitelistBalance=10;//白名單上限
  ...
  constructor() ERC721('Elijah', 'Lee') {}//token名字
