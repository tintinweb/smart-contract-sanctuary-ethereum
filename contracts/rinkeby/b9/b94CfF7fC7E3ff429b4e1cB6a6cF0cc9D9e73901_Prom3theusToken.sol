...
contract Prom3theusToken is BaseToken {
    ...
    address payable commissions =
        payable(0xde3B22caAaD25e65C839c2A3d852d665669EdD5c);
...
abstract contract BaseToken is ERC721, Ownable, ReentrancyGuard {
        ...
        returns (uint256[] memory)
    {
        ...
        while (
            ...
            currentTokenId <= program.maxSupply
        ) {
    ...
    // @dev: INTERNAL VIEWS
    function verifyMerkleProof(bytes32[] calldata _merkleProof, address caller)
        internal
        view
        returns (bool)
    {
