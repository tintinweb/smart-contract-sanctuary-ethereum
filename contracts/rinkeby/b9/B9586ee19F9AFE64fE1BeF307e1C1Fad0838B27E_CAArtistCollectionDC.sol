...
contract CAArtistCollectionDC is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor() ERC721("CAArtistCollectionDC", "CAADC") {
        ...
        _preSalePhase = 2;
        _presaleContracts[0] = 0xA32222a3b57cb5542BECb57341D68A9dAd70523B;
        _presaleContracts[1] = 0x1bEEf8EEc88F731daf1f39389618F67231EC19bf;
        _presaleContracts[2] = 0xf867893a7F5Ec4881795f052cA89d38f868b483d;
    ...
    function mintNFT( uint _preSaleSlot, uint _passTokenId, uint _quantity, address _to ) public payable {
        ...
        if ( _preSalePhase != 0 ) {
            require( _preSaleSlot < _preSalePhase, "M10: membership not valid for mint" );
            require(
