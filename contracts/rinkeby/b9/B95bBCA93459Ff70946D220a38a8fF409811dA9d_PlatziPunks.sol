...
contract PlatziPunksDNA {
    ...
    // This functions is deterministic and should not used in production. See chainlink to consume random data.
    ...
    // Get Attributes
    function _getAccessoriesType(uint256 _dna) public view returns (string memory){
