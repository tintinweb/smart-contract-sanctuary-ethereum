...
contract SillySociety is 
    ...
    // Supply Information
    uint256 public constant OG_SUPPLY = 100;
    uint256 public constant GIFT_SUPPLY = 100;
    uint256 public constant TOTAL_SUPPLY = 300;
    
    // Max Mint Per Tx
    uint256 public constant MINT = 3;
    uint256 public constant MAX_ADDRESS = 3;
    ...
    constructor(bool _revealed, bool _paused, uint256 _publicStart) ERC721A ("SillySociety", "SSOC") PublicSale(_publicStart) {
        revealed = _revealed;
        paused = _paused;
    } 
    ...
    {
        require(totalSupplyOgSale < OG_SUPPLY, "OG Maxed!");
    ...
    function gift(address receivers, uint256 _mintAmount) external onlyOwner nonReentrant {
        require(!paused, "Paused!");
        require(totalSupply() +  _mintAmount <= GIFT_SUPPLY, "Gift Maxed!");
...
contract PublicSale is Ownable {
    ...
    function setTimeStampPublicSale(uint256 _publicStart) external onlyOwner {
        publicStart = _publicStart;
    }
