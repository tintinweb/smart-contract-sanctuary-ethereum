...
contract BluechipsBooster is IBluechipsBooster, ERC721, AdminUtility, TerminalUtility {
    ...
    uint256 public constant PROOF_ETH = 1e18; // stake 1 ETH to proof
    ...
    /**
        @notice
        People who have the bluechip nfts can create a proof which promises that they will hold the nfts for 30 days
    ...
    function createProof(address _bluechip, uint256 _tokenId) external payable override {
        ...
        // @TODO should we use function _Mint to save the gas?
    ...
    function createProof(
        ...
        // Encoded based on DAO ID, Bluechips NFT Token Address, and TokenID
        ...
        uint256 _weight = _getNoZero(customBoosterWeights[_projectId][_from]) * customMultiplierOf[_projectId][_bluechip];
