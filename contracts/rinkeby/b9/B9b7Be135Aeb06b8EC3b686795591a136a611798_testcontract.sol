...
contract testcontract is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public cost2 = 0.5 ether; //here you change phase 2 cost
  ...
  uint256 public maxMintAmountPerTxPhase2 = 50; //decide how many NFT's you want to mint with cost2
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("Harry O Bear test", "HOB")  { //change this line to your full and short NFT name
    seturi(_uri);
