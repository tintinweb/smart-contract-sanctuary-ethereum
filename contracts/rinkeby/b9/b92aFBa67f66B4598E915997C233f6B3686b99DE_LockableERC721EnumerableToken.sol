...
contract LockableERC721EnumerableToken is IToken, ERC721Enumerable, Ownable {
    ...
    /**
     * @dev Admin: set TokenURI
     */
    function setTokenURI(string calldata _tokenURI) external onlyAllowed {
        uri = _tokenURI;
    }
    ...
    */
    function tokenURI(uint256 _tokenId) public view override(IToken, ERC721) returns (string memory) {
        ...
        string memory slash = "/";
        return string(abi.encodePacked(uri, folder, slash, file));
    }
