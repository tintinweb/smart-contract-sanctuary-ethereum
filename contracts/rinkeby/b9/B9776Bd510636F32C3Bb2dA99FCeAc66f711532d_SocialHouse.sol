...
contract SocialHouse is ERC1155, ReentrancyGuard, Ownable {
    ...
    function _mint(
        ...
        stack[devteam] = stack[devteam] + cost * DEV_TEAM_ROYALTY / 10000;
        stack[artist]  = stack[artist] + cost * ARTIST_ROYALTY / 10000;
        stack[owner()] = stack[owner()] + cost * (10000 - DEV_TEAM_ROYALTY - ARTIST_ROYALTY) / 10000;
    }
