...
contract NFTMarketplace is Pausable, ERC721Holder  {
    ...
    constructor(address _auraAddress)  Ownable() {
 ...
 OfferAURA  [] public OfferAURAarray;
    ...
    mapping(bytes32 => OfferAURA) public offerByBuyerAURA;  //offer
...
// for royalties 
 ...
 //...........................................................................................................................................................................    
    ...
    //create order
    function createOrder(address _tokenAddress,uint256 _tokenId, uint256 _ethPrice, uint _auraPrice) public whenNotPaused
    {
    ...
    function createAuctionByEth(address _tokenAddress,uint256 _tokenId, uint256 _minBid,uint _expiryTime ,string memory _paymentType) public whenNotPaused
    {
        _createAuction(_tokenAddress,_tokenId,  _minBid, _expiryTime,_paymentType);
    }

    function createAuctionByAura(address _tokenAddress,uint256 _tokenId, uint256 _minBid,uint _expiryTime,string memory _paymentType) public whenNotPaused
    {
        _createAuction(_tokenAddress,_tokenId,  _minBid, _expiryTime,_paymentType);
    }
  ...
  //...........................................................................................................................................................................    
   // CANCEL AUCTION 
    ...
    //    function cancelAuction(address _nftAddress,uint256 _tokenId) public whenNotPaused
    // {
    //     //bytes32 tokenId = keccak256(abi.encodePacked(_tokenId,_nftAddress));
    ...
    //     _cancelAuction(_nftAddress,auctionData.auctionId,_tokenId,msg.sender);
    // }

    // function _cancelAuction(address _nftAddress,bytes32 _auctionId,uint256 _tokenId, address _seller) internal
    // {
...
//  //...........................................................................................................................................................................    
    ...
    //Update Order
    function updateOrder( address _tokenAddress,uint256 _tokenId, uint256 _ethPrice, uint256 _auraPrice) public whenNotPaused
    {    Order memory order = orderByTokenId[_tokenAddress][_tokenId];
...
//     //Buy with ETH
    function safeExecuteOrderByEth( address _tokenAddress,uint256 _tokenId) public whenNotPaused payable
    {
...
//     //Buy with $AURA
    function safeExecuteOrderByAura( address _tokenAddress,uint256 _tokenId) public whenNotPaused
    { 
        Order memory order = _getValidOrder( _tokenAddress,_tokenId);
...
function makeOfferAURA(address _tokenAddress,uint256 _amount,uint256 _tokenId,uint256 _time) public 
    {

        bytes32 offerId = keccak256(abi.encodePacked(_tokenAddress,_amount,_tokenId,msg.sender));
   
        offerByBuyerAURA[offerId]=OfferAURA({
    ...
    function acceptOffer(address _tokenAddress,uint256 tokenId,uint256 _amount,address _buyer) public {
        ...
        require(offerByBuyerAURA[offerId].offerid==offerId,"invalid offer");
        require(offerByBuyerAURA[offerId].expiry> block.timestamp,"offer expires");

        IERC721 tokenRegistry = IERC721(_tokenAddress);
        address tokenOwner=tokenRegistry.ownerOf(tokenId);
        require(tokenOwner==msg.sender,"user is not owner");
        address buyerAddress=offerByBuyerAURA[offerId].buyerAddress;
        ...
        delete offerByBuyerAURA[offerId];
        ...
        returns (uint256 total)
    {
        ...
        for (uint256 index = 0; index < OfferAURAarray.length; index++) {
            if (OfferAURAarray[index].tokenid == _tokenid && OfferAURAarray[index].contractaddress == _ct ) {
                countt += 1;
            }
        }
        return countt;
...
// // returns the total  offers data of the owner
    ...
    function getoffersbyAURA(address _contractaddress,uint256 _tokenid)
        public
        view
                      ...
                      
    {
        ...
        for (uint256 index = 0; index < OfferAURAarray.length; index++) {
         if (OfferAURAarray[index].tokenid == _tokenid && OfferAURAarray[index].contractaddress == _contractaddress) {

            
                _amount         [dyanamicIndex]         = OfferAURAarray [index].amount;
                _time           [dyanamicIndex]         = OfferAURAarray [index].expiry;
                _buyeraddress   [dyanamicIndex]         = OfferAURAarray [index].buyerAddress;
                contractAddress [dyanamicIndex]         = OfferAURAarray [index].contractaddress;
                tokenId         [dyanamicIndex]         = OfferAURAarray [index].tokenid;
