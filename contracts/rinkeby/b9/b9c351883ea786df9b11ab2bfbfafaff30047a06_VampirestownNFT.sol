...
contract VampirestownNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 currentSupply; // Usunalem totalSupply()
    string baseURL = ""; // ipfs://QmPrzzcNwty3qMhAYe7TzRFwUvCcr8sCXUUrX9Sy3UYN9V/
                         // ipfs://Qmdg26VQG7jRmocSAD5fWMvLfevdpSc36BrHr84MkbXUiN/

    string ExtensionURL = ".json";

    uint256 mintDate;

    // 0xEB734c99A3277A1CEc8DFB431C1B24ECfA267AFE
    // olej, to moj adres
    ...
    constructor(uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721A("vampirestown", "VAMPIRE") {
        ...
        mintDate = 1654285724; // Ustaw date! https://www.unixtimestamp.com 
    }

    function checkCost(uint256 _supply) internal pure returns (uint256 _price){
        return _supply < 2500 ? 0 ether : 0.005 ether;
    }
    ...
    // ================== Mint Function =======================
      ...
      function mint(uint256 _mintAmount) public payable{
          ...
          require(msg.value >= checkCost(currentSupply) * _mintAmount, "Are your fangs too short, or you dont have enough funds?"); //  nie dziala? ? ? ? ? ? ? ? ? ? ? ? cszy dziala :OO dziala ale nie wiadomo czy dziala uwu
                                                                                                                                              //  nvm nic nie zmienia, powyzej 200 jak sie na raz mintuje gdy cost !=0 to jest blad
    ...
    function whatscurrentSupply() public view returns (uint256){
