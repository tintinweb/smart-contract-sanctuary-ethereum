...
contract TestPass is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    string private _currentBaseURI;

    uint32 public constant MAX_SUPPLY = 5_555;
    ...
    constructor() ERC721A("Testing Pass", "TPass") 
        PaymentSplitter(_team, _teamShares) // Split the payment based on the teamshares percentages
        ReentrancyGuard() // A modifier that can prevent reentrancy during certain functions
    {
        _currentBaseURI = "ipfs://QmYUuwLoiRb8woXwJCCsr1gvbr8E21KuxRtmVBmnH1tZz7/hidden.json";
    }
