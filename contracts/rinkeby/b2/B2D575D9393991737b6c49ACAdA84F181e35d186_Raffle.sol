...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    event WinnerPicked(address indexed winnerl);
    ...
    constructor(
        ...
        uint256 interval
    ) VRFConsumerBaseV2(vrfCoordinatorV2Addr) {
    ...
    /// @dev Function called by the Chainlink Keeper nodes.
    /// Returns true when:
    /// 1. The time interval has passed.
    /// 2. The lottery has at least one player and some ETH.
