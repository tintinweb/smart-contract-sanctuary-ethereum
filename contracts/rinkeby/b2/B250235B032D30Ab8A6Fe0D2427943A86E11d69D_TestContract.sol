...
contract TestContract is  Ownable, ERC721A, ReentrancyGuard, PaymentSplitter {
    ...
    address[] private _team = [
        0x92B2F31F400C393b7DE3426057b6895A11cb9926,
        0x5517245edBdd6B59A86C0148c81681D99F025651
    ];

    uint256[] private _teamShares = [75000,25000];

    constructor() ERC721A("TestContract123456", "TT")  PaymentSplitter(_team, _teamShares) {
        deployer = msg.sender;
    }
    ...
    function changePresalePrice(uint256 newPrice) public onlyOwner returns(uint256) {
    ...
    function checkPublicAmount(address wallet) public view returns (uint256) {
        return _publicMintAmount[wallet];
    }
    ...
    function mint(uint numberOfTokens) external payable {
        ...
        require(numberOfTokens + checkPublicAmount(msg.sender) <= mintLimit, "Too many public mint for this wallet");
