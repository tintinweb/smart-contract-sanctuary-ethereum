...
contract WhiteReserveNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_PUBLIC = 5000;
    uint256 public MAX_PUBLIC_PLUS_ADMIN = 5555;
    uint256 public MAX_ALLOWLIST_MINT = 1;
    ...
    function adminMint(address recipient, uint256 _teamAmount) external onlyOwner {
        require(totalSupply() + _teamAmount <= MAX_PUBLIC_PLUS_ADMIN, "Max supply exceeded!");
        _safeMint(recipient, _teamAmount);
        emit ReservedToken(msg.sender, recipient, _teamAmount);
    }
