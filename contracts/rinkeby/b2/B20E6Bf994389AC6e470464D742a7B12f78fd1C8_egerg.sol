...
contract egerg is ERC721, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

    uint256 public totalSupply = 0;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/569/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/569/contract-uri";

    address public tokenfyAddress = 0x0000000000000000000000000000000000000000;
	...
	uint256 public pricePerToken = 2000000000000000000;
    uint256 public tokenfyPrice = 5000000000000000000;
	...
	uint256 public presalePricePerToken = 5000000000000000000;
    uint256 public tokenfyPresalePrice = 4000000000000000000;
    uint256 public presaleEndDate = 1644585475;
	...
	constructor(address _signerAddress) ERC721("4", "fgbf") {
