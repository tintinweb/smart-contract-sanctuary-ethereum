...
contract TEST1230943 is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  function withdraw() external onlyOwner nonReentrant {
    ...
    Address.sendValue(payable(0xa7f2F341786E44B26A75B59cb49Ce9bE41e56529), split);
  }
