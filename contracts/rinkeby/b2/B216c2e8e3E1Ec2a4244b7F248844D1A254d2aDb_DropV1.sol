...
contract DropV1 is ERC721AB {
     ...
     */
    function unclaimedSupply(uint256 _dropId) public view returns (uint256) {
     ...
     */
    function price(uint256 _dropId) public view returns (uint256) {
        IAnotherblockV1.Drop memory drop = IAnotherblockV1(anotherblock).drops(
            _dropId
        );
     ...
     *
     * @param _to : wallet to receive the minted NFT(s)
    ...
    function withdrawAll() external {
        payable(IAnotherblockV1(anotherblock).treasury()).transfer(
...
contract ERC721AB is ERC721Enumerable, ERC721ABErrors, ERC165Storage, Ownable {
    ...
    constructor(
        ...
        // Check that _anotherblock address matches IAnotherblockV1 interface
        if (
    ...
    function _mintAB(
        ...
        IAnotherblockV1(anotherblock).updateDropCounter(_dropId, _quantity);
