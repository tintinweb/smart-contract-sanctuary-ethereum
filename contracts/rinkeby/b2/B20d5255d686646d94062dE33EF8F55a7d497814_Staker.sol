...
contract Staker {
  ...
  modifier notCompleted{
    bool check = exampleExternalContract.check();
    require(!check);
    _;
  }
  ...
  //  require(address(this).balance < threshold, "Amount exceeds the threshold");
  ...
  //cant change and read blockchain in same function, change modifier
  function execute() public payable notCompleted{
    require(timeLeft() == 0,"Deadline not yet met");
