...
contract BAPOrchestrator is ReentrancyGuard, Ownable, IERC721Receiver {
    ...
    uint256 private godBullIndex = 10010;
    ...
    function onERC721Received(
        ...
        require(msg.sender == bapTeenBullsAddr, "Only receive from BAP Teens");
