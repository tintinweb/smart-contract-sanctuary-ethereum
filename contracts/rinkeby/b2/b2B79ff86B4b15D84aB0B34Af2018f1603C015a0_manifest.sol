...
contract manifest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("manifest", "MNT") {
    setHiddenMetadataUri("ipfs://QmVkGLAnpvCnAnY78eMDjUv65jqNDYPVEp1kxrZSEF4M2v/{id}.json");
  }
