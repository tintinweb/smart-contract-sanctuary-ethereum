...
contract InfiniteCycle is ERC1155, Ownable {
    ...
    constructor()
        ERC1155("ipfs://QmVEoaBqmyzxVWg9ZsjdkzN2wSpVxdyQLh7qsHxrv2NYbh/{id}.json")
    {
        name = "Infinite Cycle";
        symbol = "Water";
        totalHolders = 0;
    ...
    function mintWater(uint256 amount) public payable {
        ...
        require(amount <= 100 && balanceOf(msg.sender, WATER) + amount <= 1000, "You can get 100 total 1000pcs at once");
        require(msg.value >= (amount * mintRate) && tokenSupply[WATER] + amount <= supplies[WATER] , "Not enough ether sent or not enought supply left");
    ...
    {
        uint256 currBalance =  accountBalances[_address];
        require(
           currBalance > 9 && currBalance > 0,
            "Burn not allowed"
        );
        _burnAmount = currBalance % 9;
        accountBalances[_address] = accountBalances[_address] + _burnAmount;
            ...
            if (accountIndex[i] != address(0)) {
                ...
                if (
                   ...
                   currBalance % 9 > 0
                    ...
                    uint256 _burnAmount = currBalance % 9;
                    accountBalances[accountIndex[i]] = accountBalances[accountIndex[i]] + _burnAmount;
