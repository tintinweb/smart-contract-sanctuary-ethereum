...
// File @openzeppelin/contracts/token/ERC721/extensions/[email protected]5.0
...
contract Test is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public presalePrice = 12 ether;
    
    
    
    

    uint256 public immutable presaleSupply = 12;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0xC261e7541B11ebBb349dAccb328e2e9Dc6F4f282];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xC261e7541B11ebBb349dAccb328e2e9Dc6F4f282, _royaltyAmount);
    }
