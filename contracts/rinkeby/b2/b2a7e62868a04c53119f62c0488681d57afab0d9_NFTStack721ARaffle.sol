...
contract NFTStack721ARaffle is ERC721A, Ownable {
  ...
  function raffleMint(uint256 _count, bytes32[] memory _proof) public payable saleIsOpen {
    ...
    require((isRaffleActive1 && (_count <= raffleMaxMint1)), "Cannot purchase this many tokens for this stage");
    require((isRaffleActive2 && (_count <= raffleMaxMint2)), "Cannot purchase this many tokens for this stage");
    require((isRaffleActive3 && (_count <= raffleMaxMint3)), "Cannot purchase this many tokens for this stage");
    require(_allowListClaimed[msg.sender] + _count <= raffleMaxMint1, "Purchase exceeds max allowed");
    require((isRaffleActive1 && (_count + supply > raffleBreakPoint1)), "No NFTs are left to mint for this stage");
