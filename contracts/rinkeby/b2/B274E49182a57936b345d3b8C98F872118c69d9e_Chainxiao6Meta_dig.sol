...
contract Chainxiao6Meta_dig is ERC721, Ownable, EIP712, ERC2981 {
  using Strings for uint256;
  ...
  constructor() ERC721("Chainxiao6Meta_dig", "C6M_dig") EIP712("Chainxiao6Meta_dig", "1") {}

  /// @notice Owner mint to reserve Chainxiao6Meta
