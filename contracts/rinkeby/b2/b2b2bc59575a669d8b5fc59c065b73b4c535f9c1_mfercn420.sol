...
contract mfercn420 is ERC721, ERC721Enumerable, Ownable{
    // for rinkeby testnet mfers contract
     address public constant MFERS_ADDRESS = 0x6501ba4afEA51677aB53C229faf863b9cE37ef09;
    // for mainnet contract
    // address public constant MFERS_ADDRESS = 0x79FCDEF22feeD20eDDacbB2587640e45491b757f;
    uint256 public constant MAX_SUPPLY = 420;
//    uint256 public constant AIRDROP_SUPPLY = 60;
//    uint256 public totalSupply;
    ...
    constructor() ERC721("mfers cn 420", "MFERCCN"){}
    ...
    function airdropMfercn(
        ...
        require(airdropActive, "Not active");
        require(to.length <= MAX_SUPPLY, "Airdrop addresses too many");
...
//        totalSupply += 1;
    ...
    function setAirdropActive(bool newActive) external onlyOwner {
        airdropActive = newActive;
    }
