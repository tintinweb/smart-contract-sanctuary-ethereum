...
contract TheMetaTribesERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    **/
    function presaleMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(currentTime() < saleStartTime + DUTCH_AUCTION_DURATION, "PresaleMint is finished");
        ...
        require(_numberMinted(msg.sender) + _quantity <= maxPerAddressDuringPresaleMint, "can not mint this many");
