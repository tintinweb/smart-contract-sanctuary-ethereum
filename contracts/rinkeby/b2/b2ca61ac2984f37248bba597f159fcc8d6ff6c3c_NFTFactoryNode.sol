...
contract NFTFactoryNode is ERC1155PresetMinterPauser, Ownable, RoyaltyByToken
{
    ...
    string private constant _token_uri = 'ipfs://QmShQogLw5o2ZT8kQwSky674hyKquPUtS8qy1K9paLGKMG/{id}.json';

    //Open sea metadata URI
    string private constant _contract_uri = 'ipfs://QmWdVPSwGWhAss719qhbbwsakXmxWucuHwDycZFnHUR7NT/contract.json';
