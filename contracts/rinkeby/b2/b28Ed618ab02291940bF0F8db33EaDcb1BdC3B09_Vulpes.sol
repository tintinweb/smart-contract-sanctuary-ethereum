...
contract Vulpes is ERC721A, Ownable {
    ...
    function checkPrice (uint256 _value, uint256 _quantity) public view returns (bool) {
        ...
        uint256 discountPrice = _quantity * discount - discount;
    ...
    function mint (uint256 _quantity) external payable {
        ...
        require(balanceOf(msg.sender) + _quantity <= mintLimit, "Reach maximum minting limit.");
