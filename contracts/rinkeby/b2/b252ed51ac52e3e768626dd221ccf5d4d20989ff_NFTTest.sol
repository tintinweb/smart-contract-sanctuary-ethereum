...
contract NFTTest is ERC721Enumerable, Ownable, ERC2981ContractWideRoyalties {
    using Strings for uint256;
    ...
    bytes32 public merkleRoot = 0x7a94226fdcf0e5449810a8d9b8081774030a69a3dddc2fb9b6d001f13baa8260;
        ...
        payable
    {
        ...
        require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded, Try minting less NFTs");
