...
contract AirdropHouses is ERC721Enumerable, Ownable {
    ...
    bool _reveal = false;
    string private _strBaseTokenURI='https://airdrophouses.mypinata.cloud/ipfs/QmdxPeaozds7ffoMmLskML8DatdZ1CatYdzDfpkzBKVYAm/';
    ...
    function getLeftPresale() public view returns (uint256) {
        uint normalCount = _tokenIdCounter.current() - _adminMintCount;
    ...
    function price() public view returns (uint256) {
        ...
        uint normalCount = _tokenIdCounter.current() - _adminMintCount;
        uint countLevel = normalCount / _sheetsPerPrice;
