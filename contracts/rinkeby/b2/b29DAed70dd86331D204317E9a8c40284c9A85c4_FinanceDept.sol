...
contract FinanceDept is AccessControl, Pausable {
    ...
    function salary(uint _jobId) public view returns (uint) {
        ...
        _result = _result * (10 + _level) / 10; // TO-DO : FINALIZE THE "LEVEL" BONUS
        return _result;
    }

    function unclaimed(uint _jobId) public view returns (uint) {
        uint _salary = salary(_jobId);
        ...
        uint _result = (_duration * 10) / payDuration * _salary / 10;
        return _result;
    } 
