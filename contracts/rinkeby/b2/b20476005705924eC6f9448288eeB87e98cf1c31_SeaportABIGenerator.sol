...
import "./OpenSeaMarket.sol";
import "./ISeaport.sol";

contract SeaportABIGenerator {
    function generateAbi(
        ...
        return
            abi.encodeWithSignature(
                "buyAssetsForEth(ISeaport.OpenSeaBuy,bool,uint256)",
                openSeaBuys,
                revertIfTrxFails,
                value
            );
...
library OpenSeaMarket {
    ...
    function buyAssetsForEth(
        ...
        console.log("[Mktplace3]-addrs[0] is %s", openSeaBuys[0].addrs[0]);
        console.log("Chegou aqui no amigo openSeaMarket, legal!");
        for (uint256 i = 0; i < openSeaBuys.length; i++) {
            _buyAssetForEth(openSea, openSeaBuys[i], revertIfTrxFails);
        }
    }
    ...
    function _buyAssetForEth(
        ...
        console.log("Chegou aqui no novo BO, opensea address is ", openSea);
