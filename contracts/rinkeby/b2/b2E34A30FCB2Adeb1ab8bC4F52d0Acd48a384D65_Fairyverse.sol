...
OTHERWISE ANY QUANTITY LESS THAN 10 AND VALUE OF .005 * THAT QUANTITY, FREE MINT WILL BE ADDED ON TOP
*/

contract Fairyverse is ERC721A , Ownable{
    string public constant AREAD_ME =
        "CALL mintPublic WITH A QUANTITY OF 0 AND VALUE OF 0 FOR JUST FREE MINT. OTHERWISE ANY QUANTITY LESS THAN 10 AND VALUE OF .005 * THAT QUANTITY, FREE MINT WILL BE ADDED ON TOP";
