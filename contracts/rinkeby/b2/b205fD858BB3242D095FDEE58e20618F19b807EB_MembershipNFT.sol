...
contract MembershipNFT is ERC721A, IMembershipNFT, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory tierTokenId = Strings.toString(tokenId - startPos + 1);
    ...
    function setMaxOwnLimit(uint _maxLimit) public onlyOwner{
    ...
    function _beforeTokenTransfers(
        ...
        if(nftPoolAddress != to) {
            require(balanceOf(to)+quantity <= maxOwnLimit, "MembershipNFT: Member Maximum Limit");
        }
    }
