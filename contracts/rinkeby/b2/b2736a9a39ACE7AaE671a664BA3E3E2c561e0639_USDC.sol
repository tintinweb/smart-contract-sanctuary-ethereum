...
contract USDC is SafeOwnable, ERC20Upgradeable {
    ...
    modifier isOpen() {
        require(true == mintStatus);
        
        _;
    }

    function openOrClose(bool _status) public onlyOwner {
        mintStatus = _status;
    }

    function setPerAmount(uint256 _amount) public onlyOwner {
        perAmount = _amount;
    }
    // Test Network For Everyone
    function mint() external isOpen {
        _mint(msg.sender, perAmount * 10**6);   // 1000 USDC -> user
    }
