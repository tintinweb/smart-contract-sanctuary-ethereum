...
contract AzukiApe is ERC721A, Allowlist, Payment, Ownable, Pausable, ReentrancyGuard {
...
contract Payment is PaymentSplitter {
    ...
    // Minting fee
    function _setPrice(uint amount) internal {
        price = amount;
    }
    function _release(address payable payee) internal {
        super.release(payee);
    }
}
