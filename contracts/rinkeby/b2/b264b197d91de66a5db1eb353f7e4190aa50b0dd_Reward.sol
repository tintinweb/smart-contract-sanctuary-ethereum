    ...
    VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab)
{
    ...
    ILayerZeroReceiver constant lzEndpoint = ILayerZeroReceiver(0x79a63d6d8BBD5c6dfc774dA79bCcD948EAcb53FA); // rinkeby
    ...
    ILSSVMRouter constant router = ILSSVMRouter(0x9ABDe410D7BA62fA11EF37984c0Faf2782FE39B5); // sudoswap rinkeby
    ...
    function initialize(address pengTogetherVault, uint64 subscriptionId) external initializer {
        ...
        trustedRemoteLookup[10011] = abi.encodePacked(pengTogetherVault);
    ...
    function requestRandomWords() external onlyAuthorized {
        ...
        COORDINATOR.requestRandomWords(
            ...
            0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc, // keyHash rinkeby
