...
contract GatosMillonarios is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Gatos millonarios", "GM") {
    setHiddenMetadataUri("ipfs://bafybeiagjpz4i6itlh5qo3wesepe2stf77femw76bcc3nhspghq5gsrx6u/hidden.json");
  }
