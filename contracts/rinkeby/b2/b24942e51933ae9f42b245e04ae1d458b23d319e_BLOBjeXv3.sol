...
contract BLOBjeXv3 is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public immutable MAX_MINTS_PER_TX;
    ...
    uint256 collectionSize_,
    uint256 maxTOKENS_
  ) ERC721A("BLOBJeXv3","BLOB3", maxBatchSize_,collectionSize_) {
