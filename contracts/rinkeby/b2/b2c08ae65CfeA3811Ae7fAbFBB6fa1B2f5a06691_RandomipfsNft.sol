...
contract RandomipfsNft is VRFConsumerBaseV2, ERC721URIStorage,Ownable {
    ...
    uint256 internal constant MAX_VALUE_CHANCE = 100;
    string[] internal s_dogTokenUris;

    //Event

    event NftRequested(uint256 requestId,address minter);
    ...
    function fulfillRandomWords(uint256 requestId,uint256[] memory randomWords) internal override {
        ...
        uint256 moddedRng = randomWords[0] % MAX_VALUE_CHANCE;
    ...
    function getBreedFromModdedRng(uint256 moddedRng) public pure returns (Breed) {
        ...
        uint256[3] memory chanceArray = getCahnceArray();
    ...
    function getCahnceArray() public pure returns(uint256[3] memory ){

        return[10,30,MAX_VALUE_CHANCE];
