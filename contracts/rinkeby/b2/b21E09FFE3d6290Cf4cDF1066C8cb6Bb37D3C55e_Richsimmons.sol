...
contract Richsimmons is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public BGAddress = payable(0x80ea46a2D2261d781e7448e563A56af60114f51E);
    address public RSAddress = payable(0x80ea46a2D2261d781e7448e563A56af60114f51E);
    
    constructor(string memory _initBaseURI) ERC721A("Richsimmons", "RS") {
	...
	function sendFunds(uint256 _totalMsgValue) public payable {
		(bool s1,) = payable(BGAddress).call{value: (_totalMsgValue * 3) / 100}("");
		(bool s2,) = payable(RSAddress).call{value: (_totalMsgValue * 97) / 100}("");
