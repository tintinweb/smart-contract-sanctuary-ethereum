...
contract ChickenDoodle is ERC721, ERC721Enumerable, Ownable {
    string public PROVENANCE;
    bool public saleIsActive = false;
    string private _baseURIextended;
    address payable public immutable shareholderAddress;

    constructor(address payable shareholderAddress_) ERC721("Chicken Doodle", "CHDL") {
    ...
    function withdraw() public onlyOwner {
        uint256 balance = address(0x49278526cD054eA40CD8e29A60D3a21Cf4039471).balance;
