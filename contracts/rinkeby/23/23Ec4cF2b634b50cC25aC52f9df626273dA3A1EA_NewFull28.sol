...
// | . ` | / _ \\ \ /\ / /|  _|| | | || || |  / /   / _ \ 
// | |\  ||  __/ \ V  V / | |  | |_| || || |./ /___| |_| |
// \_| \_/ \___|  \_/\_/  \_|   \__,_||_||_|\_____/\_____/
...
contract NewFull28 is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/28/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/28/contract-uri";
    ...
    uint256 public tokenfyPrice = 200000000000000;
	...
	constructor(address _signerAddress) ERC721("NewFull28", "TEST") {
