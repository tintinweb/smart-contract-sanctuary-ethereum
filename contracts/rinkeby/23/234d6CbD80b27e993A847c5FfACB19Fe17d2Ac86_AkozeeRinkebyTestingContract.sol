...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6D96ECAbAAd4f18777648a9582Baa4C008E4c445];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 11000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifd5vot2h7dc7hszpxcyesgbfbqchk6a36ixdghb4qwu3tutaeyki/";
...
// File: contracts/AkozeeRinkebyTestingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AkozeeRinkebyTestingContract is RamppERC721A {
    constructor() RamppERC721A("Akozee Rinkeby Testing", "AKTEST"){}
}
