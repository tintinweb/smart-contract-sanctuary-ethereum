 ...
 */
contract OneVB is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable {
    // for whitelist server signatures
    ...
    // max whitelist supply of oneV's
     ...
     * private state variables are only visible to contract OneVH
     */
...

    {
        ...
        require(supply + numberOfTokens <= whitelistsupplyLimit, "Purchase would exceed max whitelist supply.");
        require(
    ...
    function publicMint(uint8 numberOfTokens) public payable _requirePublicSaleState {
        ...
        // remove the max whitelist supply, 10, from the supply
