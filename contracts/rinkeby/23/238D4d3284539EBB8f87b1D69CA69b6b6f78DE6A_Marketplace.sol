...
contract Marketplace is ReentrancyGuard, Ownable, EIP712 {
    ...
    function matchAskWithTakerBidUsingETHAndWETH(
        ...
        (bool isExecutionValid, uint256 tokenId, uint256 amount) = IExecutionStrategy(takerBid.strategy)
        ...
        nonReentrant
    {
        ...
        (bool isExecutionValid, uint256 tokenId, uint256 amount) = IExecutionStrategy(takerAsk.strategy)
    ...
    function _validateMakerOrder(OrderTypes.MakerOrder calldata makerOrder, bytes32 orderHash) internal view {
        ...
        // for (uint256 i = 0; i < makerOrder.allowedStrategies.length; i++) {
        //     require(executionManager.isStrategyWhitelisted(makerOrder.allowedStrategies[i]), "Strategy: Not whitelisted");
        // } 
    }
    ...
    function _validateTakerOrder(OrderTypes.TakerOrder calldata takerOrder, bytes32 orderHash) internal view {
        ...
        // Verify whether the currency is whitelisted
        require(executionManager.isStrategyWhitelisted(takerOrder.strategy), "Strategy: Not whitelisted");
    }
