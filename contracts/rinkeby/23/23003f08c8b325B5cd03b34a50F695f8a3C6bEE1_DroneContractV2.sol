...
contract DroneContractV2 is Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable
{
  ...
  //// added in upgrade
   ...
   event ValueChanged(uint256 newValue);
    ...
    function store_value_2(uint256 newValue) public {
        value = newValue;
        emit ValueChanged(newValue);
    }
 
    // Reads the last stored value
    function retrieve_value_2() public view returns (uint256) {
        return value;
    }

       // Increments the stored value by 1
    function increment_value_2() public {
        value = value + 1;
