...
contract MOV is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 1218;
	uint256 public RESERVED_NFT = 333;
	...
	uint256 public PRESALE_PRICE = 0.108 ether;
	uint256 public SALE_PRICE = 0.133 ether;
    ...
    constructor() ERC721P("Meru Origin Verse", "MOV") {}
