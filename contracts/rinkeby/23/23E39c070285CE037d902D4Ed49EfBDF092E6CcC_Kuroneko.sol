...
contract Kuroneko is ERC721A, Signed, ReentrancyGuard {
    ...
    bytes32 public merkleRoot =
        0x1a62c6606337081963ca281f6183a83474914fa9ecf1d194171ad65b63c52af4;
    ...
    function getPrice() private view returns (uint256) {
        return isPresale ? whitelistPrice : publicPrice;
    }
        ...
        nonReentrant
    {
        ...
        require(msg.value >= getPrice(), "Input right amount");
        ...
        if (isPresale) {
            require(
                _presaleMints[msg.sender] + amount <= presaleMaxPerWallet,
        ...
        if (isPresale) {
            _presaleMints[msg.sender] += amount;
        }
    }
        ...
        nonReentrant
    {
        ...
        require(supply + 1 <= collectionSize, "Max supply reached");
        require(
            MerkleProof.verify(
                merkleProof,
                merkleRoot,
        ...
        require(ogMinted[msg.sender] == false, "Already claim free NFT");
    ...
    Ownable
{
    ...
    /**
     * @dev
     * for update collection size onlyOwner function
     */
    function updateCollectionSize(uint _newCollectionSize) public onlyOwner {
