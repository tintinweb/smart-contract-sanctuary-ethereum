...
******************************************************************
  ...
  Developed by Mishzai, Blochain Developers @ www.blokedia.io
******************************************************************
*/
...
contract Uncle_Chop_Chop is ERC721A, Ownable, ReentrancyGuard {
 ...
 constructor() ERC721A("Uncle Chop Chop", "UCC")  {}
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxMintAmount , "Max mint Exceeds!");
