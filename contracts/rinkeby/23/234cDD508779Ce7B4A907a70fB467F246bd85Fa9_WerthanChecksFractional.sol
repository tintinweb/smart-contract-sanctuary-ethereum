...
/*
* @title ERC1155 token for Werthan Bag Pay Roll Checks
*/
contract WerthanChecksFractional is AbstractERC1155Factory, PaymentSplitter  {

    uint256 constant MAX_SUPPLY = 1000000;
    uint256 constant MAX_EARLY_ACCESS = 1000000;
    ...
    constructor(
        ...
        // _mint(_msgSender(), 0, 380, "");
    }

    /**
    * @notice set card id that can be minted by burning previous cards
    */
    function setCurrentCard(uint256 _id) external onlyOwner {
    	require(cardId != _id, "Already set");
        cardId = _id;
    }
    ...
    */
    function airdrop(
        ...
        require(totalSupply(cardId) + amount <= MAX_EARLY_ACCESS, "Early access: max supply reached");
