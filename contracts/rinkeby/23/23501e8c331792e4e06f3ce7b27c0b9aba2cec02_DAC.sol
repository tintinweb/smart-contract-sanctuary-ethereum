...
contract DAC is ERC721A, ERC2981, ReentrancyGuard, Ownable {
    ...
    uint256 private price = 0.0069 ether;
    uint256 private FREE_maxToken = 1500;
    uint256 private maxFreePerAddress = 1;
    uint256 private reserved = 469;
    uint256 private countFree;



    string private _baseTokenURI;
    string private notRevealedUri = "ipfs://QmVBwWQhKKnuyCRmeNFroFJ1bhXD3kDf6sTuhPFFWYtwwQ";


    mapping (address => bool) public freeMinted;

    address defaultTreasury = 0xFec2bB69f1EA634ef3657655F6d4bF7232f8545f;
    
    constructor() ERC721A("DAC", "DAC") {
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        if(freeMinted[msg.sender] == false && FREE_maxToken - countFree > 0){
