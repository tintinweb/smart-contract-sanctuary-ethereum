...
contract GoblinBob is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() ERC721A("GoblinBob", "GOBBOB") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max GoblinBobs per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 GoblinBobs" );
		require(s + _mintAmount <= maxFree, "Cant exceed GoblinBob supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 GoblinBobs");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more GoblinBobs" );
        require(s + _mintAmount <= maxSupply, "Cant exceed GoblinBob supply");
