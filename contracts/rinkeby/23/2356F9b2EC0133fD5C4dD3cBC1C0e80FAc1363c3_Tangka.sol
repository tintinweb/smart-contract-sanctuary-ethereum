...
contract Tangka is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public availableToken = 10000;
    uint256 public price = 0.1 ether;
    uint256 public maxPurchaseSize = 7;
    uint256 public maxPerWallet = 7;
    string public baseExtension = ".json";
    address private ownerAddress;
    uint256[] private divList;
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(_count <= maxPurchaseSize, "Exceeds Maximum Purchase Size");
        require(
        ...
        if (msg.sender != owner()) {
            payable(ownerAddress).transfer(orderPrice);
        }
    }

    function mintOwnerTo(uint256 _count, address _to)
        public
        payable
        saleIsOpen
        onlyOwner
    ...
    function contractURI() public pure returns (string memory) {
        return "https://www.vermax.nl/contract-info-tangka.json";
    }
