...
contract MoonPool is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x398dAacC54EC43afcDaD260F2993B510aF0Ea42c); // Marketing Address
    address payable public rewardAddress = payable(0x398dAacC54EC43afcDaD260F2993B510aF0Ea42c); // Reward Address
    address payable public liquidityAddress = payable(0x398dAacC54EC43afcDaD260F2993B510aF0Ea42c); // Liquidity Address
    ...
    string private constant _name = "MoonPool";
