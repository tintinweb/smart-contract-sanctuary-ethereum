...
contract NXCTesting is Ownable, ChainlinkClient {
    ...
    constructor () {
        ...
        floorUrl = "https://api.modulenft.xyz/api/v1/opensea/collection/floor?type=nxc-sentiment-api-alpha";
    }
    ...
    function setFloorUrl(string memory newFloorUrl) external onlyOwnerOrManager {
