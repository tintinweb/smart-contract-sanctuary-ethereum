...
contract Starcatchers is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    Tiers[2] = Tier(0, 0.0999 ether, _maxMintAmountPerTx-2);
    Tiers[1] = Tier(0, 0.111 ether, _maxMintAmountPerTx-2);
    Tiers[11] = Tier(86400, 0.111 ether, _maxMintAmountPerTx-2);
    Tiers[12] = Tier(172800, 0.111 ether, _maxMintAmountPerTx-2);
