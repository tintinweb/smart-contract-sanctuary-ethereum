...
contract revealTest is ERC721A, Ownable, ReentrancyGuard { 
    ...
    constructor(string memory _hiddenMetadataUri,string memory initBaseURI) ERC721A("revealTest", "revealTest") {
