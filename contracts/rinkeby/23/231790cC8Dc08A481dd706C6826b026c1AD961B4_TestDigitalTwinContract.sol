...
//*********************************************************************//
//
//   ______          __        ____  _       _ __        __    ______         _     
//  /_  __/__  _____/ /_      / __ \(_)___ _(_) /_____ _/ /   /_  __/      __(_)___ 
//   / / / _ \/ ___/ __/_____/ / / / / __ `/ / __/ __ `/ /_____/ / | | /| / / / __ \
//  / / /  __(__  ) /_/_____/ /_/ / / /_/ / / /_/ /_/ / /_____/ /  | |/ |/ / / / / /
// /_/  \___/____/\__/     /_____/_/\__, /_/\__/\__,_/_/     /_/   |__/|__/_/_/ /_/ 
//                                 /____/                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x54E3a0afCC0E200E81de27a119fb07D154cE49C7];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x54E3a0afCC0E200E81de27a119fb07D154cE49C7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafkreifool3tncrwr4gua3rlcqljw544hyylivc6cksmwhh33nfghvgfoe/";
...
// File: contracts/TestDigitalTwinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestDigitalTwinContract is RamppERC721A {
    constructor() RamppERC721A("TestDigitalTwin", "TestHEAL"){}
}
