...
contract Tauren is ERC721A, Ownable {
    using Strings for uint256;
    ...
    bool public reveal;
    string public baseURI="ipfs://QmPmqnSEZq99wEV1zTZaFxvqDdDUUkttQ5eGwF4DhqBW1a";
    string public coverURI="ipfs://QmSYKBYJzNzKQHfGxYdp6dDpQvc2G77sPJhU9HkAzNSC8D";

    mapping(address => uint256) public addressMintedBalance;

    constructor(string memory _coverURI)
        ERC721A("Tauren", "TAUREN")
    {
        coverURI = _coverURI;
    }
