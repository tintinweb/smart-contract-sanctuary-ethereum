...
contract HungryHungryHamsters is ERC721Enumerable, Ownable
{
  ...
  */
  ...
  function mintHamster() private
  {
    ...
    if(startingIndex == 0)
    {
      startingIndex = uint256(keccak256(abi.encodePacked(block.difficulty, block.timestamp)));
    ...
    uint256 mintIndex = (totalSupply() + startingIndex) % MAX_HAMSTERS;
    ...
    */
    ...
    lastMintAddressHash = uint256(keccak256(abi.encodePacked(msg.sender)));
