...
contract UAsTest1005 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public supplyStage3 = 3000;
  uint256 public supplyStage4 = 4000;
  ...
  function mintForAddress(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    _mintLoop(msg.sender, supply.current());
    mintBalances[msg.sender] += _mintAmount;
  }
