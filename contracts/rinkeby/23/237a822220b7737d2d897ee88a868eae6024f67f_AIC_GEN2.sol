...
contract AIC_GEN2 is ERC721A, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    string private baseURI = "TO_BE_REPLACED";
    ...
    address public privateSigner = 0x7182e03391A6d7c1b7C9BeD13eE501ab859B6449;
    bool public publicLive;
    bool public privateLive;

    mapping(address => uint256) public privateMinters;

    constructor() ERC721A("AIC_G2", "AIC") {}
    ...
    function mint(uint256 tokenQuantity) external payable notContract {
        ...
        require(mintedCounter + tokenQuantity <= maxSaleSupply, "EXCEED_PUBLIC_SUPPLY");
    ...
    function privateMint(uint256 tokenQuantity, bytes memory signature, uint256 maxMints) external payable notContract {
        ...
        require(mintedCounter + tokenQuantity <= maxSaleSupply, "EXCEED_PRIVATE_SUPPLY");
