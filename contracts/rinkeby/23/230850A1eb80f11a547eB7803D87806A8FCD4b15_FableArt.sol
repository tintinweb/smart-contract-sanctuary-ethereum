...
/// @title A contract for FableArt
/// @author Phillip
/// @notice NFT Minting
contract FableArt is ERC721, Ownable, ReentrancyGuard {
  ...
  // Team wallet
  address withdrawAddress = 0xb5D774a16CF9903353DaeAE188a1954312080D4a; // Wallet 1 address
  ...
  // Mint Price
  uint256 public mintPriceDiscount = 0.048 ether;
  uint256 public mintPrice = 0.06 ether;

  // BaseURI (real, placeholder)
  string private realBaseURI =
    'https://gateway.pinata.cloud/ipfs/QmWvVa8sUuRuTYLHNXPUVH7CmoDvXx7Ura8gVQBBn3zXcQ/';
  string private placeholderBaseURI =
    'https://Ratdao.mypinata.cloud/ipfs/QmabSngCR5cztRiSemNnjXcv9KPtWYuBZ1Rg4ciHKfV4GN/';

  uint8 private LIMIT5 = 5;
  uint8 private LIMIT2 = 2;

  constructor() ERC721('FableArt', 'FArt') {}
   ...
   * mintCount:   Up to 2
   */
  function mintFreeNormal(uint8 _mintCount, bytes32[] memory _proof)
    external
    nonReentrant
    returns (uint256)
  {
   ...
   * mintCount:   Up to 2
   */
  function mintPresale(uint8 _mintCount, bytes32[] memory _proof)
    external
    payable
    nonReentrant
    returns (uint256)
  ...
  function setPlaceholderBaseURI(string memory _placeholderBaseURI)
    external
    onlyOwner
