...
contract OwnMyText is Ownable, ReentrancyGuard  {
    ...
    bool public _isSlotExtended = false; //state variable to determine if someone already payed in advance
    ...
    function purchase() public payable nonReentrant update () {
        ...
        if(msg.sender == currentOwner) {
            ...
            require(_isSlotExtended == false, "you already own this slot");
        }
        else {
        ...
        if(msg.sender == currentOwner && _isSlotExtended == false) {
            ...
            endDate = block.timestamp+q;
            //endDate = (q-block.timestamp)+block.timestamp;
    ...
    function price() public view returns (uint256 amount) {
        ...
        amount = ((newCurrentPrice*ht)+newCurrentPrice)/baseDivisible;
    ...
    function buyFromPrice() public view returns (uint256 amount) {
        ...
        amount = ((priceCalc*hh)+priceCalc)/baseDivisible;
        amount += priceCalc;
