...
contract WahICO is Ownable, ReentrancyGuard, IWahICO, WahICOEvents {
    ...
    address public USDTaddress = 0x6131ca327571AfD53139fc8d10917F1bf9Bb62fE;
    address public ETHtoUSD = 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;
        ...
        returns (uint256)
    {
        ...
        if (_type == 1) {
            uint256 _amountToUSDT = ((OracleWrapper(ETHtoUSD).latestAnswer() *
                USDTDecimals) / 10**8);
            uint256 _typeDecimals = 10**18;
            _finalUSDTvalue = (_amount * _amountToUSDT) / _typeDecimals;
        } else {
    ...
    function setFirstRange(
        // range should be set along with USD decimals
        uint128 _firstRange
    ) external onlyOwner {
