...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xCA21e3FfFB2603d7b6dd62d250f16c5363E752e2];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 1000000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVmyg5Sj6wg51SyMHcJcRyHtKacRFNMkw6sRtBpiQFwFN/";
...
// File: contracts/PlagueContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PlagueContract is RamppERC721A {
    constructor() RamppERC721A("PLAGUE", "PG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/y8h0BVDkqcW4m86uRJuO/contract-metadata";
    }
}
