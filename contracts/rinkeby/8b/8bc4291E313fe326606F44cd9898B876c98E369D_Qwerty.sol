...
contract Qwerty is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public freeSupplyLeft = 5000;
    uint256 public reserveSupplyLeft = 600;
    ...
    function mint(uint8 numTokens) external payable callerIsUser {
        ...
        if (msg.value > 0) {
            ...
            require(freeSupplyLeft - reserveSupplyLeft > 0, "Reached free mint supply");
            require(freeSupplyLeft - reserveSupplyLeft - numTokens >= 0, "Reached free mint supply");
    ...
    function reservedMint(uint8 numTokens) external callerIsUser {
        require(mintActive, "Mint has not started yet");
        require(totalSupply() + numTokens <= maxSupply, "Reached max supply");
        require(reserveSupplyLeft > 0, "Reached reserved mint supply");
