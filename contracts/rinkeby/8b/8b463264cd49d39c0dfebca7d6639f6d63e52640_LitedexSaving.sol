...
contract LitedexSaving is Ownable {
    ...
    function _collect(address _account) private returns(bool){
        require(hasStaked[_account], "Litedex: you are not staker");
        ...
        require(_earning > 0, "Litedex: no rewards claimed");
    ...
    modifier _sewIsOpen(){
        require(sew, "Litedex: super emergency withdraw is closed");
        _;
    }
