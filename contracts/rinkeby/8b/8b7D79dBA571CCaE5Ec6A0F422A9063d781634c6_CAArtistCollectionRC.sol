...
contract CAArtistCollectionRC is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    // NFT Coonfiguration
    uint256 private _nftSupply = 100;                                           // how many nfts
    uint256 private _reservedSupply = 0;                                        // how mant are reserved
    uint256 private _forSaleSupply = 100;                                       // how many available for sale
    ...
    string public _artistName = "Bubaa Shrimnps";                               // artist name
    ...
    constructor() ERC721("CAArtistCollectionRC", "CAARC") {
    ...
    function withdrawAll() public onlyRole(TREASURER_ROLE) {
        ...
        _widthdraw( _costsTreasury, balance.mul(45).div(100) );
    }
