...
// THIS CONTRACT HOLDS DATA FOR HUNDREDELEVEN METADATA. OWNERS OF HUNDREDELEVEN NFTS CAN CHANGE THEIR ACTIVE METADATA HERE
...
contract MetaCollection is Ownable {
    ...
    event tokenMetadataChanged(uint tokenId, string collection);
    event collectionEdit(uint _index, string _name, bool _isExternal, address _address, string _uri);

    function editHundredElevenContract(address _address) public onlyOwner {
    ...
    function changeMetadataForToken(uint[] memory tokenIds, uint collection) public {
        require(collection < collections.length);
        for (uint i = 0 ; i < tokenIds.length; i++) {
            ...
            emit tokenMetadataChanged(tokenId, collections[collection].name);
        }
        ...
        returns (string memory)
    {
        ...
        return
            _collection.isExternal
                ? IMetadataHandler(_collection.externalContract).tokenURI(tokenId)
    ...
    constructor() {
        addCollection("LameNumbers",false,address(0),"https://berk.mypinata.cloud/ipfs/QmVnPUzizbqxChXwmqtpmcny8rAP6yhpDqmot78PRB423R/");
        addCollection("FreqBeats",false,address(0),"https://berk.mypinata.cloud/ipfs/QmcqdA5yraVCmezGu8yaBPMzNFzn6XJVLSCF2NsQdXEURh/");
        addCollection("riset",false,address(0),"https://berk.mypinata.cloud/ipfs/QmanYvcQkQ3QPVpDZCyfLFL7xxGtKN7eqxG9hU5Tgsrvkw/");
        addCollection("FreqBeats",false,address(0),"https://berk.mypinata.cloud/ipfs/QmcqdA5yraVCmezGu8yaBPMzNFzn6XJVLSCF2NsQdXEURh/");
        addCollection("riset",false,address(0),"https://berk.mypinata.cloud/ipfs/QmanYvcQkQ3QPVpDZCyfLFL7xxGtKN7eqxG9hU5Tgsrvkw/");
        // addCollection("melodik",false,address(0),"https://berk.mypinata.cloud/ipfs/QmQTNB5tAwVtt2EqohXz2iaVFFUvQMGXnRWD6n6szSWR5o/");
        // addCollection("ATAKOI",false,address(0),"https://berk.mypinata.cloud/ipfs/QmQTNB5tAwVtt2EqohXz2iaVFFUvQMGXnRWD6n6szSWR5o/");
        addCollection("MetaChess",true,0x038f977308A835Da2632Ee24569B98A823f0E0f4,"");


        for (uint i=1; i <= 111; i++) {
            idToCollection[i] = i % 6 + 1;
        }
