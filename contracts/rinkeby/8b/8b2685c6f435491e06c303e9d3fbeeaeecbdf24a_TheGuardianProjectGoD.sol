...
contract TheGuardianProjectGoD is ERC721A, Ownable {
  ...
  enum Steps {Launch, Presale, Sale, SoldOut}
  Steps public sellingStep;

  constructor() ERC721A("Guardians of Dogs", "DoG") {sellingStep = Steps.Launch;}
  ...
  function mintPresale(uint8 mintAmount) public payable {
    ...
    require(mintAmount <= 15, "You can not mint more than 15 NFT at the same time");
  ...
  function setUpSale() external onlyOwner {
    require(sellingStep == Steps.Presale, "Active Presales at first");
  ...
  function setMaxActualDrop(uint256 _newMaxActualDrop) public onlyOwner {
    MaxToken = _newMaxActualDrop;
  }  
