...
contract Tripsters is ERC721Enumerable, Pausable, Ownable, ERC2981ContractWideRoyalties {
    ...
    uint256 public pioneerLimit;
    uint256 public wlLimit;
    uint256 public ogLimit;
    ...
    constructor() ERC721("Tripsters", "TRIPSTERS", 0) {
    ...
    function adminMint(uint256 amount, address to) 
    external 
    adminOrOwner 
    {
    ...
    {        
        ...
        require(msg.value >= _amount * wlPrice, "Incorrect Price");
        require(balances[msg.sender].whitelist + _amount <= wlLimit, "Exceeds allocated");
    ...
    {        
        ...
        require(balances[msg.sender].pioneer + _amount <= pioneerLimit, "Exceeds allocated");
    ...
    callerIsUser 
    {
        ...
        require(balances[msg.sender].og + _amount <= ogLimit, "Exceeds allocated");
    ...
    function toggleWlLive() external adminOrOwner {
    ...
    function setPioneerMerkle(IMerkle _merkle) external adminOrOwner {
        pioneerMerkle = _merkle;
    }

    function setWhitelistMerkl(IMerkle _merkle) external adminOrOwner {
