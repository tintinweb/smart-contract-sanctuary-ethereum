...
contract ViriumIdPrime is AccessControl, ERC721Burnable, ERC721Lockable {
    ...
    function setDestate(address destateContractAddress) external onlyRole(MAINTAIN_ROLE) {
        destate = IDestate(destateContractAddress);
    }
    ...
    function mint(Currency currency) external payable {
        ...
        if (currency == Currency.ETH) {
            ...
            currencyInfo.erc20.transferFrom(msg.sender, PAYEE, currencyInfo.price);
        }
