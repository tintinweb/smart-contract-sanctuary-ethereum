...
contract HappyRobotFriends is HRF, ERC165 {
    ...
    function _claimerInit() internal virtual {
        _claimer[0x4846063Ec8b9A428fFEe1640E790b8F825D4AbF0] = 3;
    ...
    function freeMint(uint256 _quantity) public {
        ...
        require(_claimer[msg.sender] >= _quantity, "HRF: not on whitelist");
        for (uint256 i=0; i < _quantity; i++) {
...
contract HRF is ERC721, ERC721Metadata, ERC173, String {
    ...
    function resetLevel(uint256 _tokenId) public {
        require(msg.sender == ownerOf(_tokenId), "HRF: Caller not owner of token");
