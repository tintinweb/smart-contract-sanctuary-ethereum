...
contract SaddleVoterProxy is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function claimFees(address _distroContract, address _claimTo)
        external
        onlyOwner
    {
        ...
        address _veRewardsContract = ISaddleYieldDistro(_distroContract)
            .vesdl_penalty_rewards();
    ...
    function checkpointFeeRewards(address _distroContract)
        external
        depositorOrOwner
    {
