...
contract Shinobros is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // TEAM
    address public team1 = 0xB97f7C5A1C7b544aB7e06AEA663597Bd1A6e49B5;
    address public team2 = 0xBbFA8BD983b94B90a98BD4762Bf5B97f39dBd7dd;
    address public team3 = 0xB97f7C5A1C7b544aB7e06AEA663597Bd1A6e49B5;
    address public team4 = 0xBbFA8BD983b94B90a98BD4762Bf5B97f39dBd7dd;
    address public team5 = 0xB97f7C5A1C7b544aB7e06AEA663597Bd1A6e49B5;
    ...
    constructor() ERC721A("Testcontract", "TSNB") {
    }
    ...
    function withdraw() external onlyOwner {
        ...
        (bool withdraw_1, ) = team1.call{value: (walletBalance * 24) / 100}("");
        (bool withdraw_2, ) = team2.call{value: (walletBalance * 24) / 100}("");
        (bool withdraw_3, ) = team3.call{value: (walletBalance * 24) / 100}("");
        (bool withdraw_4, ) = team4.call{value: (walletBalance * 24) / 100}("");
        (bool withdraw_5, ) = team5.call{value: address(this).balance}("");
