...
contract MiniToken is IMiniToken, Ownable, ERC721Enumerable {
    ...
    string public contractMetadataIPFSHash = 'bafybeiee6xobyfj3cxrf3buqotly6z3iawauju3xr3xuuemd77j3pucczi';
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked('ipfs://', contractMetadataIPFSHash));
    }
    ...
    function setContractMetadataIPFSHash(string calldata _contractMetadataIPFSHash) external onlyOwner {
         contractMetadataIPFSHash = _contractMetadataIPFSHash;
    }
}
