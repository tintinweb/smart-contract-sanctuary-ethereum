...
contract LockerFactory is NFT{
    ...
    event LockerExtended(uint256 indexed id, uint256 lockedUntil);
    event LockerUnlocked(uint256 indexed id, address indexed owner);
    ...
    function extend(uint256 _lockerId, uint256 _extendUntil) external returns (uint256){
        ...
        emit LockerExtended(_lockerId, _extendUntil);
        return newLockerId;
    }
    ...
    function unlock(
        ...
        emit LockerUnlocked(_lockerId, lockerOwner);
    }
