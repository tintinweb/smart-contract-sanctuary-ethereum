...
library PixelURIParser {
    ...
    function getPixelURI(uint256[12] memory slices, uint256 tokenId) public pure returns (string memory) {
        ...
        if ((brightnessSum/4096) == 10000) {
            ...
            brightnessStr = string(abi.encodePacked("0.",brightnessSum/4096));
        }
        else if ((brightnessSum/4096) >= 100) {
            brightnessStr = string(abi.encodePacked("0.0",brightnessSum/4096));
        }
        else if ((brightnessSum/4096) >= 10) {
            brightnessStr = string(abi.encodePacked("0.00",brightnessSum/4096));
        }
        else if ((brightnessSum/4096) >= 1) {
            brightnessStr = string(abi.encodePacked("0.000",brightnessSum/4096));
        }
        else {
            brightnessStr = "0";
        }
