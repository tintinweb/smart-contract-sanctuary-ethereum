...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "FFF";
    string private constant _symbol = "f4";
    ...
    uint256 private maxWalletAmount = 500000001 * 10**9;
    uint256 private maxTxAmount = 500000001 * 10**9;
    ...
    function manualBurn(uint256 amountToBurn) external onlyOwner() {
        _tTotal = _tTotal - amountToBurn;
        _tTotal = totalSupply();
    ...
    function openTrading() external onlyOwner() {
        ...
        maxWalletAmount = 500000001 * 10**9;
        maxTxAmount = 3000000001 * 10**9;
