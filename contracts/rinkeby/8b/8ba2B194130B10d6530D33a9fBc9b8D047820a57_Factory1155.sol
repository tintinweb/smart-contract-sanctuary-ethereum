...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new sokuNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        sokuNFTUser1155Token token = sokuNFTUser1155Token(address(addr));
...
contract sokuNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
