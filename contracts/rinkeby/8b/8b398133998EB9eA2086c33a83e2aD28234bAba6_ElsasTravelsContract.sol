...
//    / ____/ /________ ( )_____   /_  __/________ __   _____  / /____
//   / __/ / / ___/ __ `/// ___/    / / / ___/ __ `/ | / / _ \/ / ___/
//  / /___/ (__  ) /_/ / (__  )    / / / /  / /_/ /| |/ /  __/ (__  ) 
// /_____/_/____/\__,_/ /____/    /_/ /_/   \__,_/ |___/\___/_/____/  
//                                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4C283267b1282C4261969bbFb33e84eB4d43d075];
...
// File: contracts/ElsasTravelsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract ElsasTravelsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Elsas Travels";
    string public symbol = "ELSA";
