...
contract TeddyBearz is ERC721A, Ownable{
    ...
    uint256 public constant MAX_FREE_SUPPLY = 775; //275 from dev team + 500 free for community
    ...
    function mint(uint256 _quantity) external payable callerIsUser {
        ...
        if(newSupply > MAX_FREE_SUPPLY) { //public mint 776-6250
            ...
            require(totalPublicMint[msg.sender] + _quantity < MAX_PUBLIC_MINT, "You have selected too many Teddy Bearz to mint");
            require(_quantity > MAX_PUBLIC_MINT, "You have selected too many Teddy Bearz to mint");
