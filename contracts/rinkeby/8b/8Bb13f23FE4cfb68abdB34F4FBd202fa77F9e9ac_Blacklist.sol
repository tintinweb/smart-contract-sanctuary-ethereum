...
/**
 * @title The Blacklist Contract
 * @notice The Blacklist contract allows us to add/remove wallets from and to the blacklist.
 * to prevent sending tokens from a backlisted wallets
 */
contract Blacklist is IBlacklist, Ownable {
    ...
    /**
     * @notice The external method used to add wallet to blacklist
     * Owner permission required
     * @param wallet, The requested wallet address to add to the blacklist
    ...
    /**
     * @notice The external method is used to remove a wallet from blacklist
    * Owner permission required
     * @param wallet, The requested wallet address to remove from the backlist
    ...
    /**
     * @notice The external method is used to know if the wallet is backlisted or not
