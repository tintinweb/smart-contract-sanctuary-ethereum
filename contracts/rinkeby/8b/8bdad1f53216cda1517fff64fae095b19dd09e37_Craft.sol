...
contract Craft is ERC721, Ownable {
    ...
    uint256 internal remainingPreToken;
    uint256 internal remainingGeneralToken;
    uint256 internal TOTAL_TOKEN = 10000;
    uint256 internal GENERAL_TOKEN_MAX = 6500;
    uint256 internal PRE_TOKEN_MAX = 3000;
    uint256 internal reserve = 500;
    ...
    bool internal generalSaleActive = true;
    bool internal preSaleActive = true;
    uint256 internal generalSaleTargetCount;
    uint256 internal preSaleTargetCount;
