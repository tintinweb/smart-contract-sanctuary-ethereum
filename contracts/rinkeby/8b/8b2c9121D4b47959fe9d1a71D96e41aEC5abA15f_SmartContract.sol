...
working buy and sell without core autoburn
https://rinkeby.etherscan.io/address/0x01ba128b290Eece624b0abFFbf6BcB041261D2ad#code

sendeth to two wallet
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MSTvv1";
    ...
    uint256 private buyCoreUpperLimit = 1000 * 10**9; // 0.01 
    ...
    constructor () {
        ...
        swapEnabled = true;
        maxWalletAmount = 100001 * 10**9;
        maxTxAmount = 100001 * 10**9;
        tradingOpen = true;
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        _tOwned[feeAddrWallet] += tokensForBaz;
        emit Transfer(from, feeAddrWallet, tokensForBaz);
