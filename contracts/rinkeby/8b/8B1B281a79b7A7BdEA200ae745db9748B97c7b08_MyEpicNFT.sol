...
contract MyEpicNFT is ERC721URIStorage {
    ...
    uint256 private _maxTokenCount = 50;
    ...
    string[] firstWords = ["Funny", "Nerdy", "Weird", "Noob", "Naked", "High"];
    string[] secondWords = [
        "Cocoa",
        "Oat",
        "Pumpkin",
    ...
    constructor() ERC721("FunnyThreeWordies", "THREE") {
    ...
    function makeAnEpicNFT() public {
        ...
        require(newItemId < _maxTokenCount, "All tokens are minted.");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "The funniest three wordies.", "image": "data:image/svg+xml;base64,',
