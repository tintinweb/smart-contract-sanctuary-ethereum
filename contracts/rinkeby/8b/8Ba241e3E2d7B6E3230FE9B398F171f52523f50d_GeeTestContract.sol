...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x6d035EDE2CdA1aE4a2fAf81B4DbE29cebA2144d3];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x6d035EDE2CdA1aE4a2fAf81B4DbE29cebA2144d3;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 0.00033 ether;
  uint256 public EARLY_MINT_PRICE = 0.00033 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmUiY2ke7yjT8AeeL5pVhqd42dsak8Fhbb2uKxiA9EUMUj/";
...
// File: contracts/GeeTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GeeTestContract is RamppERC721A {
    constructor() RamppERC721A("Gee Test ", "GTEST"){}
}
