...
contract SealedBidAuction is Ownable, ReentrancyGuard {
    ...
    // TimeOracle
    ITimeOracle public timeOracle = ITimeOracle(0x67de150e01738A06e60cf4F060b609c862527FB6);
...
interface ITimeOracle is IERC165 {
     ...
     *  - onlyOwner
    */
    function addPriceFeed(address _newFeed) external;
    /**
     ...
     *  - onlyOwner
    */
    function deletePriceFeed(address _feedToDelete) external;
