...
contract LoomiHeads is ERC721A, Ownable, ReentrancyGuard {
    ...
    address private multiSigAddress = 0x155B3B2dB32848c990411d7f51ba68534246D2D2 ;
...

    {
        ...
        // for(uint256 i; i<6; i++){
        //     adminMapping[multiSig[i]] = keccak256("admin");
        // }
    }
    ...
    // function setMultiSigAddress() onlyAdmin{}
...
//   MODIFIER
    ...
    */
      function transferOwnership(address newOwner) public virtual override(Ownable) onlyAdmin nonReentrant {
        ...
        require(newOwner == LoomisMultiSig(multiSigAddress).getNewOwner());
