...
contract UnsTokenCrossChain is ERC20Burnable, Pausable, AccessControl {
    ...
    /**
     * @notice Function to recover ETH
     */
...
abstract contract ERC20Pausable is ERC20, Pausable {
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "xERC20Pausable: token transfer while paused");
    }
}
