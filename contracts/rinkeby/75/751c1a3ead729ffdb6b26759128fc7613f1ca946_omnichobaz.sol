...
contract omnichobaz is Ownable, ERC721, NonblockingReceiver {
     using Strings for uint256;

    address public _owner;
    string private baseURI;
    uint256 public fees = 0.5 ether;
    uint256 nextTokenId = 3;
    uint256 MAX_MINT_POLYGON = 10;
    ...
    function spawn(uint256  numTokens) public payable {
        ...
        if (msg.sender != owner()) {
        require(msg.value >= fees * numTokens);
        }
