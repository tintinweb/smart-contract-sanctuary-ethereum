...
contract UiPoolDataProvider is IUiPoolDataProvider {
    ...
    function getUniswapV3LpTokenData(
        ...
        if (sourceAddress != address(0)) {
            ...
            try source.getPositionBaseInfo(tokenId) returns (
                address token0,
                address token1,
                uint24 feeRate,
                ...
                lpTokenInfo.token0 = token0;
                lpTokenInfo.token1 = token1;
                lpTokenInfo.feeRate = feeRate;
                lpTokenInfo.positionTickLower = positionTickLower;
                lpTokenInfo.positionTickUpper = positionTickUpper;
                lpTokenInfo.currentTick = currentTick;
