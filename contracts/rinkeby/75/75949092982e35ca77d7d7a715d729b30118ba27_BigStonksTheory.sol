...
contract BigStonksTheory is ERC20, Ownable, VRFConsumerBaseV2 {
    // Basic units
    ...
    constructor(
        ...
        bytes32 _keyHash,
        address _NFTaddress
    ) ERC20("Big Stonks Theory", "STONKS") VRFConsumerBaseV2(_vrfCoordinator) {
        ...
        if (
            ...
            if (tax > 0) {
                if (_isSell && _taxIsElevated) {
                    ...
                    uint256 lpAndBuyerAmount = tax * ((taxLp + taxBuyer) / _totalTax);
