...
contract StrawberryPatchKids is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI) ERC721("StrawberryPatchKids", "SPK") {
        setBaseURI(baseURI);
    ...
    function contractURI() public view returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Strawberry Patch Kids", "description": "Lorem ipsum dolor.", "seller_fee_basis_points": 500, "fee_recipient": "0x82A9f9a4d0beCD01219B7f93654ec76eb7cc0416"}'))));
