...
// File: contracts/tipsydegens.sol
// Created by EVANZ

pragma solidity >= 0.8.0 < 0.9.0;

contract tipsydegens is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public costPB = 0.005 ether;
  uint256 public costWL = 0.003 ether;

  uint256 public maxSupply = 7777;
  uint256 public freeSupply = 1500;

  uint256 public MaxFreeWL = 2;
  uint256 public MaxFreePB = 1;
  ...
  constructor() ERC721A ( "Tipsy Degens", "TDT" ) {
...
// ~~~~~~~~~~~~~~~~~~~~ Modifiers ~~~~~~~~~~~~~~~~~~~~
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    if (isWhitelisted(msg.sender)) {
        ...
        {
        require(msg.value >= costPB * _mintAmount, "Insufficient funds!");
        }
    _;
  }
...
// ~~~~~~~~~~~~~~~~~~~~ Mint Functions ~~~~~~~~~~~~~~~~~~~~
  ...
  // FREE MINT
  function mintfree(uint256 _mintAmount) public mintCompliance(_mintAmount) {
    require(freeClaimed[msg.sender] == false, "Free mint already claimed.");
    require(freeSupply - _mintAmount >= 0, "Not enough free supply!");
    require(freeSupply > 0, "Free supply sold out.");

    if (isWhitelisted(msg.sender)) {
        require(_mintAmount == MaxFreeWL, "Invalid mint amount.");
        }
    else
        {
        require(_mintAmount == MaxFreePB, "Invalid mint amount.");
        }
...
// ~~~~~~~~~~~~~~~~~~~~ onlyOwner Functions ~~~~~~~~~~~~~~~~~~~~
  ...
  function setCostPB(uint256 _costPublic) public onlyOwner {
    costPB = _costPublic;
  }

  function setCostWL(uint256 _costWhitelist) public onlyOwner {
    costWL = _costWhitelist;
  }
  ...
  function setMaxFreeWL(uint256 _maxFreeWL) public onlyOwner {
    MaxFreeWL = _maxFreeWL;
  }

  function setMaxFreePB(uint256 _maxFreePB) public onlyOwner {
    MaxFreePB = _maxFreePB;
  }
