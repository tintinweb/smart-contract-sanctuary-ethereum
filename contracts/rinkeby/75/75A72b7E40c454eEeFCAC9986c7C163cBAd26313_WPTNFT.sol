...
contract WPTNFT is ERC721, IWPTNFT, Ownable {
    ...
    address private teamWallet = 0xE96223261220975e8b5338900b7013Aad8c128B8;
    // Star id to cid.
    ...
    function mint(address account) external payable override returns (uint256) {
        ...
        require(balanceOf(account) + 1 <= maxLimit, "Cannot exceed maxLimit");
        _transferFee(1);
        ...
        returns (uint256[] memory)
    {
        ...
        require(
            balanceOf(account) + amount <= maxLimit,
