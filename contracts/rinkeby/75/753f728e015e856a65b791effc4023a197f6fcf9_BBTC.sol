...
contract BBTC is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public _baseURIextended = "ipfs://QmaLbDC7Xka6bCQRt41gphWpTUZqDDJVS9uuUvLvGZ1vW4/";
    ...
    constructor() ERC721A("Bears and Bulls Trade Club", "BBTC") {
    ...
    function send_pool_to_exchange(bool _decision) external onlyOwner {
