...
contract PurrnelopesExclusives is ERC721A, Ownable, VRFConsumerBase{
    ...
    bytes32[3] public MerkleRoot = [bytes32(0x8440f47b2d349b35bb84843dc23a3768bdfe592fc11e977c48ee59c412d33eec)
                                    ,bytes32(0x3c7369de2da9aaac5196c7137e71a29bd38befdd094ba2db77441af72fe5a82e)
                                    ,bytes32(0x1e57cd4bcebf0718dbb585e65401f5604fac655ffc8e0a7e5425c57711746252)];
    ...
    constructor() ERC721A("Purrnelopes Exclusives", "PE") 
        ...
        keyHash = 0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311; //0xAA77729D3466CA35AE8D28B3BBAC7CC36A5031EFDC430821C02BC31A238AF445
        fee = 0.1 ether; // 2 LINK (Varies by network)
        MaxMintPerPhase = [3, 3, 3];

        transferOwnership(0xAF89Ff2946396aE39b117DE534C3EB7A29E9fA8c);
