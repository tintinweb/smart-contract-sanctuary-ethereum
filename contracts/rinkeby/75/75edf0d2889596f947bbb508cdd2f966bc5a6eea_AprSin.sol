...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    */
    ...
    // function _isTransferProxyOrOwner(address spender, uint256 tokenId) internal view virtual returns (bool) {
    //     require(_exists(tokenId), "ERC721: operator query for nonexistent token");
    //     address _owner = ERC721.ownerOf(tokenId);
    //     return (spender == _owner || spender == transferProxy);
    // }
...
contract AprSin is ERC721 {
    ...
    function transferProxy_set(address _transferProxy) public onlyOwner returns(bool){
        transferProxy = _transferProxy;
        return true;
    }
