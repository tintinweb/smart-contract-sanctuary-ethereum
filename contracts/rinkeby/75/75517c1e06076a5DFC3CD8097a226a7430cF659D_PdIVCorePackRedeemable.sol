...
contract PdIVCorePackRedeemable is VRFConsumerBaseV2, Ownable {
    ...
    address payable public ethCollectAddress;
    ...
    uint16[15800] private fullCardList;
    ...
    function collect(
        ...
        require(
            ethCollectAddress != address(0),
            "Eth forwarding wallet must be set"
        );
        ...
        (bool sent, ) = ethCollectAddress.call{ value: msg.value }("");
    ...
    function initializeAvailablePackIds2() public onlyOwner {
        ...
        for (uint16 i = 700; i < 1400; i++) {
            availablePackIds.push(i);
        }
    }

    function initializeAvailablePackIds3() public onlyOwner {
        require(availablePackIds.length == 1400, "cant re-initialize 2");
        for (uint16 i = 1400; i < 1580; i++) {
            availablePackIds.push(i);
        }
    }
    ...
    function setEthCollectAddress(address payable _ethCollectAddress)
        public
        onlyOwner
    {
        ethCollectAddress = _ethCollectAddress;
    }
