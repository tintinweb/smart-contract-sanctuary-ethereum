...
contract GeckTest is ERC721Enumerable {
    ...
    //uint256s
    uint256 public MAX_PRIVATE_SUPPLY = 4000;
    uint256 public MAX_PUBLIC_SUPPLY = 6000;
    uint256 public MAX_DEV_MINT = 0;
    ...
    constructor(
        ...
        //Shoutout to projects Loot, Anonymice and Chainrunners
        //for ideas/inspiration/logic
     ...
     * @param _randinput The input from 0 - 10000 to use for rarity generation.
    ...
    function devMint(uint256 amount) public onlyOwner {
        require(
            totalDevMinted + amount <= MAX_DEV_MINT,
    ...
    /**
     * @dev Hashing of address for API check
     */
    ...
    /**
     * @dev Creates a new hash only to display a new image on front end
     * @dev and indexes it, allowing the user to switch at any time
     */
    ...
    /**
     * @dev User can choose which image to display on front end
     * @param tokenId The user's token number
     * @param index The index of which the image hash is stored
     */
    ...
    /**
     * @dev Hash to metadata function for Legendaries
     */
    ...
    /**
     * @dev Hash to image function for Legendaries
     */
    ...
    /**
     * @dev Hash to metadata function for regular tokens
     */
    ...
    /**
     * @dev Returns a hash for a given tokenId for the image index
     * @param _tokenId The tokenId to return the hash for.
     */
    ...
    /**
     * @dev A check to see if a Genesis token has been used to mint
     */
    ...
    /**
     * @dev Sets the address for the token used for burnAndRecycle function
     */
    ...
    /**
     * @dev Begins the Genesis mint
     */
    function enableMintGenesis() public onlyOwner {
        mintGenesisActive = !mintGenesisActive;
    }

    /**
     * @dev This function is to stop the Genesis mint, then include the
     * @dev leftover available into the public supply
     * @dev It also turns off Genesis mint at the same time
     */
    function setPublicPlusPrivate() public onlyOwner {
        mintIncludeReserveActive = !mintIncludeReserveActive;
        mintGenesisActive = !mintGenesisActive;
        MAX_PUBLIC_SUPPLY = MAX_PUBLIC_SUPPLY + MAX_PRIVATE_SUPPLY;
        totalPublicSupply = totalPublicSupply + totalPrivateSupply;
    }
    ...
    /**
     * @dev Toggles the state of the burnAndRecycle function
     */
    ...
    /**
     * @dev Sets the ContractURI, used for Opensea royalties
     */
...
/**
 * @dev The interface that the Genesis mint requires
 */
...
/**
 * @dev The interface that the burnAndRecycle function requires
 */
interface NTTZToken {
