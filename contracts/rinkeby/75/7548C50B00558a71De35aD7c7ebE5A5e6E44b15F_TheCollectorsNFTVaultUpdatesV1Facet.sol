...
contract TheCollectorsNFTVaultUpdatesV1Facet is TheCollectorsNFTVaultBaseFacet {
    ...
    */
    function listNFTOnOpensea(
        ...
        _beforeListingNFTOnOpensea(vaultId, uints, _calldata, addrs[2]);
    ...
    */
    function _beforeListingNFTOnOpensea(uint256 vaultId, uint256[9] memory uints, bytes memory _calldata, address taker) internal {
