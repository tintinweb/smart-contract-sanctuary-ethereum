...
contract okaymfers is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("okaymfers", "DAMN"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.value == amt * cost,"pls send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"no mor okays available");
    require(mintEnabled, "it seems minting offed");
    require(numberMinted(msg.sender) + amt <= maxPerWallet,"dhon't be greawhdy!");
    require( amt < maxPerTx + 1, "wo wo too many per tx.");
