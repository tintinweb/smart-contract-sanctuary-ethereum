...
constructor(address initialRoyaltiesReceiver) ERC721("UNHUMAN COMPOSITIONS", "UNHMAN") {
        _royaltiesReceiver = initialRoyaltiesReceiver;
        artBalance[address(this)] = 777;
    ...
    require(artBalance[address(this)] >= 1, "Not enough art in stock to complete this purchase");
    _safeMint(msg.sender, 777-artBalance[address(this)]);
    _setTokenURI(777-artBalance[address(this)], _uri);
