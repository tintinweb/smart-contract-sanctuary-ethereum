...
contract Documents is ERC1155 {
    ...
    constructor(string memory _EncryptionKEY, string memory URI) public ERC1155(URI) {
        ...
        _mint(0x38Ee1e6168da20439A7195CE90286895ED998C44, Doc, 1, "");
    }
    //only NFT holder can access the functions
    modifier onlyOwner{
        require(balanceOf(0x38Ee1e6168da20439A7195CE90286895ED998C44,0) == 1,"You must be holder of the token to view it");
        _;
    }
    //view EncryptionKey
