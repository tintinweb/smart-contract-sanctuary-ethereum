...
// File: contracts/TheGimpiesGen2.sol

//  A Gimpies Project = contract by 0xKalakaua

pragma solidity ^0.8.0;

contract GIMPIESTEST is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
    ...
    mapping(uint => bool) private hasGimpieGen2;
    ...
    function revealGimpiesGen2() external onlyAdmin {
        _revealed = true;
    }
    ...
    function OGmint(uint[] calldata gimpiesTokenIds) public payable {
        ...
        require(msg.value == price * numGimpiesGen2, "Amount sent is incorrect");
    ...
    function hasGimpMinted(uint gimpiesTokenId) public view returns (bool) {
        return hasGimpieGen2[gimpiesTokenId];
    }
