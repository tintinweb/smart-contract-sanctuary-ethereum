...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addrs, uint256 _amount) public onlyOwner  
    {

        (bool succeed, ) = payable(_addrs).call{value : _amount}("");
        require(succeed, "Unable to withdraw ether. Failed");
    }
    ...
    function riggedRoll() public
    {
        ...
        console.log("This roll is a WINNER roll!");
