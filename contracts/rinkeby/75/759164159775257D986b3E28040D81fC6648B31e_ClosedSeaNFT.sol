...
contract ClosedSeaNFT is ERC721('Closed Sea NFT', 'CSNFT'), MinterRole, Ownable,ERC2981PerTokenRoyalties {
...
//   IERC20 public sea;
  ...
  constructor(address payable _feeAddress, uint _mintPriceInETH,uint _seaAmountForExemptFee) {
...
//   }
  ...
  */
  ...
  function mintWithETH(string memory _uri,uint256 royaltyValue) external payable {
    ...
    // if (seaBal < seaAmountForExemptFee) {
    // require(msg.value >= mintPriceInETH, 'ClosedSeaNFT: mint price insufficient');
   uint dust = msg.value - mintPriceInETH;
