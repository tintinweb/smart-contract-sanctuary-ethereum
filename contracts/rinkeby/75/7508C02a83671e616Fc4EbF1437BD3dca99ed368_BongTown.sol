...

{
    ...
    uint256 whitelistAmountLimit = 1;
    ...
    address[] private _team = [
        0x933572D5F83B00A998102b7bf1a99c0f197E685B, // Mayor gets 33% of the total revenue
        0x82de9CE4a49fFeC4C41Cf733126F618eD83a879C, // Sheriff gets 33% of the total revenue
        0x8a7aC9834e2D4487Da22Dc130C97Ee8fBDc85568 // Bongtown treasury gets 34% of the total revenue
    ];
...
function freeMint(uint256 _amount) 
    ...
    onlyAccounts
    {
        ...
        require(msg.value == 0, "BongTown: Freemint is free");
        require(!paused, "BongTown: Contract is paused");
        require(
