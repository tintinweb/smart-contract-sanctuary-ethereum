...
contract SuperDuperCats is ERC721, Ownable, ReentrancyGuard {
    ...
    string private unrevealedTokenURI = "ipfs://QmZMznoydwBVFEp6BRcV5EpZiBRgXApYgM8ngwK5yzA4Yc/placeholder.json";
    ...
    string public SDC_PROVENANCE;

    address a1 = 0x048E4a9C3eE288E4f3e05917a9531e7DC72b512E;
    address a2 = 0x6BcF019b4d914d101062A848541Ab45797b405AB;

    event TokenMinted(uint256 tokenId);

    constructor(string memory _ipfsCID)
        ERC721("Super Duper Cats", "SDC")
    {
        baseURI = string(abi.encodePacked("ipfs://", _ipfsCID, "/"));

        /*
         * Full reveal of the Super Duper Cats would be 14 days from the day of deployment of the contract.
         */
    ...
    /**
     * Mints Super Duper Cats
     */
    function mintSuperDuper(uint256 _amount) public payable {
