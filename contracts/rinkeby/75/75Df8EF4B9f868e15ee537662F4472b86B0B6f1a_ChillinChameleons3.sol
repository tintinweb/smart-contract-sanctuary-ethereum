...
contract ChillinChameleons3 is ERC721Enumerable, Ownable {
    ...
    address public constant creator1Address = 0x8B1A88D5eC8A7Bf07A36002c55375f2476Ad2d9D;
    ...
    function freemint(uint256 _tokenAmount, uint256 _timestamp, bytes memory _signature) public freemintIsOpen {
        ...
        freemintTokens[wallet] = freemintTokens[wallet] + _tokenAmount;
    ...
    function mint(uint256 _tokenAmount, uint256 _timestamp, bytes memory _signature) public payable saleIsOpen {
        ...
        mintTokens[wallet] = mintTokens[wallet] + _tokenAmount;
        for(uint8 i = 1; i <= _tokenAmount; i++){
            _mintAnElement(wallet, total + i);
        }
