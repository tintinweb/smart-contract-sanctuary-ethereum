...
contract MFTest is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public sentinentLife = 20;
    uint256 public brosLeft = 15;
    uint256 public basePrice = 0.005 ether;
    uint256 public dontBeGreedy = 5;
    ...
    constructor() ERC721A("MF-Test", "FACE") {}
    ...
    function teamMint(address to ,uint256 amount) external onlyOwner{
        ...
        require(amount <= brosLeft,'No team mints left');
        _safeMint(to,amount);
        brosLeft-=amount;
    }
    ...
    function terraform(uint256 amount) external payable nonReentrant{
        ...
        require(supply + amount + brosLeft <= sentinentLife,"Public Mint Sold Out!");
    ...
    function soManyBrosLeft(uint256 _newSupply) external onlyOwner {
        require(_newSupply <= brosLeft,"Can't Increase Supply");
        brosLeft = _newSupply;
    }
    //@seekers - oY90XcdRt56
