...
contract ProposalSystem is Modifiers, Utils{
    ...
    function addMoreGoods(uint256 _dealID)external openDeal(_dealID) isPartTaker(_dealID) { 
        ...
        require(_type == 4 && _status == true, "Make a proposal to add more goods and must be accepted");
        require(_token.allowance(msg.sender, address(this)) >= additionalTokens, "increaseAllowance to ERC20 contract");
