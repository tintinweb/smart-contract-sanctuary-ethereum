...
contract DoodBeanz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DoodBeanz", "doodBeanz") {
    setHiddenMetadataUri("ipfs://QmV4QrS2PVFYHxZiUAxZX6jR2tnVHVqPZSgBsyE2ahjyK7/1.json");
  }
