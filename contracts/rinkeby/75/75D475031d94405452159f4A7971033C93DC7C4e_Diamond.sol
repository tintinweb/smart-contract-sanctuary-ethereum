...
contract Diamond {
    ...
    constructor(
        ...
        // selectorsDiamondLoupe[1] = IDiamondLoupe.facets.selector;
        // selectorsDiamondLoupe[2] = IDiamondLoupe
        //     .facetFunctionSelectors
        //     .selector;
        // selectorsDiamondLoupe[3] = IDiamondLoupe.facetAddresses.selector;
        // selectorsDiamondLoupe[4] = IDiamondLoupe.facetAddress.selector;

        // erc165.setSupportedInterface(type(IDiamondLoupe).interfaceId, true);

        // register ERC173 (Ownable)

        // selectorsOwnable[6] = IERC173.owner.selector;
        // selectorsOwnable[8] = IERC173.transferOwnership.selector;

        // erc165.setSupportedInterface(type(IERC173).interfaceId, true);

        // register ERC165 (supportsInterface)

        // selectorsERC165[5] = IERC165.supportsInterface.selector;
