...
contract TheFuckingMeeble is ERC721A("The Lost Meeble", "Meeble"), Ownable, ReentrancyGuard {
    ...
    uint256 public TotalFreeMeeble = 15 ;
    //string public MeebleURI = "ipfs://QmRvuy4ALdpcPAevcGCAiVtQgoeUdmsnAL9xr1g1DCUmUv/";

    string public uriPrefix = "";
    string public uriSuffix = ".json";
    string public hiddenMeebleUri = "https://gateway.pinata.cloud/ipfs/QmNUTybJgUHexN7gtNSVf9HKoQ5g1Xs45ZVoANF9UeYvaY";
    ...
    function TeamSaveMeeble() external onlyOwner {
        uint256 _MeebleCreatures = totalSupply();
        require(_MeebleCreatures + 50 <= MeebleCreatures, "Exceed Total Meeble");
        require(_FreeMeebleCount[msg.sender] <= 51 , "Team has already found Meeble");
