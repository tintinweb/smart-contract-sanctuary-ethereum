...
/*
* @title ERC1155 token for ETC Pass
* @author GavinLaw
*/
contract EtcPass is AbstractERC1155Factory, PaymentSplitter  {

    uint256 constant MAX_SUPPLY = 10000;
    uint256 constant MAX_EARLY_ACCESS = 50;

    uint8 maxPerTx = 2;
    uint8 maxTxPublic = 2;
    uint8 maxTxEarly = 1;

    uint256 public mintPrice = 20000000000000000; // Wei = 0.02 ETH
    uint256 public cardIdToMint = 1;

    uint256 public purchaseWindowOpens    = 1661011200; // 2022-08-22 00:00:00
    uint256 public purchaseWindowCloses   = 7278134400; // 2200-08-22 00:00:00
    ...
    constructor(
        ...
        _mint(0x4c861201eD75F3F768c5179Ac2A18Ed85FD8717c, 0, 1, ""); // Gavin Rinkeby Account 2
    }
