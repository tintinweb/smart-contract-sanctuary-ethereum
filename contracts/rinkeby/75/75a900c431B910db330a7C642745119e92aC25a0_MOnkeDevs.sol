...
contract MOnkeDevs is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, string memory _initNotRevealedUri, bytes32 _hashroot) ERC721("MONKEEEEEE", "MD") {
    ...
    function airDrop(address[] memory to, uint256 q) public onlyOwner{
