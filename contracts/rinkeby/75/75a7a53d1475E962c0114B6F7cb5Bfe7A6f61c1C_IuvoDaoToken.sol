...
contract IuvoDaoToken is ERC20, Ownable {
  ...
  function _transfer(
    ...
    bool _isOwner = sender == owner() || msg.sender == owner();
    ...
    if (
      ...
      // don't allow swapping more than 1% of what's in the liquidity pool
      uint256 maxToSwap = (balanceOf(uniswapV2Pair) * 1) / 100;
