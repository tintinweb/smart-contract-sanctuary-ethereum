...
//contract by beermarket

contract beermarket is Ownable, ERC721A {
 ...
 string public hiddenURI = "ipfs://QmceHYTKBCRYp4vCnZeUBBZLEMVAFutTnDmXsAoFSeCMcn/1.json";

 // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
 string public CONTRACT_URI = "ipfs://QmceHYTKBCRYp4vCnZeUBBZLEMVAFutTnDmXsAoFSeCMcn/1.json";
 ...
 address public teamWallet = 0x7047290Fb985dA60e2b4C46D72EEa6409D3Ff5a3;

 mapping(address => uint256) public userMintedFree;
 mapping(address => uint256) public numUserMints;

 constructor() ERC721A("Beer Market", "BEER") { }
 ...
 require(totalSupply() >= 7, "Team mints after free");
 ...
 require(newSupply <= 7, "Not enough free supply");
