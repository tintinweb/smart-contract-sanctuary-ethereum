...
contract Elektrik is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public max_mint = 4;

    bool public revealed = false;
    bool public paused = false;

    uint public priceSale = 0.04 ether;
    ...
    constructor(string memory _notRevealedURI, string memory _baseURI) ERC721A("Elektrik", "ELEK") PaymentSplitter(_team, _teamShares) {
        baseURI = _baseURI;
    ...
    function saleMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(amountNFTsperWallet[msg.sender] + _quantity <= max_mint, "You can only get 4 NFT on the Sale");
