...
contract EscrowClone is ReentrancyGuard, Initializable {
    ...
    function withdrawETH() onlyFreeflowOrClient nonReentrant public {
        require(address(this).balance >= totalAmount, "Trying to withdraw more ETH than in the contract");
        uint256 freeflowShare = totalAmount / 100 * freeflowCut;
        uint256 devShare = totalAmount - freeflowShare;
