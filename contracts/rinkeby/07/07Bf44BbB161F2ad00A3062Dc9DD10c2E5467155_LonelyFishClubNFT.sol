...
contract LonelyFishClubNFT is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("LonelyFishClubNFT", "LFCN")
  {
    ...
    allowedMintCountMap[0x863C4635aACC663195Bad7aC5826954D383167a6] = 100;

    allowedMintCountMap[0x82Bd0c331E6C100E804453E11C5e9EdA589ad837] = 50;

    allowedMintCountMap[0x03fabc57fb29d7612098f6F9643B29e53B2e55e0] = 50;
  }
  ...
  address private constant payoutAddress1 =
    0x863C4635aACC663195Bad7aC5826954D383167a6;
