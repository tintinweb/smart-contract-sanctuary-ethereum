...
contract NAME is ERC721, Ownable {
    ...
    constructor() payable ERC721("AKHWAGAA", "K") {
        setCost(mintPrice);
    ...
    function EnablePublicMint(bool IsPublicMintLive_) external onlyOwner {
        IsPublicMintLive = IsPublicMintLive_;
    }
    ...
    {
        require(IsPublicMintLive, "The contract is paused!");
        require(
        ...
        // require(
        //     msg.value >= cost * (_mintAmount - free),
