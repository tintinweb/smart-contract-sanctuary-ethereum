...
contract PadClubContract is ERC721, Ownable {
    ...
    //NFT Stuff
    uint256 public presalePrice = 0.010 ether;  // prix de la presale modificable par le owner
    ...
    uint256 public maxMintAmountPresale = 5;    // nombre max de NFT mintables par une addresse
    uint256 public maxMintAmountPublic = 10;    // nombre max de NFT mintables par une addresse
    bool public revealed = false;

    // Sale Stuff
    bool public publicSaleOpen = false;       // vente publique fermee a la ccreation du contrat
    ...
    function tokenURI(uint256 _tokenId)  public view virtual override returns (string memory)
    {
        ...
        if (revealed == false) {  
            return bytes(currentBaseURI).length > 0 ? string(abi.encodePacked(hiddenMetadataUri, _tokenId.toString(), uriSuffix)): "";
            //return hiddenMetadataUri;  } // on retourne l url des token unrevealed
        }
