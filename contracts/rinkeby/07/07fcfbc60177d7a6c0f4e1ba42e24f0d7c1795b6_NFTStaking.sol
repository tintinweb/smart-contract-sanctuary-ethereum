...
contract QTHReward is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20("QTHReward", "QTHR") { 
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, QTHReward _token) { 
    nft = _nft;
    token = _token;
  }
