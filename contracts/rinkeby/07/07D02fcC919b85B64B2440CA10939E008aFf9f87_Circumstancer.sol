...
//  Discord:      https://discord.gg/TNrEFX9suV
...
contract Circumstancer is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721 ("Circumstancer", "C369") {
    ...
    // Enable/Disable ability to add to WL 
    function changeStatusAddWL(bool status) public onlyOwner {
        require(ENABLED_ADD_WL != status, "It is already in that state");
