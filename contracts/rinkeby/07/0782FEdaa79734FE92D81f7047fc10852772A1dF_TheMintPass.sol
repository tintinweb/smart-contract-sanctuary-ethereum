...
contract TheMintPass is ERC721URIStorage, Ownable {
    ...
    uint public maxWLMint = 3;
    uint public constant maxMint = 2;
    ...
    function setWhiteList(bytes32 _merkleRoot, uint _maxMint) external onlyOwner {
    ...
    function createWLToken(uint numberOfTokens, bytes32[] calldata _merkleProof) external payable {
        ...
        require(numberOfTokens <= maxWLMint, 'Exceeded max token purchase.');
