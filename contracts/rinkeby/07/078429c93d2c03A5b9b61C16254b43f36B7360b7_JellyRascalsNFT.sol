...
import '@openzeppelin/contracts/access/Ownable.sol'; //define functions that only the owner can use

contract JellyRascalsNFT is ERC721, Ownable {
  uint256 public mintPrice; //minimize amount of variable creation and changin
  uint256 public totalSupply;
  uint256 public maxSupply;
  uint256 public maxPerWallet;
  bool public isPublicMintEnabled; //determine when users can mint
  string internal baseTokenUri; //url for openSea
