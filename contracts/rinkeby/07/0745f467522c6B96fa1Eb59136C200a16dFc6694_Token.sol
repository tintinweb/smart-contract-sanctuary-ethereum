...
contract Token is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("key to nothing", "KTN") {}
    ...
    function mintTokens(uint256 _numberOfTokensToMint)
        public
        payable
        nonReentrant
    {
        ...
        require(
            totalSupply() + _numberOfTokensToMint <= MAX_TOTAL_SUPPLY,
        ...
        if (alreadyMintedFreeByWallet[msg.sender]) {
            ...
            require(
                msg.value >= _numberOfTokensToMint * MINT_PRICE,
            ...
            if (currentTotalFreeMint < MAX_FREE_SUPPLY) {
                ...
                require(
                    msg.value >= (_numberOfTokensToMint - 1) * MINT_PRICE,
                    "Not enough ether paid"
                );
