...
contract Graveyard_v2 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
    ...
    function mint(address _to, uint256 _mintAmount) external payable {
        ...
        uint256 i = 0;
        for (; i < _mintAmount; i++) {
            uint256 supply = totalSupply(mintedNftCount);
            if(supply <= maxSupply){
                _mint(_to, mintedNftCount, 1, "");
