...
contract CampPluto is ERC721Enumerable, Ownable {
  uint256 public mintPrice = 0.1776 ether;
  uint256 public preSaleMintPrice = 0.096 ether;
  ...
  uint256 public maximumMintSupply = 4500;
  ...
  address private OtherAddress = 0x3BdE04101063F944eC131910921103916664F395;
  ...
  constructor(string memory baseURI) ERC721("Camp Pluto", "CP") {
    setBaseURI(baseURI);
  }
