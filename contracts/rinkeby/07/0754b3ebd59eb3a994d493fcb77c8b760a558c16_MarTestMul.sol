...
contract MarTestMul is ERC1155 {
    ...
    function createCollectible(string memory uri, uint256 fee, uint256 supply) public returns (uint256) {
        uint256 newItemId = tokenCounter;
        _mint(tokenCounter, supply, uri, fee);
