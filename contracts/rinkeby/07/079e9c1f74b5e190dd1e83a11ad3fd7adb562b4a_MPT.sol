...
contract MPT is ERC721A, Ownable {
  ...
  constructor( 
    ...
    ERC721A("TEST", "TEST")
    {
    goldSaleEpoch = _goldSaleEpoch;
    platinumSaleEpoch = _platinumSaleEpoch;
 ...
 function platinumMint(bytes32[] calldata merkleProof, uint256 count)
  ...
  function publicMint(uint256 count) external payable {
    ...
    require(totalSupply() + count <= collectionSize, "Cannot Eexceeds collection size");
