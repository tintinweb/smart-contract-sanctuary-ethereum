...
contract LockupContractFactory is ILockupContractFactory, Ownable, CheckContract {
    ...
    uint constant public SECONDS_IN_SIX_MONTHS = 15768000;
...
contract LockupContract {
    ...
    uint constant public SECONDS_IN_SIX_MONTHS = 15768000; //31536000
    ...
    function _requireUnlockTimeIsAtLeastOneYearAfterSystemDeployment(uint _unlockTime) internal view {
        ...
        require(_unlockTime >= systemDeploymentTime.add(SECONDS_IN_SIX_MONTHS), "LockupContract: unlock time must be at least one year after system deployment");
    }
}
