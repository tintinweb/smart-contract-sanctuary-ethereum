...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656917400;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2C0C3DC875e968b6CDe3999fa2c6111D59472FAb];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaeavmbbr5qc624fu2csvi4pb2llbtqj3qf6ndcf5yx3thkvu77cy/";
...
contract TestContract is RamppERC721A {
    constructor() RamppERC721A("test", "RAMPP"){}
}
