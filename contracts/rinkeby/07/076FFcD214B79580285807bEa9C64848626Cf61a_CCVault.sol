...
contract CCVault is Context, IOwnable, IERC721Receiver, IERC1155Receiver {
  ...
  mapping ( address => bool ) public partnerContracts;
	...
	// **************************************
		...
		* @param tier1Crystals_     ~ type = uint256   : the amount of tier 1 crystals to stake
		* @param tier2Crystals_     ~ type = uint256   : the amount of tier 2 crystals to stake
		* @param tier3Crystals_     ~ type = uint256   : the amount of tier 3 crystals to stake
		*/
