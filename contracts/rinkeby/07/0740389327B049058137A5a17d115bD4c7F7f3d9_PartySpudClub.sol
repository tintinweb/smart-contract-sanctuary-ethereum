 ...
 */
contract PartySpudClub is ERC721, Ownable, RandomlyAssigned {
    ...
    function updateCommunityAddress(address newAddress_) external onlyOwner {
    ...
    /// Mint reserved tokens for the community and marketing
        ...
        ensureAvailabilityFor(count)
    {
        require(
            ...
            'Exceeds the reserved supply of community tokens'
        );
