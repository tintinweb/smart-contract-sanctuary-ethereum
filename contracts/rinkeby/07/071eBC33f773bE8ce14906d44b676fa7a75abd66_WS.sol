...
contract WS is Ownable, ERC721A, ReentrancyGuard {

    string public baseURI;
    uint256 public teamWS = 2; // launch
    ...
    uint256 public maxPresaleSupply = 5; // launch
    uint256 public maxWSsupply = 10; // launch
