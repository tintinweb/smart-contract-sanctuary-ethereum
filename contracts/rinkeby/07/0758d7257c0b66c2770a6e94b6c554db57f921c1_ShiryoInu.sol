...
contract ShiryoInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xF0360dA6bE15f586D2d673d11323929bf4205D3f);
        _feeAddrWallet2 = payable(0xF0360dA6bE15f586D2d673d11323929bf4205D3f);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xF0360dA6bE15f586D2d673d11323929bf4205D3f), _msgSender(), _tTotal);
    }
