...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    ...
    function makeStaticCall(Order memory order, bool callMint) internal returns(bytes memory) {
        if (callMint) {
            ...
            require(result, "1:Failed when call other contract");
            ...
            resCallData = order.callData;
            require(result, "2:Failed when call other contract");
        ...
        reentrancyGuard
    {
        ...
        bytes memory returnData = makeStaticCall(buy, signature == 0xda22caf8);
