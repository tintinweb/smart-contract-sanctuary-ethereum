...
contract TheCollectorsNFTVaultDiamond is TheCollectorsNFTVaultBaseFacet {
    ...
    constructor(
        ...
        // Currently only supporting opensea but will add more marketplaces in the near future
        ...
        LibDiamond.addFunctions(_vaultTokenManagerFacetAddress, _getNFTVaultTokenFacetSelectors());
    ...
    */
    function _getLogicFacetSelectors() internal pure returns (bytes4[] memory) {
        ...
        selectors[15] = TheCollectorsNFTVaultLogicFacet.getVaultParticipants.selector;
        selectors[16] = TheCollectorsNFTVaultLogicFacet.getParticipantPercentage.selector;
        selectors[17] = TheCollectorsNFTVaultLogicFacet.getTokenPercentage.selector;
        selectors[18] = TheCollectorsNFTVaultLogicFacet.salvageERC721Token.selector;
        selectors[19] = TheCollectorsNFTVaultLogicFacet.salvageETH.selector;
        return selectors;
    }
    ...
    */
    ...
    /*
        ...
        Adding all functions of opensea manager facet
    */
    function _getNFTVaultTokenFacetSelectors() internal pure returns (bytes4[] memory) {
