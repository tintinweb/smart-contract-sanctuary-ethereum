...
contract CreeptoThumbsNFT is ERC721, Ownable {
    ...
    constructor() payable ERC721('CreeptoThumbs', 'CPT') {
        mintPrice = 2 ether;
        totalSupply = 0;
        maxSupply = 10000;
        maxPerWallet = 10;
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(walletMints[msg.sender] < maxPerWallet, 'exceeded max per wallet');
