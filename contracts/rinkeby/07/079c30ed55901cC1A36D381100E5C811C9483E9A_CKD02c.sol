...
interface ICKStaking {
    function getStakingInfo(address staker) external view returns (uint256 started, uint256 lastChanged, uint256 stakedTokens, uint256 rewardsAccrued, uint16 activeAPR, bool rewardsPausedByUnstake );
}

contract CKD02c is Auth {
    ...
    event ProposalAdded(uint256 proposalId, uint32 voteDuration, TransferType transferType, address transferRecipient, address transferTokenCA, uint256 transferAmountNonDecimal);
    ...
    //////////////////////////////// DAO section ////////////////////////////////
    function proposalAdd(uint32 voteDuration, string memory description, TransferType transferType, address transferRecipient, address transferTokenCA, uint256 transferAmountNonDecimal, bool startVoteImmediately) external onlyAuthorizedProposer returns (uint256 proposalId) {
