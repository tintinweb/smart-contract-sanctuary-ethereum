...
contract PatriotNFT is ERC721, Ownable{
    ...
    constructor() payable ERC721("PatriotNFT", "PATRIOT") {
        ...
        maxSupply = 666;
        maxPerWallet = 100;
        devAddress = payable(0xfBCe0e10640bdD85c515F334e9321120f215282A);
    }
    ...
    function mint(uint256 _numberOfTokens) public payable {
        ...
        require(walletMints[msg.sender] + _numberOfTokens <= maxPerWallet, "Can only mint 100 NFT per wallet");
