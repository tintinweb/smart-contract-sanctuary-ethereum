...
contract TaskDToken is ERC20, Ownable {
    uint256 public immutable finalTotalSupply = 10000 * 10 ** decimals();
    uint256 public immutable ownershipMaxPercentage = 5;

    constructor() ERC20("TaskDToken", "TKD") {}
    ...
    function _beforeTokenTransfer(
        ...
        if (to != owner()) {
            uint256 ownershipPercentage = ((balanceOf(to) + amount) * 100) / finalTotalSupply;
            require(
