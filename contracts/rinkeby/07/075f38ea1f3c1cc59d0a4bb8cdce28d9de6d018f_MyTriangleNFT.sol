...
contract MyTriangleNFT is ERC721 {
    ...
    constructor(string memory imageURI) ERC721("My Triangle NFT", "MNFT") {
        s_tokenCounter = 0;
        i_imageURI = svgToImageURI(imageURI);
    }
            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"My Triangle NFT"',
                                '"description":"Description for My Triangle NFT"',
                                '"attributes": ""',
                                '"image":"',
                                i_imageURI,
                                '"}'
