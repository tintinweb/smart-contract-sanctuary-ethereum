...
contract PokerCard is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PokerCard", "PK") {
    setHiddenMetadataUri("ipfs://QmThA2u7dLKSMEaZSMmiXwgLXf3onL7JDJyGfXMGbxZXWd/hidden.json");
  }
