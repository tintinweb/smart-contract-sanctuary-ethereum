...
// 我的addr：0x58D4cc32c38637440877fe30E59589f4851ED572
// G的addr：0x0b548Dd49b9867d3467fAc04fe259e9A1D9A2123
contract CrowdFunding {
    
    event simpleEvent(address Sender, uint amount);
    ...
    */
    ...
    function searchFunder(uint256 campaignID,uint256 FunderID) public returns (address,uint)
    {
        Campaign storage c = campaigns[campaignID];
        emit simpleEvent(c.funders[FunderID].addr,c.funders[FunderID].amount);
