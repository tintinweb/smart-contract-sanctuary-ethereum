...
contract Kanemi is ERC721Enumerable, Ownable {
     ...
     * Mint Token by owner
     */
    function reserveByOwner(address _to, uint256 quantity) external onlyOwner {
    ...
    */
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= maxToMint, "Invalid amount to mint per once");
