    ...
    */
    ...
    function getAltCoinPriceinStable(
        ...
        if (
            ...
            (int256 priceFromChainLinkinStable, ) = PriceConsumer.getLatestUsdPriceFromChainlink(_stableCoin);
            uint256 stableDecimals = IERC20Metadata(_stableCoin).decimals();
            collateralAmountinStable =
                collateralAmountinStable +
                ((uint256(collateralChainlinkUsd) * 10 ** stableDecimals)  / uint256(priceFromChainLinkinStable));
