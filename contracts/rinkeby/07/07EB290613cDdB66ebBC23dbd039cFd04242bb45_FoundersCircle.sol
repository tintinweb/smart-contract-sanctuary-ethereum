...
contract FoundersCircle is ERC1155, Ownable  {
    ...
    constructor() ERC1155("") {  //TODO: set baseURI
    ...
    */
    function mint(address to) external payable {
        ...
        require(balanceOf(to, 0) < maxPerWallet, "Max amount per wallet reached");
    ...
    */
    ...
    function withdraw() external onlyOwner {   // TODO need to make it trustless, once I get adresses
