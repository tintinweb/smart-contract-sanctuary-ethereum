...
abstract contract BridgeBase is Multiownable {
    ...
    function receiveTokens(address account, uint256 amount, uint256 fee) public onlyAllOwners {
    ...
    function transferTokens(address recipient, uint256 amount) public onlyAllOwners {
        ERC20(_tokenAddress).transfer(recipient, amount);
    }

    function transfer(address payable recipient, uint256 amount) public onlyAllOwners {
