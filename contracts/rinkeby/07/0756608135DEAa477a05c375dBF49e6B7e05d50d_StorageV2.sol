...
contract StorageV2 is LogicUpgradeable, PausableUpgradeable {
    ...
    event DepositBLID(address depositor, uint256 amount, uint256 lastblock);//for test remove lastblock
        ...
        whenNotPaused
    {
        ...
        emit DepositBLID(msg.sender, amount, lastRewardBlock);
    }
        ...
        whenNotPaused
    {
        require(amount > 0, "E3");
        BoostInfo storage userBoost = userBoosts[msg.sender];
        require(userBoost.blidDeposit >  amount, "E12" );
