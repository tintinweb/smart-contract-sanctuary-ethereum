...
contract MetaLicenceplatesFinalsAA is ERC721A, ERC2981, ReentrancyGuard, Ownable {
    ...
    /**
     * @dev transfer revenue share amount to the owner of the tokenconvert
        ...
        nonReentrant
    {
        ...
        (bool success, ) = payable(user).call{value: _revenueShare * 1 wei}("");
        require(success, "Transfer failed");
        emit RevenueShareTransferred(_tokenId, _saleAmt, _revenueShare, user);
    }
