...
// File: contracts/ERC721Interface.sol
...
/*interface IERC721 {
    ...
    event ApprovalForAll(address indexed owner, address indexed operaator, bool approved);
 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable, issueNFT{
    ...
    //NFT的圖片位址
    string public _baseURI = "ipfs://URI";
    ...
    //重新設定cost
    function setCost(uint256 _newCost) public override{
        cost = _newCost;
    }
    ...
    //重新設定maxMintAmount
    function setMaxMintAmount(uint256 _newMaxMintAmount) public override onlyOwner{
     ...
     */
    function getBaseURI() public virtual view override returns (string memory) {
        return _baseURI;
    }
