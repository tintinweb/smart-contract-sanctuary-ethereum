...
//*********************************************************************//
//
//     __          ____                                  _   ______________   ______                     _     
//    / /   ____  / __/__  ________  __  ______ ___     / | / / ____/_  __/  / ____/__  ____  ___  _____(_)____
//   / /   / __ \/ /_/ _ \/ ___/ _ \/ / / / __ `__ \   /  |/ / /_    / /    / / __/ _ \/ __ \/ _ \/ ___/ / ___/
//  / /___/ /_/ / __/  __/ /  /  __/ /_/ / / / / / /  / /|  / __/   / /    / /_/ /  __/ / / /  __(__  ) (__  ) 
// /_____/\____/_/  \___/_/   \___/\__,_/_/ /_/ /_/  /_/ |_/_/     /_/     \____/\___/_/ /_/\___/____/_/____/  
//                                                                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xdafde9318BcAbf6a3C27786b434EFBEFDcb05355];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 400 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmW3dQXS4hxk436imq6dCqKG9qsf6jbR7pNo9k3F3bkTme/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 0.02 ether;
    
    uint256 public MAX_WALLET_MINTS = 2;
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 400");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 400");
...
// File: contracts/LofereumNftGenesisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LofereumNftGenesisContract is RamppERC721A {
    constructor() RamppERC721A("Lofereum NFT Genesis", "LOFERM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/2BtDDB92yxHgScgpP9uD/contract-metadata";
    }
}
