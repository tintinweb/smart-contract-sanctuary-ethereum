...
contract Utya is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint256 public constant totalSupplyCount = 50;
    uint256 public constant transactionLimit = 50;
    uint256 constant baseMintPrice = 0.007 ether;
    uint256 constant smallDiscountPrice = 0.006 ether;
    uint256 constant bigDiscountPrice = 0.005 ether;
    ...
    function mint(uint256 numTokens) payable external nonReentrant {
        ...
        require(totalSupply() + numTokens <= totalSupplyCount, "Total supply exceeded");
