...
contract tista is ERC721A, Ownable {
    uint256 public constant MINT_PRICE = 0.02021 ether;
    uint256 public constant MAX_SUPPLY = 8760;
    uint256 public constant MAX_PER_WALLET = 5;

    constructor() ERC721A("tista", "tista") {}
     ...
     * Withdrawal
     */
    address private constant gbbg =
        0x481033663A774207BEa085Fe6cA30D4948f69130;
    address private constant bggb =
        0x31A25B951d27854dA2ff117d4886e7c35891f21c;
    address private constant treasury =
        0x16FC69B2f42f81416595797bcC959F383E13269b;

    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        Address.sendValue(payable(gbbg), (balance * 15) / 100);
        Address.sendValue(payable(bggb), (balance * 15) / 100);
        Address.sendValue(payable(treasury), (balance * 70) / 100);
    }
}
