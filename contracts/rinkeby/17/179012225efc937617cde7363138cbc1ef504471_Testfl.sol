...
contract USDCDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Testfl_Usdc_Dividend_Tracker", "Testfl_Usdc_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000 * (10**18); //must hold 3,000,000,000+ tokens
    }
 
    function _transfer(address, address, uint256) pure internal override {
        require(false, "Testfl_Usdc_Dividend_Tracker: No transfers allowed");
    }
 
    function withdrawDividend() pure public override {
        require(false, "Testfl_Usdc_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Testfl contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Testfl_Usdc_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Testfl_Usdc_Dividend_Tracker: Cannot update claimWait to same value");
...
contract Testfl is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Testfl", "TESTFL") {
        	
    	marketingWallet = 0x6a402EC67bC786f539A3F73E8c33237C6BF2f299; 
    	usdcDividendToken = 0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735; 
