...
contract AVN is IAVN, IERC777Recipient, Owned {
  ...
  IAVN immutable internal LEGACY_AVN_TREASURY;
  ...
  constructor(address avt, LegacyValidatorsManager avnValidatorsManager, IAVN avnFTTreasury)
  {
    ...
    external
  {
    ...
    LEGACY_AVN_TREASURY.unlockERC777Tokens(erc777Address, address(this), lockedBalance);
  }
    ...
    external
  {
    ...
    LEGACY_AVN_TREASURY.unlockERC20Tokens(erc20Address, address(this), lockedBalance);
  }
