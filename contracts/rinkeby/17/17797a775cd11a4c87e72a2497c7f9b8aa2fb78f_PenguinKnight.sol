...
contract PenguinKnight is ERC721, Ownable  {
    ...
    uint256 public pk_total_supply = 0;
    ...
    constructor() ERC721("PenguinKnight", "PK") {
        pk_max_supply = 5555;
    ...
    function mint(address _address) internal {
        uint256 tokenId = pk_total_supply + 1;
        _safeMint(_address, tokenId);
        pk_total_supply++;
    }
    function totalSupply() internal view returns (uint256) {
        return pk_total_supply;
    }
