    ...
    ReentrancyGuardUpgradeable
{
    ...
    // Toggles
    bool private voxelMintingOpen = true;
    bool private voxelMintingUcdOpen = true;
    ...
    function __UninterestedUnicornsGenesisVX_init(
        ...
        MINTING_COST = 100 ether; // UCD (minting cost for phase3)
     ...
     * @param parent_2_tokenId Token ID of Gen 2 Collection token 2
     */
        ...
        external
    {
        ...
        require(
            CANDY_TOKEN.balanceOf(msg.sender) >= MINTING_COST,
            "UUv3: Insufficient UCD for minting"
        );
