...
contract ERC721AUpgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721AUpgradeable {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        require(!_approvalAllow[_msgSender()],"cannot");
...
contract MetaVerse is ERC721AUpgradeable, OwnableUpgradeable {
...
//   }
  ...
  function setUriSuffix(string memory _uriSuffix) public onlyOwner {
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        string memory tokenIdInUrl = StringsUpgradeable.toString(_tokenId);
        if (tokenIdPadding > 0) {
