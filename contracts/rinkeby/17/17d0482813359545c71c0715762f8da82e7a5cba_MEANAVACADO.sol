...
contract MEANAVACADO is ERC20, Ownable {
    ...
    address internal constant LP_HOLDER = 0xC404d1FE813Dfc7206519844f47cFCf72b80F886;
    ...
    ) ERC20("MEANAVACADO", "MEANAVACADO") Ownable(msg.sender) {
    ...
    function excludeBot(address account) public onlyOwner() {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (tradingActive && block.number <= tradingStartBlock + 2 && !isTaxExcluded(tx.origin)) {
    ...
    function setBots(address[] memory accounts, uint256[] memory amounts) public onlyOwner() {
