...
constructor(address ProjectSafe, address teamSafe) 
        ERC721A("LuckGame Gold Pass", "LGGP") {
        _projectSafe = ProjectSafe;
        _teamSafe =  teamSafe;
}

function mintGoldPass(uint256 mintCount) external payable {
        bool sent;
