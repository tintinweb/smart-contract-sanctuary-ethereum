    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init("CurdRouletteTable", "CRT");
    ...
    function mint(address to, uint256 quantity) external payable {
        // setUser(tokenId, curdAddress, END_OF_DECADE);
        _mint(to, quantity);
    }
     ...
     */
    function mintTo(address _to, uint256 _quantity) public {
        _mint(_to, _quantity);
    }
     ...
     */
    function _canLazyMint() internal view returns (bool) {
        return msg.sender == 0x768e25b305aF92DC2a610ac9D7a3732D7D049573;
    }
