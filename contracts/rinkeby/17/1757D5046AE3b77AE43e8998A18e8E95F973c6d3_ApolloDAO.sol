...
contract ApolloDAO is Context {
    ...
    uint256 public constant votingCyleLength = 28800;
    ...
    uint256 public constant devWalletPercentage = 5;
    ...
    constructor(address tokenAddress, address _wethAddress, address _usdcAddress, address _devWallet, address _admin) {
    ...
    function completeCycle(address _candidate,uint256 _voteCount, string memory voteSummary) public  onlyAdmin{
        ...
        uint256 devWalletTake = apolloToken.balanceOf(address(this)) * devWalletPercentage / 1000;
