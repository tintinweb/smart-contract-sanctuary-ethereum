...
contract doodledickz is Ownable, ERC721 {
    ...
    address public presalewhiteaddress2 = 0x42069ABFE407C60cf4ae4112bEDEaD391dBa1cdB;
    address public presalewhiteaddress3 = 0x42069ABFE407C60cf4ae4112bEDEaD391dBa1cdB;
    ...
    constructor() ERC721("Doodle Dickz", "DD"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      function withdraw() external onlyOwner {
        ...
        payable(0x9D1976D49e7E4C67210944EB5fCA239Fc7f48FBa).transfer(_balance * 50 / 100); //test1
        payable(0x225dAd8C2cf0715bd2573B54Cd846a31329B2531).transfer(_balance * 50 / 100); //test2
    }
