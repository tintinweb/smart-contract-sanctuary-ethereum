...
contract TempContract is ERC721Enumerable, EIP712, Ownable, Pausable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public supply = 100;            // Total supply (reserved + whitelist + public sale)
    uint256 public reservedNFTs = 10;        // Reserved token for promotion and giveaway
    uint256 public cost = 0.002 ether;         // Public Sale price
    uint256 public costWL = 0.001 ether;      // Whitelist Price
    uint256 public maxMint = 20;             // Max mint per single transaction
    uint256 public MAX_WL_PER_WALLET = 50;    // Max WL token per Wallet
    uint256 public WHITELIST_NFTS = 50;     // Token Reserved for Whitelist
    ...
    address address1 = 0x050d1B4a57FdF2e69eD13735044d9ba33A3A4c72; // Production
    address address2 = 0x58e2C833E7Dab378Cf9EC3d8Fd10C89214678991; // Marketing
    address address3 = 0x06727397AAC466917B7020Ba5DD5d6c5C3B5CB16; // Digital Ops
    ...
    constructor(string memory _initialBaseURI, string memory _SIGNING_DOMAIN, string memory _SIGNATURE_VERSION)
     ERC721("SHER NFT S1 v0.12", "SHERS1")
