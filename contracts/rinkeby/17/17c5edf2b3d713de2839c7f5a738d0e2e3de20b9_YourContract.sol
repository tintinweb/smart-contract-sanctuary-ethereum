...
contract YourContract {
  ...
  string public newPuprpose = "yo man ";
  ...
  function setPurpose3(address _address, string memory data) public {
    mappedData[_address] = data;

    emit SetPurpose(msg.sender, purpose);
  }

  function setPurpose4(Status _status, string memory data) public returns (string memory) {
    status = _status;
  ...
  function setPurpose5(string memory data) public view returns (uint256[] memory) {
    return arr;
  }

  function setPurpose6(uint256 value) public {
    arr.push(value);
  }

  function setPurpose7(string memory data) public view returns (string memory) {
    return "cool view return function";
  }

  function setPurpose8(string memory data) public payable returns (string memory) {
