    ...
    AccessControlUpgradeable
{
    ...
    function __CBWCBase_init(
        ...
        __ERC2981_init();
        __ERC721KFNC_init(name_, symbol_);
...
abstract contract ERC721KFNCUUPSUpgradeable is IERC721KFNC, UUPSUpgradeable {
    ...
    function __ERC721KFNC_init(string memory name_, string memory symbol_) internal onlyInitializing {
        __ERC721KFNC_init_unchained(name_, symbol_);
    }

    /// @notice Initializer due to this being an upgradeable contract
    /// @param name_ Name of the contract
    /// @param symbol_ An abbreviated name for NFTs in this contract
    function __ERC721KFNC_init_unchained(string memory name_, string memory symbol_) internal onlyInitializing {
        _name = name_;
        _symbol = symbol_;
