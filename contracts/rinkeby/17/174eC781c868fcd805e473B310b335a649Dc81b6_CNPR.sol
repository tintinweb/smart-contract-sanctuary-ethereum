...
contract CNPR is CNPRadmin, ERC721A {
    ...
    constructor() ERC721A("CNPR", "CNPROOKIES") {
     ...
     */
    function totalBurned() internal view virtual returns (uint256) {
        return _totalBurned();
    }
...
abstract contract CNPRadmin is CNPRcore {
    ...
    /**
     *  @notice Get the number of presale mint set for an address.
     *  @param _address The address to be set in presaleMintCount.
     *  @return The number of presale mint set at the address.
     */
