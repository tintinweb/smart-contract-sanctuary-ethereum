...
contract ERC721ABreeding is ERC721A, Ownable {
    ...
    // function breedableOf(address _address, uint256 _type) public view returns (uint256) {
    ...
    function getTokenIds(address _owner, address _contract) public view returns (uint[] memory) {
