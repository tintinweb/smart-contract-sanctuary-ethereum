...
contract MetroBlockBlackout is ERC721, Controllable {
    ...
    string public baseTokenURI = "ipfs://QmQxyBJMAk3i9g155n4EtGduQaWwS5KE1AbhjCNPJ3awuv/";
    ...
    /**
     * Returns score value for specific Block Id. 
     * Is 0 before reveal of collection.
     * @param tokenId - City Block Id (1 - 10000)
     * @return score - block score (in range of 200-400)
     */
    ...
    /**
     * Returns number which encodes info about 32 special buildings
     * (boosts buildings, laucher pods).
     * Is 0 before reveal of collection.
     * @param tokenId - City Block Id (1 - 10000)
     * @return info - block score (in range of 200-400)
     */
    ...
    function metMint(uint256 amount, bool stake) public {
        require(metSaleActive || msg.sender == deployerAddress, "MET sale is not active");
    ...
    function ethMint(uint256 amount, bool stake) public payable {
        require(ethSaleActive || msg.sender == deployerAddress, "ETH sale is not active");
    ...
    function _mint(uint256 amount, bool stake) internal {
        ...
        if (stake) {require(vaultStorageAddress != address(0x0), "VaultAddress is not defined");}
        ...
        for (uint256 i = 0; i < amount; i++) {
            ...
            _mint(stake ? vaultStorageAddress : msg.sender, newBlockId);
        ...
        if (stake) {
            IMetroVaultStorage(vaultStorageAddress).stakeUnsafe(msg.sender, tokenIds, 0, 0);
        }
    }
