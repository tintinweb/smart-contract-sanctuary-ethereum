...
contract MyToken is ERC20, Pausable, Ownable {
    ...
    function buyOnPresale() public whenNotPaused payable {
        require(CurrentStage == Stage(1) || CurrentStage == Stage(2), "Presale has not started yet or has already ended!");
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(totalSupply() + _amount * 10 ** decimals() <= MaxSupply, "Final supply reached!");
        _mint(_to, _amount * 10 ** decimals());
    }

    function setStage(uint8 _stage) public onlyOwner {
        CurrentStage = Stage(_stage);
    }
