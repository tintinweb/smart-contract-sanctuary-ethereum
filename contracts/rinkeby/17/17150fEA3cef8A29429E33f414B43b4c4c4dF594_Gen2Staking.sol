...
contract Gen2Staking is Initializable, PausableUpgradeable, ReentrancyGuardUpgradeable, RequestManagerUpgradeable, IERC721ReceiverUpgradeable {
    ...
    event StakedGenOne(address owner, uint256 id);
    event UnStakedGenOne(address owner, uint256 id);

    event StakedGenTwo(address owner, uint256 id);
    event UnStakedGenTwo(address owner, uint256 id);
    ...
    function stake(StakeRequest calldata request, bytes calldata signature) external whenNotPaused nonReentrant {
        ...
        for(uint256 i; i < noGenOnes;) {
            ...
            emit StakedGenOne(msg.sender, current);
            unchecked {
                ++i;
            }
        }
        ...
        for(uint256 i; i < noGenTwos;) {
            ...
            emit StakedGenTwo(msg.sender, current);
            unchecked {
                ++i;
            }
        }

        genOneStaked.mint(genOnes, request.genOnesAmount, msg.sender);
        genTwoStaked.mint(genTwos, request.genTwosAmount, msg.sender);
    }
    ...
    function unstake(UnstakeRequest calldata request, bytes calldata signature) external whenNotPaused nonReentrant {
        ...
        for(uint256 i; i < noGenOnes;) {
            ...
            emit UnStakedGenOne(msg.sender, current);
            unchecked {
                ++i;
            }
        }
        ...
        for(uint256 i; i < noGenTwos;) {
            ...
            emit UnStakedGenTwo(msg.sender, current);
            unchecked {
                ++i;
            }
        }

        genOneStaked.burn(genOnes, request.genOnesAmount, msg.sender);
        genTwoStaked.burn(genTwos, request.genTwosAmount, msg.sender);
    }
