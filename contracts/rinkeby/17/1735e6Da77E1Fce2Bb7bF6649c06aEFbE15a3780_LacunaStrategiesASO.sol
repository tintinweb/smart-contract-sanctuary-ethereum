...
contract LacunaStrategiesASO is ERC721A, Ownable {
    ...
    ) ERC721A("LacunaStrategiesASO", "LSAS") {
    ...
    /**
     * * Set Coupon Signer
     * @dev Set the public address of the coupon signing wallet
     * @param _couponSigner The new coupong signing wallet's public address
     */
