    ...
    AvantArteStoreInterfaceV1
{
    ...
    function isAllowedToMint(uint256) public view virtual override returns (bool) {
    ...
    function getAvailableTokenId()
        ...
        returns (uint256)
    {
        return availableErc721Tokens[0];
    }
...
abstract contract AvantArteStoreInterfaceV1 {
    ...
    event OnPurchase(address addr, uint256 id);
    ...
    /// @dev tells us if the token is available
    function isAllowedToMint(uint256 id) public view virtual returns (bool);
