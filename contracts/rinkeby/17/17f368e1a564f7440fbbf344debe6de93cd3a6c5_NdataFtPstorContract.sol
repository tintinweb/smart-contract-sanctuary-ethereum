...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x034a74a3D83A0b589cde8a02cBA258332aD960aA];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 3 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiadnchuq3uliilqabh45rmg5zp3fsrm6afn2fc62g6mgprev6z5me/";
...
// File: contracts/NdataFtPstorContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NdataFtPstorContract is RamppERC721A {
    constructor() RamppERC721A("NdataFTPstor", "NdataFtor"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/La3PVklgvLdd1vQsAZ8L/contract-metadata";
    }
}
