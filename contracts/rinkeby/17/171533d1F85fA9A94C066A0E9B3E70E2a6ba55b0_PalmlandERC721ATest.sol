...
contract PalmlandERC721ATest is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_SUPPLY = 9;
    ...
    uint public saleStartTime = 1647111167;

    mapping(address => uint) public amountNFTsperWalletWhitelistSale;

    uint private teamLength;

    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("PalmlandNFTTest", "PLT")
