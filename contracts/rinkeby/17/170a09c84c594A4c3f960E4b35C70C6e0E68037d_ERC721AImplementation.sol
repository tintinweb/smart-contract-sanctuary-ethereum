...
contract ERC721AImplementation is ERC721AUpgradeable {
    function initialize(string memory name, string memory short) initializerERC721A public {
        __ERC721A_init(name, short);
    }
