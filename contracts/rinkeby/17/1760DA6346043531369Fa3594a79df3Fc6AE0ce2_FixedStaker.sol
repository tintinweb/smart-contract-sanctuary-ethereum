  ...
  function deposit (
    ...
    console.log("checking tokenId=", tokenId);
      ...
      */
      ...
      console.log("sender", _msgSender(), "positions", position.stakedItems.length);
      /*
      for (
        ...
        */
        ...
        console.log("Before !alreadyStaked",alreadyStaked, "candidateId:", tokenId);
        if (!alreadyStaked) {
          position.stakedItems.push(tokenId);
        }
     // }
      console.log("positions after", position.stakedItems.length);
  ...
  function withdraw (
    ...
    emit Withdraw(block.timestamp, _msgSender(), _poolId, pool.item, _tokenIds);
      ...
      function getPosition(uint256 _id, address _addr) public view returns (uint256[] memory, uint256){
        ...
        console.log("returning getPosition", p.stakedItems.length, p.tokenPaid);
