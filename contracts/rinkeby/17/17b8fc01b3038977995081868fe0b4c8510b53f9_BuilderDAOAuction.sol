...
import {AuctionStorageV1} from "../auction/storage/AuctionStorageV1.sol";
import {IAuction} from "../auction/IAuction.sol";
import {IToken} from "../token/IToken.sol";
import {IUpgradeManager} from "../upgrade/IUpgradeManager.sol";
import {IWETH} from "../token/external/IWETH.sol";

contract BuilderDAOAuction is UUPSUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, AuctionStorageV1 {
    ///                                                          ///
    ///                          IMMUTABLES                      ///
    ///                                                          ///
    ...
    function _settleAuction() internal {
        ...
        if (_auction.highestBidder != address(0)) {
            ...
            if (highestBid > 0) {
                ...
                _handleOutgoingTransfer(house.treasury, highestBid);
            }
