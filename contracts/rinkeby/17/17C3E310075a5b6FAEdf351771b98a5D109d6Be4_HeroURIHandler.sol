    ...
    ERC721HolderUpgradeable
{
    ...
    function initialize(
        ...
        _enhancementCosts[1] = 500 * 10**18;
        _enhancementCosts[2] = 750 * 10**18;
        _enhancementCosts[3] = 1000 * 10**18;
        _enhancementCosts[4] = 1250 * 10**18;
        _enhancementCosts[5] = 1500 * 10**18;
        _enhancementCosts[6] = 1750 * 10**18;
        _enhancementCosts[7] = 2000 * 10**18;
        _enhancementCosts[8] = 2250 * 10**18;
        _enhancementCosts[9] = 2500 * 10**18;
        _enhancementCosts[10] = 2500 * 10**18;
        _enhancementCosts[11] = 2500 * 10**18;
        _enhancementCosts[12] = 2500 * 10**18;
        _enhancementCosts[13] = 2500 * 10**18;
        ...
        returns (Stats.HeroStats memory)
    {
        ...
        uint8 adjustment = _getPartySizeAdjustment(enh, tokenId);
    ...
    function _getPartySizeAdjustment(uint8 enhancement, uint256 tokenId)
        internal
        pure
        returns (uint8 adjustment)
    {
        if (tokenId <= 1111 && enhancement >= 10) {
            adjustment = (enhancement - 9) * 2 + 5;
