...
contract HYFI_Presale is Initializable, AccessControlUpgradeable {
    ...
    function getBuyerReferralData(address addr, string memory referral)
        external
        view
        returns (uint256)
    {
...
interface IHYFI_Referrals {
    ...
    function addToReferralCodeList(string memory referralCode) external;
    ...
    function removeFromReferralList(string memory referralCode) external;
