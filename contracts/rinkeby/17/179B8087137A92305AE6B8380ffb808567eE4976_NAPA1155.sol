...
import "../contracts/NAPA1155.sol";

contract $NAPA1155 is NAPA1155 {
    constructor(string memory _name, string memory _symbol, address _receiverRoyaltyFee, uint96 _percentageRoyaltyFee) NAPA1155(_name, _symbol, _receiverRoyaltyFee, _percentageRoyaltyFee) {}
