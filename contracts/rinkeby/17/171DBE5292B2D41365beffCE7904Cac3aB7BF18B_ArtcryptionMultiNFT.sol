...
contract ArtcryptionMultiNFT is
    Initializable,
    ERC1155Upgradeable,
    AccessControlUpgradeable
{
    ...
    modifier creatorOnly(uint256 _id) {
        require(
            ...
            "Artcryption#creatorOnly: ONLY_CREATOR_ALLOWED"
        );
        _;
    }
    ...
    modifier ownersOnly(uint256 _id) {
        require(
            ...
            "Artcryption#ownersOnly: ONLY_OWNERS_ALLOWED"
        );
        _;
    }
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        require(
            _exists(_id),
            "Artcryption#Metadata: URI query for nonexistent token"
        );
    ...
    function create(
        ...
        require(
            ...
            "ArtcryptionMultiNFT: !AUTHORIZED"
        );
