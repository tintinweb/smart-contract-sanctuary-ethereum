...
//                                                         E##0###@@@###00|[email protected]@@@@@@@@@@@@@=_:`   ..::,;;~,;~;~.`-.-..`---``      `   -..`. `~#@@@@@@0|FTTF0#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#.  _@@@@@@F'                                                
...
contract SVR is ERC721A, PaymentSplitter, Ownable {
    ...
    modifier isNotPaused(bool _enabled) { 
        ...
        constructor(string memory _newBaseURI) ERC721A("svr", "svr", MAX_PER_MINT,MAX_TOKENS) PaymentSplitter(addressList, shareList) {
        baseURI = _newBaseURI;
        _safeMint(founderWallet, 2); 
        _safeMint(artistWallet1, 1); _safeMint(artistWallet2, 1); _safeMint(artistWallet3, 1); _safeMint(artistWallet4, 1); _safeMint(artistWallet5, 1);
        _safeMint(artistWallet6, 1); _safeMint(artistWallet7, 1); _safeMint(artistWallet8, 1); _safeMint(artistWallet9, 1); _safeMint(artistWallet10, 1);
...
contract SteakDiner is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(SVR _nft, SimpleToken _token) { 
    NFT = _nft;
    token = _token;
  }
