...
//NFTの部分を.solと同じ名前に変更
contract kkkken is ERC721Enumerable, Ownable {
  using Strings for uint256;
//ここをプロジェクトに合わせて変更
  string baseURI;
  ...
  constructor(
    ...
    setBaseURI("ipfs://QmbhNN8NWmYL1TGomAEGWmUctkbSd6PFPK956TyqdpCNRF/");
    setNotRevealedURI("ipfs://QmbhNN8NWmYL1TGomAEGWmUctkbSd6PFPK956TyqdpCNRF/");
  }
