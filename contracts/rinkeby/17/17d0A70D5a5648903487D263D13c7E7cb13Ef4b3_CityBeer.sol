// SPDX-License-Identifier: MIT
    ...
    contract CityBeer is ERC721, Ownable, ERC721Enumerable {
      ...
      event BeerMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("CityBeerNew", "EFS") {}
      ...
      function mintBeer(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit BeerMinted(id, msg.sender);
          }
        }
      }
    
      function presaleBeer(uint256 numberOfTokens) external payable {
