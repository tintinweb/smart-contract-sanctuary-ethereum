...
// GenieToken.
contract GenieToken is Initializable, ContextUpgradeable, ERC20Upgradeable, UUPSUpgradeable, Whitelist {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("Genie Token", "GENIE");
        __Ownable_init();
    ...
    function transfer(address _to, uint256 _value) public override returns (bool) {
        ...
        if (taxAmount > 0){
            super.transfer(vaultAddress, taxAmount);
            emit TaxPayed(msg.sender, vaultAddress, taxAmount);
        }
        super.transfer(_to, adjustedValue);
