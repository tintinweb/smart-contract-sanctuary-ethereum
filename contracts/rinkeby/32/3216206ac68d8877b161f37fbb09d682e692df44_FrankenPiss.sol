...
contract FrankenPiss is ERC721A, Ownable, NonblockingReceiver {
    using Strings for uint256;
    ...
    function mint(uint8 numTokens) external payable {
        require(!paused);
        require(numTokens > 0);
        require(numTokens < 3, "Peexels: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ETHEREUM,
            "Peexels: Mint exceeds supply"
        );
    ...
    returns (string memory)
  {
    ...
    // This will pay Peexels 1% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0xB21830531fB573A4Cb328f93E556383446550288).call{value: address(this).balance * 1 / 100}("");
    require(hs);
    // =============================================================================
