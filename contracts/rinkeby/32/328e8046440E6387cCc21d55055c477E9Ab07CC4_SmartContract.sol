...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "recheking";
    string private constant _symbol = "recheck3";
    ...
    constructor () {
        ...
        rewardWalletMaxToken = 400 * 10**9;
        qualifiedTokensForReward = 200 * 10**9; 
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        if(toLiquify>0){
            ...
            emit AutoLiquify(ethForLiquidity, toLiquify);
        }
        */
