...
contract DEX {
    ...
    constructor(address token_addr) {
        ...
        lpEthToken = new LPEthToken("LPEthToken", "LPDEX");
    }
    ...
    function init(uint256 tokens) public payable returns (uint256) {
        ...
        console.log("lpEthToken receiver: ", msg.sender);
        console.log(
            "lpEthToken receiver balance: ",
            lpEthToken.balanceOf(msg.sender)
        );
