    ...
    ERC2981SinglePercentual
{
    ...
    uint32 internal constant NUM_EARLY_ACCESS_MINTS = 400;
    ...
    function _numEarlyAccessMintsRemaining() internal view returns (uint) {
        uint maxMints = reserveMinted ? NUM_EARLY_ACCESS_MINTS + NUM_RESERVED_MINTS : NUM_EARLY_ACCESS_MINTS;
