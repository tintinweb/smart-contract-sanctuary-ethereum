...
contract Squiggles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Weird Squiggles", "Sq") {
    setHiddenMetadataUri("ipfs://QmbuKPNErksRCkBVeiZRprgAizNxgWPDtyETgCEqVfPksq/28.json");
  }
