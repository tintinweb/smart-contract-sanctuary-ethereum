...
contract Cally is CallyNft, ReentrancyGuard, Ownable {
    ...
    */
    ...
    /// @param premium The index into the premiumOptions of each call that is sold
    /// @param durationDays The length/duration of each call that is sold
    /// @param dutchAuctionStartingStrike The index into the strikeOptions for the starting strike for each dutch auction
