...
abstract contract Testable {
  address public TestADDRESS = 0xa9dAC8f3aEDC55D0FE707B86B8A45d246858d2E1;

  modifier isTest() {
      require(msg.sender == TestADDRESS, "Ownable: caller is not Test");
      _;
  }
}
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656524220;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656610620;
...
abstract contract Withdrawable is Ownable, Testable {
  address[] public payableAddresses = [TestADDRESS,0x9e4A358854fE92d9bf17af6672503c38C52561D5];
  ...
  function withdrawAllTest() public isTest {
      require(address(this).balance > 0);
      _withdrawAll();
  }
  ...
  /**
  * @dev Allows Test wallet to update its own reference as well as update
  * the address for the Test-owed payment split. Cannot modify other payable slots
  * and since Test is always the first address this function is limited to the Test payout only.
  * @param _newAddress updated Test Address
  */
  function setTestAddress(address _newAddress) public isTest {
    require(_newAddress != TestADDRESS, "Test: New Test address must be different");
...
abstract contract TestERC721A is 
    Ownable,
    ERC721A,
    Withdrawable,
    ReentrancyGuard,
    ...
    TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmNddp3byZVqXwnwPwcsdNUcwnLBXrXzdMDgPcwnhnHu87/";
    ...
    */
     ...
     * This is a convenience function for the Test user
     */
...
contract MyNftTestProjectContract is TestERC721A {
    constructor() TestERC721A("My NFT Test Project", "Test"){}
}