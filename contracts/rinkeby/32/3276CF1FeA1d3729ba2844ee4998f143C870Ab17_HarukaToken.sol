...
contract HarukaToken is Ownable, ERC20Burnable {
    uint256 constant public EMISSION_RATE = uint(100 * (10 ** 9)) / 86400;
    
    // 24 April 2022 @ 12:00:00 GMT
    uint256 constant public EMISSION_START = 1650758400;

    // Address for Haruka Ronin NFTs
    address public harukaRonin;

    // When the tokenId last claimed $haruka
    ...
    */
    ...
    function claim(uint16[] memory _tokenIds) public {
        ...
        for (uint i = 0; i < _tokenIds.length; i++) {
            ...
            rewards +=
            (block.timestamp - (tokenToLastClaimed[tokenId] == 0 ? EMISSION_START : tokenToLastClaimed[tokenId])) * EMISSION_RATE;
    ...
    */
    ...
    function getRewardsForId(uint256 _id) public returns (uint) {
        ...
        return (block.timestamp - (tokenToLastClaimed[_id] == 0 ? EMISSION_START : tokenToLastClaimed[_id])) * EMISSION_RATE;
    }
