...
contract PookPook is ERC721A, Ownable {
    ...
    uint public price = 0.0098 ether;

    bytes32 public merkleRoot;

    mapping(address => uint) public FreeMintCount;

    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Pooks", "Pooks Terribles")
    {
        baseURI = _baseURI;
