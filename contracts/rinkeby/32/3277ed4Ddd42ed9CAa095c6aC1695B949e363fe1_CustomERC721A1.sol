...
contract ERC721AUpgradeable is ERC721A__Initializable, IERC721AUpgradeable {
    ...
    function __ERC721A_init_unchained(
        ...
        ERC721AStorage
            .layout()
            ._baseUri = "https://ipfs.io/ipfs/QmQbrF3Y9Attw1oUNAtBeEpCUBzkUGgPJaZHuS4m2YnRLb";
        ERC721AStorage
            .layout()
...
contract CustomERC721A1 is ERC721AUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init({
            name_: "CryptoOtters",
            symbol_: "ETH",
            pricePublicSale_: 100 ether,
            pricePreSale_: 75 ether,
            amountForPreSale_: 1470,
            amountForPublicSale_: 8500,
            amountForFreeSale_: 30,
