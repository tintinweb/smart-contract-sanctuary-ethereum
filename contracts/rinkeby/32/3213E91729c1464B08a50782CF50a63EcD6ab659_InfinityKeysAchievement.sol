    ...
    PaymentSplitter  
{
    ...
    */
    ...
    address[] private ikPayees = [0x71665B951a9EB87c8e6A8EF29a266fA578a78654];
    uint256[] private ikShares = [100];
    ...
    constructor(
        ...
        address _endpoint
    ) ERC1155("https://www.infinitykeys.io") PaymentSplitter(ikPayees, ikShares) {
        name = _name;
        symbol = _symbol;
        setSecret(_secret);
        setSigner(_signer);
    ...
    */
    function gateCheck ( uint256 _tokenID, address _address ) private view returns ( bool ) {
        ...
        if (gate == GateState.noGate) {
            ...
            if (balanceOf(_address, tokens[_tokenID].internalGateID) > 0) {
                return true;
            }
