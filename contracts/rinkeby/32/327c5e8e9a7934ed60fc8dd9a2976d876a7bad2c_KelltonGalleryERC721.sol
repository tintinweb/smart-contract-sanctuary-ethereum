...
import "./IKelltonNFTERC721Upgradeable.sol";

/*  Commission fee calculation related contract */
contract KelltonGalleryERC721 is
    Initializable,
    ERC721Upgradeable,
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(uint96 commissionPercentage, address commissionReceiver)
        ...
        initializer
    {
        __ERC721_init("KelltonTech", "ONEKELLTON");
    ...
    /* Map all KelltonNFT to  KelltonNFTs*/
    mapping(uint256 => KelltonNFT) public KelltonNFTs;
        ...
        nonReentrant
    {
        ...
        KelltonNFT storage nft = KelltonNFTs[payload.tokenId];
    ...
    function safeTransferNFTERC721(
        IKelltonNFTERC721Upgradeable ERC721KelltoneNFT,
        Payload memory sellerPayload,
        Payload memory buyerPayload,
        Signature memory sellerSig,
        Signature memory buyerSig
    ...
    function _mint(Payload memory payload) internal returns (uint256) {
        ...
        KelltonNFT storage newNFT = KelltonNFTs[payload.tokenId];
    ...
    function setCommission(uint256 tokenId, uint96 commissionPercentage) public virtual onlyOwner {
        ...
        KelltonNFT storage nft = KelltonNFTs[tokenId];
    ...
    function getRoyalties(uint256 tokenId) public view returns (uint96[] memory, address[] memory) {
        ...
        return (KelltonNFTs[tokenId].royalty, KelltonNFTs[tokenId].royaltyReceiver);
    }
    ...
    function _executeTransferERC721(
        ...
        require(ERC721KelltoneNFT.balanceOf(seller) >= 1, "H151");
        ...
        (royaltyPercentage, royaltyReceiver[0]) = ERC721KelltoneNFT.royaltyInfo();
        ...
        ERC721KelltoneNFT.safeTransferFrom(seller, buyer, tokenId, "");
    }
 ...
 */
interface IKelltonNFTERC721Upgradeable  {
    /**
...
contract CommissionUpgradeable {
    ...
    function _getCommission(uint256 _commissionPercentage, uint256 _salePrice)
        internal
        view
        virtual
        returns (address receiver, uint256 _commisionamount)
    {
