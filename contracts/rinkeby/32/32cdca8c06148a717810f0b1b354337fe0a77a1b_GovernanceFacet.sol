// File: GovernanceFacet_flat_flat.sol


// File: GovernanceFacet_flat.sol
...
**/
contract GovernanceFacet is VotingBooth, SeraphProtected {
    ...
    event Bipevent(uint32 indexed bip);
    ...
    **/
    ...
    function getStart(uint32 bipId) public view returns (uint32){
        return startFor(bipId);
    }

    function setStarttoNominate (uint32 bipId) public {
        s.g.bips[bipId].start = 1;
    }
