...
contract SJGContract is ERC721A, Ownable{
    ...
    uint256 public MAX_SUPPLY     = 60;            // MAX_SUPPLY 
    uint256 public MAX_PUB_MINT   = 10;             // Max mint # per wallet. //TODO this need to go.
    ...
    mapping(address => uint256) public whitelist   ;    // Tracks WL minting per address.
