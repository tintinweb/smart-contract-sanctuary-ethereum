...
contract EthArbitrage is AccessControlUpgradeable {
    ...
    function initialize(
        ...
        address tokenAddressBasic,
        address tokenAddressStable
    ...
    function changeStable(address newStableAddress)
        public
    ...
    function changeBasic(address newBasicAddress)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function withdrawStable(uint256 amount)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
        returns (uint256)
    {
    ...
    function withdrawBasic(uint256 amount)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
        returns (uint256)
    {
    ...
    function swapStableToBasic(uint256 amount, uint256 minAmountOut)
        public
        onlyRole(SIGNER)
    {
    ...
    function swapBasicToStable(uint256 amount, uint256 minAmountOut)
        public
        onlyRole(SIGNER)
    {
