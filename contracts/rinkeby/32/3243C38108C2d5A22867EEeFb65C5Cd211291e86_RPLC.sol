...
contract RPLC is ERC20Permit, Ownable {
    /// @notice Bond contract address
    address public bondContract;

    /// @notice Staking/reward contract address
    address public rewardContract;

    modifier onlyMinters() {
        require(
            bondContract == msg.sender || rewardContract == msg.sender,
            "Only minters"
        );
        _;
    }
    ...
    {
        require(
            bondContract == address(0) && rewardContract == address(0),
            "already set"
        );
        require(
