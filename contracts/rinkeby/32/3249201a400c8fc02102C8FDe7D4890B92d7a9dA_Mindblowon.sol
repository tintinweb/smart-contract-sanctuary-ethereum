    ...
    Withdrawable
{
    ...
    uint256 public constant GIFT_MAX_QTY = 35;
    uint256 internal constant DASALES_MAX_QTY = 2000;
    uint256 internal constant DA_AND_PUBLIC_MAX_QTY_PER_MINTER = 1;
    uint256 public constant DA_SALES_START_PRICE = 0.69 ether;
    uint256 public DA_LAST_PRICE = DA_SALES_START_PRICE;
    uint256 internal constant priceDropDuration = 1800; // 15 mins
    uint256 internal constant priceDropAmount = 0.05 ether;
    uint256 internal constant priceDropFloor = 0.169 ether;
    ...
    function refundAll() external {
        require(!isDASalesActivated(), "Refund Not Activate");
    ...
    function DASalesMint(uint256 canType) external payable isDASalesActive {
        ...
        DASalesMinterToTokenQty[msg.sender] += 1;
        DASalesMintedQty += 1;
        DAAddressIdToPrice[msg.sender] = price;
    ...
    function publicSalesMint(uint256 canType)
        external
        payable
        isPublicSalesActive
    {
