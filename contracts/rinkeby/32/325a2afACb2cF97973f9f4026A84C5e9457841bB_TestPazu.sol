...
contract TestPazu is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant MAXPAZUKI = 50; //7214;
    uint256 public constant freeMints = 20; //2214;
    uint256 public constant maxFreeMintsPerWallet = 11;
    uint256 public reservedPazukis = 5;
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("TestPazu", "TESTPAZU") {
        setBaseURI(baseURI);
        isSaleActive = false;
