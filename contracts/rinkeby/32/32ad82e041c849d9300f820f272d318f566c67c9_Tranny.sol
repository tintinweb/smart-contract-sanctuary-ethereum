...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xc778417E063141139Fce010982780140Aa0cD5Ab); 
...
contract Tranny is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tranny";
    string constant _symbol = "TRNY";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4253Aa611835b479dbC6F7886f5e3F81CC4dF435;  
        anothermarketingWallet = 0x2275F979bab02E940899b3077A00f21654Bbe148;
