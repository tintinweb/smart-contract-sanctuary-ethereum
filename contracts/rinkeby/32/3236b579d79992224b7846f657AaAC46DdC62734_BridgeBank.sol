...
contract BridgeBank is Initializable, ReentrancyGuardUpgradeable {
    ...
    function lock(
        ...
        slipPercentage = _slipPercentage;
    ...
    ) external view returns (uint256 amountOutIn, uint256 amountOutAfter) {
    ...
    function getImpactGetExactStableTokenForToken(
        ...
        _amountStableTokenIn =
            (_amountStableTokenIn * (10000 - PROTOCOL_FEE)) /
            10000;

        return _getImpactTokenOut(_amountStableTokenIn, path);
    }
    ...
    function getImpactGetTokenForExactStableToken(
        ...
        return _getImpactTokenOut(_amountStableTokenOut, path);
    }
    ...
    function getImpactGetStableTokenForExactToken(
        ...
        (amountOutIn, amountOutAfter) = _getImpactTokenOut(
            _amountTokenOut,
            path
        );
        amountOutIn = amountOutIn * (10000 / (10000 - PROTOCOL_FEE));
        amountOutAfter = amountOutAfter * (10000 / (10000 - PROTOCOL_FEE));
    }
