...
contract GenIDOFactory is IGenIDOFactory {
    ...
    function createGenIDO(
        ...
        GenIDO gd = new GenIDO(_underlyingToken, _totalTokenAllocation, _usdt, _maxAllocPerUserPerTier, _numApplicantsPerTier, _trancheWeightage, _trancheLength, _maxClaimPercentage, _guranteedSaleDuration, this, msg.sender);
        // Populate mapping
