...
contract DBSNFT is ERC721ABase, PaymentSplitter, ReentrancyGuard {
	// =========================================================================
	//                           Types
	// =========================================================================
	/**
	...
	uint256 public constant NUM_MAX_NFT = 1000;
	...
	modifier canMintTokens(uint256 quantity) {
		if (quantity + _totalMinted() > NUM_MAX_NFT) {
			revert Mint_SoldOut();
		}
	...
	constructor(
		...
		PaymentSplitter(royaltyReceivers, royaltyShares)
	...
	/**
	 *       @notice 3 free NFTs to each admin (7 admins - 21 NFTs total).
	 *       10 free NFTs to each creator (2 creators - 20 NFTs total).
	 *       50 free NFTs to DBS treasury.
	 */
		...
		onlyOwner
	{
		...
		if (_totalMinted() > NUM_MAX_NFT) revert AirdropExceedsMaxSupply();
