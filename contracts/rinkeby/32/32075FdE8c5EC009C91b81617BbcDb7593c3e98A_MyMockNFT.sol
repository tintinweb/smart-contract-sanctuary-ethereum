 ...
 */
 ...
 contract MyMockNFT is ERC721("My Testing NFT", "MTN") {
    ...
    event MyNFTBaseUriUpdate(
        string uri
    );

    event MyNFTTokenUriUpdate(
        uint256 _tokenId,
        string uri
    );
    ...
    function mint(address _beneficiary, string calldata _tokenUri) external returns (uint256) {
        ...
        emit MyNFTMinted(tokenId, _postCreator, _beneficiary, _tokenUri, "1 of 1");
    ...
    function burn(uint256 _tokenId) external {
        ...
        require(
            ...
            "Token.burn: Only garment owner or approved"
        );
    ...
    function setBaseURI(string memory baseURI_) external {
        ...
        emit MyNFTBaseUriUpdate(baseURI_);
    }
    ...
    function setTokenURI(uint256 _tokenId, string calldata _tokenUri) external {
        ...
        emit MyNFTTokenUriUpdate(_tokenId, _tokenUri);
    }
