...
contract RealEstateERC1155Token is ERC1155,  Ownable {
    ...
    function buyTiket(
        ...
        if (USD.balanceOf(msg.sender) < _amountUSD) {
            revert NoBalanceUSD(msg.sender, _amountUSD);
        }
...
import "@openzeppelin/contracts/access/Ownable.sol";
import "../src/RealEstateERC1155Token.sol";


contract RealEstateSale is Ownable {
    RealEstateERC1155Token private RENT1155;
    constructor(address rent1155){
        RENT1155 = RealEstateERC1155Token(rent1155);
    }
    ...
    function sellTicket(
        ...
        RENT1155.tranferTikets(from, to, idTiket, tiketAmount);
    }
