...
contract TRPP is ERC721, ERC721URIStorage, AccessProtected {
    ...
    constructor(address _whitelistAddress) ERC721("TRRP", "TTP") {
    ...
    function safeMint(string memory uri) public payable {
        ...
        require(nftCounter[msg.sender]<10,"You cannot mint more than 3 NFTs");
