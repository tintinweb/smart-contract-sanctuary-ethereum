...
contract PayslicEscrow is Ownable {
    ...
    event CreateEscrow(address seller, address buyer, string id, uint value); 
    event BuyerConfirm(address seller, address buyer, string id); 
    event SellerConfirm(address seller, address buyer, string id);   
