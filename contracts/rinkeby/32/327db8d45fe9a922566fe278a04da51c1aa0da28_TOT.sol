...
// File: contracts/OmniMoonbirds.sol
...
contract TOT is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT = 1111;
    uint256 public gas_fees = 0.001 ether;

    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("TESTOMNICHAIN", "TOT") { 
        _owner = msg.sender;
    ...
    // mint function
    function generate(uint8 numTokens) external payable {
        ...
        if (msg.sender != owner()) {
        require(msg.value >= gas_fees * numTokens);
        }
    }
