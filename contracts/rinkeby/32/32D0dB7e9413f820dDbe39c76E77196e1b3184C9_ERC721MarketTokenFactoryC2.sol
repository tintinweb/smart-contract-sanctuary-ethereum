...
contract MarketToken is
    ...
    OwnableUpgradeable
{
    string private _contractMetaHash;
    ...
    function initialize(
        ...
        _contractMetaHash = contractMetaHash_;
...
contract ERC721MarketTokenFactoryC2 {
    ...
    function createCollection(
        ...
        if (_payees.length > 0) {
            bytes memory paymentBytecode = getCreationBytecode(
        ...
        emit CreateMarketTokenProxy(tokenAddress, paymentAddress);
    }
