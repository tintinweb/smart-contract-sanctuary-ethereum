...
contract CoolSkullClubCrystal is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("COOL SKULL CLUB CYRSTALS", "CSKC") {}
    ...
    function OGMint(uint256 _mintAmount, bytes32[] calldata _OGMerkleProof) public payable nonReentrant {
    ...
    function WLMint(bytes32[] calldata _WLMerkleProof) public payable nonReentrant {
