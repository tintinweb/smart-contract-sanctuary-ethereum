...
// File: contracts/DappTokenWhitelistedCrowdsale.sol

pragma solidity ^0.8.7;



contract DappTokenWhitelistedCrowdsale is Crowdsale, MintedCrowdsale, WhitelistedCrowdsale {
  ...
  function _preValidatePurchase(
    ...
    internal
    override(Crowdsale, WhitelistedCrowdsale)
    isWhitelisted(_beneficiary)
  {
    super._preValidatePurchase(_beneficiary, _weiAmount);
  }
