  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(whitelisted[msg.sender] != true) {
          ...
          if(supply + _mintAmount == 5 && _mintAmount == 2) {
            setCost(0.07 ether);
          ...
          if(supply + _mintAmount == 501 && _mintAmount == 2) {
            setCost(0.1 ether);
          ...
          if(supply + _mintAmount == 751 && _mintAmount == 2) {
            setCost(0.12 ether);
          ...
          if(supply + _mintAmount == 1001 && _mintAmount == 2) {
            setCost(0.15 ether);
