...
import "./OwnSpotradeUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new SpotradeUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        SpotradeUser1155Token token = SpotradeUser1155Token(address(addr));
...
contract SpotradeUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
