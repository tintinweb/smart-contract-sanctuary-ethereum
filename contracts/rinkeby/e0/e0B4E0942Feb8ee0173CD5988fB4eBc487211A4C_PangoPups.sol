...
contract PangoPups is ERC721A, Ownable, ReentrancyGuard {
  /*
    ____                          ____                  
   / __ \____ _____  ____ _____  / __ \__  ______  _____
  / /_/ / __ `/ __ \/ __ `/ __ \/ /_/ / / / / __ \/ ___/
 / ____/ /_/ / / / / /_/ / /_/ / ____/ /_/ / /_/ (__  ) 
/_/    \__,_/_/ /_/\__, /\____/_/    \__,_/ .___/____/  
                  /____/                 /_/            
⠀⣀⠀⣀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⣿⡀⢻⣿⣿⣿⣿⣿⣶⠀⣤⣄⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠛⠓⠀⢻⣿⡿⠋⣉⣀⣀⢘⣿⣿⣿⡇⢠⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
  */
  ...
  uint256 public cost; //Normal mints
  uint256 public WLcost; //Whitelisted mints
  ...
  bytes32 data = "test";
  bytes32[] data2 = [bytes32("test1"),bytes32("test2"),bytes32("test3"),bytes32("test4")];
  ...
  function getNames() public view virtual returns (string[] memory) {
    string[] memory names = new string[](data2.length);
    for (uint i=0; i<data2.length; i++) {
        names[i] = bytes32ToString(data2[i]);
    }
    return names;
  }
