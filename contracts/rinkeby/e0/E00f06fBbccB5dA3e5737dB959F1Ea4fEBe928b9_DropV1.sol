...
//
/**
 * @title DropV1 Contract
 * @author Anotherblock Technical Team
 * @notice This contract is Anotherblock NFT token
 **/
...
contract DropV1 is ERC721AB {
    ...
    function mint(
        ...
        _mintAB(_to, _dropId, _quantity, _proof, false);
    }
    ...
    function claimTo(
        ...
        _mintAB(_userWallet, _tokenId, _quantity, emptyBytes, false);
    }

    /**
     * @notice
     *  Let a Paper user allowlist mint
     *  TODO limit to paper only
     */
    function paperMint(
        address _userWallet,
        uint256 _quantity,
        ...
        _mintAB(_userWallet, _quantity, _tokenId, emptyBytes, true);
    }
...
//
/**
 * @title ERC721AB Contract
 * @author Anotherblock Technical Team
 * @notice This contract is a Anotherblock NFT token standard designed to work with anotherblock.io
 **/
...
contract ERC721AB is ERC721Enumerable, ERC721ABErrors, ERC165Storage, Ownable {
    ...
    function setAnotherblock(address _anotherblock) external onlyOwner {
        // Check that the new address corresponds to IAnotherblockV1 interface
        if (
            !ERC165Checker.supportsInterface(
                _anotherblock,
                type(IAnotherblockV1).interfaceId
...
//
/**
 * @title IAnotherblockV1
 * @author Anotherblock Technical Team
 * @notice AnotherblockV1 Interface
 **/
