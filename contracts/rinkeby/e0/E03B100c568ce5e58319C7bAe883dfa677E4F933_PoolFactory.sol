...
contract PoolFactory is Context, IPoolFactory {
    ...
    function setFeeRatio(uint256 _feeRatio, uint256 _BONE) external override onlyManagerOrGovernance {
        feeRatio = _feeRatio;
        BONE = _BONE;
    }

    function getFee() external override view returns (uint256, uint256) {
...
contract Pool is Context, IPool {
    ...
    function add(
        ...
        _add(_stakeToken, _allocPoint, _startBlock, _bonusMultiplier, _bonusEndBlock, _minStakePeriod, _rewardAmount, _withUpdate, _isLpToken);
    }
...
interface IPool {
    ...
    function poolInfo(uint256) external view returns (address, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, bool);
    ...
    function add(address _stakeToken, uint256 _allocPoint, uint256 _startBlock, uint256 _bonusMultiplier, uint256 _bonusEndBlock, uint256 _minStakePeriod, uint256 _rewardAmount, bool _withUpdate, bool _isLpToken) external;
