...
import './FlokiChainSwapPair.sol';

contract FlokiChainSwapFactory is IUniswapV2Factory {
    address public feeTo;
    address public feeToSetter;

    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(FlokiChainSwapPair).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(FlokiChainSwapPair).creationCode;
...
import './FlokiChainSwapERC20.sol';
...
contract FlokiChainSwapPair is IUniswapV2Pair, FlokiChainSwapERC20 {
...
contract FlokiChainSwapERC20 is IUniswapV2ERC20 {
    using SafeMath for uint;

    string public constant name = 'FlokiChainSwap-LP-Token';
    string public constant symbol = 'FlokiChainSWAP-LP';
