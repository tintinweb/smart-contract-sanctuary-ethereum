...
enum status {bid_starting , bid_ending , running_bid, canceling_bid}
    ...
    constructor() ERC721("BNB NFT", "BNFT") Ownable(){
...
ownerr.transfer(hightestpayableBid);
...
for ( uint i = 0; i< Array.length; i++){
  ...
  struct FixedPrice{
    ...
    mapping(uint256 => FixedPrice) internal  Fixedprices; // tokenId => tokenId fixed Price
