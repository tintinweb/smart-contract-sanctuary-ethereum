...
contract MetafameSaleMTv3_0627 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Presalable{
    ...
    event OwnerMint(address indexed user, uint256 number);
    ...
    function getWLRemainingPurchase(address user) external view returns(uint256) {
