...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmUrmdum2cqESZTb5FnqLSt9y9vd3pVwZmFbTmCfg7PMPz"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("mcu_0185", "0185") payable {
        // 剛開始我們先自己 Mint 一個
