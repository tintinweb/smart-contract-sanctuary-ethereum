...
contract RAC is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    uint256 public WHITELIST_MINT_COUNT = 1500;
    ...
    function mintRAC(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            if (onlyWhitelisted == true) {
                ...
                require(
                    _totalMinted + _mintAmount <= WHITELIST_MINT_COUNT,
                ...
                require(
                    msg.value >= RETRO_PRICE * _mintAmount,
                    "insufficient funds"
                );
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _tokenIds.increment();
            emit retroArcadeNFTMinted(msg.sender, newToken);
