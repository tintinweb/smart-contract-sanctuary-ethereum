...
contract VitaZulu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 74 * 10**12 * 10**18;
    ...
    string private constant _name = "Vita Zulu";
    string private constant _symbol = "Zulu";
    ...
    uint256 public _maxTxAmount = 74 * 10**12 * 10**18; // ten trillion
    uint256 public numTokensSellToAddToLiquidity = 74 * 10**12 * 10**18;
    ...
    function airdropArray(
        ...
        uint256 iterator = 0;
        require(newholders.length == amounts.length, "Value mismatch: must be the same length");
    ...
    {
        require(
            SwapThresholdAmount > 74 * 10**12,
            "Swap Threshold Amount cannot be less than 10 Million"
        );
        numTokensSellToAddToLiquidity = SwapThresholdAmount * 10 ** _decimals;
    }
