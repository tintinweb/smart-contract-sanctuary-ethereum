...
//  _____              _                     ______       _  _ 
// /  __ \            | |                    |  ___|     | || |
// | /  \/ _   _  ___ | |_  ___   _ __ ___   | |_  _   _ | || |
// | |    | | | |/ __|| __|/ _ \ | '_ ` _ \  |  _|| | | || || |
// | \__/\| |_| |\__ \| |_| (_) || | | | | | | |  | |_| || || |
//  \____/ \__,_||___/ \__|\___/ |_| |_| |_| \_|   \__,_||_||_|
...
contract CustomFull is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/25/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/25/contract-uri";
	...
	uint256 public presalePricePerToken = 100000000000;
	...
	constructor(address _signerAddress) ERC721("Custom Full", "FULL") {
