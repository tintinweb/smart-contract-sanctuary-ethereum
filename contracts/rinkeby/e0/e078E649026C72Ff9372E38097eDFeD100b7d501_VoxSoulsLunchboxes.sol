    ...
    Signing
{
    ...
    function _mintSoul(
        ...
        require(
            currentLunchboxes + 1 <= maxAvailableLunchboxes,
        ...
        if (allowListEvent) {
            ...
            // else just mint the soul and incriment the current lunchbox mints.
            currentSaleCount++;
        }
    ...
    function mintLunchbox(
        ...
        require(msg.value >= getCost(), "Not enough eth to mint.");
    ...
    function batchMintLunchboxes(
        ...
        require(isValid, "Invalid signature");
        require(msg.value >= getCost() * id.length, "Not enough eth to mint.");
