...
abstract contract Ownable is Context {
 ...
 abstract contract ERC721AQueryable is ERC721A
 {
    ...
    contract GoblinApes is ERC721AQueryable, Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("GoblinApes", "GAP") {
  }
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
  ...
  function setwhitelistCost(uint _cost) external onlyOwner{
      whitelistCost = _cost;
 ...
 function setRevealed() external onlyOwner{
  ...
  function setMaxLimitPerAddress(uint8 _maxtx) external onlyOwner{
