...
contract Breadaverse is ERC721A, Ownable {
    ...
    uint16 public constant publicNfts = 5725;
    uint16 public constant reservedNfts = 325;
    ...
    function mint(
        ...
        require(totalSupply() + amount < publicNfts, "Mint limit reached");
        ...
        if (publicSaleStarted == false) {
            ...
            require(amount <= 3, "Cannot mint more than 3 in a single transaction");
            require(_numberMinted(msg.sender) + amount <= 3, "Address minted max amount");
        } else {
            require(amount <= 1, "Cannot mint more than 1 in a single transaction");
            require(_numberMinted(msg.sender) + amount <= 10, "Address minted max amount");
        }
