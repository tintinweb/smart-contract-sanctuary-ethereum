...
contract OrderRegistry {
    ...
    /**
     * @notice deploys a order contract using create2 then initializes with given data.  Should be called by ATS
     */
    ...
    /**
     * @notice creates a trade given two order IDs.  Should be called by ATS
     */
...
contract Order {
    ...
    /**
     * @notice ERC20 function that returns current deposited balance (for wallet integration)
     */
    ...
    /**
     * @notice ERC20 function that allows only the owner of the order to transfer funds out of the contract (wallet viable)
     */
    ...
    /**
     * @notice ERC20 function to fetch name of deposit token (for wallet integration)
     */
    ...
    /**
     * @notice ERC20 function to fetch symbol of deposit token (for wallet integration)
     */
    ...
    /**
     * @notice ERC20 function to get decimal precision for deposit token (for wallet integration)
     */
    ...
    /**
     * @notice returns active status of order
     */
    ...
    /**
     * @notice toggle active flag (only registry can call)
     */
    function toggleActive() external {
        require(msg.sender == registry, "UNAUTHORIZED");
        active = !active;
