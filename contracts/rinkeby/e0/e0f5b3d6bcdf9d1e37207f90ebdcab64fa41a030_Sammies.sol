...
// File: contracts/contracts/Sammies.sol
...
contract Sammies is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("Sammies", "CLUB") {
        setBaseURI(_baseURI);
