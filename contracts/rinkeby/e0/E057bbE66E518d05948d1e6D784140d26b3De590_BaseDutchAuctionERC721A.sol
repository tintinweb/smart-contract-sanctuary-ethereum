...
contract BaseDutchAuctionERC721A is ERC721A, LinearDutchAuction, ReentrancyGuard {
    ...
    uint64 private constant startPrice = 0.5 ether;
    uint64 private constant decreaseSize = 0.05 ether;

    uint256 private publicTotalMaxMint;
