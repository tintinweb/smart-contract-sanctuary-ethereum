...
contract JackpotApeLottery is ReentrancyGuard, IJackpotApeLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        if (freeTickets > 0) {
            // Even if user has free ticket, he should purchase one paid token at least.
            require(_ticketNumbers.length > freeTickets, "You have to purchase one paid ticket at least");
        }
        ...
        // _lotteries[_lotteryId].amountCollectedInTicketToken += amountTicketPrice;
        ...
        nonReentrant
    {
        ...
        // ) / 10000;
        uint256 amountToShareToWinners = _lotteries[_lotteryId].amountCollectedInTicketToken;
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            amountCollectedInTicketToken: _rewardAmount,
