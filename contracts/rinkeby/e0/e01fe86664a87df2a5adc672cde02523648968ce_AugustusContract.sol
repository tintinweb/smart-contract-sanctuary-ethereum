...
//
//                                 __            
//   ____ ___  ______ ___  _______/ /___  _______
//  / __ `/ / / / __ `/ / / / ___/ __/ / / / ___/
// / /_/ / /_/ / /_/ / /_/ (__  ) /_/ /_/ (__  ) 
// \__,_/\__,_/\__, /\__,_/____/\__/\__,_/____/  
//            /____/                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD4bA9c8AEc94ed618EcCF356d56Ea4cc89694300];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qma937sPBvVCn4JEPvJiyVMGfrPmhUadBScxprxibTi28F/";
...
// File: contracts/AugustusContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AugustusContract is RamppERC721A {
    constructor() RamppERC721A("augustus", "AUG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/mykEyMJMlwpieHHo1oUP/contract-metadata";
    }
}
