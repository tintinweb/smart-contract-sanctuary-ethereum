...
contract FurioPool is BaseContract
{
    ...
    {
        return paymentBalance() / tokenBalance();
    }

    /**
     * Payment.
     * @return address Payment token address.
     * @dev Returns payment token address.
     */
    ...
    /**
     * Token.
     * @return address Fur token address.
     * @dev Returns the $FUR token address.
     */
    ...
    /**
     * Dev wallet.
     * @return address Dev wallet address.
    ...
    {
        require(_devWallet != address(0), "Dev wallet not set");
        _payment.transfer(_devWallet, paymentBalance());
        _token.transfer(_devWallet, tokenBalance());
    }
}
