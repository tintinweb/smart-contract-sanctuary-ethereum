...
// YetiLand Star Here
//
contract TestYetiLand is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Test YETI LAND", "TESTYETIL") {}
    ...
    function mintYetiHolder(uint _mintAmount) public payable {
        require(sale.state != 0, "Sale is not active");
        require(_mintAmount > 0, "You must mint at least 1 NFT");
        require(isYetiHolder[msg.sender], "Only yetiHolder users allowed during presale");
        require(_reserveTokenId + _mintAmount <= (maxSupply - maxClaimLandSupply), "Max public supply exceeded");
