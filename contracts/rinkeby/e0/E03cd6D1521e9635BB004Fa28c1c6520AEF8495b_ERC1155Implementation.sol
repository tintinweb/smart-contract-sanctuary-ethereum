    ...
    ERC1155Upgradeable, ERC2981
{
    ...
    mapping(uint256 => bytes) public treads;
    ...
    function init(
        ...
        _setRoleAdmin(MINTER_ROLE, OWNER_ERC1155_ROLE);
    ...
    /// @param tread amount of tokens that should be mint
