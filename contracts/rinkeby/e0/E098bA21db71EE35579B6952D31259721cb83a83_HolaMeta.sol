...
contract HolaMeta is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 200;
    uint256 public constant MAX_PUBLIC_MINT = 1;
    uint256 public constant PUBLIC_SALE_PRICE = .006 ether;
    ...
    constructor() ERC721A("HolaMetaverso", "HOLA"){
    ...
    function mint() external payable callerIsUser{
        ...
        require((msg.value >= PUBLIC_SALE_PRICE) , "cheapo");
