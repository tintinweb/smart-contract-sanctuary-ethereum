...
contract AutisticIntelligence is Ownable, ERC721A, ReentrancyGuard {
    ...
    string private _baseTokenURI = "https://www.poettxt.art/meta/";
    address private receiver_wallet;
    uint256 public price = 1111 * 10**12; // 14
    uint256 public max_per_wallet = 11;
    uint256 public starttime = 1649269145;
    uint256 public wl_duration = 2 days;
  
    mapping(address => bool) private _whitelistedAddresses;

    address private _wassie_address = 0x980417A201604969CA1B3BFc3B1cfd087b19a30D;
