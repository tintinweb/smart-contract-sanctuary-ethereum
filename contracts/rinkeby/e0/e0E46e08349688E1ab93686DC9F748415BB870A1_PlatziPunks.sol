...
contract PlatziPunks is ERC721,ERC721Enumerable,PlatziPunksDNA{
    ...
    constructor(uint256 _maxSupply) ERC721("PlatzyPunks","PLPKS"){
        maxSupply = _maxSupply;
    }


    function mint() public payable{
        //require(msg.value>=5000000000000000, "You need 0.05ETH to mint the PlatziPunk");
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory){
        require(_exists(tokenId),"ERC721 not exists");
