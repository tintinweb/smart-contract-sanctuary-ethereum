...
contract Digit_mfers is Ownable, ERC721A {
    ...
    string private _tokenBaseURI = "https://storageapi.fleek.co/b701e2b3-d1dc-4c52-9586-8d26ee95b05d-bucket/FMD/";
    uint256 public DM_MAX = 5000;
    uint256 public DM_PRICE_free = 0 ether;
    uint256 public DM_PRICE = 0.0069 ether;
    uint256 public DM_PER_MINT = 5000;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x3445544E92EF4a2708000A08D20F14B24BA460F1).transfer(
            (currentBalance * 445) / 1000
        );
        payable(0x6b00042B2E924e3E5E8746262aF5981C5FA5D7C8).transfer(
