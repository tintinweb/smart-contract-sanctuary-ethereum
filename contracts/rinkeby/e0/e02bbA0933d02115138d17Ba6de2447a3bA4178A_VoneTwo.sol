...
contract VoneTwo is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    require(msg.value >= costs * _mintAmount, 'Insufficient funds!');
    _;
  }
  ...
  function setCost(uint256 _costs) public onlyOwner {
    costs = _costs;
  }
