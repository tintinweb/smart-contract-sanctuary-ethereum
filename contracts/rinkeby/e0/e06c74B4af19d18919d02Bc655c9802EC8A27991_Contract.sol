...
contract Contract is ERC721("StandWithUkraine", "StandWithUkraine"), ERC721Enumerable, Ownable {
    ...
    */
    ...
    uint256 private constant MAX_NFT = 500;
    uint256 private constant MAX_WL_LIMIT = 400;
    uint256 public constant MAX_PUBLIC_LIMIT = 100;
  ...
  */
    ...
    */
    ...
    payable
    {
        ...
        require(_numOfTokens <= PUBLIC_MAX_MINT, "Cannot mint above limit");
        require(totalSupply().add(_numOfTokens) <= MAX_PUBLIC_LIMIT, "Purchase would exceed max public supply of NFTs");
    ...
    */
    ...
    payable
    {
        ...
        require(totalSupply() < MAX_PUBLIC_LIMIT, 'All public tokens have been minted');
    ...
    */
    ...
    onlyOwner
    {
        ...
        for (uint256 i = 0; i < _to.length; i++) {
            require(_tokenId[i] >= MAX_PUBLIC_LIMIT, "Tokens number to mint must exceed number of public tokens");
     ...
     * URI will be blank untill totalSupply reaches MAX_PUBLIC_LIMIT
    */
    function tokenURI(
        uint256 _tokenId
    )
