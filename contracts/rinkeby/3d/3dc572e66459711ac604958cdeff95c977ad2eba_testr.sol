...
contract testr is ERC721r, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _baseURI, string memory _hiddenMetadataUri, uint _cost, uint _maxMintAmountPerTx) ERC721r("Test", "TST", 10_0) {
        baseURI = _baseURI;
