...
contract PricePrediction is SmolGame {
  ...
  uint256 private _currentObligation;
  ...
  function predict(
    ...
    _currentObligation += _finalPayout;
    require(
      _currentObligation <= wagerTokenContract.balanceOf(address(this)),
  ...
  function settlePrediction(
    ...
    _currentObligation -= _openPrediction.amountPayoutTotal;
