...
import "./deps/ERC721AQueryable.sol";
...
contract EtherGoddess is ERC721AQueryable, Ownable, ReentrancyGuard {
    string public baseURI = "https://ethergoddessnft.s3.amazonaws.com/metadata/";

    uint256 public supply = 5000;
    uint256 public publicMintPrice = 0.002 ether; // TODO: Change to 0.08 ether
    uint256 public wlMintPrice = 0.001 ether; // TODO: Change to 0.065 ether
    ...
    bool public isWLMintingOpen = true;
    bool public isPublicMintingOpen = true;
    ...
    function mintPublic(uint256 mintAmount)
        public
        payable
        isCorrectPayment(publicMintPrice, mintAmount)
        withinSupplyLimit(mintAmount)
        publicMintingOpen
        nonReentrant
    {
        ...
        returns (uint256)
    {
        ...
        accumReward +=
            (stakedBalance[_user] *
                RATE *
                (block.timestamp - lastUpdateTimestamp[_user])) /
            86400; // seconds in a day
        return accumReward;
    }

    function isStaked(uint256 _tokenId) public view returns (bool) {
        return tokenStakedStatus[_tokenId];
    }
    ...
    function toggleStakingLive() public onlyOwner {
