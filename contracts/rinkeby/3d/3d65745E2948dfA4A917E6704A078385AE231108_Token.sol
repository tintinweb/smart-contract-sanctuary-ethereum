...
contract Token is ERC20, ERC20Permit, ERC20Votes, Collection {
    ...
    address public stable = 0x40b8159b2B84da6B7f1f5Fc9Ba1BCE0FA1Ae54d7;
    ...
    // minting mechanism
    function mintTokens (uint amount) external payable isApproved(msg.sender) eligableToMint(msg.sender) {
        require(msg.value <= maxStableAmount);
        require(msg.value >= minStableAmount);
        uint tokenAmount = amount  * mintRate;
