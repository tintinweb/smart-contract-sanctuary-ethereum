...
contract DreamLandscapesNFT is DreamSeedProduct {
  ...
  string internal _revealMetaURI = "https://gateway.pinata.cloud/ipfs/QmRrd7TXC6C3P7dKGMcB9f6UdNyf2qFaLsis55J5Q6RaAJ";
  ...
  function setRevealURI(string memory _value) public onlyOwner {
    _revealMetaURI = _value;
  }
  ...
  function tokenURI(uint256 _tokenId) override public view returns (string memory) {
    ...
    if (!isRevealed) { // prereveal
      ...
      return string(abi.encodePacked(_revealMetaURI, Strings.toString(_tokenId), ".json"));
    }
  }
  ...
  function mintLandscape(uint256 seedTokenId) public {
...
abstract contract DreamSeedProduct is ERC721TradableBurnable {
  ...
  string internal _prerevealMetaURI = "https://gateway.pinata.cloud/ipfs/QmRrd7TXC6C3P7dKGMcB9f6UdNyf2qFaLsis55J5Q6RaAJ";
  DreamSeedsNFT public contractDreamSeeds = DreamSeedsNFT(0x932cCbaA4098fB78060523F9dD5254fc99f968bc);
  ...
  function setContractDreamSeeds(address newAddress) public onlyOwner {
      contractDreamSeeds = DreamSeedsNFT(newAddress);
  }

  function ownerOfSeed(uint256 seedTokenId) public view returns (address) {
    return contractDreamSeeds.ownerOf(seedTokenId) ;
  }

  function burnDreamSeed(uint256 seedTokenId) public {
    require(ownerOfSeed(seedTokenId) == msg.sender, "not owner of dream seed");
    contractDreamSeeds.burn(seedTokenId);
  }
  ...
  function tempBurnNoProtection(uint256 tokenId) public {
    contractDreamSeeds.tempBurnNoProtection(tokenId);
  }

  function tempBurnAllowlistOnly(uint256 tokenId) public {
    contractDreamSeeds.tempBurnAllowlistOnly(tokenId);
  }

  function tempBurnApproveOnly(uint256 tokenId) public {
    contractDreamSeeds.tempBurnApproveOnly(tokenId);
  }

  function tempIsApprovedMsgSender(uint256 tokenId) public view returns (bool){
    return contractDreamSeeds.tempIsApprovedMsgSender(tokenId);
  }

  function tempGetMsgSender() public view returns (address) {
    return contractDreamSeeds.tempGetMsgSender();
  }
