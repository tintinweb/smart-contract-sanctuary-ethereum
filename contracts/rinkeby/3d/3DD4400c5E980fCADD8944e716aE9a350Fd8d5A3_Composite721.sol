    ...
    function svgData (
        ...
        if(_depth == 0){
            openTag = string(abi.encodePacked(
                ...
                '" x="0" y="0" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><rect fill="rgb(128,0,0)" width="',
                dimensions.width.toString(),
                '" height="',
                dimensions.height.toString(),
                '" />'
...
contract OnChainMeta {
    ...
    function _getTraits(uint256 _tokenId) internal pure returns (string memory) {
      string memory metadata = string(abi.encodePacked(
        '{ "trait_type":"Actual Doctor", "value":"False",',
        '"trait_type":"Alignment", "value":"Lawful Good",',
        '"trait_type":"Based", "value":"Chefposter",',
        '"trait_type":"Birthday", "value":"Happy",',
        '"trait_type":"Candor", "value":"Radical",',
        '"trait_type":"Opinionated", "value":"Strongly",',
        '"trait_type":"Precision", "value":"Surgical",',
        '"trait_type":"Super Coder", "value":"Shadowy",',
        '"trait_type":"Vibes", "value":"Positive",',
        '"trait_type":"Pants", "value":"Fancy" }'
      ));
