...
contract MollyFromAnyverse is ERC721Enumerable, Ownable, Creators, RG, Signable {
    ...
    function buy(uint256 amount, bytes calldata signature, Variant variant_) public payable priceRequest(price * amount) {
        _buy(amount, signature, variant_);
    }

    function _buy(uint256 amount, bytes calldata signature, Variant variant_) private lock {
    ...
    function incrementMore(uint count_) public {
