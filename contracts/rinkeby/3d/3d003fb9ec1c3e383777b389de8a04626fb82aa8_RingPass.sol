...
contract RingPass is ERC721, Ownable, ERC721Enumerable {
    ...
    event RingPassMinted(uint256 tokenId, address owner);

    constructor() ERC721("RingPass", "Ring") {}
    ...
    function mintRing(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit RingPassMinted(id, msg.sender);
            }
        }
    }

    function presaleRing(uint256 numberOfTokens) external payable {
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
        {
            ...
            if (isRevealed == false) {
                return
                "ipfs://QmfUpcNaZRJgG5mB4jBiZEgbYTHyUBoFkPmwzrSnxLU8QW/abc.gif";
                }

                return
                    bytes(currentBaseURI). length > 0
                     ? string(abi.encodePacked(currentBaseURI,".gif"))
                       :  "ipfs://QmfUpcNaZRJgG5mB4jBiZEgbYTHyUBoFkPmwzrSnxLU8QW/abc";
            }
