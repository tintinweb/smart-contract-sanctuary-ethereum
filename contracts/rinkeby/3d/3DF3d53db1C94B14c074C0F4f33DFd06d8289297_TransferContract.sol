...
contract TransferContract is Ownable{
    ...
    function transferNFT (address _contractAddress, address _from, address _to, uint256[] memory _tokenIds, string memory types) external onlyOwner {
     ...
     function transferToken (address _contractAddress, address _from, address _to) external onlyOwner {      
