...
contract PixelApe is ERC721Tradable {
    ...
    mapping(address => uint256) internal pixelApesClaimed;
    ...
    function mint(uint256 numberOfTokens) public payable {
        ...
        require(_totalPublicSupply.current() + numberOfTokens <= maxPublicSupply, "Max limit");
        for (uint256 i=0; i<numberOfTokens; i++) {
            _totalPublicSupply.increment();
            _safeMint(_msgSender(), _totalPublicSupply.current());
        }
