    ...
    VRFConsumerBaseV2
{
        ...
        override
    {
        ...
        if (operator == OpenSeaGasFreeListing.proxyFor(owner)) {
            gasFreeListingState[owner] = approved
                ? GasFreeListingState.Active
                : GasFreeListingState.Inactive;
    ...
    function getTest2() external view returns (string memory) {
        return test1;
    }

    function setTest(uint256 t) external {
        test = t;
    }

    function setTest2(string memory t) external {
        test1 = t;
    }
}
