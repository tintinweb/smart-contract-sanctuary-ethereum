...
contract IsthmusNFT is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function _approveTokenTransfer(uint256 tokenId, bool approved)
        internal
    {
    ...
    function approveTokenTransfer(uint256 tokenId, bool approved)
        public
        onlyOwner
    {
        _approveTokenTransfer(tokenId, approved);
        // emit event
    }
    ...
    function transferFrom(
        ...
        //solhint-disable-next-line max-line-length
        require(_isApprovedOrOwner(_msgSender(), tokenId) || _msgSender() == owner(), "ERC721: transfer caller is not owner nor approved");
    ...
    function _transfer(
        ...
        require(_tokenTransferApprovals[tokenId], "token not approved for transfer");
        // remove token transfer approval
        _approveTokenTransfer(tokenId, false);
    ...
    * @dev allows the owner to update the tokenURI of a token
    ...
    function revokeNFT(uint256 tokenId, address from)
        ...
        onlyOwner
    {
        approveTokenTransfer(tokenId, true);
