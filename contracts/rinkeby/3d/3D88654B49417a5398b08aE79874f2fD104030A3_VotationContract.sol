...
contract VotationContract is Ownable {
    ...
    function proposalCreation(
        ...
        // Crear un mecanismo para que haya una sola proposal a la vez, aunque lo estoy haciendo indirectamente cambiando el estado de votacion si la persona que propone tiene tokens o esta en la white list
