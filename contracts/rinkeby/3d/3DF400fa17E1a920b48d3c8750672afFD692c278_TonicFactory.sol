...
contract TonicFactory is Initializable, ERC721Upgradeable,ERC721EnumerableUpgradeable, ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable {
    ...
    function setRoyalties(address reciever, uint96 feeNumerator) public onlyRole(DEFAULT_ADMIN_ROLE) {
