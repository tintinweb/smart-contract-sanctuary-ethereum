...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAMFF";
    string private constant _symbol = "SAMFF";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xe97C552e62D0E3129CC7E4E71853AA7B6FE384A8);
        _feeAddrWallet2 = payable(0x3a2775eED458cef0f2C6cFa169Ff6f4E1ed17885);
        _buyTax = 10;
        _sellTax = 25;
