...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    address immutable private _magic = 0x608d67763731935eAA78B90ACAd316676C083156;
...
contract suproject is ERC721A, Ownable {
    ...
    function publicMint(uint256 count) public payable callerIsUser {
        require(count > 0 && count <= maxPerTx, "Invalid mint amount!");
