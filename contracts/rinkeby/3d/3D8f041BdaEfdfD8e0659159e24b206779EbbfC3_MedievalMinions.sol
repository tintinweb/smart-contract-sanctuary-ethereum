...
contract MedievalMinions is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Medieval Minion", "MM") {
    setHiddenMetadataUri("ipfs://Qma3WGVHdyfeTgHLd1JsqEe2EMCBdNNrFLZxpcBCLRJRRF/Hidden.json");
  }
