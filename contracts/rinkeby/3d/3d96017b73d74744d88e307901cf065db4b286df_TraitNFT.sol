...
contract TraitNFT is ERC721, ITraitNFT, ReentrancyGuard {
    mapping(uint256 => string) metadata;
    using Counters for Counters.Counter;

    Counters.Counter tokenIdCounter;

    constructor() ERC721("TRAIT", "TRAIT") {}
        ...
        returns (uint256 tokenId)
    {
        ...
        metadata[tokenId] = _ipfsMetadata;
    }

    function changeMetadata(uint256 _tokenId, string calldata _newMetadata)
        external
    {
