...
contract OffbeatGuitars is ERC721Enumerable, Ownable {
    event Raffle(uint256 luckyNumber);

    string  public  baseURI;
    
    address private  constant  wallet = 0x2914D175A5a3763CC1AaC1a7B8BF67557A42b002;

    // note: true values of those variables is minus 1 from what it setted.
    uint256 public  MAX_SUPPLY = 3334;
    uint256 public  MAX_TX = 6;
    uint256 public  reserved = 34;
    
    bool public saleState = false;
    
    constructor(string memory _baseURI) ERC721("OffbeatGuitars", "OBG") {
        baseURI = _baseURI;
    }
    ...
    function generateLuckyNumber() external onlyOwner payable {
        ...
        uint256 luckyNumber = uint256(randomHash) % 3333;
        emit Raffle(luckyNumber);
    }
