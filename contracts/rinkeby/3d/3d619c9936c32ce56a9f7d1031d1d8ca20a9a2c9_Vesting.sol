...
contract Vesting is Ownable,ReentrancyGuard {
    ...
    */
    ...
    function withdrawTokens() public   nonReentrant setStart {
        ...
        if(Investors[msg.sender].isInitialAmountClaimed || Investors[msg.sender].investorType == 3 || Investors[msg.sender].investorType == 5 || Investors[msg.sender].investorType == 6) {
            if(Investors[msg.sender].investorType == 1) {
                ...
                require(block.timestamp >= launchpadLockEndDate, "Wait");
                activeLockDate = launchpadLockEndDate;
            }
             else if(Investors[msg.sender].investorType == 5) {
                require(block.timestamp >= marketdevelopmentLockEndDate, "Wait");
                activeLockDate = marketdevelopmentLockEndDate;
            }
             else if(Investors[msg.sender].investorType == 6) {
                require(block.timestamp >= airdropcampaignLockEndDate, "Wait");
                activeLockDate = airdropcampaignLockEndDate;
            }
    ...
    function setDates(uint256 StartDate,bool _isStart) public onlyOwner{
        ...
        marketdevelopmentLockEndDate = marketdevelopmentStartDate + 2 minutes;
