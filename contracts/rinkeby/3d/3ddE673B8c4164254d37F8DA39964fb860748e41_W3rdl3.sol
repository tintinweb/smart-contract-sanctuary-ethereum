    ...
    NativeMetaTransaction
{
    ...
    constructor(
        ...
        rebates[1] = 500000000000000;
        rebates[2] = 400000000000000;
        rebates[3] = 300000000000000;
        rebates[4] = 200000000000000;
        rebates[5] = 100000000000000;
    }

    function mintPriceCheck() internal {
        if (_tokenId.current() & 0x3FF == 0) {
            ongoingMintPrice += 1000000000000000; // In Wei, this is equilalent to 0.001 Ether
        }
    }
