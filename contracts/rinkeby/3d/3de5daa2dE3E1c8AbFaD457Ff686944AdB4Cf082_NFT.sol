...
contract ReceiptBridge is Ownable, ReceiptECDSA, Whitelist, IReceipt {
...
abstract contract ReceiptECDSA is EIP712 {
    ...
    function setRequestLifetime(uint256 _new) external {
