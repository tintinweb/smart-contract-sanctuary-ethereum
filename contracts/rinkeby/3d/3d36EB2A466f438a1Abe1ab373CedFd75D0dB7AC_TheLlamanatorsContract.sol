...
//
//   ________            __    __                                  __                 
//  /_  __/ /_  ___     / /   / /___ _____ ___  ____ _____  ____ _/ /_____  __________
//   / / / __ \/ _ \   / /   / / __ `/ __ `__ \/ __ `/ __ \/ __ `/ __/ __ \/ ___/ ___/
//  / / / / / /  __/  / /___/ / /_/ / / / / / / /_/ / / / / /_/ / /_/ /_/ / /  (__  ) 
// /_/ /_/ /_/\___/  /_____/_/\__,_/_/ /_/ /_/\__,_/_/ /_/\__,_/\__/\____/_/  /____/  
//                                                                                                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x64031D12CD16B82241497D4777cccb3828F2E81D];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 206 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUq8eUvV9KJUxLWdrLoWqck6cXVjiaE1ZXXhpJuk2fwdd/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 206");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 206");
...
// File: contracts/TheLlamanatorsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheLlamanatorsContract is RamppERC721A {
    constructor() RamppERC721A("The Llamanators", "LLAMA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ncs6GadWOtUmbfinh1Ej/contract-metadata";
    }
}
