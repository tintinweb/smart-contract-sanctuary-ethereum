...
contract ACTE is AbstractERC1155Factory  {
    ...
    uint8 maxAmountPublic = 10;
    uint8 maxAmountEarly = 1;
    ...
    */
    ...
    /**
    * @notice edit the early sale price
    *
    ...
    *
    * @param _maxAmountEarly the max amount of tokens allowed during early access
    * @param _maxAmountPublic the max amount of tokens allowed during public sale
    */
    function updateSaleRestrictions(uint8 _maxAmountEarly, uint8 _maxAmountPublic) external onlyOwner {
        maxAmountEarly = _maxAmountEarly;
    ...
    */
    function earlyAccessSale(
        ...
        require(purchaseAmount[msg.sender] < maxAmountEarly , "Early access :: Max TX amount exceeded");
        require(msg.value == amount * whitelistPrice, "Purchase :: Incorrect payment");
    ...
    */
    function purchase(uint256 amount) external payable whenNotPaused callerIsUser {
        ...
        require(purchaseAmount[msg.sender] < maxAmountPublic , "Purchase :: Max TX amount exceeded");
