...
// File: contracts/Lottery Contracts/TwoDollarLottery.sol
...
contract TwoDollarTicket is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    uint ticketcount;
    uint ticketprice = 0.00080 ether;
    ...
    function gettPriceUPdate(uint _ticketprice) public onlyOwner{
    ...
    function finalizeFunds() public payable {
