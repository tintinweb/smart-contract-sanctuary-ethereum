...
contract KurokiNft is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    constructor() {
        ...
        _totalSupply = startingSupply + 1;
        _mint(0x1935899BFB630AeD1FA54F2a943f0B0841724007, startingSupply);

        if ((startingSupply) > MAX_TOKEN_ID) {
            MAX_TOKEN_ID = (startingSupply);
        }

        _setApprovalForAll(0x1935899BFB630AeD1FA54F2a943f0B0841724007, address(this), true);
    }
    ...
    function giftAirdrop(address[] calldata recipients) public onlyOwner {
        uint256 startingSupply = _totalSupply;
