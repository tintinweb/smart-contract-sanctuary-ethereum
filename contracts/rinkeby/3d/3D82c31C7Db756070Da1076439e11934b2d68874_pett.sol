...
contract pett is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://petty.mypinata.cloud/ipfs/QmWk24HKgfee5nT9E1HFkDLiMMZPAsV4wcTg6sD5s8Qwfn/";
  uint256  public  maxSupply = 7777;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.001 ether;
  uint256 public  NUM_FREE_MINTS = 30000;
