...
contract TestContract is ERC721A, Ownable, ReentrancyGuard {
    ...
    /**
     * set IsRevealed to true or false
     */
    ...
    */
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        payable(0x4cFD35c63CcB0748D0DA38F841af8eA3b20e6Bb3).transfer(
            balance
        );
    }

    function withdrawAmount(uint _amount) external onlyOwner nonReentrant {
        payable(0x4cFD35c63CcB0748D0DA38F841af8eA3b20e6Bb3).transfer(_amount);
    }
