...
contract Golmes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Golmes", "GLL") {
    setHiddenMetadataUri("ipfs:QmVkGLAnpvCnAnY78eMDjUv65jqNDYPVEp1kxrZSEF4M2v/portad1.json");
  }
