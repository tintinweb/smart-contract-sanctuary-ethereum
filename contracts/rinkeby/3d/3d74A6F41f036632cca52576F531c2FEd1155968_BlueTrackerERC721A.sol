...
contract BlueTrackerERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private maxPublic =  1200;

    // Public
    uint public constant maxToTeam = 34;
    uint public maxSupply = maxPublic + maxToTeam;
    Step public sellingStep;
    uint public publicSalePrice = 0.1234 ether;
    ...
    **/
    function publicSaleMint(uint _quantity) external payable callerIsUser {
        ...
        require(totalSupply() + _quantity <= maxPublic + maxToTeam, "Max supply exceeded");
        ...
        if(totalSupply() == maxPublic + maxToTeam) {
