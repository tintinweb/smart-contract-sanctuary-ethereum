...
contract DanLand is ERC721, ERC721Enumerable, EIP712, IERC2981, Ownable, AccessControlEnumerable, Pausable, ERC721Burnable {
    ...
    function buyLandWnk(NFTVoucher calldata voucher) external {
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC721, IERC165, ERC721Enumerable, AccessControlEnumerable) returns (bool) {
