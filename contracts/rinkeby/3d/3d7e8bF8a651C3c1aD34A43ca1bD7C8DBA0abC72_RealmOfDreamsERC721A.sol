...
// @author adamdavidfortin https://twitter.com/adamdavidfortin
...
contract RealmOfDreamsERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_WHITELIST = 2565;
    uint private constant MAX_PUBLIC = 5112;
    ...
    uint public saleStartTime = 1666476000;
    ...
    uint private constant maxPerAddressDuringPublicMint = 6;
    ...
    ERC721A("Realm Of Dreams", "DREAMERS")
    ...
    */
    modifier callerIsUser() {
        require(tx.origin == msg.sender, "Contract Interaction Not Allowed");
        _;
    }
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require(currentTime() >= saleStartTime, "Presale Not Live");
        require(currentTime() < saleStartTime + 24 hours, "Presale Finished");
        uint price = wlSalePrice;
        require(price != 0, "Price 0");
        require(sellingStep == Step.WhitelistSale, "Presale Not Live");
        require(isWhitelisted(msg.sender, _proof), "Not Whitelisted");
        require(amountNFTperWalletWhitelistSale[msg.sender] + _quantity <= maxPerAddressDuringWhitelistMint, "Exceeds Max Per Wallet");
        require(totalSupply() + _quantity <= MAX_WHITELIST, "Exceed Max Supply");
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "Contract Currently Paused");
        require(currentTime() >= saleStartTime + 24 hours, "Sale Not Live");
        require(currentTime() < saleStartTime + 144 hours, "Sale Finished");
        uint price = publicSalePrice;
        require(price != 0, "Price 0");
        require(sellingStep == Step.PublicSale, "Sale Not Live");
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "Exceeds Max Per Wallet");
        require(totalSupply() + _quantity <= MAX_SUPPLY_MINUS_GIFT, "Exceed Max Supply");
        require(msg.value >= price * _quantity, "Insufficient Funds");
    ...
    **/
    function gift(address _to, uint _quantity) external onlyOwner {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "Exceed Max Supply");
