...
contract Lilos_V1 {
    ...
    function repay(uint256 listingId_) public {
        ...
        require(IERC721(listingItem.collection).isApprovedForAll(listingItem.lessee, address(this)), "Token transfer needed to be approved first.");

        IERC721(listingItem.collection).transferFrom(listingItem.lessee, listingItem.lessor, listingItem.tokenId);
