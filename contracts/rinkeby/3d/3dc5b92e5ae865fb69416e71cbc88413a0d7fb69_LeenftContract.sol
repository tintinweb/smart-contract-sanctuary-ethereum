...
// File: contracts/LeenftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LeenftContract is RamppERC721A {
    constructor() RamppERC721A("LEE NFT", "LEE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IEzDnliC3wwmD2rQMEuz/contract-metadata";
    }
}
