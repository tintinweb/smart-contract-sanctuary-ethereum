...
contract ERC1155Mintable is ERC1155BaseUpgradeable, UUPSUpgradeable {
    // Metadata:
    ...
    function setmintingChargePerToken(uint256 mintingCharge_, bool _chargeInETH)
        public
        onlyOwner
    {
    ...
    function mintingChargePerToken() public view returns (uint256) {
        if (chargeInETH) {
    ...
    function mint(
        ...
        _mint(msg.sender, amount, _royalty, tokenURI);
    }
    ...
    function lazyMint(
        ...
        require(
            msg.value >= (price + mintingChargePerToken()) * amount,
        ...
        payable(to).transfer((price - _brokerage) * amount);
    }
}
    ...
    ERC2981Upgradeable
{
    ...
    function _lazyMint(
        ...
        // Verfify signature
        {
            ...
            require(to == signer_, "ERC1155Base: Signature not verfied.");
        }
        ...
        _safeTransferFrom(to, msg.sender, tokenId, amount, bytes(""));
    }
