...
contract Test{
    ...
    function uniswapTestingTokenforTokens(uint256 price,uint256 deadline, address tokenAddress, address tokenAddress2) external returns(uint256[] memory){
    ...
    function amounts(uint256 price, address[] calldata path) external returns(uint256[] memory){
        uint[] memory amount = UniswapV2Library.getAmountsOut(factory, price, path);
        return amount;
    } 
