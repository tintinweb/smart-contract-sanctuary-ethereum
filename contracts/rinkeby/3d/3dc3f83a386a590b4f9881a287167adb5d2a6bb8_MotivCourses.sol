    ...
    ERC721URIStorageUpgradeable
{
    ...
    mapping(uint256 => mapping(uint256 => bool)) public isPurchased;
    mapping(uint256 => mapping(uint256 => bool)) public isExecuted;
    ...
    function purchaseCourse(
        ...
        _verifySignature(_userId, _courseId, _nonce, _signature);
        ...
        emit CoursePurchased(msg.sender, _courseId, _userId, _amount, _nonce);
    }
    ...
    function claimReward(
        ...
        _verifySignature(_userId, _courseId, _nonce, _signature);
        isExecuted[_userId][_nonce] = true;
    ...
    function _verifySignature(
        ...
        require(!isExecuted[_userId][_nonce], "Nonce used");
