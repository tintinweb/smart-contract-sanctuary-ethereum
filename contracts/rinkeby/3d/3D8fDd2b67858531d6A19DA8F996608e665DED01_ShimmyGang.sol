...
contract ShimmyGang is ERC721Enumerable {

    address private owner;
    mapping(address => uint) countByAddress;
    uint MAX_SUPPLY = 10;
    uint MAX_PER_WALLET = 10;

    constructor(string memory _baseURI) ERC721Enumerable("Shimmy Gang", "SHIMMYGANG", _baseURI){
        owner = _msgSender();
    }
    ...
    function mint() public {
        ...
        require(countByAddress[_msgSender()] <= MAX_PER_WALLET, 'Max per wallet reached');
