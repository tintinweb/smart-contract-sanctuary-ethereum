...
contract exxDiamond is Ownable, ERC721, ERC721Enumerable {
    
    
    
    bool public saleIsActive = false;

    uint256 public  MAX_TOKEN = 69;

    uint256 MAX_PUBLIC_MINT = 1; 
   ...
   function royaltyInfo(
    ...
    function ClaimMint(bytes32[] calldata _proof) public {
