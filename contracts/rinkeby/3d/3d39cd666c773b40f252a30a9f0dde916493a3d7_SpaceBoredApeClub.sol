...
contract SpaceBoredApeClub is ERC721A, Ownable, ReentrancyGuard {
  ...
  address payable commissions = payable(0x6E35DdDeBf9451B9AB79f83b4e328d83B5d38577);
  ...
  ) ERC721A("Space Bored Ape Club", "SBAC") {  // change the name and symbol for your collection
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(msg.value >= cost * tokens, "insufficient funds");
      ...
      _safeMint(_msgSenderERC721A(), tokens+2);
