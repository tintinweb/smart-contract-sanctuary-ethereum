...
contract whvr is ERC721r, Ownable {
    uint256 public constant very_logical_limit = 9;
    uint256 public constant pretty_reasonable_price = 0.00001 ether;
    bool public get_up = false;
    constructor() ERC721r("whateeeeeever", "......", 10000) {}
    function i_will_get_up(bool _get_up) public onlyOwner {
        get_up = _get_up;
    }
    function _baseURI() internal view virtual override returns (string memory) {
        return "ipfs://bafybeic467wwsgxhqzj6l4cbwuoierw7c3bsbuxtq5dsjjo5iyqgzs3equ/";
    }
    ...
    function mint(uint256 quantity) public payable {
        require(tx.origin == msg.sender, "contract nono...");
        require(get_up, "i not get up...");
        require(msg.value >= pretty_reasonable_price * quantity, "u not even paying me for 0.00001 eth?!");
        require(totalSupply() + quantity <= _maxSupply, "max i can supply");
        require(balanceOf(msg.sender) + quantity <= very_logical_limit, "too greedy...");
...
// whatever happens just be happy and stay alive...byebye...