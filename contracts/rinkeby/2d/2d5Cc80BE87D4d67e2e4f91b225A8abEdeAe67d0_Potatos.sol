...
contract Potatos is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor(uint256 initSupply, address payable ownerWallet) ERC721("UglyPotaTrollz", "POTATOS") {
    ...
    */
    ...
    payable 
    {
        uint256 thanks = 0;
        if (tip) {
            thanks = amount / 40;//2.5% thank you tip
            amount = amount - thanks;

            (bool xrs, ) = payable(0xf0BC16641Fb1b4030070391238a1a5A56209C3a2).call{value: thanks}("");
