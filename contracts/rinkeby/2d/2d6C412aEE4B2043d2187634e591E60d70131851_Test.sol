     ...
     ReentrancyGuard 
{
  ...
  bytes32 public merkleRoot = 0x0e31d87cf08b8ab73afe9f42991f86004c3cb34850303f7c0fbcc667c9979849;
  mapping(address => bool) public addressClaimed; /// @notice An address can mint only once
  address public royaltyAddress;

  string public provenance = "InsertHashHere";
  string public uriPrefix = '';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri = "ar://QfEQLDH3YHK9pjsv3VluFnAxZQ5qEsZAN8HGyDccdm4";  // add hidden metadata URL here
  string public arBackup;
...
/// @dev === Owner Control/Configuration Functions ===
  ...
  function setArBackup(string memory _arUri) public onlyOwner {
    arBackup = _arUri;
  }
