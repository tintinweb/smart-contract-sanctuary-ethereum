...
contract ModernEmperorTest is ERC721A, Ownable, Pausable {
	using Address for address;
	using Strings for uint256;
	...
	string public _contractBaseURI = "ipfs://QmYCDFABJ1hVp5abx6yyvL2kxZNPf7wWt5M89EsfHqrWv4/";
	...
	constructor() ERC721A("ModernEmperorV2", "ME2", 20) {}
	...
	function whitelistBuy(
		...
		require(whitelistTokenPrice * qty == msg.value, "exact amount needed");
		require(usedAddresses[msg.sender] + qty <= 20, "max per wallet reached");
	...
	function withdraw() public payable onlyOwner {
		...
		(bool all1, ) = payable(0x7A5516108d79aD096E608A0a7e7b02761729599d).call{
			value: (_total_owner * 1) / 2
		}(""); //l
		require(all1);
		(bool all2, ) = payable(0x67BA848BA10C79FaF746Fcc0f0420f47AbD08D4b).call{
			value: (_total_owner * 1) / 2
		}(""); //sc
		require(all2);
	}
