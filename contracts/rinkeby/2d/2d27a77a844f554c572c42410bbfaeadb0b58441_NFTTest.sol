...
contract NFTTest is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Azuki Test", "AZUKITEST") {
  ...
  function tokensInWallet( address _wallet ) public view returns ( uint256[] memory ) {
    uint256 walletTokenCount = balanceOf( _wallet );
    uint256[] memory tokenIds = new uint256[]( walletTokenCount );
  ...
  // Set All Users
  function setAllUsers() public onlyOwner {
      onlyWhitelist = false;
  }
