...
contract TEST is ERC721AQueryable, Ownable, ReentrancyGuard {

  using Strings for uint256;


  string public uriPrefix = "ipfs://QmdhdpSNMYYkciwcBPEWDi5itShBw49y1CVB7e4irY9H6Z/";
  ...
  address constant COLLECTION_ONE = 0x727A6984004C3C1d3b5b28be485f4c9988d822ee;
  address constant COLLECTION_TWO = 0x727A6984004C3C1d3b5b28be485f4c9988d822ee; 
  ...
  modifier hasBluechip(address account){
    require(IERC721(COLLECTION_ONE).balanceOf(account) > 0 || IERC721(COLLECTION_TWO).balanceOf(account) > 0, "You dont any of thes NFT's!");
    _;
  }
  
  function mintAsHolder(uint256 _mintAmount) public payable  mintCompliance(_mintAmount) hasBluechip(msg.sender) {
    require(whitelistMintEnabled, 'The whitelist sale is not enabled!');
    require(msg.value >= specialPrice * _mintAmount, 'Insufficient funds!');
