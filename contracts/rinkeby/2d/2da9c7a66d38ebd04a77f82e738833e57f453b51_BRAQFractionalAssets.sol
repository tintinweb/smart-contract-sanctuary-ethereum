...
// File: contracts/BRAQFractional.sol
...
contract BRAQFractionalAssets is ERC1155, Ownable {
    ...
    function newAsset(uint256 _id) public onlyOwner {
        require(!investingAssets, "There are no more assets to be invested in."); 
        require(investedAsset[_id] == false, "You've already invested in this and fractionalized it."); 
    ...
    function uri(uint256 _id) public view override returns (string memory){
        require(investedAsset[_id], "URI requested for invalid art.");
