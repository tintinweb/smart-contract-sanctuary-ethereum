...
contract SNFT is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 7000;
	uint256 public RESERVED_NFT = 777;
    ...
    constructor() ERC721P("sundere.nft", "SNFT") {}
	...
	function mintSaleNFT(address _to, uint256 _count) public onlyOwner nonReentrant{
		uint256 totalSupply = totalSupply();
        require(
