...
// File: contracts/elephant_coin.sol
...
contract ElephantToken is ERC20, Ownable {
    uint256 public immutable finalTotalSupply = 1000000 * 10 ** decimals();
    uint256 public immutable fee = 5;

    constructor() ERC20("ElephantCoin", "ELC") {}
    ...
    function _transfer(
        ...
        super._transfer(from, owner(), amountFee);
    }
