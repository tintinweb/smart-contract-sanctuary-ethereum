...
contract Twitchers is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256[3] public price = [100000000000000000, 1200000000000000000, 5000000000000000000];

    bool public URILocked;
    string private __baseURI;

    event Mint(uint8 rarity, uint8 amount, uint256 totalSupply);
    event Reveal();

    constructor(string memory baseURI_) ERC721("Name", "SMBL") {
        __baseURI = baseURI_;
    }
