...
contract UnitedKey is ERC1155Supply, Ownable, Pausable {
    ...
    uint256 public constant TOKEN_PRICE_GENESIS = 0.003 ether;
    ...
    function adminMint(address account, uint256 id, uint256 amount) public onlyOwner
    {
        ...
        require(id != TOKEN_ID_GENESIS, "CANNOT_MINT_EXISTING_TOKEN_ID");
