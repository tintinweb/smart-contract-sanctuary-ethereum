...
contract MetaGods is ERC721Enum, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public maxPresaleMintWithPass = 5;
    ...
    function mintPresale(uint256 _mintAmount, bytes32[] calldata proof) external payable {
        ...
        if(passesOwned > 0) {
            ...
            require(MintPass.isPaused(), "Not mintable");

            require(maxPresaleMintWithPass > presaleWhitelistMints[msg.sender], "Too many mints");

            availableMints = maxPresaleMintWithPass - presaleWhitelistMints[msg.sender];
        } else {
            ...
            availableMints = maxPresaleMint - presaleWhitelistMints[msg.sender];
        }
    ...
    function setMaxPresaleMintWithPass(uint256 _newMaxPresaleMintWithPass) external onlyOwner {
        maxPresaleMintWithPass = _newMaxPresaleMintWithPass;
    }
