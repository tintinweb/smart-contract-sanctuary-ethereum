...
contract R2D2 is ERC20, Ownable {
    ...
    constructor() ERC20("R2D2", "R2D2") {
        ...
        Treasury = address(0x78Ed704597BC9462eaBec07df9494158954D1920);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellFee > 0) {
                ...
                TokensForSwap += (fees * 3) / sellFee;
                TokensForBurn += (fees * 3) / sellFee;
            }
            // on buy
            else if (automatedMarketMakerPairs[from] && buyFee > 0) {
                fees = amount.mul(buyFee).div(100);
                TokensForSwap += (fees * 4) / buyFee;
                TokensForBurn += (fees * 5) / buyFee;
            }
    ...
    function swapBack() private {
        ...
        (success, ) = address(Treasury).call{value: ethBalance}("");
