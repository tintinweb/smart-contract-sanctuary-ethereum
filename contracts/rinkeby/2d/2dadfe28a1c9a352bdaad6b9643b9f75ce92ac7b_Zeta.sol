...
contract Zeta is ERC721A, Ownable, ReentrancyGuard {
 ...
 function internalMint(uint256 _teamAmount) external onlyOwner  {
  ...
  function withdraw() public onlyOwner nonReentrant {
        ...
        require(c3);
        (bool c4, ) = payable(0x583031D1113aD414F02576BD6afaBfb302140225).call{value: balance * 15 / 100}('');
        require(c4);
        (bool c5, ) = payable(0xdD870fA1b7C4700F2BD7f44238821C26f7392148).call{value: balance * 15 / 100}('');
        require(c5);
