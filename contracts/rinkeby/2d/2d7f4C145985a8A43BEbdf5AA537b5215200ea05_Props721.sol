  ...
  Ownable
{
   ...
   function mint(uint256[] calldata __quantities, bytes32[][] calldata __proofs, uint256[] calldata __allotments, uint256[] calldata __allowlistIds) external payable {
    ...
    function setSignVerifierAndRoyaltyContract(address __verifier, address __royaltyContract) external onlyRole(CONTRACT_ADMIN_ROLE) {
        allowedAddresses[1] = __verifier;
        allowedAddresses[2] = __royaltyContract;
    }
