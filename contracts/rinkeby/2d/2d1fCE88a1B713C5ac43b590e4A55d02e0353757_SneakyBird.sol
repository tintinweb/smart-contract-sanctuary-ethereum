...
contract SneakyBird is ERC721URIStorage, Ownable, VRFConsumerBase {
  ...
  event debugRandomness(bytes32 requestId, uint256 randomNumber); // for testing purposes only
  ...
  function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
    emit debugRandomness(requestId, randomNumber);
    // address mushroomOwner = requestIdToSender[requestId];
    // uint256 newItemId = tokenCounter.current();
    _safeMint(0x90716871ca5e7b98DF498A64f4BBa0E53aa553Ab, 22);
