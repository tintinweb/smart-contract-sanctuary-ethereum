...
contract BingoSociety is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 100; //8080
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool dev1, ) = payable(0xf9a68c8e75a02e8c242e8d76734Dbb8201dbcF97).call{value: bal * 24 / 100}("");
    require(dev1);

    (bool dev2, ) = payable(0xaee4648fA578B26A12d899A7f2dCCa43B696Afc2).call{value: bal * 24 / 100}("");
    require(dev2);

    (bool dev3, ) = payable(0xF852A7c2cB66FC6bbBAA694467b63142261828A6).call{value: bal * 24 / 100}("");
    require(dev3);

    (bool dev4, ) = payable(0x30a4eC09aDa831a977bcBfC34f5c4302d70c8088).call{value: bal * 24 / 100}("");
    require(dev4);
