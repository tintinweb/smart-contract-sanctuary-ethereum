...
contract DeadTownZeds is ERC721Enumerable, Ownable {
    ...
    address pagzi = 0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f;
    address macroverse = 0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f;
    address steven = 0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f;

    //date settings
    uint256 public publicDate = 1642165200;
    uint256 public endDate = 1842165200;
    ...
    //require(msg.value >= cost * _mintAmount,"LOW");
    ...
    mintPasses[0x5B38Da6a701c568545dCfcB03FcB875f56beddC4] = 1;
    mintPasses[0x310c85dF41248EFF0406Dd53eb9bAB43CDB969c5] = 10;

    mintPasses[0xF1ff23e094C3f83C39d1F5deb92A3e72Ca501cFc] = 10;
    ...
    function tokensOfOwner(address _owner) public view returns (uint256[] memory) {
        ...
        for (uint256 i; i < tokenCount; i++) {
            tokensId[i] = tokenOfOwnerByIndex(_owner, i) + 1;
        }
        return tokensId;
    }
