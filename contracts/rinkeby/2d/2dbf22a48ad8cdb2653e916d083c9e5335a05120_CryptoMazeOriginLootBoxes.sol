...
contract CryptoMazeOriginLootBoxes is ERC721Enum, Ownable, ReentrancyGuard {
    
	using Strings for uint256;
	uint256 public NFT_MINTED;
    string private baseURI;

	address public cryptoMights;
	...
	function mint(address recipient, uint256 count) external nonReentrant{
	    require(_msgSender() == cryptoMights, "Incorrect Request");
	...
	function setCryptoMightsAddress(address newAddress) external onlyOwner {
        require(newAddress != address(0), "Invalid new address");
        cryptoMights = newAddress;
    }
}