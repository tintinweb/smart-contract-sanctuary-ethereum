...
contract WagmiWorld is ERC721A, ReentrancyGuard, Ownable {
	...
	function getRootWLP() external view returns(bytes32) {
	
		return _merkleRootWagmiListPlus;
	}
	
	function getRootWL() external view returns(bytes32) {
		return _merkleRootWagmiList;
	}
