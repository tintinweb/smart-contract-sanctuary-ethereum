...
contract WWTEST is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("wwtest", "ww") {
    setHiddenMetadataUri("ipfs://QmVgWKs3fNYhsdRBq2ssqafeA41qfSA222UcXWp56yDYsV/hidden.json");
  }
