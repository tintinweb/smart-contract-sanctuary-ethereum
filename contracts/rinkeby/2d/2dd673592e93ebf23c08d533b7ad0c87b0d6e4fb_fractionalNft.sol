...
contract fractionalNft is  ERC1155Upgradeable, VRFConsumerBase {
    ...
    function addValidUser(address _user) external  {
    ...
    function fulfillRandomness(
        ...
        if (winnerTokenId == 1 || winnerTokenId == 0)
        winnerTokenId +=2;
    ...
    function royaltyInfo (uint paymentAmount) external view returns (address,uint) {
        ...
        return (msg.sender,royalty);
    }

    function setRoyaltyPercentage (uint _amount) external  {
