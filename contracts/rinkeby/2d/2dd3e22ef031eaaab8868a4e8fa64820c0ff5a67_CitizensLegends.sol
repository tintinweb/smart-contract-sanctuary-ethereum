...
contract CitizensLegends is ERC1155, Ownable, Pausable, ERC1155Supply {
   
    uint256 public constant MAX_SUPPLY = 30;

    IERC20 private tokenAddress;
    uint256 private rate = 50 ether;

    string public name;
    string public symbol;

    constructor(address _tokenAddress) ERC1155("") {
        name = "CitizensLegends";
        symbol = "CLEG";
    ...
    function mint(uint256 id, uint256 amount)
        public
    {
        require(id > 0 && id < 2, "Token doesn't exist");
        require(amount > 0 && amount <= 10, "Cannot mint more than 5 per Tx");
        require(totalSupply(id) + amount <= MAX_SUPPLY, "Sold out");
