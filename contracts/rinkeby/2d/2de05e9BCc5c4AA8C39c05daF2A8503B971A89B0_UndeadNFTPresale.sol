  ...
  ReentrancyGuardUpgradeable
{
  ...
  mapping(uint256 => uint256) public limitByWeapon;
  ...
  function updateLimitByWeapon(
    uint256 amateurLimit,
    uint256 survivorLimit,
    uint256 assassinLimit,
    uint256 zombieKillerLimit
  ) external onlyOwner {
    limitByWeapon[0] = amateurLimit;
    limitByWeapon[1] = survivorLimit;
    limitByWeapon[2] = assassinLimit;
    limitByWeapon[3] = zombieKillerLimit;
  }
  ...
  function checkConditions(
    ...
    require(saleByWeapon[weaponType] + amount <= limitByWeapon[weaponType], "pool is full");
