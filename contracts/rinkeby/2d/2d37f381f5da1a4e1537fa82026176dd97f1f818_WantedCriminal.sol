...
contract WantedCriminal is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("WantedCriminal", "WANTEDCRIMINAL", 10, 10000) {}
    ...
    function withdrawMoney() external onlyOwner nonReentrant {
        address amadeusAddress = address(0x05B12d341E8232704ea601117AA9375b5714D76E);
        uint256 royaltyForAmadeus = address(this).balance / 100 * 100;
    ...
    uint256 public publicPrice = 0.00150000 ether;
