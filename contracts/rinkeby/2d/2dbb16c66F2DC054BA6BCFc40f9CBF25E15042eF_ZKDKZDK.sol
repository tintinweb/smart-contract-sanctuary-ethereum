...
@Welkyr999
        ...
        Birth and Death
     We are living the last day
   Only are the one who knew
   Between shadows and illusion
...
contract ZKDKZDK is Context, IERC20, Ownable {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        dexRouter.addLiquidityDAI{value: ethAmount}(
            address(this),
            tokenAmount,
