...
contract WeirdosCloning is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public mintPriceApe = 1;

    string public baseURI = "ipfs://QmS5eDVK2onoUXP6eoTmGVwd5ioUhxFRSsoB1gGF92euEW";
    ...
    function setFreeClaimlistMerkleRoot(bool _claimActive, bytes32 _claimMerkleRoot)
        external
        onlyOwner
    {
    ...
    function setCreamlistMerkleRoot(bool _creamlistSaleActive, bytes32 _creamlistMerkleRoot)
        external
        onlyOwner
    {
    ...
    function setCommunityMerkleRoot(bool _communitySaleActive, bytes32 _communityMerkleRoot)
        external
        onlyOwner
    {
    ...
    function setPublicSalelistMerkleRoot(bool _publicSaleActive, bytes32 _publicMerkleRoot)
        external
        onlyOwner
    {
