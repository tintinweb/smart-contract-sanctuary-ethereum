...
{
    // Using SafeERC20Upgradeable library for IToken20
        ...
        isPublishedToCommunity(_communityID, _project)
    {
        ...
        // Local instance of variable. For saving gas.
        IToken20 _currency = _communities[_communityID].currency;
    ...
    function restrictToAdmin() external override onlyHomeFiAdmin {
        // Revert if already restrictedToAdmin
        require(!restrictedToAdmin, "Community::paused");

        // Pause community creation for non admins
        restrictedToAdmin = true;
    ...
    function unrestrictToAdmin() external override onlyHomeFiAdmin {
        // Revert if already unpaused
        require(restrictedToAdmin, "Community::not paused");

        // UnPause community creation for all
...
interface ICommunity {
    ...
    struct CommunityStruct {
        ...
        IToken20 currency; // token currency of the community
