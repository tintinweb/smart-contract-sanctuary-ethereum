...
contract MusicMetaverse is ERC1155, ReentrancyGuard, Ownable {
    ...
    address public wallet = 0xB4E3eD0b43ea1d8be31b74b4f8e59924f5ad7D5a;
    IERC20 public ryltToken;
    
    string private _uri = "https://gateway.pinata.cloud/ipfs/QmRwK972xNSm2u5L6cupscesfxgwLYbLLGtSBShr7HQ64m/";
    ...
    constructor() ERC1155(""){
        ...
        symbol = "BMMV";
        ryltToken = IERC20(0xB0915Aa56d49785926c62b862115cb979A0f6443);

        // Creation of Band Concert Hall VIP Metatickets
        _prices[0] = .0077 ether;
        _ryltPrice[0] = 50 * 10 ** 18;
        _supplies[0]= 3000;
        _saleActive[0] = false;

        // Creation of Band Concert Hall Regular Metatickets
        _prices[1] = .033 ether;
        _ryltPrice[0] = 10 * 10 ** 18;
        _supplies[1] = 7000;
        _saleActive[1] = false;
    }
    ...
    function expandMetaverse (uint256 tokenId, uint256 supply, uint256 price, bool active, string memory bURI) public onlyOwner{
        _uri = bURI;
    ...
    function withdrawRYLT() external onlyOwner {
        ryltToken.transfer(wallet, ryltToken.balanceOf(address(this)));
    }
    ...
    */
    ...
    function contractURI() public pure returns (string memory){
        return "ipfs://QmUEVkXTQpNo6ZDrhUDzRkN9pyFb3AU373MZWLvyMFJL2R";
    }
