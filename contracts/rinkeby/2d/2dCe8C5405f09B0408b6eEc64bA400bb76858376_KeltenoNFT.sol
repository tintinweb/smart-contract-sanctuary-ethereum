...
contract KeltenoNFT is ERC721Enumerable, PullPayment, Ownable, ReentrancyGuard {
    ...
    bool public airDropMintEnabled = false;
    ...
    constructor() ERC721("KeltenoTST", "KLTN") {
    ...
    function toggleAirDropMintEnabled() external onlyOwner {
        airDropMintEnabled = !airDropMintEnabled;
    }
    ...
    function claim() external nonReentrant {
        require(airDropMintEnabled, 'The airdrop claim is not enabled!');
