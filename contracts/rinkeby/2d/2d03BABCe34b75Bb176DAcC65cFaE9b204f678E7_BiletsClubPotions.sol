...
/**
 * @title BiletsClubPotions Contract
 */

contract BiletsClubPotions is ERC1155, Ownable, ReentrancyGuard {
    string public name = "Bilets Club Potions";
    string public symbol = "BLT-Potions";
    bool public pause = false;

    uint256 public constant SmallHP = 0;
    uint256 public constant HP = 1;
    uint256 public constant StrongHP = 2;
    uint256 public constant GreatHP = 3;
    uint256 public constant UltimateHP = 4;
    uint256 public constant SupremeHP = 5;

    uint256 public constant SmallMP = 6;
    uint256 public constant MP = 7;
    uint256 public constant StrongMP = 8;
    uint256 public constant GreatMP = 9;
    uint256 public constant UltimateMP = 10;
    uint256 public constant SupremeMP = 11;

    string public contractURI =
        "https://bilets.club/api/opensea_contracts_meta/contractHeals/{id}";
