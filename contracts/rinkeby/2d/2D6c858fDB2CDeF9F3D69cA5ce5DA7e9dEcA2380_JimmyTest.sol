    ...
    PaymentSplitter
{
    ...
    function setPublicActive(bool _isPublicActive) public onlyOwner {
        isPublicActive = _isPublicActive;
    }

    function setWhiteListActive(bool _isWhiteListActive) public onlyOwner {
    ...
    function publicMint(uint256 amount, uint256 maxAmount)
        public
        payable
        nonReentrant
    {
        ...
        require(isPublicActive, "Public sale is closed");
        require(
