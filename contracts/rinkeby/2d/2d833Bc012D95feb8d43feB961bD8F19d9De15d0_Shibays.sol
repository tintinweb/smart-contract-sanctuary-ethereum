...
contract Shibays is ERC721A, Ownable {
    ...
    uint32 public reservedtMintCounter;
    ...
    function isWLOGOpen() public view returns (bool) {
        return block.timestamp >= WLOGStartDate && OGWLOpenstate;
    }
        ...
        onlyEOA
    {
        ...
        require(
            reservedtMintCounter + amount <= reservedSupply,
            "Max supply reached"
        );
        reservedtMintCounter += amount;
        _safeMint(msg.sender, amount);
    }
