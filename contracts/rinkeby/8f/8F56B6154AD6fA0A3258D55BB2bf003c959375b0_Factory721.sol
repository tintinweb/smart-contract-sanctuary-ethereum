...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new YouForgeNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        YouForgeNFTUser721Token token = YouForgeNFTUser721Token(address(addr));
...
contract YouForgeNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
