...
contract LuckyGift is ERC1155, ERC1155Supply, ERC1155Burnable, Ownable {
    // Supply
    ...
    // Authorized
    address public authorizedFutureContract; 
    ...
    {
        //Project
        name = string(abi.encodePacked("Lucky Gift ", unicode"🎁"));
        // symbol = unicode"🎁";
        tokenUri = "ipfs://";
    ...
    // MINT
    function publicMint(uint256 quantity_) external payable { //isUser isWhitelisted { 
    ...
    function migrateToken() external isUser {
        ...
        iOrigamasks futureContract = iOrigamasks(authorizedFutureContract);
