...
// File: contracts/t10.sol

pragma solidity >=0.7.0 <0.9.0;

contract T10 is ERC721A {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string private uriPrefix = "ipfs://Qmah47Sqk3yoTeLYWrKigA6ASevt5AEzdLJmsV7yf3Kyxt/";
  ...
  function mintForWL(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
