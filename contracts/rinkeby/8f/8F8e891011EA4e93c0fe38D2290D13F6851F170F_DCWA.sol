...
contract DCWA is ERC721A, Ownable {
    ...
    constructor() ERC721A("Deeper Crypts of a Wandering Artist", "DCWA") {
        currentIndex++;
        changeMaxStateOfToken(1,14);
        //manageWhitelistOfAddress(0x452E69eebC19296270b8ED2f691891AA9E513397, true);
        //manageWhitelistOfAddress(0xbfc33Bf722371d33Bc6a3a2ed298595F637Fd673, true);
    }
