...
contract Ngopa is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmSW8DfTjaWv8LG5UTctFfDCMkADzVkkXykdMXkYiuJ34P";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmSW8DfTjaWv8LG5UTctFfDCMkADzVkkXykdMXkYiuJ34P";
    ...
    */
    ...
    function teamMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= FREE_MINT_MAX || freeSale == false, "Team mints after free");
