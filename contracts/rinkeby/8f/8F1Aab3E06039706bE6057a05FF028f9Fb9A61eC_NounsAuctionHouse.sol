...
contract NounsAuctionHouse is INounsAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function createBid(uint256 nounId) external payable override nonReentrant {
        ...
        require(_auction.nounId == nounId, 'Lil Moonbirds not up for auction');
    ...
    function _settleAuction() internal {
        ...
        if (_auction.amount > 0) {
            ...
            uint256 ownerBalance = (_auction.amount * 99) / 100;
            uint256 nounsDAOBalance = (_auction.amount * 1) / 100;

            _safeTransferETHWithFallback(nounsDAO, nounsDAOBalance);
            _safeTransferETHWithFallback(owner(), ownerBalance);
        }
