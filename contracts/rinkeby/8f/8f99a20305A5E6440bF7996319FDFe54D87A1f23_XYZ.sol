...
contract XYZ is ERC721, Ownable {
    using Strings for uint256;

    uint256 public fee = 1000000000000; // in wei // 0.000001
    uint256 public maxMintLength = 20;
    ...
    ) public payable
    {
        ...
        for (uint256 i = 0; i < kt.length; i++) {
            console.log(getTeFromTokenId(kt[i]));
