...
contract SaleExtension is AdminControl, Allowlist, CreatorExtensionBasic {
    //
    // Libraries
    //
    ...
    constructor() Allowlist(bytes32(0)) {
        maxSupply = 100;
        creator = address(0xF105b6f4aa1F7C0E068424a9bbAC9a4626F69720);
        launchDate = 1;
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AdminControl, Allowlist, CreatorExtensionBasic)
        returns (bool)
    {
        return
...
abstract contract Allowlist is AdminControl {
    ...
    /**
     * @param merkleRoot_ the merkle root to be used
     */
