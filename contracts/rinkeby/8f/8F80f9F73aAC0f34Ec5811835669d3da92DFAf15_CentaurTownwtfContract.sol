...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA53B3f19680E08C2365Ceffc2941d8c5Bd5CE272];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmcCcsAGBhUicPJdSXEJACfNk1ZtRfBXW7iCGPzV5jmSaG/";
...
// File: contracts/CentaurTownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CentaurTownwtfContract is RamppERC721A {
    constructor() RamppERC721A("CentaurTownwtf", "CTWTF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/lYsnKLIvkoCmr9Ww3oBG/contract-metadata";
    }
}
