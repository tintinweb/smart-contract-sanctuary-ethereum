...
contract CaveRiddles2 is ERC721, ERC721Enumerable, ERC2981, Ownable {
	...
	// function bulkMintERC712(IERC721 _token, address [] calldata _to, uint256 [] calldata _id) public {
	// 	require(_to. length == _id.length, "Receivers and IDs are different length"); 
	// 	for (uint256 i = 0; i<_to.length; i++) {
	// 		_safeMint(msg.sender, _to[i], _id[i]);
	// 	}
	// }
