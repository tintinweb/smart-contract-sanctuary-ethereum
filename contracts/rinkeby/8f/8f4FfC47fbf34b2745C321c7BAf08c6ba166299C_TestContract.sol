    ...
    PaymentSplitter
{
    ...
    uint256[] private _teamShares = [75, 25]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0x2735f28DE0B7fB37d97317E00E2D05c9bE7FEC5E, // Admin Account gets 25% of the total revenue
        0xe7422F48de521FEAd3a54bAf632855b009DF1F57 // Test Account gets 35% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("TestContract", "TestJor")
