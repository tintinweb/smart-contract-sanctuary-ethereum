...
contract DemoContract is ClaimableERC721Tradable, ReentrancyGuard {
  using Counters for Counters.Counter;

  uint256 private launchTimestamp;
  uint256 private publicSaleTimestamp;

  uint256 private maxMintsWalletAddress = 100;
  
  uint256 private totalPandasCount = 100;
  ...
  constructor(
    ...
    tierPrices[0] = 5000000000000000; // 0.005 ETH
    tierPrices[1] = 3000000000000000; // 0.003 ETH
    tierPrices[2] = 2000000000000000; // 0.002 ETH
    tierPrices[3] = 1000000000000000; // 0.001 ETH

    tierAmounts[0] = 10;  
    tierAmounts[1] = 20; 
    tierAmounts[2] = 20; 
    tierAmounts[3] = 50; 
    tierAmounts[4] = 0; // Giveaways
  ...
  function baseTokenURI() override public pure returns (string memory) {
    return "ipfs://QmTMxUPDZ6XqFfphmMt58Te4ycqGw5jHcmdqfgSU3W5Qgd/";
  }
