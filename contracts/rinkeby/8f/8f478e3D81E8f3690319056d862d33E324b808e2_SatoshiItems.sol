...
contract SatoshiItems is ERC1155, Operatorable {
    uint256 public constant SATOSHI_CRYSTAL = 0;
    uint256 public constant MATZ = 1;

    constructor() ERC1155("") Operatorable() {
        mintSingle(_msgSender(), SATOSHI_CRYSTAL, 10000, "");
        mintSingle(_msgSender(), MATZ, 10000, "");
    }
    ...
    function mintSingleBatch(
        ...
        for(uint256 i = 0; i < tos.length; i++) {
            super._mint(tos[i], id, amounts[i], data);
        }
    }
