    ...
    Ownable
{
    ...
    constructor() {
        //set ERC165 pattern
        supportedInterfaces[
            this.getRarityById.selector ^
                this.getRarityByName.selector ^
                this.getRarities.selector ^
                this.setRarity.selector ^
                this.changeRarityName.selector ^
                this.getTrait.selector ^
                this.getTraitByName.selector ^
                this.getTraits.selector ^
                this.getEnabledTraits.selector ^
                this.setTrait.selector ^
                this.GetArtByUri.selector ^
                this.GetArtCount.selector ^
                this.GetArt.selector ^
                this.GetArts.selector ^
                this.GetRemovedArts.selector ^
                this.SetArt.selector ^
                this.RemoveArt.selector ^
                this.setArtist.selector
        ] = true;
        ...
        returns (bool result)
    {
        ...
        if (CheckIfArtInRemoved(_traitId, _rarityId, _artUri)) {
            (uint256 removedIdx, bool foundRemoved) = GetRemovedArtIdxByUri(
                _traitId,
                _rarityId,
                _artUri
            );
