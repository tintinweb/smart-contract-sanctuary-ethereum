...
contract WarrantyNFT is ERC721URIStorage  {
  ...
  constructor() ERC721 ("WarrantyTest", "WRNTY") {
    ...
    function encodeBaseImage(string memory productId,string memory user , string memory dateRegistered   ) public  returns  ( string memory) {
    ...
    string memory base_svg =string ( abi.encodePacked('<svg width="479.99999999999994" height="479.99999999999994" xmlns="http://www.w3.org/2000/svg">',
                                        ...
                                        '<text xml:space="preserve" text-anchor="start" font-family="Noto Sans JP" font-size="24" id="svg_6" y="420.00" x="45.00000" stroke-width="0" stroke="#000" fill="#000000">Warranty Period: 6 Months</text>',
...
function expireNFT() public {
  ...
  function mintWarrantyNFT( string memory productId,string memory _name,string memory user, string memory _date ,address reciever ) public {
    ...
    string memory contractName = string(abi.encodePacked(_name ,"'s warranty"));
