...
contract DAOProxyFactory is AccessControl {
    ...
    function newDAOProxy(
        ...
        IMembershipModule membershipModule = getMembershipModuleType(tokenAddress);
    ...
    function getMembershipModuleType(address tokenAddress) public returns (IMembershipModule membershipModule){
        if (ERC165(tokenAddress).supportsInterface(0x80ac58cd)) { // supports erc721
