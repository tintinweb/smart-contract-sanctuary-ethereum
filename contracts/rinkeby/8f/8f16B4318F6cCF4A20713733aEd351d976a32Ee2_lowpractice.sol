...
contract lowpractice is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LOW Prctice", "LP") {
    setHiddenMetadataUri("ipfs://QmdKMRqULUGdn8EVSaY56j5Kd11kZpNkx4t4cHEVQxeYyV/hidden.json");
  }
