...
contract TheWonderfulChildrenoftheWorld is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TheWonderfulChildrenoftheWorld", "TWCW") {
    setHiddenMetadataUri("ipfs://Qmcv2cuPnDBh3Lp1AGKAeSKu2uM196jrhQ63hyxHjt47Ak/hidden.json");
  }
