 ...
 OwnableUpgradeable
  ...
  mapping(string => bool) _tokenExists;
    ...
    constructor(SharedNFTLogic _sharedNFTLogic)
     VRFConsumerBase(
            0x8C7382F9D8f56b33781fE506E897a4F1e2d17255, // Coordinator
    ...
    // * VRF 
    // * Random number request from Chainlink node
    function getRandomNumber() public returns (bytes32 requestId) {
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        return requestRandomness(keyHash, fee);
    }

    // * Chainlink random number fulfillment
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        randomResult = 0;
        randomResult = (randomness % 10000);
            }
  
    // * mintNFT with random result 
    function mintVRF() public {
