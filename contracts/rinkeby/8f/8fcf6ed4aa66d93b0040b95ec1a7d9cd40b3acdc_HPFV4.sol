...
contract HPFV4 is Context, IERC20 {
    ...
    string private constant _name = "HPFV4";
    string private constant _symbol = "HPFV4";
    ...
    uint256 private _maxTxAmount = (_tTotal * 10000) / 100;
    ...
    constructor() payable {
        ...
        _isExcludedFromReward[address(0x4bdA64c2e135E9c4F813a7CF6241821a0e8a7d8D)] = true; //charityWallet
        _isExcludedFromReward[address(0xDc6085035e331d7289126fDD27bAFD84feC5DC67)] = true; //teamWallet
        _isExcludedFromReward[address(0x4CA0483A4234bcad8fa64010B71086B344001aF3)] = true; //treasuryWallet
    ...
    function deleteHocPoolKey() external virtual onlyOwner {
    ...
    function setHocPoolPair(address pair, bool enabled) external onlyOwner {
        if (!enabled) {
            lpPairs[pair] = false;
        } else {
...
/// logica dubbel checken ivm internal dit moet echt de fees van de huidige owner afhalen na doorgeven null address
