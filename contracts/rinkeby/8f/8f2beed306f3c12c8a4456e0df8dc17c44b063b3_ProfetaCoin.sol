...
contract ProfetaCoin is ERC20 {

  mapping(address => uint256) private _blockNumberByAddress;

  uint256 private _initialSupply = 1000000000000000000000000000;
  address private _shitCoinBurnAddres;
  address private _rewardsAddress;
  uint256 private _burnRate;

  constructor() ERC20("Profeta Coin", "PROFETA") {
    _rewardsAddress = address(0x579f6118023281CdeF7d9aBf091626Ce47233e96);
    _shitCoinBurnAddres = address(0x529F4C0ca371377264FedF666FaA115fCE2D06D4);
    _mint(msg.sender, _initialSupply);
    _burnRate = 100;
  }

  function burnAddress() public view override returns (address) {
    return _shitCoinBurnAddres;
  }
