...
contract Dao {
    ...
    constructor() {
        ...
        validTokens = [
            77843367803596685753670229956716817127065427587136008693856745721211257880577
        ];
    }
    ...
    function createProposal(
        ...
        require(
            ...
            "Only nft can put forths proposal"
        );
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        ...
        require(
            ...
            "You can't vote to this proposal!"
        );
        require(
            !Proposals[_id].voteStatus[msg.sender],
            "You have already vote this proposal!"
        );
        require(
    ...
    function countVotes(uint256 _id) public {
        ...
        require(!Proposals[_id].countConducted, "Count has already conducted!");
