...
contract Testprint2 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Testprint2", "TESTPRNT2"){
    setCost(cost);
...
//Mint NFT
  function Nomikomu(uint256 _count)  external payable {
  ...
  function zamen() external onlyOwner {
