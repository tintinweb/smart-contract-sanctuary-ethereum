...
contract CutePuppy  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmfSDwr6GeEDb1sqctnwNQohvavfcqtc9wmW3pCUFSUUXp/";
    ...
    constructor() ERC721A("Cute Puppy", "CUTEPUPPY"){}
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI,"pre-reveal.json"))//string(abi.encodePacked(currentBaseURI,Strings.toString(_tokenId+1),".json"))
            : "";
    }
