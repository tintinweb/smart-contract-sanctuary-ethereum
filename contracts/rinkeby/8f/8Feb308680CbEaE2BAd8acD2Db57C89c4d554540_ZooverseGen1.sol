...
contract ZooverseGen1 is OldERC721A {
    constructor() OldERC721A("Z1", "Z1", 10000){}
    ...
    IERC721Enumerable
{
    ...
    constructor(
        ...
        require(maxBatchSize_ > 0, "OldERC721A: max batch size must be nonzero");
        _name = name_;
        _symbol = symbol_;
    ...
    function tokenByIndex(uint256 index)
        ...
        returns (uint256)
    {
        require(index < totalSupply(), "OldERC721A: global index out of bounds");
        return index;
    }
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index)
        ...
        returns (uint256)
    {
        require(index < balanceOf(owner), "OldERC721A: owner index out of bounds");
        ...
        revert("OldERC721A: unable to get token of owner by index");
    }
    ...
    function balanceOf(address owner) public view override returns (uint256) {
        require(
            owner != address(0),
            "OldERC721A: balance query for the zero address"
        );
    ...
    function _numberMinted(address owner) internal view returns (uint256) {
        require(
            owner != address(0),
            "OldERC721A: number minted query for the zero address"
        );
    ...
    {
        require(_exists(tokenId), "OldERC721A: owner query for nonexistent token");
        ...
        revert("OldERC721A: unable to determine the owner of token");
    }
    ...
    function approve(address to, uint256 tokenId) public override {
        ...
        require(to != owner, "OldERC721A: approval to current owner");

        require(
            _msgSender() == owner || isApprovedForAll(owner, _msgSender()),
            "OldERC721A: approve caller is not owner nor approved for all"
        );
        ...
        returns (address)
    {
        require(
            _exists(tokenId),
            "OldERC721A: approved query for nonexistent token"
        );
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        require(operator != _msgSender(), "OldERC721A: approve to caller");
    ...
    function safeTransferFrom(
        ...
        require(
            ...
            "OldERC721A: transfer to non ERC721Receiver implementer"
        );
    }
    ...
    function _safeMint(
        ...
        require(to != address(0), "OldERC721A: mint to the zero address");
        // We know if the first token in the batch doesn't exist, the other ones don't as well, because of serial ordering.
        require(!_exists(startTokenId), "OldERC721A: token already minted");
        require(quantity <= maxBatchSize, "OldERC721A: quantity to mint too high");
    ...
    function _transfer(
        ...
        require(
            isApprovedOrOwner,
            "OldERC721A: transfer caller is not owner nor approved"
        );

        require(
            prevOwnership.addr == from,
            "OldERC721A: transfer from incorrect owner"
        );
        require(to != address(0), "OldERC721A: transfer to the zero address");
