  ...
  VRFConsumerBaseV2
{
  ...
  uint16 vrfRequestConfirmations = 10;
  ...
  function requestRandomSeed() external onlyOwner {
    require(randomSeed == 0, "The random seed was already requested");
  ...
  function mintAllowlist(
    ...
    signers.requireValidSignature(_signaturePayload(to, nonce), sig);
    ...
    returns (string memory)
  {
    ...
    if (randomSeed == 0 || finalInventory == 0) {
      ...
      return string(abi.encodePacked(baseURI, "unrevealed"));
    } else {
