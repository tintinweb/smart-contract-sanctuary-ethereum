    ...
    TellerV2Context
{
    ...
    uint256 public constant CURRENT_CODE_VERSION = 3;
    ...
    function onUpgrade(address _lenderCommitmentForwarder) external {
        require(
...
interface IMarketRegistry {
    ...
    function getMarketFeeRecipient(uint256 _marketId) external returns (address);
