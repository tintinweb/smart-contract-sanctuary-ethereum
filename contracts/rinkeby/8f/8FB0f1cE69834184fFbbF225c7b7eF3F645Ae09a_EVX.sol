...
contract EVX is ERC721Enumerable, Ownable {
    ...
    address public airdropuser = address(0x3bBa70bcFD98C2a8718140497e88f51Fbf80E766);
    string baseURI;
    ...
    function claim(uint256 tokenQuantity, address owner) public payable onlyOwner{
        require(
            totalSupply() + tokenQuantity <= MAX_SUPPLY,
            "Sale would exceed max supply"
        );
