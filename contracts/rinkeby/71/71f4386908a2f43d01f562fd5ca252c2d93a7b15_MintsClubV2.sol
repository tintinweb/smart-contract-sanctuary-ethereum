...
contract MintsClub is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable{
    ...
    productowner  = 0xe0c4e3817a8e8B9099E7b3B21905D3B5B543D575; // product owner address
    default_Fee = 20; // default fee initial value
    ended = false;   // ended initial value
    _baseURI = "";  // base uri
...
// File contracts/MintsClubV2.sol
...
contract MintsClubV2 is MintsClub{


    uint256 umar ;
      function settUmar() public returns(uint256 _umar){
        umar = _umar;
      }  
