...
contract TestNFT is ERC721, IERC2981, ReentrancyGuard, Ownable {
    ...
    constructor(string memory customBaseURI_) ERC721('TestToken33', 'TTKN3') {
    ...
    address private constant OPENSEA =
        0x1E0049783F008A0085193E00003D00cd54003c71;

    /* BLOCK UNSUPPORTED MARKETPLACE */
    function _requireMarketplaceWithERC2981(address to) internal pure {
        require(to != OPENSEA, 'does not support ERC-2981');
    }
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        _requireMarketplaceWithERC2981(operator);
        super.setApprovalForAll(operator, approved);
    }

    function approve(address to, uint256 tokenId) public virtual override {
        _requireMarketplaceWithERC2981(to);
