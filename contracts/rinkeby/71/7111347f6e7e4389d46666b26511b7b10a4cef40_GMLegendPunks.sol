...
// File: contracts/GMLegendPunks-testnet.sol
...
contract GMLegendPunks is ERC721A, Ownable{
    ...
    uint public supplyLimit = 20;
    uint public freeSupply = 2;
    bool public publicSaleActive = false;
    string public baseURI;
    uint256 public tokenPrice = .0049 ether;
  ...
  function mint(uint256 _quantity) external payable{
      if(totalSupply() < freeSupply){
          ...
          require(_quantity <= maxPerTransaction, "Over max per transaction! Limit is 20");
      }
