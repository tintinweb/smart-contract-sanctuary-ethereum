...
contract FERC1155Seller is ERC1155Holder, ReentrancyGuard {
    ...
    event Purchase(address buyer, uint256 fId, uint256 amount, uint256 price);
    event End(uint256 fId, uint256 bal, address who);
    event UpdatePrice(uint256 fId, uint256 price);
    ...
    function list(
        ...
        emit Listing(_fId, msg.sender, _amount, _start, _end, _price);
    }
        ...
        whileActive(_fId)
    {
        ...
        emit Purchase(msg.sender, _fId, _amount, price);
    }
