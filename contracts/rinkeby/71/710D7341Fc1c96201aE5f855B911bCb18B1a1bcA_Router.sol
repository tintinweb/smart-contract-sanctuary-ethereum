    ...
    ReentrancyGuard
{
    ...
    address public BASE_TOKEN_ADDRESS = 0x77D5e613A4B59F3A12c7690c5371e906b9Fdb3c5;
    ...
    function setBaseTokenAddress(address _baseAddress) public onlyOwner {
        BASE_TOKEN_ADDRESS = _baseAddress;
    }
        ...
        )
    {
        ...
        if (MerkleProof.verify(input.merkleProof, merkleRoot, leaf)) {
            ...
            if (protocolFeeAmount < remainOutputValue) {
                ...
                protocolFeeAmount = 0;
                path[0] = path[1];
                path[1] = BASE_TOKEN_ADDRESS;
                realAllowedValue = dexRouter.getAmountsOut(protocolFeeAmount, path)[1];
