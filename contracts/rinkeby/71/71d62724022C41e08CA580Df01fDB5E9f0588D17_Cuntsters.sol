    ...
    ERC2981ContractWideRoyalties
{
    ...
    uint256 public pioneerPrice = 0.0015 ether;
    uint256 public ogPrice = 0.002 ether;
    uint256 public whitelistPrice = 0.0025 ether;

    uint256 public pioneerLimit = 6;
    uint256 public ogLimit = 6;
    uint256 public whitelistLimit = 6;
    ...
    function pioneerMint(uint256 _amount)
        external
        payable
    ...
    function ogMint(uint256 _amount)
        external
        payable
...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _internalTokenID(uint256 externalTokenID_)
        private
        view
        returns (uint256)
    {
