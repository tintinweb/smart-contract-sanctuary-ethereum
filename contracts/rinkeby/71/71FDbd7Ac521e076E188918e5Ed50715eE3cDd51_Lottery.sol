...
contract Lottery is VRFConsumerBase, ColorMap  {
    ...
    event LotteryTriggered(address recentWinner, uint lottPot);
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        if(randomValues[0] % 3 == 1) {
            ...
            uint lottPot;
            randomResult = randomValues[1] % cells;
            ...
            _unpause();
            emit LotteryTriggered(recentWinner, lottPot);
        } else {
            _unpause();
        }
    }
