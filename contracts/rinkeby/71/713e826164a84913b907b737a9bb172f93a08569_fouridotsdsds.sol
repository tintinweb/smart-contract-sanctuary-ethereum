...
contract fouridotsdsds is ERC721A, ERC721AQueryable, Owned {
  uint256 constant EXTRA_MINT_PRICE = 0.006 ether;
  uint256 constant MAX_SUPPLY_PLUS_ONE = 1501;
  ...
  string tokenBaseUri = "ipfs://QmTrsf3UU2mUufpwnEZ6jkDuSxvPLLs9GM3AzScHgRw4zh/";

  bool public paused = true;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("4 Idiots 7", "4ID7") Owned(msg.sender) {
      setHiddenMetadataUri("ipfs://QmTrsf3UU2mUufpwnEZ6jkDuSxvPLLs9GM3AzScHgRw4zh/hidden.json");
  }

  // Rename mint function to optimize gas
  function mint_idiot (uint256 _quantity) external payable {
    unchecked {
