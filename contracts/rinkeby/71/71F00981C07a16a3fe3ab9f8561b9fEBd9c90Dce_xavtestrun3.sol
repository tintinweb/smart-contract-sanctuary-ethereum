...
contract xavtestrun3 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("xavtestrun3", "XTR3") {
    setHiddenMetadataUri("ipfs://QmZ6D4UiG8eriQNCYyqcoVQoqab264ygjGChHLuS9oWnk3/hidden.json");
  }
