...
contract UglyClowns is ERC721, Ownable {
    using Strings for uint256;
    ...
    // Number of SPs reserved for promotion & giveaways
    uint256 private _totalReserved = 2;
    ...
    modifier onlyAdmin() {
        require(
            _msgSender() == owner() || _msgSender() == fonsi,
    ...
    function sendPrize(address payable receiver, uint256 amount)
        external
        payable
        onlyOwner
    {
