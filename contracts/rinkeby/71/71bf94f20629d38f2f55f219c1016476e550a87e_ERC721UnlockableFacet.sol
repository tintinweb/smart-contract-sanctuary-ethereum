...
contract ERC721UnlockableFacet is IERC721UnlockableFacet {
        ...
        override
    {
        ...
        _unlockToken(_to, _tokenId);
    }

    function _unlockToken(address to_, uint256 tokenId_) internal virtual {
        // solhint-disable-next-line reason-string
        require(
            s.erc721Base.owners[tokenId_] == s.diamondAddress,
        ...
        s.erc721Base.balances[s.diamondAddress] -= 1;
        s.erc721Base.balances[to_] += 1;
        s.erc721Base.owners[tokenId_] = to_;

        emit Transfer(s.diamondAddress, to_, tokenId_);
    }
}
