...
contract Index is OwnableUpgradeable {
    ...
    function udpateindex(
     address[] memory _tokens, uint16[] memory _percentages
    ) external onlyOwner {
    ...
    function deposit(uint256 amountin) public {
        ...
        require(
            checkbalancebytoken(ptoken, msg.sender) >= amountin &&
        ...
        IERC(ptoken).transferFrom(msg.sender, address(this), amountin);
