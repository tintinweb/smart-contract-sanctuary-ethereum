...
/**
 * @title NOTSkullbotBikerGang contract
...
contract NOTSkullbotBikerGang is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("NOTSkullbotBikerGang", "NSBG") {}
    ...
    function mint(uint256 amt) external payable {
        ...
        require(totalSupply() + amt < maxSupply + 1, "No more skull");
