...
contract BoredLickingCat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bored Licking Cat", "BLC") {
    setHiddenMetadataUri("ipfs://QmZFYk9Zxx3RdwdawfYPR9smEo7rw2Geh4PBBfpHQbaAga/hidden.json");
  }
