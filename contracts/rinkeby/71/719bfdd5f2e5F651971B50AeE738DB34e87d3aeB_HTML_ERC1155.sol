 ...
 */
 ...
 interface SubContract_Interface{
  ...
  function canSell(uint256 _tokenId) external view returns (bool);
}

contract HTML_ERC1155 is ERC1155Tradable {
...
function uri(
    ...
    require(_exists(_id), "ERC1155Tradable#uri: NONEXISTENT_TOKEN");
    SubContract_Interface SubContract = SubContract_Interface(externalContracts[_id]);
  ...
  function setApprovalForAll(address operator, bool approved) public virtual override {
    ...
    function safeTransferFrom(
        ...
        SubContract_Interface SubContract = SubContract_Interface(externalContracts[id]);
        require(SubContract.canSell(1));
