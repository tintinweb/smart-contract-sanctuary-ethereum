...
contract FearWolf is FearWolfBase, ERC721Enumerable, AccessControl, Pausable, OpenSeaCompatible, VRFConsumerBase, IMRC721Metadata {
    ...
    */
    ...
    uint64 private constant MAIN_CHAINID = 4; // FIXME !! put '1' for Ethereum
    ...
    function _beforePause() internal virtual override {
        revert("Once unleashed FEAR Wolf cannot be stopped anymore"); // cannot pause!
    }
    ...
    */
    ...
    function encodeParams(uint256 id) public view tokenExists(id) returns(bytes memory){
    ...
    function setFuzz(address _address) external whenPaused onlyRole(ADMIN_ROLE) {
