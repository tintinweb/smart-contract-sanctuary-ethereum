...
contract sbASCII is ERC721URIStorage, Ownable {
  ...
  string svgPartTwo = "'/><text x='50%' y='30%' class='base' dominant-baseline='middle' text-anchor='middle'>Current EXP Balance:</text><text x='50%' y='50%' class='base' dominant-baseline='middle' text-anchor='middle'>";
  ...
  function updateURI(uint256 _tokenId, string memory _balance) internal {
    // Add the random color in.
    string memory randomColor = pickRandomColor(_tokenId);
    string memory finalSvg = string(abi.encodePacked(svgPartOne, randomColor, svgPartTwo, _balance, "</text></svg>"));
  ...
  function updateTokenURI(uint256 _tokenId) internal {
    ...
    updateURI(_tokenId, Strings.toString(balance));
  }
