...
contract MyToken is ERC721, ERC721URIStorage, Ownable {
    ...
    */
    ...
    constructor() ERC721("NestCoin", "NCN") {}
     ...
     function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qmame2QwQMsvv99g84BJdDs7bcH5UCu8qXKzWL3NpsALNU";
    }
   ...
   */
    ...
    function awardItem(address minter, string memory uri, uint256 price) public{
        nestCoin.transferFrom(msg.sender, address (this), price);
        uint256 newToken = safeMint(minter, uri);
