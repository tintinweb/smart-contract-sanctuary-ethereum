...
import "./Test1155TokenMinter.sol";

contract Test1155Holder is IERC1155Receiver, AccessControl {
    ...
    function sendToken(
        ...
        Test1155Minter minter = Test1155Minter(minterContract);
        minter.safeTransferFrom(address(this), to, id, amount, "");
    }
...
contract Test1155Minter is ERC1155, AccessControl {
    ...
    {
        require(
            _tokenIds.current() >= tokenId,
            "The MetaData for this tokenId does not exist in this contract"
        );
    ...
    //Mint a token from an already existing token id
    function mintToken(
        address recipient,
        uint256 tokenId,
        uint256 amount
