...
contract Crazy is Ownable, ERC721, ERC2981 {
  ...
  function buyFree(uint256 numberOfTokens) external {
    ...
    require(balanceOf(msg.sender) + numberOfTokens < 6, "Exceeds mint limit of 5, per wallet");
    require(numberOfTokens > 0, "Should mint atleast 1 paper pass");
    require(paperSupply + numberOfTokens <= PAPER_PASS_SUPPLY, "Paper pass supply maxed out");
