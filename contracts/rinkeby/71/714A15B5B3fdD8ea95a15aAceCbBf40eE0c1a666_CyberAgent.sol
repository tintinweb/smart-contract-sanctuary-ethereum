    ...
    ERC2981Upgradeable
{
    ...
    modifier validTokenId(uint256 _tokenId) {
        require(_tokenId > 0 && _tokenId <= tokenCounter, "Invalid tokenId");
        _;
    }
     ...
     *  @dev    Only owner can call this function.
     */
    function mint(address _owner, string memory _uri) external onlyOwner {
        tokenCounter++;
        _mint(_owner, tokenCounter);
        _setTokenURI(tokenCounter, _uri);
        emit Minted(tokenCounter, _owner, _uri);
    }
