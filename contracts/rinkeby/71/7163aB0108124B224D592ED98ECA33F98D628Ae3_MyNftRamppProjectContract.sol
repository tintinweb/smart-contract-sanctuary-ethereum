...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8a06fB40530E847a53b3C53d0b8182Ce661C1F62];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSX3P6LoMyrxbViKFCYCA2hfA7gQD6ZwAFc2CsZ2c37RB/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project", "SYMB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GftmZaGelYpg7POno49c/contract-metadata";
    }
}
