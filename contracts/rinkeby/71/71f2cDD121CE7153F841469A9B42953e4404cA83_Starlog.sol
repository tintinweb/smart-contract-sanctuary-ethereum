...
contract Starlog is ERC721, Ownable, VRFConsumerBaseV2 {
        ...
        override
    {
        ...
        tokenIdToSeed[currentId] = randomNumber;
        _safeMint(requestToSender[requestId], currentId);
        currentId++;
    }
    ...
    function tokenURI(uint256 tokenId) public override view returns(string memory) {
        if(isRevealed) {
            ...
            string memory uri = string(abi.encodePacked("https://api.starlog.ai/planet/", seed));
            return uri;
        } else {
            return "https://api.starlog.ai/planet";
        }
    }
