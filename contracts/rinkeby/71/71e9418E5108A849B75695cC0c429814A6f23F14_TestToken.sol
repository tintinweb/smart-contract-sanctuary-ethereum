...
contract TestToken is ERC721, Pausable, Ownable {
    ...
    // Merkle Root for the Whitelist mint
...
//===========================
    ...
    uint256 public test01;
    uint256 public test02;
    uint256 public test03;
    uint256 public test04;

    function testStuff() public {
        test01 = block.timestamp;
        test02 = auctionStartTime;
        test03 = auctionStartTime + 1 days;
        test04 = 1 days;
    }

    // Auction function, able to mint multiple NFTs at once efficiently
    function auction(uint256 count) public payable whenNotPaused { //(bool mintingTwo)
...
// WHITELIST MINTING
    ...
    function mintWL(bytes32[] calldata _merkleProof) public payable {

        if(totalSupply + 1 > auctionSupply) revert MintedOut();
...
//===========================
    ...
    // FUNCTIONS THAT ALLOW PAUSABLE FUNCTIONALITY
