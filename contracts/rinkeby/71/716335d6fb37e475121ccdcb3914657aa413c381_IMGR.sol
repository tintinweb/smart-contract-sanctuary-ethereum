...
contract IMGR is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("IMGR", "IMGR") ERC20Permit("IMGR") {
    ...
    function _mint(address to, uint256 amount)
        ...
        override(ERC20, ERC20Votes)
    {
        uint cap = 900000000 * (10 ** 18);
        require((totalSupply() + amount) <= cap, "Cap has been passed: cap exceeded");
