...
contract FakeTestToo is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("Fake Test Too", "FTTOO") {
    setBaseURI("http://localhost:4000/api/fake-test-too/token/");
