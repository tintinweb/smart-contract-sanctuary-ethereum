...
/// @title KNC collection smart contract
contract KNC2 is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement {
    using Strings for uint256;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "KNC: total supply reached");
        _;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "KNC: tranfer is temporarily unavailable"
            );
        }
