...
contract NFTLoan {
    ...
    function loanCreated(
        ...
        require(
            ...
            "Sorry mate, can't go back in time"
        );
     ...
     */
    function interestAccrued(uint256 _loanId, uint256 _future)
        public
        view
        returns (uint256)
    {
        ...
        uint256 _maxInterest = ABDKMath64x64.mulu(
            _interestRate,
            loan.loanAmount
        ); // Maximum interest applicable
     ...
     */
    function totalInterest(uint256 _loanId, uint256 _future)
        public
        view
        returns (uint256)
    {
     ...
     */
    function totalPayment(uint256 _loanId, uint256 _future)
        public
        view
        returns (uint256)
    {
    ...
    function acceptLoan(uint256 _loanId) external payable {
        ...
        if (loan.loanHistory != 0) {
            ...
            require(
                ...
                "Sorry mate, can't accept maximum loan"
            );
    ...
    function repayAmount(uint256 _loanId) external payable {
        ...
        require(
            ...
            "Sorry mate, can't repay a paid loan"
        );
    ...
    function cancelLoan(uint256 _loanId) external {
        ...
        require(
            loan.nftOwner == msg.sender,
            "Sorry mate, only NFT owner can cancel."
        );
    ...
    function liquidateLoan(uint256 _loanId) external {
        ...
        require(
            ...
            "Sorry mate, only lender can withdraw funds"
        );
