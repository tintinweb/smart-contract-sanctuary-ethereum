...
contract MyTokenFactoryUUPS {
    ...
    mapping(uint256 => address) private _addressesOfProxies;
    ...
    constructor() {
        _tokenImplementation = address(new TokenUpgradeable());
    }
    ...
    function createToken(
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeWithSelector(
                TokenUpgradeable(address(0)).initialize.selector,
                name,
                symbol,
                initialSupply,
                owner
        ...
        _addressesOfProxies[currentCounter] = address(proxy);
        _tokenIdCounter.increment();
        emit TokenDeployed(address(proxy));
        return address(proxy);
    }

    function addressOfProxy(uint8 index) public view returns (address) {
        return _addressesOfProxies[index];
    }
}
