...
contract MetaGodsToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    event TimestampEvent(uint256 first, uint256 second, uint256 third, uint256 fourth);
    ...
    function withdraw(
        ...
        // TO REMOVE
        emit TimestampEvent(generationDate_, withdrawRequestLifetimeSeconds, generationDate_ + withdrawRequestLifetimeSeconds, block.timestamp);
    }
