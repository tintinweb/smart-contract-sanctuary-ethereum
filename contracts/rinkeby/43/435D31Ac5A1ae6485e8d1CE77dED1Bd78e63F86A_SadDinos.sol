...
contract SadDinos is ERC721A, Ownable {
    ...
    function freeMint(uint256 _amount) external payable publicSaleActive mintCompliance(_amount) {

        uint256 userFreeMintsTotal =  _freeMinted[msg.sender];
        require(userFreeMintsTotal + _amount <= freeMax, "Max free mint limit");
