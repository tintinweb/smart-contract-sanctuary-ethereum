 ...
 */
contract TestToken is IBEP20, Ownable, MinterRole, PauserRole, Pausable {
...
// call in constructor
    constructor() public {
        ...
        _decimals = 18;
        isInitialized = true;
        _owner = 0x4B82e0dcD28fF254769Ab98a78A980774ed89d38;
        _addMinter(0x4B82e0dcD28fF254769Ab98a78A980774ed89d38);
        _addPauser(0x4B82e0dcD28fF254769Ab98a78A980774ed89d38);
        _paused = false;
    }
    ...
    function mint(address to, uint256 value) public onlyMinter returns (bool) {
        require(value + _totalSupply <= 1000000000 ether, "max supply exceeding");
        _mint(to, value);
        return true;
    }
    ...
    */
    ...
    function drop(address[] memory recipients, uint256[] memory values) public onlyMinter {
