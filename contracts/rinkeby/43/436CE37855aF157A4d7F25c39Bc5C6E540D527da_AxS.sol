...
contract AxS is ERC721A, Ownable {
    uint256 public constant maxMintSupply = 10;
    ...
    constructor() ERC721A("AxS", "ERC721R") {
    ...
    function isWhiteListed2(bytes32[] calldata proof) public view returns (bool) {
         return (_isAllowlisted(msg.sender, proof, merkleRoot));
    }
