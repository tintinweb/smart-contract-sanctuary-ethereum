...
contract Movie is ERC721Optimized, Ownable, ReentrancyGuard {
    ...
    function SetTokenIdPrice(uint256 tokenId,uint256 newTokenPrice) public payable nonReentrant {
       //授权
        address owner = ERC721Optimized.ownerOf(tokenId);
    ...
    function mint(uint256 numberOfTokens) public payable nonReentrant {
        ...
        //transfer add tradePercent
        function buyMovie(address seller,address buyer,
        uint256 tokenId, uint256 amount) public payable nonReentrant{ 
            //check balance
            ...
            //tradeFee
            uint256 tradeFee = amount * uint256(tradeFeePrecent);
