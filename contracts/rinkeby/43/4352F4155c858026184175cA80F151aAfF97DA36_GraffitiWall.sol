    ...
    Pausable
{
    ...
    function safeMint(address to) public onlyOwnerorAdmin {
        // Mint 1 token
        _safeMint(to, 1);
    }
    ...
    function getSvg(uint tokenId) private view returns (string memory) {
        ...
        //parts[0] = "<svg width='350px' height='350px' xmlns='http://www.w3.org/2000/svg'><style>.a { fill: ";
        //parts [1] = graffiti[tokenId].fill;
        //parts [2] = " ; font-size: 18px; }</style><rect width='100%' height='100%' fill='black' /><text x='10' y='20' class='a'>";
        //parts[3] = graffiti[tokenId].message;
        //parts[4] = "</text></svg>";
    ...
    function setTokenMessage(uint tokenId, string memory message) external onlyOwnerorAdmin {
        ...
        graffiti[tokenId].message = message;
    }
