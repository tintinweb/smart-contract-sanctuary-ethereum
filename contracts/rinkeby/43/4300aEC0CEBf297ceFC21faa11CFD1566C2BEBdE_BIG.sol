...
contract BIG is ERC721, IERC721Receiver, Ownable, ERC721Enumerable, ERC721Royalty {
    ...
    constructor() ERC721("BIG Society", "BIG") {}
    ...
    function mintBig(uint256 _numberOfTokens) public payable returns (uint256[] memory) {
        ...
        for (uint256 i = 0; i < _numberOfTokens; i++) {
            uint256 mintedToken = _safeMintBig(msg.sender);
