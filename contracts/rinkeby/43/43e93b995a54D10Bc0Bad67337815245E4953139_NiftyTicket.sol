...
contract NiftyTicket is ERC721AQueryable, Ownable {
    ...
    modifier onlyFactory() {
        require(msg.sender == factory, "!factroy");
        _;
    }
    ...
    function initialize(
        ...
        _transferOwnership(tx.origin); //improve this later
    ...
    function mint(address _sudoPool, uint256 quantity) internal {
        _mintERC2309(_sudoPool, quantity);
    }

    // since users get stuck with our contract, give them an ability to mint in the future
    function ownerMint(address _to, uint256 qty) external onlyOwner {
        _mintERC2309(_to, qty);
    }
    ...
    function setName(string memory value) public onlyFactory {
        _setStringAtStorageSlot(value, 2);
    }

    function setSymbol(string memory value) public onlyFactory {
