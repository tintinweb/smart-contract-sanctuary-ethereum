...
contract AmazonClub is ERC721AQueryable, ERC721ABurnable, Ownable {
    ...
    bool public openSales = true;

    string public _contractUri =
        "https://bilets.club/api/opensea_meta_amazon/contract";
    string public _baseUri = "https://bilets.club/api/opensea_meta_amazon/";

    constructor() ERC721A("Amazon Club NFT", "AMZC") {
        _safeMint(msg.sender, 2222);
    }

    function mint(uint256 amount) external payable {
        require(totalSupply() < maxSupply, "Sold out.");
        require(openSales, "Sales is not active.");
    ...
    function flipSales() external onlyOwner {
        openSales = !openSales;
    }
