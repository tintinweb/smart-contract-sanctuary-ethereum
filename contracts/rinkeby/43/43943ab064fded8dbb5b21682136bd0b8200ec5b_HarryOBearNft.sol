...
contract HarryOBearNft is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public cost1 = 0.3 ether; //here you change phase 1 cost (for example first 1k for free, then 0.004 eth each nft)
  uint256 public cost2 = 0.4 ether; //here you change phase 2 cost
  uint256 public supplyLimitPhase1 = 10;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 60;  //change it to your total NFT supply
  uint256 public maxMintAmountPerTxPhase1 = 3; //decide how many NFT's you want to mint with cost1
  uint256 public maxMintAmountPerTxPhase2 = 6; //decide how many NFT's you want to mint with cost2
  uint256 public maxLimitPerWallet = 6; //decide how many NFT's you want to let customers mint per wallet
...
// ================== Constructor Start =======================
  constructor( string memory _uri, string memory _hiddenMetadataUri) ERC721A("Harry O Bear Prime", "HOB")  { //change this line to your full and short NFT name
    seturi(_uri);
