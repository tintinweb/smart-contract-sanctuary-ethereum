...
/*
  --------------------------
     DRScontract
     * 4-4-22, initial trial -- see Rinkeby: 0x387De13CF6f858B91321bb17571037C801b57eE7
     * https://rinkeby.etherscan.io/address/0x387De13CF6f858B91321bb17571037C801b57eE7#code
     * Deployer was: https://rinkeby.etherscan.io/address/0x0f5e5b3068594eebfd69e854798bd0004b16d7fa
     * 4-11-22, updated merkle root: 0x4b1d9bdee2439edf9b525fb769af1902aa09c5e1c787ef11e22af7ce0da3903a
     * 4-20-22 -- deploying new test to Rinkeby.
  --------------------------
*/
...
contract DRScontract is Ownable, ERC721A, PaymentSplitter {

    uint public MAXSUPPLY = 10000; // *Hard-code in setMaxSupply() also.
    ...
    constructor(address[] memory distro, uint[] memory distro_shares, address[] memory teamclaim, bytes32 _merkleRoot)
        ERC721A("DRS-TEMPLATE", "DRS")
        PaymentSplitter(distro, distro_shares)
    {
        METADATAURI = "ipfs://QmVPLq3wPzs1K429DLJy8iJuSdRWoVDiTb4TA8JFi7fNGb/";  // test

        accounts[msg.sender] = Account( 0, 0, 0 );

        // Set Project / Team NFTs & Initial Admin Levels:
        accounts[teamclaim[0]] = Account( 25, 0, 1); // .
