...
contract AmorMundi is ERC721AQueryable, Ownable, ReentrancyGuard {
    string _baseTokenURI =
        "ipfs://QmX1opaH5HrXS7t77DCEsK7ZN4UbrwzJK3utJP88cgBPHE/";
    ...
    constructor(uint256[] memory _tokens, uint256[] memory _prices) ERC721A("Amor x Stephan Breuer", "Amorx1") {
        _mint(address(this), 88);
    ...
    function buy(uint256 tokenId) external payable nonReentrant {
        ...
        require(ownerOf(tokenId) == address(this), "sold");
