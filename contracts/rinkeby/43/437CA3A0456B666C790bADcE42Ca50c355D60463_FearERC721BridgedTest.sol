...
import "./../common/ERC721/IMRC721.sol";
 ...
 * @dev FEAR NFT test.
 */
contract FearERC721BridgedTest is ERC721Enumerable, AccessControl, Withdrawable, OpenSeaCompatible, IMRC721 {
    ...
    */
    ...
    constructor() ERC721("FEAR ERC721 Bridged Test", "F721TEST") {
    ...
    function mint(address to, uint256 id) external onlyRole(BRIDGER_ROLE) {
