...
import "./IYourNftToken.sol";

contract DreamEyeHParent is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  IYourNftToken public histContract;
  ...
  function setHistContract(address _histContract) public onlyOwner {
    histContract = IYourNftToken(_histContract);
  }
