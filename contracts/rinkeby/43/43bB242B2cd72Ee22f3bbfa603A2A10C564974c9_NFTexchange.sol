...
contract NFTexchange {
    ...
    string private constant SELL_TYPE = "SellOrder(string _nonce,uint _startsAt,uint _expiresAt,address _nftContract,uint256 _nftTokenId,address _paymentTokenContract,address _seller,uint256 _sellerAmount,uint256 _feeWithRoyalty,uint256 _totalAmount)";
    string private constant BUY_TYPE = "BuyOrder(string _nonce,uint _startsAt,uint _expiresAt,address _nftContract,uint256 _nftTokenId,address _paymentTokenContract,address _buyer,uint256 _sellerAmount,uint256 _feeWithRoyalty,uint256 _totalAmount)";
    ...
    event Exchange(string exchangeId);
    ...
    ifUnpaused payable external returns(bool) {
        ...
        require(block.timestamp >= sell._startsAt, "Sell offer hasn't started.");
    ...
    ifUnpaused external returns(bool) {
        ...
        require(block.timestamp >= buy._startsAt, "Buy offer hasn't started.");
    ...
    string memory exchangeId, uint256 minBidAmountToExecute,
