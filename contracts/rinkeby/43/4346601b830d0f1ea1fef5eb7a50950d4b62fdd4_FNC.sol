...
/// @title FNC collection smart contract
contract FNC is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement, ContextMixin, NativeMetaTransaction {
    using Strings for uint256;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "FNC: total supply reached");
        _;
    }
    ...
    /// @notice update contract
    /// @param _contractURI URI
    /// @dev from owner
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "FNC: tranfer is temporarily unavailable"
            );
        }
