...
import "./interfaces/IOpenSea.sol";

contract HomeCat is Ownable, Pausable, ERC721A {
    ...
    modifier onlyMaxSupply(uint256 quantity) {  _; }

    constructor() ERC721A("Home Cat","HC") {
    }
    ...
    function mint(uint256 quantity)
        ...
        onlyAccounts
    {
        require( totalSupply() + quantity <= MAX_SUPPLY , 'Exceeded maximum supply');

        uint256 currentPrice = quantity * MINT_PRICE;
    ...
    {
        // OPENSEA
        if (operator == IOpenSea(0xa5409ec958C83C3f309868babACA7c86DCB077c1).proxies(owner)) return true;
        // LOOKSRARE
