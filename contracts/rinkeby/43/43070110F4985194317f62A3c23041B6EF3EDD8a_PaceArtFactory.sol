...
contract PaceArtFactory is Ownable {
    ...
    /// @notice This function will be used to set new ProxyRegistry address.
    ...
    /// @notice This function will be used to set new Exchange address.
    ...
    /// @notice This function will be used to deploy new ERC721 collection.
    /// @param _name Collection name.
    /// @param _symbol Collection symbol.
    /// @param _tokenURI Collection baseURI.
    ...
    function pushCollection(
        address  _pushLdyAddress,
        address  _pushLdyUserAddress
    )  external onlyOwner {
        collections[_pushLdyUserAddress].push(_pushLdyAddress);
    }
}
