...
contract HausPets is ERC721URIStorage, ERC721Burnable, Pausable, Ownable {
    ...
    uint256 public baseCounter = 0;
    uint256 public midCounter = 390;
    uint256 public rareCounter = 3112;
    ...
    function adoptTokenPet(uint256 quantity) public whenNotPaused {
        ...
        uint256 allowance = _gotterdammerung.allowance(msg.sender, address(0xd61F1c85df608701e3cd8CB245DBa925430e8854));
        require(allowance >= quantity * 25000, "Exceeds approved token allowance");

        _gotterdammerung.transferFrom(msg.sender, address(0xd61F1c85df608701e3cd8CB245DBa925430e8854), quantity * 25000);
