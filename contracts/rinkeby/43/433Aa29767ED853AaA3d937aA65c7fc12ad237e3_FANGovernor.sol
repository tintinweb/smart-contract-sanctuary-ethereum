  ...
  GovernorVotesQuorumFractionUpgradeable
{
  ...
  ) public payable initializer
  {
    ...
    /*
     * Four values control governance:
     *
     * votingDelay, in blocks (using 12 seconds/block)
     * 10 blocks (2 minutes) for testing
     * 36000 blocks (5 days) potential active governance value
     * 13149000 blocks (5 years) safe off position
     *
     * votingPeriod, in blocks
     * 50 blocks (10 minutes) for testing
     * 72000 blocks (10 days) potential active governance value
     * 13149000 blocks (5 years) safe off position
     *
     * proposalThreshold, in tokens
     * 1000 tokens (1 thousand tokens) for testing
     * 1000000 tokens (1 million tokens) potential active governance value
     * 600000000 tokens (600 million tokens, 60% of total supply) safe off position
     *
     * timelock, in milliseconds (in FANGovernorTimelockController)
     * 120000 milliseconds (2 minutes) for testing
     * 172800000 milliseconds (2 days) potential active governance value
     * 157788000000 milliseconds (5 years) safe off position
     *
     * https://ethereum.org/en/developers/docs/blocks/#block-time
     * "the average block time is between 12 to 14 seconds", using 12 seconds
     */

    _votingDelay = 13149000;
    _votingPeriod = 13149000;
    _proposalThreshold = 600000000;
  }

/*
  You can uncomment this function as part of a test upgrading the contract
  After uncommenting it, you can also change the string the function returns

  function exampleUpgradedFunction()
    public
    view
    returns (string memory)
  {
    return "Example new function returning message 1";
  }
*/
