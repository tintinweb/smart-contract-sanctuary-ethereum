...
contract CrocoKingStaking is AccessControl {
    ...
    uint256 public minTokenReward = 100 ether;

    uint256[3] public defaultPackageIndex = [0, 1, 2];
    uint256[3] public defaultLockTime = [3 minutes, 10 minutes, 15 minutes];
    uint256[3] public defaultReward = [1000 ether, 3000 ether, 10000 ether];
