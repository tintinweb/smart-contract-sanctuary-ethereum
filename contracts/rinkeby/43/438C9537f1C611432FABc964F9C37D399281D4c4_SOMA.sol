...
contract SOMA is ISOMA, PausableUpgradeable, ERC165Upgradeable {
    ...
    constructor(
        address _master,
        address _subMaster,
        ISomaGuard _somaGuard,
        ISomaSwapRouter _somaSwapRouter,
        ISomaSwapFactory _somaSwapFactory,
        ITemplateFactory _templateFactory,
        ISomaAccessControl _somaAccessControl
    ) {
        master = _master;
        subMaster = _subMaster;
        access = _somaAccessControl;
        guard = _somaGuard;
        factory = _somaSwapFactory;
        router = _somaSwapRouter;
    ...
    function unpause() external override onlyMaster {
        _unpause();
    }
}
