...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQ3Tt5sPXX4nnypVd2Fqa428kixoN8vcq5kmmC4RRL4uE/";
...
// File: contracts/TestApesTutorialContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestApesTutorialContract is RamppERC721A {
    constructor() RamppERC721A("Test Apes Tutorial", "TESTAPES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Zpz1S0eVJRcJSx4biInW/contract-metadata";
    }
}
