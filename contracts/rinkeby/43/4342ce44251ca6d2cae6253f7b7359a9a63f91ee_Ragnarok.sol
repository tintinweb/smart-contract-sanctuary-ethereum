...
contract Ragnarok is ERC1155Pausable, Ownable {
    ...
    constructor(
    ) ERC1155("https://protected-oasis-25936.herokuapp.com/nft/{id}.json") {
        defaultSaleStartTime = 1651078800;
        ...
        emit UpdatedMerkleRootOfPixelMint(0xddaac2f711d324e054766488df719ce30e72ef30e9d177ccb6e81ecdcf71ae71, msg.sender);
        emit UpdatedMerkleRootOfPillMint(0x0f2a7e1309a3a72f36ff779d697e0cfeb3e0a0526d54e9eb0217db4d3293c57f, msg.sender);
        emit UpdatedPlatformWalletAddress(0xad85B2c59071F837Fc210d1Fdf885529C5E0b75F, msg.sender);
        emit UpdatedPlatformMintingAddress(0xad85B2c59071F837Fc210d1Fdf885529C5E0b75F, msg.sender);
        emit UpdatedSaleStartTime(1651078800, msg.sender);
    }
