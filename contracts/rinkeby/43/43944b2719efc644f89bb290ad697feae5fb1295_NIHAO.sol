...
contract NIHAO is ERC721A, Ownable {
    enum Status {
        Waiting,
        Started,
        Finished,
    ...
    string  baseURI;
    string public notRevealeUri;
    string public baseExtension = ".json";


    uint256 public constant MAX_MINT_PER_ADDR = 2;
    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public  PRICE = 0.010000 ether;
    ...
    constructor(string memory initBaseURI, string memory initNotRevealeUri) ERC721A("nihao", "nh") {
        baseURI = initBaseURI;
        initNotRevealeUri = initNotRevealeUri;
    }
    ...
    function setNotRevealedURI(string calldata newnotRevealedURI) external onlyOwner {
        notRevealeUri = newnotRevealedURI;
