...
/// @title TheAgencyPass Contract
/// @author UncleAaroh
/// @custom:security-contact  [email protected]
/// @custom:company  Hashtag Hodling

contract TheAgencyPassContract is
    ERC721HH,
    IERC2981,
    Ownable,
    PaymentSplitter,
    ReentrancyGuard
{
    ...
    string public contractURIstr =
        "ipfs://QmZ1SRF88AxU498ZFmVG4HudFgnbSF4gPqE3PuK1VmQXcs";
    string public baseExtension = ".json";
    string private baseURI =
        "ipfs://Qma9LBz3vpK3ciYPPpxsLYHGe6m4J3Tg8cZPeJP62n3CkS/";
    ...
    mapping(address => uint256) private _whitelistOGMintTracker;

    address public royaltyOwner;

    /// @dev === PRICE CONFIGURATION ===
    uint256 public whitelistOGPrice = 0.1 ether;
    uint256 public whitelistPrice = 0.25 ether;

    /// @dev === RESERVE/DROPS CONFIGURATION ===
    uint256 public constant NUMBER_RESERVED_TOKENS = 50;

    /// @dev === SALE CONFIGURATION ===
    bool public whiteListSaleIsActive = false;
    bool public whiteListOGSaleIsActive = false;
    ...
    /// @dev === Stats ===
    uint256 public OGWhitelistMinted = 0;
    uint256 public reservedTokensMinted = 0;

    constructor(address[] memory _payees, uint256[] memory _shares)
        payable
        ERC721HH("TheAgencyPass", "AGCY")
    ...
    function mintWhitelist(
        ...
        isCorrectPayment(whitelistPrice, numberOfTokens)
    ...
    function mintOGWhitelist(bytes32[] calldata merkleProof)
        external
        payable
        isSaleActive(whiteListOGSaleIsActive)
        isValidMerkleProof(merkleProof, whitelistOGMerkleRoot)
        isCorrectPayment(whitelistOGPrice, 1)
        nonReentrant
    {
        require(OGWhitelistMinted < 300, "OG Supply exceeded");
        require(_whitelistOGMintTracker[msg.sender] < 1, "NFT already minted");

        OGWhitelistMinted++;
        _whitelistOGMintTracker[msg.sender]++;

        _mintToken(msg.sender, OGWhitelistMinted);
    }
    ...
    function setRoyaltyOwner(address _royaltyOwner) public onlyOwner {
    ...
    function setWhitelistOGPrice(uint256 _whitelistOGPrice) external onlyOwner {
        whitelistOGPrice = _whitelistOGPrice;
    }
    ...
    function setWhitelistOGMerkleRoot(bytes32 merkleRoot) external onlyOwner {
        whitelistOGMerkleRoot = merkleRoot;
    }
    ...
    function flipWhitelistOGSaleState() external onlyOwner {
        whiteListOGSaleIsActive = !whiteListOGSaleIsActive;
    }
        ...
        returns (bool isOperator)
    {
        ...
        return ERC721HH.isApprovedForAll(_owner, _operator);
    }
    ...
    {
        return (royaltyOwner, (_salePrice * 10) / 100);
    }
...
// SPDX-License-Identifier: MIT
// ERC721A Contracts v4.2.2
// Creator: Chiru Labs and modified by Uncle Aaroh
...
contract ERC721HH is IERC721A {
     ...
     */
    function _mintToken(address to, uint256 currentIndex) internal virtual {
