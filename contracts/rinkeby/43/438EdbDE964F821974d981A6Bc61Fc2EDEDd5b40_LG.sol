 ...
 * via governance vote.
 */
contract LG is ERC20_1155Votes, AccessControl, AllocationControl, EmissionCurves, IAllocationMinter, IERC20Permit {
 ...
 */
contract ERC20_1155Votes is ERC1155Supply, EIP712, IERC20Metadata {
    using Counters for Counters.Counter;
