...
/**
    @title MallowAuctions
    @author MetaMallow Team
    @dev MetaMallow whitelist auctions
*/
...
contract mallowAuctions is Ownable{
    ...
    mapping(string => bool) public auctionExists;   //check if auction name exists already
    ...
    constructor (){
        //setApprovedAddresses(msg.sender, true);
    }
    ...
    /**  
        @dev set the reference for the LOVE and Firepit contracts
        @param _loveAddress LOVE contract address
        @param _firepitAddress Firepit contract address
    */
    ...
    /**  
        @dev update the signer in case something goes wrong
    */
    ...
    /**  
        @dev function to enter a certain auction
        @param _auctionId Auction id to enter
        @param _tokenIds Array with staked Metamallows {ERC721A} tokens
        @param _signature generated signature
    */
    ...
    /**  
        @dev create a dutch auction function
    */
    ...
    /**  
        @dev create a normal auction function
    */
    ...
    /**  
        @dev update any auction information
    */
    ...
    /**  
        @dev remove any auction. It will still be in the contract in case we may need the auction info
    */
    ...
    */
    ...
    /**  
        @dev get the auction information
    ...
    */
    ...
    /**  
        @dev get the name of the auction
        @param _auctionId id of the auction
    */
    ...
    /**  
        @dev get the whitelisted user addresses for the auction
        @param _auctionId id of the auction
    */
    ...
    /**  
        @dev get the current auction price
        @param _auctionId id of the auction
    */
    function getCurrentPrice(uint256 _auctionId) public view returns (uint256){
        require(auctionSettings[_auctionId].exists,"Auction does not exist or removed");
        if(auctionSettings[_auctionId].auctionType == 1){    //DUTCH auction
            if(block.timestamp < auctionSettings[_auctionId].startTime){
    ...
    /**  
        @dev checks if user is whitelisted for the auction
        @param _auctionId id of the auction
    ...
    */
    ...
    /**  
        @dev counts the total number of auctions opened
    */
    ...
    /**  
        @dev counts the total number of auctions closed
    */
    ...
    /**  
        @dev counts the total number of auctions upcoming
    */
    ...
    /**  
        @dev counts the total number of auctions removed
    */
    ...
    /**  
        @dev get all the auctions opened
    */
    ...
    /**  
        @dev get all the auctions closed
    */
    ...
    /**  
        @dev get all the auctions upcoming
    */
    ...
    /**  
        @dev Dapp request function to improve speed times. Get {_x} auctions opened and closed. Get all the upcoming auctions ordered from start time.
        Get all the opened auctions first, then the closed auctions from a certain index {_start}
        @param _start auction index
        @param _x number of auctions to get
        @param _wallet wallet to check if it is whilisted
    */
...
/**
    @title LOVE
    @author MetaMallow Team
    @dev LOVE contract extends ERC20 Fungible Token implementation 
*/
...
contract teste_3 is ERC20, Ownable{
    ...
    /** 
      @dev {ERC20-mint} function. Only onlyApprovedAddresses contracts can mint
      @param _to address to mint LOVE tokens
    ...
    */
    ...
    /** 
      @dev {ERC20-burn} function. Only onlyApprovedAddresses contracts can burn
      @param _to address to burn LOVE tokens
