...
// File: contracts/nextContract.sol
...
contract nextContract is ERC721A, ERC2981 , Ownable, Pausable {
    using Strings for uint256;

    string public baseURI = "";
    string internal revealUri = "ipfs://Qmaj7zT275Eyfdac4dNxVLV7S4zrop9gYNDpwShicXNvWL/0.png";
    ...
    address private fromContractAddr;
    // Mint From Burn
    // NextContract.mintFromBurn(newCount, msg.sender);
    function mintFromBurn(uint256 _mintAmount, address _address) public payable whenNotPaused onlyOwnerORFromContract {
    ...
    modifier onlyOwnerORFromContract() {
        require(fromContractAddr == _msgSender() || owner() == _msgSender(), "Ownable: caller is not the Owner or SalesContract");
        _;
    }
    function setFromContract(address newFromContractAddr) external onlyOwner {
        fromContractAddr = newFromContractAddr;
    }
    function getFromContract() external view returns (address) {
        return fromContractAddr;
    }
