...
contract AvatarTreasury is AccessControl, ReentrancyGuard {
    ...
    function getAllTokenBalances() external view returns (TokenInfo[] memory) {
        ...
        tokenInfo[0] = TokenInfo("USDT", USDT, getTokenBalance(USDT));
        tokenInfo[1] = TokenInfo("USDC", USDC, getTokenBalance(USDC));
        tokenInfo[2] = TokenInfo("WETH", WETH, getTokenBalance(WETH));
        return tokenInfo;
    }
