    ...
    ERC1155HolderUpgradeable
{
    ...
    uint64 public constant INITIAL_REWARD = 5;
    ...
    /// @dev mapping from staker address to staked timestamp
    mapping(address => uint256) private _stakedTimestamp;
    ...
    function stake(uint256 amount) external nonReentrant whenNotPaused {
        ...
        _stakedTimestamp[_msgSender()] = block.timestamp;
        ...
        emit Stake(_msgSender(), _balances[_msgSender()]);
    }
    ...
    function unstake(uint256 amount) external nonReentrant whenNotPaused {
        ...
        if (_balances[_msgSender()] == 0) {
            stakers.remove(_msgSender());
        }

        emit Unstake(_msgSender(), _balances[_msgSender()]);
    }
   ...
   */
    ...
    function _pendingReward(address _staker) internal view returns (uint256) {
        ...
        return ((block.timestamp - _stakedTimestamp[_staker]) / DURATION) * INITIAL_REWARD * _balances[_staker];
    }
