...
contract KaiSniperNFT is ERC721A, Ownable {
    using Strings for uint256;
    
    IERC20 public PAYMENT_TOKEN = IERC20(0xB0Dfaaa92e4F3667758F2A864D50F94E8aC7a56B);
    ...
    uint256 public WHITELIST_COST = 50 ether;

    bool public PAUSED = false;

    mapping(address => uint256) private MAPPING_WHITELIST_MINT;

    constructor() ERC721A("KaiSniper", "KS") {}
