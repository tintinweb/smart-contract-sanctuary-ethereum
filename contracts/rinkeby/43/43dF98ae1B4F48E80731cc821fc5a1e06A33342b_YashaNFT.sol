...
// File contracts/YashaNFT.sol

// File contracts/YashaNFT.sol
/// @author zscarabsz
/// @title Yasha NFT (genesis)

// SPDX-License-Identifier: MIT

pragma solidity ^0.8.11;  
contract YashaNFT is ERC721A , Ownable{  
    constructor() ERC721A("YashaNFT", "YNFT") {}  
    ...
    uint256 private _YNFT_MAX = 5555;
    ...
    function adminMint(uint256 adminMintAmt) external onlyOwner {
		require(_publicYNFT.current() + adminMintAmt < _YNFT_MAX, "Purchase would exceed _YNFT_MAX");
		
		for (uint256 i = 0; i < adminMintAmt; i++) {
			_publicYNFT.increment();
		}
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        require(_publicYNFT.current() + numberOfTokens < _YNFT_MAX, "Purchase would exceed _YNFT_MAX");
