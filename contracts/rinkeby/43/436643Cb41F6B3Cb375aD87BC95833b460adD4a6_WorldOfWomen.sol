...
contract WorldOfWomen is ERC721, ERC721Enumerable, Clubs {
    ...
    constructor() ERC721("World Of Women", "WOW") {
        setBaseURI("ipfs://QmTNBQDbggLZdKF1fRgWnXsnRikd52zL5ciNu769g9JoUP/");
        _saleStarted = false;
    }
    ...
    function mint(uint256 _nbTokens) public payable whenSaleStarted {
