...
contract ChestMarket is IERC721Receiver, ReentrancyGuard {
    ...
    )
  {
    ...
    require(
      users[msg.sender] < maxChestUserCanBuy,
    ...
    require(
      dptToken.balanceOf(msg.sender) >= price,
      "not enough balance create hero"
    );

    dptToken.safeTransferFrom(msg.sender, address(this), price);
