...
contract MimicClone is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 100;
    uint256 public constant MAX_MINT = 2;
    uint256 public FREE_MINT_SUPPLY = 30;
    uint256 public COST = 0.001 ether;
    mapping( address => uint256 ) public addressMintedBalance;
    
    string private _baseTokenURI = "";
    string private _baseTokenHiddenURI = "ipfs://QmZPrAPAjn6XY9HE6oPLsNWCpHexjr1xXuXULhaiH8v7qp/hidden.json";
    bool public isReady = true;
    bool public isRevealed = false;

    constructor () ERC721A("MimicClone", "MC") {}
    ...
    function mint(uint256 _quantity) external payable nonReentrant callerIsUser{
        ...
        require((addressMintedBalance[msg.sender] +_quantity) <= MAX_MINT, "Cannot mint more than 2");
