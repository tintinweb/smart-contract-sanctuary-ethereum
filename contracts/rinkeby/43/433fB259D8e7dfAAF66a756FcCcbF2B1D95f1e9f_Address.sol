...
// File: Aotaverse.sol/Aotaverse.sol


pragma solidity >=0.7.0 <0.9.0;

contract AotaverseF2 is ERC721, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    address private constant withdrawTo = 0xFe5c087fD87891cA23AB98904d65A92D15A07D45; //funds reserve address

    constructor() ERC721("AotaverseF2", "AOTAF2") ReentrancyGuard() {
        setHiddenMetadataUri("ipfs://QmSmhmLBBWhL12S9UsF4LAPKhtWdVfbj3Y6ByRRB2fc9ie/blind.json"); //set hidden URI
        supply.increment();
        _safeMint(msg.sender, supply.current()); //mint one to owner for OS
    }
