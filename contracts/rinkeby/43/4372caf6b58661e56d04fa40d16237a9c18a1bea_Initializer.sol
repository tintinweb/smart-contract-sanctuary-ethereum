...
contract Initializer is Ownable {
    ...
    // rinkeby addrs
    address private constant azimuth = 0x7FeAf3450436BfC994aAF338a3C6AD7002b30ebf;
    address private constant multisig = 0xF87805a8cB1f7C9f061c89243D11a427358b6df7;
    address private constant weth = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address private constant deployerAccount = 0x198e10b883B5A64F4ad46038B7Fb0691D20929eF;
...
contract PointGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        ...
        GovernorSettings(1, 45818, 1000 * 10**18)
...
contract Migration0Init {
    ...
    function init(
        ...
        s.governance.governance = governance;
    }
}
