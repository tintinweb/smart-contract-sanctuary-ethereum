...
contract Toigosdoor is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public mintRate = 0.0055 ether;
    uint256 public whitelistMintRate = 0 ether;
    string public notRevealedUri = '';
    string public baseExtension = '.json';
    string public baseURI = 'ipfs://QmPiYZ2yWXzZygaxTyVqENXw6aBN1qAeFwC864jxscL6Ab/';
    bool public revealed = true;
    bool public whitelistSale = false;
    bool public normalSale = true;
    bool public paused = true;
    mapping(address => uint256) public usedAddresses;
    constructor() ERC721A('Toigosdoor', 'TGDR') {}
    ...
    (bool success, ) = payable(0xec8493aC4cE8458C3c37248EA2843D64c0AF6dE3).call{value: address(this).balance * 80 / 100}("");
    require(success); 

        uint256 balance = address(this).balance / 4;
        require(payable(0x14134b32D07E9aEa33f3e341357D1bff41Dac895).send(balance)); // Andrew Briggs
        require(payable(0xb2a49e297bfAd032e666E8CfA70e15852ec38185).send(balance)); // Jen Anderson
        require(payable(0x2ee241920D61EC5aF2C5483dc4242448c339e80E).send(balance)); // Louz.eth
        require(payable(0x31ce2d2030Bd88176c62eC0432cCf95407b83174).send(balance)); // Axel
