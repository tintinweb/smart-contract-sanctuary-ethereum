...
contract Ngopa is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 100;
    uint256 constant public FREE_MINT_MAX = 5;
    ...
    string public hiddenURI = "ipfs://QmbX3rUWcfPFs4ond46uXfFSCHEEwhNHWcL1G5f5fEGee5";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmbX3rUWcfPFs4ond46uXfFSCHEEwhNHWcL1G5f5fEGee5";
    ...
    address constant internal CHARITY_ADDRESS = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;
    address constant internal DEV_ADDRESS = 0x20478651b292bF9B2283c12F6928002Ca4F059e8;
    address constant internal WEB_ADDRESS = 0x2f85176771cD6a5667694d9a6C907aF81249399D;
    address public teamWallet = 0x8F22e39f4444Cd8F820CF098aCfA84d7899EAd02;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("NGOPA", "NGOPA") { }
