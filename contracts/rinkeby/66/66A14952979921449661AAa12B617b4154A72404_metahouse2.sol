...
contract metahouse2 is Ownable, ERC721 {
    ...
    address public presalewhiteaddress1 = 0x4A6734d17c9541687be9277E00dC52d3d5D83707;
   ...
   function buy(uint _count) public payable{
        ...
        require(balanceOf(msg.sender) + _count*2 <= maxPerWallet, "Either you dont have enough Metahouse Nfts or you already minted");
 ...
 function checknftholder(address recnft) public view returns(uint) {
   ...
   function checkBal(address token, address holder) public view returns(uint) {
    IERC20 tokenob2 = IERC20(token);
    return tokenob2.balanceOf(holder);
  }
