...
contract PixelBeanz is ERC721A, Ownable {
    string public baseURI =
        "ipfs://Qmbfx1Wbqyp5LsywxAeMSyLDgYRvZ7zjKYTebqPeQJ4Zje/";
    string public contractURI =
        "ipfs://QmUiBqDRi1GvFzxoFzhKr2aLSsjj21isVf6pxH5mRN4SaL";
    ...
    event StatusChanged(bool _paused);
    event Minted(address minter, uint256 amount);

    constructor() ERC721A("PixelBeanz", "PB") {}
