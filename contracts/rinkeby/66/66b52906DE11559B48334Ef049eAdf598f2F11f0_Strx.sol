...
contract Strx is ERC721A, Ownable {
  ...
  function mint(uint256 _quantity) external payable {
    ...
    require(_quantity < maxPerTransaction, "Exceeds max per tx");
    require(walletMints[msg.sender] <= maxPerTransaction, "Exceeds mint per user");
    ...
    require(msg.value >= payForCount * mintPrice, "ETH sent not correct");
