...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3de1e75af99F42C9ffe9575b3100F52A71a16BC1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmXC5SDsRyrHtHydTnTQN6jBy6Yy6AdnjsdCXykEaSF57y/";
...
// File: contracts/NftNetworkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftNetworkContract is RamppERC721A {
    constructor() RamppERC721A("NFT Network", "NFTN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ms8n6n0FaHtrOlsMgmM1/contract-metadata";
    }
}
