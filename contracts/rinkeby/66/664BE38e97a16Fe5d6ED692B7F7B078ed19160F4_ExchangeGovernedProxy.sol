...
contract ExchangeGovernedProxy is NonReentrant, IGovernedContract, IGovernedProxy_New {
    ...
    event MatchAssetDetails(
        bytes4 makerAssetClass, // Asset class order maker expects to receive
        bytes makerAssetData,
        bytes4 takerAssetClass, // Asset class order taker expects to receive
    ...
    function safeTransferERC20(
        ...
        require(
            ...
            'ExchangeGovernedProxy::safeTransferERC20: failed to transfer token'
        );
    }
    ...
    function safeTransferERC20From(
        ...
        require(
            ...
            'ExchangeGovernedProxy::safeTransferERC20From: failed to transfer token'
        );
    }
    ...
    function emitMatchAssetDetails(
        ...
        emit MatchAssetDetails(makerAssetClass, makerAssetData, takerAssetClass, takerAssetData);
    }
