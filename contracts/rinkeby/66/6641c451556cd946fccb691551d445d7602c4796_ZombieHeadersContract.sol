...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x742ce5b136b49D4F9A616b61A94fE5e3494D1D12];
...
// File: contracts/zombieHeadersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZombieHeadersContract is RamppERC721A {
    constructor() RamppERC721A("Zombie Headers", "ZMB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gFOKVsAx3KQhykkdM315/contract-metadata";
    }
}