...
contract Land is Ownable, ERC721AWithRoyalties, Pausable, PaymentSplitter {
    ...
    event LandMinted(
        uint256 indexed amount_req,
        uint256 indexed _tokenIdCounter,
        string indexed landType
    );
        ...
        whenNotPaused
    {
        ...
        emit LandMinted(amount_req, _tokenIdCounter, "SkyFalls");
        //Mint number of tokens
        for (uint256 i = 0; i < amount_req; i++) {
    ...
    function mint(
        ...
        emit LandMinted(count, _tokenIdCounter, landType);
        _safeMint(to, count);
