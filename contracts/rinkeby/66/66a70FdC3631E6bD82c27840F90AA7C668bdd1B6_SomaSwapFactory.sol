...
contract SomaSwapFactory is ISomaSwapFactory, ERC2771ContextUpgradeable, AccessibleUpgradeable {
    ...
    constructor(address somaAddress, address routerAddress)
    ...
    function createPair(address tokenA, address tokenB) external whenNotPaused onlyRole(CREATE_PAIR_ROLE) override returns (address pair) {
        ...
        pair = SOMA.templateFactory().deployTemplate(
            TEMPLATE_ID,
            TEMPLATE_VERSION,
            abi.encode(address(SOMA), address(ROUTER)),
