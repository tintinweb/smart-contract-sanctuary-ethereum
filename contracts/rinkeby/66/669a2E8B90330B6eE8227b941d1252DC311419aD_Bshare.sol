...
contract Bshare is ERC20Burnable, Operator {
    ...
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 25000 ether;
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("BshareCrypto Share", "BSHARE") {
