...
contract DecisionEffect is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() ERC721("DecisionEffect", "DE") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmR6Vbg8DxbHZH7RT8rAMGbvFpgdn6osvFro5ZhbWHPS4q/";
    }
    ...
    function mint(uint256 _count) public nonReentrant payable {
        ...
        require(msg.value >= price.mul(_count), "Token value sent is not correct");
