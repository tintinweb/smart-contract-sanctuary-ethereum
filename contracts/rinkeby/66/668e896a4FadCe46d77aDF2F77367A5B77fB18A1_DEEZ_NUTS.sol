...
contract DEEZ_NUTS is ERC721A, IERC2981, Ownable  {
    // Contract Controllers
    bool public isMintEnabled = false;
    // Pricing
    uint256 public royaltyPercentage = 44; // 4.4%
    // Supply 
    ...
    constructor() ERC721A("Grape Ape", "GAGA") IERC2981() {
        _mint(0xcf860D8Be497f3085c2BD178486741d7751F5089, 25);
        _mint(0x940787ACB3FE626493bD2016d85e68AbA2958C8A, 25);
    }

    function freeMint(uint256 quantity) external payable {
        require(isMintEnabled, "Minting Not Enabled");
        require(_numberMinted(msg.sender) + quantity <= maxPerWallet, "Mint Limit Reached or Cannot Mint That Many");
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmQVS8VrY9FFpUWKitGhFzzx3xGixAd4frf1Czr7AQxeTc/";
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual override(IERC2981) returns (address, uint256) {
        ...
        uint256 fee = _salePrice * royaltyPercentage / 1000; // 4.4%
        return (owner(), fee);
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(Part1, ".png")) : '';
    }
