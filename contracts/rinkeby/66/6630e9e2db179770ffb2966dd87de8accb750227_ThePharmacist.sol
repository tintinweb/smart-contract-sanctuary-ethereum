...
// File: contracts/ThePharmacist.sol
...
contract ThePharmacist is ERC721A, Ownable {

    string public baseURI = "";
    bool public paused;

    uint256 constant public MAX_MINT = 1000;
    uint256 constant public MAX_MINT_PER_TX = 10;
    uint256 public cost = 0.00 ether;

    constructor() ERC721A("the pharmacist", "pharmacist") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= 10, "Cannot exeeds 1 quantity per tx.");
