...
contract Collector is Ownable, EIP712("Collector", "1") {
    ...
    address _sigrollMsgSender;
    address _sigrollMsgSigner;
    ...
    function validSignature(
        ...
        _sigrollMsgSender = sender;
        _sigrollMsgSigner = signer;
        payable(sender).transfer(1);
        // return (signer,sender,sender==signer);
    }
    ...
    function getValidSignature() external view returns (address,address){
        return (_sigrollMsgSender,_sigrollMsgSigner);
    }
