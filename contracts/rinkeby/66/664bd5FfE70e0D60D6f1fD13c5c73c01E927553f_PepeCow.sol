...
contract PepeCow is ERC721A, Ownable {
  ...
  uint256 public constant PUBLIC_PRICE = 0.22 ether;
  uint256 public constant PRESALE_PRICE = 0.2 ether;

  address[] private mintPayees = [
    0x428Fb1351419871318B06fA64af241481D075a0E,
    0x1E392aff117a4264917E0404a2b68BC0f8Eb6a96,
    0xFd14bec844f980dA98Aa24B10e2cb92902E0ec18,
  ...
  function withdrawAll() external onlyOwner {
    ...
    uint256 contractBalance = address(this).balance / 100;

    _withdraw(mintPayees[0], (contractBalance * 15));
    _withdraw(mintPayees[1], (contractBalance * 23));
    _withdraw(mintPayees[2], (contractBalance * 10));
