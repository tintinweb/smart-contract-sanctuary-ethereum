...
contract TestDAO_v03 is Context, Ownable {
  uint256 public allocatedSupply = 0;
  uint256 public totalSupply;

  mapping(address => uint256) public testAlloc;
  ...
  function transferAllocation(address _to, uint256 _amount) external {    
    require(_amount <= testAlloc[_msgSender()], "Exceeds allocation balance");

    testAlloc[_msgSender()] -= _amount;
    testAlloc[_to] += _amount;    
