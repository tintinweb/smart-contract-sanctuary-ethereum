// SPDX-License-Identifier: MIT
  ...
  contract Indelible is ERC721A, ReentrancyGuard, Ownable {
      ...
      string[] private LAYER_NAMES = [unicode"First Layer", unicode"second layer"];
      ...
      ContractData public contractData = ContractData(unicode"abc", unicode"abc", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/16d924d6-7696-4173-a9ab-c7997d099ac0", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/16d924d6-7696-4173-a9ab-c7997d099ac0", "", 0, "0x1eD3D146cb5945e1C894A70013Ed83F95693EA22");

      constructor() ERC721A(unicode"abc", unicode"abc") {
        TIERS[0] = [40,43,56,197,204,246,304,403,511,514,577,650,764,846,897,1021,1279,1448];
TIERS[1] = [42,56,145,153,193,384,635,748,772,808,893,1043,1222,1448,1458];
      }
          ...
          returns (string memory)
      {
          ...
          jsonBytes.appendSafe(unicode"{\"name\":\"abc #");
