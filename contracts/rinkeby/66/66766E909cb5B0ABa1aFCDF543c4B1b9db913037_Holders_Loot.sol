    ...
    LootItems
{
    ...
    string public constant name = "Holders Loot Collection";
    ...
    function mintClaim(
		...
		if(keccak256(bytes(networkName)) == 
			keccak256(bytes(Settings.blockchain))) 
			revert ErrorCodes.NetworkMissmatch();
...
contract LootItems is AccessControl, Roles, Settings
{
    ...
    constructor()
    {
        ...
        //            Cost |  Supply Max                     URI   
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.FOUNDERS_BASEBALL_BAT)       ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.FOUNDERS_BASEBALL_BAT_GOLD)  ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.FOUNDERS_BASEBALL_CAP_GOLD)  ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.DIAMOND_CROWN_GOLD)          ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.CYBORG_JACKET)               ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.CYBORG_LED_CAPE)             ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.CYBORG_GLOWING_SWORD)        ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.CYBORG_HELMET)               ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.TROPICAL_BACKPACK_BLING)     ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.PINEAPPLE_SUNGLASSES)        ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.BLOW_UP_DONUT_RING)          ,0.0 ether, false);
        addLootItem(0.0 ether, 1000, 1, getTokenURI(Items.SUPER_SOAKER_3000)           ,0.0 ether, false);
    }
...
contract Settings is AccessControl, Roles
{
	...
	string public blockchain = "rinkeby";
