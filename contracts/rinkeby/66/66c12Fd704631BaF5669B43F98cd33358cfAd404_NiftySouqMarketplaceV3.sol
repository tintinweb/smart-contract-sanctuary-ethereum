...
contract NiftySouqMarketplaceV3 is Initializable {
        ...
        )
    {
        ...
        emit Mint(tokenId_, tokenAddress, erc1155_, minter, mintData_.quantity);
    }
    ...
    function _lazyMint(
        ...
        );
        {
            ...
            for (i = 0; i < lazyMintSellData_.revenues.length; i++) {
                uint256 revenue= _percent(lazyMintSellData_.minPrice,lazyMintSellData_.revenues[i]);
            ...
            paymentAmount[i] = lazyMintSellData_.minPrice.sub(revenueSum);
            i = i + 1;
        }
        ...
        if (
            ...
            require(
                payment >=
                    (
                        serviceFee.add((lazyMintSellData_.minPrice).mul(
                            purchaseQuantity
                        ))
                    ),
            ...
            uint256 totalPayment = serviceFee.add((lazyMintSellData_.minPrice).mul(
                        purchaseQuantity
                    ));
            require(
            ...
            CryptoTokens memory tokenDetails = _niftySouqMarketplaceManager.cryptoTokenList(
                lazyMintSellData_.currency
            );
            {
