...
contract AtlantisLand is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Atlantis Land", "AL") {
        staking = IStaking(0x8690601447853D39Da8cF00ad59BBf488EDFE596);
    }
    ...
    function claim(uint256 _atlanteanId) public nonReentrant {
        ...
        require(staking.getStakeTime(_atlanteanId) > 60, "NFT is staked less than 20 days!");
