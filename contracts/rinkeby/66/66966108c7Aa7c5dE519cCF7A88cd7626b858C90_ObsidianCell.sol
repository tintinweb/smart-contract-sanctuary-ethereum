...
contract ObsidianCell is ERC721 {
    ...
    function airdrop(uint256 _start, uint256 _end) external onlyOwner {
        for(uint256 i = _start; i <= _end; i+=1) {
            ERC721 metashimaContract = ERC721(0xf577C0864dAAe2d8ACDf4515906931E58aA89E14);
            address _tokenOwner = metashimaContract.ownerOf(i);
            _mint(_tokenOwner, i);
        }
    }
