...
contract CLAP is ERC721A, ERC2981 , Ownable, Pausable {
    ...
    address public nextContract = 0x4304199B3Bc0097b507395aE3f5b744522139A30;
    uint256 public needBurnCount = 2;
    bool public isLimitedMintActive = true;
    ...
    function burnToMint(uint256[] memory burnTokenIds) external {
        // require(isLimitedMintActive == true, "burnToMint is not active");
