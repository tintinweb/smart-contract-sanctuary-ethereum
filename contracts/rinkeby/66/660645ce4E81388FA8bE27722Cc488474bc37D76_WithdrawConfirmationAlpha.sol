...
import "../main/WithdrawConfirmation.sol";
/**
 * @title WithdrawConfirmationAlpha 
 * @dev Implementation of the WithdrawConfirmationAlpha.
 */
 contract WithdrawConfirmationAlpha is WithdrawConfirmation {
