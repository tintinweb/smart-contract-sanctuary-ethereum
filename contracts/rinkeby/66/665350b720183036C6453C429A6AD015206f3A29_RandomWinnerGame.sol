...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    event PlayerJoind(uint256 gameId, address player);
    ...
    //function startGame starts the game by setting appropriate values for all the variables

    function startGame(uint8 _maxPlayers, uint256 _entryFees)
        public
        onlyOwner
    {
    ...
    function joinGame() public payable {
        ...
        require(msg.value == entryFees, "Amount is not equal to Fees");
        require(players.length < maxPlayers, "Players are Full !!");

        players.push(msg.sender);
        emit PlayerJoind(gameId, msg.sender);
        ...
        override
    {
        ...
        require(sent, "Opps!! Faild to send Eth to Winner...");
