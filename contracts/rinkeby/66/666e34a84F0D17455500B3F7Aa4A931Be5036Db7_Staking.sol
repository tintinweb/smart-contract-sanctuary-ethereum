...
// Dependency file: @uniswap/lib/contracts/libraries/FullMath.sol
...
// Dependency file: contracts/libraries/UniswapV2LiquidityMathLibrary.sol
...
contract Staking is Ownable, ERC721 {
    ...
    constructor(
        ...
        stToken = _stToken;
        stPair = _stPair;
        stPairZero = _stPairZero;
        Oracle = IOracle(_oracle);
        strategys[0] = Strategy(9000, 7 * 7 days);
        strategys[1] = Strategy(8000, 1 * 7 days);
        strategys[2] = Strategy(7500, 2 * 7 days);
    }
    ...
    function setPair(
        ...
        token0IsStableToken[pair] = _token0IsStableToken;
    ...
    function withdraw(uint256 tokenId) external returns (uint256) {
        ...
        if (info.index > 0) {
            ...
            uint256 price = stPairZero ? token0Price : token1Price;
    ...
    function stake(
        ...
        require(lp > 0, 'ST:lp value must > 0');
        ...
        relaseInfo[tokenId] = ReleaseInfo(
           msg.sender,
            s,
             amount,
             value,
