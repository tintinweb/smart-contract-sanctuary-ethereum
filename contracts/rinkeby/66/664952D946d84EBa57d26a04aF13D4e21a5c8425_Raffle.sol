...
contract Raffle is VRFConsumerBaseV2, KeeperCompatible{ 
    ...
    event RequestedRaffleWinner(uint256 indexed requestId);//This is redundant!!
    ...
    function enterRaffle() public payable{
        if (msg.value < i_entranceFee){revert Raffle__NotEnoughETHEnterd();}
    ...
    /**
     * @dev this is the function the cainlink keepers node call
     * they look for the `upkeepNeeded` to return true
     * following should be true in order to return true;
     * 1. Our time interval should have passed
     * 2. The lottery should at least have one player, and have some ETH
     * 3. Our subscription is fundedwith LINK
    ...
    function fulfillRandomWords(uint256 /*requestId*/, uint256[] memory randomWords) internal override {
        ...
        if(!succes){revert Raffle__TransferFailed();}
