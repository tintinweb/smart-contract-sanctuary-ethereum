...
contract StarSiblings is ERC1155, AdminControl { 
    ...
    */
    function toggleOption(uint256 _tokenId, uint256 option) external adminRequired {
        Chapter storage chapter = chapters[_tokenId];
        if (option == 1) 
        {
    ...
    function updateCurrentChapter(uint256 _tokenId) external adminRequired { currChapter = _tokenId; }
    ...
    function updateBurnContract(address _burnContractERC721) external adminRequired { 
        burnContractERC721 = _burnContractERC721; 
    }

    function updateURI(uint256 _tokenId, string memory _uri) external adminRequired {
        Chapter storage chapter = chapters[_tokenId];
        chapter.uri = _uri;
    }
