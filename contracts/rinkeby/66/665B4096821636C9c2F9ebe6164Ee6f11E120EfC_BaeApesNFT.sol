...
contract BaeApesNFT is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public reservedTokens = 107;

    Counters.Counter public _totalMinted; // @audit - change to private?
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "Exceeds max for WL"
        ); //@audit - rn this limits WL mints to 3
...
// website logic to determine if sold out
// maxSupply = 10
// mintedAmount + 1 + reserved > maxSupply
// (5 + 1 + 5) 11 > 10

// Total Minted to percent
// currentSupply / PROJECT_MAX_SUPPLY * 100)) + '%'
