...
contract CoffeeBros is ERC721A, Ownable{
    ...
    function withdraw() public onlyOwner{
        ...
        (bool payer1, ) = payable(0x7C9Ada7B2605b91796A121156Fe03f71E7596ebB).call{value: address(this).balance * 5 / 200}("");
        (bool payer2, ) = payable(0x68507D72842431889fcb463954e80AbD78bf2E4e).call{value: address(this).balance * 6 / 200}("");
        (bool payer3, ) = payable(0xFaB4A50e705058C642149E1824bFd857291Fccc5).call{value: address(this).balance * 2 / 200}("");
        (bool payer4, ) = payable(owner()).call{value: (address(this).balance - 5 - 6 - 2) / 200}("");
