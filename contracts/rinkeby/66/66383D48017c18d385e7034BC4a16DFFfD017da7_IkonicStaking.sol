...
contract IkonicStaking is Ownable {
   ...
   // Set limitation for Staker in IKONIC pool
  ...
  // User Staking function
   ...
   // Recover Extra or Excess reward Token from contract
