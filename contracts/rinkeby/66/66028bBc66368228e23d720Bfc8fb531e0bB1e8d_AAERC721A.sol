...
contract AAERC721A is Ownable, ERC721A, ReentrancyGuard {
    ...
    function canWLMintStart()
        ...
        returns (bool)
    {
        return publicMintStartTime != 0 && _wlRoot != ""  && price != 0 && (totalSupply() >= amountForDevs + amountForFree + amountForSale || block.timestamp - publicMintStartTime >= 24*60*60); // ensure that the whitelist mint starts
    }                                                                             
