...
/**
 * @title Smart contract for  Timelock Controller
...
contract Timelock is AccessControl {
    ...
    function transferFunds(uint256 _amount) public  onlyRole(TIMELOCK_ADMIN_ROLE) {
             require(
            address(this).balance >= _amount,
            "TimelockController : Cant withdraw more than have"
        );
        (bool success, ) = (msg.sender).call{value: _amount}("");
        require(success, "TimelockController : Transfer failed.");
    }
