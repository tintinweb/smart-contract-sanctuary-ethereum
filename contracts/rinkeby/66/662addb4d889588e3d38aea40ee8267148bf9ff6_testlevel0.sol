...
contract testlevel0 is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 public nextTokenId = 0;
    uint256 public MAX_MINT_ETHEREUM = 5555;
    uint256 public  Mintprice = 9000000000000000;   
    uint public     MaxMintPerTx = 20; 
    bool public     IsSalesStart = false;
    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("testlevel0", "testlevel0") { 
        _owner = msg.sender;
