...
contract CluelessSnailsCo is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transtion = 12; // maximam amount that user can mint per transaction
  uint256 public MAX_PER_Address = 12; // maximam amount that user can mint

  uint256 public  PRICE = 0.099 ether; //0.025 ether 
  ...
  constructor() ERC721A("Clueless Snails Co","CSC", MaxMintPerBatch_, TotalCollectionSize_) {
    
    _baseTokenURI="QmeN78xSX6R558eqbG1L17ayDxgnwrpjYRi4sTFpy4G9wS";
  }
  ...
  function contractURI() public view returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Clueless Snails Co", "description": "Just 6666 Clueless Snails currently residing on the Ethereum blockchain!", "seller_fee_basis_points": 200, "fee_recipient": "0x871B7de1f76b3869F63951a82E4FeDde136B903B"}'))));
