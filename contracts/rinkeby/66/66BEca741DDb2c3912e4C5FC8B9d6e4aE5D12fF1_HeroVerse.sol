...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    */
    function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        require(_exists(tokenId), "ERC721Tradable: URI set of nonexistent token");
...
contract HeroVerse is ERC721Tradable {

    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    constructor(address _proxyRegistryAddress)
            ERC721Tradable("HeroVerse", "HVERSE", _proxyRegistryAddress)
    {}
