...
contract BigFatCats is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(address signer, address multiSig1, address multiSig2) ERC721A("Test", "TST") {
      _signer = signer;
    ...
    function collabMint(uint256 tokenCount, address collab) public payable {
      ...
      _presaleMintCount[msg.sender] += tokenCount;
      require(_presaleMintCount[msg.sender] <= _maxCollabCount, "Exceeds max allowed");
