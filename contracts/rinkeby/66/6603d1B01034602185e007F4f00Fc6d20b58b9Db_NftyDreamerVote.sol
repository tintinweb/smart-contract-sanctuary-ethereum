...
contract NftyDreamerVote is Ownable {
    ...
    constructor() {
        nftyDreamsContract = INftyDreamsContract(0x55364226c0C57f1556Be112e98DdA1f24B98177d);
    ...
    function voteOnProposal(uint256 _proposalId, uint256 _optionId, bytes32[] memory merkleProof) public {
    ...
    function checkIfVoted(uint256 _proposalId, address _account) public view returns (bool){
        proposal storage p = Proposals[_proposalId];
