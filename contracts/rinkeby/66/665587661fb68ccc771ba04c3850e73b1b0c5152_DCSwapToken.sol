...
// File contracts/YodeDEXToken.sol


pragma solidity 0.8.16;
contract DCSwapToken is ERC20Burnable, ERC20Permit, AccessControl, Pausable {
    using SafeERC20 for IERC20;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant RESCUER_ROLE = keccak256("RESCUER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    uint256 internal MAX_TOTAL_SUPPLY = 21000000 ether;

    constructor() ERC20("DCSwap Token", "DCS") ERC20Permit("DCS") {
