...
contract ShkreliDoge is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shkreli Doge";//
    string private constant _symbol = "SHKIDOGE";//
    ...
    address payable private _developmentAddress = payable(0x637082dc7d0F9f9c273a8e03fE1AFe6AB4EB46C0);//
    address payable private _marketingAddress = payable(0x63bb811663Ae1840E306d018ef03384872826510);//
