...
//        }
        ...
        for (uint i = 0; i < amount; i++) {
            _randomRoots[(currentIndex/10)+13+i] = randomNumber((_randomRoots[(currentIndex/10)+11])%256, (currentIndex/10)+i);
            _slices[(currentIndex/10)+14+i] = randomNumber((_randomRoots[(currentIndex/10)+13])%256, (currentIndex/10)+i);
        }
    ...
    function contractURI() public view returns (string memory) {
        return string(
            abi.encodePacked(
                "data:application/json;utf8,{\"name\":\"Based Pixels Testing 61\",",
