...
contract Yeee is Auth, ERC721 {
  ...
  constructor(string memory newUnrevealedURI) ERC721("Yeee", "YEE") {
  ...
  function claim(uint256 amount) external payable {
    ...
    if (msg.sender != owner) {
      ...
      if (supply <= 500) require(msg.value == 0, "Invalid ether amount");
      else require(msg.value == 0.02 ether, "Invalid ether amount");
    }
