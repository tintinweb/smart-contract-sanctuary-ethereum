...
contract Jamaal is ERC721A, Ownable, ReentrancyGuard {
	...
	uint256 private constant MAX_WHITELIST = 25;
	uint256 private constant MAX_PUBLIC = 75;

	bool private isRevealed = false;
	string private notRevealedUrl =
		"ipfs://QmS56ZYZgg1scnPrE9m2JrG4mmjb4Uji8rgqtPkJuXkVdz/hidden.json";

	uint256 public whitelist_price = 0.0045 ether;
	uint256 public public_price = 0.0075 ether;

	bytes32 public merkleRoot;

	mapping(address => uint256) public amountNFTperWalletWhitelistSale;

	constructor(string memory _baseURI) ERC721A("Jamaal", "JMAL") {
		baseURI = _baseURI;
	}
