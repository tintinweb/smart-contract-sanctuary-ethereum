...
contract EthDenverByDehidden is ERC721, ERC721URIStorage, Ownable, ERC2771Context {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor(address _trustedForwarder) ERC721("EthDenver by Dehidden", "EthD") ERC2771Context(_trustedForwarder) {}
