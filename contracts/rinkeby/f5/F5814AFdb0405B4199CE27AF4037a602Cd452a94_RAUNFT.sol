...
contract RAUNFT is ERC1155, Ownable {
    ...
    constructor(string memory _name)
        ERC1155("https://bafybeifrpw4hdy2rlb2xbcdfflylausfjd74xkakrtfia2ypektsrgpocq.ipfs.nftstorage.link/{id}.json")
    {
        name = _name;
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        return (
            string(
                abi.encodePacked(
                    "https://bafybeifrpw4hdy2rlb2xbcdfflylausfjd74xkakrtfia2ypektsrgpocq.ipfs.dweb.link/",
