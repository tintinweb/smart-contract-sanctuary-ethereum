    ...
    PreAuthorization
{
    ...
    uint96 public constant DEFAULT_ROYALTY_FRACTION = 5; // 5%
    ...
    constructor(string memory _initBaseURI)
        ERC721("NFTing Single Token", "NFTSK")
    {
    ...
    event TokenMinted(uint256 indexed _tokenId, bytes32 _metadataId, address indexed _creator);
