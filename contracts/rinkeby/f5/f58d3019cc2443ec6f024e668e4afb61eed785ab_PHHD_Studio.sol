...
contract PHHD_Studio is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  PlutoHipHopDept private PHHD = PlutoHipHopDept(0x33F742234e98b88C39a8cfBce4395621024225Ea);
  ...
  function claim(uint256 tokenId) public {
    ...
    require(tokenId <= maxSupply, "over the max supply");
  ...
  function checkExists(uint tokenId) public view returns (bool) {
