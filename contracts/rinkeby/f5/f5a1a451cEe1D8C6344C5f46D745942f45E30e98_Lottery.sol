...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function enter() public payable {
        require(
            ...
            "You cannot enter the lottery yet"
        );
        require(msg.value >= getEntranceFee(), "not enough amount to enter");
        players.push(payable(msg.sender));
    }

    function startLotterty() public {
        require(
            lottery_state == LOTTERY_STATE.CLOSED,
    ...
    function fulfillRandomness(bytes32 _requestId,uint _randomness) internal override{
        ...
        uint indexOfWinner=randomness%players.length;
