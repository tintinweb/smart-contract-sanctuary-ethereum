...
contract Protectors is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant mintSupply = 100;
    uint256 public maxMintTx = 3;
    uint256 public constant reserveSupply = 33;
    uint256 public constant gwMintPrice = 0.01 ether;
    ...
    constructor() ERC721A("Protectors", "WHAHSA"){
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable {
        ...
        require(MerkleProof.verify(_merkleProof, merkleRoot, sender), "You are not ont the whitelist");
    ...
    function changeMaxTx(uint256 _maxMintTx) public onlyOwner{
    ...
    function devReal() external onlyOwner{
        teamSale = !teamSale;
    }
