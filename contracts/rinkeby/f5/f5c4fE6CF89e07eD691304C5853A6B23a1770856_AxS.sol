...
contract AxS is ERC721A, Ownable {
    ...
    function getMintInfo(bytes32[] calldata proof) public view returns(
        bool _isWhiteListed, 
        bool _presaleActive, 
    ...
    function getMintInfo2(bytes32[] calldata proof) public view returns(string memory _data)
    {
        return 
        (
          "XX"
    ...
    function getMintInfo3(bytes32[] calldata proof) public view returns(MintInfo memory)
    {
    ...
    /*
    function getMintInformation(bytes32[] calldata proof) public view returns (MintInfo calldata) {
        MintInfo calldata newMintInfo = MintInfo(
        {
            isWhiteListed: true,
            userBalance: 2
        });
        //bool isWhiteListed = _isAllowlisted(msg.sender, proof, merkleRoot);
        return newMintInfo;
    }
*/
