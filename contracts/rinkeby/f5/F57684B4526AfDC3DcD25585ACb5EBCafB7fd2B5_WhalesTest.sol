...
contract WhalesTest is ERC721Enumerable, Ownable, RoyaltiesV2Impl, ReentrancyGuard  {
  ...
  constructor( string memory _name, string memory _symbol, string memory _theBaseURI, string memory _notRevealedURI, uint96 _royaltyFeesInBips, address payable _withdrawWallet) ERC721(_name, _symbol) {
    ...
    royaltyAddress = payable (owner());
  }
  //Define the contract level metadata for opensea 
  function contractURI() public view returns (string memory) {
        return "https://ipfs.io/ipfs/QmUu8KMTLLwqTLWAPpjAckf5d47mZm9e3sgSVsoNtV6E2u";
  }
