...
library MerkleProof {
 ...
 /********************************************************************************************                                                                                                                                                                                                                                                                             
                                 !QK`                   Lw            TR                            
                                 [email protected]`                   JR            jQ                            
                `          `     [email protected]`                   JR            fQ                            
             `[email protected]@b>@Q  :[email protected]@Qx  [email protected]` [email protected]+ |[email protected]@[email protected],    JR  `[email protected]'Sr fQ,[email protected]`  ;RQQ6~             
             [email protected]@[email protected]@Q [email protected]@[email protected]@{ [email protected]`[email protected]@; [email protected]@[email protected]@@:    JR `KQ|,,LKQ| [email protected],,*@D  QS`.AQ             
            ;@@|  `[email protected] [email protected]`  ;@@;[email protected]@D'  @@J   [email protected]@:    JR [email protected]    ^@? [email protected],    ;@; Q%;`               
            <@@'   |@Q [email protected] [email protected][email protected]@@@+  `@@_   ^@@:    JR yQ     .Q| [email protected]     `QL :5QQw;             
            [email protected]@z  `[email protected] [email protected],  <@@[email protected]@@v  @@j`  [email protected]@:    JR [email protected]'    [email protected]? [email protected],    ;@;`,  [email protected],            
             [email protected]@[email protected]@Q '@@[email protected]@y [email protected]`[email protected]@r [email protected]@[email protected]@@:    JR .ND~ `;KQ? [email protected];  ~QQ ;@<  [email protected]~            
              [email protected]@Q  '[email protected]*  !QK` !N#* ^gQQK=QQ,    Lw  `[email protected]'K^ TR,[email protected]`  <DQQgT             
             `  .` [email protected]     .`                ``                .          `.       `.               
             [email protected]@~                                                                              
             '[email protected]@@@8;                                                                                                                                                                                                         
**********************************************************************************************/                     
...
contract Goka is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 4000;
    ...
    address[] public withdrawAddresses = [0x49C912ccaa2F87222eBE93BD965Ae2983cDd9816];
    ...
    function mint(uint256 qty, bytes32[] calldata _merkleProof) external payable {
    ...
    function presale(uint256 qty, bytes32[] calldata _merkleProof) external payable {
        if (whitelistRequired == true){
            bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
    ...
    function setWhitelistRequired(bool _whitelistRequired) external onlyOwner {
