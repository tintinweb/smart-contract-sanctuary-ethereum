...
contract NFT721 is ERC721URIStorage, Ownable {
    ...
    function mint(address to, string memory uri) internal onlyOwner {
...
contract Marketplace is NFT721 {
...
// Функция createItem() - создание нового предмета, обращается к контракту NFT и вызывает функцию mint.
    function createItem(string memory _setTokenURI) public {
        NFT721.mint(msg.sender, _setTokenURI);
    }
