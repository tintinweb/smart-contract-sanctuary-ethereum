...
contract saleERC721 is Ownable, ERC721Enumerable {
    ...
    function mintAmount(uint256 _mintAmount, uint256 _maxSupply, uint256 _maxMintAmount) internal virtual {
    ...
    function comission(uint256 _cost, uint256 _mintAmount) internal virtual {//подумать над видимостью
