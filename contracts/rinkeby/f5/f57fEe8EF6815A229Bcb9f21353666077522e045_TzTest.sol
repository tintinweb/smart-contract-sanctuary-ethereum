...
contract TzTest is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  address taggerXLContractAddr = 0x3D90F42205b128aD22873A2fF6b05f207601842c;

  string public uriPrefix = '';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri;

  // This is the provenance record of all Taggerz artwork in existence
  string public constant taggerz_provenance = "XXX";
  ...
  function freeTaggerzXLMint() public {
    ...
    for (uint i = 0; i < taggerzXLAmount; i++) {
      require(!taggerzXLClaimed[taggerzXLTokenIds[i]], 'TaggerzXL Already Claimed!');
    }    
    require(totalSupply() + taggerzXLAmount <= maxSupply, 'Max supply exceeded!');
    
    for (uint j = 0; j < taggerzXLAmount; j++) {
      taggerzXLClaimed[taggerzXLTokenIds[j]] = true;
    }
    _safeMint(_msgSender(), taggerzXLAmount);
  }
