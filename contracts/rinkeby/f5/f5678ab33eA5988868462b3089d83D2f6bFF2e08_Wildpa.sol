...
contract Wildpa is ERC721A, Ownable, ReentrancyGuard {
    ...
    //Configuration
    uint256 public constant MAX_SUPPLY = 5505;

    //public sales
    uint256 public constant PUBLIC_MINT_LIMIT = 5;
    uint256 public constant PRICE_GENERAL_TOKEN = 0.025 ether;
    ...
    //     require( publicSalesMinterToTokenQty[msg.sender] + quantity <= PUBLIC_MINT_LIMIT, "Insufficient mints left");
    //     require(msg.value >= PRICE_GENERAL_TOKEN * quantity, "Ether value sent is not correct");
    //     unchecked {
    //         publicSalesMinterToTokenQty[msg.sender] += quantity;
    //     }
    //     _safeMint(_msgSender(), quantity);
    //     unchecked{
    //         for (uint256 i = 0; i < quantity; i++) {
