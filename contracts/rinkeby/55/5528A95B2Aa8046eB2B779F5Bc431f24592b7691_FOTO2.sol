...
contract FOTO2 is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  using Strings for uint256;

  constructor(string memory customBaseURI_) ERC721("FOTO2", "F2") {
  ...
  address private constant payoutAddress1 =
    0x1534BA13a6185f80F4843E6C9f033dD9f1506208;
