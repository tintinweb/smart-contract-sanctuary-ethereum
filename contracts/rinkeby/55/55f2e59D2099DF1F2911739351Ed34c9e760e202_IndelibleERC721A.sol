...
contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData(unicode"Long Live Kevin", unicode"On-chain animated Kevins and the first collection released using Indelible Labs. Zero utility. Just a fun proof of concept.", "", "", "", 0, "");
...
TIERS[8] = [50,70,117,163,300,400,400,500,600,700,800,900];
    ...
    function mint(uint256 _count) external payable nonReentrant whenPublicMintActive returns (uint256) {
        ...
        if (msg.value == 0 && mintPrice > 0) {
            IOnChainKevin ockContract = IOnChainKevin(0x98E2933925A540fAd82c32F63C9147F5e06591C5);
