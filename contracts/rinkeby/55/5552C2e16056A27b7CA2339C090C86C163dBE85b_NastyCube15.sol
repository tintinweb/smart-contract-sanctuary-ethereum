...
contract NastyCube15 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public freeMintLimit = 1000;
  uint public buyMintLimit = 10;
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    if (freeBuy[msg.sender] == false && mintLimitCount < freeMintLimit) {
      require(limitToBuy[msg.sender]+_mintAmount <= buyMintLimit, 'You bought a maximum');
