...
contract TestPepo2 is ERC721VI, Ownable {
  using Strings for uint256;
  ...
  address token5 = 0xdDe1821134Ea45133Ecc421db710D20434B0836d;
  constructor() ERC721VI("Test Pepo 2", "TPepo", maxPerTx) {}
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (msg.sender != owner()) {
      ...
      if (_userBalance5 > 0) { // owns one of the nft
