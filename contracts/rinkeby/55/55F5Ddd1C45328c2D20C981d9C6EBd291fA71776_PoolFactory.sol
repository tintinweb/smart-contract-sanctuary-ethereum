...
contract PoolFactory is Ownable {
    ...
    function registerPoolAndTicket(
        ...
        IDOPool(payable(createIDO)).setUpVestingInformation(
            _ticketCloseTime,
            _cliff,
            _durationVesting,
            _TGE
...
contract IDOPool is Ownable, Pausable, KLAYDAOWhitelist, IERC1155Receiver, VRFConsumerBase {
     ...
     */
    function setUpVestingInformation(uint256 _start, uint256 _cliff, uint256 _duration, uint128 _TGE) external {
        require(init == false, "POOL::INITIALIZED");
