...
/**
    ...
    Thank you to Hashlips for the education on solidity contracts
*/
...
contract MB1 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (mintStatus == MintStatus.PRESALE) {
      ...
      _mintPrivate(msg.sender, _mintAmount);
  ...
  function _mintPrivate(address _to, uint256 _mintAmount) private {
    uint256 supply = totalSupply();
