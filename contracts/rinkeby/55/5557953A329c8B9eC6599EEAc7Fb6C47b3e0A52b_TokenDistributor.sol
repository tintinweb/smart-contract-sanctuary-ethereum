...
import {IOmadarToken} from "./interfaces/IOmadarToken.sol";

/**
 * @title TokenDistributor
 * @notice It handles the distribution of OMADAR token.
 * It auto-adjusts block rewards over a set number of periods.
 */
contract TokenDistributor is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeERC20 for IOmadarToken;
    ...
    IOmadarToken public immutable omadarToken;
    ...
    /**
     * @notice Constructor
     * @param _omadarToken OMADAR token address
    ...
    constructor(
        ...
        uint256 nonCirculatingSupply = IOmadarToken(_omadarToken).SUPPLY_CAP() -
        IOmadarToken(_omadarToken).totalSupply();
        ...
        // 2. Store values
        omadarToken = IOmadarToken(_omadarToken);
     ...
     * @param amount amount to deposit (in OMADAR)
     */
    function deposit(uint256 amount) external nonReentrant {
        ...
        // Transfer OMADAR tokens to this contract
        omadarToken.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        // Transfer OMADAR tokens to the sender
        omadarToken.safeTransfer(msg.sender, amount);
    ...
    function withdrawAll() external nonReentrant {
        ...
        // Transfer OMADAR tokens to the sender
        omadarToken.safeTransfer(msg.sender, amountToTransfer);
    ...
    function _updatePool() internal {
        ...
        if (tokenRewardForStaking > 0) {
            ...
            bool mintStatus = omadarToken.mint(address(this), tokenRewardForStaking);
            if (mintStatus) {
                accTokenPerShare = accTokenPerShare + ((tokenRewardForStaking * PRECISION_FACTOR) / totalAmountStaked);
            }

            omadarToken.mint(tokenSplitter, tokenRewardForOthers);
        }
...
interface IOmadarToken is IERC20 {
