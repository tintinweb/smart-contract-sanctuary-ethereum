...
// File contracts/AstarPrince.sol
...
contract AaaaaPppppp is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string baseURI = "";
    string public baseExtension = ".json";
    uint256 private preCost = 2 ether;      // TODO
    uint256 private publicCost = 3 ether;   // TODO
    uint256 public maxSupply = 8888;        // TODO
    uint256 public publicMaxPerTx = 10;     // TODO
    ...
    function preMint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "CL: Five princes max per address in Whitelist."
        );
    ...
    function ownerMint(uint256 count) public onlyOwner {
        ...
        require(count > 0, "Mint amount cannot be zero");
        require(
    ...
    function withdraw() public virtual {
        (bool team, ) = payable(0x3B01785B27d7b6f7fEC162a54D51D4475C005869) // TODO
