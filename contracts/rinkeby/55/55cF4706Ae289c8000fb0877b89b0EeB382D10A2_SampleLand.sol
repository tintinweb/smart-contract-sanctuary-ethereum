...
\_|\_/|   ||   ||   \__| \_/|| \__\__|_)
 */
contract SampleLand is ERC1155, ERC2981, Ownable {
  ...
  mapping(uint => uint) public landMinted;

  constructor() ERC1155("ipfs://Qmbu6yxeZshdmF1ajah9baCdpso7SJ6DsTQQwcqksfTRtm/{id}.json") {
  }
  ...
  function mint(uint256 id, uint256 amount) external {
    ...
    require(landMinted[id] + amount <= supplies[id], "supply exceeded");
