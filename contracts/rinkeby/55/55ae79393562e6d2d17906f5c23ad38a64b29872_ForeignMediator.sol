...
function test1(address _from, uint256 _tokenId) external view returns (address tokenAddress) {
	address myTokenAddress = erc721token();
	return myTokenAddress;	
}
/*
function test2(address _from, uint256 _tokenId) external view returns (string name) {
