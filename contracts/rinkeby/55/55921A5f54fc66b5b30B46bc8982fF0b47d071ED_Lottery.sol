...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function endLottery() public onlyOwner {
        require(
            lottery_state == LOTTERY_STATE.OPEN,
            "Cannot end any lottery yet");
        lottery_state = LOTTERY_STATE.CALCULATING_WINNER;
        // uint256(
        //     keccack256(
        //         abi.encodePackage(
        //             nonce, // nonce is predictable (txn number)
        //             msg.sender, // predictable address from sender
        //             block.difficulty, // can be manipulated by miners
        //             block.timestamp // block timestamps are predictable
        //             )
        //         )
        //     ) % players.length
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        // Reset into new lottery with no addresses
