...
contract ExpansionFrank is ERC721A, Ownable {

    string public baseURI = "https://ipfs.io/ipfs/QmTX6eNdyhZxECqnNdbRKP9SPESNHJyti3d7SgtdmYnKij/";
    bool public paused;

    uint256 constant public MAX_MINT = 2000;
    uint256 constant public MAX_MINT_PER_TX = 20;
    uint256 public cost = 0.0069 ether;

    constructor() ERC721A("ExpansionFrank", "EXPANSIONFRANK") {}
