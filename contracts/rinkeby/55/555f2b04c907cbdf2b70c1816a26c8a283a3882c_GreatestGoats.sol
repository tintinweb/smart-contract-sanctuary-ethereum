...
contract GreatestGoats is ERC721A, Ownable {
    ...
    bytes32 public holderSaleMerkleRoot = 0x5a14387996da8cfcf71a285da95d72d116a2aadff684c475e7d1f7161b09169d;
    ...
    function holderMint(uint256 _quantity, bytes32[] calldata proof) external payable {
        ...
        require(MerkleProof.verify(proof, holderSaleMerkleRoot, keccak256(abi.encodePacked(msg.sender))), "INVALID_PROOF");
    ...
    function setRaffleSaleDetails(bytes32 _root, uint8 _maxMint) external onlyOwner {
