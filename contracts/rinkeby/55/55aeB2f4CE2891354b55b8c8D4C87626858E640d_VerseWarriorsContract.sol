...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2CC23281963Fc2c9b0ACFFe0704bA9748dC9512d];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih25nbkgdgm7mteqzzhjvprdjwys5epcbmsul7skdfjq6kw2dspwe/";
...
// File: contracts/VerseWarriorsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VerseWarriorsContract is RamppERC721A {
    constructor() RamppERC721A("Verse Warriors", "VW"){}
}
