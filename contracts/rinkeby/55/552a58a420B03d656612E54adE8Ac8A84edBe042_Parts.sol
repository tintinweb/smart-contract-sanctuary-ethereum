...
contract Parts is ERC1155, ERC1155CollectionBase, AdminControl{
    ...
    */
    ...
    function setCollectionURIs(string calldata _part1Uri, string calldata _part2Uri, string calldata _part3Uri, string calldata _part4Uri) external adminRequired {
        part1Uri = _part1Uri;
        part2Uri = _part2Uri;
        part3Uri = _part3Uri;
        part4Uri = _part4Uri;
...
abstract contract ERC1155CollectionBase is CollectionBase, IERC1155Collection {
     ...
     */
    function purchase(uint16 amount) external virtual override {
