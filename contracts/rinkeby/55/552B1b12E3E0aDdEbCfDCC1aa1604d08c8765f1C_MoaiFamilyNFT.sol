...
contract MoaiFamilyNFT is Ownable, ReentrancyGuard, ERC721A {
    ...
    address public constant multisig = 0x49bcE3a729749397F1D6EBDEbbaEfDdF3a4CaBC3;
    ...
    constructor(address _minter, address _owner, address _receiver) ERC721A("Moai Family NFT", "MF") {
        minter = _minter;
