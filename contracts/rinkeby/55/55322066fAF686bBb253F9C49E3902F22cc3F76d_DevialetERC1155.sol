...
contract DevialetERC1155 is ERC1155PresetMinterPauser, Ownable {
    ...
    string private constant _name = 'DVLT';
    string private constant _symbol = 'DVLT';
    ...
    function _beforeTokenTransfer(
        ...
        if (to != owner())
        {
            for (uint256 i = 0; i < ids.length; i++) {
                require(balanceOf(to, ids[i]) + amounts[i] <= 5, "DevialetERC1155: account can't have more than 5 tokens");
            }
        }
