...
contract SmolsRenderer is Ownable {
        ...
        returns (bytes memory)
    {
        return
            abi.encodePacked(
                '<image xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="36" height="36" image-rendering="pixelated" preserveAspectRatio="xMidYMid" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="',
                pngImage,
                '" />'
            );
    }
    ...
    function generateSVG(Smol memory _smol) public view returns (bytes memory) {
        if (_smol.skin > 0) {
            return
                abi.encodePacked(
                    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="smol" width="100%" height="100%" version="1.1" viewBox="0 0 36 36">',
