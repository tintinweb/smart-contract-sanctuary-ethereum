...
contract DrShanks is ERC721, RoyaltiesV2Impl, Ownable {
    ...
    uint256 private constant MAX_RESERVED_MINTS = 100;
    uint256 private RESERVED_MINTS = 0;

    //Dev1
    address public REWARDPOOL = 0xfeB31F196D4d9115642c505C6efe95be0b75B664;
    //Dev2
    address public constant PROJECTADRESS = 0x5fFe7Feef21b5d31BE4Eab9a24ccD60d29a2eF7c;
    ...
    function _mintSingleNFT() private {
      ...
      setRoyalties(newTokenID, payable(REWARDPOOL), 5000);
      _tokenIds.increment();
...
//Withdraw money in contract to Owner
    function withdraw() public payable onlyOwner {
     ...
     (bool successProject, ) = (msg.sender).call{value: balanceToProject}("");
     
     uint256 balanceToRewardPool = (balance * 2000)/10000;
     (bool successReward, ) = (msg.sender).call{value: balanceToRewardPool}("");

     require(successProject && successReward, "Transfer failed.");
    }
