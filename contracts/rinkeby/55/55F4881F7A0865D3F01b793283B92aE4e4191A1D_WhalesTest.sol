...
contract WhalesTest is ERC721Enumerable, Ownable, RoyaltiesV2Impl, ReentrancyGuard  {
  ...
  uint256 public max_mint_allowed = 10;
  // set the Max NFT per address
  uint256 public max_mint_per_address = 10;
  ...
  function contractURI() public view returns (string memory) {
        return "https://ipfs.io/ipfs/QmaEiV4kuWi685PDMi8jTRSS38xcE17QTtsWurgyxu4FE6/";
  }
...
**/
  function setUpSale() external onlyOwner {
    require(sellingStep == Steps.Before, "First the presale, then the sale.");
    sellingStep = Steps.Sale;
}
