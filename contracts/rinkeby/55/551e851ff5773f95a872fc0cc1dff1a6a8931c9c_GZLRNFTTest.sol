...
// File contracts/GZLRNFTTest.sol
//SPDX-License-Identifier: MIT  
pragma solidity ^0.8.4;  
contract GZLRNFTTest is ERC721A , Ownable { 
    constructor() ERC721A("GZLRNFTTest", "GZLR") {}  
  
    using Strings for uint256;

    address payable private _PaymentAddress = payable(0x459657531AACf0F5987Cf21837eef4db56e91a22);

    uint256 public GZLR_MAX = 30;
    uint256 private GZLR_ADMIN = 5;
    uint256 private GZLR_PUBLIC = GZLR_MAX - GZLR_ADMIN;
    
    uint256 private PRESALE_PRICE = 0.0001 ether;
    uint256 private PUBLIC_PRICE = 0.0002 ether;
    ...
    uint256 private _activeDateTime = 1651979697; // (GMT): Sunday, May 8, 2022 3:14:57 AM
    ...
    function adminMint(uint256 adminMintAmt) external onlyOwner {
        ...
        require(0 < adminMintAmt && adminMintAmt < GZLR_MAX, "Admin Mint Amount must lower than GZLR_MAX");
        GZLR_ADMIN = adminMintAmt;
        GZLR_PUBLIC = GZLR_MAX - GZLR_ADMIN;
        _safeMint(msg.sender, GZLR_ADMIN);
    }
