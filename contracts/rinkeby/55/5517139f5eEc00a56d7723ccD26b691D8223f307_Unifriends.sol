...
contract Unifriends is ERC721Enumerable, Ownable {
    ...
    */
    function _mint(address to, uint256 tokenId) internal virtual override {
        ...
        mintNonce++;
        _owners.push(to);
        tokenIdToRandomNumber[tokenId] = psuedorandom(to, tokenId);
    ...
    */
     ...
     */
    function psuedorandom(address to, uint256 tokenId)
        private
        view
        returns (uint256)
    {
        ...
        if (tokenId == 0) {
            return
                Unifriend({
                    ...
                    description: string(
                        abi.encodePacked(
                            "Dr. X is pure evil. The antithesis of the genesis unicorns and Unifriends.",
                            "The meticulous planning with unparalleled genius make Dr. X a complex and difficult adversary for the Unifriends."
                        )
                    ),
                    isLegendary: true,
                    trait: trait
            ...
            return
                Unifriend({
                    ...
                    intelligence: 91,
                    name: "Cyber Pegasus",
                    description: "From not being able to walk or fly to having the fastest wings in the entire galaxy. A second chance at life.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 2) {
            ...
            return
                Unifriend({
                    ...
                    intelligence: 97,
                    name: "King Bastion",
                    description: "King Bastion is the oldest Unifriend in the galaxy. He is very wise. Always in gold he shines and rules the metaverse.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 4) {
            return
                Unifriend({
                    ...
                    intelligence: 96,
                    name: "Queen Bastion",
                    description: "Queen Bastion is the smartest lady in the whole entire metaverse, Her unique kinetic aura keeps the metaverse at peace.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 5) {
            return
                Unifriend({
                    ...
                    intelligence: 92,
                    name: "Mutated Uni",
                    description: "Accidentally covered with toxicity, he is a mutated Unicorn that is filled with slime.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 6) {
            return
                Unifriend({
                    ...
                    intelligence: 95,
                    name: "Shadow Uni",
                    description: "The darkest Unicorn in the galaxy. He lives in a black hole alone with no one around.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 7) {
            return
                Unifriend({
                    ...
                    intelligence: 93,
                    name: "Uni Bot",
                    description: "He is the Robot of the metaverse with his a sharp intellect and perfect grades.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 8) {
            return
                Unifriend({
                    ...
                    intelligence: 92,
                    name: "Experiment 73",
                    description: "An escapee from Dr. X lab, he is one of the strongest prisoners and should not to be trusted.",
                    isLegendary: true,
                    trait: trait
                });
        } else if (tokenId == 9) {
            return
                Unifriend({
                    ...
                    intelligence: 94,
                    name: "Spurr",
                    description: "The loner that's never around. Her name is Spurr, she is fast, witted and always secretly up to trouble.",
                    isLegendary: true,
                    trait: trait
                });
        }
