...
pragma solidity ^0.8.0;
// import "hardhat/console.sol"; // remove me
//                         )/_
//               _.--..---"-,--o_
//          \L..'           ._O__)_
//  ,-.     _.+  _  \..--( /           LizardKing
...
contract Inferno is ERC721, ERC721URIStorage, Pausable, AccessControl, Ownable {
    ...
    uint256 private _public_price = 15000000000000000; // 0.15 Ether
    uint256 private _wl_price = 10000000000000000;     // 0.10 Ether  
    uint256 private _maxSupply = 1200;
    uint256 private _maxZodiacSupply = 100;

    uint256 private _phaseMaxSupply = 666; // Will be set on each phase switch. Take _tokenCounter and add phaseSupply to it.
    uint256 private _initialPhaseCount = 12;
    ...
    constructor() ERC721("BazingaTest Contractarino", "BIGABALLS") {
        _pause();
        ...
        zodiacSigns["sag"] = ZodiacSign("Sagatarius", Counters.Counter(0), true);
    ...
    function initializeMint() public onlyOwner {
        preMint(msg.sender, "aqu");
        preMint(msg.sender, "ari");
        preMint(msg.sender, "can");
        preMint(msg.sender, "cap");
        preMint(msg.sender, "gem");
        preMint(msg.sender, "leo");
        preMint(msg.sender, "lib");
        preMint(msg.sender, "pis");
        preMint(msg.sender, "sag");
        preMint(msg.sender, "sco");
        preMint(msg.sender, "tau");
        preMint(msg.sender, "vir");
    }
