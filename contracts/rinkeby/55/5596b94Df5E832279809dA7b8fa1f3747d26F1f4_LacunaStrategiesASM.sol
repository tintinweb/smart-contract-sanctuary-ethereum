...
contract LacunaStrategiesASM is ERC721A, Ownable {
    ...
    ) ERC721A("LacunaStrategiesASM", "LSASM") {
    ...
    function mintWhitelist(uint256 _qty, uint256 _allotted, Coupon memory _coupon) external {
        ...
        bytes32 digest = keccak256(
			abi.encode(CouponType.Whitelist, _allotted, msg.sender)
		);
        ...
        require(_qty + addressToMinted[msg.sender]._whitelistMintsByAddress < _allotted + 1, "Exceeds Max Allotted");
        // Increment number of whitelist tokens minted by wallet
        addressToMinted[msg.sender]._whitelistMintsByAddress += _qty;
