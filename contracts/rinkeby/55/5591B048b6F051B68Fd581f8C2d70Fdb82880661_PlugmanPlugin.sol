...
import "./IPlugmanPlugin.sol";

contract PlugmanPlugin is IPlugmanPlugin, ERC1155, ERC2981, Ownable {
    string public name = "PlugmanPlugin";
    string public symbol = "PLUGMAN_PLUGIN";
    mapping(uint256 => string) private _uris;

    constructor() ERC1155("") {}

    /**
     * @dev See {IPlugmanPlugin-mint}.
     */
    function mint(
        address to,
        uint256 id,
    ...
    /**
     * @dev See {IPlugmanPlugin-mintBatch}.
     */
    function mintBatch(
        address to,
        uint256[] memory ids,
