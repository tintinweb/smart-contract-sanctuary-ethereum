...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    require(msg.value >= 1 ether / tokensPerEth, "Not enough value");
  ...
  function sellTokens(uint256 _amount) public payable {
    uint ethAmount = _amount / tokensPerEth;
    require(address(this).balance >= ethAmount, "Not enough balance on the contract");
...
contract YourToken is ERC20 {
    address owner = address(0x7F819F80Acf714eA15b3f71F55Ff72d79b036C44);
