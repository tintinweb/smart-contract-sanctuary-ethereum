...
contract ERC721WithRoyaltyFee is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    Pausable,
    ...
    ERC2981ContractWideRoyalties
{
    ...
    event SetReceiveRoyaltyFee(address walletRoyaltyFee);
    event Minted(address recipient, uint256 royaltyRate);
    ...
    function setOperator(address payable operator, bool isOperator)
        public
        onlyOwner
    {
    ...
    function setReceiveRoyaltyFee(address _walletRoyaltyFee)
        public
        onlyOperator
    {
        require(
        ...
        walletReceiveFee = _walletRoyaltyFee;
        emit SetReceiveRoyaltyFee(_walletRoyaltyFee);
    }
    ...
    function safeMint(address to, uint256 num) public onlyOperator {
        for (uint256 i = 1; i <= num; i++) {
            ...
            _setRoyalties(walletReceiveFee, royaltyRate);
            emit Minted(to, royaltyRate);
        }
    }
