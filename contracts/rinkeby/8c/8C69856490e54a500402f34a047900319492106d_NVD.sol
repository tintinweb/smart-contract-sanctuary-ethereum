...
contract NVD is ERC20, Ownable{
    ...
    address public DAO = 0x0DDe70cBf8cB395Bd0f68e815273E43bC25d193E;
    uint256 public tax = 8;
    mapping(address => bool) whiteList;

    constructor() ERC20("NFT VC DAO", "NVD") {
        _mint(0x0DDe70cBf8cB395Bd0f68e815273E43bC25d193E, 100000000000 * 10 ** 18);
    }
    ...
    function _transfer(
        ...
        if(whiteList[sender] || whiteList[recipient]){
            ...
            super._transfer(sender,DAO,taxAmount);
