...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xdbf137072D98CFD292e7Fa1B06b99536537047dD];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xdbf137072D98CFD292e7Fa1B06b99536537047dD;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmS1b4iEHJwQLgWNKcDYNfinkMTST3r58Z9Wd7AUqP4xxp/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3500");
...
// File: contracts/UnksogContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UnksogContract is RamppERC721A {
    constructor() RamppERC721A("UNKS OG", "UNKS"){}
}
