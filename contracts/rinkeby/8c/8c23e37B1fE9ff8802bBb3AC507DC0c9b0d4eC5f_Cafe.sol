...
contract Cafe is ERC721, Ownable {
    ...
    function reserveCafe() public onlyOwner {   
     ...
     function mintCafe(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxCafe, "Purchase would exceed max supply of Cafe");
