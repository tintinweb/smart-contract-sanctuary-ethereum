...
/// @title Interface of the tinydinos standard
contract tinydinos is ONFT721 {
    ...
    /// @notice Constructor for the tinydinos
    /// @param _layerZeroEndpoint handles message transmission across chains
    /// @param _startMintId the starting mint number on this chain
    /// @param _endMintId the max number of mints on this chain
    constructor(string memory baseURI_, address _layerZeroEndpoint, uint _startMintId, uint _endMintId) ONFT721("tiny dinos", "dino", _layerZeroEndpoint) {
    ...
    function mint() external payable {
        require(nextMintId <= maxMintId, "tinydinos: max mint limit reached");
