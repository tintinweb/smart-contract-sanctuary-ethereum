...
// File: contracts/Seromon Low GasTest.sol
...
contract SRMTEST is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SRMTEST", "SRMT") {
    setHiddenMetadataUri("ipfs://QmSf9bCmFebTEp2kdRTUpDiPwrRH7qjhbPSBhr1VPubGfC/hidden.json");
  }
