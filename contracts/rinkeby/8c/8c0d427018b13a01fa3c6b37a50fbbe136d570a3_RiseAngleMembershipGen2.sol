...
contract RiseAngleMembershipGen2 is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_PUBLIC_RAMS = 1000;
    ...
    constructor(address _preBuyContract) ERC721("RiseAngle Membership Gen 2", "RAM2") {
        baseTokenURI = "https://ipfs.io/ipfs/QmarQ9FdEzV1rLSdSN3afAk14zX7u2mfJfjsbd7SMQF8V1/";
    ...
    function mint(uint256 amountOfRams) external payable {
        ...
        require(totalSupply() + amountOfRams <= MAX_PUBLIC_RAMS, "Would exceed max public sale tokens");
