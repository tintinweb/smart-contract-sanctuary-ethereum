...
contract Hash is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PUBLIC_RENEW_PRICE = 0.01 ether;
    ...
    {
        uint tokenIndex = tokenCounter.current() + 1;
    ...
    */
    function renewToken(uint _tokenId) public payable {
        ...
        require(msg.value == PUBLIC_RENEW_PRICE, "Incorrect Ether amount.");
