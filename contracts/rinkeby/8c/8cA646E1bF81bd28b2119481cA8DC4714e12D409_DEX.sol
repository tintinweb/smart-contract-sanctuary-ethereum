...
contract DEX {
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(success, "DEX tokenToEth() - Revert transfering ETH to you");
        emit TokenToEthSwap(
            msg.sender,
            "Balloons to ETH",
            ethOutput,
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        require(
            ...
            "DEX deposit() - Revert transfering tokens"
        );
        ...
        returns (uint256 eth_amount, uint256 token_amount)
    {
        require(
            ...
            "DEX withdraw() - sender doens't have enough liquidity to withdraw"
        );
        ...
        require(success, "DEX withdraw() - revert transfering eth to you");
        require(
            token.transfer(msg.sender, tokenAmount),
            "DEX withdraw() - Revert transfering tokens"
        );
