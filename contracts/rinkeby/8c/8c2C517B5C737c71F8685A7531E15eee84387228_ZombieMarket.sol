...
contract ZombieMarket is ZombieHelper,ERC721{
...
contract ZombieFactory is Ownable {
  ...
  function _createZombie(
    ...
    uint256 _save,
    uint256 _lucky,
    uint256 _level) internal {
    zombies.push(Zombie(_speed, _shoot, _defend, _save,_lucky,_level));
  ...
  function createZombie() public{
    ...
    uint256 randSpeed = _generateRandomDna(49,100,zombieCount,"Speed");
    uint256 randShoot = _generateRandomDna(49,100,zombieCount,"Shoot");
    uint256 randDefend = _generateRandomDna(49,100,zombieCount,"Defend");
    uint256 randSave = _generateRandomDna(49,100,zombieCount,"Save");
    uint256 randLucky = _generateRandomDna(49,100,zombieCount,"Lucky");
   _createZombie(randSpeed,randShoot,randDefend,randSave,randLucky,1);
  }
