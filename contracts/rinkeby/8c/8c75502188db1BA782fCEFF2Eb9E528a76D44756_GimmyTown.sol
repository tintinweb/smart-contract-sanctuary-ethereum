...
contract GimmyTown is Ownable, ERC721A {
    ...
    constructor() ERC721A("GimmyTown", "GTOWN") {}
    ...
    function freeMint(uint256 _quantity) external payable mintCompliance() {
        ...
        _safeMint(msg.sender, _quantity);
        totalFreeMintedAmount = totalFreeMintedAmount + _quantity;
    }
    ...
    function refundIfOver(uint256 _publicCost) private {
        require(msg.value >= _publicCost, "Not enough ETH sent."); 
        }
