...
contract TTTreasure is ERC721, Ownable {
    ...
    function publicMint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "TTTreasure: Total mint amount exceeded"
        );
        require(
            addressToMintedAmount[msg.sender] + _mintAmount <= maxMintPerWallet,
            "TTTreasure: Exceeded mint per wallet"
        );
        require(
            msg.value == cost * _mintAmount,
            "TTTreasure: not enough ether sent for mint amount"
        );
