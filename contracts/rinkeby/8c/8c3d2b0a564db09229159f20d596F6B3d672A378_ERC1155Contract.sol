...
contract ERC1155Contract is ERC1155, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    function create(
        ...
        tokenTypes[_id].maxSupply = tokenParameters.maxSupply;
        tokenTypes[_id].maxPerWallet = tokenParameters.maxPerWallet;
        tokenTypes[_id].maxPerTransaction = tokenParameters.maxPerTransaction;
        tokenTypes[_id].preSalePrice = tokenParameters.preSalePrice;
        tokenTypes[_id].pubSalePrice = tokenParameters.pubSalePrice;
    ...
    function reserve(uint256 _id, bytes memory _data, address _address, uint256 _quantity) public onlyOwner nonReentrant {
        uint256 _currentSupply = tokenTypes[_id].totalSupply;
        require(_currentSupply <= tokenTypes[_id].maxSupply, "Sold out.");
