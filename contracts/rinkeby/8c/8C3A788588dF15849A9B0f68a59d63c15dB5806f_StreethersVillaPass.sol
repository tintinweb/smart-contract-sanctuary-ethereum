...
contract StreethersVillaPass is ERC721, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_SUPPLY = 799;
    ...
    event Log(address claimerAddress, uint256 nftBalance, uint256 tokenBalance);

    constructor() ERC721("STREETHERS VILLA PASS", "VILLAPASS") {}
    ...
    function claimPass() public {
        ...
        // require(
        //     totalSupply().add(nftBalance) <= MAX_SUPPLY,
        //     "Exceed max supply"
        // );
        ...
        // emit Log(msg.sender, nftBalance, tokenBalance);

        emit Log(msg.sender, 3, 2500000000000000);
    }
