...
contract Elixir is ERC721, ERC721Burnable, AccessControl {
        ...
        returns (string memory)
    {
        ...
        string memory attributes = generateAttributes(
            tokenId,
            elixirCurrentSteadyValue > 0 ? Strings.toString(uint256(elixirCurrentSteadyValue)/divisor) : int2str(elixirCurrentSteadyValue),
            currentPrice/divisor,
            forgeConstant/divisor
        );
        ...
        )
    {
        ...
        elixirCurrentSteadyValue = (int256(currentPrice) - int256(forgeConstant)) 
                                    * int256(elements[tokenId].amount) / int256(10**decimals * 10**decimals);
        timeLeft = 0;
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    ',{"trait_type": "Forge Price", "value":',Strings.toString((elements[tokenId].forgePrice)),'}',
                    ',{"trait_type": "Amount", "value":',Strings.toString((elements[tokenId].amount)),'}',
                    ',{"trait_type": "Price", "value":',Strings.toString(currentPrice),'}',
                    ',{"trait_type": "Total Value", "value":',elixirCurrentSteadyValue,'}',
                    ',{"trait_type": "Alchemist", "value":"',Strings.toHexString(uint160(elements[tokenId].alchemistId), 20),'"}',
                    ',{"trait_type": "forgeConstant", "value":',Strings.toString(forgeConstant),'}'
                )
            );
    }
