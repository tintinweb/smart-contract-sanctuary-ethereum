...
contract NFTation is Initializable, 
    ...
    function addTestForGnosis() public view returns(string memory)  {
        return "hi my friend";
    }
}
...
contract FixedPriceMarketPlace is Initializable,
    ...
    function createMarketItem(uint256 tokenId, uint256 price) public  whenNotPaused nonReentrant returns (uint256)   {
    ...
    function changeMarketItemPrice(uint256 _itemId, uint256 _newPrice) public whenNotPaused nonReentrant  {
