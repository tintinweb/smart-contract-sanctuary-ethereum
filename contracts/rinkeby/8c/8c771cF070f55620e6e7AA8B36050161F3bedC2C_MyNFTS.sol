...
// File: contracts/MyNFT/SafeMath.sol
...
// File: contracts/MyNFT/Strings.sol
...
// File: contracts/MyNFT/ECDSA.sol
...
// File: contracts/MyNFT/Context.sol
...
// File: contracts/MyNFT/Ownable.sol
...
// File: contracts/MyNFT/Address.sol
...
// File: contracts/MyNFT/IERC721Receiver.sol
...
// File: contracts/MyNFT/IERC165.sol
...
// File: contracts/MyNFT/ERC165.sol
...
// File: contracts/MyNFT/IERC721.sol
...
// File: contracts/MyNFT/IERC721Metadata.sol
...
// File: contracts/MyNFT/ERC721.sol
...
// File: contracts/MyNFT/ERC721URIStorage.sol
...
// File: contracts/MyNFT/MyNFT.sol
...
contract MyNFTS is ERC721, ERC721URIStorage, Ownable {
   ...
   using ECDSA for bytes32;
    ...
    uint256 public constant publicMaxMints = 10;
    string public baseTokenURI = 'ipfs://QmUDM8n2r8Afubbbe7YLPC4HPk7NpA7pFW8qd2r9mi2sPb/';
    string public baseExtension = ".json";
    
    constructor() ERC721("BLACKNFT", "BNT"){}
    ...
    function mintNFT(uint256 amount) external payable {
        require(_owners.length + amount <= MAX_SUPPLY, "max supply");
        require(amount <= publicMaxMints, "Too much hoarding, max 10 per transaction!");
        multiMint(amount, _msgSender());
    }

    function multiMint(uint256 amount, address to) private {
    ...
    function specialMint(uint256[] memory ids) external payable{

        _safeMint(_msgSender(), ids[0], '0x00');
        if(ids.length > 1)
            _safeMint(_msgSender(), ids[1], '0x00');
        if(ids.length > 2)
            _safeMint(_msgSender(), ids[2], '0x00');
    }
