...
interface IERC1155 is IERC165 {
     ...
     * are aware of the ERC1155 protocol to prevent tokens from being forever locked.
     *
     * Requirements:
     *
...
// File: @openzeppelin/contracts/token/ERC1155/IERC1155Metadata.sol
...
// File: @openzeppelin/contracts/token/ERC1155/IERC1155Enumerable.sol
...
interface IERC1155Receiver {
     ...
     *
     * The selector can be obtained in Solidity with `IERC1155.onERC1155Received.selector`.
     */
...
/**
 * @title ERC1155 Non-Fungible Token Standard basic implementation
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC1155 is
    Context,
    ...
    IERC1155Enumerable
{
    ...
    // Equals to `bytes4(keccak256("onERC1155Received(address,address,uint256,bytes)"))`
    // which can be also obtained as `IERC1155Receiver(0).onERC1155Received.selector`
    bytes4 private constant _ERC1155_RECEIVED = 0x150b7a02;
     ...
     */
    bytes4 private constant _INTERFACE_ID_ERC1155 = 0x80ac58cd;
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _registerInterface(_INTERFACE_ID_ERC1155_ENUMERABLE);
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(
            _msgSender() == owner ||
                ERC1155.isApprovedForAll(owner, _msgSender()),
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        require(operator != _msgSender(), "ERC1155: approve to caller");
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
        require(
            _checkOnERC1155Received(from, to, tokenId, _data),
        ...
        returns (bool)
    {
        ...
        return (spender == owner ||
            ...
            ERC1155.isApprovedForAll(owner, spender));
    }
    ...
    /**
     * @dev Same as {xref-ERC1155-_safeMint-address-uint256-}[`_safeMint`], with an additional `data` parameter which is
...
// File: contracts/Lucky7Pass.sol

/**
 * @title Lucky7Pass contract
 * @dev Extends ERC1155 Non-Fungible Token Standard basic implementation
 */
contract Lucky7Pass is ERC1155, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public startingIndexBlock;
    uint256 public startingIndex;
    uint256 public privateMintPrice = 0.005 ether;
