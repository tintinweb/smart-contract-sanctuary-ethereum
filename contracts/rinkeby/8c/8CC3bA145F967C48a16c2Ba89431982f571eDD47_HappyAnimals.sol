...
contract HappyAnimals is ERC721, Ownable {
  ...
  uint256 private maxSupplyPrivate = 90;
  ...
  function mintAnimal() external {
    uint256 totalMinted = totalSupply();

    // checks
    // require(whitelistedWallets[msg.sender], "This wallet is not authorized to mint.");
    require(!paused, "Minting paused by owner.");
    require(totalMinted.add(maxPerMint) <= maxSupplyPrivate, "Not enough NFTs.");
    // require(amount >= price, "Not enough balance to mint NFTs.");
    // require(
  ...
  function getBalanceOf(address _wallet) public view returns (uint256) {
