...
contract SillyStaking is Ownable, IERC721Receiver {
    ...
    constructor(Silly721 _nft, Silly20 _token){
        nft = _nft;
        token = _token;
    }
    ...
    function stake(uint256[] calldata tokenIds) external {
        ...
        for (uint i = 0; i < tokenIds.length; i++){
            ...
            require(nft.ownerOf(tokenId) == msg.sender, "This NFT does not belong to you.");
            require(vault[tokenId].tokenId == 0, "This NFT has already been staked.");
    ...
    function _unstakeMany(address account, uint256[] calldata tokenIds) internal {
        ...
        for (uint i = 0; i < tokenIds.length; i++){
            ...
            require(staked.owner == msg.sender, "This NFT does not belong to you.");
    ...
    function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
        ...
        for (uint i = 0; i < tokenIds.length; i++){
            ...
            require(staked.owner == account, "This NFT does not belong to you.");

            uint256 stakedAt = staked.timestamp;
            rewardMath = 100 ether * (block.timestamp - stakedAt) / 86400; // 1 Token 24h
    ...
    function onERC721Received(
        ...
        require(from == address(0x0), "Cannot send NFTs directly to this vault.");
