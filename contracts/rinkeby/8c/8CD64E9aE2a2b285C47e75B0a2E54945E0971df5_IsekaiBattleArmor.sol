...
contract IsekaiBattleArmor is ERC1155Burnable, AccessControlEnumerable, Ownable, IIsekaiBattleArmor {
    ...
    IIsekaiBattle public override ISBContract;
    ...
    function uri(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory armorType = ISBContract.staticData().armorTypeText(info.armorType);
...
interface IIsekaiBattleArmor {
    ...
    function ISBContract() external view returns (IIsekaiBattle);
