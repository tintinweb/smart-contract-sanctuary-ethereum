...
// File: contracts/LoopyLlamas.sol
...
contract LoopyLlamas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Loopy Llamas (Official)", "LL") {
    setHiddenMetadataUri("ipfs://QmT8mvnwo1hsFUpYmGpnSCUTeSwFiPHdMAwxvqpHnSPjgK/hidden.json");
  }
