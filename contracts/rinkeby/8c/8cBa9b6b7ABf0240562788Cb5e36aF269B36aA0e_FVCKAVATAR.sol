 ...
 * FVCKAVATAR//
 */
contract FVCKAVATAR is ReentrancyGuard, AdminControl, ERC721, IERC1155Receiver {
    ...
    constructor(address essenceAddress) ERC721("FVCKAVATAR//", "FVCKAVATAR//") {
    ...
    */
	...
	function _onERC1155Received(address from, uint256 id, uint256 value) private {
        require(isRedemptionEnabled, "Redemption inactive");
