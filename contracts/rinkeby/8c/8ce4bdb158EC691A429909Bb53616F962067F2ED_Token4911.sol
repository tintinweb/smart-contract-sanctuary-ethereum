    ...
    ITokenERC721
{
 ...
 /// @dev Mints an NFT according to the provided mint request.
    ...
    function collectPrice(MintRequest memory _req) internal {
        ...
        CurrencyTransferLib.transferCurrency(_req.currency, _msgSender(), _req.aIDFeeRecipient, aIDFees);
        CurrencyTransferLib.transferCurrency(_req.currency, _msgSender(), _req.rIDFeeRecipient, rIDFees);
