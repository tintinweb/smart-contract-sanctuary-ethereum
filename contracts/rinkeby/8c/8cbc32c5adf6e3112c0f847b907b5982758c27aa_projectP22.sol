...
contract projectP22 is ERC1155, Ownable {
    ...
    function unclaimAllOwnsTokensShare() external view returns(uint256) {
        ...
        for (index = 0; index < tokenCount; index++) {
            alreadyClaimedAmount += perTokenClaimedAmount[revenueSharingContract.tokenOfOwnerByIndex(msg.sender, index)];
        }
