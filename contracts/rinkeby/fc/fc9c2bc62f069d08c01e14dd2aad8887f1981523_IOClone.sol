...
contract IOClone is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRESALE_MINT_QUANTITY = 1;
    ...
    function preSaleBuy(
        ...
        if (whitelistClaimed[msg.sender] + mintQuantity > PRESALE_MINT_QUANTITY)
