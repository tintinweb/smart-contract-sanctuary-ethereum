...
contract Trade is AccessControl {
    ...
    */
    ...
    function swapToken(Swapping memory swapMetaData, Sign memory sign)
        external
        returns (bool)
    {
        verifyBuyerSign(
            swapMetaData.to,
            swapMetaData.swapTokenId1,
            swapMetaData.swapTokenId2,
            swapMetaData.swapnftAddress1,
            swapMetaData.swapnftAddress2,
            swapMetaData.buyingQty,
            sign
        );

        if(swapMetaData.nftType == BuyingAssetType.ERC721) {
            transferProxy.erc721safeTransferFrom(
                IERC721(swapMetaData.swapnftAddress2),
                swapMetaData.from,
                swapMetaData.to,
                swapMetaData.swapTokenId2
            );
            ...
            transferProxy.erc721safeTransferFrom(
                IERC721(swapMetaData.swapnftAddress1),
                swapMetaData.to,
                swapMetaData.from,
                swapMetaData.swapTokenId1
            );
        ...
        if(swapMetaData.nftType == BuyingAssetType.ERC1155)  {
            transferProxy.erc1155safeTransferFrom(
                IERC1155(swapMetaData.swapnftAddress2),
                swapMetaData.from,
                swapMetaData.to,
                swapMetaData.swapTokenId2,
                swapMetaData.sellingQty,
                ""
            );

            transferProxy.erc1155safeTransferFrom(
                IERC1155(swapMetaData.swapnftAddress1),
                swapMetaData.to,
                swapMetaData.from,
                swapMetaData.swapTokenId1,
                swapMetaData.buyingQty,
