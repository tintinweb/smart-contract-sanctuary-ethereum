...
contract Prova is Ownable, ERC721A {
    uint256 public maxSupply                    = 50;
    uint256 public maxFreeSupply                = 20;

    uint256 public maxPerAddressDuringFreeMint  = 10;
    ...
    function freeMint(uint256 _quantity) external payable mintCompliance() {
        ...
        if (msg.sender != owner()) {
            if(onlyWhitelisted == true) {
                ...
                require(ownerMintedCount + _freeMintedAmount <= maxPerAddressDuringFreeMint, "max NFT per address exceeded");
            }
        }
    ...
    function cutMaxFreeSupply(uint256 _amount) public onlyOwner {
        require(
            maxFreeSupply - _amount <= maxSupply,
            "Max free supply cannot exceed max supply"
        );
        ...
        returns (string memory)
    {
        ...
        string memory currentBaseURI = revealedMetadataUri;
        return
    ...
    function setrevealedMetadataUri(string memory _revealedMetadataUri)
        public
        onlyOwner
    {
...
/**
["0x25238e75ce63DE1640A332fe22247C1EC704De4C",
"0x8EFFD2A090FE47Eee227bC2b1d0994eE08B0AE3C",
"0x8EFFD2A090FE47Eee227bC2b1d0994eE08B0AE3C"]
*/