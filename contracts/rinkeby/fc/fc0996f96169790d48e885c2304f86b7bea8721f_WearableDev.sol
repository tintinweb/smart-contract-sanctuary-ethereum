...
// File: contracts/wearableDevV1.sol
...
contract WearableDev is Ownable, ERC721A, ReentrancyGuard, ERC2981{
  ...
  constructor(
  ) ERC721A("WearableDev", "WD",batchSize, _totalSupply) {
     tokenCount = 0;
  }
  ...
  //key Project
  address x1_address = 0xF9951627EcD7F94890A0b325C91C63FD963C011C;
