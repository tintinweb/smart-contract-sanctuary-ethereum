...
contract Rpcp is ERC721A, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    string private baseURIRaton;
    string private baseURICarcajou;
    string private baseURIRenard;
    string private baseURILoup;
    string private baseURIOurs;
    string private notRevealedURIRaton;
    string private notRevealedURICarcajou;
    string private notRevealedURIRenard;
    string private notRevealedURILoup;
    string private notRevealedURIOurs;
    string public baseExtension = ".json";
    bool private revealedRaton = false;
    bool private revealedCarcajou = false;
    bool private revealedRenard = false;
    bool private revealedLoup = false;
    bool private revealedOurs = false;
