 ...
 */
contract Katch is IBEP20, HasForeignAsset {
    ...
    constructor(address _owner) {
        ...
        _mintOnce(msg.sender, (_maxSupply.mul(10**_decimals)).mul(40).div(100));
        _mintOnce(_owner, (_maxSupply.mul(10**_decimals)).mul(60).div(100));
    }
