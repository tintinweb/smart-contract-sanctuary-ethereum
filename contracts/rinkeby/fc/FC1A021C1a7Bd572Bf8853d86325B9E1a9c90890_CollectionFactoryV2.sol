...
contract CollectionFactoryV2 is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function createCollection(
        ...
        CollectionV2 collection = new CollectionV2(name, symbol, _contractURI, tokenURIPrefix, msg.sender, marketplace);
...
contract CollectionV2 is ReentrancyGuard, Ownable, Pausable, CBRNFTDefault {
    ...
    ) CBRNFTDefault(name, symbol, _contractURI, tokenURIPrefix, _admin, _marketplace) {
    ...
    Royalties
{
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721, ERC721URIStorage) returns (string memory) {
        ...
        //return baseURI+super.tokenURI(tokenId);
    }
