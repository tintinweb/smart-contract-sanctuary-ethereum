...
contract NFT_PRESALE_PROVA is Ownable, ERC721Enumerable {
  ...
  function whitelistUsers(address[] calldata _users) public onlyOwner {   //input as ["0x...", "0x...", ...]
  ...
  function withdraw() public payable onlyOwner {
    // This will payout the contract balance to owner.
