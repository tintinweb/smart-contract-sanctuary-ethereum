...
contract LadyGAGA is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxNFTPerAccount = 4;
  ...
  function Mint(uint256 _mintAmount, bytes32[] calldata merkleProof) public payable nonReentrant mintCompliance(_mintAmount) {
  ...
  function getCurrentPrice(uint256 _mintAmount, bytes32[] calldata merkleProof) public view returns (uint256) {
    uint256 finalPrice;
      if(isValidMerkleProof(merkleProof,whitelistMerkleRoot)){
          if(addressGetFreeMint[_msgSender()] == 0 && maxFreeMint > 0){
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // Pay for Team
    (bool cl, ) = payable(0xc7bae424C11E1ef9a005aeE8185E973116Fc5A9E).call{value: totalBalance * 70 / 100}("");
    require(cl);
    // =============================================================================
