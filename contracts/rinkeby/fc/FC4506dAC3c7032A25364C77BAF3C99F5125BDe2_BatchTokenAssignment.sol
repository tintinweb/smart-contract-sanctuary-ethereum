...
contract BatchTokenAssignment is Ownable, ReentrancyGuard {
  ...
  function depositAndVestingPlanMB1(uint256 nftID, uint256 amount, address token, uint256 _cliff, uint16[] calldata _percentages, uint256[] calldata _unlockDuration, uint256 _startTime) public {
  ...
  function depositAndVestingPlanGG(uint256 nftID, uint256 amount, address token, uint256 _cliff, uint16[] calldata _percentages, uint256[] calldata _unlockDuration, uint256 _startTime) public {
  ...
  function addVestingPlanMB1(uint256[] calldata nftIDs, uint256[] calldata amounts, address token, uint256 _cliff, uint16[] calldata _percentages, uint256[] calldata _unlockDuration, uint256 _startTime) external {
    require(nftIDs.length == amounts.length, "Lengths don't match");

    for(uint256 i = 0; i < nftIDs.length; i++) {     
      depositAndVestingPlanMB1(nftIDs[i], amounts[i], token, _cliff, _percentages, _unlockDuration, _startTime);
    }
  }

  function addVestingPlanGG(uint256[] calldata nftIDs, uint256[] calldata amounts, address token, uint256 _cliff, uint16[] calldata _percentages, uint256[] calldata _unlockDuration, uint256 _startTime ) external {
    require(nftIDs.length == amounts.length, "Lengths don't match");

    for(uint256 i = 0; i < nftIDs.length; i++) {     
      depositAndVestingPlanGG(nftIDs[i], amounts[i], token, _cliff, _percentages, _unlockDuration, _startTime);
    }
  }
