...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Comprou", "Vendeu", "Holdou", "Mintou", "DeuAllInEm", "EntrouFreeEm"];
  string[] secondWords = ["Axie", "Bombcrypto", "Pvu", "Bitcoin", "BoredApe", "Cryptomines"];
  string[] thirdWords = ["EFoiScamado", "EReinvestiu", "EFez10x", "EFicouRico", "EFaliu"];

  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721 ("ToTheMoon", "MOON") {
  ...
  function getTotalNFTsMintedSoFar() public view returns (uint256) {
        ...
        console.log("NFTSSSSSSSSS", _tokenIds.current());
  ...
  function makeAnEpicNFT() public {
    require( _tokenIds.current() <= TOTAL_SUPPLY , "Insufficient tokens" );
