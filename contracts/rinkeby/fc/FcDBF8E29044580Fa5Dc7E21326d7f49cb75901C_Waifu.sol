...
contract Waifu is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function getfreegoblin(uint256 _mintAmount) public payable nonReentrant{
    ...
    function getmanygoblins(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
    ...
    function goblingift(uint256[] calldata quantity, address[] calldata recipient)
        external
        onlyOwner
    {
        require(
