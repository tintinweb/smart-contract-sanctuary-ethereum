...
contract Rabbit is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721A("The Joyful Rabbit", "Rabbit") {
    setNotRevealedUri("ipfs://QmVKCErzL9sGzdc3hZnnXk3SsrrYJS3zY96cKsj3MqQ5b1/");
  }
