...
// File: contracts/PajamaMinis.sol
...
contract Pajamaminis is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 10000;
    uint public _price = 0.08 ether;
    uint256 public maxBuyPerTx = 5;
    bool public paused;
    

    constructor() ERC721A("Pajamaminis", "MINI") {
        paused = true;
    }
    // Read the price
