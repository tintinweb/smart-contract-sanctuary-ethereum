...
contract OCMRenderingContract is Ownable {
    ...
    string[][] private bg_names = [["bg1_0", "bg1_1", "bg1_2", "bg1_3", "bg1_4", "bg1_5", "bg1_6", "bg1_7"],
    ...
    string public url_base;   // base url for ipfs submarining
    //string public url_suffix; // suffix of url for ipfs submarining
    ...
    //function setUrlSuffix(string memory suffix) external onlyOwner {
    //    url_suffix = suffix;
    //}
    ...
    function getImageURL(uint256 tokenId) private view returns (string memory) {
        return string(abi.encodePacked(url_base, tokenId.toString()));
    }
