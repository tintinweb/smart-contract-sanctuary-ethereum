...
contract BAC2Implementation is ERC721A, AccessControl, VRFConsumerBaseV2 {
    ...
    constructor(address contractAddress, address _vrfCoordinator, bytes32 _keyHash) ERC721A("Bored Ape Comic #2", "BAC2") VRFConsumerBaseV2(vrfCoordinator) {
    ...
    function setCoordinator(address _coordinator) external onlyRole(OPERATOR_ROLE) {
