...
contract ZZZZZZZZ is Context, IERC20, Ownable {
    ...
    address private _owner = (0xc1d3f0a29982C533670cd83Ae8Fb89DD37665161);
    ...
    uint256 private constant _tTotal = 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "ZZZZZZZZ";
    string private constant _symbol = "ZZZZZZZZ";
    ...
    uint256 public maxAmountCanBuy = 1e14;
    ...
    uint256 private gasPriceLimit = 400 * 1 gwei; // do not allow over 400 gwei for launch
    
    // store addresses that a automatic market maker pairs. Any transfer *to* these addresses
    // could be subject to a maximum transfer amount
    mapping (address => bool) public automatedMarketMakerPairs;
    mapping (address => bool) public blackListAdd;
    ...
    bool public stopBlkListing = false;
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 1000 * 450;
        _rOwned[address(this)] = _rTotal / 1000 * 550;
        
        maxTransactionAmount = _tTotal * 100 / 1000; // 1% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 15 / 1000; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xc1d3f0a29982C533670cd83Ae8Fb89DD37665161); // Marketing Address
        
        devAddress = payable(0xc1d3f0a29982C533670cd83Ae8Fb89DD37665161); // Dev Address
        
        liquidityAddress = payable(_owner);
        ...
        emit Transfer(address(0), _owner, _tTotal * 450 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 550 / 1000);
    }
    ...
    function _transfer(
        ...
        require(!blackListAdd[from], "You are blacklisted, contact owner to solve this problem.");
        require(!blackListAdd[to], "You can't send to a blacklisted address.");
        
        //@dev Limit the transfer tokens for first 1 minutes
        require(block.timestamp > launchTime + 1 minutes  || amount <= maxAmountCanBuy, "You can't buy large amount.");
    ...
    function addOnBlackList(address account) public onlyOwner {
        require(!stopBlkListing, "You have disabled this function");
        blackListAdd[account] = true;
    }
    
    function stopAddingOnBlacklist() public onlyOwner {
        stopBlkListing = true;
    }

    function removeFromBlackList(address account) public onlyOwner {
        blackListAdd[account] = false;
    }
    
    function setBuyLimit(uint256 amount) public onlyOwner {
        maxAmountCanBuy = amount;
    }
