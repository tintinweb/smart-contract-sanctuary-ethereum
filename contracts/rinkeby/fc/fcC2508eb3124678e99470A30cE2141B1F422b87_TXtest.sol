...
contract TXtest is ERC721A, Ownable, ReentrancyGuard {
    ...
    address private constant AA_ADDRESS =
        0x9bB755DcD634bE970E80f9643ad229a196448878;
    ...
    constructor() ERC721A("TX", "TRIBv1.6") {}
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        _withdraw(AA_ADDRESS, (contractBalance * 10) / 100);
        _withdraw(BB_ADDRESS, (contractBalance * 10) / 100);
        _withdraw(CC_ADDRESS, address(this).balance);
    }
