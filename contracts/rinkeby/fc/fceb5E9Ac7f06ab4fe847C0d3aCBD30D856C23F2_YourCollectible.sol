...
contract YourCollectible is Context, ERC165, IERC721, IERC721Metadata,
IERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Address for address;
    using Strings for uint256;
    //
    event MintInfo(uint256 indexed id, uint256 indexed songId, uint256 indexed songSerial);
    //
...
//not needed anymore as theyre defined up top explicitly now
//    constructor() ERC721("DeSante Records", "JDR") {}
      ...
      function tokenByIndex(uint256 index) public view override returns (uint256) {
          require(index <= _tokenIds.current(), "Token Index out of bounds");
          return index;
      }

      function tokenOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256) {
          //require(index <= balanceOf(owner), "Owner Index Out Of Bounds");
          uint256 numMintedSoFar = _tokenIds.current();
          uint256 tokenIdsIdx;
    ...
    //could be removed when deployed to mainnet maybe
    //sets the baseURI
    ...
    function safeTransferFrom(
      ...
      require(!_checkOnERC721Received(from, to, tokenId, _data), "TransferToNonERC721ReceiverImplementer");
    }
    ...
    //
          ...
          onlyOwner
      {
          ...
          emit MintInfo(id, songId, songSerial);
      }
          ...
          onlyOwner
      {
          ...
          require(songSerial < 5, "Max amount of copies reached");
