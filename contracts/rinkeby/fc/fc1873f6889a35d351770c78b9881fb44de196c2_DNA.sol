...
contract DNA is ERC1155, Ownable, AccessControl, ReentrancyGuard, VRFConsumerBaseV2 {
        ...
        VRFConsumerBaseV2(vrfCoordinator)
    {
        ...
        boosts.push(Boost({ cost: 150 ether, rarities: [uint256(2), 10, 35, 80] }));     // basic boost (2%, 8%, 25%, 45%, 20%)
        boosts.push(Boost({ cost: 10 ether, rarities: [uint256(1), 5, 20, 100] }));      // no commons (1%, 4%, 15%, 80%, 0%)
        boosts.push(Boost({ cost: 30 ether, rarities: [uint256(0), 0, 50, 50] }));       // 50/50 rare/common (0%, 0%, 50%, 0%, 50%)
        boosts.push(Boost({ cost: 300 ether, rarities: [uint256(20), 40, 60, 80] }));    // flattened (20%, 20%, 20%, 20%, 20%)
        boosts.push(Boost({ cost: 1000 ether, rarities: [uint256(0), 100, 100, 100] })); // always epic (0%, 100%, 0%, 0%, 0%)
    }
