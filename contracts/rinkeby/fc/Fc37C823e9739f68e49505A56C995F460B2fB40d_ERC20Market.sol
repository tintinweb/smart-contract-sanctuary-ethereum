...
// File: ERC20Marketplace/ERC20Market.sol
...
contract ERC20Market is Ownable {
    ...
    function buyToken(uint amount) external payable {
        require(token.balanceOf(address(this))>= amount, "Contract does not have enough supply");
        require((amount*price)>= msg.value, "Not enough funds provided");
