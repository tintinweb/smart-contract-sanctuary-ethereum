...
//  / ___/__  ___  / / / /  ___ ____/ /_ __  / ___/ /_ __/ / 
// / /__/ _ \/ _ \/ / / /__/ _ `/ _  / // / / /__/ / // / _ \
// \___/\___/\___/_/ /____/\_,_/\_,_/\_, /  \___/_/\_,_/_.__/
//                                  /___/                                  
// ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
// ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
// ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
...
contract CoolLadyClub is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public maxAmountForPublic = 1500;
   ...
   modifier isNotExceedMaxMintPerTx(uint256 amount) {
        ...
        isNotExceedMaxMintPerTx (_mintAmount)
    {
        ...
        require(totalSupply() + _mintAmount <= maxAmountForPublic, "Not enough remaining supply for public");
    ...
    function setWhiteList(address[] memory addresses, uint256[] memory place)
        external
        onlyOwner 
    {
        require(addresses.length == place.length, "addresses does not match numSlots length");
        for (uint256 i = 0; i < addresses.length; i++) {
        whitelist[addresses[i]] = place[i];
        }
    }

    function addHolders(address[] memory _addresses, uint256[] memory claimableTokens)
        public
        onlyOwner
    {
        require(_addresses.length == claimableTokens.length, "addresses and tokenid length mismatch");

        for (uint256 i = 0; i < _addresses.length; i++) {
            claimableToken[_addresses[i]] = claimableTokens[i];
        }
    }
    ...
    function withdraw() 
        ...
        nonReentrant 
    {
        (bool dev, ) = payable(0x978b29EBbe40E47D8f1Ec0867fEB2671f7660A17).call{value: address(this).balance * 15 / 100}(""); 
        require(dev);
        (bool co, ) = payable(owner()).call{value: address(this).balance}("");
        require(co);
    }
}