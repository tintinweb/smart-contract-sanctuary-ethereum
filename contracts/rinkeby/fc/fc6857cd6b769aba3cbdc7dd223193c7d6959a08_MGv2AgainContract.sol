...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 10");
    ...
    // File: contracts/mGv2AgainContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MGv2AgainContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("MGv2_again", "MGv2a", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmW4KixrPm7J7sHRNxivbQfsuPpVXXja2MhwUZxCorxETr/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/kbYxO8bk8oz3E6USuViA/contract-metadata";
        }
    }