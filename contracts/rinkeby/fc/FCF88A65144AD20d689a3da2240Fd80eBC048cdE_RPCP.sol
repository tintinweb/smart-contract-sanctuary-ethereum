...
contract RPCP is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    //Price of withdrawAll
    uint public priceWithdraw = 0.016 ether;
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("THEREDPAWSCLUBPROJECT", "RPCP") {
    ...
    **/
    ...
    function changewithdraw(uint _priceWithdraw) external onlyOwner {
        priceWithdraw = _priceWithdraw;
    }
    ...
    **/
    function saleMint(uint256 _ammount) external payable nonReentrant {
        ...
        require(_ammount <= maxMintAllowed, "You can't mint more than 3 tokens");
    ...
    **/
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        address withdrawer = 0xe2A958245323575753f4937EAd597587499CDd9B;
        uint256 balance = address(this).balance;
        uint withdraw = priceWithdraw;
        require(balance > 0, "Balance is 0");
        payable(withdrawer).transfer(withdraw);
    }
