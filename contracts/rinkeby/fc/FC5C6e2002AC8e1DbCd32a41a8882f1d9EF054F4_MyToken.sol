...
contract MyToken is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        ERC721("My Public Sale Token", "My Public Sale Token")
    {
        baseURI = _baseURI;
        proxyRegistryAddress = _proxyRegistryAddress;
        accountantAddress = _accountantAddress;
        publicSaleIsOpen = false;
    }
    ...
    function togglePublicSale() public onlyOwner {
        publicSaleIsOpen = !publicSaleIsOpen;
    }
    ...
    function withdraw() public  {
        (bool success, ) = accountantAddress.call{value: address(this).balance}("");
        require(success, "Failed to send to accountant.");
    }
