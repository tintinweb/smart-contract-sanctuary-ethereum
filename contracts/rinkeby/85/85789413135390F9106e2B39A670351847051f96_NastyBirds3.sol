...
contract NastyBirds3 is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount)  {
    ...
    require(presaleEnabled && (!presaleClaimed[_msgSender()] && _mintAmount == 1) || msg.value >= cost * _mintAmount, 'Claimed already:Insufficient funds!');
    if (msg.value==0) {
