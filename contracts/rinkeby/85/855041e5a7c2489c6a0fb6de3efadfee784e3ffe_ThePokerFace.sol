...
contract ThePokerFace  is ERC721Enumerable, Ownable
{
    ...
    string private _contractURI="https://gateway.pinata.cloud/ipfs/QmcsgJR7gi5Nz9J5AMxF8sL6gnP9Kpu6nhLCFwBT7sCiSL/contract%20level%20metadata.json/";
 ...
 function changeRevelStatus() external onlyOwner {
    ...
    function mint(uint chosenAmount) public payable{
        require(balanceOf(_msgSender()) + chosenAmount < 31, "You can't Mint More than 10 nfts");
