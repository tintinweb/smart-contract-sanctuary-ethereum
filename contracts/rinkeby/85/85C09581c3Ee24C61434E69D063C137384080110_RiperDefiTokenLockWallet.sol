...
/**
 * @title RiperDefiTokenLockWallet
 * @notice This contract is built on top of the base RiperDefiTokenLock functionality.
 ...
 * The function calls allowed are queried to the RiperDefiTokenLockManager, this way
...
import "../interfaces/IRiperDefiTokenLock.sol";

/**
 * @title RiperDefiTokenLock
 ...
 * default schedule.
 */
abstract contract RiperDefiTokenLock is Ownable, IRiperDefiTokenLock {
