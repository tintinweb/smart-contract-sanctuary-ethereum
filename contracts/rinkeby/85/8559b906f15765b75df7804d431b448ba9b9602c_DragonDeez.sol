...
contract DragonDeez is ERC721A, Ownable {
    ...
    mapping(address => bool) public vipMint;
    ...
    bytes32 public vipMerkleRoot = 0x07e1a5b2aa5adeac0870d2eb53677fb8369dc6dd6ab197a681c912e470a63aa2;
    ...
    function whitelistMint(uint256 _quantity, bool _isvip, bytes32[] calldata _merkleProof, bytes32[] calldata _vipMerkleProof) external payable {
        
        require(_quantity > 0, "Quantity cannot be less than 0");

        if (_isvip && freeMintCounter <= MAX_FREE_SUPPLY){

            if (!vipMint[msg.sender]){
            ...
            require(vipMint[msg.sender] == false, "Already Minted!");
            require(msg.value >= PRICE * (_quantity - 1), "Not enough Ether");
            require(whitelistedMint[msg.sender] >= 2, "Already Minted");

            bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
            require(MerkleProof.verify(_vipMerkleProof, vipMerkleRoot, leaf), "Invalid Merkle Proof");

            vipMint[msg.sender] = true;
