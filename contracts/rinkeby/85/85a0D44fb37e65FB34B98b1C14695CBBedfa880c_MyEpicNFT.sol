...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Banana", "Maca", "Uva", "Mamao", "Laranja", "Morango"];
  string[] secondWords = ["Pacoca", "Creme", "Nata", "Leite Condensado", "Doce de Leite", "Leite em Po"];
  string[] thirdWords = ["Sorvete", "Acai", "Pudim", "Mussi", "Geleia", "Pasta"];
