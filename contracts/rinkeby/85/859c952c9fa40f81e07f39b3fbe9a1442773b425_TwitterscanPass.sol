...
contract TwitterscanPass is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    function setBegin(uint begin) external onlyRole(DEFAULT_ADMIN_ROLE) {
        conf.begin = begin ;
    }
    ...
    function whitelistMint (uint vol,bytes32[] calldata _merkleProof) public whenNotPaused payable{
        ...
        require(claimed<2, "Address have already claimed.");
