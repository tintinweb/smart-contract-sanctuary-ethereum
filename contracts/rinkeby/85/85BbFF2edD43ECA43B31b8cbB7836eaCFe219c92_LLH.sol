...
contract LLH is ERC721Enumerable, Ownable {
    ...
    uint256 public LLHPrice_whitelist = 5550000000000000000;
	  uint256 public LLHPrice_public = 5550000000000000000;
    uint public maxLLHTx = 1;
	  uint public maxLLHPurchase = 10;
    uint public maxLLHPurchaseWl = 1;
    uint public maxLLHPurchaseVip = 2;

    uint256 public constant MAX_LLH = 6666;
    uint public LLHReserve = 100;
	  uint public LLHWhitelistReserve = 3900;
