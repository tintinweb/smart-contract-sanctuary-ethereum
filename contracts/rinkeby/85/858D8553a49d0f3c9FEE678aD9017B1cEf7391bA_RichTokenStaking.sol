...
contract RichTokenStaking is Ownable, ReentrancyGuard {
    ...
    uint256 constant public stakingPeriodLength = 600 seconds;
    ...
    function poolInfo() public view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (
            startStakingTs,
            canClaimTs,
            rewardAmount, 
    ...
    function userReward(address account) public view returns (uint256) {
        ...
        return userStakedQty * rewardAmount / totalStaked;
    }
    ...
    function claimReward() nonReentrant external {
        ...
        uint256 canClaimQty = userReward(msg.sender);
