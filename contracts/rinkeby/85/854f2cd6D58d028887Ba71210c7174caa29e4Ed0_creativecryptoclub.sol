...
// File: contracts/generativecryptoclub.sol
...
contract creativecryptoclub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("creative crypto club", "CCC") {
    setHiddenMetadataUri("ipfs://QmdYtLMoBWcav2fenBE7oMTnC8BQpyAJzyKm3mbvosaXu4/hidden.json");
  }
