...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/Qmd5stMQuWc1T3fEBwM79VpD2kv8jEdNNxYV7oLoK4QtkS/"; // 這一行是 NFT 該去哪裡找你的 MetaData
    bool public paused = false; // 可以拿來暫停或者開啟 Mint
    uint256 public cost = 0.01 ether; // Mint 價格
    uint256 public maxSupply = 9; // 只有9個 NFT
    uint256 public maxMintAmount = 8; // 一次最多只能 Mint 一個

    constructor() ERC721("0841test2", "Test2") payable {
        // 剛開始我們先自己 Mint 一個
