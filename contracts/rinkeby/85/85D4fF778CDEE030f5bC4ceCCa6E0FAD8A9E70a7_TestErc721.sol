...
/// @author ac019
contract TestErc721 is ERC721A, AccessControl, ReentrancyGuard {
    //management
    ...
    ) ERC721A("TestErc721", "TESTERC721") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(DEFAULT_ADMIN_ROLE, _contractOwner);
        _setupRole(MINTER_ROLE, _craftingContract);
        _setupRole(BURNER_ROLE, _craftingContract);
        _setupRole(TRANSFER_ROLE, _marketContract);
        ...
        nonReentrant
    {
        ...
        require(
            userMinted[_recipient] + _mintAmount <= MAX_PER_TRANSACTION,
            "Exceeded max allowlist mints"
        );
        ...
        botCheck
    {
        ...
        require(
            _mintAmount <= MAX_PER_TRANSACTION,
    ...
    function setSaleState(bool _isAllowlistSale, bool _isPublicSale)
        public
        onlyOwner
    {
        isAllowlistSale = _isAllowlistSale;
        isPublicSale = _isPublicSale;
        emit SetSaleState(_isAllowlistSale, _isPublicSale);
    }
