...
contract Pixelmon is ERC721, Ownable {
    ...
    address constant gnosisSafeAddress = 0x9Cac0d8DD513D45e9501E834123a349c46DC79da;

    /// @dev 7750, plus 330 for the Pixelmon Gnosis Safe
    uint constant auctionSupply = 7750 + 330;

    uint256 constant dutchAuctionTimeInterval = 1 minutes;
    ...
    uint256 public auctionStartTime = 1644256800;
    ...
    uint256 public mintlistPrice = 0.25 ether;
    ...
    /// block.timestamp is in SECONDS, not MILLI SECONDS
...
//=========================== Your functions used for testing
    ...
    function almostCurrentPrice() public view returns (uint256) {
        uint256 priceChanges = (( block.timestamp - auctionStartTime ) /  1 minutes ) * 0.1 ether ;
    ...
    function test_priceChanges() public view returns (uint256) {
        return (( block.timestamp - auctionStartTime ) /  1 minutes ) * 0.1 ether ;
    }
