...
contract BiPlaneBobo is ERC721A, Ownable {
    ...
    bool public mlSaleActive = false;
    ...
    constructor(string memory baseURI) ERC721A("BiPlane Bobo", "BPBobo") {
        baseUri = baseURI;
    }
    ...
    // Mint functionality ------------------------------------------------------------------------
    // Validates a signature of an address padded to 32 bytes with a byte suffix of 1
    ...
    // Validates a signature of an address padded to 32 bytes with a byte suffix of 2
