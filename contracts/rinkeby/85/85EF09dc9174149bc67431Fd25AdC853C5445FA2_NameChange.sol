...
contract NameChange is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ILoomi public loomi;
    ...
    function initialize(address _loomi) external {
      firstNamePrice = 10000 ether;
      titlePrice = 50000 ether;
      secondNamePrice = 20000 ether;
    ...
    */
    function updateFirstNamePrice(uint256 _fNamePrice) public onlyOwner {
      require(_fNamePrice < MAX_PERCENT, "Wrong value passed");
      firstNamePrice = _fNamePrice;
    }

    /**
    * @dev Function allows admin to update step amount.
    */
    ...
    /**
    * @dev Function allows admin to update tax increment amount.
    */
    function updateTitlePrice(uint256 _titlePrice) public onlyOwner {
      titlePrice = _titlePrice;
    }
