...
// bLAH BLAH LALALALA LAAAAAAAA
// MINT 0.01
// MAX 100,000
// REVEAL AFTER MINT COMPLETES
...
abstract contract SOLRIERC721A is 
    Ownable,
    ERC721A,
    ReentrancyGuard  {
    constructor(
    ...
    ) ERC721A(tokenName, tokenSymbol, 500, 100000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVqeHFNzzzMhC7yDEj15YCEwCaq6Np7FAQVAqWpQ1Dfuk/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 100000");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 100000");
...
// File: contracts/SoladriContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SolarDriveContract is SOLRIERC721A {
    constructor() SOLRIERC721A("SolarDrive", "SOLDRI"){}

    function contractURI() public pure returns (string memory) {
      return "https://gateway.pinata.cloud/ipfs/QmapuvuUaNUC1TwkLPgoF83UwwjvmfZqoosdWHyhpRfE22";
    }
}