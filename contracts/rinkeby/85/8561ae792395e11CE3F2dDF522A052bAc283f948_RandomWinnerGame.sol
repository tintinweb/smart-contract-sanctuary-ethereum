...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    /**
    *startGame starts the game by setting all the required values
     */
     function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner{
        ...
        delete players;
        //set maxPlayers for the game
        maxPlayers = _maxPlayers;
        //set gameStarted to true
        gameStarted = true;
        //set entryFee for the game
        entryFee = _entryFee;
        gameId +=1;
     ...
     /**
     * joinGame is the function called when a user wants to join the game
     */
