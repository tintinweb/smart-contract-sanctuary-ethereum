...
contract NovaCats is ERC721, Owned {
   ...
   /// ERRORS
        ...
        returns (string memory)
    {
        ...
        string memory description = "Nova Cats. Cat emoji designed by OpenMoji (the open-source emoji and icon project). License: CC BY-SA 4.0";
        ...
        returns (string memory)
    {
        string memory svg = string.concat(
            ...
            "novacat",
            Strings.toString(tokenId),
            '" width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">',
