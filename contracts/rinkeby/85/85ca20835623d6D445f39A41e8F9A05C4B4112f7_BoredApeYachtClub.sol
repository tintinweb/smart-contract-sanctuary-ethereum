...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        bool  revealed= false;
        string memory revealUrl= "https://ipfs.io/ipfs/QmYv6G47fwdbG4JE3Aakz63NrAKSiLpjAidSWiScosQ5PR/locked.json";
...
contract BoredApeYachtClub is ERC721, Ownable {
    ...
    string public revealUrl = "ipfs.io/ipfs/QmYv6G47fwdbG4JE3Aakz63NrAKSiLpjAidSWiScosQ5PR/locked.json";
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 saleStart) ERC721(name, symbol) {
        ...
        REVEAL_TIMESTAMP = saleStart + (0 * 9);
    }
