...
contract AmusedMonkeys is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant RESERVED_TOKENS_1 = 25;
    uint256 public constant RESERVED_TOKENS_2 = 725;
    uint256 public constant FOR_SALE_TOKENS = 100000 - RESERVED_TOKENS_1 - RESERVED_TOKENS_2;
    address public constant RESERVED_TOKENS_ADDRESS_1 = 0x4aB97F3609d97e5FF5bD33a2aC6B097a3f9B7781;
    address public constant RESERVED_TOKENS_ADDRESS_2 = 0x68474f92dcb9Fb9634EDE7D59C8c06747fCD3fB7;
    ...
    uint256 public tokenPricePresale = 0.008 ether;
    uint256 public tokenPricePublicSale = 0.01 ether;

    uint256 public maxTokensPerAddressPresale = 25;
    uint256 public maxTokensPerAddress = FOR_SALE_TOKENS;
    ...
    constructor() ERC721A("Amused Monkeys", "AMRP") {
        _safeMint(RESERVED_TOKENS_ADDRESS_1, RESERVED_TOKENS_1);
        _safeMint(RESERVED_TOKENS_ADDRESS_2, RESERVED_TOKENS_2);
    }
