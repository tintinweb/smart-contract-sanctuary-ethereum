...
contract ACTE is AbstractERC1155Factory  {
    ...
    */
    ...
    function toggleRaining() external onlyOwner{
        isRaining = !isRaining;
    }
    ...
    */
    function uri(uint256 _id) public view override returns (string memory) {
        ...
        uint256 trueId = _id + 1;

		if(isRaining){
			return bytes(baseRainTokenUri).length > 0 ? string(abi.encodePacked(baseRainTokenUri, Strings.toString(trueId), ".json")) : "";
		}
		
        return bytes(baseTokenUri).length > 0 ? string(abi.encodePacked(baseTokenUri, Strings.toString(trueId), ".json")) : "";
    }
    ...
    */
    function freeMint(
        ...
        require(mintFreeAmount[msg.sender] < maxAmountFreeMint , "Free Minting :: Max amount exceeded");
    ...
    */
    function whitelistMint(
        ...
        require(mintWhitelistAmount[msg.sender] < maxAmountWhitelist , "Whitelist Sale :: Max amount exceeded");
    ...
    */
    function publicMint(uint256 amount) external payable whenNotPaused callerIsUser {
        ...
        require(mintPublicSaleAmount[msg.sender] < maxAmountPublic , "Public Sale :: Max amount exceeded");
