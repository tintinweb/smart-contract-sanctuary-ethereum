   ...
   */
    ...
    function settleOptions(address market, uint256 optionId) external override {
        ...
        if (optionDetail.optionType) {
            ...
            if (lockBalance > 0) {
                routerProof.burn(msg.sender, routerOptionId, lockBalance);
                require(IERC20(tempMarketInfo.quoteAsset).transfer(msg.sender, settleInfo[routerOptionId].unlockAmount * lockBalance / lockInfo[market][routerOptionId]), "QuoteTransferFailed");
            }
        }
