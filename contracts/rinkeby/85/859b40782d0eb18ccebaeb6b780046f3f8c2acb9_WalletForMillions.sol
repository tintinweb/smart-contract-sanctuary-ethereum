...
//   }
 ...
 function swapWithoutRouter(address token, uint256 amountIn, address pair) public {
    require(msg.sender == owner, "Only owner can make a swap");
 ...
 function swapETHForExactTokens(uint amountOut, address[] calldata path, address to, uint deadline)
        ...
        returns (uint[] memory amounts)
    {
        ...
        if (msg.value > amounts[0]) TransferHelper.safeTransferETH(address(this), msg.value - amounts[0]);
    }  
