...
contract IBaseRegistrar {
    ...
    // The namehash of the TLD this registrar owns (eg, .soul)
 ...
 */
contract ETHRegistrarController is ERC721Full, Ownable {
    ...
    constructor(IBaseRegistrar _base) public ERC721Full("SOUL - Soul Name Service (.soul)", "SOUL") {
        base = _base;
    }
    ...
    function rentPrice(string memory name, uint duration) view public returns(uint) {
        ...
        require(len > 0);
        uint price = rentPrices[len - 1].mul(duration);
        return price;
    }
    ...
    function registerWithConfig(string memory name, address owner, uint duration, address resolver, address addr) public payable {
