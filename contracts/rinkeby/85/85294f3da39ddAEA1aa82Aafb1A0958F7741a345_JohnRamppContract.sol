...
//
//            __      __             ____                            
//           / /___  / /_  ____     / __ \____ _____ ___  ____  ____ 
//      __  / / __ \/ __ \/ __ \   / /_/ / __ `/ __ `__ \/ __ \/ __ \
//     / /_/ / /_/ / / / / / / /  / _, _/ /_/ / / / / / / /_/ / /_/ /
//     \____/\____/_/ /_/_/ /_/  /_/ |_|\__,_/_/ /_/ /_/ .___/ .___/ 
//                                                    /_/   /_/      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD1B74864a770d197Fe66fb6472012589D712E55F];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfY1gk715vmXgFEWdZgXHwdWZB8BWHbmaQkF8meQpa6Wo/";
...
// File: contracts/JohnRamppContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JohnRamppContract is RamppERC721A {
    constructor() RamppERC721A(" John Rampp ", "John"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/y7Q5pJkvtLnimibCJ6iG/contract-metadata";
    }
}
