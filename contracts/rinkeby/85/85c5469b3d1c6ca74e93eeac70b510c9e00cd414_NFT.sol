...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint private silverAmount;
  string private zoomLink;
...
function setLink(string memory _link)public onlyOwner{
    ...
    returns (string memory)
  {
    ...
    if (tokenId <= silverAmount){
        return silveruri;
    }else{
        return golduri;
    }
  }
    function setSilverAmount(uint256 _newSilverAmount) public onlyOwner {
        silverAmount=_newSilverAmount;
    }
