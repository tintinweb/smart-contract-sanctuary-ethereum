...
contract Amm is IAmm, AmmStorageV1, BlockContext, OwnerPausable, ReentrancyGuardUpgradeable {
        ...
        )
    {
        ...
        if (_coinBalances[0] != 0 && _coinBalances[1] != 0) {
            ...
            //AM_IBIA imbalance initial amounts
            require(amount0Desired == (priceCurrent * amount1Desired) / 1e18, "AM_IBIA");
        }
        ...
        require(liquidity >= minLiquidity, "AM_TLRAL");
    ...
    function removeLiquidity(
        ...
        for (uint8 i = 0; i < N_COINS; i++) {
            ...
            require(tokenAmount >= (i == 0 ? minAmount0 : minAmount1), "AM_TLRRL");
        ...
        returns (uint256)
    {
        ...
        uint256[N_COINS] memory amountsp = [
            amount0Desired * _coinPrecisions[0],
            (amount1Desired * _priceScale * _coinPrecisions[1]) / PRECISION
        ];
        xp[0] += amountsp[0];
        xp[1] += amountsp[1];
