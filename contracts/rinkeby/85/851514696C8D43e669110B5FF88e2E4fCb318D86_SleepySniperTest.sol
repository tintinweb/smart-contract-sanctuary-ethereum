...
contract SleepySniperTest is ERC721A {
    ...
    constructor(string memory name, string memory symbol, bytes32 whiteListMerkleRoot, uint premintTokensNumber, address premintAddress, address[] memory admins ) ERC721A(name, symbol){
    ...
    function contractURI() public view returns(string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmeyqrXjyQqFpCWT7m5HP4B7XeVnSjQFJ6CWWmeZ73L45a";
    }
}
