...
contract NomadMinting is Initializable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function withdraw() public {
    ...
    (bool success, ) = payable(0xBc18CB7be21d7225F85f07408152FBc71f3380c1).call{
      value: (balance * 10) / 100
    }("");
    require(success);
    (success, ) = payable(0x5be495FFE3C171babdDd16AFb8BA816deF29d26c).call{
      value: (balance * 10) / 100
    }("");
    require(success);
  ...
  function setFirstToken() public onlyOwner {
    _setTokenData(
