...
contract NinfaERC721 is ERC2981, AccessControl, ERC721Enumerable  {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string( // once hex decoded base58 is converted to string, we get the initial IPFS hash, i.e. the base58 bytes become QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq
            abi.encodePacked(
                _baseTokenURI,
                toBase58( // 0x516d65536a53696e4870506e6d586d73704d6a776958794e367a533445397a63636172694752336a786361577471 base 58 decoded example
                    abi.encodePacked( // 0x1220ef49d44a221b579b006caa311062451f410338ca98a131dc7ab8df9bbe76ec0a full bytes of base58 + hex encoded IPFS hash example.
                        ...
                        _tokenURIs[tokenId] // tokenURI (IPFS hash) with its first 2 bytes truncated, base58 and hex encoded returned as bytes32: 0xef49d44a221b579b006caa311062451f410338ca98a131dc7ab8df9bbe76ec0a (example)
                    )
                )
            )
        );
    ...
    /**
     * @dev https://github.com/MrChico/verifyIPFS/blob/master/contracts/verifyIPFS.sol#L28
     */
...
abstract contract ERC2981 is IERC2981, ERC165 {
     ...
     * TODO The original author may want to change the royalty receiver address (or the royalty percentage).
     */
