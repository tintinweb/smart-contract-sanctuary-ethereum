...
contract MagicRainbow is Ownable, ERC721A {


    uint256 public adoptionLimit = 20;
    uint256 public adoptionLimitWL = 20;

    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    string public baseURI = "https://dirfotco.vercel.app/api/nft/";
    string public _extension = "";
    uint256 public price = 0.09 ether;
    uint256 public maxSupply = 1000;
    uint256 public freeMintSupply = 0;
    
    constructor() ERC721A("Magic Rainbow", "MR"){}
    ...
    function mintNFT(uint256 _quantity) public payable {
        ...
        require(msg.value == get_price() * _quantity, "Needs to send more eth");
        ...
        if(get_price() == 0){
            require(totalSupply() + _quantity <= freeMintSupply,"Reaching Max Free Mint Supply");
        }
   ...
   function update_freeMintSupply(uint256 _temp) public onlyOwner() {
        freeMintSupply = _temp;
    }
