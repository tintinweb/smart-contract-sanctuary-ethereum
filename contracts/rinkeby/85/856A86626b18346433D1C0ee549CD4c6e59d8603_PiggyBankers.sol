...
contract PiggyBankers is ERC721A, Ownable, PaymentSplitter {
    ...
    address[] private team_ = [
        0x831BF0657E0c1256297053802dE80D47AAec1876
    ];
    ...
    function presaleMint(
        ...
        require(
            amount <= max,
            "PiggyBankers: You can't mint more tokens at presale!"
        );
    ...
    function reserveTokens(uint256 amount) external {
        require(
            canReserveToken[msg.sender] == true,
            "PiggyBankers: You are not allowed to reserve tokens"
        );
        require(
            totalSupply() + amount <= maxSupply,
            "PiggyBankers: You can't mint mint than max supply"
        );
