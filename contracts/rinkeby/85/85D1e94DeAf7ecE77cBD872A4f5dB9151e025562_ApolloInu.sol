...
contract ApolloInu is IERC20, Context {
    ...
    function bigDivide (uint256 nominator, uint256 denominator) external view returns (uint256) {
        return (nominator / denominator);
    }

    function bigSubtract (uint256 nominator, uint256 denominator) external view returns (uint256) {
        return (nominator - denominator);
    }
