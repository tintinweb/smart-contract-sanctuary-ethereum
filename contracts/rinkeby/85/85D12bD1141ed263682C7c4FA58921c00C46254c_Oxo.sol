...
contract Oxo is ERC721, Ownable {
    ...
    string public notRevealedUri; //Uri if tokens are not revealed
    bool public isRevealed; //Enabling reveal uri
    ...
    constructor() ERC721("testArt", "TXT") {
        totalSupply = 100;
        reserve = 10;
        preSalePrice = 9000000000000000;
        publicPrice = 10000000000000000;
        tokenId = 0;
        publicSaleEvent = false;
        whitelistSaleEvent = true;
        isRevealed = true;
        baseUri = "https://oxo-art-7wofb.ondigitalocean.app/tokens/";
        contractUri = "https://oxo-art-7wofb.ondigitalocean.app/tokens/contract.json";
        baseExtension = ".json";
        ...
        payable
    {
        ...
        require(
            balanceOf(msg.sender) + number <= maxTokensWallet,
