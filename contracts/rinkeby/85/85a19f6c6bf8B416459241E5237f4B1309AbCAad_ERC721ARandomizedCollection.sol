 ...
 * which allows for up to 10 times cheaper MINT gas fess, but does increase first time TRANSFER gas fees.
 *
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // of checking 10 values, but is up to 10 times cheaper on batch mints.
    uint256 internal constant SEQ_MINT_LIMIT = 10;
...
abstract contract ERC721Marketplace is ERC721A, Ownable {
    ...
    function retrieveLoan(uint256 tokenId) external {
        ...
        // No check necessary because borrowerAddress the result of ownerOf()
        _safeTransferIgnoreOwner(borrowerAddress, msgSender, tokenId, "");
 ...
 *
 * With a reveal mechanism, the price of minting becomes very cheap with the help of ERC721A improvements.
 */
contract ERC721ARandomizedCollection is ERC721Marketplace {
    ...
    /**
     * @dev returns if this collection already has the final IPFS hash of it's tokens
