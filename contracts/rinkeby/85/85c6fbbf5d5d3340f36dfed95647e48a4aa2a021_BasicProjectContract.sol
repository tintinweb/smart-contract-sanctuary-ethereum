...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/basicProjectContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract BasicProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Basic Project", "BASIC", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://infinite.com/token/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/dI4nVm6tIkAOpEiQ79Qf/contract-metadata";
        }
    }