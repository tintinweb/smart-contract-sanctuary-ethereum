...
contract FinNFE is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xEE323D325DbD7179381dAaA90747bC01d0484feA);
    ...
    constructor() ERC20("FinViv", "ViFIN") {
