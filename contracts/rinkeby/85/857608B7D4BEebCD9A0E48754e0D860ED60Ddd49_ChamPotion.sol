...
contract ChamPotion is IERC721, Ownable, Functional {
    ...
    constructor() {
        ...
        CHAM = ERC721(0x438c915F69be7cc8B2094373Ea247dD10bb27B60); // TESTNET ONLY FreedomEagleClub
    ...
    function mint(uint256[] memory tokenIds) external payable reentryLock {
    ...
    function mintSingle(uint256 tokenId) external payable reentryLock {
        require(mintActive, "closed for business");
