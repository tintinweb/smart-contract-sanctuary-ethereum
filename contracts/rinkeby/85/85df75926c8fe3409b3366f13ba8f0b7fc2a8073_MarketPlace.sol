    ...
    EIP712Upgradeable
{
    ...
    event LogOrderFinalised721(uint256 tokenId, address buyer, address seller);
    ...
    function finaliseERC721Auction(
        ...
        uint256 bidAmount
    ) public OnlySeller(_auctionId) returns (bool) {
        ...
        emit LogOrderFinalised721(voucher.tokenId, buyer, seller);
        return true;
    }
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "MarketplaceVoucher{address,uint256,uint256,uint256,uint256)"
                        ),
                        voucher.owner,
                        voucher.tokenId,
                        voucher.minPrice,
