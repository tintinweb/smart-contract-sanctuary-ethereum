...
contract ALGOROBOT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ALGOROBOT", "ALRBT") {
    setHiddenMetadataUri("ipfs://QmRRHFZ92UGxX2mmdVNrvHjc65pHUBoZUJh2Lbc7MvbaAN/hidden.json");
  }
