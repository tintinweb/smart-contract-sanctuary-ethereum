...
// File: contracts/TestHoolet.sol

pragma solidity >=0.8.0 <0.9.0;

contract TestHooletGuarantID is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Test Hoolet GuarantID", "TOHG") {}
    ...
    function mintDifferentQuantity(address[] calldata recipients, uint256[] calldata nftQuantityForEachRecipient) public onlyOwner {
        ...
        for (uint256 i = 0; i < recipients.length; ++i) {     
            require(totalSupply() + nftQuantityForEachRecipient[i] <= maxSupply, "Request Exceeds Max Supply");
    ...
    function mintSameQuantity(address[] calldata recipients, uint256 nftQuantityPerRecipient) public onlyOwner {
        for (uint256 i = 0; i < recipients.length; ++i) {     
            require(totalSupply() + nftQuantityPerRecipient <= maxSupply, "Request Exceeds Max Supply");
     ...
     * _newMaxSupply must be greater than or equal to the totalSupply.
     */
    function setMaxSupply(uint256 _newMaxSupply) public onlyOwner {
        require(_newMaxSupply >= totalSupply(), "newMaxSupply must be greater than or equal to the totalSupply");
