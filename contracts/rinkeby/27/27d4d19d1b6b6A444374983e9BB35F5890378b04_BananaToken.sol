...
contract BananaToken is Ownable, MULTIDRIP20 {
     ...
     */
    function startHarvest(address addr, uint128 multiplier) external {
     ...
     */
    function stopHarvest(address addr, uint128 multiplier) external {
        if (msg.sender != monkeVoyagerAddress && msg.sender != owner())
            revert NotOwnerOrMonkeVoyagerContract();
