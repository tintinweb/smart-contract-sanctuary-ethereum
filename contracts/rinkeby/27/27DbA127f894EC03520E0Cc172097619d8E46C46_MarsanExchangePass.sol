...
contract MarsanExchangePass is ERC721i, ReentrancyGuard {
  ...
  string private baseImg = "ipfs://QmZfPBbhWJcNLPc4B8gAknR7vPgxKwvpWGhKb4eAJyGei8";
  /// @dev IPFS video for onchain metadata use.
  string private baseAnim = "ipfs://QmbsrFzsh3mwfgiegtyc7uokHSRRyQhnsnEN3LmZ5tRAyn";
  /// @dev IPFS tokenURI for offchain metadata
  string private baseURI = "ipfs://QmYi3RSrFPj24C9fdtw1Z8m6H46FSB2pbSv3EovvHHwyp7";
