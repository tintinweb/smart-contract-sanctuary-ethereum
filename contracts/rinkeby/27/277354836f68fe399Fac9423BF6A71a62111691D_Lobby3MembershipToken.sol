    ...
    Ownable
{
  ...
  function mintStandardETH(address to, uint256 numTokens) external payable {
    ...
    for (uint256 i=0; i < numTokens; i++) {
      ...
      string memory metadataIndex = append(Strings.toString(standardId), '/uri/');
  ...
  function mintGoldETH(address to, uint256 numTokens) external payable {
    ...
    for (uint256 i=0; i < numTokens; i++) {
      ...
      uint256 tokenId = _tokenIdCounter.current();
      string memory metadataIndex = append(Strings.toString(goldId), '/uri/');
      _safeMint(to, tokenId);
      _setTokenURI(tokenId, metadataIndex);
  ...
  function mintDiamondETH(address to) external payable onlyOwner {
    ...
    string memory metadataIndex = append(Strings.toString(diamondId), '/uri/');
    _safeMint(to, tokenId);
    _setTokenURI(tokenId, metadataIndex);
