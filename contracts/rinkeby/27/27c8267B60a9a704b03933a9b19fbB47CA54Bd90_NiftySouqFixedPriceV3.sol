...
contract NiftySouqFixedPriceV3 is Initializable {
        ...
        returns (Payout memory payout_)
    {
        ...
        if (sale.isERC1155) {
            ...
            if (
                ...
                payment = buyNft_.payment;
            } else {
                require(isSalesupportedTokens[_saleCurrency[buyNft_.offerId]],"unsupported token");
    ...
    function payout(NiftySouqIMarketplace.Payout memory payoutData_) internal {
