...
//  * In this smart contract I have taken every measure possible to
//  * keep the costs of gas managable every step along the way.
//  * 
//  * In this contract I've used several different methods to keep costs down.
//  * 
...
contract Club44 is ERC721Enumerable, ERC2981, Ownable {
    ...
    constructor(
        ...
        _setDefaultRoyalty(_simonoFromRoyalty, 1000);
    }
    ...
    function collectReserves() external onlyOwner {
        ...
        for (uint256 i; i < RESERVES; i++) _safeMint(_msgSender(), i);
    }
    // set mint price
    ...
    function publicMint(uint256 _amount) public payable {
        ...
        require(_totalSupply + 1 < MAX_SUPPLY, "Excedes max supply.");
