...
library Crazy {
    ...
    function getS(uint256 id) external pure returns (string memory){
        ...
        if(id == 8){
            s = '<path d="M900 731.25h506.25v506.25H900V731.25z" fill="#00bbd4"/><path d="M1012.5 843.75h281.25V1125H1012.5V843.75z" fill="#03a8f4"/><path d="M1125 956.25h56.25v56.25H1125v-56.25z" fill="#2195f3"/></g>';
        }
        if(id == 9){
        ...
        if(id == 12){
            s = '<path d="M900 731.25h506.25v506.25H900V731.25z" fill="#ffff8d"/><path d="M1012.5 843.75h281.25V1125H1012.5V843.75z" fill="#ffa200"/><path d="M1125 956.25h56.25v56.25H1125v-56.25z" fill="#e65100"/></g>';
        }
        if(id == 13){
