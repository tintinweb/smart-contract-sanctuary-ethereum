...
contract IOClone is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant COMMUNITY_SUPPLY = 10;
    uint256 public constant FOUNDERS_SUPPLY = 6;
    ...
    uint256 public publicSaleStartPrice = .011 ether;
    uint256 public constant PUBLIC_SALE_DROP_INTERVAL = 60;
    uint256 public constant PUBLIC_SALE_DROP_AMOUNT = 0.001 ether;
    ...
    function preSaleBuy(
        ...
        if (whitelistClaimed[msg.sender] + mintQuantity > PRESALE_MINT_LIMIT)
