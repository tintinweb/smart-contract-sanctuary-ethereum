...
// Team Management
    ...
    function createTeam(address[] memory _members, string memory _name) public virtual {
        for (uint i = 0; i < _members.length;i++)
            require(!inAnyTeam(_members[i]), "One member is already on a team.");
    ...
    function nominateMember(uint _teamId, address _newAddress) public { // require you are on team
        require(inTeam(_newAddress,_teamId), "You are not on this team");
