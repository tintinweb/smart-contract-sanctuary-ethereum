...
contract BDN is Context, ERC165, IERC721, IERC721Metadata, Ownable, IERC2981 {
    using Address for address;
    using Strings for uint256;

    // Token name
    string private _name = "Test BDN 0.2";

    // Token symbol
    string private _symbol = "BDN-0.2";
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external override view returns (address receiver, uint256 royaltyAmount) {
        return (royaltiesReceiver, _salePrice * 10 / 100);
    }
