...
contract BBTC is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public _baseURIextended = "ipfs://QmNrfhoHrvFPJbUn5gwDAbP3VDQNbv45smQQ1EtfidrKvy/";
    ...
    function update_pool_profit() external onlyOwner  {
        tokens_profit = address(this).balance - total_in_comissions; // + tokens_profit
    }

    function update_pool_exchange() external onlyOwner  {
        project_funds = address(this).balance - total_in_comissions; // + tokens_profit
    }
