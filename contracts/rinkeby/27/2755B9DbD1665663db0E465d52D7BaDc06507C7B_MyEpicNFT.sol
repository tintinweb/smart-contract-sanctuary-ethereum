...
contract MyEpicNFT is ERC721URIStorage {
    ...
    event NewEpicNFTMinted(address sender, uint256 tokenId, uint256 minted);
    ...
    function makeAnEpicNFT() public {
        require(supply < 51, "all supply have been minted");
        ...
        supply++;
        emit NewEpicNFTMinted(msg.sender, newItemId, supply);
    }
