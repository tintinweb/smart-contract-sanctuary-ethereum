...
//expirationPeriod at least the interval of client to feed data(currently 6h in mainnet)
//double here so we have at least 2 prices for each feeder when aggregate
uint64 constant Default_ExpirationPeriod = 21600 * 2;
//reject when price increase/decrease 50 times more than original value
