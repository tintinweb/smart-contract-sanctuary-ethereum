...
contract Guilds is ERC1155Supply {
    ...
    function modMint(address _modAddress, uint256 _amount, uint256 _id) public payable onlyRole(MODERATOR, _id) {
        require(!AllGuilds[_id].Locked, "Guild spots are locked");
        uint256 ownerFee = _amount * minimumMintRate;
        uint256 _modMintLimit = ModMintLimit[_id][_modAddress];
    ...
    function adminSetModMintLimit(uint256 _id, address _account, uint256 _mintLimit) private onlyRole(ADMIN, _id) {
