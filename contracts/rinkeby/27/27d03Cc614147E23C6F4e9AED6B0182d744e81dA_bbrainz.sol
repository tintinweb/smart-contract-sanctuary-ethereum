...
contract bbrainz is ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    uint256 public maxSupply = 8888; // Max amount of NFTs that can be minted in total
    ...
    function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
		...
		require(supply + totalBurned + _mintAmount <= maxSupply, "Max NFT limit exceeded.");
