...
contract OCASnake is Ownable, ERC721A, ERC2981, ReentrancyGuard {
        ...
        returns (uint256)
    {
        ...
        uint256 seed = uint256(
            keccak256(abi.encodePacked(apple, tokenId, salt, uint256(0)))
        );
        return seed;
    }
        ...
        returns (string[30] memory)
    {
        ...
        uint256 rn = (generateAppleSeed(tokenId, 420 + variant) %
            (colors.length - 10)) + 10;
    ...
    function generateColorArray(
        ...
        uint256 o = uint256(generateAppleSeed(tokenId, variant + i) + i);
        ...
        returns (bytes memory)
    {
        ...
        attributesNumbers[0] = AttributesNumbers(
            "Color Count",
            "",
            (generateAppleSeed(tokenId, userConfigList[tokenOwner].variant) %
                (colors.length - 10)) + 10,
            colors.length
        );
