...
contract TurfShop is ERC1155, ERC1155Supply, AccessControl {
  ...
  event ReleaseStatusBlockNumberLog(uint, uint, uint);
  ...
  modifier checkReleaseStatus(uint objectId){
    ...
    if(turfObjects[objectId].releaseType == TurfObjectReleaseType.ON_OFF){
      ...
      emit ReleaseStatusBlockNumberLog(block.number, turfObjects[objectId].startingReference, turfObjects[objectId].endReference);
