...
contract XSFC is ERC721A, Ownable {
    uint256 public constant presalePrice = 0.01e18; // 0.01 ETH
    uint256 public constant price = 0.015e18; // 0.015 ETH
    uint256 public constant SALE_TIME_START = 1658908800; // 2022/07/27 16:00
    uint256 public constant PRESALE_TIME_START = 1658728800; // 2022/07/25 14:00
    uint256 public constant PRESALE_TIME_END = 1658901600; // 2022/07/27 14:00
    ...
    uint256 public mintedAmount; // without teamReward
    ...
    bytes32 public wlRoot = 0x9bd9f064489812b6515f22aa8471d51c971bdc6cc332d2a7d28764bbba0d9394; // todo
    bytes32 public vipRoot = 0x4f02b9eaffc2d9ae04df6c9a91fc52e4c3697f31aaacf42295cb7fc8e2a04892; // todo
    ...
    function presaleMint(uint numberOfTokens, bytes32[] memory wlProof, bytes32[] memory vipProof) external payable {
        ...
        require(PRESALE_TIME_START <= block.timestamp, "Not time yet");  //todo
        require(PRESALE_TIME_END >= block.timestamp, "Out of time");  //todo
    ...
    function mint() external payable {
        ...
        require(SALE_TIME_START <= block.timestamp, "Not time yet"); //todo
    ...
    function withdrawNFT(address recipient,uint256 amount) public onlyOwner{
        ...
        require(block.timestamp > 1659513600 ,"sale is not end!"); //todo 2022/08/03 16:00
