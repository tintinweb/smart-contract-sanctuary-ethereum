...
contract StacktWalletFactory {
    ...
    StacktWalletProxyFactory internal proxyFactory = StacktWalletProxyFactory(0x38Cf7C2bD011Eb005526062C87eC1303c056B7a4);   ///
    address constant stacktWalletSingletonAddress = 0x929fD34dFB1F65dfC6761aa2AfA98d6E67c79a45; ///
    ...
    function createWallet(
        ...
        // setup data
        bytes memory setupData = abi.encodeCall(StacktWallet.setup, (StacktWallet.StacktWalletSetup({msgSender: msg.sender, startFundingTime: _startFundingTime, fundingDuration: _fundingDuration, fundPrice: _fundPrice, funderLimit: _funderLimit}), stacktSetup.to, stacktSetup.data, stacktSetup.fallbackHandler, stacktSetup.paymentToken, stacktSetup.payment, stacktSetup.paymentReceiver, controllerGuardAddr));
