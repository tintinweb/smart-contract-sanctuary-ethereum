...
contract Lauend_Sucks_Ballz_Inu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Lauend Sucks Ballz Inu";//
    string private constant _symbol = "LSBI";//
    ...
    address payable private _marketingAddress = payable(  0x33Ca4F8F60D29A8EFf38987cF6fc08f70826309A);
