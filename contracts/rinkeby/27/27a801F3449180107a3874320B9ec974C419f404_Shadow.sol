...
/** @title Daemonica spirit bound contract
  * @author @0xAnimist
  * @notice Entity shadows
  */
contract Shadow is ERC721, Ownable {

  IEntity entity;

  uint8 public modulo = 89;
  bool public initialized = false;


  /**
   * @dev Overrides ERC721.balanceOf() with balance of Daemonica entities owned by _owner
   */
  function balanceOf(address _owner) public view override returns (uint256) {
    require(initialized, "Not initialized");
    require(_owner != address(0), "ERC721: balance query for the zero address");
    return entity.balanceOf(_owner);
  }

  /**
   * @dev Overrides ERC721.ownerOf() to point to owner of Daemonica Entity with same _tokenId
   */
  function ownerOf(uint256 _tokenId) public view override returns (address) {
    require(initialized, "Not initialized");
    address owner = entity.ownerOf(_tokenId);
   ...
   /**  @notice
     *  @dev
     *  @param _tokenId tokenId of the shadow to render
     */
   function tokenURI(uint256 _tokenId) override public view returns (string memory) {
     require(initialized, "Not initialized");
     return Compose.uri();
     //return "https://ipfs.pixura.io/ipfs/QmQpEcE1GHsN9Q444wyBP1ZwtQHCN1pdkUuJf1SfNLWvb5/metadata.json";
     //return tokenURI(_tokenId, entity.getTickCount(_tokenId));
   }
...
*/
  ...
  /**  @notice Shadow constructor
    */
  constructor() ERC721("Daemonica Shadow", "KA") Ownable() {
  }
...
/** @title Daemonica Shadow Compose library
  * @author @0xAnimist
  * @notice Composes Daemonica shadows
  */
library Compose {

  string public constant URI = '{"name":"Ka","createdBy":"Unknown","yearCreated":"1479\u002D1458 B.C.","description":"Hatshepsut, the most successful of several female rulers of ancient Egypt, declared herself king sometime between years 2 and 7 in the reign of her stepson and nephew, Thutmose III. She adopted the full titulary of a pharaoh, including the throne name Maatkare, which is the name most frequently found on her monuments. Her throne name and her personal name, Hatshepsut, are both written inside oval cartouches making them easy to recognize.","image":"https://images.metmuseum.org/CRDImages/eg/original/21V_CAT096R3.jpg","media":{"uri":"https://images.metmuseum.org/CRDImages/eg/original/21V_CAT096R3.jpg","dimensions":"815x1200","size":"91029","mimeType":"image/jpeg"}}';
