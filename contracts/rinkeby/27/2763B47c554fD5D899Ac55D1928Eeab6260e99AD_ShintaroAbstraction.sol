...
//  { insert ascii art}
//  DRP + Pellar 2022
//  Abstration - Shintaro Kago

contract ShintaroAbstraction is ERC1155Burnable, ERC1155Supply, Ownable {
  struct TokenInfo {
    bool tradingPaused;
    bool isPublic;
    uint64 maxPerTxn;
  ...
  constructor() ERC1155("") {
    // auction token 
    init(0, 1, new uint64[](0), 1, 10 ether, 0, 1000000000, "ipfs://Qma5YdqrAgVifcdbaELN7juNXDBSvnJ4V2yQ9qLqivze8d");
    // start: 1656057600, 1656144000 (jun 23rd - 24th 8am aest)
    init(1, 1, new uint64[](0), 10, 1.25 ether, 1656057600, 1656144000, "ipfs://QmWGf2RLimHmPpkKjU5hwiAWsu2E2VdM54sfvGBXARVP4q");
    init(2, 1, new uint64[](0), 25, 0.7 ether, 1656057600, 1656144000, "ipfs://QmYb3aYeNgGCTSJmpAon71Cgqxbegx33P4FQj7sYpvJNZJ");

    // after init mint to deployer to transfer to auction
