...
contract MV3 is ERC721A, Ownable {
  ...
  constructor(uint256 collectionSize_) ERC721A("Test", "Test") {
    ...
    function mintFromSignature(uint8 _v, bytes32 _r, bytes32 _s, int quantity, int tier, uint32 count) external payable returns (bool) {
    ...
    function setPublicSaleStartTime(uint256 start) external onlyOwner {
