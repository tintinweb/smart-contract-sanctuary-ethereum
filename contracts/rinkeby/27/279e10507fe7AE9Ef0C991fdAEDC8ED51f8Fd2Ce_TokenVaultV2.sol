...
contract TokenVaultV2 is ITokenVaultV2, Ownable, RevestAccessControl {
    ...
    function depositToken(
        ...
        // Method deprecated, for all intents and purposes
    }

    // TODO: Consider a refactored method in ITokenVaultV2 that includes supply as a parameter
    function withdrawToken(
        ...
        if(fnftId <= FNFT_CUTOFF) {
            ...
            if(pipeTo != address(0)) {
                ...
                console.log("Transferring to: %s", pipeTo);
        ...
        // TODO: None of this should run the same way if asset is zero-asset
        // NB: The way we have reconfigured things breaks the old methods of 
        //     storing a non-zero amount of asset in tokenvault via depositAmount
        // ––– WILL BREAK LEGACY STAKING SYSTEM
        
        console.log("User balance is: %s", IERC20(asset).balanceOf(user)/(1 ether));
        ...
        console.log("Reached this point without reversion");
    ...
    function mapFNFTToToken(
        ...
        // We don't specify depositAmount or depositMul, neither are necessary any more
    ...
    /// TODO: Ensure this can handle new FNFTs
    function splitFNFT(
        uint fnftId,
    ...
    **/
    ...
    function getFNFTCurrentValue(uint fnftId) external view override returns (uint) {      
        ...
        // TODO: How will this method handle the legacy staking contracts suddenly having a different TokenVault? 
        //       Or do we even need to worry about this? Likely not, if we're replacing staking contracts entirely
        //       As their address registry version will still point to the old TokenVault
        if(fnftId <= FNFT_CUTOFF) {
