 ...
 */
contract Facets is ERC721CollectionBase, ERC721, DutchAuction, ReentrancyGuard, AdminControl {
    ...
    constructor(string memory name_, string memory symbol_, uint16 purchaseMax_, uint256 purchasePrice_, uint256 minimumPrice_, uint16 purchaseLimit_, uint16 transactionLimit_, uint256 presalePurchasePrice_, uint16 presalePurchaseLimit_, address signingAddress, bool useDynamicPresalePurchaseLimit_) ERC721(name_, symbol_) {
        _initialize(purchaseMax_, purchasePrice_, purchaseLimit_, transactionLimit_, presalePurchasePrice_, presalePurchaseLimit_, signingAddress, useDynamicPresalePurchaseLimit_);
        minimumPrice = minimumPrice_;
        priceDropInterval = 50;
        priceDropMagnitude = 50;
    }
