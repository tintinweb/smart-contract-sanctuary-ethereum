...
contract FashionNFT is ERC721A, Ownable {
    ...
    address public verifiedSigner; //placeholder
    ...
    function mintWhitelist(
        ...
        _OG
            ...
            : require(purchased + _quantity < 2, "INVALID_QUANTITY");
        require(msg.value >= whitelistPrice * _quantity, "INSUFFICIENT_PRICE");
        require(
            matchSigner(
                hashTransaction(_OG, _quantity, msg.sender),
                _signature
            ),
            "UNAUTHORIZED"
        );
    ...
    /**
     * @notice return signature public address
     */
    ...
    /**
     * @notice create hash of function parameters
     */
