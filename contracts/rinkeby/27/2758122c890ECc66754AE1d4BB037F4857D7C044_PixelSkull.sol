...
contract PixelSkull is AdminControl, ReentrancyGuard {
        ...
        returns (uint256 tokenId)
    {
        ...
        NFTDataAttributes memory tokenData = getImageMetaByHash(imageHash);
        ...
        tokensData[imageHash].tokens.push(newItemId);
        tokensData[imageHash].owners.push(msg.sender);
        tokensData[imageHash].sold = tokensData[imageHash].sold + 1;
        _tokens[newItemId] = imageHash;

        uint256 valueTransfer = (msg.value / 100) * 70;
        require(tokensData[imageHash].artist != address(0),"");
