...
contract TestNFT is ERC721AUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, IERC2981Upgradeable {
    ...
    bool private _mintActiveTeam;
    bool private _mintActiveGmi;
    bool private _mintActiveAllow;
    bool private _mintActivePublic;
    ...
    function initialize(string memory name, string memory symbol, address royaltyOwner) initializerERC721A initializer public {
        ...
        _maxSupply = 4242;
        _cost = 0.01 ether; //TODO: Check
        _communityLimit = 242;
        _communityMinted = 0;
        _royaltyAmount = 750; //TODO: Check
    ...
    function withdraw() public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        withdrawPrivate(0x5Ba56afFf424e0B26227f793bD4e0e5e06132206, balance); //TODO: Check
    }
