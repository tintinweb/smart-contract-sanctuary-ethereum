...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function batchMint(address[] memory receivers, uint256[] memory tokenIds) external onlyOwner {
        require(receivers.length == tokenIds.length, "Receivers and tokenIds must be same length!");
