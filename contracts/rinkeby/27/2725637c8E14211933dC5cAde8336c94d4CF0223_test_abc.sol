...
contract test_abc is ERC721Enumerable, Ownable {
    ...
    uint256 public presaleStartDate = 1651875410;       // 28 Nov 2021 02:00:00 EST
    uint256 public publicStartDate = 1652221010;        // 29 Nov 2021 03:00:00 EST

    uint256 public mintPrice = 0.2 ether;

    mapping(address => bool) public ownerList;
    address[] private ownerListAdr;
    ...
    */
    ...
    constructor() ERC721("Agelessteez", "Agelessteez") {
        //setBaseURI(baseURI);
        // whitelist[address(0xd98445cAA59708F31717Ae024C4269617C741e87)] = true;
        // whitelist[address(0x0d7804C83F2c20D317605601b2d6731e89b051cb)] = true;
        // whitelist[address(0x0264c4CaBEcafA630Bf082155bD394EB6a48e7b8)] = true;
        // whitelist[address(0xdD4127C80F8E59b2a8a9A64dC9d62dd7caa5C339)] = true;
        // whitelist[address(0xb392B6Eb9d71f8Cd9e5aB302719a2129fa590E38)] = true;
        // whitelist[address(0x37f523C6285aD3F51E3C4E446eA6aC96B5585f1E)] = true;
        // whitelist[address(0xe8b795273e254b5E8232412a0ec059278aac99e7)] = true;
        // whitelist[address(0x2D4b5D13F1dEe7828FbAda436BcCd82210585BBc)] = true;
        // totalWhitelist = 8;
    }
    ...
    function preSaleMint(uint256 _mintCount) public payable onlyWhitelisted {
        ...
        require(tokenCount < maxPreSaleMint,           string(abi.encodePacked('You can only mint ', maxPreSaleMint.toString(), ' Teez in PreSale')));
        require(supply < maxSupply,                     'This transaction would exceed max supply of agelessteez');
        require(supply < presaleSupply,                 'This transaction would exceed max presale supply of agelessteez');
        require(msg.value >= mintPrice,                 'Ether value is too low');

        for (uint256 i = 0; i < _mintCount; i++) {
            if (totalSupply() < presaleSupply) {
                if (!ownerList[msg.sender]) {
                    ownerList[msg.sender] = true;
                    ownerListAdr.push(msg.sender);                 
                }
    ...
    function setPresaleMint(uint256 _maxPreSaleMint) public onlyOwner {
    ...
    function info() public view returns (uint256, uint256, uint256, address[] memory, uint256) {
        return (price(), publicStartDate, totalSupply(), ownerListAdr, ownerListAdr.length);
    }
}