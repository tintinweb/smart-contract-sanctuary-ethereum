...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9F20cDC0033E55365B6Ce4a20A0a4A86384f4AF0];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 54 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbJEqKC12KiiPmYjHaUGbmcHNvhepwjwSS2HL9Bbytw5i/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 54");
...
// File: contracts/FearNoMoreContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FearNoMoreContract is RamppERC721A {
    constructor() RamppERC721A("Fear No More", "FNM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vjiZFRYTEoCSZhsRCdZC/contract-metadata";
    }
}
