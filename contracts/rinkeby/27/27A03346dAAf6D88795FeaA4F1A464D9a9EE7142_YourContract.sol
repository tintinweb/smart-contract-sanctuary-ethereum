...
contract YourContract is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) ERC721 ("EdaNewSVGCollection", "EDA") { 
    ...
    function mintItem() public { //function to create nfts
        ...
        string memory result = "hello"; // Will be random word/number in the future 
