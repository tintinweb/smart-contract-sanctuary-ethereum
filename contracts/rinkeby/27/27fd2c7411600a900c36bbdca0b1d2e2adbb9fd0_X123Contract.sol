...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmahzuFs23yhtUMjSq8eLqRMSwGqhLi7JBaiaxBBzkooEL/";
...
// File: contracts/X123Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X123Contract is RamppERC721A {
    constructor() RamppERC721A("123", "123444"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IDIP4ZVAG0zf6CT7lVzj/contract-metadata";
    }
}
