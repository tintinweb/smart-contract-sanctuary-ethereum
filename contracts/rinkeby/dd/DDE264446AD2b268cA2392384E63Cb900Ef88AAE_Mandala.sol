    ...
    ReentrancyGuard
{
    ...
    constructor(string memory tokenURI_)
        ERC721Base(tokenURI_, "Mandala", "MANDALA", MAX_SUPPLY)
    {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);

        _setupRole(AIRDROPPER_ROLE, 0x6715D9C7Ad2aE25c9D732B9bE9b32603e9328f83);
        _transferOwnership(0x6715D9C7Ad2aE25c9D732B9bE9b32603e9328f83);
    }

    function airdrop(address wallet, uint256 amount) external onlyRole(AIRDROPPER_ROLE)
    {
        _cmint(wallet, amount);
    }
...
contract ERC721Base is ERC721A {
    ...
    // Mint
    function _cmint(address wallet, uint256 amount) internal {
    ...
    function _cmints(
        ...
        require(supply + totalQuantity <= maxSupply, "ERC721Base: Mint/order exceeds supply");
