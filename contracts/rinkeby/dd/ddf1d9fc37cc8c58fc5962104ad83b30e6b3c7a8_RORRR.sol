...
contract RORRR is ERC721URIStorage, Ownable{
 
    event MintROR (address indexed minter, uint256 startWith, uint256 times);
    
    
    uint256 public totalROR;
    uint256 public totalCount = 2049; //bruhTotal
    uint256 public maxBatch = 5; // bruhBatch
    uint256 public price = 20000000000000000; // 0.02 eth
    uint256 public releaseUnix = 1644390600; // works KEKW
    uint256 public presaleRelease = 1644391800; // presale time (please work)
