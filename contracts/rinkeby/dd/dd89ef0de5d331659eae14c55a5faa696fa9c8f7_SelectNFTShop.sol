...
contract SelectNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    function createProject(string calldata name, string calldata creator, string calldata baseUri, uint128 maxSupply) 
        public 
        onlyOwner
    {
        projects[nextProjectId++] = ProjectData(false, name, creator, baseUri, maxSupply, 0);
    }
...
contract SelectNFTShop is Ownable {
    ...
    function createSale(uint128 _projectId, uint64 _maxSupply, uint64 _maxPerTx, uint64 _maxPerWallet, uint64 _startTime, uint128 _price)
        public
        onlyOwner
    {
