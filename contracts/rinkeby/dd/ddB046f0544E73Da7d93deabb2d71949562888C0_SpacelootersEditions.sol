...
// Placeholder name
contract SpacelootersEditions is
    ERC1155,
    ERC1155Burnable,
    ERC1155Supply,
    // ERC1155URIStorage,
    ...
    PullPayment
{
    ...
    // TODO: Possibly replace with a real URL in the constructor.
    constructor(address signer_) ERC1155("https://spacelooters-staging.nyc3.digitaloceanspaces.com/metadata/{id}.json") {
        // Send royalties to contract owner at 10% (1000 basis points)
    ...
    /**
        ...
        @param newSigner_ Address of the new signer.
     */
    function newSigner(address newSigner_) public onlyOwner {
        require(newSigner_ != signer && newSigner_ != address(0));
        signer = newSigner_;
    }
    ...
    function contractURI() public pure returns (string memory) {
        ...
        return
            "https://spacelooters-staging.nyc3.digitaloceanspaces.com/metadata/spacelooters-editions-contract.json";
    }
    ...
    /**
        ...
        @param expiry The expiration Unix timestamp (in seconds) of the signature.
    ...
    function mint(
        ...
        require(
            _verify(tokenId, expiry, signature),
    ...
    /**
        ...
        @param expiry The expiration Unix timestamp (in seconds) for the signature.
    ...
    function _verify(
        ...
        return
            keccak256(
                abi.encodePacked(msg.sender, tokenId, expiry, address(this))
