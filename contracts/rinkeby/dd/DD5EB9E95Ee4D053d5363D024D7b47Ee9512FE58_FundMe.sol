...
contract FundMe{
    ...
    //this function can be payable with ETH
    //it explicitly allows the function to receive ether
    function fund() public payable{
        // $50
        //uint256 minimumUSD = 1 * 10 ** 18;
        //require(getConversionRate(msg.value) >= minimumUSD," You need to spent more ETH");
    ...
    function getVersion() public view returns (uint256){
        // finding the price feed addresses
        // We have a contract defined above functions in the 0x... address
