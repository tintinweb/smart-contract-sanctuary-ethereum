...
contract TimeVault {
    ...
    function withdrawEther() public onlyOwner isUnlocked returns (bool) {
        require(funds > 0, "You don't have any funds");
        uint256 amount = funds;
        funds = 0;
        (bool sent, ) = beneficiary.call{value: funds}("");
        return sent;
    }

    function withdrawTokens() public onlyOwner isUnlocked returns (bool) {
