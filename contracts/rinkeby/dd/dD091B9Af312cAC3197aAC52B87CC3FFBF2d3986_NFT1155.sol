    ...
    Ownable
{
    ...
    function burn(
        ...
        uint256 tokenId,
        uint256 amount
    ) public override(ERC1155Burnable) onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function buy(
        ...
        uint256 value = msg.value;
        {
            ...
            bytes32 messageHash = keccak256(
                abi.encodePacked(address(this), to, id, value, orderId, expires, uri)
            );
        ...
        emit Buy(msg.sender, to, id, value, orderId, expires, lang);
    }
