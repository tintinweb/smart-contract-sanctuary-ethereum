...
contract SignArtGatewayV5 is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721HolderUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, ERC2981Upgradeable {
    ...
    string constant pending = "PENDING"; // remove when reset proxy
    string constant closed = "CLOSED"; // remove when reset proxy
    // consider remove burn option too
