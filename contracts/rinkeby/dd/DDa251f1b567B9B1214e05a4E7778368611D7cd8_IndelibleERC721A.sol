// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Head", unicode"Mouth", unicode"Face", unicode"Eyes", unicode"Nose", unicode"Shirt", unicode"Skin", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Fast Food Runners", unicode"Just some runners who have to work in fast food", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/b69da6e1-4839-4c12-be59-a069165ad61e", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/b69da6e1-4839-4c12-be59-a069165ad61e", "", 690, "0x1BB03305286DB08af2c313765cf900169843D0c7");

        constructor() ERC721A(unicode"Fast Food Runners", unicode"FFR") {
            TIERS[0] = [100,100,100,100,200,200,200];
TIERS[1] = [50,50,50,50,100,100,100,100,100,100,100,100];
TIERS[2] = [4,6,9,13,18,41,52,54,66,73,88,94,122,164,196];
TIERS[3] = [200,200,200,200,200];
TIERS[4] = [200,200,200,200,200];
TIERS[5] = [100,100,100,100,100,100,100,100,200];
TIERS[6] = [72,74,111,145,177,421];
TIERS[7] = [50,50,50,50,100,100,100,100,100,100,100,100];
        }
