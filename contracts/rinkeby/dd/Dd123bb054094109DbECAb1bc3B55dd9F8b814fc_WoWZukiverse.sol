...
contract WoWZukiverse is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    function mint(uint32 _mintAmount, bytes memory signature, uint64 freeMints, bool allowlisted) public payable mintCompliance(_mintAmount) {
        ...
        require(_mintAmount <= MAX_MINT_AMOUNT_PER_TX || _mintAmount <= remainingFreeMints, "Mint limit exceeded!");
