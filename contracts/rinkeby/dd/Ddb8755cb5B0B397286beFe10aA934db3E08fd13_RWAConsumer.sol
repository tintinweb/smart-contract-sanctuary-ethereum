...
contract RWAConsumer is ChainlinkClient, Ownable {
    ...
    event DataFullfilled(uint256 result);
    ...
    {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.initiated_response.selector);
     ...
     */ 
    function initiated_response(bytes32 _requestId, uint256 _result) public recordChainlinkFulfillment(_requestId)
    {
        result = _result;
    ...
    function setJobId(bytes32 _jobId) onlyOwner public {
        jobId = _jobId;
    }
