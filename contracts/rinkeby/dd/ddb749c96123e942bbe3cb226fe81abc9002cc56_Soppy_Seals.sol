...
contract Soppy_Seals  is ERC721Enumerable, Ownable
{
    ...
    uint public Special_NFT_Gaveaway=0;
   ...
   function get_Pre_Mint_Price() public view returns(uint256){
    ...
    function getmintprice() public view returns(uint256){
     ...
     function airdrop(address a, uint q)public onlyOwner{
         require(tokenId<=5555, "Local Mint must be less than 5500");
        for (uint i = 0; i < q; i++) {
     ...
     function Special_gaveaway(address a,  uint nftnumber)public onlyOwner{
                  require(tokenId<5555, "Local Mint must be less than 5500");        
                  _safeMint(a, nftnumber);
                  Special_NFT_Gaveaway++;
    ...
    function ResetTokenId(uint StartID) public onlyOwner{
        tokenId = StartID;
    }
      function SpecialNFT_GaveawaySupply() private view returns (uint)
    {
        return Special_NFT_Gaveaway;
    }
}