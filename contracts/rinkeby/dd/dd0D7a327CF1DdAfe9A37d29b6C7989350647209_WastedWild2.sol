// SPDX-License-Identifier: MIT
    ...
    contract WastedWild2 is ERC721A, Ownable {
        ...
        uint256 public _startSaleTimestamp = 1647806400; //3/20/2022 3:00PM EST
        uint256 public _whiteListWindow = 600; //10 minutes
        ...
        function publicMint(uint256 tokensToMint) external payable {
            ...
            if(block.timestamp < _startSaleTimestamp + _whiteListWindow){
                require(_whiteList[msg.sender] > 0, "need to be on white list to mint during this window");
            }
