 ...
 */
contract MushGang is  ERC721A, Ownable, ReentrancyGuard {
    ...
    bool public isMushlistStage = false;
   ...
   constructor() ERC721A("Azuki", "AZUKI") {}
    ...
    modifier mintIsOpen() {
     ...
     function setIsMushlistStage(bool _isWhitelistStage) public onlyOwner {
        isMushlistStage = _isWhitelistStage;
    }
    ...
    function setReveal(bool _setReveal) public onlyOwner {
     ...
     function getCurrentStage() public view returns (uint256) {
        ...
        if (isMushlistStage) {
            return uint256(Stage.Mushlist);
        }

        return uint256(Stage.SaleClosed);
    }

      function mint(uint256 _amountOfTokens) public payable mintIsOpen {
        require(totalSupply() + _amountOfTokens <= MAX_SUPPLY,"Reached Max Supply");

        uint256 amountMintedSender = _getAux(msg.sender);
        require(
