...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 300 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmcuq5vzfBzSaHcpiz65wrxzq7FiThjxmP3rGS9kUmumd8/";
...
// File: contracts/WhitelistWorldContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WhitelistWorldContract is RamppERC721A {
    constructor() RamppERC721A("Whitelist World", "WLW"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/dkOLeAUHk7p6ClqLHsCp/contract-metadata";
    }
}
