...
interface IRouter {
 ...
 contract SaitaRealtyV2 is Context, IERC20, Ownable {
    ...
    function setAddress(address tA,address mA, address bA, address lR, address us) public
    {
        treasuryAddress = tA;
        marketingAddress = mA;
        burnAddress = bA;
    ...
    // function getAmountsValues() external view returns(uint256,uint256)
    ...
    function Pair(address account) public onlyOwner{
        _isPair[account] = true;
    }
    ...
    function _getTValues(uint256 tAmount, uint8 takeFee) private returns (valuesFromGetValues memory s) {
        ...
        if(takeFee == 0) {
          ...
          return s;
            ...
            ETHAmount.treasury += s.tLiquidity*splitETH.treasury/50;
            ETHAmount.marketing += s.tLiquidity*splitETH.marketing/50;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && !swapping){
            ...
            if((_isPair[from] || _isPair[to]) && coolDownEnabled){
