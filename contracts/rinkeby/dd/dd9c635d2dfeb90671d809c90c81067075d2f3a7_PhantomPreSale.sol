...
library SafeMath {
    ...
    uint256 private constant MAX_BUY = 3500e18; // Max Amout Of Dai user can use for buy
    uint256 private constant MIN_BUY = 90e18; // Min Amount of Dai user can use for buy
