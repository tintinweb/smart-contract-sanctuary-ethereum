...
contract BrandDAOGovernance is
    Governor,
    GovernorVotes,
    GovernorSettings,
...
{
    IERC721 public generatives;

    constructor(
        IVotes _token,
        TimelockController _timelock,
        IERC721 generatives_
    )
        Governor("BrandDAO")
        GovernorVotes(_token)
        GovernorVotesQuorumFraction(4)
        GovernorSettings(0, 46027, 0)
        GovernorTimelockControl(_timelock)
    {
        generatives = generatives_;
    }
    ...
    function propose(
        ...
        require(
            generatives.balanceOf(msg.sender) > 0,
            "Account not eligible for proposing"
        );
    ...
    /**
     * @dev override this to specify how a proposal is passed
     */
    ...
    function _castVote(
        ...
        require(
            generatives.balanceOf(account) > 0,
            "Account not eligible for voting"
        );
