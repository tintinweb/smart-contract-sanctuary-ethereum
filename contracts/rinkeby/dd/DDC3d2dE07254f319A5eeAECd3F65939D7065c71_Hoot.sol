...
contract Hoot is ERC721, Ownable, ReentrancyGuard {
        ...
        returns (string memory)
    {
        ...
        // if (bytes(traits[3]).length > 0) {
        //     parts[18] = '<text x="10" y=';
        //     parts[19] = toString(80);
        //     parts[20] = traits[3];
        //     parts[21] = ' class="base"></text>';
        // }

        // if (bytes(traits[4]).length > 0) {
