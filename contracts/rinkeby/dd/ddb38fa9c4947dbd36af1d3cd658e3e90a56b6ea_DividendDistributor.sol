...
contract Test is IERC20, Auth {
    ...
    uint256 public rewardFeeBuy = 4;
    uint256 public lpFeeBuy = 2;
    uint256 public marketingFeeBuy = 3;
    uint256 public rewardFeeSell = 4;
    uint256 public lpFeeSell = 2;
    uint256 public marketingFeeSell = 3;

    uint256 public totalFeeBuy = devFee.add(lpFeeBuy).add(rewardFeeBuy).add(marketingFeeBuy);
    uint256 public totalFeeSell = devFee.add(lpFeeSell).add(rewardFeeSell).add(marketingFeeSell); 
    ...
    function manualSendEth() external onlyOwner {
        ...
        uint256 devBalanceETH = contractETHBalance.mul(devFee).div(totalFeeSell);
