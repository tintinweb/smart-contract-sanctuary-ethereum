...
contract TestPepo is ERC721VI, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721VI("Test Pepo", "TPepo", maxPerTx) {}
  ...
  function withdrawall() public onlyOwner {
    ...
    require(payable(0x0ec4928146217B484330D373757d8AC3343058FF).send(_balance));
  }
}