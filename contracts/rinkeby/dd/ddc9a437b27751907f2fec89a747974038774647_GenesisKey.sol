...
contract GenesisKey is Initializable, ERC721AUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable, IGenesisKey {
    ...
    mapping(bytes32 => uint256) public claimableBlock; // TODO: delete
    ...
    uint256 public gweiMax; // TODO: delete
    ...
    IERC721MetadataUpgradeable
{
    ...
    function tokenIdsOwned(address user) external view returns (uint256[] memory) {
