...
contract MetroVault is Ownable, IERC721Receiver {
    ...
    MetroImitation survivor = MetroImitation(0x3ab88713020bB792630e36f445373B81B04DC6C1);
    ...
    function setContract(MetroImitation _newContract) external onlyOwner {
