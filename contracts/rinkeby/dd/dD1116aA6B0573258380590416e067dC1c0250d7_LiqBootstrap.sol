...
contract LiqBootstrap is Ownable, ReentrancyGuard, IClaimable {
    ...
    uint256 public tvlCap = 1000 ether;
    ...
    function deposit() external payable nonReentrant {
        ...
        require(msg.value >= 1e15, "Min deposit amount is 0.001 ETH");
        require(address(this).balance + msg.value < tvlCap, "Tvl limit reached");
        ...
        editRecipient(msg.sender, newShares);
    ...
    // In case some other tokens get stuck in the contract
    // Owner does not have the ability to take out MON
