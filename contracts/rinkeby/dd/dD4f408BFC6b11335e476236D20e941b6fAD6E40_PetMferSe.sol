...
contract PetMferSe is ERC721A, Ownable, Pausable {
    ...
    constructor() ERC721A("PetMfer", "PMF"){
        _pause();
    }
    ...
    function setContractBaseURI(string memory contractBaseURI) external onlyOwner {
