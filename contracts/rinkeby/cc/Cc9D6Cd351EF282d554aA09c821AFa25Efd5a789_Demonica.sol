...
contract Demonica is Ownable, ERC721A, ReentrancyGuard {
    ...
    address private constant TLE_TEAM = 0x36063DCaED2B9b8BB3779A191b506f057805C939; // enter valid team wallet
    ...
    function mintPresale(bytes32[] calldata proof, uint256 amount) external payable mintGuard(amount) {
        ...
        require(
            presaleAddressMintCount[msg.sender] + amount <= MAX_PRESALE_MINTS,
