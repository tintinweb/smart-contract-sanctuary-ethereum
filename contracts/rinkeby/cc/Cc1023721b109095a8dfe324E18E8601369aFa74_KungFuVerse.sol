...
contract KungFuVerse is ERC721A, Ownable, ReentrancyGuard {
    uint256 public constant MAX_SUPPLY = 5000;
    uint256 public constant MAX_PER_MINT_NUM = 5;
    uint256 public constant PRESALE_PRICE_PER_TOKEN = 0.05 ether;
    uint256 public constant PUBLICSALE_PRICE_PER_TOKEN = 0.1 ether;
    ...
    constructor() ERC721A("KungFuVerse", "KFV") {
    }
