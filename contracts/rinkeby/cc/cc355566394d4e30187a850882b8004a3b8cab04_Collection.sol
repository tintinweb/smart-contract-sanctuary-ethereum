...
contract Collection is ERC1155Tradable {
    constructor(address _proxyRegistryAddress)
        ERC1155Tradable("Collection", "STORE", _proxyRegistryAddress)
    {
        _setURI("https://api.frank.hk/api/nft/demo/1155/marvel/{id}.json");
    }
}
 ...
 */
contract ERC1155Tradable is ERC1155Burnable, Pausable, Ownable {
