    ...
    PaymentSplitter 
{
    ...
    address[] private _team = [
        0x52afbd46ECf1444a73C03b9c296E25c558291F1B, // Admin Account gets 25% of the total revenue
        0xe9e1543eFfcB22337e801104b77Ea524c7Ea358F, // Test Account gets 35% of the total revenue
        0xA0A73c42F4537E54562a822Be8035767213596A6 // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("ComplacentMonkey", "MONKEY")
