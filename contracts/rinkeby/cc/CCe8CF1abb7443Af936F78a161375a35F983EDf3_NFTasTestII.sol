...
contract NFTasTestII is ERC721A, Ownable, ReentrancyGuard {
    ...
    bool public bulkMintEnabled = false;
    ...
    constructor() payable ERC721A("NFTasTestII", "NFTASTII") {}
    ...
    function bulkMint(uint256 _qty) public payable nonReentrant {
        _checkPaused();
        _checkCanMint(_qty);
        require(!bulkMintEnabled, "Bulk mint is not enabled!");
    ...
    function setBulkMintEnabled(bool _val) public onlyOwner {
        bulkMintEnabled = _val;
    }
