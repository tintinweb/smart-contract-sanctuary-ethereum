...
contract TheHomegirls is ERC721A, Ownable {
  ...
  string private _baseURIextended = "ipfs://Qme3hJ7b6YrAT2KksFnqxeLMJTG3WFfptF1VycyVuxm6DY/hidden.json";

  address[] private mintPayees = [
    0x2ee241920D61EC5aF2C5483dc4242448c339e80E
  ];

  constructor() ERC721A("TheHomegirls", "TBYH") {}
  ...
  function withdrawAll() external onlyOwner {
    ...
    _withdraw(mintPayees[0], (contractBalance * 100) / 100);
  }
  ...
  function reserveMint(uint256 nMints, uint256 batchSize) external onlyOwner {
    ...
    for (uint256 i = 1; i < nMints / batchSize; i++) {    
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, tokenId.toString())) : 'ipfs://QmNc39XTCUdJcsfPDqLGwjQtPtegJAWsj2zWCmLQdwvMEW/';
    }
