...
contract SeriesTwo is ERC721, ERC721URIStorage, Ownable, Pausable {
  ...
  uint40 public preMintEnd = 1659769200;
  ...
  constructor() ERC721("Ethnology Series 2: Gods and Demons", "Gods and Demons S2") {
    setBaseURI("ipfs://QmbnLsx7vvnBni8UZfBRgBcDbDbZogjwCRDUu7wRQm3y4d/");
    setSeriesOne(0x3B093D3FeC569a32E57Eb758bE944146f22f4D46);
  }
  ...
  function checkLimit(address _user, bytes32[] memory _proof) public view returns (uint8) {
    return (seriesOneBal(msg.sender) >= 1) ? 5 : (isWhiteListed(_proof, _root, getMarkleLeaf(_user))) ? 3 : 0;
  }
}
