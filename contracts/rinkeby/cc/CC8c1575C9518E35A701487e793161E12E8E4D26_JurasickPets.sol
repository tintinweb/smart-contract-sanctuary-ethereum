...
contract JurasickPets is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 constant nbFree = 50;
    // uint256 constant wlPrice = 0.06 ether;
    // uint256 constant price = 0.08 ether;
    uint256 constant wlPrice = 0.006 ether;
    uint256 constant price = 0.008 ether;

    uint64 nbFreeMinted = 0;
    uint256 constant maxWLMint = 1;
    uint256 constant maxMint = 20;

    uint8 vestingStep = 0;

    uint64 constant limitAge2 = 180; // Test
    uint64 constant limitAge3 = 360; // Test
    uint64 constant limitAge4 = 540; // Test
    uint64 constant limitAge5 = 720; // Test
    // uint64 constant limitAge2 = 259200; // Prod
    // uint64 constant limitAge3 = 864000; // Prod
    // uint64 constant limitAge4 = 1564000; // Prod
    // uint64 constant limitAge5 = 2864000; // Prod
    ...
    constructor() ERC721A("JurasickPets", "DINO", 20, 10000) {
        vestingStepAllowedRatio[0] = 30;
        vestingStepAllowedRatio[1] = 10;
        vestingStepAllowedRatio[2] = 10;
        vestingStepAllowedRatio[3] = 10;
        vestingStepAllowedRatio[4] = 10;
        vestingStepAllowedRatio[5] = 10;
        vestingStepAllowedRatio[6] = 20;
    }
    ...
    function updateBirthDate(uint256 tokenId) internal {
        ...
        if (age < limitAge2) {
            ...
            birthDate[tokenId] = block.timestamp - limitAge2; // Back to the beginning of Yougnster stage
            ...
            birthDate[tokenId] = block.timestamp - limitAge4; // Back to the beginning of Grampa stage
        } else {
            birthDate[tokenId] = block.timestamp - limitAge5; // Back to the beginning of Fossile stage
        }
    }
    ...
    function wlMint(
        ...
        require(wlSale, "Public sale has not begun yet");
        require(
        ...
        console.log("Signer is ok :", checked);
    ...
    function checkWL(
        ...
        console.log("Address recovered :", recovered, owner());
    ...
    function withdrawMoney() external onlyOwner nonReentrant {
        ...
        require(checkVestingStep(), "Not authorized to take monaey now ;)");
        uint256 balanceToWithdraw = (address(this).balance / 100) *
            vestingStepAllowedRatio[vestingStep];
        vestingStep++;
    ...
    function checkVestingStep() internal view returns (bool) {
        ...
        if (vestingStep == 6 && block.timestamp > 1667257200) return true; // 2022-11-01
        return false;
    }

    function emergencyWithdrawMoney() external onlyOwner nonReentrant {
        require(
            block.timestamp >= 1669849200,
