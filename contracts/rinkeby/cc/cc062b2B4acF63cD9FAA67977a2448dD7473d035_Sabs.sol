...
contract Sabs is ERC20Burnable, Ownable {

    using SafeMath for uint256;

    uint256 public MAX_WALLET_STAKED = 10; // launch set to 100
    uint256 public EMISSIONS_RATE = 11574070000000; // launch multiply by 10
    uint256 public CLAIM_END_TIME = 1672581600; // jan 1 2023
    ...
    function stakeByIds(uint256[] memory tokenIds) public {
        require(
            stakerToTokenIds[msg.sender].length + tokenIds.length <=
                MAX_WALLET_STAKED,
            "Must have less than 31 wabi staked!"
        );
