...
contract ADE is ERC721A, Ownable, ReentrancyGuard {
...
constructor() ERC721A("ADT", "ADE",50,10000)
{}
...
function toString(bytes memory data) public pure returns(string memory) {
    ...
    string[] private signcolors = ["F00","F10","F20","F30","F40","F50","F60","F70","F80","F90","FA0","FB0","FC0","FD0","FE0","FF0","EF0","DF0","CF0","BF0","AF0","9F0","8F0","7F0","6F0","5F0","4F0","3F0","2F0","1F0","0F0","0F1","0F2","0F3","0F4","0F5","0F6","0F7","0F8","0F9","0FA","0FB","0FC","0FD","0FE","0FF","0EF","0DF","0CF","0BF","0AF","09F","08F","07F","06F","05F","04F","03F","02F","01F","00F","10F","20F","30F","40F","50F","60F","70F","80F","90F","A0F","B0F","C0F","D0F","E0F","F0F","F0E","F0D","F0C","F0B","F0A","F09","F08","F07","F06","F05","F04","F03","F02","F01" ];
    uint256 finaldimension = 500;
    uint256 signszelesseg = 400;
    uint256 surusegmin = 8;
    uint256 surusegmax = 22;
    function createSVG(address wallet) public view returns (string memory) 
    {
	bytes memory pathstr;
	string memory walletstring = toString(wallet);
	pathstr = abi.encodePacked("<text style=\"font-size: 19;\" x=\"20\" y=\"30\" fill=\"#ff0000\">Wallet: ",walletstring,"</text>");
	return string(pathstr);
    }
    function tokenURI(uint256 tokenId) override public view returns (string memory) 
    {
	string memory pathstr;
	pathstr = createSVG(ownerOf(tokenId));
	pathstr = string(abi.encodePacked('<svg xmlns="http:/','/www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" fill="#fff"/>',pathstr,'</svg>'));
	pathstr = b64encode(bytes(pathstr));
	pathstr = string(abi.encodePacked('{"name": "AADEE #',Strings.toString(tokenId),'", "attributes": [{"trait_type": "Background","value": "5"},{"trait_type": "Segments","value": "9"}],"image": "data:image/svg+xml;base64,',pathstr,'"}'));
