...
contract DustBoyNFT is ERC721Enumerable, IERC2981, ReentrancyGuard, Ownable {
    ...
    function setSensor(
        ...
        sensors[_tokenId].field1 = _field1;
        sensors[_tokenId].field2 = _field2;
        sensors[_tokenId].field3 = _field3;
    }

    function setSensor(uint256 _tokenId, Sensor memory s) public {
        require(ownerOf(_tokenId) == msg.sender);
