...
contract TestBroken is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TestBroken", "TBA") {
    setHiddenMetadataUri("ipfs://QmSLHgCKM5KXZWGSMUv1VEFrJmXEa9zMDBAr7dPGXcaBz5/hidden.json");
  }
