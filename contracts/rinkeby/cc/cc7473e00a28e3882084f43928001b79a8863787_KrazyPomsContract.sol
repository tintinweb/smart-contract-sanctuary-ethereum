...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4491e297af84f56521e3A05B50C08f0E503FFE3f,0x1922dd8d48713a9E428Ea0BE471A286f9dad48f6];
...
// File: contracts/KrazyPomsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KrazyPomsContract is RamppERC721A {
    constructor() RamppERC721A("KrazyPoms", "KRP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/NqUpzxNbG5GPIbeKbiI2/contract-metadata";
    }
}
