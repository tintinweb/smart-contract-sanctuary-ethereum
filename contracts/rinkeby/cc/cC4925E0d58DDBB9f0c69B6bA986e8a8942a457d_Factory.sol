...
contract Factory {
    ...
    /// @param _payees The address array of the new contract in which the funds 
    /// will be splitted.
    /// @param _shares The precentage array of the respective ethereum addresses
    ...
    function registerContract(
        ...
        Splitter splitter = new Splitter(factoryOwner, false, _payees, _shares);
...
contract Splitter is PaymentSplitter ,Ownable ,Pausable  {
    constructor(
