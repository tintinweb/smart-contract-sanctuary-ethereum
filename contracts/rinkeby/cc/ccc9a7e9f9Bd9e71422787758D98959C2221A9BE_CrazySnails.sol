...
contract CrazySnails is ERC721Enumerable, Ownable {

    string public revealedUri = "https://crazy-snails.herokuapp.com/avatars/";
    string public notRevealedUri = "https://crazy-snails.herokuapp.com/default/";
    uint256 public maxSupply = 7777;
    uint256 public Public_Price = 0.20 ether;
    uint256 public Presale_Price = 0.17 ether;
    ...
    constructor() ERC721("CrazySnails", "CSNAILS") {}
    ...
    function removeFromPresaleList(address _address) public onlyOwner {
        require(
            _address != address(0),
            "Message: Can't remove a zero address"
        );
        if (_presaleList[_address] == true) {
            _presaleList[_address] = false;
            presale_list_length = presale_list_length - 1;
        }
    }
    ...
    function removeFromOgList(address _address) public onlyOwner {
        require(
            _address != address(0),
            "Message: Can't remove a zero address"
        );
        if (_ogList[_address] == true) {
            _ogList[_address] = false;
            og_list_length = og_list_length - 1;
        }
    }
    ...
    function preSaleHasFinished () public onlyOwner {
        PreSaleStarted = false;
    }

    function preSaleHasFinished_PublicSaleHasStarted () public onlyOwner {
        PreSaleStarted = false;
    ...
    function publicSaleHasFinished () public onlyOwner {
    ...
    function withdrawAll() public onlyOwner {
        ...
        uint256 _balanceFivePerc = address(this).balance * 5 / 100;
        uint256 _balanceThirtyPerc = address(this).balance * 30 / 100;

        (bool marketingAgent, ) = payable(0xb2f8f2C12213cFD1D0Fccd5f0cAAc27243875Bb2).call{value: _balanceFivePerc}("");
        require(marketingAgent);

        (bool developer, ) = payable(0x8818F967A6Df5fb655248564DE3aC9519cFdC779).call{value: _balanceFivePerc}("");
        require(developer);

        (bool cofounderOne, ) = payable(0x55199CDb3131A570D2b11131Fc30A3F69c581366).call{value: _balanceThirtyPerc}("");
        require(cofounderOne);

        (bool cofounderTwo, ) = payable(0xEE8B6525DECE14d714F14a65a89951f2a88291BE).call{value: _balanceThirtyPerc}("");
        require(cofounderTwo);

        (bool designer, ) = payable(0xc7D32a3b45Cb697fd5605BebC3795AAAB1B5cF93).call{value: _balanceThirtyPerc}("");
        require(designer);
