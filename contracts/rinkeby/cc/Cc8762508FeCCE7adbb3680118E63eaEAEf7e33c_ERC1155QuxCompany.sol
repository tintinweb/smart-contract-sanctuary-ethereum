...
abstract contract ERC1155DefaultApproval is
    ...
    UUPSUpgradeable
{
    ...
    function __ERC1155QuxCompany_init(
        string memory name_,
        ...
        for (uint8 i = 0; i < _addresses.length; i++) {
            address operator = _addresses[i];
            require(
                AddressUpgradeable.isContract(operator),
                "ERC1155QuxCompany: delegate call to non-contract"
            );
            _setDefaultApproval(operator, true);
        }
    }
    ...
    function transferToRecipients(
        ...
        require(
            ...
            "ERC1155QuxCompany: not enough tokens are owned."
        );
        ...
        for (uint8 i = 0; i < _transfers.length; i++) {
            ...
            if (_transfer.value < 1) {
                continue;
            }
            safeTransferFrom(from, _transfer.to, tokenId, _transfer.value, "");
    ...
    function toHexDigit(uint8 d) internal pure returns (bytes1) {
        ...
        revert("ERC1155QuxCompany: invalid value for hexadecimal.");
    }
