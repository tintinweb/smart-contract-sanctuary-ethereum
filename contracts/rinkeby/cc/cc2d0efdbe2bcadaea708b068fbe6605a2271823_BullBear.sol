...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, KeeperCompatibleInterface, VRFConsumerBaseV2 {
    ...
    constructor(uint256 updateInterval, address _priceFeed, address vrfCoordinator) ERC721("Bull&Bear", "BBTK") VRFConsumerBaseV2(vrfCoordinator) {
    ...
    function fulfillRandomWords(
        ...
        console.log("Getting random nbr");

        // Change % 3 by % URIs array lenght 
