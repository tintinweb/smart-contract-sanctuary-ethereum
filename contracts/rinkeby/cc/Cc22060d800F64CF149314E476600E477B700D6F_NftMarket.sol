    ...
    SuperAdminControl
{
        ...
        whenNotPaused
    {
        ...
        uint256 stableCoinDecimals = IERC20Metadata(loanDetailsNFT.borrowStableCoin).decimals();
        require(loanDetailsNFT.loanAmountInBorrowed >= (ITokenMarketRegistry(marketRegistry).getMinLoanAmountAllowed() * (10 ** stableCoinDecimals)), "GLM: min loan amount invalid");
    ...
    function laonCancelBulk(uint256[] memory _loanIds)
        external
