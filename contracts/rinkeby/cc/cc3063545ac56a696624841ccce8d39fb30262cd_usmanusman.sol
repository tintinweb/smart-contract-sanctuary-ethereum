...
contract usmanusman is ERC721A,Ownable{
    // variables
       using Strings for uint256;
    ...
    uint public reserve=2;
    uint public presaleprice=1 ether;
    ...
    function setreserve(uint _reserve )public onlyOwner{
...
function whiteListMint( uint chosenAmount) public payable  {
