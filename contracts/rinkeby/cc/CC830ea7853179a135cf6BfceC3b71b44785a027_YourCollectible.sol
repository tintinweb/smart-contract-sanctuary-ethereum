...
//    mapping(uint256 => tokenInfo) private _tokenIdInfo;
    mapping(uint256 => uint256) private _tokenIdInfoNew;
    ...
    function mintItem() public returns (uint256) {
        _tokenIds.increment();
        uint256 tokenId = uint256(_tokenIds.current());
          ...
          onlyOwner
      {
          ...
          uint256 id = uint256(_tokenIds.current());
          uint256 songId = uint256(_songIds.current());
...
//          _tokenIdInfo[id].serial = songSerial;
          ...
          uint256 tokenIdInfoTemp = (songId * 1000000) + songSerial;
          _tokenIdInfoNew[id] = tokenIdInfoTemp;
          ...
          payable
      {
          ...
          //requires the current amount of copies that song to be less than 100
          require(_songSerials[songId] < 100, "Max amount of copies reached");
...
//      return _tokenIdInfo[tokenId].song;
      return _tokenIdInfoNew[tokenId] / 1000000;
