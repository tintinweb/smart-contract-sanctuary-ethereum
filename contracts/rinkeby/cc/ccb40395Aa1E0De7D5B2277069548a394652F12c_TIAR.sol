...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "TIAR";
    string internal constant SYMBOL = "TIAR";
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 20; // 1% of the total supply
    
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 20; // 2% of the total supply
    
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 200; // 0.1% of the total supply

    // --------------------- Fees Settings ------------------- //


    address internal TreasureryAddress = 0x02C2Cc6081c3310589fE44c67f737CC997042135;
    address internal StakingAndMoreAddress = 0xAaD5c453E5f3ad2af18a33D9508AaEA2238Bb3A1;


    address internal burnAddress = 0x0000000000000000000000000000000299792458;

    address internal ProjectManagementAdress = 0xcE144d1dA55B4F87439C06B1f1907502A7FA185C;
    ...
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.Rfi, 0, address(this) ); 

        _addFee(FeeType.Burn, 3, burnAddress );
        _addFee(FeeType.Liquidity, 10, address(this) );
        _addFee(FeeType.External, 10, TreasureryAddress );
        _addFee(FeeType.External, 20, StakingAndMoreAddress );
        _addFee(FeeType.ExternalToETH, 7, ProjectManagementAdress );
    }
