...
contract _80DVault is Ownable {
    ...
    function burnNFTIds(uint256 tokenIds) public
    returns (uint256[] memory burnTokens) {
           burnNftTokens.push(tokenIds);

           return burnNftTokens;
