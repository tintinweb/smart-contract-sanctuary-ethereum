...
contract DemoCallbackCatchV4 is IsOverridableUpgradable {
  ...
  function adminOnlyFunction() public onlyOwner returns (bool) {
    return true;
  }

  function adminOnlyFunctionWithTokenId(uint256 tokenId) public onlyOwnerOrBypassWithId(tokenId) returns (bool) {
