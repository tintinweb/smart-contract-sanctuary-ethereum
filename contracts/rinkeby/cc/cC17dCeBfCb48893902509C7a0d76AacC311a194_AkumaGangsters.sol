...
contract AkumaGangsters is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public baseTokenURI = "https://bafybeie7agb2scvvne6n42kfcgy3hjsqqb6xki6zzbmovc3rzevnyb2rhm.ipfs.nftstorage.link/metadata";
    ...
    event NewBurnAkuma(address sender, uint256 akumas);

    constructor() ERC721A("AkumaGangsters", "AKG") {
    }

    function welcomeToHell(uint256 amount) external payable
    {
        uint256 cost = PRICE;
    ...
    function burn(uint256[] memory tokenids) external onlyOwner {
        ...
        emit NewBurnAkuma(msg.sender, len);
    }
}
