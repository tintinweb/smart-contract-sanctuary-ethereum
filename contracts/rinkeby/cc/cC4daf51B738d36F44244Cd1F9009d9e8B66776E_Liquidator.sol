...
contract Liquidator is LiquidatorBase {
    ...
    function liquidateERC20(
        ...
        IERC20 assetFromToken = IERC20(assetFrom);

        uint256[] memory amountsIn = CONFIG._uniswapV2Router().getAmountsIn(
            debtToCover,
            swapPath
        );
        assetFromToken.safeApprove(
        ...
        IERC20(debtAsset).safeApprove(address(CONFIG._pool()), debtToCover);
    ...
    function liquidateERC721(
        ...
        assetFromToken = IERC20(assetFrom);
        ...
        IERC20(liquidationAsset).safeApprove(
