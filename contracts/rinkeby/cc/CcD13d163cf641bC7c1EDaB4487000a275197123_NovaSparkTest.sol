...
contract NovaSparkTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Nova Sparks", "NS") {
    setHiddenMetadataUri("ipfs://QmYrSwsj1w6tCtP43r2i9TsgKSpuZkQnpqv9E1fvnhcX8p/hidden.json");
  }
