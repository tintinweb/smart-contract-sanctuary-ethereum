...
contract StarMetadata is IStarMetadata, AdminControl {
    ...
    address public _starNameLookup;
     ...
     */
    function updateStarNameLookup(address starNameLookup) public adminRequired {
        _starNameLookup = starNameLookup;
    }
     ...
     */
    function updateStar(uint8 starType, string memory url, uint16 min, uint16 max) public adminRequired {
    ...
    function metadata(uint256 tokenId, IStar.StarInfo memory starInfo) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked('data:application/json;utf8,',
            ...
            '","attributes":[',
              '{"trait_type":"Type","value":"',  IStarName(_starNameLookup).getDefaultName(starInfo), '"},',
