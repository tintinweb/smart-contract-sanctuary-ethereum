...
contract CryptoToucan is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("CryptoToucan", "Toucan") {
        setBaseURI(baseURI);
    }

    function reserveNFTs() public onlyOwner {
        uint256 totalMinted = _tokenIds.current();
        require(totalMinted.add(500) < MAX_SUPPLY, "Not enough NFTs");
