...
contract FunkyCrocs is ERC721Enumerable, Ownable {  
    ...
    uint256 public constant MAX_PRESALE_SUPPLY = 10;
    uint256 public constant MAX_MINT_PER_TX = 1;

    // The base link that leads to the image / video of the token
    string public baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmTaBvNBo8ZhsfDgw31qhhyDSFMbx4EdjkTuYq1db8X2wf/"; 
    ...
    constructor () ERC721 ("Damian Guilisasti", "DGT") {
        price = initial_price;
    }
