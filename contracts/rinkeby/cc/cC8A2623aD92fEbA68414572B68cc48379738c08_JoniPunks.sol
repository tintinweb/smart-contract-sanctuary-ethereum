...
// File contracts/JoniPunksDNA.sol

pragma solidity ^0.8.0;

contract JoniPunksDNA {
...
// File contracts/JoniPunks.sol

pragma solidity ^0.8.0;

contract JoniPunks is ERC721, ERC721Enumerable, JoniPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("JoniPunks", "PLPKS") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No JoniPunks left :(");
