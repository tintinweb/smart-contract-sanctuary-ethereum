...
contract CryptoBonsai is ERC721Enumerable, Ownable {
    ...
    function getFgAcc(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 10 && gt <= 20) { fgAcc = 1; }
        if (gt > 21 && gt <= 30) { fgAcc = 2; }
        if (gt > 31 && gt <= 40) { fgAcc = 3; }
        if (gt > 41 && gt <= 50) { fgAcc = 4; }
        if (gt > 51 && gt <= 60) { fgAcc = 5; }
        if (gt > 61 && gt <= 70) { fgAcc = 6; }
        if (gt > 71 && gt <= 80) { fgAcc = 7; }
        if (gt > 81 && gt <= 90) { fgAcc = 8; }
        if (gt > 91 && gt <= 95) { fgAcc = 9; }
        if (gt > 96 && gt <= 100) { fgAcc = 10; }
    ...
    function getAccessories(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 1 && gt <= 5) { Accessories = 1; }
        if (gt > 6 && gt <= 10) { Accessories = 2; }
        if (gt > 11 && gt <= 15) { Accessories = 3; }
        if (gt > 16 && gt <= 20) { Accessories = 4; }
        if (gt > 21 && gt <= 25) { Accessories = 5; }
        if (gt > 26 && gt <= 29) { Accessories = 6; }
        if (gt > 30 && gt <= 39) { Accessories = 7; }
        if (gt > 40 && gt <= 50) { Accessories = 8; }
        if (gt > 51 && gt <= 60) { Accessories = 9; }
        if (gt > 61 && gt <= 70) { Accessories = 10; }
        if (gt > 71 && gt <= 80) { Accessories = 11; }
        if (gt > 81 && gt <= 85) { Accessories = 12; }
        if (gt > 86 && gt <= 90) { Accessories = 13; }
        if (gt > 91 && gt <= 95) { Accessories = 14; }
        if (gt > 96 && gt <= 100) { Accessories = 15; }
    ...
    function getPotAccessories(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 10 && gt <= 20) { potAcc = 1; }
        if (gt > 21 && gt <= 30) { potAcc = 2; }
        if (gt > 31 && gt <= 40) { potAcc = 3; }
        if (gt > 41 && gt <= 50) { potAcc = 4; }
        if (gt > 51 && gt <= 60) { potAcc = 5; }
        if (gt > 61 && gt <= 70) { potAcc = 6; }
        if (gt > 71 && gt <= 80) { potAcc = 7; }
        if (gt > 81 && gt <= 90) { potAcc = 8; }
    ...
    function getBgAcc(uint256 tokenId) internal pure returns (uint256) {
        ...
        if (gt > 30 && gt <= 40) { BgAcc = 1; }
        if (gt > 41 && gt <= 50) { BgAcc = 2; }
        if (gt > 51 && gt <= 60) { BgAcc = 3; }
        if (gt > 61 && gt <= 70) { BgAcc = 4; }
        if (gt > 71 && gt <= 85) { BgAcc = 5; }
        if (gt > 86 && gt <= 92) { BgAcc = 6; }
        if (gt > 93 && gt <= 100) { BgAcc = 7; }
    ...
    function getBonsaiSVG(cryptoBonsai memory bonsai) internal view returns (string memory) {
        ...
        parts[7] = '<path d="M120 410h260v10h10v10h-10v10h-10v10h-20v10h-200v-10h-20v-10h-10v-10h-10v-10h10z" fill="#000000" opacity="0.25"/><path d="M160 110h20v10h10v10h30v-20h20v30h10v10h20v-10h10v-10h20v10h10v10h10v-20h20v20h40v10h10v10h10v10h10v20h-10v10h-10v10h-10v10h-20v20h-40v-30h10v-10h10v-10h10v-10h-10v-10h-10v10h-10v10h-10v10h-30v-10h-10v-10h-40v-10h-10v-10h-30v10h10v20h10v10h10v20h-10v10h-10v10h-20v-10h-20v10h-20v-10h-10v-10h-10v10h-10v-10h-10v-20h10v-10h10v-20h-10v-10h-10v-20h10v-10h10v-10h30v-10h10z" fill="';
