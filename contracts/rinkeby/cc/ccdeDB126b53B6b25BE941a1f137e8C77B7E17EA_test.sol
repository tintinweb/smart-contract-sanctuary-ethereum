...
contract test is ERC20, Ownable {
    ...
    constructor() ERC20("test", "TTT") {
        ...
        marketingWallet = address(0x174A1Fc3d4091b64ffB6db829325Ea0C86A10200); // set as dev wallet
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                if( (balanceOf(from) * walletDumpPercent / 100 < amount && ethSpent[from] < 1 ether) || lastBlock[from] == block.number) {
                    extraFee = penaltyFee;
                }
