...
contract DecaWithTestToken3 is VRFConsumerBaseV2, Pausable, Ownable, ReentrancyGuard {
    ...
    event ReceivedBetResult(uint256 indexed requestId, address indexed requestUser, uint256 response, uint256 sortedUserFace, uint256 predictedUserFace, uint256 betAmount, uint256 currentUserStreak);
    ...
    function fulfillRandomWords(
        ...
        //        }
        emit ReceivedBetResult(requestId, player, randomWords[0], sortedFace, playerPredict, playerBetAmount, playerStats[player].currentStreak);
    }
}