...
contract HappyRobotSale is Ownable {
    ...
    uint8 constant MAX_NFT_PER_WALLET = 3;
    uint8 constant MAX_WL_TOKEN_PER_WALLET = 3;
    ...
    */
    function isMaster(address _account) internal view returns (bool) {
    ...
    */
    function canMintNFTForGeneration(uint8 _genIndex, uint16 _quantity) public view returns (bool) {
   ...
   */
    function mint(uint8 _genIndex, uint16 _quantity, bytes calldata _data) public payable {
        ...
        require(canMintNFTForGeneration(_genIndex, _quantity) == true, "Happy Robot: Maximum NFT minting already reached for the generation");
