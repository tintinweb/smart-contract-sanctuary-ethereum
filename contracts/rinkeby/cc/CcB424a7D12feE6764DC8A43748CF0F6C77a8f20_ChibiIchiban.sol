...
// File: contracts/ChibiIchiban.sol
...
contract ChibiIchiban is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Chibi Ichiban", "CHI") {
    setHiddenMetadataUri("ipfs://QmUii6M7tcYc47fxWcTmUfMUBQsifTkUZxsmu4ZqNNv2Up/1.json");
  }
