...
contract NFWANTED is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUngreb9witCHxPXH2BowcrBUSTxM3SFd5Jgdi3x2pZUW";
    ...
    uint256 public constant PRESALE_PRICE = 0.002 ether;
    ...
    modifier isCorrectPayment(uint256 _price, uint256 numberOfTokens) {
    ...
    constructor(
    ) ERC721A("NFwanTed9", "NFWP9", 100, maxSupply) {
    }
