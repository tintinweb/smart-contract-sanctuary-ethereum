...
Tokenomics: 
1% AUTO BURN. Tokens instantly deleted from existence+supply
1% AUTO REWARD. Holders with .5% tokens in wallet will recieve tokens as rewards. 
1% AUTO LIQUIDITY. Ensure higher floors & less dumps
4% DevandMarketing. For Project Dev 
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "T1FinalCheckinAugust6";
