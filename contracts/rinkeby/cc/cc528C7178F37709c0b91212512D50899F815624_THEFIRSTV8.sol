...
contract THEFIRSTV8 is ERC721Enumerable, AccessControl, Ownable, ReentrancyGuard {
  ...
  uint96 public royaltyFee = 250; //2.5 percent fee royalties
  uint256[] internal mintedTokens; //add to list token already minted
  // add royalty receiver
  ...
  function transferOwnership(bytes32 role, address account) public {
 ...
 function royaltyInfo(
    ...
    // set royalties info, use this function change royalty value
    function changeRoyaltyFee(uint96 _royaltyFee) public {
        require(hasRole(ADMIN, msg.sender), "Only admin can use this function");
    ...
    function _setTokenRoyalty(
        ...
        fee = royaltyFee;
        require (fee <= 10000, "royalty too high");
