...
contract Deneme1234 is ERC721A, Ownable {
    ...
    function isFreeMintedLimit() public view returns (bool) {

        return _mintedFreeAmount[msg.sender] == MAX_FREE_MINT_PER_WALLET ? true : false;
