...
contract GameErc1155 is ERC1155 {
    uint256 public constant Rupesh = 1;
    uint256 public constant Lokesh = 2;
    uint256 public constant Mayank = 3;

    constructor() ERC1155("https://ipfs.io/ipfs/bafybeihjjkwdrxxjnuwevlqtqmh3iegcadc32sio4wmo7bv2gbf34qs34a/{id}.json") {
        _mint(msg.sender, Rupesh, 1, "");
        _mint(msg.sender, Lokesh, 1, "");
        _mint(msg.sender, Mayank, 1, "");
    }
