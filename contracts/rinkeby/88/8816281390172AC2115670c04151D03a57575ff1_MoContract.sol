...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6a150Ad9a9ed66E6A52862ee00c7B8a0D18b6030];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://https://gateway.pinata.cloud/ipfs/QmUhpzRhmTz6UYZVGATR3WLEaLsad5aKqVaAKUxCFwq5dH/";
...
// File: contracts/MoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoContract is RamppERC721A {
    constructor() RamppERC721A("MO", "MT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SN5cQ9BoNdCbYlZwNPBN/contract-metadata";
    }
}
