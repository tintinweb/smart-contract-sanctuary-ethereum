...
contract ClubNumber4 is ERC721A, Ownable {

	uint public constant MAX_TOKENS = 10626;
	
	uint public CURR_MINT_COST = 0.001 ether;
	...
	constructor() ERC721A("Club Number 4", "ClubNumber4") {
		setBaseURI("http://137.184.20.41/club4/");
	}
	...
	function walletOfOwner(address _owner) public view returns (uint256[] memory) {
		...
		while (ownedTokenIndex < ownerTokenCount && currentTokenId <= MAX_TOKENS) {
