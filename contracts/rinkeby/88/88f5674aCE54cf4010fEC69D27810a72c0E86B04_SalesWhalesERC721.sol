...
contract SalesWhalesERC721 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_TOKENS_PER_MINT = 50; // 1
  uint256 public constant MAX_TOKENS_PER_MINT_WL = 5000; // 3
  uint256 public constant MAX_TOKENS = 4444;
  uint256 public constant MAX_WHITELIST_TOKENS = 1500;
  uint256 public constant MAX_TEAM_TOKENS = 444;
  uint256 public constant MAX_USED_SIGNATURES = MAX_WHITELIST_TOKENS;
  uint256 public constant MAX_TOKENS_PER_WALLET = 5000; // 3
