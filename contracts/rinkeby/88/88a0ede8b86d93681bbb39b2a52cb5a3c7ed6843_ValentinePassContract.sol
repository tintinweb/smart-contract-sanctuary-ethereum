  ...
  function _beforeTokenTransfer(
    ...
    contract ValentinePassContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Valentine Pass", "VDAYPASS", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/aGjLTS6ElpJorSE5NQx8/contract-metadata";
        }
    }