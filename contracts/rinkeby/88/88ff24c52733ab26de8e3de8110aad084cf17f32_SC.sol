...
contract SC is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    uint currentTokenId;
    uint256 internal MAX_SUPPLY;
    uint256 internal MAX_PER_WALLET;
    uint8 internal royaltyPercent;
    ...
    address payable internal royaltyAddress;
    ...
    function initialize() initializer public {
        ...
        propertyPrice[0] = 0.005 ether;
        propertyPrice[1] = 0.0010 ether;
        propertyPrice[2] = 0.0015 ether;
        propertyPrice[3] = 0.0020 ether;
        currentTokenId = 1;
        royaltyPercent = 25;
        MAX_SUPPLY = 50000;
        MAX_PER_WALLET = 50000;
        // eth-usd ropsten - 0x8468b2bDCE073A157E560AA4D9CcF6dB1DB98507
    ...
    function airdropNFT(uint8 _property, string memory _uri, address _to) external payable whenNotPaused onlyOwner {
        require(!uriIsPresent[_uri], "This URI already exists");
        require(!_isBlackListed[_to], "This account is blacklisted");
    ...
    function setRoyaltyAddress(address payable acc) public onlyOwner{
        royaltyAddress = acc;
    }
    ...
    function withdrawMoney() public onlyOwner {
        require(wallet1 != address(0) && wallet2 != address(0) && royaltyAddress != address(0), "Assign wallet1, wallet2 and royaltyAddress addresses properly");
        royaltyAddress.transfer(25*(address(this).balance)/1000);
        wallet1.transfer(70*(address(this).balance)/100);
    ...
    // pass in percent as => 2.5 becomes 25
    function setRoyaltyPercent(uint8 percent) public onlyOwner {
