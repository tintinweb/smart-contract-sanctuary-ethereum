...
/**
 * enter the lottery paying some eth/amount
 * pick a random winner
 * winner to be picked after x mins -> automaticlly execution
 * use tool: chainlink oracle -> randomness, automated execution -> chanlink Keeper
 */
 ...
 * @author lok
 * @notice this cotranct is creating for lottery and it can automaticly implements.
 */
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function fulfillRandomWords(
        ...
        s_raffleState = RaffleState.OPEN; //reopen rafflestate
        s_players = new address payable[](0); //reset s_players
