...
contract KryptKitties is Ownable, ERC721A, ReentrancyGuard {
    uint256 public constant MAX_TEAM_MINT = 1500;
    uint256 public constant MAX_FREE_MINT = 25000;
    uint256 public constant MAX_PAID_MINT = 12500;
    ...
    function paidMint(uint256 quantity) external payable callerIsUser {
        ...
        require(
            currentPriceToMint() * quantity <= msg.value,
    ...
    function currentPriceToMint() public view returns (uint256) {
        uint256 totalMinted = countTeamMint + countPaidMint + countFreeMint;
        // price goes up linearly
        return BASE_PRICE * ((totalMinted / 5000) + 1);
    }
