...
contract MyToken is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    string namecontract = "NFT Minter";
    
    // Symbol of the NFT contract.
    string symboltoken = "GGG";
    string tokenname = "The Ron Bielecki";
    // The maximum number of tokens that can be minted in this collection.
    uint256 maxSupply = 5000;
    // Minting price per token.
    uint256 mintonePrice = 0.00077 ether;
    uint256 minttwoPrice = 0.00087 ether;
    uint256 mintfreePrice = 0.00097 ether;
    ...
    address public treasuryAddress = 0xa46f3EF4F70C56A32B5Ff58714854F992106BC0C;
    ...
    address royaltiesAddress = 0xa46f3EF4F70C56A32B5Ff58714854F992106BC0C;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafkreict3tqvic6cx4qsrqx57pmjhjadflyblmjb5wufw3kpvvgpz7tbqy";
    }
    ...
    function Supplys() public view returns (uint256) {
    return Supply;
    }
