...
contract WRSContractV6 is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint public constant MAX_MINT_DURING_WHITELIST = 2000;
    uint public constant MAX_PER_WHITELISTED_WALLET = 3;
    uint public constant MAX_MINTS_BY_OWNER = 23;
    uint public constant WHITELIST_START_TIME = 1651150800; //Thur, 6:30
    uint public constant WHITELIST_END_TIME = WHITELIST_START_TIME + 2 days;
    uint public currentWhitelistMints;
    uint public ownerCurrentMints; 
    address public multisigWallet = 0xf2f0A6230827fa83982290de68234B4821F7D868; 
