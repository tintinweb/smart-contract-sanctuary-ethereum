...
contract TroversePlanets is Ownable, ERC721AStakable {
    ...
    constructor() ERC721AStakable("Troverse Planets", "PLANET") { }
    ...
    */
    ...
    /**
     * @dev See {ERC721AStakable-_baseURI}.
     */
    ...
    /**
     * @dev See {ERC721AStakable-_setOwnersExplicit}.
     */
     ...
     */
    function getRealOwnership(uint256 tokenId) external view returns (address) {
 ...
 */
contract ERC721AStakable is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    bool public staked;
    ...
    function stake(bool state) public {
        staked = state;
    }
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = ERC721AStakable.ownerOf(tokenId);
