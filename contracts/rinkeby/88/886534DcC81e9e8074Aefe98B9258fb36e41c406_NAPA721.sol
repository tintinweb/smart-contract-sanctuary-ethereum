...
import "../contracts/NAPA721.sol";

contract $NAPA721 is NAPA721 {
    constructor(string memory _name, string memory _symbol, address _receiverRoyaltyFee, uint96 _percentageRoyaltyFee) NAPA721(_name, _symbol, _receiverRoyaltyFee, _percentageRoyaltyFee) {}
