    ...
    ERC2981
{
        ...
        )
    {
        ...
        _setPaymentContract(_paymentContract, _royalties);
     ...
     */
    function _setPaymentContract(address _paymentContract, uint96 _royalties)
        internal
    {
        require(
        ...
        paymentContract = _paymentContract;
        _setDefaultRoyalty(paymentContract, _royalties);
    }

    function setPaymentContract(address _paymentContract, uint96 _royalties)
        external
        onlyAdmin
    {
        _setPaymentContract(paymentContract, _royalties);
    }
