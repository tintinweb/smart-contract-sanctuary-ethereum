...
contract TTT is Delegated, ERC721A, ReentrancyGuard {
    ...
    function publicMint(uint256 quantity) external payable callerIsUser {
        ...
        require(
            ...
            "Quantity must be less than maxBatchSize"
        );
        require(
    ...
    function setMaxBatchSize(uint256 maxBatchSize_) external onlyDelegates {
    ...
    function setCollectionSize(uint256 collectionSize_) external onlyDelegates {
