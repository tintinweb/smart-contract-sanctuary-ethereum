...
contract NumberGuessingGame is VRFConsumerBaseV2 {
    ...
    event NumberPicked(uint256 indexed correctNumber);
    ...
    s_correctNumber = randomWords[0] % 5;
    emit NumberPicked(s_correctNumber);
  }
function guessTheNumber(uint256 num) public payable {
    ...
    function getCorrectNumber() public view returns(uint256){
