...
contract Parrot is Context, IERC20, Ownable {
    ...
    address private USDC = 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926;
    ...
    function swapBack() private {
        ...
        swapTokensForTokens(initialUSDCBalance);
        _receiver.withdraw();
    ...
    function launch() external onlyOwner {
        ...
        maxBuyAmount = 1e7 * (10**_decimals);
        maxSellAmount = 1e7 * (10**_decimals);
        maxWalletAmount = 2e7 * (10**_decimals);
...
import "./interfaces/IUSDCReceiver.sol";
