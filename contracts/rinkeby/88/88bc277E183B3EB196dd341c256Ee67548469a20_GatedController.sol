...
contract GatedController is Controller {
    ...
    /**
     * @dev Unpermissioned commitment is blocked.
     */
    function commit(bytes32) public pure override {
        revert("use with whitelisting params");
    }
...
contract Controller is Ownable {
    ...
    function rentPrice(string memory, uint _duration) view public returns(address, uint) {
