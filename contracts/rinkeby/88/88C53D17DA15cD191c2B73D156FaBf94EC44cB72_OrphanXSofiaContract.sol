...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x424307CcDc88dE5cA6c0BB9d08c945ED86171E06];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x424307CcDc88dE5cA6c0BB9d08c945ED86171E06;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 444;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiac3h2p337vfikpmhkbhhy372eb2sfhvqtls4pg2fdaimoi7rv7n4/";

    bool public mintingOpen = true;
    
    
    uint256 public MAX_WALLET_MINTS = 8;
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 888");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 888");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 888");
...
// File: contracts/OrphanXSofiaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OrphanXSofiaContract is RamppERC721A {
    constructor() RamppERC721A("OrphanX  Sofia", "SOFIA"){}
}
