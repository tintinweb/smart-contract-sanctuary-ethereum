...
// File: contracts/Fishi.sol

pragma solidity >=0.7.0 <0.9.0;



contract FishmanLaboratory is ERC721Enumerable, Ownable {
    using Strings for uint256;
    string private baseURI;
    string public baseExtension = ".json";
    string public notRevealedUri;
    uint256 public preSaleCost = 0.079 ether;
    uint256 public cost = 0.079 ether;
    uint256 public maxSupply = 7000;
    uint256 public preSaleMaxSupply = 5500;
    uint256 public maxMintAmountPresale = 2;
    uint256 public maxMintAmount = 2;
    uint256 public nftPerAddressLimitPresale = 200;
    uint256 public nftPerAddressLimit = 200;
    uint256 public preSaleDate = 1647979200;
    uint256 public preSaleEndDate = 1648065600;
    uint256 public publicSaleDate = 1648065600;
