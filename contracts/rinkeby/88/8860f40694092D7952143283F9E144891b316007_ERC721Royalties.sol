...
contract ERC721Royalties is ERC721Royalty, ERC721Enumerable, ERC721Pausable, Ownable {
    ...
    address payable constant royaltyReciver = payable(0xd24650CC44AedF38429CF68B9A1451a51EE0Ba7E);

    // Akoin address to get mint share
    address payable constant akoinAddress = payable(0x756Cde64Bd25177e7834938E7199886eAa7f73E4);

    // Mad dawgs address to get mint share
    address payable constant madDawgsAddress = payable(0xd24650CC44AedF38429CF68B9A1451a51EE0Ba7E);
    ...
    uint public akoinShare = 0.02 ether;

    // Mad Dawgs share of each mint
    uint public madDawgsShare = 0.04 ether;
    ...
    uint96 public royaltyPercentage = 1000;
    ...
    constructor(
        ...
        // whitelist for testing only
        isWhiteListed[0x447EF67f32720584db14766673f722ebeaaE72b8] = true;
        isWhiteListed[0x756Cde64Bd25177e7834938E7199886eAa7f73E4] = true;
        isWhiteListed[0x200F4CF9235c99451D96cB767769135C53F7D7B7] = true;
    }
    ...
    function preSaleMint(uint _count) public payable whenNotPaused {
        ...
        uint preSalePrice = 0.06 ether;
        uint preSaleMaxMint = 10;
        ...
        (bool akoinSuccess, ) = payable(akoinAddress).call{
            value: akoinShare
        }("");
