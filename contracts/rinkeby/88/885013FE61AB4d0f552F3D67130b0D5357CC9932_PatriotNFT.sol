...
contract PatriotNFT is ERC721, Ownable{
    ...
    constructor() payable ERC721("PatriotNFT", "PATRIOT") {
        mintPrice = 0.0002 ether;
        totalSupply = 0;
        maxSupply = 666;
        maxPerWallet = 10;
        devAddress = payable(0xf0b9bb5D6a4E218B1e03c1072f33ffb522549c1a);
    }
    ...
    function getLimitAddressWhitelisted() public view returns (uint256[] memory){
        return limitAddress;
    }
    ...
    function mint(uint256 _numberOfTokens) public payable {
        ...
        require(walletMints[msg.sender] + _numberOfTokens <= maxPerWallet, "Can only mint 1 NFT per wallet");
        ...
        if(whitelistedAddresses.length > 0){
            ...
            require(isAddressWhiteListedLimit(msg.sender, 2), "Exceed limit whitelist wallet");
        }
