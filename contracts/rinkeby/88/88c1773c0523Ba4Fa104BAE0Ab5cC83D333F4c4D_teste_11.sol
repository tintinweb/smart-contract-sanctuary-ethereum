...
/**
    ...
    @dev MetaMallow extends ERC721A Non-Fungible Token implementation
*/
...
contract teste_11 is ERC721A, Ownable {
    ...
    */
    ...
    /**  
        @dev Mint MetaMallow function for whitelisted users
        @param _mintAmount number of ERC721 tokens to be minted
    */
    ...
    /**  
        @dev Mint MetaMallow function for public sale
        @param _mintAmount number of ERC721 tokens to be minted
    */
    ...
    /**  
        @dev Mint MetaMallow function for several wallets 
        @param _airdropWallets wallets to mint for
    */
    ...
    /**  
        @dev mint MetaMallow function for one wallet
        @param _airdropWallet wallet to mint for
        @param quantity amount of ERC721 tokens to mint
    */
    ...
    /**  
        @dev update pre supply function
        @param _newMaxPreSupply new pre supply
    */
    ...
    /**  
        @dev set the reference for the Firepit contract address
        @param _teste_2Address firepit contract address
    */
    function setDependeciesAddresses(address _teste_2Address) external onlyOwner{
        Iteste_2 = ITeste_2(_teste_2Address);
    }
    /**  
        @dev get the ownership data of token id
        @return TokenOwnership of token id
    */
    ...
    */
    ...
    /**  
        @dev define the whitelisted addresses
        @param _whitelistedWallets array with whitelisted addresses
    */
    ...
    /**  
        @dev set the sale state for the MetaMallow contract, if 0 means closed,
        @param _saleState 0 means closed, 1 means presale state, 2 means public sale state
    */
    function setSale(uint8 _saleState) external onlyOwner(){
        saleState = State(_saleState);
    }
    /**  
        @dev returns the number of MetaMallows minted by {_owner}
    */
    function numberMinted(address _owner) public view returns (uint256) {
        return _numberMinted(_owner);
    }
    /**  
        @dev set the maximum amount of MetaMallows to be minted in sales
    */
    ...
    */
    ...
    /**  
        @dev ERC721A {transferFrom} overrided so that users do not have to waste gas approving the Transfer when staking, only staking and
        unstaking functions from Firepit contract can override it. Transfers from user wallets and other contracts remains the same
    */
