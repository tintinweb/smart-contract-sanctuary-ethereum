...
contract ERC721Base is ERC721Enumerable, AccessControl, Pausable, Ownable {
    ...
    function mint(address[] memory tos, uint256[] memory tokenIds)
        public
        ...
        onlyRole(MINTER_ROLE)
    {
        ...
        emit SetTokenURI(tokenId, tokenURI_);
    }
