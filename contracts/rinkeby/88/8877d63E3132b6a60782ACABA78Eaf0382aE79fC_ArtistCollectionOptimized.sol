...
import "../Signable.sol";
import "./OptimizedERC721.sol";
import "./OptimizedERC721Enumerable.sol";
import "./OptimizedERC721URIStorage.sol";
import "./OptimizedERC721Burnable.sol";

// Version: Artist-3.0
contract ArtistCollectionOptimized is
    OptimizedERC721,
    OptimizedERC721Enumerable,
    OptimizedERC721URIStorage,
    OptimizedERC721Burnable,
    Royalties,
    AccessControlEnumerable
{
     ...
     */
    bytes32 public constant SIGNABLE_MINTER_ROLE =
        keccak256("SIGNABLE_MINTER_ROLE");
    ...
    ) OptimizedERC721(contractName, tokenSymbol, artist) {
    ...
    modifier onlySignableMinter() {
        require(
            hasRole(SIGNABLE_MINTER_ROLE, msg.sender),
            "Restricted to approved signable minters"
        );
        _;
    }
    ...
    function mintSignable(
        ...
        address to = Signable.recoverPersonalAddress(
            tokenId,
            _tokenURI,
            v,
            r,
        ...
        require(
            ...
            "Signature not generated by admin"
        );
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal override(OptimizedERC721, OptimizedERC721Enumerable) {
        super._beforeTokenTransfer(from, to, tokenId);
    }

    function _burn(uint256 tokenId)
        internal
        override(OptimizedERC721, OptimizedERC721URIStorage)
    {
        super._burn(tokenId);
    }
 ...
 */
abstract contract OptimizedERC721URIStorage is OptimizedERC721 {
 ...
 * account.
 */
abstract contract OptimizedERC721Enumerable is
    OptimizedERC721,
    IERC721Enumerable
{
    ...
    {
        require(
            index < OptimizedERC721.balanceOf(owner),
    ...
    {
        require(
            index < OptimizedERC721Enumerable.totalSupply(),
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = OptimizedERC721.balanceOf(to);
        ...
        private
    {
        ...
        uint256 lastTokenIndex = OptimizedERC721.balanceOf(from) - 1;
 ...
 */
abstract contract OptimizedERC721Burnable is Context, OptimizedERC721 {
    /**
 ...
 * {ERC721Enumerable}.
 * Optimized to mint directly to an address, but emit 2 transfers such that it does not appear as an airdrop by Opensea
 */
contract OptimizedERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        _beforeTokenTransfer(address(0), _hopFrom, tokenId);

        _balances[to] += 1;
        _owners[tokenId] = to;

        emit Transfer(address(0), _hopFrom, tokenId);
        _transfer(_hopFrom, to, tokenId);
    }
