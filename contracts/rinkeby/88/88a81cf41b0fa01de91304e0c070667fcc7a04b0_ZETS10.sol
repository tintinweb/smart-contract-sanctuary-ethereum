...
contract ZETS10 is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("ZETS10", "ZT10") {}
    ...
    function uri(uint256 _tokenId) public view virtual returns (string memory) {
        return string(abi.encodePacked("ipfs://Qmc6bVfnAsk74WJx9Ls3Dse33FuE8M5t6VHup5iF4NL77k/", Strings.toString(_tokenId), ".json"));
    }
