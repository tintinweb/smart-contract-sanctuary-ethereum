...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierStartMintTimes = [1644849053, 1644851753];
    //Minting ending time in unix-epoch [phase 1 start, phase 2 start]
    uint256[] public tierMintEndTimes = [1644849953, 1644852653];
    //Minting tier fee
    ...
    uint256 public whitelistSaleDisableTime = 1644848153;
    uint256 public whitelistSaleStartTime = 1644847253;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1644850853, 1644853553];
