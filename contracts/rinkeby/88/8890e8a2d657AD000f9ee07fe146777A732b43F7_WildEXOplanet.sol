...
contract WildEXOplanet is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierStartMintTimes = [1644841267, 1644842167];
    //Minting ending time in unix-epoch [phase 1 start, phase 2 start]
    uint256[] public tierMintEndTimes = [1644841567, 1644842467];
    //Minting tier fee
    ...
    //Whitelist mint fee
    uint256 public whitelistMintFee = 0.002 ether;
    //Whitelist disable time
    uint256 public whitelistSaleDisableTime = 1644840967;
    uint256 public whitelistSaleStartTime = 1644840667;
    //Reveal time for Phase 1 and Phase 2 tokens
    uint256[] public revealTime = [1644841867, 1644842767];
