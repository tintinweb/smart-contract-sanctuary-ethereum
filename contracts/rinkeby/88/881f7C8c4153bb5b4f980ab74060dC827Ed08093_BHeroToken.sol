...
contract BHeroToken is ERC721Upgradeable, AccessControlUpgradeable, PausableUpgradeable, UUPSUpgradeable {
  ...
  function initialize(address _design, address _oracle) public initializer {
    ...
    plushie = IBEP20(0x6D0b9CB6f3ea91552723F8AE6DEE197da2b73A67); // mintable coin for test oracle da mintable yi güncelemedim haberin olsun token e yazayım mı
  ...
  function getInfo() public view returns (uint256 amount ,uint256 bnbAmount) {
    return (design.getMintCost(),oracle.getNFTPrice(design.getMintCost()));
  }
  ...
  function mint(uint256 count) payable external {
    ...
    uint256 bnbAmount = oracle.getNFTPrice(amount); // interfaceden değil mi bu ?? çektik işte
