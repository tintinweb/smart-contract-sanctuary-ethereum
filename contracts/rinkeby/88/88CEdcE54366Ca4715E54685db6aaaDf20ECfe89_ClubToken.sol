...
contract ClubToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    mapping(address => bool) private _lock;
    string private _name;

    function initialize() initializer public {
        __ERC20_init("CLUB Token", "CLUB");
    ...
    function transferBulk(address[] memory _tos, uint256[] memory _values) public {
        require(_tos.length == _values.length, "Count Recipients/values don't match");
