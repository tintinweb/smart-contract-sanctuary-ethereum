...
contract CPTLO is ERC721URIStorage, Ownable, ReentrancyGuard{
...
//paused can be used to pause contract so no one can mint during this state!
bool public presale = true;
    uint256 immutable public maxGiftMintId = 0;
    uint256 public giftMintId = 0;

    uint256 immutable public maxWhitelistId = 122;
    uint256 public whitelistId = 1;
    uint256 public constant WHITELIST_SALE_PRICE = 0 ether;

    uint256 immutable public maxPublicMint = 2222;
    uint256 public publicMintId = 123;
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("Camera Person: The Lost Ones", "CPTLO") {
        setBaseURI(_baseURI);
