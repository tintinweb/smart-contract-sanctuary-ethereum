...
contract FlammablePunks is ERC721 {
    ...
    function rescuePunks(uint256 _quantity) public payable returns (bytes32) {
        require(tokenCounter < 99, "All punks have been rescued!");
        require(
            tokenCounter + _quantity <= 99,
        ...
        returns (bytes32)
    {
        ...
        uint256 vitalsProb = randomNumber % 99;
        uint256 vitals;
        ...
        for (uint256 i = 0; i < _quantity; i++) {
            ...
            string memory tokenCounterStr = uint2str(tokenCounter);
            _setTokenURI(
                tokenCounter,
                string(
                    abi.encodePacked(
