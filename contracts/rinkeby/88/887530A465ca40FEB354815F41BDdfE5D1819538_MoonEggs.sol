/**
    ...
    */
    ...
    pragma solidity ^0.8.0;
    contract MoonEggs is ERC721A, Ownable {
        using Strings for uint;

        uint public constant MINT_PRICE = 0.0029 ether;
        uint public constant MAX_NFT_PER_TRAN = 10;
        uint public constant MAX_PER_WALLET = 200;
        uint public maxSupply = 4361;

        // string private _baseURIExtended;
        bool public isPaused = true;
        bool public isMetadataFinal;
        string private _baseURL  = "ipfs://QmV5fdwFFkihMf9hgTvXS3gJbWiiScDKVDagq8b2S7ugv7/";
        string public prerevealURL;
        mapping(address => uint) private _walletMintedCount;

        constructor()
        // Name
        ERC721A('MoonEggs', 'Eggs') {
        }
