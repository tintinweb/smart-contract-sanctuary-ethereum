...
contract RicchezzaSword002 is ERC721URIStorage {
    /* Variable */
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    address private immutable linkTokenAddress;
    string private constant baseTokenURI = 
        "ipfs://QmfKSYVeTxFMVBc81fN4U1CeeD5oLeLnPQRDpLSNC4Y8qA?filename=sword001.json";
    ...
    function mintThisNFT(address _player) public returns (uint256) {
        require(
            IERC20(linkTokenAddress).balanceOf(msg.sender) > 5,
            "not enougth LINK"
        );
        // pay process
        IERC20(linkTokenAddress).transferFrom(msg.sender, address(this), i_price);
    ...
    function burnAndRedeem(uint256 _tokenIdToBurn) public {
        ...
        IERC20(linkTokenAddress).transfer(msg.sender, i_redeemPrice);
