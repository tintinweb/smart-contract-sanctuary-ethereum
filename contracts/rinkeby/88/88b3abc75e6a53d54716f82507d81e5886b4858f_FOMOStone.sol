...
contract FOMOStone is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(address payable _owner) ERC721("FOMO Stone", "FOMO") {
        ...
        saleConfig.max_num = 5;//最多mint數量=2
        saleConfig.FOMO_total = 60;//發行4200
        saleConfig.round_total = 20;//每階段最多mint個數
        saleConfig.startTime = 1650848400;//2022-04-25 09:00
        saleConfig.endTime = 1650859200;//2022-04-25 12:00
