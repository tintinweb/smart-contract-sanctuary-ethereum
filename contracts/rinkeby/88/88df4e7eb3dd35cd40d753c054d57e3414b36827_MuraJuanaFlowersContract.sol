...
//
//     __  ___                     __                                ________                            
//    /  |/  /_  ___________ _    / /_  ______ _____  ____ _        / ____/ /___ _      _____  __________
//   / /|_/ / / / / ___/ __ `/_  / / / / / __ `/ __ \/ __ `/       / /_  / / __ \ | /| / / _ \/ ___/ ___/
//  / /  / / /_/ / /  / /_/ / /_/ / /_/ / /_/ / / / / /_/ /  _    / __/ / / /_/ / |/ |/ /  __/ /  (__  ) 
// /_/  /_/\__,_/_/   \__,_/\____/\__,_/\__,_/_/ /_/\__,_/  (_)  /_/   /_/\____/|__/|__/\___/_/  /____/  
//                                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7F51CD3e8eA79bEdC807a05Ba2D7352Ac795a99A];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 1420 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWTAs9pnTigAnzNX3roz9z86GBJ3M51orMPGuoXWfjqK6/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1420");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1420");
...
// File: contracts/MuraJuanaFlowersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MuraJuanaFlowersContract is RamppERC721A {
    constructor() RamppERC721A("MuraJuanaFlowers", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/eLjWO6x7NFSakO38f6Ua/contract-metadata";
    }
}
