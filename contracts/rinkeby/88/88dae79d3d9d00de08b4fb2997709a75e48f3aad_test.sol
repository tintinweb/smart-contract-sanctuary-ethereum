...
contract test is ERC721A, Ownable {
    ...
    string public baseURI = "https://ipfs.io/ipfs/QmRRAqpW5FBGJqdgzYJLDF4STp2yvnNWvRzYhHRRmDVA2g";
    ...
    function mintSpecial(uint256 numTokens) 
        public 
        onlyOwner
    {
        _safeMint(msg.sender, numTokens);
    ...
    function setMaxMints(uint256 newMax) 
        private
        onlyOwner 
    {
        MAX_MINTS = newMax;
    ...
    function setSupply(uint256 newSupply) 
        private
        onlyOwner 
    {
