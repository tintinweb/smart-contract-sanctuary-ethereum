...
contract FuzzStaking is IERC721Receiver, Ownable {
    ...
    function setMinimumClaim(uint256 _minimumClaim) public onlyOwner() {
        minimumClaim = _minimumClaim;
    }
        ...
        returns (uint256[] memory rewards)
    {
        ...
        for (uint256 i; i < tokenIds.length; i++) {
            ...
            rewards[i] =
                ...
                (Math.min(block.timestamp, maxRewardTime) - depositTimes[account][tokenId]);
        }
    }
