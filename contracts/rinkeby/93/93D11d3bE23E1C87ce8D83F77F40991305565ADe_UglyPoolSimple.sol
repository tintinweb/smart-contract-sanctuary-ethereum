...
contract UglyPoolSimple is IERC721Receiver, Ownable, Pausable {
    ...
    constructor(){
        ...
        createPool(IERC721(0x0000000000000000000000000000000000000000),emptyArray,0, 0);         // set pools[0] to nothing
...
// Create Pool
    ...
    function createPool(IERC721 _registry, uint[] memory _tokenIds, uint _price, uint _fee) public whenNotPaused { 
