...
contract R0N1World is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
  ...
  /****************************************************
    PRE-MINTING
  /****************************************************/
  function preMintR0N1(uint256 _qty) public payable onlyOwner {
    require(totalSupply() + _qty <= MAX_OWNER_SUPPLY, "Not enough left");
  ...
  function mintR0N1(uint256 _qty) public payable whenNotPaused nonReentrant {
    ...
    require(totalSupply() + _qty <= MAX_SUPPLY, "Not enough left");
