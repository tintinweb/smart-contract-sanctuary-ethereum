...
// Set the open zepellin contract version
...
contract PlainSample002V1 is ERC721, ERC721Enumerable, Ownable, Pausable {

    using SafeMath for uint256;

    uint256 public constant MAX = 20000;

    uint256 public constant MAX_PER_PURCHASE = 100;

    //price is expressed in wei
    uint256 private price = 1; // 0.000000000000000001 Ether
    // uint256 private price = 50000000000000000; // 0.05 Ether

    constructor() ERC721("PlainSample002V1", "PS002V1") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmcqdWzXjo9qgzjzk6vKey4nntvxa7CJynDTXx1HDRwwVw/";
    }
