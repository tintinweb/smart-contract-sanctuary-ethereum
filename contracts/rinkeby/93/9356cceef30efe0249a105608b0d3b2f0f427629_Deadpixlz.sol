...
contract Deadpixlz is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transtion = 10; // maximam amount that user can mint
  uint256 public MAX_PER_Address = 50; // maximam amount that user can mint
  ...
  constructor() ERC721A("DEAD PIXLZ","DEAD PIXLZ") {
    _baseTokenURI = "ipfs://QmUrUsS13HfsvM2BkZGj6VqD4brbBfnR4PQNK9chxsGzXk/";
  }
  ...
  function giveaway(address address_, uint quantity_)public onlyOwner{
    require(totalSupply() + quantity_ <= TotalCollectionSize_, "reached max supply");
