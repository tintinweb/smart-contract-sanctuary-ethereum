...
contract Ragnarok is ERC1155, ERC1155Pausable, ERC1155Supply, Ownable {
    ...
    address payable DEFAULT_PLATFORM_ADDRESS =
        payable(0xE680BA443942b363046e2ccFC286Ad6404014eB3);
    ...
    uint256 public constant DEFAULT_NFT_PRICE = 0.77 * 1 ether; // Actual value -> 0.77 * 1 ether;
    uint256 public constant DEFAULT_DECREASE_NFT_PRICE_AFTER_TIME_INTERVAL =
        0.0035 * 1 ether; // Actual value -> 0.0035 * 1 ether;
    ...
    uint256 public constant DEFAULT_INITIAL_PUBLIC_SALE = 1 hours; // Actual value -> 1 days;
    uint256 public constant DEFAULT_PIXELMINT_SALE = 3 hours; // Actual value -> 3 days;
    uint256 public constant DEFAULT_PILLMINT_SALE = 5 hours; // Actual value -> 5 days;
    uint256 public constant DEFAULT_TEAMMINT_SALE = 6 hours; // Actual value -> 6 days;
    ...
    function teamMintingSale() external returns (bool) {
        if (checkSaleType() == SaleType.TeamMint) {
            ...
            if (teamMintWhitelistedAddresses[msg.sender] != 0)
                revert WhitelistedAddressAlreadyClaimedNFT();
            if (msg.sender != DEFAULT_PLATFORM_ADDRESS)
                revert UnAuthorizedRequest();

            teamMintWhitelistedAddresses[msg.sender] = 1;
