...
library EnumerableSet {
    ...
    function add(AddressSet storage set, address value)
        ...
        returns (bool)
    {
        return _add(set._inner, bytes20(uint160(value)));
    }
    ...
    function remove(AddressSet storage set, address value)
        ...
        returns (bool)
    {
        return _remove(set._inner, bytes20(uint160(value)));
    }
    ...
    function contains(AddressSet storage set, address value)
        ...
        returns (bool)
    {
        return _contains(set._inner, bytes20(uint160(value)));
    }
    ...
    function insert(
        ...
        return _insert(set_._inner, index_, bytes20(uint160(valueToInsert_)));
    }
...
abstract contract BEP20 is IBEP20 {
    ...
    bytes32 private constant BEP20TOKEN_ERC1820_INTERFACE_ID =
        keccak256("BEP20Token");
...
abstract contract BEP20Permit is BEP20, IBEP2612Permit {
...
contract VaultOwned is Ownable {
    address internal _vault = msg.sender;
...
contract TToken is BEP20Permit, VaultOwned {
    using SafeMath for uint256;
    address public admin;

    constructor() BEP20("TToken", "TTK", 18) {
        _mint(msg.sender, 600 * 10**9);
        admin = msg.sender;
    }
