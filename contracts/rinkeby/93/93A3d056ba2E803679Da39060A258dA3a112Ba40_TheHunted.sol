...
contract TheHunted is ERC1155, Ownable {
    struct NftToken {
    ...
    constructor() 
      ERC1155("https://gateway.pinata.cloud/ipfs/QmQ1xSt4ygGS7D9mGa27vXNQYYMWWQn3CBrSETvfaLn6Q6/{id}")
    {
    ...
    modifier canMint(uint8 _number)
    {
        ...
        require (nftToken.currentMinted + _number <= nftToken.totalSupply, "exceed the max supply limit");
        _;
    }
    ...
    /* 
      mint tokens
    */
    function mint(uint8 number) external payable canMint(number)
    {
    ...
    */
    ...
    {
        require (nftToken.currentMinted + _addrs.length <= nftToken.totalSupply, "exceed the max supply limit");
        uint32 _currentMintedID = nftToken.currentMinted;
