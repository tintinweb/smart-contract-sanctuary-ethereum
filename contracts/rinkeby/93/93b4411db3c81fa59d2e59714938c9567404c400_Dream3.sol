...
contract Dream3 is ERC721A,Ownable,ReentrancyGuard,ERC2981  {
    using Strings for uint256;

    uint256 public constant NFT_COLLECTION_MAX = 10000;    
    uint256 public constant MAX_PER_WALLET = 20;
    uint256 public constant RESERVE_TOKEN = 100;
    ...
    ******************/
    ...
    function reserveTokensForTeam() external onlyOwner{
        ...
        _mint(teamWallet, RESERVE_TOKEN);
    }
