...
contract AswangAllowlistRaffle is OpenAllowlistRaffleBase {
    ...
    uint256 public rwasteFee;
    uint256 public scalesFee;
        ...
        )
    {
        ...
        rwasteFee = _rwasteFee;
        scalesFee = _scalesFee;
    }
    ...
    /**
     * @notice Set fee to purchase a single raffle entry with $RWASTE
     * @param _rwasteFee Cost of a raffle entry in $SCALES
     */
    function setRwasteFee(uint256 _rwasteFee) public onlyOwner {
        rwasteFee = _rwasteFee;
    }

    /**
     * @notice Set fee to purchase a single raffle entry with $SCALES
     * @param _scalesFee Cost of a raffle entry in $RWASTE
     */
    function setScalesFee(uint256 _scalesFee) public onlyOwner {
        scalesFee = _scalesFee;
    }
    ...
    function enterWithRWaste(uint256 amount) public whenNotPaused onlyKingz {
        RWASTE.burn(_msgSender(), amount * rwasteFee);
    ...
    function enterWithScales(uint256 amount) public whenNotPaused onlyKingz {
        SCALES.spend(_msgSender(), amount * scalesFee);
