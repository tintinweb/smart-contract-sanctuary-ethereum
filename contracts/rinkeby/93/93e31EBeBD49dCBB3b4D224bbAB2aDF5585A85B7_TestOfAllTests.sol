...
contract TestOfAllTests is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // CONFIGURE VARIABLES BELOW, SET NAME AND SYMBOL IN CONSTRUCTOR, CHANGE WITHDRAW RECIPIENT
    string public baseURI; // (when reveal is ready)
    string public hiddenURI;
    bytes32 public whitelistMerkleRoot; // (after whitelisting is ready)
    ...
    constructor() ERC721A("Test Of All Tests", "TOAT") {}
