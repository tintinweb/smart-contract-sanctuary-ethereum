...
contract NFT is ERC721Enumerable, Ownable {
  ...
  address private payTo = 0x55feCD02FcaeA0828176094C2b2E356a8469DB13;
  uint256 public freeMintLimit = 1;
  bool public paused = false;
  bool public onlyWhitelist = true;
  address[] public whitelistedAddresses = [0x8fB24B307aaFE1BF02977934936487C06Ae8C1a0, 
  0xf40D690550e3a244F5127494259227d32CAbd6D4];
  address[] public freeMintAddresses = [0xf40D690550e3a244F5127494259227d32CAbd6D4];

  mapping(address => uint256) public addressMintedBalance;

 constructor(
  ) ERC721("ApeStarz", "APSZ") {}
  ...
  function mint(uint256 _amount) public payable {
    ...
    require(supply + _amount <= maxSupply, "maxSupply exceeded");
