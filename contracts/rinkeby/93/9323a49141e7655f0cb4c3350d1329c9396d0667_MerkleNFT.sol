...
contract MerkleNFT is ERC721Burnable, ERC2981, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public TOKEN_LIMIT = 5000;
        ...
        public
    {
        ...
        require(
            ...
            "MerkleNFT: invalid merkle proof"
        );
    ...
    function mint(uint256 amount) public {
        require(PUBLIC_MINTABLE == true, "MerkleNFT: public minting disabled");
        require(
        ...
        virtual
    {
        require(
            ...
            "MerkleNFT: We are out of Tokens"
        );
    ...
    function setBaseURI(string memory _baseTokenUri) public virtual onlyOwner {
        require(!BASE_URI_FROZEN, "MerkleNFT: BaseURI can't be changed anymore");
