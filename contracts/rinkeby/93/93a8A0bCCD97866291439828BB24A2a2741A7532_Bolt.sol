...
contract Bolt is Ownable, ERC721A, ReentrancyGuard {
    ...
    //supply
    uint256 private constant TotalCollectionSize_ = 4045; // total number of nfts
    uint256 private constant WL_Supply = 1500; // total number of nfts for wl
     uint256 private constant team_supply = 10; // total number of nfts for team
