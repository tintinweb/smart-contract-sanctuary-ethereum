...
// File: contracts/MyNewContractContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNewContractContract is RamppERC721A {
    constructor() RamppERC721A("My New Contract", "ROBOT"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/O9da41A5H8xWrKrezSg3/contract-metadata";
    }
}
