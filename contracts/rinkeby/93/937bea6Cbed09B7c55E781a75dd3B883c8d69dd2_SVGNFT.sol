...
contract SVGNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("OnChainDog", "OCDOG")
    {
       tokenCounter = 0;
    ...
    function tokenCounterString() public view returns(string memory) {
        // Expression that reads state
        return string(uint2str(tokenCounter));
    }
    ...
    function formatTokenURI(string memory imageURI) public view returns (string memory) {
        string memory tkc = tokenCounterString();
        return string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{',
                                    '"name":"OnChainDog', tkc ,'",',
                                    '"description":"OnChainDog - 3333 Dogs...Image, metadata, ownership all on chain.",',
