...
contract SuperBLOX3D is ERC721A, Ownable {
    ...
    constructor() ERC721A("superBLOX3D", "SB3D") {
        saleIsActive = false;
        revealed = false;
    }
    ...
    function airdropSB(uint256 _qty) public onlyOwner {
        ...
        //ERC721A sbContract = ERC721A(0x9eAE2e033dAe8573f53617125967f963AF96984C);
        
        ERC721A sbContract = ERC721A(0xd9145CCE52D386f254917e481eB44e9943F39138); //FOR TESTING
        
        for(uint256 i = 0; i < _qty; i++) {
        _safeMint(sbContract.ownerOf(adCount),1);
        adCount = adCount + 1;
        }
