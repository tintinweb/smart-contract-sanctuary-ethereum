...
/**
 * @title Clothing contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract Clothing is ERC721, Ownable {
    using SafeMath for uint256;
    uint public maxNFTPurchase = 20;
    uint256 public maxNFT = 55;

    constructor() ERC721("Chicken Derby - Clothing", "CD-CLOTH") {}
    ...
    function setMaxToMint(uint256 _maxValue) external onlyOwner {
        maxNFTPurchase = _maxValue;
    }

    /**
     * Set maximum count to mint totally
     */
    function setMaxNFT(uint256 _maxValue) external onlyOwner {
        maxNFT = _maxValue;
    }
