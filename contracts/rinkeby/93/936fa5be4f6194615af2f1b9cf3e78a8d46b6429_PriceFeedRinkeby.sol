...
contract PriceFeedRinkeby {
    ...
    constructor() {
        ...
        btc_usd_price_feed = AggregatorV3Interface(0xECe365B379E1dD183B20fc5f022230C044d51404);
    ...
    function getBtcUsd() public view returns (uint) {
        (
            , int price, , , 
        ) = btc_usd_price_feed.latestRoundData();

        
        uint BtcUsd = price.toUint256();

        return BtcUsd;
    }

    function getEurUsd() public view returns (uint) {
        (
            , int price, , , 
