...
contract CliveGotRekt is ERC721, Ownable, ERC721Enumerable, ReentrancyGuard {
    using Strings for uint256;
	...
	uint256 public SALE_PRICE = 0.007 ether;
    ...
    constructor() ERC721("Clive Got Rekt", "CLIVE") {}
