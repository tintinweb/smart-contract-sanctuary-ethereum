...
contract SpaceCrocos is ERC721A, ERC2981 , Ownable, Pausable {
    ...
    address constant public BULK_TRANSFER_ADDRESS = 0x92A4517AD3F13acD9F839237588333Bfc8F44501;
    ...
    function withdraw() external onlyOwner {
        Address.sendValue(payable(0x4e853b7a1FdbFf9FB11Ce02C362cca8465B77f06), address(this).balance);
    }
