...
contract Elite is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable, UUPSUpgradeable, ContextMixin, NativeMetaTransaction {
    ...
    bool private _secAllowMsgSenderOverride;
    bool private _secAllowIsApprovedForAll;
    ...
    function initialize() initializer public {
        __ERC721_init("Elite", "ELT");
        __ERC721Enumerable_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC721Burnable_init();
        __EIP712_init("Elite", "1");
        __ERC721Votes_init();
        ...
        _secAllowMsgSenderOverride = true;
        _secAllowIsApprovedForAll = true;
        inited = false;
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://elite.sh/";
    }
    ...
    function isApprovedForAll(address owner, address operator) public view override(ERC721Upgradeable, IERC721Upgradeable) returns (bool isOperator) {
...
contract NativeMetaTransaction is EIP712Base {
    ...
    mapping(address => uint256) noncesv2;
    ...
    function executeMetaTransaction(
        ...
        noncesv2[userAddress] = noncesv2[userAddress].add(1);
...
contract EIP712Base is InitializableV2 {
    struct EIP712Domain {
        string name;
        string version;
