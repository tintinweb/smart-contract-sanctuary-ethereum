...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private treasury  = 0x111189d729e8d544764994C78504434b7b3b86Ca;
...
contract Shite  is ERC20, Ownable {

    address private team = 0x11117b6a9473421ad04e0704537684cA9aCe4EC4;
    address private treasury  = 0x111189d729e8d544764994C78504434b7b3b86Ca;
    address burn = 0x000000000000000000000000000000000000dEaD;
    constructor() ERC20("ShiteDodge", "Shite" ) {
        _mint(msg.sender, 100000000000000000000);
        _mint(team, 100000000000000000000);
        _mint(treasury , 100000000000000000000);
        _burn (treasury, 50000000000000000000);
    }
