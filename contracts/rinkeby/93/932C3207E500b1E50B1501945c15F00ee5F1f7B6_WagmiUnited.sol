...
contract WagmiUnited is PvERC1155, PVAllowlist, PaymentSplitter  {
    ...
    */
    function returnToPreviousPhase() external onlyOwner {
        require(tokenIdToMint > 1, "Cannot go below phase 1");
    ...
    */
    function publicMint(uint256 amount) external payable {
        require(msg.sender == tx.origin, "minting from contract prohibited");
        require(amount < maxPerTx, "max amount exceeded");
        require(msg.value == amount * mintPrice, "Purchase: Incorrect payment"); 
        require(totalSupply(1) + amount <= maxSupply, "Purchase: Max supply reached");
    ...
    */
     ...
     */
    function ownerMint(address _receiver, uint256 _amount, uint256 _tokenId) external onlyOwner {
