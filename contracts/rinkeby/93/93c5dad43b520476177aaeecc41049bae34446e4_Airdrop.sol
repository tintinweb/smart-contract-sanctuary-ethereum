...
string private _tokenBaseURI = "https://ipfs.io/ipfs/QmTaH2TPvGUVaxFsZh72Ri8iknpycrRriufFhKYyAeDdqP?filename=bug.jpg";
    
    constructor() ERC721("Certificate", "Encode") {
    ...
    function Graduation(address[] memory receivers) external onlyOwner {
    ...
    function setBaseURI(string calldata URI) public onlyOwner notLocked {
        _tokenBaseURI = URI;
    }
