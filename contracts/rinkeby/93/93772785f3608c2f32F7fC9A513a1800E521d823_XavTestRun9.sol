...
// File: contracts/xavtestrun9.sol
...
contract XavTestRun9 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("XTR9", "XTR") {
    setHiddenMetadataUri("ipfs://QmX7dgF51Vx9vcDei3SpBxTvdke3yovNKUnZMHdkABXBaB/hidden.json");
  }
