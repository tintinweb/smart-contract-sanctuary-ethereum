// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Overlay", unicode"Face", unicode"Head", unicode"Background"];
        bool private shouldWrapSVG = true;

        uint256 public constant maxSupply = 4096;
        uint256 public maxPerAddress = 100;
        uint256 public publicMintPrice = 0.032 ether;
        string public baseURI = "";
        bool public isPublicMintActive = false;
        
        ContractData public contractData = ContractData(unicode"Mikrobes", unicode"pixelated variations of the bktrio microbes", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/8ce16aaf-caab-4d09-8054-17f75bd1e13a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/8ce16aaf-caab-4d09-8054-17f75bd1e13a", "", 0, "0x62F099a34F01d57c67A100851184bEA0D48b45F6");

        constructor() ERC721A(unicode"Mikrobes", unicode"mkrb") {
            TIERS[0] = [5,10,10,20,50,50,50,50,50,50,50,100,100,100,100,100,100,100,100,100,100,2701];
TIERS[1] = [10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,42,42,42,42,42,76,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100];
TIERS[2] = [4,4,8,8,8,8,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,25,25,25,25,25,25,25,25,25,25,25,25,25,25,25,25,25,25,25,25,26,26,26,26,26,26,26,42,42,42,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,45,45,45,45,45,45,45,45,45,45,45,46,46,46,46,46,46,46,46,46,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,54,54,55,56,57,58,58,58,60];
TIERS[3] = [10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,20,20,20,20,20,20,20,20,20,30,30,30,30,30,36,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,300,300,300,300,300,300,300,300,500];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Mikrobes #");
