    ...
    ERC721Holder
{
    ...
    mapping(bytes32 => bool) public hashedMessage;
    ...
    function fill(
        ...
        require(isAuthorizedTransaction(_hashedMessage, _v, _r, _s), "Unauthorized");
        require(!hashedMessage[_hashedMessage], "Authorization expired");
        require(tokenIds.length == tokenURIs.length, "Missing token IDs or URIs");

        filledSwap[swapTxHash] = true;
        hashedMessage[_hashedMessage] = true;
    ...
    function isAuthorizedTransaction(bytes32 _hashedMessage, uint8 _v, bytes32 _r, bytes32 _s) public view returns (bool) {
