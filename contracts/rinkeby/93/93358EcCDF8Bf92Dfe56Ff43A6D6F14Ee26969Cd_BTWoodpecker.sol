...
contract BTWoodpecker is ERC721, Ownable {

    uint public mintPrice = 1 wei;
    uint public maxItems = 999;
    ...
    constructor(address _recipient) ERC721("BTWoodpecker", "BT") {
        transferOwnership(0x1a01Ce615f69b52A25D6afAcAFE658B51CfFbafF);
