...
contract P2PExchangeV2 is ReentrancyGuard,Ownable {
        ...
        nonReentrant
    {
        ...
        uint256 sendAmount = _amount.mul(100*100 - fee).div(100).div(100); //fee
        ...
        emit Withdraw(_token,_user, sendAmount);
    }

    // user cancel transaction after deposit coin
    function withdrawETH(address _user,uint256 _amount) external  onlyOwner nonReentrant {
