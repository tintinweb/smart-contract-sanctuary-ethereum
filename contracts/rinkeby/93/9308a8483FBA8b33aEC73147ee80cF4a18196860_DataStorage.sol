...
contract DataStorage is Ownable {
    ...
    mapping(uint256 => Pass) internal _passIdToCollectionPass;
    ...
    function getPassIdToCollectionPass(uint256 _passId) external view returns (Pass memory){
    ...
    function addPass(uint256 _passId, Pass calldata _pass) external onlyConsumer {
