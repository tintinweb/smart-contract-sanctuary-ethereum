...
contract testV1 is ERC721, Ownable {
    using Counters for Counters.Counter;
    using SafeMath for uint256;

    Counters.Counter private _tokenIds;
    uint256 public constant MAX_SUPPLY = 323; //10.000 V1 Phunks
    uint256 public constant MAX_PER_MINT = 10;
    uint256 private constant MAX_RESERVED_MINTS = 5;

    uint256 public FREE_STAGE_MINTING= 5;
    ...
    string public baseTokenURI = "ipfs://QmNWKAz3TPqaERTTit2MozVNnRK2uWhCtjHW5UQtyy5dgU/";

    constructor() ERC721("testV1", "V1test") {
