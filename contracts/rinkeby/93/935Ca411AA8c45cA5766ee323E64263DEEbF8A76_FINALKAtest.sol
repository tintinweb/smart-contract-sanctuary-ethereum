...
contract FINALKAtest is ERC721URIStorage, ERC721Burnable, ERC721Royalty, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    string private _contractURI;
    uint256 public burned;

    constructor(string memory contractURI_, uint96 feeNumerator) ERC721("FINALKAtest", "Fin") {
