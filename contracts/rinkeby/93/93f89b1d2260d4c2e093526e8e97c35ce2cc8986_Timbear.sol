...
contract Timbear is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool artistSuccess, ) = payable(0x95cc77a2c37Fd7e1A603e9c879A3A8f08B02F755).call{value: address(this).balance * 50 / 100}('');
