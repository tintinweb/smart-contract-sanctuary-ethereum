...
// File: src/contracts/Genetinks.sol

pragma solidity ^0.8.4;



contract Genetinks is ERC721Enumerable, Ownable {
    enum Status {
        NOT_LIVE,
        PRESALE,
        PUBLIC_MINT
    ...
    bytes32 private constant whitelistRoot =
        0x3d8c086a783cfbb8f87e9e39baf113847677c5b8854891c1ec943de19a0d1f16;
    ...
    //Constructor
    //**************************************************************************
    constructor() payable ERC721("Genetinks", "GENTNKS") {
        //Hardcode foundation piece owner addresses
        foundationHolderWallets[
            0xF0C4eA72e1e294bC6c297a695838db7b1c671325
        ] = true;
        foundationHolderWallets[
            0x468886B83E425074E2929F2Ad6CBC7E6c46c72a8
        ] = true;

        //Hardcode mods mints allowed
        modAllocation[0xE08F1bCAFD331f7dE3CB381f4c9638542E067444] = 2;
        modAllocation[0xD0343d11e3191d631d482839fC405Ccc703E8ce8] = 3;
    }
    ...
    function mintFoundation(uint256 quantity) external payable presaleCheck {
        ...
        require(
            msg.value + mintPrice >= mintPrice * (quantity - 1),
            "Insufficient funds"
        );
