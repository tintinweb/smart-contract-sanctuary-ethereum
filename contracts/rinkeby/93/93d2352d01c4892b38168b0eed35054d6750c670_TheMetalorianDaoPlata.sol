...
// File: contracts/theMetalorianDaoPlata.sol
...
///@title TheMetalorianDaoPlata
///@notice Token ERC721 for the Metalorian Dao
contract TheMetalorianDaoPlata is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 3000;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 3000;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian Dao Plata", "TMDP") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeicf3d45zkvwbemckmingfpwwsvte3wa2pj5qnrt7gggczmt4x5k3u/PlataJson/";   
        mintCost = 0.0001 ether;
    }
    ...
    event MintTheMetalorianDaoPlata(address indexed user, uint256 tokenId); 
    ...
    function mintTheMetalorianDaoPlata(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDaoPlata(msg.sender, tokenIdCounter.current());            
