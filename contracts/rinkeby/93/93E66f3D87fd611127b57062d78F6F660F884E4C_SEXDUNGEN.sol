...
contract SEXDUNGEN is ERC721A, Ownable {
  ...
  Counters.Counter private supply;
    ...
    string uriPrefix = "https://gateway.pinata.cloud/ipfs/QmSDLnJ5k4HkVeubW5beNmQQRuRpuq4hetFGn8GSMxAmTi/";
    ...
    uint256 public constant FREE_AMOUNT = 10;
    uint256 public CLAIMED_SUPPLY;

    bool public IS_SALE_ACTIVE = false;

  constructor() ERC721A("bitti", "btt") {} 

  function ownerMint(uint256 quantity) external payable {
      require(supply.current() + quantity <= MAX_SUPPLY, "Excedes max supply.");
