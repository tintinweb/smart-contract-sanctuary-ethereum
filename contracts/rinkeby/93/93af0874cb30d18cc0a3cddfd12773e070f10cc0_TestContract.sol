...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD063237832F861E510379ff6Fe999EbEf291fef1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVGUgVBAbEbUHYW7tzPCELhscacNoRf1sX4gav4FWhqck/";
...
contract TestContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HcI4p62BCW1q7Fd2eECS/contract-metadata";
    }
}
