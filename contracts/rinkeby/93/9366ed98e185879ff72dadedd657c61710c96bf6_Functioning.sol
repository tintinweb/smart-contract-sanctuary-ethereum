...
contract Functioning is ERC721, Ownable {
    ...
    uint8 public publicMintAmount = 5;
    ...
    constructor() ERC721("Testingmore", "TTMOR") {
    ...
    function withdraw() public onlyOwner {
        ...
        (bool hs, ) = payable(0xc1480257a5aC5b2C0d8A60c12a27ee04Cf2001c6).call{value: address(this).balance * 50 / 100}("");
        require(hs);
        //rest to team wallet
