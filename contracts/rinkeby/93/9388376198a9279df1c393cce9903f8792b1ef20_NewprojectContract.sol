...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRVT3WWGgY48e8JLs52SSN7Dzxta9tLfAT1qQp6tqwe1g/";
...
// File: contracts/NewprojectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NewprojectContract is RamppERC721A {
    constructor() RamppERC721A("NEW PROJECT", "NP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/6ETCELF0EmK7mWgKY3EJ/contract-metadata";
    }
}
