...
contract DenToken is ERC721Enumerable, Ownable 
{
    using Counters for Counters.Counter;

    uint256 private constant MAX_TOKENS = 2000;
    uint256 private constant MINT_PRICE = 0.001 ether;
    string private constant BASE_URI = "https://jfystorage.blob.core.windows.net/nft01/meta/";
    
    Counters.Counter private tokenIdCounter;

    constructor() ERC721("TTOKEN1", "TTOK") 
    {        
    }
    ...
    {        
        require(totalSupply() < MAX_TOKENS, "Total supply already reached.");
        require(msg.value >= MINT_PRICE, "Mint price not reached.");
        tokenIdCounter.increment();
        uint256 nextId = tokenIdCounter.current();
        _mint(to, nextId);
    }
