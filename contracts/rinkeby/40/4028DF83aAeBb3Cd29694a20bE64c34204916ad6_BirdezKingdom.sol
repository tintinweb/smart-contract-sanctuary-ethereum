...
contract BirdezKingdom is ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => uint256) private maxPaidMintsPerToken;
    mapping(uint256 => uint256) private maxFreeMintsPerToken;
    ...
    address[] public teamPayments = [
        ...
        0x9aB0f8ED479df9a7E06FCDBd349FBcE71868fa60, // DEV 1
        0x9fF26b2Df7bBaE58a66fBC0A019E66943cD56548, // Artist 2
        0x9444E845311c0d247eaE0FE0122E53Ffec357848 // DEV 2,
    ];
    ...
    function flipPrivateSaleState() public onlyOwner {
        // After birdez gang reserved sale, flip whitelist sale to open the door to whitelist members
        startSale = !startSale;
    } 
    ...
    function flipSaleState() public onlyOwner {
        // After whitelist sale, flip public sale to open the door to the world
    ...
    function flipGenesisState() public onlyOwner {
        // After birdez gang public sale sale, flip genesis sale to open the door to genesis owner
    ...
    function genesisPaidMint(uint256 _numberOfTokens) external payable{
        ...
        for (uint i = 0; i < _numberOfTokens; i++) { 
            ...
            if(maxPaidMintsPerToken[tid] > 0) continue; 
            if (totalSupply() < MAX_SUPPLY) {
                _safeMint(_user, totalSupply());
                maxMintsPerAddress[_user]++;
                maxPaidMintsPerToken[tid]++;
            } else {
