...
contract CHOOSEWISELY is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount){
    if(msg.sender != owner()){
      ...
      require(_freeWalletMints[_msgSender()] + _mintAmount <= maxMintAmountPerWallet, 'You have already minted');
