...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 2121 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://int.bape.com/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2121");
...
// File: contracts/ABapeBathingApeSupremeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ABapeBathingApeSupremeContract is RamppERC721A {
    constructor() RamppERC721A("A Bape  Bathing APE   Supreme ", " ApeBape"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YgUD99Me0W9TNcsJDVAg/contract-metadata";
    }
}
