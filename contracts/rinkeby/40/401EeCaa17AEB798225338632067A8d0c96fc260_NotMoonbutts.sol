...
contract NotMoonbutts is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Not Moonbutts", "NMB") {
        PRICE = price;
    ...
    function airdropOwner(address _to, uint _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
