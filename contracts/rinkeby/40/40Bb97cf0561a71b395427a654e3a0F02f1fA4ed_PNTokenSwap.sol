...
/** @title Probably Nothing Token Swap from V1 to V2
 * @author 0xEwok and audie.eth
 * @notice This contract swaps PN tokens for PNv2 tokens and compensates taxes
 */
contract PNTokenSwap is IPNTokenSwap, ReentrancyGuard, Ownable {
    ...
    /** @notice Provides address of recevied from swap
    ...
    function swap(uint256 amount) external override {
        ...
        require(
            v1Contract.allowance(msg.sender, address(this)) >= amount,
            "Approved allowance too low"
        );
        require(
