...
Owner = msg.sender;
    ...
    *
    */ 
    function getLastProposalWinning() public returns(uint, address, string memory){
    emit getWinning(winnings.length, proposalsWinning[winnings.length].voter, proposalsWinning[winnings.length].description);
