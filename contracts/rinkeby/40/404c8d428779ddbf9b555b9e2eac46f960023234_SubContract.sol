...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5ba9355a10611Ed4339526472a59bEfed3549bAD];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQHwwgTik3jEhMX2JkcBQK9CHBq2qQSzXKtdf1i9DjjDQ/";
...
contract SubContract is RamppERC721A {
    constructor() RamppERC721A("Sub", "Submarine"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Nz359oXxtodWiSr4shst/contract-metadata";
    }
}