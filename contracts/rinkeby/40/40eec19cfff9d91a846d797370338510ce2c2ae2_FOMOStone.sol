...
contract FOMOStone is ERC721, ERC721Enumerable, Ownable {
    ...
    mapping (address => uint8) private mint_num;
    ...
    constructor(address payable _owner) ERC721("FOMO Stone", "FOMO") {
        ...
        saleConfig.startTime = 1650524400;//2022-04-21 11:30
        saleConfig.endTime = 1650528000;//2022-04-21 12:00
    ...
    function mint(uint num, uint8 _type) public payable {
        ...
        require(totalSupply() + num <= 4200, "Purchase would exceed max supply of tokens");
    ...
    function set_round(uint8 _round) public onlyOwner {
