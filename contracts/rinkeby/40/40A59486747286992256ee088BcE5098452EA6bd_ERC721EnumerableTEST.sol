...
contract ERC721EnumerableTEST is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string private tokenBaseURI = '';

    constructor() ERC721("ENUMERABLE TEST", "ENUMTEST") {}

    /// @notice this will mint batches to make a stress tests, no token max supply is provided
