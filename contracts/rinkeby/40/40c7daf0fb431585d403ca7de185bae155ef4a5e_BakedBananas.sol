...
//
// 
// National Banana Day & 420 have landed on the same day, and the pairing is exquisite.
// Yes, this is a real day, and we happen to be particularly fond of the whacky yellow foodstuff (and the green stuff).
// We decided to create this free mint NFT collection to bring some fun and laughs to the NFT community on this special day <3
// -KevNFriends Team 
// https://discord.gg/kevnfriends
...
contract BakedBananas is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("Baked Bananas", "NANAS", 2300, maxSupply) {
    }
