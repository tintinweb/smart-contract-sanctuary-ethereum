...
contract KTTtest is ERC721A, Ownable, ReentrancyGuard {
  ...
  function GetKaeru(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
