...
contract ApeHaterClub is ERC721AQueryable, Ownable, ReentrancyGuard {    
    ...
    uint256 public constant PRICE_PHASE2 = 0 ether;
...
//FREE MUTATION MINT (PHASE 1)
    function MintMutationPhase1(uint256 amount) external  {
        ...
        //require(bnno.balanceOf(msg.sender, 0) <= amount,"Must be at max the quantity of your Bananos"); //this is the fail loool
...
//test function, how many bananos WORKING
