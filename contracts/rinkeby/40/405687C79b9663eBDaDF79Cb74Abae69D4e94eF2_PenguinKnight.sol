...
contract PenguinKnight is ERC721A, Ownable  {
    ...
    constructor() ERC721A("PenguinKnight", "PK") {
        ...
        pk_wl_start_timestamp = 0;
        pk_og_start_timestamp = 0;
        pk_ep_start_timestamp = 0;
        pk_public_start_timestamp = 0;

        pk_wl_mint_price = 0.035 ether;
        pk_og_mint_price = 0.035 ether;
        pk_ep_mint_price = 0.035 ether;
        pk_public_mint_price = 0.035 ether;
