...
contract SysApes is Ownable, ERC721 {
    
    uint public tokenPrice = 299 ether;
    uint constant maxSupply = 999;
    uint public presale_price = 249 ether;
    ...
    uint public _walletLimit=3; //Max Limit for perwallet
     uint public phase= 999;
  
         
    constructor() ERC721("SysApes", "SA"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    if(reveal) {
        return string(abi.encodePacked(baseURI, Strings.toString(_tokenId), _extension));
    }
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 85 / 100);
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 15 / 100);
    }
