...
contract PandaPool is Ownable, IERC721Receiver, IPandaPool, VRFConsumerBaseV2 {
     ...
     */
    function _onReborn(address sender, uint256 _ownerTokenId, uint256 _targetTokenId) public override  {
        IERC721 _pandaNFT = IERC721(pandaNFT);
    ...
    function fulfillRandomWords(
        ...
        _onReborn(reqInfo.sender,reqInfo.ownerTokenId, targetIndex);
    }
