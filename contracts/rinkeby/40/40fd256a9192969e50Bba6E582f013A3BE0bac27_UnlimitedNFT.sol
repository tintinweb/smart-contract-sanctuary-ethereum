...
contract UnlimitedNFT is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    //         _startTime = _auctionable ? _startTime : 0;
    //         _endTime = _auctionable ? _endTime : 0;
        ...
        nonReentrant
    {
        ...
        require(!item.auctionable, "no auctionable");
    ...
    function acceptWinningBid(uint256 _id)
        ...
        nonReentrant
    {
        require(items[_id].auctionable, "no auction");
        require(!items[_id].isSold, "already sold");
        require(block.timestamp > items[_id].endTime, "running now");
    ...
    function _checkCanBuy(uint256 _id) internal view {
        ...
        if (item.auctionable) {
            require(block.timestamp >= item.startTime, "not started");
            require(block.timestamp <= item.endTime, "auction over");
        }
