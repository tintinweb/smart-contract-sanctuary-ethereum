...
contract MinterTokenXYZ is ERC721, Ownable, Pausable, BasicMetaTransaction {
    ...
    function createMinterToken(bytes memory signature, address contractAddress, 
        ...
        whenNotPaused
    {   
        bytes32 messageHash = hashTransaction(msgSender(), address(this), contractAddress, contractToken, uri);
        bytes32 messageHashCheap = hashTransactionCheap(msgSender(), address(this), contractAddress, contractToken);
        ...
        _safeMint(msgSender(), _mintedTokens);
