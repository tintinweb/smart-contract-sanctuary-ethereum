...
// Dependency file: contracts/NFTSale2.sol
    ...
    WithdrawalElement
{
    ...
    function _processWithRandomness(
        ...
        tokensPerWallet[roundId][user] += 1;
...
// Root file: contracts/tests/NFTSaleMock2.sol


pragma solidity ^0.8.9;

// import "contracts/NFTSale2.sol";

contract NFTSaleMock2 is NFTSale2 {
    constructor(address _vrfCoordinator, address _linkTokenAddress)
        NFTSale2(_vrfCoordinator, _linkTokenAddress)
    {}

    function test_FullFill(
        uint256 requestId, /* requestId */
        uint256 randomWord
    ) external {
