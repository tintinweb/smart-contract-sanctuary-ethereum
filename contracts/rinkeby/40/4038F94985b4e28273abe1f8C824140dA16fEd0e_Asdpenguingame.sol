...
contract Asdpenguingame is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Asd Penguin Game", "anft") {
    setHiddenMetadataUri("ipfs://QmdiaZmAf7wVFbfJndyxjPRLCHNL41r27PmAzwh4V6SUrm/hidden.json");
  }
