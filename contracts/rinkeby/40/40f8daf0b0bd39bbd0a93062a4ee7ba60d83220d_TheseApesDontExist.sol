...
contract TheseApesDontExist is ERC721A, Ownable, Pausable {
    ...
    uint256 internal constant MAX_FREE_PER_WALLET   = 20; // CHANGE
    ...
    string internal description                     = "These Apes Don't Exist is a collection of high resolution (2048 x 2048px) "
                                                      "AI-generated apes with hypercolor blended visual traits imagined by "
    ...
    uint256[] internal TOKEN_COUNT_PRICE_THRESHOLDS = [4, 10, 100, 200, 300, 400, 500, 600, 700, 800, 4244, 4344]; // CHANGE
