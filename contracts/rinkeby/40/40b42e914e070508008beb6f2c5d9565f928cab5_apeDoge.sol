...
contract apeDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Ape Doge";
    string private _symbol = "ApeDoge";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xAc1123ee301f1dcc103fc40E0817A27BE3c49F4E);
    address payable public BuyBackWalletAddress = payable(0xAc1123ee301f1dcc103fc40E0817A27BE3c49F4E);
    ...
    uint256 public _maxTxAmount = 15000000 * 10**12;
    uint256 public _walletMax = 30000000 * 10**12;
    uint256 private minimumTokensBeforeSwap = 1000000 * 10**12;
