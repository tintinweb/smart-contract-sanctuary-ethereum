...
contract TotlinTest is ERC721A, Ownable {
    ...
    constructor() ERC721A("Tester", "TOT") {}
    ...
    //@param: quantity | Number of <enter> a user wants to mint
    function mint(uint256 quantity) external payable {
        require(saleLive, "The public sale is not live yet!");
        require(quantity <= MAX_MINT, "Can't mint more than 10 <enter> per transaction!");
        require(totalSupply() + quantity <= MAX_SUPPLY, "Not enough <enter> left!");
    ...
    function reserveMints() external onlyOwner {
        ...
        _safeMint(_teamWallet, RESERVE_QTY); //TODO See if change to 3 param version
    }
