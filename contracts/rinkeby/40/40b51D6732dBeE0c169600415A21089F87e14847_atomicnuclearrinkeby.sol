...
contract atomicnuclearrinkeby is ERC721, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x1063b076a2D75014dB89E4E8324CbF864C54d059).call{value: address(this).balance * 100 / 100}("");
    require(hs);
    // =============================================================================
