...
contract LG6 is ERC1155, ERC1155Burnable,  Ownable, ReentrancyGuard {
    string private _name="lgnm";
    string private _symbol = "LG";  
	string private baseURI;
	uint256 public price = 0.002 ether;
    uint256 public discPrice = 0.001 ether;
    ...
    uint256 public _totalSupply = 28;
    ...
    function zeroMint(uint256 mintCount) external  {
	    require(
                 (_freeSaleIsActive),
                "Closed"
        );
