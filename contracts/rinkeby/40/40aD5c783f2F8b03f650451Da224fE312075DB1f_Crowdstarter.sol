...
import "./interfaces/ICrowdstarter.sol";

// ipfs://bafybeiehuober7b73ahbekg5nli5jlouymste35ao53ho3m7gsomlmasgq/1.json

// extensions/ERC1155Supply.sol

contract Crowdstarter is
    ERC1155Supply,
    Ownable,
    ReentrancyGuard,
    ICrowdstarter
{
    ...
    function setURI(uint256 _tokenId, string memory _uri) public onlyOwner {
        ...
        require(exists(_tokenId), "ERC1155 token does not exist");
        tokenInfo[_tokenId].tokenURI = _uri;
    ...
    function createToken(
        ...
        _mint(_creator, tokenId, _quantity, "");
        tokenId++;

        emit CreateToken(
            _tokenInfo.tokenId,
            _tokenInfo.influencer,
            _tokenInfo.creator,
            _tokenInfo.createdAt,
            _tokenInfo.quantity,
            _tokenInfo.tokenURI
        );
    }
...
interface ICrowdstarter is IERC1155 {
    /**
