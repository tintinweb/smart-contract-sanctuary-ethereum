...
contract Test is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/614/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/614/contract-uri";
	...
	uint256 public pricePerToken = 100000000000000;
    uint256 public tokenfyPrice = 100000000000000;

    // presale settings
    address private signerAddress;
    mapping(address => uint256) public presaleMinted;
	uint256 public presaleMaxSupply = 4;
	uint256 public presaleMaxPerMint = 1;
	uint256 public presalePricePerToken = 10000000000000;
    uint256 public tokenfyPresalePrice = 100000000000000;
	...
	constructor(address _signerAddress) ERC721("Test", "TST") {
