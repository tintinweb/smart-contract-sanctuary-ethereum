...
contract Shamanzs is ERC721, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    uint256 public FREQUENCY = 900; // 15 minutes
    uint256 public MAX_MINT_AMOUNT = 3;
    uint256 public END_COST = 0.15 ether;
    uint256 public DECREMENT = 0.05 ether;
    uint256 public INITIAL_COST = 0.5 ether;
    uint256 public DUTCH_AUCTION_SUPPLY = 1860;
    uint256 public START_AUCTION_AT = 1651622400;
    // Whitelist
    bool public WHITELIST = false;
    uint256 public WHITELIST_COST = 0.144 ether;
    uint256 public WHITELISTED_MAX_MINT_AMOUNT = 2;
    // Allowlist
    bool public ALLOWLIST = false;
    uint256 public ALLOWLIST_COST = 0.144 ether;
    ...
    address private PUBLIC_MINTING_ADDRESS;
    ...
    constructor(
        ...
        PUBLIC_MINTING_ADDRESS = _publicMintAddress;
    ...
    function setMintAddress(address _address) public onlyOwner {
        PUBLIC_MINTING_ADDRESS = _address;
    }
