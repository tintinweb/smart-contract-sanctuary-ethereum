...
contract CopeCasinoReward is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public hopeWinChance = 14;

    uint256 public hopeLoseChanceFix = 10;
    uint256 public hopeLoseChance = 19;

    uint256 public copeWinChanceFix = 1;
    uint256 public copeWinChance = 10;

    uint256 public copeLoseChanceFix = 10;
    uint256 public copeLoseChance = 28;
    ...
    constructor(
        ...
        address _copeBearContractAddress,
    ...
    function rollWithCope() external nonReentrant {
        ...
        require(totalSupply() + 1 <= maxTotalSupply, "Exceeds total supply");
        require(IERC20(copeBearContractAddress).allowance(_msgSender(), address(this)) >= copePrice, "Not enough $HOPE allowance");
        ...
        if (rolledNft || (uint256(keccak256(abi.encodePacked(
            ...
            IERC20(hopeTokenContractAddress).transferFrom(_msgSender(), address(this), copePrice);
        }
    }
