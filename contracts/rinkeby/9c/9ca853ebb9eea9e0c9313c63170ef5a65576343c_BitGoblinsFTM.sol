...
/*  The bitGoblins.FTM - 
  ...
  \( \   o\/o   / )/     \( \   o\/o   / )/     \( \   o\/o   / )/   
   ...
   ___\ \|uu|/ /___       ___\ \|uu|/ /___       ___\ \|uu|/ /___      
 /`    \ .--. /    `\   /`    \ .--. /    `\   /`    \ .--. /    `\ 
/       '----'       \ /       '----'       \ /       '----'       \
...
contract BitGoblinsFTM is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, ClampedRandomizer {
    ...
    constructor (
        ...
        ERC721 (name, symbol) ClampedRandomizer(maxSupply)
    {
        max_supply = maxSupply;
        publicPrice = publicMintPrice;
    ...
    function revealGoblin() external onlyAdmin {
        _revealed = true;
    }
    ...
    function setPublicPrice(uint publicMintPrice) external onlyAdmin {
        publicPrice = publicMintPrice;
    }

    function setNftPerAddressLimit(uint _limit) public onlyAdmin {
    ...
    function whitelistSwitch() public onlyAdmin {
        _onlyWhitelisted = !_onlyWhitelisted;
    }

    function adminMint(uint _mintAmount) public onlyAdmin {
    ...
    function whitelistMint(uint _mintAmount) public payable {
        ...
        require(supply + _mintAmount <= max_supply, "max NFT limit exceeded");
        require(_onlyWhitelisted == true, "Only Whitelist can mint at this time");
    ...
    function publicMint(uint _mintAmount) public payable {
        require(_openMint == true, "Minting is currently not open");
        require(_mintAmount <= maxMintAmount, "max mint amount per session exceeded");
        uint256 supply = totalSupply();
        uint256 ownerMintedCount = addressMintedBalance[msg.sender];
    ...
    function internalMintToken(address to,uint256 tokenId) internal {
        _safeMint(to, tokenId);
    }
    ...
    function safeMintToken(address to,uint256 tokenId) public onlyAdmin {
...
/*
["0xec449C8de641F77a81ACA398Ed7641B260E8805A","0x87B01800624baE02a566cf12932A362f3E47058B","0x350Da1601026F5e058d14e390249d1D0A50898b9"]
*/