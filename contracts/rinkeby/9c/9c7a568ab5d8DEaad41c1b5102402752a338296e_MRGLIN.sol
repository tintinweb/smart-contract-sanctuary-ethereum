...
contract MRGLIN is ERC721A, Ownable {
    ...
    function publicMint(uint8 _quantity) payable external noBots() {
        ...
        require(isPublicSaleActive, "MRGLIN :: Public sale has yet to be activated or already has been activated and is over.");
        require(hasPublicMinted[msg.sender] + _quantity <= isMaxPublicMints, "MRGLIN :: You reached you're max mints");
