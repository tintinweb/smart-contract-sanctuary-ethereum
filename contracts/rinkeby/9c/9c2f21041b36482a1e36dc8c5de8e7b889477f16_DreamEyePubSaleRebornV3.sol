...
contract DreamEyePubSaleRebornV3 is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  */
  ...
  function recreate(uint256 _tokenId) public {
      ...
      dreamEyePubSaleV3.burnGen(_tokenId);
      // // _mint(_msgSender(), _tokenId);     
      transferFrom(rbowner, owner, _tokenId); 
  }

  function recreateWithApproval(address to, uint256 _tokenId) public {
      // require(msg.value >= publicSaleCost, 'Insufficient funds!');
      address owner = dreamEyePubSaleV3.ownerOf(_tokenId);
      address rbowner = ownerOf(_tokenId);
      require(owner == _msgSender(), "STOP! THIEF!");
      dreamEyePubSaleV3.approve(to, _tokenId);
