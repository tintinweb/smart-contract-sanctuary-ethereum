...
contract ValNft2 is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        require(ownerTokenCount < nftPerAddressLimit, "max NFT limit per address reached");
    ...
    function checkValidity(bytes32[] calldata merkleProof) public view returns (bool){
        ...
        require(MerkleProof.verify(merkleProof, root, keccak256(abi.encodePacked(msg.sender))), "Incorrect proof");
        return true; 
    }
