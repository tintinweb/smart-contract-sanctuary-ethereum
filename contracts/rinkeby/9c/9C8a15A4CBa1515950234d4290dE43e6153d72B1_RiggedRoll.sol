...
error RiggedRoll__NotEnoughEthToCall();
error RiggedRoll__NotGoingToWin(uint256 roll);
...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() public {
        if (address(this).balance < 0.002 ether) {
            revert RiggedRoll__NotEnoughEthToCall();
        }
        ...
        if (roll > 2) {
            revert RiggedRoll__NotGoingToWin(roll);
        }
