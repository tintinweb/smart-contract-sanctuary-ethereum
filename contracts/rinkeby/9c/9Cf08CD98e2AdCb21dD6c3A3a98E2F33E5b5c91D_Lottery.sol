...
error Lettery__NotEnoughPlayers();
error Lottery__NotOpen();
error Lottery__upKeepNotNeeded();

/** @title A sample lottery contract
 * @author Sumeet Rohra
 * @notice This contract is for creating untamperable lottery contracts.
 * @dev The contract is designed to be used with the chainlink VRF V2 and chainlink keepers
 */
