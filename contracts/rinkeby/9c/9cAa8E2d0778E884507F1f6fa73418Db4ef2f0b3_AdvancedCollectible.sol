...
contract AdvancedCollectible is ERC721, VRFConsumerBaseV2 {
    ...
    event RequestedRandomness(uint256 indexed requestId, address requester);
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory _randoms)
        internal
        override
    {
        /**
