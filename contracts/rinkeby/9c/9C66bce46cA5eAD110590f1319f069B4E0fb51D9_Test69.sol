...
contract Test69 is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Test69", "TEST69") {}
    ...
    function freedomMint(uint256 amt) external callerIsUser {
        ...
        require(
            ...
            "Can't have that many mints mate!"
        );
    ...
    function mint(uint256 amt) external payable {
        uint256 cost = price;
        require(msg.sender == tx.origin, "Is that you?");
