...
contract TokenForge721 is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
    ...
    function createMessage(
        ...
        return keccak256(abi.encode(tokenId, hash, address(this)));
    }
    ...
    function validateSignature(
        ...
        bytes32 message = createMessage(tokenId, hash).toEthSignedMessageHash();
    ...
    function mintTo(
        ...
        validateSignature(tokenId, tokenUri, signature);
    ...
    function mintAuto(
        ...
        mintToAuto(msg.sender, nonce, tokenUri, signature);
    }
    ...
    function mintToAuto(
        ...
        // validateSignature(nonce, tokenUri, signature);
