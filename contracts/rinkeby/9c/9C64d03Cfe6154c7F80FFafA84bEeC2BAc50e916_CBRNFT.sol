...
contract CBRNFT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable,Royalties {
  ...
  function safeMint(address to ,string memory uri,address creator, uint256 value) public onlyRole(MINTER_ROLE) returns(uint){
