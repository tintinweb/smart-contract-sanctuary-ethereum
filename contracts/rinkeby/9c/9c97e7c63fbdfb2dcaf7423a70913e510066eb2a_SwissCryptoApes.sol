...
contract SwissCryptoApes is ERC721Enumerable, Ownable {
    ...
    uint256 public PRICE = 172 ether;
    uint256 public PRICE_PRESALE = 108 ether;
    ...
    function claimReserved(address recipient, uint256 amount) external onlyOwner {
        require(reservedClaimed != RESERVED_APES, "Already have claimed all reserved turtles");
    ...
    function mintPresale(uint256 amountOfApes) external payable whenPresaleStarted {
        ...
        require(PRICE * amountOfApes == msg.value, "Matic amount is incorrect");
