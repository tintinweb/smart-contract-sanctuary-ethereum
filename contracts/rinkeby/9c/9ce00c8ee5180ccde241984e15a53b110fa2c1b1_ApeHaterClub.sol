...
contract ApeHaterClub is ERC721AQueryable, Ownable, ReentrancyGuard {    
    ...
    function MintFreeMutation(uint256 amount) external  {
        ...
        require(bnno.balanceOf(msg.sender, 0) > 0 ,"Must own at least 1 Banano."); //testing this
        uint256 NumberBananosAddress = bnno.balanceOf(msg.sender, 0);
        require(NumberBananosAddress >= amount ,"Must own at least 1 Banano, or not exceed Bananos amount to mutate."); //testing this
