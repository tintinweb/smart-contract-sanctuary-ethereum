...
contract MFE is MFESplitsTestnet, TFCBase {
    constructor()
        TFCBase(
            'MFE',
            'MFE',
            'https://gateway.pinata.cloud/ipfs/Qm0/', // TODO
            addresses,
            splits
        )
    {
...
import '@nftculture/nftc-contract-library/contracts/token/ThreePhaseMint.sol';
    ...
    ThreePhaseMint
{
    ...
    uint256 private constant MAX_PRESALE_BATCH_SIZE = 2;
    uint256 private constant MAX_PUBLIC_BATCH_SIZE = 3;

    uint256 private constant AVAILABLE_PRESALE_QUANTITY = 2;
    uint256 private constant AVAILABLE_PUBLIC_QUANTITY = 3;
    ...
    ) ERC721A(__name, __symbol) SlimPaymentSplitter(__addresses, __splits) ThreePhaseMint(0.001 ether, 0.001 ether, 0.001 ether) {
        baseURI = __baseURI;
    }
...
contract MFESplitsTestnet {
    ...
    address[] internal addresses = [
        0xc7377DE253149BF75f89c03BF52F953989bBe5E8 // TODO
    ];
...
/**
 * @title Three Phase Mint Implementation
 * @author @NiftyMike, NFT Culture
 * @dev All the code needed to support a Three Phase mint in a standard way.
 *
 * Phase 1 - Claiming
 * Phase 2 - Presale
 * Phase 3 - Public Mint
