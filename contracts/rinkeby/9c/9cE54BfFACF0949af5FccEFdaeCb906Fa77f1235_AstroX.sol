...
contract AstroX is ERC721A, Ownable, PaymentSplitter  {
    ...
    uint public constant _price = .0032 ether;
    uint public constant _preprice = .0012 ether;
    uint public constant MaxPerMint = 250;
    uint public constant AirDropSupply = 2000;

    string public _contractBaseURI;

    uint256[] private _teamShares = [100];
	address[] private _team = [0x5600c739675392F4D692aBFc4E077E2C2caD35bf];

    constructor(string memory baseURI) 
        ERC721A("ASTROXNFT", "ASTROX")
...
contract ERC721A is IERC721A {
    struct TokenApprovalRef {
        ...
        bool isRevealed;
        string public hiddenURI = 'ipfs://bafybeiafrte4czmqjkh3ssonu4q7k33ydrp35ovsiypevll645tht3smnu/hidden';
