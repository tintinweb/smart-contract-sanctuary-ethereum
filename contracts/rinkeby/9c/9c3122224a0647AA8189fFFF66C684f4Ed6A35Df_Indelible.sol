// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Special", unicode"Head", unicode"Face", unicode"Eyes", unicode"Stripes", unicode"Feet", unicode"Belly", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Tiny Pussies", unicode"Tiny Pussies | Limited artwork for those who love pussy cats | onchain + cc0", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9d4d1d66-a0ab-451c-8b8f-d81cb69e6c85", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9d4d1d66-a0ab-451c-8b8f-d81cb69e6c85", "", 500, "0x08e59E15B00e73648B23f372634B1F3F4383D2Bc");

        constructor() ERC721A(unicode"Tiny Pussies", unicode"TINYPUS") {
...
TIERS[4] = [15,15,15,15,15,425];
TIERS[5] = [9,15,25,30,46,50,325];
TIERS[6] = [12,12,14,15,15,23,24,24,27,35,39,44,46,50,60,60];
TIERS[7] = [5,9,10,10,10,12,13,14,14,15,15,15,15,15,15,15,15,18,19,20,20,21,23,25,32,35,35,35];
TIERS[8] = [4,8,12,15,16,29,30,45,45,55,55,56,65,65];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Tiny Pussies #");
