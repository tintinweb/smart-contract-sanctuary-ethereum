...
contract NFTContract is ERC721, Ownable, PullPayment {
  ...
  function mintTo(uint256 amount, address recipient) public payable {
    require(mintCount[recipient] + amount <= maxMint, "One address only can mint 5 tokens");

    require(currentTokenId.current() < total + amount, "Max supply reached");
