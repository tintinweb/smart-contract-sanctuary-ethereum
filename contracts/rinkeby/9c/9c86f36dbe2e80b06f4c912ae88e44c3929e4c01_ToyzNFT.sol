...
abstract contract MultiSigOwnable is Ownable {
    ...
    event MultiSigOwnershipTransferred(
        address indexed previousMultiSigOwner,
        address indexed newMultiSigOwner
    );
    ...
    modifier onlyMultiSigOwner() {
        ...
        require(
            multisigOwner() == _msgSender(),
            "MultiSigOwnable: caller is not the owner"
        );
        _;
    }
     ...
     */
    function transferMultiSigOwnership(address newMultiSigOwner)
        public
        virtual
        onlyMultiSigOwner
    {
        // solhint-disable-next-line reason-string
        require(
            newMultiSigOwner != address(0),
            "MultiSigOwnable: new owner is the zero address"
        );
     ...
     * Internal function without access restriction.
     */
    function _transferMultiSigOwnership(address newMultiSigOwner)
        internal
        virtual
    {
...
contract ToyzNFT is ERC721A, MultiSigOwnable, Pausable, ReentrancyGuard {
    // TODO: change provenance hash
    // Provenance hash of all tokens
    bytes32 public constant PROVENANCE_HASH = 0x13d1c361df87adb48e35d4f10316be308c5d4fee46322404d1eb8d9422c303da;
    ...
    uint256 public constant MAX_PER_ACCOUNT = 4;

    // Number of tokens for the team
    uint256 public constant TEAM_ALLOCATION = 10;
    ...
    constructor(
        ...
        // Mint `TEAM_ALLOCATION` tokens to the team multisig
        _mint(teamMultiSig_, TEAM_ALLOCATION, "", false);
    }
