...
contract DiamondPunks is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool s, ) = payable(0x9B4FBCEc8F8A7Ae18Aa329Aa60Ac58C8C618C0C6).call{value: address(this).balance}("");
    require(s, "Insufficient Funds");
  }
