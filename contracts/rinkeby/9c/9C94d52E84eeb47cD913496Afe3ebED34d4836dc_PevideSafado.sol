...
contract PevideSafado is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("PevideSafado", "PS"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more safadexnhos");
    require(mintEnabled, "Minting is not live yet, hold on safadao.");
