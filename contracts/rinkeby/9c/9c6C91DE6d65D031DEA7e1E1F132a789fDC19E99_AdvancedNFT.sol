...
contract AdvancedNFT is ERC721EnumerableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public whitelisteSaleNftPrice;
    ...
    function initialize(string memory _name, string memory _symbol) initializer public {
        ...
        whitelisteSaleNftPrice = 20000000000000000;
        maxNftPurchase = 3;
    ...
    function changeWhitelisteSaleNftPrice(uint256 _whitelisteSaleNftPrice) external {
        whitelisteSaleNftPrice = _whitelisteSaleNftPrice;
    }
