...
contract Composite721 is Tiny721, OnChainMeta {
    ...
    */
    function tokenURI (
        ...
        return _buildMeta(_id, this.svgData(_id, 0), attributes, description);
    }
...
contract OnChainMeta {
    ...
    function _buildMeta(uint256 _tokenId, string memory _svgData, string memory _attributes, string memory _description) internal pure returns (string memory) {
