...
//    ) ERC721("Defence Force", "DFWN") {
        ...
        Stage memory preSale = Stage({
            mintFee: 0.001 ether,
            maxMint: 20,
            startTime: 1651410000,//2022-05-01 21:00:00
            endTime: 1651411800,//2022-05-01 21:30:00
            isWhitelist: true
        });
        stages.push(preSale);
        ...
        Stage memory airDrop = Stage({
            mintFee: 0,
            maxMint: 10,
            startTime: 1651413600,//2022-05-01 22:00:00
            endTime: 1651415400,//2022-05-01 22:30:00
            isWhitelist: true
        });
        stages.push(airDrop);
        ...
        Stage memory sale = Stage({
            mintFee: 0.002 ether,
            maxMint: MAX_MINT,
            startTime: 1651417200,//2022-05-01 23:00:00
            endTime: 1651419000,//2022-05-01 23:30:00
            isWhitelist: false
        });
        stages.push(sale);
    }
