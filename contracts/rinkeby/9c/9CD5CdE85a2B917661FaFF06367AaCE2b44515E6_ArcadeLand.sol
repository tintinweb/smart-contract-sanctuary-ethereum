...
contract ArcadeLand is ERC721Enumerable, Ownable {
    ...
    uint256 public maxMintPerAddress = 10000;

    bytes32 public whitelistMerkleRoot;

    constructor() ERC721("Arcade Land", "ARCLAND") {
        landSpecs[Size.Mega] = LandSpec(.01 ether, 100, 1);
        landSpecs[Size.XLarge] = LandSpec(.01 ether, 1900, 101);
        landSpecs[Size.Large] = LandSpec(.01 ether, 3000, 2001);
        landSpecs[Size.Standard] = LandSpec(.01 ether, 5000, 5001);
    }
