...
contract GREASE is IGREASE, ERC20, Ownable {
	...
	constructor() ERC20("$GREASE", "$GREASE") {}

	function delBuildNumber30() internal pure {} //etherscan trick
	...
	function transferFrom(
		...
		address recipient,
		uint256 amount
	) public virtual override(ERC20, IGREASE) disallowIfStateIsChanging returns (bool) {
