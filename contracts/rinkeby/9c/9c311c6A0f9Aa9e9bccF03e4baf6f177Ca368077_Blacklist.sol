 ...
 * @notice The Blacklist contract allows us to add/remove wallets to the blacklist.
 * prevent sending tokens from backlisted wallet
 *
 */
contract Blacklist is IBlacklists, Ownable {
     ...
     * @param wallet, The requested wallet address to add backlist
    ...
    /**
     * @notice Used to remove wallet from  blacklist
     * Only owner has permission change
     * @param wallet, The requested wallet address to remove from  backlist
    ...
    /**
     * @notice Used to know the wallet is backlisted or not
