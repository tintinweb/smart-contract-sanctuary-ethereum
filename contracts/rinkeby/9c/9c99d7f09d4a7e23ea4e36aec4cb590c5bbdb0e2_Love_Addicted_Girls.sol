...
contract Love_Addicted_Girls is StellarBase {
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
    {
        return string(abi.encodePacked(BASE_URI, super.tokenURI(tokenId)));
    }
    ...
    function _preSaleMint(string memory itemName)
        public
        virtual
        payable
    {
    ...
    function _publicSaleMint(string memory itemName)
        public
        virtual
        payable
    {
