...
/**
 * @title MFER Friends
 * @author BCC Team (AbdulBasit, Asim, Noman, Mansoob, Tariq)
...
contract MFER is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 private NFTPrice;
    uint256 private NFTMaxSupply;
    uint256 private maxCapPerMint = 50;                     //per address mint 
    mapping(address => uint256) internal mintBlanceOf;
    bool private startSale = true;
    string internal baseuri = "https://mferfriends.mypinata.cloud/ipfs/QmWGL32AUAXBfiJV8bjrw4YzJrfdUkz9FnEoia3qZMcktu/";

                        
    constructor() ERC721("MFER FRIENDS", "MFRIENDS") {
        NFTPrice = 0.02 ether;         //20 Finney           
        NFTMaxSupply = 6666;            //6666
    }
    ...
    function lastTokenID() external view returns(uint256) {
        require(totalSupply() >= 1, "No token minted yet");
