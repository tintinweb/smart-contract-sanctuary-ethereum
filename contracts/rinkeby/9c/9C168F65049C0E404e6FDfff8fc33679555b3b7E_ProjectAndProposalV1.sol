...
contract ProjectAndProposalV1 is ProjectAndProposal{

    uint public magicNumber;

    function welcomeFromVersion1() public pure returns(string memory){
        return "This version is from newer version of contract";
    }

    function setMagicNumber(uint _val) public onlyOwner{
        magicNumber = _val;
