...
contract RageRhinos is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.001 ether;
    uint256 public MAX_SUPPLY = 3333;
    uint256 public MAX_MINTS = 20;
    string public baseURI = "ipfs://bafybeidr47rw7ez5sd5joiocl7d7je6korfvriju5rql7pqll6chatuzva/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Rage Rhinos", "RGRH", MAX_MINTS, MAX_SUPPLY) {  
    }
