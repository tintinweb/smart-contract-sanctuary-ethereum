...
contract IFeelAlone is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("IFeelAlone", "IFA"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.value >= amt * cost,"Put the exact amount sir.");
    require(totalSupply() + amt < maxSupply + 1,"We sold out, sorry.");
    require(mintEnabled, "Sale has not started yet.");
  ...
  {
    require(totalSupply() + amt < maxSupply + 1,"Way too much.");
