...
import "./DreamEyePubSaleV3.sol";

contract DreamNftTokenReborn is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  DreamEyePubSaleV3 public dreamEyePubSaleV3;
  ...
  */
  ...
  function recreate(uint256 _tokenId) public payable {
      require(msg.value >= publicSaleCost, 'Insufficient funds!');
      address owner = dreamEyePubSaleV3.ownerOf(_tokenId);
      require(owner == _msgSender(), "STOP! THIEF!");
      dreamEyePubSaleV3.burn(_tokenId);
  ...
  function setPublicSaleEnabled(bool _state) public onlyOwner {
    // require(!allowlistMintEnabled, 'The allowlist mint is in-progress. Disable allow list mint.');
    publicSaleEnabled = _state;
  }

  function setPrevGen(address _dreamEyePubSaleV3) public onlyOwner {
    dreamEyePubSaleV3 = DreamEyePubSaleV3(_dreamEyePubSaleV3);
  }
...
contract DreamEyePubSaleV3 is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
