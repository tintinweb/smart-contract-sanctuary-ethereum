...
interface VCDividendTracker {
    ...
    function excludeBatchFromDividends(address[6] memory accounts, bool reduceHolderCount) external;
...
contract PlatformToken is ERC20, Ownable {
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        ...
        address[6] memory toExclude = [address(newDividendTracker), address(this), owner(), address(uniswapV2Router), address(uniswapV2Pair), ZERO_ADDRESS];
        newDividendTracker.excludeBatchFromDividends(toExclude, false);
  
  

        // do not send token to the dead address dividends will be lost
        ...
        ownerOrMinter
    {
        ...
        while (i < vestedAddresses.length) {
            ...
            _transfer(owner(), vestAddress, _amount);
