...
// File contracts/ERC721A.sol
    ...
    contract TEST001 is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    ...
    constructor() ERC721A("TEST001", "T001") {setHiddenMetadataUri("ipfs:///hidden.json");}
