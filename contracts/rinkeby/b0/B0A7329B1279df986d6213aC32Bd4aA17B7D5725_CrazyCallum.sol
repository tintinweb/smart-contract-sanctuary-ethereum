...
contract CrazyCallum is ERC721A, Ownable, Pausable {
    ...
    uint256 public mint2price = 0.025 ether;
    uint256 public mint4price = 0.045 ether;
    uint256 public constant maxDucks = 4;

    string public constant baseURI = "ipfs://QmdyYjeV6uuQ13Bh4ETxcA3TJdmWAb9j1src4XW7tJv8qt/";
    ...
    function mint2Callums() public payable whenNotPaused {
        ...
        unchecked { require(totalSupply() + 2 <= maxDucks, 'MAX_REACHED'); }
        _safeMint(msg.sender, 2);
    }

    function mint4Callums() public payable whenNotPaused {
        require(mint4price <= msg.value, 'LOW_ETHER');
        unchecked { require(totalSupply() + 4 <= maxDucks, 'MAX_REACHED'); }
