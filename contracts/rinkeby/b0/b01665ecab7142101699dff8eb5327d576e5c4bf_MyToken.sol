...
contract PunkDNA {
    ...
    // This function is deterministic and do not should use in prod
...
contract MyToken is ERC721, ERC721Enumerable, PunkDNA {
    ...
    function safeMint() public payable {
        ...
        require(tokenId < maxSupply,'Token capacity is full');
    ...
    function tokenURI(uint256 tokenId) public view override  returns (string memory){
        ...
        string memory jsonURI = Base64.encode(abi.encodePacked(
                '{ "name": "MyTokenPunks #',
                tokenId.toString(),
                '", "description": "MyToken Punks are randomized Avataaars stored on chain to teach DApp development", "image": "',
                image,
                '"}'
            ));
