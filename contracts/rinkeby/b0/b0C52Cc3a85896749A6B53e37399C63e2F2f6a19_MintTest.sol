...
contract MintTest is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public believerPrice = 0.0055 ether; //believer

    // set default Pause
    SaleStatus public saleStatus = SaleStatus.PAUSED;
    bool public revealed = false; //아직 리빌 아님 
  ...
  //      setRoyaltyInfo(teamWallet,_royaltyFeesInBips);   
    ...
    // 해야할 것 : 한 트젝에 얼만지 개인당 얼만지 그걸 그냥 통일시키자 한명당 n 개 살 수 있으면 한 트젝에도 n개까지 구매할 수 있는것 
    ...
    function getPrice(uint256 _count) public view returns(uint256){  // 이것도 이제 수정해야 함 
