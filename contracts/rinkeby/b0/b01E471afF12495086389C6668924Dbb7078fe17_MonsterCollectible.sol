...
contract MonsterCollectible is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, VRFv2Consumer {
    ...
    function generateMonster(uint256 _rarityNumInput, uint256 _specificMonsterInput) private returns (uint256) {
