...
contract BlockProbeFoundersPass is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_TEAM = 25; // Allocated for team to partnerships and marketing
    ...
    string private _tokenBaseURI = "https://blockprobe.io/api/tokens/";

    constructor() ERC721("Test Founders Pass", "Test PFP") {
    }

    /**
     * @dev Mint a token during the presale, requires to be on the Founders Pass List
     * @param _merkleProof Merkle proof to verify they are on the Founders Pass List
     */
    ...
    */
    ...
    /**
    * @dev Overrides default baseURI function
    */
    ...
    /**
    * @dev Check if a user holds a Founders Pass
    */
