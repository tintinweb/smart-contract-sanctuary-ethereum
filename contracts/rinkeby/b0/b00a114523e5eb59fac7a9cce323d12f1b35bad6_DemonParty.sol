...
contract DemonParty is ERC721, Ownable {
  ...
  constructor(string memory _coverURI) ERC721("DemonParty", "DEMONS") {
    coverURI = _coverURI;
  }
  ...
  // WITHDRAWAL
  //
  // TODO: get final rates and addresses
  //---------------------------------------------------------------

  uint256 public rate1 = 200;
  uint256 public rate2 = 150;
  uint256 public rate3 = 15;
  uint256 public rate4 = 10;

  address public payout1 = address(0xBe87DA9462669D7056a97947F895419480cd4C4D);
  address public payout2 = address(0xA085De7a7F6FAc1ebf40dcb78496a3963284fcd6);
  address public payout3 = address(0x9500c6Ed0f41C41b999291d3A7e7c77ba5C45FeC);
  address public payout4 = address(0x11Af20d57F83042955dfEc1cd52dF14e56E82D87);
  address public payout5 = address(0xe166Df0F12ca000d240DC8590d874D50BeE5a21A);
  address public payout6 = address(0xe664a4E850CcD7846269f9ce2847a866e2E26F70);
  address public payout7 = address(0xB0286eb8702fc20F5766859B3AeE5C6d531257cC);
  address public payout8 = address(0x75359312C8BFD59169d8c19cB29dCD97d8DA0653);
  address public payout9 = address(0x1924c4e34AE875cCBb4F0DE3BF42d019367F0e60);

  function withdraw() public {
    uint256 balance = address(this).balance;

    (bool sent1, ) = payable(payout1).call{value: balance * rate1 / 1000}("");
    require(sent1, "Failed to send Ether");
    (bool sent2, ) = payable(payout2).call{value: balance * rate1 / 1000}("");
    require(sent2, "Failed to send Ether");
    (bool sent3, ) = payable(payout3).call{value: balance * rate1 / 1000}("");
    require(sent3, "Failed to send Ether");
    (bool sent4, ) = payable(payout4).call{value: balance * rate1 / 1000}("");
    require(sent4, "Failed to send Ether");
    (bool sent5, ) = payable(payout5).call{value: balance * rate2 / 1000}("");
    require(sent5, "Failed to send Ether");
    (bool sent6, ) = payable(payout6).call{value: balance * rate3 / 1000}("");
    require(sent6, "Failed to send Ether");
    (bool sent7, ) = payable(payout7).call{value: balance * rate3 / 1000}("");
    require(sent7, "Failed to send Ether");
    (bool sent8, ) = payable(payout8).call{value: balance * rate4 / 1000}("");
    require(sent8, "Failed to send Ether");
    (bool sent9, ) = payable(payout9).call{value: (balance * rate4 / 1000)}("");
    require(sent9, "Failed to send Ether");
  }
}