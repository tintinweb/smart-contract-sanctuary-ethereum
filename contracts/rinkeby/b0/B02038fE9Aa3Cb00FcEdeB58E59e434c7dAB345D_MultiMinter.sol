...
contract MultiMinter is Ownable {
    ...
    function mintFromDeployedClonesWithFund(
        ...
        uint8 mintPerCall,
        bytes calldata datacall
    ) public payable validateTx(clonesAmount, mintPerCall * txPerClone) {
        require(clonesAmount <= clones.length, "Too much clones");
        uint256 totalMint = mintPerCall * txPerClone * clonesAmount;
        uint256 remaining = maxSupply - NFT(saleAddress).totalSupply();
        uint256 lastClone;
    ...
    function mintFromDeployedClonesWithFund_bundle(
        ...
        require(
            msg.value >=
                nftPrice *
                    (clonesAmount * txPerClone * mintPerCall) +
    ...
    function multiMint(
        ...
        uint256 _txCount,
        bytes calldata datacall
    ) public payable validateTx(_txCount, _numberOfTokens) {
