  ...
  ReentrancyGuard
{
    ...
    prohibitTeleportation(TRKeys.RELIQUARY_CHAMBER_DIVINITYS_END)
  {
    ...
    // of dust. It's almost too bright to see; a curious relic lay before you atop
    // the pedestal. As you take it into your hands, magic courses across its surface,
    // responding to your touch. An ancient device of sorts? A thought sparks, as if not your own:
    // learn, create, feel ...
...
library TRKeys {
  ...
  address public constant VIBES_GENESIS = 0x0853cF294605F84d4f80789028438e012615D576;
  address public constant VIBES_OPEN = 0xF2F7fB3fAC2C348E668dA33bbb0E626E34429048;

  // TODO: restore for mainnet
