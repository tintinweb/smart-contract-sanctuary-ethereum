...
contract devalphapineapple20220401 is 
    ERC721, 
    Ownable, 
    ReentrancyGuard, 
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://abc/hidden.json";
    ...
    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("devAlphaPineapple20220401", "dap220401")
    ...
    onlyAccounts
    {
        require(msg.sender == account,          "NFTG: Not allowed");
        require(presaleM,                       "NFTG: Presale is OFF");
        require(!paused,                        "NFTG: Contract is paused");
        require(
            _amount <= presaleAmountLimit,      "NFTG: You can't mint so many tokens");
        require(
            _presaleClaimed[msg.sender] + _amount <= presaleAmountLimit,  "NFTG: You can't mint so much tokens");
        ...
        require(
            ...
            "NFTG: max supply exceeded"
        );
        require(
            _price * _amount <= msg.value,
            "NFTG: Not enough ethers sent"
        );
    ...
    onlyAccounts
    {
        require(publicM,                        "NFTG: PublicSale is OFF");
        require(!paused,                        "NFTG: Contract is paused");
        require(_tokenSelector > 0,             "NFTG: Undefined Token");
        ...
        require(
           !_exists(_tokenSelector),
            "NFTG: Token has been minted before"
        );
