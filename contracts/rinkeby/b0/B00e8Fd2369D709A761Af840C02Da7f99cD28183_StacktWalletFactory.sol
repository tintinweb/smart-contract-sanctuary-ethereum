...
import "github.com/safe-global/safe-contracts/blob/v1.3.0/contracts/proxies/GnosisSafeProxyFactory.sol";
...
contract StacktWalletFactory {
    ...
    GnosisSafeProxyFactory internal safeFactory = GnosisSafeProxyFactory(0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2);   ///
    address constant stacktWalletSingletonAddress = 0xB06952A25845eAB7408B55881660b826cE603Fa3; ///
    ...
    function createWallet(
        ...
        // stackt wallet
        proxy = safeFactory.createProxy(stacktWalletSingletonAddress, setupData);
