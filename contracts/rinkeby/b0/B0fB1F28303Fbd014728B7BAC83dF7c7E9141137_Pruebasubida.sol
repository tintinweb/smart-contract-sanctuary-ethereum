...
contract Pruebasubida is ERC721, Ownable {
    ...
    uint256 private constant min_price = 0.00001 ether;
    ...
    constructor(string memory _baseURIextended) ERC721("PruebaSubida", "PruebaSubida"){
