...
contract ClubKawaiiPeaceProject is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    function batchSetTokenSupply( uint256[] memory tokenIds_, uint256[] memory newSupplies_ )
    public
    onlyOwner
    {
        ...
        for ( uint256 i = 0; i < tokenIds_.length; i++ ) {
            ...
            if ( exists(tokenId) && newSupply >= totalSupply(tokenId) ) {
