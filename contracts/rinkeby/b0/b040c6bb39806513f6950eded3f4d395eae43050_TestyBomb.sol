...
contract TestyBomb is ERC721, Ownable {
    ...
    uint public constant maxBombsInWallet = 5;
    uint256 constant public maxTokenPurchasePresale = 2;   
    ...
    */
    function mintBomb(uint numberOfTokens) public payable {
        ...
        require(balanceOf(msg.sender) + numberOfTokens <= maxBombsInWallet, "Each address may only own ten bombs");       
       ...
       if(privateSaleIsActive) {
            ...
            require(numberOfTokens <= max_Bombs, "Can only mint maxTokenPurchase tokens at a time");
        }
