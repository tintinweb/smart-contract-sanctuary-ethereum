...
contract USMUpgradeable is ERC20Upgradeable, MintableUpgradeable {
  ...
  function _transfer(address from, address to, uint256 amount) internal virtual override {
    require(amount <= transferAmountMax || whitelist[from] || whitelist[to], "Transfer amount is too large");
...
contract USMUpgradeableProxy is TransparentUpgradeableProxy {
