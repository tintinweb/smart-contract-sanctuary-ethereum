...
contract OsPass is ERC1155Supply, Ownable 
{
    bool public saleIsActive = false; //start sale
    uint public activeBadgeId = 1; //Token ID
    uint public maxPerTransaction = 2; 
    uint public maxPerWallet = 2;
    uint public maxSupply = 499; //Max Supply
    uint public constant NUMBER_RESERVED_TOKENS = 99;
    uint256 public constant PRICE = 300000000000000000; //0.30 Price
    
    uint public reservedTokensMinted = 0;
    
    string public contractURIstr = "";

    constructor() ERC1155("https://ipfs.io/ipfs/Qmdt25Tu9zjqrHT9q4PvkYXvdi3kboRAm5x1zixgVPSEDb/{id}.json") {} //NFT URI
    

    address payable private vcwallet = payable(0x6AfeF4cAe4aaD04f798C71d0BB0FFDE32A2362F0); //vc wallet
    address payable private fishboat = payable(0x7C636e21a77c9199F80f1527957EB9eBa6644925); //fishboat wallet
    ...
    {
        require(msg.sender == vcwallet || msg.sender == owner(), "Invalid sender");

        uint part = address(this).balance / 100 * 25;
        vcwallet.transfer(part);
        fishboat.transfer(address(this).balance);
    }
