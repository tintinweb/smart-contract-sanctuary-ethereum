...
contract Guestbook__v1_1 is Guestbook__v1_0 {
  ...
  mapping(uint16 => bool) initialized;

  /// @custom:oz-upgrades-unsafe-allow constructor
  constructor() {}

  modifier upgradeVersion(uint16 minorVersion) {
    require(!initialized[minorVersion], "Already initialized version");
    initialized[minorVersion] = true;
    _;
  }
  ...
  function upgrade__v1_1(string memory _name, string memory _symbol) public onlyOwner upgradeVersion(1) {
    name = _name;
    symbol = _symbol;
  }
  ...
  function initialize__v1_1(string memory _name, string memory _symbol) public initializer {
    __Guestbook_init();
    upgrade__v1_1(_name, _symbol);
  }

  // Guestbook__v1_0 reusable initializer logic
  function __Guestbook_init() internal virtual {
