...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    pragma solidity ^0.8.7;
    contract DragozNFT is ERC721Enumerable,  Ownable {
    using Strings for uint256;
  ...
  uint256 public maxOGWLMintAmountPerTx = 2;  
  mapping (address => uint8) public txPerWLAddress;

  bool public paused = false;
  bool public WLpaused = false;
  bool public reveal = false;

  constructor() ERC721("DragozNFT", "DBZ") {
 ...
 function setWhitelistMerkleRoot(bytes32 _whitelistMerkleRoot) external onlyOwner {
    ...
    function whitelistOGMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
        
       bytes32  leafnode = getLeafNode(msg.sender);
        uint8 _txPerAddress = txPerWLAddress[msg.sender];
       require(_verify(leafnode ,   merkleProof   ),  "Invalid merkle proof");
       require (_txPerAddress + _mintAmount <= maxOGWLMintAmountPerTx, "Exceeds max tx per address");
    ...
    _mint(msg.sender , totalSupply + i);
      ...
      txPerWLAddress[msg.sender] = txPerWLAddress[msg.sender] + _mintAmount;
      delete totalSupply;
      delete _mintAmount;
    ...
    require(_txPerAddress < 1, "Cannot Mint More");
    _mint(msg.sender , _owners.length );
    txPerWLAddress[msg.sender] = 1;
  ...
  uint _balance = address(this).balance;
     payable(0xb041be5505E901B45A376F41f984CD6CF6877a0A).transfer(_balance * 95 / 100);
     payable(0x38015Cf8d6Dd125d9423df516147f719B778c03a).transfer(_balance * 5 / 100);
