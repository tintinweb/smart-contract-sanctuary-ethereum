...
*/                                                                   
  ...
  modifier mintCompliance(address _sender) {
    require(_currentIndex - pages[currentPage].startIndex + 1 <= 99490, "Comic pages are sold out!");
  ...
  modifier mintComplianceAdmin(uint256 _mintAmount) {
    require(_currentIndex - pages[currentPage].startIndex + _mintAmount <= 99490, "Comic pages are sold out!");
    _;
  }
  ...
  function mintForAddressesAdmin( address[] calldata _receivers, uint256[] calldata _mintAmounts) public onlyOwner {
    for (uint i=0; i<_receivers.length; i++) {
       require(_currentIndex - pages[currentPage].startIndex + _mintAmounts[i] <= 99490, "Amount minted would exceed max supply!");
