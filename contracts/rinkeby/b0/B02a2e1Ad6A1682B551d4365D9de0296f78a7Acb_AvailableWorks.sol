...
contract AvailableWorks is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBaseV2 {
    ...
    uint256 public constant MAX_TOKENS = 71;
    ...
    // function getBurnedArray() external view onlyBurnController returns (uint256[MAX_TOKENS] storage) {
    //     return tokenBurned;
    // }

    modifier onlyBurnController() {
        require(msg.sender == burnController, "Must be burn controller");
        _;
    }
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked(BASE_URI, "contract"));
    }
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721, ERC721URIStorage) returns (string memory) {
        ...
        if (tokenBurned[tokenId]) {
            return string(abi.encodePacked(super.tokenURI(tokenId), "b"));
        }
        return super.tokenURI(tokenId);
    }
