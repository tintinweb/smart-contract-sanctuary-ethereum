...
contract Voucher is ERC1155  , Ownable , AccessControl {
    ...
    constructor(string memory _name ,string memory _baseURI , uint256 _maxSupply) 
    ERC1155(_baseURI) {
        name = _name;
        baseURI = _baseURI;
    ...
    function mint(address _to) public onlyOwner onlyRole(VAULT) {
        _mint(_to,voucher, 1, "Ethernal Voucher");
    }

    function redeem (address _customer) public onlyOwner onlyRole(VAULT) {
