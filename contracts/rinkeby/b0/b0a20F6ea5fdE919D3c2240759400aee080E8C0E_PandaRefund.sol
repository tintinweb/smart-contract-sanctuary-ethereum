...
contract PandaRefund is Ownable, ReentrancyGuard {
    ...
    function approveRedeem() external refundOpenning timeOut {
        require(openRefund, "PandaDAO: refund close.");
        require(pandaToken.balanceOf(msg.sender) > 0, "PandaDAO: you do not have any PandaTokens.");
        operatorStore.setOperator(address(this), PANDADAO_PROJECT_ID, operationsRedeem);
    }
