...
contract KOGA is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Kogake Carbon Token", "KOGA") ERC20Permit("KOGA") {}

    function decimals() public view virtual override returns (uint8) {
        return 9;
    }

    function initMinters(address _bondContract, address _rewardContract, address _nftContract)
        external
        onlyOwner
    {
        require(
            _bondContract != address(0) && _rewardContract != address(0) && _nftContract != address(0),
            "zero addr"
        );
