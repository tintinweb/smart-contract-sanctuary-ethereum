...
contract Dev is Ownable, ERC721A, ReentrancyGuard {
    //// constructor

    constructor() ERC721A("Dev Dev", "DEV") {
        collectionSize = 3;
        maxBatchSize = 2;
    }
    ...
    function checkSafeMint(uint256 quantity) private {
        require(msg.value >= mintPrice, "Need to send more ETH.");
        require(totalMinted() + quantity <= collectionSize, "reached max supply");
    }
}
