// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accessories", unicode"Eyes", unicode"Head", unicode"Mouth", unicode"Body", unicode"Background"];
        ...
        uint256 public publicMintPrice = 0.042 ether;
        string public baseURI = "";
        bool public isPublicMintActive;
        
        ContractData public contractData = ContractData(unicode"ChainedToadz", unicode"ChainedToadz are a collection 6969 small amphibious creatures trying to escape the tyrannical rule of the Evil King Gremplin by going fully on-chain. Created by Apeblond using the amazing art designed by Gremplin. This project is in the public domain. Feel free to use the toadz in any way you want.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/33ac0790-1816-4e6c-86bc-0fe84f40816b", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/33ac0790-1816-4e6c-86bc-0fe84f40816b", "https://www.chainedtoadz.io/", 500, "0xBc3D20463320958Dc7DE604b5FdCE94d9A85CEB2");

        constructor() ERC721A(unicode"ChainedToadz", unicode"CTOADZ") {
            TIERS[0] = [46,102,116,172,203,204,212,5914];
TIERS[1] = [46,59,64,79,79,79,87,91,93,96,97,111,111,116,117,127,128,129,130,130,130,135,135,140,146,147,150,165,169,170,220,220,250,250,2573];
TIERS[2] = [21,22,24,33,44,46,49,50,50,52,54,54,55,56,57,58,58,59,60,60,60,61,62,62,62,62,63,80,84,91,93,97,97,97,105,109,113,124,140,141,149,151,153,159,164,168,169,170,172,172,172,173,179,183,188,193,199,1290];
TIERS[3] = [2,76,85,107,114,163,170,183,190,202,203,229,229,233,241,306,310,354,3572];
TIERS[4] = [2,6,11,45,67,92,140,156,162,171,175,192,193,203,207,209,215,220,233,234,235,235,237,241,256,258,258,258,271,288,301,335,347,516];
TIERS[5] = [10,19,22,424,439,456,462,472,484,497,500,507,514,523,523,532,585];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"ChainedToadz #");
