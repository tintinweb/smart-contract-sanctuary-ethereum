 ...
 *
 */
contract GrittyCats is RoyaltySplits, CryptoframeCreator {
	constructor(
...
/// @author Cryptoframe (cryptoframe.io)
 ...
 */
abstract contract CryptoframeCreator is
	Context,
	Ownable,
	ReentrancyGuard,
...
contract RoyaltySplits {
	address[] internal addresses = [
		0x76A39467b1c8141a84FC08d0298cE4A01C60592A,
		0xDF47fa8912A9b3d2B826284fC0208270D653E3F7,
		0xC415D3021F8397274eD1f71f676d505C5B2C0c61
	];

	uint256[] internal splits = [35, 35, 30];
}
 ...
 * @author Cryptoframe (cryptoframe.io) (revised) minimized gas costs via shorter errors
