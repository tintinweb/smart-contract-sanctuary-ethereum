...
contract EscrowClone is ReentrancyGuard, Initializable {
    ...
    function contractApproveERC20(uint256 _amount, address _erc20) public onlyFreeflowOrClient nonReentrant {
        SafeERC20.safeApprove(IERC20(_erc20), address(this), _amount);
    }
