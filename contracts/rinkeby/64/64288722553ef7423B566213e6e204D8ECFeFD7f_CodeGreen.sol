...
contract CodeGreen is ERC1155Supply, Ownable, Pausable {
     ...
     */
    function mintPresale(bytes32[] calldata merkleProof) external isValidMerkleProof(merkleProof, merkleRoot) {
        require(preSaleIsActive && !publicSaleIsActive, "PRESALE_NOT_ACTIVE");
    ...
    /**
     * @notice Allow public minting of a single token
     */
