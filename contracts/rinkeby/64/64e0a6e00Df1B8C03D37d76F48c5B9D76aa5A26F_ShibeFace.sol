...
contract ShibeFace is ERC1155, Merkle, ReentrancyGuard {
    ...
    uint256 public constant presalePerWallet = 3;
    uint256 public constant publicsalePerWallet = 5;
    uint256 public constant presalePriceInEth = 0.011 ether;
    uint256 public constant publicsalePriceInEth = 0.011 ether;
    uint256 public presalePriceInShib = 1 ether;
    uint256 public publicsalePriceInShib = 1 ether;

    address public shib = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709;
    address public developer = 0x01CB52008400316898535ef77d2844746Fdd90e5;

    uint256 public preSaleStart = 10444333;
    uint256 public constant preSaleMaxSupply = 333;

    uint256 public publicSaleStart = 10446598;
