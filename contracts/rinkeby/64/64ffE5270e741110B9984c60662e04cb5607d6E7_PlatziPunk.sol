...
contract PunksDNA {
    ...
    //this pseudo random number generator don┬┤t be used in production, but it┬┤s very usefull for testing
        ...
        returns (uint256)
    {
        ...
        bytes memory encondeParams = abi.encodePacked(combinedParams);
        bytes32 hashedParams = keccak256(encondeParams);
...
// File contracts/PlatziPunk.sol

 
pragma solidity ^0.8.0;
contract PlatziPunk is ERC721, ERC721Enumerable, PunksDNA {
