...
contract Land is ERC721, ERC2981, ReentrancyGuard, Ownable {
    /**
    ...
    * @param _previewURI preview uri to use when tokenURI is empty
    * @param _maxSupply nft max supply
    * @param _mintPrice minting price
    * @param _withdrawalRecipient address to withdraw contract balance
    * @param _merkleRoot initial merkle root
    * @param _royaltyFeesInBips has 2 decimal precision. E.g. a value of 500 would result in a 5% royalty fee
    * @param _royaltyReceiverAddress address to receive royalty fees
    * @param _maxMintPerAddress initial maximum mint per address
    */
    constructor(
        string memory _name,
        ...
        ERC721(_name, _symbol)
    {
        ...
        eliteTokenStart = _eliteTokenStart;
    ...
    */
    ...
    /**
    * @dev Sets new saleStatus sale status
    *
