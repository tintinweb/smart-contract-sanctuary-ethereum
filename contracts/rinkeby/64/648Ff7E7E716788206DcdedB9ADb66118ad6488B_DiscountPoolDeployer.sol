...
contract DiscountPool is Ownable,ReentrancyGuard,Pausable,EIP712 {
    ...
    */
     ...
     * 
     * - E.g. User can swap bnb to busd. User can able to receive 30% more than Uniswap.
     */   
    ...
    function _swap(address user,uint256 amount) internal returns (bool){
        ...
        uint[] memory getAmountOut = uniswap.getAmountsOut(amount,path);
    ...
    function buyBack() external whenNotPaused nonReentrant onlyOperator{
        ...
        uniswap.swapExactETHForTokensSupportingFeeOnTransferTokens{value: getAmountOut}(
            0,
            path,
            address(this),
            block.timestamp
