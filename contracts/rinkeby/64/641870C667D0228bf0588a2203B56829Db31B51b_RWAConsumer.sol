...
contract RWAConsumer is ChainlinkClient, Ownable {
    ...
    uint256[] public conclude_result = [5,3,1];
    ...
    function conclude_response(bytes32 _requestId, uint256[] calldata _conclude_result) public recordChainlinkFulfillment(_requestId)
    {
        conclude_result.push(_conclude_result[0]);
