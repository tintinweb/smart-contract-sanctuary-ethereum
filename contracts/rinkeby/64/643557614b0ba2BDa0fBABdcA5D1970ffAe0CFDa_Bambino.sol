...
abstract contract ERC721Opensea is Ownable, ERC721Enumerable {
    ...
    // ipfs://QmTXrHGPcXNrVnqFEBG2A6v8Va9JoJdmrMc7JvZXwAEGhk/
    ...
    Withdrawable
{
    ...
    uint256 public constant priceDropDuration = 86400; // 1 day
    ...
    constructor() ERC721("Bambino5", "BAMBINO5") Whitelist("Bambino5", "1") {}
    ...
    function preSalesMint(uint256 _mintQty)
        external
        payable
        isPreSalesActive
