...
contract OnchainNft is ERC721 {
    ...
    function mintExp() public returns(uint) {
    ...
    function generateBase64Image() private pure returns (string memory) {
...
'"<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#F6CE94">100</text>"',
