...
contract RandomIpfsNft is ERC721URIStorage, VRFConsumerBaseV2, Ownable {
    ...
    //NFT info
    // Rarity, written in percentage, should sum to 100
    uint256 private constant PUG_CHANCE = 10;
    uint256 private constant SHIBA_CHANCE = 20;
    uint256 private constant BERNARD_CHANCE = 70;
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        uint256 moddedRng = randomWords[0] % (PUG_CHANCE + SHIBA_CHANCE + BERNARD_CHANCE);
    ...
    function getChanceArray() public pure returns (uint256[3] memory) {
        return [PUG_CHANCE, PUG_CHANCE + SHIBA_CHANCE, PUG_CHANCE + SHIBA_CHANCE + BERNARD_CHANCE];
    }
