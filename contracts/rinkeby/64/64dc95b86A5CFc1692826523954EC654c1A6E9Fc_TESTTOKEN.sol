...
contract TESTTOKEN is ERC721AA, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721AA("TESTTOKEN2", "TTT2") {
    setUriPrefix("ipfs://QmVMcyZrMcZQJxaPdbdCb6osyC3hEa3HQCJsT64RurcR9r/");
    setHiddenMetadataUri("ipfs://QmR9H7JvfKhPQ75Bf9HX3d7ckVad66EpLSMehx5FBmh8Kp/");
  }
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    if (revealed == false) {
      return string(abi.encodePacked(hiddenMetadataUri, nfts[_tokenId].blindBoxType.toString(), ".png"));
    }
