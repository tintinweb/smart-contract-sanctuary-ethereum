...
pragma solidity ^0.8.13; // <-- version directive
...
contract Character is ERC721URIStorage, Ownable {
  ...
  uint256 fee = 0.0001 ether; // <-- any fees we want to change on txs
  ...
  string public notRevealedUri = "ipfs://QmZ1VdZ71YkLZ6Lg3w8zjTkf7iUhRMC5nR5SwbM9J6BccA"; // <-- link to metadata for e.g. hidden opensea listing of token
