...
contract Squibs is ERC721A, Ownable {
    ...
    // Withdraw addresses
    address t1 = 0xeD6a7bc2338367Ab708F3EE2fA8DB0672e821f15; // TEAM WALLET
    address t2 = 0x2cD31e21d98996944808653bDF8A34201C1f4D32; // COMMUNITY WALLET
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(t1).send(((_total)/100)*90)); 
        require(payable(t2).send(((_total)/100)*10)); 
