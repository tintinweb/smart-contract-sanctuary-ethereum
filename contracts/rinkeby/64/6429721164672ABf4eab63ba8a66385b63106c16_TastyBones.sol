...
contract TastyBones is Ownable, ERC721A, ReentrancyGuard {
    ...
    // raffle mint
    mapping (address => uint256) public mintedTBforRaffle;
    mapping(address => uint256) addressBlockBought;

    bytes32 private freeMintBoneMerkleRoot = 0x12a25c309e8ddcdae1043d3793c72719fafd7521b8accad27c9750376df5ea0d;
    bytes32 private freeMintListMerkleRoot = 0x5a7b44011aedc7903406f9f1bd7aa232264a14cf0f636db77dceb950fcdacef9;

    bytes32 private presaleMerkleRoot = 0x893fb77e38cc82ad6c7dde9fdf8fed82a50b1c3479cf79140b009eff593fd796;
    bytes32 private raffleMerkleRoot = 0xe62edbb82a1414de0e5d81626d955a6c522109dc5ab8bc9ac3c469e19929e739;
    ...
    function mintFreeWithBone(
        uint256 boneTokenId, 
        bytes32[] calldata boneProof) external payable isSecured(1) {
        ...
        require(tokenSupply.current() + 1 < maxFreeMintSupply, "EXCEEDS_FREE_MINT_SUPPLY" );
        require(mintedTBforFreeMintAddress[msg.sender] + 1 <= maxFreeMint,"ALREADY_MINTED_MAX_2");
    ...
    function mintFreeWL(
        ...
        require(tokenSupply.current() + numberOfTokens < maxFreeMintSupply, "EXCEEDS_FREE_MINT_SUPPLY" );
        require(mintedTBforFreeMintAddress[msg.sender] + numberOfTokens <= maxMint,"CANNOT_MINT_MORE_THAN_ALLOWED");
        require(mintedTBforFreeMintAddress[msg.sender] + numberOfTokens <= maxFreeMint,"ALREADY_MINTED_MAX_2");
        require(MerkleProof.verify(freeMintProof, freeMintListMerkleRoot, keccak256(abi.encodePacked(msg.sender))), "YOU_ARE_NOT_WHITELISTED_TO_MINT_FREE");
    ...
    function mintPresale(uint256 numberOfTokens, bytes32[] calldata proof) external payable isSecured(2) {
        ...
        require(mintedTBforPresale[msg.sender] + numberOfTokens <= maxPresaleMint, "EXCEEDS_MAX_PRESALE_MINT" );
        require(tokenSupply.current() + numberOfTokens < maxPresaleSupply, "EXCEEDS_MAX_SUPPLY" );
    ...
    function mintRaffle(bytes32[] calldata proof) external payable isSecured(3) {
        ...
        require(tokenSupply.current() + maxRaffleMint <= maxTastyBones, "EXCEEDS_MAX_SUPPLY" );
        require(mintedTBforRaffle[msg.sender] + maxRaffleMint <= maxRaffleMint, "EXCEEDS_MAX_RAFFLE_MINT" );
        ...
        mintedTBforRaffle[msg.sender] += maxRaffleMint;
    }
