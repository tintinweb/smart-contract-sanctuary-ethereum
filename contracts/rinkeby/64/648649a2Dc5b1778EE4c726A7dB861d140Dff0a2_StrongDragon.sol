...
contract StrongDragon is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Strong Dragon", "DRAGON") {
    setHiddenMetadataUri("ipfs://QmRpRBpCMERhTvCQz7tWKB42oDKD9TNHGVyfoWGp9NQRC4/hidden_Dragon_Metadata.json");
  }
