...
contract TestToken is ERC721, Pausable, Ownable {
    ...
    // Starting time in UNIX, but in seconds
    uint256 public wlMintStartTime = 1774256800;
...
//=========================== Your functions used for testing
    ...
    function setAuctionStartPrice (uint256 _auctionStartPrice) public onlyOwner {
        auctionStartPrice = _auctionStartPrice;
    }

    function setWLMintStartTime (uint256 _wlMintStartTime) public onlyOwner {
    ...
    function setAuctionStartTime ( uint256 newTimestamp ) public onlyOwner {
...
// WHITELIST MINTING
    ...
    function mintWL(bytes32[] calldata _merkleProof) public payable whenNotPaused {


        //make a require for when the whitelist starts?
    ...
    function setMerkleRoot(bytes32 _merkleRoot) public onlyOwner {
        merkleRoot = _merkleRoot; //49929b11321e74458cc6d5ee43fa22c0bc9a89b1415391a29c7c8706122b87f2
    }
