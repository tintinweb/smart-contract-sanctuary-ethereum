...
contract BabbiERC721 is ERC721Royalty, Ownable, ReentrancyGuard {
  ...
  // Contructor
  constructor(string memory _URI) ERC721("BabbiERC721", "BabbiERC721") {
    //TODO: Babies
    setBaseURI(_URI);
  }
  ...
  ////////////////////////// REMOVE ////////////////////////// TODO
  function setCoolmansUniverse(address _address) public onlyOwner {
    coolmansUniverse = ERC721Enumerable(_address);
  }
}
