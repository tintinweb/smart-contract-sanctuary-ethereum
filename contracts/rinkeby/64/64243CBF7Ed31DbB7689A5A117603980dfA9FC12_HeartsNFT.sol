...
contract HeartsNFT is ERC721URIStorage, Ownable {
    ...
    function heartToImageURI(string memory _word, string[4] memory colorArray) private pure returns (string memory imageURI) {
        ...
        string memory fourSVG = string(abi.encodePacked('<defs><g id="h"><path d="M50 160 l95 125 l95 -125a45 50, 35, 0,0 -95,-45a45,50 -35 0,0 -95,45"Z /></g><g id="h2"><path d="M65 160 l88 115 l88 -115a40 45, 35, 0,0 -88,-45a40,45 -35 0,0 -88,45"Z /></g></defs>')); 
