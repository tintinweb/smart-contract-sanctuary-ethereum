...
contract ScotchNFT is ScotchBeneficiary, ERC721URIStorage {
...

  {
...

    {
      ...
      (bool success, bytes memory result) = wrapper.delegatecall(abi.encodeWithSignature("wrap721(address,uint256,uint256,uint256,address,uint256,uint256,address)",
      ...
      uint256 wrappedId = abi.decode(result, (uint256));



      require(success && wrappedId > 0, "Could not wrap NFT");
