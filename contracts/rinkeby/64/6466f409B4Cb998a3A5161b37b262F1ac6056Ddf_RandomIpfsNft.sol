...
abstract contract ERC721URIStorage is ERC721 {
    using Strings for uint256;                  // as Strings.sol is already inherited by ERC721.sol

    // Optional TokenId mapping to token URIs (req. in Random Ipfs Nft.sol)
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        // _baseURI() returns "" in case of RandomIpfsNft.sol as it's not overridden

        // If there is no base URI ( value is default = ""), return the tokenURI as such
