...
contract ChildrenOfUkiyo is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant AMOUNT_FOR_DEVS = 200;
    ...
    ) ERC721A("Children of Ukiyo", "CHILDRENOFUKIYO") {
    ...
    function devMint(uint256 quantity) external onlyOwner {
        require(totalSupply() + quantity <= AMOUNT_FOR_DEVS, "too many already minted before dev mint");
