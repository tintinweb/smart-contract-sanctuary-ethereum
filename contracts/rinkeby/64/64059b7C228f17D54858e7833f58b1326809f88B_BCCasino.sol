...
contract BCCasino is AccessControl {
    ...
    function deposit(uint256 machineId) external returns (bool) {
        require(machineId <= machineIdCounter.current(), "Invalid machineId");
    ...
    function reward(
        ...
        require(
            ...
            "User didn't made a deposit for the game. Invalid request"
        );
...
contract BCNFT is ERC721, AccessControl {
    using Counters for Counters.Counter;

    Counters.Counter public tokenIdCounter;

    constructor() ERC721("BCNFT", "BC721") {
        tokenIdCounter.increment();
    }

    function mint(address user) external onlyAdmin returns (uint256) {
