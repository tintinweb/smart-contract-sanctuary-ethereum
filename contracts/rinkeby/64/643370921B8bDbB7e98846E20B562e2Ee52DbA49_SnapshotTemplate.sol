...
// File @openzeppelin/contracts-upgradeable/proxy/ERC1967/ERC1967UpgradeUpgradeable.[email protected]
...
}// File contracts/templates/SnapshotTemplate.sol
...
contract SnapshotTemplate is SnapshotFeature {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC20SnapshotRewrited) {
