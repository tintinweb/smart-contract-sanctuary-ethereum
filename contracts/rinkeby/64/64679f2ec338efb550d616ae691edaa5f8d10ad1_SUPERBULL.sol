...
contract SUPERBULL is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "SUPER BULL";
    string private _symbol = "SUPERBULL";
