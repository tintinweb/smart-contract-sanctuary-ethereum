...
contract Cryptotz_ is Ownable, ERC721A {
    ...
    address constant internal owner_address = 0x2bda8cE2c8Bad94C02d9890447aD3dF57fd3a4e3;
    address public ownerwallet = 0x5AA0c01d481546c388Ef28f495dD1e898399A4E9;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Contract Name", "Symbol") { }
    ...
    function ownerMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= 1000, "owner mints after free");
