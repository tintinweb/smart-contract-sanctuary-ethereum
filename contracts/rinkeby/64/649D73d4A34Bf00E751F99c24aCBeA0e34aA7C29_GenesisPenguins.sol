...
contract GenesisPenguins is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) internal userAmountMinted;
    ...
    function setSaleState(
        ...
        emit SetSaleState(_isWhitelistSale, _isDiamondSale, _isPublicSale);
    }
