 ...
 *
 * Yachts is a ERC721 Contract.
 */
contract Yachts is ERC721, ERC2981, Ownable {
    ...
    function mint() public {
        require(
            ...
            "Yachts: Public Minting is not Enabled"
        );
     ...
     */
    function mint(address tokenReceiver) public onlyOwner {
        _mint(tokenReceiver, _tokenIdTracker.current() + 1);
        _tokenIdTracker.increment();
    }
    ...
    function setTokenURI(uint256 tokenId, string memory permanentTokenURI)
        ...
        onlyOwner
    {
        require(_exists(tokenId), "Yachts: URI set of nonexistent token");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "Yachts: URI query for nonexistent token"
        );
