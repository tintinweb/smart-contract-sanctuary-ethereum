...
// File: contracts/MonkeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MonkeContract is RamppERC721A {
    constructor() RamppERC721A("Monke", "MONKE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sqfIwg30Fjm0ZDkmPOEQ/contract-metadata";
    }
}
