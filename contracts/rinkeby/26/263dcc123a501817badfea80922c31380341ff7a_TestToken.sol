 ...
 */
contract TRC20 is Context, ITRC20, ITRC20Metadata,Ownable {
...
contract TestToken is TRC20,TRC20Burnable {
    constructor()
         TRC20("TestToken", "TEST", 18) {
            _mint(msg.sender, 690000000000000000000000000000 * (10 ** uint256(18)));
        }
