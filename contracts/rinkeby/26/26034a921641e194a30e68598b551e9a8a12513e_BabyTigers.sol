...
contract BabyTigers is ERC721A, ReentrancyGuard, Ownable {
    ...
    mapping(uint256 => bool) public burnedTypicalTigers;
    ...
    function holderMint(uint256[] calldata _typicalTigerIds, uint256 _count) external payable nonReentrant {
    ...
    function holderFreeMint(uint256[] calldata _typicalTigerIds, uint256 _count) external nonReentrant {
        require(holderSaleIsActive, "HOLDER_SALE_INACTIVE");
        require(
            _count == _typicalTigerIds.length,
            "INSUFFICIENT_TT_TOKENS"
        ...
        for (uint256 i = 0; i < _typicalTigerIds.length; i++) {
            burnedTypicalTigers[_typicalTigerIds[i]] = true;
        }
        _safeMint(msg.sender, _count);
    }
