...
contract pandasoaceyes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("panda space yes", "SYMBOL") {
    setHiddenMetadataUri("ipfs:/Qmd66o5tqsvaRgfey7epetffDSwyfrGHSU2qHSrZiGtfHy/hidden.json");
  }
