...
contract NemoLand is Admin, ERC721Upgradeable {
    ...
    event CurrencyAdded(uint256 currencyType);
    ...
    function addCurrency(
        ...
        emit CurrencyAdded(_currecyType);
    }
    ...
    function allowBuy(
        ...
        tokenIdToPrice[_id] = OnSaleLand(weiAmount, msg.sender, currencyType);
        emit AllowBuy(msg.sender, _id, weiAmount, currencyType);
    }
    ...
    function buy(uint256 _id, uint256 _amount) external payable {
        ...
        address seller;
        uint256 comission;
        uint256 leftOver = _amount - comission;
        if (0 == currencyType) {
