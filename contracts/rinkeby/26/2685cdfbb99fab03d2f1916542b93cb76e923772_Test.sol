...
/*
* @title ERC1155 token for Test cards
*/
contract Test is AbstractERC1155Factory{
    ...
    constructor(
        ...
        _mint(0x5BFEB9975184272efeA22D31E6b11359DAbE34d4, 0, 200, "");
    }
    ...
    */
    function editSaleRestrictions(uint8 _maxPerTx, uint8 _maxTxPublic) external onlyOwner {
        maxPerTx = _maxPerTx;
