...
contract Cat03 is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_CATS = 100;
    
    // list of addresses that have a number of reserved tokens for presale
    mapping(address => uint256) private _preSaleWhitelist;

    address t1 = 0x60d121A9D4957817817da90E539EC6e12F7B5F72;
    address t2 = 0x555B30bAeFBe4c36e9Fe2E3437c97a4a21BB7f38;
    
    constructor() ERC721('Fo Test 03', 'FoTest03') {
    ...
    function setInitialURI(string memory updatedURI) public onlyOwner {
        URI = updatedURI;
    }


    function giveAway(address[] memory _toAddresses, uint256 numberOfTokens)
        public
        onlyOwner
    {
    ...
    function preSaleMintCat(uint256 numberOfTokens) public payable {
        uint256 supply = totalSupply();
