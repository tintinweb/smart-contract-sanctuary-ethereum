...
contract AlphaWhaleNFT is ERC721A, Ownable, Pausable {
    ...
    uint256 public MAX_PER_WHITELIST_ADDRESS = 5;
    uint256 public MAX_PER_AIRDROP_ADDRESS = 1;

    // public sale mint max per tx
    uint256 public MAX_PER_TX = 20;

    uint256 public mintPriceInWei = 0.14 ether;

    address public alphaWhaleWallet1 =
        0x1fD07Ff9BF2663495C2FcC084fD65473Bfa29b9e;
    address public alphaWhaleWallet2 =
        0xd7942B32f580b6a2db22818c75e46a1f87f428Bb;

    uint256 public alphaWhaleFeePercent1;
    uint256 public alphaWhaleFeePercent2;
    ...
    function publicMint(uint256 count) public payable {
        ...
        require(
            ...
            "AlphaWhaleNFT: Exceeds max supply."
        );
        require(
            count <= MAX_PER_TX,
     ...
     * @param _alphaWhaleWallet1 The alphawhale wallet address
     * @param _alphaWhaleWallet2 The alphawhale wallet address
     */
    function setWallet(address _alphaWhaleWallet1, address _alphaWhaleWallet2)
        external
        onlyOwner
    {
        alphaWhaleWallet1 = _alphaWhaleWallet1;
        alphaWhaleWallet2 = _alphaWhaleWallet2;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0, "AlphaWhaleNFT: no balance available");

        payable(alphaWhaleWallet1).transfer(
            (balance * alphaWhaleFeePercent1) / totalFeeUnitPercent
        );
        payable(alphaWhaleWallet2).transfer(
            (balance * alphaWhaleFeePercent2) / totalFeeUnitPercent
        );
    }

    /**
     * @dev Set fund distribution percent
     * @param _alphaWhaleFeePercent1 The alpha whale fund percent
     * @param _alphaWhaleFeePercent2 The alpha whale fund percent
     * @param _totalFeeUnitPercent The total fee unit percent
     */
    function setFee(
        uint256 _alphaWhaleFeePercent1,
        uint256 _alphaWhaleFeePercent2,
        uint256 _totalFeeUnitPercent
    ) external onlyOwner {
        alphaWhaleFeePercent1 = _alphaWhaleFeePercent1;
        alphaWhaleFeePercent2 = _alphaWhaleFeePercent2;
    ...
    {
        require(_exists(_tokenId), "AlphaWhaleNFT: Token does not exist.");
    ...
    function _beforeTokenTransfers(
        ...
        require(!paused(), "AlphaWhaleNFT: paused token transfer");
    }
}
