...
contract NineTTwo is ERC721A, Ownable, ReentrancyGuard {
  constructor() ERC721A("NTP2", "NTT2") {}

using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public NTT_PUBLIC_PER_USER = 5;
    uint256 public  NTT_WHITELIST = 20; //999
    uint256 public  NTT_GIFT = 7; //200
    uint256 public  NTT_PUBLIC = 18; //8800
    uint256 public constant NTT_MAX_SUPPLY = 45;
