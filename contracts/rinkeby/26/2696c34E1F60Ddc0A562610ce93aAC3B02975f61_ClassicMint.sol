...
contract ClassicMint is BaseTemplate {
    ...
    bytes32 private constant TEMPLATE_TYPE = bytes32("Classic Mint");
    ...
    function templateType() external pure returns (bytes32) {
        return TEMPLATE_TYPE;
    }

    // Returns the version of the template.
    function templateVersion() external pure returns (uint8) {
