...
contract PulseTroll is ERC20, Ownable {
    ...
    mapping(address => uint256) public claimListAmounts;
     ...
     */
    function updateClaimMaxInterval(uint256 val) public onlyOwner {
     ...
     */
    function updateClaimMaxDate(uint256 val) public onlyOwner {
        claimMaxDate = val;
    }
    ...
    function claim() internal {
        require(block.timestamp < claimMaxDate, "Cant claim");
        require(!claimList[msg.sender], "Cant claim");
        require(claimListAmounts[msg.sender] == 0, "Cant claim");
     ...
     */
    function canClaim(address account) internal view virtual returns (bool) {
