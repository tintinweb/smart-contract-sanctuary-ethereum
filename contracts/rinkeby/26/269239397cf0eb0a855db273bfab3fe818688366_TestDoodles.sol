...
contract TestDoodles is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _maxMint = 10;
    uint256 private _price = 1 * 10**15; //0.01 ETH;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 10000;

    constructor(string memory baseURI) ERC721("TestDoodles", "TESTDOODLES")  {
        setBaseURI(baseURI);
    }
