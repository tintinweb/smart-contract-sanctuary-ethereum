...
contract MarioNFT is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 5;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("Mario NFT", "MNFT") {

        tokenIdCounter.increment();
        baseURI = "ipfs://QmNiGPz3GFzhsMVPQb7JoPVNw7U4VZyCh9t66JHGqKC6ue/";   
        mintCost = 0.01 ether;
    }
    ...
    event MintMArioNFT(address indexed user, uint256 tokenId); 
    ...
    function mintMarioNFT(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintMArioNFT(msg.sender, tokenIdCounter.current());            
