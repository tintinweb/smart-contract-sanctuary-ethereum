...
contract dmony is ERC721, Ownable {
  ...
  uint256 public maxSupply = 3434;
  uint256 public maxMintAmountPerTx = 3;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("dmoney", "DM") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xEe287F54E3FA1324CBb4a4366f50d37802fb6b70).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
