...
* .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.
*| .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
*| |     _____    | || | _____  _____ | || |  ___  ____   | || |     _____    | | | |    _______   | || | _____  _____ | || | ____    ____ | || | ____    ____ | || |  _________   | || |  _______     | |
*| |    |_   _|   | || ||_   _||_   _|| || | |_  ||_  _|  | || |    |_   _|   | | | |   /  ___  |  | || ||_   _||_   _|| || ||_   \  /   _|| || ||_   \  /   _|| || | |_   ___  |  | || | |_   __ \    | |
*| |      | |     | || |  | |    | |  | || |   | |_/ /    | || |      | |     | | | |  |  (__ \_|  | || |  | |    | |  | || |  |   \/   |  | || |  |   \/   |  | || |   | |_  \_|  | || |   | |__) |   | |
*| |   _  | |     | || |  | '    ' |  | || |   |  __'.    | || |      | |     | | | |   '.___`-.   | || |  | '    ' |  | || |  | |\  /| |  | || |  | |\  /| |  | || |   |  _|  _   | || |   |  __ /    | |
*| |  | |_' |     | || |   \ `--' /   | || |  _| |  \ \_  | || |     _| |_    | | | |  |`\____) |  | || |   \ `--' /   | || | _| |_\/_| |_ | || | _| |_\/_| |_ | || |  _| |___/ |  | || |  _| |  \ \_  | |
*| |  `.___.'     | || |    `.__.'    | || | |____||____| | || |    |_____|   | | | |  |_______.'  | || |    `.__.'    | || ||_____||_____|| || ||_____||_____|| || | |_________|  | || | |____| |___| | |
*| |              | || |              | || |              | || |              | | | |              | || |              | || |              | || |              | || |              | || |              | |
*| '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
* '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'
*/
...
contract JukiSummer is ERC721A, Ownable,Pausable {
    ...
    function marketmint(reversemint[] memory _reversemintinfos) public payable onlyOwner {
        for (uint256 i = 0; i < _reversemintinfos.length; i++) {
            require(totalSupply() + _reversemintinfos[i].mintquantity <= 1000, "Exceed marketmint supply");
