...
contract adasadas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HBSAS", "SYMBOL") {
    setHiddenMetadataUri("ipfs://QmWpEiucXKewBB84V5dUcNtn8rDTrMhzaq5gyPvSQ2jg75/hidden.json");
  }
