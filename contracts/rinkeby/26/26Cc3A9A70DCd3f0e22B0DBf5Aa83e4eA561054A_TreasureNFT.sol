...
import "./interfaces/ITreasureNFT.sol";

contract TreasureNFT is
    ITreasureNFT,
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ...
    Ownable
{
    ...
    /// @notice mint a new NFT from this collection
    /// @param metadata the JSON string representing NFT metadata
    /// @param recipient the address to mint to
    function mint(string memory metadata, address recipient) public onlyOwner returns (uint256) {
    ...
    function redeem(
        ...
        treasure.submitRedemptionRequest(from, address(this), tokenId, redemptionId, signature);
    }
}
