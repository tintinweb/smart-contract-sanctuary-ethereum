...
contract MyEpicNFT is ERC721URIStorage {
    ...
    uint256 private _totalNFTMinted = 0;

    uint256 TOTAL_MINT_MAX_SIZE = 50;
    ...
    function makeAnEpicNFT() public {
        require(
            _totalNFTMinted < TOTAL_MINT_MAX_SIZE,
            "Todos os NFT ja foram cunhados!"
        );
        ...
        _totalNFTMinted = _totalNFTMinted + 1;
        ...
        console.log("Total NFT cunhado %s", _totalNFTMinted);
    }
