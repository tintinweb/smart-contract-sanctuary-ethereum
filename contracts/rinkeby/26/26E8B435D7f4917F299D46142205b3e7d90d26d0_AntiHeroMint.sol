...
contract AntiHeroMint is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using SafeMath for uint256;
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public MAX_ANTIHEROES = 6666;
    uint256 public MINT_PASS_SUPPLY = 4810;
    uint256 public PUBLIC_SUPPLY = 0;
    uint256 public WL_SUPPLY = 1856;
    uint256 public MAX_PER_PURCHASE = 2;
    uint256 public ANTIHERO_BASE_PRICE = 0.13 ether;
    ...
    Counters.Counter public publicMintSupply;
    Counters.Counter public wlMintSupply;
    Counters.Counter public mintPassSupply;
    ...
    constructor() ERC721("Hero Galaxy: Anti-Heroes", "ANTI-HERO") {}
    ...
    function _safeMintAntiheroes(uint256 _quantity, bool _freeMint) internal {
        ...
        for (uint256 i = 0; i < _quantity; i++) {
            ...
            if (mintIndex < MAX_PER_PURCHASE) {
                ...
                emit AntiheroMinted(msg.sender, msg.value, tierLevel(msg.value, _freeMint, _quantity));
            }
        }
    }
    function tierLevel(uint256 amountSent, bool freeMint, uint256 quantity) internal view returns (uint256 tier) {
        if (!freeMint) {
