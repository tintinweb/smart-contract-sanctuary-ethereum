...
contract Wordle is ERC721, Ownable, IERC721Receiver {
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
      ...
      toString(tokenId),
        '","image":"https://ipfs.io/ipfs/QmbRwxoWigi6LX4jq7E5MDiVZNadEBq7uRgCX9Zc2Yzsiq","collection_name":"Web3Wordle","platform":"Web3Wordle","curation_status":"curated","series":"1","description":"Web3Wordle is an on-chain word game based on opensourced code. Play online to save your score here: https://w3w.lol/game/',
        toString(tokenId),
        ...
        toString(tokenId),
        '/","version":"1.0"}, "attributes":[{"trait_type":"AverageGuessesToSolve","value":',
