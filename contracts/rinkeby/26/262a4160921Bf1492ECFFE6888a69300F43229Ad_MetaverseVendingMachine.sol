...
contract MetaverseNFT721 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
  using Counters for Counters.Counter;

  address constant metaverseEOAAddress = 0xAb3cbE5E57e0B2035831DcA8e0Ce8f10F2eFa05D;
  bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  bytes32 public constant VENDING_MACHINE_ROLE = keccak256("VENDING_MACHINE_ROLE");
  Counters.Counter private _tokenIdCounter;

  constructor() ERC721("MetaverseNFT721", "JOE") {
    _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
  ...
  // vending machines are able to bypass ownership checks and transfer NFTs out of pre-determined addresses,
  function vendingMachineTransfer(address to, uint256 tokenId) public onlyRole(VENDING_MACHINE_ROLE) {
    _transfer(metaverseEOAAddress, to, tokenId);
  }
