...
library HairDetail {
    ...
    function classicHairs(string memory hairsColor)
        private
        pure
    ...
    function classicTwoHairs(string memory hairsColor)
        private
        pure
        returns (string memory)
    {
    ...
    function spike(string memory hairsColor)
        private
        pure
        returns (string memory)
    {
    ...
    function shortHairs(string memory hairsColor)
        private
        pure
        returns (string memory)
    {
