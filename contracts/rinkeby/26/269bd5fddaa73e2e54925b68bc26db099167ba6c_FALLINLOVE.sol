...
contract FALLINLOVE is Context, IERC20, Ownable {
  ...
  // enable trading 
    ...
    // whitelisting address that will exclude from fee on selling 
    function setWhiteListingAddress( address _walletAddress ) public onlyOwner {
    _isExcludedFromFee[_walletAddress] = true ; 
    }
