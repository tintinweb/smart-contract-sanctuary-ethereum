...
/// @title Hidden Royals Mint Contract
/// @author Hidden Royals
contract ERC721AVRF is ERC721A, VRFConsumerBaseV2, Ownable {
    using Strings for uint256;
    ...
    constructor(
        ...
        bytes32 _keyHash,
        address _owner
    ) ERC721A("Token Name", "Token Symbol") VRFConsumerBaseV2(_vrfCoordinator) {
        // -- Chainlink
        require(
            subscriptionId != 0,
