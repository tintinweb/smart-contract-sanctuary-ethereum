...
contract MRC721Bridge is AccessControl, IERC721Receiver {
  ...
  uint256 public dstGasFee = 0.0002 ether;
  ...
  function deposit(
    ...
    txs[txId] = TX({
      ...
      nftId: nftId,
      user: msg.sender,
      payedDstFee: msg.value==(bridgeFee+dstGasFee)?true:false
    });
    ...
    )
  {
    ...
    payedDstFee = txs[_txId].payedDstFee;
  }
  ...
  function setDstGasFee(uint256 _val) public onlyRole(ADMIN_ROLE){
    dstGasFee = _val;
  }
