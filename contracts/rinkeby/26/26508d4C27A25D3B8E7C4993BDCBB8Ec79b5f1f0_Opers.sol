...
contract Opers is Ownable {
    ...
    function takeAppointment(uint256 _user_id, uint256 _doctor_id, string memory _appointment_date, string memory _appointment_time, string memory _visiting_reason, string 
    ...
    memory _receiver_encryption_key, string[] memory _document_links) public{
        ...
        Appointment memory new_appointment = Appointment(appointment_id_counter, _user_id, _doctor_id, _appointment_date, _appointment_time, _visiting_reason, _sender_encryption_key, _receiver_encryption_key, "Pending");
