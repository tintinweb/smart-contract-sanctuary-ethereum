...
contract POPESRUS is ERC721A, Ownable, ReentrancyGuard
{

    using Strings for string;

    uint public constant MAX_TOKENS = 240000;
    uint public constant NUMBER_RESERVED_TOKENS = 240; 
    ...
    constructor() ERC721A("POPESRUS", "PRU") {}
    ...
    if (msg.sender != owner()) {
        require(msg.value >= PRICE * amount, "Not enough ETH for transaction");
        require(saleIsActive, "Sale must be active to mint");
        require(amount <= MAX_TOKENS, "Exceeded maxMintAmount");
    }
