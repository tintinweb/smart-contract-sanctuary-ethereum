...
contract ERC721ICollection is ERC721i, ERC2981 {
    ...
    constructor(address _owner, string memory _name, string memory _symbol, uint256 _tokenSupply, string memory _baseURI, uint96 _royaltyRate) ERC721i(_name, _symbol, _owner, _tokenSupply) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721iEnumerable, ERC2981) returns (bool) {
        return super.supportsInterface(interfaceId) || ERC2981.supportsInterface(interfaceId);
    }

}

contract ERC721IFactory {
    struct TokenDetails{
    ...
    function createERC721ICollection(string memory _name, string memory _symbol, uint _tokenSupply, string memory _baseURI, uint96 _royaltyRate) external {
        ERC721ICollection token = new ERC721ICollection(msg.sender, _name, _symbol, _tokenSupply, _baseURI, _royaltyRate);
