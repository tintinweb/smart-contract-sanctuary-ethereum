// SPDX-License-Identifier: MIT
  ...
  contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
      ...
      uint256 private constant MAX_TOKENS = 50;
      uint256 private constant NUM_LAYERS = 3;
      uint256[][NUM_LAYERS] private TIERS;
      string[] private LAYER_NAMES = [unicode"Face", unicode"Skin", unicode"Background"];
        
      uint256 public maxPerAddress = 100;
      uint256 public mintPrice = 0.02 ether;
      string public baseURI = "";
      bool public isMintingPaused = true;
      ContractData public contractData = ContractData(unicode"FirstTest", unicode"First test collection in indelibles", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "", 1000, "0x10EC407c925A95FC2Bf145Bc671A733D1fBa347E");

      constructor() ERC721A(unicode"FirstTest", unicode"FTC") {
        TIERS[0] = [1,1,1,1,1,1,2,2,4,4,4,5,7,7,9];
TIERS[1] = [10,16,24];
TIERS[2] = [1,1,2,4,4,5,5,5,6,6,11];
      }
