...
contract ArtHouse is ERC1155Upgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable {
    using Strings for *;
    ...
    function initialize(
        ...
        string calldata baseARURI
    ) initializer public {
        ContractInfo storage _contractInfo = contractInfo;
        
        _contractInfo.name = _name;
        _contractInfo.description = description;
        _contractInfo.externalURL = externalURL;
        _contractInfo.baseARURI = "https://arweave.net/";
    }
...
//         string memory imageARHash,
//         string memory htmlARHash
//     ) public {
//     // ) public onlyOwner {
...
//             imageARHash: imageARHash,
//             htmlARHash: htmlARHash
//         }));
        
//         _mint(msg.sender, tokens.length - 1, 1, new bytes(0));
//     }
...
//         require(amount > 0, "Mint at least one");
//         require(msg.value == (tokenInfo.mintPrice * amount), "Need exact payment");
//         require(amount + totalSupply(tokenId) <= tokenInfo.maxSupply, "Supply limit reached.");
...
// //         string memory escapedText = Utils.escapeHTML(tokenInfo.text);

// //         bytes memory outputBytes = DynamicBuffer.allocate(1024 * 1024);
        
// //         outputBytes.appendSafe(
// // '<svg class="x3fvufWE1e3H1xpo" width="1200" height="1200" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 96 96">'
// //     '<foreignObject x="0" y="0" width="100%" height="100%">'
// //         '<div xmlns="http://www.w3.org/1999/xhtml">'
// //             '<style>'
// //             '.x3fvufWE1e3H1xpo, .x3fvufWE1e3H1xpo * {box-sizing:border-box;margin:0;padding:0;border:0}'
// //             '</style>'
// //         );
        
// //         outputBytes.appendSafe(bytes(escapedText));
...
//         bytes memory imageURI = abi.encodePacked(contractInfo.baseARURI, tokenInfo.imageARHash);
//         bytes memory htmlURI = abi.encodePacked(contractInfo.baseARURI, tokenInfo.htmlARHash);
