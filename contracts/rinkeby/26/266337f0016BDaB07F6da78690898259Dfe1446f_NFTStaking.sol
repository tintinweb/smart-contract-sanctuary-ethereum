...
import "../Deployed/N2DRewards.sol";
import "../Deployed/DiamondSkyline.sol";
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(DiamondSkyline _nft, N2DRewards _token) { 
    nft = _nft;
    token = _token;
  }
...
contract DiamondSkyline is ERC721A, Ownable, ReentrancyGuard {
    // ======== 1. `using` =========
