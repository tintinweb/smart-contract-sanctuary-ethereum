...
contract devalphapineapple20220501 is 
    ERC721, 
    Ownable, 
    ReentrancyGuard, 
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://limbo/hidden.json";
    ...
    uint256 _price = 150000000000000; // 0.15 ETH
    ...
    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("devAlphaPineapple20220501", "dap220501")
    ...
    onlyAccounts
    {
        ...
        require(
            ...
            "NTFG : Impossible Mint"
        );        

        require(
            !_exists(_tokenSelector),
            "NFTG : You can not mint this token."
        );
