...
interface MCCTrade {
    function availablePack(address from) external view returns (uint256);
    ...
    ERC721BurnableUpgradeable
{
    ...
    function mint(
        ...
        require(
            MCCTrade(TradeAddress).availablePack(msg.sender) > 0,
        ...
        MCCTrade(TradeAddress).decreasePack(msg.sender);
