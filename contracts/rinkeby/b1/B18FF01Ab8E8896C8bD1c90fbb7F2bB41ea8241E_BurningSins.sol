...
contract BurningSins is AdminControl, ICreatorExtensionTokenURI {
    ...
    function configure(address marketplace, uint listingId, address burnableContractAddress, uint[] memory burnableTokenIds, address newTokenAddress) public adminRequired {
