...
contract TestTestTest is ERC721A, Ownable {
    ...
    uint256 public constant limitPerWallet = 20;
    ...
    function mint(uint256 amount) external payable callerIsUser {
        ...
        require(amount <= limitPerWallet, "Max mint amount per wallet exceeded.");
        require(numberMinted(msg.sender) + amount <= limitPerWallet, "Max mint amount per wallet exceeded.");
        require(
