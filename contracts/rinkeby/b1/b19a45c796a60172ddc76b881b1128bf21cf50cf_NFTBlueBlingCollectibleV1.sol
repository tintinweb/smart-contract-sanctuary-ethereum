...
contract NFTBlueBlingCollectibleV1 is  ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
...
//Replace Constructor with initialize
  //  constructor(string memory baseURI) ERC721("NFT Collectible Collection", "BlueBlingNFT") {
    // setBaseURI(baseURI);
//}
