...
contract LazyDon is ERC721, Ownable {
  ...
  constructor() ERC721("Lazy Don 1", "LD") {}
  ...
  function mint(uint256 _mintAmount, uint256 _pid) public payable mintCompliance(_mintAmount) {
