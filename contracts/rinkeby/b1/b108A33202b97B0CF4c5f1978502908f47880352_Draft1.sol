...
contract Draft1 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private ownerReservedMint = 20;
    ...
    modifier lessThanMaxPerTx(uint256 quantity) {
        require(
            quantity <= maxPerTx,
            "The maximum number of minted tokens per transaction is 4."
        );
        _;
    }
    ...
    function ownerMint() public onlyOwner {
        _safeMint(msg.sender, ownerReservedMint);
    }
}
