...
contract TheStarslab is ERC721Enumerable, Ownable {
    ...
    address payable private _PaymentAddress1 = payable(0x6de384171bb0c9Bf458c37874Ef6c1f6B2C1A906);
    address payable private _PaymentAddress2 = payable(0x691Bd90a1412095742e86173b3BAAD6610652099);

    uint256 public TSL_MAX = 9999;
    uint256 public PRESALE_PRICE = 0.001 ether; // 0.2 ETH
    uint256 public PUBLIC_PRICE = 0.001 ether; // 0.2 ETH
    uint256 private REVEAL_DELAY = 0 hours;
    uint256 private PRESALE_HOURS = 3 days;
