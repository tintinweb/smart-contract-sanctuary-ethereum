...
contract CollectionFactory is Withdrawable, ERC721A{
  ...
  // NEED TO CHANGE NAME AND TICKER !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    */
    function acceptBid(
      ...
      if(msg.sender == _auctionDetails.artist || msg.sender == _auctionDetails.buyer){
         ...
         mint(_auctionDetails.auctionID, _auctionDetails.tokenURI, _auctionDetails.buyer);
    ...
    */
    function mint(uint256 _auctionId, string memory _tokenURI, address _buyer) internal {
