    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 9, 9) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidavaiwacvflvkbfcym37ua5aeeuu4vws2hm4rjkc7couy32q555a/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 9");
...
contract TestingContract is RamppERC721A {
    constructor() RamppERC721A("TESTING", "TXT"){}
}
