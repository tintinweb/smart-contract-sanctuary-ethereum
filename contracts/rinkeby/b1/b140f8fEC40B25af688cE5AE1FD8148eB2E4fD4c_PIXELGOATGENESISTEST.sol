...
contract PIXELGOATGENESISTEST is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public cost;
  uint256 public finalMaxSupply = 5000;
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    ...
    require(msg.value >= cost * (_mintAmount - free), "PAYMENT: invalid value"); //first free and the rest is paid
