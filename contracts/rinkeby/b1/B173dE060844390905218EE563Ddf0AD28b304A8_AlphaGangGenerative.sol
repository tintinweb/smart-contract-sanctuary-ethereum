...
contract AlphaGangGenerative is ERC721A, Ownable {
    // ref to staking contract is in the ERC721AC
    ...
    address communityWallet = 0x0997C26fC2FdEC68627665a22ACC43c361f504Fe;
    ...
    modifier mintCompliance(uint256 _mintAmount, uint8 mintType) {
        ...
        require(_sender == tx.origin, "EOA only");
    ...
    function ogMint(uint256 _mintAmount, address _owner)
        ...
        returns (uint256)
    {
        require(msg.sender == address(AGStake), "Only staker");
