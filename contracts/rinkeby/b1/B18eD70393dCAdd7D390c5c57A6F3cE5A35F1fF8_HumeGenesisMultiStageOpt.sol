...
/// @param merkleRootPOAP POAP Whitelist Merkle Tree Root hash (can be modified by admin).
/// @param merkleRootMusic Music NFT Whitelist Merkle Tree Root hash (can be modified by admin).
/// @param merkleRootScenesSounds Scenes&Sounds Whitelist Merkle Tree Root hash (can be modified by admin).
...
struct ConstructorConfig {
    ...
    string symbol;
    string baseURI;
    bytes32 merkleRootPOAP;
    bytes32 merkleRootMusic;
    bytes32 merkleRootScenesSounds;
    address admin;
    address owner;
}

/// @title HumeGenesisMultiStageOpt
/// @notice
///
/// <Hume Easter Egg placeholder>
///
/// Represents a Hume Genesis NFT with multiple whitelists with allowance per address
contract HumeGenesisMultiStageOpt is ERC721A, Ownable, Adminable {
    ...
    uint256 public constant GENESIS_PRICE = 1E16; // 0.01ETH
        ...
        ERC721A(config_.name, config_.symbol)
    {
        ...
        // Set Merkle Roots
        merkleRoots[State.PreSalePOAP] = config_.merkleRootPOAP;
        merkleRoots[State.PreSaleMusic] = config_.merkleRootMusic;
        merkleRoots[State.PreSaleScenesSounds] = config_.merkleRootScenesSounds;
