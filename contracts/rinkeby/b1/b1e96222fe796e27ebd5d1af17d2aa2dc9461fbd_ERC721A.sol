...
contract GOBLINBOB is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("GOBLINBOB", "GBOB") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max GOBLINBOB per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 GOBLINBOB" );
		require(s + _mintAmount <= maxFree, "Cant exceed GOBLINBOBS supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 GOBLINBOB");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more GOBLINBOB" );
        require(s + _mintAmount <= maxSupply, "Cant exceed GOBLINBOBS supply");
