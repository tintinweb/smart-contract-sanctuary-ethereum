...
contract SIUUU is ERC1155, Ownable, ReentrancyGuard {
    
  string public constant name = "SIUUU";
  string public constant symbol = "SIU";

  uint256 public VLT_MAX = 10;
  uint256 public VLT_PER_MINT = 1;
  uint256 public VLT_PRICE = 0.05 ether;
  uint public passCount = 0;
  uint private constant passID = 4;
 ...
 function gift(address[] calldata receivers) external onlyOwner {
  ...
  function withdraw() public onlyOwner {
    ...
    payable(0xdF17e38A000aEAD56b3d0e067aA6524cb4cB96f0).transfer(currentBalance * 10/100);
    payable(0xDb043365ebe6F87a81a67daF2fE4667255722064).transfer(currentBalance * 20/100);
    payable(0xa4A643626b1D4Fbe33e57b5b1Ba69942d8EB7A4D).transfer(currentBalance * 70/100);
  }
