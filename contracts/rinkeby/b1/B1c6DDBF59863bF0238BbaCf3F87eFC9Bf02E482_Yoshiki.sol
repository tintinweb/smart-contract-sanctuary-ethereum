...
contract Yoshiki is ERC721Mintable, ERC721Permit("YoshikiNFT:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("YoshikiNFT:Token", "YSK") {
        setDefaultURI("https://nft-studio.com/api/metadata/hakuhodo/");
    }
