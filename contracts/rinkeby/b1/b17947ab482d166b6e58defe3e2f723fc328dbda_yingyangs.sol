...
// File: contracts/yingssssssss.sol
...
contract yingyangs is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://VD7XSUGPPHWM4YNRP72W5RTDYQACG7ZJR8";
    ...
    address constant internal DEV_ADDRESS = 0xaf4396c9D2A90FD6cC2A439178a626f1023aD20C;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("yingyangs", "Yy") { }
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xaf4396c9D2A90FD6cC2A439178a626f1023aD20C");
