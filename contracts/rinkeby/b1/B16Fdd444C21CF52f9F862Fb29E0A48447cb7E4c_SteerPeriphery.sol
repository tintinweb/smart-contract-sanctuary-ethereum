...
/// @notice You can use this contract to enumerate strategy and vault detials but also create, join, and leave vaults
...
interface IUniLiquidityManager is IERC20 {
    ...
    function token0Locked() external view returns (uint256);

    function token1Locked() external view returns (uint256);

    function strategistPromisedT0() external view returns (uint256);

    function strategistPromisedT1() external view returns (uint256);

    function steerPromisedT0() external view returns (uint256);

    function steerPromisedT1() external view returns (uint256);

    function promisedToken0() external view returns (uint256);

    function promisedToken1() external view returns (uint256);

    function LPTqueuedForWithdrawal() external view returns (uint256);

    function getBalance0() external view returns (uint256);

    function getBalance1() external view returns (uint256);

    function currentTransactionIndex() external view returns (uint256);

    function claimableLPT() external view returns (uint256);
