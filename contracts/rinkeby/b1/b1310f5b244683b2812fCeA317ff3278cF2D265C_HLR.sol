...
contract HLR is ERC721, Ownable {


    // Keeping track of supply and displaying it.
    using Counters for Counters.Counter;
    Counters.Counter private testingSupply;
    

    constructor() ERC721("HLR", "HLR") {}
...
//////**************************////
    ...
    function reveal(string memory _revealURI) 
        external 
        onlyOwner 
    {
        baseURI = _revealURI;
    ...
    function setInitialURI(string memory _URI)
        external 
        onlyOwner {
        require (!revealed);
        baseURI=_URI;
