...
contract Hagalaz is ERC721A, Ownable {
    ...
    function setTokenURI(uint256 _tokenToUpdate, address _targetContract, uint256 _targetTokenId) public payable {
        ...
        _indTokenURI[_tokenToUpdate] = fetchTokenURI(_targetContract, _targetTokenId);       
    }

    function fetchTokenURI(address _targetContract, uint256 _targetTokenId) public view returns (string memory) {
        ERC721A targetTokenAddress = ERC721A(_targetContract);
        
        string memory _returnedTokenURI = targetTokenAddress.tokenURI(_targetTokenId);
       
        return _returnedTokenURI;
    }
