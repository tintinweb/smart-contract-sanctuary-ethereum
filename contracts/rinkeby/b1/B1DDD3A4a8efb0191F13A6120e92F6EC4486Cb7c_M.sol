...
contract M is ERC4907A, ERC2981, Ownable {

  uint256 public constant SUPPLY = 1000;

  string public constant PROVENANCE = "2e3a29ce02a5c9736c40243745048503e4365fdc37ed690552878f605ee416da";
  ...
  function reveal(uint256 offset, string memory _baseUri) external onlyOwner whenMetadataNotFrozen {
