...
contract DividendDistributor is IDividendDistributor {
    ...
    //define the token you want to be auto-rewarded    BTCpeg rewards
    IBEP20 REWARD = IBEP20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    //dont change that (:
...
contract BUSD is IBEP20, Auth {
    ...
    //define the token you want to be auto-rewarded busd
    ...
    string constant _name = "BUSDKING";
    //change the token symbol
    string constant _symbol = "BUSDKING";
    //dont change that
    uint8 constant _decimals = 2;

    //defines the total supply --> 100 = 100e8 <-- THE e8 HAS TO BE THERE 69_000_000_000e8;
    ...
    address public marketingFeeReceiver = 0x278B621F97b61eBa16FE368Fbfc6A0f787B346e5;
