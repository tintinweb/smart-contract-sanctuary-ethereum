...
contract SketchGhostSpace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sketch Ghost Space", "SGS") {
    setHiddenMetadataUri("ipfs://QmTDtbBe8fEb7ZxZRSMFANuGpF2oCaG2ethdLd8PdUMTF9K/hidden.json");
  }
