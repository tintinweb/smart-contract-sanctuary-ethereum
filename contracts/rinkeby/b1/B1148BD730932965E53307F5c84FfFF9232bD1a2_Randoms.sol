...
contract Randoms is ERC721,ERC721Enumerable,Ownable {
    using Strings for uint256;
        ...
        string public unrevealedBaseURI_="ftp";
        ...
        function _unrevealedBaseURI() internal view returns (string memory) {
            return unrevealedBaseURI_;
        }
        function setUnrevealedBaseURI(string calldata UnrevealedBaseURI) external onlyOwner{
            
        unrevealedBaseURI_ = UnrevealedBaseURI;
        }
