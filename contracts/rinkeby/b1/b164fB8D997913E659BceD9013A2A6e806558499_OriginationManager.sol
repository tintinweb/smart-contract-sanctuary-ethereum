...
interface IOriginationManager {
     ...
     * - The external signer must be msg.sender
     * - The external signer must be a borrower 
     * @param loanTerms - struct containing specifics of loan made between lender and borrower
     * @param borrowerPrimaryAddress - address of Primary wallet of borrower
     * @param borrowerSecondaryAddress - address of Secondary wallet of borrower
     * @param lenderPrimaryAddress - address of lender
     * @param tokenType - type of NFT token ERC721 - 0, ERC1155 - 1
