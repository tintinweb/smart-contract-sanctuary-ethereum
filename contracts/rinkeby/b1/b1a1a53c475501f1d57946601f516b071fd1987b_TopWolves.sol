...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
    ...
    //constructor() {
    //    _setupRole(0x00, 0xa3846fcf6F82709eAC719c230f423CfBe69Fd6C2);
    //}
...
contract TopWolves is ERC721, ReentrancyGuard, AccessControl {
    ...
    uint16 public freemintgiveawaylimit = 100;
    ...
    constructor() ERC721("TopWolves", "TW") {
        for (uint16 i = 0; i < freemintgiveawaylimit; i++) {
            _tokenId++;
            _safeMint(teamWalletAddress, _tokenId);
        }
        totalLimit -= freemintgiveawaylimit;
