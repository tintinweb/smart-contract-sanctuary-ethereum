...
contract RAUNFT is ERC1155, Ownable {
    ...
    constructor()
        ERC1155("https://bafybeiax462qikrxczhydeokstxfd2nnrmpxcyaui24xl62rmspdgymb6q.ipfs.dweb.link/{id}.json")
    {
        ...
        _mint(msg.sender, 6, 100, "");
        _mint(msg.sender, 7, 100, "");
        _mint(msg.sender, 8, 100, "");
        _mint(msg.sender, 9, 100, "");
    }
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        return (
            string(
                abi.encodePacked(
                    "https://bafybeiax462qikrxczhydeokstxfd2nnrmpxcyaui24xl62rmspdgymb6q.ipfs.dweb.link/",
