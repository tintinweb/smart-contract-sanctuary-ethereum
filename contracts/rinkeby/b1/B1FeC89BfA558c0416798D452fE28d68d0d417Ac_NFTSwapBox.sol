  ...
  Ownable
{
    ...
    function addWhiteListNFT(address erc721Token) external onlyOwner {
        whitelistNFT[erc721Token] = true;
    }
    ...
    function _checkAssets(
        ...
        for (uint256 i = 0; i < erc721Details.length; i++) {
            ...
            require(whitelistNFT[erc721Details[i].tokenAddr], "Not allowed ERC721 tokens");
