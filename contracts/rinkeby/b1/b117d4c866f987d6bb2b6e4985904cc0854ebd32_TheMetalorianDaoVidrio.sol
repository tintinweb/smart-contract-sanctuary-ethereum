...
// File: contracts/theMetalorianDaoVidrio.sol
...
///@title TheMetalorianDaoVidrio
///@notice Token ERC721 for the life Out 
contract TheMetalorianDaoVidrio is ERC721, Ownable {   
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian Dao Vidrio", "TMDV") {
    ...
    event MintTheMetalorianDaoVidrio(address indexed user, uint256 tokenId); 
   ...
   /// =========================================================
    ...
    function mintTheMetalorianDaoVidrio(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDaoVidrio(msg.sender, tokenIdCounter.current());            
