...
contract AtomicSwapERC20ToERC20 {
  ...
  function open(bytes32 _swapID, uint256 _openValue, address _openTrader, address _openContractAddress, uint256 _closeValue, address _closeTrader, address _closeContractAddress) public onlyInvalidSwaps(_swapID) {
