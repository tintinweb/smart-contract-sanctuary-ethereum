...
🔥 Telegram: https://t.me/SpaceWormPortal

🐦 Twitter: https://twitter.com/SpaceWormETH

🌐 Website: https://SpaceWorm.army

    Linktree: https://linktr.ee/spacewormeth
                    ...
                    ██░░  ░░░░░░  ░░██
                      ██░░      ░░██
                        ...
                        $WORM Features:
                            - On Launch
                                - Buy tax:
                                    - 3% Burn (tokens instantly deleted from existence+supply)
                                    - 2% Marketing (to ensure project longevity)
                                ...
                                - Sell tax:
                                    ...
                                    - 3% Marketing (to help promote the token further if sells are occuring)
                                    - 1% Liquidity
...
contract SpaceWorm is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SpaceWorm", "$WORM") {
        ...
        uint256 totalSupply = 1100000 * (10 ** 18);
        supply += totalSupply;
        ...
        marketingAddress = 0x35F6F6c131c2B1d6FbB58F011bFCC4b232bcAB37;
