...
contract SharkzSoulBadge is IScore, Adminable, ReentrancyGuard, EIP712Whitelist, ERC5114SoulBadge {
    ...
    constructor(string memory _name, string memory _symbol, string memory _collectionUri, string memory _baseUri) 
        ERC5114SoulBadge(_name, _symbol, _collectionUri, _baseUri) 
        EIP712Whitelist() 
    {
