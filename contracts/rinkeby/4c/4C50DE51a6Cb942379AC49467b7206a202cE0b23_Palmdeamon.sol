...
contract Palmdeamon is ERC721, Metadata {
    ...
    constructor(address _admin) ERC721("Seedcapital", "SDC") {
        admin = _admin;
    }
    ...
    function mintafterverification(
        ...
        tokendata[tokenid].rtimestamp = rtimetamp;
...
contract Metadata is GenerativeSvg {
    function generatemetadata(
        ...
        string memory attributes = generateattributes(
            ...
            cschemes[locationcolor].currator
        );
...
contract GenerativeSvg {
    ...
    constructor() {
        cschemes[0].firsthex = '#FF4000';
        cschemes[0].secondhex = '#12491D';
        cschemes[0].venue = 'Art Dubai';
        cschemes[0].plant = 'Pachira aquatica';
        cschemes[0].currator = 'Fingerprints DAO';

        cschemes[1].firsthex = '#ffea00';
        cschemes[1].secondhex = '#481249';
        cschemes[1].venue = 'MOMA';
        cschemes[1].plant = 'Pachira aquatica';
        cschemes[1].currator = 'Proof of Art';


        cschemes[2].firsthex = '#167d5e';
        cschemes[2].secondhex = '#5e67b0';
        cschemes[2].venue = 'Neue Nationalgallerie';
        cschemes[2].plant = 'Pachira aquatica';
        cschemes[2].currator = 'terra0 retrospective';
        mapfactor = 100;
    }
    ...
    function _generatecolorprofile(
        ...
        cschemes[profile].currator = currator;
    }
        ...
        returns (string memory)
    {
        ...
        string memory l = Strings.toString(
            mapvalue(temp, 18000, 24000, 50, 100)
        );
    ...
    function gradienty(uint256 temp) internal view returns (string memory) {
        return Strings.toString(mapvalue(temp, 18000, 24000, 300, 1000));
    }
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    " ",
                    Strings.toString(
                       580 - (mapvalue(temperature, 18000, 24000, 245, 580) - 245)
                    ),
    ...
    function buildtemperatur(uint256 temperature)
        internal
        pure
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    cschemes[colorpointer].currator,
                    "</tspan></text>"
                )
            );
    }
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    Strings.toString(
                        650 - mapvalue(temp, 18000, 24000, 250, 390)
                    ),
                    ")' fill='#EBEBEB' font-family='Courier, monospace' font-size='49'>_</text>"
                )
            );
