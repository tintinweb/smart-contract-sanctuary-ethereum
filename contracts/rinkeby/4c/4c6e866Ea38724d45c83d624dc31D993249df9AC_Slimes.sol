...
contract Slimes is ERC721, ERC721Burnable, Ownable {
    ...
    uint256 public constant maxSupply = 988; // 9888
    uint256 public maxTotalFreeMint = 300; // 3000
    uint256 private constant maxReserved = 30; // 300
    ...
    // Team
    address cyrus     = 0x4EDC454B22adAB27c2367EaF992d4a0F29E9Dbd7;
    address ardie     = 0xD516CB9A19A592473c8A321d4Ab52bc8F1eC065f;
    address eugene    = 0x5FeBEfe0AB7b7a097548ab3259De8Ab2B62a89c8;
    address slimesDAO = 0x203e03A5d153393774C76E7fb4Df035405C4d9d9;
    address slimes    = 0x5989757c436311a9E70403a3Ccc24B77eC2324ca;


    constructor() ERC721("SLIMES Alpha", "SLIMER") { }
    ...
    */
    function mint(uint256 amount) public payable {
        ...
        uint256 reserveMinted = _reserveMinted.current();
        require(saleStart, "SALE PAUSED");
        require((totalIssued.add(amount) - reserveMinted) <= (maxSupply - maxReserved));
    ...
    function mintReserved(uint256 amount, address receiver) public onlyOwner {
        uint256 totalIssued = _tokenIds.current();
        require(totalIssued.add(amount) <= maxSupply);
