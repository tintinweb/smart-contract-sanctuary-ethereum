...
contract LiquidityAndStakingV1 is OwnableUpgradeable{
    ...
    function initialize() public initializer {
        ...
        liqRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        factory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;
        GainTokenAddress = 0xE43912D2024C35f3b6807fB50843149F87d7104e;
    ...
    function updateGLWallet(address _address)
        external onlyOwner {
        GLWallet = _address;
    }
    ...
    function addLiquidityFromContract(
        ...
        tokenAddressB.approve(liqRouterAddress, IERC20(tokenAddress).balanceOf(address(this)));
    ...
    function swapFromContract(
        ...
        tokenAddress_.approve(liqRouterAddress, IERC20(tokenAddress).balanceOf(address(this)));
    ...
    function tokenSwap(address pair1, address pair2) external onlyOwner returns(bool){
        ...
        tokenAddress.approve(liqRouterAddress, IERC20(tokenAddress).balanceOf(address(this)));
            
        (amountsPair1) = swapFromContract(pair1, amount, PAIR1_GAIN, address(this), deadline);
        addLiquidityFromContract(pair1, amount, amountsPair1[1], 1, 1, GLWallet, deadline);
        (amountsPair2) = swapFromContract(pair2, amount, PAIR2_GAIN, address(this), deadline);
        addLiquidityFromContract(pair2, amount, amountsPair2[1], 1, 1, GLWallet, deadline);
