...
contract LLCollection is ERC721Enumerable, Ownable, RoyaltiesV2Impl, Pausable {
    /******************************/
    /**    State Variables       **/
    /******************************/
    ...
    /**    Events                **/
    /******************************/
    event Revealed(address indexed account);
    ...
    function mintByOwner(address _to) external onlyOwner {
    ...
    function mintNFT(uint256 _numOfTokens) public payable {
        require(
            msg.value >= NFTPrice * _numOfTokens,
        ...
        returns (string memory)
    {
        require(
            _exists(_tokenId),
            "Lynchs Locks: URI query for nonexistent token"
        );
        if (!reveal) {
            return blindURI;
        } else {
