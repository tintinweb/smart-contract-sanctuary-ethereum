...
contract GameToken is ERC721Enumerable, Ownable {
    ...
    uint256 public startingPrice = 0.1 ether;
    uint256 public priceIncrement = 0.025 ether;
    uint256 public maxPerTier = 1000;
    uint256 public constant maxMintsPerTransaction = 2;

    uint256 private adminMinted;
    uint256 private whitelistsMinted;
    uint256 private bronzelistsMinted;
    ...
    function mintPrice() public view virtual returns (uint256) {
        uint tier = totalSupply() / maxPerTier;
