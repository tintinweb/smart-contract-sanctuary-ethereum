...
contract MER1155 is ERC1155, Ownable , Pausable {
  ...
  function airDrop(address recipient ,uint _id, uint _amount) external  onlyOwner
    {
       _mint(recipient, _id, _amount, "");
        airDroppedTokens[_id] = true;
    }

  function setNFTPrice(uint _id ,uint256 _mintValue) external  onlyOwner 
    {
