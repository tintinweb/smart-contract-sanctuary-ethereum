...
contract NFTSwapBox is ReentrancyGuard, Ownable, INFTSwap {
    ...
    uint64[] public swapFees = [0.0001 ether, 0.0002 ether, 0.0003 ether, 0.0004 ether, 0.0005 ether];
    bool openSwap = false;
    ...
    function createBox(
        ...
        payable(NFTSwap).transfer(gasTokenAmount);
        ...
        payable
    {
        ...
        require(msg.value >= swapFees[4], "Insufficient Swap Fee");

        swapOwner.transfer(swapFees[4]);
