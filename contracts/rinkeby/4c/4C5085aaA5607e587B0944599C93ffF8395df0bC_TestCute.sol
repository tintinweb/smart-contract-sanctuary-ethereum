...
contract TestCute is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 4444;
    uint256 Allremain = 4444;
    uint256 public mintRate = 0.004 ether; 
    uint256 MintForWallet = 4444;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = "ipfs://QmXYXt7tH4f9GpZdM6xxsjFXAGbLguSsfzm1P3751Y8xX9/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("Test Cute", "TCUTE") {}
