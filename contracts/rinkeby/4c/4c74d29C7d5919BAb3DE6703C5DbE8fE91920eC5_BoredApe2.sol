    ...
    PaymentSplitter 
{
    ...
    address[] private _team = [
        0x88Ea5cbb15Fc039D02cfBa387d27a1c7bfA92e4F, // Admin Account gets 25% of the total revenue
        0x41A22780797839809286Ee5F41534b366F3b3892, // Test Account gets 35% of the total revenue
        0x51dDA16fBDc4aD96bF7dC5A50d254fCf791F868E // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("BoredApe2", "APE")
