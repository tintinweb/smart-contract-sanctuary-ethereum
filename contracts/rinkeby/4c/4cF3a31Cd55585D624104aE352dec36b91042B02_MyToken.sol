...
contract MyToken is ERC20, Ownable {
    ...
    constructor(string memory _name, string memory symbol, address _reciever) ERC20(_name, symbol) {
        _mint(_reciever, 200 * 10 ** decimals());
    }
    ...
    function faucet() external {
        ...
        addressTime[msg.sender] = block.timestamp + 30 seconds;
    }

    //airdrop
    function airdrop(address[] memory _airdrops) public {
