...
contract Staker {
    ...
    function withdraw() external exceededDeadline thresholdNotReached notCompleted {

        require(openForWithdraw == true, "You aren't allowed to withdraw yet.");
        require(balances[msg.sender] != 0, "User's balance is 0, can't withdraw.");
