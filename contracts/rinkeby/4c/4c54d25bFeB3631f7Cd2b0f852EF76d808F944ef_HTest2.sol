...
contract HTest2 is ERC721AQueryable, ERC2981 , Ownable, Pausable {//ここを書き換える
    ...
    uint256 public publicCost = 0.006 ether;//ここを書き換える
    ...
    uint256 constant public mintLimitH = 3;//ここを書き換える
    uint256 constant public mintLimitG = 2;//ここを書き換える
    uint256 constant public mintLimitP = 2;//ここを書き換える

    mapping(address => uint256) public MintedH; 
    mapping(address => uint256) public MintedG; 
    mapping(address => uint256) public MintedP; 

    bytes32 public merkleRootH;
    bytes32 public merkleRootG;
 
    constructor(
    ) ERC721A("HTest2","HTV2") {//ここを書き換える
    ...
    function publicMint(uint256 _mintAmount) public payable whenNotPaused {
        ...
        require(_mintAmount <= mintLimitP, "Mint amount over");
    ...
    function HPassMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable whenNotPaused {
        ...
        require(mintLimitH >= MintedH[msg.sender] + _mintAmount, "You have no Mint left");
    ...
    function GPassMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable whenNotPaused {
        ...
        require(mintLimitG >= MintedG[msg.sender] + _mintAmount, "You have no Mint left");
