...
contract LolClub is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 8000;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmaznXoK8peMcXZo23zwUfVsZFJXW5WJdKHvtQZL6z7BXA/";
    string public baseExtension = "";
     bool public paused = false;   
    
     constructor() ERC721A("Lol Club", "Lolclub", MAX_MINTS, MAX_SUPPLY) {  
    }
