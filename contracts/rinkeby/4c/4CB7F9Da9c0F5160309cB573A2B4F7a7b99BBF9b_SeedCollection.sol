    ...
    Ownable
{
    ...
    constructor(uint256 price_, string memory uri_) ERC1155(uri_) {
        _price = price_;
    ...
    function redeem(
        ...
        uint256 mintPrice = _price * amount;
    ...
    function mintBatch(address[] calldata accounts, uint256[] calldata amounts)
        public
        onlyOwner
    {
