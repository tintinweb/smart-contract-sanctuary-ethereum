...
state variables, events, modifiers, constructor and functions.
*/
...
contract InfinitePressure is ERC721Enumerable, Ownable {    
  ...
  // Rinkeby
  address private constant AUCTION_HOUSE_ADDRESS = 0xca8b41FAb70B6FC7a6BfD0f2Bb285bc47c392C02;
  // Mainnet
  // address private constant AUCTION_HOUSE_ADDRESS = 0x25d1EBa8180982bB9b4F59108F11A777F728fb5f;

  event PermanentURI(string _value, uint256 indexed _id);
  
  constructor(address _proxyRegistryAddress) 
    ERC721("Infinite Pressure by Chuck Anderson", "INFPRS") 
  {
    ...
    // Authorize AuctionHouse to transfer tokens
    setApprovalForAll(AUCTION_HOUSE_ADDRESS, true);
  }
