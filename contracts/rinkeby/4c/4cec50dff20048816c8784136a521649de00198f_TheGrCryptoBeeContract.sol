...
//*********************************************************************//
//
// 88888888888 888                     .d8888b.  8888888b.        .d8888b.                            888            888888b.                     
//     888     888                    d88P  Y88b 888   Y88b      d88P  Y88b                           888            888  "88b                    
//     888     888                    888    888 888    888      888    888                           888            888  .88P                    
//     888     88888b.   .d88b.       888        888   d88P      888        888d888 888  888 88888b.  888888 .d88b.  8888888K.   .d88b.   .d88b.  
//     888     888 "88b d8P  Y8b      888  88888 8888888P"       888        888P"   888  888 888 "88b 888   d88""88b 888  "Y88b d8P  Y8b d8P  Y8b 
//     888     888  888 88888888      888    888 888 T88b        888    888 888     888  888 888  888 888   888  888 888    888 88888888 88888888 
//     888     888  888 Y8b.          Y88b  d88P 888  T88b       Y88b  d88P 888     Y88b 888 888 d88P Y88b. Y88..88P 888   d88P Y8b.     Y8b.     
//     888     888  888  "Y8888        "Y8888P88 888   T88b       "Y8888P"  888      "Y88888 88888P"   "Y888 "Y88P"  8888888P"   "Y8888   "Y8888  
//                                                                                       888 888                                                  
//                                                                                  Y8b d88P 888                                                  
//                                                                                   "Y88P"  888                                                  
//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC23Cf23584458D9DaEEb1Fd73e809a61b50608BC,0x7733BAfD0fEcb0aE3f43AAD425Fdf892E4B4ea6b,0x7A2DF722BbD935eFcC8302f6b28438a38b5350e7];
  uint256[] public payableFees = [5,50,35,10];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 15000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmY3JzRFj5XRpCk8p6tUVtHxDWYxrnZbr5L5h77ZPc7RfU/";

    bool public mintingOpen = false;
    
    uint256 public PRICE = 0.03 ether;
    
    uint256 public MAX_WALLET_MINTS = 15;
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 15000");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 15000");
...
// File: contracts/TheGrCryptoBeeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheGrCryptoBeeContract is RamppERC721A {
    constructor() RamppERC721A("The GR CryptoBee", "TGRCBEE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/3h1YcMwOJZAOdoHvc5Ol/contract-metadata";
    }
}
