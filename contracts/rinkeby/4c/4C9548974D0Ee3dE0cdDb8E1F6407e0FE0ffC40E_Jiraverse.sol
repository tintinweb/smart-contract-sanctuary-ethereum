...
contract Jiraverse is ERC721A, Ownable {
    ...
    // TODO : Update with correct base uri
    string public base_uri = "";

    // TODO : Update with correct JIRA token address
    ...
    address public constant JIRA_TOKEN_ADDRESS = 0xd9145CCE52D386f254917e481eB44e9943F39138;
    uint public constant JIRA_TOKEN_DECIMALS = 10 ** 18;
    ...
    function gen1Mint(uint _quantity, bytes32 [] calldata _gen1_merkle_proof, uint _gen1_allocation) external {
        ...
        require(_totalMinted() + _quantity * 2 <= 10000, "Not enough tokens left to mint");
        ...
        IERC20(JIRA_TOKEN_ADDRESS).transferFrom(msg.sender, address(this), 200 * JIRA_TOKEN_DECIMALS * _quantity);
    ...
    function gen2Mint(uint _quantity, bytes32 [] calldata _gen2_merkle_proof, uint _gen2_allocation) external {
        require(tx.origin == msg.sender);
        require(private_sale_running, "Private sale is not running");
        require(_totalMinted() + _quantity <= 10000, "Not enough tokens left to mint");
    ...
    function publicMint(uint _quantity) external payable {
        ...
        require(_numberMinted(msg.sender) + _quantity <= 3, "Cannot mint more than 3 total");
    ...
    function withdrawJIRA(address _to, uint _quantity) external onlyOwner {
        IERC20(JIRA_TOKEN_ADDRESS).transferFrom(address(this), _to, _quantity);
    }
}
