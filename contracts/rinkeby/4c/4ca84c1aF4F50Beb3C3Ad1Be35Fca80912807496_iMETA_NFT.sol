...
contract iMETA_NFT is Initializable, UUPSUpgradeable, OwnableUpgradeable, ERC1155Upgradeable {
    ...
    //NFT 민팅
    function mintQuad(uint256 id, uint256 amount, bytes memory data) public onlyOwner returns(uint) {
        _tokenIds.increment();
    ...
    function uri(uint256 quadId) public view virtual override returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "https://ipfs.io/ipfs/QmYPSJ5rLeviyDuszcZfJ3rxHa7qJdwH7fRSQH2bnq6HdF/",
