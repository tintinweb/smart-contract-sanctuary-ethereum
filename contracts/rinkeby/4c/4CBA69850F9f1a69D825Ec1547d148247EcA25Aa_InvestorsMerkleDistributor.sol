...
contract InvestorsMerkleDistributor is Ownable {
    address public immutable  token;
    bytes32 public immutable  merkleRoot;
    uint256 lock = 9 hours;
    uint256 startTime;
    struct UserInfo {
        uint256 amount;
        uint256 reward;
    ...
    function getReward(address account) public view returns (uint256) {
        ...
        shouldReward = shouldReward < userInfo[account].amount ? shouldReward:userInfo[account].amount;
