...
//*********************************************************************//
//
// BEARPEPES! 50% OF THE MINT WILL BE DONATED TO"Multidisciplinary Association for Psychedelic Studies"
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x3B180B54D301e149600Ca7B59bcca8404414f653];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x3B180B54D301e149600Ca7B59bcca8404414f653;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeidn5s2g744sbfw2dp7iagncnlowcdk6n3et4e5xkhfh3leqpmw37e/";
...
// File: contracts/BearPepesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BearPepesContract is RamppERC721A {
    constructor() RamppERC721A("Bear Pepes", "BEPES"){}
}
