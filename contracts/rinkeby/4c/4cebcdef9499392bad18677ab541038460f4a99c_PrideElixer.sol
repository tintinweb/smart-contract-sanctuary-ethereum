...
contract PrideElixer is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public publicSupply = 50;
    uint256 public whiteListSupply = 5;
    uint256 public RESERVE_SUPPLY = 10;

    //limits
    uint256 public maxMintAmountPerWallet = 4;
    uint256 public maxMintAmountPerWhitelist = 1;
 ...
 // =============================================================================//
  ...
  // =============================================================================//
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        (bool hs, ) = payable(WALLET_A).call{value: balance * 7 / 100}("");
