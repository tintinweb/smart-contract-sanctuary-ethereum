...
//    brands, or other intellectual property associated with                                               //
//    project/publisher organization.                                                                      //
//                                                                                                         //
...
//    non-exclusive, license to use, copy, display, modify, and create derivative works from the           //
//    specific art associated with the NFT which you own, subject to the restrictions described in         //
//    Section 2.4 below.                                                                                   //
//                                                                                                         //
//    2.2 You may NOT use this commercial license for economic activity royalty free, subject to           //
//    the usage limitations described in Section 2.4 below.                                                //
//                                                                                                         //
