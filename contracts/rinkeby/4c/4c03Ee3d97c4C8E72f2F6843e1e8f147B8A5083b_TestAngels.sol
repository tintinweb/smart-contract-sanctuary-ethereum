...
IRoyalties
{
    ...
    uint256 public LAST_LOCKED_TOKEN_ID;
    uint256 public VALUE_ADD_TRANSFER_LOCK_TIMESTAMP;
    ...
    function setPreSaleMaxPerWallet(uint256 newValue) external onlyOwner {
        MAX_PRE_SALE_MINT_PER_ADDRESS = newValue;
    }

    function setMaxPerTransaction(uint256 newValue) external onlyOwner {
        MAX_MINT_PER_TRANSACTION = newValue;
    }

    function setLastLockedTokenId(uint256 newValue) external onlyOwner {
        LAST_LOCKED_TOKEN_ID = newValue;
    }

    function setValueAddTransferLockTimestamp(uint256 newValue) external onlyOwner {
        VALUE_ADD_TRANSFER_LOCK_TIMESTAMP = newValue;
    }
...
contract TestAngels is ERC721Collection {
    constructor(
        string memory name,
        string memory symbol,
        uint256 price,
