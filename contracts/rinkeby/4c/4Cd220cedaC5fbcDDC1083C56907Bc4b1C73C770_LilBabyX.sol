...
contract LilBabyX is ERC721, Ownable, IMintedBeforeReveal {
    ...
    function FreeMint(uint256 numberOfTokens) public {
       ...
       //Send Token
        ILilBanana(LILBANANA_ADDRESS).transferFrom(msg.sender, 0x2F941703BC94b66e238D4A04E374727632629B0F, BASE_LILBANANA_COST);
      ...
      function reserveGiveaway(uint256 numTokens) public onlyOwner {
       ...
       function setPrice(uint256 _newPrice) public onlyOwner() {
        _price = _newPrice;
           ...
           function setPriceInTokens(uint256 _newPriceInTokens) public onlyOwner() {
        BASE_LILBANANA_COST = _newPriceInTokens;
    }
