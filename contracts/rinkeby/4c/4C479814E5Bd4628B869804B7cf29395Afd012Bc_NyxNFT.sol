...
{
    // string public constant NFT_METADATA_URL = "https://infura-ipfs.io/ipfs/Qmb9uKYahMUFxxcJjNxyP7xPtoCbfpi1XBjRmXeQ1yGMWJ?filename=nyxlogo";
    uint256 public MAX_SUPPLY = 5555;
    uint256 public constant NYX_MINT_FEE_PCT = 10;
    uint256 public constant NYX_PREMINT_PCT = 10;
    uint256 public max_holding = 2;
    uint256 public max_holding_whitelist = 5;
    uint256 public max_holding_sec_mkt = 20;
    uint256 public MAX_WHITELISTED = 5555;
    // QU EST CE QU ON GARDE ET QU ES CE QU ON ENLEVE ? 
        ...
        public onlyOwner
    {
        ...
        require(burn_amount > 0, "Nothing to burn");
