...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    constructor(
        ...
        uint256 mintFee
    ) VRFConsumerBaseV2(vrfCoordinator) ERC721("Random NFT", "RN") {
        i_vrfCoordinator = VRFCoordinatorV2Interface(vrfCoordinator);
        i_subscriptionId = subscriptionId;
        i_gasLane = gasLane;
        i_callbackGasLimit = callbackGasLimit;
        dog_tokenUris = dogTokenUris;
        i_mintFee = mintFee;
    }
        ...
        override
    {
        ...
        Breed dogBreed = getBreedFromModedRng(modedRng);
        s_tokenCounter += 1;
        _safeMint(dogOwner, newToken);
        _setTokenURI(newToken, dog_tokenUris[uint256(dogBreed)]);
