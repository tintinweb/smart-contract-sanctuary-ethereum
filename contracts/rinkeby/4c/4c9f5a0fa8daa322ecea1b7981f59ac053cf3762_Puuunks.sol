    ...
    Ownable
{
    ...
    function _mint() internal {
        ...
        tokenWidth[nextMint] = rand(1250) + 750 ;
    ...
    function claimTokenByPunkId(uint256 id) external nonReentrant callerIsUser {
        ...
        tokenList[id] = true;
        tokenWidth[id] = rand(1250) + 750;
        _safeMint(msg.sender, id);
    }
    // claim a few tokens if you are a Lockout holder
    function claimTokenByLockoutId(uint256 id) external payable nonReentrant callerIsUser {
        require(
            balanceOf(msg.sender) + 5 <= 75,
            "you own too many"
        );
    ...
    function claimTokenByMessageId(uint256 id) external payable nonReentrant callerIsUser {
        require(
            balanceOf(msg.sender) + 5  <= 75,
            "you own too many"
        );
    ...
    function claimTokenByMountainId(uint256 id) external payable nonReentrant callerIsUser {
        require(
            balanceOf(msg.sender) + 5  <= 75,
            "you own too many"
        );
        ...
        returns (string memory)
    {
        ...
        trait = string.concat(trait,',{"trait_type": "Width","value": "',  Strings.toString((newWidth/500)*100)  , ' %"}');
