...
contract Token is Ownable, ERC721A, ReentrancyGuard {
    ...
    ERC721A public constant genesisToken = ERC721A(0x8c8130CEcC564706D0504b78aD3BF1EfcC46Cf32);

    mapping(uint256 => bool) private usedGenesisTokens;
    ...
    modifier holdsGenesisToken() {
        require(
            genesisToken.balanceOf(msg.sender) > 0,
            "you must hold at least one genesis token"
        );
        _;
    }
    ...
    function usedGenesisToken(uint256 tokenId) external view returns (bool) {
        return usedGenesisTokens[tokenId];
    }
