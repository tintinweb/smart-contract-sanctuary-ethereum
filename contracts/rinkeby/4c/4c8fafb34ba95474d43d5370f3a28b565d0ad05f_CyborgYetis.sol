...
contract CyborgYetis is ERC721I, Ownable {
    ...
    // Interfaces
    IERC721 public SpaceYetis = IERC721(0xDf5bAe8cCceE441a52ee6E44873b04ca31288B48);
    iPlasma public Plasma = iPlasma(0xAfDdf74AC74C73Eef14C4e1063333D26858CE3f1);
    ...
    // Fusion Mechanism
    function fusion(uint256 parent1_, uint256 parent2_, uint256 amount_) external {
