...
contract PokerGene is ERC721, Ownable {
    ...
    uint256 public MAX_PER_PUBLIC_MINT = 2;
        ...
        ERC721("PokerGene", "POKERGENE")
    {
        ...
        // tokenIds is initialized to 1, since starting at 0 leads to higher gas cost for the first minter
        _tokenIds.increment();
        setBaseURI(baseURI);
    }
    ...
    function _mintSingleNFT(address _toAddress) private {
        uint256 newTokenID = _tokenIds.current();
        _tokenIds.increment();
        _safeMint(_toAddress, newTokenID);
    }
