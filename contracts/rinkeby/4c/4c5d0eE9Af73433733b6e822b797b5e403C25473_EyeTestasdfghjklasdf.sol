...
contract EyeTestasdfghjklasdf is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    require(hs);
    // =============================================================================
    // Charity Wallet, 30% Mint
    (bool cs, ) = payable(0x130dA24f1fa352632D79D02a95eE3c9faf1b9A98).call{value: address(this).balance * 30 / 100}('');
    require(cs);
