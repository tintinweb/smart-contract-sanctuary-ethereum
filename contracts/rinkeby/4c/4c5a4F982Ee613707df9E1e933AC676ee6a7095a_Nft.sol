...
contract Nft is ERC721A("Non Fungible Token", "NFT") {
    string public baseURI = "ipfs://QmUo7f95BgJDVZDVygRVMy638YpZDVsJYqNVQCvmP3LctT/";
    ...
    function addToAllowlist(address[] calldata addresses, bool _add) external onlyOwner {
    ...
    // Opensea Registerar Polygon Testnet (Not sure) 0xFd71Dc9721d9ddCF0480A582927c3dCd42f3064C
    address openSeaRegistrar = 0xF57B2c51dED3A29e6891aba85459d600256Cf317;
...
interface ProxyRegisterar {
    function proxies(address) view external returns(address);
}