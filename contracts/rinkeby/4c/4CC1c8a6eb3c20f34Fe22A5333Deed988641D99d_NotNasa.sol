    ...
    PaymentSplitter
{
    ...
    uint256 public constant PRESALE_PRICE = 140000000000000000; // 0.14 ETH
    uint256 public constant PUBLIC_PRICE = 200000000000000000; // 0.2 ETH
    uint256 public constant MAX_SUPPLY_PLUS_TWO = 1113; // real max supply is 1111
    ...
    function mint(uint256 count) external payable nonReentrant {
        ...
        require(supply + count < MAX_SUPPLY_PLUS_TWO, "Max supply reached");
    ...
    function allowlistMint(bytes32[] calldata proof, uint256 allowance)
        external
        payable
        nonReentrant
    {
        ...
        require(
            addressToMinted[msg.sender] + 1 <= allowance,
            "Exceeds allowlist supply"
        );
        uint256 supply = _owners.length;
        require(supply + 1 < MAX_SUPPLY_PLUS_TWO, "Max supply reached");
        require(PRESALE_PRICE * 1 <= msg.value, "Invalid funds provided");
