...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Epic", "Fantastic", "Crude", "Crazy", "Very", "Grand"];
  string[] secondWords = ["Meta", "Live", "Pop", "Cute", "Sweet", "Long"];
  string[] thirdWords = ["Tiger", "Dog", "Monkey", "Panda", "Animals", "Turtle"];
