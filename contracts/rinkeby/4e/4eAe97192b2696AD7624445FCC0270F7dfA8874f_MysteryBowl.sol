    ...
    */
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64Upgradeable.encode(
            bytes(
                string(abi.encodePacked("{\"name\": \"Bowl #", StringsUpgradeable.toString(_tokenId), "\", \"image\":\"", bowlImage, "\", \"attributes\": [{\"trait_type\":  \"Can Summon Anomura\",\"value\":\"", bowls[_tokenId] == true ? "true" : "false","\"}, {\"trait_type\":  \"Starfish\",\"value\":\"", StringsUpgradeable.toString(starfish(_tokenId)),"\"}]""}"))
                )
        );
