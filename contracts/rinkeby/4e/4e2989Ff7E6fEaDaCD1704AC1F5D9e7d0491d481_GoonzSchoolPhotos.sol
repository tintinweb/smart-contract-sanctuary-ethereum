...
contract GoonzSchoolPhotos is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function ownerOf(uint256 tokenId) public view virtual override returns (address owner) {
        ...
        if (owner == portalGoonz) {
            console.log("checking to see who owns portal goon token id %s", tokenId);
    ...
    function initializeBulk(uint256 start_, uint256 end_) external onlyOwner {
        emit ConsecutiveTransfer(start_, end_, address(0), address(this));
    }
    
    function initializeBulkTo(uint256 start_, uint256 end_, address to_) external onlyOwner  {
