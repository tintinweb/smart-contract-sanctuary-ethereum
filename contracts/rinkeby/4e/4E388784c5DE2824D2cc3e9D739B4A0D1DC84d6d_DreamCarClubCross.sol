...
import "./DreamCarClub.sol";

// @author: olive

contract DreamCarClubCross is Ownable {
    ...
    DreamCarClub public dreamCarClub;
    ...
    modifier saleIsOpen() {
        require(!PAUSE, "DreamCarClubCross: Sales not open");
        _;
    }

    constructor(DreamCarClub _dreamCarClub) {
        dreamCarClub = _dreamCarClub;
    }
    ...
    function mintCross(uint256 amount, address recipient) external {
        require(
            amount <= LIMIT_PER_MINT,
            "DreamCarClubCross: Mint amount exceed Max Per Limit."
        );
        ...
        dreamCarClub.giftMint(mintAddress, mintAmounts);
    }
    ...
    function setDreamCarClub(DreamCarClub _dreamCarClub)
        external
        onlyOwner
    {
        dreamCarClub = _dreamCarClub;
