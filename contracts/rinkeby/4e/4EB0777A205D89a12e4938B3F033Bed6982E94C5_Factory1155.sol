...
import "./ParadoxUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new ParadoxUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ParadoxUser1155Token token = ParadoxUser1155Token(address(addr));
...
contract ParadoxUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
