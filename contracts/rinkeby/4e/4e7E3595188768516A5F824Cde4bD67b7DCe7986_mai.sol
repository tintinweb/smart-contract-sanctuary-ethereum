...
/**
 * @title dinosaur philosophy (Official instagram: https://www.instagram.com/dinosandcomics)
 * @dev Extends ERC721A
 */
...
contract mai is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on mai");
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more dinosaurs");
