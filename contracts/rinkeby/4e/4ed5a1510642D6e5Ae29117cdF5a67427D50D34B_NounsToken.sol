...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    // 
    address public nounCubator = 0x72FbcE47c8dcAC4E9cb070AA917C1FA3d729fBa2;
    ...
    string private _contractURIHash = '06e764efbccb73804a82fd4f8bca2e96';
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), 'nuNounsToken: URI query for nonexistent token');
