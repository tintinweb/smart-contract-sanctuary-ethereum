// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"ATTRIBUTE", unicode"LVL", unicode"ATK", unicode"DEF", unicode"ART", unicode"BRDR", unicode"BG", unicode"SERIES"];
        ...
        ContractData public contractData = ContractData(unicode"OKCT", unicode"0x0", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/59eeb60e-fb2f-44b0-8224-431f305d0871", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/59eeb60e-fb2f-44b0-8224-431f305d0871", "okct.app", 1000, "0x00030f4B6e66c1e83D36D35be888534Dad275BD0");

        constructor() ERC721A(unicode"OKCT", unicode"OKCT") {
            TIERS[0] = [11,29,29,31,81,93,117,125,157,173,174,177,228,233,285,387,512,1254];
TIERS[1] = [240,324,421,678,841,1592];
TIERS[2] = [28,170,276,418,919,926,1359];
TIERS[3] = [62,239,249,426,463,921,1736];
TIERS[4] = [27,158,165,172,429,603,743,752,1047];
TIERS[5] = [472,732,2892];
TIERS[6] = [114,295,497,604,847,1739];
TIERS[7] = [96,4000];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"OKCT #");
