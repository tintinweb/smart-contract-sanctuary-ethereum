...
contract CyberKnightsSmartContract is ERC721Enumerable, Ownable {
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual override {
        require(ownerOf(tokenId) == msg.sender || from == address(0), "You are not the owner of this NFT!");
    ...
    function setStatusOfNFT(uint256 tokenId) external {
        require(ERC721.ownerOf(tokenId) == msg.sender, "You are not the owner of this NFT!");
        allowNftTransfer[tokenId] == true;
    }
}
