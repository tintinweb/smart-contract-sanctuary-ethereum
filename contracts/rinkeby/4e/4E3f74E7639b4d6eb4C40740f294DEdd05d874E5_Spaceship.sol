...
contract Spaceship is IERC721Receiver, Ownable {
    ...
    function setColorMap(uint8[] calldata colorMap) public onlyOwner {
        tokenIdToColors = colorMap;
    }
    ...
    function stakedTokenByIndex(address owner, uint256 index) public view returns (Stake memory) {
    ...
    function stakeMultiple(address _owner, uint256[] calldata _tokenIds) external {
        ...
        numStakedByOwner[_owner] += _tokenIds.length;
    }
    ...
    function claimMultiple(
        ...
        unchecked {
            for (uint256 i = 0; i < _tokenIds.length; i++) {
                ...
                require(stake.owner == _owner, 'You didnt stake that NFT.');
            ...
            for (uint256 i = 0; i < _tokenIds.length; i++) {
                ...
                if (_unstake) {
                    // Return NFT
                    nftContract.transferFrom(address(this), _owner, _tokenIds[i]);
