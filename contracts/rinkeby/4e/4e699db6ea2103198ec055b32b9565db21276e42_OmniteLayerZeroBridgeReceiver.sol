...
contract OmniteLayerZeroBridgeReceiver is
    OmniteBridgeReceiver,
    IOmniteLayerZeroBridgeReceiver
{
    // required: the LayerZero endpoint which is passed in the constructor
    ILayerZeroEndpoint public endpoint;
    ISystemContext public immutable systemContext;

    constructor(ISystemContext systemContext_) OmniteBridgeReceiver(0) {
...
abstract contract OmniteBridgeReceiver is IBridge, IApiVersion {
