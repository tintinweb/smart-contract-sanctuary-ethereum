...
contract DTEST200 is ERC721, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
  ...
  constructor() ERC721("DTEST200", "DT200") {setHiddenMetadataUri("ipfs://QmWrX4cCtnQZPbDDVH1WMibnLYQNyW68WrEVHeAPF7u8VP/hidden.json");}
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) freeMintsAvailable() {require(!paused, "The contract is paused!"); 
        ...
        require(msg.value >= price, "Insufficient funds!"); _mintLoop(msg.sender, _mintAmount); freeMintCountMap[msg.sender] += _mintAmount;}
  ...
  function setMaxFreeAmountPerTx(uint256 _maxFreeAmountPerTx) public onlyOwner {maxFreeAmountPerTx = _maxFreeAmountPerTx;}
