...
contract UndeadGenuineAI is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.006 ether;
    uint256 public maxSupply = 404;
    uint256 public maxFree = 44;
    uint256 public maxperAddressFreeLimit = 2;
    uint256 public maxperAddressPublicMint = 2;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("Undead GenuineAI", "UGAI") {
        setBaseURI("ipfs://QmYCLeLDuEygTSimQhJ3UxcEsEX8pA4RNGgzkVjMaZhcam/");
