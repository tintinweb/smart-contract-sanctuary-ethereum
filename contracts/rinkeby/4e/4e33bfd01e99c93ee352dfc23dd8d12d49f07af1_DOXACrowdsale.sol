    ...
    function extractAlt(uint8 tokenType, address _addr) public onlyOwner {
     ...
     function initialize(uint256 _tokenRate, address _tokenAddress, address _admin, uint _startDate, uint _endDate)  external initializer{
        ...
        admin = _admin;
         signer=msg.sender;
         __Ownable_init();
        priceFeedETHUSD = AggregatorV3Interface(0x608307CC588f09A01480861D9B817EAE1624D418);
        priceFeedETHDAI = AggregatorV3Interface(0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C);
    }
