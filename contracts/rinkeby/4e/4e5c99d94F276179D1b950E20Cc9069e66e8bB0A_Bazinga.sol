...
contract Bazinga is ERC20, Ownable, VRFConsumerBaseV2 {
    // Basic units
    ...
    constructor(
    ) ERC20("Bazinga", "BZNG") VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab) {
    ...
    function _settleRPSLSvsChainlink(
        ...
        uint256 rektageOrNot = (randomNumber*block.timestamp*block.difficulty) % 100;
