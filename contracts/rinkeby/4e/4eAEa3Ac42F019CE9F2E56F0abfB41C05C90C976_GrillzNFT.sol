...
contract GrillzNFT is ERC721Enumerable, Ownable {
  ...
  uint256 public saleStartTimestamp = 1653486376;
  uint256 public endOnlyWhitelistedTimestamp = saleStartTimestamp + 86400;
  uint256 public revealedTimestamp = endOnlyWhitelistedTimestamp + 86400;
  ...
  function mint(uint256 _amount) public payable {
    ...
    if (msg.sender != owner()) {
        if (block.timestamp < endOnlyWhitelistedTimestamp) {
  ...
  function setEndOnlyWhitelistedTimestamp(uint256 _timestamp) public onlyOwner {
    endOnlyWhitelistedTimestamp = _timestamp;
  }
