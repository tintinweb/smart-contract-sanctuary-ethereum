...
pragma solidity ^0.8.0;
 ...
 contract Strangedeer_test01 is Ownable, ERC721A, ReentrancyGuard {
    struct Config {
        uint256 maxSupply;
        uint256 reserved;
    ...
    Config public config= Config(99, 0, 11, 0.005 ether, 5, "");
    bool public isMintStarted= false;
    uint256 public maxFreeMintAmountPerTx=3;
    uint256 public maxMintAmountPerTx=5;
    constructor() ERC721A("Strangedeer_test01", "Strangedeer_test01") 
    {
