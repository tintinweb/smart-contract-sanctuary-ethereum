...
;
    ...
    function getVerify(uint256 pow_index)public view returns(bytes32){
    ...
    function verifyPOW(uint256 pow_index,uint256 _nftNumber)public view returns(bool){
    ...
    function WLMint(uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) external payable  {
