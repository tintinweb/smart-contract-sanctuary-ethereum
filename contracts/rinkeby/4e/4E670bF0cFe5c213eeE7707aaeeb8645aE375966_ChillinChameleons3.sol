...
contract ChillinChameleons3 is ERC721Enumerable, Ownable {
    ...
    address public constant creator1Address = 0x8AA043A60E072c43aFD24b8F36619A016d3cf96e;
    address public constant creator2Address = 0x3f2D29e84BF509e508bD60470Ff61409516848eB;
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(creator1Address, address(this).balance * 85 / 100);
        _widthdraw(creator2Address, address(this).balance * 15 / 100);
    }
