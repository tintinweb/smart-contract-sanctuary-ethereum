...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeE0E8F8eF2cfaBe3eA49C8eB3FaCD5EEA248D91a];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1000, 5000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVDgmgofBMxoZcvhU7Xg67aNmTtf9rpVwgEfHAztuYLG6/";
...
// File: contracts/PunkPlanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PunkPlanContract is RamppERC721A {
    constructor() RamppERC721A("Punk Plan", "PUNK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ZyVTqbI404BwGFn2IKls/contract-metadata";
    }
}
