...
contract GOTOKUTESTF is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool hs, ) = payable(0x94E89fC0CE0c6ef89572EfCE2A480369127402aE).call{value: address(this).balance * 27 / 100}('');
    require(hs);
