...
contract HMHMO is ERC721Enumerable, Ownable, ReentrancyGuard {

    uint16 public constant LIMIT = 1666;

    bytes32 public merkleRoot;
    uint256 public price = 66600000000000000;
    ...
    constructor(string memory _uri) ERC721("hmhm","HMHMO") {
        URI = _uri;
    }
    ...
    function mint(uint16 amount, bytes32[] calldata proof) external payable nonReentrant {
        ...
        require(publicSaleActive || amount + claimed[_msgSender()] < 3, "Exceeds limit per user");
