...
contract WKG2D is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public finalMaxSupply = 3333;
   uint256 public currentMaxSupply = 1500;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Wukong2D NFT", "WKG2DNFT") {
  ...
  function withdraw() public onlyOwner {
    ...
    (bool hs, ) = payable(0x4B57a67f43a6Bc29A8d1B9f58D5C32e9a044AC13).call{value: address(this).balance * 5 / 100}("");
    require(hs);
