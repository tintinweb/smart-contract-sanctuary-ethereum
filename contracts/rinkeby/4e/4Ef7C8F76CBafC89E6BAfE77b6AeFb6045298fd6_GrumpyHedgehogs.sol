...
contract GrumpyHedgehogs is ERC721A, Ownable{
    ...
    uint256 public constant PUBLIC_SALE_PRICE = .0005 ether;
    uint256 public constant WHITELIST_SALE_PRICE = .0003 ether;
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "We are out of Hedgies :(");
        require((totalWhitelistMint[msg.sender] + _quantity)  <= MAX_WHITELIST_MINT, "You have already whitelist minted the max amount");
