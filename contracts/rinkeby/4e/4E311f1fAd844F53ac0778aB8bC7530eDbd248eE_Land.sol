...
contract Land is ERC721, ReentrancyGuard, Ownable, Pausable {
    ...
    string public unrevealedURI =
        "ipfs://QmYkTARibhvTtRw3WYWjf98vNRzeoHPqa1vHUe3quPWqK9/";
    uint16 public lastTokenSoldAfterSale;
    ...
    function setLastTokenIdSoldAfterSale(uint16 _lastTokenSoldAfterSale)
        external
        onlyOwner
    {
        lastTokenSoldAfterSale = _lastTokenSoldAfterSale;
    }
    ...
    {
        if (_tokenId <= lastTokenSoldAfterSale) {
