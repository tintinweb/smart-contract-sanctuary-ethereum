...
contract Payments is Ownable {
    ...
    function calculateRandomnessChainlinkFee(
        ...
        uint256 ETHLINKpriceinwei,
        uint256 amountOfItems,
        uint256 gaslanegwei
    ) public view returns (uint256) {
        require(lanes[gaslanegwei] != 0x0, "Invalid gas lane");
        baseCallbackFeeInGwei =
            (baseCallbackFeeInGwei + (amountOfItems * 20000)) *
            10**9;
        uint256 fallbackprice = ETHLINKpriceinwei / 1000000000; //in gwei.
        uint256 math1 = (gaslanegwei * 10**9) *
            (baseCallbackFeeInGwei / fallbackprice) +
    ...
    function buyLinkToken(
        ...
        token.transferFrom(msg.sender, address(this), amountToTokenToBuy_);
    ...
    function createSubscriptionAndTopUpBalance(
        ...
        COORDINATOR.acceptSubscriptionOwnerTransfer(subscriptionID);
