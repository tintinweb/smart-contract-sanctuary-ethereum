...
contract RoyaltiesRegistry is ERC165, OwnableUpgradeable, IRoyaltiesRegistry {
     ...
     *                               MODIFIERS
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    modifier isCollectionAdminOrOwner(address collectionAddress) {
    ...
    ) public isCollectionAdminOrOwner(collectionAddress) {
    ...
    function primaryRoyaltyInfo(address collectionAddress, uint256 tokenId)
        external
        view
        isCollectionAdminOrOwner(collectionAddress)
