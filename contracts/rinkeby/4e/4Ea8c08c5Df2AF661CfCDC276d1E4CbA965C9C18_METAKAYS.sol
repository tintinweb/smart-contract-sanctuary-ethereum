...
contract METAKAYS is Ownable, ERC721 {
    ...
    function kustomize(uint256 _itemID, uint8[] memory selection_, string memory _entryName) public {
      require(msg.sender == ownerOf(_itemID), "YOU ARE NOT THE OWNER!");
      require(customShirtCheck(_entryName) == true, "PLEASE ONLY USE 1-8 CAPITAL LETTERS!");
