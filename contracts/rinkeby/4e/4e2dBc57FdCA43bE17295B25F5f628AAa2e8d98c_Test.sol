...
contract Test{
    ...
    function uniswapTestingTokenforTokens(uint256 price,uint256 deadline, address tokenAddress1, address tokenAddress2) external returns(uint256){
         address[] memory path = new address[](2);
        path[0] = tokenAddress1;
        path[1] = tokenAddress2;
