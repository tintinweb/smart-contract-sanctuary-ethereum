...
// @author METASTELAR https://twitter.com/metastellar
...
contract AdamPixelBoy is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 private constant MAX_PUBLIC = 7;
    ...
    uint256 public saleStartTime = 1656353836;
    ...
    uint256[] private _teamShares = [334, 333, 333];

    //Constructor
    constructor(bytes32 _merkleRoot, string memory _baseURI)
        ERC721A("MyCollection", "MC")
    ...
    /**
     * @notice This contract can't be called by another contracts
     */
    modifier callIsUser() {
    ...
    /**
     * @notice This method return baseURI of an already minted NFT by its tokenId
     *
     ...
     * @param _wlSalePrice The new price of one NFT during whitelist sale
     */
     ...
     * @param _saleStartTime The next starting timestam of the whitelist sale
     */
     ...
     *
     * @param _isPaused true of false if we want to pause or unpause the contract
     */
    ...
    /**
     * @notice Release the gains on every address
     */
     ...
     * @param _quantity AMOUNT OF NFTs wants to mint
     ...
     *
     * @param _account Account which will receive NFTs
     * @param _quantity Amount of NFTs user want to mint
     **/
     ...
     * @param _quantity Amount of NFTs the owner want to gift
     **/
