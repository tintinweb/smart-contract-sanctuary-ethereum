...
import "./AnimatedPunkzRewards.sol";
import "erc721a/contracts/ERC721A.sol";

contract StakeAlienPunkzTest is Ownable, IERC721Receiver {
  ...
  ERC721A nft;
  AnimatedPunkzRewardsTest token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(ERC721A _nft, AnimatedPunkzRewardsTest _token) { 
    nft = _nft;
    token = _token;
  }
...
contract AnimatedPunkzRewardsTest is ERC20, ERC20Burnable, Ownable {
