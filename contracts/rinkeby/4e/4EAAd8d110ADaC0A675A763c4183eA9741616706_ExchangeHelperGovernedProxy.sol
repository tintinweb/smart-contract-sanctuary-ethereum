 ...
 */
contract ExchangeHelperGovernedProxy is NonReentrant, IGovernedContract, IGovernedProxy_New {
    ...
    modifier senderOrigin() {
        ...
        require(
            ...
            'ExchangeHelperGovernedProxy: Only direct calls are allowed!'
        );
        _;
    }
    ...
    modifier onlyImplementation() {
        require(
            ...
            'ExchangeHelperGovernedProxy: Only calls from implementation are allowed!'
        );
        _;
    }
        ...
        returns (IUpgradeProposal)
    {
        require(
            ...
            'ExchangeHelperGovernedProxy: Already active!'
        );
        require(
            _newImplementation.proxy() == address(this),
            'ExchangeHelperGovernedProxy: Wrong proxy!'
        );
    ...
    function upgrade(IUpgradeProposal _proposal) external noReentry {
        ...
        require(
            ...
            'ExchangeHelperGovernedProxy: Not registered!'
        );
        require(_proposal.isAccepted(), 'ExchangeHelperGovernedProxy: Not accepted!');
    ...
    function migrate(IGovernedContract) external {
        revert('ExchangeHelperGovernedProxy: Good try');
    }
    ...
    function() external payable senderOrigin {
        ...
        if (false) {
            ...
            require(
                ...
                'ExchangeHelperGovernedProxy: delegatecall cannot be used'
            );
        }
