...
contract WadBurn is AdminControl, ICreatorExtensionTokenURI {
  ...
  function tokenURI(address creator, uint256 tokenId) external view override returns (string memory) {
    ...
    require(tokenId >= mintedTokenIds[0] && tokenId < assetURIs.length, "Invalid token");
...
/*
    ...
    tokenToSend[1] = redemptionTokenId+1;
    tokenToSend[2] = redemptionTokenId+2;
    tokenToSend[3] = redemptionTokenId+3;
*/
