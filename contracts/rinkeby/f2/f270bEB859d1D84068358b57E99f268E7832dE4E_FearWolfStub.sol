 ...
 */
contract FearWolfStub is ERC721Enumerable, AccessControl, ReentrancyGuard {
    ...
    */
    ...
    function initialMint(address initialOwner, uint256 wolvesCount) external nonReentrant onlyRole(MINTER_ROLE) {
