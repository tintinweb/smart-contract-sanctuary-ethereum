...
contract Skeletonz_Raffle is Ownable, VRFConsumerBase {

  uint[] public winners = new uint[](50);

  uint public winners_drawn = 0;

	function drawWinner() external onlyOwner {

        uint _rand = (uint(keccak256(abi.encodePacked(randomResult, msg.sender, block.timestamp, winners_drawn))) % (665 - 500 + 1)) + 500;

        winners[winners_drawn] = _rand;
