 ...
 *
 * See `test/utils/cryptography/MerkleProof.merkle.js` for some examples.
 */
library MerkleProof {
    /**
...
contract FunkyPassTest is ERC721Enumerable, Ownable, ERC2981, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("Funky Pass", "FP") {
        ...
        _setRoyalties(msg.sender, 1000); //10% Royalties
    }
