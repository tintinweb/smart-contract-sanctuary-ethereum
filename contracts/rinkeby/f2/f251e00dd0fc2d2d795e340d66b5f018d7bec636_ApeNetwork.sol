...
contract ApeNetwork is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$APN";
    ...
    uint256 public _maxTxAmount = 5000000 * 10**9; //1%
    uint256 public _maxWalletSize = 10000000 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 250000; // 0.05% swap wallet
