...
contract TokenTBDAuction is Ownable {
    ...
    function cancelAuction(uint8 tokenId) external payable onlyPaperOrOwner {
        ...
        require(address(tokenTBDK) != address(0), "NULL_CONTRACT_ADDRESS");
        require(
            !tokenTBDK.mintedPlatinum(tokenId),
...
contract TokenTBD is ERC721, Ownable {
    ...
    function mint(
        ...
        require(
            msg.value >= (silverPrice * silverQuantityToMint +
                            goldPrice * goldQuantityToMint),
            "INSUFFICIENT_ETH"
        );
    ...
    function modifyTokenPrices(
        uint256 newSilverPrice,
        uint256 newGoldPrice) external onlyOwner {
