...
contract WildEXOplanetGame is ERC721, EIP712, Ownable{
    ...
    uint256[] public tierMintTimes = [1643631826, 1643632726, 1643632726, 1643632726, 1643632726];
    ...
    uint256 public whitelistSaleDisableTime = 1643631826;
    uint256[] public revealTime = [1643632726, 1643633626]; //tier [(1),(2,3,4,5)]
