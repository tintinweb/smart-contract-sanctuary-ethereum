...
contract HfTestContract is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 2500;
    uint256 public immutable supply = 5069;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x8060105AAeefC042cA0E52c10171d701a6793672];
    uint256[] public withdrawPercentages = [5, 95];

    bytes32 public merkleRoot = 0x9448d485713250313445ee45a367a733c826d2511ffe43684f9b815573dd5a18;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xfD539ae1Dc9fa6eDb5961961F40EB518d0f4bba4, _royaltyAmount);
    }
