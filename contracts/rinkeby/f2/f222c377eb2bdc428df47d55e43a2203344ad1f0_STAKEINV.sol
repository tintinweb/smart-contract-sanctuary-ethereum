...
// File: StakingProject/StakeInvo.sol
 ...
 contract STAKEINV is ReentrancyGuard, Pausable{
...
/* ========== VIEWS ========== */
   ...
   function rewardOFUSer(address account) public view returns (uint256) {
    ...
    function withdraw(uint256 amount) public nonReentrant  updateReward(msg.sender) {
        require(amount > minStake, "Please provide sufficient stake");
        _totalSupply = _totalSupply.sub(amount);
        require(_totalSupply < 0, "Insufficient stake for withdraw");
