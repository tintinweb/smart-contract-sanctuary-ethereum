...
contract Vendor is Ownable {
  ...
  // fallback and receive special functions that receives eth and calls buyTokens()
  ...
  function buyTokens() public payable {
    // use msg.value and tokensPerEth to calculate an amount of tokens
    uint256 amountOfTokens = msg.value * tokensPerEth;
    // to yourToken.transfer() to msg.sender.
  ...
  function sellTokens(uint256 amountOfTokens) public {
    ...
    require(success, 'eth back failed');
  }
}
