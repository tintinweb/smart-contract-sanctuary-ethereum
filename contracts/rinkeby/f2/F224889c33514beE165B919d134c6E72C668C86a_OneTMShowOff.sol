...
abstract contract ERC721Reedemable is Context, Ownable {
    ...
    function _redeem(uint256 _tokenId, uint256 _ammount) internal {
        ...
        uint256 availableRedeems = tokenIdToRemainingRedeems[_tokenId];
        require(availableRedeems > 0, "You have no redeems left");
        require(availableRedeems > _ammount, "You have not enough redeems");
        tokenIdToRemainingRedeems[_tokenId] = availableRedeems - 1;
