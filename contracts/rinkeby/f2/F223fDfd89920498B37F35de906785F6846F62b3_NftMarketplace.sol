...
error NftMarketplace__NotApprovalMarketplace();
...
contract NftMarketplace is ReentrancyGuard {
    ...
    function listItem(
        ...
        // 2. owner can still hold their nft and give the markeplace approval to sell the nft for them
        IERC721 nft = IERC721(nftAddress);
        if (nft.getApproved(tokenId) != address(this)) {
            revert NftMarketplace__NotApprovalMarketplace();
        }
        ...
        isListed(nftAddress, tokenId)
    {
        ...
        // we don't just send seller the money... sending the money to the user No
        // have them wirhdraw the money Yes!
        ...
        // chech to makesure nft transfer
