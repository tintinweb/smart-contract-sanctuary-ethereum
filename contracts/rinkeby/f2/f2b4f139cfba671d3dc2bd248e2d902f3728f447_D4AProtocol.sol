...
contract D4AProtocol is Initializable, ReentrancyGuardUpgradeable{
  ...
  function createProject(uint256 _start_prb,
                         ...
                         uint96 _royalty_fee,
                         string memory _project_uri) public payable nonReentrant returns(bytes32 project_id){
...
library D4AProject{
  ...
  function createProject(mapping(bytes32=>project_info) storage all_projects,
    ...
    require(_royalty_fee >= 500 && _royalty_fee <= 1000, "royalty fee out of range");
    {
