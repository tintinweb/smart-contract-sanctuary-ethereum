...
contract SvgNft is ERC721, Ownable {
    ...
    constructor(string memory svgImage) ERC721("Dynamic NFT721", "DSN") {
        s_tokenCounter = 0;
        s_ImageURI = svgToImageURI(svgImage);
    }

    function svgToImageURI(string memory svgImage)
        public
        pure
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "emoji", // You can add whatever name here
                                '", "description":"An emoji nft", ',
