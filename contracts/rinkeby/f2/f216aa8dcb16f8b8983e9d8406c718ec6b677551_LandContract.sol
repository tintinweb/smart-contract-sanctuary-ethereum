...
contract LandContract is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SPIRITLAND", "INDL") {
  ...
  function mint(uint256 _mintAmount,string memory name, int256  x,int256 y,int256 z,uint256 sx,uint256 sy,uint256 sz) public mintCompliance(_mintAmount) {
    console.log("start");
    require(!paused, "The contract is paused!");
    console.log("Here2");
    Land memory l = Land(name, msg.sender, x, y, z, sx, sy, sz);
    console.log("heere");  
    lands.push(l);
