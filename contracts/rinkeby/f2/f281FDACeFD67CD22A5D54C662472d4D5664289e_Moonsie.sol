...
contract Moonsie is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  address CommunityWalletAdd = 0x5767a322C6BE18cB0903499e8cF901C484400170;
  address MoonlightCapitalAdd = 0x5767a322C6BE18cB0903499e8cF901C484400170;
  address LeadDeveloperAdd = 0x5767a322C6BE18cB0903499e8cF901C484400170;
  address PartnerAdd = 0xF6F6F9B2F92F2AB2B39c9a8dE933f8FfA6e16fF0; // A
  address MarketingLeadAdd = 0x1dAADd414A35C6F2F6ae61B0a199BACEE8A7B8B8; // C
  address AdvisorAdd = 0xF68e9369CF9256f1E424d5F57b8F26B836597d67; // B
  address LegendaryAdvisorRyckAdd = 0x133C20C995578f06E039839bB3355d986FcE1a49; // D
  address LegendaryAdvisorZerocoolAdd = 0x5767a322C6BE18cB0903499e8cF901C484400170;
   ...
   * MarketingLead - 2.4%
   * Advisor - 1.8%
   * LegendaryAdvisorRyck - 3%
   * LegendaryAdvisorZerocool - 3%
   */

  function devWithdraw() external onlyOwner nonReentrant {
    uint256 CurrentContractBalance = address(this).balance;

    uint256 communityWallet = (CurrentContractBalance * 4000) / 10000;
    uint256 moonlightCapital = (CurrentContractBalance * 420) / 10000;
    uint256 LeadDeveloper = (CurrentContractBalance * 600) / 10000;
  ...
  function backupWithdraw() external onlyOwner nonReentrant {
