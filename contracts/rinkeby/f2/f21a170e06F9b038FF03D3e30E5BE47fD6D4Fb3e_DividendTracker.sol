...
contract CrypTIP is Context, IERC20, Ownable {
    ...
    uint256 public _maxBuyAmount = 10000000 * 10**9;
    uint256 public ethPriceToSwap = 200000000000000000; //.2 ETH
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public buyBackAddress = 0x57E7A48859349B5231eC154964e3526CC2E5aA9E;
    address public investmentAddress = 0x18649565Ae328d64bfFC353702fdbda60636613A;
    address public devAddress = 0x43A428BA04f417694752f4d2f4DA3C31ab0Ffa70;
    ...
    function sendDividends(uint256 dividendAmount) private {
        (bool success,) = address(dividendTracker).call{value : dividendAmount}("");
        if (success) {
            emit SendDividends(dividendAmount);
        }
    }
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _name = "CrypTIP Tracker";
    string private _symbol = "CTIPT";
    uint8 private _decimals = 9;
    ...
    constructor() {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 500000000000 * (10 ** _decimals);
    ...
    function setTokenBalance(address account) external {
        uint256 newBalance = crypTIP.balanceOf(account);
