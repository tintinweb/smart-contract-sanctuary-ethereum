...
contract Contract is ERC721Enumerable, Ownable {
  ...
  constructor(string memory tokenName, string memory tokenSymbol, string memory _initBaseURI,string memory _initnotRevealURI)
    ERC721(tokenName, tokenSymbol) { setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI); }
