...
// File: contracts/PixelLanders.sol
...
contract PixelLanders is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable maxPerAddressDuringMint;
    uint256 public immutable mintPrice;


    constructor(uint256 maxBatchSize_, uint256 collectionSize_, uint256 mintPrice_)
        ERC721A("PixelLanders", "PLFTW", maxBatchSize_, collectionSize_)
    {
    ...
    function pixelDream(uint256 quantity) external payable callerIsUser {
