...
contract Rengab is ERC165, IERC721, IERC721Metadata, Ownable{
  ...
  function symbol() external override view returns (string memory symbol_ret){
    ...
    */
    ...
    function mintPublic(uint256 _mintAmount) public {
        ...
        require(addressToMintedCount[msg.sender] < 2, "Can't mint that many");

        addressToMintedCount[msg.sender] += _mintAmount;
