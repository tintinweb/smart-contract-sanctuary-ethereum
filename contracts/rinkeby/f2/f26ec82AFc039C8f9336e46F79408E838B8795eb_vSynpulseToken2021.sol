...
// File: vSynpulseToken2021.sol

//import "@openzeppelin/contracts/token/ERC777/ERC777.sol"; implementation of this would have been more time consumming, therefore we will launch the first token in the ERC20 standard.
...
contract vSynpulseToken2021 is ERC20, Pausable {
    ...
    constructor(uint256 initialSupply)
        ERC20("vSynpulseToken2021test0", "vSYN21test0")
    {
        _mint(msg.sender, initialSupply); // initial supply can be minted to a different address.
        // setting the master contract to which all coins will be vested to.
        masterContract = 0x965067c63dc2E70A905367E7915966079Ea5785B;
