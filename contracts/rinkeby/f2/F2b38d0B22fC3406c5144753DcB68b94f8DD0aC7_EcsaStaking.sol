...
/**
 * How all exit of ECSA rewards are managed.
 */
contract ExitQueue is Ownable {
    ...
    IERC20 public ECSA;   // ECSA

    // Limit of how much ecsa can exit per epoch
    uint256 public maxPerEpoch;

    // Limit of how much ecsa can exit per address per epoch
    ...
    function join(address _exiter, uint256 _amount) external {        
        ...
        SafeERC20.safeTransferFrom(ECSA, msg.sender, address(this), _amount);
    ...
    function withdraw(uint256 epoch) external {
        ...
        SafeERC20.safeTransfer(ECSA, msg.sender, amount);
