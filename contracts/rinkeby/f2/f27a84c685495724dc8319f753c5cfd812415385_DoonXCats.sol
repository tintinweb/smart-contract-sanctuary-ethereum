...
contract DoonXCats is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public constant MAX_MINT_PER_ADDR = 14;
    ...
    constructor(string memory initBaseURI) ERC721A("DoonXCats", "DXC") {
        baseURI = initBaseURI;
