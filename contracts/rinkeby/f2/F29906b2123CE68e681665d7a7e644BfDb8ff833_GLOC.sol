...
//        addressMintedBalance[msg.sender]++;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof)
    ...
    payable
    {
        ...
        require(
            whiteListClaimed[msg.sender] + _mintAmount <= whitelistMaxPerWallet,
            "Already claimed max for whitelist"
        );
...
///////
  function setwhitelistMaxPerWallet(uint256 _newwhitelistMaxPerWallet) public onlyOwner {
