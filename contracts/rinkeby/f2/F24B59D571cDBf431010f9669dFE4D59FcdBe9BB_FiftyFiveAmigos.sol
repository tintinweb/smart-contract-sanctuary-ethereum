...
contract FiftyFiveAmigos is ERC721A, Ownable {
  ...
  string private _baseURIextended = "ipfs//:QmTmS1ZAfLVFXJSEL8v8h48stEhR6Qd9PHgFSY8SeDZtZw/hidden.json";

  address[] private mintPayees = [
    0xBD584cE590B7dcdbB93b11e095d9E1D5880B44d9
  ];

  constructor() ERC721A("Fifty Five Amigos", "AMIGOS") {}
