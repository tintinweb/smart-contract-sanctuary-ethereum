...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmV1pgiUUVMKmSEErCigVUCDYxhL3b8qbsJfKibHHzZnmA/";
...
// File: contracts/IamfutureartsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IamfutureartsContract is RamppERC721A {
    constructor() RamppERC721A("I AM FUTURE ARTS", "IAFA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/yv44HZ4IekFZKqG6rpO9/contract-metadata";
    }
}
