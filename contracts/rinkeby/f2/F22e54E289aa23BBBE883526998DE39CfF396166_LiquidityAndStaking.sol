...
contract LiquidityAndStaking is Ownable{
    ...
    constructor() {
        ...
        GainTokenAddress = 0x9EDd748ed59FA6882698a1852612D5973c963232;
        GLWallet = 0x819704F4dd43c1c2D8890be1a44dEdb2caBE8647;
        GainAmount = 1000 * (10 ** 18);
    }
    ...
    function tokenSwap(address pair1, address pair2) external onlyOwner returns(bool){
        ...
        (amountsPair1) = swapFromContract(pair1, amount, PAIR1_GAIN, address(this), deadline);
        addLiquidityFromContract(pair1, amount, amountsPair1[1], 1, 1, address(this), deadline);
        (amountsPair2) = swapFromContract(pair2, amount, PAIR2_GAIN, address(this), deadline);
        addLiquidityFromContract(pair2, amount, amountsPair2[1], 1, 1, address(this), deadline);
