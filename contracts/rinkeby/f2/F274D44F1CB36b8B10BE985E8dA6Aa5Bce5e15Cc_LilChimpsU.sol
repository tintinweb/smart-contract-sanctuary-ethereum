...
contract LilChimpsU is AuthorizableU, ERC721AU, ReentrancyGuardUpgradeable {
    ...
    string public s_staticTokenURI;
    ...
    function initialize() public virtual initializer {
        ...
        s_staticTokenURI = "https://ipfs.infura.io/ipfs/QmWSYfyVsc5n8LK3cL3zgrP6S9NQgJFTaYr4LFuqmkizdV";
    }
    ...
    function isRevealDuration() public view returns (bool) {
        return block.timestamp > s_startTimestamp && block.timestamp < s_startTimestamp + s_preSaleDuration;
    }
    ...
    function setPreRevealDuration(uint256 _preRevealDuration)
        external
        onlyOwner
    {
    ...
    function adminMint(address[] memory recipients, uint256[] memory quantities) public onlyOwner {
