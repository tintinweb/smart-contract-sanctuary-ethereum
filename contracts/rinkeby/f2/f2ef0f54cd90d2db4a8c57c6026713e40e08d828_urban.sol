...
//    Unlike the trip a year prior, this time I brought my camera.                                                                   //
//                                                                                                                                   //
...
//                                                                                                                                   //
//    Many of these photos are presented in unconventional orientations in order break the context of standing in the middle of      //
//    the city in an effort to show you the beauty that exists outside of the literal subject– in the words of Minor White “One      //
//    should not only photograph things for what they are but for what else they are”.                                               //
//                                                                                                                                   //
//    I hope that these photos cause you to look closer at your surroundings to find a deeper appreciation for the often             //
...
//    the next time I visit a large city with my camera will be, or even if I ever will. But my intent is to add to this             //
//    collection in “blocks”, which each new block being a sampling of images from a single trip.                                    //
//                                                                                                                                   //
