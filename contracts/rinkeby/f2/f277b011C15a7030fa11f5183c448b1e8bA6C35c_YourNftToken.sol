...
contract YourNftToken is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require(
            tx.origin == msg.sender, 'Contracts cannot mint'
        );
        _;
    }
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        require(address(this).balance > 0, 'Cannot withdraw funds, balance is 0');
        // =============================================================================
    ...
    modifier freeMintCompliance(uint256 _mintAmount) {
        ...
        require(_mintAmount <= maxFreeMintAmountPerTx, 'Free mint amount execeeds max free mint per transaction!');
        require(totalSupply() + _mintAmount <= maxFreeMintSupply, 'Free mint amount will exceed max free mint supply');
        
        require(
            (balanceOfNFtTokenAmountInWallet(msg.sender) + _mintAmount) <= maxFreeMintAmountPerTx,
        ...
        require(
             maxFreeMintAmountPerTx > balanceOfNFtTokenAmountInWallet(msg.sender),
        ...
        require(
            tx.origin == msg.sender, 'Contracts cannot free mint'
        );
        _;
    }
    ...
    function balanceOfNFtTokenAmountInWallet(address _sender) public view returns (uint256) {
