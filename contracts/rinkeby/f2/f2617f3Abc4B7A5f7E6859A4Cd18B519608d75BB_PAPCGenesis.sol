...
contract PAPCGenesis is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'https://ipfs.io/ipfs/QmXng4M2LvUdc1a5vzYbx6UrJJNe61mignwsmDGJAiegBV/';
  ...
  constructor() ERC721A("Punk Ape Pixel Club Genesis", "PAPC-Genesis") {
  ...
  function setNum(uint256 _addAN, uint256 _addBN, uint256 _addCN, uint256 _addDN) external onlyOwner {
  ...
  function setAddress(address _addAA, address _addBA, address _addCA, address _addDA) external onlyOwner {
      addA = _addAA;
      addB = _addBA;
      addC = _addCA;
      addD = _addDA;
