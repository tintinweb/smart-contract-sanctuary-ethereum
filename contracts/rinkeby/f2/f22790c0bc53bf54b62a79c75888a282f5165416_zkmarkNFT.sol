...
contract zkmarkNFT is ERC721, Ownable {
    string public baseURI = "ipfs://QmRX6eifN5uhYmeKHSMfBEpBpPx67ic4mrWzJQbKQiAaqn/";
    uint256 public MAX_SUPPLY = 10;
    uint256 public cost = 0.05 ether;
    uint256 public maxPerWallet = 1;
    bool public publicSale; // isMainSaleActive
    mapping(address => uint256) public walletCap; // 每个地址mint的数量
    using Counters for Counters.Counter;
    Counters.Counter private _tokenSupply; // 按mint顺序给每个NFT一个编号

    // 确定NFT全名和缩写
    constructor() ERC721("zkmark NFT", "ZMTN") {
        publicSale = true;
    }
