...
contract CryptoNarcoCartelNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Crypto Narco Cartel", "CNC") {
    setHiddenMetadataUri("ipfs://QmVn1W9kixx4kDB9BCiViMGo48wNbVoXon53oFEcZbUD8H/hidden.json");
  }
