...
contract CodyCoversNFT is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Cody Covers NFT", "CVRS") {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint16 _count) external payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(
                _count <= MAX_ALLOWED,
                "Maximum allowed NFTs per transaction exceeded"
            );
            require(
