...
contract OfficialFun is BEP721Enumerable, IBEP2981, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxKnights = 1125; 
    uint256 public maxMintAmount = 5; 
    uint256 public safeMeSomeKnights;
    ...
    constructor(
        ...
        address royalties        
    ) BEP721("Punky Knightsy", "Knighty") {
        setBaseURI(_initBaseURI);
        setUnrevealedURI(_initUnrevealedUri);  
        setRoyaltyInfo(royalties, 100);      
    } 
    ...
    function reserveKnights(uint256 _safeMeSomeKnights) external onlyOwner {        
        safeMeSomeKnights = _safeMeSomeKnights;
        uint knights;
        uint i;
        for (i = 1; i < _safeMeSomeKnights; i++) {
    ...
    function royaltyInfo(uint256 tokenId, uint256 salePrice) external view returns (address, uint256 royaltyAmount) {
        ...
        royaltyAmount = (salePrice / 1000) * _royaltiesPercentage;
