...
contract BoaredPunks is Ownable, ERC721 {
    ...
    uint public phase=9650;

      DutchAuctionConfig public dutchAuctionConfig = DutchAuctionConfig({
      txLimit: 20,
      startTime: 1655010000, // Tuesday, March 1, 2022 12:00:00 PM GMT
      bottomTime: 1655074900, // Tuesday, March 1, 2022 1:11:40 PM GMT
    ...
    constructor() ERC721("Boared Punks", "BP"){}
