...
contract protoKol2 is iProtoKol {
   ...
   */
    function generateTGE(uint256 _campaignId, address token) external {
        ...
        // IERC20(campaigns[_campaignId].campaignData.preSaleToken).transferFrom(
        //     msg.sender,
        //     _vault,
   ...
   */
    ...
    function claimPreSaleTokens(
        ...
        if (campaigns[_campaignId].vestingData.isVestingInEnabled) {
            ...
            emit ClaimPreSaleTokens(_campaignId, eligibleRwd, preSale, msg.sender);
        }
    }
   ...
   */
    function claimBackInvestmentByKOL(
        ...
        require(blackListedKOL[_msgSender][_campaignId] != true, "Protokol:KOL blacklisted");
        ...
        _safeTransfer(_USDT, _msgSender, _invest);
...
interface iProtoKol {
    ...
    event ClaimPreSaleTokens(uint256 campaign_Id, uint256 _amount, address _preSaleToken, address _kol);
