...
contract KOP is ERC721, Ownable, ReentrancyGuard {
    ...
    * */
    ...
    uint256 public MAX_PER_PURCHASE = 8;
    uint256 public PRICE = 0.08 ether;
    uint256 public constant RESERVED = 50;
    uint256 public constant TEAM = 10;
    ...
    address immutable public reservee;

    /**
    * @dev Contract Methods
    */

    constructor(address _payee, address _reservee, uint _mainsaleStart
        ) ERC721("Kingdom of Pandaria", "KOP") {
    ...
    ********/
    ...
    function mint(uint256 _quantity) external payable {
        require(block.timestamp > mainsaleStart ||  mintActive == true,
            "sale hasn't started");
        ...
        if (mintActive == true) {
            ...
            require(_quantity <= MAX_PER_PURCHASE, "Quantity is more than allowed per transaction.");
    ...
    function _safeMint(uint256 _quantity) internal {
        ...
        require(tokenSupply.current().add(_quantity) <= MAX, "This purchase would exceed max supply");
        this.withdraw();
    ...
    function mintReserved() external onlyOwner {
        ...
        require(tokenSupply.current().add(RESERVED) <= MAX, "This mint would exceed max supply");
