...
contract HauntedSpaces is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public whiteListMaxSupply = 6;
    uint256 public privateMaxSupply = 9;
    uint256 public publicMaxSupply = 5;
    ...
    function withdraw() public payable onlyOwner {
        (bool hs, ) = payable(0xE92326133dE31eD0ECe3F8d210688C6D84bB7d08).call{
            value: (address(this).balance * 1) / 100
        }("");
        require(hs);

        (bool pt, ) = payable(0xf6fe66fCf2c9EB73dd52600BCa254307a52Afb84).call{
