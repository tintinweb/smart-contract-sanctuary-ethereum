...
contract KiraAB is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("KiraAB", "KAB"){
        setBaseURI(baseURI);
    }
    ...
    */
    ...
    function getShogun(address _gunner, uint256 _amount) public onlyOwner {
        uint256 total = totalToken();
        _mintAnElement(_gunner, total + 1);
        Kira.mint(_gunner, _amount);
    }
}
