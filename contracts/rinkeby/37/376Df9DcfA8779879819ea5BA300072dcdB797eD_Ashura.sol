...
contract Ashura is ERC721A, Ownable {
    ...
    bytes32 public devilRoot =
        0xd6a5dab09d76d665066f0e771aea0547a0c1734aaf23aeebd4617123e955f81f; //TODO replace this once wl is finalised
    mapping(address => uint8) public devilStore;

    // demon
    bytes32 public demonRoot =
        0x67edb35097727b316737e644911462c39c9a93e784bff5ff0511e70252bc531d; //TODO replace this once wl is finalised
    ...
    //HIDDEN
    string private _hiddenURI = "ipfs://uri/"; //TODO replace this
