...
// File contracts/TheFirstTest.sol
...
contract TheFirstTest is ERC721Enumerable, Ownable {
    ...
    uint256 public _maxPreSaleSupply = 1000;
    ...
    constructor(string memory baseURI, bytes32 merkleRoot) ERC721("TheFirstTest", "TFT") {
    ...
    function whitelistMint(uint256 mintCount, bytes32[] calldata merkleProof) external payable {
        ...
        require(mintCount + minted <= 3,                        "max_mint_count_exceeded");
