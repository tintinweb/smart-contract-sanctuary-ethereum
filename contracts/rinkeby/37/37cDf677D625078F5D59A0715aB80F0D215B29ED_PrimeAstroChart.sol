...
library SVGGenerator {
     ...
     */
    function intToFixedNx4String(int256 value) public pure returns (string memory) {
        string memory sign="";
        if(value < 0) {
            sign = "-";
            value = -value;
    ...
    function genLineCoordinates(
        ...
        int128 r0,
        int128 r1
    ) private pure returns (int256[4] memory coordinates) {
        int128 cx = 600 << 64;
        r0 = r0 << 64;
        r1 = r1 << 64;
        return [
        ...
        returns (string memory res)
    {
        ...
        for (uint8 i = 1; i < copiedPlanets.length; i++) {
            ...
            //to64x64
            planets64x64[i] = XpMath.divi(copiedPlanets[i], PRECISION);
        }
        //draw planets
        for (
            uint32 i = 0;
            ...
            res = concat(res, text(intToFixedNx4String(xy[2]), intToFixedNx4String(xy[3]), PLANETS_TEXT[i], fontSize));
    ...
    function dot(int256 x, int256 y)
        private
        pure
        returns (string memory res)
    {
    ...
    function line(
        ...
        return
            lineForString(
                intToFixedNx4String(a),
                intToFixedNx4String(b),
                intToFixedNx4String(c),
                intToFixedNx4String(d),
                intToFixedNx4String(w)
            );
    }
