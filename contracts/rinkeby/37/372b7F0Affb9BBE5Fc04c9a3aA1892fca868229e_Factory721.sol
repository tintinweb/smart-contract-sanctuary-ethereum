...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new AnathaNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AnathaNFTUser721Token token = AnathaNFTUser721Token(address(addr));
...
contract AnathaNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
