...
contract PlumpKittens is ERC721A, Ownable { 
  ...
  uint256 public WHITELIST_MAX_MINT_AMOUNT = 15;
  ...
  uint256 public wlCost = 0.035 ether;
  ...
  function wlMint(uint256 _mintAmount, bytes32[] calldata proof) public payable mintCompliance(_mintAmount) wlMintPriceCompliance(_mintAmount) {
      require(!paused, 'The contract is paused!');
      ...
      require(!whitelistedAddresses[msg.sender], "Address already claimed");
...
function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
  ...
  function setCost(uint256 _cost) public onlyOwner {
    cost = _cost; // set cost in wei amount 
  }

  function setWlCost(uint256 _wlCost) public onlyOwner {
    wlCost = _wlCost; // set wlCost in wei amount 
  }

   function setWHITELIST_MAX_MINT_AMOUNT(uint256 _WHITELIST_MAX_MINT_AMOUNT) public onlyOwner {
    WHITELIST_MAX_MINT_AMOUNT = _WHITELIST_MAX_MINT_AMOUNT; 
  }
