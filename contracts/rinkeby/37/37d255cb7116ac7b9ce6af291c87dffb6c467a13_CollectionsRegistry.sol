...
contract CollectionsRegistry is ICollectionRegistry {
    ...
    function registerCollection(
        ...
        require(
            collections[collectionAddress_] == bytes32(0x0),
            "Address already in collection"
        );
        require(collectionAddress_ != address(0), "Collection addr zero");
        require(owner_ != address(0), "Owner addr zero");
        require(collectionId_ != bytes32(0), "Collection id zero");
    ...
    function registerOriginalAddress(
        ...
        // solhint-disable-next-line reason-string
        require(
            originalAddress_ != address(0),
            "Address of collection cannot be zero"
        );
        // solhint-disable-next-line reason-string
        require(
    ...
    {
        // solhint-disable-next-line reason-string
        require(collectionId_ != bytes32(0), "Collection id zero value");
        // solhint-disable-next-line reason-string
        require(owner_ != address(0), "Collection owner address zero value");
        _setOwner(collectionId_, owner_);
    ...
    {
        require(collectionId_ != bytes32(0), "Collection id zero");
        require(record_.owner != address(0), "Recrod address zero");
        require(record_.addr != address(0), "Record owner zero");
    ...
    {
        require(addr_ != address(0), "Collecton addr zero");
        require(collectionId_ != bytes32(0), "Collection id zero");
        collections[addr_] = collectionId_;
    }
