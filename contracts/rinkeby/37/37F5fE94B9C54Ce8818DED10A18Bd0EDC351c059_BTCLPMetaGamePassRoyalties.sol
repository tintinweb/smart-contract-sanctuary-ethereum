...
contract BTCLPMetaGamePassRoyalties is ERC1155, IERC2981, Ownable, ERC1155Supply, ContextMixin { 
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        ...
        return string(abi.encodePacked(
            "https://ipfs.io/ipfs/QmZxiLeypDwpQ2aXw97GyiFvfZZT5rUJZJw2zrx3p8nxNa/",
    ...
    function contractURI() public pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmaSAzDbWNDdMWMwHcEdLdDGLL9w5VGrrrXtAjkprcF4cy?filename=contract.json"; // Contract-level metadata
    }
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "https://ipfs.io/ipfs/QmZxiLeypDwpQ2aXw97GyiFvfZZT5rUJZJw2zrx3p8nxNa/"; // IPFS base for collection
