...
contract WRLDTakeOver is Ownable, ERC721A, ReentrancyGuard {
	...
	uint256 public constant DEV_AMOUNT = 20;
    ...
    constructor() ERC721A("WRLDTakeOver", "WTKO", MAX_BATCH, MAX_TOKENS) {
    ...
    function publicSaleMint(uint256 quantity) external payable nonReentrant {
		...
		require(_tokensClaimed[msg.sender] + quantity <= MAX_TOKENS_PER_WALLET, "Total exceeds 5");
