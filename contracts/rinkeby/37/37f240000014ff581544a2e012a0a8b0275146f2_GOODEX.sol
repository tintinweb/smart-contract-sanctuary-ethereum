...
contract GOODEX is ERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2BaEfec1814eef5f4f6757a870109C29179840e2);
    address payable public charityAddress = payable(0x2BaEfec1814eef5f4f6757a870109C29179840e2);
    address payable public devAddress = payable(0x2BaEfec1814eef5f4f6757a870109C29179840e2);

    uint256 public swapTokensAtAmount = 200000 * (10**18);

    //BUY Fees
    uint256 private liquidityBuyFee = 0;
    uint256 private marketingBuyFee = 0;
    uint256 private devBuyFee = 0;
    
    //SELL Fees
    uint256 private liquiditySellFee = 0;
    uint256 private devSellFee = 0;
    uint256 private charitySellFee = 0;
    
    
    uint256 public totalBuyFees = marketingBuyFee.add(liquidityBuyFee).add(devBuyFee);
    uint256 public totalSellFees = liquiditySellFee.add(devSellFee).add(charitySellFee);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        GOODEXDividendTracker newDividendTracker = GOODEXDividendTracker(
            payable(newAddress)
        );
    ...
    function updateWallets(address payable _marketingAddress, address payable _charityAddress, address payable _devAddress) public onlyOwner {
    ...
    function updateBuyFees(
        ...
        marketingBuyFee = newMarketingFee;
        liquidityBuyFee = newLiquidityFee;
        devBuyFee = newDevFee;
        totalBuyFees = marketingBuyFee.add(liquidityBuyFee).add(devBuyFee);
        emit UpdateBuyFees(newMarketingFee, newLiquidityFee, newDevFee);
    ...
    function updateSellFees(
        ...
        devSellFee = newDevFee;
        charitySellFee = newCharityFee;
        totalSellFees = liquiditySellFee.add(devSellFee).add(charitySellFee);
        emit UpdateSellFees(newLiquidityFee, newDevFee, newCharityFee);
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            uint256 fees = marketingFeeAmount + liquidityFeeAmount + devFeeAmount + charityFeeAmount;
    ...
    function swapAndSendDevBNB() private {
        ...
        _approve(address(this), address(uniswapV2Router), devTokens);
    ...
    function swapAndSendCharityBNB() private {

        uint256 charityTokens = balanceOf(address(this));
        ...
        _approve(address(this), address(uniswapV2Router), charityTokens);
...
contract GOODEXDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("GOODEX_Dividend_Tracker", "GOODEX_Dividend_Tracker") {
    	claimWait = 3600;
