...
//@dev A control contract to create and view Ballots using the PTBallot contract
contract YourContract {
    PTBallot public newBallot;
    address[] public deployedBallots;
        /**
     * @dev Starts an election by deploying a Ballot from the PTBallot contract
     ...
     */
    function startElec (bytes32[] memory candidateNames, bytes32[] memory candidateParties, address myAddress, uint8 amountOfDays) public returns (address) {
