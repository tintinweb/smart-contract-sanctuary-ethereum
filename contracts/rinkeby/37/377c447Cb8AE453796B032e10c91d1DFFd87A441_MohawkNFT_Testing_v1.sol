...
contract MohawkNFT_Testing_v1 is ERC721r, Ownable{
...
//    bool public stoppedEarlyMint = false;
    ...
    constructor(string memory _baseTokenURI,uint256 _totalSupply) ERC721r("MohawkNFT_Testing_v1", "MWHK",_totalSupply)
     {
