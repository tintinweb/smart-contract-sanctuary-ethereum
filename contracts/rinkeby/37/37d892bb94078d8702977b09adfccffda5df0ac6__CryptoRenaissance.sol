...
contract _CryptoRenaissance is ERC721("Crypto-Renaissance", "CrypRen") {
    ...
    address constant REN_TEAM = address(0x9b4cf38AFD94F1905B3BAD74DddbcadD21466990); // change this to your address
    ...
    function tokenURI(uint256 tokenId) public override view returns (string memory) {
        ...
        return string(abi.encodePacked(revealedURI, "/", _toString(tokenId), ".png"));
    }
