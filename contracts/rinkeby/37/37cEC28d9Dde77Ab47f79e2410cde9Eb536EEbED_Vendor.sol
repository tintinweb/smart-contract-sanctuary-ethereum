...
contract Vendor is Ownable {
  ...
  function buyTokens() external payable {
    // This require is making sure the vendor has enough tokens to cover the purchase request
    require(yourToken.balanceOf(address(this)) >= msg.value * tokensPerEth, "Not enough tokens for your purchase");
