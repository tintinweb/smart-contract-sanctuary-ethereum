...
contract Wrapper is ERC4907, IWrapper, IERC721Receiver {
    ...
    Counters.Counter private _upgradedTokenCount;
    ...
    function setTokenContract(address tokenContract_) public {
        _tokenContract = tokenContract_;
    }
    ...
    function deposit(uint256 tokenId) public override {
        ...
        ERC721(_tokenContract).safeTransferFrom(
            _msgSender(),
            address(this),
            tokenId
        );
        _mint(_msgSender(), tokenId);
        _upgradedTokenCount.increment();
    ...
    /**
     * @dev Returns the number of tokens upgraded
     */
    function totalSupply() public view returns (uint256) {
        unchecked {
            return _upgradedTokenCount.current();
        }
    }
    ...
    {
        return ERC721(_tokenContract).tokenURI(tokenId);
    }
}
