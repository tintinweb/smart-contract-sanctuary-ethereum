...
contract EthereumEstatesTest is ERC721, Ownable, ReentrancyGuard {
  ...
  constructor(
    uint256 _maxEthereumEstatesTest,
    uint256 _maxEthereumEstatesTestPerPurchase,
    uint256 _maxEthereumEstatesTestWhitelistCap
  ) ERC721("EthereumEstatesTest", "ETES") {
    MAX_Ethereum_Estates = _maxEthereumEstatesTest;
    MAX_Ethereum_Estates_PER_PURCHASE = _maxEthereumEstatesTestPerPurchase;
    MAX_Ethereum_Estates_WHITELIST_CAP = _maxEthereumEstatesTestWhitelistCap;
  }
  ...
  function presaleMint(uint256 _quantity, bytes calldata _whitelistSignature) external payable nonReentrant {
    ...
    _safeMintEthereumEstatesTest(_quantity);
  }
  ...
  function _safeMintEthereumEstatesTest(uint256 _quantity) internal {
  ...
  function mintReservedEthereumEstatesTest() external onlyOwner {
