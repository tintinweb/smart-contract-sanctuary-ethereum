...
contract VinciNFT is ERC721Royalty, Ownable {
    ...
    function mintBatchTo(uint[] memory tokenIds, address _to) public onlyOwner {
        require(tokenIds.length < 50, "max 50 tokenIds per patch");
