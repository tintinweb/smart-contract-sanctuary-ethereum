// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"OnChainKevin", unicode"First on-chain Kevin derivative.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e26bd562-b597-4ead-ae3c-2576eab437f1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e26bd562-b597-4ead-ae3c-2576eab437f1", "", 0, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");

        constructor() ERC721A(unicode"OnChainKevin", unicode"DERP") {
            TIERS[0] = [9,38,87,138,263,410,1055];
TIERS[1] = [14,19,55,93,122,177,180,197,343,800];
TIERS[2] = [10,11,31,32,33,42,52,58,77,87,92,105,108,129,207,229,265,432];
TIERS[3] = [7,9,28,32,34,48,50,56,60,108,109,143,185,203,224,317,387];
TIERS[4] = [12,74,82,200,335,583,714];
TIERS[5] = [108,235,385,571,701];
TIERS[6] = [28,30,43,66,67,69,86,93,96,108,135,150,174,203,286,366];
TIERS[7] = [270,778,952];
TIERS[8] = [4,9,102,163,163,163,195,220,237,279,465];
        }
