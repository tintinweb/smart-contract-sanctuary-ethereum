...
// File: contracts/UglyElfHiddenSociety.sol
...
contract UglyElfHiddenSociety is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ugly Elf Hidden Society", "UEHS") {
    setHiddenMetadataUri("ipfs://QmSXk1h6JFHGdPUYdxapkYshhN1GUe9FQMtwdxmiDc7RX9/hidden.json");
  }
