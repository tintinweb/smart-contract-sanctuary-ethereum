...
contract Staking is XCoin {
    ...
    uint256 public rewardRate = 10**16;

    constructor(
        string memory name,
        string memory symbol,
        uint256 initialSupply
    ) XCoin(name, symbol, initialSupply) {}
    ...
    function withdrawRewards() public {
        ...
        // set the date of the last reward update
        users[msg.sender].lastRewardUpdate = block.timestamp;
    ...
    function computeReward(address _user) public view returns (uint256) {
        ...
        uint256 ratioOwned = users[_user].stakedAmount / totalStakedAmount;
        return
