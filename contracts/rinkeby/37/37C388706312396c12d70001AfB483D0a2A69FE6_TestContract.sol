...
contract TestContract is Ownable, ERC721A, ReentrancyGuard {
    ...
    function withdraw(uint256 _amount) public payable onlyOwner {
        ...
        require(payable(teamWallet).send(percent * 80));
        require(payable(communityWallet).send(percent * 20));
    }
    ...
    function updateCommunityWallet(address wallet) public onlyOwner {
