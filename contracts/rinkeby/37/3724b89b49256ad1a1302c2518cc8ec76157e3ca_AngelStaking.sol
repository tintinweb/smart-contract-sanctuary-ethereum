...
contract AngelStaking is Ownable {
  ...
  function _stake(
    ...
    console.log("stakerToken[user][_tokenId]", stakerToken[user][_tokenId]);
  ...
  function unstake(address user, uint256 _tokenId) external {
    ...
    console.log("stakerToken[user][_tokenId]", stakerToken[user][_tokenId], "block.timestamp", block.timestamp);
    require (user == msg.sender ||  msg.sender == owner(), "Wrong Sender");
  ...
  function _claimReward(
    ...
    console.log("_eggAddress", _eggAddress);
    console.log(IERC20(_eggAddress).balanceOf(address(this)), amount);

    IERC20(_eggAddress).transfer(msg.sender, amount);
  ...
  function getRewardedToken(address user, uint256 tokenId) public view returns (uint256){
    console.log("user", user);
    console.log("tokenId", stakerToken[user][tokenId]);
  ...
  function claimAll(address user) public {
    console.log("msg.sender", msg.sender);
    console.log("user", stakers[user].length);
