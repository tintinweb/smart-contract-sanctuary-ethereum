...
contract ASCIIBirds is ERC721A, Ownable, ReentrancyGuard {
    uint256 private _collectionSize = 2222;
    uint256 private _batchSize = 2;
    bool private _paused = true;
    string private _baseTokenURI;

    constructor() ERC721A("ASCIIBirds", "Bird") {}

    function _baseURI() internal view virtual override returns (string memory) {
        return _baseTokenURI;
    }

    function privateMint(address to, uint256 quantity) public onlyOwner {
        require(
