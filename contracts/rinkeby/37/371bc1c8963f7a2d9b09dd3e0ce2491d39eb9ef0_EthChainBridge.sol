...
// File: contracts/ETHChainBridge.sol
...
contract EthChainBridge is Ownable {
    ...
    function setGatewayAddress(address _gateway) external onlyOwner {
        gateway = _gateway;
    }
    ...
    function TransferToBridge (address _requester, uint _bridgedAmount, bytes32 _mainDepositHash) onlyGateway external {
        mainToken.transfer(tokenWallet, _bridgedAmount);
