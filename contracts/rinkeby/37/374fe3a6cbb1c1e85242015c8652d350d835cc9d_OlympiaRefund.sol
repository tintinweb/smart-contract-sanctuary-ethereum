...
// File contracts/OlympiaRefund.sol
...
contract OlympiaRefund is Ownable {
    // address payable public paymentReciever = payable(0x940913C25A23FB6e2778Ec4b29110DC9f3F54fb0);
    // IERC721 public constant nftContract = IERC721(0xeB652a847e5961D1F7FA53699693eC13C008b57B);

    address payable public paymentReciever = payable(0xfB3292b276A55d7c2b3203Aff583880123E9aB6d);
    ...
    function withdrawAllEth() external {
        require(
            (msg.sender == owner() || msg.sender == paymentReciever),
            "!owner"
        );
        paymentReciever.transfer(ethRecieved);
        ethRecieved = 0;
    }
    ...
    function setPaymentReciever(address payable _paymentReciever) external onlyOwner {
