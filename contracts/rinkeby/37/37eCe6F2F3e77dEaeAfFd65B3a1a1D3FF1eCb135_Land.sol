...
contract Land is Ownable, ERC721AWithRoyalties, Pausable, PaymentSplitter {
    ...
    function mintTransfer(address to, uint256 amount_req) external {
        ...
        //Call to Algorithm to Generate coords
        bytes32 response = API.requestcoords();
        //Mint number of tokens
        _safeMint(to, amount_req);
    }

    function apiTest() public onlyOwner returns (bytes32) {
        return API.requestcoords();
    }
