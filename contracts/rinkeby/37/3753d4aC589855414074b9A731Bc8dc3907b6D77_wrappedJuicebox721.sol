...
contract wrappedJuicebox721 is Context, Ownable {
    ...
    function totalSupply() public view returns (uint256) {
        return juicebox721Contract._tokenId() + 1;
    }

    function mintableAmount() public view returns (uint256) {
        return totalSupply() - reedemableSupply;
    }
    ...
    function setMintingStatus(bool _newStatus) public onlyOwner notLocked {
        mintingStatus = _newStatus;
    }
