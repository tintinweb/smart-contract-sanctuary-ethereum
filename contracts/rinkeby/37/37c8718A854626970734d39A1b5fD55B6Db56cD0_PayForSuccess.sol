...
contract PayForSuccess {
    ...
    string public contractName = "Pay4Success";
    ...
    event ClinialResult(address submitter, string documentURI, uint32 clinicalTrialStage);
    ...
    function depositAssets(
        ...
        emit CallValidators(msg.sender, altAddress, amount, assetAddress, EventFlags.DEPOSITED);
    }
    ...
    function depositEth() public payable {
        ...
        emit CallValidators(
            msg.sender,
            "alternate", //alternate address same
            msg.value,
    ...
    function submitClinialResult(string calldata documentURI, uint32 clinicalTrialStage) public {
        emit ClinialResult(msg.sender, documentURI, clinicalTrialStage);
    }
