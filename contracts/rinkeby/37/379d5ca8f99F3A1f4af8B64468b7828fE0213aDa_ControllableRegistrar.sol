...
StartOnlyCallbackMinml {
    ...
    constructor() 
    RegistrarWithDeployerPrimitive(address(0), "faf", "af"){
        assignedContract[bytes4(keccak256("changeRegistrarControlledKeys(bytes32,bool)"))] = address(0);
        assignedContract[bytes4(keccak256("setInformation(bytes32,address,uint256)"))] = address(0);   
        RESOLVER = IResolverWithControl(address(0));
    }
    ...
    //     RESOLVER = IResolverWithControl(resolver);
    // }
