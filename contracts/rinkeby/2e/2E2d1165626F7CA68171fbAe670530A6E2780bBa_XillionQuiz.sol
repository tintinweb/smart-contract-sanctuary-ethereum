...
contract XillionQuiz is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function changeQuizSettings(
      uint256 quizId_,
      address quizTokenAddess,
      uint256 tokensRewardAmount,
      uint256 tokensAmountPerWallet,
      QuizState _stateQuiz
    ) external onlyOwner{
      Quiz memory quiz_ = idToQuiz[quizId_];

      quiz_.tokensRewardAmount = tokensRewardAmount;
      quiz_.tokensAmountPerWallet = tokensAmountPerWallet;
      quiz_.quizTokenAddess = quizTokenAddess;
      quiz_.quizState = _stateQuiz;
  ...
  function withdrawAllERC20(address contractAddress) external onlyOwner {
     ...
     /**
     * @notice changes multiplier depends on reward roles
     * @param baseRoleMultiplier_ Base...
     * @param advancedRoleMultiplier_ Advanced...
     * @param epicRoleMultiplier_ Epic...
     */
    function changeRewardRoleMultipliers(
      uint256 baseRoleMultiplier_,
      uint256 advancedRoleMultiplier_,
      uint256 epicRoleMultiplier_
    ) external onlyOwner {
