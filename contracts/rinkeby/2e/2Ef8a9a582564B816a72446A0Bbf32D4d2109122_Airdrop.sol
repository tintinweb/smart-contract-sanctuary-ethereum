...
contract Airdrop is ERC721A, Ownable {
    ...
    constructor(address _proxyRegistryAddress, bytes32 _root) ERC721A("Airdrop TEST", "AIR", 100) {
    ...
    function claim(uint256 _quantity, bytes32[] memory _proof) public payable {
