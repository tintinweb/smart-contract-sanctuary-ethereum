...
//    /  |/  (_)___  (_)    | |  / /  _/ /__(_)___  ____ ______
//   / /|_/ / / __ \/ /     | | / // // //_/ / __ \/ __ `/ ___/
//  / /  / / / / / / /      | |/ // // ,< / / / / / /_/ (__  ) 
// /_/  /_/_/_/ /_/_/       |___/___/_/|_/_/_/ /_/\__, /____/  
//                                               /____/        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD00075A4260e6CdAA299F39cB5451cb2d7CEa973];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.005 ether;
  uint256 public earlyMintTokenIdCap = 350;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 30, 5555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeia753q3gxltfwaicaz6bvrka67li6s45ftfhukri7jebd3puufsry/";
...
// File: contracts/MiniVikingsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MiniVikingsContract is RamppERC721A {
    constructor() RamppERC721A("MiniVikings", "MiniV"){}
}
