...
contract TestVED1{
    ...
    function addListingMain(uint256 price, address contractAddr, uint256 tokenId) public {
    ...
    function purchaseMain(address contractAddr, uint256 tokenId, uint256 amount) public payable{
        Listing memory item = listings[contractAddr][tokenId];
        require(msg.value>=item.price*amount, "insufficient funds sent");
        balances[item.seller]+=msg.value;
