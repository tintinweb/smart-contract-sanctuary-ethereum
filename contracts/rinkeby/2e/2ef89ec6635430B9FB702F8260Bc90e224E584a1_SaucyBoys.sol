...
import "./lib/OpenseaTradeable.sol";
...
contract SaucyBoys is ERC721A, PaymentSplitter, Ownable, AccessControl, Pausable, ReentrancyGuard, Allowlist {
    ...
    PaymentSplitter(payees, shares) {
        ...
        transferOwnership(0x2961dA73F6e08EeE37EC3F488e9008004F90BbDC);
    }
    ...
    function setMaxSupply(uint amount) 
        external 
        onlyRole(DEFAULT_ADMIN_ROLE) {
        maxSupply = amount;
    }
    ...
    function setRequireAllowlist(bool value) 
        public 
        onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        || OpenseaTradeable.isApprovedForAll(owner, operator) 
