...
contract Pollen  {
  ...
  //      uint256 rewards;
    ...
    constructor() {
        ...
        PollenNFT = IPollenNft(0x72Ae5f9FCc4a97D1B52CA6d652f97ce70048eF60);
   ...
   function unstake(address _owner, uint256 tokenIndex) public  {
        ...
        PollenNFT.approve(address(this), tokenIndex);

        PollenNFT.safeTransferFrom(_owner, address(this), tokenIndex);
        
        PollenNFT._burn(tokenIndex);
    }
