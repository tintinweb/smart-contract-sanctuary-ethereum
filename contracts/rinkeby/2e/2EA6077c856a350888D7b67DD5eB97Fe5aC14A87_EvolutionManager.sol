...
contract EvolutionManager is Context, Ownable, IERC721Receiver {
    ...
    function evolveGalacticGorrilas(
        ...
        require(isMonkeysLive, "galactic gorillas evolution is not live yet");
    ...
    function evolveAlienGorilas(
        ...
        require(isMonkeysLive, "alien gorillas evolution is not live yet");
    ...
    function toggleGorrilas() external adminOrOwner {
        isGorillasLive = !isGorillasLive;
    }

    function toggleAlients() external adminOrOwner{
