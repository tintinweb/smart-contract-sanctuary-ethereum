...
import "MarketplaceWhitelistDev.sol";

contract PJFDev is ERC721, HasRoot, HasAdmin, SigVerifier, MarketplaceWhitelistDev {
    ...
    constructor(
        ...
        address root,
        address admin
    ) ERC721("UEpGTkZU yzg1roaGJ", "5tO3QZ") {
...
contract MarketplaceWhitelistDev is HasRoot {

    // Whitelist Marketplace contracts for easy trading.
    address public constant openSeaProxyAddress =
        address(0x1E525EEAF261cA41b809884CBDE9DD9E1619573A); // OpenSea proxy
    address public constant looksRareAddress =
        address(0x3f65A762F15D01809cDC6B43d8849fF24949c86a); // LooksRare transfer manager
