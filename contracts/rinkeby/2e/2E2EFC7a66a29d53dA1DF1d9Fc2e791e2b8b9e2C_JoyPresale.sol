...
contract JoyPresale is ContextUpgradeable, AuthorizableU {
    ...
    // function updateVestingInfo(bool addFlag, uint8 index, uint8 _initClaimablePercent, uint256 _lockingDuration, uint256 _vestingDuration) public onlyAuthorized {
    //     if (addFlag) {
