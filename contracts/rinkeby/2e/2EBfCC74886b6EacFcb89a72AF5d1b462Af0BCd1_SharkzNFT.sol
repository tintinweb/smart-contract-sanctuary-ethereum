...
contract SharkzNFT is Initializable, UUPSUpgradeable, AdminableUpgradeable, ERC721AStructUpgradeable, ERC721ABurnableUpgradeable, ERC4907Upgradeable, IScore, EIP712WhitelistTypedUpgradeable, MintSetupUpgradeable {
    ...
    function initialize() public initializer onlyProxy {
        __Adminable_init();
        __ERC721AStruct_init("Sharkz NFT", "SHARKZNFT");
        ...
        isFreeMintActive
    {
        ...
        require(_totalMinted() + _qty <= mintConfig.freeMintBySoulIdSupply, "Reached max supply for free minting.");
    ...
    {
        require(_totalMinted() + _qty <= mintConfig.freeMintByWLSupply, "Reached max supply for free minting.");
        ...
        checkWhitelist(_signature,"presale")
    {
        ...
        require(_totalMinted() + _qty <= mintConfig.presaleMintSupply, "Reached max supply for presale minting.");
        // we use ERC721A auxiliary address data, aux field to store number presale minted
...
contract MintSetupUpgradeable is AdminableUpgradeable {
    ...
    function __MintSetup_init_unchained() internal onlyInitializing {
        ...
        mintConfig.presaleMintStartTime = 1664539800;
        ...
        mintConfig.publicMintStartTime = 1664539800;
    }
