...
contract Shuakipies is ERC1155Supply, Ownable
{
    ...
    string public name = "Shuakipies";

    uint public reservedTokensMinted = 0;

    string public contractURIstr = "";

    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmXr4Z4CYJ2L7XqsGWhcSqRY1WPocTWCeywzwPPgo51Jof/{id}.json") {}
