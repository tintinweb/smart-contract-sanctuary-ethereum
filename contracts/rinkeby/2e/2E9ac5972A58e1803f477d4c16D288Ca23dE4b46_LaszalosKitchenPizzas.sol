...
interface IERC165 {
...
} contract LaszalosKitchenPizzas is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    modifier ingredientContract() {
        require(msg.sender == ingredientAddress, "action not allowed");
        _;
    }
    ...
    uint256 [] pizzaIds;
    constructor() ERC721("Laszalos Kitchen Pizzas", "LKP") {}
    ...
    function updatePizzaList(uint256 pizzaId, address from, uint256 _pizzaId, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings, bool isRandom, bool unbaked, bool calculated, uint256 rarity) public ingredientContract {
    ...
    function setIngredientContract(address ingredient) public { //onlyOwner
        ingredientAddress = ingredient;
    }
    ...
    function randomBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings ) public ingredientContract {
    ...
    function bakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) public ingredientContract {
        _nftIds.increment();
        uint256 _nftId = _nftIds.current();
        _mint(msg.sender, _nftId);
        _setTokenURI(_nftId, metadata);
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings ) public ingredientContract {
        PizzasResponse memory pizzasResponse = PizzasResponse(
            0,
            base,
            sauce,
    ...
    function unbakePizza( uint256 _pizzaId ) public onlyNFTOwner(_pizzaId) ingredientContract {
    ...
    function rebakePizza( uint256 _pizzaId, string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings ) public onlyNFTOwner(_pizzaId) ingredientContract {
