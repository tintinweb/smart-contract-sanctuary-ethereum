...
contract AlvinEyes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ALVINEYES", "AES") {
    setHiddenMetadataUri("ipfs://QmU5RsBZxEVA1PaMB1aFFSfgiQz6HxkixF9JXBXfBemEg8/hidden.json");
  }
