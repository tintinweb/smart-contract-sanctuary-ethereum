...
contract Testsquare is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("squareeeeee", "SQE") {

        _tokenIdCounter.increment();
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmXakRWyynLrDtMytnbyfBtYgiLLyE4uHkbSHyLjUxgdJh/";
    }
    ...
    function safeMint(address to) public payable {
        ...
        require(totalSupply() < MAX_SUPPLY, "no more mintable tokens");
