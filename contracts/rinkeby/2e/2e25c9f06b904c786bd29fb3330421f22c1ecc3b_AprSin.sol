...
contract AprSin is ERC721 {
    ...
    event testAddr(address indexed addr1, address indexed addr2);
    ...
    function testSender(uint256 tokenId) public {
        address _owner = ERC721.ownerOf(tokenId);
        emit testAddr(_msgSender(), _owner);
    }
}