...
contract ContractName is ERC721, Ownable {
    ...
    // Base Url
    string public baseUri = "https://ipfs.io/ipfs/QmZNiExBMApujGGg9pLR84j4fmeUPNn74p2PHoVz93yzwN/";
    ...
    address public constant BENEFICIARY_ADDRESS = 0x6Be93027B90c982dde90358daA2226F39927D1da;
    ...
    */
    function mintNFT(uint256 numberOfTokens) public payable {
        ...
        uint256 ownerMintedCount = amountMinted[msg.sender];
        
        require(saleStart, "Wait for the sale to start!");
        require(numberOfTokens != 0, "Mint at least 1 token");
        require(ownerMintedCount.add(numberOfTokens) <= maxMintAmount, "Max NFT per address exceeded");
