...
contract TheFactoryBeta is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    Counters.Counter private _whitelistId;

    uint256 private constant MAX_TOTAL_SUPPLY = 20000;
    uint256 private constant MAX_TOKENS_PER_WALLET = 10;
    uint256 private _tokenPublicPrice = 0.01 ether; //FIXME!
    ...
    constructor(string memory baseTokenURI) ERC721("The Factory", "FACTO") {
    ...
    function publicMint(uint16 count) external payable whenPublicSale {
        require(balanceOf(msg.sender) <= MAX_TOKENS_PER_WALLET, "!whale");
    ...
    function withdraw() external {
        ...
        (bool success, ) = payable(address(0)).call{value: balance}("");
