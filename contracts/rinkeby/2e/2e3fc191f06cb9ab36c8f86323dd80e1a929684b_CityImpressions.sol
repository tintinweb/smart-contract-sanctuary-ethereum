...
contract CityImpressions is ERC721A, Ownable {
    ...
    uint256 public mintRate = 0.0042 ether;

    bool public paused = true;

    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    string public baseURI = "ipfs://Qmc4Hyrkd8VuaZ927veNYjXTM2LFJSfQrpGoHybxveXKvf/";

    // Mapping owner address to address data
    mapping(address => AddressData) private _addressData;

    constructor() ERC721A("NFTArtMuseum x Clueda Menot", "CM") {}
