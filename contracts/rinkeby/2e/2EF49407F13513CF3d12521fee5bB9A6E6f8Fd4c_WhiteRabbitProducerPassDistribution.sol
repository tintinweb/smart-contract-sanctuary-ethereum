...
/**
 * @dev Our previous producer pass contract did not allow different amount per address on allow list
    This contract exists to distribute producer pass supply differently per wallet with merkle tree
 */
contract WhiteRabbitProducerPassDistribution is ERC1155Holder, Ownable {
    ...
    // _userPassesMintedPerTokenId[msg.sender][episodeId] => number of minted passes
