...
contract CSCollectionOne is ERC721, IERC2981, Ownable {
    ...
    mapping(uint256 => bool) public claimedToken;

    CSInterface public collectiveStrangersContract =
        CSInterface(0xc442e0dAcef8842eA0DFAe3ad83E54ebbFF18a71);

    constructor(string memory _baseURI)
        ERC721("CSCollectionOne", "CSTRNGRS1")
        Ownable()
    {
    ...
    function airdropToken(address _to, uint8 _tokenId) external onlyOwner {
        _mint(_to, _tokenId);
    }
    ...
    function updateCSContract(CSInterface _contractAddress) external onlyOwner {
        collectiveStrangersContract = _contractAddress;
    }
