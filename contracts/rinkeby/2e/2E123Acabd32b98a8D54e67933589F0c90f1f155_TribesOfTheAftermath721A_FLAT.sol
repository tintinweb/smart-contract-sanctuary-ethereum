...
contract TribesOfTheAftermath721A_FLAT is ERC721A, Ownable {


    using Strings for uint256;

    string internal contractName = "TOTA 7K TEST v1";
    string internal contractAbbr = "TOTA7Kv1";

    string public uriPrefix = "";
    string public uriSuffix = "";
    string public hiddenMetadataUri = "ipfs://QmZtQ7Gbh6HTbV9ZtNy8vnhk6orj5y7kQai8MoVmAXe55s/tota.json";
    bool public isRevealed = false;
    
    uint256 public preSaleCost = 0.01 ether;
    uint256 public pubSaleCost = 0.02 ether;    // 0.08 for production
    
    uint256 public maxPresalePerWallet = 2;     // 
    uint256 public maxMintAmountPerTx = 5;      //

    uint256 public maxSupply = 50;              // 8888 for production 
    uint256 private reservedForOwner = 10;      //
    address private ownerAddress = 0x18F1005F7396F91e2aDa919B3Da3Fb487A3b8069;
    ...
    address internal devWalletAddress = 0xd5070aaEB21F31897cfF5626415cDb9914B07a26;
    ...
    constructor() ERC721A(contractName, contractAbbr) {
        ...
        _safeMint(ownerAddress, reservedForOwner);
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        require(isSaleActive, "The public sale is not active!");
