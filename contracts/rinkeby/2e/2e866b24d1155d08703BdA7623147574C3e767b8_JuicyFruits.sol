...
contract JuicyFruits is ERC721, ERC721Enumerable, Ownable {

	
	uint public constant MAX_TOKENS = 2222;
	uint public constant MAX_TOKENS_VIP = 0;
	
	address private constant devAddress = 0xA2efE2b517Ed04b8f3707e47151b7F5b8621d833;
	...
	constructor() ERC721("JuicyFruits", "JF") {
		setBaseURI("http://api.juicyfruitsnft.com/juicy/");
	}
	...
	function mintNFT(uint _mintAmount, bytes32[] memory proof) external payable {
		...
		require(payable(devAddress).send( ((msg.value / 100) * 10) ));
	}
