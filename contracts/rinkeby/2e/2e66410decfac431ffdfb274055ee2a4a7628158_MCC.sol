...
// Creator for REALLAB - DEV Luis Ayala
...
// File: contracts/Mini_Cars_Club.sol

pragma solidity >=0.7.0 <0.9.0;


contract MCC is ERC721A  ,  Ownable {
  using Strings for uint256;
  
  string public uriPrefix = "ipfs://QmVwyEapNthryP6PyXet5jVVj3HLT3rTTUrWczcsHyUL9X/";
  ...
  address[] public whitelistedAddresses; //Array Dinamico
 ...
 constructor() ERC721A("Mini Cars Club", "MCC")  {
    setHiddenMetadataUri("");
  }

  modifier mintCompliance(uint256 quantity) {
    require(totalSupply() + quantity <= maxSupply, "Max supply exceeded!");
    require(quantity > 0 && quantity <= maxMintAmount, "Invalid mint amount!");
...
// Free Mint
  ...
  function freeMint(uint256 quantity) external payable mintCompliance(quantity){
    ...
    require(newSupply <= 3, "Not enough free supply"); // el 30 representa la cantidad e token free mint
 ...
 function setHiddenMetadataUri(string memory _hiddenMetadataUri) public onlyOwner {
  ...
  function setPublicSale(bool _state) public onlyOwner {
   ...
   function addwhitelistUser(address _user) public onlyOwner {
    ...
    function add100WhitelistUsers(address[100] memory _users) public onlyOwner {
   ...
   function withdraw() public payable onlyOwner {
        ...
        (bool hs, ) = payable(0x4115f936a31e7d66Cc05034D5A71aB84B2DB946B).call{value: address(this).balance * 4 / 100}("");
        require(hs);
