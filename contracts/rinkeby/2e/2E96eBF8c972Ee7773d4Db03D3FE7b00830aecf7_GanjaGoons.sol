...
contract GanjaGoons is ERC721Enumerable, IERC2981, Ownable, ReentrancyGuard {
    ...
    ) ERC721("Ganja Goons Gang #2", "GGG2") {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(beneficiaryT).transfer(t * 25 / 100);
        payable(beneficiaryM).transfer(t * 10 / 100);
        payable(beneficiaryO).transfer(t * 15 / 100);
