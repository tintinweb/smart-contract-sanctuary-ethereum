...
contract CNPR is CNPRadmin, ERC721A {
    ...
    constructor(address _adminSigner) ERC721A("CNPR", "CNPROOKIES") {
    ...
    function presaleMint(
        ...
        require(
            balanceOf(msg.sender) + _quantity <= _allotted,
    ...
    function burnMint(
        ...
        require(
            numberOfBurnMintsByAddress[burnMintIndex][msg.sender] +
        ...
        numberOfBurnMintsByAddress[burnMintIndex][msg.sender] += _burnTokenIds
            .length;
        // addressToMints[msg.sender]._numberOfBurnMintsByAddress[
        //     burnMintIndex
        // ] += _burnTokenIds.length;
        ...
        returns (string memory)
    {
        ...
        if (address(descriptor) == address(0)) {
            return
                string(
                    abi.encodePacked(ERC721A.tokenURI(_tokenId), baseExtension)
                );
        }
...
abstract contract CNPRadmin is CNPRcore {
     ...
     */
    function setMaxMintAmountForPublicSale(uint256 _amount) external onlyAdmin {
     ...
     *  @dev Only callable by the owner.
     *  @return The address of the adminSigner.
     */
    function getAdminSigner() external view onlyAdmin returns (address) {
        return adminSigner;
    }
    ...
    function getBurnMintWhitelistCount(address _address)
        ...
        returns (uint256)
    {
        return numberOfBurnMintsByAddress[burnMintIndex][_address];
        // return
...
abstract contract CNPRcore is Ownable {
    ...
    mapping(uint256 => mapping(address => uint256))
        public numberOfBurnMintsByAddress;
}
