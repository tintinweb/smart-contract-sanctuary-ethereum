...
contract Cards is ERC721, ERC721URIStorage, Ownable {

event PermanentURI(string _value, uint256 indexed _id); //freeze metadata

    constructor() ERC721("Meet the Team", "MTT") {}
...
function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
        return (0xe24974150f6Ae456ca04f9708F88F2c98d9f5F19, (_salePrice * 1000) / 10000); //implement royalties
}

function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721) returns (bool) {
        return (interfaceId == type(IERC2981).interfaceId || super.supportsInterface(interfaceId)); //compatible with EIP2981
}
}
