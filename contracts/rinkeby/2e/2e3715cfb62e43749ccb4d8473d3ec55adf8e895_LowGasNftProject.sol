...
contract LowGasNftProject is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Low Gas", "TLG") {
    setHiddenMetadataUri("ipfs://QmY91BGGawcZ8VFwu7dcjtexmUqNfkQvGhxKLk5V49ZEY2/hidden.json");
  }
