...
contract NFTmint is ERC721Enumerable, Ownable {
    address Owner;
    uint256 public priceNFT = 0.1 ether;
    uint256 public MaxSupply = 10000;
    uint256 public MaxSupply1 = 0;
    uint256 public MaxSupplyPerTX = 2;
    event MintNFT (address senderAddress, uint256 NFTtoken);
    mapping(address => bool) public Whitelist;
    uint[] soldedTokenIds;

    constructor () ERC721 ("NFTmint", "NFT") {
        Owner = 0x186b6e22b1bd0cCc008Ef3e971D69Df33d91ceB4;
    }

    function GetWhitelist (address _address) public {
        require(msg.sender == Owner, "Not an Owner");
        Whitelist[_address] = true;
    }
  
    modifier checkTokenStatus(uint256 _TokenId) {
    ...
    function WhitelistMintNFT (uint256 _TokenId) public payable {
       require(Whitelist[msg.sender], "You're not Whitelisted");
        require(msg.value == priceNFT, "Invalid Price");
    ...
    function WithdrawMoney () public payable {
        ...
        require(balance > 0, "Smart contract don't have ETH");
        (bool transfer, )=(msg.sender).call{value: balance}("");
        require (transfer == true, "not transfer");
    }
}