...
contract NicMeta is ERC721Enumerable, Ownable {
    ...
    bool public _isSaleActive = false; //准許合約開賣
    bool public _revealed = false; //盲盒

    // Constants
    uint256 public constant MAX_SUPPLY = 1; //總數
    uint256 public mintPrice = 0.01 ether; //價格
    uint256 public maxBalance = 1; //每個錢包地址擁有的數量
    uint256 public maxMint = 1; //一次能mint的數量
