...
contract UnknownNFT is ERC721A, Ownable {
    ...
    function checkWhitelist(
        ...
        return isWhitelist(msg.sender, proof, merkleRoot);
    }
    ...
    function whitelistMint(
        ...
        require( isWhitelist(msg.sender, proof, merkleRoot), "UNKNOWN: not permission to whitelist mint" );
