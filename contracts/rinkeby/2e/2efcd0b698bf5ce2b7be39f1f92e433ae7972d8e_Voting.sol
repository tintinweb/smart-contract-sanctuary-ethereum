...
contract Voting is AccessControlEnumerable {
    ...
    mapping(address => mapping(uint => uint)) public uservotesbyid;
    mapping(address => mapping(uint => string)) public userchoicesbyid;
        ...
        external
    {
        ...
        uservotesbyid[msg.sender][ballotId] = choiceId;
        ...
        external
    {
        ...
        userchoicesbyid[msg.sender][ballotId] = choice;
