...
// File: contracts/cbr.sol

pragma solidity >=0.7.0 <0.9.0;

contract CBR is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    // presale
    function presaleMint(uint256 _mintAmount, bytes32[] memory _proof, bytes32 _leaf)
        public
        payable
    {
        ...
        require(verify(_proof, _leaf), "Invalid proof");
