...
contract VrhQuery {
    ...
    function dashboard(address addr, address votingEscrowAddress, address guildControllerAddress, address rewardVestingEscrowAddress) external view returns (uint[] memory) {
