...
// $$ |      $$ |$$\ $$ |  $$ |      $$ |  $$ |$$   ____|$$ |  $$ | \$$$  /  $$   ____|$$ |      
// $$$$$$$$\ \$$$$  |$$ |  $$ |      $$$$$$$  |\$$$$$$$\ $$ |  $$ |  \$  /   \$$$$$$$\ $$ |      
// \________| \____/ \__|  \__|      \_______/  \_______|\__|  \__|   \_/     \_______|\__|      
//                                                                                              
//                                                                                                                                      
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfdAbF429011323F4Db2eB23411DB1278B6913Dd3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://ipfs://QmeS8KxCz2fnvMG6EdLPckLof6dyL32qh7ED6waUjeeD8A/";
...
// File: contracts/EthDenverContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract EthDenverContract is RamppERC721A {
    constructor() RamppERC721A("Eth Denver", "CryptoPunk"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/naiKFqrPFciSc5KLUFPI/contract-metadata";
    }
}
