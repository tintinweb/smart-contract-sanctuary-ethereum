...
//    ) ERC721("Defense Force", "DFWN") {
    ) ERC721("Levi's TWO-NFT", "Levi-TWO") {
        ...
        Stage memory preSale = Stage({
            mintFee: 0.001 ether,
            maxMint: 30,
            startTime: 1651633200,//2022-05-04 11:00:00
            endTime: 1651647600,//2022-05-04 15:00:00
            isWhitelist: true
        });
        stages.push(preSale);
        ...
        Stage memory airDrop = Stage({
            mintFee: 0,
            maxMint: 40,
            startTime: 1651649400,//2022-05-04 15:30:00
            endTime: 1651662000,//2022-05-04 19:00:00
            isWhitelist: true
        });
        stages.push(airDrop);
        ...
        Stage memory sale = Stage({
            mintFee: 0.002 ether,
            maxMint: MAX_MINT,
            startTime: 1651663800,//2022-05-04 19:30:00
            endTime: 1651672800,//2022-05-04 22:00:00
            isWhitelist: false
        });
        stages.push(sale);
    }
...
contract DfNft2 is ERC721Enumerable,ERC721Burnable,ERC721Pausable,ReentrancyGuard,Ownable{
...
//    ) ERC721("Defence Force", "DFWN") {
    ) ERC721("Levi's NFT", "Levi") {
        require(feeTo != address(0) ,"feeTo is the zero address");
        ...
        Stage memory preSale = Stage({
            mintFee: 0.08 ether,
            maxMint: 4000,
            startTime: 1652112000,//2022-05-10:00:00:00
            endTime: 1652284799,//2022-05-11:23:59:59
            isWhitelist: true
        });
        stages.push(preSale);
        ...
        Stage memory airDrop = Stage({
            mintFee: 0,
            maxMint: 2500,
            startTime: 1652284800,//2022-05-12:00:00:00
            endTime: 1652457599,//2022-05-13:23:59:59
            isWhitelist: true
        });
        stages.push(airDrop);
        ...
        Stage memory sale = Stage({
            mintFee: 0.12 ether,
            maxMint: MAX_MINT,
            startTime: 1652457600,//2022-05-14:00:00:00
            endTime: 1747151999,//2025-05-13:23:59:59
            isWhitelist: false
        });
        stages.push(sale);
    }
    ...
    function mintNft(uint _count) external payable nonReentrant whenNotPaused{
        ...
        require(block.timestamp >= stages[index].startTime && block.timestamp <= stages[index].endTime, "Not on sale");

        mintNft(index,_count);
    }
    ...
    function mintNft(uint index, uint _count) private{
        ...
        uint _mintable = mintable(index,_msgSender());
        require(_mintable >= _count, "There's not enough surplus");
        require(msg.value >= mintFee.mul(_count), "The ether value sent is not correct");
