...
contract TopWolves is ERC721, ReentrancyGuard, AccessControl {
    ...
    string private realBaseURI = "https://topwolves.mypinata.cloud/ipfs/QmUQfkgorwUAvpEhXfB6gLN3UYG1ghVF9hAPkzfQoFtDD5/";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if(revealStatus) {
            ...
            return string(abi.encodePacked(_baseURI(), "QmQ4JY9Gnwmftdb7Q1WNQ7Rrtf4yt8FaQyZTX7uK8vAgSw"));
        }
    }
