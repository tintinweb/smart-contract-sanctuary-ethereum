...
contract AlMighty is Ownable, ERC721A, ERC2981, ReentrancyGuard {
    enum SalePhase {
        unavailable,
        whitelistMint,
        publicMint
    ...
    bytes32 public rootHash =
        0x9ee14b1dba7b5bd030eaee955150dbbe3b5bc868da80fdeb7d9fc73af74ed438;

    uint96 public ROYALTY_PERCENTAGE = 750;

    uint256 public immutable MAX_FREE_PER_WALLET = 1;
    uint256 public immutable MAX_SUPPLY = 66;
    uint256 public immutable MAX_TX_PER_WALLET = 2;
    uint256 public immutable SALE_PRICE = 0.001 ether;
    uint256 public immutable MAX_WHITELIST_TX = 6;

    string internal prerevealURI = "";
    string internal baseURI = "";

    SalePhase public SALE_PHASE = SalePhase.unavailable;
    ...
    constructor() ERC721A("AlMighty", "AlMighty") {
