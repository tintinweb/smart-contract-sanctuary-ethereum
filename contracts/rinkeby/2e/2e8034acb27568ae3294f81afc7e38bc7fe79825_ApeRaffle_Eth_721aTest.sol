...
contract ApeRaffle_Eth_721aTest is ERC721A, Ownable {

    uint256 public apePrice = 8000000000000000;
    uint public maxApePurchase = 24;
    uint public ApeSup = 1000;
    bool public drop_is_active = false;
    bool public presale_is_active = true;
    string public baseURI = "https://ipfs.io/ipfs/QmWvbVMFQLE6CH77P6TqRQw3Y1aD9TL24nj6tTmyLZqdE5/";
    ...
    constructor() ERC721A("ApeRaffle_Eth", "APEONE",24, 10000){
    ...
    function PresaleMint(uint256 numberOfTokens) public payable{
        ...
        require(whitelist[msg.sender].presalemints + numberOfTokens <= maxApePurchase,"This Wallet has already minted its 10 reserved APERFL's");
