...
contract PricingModuleV1 is IDepositHandler, AccessControlEnumerable {
    ...
    event TokenPriceUpdated(uint256 indexed oldPrice, uint256 newPrice);
    event VestedTokenPriceUpdated(uint256 indexed oldPrice, uint256 newPrice);
    ...
    constructor(
        ...
        require(
            ...
            "PricingModuleV1::constructor::ZERO: USDT cannot be zero address."
        );
        ...
        VESTED_TOKEN_PRICE = vestedTokenPrice;
    ...
    function setVestedTokenPrice(uint256 newPrice) external onlyRole(DEFAULT_ADMIN_ROLE) {
        uint256 oldPrice = VESTED_TOKEN_PRICE;
        VESTED_TOKEN_PRICE = newPrice;

        emit VestedTokenPriceUpdated(oldPrice, newPrice);
    }
        ...
        )
    {
        ...
        uint256 tokenPrice = isVested ? VESTED_TOKEN_PRICE : TOKEN_PRICE;
        ...
        if (!isVested) {
            ...
            usdtCost += (nonFungibleTokenDeposits.length + multiTokenDeposits.length) * tokenPrice;
        }
