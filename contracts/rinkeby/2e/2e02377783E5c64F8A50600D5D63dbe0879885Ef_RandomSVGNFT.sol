...
contract RandomSVGNFT is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    // event RequestRandomSVG(uint256 indexed requestId, uint256 indexed tokenId);
    ...
    constructor(
        ...
        ERC721("Random On-Chain SVG NFT", "rSVGNFT")
    {
        ...
        override
    {
        ...
        uint256 tokenId = s_tokenCounter;
        s_tokenCounter = s_tokenCounter + 1;
        string memory svg = generateSVG(randomWords[0]);
        ...
        // tokenIdToRandomNumber[tokenId] = randomWords[tokenId];
        // emit CreatedUnfinishedRandomSVG(tokenId, randomWords[tokenId]);
    }
        ...
        returns (string memory finalSVG)
    {
        ...
        finalSVG = string.concat(finalSVG, "</svg>");
    }
    ...
    //     );
    //     require(s_tokenCounter > _tokenId, "TokenId has not been minted yet!");
    //     require(
