...
contract MoonVaginas is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public _price = 100000000000; // 0.06969 ETH
	...
	function teamReservedTokensMint(uint256 _amount)
		...
		require(
            current <= maxSupply - teamTokens -teamTokensMinted,
            "MoonVaginas: Max supply exceeded"
        );

        require(
            teamTokensMinted != teamTokens,
    ...
    function publicSaleMint(uint256 _amount) external payable onlyAccounts {
        ...
        //Add of teamTokens - teamTokensMinted
        require(
