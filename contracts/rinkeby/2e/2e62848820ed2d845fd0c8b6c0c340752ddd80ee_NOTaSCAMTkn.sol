...
// File: contracts/NOTaSCAMTkn.sol
...
contract NOTaSCAMTkn is ERC20, Ownable {
    ...
    constructor() ERC20("NOTaSCAMTkn", "NaSCTkn") {}
    ...
    function buyOnPresale() public payable {
        ...
        require(
            cost > 0,
            "The cost has not been properly set!"
        );
    ...
    function setStageAndCost(uint8 _stg, uint256 _cost) public onlyOwner {
        stage = _stg;
        cost = _cost*10**decimals();
    }
