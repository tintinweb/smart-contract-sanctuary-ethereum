...
// File: MeltingPlanets.sol

contract MeltingPlanets is ERC721, Ownable, VRFConsumerBase {
    using SafeMathChainlink for uint256;

    uint256 public tokenCounter;
    bytes32 public keyhash;
    uint256 public fee;
    uint256 public constant planetPrice = 0.08 ether;
    ...
    function createCollectible(uint256 numberOfTokens)
        public
        payable
        returns (bytes32)
    {
        ...
        require(
            planetPrice * numberOfTokens <= msg.value,
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        Planet planet = Planet(randomNumber % 3);
