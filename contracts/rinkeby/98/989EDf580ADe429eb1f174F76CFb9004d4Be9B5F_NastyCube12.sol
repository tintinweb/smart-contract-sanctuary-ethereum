...
contract NastyCube12 is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    if (msg.value == 0 && freeBuy[msg.sender] == false && mintLimitCount < freeMintLimit) {
    ...
    require(limitToBuy[msg.sender] < freeMintLimit, 'You bought a maximum');
    _;
