...
contract HONEY is ERC20, Pausable, Ownable, ReentrancyGuard {
    uint256 public constant EMISSION_RATE = 57870370370370; // 5 per day

    IERC721 private constant _bearCartel =
        IERC721(0xBe5421A897D9bEc75EA2009249c2f40f2B311eCd);
    ...
    function burnBears(uint256[] memory tokenIDs)
        ...
        callerIsSender
    {
        uint256 honeyPerToken = 1000000000000000000 * 250; // 250 HONEY per token
        ...
        for (uint256 i = 0; i < tokenIDs.length; i++) {
            ...
            _bearCartel.safeTransferFrom(msg.sender, address(0), tokenIDs[i]);
        }
