...
contract NFTFactory {
    ...
    function createDDAT(uint256 _maxTokens, string memory _assetName, string memory _ticker, uint256 _price, uint256 _preSalePrice, address _verifyingAccount) 
        public
        returns (NFTContract)
    {
        //increases the index
        ...
        NFTContract newNFTContract = new NFTContract(_maxTokens, _assetName, _ticker, _price, _preSalePrice, _verifyingAccount);
