...
contract LoserClub is ERC721A, Ownable {
  ...
  constructor() payable ERC721A('Loser Club', 'LOSERCLUB') {
    ...
    allowlistSaleTime = 1637978400; // @todo set minting date
  ...
  */
  ...
  function withdraw() external onlyOwner {
    ...
    (bool success, ) = mainWallet.call{ value: balance }('');
  ...
  */
  ...
  /**
   ...
   ============================================
  */
  function checkAllowlist(bytes32[] calldata proof_, bytes32 leaf_)
    external
    view
    returns (bool)
  {
