...
// File contracts/LoanBorrower.sol
...
// File contracts/TokenLoanCollateral.sol
...
// File contracts/TokenFractionalize.sol
...
// File contracts/LoanTreasury.sol
...
// File contracts/LoanOrchestrator.sol
...
contract LoanOrchestrator {
    ...
    function activateLoan(uint256 _loanId, uint256[] memory _bids) public payable {
        ...
        for (uint256 i = 0; i < _bids.length; i++) {
            ...
            require(ethAmount >= bid.acceptedAmount, "not enough funds to activate loan");
...
// File contracts/LoanAuction.sol
...
// File contracts/LoanArbiter.sol
...
contract LoanArbiter is Ownable {
    ...
    function createLoanCampaign(
        ...
        require(msg.value == amount, "eth must be equal fee amount");
