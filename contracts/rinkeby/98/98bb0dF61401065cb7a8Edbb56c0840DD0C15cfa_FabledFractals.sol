...
contract FabledFractals is ERC721("Flames by Fabled Fractals | Official Collection RINKEBY2", "FLAME"), ERC721Enumerable, Ownable {
    ...
    address[] public whitelist_addresses;
    mapping(address => uint256) public whitelist_limits;

    address[] public giveaway_addresses;
    mapping(address => uint256) public giveaway_limits;

    address[] public airdrop_addresses;
    mapping(address => uint256) public airdrop_limits;
