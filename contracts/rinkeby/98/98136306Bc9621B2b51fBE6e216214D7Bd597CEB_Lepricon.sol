...
// File: contracts_real/erc20_token.sol
 ...
 */
 ...
 abstract contract MultiTransfer is ERC20 {
     ...
     */
    function multiTransferFrom(address from, address[] memory to, uint256[] memory value) public returns (bool) {
        require(to.length > 0, "Empty array");
        require(value.length == to.length, "Length mismatched");
...
contract Lepricon is MultiTransfer {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () ERC20("Lepricon Token", "L3P") public {
