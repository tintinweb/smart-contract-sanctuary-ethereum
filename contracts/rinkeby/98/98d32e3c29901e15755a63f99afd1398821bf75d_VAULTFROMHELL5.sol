...
contract VAULTFROMHELL5 is Ownable, IERC721Receiver {
    struct vaultInfo {
        IERC721 nft;
        string name;
    }
    ...
    function _stakeBGF(uint256[] calldata tokenIds) internal {
        ...
        uint256 holdsFamiliar = IERC721(familiars).balanceOf(msg.sender);
    ...
    function _claim(uint256[] calldata tokenIds, bool _unstake) internal {
        ...
        uint256 userFamiliars = IERC721(familiars).balanceOf(msg.sender);
