...
contract Kinkverse is ERC721A, Ownable, ReentrancyGuard {
    ...
    //Mint limits
    uint256 public ADDRESS_MAX_MINTS = 4;
    uint256 public ADDRESS_OG_MAX_MINTS = 1;
    uint256 public ADDRESS_WL_MAX_MINTS = 4;
    uint256 public PUBLIC_MINT_PER_TX = 4;
        ...
        payable
    {
        ...
        require(
            totalSupply() + numberOfMints <= maxSupply - 500,
