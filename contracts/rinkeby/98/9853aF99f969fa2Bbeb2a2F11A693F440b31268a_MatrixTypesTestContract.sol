...
contract MatrixTypesTestContract {
    ...
    address[3][] address_Fixed_x_Dynamic_MatrixValue;
    address[][2] address_Dynamic_x_Fixed_MatrixValue;
    address[2][3] addressFixedMatrixValue;

    // // matrix of booleans
    bool[][] boolDynamicMatrixValue;
    bool[3][] bool_Fixed_x_Dynamic_MatrixValue;
    bool[][2] bool_Dynamic_x_Fixed_MatrixValue;
    bool[2][3] boolFixedMatrixValue;

    // matrix of strings
    string[][] stringDynamicMatrixValue;
    string[3][] string_Fixed_x_Dynamic_MatrixValue;
    string[][2] string_Dynamic_x_Fixed_MatrixValue;
    string[2][3] stringFixedMatrixValue;

    // // matrix of bytes
    bytes[][] bytesDynamicMatrixValue;
    bytes[][2] bytes_Dynamic_x_Fixed_MatrixValue;
    bytes[3][] bytes_Fixed_x_Dynamic_MatrixValue;
    ...
    function testAddress_Dynamic_x_Fixed_MatrixValue(address[][2] memory newValue) public {
        address_Dynamic_x_Fixed_MatrixValue = newValue;
    }

    function testAddress_Fixed_x_Dynamic_MatrixValue(address[3][] memory newValue) public {
    ...
    function testBoolean_Dynamic_x_Fixed_MatrixValue(bool[][2] memory newValue) public {
        bool_Dynamic_x_Fixed_MatrixValue = newValue;
    }

    function testBoolean_Fixed_x_Dynamic_MatrixValue(bool[3][] memory newValue) public {
    ...
    function testString_Dynamic_x_Fixed_MatrixValue(string[][2] memory newValue) public {
        string_Dynamic_x_Fixed_MatrixValue = newValue;
    }

    function testString_Fixed_x_Dynamic_MatrixValue(string[3][] memory newValue) public {
    ...
    function testBytes_Dynamic_x_Fixed_MatrixValue(bytes[][2] memory newValue) public {
        bytes_Dynamic_x_Fixed_MatrixValue = newValue;
    }

    function testBytes_Fixed_x_Dynamic_MatrixValue(bytes[3][] memory newValue) public {
    ...
    // many matrix params
    function testManyMatrixParams(
        int128[3][2] memory int128FixedMatrixNewValue,
        uint256[3][2] memory uInt256FixedMatrixNewValue,
        address[][] memory addressDynamicMatrixNewValue,
        bool[2][3] memory boolFixedMatrixNewValue,
        string[2][] memory string_Fixed_x_Dynamic_MatrixNewValue,
        bytes[][2] memory bytes_Dynamic_x_Fixed_MatrixNewValue
    ) public {
        int128FixedMatrixValue = int128FixedMatrixNewValue;
        uInt256FixedMatrixValue = uInt256FixedMatrixNewValue;
        addressDynamicMatrixValue = addressDynamicMatrixNewValue;
        boolFixedMatrixValue = boolFixedMatrixNewValue;
        string_Fixed_x_Dynamic_MatrixValue = string_Fixed_x_Dynamic_MatrixNewValue;
        bytes_Dynamic_x_Fixed_MatrixValue = bytes_Dynamic_x_Fixed_MatrixNewValue;
    }
    ...
    function getAddress_Dynamic_x_Fixed_MatrixValue() public view returns (address[][2] memory) {
        return address_Dynamic_x_Fixed_MatrixValue;
    }

    function getAddress_Fixed_x_Dynamic_MatrixValue() public view returns (address[3][] memory) {
    ...
    function getBoolean_Dynamic_x_Fixed_MatrixValue() public view returns (bool[][2] memory) {
        return bool_Dynamic_x_Fixed_MatrixValue;
    }

    function getBoolean_Fixed_x_Dynamic_MatrixValue() public view returns (bool[3][] memory) {
    ...
    function getString_Dynamic_x_Fixed_MatrixValue() public view returns (string[][2] memory) {
        return string_Dynamic_x_Fixed_MatrixValue;
    }

    function getString_Fixed_x_Dynamic_MatrixValue() public view returns (string[3][] memory) {
    ...
    function getBytes_Dynamic_x_Fixed_MatrixValue() public view returns (bytes[][2] memory) {
        return bytes_Dynamic_x_Fixed_MatrixValue;
    }

    function getBytes_Fixed_x_Dynamic_MatrixValue() public view returns (bytes[3][] memory) {
