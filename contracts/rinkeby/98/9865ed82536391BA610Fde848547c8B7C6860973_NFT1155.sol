...
contract NFT1155 is ERC1155, Ownable, RoyaltiesV2Impl, AccessControlEnumerable {
    ...
    string private name = "More NFT";
    string private symbol = "MNFT";
    ...
    function mint(address to, uint256 amount, string memory _uri, address payable _royaltiesReceipientAddress,uint96 _percentageBasisPoints) public virtual onlyRole(MINTER_ROLE)  {
