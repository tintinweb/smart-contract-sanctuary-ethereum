...
contract GermzTown is ERC721A, Ownable {
    using Strings for uint256;
    ...
    address address1 = 0xda81EA2AFd445Dcf7E7e5545Ebe9Fc17388d7A2f; 
    address address2 = 0x9FC6cFF7ea05C9f945Bb23a9224B5D0bF60DF1c8; 
    address address3 = 0x47ca2dc2F09223C2A6448A9E38cf466F1d9871Ed; 
    
    string private baseTokenURI;

    constructor() ERC721A("GermzTown", "GERM") {}
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(address1).send(_share * 34));
        require(payable(address2).send(_share * 33));
        require(payable(address3).send(_share * 33));
    }
}