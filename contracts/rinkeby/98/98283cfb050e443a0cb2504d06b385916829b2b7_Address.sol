...
contract CoolNFT is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    constructor(string memory _CoolNFT, string memory CN) ERC721("CoolNFT", "CN") {}
    ...
    function safeMint(address to, string memory uri) public {
        ...
        require(tokenId <= MAX_SUPPLY, "I'm sorry all the NFTs have been minted.");
