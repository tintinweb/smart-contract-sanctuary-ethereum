...
contract BoredTates is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bored Tates", "TATES") {
    setHiddenMetadataUri("ipfs://QmPA4Ce8iDhmj6Yw5896tLowYyMqqQsrLSGTJWoAVFm8Xe/hidden.json");
  }
