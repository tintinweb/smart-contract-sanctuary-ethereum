...
abstract contract SMCSymbolERC721V2 is
    ISMCManagerV2,
    ERC721Enumerable,
    AccessControl,
    Pausable,
    Ownable
{
    ...
    ISMCSymbolDescriptorV2 public SMCSymbolDescriptorContract;
    ISMCSymbolDataV2 public SMCSymbolDataContract;
    IApprovalProxy public approvalProxy;

    uint256 private limit = 260;
    uint256 private rights = 36;
    uint256 private rarityDigit = 9;

    constructor(string memory _name, string memory _synbol)
    ...
    function setDescriptorContract(address descriptor) public onlyOwner {
        SMCSymbolDescriptorContract = ISMCSymbolDescriptorV2(descriptor);
    }

    function setDataContract(address dataContract) public onlyOwner {
        SMCSymbolDataContract = ISMCSymbolDataV2(dataContract);
    }
    ...
    function getRespect(uint256 tokenId)
        public
        view
        override
        returns (string memory)
    {
        uint256 typeId = getTypeId(tokenId);
        uint256 artist = typeId % 10;
        return SMCSymbolDataContract.Respects()[artist];
    }
        ...
        returns (uint256)
    {
        uint256 typeId = getTypeId(tokenId);
        uint256 artist = typeId % 10;
        return SMCSymbolDataContract.RespectColorCodes()[artist];
    }
    ...
    {
        uint256 typeId = getTypeId(tokenId);
        uint256 respect = typeId % 10;
        string[] memory codesOfArt = SMCSymbolDataContract.CodesOfArt(respect);
        return pluck(tokenId, "COA", codesOfArt);
    }
    ...
    function getRarity(uint256 tokenId)
        ...
        returns (string memory)
    {
        return SMCSymbolDataContract.Rarities()[rarityDigit];
    }
        ...
        returns (string memory)
    {
        ...
        return
            ISMCSymbolDescriptorV2(SMCSymbolDescriptorContract).tokenURI(
                this,
                tokenId
            );
    }
    ...
    function random(string memory prefix, uint256 tokenId)
        ...
        returns (uint256)
    {
        uint256 respectColorCode = getRespectColorCode(tokenId);
        return
            random(
                respectColorCode,
    ...
    function random(uint256 respectColorCode, string memory input)
        internal
        pure
        returns (uint256)
    {
...
contract SMCSymbolV2 is SMCSymbolERC721V2 {
    constructor(string memory _name, string memory _synbol)
        SMCSymbolERC721V2(_name, _synbol)
    {}
}
