...
contract Shibays is ERC721A, Ownable {
    ...
    uint256 public WLOGStartDate = 1649599200;
    ...
    constructor() ERC721A("Shibays", "SBS") {}
    ...
    function freeMint(uint256 amount) external onlyEOA {
        require(isFreeOpen == true, "Free Mint session closed");
        require(totalSupply() + amount <= maxSupply, "Max Supply reached");
    ...
    function reservedMint(bytes32[] calldata proof, uint16 amount)
        external
        onlyEOA
    {
