...
contract ShibaTicket is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    function payoutERC20(IERC20 token) public {
        // Calculate the percentage of the pot given to winner
        uint256 erc20Payoutbalance = (IERC20(0x4ca1960330D98e345D0953Ef503eF45668548470).balanceOf(address(this)) / 1000) * 100;
