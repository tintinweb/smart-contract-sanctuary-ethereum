...
// File: contracts/@rarible/royalties/contracts/LibRoyalties2981.sol
...
// File: contracts/@rarible/royalties/contracts/IERC2981.sol
...
contract KOPOKOMafia is ERC721A, PaymentSplitter, Ownable,RoyaltiesV2Impl, ReentrancyGuard {
    ...
    uint public max_mint_allowed = 4;
    //Maximum number of NFTs an address can mint
    uint public max_mint_allowed_presale = 4;
    //Price of one NFT in presale
    uint public pricePresale = 0.0058 ether;
    //Price of one NFT in sale
    uint public priceSale = 0.0060 ether;
    ...
    address[] private _team = [
        0xd9F34Beb88D693EF6c17210040499cdC55Fc89e4
    ];
    ...
    constructor() ERC721A("KPKPROJECT I DROP00", "KPD") PaymentSplitter(_team, _teamShares) {
    ...
    * @notice Edit the Merkle Root 
    *
    * @param _theBaseURI The new Merkle Root
    * @param _notRevealedURI The new Merkle Root
