...
contract FD is ERC721A, Ownable, ReentrancyGuard, ERC2981, IERC1155Receiver {
    using Strings for uint256;
    ...
    uint256 public tokenPrice = .01 ether; // for testing
    string public baseURIExtended = "";
    string public extension = ".json"; // configurable extension
    bool public claimActive = false;
    uint96 public tokenRoyalties = 500; // 5% royalty

    address royaltyPayout = 0xB090fc5D0C06804dfbf06efb59Ce1F291f13162a; // TODO: change
    ...
    function mint(uint256 amount) external payable callerIsUser nonReentrant {
        ...
        require(
            ...
            "FD: Have not deposited any OG passes to clai"
        );
        require(
