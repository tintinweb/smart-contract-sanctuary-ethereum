...
contract interface_0529_1707_test is ERC721{
    using strings for *;
...
//metadata
    ...
    constructor() ERC721("interface_0529_1707_test" , "interface_0529_1707_test" ) {
    ...
    function sendMint(string memory _layerInfo,string memory _onlyLayerInfo)public payable{
        ...
        for (uint i = 0; i < 9 ; i++) {
            ...
            if(strings.equals( uintTo_StringNumToStringLayerName[i][su.str2uint(parts[i])].toSlice() ,"".toSlice() ) && i < 8){
                missList[_msgSender()]++;
                require(false,su.uint2str(i));
            }
        }
