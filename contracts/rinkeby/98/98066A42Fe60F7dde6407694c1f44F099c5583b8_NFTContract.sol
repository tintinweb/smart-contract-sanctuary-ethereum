...
contract NFTContract is ERC721, Ownable {
    ...
    string public _prefixURI = "ipfs://hash/";

    mapping(address => bool) private _freelist;


    constructor(uint256 maxTokens, string memory assetName, string memory ticker, uint256 price, uint256 preSalePrice, address verifyingAccount) ERC721(assetName, ticker) 
    {
    ...
    function presaleMintItems(uint256 amount, bytes memory signedMessage) public payable {
        ...
        require(verifyAccountWithSignature(msg.sender, signedMessage, _verifyingAccount),"not whitelisted");
