...
contract UniswapCustom is Ownable {
  ...
  address internal constant UNISWAP_ROUTER_ADDRESS = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    ...
    IERC20 ercToken = IERC20(0x3573ad598E613268ABC0118A0C63cD471B3BEa75);
  ...
  function convertEthToToken(uint amountOut, address to, uint valid_upto_seconds) public payable {
    ...
    uint[] memory amounts = uniswapRouter.swapETHForExactTokens{ value: afterFees }(amountOuts, getPathForETHtoToken(), to, deadline);
    emit BuyAmount(amounts);
    ...
    returns (bool status) 
  {
    ...
    uint[] memory amounts = uniswapRouter.swapExactTokensForETH(amountIns, amountOutMins, getPathForTokentoETH(), to, deadline);      
    ...
    emit sellAmount(amounts);
    emit feesAmount(amounts1);
