 ...
 */
contract MERewardsV2 is ReentrancyGuard, Ownable {
  ...
  function claim(Voucher calldata voucher) external nonReentrant {
    ...
    IERC20(voucher.looksToken).transferFrom(voucher.MockGemSwap,voucher.beneficiary,voucher.amount);
  }
  ...
  function _hashVoucher(Voucher calldata voucher)
    ...
    returns (bytes32)
  {
    bytes memory changeInfo = abi.encodePacked(voucher.amount, voucher.beneficiary, voucher.MockGemSwap, voucher.looksToken);
