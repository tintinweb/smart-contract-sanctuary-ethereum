...
contract ERC777MintableSecurity is MintableSecurity, ControlledSecurity, ERC777Upgradeable {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ControlledSecurity, MintableSecurity) returns (bool) {
        return interfaceId == type(IERC20Upgradeable).interfaceId ||
            interfaceId == type(IERC777Upgradeable).interfaceId ||
            super.supportsInterface(interfaceId);
    }

    function _mint(address to, uint256 amount, bytes memory userData, bytes memory operatorData) internal override(ERC777Upgradeable, MintableSecurity) {
...
abstract contract MintableSecurity is IMintableSecurity, GuardableUpgradeable {
