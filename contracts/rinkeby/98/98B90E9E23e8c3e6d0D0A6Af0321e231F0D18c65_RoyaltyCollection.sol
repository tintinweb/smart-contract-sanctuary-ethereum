...
///ty to @author Simon Fremaux (@dievardump) for inspiration
...
contract RoyaltyCollection is BaseCollection, ERC2981PerTokenRoyalties {


    uint256 nextTokenId;
    string private _collectionType = "royalty";
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(BaseCollection, ERC2981Base)
        returns (bool)
    {
