...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe749e9E7EAa02203c925A036226AF80e2c79403E];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 111) { }
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 111");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 111");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 111");
...
// File: contracts/HuhutownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HuhutownContract is RamppERC721A {
    constructor() RamppERC721A("HUHU TOWN", "HUHUUUU"){}
}
