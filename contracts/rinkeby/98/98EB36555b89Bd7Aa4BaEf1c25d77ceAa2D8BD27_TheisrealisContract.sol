...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2755aE7FDD23679585D8B3b93b9f1fb1c545bace];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmbBDHRadBLpg4CnZPj9jHaMAAPJ8ads2mQEFb2Wvorpvj/";
...
// File: contracts/TheisrealisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheisrealisContract is RamppERC721A {
    constructor() RamppERC721A("THE ISREALIS", "ISREAL"){}
}
