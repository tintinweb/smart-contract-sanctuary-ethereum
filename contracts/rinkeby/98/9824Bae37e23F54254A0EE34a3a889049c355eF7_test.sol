...
contract test is ERC721Optimized, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant maxSupply = 10; ///need to change
    ...
    constructor(string memory baseURI) ERC721Optimized("test", "test") { /// need to change
