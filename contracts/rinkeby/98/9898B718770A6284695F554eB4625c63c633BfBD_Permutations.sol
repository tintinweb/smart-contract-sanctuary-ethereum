...
contract Permutations is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public immutable collectionSize = 999;
    uint256 public immutable maxPublicSaleAmount = 888;
        ...
        callerIsUser
    {
        ...
        require(totalSupply() + 1 <= maxPublicSaleAmount, "reached max supply");
