...
Checkout the ongoing contributions for Peace in Ukraine in the links above.
*/
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        toString(freq),
                        " }]",
                        ', "description": "Peace DAO Distortion NFT was created to thank financial contributors to the Peace DAO Movement JuiceBox. This NFT was developed in collaboration with @onchainworld as an on-chain art piece.", "image": "data:image/svg+xml;base64,',
                        Base64.encode(
                            bytes(
                                string(
                                    abi.encodePacked(
