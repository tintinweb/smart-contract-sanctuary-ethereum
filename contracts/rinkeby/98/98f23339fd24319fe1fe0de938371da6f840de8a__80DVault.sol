...
contract _8OD is ERC721A, Ownable {
    ...
    // NFT Prices
    uint256 public costWL = 0.45 ether;
    uint256 public costFreeMint = 0.00 ether;
    uint256 public cost = 0.64 ether;
    ...
    uint256 public maxMintAmountStarHunter = 5;

    // NFTS Max for Hunter
    uint256 public maxMintAmountHunter = 2;
...
contract _80DVault is Ownable {
    uint256 public totalStaked;
    uint256 public claimCost = 1 ether;
    ...
    function payAndclaim(uint256[] calldata tokenIds) public payable {
    ...
    function unstake(address account, uint256[] calldata tokenIds)
        external
    {
        uint256 tokenId;
        totalStaked -= tokenIds.length;
    ...
    function setClaimCost(uint256 _price) public onlyOwner {
        claimCost = _price;
    }
