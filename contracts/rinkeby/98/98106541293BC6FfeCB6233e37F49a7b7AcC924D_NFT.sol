...
import './gotbit-contracts/contracts/token/ERC1155/extensions/ERC1155DataStorage.sol';

contract NFT is ERC1155DataStorage {
    constructor(
        string memory name_,
...
contract ERC1155Extended is ERC1155, AccessControl {
    ...
    function setTokenURI(uint256 id, string memory uri_) public onlyRole(CREATOR_ROLE) {
        uris[id] = uri_;
...
abstract contract ERC1155DataStorage is ERC1155Extended {
    ...
    function setTokenData(uint256 id, Data memory data_) public onlyRole(CREATOR_ROLE) {
        datas[id] = data_;
