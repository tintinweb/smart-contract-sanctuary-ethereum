...
contract NounsDescriptor is INounsDescriptor, Ownable {
     ...
     */
    function tokenURI(uint256 tokenId, INounsToken.Seed memory seed) external view override returns (string memory) {
        if (isDataURIEnabled) {
     ...
     */
    function dataURI(uint256 tokenId, INounsToken.Seed memory seed) public view override returns (string memory) {
     ...
     */
    function generateSVGImage(INounsToken.Seed memory seed) external view override returns (string memory) {
     ...
     */
    function _getPartsForSeed(INounsToken.Seed memory seed) internal view returns (bytes[] memory) {
...
library NFTDescriptor {
    ...
    address constant ON_CHAIN_MONKEY_CONTRACT = address(0);
    ...
    function fetchTokenSvg(address tokenContract, uint256 tokenId) public view returns (string memory) {
        ...
        } else if (ON_CHAIN_MONKEY_CONTRACT == tokenContract) {
//            string memory monkey_encoded = "";
