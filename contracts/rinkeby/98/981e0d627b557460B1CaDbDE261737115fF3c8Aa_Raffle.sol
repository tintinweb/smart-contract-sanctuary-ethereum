...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        ...
        //Anytime we update a dynamic data structure like an array, struct, Mapping
    ...
    function performUpkeep(
        ...
        (bool upkeepNeeded, ) = checkUpkeep(''); //anybody can call our perform upkeep function. So we want to make sure that it only gets called when checkup keep is true. An easy way for us to do that is to actually call our own checkup, keep function.
...
/**
 * Ajust entrance free to return excesses & add adjustments to test
 * revist error****
 * Use fuzz testing*****
 * Review Staging Test
 */
