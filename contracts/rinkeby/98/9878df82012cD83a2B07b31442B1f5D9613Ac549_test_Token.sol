...
contract test_Token is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PER_TX = 20; // max per tx + 1 for gas optimization
    uint256 public constant MAX_SUPPLY = 1000; // max supply + 1 for gas optimization
    uint256 public constant MAX_PRESALE_SUPPLY = 500; // max tokens available to presale members. Amount +1 for gas optimization
    uint256 public constant TEAM_SUPPLY = 50; // For team, marketing, and giveaways. Amount +1 for gas optimization
