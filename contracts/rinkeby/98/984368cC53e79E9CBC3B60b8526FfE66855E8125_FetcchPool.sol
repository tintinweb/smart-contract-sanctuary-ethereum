...
contract FetcchPool is Ownable {
    ...
    function setCommLayer(address _lz) external onlyOwner {
    ...
    function deposit(
        ...
        lz.sendMsg(_chainId, _dst, _payload);
    }
    ...
    function release(bytes memory _swapData) external onlyCommLayer {
        ...
        if (_dexRequired) {
            ...
            IERC20(_toToken).safeTransferFrom(
                address(this),
                _receiver,
                _amount
            );
