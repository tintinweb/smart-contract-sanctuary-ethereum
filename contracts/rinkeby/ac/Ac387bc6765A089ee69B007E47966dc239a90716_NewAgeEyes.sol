...
contract NewAgeEyes is Ownable, ERC721A {
    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    bool public privateSaleOpen = false;
    string private baseURI = "ipfs://QmYjLK5wqQVSDub1idogH2Hn5seK7HHX2sybD43Qgf7NxT/";
    string public _extension = ".json";
    string public hiddenMetadataUri = "ipfs://QmYjLK5wqQVSDub1idogH2Hn5seK7HHX2sybD43Qgf7NxT/";
    ...
    uint256 public publicLimit = 9850;

    bool public revealed = false;    
    constructor() ERC721A("New Age Eye Collection", "WW"){}
    ...
    function mintNFT(uint256 _quantity) public payable {
        ...
        require(totalSupply() + _quantity < publicLimit, "Reaching max supply");
    ...
    function mintPresale(uint256 _quantity) public payable {
        require(_quantity > 0 && _quantity <= 20, "Wrong Quantity.");
        require(totalSupply() + _quantity < presaleLimit, "Reaching max supply");
    ...
    function sendReserved(address _reciever, uint256 _count) external onlyOwner{
            require(totalSupply() + _count < maxSupply, "Max Supply Reached.");
            require( (_reserved - _count) >= 0, "Cannot mint more");
    ...
    function sendAirdrops(address _reciever, uint256 _count) external onlyOwner{
            require(totalSupply() + _count < maxSupply, "Max Supply Reached.");
            _safeMint(_reciever, _count);
