...
contract StarNotary is ERC721 {
	...
	event Created(address sender, uint256 tokenId, bytes19 coordinates, bytes name);
	event ChangedName(address sender, uint256 tokenId, bytes newName);
	event PutForSale(address sender, uint256 tokenId, uint256 priceInWei);
	event RemovedFromSale(address sender, uint256 tokenId);
	event Sold(address sender, uint256 tokenId);
