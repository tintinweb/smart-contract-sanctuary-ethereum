...
__________.__              .__     __      ______________________________    _________
\______   \__|__  ___ ____ |  |   /  \    /  \____    /\______   \______ \  /   _____/
 |     ___/  \  \/  // __ \|  |   \   \/\/   / /     /  |       _/|    |  \ \_____  \ 
 |    |   |  |>    <\  ___/|  |__  \        / /     /_  |    |   \|    `   \/        \
 |____|   |__/__/\_ \\___  >____/   \__/\  / /_______ \ |____|_  /_______  /_______  /
                   \/    \/              \/          \/        \/        \/        \/ 
...
contract PixelWZRDS is ERC721A, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    address private constant TEAM_ADDRESS = 0x1f1238c14db58Beac45c4A3efe86BE86eF74C661;

    uint256 public constant TOTAL_MAX_SUPPLY = 10000;
    uint256 public constant TOTAL_FREE_SUPPLY = 10000; 
    uint256 public constant TEAM_CLAIM_AMOUNT = 30;


    uint256 public  MAX_FREE_MINT_PER_WALLET = 2;
    uint256 public  MAX_PUBLIC_PER_TX = 20;
    ...
    constructor() ERC721A("Pixel WZRDS", "PZRDS") {
