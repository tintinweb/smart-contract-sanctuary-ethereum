...
contract MonsterCollectible2 is ERC721URIStorage, Ownable, Pausable, VRFv2Consumer {
    ...
    function fulfillRandomWords(
        ...
        emit NewlySplitNumbers(s_randomNumSplit); // 20, 15, 33, 98
    ...
    function mintBoosterPack() public  {
        ...
        ) = _splitInto4Numbers(s_randomNumSplit);
    ...
    function _splitInto4Numbers(uint256[] memory _nums) internal view returns (uint256, uint256, uint256, uint256) {
        return (
            _nums[0],
            _nums[1],
            _nums[2],
...
contract VRFv2Consumer is Ownable, VRFConsumerBaseV2 {
    ...
    // function.
    uint32 internal s_callbackGasLimit = 200000;
    ...
    uint256[] internal s_randomNumSplit;
    ...
    function getCardRandomizerNumbers() external view returns (uint256[] memory)
    {
    ...
    function setSplitBy(uint256 _newsplitby) external onlyOwner returns (uint256)
    {
        if (_newsplitby <= 0) {
