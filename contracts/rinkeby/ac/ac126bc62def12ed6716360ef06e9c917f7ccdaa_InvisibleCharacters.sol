...
contract InvisibleCharacters is ERC721, ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public constant maxSupply = 5000;
    uint256 private _unitPrice = 0.05 ether;
    uint256 private _reserved = 200;
    string  private _name = "Invisible Characters";
    string private _symbol = "INCH";
    bool private _saleStarted = false;
    string public baseURI;

    constructor(address owner_) ERC721(_name, _symbol) Ownable(owner_) {
