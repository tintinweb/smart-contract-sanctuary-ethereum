...
contract CloudzFrenz is ERC721A, Ownable, ReentrancyGuard {
  ...
  address public v2Address =0x40b213925A1278979a23fB49417cb7D9C51E17C9;
  ...
  function claimFromParentNFT(uint256 numberOfTokens) external payable {
    ...
    require(balanceToken + numberOfTokens <= balanceAddr, "max limit reached");
    ...
    for (uint256 i = balanceToken; i < (balanceToken + numberOfTokens); i++) {
        ...
        _safeMint(msg.sender, totalSupply() + counter);
