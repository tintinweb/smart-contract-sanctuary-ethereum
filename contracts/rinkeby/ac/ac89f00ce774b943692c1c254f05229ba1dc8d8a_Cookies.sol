...
contract Cookies is ERC721EnumerableLite, Delegated, PaymentSplitter {
    ...
    string public _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmT38BkFYZyciG8VMigWEyqz5zgC9fuh2rWNFMBuRoxx1V/'; // Test ipfs
    ...
    address _royaltyAddress = 0x0631aBa27f206AF64A1a78B5070E8898A05070DF;

    // Mapping owner address to wl mint count 
    mapping(address => uint) private _presaleMintCount;

    // Withdrawal addresses
    address dev = 0x0631aBa27f206AF64A1a78B5070E8898A05070DF;
    address project = 0x49568f1b06574030d9318F1eb54d8ceB0953cC00; 

    address[] addressList = [dev, project];
    uint[] primaryShares = [100, 900];

    constructor()
    ERC721B("Cookies", "COOKIES")
