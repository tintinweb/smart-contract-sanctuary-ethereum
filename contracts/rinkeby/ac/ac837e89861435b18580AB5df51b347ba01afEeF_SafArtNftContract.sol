...
//*********************************************************************//
//
//    _____       _______         __     _   ______________
//   / ___/____ _/ __/   |  _____/ /_   / | / / ____/_  __/
//   \__ \/ __ `/ /_/ /| | / ___/ __/  /  |/ / /_    / /   
//  ___/ / /_/ / __/ ___ |/ /  / /_   / /|  / __/   / /    
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x93dA4f7AFce53e2FD5B6C731c4bD983C47808A7D];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmS3FnE3gmwjfFqLv93CPoKnpocCZCLDM1Aq4yjR1SCn8q/";
...
// File: contracts/SafArtNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SafArtNftContract is RamppERC721A {
    constructor() RamppERC721A("SafArt NFT", "Safart"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qxJ7AeLkUYVAKxWJTKnS/contract-metadata";
    }
}
