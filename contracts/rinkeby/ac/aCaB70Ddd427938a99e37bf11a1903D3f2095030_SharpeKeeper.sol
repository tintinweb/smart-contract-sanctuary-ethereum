...
contract SharpeKeeper is KeeperCompatibleInterface{
    ...
    // constructor(uint updateInterval, address _vault, address _keeper, int24 _baseThreshold, int24 _limitThreshold) {
    //     interval = updateInterval;
    //     lastTimeStamp = block.timestamp;
    ...
    //     );
    // }
    // function setRegistry(address _keeper) external onlyGovernance{
    //     keeper = _keeper;
    // }
    // function _floor(int24 tick) internal view returns (int24) {
    //     int24 compressed = tick / tickSpacing;
