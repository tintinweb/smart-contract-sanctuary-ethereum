    ...
    Signature
{
    ...
    uint public presalePrice = 0.0 ether;
    
    
    constructor(bool isPaying, uint256 deploymentPrice) ERC721A("GCV2", "gcv") payable {
        if(isPaying){
...
contract Signature is Ownable {
    ...
    bytes32 private immutable NAME = keccak256("GCV2");
