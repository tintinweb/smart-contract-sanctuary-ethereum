...
contract retrogoblins is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("retrogoblins", "RGOB"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    ...
    require(amt <= 3, "can not mint this many free at a time");
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Goblins...");
