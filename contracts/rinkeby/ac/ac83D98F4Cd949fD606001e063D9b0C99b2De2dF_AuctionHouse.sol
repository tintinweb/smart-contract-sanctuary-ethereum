    ...
    IERC721Receiver
{
    ...
    /// @notice Settle the current auction, mint a new FLUIDnft, and put it up for auction.
    ...
    /// @notice Create a bid for a FLUIDnft, with a given amount.
    ...
    /// @dev If there are no bids, the FLUIDnft is burned.
