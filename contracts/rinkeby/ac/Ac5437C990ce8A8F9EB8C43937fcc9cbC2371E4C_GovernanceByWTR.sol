...
// Implementation of Governance Bravo as in here: https://www.comp.xyz/t/governor-bravo-development/942
// More description at: https://medium.com/tally-blog/understanding-governor-bravo-69b06f1875da

contract GovernanceByWTR is
    Governor,
    GovernorSettings,
...
{
    /// @notice initial gov values are initialized upon deployment
    /// @param _token ERC20 based VoteEscrow address
    /// @param _timelock TimelockController address
    /// @param _initialVotingDelay number of blocks to wait before first vote. e.g. `10` for 10 blocks
    /// @param _initialVotingPeriod seconds as duration of voting period.  e.g. `45818` for 1 week
    /// @param _initialProposalThreshold number of VoteEscrow needed to create proposal.  e.g. `1000e18` for 1000 VoteEscrow tokens
    /// @param _quorumNumeratorValue used for indicating percentage of supply needed to reach quorum.  e.g. `4` for 4% of supply to reach quorum
    constructor(
        IVotes _token,
