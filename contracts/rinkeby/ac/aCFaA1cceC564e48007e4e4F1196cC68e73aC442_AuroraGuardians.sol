...
contract AuroraGuardians is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Aurora Guardians", "AGT") {
        ...
        apollXMemberMap[0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2] = true;
        allowListMap[0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db] = true;
    }
    ...
    string private customBaseURI = "https://aurora-guardians.apollx.workers.dev/";
    ...
    function mint(uint256 count) public payable nonReentrant {
        ...
        if(apollXMemberMap[msg.sender] && apollxListIsActive) {
            ...
            mintController(2, count, "Insufficient payment, 0.005 ETH for token 3, s4 and 5 in your wallet");
        } else {
    ...
    /** PAYOUT **/
    address private constant contributor1 = 0x793e1FC096eD9513246e64B2776B06c2a7A507cc; // rinkiby test address
    address private constant contributor2 = 0xfB4Fa2e16f60Dc35b1fDc711E170724CA612420c; // rinkiby test address
    address private constant contributor3 = 0xfB4Fa2e16f60Dc35b1fDc711E170724CA612420c; // rinkiby test address
