...
contract HouseHold is UpgradeablePausable, IHouseHold {
  ...
  function getMortgageTerm(address borrower, address mortgage) public view override returns (IMortgage.MortgageTerms memory) {
    require(mortgagesBorrowers[borrower].mortgages[mortgage], "Mortgage not find");
    return IMortgage(mortgage).getMortgageTerms();
  }
}
...
interface IHouseHold {
  ...
  function getMortgageTerm(address borrower, address mortgage) external view returns (IMortgage.MortgageTerms memory);
}
