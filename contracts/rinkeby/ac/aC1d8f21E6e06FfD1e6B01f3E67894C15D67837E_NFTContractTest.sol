...
/**
 * ERC721 Smart Contract By Moazzam Ahmed Godil                                                                      
 */

contract NFTContractTest is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public cost = 0.02 ether; // Cost of each NFT
    uint256 public maxSupply = 9630; // Max amount of NFTs that can be minted in total
