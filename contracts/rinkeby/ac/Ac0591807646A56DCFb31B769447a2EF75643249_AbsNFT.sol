...
contract AbsNFT is ERC721Enumerable, ERC721URIStorage, Ownable {//ERC721URIStorage
    ...
    function mintTypeBatch(address[] memory to, uint256 count, string[] memory tokenUri) public {
        for(uint256 x=0;x<count;x++) {
            mint(to[x], tokenUri[x]);
        }
    }
