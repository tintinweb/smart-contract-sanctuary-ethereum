...
contract KungFuVerse is ERC721A, Ownable, ReentrancyGuard {
    ...
    * Whitelist
    */
    function recoverSigner(bytes32 messageDigest, bytes memory signature) internal pure returns (address) {
    ...
    */
    ...
    function mintAllowList(uint32 num, bytes memory signature) external payable nonReentrant {  
        ...
        require(recoverSigner(messageDigest, signature) == _signer, "Address is not in allowlist");
