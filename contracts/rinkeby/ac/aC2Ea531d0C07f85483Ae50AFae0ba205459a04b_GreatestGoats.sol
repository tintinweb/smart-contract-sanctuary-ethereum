...
contract GreatestGoats is ERC721A, Ownable {
    ...
    bytes32 public holderSaleMerkleRoot = 0x1a818965e8e6682ed05d4f6bfca55844b4aed765e59a33dd2e55c72f505596f2;
    ...
    function holderMint(uint256 _quantity, bytes32[] calldata proof) external payable {
        ...
        require(MerkleProof.verify(proof, holderSaleMerkleRoot, keccak256(abi.encodePacked(msg.sender))), "You have submitted invalid proofs.");
        hasHolderMinted[msg.sender] += _quantity;
        _safeMint(msg.sender, _quantity);
    }

    function mintPublicSale(uint256 _quantity) external payable {
