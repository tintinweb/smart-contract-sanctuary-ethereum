    ...
    ReentrancyGuard
{
    ...
    address public USDT_ADDRESS = 0x77D5e613A4B59F3A12c7690c5371e906b9Fdb3c5;
    address public USDC_ADDRESS = 0x482d1f63847EAD3B8121d154833044C29B06fd83;
        ...
        )
    {
        ...
        if (MerkleProof.verify(input.merkleProof, merkleRoot, leaf)) {
            ...
            uint256 remainOutputValue = dexRouter.getAmountsOut(maxAllowLimit - allowList[msg.sender], path)[1];
