...
contract MockFortune721 is ERC721 {
  constructor(string memory name, string memory symbol) ERC721(name, symbol) {}

  uint256 private _tokenCount = 1;
  ...
  {
    if (tokenId == 1) {
      return "https://arweave.net/aOVIbEbHB4RlCWjxi7mQI32imkcHmzF1rEd-WVs2cYQ";
    } else if (tokenId == 2) {
      return "https://arweave.net/fhnPqqA7K4eE0OQ9_1roOCRPTXUWItywH_-fOqBwm9A";
    } else if (tokenId == 3) {
      return "https://arweave.net/qsRhgBn4zO4wcH3IEaNd9nLBLNEs6rprpw-AlMPOrlI";
    } else {
      revert();
    }
  }
