...
contract LOKI is ERC20, Auth {
    ...
    uint256 public _totalSupplyAdjusted = _totalSupply / 10 * 4;
    uint256 public _maxTxAmount = _totalSupplyAdjusted / 20;
    uint256 public _maxWalletAmount = _totalSupplyAdjusted / 20;
    ...
    uint256 private sellBuybackBurnFee = 0;
    ...
    address private operationsFeeReceiver = 0x000000000000000000000000000000000000dEaD;
    address private buybackFeeReceiver = 0xc99877c55047a6147De96dde86A48C81B69b927F;
    address private stakingFeeReceiver = 0x000000000000000000000000000000000000dEaD;
