...
contract SlayToEarnClaimRewards {
    ...
    function checkUint256(uint256 value) public pure returns (string memory) {
        return Strings.toString(uint256(keccak256(abi.encodePacked(value))));
    }

    function checkUint256Array(uint256[] memory value) public pure returns (string memory) {
        return Strings.toString(uint256(keccak256(abi.encodePacked(value))));
    }

    function checkBytes(bytes memory value) public pure returns (string memory) {
        return Strings.toString(uint256(keccak256(abi.encodePacked(value))));
    }
