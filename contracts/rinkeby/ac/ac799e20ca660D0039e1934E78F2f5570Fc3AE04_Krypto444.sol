    ...
    PaymentSplitter 
{
    ...
    uint256 _price = 10000000000000000; // 0.01 ETH one 0 was added

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [100]; // PERCENTAJE PER PEOPLE IN THE TEAM
    address[] private _team = [
        0x4f66E32116869E53bCD19d96ff124989f4bD487a // Admin Account gets 100% of the total revenue
    ];
