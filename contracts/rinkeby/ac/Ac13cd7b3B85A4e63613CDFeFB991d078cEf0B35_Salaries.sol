...
contract Salaries is AccessControl {
    ...
    function basepay(uint _jobId, uint _companyBase, uint _companySpread) public pure returns (uint) {
        uint _baseSalary = _companyBase * 10 ** 18;
        ...
        return (_result / 10 ** SALARY_DECIMALS);
    }
    ...
    function teamworkBonus(uint _owned, uint _capacity) public pure returns (uint) { // returns a percent
        // 10% bonus for every 1% of the company that you own .. total owned must be > 1
        uint _result = 0;
        if (_owned > 1)
          _result = (_owned * 100 / _capacity) * 10;
        return Math.min(_result,MAX_TEAMWORK_BONUS);
    }

    function teamworkBonus(uint _totalSalaries, uint _owned, uint _capacity) public pure returns (uint) { 
        return _totalSalaries + (_totalSalaries * teamworkBonus(_owned, _capacity) / 100);
    }
...
/**
 * @title Regular Jobs v1.0 
 */

 // To-Do : Does regIds work?
...
contract Jobs is ERC721, ERC721Royalty, AccessControl {
    ...
    constructor() ERC721("Regular Jobs", "Jobs") {
        ...
        financeDept.setSalaries(salaries);
...
// Primary Functions
    ...
    function safeMint(address _to, uint _regId) public {  
        // require(regularsNFT.ownerOf(_regId) == _to);             // TO-DO : Add before deploy
        ...
        // hasJob[_regId] = true;
        jobByRegId[_regId] = _jobId;            // SAVE REG -> JOB
        if (companies.isManager(_regId)){       // set Managers as seniority 2
            seniority.setLevel(_jobId,Math.min(seniority.level(_jobId) + 2, 2));
        }
    ...
    function setRegularId(uint _jobId, uint _regId) public {
        ...
        require(regIds[_jobId] != _regId, "A reg already assigned to this job");
        require(hasJob(_regId) == false, "A reg already assigned to another job");
        uint _prevRegId = regIds[_jobId];
        regIds[_jobId] = _regId;   
        jobByRegId[_prevRegId] = 0;             // SAVE REG -> JOB
        jobByRegId[_regId] = _jobId;            // SAVE REG -> JOB      
        timestamps[_jobId] = block.timestamp;                             
...
// Admin Functions
    ...
    function setjobByRegId(uint _jobId, uint _regId) public onlyRole(MINTER_ROLE) {
...
// View Functions
    ...
    // function jobByRegId(uint _regId) public view returns (uint) {
    //     return regIds[];
    // }
...
// Init companies
        ...
        companies[0] =  Company({ capacity : 212, baseSalary : 9720 });
        companies[1] =  Company({ capacity : 350, baseSalary : 6560 });
        companies[2] =  Company({ capacity : 120, baseSalary : 18670 });
        companies[3] =  Company({ capacity : 144, baseSalary : 15890 });
        companies[4] =  Company({ capacity : 168, baseSalary : 11820 });
        companies[5] =  Company({ capacity : 160, baseSalary : 12330 });
        companies[6] =  Company({ capacity : 100, baseSalary : 22000 });
        companies[7] =  Company({ capacity : 184, baseSalary : 10940 });
        companies[8] =  Company({ capacity : 500, baseSalary : 5100 });
        companies[9] =  Company({ capacity : 188, baseSalary : 10740 });
        companies[10] = Company({ capacity : 140, baseSalary : 16290 });
        companies[11] = Company({ capacity :  96, baseSalary : 22830 });
        companies[12] = Company({ capacity :  50, baseSalary : 37800 });
        companies[13] = Company({ capacity : 192, baseSalary : 10550 });
        companies[14] = Company({ capacity :  92, baseSalary : 23740 });
        companies[15] = Company({ capacity : 156, baseSalary : 12600 });
        companies[16] = Company({ capacity : 176, baseSalary : 11360 });
        companies[17] = Company({ capacity : 148, baseSalary : 15510 });
        companies[18] = Company({ capacity : 200, baseSalary : 10200 });
        companies[19] = Company({ capacity : 136, baseSalary : 16710 });
        companies[20] = Company({ capacity : 204, baseSalary : 10030 });
        companies[21] = Company({ capacity : 104, baseSalary : 21230 });
        companies[22] = Company({ capacity : 218, baseSalary : 9500 });
        companies[23] = Company({ capacity :  57, baseSalary : 33380 });
        companies[24] = Company({ capacity : 196, baseSalary : 10370 });
        companies[25] = Company({ capacity : 206, baseSalary : 9950 });
        companies[26] = Company({ capacity : 210, baseSalary : 9800 });
        companies[27] = Company({ capacity :  88, baseSalary : 24730 });
        companies[28] = Company({ capacity : 214, baseSalary : 9640 });
        companies[29] = Company({ capacity : 242, baseSalary : 8720 });
        companies[30] = Company({ capacity : 124, baseSalary : 18130 });
        companies[31] = Company({ capacity : 164, baseSalary : 12070 });
        companies[32] = Company({ capacity : 116, baseSalary : 19240 });
        companies[33] = Company({ capacity : 180, baseSalary : 11140 });
        companies[34] = Company({ capacity : 172, baseSalary : 11580 });
        companies[35] = Company({ capacity : 132, baseSalary : 17150 });
        companies[36] = Company({ capacity : 152, baseSalary : 15160 });
        companies[37] = Company({ capacity : 450, baseSalary : 5480 });
        companies[38] = Company({ capacity : 600, baseSalary : 4530 });
        companies[39] = Company({ capacity : 112, baseSalary : 19860 });
        companies[40] = Company({ capacity :  65, baseSalary : 29490 });
        companies[41] = Company({ capacity :  76, baseSalary : 27470 });
        companies[42] = Company({ capacity :  80, baseSalary : 27000 });
        companies[43] = Company({ capacity :  84, baseSalary : 25810 });
        companies[44] = Company({ capacity : 290, baseSalary : 7560 });
        companies[45] = Company({ capacity : 108, baseSalary : 20520 });
        companies[46] = Company({ capacity : 276, baseSalary : 7860 });
        companies[47] = Company({ capacity : 400, baseSalary : 5950 });
        companies[48] = Company({ capacity :  53, baseSalary : 35760 });
        companies[49] = Company({ capacity : 300, baseSalary : 3730 });
        companies[50] = Company({ capacity :  69, baseSalary : 29440 });
        companies[51] = Company({ capacity :  72, baseSalary : 28290 });
        companies[52] = Company({ capacity : 208, baseSalary : 9870 });
        companies[53] = Company({ capacity : 128, baseSalary : 17630 });
        companies[54] = Company({ capacity :  73, baseSalary : 27930 });
...
// Specials companies
        ...
        parseSpecialRegIDs(55,_tempArray, 31310); // baseSalary = 3131
        ...
        parseSpecialRegIDs(56,_tempArray, 38530); // baseSalary = 3853
        ...
        parseSpecialRegIDs(57,_tempArray, 41270); // baseSalary = 4127
        ...
        parseSpecialRegIDs(58,_tempArray, 39540); // baseSalary = 3954
        ...
        parseSpecialRegIDs(59,_tempArray, 37090); // baseSalary = 3709
...
// ADMIN FUNCTIONS
    ...
    function makeNewJob(uint _regularId) public onlyRole(MINTER_ROLE) returns (uint, uint) {
        ...
        if (_specialCompanyId == 0) {   // If Regular id is NOT special
            ...
            counts[_companyId]++;
            console.log(_regularId, "=>",add1(_pull));      // offset by 1
            emit jobIDCreated(_regularId, _pull, _companyId, msg.sender);
            return (_pull + 1, _companyId);                 // offset by 1
            ...
            console.log(_regularId, "=>",add1(_newJobId));  // offset by 1
            emit jobIDCreated(_regularId, _newJobId, _specialCompanyId, msg.sender);
            return (add1(_newJobId), _specialCompanyId);    // offset by 1
        } 
    }
...
contract FinanceDept is AccessControl, Pausable {
    ...
    uint public maxClaimTime = 12 weeks;
    ...
    constructor() { 
	    ...
	    _grantRole(MINTER_ROLE, msg.sender);
	    _grantRole(MINTER_ROLE, tx.origin);
        regularsToken = RegularToken(0xf29170447b21baE0f940Ed27629DB4Cc9b81Fbde); // Regulars Token on Rinkeby
    }
...
// CONTRACT MANAGEMENT
    ...
    function setJobs(Jobs _jobs) public onlyRole(MINTER_ROLE){
        jobs = _jobs;
    }
    ...
    function setSalaries(Salaries _salaries) public onlyRole(MINTER_ROLE){
        salaries = _salaries;
    }
