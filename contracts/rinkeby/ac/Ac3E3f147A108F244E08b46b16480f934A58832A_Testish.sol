...
contract Testish is ERC1155, Ownable {
    ...
    function burnAntidoteForAddress(uint256 _id, address burnTokenAddress)
        external
    {
        // DONT FORGET TO ADD THIS BEFORE
        // require(msg.sender == mutationContract, "Invalid burner address");
        _burn(burnTokenAddress, _id, 1);
    }
