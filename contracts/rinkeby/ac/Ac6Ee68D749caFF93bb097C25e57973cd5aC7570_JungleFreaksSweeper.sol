...
contract JungleFreaksSweeper is ERC721A, Ownable, Pausable, ReentrancyGuard {  
    ...
    address private treasuryWallet = address(0x10101Ac0932e74494F4A553aE9770084A6c8e181);
	...
	constructor() ERC721A("Jungle Freaks Sweeper", "JFFS") {
        _pause();
        setBaseUri("https://ipfs.io/ipfs/QmSVCUvMTBrYZykpbkYMGFMSbFZnUSAQTgiXHYXAvNvxvg");
    }
