...
contract TestContract is ERC721A, Ownable { 
    constructor() ERC721A("Test", "TESTR") {}
    ...
    string private _baseTokenURI = "https://test.xyz/pngs/"; // for NFTs rendered off-chain (to be compatible with Twitter, etc.)
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        json = string.concat('{"name":"#',_toString(tokenId),'", "description":"Test.","attributes":',json,', "image":"', output, '"}'); 
