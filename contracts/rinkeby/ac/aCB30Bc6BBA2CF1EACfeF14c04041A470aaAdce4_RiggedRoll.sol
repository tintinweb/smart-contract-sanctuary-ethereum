...
contract DiceGame {
    ...
    function rollTheDice() public payable {
        ...
        uint256 realBlock = block.number - 1;
        console.log("THE BLOCK IS ", realBlock);
...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() public {
        ...
        uint256 roll = uint256(hash) % 16;
        uint256 riggedBlock = block.number - 1;
        console.log("THE RIGGED BLOCK IS ", riggedBlock);
        console.log("THE RIGGED NONCE IS ", nonce);
