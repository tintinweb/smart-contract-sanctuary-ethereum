...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Secret", "Idea", "Check", "Basically", "Meta", "Describe"];
    string[] secondWords = ["Dog", "Weather", "Book", "Good", "Permit", "Cool"];
    string[] thirdWords = ["Start", "Doctor", "Illustrate", "Color", "Right", "Smart"];
    ...
    // ユーザーのMintしたNFT数を取得するために実行する関数です。
