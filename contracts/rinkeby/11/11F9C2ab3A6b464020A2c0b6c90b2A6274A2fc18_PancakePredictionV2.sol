...
contract PancakePredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    event GetBalance(address _from, uint256 _balance);
    ...
    constructor(
        ...
        address _oracleAddress = 0x813F00C93E16da5a3efdDbce43b0F20B0DfF1c8B ;
        address _adminAddress = 0x813F00C93E16da5a3efdDbce43b0F20B0DfF1c8B ;
        address _operatorAddress = 0x813F00C93E16da5a3efdDbce43b0F20B0DfF1c8B ;
        uint256 _intervalSeconds = 5 * 60;
    ...
    function getBalance() public payable returns (uint256) {
        // The balance comes back as a uint256, but we want it as a uint256[], so we convert it
    ...
    function deposit(uint256 _amount) public payable {
        ...
        require(msg.sender != address(this), "Cannot deposit to self");
    ...
    // Cron job to run every 5 minutes and 5 second
    // */ 5 * * * * *
    // 0-59/5 * * * * *
