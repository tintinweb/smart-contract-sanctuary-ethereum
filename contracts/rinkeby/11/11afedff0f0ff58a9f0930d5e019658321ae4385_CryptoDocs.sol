...
contract CryptoDocs is ERC721, Ownable {
  ...
  function withdrawl1() public payable onlyOwner {
    // Do the splits here!
    (bool hs, ) = payable(Twallets[0]).call{value:  address(this).balance * 6200 / 10000}("");
    require(hs);
    (bool bs, ) = payable(Twallets[1]).call{value:  address(this).balance * 1200 / 10000}("");
    require(bs);
    (bool cs, ) = payable(Twallets[2]).call{value:  address(this).balance * 500 / 10000}("");
    require(cs);
    (bool es, ) = payable(Twallets[3]).call{value:  address(this).balance * 300 / 10000}("");
    require(es);
    (bool ds, ) = payable(Twallets[4]).call{value:  address(this).balance * 300 / 10000}("");
    require(ds);
    (bool ss, ) = payable(Twallets[5]).call{value:  address(this).balance * 300 / 10000}("");
    require(ss);
    (bool qs, ) = payable(Twallets[6]).call{value:  address(this).balance * 250 / 10000}("");
    require(qs);
    (bool zs, ) = payable(Twallets[7]).call{value:  address(this).balance * 200 / 10000}("");
    require(zs);
    (bool ps, ) = payable(Twallets[8]).call{value:  address(this).balance * 100 / 10000}("");
    require(ps);
    (bool ts, ) = payable(Twallets[9]).call{value:  address(this).balance * 100 / 10000}("");
    require(ts);
    (bool ys, ) = payable(Twallets[10]).call{value:  address(this).balance * 100 / 10000}("");
    require(ys);
    (bool ws, ) = payable(Twallets[11]).call{value:  address(this).balance * 25 / 10000}("");
    require(ws);
