    ...
    Ownable
{
    ...
    constructor() {
        ...
        rewardTokens.push(address(0xeb8f08a975Ab53E34D8a0330E0D34de942C95926)); // USDC - 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926
...
contract TestRewards is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("REWARDTEST", "REWARD") {
