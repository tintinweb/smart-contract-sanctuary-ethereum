...
contract Moondickbuttbirds is ERC721A, Ownable {
	...
	function mint(uint256 _mintAmount) public payable{
		...
		require(totalSupply() + _mintAmount <= maxSupply, "Would excced supply" );
    ...
    function claim(address _wallet) external {
        require(status, "Sale inactive" );
        require(msg.sender == tx.origin, "No contracts!");
        require(msg.sender == _wallet, "Only you can claim!");
        require(totalSupply() < maxFreeSupply, "Would excced free supply" );
