...
contract MetaNote is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Meta Note", "NOTE") {
    setHiddenMetadataUri("ipfs://bafkreigtmpn2btrekpsg7nw3lcbmh7vcllxjgzsptcocksszyyt2jt5epq/hidden.json");
  }
