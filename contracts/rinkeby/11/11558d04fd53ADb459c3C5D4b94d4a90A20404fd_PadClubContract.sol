...
contract PadClubContract is ERC721, Ownable {
    ...
    //NFT Stuff
    uint256 public presalePrice = 0.000015 ether;  // prix de la presale modificable par le owner
    uint256 public publicPrice = 0.00001 ether;   // prix de la publicSale modificable par le owner
    ...
    uint256 public maxMintAmountPublic = 2;    // nombre max de NFT mintables par une addresse
