...
contract SyndicatePosters is ERC1155, Ownable, ReentrancyGuard {
    ...
    //event NewPass(uint tokenID, address userID);

    using Address for address;
    using SafeMath for uint256;
    using ECDSA for bytes32;

    //and allow if you own a baby kaiju -> spend 500 scales -> get alpha pass

    uint256 public constant TOTAL_SUPPLY = 10;
    uint256 public constant RESERVED = 0;
    uint256 public constant TOKEN_ID = 0;
    address public constant SIGNER = 0xFE3aAc186e2bb16b8C1fD2E8707D5D825301bFbD;

    // Track mints
    mapping(bytes => bool) public signatureUsed;


    string public name = "SyndicatePosters";
    ...
    function mint(bytes memory signature) public nonReentrant validMinter(signature) {
        ...
        require(currentSupply.add(1) <= TOTAL_SUPPLY, "Exceeds maximum number of tokens");
