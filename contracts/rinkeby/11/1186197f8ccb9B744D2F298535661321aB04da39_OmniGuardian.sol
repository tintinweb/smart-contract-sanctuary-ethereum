...
abstract contract Ownable is Context {
    ...
    //returns pro
    function pro() public view returns (uint256) {
        return _pro;
    }
...
contract OmniGuardian is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("OmniGuardian", "OG") { 
        _owner = msg.sender;
