    ...
    ReentrancyGuard 
{
    ...
    event contractCreated(string name, string symbol, uint256 totalSupply);
    ...
    /**
     * @dev Overwriting approve function to prevent any party other than the Marketplace to approve and transfer tokens.
     */
    ...
    /**
     * @dev Returns whether `spender` is allowed to manage `tokenId`. Marketplace Only.
     *
     * Requirements:
     *
     * - `tokenId` must exist.
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view override returns (bool) {
        ...
        return (spender == _marketplaceAddress);
    }
    ...
    * @dev superadmin only - address updates to enable modularity of system
        ...
        nonReentrant 
    {
        ...
        setApprovalForAll(oldAddress, false);
    ...
    */
    ...
    function logContractCreated() public onlyOwner returns (bool) {
        emit contractCreated(name(), symbol(), total);
        return true;
    }
