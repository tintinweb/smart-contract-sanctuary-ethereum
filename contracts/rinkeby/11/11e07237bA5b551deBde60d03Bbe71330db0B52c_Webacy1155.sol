...
contract Webacy1155 is ERC1155 {
  uint256 public lastMintedToken = 0;
  mapping(uint256 => uint256) public existence;
  string public symbol; 
  

    constructor(string memory _symbol) ERC1155("https://eabacy.example/api/item/{id}.json") {
      symbol = _symbol;
    }
    ...
    function privateMint(uint256 _amount, address _address) private {
      _mint(_address, lastMintedToken, _amount, "");
      existence[lastMintedToken] = _amount;
      lastMintedToken++;
    }
