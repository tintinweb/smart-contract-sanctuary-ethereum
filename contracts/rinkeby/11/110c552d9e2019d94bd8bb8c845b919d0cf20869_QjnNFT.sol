...
contract QjnNFT is ERC721,  ERC721Enumerable, ERC721URIStorage  {
    using Strings for uint256;
    ...
    function mintNFT2(address _to,uint256 tokenid,string memory tokenURI_) public returns (uint256){
        //_tokenIds.increment();
