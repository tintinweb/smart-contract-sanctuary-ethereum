...
contract SWT1 is TokenControl,claimable
{
    using SafeMath for uint256;
    string public constant name    = "SW1-Token";
    string public constant symbol  = "SW1";
    uint256 public decimals = 18;
    uint256 totalsupply =  100000000000000000*(10**decimals);
