...
import "./CassetteSenseiNFT.sol";

contract CSSRedemption {
    CassetteSenseiNFT public nft;

    constructor() {
        nft = CassetteSenseiNFT(0x367de52f8135cF2Df7AA90C932762cC921660e7b);
    }

    function Existing(address _t) public {
        nft = CassetteSenseiNFT(_t);
    }
