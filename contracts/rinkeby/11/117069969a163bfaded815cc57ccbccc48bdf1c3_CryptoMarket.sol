...
contract CryptoMarket is ReentrancyGuard {
  ...
  uint256 public commission_for_marketplace = 0;
  ...
  function createMarketSale_erc721(uint256 itemId) public payable nonReentrant{
    ...
    if(markettokens[itemId].is_fixed==true){
      ...
      markettokens[itemId].owner.transfer(price*(1-(commission/100)-(royality/100)));

      markettokens[itemId].creater.transfer(price*(royality/100));

      owner.transfer(price*(commission/100));
