...
contract FLIP5050 is ERC721A, Ownable, ReentrancyGuard {
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        // flipToken.updateRewardOnMint(_msgSender(), _amount);
    }
    ...
    function mintWhitelist(bytes32[] memory _proof) external nonReentrant {
        ...
        // flipToken.updateRewardOnMint(_msgSender(), 1);
    }
    ...
    //     flipToken.updateReward(msg.sender, address(0));
    //     flipToken.getReward(msg.sender);
    // }
    ...
    function _beforeTokenTransfers(
        ...
        if (from != address(0)) {
            // flipToken.updateReward(from, to);
        }
    }
}
