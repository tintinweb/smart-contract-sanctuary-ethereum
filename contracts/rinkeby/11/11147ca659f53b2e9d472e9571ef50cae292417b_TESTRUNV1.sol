...
// ERC721A Contracts v4.0.0
    ...
    contract TESTRUNV1 is Ownable, ERC721A {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/Qmah2NqDMz1CrsChf45RFw2obDXpVKTWAmXmMmvrUJnDTP";
    string public constant baseExtension = "";
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("TESTRUNV1", "V1") {_safeMint(msg.sender, 1);}
