...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Seya", "Hyoga", "Shun", "Ikky", "Shyriu", "Saori"];
  string[] secondWords = ["Naruto", "Sakura", "Sasuke", "Madara", "Kakashi", "Orochimaru"];
  string[] thirdWords = ["Goku", "Vegeta", "Gohan", "Trunks", "Freeza", "Bills"];
  ...
  function pickRandomFirstWord(uint256 tokenId) public view returns (string memory) {
    ...
    uint256 rand = random(string(abi.encodePacked("Seya", Strings.toString(tokenId))));
  ...
  function pickRandomThirdWord(uint256 tokenId) public view returns (string memory) {
    uint256 rand = random(string(abi.encodePacked("Goku", Strings.toString(tokenId))));
