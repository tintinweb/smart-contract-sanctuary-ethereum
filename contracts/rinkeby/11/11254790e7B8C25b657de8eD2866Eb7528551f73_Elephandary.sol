...
string  public baseTokenUrl = "https://bombabomba.com/elephan-metadata/";
//Düzenlenecek .json varsa da alttakini kullancan yoksa tokenUri fonksiyonunu override etmeye gerek yok
...
// This function reduces max supply. 
...
function setFreeMintPerWallet (uint256 maxFreeMintPerWallet_) external onlyOwner {

maxFreeMintPerWallet = maxFreeMintPerWallet_ ;
