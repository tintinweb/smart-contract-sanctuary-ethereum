...
contract MyNFT is ERC721URIStorage, Ownable {
    ...
    uint256  private _maxWhitelistedAddresses;
    ...
    uint256 private _numAddressesWhitelisted;
    ...
    function setMaxWhiteListAmount(uint256 maxWhitelistedAmt) public {
        _maxWhitelistedAddresses = maxWhitelistedAmt;
    }

    constructor() ERC721("MyNFT", "NFT") {
        setMaxWhiteListAmount(10);
    }
    ...
    function addAddressToWhitelist() public {
  	// ensures that the caller of the function is not already part of the whitelist.
        require(!_whitelistedAddresses[msg.sender], "Sender has already been whitelisted");

   	// check if the maximum number of whitelisted addresses is not reached, if not then throw an error.
        require(_numAddressesWhitelisted < _maxWhitelistedAddresses, "You cannot join now. Limit has been reached");
