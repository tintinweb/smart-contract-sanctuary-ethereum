...
contract MINTTEST is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_NFTS_PER_TX = 50;   
    uint256 public constant MAX_NFTS_PER_WALLET = 50;   
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor(string memory baseTokenURI, address beneficiary) ERC721("MintTest", "MINTTEST") {
