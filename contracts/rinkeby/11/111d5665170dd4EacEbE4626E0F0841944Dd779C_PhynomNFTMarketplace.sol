...
//   uint256 public listingPercentage = 5; //5%
  ...
  function getListPercenteage(uint256 collectionId) external view returns (uint256) {
    return collections[collectionId].listingFee;
  }
  ...
  function createMarketSale(
    ...
    uint256 listFee = price * (collections[collectionId].listingFee/TOTAL_PERC);
  ...
  function createANewCollection(string calldata _logoUrl,string calldata _collectionName,string calldata _category,string calldata _websiteUrl,string calldata _instaProfile,uint256 _listingFee) external {
      require(_listingFee<=20,"Listing fee cannot be greator than 20%");
    ...
    function setListingPercentage(uint256 collectionId,uint256 _listingPercentage) external {
      require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
      require(collections[collectionId].listingFee != _listingPercentage,"New listing percentage cannot be same with previous listing percentage");
      require(_listingPercentage<=20,"Invalid percentage");
      collections[collectionId].listingFee = _listingPercentage;
    }

    function setCollectionName(uint256 collectionId,string calldata _name) external {
      require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
      collections[collectionId].name = _name;
    }
    
    function setCollectionLogoUrl(uint256 collectionId,string calldata _logoUrl) external {
      require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
      collections[collectionId].logoUrl = _logoUrl;
    }

    function setCollectionCategory(uint256 collectionId,string calldata _category) external {
      require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
      collections[collectionId].category = _category;
    }

    function setCollectionWebsiteUrl(uint256 collectionId,string calldata _websiteUrl) external {
      require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
      collections[collectionId].websiteUrl = _websiteUrl;
    }

    function setCollectionInstaProfile(uint256 collectionId,string calldata _instaProfile) external {
      require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
