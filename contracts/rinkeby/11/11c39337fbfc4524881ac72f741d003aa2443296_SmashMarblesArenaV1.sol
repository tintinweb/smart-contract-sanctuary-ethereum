...
contract SmashMarblesArenaV1 is SmashMarblesStorageV1 {
    ...
    function initialize() public initializer {
        ...
        COMMUNITY_WALLET = 0x2a8C9dbAd84F8A88ff3e880bC26b8D336a53fd47; // community wallet

        marblePrice = 125000000000000000;
        arenaPrice=125000000000000000;
    ...
    // /**
    //  * @dev change price of token that one token can have
    //  *
    //  * @param _price price of token in wei (one token price)
    //  *
    //  * Requirement : -
    //  *              only contract owner can call
    //  */
    // function changemarblePrice(uint256 _price) external virtual onlyOwner {
    //     marblePrice = _price;
    // }
    ...
    // no need
    /**
     * @dev check address is white listed or not
     *
