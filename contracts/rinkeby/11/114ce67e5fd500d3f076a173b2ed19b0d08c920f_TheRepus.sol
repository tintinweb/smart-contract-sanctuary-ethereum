    ...
    Ownable
{
    ...
    constructor (address artifactsAddress) ERC721("The Repus", "REPUS") {
    ...
    function setArtifactMinterAddress(address atfMinter) external onlyOwnerOrManager {
    ...
    function mint(uint256 amount) external payable {
        ...
        artifactsContract.burn(msg.sender, ARTIFACT_ID, amount);
