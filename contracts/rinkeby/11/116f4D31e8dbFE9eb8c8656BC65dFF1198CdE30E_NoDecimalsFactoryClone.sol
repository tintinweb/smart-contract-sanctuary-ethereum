...
contract NoDecimalsFactoryClone {
    ...
    event ERC20Deployed(address clone, string name, string symbol, address operator, uint256 initialSupply);
    ...
    function createToken(
        ...
        NoDecimalsERC20Alpha(clone).initialize(name, symbol, msg.sender, initialSupply);

        _tokens.add(address(clone));
        emit ERC20Deployed(clone, name, symbol, msg.sender, initialSupply);
        return clone;
    }
}
