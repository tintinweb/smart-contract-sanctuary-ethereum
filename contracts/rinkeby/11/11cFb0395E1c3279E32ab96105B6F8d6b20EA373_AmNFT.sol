...
contract AmNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    
    uint256 constant public PASS_COST = 0.1 ether;
    ...
    function mint() external whenNotPaused payable {
        ...
        require(msg.value == PASS_COST, "Wrong amount of ethers to pay!");
