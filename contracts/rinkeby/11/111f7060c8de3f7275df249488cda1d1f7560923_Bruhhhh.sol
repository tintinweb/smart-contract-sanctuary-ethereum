...
contract Bruhhhh is ERC721Enum, Ownable, ReentrancyGuard {
	...
	function mintWL(uint256 _mintAmount, bytes32[] calldata proof) public payable nonReentrant{
        ...
        require(reserve + _mintAmount <= maxfreemintMint, "Low");
        require(_mintAmount <= maxfreemintMint, "Try less");
        require(msg.value >= freemintCost * _mintAmount,"Insufficient");
	...
	function mint(uint256 _mintAmount) public payable nonReentrant{
        uint256 s = totalSupply();
        uint256 reserve = userfreemintLimit[msg.sender];
        ...
        userfreemintLimit[msg.sender] += _mintAmount;
        delete reserve;
    ...
    function setfreemintMaxMintAmount(uint256 _newMaxMintAmount) public onlyOwner {
	maxfreemintMint = _newMaxMintAmount;
	}
