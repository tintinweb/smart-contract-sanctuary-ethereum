...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    mapping(address => uint256) public addressToAmountLottery;
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        //uint256 cost_to_enter = (usdEntryFee * 10**18) / price;
    ...
    function enter() public payable returns (address) {
        // $50 minimum
        require(lottery_state == LOTTERY_STATE.OPEN, "Lottery not openned yet!");
    ...
    function startLottery() onlyOwner public {
        require(lottery_state == LOTTERY_STATE.CLOSED, "Lottery can't be openned yet!");
