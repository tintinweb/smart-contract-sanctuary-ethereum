...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4E8057608789dab6a686b784D8e0346800fAcc3b];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://ipfs.infura.io:5001/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vFE81L2msltyd5MwUHid/contract-metadata";
    }
}
