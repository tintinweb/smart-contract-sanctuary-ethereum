...
contract ProjectX is ERC20, Ownable {
    ...
    constructor() ERC20("Project X", "PTX01") {
        ...
        treasuryWallet = payable(0x9B86f9035B21aeFBd3344903ee276D6Dd3513E0D);
    ...
    function updateTaxFee(
        ...
        taxFee = _fee;
        require(taxFee <= 25, "Must keep buy fees at 25% or less");
    }
    ...
    function updateTreasuryWallet(address payable newTreasuryWallet)
        external
        onlyOwner
    {
