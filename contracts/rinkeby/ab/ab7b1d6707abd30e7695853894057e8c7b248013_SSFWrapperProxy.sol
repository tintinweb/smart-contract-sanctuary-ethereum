...
contract SSFWrapperProxy {
    ...
    modifier onlyCreatorLazyMint(
        ...
        // (or seaport/conduit - which should never be possible)
        uint256 fromBalance = token.balanceOf(from, tokenId);
    ...
    function safeTransferFrom(
        ...
        uint256 _amount,
        bytes memory
    ) public onlyProxy onlyCreatorLazyMint(_from, _tokenId, _amount) {
