...
contract Techeu is ERC721Enumerable, Ownable, ReentrancyGuard {
    //MERKLEFEATURE
    bytes32 public merkleRoot;
    mapping(address => uint256) public claimed;
    uint256 public costPre = 0.1 ether;
    uint256 public maxMintPre = 3;
    uint256 public preDate = 1652085793;
    //MERKLEFEATUREEND
    ...
    modifier checkPrePrice(uint256 _mintAmount) {
    ...
    //MERKLEFEATURE
    function mintPre(uint256 count, bytes32[] calldata _merkleProof) external payable checkLimit(count) checkPrePrice(count) checkPreDate {
