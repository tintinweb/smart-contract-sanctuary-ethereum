...
contract StakedGRT is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("StakedGRT", "sGRT") {}
...
interface IStaking is IStakingData {
    ...
    function delegationTaxPercentage() external view returns(uint256);
...
contract DeStake is Initializable,OwnableUpgradeable,ReentrancyGuardUpgradeable,PausableUpgradeable{
    ...
    function startUndelegation() external onlyOwner{
        ...
        //todo set to undelegate address and amount
        emit GRTUndelegatedFromIndexer(address(0),0);
    }
    ...
    function depositAndDelegate(uint256 _delegateAmount) external nonReentrant whenNotPaused{
        ...
        sGRT.mint(address(this), _delegateAmount);
        sGRT.transferFrom(address(this), msg.sender,  sGRTAmount);
