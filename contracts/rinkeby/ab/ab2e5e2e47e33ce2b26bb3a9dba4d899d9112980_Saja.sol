...
contract Saja is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        taxFees = TaxFees(1,7,1,1);
        distribution = Distribution(40, 50, 25, 25);
    ...
    function setTaxFees(uint256 reflectionFee, uint256 liquidityFee, uint256 sellReflectionFee, uint256 sellLiquidityFee) external onlyOwner {
