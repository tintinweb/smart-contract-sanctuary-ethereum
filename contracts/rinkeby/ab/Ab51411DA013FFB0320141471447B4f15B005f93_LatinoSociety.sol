...
contract LatinoSociety is ERC721A, Ownable, ReentrancyGuard {
 ...
 // --------------------------------------------------------------------------
  ...
  //
  // Setting up accounts here for funds distribution
  // These are only test accounts !! 
  //-------------------------------------------------------------
  address acct1 = 0x837F8202aad7ca7F59cFf4D356EB593B70c9E6aC;  // MultiSig1 --- Update 
  address acct2 = 0x2f4852277b585D664Aa8277D28F17AfAF2Aa5C62;  // MultiSig2 -- Update
 ...
 function setProvenance(string memory provenance) public onlyOwner {
  ...
  //      
  //      setDefaultRoyalty(royaltyAddress, royaltyBps);
  //  }
     /// Let's see which one works out best in test 
    function setRoyalties(address recipient, uint256 value) public onlyOwner {
        setRoyalties(recipient, value);
    }
  ...
  function setUriSuffix(string memory _uriSuffix) public onlyOwner {
    ...
    function withdrawAll() external onlyOwner {
        ...
        require(payable(acct1).send(balance / 100 * 50));
        require(payable(acct2).send(balance / 100 * 50));
    }
