...
contract Wabbles is ERC721, Ownable {
    ...
    uint32 private commission = 11; // 1.1%
    address private author = 0x72330172444fCE7A11F5F9132A22805e23DEA2ac;
...
abstract contract Revealable is Wabbles {
...
abstract contract Presaleable is Wabbles {
...
contract WabblesPresaleReveal is Wabbles, Revealable, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) Wabbles(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
