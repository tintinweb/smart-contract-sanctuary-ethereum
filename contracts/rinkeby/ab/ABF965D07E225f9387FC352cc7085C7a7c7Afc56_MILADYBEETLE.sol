...
_transferOwnership(0x88B0CdF5700Fc0293B265eA6904205E3F1576069);
}
...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x88B0CdF5700Fc0293B265eA6904205E3F1576069;
...
address[] public payableAddresses = [RAMPPADDRESS,0x88B0CdF5700Fc0293B265eA6904205E3F1576069];
...
) ERC721A(tokenName, tokenSymbol, 20, 7000 ) {}
using SafeMath for uint256;
uint8 public CONTRACT_VERSION = 2;
string public _baseTokenURI = "ipfs://QmPGsZFLZ9whdy1MpezEFPwWR6csYQqW5DGyLwWsjeDxZp/";  // json IPFS goes here
...
require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 7000");
...
require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 7000");
...
contract MILADYBEETLE is RamppERC721A {
constructor() RamppERC721A("Milady BEETLES", "MB"){}

function contractURI() public pure returns (string memory) {
return "ipfs://QmXqm4TF2bQRjBuMbWa5jaEc3veyHg3CJaBjbAbbTNXgod";
}
}