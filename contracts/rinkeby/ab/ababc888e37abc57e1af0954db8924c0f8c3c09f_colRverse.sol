...
contract colRverse is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public MAX_PER_Transtion = 500; // maximam amount that user can mint per transaction
  uint256 public MAX_PER_Address = 1496; // maximam amount that user can mint

  uint256 public  PRICE = 0.00000000005 ether; //0.0005 during sale 

  uint256 private constant TotalCollectionSize_ = 1496; // total number of nfts
  uint256 private constant MaxMintPerBatch_ = 500; //max mint per trx
  ...
  constructor() ERC721A("SnailNft","SnailNft", MaxMintPerBatch_, TotalCollectionSize_) {
   // _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmatJskMRb8L1VEHYhyqKwbQ2cFjE5BpQaZ5aYLJC8uzWR/";
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmQPMtkKtjtUcerhVdUUG9SkBcYZEjzcPP5nFWFsTdZ9ao/";
  }
