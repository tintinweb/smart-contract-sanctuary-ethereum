...
contract Encryption {
    ...
    mapping(address => uint256) ecryptedMapping;

    EncryptedAddress[] public encryptedmapping;

    function _generateMapping(address _address, uint256 _encryption) private {
        ecryptedMapping[_address] = _encryption;
        encryptedmapping.push(EncryptedAddress(_address, _encryption));
    }
    ...
    function encryptAddress() public {
