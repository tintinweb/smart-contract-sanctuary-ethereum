...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    event RandomnessDetails(uint256 randomness, uint256 playersLength, uint256 indexOfWinner, uint256 balance);
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        emit RandomnessDetails(_randomness, players.length, indexOfWinner, address(this).balance);
