...
contract NFT_Contract is ERC721A, Ownable {
    ...
    address ticketAddress = 0xF1c52BF748Aa0C5333D5C04607a5e83ce031E355;
    ...
    // for future use
    function avatar(uint256 _id, uint256 quantity) external onlyAdmin {
    ...
    function setAvatarContract(address _contract) public onlyOwner {
        Contract = _contract;
    }

    function setTicketsContract(address _ticket) public onlyOwner {
        ticketAddress = _ticket;
    }
