...
contract theonionz is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cannot mint 0 theonionz");
        require(_mintAmount <= maxperAddressPublicMint, "Cannot mint more theonionz" );
        require(s + _mintAmount <= maxSupply, "Cannot exceed Moondle supply");
        ...
        onlyOwner
    {
        ...
        require(s + totalQuantity <= maxSupply, "Too many theonionz");
