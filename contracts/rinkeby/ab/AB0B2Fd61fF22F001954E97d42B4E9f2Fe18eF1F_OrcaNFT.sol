...
contract OrcaNFT is ERC721, Ownable {
    ...
    //NFT Stuff
    // OG STUFF
    uint256 public ogWhitelistPrice = 0.00004 ether;  // prix de la presale modificable par le owner
    uint256 private maxOGSupply = 99;        // nombre max de NFT pour le marketing/cadeaux
    uint256 private maxMintAmountOG = 1;    // nombre max de NFT mintables par une addresse
    bool    private ogSaleOpen;       // vente publique fermee a la ccreation du contrat
    mapping(address => uint256) public AddressPurchasesOG;
    // WHITELIST
    uint256 public whitelistPrice = 0.00005 ether;  // prix de la presale modificable par le owner
    uint256 private maxWhitelistSupply = 900;    // nombre max de NFT pour la presale/Whitelist
    bool    private whitelistSaleOpen;       // vente publique fermee a la ccreation du contrat
    // PUBLIC 
    uint256 public publicPrice = 0.00006 ether;   // prix de la publicSale modificable par le owner
    uint256 public maxPublicSupply = 999;    // nombre max de NFT pour le public
    bool    private publicSaleOpen; 
    uint256 private maxMintAmount = 3;    // nombre max de NFT mintables par une addresse
    // Sale Stuff
    bool private contract_LOCK = false;        // Locks contract data for ever
    mapping(address => uint256) public AddressPurchases;
    bool public revealed = false;

    address private _team1 = 0x26402eD875BAa5177eCcbABcE09A112a17Fd7873; // me
    address private _team2 = 0xB12940074CB5Ab121E697B97E2bDe930abe1721C; // pep
    address private _team3 = 0xa575b0CE406cea0a64b4C246EEaB62eE4b18f473;// hyperino
    ...
    function mintOG(uint256 _mintAmount) public payable  {
        ...
        require(ogSaleOpen, "OG Whitelist not open!"); // 
    ...
    function mintPublic(uint256 _mintAmount  ) public payable {
        ...
        require(_mintAmount <= maxMintAmount ,"3 NFT maximum per Wallet!");
        require(AddressPurchases[msg.sender]+_mintAmount <= maxMintAmount+3,  "Maximum NFTs minted per wallet");// no more mints for address // max nfts mintable
    ...
    function setWhitelistSaleOpen(bool _state,string memory init) external onlyOwner {
