  ...
  IERC2981Upgradeable
{
  ...
  bytes32 public constant MINTER_ROLE = keccak256("MONTER_ROLE");
  ...
  mapping(uint256 => uint256) public ciculatingSupply;
  ...
  function initialize(
    ...
    __AlturaERC1155_init_unchained(_name, _creator, _factory);
  }
    ...
    returns (address receiver, uint256 royaltyAmount)
  {
    return (
      creatorOf(_tokenId),
      ((_salePrice * royaltyOf(_tokenId)) / PERCENTS_DIVIDER)
    );
  }
}
