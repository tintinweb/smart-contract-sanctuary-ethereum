...
contract TestVRF is VRFConsumerBaseV2 {
    ...
    uint256[] public vrf_randomWords;
    ...
    function fulfillRandomWords(
        ...
        vrf_randomWords = randomWords;

        getRandomNumber();
    }

    function getRandomNumber() internal view returns (uint256[] memory) {
        // how to implement waits and returns
        return vrf_randomWords;
    }

    // function addConsumer(address consumerAddress) external onlyOwner {
    //     // Add a consumer contract to the subscription.
    //     COORDINATOR.addConsumer(vrf_subscriptionId, consumerAddress);
    // }

    // function removeConsumer(address consumerAddress) external onlyOwner {
    //     // Remove a consumer contract from the subscription.
    //     COORDINATOR.removeConsumer(vrf_subscriptionId, consumerAddress);
    // }

    // function cancelSubscription(address receivingWallet) external onlyOwner {
    //     // Cancel the subscription and send the remaining LINK to a wallet address.
    //     COORDINATOR.cancelSubscription(vrf_subscriptionId, receivingWallet);
