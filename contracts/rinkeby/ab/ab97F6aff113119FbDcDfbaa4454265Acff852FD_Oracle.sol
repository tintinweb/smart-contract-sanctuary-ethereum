...
contract Oracle is TellorVars {
    // Storage
    uint256 public reportingLock = 60;//former 10 hours // amount of time before a reporter is able to submit a value again
    ...
    struct Report {
        ...
        mapping(uint256 => uint256) valueByTimestamp; // mapping of timestamps to values
    ...
    function removeValue(bytes32 _queryId, uint256 _timestamp) external {
        ...
        rep.timestamps.pop();
        rep.valueByTimestamp[_timestamp] = 0;
