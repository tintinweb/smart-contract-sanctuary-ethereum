...
contract NounsDescriptor is INounsDescriptor, Ownable {
     ...
     */
    function addArtAndColorBunch(uint8 paletteIndex, string[] calldata newColors, bytes calldata art) external override onlyOwner {
...
interface INounsDescriptor {
    ...
    function addArtAndColorBunch(uint8 paletteIndex, string[] calldata newColors, bytes calldata art) external;
