...
// File: contracts/Factory/IDOGEForbiddenTlds.sol


pragma solidity ^0.8.4;

interface IDOGEForbiddenTlds {
...
// File: contracts/Factory/IDOGETLDFactory.sol


pragma solidity ^0.8.4;

interface IDOGETLDFactory {
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     * @return bool whether the call correctly returned the expected WDOGE value
     */
...
// File: contracts/Factory/strings.sol
...
// File: contracts/Factory/DOGETLD.sol
...
/// @title DOGE Domains TLD contract (v2)
/// @author Tempe Techie
/// @notice Dynamically generated NFT contract which represents a top-level domain
contract DOGETLD is ERC721, Ownable, ReentrancyGuard {
  using strings for string;

  uint256 public price; // domain price
  bool public buyingEnabled; // buying domains enabled
  address public factoryAddress; // DOGETLDFactory address
  uint256 public royalty; // share of each domain purchase (in bips) that goes to DOGE Domains
  ...
  string public description = "DOGE Domains digital identity. Visit https://DOGE.domains/";
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    IDOGETLDFactory factory = IDOGETLDFactory(factoryAddress);
  ...
  // FACTORY OWNER (current owner address of DOGETLDFactory)
...
// File: contracts/Factory/DOGETLDFactory.sol
...
/// @title DOGE Domains TLD Factory contract (v2)
/// @author Tempe Techie
/// @notice Factory contract dynamically generates new TLD contracts.
contract DOGETLDFactory is Ownable, ReentrancyGuard {
  using strings for string;

  string public projectName = "DOGE.domains";
  ...
  uint256 public royalty = 0; // royalty for DOGE Domains when new domain is minted 
  ...
  function _validTldName(string memory _name) view internal {
    ...
    IDOGEForbiddenTlds forbidden = IDOGEForbiddenTlds(forbiddenTlds);
