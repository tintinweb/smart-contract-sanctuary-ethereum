...
// File: contracts/theMetalorianDAOBronze.sol
...
///@title TheMetalorianDAOBronze
///@notice Token ERC721 for the Metalorian DAO 
contract TheMetalorianDAOBronze is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 20000;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 20000;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian DAO Bronze", "TMDB") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeibpwr2zjobhjxw37la6gsxijh5vnd727cwdy2erzpommo3rapzczi/BronzeMetadata/";   
        mintCost = 0.000005 ether;
    }
    ...
    event MintTheMetalorianDAOBronze(address indexed user, uint256 tokenId); 
    ...
    function mintTheMetalorianDAOBronze(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDAOBronze(msg.sender, tokenIdCounter.current());            
