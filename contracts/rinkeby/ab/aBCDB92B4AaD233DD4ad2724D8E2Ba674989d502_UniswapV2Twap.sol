...
contract UniswapV2Twap {
    ...
    // wait a minimum of 1800 seconds between updates
    uint public constant PERIOD = 1800;
    ...
    // the last block timestamp that we updated the price
    ...
    // NOTE: IUniswapV2Pair
    // since we are using pragma 0.6, we have to use public 
    constructor(IUniswapV2Pair _pair) public {
        ...
        // getReserves returns three outputs, reserve0, reserve1, blockTimestampLast(which we assigned)
