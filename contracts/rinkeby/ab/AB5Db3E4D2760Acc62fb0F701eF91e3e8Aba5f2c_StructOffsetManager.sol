...
contract StructOffsetManager is VRFConsumerBaseV2, Ownable {
     ...
     */
    function setVRFRequestConfig(VRFRequestConfig calldata vrfRequestConfig) public onlyOwner {
        _VRF_REQUEST_CONFIG = vrfRequestConfig;
    }
     ...
     */
    function offsetWithPRNG(Offsetable offsetable) public {
     ...
     * @param offsetable Address of Offsetable contract
     */
    // TODO: PERMISSION/CHARGE FOR FUNCTION SO ANYONE CANT USE OUR $LINK
    function offsetWithVRF(Offsetable offsetable) public {
        if (Ownable(address(offsetable)).owner() != _msgSender())
            revert StructOffsetManager_CallerNotContractOwner();
