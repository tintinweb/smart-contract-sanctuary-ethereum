...
contract TaipeiMonopolyNFT is ERC721RExample {
    function sayHi() external pure returns (string memory) { // 只有外部可以呼叫，回傳字串 （memory，不記錄在區塊鏈上，使用完即消失）
        return "Hi I'm  in taipei.";
    }
}
...
contract ERC721RExample is ERC721A, Ownable {
    ...
    uint256 public constant maxUserMintAmount = 1;
