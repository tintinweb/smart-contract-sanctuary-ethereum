    ...
    ITimeLocked
{
     ...
     * is past `lockEnd`.
     *
     * WARNING: `_mint` will also be blocked since `from` will have
     * zero balance, but this is not functionality we use anymore.
     * To enable minting in the future, this hook needs to be removed.
     */
