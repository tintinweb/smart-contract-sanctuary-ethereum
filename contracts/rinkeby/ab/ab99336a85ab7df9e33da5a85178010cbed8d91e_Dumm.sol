...
contract Dumm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Dumm";
    string private constant _symbol = "DUMM";
    ...
    address payable private _developmentAddress = payable(0x72330172444fCE7A11F5F9132A22805e23DEA2ac);
    address payable private _marketingAddress = payable(0x72330172444fCE7A11F5F9132A22805e23DEA2ac);
