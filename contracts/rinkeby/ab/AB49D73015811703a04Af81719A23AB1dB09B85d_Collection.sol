...
constructor()public ERC1155 ("https://bafybeicl5wux3yohl4zui7xa6dpytg4el3e3qbal25wlysupcv5knjt4mm.ipfs.nftstorage.link/{id}.jpg"){
    mint(msg.sender,0, 10**18,"");
    mint(msg.sender,1, 10**18,"");
    mint(msg.sender,2, 10**18,"");
    mint(msg.sender,3, 10**18,"");
