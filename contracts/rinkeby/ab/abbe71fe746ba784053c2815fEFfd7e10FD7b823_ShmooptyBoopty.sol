...
contract ShmooptyBoopty is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint128 public  releaseTimestamp = 0;
  ...
  mapping(address => uint64) public addressMintBalance;

  constructor(
    uint128 release
  ) ERC721A("ShmooptyBoopty", "BOOP") {
    releaseTimestamp = release;

    Tiers[5] = Tier(0, 0.00000888 ether, _maxMintAmountPerTx);
    Tiers[4] = Tier(0, 0.00000888 ether, _maxMintAmountPerTx-1);
    Tiers[3] = Tier(0, 0.00000999 ether, _maxMintAmountPerTx-1);
    Tiers[2] = Tier(86400, 0.00000999 ether, _maxMintAmountPerTx-2);
    Tiers[1] = Tier(86400, 0.0000111 ether, _maxMintAmountPerTx-2);
    Tiers[0] = Tier(172800, 0.0000111 ether, _maxMintAmountPerTx-2);
  }
    ...
    private
  {
    ...
    require(
      block.timestamp > (releaseTimestamp + t.wenOffset),
  ...
  function setReleaseTimestamp(uint128 release)
    public
    onlyOwner
  {
    releaseTimestamp = release;
  ...
  function treasuryMint(uint256 quantity)
    public
    onlyOwner
  {
    require(
