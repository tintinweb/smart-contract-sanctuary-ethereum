...
contract Onitama is Ownable, ERC721A {
    ...
    address public teamAddress = 0x7D84186286EDd37dbD4013624efdf8aE33727006;
    ...
    function whitelistMint(
        ...
        if (addressMintedCount[msg.sender] + quantity > mintLimit)
    ...
    function isAuthorized(
        ...
        bytes32 hash = keccak256(
            abi.encode(abi.encodePacked(sender, mintLimit))
        );

        return signerAddress == ecrecover(hash, v, r, s);
    }
