...
contract JackpotRoyaleSpecialEdition is ERC1155, Ownable {
    string private baseUri; // Pinata URL
    string public name; // Collection Name
    string public symbol; // Collection symbol
    address private externalContractAddress; // Collabrated contract address

    uint256 private unitPrice = 0.01 ether;
    uint256 private maxSupply = 10;
    uint256 private mintingLimitPerTransaction = 10;
