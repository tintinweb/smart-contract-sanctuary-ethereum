...
contract GamblingGnomes is ERC721, Ownable {
    ...
    uint256 public _presale_price = 69000000000000000; // 0.06 ETH
    bool private _presaleActive = false;
    bool private _saleActive = false;

    string public _prefixURI = "ipfs://QmVSHSkVPK522xnRK4btoqZqhrEQ8uQkLgyoXntchijWjd/";
    ...
    function withdraw_all() external onlyOwner {
        ...
        //main
        payable(0xa9Eea183Ae91478F7F78E0358b041A1954ed471b).transfer(balance * 9500 / 10000);
        //dev
        payable(0x679d81EeC316Cf2443CE6438a8B5b5eCFB9723bd).transfer(balance * 500 / 10000);
    }
}
