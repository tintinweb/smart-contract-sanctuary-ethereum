...
import "./IEtherspotHelper.sol";
import "./lz/NonblockingLzApp.sol";
contract BridgeHelperV3 is IEtherspotHelper, NonblockingLzApp {
    uint public counter;
...
interface IEtherspotHelper {
    event BridgingStarted(address asset, address from, address to);
    event BridgingCompleted(address asset, address to);
