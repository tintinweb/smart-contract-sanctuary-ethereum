    ...
    ReentrancyGuard
{
    ...
    function toggleDirectBuyoutEnabled() public {
        require(isDirectBuyoutAllowed, "Direct buyout is not start");
    ...
    function _updateReservePrice(uint256 _reservePrice, uint256 weight) internal {
        uint256 lowerBound = (baseUnitReservePrice *
            globalGovernanceSettings.minUnitReservePrice()) /
            10000;
        uint256 upperBound = (baseUnitReservePrice *
            globalGovernanceSettings.maxUnitReservePrice()) /
            10000;
        ...
        uint256 _weightedReservePrice = (_reservePrice * weight * totalFNFT) /
            totalSupply();
        ...
        internal
    {
        ...
        uint256 _weightedAuctionLength = (_auctionLength * weight) /
            totalSupply();
