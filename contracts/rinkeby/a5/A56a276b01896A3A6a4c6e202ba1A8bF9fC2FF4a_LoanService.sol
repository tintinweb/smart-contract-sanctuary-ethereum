...
contract LoanService is Ownable {
    ...
    function processOffers(LoanCommon.Loan memory _loan, uint256[] memory _offers) internal {
        ...
        uint256 loanCalculatedInterest = 0;
        for (uint256 i = 0; i < _offers.length; i++) {
            ...
            loanCalculatedInterest = loanCalculatedInterest.add(offer.interest);
        }
        ...
        updateLoanCalculatedInterest(_loan.loanId, loanCalculatedInterest.mul(10).div(_offers.length));
    }
