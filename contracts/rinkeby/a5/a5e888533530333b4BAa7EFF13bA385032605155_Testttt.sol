...
contract Testttt is ERC20, Ownable {
    ...
    constructor() ERC20("A", "A") {
        ...
        minimumFeeTokensToTake = _totalSupply / 1000;
    ...
    // used to have a dynamic swapback amount
    function lpCheck() internal {
        if (currentLP == 0) {
            (uint256 r1, uint256 r2, ) = uniswapV2Pair(pair).getReserves();
            if (r1 > 0 || r2 > 0) {
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 usdcBalance = IERC20(USDC).balanceOf(address(this)) - initialBalance;
