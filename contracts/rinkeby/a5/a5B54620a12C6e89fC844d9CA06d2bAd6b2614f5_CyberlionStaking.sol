...
contract CyberlionStaking is Ownable {
    ...
    constructor(intable _rewardsToken, address _heatClAddress) {
    ...
    function _claimReward(address _userAddress, uint256 _collectionID) internal {
        // UserInfo storage user = userInfo[_userAddress];
        // CollectionInfo storage collection = collectionInfo[_collectionID];
       uint256 payableAmount = 1000000000000000000;
        ...
        //     mintMinerReward(payableAmount);
            rewardsTokenAddress.transferFrom(heatClAddress, _userAddress,  payableAmount);
    }
