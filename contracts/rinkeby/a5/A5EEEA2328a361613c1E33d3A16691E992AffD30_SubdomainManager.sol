...
contract SubdomainManager is  IManager, IERC721Receiver, Ownable, ERC165, ERC721, IERC2981, ENSEnumerable {
    ...
    event UpdateDefaultMintPrice(address indexed _addr, uint256 indexed _id, uint256 _defaultPriceInWei);
    ...
    IReverseResolver public ReverseResolver = IReverseResolver(0x6F628b68b30Dc3c17f345c9dbBb1E483c2b7aE5c);
...
function depositEns(string calldata _label, uint256 _royalty, uint256 _mintPrice, string calldata _defaultImageUri) payable external {
    ...
    function registerSubdomain(uint256 _id, string memory _label) payable public {
        ...
        if (msg.sender != owner){
            ...
            require(IdToRegisterMap[_id].canRegister(_id, _label, msg.sender, msg.value));
        }
    ...
    function setMintPrice(uint256 _id, uint256 _price) public tokenOwner(_id) {
        ...
        emit UpdateDefaultMintPrice(msg.sender, _id, _price); 
    }
...
contract MetadataProviderV1 is IMetadata {
   ...
   function tokenURI(uint256 tokenId) public view returns(string memory){
        ...
        string memory locked = (ens_func.ownerOf(ownerId) == address(Manager)) && (Manager.TokenLocked(ownerId)) ? "True" : "False";
