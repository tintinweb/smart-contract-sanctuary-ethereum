...
contract TheTestingNft is ERC721A, Ownable {
    ...
    uint256 public presaleMintLimit = 1;
    uint256 public nftPerAddressLimit = 1;
    uint256 public freeMintingLimit = 2;
    bytes32 public merkleRoot =
        0x4561e3f811a5b66491bafb520b284d434ae1f577be32e319a11dfdd9ce3e9214;
    bool public paused = false;
    mapping(address => uint256) public addressMintPresaleCount;

    struct Period {
        uint32 presalesStartTime;
        uint32 presalesEndTime;
    }

    Period public period;

    constructor() ERC721A("The Testing NFt", "TESTINGNFT", 1) {
        setBaseURI("ipfs://QmbHckn8mwSeFKs9ATCb7fEzbjhPXpKG1hAPBi1Sd11dDD/");
        setPeriods(1645020000, 1648471500);
    }
    ...
    function getCurrentCost() public view returns (uint256) {
        ...
        if(totalSupply()<freeMintingLimit){
            return 0 ether;
        } else if (isOnPresales()) {
            return presaleCost;
        } else {
            return cost;
        }
