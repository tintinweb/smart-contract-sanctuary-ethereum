...
contract Bolt is Ownable, ERC721A, ReentrancyGuard {
    ...
    //supply
    uint256 public  TotalCollectionSize_ = 20; // total number of nfts
    uint256 public  WL_Supply = 15; // total number of nfts for wl
    uint256 public  team_supply = 10; // total number of nfts for team
    uint256 public  team_q = 5; // total number of nfts for team
