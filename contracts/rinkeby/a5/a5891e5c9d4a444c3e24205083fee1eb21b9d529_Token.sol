...
contract Token is ERC20("Origins","OGN",18) {


    // 1 eth = 10 ^ 18 wei = 10 ^ 18 OGN
    // 1 wei == 1 OGN
    // ERC20
    // 1. Full length name of the token
    // 2. Short form
    // 3. Decimals
    // 1 USD = 100 Cents = 10 ^ 2(2 --> Decimal)
    // 1 ETH = Wei = 10^18
