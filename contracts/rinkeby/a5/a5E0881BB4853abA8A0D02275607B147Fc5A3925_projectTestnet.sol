...
contract projectTestnet is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() public ERC721A("projectTestnet", "PT", 1000, 1000) {}
        ...
        returns (string memory)
    {
        ...
        return
            bytes(currentBaseURI).length > 0
                ? string(
                    abi.encodePacked(baseURI, _tokenId.toString(), uriSuffix)
                )
                : "";
    }
