    ...
    AccessControl
{
    ...
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");//The role assigned to the USDPlusMinter
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");//The role assigned to the USDPlusBurner
