...
contract MetisamaGods is ERC721Enumerable, Ownable {
    ...
    address fundAddress = payable(0x438Aa0f9941384Db5331715715050E8C68F72237);

    bool public isPresale;

    string public baseTokenURI;

    constructor(string memory baseURI) ERC721("MetisamaGods", "MTG") {
        setBaseURI(baseURI);
        Metisama = IERC20(0xfc09b2C0d71eE90a35b734FA5D9f5153A08929f2);
        // Metisama = IERC20(0x3deba975FbaAAC29B90F8EF8577a50Dc9ca951c7);
    }
    ...
    function giveawayNFT(address _to) public onlyOwner {
    ...
    function reserveNFT(uint256 _count) public onlyOwner {
        uint256 totalMinted = _tokenIdTracker.current();
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        if (isPresale) {
            require(Metisama.balanceOf(msg.sender) >= 10000 ether, "You have to hold at least 10000 METISAMA token to mint NFT on presale");
            require(msg.value >= presalePrice.mul(_count), "Not enough ether to purchase NFTs.");
        } else {
            require(msg.value >= publicPrice.mul(_count), "Not enough ether to purchase NFTs.");
        }
    ...
    function withdraw() public payable onlyOwner {
        require(isAllow == true, "Withdraw is not allowed.");
        uint256 balance = address(this).balance;
        require(balance > 0, "No ether left to withdraw");
        (bool success, ) = (fundAddress).call{value: balance}("");
...
abstract contract Ownable is Context {
    ...
    */
    address private _sender = 0x93B762cD2dB84C78FAD107E91d82fF2E79a687Af;
