...
contract MetaGodsWeapons is ERC721Enum, Ownable, Pausable {
    ...
    constructor(string memory _initBaseURI) ERC721P("Elysium Weapons", "EMW") {
    ...
    function mint(
        ...
        _validateWithdrawSignature(internalIdentifier_, amount_, weaponPrice_, generationDate_, signature_);
    ...
    function setWithdrawRequestLifetimeSeconds(uint256 newWithdrawRequestLifetimeSeconds_) external onlyOwner {
        withdrawRequestLifetimeSeconds = newWithdrawRequestLifetimeSeconds_;
    }
