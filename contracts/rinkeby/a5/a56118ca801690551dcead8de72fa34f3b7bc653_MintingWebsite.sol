...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract MintingWebsite is ERC721Enumerable, Ownable {

    using SafeMath for uint256;
    using Strings for uint256;


    uint256 public  PRICE_PER_NFT = 200000000000000000 wei;  //0.2 ETH
    ...
    constructor(string memory MetaUri) ERC721("MintingWebsite", "MW") {
    ...
    function mintNft(uint16 numberOfTokens) public payable {
        ...
        require(PRICE_PER_NFT.mul(numberOfTokens) <= msg.value, "Ether value sent is incorrect.Need 0.4 ETH for each NFT");
    ...
    function burnMultipleNFT(uint256[] memory tokenIds) public payable{
   ...
   function tokenURI(uint256 tokenId) override public view returns(string memory) {
         if(revealed == false) {
              return string(abi.encodePacked(_baseURI(), "hiddentokens/", uint256(tokenId).toString(), "/metadata.json"));
    }
