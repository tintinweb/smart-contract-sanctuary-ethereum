...
contract TheyDontKnow is ERC721Enumerable, Ownable {
    ...
    mapping(address => bool) private mintedList;

    constructor() ERC721("TheyDontKnow", "TDK") {}

    // Mint Free
    function Mint() external payable {
        uint256 next_token = totalSupply() + 1;
        require(status == 1, "Mint is not active");
        require(!mintedList[msg.sender], "Address already claimed");
        require(next_token < MAX_SUPPLY, "Purchase would exceed max tokens");
