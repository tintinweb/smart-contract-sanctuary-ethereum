    ...
    PaymentSplitter 
{
    ...
    uint256 public maxSupply = 103;

    string public baseURI; 
    string public notRevealedUri = "ipfs://QmYUuwLoiRb8woXwJCCsr1gvbr8E21KuxRtmVBmnH1tZz7/hidden.json";  //Imagem que verao antes de revelar
    ...
    uint256 publicsaleMaxMint = 5;

    mapping(address => uint256) public _presaleClaimed;

    uint256 _price = 1500000000000000; // 10000000000000000 = 0.01 ETH   1500000000000000 = 0,0015 ETH
    ...
    onlyAccounts
    {
        ...
        require(
            _amount <= presaleAmountLimit,      "Punks Paradise: You can't mint so much tokens");
        require(
            _presaleClaimed[msg.sender] + _amount <= publicsaleMaxMint,  "Punks Paradise: You can't mint so much tokens");

        require(
            _amount <= publicsaleMaxMint,      "Punks Paradise: You can't mint so much tokens");
        require(
            _presaleClaimed[msg.sender] + _amount <= publicsaleMaxMint,  "Punks Paradise: You can't mint so much tokens");
