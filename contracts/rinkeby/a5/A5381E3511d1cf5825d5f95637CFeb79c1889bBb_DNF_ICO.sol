...
contract DNF_ICO is Ownable {
    ...
    event CollectorUpdate(address indexed _fundCollector);
    event MaxCapUpdate(uint256 _amount);
    event MinContributionUpdate(uint256 _amount);
    event MaxContributionUpdate(uint256 _amount);
    ...
    function updateFundCollector(address _fundCollector) external onlyOwner {
        ...
        emit CollectorUpdate(_fundCollector);
    }

    function updateMaxCap(uint256 _maxCap) external onlyOwner {
        maxCap = _maxCap;
        emit MaxCapUpdate(_maxCap);
    }
        ...
        onlyOwner
    {
        ...
        emit MinContributionUpdate(_minContribution);
    }
        ...
        onlyOwner
    {
        ...
        emit MaxContributionUpdate(_maxContribution);
    }
