 ...
 */
contract ProjectStarter is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("Project Starter", "PRO") public {
    ...
    */
    function mintPro(address payable recipient, string memory uri, uint256 mintIndex) public payable onlyMaster returns (uint256) {
