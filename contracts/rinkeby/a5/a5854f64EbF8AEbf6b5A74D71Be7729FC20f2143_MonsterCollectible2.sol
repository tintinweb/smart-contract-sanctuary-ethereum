...
contract MonsterCollectible2 is ERC721URIStorage, Ownable, Pausable, VRFv2Consumer {
    ...
    mapping(address => uint) private addressToUnmintedPacks; // Address -to- Number of unminted pack in wallet
    mapping(uint => uint) public tokenIdToMonster; // Unique NFT Token ID -to- Monster ID
    ...
    function mintBoosterPack() external {
        ...
        addressToUnmintedPacks[msg.sender] == 0;
    }
    ...
    function mintMonster(uint256 _monster, address _monsterOwner) private {
        ...
        tokenIdToMonster[newTokenId] = _monster;
