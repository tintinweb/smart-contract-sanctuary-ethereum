...
contract eithBITBAYC is ERC721, NonblockingReceiver {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(!paused, "8bitbayc: Paused");
        require(nextTokenId + _amount <= MAX_MINT, "8bitbayc: Mint exceeds supply");
        require(MAX_PER_TX >= _amount , "8bitbayc: Excess max per tx");
        require(MAX_PER_WALLET >= minted[_caller] + _amount, "8bitbayc: Excess max per wallet");
