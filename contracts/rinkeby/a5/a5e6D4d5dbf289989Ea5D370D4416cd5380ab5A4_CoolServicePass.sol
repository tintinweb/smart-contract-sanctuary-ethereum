...
contract CoolServicePass is ERC1155, ERC1155Supply, Ownable {
    using Strings for uint256;

    // The name of the token ("Cool Pass Project")
    string public name;
    // The token symbol ("CHRLS")
    ...
    mapping(uint256 => Pass) private episodeToProducerPass;
    ...
    function setProducerPass(
        ...
        episodeToProducerPass[episodeId] = Pass(
            price,
            episodeId,
            maxSupply,
            maxPerWallet,
    ...
    function reserveProducerPassesForGifting(
        ...
        Pass memory pass = episodeToProducerPass[episodeId];
