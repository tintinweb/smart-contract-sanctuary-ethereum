  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x1E7D6cB76F5D8f5b51CDd3F05352B9159bc70057);
    ...
    // File: contracts/mgv2TestContractContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract Mgv2TestContractContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("MGV2_Test_contract", "MGV2", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/74y6Jq0cpMqSV02dO3Cx/contract-metadata";
        }
    }