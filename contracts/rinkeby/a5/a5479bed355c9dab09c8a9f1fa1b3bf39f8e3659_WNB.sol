...
contract WNB is ERC721A , Ownable  {
    ...
    function changeMaxMint(uint256 maxMint) public onlyOwner {
     ...
     constructor() ERC721A("Wicked N Bad", "WNB") {}
        ...
        address payable one = payable(0x3edCe801a3f1851675e68589844B1b412EAc6B07);
        address payable two = payable(0x3edCe801a3f1851675e68589844B1b412EAc6B07);
        address payable three = payable(0x3edCe801a3f1851675e68589844B1b412EAc6B07);
   
        one.transfer(balance.mul(40).div(100));
        two.transfer(balance.mul(40).div(100));
        three.transfer(balance.mul(20).div(100));
