...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x71ECB18fcD700C10ca3588d1d21d09bE1BF92a8d];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "http://foo.com/";
...
// File: contracts/SamTest1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SamTest1Contract is RamppERC721A {
    constructor() RamppERC721A("SamTest1", "ST1"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/X4umObRvyv2DqrWVEslr/contract-metadata";
    }
}
