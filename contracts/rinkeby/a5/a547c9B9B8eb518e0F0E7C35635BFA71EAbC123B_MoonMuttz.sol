...
contract MoonMuttz is ERC721, Ownable {
   using Address for address;
    ...
    using SafeMath for uint256;
        ...
        // Base URI
    string private _nftBaseURI = "ipfs://bafybeihrzqovx5glo5mkwope2vjys6iqngoegpqpywctccd6mr2z4ccoqi/";
    string private _extension = '.json';

    // Token Supply
    uint private immutable _totalSupply = 10000;
    uint private immutable _totalPresaleSupply = 3000;
    uint private currentSupply = 0;
    uint private maxPerWallet = 5;
    ...
    function buyTokensOnPresale(uint256 tokensNumber, bytes calldata signature) public payable {
      ...
      require((currentSupply.add(tokensNumber)) <= _totalPresaleSupply , "You try to mint more tokens than totalPresaleSupply");
    ...
    function changePresalePrice(uint _newPresalePrice) public onlyOwner{
