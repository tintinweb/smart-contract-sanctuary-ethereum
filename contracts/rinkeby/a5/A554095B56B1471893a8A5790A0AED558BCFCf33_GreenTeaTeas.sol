...
contract GreenTeaTeas is ERC721, Ownable, VRFConsumerBase {
    ...
    uint128 public constant MAX_SUPPLY = 10; // TODO to 1k
    uint256 public constant MINT_PRICE = 0.005 ether; // TODO to 0.066
    ...
    constructor(string memory _baseURI, address[] memory _team, address[] memory _whiteList) // TODO base uri wont be set during init
        ERC721("GreenTeaTeas", "GTT")
        VRFConsumerBase(
        // @see https://docs.chain.link/docs/vrf-contracts/v1/
            0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B, // VRF Coordinator TODO To MainNet
            0x01BE23585060835E02B77ef475b0Cc51aA1e0709  // LINK Token TODO ToMain Net
        )
    {
        setBaseURI(_baseURI);
        team = _team;
        ...
        for(uint128 i = 0; i < team.length; i++){
            preMint(team[i]);
        }
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if(! isRevealed){
            return notRevealedUri; // TODO possible to hardcode this to reduce gas fees.
        }
    ...
    function preMint(address to) internal {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        randomResult = expand((randomness % MAX_SUPPLY) + 1, RAFFLE_WINNERS); // TODO verify keys align with the keys of the owners array
    ...
    function _withdrawCharity(uint256 amount) internal {
        payable(0xB5C181F7Fb2590F92086203B90f6A9546aB646F2).transfer(amount); // TODO  Charity account testnet
    }

    function _withdrawRaffle(uint256[] memory winningTokens) internal { // TODO verify memory
