...
contract TESTT is ERC20, Ownable {
    ...
    address public constant token = address(0xc778417E063141139Fce010982780140Aa0cD5Ab); // BAKE
    ...
    constructor() ERC20("TEST", "TEST") {
    	...
    	marketingWallet = address(0x18169773B258fC64225073419425dcD0004A3215); // set as marketing and maintenance wallet
        devWallet = address(0xECED8Ea0E64e2F3AdE0B1CE6EAA6B0959E10616c); // set as dev fee wallet
