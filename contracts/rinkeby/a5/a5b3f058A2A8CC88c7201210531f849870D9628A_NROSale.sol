...
contract NROSale is Ownable, ReentrancyGuard {
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1656478800;
    uint64 public immutable whitelistEndTime = 1656480600;

    uint64 public immutable publicStartTime = 1656480600;
    uint64 public immutable publicEndTime = 1656482400;

    uint64 public immutable withdrawTime = 1656482400;
