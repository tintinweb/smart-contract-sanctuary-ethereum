...
// Royalties
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view returns (address, uint256) {
        ...
        uint256 royaltyAmount = (_salePrice * royaltyFee) / _feeDenominator();

        return (creator, royaltyAmount);
    }
   
      function setRoyalityFee(uint96 _royaltyFee) public onlyOwner {
          require(_royaltyFee <= _feeDenominator(),"royalty fee will exceed salePrice");
        royaltyFee = _royaltyFee;
    }
