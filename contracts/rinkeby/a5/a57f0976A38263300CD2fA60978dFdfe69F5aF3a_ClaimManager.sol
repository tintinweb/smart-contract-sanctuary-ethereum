...
contract ClaimManager {
  ...
  */
  ...
  modifier isManager {
    require(
      saleManager.getManager(saleId) == msg.sender,
  ...
  function void(address claimant) public isManager saleOver returns (uint256) {
  ...
  function open() public isManager saleOver {
