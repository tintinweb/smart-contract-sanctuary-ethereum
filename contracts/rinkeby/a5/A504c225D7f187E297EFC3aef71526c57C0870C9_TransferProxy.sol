...
//@title TransferProxy is used for communicating with Viku721, Viku1155, tokens(WETH, WBNB, WMATIC,...).
...
contract TransferProxy is AccessControl, ITransferProxy {
    ...
    //@notice the function transfers Viku721 NFTs to users.
    //@param token, Viku721 address @dev see {IERC721}.
    ...
    //@notice the function transfers Viku721 NFTs to users.
    //@param token, Viku1155 @dev see {IERC1155}.
    //@param from, seller address, NFTs to be transferrred from this address.
    //@param to, buyer address, NFTs to be received to this address.
    //@param tokenId, unique NFT id to be transfer.
    ...
    //@notice function used for Viku1155Lazymint, it does NFT minting and NFT transfer.
    //@param nftAddress, Viku1155 @dev see {IERC1155}.
    ...
    //@notice function used for Viku721Lazymint, it does NFT minting and NFT transfer.
    //@param nftAddress, Viku721 address @dev see {IERC721}.
    //@param from, NFT to be minted on this address.
    //@param to, NFT to be transffered from address to this address.
    //@param _tokenURI, IPFS URI of NFT to be Minted.
    //@param _royaltyFee, fee permiles for secondary sale.
