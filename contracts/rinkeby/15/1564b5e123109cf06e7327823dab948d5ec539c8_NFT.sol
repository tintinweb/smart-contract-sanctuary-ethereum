...
contract NFT is ERC721, ERC2981ContractWideRoyalties, Ownable
{
    using Strings for uint256;
    ...
    constructor(
      ...
      address[] memory _whiteListAddress
        ...
        presaleEndDate = _publicsaleStartDate;
        revealDate = _revealDate;
        PRICE = _price;
        PRE_PRICE = _premintprice;
        MAX_SUPPLY = _totalsupply;
        addToWhitelist(_whiteListAddress);
    }
    
    function addToWhitelist(address[] memory _addresses) private {
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        if (block.timestamp < presaleEndDate) {
            ...
            require(preMinted[msg.sender] <= 10, "Address can't mint more than 10 NFTs in pre-sale.");
        } else {
            minted[msg.sender] += _count;
            require(minted[msg.sender] <= 20, "Address can't mint more than 20 NFTs in public-sale.");
        }
