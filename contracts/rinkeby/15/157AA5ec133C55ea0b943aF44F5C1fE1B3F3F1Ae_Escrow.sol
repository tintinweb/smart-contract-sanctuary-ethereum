...
contract Escrow {
  ...
  function accept(address _tx_id, address _buyer, ERC20 _token,  uint256 _amount) external payable returns (uint256) {
    token = _token;
    ...
    balances[msg.sender][_tx_id].amount = _amount * (10 ** 18);
