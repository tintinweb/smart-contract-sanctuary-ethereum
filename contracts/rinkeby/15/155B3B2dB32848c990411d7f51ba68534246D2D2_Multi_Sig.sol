   ...
   address[] public payroll = [
    ...
    constructor()
    {
     ...
     adminMapping[0x9376b1b8931f3F02B4119665079fb37C91d05464] = keccak256("admin"); //coso
      adminMapping[0x1687f54B8E34ddE855629e5aada05E824320F0A5] = keccak256("admin"); //manic
       adminMapping[0xb1Bc6128Ff9493b4fca2d90A3dfF2F8921558475] = keccak256("admin"); //syed
        adminMapping[0x0c2f8b7D7A7C8979F8297c14d27e76E7909ac1c0] = keccak256("admin"); //meri
            adminMapping[0x6884efd53b2650679996D3Ea206D116356dA08a9] = keccak256("admin"); //for testing purposes;
        //  adminMapping[0x4d98F36b5C831229aeff18637221264EDDf13F1E] = keccak256("admin");
        //     adminMapping[0x5B38Da6a701c568545dCfcB03FcB875f56beddC4] = keccak256("admin");
    }
