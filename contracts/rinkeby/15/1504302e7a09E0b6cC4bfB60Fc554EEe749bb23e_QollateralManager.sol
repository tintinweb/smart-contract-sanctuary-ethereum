...
contract QollateralManager is Initializable {
  ...
  function initialize(address qParamsAddress_, address qontrollerAddress_) public initializer {
  ...
  function _setCloseFactor(uint closeFactor_) external {
    ...
    require(closeFactor_ <= _qParams.MANTISSA_FACTORS(), "must be between 0 and 1");
  ...
  function _setLiquidationIncentive(uint liquidationIncentive_) external {
    ...
    require(
            liquidationIncentive_ >= _qParams.MANTISSA_FACTORS(),
