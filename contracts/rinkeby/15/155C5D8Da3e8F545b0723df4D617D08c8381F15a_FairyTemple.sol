...
contract FairyTemple is ERC721, ERC721Enumerable, Ownable 
{
    ...
    function mintTokenWlSale(uint256 amount) external payable
    {
        ...
        require(balanceOf(msg.sender) + amount <= 2, "Limit is 2 tokens per wallet, this sale not allowed"); 
    ...
    function mintTokenPreSale(uint256 amount) external payable
    {
        ...
        require(balanceOf(msg.sender) + amount <= 5, "Limit is 5 tokens per wallet, this sale not allowed"); 
