...
contract Minisquatch is ERC721Enumerable, Ownable {
  ...
  address public metasquatchAddress = 0x571777587D4d8BEC631730D38fFD014379E523F8;
  address public landAddress = 0x54CfEF426Dc91E3727D1FbfD843cF89d57cd87de;

  address public rewardPool = 0x090DEB1155C4aEC2eC8774954852d0fEB4Fad23C;
  ...
  function mint() public payable {
    ...
    require(IRewardPool(rewardPool).addNodeInfo(supply + _mintAmount, msg.sender), "Can't update rewardpool data");
