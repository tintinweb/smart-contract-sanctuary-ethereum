...
contract MonsterFallen is MonsterBase {
  ...
  string internal constant _CHAMBER_NAME = "Chamber(1) with Fallen";
  uint internal constant _CHAMBER_TYPE = uint(IChamberController.ChamberType.ENEMY_NPC);
