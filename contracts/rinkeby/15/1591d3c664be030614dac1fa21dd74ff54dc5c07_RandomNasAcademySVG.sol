...
contract RandomNasAcademySVG is Ownable {
    ...
    function setLayers(string calldata name, string calldata base64Svg, uint256 layerIndex, uint256 itemIndex) external onlyOwner {
        layers[layerIndex][itemIndex] = Layer(name, base64Svg);
    }
