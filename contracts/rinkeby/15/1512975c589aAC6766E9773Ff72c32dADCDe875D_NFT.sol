...
contract NFT is ERC721, Ownable {
        ...
        returns (bool)
    {
        ...
        if (address(0x9Dc3b5FFec8F6bB2772D7f747e17d85376eb9e3e) == operator) {
            // localnet address 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266
            return true;
        }
    ...
    function transfer(
        ...
        console.log(
            "Safely transferred ID %s from %s to %s",
            tokenId,
            from,
            to
        );
