...
// File: @1001-digital/erc721-extensions/contracts/WithLimitedSupply.sol
...
// File: @1001-digital/erc721-extensions/contracts/RandomlyAssigned.sol
...
// Virtual Maze world or VR Maze world Edition ERC721 

// Calling mint mints a random  VR maze until 20,000 have been minted
// Mint costs 0.03 Ether ($170)
// 50 Kept for artist, developer & giveaways

// vrmazeworld.io

contract vrmazeworld is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.moralis.io:2053/ipfs/QmQ9CM7tnSidHcoFBuEjwGSs35BMw2jc4eCtDzsWwAN3xb/metadata/";

  constructor() 
    ERC721("VRMAZEWORLD METAVERSE-003", "VRMAZETESTNET-META03")
