...
contract Naffle is Ownable, ERC721A {
    bytes32 public merkleRoot;

    uint256 public MAX_SUPPLY = 8888;
    uint256 public TEAM_MINT_MAX = 500;

    uint256 public allowListMax = 2500;
    uint256 public publicMintMax = 5888;
    
    uint256 public ALLOW_LIST_PRICE = 0.15 ether;
    uint256 public PUBLIC_PRICE = 0.2 ether;

    uint256 constant public ALLOW_LIST_MINT_LIMIT = 2;

    uint256 public PUBLIC_MINT_LIMIT = 4;

    uint256 public totalSupplyTeam;
    uint256 public totalSupplyPublic;

    // Remaining ~42% goes to the community pot
    uint256 internal DEV_WITHDRAW_PERCENT = 2500;
    uint256 internal FOUNDER_WITHDRAW_PERCENT = 3000;
    uint256 internal ARTIST_WITHDRAW_PERCENT = 300;
    ...
    // Note: Booleans that are false by default don't need to be set, saves a little gas
    ...
    // TODO: Ensure that all the addresses and percentages are set

    // Payment addresses
    address constant internal DEV_ADDRESS = 0x31f8933601497fD6Ade6EaEaA6a66b281d238E70;
    address internal FOUNDER_ADDRESS = 0x0030aDf9Fc80824801972ebA845b64eB4c684a66;
    // TODO: Update this
    address constant internal ARTIST_ADDRESS = 0xa8771fD60920f165Fb4E4CFCA2Cb1ab055f9ED53;
    address constant internal COMMUNITY_ADDRESS = 0xc860d45244C056eCd165e00e1753B92314ec6E59;

    mapping(address => bool) public userMintedWL;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Naffle", "NAFFLE") { }
    ...
    */
    ...
    function teamMint(uint256 quantity) external payable mintCompliance(quantity) {
        require(msg.sender == FOUNDER_ADDRESS, "Team minting only");
    ...
    function allowListMint(uint256 quantity, bytes32[] memory proof) external payable mintCompliance(quantity) {
        require(allowListSale, "WL sale inactive");
        require(_verifyPublicAllowList(proof), "User not on WL");
    ...
    */
    ...
    // TODO: Don't forget to remove any methods for constant variables
    ...
    function setAllowListMax(uint256 _allowListMax) public onlyOwner {
        ...
        publicMintMax = MAX_SUPPLY - TEAM_MINT_MAX - _allowListMax;
    }    
    ...
    function setFounderWithdrawCut(uint256 _founderPercentage) public onlyOwner {
        FOUNDER_WITHDRAW_PERCENT = _founderPercentage;
    }
    ...
    function setFounderWalletAddress(address _founderWalletAddress) public onlyOwner {
        FOUNDER_ADDRESS = _founderWalletAddress;
    } 
    ...
    function withdraw() external payable onlyOwner {
        ...
        // TODO: Make sure these denominators are correct
        ...
        // Withdraw the ENTIRE remaining balance to the community wallet
        (succ, ) = payable(COMMUNITY_ADDRESS).call{
            value: address(this).balance
        }("");
        require(succ, "Community (remaining) transfer failed");
    }
