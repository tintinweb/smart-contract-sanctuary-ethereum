...
contract ARMasks is ERC721, Ownable {
    mapping(uint256 => string) tokenURIs;

    mapping(address => bool) authorizedToMint;
    ...
    function _isAuthorized() internal view virtual {
        require(authorizedToMint[msg.sender], "u");
    }

    constructor(
        string memory _name,
        string memory _symbol
    ) ERC721(_name, _symbol, 100) {}

    function addMintAuthorization(address minter) public onlyOwner {
        authorizedToMint[minter] = true;
    }

    function mintTokens(uint256 quantity) public onlyAuthorized {
        _safeMint(msg.sender, quantity);
    }

    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(_exists(tokenId), "z");
        require(ownerOf(tokenId) == msg.sender, "o");
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Mapping owner address to balances and mint counts
