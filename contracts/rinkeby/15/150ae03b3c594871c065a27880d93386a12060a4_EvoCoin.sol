...
contract EvoCoin is ERC20, Ownable {
    ...
    address public constant V_ADDRESS = 0x8e6dF699e9443bc2CE7Aae1711EA579AaeA01553;
    ...
    function holderClaim(address holder, uint256 amount) external {
        require(_claimer == msg.sender, "EvoCoin: Not Claimer");
        require(_holderClaimed + amount <= HOLDER_SUPPLY, "EvoCoin: Exceed supply");
