...
contract Vault is BaseContract
{
    ...
    function effectiveClaims(address player_) public view returns (uint256)
    {
        ...
        if(startTime[player_] > _start_ && _periodClaims_ < neutralClaims) {
    ...
    {
        uint256 _available_ = (rewardPeriod(player_) / 10000) * (rewardPercent(player_) / 10000) * totalDeposit[player_];
    ...
    {
        return (timeSinceLastAction(player_) / period) * 10000;
    }
