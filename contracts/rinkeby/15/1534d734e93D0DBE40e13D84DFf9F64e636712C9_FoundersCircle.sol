...
contract FoundersCircle is ERC1155, Ownable  {
    ...
    uint256 public price = 0.025 ether;  //TODO: set for 0.25
    bool public isPublicSaleActive;
    string metaData = "ipfs://QmfEusbVJSzi7SJJd6M6iCFnEX27mFX1aeFUbNBuLiUZWw"; 
    address private t1 = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; // bucks
    address private t2 = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8; // rune
    address private t3 = 0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65; // Greeny
    address private t4 = 0x90F79bf6EB2c4f870365E785982E1f101E93b906; // whatsherface
    address private t5 = 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC; // FCC
    ...
    */
    ...
    function withdraw() external onlyOwner { 
        uint256 _founderCut = address(this).balance /5 *4;
        uint256 _each = (address(this).balance - _founderCut)/ 4;
        require(payable(t1).send(_founderCut));
