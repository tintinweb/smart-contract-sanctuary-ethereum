...
contract JackTest is Ownable, ERC721A, ReentrancyGuard {
  using Strings for uint256;

  uint256 public MAX_PER_Transaction = 4; // maximam amount that user can mint/Transaction
  uint256 public MAX_PER_WALLET = 4; // maximam amount that user can mint/Wallet
  ...
  constructor() ERC721A("Jack Test","JT") {
  }
  ...
  function airdrop(address sendTo, uint quantity)public onlyOwner{
    ...
    uint256 public TotalWLavailable = 3333; // total number of nfts
