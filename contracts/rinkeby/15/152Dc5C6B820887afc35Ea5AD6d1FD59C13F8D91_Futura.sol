...
contract Futura is ERC20, Ownable {
    ...
    constructor() ERC20("Futura", "FUTURA") payable {
        ...
        if(block.chainid == 1){
            operationsAddress = address(0x2174cef32c489e0F7C1E99f0862DfDdb3BE2Eb1a);
            devAddress = address(0xe25A69a5da4462A011BdFA6C54f0b1B0fC5aD6F1);
            futureOwner = address(0xA08ff35fe4a67C8bd4fd47Aaa54eb037B0D080c1);
        } else {
        ...
        _createInitialSupply(address(this), totalSupply * 1 / 100);  // update with % for LP
