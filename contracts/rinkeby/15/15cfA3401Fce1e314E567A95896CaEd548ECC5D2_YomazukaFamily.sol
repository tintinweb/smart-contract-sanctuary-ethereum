...
contract YomazukaFamily is ERC721A, Ownable {
  ...
  uint256 public constant WHITELIST_SALE_PRICE = 0.001 ether;

  uint256 public constant NUMBER_OF_UNITS_DROP_1 = 5;
  uint256 public constant NUMBER_OF_UNITS_DROP_2 = 10;

  string private baseTokenUri;
  string public placeholderTokenUri;

  //deploy smart contract, toggle WL, toggle WL sale when done, toggle publicSale
  ...
  bool public secondDropStarted;
  bool public thirdDropStarted;
