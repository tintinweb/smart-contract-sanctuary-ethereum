...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    event RequestedRaffleWinner(uint indexed reqID);
    ...
    function performUpkeep(
        ...
        uint reqID = i_coordinator.requestRandomWords(
            i_gasLane,
            i_subscriptionID,
        ...
        override
    {
        ...
        address payable recentWinner = s_players[
            (indexOfWinner % s_players.length)
        ];
