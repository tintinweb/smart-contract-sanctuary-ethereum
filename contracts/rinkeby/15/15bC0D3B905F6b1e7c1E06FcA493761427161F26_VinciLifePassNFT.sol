...
contract VinciLifePassNFT is ERC721Royalty, Ownable {
    ...
    IERC721 ticketNFTContract;

    /**
     * @dev Event for the start of a sale
     * @param _nftContract Contract address of the NFT
     */
    event TicketNFTContractSet(
        IERC721 _nftContract
    );

    constructor(address receiver) ERC721("Vinci LifePass NFT", "VLPNFT") {
    ...
    function setTicketNFTContract(IERC721 _ticketNFTContract) public onlyOwner {
        ticketNFTContract = _ticketNFTContract;
    }
