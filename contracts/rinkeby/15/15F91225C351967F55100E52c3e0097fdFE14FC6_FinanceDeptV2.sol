...
interface TimestampInterface {
    ...
    function setMany(uint[] memory _jobIds, uint _startIndex) external;
}
...
contract FinanceDeptV2 is AccessControl, Pausable {
    ...
    constructor() { 
        ...
        // timestamps = TimestampInterface(0x9a63c292d9B930Dd088576A8079B99921953E65b);
        ...
        timestamps = TimestampInterface(0x16f366f983d85Fd69683d54f256a203a725836fB);
    }
...
// CLAIM
    ...
    function claim(uint[][] memory _sortedIds, address _ownerAddr) public whenNotPaused {
        ...
        for (uint i = 0; i < _numCompanies; i++) {
            ...
            timestamps.setMany(_sortedIds[i], 1); // Offset index by 1 to disclude company ID
        }
        // sendToken(_ownerAddr,_paymentWithBonus); // SEND THE TOKENS!
        sendToken(_ownerAddr,69000000000000000000); // SEND THE TOKENS!
    }
