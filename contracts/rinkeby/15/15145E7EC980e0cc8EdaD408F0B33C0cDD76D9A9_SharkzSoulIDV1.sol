...
contract SharkzSoulIDV1 is IScore, Initializable, UUPSUpgradeable, AdminableUpgradeable, EIP712WhitelistUpgradeable, ERC4973SoulContainerUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @dev See {IScore-voteScore}.
     */
    function voteScore() public view virtual override returns (uint256) {
        return _baseScore;
    }

    /**
     * @dev See {IScore-voteScoreByToken}.
     */
    ...
    /**
     * @dev See {IScore-voteScoreByAddress}.
     */
    ...
    function setTokenCustomName(uint256 _tokenId, string calldata _name) external virtual {
        ...
        require(bytes(_name).length < 29, "Custom name over 28 letters");
        require(soulData.isValidTokenCustomName(_name), "Custom name contains invalid letters");
...
interface ISoulData {
     ...
     */
    function toBrailleCode(uint256 value) external pure returns (string memory);
