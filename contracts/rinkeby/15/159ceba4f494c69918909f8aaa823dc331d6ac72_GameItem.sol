...
contract GameItem is ERC721URIStorage, Ownable {
    ...
    uint public constant maxPurchaseFree = 1;
    uint public constant maxNFTs = 8;
    uint256 public constant purchasePrice = 500000000000000; //0.005 ETH

    constructor() ERC721("griddy2", "gbattleships") {}
    ...
    function mintBattleships(uint numberOfTokens) public payable {
        if (_tokenIds.current() > 2) {
            ...
            require(numberOfTokens <= maxPurchaseFree, "Can only mint 5 tokens at a time during free mint");
        }
