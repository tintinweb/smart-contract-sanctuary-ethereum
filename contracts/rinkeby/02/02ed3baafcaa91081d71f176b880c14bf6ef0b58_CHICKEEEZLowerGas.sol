...
contract CHICKEEEZLowerGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CHICKEEEZ", "CHICKEEEZ") {
    setHiddenMetadataUri("ipfs://QmdyH6XsRW93saa5H2LiwoN9TedNejiJW1sRimT8RHPGHQ/hidden.json");
  }
