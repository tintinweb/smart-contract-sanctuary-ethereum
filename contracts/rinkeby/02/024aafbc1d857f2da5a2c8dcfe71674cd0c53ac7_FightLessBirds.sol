...
/*
 ...
 ______ _      _____ _____ _    _ _______ _      ______  _____ _____   ____ _____ _____  _____   _____ 
 |  ____| |    |_   _/ ____| |  | |__   __| |    |  ____|/ ____/ ____| |  _ \_   _|  __ \|  __ \ / ____|
 | |__  | |      | || |  __| |__| |  | |  | |    | |__  | (___| (___   | |_) || | | |__) | |  | | (___  
 |  __| | |      | || | |_ |  __  |  | |  | |    |  __|  \___ \\___ \  |  _ < | | |  _  /| |  | |\___ \ 
 | |    | |____ _| || |__| | |  | |  | |  | |____| |____ ____) |___) | | |_) || |_| | \ \| |__| |____) |
 |_|    |______|_____\_____|_|  |_|  |_|  |______|______|_____/_____/  |____/_____|_|  \_\_____/|_____/ 
...
contract FightLessBirds is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSeb1jYAhkLVxavxEdmAHeiW4iHQeVLo2a1RGHDJEMwRh";
    ...
    constructor(
    ) ERC721A("FlightLess Birds", "FlightLess", 100, maxSupply) {
    }
