...
contract WorldsOfTrains is ERC721A, Ownable {
    ...
    string private baseTokenURI = "ipfs://QmTcZoL7SWD74NGRKyQAAV35ahaGnYvhcLiAyqnwNKhzFe/";

    /// @dev Size of NFT Collection
    uint256 private constant TOTAL_SUPPLY = 11_111;
    ...
    function publicSaleMint(uint256 _quantity) external payable callerIsUser {
        ...
        if((maxPublicSupply - totalSupply()) == 0)
    ...
    /// @custom:owner Could be called only by Smart Contract Owner     
    function _setPublicSale(bool _state) internal onlyOwner {
        publicSale = _state;
    }     
