...
contract Sample is ERC721, Ownable {
    ...
    string private _baseTokenURI = "https://wcnft.mypinata.cloud/ipfs/QmQHSMW59XRSyvcYtvuhXBw2zbr8PbxK9mM5EQP8VvHcix/";

    constructor() ERC721("Sample", "SAM") {
        for(uint i=0; i<10; i++) {
            mint(0xdb691003c88E7b1BEE5BdcaF296e2140DF6ccee2);
        }
    }
