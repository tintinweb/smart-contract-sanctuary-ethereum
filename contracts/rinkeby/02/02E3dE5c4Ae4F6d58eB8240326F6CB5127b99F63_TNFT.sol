...
contract TNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    function mintNFTone() public payable {
        uint256 supply = totalSupply();
        _safeMint( msg.sender, supply);               
    }

    function mintNFTwithBool(uint256 num, bool flag) public payable {
        uint256 supply = totalSupply();
        for(uint256 i = 0; i < num; i++){
            _safeMint( msg.sender, supply + i );
        }
    ...
    function mintNFTwithBool2(bool flag, uint256 num, address addr) public payable {
        uint256 supply = totalSupply();
        for(uint256 i = 0; i < num; i++){
            _safeMint( msg.sender, supply + i );
        }               
