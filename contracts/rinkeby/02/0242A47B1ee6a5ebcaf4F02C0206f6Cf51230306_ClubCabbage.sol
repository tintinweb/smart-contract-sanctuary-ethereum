...
// File: contracts/ClubCabbage_LowGas.sol
...
contract ClubCabbage is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Club Cabbage", "CABB") {
    setHiddenMetadataUri("ipfs://QmXLsspE2vqW22pkJreAovYBrfeUM2qNJPEPpvdGTaWuAp/hidden.json");
  }
