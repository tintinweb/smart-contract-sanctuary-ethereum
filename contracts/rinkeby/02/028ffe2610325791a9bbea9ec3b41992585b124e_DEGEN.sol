...
contract DEGEN is ERC721, Ownable {
    ...
    uint256 constant public maxTokens = 5555;
    ...
    constructor() ERC721("Dgen Tokens", "DGEN") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmS1MWCREdtCLGFfFUkqhBLqEb9XSFHrGoHTkVpjQUq9Kk/";
    }

    function dgenMint(uint256 qty) public payable activeSale isNotContract {
        uint256 currentTokens = tokens.current();

        require(currentTokens <= maxTokens, "Total Supply has been reached");
        require(qty > 0 && qty <= maxPerTxn, "Not a valid quantity of passes");
        require(currentTokens.add(qty) <= maxTokens, "You would exceed Total Supply");
