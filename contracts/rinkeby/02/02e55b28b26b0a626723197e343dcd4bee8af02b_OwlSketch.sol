...
contract OwlSketch is Ownable, ERC721 {
  ...
  function togglePublicSaleActive() external onlyOwner {
    ...
    require(this.balanceOf(msg.sender) + numberOfTokens <= 2, "Per wallet limit reached! Per wallet limit is 2 tokens.");
