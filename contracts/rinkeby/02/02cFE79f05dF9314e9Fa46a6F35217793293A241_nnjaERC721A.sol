...
contract nnjaERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    // Address to be change prior deployment, and double check that address are correct
    ...
    */
    ...
    /**
    * @notice Mint function for Whitelist Sale - Free Mint, no payable no price define here
    *
    ...
    * @param _proof The Merkle Proof
    ...
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external callerIsUser {
        ...
        require(amountNFTperWalletWhitelistSale[msg.sender] + _quantity <= maxPerAddressDuringWhitelistMint, "You can only get 2 NFTs on this sale");
    ...
    * @param _quantity Amount of NFT user want to mint
    ...
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "contract is paused");
        require(currentTime() >= saleStartTime + 8 hours, "Public sale has not started yet");
        require(currentTime() < saleStartTime + 16 hours, "Public sale is finished" );
        uint price = publicSalePrice;
        require(price != 0, "Price is 0");
        require(sellingStep == Step.PublicSale, "Public sale is not activated");
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "You can only get 4 NFTs on this sale");
    ...
    * 
    * @param _publicSalePrice The new price of a NFT during Public Sale
     */
    ...
    /**
    * @notice changing the starting time (timestamp) of Whitelist Sale
    * 
    ...
    * @return bytes32 the hashed address  
    ...
    /**
    * @notice returns true if a leaf can be proved to be a part of a merkle tree define by root
    *
    * @param _leaf the leaf
    * @param _proof the merkle proof
    *
    * @return True if a leaf can be proved to be a part of a merkle tree define by root
     */
    ...
    /**
    * @notice check if an address if Whitelisted or not
    *
    * @param _account the account checked
    * @param _proof the merkle proof
    *
    * @return bool return true if address is Whitelisted, false otherwise obviously
     */
