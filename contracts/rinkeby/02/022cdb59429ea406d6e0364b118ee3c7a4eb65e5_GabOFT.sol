...
// File contracts/examples/GabOFT.sol
...
contract GabOFT is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable,ERC20PermitUpgradeable,ERC20VotesCompUpgradeable, OFT {
   // constructor(address _layerZeroEndpoint) OFT("GAB", "GAB", _layerZeroEndpoint) {}
    ...
    function initialize(        
      ...
      OFTInit("GAB", "GAB", _layerZeroEndpoint);
      __Ownable_init();
         __ERC20Permit_init("gab");
