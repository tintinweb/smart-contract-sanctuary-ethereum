...
contract TlStablecoinV010 is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function isRedemptionAddress(address account) internal pure returns (bool) {
        return uint256(uint160(account)) < REDEMPTION_ADDRESS_COUNT && uint256(uint160(account)) != 0;
    }
