...
contract lessbots is Ownable, PaymentSplitter, ERC721A, ReentrancyGuard {
    ...
    function publicSaleMint(
        ...
        // good luck, bot
        require(
            MerkleProof.verify(_merkleProof, _suppliedRoot, addressLeaf),
            "Invalid MerkleProof"
        );
        require(
            MerkleProof.verify(_merkleProof, _suppliedRoot, passLeaf),
            "Invalid MerkleProof 2"
        );
        require(
            MerkleProof.verify(_passProof, publicRoot, passLeaf),
            "Invalid MerkleProof 3"
        );
