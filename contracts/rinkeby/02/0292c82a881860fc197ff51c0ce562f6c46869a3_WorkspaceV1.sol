...
contract WorkspaceV1 is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable, WorkspaceStorageV1{
    ...
    function checkIn(uint256 _spaceID) external returns(bool){
        ...
        require(users[msg.sender].spaceID == 0);
       // require(users[msg.sender].hold == false,"Plz cancel your hold");
        ...
        users[msg.sender].depositToken = (space.hourlyRate)*8;//change name of depositToken
    ...
    function checkOut(uint256 _spaceID) external returns(bool){
        ...
        //transfer token in wei format
        transferFrom(space.owner, msg.sender, returnValue);
