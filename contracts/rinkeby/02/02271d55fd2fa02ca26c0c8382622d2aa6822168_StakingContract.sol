...
contract StakingContract {
    ...
    event createBattle(address indexed battleCreator, uint256 stakeAmount, uint256 indexed battleId, address refaralPerson);
    event joinBattle(address indexed battlejoiner, uint256 stakeAmount, uint256 indexed battleId, address refaralPerson);
    ...
    function CreateBattle(uint256 _amount, uint256 _riskPercentage, address referalPerson) external {
        ...
        emit createBattle(msg.sender,stakeAmount,battleId, referalPerson);
    ...
    function JoinBattle(uint256 _amount, uint256 _battleId, address referalPerson) public {
        ...
        emit joinBattle(msg.sender,stakeAmount,battleId, referalPerson);
    }
