...
contract FarmHorses is ERC721A, Ownable, ReentrancyGuard {
  ...
  address constant public whitelist = address(0x6F1C0fED91621d3d3b79915d363d2E653208Fa84); // whitelist
  ...
  function whitelistMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    bool _iswhitelist =  ZCoreWhitelist(whitelist).isUserWhiteListed(_msgSender());
