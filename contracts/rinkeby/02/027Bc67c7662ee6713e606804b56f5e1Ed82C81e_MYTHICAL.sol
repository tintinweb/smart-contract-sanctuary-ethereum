...
contract MYTHICAL is ERC721LPhantomStakeable {
    ...
    string private _baseURI = "ipfs://QmSb7QuSQwd1tD1hpmNd5svWNaoScyCH5S5JAD9dWKSoij/";
  ...
  function publicMint(uint256 _quantityGenesis, uint256 _quantityInhibitor) public callerIsUser {
    unchecked {
  ...
  function mintTeamAllocation() external onlyOwner callerIsUser {
      ...
      INHIB.mintHelper(_msgSender(), 50);
      _mint(_msgSender(), 50);
