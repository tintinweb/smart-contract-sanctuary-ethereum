...
interface IERC721A {
  ...
  function locktoken(uint256 tokenid) external returns (bool);
  function Unlocktoken(uint256 tokenid) external returns (bool);
...
// File contracts/interfaces/ERC721A.sol
...
contract ERC721A is IERC721A {
  ...
  function locktoken(uint256 tokenid) external virtual override returns (bool) {
    lock[tokenid] = true;
    return lock[tokenid];
  }
...
// File contracts/interfaces/ERC721ABurnable.sol
...
// File contracts/interfaces/ERC721AQueryable.sol
...
// File contracts/mocks/ERC721A.sol
...
contract NFTBetting is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable {
  ...
  function createToken(address tokenAddress)
    public
    payable
    returns (uint256 _tokenId)
  {
    if (IERC721A(tokenAddress).balanceOf(address(this)) == 0) {
