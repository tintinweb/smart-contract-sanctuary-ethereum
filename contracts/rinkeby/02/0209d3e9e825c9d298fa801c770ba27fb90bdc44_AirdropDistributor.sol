...
contract AirdropDistributor {
    ...
    event NameUpdated(address indexed account, string indexed newName);
    event BaseInfoURIUpdated(address indexed account, string indexed newBaseInfoURI);
    ...
    function updateName (string calldata _name) public {
        ...
        name = _name;
        emit NameUpdated(owner, _name);

    }

   function updateBaseInfoURI (string calldata _baseInfoURI) public {
        require(owner == msg.sender, "Caller is not the owner");
        require(isActive, "Campaign is stopped");
        baseInfoURI = _baseInfoURI;
    ...
    function claim(
        ...
        require(!claimed[msg.sender], "Account has claimed");
