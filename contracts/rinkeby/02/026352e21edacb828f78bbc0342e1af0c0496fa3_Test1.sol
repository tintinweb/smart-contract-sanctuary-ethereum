...
contract Test1 is Ownable, ERC721A {
    ...
    uint256 public constant FREE_MINT_SUPPLY = 2;
    uint256 public constant MAX_MINT_PER_TRANSACTION = 10; 
    uint256 public constant MAX_FREEMINT_PER_USER = 1; 
  ...
  function burnToken (uint256 tokenId) payable public {
    require(_exists(tokenId),"ERC721Metadata: Burn query for nonexistent token");
