...
contract Lottery is VRFConsumerBaseV2, Ownable {
    ...
    constructor(address _priceFeedAddress, address vrfCoordinator, uint64 _s_subscriptionId) VRFConsumerBaseV2(vrfCoordinator) {
        usdEntryFee = 50;
    ...
    function fulfillRandomWords(
        ...
        lottery_state = LOTTERY_STATE.CLOSED;
        recentRandomNumber = randomWords[0];
    }
