...
contract Sample_Collection_Test_1 is IERC721, Ownable, Functional {
     ...
     */
    constructor() payable {
        _name = "Sample Collection Test 1";
        _symbol = "SCT1";
        _baseURI = "https://nftpandemic.io/metadata/";
        _extension = ".json";
        logo = "https://nftpandemic.io/imagedata/1.png";
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Sample_Collection_Test_1.onERC721Received.selector;
    }
