...
contract CollectionManager {
    ...
    // Event
    event CreateCollection(string name, string symbol,  uint256 royalty, address[]  collaborators, NFTCollection new_contract);
    ...
    function creatcollection(
        ...
        emit CreateCollection(_collectionname, _collectionsymbol,  _royalty, _collaborators, newcollection);
