...
contract Calculator is ERC721Enumerable, ERC2981, Ownable {
    ...
    function mint(uint[] memory schemeIndexes) public payable { //takes an array of numbers from 0-4
                ...
                Base64.encode(
                    bytes(
                          abi.encodePacked(
                              ...
                              Strings.toString(id),
                              '", "description":',
                              '"Fully working, completely on chain calculator."',
                              ',"directions":',
                              '"To enjoy, simply copy the image url and paste it in a web browser. Or, visit our [Official Website](',
                              frontEnd,
                              ")",
                              '", "external_url":"',
                              frontEnd,
