...
contract MosiMosiMosi is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Mosi Mosi Mosi", "MMM") {
    setHiddenMetadataUri("ipfs://QmesW2Vrw9JtcKDmk43xMNp8nsL8KgbNRskQUF8xAAxrc4/hidden.json");
  }
