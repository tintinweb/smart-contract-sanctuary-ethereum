...
contract MetaHookahs is ERC721A, Ownable {
    ...
    uint256 public nftPerAddressLimitWL = 8;
    ...
    constructor() ERC721A("Meta Hookahs", "MH") {}
    ...
    function allowedMintNumber(address _user) public view returns (uint256) {
        uint256 mintedBalance = addressMintedBalance[_user];
        return nftPerAddressLimitWL - mintedBalance;
    }
