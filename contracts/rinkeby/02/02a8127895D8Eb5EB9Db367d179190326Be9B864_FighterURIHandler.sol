    ...
    ERC721HolderUpgradeable
{
    ...
    function initialize(
        ...
        _enhancementCosts[0] = 25 * 10**18;
        _enhancementCosts[1] = 35 * 10**18;
        _enhancementCosts[2] = 50 * 10**18;
        _enhancementCosts[3] = 75 * 10**18;
        _enhancementCosts[4] = 100 * 10**18;
        _enhancementCosts[5] = 125 * 10**18;
        _enhancementCosts[6] = 150 * 10**18;
        _enhancementCosts[7] = 200 * 10**18;
        _enhancementCosts[8] = 250 * 10**18;
        _enhancementCosts[9] = 300 * 10**18;
        _enhancementCosts[10] = 300 * 10**18;
        _enhancementCosts[11] = 300 * 10**18;
        _enhancementCosts[12] = 300 * 10**18;
        _enhancementCosts[13] = 300 * 10**18;

        // Initialize enhancement odds
        _enhancementOdds[0] = 9000;
        _enhancementOdds[1] = 8500;
        _enhancementOdds[2] = 8000;
        _enhancementOdds[3] = 7500;
        _enhancementOdds[4] = 7000;
        _enhancementOdds[5] = 6500;
        _enhancementOdds[6] = 6000;
        _enhancementOdds[7] = 5500;
        _enhancementOdds[8] = 5000;
        _enhancementOdds[9] = 2500;
        _enhancementOdds[10] = 2500;
        _enhancementOdds[11] = 2500;
        _enhancementOdds[12] = 2500;
        _enhancementOdds[13] = 2500;

        // Initialize enhancement odds
        _enhancementDegredationOdds[0] = 0;
        _enhancementDegredationOdds[1] = 500;
        _enhancementDegredationOdds[2] = 1000;
        _enhancementDegredationOdds[3] = 1500;
        _enhancementDegredationOdds[4] = 2000;
        _enhancementDegredationOdds[5] = 2500;
        _enhancementDegredationOdds[6] = 3000;
        _enhancementDegredationOdds[7] = 3500;
        _enhancementDegredationOdds[8] = 4000;
        _enhancementDegredationOdds[9] = 5000;
    ...
    function reveal(uint256[] calldata tokenIds) public override whenNotPaused {
        unchecked {
            for (uint256 i = 0; i < tokenIds.length; i++) {
                ...
                require(
                    _checkOnEnhancement(tokenIds[i], enhancement),
    ...
    function upgrade() external onlyRole(DEFAULT_ADMIN_ROLE) {
        // Initialize enhancement costs
        _enhancementCosts[0] = 25 * 10**18;
        _enhancementCosts[1] = 35 * 10**18;
        _enhancementCosts[2] = 50 * 10**18;
...
interface IEnhancer {
    function onEnhancement(uint256, uint8) external returns (bytes4);
}
...
abstract contract Enhanceable is IEnhanceable, Initializable, Seedable {
    ...
    function _checkOnEnhancement(uint256 tokenId, uint8 prev)
        internal
        returns (bool)
    {
        address owner = _token.ownerOf(tokenId);
        if (owner.isContract()) {
            try IEnhancer(owner).onEnhancement(tokenId, prev) returns (
                bytes4 retval
            ) {
