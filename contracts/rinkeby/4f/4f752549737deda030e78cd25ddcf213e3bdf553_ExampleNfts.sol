// SPDX-License-Identifier: MIT
    ...
    contract ExampleNfts is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 20000000000000000; // 0.0020 ETH 
      ...
      event ExampleMinted(uint256 tokenId, address owner);
      ...
      function mintExample(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit ExampleMinted(id, msg.sender);
          }
        }
      }
    
      function presaleExample(uint256 numberOfTokens) external payable {
