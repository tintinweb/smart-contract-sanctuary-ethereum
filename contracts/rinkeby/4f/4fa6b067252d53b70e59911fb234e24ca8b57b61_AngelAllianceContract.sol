...
// File: AngelAllianceContract_flat.sol
...
contract AngelAllianceContract is ERC721, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        (bool sTwo, ) = payable(0xB5a2F56Ed0b188ae7779b3d110d59631F97b1443)
            .call{value: (balance * 33) / 100}("");
        require(sTwo);

        (bool sThree, ) = payable(0x2d34C569B5F0E62a0984A770bCcf283907BC7853)
        ...
        (bool sFive, ) = payable(0x9bB0c2B17d1C3f74Deff8cCB8CE74582fF3DDE70)
            .call{value: (balance * 8) / 100}("");
        require(sFive);

        (bool sSix, ) = payable(0xe84476Eca219104F485419E9114F5eb1A4279486)
