...
contract OnChainNFT is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public MAX_PER_Address = 10000; // maximam amount that user can mint

  uint256 public  PRICE = 0.70 ether;
  ...
  constructor() ERC721A("OnChain","OnChain NFT") {
    ...
    _baseTokenURI= "https://bafybeiggoxf4ndoyhvkiwderbdcrycrezecai6j7zpcdnj5ldhjocyrule.ipfs.nftstorage.link/";
}
