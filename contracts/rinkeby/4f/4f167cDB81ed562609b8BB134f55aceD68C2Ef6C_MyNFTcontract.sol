...
//MyNFTcontract 
contract MyNFTcontract is ERC721Enumerable, Ownable { //参数0
    ...
    uint256 public unitPrice = 8 * 10**16; // .08 eth   参数1
    uint256 public unitPrice_Presale = 3 * 10**16; //.03 eth 参数2
    uint256 public constant MAX_ELEMENTS = 8888; // 参数3
    
    uint256 public constant MAX_PER_MINT = 10; // 参数4
    uint256 public constant MAX_BY_MINT_WHITELIST = 3; //参数5
    uint256 public constant MAX_RESERVE_AMOUNT = 500; //参数6
    ...
    uint256 private _maxNumPerReserve = 100; //参数7
    ...
    constructor(string memory NFTbaseURI, string memory NFTnotRevealedURI) ERC721("MyNFTcontract", "MNFT") {
        setBaseURI(NFTbaseURI);
        setNotRevealedURI(NFTnotRevealedURI);
    }
