...
contract PagziCandir is ERC721Enumerable, Ownable, ReentrancyGuard {
    //MERKLEFEATURE
    ...
    constructor() ERC721("Pagzi Candir", "PGZCN") {
        baseURI = "https://tsc.metadata.test/meta/";
    }
