...
//--------------------- Set & Change anythings
    ...
    */
    function setWhitelistUser(address _walletAddress) external onlyOwner {
        whitelisted[_walletAddress].walletAddress = _walletAddress;
        whitelisted[_walletAddress].mintAmount = wlMintAmount;
