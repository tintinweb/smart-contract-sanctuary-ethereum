...
contract METANFT_v2 is Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    function testUpdate() public pure returns (string memory) {
        return "I am METANFT_v2";
    }
}