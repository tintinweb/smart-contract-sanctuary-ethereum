...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        Ownable
    {
        ...
        uint256 public SUPPLYCAP = 2500;
        uint256 public PRICE = 0.05 ether;
        uint256 public MAX_MINT_PER_TX = 2;
        address[] public payableAddresses = [RAMPPADDRESS];
        uint256[] public payableFees = [5];
        uint256 public payableAddressCount = 2;
        
        bool public isRevealed = false;
        string private IPFSTokenURI = "ipfs://QmNYUzrNPkxdiTUfGJGLPAW5Hs36fneaDZPRHGmApE7qwA/";
        ...
        constructor(
            ...
            payableAddresses.push(0x78289828e64d43dACC84Dda3A746cb36C6A8b9fd);
            payableFees.push(uint256(95));
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 2500");
      ...
      require(mintingOpen == true, "Minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 2500");
    ...
    // File: contracts/interstellarApeClubContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract InterstellarApeClubContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Interstellar Ape Club", "IAC", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/Q4v3de2cSQTUnR2rsAMh/contract-metadata";
        }
    }