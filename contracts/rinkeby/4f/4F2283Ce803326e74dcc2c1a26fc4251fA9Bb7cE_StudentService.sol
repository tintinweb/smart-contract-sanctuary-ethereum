...
contract StudentService {
    ...
    function loadData() private {
        ...
        Exam memory exam0 = Exam(0, course0, 1664335534, true);
        Exam memory exam1 = Exam(1, course1, 1664335534, true);
        Exam memory exam2 = Exam(2, course2, 1664335534, true);
        exams.push(exam0);
        exams.push(exam1);
        exams.push(exam2);
        studentExamResults[0xA5A5A6c6C867e8BFd6cF8fcF472D70bC53eCb7a4].push(
            ExamResult(0xA5A5A6c6C867e8BFd6cF8fcF472D70bC53eCb7a4, exams[1], 7)
        );
        ...
        examHistoryExists(_index, msg.sender)
    {
        studentExamResults[msg.sender].push(
            ExamResult(msg.sender, exams[_index], 0)
        );
