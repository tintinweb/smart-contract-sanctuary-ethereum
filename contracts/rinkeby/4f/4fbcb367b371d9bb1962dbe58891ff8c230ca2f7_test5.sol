...
contract test5 is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
        ...
        ERC721 (name, symbol)
    {
        ...
        _genesisContract = IERC721(genesisContractAddress);
        _wallet = wallet;
    ...
    function OGmint(uint[] calldata genesisTokenIds) public payable {
        ...
        require(msg.value == price * numNewNft, "Amount sent is incorrect");
        ...
        for (uint i=0; i < numNewNft; ++i) {
            ...
            require(
                ...
                "Caller is not owner of that NFT"
            );
            require(
                hasNewNft[genesisTokenId] == false,
                "This Gimp has already minted a new NFT"
            );
    ...
    function publicMint() public payable {
        ...
        require(tokenIdTracker.current() <= max_supply, "All tokens have been minted");
        require(msg.value == publicPrice, "Amount sent is incorrect");
