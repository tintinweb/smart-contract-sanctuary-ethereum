...
contract test is ERC721A, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 amt) external payable {
        ...
        require(mintEnabled, "Minting is not live yet, hold on test.");
    ...
    function WLMint(bytes32[] calldata _merkleProof, uint256 amt)
        ...
        payable
    {
        require(wlEnabled, "test mint is disabled.");
        require(
            totalSupply() + amt < totalFreeForWL + 1,
            "No more tests for WL"
        );
    ...
    function setmaxPerTxWL(uint256 maxPerTxWL_) external onlyOwner {
        maxPerTxWL = maxPerTxWL_;
    }
