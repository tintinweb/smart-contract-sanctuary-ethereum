...
// ERC721A Contracts v4.0.0
    ...
    contract aimoonrunner is Ownable, ERC721A {
    uint256 public maxSupply                    = 10000;
    uint256 public maxFreeSupply                = 10000;
    uint256 public maxPerTxDuringMint           = 20;
    uint256 public maxPerAddressDuringMint      = 22;
    uint256 public maxPerAddressDuringFreeMint  = 2;
    uint256 public price                        = 0.003 ether;
    bool    public saleIsActive                 = true;
    bool    public revealed                     = false;

    address constant internal TEAM_ADDRESS = 0x2DdbD34F22e24675B4eA5C10B10BD30F179C8423;
    string public baseURI = "";
    string public constant baseExtension = "";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("aimoonrunner", "AIMOONR") {_safeMint(msg.sender, 1); setHiddenMetadataUri("ipfs://QmUWE9pNAGWNSktpECwpZW5xkNTeWy9uwDPHcEf5jZFy8e");}
