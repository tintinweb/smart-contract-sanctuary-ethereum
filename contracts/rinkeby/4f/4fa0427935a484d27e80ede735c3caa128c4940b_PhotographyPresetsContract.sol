...
// File: contracts/PhotographyPresetsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract PhotographyPresetsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Photography Presets";
    string public symbol = "Presets";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/bM1mz5T8SYH9PARkPwVo/contract-metadata";
    }
