...
//
//     ____                                       
//    / __ \____ _____ ___  ____  ____  ___  _____
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://api/coktne/";
...
// File: contracts/RampperContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RampperContract is RamppERC721A {
    constructor() RamppERC721A("Rampper", "RAMPPR"){}

    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/yZNCjTV9nfpoe4BHaGLB/contract-metadata";
    }
}
