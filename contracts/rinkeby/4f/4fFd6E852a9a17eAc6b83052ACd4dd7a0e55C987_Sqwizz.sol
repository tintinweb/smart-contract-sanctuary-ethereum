...
contract Sqwizz is ERC721ABurnable, ReentrancyGuard, Ownable {
    ...
    uint256 public constant MAX_NEONLIST_MINT = 2;
    ...
    mapping(address => uint256) public totalNeonlistMint;
    ...
    modifier neonlistEligible(
        ...
        if (_msgSender() != owner()) {
            ...
            require(
                ownerTokenCount + _mintAmount <= MAX_NEONLIST_MINT,
                "User is over NeonList mint limit"
            );
        }
        _;
    }
    ...
    {
        totalNeonlistMint[_msgSender()] += _mintAmount;
