...
contract GreatGoat is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmW6vgNaE5qQ2kqjfi4rBhLWbnPJtceEXxC2bH5hjR77Eq/";
    uint   public price             = 0.005 ether;
    uint   public maxPerTx          = 10;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 5555;
    uint   public maxSupply         = 5555;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Uncle Ghost", "UG"){}
