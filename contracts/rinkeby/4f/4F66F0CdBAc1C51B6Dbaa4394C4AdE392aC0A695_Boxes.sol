...
contract Boxes is Ownable, VRFConsumerBaseV2 {
    ...
    struct Contest {
        ...
        bool rewardsCanBeClaimed; // boxesAssignedScores prevents people from claiming boxes, this prevents people from claiming rewards
    ...
    constructor(
        ...
        treasury = treasury_;
        // operating wallet
        operationsWallet = operatingWallet_;
    }
