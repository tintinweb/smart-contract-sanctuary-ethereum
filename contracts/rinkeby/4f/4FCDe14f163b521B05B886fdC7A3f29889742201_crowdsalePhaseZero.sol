...
contract crowdsalePhaseZero is IERC20Upgradeable, globals, ReentrancyGuardUpgradeable { // ContextUpgradeable, 
    ...
    function initialize() initializer public {      
        ...
        setPhase(1);
        _rate = 5; //1;
        _walletAddress = payable(address(0xfc89331182fb57c5a5d64D404B6E74c07005F202));
        _wallet = address(0xfc89331182fb57c5a5d64D404B6E74c07005F202);
        _token = IERC20Upgradeable(address(0x6af8786B1C879Cc5949c3b42566b063AdB8a0feC));//IERC20(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512);
    ...
    function sWalletAddr(address wallet) external onlyRole(globals.ADMIN_ROLE)
    {
        _walletAddress = payable(wallet);
    }

    function sWalletPay(address wallet) external onlyRole(globals.ADMIN_ROLE)
    {
        _wallet = wallet;
    }
    ...
    /*function wallet() public view returns (IERC20Upgradeable) {
        return _wallet;
    }*/
    ...
    function transferForFounderFundProposal(address sender,
        address recipients,
        uint256 amounts
    ) external override returns (bool) {
        return _token.transferForFounderFundProposal(sender, recipients, amounts);
    }
    ...
    function transferForCrowdSale(
        ...
        return _token.transferForCrowdSale(sender, recipient, amount);
    }
