...
contract Goodfellas is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    //     require(isCommunitySaleActive, "Community sale off");
    // }
    ...
    // Check to see if we have GAC to gift
    ...
    //     canGiftGACs(1)
    // {
    //     require(!claimed[msg.sender], "Ape already claimed");
