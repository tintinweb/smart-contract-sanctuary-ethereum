...
contract Pizzas is ERC20, Ownable {
    ...
    address public signerAddress; // Root key
    ...
    function withdraw(
        ...
        require(totalSupply() + toWithdraw <= MAX_SUPPLY, "Max supply reached");
        usedNonces[nonce] = true;
        bytes32 inputHash = keccak256(
            abi.encodePacked(msg.sender, toWithdraw, nonce)
        );
        ...
        userStats.tokensWithdrawn += toWithdraw;
