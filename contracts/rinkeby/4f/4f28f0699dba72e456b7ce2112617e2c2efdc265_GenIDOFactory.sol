...
contract GenIDOFactory is UpgradeableBeacon{
    ...
    function createGenIdo(
        ...
        BeaconProxy bp= new BeaconProxy(address(this),abi.encodeWithSelector(GenIDO(address(0)).initialize1.selector,_underlyingToken,_totalTokenAllocation,_maxTokenAllocPerUserPerTier,_usdt,_numApplicantsPerTier,_trancheWeightage,_trancheLength,_maxTokenAllocationPermitted,_guranteedSaleDuration,_tokenPerUsd));
