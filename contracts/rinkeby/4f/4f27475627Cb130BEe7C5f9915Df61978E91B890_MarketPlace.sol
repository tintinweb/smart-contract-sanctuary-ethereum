...
contract MarketPlace is Ownable, Pausable, ReentrancyGuard {
    ...
    function _fillBuyOrder(BuyOrder memory buyOrder, bytes memory signature) internal {
        /////////////////
        ///  Finalize ///
        /////////////////
    ...
    function _transferNFT(
        ...
        if (contractAddress.supportsInterface(InterfaceId_ERC721)) {
            ...
            require(!cancellationRegistry.isOrderCancelled(signature),"This order has been cancelled");
