...
contract NFTTEST is ERC721, ERC721Enumerable, Ownable, Pausable, ERC721Burnable {
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused {
        ...
        blacklistedAddresses.push(msg.sender);
    ...
    function checkBlackListedAddress(address _address) public view returns (bool) {
    ...
    function transferFrom(
        ...
        //solhint-disable-next-line max-line-length
        require(_isApprovedOrOwner(_msgSender(), tokenId), "ERC721: transfer caller is not owner nor approved");
        require(!checkBlackListedAddress(from), "Address is not allowed to transfer NFT");
        _transfer(from, to, tokenId);
    }
