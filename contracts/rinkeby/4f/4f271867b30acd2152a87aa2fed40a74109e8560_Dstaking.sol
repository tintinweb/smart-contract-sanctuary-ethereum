...
// File: interfaces/IDivineCreatures.sol
...
contract Dstaking is ReentrancyGuard {
...
//        uint256 balance = divineCreature.balanceOf(msg.sender);

//

//        require(balance > 0, "User has nothing to stake");
...
//            console.log('divineCreature.balanceOf(msg.sender)', divineCreature.balanceOf(msg.sender));

//            uint256 index = divineCreature.tokenOfOwnerByIndex(msg.sender,i);

//            console.log('index', index);

//

//            _stake(msg.sender, index);
...
//    }
    ...
    */
    ...
    function unstake(uint256 _tokenId) external nonReentrant {
        ...
        require(
            ...
            "Sender is not the owner of nft with tokenID"
    ...
    */
    ...
    /// @notice Returns current pending rewards
    ...
    */
    ...
    function _stake(address _user, uint256 _tokenId) internal {
        ...
        divineCreature.safeTransferFrom(msg.sender, address(this), _tokenId);
    ...
    */
    ...
    function _claim(address _user) internal {
        ...
        skulls.mintTo(msg.sender, payableAmount);
        ...
        emit RewardPaid(msg.sender, payableAmount);
