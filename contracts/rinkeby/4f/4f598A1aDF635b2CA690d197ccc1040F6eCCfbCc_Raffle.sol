 ...
 *  @notice This contracts implements a secure, decentralized raffle lottery
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        // require(msg.value >= i_entraceFee, "You must pay the entrace fee.");
    ...
    /**
     * @dev This function is called by the Chainlink Keeper nodes to determine
     * whether upkeep is needed via `upkeepNeeded`.
     * To return true:
     * 1. Specified time interval must have elapsed
     * 2. Lottery must have at least 1 entrant and be funded
     * 3. Chainlink Keeper must be funded with LINK
    ...
    function performUpkeep(
        ...
        // Get random words from VRF coordinator
    ...
    function getNumWords() public pure returns (uint256) {
        // Can be pure function since NUM_WORDS is constant
        return NUM_WORDS;
    }
