...
contract VividAlpha is ERC721A, Ownable, PaymentSplitter {
    bool public saleActive = false;

    uint256 public price         = 0 ether;
    uint256 public maxSupply     = 200;
    uint256 public maxMintsPerTx = 10;
    uint256 public maxMintsTotal = 10;
    ...
    ) ERC721A("Vivid Alpha", "VALPHA") PaymentSplitter(team, teamShares) {
        _baseTokenURI    = baseTokenURI;
        _teamLength      = team.length;
    }
    ...
    function whitelists() public view onlyOwner returns (Whitelist[] memory) {
        return _whitelists;
    }

    function whitelistMintsOf(uint256 whitelistIndex, address minterAddress) public view onlyOwner returns (uint256) {
