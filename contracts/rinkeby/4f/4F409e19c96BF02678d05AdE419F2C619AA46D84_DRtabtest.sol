...
contract DRtabtest is ERC721, Ownable {
    ...
    string public preRevealURL = "ipfs://";
    mapping(address => uint) private _mintedCount;
    

    constructor() ERC721("DRtabtest", "TST123"){}
    ...
    function mint(uint count) external payable {
        ...
        require(msg.value >= calcTotal(count, MINT_PRICE), "ZeroCodeNFT: Ether value sent is not sufficient");
