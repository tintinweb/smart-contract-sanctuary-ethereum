...
contract EnchantedValley is ERC721, Ownable {
    ...
    */
    function fixRoyaltiesParams(address newRoyaltiesReceiver, uint256 newRoyaltiesPercentage)
        external
        onlyOwner
    {
    ...
    */
    function withdrawEther() external onlyOwner {
        ...
        require(gnosis_vault != address(0) && balance > 0, "Can't withdraw on black hole.");
