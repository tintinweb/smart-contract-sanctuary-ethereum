  ...
  function animationURI(uint256 tokenId) public view returns (bytes memory) {
    ...
    return
      abi.encodePacked(
        ...
        Base64.encode(
          abi.encodePacked(
            '<html><head><style>body,html{margin:0;display:flex;justify-content:center;align-items:center;background:', UtilAssets.getAssetBackground(UtilTraits.getOptionBackground(dna)), ';overflow:hidden}.a{width:min(100vw,100vh);height:min(100vw,100vh);position:relative}.b{width:100%;height:100%;background:100%/100%;image-rendering:pixelated;position:absolute}.h{animation:1s ease-in-out infinite d}@keyframes d{0%,100%{transform:translate3d(-1%,0,0)}25%,75%{transform:translate3d(0,2%,0)}50%{transform:translate3d(1%,0,0)}}</style></head><body>',
              '<div class="a">',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.BELLY, UtilAssets.getAssetBelly(UtilTraits.getOptionSpecies(dna), UtilTraits.getOptionBelly(dna))), ')"></div>',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.ARMS, UtilAssets.getAssetArms(UtilTraits.getOptionSpecies(dna))), ')"></div>',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.FEET, UtilAssets.getAssetFeet(UtilTraits.getOptionSpecies(dna))), ')"></div>',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.FOOTWEAR, UtilAssets.getAssetFootwear(UtilTraits.getOptionFootwear(dna))), ')"></div>',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.CLOTHING, UtilAssets.getAssetClothing(UtilTraits.getOptionClothing(dna))), ')"></div>',
                '<div class="b h">',
                  '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.HEAD, UtilAssets.getAssetHead(UtilTraits.getOptionSpecies(dna), UtilTraits.getOptionLocale(dna))), ')"></div>',
                  '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.EYES, UtilAssets.getAssetEyes(UtilTraits.getOptionEyes(dna))), ')"></div>',
                  '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.MOUTH, UtilAssets.getAssetMouth(UtilTraits.getOptionMouth(dna))), ')"></div>',
                  '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.NOSE, UtilAssets.getAssetNose(UtilTraits.getOptionNose(dna))), ')"></div>',
                '</div>',
                '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.JEWELRY, UtilAssets.getAssetJewelry(UtilTraits.getOptionJewelry(dna))), ')"></div>',
                // '<div class="b" style="background-image:url(data:image/png;base64,', fetchAssetString(LayerOrder.HAT, UtilAssets.getAssetHat(UtilTraits.getOptionHat(dna))), ')"></div>',
...
library UtilTraits {
  function getOptionBackground(uint256 dna) internal pure returns (uint8) {
    uint16 bg = UtilAssets.getGene(TraitDefs.BACKGROUND, dna);
    uint16 variant = bg % 4;
  ...
  function getOptionSpecies(uint256 dna) internal pure returns (uint8) {
    uint16 species = UtilAssets.getGene(TraitDefs.SPECIES, dna);
  ...
  function getOptionBelly(uint256 dna) internal pure returns (uint8) {
    uint16 belly = UtilAssets.getGene(TraitDefs.BELLY, dna);
  ...
  function getOptionLocale(uint256 dna) internal pure returns (uint8) {
    uint16 locale = UtilAssets.getGene(TraitDefs.LOCALE, dna);
  ...
  function getOptionEyes(uint256 dna) internal pure returns (uint8) {
    uint16 eyes = UtilAssets.getGene(TraitDefs.EYES, dna);
  ...
  function getOptionMouth(uint256 dna) internal pure returns (uint8) {
    uint16 mouth = UtilAssets.getGene(TraitDefs.MOUTH, dna);
  ...
  function getOptionNose(uint256 dna) internal pure returns (uint8) {
    uint16 nose = UtilAssets.getGene(TraitDefs.NOSE, dna);
  ...
  function getOptionFootwear(uint256 dna) internal pure returns (uint8) {
    uint16 footwear = UtilAssets.getGene(TraitDefs.FOOTWEAR, dna);
  ...
  function getOptionHat(uint256 dna) internal pure returns (uint8) {
    uint16 hat = UtilAssets.getGene(TraitDefs.HAT, dna);
  ...
  function getOptionClothing(uint256 dna) internal pure returns (uint8) {
    uint16 clothes = UtilAssets.getGene(TraitDefs.CLOTHING, dna);
  ...
  function getOptionJewelry(uint256 dna) internal pure returns (uint8) {
    uint16 jewelry = UtilAssets.getGene(TraitDefs.JEWELRY, dna);
  ...
  function getOptionAccessories(uint256 dna) internal pure returns (uint8) {
    uint16 accessory = UtilAssets.getGene(TraitDefs.ACCESSORIES, dna);
  ...
  function getOptionFaceAccessory(uint256 dna) internal pure returns (uint8) {
    uint16 faceAccessory = UtilAssets.getGene(TraitDefs.FACE_ACCESSORY, dna);
