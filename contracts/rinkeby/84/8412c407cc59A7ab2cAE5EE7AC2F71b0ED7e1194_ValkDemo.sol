...
contract ValkDemo is ERC721A, ERC2981, Ownable, ReentrancyGuard {
  ...
  bool public summonEinherjarEnabled = false;
  ...
  */
  ...
  function summonEinherjar(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    // Verify whitelist requirements
    require(summonEinherjarEnabled, 'Summoning has not started!');
    require(!whitelistClaimed[_msgSender()], 'You already claimed!');
...
// }
  ...
  function setsummonEinherjarEnabled(bool _state) public onlyOwner {
    summonEinherjarEnabled = _state;
  }
