...
error Nursery_FunctionLocked();
error Nursery_IndexOutOfRange();
    ...
    ReentrancyGuard
{
    ...
    /**
     * @notice Get pending $POLLEN rewards for a specified account calculated base on their staked COINPLANT tokens
    ...
    function _getPending(address _account) internal view returns (uint256) {
        ...
        return
            (_accountInfo.shares *
                BASE_RATE *
                (block.timestamp - _accountInfo.lastUpdate)) / 60 seconds;
    }
