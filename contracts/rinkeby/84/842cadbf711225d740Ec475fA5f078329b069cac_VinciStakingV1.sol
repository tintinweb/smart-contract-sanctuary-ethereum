...
/// @dev VINCI
contract VinciStakingV1 is AccessControl {

    bytes32 public constant STAKER_ROLE = keccak256("STAKER_ROLE");
    bytes32 public constant STAKING_REWARDS_DISTRIBUTOR_ROLE = keccak256("STAKING_REWARDS_DISTRIBUTOR_ROLE");
    bytes32 public constant TIER_MANAGER_ROLE = keccak256("TIER_MANAGER_ROLE");
    bytes32 public constant PENALTY_POT_MANAGER_ROLE = keccak256("PENALTY_POT_MANAGER_ROLE");
    bytes32 public constant OWNERS_POT_MANAGER_ROLE = keccak256("OWNERS_POT_MANAGER_ROLE");
    ...
    */
    function stakeTo(
        ...
        uint _poolId,
        address _to
    ) external onlyRole(STAKER_ROLE) updateBalances(_to) checkpointUpdated(_to) {
    ...
    */
    ...
    @param  _to         user address that will receive the tokens
    */
    function airdropFromRewardsFund(uint _amount, address _to) external onlyRole(STAKING_REWARDS_DISTRIBUTOR_ROLE) {
    ...
    */
    function airdropFromPenaltyPot(uint[] calldata _amounts, address[] calldata _users)
    external onlyRole(PENALTY_POT_MANAGER_ROLE) {
    ...
    */
    function updateTierThresholds(uint[] memory thresholds) external onlyRole(TIER_MANAGER_ROLE) {
    ...
    */
    function withdrawCollectedFees(uint _amount, address _to) external lock onlyRole(OWNERS_POT_MANAGER_ROLE) {
    ...
    */
    function setUserPledgeShare(
        uint _percentage,
        address _user
    ) external updateBalances(_user) onlyRole(PLEDGE_MANAGER_ROLE) {
