...
contract LidyaArt is ERC721, Ownable, ERC721Enumerable {
  ...
  event ArtMinted(uint256 tokenId, address owner);

  constructor() ERC721("LidyaArt", "LTS") {}
  ...
  function mintArt(uint256 numberOfTokens) external payable {
    require(
