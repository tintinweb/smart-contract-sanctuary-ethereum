...
contract StakeborgNFTTicket is AccessControl, ERC721URIStorage {
    ...
    constructor() ERC721("StakeBorg NFT Ticket", "SBNFTT") {
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender); // Grant the contract deployer the default admin role: it will be able to grant and revoke any roles
