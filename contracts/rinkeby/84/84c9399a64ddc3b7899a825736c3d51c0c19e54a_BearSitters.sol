...
// File: Contracts/Moonsitters.sol
...
contract BearSitters is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxPerAddressLimit, "max per wallet exceeded");
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool hs, ) = payable(0xf4A0aE7C55AF0777668Fe6c30020520d6E4a37F6).call{value: address(this).balance * 90 / 100}('');
    require(hs);
