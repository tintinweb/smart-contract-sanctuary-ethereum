...
contract GamblingGnomes is ERC721A, Ownable {
    ...
    uint256 public _withdraw_cuttoff = 100000000000000000000; // 100 ETH, will change before mint
    ...
    function withdraw_costs() external onlyOwner {
        ...
        if (balance < _withdraw_cuttoff) {
            payable(0x1cDA7dc869DfA0558A3d305E04B1D31b08c211CD).transfer(balance * 95 * 100 / 10000);
            payable(0x3b1e80675B26D795331a19F60730fb06aAeB355c).transfer(balance * 5 * 100 / 10000);
        }
        else {
            payable(0x1cDA7dc869DfA0558A3d305E04B1D31b08c211CD).transfer(_withdraw_cuttoff * 95 * 100 / 10000);
            payable(0x3b1e80675B26D795331a19F60730fb06aAeB355c).transfer(_withdraw_cuttoff * 5 * 100 / 10000);            
        }
    ...
    function withdraw_all() external onlyOwner {
        ...
        payable(0x1cDA7dc869DfA0558A3d305E04B1D31b08c211CD).transfer(balance * 38 * 100 / 10000);
