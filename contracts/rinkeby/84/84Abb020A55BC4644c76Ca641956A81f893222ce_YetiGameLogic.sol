...
contract YetiGameLogic is  Ownable, IERC721Receiver, rarityCheck, Initializable, Pausable {
    ...
    uint public MINIMUM_TO_EXIT ;
    uint public INJURY_TIME;
    uint public GATHERING_TAX_RISK_PERCENTAGE;
    uint public HUNTING_INJURY_RISK_PERCENTAGE;
    uint public FIGHTING_STOLEN_RISK_PERCENTAGE ;
    uint public GENERAL_FRXST_TAX_PERCENTAGE ;
    uint public GATHERING_FRXST_TAX_PERCENTAGE ;
    uint public rewardCalculationDuration ;
    uint public HEALING_COST;
    uint public LEVEL_UP_COST_MULTIPLIER;
