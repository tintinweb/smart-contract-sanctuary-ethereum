...
contract WeeziAngelsToken is ERC721, ERC721Enumerable, Ownable, OracleClient {
    ...
    {
        // require(_exists(_tokenId) = false, "TOKEN_ALREADY_USED");
        // require(balanceOf(msg.sender) = 0, "USER_ALREADY_OWNS_THE_TOKEN");
...
contract OracleClient is Ownable {
    ...
    modifier withValidOracleData(
        ...
        //
        require(_tokenId > 0, "ZERO_TOKEN_ID");

        // Check that signature is not expired and is valid
        //
        require(
            isValidSignatureDate(_timestamp),
            "EXPIRED_PRICE_DATA"
        );
    ...
    function isValidSignature(
        ...
        return recover(_user, _tokenId, _timestamp, _signature) == oracleAddress;
    }
    ...
    function recover(
        ...
        bytes32 dataHash = keccak256(
            abi.encodePacked(_user, _tokenId, _timestamp)
        );
