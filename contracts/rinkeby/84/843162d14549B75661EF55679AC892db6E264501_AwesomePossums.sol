...
contract AwesomePossums is ERC721A, Ownable {
    ...
    uint256 public constant FOR_SALE_TOKENS = 12000 - RESERVED_TOKENS;
    ...
    constructor() ERC721A("Awesome Possums", "Awesome Possums") {
    ...
    function setCurrentForSaleLimit(uint256 _currentForSaleLimit) external onlyOwner {
        currentForSaleLimit = _currentForSaleLimit;
    }
