...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function performUpkeep(
        ...
        s_raffleState = RaffleState.CALCILATING;
        uint256 rquestId = i_vrfCoordinator.requestRandomWords(
            i_gasLane,
            i_subscriptionId,
        ...
        emit RequestedRaffleWinner(rquestId);
    }
    ...
    function getNumberOfPlayters() public view returns (uint256) {
        return s_players.length;
    }

    function getLatastTimeStamp() public view returns (uint256) {
