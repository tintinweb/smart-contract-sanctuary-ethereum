    ...
    BaseRelayRecipient
{
    ...
    function setState(address _user, bytes32 _state) public {
        ...
        emit SetState(_msgSender(), _user, _state);
    }
    ...
    function mint(
        ...
        emit Mint(_msgSender(), _user, _id, _balance, _retailer);
    }
    ...
    function spend(bytes32 _id, uint256 _amount) public {
        ...
        totalSpent += _amount;
        emit Spend(_msgSender(), card.owner, _id, _amount);
    }
    ...
    function fund(bytes32 _id, uint256 _amount) public {
        ...
        card.balance += _amount;
        totalFunded += _amount;
        emit Fund(_msgSender(), card.owner, _id, _amount);
    }
    ...
    function transfer(bytes32 _id, address _to) public {
        ...
        require(ids[_id] == true, "Card not found");
        require(isAuthorized(card.owner), "Unauthorized");
        emit Transfer(_msgSender(), card.owner, _to, _id);
        card.owner = _to;
    }
