...
contract FeeManager is Ownable {
    ...
    event RoyalFeePerMillion(uint256 cutPerMillion);
...
contract PayableMarketplace is Pausable, FeeManager, IMarketplace, ERC721Holder, ReentrancyGuard {
    ...
    function _createOrder(address _nftAddress, uint256 _assetId, uint256 _priceInWei, uint256 _expiresAt, address _creator, uint _royalFee) internal {
        ...
        require(_royalFee <= maxCutPerMillion, "Marketplace: Royal fee must be < 10%");
