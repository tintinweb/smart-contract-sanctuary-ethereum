 ...
 * Some partial text just for width testing (129 chars)
 *  ,                         ////              ////,         ,          //   //////////                         ///        .///
 *  ██*          *██%    (███████████*      .███████████*    %███       (██*   /██████████(        (██           /████    ,████
 *  /████      █████%   ███        /███    ███&       .███#    ████     (██*           .███        ████(            ████ ████
 *     %███(*███████%  ███%         .██%  *██(         /███      %████* (██*          *%███      ███% ███            /█████
...
contract MFE is MFESplitsTestnet, TFCBase {
    ...
    constructor()
        TFCBase(
            'MFE',
            'MFE',
            'https://nftculture.mypinata.cloud/ipfs/QmezgdQtR4v1tPvf6NiwrCfK4Kdxzh1ieqXSLA3puVHuec/', // V1 Metadata
            addresses,
            splits,
        ...
        )
    {
        ...
        // Contract MFE Rinkeby V4 deployed to address: [0x841A7eD4F47067657eF368249A9A9454399c15Fe].
    }
