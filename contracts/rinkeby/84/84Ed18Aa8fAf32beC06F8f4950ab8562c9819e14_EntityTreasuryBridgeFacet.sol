...
contract EntityTreasuryBridgeFacet is EternalStorage, Controller, EntityTreasuryFacetBase, IEntityTreasuryBridgeFacet, IDiamondFacet {
    ...
    function getSelectors() public pure override returns (bytes memory) {
        return abi.encodePacked(IEntityTreasuryBridgeFacet.transferFromTreasury.selector, IEntityTreasuryBridgeFacet.transferToTreasury.selector);
    }
...
interface IEntityTreasuryBridgeFacet {
     ...
     */
    event TransferToTreasury(address indexed caller, address indexed unit, uint256 indexed amount);
     ...
     * @param amount The amount moved.
     */
    event TransferFromTreasury(address indexed caller, address indexed unit, uint256 indexed amount);
}
