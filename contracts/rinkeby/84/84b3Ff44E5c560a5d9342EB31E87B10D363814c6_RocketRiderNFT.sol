...
contract RocketRiderNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) tokensPerWallet;
    ...
    function mint(uint256 quantity) external payable nonReentrant {
        ...
        require(tokensPerWallet[msg.sender] + quantity <= maxPerWallet, "Max per wallet exceeded!");
