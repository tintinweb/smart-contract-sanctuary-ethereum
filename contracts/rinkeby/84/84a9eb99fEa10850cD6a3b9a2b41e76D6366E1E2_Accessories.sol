...
// DollsVol1 is an ERC1155 contract that contains crypto dolls vol1.
contract Accessories is Ownable, ERC1155Supply, ERC1155PresetMinterPauser {
    // Contract name
    string public name;
    ...
    constructor(string memory _uri) ERC1155PresetMinterPauser(_uri) {
        name = "Crypto Buddies Accessories";
        symbol = "CBDA1";
    }
