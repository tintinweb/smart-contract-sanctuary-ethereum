...
contract Patience is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private constant PRESALE_AL_ALLOCATION = 240;
    ...
    uint256 private preSaleLaunchTime = 1652582700;
    uint256 private publicSaleLaunchTime = 1662583300;
    ...
    function _canMintPresale(address wallet, uint256 amount, bytes memory data) internal view returns (bool, PreSaleType) {
        ...
        if (gmDao.balanceOf(wallet, gmDaoTokenId) > 0) {
