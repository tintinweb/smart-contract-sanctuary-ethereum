...
/// @dev The contract inherits from the ERC721 standard made by OpenZeppelin.
contract Moonwalkers is ERC721A, Pausable, Ownable, ReentrancyGuard {
  ...
  constructor(uint256 _maxSupply) ERC721A("Moonwalkers", "MW") {
    ...
    unrevealedTokenURI = "";
    saleConfig.publicSaleMintPrice = 0.001 ether;   // TO EDIT FOR PROD
    saleConfig.presaleMintPrice = 0.0008 ether;   // TO EDIT FOR PROD
    saleConfig.presaleStartTime = 1650540387;   // TO EDIT FOR PROD
    saleConfig.publicSaleStartTime = 1650540387;   // TO EDIT FOR PROD
  ...
  function publicSaleMint(uint256 _mintAmount) external payable whenNotLocked callerIsUser {
    ...
    require(block.timestamp > config.publicSaleStartTime, "Public sale has not started yet."); // Need to take 1 second less cause it's a strict superior
