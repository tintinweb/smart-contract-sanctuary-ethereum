...
contract MagicalUnicorns is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Magical Unicorns", "UNCRN") {}

    function safeMint(address to, string memory uri) public {
        uint256 tokenId = _tokenIdCounter.current();
        _mintedPerAddress[to]++;
        require(tokenId <= MAX_SUPPLY, "I'm sorry. All NFTs have been minted.");
        require(_mintedPerAddress[to] <= 5, "You have already minted the maximum of 5 NFTs.");
