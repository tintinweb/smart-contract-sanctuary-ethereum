...
error StudentService__UserDoesNotExist();
error StudentService__ExamAlreadyRegistered();
error StudentService__ExamDoesNotExist();
error StudentService__ExamRegisteredLate();
...
contract StudentService {
    ...
    function loadData() private {
        ...
        Exam memory exam0 = Exam(1, course0, 1664335534, true);
        Exam memory exam1 = Exam(2, course1, 1664335534, true);
        Exam memory exam2 = Exam(3, course2, 1664335534, true);
        exams.push(exam0);
        exams.push(exam1);
        exams.push(exam2);
        ...
        professorExamResults[0xf61D8b5E25c0C69012e225ef7c1102B1451D43e5].push(
            ExamResult(0xdf26F670674fbF1f5BD3c60f67299e33ec68c659, exams[1], 7)
        );
        studentExamResults[0xA5A5A6c6C867e8BFd6cF8fcF472D70bC53eCb7a4].push(
            ExamResult(0xA5A5A6c6C867e8BFd6cF8fcF472D70bC53eCb7a4, exams[2], 9)
        );
        professorExamResults[0xf61D8b5E25c0C69012e225ef7c1102B1451D43e5].push(
            ExamResult(0xdf26F670674fbF1f5BD3c60f67299e33ec68c659, exams[2], 9)
        );
    }
    ...
    function examIsRegistered(uint256 _index, address _address)
        ...
        returns (bool)
    {
        ExamResult[] memory examResults = studentExamResults[_address];
        for (uint i = 0; i < examResults.length; i++) {
            if (
                examResults[i].exam.id == _index &&
                examResults[i].student == _address
            ) {
                return true;
            }
        }
