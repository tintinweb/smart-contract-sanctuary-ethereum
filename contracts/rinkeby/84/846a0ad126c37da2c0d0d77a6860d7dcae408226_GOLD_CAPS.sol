...
contract GOLD_CAPS is ERC721A, Ownable {
    ...
    constructor(string memory baseuri, bytes32 finalRootHash) ERC721A("GOLD CAPS", "WOFGC") {
        _baseURI1 = baseuri;
        rootHash = finalRootHash;
    }

    uint256 public maxsupply = 21;
    uint256 public reserve = 3;
    ...
    function whiteListMint(
        ...
        require(
            _SaleAddresses[msg.sender].counter + chosenAmount <= SaleMaxQuantity,
