...
contract DigidorablesC1 is ERC721A, Ownable, ReentrancyGuard {
  ...
  ERC721A private immutable boxelContract;
  ...
  constructor(
    ...
    boxelContract = ERC721A(boxelContract_); //0xfF58403B9b011659f45d12744a0bE5F01c9FB607
  ...
  function redeem(uint256 tokenId, bytes32[] memory proof) external onlyUser {
    ...
    if(usedTokens[tokenId]) revert TokenHasBeenRedeemed();
