...
{
    // Time
    uint256 public TIMESTAMP_PRESALE = 1645279170; // TODO // 1645279170 = 2022-02-19T13:59:30.000Z
    uint256 public TIMESTAMP_RAFFLE = 1645322400; // TODO // 1645322400 = 2022-02-20T02:00:00.000Z
    uint256 public TIMESTAMP_RAFFLE_END = 1645344000; // TODO // 1645344000 = 2022-02-20T08:00:00.000Z
    uint256 public TIMESTAMP_SALE = 1645365570; // TODO // 1645365570 = 2022-02-20T13:59:30.000Z

    // Price
    uint256 private constant PRICE = 0.165 ether; // TODO

    // Mint
    uint256 private constant LIMIT = 1; // TODO
    uint256 private constant LIMIT_SALE = 2; // TODO
        ...
        RoborovskiName(rnct_)
    {
        ...
        _mint(0x5AF3F92c0725D54565014b5EA0d5f15A685d1a2a, 1); // TODO
        isMintedBeforeSale[1] = true;
        _indices[1] = MAX_SUPPLY - 2;
        _mint(0x5AF3F92c0725D54565014b5EA0d5f15A685d1a2a, 2); // TODO
    ...
    function setTimestampRaffle(uint256 timestamp) external onlyOwner {
        TIMESTAMP_RAFFLE = timestamp;
    }

    function setTimestampRaffleEnd(uint256 timestamp) external onlyOwner {
        TIMESTAMP_RAFFLE_END = timestamp;
    }
    ...
    function mintRaffle(uint256 count, uint256 signId, bytes memory signature) external payable nonReentrant {
        require(block.timestamp >= TIMESTAMP_RAFFLE && block.timestamp < TIMESTAMP_RAFFLE_END, "ROBOROVSKI: raffle not open");
        _checkSignature(_msgSender(), count, signId, signature);
