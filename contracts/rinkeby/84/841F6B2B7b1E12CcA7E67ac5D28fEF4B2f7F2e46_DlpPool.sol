    ...
    Timestamp
{
     ...
     */
    event LogUpdateAdditionalDLPPerSecond(address indexed by, uint256 newDlpPerSecond);
    ...
    function _updateAdditionalDLPPerSecond() internal virtual {
        ...
        // emit an event
        emit LogUpdateAdditionalDLPPerSecond(msg.sender, dlpAdditionalPerSecond);
    }
