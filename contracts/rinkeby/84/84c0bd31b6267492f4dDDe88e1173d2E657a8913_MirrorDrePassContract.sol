...
//
//     __  ____                         ____               ____                 
//    /  |/  (_)_____________  _____   / __ \________     / __ \____ ___________
//   / /|_/ / / ___/ ___/ __ \/ ___/  / / / / ___/ _ \   / /_/ / __ `/ ___/ ___/
//  / /  / / / /  / /  / /_/ / /     / /_/ / /  /  __/  / ____/ /_/ (__  |__  ) 
// /_/  /_/_/_/  /_/   \____/_/     /_____/_/   \___/  /_/    \__,_/____/____/  
//                                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x43f380e356D30a4Ca7Fa411208f60f0f4dD398c0,0xC125295e8324aabe1f9802C402b232b58e959B86];
  uint256[] public payableFees = [5,45,50];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 99;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihrcp7rbzmk3l2f3wdodzlw3kwcvz5pwy5htdppyj343ezf7qzw3i/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 999");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 999");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 999");
...
// File: contracts/MirrorDrePassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MirrorDrePassContract is RamppERC721A {
    constructor() RamppERC721A("Mirror Dre Pass", "MRDP"){}
}
