...
contract CryptoEyeo2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SketchyEyes", "SKE") {
    setHiddenMetadataUri("ipfs://QmTNVscuXYxhPedAyTGtJFwGXCTpoPSFNNG1a1tDFgxQ6V/_metadata.json");
   // https://gateway.pinata.cloud/ipfs/QmTNVscuXYxhPedAyTGtJFwGXCTpoPSFNNG1a1tDFgxQ6V
  }
