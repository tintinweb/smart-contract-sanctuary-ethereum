...
contract EZU is ERC721BatchEnumerable, ERC2981Base, IOwnable, IPausable, ITradable, IWhitelistable {
	...
	address public PA_TREASURY_ADDRESS = 0x218B622bbe4404c01f972F243952E3a1D2132Dec;

	// Magic Eden treasury address
	address public ME_TREASURY_ADDRESS = 0xA55c2F8Af10d603976dEcA0B61Cd87ba2F9C6492;
	...
	// **************************************
		...
		*/
		function setTreasuries( address meTreasury_, address paTreasury_ ) external onlyOwner {
			PA_TREASURY_ADDRESS = paTreasury_;
			ME_TREASURY_ADDRESS = meTreasury_;	
		}
		...
		*/
		function withdraw(uint256 _amount) external onlyOwner {
			...
			uint256 me_cut = (_amount / 3636) * 100; // ~2.75%
			uint256 pa_cut = _amount - me_cut;
			_sendValue( payable( PA_TREASURY_ADDRESS ), pa_cut );
			_sendValue( payable( ME_TREASURY_ADDRESS ), me_cut );
		}
	// **************************************
