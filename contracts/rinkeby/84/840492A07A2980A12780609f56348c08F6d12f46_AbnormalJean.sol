...
contract AbnormalJean is Context, ERC721Enumerable, Ownable, ReentrancyGuard  {
  ...
  ERC721("Abnormal Jean", "JEAN")
  {
    ...
    MetroPass = IERC721(0x528bee9B739072748E7c1BF0E38a962669cFFA75);
    Passport = IERC721(0xE9aD9a18828CFDCCD00E41f790070a9Cc6791d21);
  ...
  function claim(
    ...
    if (currentStatus == Statuses.Whitelist && msg.value > 0) payable(_msgSender()).transfer(msg.value);
  }
