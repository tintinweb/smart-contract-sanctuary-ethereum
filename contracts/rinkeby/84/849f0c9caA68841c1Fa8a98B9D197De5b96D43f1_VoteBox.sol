...
contract VoteBox is Adminable, IVoteBox, EIP712VoteAllowlist {
    ...
    function isVoterNftHolder(uint256 _pid) public view override existsPoll(_pid) returns (bool) {
        ...
        return _isExternalNftOwner(nftContract, msg.sender);
    }
