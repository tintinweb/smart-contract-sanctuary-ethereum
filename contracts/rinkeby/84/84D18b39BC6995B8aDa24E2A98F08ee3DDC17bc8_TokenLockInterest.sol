...
contract TokenLockInterest is ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        IERC20(tokenAddress_).safeTransfer(address(this), amount_);
        ...
        nonReentrant
    {
        ...
        emit Locked(msg.sender, tokenAddress_, amount_);
    }
    ...
    function getLock(
        ...
        bytes32 lockId_
    ) public returns (Lock memory) {
        require(
            account_ != address(0) && tokenAddress_ != address(0),
            "TLI: Zero address"
        );
        _updateLocks(account_, tokenAddress_);
        return _locks[lockId_];
    }

    function getLockRemainingTime(
        address account_,
        address tokenAddress_,
        bytes32 lockId_
    ...
    function getWithdrawableAmount(address account_, address tokenAddress_)
        public
        returns (uint256)
    {
        require(
        ...
        _updateLocks(account_, tokenAddress_);
        return _userTokenBalances[account_][tokenAddress_];
    }
}
