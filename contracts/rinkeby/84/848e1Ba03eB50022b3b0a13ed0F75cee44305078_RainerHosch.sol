...
contract RainerHosch is ERC1155PresetMinterPauser, Ownable {
    ...
    string public name = "Rainer Hosch - Iconography - Genesis Collection FAKE";
    string public symbol = "RAINERHOSCHGENESISFAKE"; 
    
    string public contractUri = "https://nft.alexsachs.com/rainerhosch/contract"; 

    constructor() ERC1155PresetMinterPauser("https://nft.alexsachs.com/rainerhosch/{id}") {
    }
