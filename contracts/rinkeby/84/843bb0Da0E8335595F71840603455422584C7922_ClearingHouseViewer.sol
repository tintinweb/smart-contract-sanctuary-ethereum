...
contract ClearingHouseViewer is IClearingHouseViewer {
    ...
    function marginRatio(address account) public view override returns (int256) {
        ...
        (int256 openNotional, int256 unrealizedPositionPnl, int256 fundingPayments) = clearingHouse
            .getPositionAcrossMarkets(account);
...
interface IClearingHouse is IIncreOwnable {
    ...
    function getFreeCollateralLiquidity(address account, bool isDiscounted) external view returns (int256);

    function getPositionAcrossMarkets(address account)
        external
        view
        returns (
            int256 absOpenNotional,
            int256 unrealizedPositionPnl,
            int256 fundingPayments
        );
...
interface IOracle {
    ...
    event OracleUpdated(address asset, AggregatorV3Interface aggregator);
...
interface IPerpetual {
    ...
    function getTraderPositionHealth(address account) external view returns (int256 pnL, int256 absOpenNotional);
    ...
    function getLpPositionHealth(address account) external view returns (int256 pnL, int256 absOpenNotional);
