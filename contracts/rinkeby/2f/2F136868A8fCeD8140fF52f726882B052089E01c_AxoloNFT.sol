...
contract AxoloNFT is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    uint256 axoloPrice = 0.001 ether;
    ...
    constructor(address manager) ERC721("AXL", "AXL") {
