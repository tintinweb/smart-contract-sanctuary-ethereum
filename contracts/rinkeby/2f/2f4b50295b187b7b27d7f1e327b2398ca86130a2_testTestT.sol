...
contract testTestT is ERC20Interface{ 
    string public name; 
    ...
    address public taxWallet = 0xdD870fA1b7C4700F2BD7f44238821C26f7392148; 
    ...
    function transfer(address to, uint tokens) public override returns (bool success) { 
        ...
        uint256 maxhold = ((totalSupply() * 1)/100); 
        require(balanceOf(to)<maxhold, "You can hold 2% max"); 
        //2% overall holding amount : purchasable amount 
        require(balances[msg.sender] >= tokens); 
        //7% treasury tax  
        uint256 treasTax = ((tokens * 7)/100); 
        //tokens -= treasTax;  
        unchecked{balances[msg.sender] -= treasTax;} 
        unchecked{balances[taxWallet] += treasTax;} 
