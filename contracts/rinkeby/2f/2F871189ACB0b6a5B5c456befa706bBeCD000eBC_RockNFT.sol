...
contract RockNFT is ERC721Enumerable, Ownable {
    ...
    uint public tokensReservedForDutchAuction = 300;
    ...
    uint internal Shareholder_1_Share = 3; 
    uint internal Shareholder_2_Share = 2;
    uint internal Shareholder_3_Share = 95; 
    ...
    uint public dutchPriceAdditional; // = 10 ether, record the additional price of dutch and deduct
