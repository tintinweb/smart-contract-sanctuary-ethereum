...
contract Astronauts is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmZS1LYD9vDAR8ZkSiJZLqRuwpM54tCmEkwMmv7p5otfdb/";
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    function publicMint(uint256 count) external payable {
        ...
        require((totalSupply() < FREE_AMOUNT), "Free mint phase is over, only paid mints available right now");
