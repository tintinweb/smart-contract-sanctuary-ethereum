...
contract Token is ERC721, Ownable {
  ...
  uint256 internal fixedPrice = 0;
  uint256 internal firstPrice;
  uint256 internal secondPrice;
  uint256 internal thirdPrice;
  uint256 internal priceLevel;
  ...
  function getPrice() public view returns (uint256) {
    ...
    if (onlyWhitelisted) return firstPrice;
    if (supply.current() < priceLevel) return secondPrice;
    return thirdPrice;
  }
  ...
  function dangerouslySetUriSuffix(string memory _uriSuffix) public onlyOwner {
