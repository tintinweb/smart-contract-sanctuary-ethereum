...
contract MyToken is OwnableUpgradeable, ERC721AUpgradeable, ReentrancyGuardUpgradeable {
  uint256 public constant maxPerAddressDuringMint = 5;
  uint256 public constant amountForDevs = 200;
  uint256 public constant amountForAuctionAndDev = 8900;
  ...
  function initialize() initializer public {
    ...
    __ERC721A_init("MyToken", "MyToken", 5, 10000);
    __Ownable_init();
  }
  ...
  IERC721EnumerableUpgradeable
{
  ...
  function __ERC721A_init(string memory name_, string memory symbol_, uint256 maxBatchSize_, uint256 collectionSize_) internal onlyInitializing {
  ...
  function __ERC721A_init_unchained(string memory name_, string memory symbol_, uint256 maxBatchSize_, uint256 collectionSize_) internal onlyInitializing {
    _name = name_;
    _symbol = symbol_;
