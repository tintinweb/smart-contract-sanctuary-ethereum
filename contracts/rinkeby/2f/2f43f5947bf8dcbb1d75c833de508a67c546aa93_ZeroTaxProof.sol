...
Liquidity Locked for 1 week then I will expand when we reach certain milestones
...
contract ZeroTaxProof is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ZeroTaxProof", "ZTP") {
