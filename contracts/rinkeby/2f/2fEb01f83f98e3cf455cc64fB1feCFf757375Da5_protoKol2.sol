...
contract protoKol2 is iProtoKol {
   ...
   */
    ...
    function withdrawPenaltyAndUpdateAddress(address[3] memory _setNewAddresses, bool wantToWithdraw)
        external
        onlyAdmin
    {
        if (!wantToWithdraw) {
...
interface iProtoKol {
    ...
    event WithdrawPenaltyAndUpdateAddress(address[3] _setNewAddresses, uint256 penaltyAmount);
