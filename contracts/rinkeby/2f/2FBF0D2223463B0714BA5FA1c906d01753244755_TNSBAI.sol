...
contract TNSBAI is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmZ9ERb3Dqdn5fc5ikiGZCYupgFbXM7MTDgaeyaEoaxXNd"; // Contract-level metadata
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://QmV7iZCxR4sTDavi1AYnkKv5CnKPx1uA9nqCWjrYCTW3vY/"; // IPFS base for collection
    ...
    function _mint(
        ...
        // Caps per token supply to 1 editions
