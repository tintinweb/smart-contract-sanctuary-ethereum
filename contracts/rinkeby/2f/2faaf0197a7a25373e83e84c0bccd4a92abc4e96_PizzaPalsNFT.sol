...
contract PizzaPalsNFT is ERC721A, Ownable {
    ...
    constructor() ERC721A("Pizza Pals NFT", "PZP") {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(MAX_PER_TX >= _amount , "Exceeds max per paid tx");
    ...
    function setMaxPerTx(uint256 _newMPT) public onlyOwner {
        MAX_PER_TX = _newMPT;
    }
    
    function setMaxPerWallet(uint256 _newMPW) public onlyOwner {
        MAX_PER_WALLET = _newMPW;
    }
