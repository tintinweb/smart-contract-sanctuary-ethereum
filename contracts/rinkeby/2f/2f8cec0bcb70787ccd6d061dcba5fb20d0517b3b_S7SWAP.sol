...
contract S7SWAP {
  ...
  function exchange (address _openTrader, address _meduim, address _openContractAddress, address _closeTrader, address _closeContractAddress) public {
      ...
      require(openERC20Contract.approve(_meduim, openTotal));
      require(openERC20Contract.transfer(_meduim, openTotal));
