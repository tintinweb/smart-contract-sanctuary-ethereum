...
contract TestGate is Context, IERC20, Ownable {
    ...
    string private _name = "TestGate";
    string private _symbol = "TestGate";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2; // Marketing
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _rFee = 6;
    ...
    uint256 public _maxTxAmount = 2 * 10 ** 17;
