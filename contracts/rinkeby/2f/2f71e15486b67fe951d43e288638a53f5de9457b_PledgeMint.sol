...
contract PledgeMint is Ownable, ReentrancyGuard {
	...
	IERC20 public USDC = IERC20(0x322D8AD3F54CF5b8383F6f83e5C83Fdb5d4237Af); // USDC
    ...
    function pledge(uint16 phaseId, uint8 number) external callerIsUser nonReentrant{
	...
	function pledge(uint16 phaseId, uint8 number, bytes32[] calldata merkleProof) external callerIsUser nonReentrant{
        PhaseConfig memory phase = phases[phaseId];
