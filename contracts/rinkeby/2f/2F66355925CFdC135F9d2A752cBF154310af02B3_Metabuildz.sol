...
/*
  __  __      _        ____        _ _     _     
 |  \/  | ___| |_ __ _| __ ) _   _(_) | __| |____
 | |\/| |/ _ \ __/ _` |  _ \| | | | | |/ _` |_  /
 | |  | |  __/ || (_| | |_) | |_| | | | (_| |/ / 
 |_|  |_|\___|\__\__,_|____/ \__,_|_|_|\__,_/___|
...
contract Metabuildz is ERC721A, ReentrancyGuard, Delegated {
    ...
    // ======== CONSTRUCTOR ========
    constructor() ERC721A("Metabuildz v.1", "MBZ") {}
        ...
        callerIsUser
    {
        ...
        require(msg.value == whitelistPrice, "Incorrect ether sent");
        require(totalSupply() < MAX_SUPPLY, "Max supply reached");
        require(_numberMinted(msg.sender) < 3, "Unable to mint anymore, max of 3 mint per wallet.");
        require(_whitelistAddresses[msg.sender] == true, "Address is not whitelisted");
        ...
        callerIsUser
    {
        ...
        require(totalSupply() < MAX_SUPPLY, "Max supply reached");
        require(_numberMinted(msg.sender) < 10, "Already minted");
        
        _safeMint(msg.sender, quantity);
    }

    function teamMint(uint256 _quantity) external onlyDelegates {
    ...
    function setwhitelistPrice(uint256 _price) external onlyDelegates {
        whitelistPrice = _price;
    }

    function setWhitelistAddress(address _whitelist) external onlyDelegates {
        require(_whitelistAddresses[_whitelist] == false,"Address is already whitelisted");
        _whitelistAddresses[_whitelist] = true;
    }
