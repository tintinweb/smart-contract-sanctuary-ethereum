...
// File: gist-607974f570f437e4356d136ecfad816b/contracts/Contract.sol
...
contract Contract is Ownable, ERC721A, ReentrancyGuard {
    ...
    // cmd: date +%s -d '2022-04-06 14:00:00' 
    uint32 presaleStartTime = 1649246400;
    uint32 saleStartTime = 1649246400;
    ...
    // Whitelist (mintlist) minting
    function preMint(uint256 quantity) external payable nonReentrant callerIsUser {
