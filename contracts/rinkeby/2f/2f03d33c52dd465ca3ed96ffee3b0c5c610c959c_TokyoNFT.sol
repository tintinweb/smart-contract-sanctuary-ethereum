...
contract TokyoNFT is ERC721A, Ownable{ 
    ...
    constructor(uint256 yumyum, uint256 fatcat, string memory miaow_pic, uint256 no_greedy_cat, uint256 wantmoremiaow, bool miaowgooo, uint256 frendsbenefit) ERC721A("Tokyo", "TOK"){
    ...
    function miaowtastic(uint256 _mintAmount) public payable mintRegulation(_mintAmount) {
        ...
        function CATTAKEOVER(uint256 _mintAmount) public mintRegulation(_mintAmount) onlyOwner {
        _safeMint(msg.sender, _mintAmount);
    }

        function dothehumptydumpty(string calldata fish) public onlyOwner{
        FISH = fish;
    }
