...
contract TeddyBandits is ERC721Enumerable, Ownable
{
    ...
    function contractURI() public view returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "TeddyBandits", "description": "The story revolves around a faction of teddy bears with a code. A code that must not be broken or else consequences will follow to those who violate it. Bandits will punish everyone who breaks the code; which is leaving the faction, by fining them a small fee for their punishment.", "seller_fee_basis_points": 500, "fee_recipient": "0xf4a07925cFCe8F3abF79539f584dC86F4964E512"}'))));
