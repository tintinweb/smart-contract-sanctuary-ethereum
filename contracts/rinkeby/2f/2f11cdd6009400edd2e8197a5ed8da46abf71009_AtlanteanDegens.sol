...
contract AtlanteanDegens is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmZJCf13SJzC6v3pUBVmeDQMKt4H8tSXaUe6p8z3UQacJ6/";

    constructor() ERC721A("AtlanteanDegens", "AD") {}

    function mint(uint256 quantity) external payable {
        // _safeMint's second argument now takes in a quantity, not a tokenId.
        require(quantity + _numberMinted(msg.sender) <= MAX_MINTS, "Max mints reached");
        require(totalSupply() + quantity <= MAX_SUPPLY, "Going");
