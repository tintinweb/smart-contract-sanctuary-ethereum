...
contract COSMIQS is ERC721A, Ownable, PaymentSplitter  {
    ...
    uint256 public constant maxSupply = 8888;  //First [number] will be auctioned off for charity. Dev mint [number] will be minted for giveaways and partnetships.
    ...
    bool private activeIncubator = true;
    ...
    function mintCosmiq(uint256 _tokenAmount, bytes32[] calldata proof) external payable {
        ...
        if (msg.sender != owner()) {
            ...
            if(activeWhitelist == true && activeIncubator == false) {
    ...
    function setIncubatorList(bool _incubactive) public onlyOwner {
        activeIncubator = _incubactive;
    }
