...
contract MyNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(address _importantAddress) ERC721("MyNFT", "MTK") {
        importantAddress = _importantAddress;
    }

    function safeMint(string memory uri, uint256 quantity, bytes memory sig) public payable {
        require(msg.value >= quantity * _unitPrice, "Not enough ETH sent; check price!"); 
        require(isValidData(uri, sig), "Invalid Value!");
