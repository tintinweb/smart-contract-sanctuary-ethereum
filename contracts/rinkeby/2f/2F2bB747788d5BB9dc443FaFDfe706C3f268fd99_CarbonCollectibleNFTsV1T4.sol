...
contract CarbonCollectibleNFTsV1T4 is Initializable, ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize(string memory _initBaseURI, address _initOwner) public initializer {
    __ERC721_init("CarbonCollectibleNFTsT4", "CCNT4");
    __Ownable_init();
