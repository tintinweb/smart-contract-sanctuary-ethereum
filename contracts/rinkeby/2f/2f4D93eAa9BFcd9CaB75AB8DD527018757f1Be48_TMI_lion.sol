...
contract TMI_lion is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(address _signerAddress) ERC721A("too much information lion", "TMI") {
        collectionSize = 288+300;
        maxBatchSize = 1;
        payoutAddress = 0x24f40E6c01E8f5A33cf003Ba666D78dcE1577A42;
        signerAddress = _signerAddress;
        currentSaleIndex = 0;

        SaleConfig memory whitelistSaleConfig = SaleConfig({
            startTime: 1648188000,
            endTime: 1648202400,
            price: 0.5 ether,
            stage: SaleStage.Whitelist
        });
        SaleConfig memory whitelist2SaleConfig = SaleConfig({
            startTime: 1648206000,
            endTime: 1648216800,
            price: 0.5 ether,
