...
contract NftTankPad is ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant RESERVE_NFT = 100;
    uint256 public constant PUBLIC_NFT = 2000;  //  maximum public NFT for mint
    uint256 public constant NFT_PRICE = 0.4 ether; //per token prise
