...
contract TestPepoFinal is ERC721VI, Ownable {
  using Strings for uint256;
  ...
  address token4 = 0x42069ABFE407C60cf4ae4112bEDEaD391dBa1cdB; //CryptoDickbutts S3
  address token5 = 0xdDe1821134Ea45133Ecc421db710D20434B0836d; //Rinkey test

  constructor() ERC721VI("Test Pepo Final", "TPepoFinal", maxPerTx) {}
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    uint _userBalance5 = IERC721(token5).balanceOf(msg.sender);

    if (_userBalance1 + _userBalance2 + _userBalance3 + _userBalance4 + _userBalance5 > 0) { // owns one of the nft
  ...
  function withdrawall() public onlyOwner {
    ...
    require(payable(0x70a8A3c8f07C7B7C05b072Da1aBa9d09d147ab0d).send(_balance));
  }
}