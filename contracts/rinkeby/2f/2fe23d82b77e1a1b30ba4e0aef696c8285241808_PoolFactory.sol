...
contract PoolFactory is OwnableUpgradeable{
    ...
    function initialize(address _master , address _privatemaster , address _poolmanager , address _fairmaster , uint8 _version , uint256 _kycPrice , uint256 _auditPrice , uint256 _masterPrice ,  uint256 _privatemasterPrice , uint256 _fairmasterPrice  , uint256 _contributeWithdrawFee , bool _IsEnabled)external initializer {
        __Ownable_init();
        master = _master;
