...
contract JekyllAndHydeNFT is ERC2981, ERC721, Ownable {
    uint256 private constant collectionSize = 1100; // 10% hats, (100 Jekyll)
    uint256 private constant earnableNFTs = 100; // 10% hats (10 Hyde)
    uint256 private mintableNFTsAvailable = collectionSize - earnableNFTs;
    uint256 private nextEarnedNFTId = 0;

    // mutable properties
    string private _baseTokenURI =
        "https://bookcoin.mypinata.cloud/ipfs/QmYQSVqdtqManJv5aR5dtmDsjGeZ1KDW4N6uZLsB7hAgeZ/";
    ...
    // used for psuedo-psuedoRandom mint mechanic
    ...
    // EIP2981 properties
    address royaltyAddr = 0x51AaE7357c8baD10DB3532e9AC597efFA5C3820f; //TODO: Replace this with a BookCoin wallet
    ...
    function claim(bytes32[] calldata proof) external {
        ...
        require(_verifyClaim(_leafAddress(account), proof), "Bad Proof");
    ...
    function earn(string calldata code, bytes32[] calldata proof) external {
        address account = _msgSender();
        require(_verifyEarn(_leafString(code), proof), "Bad Proof");
    ...
    function _nextToken() internal returns (uint256) {
        ...
        uint256 tempMax = maxSupply() - mintedSupply() - earnableNFTs;
