...
abstract contract OwnableWithTempOwnership is Ownable {
    ...
    function setTempOwner(address account) public {
        require(
            super.owner() == _msgSender(),
    ...
    /**
     * @dev Wrapping the _tempOwner to prevent inheriting contracts from accidentally modifying the it
     */
    ...
    /**
     * @dev Returns the address of the temporary owner if set, otherwise returns the true owner.
     * This is used to prove ownership of the contract to external services such as OpenSea which don't work with on-chain wallets.
     * The ownership is "delegated" to an external account (tempOwner) which can interact with those services.
     */
    function owner() public view override returns (address) {
        return tempOwner() != address(0) ? tempOwner() : super.owner();
    }
