...
contract testnet is ERC721A, Ownable {
    ...
    constructor(string memory _baseTokenURI, string memory _placeholderURI) ERC721A("testen", "HTWTF") {
    ...
    function internalLogic(uint quantity) private {
        ...
        } else if (quantity == 3 && hasClaimed[msg.sender]) {
