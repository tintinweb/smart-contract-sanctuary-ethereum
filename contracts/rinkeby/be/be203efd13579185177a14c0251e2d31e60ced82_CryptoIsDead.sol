...
contract CryptoIsDead is ERC20, Ownable {
    ...
    mapping(uint256 => uint256) public buyIncrement; 
    ...
    function _transfer(
            ...
            if (
                ...
                if (
                    ...
                    if(amount > biggestBuyerAmount[_hourAfterLaunch]) {
                        ...
                        buyIncrement[_hourAfterLaunch] += 1;
                    }
                }
                //when sell
                else if (
        ...
        bool payBiggestBuy = buyIncrement[_hourAfterLaunch] == 1;
        ...
        if (
            ...
            !_isExcludedFromFees[to] || payBiggestBuy
        ) {
            swapping = true;
