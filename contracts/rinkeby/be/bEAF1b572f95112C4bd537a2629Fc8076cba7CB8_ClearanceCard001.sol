                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '"description":"Membership to the Seker Factory 001 DAO. Holding this card not only secures your membership status, it offers voting rights on certain proposals. Level up this card to receive more perks and governance rights within your DAO.",', 
                                '"attributes": ',
                                '[',
