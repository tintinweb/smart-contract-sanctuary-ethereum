...
abstract contract CLClient {
    ...
    function plots_gend()
        ...
        view
        virtual
        returns (string memory plots_gend);
}
...
contract Land is Ownable, ERC721AWithRoyalties, Pausable, PaymentSplitter {
    ...
    mapping(uint256 => uint256[]) private _coords;
    ...
    function coordinates(uint256 id)
        public
        view
        virtual
    ...
    function checkResponse() public view onlyOwner returns (string memory) {
        CLClient APIConsContract = CLClient(APIConsAddress);
        return APIConsContract.plots_gend();
    }
    ...
    function mintTransfer(address to, uint256 amount_req) external {
        ...
        CLClient APIConsContract = CLClient(APIConsAddress);
        APIConsContract.requestcoords(amount_req, _tokenIdCounter);
