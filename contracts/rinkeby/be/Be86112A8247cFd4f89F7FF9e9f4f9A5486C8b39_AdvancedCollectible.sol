...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    event typeAssigned(uint256 indexed tokenId, Type pmtype);
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        Type rdType = Type(randomNumber % 3);
        uint256 newTokenId = tokenCounter;
        tokenIdToType[newTokenId] = rdType;
        emit typeAssigned(newTokenId, rdType);
