...
contract OnChainNFT is ERC721, VRFConsumerBase {
  ...
  mapping(uint256 => uint256) internal bodyColor;
  mapping(uint256 => uint256) internal earColor;
  mapping(uint256 => uint256) internal eyeColor;
