...
contract BearCartel is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public constant MAX_PUBLIC_SUPPLY = 3666;
    uint256 public constant MAX_SUPPLY = MAX_PRESALE_SUPPLY + MAX_PUBLIC_SUPPLY;
    uint256 public constant MAX_PRESALE_MINT_PER_WALLET = 3;
    uint256 public constant MAX_PUBLIC_MINT_PER_WALLET = 6;

    uint256 public constant PUBLIC_SALE_MINT_PRICE = 0.11 ether;
    uint256 public constant PRESALE_MINT_PRICE = 0.08 ether;

    mapping(address => uint256) presaleMintTracker;
    mapping(address => uint256) publicSaleMintTracker;
    ...
    string private _metadataUrl =
        "https://faw101ot59.execute-api.us-east-1.amazonaws.com/dev/tokens/";
        ...
        callerIsSender
    {
        ...
        require(
            presaleMintTracker[msg.sender] + amount <=
                MAX_PRESALE_MINT_PER_WALLET,
            "AMOUNT_EXCEEDS_MAX"
        );
        ...
        callerIsSender
    {
        ...
        require(amount > 0, "MINIMUM_MINT_NOT_REACHED");
        require(
            publicSaleMintTracker[msg.sender] + amount <=
