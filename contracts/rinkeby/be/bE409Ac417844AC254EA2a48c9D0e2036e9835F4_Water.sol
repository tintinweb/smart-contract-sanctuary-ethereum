...
contract Water is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Water", "hydrate") {
        setBaseURI(baseURI);
    ...
    function reserveNFTs(uint numTokens) public onlyOwner {
        ...
        require(tokensMinted.add(numTokens) - 1 <= supply, "exceeds supply");
    ...
    function mintWhitelist() public {
        ...
        uint tokensMinted = _tokenIds.current();
        require(tokensMinted.add(1) - 1 <= supply, "exceeds supply");
        
        _mintToken();
        mintedWallets[msg.sender] = true;
    }

    function mintReserveList() public {
