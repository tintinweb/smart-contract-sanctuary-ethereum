...
contract DESPERATEopensea is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Royalty, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    string private _contractURI;
    uint256 public burned;

    constructor(string memory contractURI_, uint96 feeNumerator) ERC721("DoesItWork?0.8.7opti", "Works?") {
...
// --- minting
    ...
    function safeMint(address recipient, string memory tokenURI_) public onlyOwner {
    ...
    /// @notice Mint several tokens at once
    /// @dev Caller needs to be contract owner
    /// @param recipient is recipient of all tokens
    /// @param tokenURIs an array of uris for each token
    ...
    function totalSupply()
        ...
        returns (uint256)
    {
        return _tokenIdCounter.current() - burned;
    }
    ...
    function resetAllTokensRoyalties()
        external
        onlyOwner
    {
        for (uint256 i = 0; i < _tokenIdCounter.current(); i++) {
            _resetTokenRoyalty(i);
        }
    }
