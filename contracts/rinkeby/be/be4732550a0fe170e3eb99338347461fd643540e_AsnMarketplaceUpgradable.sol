    ...
    EIP712Upgradeable
{
    ...
    function verifySignature(bytes memory signature)
        ...
        returns (address)
    {
        bytes32 digest =_hashBidWithCryptoData(
                    msg.sender,
                    10,
                    1,
                    1
    ...
    bytes32 private constant BID_WITH_CRYPTO_TYPEHASH =
        keccak256(
            "bid(address bidder,uint256 collectableId,uint256 amount,uint nounce)"
        );
