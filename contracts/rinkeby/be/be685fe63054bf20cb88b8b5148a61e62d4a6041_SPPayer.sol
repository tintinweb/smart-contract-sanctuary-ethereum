...
contract SPPayer is ISPPayer {
  ...
  function pay(uint256 _projectId, address _token, uint256 _amount) external override {
    SPProjectMetadata memory meta = projects.getMetadataOf(_projectId);
    uint256 mintTokenAmount = _amount / meta.tokenPrice;
    ...
    store.mintFor(msg.sender, _projectId, mintTokenAmount, false);
  }
