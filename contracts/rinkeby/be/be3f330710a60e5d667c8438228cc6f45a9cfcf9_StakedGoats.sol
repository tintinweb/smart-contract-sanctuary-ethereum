...
contract StakedGoats is Delegated, ERC721EnumerableLite {
    ...
    string private _tokenURIPrefix = "https://goatgauds.s3.us-west-1.amazonaws.com/metadata/staked/";
    string private _tokenURISuffix = ".json";

    // Goat Gauds NFT Contract Address
    address contractGoatGauds = 0x5CEbE5Cde01aB154fB46B7984D6354DA367bCBaF;
    // GG Flowers Token Contract Address
    address contractFlowers = 0x0750e1738F56F81791f0E124d6922fEfe037daE8;
    ...
    event Migrated(uint256[] tokens, address[] owners);
    ...
    function migrate(uint[] memory tokenIds_, address[] memory addresses_) public onlyOwner {
        ...
        for (uint256 i = 0; i < tokenIds_.length; i++) {
            ...
            _mint(addresses_[i], _mintId++);
        }
        stakedTotal = stakedTotal + tokenIds_.length;
        emit Migrated(tokenIds_, addresses_);
    }
