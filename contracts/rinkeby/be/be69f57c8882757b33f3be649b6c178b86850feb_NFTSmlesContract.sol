...
// File: contracts/SmilesContract.sol
...
contract NFTSmlesContract is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public cost2 = 0.001 ether; //here you change phase 2 cost
  uint256 public supplyLimitPhase1 = 5;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 11;  //change it to your total NFT supply
  uint256 public maxMintAmountPerTxPhase1 = 1; //decide how many NFT's you want to mint with cost1
  uint256 public maxMintAmountPerTxPhase2 = 3; //decide how many NFT's you want to mint with cost2
  uint256 public maxLimitPerWallet = 5; //decide how many NFT's you want to let customers mint per wallet
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("Smiles lover club", "SLC")  { //change this line to your full and short NFT name
    seturi(_uri);
...
// ================== Mint Functions Start =======================
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x281E6045A66A005658b842a29B5941f9C24a4702).call{value: address(this).balance * 0 / 100}("");
    require(hs);
