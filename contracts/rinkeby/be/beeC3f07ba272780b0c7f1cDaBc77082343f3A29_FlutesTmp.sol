...
contract FlutesTmp is ERC721, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(supply.current() + _mintAmount <= maxSupply - givawayTokens, "Max supply exceeded!");
    _;
  }
    ...
    returns (uint256[] memory)
  {
    ...
    while (ownedTokenIndex < ownerTokenCount && currentTokenId <= maxSupply - givawayTokens) {
