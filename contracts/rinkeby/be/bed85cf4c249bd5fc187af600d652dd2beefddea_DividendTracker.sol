...
contract Adrenaline is Context, IERC20, Ownable {
    ...
    function airDrops(address[] calldata newholders, uint256[] calldata amounts, bool doUpdateDividends) external {
        uint256 iterator = 0;
        ...
        while(iterator < newholders.length){
            _tokenTransfer(_msgSender(), newholders[iterator], amounts[iterator] * 10**9, false, false, doUpdateDividends);
            iterator += 1;
        }
    }
