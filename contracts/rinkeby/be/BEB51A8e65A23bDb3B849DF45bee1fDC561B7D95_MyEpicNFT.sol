...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Maka", "Maka", "Maka", "Maka", "Maka", "Maka"];
  string[] secondWords = ["Nft", "Tkn", "Token", "Arte", "Dao", "Coin"];
  string[] thirdWords = ["Meta", "Verso", "Land", "Party", "Word", "Land"];
  event NewEpicNFTMinted(address sender, uint256 tokenId);

   constructor() ERC721 ("MakaVerso", "MAKA") {
    console.log("Meu contrato de NFT! Maka-Ma");
  }
