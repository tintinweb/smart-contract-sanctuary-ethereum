...
contract ccc is Ownable, ERC721A, ReentrancyGuard {
  ...
  function allowlistMint() external payable callerIsUser {
    ...
    require(allowListStartTime <= block.timestamp && allowListStartTime!=0,"not opened yet");
    require(allowListOvertTime > block.timestamp,"it is over");
    ...
    callerIsUser
  {
    ...
    uint256 forPublic = collectionSize - 300;
    require(totalSupply() + quantity <= forPublic, "reached max supply");
