    ...
    VRFConsumerBaseV2
{
    ...
    */
    function mintToken() public onlyOwner returns (uint256) {
        ...
        emit tokenIdRandomRequest(requestId, tokenCounter.current());

        return tokenCounter.current();
    }

    function revealTokenId(uint256 tokenId) internal {
        require(
    ...
    function getRandomWords() internal returns (uint256) {
