...
// File: contracts/TASContract.sol
...
pragma solidity >=0.7.0 <0.9.0;
  ...
  contract TimepieceApeSociety is ERC721, Ownable {
  using Strings for uint256;
  ...
  ) ERC721("Timepiece Ape Society", "TAS") {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            require(ownerTokenCount + _mintAmount <= nftPerAddressLimitWL, "max Whitelist Mint exceeded");
        }
  ...
  function setNftPerAddressLimit(uint256 _limit) public onlyOwner {
    ...
    function setWLlimit(uint256 _limit) public onlyOwner {
