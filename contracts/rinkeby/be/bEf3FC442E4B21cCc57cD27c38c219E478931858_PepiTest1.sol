...
contract PepiTest1 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("PepiTest1", "Pepi"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Pepi");
    require(mintEnabled, "Minting is not live yet, hold your cannoli's.");
