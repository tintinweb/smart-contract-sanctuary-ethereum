...
// File contracts/token/WhitelistRoleUpgradeable.sol
...
contract WhitelistRoleUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable {
...
contract Token is Initializable, OwnableUpgradeable, ERC20Upgradeable, ERC20CappedUpgradeable, ERC20BurnableUpgradeable, WhitelistRoleUpgradeable {
	uint256 private _cap; // Maximum supply
	uint8 _decimals;

	function __Token_init(string memory name_, string memory symbol_, uint8 decimals_, uint256 cap_) public initializer {
		_cap = cap_;
		_decimals = decimals_;
