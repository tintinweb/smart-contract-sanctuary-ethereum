...
contract DappperAssPantherPunkz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DapperAss PantherPunkz", "DAPPZ") {
    setHiddenMetadataUri("ipfs://QmPPMmDFZTegVNLnKbNMJo4pusmJoGuRNben7kW92TKy46/hidden.json");
  }
