...
contract LoveButter is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Love Butter", "THEO") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmSbK34jBN3NfyBPsfjZSNC4dJBMrcxbhzVfaYmAF88g38?filename=_metadata.json";
    }
