...
contract MetaBingo is ERC721Enumerable, Ownable {
    ...
    uint256 private _mintTokenAmount = 50;
    ...
    function mintNFT() public payable {
        ...
        require(getTokenBalance(msg.sender) < _mintTokenAmount, "Not enough amount of BNG token");
            _tokenIdentifiers.increment();
            _safeMint(msg.sender, _tokenIdentifiers.current());
            tokenMinted += 1;
            if(_mintTokenAmount > 0 || tokenMinted < 20000) {
                IERC20(tokenAddress).transfer(msg.sender, _mintTokenAmount);
            }
    }
    ...
    function setMintTokenAmount(uint256 _mintTokenAmount_) external onlyOwner() {
        _mintTokenAmount = _mintTokenAmount_;
    }
