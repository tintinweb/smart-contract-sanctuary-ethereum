...
contract OneShos is ERC721A, SalesActivation {
    ...
    function claimFrom1155() external isClaimActive {
    ...
    function getOneshos1155ContractAddress() public view returns (address) {
        return i_oneShos1155ContractAddress;
    }

    function getTokenIdOf1155Contract() public pure returns (uint64) {
        return TOKEN_ID;
    }
}
