...
contract Revan is Context, IERC20, Ownable {
    ...
    address payable private mainWallet = payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    ...
    uint256 private _tTotal = 69369369369369* 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ApeKingCaeser";
    string private _symbol = "APEKC";
    ...
    function initContract() external onlyOwner() {
        ...
        mainWallet = payable(0x6631e84a6EF90c2D3EcEC262d62761B07Bf048bb);
    }
