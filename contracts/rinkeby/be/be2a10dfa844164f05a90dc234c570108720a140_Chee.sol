...
contract Chee is ERC721F {
    ...
    uint public constant MAX_PURCHASE = 5; // set 1 to high to avoid some gas
    ...
    constructor() ERC721F("Chee", "CHEE") {
        setBaseTokenURI("ipfs://QmcAecZ3q6hq9CbgenY2E1HXcxUZaZLx8AH7Z2hB7sSKqp/"); 
        _safeMint(SIMON, 0);
    }
    ...
    function mint(uint256 numberOfTokens) external payable{
        ...
        require(amount[msg.sender]+numberOfTokens<5,"Purchase would exceed max mint for walet");
