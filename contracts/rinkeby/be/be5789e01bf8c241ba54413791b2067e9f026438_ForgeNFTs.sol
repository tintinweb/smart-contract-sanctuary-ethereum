...
contract ForgeNFTs is ERC1155 {
    ...
    mapping (address => bool) public allowed_to_mint_directly;
    
    constructor() ERC1155("https://ipfs.io/ipfs/Qmf26APXuuGWee6GYJLvkJ4ZDsASdb7DQtqrysY6jEQ5z5/{id}") {
        _owner = msg.sender;
        allowed_to_mint_directly[msg.sender] = true;
    }

    modifier authorizedAddressesOnly {
      require(allowed_to_mint_directly[msg.sender] == true, "ForgeNFTs: Unauthorized address.");
      _;
    }

    function allowToMintDirectly(address user) public {
        require(msg.sender == _owner, "ForgeNFTs: Unauthorized address.");
        allowed_to_mint_directly[user] = true;
    }
