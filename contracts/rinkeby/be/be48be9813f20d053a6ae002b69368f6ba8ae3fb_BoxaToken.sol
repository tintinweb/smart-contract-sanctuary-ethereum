...
contract BoxaToken is Context, IERC20, Ownable {
    ...
    address payable public rewardAddress = payable(0x000000000000000000000000000000000000dEaD); // Burnn Address
    address payable public liquidityAddress = payable(0x5b5fcD594Af6758844d8aFD1126a2E678Ef89223); // Liquidity Address, owner address
