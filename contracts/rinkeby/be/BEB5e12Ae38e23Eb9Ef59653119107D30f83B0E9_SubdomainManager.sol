...
contract SubdomainManager is  IManager, IERC721Receiver, Ownable, ERC165, ERC721, IERC2981, ENSEnumerable {
    ...
    function registerSubdomain(uint256 _id, string memory _label) payable public {
        ...
        if (msg.sender != TokenOwnerMap[_id]){
            require(msg.value == MintCost[_id], "incorrect ether");
            require(MintCost[_id] != 0, "not for primary sale");
        }
...
abstract contract ENSEnumerable  {
    ...
    function tokenByIndex(uint256 index) public view virtual returns (uint256) {
        require(index < totalTLDCount(), "ERC721Enumerable: global index out of bounds");
