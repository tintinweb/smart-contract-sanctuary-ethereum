...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNnzd6CvscVJz5uuBd87bKE8mE7FRgeysA5NGQ1HJoLAj/";
...
// File: contracts/StrangesnakeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract StrangesnakeContract is RamppERC721A {
    constructor() RamppERC721A("strange snake", "SNAKE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SLxz8H73NhriE2hIZ3IW/contract-metadata";
    }
}
