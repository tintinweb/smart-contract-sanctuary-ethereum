 ...
 * 
 */
contract SMB is ERC721F {
    using SafeMath for uint256;
    using Strings for uint256;

    address private constant SIMON = 0xD37B441828Af470746b06E5500a6fbd6b92ffeAb;

    uint256 public tokenPrice = 0.025 ether;
    uint256 public constant MAX_TOKENS = 1000;


    constructor() ERC721F("Safemoon Birds", "SMB") {
        setBaseTokenURI(
            "ipfs://QmVVRKdS6TsA4ejE2mcHm183tK4jzMxaYhDSkj5Cyc294e/"
        );
         _safeMint(SIMON, 0);
    }
   ...
   function mint(uint256 numberOfTokens) external payable{
    ...
    function withdraw() public onlyOwner {
        ...
        _withdraw(SIMON, address(this).balance); //Simon
    }
}
