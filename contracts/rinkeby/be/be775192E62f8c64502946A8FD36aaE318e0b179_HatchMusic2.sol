  ...
  function createTrackInternal(
    ...
    string[] memory _artistsNames
      ...
      for (uint256 i = 0; i < _trackNames.length; ++i) {
        ...
        track[currentTrackId].artistsWallets = _artistsWallets; 
        track[currentTrackId].artistsShares = _artistsShares; 
        track[currentTrackId].artistsNames = _artistsNames; 
