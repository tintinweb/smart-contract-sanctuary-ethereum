...
import "./OwnSpotradeUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new SpotradeUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        SpotradeUser721Token token = SpotradeUser721Token(address(addr));
...
contract SpotradeUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
