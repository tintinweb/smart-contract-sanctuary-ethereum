...
contract DespairCitySoldiers is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("Despair City Soldiers", "DSC") {}
    
    uint256 public collectionSize = 499;
    ...
    uint256 public publicPrice = 0.0007000 ether;
    uint256 public amountForPublicSale = 499;
