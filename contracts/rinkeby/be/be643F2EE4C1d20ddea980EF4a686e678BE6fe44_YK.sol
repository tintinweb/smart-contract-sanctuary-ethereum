...
contract YK is ERC721A, Ownable, ReentrancyGuard {
    ...
    bytes32 public whitelistMerkleRoot =
        0x7777269bca4c16a4fd58332f87d33ece7e8b4c19545459d172d31a37f5b0db1a;
    ...
    uint256 public immutable publicSaleStartTime = 1662103800; // 2022-09-02 15:30:00 GMT+8
    uint256 public immutable publicSaleEndTime = 1662120000; // 2022-09-02 20:00:00 GMT+8
    ...
    uint256 public lastPublicSoldTime = 1662017400;
    ...
    function getMaxSupply() public view virtual returns (uint256) {
        ...
        if (block.timestamp < publicSaleStartTime) {
            ...
            uint256 supply = MAX_SUPPLY - ((interval / 300) * 5);
            if (supply < ts) {
                return ts;
            } else {
                return supply;
