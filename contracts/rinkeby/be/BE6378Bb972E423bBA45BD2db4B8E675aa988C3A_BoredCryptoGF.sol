...
contract BoredCryptoGF is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("BoredCrytoGF", "BoredCrytoGF", maxBatchSize_, collectionSize_) {
  ...
  function startAllowlistMint(uint64 allowlistPriceWei) external onlyOwner{
    saleConfig.allowlistPrice = allowlistPriceWei;
    state = "Allowlist Minting";
  }

  function endAllowlistMintAndStartPublicMint(
