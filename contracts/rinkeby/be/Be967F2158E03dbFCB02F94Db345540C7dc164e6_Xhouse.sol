...
contract Xhouse is ERC721Enumerable, Ownable {
    ...
    function resumeAuction() public onlyOwner {
        pausedTime = pausedTime + block.timestamp - currentTime;
        mintStarted = true;
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        currentPrice =
            5 ether -
            (0.1 ether * (block.timestamp - initialTime - pausedTime)) /
            7200;
        if (currentPrice < 1.5 ether) currentPrice = 1.5 ether;
