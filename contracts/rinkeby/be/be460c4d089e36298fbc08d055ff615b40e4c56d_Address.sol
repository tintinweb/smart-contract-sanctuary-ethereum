...
// SPDX-License-Identifier: MIT
      ...
      Developed by Meraj, Blochain Developers @ www.blokedia.io
       
       ** Flattened file, Containing all extensions.
       ** Contract "Candle Defenders" starts at line 1260.
...
*/     
    ...
    pragma solidity ^0.8.0;
        ...
        contract Candle_Defenders is ERC721A, Ownable {
            using Strings for uint256;

        // Name and Symbol are not Modifiable once deployed.
            constructor() ERC721A("Candle Defenders", "CD") {}

        //max supply
            uint16 public constant maxSupply = 10000;

        //BaseUri and Hidden MetaData URI are Modifiable, If required.
            string public baseURI = "ipfs://QmPgdWXP5HcZ62qXxUSGrXZVxxEKLrxmvCSQfVQACHj6Di/";
        ...
        //Only whitelisted users can mint if WLPaused is set to False.
            function WL_mint(uint256 _mintAmount) public payable {
                ...
                require (CheckWhitelist(msg.sender), "User is not Whitelisted"); 
                   uint256 Maxmint = _mintAmount + balanceOf(msg.sender);
                require(Maxmint <= MaxMintWL, "Mint Amount is greater than Max mint Amount");
                   uint256 supply = totalSupply();
                require(_mintAmount > 0, "Mint amount must be greater than 0");
                require(supply + _mintAmount <= maxSupply, "Mint amount is greaater than available tokens");
        ...
        // to Owner Mint tokens
          ...
          //to Check whether an Address is whitelisted
        ...
        //To Set Max Mints
            function setMaxMintPublic(uint8 _MaxMintPublic) public onlyOwner {
                MaxMintPublic = _MaxMintPublic;
            }
            

            function setMaxMintWL(uint8 _MaxMintWL) public onlyOwner {
