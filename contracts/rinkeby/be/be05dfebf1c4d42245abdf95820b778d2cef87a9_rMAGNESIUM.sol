...
contract AncientDevice is ERC721Enumerable, OwnableWithAdmin, Pausable {
  ...
  uint constant YIELD_END_TIME = 1647727200; // rinkeby: March 19, 2022, 6pm ET ... TODO : delete for mainnet
  ...
  function claimDevices(uint256 _amount, bytes32[] calldata _merkleProof, uint256 _allowance) external whenNotPaused {
    ...
    require(_verify(_merkleProof, _leaf(Strings.toString(_allowance), payload)), "Invalid Merkle Tree proof supplied.");
