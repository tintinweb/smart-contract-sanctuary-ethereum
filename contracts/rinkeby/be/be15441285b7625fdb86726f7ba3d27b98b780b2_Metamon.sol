...
contract Metamon is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Metamongo", "Mtmng") {
    //   setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmTA9qktmuq7B7yK9Z2Q9rqWKJu7HzA4Kp6SVoPipBMQBk");
  }
  ...
  function mintForSelf(uint256 _mintAmount) public selfMintCompliance(_mintAmount) onlyOwner {
    ...
    // new_WhitelistMint
    function PresaleMinted(bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
