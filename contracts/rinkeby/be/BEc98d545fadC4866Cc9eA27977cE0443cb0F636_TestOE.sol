...
contract TestOE is AdminControl, ICreatorExtensionTokenURI, ReentrancyGuard {
  ...
  constructor(address creator) {
    _active = false;
    _creator = creator;
    _uriParts.push('data:application/json;utf8,{"name":"IAM ROBOT #');
    _uriParts.push('<EDITION>');
    _uriParts.push('/');
    _uriParts.push('<TOTAL>');
    _uriParts.push('", "created_by":"j", ');
    _uriParts.push('"description":"Minted with Manifold", ');
    _uriParts.push('"image":"https://google.com","image_url":"https://google.com","image_details":{"sha256":"12e99eba9513e99fad7d464b19951d0a8b124f130907cdf03ce629c42e6546a7","bytes":6136532,"width":2120,"height":2400,"format":"JPEG"},');
    _uriParts.push('"animation":"https://google.com","animation_url":"https://google.com","animation_details":{"sha256":"0c5cec4676132dfce1cd17de334175598b0ea3befbe929e348325111acc87d62","bytes":103275550,"width":1808,"height":2048,"duration":30,"format":"MP4","codecs":["H.264","AAC"]},');
