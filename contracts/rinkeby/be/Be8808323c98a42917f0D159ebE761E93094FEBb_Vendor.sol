...
contract Vendor is Ownable {
    ...
    // 100 tokens for 1000000000000000000 wei
    // 60 tokens for  600000000000000000 wei
    // 1 tokens for  10000000000000000 wei

    // 100 tokens for 1 ether
    // 60 tokens  for 0.6 ether
    ...
    function buyTokens() public payable {
        ...
        // uint256 tokens = msg.value / 10000000000000000 wei;
    ...
    function sellTokens(uint256 _amount) public payable {
        ...
        require(userBalance >= _amount, "Insufficient token amount");

        uint256 amountOfEthToTransfer = _amount / tokensPerEth;
        uint256 ownerETHBalance = address(this).balance;

        console.log("VALUE ETHER to transfer: ", amountOfEthToTransfer);
        console.log("VALUE ETHER owner has: ", ownerETHBalance);
        ...
        require(sent, "Failed to send tokens from user to vendor");

        (sent, ) = msg.sender.call{value: amountOfEthToTransfer}("");
        require(sent, "Failed to send Ether from vendor to user");
