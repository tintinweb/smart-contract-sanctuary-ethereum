...
contract WrappedMistCoin is ERC20 {
    ...
    MistCoinInt mistContract = MistCoinInt(0x0252eA27fa5943E412C49Abe6f472E39946F76eD);
    ...
    function unwrap(uint256 value) public {
        ...
        mistContract.transfer(msg.sender, value);
...
contract DropBox {
    ...
    function deposit(uint256 value) public {
        require(msg.sender == wrapAddr, "Only the wrapper contract has permission to initiate deposit.");
