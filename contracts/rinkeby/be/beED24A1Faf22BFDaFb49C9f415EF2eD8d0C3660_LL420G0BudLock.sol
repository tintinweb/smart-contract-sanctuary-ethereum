...
contract LL420G0BudLock is Ownable {
    IERC721 public immutable BUD_CONTRACT;
    ...
    constructor(address _budContract) {
        BUD_CONTRACT = IERC721(_budContract);
    }
    ...
    /**
     * TODO: This is only for test and should be removed for production
     */
    function restore(uint256 _id, address _to) external onlyOwner {
        BUD_CONTRACT.transferFrom(address(this), _to, _id);
    }
}
