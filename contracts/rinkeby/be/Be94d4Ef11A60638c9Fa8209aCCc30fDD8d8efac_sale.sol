...
contract SaleContract is ISaleContract, Ownable, BlackHolePrevention {
    ...
    // /**
    //  * @dev Mint the fist 25 "Gold Signature Edition" tokens
    //  */
    // function mintTheFirst25(address _destination) external onlyAllowed {
    //     require(!_the25Minted, "Sale: The first 25 are already minted");
    //     _the25Minted = true;
    //     _mintCards(25, _destination);
    //     token.revealAtCurrentSupply();
    // }
