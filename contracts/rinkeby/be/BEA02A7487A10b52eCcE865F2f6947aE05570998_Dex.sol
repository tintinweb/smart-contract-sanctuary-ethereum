...
contract Dex is Ownable {
  ...
  /**
   * @dev Amount of TTD that you can buy with 1 ETH.
   * @notice Since TTD has 2 decimal precision, let's
   * define 0.01 TTD = 1 wTTD (smallest TTD unit).
   * Then, if "10_000 wei gets you 1 TTD", it follows
   * that 1 ETH = 1*(10**18) wei gets you 1*(10**14) TTD
   * which is equivalent to 1*(10**16) wTTD.
   */
  uint256 public constant BUY_RATE = 10**16; // in wTTD
  /**
   * @dev Amount of ETH that you get when selling 1 TTD.
   * @notice We follow the "1 TTD gets you 5000 wei" rule.
   */
  ...
  /**
   * @dev Return ETH balance for the `Dex` contract.
   */
  ...
  /**
   * @dev User deposits ETH getting TTD back using
   * "10_000 wei gets you 1 TTD" as the exchange rate.
   */
  function buy() external payable {
    // Amount of TTD (wTTD) to be sent to the buyer.
  ...
  /**
   * @dev User deposits TTD getting ETH back using
   * "1 TTD gets you 5000 wei" as the exchange rate.
   * @notice Before selling the transfer must
   * be approved in the TTD contract.
   * @param _ttdIn The amount of wTTD tokens to be
   * exchanged.
   */
...
contract TestTokenDex is ERC20 {
  uint256 private constant SUPPLY = 500_000_000_000_000  * (10**2);
