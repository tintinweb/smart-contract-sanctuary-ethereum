...
contract BountySports is ERC721Enumerable, Ownable {
    ...
    address bounty = 0xb00b16A2Ecc169B15383f4985c090d0fB8d2cab0;
    ...
    function mintWhitelist(address _to, uint256 _mintAmount) external payable{    
    require(_mintAmount > 0, "Duh!" );
    require((publicDate <= block.timestamp),"DATE");
    uint256 totalSupply = _owners.length;
    require(totalSupply + _mintAmount < maxSupply + 1, "Sorry" );
    ...
    mintPasses[msg.sender] = reserve - _mintAmount;
    delete totalSupply;
    delete reserve;
    }
    //only owner
