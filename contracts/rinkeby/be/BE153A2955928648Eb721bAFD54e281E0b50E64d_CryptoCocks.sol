...
library CryptoCocksLib {
    function getCid(uint id) external pure returns (string memory cid) {
        ...
        if (id <= 2000) {
            batch = "bafybeifmurkv3chzceucomi2pdxbclspcfqutbkebr4wd25vkjakmmdnli"; // TODO MF: Revert!
        } else if (id <= 4000) {
            batch = "bafybeicbksys46bartzshjmibpihhnajdi7z4swvvh26yvpgugsuhtbvse";
        } else if (id <= 6000) {
            batch = "bafybeickjduywrpbxkssnkodlx44m6y2q7vzyvubqifu66fxtllfs52yfu";
        } else if (id <= 8000) {
            batch = "bafybeia2pcyz6t2rdy2ada6dws5lgaujeth3kblqg7asmkhivb6eaphza4";
        } else {
            batch = "bafybeiavieytoibx7lo7dmb6xygwyx64yraa6whcqvawz4433l7infrgkm";
        }
