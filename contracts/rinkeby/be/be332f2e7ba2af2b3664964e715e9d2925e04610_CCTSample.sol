...
contract CCTSample is ERC721, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public publicSaleDate = 1648749600;  // Timestamp of public sale start date
    ...
    address public communityFundAddress = 0x682af4ca65182d943a36De953586F92d436eC593;    // The Community Fund address
    ...
    uint16 public preSaleTokenLimit = 7000;    // Max amount of tokens available for mint at the pre sale
    uint8 constant public preSaleLimitPerUserVipPl = 5;  // Max amount of tokens available for mint at the pre sale per address
    uint8 constant public preSaleLimitPerUserPl = 20;  // Max amount of tokens available for mint at the pre sale per address
    uint8 public amountForGiveAway = 150;  // Amount of tokens reserved for give away
    uint8 public publicSaleLimitPerTx = 20;    // Max amount of tokens available for mint at the public sale per transaction
    ...
    bytes32 public _merkleRootVipPl = 0x1d3968f26bb465d98c0a2a1eede054542b2cb95aefbf95d8543d53c54064b202;
    bytes32 public _merkleRootPl = 0x1d3968f26bb465d98c0a2a1eede054542b2cb95aefbf95d8543d53c54064b202;
    string public _prerevealUri = "ipfs://QmPTjiinfMieRH5SSHYVyTETpoHZnU1S6DA5864jKUbD7j/";

    
    /*
    * @param _name The name of the NFT
    * @param _symbol The symbol of the NFT
    * @param _merkleRootVipPl Merkle root for the VIP Pinklist
    * @param _merkleRootPl Merkle root for the pinklist
    * @param _publicSaleDate Timestamp of the public sale stage date
    * @param _communityFundAddress The Community Fund address
    * @param _prerevealUri The NFT ipfs data uri
    */
    constructor (
        string memory _name, 
    ...
    */
    function distributeFunds(uint256 _amountToCommunityFund) external onlyOwner {
    ...
    */
    function _preSaleMintVipPl(uint256 _amount) private {
        ...
        _buyAndRefund(totalSupply_, _amount, preSaleVipPlPrice);
    ...
    */
    function _preSaleMintPl(uint256 _amount) private {
        ...
        uint256 totalSupply_ = totalSupply;
        require(totalSupply_ + _amount <= preSaleTokenLimit, "presale token limit exceeded");
        _buyAndRefund(totalSupply_, _amount, preSalePlPrice);
    ...
    */
    function _verifyVipPL(bytes32 _leaf, bytes32[] memory _proof)
    internal view returns (bool)
    {
        return MerkleProof.verify(_proof, merkleRootVipPl, _leaf);
    }
    ...
    * @param _proof Proof for the user
    */
    function _verifyPL(bytes32 _leaf, bytes32[] memory _proof)
    internal view returns (bool)
    {
        return MerkleProof.verify(_proof, merkleRootPl, _leaf);
    }
