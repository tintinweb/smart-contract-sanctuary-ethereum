...
//       $$ |  $$ |\$$$ |$$ |  $$ |   $$ |$$   ____| \____$$\   $$ |$$\     
//     $$$$$$\ $$ | \$$ |\$$$$$$  |   $$ |\$$$$$$$\ $$$$$$$  |  \$$$$  |    
//     \______|\__|  \__| \______/    \__| \_______|\_______/    \____/    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB4EeF5D44Dffe7CA886a07ec08774C208B93Db00];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXG7zNy9TK7QgYzVGGsZd8S5QHQtvTRQdUaUCZYodiUtK/";
...
// File: contracts/InuTest2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InuTest2Contract is RamppERC721A {
    constructor() RamppERC721A("INUTest2", "2INUT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ZUhszdHzBrkWdDnK3eVS/contract-metadata";
    }
}
