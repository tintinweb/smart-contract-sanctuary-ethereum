...
contract USDPImplementationV3 {
    ...
    string public constant name = "UDPN-USDP"; // solium-disable-line
    string public constant symbol = "pUDPN"; // solium-disable-line uppercase
