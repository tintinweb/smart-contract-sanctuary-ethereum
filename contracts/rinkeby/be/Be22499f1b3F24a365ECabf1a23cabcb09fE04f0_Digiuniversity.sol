...
contract Digiuniversity is Ownable, ERC721A {
  string public baseURI = 'ipfs://bafybeibhdphece6hrcx6pdmjhhattofhdyfimk57oau22rk5ti2ixcju6m/';

  bool public isMintOpen = false;

  uint256 public immutable unitPrice = 0.002 ether;

  uint256 public immutable maxSupply = 3022;

  uint256 public immutable maxWalletSupply = 20;

  uint256 public immutable maxWalletFreeSupply = 2;

  constructor() ERC721A('Digiuniversity', 'DUV') {
    _mint(msg.sender, 1);
  }
