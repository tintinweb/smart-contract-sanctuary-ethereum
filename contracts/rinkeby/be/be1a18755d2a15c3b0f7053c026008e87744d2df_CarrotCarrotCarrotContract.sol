...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 1828 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmR6x1sBrfAocJCmXGwHfn1u3RJ1CndasCRd2QsCcGW8aU/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1828");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1828");
...
// File: contracts/CarrotCarrotCarrotContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CarrotCarrotCarrotContract is RamppERC721A {
    constructor() RamppERC721A("CarrotCarrotCarrot", "CARROT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5hd9UlW0dRaXT3NdS5HQ/contract-metadata";
    }
}