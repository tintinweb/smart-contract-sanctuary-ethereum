...
import "../erc-721/ERC721MarketToken.sol";
 ...
 *
 */
contract ERC721MarketTokenFactoryC2 is Ownable {
    address public beacon;
    address transferProxy;
    address lazyTransferProxy;

    event Create721MarketTokenProxy(address proxy);
    event Create721MarketUserProxy(address proxy);
    ...
    function createToken(
        ...
        ERC721MarketToken token = ERC721MarketToken(address(beaconProxy));
        token.transferOwnership(_msgSender());
        emit Create721MarketTokenProxy(beaconProxy);
    }
    ...
    function createTokenUser(
        ...
        ERC721MarketToken token = ERC721MarketToken(address(beaconProxy));
        token.transferOwnership(_msgSender());
        emit Create721MarketUserProxy(beaconProxy);
    }
    ...
    function getData(
        ...
        return
            abi.encodeWithSelector(
                ERC721MarketToken(address(0)).__ERC721MarketToken_init.selector,
                _name,
                _symbol,
                baseURI,
                contractURI,
    ...
    function getData(
        ...
        return
            abi.encodeWithSelector(
                ERC721MarketToken(address(0))
                    .__ERC721MarketTokenUser_init
                    .selector,
                _name,
                _symbol,
                baseURI,
