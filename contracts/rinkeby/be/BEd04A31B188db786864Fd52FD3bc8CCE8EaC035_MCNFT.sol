...
contract MCNFT is ERC721Psi, VRFConsumerBaseV2, ReentrancyGuard, EIP712Whitelisting, ERC2981ContractWideRoyalties {
    ...
    uint256 public privatePrice = 0.0008 ether; // 0.08 ether; mainnet
    uint256 public publicPrice = 0.00098 ether; // 0.098 ether; mainnet
    uint256 public airdropAmount = 200;
    uint256 public airdropMinted = 0;
    uint private maxMintPerAddress = 200; // 2; mainnet
    bool public randomseedRequested = false;
    bool public hasSaleStarted = false;

    //TODO: change on mainnnet
    ...
    // TODO update sha 256 on mainnet
