...
contract Secondary is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl{
  ...
  constructor(
  ...
  ) ERC721A("XXX", "xxx") {  // _tokenName, _tokenSymbol
    cost = 15;
    ...
    tokenIdPrice[1] = 10;
    approveMint[1][0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2] = true;
  }
  ...
  function getInput ( uint256 _mintAmount) public view returns(string memory) {
    string memory input = string (abi.encodePacked('"',Strings.toHexString(uint160(_msgSender()), 20), ':', Strings.toString(_mintAmount),'"'));
   return input;
  }
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount)  {
    ...
    // string memory input = string (abi.encodePacked('"',Strings.toHexString(uint160(_msgSender()), 20), ':', Strings.toString(_mintAmount),'"'));
    // console.log(input);
    bytes32 leaf = keccak256(abi.encodePacked("0x7b42818B8540F4854E3E96DBDe5cbDa7Dd707a61:1")); //_msgSender(), 
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount)  { //mintPriceCompliance(_mintAmount)   AllowMintPrice(_tokenId) AllowMintFor(_tokenId)
