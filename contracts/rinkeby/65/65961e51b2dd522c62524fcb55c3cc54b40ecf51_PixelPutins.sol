...
contract PaymentSplitter is Context {
    ...
    function release(address payable account) public virtual {
        ...
        uint256 totalReceived = address(account).balance + _totalReleased;
...
contract PixelPutins is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  // Withdrawal addresses
    address t1 = 0x165CD37b4C644C2921454429E7F9358d18A45e14;
    address t2 = 0x5d11C39e9147b21d9F76C1F977193e66FBa48826;
    address t3 = 0x637A546D4543d37FfC03642930Ff2Da8f410a994;

    address[] addressList = [t1, t2, t3];
    uint256[] shareList = [80, 10, 10];
  ...
  * Note: `cost` is in wei. 
  */
  constructor(string memory tokenName, string memory symbol, uint256 cost, uint256 supply) ERC721A(tokenName, symbol) Ownable() PaymentSplitter(addressList, shareList) {
    _mintCost = cost;
    _maxSupply = supply;
  ...
  */
  function mintTokensForOther(address[] calldata recipients)
  public
  payable
  nonReentrant{
