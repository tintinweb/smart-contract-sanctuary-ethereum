    ...
    KeeperCompatibleInterface
{
    ...
    bool public _isInitialState = true;
    ...
    function mint() external whenNotPaused {
        require(
            ...
            "The caller is not an externally owned account"
        );
        require(
            balanceOf(msg.sender) == 0,
            "The caller has already minted this NFT"
        );
    ...
    function _flipState() private {
        ...
        emit FlipState(_isInitialState);
    }
        ...
        returns (string memory)
    {
        ...
        return
            bytes(baseURI).length > 0 && _isInitialState
                ? string(abi.encodePacked(baseURI, "0"))
