...
contract Breezy is Ownable, ERC721A, ReentrancyGuard, PaymentSplitter {
    ...
    address public winterAddress2 = 0xE29A94bDDfEf3DE77cdFdF85481776071a2Edf95;
    // address public winterAddress3 = 0xe0CB05cBf3dBeb647394905848d9361Daa99dE28;
    ...
    function mintPreSaleCard(
        ...
        require(
            msg.sender == winterAddress || msg.sender == winterAddress2,
            "Not authorized"
        );
        // check proof & mint
