...
contract NftCollection is BaseCollection {
    ...
    //constants
    string public _collectionType = "standard";
    ...
    {
        require(_saleActive, "Minting is not active right now. Please, check back later.");
        _purchaseMint(numberOfTokens, _msgSender());
    }


    function _purchaseMint(uint256 numberOfTokens, address sender) internal {
        uint256 mintPrice = _price.mul(numberOfTokens);
