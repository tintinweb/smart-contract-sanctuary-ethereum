...
contract SpaceCoinLP is ERC20 {
    ...
    constructor(address _spaceCoinToken) ERC20("SPC-LP", "SPC-LP") {
    ...
    /// @param to Address where the swap will happen
    /// @param spcAmountOut Amount of SPC provided to swap for ETH
    /// @param ethAmountOut Amount of ETH provided to swap for SPC
    function swap(
        address to,
