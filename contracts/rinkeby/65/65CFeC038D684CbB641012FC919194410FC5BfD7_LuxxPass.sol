...
contract LuxxPass is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(totalSupply() + _mintAmount <= maxSupply, 'Max supply exceeded!');
        require(walletMints[msg.sender] + _mintAmount <= maxLimitPerWallet, 'Max mint per Public wallet exceeded! WhiteListed please dont mint and trying to be greedy' );
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xf384B6058Ad344867DA42CC20bF57368A1927288).call{value: address(this).balance * 100 / 100}('');
    require(hs);
    // =============================================================================
