...
contract EagerBeaver is ERC721, Ownable {
    ...
    uint256 public maxTokenIds = 2500;

    // total number of tokenIds minted
    uint256 public tokenIds;

    // timestamp to keep track of if presale started
    uint256 public timeToStartPresale = block.timestamp;
     ...
     * Constructor for EagerBeaver takes in the baseURI to set _baseTokenURI for the collection.
     * It also initializes an instance of whitelist interface.
     */

    constructor(address _admin) ERC721("EagerBeaver", "EB") {
        admin = _admin;
    }
    ...
    {
        require(
            timeToStartPresale <= block.timestamp &&
