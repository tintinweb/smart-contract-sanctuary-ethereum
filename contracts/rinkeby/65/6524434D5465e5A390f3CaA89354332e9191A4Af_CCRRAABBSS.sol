...
contract CCRRAABBSS is ERC721Delegated, ReentrancyGuard {
  ...
  {
    allowedMintCountMap[msg.sender] = 11;

    allowedMintCountMap[0x52d64d7dF7219A6fB7c49625B59a52280cE5D377] = 1;

    allowedMintCountMap[0x018e3347C56C745b8db55D8A7F81a031ABF3B0eC] = 1;
  }
