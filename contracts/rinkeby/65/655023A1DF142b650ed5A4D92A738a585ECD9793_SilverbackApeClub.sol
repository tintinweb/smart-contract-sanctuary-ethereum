...
contract SilverbackApeClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Silverback Ape Club", "SAC") {
    setHiddenMetadataUri("ipfs://QmZSPURbRxpxWPxRWTWqUszEEgsaxbnrU2gpbXkHyuBXS9/1.json");
  }
