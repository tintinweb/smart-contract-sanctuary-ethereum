...
contract SaviorsOfTheSea is ERC721, ERC721URIStorage, ERC721Enumerable, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    uint256 private maxFreelistSupply = 250;
    uint256 private freelistTokensClaimed = 0;

    uint256 private MAX_SS_AT_GREENLIST = 10;
    uint256 public greenlistPrice = 0.02 ether;
    bool public greenlistSale = false;
    uint256 private maxGreenlistSupply = 2500;
    uint256 private greenlistTokensClaimed = 0;
     ...
     */
    function setWithdrawAddr(address _WITHDRAW_ADDR) nonReentrant public onlyOwner {
        WITHDRAW_ADDR = _WITHDRAW_ADDR;
    }

    function withdraw() nonReentrant public onlyOwner {
    ...
    */
    function reserveMint(uint256 reservedAmount, address mintAddress) nonReentrant public onlyOwner {        
