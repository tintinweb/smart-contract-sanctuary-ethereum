...
contract DreamEyeFeederV1 is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  DreamEyeGenV1 public dreamEyeGenV1;
  ...
  function mint(uint256 _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
    ...
    dreamEyeGenV1.evolve(totalMinted(), 3);
  }
  ...
  */
  ...
  function setTargetContract(address _dreamEyeGenV1) public onlyOwner {
    dreamEyeGenV1 = DreamEyeGenV1(_dreamEyeGenV1);
  }
