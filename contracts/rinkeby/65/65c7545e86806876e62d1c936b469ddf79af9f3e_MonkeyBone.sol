...
contract MonkeyBone is Ownable, ERC721A {
    ...
    uint256 public maxFreePerAddress         = 10;
    
    uint256 public price                        = 0.00 ether;
    bool    public saleIsActive                 = false;


    address constant internal TEAM_ADDRESS = 0x18aaf7b954B6b8f62adCcB3896FF4df484b040aa;
    ...
    constructor() ERC721A("Monkeybone", "SEXCULT") {_safeMint(msg.sender, 1);
    }
