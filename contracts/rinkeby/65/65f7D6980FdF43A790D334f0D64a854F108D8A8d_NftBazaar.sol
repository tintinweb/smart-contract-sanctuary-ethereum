...
interface IMy1155 is IERC1155{
    function mint(address to, uint256 id, uint256 amount, bytes memory data) external;
    
    function mintWithURI(string memory _uri, address to, uint256 id, uint256 amount, bytes memory data) external;

    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) external;

    function mintBatchWithURI(string memory _uri, address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) external;
}
