...
// File: contracts/TestAcidApes.sol
...
contract TestAcidApes is ERC721Enumerable, Ownable {
    
    using SafeMath for uint256;
    
    string public baseTokenURI; 

    uint256 public constant RESERVED_FOR_FA = 1000;
    uint256 public constant SUPER_ACID_POTION_TYPE_ID = 1;
    uint256 public constant MAX_ACID_BEASTS = 10;
    ...
    //FA contract address
    address public fa_contract = 0x701C912b093b2c8763aD242a038F0b802eb19108;

    //NAV contract address
    address public nav_contract = 0xB933d3e6C203d8A9625e419931504440661a72E8;  //tbd 

    mapping (uint256 => uint256) public superAcidBeastById; //new
    
    //constructor takes in baseTokenURI
    constructor(string memory _baseTokenURI) ERC721("TestAcidApes","TACID") {
    ...
    function holderMint(uint256 _tokenId, uint256 _potionType) public {
        ...
        if (_potionType == SUPER_ACID_POTION_TYPE_ID)
        {
            ...
            require( next_acid_beast_token_id < (MAX_ACID_BEASTS + 4000), "Max Acid Beasts have been minted"); 
