...
contract SkulltoonsGenesis is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    function preSaleMint(bytes32[] calldata _wlProof, bytes32[] calldata _slProof) external payable callerIsUser nonReentrant {        
        uint256 allowedCount = getAllowedMintCount(_wlProof, _slProof);
        ...
        require(_numberMinted(msg.sender) <= allowedCount, "This address cannot mint anymore tokens");
    ...
    function tokenHoldersMint() external payable callerIsUser nonReentrant {
        ...
        require(_numberMinted(msg.sender) + MAX_TOKEN_HOLDERS_MINT_PER_WALLET <= MAX_TOKEN_HOLDERS_MINT_PER_WALLET, "This address cannot mint anymore tokens");
    ...
    function publicMint() external payable callerIsUser nonReentrant {
        ...
        require(_numberMinted(msg.sender) + MAX_PUBLIC_PER_WALLET <= MAX_PUBLIC_PER_WALLET, "This address cannot mint anymore tokens");
