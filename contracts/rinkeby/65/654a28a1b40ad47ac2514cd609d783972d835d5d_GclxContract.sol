...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1e92aee97000f50b54D280919b4DF8A35b5d6e21];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVYZi6XyTgC9xmZnH8Co1pEuNRUpr3WjFUpVN1N6uLstB/";
...
// File: contracts/GclxContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GclxContract is RamppERC721A {
    constructor() RamppERC721A("gclx", "gclx"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/I9Dzy0PfxEFfPIeqBQwn/contract-metadata";
    }
}
