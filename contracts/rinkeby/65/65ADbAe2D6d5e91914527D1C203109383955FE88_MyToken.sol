...
contract MyToken is ERC721A, ERC2981, Ownable, Pausable {
    ...
    bool public canUserMint = false;
    constructor() ERC721A("WaifuVerse Genesis", "WVG"){
        _setDefaultRoyalty(_treasuryAccount, 1000);
        baseUri = "https://ipfs.io/ipfs/Qme5sNH4PptH5u4zPj2FMquftBys2AMUkazUHwqj2q4P8E/";
        _pause();
    }
    ...
    modifier onlyPossibleMint(uint256 quantity) {
        ...
        require(canUserMint, "You can't mint just now");
        _;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        string memory  _oddBaseUri = "https://ipfs.io/ipfs/QmdLzKa33rDNqNzLubJ1N8KboFvjTcLi6ZtKymctvQ9uUz/";
        string memory _evenBaseUri = "https://ipfs.io/ipfs/QmYsGugBPcYmV5Ck7ZMHXYRXBNPw6qTpck6rgFasC6pKh8/";
        return revealState ? (tokenId % 2 == 0 ? _evenBaseUri : _oddBaseUri) : baseUri;
    }
