...
contract BullTime is Ownable, ERC721A, ReentrancyGuard {
    ...
    // --- genesis
    function genesisMint(uint256 quantity) external callerIsUser payable canBuy(quantity) {
    ...
    // --- presale
    function preSaleMint(uint256 quantity) external callerIsUser payable canBuy(quantity) {
    ...
    // --- public mint
    function publicMint(uint256 quantity) external callerIsUser payable canBuy(quantity) {
