...
contract NFT is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("NFT Collectible", "NFTC") {
        ...
        //TODO add minting for other owner
    }
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        require(_count > 0 && _count <= MAX_PER_MINT, "Minimum 1 and maximum 5 NFTs.");
    ...
    function whitelistMint(uint256 numTokens, bytes calldata signature, bool golenList) public payable {
        uint256 totalMinted = totalSupply();

        require(isWhiteListActive, "White and golden list minting is not active");
        require(totalMinted.add(numTokens) < MAX_SUPPLY, "Not enough NFTs left!");
        ...
        if(golenList){
            ...
            require(tokensMinted[msg.sender]+numTokens < 2, "Exceeded max available to purchase");
            ...
            require(tokensMinted[msg.sender]+numTokens < 5, "Exceeded max available to purchase");
            tokensMinted[msg.sender] += numTokens;
            for (uint256 i = 0; i < numTokens; i++) {
               _safeMint(msg.sender, totalMinted + i);
            }
    ...
    function reserveNFTs(uint256 _amount) external onlyOwner {
        ...
        require(totalMinted.add(_amount) < MAX_SUPPLY, "Not enough NFTs left to reserve");
