...
/**
 * @title COSEImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controleld by a central SupplyController. By implementing COSEImplementation
...
contract COSEImplementation {
    ...
    string public constant name = "COSE"; // solium-disable-line uppercase
    string public constant symbol = "COSE"; // solium-disable-line uppercase
    ...
    */
    ...
    function burn(uint256 amount)  public whenNotPaused returns (bool){
        ...
        require(frozen[msg.sender], "address is frozen");
    ...
    function _burn(address account, uint256 amount) public whenNotPaused returns (bool)  {
        require(account != address(0), "ERC20: burn from the zero address");
        require(frozen[account], "address is frozen");
