...
contract Sol4U is SolidaritySplitsTestnet, SolidarityBase {
    constructor()
        SolidarityBase(
            'Sol4U',
            'Sol4U',
            'https://gateway.pinata.cloud/ipfs/', // pinata url
            'Qme9T3ZXrPFNoGueqdmmu3vtL3VZLE4iooufasTy47kqyR/1396.png', // First Punk
            'Qme9T3ZXrPFNoGueqdmmu3vtL3VZLE4iooufasTy47kqyR/1397.png', // Second Punk
            addresses,
            splits
        )
    {
        // Implementation version: 1
        // Alpha Release: Contract Address = 
    }
    ...
    OnePhaseMint
{
    ...
    uint256 private constant MAX_MINT_BATCH_SIZE = 50;

    string public baseURI;
    string public tokenTypeOneURIPart;
    string public tokenTypeTwoURIPart;
    ...
    ) ERC721A(__name, __symbol) SlimPaymentSplitter(__addresses, __splits) OnePhaseMint(0.1 ether){
        baseURI = __baseURI;
    ...
    function setTokenTypeURIs(string memory __tokenTypeOneURIPart, string memory __tokenTypeTwoURIPart) external onlyOwner {
        tokenTypeOneURIPart = __tokenTypeOneURIPart;
        tokenTypeTwoURIPart = __tokenTypeTwoURIPart;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory activePath = tokenTypeOneURIPart;
        string memory activeAttributes = _videoAttributes();

        if(tokenId > lastTokenMinted) {
            activePath = tokenTypeTwoURIPart;
            activeAttributes = _photoAttributes();
        }
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    OnChainEncoding.encode(
                        bytes(
                            string(
                                abi.encodePacked(
                                    '{"name": "Solidarity NFT #',
                                    OnChainEncoding.toString(tokenId),
                                    '", "description": "Solidarity NFT Project for Ukraine, Created by JR.", "image": "',
                                    abi.encodePacked(base, activePath),
                                    '","attributes": [',
                                    activeAttributes,
     ...
     *
     * This method probably will not be used, just here in case it is needed.
     */
    ...
    function _photoAttributes() internal pure virtual  returns (string memory) {
        return '{"trait_type": "TITLE", "value": "The Resilience of Ukraine"}, {"trait_type": "CREATOR", "value": "JR"}, {"trait_type": "FORMAT", "value": "PHOTO"}';
    }

    function _videoAttributes() internal pure virtual  returns (string memory) {
        return '{"trait_type": "TITLE", "value": "Unfurling The Resilience of Ukraine"}, {"trait_type": "CREATOR", "value": "JR"}, {"trait_type": "FORMAT", "value": "VIDEO"}';
    }
}
