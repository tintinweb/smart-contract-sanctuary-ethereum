...
contract Web3InTravelNFTTicket is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function sponsorship(string memory _quote) external payable nonReentrant {
        ...
        details[DET_SPONSOR_QUOTE] = string(abi.encodePacked("Sponsor ", _quote));
    ...
    function tokenURI(uint256 _tokenId) override public view returns (string memory) {
        ...
        parts[4] = string(abi.encodePacked('<text x="175" y="250" class="b" text-anchor="middle" >',details[DET_SPONSOR_QUOTE],'</text><text x="175" y="330" text-anchor="middle" class="c">',details[DET_CREDITS],'</text>',_TRIPS_LOGO,'</svg>'));
