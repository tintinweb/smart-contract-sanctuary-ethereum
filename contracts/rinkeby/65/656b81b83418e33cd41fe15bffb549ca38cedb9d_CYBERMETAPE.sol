...
contract CYBERMETAPE is ERC721, Ownable, IERC2981, PaymentSplitter {
    ...
    uint256 public whiteListSaleStart = 1645554600;
    uint256 public publicSaleStart = 1645561800;
    ...
    constructor() ERC721("CYBERMETAPE", "CM") PaymentSplitter(_payees, _shares) payable {
        ...
        setNotRevealedURI("ipfs://QmVBsdvYqL1swYqzfUMB4HKNkTNdzzQJsGEuZZmf4Wef8y/hidden.json");
        contractUri = "ipfs://QmSZFpxLyzJ4Lmwv7Fz7eWrtynNtFBYST2C1CkoMif2CVa/contract.json";
    }
    // internal
