...
contract PowerInterns is AdminControl, ICreatorExtensionTokenURI, ILazyDelivery, ILazyDeliveryMetadata {
    ...
    function configure(address marketplace, uint listingId) public adminRequired {
