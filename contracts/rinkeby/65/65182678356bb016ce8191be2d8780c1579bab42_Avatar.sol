...
contract Avatar is IAvatar, ERC721, Ownable {
    ...
    constructor(address sigAddress, address payable _withdrawalAddress)
    ...
    function mintAvatar(
        ...
        require(
            msg.value >= price,
            "The avatar price is higher than the amount paid"
        );
    ...
    function reserveAvatar(
        ...
        bytes32 digest = keccak256(
            abi.encodePacked(
                "SomeProjectReservationApproval",
                msg.sender,
                signatureExpiration,
                price
            )
        ...
        require(
            msg.value >= price,
            "The reservation price is higher than the amount paid"
        );
    ...
    function _afterTokenTransfer(
        ...
        if (_attendant != ILockerRoomAttendant(address(0)))
            _attendant.afterAvatarTokenTransfer(from, to, tokenId);
    }
