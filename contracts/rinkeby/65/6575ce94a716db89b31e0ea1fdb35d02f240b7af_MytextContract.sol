...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUhpzRhmTz6UYZVGATR3WLEaLsad5aKqVaAKUxCFwq5dH/";
...
// File: contracts/MytextContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MytextContract is RamppERC721A {
    constructor() RamppERC721A("MY TEXT", "TEXT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/aieiYgbXxsx4ssxgOBO4/contract-metadata";
    }
}
