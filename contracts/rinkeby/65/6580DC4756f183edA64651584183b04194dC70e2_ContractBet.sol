 ...
 */
contract ContractBet is ChainlinkClient {
    using Chainlink for Chainlink.Request;

    uint256 public games;
    string public gID;
    uint256 public paymentQty;
    address private oracle;
    bytes32 private jobId;
    uint256 private fee;
    uint256 public creatorBet;
     ...
     * Fee: 0.1 LINK
     */
    constructor(string memory _gameId, uint256 _creatorBet) {
        setPublicChainlinkToken();
        gID = _gameId;
        creatorBet = _creatorBet;
        oracle = 0x754E8b2c5a843874354653527218121e45d311B6;
        jobId = "53ad9b74feef4cba8e52a348e2ef6ac4";
     ...
     */
    function requestGamesData() public payable returns (bytes32 requestId) {
        ...
        paymentQty = msg.value;
        // request.add("gameId", "67517");
        // string memory gID = _gID;

        request.add("gameId", gID);
     ...
     */
    function fulfill(bytes32 _requestId, uint256 _games)
        public
