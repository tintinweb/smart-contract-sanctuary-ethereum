...
contract IggyPop is ERC1155PresetMinterPauser, Ownable {

    string public name = "IggyPop";
    string public symbol = "IggyPop";
    
    string public contractUri = "https://iggy.rainerhosch.com/contract"; 

    constructor() ERC1155PresetMinterPauser("https://iggy.rainerhosch.com/{id}") {
    }
