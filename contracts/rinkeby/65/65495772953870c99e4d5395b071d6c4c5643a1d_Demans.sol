...
contract Demans is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdRzbkEdPaN9fYzzrhH4Ra47ufEwoAab6gR8AUg6wTNqo/";
    ...
    uint256 public constant PUBLIC_SALE_PRICE = 0.00333 ether;
    ...
    constructor(
    ) ERC721A("Demans", "DMAN", 100, maxSupply) {
    }
