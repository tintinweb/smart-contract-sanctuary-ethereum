...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Why", "How", "When", "Are", "What", "Is"];
    string[] secondWords = ["You", "He", "She", "Him", "Her", "It"];
    string[] thirdWords = [
        "Alive",
        "Dead",
        "lying",
    ...
    function makeAnEpicNFT() public {
        ...
        /* 
    {_tokenIds} to keep track of the NFTs unique identifier, and it's just a number! It's automatically initialized to 0 when we declare {private _tokenIds}. 
    So, when we first call {makeAnEpicNFT}, {newItemId} is 0.
    ...
    {_tokenIds} is state variable which means if we change it, the value is stored on the contract directly.*/
        ...
        _tokenIds.increment();
        /*
    we increment {tokenIds} using {_tokenIds.increment()} (which is a function OpenZeppelin gives us). 
    This makes sure that next time an NFT is minted, it'll have a different {tokenIds} identifier. 
