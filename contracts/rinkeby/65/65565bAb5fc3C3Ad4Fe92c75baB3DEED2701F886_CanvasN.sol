...
contract CanvasN is ERC721 {
    ...
    function setMaxMintAmount(uint256 _newMaxMintAmount) public onlyAdminAndOwner {
    ...
    function setBaseExtension(string memory _newBaseExtension) public onlyAdminAndOwner {
    ...
    function setAll(
        string memory _allBaseURI, string memory _notRevealedURI,
        bool _reveal, bool _lock, bool mintState,
    ...
    function withdraw(uint256 _amount, address _receiver) public payable onlyOwner {
