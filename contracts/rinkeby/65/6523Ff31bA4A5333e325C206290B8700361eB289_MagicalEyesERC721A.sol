...
contract MagicalEyesERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public saleStartTime = 1660899600;
    ...
    ERC721A("Magical Eyes V2", "ME") 
    PaymentSplitter(_team, _teamShares) {
        merkleRoot = _merkleRoot;
        baseURI= _baseURI;
        teamLength = _team.length;
        _safeMint(0x7e0F8AfEE158b50c5e5c38a07eB329D05be8605d, 1);
    }
