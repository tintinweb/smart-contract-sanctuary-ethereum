...
contract TESTCONTRACT1 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("TESTCONTRACT1.wtf", "JOSHTEST"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on hombre");
    require(totalSupply() + amount < maxSupply + 1,"No more hombre");
