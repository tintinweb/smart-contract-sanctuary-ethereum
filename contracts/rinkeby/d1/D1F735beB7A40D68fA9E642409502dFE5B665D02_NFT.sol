...
contract NFT is ERC721A, Ownable, VRFConsumerBase {
    ...
    uint256 public saleState = 0; // 0 = paused, 1 = public sale
    ...
    ) VRFConsumerBase(chainlink.coordinator, chainlink.linkToken) ERC721A("NFT", "NFT") {
    ...
    function publicMint(uint256 amount) public payable callerIsUser {
        require(saleState > 0, "Public sale not live");
        require(amount > 0, "Bad amount");
        require(amount <= 20, "You can mint a maximum of 20 fantastic token");
