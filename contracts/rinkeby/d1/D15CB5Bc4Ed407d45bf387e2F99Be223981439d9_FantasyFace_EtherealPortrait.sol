...
// File: contracts/FantasyFace_EtherealPortrait.sol
...
contract FantasyFace_EtherealPortrait is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Fantasy Face_Ethereal Portrait", "FFEP") {
    setHiddenMetadataUri("ipfs://QmeX9TpL7CguoiNtqK2Ao9kLAgTabMgNzn8KSfny7of5LJ/hidden.json");
  }
