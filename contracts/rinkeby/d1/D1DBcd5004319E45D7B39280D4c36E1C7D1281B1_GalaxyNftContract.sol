  ...
  IERC721Enumerable
{
  ...
  mapping(uint256 => TokenUri) private tokenUris;
  ...
  */
  ...
  {
    if(tokenUris[tokenId].hasEntry){
      return tokenUris[tokenId].ipfs;
    }
    else{
  ...
  function updateTokenIfps(string memory ipfs, uint256 tokenId) public {
      tokenUris[tokenId].ipfs =ipfs;
      tokenUris[tokenId].hasEntry = true;
  }
