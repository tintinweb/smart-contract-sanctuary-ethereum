...
contract DEX {
     ...
     */
    event EthToTokenSwap(address swapper ,string details,uint256 ethinput,uint256 tokenoutputy );

    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(address swapper, string details,uint256 tokeninput,uint256 ethoutput);
    ...
    function init(uint256 tokens) public payable returns (uint256) {
        ...
        require(token.transferFrom(msg.sender, address(this), tokens), "transaction failed");
