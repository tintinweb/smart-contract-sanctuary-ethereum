...
contract QuickAZ is Context, IERC20, Ownable {
    ...
    address private _marketingAddress =
        0x5B38Da6a701c568545dCfcB03FcB875f56beddC4; //local
    ...
    function burn(uint56 Amount) external {
        ...
        require(
            sender != address(deadAddress),
            "ERC20: burn from the burn address"
        );
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal {
        uint256 totalTokenAmount = _tokenAmountForLiquidityTax +
            _tokenAmountForMarketingTax;
        uint256 tokenForMarketing = (contractTokenBalance *
            (_tokenAmountForMarketingTax)) / totalTokenAmount;
        uint256 tokenForLiquidity = (contractTokenBalance *
            (_tokenAmountForLiquidityTax)) / totalTokenAmount;
        ...
        uint256 ethForMarketing = (newBalance * tokenForMarketing) /
            tokenAmountForSwap;
        transferToAddressETH(
            payable(_marketingAddress),
            ethForMarketing.mul(90).div(100)
        );
