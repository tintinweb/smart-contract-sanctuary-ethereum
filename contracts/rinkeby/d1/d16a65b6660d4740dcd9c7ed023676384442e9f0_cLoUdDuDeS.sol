...
//          Hey Clouds!
// SOCIALS:
//   Cloudsite: clouddudesnft.com
//   Twitter: @CloudDudesNFT
//   Instagram: @clouddudesnft
...
//IPFS   IPFS   IPFS   IPFS   IPFS   IPFS   IPFS   IPFS   IPFS
//=============================================================   
...
// ============================================================
    ...
    function tokenByIndex(uint256 Index) public view override returns (uint256) {
        require(Index < totalSupply(), "ERC721A: global index out of bounds Total Supply");
        return Index;
    }
    ...
    function tokenOfOwnerByIndex(address Owner, uint256 Index) public view override returns (uint256) {
        ...
        revert("ERC721A: Error! Unable to get token of owner by index!");
    }
    ...
    function ownershipOf(uint256 tokenId) internal view returns (TokenOwnership memory) {
        ...
        revert("ERC721A: Error! Unable to determine the Owner of Cloud Token");
    }
...
// ============================================================
    ...
    function approve(address To, uint256 tokenId) public override {
        ...
        require(To != CloudOwner, "ERC721A: ERROR! Approval to current Cloud Owner");

        require(
            _msgSender() == CloudOwner || isApprovedForAll(CloudOwner, _msgSender()),
            "ERC721A: ERROR! Approve caller is not Cloud Owner nor approved for all"
        );
    ...
    function getApproved(uint256 tokenId) public view override returns (address) {
        require(_exists(tokenId), "ERC721A: ERROR! Approved query for nonexistent Cloud Token!");
...
// ============================================================
    ...
    function _mint(
        ...
        require(to != address(0), "ERC721A: ERROR! mint to the zero address!");
        require(QuantityClouds != 0, "ERC721A: ERROR! QuantityClouds must be greater than 0!");
...
contract cLoUdDuDeS is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public maxSupplyClouds = 100;
    uint256 public MaxCloudsPerAddress = 10;
    uint256 public CloudPrice = 0.0005 ether;
    ...
    function _baseURI() internal view virtual override returns (string memory) {
 	...
 	function FreeMint(address wallet, uint256 _CloudsAmount) public onlyOwner {
  	    uint256 TotalCloudsForFree = 20;
	    require(TotalCloudsForFree + _CloudsAmount <= 2, "You can Free Mint only 1 Cloud!");
        require(_CloudsAmount > 0, "You can't mint 0 Clouds! LOL 0-0!");
        _safeMint(wallet, _CloudsAmount);
    }

        function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmdZpwNWSXzDoHraPU5WC6tMifG6rp5vq6SgneYt73XXV3/", tokenId.toString(), ".json"));
    } 
...
//==================================================================================================================
//CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS   CLOUDS
//==================================================================================================================
//⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠿⠿⠿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
//⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠁⢀⣀⣀⣀⡀⠀⠙⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
//⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡏⠀⢰⣿⡟⠛⠻⣿⣦⠀⠈⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
