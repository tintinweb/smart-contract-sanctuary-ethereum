...
contract BulbNFTs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bulbstore", "BLB") {
    setHiddenMetadataUri("ipfs://Qmb2n7ZqRqGap4uJhFJ4ehtnPiHfgj6cTTb3D5V2XZbjiw/hidden.json");
  }
