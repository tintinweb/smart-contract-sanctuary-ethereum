...
contract MonartNFT is ERC721Enumerable, Pausable, PaymentSplitter {
    using Counters for Counters.Counter;

    uint256 public maxTotalSupply = 5;
    uint256 public maxGiftSupply = 10;
    ...
    uint256 public MintPrice = 180000000000000000;
    string public baseURI;
    Counters.Counter private _tokenIds;
    uint256[] private _teamShares = [100];
    address[] private _team = [0xb19892F4d4cB90F834c26960611B253EcD3FdA0B];
    ...
    function saleMint(uint256 _amount) internal {
        ...
        require(_amount <= maxCount, "Can only mint 10 tokens at a time");
        require(
            totalNFT + _amount <= maxTotalSupply,
            "Message: max supply exceeded"
        );
