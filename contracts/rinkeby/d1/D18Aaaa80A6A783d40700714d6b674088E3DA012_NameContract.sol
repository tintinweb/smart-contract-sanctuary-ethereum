...
//
//     __                   __                                  __  
//    / /_  ___  ____ _____/ /__  _____   ____ ___  ____ ______/ /__
//   / __ \/ _ \/ __ `/ __  / _ \/ ___/  / __ `__ \/ __ `/ ___/ //_/
//  / / / /  __/ /_/ / /_/ /  __/ /     / / / / / / /_/ / /  / ,<   
// /_/ /_/\___/\__,_/\__,_/\___/_/     /_/ /_/ /_/\__,_/_/  /_/|_|  
//                                                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x6e60b676cFaD002ad652E30B83080EeB8f617840];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x6e60b676cFaD002ad652E30B83080EeB8f617840;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmf5cR55s67d4LYMcFVxR1dLM4Cfp3n3vW4YVZLVT5wKtp/";
...
// File: contracts/NameContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NameContract is RamppERC721A {
    constructor() RamppERC721A("Name", "TOKEN"){}
}
