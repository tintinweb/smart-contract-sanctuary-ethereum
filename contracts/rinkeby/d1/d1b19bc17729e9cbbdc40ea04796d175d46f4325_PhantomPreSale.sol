...
library SafeMath {
    ...
    uint256 private constant PRICE = 0.008e18; // PTM token price is 0.008 DAI
    uint256 private constant MAX_BUY = 1000e18; // Max Amout Of Dai user can use for buy
    uint256 private constant MIN_BUY = 250e18; // Min Amount of Dai user can use for buy
    ...
    function claim() public {
        ...
        PTM.transfer(msg.sender, amount);
