...
contract TestNet is ERC1155, Ownable, Pausable {
    string public name;
    string public symbol;

    uint256 public PRICE_TIER_1 = 0.0025 ether;
    uint256 public PRICE_TIER_2 = 0.01 ether;
    uint256 public PRICE_TIER_3 = 0.05 ether;
    ...
    function mintTier1() external payable {
      unchecked {
          require(msg.value >= PRICE_TIER_1, "insufficient eth");
      }
    ...
    function mintTier2() external payable {
      unchecked {
          require(msg.value >= PRICE_TIER_2, "insufficient eth");
      }
