...
// @author: andrewjiang.eth on manifold.xyz creator core
...
contract WhereMyVansGo is ERC721Creator {
    ...
    bytes32 public merkleRoot; // Merkle tree to validate old token IDs on OpenSea shared contract are part of WMVG collection
