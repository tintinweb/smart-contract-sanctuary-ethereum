...
// File: contracts/SalamandersLowGas.sol
...
contract SalamandersSmartContract is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SALAMANDERS", "SAL") {
    setHiddenMetadataUri("ipfs://QmaDTjBfwcrP7ycj5s3QDbs6J3VNW39a3DN5S6qELrJCAt/hidden.json");
  }
