...
contract Boilerplate is
    ...
    Withdrawable
{
    uint256 public constant TOTAL_MAX_QTY = 10000; // enter max qty here
    uint256 public GIFT_MAX_QTY = 100; // enter max gift here
    uint256 public constant DASALES_MAX_QTY = 1000; // enter max DA quantity here
    uint256 public constant DA_MAX_QTY_PER_MINTER = 2; // enter max qty per minter for DA here
    uint256 public constant PUBLIC_MAX_QTY_PER_MINTER = 2; // enter max qty per minter for Public Sale here
    uint256 public constant DA_SALES_START_PRICE = 0.5 ether; // enter DA starting price here
    uint256 public DA_LAST_PRICE = DA_SALES_START_PRICE;
    uint256 public constant priceDropDuration = 1800; // enter how many second price will drop here
    uint256 public constant priceDropAmount = 0.025 ether; // enter how much price will drop here
    uint256 public constant priceDropFloor = 0.25 ether; // enter how much floor price will be here
    uint256 public fPublicSalesPrice = DA_SALES_START_PRICE; // enter how much public sale price will be here
    ...
    constructor()
        ERC721("Boilerplate Token", "BOILERPLATE")
    ...
    function getPrice() public view returns (uint256) {
        if (isDASalesActivated()) {
            uint256 dropCount = (block.timestamp - DASalesStartTime) /
                priceDropDuration;
            return
                // please count how much price dropping will occour and put it here
                dropCount < 10
                    ? DA_SALES_START_PRICE - dropCount * priceDropAmount
                    : priceDropFloor;
        } else if (isPrivateSalesActivated()) {
            // please put private sales price here
    ...
    function DASalesMint() external payable isDASalesActive {
