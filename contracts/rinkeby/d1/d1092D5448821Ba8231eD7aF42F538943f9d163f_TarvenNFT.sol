// SPDX-License-Identifier: MIT
    ...
    contract TarvenNFT is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public constant tokenPublicPrice = 350000000000000000; // 0.35 ETH
      uint256 public constant tokenPreSale = 250000000000000; // 0.25 ETH
      ...
      bool public saleIsActive = true; // when launch sale then call to function
      ...
      function presaleTarven(uint256 numberOfTokens) external payable {
        ...
        require(
          msg.value >= tokenPreSale.mul(numberOfTokens),
          "Ether value sent is not correct"
        );
        require(balanceOf(msg.sender) < 1 , "Must be mint only one");
