...
contract DevNFTTest is DevCitiNFT {
    ...
    function initialize(NFTContractInitializer memory _initializer) initializer public {
...
contract DevCitiNFT is BaseCitiNFT, ERC721URIStorageUpgradeable {
     ...
     */
    function __DevCitiNFT_init(string memory _name, string memory _symbol, NFTContractInitializer memory _initializer) internal onlyInitializing {
...
struct NFTContractInitializer {
    // `adminAddress` receives {DEFAULT_ADMIN_ROLE}, {MINTER_ROLE} and {PAUSER_ROLE}, assumes msg.sender if not specified.
...
contract Versioned {
    string public constant version = "fe8b10470844e0b94e0f7df0e3ce243de450e200";
}
