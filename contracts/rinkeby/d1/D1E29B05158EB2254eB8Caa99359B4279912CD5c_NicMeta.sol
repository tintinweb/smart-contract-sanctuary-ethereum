...
contract NicMeta is ERC721Enumerable, Ownable {
    ...
    function minteyeNFT(uint256 tokenQuantity) public payable {
        require(
            totalSupply() + tokenQuantity <= MAX_SUPPLY,
            "Sale would exceed max supply"
        );
        require(_isSaleActive, "Sale must be active to mint eyeNFT");
        require(
        ...
        _minteyeNFT(tokenQuantity);
    }

    function _minteyeNFT(uint256 tokenQuantity) internal {
