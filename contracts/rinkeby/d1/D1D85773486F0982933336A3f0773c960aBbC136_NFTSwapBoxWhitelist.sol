...
contract NFTSwapBoxWhitelist is INFTSwap, Ownable, AccessControl {
    ...
    function setUsingERC721Whitelist(bool usingList) external  onlyAdmin {
        swapConfig.usingERC721WhiteList = usingList;
    }

    function setUsingERC1155Whitelist(bool usingList) external  onlyAdmin {
        swapConfig.usingERC1155WhiteList = usingList;
    }

    function setNFTTokenCount(uint256 limitTokenCount) external  onlyAdmin {
        swapConfig.NFTTokenCount = limitTokenCount;
    }

    function setERC20TokenCount(uint256 limitERC20Count) external  onlyAdmin {
    ...
    */
    ...
    function addWhiliteListERC721Token(address erc721Token) external  onlyAdmin {
        require(
    ...
    function removeFromERC721WhiteList(uint256 index) external  onlyAdmin {
    ...
    function removeFromERC1155WhiteList(uint256 index) external onlyAdmin {
