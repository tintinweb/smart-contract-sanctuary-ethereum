...
contract Rugged is ERC721A, Ownable {
    ...
    constructor() ERC721A("RUGGED", "RUGGED") {
    ...
    function mint(uint256 count) external payable {
        ...
        require(msg.value >= count * cost, "Don't be cheap send it all!");
        require(totalSupply() + count < maxSupply + 1, "No more");
        require(mintEnabled, "Hold up Asshole we haven't flipped the switch");
