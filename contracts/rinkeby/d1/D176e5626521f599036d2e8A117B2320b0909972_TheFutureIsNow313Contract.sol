...
//*********************************************************************//
//
//   ________            ______      __                     ____        _   __                 _____________
//  /_  __/ /_  ___     / ____/_  __/ /___  __________     /  _/____   / | / /___ _      __   |__  <  /__  /
//   / / / __ \/ _ \   / /_  / / / / __/ / / / ___/ _ \    / // ___/  /  |/ / __ \ | /| / /    /_ </ / /_ < 
//  / / / / / /  __/  / __/ / /_/ / /_/ /_/ / /  /  __/  _/ /(__  )  / /|  / /_/ / |/ |/ /   ___/ / /___/ / 
// /_/ /_/ /_/\___/  /_/    \__,_/\__/\__,_/_/   \___/  /___/____/  /_/ |_/\____/|__/|__/   /____/_//____/  
//                                                                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1f1A8679Dfae782D35d73d81E6A11012F5cd40DC,0x26ee75Fcd1AFe489cF3e2DD0F9Aaf9251cA2122c];
  uint256[] public payableFees = [5,85,10];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 20) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigq7nrttjdspmo7jmwxxgtjlwuflj66ohjlhlb2rjwotxv64h6abe/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 20");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 20");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 20");
...
// File: contracts/TheFutureIsNow313Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheFutureIsNow313Contract is RamppERC721A {
    constructor() RamppERC721A("The Future Is Now 313", "Future313"){}
}
