...
contract touchGrass is ERC721A, Ownable, ReentrancyGuard {
    ...
    bool public publicSaleIsLive = !publicSaleIsLive;

    constructor() ERC721A("Touch Grass", "TG") {}
    ...
    function toggleSaleState() external onlyOwner {
        if (publicSaleIsLive = !publicSaleIsLive) {
    ...
    function emergencySetmaxSupply(uint256 maxSupply_) external onlyOwner {
