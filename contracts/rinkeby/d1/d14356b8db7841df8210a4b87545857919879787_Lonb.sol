...
contract Lonb is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
  ...
  constructor() ERC721A("Toxic Turtles", "TT") {
    _setDefaultRoyalty(0x7C6B970eF4E98E973830735a3eE89c2BAA8A1b1C, 500);
...
//*******************ADMIN AREA********************
  ...
  function withdraw() public onlyOwner nonReentrant {
   ...
   (bool hs, ) = payable(0x7C6B970eF4E98E973830735a3eE89c2BAA8A1b1C).call{value: address(this).balance * 5 / 100}('');
    require(hs);
