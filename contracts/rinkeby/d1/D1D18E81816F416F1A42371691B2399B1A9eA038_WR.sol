...
contract WR is ERC721Enumerable, PaymentSplitter, Ownable {
    ...
    function reserveTokens(uint256 numberOfTokens) public onlyOwner {
        ...
        require(
            TOTAL_RESERVED.add(numberOfTokens) <= RESERVED_TOKENS,
    ...
    function mintPreSaleTokens(
        ...
        require(
            MerkleProof.verify(_merkleProof, preSaleRoot, leaf) ||
                _preSaleListOverflow[msg.sender],
            "Invalid MerkleProof"
        );
    ...
    function mintOGSaleTokens(
        ...
        require(
            _ogSaleList[msg.sender].add(numberOfTokens) <= MAX_OG_MINTS,
            "Exceeded max available to purchase"
        );
        require(numberOfTokens > 0, "Must mint more than 0 tokens");
        require(
        ...
        require(
            MerkleProof.verify(_merkleProof, ogSaleRoot, leaf) ||
                _ogSaleListOverflow[msg.sender],
            "Invalid MerkleProof"
        );
