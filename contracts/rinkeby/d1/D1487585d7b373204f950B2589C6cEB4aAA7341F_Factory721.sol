...
import "./paradoxNFT721UserToken.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new paradoxNFT721UserToken{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        paradoxNFT721UserToken token = paradoxNFT721UserToken(address(addr));
...
contract paradoxNFT721UserToken is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
