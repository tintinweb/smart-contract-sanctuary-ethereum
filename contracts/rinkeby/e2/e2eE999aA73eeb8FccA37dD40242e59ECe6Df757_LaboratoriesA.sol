...
contract LaboratoriesA is ERC721AQueryable, Ownable {
    ...
    constructor() ERC721A("The Digital Pets Company", "LABORATORY") {}
    ...
    function mintPrivate(
        ...
        checkWalletLimit(msg.sender, _quantity, _maxQuantity)
        checkWhitelist(msg.sender, _maxQuantity, _proof)
    ...
    function createLeaf(address _account, uint256 _maxQuantity)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(abi.encodePacked(_account, _maxQuantity));
    }
    ...
    modifier checkWalletLimit(
        ...
        require(
            _numberMinted(_account) + _quantity <= _maxQuantity,
    ...
    modifier checkWhitelist(
        ...
        require(
            verifyProof(createLeaf(_account, _maxQuantity), _proof),
