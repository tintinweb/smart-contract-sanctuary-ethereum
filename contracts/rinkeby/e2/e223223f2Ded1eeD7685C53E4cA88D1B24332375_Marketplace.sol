...
contract Marketplace {
    ...
    ERC1155 token_contract = ERC1155(0x8B1C11AA73C38555394D85F2D73c940E226AcB42); // Replace with NFT Smart Contract address
    ...
    function addListing(
        ...
        token_contract.safeTransferFrom(
            msg.sender,
            address(this),
            token_id,
            amount,
    ...
    function removeListing(uint256 listing_id) public {
        ...
        token_contract.safeTransferFrom(
            ...
            listings[listing_id].amount,
            ""
        );
    }

    function buy(uint256 listing_id) public payable {
        require(listings[listing_id].is_active, "Must be active");
