...
contract VonCaps is ERC721Enumerable, Ownable {
    ...
    bool public MINTING_OPENED = true;
    bool public USE_MERKEL = false;


    string public baseTokenURI;

    constructor(string memory baseURI) ERC721("VonCaps Collectible", "VCNFT") {
        setBaseURI(baseURI);
    }
    ...
    function setMintingOpened(bool _open) public onlyOwner {
        MINTING_OPENED = _open;
    }
