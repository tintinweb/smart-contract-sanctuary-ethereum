...
contract CryptoFarm is ERC721A, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_, string memory contractURI_, string memory tokenMetadata_)
    ...
    function mint() public {
        ...
        require(
            usersNFTQuantity[msg.sender] == 0,
            "cryptoFarm: user owns an NFT"
        );
