...
contract OnePieceNFT is ERC721, Ownable, ILayerZeroReceiver  {
    uint256 public totalSupply;
    string internal baseTokenUri;
    ILayerZeroEndpoint public endpoint;
    mapping(uint16 => bytes) public remotes;

    constructor(address _layerZeroEndpoint) payable ERC721('OnePieceNFT', 'opNFT') {
        totalSupply = 0;
    ...
    function setBaseTokenUri(string memory baseTokenUri_)  internal{
        ...
        payable
    {
        ...
        bytes memory payload = abi.encode(msg.sender, baseTokenUri_);
