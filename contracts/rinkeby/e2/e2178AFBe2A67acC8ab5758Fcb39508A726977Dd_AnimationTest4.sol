...
/*
    ...
    ERC 721A starts with mint number 0, adjust here 
    or in IPFS metadata names
*/
...
contract AnimationTest4 is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("AnimationTest4", "ANIMT4") {}

    function mintPublic(uint256 _amount) external nonReentrant {
