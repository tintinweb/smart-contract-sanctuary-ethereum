...
// File: testonemore.sol


pragma solidity ^0.8.4;
contract Testonemore is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("testonemore", "tom") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://nft-central-bucket.s3.us-west-2.amazonaws.com/62e379c189c0f58529eb6f00/json/";
    }
