...
contract NFT_Student is Ownable, ERC721A, PaymentSplitter {
    ...
    //public create automatically a getter for the front end 
    Step public sellingStep;

    uint private constant MAX_SUPPLY = 50;
    uint private constant MAX_WHITELIST = 3;
    uint private constant MAX_PUBLIC = 40;
    uint private constant MAX_GIFT = 7;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("NFT Student", "STUDENT")
