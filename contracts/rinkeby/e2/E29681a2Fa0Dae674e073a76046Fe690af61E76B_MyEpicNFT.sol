...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Aim","Standard","You","Dog","Read","Swim"];
    string[] secondWords =["Catch","Cool","Happy","Occur","Peer","Will"];
    string[] thirdWords =["Join","Error","Word","Learn","Maybe","Pull"];
    ...
    // pickRancomFirstWord関数は、最初の単語を選びます。
    ...
    // pickRandomThirdWord関数は、3番目に表示される単語を選びます。
    ...
    function makeAnEpicNFT() public {
        ...
        require(newItemId < maxItemId,"Mint exceeds max value");
