...
contract ptn is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public whitelistCost1 = 0.000000045 ether; 
    uint256 public whitelistCost2 = 0.0000000090 ether; 

    uint256 public publicSaleCost = 0.000000135 ether; 
    ...
    constructor(bytes32 _initWLsigner, string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("PTNTNT", "efeffe") {
