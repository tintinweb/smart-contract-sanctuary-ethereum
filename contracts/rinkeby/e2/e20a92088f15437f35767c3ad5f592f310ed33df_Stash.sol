    ...
    ERC721Stashable
{
    ...
    function initialize() public initializer {
        ...
        __Ownable_init();
        setPublicSale(1661014800,1661022000,2000);
        signer = address(0xe36f2696ddda39B31cE57B115ccCE65b21223EBa);

        _setDefaultRoyalty(msg.sender, 500); //TODO receiver, feeNumerator (1000 => 10%)
    }
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x6ed5a435495480774Dfc44cc5BC85333f1b0646A).transfer((balance * 800) / 1000);
        payable(0x2d0F4bcD4D2f08FAbD5a9e6Ed7c7eE86aFC3B73f).transfer((balance * 200) / 1000);
    }
