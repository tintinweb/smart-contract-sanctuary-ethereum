...
// @author: Gilles Collard, https://twitter.com/primes_wtf
...
contract PrimesERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 private constant MAX_GIFT = 16;
    uint256 private constant MAX_DESIGNER = 100;
    uint256 private constant MAX_SUPPLY_MINUS_RESERVED = 1460;
    uint256 private constant MAX_WHITELIST = 730;
    uint256 private constant MAX_PUBLIC = 730;

    uint256 public wlSalePrice = 0.0005 ether;
    uint256 public publicSalePrice = 0.00075 ether;

    uint256 public saleStartTime = 1655762400;
    ...
    uint256 private constant maxPerAddessDuringWhitelistMint = 3;
    uint256 private constant maxPerAddessDuringPublicMint = 3;
    ...
    uint256[] private _teamShares = [250, 250, 500];
     ...
     * @param _account Account that receive the NFT
     * @param _quantity Amount of NFT the user want to mint
    ...
    function whitelistMint(
        ...
        require(currentTime() < saleStartTime + 72 hours, "Sale is finished"); // impact publicMint()
        ...
        require(
            amountNFTperWalletWhitelistSale[msg.sender] + _quantity <=
                maxPerAddessDuringWhitelistMint,
        ...
        callerIsUser
    {
        require(!isPaused, "Contract is paused");
        require(
            currentTime() >= saleStartTime + 72 hours,
        ...
        require(
            amountNFTperWalletPublicSale[msg.sender] + _quantity <=
                maxPerAddessDuringPublicMint,
            "You can only get 3 NFTs"
        );
        require(
            totalSupply() + _quantity <= MAX_SUPPLY_MINUS_RESERVED,
            "Max supply exceeded"
        );
     ...
     * @param _quantity Amount of NFT the owner want to mint
     */

    function gift(address _to, uint256 _quantity) external onlyOwner {
        require(
            sellingStep > Step.PublicSale,
            "Gift is allowed only after the public sale"
        );
    ...
    {
        require(_exists(_tokenId), "URI query for nonextistent token");
        return string(abi.encodePacked(baseURI, _tokenId.toString(), ".json"));
    }

    /**
     * @notice Allows to set the whitelist sale price
     * @param _wlSalePrice new price during whitelist sale
     */
     ...
     * @param _publicSalePrice new price during public sale
     */
    ...
    /**
     * @notice Set the start of the whitelist sale
     * @param _saleStartTime new datum of starting WL sale
     */
    ...
    /**
     * @notice Pause / depaused smart contract
     * @param _isPaused The new base URI of the NFTs
     */
    ...
    /**
     * @notice Change the base URI of NFTs
     * @param _baseURI the new base URI
     */
    function setMerkleRoot(string memory _baseURI) external onlyOwner {
        baseURI = _baseURI;
    }
     ...
     * @param _account the address to hash
    ...
    /**
     * @notice returns true if leaf is proved as a part of merkle tree root
     ...
     * @param _account an account checked
     * @param _proof the merkle proof
     * @return bool true / false
     */
    ...
    /**
     * @notice Not allowing to receive ethers outside minting function
     */
