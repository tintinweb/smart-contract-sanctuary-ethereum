...
contract Socrat is ERC721A, Ownable, ReentrancyGuard {
  ...
  /**
   * @notice minting is carried out in three stages whitelist, presale, public-sale and at each stage the Panacea price increases by 0.08 ETH.
   */
  ...
  /**
   * @dev reserves aside 49 panaceas for marketing etc.
   */
