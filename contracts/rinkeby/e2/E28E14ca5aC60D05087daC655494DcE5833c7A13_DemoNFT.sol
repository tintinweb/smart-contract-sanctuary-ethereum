...
contract DemoNFT is ERC721AQueryable, Pausable, Ownable, ReentrancyGuard {
    ...
    uint public maxFreeSupply = 2000;
    uint public maxSupply = 2500;
    uint public maxMintAmountPerTx = 20;
    uint public maxFreeMintAmountPerTx = 3;

    bool public revealed = false;

    constructor() ERC721A("DemoNFT", "DNFT") {}
    ...
    function mint(uint256 _mintAmount) external payable whenNotPaused {
        ...
        if (msg.value > 0) {
            ...
            require(_mintAmount > 0 && _mintAmount <= maxFreeMintAmountPerTx, 'Invalid mint amount!');
            require(totalSupply() + _mintAmount <= maxFreeSupply, 'Free supply exceeded!');
        }
    ...
    function setMaxFreeMintAmountPerTx(uint256 _maxFreeMintAmountPerTx) external onlyOwner {
