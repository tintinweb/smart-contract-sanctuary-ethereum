...
contract Kitty is ERC721Enumerable, Ownable, ReentrancyGuard  {  
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 5300; 
    ...
    uint256 public wlCost = 17500000000000000;
...
constructor(
    ...
    function whiteListMint(bytes32[] calldata _merkleProof ) public payable  {
          ...
          //verify Cost
          require(msg.value == wlCost.mul(1),  "Ether value sent is not correct");
          //Mark Claim
    ...
    function mint(uint256 _count) public payable saleIsOpen nonReentrant{
          ...
          require(_count <= 20, "Can only mint 20 tokens at a time");
          require(msg.value==mintCost.mul(_count), "Ether value sent is not correct");
    ...
    function claim(uint256[] memory _tokensId) public claimIsOpen {
          ...
          require(_cupCatsUsed[_tokensId[i]] == false, "Already claimed!");
          require(cupCats.ownerOf(_tokensId[i]) == _msgSender(), "Bad owner!");
          //Mark Claim
    ...
    function checkClaim(uint256 _tokenId) public view returns(bool) {
        return _cupCatsUsed[_tokenId] == false && _tokenId>5024 == false;
    }
    ...
    function withdraw() public payable onlyOwner {
        (bool os, ) = payable(owner()).call{value: address(this).balance}("successful");
        require(os);
    }
