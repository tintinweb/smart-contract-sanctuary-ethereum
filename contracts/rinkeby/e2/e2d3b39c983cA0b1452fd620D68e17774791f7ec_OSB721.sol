...
contract OSB721 is ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC2981Upgradeable, OwnableUpgradeable {
    ...
    function initialize(address _owner, string memory _name, string memory _symbol, uint256 _maxBatch, address _receiverRoyaltyFee, uint96 _percentageRoyaltyFee) public initializer {
    ...
    function mint(address _to, uint256 _id) external onlyOwnerOrController {
         _safeMint(_to, _id);
    }
