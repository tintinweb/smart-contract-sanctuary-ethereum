...
contract JustNumbers is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    uint256 public MAX_SUPPLY = 2500;
    uint256 public OWNER_SUPPLY = 300;
    ...
    function addWhitelist(address[] memory users, bool approved) public onlyOwner {
