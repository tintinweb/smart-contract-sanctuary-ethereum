...
contract TheJewishLadies is ERC721, Ownable {
   
    string public baseURI = "https://nftstorage.link/ipfs/bafybeiccmuprxv72lw3rck47i4oqkju44b3w5qtztedszfrutjjqa6x7hq/";  

    address public authorizedSigner = 0x5172c410aD20d27763c686Ada1458d2c00e145D3;  

    uint constant public MAX_SUPPLY = 4040;

    uint public maxMintsPerWallet = 15;
    uint public totalSupply;
    mapping(address => uint) public mintedNFTs;

    constructor() ERC721 ("The Jewish Ladies", "JEWL") {
        mintNFTs(1);
    }
    ...
    function publicMint(uint mintAmount) external payable {
        if (mintAmount > 0) {
            mint(mintAmount);
        }
    }
