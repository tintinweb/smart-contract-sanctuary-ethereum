...
contract RRKennelClub is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 9602;
    ...
    address constant internal DEV_ADDRESS = 0x6403C799e97f2EE222639765f3E55ae77E2e58E0;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("RRKennelClub", "RRKC") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 555, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x6403C799e97f2EE222639765f3E55ae77E2e58E0");
