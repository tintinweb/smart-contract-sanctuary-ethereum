...
contract Staker {
  ...
  bool public externalContractCompleted = false;
  ...
  modifier notCompleted() {
    require(externalContractCompleted == false, "ExampleExternalContract has been already completed!");
    _;
  }
  ...
  function execute() notCompleted public {
    require(timeLeft() == 0, "Deadline not passed! You have to wait a little bit more.");
  ...
  function withdraw() notCompleted public {
    require(openForWithdraw == true, "Withdraw are disabled because balance went over threshold.");
  ...
  receive() external payable {
    (bool success, ) = address(this).delegatecall(abi.encodeWithSignature("stake()"));
    require(success, "Failed to stake Ether");
  }
}
