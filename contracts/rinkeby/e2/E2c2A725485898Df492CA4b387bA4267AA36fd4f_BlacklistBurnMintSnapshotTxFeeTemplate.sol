...
import "../features/TxFeeFeatureAlt.sol";
        ...
        TxFeeFeatureAlt
{
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, BlacklistFeature, TxFeeFeatureAlt) {
...
import "../common/BaseGovernanceWithUserUpgradable.sol";
import "../features-interfaces/ITxFeeFeatureAlt.sol";
import "../ERC20Base.sol";
