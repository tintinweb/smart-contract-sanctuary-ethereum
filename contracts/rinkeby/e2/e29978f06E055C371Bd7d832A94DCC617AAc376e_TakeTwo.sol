...
contract TakeTwo is ERC721A, Ownable {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x980BF4b28418614C5BD6b2b0466831464C6Fe5Fb).transfer(balance * 1 / 20);
        payable(0x88D40ADF6CeB80Be34CEae574DEbbCc20a67cd67).transfer(balance * 1 / 20);
        payable(0xaaEf03a94B51fE6497Eb2BA7BD44da7b004317f1).transfer(address(this).balance);
    }
