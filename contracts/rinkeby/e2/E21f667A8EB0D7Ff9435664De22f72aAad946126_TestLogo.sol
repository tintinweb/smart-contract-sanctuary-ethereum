...
contract TestLogo is ERC721URIStorage, Ownable {
    uint256 private _maxSupply;
    uint256 public _price = 0.05 ether;
    string private _tokenURI;
    uint256 _currentSupply = 0;

    constructor() ERC721("Asios Logo", "ASIOS") {}

    function mint() public payable returns (uint256) {
        require (_currentSupply + 1 <= _maxSupply, "No more available to mints"); 
        require(
            msg.value >= _price,
        ...
        _setTokenURI(_currentSupply, _tokenURI);
