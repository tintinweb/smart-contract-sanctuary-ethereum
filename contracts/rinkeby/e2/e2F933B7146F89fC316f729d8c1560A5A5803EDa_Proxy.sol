...
contract Proxy is AccessControl, Ownable, ReentrancyGuard, Structs {
    ...
    /// @param _name Cryochambers Phase name
    ...
    /// @param _maxTokenId Max token ID to sell in this phase (0 if no checking)
    /// @param _intervalMinutes Interval for price decrease in minutes
    /// @param _priceDecrease Price decrease value in ETH
    /// @param _requireMintPass Phase require mint pass?
