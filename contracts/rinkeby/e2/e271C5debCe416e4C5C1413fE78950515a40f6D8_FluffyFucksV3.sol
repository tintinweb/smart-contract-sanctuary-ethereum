...
{  
    ...
    bytes32 internal merkleFreeList = "_";
    bytes32 internal merkleLuckiest = "_";
    bytes32 internal merkleRaffle = "_";
    ...
    string internal contractMetadataURI = "https://foo.bar/json.json";
    string internal tokenURIpart = "https://foo.bar/";

    constructor()
        ERC721A("Fluffy Fucks", "FFX")
    {
        MintTimer memory tmp = MintTimer({
            from: 1654412400, //1654408800,
            to: 1654437600, //1654434000,
            canMint: 2
        });
        ...
        mintTimes[MintType.FreeList].from = 1654437600;
        mintTimes[MintType.FreeList].to = 1654455600;
        
        // public mint
        mintTimes[MintType.Public] = tmp;
        mintTimes[MintType.Public].from = DATE_WILDCARD;
        ...
        nonReentrant
    {
        ...
        // check if is guaranteed
        if (mintType == MintType.Public && merkleVerify(_merkleProof, merkleRaffle, msg.sender)) {
            mintType = MintType.Guaranteed;
        }

        // check if is freelisted
        if (merkleVerify(_merkleProof, merkleFreeList, msg.sender)) {
     ...
     * Merkles
     */
    function setMerkleFreeList(bytes32 _merkle)
        external
        onlyOwnerOrAdmin
    {
        merkleFreeList = _merkle;
    }
