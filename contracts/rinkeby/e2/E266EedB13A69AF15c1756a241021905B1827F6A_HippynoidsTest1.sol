...
contract HippynoidsTest1 is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.005 ether;
    uint256 public maxSupply = 6060;
    ...
    constructor() ERC721A("HippynoidsTest1", "Hippy") {
        setBaseURI("");
	...
	require(saleActivated, "Mint: Mint process is pause");
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max BokiGirls per address exceeded");
        require(_mintAmount > 0, "Cant mint 0 HippynoidsTest1");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more HippynoidsTest1" );
        require(s + _mintAmount <= maxSupply, "Cant exceed HippynoidsTest1 supply");
