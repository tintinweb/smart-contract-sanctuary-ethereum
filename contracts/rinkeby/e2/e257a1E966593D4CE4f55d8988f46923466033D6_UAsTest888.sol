...
contract UAsTest888 is ERC721A, Ownable, ReentrancyGuard {
  ...
  bool public revealedStage1 = false;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    uint256 _maxAmount = _allowList[msg.sender] > 3 ? 3 : _allowList[msg.sender];
  ...
  function setRevealedStage1(bool _state) public onlyOwner {
    revealedStage1 = _state;
  }
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    if (revealedStage1 == false && stage == 1) {
