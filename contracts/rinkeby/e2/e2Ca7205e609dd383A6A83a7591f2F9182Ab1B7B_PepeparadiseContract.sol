...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x793e6AdcceCF7d01F62E814498392966d1eCbD4A];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x793e6AdcceCF7d01F62E814498392966d1eCbD4A;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif6lksp7rnl7s3samp5y5cwejzaipkvt2opctvh6sisfrg2444nma/";
...
// File: contracts/PepeparadiseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PepeparadiseContract is RamppERC721A {
    constructor() RamppERC721A("PEPE PARADISE", "PEPE"){}
}
