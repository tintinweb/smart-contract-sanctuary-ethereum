...
contract RegularSpacecraft is ERC721 {
	uint16 public totalTokens = 100;
	...
	constructor() ERC721("RegularSpacecraft", "RSC") {}
	 ...
	 */
	function setBaseUri(string calldata _baseUri) external onlyOwner contractIsNotFrozen {
		baseUri = _baseUri;
	}
	...
	function devMint(uint16 amount) external onlyOwner {
