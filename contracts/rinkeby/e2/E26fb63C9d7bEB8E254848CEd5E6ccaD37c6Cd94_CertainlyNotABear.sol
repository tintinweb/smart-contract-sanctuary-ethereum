...
contract CertainlyNotABear is ERC721A, Ownable, ReentrancyGuard, KeeperCompatibleInterface {
    ...
    address public PANDA_CONTRACT_ADDRESS = 0x4706d9b3C94D1516277dC092E5eCD3DCeeD718C0;
    ERC721A public pandaContract;

    string public market = "bear";

    int256 limiarPrice = 2000;
    ...
    */
    ...
    {
        pandaContract = ERC721A(PANDA_CONTRACT_ADDRESS);
