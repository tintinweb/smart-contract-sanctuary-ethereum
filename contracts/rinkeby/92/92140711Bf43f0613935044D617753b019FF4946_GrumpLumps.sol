    ...
    RandomlyAssigned
{
    ...
    onlyAccounts
    {
        require( tokenCount() + 1 <= totalSupply(),     "Grump Lumps: max supply exceeded");
        require( availableTokenCount() - 1 >= 0,        "Grump Lumps: You cannot mint more than the available token couunt");
