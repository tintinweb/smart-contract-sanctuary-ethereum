...
/** 
 *  SourceUnit: h:\work\TheDawgChain\contracts\contracts\TheDawgChainAuction.sol
*/
...
interface ITheDawgChainNFT {
	function safeTransferFrom(address from, address to, uint256 tokenId) external;    
    function ownerOf(uint256 tokenId) external view returns (address);       
}

contract TheDawgChainAuction is Ownable, ERC721Holder {
    ...
    ITheDawgChainNFT public nftCollection;
    ...
    event BidSuccess(address from, uint256 auctionId, uint256 price, uint256 bidIndex);
    ...
    constructor (address _governanceToken, 
		...
		nftCollection = ITheDawgChainNFT(_nftCollection);
	}   
