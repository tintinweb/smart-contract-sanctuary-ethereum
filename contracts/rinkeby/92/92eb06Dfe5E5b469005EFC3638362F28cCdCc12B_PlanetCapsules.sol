...
// File: contracts/lowGasTestPlanetCasules.sol
...
contract PlanetCapsules is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Planet Capsules", "PLNT") {
    setHiddenMetadataUri("ipfs://QmZ4Qo8Da6mjqCM7v9fGDYhG6iZSKfhmRXzNZe7GK7KJ3N/hidden.json ");
  }
