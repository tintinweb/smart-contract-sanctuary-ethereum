...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmXgAxbscGgunbZFkvZqRNQnDjiwsCHr69SG6cL2RBUUAG/";
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 20");
    ...
    // File: contracts/kicksywicksyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract KicksywicksyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("KICKSYWICKSY", "KYS", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/mIpxyJqdZrdzSuOSJE33/contract-metadata";
        }
    }