...
contract RIFTXR is ERC721A, Ownable{
  ...
  /* ––– PUBLIC VARIABLES ––– */
    ...
    *@notice -Variable to enable public minting 
    ...
    /**
    *@notice variable for Pausing some functions in case of exploit
     */
    ...
    *@dev function to set MerkleRoot
     ...
     */
     function setMerkleRoot(bytes32 _merkleRoot) external onlyOwner {
      ...
      /**
    *@notice -Sets the PAUSE variable to true or false
    *@param _pause: new state of PAUSE variable
     */
    ...
    */
    ...
    function tokenURI(uint256 _tokenID) public view override returns (string memory) {
        ...
        return bytes(_baseURIChecker).length > 0 ? string( abi.encodePacked(baseURI, "/", _tokenID.toString(), ".json") ) : "";
    }
    ...
    modifier enoughPassesRemaining(uint256 numberOfTokens) {
     ...
     modifier maxPassesPerWallet(uint256 numberOfTokens) {
         if(numberOfTokens > 3 && _numberMinted(msg.sender) > 3) 
            revert RIFT__maxMintablePasses();
            _;
     }
