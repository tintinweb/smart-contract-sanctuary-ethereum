...
contract Squishiland is ERC721, Ownable {
    ...
    constructor() ERC721("Squishiland", "SVLAND") {
        land[LandSize.Mythic] = LandAttribute(0.01 ether, 2494, 1950, 0, 0);
        land[LandSize.Legendary] = LandAttribute(0.02 ether, 1500, 450, 0, 0);
        land[LandSize.Epic] = LandAttribute(0.03 ether, 400, 50, 0, 0);
        land[LandSize.Rare] = LandAttribute(0.04 ether, 50, 0, 0, 0);
    }
    ...
    function totalSupply() public view returns (uint256) {
        ...
        for (uint256 s; s < MAX_LAND_SIZES; s++) {
            ...
            total += land[size].minted - land[size].burnt;
        }
        return total;
    }
    ...
    function burn(uint256 tokenId) public {
        ...
        require(
            land[size].burnt < land[size].minted,
    ...
    function totalSupplyBySize(LandSize _size) public view returns (uint256) {
        return land[_size].minted - land[_size].burnt;
    }
