...
// File: Spiritual Audacities_flat.sol
...
// File: contracts/Spiritual Audacities.sol
...
contract Spiritual_Audacities is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://PU8FMQBWN39Y2345ZAMZQS1IND6BIBYU9W/";

    bool public paused = true;
    bool public revealed = false;

    bool public OGSpiritsSale = true;
    bool public publicSale = false;

    
    address constant internal DEV_ADDRESS = 0x4833307607E175E7097b9b8f5dc3077ac60759A8;
    
    

    mapping(address => bool) public userMintedOGSpirits;
    mapping(address => uint256) public numUserMints;

    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Spiritual Audacities", "SPAD") { }
    ...
    function OGSpiritsMint(uint256 quantity) external payable mintCompliance(quantity) {
        require(OGSpiritsSale, "OGSpirits sale inactive");
        require(msg.value == 0.01 ether, "This phase is OGSpirits");
        require(quantity == 1, "Only #1 OGSpirits");

        uint256 newSupply = totalSupply() + quantity;
        
        require(newSupply <= 333, "Not enough OGSpirits supply");

        require(!userMintedOGSpirits[msg.sender], "User max OGSpirits limit");
        
        userMintedOGSpirits[msg.sender] = true;
    ...
    function setPublicEnabled(bool _state) public onlyOwner {
        publicSale = _state;
        OGSpiritsSale = !_state;
    }
    function setOGSpiritsEnabled(bool _state) public onlyOwner {
        OGSpiritsSale = _state;
        publicSale = !_state;
    }
