...
// File: contracts/interfaces/IMetaIconsExchange.sol


pragma solidity ^0.8.0;


interface IMetaIconsExchange {
...
// File: contracts/MetaIconsExchange.sol
...
/**
 * @title MetaIconsExchange
 * @notice It is the core contract of the MetaIcons exchange.
 */
contract MetaIconsExchange is IMetaIconsExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x06214ae14f9131c79e451effddb0f23d1e69ec68a1684193e0071f8438d40940, // keccak256("MetaIconsExchange")
     ...
     */
    function matchAskWithTakerBidUsingETHAndWETH0(
        OrderTypes.TakerOrder calldata takerBid,
        OrderTypes.MakerOrder calldata makerAsk
     ...
     * @param makerAsk maker ask order
     */
    function matchAskWithTakerBidUsingETHAndWETH1(
        OrderTypes.TakerOrder calldata takerBid,
        OrderTypes.MakerOrder calldata makerAsk
    ) external payable {
        require((makerAsk.isOrderAsk) && (!takerBid.isOrderAsk), "Order: Wrong sides");
     ...
     * @param makerAsk maker ask order
     */
    function matchAskWithTakerBid0(OrderTypes.TakerOrder calldata takerBid, OrderTypes.MakerOrder calldata makerAsk)
        external
        nonReentrant
    {
        require((makerAsk.isOrderAsk) && (!takerBid.isOrderAsk), "Order: Wrong sides");
     ...
     * @param makerAsk maker ask order
     */
    function matchAskWithTakerBid1(OrderTypes.TakerOrder calldata takerBid, OrderTypes.MakerOrder calldata makerAsk)
        external
    {
        require((makerAsk.isOrderAsk) && (!takerBid.isOrderAsk), "Order: Wrong sides");
        require(msg.sender == takerBid.taker, "Order: Taker must be the sender");
