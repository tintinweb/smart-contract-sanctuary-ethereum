...
contract MonkeNFT is ERC721A , Ownable{  
	...
	event monkeChecked(address indexed _holder, uint _bal, bool _result);
	...
	function hasMonkeToken(address user) public returns(bool) {
		...
		emit monkeChecked(user, bal, result);
		return result;
	}
