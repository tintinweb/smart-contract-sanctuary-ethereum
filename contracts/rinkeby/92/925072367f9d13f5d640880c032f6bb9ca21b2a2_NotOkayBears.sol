...
contract NotOkayBears is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
        ...
        mintPriceCompliance(_mintAmount)
    {
        require(
            ...
            "NOB: Exceeds max mint per wallet!"
        );
