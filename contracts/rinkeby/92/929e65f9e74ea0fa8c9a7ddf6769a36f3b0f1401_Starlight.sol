...
contract Starlight is ERC721A, Ownable {
  ...
  constructor() ERC721A("Starlight", "SxS") {
  ...
  //Team Mint 
   function teamMint(uint8 quantity) external {
    require(!pausedTeamMint, "Contract paused");
...
//   function mintStarlight(uint8 quanity, uint8 authAmt, bytes32[] memory proof, bytes32 leaf) payable public {
//         require(phase != 0, "Sale has not started");
//         require(totalSupply() + quanity <= supply, "Not enough inventory");
//         require(msg.value == quanity * mintPrice, "Invalid value sent");
//         require(walletBuys[msg.sender] + quanity <= saleDetails.maxBuy, "Buy limit reached");

//         // TODO: Untested verification; need to generate merkle tree with whitelist data
//         if (saleDetails.phase != 0x02 && !verify(proof, leaf, msg.sender, authAmt))
