    ...
    StacktGuardManager
{
    ...
    struct StacktWalletSetup { address msgSender; uint256 startFundingTime; uint256 fundingDuration; uint256 fundPrice; uint256 funderLimit; }
    ...
    function setup(
        ...
        emit WalletSetup(msg.sender, stacktSetup.startFundingTime, stacktSetup.fundPrice, to, fallbackHandler);
    }
