...
contract ShaBiTiger is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("ShaBiTiger", "SBT") {
        setBaseURI(baseURI);
    }
    ...
    function reserveNFTs() public onlyOwner {
        ...
        require(totalMinted.add(0) < MAX_SUPPLY, "Not enough NFTs left to reserve");
