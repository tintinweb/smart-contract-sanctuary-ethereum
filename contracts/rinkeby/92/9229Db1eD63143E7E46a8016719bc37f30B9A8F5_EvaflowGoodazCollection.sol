...
contract EvaflowGoodazCollection is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
  ...
  constructor(
    ...
    royaltyReceiver_1 = 0xAfda4F57783D1b958307beAeC1Efedee0ba7943b;
  ...
  function setRoyalties(uint _tokenId, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints) public onlyOwner {
    ...
    //     return interfaceId == LibRoyaltiesV2._INTERFACE_ID_ROYALTIES || interfaceId == _INTERFACE_ID_ROYALTIES_RARIBLE || interfaceId == _INTERFACE_ID_ROYALTIES_FOUNDATION || interfaceId == _INTERFACE_ID_ROYALTIES_EIP2981 || super.supportsInterface(interfaceId);
    // }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721A) returns (bool) {
        ...
        if(interfaceId == _INTERFACE_ID_ROYALTIES_EIP2981) {
            return true;
        }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
        ...
        if (_royalties.length > 0 && _tokenId > 0 && _tokenId <= 50){
