...
contract CitySwapParams is Ownable{
    ...
    function paramsAreValid (uint256 _offerId, bytes memory _encodedData,
      ...
      uint8 category = decodeParams(_encodedData);

      bytes32 hash = this.encodeParams(_offerId, category);
    ...
    {
        uint8 category = abi.decode(_encodedData, (uint8));
