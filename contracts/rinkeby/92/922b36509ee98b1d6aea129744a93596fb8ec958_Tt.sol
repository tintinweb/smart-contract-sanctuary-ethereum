...
contract Tt is Context, IERC20, Ownable {
    ...
    address private _owner = 0x00D6f8286443d43671Ab2e42402CB81178fA6E5f; //owner of the contract
    ...
    uint256 private constant _tTotal = 10 * 1e12 * 1e9;
    ...
    uint256 public maxAmountCanBuy = 1e10;
    ...
    mapping(address => bool) public boughtEarly; // mapping to track addresses that buy within the first 2 blocks pay a 3x tax for 30 min to sell
    ...
    constructor() payable {
        ...
        _maxTransactionAmount = _tTotal * 150 / 10000; // 0.75% max trx 
        _maxWalletAmount = _tTotal * 300 / 10000; // 2.25% max Wallet
        minimumTokensBeforeSwap = _tTotal * 3 / 10000; // 0.03% swap tokens amount
        
        marketingAddress = payable(0x00D6f8286443d43671Ab2e42402CB81178fA6E5f);
        
        devAddress = payable(0x00D6f8286443d43671Ab2e42402CB81178fA6E5f); 
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // higher tax if bought in the same block as trading active for 30min (sniper protect)
