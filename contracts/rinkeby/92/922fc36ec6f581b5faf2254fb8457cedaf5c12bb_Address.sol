...
contract Kousins is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint private stopat = 0;
  uint private reserve = 0;

  uint public status = 0; //0-pause 1-whitelist 2-public 

  constructor() ERC721A("Kousins","Kousins NFT") {
    _beforerevealURI = "https://gateway.pinata.cloud/ipfs/QmRmfXN3drtob8QnuwT8AXGd2vLj4zZJNfvWdansRK2tUy";
}
