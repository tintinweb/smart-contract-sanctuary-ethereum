...
contract TokenForgeFactoryTF01 is Context, AccessControlEnumerable {
        ...
        returns (TokenForge1155v3)
    {
        ...
        instance.grantRole(instance.MINTER_ROLE(), _msgSender());
        // renounce minting role from factory
        instance.renounceRole(instance.MINTER_ROLE(), address(this));

        instance.grantRole(instance.DEFAULT_ADMIN_ROLE(), _msgSender());

        instance.renounceRole(instance.DEFAULT_ADMIN_ROLE(), address(this));
