...
abstract contract Membership is DatabaseContext {
    ...
    mapping(address => bool) private moduleMembers;
...
contract NFTDatabase is INFTDatabase, Membership {
    ...
    function GetNFTsByOwner(address _owner) public override view returns (uint[] memory) {
    ...
    function GetNFTByID(uint _nftID) public override view returns (string memory _name, uint _dna, uint32 _level, uint16 _winCount, uint16 _lossCount, address _ownerAddress){
