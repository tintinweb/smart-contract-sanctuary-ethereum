...
contract DigitalHearts is Ownable, ERC721A, ReentrancyGuard {
    ...
    // "MG Digital Hearts Official", "DHEARTS"
    constructor(
    ...
    function fillPresalelist(address[] memory addresses) external onlyOwner {
        /*require(
