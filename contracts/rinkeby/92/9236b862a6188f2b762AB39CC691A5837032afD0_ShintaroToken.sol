...
contract ShintaroToken is ERC1155Burnable, ERC1155Supply, Ownable {
  ...
  constructor() ERC1155("") {
    ...
    init(0, type(uint64).max, new uint64[](0), 100, 0.1 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(1, type(uint64).max, new uint64[](0), 100, 0.1 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(2, type(uint64).max, new uint64[](0), 50, 0.2 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(3, type(uint64).max, new uint64[](0), 50, 0.2 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(4, type(uint64).max, new uint64[](0), 25, 0.7 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(5, type(uint64).max, new uint64[](0), 25, 0.7 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(6, type(uint64).max, new uint64[](0), 10, 1.25 ether, 0, 10000000000, ''); // change start time, end time and uri
    init(7, type(uint64).max, new uint64[](0), 10, 1.25 ether, 0, 10000000000, ''); // change start time, end time and uri

    uint64[] memory counters = new uint64[](1);
    counters[0] = 9;
    init(8, type(uint64).max, counters, type(uint64).max, 0 ether, 0, 10000000000, ''); // change start time, end time and uri

    counters[0] = 8;
    init(9, type(uint64).max, counters, type(uint64).max, 0 ether, 0, 10000000000, ''); // change start time, end time and uri
  }
