...
contract LMAdventurers is Ownable, ERC721A, ReentrancyGuard {
  using Strings for uint256;

  uint256 public constant LMA_SUPPLY = 5757;
  uint256 public constant LMA_PER_MINT = 5;
  uint256 public constant LMA_PRICE = 0.042 ether;
  ...
  constructor() ERC721A("Legend Maps Adventurers", "LMA", 200) {}
  ...
  function mint(uint256 mintsRequested) external payable {
    ...
    require(mintsRequested <= LMA_PER_MINT, "EXCEEDS_MAX");
