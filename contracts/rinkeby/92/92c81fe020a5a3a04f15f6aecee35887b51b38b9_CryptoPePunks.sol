...
contract CryptoPePunks is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmciijpWNDobNau4QpG4Bb6zkvhUEMahrAhoKBqYGpc35n/";
    uint   public price             = 0.006 ether;
    uint   public maxPerTx          = 5;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 3636;
    uint   public maxSupply         = 3636;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Crypto PePunks", "PEPUNKS"){}
