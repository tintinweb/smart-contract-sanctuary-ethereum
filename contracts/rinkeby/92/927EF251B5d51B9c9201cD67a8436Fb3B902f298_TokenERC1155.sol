...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
    ...
    /**
     * @dev Like TransferSingle Event.
     */
    event TransferMSERC1155(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value);
    ...
    function _safeTransferFrom(
        ...
        emit TransferMSERC1155(operator, from, to, id, amount);
    ...
    function _mint(
        ...
        emit TransferMSERC1155(operator, address(0), to, id, amount);
    ...
    function _burn(
        ...
        emit TransferMSERC1155(operator, from, address(0), id, amount);
