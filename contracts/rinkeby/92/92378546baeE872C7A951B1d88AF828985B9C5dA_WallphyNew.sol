...
contract WallphyNew is Context, IERC20, Ownable {
        ...
        returns (bool)
    {
        ...
        } else if (taxOnlyDex == true && (_msgSender() == uniswapV2Pair || _to == uniswapV2Pair)) {//Taxes direct transfers to/from LP pair
