...
contract Distributor is IDistributor, AlfaAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        require(_afa != address(0), 'Zero address: OHM');
        afa = IERC20(_afa);
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        return afa.totalSupply().mul(_rate).div(rateDenominator);
    }
...
interface ITreasury {
    ...
    function manageReserves(address _token, uint256 _amount) external;
...
abstract contract AlfaAccessControlled {
    /* ========== EVENTS ========== */

    event AuthorityUpdated(IAlfaAuthority indexed authority);
    ...
    function setAuthority(IAlfaAuthority _newAuthority) external onlyGovernor {
