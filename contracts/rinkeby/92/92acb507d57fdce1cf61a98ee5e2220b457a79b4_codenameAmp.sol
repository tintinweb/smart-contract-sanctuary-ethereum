...
contract codenameAmp  is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant TOKEN_PRICE = 0; //0 ETH
  ...
  constructor(string memory baseURI) ERC721("codenameAmp", "Ampcode") {
    setBaseURI(baseURI);
  }
