...
contract BLKD is Context, IBEP20, Ownable {
    ...
    address public OwnerWallet = 0xA5e597C8727Ac8ADd3f12A0eFBf5E161e37754C1;
    ...
    function setTaxFeePercentage(uint256 taxFee,uint256 liquidityFee,uint256 DevelopmentFee,uint256 MarketingFee) external onlyOwner() {
        _taxFee = taxFee;
        _previousTaxFee = _taxFee;
