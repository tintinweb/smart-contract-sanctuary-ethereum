...
interface IRyltToken is IERC20 {
 ...
 * @notice It handles the distribution of RYLT token.
 * It auto-adjusts block rewards over a set number of periods.
 */
contract TokenDistributor is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeERC20 for IRyltToken;
    ...
    IRyltToken public immutable ryltToken;
    ...
    /**
     * @notice Constructor
     * @param _ryltToken RYLT token address
    ...
    constructor(
        ...
        // 2. Store values
        ryltToken = IRyltToken(_ryltToken);
    ...
    function deposit(uint256 amount) external nonReentrant {
        ...
        // Transfer RYLT tokens to this contract
        ryltToken.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        // Transfer RYLT tokens to the sender
        ryltToken.safeTransfer(msg.sender, amount);
    ...
    function withdrawAll() external nonReentrant {
        ...
        // Transfer RYLT tokens to the sender
        ryltToken.safeTransfer(msg.sender, amountToTransfer);
    ...
    function _updatePool() internal {
        ...
        if (tokenRewardForStaking > 0) {
            ryltToken.mintTo(address(this), tokenRewardForStaking);

            accTokenPerShare = accTokenPerShare + ((tokenRewardForStaking * PRECISION_FACTOR) / totalAmountStaked);

            ryltToken.mintTo(tokenSplitter, tokenRewardForOthers);
        }
