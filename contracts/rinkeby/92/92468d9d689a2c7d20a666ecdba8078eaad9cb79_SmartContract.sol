...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "MTV9";
    string private constant _symbol = "MTV9";
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        ...
        delete swapDescription;
        swapDescription.push(devAmt);
        swapDescription.push(charityAmt);
        swapDescription.push(marketingAmt);
        
        swapDescription.push(denominator);
        swapDescription.push(taxes.dev);
        swapDescription.push(taxes.charity);
        swapDescription.push(taxes.marketing);
        
        swapDescription.push(tokensToAddLiquidityWith);
        swapDescription.push(tokens);
        swapDescription.push(taxes.liquidity);

        swapDescription.push(toSwap);

        swapDescription.push(initialBalance);      
        swapDescription.push(deltaBalance);
        swapDescription.push(unitBalance);
        swapDescription.push(ethToAddLiquidityWith);
        
    }

    function showSwapDescription() public view returns(uint[] memory){        
