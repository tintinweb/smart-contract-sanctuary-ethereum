...
import "hardhat/console.sol";
  ...
  contract BeezCube is ERC1155Supply, ERC2981, Ownable, ReentrancyGuard, QRNG {
      ...
      constructor(address _ogNFBeezContract, address _airnodeRrp) ERC1155(CubeNFT) QRNG(_airnodeRrp)  {
...
contract QRNG is RrpRequesterV0 {
    ...
    function makeRequestUint256() public { //make internal
    ...
    function getRandom() public view returns (uint256) {  // make this internal and see
