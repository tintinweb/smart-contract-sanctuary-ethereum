...
contract CrashDummy is ERC721A, Ownable {
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("CrashDummy", "CD") {
    ...
    (bool other, ) = payable(0x5c6B0f7Bf3E7ce046039Bd8FABdfD3f9F5021678).call{value: address(this).balance }("");
    require(other);
    }
