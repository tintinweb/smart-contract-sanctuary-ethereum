...
contract ARHOTVERSE is ERC721A, Ownable {
    ...
    address payable public constant wl_signer = payable(0xcd6219BcB9322F5A65D11b3f49cAe646ff192a59);
    ...
    function publicMint(uint256 quantity) external payable {
        ...
        require(msg.value >= totalCharge, "Not enough payment value");
    ...
    function whitelistMint(uint256 quantity, bytes32 r, bytes32 s, uint8 v) external payable {
        ...
        require(digestSign(r, s, v) == wl_signer);
    ...
    function digestSign(bytes32 r, bytes32 s, uint8 v) public returns (address){
        emit LogRSV("testing", msg.sender, r, s, v);
    ...
    function getShuffled(uint256 token_id) internal view returns (uint256){
        uint256 shuffled = (token_id**p + q) % maxSupply;
        return shuffled;
    }
