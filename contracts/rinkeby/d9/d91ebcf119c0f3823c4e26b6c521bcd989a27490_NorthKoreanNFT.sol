...
// File: contracts/NorthKoreanNFT.sol
...
contract NorthKoreanNFT is ERC721A
{
    using Strings for uint256;
    ...
    constructor() ERC721A("The North Korean NFT", "NKOREAN", maxMintAmount) {
        owner = msg.sender;
        maxSupply = 6666;
        ownerReserved = 1000;
        tier1_limit = 1000;
        tier1_price = 0.25 ether;
        tier2_price;
    }
