// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Glasses", unicode"Head", unicode"Accessory", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Nounsmols", unicode"Apenoun travelled to Smolville to meet a female Smol Brain. When he arrived there he realised that he had been catfished to extract his Nounish essence and create clones of him. Some Nouns tried to save him... and now they all look very smol. CC0, just vibes.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/b51796b8-a5a8-42c8-aa8c-4a84113d3943", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/b51796b8-a5a8-42c8-aa8c-4a84113d3943", "", 500, "0xBc3D20463320958Dc7DE604b5FdCE94d9A85CEB2");

        constructor() ERC721A(unicode"Nounsmols", unicode"NOUNSMOL") {
            TIERS[0] = [331,331,331,332,332,332,332,332,332,332,332,332,332,332,332,332,332,332,332,332,332];
TIERS[1] = [190,190,190,190,190,190,190,190,190,201,201,201,201,201,201,201,201,201,345,345,345,345,345,345,345,345,345,345];
TIERS[2] = [193,193,193,193,193,193,193,193,193,193,193,193,193,193,193,193,193,193,3495];
TIERS[3] = [258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,258,259,259,259];
TIERS[4] = [100,100,284,285,620,620,620,620,620,620,620,620,620,620];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Nounsmols #");
