...
contract Secondary is ERC721, Ownable, ReentrancyGuard, RoyaltiesV2Impl{
  ...
  function whitelistMint(uint256 _tokenId, bytes32[] calldata _merkleProof) public payable {
    ...
    string memory input = string (abi.encodePacked(Strings.toHexString(uint160(_msgSender()), 20)));
    // console.log(input);
...
////////////////////////////////////////////////////////////////////////////////////
  ...
  function setRoyalties(uint _tokenId, address payable  _royaltiesReceipientAddress1, address payable  _royaltiesReceipientAddress2, uint96 _percentageBasisPoints1, uint96 _percentageBasisPoints2) public onlyOwner {
      ...
      _royalties[1].value = _percentageBasisPoints2;
      _royalties[1].account =  _royaltiesReceipientAddress2;
