...
interface ITreasury {
    function validatePayment() external;
}
    ...
    UUPSUpgradeable
{
    ...
    mapping(address => bool) public freeTaxAddress;
    ...
    function initialize() public initializer {
        ...
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Pioneer DAO Token");
        __ERC20Votes_init();
        ...
        onlyOwner
    {
        ...
        freeTaxAddress[_whitelist] = _status;
    }
    ...
    function _transfer(
        ...
        if (freeTaxAddress[sender] || freeTaxAddress[recipient]) {
            ...
            ITreasury(treasury).validatePayment();
        }
    }
