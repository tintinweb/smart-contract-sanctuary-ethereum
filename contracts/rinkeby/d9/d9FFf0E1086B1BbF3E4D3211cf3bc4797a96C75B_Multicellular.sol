...
contract Multicellular is  Ownable, ERC721A, ReentrancyGuard {
    ...
    function distribute() public nonReentrant{
        uint256 prize = address(this).balance / (maxSupply-burnCounter);
    ...
    function consume(uint256 consumerId_, uint256 targetId_) public {
        ...
        require(wormActive[consumerId_] == true, 'your worm is dead lol');
    ...
    function scarifice(uint256 sacrifice_, uint256 predator_) public {
        require(msg.sender == ownerOf(sacrifice_), 'sender not the owner of NFT');
        require(wormActive[sacrifice_] == true, 'your worm is already dead lol');
