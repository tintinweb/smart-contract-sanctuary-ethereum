...
contract NFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public MaxGiftSupply = 5;
    ...
    bool public PreSaleStatus;     // sale: pre
    ...
    function mintPreSale(
        ...
        // check mint:
        require(count <= MaxMintCount, "max mint amount");
    ...
    function mint(address to, uint256 count) external payable {
        ...
        // check max buy:
        require(count <= MaxMintCount, "exceeds maximum purchase amount");
        // check max supply:
