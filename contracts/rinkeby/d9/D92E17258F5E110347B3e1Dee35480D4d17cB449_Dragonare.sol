...
contract Dragonare is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Dragonare", "DRA") ERC20Permit("Dragonare") {_mint(msg.sender, 10000000 * 10 ** decimals());}
