...
contract Cannasapiens is ERC721Tradable {
    ...
    uint256 public constant RESERVE_FOR_AIRDROPS = 15;

    uint256 public constant RESERVE_FOR_WHITELISTED = 1000;

    uint256 public constant MAX_PRESALE_USER_MINTED_TOKENS_PER_TX = 1;

    uint256 public constant MAX_PUBSALE_USER_MINTED_TOKENS_PER_TX = 3;

    uint256 public constant MAX_PRESALE_TOKENS_MINT = 9;

    uint256 public constant MAX_PUBLIC_SALE_TOKENS_MINT = 21;
