...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, Ownable {
    ...
    // function Price_allrounder(uint256  Presale_Price, uint256  Mainsale_Price) public onlyOwner {
    //     _presalePrice = Presale_Price; 
    //     _price = Mainsale_Price;
    // }

    // function Supply_allrounder(uint256  Mainsale_Supply,uint256  Presale_Supply) public onlyOwner {
...
//     }
    ...
    function PresaleMaxSupplyShow() virtual public  returns (string memory){
        return suppllyshow=Strings.toString(_maxPresaleSupply);
    }
