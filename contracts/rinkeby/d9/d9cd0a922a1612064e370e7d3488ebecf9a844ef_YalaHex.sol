...
||   ;        \  \       ╚═╝   ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝       ╚═╝╚══════╝       ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝
||===;        \  \
||   |         | |    1- HEXY IS A CONTRACT FOR TRUSTLESSLY POOLING 14 HEX STAKES LADDERED YEARLY WITH 5.555 PERCENT OF TOTAL HEX PLEDGED AND ONE FINAL STAKE WITH 22.23 PERCENT FOR THE 15TH YEAR.
...
contract YalaHex is ERC20, ERC20Burnable, ReentrancyGuard, Ownable {
    ...
    address constant HEX_ADDRESS = 0x78a52239383f4B772781276b3De36086A5a2169e; // HEX.com official contract address
    address constant HEDRON_ADDRESS = 0x523aDE599F37A4799b31B7FB5Fe41251B92b04c4; // HEDRON.PRO official contract address
