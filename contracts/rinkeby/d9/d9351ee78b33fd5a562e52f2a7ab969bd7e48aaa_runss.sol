...
contract runss is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("runss", "runner", maxBatchSize_, collectionSize_, collectionSizeFree_) {
    maxPerAddressDuringMint = 60;
