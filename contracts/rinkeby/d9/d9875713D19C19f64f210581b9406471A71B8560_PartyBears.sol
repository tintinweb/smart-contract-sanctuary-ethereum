...
contract PartyBears is ERC721Enumerable, ERC721URIStorage, ReentrancyGuard, Ownable {
  ...
  constructor() ERC721("Party Bears", "PartyBears") {
    _tokenUriBase = "https://api.partybear.xyz/api/token/";
  }
  ...
  function mint(uint256 amount) external payable nonReentrant {
    require(!Address.isContract(msg.sender), "Contracts are not allowed to party with bears.");
    require(amount <= MAX_MINT, "You can only bring 5 Party Bears to dance per transaction.");
    require(
