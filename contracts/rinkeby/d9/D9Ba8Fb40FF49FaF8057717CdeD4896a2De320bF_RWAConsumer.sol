...
contract RWAConsumer is ChainlinkClient, Ownable {
     ...
     * Receive the response in the form of uint256
     */
    function conclude_response(bytes32 _requestId, bytes calldata _conclude_result) public recordChainlinkFulfillment(_requestId)
    {
