...
contract UghaBugha is ERC721A, Ownable {
    ...
    uint public publicSupply = 3900;
    uint public wlSupply = 1100;
	...
	function ughalistMint(uint256 quantity, bytes32[] memory _merkleProof) external payable { // mints Ughalist tokens
        ...
        require(totalSupply() + quantity <= wlSupply, "Quantity exceeds max Ughalist supply of tokens");
