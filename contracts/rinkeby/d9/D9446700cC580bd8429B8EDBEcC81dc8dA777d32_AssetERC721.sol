...
contract AssetERC721 is ERC721Custom {
  constructor (address _proxyRegistryAddress) ERC721Custom("AssetERC721", "SA-ERC721", _proxyRegistryAddress) {}
...
abstract contract ERC721Custom is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
