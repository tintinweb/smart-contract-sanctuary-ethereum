...
contract DataRetrievability is Ownable {
    ...
    address[] active_referees;
    // Array of active providers
    address[] active_providers;
    // Protocol address
    address protocol_address;
    uint256 slashing_multiplier = 10;
    uint256 deposit_multiplier = 10;
    /**
     * TEST PARAMETERS
     */
    uint32 round_duration = 12;
    uint32 deal_timeout = 60;
    uint32 min_duration = 120;
    uint32 max_duration = 240;
    /**
     * RINKEBY PARAMETERS
     */
    // Setting round duration to 1 Hour
    // uint32 round_duration = 3_600;
    // Setting timeout to accept deal to 1 Week
    // uint32 deal_timeout = 86_400;
    // Setting minimum duration of deal to 1 Month
    // uint32 min_duration = 2_592_000;
    // Setting minimum duration of deal to 12 months
    // uint32 max_duration = 31_104_000;
    ...
    // Event emitted when new provider is enabled
    event ProviderEnabled(address provider, string endpoint);
    // Event emitted when new provider is disabled
    event ProviderDisabled(address provider, string endpoint);
    // Event emitted when new Referee is enabled
    event RefereeEnabled(address Referee, string endpoint);
    // Event emitted when new Referee is disabled
    event RefereeDisabled(address Referee, string endpoint);
    ...
    */
    function setRefereeStatus(
        ...
        if (_state) {
            ...
            emit RefereeEnabled(_referee, _endpoint);
        } else {
            ...
            emit RefereeDisabled(_referee, _endpoint);
        }
    }
    ...
    */
    function setProviderStatus(
        ...
        if (_state) {
            ...
            emit ProviderEnabled(_provider, _endpoint);
        } else {
            ...
            emit ProviderDisabled(_provider, _endpoint);
        }
    }
    ...
    */
    function redeemDeal(uint256 deal_index) external {
        require(
            deals[deal_index].accepted == msg.sender,
            "Only who accepted can redeem the deal"
        );
    ...
    */
    function createAppeal(uint256 deal_index) external payable {
        ...
        // Creating appeal
        appeals[index].deal_index = index;
