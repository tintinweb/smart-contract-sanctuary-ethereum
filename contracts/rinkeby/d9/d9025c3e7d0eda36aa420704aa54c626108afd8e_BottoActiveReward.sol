    ...
    EIP712Upgradeable
{
    ...
    /// The collection name
    string public constant name = "The Botto Manifesto";
    ...
    function setURI(string memory newuri_) external virtual {
        require(
            ...
            "BottoActiveReward: must have uri setter role"
        );
    ...
    function setSupply(
        ...
        require(
            ...
            "BottoActiveReward: must have supply setter role"
        );
        ...
        virtual
    {
        require(
            ...
            "BottoActiveReward: must have minter role"
        );
    ...
    function redeem(
        ...
        require(
            ...
            "BottoActiveReward: permit expired"
        );
        ...
        if (permit_.recipient != address(0)) {
            require(
                ...
                "BottoActiveReward: recipient does not match permit"
            );
        }
        ...
        require(
            ...
            "BottoActiveReward: redeem cap reached for this address"
        );
        ...
        if (permit_.minimumPrice != 0) {
            if (permit_.currency == address(0)) {
                require(
                    ...
                    "BottoActiveReward: transaction value under minimum price"
                );

                (bool success, ) = permit_.payee.call{value: msg.value}("");
                require(success, "BottoActiveReward: transfer failed.");
            } else {
    ...
    function recover(
        ...
        require(
            ...
            "BottoActiveReward: must have admin role"
        );

        require(amount_ > 0, "BottoActiveReward: invalid amount");
        ...
        if (from == address(0)) {
            for (uint256 i = 0; i < ids.length; ++i) {
                ...
                require(
                    ...
                    "BottoActiveReward: exceeding total supply cap"
                );
            }
        }
    }
