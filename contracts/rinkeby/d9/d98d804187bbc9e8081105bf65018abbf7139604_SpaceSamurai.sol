...
contract SpaceSamurai is ERC721, Ownable {
 ...
 uint256 public mintPrice = 0.08 ether;
  ...
  uint256 private maxReserveCount = 25;
  ...
  uint256 public maximumAllowedTokensPerPurchase = 15;
  ...
  constructor(string memory baseURI) ERC721("Space Samurai", "SS") {
    setBaseURI(baseURI);
  }
