...
contract something is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbQW4v3qX4715G1CjTiUtmg6JRzP";
    ...
    uint256 public SALE_PRICE = 0.00606 ether;
    ...
    constructor(
    ) ERC721A("something", "something", 100, maxSupply) {
    }
