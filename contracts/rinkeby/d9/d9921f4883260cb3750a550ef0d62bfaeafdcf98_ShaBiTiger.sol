...
// 
contract ShaBiTiger is ERC721, Ownable {
...
abstract contract Revealable is ShaBiTiger {
...
abstract contract Presaleable is ShaBiTiger {
...
contract ShaBiTigerPresaleReveal is ShaBiTiger, Revealable, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) ShaBiTiger(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
