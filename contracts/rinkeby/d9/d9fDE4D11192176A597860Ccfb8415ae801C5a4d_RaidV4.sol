        ...
        unchecked {
            ...
            if (raider.startRound <= roundId) {
                ...
                for (_roundId; _roundId <= roundId; _roundId++) {
                    ...
                    console.log(
                        "roundId %s, reward amount %s",
                        roundId,
                        _roundReward(raider, round, boss)
                    );
        ...
        returns (uint32 _roundId, uint256 rewards)
    {
        ...
        unchecked {
            ...
            for (_roundId; _roundId < _lastRound; _roundId++) {
                ...
                boss = bosses[round.boss];
                console.log(
                    "reward in loop (1)- roundId %s, reward amount %s",
                    _roundId,
                    _roundReward(raider, round, boss)
                );
                rewards += _roundReward(raider, round, boss);
            ...
            for (_snapshotId; _snapshotId < snapshots.length; _snapshotId++) {
                console.log(
                    "reward from snapshot - roundId %s, reward amount %s",
                    _roundId,
                    snapshots[_snapshotId].attackDealt * raider.dpb
                );
            ...
            while (block.number > round.finalBlock) {
                ...
                boss = bosses[round.boss];
                console.log(
                    "reward in loop (2)- roundId %s, reward amount %s",
                    _roundId,
                    _roundReward(raider, round, boss)
                );
                rewards += _roundReward(raider, round, boss);
    ...
    function _roundReward(
        ...
        unchecked {
            ...
            if (
                ...
                console.log(
                    "hit #2 start - %s, raider start - %s, round final - %s",
                    round.startBlock,
                    raider.startBlock,
                    round.finalBlock
                );
            ...
            console.log(
                "blocks defeated %s, multiplier %s, raider dpb %s",
