...
contract RarePizzasBoxV4b is RarePizzasBoxV4 {
...
contract RarePizzasBoxV4 is RarePizzasBoxV3Fix {
    ...
    function _multiPurchase(uint256 n) internal virtual {
        ...
        for (uint256 i = 0; i < n; i++) {
            ...
            _safeMint(batchMintUsers[i], _getNextPizzaTokenId());
 ...
 *
 */
contract RarePizzasBoxV2Fix is RarePizzasBoxFix, IChainlinkVRFCallback, IRarePizzasBoxV2Admin {
    using AddressUpgradeable for address;
    using CountersUpgradeable for CountersUpgradeable.Counter;
    using SafeMathUpgradeable for uint256;
