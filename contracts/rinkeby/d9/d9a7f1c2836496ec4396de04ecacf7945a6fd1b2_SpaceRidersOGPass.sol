...
contract SpaceRidersOGPass is ERC721A, Ownable {
    ...
    uint256 public starCost = 100 ether;
    uint256 public claimableReserve = 600;

    StarToken public starToken =
        StarToken(0xE722dE4be5DCb7f7695B744C9fFB61c8d5C9482a);
    SpaceRiders public spaceRiders =
        SpaceRiders(0x31D69E26143560493EbcfF660d068e1821cd3A17);
    ...
    modifier mustPassChecks() {
        ...
        require(
            spaceRiders.balanceOf(msg.sender) >= 1,
            "Must hold a Space Rider"
        );
        require(
            _numberMinted(msg.sender) + 1 <= MAX_MINT_AMOUNT,
    ...
    function claim(bytes32[] memory proof) public mustPassChecks {
        require(totalSupply() < MAX_SUPPLY, "Supply limit exceeded");
        require(
    ...
    function mintWithStar() public mustPassChecks {
        require(
            totalSupply() < MAX_SUPPLY - claimableReserve,
            "Supply limit exceeded"
        );
        require(
            starToken.balanceOf(msg.sender) >= starCost,
            "Insufficient star"
        );
    ...
    {
        require(
            _newClaimableReserve <= MAX_SUPPLY - totalSupply(),
            "Must be less than or equal to remaining supply"
        );
    ...
    function setMaxSupply(uint256 _newMaxSupply) public onlyOwner {
        require(
            ...
            "Must be less than or equal to current max supply"
        );
        require(
            _newMaxSupply >= totalSupply() + claimableReserve,
            "Must be greater than or equal to current supply and claimable reserve"
        );
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool successC, ) = payable(0x51D8f89Fae2e82c4bAcF6Ec270f36624bc9C6D1E)
            .call{value: (balance / 100) * 20}("");
        (bool successD, ) = payable(0x2A76bAA2F2cFB1b17aE672C995B3C41398e86cCD)
