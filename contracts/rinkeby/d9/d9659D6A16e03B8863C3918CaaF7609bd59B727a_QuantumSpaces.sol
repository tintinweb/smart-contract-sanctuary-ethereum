    ...
    UUPSUpgradeable
{
    ...
    function initialize(address admin, address payable quantumTreasury)
        public
        virtual
        initializer
    {
        __QuantumSpaces_init(admin, quantumTreasury);
    }
    ...
    function __QuantumSpaces_init(
        ...
        __QuantumSpaces_init_unchained(admin, quantumTreasury);
    }
    ...
    */
        ...
        payable
    {
        ...
        if (block.timestamp > mintAuth.issuedAt + mintAuth.validPeriod)
            revert AuthorizationExpired(
                mintAuth.issuedAt + mintAuth.validPeriod,
                block.timestamp
            );
