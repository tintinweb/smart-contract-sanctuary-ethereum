...
/**
 ...
 | (___   /  \ \  / /| |__
  \___ \ / /\ \ \/ / |  __|
  ____) / ____ \  /  | |____
 |_____/_/    \_\/   |______|_ ______ _______
 |  __ \| |        /\   | \ | |  ____|__   __|
 | |__) | |       /  \  |  \| | |__     | |
 |  ___/| |      / /\ \ | . ` |  __|    | |
 | |    | |____ / ____ \| |\  | |____   | |
 |_|____|______/_/____\_\_|_\_|______|  |_|
 |  ____|   /\   |  __ \__   __| |  | |
 | |__     /  \  | |__) | | |  | |__| |
 |  __|   / /\ \ |  _  /  | |  |  __  |
 | |____ / ____ \| | \ \  | |  | |  | |
...
contract SavePlanetEarth is ERC721A, Ownable, ReentrancyGuard {

  bool public          canMint;

  uint public          totalAvailable    = 8888;
    ...
    payable
  {
    ...
    require(
      ...
      "Nice try... not sure what you're up to but the answer is no."
    );

    require(canMint, "Connot mint yet");
    ...
    require(
      ...
      "minting too many on this wallet address"
    );
