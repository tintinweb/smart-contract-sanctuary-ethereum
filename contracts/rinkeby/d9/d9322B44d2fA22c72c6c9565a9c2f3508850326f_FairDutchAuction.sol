...
contract FairDutchAuction is BaseTemplate {
    ...
    address internal immutable fee;
    ...
    function initialize(
        ...
        __Pausable_init();
        _setOwnership(owner);
        __PrimarySale_init(fee, payees, shares);
        _setDefaultRoyalty(royaltyRecipient, royaltyFraction);

        delayReveal = _delayReveal;
        mintableQuantity = saleConfig.quantity;
    ...
    function totalQuantity() public view returns (uint256) {
        return mintableQuantity + reservedTokens;
    }
        ...
        nonReentrant
    {
        ...
        require(totalTokensMinted < mintableQuantity, "Assets have sold out!");
        require(
            totalTokensMinted + quantity <= mintableQuantity,
        ...
        // set final price.
        if (totalTokensMinted + quantity == mintableQuantity) {
    ...
    Royalty
{
    ...
    uint256 public mintableQuantity;
    ...
    function withdrawUnmintedTokens()
        ...
        nonReentrant
    {
        uint256 unmintedTokens = mintableQuantity - totalSupply();
    ...
    function setMintableQuantity(uint256 quantity) external onlyOwner {
        mintableQuantity = quantity;
    }
...
abstract contract TokenMetadata is OwnableUpgradeable {
    ...
    modifier whenRevealIsDelayed() {
        require(delayReveal, "Delay metatadata reveal is not enabled");
        _;
    }
