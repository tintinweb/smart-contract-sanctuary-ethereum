...
contract FeverDreamFriends is ERC721A, Ownable {
    ...
    uint256 public _presale_price = 90000000000000000; // 0.09 ETH
    uint256 public _OG_price = 80000000000000000; // 0.08 ETH
    uint256 public _max_whitelist_mint = 1111; // can be changed

    bool private _saleActive = false;
    bool private _presaleActive = false;
    bool private _OGSale = false;

    address _developer = 0xa10CBBdf4064277BBa805C4f43bE1d36CE2f1FD7;
    address _marketer = 0xa1C799c6656884299B49a187833fa196C256f9c9;
    ...
    function withdraw_to(address _addr) external onlyOwner {
        uint256 balance = address(this).balance;
        payable(_developer).transfer(balance * 15 / 100);
        payable(_marketer).transfer(balance * 10 / 100);
        payable(_addr).transfer(balance * 75 / 100);
    }
    ...
    function presaleMintItems(uint256 amount) public payable {
        ...
        require(amount <= _max_whitelist_mint, "Mint: You may only mint a certain amount");
