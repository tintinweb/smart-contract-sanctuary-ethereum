...
contract SubdomainRegistrar is Ownable, ERC721A {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        jsonA = abi.encodePacked(jsonA, '", "attributes": [{"trait_type":"prefix","value":"', prefix, '"},{"trait_type":"base_domain","value":"', string(domainMap[domainIndex]), '"},{"trait_type":"base_price","value":"', toString(domainPriceMap[domainIndex]), '"},{"trait_type":"base_domain_index","value":"');
