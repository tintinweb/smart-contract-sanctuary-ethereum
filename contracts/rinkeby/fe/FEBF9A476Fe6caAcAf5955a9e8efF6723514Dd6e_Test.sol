     ...
     ReentrancyGuard 
{
  ...
  string public CANARY_PROVENANCE = "InsertHashHere";
  string public uriPrefix = '';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri = "ipfs://QmfT3pYRmYWPszMKgKqk8iSWnwYLqGYRdUNhCE5s5NKSR7/hidden.json";  // add hidden metadata URL here
  string public metadataBackup = "InstertLinkHere";
  
  uint256 public cost = 0.1 ether;
  uint256 public maxSupply = 5; /// @notice +1 to save on gas cost of <= vs <
...
/// @dev === Owner Control/Configuration Functions ===
  ...
  function setRevealed(bool _state) public onlyOwner {
    revealed = _state; //maybe change to true so can not hide after reveal
  }
...
//IERC2981 Royalty Standard
        ...
        external view override returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (royaltyAddress, (salePrice * 500) / 10000); // 500 is 5%
    }                                                
