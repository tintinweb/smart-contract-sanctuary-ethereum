...
contract Shiba is ERC721A, Ownable {
    ...
    constructor(string memory _baseUri)
        ERC721A("Shiba NFT", "SHNF", 55, MAX_TOKENS) // limit 10 mint
    {
    ...
    function _mintStatus() private view returns (uint8) {
        if (publicMintActive) {
            return 1;
        }
        return 0;
