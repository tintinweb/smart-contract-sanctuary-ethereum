...
contract DegenDisease is ERC721A,Ownable,WhitelistMint{
	...
	uint256 public _diseasePrice = 0.00 ether; 
    ...
    mapping(address => bool) private mintfree;
    ...
    function pubfreeMint(uint amount) external payable {
        require(amount>0,"Cannot mint 0 or below 0");
        require(amount<=limitmint,"Cannot mint 3 or more");
    ...
    function setWLNonActive() external onlyOwner{
        openForMint=false;
        openForFree=false;
    }
