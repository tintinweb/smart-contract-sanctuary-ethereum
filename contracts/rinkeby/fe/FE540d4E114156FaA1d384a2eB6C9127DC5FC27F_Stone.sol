...
contract Stone is Ownable, ERC20, Pausable {
    ...
    uint256 public taxRateMax = 10000;
    ...
    function setTaxRate(uint256 _taxRate) external onlyOwner {
        ...
        require(_taxRate <= taxRateMax, "TaxRate below max");

        taxRate = _taxRate;
        emit taxChanged(_taxRate);
    }

    function setTaxRateMax(uint256 _taxRateMax) external onlyOwner {
        taxRateMax = _taxRateMax;
    }
