...
contract PeopleDNA {
    ...
    {
        uint256 combinedParam = _tokenId + uint160(_minter);

        bytes memory encodedParams = abi.encodePacked(combinedParam);
...
// File contracts/DevNftPunks.sol


pragma solidity ^0.8.0;
contract DevNftPunks is ERC721, ERC721Enumerable,PeopleDNA{
    ...
    constructor (uint256 _maxSupply) ERC721 ("DevNftPunks","DVNP"){
    ...
    function mint() public payable  {
        ...
        require(current < maxSupply,"No fabi punks left :(  Pasame plata ");
    ...
    function paramURI(uint256 _dna) internal view returns(string memory){
    ...
    function imageByDNA(uint256 _dna) public view returns (string memory) {
        string memory baseURI = _baseURI();
        string memory paramsURI = paramURI(_dna);
