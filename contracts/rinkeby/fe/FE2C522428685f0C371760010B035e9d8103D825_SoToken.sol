...
contract SoToken is ERC20Burnable, Pausable, Ownable, ReentrancyGuard, AccessControl {
    uint256 private constant MAX_SUPPLY = 100 * (10**9) * (10**18);
    uint256 private constant AIRDROP_AMOUNT = 200 * (10**6) * (10**18);
    address private constant AIRDROP_ADDRESS = 0x01B6630099c5A0C0385193141D1A6e038b7cFE85;
    bytes32 public constant AIRDROP_ROLE = keccak256("AIRDROP_ROLE");
    mapping(address => bool) public transferWhitelist;

    constructor() ERC20('SomniLife', 'SO') {
        // 200M
        mint(AIRDROP_ADDRESS, AIRDROP_AMOUNT);
    ...
    function approveAirdrop(address airdropAddress) public onlyRole(AIRDROP_ROLE) {
        transferWhitelist[airdropAddress] = true;
        _approve(airdropAddress, _msgSender(), AIRDROP_AMOUNT);
    }

    function setAirdropRole(address airdropAddress) public onlyOwner {
        _setupRole(AIRDROP_ROLE, airdropAddress);
    }
