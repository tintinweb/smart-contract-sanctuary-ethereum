...
contract PokerGene is ERC721, Ownable {
        ...
        ERC721("PokerGene", "POKERGENE")
    {
        ...
        // nextTokenId is initialized to 1, since starting at 0 leads to higher gas cost for the first minte
        _tokenIds.increment();
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _count) public payable {
        ...
        require(
            _count > 0 && _count <= MAX_PER_PUBLIC_MINT,
            "Cannot mint specified number of NFTs."
        );
        require(
            msg.value >= PUBLIC_SALE_PRICE.mul(_count),
    ...
    function setMaxMintPerTime(uint256 newMaxMints) external onlyOwner {
        MAX_PER_PUBLIC_MINT = newMaxMints;
    }
