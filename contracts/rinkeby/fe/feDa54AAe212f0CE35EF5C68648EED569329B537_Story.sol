...
//  }
  ...
  //  CREATE A USER
  function setStory(uint256 _tokenId, string memory _tokenText) public  {
  ...
  function readStory(uint256 _tokenId) public view returns (string memory) {
    ...
    return string(abi.encodePacked( "Token #",Strings.toString(_tokenId), " ", storyData[_tokenId].tokenText));
  }
...
//  }
  ...
  function mint(uint256 _quantity) public payable {
    ...
    for (uint256 i = 0; i < _quantity; i++ ) {
      ...
      totalSupply++;
      setStory(newTokenId, string(abi.encodePacked("Zlerp is here #", newTokenId)));
