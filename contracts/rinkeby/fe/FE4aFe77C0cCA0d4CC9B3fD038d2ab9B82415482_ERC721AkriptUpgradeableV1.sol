...
contract ERC721AkriptUpgradeableV1 is
    Initializable,
    ERC721Upgradeable,
    ...
    ERC721BurnableUpgradeable
{
    ...
    function transfer(
        ...
        address _to,
        uint256 _tokenId
    ) public onlyERC721Owner(_tokenId) {
        safeTransferFrom(_from, _to, _tokenId);
    }

    function updateMetadata(uint256 _tokenId, string memory _uri)
        public
        onlyERC721Owner(_tokenId)
    {
