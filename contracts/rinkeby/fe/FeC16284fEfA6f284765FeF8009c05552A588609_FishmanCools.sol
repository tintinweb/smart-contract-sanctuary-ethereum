...
// File: contracts/FishmanCools.sol



// Amended by FishmanCools
/**
    !Disclaimer!
...
contract FishmanCools is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FishmanCools", "FC") {
    setHiddenMetadataUri("ipfs://QmaAsKgjhiEm5q8SQkV15eDyk6VkDAM3p4Mbw8XCuAUXsR/Hidden.json.json");
  }
