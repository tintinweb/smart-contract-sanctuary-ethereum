...
//   / /   / _ \/ __ \/ __ \/ __ \/ / __  / 
//  / /___/  __/ /_/ / /_/ / /_/ / / /_/ /  
// /_____/\___/\____/ .___/\____/_/\__,_/   
//                 /_/                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xad97F1E9289fa70B234976eFa4a1AB6780A6B666,0x2309a2C17CC812e8B9D4EA091F62409244FD7610,0xC9398465ab00999D2A35AAbcDfBfdaB6ed669338];
  uint256[] public payableFees = [5,45,40,10];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQp73eH3f72DwbUGNATp8U4rBsuk92r55w5MbZthfaZD3/";
...
contract LeopoldContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/3X3qhs2iLonD9FEm1QNg/contract-metadata";
    }
}
