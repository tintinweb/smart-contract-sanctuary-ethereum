...
uint256 public startSupply;
  ...
  constructor(string memory _name, string memory _symbol, uint256 maxSupply,uint256 startTokens, uint cost) Ownable() ERC721(_name, _symbol) {
    MAXSNOW = maxSupply;
    price = cost;
  ...
  function buy() external payable {
        ...
        if (totalSupply() >= startSupply){price = address(this).balance / totalSupply() * 120/ 100;}
