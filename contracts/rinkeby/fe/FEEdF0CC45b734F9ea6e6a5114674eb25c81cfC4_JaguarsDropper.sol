...
contract JaguarsDropper is Multicall
{
    ...
    Jaguars public immutable jaguar;
    ...
    constructor(ApeGang _ape, Jaguars _jaguar, bytes32 _whitelistRoot)
    {
        ape           = _ape;
        jaguar        = _jaguar;
    ...
    external onlyWhitelisted(keccak256(abi.encodePacked(tokenId, count)), proof)
    {
        ...
        {
            jaguar.mint(to, 1 + __manifest.draw(keccak256(abi.encode(seed, i)))); // ids are 1 to 5000
        }
    }
}
