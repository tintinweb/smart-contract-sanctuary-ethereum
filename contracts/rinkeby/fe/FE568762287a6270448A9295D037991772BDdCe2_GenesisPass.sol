...
contract GenesisPass is ERC721A, Ownable, ReentrancyGuard, TimeBlock {
  ...
  uint  public MAX_SUPPLY_WAVE1 = 100;
  uint  public MAX_SUPPLY_WAVE2 = 900;
  uint  public MAX_SUPPLY_WAVE3 = 100;

  uint public BATCH1 = 3 * 10**17;
  uint public BATCH2 = 5 * 10**17;
  uint public BATCH3 = 10**18;
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    ...
    function setWave2(bool _isWave2) public onlyOwner{
        isWave2 = _isWave2;
    }
    function setWave3(bool _isWave3) public onlyOwner{
        isWave3 = _isWave3;
    }
