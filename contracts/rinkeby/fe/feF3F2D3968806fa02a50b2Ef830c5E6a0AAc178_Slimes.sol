...
contract Slimes is ERC721, Ownable {
    ...
    constructor() ERC721("Slimes", "SLM") {
        totalAmount = 10;
        TOKENS_PER_WALLET = 3;
        baseURI = "https://gateway.pinata.cloud/ipfs/QmT4bCPmhk4kzCxtSoGuHHXGECTvor5c5Yz9WZRgXpojtr/";
    }
    ...
    modifier notSoldOut(uint256 amount) {
        require(totalMinted + amount <= totalAmount, "Sold out");
        _;
    }
    ...
    function safeMint(uint256 amount) public onlyOwner notSoldOut(amount) {
