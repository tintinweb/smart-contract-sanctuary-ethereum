...
contract TheRoosterHood is ERC721Enumerable, Ownable
{
    using SafeMath for uint256;
    using Strings for uint256;

    uint public constant _TOTALSUPPLY = 9494;
    uint public maxQuantity =3;
    // WL 0.06  // Public 0.08
    ...
    constructor(string memory baseURI) ERC721("The Rooster Hood", "TRH") {
        setBaseURI(baseURI);
    ...
    function reserveNFT(uint chosenAmount) public onlyOwner {
    ...
    //     string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "The Rooster Hood", "description": "THE RoosterHOOD is a collection of 9494 NFT, based on Brooster’s trials and tribulations. Putting community at the center of the collection, no yacht party but long term rewards and support.", "seller_fee_basis_points": 700, "fee_recipient": "0x54d6b6c93180264285b906f42a3d6330fd0da3a1"}'))));
