...
contract NftHunterPass is ERC721Enumerable, Ownable {
    //supply counters
    ...
    constructor() ERC721("NFT Hunter Pass", "NHP") {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory metadata = string(abi.encodePacked(
            '{"name": "Nft Hunter Pass NFT #',
            Strings.toString(tokenId),
            '", "description": "This is NFT Hunter nft.", "image": "' ,
            pass.imagePath,
            '", "attributes":[',
