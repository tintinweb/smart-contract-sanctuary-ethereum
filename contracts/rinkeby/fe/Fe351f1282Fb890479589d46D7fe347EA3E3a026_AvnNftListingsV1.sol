...
contract AvnNftListingsV1 is IAvnNftListingsV1 {
    ...
    isListedForBatchSale(_batchId)
  {
    ...
    emit LogSoldFromBatch(nftId, _avnPublicKey, msg.sender, _batchId, batch[_batchId].saleIndex);
...
interface IAvnNftListingsV1 {
  ...
  event LogSoldFromBatch(uint256 indexed nftId, bytes32 indexed avnPublicKey, address indexed buyer, uint256 batchId, uint64 saleIndex);
