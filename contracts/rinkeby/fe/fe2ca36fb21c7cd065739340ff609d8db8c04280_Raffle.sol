...
contract Raffle is VRFConsumerBase {
    ...
    uint256 public constant MAX_WINNERS = 1500;
    ...
    event randomSeedAdded(bytes32 requestId);
    ...
    function addRandomSeed() public onlyOwner returns (bytes32 requestId) {
        require(
    ...
    function selectWinners(uint256 winnerBatchSize) external onlyOwner {
        ...
        require(winners.length + winnerBatchSize <= MAX_WINNERS, "exceeds the number of whitelist allocation");
    ...
    function getBatchedWinners(uint256 offset, uint256 qty) external view returns (address[] memory results) {
        ...
        override
    {
        ...
        emit randomSeedAdded(requestId);
    }
