...
contract ShibnobiNFT is ERC721Enumerable, IERC2981, Ownable, ReentrancyGuard {
  ...
  ) ERC721("Shinobi NFT", "Shinja") {
    signer = 0xD44FbeB26c88F0f18f72664E3c446E0C2836908D;
  ...
  function batchUriByOwner(address account) external view returns (string[] memory) {
  ...
  function mintListed(
    ...
    require(_validateData(sender, signature), "Not whitelisted");
