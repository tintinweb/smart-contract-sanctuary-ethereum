...
// Creator: LuckyDucklings Dev Team
...
contract LuckyERC721A is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxWhitelistSupply = 2;
  uint256 public maxPresaleSupply = 4;
  ...
  constructor(
    ...
    function mint(uint256 _mintAmount) public payable callerIsUser {
       if(whitelistMintEnabled) {
        ...
        require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid mint amount!');
        require(totalSupply() + _mintAmount <= maxPresaleSupply, 'Max Presale supply exceeded!');
