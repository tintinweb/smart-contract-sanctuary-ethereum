...
contract YellowDuckCollection is ERC721Enumerable, Ownable {
    ...
    mapping(bytes => bool) usedYellowlistBackendSignatures;
    ...
    function _verifyBackendSignature(
        ...
        require(valid, "Message was not signed by the server admin wallet");
    ...
    function enableYellowlistState() public payable onlyOwner {
        saleState = 0;
    }

    // transition to whitelist state
    function enableWhitelistState() public payable onlyOwner {
        saleState = 1;
    }

    // transition to public sale state
    function enablePublicSaleState() public payable onlyOwner {
        saleState = 2;
    }
    ...
    // set new extension for metadata (ex: .json)
        ...
        requireWhitelistState
    {
        require(
            ...
            "You may mint up to 3 ducks on the whitelist"
        );
