...
// File: contracts/BendyBrains.sol
    ...
    ReentrancyGuard
{
    ...
    uint256 public constant WHITELIST_MINT_LIMIT = 4;
    ...
    ) ERC721A("BendyBrainsTest", "BendyB", MAX_PER_WALLET, MAX_SUPPLY) Whitelist("BendyB", "4") { // CHANGE ME
        ...
        isSenderWhitelisted(_signedQty, _nonce, _signature)
    {
        ...
        require(whitelistSalesMinterToTokenQty[msg.sender] + _quantity <= _signedQty, "exceed signed quantity");
