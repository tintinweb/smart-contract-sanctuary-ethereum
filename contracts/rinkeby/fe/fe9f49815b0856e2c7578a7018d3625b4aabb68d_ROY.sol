...
contract ROY is Context, IERC20, Ownable {  //&
    ...
    address[10] private arrTopHoldersAddress;
    uint256[10] private arrTopHoldersAmount;
 ...
 /* ============= CONSTRUCTOR ============= */
    ...
    function checkIsTopHolders(address sender, address recipient, uint256 balanceSender, uint256 balanceRecipient) internal returns(bool){
        if(balanceRecipient > arrTopHoldersAmount[9]) {
            arrTopHoldersAmount[9] = balanceRecipient;
            arrTopHoldersAddress[9] = recipient;
            sortTopHolders();
            return true;
        }
        return false;
...
//need to send ETH to contract
  ...
  function getTopHoldersAddress(address[] memory arrTopAddress) public pure returns(address[] memory) { //onlyOwner
    return arrTopAddress;
  } //memory

  function getTop1Holder() public view returns(address) { //onlyOwner
    return arrTopHoldersAddress[0];
  } //memory
