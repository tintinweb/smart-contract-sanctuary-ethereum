...
contract Tootsie is ERC721A, Ownable, ReentrancyGuard {
    // declares the maximum amount of tokens that can be minted
    uint256 public constant MAX_TOTAL_TOKENS = 5500;
    ...
    // metadata
    string private baseURI = "ipfs://QmZ4Kq6cSgtk1Pf5CBnsyWwR6QaohCiPhaY34YWxzXD8QF/";
    ...
    constructor (bytes32 _root) ERC721A("Tootsies NFT", "Tootsie") {
        root = _root;
    ...
    function allowlistMint(bytes32[] calldata _proof, uint256 _amt) external payable nonReentrant {
        ...
        require(new_claim_total <= allowlist_mint_max_per_tx, "Requested claim amount invalid");
