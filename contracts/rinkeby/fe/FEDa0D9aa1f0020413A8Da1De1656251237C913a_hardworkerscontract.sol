...
contract hardworkerscontract is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Hard Workers", "HWKS") {
    setHiddenMetadataUri("ipfs://QmRBJx8K69q5LZ595r9tpRA6QDsBJxHn9iubFiYVg86k3s/hidden.json");
  }
