...
contract KHANG is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    // Batch minting for specific address
    _safeMint(address(0x06b5a239FD9c3601d1213998aC5a0228b887cA7E), 20);
  }
