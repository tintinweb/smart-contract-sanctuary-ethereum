...
// File: contracts/RedPandaFrens.sol

pragma solidity ^0.8.7;

contract RedPandaFrens is Ownable, ERC721, NonblockingReceiver {
    using Strings for uint256;

    address public _owner;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT = 8894;
    ...
    constructor(address _layerZeroEndpoint) ERC721("Red Panda Frens", "RPF") { 
        _owner = msg.sender;
