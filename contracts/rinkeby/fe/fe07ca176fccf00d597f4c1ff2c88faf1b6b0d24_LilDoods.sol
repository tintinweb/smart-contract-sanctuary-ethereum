...
contract LilDoods is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LilDoods", "LDS") {
    setHiddenMetadataUri("ipfs://QmUXd3FSCptuFNDL7sF2rhTfBoenAYmkbH1SzxkN1HYpmB.json");
  }
