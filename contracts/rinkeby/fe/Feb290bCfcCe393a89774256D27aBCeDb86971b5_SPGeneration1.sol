...
import "./ISideCar.sol";
import "./INftMasterToken.sol";

contract SPGeneration1 is INftMasterToken, ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  ISideCar[] public sideCars; //TODO array of sidecars
  ...
  //TODO - reveal and update first stage URI in one go - than having 2 func calls
  ...
  */
  ...
  function _afterTokenTransfers(address from, address to, uint256 tokenId, uint256 quantity) internal override {
      //TODO - validate if this call is needed
