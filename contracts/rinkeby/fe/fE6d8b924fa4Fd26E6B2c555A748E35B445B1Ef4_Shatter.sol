...
contract Shatter is ERC721A, EIP2981AllToken, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns(string memory) {
        ...
        if (shatters > 1) {
            ...
            attr = string(abi.encodePacked('[{"trait_type": "Edition", "value": "', tokenId.toString(), '"},{"trait_type": "Shattered", "value": "', shatterStr, '"},{"trait_type": "Fused", "value": "', fuseStr, '"}]'));
        } else {
            if (isShattered) {
                shatterStr = "Yes";
            }
            ...
            attr = string(abi.encodePacked('[{"trait_type": "Shattered", "value": "', shatterStr, '"},{"trait_type": "Fused", "value": "', fuseStr, '"}]'));
        }
        return string(
            abi.encodePacked(
