...
abstract contract IUSM is IERC20 {
    ...
    function refreshPrice() public virtual returns (uint collateralPrice, uint syntheticPrice, uint updateTime);

    function latestPrice() public virtual view returns (uint collateralPrice, uint syntheticPrice, uint updateTime);
    function latestOraclePrice() public virtual view returns (uint collateralPrice, uint syntheticPrice, uint updateTime);
