...
import "./MintyardUser721Token.sol";
...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new MintyardUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        MintyardUser721Token token = MintyardUser721Token(address(addr));
...
contract MintyardUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
