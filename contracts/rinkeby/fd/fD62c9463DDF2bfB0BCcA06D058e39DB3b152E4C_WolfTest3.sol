...
contract WolfTest3 is ERC721A, ERC2981, Ownable, ReentrancyGuard {
  ...
  uint256 public free_mint = 0;
  uint256 public price_after_free_mint = 1000000000000000;
...
modifier mintCompliance(uint256 _mintAmount) {
  ...
  function setFreeMintAmount(uint256 _free_mint_amount) public onlyOwner {
    free_mint = _free_mint_amount;
    if (free_mint >=  _publicMinted()){
      setCost(0);
    }
  }
