...
contract DehyratemanTest5 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DehyratemanTest5", "DYM") {
    setHiddenMetadataUri("ipfs://QmTg7qnrueBSyFKVPKCXbuLDWwCqgTtArdUtupGuCyUL3w/hidden.json");
  }
