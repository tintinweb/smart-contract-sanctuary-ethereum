...
contract iRinkeby is IIllogics, ERC721Enumerable, Ownable, VRFConsumerBase {
    /**************************
     *
...
// Data structure that defines the elements of stakedToken
    ...
    uint256 public constant GOOP_INTERVAL = 1 minutes; // The interval upon which Goop is calcualated
    uint256 public goopPerInterval = 50; // Goop awarded per interval
  ...
  event RequestedRandomNumber(bytes32 indexed requestId); // emitted when the ChainLink VRF is requested
   ...
   /**
    ...
    function setVerifyVRF() external onlyAdmin {
        require(!verifyVRF, "this is a oneWay function it can not be called twice");
        collectionDNA[1] = 0;
        periodCounter = 0;
        verifyVRF = true;
    }
  ...
  /**
    ...
    function verify125() public pure returns(uint256){
        return 5;
    }
}
