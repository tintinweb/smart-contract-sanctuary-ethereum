...
contract StakeToken is ERC20, Ownable {
  ...
  IERC721 private _immortalStakedToken;
  ...
  constructor( address _rewardsTokenAddr, address _immortalStakedTokenAddr, address _originalTokenOwner, 
    ...
    _immortalStakedToken = IERC721(_immortalStakedTokenAddr);
  ...
  function stakeTokens(uint256[] memory _tokenIds, uint256[8] memory kindNFT) public {
    ...
    for (uint256 _i = 0; _i < _tokenIds.length; _i++) {
        _immortalStakedToken.transferFrom(msg.sender, address(this), _tokenIds[_i]);
    }
  ...
  function unstakeTokens(bool _shouldHarvest) external {
    ...
    for (uint256 _i = 0; _i < _staker.nftTokenIds.length; _i++) {
        _immortalStakedToken.transferFrom(
            address(this),
            msg.sender,
