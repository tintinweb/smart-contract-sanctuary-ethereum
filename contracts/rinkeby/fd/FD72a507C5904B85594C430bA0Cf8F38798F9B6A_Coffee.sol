...
contract Coffee is Ownable, ERC721A {

    uint256 public cost = 0.001 ether;
    uint256 public maxSupply = 88888;
    uint256 public mintAmountPerTx = 10;
    uint256 public mintEndTime = 1662134400;
    mapping(address => bool) public mintlist;

    constructor() ERC721A("Coffee", "Coffee") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(
            quantity > 0 && quantity <= mintAmountPerTx,
            "Invalid mint amount!"
        );
        require(
            !mintlist[msg.sender],
            "You have mint already"
        );
        require(
