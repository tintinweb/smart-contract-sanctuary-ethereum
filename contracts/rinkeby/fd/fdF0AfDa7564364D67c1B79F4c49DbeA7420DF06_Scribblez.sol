...
contract Scribblez is ERC721A, ReentrancyGuard, Ownable {
    ...
    string baseURI = "ipfs://QmTuTqK4ooXS4XVGZLowBcyKXdAb2vEfxaJ48PBdG4fNgk/";
    string notRevealedURI = "ipfs://xxx/not-revealed.json";
    ...
    function setWhitelistAddress(address[] calldata accounts)
        external
        onlyOwner
    {
