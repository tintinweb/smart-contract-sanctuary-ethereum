...
import "./IERC721RaribleMinimal.sol";
...
contract ERC721RaribleFactoryC2 is Ownable {
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, uint salt) external {
        ...
        IERC721RaribleMinimal token = IERC721RaribleMinimal(address(beaconProxy));
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) view internal returns(bytes memory){
        return abi.encodeWithSelector(bytes4(keccak256(bytes("__ERC721Rarible_init(string,string,string,string,address,address)"))), _name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);
    }
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) view internal returns(bytes memory){
        return abi.encodeWithSelector(bytes4(keccak256(bytes("__ERC721RaribleUser_init(string,string,string,string,address[],address,address)"))), _name, _symbol, baseURI, contractURI, operators, transferProxy, lazyTransferProxy);
    }
}
