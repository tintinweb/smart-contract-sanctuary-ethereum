...
contract QRNG_Testing is ERC721, RrpRequesterV0, Ownable {
    ...
    constructor(address _airnodeRrp)
      ...
      ERC721("QRNG_Testing", "QRNG_Testing") {}
    ...
    function requestNewCharacterExample(uint256 size, uint256 howMany) external {
          ...
          bytes32 requestId = airnodeRrp.makeFullRequest(
            ...
            abi.encode(bytes32("1u"), bytes32("size"), size, howMany)
          );
    ...
    function fulfillUint256Array(bytes32 requestId, bytes calldata data, uint256 theAmount)
        external
        onlyAirnodeRrp
    {
        require(
        ...
        for (uint x = 0; x<theAmount; x++) {

        uint256 newId = characters.length;
        uint256 strength = (qrngUint256Array[theAmount] % 100000000);
        uint256 intelligence = ((qrngUint256Array[theAmount] % 100000000) / 10000000);
        uint256 mana = ((qrngUint256Array[theAmount] % 100000000) / 1000000);
