...
contract MyContructlessson is ERC721URIStorage, Ownable {
   ...
   /**
     ...
     */
    function changeTokenURI(uint256 tokenId) public onlyOwner {

        string memory jsonFile = string(abi.encodePacked('metadata', Strings.toString(tokenId), '-used.json'));
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeihszjjp7w3sgq64miltu6wutbmhgp3upcg7frxkw3wpqbas3mpcjy/";
    }
