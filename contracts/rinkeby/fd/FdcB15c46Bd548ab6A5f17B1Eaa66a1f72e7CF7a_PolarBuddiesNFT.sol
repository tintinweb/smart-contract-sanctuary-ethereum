...
contract PolarBuddiesNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Polar Buddies NFT", "POLAR") {
    setHiddenMetadataUri("ipfs://QmRmjPaRAYchKUB4LYoJsdo8bgQNto9V4KJEm87ozFbZ8g/hidden.json");
  }
