    ...
    IERC721ReceiverUpgradeable
{
    ...
    event RoyaltiesPaid(uint256 tokenId, uint256 value);
		event LogMarketplaceListingFeeUpdated(uint256 newFees, address senderAddress);
    ...
    function updateFeeAddress(address _newFeeAddress) public OnlyAdmin {
		...
		function updateMarketplaceListingFees(uint256 _marketplaceListingFees) public OnlyAdmin {
        marketplaceListingFees = _marketplaceListingFees;
        emit LogMarketplaceListingFeeUpdated(_marketplaceListingFees, _msgSender());
    }
