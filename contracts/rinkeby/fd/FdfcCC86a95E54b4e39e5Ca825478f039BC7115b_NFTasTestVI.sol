...
contract NFTasTestVI is ERC721, Ownable, ReentrancyGuard {
    uint256 public constant MAX_SUPPLY = 2500;

    uint256 public whitelistCost = 50000000 gwei;
    uint256 public publicCost = 90000000 gwei;
    ...
    constructor() payable ERC721("NFT AS Test VI", "NFTASTVI") {}
