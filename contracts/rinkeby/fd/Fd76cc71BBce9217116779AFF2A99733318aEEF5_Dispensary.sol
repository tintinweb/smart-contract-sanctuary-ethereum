...
contract Dispensary is IERC1155Receiver {
    ...
    mapping(uint256 => mapping(address => bool)) public hasBeenDispensed;
    ...
    function setStrainForDispense(address _strain) public {
    ...
    function dispense(uint256 _bud) public {
        require(
            !hasBeenDispensed[_bud][msg.sender],
            "already dispensed bud :("
        );
        hasBeenDispensed[_bud][msg.sender] = true;
