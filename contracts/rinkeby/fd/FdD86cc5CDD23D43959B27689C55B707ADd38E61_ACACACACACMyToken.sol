...
contract ACACACACACMyToken is ERC20, ERC20Burnable, ERC20Freezable, Ownable {
    constructor() ERC20("ACACACACACMyToken", "MTK") {
        _setAccess(Access.OWNABLE);
        FeatureType[] memory _features = new FeatureType[](2);
