...
contract Animals2 is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public PRESALE_PRICE = 0.005 ether;
    ...
    constructor() ERC721("Animals2", "AML") {
        ...
        onlyOwner
    {
        ...
        for (uint256 k = 0; k < airdropAddress.length; k++) {
            _mintAMLS(airdropAddress[k], numberOfTokens);
        }
    }
    ...
    function mintPublic(uint256 numberOfTokens) external payable nonReentrant {
        ...
        _mintAMLS(msg.sender, numberOfTokens);
    }
    ...
    function _mintAMLS(address to, uint256 numberOfMints) internal {
