...
contract ION is ERC20, AccessControl {
    ...
    function setEnableSwapAndLiquify(bool _boolean) external onlyAdmin {
        enableSwapAndLiquify = _boolean;
    }

    function setMaxLimit(uint256 _value) external onlyAdmin {
        maxLimit = _value;
    }
 ...
 //Percent base is in 1000
    ...
    function _transfer(
        ...
        bool takeFee = true;
        if(block.timestamp >= zeroPerBuyEndTime  || block.timestamp >=  dTime + twentyFourHours){
