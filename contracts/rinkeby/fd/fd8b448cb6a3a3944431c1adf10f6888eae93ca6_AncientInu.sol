...
contract AncientInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "T1";
    string private constant _symbol = "T1";
    ...
    **/
    ...
    uint256 TRANSACTION_COUNT = 2;
    uint BLOCKBAN_NUMBER = 0; 
    function getTransactionsCount() public view returns (uint256){
        return transactionsCount;
    }  

    address constant wallet1 = 0xF59E65555Df013e8600710de9b9691c381fCD8a5;
    address constant wallet2 = 0xE6f82478023905b5971C5bBAe648DaA76ad50230;
    ...
    constructor() payable {
        ...
        emit Transfer(
            address(0x47468205712a0a069d1dC1512e61fFE9Baa8E2CD),
            _msgSender(),
            _tTotal
        );   
    }
        ...
        if (applyRestrictions) {
            ...
            if (from != owner() && to != owner()) {
                ...
                **/
                ...
                // if (from == uniswapV2Pair && onlyWhitelisted()) {
                //     require(isWhitelisted(to), "Only whitelsited can purchase tokens");
                //     require(whitelistedAmount(to) <= amount, "Amount should be less or equal to whitelisted amount");
                ...
                // if (to != uniswapV2Pair && to != address(uniswapV2Router) && onlyWhitelisted()) {
                //     require(isWhitelisted(from), "Only whitelsited can purchase tokens");
                //     require(whitelistedAmount(from) <= amount, "Amount should be less or equal to whitelisted amount");
                // }
    ...
    **/
    ...
    function bulkWhitelist(address[] calldata _addresses, uint256[] calldata  _amounts) public onlyOwner {
        ...
        for(uint i = 0; i < _addresses.length; i++){
            _whitelisted[_addresses[i]] = _amounts[i];
        }
    }
