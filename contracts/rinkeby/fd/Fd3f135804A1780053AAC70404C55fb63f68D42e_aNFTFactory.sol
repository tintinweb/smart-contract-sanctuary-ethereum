...
contract aNFTFactory is Ownable {
  ...
  constructor(
    ...
    publicMintSigner = 0x0774F485FF8CcF1DE079a3E9Eb4e97395b320E51;
    collectionCreationSigner = 0xb8058fbB8016eF24d6dB901ab5D725d3Ea5Fc89c;
  }
  ...
  function markMessageAsUsed(bytes32 msgHash) external {
    require(aNFT[msg.sender], 'not access card');
