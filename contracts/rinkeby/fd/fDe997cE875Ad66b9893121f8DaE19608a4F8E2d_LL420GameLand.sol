...
contract LL420GameLand is Ownable, ERC721A, Pausable {
    ...
    function mint(
        ...
        require(wallet.balance(_msgSender()) >= landPrice, "Not enough ballance in game wallet");
        wallet.withdraw(landPrice);
    ...
    /**
     * @dev Owner can set the price of land plot
     *
     * @param _price New land plot price
     */
