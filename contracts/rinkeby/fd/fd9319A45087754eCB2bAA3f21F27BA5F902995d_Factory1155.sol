...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new BluebitNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BluebitNFTUser1155Token token = BluebitNFTUser1155Token(address(addr));
...
contract BluebitNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
