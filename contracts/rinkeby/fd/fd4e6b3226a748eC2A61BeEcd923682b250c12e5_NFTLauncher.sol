...
contract NFTLauncher is VRFConsumerBase, ChainlinkClient  {
    ...
    constructor(string memory chainLinkJobId,  address _vrfCordinator, address _oracle, address linkTokenAddress, address _routerAddress, bytes32 _keyHash, uint256 chainlinkPackGenerationPrice, uint256 chainlinkRandomnessAmountFee, uint256 _packLaunchCost)
        VRFConsumerBase(
            _vrfCordinator,
            linkTokenAddress
        )
