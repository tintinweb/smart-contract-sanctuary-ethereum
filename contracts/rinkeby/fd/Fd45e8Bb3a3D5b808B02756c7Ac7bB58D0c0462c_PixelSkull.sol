...
contract PixelSkull is AdminControl, ReentrancyGuard {
    ...
    function setNftData(string[] memory _tokensData, address payable[] memory  _artists)
        public
        adminRequired
    {
    ...
    function withdraw(string memory imageHash)
        private
    {
        uint256 valueTransferArtist = (msg.value / 100) * 70;
        ...
        emit Withdraw(contractData.payoutAddress, address(this).balance);
    }
}
