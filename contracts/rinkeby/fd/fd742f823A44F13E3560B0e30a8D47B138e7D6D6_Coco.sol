...
contract Coco is ERC20Burnable, Ownable{
    ...
    uint256 public immutable DEFAULT_START_TIMESTAMP; // This block timestamp will be used for ID's that have never claimed $COCO
    address public waveCatchers;
    mapping (uint256 => uint256) tokenToLastClaimed;

    constructor() ERC20("Coco", "COCO") {
        DEFAULT_START_TIMESTAMP = block.timestamp - (24*60*60);
    }
