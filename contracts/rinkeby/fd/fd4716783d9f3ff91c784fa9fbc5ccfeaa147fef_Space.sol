...
contract Space is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        __ERC20_init("Space", "SPACE");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();

        _mint(msg.sender, 150000000);
    }
