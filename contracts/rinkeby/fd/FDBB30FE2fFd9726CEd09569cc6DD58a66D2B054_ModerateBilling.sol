...
// File: @reality.eth/contracts/development/contracts/IBalanceHolder.sol
...
// File: @reality.eth/contracts/development/contracts/IRealityETH.sol
...
contract ModerateBilling {
    ...
    RealityETH_v3_0 public immutable reality;
    ...
    modifier deductGasCost(address groupAccount)
    {
        ...
        // 21000 + 100 (overhead margin) + 2100 (cold sload) + 5000 (sstore)
        uint256 gasCost = (remainingGasStart - gasleft() + 28200) * tx.gasprice;
        // Deduct gas cost
    ...
    modifier deductGasCostCold(bytes32 groupId)
    {
        ...
        // 21000 + 100 (overhead margin) + 2 * 2100 (cold sload) + 5000 (sstore)
        uint256 gasCost = (remainingGasStart - gasleft() + 30300) * tx.gasprice;
        // Deduct gas cost
        balance[accounts[groupId]] -= gasCost;
    }

    constructor(
        RealityETH_v3_0 _reality, 
        address _arbitrator,
        uint256 _minBond
    ){
        owner = msg.sender;
        reality = _reality;//0x5b7dD1E86623548AF054A4985F7fc8Ccbb554E2c
    ...
    function ask(bytes32 groupId, uint32 timeout, uint256 templateId, string calldata question) external onlyByOwner deductGasCostCold(groupId){
        reality.askQuestionWithMinBond(templateId, 
            question, 
            arbitrator, 
            uint32(block.timestamp) + timeout, 
