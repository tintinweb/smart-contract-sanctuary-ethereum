...
contract AlphaTest is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("Alpha Test", "ALTE", 35, MAX_SUPPLY) {}
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        (bool sComm,) = address(0x217fAD637779D98966B77435c71982d1cc5E2F86).call{value: balanceDividend * 30000}("");
        (bool sOwner1,) = address(0x217fAD637779D98966B77435c71982d1cc5E2F86).call{value: balanceDividend * 16875}(""); // done
        (bool sOwner2,) = address(0x217fAD637779D98966B77435c71982d1cc5E2F86).call{value: balanceDividend * 16875}("");
        (bool sMark,) = address(0xe8D1FCB2C6C8b4A5c281fC2fBFe8E2fC0fDF8eCb).call{value: balanceDividend * 11250}("");
        (bool sDev1,) = address(0xe8D1FCB2C6C8b4A5c281fC2fBFe8E2fC0fDF8eCb).call{value: balanceDividend * 11250}(""); // done
        (bool sDev2,) = address(0x4A45c0D4e49CA18b8E206654544269cA8a73ab81).call{value: balanceDividend * 11250}(""); // done
        (bool sArt,) = address(0x4A45c0D4e49CA18b8E206654544269cA8a73ab81).call{value: balanceDividend * 2500}("");
    }
}
