...
contract ERC721Basic is ERC721A, Pausable, AccessControl {
    ...
    constructor(string memory _name, string memory _symbol, string memory _contractURI, string memory _baseTokenURI, address _feeCollectorAddress) ERC721A(_name, _symbol) {
