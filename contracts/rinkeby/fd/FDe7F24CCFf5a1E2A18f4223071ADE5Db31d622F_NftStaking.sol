...
contract NftStaking is IERC721Receiver, AccessControlUpgradeable, Signature {
        ...
        returns (uint256)
    {
        ...
        return
            (block.timestamp -
                addidtionalNewPoolInfo.lastUserClaim[_userAddress]) *
            ((addidtionalNewPoolInfo.tokensStaked[_userAddress] *
        ...
        updateState(_poolId, msg.sender)
    {
        ...
        additionalPoolInfo.lastUserClaim[msg.sender] = block.timestamp;

        additionalPoolInfo.userLastStakeTime[msg.sender] = block.timestamp;
        
        emit Staked(msg.sender, _poolId, _payload._ids, _payload._prices, totalPrice);
    }
