...
// SPDX-License-Identifier: MIT
    ...
    contract EMRRecord is Ownable {
        ...
        /*
        * Registering the Data of patients
        */
        ...
        function RegisterPatient(
            ...
            require(
                _patid != patients[_patid].pat_Id,
                "Patient Already Registered"
            );

            patients[_patid] = Patient(
                _patid,
                _email,
                _medicalreport
            );
        ...
        */
        ...
        function AddMedicalReport(
            ...
            patients[_patId].medicalreport.push(MedicalReportIndex);
        }


        /* 
         * To get Medical Report Index of the address  
         */
        function GetMedicalReports(uint256 pat_Id) public view returns(uint256[] memory){
        return patients[pat_Id].medicalreport;
    }
