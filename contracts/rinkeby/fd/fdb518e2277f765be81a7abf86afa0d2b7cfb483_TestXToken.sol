...
contract TestXToken is ERC20VotesUpgradeable, ERC20CappedUpgradeable, ERC20BurnableUpgradeable {

    string internal constant NAME = "TestX Token";
    string internal constant SYMBOL = "TESTX";
    ...
    function initialize() initializer public {
        ...
        // Seed Round - 6%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 6 / 100);
        // Private Round - 9%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 9 / 100);
        // Strategic Round - 2%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 2 / 100);
        // Public Sale - 2%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 2 / 100);
        // DEX Liquidity - 1%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 1 / 100);
        // Team - 15%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 15 / 100);
        // Advisors - 7%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 7 / 100);
        // Staking Rewards - 10%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 10 / 100);
        // Marketing - 15%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 15 / 100);
        // Usage rewards - 33%
        _mint(address(0xeA5E8ACb1716b4F43af165472778292f3D76E22F), initialSupply * 33 / 100);
