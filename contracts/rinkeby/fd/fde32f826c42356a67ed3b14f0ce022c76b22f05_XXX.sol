...
contract XXX is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // Constants
	// #UPDATE
    uint256 public constant MAX_SUPPLY = 66;// 1326

    uint256 public mintPrice = 0.1 ether;
    uint256 public whitelistPrice = 0.095 ether;// default the same with mintPrice
    uint256 public tierSupply = 11;
    ...
    function whitelistMint(uint256 quantity) public payable nonReentrant {
    ...
    function auctionMint(uint256 quantity) public payable nonReentrant {
