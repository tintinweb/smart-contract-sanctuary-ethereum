...
contract IdraAngels is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_ANGELS = 7777;
    ...
    constructor(string memory baseURI) ERC721("Angel", "AGL") {
    ...
    function mintAngel(uint256 count) public payable {
        ...
        require(_tokenIdCounter.current() + count <= MAX_ANGELS, "Purchase would exceed supply");
