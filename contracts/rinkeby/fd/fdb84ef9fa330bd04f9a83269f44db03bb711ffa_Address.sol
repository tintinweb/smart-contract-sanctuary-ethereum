...
contract testicles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("testicles", "testys") {
    setHiddenMetadataUri("ipfs://QmbZZGqZ51c2dUEEAzA7BCSbfQBa1nWFJhTEdpFbPf2NdT/1.json");
  }
