...
// File: apenft-0531/interfaces/IWETH.sol
...
// File: apenft-0531/interfaces/ITransferManagerNFT.sol
...
// File: apenft-0531/interfaces/IRoyaltyFeeManager.sol
...
// File: apenft-0531/interfaces/IApeNftExchange.sol


pragma solidity ^0.8.0;


interface IApeNftExchange {
...
// File: apenft-0531/interfaces/IExecutionManager.sol
...
// File: apenft-0531/interfaces/ICurrencyManager.sol
...
// File: apenft-0531/libraries/SignatureChecker.sol
...
// File: apenft-0531/ApeNftExchange.sol
...
/**
 * @title ApeNftExchange
 * @notice It is the core contract of the ApeNft exchange.
 */
contract ApeNftExchange is IApeNftExchange, ReentrancyGuard, Ownable {
    ...
    constructor(address _currencyManager, address _executionManager, address _royaltyFeeManager, address _WETH, address _protocolFeeRecipient) {
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x946b83bac9528c90ced361c0ff85b5bed7d05ff46bd406544220ec62fb342576, // keccak256("ApeNftExchange")
    ...
    function _validateOrder(OrderTypes.MakerOrder calldata makerOrder, bytes32 orderHash) internal view {
        ...
        require(
            (!_isUserOrderNonceExecutedOrCancelled[makerOrder.signer][makerOrder.nonce]) && (makerOrder.nonce >= userMinOrderNonce[makerOrder.signer]),
