...
contract token is ERC721 {
  ...
  //events--------------------------------
  event lognewItem(uint256 tokenID, uint256 createdAt); //create new item by supplier
  event lognewNugget(bytes32 tokenID, uint256 createdAt);
  event _purchasedByManufacturer(uint256 tokenID, uint256 createdAt);
    ...
    returns (uint256)
  {
    ...
    emit lognewItem(int_tokenID, block.timestamp);
  ...
  function purchasedByManufacturer(
    ...
    emit _purchasedByManufacturer(int_tokenID, block.timestamp);
  }
