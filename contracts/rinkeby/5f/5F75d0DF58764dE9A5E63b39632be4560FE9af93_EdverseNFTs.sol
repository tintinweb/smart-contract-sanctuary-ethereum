...
contract EdverseNFTs is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.007 ether; // Mint fee in ETH
  uint256 public maxSupply = 1000;
  uint256 public publicsalePerAddressLimit = 1000; // Per address mint limit

  bool public paused = false;
  bool public revealed = true;
  
  uint256 metadataUpdateFee = 0.003 ether;// Fee in ETH
