...
/** 
 *  SourceUnit: d:\OrionSolidified\christoph\codebase\contracts\Spectrum.sol
*/
...
contract Spectrum is ERC721, Ownable {
    ...
    constructor() payable ERC721('Spectrum', 'SPCTRM') {
        ...
        maxSupply = 35;
        maxPerWallet = 4;
        withdrawWallet = 0x682e5EDb73aB934aFCCD10A59AB999EAfbDd2602;
        setHiddenMetadataUri("ipfs://QmYqsmL3dWtXWmcV5DtGUJFbjiHLqLbADh4hPA9KXY3whj/"); 
        isRevealed = false;
        SPCTRM_PROVENANCE = "Test Provenance";
    }
    ...
    string private customContractURI = "ipfs://QmVaG3sEL11pvdR4Fab21KuFDypK8kH9Lf1ESVM4RBGC4q/";
