...
// Compiles in brownie, but wont compile in remix, maybe brownie-config.yaml help brownie...
...
contract Lottery is VRFConsumerBase, Ownable{
    ...
    constructor(address _priceFeedAddress,
        ...
        lottery_state = LOTTERY_STATE.CLOSED; // eqiuvalent to => lottery_state = 1;
        fee = _fee;
        keyHash = _keyHash;
    }
    ...
    function getEntranceFee() public view returns(uint256){
        ...
        uint256 adjsutedPrice = uint256(price) * 10**10; // 18 decimals
        uint256 costToEnter = (usdEntryFee * (10**18)) / adjsutedPrice;
        return costToEnter;
    }
