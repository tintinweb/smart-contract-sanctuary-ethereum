...
contract GenesisDuck is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    uint256 public maxPerAddressDuringMint;
    uint256 public amountForCCBuyers;
    ...
    SalePhase public currentSalePhase = SalePhase.CCSale;

    constructor(
        uint256 maxBatchSize_,
        uint256 collectionSize_,
        uint256 amountForCCBuyers_
    ) ERC721A("GenesisDuck", "GDK", maxBatchSize_, collectionSize_) {
        maxPerAddressDuringMint = maxBatchSize_;
        amountForCCBuyers = amountForCCBuyers_;
    }
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "can not mint this many with the same address"
        );
    ...
    // For Buyers Using Credit Card
    function mintForCCBuyers(uint256 quantity) external onlyOwner {
        require(
            totalSupply() + quantity <= amountForCCBuyers,
            "too many already minted for CC buyers"
        );
        require(
