...
contract partat is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("part", "perge") {}
    ...
    uint256 public constant MAX_PUBLIC_SALE_AMOUNT = 4444;

    uint256 public mintPrice = 0.004444 ether;
