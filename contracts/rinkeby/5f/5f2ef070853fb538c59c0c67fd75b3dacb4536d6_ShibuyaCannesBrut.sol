...
contract ShibuyaCannesBrut is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(uint256 maxSupply) ERC721("ShibuyaCannesBrut", "SHIBCANNBRUT") {
        saleConfig = SaleConfig({
            goldTierPrice: 70000000000000000,
            silverTierPrice: 60000000000000000,
            bronzeTierPrice: 50000000000000000,
            maxPerTransaction: 2,
            maxSupply: maxSupply,
            saleOpen: false,
            merkleRoot: ""
