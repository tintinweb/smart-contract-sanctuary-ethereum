...
contract WebacyBusinessU is Initializable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function TestTokenBeneficiaryToContractToMember(address _destinationAddress, address _contractAddress)public view returns (address){
        return tokenBeneficiaryToContractToMember[_destinationAddress][_contractAddress];
    }
