...
contract ForestToken is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, ERC1155SupplyUpgradeable {
    ...
    struct TokenMetadata {
        ...
        uint256 conservation_frequency;
        string asset_type;
    ...
    uint256 public area_size;
    string public unit_size;
    string public property_name;
    string public monitoring_provider;
    ...
    function initialize() initializer public {
        ...
        name = "Surui Tribe Land";
        symbol = "STL";
        description = "Surui Tribe Land";
        area_size = 1000;
        unit_size = "ha";
        property_name = "Surui Tribe";
        monitoring_provider = "";
    }
    ...
    function mint(
        ...
        uint256 _conservation_frequency,
