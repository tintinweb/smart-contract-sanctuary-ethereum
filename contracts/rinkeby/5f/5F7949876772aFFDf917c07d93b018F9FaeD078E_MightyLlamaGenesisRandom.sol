...
contract MightyLlamaGenesisRandom is ERC721PsiAddressData , VRFConsumerBaseV2 {
    ...
    // Random TokenID Winner selector with Chain Link Rnadomness VRF
    ...
    function fulfillRandomWords(
        ...
        uint256 d20Value = (randomWords[0] % totalSupply()) + 1;
        randomTokenWinner[randomWinnerCount] = d20Value;
        emit RandomWinnerAnnounced(d20Value, reqeustIdsMap[randomWinnerCount]);
    }
    ...
    function getLatestRandomWinner() view public onlyOwner returns (uint256) {
