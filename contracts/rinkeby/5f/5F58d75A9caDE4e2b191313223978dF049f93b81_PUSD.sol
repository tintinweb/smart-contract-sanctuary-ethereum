...
import "../../middleLayer/interfaces//ILayerZeroEndpoint.sol";
import "../../middleLayer/interfaces/ILayerZeroReceiver.sol";
...
contract PUSD is PUSDAdmin, PUSDMessageHandler {
    ...
    function sendTokensToChain(
        ...
        require(paused == false, "PUSD_TRANSFERS_PAUSED");
    ...
    CommonModifiers
{
    ...
    function mintFromChain(
        ...
        emit ReceiveFromChain(srcChain, receiver, amount);
    }
}
