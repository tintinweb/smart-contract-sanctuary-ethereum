...
//    / ____/_  __/ /___  __________ |__  <  / // /
//   / /_  / / / / __/ / / / ___/ _ \ /_ </ / // /_
//  / __/ / /_/ / /_/ /_/ / /  /  __/__/ / /__  __/
// /_/    \__,_/\__/\__,_/_/   \___/____/_/  /_/   
//                                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2DcC561B33b2e68Dc347bd44bC736FEEFe64F33D];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRosiqx6BWCiwnMk4NpUMu4srarTzuoqp3hi4Qd3gLN7E/";
...
// File: contracts/Future314Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Future314Contract is RamppERC721A {
    constructor() RamppERC721A("Future314", "Fut314"){}
}
