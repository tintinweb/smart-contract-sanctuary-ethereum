...
contract Voltnobi is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transtion = 10; // maximam amount that user can mint
  uint256 public MAX_PER_Address = 20; // maximam amount that user can mint

  uint256 public  PRICE = 0.1 ether;

  uint256 private constant TotalCollectionSize_ = 1000; // total number of nfts
  ...
  constructor() ERC721A("Voltnobi","Voltnobi", MaxMintPerBatch_, TotalCollectionSize_) {
