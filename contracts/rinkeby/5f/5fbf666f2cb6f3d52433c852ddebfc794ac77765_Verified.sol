...
contract Verified is ERC721, ERC721URIStorage, Ownable {
...
event Revoke(address indexed to, uint256 indexed tokenId);
    ...
    constructor() ERC721("KYCHECK", "VRFD") {}
    ...
    function burn (uint256 tokenId) external {
        require (ownerOf(tokenId) == msg.sender, "Only NFT Owner Can Burn It");
        _burn(tokenId);
    }
    ...
    _burn(tokenId);
     ...
     function _beforeTokenTransfer(
        ...
        "This Is A SoulBound NFT, It Cannot Be Transfered, Only Burned.");
    }
