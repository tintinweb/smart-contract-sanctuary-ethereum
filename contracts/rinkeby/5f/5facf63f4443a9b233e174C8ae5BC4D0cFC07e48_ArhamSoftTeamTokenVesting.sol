...
/**
 * ArhamTeam tokens vesting contract. 
 *
 ...
 *      Team Funds: 17%
 *      8% monthly from 10th month after TGE
 *
 */
contract ArhamSoftTeamTokenVesting {
     ...
     */
    uint256 public vestingStartTimestamp = 1675062000;
    ...
    function initVestingStages () internal {
        ...
        stages[1].tokensUnlockedPercentage = 16;
        stages[2].tokensUnlockedPercentage = 24;
        stages[3].tokensUnlockedPercentage = 32;
        stages[4].tokensUnlockedPercentage = 40;
        stages[5].tokensUnlockedPercentage = 48;
        stages[6].tokensUnlockedPercentage = 56;
        stages[7].tokensUnlockedPercentage = 64;
        stages[8].tokensUnlockedPercentage = 72;
        stages[9].tokensUnlockedPercentage = 80;
        stages[10].tokensUnlockedPercentage = 88;
        stages[11].tokensUnlockedPercentage = 96;
        stages[12].tokensUnlockedPercentage = 100;
