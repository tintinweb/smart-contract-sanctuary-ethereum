...
// File: contracts/Cannasapiens.sol
 ...
 */
contract Cannasapiens is ERC721Tradable {
    using Counters for Counters.Counter;

    constructor() ERC721Tradable("Cannasapiens", "CNSP", address(0x1E525EEAF261cA41b809884CBDE9DD9E1619573A)) {
        
        // whitelist contract owner's address & instantiate an initial storage to avoid gas cost increase at next application
        applyForWhitelist();
    
        setPresaleStartTime(block.timestamp + 0);
    
    }

    function baseTokenURI() override public pure returns (string memory) {
        return "ipfs://QmWK1vTBtPq2z896w51udauHgGdrpLGd7siAq8G1SbY1ci/";
    }



    // Constants 12500000000000000

    uint256 public constant MAX_TOKENS = 11;

    uint256 public constant RESERVE_FOR_AIRDROPS = 1;

    uint256 public constant RESERVE_FOR_WHITELISTED = 1;

    uint256 public constant MAX_PRESALE_USER_MINTED_TOKENS_PER_TX = 5;

    uint256 public constant MAX_PUBSALE_USER_MINTED_TOKENS_PER_TX = 5;

    uint256 public constant MAX_PRESALE_TOKENS_MINT = 10;

    uint256 public constant MAX_PUBLIC_SALE_TOKENS_MINT = 10;

    uint256 public constant PRESALE_TOKEN_VALUE = 0.0002 ether;

    uint256 public constant PUBLIC_SALE_TOKEN_VALUE = 0.00025 ether;
