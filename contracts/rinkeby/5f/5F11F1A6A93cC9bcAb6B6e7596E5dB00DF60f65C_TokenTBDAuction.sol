...
contract TokenTBDAuction is Ownable {
    ...
    function placeBid(uint8 tokenID, address recipient)
        ...
        notLocked
    {
        require(paperWallets[msg.sender], "ONLY_PAPER_WALLETS_ALLOWED");
    ...
    function endAuction(uint8 tokenId) external {
        ...
        require(
            currentTopBids[tokenId].wallet_recipient != address(0),
            "NO_WINNERS"
        );
        tokenTBDK.mintPlatinum(
            tokenId,
            currentTopBids[tokenId].wallet_recipient
        );
    }
