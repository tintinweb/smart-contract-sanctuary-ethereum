...
contract ContractName is ERC721{
    ...
    // image variables
    string start = 'https://inwritingapi.com/inwriting/get_svg.php?tokenID=';
    string end = '';
    ...
    // string font_link = "http://fonts.cdnfonts.com/css/menlo";
    // string font = "Menlo";
    // uint256 line_height = 1208;  // 1.208 * 1000
    // uint256 font_size = 24000;  // 24 * 1000
    // uint256 dynamic_width_modifier = 1000;  // 1 * 1000
    // uint256 dynamic_height_modifier = 850;  // 0.85 * 1000


    // returns the svg image format of the string
    // function get_image(uint256 tokenId) public view returns (string memory) {
        // strings.slice memory s = get_string(tokenId).toSlice();
        // strings.slice memory delim = "<".toSlice();
        // string[] memory parts = new string[](s.count(delim) + 1);
        // for(uint256 i = 0; i < parts.length; i++) {
        //     parts[i] = s.split(delim).toString();  // split string at <
        // }
        // string memory newString = '';
        // for (uint256 i = 0; i < parts.length; i++) {
        //     newString = string(abi.encodePacked(newString, "&lt", parts[i]));  // put string back together with &lt in between
        // }

        // s = newString.toSlice();
        // delim = ">".toSlice();
        // string[] memory parts1 = new string[](s.count(delim) + 1);
        // for(uint256 i = 0; i < parts1.length; i++) {
        //     parts1[i] = s.split(delim).toString();  // split string at >
        // }
        // for (uint256 i = 0; i < parts1.length; i++) {
        //     newString = string(abi.encodePacked(newString, "&gt", parts[i]));  // put string back together with &gt in between
        // }


        // s = newString.toSlice();
        // delim = "\n".toSlice();
        // uint256 num_lines = s.count(delim) + 1;
        // string[] memory parts2 = new string[](s.count(delim) + 1);
        // uint256 longest_length = 0;
        // uint256 current_length = 0;
        // for(uint256 i = 0; i < parts2.length; i++) {
        //     parts2[i] = s.split(delim).toString();  // split string at newline
        //     current_length = parts2[i].toSlice().len();
        //     if (current_length > longest_length) {
        //         longest_length = current_length;
        //     }
        // }

        // uint256 dynamicWidth = uint256(longest_length * font_size * dynamic_width_modifier / 1000 / 1000);
        // uint256 dynamicHeight = uint256(num_lines * line_height * font_size * dynamic_height_modifier * 6 / 5 / 1000 / 1000);

        // string memory returnString = "<svg xmlns='http://www.w3.org/2000/svg' width='";

        // returnString = string(abi.encodePacked(returnString, dynamicWidth.toString(),
        //                                        "' height='", dynamicHeight.toString(), 
        //                                        "'  font-size='", uint256(font_size / 1000).toString(),
        //                                        "'><style>@import url('", font_link, 
        //                                        "');</style><text font-family='", font, "' x='0' y='0' xml:space='preserve' text-anchor='start'>"));
        
        // string memory first = string(abi.encodePacked("<tspan x='0' dy='", (line_height / 1000).toString(), "em'>"));
        // for (uint256 i = 0; i < parts2.length; i++) {
        //     returnString = string(abi.encodePacked(returnString, first, parts2[i], "</tspan>"));  // format into svg
        // }

        // returnString = string(abi.encodePacked(returnString, "</text></svg>"));

        // returnString = string(abi.encodePacked("data:image/svg+xml;base64,", Base64.encode(bytes(returnString))));

        // return returnString;

        // return get_string(tokenId); 
    // }
 ...
 */
 ...
 // this code was modified for solidity 8.0.0
library strings {
    struct slice {
        uint _len;
        uint _ptr;
    ...
    // returns the svg image format of the string
    // function get_image(string memory svgString,
    //                    uint256 font_size,
    //                    uint256 dynamic_width_modifier,
    //                    uint256 line_height,
    //                    uint256 dynamic_height_modifier,
    //                    string memory font_link,
    //                    string memory font) public view returns (string memory) {
    //     strings.slice memory s = svgString.toSlice();
    //     strings.slice memory delim = "<".toSlice();
    //     string[] memory parts = new string[](s.count(delim) + 1);
    //     for(uint256 i = 0; i < parts.length; i++) {
    //         parts[i] = s.split(delim).toString();  // split string at <
