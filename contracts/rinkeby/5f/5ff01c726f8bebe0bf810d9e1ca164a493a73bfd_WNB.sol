...
contract WNB is ERC721A , Ownable  {
    ...
    mapping(address => uint256) numberOfMintsPerWallet;
    ...
    function Mint(uint256 quantity) external payable {
        ...
        require(numberOfMintsPerWallet[msg.sender] + quantity <= maxMintsPerWallet, "You have exceeded the number of mintable NFTs for this wallet");

        uint256 temp = numberOfMintsPerWallet[msg.sender];
        numberOfMintsPerWallet[msg.sender] = temp + quantity;
