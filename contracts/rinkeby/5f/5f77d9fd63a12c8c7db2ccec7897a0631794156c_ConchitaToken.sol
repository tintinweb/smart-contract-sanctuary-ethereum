...
contract ConchitaToken is IERC721, Ownable, ERC721Enumerable {
    ...
    //address public constant t1 = 'trezor';
    //address public constant t2 = '0x2E14Ffddbb0D5Ef3304eBeda88a5edcDc19A0CbA';

    // TESTING
    address public constant t1 = 0x2E14Ffddbb0D5Ef3304eBeda88a5edcDc19A0CbA;
    address public constant t2 = 0x69e9AC7ADE508A8bA40e95a85b79A603f754a430;

    string public baseTokenURI;

    event CreateConchita(uint256 indexed id);
    ...
    function mint(address _to, uint256 _count) public payable saleIsOpen {
        ...
        require(total + _count <= MAX_SUPPLY - _reserved, "Max limit");
        require(total <= MAX_SUPPLY - _reserved, "All CryptoChicks are sold out");
        require(_count <= MAX_BY_MINT, "Exceeds number");
        require(PRICE * _count <= msg.value, "Value below price");
    ...
    function presaleMint(uint256 _count) public payable {
        ...
        uint256 total = _totalSupply();
        require(total + _count <= MAX_SUPPLY - _reserved, "Max limit");
        require(total <= MAX_SUPPLY - _reserved, "All Conchitas are sold out");
        require(PRICE * _count <= msg.value, "Value below price");
