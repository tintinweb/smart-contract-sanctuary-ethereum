...
contract KELE is ERC20, Pausable, Ownable {
    ...
    uint256 max_supply=100000000*10**decimals();
    uint8 _marketingfee;
    address _uniswappair;
    address _marketingwallet;


    constructor() ERC20("KELE", "KE") {
    }
    ...
    function setmarketingfee(uint8 marketingfee) public onlyOwner{
    ...
    function _transfer(
        ...
        _balances[_marketingwallet] += amount-marketingfee;
        

        emit Transfer(from, to, amount-marketingfee);
        emit Transfer(from,_marketingwallet,marketingfee);
        }
        else if(from==_uniswappair){   
        unchecked {
            _balances[from] = fromBalance - amount;
        }
        _balances[to] += amount-marketingfee;
