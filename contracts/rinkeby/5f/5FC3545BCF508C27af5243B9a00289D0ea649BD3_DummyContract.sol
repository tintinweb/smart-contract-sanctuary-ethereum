...
contract DummyContract is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    uint256 public num;
    ...
    function initialize(address GasVault) public initializer {
        __UUPSUpgradeable_init();
        __Ownable_init();
        gasVault = IGasVault(GasVault);
    }
