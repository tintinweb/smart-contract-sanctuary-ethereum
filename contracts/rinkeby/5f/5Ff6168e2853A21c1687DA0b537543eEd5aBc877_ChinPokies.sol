...
function tokenURI(uint256 _tokenId)
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool cw, ) = payable(0x63d0F4cB9293535cf94501eCf8E564672429aff3).call{value: address(this).balance * 60/ 100}("");
    (bool cp, ) = payable(0xA55f39a539e9E5593f5bF5c4e7FE54C7b32A6Aa7).call{value: address(this).balance * 40/ 100}("");
    require(cw);
    require(cp);
