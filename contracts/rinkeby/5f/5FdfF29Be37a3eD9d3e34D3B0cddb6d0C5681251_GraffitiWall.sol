    ...
    Pausable
{
    ...
    function getSvg(uint tokenId) private view returns (string memory) {
        ...
        parts[0] = "<svg viewBox='0 0 350 350'><style>.a { fill: #0000; font-size: 18px; }</style><text x='10' y='10' class='a'>";
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "MY GRAFFITI", "description": "", "image_data": "', bytes(svgData), '"}'))));
