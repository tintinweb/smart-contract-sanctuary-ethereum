...
contract Lottery is VRFConsumerBaseV2, Ownable {
    ...
    constructor(address _priceFeedAddress, uint64 _subscriptionId)
        public
    ...
    function endLottery() public onlyOwner {
        ...
        //     )
        // ) % players.length;
        lottery_state = LOTTERY_STATES.CACULATE_WINNER;
        requestRandomWords();
    }
