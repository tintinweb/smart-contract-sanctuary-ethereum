  	...
  	enum EContestState
   	{
		CONTEST_EMPTY, /* 0 */
	   	...
	   	CONTEST_RANDOM_REQUESTED, /* 2 RANDOM REQUEST */
	   	CONTEST_RANDOM_DELIVERED, /* 3 RANDOM DELIVERED */
		CONTEST_PROOF_REQUESTED, /* 4 PROOF REQUESTED */
	   	CONTEST_PROOF_DELIVERED, /* 5 PROOF DELIVERED */
		CONTEST_WINNER_LOTTERY_DONE, /* 6 ETH DEPOSIT TO TWITTER WINNER ID */
	   	CONTEST_END /* 7 */
   	}
	...
	*/
	function requestProofFromNode(string memory tweetID)
		...
		onlyOwnerOrContestOwner(tweetID)
	  	onlyContestState(tweetID, EContestState.CONTEST_RANDOM_DELIVERED)
   	{
		...
		onlyContestState(tweetID, EContestState.CONTEST_CREATED)
	{
		...
		if ( fakeVRF == true)
		{
			...
			contest[tweetID].contestState = EContestState.CONTEST_RANDOM_REQUESTED;
			contest[tweetID].contestState = EContestState.CONTEST_RANDOM_DELIVERED; // on-chain.
		}
		else
		{
