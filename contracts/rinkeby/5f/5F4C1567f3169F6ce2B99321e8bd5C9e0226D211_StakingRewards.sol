...
contract StakingRewards {
    ...
    mapping(address => mapping(uint256 => uint256)) public _ownedStakings;

    mapping(uint256 => uint256) public _ownedStakingsIndex;
    
    StakingInfo[] _allStakings;

    mapping(uint256 => uint256) public _allStakingIndex;
    ...
    function _removeStakingFromOwnerEnumeration(address from, uint256 stakingId) public {
    ...
    function _removeStakingFromAllStakingsEnumeration(uint256 stakingId) public {
