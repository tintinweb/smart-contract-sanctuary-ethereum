...
/****************************************************************************/
        ...
        contract Sleazy_Sloths_Adventure_Club is ERC721A, Ownable {
        using Strings for uint256;

            // Name & Symbol of Project in Constructor 
            constructor() ERC721A("Sleazy Sloths Adventure Club", "SSAC") {}

            //max supply is set to 8888
            uint16 public constant maxSupply = 8888;
            // uriPrefix is the BaseUri
            string public uriPrefix = "ipfs://QmSDBEndceiGHWub56EXtZ5JJXVvEefp3zAZ7rw8R3mGGi";
