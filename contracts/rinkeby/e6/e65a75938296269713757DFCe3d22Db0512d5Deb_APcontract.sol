...
contract APcontract is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public WALLETLIMIT = 12; // 12 limit for public sale
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account( 50, 0, 1); // GB
        accounts[teamclaim[1]] = Account( 50, 0, 1); // MS
        accounts[teamclaim[2]] = Account( 25, 0, 1); // JD
        accounts[teamclaim[3]] = Account( 25, 0, 1); // WD
        accounts[teamclaim[4]] = Account( 25, 0, 1); // G1
        accounts[teamclaim[5]] = Account( 25, 0, 1); // G2
