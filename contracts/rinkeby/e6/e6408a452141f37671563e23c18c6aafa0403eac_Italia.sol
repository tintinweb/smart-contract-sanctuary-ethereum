...
contract Italia is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory output = string.concat('{"name": "WE3+DREAM+Avara Italia', toString(tokenId), '", "description": "this is a description", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(stickerSVGs)), '"}');
