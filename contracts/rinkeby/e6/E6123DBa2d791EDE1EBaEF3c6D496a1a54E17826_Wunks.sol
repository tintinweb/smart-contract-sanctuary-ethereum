...
contract Wunks is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  address public collectionWhitelist = address(0x7C201274fD4c4d8B574Dd7631c0e4615b6650341);
  mapping(address => uint256) private allowance;
  mapping(address => bool) public projectProxy;
  string public baseURI;
    
  constructor() ERC721("Wunks", "WUNK") {
    setBaseURI("http://localhost:4000/api/wunks-w-ZZzI/token/");
  }
