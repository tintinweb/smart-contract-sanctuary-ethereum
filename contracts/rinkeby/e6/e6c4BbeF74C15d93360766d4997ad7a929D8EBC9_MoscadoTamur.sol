...
contract MoscadoTamur is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 6969;
    uint256 Allremain = 6969;
    uint256 public mintRate = 0.003 ether;
    uint256 MintForWallet = 6969;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = "ipfs://testURI" ;
    bool public start = true;

    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("Mosca do Tamur", "MDT") {}
