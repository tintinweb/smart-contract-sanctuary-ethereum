...
contract GasMonster is ERC721A, VRFConsumerBaseV2, ChainlinkClient, Ownable {
	 ...
	 */
	event Mint(uint256 tokenId, address owner, NFT token);
	...
	function mint(uint256 quantity) external payable {
		...
		for (uint256 i = 0; i < quantity; i++) {
			...
			mintedTokensIds[i] = startIndex + i;
		}
	 ...
	 */
	function fulfillRandomWordsTest(uint256 _requestId, uint256[] memory _randomWords) public {
