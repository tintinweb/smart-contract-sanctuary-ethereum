...
contract MintPass is ERC1155Supply, Ownable {
    ...
    string public symbol = "Mint Pass";
    ...
    constructor()
        ERC1155("ipfs://QmeySDQiuPHZjt6Hska6SNBfrhj4E8vvGXcKsUC4gG24QM/0.json")
    { }

    function mintPass(uint256 amount) external {
        require(isPublic, "Public not active");
        require(totalSupply(0) + amount <= MAX_SUPPLY, "Max supply reached");
        require(amount <= MAX_PER_TX, "Max per transaction");
        _mint(msg.sender, 0, amount, "");
    }
 
    function mintEarlyPass(uint256 amount, uint256 allowance, bytes32[] calldata proof) external {
