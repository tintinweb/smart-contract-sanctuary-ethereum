...
// File: contracts/theMetalorianDaoHolografic.sol
...
///@title TheMetalorianDaoHolografic
///@notice Token ERC721 for the life Out 
contract TheMetalorianDaoHolografic is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 50;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 50;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian Dao Holografic", "TMDH") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeibxfqloydlpzkryl5ssxconu3i3oriupdpqgkbxsu3an2ezsletqm/HolograficJson/";   
    ...
    event MintTheMetalorianDaoHolografic(address indexed user, uint256 tokenId); 
   ...
   /// =========================================================
    ...
    function mintTheMetalorianDaoHolografic(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDaoHolografic(msg.sender, tokenIdCounter.current());            
