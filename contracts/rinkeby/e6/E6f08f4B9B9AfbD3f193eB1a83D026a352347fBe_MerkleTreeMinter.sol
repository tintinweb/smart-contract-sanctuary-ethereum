...
contract MerkleTreeMinter is ERC721AUpgradeable {
    // --- PROPERTIES ---- //

    // Calculated from `merkle_tree.js`
    bytes32 public merkleRoot =
        0xed8ed2671dc6333a69b147c5606bb88c96fb2d274bd96b76af73b6beacd779d9;

    uint8 MAX_MINT_BATCH_SIZE = 5;

    uint256 FZ_HOLDERS_MINT_PRICE = 2000000000000000;

    uint256 PUBLIC_MINT_PRICE = 5000000000000000;
        ...
        payable
    {
        ...
        require(msg.value == publicPrice * quantity, "Wrong price");
