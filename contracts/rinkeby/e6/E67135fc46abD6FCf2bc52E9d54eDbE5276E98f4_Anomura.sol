    ...
    OwnableUpgradeable 
{
    ...
    function initialize(address _bowlAddress, address _anomuraDataAddress) external initializer {
        ...
        __ERC721_init("Anomura TestV1", "ANOMURA");
    ...
    */
    function ownerMintAnomura(address _address) external onlyOwner 
    {
    ...
    We generate each part of the anomura, and store in the mapping to be view later
    */
    function mintAnomura(address _address) external onlyBowlContract(_address) returns (uint256 anomuraId)
    {
        require(address(anomuraData) != address(0x0), "Anomura data address is 0");
        ...
        string memory generatedHeadPieces = pluck(anomuraId, "HEADPIECE", data.headPieces, data.prefixes, data.suffixes, data.unique);
