...
contract FractionalGentleman is ERC721A, Ownable {
    using Strings for uint256;
    uint256 public constant MAX_SUPPLY = 2000; //* set to 20 for testing purposes
    ...
    constructor(uint256 _devMintAmount) ERC721A("FractionalGentleman", "FG") {
    ...
    function devMint() external onlyOwner {
        require(
            totalSupply() + devMintAmount <= MAX_SUPPLY,
            "You cannot mint more than the total supply!"
        );
