    ...
    TokenRescuer
{
    ...
    /**
     * @notice Tracks project contracts that have automatic approval.
     */
     ...
     */
    modifier onlyWithCorrectPayment(uint256 _mintAmount) {
        unchecked {
    ...
    function mintWhitelist(
        ...
        onlyWithCorrectPayment(_mintAmount)
