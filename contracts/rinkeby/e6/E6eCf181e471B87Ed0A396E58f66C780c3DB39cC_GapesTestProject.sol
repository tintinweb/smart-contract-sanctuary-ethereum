...
contract GapesTestProject is ERC721A, Ownable, ReentrancyGuard {
 ...
 //sale status
  ...
  constructor(
    ...
    //set max limit amount per wallet
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(_mintAmount + _numberMinted(msg.sender) <= maxMintAmountPerWallet, 'Exceeded the limit');
 ...
 //change max supply amount
  ...
  function withdraw() public onlyOwner nonReentrant {
    // =============================================================================
    // This will transfer amount in the contract balance to the owner.
    // =============================================================================
