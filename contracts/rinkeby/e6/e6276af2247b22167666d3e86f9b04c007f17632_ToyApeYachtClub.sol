...
contract ToyApeYachtClub is Ownable, ERC721A, ERC2981, ReentrancyGuard {
    ...
    uint256 public immutable TOTAL_SUPPLY = 200;
    uint256 public immutable HOLDER_MINT_TOTAL_SUPPLY = 10;
    uint256 public immutable WHITELIST_PUBLIC_TOTAL_SUPPLY = 100;
    uint256 public immutable CLAIM_TOTAL_SUPPLY = 100;
    ...
    constructor(address toybirdsContract) ERC721A("Sharkie", "SYC") {
