...
contract FBB is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public PRICE = 0.0002 * 10**18;
    ...
    ) ERC721A("Qbi", "Qbi", _maxPerMint, 500) {
        baseURI = initBaseURI;
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount > 0, "Zongzi: invalid amount");

        require(
            amount <= maxPerMint,
            "Zongzi: Exceeds the single maximum limit."
        );
