...
contract LilBOB is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFT = 1111; //This is full collection should be 1111
    uint256 public constant MAX_NFT_WL = 300; // This should be 300 for WL
    uint256 public MAX_NFT_VIP = 2; // This is for VIP giveaways should be 68
    uint256 public constant MAX_NFT_GIVEAWAY = 2; // This is for general giveaways should be 143
    ...
    function random(uint256 timestamp, uint256 tokenId) internal view returns (uint256) {
