...
contract LootBoxFactory is FactoryERC1155, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    string
        internal constant baseMetadataURI = "https://kirin178hsu.wixsite.com/kilos-garden/_functions/";
    ...
    uint256 constant NUM_ITEM_OPTIONS = 100;
    ...
    function name() override external pure returns (string memory) {
        return "Kilos Garden Membership Pre-Sale";
    }
    ...
    function canMint(uint256 _optionId, uint256 _amount)
        ...
        returns (bool)
    {
        return _canMint(owner(), _optionId, _amount);
    }
        ...
        returns (uint256)
    {
        if (_optionId < NUM_ITEM_OPTIONS) {
            ...
            uint256 currentSupply = lootBox.balanceOf(owner(), 1);
            ...
            return lootBox.getTokenSupplyLimit(tokenId).sub(currentSupply);
        }
    }

    function test() public view returns(uint256) {
        ERC1155Tradable lootBox = ERC1155Tradable(nftAddress);
        return lootBox.balanceOf(address(0x24f38453A0950e873e1AC2241A7440cbBEe38F9E), 1);
    }
    ...
    function test3() public view returns(uint256) {
        ERC1155Tradable lootBox = ERC1155Tradable(nftAddress);
        return lootBox.balanceOf(owner(), 1);
    }

    function test4() public view returns(uint256) {
        // ERC1155Tradable lootBox = ERC1155Tradable(nftAddress);
        return balanceOf(address(0xeBb78944AebB3Dfa05d78294056B67f91FE9342D), 1);
    }

    function test5() public view returns(uint256) {
        return balanceOf(address(0x24f38453A0950e873e1AC2241A7440cbBEe38F9E), 1);
    }

    function test6() public view returns(bool) {
        return _canMint(address(0xeBb78944AebB3Dfa05d78294056B67f91FE9342D), 1, 1);
    }

    function test7() public view returns(bool) {
        return this.canMint(1, 1);
    }

    function test8(uint256 _optionId, uint256 _amount) public view returns(bool) {
        bool aaa = this.canMint(_optionId, _amount);
        return true;
    }

    function test9(uint256 _optionId) public view returns(uint256) {
        return balanceOf(address(0xeBb78944AebB3Dfa05d78294056B67f91FE9342D), 1);
    }

    function test10(uint256 _optionId, uint256 _amount) public view returns(bool) {
        return _canMint(address(0xeBb78944AebB3Dfa05d78294056B67f91FE9342D), _optionId, _amount);
    }
