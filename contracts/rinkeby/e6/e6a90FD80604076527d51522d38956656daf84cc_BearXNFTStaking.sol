...
contract BearXNFTStaking is OwnableUpgradeable {
    ...
    function BurnRootx_mintSrootx (uint256 _amount) public {
        require(IERC20Upgradeable(ROOTxTokenAddress).allowance(msg.sender, 0xf07a36DC256AC82B2159a355580FD842Bc0b090F) >= _amount, "You have to approve rootx to staking contract");
        IERC20Upgradeable(ROOTxTokenAddress).transferFrom(msg.sender, 0xf07a36DC256AC82B2159a355580FD842Bc0b090F, _amount*10**18);
        ERC20Upgradeable(ROOTxTokenAddress)._burn(_amount*10**18);
        IERC20Upgradeable(SROOTxTokenAddress).mintToken(msg.sender, _amount*10**18*5);
    }
}