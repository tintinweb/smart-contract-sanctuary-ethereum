...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xaBc0deDB66EdF12796EA140E06aEEaAbf9F9e8a7];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 101 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVT5eRTXsshsGQoccWN1r2xP9iXC7ajepgpA4QbMqx5a2/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 101");
        _safeMint(_to, 1);
    }
...
// File: contracts/EdcContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract EdcContract is RamppERC721A {
    constructor() RamppERC721A("EDC", "EDC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wd6x6x4ZaZfPiZ6BthJQ/contract-metadata";
    }
}
