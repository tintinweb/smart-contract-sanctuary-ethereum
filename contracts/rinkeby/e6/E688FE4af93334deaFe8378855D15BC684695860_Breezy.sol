...
contract Breezy is Ownable, ERC721A, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public PRESALE_PRICE = 0.035 ether;
    ...
    address public winterAddress = 0xe0CB05cBf3dBeb647394905848d9361Daa99dE28;
    ...
    function setTeamAmount(uint256 quantity) external onlyOwner {
        ...
        callerIsUser
    {
        ...
        require(msg.sender == winterAddress, "Not authorized");
        _safeMint(recipient, quantity);
    }
