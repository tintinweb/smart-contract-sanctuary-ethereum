...
contract TokensNew4 is ERC721, ERC721Enumerable, Ownable, EIP712, ERC721Votes {
    ...
    function safeMint(address to) public virtual onlyOwner {
        ...
        require (tokenId <= maxSupply, "Exceeded token availability");
