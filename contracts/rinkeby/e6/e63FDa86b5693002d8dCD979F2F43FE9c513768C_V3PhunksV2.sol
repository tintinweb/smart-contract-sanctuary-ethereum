...
contract V3PhunksV2 is ERC721r, Ownable {

    mapping(address => uint256) walletMinted;

    uint256 maxPerWallet = 10;
    uint256 mintRate = 0.005 ether;
    uint256 counter;

    constructor() ERC721r("V3 Phunks V2", "V3PHUNKSV2", 10_000) { 

    }

    function publicMint(uint256 amount) external payable {
        require(walletMinted[msg.sender] + amount <= maxPerWallet, "Max 10 Phunks per wallet");
        require(msg.value >= (mintRate * amount), "Not enought eth");
    ...
    //charity info
    // address public charityAddress = 0xd0cF3a17f8Bc362540c354E9eEc761C5A7952b5D;
    address public charityAddress = 0x165489bF0497401101929e2AA8De78f33Dc53D30;

    function setCharity(address _address) external onlyOwner {
    ...
    function withdrawToCharityAddress() external onlyOwner {
