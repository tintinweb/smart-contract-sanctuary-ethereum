...
contract Ethcc is ERC2981, ERC721A, Ownable, PaymentSplitter {
    ...
    modifier checksPresale(uint _quantity) {
        require(sellingStep == Step.PreSale, "Not yet PreSale Step");
    ...
    function mint(uint16 _quantity, bytes32[] calldata _ogMerkleProof, bytes32[] calldata _wlMerkleProof) public payable {
    ...
    function _safePublicMint(uint16 _quantity) internal {
