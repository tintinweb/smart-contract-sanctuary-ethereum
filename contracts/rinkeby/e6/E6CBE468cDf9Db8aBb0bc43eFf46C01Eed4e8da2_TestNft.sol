...
contract TestNft is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
    ...
    function mint(uint256 amount, uint256 slotId, uint256 validUntil, bytes memory signature) external payable {
        require(_canMint(_msgSender(), amount, slotId, validUntil, signature), "TestNft: must have valid signing");
        ...
        require(validUntil <= block.timestamp, "TestNft: Slot must be used before expiration time");
