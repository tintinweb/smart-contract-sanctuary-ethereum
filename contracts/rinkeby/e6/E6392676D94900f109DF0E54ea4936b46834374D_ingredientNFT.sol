...
library SafeMath {
    ...
    */
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) external returns (PizzasResponse memory);
    function randomBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings) external returns (PizzasResponse memory);
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings ) public payable pizzaTypeAvailableValidation(2) {
        ...
        if(cheese > 0) {
            transerIngredient(cheese);
            increaseUsedCountByIngredientId(cheese);
        }
    ...
    // 6- rebake pizza
    function rebakePizza( uint256 _pizzaId, string memory metadata, uint256 base, uint256 sauce, uint256 cheese, uint256[] memory meats, uint256[] memory toppings, uint256[] memory allOldIngs, uint256[] memory oldIngs ) public payable pizzaTypeAvailableValidation(4){
