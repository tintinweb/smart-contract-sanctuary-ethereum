...
contract BasicFunctions {
    ...
    // example
    // need to specifiy the type in the parameters of the function 
    ...
    function multiplyBlacance(uint _multiplier) external {
        myBalance = myBalance * _multiplier;
    }

    // this function uses a for loop and multiplies params and string comparision 
