...
contract Tocci is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
  ...
  function whitelistMint(uint256 _mintAmount, bytes memory sig) public payable mintCompliance(_mintAmount) {
    ...
    require(preSaleListCounter[_msgSender()] + _mintAmount <= maxPresale,"Exceeded max available to purchase");
    preSaleListCounter[_msgSender()] += _mintAmount;
