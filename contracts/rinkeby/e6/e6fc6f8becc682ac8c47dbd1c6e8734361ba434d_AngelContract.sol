...
contract AngelContract is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Angel Alliance", "AGA") {
        setHiddenMetadataUri(
            "ipfs://QmYj2CgrZzG1TpkiDZTRmQexxiE67cHeBXDUdCxEdgeKTi/hidden.json"
        );
    }
    ...
    function withdraw() public onlyOwner {
        ...
        (bool hs, ) = payable(0xf8C2715f00a632f3F62A086f3BD7957146784A79).call{
            value: (balance * 15) / 100
        }("");
        require(hs);

        (bool js, ) = payable(0xa38647042AD4461Bd04B1CB2677268830D3BF56b).call{
            value: (balance * 15) / 100
        }("");
        require(js);

        (bool ts, ) = payable(0x5fABA91b149a847E63BbD9BacD868ed64082F895).call{
            value: (balance * 33) / 100
        }("");
        require(ts);

        (bool xs, ) = payable(0x5a1A247446aF232dC3479edd7bE5Df1A6CcAEeBf).call{
            value: (balance * 27) / 100
        }("");
        require(xs);
