...
contract Baboonverse is ERC721A, Ownable, VRFConsumerBase, ReentrancyGuard {
    ...
    */
    ...
    address payable public payableRoadmapWallet;
    ...
    */
        ...
        VRFConsumerBase(vrfCoordinator_, link_)
    {
        ...
        */
        ...
        // @todo Add wallet address for roadmap  here
        payableRoadmapWallet = payable(address(0x90F79bf6EB2c4f870365E785982E1f101E93b906));
    ...
    function publicMint(uint256 quantity_, uint256 publicMintKey_) external payable isUser isPublicMint { 
        require(publicMintKey_ == publicMintKey, "Incorrect key");
        require(totalSupply() < maxSupply, "Sold out");
        require(numberMinted(msg.sender) + quantity_ <= maxPerWallet, "Max per wallet reached.");
        require(quantity_ <= maxPerTxn, "Max per txn exceeded");
        require(msg.value == MINT_PRICE * quantity_, "Wrong value!");
    ...
    function setMaxMintBatchSize(uint256 maxMintBatchSize_) external onlyOwner {
        maxMintBatchSize = maxMintBatchSize_;
    }
    ...
    function withdrawMoney() external onlyOwner {
        uint256 balanceForRoadmap = address(this).balance * 300 / 1000; // 30% for Roadmap
        uint256 remainingBalance = address(this).balance - balanceForRoadmap;

        withdraw(payableRoadmapWallet, balanceForRoadmap); // ROADMAP
        withdraw(payable(msg.sender), remainingBalance); // ROADMAP
    }
