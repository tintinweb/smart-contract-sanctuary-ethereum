...
contract ZTest is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZTEST3";
    string private constant _symbol = "ZTEST3";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x17B13802076934E66f151c35ADf042FB812b9661);
        _feeAddrWallet2 = payable(0x17B13802076934E66f151c35ADf042FB812b9661);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x17B13802076934E66f151c35ADf042FB812b9661), _msgSender(), _tTotal);
    }
