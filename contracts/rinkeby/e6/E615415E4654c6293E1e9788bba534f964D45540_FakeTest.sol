...
contract FakeTest is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("Fake Test", "FTEST") {
    setBaseURI("http://localhost:4000/api/fake-test-mojnOyQ/token/");
  ...
  function mintToken(uint numberOfTokens) public payable {
    require(allowance[_msgSender()] < 2, "You have already reached the max number of mints with this wallet.");
