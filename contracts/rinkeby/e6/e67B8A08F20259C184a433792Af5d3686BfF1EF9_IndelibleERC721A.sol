// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Mouth", unicode"Eyes", unicode"Nose", unicode"Shirt", unicode"Skin"];
        ...
        uint256 public maxPerAllowList = 10;
        bool public isAllowListActive;
        
        ContractData public contractData = ContractData(unicode"Small", unicode"SMALL", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9a8300e7-0a8a-444b-b851-5d1fb8cd1777", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9a8300e7-0a8a-444b-b851-5d1fb8cd1777", "", 500, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");

        constructor() ERC721A(unicode"Small", unicode"SMALL") {
            TIERS[0] = [18,42,98,170,172];
TIERS[1] = [20,23,119,166,172];
TIERS[2] = [3,107,168,222];
TIERS[3] = [7,94,109,125,165];
TIERS[4] = [33,214,253];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Small #");
