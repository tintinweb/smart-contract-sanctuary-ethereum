...
contract PPYC is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 4999;
    uint256 public constant MAX_FREE_PER_WALLET = 4999;
    uint256 public constant COST = 0 ether;

    string private constant _name = "PEPE PUNK YC";
    string private constant _symbol = "PPYC";
