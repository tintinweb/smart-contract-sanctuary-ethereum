...
contract DeviantAlienCollective is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721("Deviant Alien Collective", "DAC") {
    setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmaUJRwBKPhxinTM42GgXDPuZoXdpucZRTHYNBVz7Nw7tV/hidden.json");
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This section will pay out 25% of the profits to members and the DAO later on.
    // =============================================================================
    (bool hs, ) = payable(0x6Db590D9174033B58A0708309957942ACBA4dA71).call{value: address(this).balance * 25 / 100}("");
    require(hs);
    // =============================================================================
    (bool ps, ) = payable(0x122386bc819D60455A5C6adDF0890a676c94d7FB).call{value: address(this).balance * 25 / 100}("");
    require(ps);
    // =============================================================================
    (bool ts, ) = payable(0x07EFBc95739de569f95Ae412eb49D8097632e606).call{value: address(this).balance * 25 / 100}("");
    require(ts);
