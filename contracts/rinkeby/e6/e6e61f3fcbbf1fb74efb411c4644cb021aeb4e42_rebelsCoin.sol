...
abstract contract rebelsERC721Interface {
...
contract rebelsCoin is ERC1155, Ownable, ERC1155Burnable {
    ...
    // Set authorized contract address for minting the rebels ERC721 token
    function setrebelsContract(address contractAddress) public onlyOwner {
        rebelsContractAddress = contractAddress;
    }
    ...
    function migrateToken(uint256 id) public {
        ...
        rebelsERC721Interface rebelsContract = rebelsERC721Interface(
            rebelsContractAddress
        );
        rebelsContract.mintTransfer(msg.sender);
    }

    // Force migrate ERC1155 to ERC721
