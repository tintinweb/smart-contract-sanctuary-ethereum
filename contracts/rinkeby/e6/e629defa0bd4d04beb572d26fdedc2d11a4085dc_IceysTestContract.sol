...
// File: contracts/IceysTestContract.sol
...
contract IceysTestContract is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function withdraw(address _add1, address _add2) public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;

        Address.sendValue(payable(_add1), balance / 2);
        Address.sendValue(payable(_add2), balance / 2);
    }
}