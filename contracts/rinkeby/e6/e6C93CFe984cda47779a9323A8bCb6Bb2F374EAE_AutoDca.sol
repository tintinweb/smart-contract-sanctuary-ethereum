...
contract BalanceHolder {
    ...
    function setUpTask(IOps _ops) private {
        _ops.createTask(address(this), AutoDca.exec.selector, address(this), abi.encodeWithSelector(AutoDca.checker.selector));
    }
...
contract AccountManager {
    ...
    constructor(
        ...
        balanceHolder = new BalanceHolder(address(this), _ops);
    }
