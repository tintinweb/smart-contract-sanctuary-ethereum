 ...
 */
contract RoyaltiesRegistryGovernedProxy is NonReentrant, IGovernedContract, IGovernedProxy_New {
    ...
    modifier senderOrigin() {
        ...
        require(
            ...
            'RoyaltiesRegistryGovernedProxy: Only direct calls are allowed!'
        );
        _;
    }
    ...
    modifier onlyImplementation() {
        require(
            ...
            'RoyaltiesRegistryGovernedProxy: Only calls from implementation are allowed!'
        );
        _;
    }
    ...
    function emitRoyaltiesSetForToken(
        ...
        emit RoyaltiesSetForToken(token, tokenId, royaltiesRecipients, royaltiesAmounts);
    }
    ...
    function emitRoyaltiesSetForContract(
        ...
        emit RoyaltiesSetForContract(token, royaltiesRecipients, royaltiesAmounts);
    }
        ...
        returns (IUpgradeProposal)
    {
        require(
            ...
            'RoyaltiesRegistryGovernedProxy: Already active!'
        );
        require(
            _newImplementation.proxy() == address(this),
            'RoyaltiesRegistryGovernedProxy: Wrong proxy!'
        );
    ...
    function upgrade(IUpgradeProposal _proposal) external noReentry {
        ...
        require(
            ...
            'RoyaltiesRegistryGovernedProxy: Not registered!'
        );
        require(_proposal.isAccepted(), 'RoyaltiesRegistryGovernedProxy: Not accepted!');
    ...
    function migrate(IGovernedContract) external {
        revert('RoyaltiesRegistryGovernedProxy: Good try');
    }
    ...
    function() external payable senderOrigin {
        ...
        if (false) {
            ...
            require(
                ...
                'RoyaltiesRegistryGovernedProxy: delegatecall cannot be used'
            );
        }
