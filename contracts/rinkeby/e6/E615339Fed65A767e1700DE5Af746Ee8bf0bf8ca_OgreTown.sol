...
contract OgreTown is ERC721A, Ownable, ReentrancyGuard {    
   ...
   uint256 public tokenCounter;
    ...
    constructor(uint256 _mintLimit, uint256 _reserved_supply, string memory name_, string memory symbol_) ERC721A(name_, symbol_){
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(_baseURI, Strings.toString(tokenId),".json")) : "";
    }
}
