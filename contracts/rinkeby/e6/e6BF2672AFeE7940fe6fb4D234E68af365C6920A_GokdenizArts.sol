    ...
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmWEK4iYWJ17UYtw4pGUsN2816yhagVHv75ZAf7R5aCHSt/hidden.json";
    ...
    address[] private _team = [
        0xa25CDC021Eec2444DB69Fd74B2E63D6D4CA7d5cB, // Admin Account gets 25% of the total revenue
        0x42fdd19A2c119A140c2B894777e21aF8cfB778e2, // Test Account gets 35% of the total revenue
        0x7f0BafaD4E576a9abceFcCff7c81Ef728b18A80C // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("GokdenizArts", "GARTS")
