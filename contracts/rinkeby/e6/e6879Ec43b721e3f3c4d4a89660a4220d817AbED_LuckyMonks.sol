...
contract LuckyMonks is ERC721URIStorage, Ownable, RoyaltiesV2Impl {
    ...
    constructor() payable ERC721("LuckyMonks", "Collection") {
        _escrow = new Escrow();
        _paused = false;
    ...
    function mintNFTs(
        ...
        require(msg.value >= cost * _mintAmount, "Not enough ether to purchase NFTs.");
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            ...
            _royalties[0].value = salesFee;
            _royalties[0].account = payable(owner());
            _saveRoyalties(maxMintAmount + i, _royalties);
        }
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmRfnTp5jKWWhJFr2hzcq66S4AddiwFGvLTpkiwMepCZsp/";
    }
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        if (_royalties.length > 0) {
            return (
                ...
                (_salePrice * _royalties[0].value) / 7000
            );
        }
        return (address(0), 0);
    }
