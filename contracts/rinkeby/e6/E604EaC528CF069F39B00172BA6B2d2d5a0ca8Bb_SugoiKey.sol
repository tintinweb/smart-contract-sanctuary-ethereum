...
contract SugoiKey is Satoshigoat {
	...
	string [3] _hashes = ["QmcACQRDcWwhVXCRCKgFyy6jYUVbxTProhwWLVMdBn3b2z",//STILL WRONG
						  "QmTtw7j9LjHsHMxWC9LsBZPtKES2ioqrLaQsscN1DpPoux",
						  "QmYF5LdngPYTM3kqHBGSN3npXjtcDzHnzxKBLD7Ya3LtBv"];
	string [3] _vanguardHashes = ["QmcACQRDcWwhVXCRCKgFyy6jYUVbxTProhwWLVMdBn3b2z",//STILL WRONG
						  		  "QmTtw7j9LjHsHMxWC9LsBZPtKES2ioqrLaQsscN1DpPoux",
						  		  "QmYF5LdngPYTM3kqHBGSN3npXjtcDzHnzxKBLD7Ya3LtBv"];
		...
		claimArgsOK(to, qty, plugTid)
	{
		...
		_setAux(to, _getAux(to) + uint64(qty));
	}
