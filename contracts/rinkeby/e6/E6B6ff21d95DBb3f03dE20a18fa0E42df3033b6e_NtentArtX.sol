...
contract NtentArtX is ERC721A {
    ...
    function projectShowAllTokens(uint256 _projectId) public view returns (uint256[2] memory){
    ...
    function projectIdToTokenIds(uint256 _projectId) public view returns (uint256[] memory projectTokenIds){
