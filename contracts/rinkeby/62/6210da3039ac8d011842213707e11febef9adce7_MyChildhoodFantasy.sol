...
// File: contracts/MyChildhoodFantasy.sol
...
contract MyChildhoodFantasy is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public constant FREE_MINT_SUPPLY = 5;
    uint256 public INSTANT_FREE_MINTED = 1;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("My Childhood Fantasy ", "MCHF") {
        baseURI = initBaseURI;
