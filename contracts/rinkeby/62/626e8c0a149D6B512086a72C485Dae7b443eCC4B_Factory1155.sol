...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new constructartNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        constructartNFTUser1155Token token = constructartNFTUser1155Token(address(addr));
...
contract constructartNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
