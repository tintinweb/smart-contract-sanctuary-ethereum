...
contract HolyTestToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function withdraw(string memory id, uint256 numberOfTokens) public nonReentrant {
        internalWithdraw(id, numberOfTokens);
    }
    ...
    function internalWithdraw(string memory id, uint256 numberOfTokens) private  {
