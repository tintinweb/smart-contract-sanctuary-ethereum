...
contract Gapes is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(totalSupply() + _mintAmount <= maxSupply - reserveSupply,
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    //per address mint quota exceeted
  ...
  // reserved supply only contract owner can mint
 ...
 function _baseURI() internal view virtual override returns (string memory) {
  ...
  function setReserveSupply ( uint256 _reserveSupplyAmount) public onlyOwner {
    reserveSupply = _reserveSupplyAmount;
  }
  ...
  function setMaxSupply(uint256 _supply) public onlyOwner {
    require(_supply > totalSupply(),'Can only increase supply');
    maxSupply = _supply;
  }
