    ...
    OwnableUpgradeable
{
    ...
    */
    ...
    function loanAdjusted(
        ...
        emit LoanOfferAdjusted(_loanIdAdjusted, borrowerOffers[_loanIdAdjusted]);
    }
        ...
        whenNotPaused
    {
        ...
        require(!this.isLiquidationPending(_loanId), "GNM: Loan Already Payback or Liquidated");
...
interface INetworkLoan {
    ...
    event LoanOfferCreated(uint256 _loanId, NetworkLoanData.LoanDetails _loanDetails);

    event LoanOfferAdjusted(uint256 _loanId, NetworkLoanData.LoanDetails _loanDetails);
