...
contract TestRun is Ownable, ERC721 {
  ...
  uint256 public constant WHITELIST_MINTS = 1500;
  ...
  function publicMint(uint256 amount) external payable {
    require(active, 'Token sale is not currently active');
    require(amount <= MINT_LIMIT_PER_TX, 'Cannot mint more than 5 tokens per transation');
