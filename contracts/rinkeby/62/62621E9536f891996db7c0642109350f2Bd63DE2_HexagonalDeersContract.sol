...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQMjUcpCuRguWouSaYT5Gca1hGoFntzx9cjw8zeApuLHs/";
...
// File: contracts/HexagonalDeersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HexagonalDeersContract is RamppERC721A {
    constructor() RamppERC721A("HexagonalDeers", "HEXAL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/zQmR6aGp7HurYOpYNTjD/contract-metadata";
    }
}