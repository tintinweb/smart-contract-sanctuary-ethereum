...
contract FunkyFlies is Context, IERC20, LockToken {
    ...
    address payable public marketingAddress = payable(0xf81a32aC3645fF9E3A6b4a1D0ac4E607EE441e46); // Marketing wallet address.
    address payable public developerAddress = payable(0x5e11CF5201DAc10afe311828d3473c4b806666f3); // Developer wallet address. 
    address public stakingAddress = address(0x78A276D94354dA15B690A1e15228F2200b45Fc6a); // Staking contract address
