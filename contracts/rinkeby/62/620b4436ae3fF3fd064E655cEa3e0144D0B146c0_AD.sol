...
contract AD is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant MINT_PRICE_WRLD_PRESALE = 300 ether;
    uint256 public constant MINT_PRICE_WRLD = 350 ether;
    ...
    address public constant PAYMENT_ADDRESS = 0xeEB60fEaAE94436d4450c60BC0de117B99254997;
    ...
    constructor() ERC721A("AD", "AD", MAX_BATCH, MAX_TOKENS) {
    ...
    function preSaleWRLDMint(uint256 quantity, bytes32[] calldata proof) external {	
        require(preSale, "Not presale");
        require(MerkleProof.verify(proof, merkleRoot, keccak256(abi.encodePacked(msg.sender))), "Not whitelisted");
        require(_tokensClaimedInPresale[msg.sender] + quantity <= MAX_TOKENS_IN_PRESALE, "Total exceeds 5");
