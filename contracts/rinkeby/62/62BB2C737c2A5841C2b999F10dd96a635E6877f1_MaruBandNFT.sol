  ...
  MerkleProofAllowlisting
{
  ...
  uint256 private devMintedCount = 0;
  uint256 private constant PUBLIC_SALE_PRICE = 0.0001 ether;
  uint256 private constant PRE_SALE_PRICE = 0.00008 ether;
  uint256 private constant COLLECTION_SIZE = 1203;
  uint256 private constant MAX_DEV_MINT_LIMIT = 103;
  uint256 private constant PRE_SALE_MAX_MINT_PER_TX = 2;
