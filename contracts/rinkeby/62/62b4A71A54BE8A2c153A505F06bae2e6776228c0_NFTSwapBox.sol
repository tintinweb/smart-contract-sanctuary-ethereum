    ...
    ERC1155Holder
{
    ...
    /**
        SwapContractFee
        index 0 : Creating SwapBoxFee,
        index 1 : Waiting_for_offers state Fee,
        index 2 : Offered Fee,
        index 3 :  Destoryed Fee
     */
    ...
    //Transfer royaltyfee to royaltyReciever
    function _transferRoyaltyFee(RoyaltyFee[] memory boxRoyaltyFee) internal {
        for(uint256 i = 0; i < boxRoyaltyFee.length; i++){
    ...
    function toOffer(uint256 boxID) public payable isOpenForSwap nonReentrant {
        ...
        require(msg.value >= swapBoxes[boxID].nftSwapFee + swapBoxes[boxID].gasTokenFee + swapConstantFees[2] + boxroyaltyFees, "Insufficient Offer Fee");
        INFTSwapBoxAssets(NFTSwapBoxAssets)._transferERC20Fee(swapBoxes[boxID].erc20Fees, msg.sender, NFTSwapBoxAssets, true);
        ...
        nonReentrant
    {
        ...
        _transferSwapFees(swapBoxes[listBoxID].nftSwapFee, swapBoxes[listBoxID].gasTokenFee, swapBoxes[listBoxID].erc20Fees, swapBoxes[listBoxID].boxRoyaltyFee, withdrawOwner);
        _transferRoyaltyFee(swapBoxes[listBoxID].boxRoyaltyFee);
        _transferSwapFees(swapBoxes[offerBoxID].nftSwapFee, swapBoxes[offerBoxID].gasTokenFee, swapBoxes[offerBoxID].erc20Fees, swapBoxes[offerBoxID].boxRoyaltyFee, withdrawOwner);
        _transferRoyaltyFee(swapBoxes[offerBoxID].boxRoyaltyFee);
    ...
    function deListBox(uint256 listBoxID) public isOpenForSwap nonReentrant {
        ...
        _transferSwapFees(swapBoxes[listBoxID].nftSwapFee, swapBoxes[listBoxID].gasTokenFee, swapBoxes[listBoxID].erc20Fees, swapBoxes[listBoxID].boxRoyaltyFee, msg.sender);
        emit SwapBoxDeList(
            listBoxID,
            State.Initiated,
    ...
    function deOffer(uint256 offerBoxID) public isOpenForSwap nonReentrant {
        ...
        _transferSwapFees(swapBoxes[offerBoxID].nftSwapFee, swapBoxes[offerBoxID].gasTokenFee, swapBoxes[offerBoxID].erc20Fees, swapBoxes[offerBoxID].boxRoyaltyFee, msg.sender);
