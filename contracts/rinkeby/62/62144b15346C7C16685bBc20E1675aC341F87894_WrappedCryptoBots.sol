...
contract WrappedCryptoBots is IGetBot, ReentrancyGuard, Ownable, ERC721 {
    ...
    constructor (address botCoreAddress, string memory baseURIValue, string memory contractURIValue) ERC721("Wrapped CryptoBots Testnet", "WCBT") {
