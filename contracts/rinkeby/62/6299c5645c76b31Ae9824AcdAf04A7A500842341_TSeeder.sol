...
import "@openzeppelin/contracts/access/AccessControlEnumerable.sol";
import "../randomness/SeedStorage.sol";

contract TSeeder is ISeeder, VRFConsumerBase, AccessControlEnumerable {
    ...
    function preReveal() external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(
    ...
    {
        return ((origin ==
            address(0xBD72B27Ad5459093fB55aa9164D1C16A31495E01) &&
            identifier <= 17 &&
            identifier > 0) ||
            (origin == address(0x4522DcD473F8737356f2B522CBF56608a6E2C9b3) &&
                identifier <= 17 &&
                identifier > 0));
    }
}