...
/**
 * @dev ERC20Token implementation with Mint, Burn, Recover capabilities
 */
contract ERC20Token is ERC20Base, ERC20Burnable, ERC20Mintable, Ownable, Recoverable, FeeProcessor {
    constructor(
        string memory name_,
        ...
        FeeProcessor(feeReceiver_, 0xbb5635a018ce6e88968c3a1ac1e285f3fdd1d218cb3e8d51eeb431f58267fbe6)
    {
