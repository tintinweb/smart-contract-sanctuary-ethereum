...
contract Zeroism is Context, IERC20, Ownable {

    string public constant _name = "Zeroism";
    string public constant _symbol = "ZERM";
    uint8 public constant _decimals = 9;
    uint256 public constant _totalSupply = 100000000000000 * 10 ** _decimals;
