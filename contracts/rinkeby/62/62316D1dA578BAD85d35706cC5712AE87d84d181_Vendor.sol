...
// Deployer Account is 0x989b1da1a82c6200e8cf882d0b047a7a6583e651 https://oriojas-beginner.surge.sh/
...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 _amount) external {
    ...
    bool tokenEvent = yourToken.transferFrom(msg.sender, address(this), _amount);
    require(tokenEvent, "Failed to transfer tokens");
