...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
 ...
 contract ks01test is Ownable, ERC721A, ReentrancyGuard {
    struct Config {
        uint256 maxSupply;
        uint256 reserved;
    ...
    Config public config= Config(200, 0, 50, 0.005 ether, 10, "");
    bool public isMintStarted= false;
    uint256 public maxFreeMintAmountPerTx=3;
    uint256 public maxMintAmountPerTx=10;
    constructor() ERC721A("ks01test", "ks01") 
    {
