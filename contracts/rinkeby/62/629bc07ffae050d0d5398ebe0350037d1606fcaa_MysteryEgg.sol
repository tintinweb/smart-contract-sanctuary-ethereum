...
contract MysteryEgg is ERC721A, Ownable {
	...
	address private constant developerContract = 0x9Cc2A05A93Db3f262FcA779605EF953dA196B6A2;
	address private constant developerDApp = 0x10469C7E81161BC7fF99c5647eEBdA1368F6482A;
	address private constant team = 0xB938D59B63cB6ebAE47F5c0d85FbfB506395b4c8;
	uint256 public howMuchPaid;
	uint256 public toPay = 160000000000000000;
    ...
    */
	...
	function withdrawal() external onlyOwner {
			if (howMuchPaid >= toPay) {  		
				toPay = toPay - (howMuchPaid + address(this).balance);
				...
				howMuchPaid = howMuchPaid + toPay;

				(bool x, ) = payable(team).call {
