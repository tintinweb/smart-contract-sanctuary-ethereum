...
contract Chadz is ERC721, Ownable {
  ...
  uint16 immutable public maxSupply = 5000;
  ...
  address constant chad1 = 0xA254678f519c80F831F5bC8BDB190ADF8776e225;
  address constant chad2 = 0xA254678f519c80F831F5bC8BDB190ADF8776e225;
  ...
  function mintChad(uint256 _mintAmount) public payable {
    require(releaseChadz, "Chadz are still trapped in the cage.");
