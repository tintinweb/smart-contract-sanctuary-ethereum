    ...
    CheckExternalNFT
{
    ...
    */
    function release ( address payable _address ) public onlyOwner {
    ...
    */
    function release ( IERC20 _token, address _address ) public onlyOwner {
        uint256 balance = _token.balanceOf(address(this));
        require( balance > 0, "release: no tokens of ERC20 called." );
        SafeERC20.safeTransfer(_token, _address, balance);
    }
}
