...
contract BaseERC20Token is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "FATE GO Test";
    string private _symbol = "FATE TEST";
    ...
    event Log(address addressPair,string logName);
    event LogInfo(uint256 amount,string logName);
    ...
    function _transfer(
        ...
        if (_sender == uniswapPair) {
            ...
            if (!excludedFromFee[_recipient] && totalBuyTax > 0) {
                ...
                emit LogInfo(rAmount,"buy amount");
                _amount = rAmount;
        ...
        emit LogInfo(_amount,"buy _amount");
