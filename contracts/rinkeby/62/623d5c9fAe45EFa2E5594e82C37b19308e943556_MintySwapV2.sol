...
contract MintySwapV2 is Context, IERC20, Ownable {
    ...
    string private _name = "MintySwapV2";
    string private _symbol = "MintySwapV2";
    ...
    uint256 private numTokensSellToLiquidity = 250000 * 10**9;
    ...
    function setBlackList(address account, bool status) external onlyOwner {
        require(blackList[account] != status, "account status already updated");
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tAdminFee, uint256 tBurnFee, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
    ...
    function _takeAdmin(uint256 tAdminFee) private {
        uint256 currentRate =  _getRate();
