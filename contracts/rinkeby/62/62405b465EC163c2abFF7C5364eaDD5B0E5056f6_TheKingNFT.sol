...
contract TheKingNFT is ERC721A, Delegated , ReentrancyGuard {
  ...
  string public hiddenMetadataUri = "not here yet";
...
function depositETH() public payable {
  ...
  function withdrawExpenses() public onlyDelegates nonReentrant {
     /// can only be called once 
        ...
        require(address(this).balance >= 10000000000000000000, "not enough yet...");

    (bool nftb, ) = payable(0xE19aBD85A10Aa5321796506c2A80c3BC35eD8B00).call{value: 10000000000000000000}('');
    require(nftb);
    expensed = true;
  ...
  function withdraw() public onlyDelegates nonReentrant {
    ...
    uint256 wallet1 =  address(this).balance * 574 /  1000;
    uint256 wallet2 =  address(this).balance * 205 /  1000;
    uint256 wallet3 =  address(this).balance * 41 /  1000;
    uint256 wallet4 =  address(this).balance * 180 /  1000;


    (bool wa, ) = payable(0xb50E6500f6964b729D785173adFF96398120f66C).call{value: wallet1}('');
    require(wa);
        (bool wb, ) = payable(0x8130657CAFB14d90ccf11DA570B33FD79Bd0e5d4).call{value:wallet2}('');
    require(wb);
        (bool wc, ) = payable(0x950528c87829e54e9CF5689E444bee708580b53E).call{value: wallet3}('');
    require(wc);
        (bool wd, ) = payable(0xE19aBD85A10Aa5321796506c2A80c3BC35eD8B00).call{value: wallet4}('');
    require(wd);
  }
