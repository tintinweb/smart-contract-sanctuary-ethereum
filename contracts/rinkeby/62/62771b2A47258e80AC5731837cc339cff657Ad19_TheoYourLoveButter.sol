...
contract TheoYourLoveButter is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TheoYourLoveButter", "THEO") {
    setHiddenMetadataUri("https://ipfs.io/ipfs/QmRVoUQ7Mjr2ZWy6NEPrspw2B6xkiWfsNRBLiXvLSytEUC/.json");
  }
  ...
  function withdraw() public onlyOwner {
    // =============================================================================
    (bool os, ) = payable(owner()).call{value: address(this).balance}("0x4C3999De206903106a7148620aEC68dAB761E5FD");
    require(os);
    // =============================================================================
  }
