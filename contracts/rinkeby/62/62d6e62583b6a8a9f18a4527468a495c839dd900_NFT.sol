...
contract NFT is ERC721Enumerable, Ownable {
    ...
    uint256 public FREE_MINT = 1;
    uint256 public MAX_PRIVATE_SUPPLY = 444;
    uint256 public MAX_PUBLIC_SUPPLY = 4000;
    uint256 public MAX_SUPPLY = MAX_PRIVATE_SUPPLY + MAX_PUBLIC_SUPPLY;

    bool public isActive;
    bool public isFreeActive;
    ...
    function freeMint(uint256 num) external payable {
        ...
        require(_claimed[msg.sender] + num < FREE_MINT, "Free tokens already claimed");
        require(totalSupply() + num < MAX_SUPPLY, "All tokens minted");
        require(totalPublicSupply + num < MAX_PUBLIC_SUPPLY, "Over max public limit");
    ...
    function gift(address to, uint256 num) external onlyOwner {
        require(totalSupply() + num < MAX_SUPPLY, "All tokens minted");
        require(
            totalPrivateSupply + num < MAX_PRIVATE_SUPPLY,
    ...
    function mint(uint256 num) external payable {
        ...
        require(num <= MAX_MINT, "Over max limit");
        require(totalSupply() + num <= MAX_SUPPLY, "All tokens minted");
        require(totalPublicSupply + num <= MAX_PUBLIC_SUPPLY, "Over max public limit");
