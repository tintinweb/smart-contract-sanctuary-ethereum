...
contract SharpeKeeper is KeeperCompatibleInterface{
    ...
    function rebalanceQuery() public view returns (bool) {
        ...
        // check if price not too close to boundary
    ...
    /**
     * @notice checks if time duration for rebalance has been reached
     */
    ...
    function performUpkeep(bytes calldata performData) external override{
        lastTimeStamp = block.timestamp;
        require(rebalanceQuery(), "can't rebalance at the moment");
        (, int24 tick, , , , , ) = pool.slot0();
