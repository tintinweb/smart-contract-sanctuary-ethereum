...
contract MetaRelics is ERC721Enumerable, Ownable {
	...
	// mint function for the 2nd sale wave. Only selected addresses will be allowed
	// Owner can still only mint 1. Owner should always invoke presaleMint for minting multiple.
    // Call will fail if the contract is paused, the 
