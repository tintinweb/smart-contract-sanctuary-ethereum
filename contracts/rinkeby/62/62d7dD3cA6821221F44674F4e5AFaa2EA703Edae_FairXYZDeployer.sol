...
contract FairXYZDeployer is ERC721xyz, Pausable{
    ...
    // override the URI
    function overrideURI(string memory newURI)
        onlyOwner
        public
    {
    ...
    // change your reveal date - change the Path URI
    function changePathURI(string memory newPathURI)
        onlyOwner
        public
    {
        require(!lockURI, "URI change has been locked");
        ...
        returns (uint256)
    {
        ...
        if(maxMintsPerWallet > 0)
        {
            ...
            {
                reimbursement += numberOfTokens - (maxMintsPerWallet - mintsPerWallet[msg.sender] );
        ...
        {
            reimbursement += numberOfTokens - (maxTokens - viewMinted() );
        ...
        {
            payable(msg.sender).transfer( reimbursementPrice );
        }
    ...
    function releaseMint() onlyOwner public
    {
