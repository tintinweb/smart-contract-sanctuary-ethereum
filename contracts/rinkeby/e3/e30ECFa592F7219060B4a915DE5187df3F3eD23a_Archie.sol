...
contract Archie is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('Archie Test #2 ', 'ArchieTest2') {
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0xD8151257A425BcA15cA0a6F7e73561a11Ab54462).transfer(balanceP1);
        payable(0x8dCE7900e1870198749b050d82B211D6887bC300).transfer(balanceP2);
