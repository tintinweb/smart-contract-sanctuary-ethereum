...
contract JapanDAO is ERC1155, Ownable {
    ...
    constructor() ERC1155("") {
        name = "JapanDao";
        symbol = "JDN";
        phaseData[1].totalSupply = 1000;
        phaseData[1].cost = 0;
        phaseData[1].maxMintAmount = 5;
        tokenURI[1] = "ipfs://QmNpYsk8vpkkRKV6AvcbhP8QR1VY3eQfeVRRS1axJcszyK/1.json";
    }

    function setPhaseData( uint256 _id , uint256 _totalSupply , uint256 _cost , uint256 _maxMintAmount ) external onlyOwner {
        phaseData[_id].totalSupply = _totalSupply;
