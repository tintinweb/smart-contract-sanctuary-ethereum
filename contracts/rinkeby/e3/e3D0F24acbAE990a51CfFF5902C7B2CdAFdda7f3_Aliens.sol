...
contract Aliens is ERC721Enumerable, Ownable {
    ...
    */
    ...
    function whitelistRemaining(address _address) public view returns (uint8) {
    ...
    */
    function airdrop(uint8 numberOfTokens) external onlyOwner {
        ...
        for (uint8 i = 1; i <= numberOfTokens; i++) {
            _mintTokens(IERC721Enumerable(MCVAddress).ownerOf(airdropNonce + i), 1);
        }
    }
    ...
    */
    ...
    function viewAirdropNonce() public view returns (uint256) {
        return airdropNonce;
    }

    function setBaseURI(string memory _newURU) external onlyOwner {
        _baseTokenURI = _newURU;
    }
