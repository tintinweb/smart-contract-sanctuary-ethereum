...
contract GreenWoodERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_WHITELIST = 280;
    ...
    uint public saleStartTime = 1663927200;
    ...
    uint private constant maxPerAddressDuringWhitelistMint = 100;
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require(currentTime() >= saleStartTime, "Sale has not started yet"); // Satış henüz başlamadı
        require(currentTime() < saleStartTime + 12 hours, "Sale is finished"); // Satış bitti
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "Contract is Paused");
        require(currentTime() >= saleStartTime + 12 hours, "Public sale has not started yet"); // Toplu satış henüz başlamadı
        require(currentTime() < saleStartTime + 24 hours, "Public Sale is finished"); // Kamu Satışı tamamlandı
