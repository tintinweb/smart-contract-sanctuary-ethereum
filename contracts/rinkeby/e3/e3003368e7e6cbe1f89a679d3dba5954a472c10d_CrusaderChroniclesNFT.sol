...
contract CrusaderChroniclesNFT is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmbqC31XHUBpnj9nKtfRFyFNwnogoMSeATDEtZW7t5APjj/";
  ...
  constructor() ERC721A("Crusader Chronicles", "Crsdr") {
