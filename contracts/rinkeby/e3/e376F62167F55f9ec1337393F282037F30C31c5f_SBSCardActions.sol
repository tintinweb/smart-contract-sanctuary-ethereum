...
contract SBSCardActions is ERC1155, ERC1155Supply, ERC1155Burnable, Ownable, ReentrancyGuard {
    ...
    address public tokenContract = 0x96B5ea3dA846D894ce38508126c48c55e0119bbF;
    ...
    */
    function mintAction(uint256 tokenId, uint256 qty) external nonReentrant {
        ...
        require(actions[tokenId].tokenPrice * qty <= getAllowance(), "You need to approve more ape coin to be transferred");
    ...
    */
    ...
    /**
    * @notice get tokens allowed to be transferred 
    */
    function getAllowance() public view returns(uint256){
       return IERC20(tokenContract).allowance(msg.sender, address(this));
    }
