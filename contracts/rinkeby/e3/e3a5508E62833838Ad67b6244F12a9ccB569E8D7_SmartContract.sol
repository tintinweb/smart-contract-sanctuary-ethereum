...
/**
2% autoliquidity 2% autoburn 2% auto reward 2 plus 6% dev
1M supply
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "nzv2";
    uint8 private constant _decimals = 9;

    uint256 public buyAutoLiquidityFee = 200;
    uint256 public buyAutoBurnFee = 200;
    uint256 public buyAutoRewardFee = 200;
    uint256 public buyBAZFee = 600;
    uint256 public totalBuyFees;
    //uint256 public totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyAutoRewardFee;
    //uint256 public totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyAutoRewardFee + buyBAZFee;

    uint256 public sellAutoLiquidityFee = 200;
    uint256 public sellAutoBurnFee = 200;
    uint256 public sellAutoRewardFee = 200;
    uint256 public sellBAZFee = 600;
    uint256 public totalSellFees;
    //uint256 public totalSellFees =  sellAutoLiquidityFee + sellAutoBurnFee + sellAutoRewardFee;
    //uint256 public totalSellFees =  sellAutoLiquidityFee + sellAutoBurnFee + sellAutoRewardFee + buyBAZFee;
    ...
    constructor () {
        ...
        //totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyAutoRewardFee;
        totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyAutoRewardFee + buyBAZFee;
        ...
        totalSellFees = sellAutoLiquidityFee + sellAutoBurnFee + sellAutoRewardFee + sellBAZFee;   
        ...
        swapEnabled = true;
        maxWalletAmount = 40001 * 10**9; //should be change to 10K
        maxTxAmount = 40001 * 10**9; //should be change to 10k
        tradingOpen = true;
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
       uint256 totalFee = autoLiquidityRatio + autoBurnFeeRatio + autoRewardFeeRatio + autoBurnFeeRatio;
        if (totalFee == 0)
            return;
        uint256 toLiquify = (tokenAmount * autoLiquidityRatio) / (totalFee);
        uint256 toSwapForEth = tokenAmount - toLiquify;
        ...
        if (toLiquify > 0) {
            uniswapV2Router.addLiquidityETH{value: liquidityBalance}(
                address(this),
                toLiquify,
                0,
                0,
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = tokensForAutoLiquidity + tokensForAutoBurn + tokensForAutoReward + tokensForBaz;
    ...
    /** 
    function updateBuyFees(uint256 _buyAutoLiquidityFee, uint256 _buyAutoBurnFee, uint256 _buyAutoRewardFee) external onlyOwner {
        buyAutoLiquidityFee = _buyAutoLiquidityFee;
        buyAutoBurnFee = _buyAutoBurnFee;
        buyAutoRewardFee = _buyAutoRewardFee;
        totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyAutoRewardFee;
    ...
    */   
    function updateBuyFees(uint256 _buyAutoLiquidityFee, uint256 _buyAutoBurnFee, uint256 _buyAutoRewardFee, uint256 _buyBAZFee) external onlyOwner {
        buyAutoLiquidityFee = _buyAutoLiquidityFee;
        buyAutoBurnFee = _buyAutoBurnFee;
        buyAutoRewardFee = _buyAutoRewardFee;
        buyBAZFee = _buyBAZFee;
      ...
      /** 
    function updateSellFees(uint256 _sellAutoLiquidityFee, uint256 _sellAutoBurnFee, uint256 _sellAutoRewardFee) external onlyOwner {
        sellAutoLiquidityFee = _sellAutoLiquidityFee;
        sellAutoBurnFee = _sellAutoBurnFee;
        sellAutoRewardFee = _sellAutoRewardFee;
        totalSellFees = sellAutoLiquidityFee + sellAutoBurnFee + sellAutoRewardFee;
    ...
    */
    function updateSellFees(uint256 _sellAutoLiquidityFee, uint256 _sellAutoBurnFee, uint256 _sellAutoRewardFee, uint256 _sellBAZFee) external onlyOwner {
        sellAutoLiquidityFee = _sellAutoLiquidityFee;
        sellAutoBurnFee = _sellAutoBurnFee;
        sellAutoRewardFee = _sellAutoRewardFee;
        sellBAZFee = _sellBAZFee;
