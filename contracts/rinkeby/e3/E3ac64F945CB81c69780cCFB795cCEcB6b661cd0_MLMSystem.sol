...
contract MLMSystem is Initializable {
    ...
    function getLevel(address _member) public view returns (uint8 level) {
        ...
        if (currentBalance >= levels[0] && currentBalance < levels[1]) {
            return 1;
        } else if (currentBalance >= levels[1] && currentBalance < levels[2]) {
            return 2;
        } else if (currentBalance >= levels[2] && currentBalance < levels[3]) {
            return 3;
        } else if (currentBalance >= levels[3] && currentBalance < levels[4]) {
            return 4;
        } else if (currentBalance >= levels[4] && currentBalance < levels[5]) {
            return 5;
        } else if (currentBalance >= levels[5] && currentBalance < levels[6]) {
            return 6;
        } else if (currentBalance >= levels[6] && currentBalance < levels[7]) {
            return 7;
        } else if (currentBalance >= levels[7] && currentBalance < levels[8]) {
            return 8;
        } else if (currentBalance >= levels[8] && currentBalance < levels[9]) {
            return 9;
        } else if (currentBalance >= levels[9]) {
            return 10;
        }
    }
