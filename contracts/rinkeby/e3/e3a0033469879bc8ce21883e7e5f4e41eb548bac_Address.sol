...
// File: contracts/EyesTestNft.sol
...
contract EyesTestNft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("EYESTEST", "EYE") {
    setHiddenMetadataUri("ipfs://QmeuFTMaEvbZNym8YqcHsbcZnkTVR9aGr8ek5hWeokspz1/hidden.json");
  }
