...
contract Test123456 is  Ownable, ERC721A, ReentrancyGuard, PaymentSplitter {
    ...
    address[] private _team = [
        0x1A7155c619B3582F847394Df30603F86EEcB71B0,
        0x17395342d2c74C93f40BAA620D2d434cAec4b839,
        0xA3cb90D70f72Ae63Ba87A61B3fBE83c71FCC5EbD
    ];
    ...
    constructor() ERC721A("Test123456", "TT")  PaymentSplitter(_team, _teamShares) {
        deployer = msg.sender;
    }
    ...
    function packAux(uint32[] memory _mintPerWallet) private pure returns(uint64) {
        ...
        //    val |= (uint64(_mintPerWallet[i]) << (i)*8);
        //}
        //
        //val |= (uint64(_mintPerWallet[0]));
        //return val;
    }
    ...
    function unpackAux(uint64 _aux) private pure returns(uint32[] memory) {
        ...
        //uint8[] memory _mintPerWallet = new uint8[](8); // 8 = num max of sales
        //for(uint256 i = 1; i < 2; i++){
        //    _mintPerWallet[i] = uint8(_aux >> (8 * (i)));
        //}
        //_mintPerWallet[0] = uint8(_aux);
        //
