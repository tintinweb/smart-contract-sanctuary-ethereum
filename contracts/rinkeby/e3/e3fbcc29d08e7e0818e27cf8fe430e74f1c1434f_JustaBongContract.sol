...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x22488134b89E953D2FBc1DC76ca13878Bfbf1881];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 420 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYmk2F6iXT4NiX7gkN66WHUreFC1zpv9nXBEtojmST8Lz/";
...
// File: contracts/JustaBongContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JustaBongContract is RamppERC721A {
    constructor() RamppERC721A("JustaBong", "BONG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/DBox2slWA7xfP5pfxHn8/contract-metadata";
    }
}