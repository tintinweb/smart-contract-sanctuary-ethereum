...
contract Abcd is Context, AccessControlEnumerable, ERC20, ERC20Permit {
        ...
        returns (bool) 
    {
        ...
        require(currentAllowance >= amount, "ABCD: transfer amount exceeds allowance");
        ...
        notPausedContract
    {
        ...
        require(vestingContract == _msgSender(), "ABCD: !VESTING_CONTRACT");
        ...
        notPausedContract
    {
        ...
        require(rewards > 0, "ABCD: !rewards");
