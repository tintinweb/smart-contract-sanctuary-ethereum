...
contract BridgeBank is Initializable, ReentrancyGuardUpgradeable {
    ...
    function getTokenForExactToken(
    ...
    function getImpactTokenOut(uint256 _amountTokenIn, address[] memory path)
        internal
        view
        returns (uint256, uint256)
    {
        ...
        uint256[2] memory reserve = [
            ...
            IERC20(path[1]).balanceOf(getSushiToken) -
                getExactTokenForToken(_amountTokenIn, path)
        ];
    ...
    function getImpactTokenIn(uint256 _amountTokenOut, address[] memory path)
        internal
        view
        returns (uint256, uint256)
    {
        ...
        uint256[2] memory reserve = [
            IERC20(path[0]).balanceOf(getSushiToken) +
                getTokenForExactToken(_amountTokenOut, path),
    ...
    function getExactTokenForStableToken(
        ...
        path[1] = stableToken;
        return getExactTokenForToken(_amountTokenIn, path);
    }
    ...
    function getImpactGetExactTokenForStableToken(
        ...
        return getImpactTokenOut(_amountTokenIn, path);
    }
    ...
    function getExactStableTokenForToken(
        ...
        _amountStableTokenIn =
            ...
            10000;
        return getExactTokenForToken(_amountStableTokenIn, path);
    }
    ...
    function getImpactGetExactStableTokenForToken(
        ...
        return getImpactTokenOut(_amountStableTokenIn, path);
    }
    ...
    function getTokenForExactStableToken(
        ...
        path[0] = _tokenInAddr == address(0) ? WETH : _tokenInAddr;
        path[1] = stableToken;
        return getTokenForExactToken(_amountStableTokenOut, path);
    }
    ...
    function getImpactGetTokenForExactStableToken(
        ...
        return getImpactTokenOut(_amountStableTokenOut, path);
    }
    ...
    function getImpactGetStableTokenForExactToken(
        ...
        (amountOutIn, amountOutAfter) = getImpactTokenOut(
            _amountTokenOut,
            path
        );
