// deployed to 0xe3C1c820f688Db1986a10B8ddACd9e4De2a318f3 on rinkeby
...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable, VRFConsumerBaseV2  {
   ...
   // For testing with the mock on Rinkeby, pass in 10(seconds) for `updateInterval` and the address of your 
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        ...
        //comes from erc721 extentension URI storage. 
    ...
    function getLatestPrice() public view returns(int256){
      (
            /*uint80 roundID*/,
            int price, // 18 decimals per chainlink docs on btc/usd pair
            /*uint startedAt*/,
            /*uint timeStamp*/,
            /*uint80 answeredInRound*/
 ...
 // random values to.
  function fulfillRandomWords(
    ...
    //       //get random number for index of uris
    //     for(uint i= 0; i < _tokenIdCounter.current(); i++){
