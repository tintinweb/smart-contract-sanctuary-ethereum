...
contract EthboxMetadata is Ownable {
    ...
    constructor() {
        ...
        messageInsert = '<g id="message-${_INDEX}" style="display:${_VISIBILITY}" onclick="cycleMessage()"><foreignObject x="10%" y="5%" width="97.1%" height="14.2%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:white;font-family:monospace;font-size:0.9em">to  : ${_TO}</div></foreignObject><foreignObject x="10%" y="10%" width="97.1%" height="14.2%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:white;font-family:monospace;font-size:0.9em">from: ${_FROM} </div></foreignObject><foreignObject x="10%" y="15%" width="97.1%" height="90%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:#4AF626;font-family:monospace;font-size:1.5em"> ${_MESSAGE} </div></foreignObject><foreignObject x="10%" y="85%" width="97.1%" height="90%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:red;font-family:monospace;font-size:1.8em;text-align:left"> Bid: ${_VALUE} ETH </div></foreignObject><foreignObject x="82%" y="85%" width="97.1%" height="90%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:red;font-family:monospace;font-size:1.5em;text-align:left">(${_POSITION})</div></foreignObject></g>';
        emptyInsert = '<g style="display:visible"><foreignObject x="10%" y="45%" width="97.1%" height="14.2%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:white;font-family:monospace;font-size:0.9em"> ${_TO}</div></foreignObject><foreignObject x="10%" y="10%" width="97.1%" height="90%"><div class = "plain-text" xmlns="http://www.w3.org/1999/xhtml" style="color:#4AF626;font-family:monospace;font-size:1.5em"> Empty Ethbox</div></foreignObject></g>';
        ethboxInsert = '<svg id= "wrapper" width="350px" height="350px" viewbox="0 0 100% 100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink= "http://www.w3.org/1999/xlink"><rect width="100%" height="100%" fill="black" /><text x="10%" y="95%" font-size="0.8em" fill="white" font-family="monospace"> Click or tap to cycle messages </text>${_MESSAGES}<script>var current_message = 0;var messages = document.querySelectorAll(\'[id^="message-"]\');document.getElementById("wrapper").setAttribute("width", "100%");document.getElementById("wrapper").setAttribute("height", "100%");function cycleMessage() {document.getElementById("message-" + current_message).style.display ="none";current_message = (current_message + 1) % messages.length;document.getElementById("message-" + current_message).style.display ="block";};</script></svg>';
    }
