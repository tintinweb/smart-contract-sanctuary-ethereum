...
// File: contracts/IDO/IDOToken.sol
...
contract IDOToken is ERC20, Ownable {
    uint256 private constant _initialSupply = 2500000 * 10**18;
    uint256 private constant _maxSupply = 6000000 * 10**18;
    string public _symbol;
    string public _name;
    address public ido;

    constructor(address admin) ERC20("IDO Daylight", "IDODAYL") {
        _mint(msg.sender, _initialSupply);
        _transferOwnership(admin);
    }

    /**
     * @dev See {ERC20-initialSupply}.
     */
