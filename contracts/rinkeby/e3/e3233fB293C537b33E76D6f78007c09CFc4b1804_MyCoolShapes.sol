...
contract MyCoolShapes is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("My Cool Shapes", "MCSC") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 150;
  ...
  uint256 public constant MAX_MULTIMINT = 150;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 150 at a time");
