    ...
    PaymentSplitter 
{
    ...
    function presaleMint(address account, uint256 _amount, bytes32[] calldata _proof, uint256 tokenId)
    external
    payable
    ...
    function mintInternal(uint256 tokenId1) internal nonReentrant {
        _tokenIds.increment();
