...
import "./DavinciUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new DavinciUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DavinciUser1155Token token = DavinciUser1155Token(address(addr));
...
contract DavinciUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControl
