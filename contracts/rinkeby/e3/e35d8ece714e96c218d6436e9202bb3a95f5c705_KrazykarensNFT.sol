...
/**
 * @title A contract for Krazy Karens
 * @author H!ro
 * @notice NFT Minting
 */
contract KrazykarensNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    address[] private _royaltyAddresses = [
        ...
        0xf3Dd09D30249Ca3FB34251aBC144ad4409d79597  // Team wallet address
    ];
    ...
    constructor(
        ...
        _royaltyShares[_royaltyAddresses[0]] = 1;  // Royalty for dev wallet
        _royaltyShares[_royaltyAddresses[1]] = 99; // Royalty for team wallet
    }
        ...
        payable
    {
        ...
        require(
            _count > 0 && balanceOfAddress[msg.sender] + _count <= MAX_MINT_PER_WL,
            "COUNT_INVALID"
        );
    ...
    function mint(uint256 _count) public payable {
        ...
        require(
            _count > 0 && balanceOfAddress[msg.sender] + _count <= MAX_MINT_PER_TX,
            "COUNT_INVALID"
        );
        require(totalSupply >= GIVEAWAY_SUPPLY, "GIVEAWAY_NOT_MINTED");
        require(totalSupply + _count <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
