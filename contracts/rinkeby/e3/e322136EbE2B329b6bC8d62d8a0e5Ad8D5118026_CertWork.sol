...
contract CertWork {
    ...
    returns (address)
  {
    ...
    CertProposal proposalContract = new CertProposal(
      'https://ipfs.infura.io/ipfs/QmTzMnK6zsAJ7CKt9LEF268dToxhfAFcNxYVx2Z1MbxJng',
      'https://ipfs.infura.io/ipfs/Qmcpzx1TuT6ukPGk1XRULYqtHV1RnDgNWJC4MYz8Xv3dtr',
      'https://ipfs.infura.io/ipfs/QmWHMe3jH4b1HHE95czDPYhZ8mqS54gon3W18C1VPYhQNu'
    );
...
contract CertProposal is ERC721 {
  ...
  constructor(
    ...
    bronzeTokenURI = _bronzeTokenURI;
    silverTokenURI = _silverTokenURI;
    goldTokenURI = _goldTokenURI;
  }
}
