...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function setTreasureContract(address _treasureContract) external {
        address _mamager = IUniswapV2Factory(factory).manager();
        require(
            IManager(_mamager).isSuperAdmin(msg.sender),
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"06bbd3bebeb8ff0cb34b0a4b91879b80d09e4371ea29a5047316e5117fc531f9" // init code hash
                    )
                )
            )
        );
