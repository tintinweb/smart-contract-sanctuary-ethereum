...
/**
 * @title Sq NFT Smart Contract
 * @author @0x33
 */
contract Sq is ERC721A, Ownable {
    ...
    address public signingAuthority = 0x4964766AD15F8F601a30a6233227fEf29a16c549;

    constructor() ERC721A("Sq", "S")  {}
    ...
    function reserveSquiggles(address target, uint256 quantity) external onlyOwner {
