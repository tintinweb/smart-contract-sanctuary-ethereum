...
contract Marketplace is ReentrancyGuard,ERC1155Holder {
     ...
     */
    function cancelMarketItem(address nftContractAddress, uint256 marketItemId, uint256 amount) public payable nonReentrant {
        uint256 tokenId = marketItemIdToMarketItem[marketItemId].tokenId;
...
contract NFTMint is ERC1155, Ownable {
    ...
    function initialize(string memory _name, string memory _symbol, address owner) public {
        Owner = owner;
        name = _name;
        symbol = _symbol;
    }
