...
import "./NFTTransferManager.sol";
import "../royalties/IRoyaltiesProvider.sol";

contract Exchange is ExchangeCore, NFTTransferManager {
    function __Exchange_init(
        ...
        __NFTTransferManager_init_unchained(newProtocolFee, newDefaultFeeReceiver, newRoyaltiesProvider);
...
import "../TransferProxy/ITransferProxy.sol";
import "../TransferProxy/INftTransferProxy.sol";
import "../TransferProxy/IERC20TransferProxy.sol";
...
abstract contract NFTTransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function __NFTTransferManager_init_unchained(
        uint newProtocolFee,
        address newDefaultFeeReceiver,
        IRoyaltiesProvider newRoyaltiesProvider
...
abstract contract ExchangeCore is Initializable, OwnableUpgradeable, AssetMatcher, TransferExecutor, OrderValidator, ITransferManager {
    ...
    function matchAndTransfer(LibOrder.Order memory orderLeft, LibOrder.Order memory orderRight) internal {
        LibAsset.AssetType memory makeMatch = matchAssets(orderLeft.makeAsset.assetType, orderRight.takeAsset.assetType);
        require(makeMatch.assetClass != 0, "assets don't match");
        LibAsset.AssetType memory takeMatch = matchAssets(orderLeft.takeAsset.assetType, orderRight.makeAsset.assetType);
