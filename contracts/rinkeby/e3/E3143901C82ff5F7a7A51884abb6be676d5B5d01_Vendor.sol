...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    require(msg.value > 0, "Requires ETH");
  ...
  function sellTokens(uint256 amount) public payable validAddress(msg.sender) moreThanZero(amount) {
