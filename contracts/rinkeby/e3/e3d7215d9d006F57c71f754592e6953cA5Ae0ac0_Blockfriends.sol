...
// File: contracts/Blockfriends2.sol
...
contract Blockfriends is ERC721, ERC721URIStorage, Ownable {
	...
	uint256 MAX_TOKENS_PRESALE=500;
	uint256 public FEE;
	...
	address public constant devAddress = 0x169eD44E61D704Fe373af5E0B4D33a7D55E3c9c6;

    //Mapping to store URI data for delayed reveal
    //mapping(uint256 => string) public tokenIdToURI;

    constructor(string memory mybaseuri, string memory myrevealuri) ERC721("Blockfriends", "BLF") {
		_tokenIdCounter.increment();
		setBaseURI(mybaseuri);
		setprerevealURI(myrevealuri);
		FEE=62500000000000000;
		FEEpresales=60000000000000000;
		MAXNFTperADDR = 500;
		MAX_TOKENS=500;
	...
	function mint(uint minttimes) public payable {
