...
contract MetroBlockBlackout is ERC721, Controllable, IMetroBlockInfo {
    ...
    string public baseTokenURI = "ipfs://QmPFNYa3LPiXRp2zZCxAswUR3XxTtdNJxCh7MgzfsBnLKZ/";
    ...
    function getMaxBlockCount() public view returns (uint256) {
    ...
    function metMint(uint256 amount, bool stake) public {
        ...
        metToken.burnFrom(_msgSender(), metPrice * amount); 
        _mint(amount, stake);
    }
