...
(̴̡̟̺̾͘͘ ͡°̵̟͓̽͆ ͜ʖ̸͔̘͎͋̐̐ ͡°̵̪͚͖̔̈́͐)̴̡͖̘̓̿                                                                                                       
...
contract kappa is ERC721A, Ownable {
    ...
    uint256 public constant PAID_SUPPLY = 44500;
    uint256 public constant MAX_SUPPLY = FREE_SUPPLY + PAID_SUPPLY;

    constructor() ERC721A("kappa", "Kap", MAX_TXN) {
        saleEnabled = false;
        price = 0.02 ether;
    }
