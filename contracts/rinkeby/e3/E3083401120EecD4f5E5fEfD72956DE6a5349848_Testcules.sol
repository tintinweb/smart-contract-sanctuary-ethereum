...
contract Testcules is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Testcules", "TMH") {
    baseURI = "https://api.demo.io/metadata/";

    stakeHolders.push(stakeHolder(0xe216bB9303C0257ef4334E878844fd6f752cA14D, 500));
    stakeHolders.push(stakeHolder(0x52507322753232D5036E283c7E7aF2bcB35deCbc, 250));
    stakeHolders.push(stakeHolder(0x65481D14C457A5886962ebc80b66775792d7Ff5f, 125));
    stakeHolders.push(stakeHolder(0xcA4c8074586A1C5479336903504A9cc6D935125f, 125));
  }
  ...
  function mint(uint256 _qty) external payable nonReentrant mintChecker(_qty) {
    require(salesStatus == salesStatuses.PUBLIC_SALE, "Sale is not started yet!");
  ...
  function preMint(uint256 _qty, bytes32[] calldata _merkleProof) external payable nonReentrant mintChecker(_qty) {
    require(salesStatus == salesStatuses.PRE_SALE, "Sale is not started yet!");
    require(msg.value >= cost * _qty, "Insufficient funds!");
  ...
  function gift(address to, uint256 _qty) external onlyOwner mintChecker(_qty) {
  ...
  function withdraw() public onlyOwner {
    ...
    for(uint256 i=0; i < stakeHolders.length; i++){
      payable(stakeHolders[i].addr).transfer((balance * stakeHolders[i].rate) / 1000);
    }
  }
