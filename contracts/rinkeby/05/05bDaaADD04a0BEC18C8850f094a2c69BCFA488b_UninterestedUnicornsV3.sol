    ...
    ReentrancyGuard
{
    ...
    address public uuGen1Address;
    address public uuGen2Address;
        ...
        public
    {
        ...
        IERC721 parent1 = IERC721(uuGen1Address);
        IERC721 parent2 = IERC721(uuGen2Address);
        address parent1Owner = parent1.ownerOf(parent_1_tokenId);
        address parent2Owner = parent2.ownerOf(parent_2_tokenId);
        require(
    ...
    function createVoxelUCD(uint16 parent_1_tokenId, uint256 _amount) public {
        require(
