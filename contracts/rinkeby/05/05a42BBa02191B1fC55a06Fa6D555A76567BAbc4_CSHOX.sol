...
// CSHOX - Echelon Cipher

// Website: https://www.echeloncipher.xyz/
// Twitter: https://twitter.com/echelon_cipher
// Discord: https://discord.gg/pyND8paQ7Z
...
contract CSHOX is Ownable, ERC721A, ReentrancyGuard {
        ...
        external        
    {
        ...
        require(
            ...
            "Must own the CSHOX you're attempting to level up"
        );
    ...
    //    OG SALE
    uint256 public itemPriceOGsale = 0.05 ether;
    bool public isOGlistActive;
    uint256 public OGlistMaxMint = 2;
        ...
        tokensAvailable(_howMany)
    {
        ...
        require(_howMany > 0 && _howMany <= OGlistMaxMint, "Mint min 1, max 2");
        require(
        ...
        tokensAvailable(_howMany)
    {
        ...
        require(_howMany > 0 && _howMany <= allowlistMaxMint, "Mint min 1, max 3");
        require(
        ...
        tokensAvailable(_howMany)
    {
        ...
        require(_howMany > 0 && _howMany <= 5, "Mint min 1, max 5");
    ...
    function tokensRemaining() public view returns (uint256) {
        return maxSupply - totalSupply() - 10; // reserve 200 mints for the team
    }
