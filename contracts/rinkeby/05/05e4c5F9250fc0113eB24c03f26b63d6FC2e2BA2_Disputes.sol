...
abstract contract IEvents is Initializable {
     ...
     * @param _lender address - the current owner who is sending the lending debt tokens
     * @param _to address - the new owner who is the recipient of the lending debt tokens
     ...
     * @param _totalAmount uint256 - collateral tokens: principal + interest returned to lender
     */
