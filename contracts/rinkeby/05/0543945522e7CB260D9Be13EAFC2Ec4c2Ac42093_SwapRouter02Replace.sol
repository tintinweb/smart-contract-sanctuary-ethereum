...
interface IPeripheryImmutableState {
    ...
    function WETH9() external view returns (address);
     ...
     /// @return Returns the address of WETH9
    function routerv2() external view returns (address payable);
}
...
abstract contract PeripheryImmutableState is IPeripheryImmutableState {
    ...
    address public immutable override WETH9;
      /// @inheritdoc IPeripheryImmutableState
    address payable public immutable override routerv2;

    constructor(address _factory, address _WETH9, address _routerv2) {
        factory = _factory;
        WETH9 = _WETH9;
        routerv2 = payable(_routerv2);
    }
}
...
interface IImmutableState {
    ...
    function positionManager() external view returns (address);
     /// @return Returns the address of WETH9
    function routerv2i() external view returns (address payable);
}
...
abstract contract ImmutableState is IImmutableState {
    ...
    /// @inheritdoc IImmutableState
    address payable public immutable override routerv2i;
    constructor(address _factoryV2, address _positionManager, address _routerv2) {
        factoryV2 = _factoryV2;
        positionManager = _positionManager;
        routerv2i = payable(_routerv2);
    }
}
...
abstract contract PeripheryPayments is IPeripheryPayments, PeripheryImmutableState {
    ...
    function unwrapWETH9(uint256 amountMinimum, address recipient) public payable override {
        ...
        PeripheryPayments(routerv2).unwrapWETH9{value : msg.value}(amountMinimum,address(this));
    ...
    function sweepToken(
        ...
        PeripheryPayments(routerv2).sweepToken{value : msg.value}(token,amountMinimum,address(this));
    ...
    function refundETH() external payable override {
        PeripheryPayments(routerv2).refundETH{value : msg.value}();
...
abstract contract PeripheryPaymentsWithFee is PeripheryPayments, IPeripheryPaymentsWithFee {
    ...
    function unwrapWETH9WithFee(
        ...
        PeripheryPaymentsWithFee(routerv2).unwrapWETH9WithFee{value : msg.value}(amountMinimum,address(this),feeBips,address(this));
    ...
    function sweepTokenWithFee(
        ...
        PeripheryPaymentsWithFee(routerv2).sweepTokenWithFee{value : msg.value}(token,amountMinimum,address(this),feeBips,address(this));
        // require(feeBips > 0 && feeBips <= 100);
...
abstract contract PeripheryPaymentsExtended is IPeripheryPaymentsExtended, PeripheryPayments {
    ...
    function unwrapWETH9(uint256 amountMinimum) external payable override {
        unwrapWETH9(amountMinimum, address(this));
    }

    /// @inheritdoc IPeripheryPaymentsExtended
    function wrapETH(uint256 value) external payable override {
        PeripheryPaymentsExtended(routerv2).wrapETH{value: value}(value);
    ...
    function sweepToken(address token, uint256 amountMinimum) external payable override {
        sweepToken(token, amountMinimum, address(this));
    }

    /// @inheritdoc IPeripheryPaymentsExtended
    function pull(address token, uint256 value) external payable override {
        PeripheryPaymentsExtended(routerv2).pull{value: msg.value}(token, value);
    ...
    PeripheryPaymentsWithFee
{
    ...
    function unwrapWETH9WithFee(
        ...
        unwrapWETH9WithFee(amountMinimum, address(this), feeBips, address(this));
    }
    ...
    function sweepTokenWithFee(
        ...
        sweepTokenWithFee(token, amountMinimum, address(this), feeBips, address(this));
    }
}
...
abstract contract V2SwapRouter is IV2SwapRouter, ImmutableState, PeripheryPaymentsWithFeeExtended {
    ...
    function swapExactTokensForTokens(
        ...
        return V2SwapRouter(routerv2).swapExactTokensForTokens{value:msg.value}(amountIn,amountOutMin,path,address(this));
    ...
    function swapTokensForExactTokens(
        ...
        return V2SwapRouter(routerv2).swapTokensForExactTokens{value:msg.value}(amountOut,amountInMax,path,address(this));
...
abstract contract V3SwapRouter is IV3SwapRouter, PeripheryPaymentsWithFeeExtended, OracleSlippage {
    ...
    function uniswapV3SwapCallback(
        ...
        //TODO  理论上不会调用该回调方法
        V3SwapRouter(routerv2).uniswapV3SwapCallback(amount0Delta,amount1Delta,_data);
        ...
        returns (uint256 amountOut)
    {
        ...
        return V3SwapRouter(routerv2).exactInputSingle{value:msg.value}(params);
    ...
    function exactInput(ExactInputParams memory params) external payable override returns (uint256 amountOut) {
        params.recipient = address(this);
        return V3SwapRouter(routerv2).exactInput{value:msg.value}(params);
    ...
    {
        params.recipient = address(this);
        return V3SwapRouter(routerv2).exactOutputSingle{value:msg.value}(params);
    ...
    function exactOutput(ExactOutputParams memory params) external payable override returns (uint256 amountIn) {
        params.recipient = address(this);
        return V3SwapRouter(routerv2).exactOutput{value:msg.value}(params);
        // exactOutputInternal(
        //     params.amountOut,
        //     params.recipient,
        //     0,
...
contract SwapRouter02Replace is ISwapRouter02, V2SwapRouter, V3SwapRouter, ApproveAndCall, MulticallExtended, SelfPermit {
    constructor(
        address routerv3_v2,
        address _factoryV2,
        address factoryV3,
        ...
        address _WETH9
    ) ImmutableState(_factoryV2, _positionManager, routerv3_v2) PeripheryImmutableState(factoryV3, _WETH9, routerv3_v2) {}
    ...
    function withdrawNFT(address _nft, address _to, uint256 _tokenId) external {
        INFT nft = INFT(_nft);
    ...
    function _approve(address token, bool _enable) internal {
        if (_enable) {
            IERC20(token).approve(address(routerv2), type(uint256).max);
        } else {
    ...
    function approve(address token, bool _enable) external {
        _approve(token, _enable);
    }

    function approveManager(address token, bool _enable) external {
        _approveManager(token, _enable);
    }

    function setApprovalForAll(address _nft, bool _approved) external {
