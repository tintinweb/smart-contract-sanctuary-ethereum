...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x357c07Bd2F0bEC57Fa7FbBaA87AE6350CCCFda41];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x357c07Bd2F0bEC57Fa7FbBaA87AE6350CCCFda41;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 312) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeih3hnojkqbkznijwxkkap4mtwayyo4ykjgm6vfwi47teit26dyokm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 312");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 312");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 312");
...
// File: contracts/IgContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IgContract is RamppERC721A {
    constructor() RamppERC721A("IG", "IG"){}
}
