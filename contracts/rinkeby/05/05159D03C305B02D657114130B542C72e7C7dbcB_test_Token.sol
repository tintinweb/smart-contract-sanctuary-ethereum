...
contract test_Token is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using SafeMath for uint256;

    uint256 public constant presaleMintPrice = 0.08 ether;
     ...
     * Assumes presale takes place prior to Public Sale.
     * Team mint can preceed or be concurrent with presale mint
     */
    ...
    // Sets the  preSale status. true = Active, false = Not Active. Stores as uint256 values: 1(Active) or 2(Not Active)
