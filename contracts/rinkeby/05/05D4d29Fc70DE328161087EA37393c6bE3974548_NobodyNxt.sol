...
contract NobodyNxt is ERC721, Ownable {
  ...
  string public baseURI = 'https://gateway.pinata.cloud/ipfs/QmRzwPtMzgBuKjqLwTSiSMXwaPQ7gaSebAwbR7n9GKPMSs';
...
//   nobodyinterface nobodycontract = nobodyinterface(nobodyaddress);  
  ...
  constructor (uint _maxNobody, uint _maxNobodyPerPurchase ) ERC721("Txn", "Txn") {
    maxNobody = _maxNobody;
    maxNobodyPerPurchase = _maxNobodyPerPurchase;
    _mintnobody(creator, 2);
  }
