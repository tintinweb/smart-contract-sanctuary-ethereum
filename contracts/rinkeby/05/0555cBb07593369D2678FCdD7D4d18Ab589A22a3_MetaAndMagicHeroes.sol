...
import "./interfaces/IMetaAndMagicHeroesRenderer.sol";
import "../ERC721A.sol";
...
contract MetaAndMagicHeroes is Ownable, ERC721A, MerkleWhitelist {
    ...
    address public MetaAndMagicHeroesRendererAddress;
    constructor() ERC721A("Mars & Murrie Heroes", "MNM", 5) {}
    ...
    {
        return IMetaAndMagicHeroesRenderer(MetaAndMagicHeroesRendererAddress).tokenURI(_tokenId);
    }

    function setStakingApproval(address _address, bool _approved) public {
        setApprovalForAll(_address, _approved);
    }

    function setMetaAndMagicHeroesRendererAddress(address _address) public {
        MetaAndMagicHeroesRendererAddress = _address;
    }
...
interface IMetaAndMagicHeroesRenderer {
