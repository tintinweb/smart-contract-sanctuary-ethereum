...
import "./CryptonMediaUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new CryptonMediaUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CryptonMediaUser721Token token = CryptonMediaUser721Token(address(addr));
...
contract CryptonMediaUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
