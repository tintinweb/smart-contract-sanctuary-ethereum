...
contract Mounts is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private Type = [
         "Donkey", "Donkey", "Donkey", "Donkey", "Mule", "Mule", "Mule", "Mule", "Mule", "Pony", "Pony", "Pony", "Pony", "Pony", "Camel", "Camel", "Camel", "Camel", "Camel", "Horse", "Horse", "Horse", "Horse", "Horse", "CaveBear", "CaveBear", "CaveBear", "CaveBear", "Direwolf", "Direwolf", "Direwolf", "Direwolf", "Chimera", "Chimera", "Chimera", "Pegasus", "Pegasus", "Pegasus", "Phoenix", "Phoenix", "Phoenix", "Gryphon", "Gryphon", "Gryphon", "Wyvern", "Wyvern", "Wyvern", "Dragon", "Dragon", "Flying Rug", "Donkey"
    ];
    ...
    function getGender(uint256 tokenId) public view returns (string memory) {
        return Gender[random("Gender", tokenId, 0, 12)];
    }
