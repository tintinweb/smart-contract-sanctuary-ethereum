...
contract fifagoblin is ERC721A, Ownable {
    
    using Strings for uint256;
    uint256 FREE_MINT_LIMIT_PER_WALLET = 1;
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmXUdkSLCzc7LZTadPr6w3uySw9UDV3d7iEfz1xpJrNY4Y/";

    mapping(address => uint256) private freeMintCountMap;
    

    constructor() ERC721A("FIFAGOBLIN", "FG") {}
