...
library SafeMath {
    ...
    */
    ...
    function buyAndBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings ) public payable pizzaTypeAvailableValidation(2) {
    ...
    function randomBakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings ) public payable pizzaTypeAvailableValidation(1){
    ...
    // 5- unbake pizza 
    function unbakePizza( uint256 _pizzaId, uint256[] memory ingredientIds) public payable pizzaTypeAvailableValidation(3){
    ...
    // 6- rebake pizza
    function rebakePizza( uint256 _pizzaId, string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings, uint256[] memory allOldIngs, uint256[] memory oldIngs ) public payable pizzaTypeAvailableValidation(4){
    ...
    function bakePizzaAndMint(string memory metadata, uint256 base, uint256 sauce, uint256[] memory cheese, uint256[] memory meats, uint256[] memory toppings ) public payable pizzaTypeAvailableValidation(2) {
    ...
    function burnIngredient(uint256 ingredientId) public {
