...
contract WRSContractV7 is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint public WHITELIST_START_TIME = 1651179180;
    uint public WHITELIST_END_TIME = WHITELIST_START_TIME + 2 days;
    uint public currentWhitelistMints;
    uint public ownerCurrentMints; 
    address public multisigWallet = 0xdD870fA1b7C4700F2BD7f44238821C26f7392148; 
    ...
    function setWhitelistStartTime(uint _time) external whenNotPaused onlyOwner{
        ...
        WHITELIST_END_TIME = WHITELIST_START_TIME + 2 days;
    }
