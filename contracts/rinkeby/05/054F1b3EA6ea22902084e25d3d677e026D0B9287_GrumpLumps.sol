...
// @author ACEWLBRN
// Contract V2 of GrumpLumps changing mintprice & updating functions
    ...
    PaymentSplitter
{
    ...
    function setPrice(uint256 _newPrice, uint256 _newPresalePrice)
        public
        onlyOwner
    {
        _price = _newPrice;
    ...
    onlyAccounts
    {
        ...
        require(totalSupply() + _amount <= maxSupply, "Grump Lumps: max supply exceeded");
