...
contract Cubes is ERC721, ERC721Enumerable, Ownable {
  using Counters for Counters.Counter;
  using Strings for uint256;

  string constant tokenName   = "Cube";
  string constant tokenSymbol = "CUBE";
...
//    string memory svgData = getSvg(tokenId);
    ...
    string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Cube ', Strings.toString(tokenId),'", "description": "", "image": "https://nopsta.com/petarp/images/6/petarp-00', Strings.toString(tokenId),'-001.png", ', getAttributes(tokenId) ,'}'))));
  ...
  function getAttributes(uint256 tokenId) 
    ...
    returns (string memory) 
  {
    return string(abi.encodePacked('"fg": "Black", "bg": "White"'));
  }
