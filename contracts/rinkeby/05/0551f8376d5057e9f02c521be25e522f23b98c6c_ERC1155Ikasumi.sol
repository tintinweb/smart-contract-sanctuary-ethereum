...
// File: contract-erc1155-20220812-a.sol
...
contract ERC1155Marketplace is ERC1155YuzuInternal, ReentrancyGuard {
    ...
    event Bid(        uint256 indexed tokenId, uint256 indexed queueId, address indexed from,   uint256 qty,         uint256 price);
    event Sell(       uint256 indexed tokenId, uint256 indexed queueId, address indexed to,     uint256 qty,         uint256 price);
    ...
    function sell(uint256 tokenId, uint256 qty, uint256 price, address wallet) external {
        ...
        emit Sell(tokenId, openSalesLength[tokenId], _msgSender(), qty, price);
    ...
    function bid(uint256 tokenId, uint256 qty, uint256 price) external nonReentrant {
        ...
        emit Bid(tokenId, openOffersLength[tokenId], _msgSender(), qty, price);
