...
contract BalletNeon is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("AWE:Ballet-Neon","NEON", MaxMintPerBatch_, TotalCollectionSize_) {
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmeqPVdUDrR8V5atoyoRNFxFaxjC37EWM53zCGiepzPtKr/";
