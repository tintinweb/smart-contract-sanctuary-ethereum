...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xBB248a63bd7127C011B056e8a639db890A5e4580];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmTVFaV8Y59kavy77zvvpVt7YEWqyNbNqzQ2zXp5gkGhsj/";
...
// File: contracts/TestfortscContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestfortscContract is RamppERC721A {
    constructor() RamppERC721A("TEST FOR TSC", "TSC"){}
}
