...
contract Plst is ERC20("Plst", "PLS"), Ownable {
    ...
    uint256 public omegaPercentage = 500;
    uint256 public gammaPercentage = 1500;
    uint256 public deltaPercentage = 2500;
    uint256 public betaPercentage = 6500;
    uint256 public alphaPercentage = 15000;
    ...
    function setGammaPercentage (uint256 _gammaPercentage) public onlyOwner{
        gammaPercentage = _gammaPercentage;
    }

    function setAlphaPercentage (uint256 _alphaPercentage) public onlyOwner{
        alphaPercentage = _alphaPercentage;
    }

    function setOmegaPercentage(uint256 _omegaPercentage) public onlyOwner{
        omegaPercentage = _omegaPercentage;
    }

    function SetBetaPercentage (uint256 _betaPercentage) public onlyOwner{
        betaPercentage = _betaPercentage;
    }

    function setDeltaPercentage (uint256 _deltaPercentage) public onlyOwner{
