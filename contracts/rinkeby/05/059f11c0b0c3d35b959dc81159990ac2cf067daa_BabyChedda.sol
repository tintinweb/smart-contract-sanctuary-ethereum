...
contract BabyChedda is Ownable, IERC20 {
    ...
    string private _symbol = "BCHEDDA";
    ...
    constructor() {
        marketingWallet = 0xE1995a6441B0e5443f5403A69e530a33249C4f2a;
        liquidityWallet = 0xE1995a6441B0e5443f5403A69e530a33249C4f2a;  
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Baby Chedda: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "Baby Chedda: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "Baby Chedda: Sender is blacklisted");
        require(!isBlacklisted[recipient], "Baby Chedda: Recipient is blacklisted");

        require(sender != address(0), "Baby Chedda: transfer from the zero address");
        require(recipient != address(0), "Baby Chedda: transfer to the zero address");

        uint256 _maxTxAmount = (totalSupply() * maxTx) / 10000;
        uint256 _maxWallet = (totalSupply() * maxWallet) / 10000;
        require(
        ...
        require(
            ...
            "Baby Chedda: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "Baby Chedda: approve from the zero address");
        require(spender != address(0), "Baby Chedda: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "Baby Chedda: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "Baby Chedda: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "Baby Chedda: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function _executeSwap(uint256 tokens, uint256 native) private {
        ...
        if (address(marketingWallet) != address(0)) {
            swapTokensMarketing = (tokens * marketingFee) / totalFee;
        }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Baby Chedda: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Baby Chedda: DEX pair can not be removed");
    ...
    function setFee(
        ...
        totalFee = _marketingFee + _liquidityFee + _dividendFee;
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            automatedMarketMakerPairs[pair] != value,
            "Baby Chedda: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Baby Chedda: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "Baby Chedda: compounding is not enabled");
    ...
    function setmaxTx(uint256 amount) external onlyOwner {
        require(amount >= 75 && amount <= 10000, "Must be between 75 and 10000");
        maxTx = amount;
    }
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "BabyChedda_DividendTracker";
    string private _symbol = "BabyChedda_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "BabyChedda_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "BabyChedda_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "BabyChedda_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "BabyChedda_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("BabyChedda_DividendTracker: method not implemented");
    }
