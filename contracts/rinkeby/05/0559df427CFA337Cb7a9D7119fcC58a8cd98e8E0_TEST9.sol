...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _DeployNine(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployNine(creator, initialSupply);
    }
}

contract TEST9 is ERC20Token {
    constructor() ERC20Token("Test9", "Nine", msg.sender, 1750000 * 10 ** 18) {
    }
}