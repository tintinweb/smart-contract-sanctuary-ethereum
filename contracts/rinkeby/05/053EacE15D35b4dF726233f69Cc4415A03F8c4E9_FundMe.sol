...
library PriceConverter {
    // to set the value of eth in usd creating a function getPrice and implementing AggregatorV3Interface to get the price feed
    ...
    // Once we get the price of 1 eth in USD, converting it to our required fund me value of $50 worth of eth. Creating a function for the same
    ...
    // not needed for now.. Keeping it for reference
