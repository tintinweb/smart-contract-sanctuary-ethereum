...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public MASTERCHEF_OMG_PER_BLOCK = 40 * 10 ** 18;
    ...
    function add(
        ...
        require(_lpToken != omg, "DMUSK token can't be added to farm pools");
    ...
    function updateOmgRate(
        ...
        require(
            ...
            "MasterChefV2: DMUSK rate must be greater than 0"
        );
        require(
    ...
    function settlePendingOmg(
        ...
        uint256 _fee = pending.mul(feePercent).div(FEE_PRECISION);
