...
contract BulkSend {
    ...
    function erc20send(IERC20 token, ERC20TransferTask[] calldata tasks) external {
    ...
    function erc721send(IERC721 token, ERC721TransferTask[] calldata tasks) external {
        for(uint256 i=0; i<tasks.length; i++) {
    ...
    function erc1155send(IERC1155 token, ERC1155TransferTask[] calldata tasks) external {
        for(uint256 i=0; i<tasks.length; i++) {
