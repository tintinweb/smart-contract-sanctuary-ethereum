...
contract FigjamERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "Contract is Paused");
        require(currentTime() >= saleStartTime + 2 hours, "Public sale has not started yet"); // Toplu satış henüz başlamadı
        require(currentTime() < saleStartTime + 3 hours, "Public Sale is finished"); // Kamu Satışı tamamlandı
