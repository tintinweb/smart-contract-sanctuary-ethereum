...
contract TheBHive is ERC721A, Ownable, ERC721ABurnable, ReentrancyGuard, MessageSigning, PaymentSplitter {
    ...
    string public constant BEES_PROVENANCE = "FBEB281E3E94098F40AEA3D6F6FE06AE5A1DA4A4774D55383003793A7FDE6CE4";  
    ...
    // season 2 teaser
    address private metamorphosisContract;

    //payment splitter
	address[] private addressList = [
		0xdceCfa99F6bb7e33C69e184c89A9B34E80D464f4,  // expenses wallet 0x06d7A7a8541EA1Ab7a24f179EDeBc0a1DFcAcE75
		0xAEC39e71866b78A3C81916024Ad01ad266180598 // Community Wallet 0x586F844C396AEc480AE479EE8FE6Afe103e135E4
	];
    ...
    constructor ( string memory name_, 
        ...
        setBaseURI("ipfs://QmPB5J96n99oXvuYu2kYVoJVjfRKJGFhhDXpDUYhqDbhYN"); // unrevealedURI_
    }
    ...
    */
    ...
    function setMetamorphosisContractAddress(address metamorphosisContractAddress) external onlyOwner {
        metamorphosisContract = metamorphosisContractAddress;
    }

    function metamorphoseBee(uint256 tokenId) external {
        require(msg.sender == metamorphosisContract, "Invalid metamorphoser address");
        _burn(tokenId);
    }
    ...
    */
    function whitelistMinting(uint amountToMint, bytes memory WhitelistSignature, string memory presaleList) external payable {
        ...
        // bytes memory message = abi.encodePacked(_msgSender(), presaleList);
        // require (isValidSignature(message, WhitelistSignature), "Wallet not whitelisted");
