...
contract tosting is ERC721A {
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "testing1234 | ", colorGenerator.toString(abi.encodePacked(tokenId)),"",
                                '", "description":"?", "image":"', string(abi.encodePacked("data:image/svg+xml;base64,",Base64.encode(bytes(string(abi.encodePacked(svg)))))),
    ...
    constructor() ERC721A("Ortomich 3D", "Obbbb") {
        owner = msg.sender;
    }
}
