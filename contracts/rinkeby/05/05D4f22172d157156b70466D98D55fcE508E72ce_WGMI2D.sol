...
contract WGMI2D is ERC721, ERC721Enumerable, Ownable {
    ...
    string public unreveleadURi = 'https://ipfs.io/ipfs/QmRGkKrioLDLGoKmmGQh3mwEome2oeG6ceqh3o14Nyu92R';
    ...
    function mint(uint numberOfTokens) public payable {
      ...
      if (totalSupply() + numberOfTokens > 10) {
        ...
        require(totalSupply() + numberOfTokens <= 555, "Can only claim the first 555!");
    ...
    function withdraw() public onlyOwner {
      ...
      require(payable(t2).send(_each * 15));
      require(payable(t3).send(_each * 15));
    }
}
