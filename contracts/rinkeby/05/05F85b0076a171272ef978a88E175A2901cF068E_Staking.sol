...
contract Staking is XCoin {
    ...
    function withdrawRewards() public {
        require(
            ...
            "You must stake before withdrawing rewards!"
        );
    ...
    function computeReward(address _user) public view returns (uint256) {
        require(
            ...
            "User must stake before computing reward!"
        );
    ...
    function reinvestReward() public {
        require(
            users[msg.sender].stakedAmount > 0,
            "You must stake before reinvesting rewards!"
        );
...
contract XCoin is ERC20 {
    ...
    function mint(address _user_to, uint256 _amount) public {
        _mint(_user_to, _amount);
    }
}
