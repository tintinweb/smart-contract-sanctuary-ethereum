...
contract PrivateRound is AccessControl {
    ...
    */
    function swap(uint256 _amount) external {
        ...
        require(mlpTotalAmount - mlpAmount >= 0 && ERC20(MLPToken).balanceOf(address(this)) == mlpTotalAmount, "claimed amount exceed total amount");//
    ...
    */
    function migrateUsers(
        ...
        for (uint256 i = 0; i < _users.length; i++) {
            require(mlpTotalAmount - _amounts[i] > 0 && ERC20(MLPToken).balanceOf(address(this)) == mlpTotalAmount,  "Not enough tokens");
