...
/**
  ...
  February 8th, 2022.
*/
contract ERC721LiteMultiEmit is ERC165, IERC721, IERC721Metadata, Ownable {
  ...
  */
    function _transfer(
        ...
        if (allTransfersLocked) {
            revert TransferIsLockedGlobally();
        }
        if (transferLocks[_id]) {
  ...
  */
    function mint_Qgo(address _recipient, uint256 _amount) external onlyAdmin {
