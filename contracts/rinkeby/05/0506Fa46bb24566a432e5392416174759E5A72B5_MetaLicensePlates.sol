    ...
    OwnableUpgradeable
{
    ...
    /**
     * @dev mint `_quantity` amount of token to caller `msg.sender`.
     *
        ...
        mintPriceCompliance(_quantity)
    {
        ...
        emit TokenMinted(_quantity, tokenId, msg.sender);
    }
        ...
        onlyOwner
    {
        ...
        emit TokenMintedForAddress(_quantity, _nextTokenId(), msg.sender);
    }

    /**
     * @dev mint `_quantity` amount of token to a whitelist address `msg.sender` .
     *
    ...
    /**
     * @dev transfers `tokenId` token from `msg.sender` to `_receiver`.
     *
    ...
    function transferRevenueShare(uint256 _tokenId, uint256 _saleAmt)
        ...
        payable
    {      
        require(msg.sender == royaltyOwner, "Invalid royalty owner.");
    ...
    /*** VIEW FUNCTIONS ***/
     ...
     /**
     * @dev returns revenue share amount for token id `_tokenId` using sale amount `_saleAmt`.
     *
