...
contract LXDAOBuidler is Ownable, ERC721AQueryable {
    ...
    /**
     * Issue the Token and set the metadata at same time.
     *
     * Requirements:
     *
     * - `metadataURI` the URI of metadata file.
     ...
     *
     * Emits a {TokenStatusChanged} event.
     */
    ...
    // todo unify the comments styles? @kahn
    /**
    ...
    /**
     * Similar as `transferFrom(address from, address to, uint256 tokenId)`
     *
     * Requirements:
     *
     * - `from` cannot be the zero address.
