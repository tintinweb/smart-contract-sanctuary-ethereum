...
interface ICollectionFactory {
  function rolesContract() external view returns (IRoles);
...
contract FNDCollectionFactory is ICollectionFactory {
   ...
   */
  IRoles public override rolesContract;
   ...
   */
  IProxyCall public override proxyCallContract;
  ...
  constructor(address payable _proxyCallContract, address payable _rolesContract) {
