...
/// @title CNC collection smart contract
contract CNC2 is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement {
    using Strings for uint256;
    using Counters for Counters.Counter;

    uint256 internal constant MAX_TOTAL_SUPPLY = 20;
    ...
    modifier checkMaxTotalSupply() {
        require(totalSupply() < maxTotalSupply(), "CNC: total supply reached");
        _;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (lockTransfers) {
            require(
                ...
                "CNC: tranfer is temporarily unavailable"
            );
        }
