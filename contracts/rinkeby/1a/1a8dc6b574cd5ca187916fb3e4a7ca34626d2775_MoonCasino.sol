...
contract MoonCasino is ERC20, Ownable {
    ...
    constructor(
        ...
        updateFee(_feeDecimals, _marketingfeePercentage, _devfeePercentage, _liquidityfeePercentage);
    ...
    function _transfer(
        ...
        (uint256 marketTokens, uint256 devTokens, uint256 tokensToLock) = calculateTokenFee(
            amount,
            feeDecimals,
