...
import "../lib-part/HasContractURI.sol";
    ...
    HasContractURI
{
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId)
        ...
        view
        virtual
        override(ERC721UpgradeableMinimal, ERC721DefaultApprovalMinimal)
        returns (bool)
    {
        return
            ERC721DefaultApprovalMinimal._isApprovedOrOwner(spender, tokenId);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC165Upgradeable, ERC721LazyMinimal)
        returns (bool)
    {
    ...
    function tokenURI(uint256 tokenId)
        ...
        view
        virtual
        override(ERC721UpgradeableMinimal, ERC721LazyMinimal)
    ...
    ERC721URI
{
    ...
    function mintAndTransfer(
        ...
        if (!isApprovedForAll(minter, sender)) {
...
import "../access/IsPrivateCollection.sol";
import "../access/MinterAccessControl.sol";

contract ERC721MarketToken is
    ERC721BaseMinimal,
    IsPrivateCollection,
    MinterAccessControl
{
    event CreateERC721MarketToken(address owner, string name, string symbol);
    event CreateERC721MarketTokenUser(
        address owner,
        string name,
        string symbol
    );

    function __ERC721MarketTokenUser_init(
        string memory _name,
        ...
        __ERC721MarketToken_init_unchained(
            _name,
            _symbol,
            baseURI,
            contractURI,
        ...
        isPrivate = true;
        emit CreateERC721MarketTokenUser(_msgSender(), _name, _symbol);
    }

    function __ERC721MarketToken_init(
        string memory _name,
        string memory _symbol,
        string memory baseURI,
        string memory contractURI,
        ...
        isPrivate = false;
        emit CreateERC721MarketToken(_msgSender(), _name, _symbol);
    }

    function __ERC721MarketToken_init_unchained(
        string memory _name,
        string memory _symbol,
        string memory baseURI,
        string memory contractURI,
