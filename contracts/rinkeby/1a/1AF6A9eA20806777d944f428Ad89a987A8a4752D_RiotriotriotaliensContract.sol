...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656394860;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656308460;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0d817C667072033480F82163a38eE11Baf12109B];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://test/";
...
// File: contracts/RiotriotriotaliensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RiotriotriotaliensContract is RamppERC721A {
    constructor() RamppERC721A("riot riot riot aliens", "RRRA"){}
}
