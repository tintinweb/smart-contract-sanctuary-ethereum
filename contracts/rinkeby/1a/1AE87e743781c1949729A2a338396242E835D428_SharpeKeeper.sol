...
contract SharpeKeeper is KeeperCompatibleInterface{
    ...
    constructor(uint updateInterval, address _keeper, address _vault, int24 _baseThreshold, int24 _limitThreshold) public{
    ...
    ReentrancyGuard
{
    ...
    address public RebalanceKeeper;
    ...
    function rebalance(
        ...
        require(msg.sender == RebalanceKeeper, "RebalanceKeeper");
     ...
     * deployed.
     */
    function setRebalanceKeeper(address _RebalanceKeeper) external onlyGovernance {
        RebalanceKeeper = _RebalanceKeeper;
    }
