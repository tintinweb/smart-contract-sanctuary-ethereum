...
contract TestCMonk is ERC721A, Ownable  {
  using SafeMath for uint256;
	using Strings for uint256;
    bytes32 public merkleRoot;
	mapping(address => uint256) public claimedWL;
    uint256 constant public MAX_SUPPLY= 50;
	  uint256 constant public MAX_WL_SUPPLY = 20;
    uint256 public WL_PRICE = 0.001 ether;
    uint256 public PRICE = 0.002 ether;
    uint256 public giveawayLimit = 10;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
	  address private wallet1 = 0xDa1e5202Ec5a0107acb1887131173b666b834Eb1; // Company Wallet
    address public Authorized = 0xDa1e5202Ec5a0107acb1887131173b666b834Eb1; // Dev Wallet for Testing (no percentage)
    ...
    constructor() ERC721A("TestCMonk", "COMO") { }
	...
	function addToWL(address[] memory newAddressList) external onlyAuthorized {
		for(uint i; i < newAddressList.length; i++) {
		claimedWL[newAddressList[i]] = 1;
	}
    }
    ...
    function whitelistMint(uint256 numberOfTokens, bytes32[] calldata merkleProof ) payable external callerIsUser {
        ...
        require(MerkleProof.verify(merkleProof, merkleRoot,  keccak256(abi.encodePacked(msg.sender))) || claimedWL[msg.sender]!=0, "Not Whitelisted");
