...
// Genotime Authority (GA) Common Shares
// GENOTIME AUTHORITY COMPANY LIMITED, Athenee Tower, 23rd Floor, 63 Wireless Road, Lumpini, Pathumwan, Bangkok 10330, THAILAND
...
//                                                    `                                              //
//     ____                  _   _                     _         _   _                _ _            //
//    / ___| ___ _ __   ___ | |_(_)_ __ ___   ___     / \  _   _| |_| |__   ___  _ __(_) |_ _   _    //
//   | |  _ / _ \ '_ \ / _ \| __| | '_ ` _ \ / _ \   / _ \| | | | __| '_ \ / _ \| '__| | __| | | |   //
//   | |_| |  __/ | | | (_) | |_| | | | | | |  __/  / ___ \ |_| | |_| | | | (_) | |  | | |_| |_| |   //
//    \____|\___|_| |_|\___/ \__|_|_| |_| |_|\___| /_/   \_\__,_|\__|_| |_|\___/|_|  |_|\__|\__, |   //
//                                                                                          |___/    //
//                                                    `                                              //
//---------------------------------------------------------------------------------------------------//
...
/***********************************************************/
/* Genotime Authority (GA) Common Shares STARTS HERE   */
/***********************************************************/

contract GenotimeAuthority is Authorizable, TokenERC20 {
   ...
   /// no tokens can be ever issued when this is set to "true"
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    constructor() TokenERC20(0, "Genotime Authority", "GA", 18) {
        maxTotalSupply = 9092022 * 10**uint256(decimals);
        tokenSaleHardCap = 5000000 * 10**uint256(decimals); // Default Crowsale Hard Cap amount with decimals
        baseRate = 1000 * 10**uint256(decimals); // Default base rate Token) :1 eth amount with decimals
    }
    ...
    function mintToken(address target, uint256 mintedAmount) onlyAuthorized public {
        ...
        //Check over max totalSupply
        require(totalSupply <= maxTotalSupply, "Can't mint token, It  over max totalsupply");
