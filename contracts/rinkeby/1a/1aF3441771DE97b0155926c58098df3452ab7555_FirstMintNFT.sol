...
contract FirstMintNFT is ERC721, Ownable ,ReentrancyGuard{
    ...
    uint256 public max_cost = 0.1 ether;
    uint256 public min_cost = 0.001 ether;
    uint256 public NFT1_cost = 0.1 ether;
   ...
   function _baseURI() internal view virtual override returns (string memory) {
    ...
    function update() external {
        require(block.timestamp - lastRun >= 1 minutes, "Need to wait 1 minute");
        lastRun = block.timestamp;
        NFT1_cost = NFT1_cost - 0.002 ether;
    }

    function getPrice() external view returns (uint){
        return NFT1_cost - (block.timestamp - lastRun)/60 * 0.002 ether;
    }
