...
contract MOJI is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public maxTotalSupplyWithCurrentSeries1 = 1000;
    ...
    function mintMOJI(uint numberOfTokens) public payable {
        ...
        require(currentTotalSupply + numberOfTokens <= maxTotalSupplyWithCurrentSeries1, "Purchase would exceed max supply of MOJIs"); // ref MAX_MOJI
