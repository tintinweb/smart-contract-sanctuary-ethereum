...
contract marketplace is Ownable {
    ...
    constructor(address token_, uint decimals_) {
      token = token_;
      decimals = decimals_;
        ...
        external
    {
        ...
        IERC20(token).transferFrom(msg.sender, idToMarketItem[itemId].seller, idToMarketItem[itemId].price);
    ...
    {
        require(!idToMarketItem[itemId].sold, "Already sold");
        require(msg.sender == idToMarketItem[itemId].seller, "Not yours");
    ...
    function fetchMarketItems2() external view returns (MarketItem[] memory) {
        uint256 itemCount = _itemIds.current();
        uint256 unsoldItemCount = _itemIds.current() - _itemsSold.current();
        uint256 currentIndex;
