...
contract MetaCell is ERC721, ACellRepository, IMetaCellCreator, IAdmin, IOperator, Ownable {
    ...
    function addMetaCell(CellData.Cell memory _cell) external override isOperator {
        _addMetaCell(_cell);
    }

    function removeMetaCell(uint256 _tokenId, address _owner) external override isOperator {
