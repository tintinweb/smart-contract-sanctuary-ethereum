...
// Es soll eine Fehlermeldung zurückgeliefert werden, wenn die neue Nachricht, die gleiche ist wie die alte.									
function updateMessage(string memory newMessage) public{

    require(
        !compareStrings(_message, newMessage), "Die Nachrichten sind identisch");
	_message = newMessage;
}									
