...
contract RinkesDelPinkes is ERC721A, Ownable {
    ...
    uint private immutable TRAIT_TOKEN_EPOCH = 90;//ONE_DAY;
    uint private immutable FUSE_COOLDOWN = 120;//ONE_DAY * 3;
    ...
    constructor(bytes32 _generalMerkleRoot, bytes32 _devMerkleRoot, uint16 genesisCap) ERC721A("RinkesDelPinkes", "RINKES", 12) {
        // Palette
    ...
    */
    ...
    function mint(uint256 quantity, bytes32[] calldata merkleProof, bool isTeamMint) private {
        ...
        if(isTeamMint) {
            ...
            require(addrToMintedQ[msg.sender] == 0, "m4");
        }
    ...
    */
    ...
    function hash(
        ...
        // This is a robust uniform random algo which is only slightly less random than Math.random(). Seed is deterministic to prevent
        // flash botting.
