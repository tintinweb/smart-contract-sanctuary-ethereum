...
contract ForzaCars is ERC1155, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_CAR_TYPE = 10000;
    
    uint256 public BASE_CAR_OFFSET = 0;
    uint256 public currentBaseCar = 10;

    uint256 public SUPER_CAR_OFFSET = 10000;
    uint256 public currentSuperCar = 0;

    uint256 public F1_CAR_OFFSET = 20000;
    uint256 public currentF1Car = 0;

    uint256 public OFFROAD_CAR_OFFSET = 30000;
    uint256 public currentOffroadCar = 0;
    ...
    function getMysteryCar(uint256 forzaCoin) payable external nonReentrant returns(uint carId){
    ...
    function setMysteryPrice(uint256 ethPrice, uint256 forzaCoinPrice) external {
    ...
    function airdropBaseCar(uint256 carId, address to) external {
        //require msg.sender() approuve wallet?
        require(balanceOf(to, carId) == 0, "User already got base car");
        require(carId >= 0 && carId < BASE_CAR_OFFSET + MAX_CAR_TYPE, "Type is not base");
    ...
    function updateValidCars(uint256[] memory carIds, bool[] memory status) external {
