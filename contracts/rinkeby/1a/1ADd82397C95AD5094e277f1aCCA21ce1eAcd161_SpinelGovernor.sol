...
contract SpinelGovernor is
    ...
    GovernorTimelockCompoundUpgradeable, OwnableUpgradeable
{
    ...
    function propose(
        ...
        require(1 > 2, "Unsupported method");
        return 0;
    }
    ...
    ) internal override(GovernorUpgradeable, GovernorTimelockCompoundUpgradeable) onlyOwner{
