...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdV5uivPWXkN7XsVXVxDFGCb6vusvtJy25X5Gmvyqy1kc/";
...
contract KissMeMonkeyContract is RamppERC721A {
    constructor() RamppERC721A("KissMeMonkey", "KMM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/80cUmXsfx7rdtY132b3j/contract-metadata";
    }
}
