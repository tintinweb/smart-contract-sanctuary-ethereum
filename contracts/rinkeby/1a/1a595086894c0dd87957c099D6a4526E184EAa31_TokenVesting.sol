...
contract TokenVesting is Ownable, ReentrancyGuard, Pausable {
    ...
    // Suma de Tokens totales asignados a wallets

    // ESTO NO SE ESTA ASIGNANDO EN NINGÚN SITIO, he de arreglarlo

    uint256 public totalTokensAssigned;

    //TOTAL DE TOKENS QUE PUEDE ASIGNAR EL OWNER A LA GENTE
    ////
    ////
    /////
    /////

    uint256 public totalTokensAvailableToAssig = 1000000000;
    ...
    constructor(
        address addressToken // address beneficiary, // uint256 start,
    ) public // uint256 cliffDuration,
    // uint256 duration,
    // bool revocable
    {
    ...
    function assignTokensToWallet(
        ...
        // ESTA HAY QUE BORRARLA DESPUES DE PROBARLA
        uint256 _firstClaimDate = lastUpdated + 20;
        ...
        uint256 tokensRestantes = totalTokensAvailableToAssig -
            totalTokensAssigned;
