...
contract MVPGoatClubStaking is Ownable, ERC721Holder, Pausable {
    using EnumerableSet for EnumerableSet.UintSet;
    IERC721 public nftContractInstance;
    IERC20 public tokenContractInstance;

    // Number of tokens per block. There are approx 6k blocks per day and 45 tokens are represented by 45**9 (after considering decimals).
    uint256 public rate;
