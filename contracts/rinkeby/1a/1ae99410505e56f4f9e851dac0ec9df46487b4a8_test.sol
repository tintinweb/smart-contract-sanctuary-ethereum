...
contract test is ERC721URIStorage{
    ...
    string public headTokenURI;
    string public footerTokenURI;

    constructor() public ERC721("XueXuesNFT", "XXNFT") {
        headTokenURI="ipfs://QmVyUPccZePCRXYxq7wSc2KNjNBJx7YC9bq27FX3Vy2c7W/";
        footerTokenURI=".json";
    ...
    function getTokenURI(uint256 id) public returns(string memory) {
        ...
        Stringid = Strings.toString(id);
        string memory TokenURI =string.concat(headTokenURI,"1",footerTokenURI);

        return TokenURI;
    }

    function mint(uint256 numberOfToken) public {
        for(uint256 i=0;i<numberOfToken;i++){
            string memory TokenURI;
            TokenURI=getTokenURI(tokenid);
            _safeMint(msg.sender , tokenid);
    ...
    function setHeadTokenURI(string memory head) public {
        headTokenURI=head;
    }

    function setFooterTokenURI(string memory footer) public {
        footerTokenURI=footer;
    }
