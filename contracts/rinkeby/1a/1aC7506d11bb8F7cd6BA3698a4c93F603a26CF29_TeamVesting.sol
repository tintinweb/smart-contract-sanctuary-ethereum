...
contract TeamVesting is Ownable {
    ...
    /// @param _allocation Total allocation 
    ...
    function removeAccount(address _address) external onlyOwner {
        totalLocked -= accounts[_address].allocation;
    ...
    function withdraw() public {
        ...
        totalLocked -= _allowance; // When withdrawing, the locked are released
    ...
    function adminWithdraw(address _address, uint256 _amount) external onlyOwner {
        require(_amount <= ERNBalance(), "Cannot withdraw more than balance");
