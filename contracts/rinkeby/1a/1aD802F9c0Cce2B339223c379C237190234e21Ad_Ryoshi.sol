...
/* 
For all you motherfuckers who are too lazy to bridge Doge to Dogechain this is for you!

Max tx: 1%
Max wallet: 2%
Taxes: 0/0 + 24hr 25% Jeet tax ( 5% LP, 20% burns )

Whats the tg you ask? Im too fucking lazy to set one up. If you want one figure that shit out yourself thanks. Im sure the community will appreciate your efforts.
...
contract Ryoshi is ERC20, Ownable {
    ...
    address public marketingWallet = 0x78Ed704597BC9462eaBec07df9494158954D1920;

    uint256 public swapTokensAtAmount = 200 * (10**18);

    uint256 public liquidityFee = 5;
    uint256 public marketingFee = 5;
    uint256 public buybackFee = 15;
    ...
    constructor (address _newOwner) ERC20("Proof Of Larp", "Ryoshi2.0") {
        ...
        _mint(_newOwner, 1_000_000_000_000 * (10**18));
