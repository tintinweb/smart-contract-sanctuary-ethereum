...
contract JamesContract is ERC721A, Ownable {
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, bytes32 _initWLsigner) ERC721A("James Contract", "JC") {
