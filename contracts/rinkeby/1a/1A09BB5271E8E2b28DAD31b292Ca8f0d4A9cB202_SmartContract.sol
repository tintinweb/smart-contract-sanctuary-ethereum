...
//FTS 021622  
pragma solidity ^0.8.9; //two threshold //10% tax /v2
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletSize = 2000000000000001 * 10**9; //2Q
    ...
    string private constant _name = "FTS10T";
    string private constant _symbol = "FTS10T";
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function Settings(uint256 _swapTokensAtAmountini, uint256 _swapTokensAtAmountfin, uint256 _maxTxAmount, uint256 _maxWalletSize) external onlyOwner{
        swapTokensAtAmountini = _swapTokensAtAmountini * 10 **_decimals;
        swapTokensAtAmountfin = _swapTokensAtAmountfin * 10 **_decimals;
