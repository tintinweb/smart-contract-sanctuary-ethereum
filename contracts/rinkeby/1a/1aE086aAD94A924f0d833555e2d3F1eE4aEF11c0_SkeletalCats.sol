...
contract SkeletalCats is ERC721, ERC1155Holder, Ownable, RandomlyAssigned {
		...
		validateEthPayment(count,true)
	{
		...
		require(MerkleProof.verify(merkleProof, allowlistMerkleRoot, toBytes32(msg.sender)) == true, "invalid merkle proof");
		...
		validateEthPayment(count,true)
	{
		...
		require(MerkleProof.verify(merkleProof, waitlistMerkleRoot, toBytes32(msg.sender)) == true, "invalid merkle proof");
	...
	function ownerMint(address to, uint256 id) private {
