...
contract ATWCrypto is ERC721A, Ownable {
    ...
    uint private mintCost_ = 100 ether; //price is in polygon
    ...
    constructor() ERC721A('ATW Crypto', 'ATWC') {
        unrevealedURI = "ipfs://.../";
    }
    ...
    modifier onlyValidAccess(uint8 _v, bytes32 _r, bytes32 _s) {
        require(!whitelistActive || isValidAccessMessage(msg.sender,_v,_r,_s), 'Invalid Signature' );
        _;
    }
    ...
    */
    ...
    function reservedMint(address[] memory recipients) public onlyOwner {
        require(_reservedMints + recipients.length <= maxTotalTokens, "Not enough Reserved NFTs left to mint..");
        ...
        _reservedMints += recipients.length; 
    ...
    //activate and deactivate the whitelist
