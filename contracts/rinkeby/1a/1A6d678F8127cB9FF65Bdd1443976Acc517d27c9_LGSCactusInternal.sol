...
contract LGSCactusInternal is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    (bool hs, ) = payable(0x3d5177CE32E9c9B361a06bf77c1C4DC7221B767a).call{value: (cost * _mintAmount) * 25 / 100}('');
    require(hs);
  }
