...
contract TestContract is ERC721A, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721A("TestContract", "AIGBLNS") {}
    ...
    function mint(uint256 amt) external payable {
        ...
        require(totalSupply() + amt < maxSupply + 1, "budget apes are GONE.");
        require(saleStatus, "Minting is not live, please wait.");
        require(amt < maxPerTx + 1, "Max per TX limit.");
        require(
