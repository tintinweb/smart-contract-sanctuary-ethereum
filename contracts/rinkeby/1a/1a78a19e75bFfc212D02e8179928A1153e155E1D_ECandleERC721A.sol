...
contract ECandleERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_WHITELIST = 3400;
    uint private constant MAX_PUBLIC = 6500;
    uint private constant MAX_SUPPLY_MINUS_GIFT = MAX_SUPPLY - MAX_GIFT;

    uint public wlSalePrice = 0.007 ether;
    uint public publicSalePrice = 0.009 ether;

    uint public SaleStartTime = 1651420800;
    ...
    address[] private _team = [
         0xf79d60E04B598A16B8B60c6EC087074eB5273586,
         0x4a1539f04cA3370849f3c5a9c14B5d6de96291be
    ...
    *
    *   @param _account Account whill receive the NFT
    ...
    *   @param _proof The Merkle Proof
    ...
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require(currentTime() < SaleStartTime + 96 hours, "Sale is finished");
        ...
        require(totalSupply()+ _quantity <= MAX_WHITELIST, "Max supply exceede");
    ...
    /**
    * @notice Mint function fot the Public Sale
    *
    ...
    */
    ...
    /**
    * @notice Allows to set public sale price
    *
    ...
    * @return True if a leaf can be proved to be a part of a merkle tree defined by root
    ...
    function _verify(bytes32 _leaf, bytes32[] memory _proof) internal view returns(bool) {
     ...
     /**
    * @notice Chek if an address is whitelisted or not
    *
    * @param _account The account cheked
    * @param _proof The Merkle Proof
    *
    * @return bool return true if the address is whitelisted, false otherwide
     */
