...
contract SuperSimsClub is ERC721, Ownable {
    ...
    function getPresaleWhitelist() public view returns (address[] memory) {
    ...
    */
    ...
    function withdraw(uint256 _weiAmount, address _to) public onlyOwner {
