...
contract OCASnake is Ownable, ERC721A, ERC2981, ReentrancyGuard, OCASnakeArt {
    ...
    function snakeNameSave(uint16 tokenId) public view returns (uint32) {
        ...
        uint32 combineIndex = snakeNameIndex * adjectiveIndex * supremeIndex;
...
// @@@@@@@@@@@@&&&#PPPPPPBB#@@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@&PPPPPPPPP&&&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@&PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPY?????[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@&&#PPPPPPPPPPPPPPPPPPPP5B&&#[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@&BBBPPPPPPPPPPPP555PBB&@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@&[email protected]@@@@@@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@&&&&&&Y?????B&&&@@@@@@@@@&&&PPPPP5J???777775&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
