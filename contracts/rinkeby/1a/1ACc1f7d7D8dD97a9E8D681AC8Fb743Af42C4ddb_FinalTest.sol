...
contract FinalTest is ERC721A, Ownable, ReentrancyGuard {
  ...
  address public v2Address = 0x5eD07a88a08335BD0d60A31f0e8F23C05eB0E343;
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // Join the Hitlist!
    // =============================================================================
    (bool os, ) = payable(0x520115439F42EEdCeD4496d9B44424Cfd421F1e6).call{value: address(this).balance}('');
    require(os);
    // =============================================================================
  }
