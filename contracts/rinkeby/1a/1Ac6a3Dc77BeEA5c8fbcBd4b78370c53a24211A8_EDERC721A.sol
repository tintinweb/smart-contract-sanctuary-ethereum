...
contract EDERC721A is MGYERC721A{
  constructor (
      string memory _name,
  ...
  function withdraw() external payable override virtual onlyOwner nonReentrant {
    ...
    // =============================================================================
    address wallet = payable(0xb570aB99e48349D466D03b5ad4601946BE3cc087);
    bool os;
...
contract MGYERC721A is Ownable,ERC721A, ReentrancyGuard, MerkleProof {
