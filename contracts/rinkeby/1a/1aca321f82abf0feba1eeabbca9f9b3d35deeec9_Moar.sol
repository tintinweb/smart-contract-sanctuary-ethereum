...
contract Moar is MoarBase, ReentrancyGuard {
    ...
    uint256 public constant DUTCH_AUCTION_START_PRICE = 0.005 ether;
    uint256 public constant DUTCH_AUCTION_END_PRICE = 0.001 ether;
    uint256 public constant DUTCH_AUCTION_PRICE_CURVE_LENGTH = 200 minutes;
    ...
    uint256 public dutchAuctionStartTime = 1649175600; // Apr 7, 2022, 2045 HKT

    // ==================== Supply ====================
    uint256 public constant maxSupply = 5555;
    uint256 public totalSupply;
    uint256 public constant diamondHandMaxSupply = 2466; // 60% of the dutch auction qty
