...
contract HDRNStaking is Ownable, ReentrancyGuard {
    ...
    uint256 public stakingPeriod=2 days;
    ...
    function updateStakingPeriod(uint256 newStakingPeriodInDays) public onlyOwner{
        require(newStakingPeriodInDays != stakingPeriod,"Add a different staking period");
