...
contract MyEpicNFT is ERC721URIStorage {
    ...
    uint256 private constant LIMIT_TOKEN = 10;
    ...
    string[] colors = ["red", "#8010c2", "black", "yellow", "blue", "purple"];
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combinedWord,
                        '", "description": "A acclaimed collection.", "image": "data:image/svg+xml;base64,',
