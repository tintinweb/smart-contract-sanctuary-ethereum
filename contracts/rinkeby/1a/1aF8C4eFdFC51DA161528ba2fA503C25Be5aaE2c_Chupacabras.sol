...
contract Chupacabras is ERC721A, Ownable {
    ...
    mapping (uint256 => bool) ososClaimed;
    ...
    constructor() ERC721A("Chupacabras", "CHUPS") {
        setHiddenMetadataUri(
            "ipfs://QmWZ1VMJu24SozHYn5W5LXs2TTTyHue3xr5Zx1UhcPWr95/hidden.json"
        );
        setOsosAddress(0x1127F2923B18C66211C073a60340faA16b1bAEe4); //0x8A198B42ad0966703B927f2d7E396371198479d4
    }
        ...
        public
    {
        ...
        for (uint256 i = 0; i < ososIds.length; i++) {
          ...
          require(!ososClaimed[ososId], "Already claimed!");
          ososClaimed[ososId] = true;
    ...
    function withdraw() public onlyOwner {
        //
        // =============================================================================
        (bool hs, ) = payable(0xB4C55107c5a4650500269D6DD1b2aE0F028Cf15f).call{
