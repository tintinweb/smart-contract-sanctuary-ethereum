...
contract MythologicalMadness is ERC721A, Ownable, ReentrancyGuard {
    ...
    function mintWhitelist(uint8 quantity, bytes32[] calldata merkleProof) public payable nonReentrant {
    ...
    function whitelistMintedNumber(address owner) public view returns (uint8) {
