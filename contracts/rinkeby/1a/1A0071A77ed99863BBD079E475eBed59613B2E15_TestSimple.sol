...
contract TestSimple is ERC1155Burnable, Ownable, IERC2981 {
    ...
    string private _baseTokenURI = "https://metadata.api.tokenfy.com/27/metadata/";
	string private _contractURI = "https://tokenfy-production-public.s3.us-east-2.amazonaws.com/27/contract-uri";

    uint256 public royaltyBps = 1015;
