...
contract DemoMan is ERC721, ERC2981, Ownable {
    uint256 public constant MAX_SUPPLY = 5555;

    uint256 public premintprice = .025 ether;
    ...
    function premintMint(uint256 count, bytes32[] calldata merkleProof) external payable virtual {
        ...
        require(premintprice * count == msg.value, "Incorrect ETH value sent");
        require(
