...
contract ERC721NFTGrails is ERC721Base {
    function __ERC721NFTGrail_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        _setBaseURI(baseURI);
...
abstract contract ERC721Lazy is IERC721LazyMint, ERC721Upgradeable, Mint721Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
    ...
    function __ERC721Lazy_init_unchained() internal initializer {
        _registerInterface(0xe8a3d485); //clarify
    }
