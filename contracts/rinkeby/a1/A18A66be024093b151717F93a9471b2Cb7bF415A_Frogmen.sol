...
contract Frogmen is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("Frogmen", "FROGMEN", 100, 5326) {}
    ...
    /* Mint */
    function mintPrecheck(uint256 numberOfTokens, bool isOwner) private {
    ...
    function processMint(uint256 numberOfTokens, bool isOwner) private {
        ...
        mintPrecheck(numberOfTokens, isOwner);
