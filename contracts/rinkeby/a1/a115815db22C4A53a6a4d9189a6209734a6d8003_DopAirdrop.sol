...
interface IAirdrop {
    ...
    function claimed(bytes32 node) external view returns (bool);
    ...
    event Claimed(bytes32 node, address account, uint256 amount);
}
...
contract DopAirdrop is IAirdrop, Ownable {
    ...
    mapping(bytes32 => bool) public override claimed;
    ...
    function claim(uint256 amount, bytes32[] calldata merkleProof
        ...
        require(!claimed[node], "DopAirdrop: Already claimed.");
        ...
        emit Claimed(node, account, amount);
    }
}