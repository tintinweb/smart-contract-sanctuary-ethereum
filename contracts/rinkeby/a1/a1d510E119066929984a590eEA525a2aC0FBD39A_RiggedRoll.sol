...
contract DiceGame {
    ...
    function rollTheDice() public payable {
        ...
        console.log("Game Nonce: %d", nonce);
...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public onlyOwner {
        require(_amount <= address(this).balance, "Balance isn't high enough");
    ...
    function riggedRoll() public onlyOwner {
        ...
        console.logBytes32(prevHash);
        console.log("Nonce: %d", diceGame.nonce());
        console.log("Address: ", address(diceGame));
        console.logBytes32(newHash);
        uint256 roll = uint256(newHash) % 16;
        console.log("Rigged Roll: ", roll);

        if (roll == 0 || roll == 1 || roll == 2) {
            console.log("Calling Dice Game");
            diceGame.rollTheDice{value: 0.002 ether}();
        } else {
            revert("Failed Dice Roll");
        }
    }
