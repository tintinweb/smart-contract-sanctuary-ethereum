...
contract AnonRobinPasses is ERC1155Supply, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	bytes32 public root = 0xd12748d894a31f4e1a1a37b135637a978a0fcf5e068fe12ef87bdd7da22c7c16;

	string public _baseURI = "ipfs://QmZs3Bdfsi1Kw8VFy3AWZWqYjSpBKtRWvpZK3A8XqXVSah/";
	string public _contractURI = "ipfs://QmQ1YYd3j925FyiSuN1Gi5Eor6eJaYEZgqEgShHra5RMz4";

	uint256 public presaleStartTime = block.timestamp - 1;
	uint256 public publicStartTime = block.timestamp - 1;
	...
	address[] private addressList = [
		...
		0x00000004Af22764bb04ddf4402Fd35F6e3011123 //a
	...
	function presaleBuy(
		...
		require(totalSupply(id) + qty <= maxSuppliesPresale[id], "out of stock");
	...
	/**
	 @dev admin can mint whatever
	 @param id - the token ID
	 @param qty - the quantity
	  */
	function adminMint(uint256 id, uint256 qty) external onlyOwner {
		require(totalSupply(id) + qty <= maxSupplies[id], "out of stock");
		_mint(msg.sender, id, qty, "");
	}
	...
	function setProxyRegistry(address newRegistry) external onlyOwner {
