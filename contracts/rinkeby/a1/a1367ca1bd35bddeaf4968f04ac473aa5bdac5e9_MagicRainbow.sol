...
contract MagicRainbow is EIP712, Ownable, ERC721A {
    ...
    constructor() ERC721A("Magic Rainbow", "MR") EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION){}
    ...
    function mint_presale(uint256 quantity, uint256 id, bytes memory signature) public payable {
        require(quantity > 0 && quantity <= adoptionLimitWL, "Wrong Quantity.");
        ...
        require(getMintedCount(msg.sender) + quantity <= adoptionLimitWL, "Exceed max minting amount");
