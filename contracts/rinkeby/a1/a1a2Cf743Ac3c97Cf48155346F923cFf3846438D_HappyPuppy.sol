...
contract HappyPuppy is ERC721, Ownable {
  ...
  constructor() ERC721("Happy Puppy", "XD") {
    setBaseURI("ipfs://QmVR3GH5b7q1biBCoZXbZeBaNTgQby3xs9znWAgcGMwtCZ");
  ...
  // Function to change the ipfs URI
  function changeIPFSURI(string memory _ipfsURI) public onlyOwner {
    ipfsURI = _ipfsURI;
  }
