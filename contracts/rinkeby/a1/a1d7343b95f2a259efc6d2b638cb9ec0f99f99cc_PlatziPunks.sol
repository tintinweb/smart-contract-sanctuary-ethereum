...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA{
    ...
    mapping (uint256 => uint256) public tokenDNA; //Apuntar├í desde el tokenId al ADN
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory){
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "PlatziPunks #"',
                tokenId.toString(),
                '"description": "Developed avatars and stored on chain", "image": "',
                image,
                '"}'
            )
        );
