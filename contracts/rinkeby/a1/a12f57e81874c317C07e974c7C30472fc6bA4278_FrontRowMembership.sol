...
contract FrontRowMembership is ERC1155, Pausable, AccessControlEnumerable {
    ...
    constructor(string memory _uri, address payable _beneficiary, address _signer, address[] memory admins) ERC1155(_uri) {
        ...
        name = "Strategically Targeted Entertainment Value Expansion Test 2";
        symbol = "STEVETEST2";
    ...
    //    return string(abi.encodePacked(ERC1155.uri(0), "opensea.json"));
    //}
    ...
    // FIXME: Remove from final contract.
    // ...you didn't remove it did you?
    // ...
    // "yeah this function is left here intentionally"
