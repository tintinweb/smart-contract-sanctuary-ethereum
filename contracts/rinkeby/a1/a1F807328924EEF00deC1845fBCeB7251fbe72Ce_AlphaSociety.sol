...
/*
Twitter: https://twitter.com/AlphaSocietyNFT
Website: https://alphasociety.club
Discord: https://discord.gg/CHANGEME
*/


contract AlphaSociety is ERC721A, Ownable {
    ...
    // TO DO: set to private before live
    mapping(address => bool) public _freeMintAddr;

    constructor(
        string memory base,
        bytes32 merkleRoot,
        address[] memory freeMinterAddresses
    ) ERC721A("Alpha Society", "ALPHA") {
        _baseUri = base;
    ...
    function remainingTokens() public view returns (uint256) {
        return availableNFTs - _currentIndex;
    }
