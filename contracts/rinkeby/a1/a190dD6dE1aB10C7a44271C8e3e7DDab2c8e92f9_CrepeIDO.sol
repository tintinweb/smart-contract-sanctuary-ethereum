...
contract CrepeIDO is AccessControl, ReentrancyGuard {
    ...
    uint160 public constant minSqrtPriceLimit = 4295128740;
    uint160 public constant maxSqrtPriceLimit = 1461446703485210103287273052203988822378723970341;
        ...
        external payable nonReentrant
    {
        ...
        if (_acceptedToken == address(0)) {
            ...
            uint160 sqrtPriceLimit = _acceptedToken < USDC ? minSqrtPriceLimit : maxSqrtPriceLimit;
            IERC20Metadata(_acceptedToken).safeTransferFrom(
                msg.sender,
                address(this),
                _amountIn
