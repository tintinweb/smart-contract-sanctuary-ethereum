...
contract FluctuationOverload0825 is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    // Reserve up to 30 comics for founders (10 per team member)
    uint public foundersReserve = 30;
   ...
   function setBaseURI(string memory newuri) public onlyOwner {
    ...
    function publicMint(uint COMICS) public payable {
