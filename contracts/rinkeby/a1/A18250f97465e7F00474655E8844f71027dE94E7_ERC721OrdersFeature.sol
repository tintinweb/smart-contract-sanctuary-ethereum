...
import "../src/features/interfaces/IERC721OrdersFeature.sol";
import "../src/features/interfaces/IERC1155OrdersFeature.sol";

contract DummyZeroEx is IERC721OrdersFeature, IERC1155OrdersFeature {
    function sellERC721(
    ...
    function cancelERC721Order(uint256 orderNonce) external override{}
    ...
    ) external override returns (uint256[] memory profits, bool[] memory successes){}
    ...
    function cancelERC1155Order(uint256 orderNonce) external override{}
