...
contract NFTCreator is ERC721Enumerable, Ownable, ReentrancyGuard {

    uint64 public MAX_TOKENS_PER_ACCOUNT_FOR_FREE;
    uint64 public MAX_TOKENS_PER_ACCOUNT_FOR_SALE;
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_) ERC721(name_, symbol_) {
        ...
        freeSupply = 1000;
        maxSupply = 7000;
        MAX_TOKENS_PER_ACCOUNT_FOR_FREE = 1;
        MAX_TOKENS_PER_ACCOUNT_FOR_SALE = 5;
    }
    ...
    function saleMint(uint256 num) external payable callerIsUser mintStarting nonReentrant {
        require(totalSupply() + num <= maxSupply, "over total supply");
    ...
    function setSaleStart() external {
        saleStarting = true;
    }

    function pausedSale() external {
        saleStarting = false;
    }
