...
contract FundMe {
    ...
    uint256 minimum_usd_amount =  50 * 10 ** 18;
    ...
    function fund() public payable {
        require(get_conversion_rate(msg.value) >= minimum_usd_amount, "You need to spend more ether");
    ...
    function get_entrance_fee() public view returns(uint256) {
        ...
        return ((minimum_usd_amount * precision) / price) + 1;
    }
}
