...
contract MetaChess {
    ...
    function getMetadataJSON(uint256 tokenId) public view returns (string memory) {
        ...
        string memory json = string(abi.encodePacked('{"name": "#', toString(tokenId), ' - MetaChess", "description": "HundredEleven is a cryptoart metacollection with interchangable metadata, created by berk aka princesscamel aka guerrilla pimp minion bastard. Holders of a NFT from this series can swap the active metadata within collections on-chain. Visit https://hundredeleven.art for more info about the metacollection and interacting with tokens. Current collection shown in this token is MetaChess - randomly on-chain generated 111 chess moves.", "external_url": "https://hundredeleven.art/", "artist": "berk aka princesscamel aka guerrilla pimp minion bastard", "media_type": "image", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(image)), '","attributes":[{"trait_type": "Collection", "value": "MetaChess"' , '}]}'));
        return json;
    }
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked('{"name": "MetaChess", "description": "on-chain generated random 111 chess moves.", "artist": "berk aka princesscamel aka guerrilla pimp minion bastard", "external_link": "https://hundredeleven.art/", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(generateImage(69))),'"}'));
    }
