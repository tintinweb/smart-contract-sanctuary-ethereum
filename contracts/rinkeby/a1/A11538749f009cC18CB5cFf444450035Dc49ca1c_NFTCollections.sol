...
contract NFTCollections is ERC721Upgradeable, OwnableUpgradeable {
     ...
     * 
     */
    function internalMintFromCollection(uint256 collectionId, uint256 tokenIdInCollection, address mintTo, bool fromAdmin, uint256 msgvalue) internal {
        // revert if collection id is outside bounds
        require(collectionId < collections.length, "Bad collection ID");
        
        uint256 expectedPrice;
        if (materialsAndToolsContract.balanceOf(mintTo, 0) > 0) {
        ...
        if (!fromAdmin) {
            ...
            require(msgvalue == expectedPrice, "Wrong amount of ETH");
    ...
    function addAndEditCollections(CollectionUpdate calldata collectionsToUpdate, Collection[] calldata collectionsToAdd) external onlyOwner {
        ...
        for (i = 0; i < collectionsToUpdate.updatedItemLabel.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedBaseURI.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedBaseToken.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedBaseCollection.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedPrice.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedDiscountPrice.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedTotalTokenIds.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedMtRequirementIds.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedMtRequirementCounts.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedCollectionType.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedPaymentErc20Price.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedPaymentErc20Address.length; i++) {
        ...
        for (i = 0; i < collectionsToUpdate.updatedAvailable.length; i++) {
        ...
        for (i = 0; i < collectionsToAdd.length; i++) {
    ...
    function mintFromCollection(uint256 collectionId, uint256 tokenIdInCollection) public payable {
        internalMintFromCollection(collectionId, tokenIdInCollection, msg.sender, false, msg.value);
    }

    /**
     * @dev Mint multiple tokens from collections
     */
    function mintFromCollectionMultiple(uint256[] calldata collectionIds, uint256[] calldata tokenIdsInCollection, uint256[] calldata prices) public payable {
        require(collectionIds.length == tokenIdsInCollection.length && collectionIds.length == prices.length, "Bad lengths");
        ...
        for (uint256 i=0; i < prices.length; i++) {
            internalMintFromCollection(collectionIds[i], tokenIdsInCollection[i], msg.sender, false, prices[i]);
        }
    }
