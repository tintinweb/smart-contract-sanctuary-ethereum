...
import "./Interfaces/ISerumStaking.sol";
import "./Interfaces/IMutantCats.sol";
...
contract CuredCats is ERC721Enumerable, Ownable, IERC721Receiver {
    ...
    IMutantCats public mutantCatsAddress;
    ISerumStaking public serumAddress;
    ...
    constructor(
        ...
        baseURI = baseURI_;
        mutantCatsAddress = IMutantCats(_mutantCatsAddress);
        serumAddress = ISerumStaking(_serumAddress);
   ...
   //Basic Functions 
    ...
    //         //burn serum
    //         serumAddress.burn(msg.sender, SERUM_TOKEN_ID,  1); 
    //         //transfer mutantCats
    //         MUTANT_CATS_TOKEN_ID = _tokenIds[i];
    //         mutantCatsAddress.burn(MUTANT_CATS_TOKEN_ID);
    //         //mint curedCats
...
interface ISerumStaking is IERC1155 {
...
interface IMutantCats is IERC721 {
