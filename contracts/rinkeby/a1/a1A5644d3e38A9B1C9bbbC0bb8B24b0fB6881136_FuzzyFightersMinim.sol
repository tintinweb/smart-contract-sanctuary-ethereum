...
contract FuzzyFightersMinim is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant TOTAL_COLLECTION_QTY = 22;
    uint256 public constant PRESALE_MAX_QTY = 10; // public 22-(5)- 8 = 9 
    uint256 public constant AIRDROP_MAX_QTY  = 5; // gift + reserved
    uint256 public constant RESERVED_MAX_QTY  = 3;
