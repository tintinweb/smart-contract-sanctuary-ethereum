...
contract MetaGods is ERC721Enum, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    function reserve(address to_, uint256 reserveAmount_) public onlyOwner {
    ...
    function setMaxPassHolderPaidMints(uint256 maxPassHolderPaidMints_) public onlyOwner {
