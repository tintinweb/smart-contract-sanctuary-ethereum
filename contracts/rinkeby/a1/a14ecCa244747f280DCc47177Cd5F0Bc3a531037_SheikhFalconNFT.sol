...
contract SheikhFalconNFT is ERC721A("SheikhFalconNFT", "SF"), Ownable, ERC2981 {
    ...
    uint256 public costPerNft = 0.01 * 1e18;
    ...
    function purchaseTokens(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= nftPerAddressLimit, "max mint amount per address exceeded");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x3edA3EDA0888412D20683F4B6529153eAadb672e).transfer((balance * 0.90 ether) / 1 ether); // 90%
        payable(0x3edA3EDA0888412D20683F4B6529153eAadb672e).transfer((balance * 0.10 ether) / 1 ether); // 10%
    }
