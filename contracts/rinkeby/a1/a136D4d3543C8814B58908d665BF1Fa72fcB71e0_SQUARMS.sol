...
contract SQUARMS is ERC20Burnable, Ownable {
    ...
    function claimByTokenId(uint256 tokenId) public {
        ...
        require(block.timestamp - tokenIdToTimeStamp[tokenId]  >= STAKE_DURATION, "less than stake duration");
    ...
    function claimAll() public {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            uint tokenDuration = block.timestamp - tokenIdToTimeStamp[tokenIds[i]];


          if (tokenDuration >= STAKE_DURATION) {
        ...
        _mint(msg.sender, totalRewards);
              ...
              require(tokenDuration  >= STAKE_DURATION, "less than stake duration");
              }
