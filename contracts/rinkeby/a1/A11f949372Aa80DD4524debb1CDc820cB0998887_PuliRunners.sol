    ...
    Ownable
{
    ...
    function mintWhitelistToken(
        ...
        uint256 _price = whiteListMap[batchDescription].price[address(token)];
...
contract PuliRunners is PuliNFT {
    ...
    string baseToken = "https://runners.pulitoken.net/metadata/";

    constructor(address proxyAddress)
        PuliNFT("Puli Inu Runners", "PRNR", proxyAddress, 2010)
    {
        withdrawalAddress = msg.sender;
    }

    function setBaseTokenURI(string memory _baseToken) public onlyOwner {
    ...
    function contractURI() public view override returns (string memory) {
        return string(
            abi.encodePacked(baseTokenURI(), "contract.json")
        );
    }
