...
contract badSapiens is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant whitelist_PRICE = .05 ether;
    ...
    uint256 public constant public_LIMIT = 4;
