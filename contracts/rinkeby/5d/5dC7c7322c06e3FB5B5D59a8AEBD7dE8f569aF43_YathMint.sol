...
contract YathMint is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(bytes32 _collabMerkleRoot, bytes32 _premintMerkleRoot, uint256 _startMint, string memory _aliveURI, string memory _deadURI)
    ...
    function tokenURI(uint256 _nftId) public view override(ERC721A) returns (string memory) {
        ...
        if (gameAddress != address(0)) {
            //TODO : refaire la fonction ici pour appeler l'autre contrat
