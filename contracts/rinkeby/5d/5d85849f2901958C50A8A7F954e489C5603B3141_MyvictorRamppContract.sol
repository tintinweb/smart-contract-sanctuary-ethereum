...
//
//     __  ___               _      __                ____                            
//    /  |/  /_  __   _   __(_)____/ /_____  _____   / __ \____ _____ ___  ____  ____ 
//   / /|_/ / / / /  | | / / / ___/ __/ __ \/ ___/  / /_/ / __ `/ __ `__ \/ __ \/ __ \
//  / /  / / /_/ /   | |/ / / /__/ /_/ /_/ / /     / _, _/ /_/ / / / / / / /_/ / /_/ /
// /_/  /_/\__, /    |___/_/\___/\__/\____/_/     /_/ |_|\__,_/_/ /_/ /_/ .___/ .___/ 
//        /____/                                                       /_/   /_/      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9cdeF90FFB8440ba966b31C0405E44b2BE1537b1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmW9anuto5tHZ1VRnPehRg97M4soKCefELiPKAtZpB7mDd/";
...
// File: contracts/MyvictorRamppContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyvictorRamppContract is RamppERC721A {
    constructor() RamppERC721A("My victor Rampp", "MRRAMPP "){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/mrTIthg9u9Iaov5ycR6b/contract-metadata";
    }
}
