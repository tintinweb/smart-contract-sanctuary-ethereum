...
contract MfersNFT is ERC721A, Ownable {
    ...
    string public baseURI = 'https://mfers-in-wallstreet.netlify.app/.lambda/meta/';
    ...
    function batchMint(uint amount) public payable {
        require( amount <= MAX_MINT_PER_ADDR, "Exceeds the maximum mint amount of a sinle transaction");
