...
// File: contracts/cryptogeneration.sol
...
contract cryptogenerationnft is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public currentMaxSupply = 200;
  uint256 public maxMintAmountPerTx = 20;

  bool public paused = false;
  bool public revealed = false;

  constructor() ERC721("crypto generation nft", "CGN") {
    setHiddenMetadataUri("ipfs://bafybeih7yioh7negcjpanz3f66s6e6pnxwfvdwsq2o64mbztfhnzkuajru/hidden.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    _mintLoop(msg.sender, _mintAmount);//falst mint
  ...
  function setCurrentMcurrentMaxSupply(uint256 _supply) public onlyOwner {
      require(_supply <= finalMaxSupply && _supply >= totalSupply());
      currentMaxSupply = _supply;
  }

 function risetfinlMaksuply () public onlyOwner {
