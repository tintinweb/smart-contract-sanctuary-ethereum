...
contract MerkleTreeWithHistory {
  ...
  */
  function hashLeftRight(bytes32 _left, bytes32 _right) public pure returns (bytes32) {
    ...
    uint256 C = 0;
      (R, C) = Hasher(0x74f84b34d01682B38EA568CE2208374caf2B8F27).MiMCSponge(R, C);
...
contract SpillWays is MerkleTreeWithHistory, ReentrancyGuard {
  ...
  */
  ...
  /**
    @dev Deposit funds into the contract. The caller must send (for native) or approve (for ERC20) value equal to or `denomination` of this instance.
