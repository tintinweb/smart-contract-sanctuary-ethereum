...
contract imaginaryballsAzuki is ERC721A, Ownable {
    using Strings for uint256;
    ...
    string public baseURI = "https://imaginaryballs.com/";

    constructor() ERC721A("IMAGINARY BALLS", "IB") {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
      ...
      return bytes(currentBaseURI).length > 0
          ...
          return "https://imaginaryballs.com/unrev.json";
      }
  }
