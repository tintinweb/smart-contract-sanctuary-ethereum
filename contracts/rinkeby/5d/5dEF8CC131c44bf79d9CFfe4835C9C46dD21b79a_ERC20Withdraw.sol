...
contract ERC20Withdraw is IERC20Withdrawable, Withdraw  {
    ...
    function setBlacklist(address _blacklist) external onlyOwner {
        ...
        emit SetBlackList(_blacklist);
    }

    function create(uint256 _amount, uint256 _tokenId) external whenNotPaused {
        require(!blacklist[msg.sender], "Sender be in blacklist ");
        ...
        nonReentrant
    {
        ...
        IERC20Mintable(request.token).mint(_user, request.amount);
