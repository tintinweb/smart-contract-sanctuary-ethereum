...
contract Fat is ERC721A, Ownable, ReentrancyGuard {
    using MerkleProof for bytes32[];

    // ===== Variables =====
    uint16 constant devSupply = 100;
    uint16 constant presaleSupply = 200;
    uint16 constant collectionSupply = 7777;

    bool private privateMintStarted;
    bool private publicMintStarted;

    uint8 private presaleMaxItemsPerWallet = 7;

    uint256 private presalePrice = 0.007 ether;
