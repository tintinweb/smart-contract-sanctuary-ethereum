...
contract NFTPuzzle is ERC721, Ownable, ReentrancyGuard, VRFConsumerBaseV2{
      ...
      constructor(string memory _base_uri, address vrfCoordinator) ERC721("Legendary Puzzle","LGP")  VRFConsumerBaseV2(vrfCoordinator)
      {
  ...
  */
  ...
  function requestRandomWords() internal onlyOwner 
  {
    ...
    randomNumber = randomWords[0] % 30 + 1;
