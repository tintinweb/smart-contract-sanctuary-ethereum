...
/**
 * @title SongAlbumNFTTradable
 * SongAlbumNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract SongAlbumNFTTradable is ERC721, Ownable {
