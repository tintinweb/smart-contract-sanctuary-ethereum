...
contract Donut is ERC721Common, ReentrancyGuard {
    using Strings for uint256;

    uint256 public _tokenIdTracker;
    IERC721 public franchise;
    ...
    {
        franchise = IERC721(_franchise);
    }

    function mint() public 
        nonReentrant
        whenNotPaused {
        require(franchise.balanceOf(msg.sender) > 0, "Not the franchise holder");
