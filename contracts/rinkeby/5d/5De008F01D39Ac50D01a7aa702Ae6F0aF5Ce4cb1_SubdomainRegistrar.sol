...
contract SubdomainRegistrar is Ownable, ERC721A {
    ...
    function stakeDomain (string memory domain, bool enabled, uint256 price, uint256 unlockUnixTimestamp) external {
        ...
        address registrant = ensRegistrarContract.ownerOf(domainToTokenId(domain));
        require(msg.sender == nodeOwner || msg.sender == registrant, "You don't own this domain.");
        ...
        if (domainLabelMap[domain] == 0) {
            ...
            // ensContract.setOwner(node, address(this)); maybe not needed
