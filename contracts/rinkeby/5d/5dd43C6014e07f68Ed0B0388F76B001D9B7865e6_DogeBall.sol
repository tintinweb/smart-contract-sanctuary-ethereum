...
contract DogeBall is ERC721, Ownable {
    ...
    uint256 public _price = 60000000000000000; // 0.03 ETH
    ...
    function authMint(bytes memory signedMessage) public payable {
        require(_saleActive);
        require(verifyAccountWithSignature(msg.sender, signedMessage, _verifyingAccount),"not whitelisted");


        require(!_hasFreeMinted[_msgSender()], "Has already free-minted...");
