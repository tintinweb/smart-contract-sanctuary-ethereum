...
contract CuriousAddysNFT is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard, IERC2981 {
    ...
    constructor(string memory _baseContractURI, string memory _tokenSuffixURI) ERC721("CuriousAddysNFTDev", "CAD") {
