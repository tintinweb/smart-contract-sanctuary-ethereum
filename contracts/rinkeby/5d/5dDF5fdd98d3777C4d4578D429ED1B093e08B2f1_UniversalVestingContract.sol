...
contract UniversalVestingContract is Ownable, Pausable {
    ...
    function setThresholdTimeForVesting (uint startTime) external onlyOwner {
        ...
        linearVestingAmountWithdrawThresholdTime= [0,startTime+61 days,startTime + 1 days,startTime + 1 days,startTime + 1 days,startTime + 181 days,startTime + 31 days,startTime + 31 days,startTime + 181 days, startTime + 91 days,startTime + 1 days];
