...
contract TokenBux is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    ...
    constructor() ERC20("TokenBux", "TOKENBUX") ERC20Permit("TokenBux") {}
    ...
    function mint() external onlyOwner {
        ...
        _mint(treasuryWallet, 4500000 * 10 ** decimals());
        _mint(rewardsWallets, 4500000 * 10 ** decimals());
        _mint(developmentWallet, 4500000 * 10 ** decimals());
        _mint(teamWallet, 4500000 * 10 ** decimals());
        initMint = true;
    }
}
