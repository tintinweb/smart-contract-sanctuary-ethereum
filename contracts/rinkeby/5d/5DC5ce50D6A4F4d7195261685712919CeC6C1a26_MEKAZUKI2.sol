...
contract MEKAZUKI2 is IERC721, Ownable, Functional {
     ...
     */
    constructor() {
        _name = "Mekazuki Migration";
        _symbol = "MZM";
        _baseURI = "https://newwebsite/metadata/";
        _hideTokens = true;
        
        //OGContract = ERC721(0x84845C3b92656c3459f8D704dfBC6a3830A94fe3);  //MEKAZUKI MAINNET
        OGContract = ERC721(0x1cA4915EBDDAA0a0F0068E67a43330E0FBD50C26);   //TESTNET ONLY
        ...
        maxPerTxn = 10;
        maxPerWallet = 20;
        mintStart = 3500; // Defines the position that we will start minting if that feature is opened.
    }
