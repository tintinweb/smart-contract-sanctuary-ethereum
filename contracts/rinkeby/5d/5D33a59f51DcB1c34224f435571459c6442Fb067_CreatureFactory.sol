...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    // string public baseURI = "https://bafkreifsnhyutf3x4qyllchkxz6ha4lyasfwjntu7huw55xpog2w2ntkoa.ipfs.nftstorage.link/";
    string public baseURI = "https://bafybeialbl2mdq32qeurokvneoa2fs4qxybcfw3wuv36g474f5qvv6a3hi.ipfs.nftstorage.link/box/";
    ...
    uint256 NUM_CREATURES_IN_MULTIPLE_CREATURE_OPTION = 1;
    ...
    function name() override external pure returns (string memory) {
        return "Test OpenSeaCreature Item Sale 2";
    }
...
contract CreatureLootBox is ERC721Tradable {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://bafybeialbl2mdq32qeurokvneoa2fs4qxybcfw3wuv36g474f5qvv6a3hi.ipfs.nftstorage.link/box/";
    }
...
contract Creature is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Test Creature 2", "TSCC", _proxyRegistryAddress)
    {}
