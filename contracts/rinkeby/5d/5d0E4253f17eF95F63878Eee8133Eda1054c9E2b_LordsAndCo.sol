...
contract LordsAndCo is Ownable, ReentrancyGuard {
    ...
    */
    ...
    /**
    * @dev Returnes price change and it's direction from the last user claim
    */
    ...
    /**
    * @dev Returns claimable $loomi amount for user based on baseRate and price change
    */
    ...
    */
    ...
    /**
    * @dev Returns current $loomi price to ether
    */
