...
contract VoteAnzenToken is Context, AccessControlEnumerable, ERC20Votes {
    ...
    modifier onlyHasRole(bytes32 _role) {
        require(
            ...
            "veAnzenToken.onlyHasRole: Permission denied"
        );
        _;
    }
    ...
    function _transfer(
        ...
        revert("veANZ is non-transferable");
    }
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) internal _balances; // Change of private variable
