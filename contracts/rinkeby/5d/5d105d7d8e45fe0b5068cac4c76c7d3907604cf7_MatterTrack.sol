    ...
    UUPSUpgradeable
{
    ...
    function redeem(
        ...
        _mintTrack(buyerAddress, tokenId, mintCount);
    }
    ...
    function _verifySignature(
        ...
        bytes32 digest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256(
                        "MatterTrackSignData(uint256 tokenId,uint256 mintCount,uint256 maxMintCount,uint256 price,uint256 collaboratorsHash)"
                    ),
                    tokenId,
                    mintCount,
                    maxMintCount,
...
contract SharedLogic {
    ...
    uint256 public constant PERCENTAGE = 50000;
