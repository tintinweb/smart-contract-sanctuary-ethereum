...
contract protoKol2 is iProtoKol {
   ...
   */
    ...
    function withdawPresaleByCampaignOwner(uint256 _campaignId) external {
        ...
        uint256 transferToPresale = campaignDetails.campaignData.presaleAmount - shareOfKolsInTermsToken;

        IERC20(campaignDetails.campaignData.preSaleToken).transfer(
            msg.sender,
            (transferToPresale * 10**IERC20(campaignDetails.campaignData.preSaleToken).decimals()) / 1e18
        );
    }
