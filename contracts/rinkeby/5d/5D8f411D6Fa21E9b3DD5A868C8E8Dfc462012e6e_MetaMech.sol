...
contract MetaMech is ERC721AOwnersExplicit, Ownable {
    uint256 internal constant RESERVE_LIMIT = 410;
    uint256 internal constant MAX_LIMIT = 10000;
    uint256 internal constant MAX_SALE_LIMIT = 10000;
    uint256 internal constant PRE_SALE_ONCE_LIMIT = 10;
    uint256 internal constant NORMAL_SALE_ONCE_LIMIT = 10;
    ...
    uint256 public reserveMintedAmt; // has pre minted num
    uint256 public mintedAmt; // has minted num
    ...
    function mintTo(address[] calldata _tos, uint256 amount) public onlyOwner {
        ...
        uint256 _reserveMintedAmt = reserveMintedAmt;
        ...
        require(
            _reserveMintedAmt + mintAmt <= RESERVE_LIMIT,
            "MetaMech: reached reserved limit"
        );
    ...
    function mint(uint256 num) public payable {
        ...
        if (
            ...
            require(
                _reserveMintedAmt + num <= RESERVE_LIMIT,
                "MetaMech: presale reached max limit"
            );
            require(
            ...
            require(
                ...
                "MetaMech: price error, please check msg.value."
            );
