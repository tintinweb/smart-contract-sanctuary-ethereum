...
// File: https://github.com/chiru-labs/ERC721A/blob/9b2dff8a0ce2d6caad85a69d9d8e73a0429f2710/contracts/IERC721A.sol
...
// File: https://github.com/chiru-labs/ERC721A/blob/9b2dff8a0ce2d6caad85a69d9d8e73a0429f2710/contracts/ERC721A.sol
...
// File: contracts/Sunglasses721.sol
...
contract PleinSunglasses721 is ERC721A, Ownable {

    uint128 private constant MAX_TOKEN_SUPPLY = 1000;
    uint128 private nextTokenId = 0;
    ...
    /**
    * Premint function for contract owner.
    */
    function premint(uint256 numberOfTokens) external onlyOwner() {
        if(numberOfTokens > MAX_TOKEN_SUPPLY )
            revert WrongAmountRequested();
        unchecked {
            if(nextTokenId + numberOfTokens > MAX_TOKEN_SUPPLY)
