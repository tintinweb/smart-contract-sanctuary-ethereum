...
import "./NBR1155.sol";
import "./lzContracts/IONFT1155.sol";
...
contract IKTEST is  Ownable, NBR1155, ERC1155Pausable, ERC1155Supply, PaymentSplitter {
    ...
    ) ERC1155("https://www.infinitykeys.io") PaymentSplitter(addresses, splits) NBR1155(_layerZeroEndpoint) {
        name_ = _name;
        symbol_ = _symbol;
        setSecret(_secret);
        setSigner(_signer);
    ...
    */
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(NBR1155, ERC1155) returns (bool) {
...
import "./lzContracts/IONFT1155Core.sol";
import "./lzContracts/NonblockingLzApp.sol";
import "@openzeppelin/contracts/utils/introspection/ERC165.sol";

abstract contract NBR1155 is NonblockingLzApp, ERC165, IONFT1155Core {
    constructor(address _lzEndpoint) NonblockingLzApp(_lzEndpoint) {}

    uint16 version = 1;
    uint gas = 350000;
    bytes public adapterParams = abi.encodePacked(version, gas);
    ...
    function sendFrom(address _from, uint16 _dstChainId, bytes memory _toAddress, uint _tokenId, uint _amount, address payable _refundAddress, address _zroPaymentAddress, bytes memory _adapterParams ) public payable virtual override {
        _sendBatch(_from, _dstChainId, _toAddress, _toSingletonArray(_tokenId), _toSingletonArray(_amount), _refundAddress, _zroPaymentAddress, adapterParams);
    }
