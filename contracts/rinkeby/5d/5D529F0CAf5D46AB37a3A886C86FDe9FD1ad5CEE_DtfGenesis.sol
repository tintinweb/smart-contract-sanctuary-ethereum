...
contract DtfGenesis is ERC721A, Ownable {
    ...
    address public DAO_ADDRESS = 0x2840ae7759FEa26f4ad73191b271750BeD2D77b1;
        ...
        payable
    {
        ...
        require(supply + _mintAmount <= maxSupply, "Minting would exceed the max supply of NFTs");
    ...
    function mintForDAO() external onlyOwner {
        uint256 supply = totalSupply();
        require(supply + AMOUNT_RESERVED_FOR_DAO <= maxSupply, "Minting would exceed the max supply of NFTs");
        _safeMint(DAO_ADDRESS, AMOUNT_RESERVED_FOR_DAO);
    }
