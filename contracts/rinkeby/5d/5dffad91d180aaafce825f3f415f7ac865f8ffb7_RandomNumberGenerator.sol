...
// File: contracts/5_Lottery_RandomGenerator.sol
...
// File: contracts/interfaces/IFrostyLottery.sol
...
interface IFrostyLottery {
     ...
     * @notice Draw the final number, calculate reward in FRST per group, and make lottery claimable
     ...
     * @param _amount: amount to inject in FRST token
     ...
     * @param _priceTicketInFrst: price of a ticket in FRST
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Frosty lottery

     */

    function getRandomNumber(uint256 _seed) external override {

        require(msg.sender == frostyLottery, "Only FrostyLottery");
     ...
     * @notice Set the address for the FrostyLottery

     * @param _frostyLottery: address of the Frosty lottery

     */

    function setLotteryAddress(address _frostyLottery) external onlyOwner {

        frostyLottery = _frostyLottery;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFrostyLottery(frostyLottery).viewCurrentLotteryId();
