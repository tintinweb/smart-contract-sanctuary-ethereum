    ...
    UUPSUpgradeable
{
    ...
    /// @notice Pause token transfers in the event of emergency
    /// @dev This will only be used for emergency situations and should not be used for any other reason
    function pause() public onlyOwner {
        _pause();
    }

    /// @notice Unpause token transfers in the event of emergency
    /// @dev This will restore token transfers after a emergency event
    ...
    /// @notice Upgrade proxy support function
