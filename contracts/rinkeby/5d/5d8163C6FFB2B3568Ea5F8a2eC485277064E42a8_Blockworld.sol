...
contract Blockworld is ERC721Enumerable, Ownable {
    ...
    address public constant creatorAddress =
        0xB80F4A14D25694d04fbA703ec710e98Fa698B20d;

    event PauseEvent(bool pause);
    event welcomeToBlockworld(uint256 indexed id);
    event NewPriceEvent(uint256 price);
    event NewMaxElement(uint256 max);

    constructor(string memory baseURI) ERC721("Blockworldpvp", "Blockhead") {
        setBaseURI(baseURI);
    }
    ...
    function _mintAnElement(address _to, uint256 _tokenId) private {
        ...
        emit welcomeToBlockworld(_tokenId);
    }
