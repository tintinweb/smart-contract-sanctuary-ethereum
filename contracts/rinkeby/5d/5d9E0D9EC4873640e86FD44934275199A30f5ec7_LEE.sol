...
contract LEE is ERC20, Ownable {
    uint256 public constant MAX_VALUE = 7000000000000000000000000000;
    ...
    uint256[] public daysIncremented = [//lets assume start date is 01.september
    30,
    61,
    91,
    122,
    ...
    function mint(address _to, uint256 _amount) external onlyOwner {
        require(totalSupply() + _amount <= maxSupply(block.timestamp), "Can't mint more then max amount");
        _mint(_to, _amount);
    }
