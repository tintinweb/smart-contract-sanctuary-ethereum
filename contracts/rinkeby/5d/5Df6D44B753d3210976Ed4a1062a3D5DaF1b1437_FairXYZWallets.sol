...
contract FairXYZWallets is Ownable{
    ...
    mapping(address => bool) preApprovedAddresses;
    ...
    // Gas-free listings on OpenSea, LooksRare, etc.
    function addPreapproved(address preapprovedAddress) public onlyOwner returns(address)
    {
