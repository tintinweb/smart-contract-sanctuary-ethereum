...
contract GenesisBlooms is
    ERC721,
    Ownable //Reentrance Guard
{
    ...
    constructor() ERC721("Genesis Bloomz", "BLOOMS") {}
    ...
    {
        require(
            currentTokenId.current() < COLLECTION_SIZE,
            "Genesis Blooms: the maximum number of NFTs have already been minted."
        );
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "GenesisBlooms: the token Id supplied does not exist."
        );
