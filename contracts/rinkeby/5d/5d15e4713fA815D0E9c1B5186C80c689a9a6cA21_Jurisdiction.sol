...
/**
 * @title Opinions Contract - Track Opinion about Entities
 * @dev To Extend or Be Used by Jurisdictions (As Rules)
 * - [TODO] Hold & Serve Opinions
...
abstract contract Opinions is IOpinions {
    ...
    struct Opinion {
        ...
        // bool negation;  //0 - Commision  1 - Omission        //S
        int8 value;     //V
        // Value value;
        int8 strict;    //O
    }
    ...
    */
    ...
    mapping(uint256 => Opinion) internal _opinionsOwn;  //Opinions about Tokens of Self / Known Entity
    mapping(uint256 => mapping(address => Opinion)) internal _opinions;   //Opinions about Tokens Held on Other Contracts
    /// @note This introduces a blindspot: Token-0 is considered the contract itself, so if it exists, it can't be addressed. Ideally, null would mean the contract itself. 
