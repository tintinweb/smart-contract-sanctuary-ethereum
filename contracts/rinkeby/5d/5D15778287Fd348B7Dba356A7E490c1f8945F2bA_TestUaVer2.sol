...
contract TestUaVer2 is ERC1155, Ownable, ReentrancyGuard {
    ...
    uint256 public artworks = 10;
    //uint256 public maxSupply = artworks * 10;
    uint256 public maxPerTransaction = 10;

    string private _uri = "";
    string private suffix = ".json";

    string private hiddenUri = "ipfs://QmUQtxC3NWLq58RxxbNKkyFTKpDVQZyCGUgT3CN7LNqb6R/hidden.json";
