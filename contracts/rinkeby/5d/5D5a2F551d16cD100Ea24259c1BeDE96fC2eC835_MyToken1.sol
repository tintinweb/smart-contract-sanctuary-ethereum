...
contract MyToken1 is ERC721, ERC721Enumerable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://cloudfront-us-east-2.images.arcpublishing.com/reuters/43YAWLITTZJLZIQTCP2JSS4KSM.jpg";
    }
    ...
    function _saleToken(
        ...
        uint256 roy = pBEPent(amount, _royal[tokenId]);
        payable(_creator[tokenId]).transfer(roy);
