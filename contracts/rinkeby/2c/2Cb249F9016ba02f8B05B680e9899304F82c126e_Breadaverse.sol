...
contract Breadaverse is ERC721Enumerable, Ownable {
    ...
    uint16 public constant totalBreads = 10000;

    uint16 public breadPrice = 415;
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        breadId = 1; // item 1-9500
        reserveBreads = 9500; // item 9501-10000
    }
    ...
    function mint(
        ...
        require(breadId + amount <= 9500, "Mint limit reached");
    ...
    function reserveBread(address to, uint16 amount) public onlyOwner {
        require(reserveBreads + amount <= 10000, "Out of stock");
    ...
    function setbreadPrice(uint16 price) public onlyOwner {
        breadPrice = price;
    }
