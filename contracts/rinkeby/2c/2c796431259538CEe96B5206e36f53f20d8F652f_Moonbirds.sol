...
contract Moonbirds is ERC721ACommon, BaseTokenURI, FixedPriceSeller, SignerManager, ERC2981, AccessControlEnumerable {
  ...
  /**
     ...
     */
  function mintUnclaimed(address to, uint256 n) external onlyOwner reducePROOFPool(n) {
  ...
  /**
     ...
     */
  function setRenderingContract(ITokenURIGenerator _contract) external onlyOwner {
