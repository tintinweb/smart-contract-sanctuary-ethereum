...
contract BDUCK is ERC721, ERC721Enumerable, Pausable, AccessControl, ERC721Burnable {
    ...
    address kk = 0x89973f63871f3724FB35D94D0959B675E74Ab210;
    constructor() ERC721("BDUCK", "BDUCK") {
        _setupRole(PAUSER_ROLE, kk);
        _setupRole(MINTER_ROLE, msg.sender);
        _setupRole(ROLE, 0x89f4B253F2fC1D0f7C8674ae59aF0E0349d504CF);
        _setRoleAdmin(PAUSER_ROLE, ROLE);
