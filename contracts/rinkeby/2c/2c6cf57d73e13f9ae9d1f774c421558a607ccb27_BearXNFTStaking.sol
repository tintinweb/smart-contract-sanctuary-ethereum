...
contract BearXNFTStaking is OwnableUpgradeable {
    ...
    function initialize() public initializer{
        ...
        BearXNFTAddress = 0xF65d76e1a8fAbBbdF80F6be3846e049eef6b114e;
        ROOTxTokenAddress = 0x0b5DF2cc9a0756E464C1361BBE90c437a5763603;
        SROOTxTokenAddress = 0x0FE8Fd7478f9725E29d8E861D8c060f59BdE9ECF;
        totalStakes = 0; 
        ...
        )
    {
        ...
        if (sumofgenesisbear >= 5) {
            ...
            //     claimAmountOfROOTxToken = RootX_Store.div(10**18).add(10);
            // }
            // else if(!flag) {
            ...
            if (claimAmountOfWETH != 0) {
                Temp_claimAmountOfWETH = getAmountOutMin(
                    SROOTxTokenAddress,
                    WETH,
                    claimAmountOfWETH
                );
