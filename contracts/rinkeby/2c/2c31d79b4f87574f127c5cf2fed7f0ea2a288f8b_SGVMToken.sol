...
contract SGVMToken is ERC721A, Ownable {
    ...
    bool public corporateDidClaimRound1 = false;
    uint256 public constant corporateClaimAmountA = 444;
    uint256 public constant forkClaimAmount = 47;
    uint256 public constant corporateClaimAmountB = 731;

    bool public corporateDidClaimRound2 = false;
    uint256 public constant corporateClaimAmountC = 1000;
    ...
    function corporateClaim1() external onlyOwner {
        require(
            !corporateDidClaimRound1,
            "Corporate has already claimed their SGVMs (1)"
        );
        ...
        corporateDidClaimRound1 = true;
    }

    function corporateClaim2() external onlyOwner {
        require(
            !corporateDidClaimRound2,
            "Corporate has already claimed their SGVMs (2)"
        );

        _safeMint(sGvmCorporate, corporateClaimAmountC);

        corporateDidClaimRound2 = true;
    }
}
