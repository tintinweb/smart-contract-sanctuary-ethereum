...
function changeRafflesFee(uint _affiliateFee, uint _stakingFee) public onlyOwner{
s_affiliateFee = _affiliateFee;
s_stakingFee = _stakingFee;
}

function affiliateChange(address _add) public {
    affiliate[msg.sender] = _add;
}
