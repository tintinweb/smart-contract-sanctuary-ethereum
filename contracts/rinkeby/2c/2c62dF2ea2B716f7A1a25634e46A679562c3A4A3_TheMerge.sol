...
contract TheMerge is ERC721Enumerable, ERC721Burnable, ERC2981, Ownable, Pausable {
     ...
     * @param randomHash a block hash or VRF result
     **/
    ...
    function genesisSeed(uint256 tokenId) public view returns (bytes32) {
    ...
    function setBaseURI(string memory newBaseURI, uint256 cohortId_) public onlyOwner {
