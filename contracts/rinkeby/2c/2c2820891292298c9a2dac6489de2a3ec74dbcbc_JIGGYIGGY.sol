...
contract JIGGYIGGY is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("JIGGY JIGGY IGAUNAS", "IGGY") {
    setHiddenMetadataUri("ipfs://QmQMtVijyjmKtmxWAZUKz1ApMrpiJ6ua8YsMCWJmacrAAj/1.json");
  }
