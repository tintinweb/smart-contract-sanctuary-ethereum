...
contract Disrupt3rsAllow is ERC721, Ownable, ERC721Burnable, ERC2981 {
    ...
    constructor(uint96 _royaltyFeesInBips, string memory _URI, address _royalty, address _fee ) ERC721("Disrupt3rs", "DSRPT") {
