...
contract xUnknown is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private _maxtokensperwallet = 5;
    uint256 private _maxtokenspertx = 5;
    ...
    function mint(uint256 amount) public payable nonReentrant {
        ...
        if(_checkperwallet) {
            ...
            require(amount <= _maxtokenspertx, "minted amount exceeds max tokens per tx");
        }
