...
contract PokerDawgsCollection is ERC721, Ownable {
    ...
    // Change these
    address public verifiedSigner = 0x71F47BE92D0B8C6282102aea9761B7F7a0Ae0CC8;
    ...
    constructor() ERC721("Poker Dawgs", "POKERDAWGS") {}
    ...
    function isWhitelisted(address sender, bytes32[] memory _merkleProof)  private view returns (bool){
        return MerkleProof.verify(_merkleProof, _merkleRoot, keccak256(abi.encodePacked(sender)));
    }
