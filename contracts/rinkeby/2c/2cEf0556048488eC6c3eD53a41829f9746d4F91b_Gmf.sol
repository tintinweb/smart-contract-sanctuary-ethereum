...
//requires the pragma experimental ABIEncoderV2;
//deployed as a flattened file, with all contracts using solidity 0.8.11
...
contract Gmf is Ownable, IERC20 {       
    ...
    address public dividendTrackerAddress = address(dividendTracker);
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "GMF_DividendTracker";
    string private _symbol = "GMF_DividendTracker";
    ...
    function manualSendDividend(uint256 amount, address holder)
        ...
        onlyOwner
    {
        uint256 contractMetisBalance = address(this).balance;
        payable(holder).transfer(amount > 0 ? amount : contractMetisBalance);
    }
