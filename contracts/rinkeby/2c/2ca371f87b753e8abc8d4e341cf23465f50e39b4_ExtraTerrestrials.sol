...
contract ExtraTerrestrials is ERC721r, Ownable, Pausable {

    uint256 public constant MAX_SUPPLY = 10;
    uint256 public constant MAX_PUBLIC_MINT = 2;

    string private  baseTokenUri = "ipfs.io/ipfs/QmRT9TsLRV76dvaVZXHWBZNvFYpJAqJSjUb8TX1AmT8dXg/";
    ...
    function PriceUpdate(uint256 _supply) internal pure returns (uint256 _cost){
     ...
     function mintNFT(uint256 _quantity) external payable whenNotPaused callerIsUser{
