...
contract STYX is ERC721A , Ownable  {
    ...
    function changeMaxMint(uint256 maxMint) public onlyOwner {
     ...
     constructor() ERC721A("Styx Land Collection", "LAND") {}

        function withdraw() public onlyOwner {
        uint balance = address(this).balance;
        
        address payable one = payable(0xAe2C5fB3d9924E9c83e4252005F48723f60a43b2);
        
        one.transfer(balance.mul(100000000000000000000).div(100000000000000000000));
