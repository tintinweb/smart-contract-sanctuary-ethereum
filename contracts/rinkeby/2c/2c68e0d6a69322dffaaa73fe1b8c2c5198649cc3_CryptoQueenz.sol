...
contract CryptoQueenz is Ownable, ERC721, ERC2981, TheTreasury {
  ...
  function buyPublic(uint256 numberOfTokens) external payable {
    ...
    //TODO change this
    // require(block.timestamp >= presaleConfig.endTime, "Sale not active");
  ...
  function configurePresale(uint256 startTime, uint256 endTime, uint256 mintPrice)
    external
    onlyOwner
  {
    uint32 _startTime = startTime.toUint32();
