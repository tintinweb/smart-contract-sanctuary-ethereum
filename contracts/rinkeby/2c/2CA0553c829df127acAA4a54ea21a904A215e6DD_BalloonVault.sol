...
contract BalloonVault is Ownable, IERC721Receiver, PaymentSplitter {
    ...
    function setSaleState(bool _saleIsActive, uint256 _price) public onlyOwner {
        saleIsActive = _saleIsActive;
        price = _price;
    }

    function updateConfig(uint256 _startingId, uint256 _maxSupply) public onlyOwner {
        nextId = _startingId;
    ...
    function buy(uint16 _quantity) public payable {
        ...
        require(nextId + _quantity <= maxSupply, "Insufficient supply");
