...
contract BaseNFT is ERC721A, Pausable, Ownable {
     ...
     * @param started - Yes or now
     */
    function setSaleStarted(bool started) external onlyOwner {
    ...
    function presaleBuy(
        ...
        require(msg.value == amount * presalePrice, "incorrect price");

        // Signature verification
        bytes32 msgHash = keccak256(
            abi.encode(msg.sender, _UUID, amount)
        );
    ...
    function publicBuy(uint256 _amount) external payable {
        ...
        require(msg.value == price * _amount, "Ether values is not correct");
