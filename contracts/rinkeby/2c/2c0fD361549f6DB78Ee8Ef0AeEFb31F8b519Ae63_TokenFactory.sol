...
contract TokenFactory is IFactoryERC721, Ownable {
    ...
    string private uri = 'ipfs://QmNgpvsr2gUPbQjTjwqdgTH2zLC3LS85YkmDqNnXqNQt7M/';
    uint256 TOKENS_NUM_OPTIONS = 11;
    uint256 lastIndex;
    ...
    function name() external pure override returns (string memory) {
        return '222NEKOT ENIARKU NI RAW ON';
        //        return 'NO WAR IN UKRAINE TOKEN';
    }
...
//      return 'NWIUF';
    ...
    function getUri(uint256 _optionId) internal view returns (string memory) {
        if (sold[_optionId] == true) {
            _optionId = 0;
        }
        return string(abi.encodePacked(uri, Strings.toString(_optionId)));
    }
