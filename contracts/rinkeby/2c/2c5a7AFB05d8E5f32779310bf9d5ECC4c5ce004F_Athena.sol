...
contract Athena  is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  using Strings for uint256;
    ...
    //supplies
    uint256 public mintSupply = 9500;
    uint256 public RESERVE_SUPPLY = 250;
    uint256 public AIRDROP_SUPPLY = 250;
  ...
  /**
    ...
    modifier mintLimitCompliance(uint256 _mintAmount) {
        ...
        require(addressMintedBalance[msg.sender].mintCount + _mintAmount <= maxMintAmountPerWallet,
         ...
         require( minted + _mintAmount <= mintSupply , "Max supply Exceeded"); 
       _;
    } 
  ...
  /**
    ...
    */
    ...
    {
          require(_mintAmount > 0, 'Mint amount should be greater than 0'); 
         require(airdropMinted + _mintAmount < AIRDROP_SUPPLY, "airdrop supply Exceeded");
          _mintLoop(_receiver, _mintAmount);
           airdropMinted += _mintAmount;    
    }
  ...
  /**
    ...
    */
    function mintReserved(address to, uint256 quantity)
     ...
     onlyOwner
    {
        require(quantity > 0, 'Mint amount should be greater than 0'); 
        require(reserveMinted + quantity < RESERVE_SUPPLY, "Reseve supply Exceeded");
  ...
  /**
    * Update colletion AIRDROP_SUPPLY.
    * @param _supply token supply.
    */
    function setAirdropSupply(uint256 _supply) public onlyOwner {
        AIRDROP_SUPPLY = _supply;
    }

  /**
    * Update colletion RESERVE_SUPPLY.
    * @param _supply token supply.
    */
    function setReserve_supply(uint256 _supply) public onlyOwner {
