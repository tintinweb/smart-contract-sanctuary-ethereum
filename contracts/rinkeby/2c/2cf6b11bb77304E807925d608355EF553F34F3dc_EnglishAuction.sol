...
contract EnglishAuction {
    ...
    // // Top Bids Yet
    uint[] topBidsYet;
    address[] checkTopbiddersAddressYet;
    ...
    function bid() external payable {
        ...
        checkTopbiddersAddressYet.push(msg.sender);
    ...
    function get_bidders_all_Bids( uint _auctionNo ) public view returns( uint[] memory ) {
    ...
    function checkTopbiddersAddress() public view returns (address[] memory) {
        return checkTopbiddersAddressYet;
    }
