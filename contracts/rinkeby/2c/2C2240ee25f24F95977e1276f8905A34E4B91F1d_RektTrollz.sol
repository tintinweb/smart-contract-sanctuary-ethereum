...
contract RektTrollz is Ownable, ERC721A, ReentrancyGuard {
    uint256 public constant PRICE = 0 ether;             // Price of the single degens
    uint256 public constant MAX_MINT_SIZE = 2;             // Max degens allowed in one mint
    uint256 public constant MAX_MINTS = 3333;               // Maximum degens count
    uint256 public constant MAX_TOKENS_PUBLIC_MINT = 2933;  // Maximum degens count for public sale
    uint256 public RESERVED_MINTS_AVAILABLE = 400;          // Reserved degens count
    uint256 public numTokensMinted = 0;                     // Sold degens count
    uint256 public constant MINT_PER_WALLET = 2;           // One Wallet can mint only 10
