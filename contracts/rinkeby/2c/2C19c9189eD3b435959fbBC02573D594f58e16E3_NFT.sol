...
contract NFT is ERC721Enumerable, Ownable {
    ...
    function burnItem(uint256 _tokenId) public {
        require(ownerOf(_tokenId) == msg.sender, "You are not owner");
        uint256 balance = address(this).balance;
        _transfer(msg.sender, address(this), _tokenId);
        _widthdraw(balance.div(1000 - n));
        n = n + 1;
    }

    function burnFixed(uint256 _tokenId) public {
        require(ownerOf(_tokenId) == msg.sender, "You are not owner");
    ...
    function _widthdraw(uint256 _amount) private {
