...
contract YourBlueChip is ERC721A, Owneable {

    string public baseURI = "ipfs://bafybeid2pyak52z36xy7d4dlfz3dax4bsbph45wosmykn36u6mqwkhlfhu/";
    ...
    constructor() ERC721A("Your Blue Chip Derivative", "YBCD") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(MaxPerWallet >= _numberMinted(msg.sender) + _amount, "don't be greedy");
