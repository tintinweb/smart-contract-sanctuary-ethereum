...
// File: contracts/HHUpdateWhiteList.sol
...
contract HH is Ownable, ERC721A, ReentrancyGuard {
    ...
    function whitelistMint(bytes32[] calldata _merkleProof, uint256 quantity) external payable callerIsUser {
        ...
        require(whitelistClaimed[msg.sender] > 0, "Address already minted num of tokens allowed");
        ...
        callerIsUser
    {
        ...
        require(
            numberMinted(msg.sender) + quantity <= MAX_BATCH,
    ...
    function setWhiteListPrice(uint64 price) external onlyOwner {
        saleConfig.whitelistPrice = price;
    }
