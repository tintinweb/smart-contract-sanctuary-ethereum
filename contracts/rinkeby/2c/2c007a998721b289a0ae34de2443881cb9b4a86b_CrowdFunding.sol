...
contract CrowdFunding {
    ...
    */
    ...
    function f(uint256 campaignID,uint256 funderID) public view returns (address, uint256)
    {
        return (campaigns[campaignID].funders[funderID].addr ,campaigns[campaignID].funders[funderID].amount);
    }
