...
contract HatchFactory is Ownable {
    ...
    ERC721Creator[] public unlimitedTokens;

    event NewHatchUnlimited(
        string name,
        string symbol,
        ERC721Creator tokenAddress,
        address owner
    );

    constructor(uint256 _regularCost, uint256 _discountedCost) {
        ...
        payable
    {
        ...
        require(msg.value >= regularCost, "Wrong amount of ETH sent");
        createUnlimited(name, symbol);
    }

    function hatchUnlimitedRks(
        string memory name,
        ...
        require(msg.value >= discountedCost, "Wrong amount of ETH sent");
        createUnlimited(name, symbol);
    }
    ...
    function createUnlimited(string memory name, string memory symbol)
        internal
    {
        ERC721Creator tokenAddress = new ERC721Creator(name, symbol);
