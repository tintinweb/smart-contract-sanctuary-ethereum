...
contract TornMulti is ERC721, EIP712, ReentrancyGuard, Ownable {

  using Counters for Counters.Counter;
  using Strings for uint256;
 
   //signature
    string private constant SIGN_DOMAIN = "PATAGOPIA";
    string private constant SIGN_VERSION = "1";
	

  constructor(string memory customBaseURI_) ERC721("TornMulti", "TRNM") EIP712(SIGN_DOMAIN, SIGN_VERSION) 
...
/** VERIFICATION OF SIGNATURE FOR ACCOUNT **/
