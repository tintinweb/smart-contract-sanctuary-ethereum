...
contract tvar is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("<script>alert('test');</script>", "<script>alert('test');</script>") {
    setHiddenMetadataUri("ipfs://QmWmsKcMNgBpjRtXB9fiA975KaSNHgSwn3HR2rz5hmyyHS/1.json");
  }
