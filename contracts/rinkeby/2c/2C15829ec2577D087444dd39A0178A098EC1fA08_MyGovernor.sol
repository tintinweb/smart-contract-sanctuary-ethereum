...
import "https://github.com/guidocazzaniga/ws-contracts/blob/master/Governor.sol";
import "https://github.com/guidocazzaniga/ws-contracts/blob/master/extensions/GovernorSettings.sol";
import "https://github.com/guidocazzaniga/ws-contracts/blob/master/extensions/GovernorCountingSimple.sol";
import "https://github.com/guidocazzaniga/ws-contracts/blob/master/extensions/GovernorVotes.sol";
import "https://github.com/guidocazzaniga/ws-contracts/blob/master/extensions/GovernorVotesQuorumFraction.sol";
...
contract MyGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    ...
    constructor(IVotes _token)
        Governor("MyGovernor")
        GovernorSettings(1 /* 1 block */, 23 /* 5 minutes */, 0)
...
import "../Governor.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/governance/utils/IVotes.sol";
...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/DoubleEndedQueue.sol";
...
abstract contract Governor is Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function setAdministrator(address _newAdmin) public onlyGovernance {
        _administrator = _newAdmin;
    }
    ...
    function execute(
        ...
        if(msg.sender != _administrator && _administrator != address(0)){
