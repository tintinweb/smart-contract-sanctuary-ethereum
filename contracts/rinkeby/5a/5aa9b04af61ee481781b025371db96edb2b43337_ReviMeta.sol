...
contract ReviMeta is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI) ERC721("ReviMeta", "RM") {
        setBaseURI(baseURI);
    ...
    { 
     ...
     function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if(bytes(base).length > 0){
            return reveal ? string(abi.encodePacked(base, tokenId.toString(), ".json")) : string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmfKTZxVdTSPU9LN4AN4nQKkk325anoVV9KJNjhxL9Yt77"));
        }
        else 
        return "";
    }
    function contractURI() public view returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "RaviMeta", "description": "Collection of 5000 unique RaviMeta characters.", "seller_fee_basis_points": 1000, "fee_recipient": "0x6BC5e5822C8c2807Bc5D54cdD9925B9214fC0f79"}'))));
