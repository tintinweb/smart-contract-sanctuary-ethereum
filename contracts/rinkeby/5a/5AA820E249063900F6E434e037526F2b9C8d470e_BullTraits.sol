...
contract BullTraits is Ownable, ITraits {
  ...
  function drawSVG(uint256 tokenId) public view returns (string memory) {
    ...
    console.log('sfur:', sfur.png);
    console.log('shead:', shead.png);
    console.log('sEar:', sEar.png);
    console.log('sEyes:', sEyes.png);
    console.log('sNose:', sNose.png);
    console.log('sMouth:', sMouth.png);
    console.log('sNeck:', sNeck.png);
    console.log('sFeet:', sFeet.png);
