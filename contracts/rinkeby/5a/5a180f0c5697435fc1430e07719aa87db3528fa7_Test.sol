...
contract Test is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(uint256 maxSupply_, uint256 presaleSupply_, uint256 amountForDevs_) ERC721A("Test", "Test") {
  ...
  function setupPublicSaleInfo(uint256 publicSaleStartPrice, uint256 publicSaleStartTime) external onlyOwner {
    saleConfig = SaleConfig(0, 0, 0, publicSaleStartPrice, publicSaleStartTime);
  }
