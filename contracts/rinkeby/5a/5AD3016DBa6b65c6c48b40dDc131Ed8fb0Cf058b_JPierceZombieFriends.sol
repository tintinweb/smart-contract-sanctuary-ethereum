...
contract JPierceZombieFriends is IERC721A, Ownable {
    ...
    */
    function getEthSignedMessageHash(bytes32 _messageHash, bytes32 _msg2)
        public
        pure
        returns (bytes32)
    {
    ...
    */
    function verify(
        ...
        bytes32 ethSignedMessageHash = getEthSignedMessageHash(_msg, _msg2);
