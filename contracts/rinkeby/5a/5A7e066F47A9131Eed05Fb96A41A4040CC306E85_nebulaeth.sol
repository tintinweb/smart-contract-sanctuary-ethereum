...
contract nebulaeth is ERC721Delegated {
    ...
    function getSvg(uint256[12] memory currentEpoch, string[12] memory epochLabels) private view returns (string memory) {
        ...
        parts[7] = uintToString(currentEpoch[0]);
        parts[8] = '" seed="';
        ...
        parts[11] = uintToString(currentEpoch[0]);
        parts[12] = uintToString(currentEpoch[1]);
        parts[13] = '" numOctaves="';
        parts[14] = uintToString(currentEpoch[2]);
        parts[15] = '" seed="';
        parts[16] = uintToString(currentEpoch[3]);
        ...
        metadata = string(
            abi.encodePacked(
                metadata,
                uintToString(currentEpoch[5]),
                " ",
                epochLabels[4],
                " ",
                uintToString(currentEpoch[4]),
                " by the ",
                getStricture(),
                "0x",
        ...
        metadata = string(
            abi.encodePacked(
                ...
                epochLabels[3],
                '","value": "',
                uintToString(currentEpoch[3]),
                '"},{"trait_type": "',
                epochLabels[2],
                '","value": "',
                uintToString(currentEpoch[2]),
                '"},{"trait_type": "',
                epochLabels[1],
                '","value": "',
                uintToString(currentEpoch[1]),
                '"},{"trait_type": "',
                epochLabels[0],
                '","value": "',
                uintToString(currentEpoch[0]),
                '"}]'
            )
        );
    ...
    function mint() public {
        ...
        string memory svgData = getSvg(currentEpoch, epochLabels);
