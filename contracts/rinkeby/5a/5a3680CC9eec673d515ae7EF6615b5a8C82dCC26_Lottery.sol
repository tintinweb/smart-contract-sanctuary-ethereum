...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        uint256 theFee,
        bytes32 theKeyhash
    ) public VRFConsumerBase(vrfAdd, link) {
        entryFee = .002 * (10**18);
        priceFeed = AggregatorV3Interface(add);
    ...
    function ShutDownLottery() public onlyOwner {
        lottery_state = LOTTERY_STATE.CALCULATE;
        ...
        override
    {
        ...
        uint256 indexOfWinner = randomness % (players.length + 1);
        recentWinner = players[indexOfWinner];
        contractOwner.transfer(address(this).balance / 5);
