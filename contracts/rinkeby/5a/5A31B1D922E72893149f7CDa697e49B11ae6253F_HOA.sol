...
contract HOA is ERC721URIStorage, Ownable {
    ...
    uint256 public maxElement = 10000;
    uint256 public wlElement = 1500;
    ...
    function whitelistMint(address _to, uint _count, bytes32[] memory _merkleProof) public payable {
      ...
      if(_whitelistCnt.current() < wlElement) {
    ...
    function mintItem(address _to, uint _count) public payable {
      ...
      require(ownWallet[msg.sender] + _count <= 10, "Maxium is 10");
      require(msg.value >= _count * publicCost, "Not match balance");
      require(_whitelistCnt.current() >= wlElement, "You can't mint in presale period");
    ...
    function isPresale() public view returns (bool) {
        return _whitelistCnt.current() < 1500;
    }
    ...
    function setMaxElement(uint element) public onlyOwner {
      maxElement = element;
    }
