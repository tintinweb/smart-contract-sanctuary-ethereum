...
abstract contract AccessController is AccessControlUpgradeable, SeraphProtected {
    ...
    function addAdmin(address newAdmin) public onlyAdmin withSeraph {
        _grantRole(ADMIN_ROLE, newAdmin);
    }

    function revokeAdmin(address admin) public onlyAdmin withSeraph {
        _revokeRole(ADMIN_ROLE, admin);
    }

    function setGovernor(address newGovernor) public onlyAdmin withSeraph {
    ...
    function setExecutive(address newExecutive) public onlyAdmin withSeraph {
...
contract LeverageEngine is AccessController, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function setDependencies(
        ...
        address addressOUSD
    ) external nonReentrant onlyAdmin withSeraph {
    ...
    function initialize() public initializer withSeraph {
        _grantRole(ADMIN_ROLE, _msgSender());
        setGovernor(_msgSender());
        setExecutive(_msgSender());
        setGuardian(_msgSender());
