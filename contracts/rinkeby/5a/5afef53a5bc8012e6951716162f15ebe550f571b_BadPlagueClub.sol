...
/// @title Contract of Bad Plague Club
/// @author wraps
...
contract BadPlagueClub is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    address[] private _team = [ 
        0x54F0eaaED50F299E2dB62063A01C755Ef3624acF
    ];
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("Bad Plague Club", "BPC") PaymentSplitter(_team, _teamShares) {
