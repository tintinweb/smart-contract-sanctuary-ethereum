...
contract KangarooCountryClub is ERC721A, Ownable, ReentrancyGuard, ControlledAccess {
    ...
    /** Provenance Hash for random distribution of NFTs */
    ...
    modifier mintCompliance(uint256 _quantity, uint256 _maxPerAddress, uint256 _startTime) {
        require(block.timestamp >= _startTime, "Sale has not started yet");
    ...
    function mint(uint256 quantity)
        ...
        callerIsUser
        nonReentrant
        mintCompliance(quantity, maxPublicMintPerAddress, publicSaleStartTime) /** Mint Complaince for Public Sale */
    {
    ...
    function presaleMint(uint256 quantity, bytes32 _r, bytes32 _s, uint8 _v)
        ...
        nonReentrant 
        mintCompliance(quantity, maxPresaleMintPerAddress, presaleStartTime) /** Mint Compliance for Presale */
    {
        _safeMint(msg.sender, quantity);
...
/// OWNER FUNCTIONS ///
    ...
    function setPublicSaleStartTime(uint _startTime) public onlyOwner {
        publicSaleStartTime = _startTime;
    }

    function setPresaleStartTime(uint _startTime) public onlyOwner {
