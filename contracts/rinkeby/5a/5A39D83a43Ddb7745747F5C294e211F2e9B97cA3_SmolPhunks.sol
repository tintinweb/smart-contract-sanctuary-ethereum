...
contract SmolPhunks is Ownable, ERC721F {
    ...
    uint private constant costPerToken = 0.01 ether;
    uint private constant maxSupply = 10_000;
    uint private constant mintBatchSize = 30;
    ...
    function totalMintCost(uint numTokens) private pure returns (uint) {
