...
// File: contracts/1155liquidx.sol
// Author: @fbeach73

contract liquidxa is ERC1155, Ownable {
    string public constant name = "LiquidXa";
    string public constant symbol = "NinjaLiquidXa";

    uint32 public totalSupply = 0;
    uint256 public constant unitPrice = 0.005 ether;

    uint32 public preSaleStart = 1638043200;
    uint32 public constant preSaleMaxSupply = 200;
    
    uint32 public publicSaleStart = 1638054000;
    uint32 public constant publicSaleMaxSupply = 500;
    ...
    function withdraw() external onlyOwner {
        address[2] memory addresses = [
            ...
            0x4ececbC76636F9934A23Aa5e27b3f74f731dB604
        ];
