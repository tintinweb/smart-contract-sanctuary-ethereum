    ...
    AdminManagerUpgradable
{
    ...
    uint256 private _maxWhitelistClaims;
    uint256 private _publicMintTxLimit;
        ...
        initializer
    {
        ...
        __ERC721_init_unchained("TEST", "T");
        ...
        ethCost = 0.8 ether;
        maxGenesisSupply = 8400;
        _maxWhitelistClaims = 3;
        _publicMintTxLimit = 5;
    }
        ...
        nonReentrant
    {
        ...
        require(
            _mintsByWhitelist[msg.sender] + amount <= _maxWhitelistClaims,
    ...
    function mint(uint256 amount) external payable whenNotPaused nonReentrant {
        ...
        require(amount <= _publicMintTxLimit, "You can't mint so many tokens");
        require(msg.value >= ethCost * amount, "Not enough ether");
        _callMint(amount);
    }
    ...
    function setMaxWhitelistClaims(uint256 maxWhitelistClaims)
        external
        onlyAdmin
    {
        _maxWhitelistClaims = maxWhitelistClaims;
    }

    function setPublicMintTxLimit(uint256 publicMintTxLimit)
        external
        onlyAdmin
    {
        _publicMintTxLimit = publicMintTxLimit;
    }
