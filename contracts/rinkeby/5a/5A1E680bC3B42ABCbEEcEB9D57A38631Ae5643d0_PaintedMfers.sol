// SPDX-License-Identifier: MIT
    ...
    contract PaintedMfers is ERC721, Ownable, ERC721Enumerable {
      ...
      event UkrainainmfersMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Ukrainians Mfers", "UKRM") {}
      ...
      function mintUkrainianmfers(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit UkrainainmfersMinted(id, msg.sender);
          }
        }
      }
