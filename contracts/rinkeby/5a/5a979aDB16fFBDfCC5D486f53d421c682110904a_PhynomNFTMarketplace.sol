...
contract PhynomNFTMarketplace is ReentrancyGuard,Ownable {
  ...
  function createMarketItem(
    ...
    collections[collectionId].itemsListed = collections[collectionId].itemsListed.add(1);
  ...
  function createMarketSale(
    ...
    collections[collectionId].itemsSold = collections[collectionId].itemsSold.add(1);
    collections[collectionId].totalSale = collections[collectionId].totalSale.add(price);
...
function editANewCollection(uint256 collectionId,string calldata _logoUrl,string calldata _collectionName,string calldata _category,string calldata _websiteUrl,string calldata _instaProfile) external {
    require(collections[collectionId].collectionId!=0,"Invalid collection id");
      require(collections[collectionId].userAddress==msg.sender,"You are not authorized for this operation");
