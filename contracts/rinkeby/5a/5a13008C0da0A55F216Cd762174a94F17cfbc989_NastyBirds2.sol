...
contract NastyBirds2 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxPreSaleCount;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(!paused, 'Contract on pause');
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require((preSaleEnabled && msg.value == 0 && !preSaleClaimed[msg.sender] && _mintAmount == 1  && preSaleCount < maxPreSaleCount) || (publicSaleEnabled && msg.value >= cost * _mintAmount && _mintAmount > 0 ), 'Cannot mint this way');

    if (preSaleEnabled && msg.value == 0 ) {
  ...
  function setCost(uint256 _cost) public onlyOwner {
   ...
   function setMaxPresaleCount(uint256 _count) public onlyOwner {
    maxPreSaleCount = _count;
   }
