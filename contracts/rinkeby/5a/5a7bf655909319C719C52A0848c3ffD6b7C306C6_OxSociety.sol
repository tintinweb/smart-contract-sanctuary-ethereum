...
contract OxSociety is ERC1155, ERC2981Base, Ownable {
  ...
  uint256 _artistPayoutBasisPoint;
  uint256 private _currentTokenTypeID = 0; // Used to keep track of the number of different NFTs
  ...
  function contractURI() public pure returns (string memory) {
    return "ipfs://QmasPKZ79uEEC9jCHWWueyp8nAwVr9NKHySMywdzyQrZbT";
  }
...
contract $OxSociety is OxSociety {
    ...
    function $_artistPayoutBasisPoint() external view returns (uint256) {
        return _artistPayoutBasisPoint;
    }
