...
contract BurnWallet is Ownable {
    ...
    {   
        ...
        require(
            day * burnPerDay - totalBurn > 0, 
            "Day burn limit exceed"
        );

        // the burn amount
        uint256 toBurn = Math.min(token.balanceOf(address(this)), day * burnPerDay - totalBurn);


        // checking if a 900 billion is allready burned
        require(
...
contract DuDeToken is ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    public initializer 
    {
        ...
        burnWallet = new BurnWallet(address(this), owner());
