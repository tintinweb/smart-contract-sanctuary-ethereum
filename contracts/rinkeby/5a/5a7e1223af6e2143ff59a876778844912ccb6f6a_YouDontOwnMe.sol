...
contract YouDontOwnMe is Ownable, ERC721A {
    ...
    string private revealedURI = "ipfs://QmYFqYy2cnYVKdUQrfF6fLSMLkAMTVEwtio6K56a8isxgd/";
    ...
    address constant internal DEV_ADDRESS = 0x4b3cBEe11cBA65B7a9Fa5B677a96Cb643eDff654;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("You Dont Own Me", "YDOM") { }
    ...
    function FREE(uint256 quantity) external payable mintCompliance(quantity) {
        require(freeSale, "Free sale inactive");
        require(msg.value == 0, "This phase is free");
        require(quantity == 2, "Only #1 free");
    ...
    function Public(uint256 quantity) external payable mintCompliance(quantity) {
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x4b3cBEe11cBA65B7a9Fa5B677a96Cb643eDff654");
