...
contract xKarafuru is ERC721 {
    ...
    uint256 public constant totalSupply = 5555;
    address public owner = msg.sender;
    string private baseURI_;
    string private blindURI_ = "ipfs://";
        ...
        payable
    {
        ...
        if (block.timestamp < 1645448400) {
            require(false, "Mint is not open yet.");
        }
        if (block.timestamp >= 1645448400 && block.timestamp < 1645455600) {
            require(
