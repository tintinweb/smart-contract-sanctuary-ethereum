...
contract NiftySouq1155V3 is ERC1155Upgradeable, AccessControlUpgradeable {
    ...
    function setNiftySouqAddress(address niftySouqMarketplace_) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Nifty1155:101B");
        require(niftySouqMarketplace_ != address(0), "Nifty1155:100A");
        _niftyMarketplace = niftySouqMarketplace_;
    }
    ...
    function updateRoyalties(uint256 tokenId_, address[] calldata creators_, uint256[] calldata royalties_) external validatePayouts(creators_, royalties_){
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender) || nftInfos[tokenId_].minter==msg.sender,"Nifty1155:101BC");
