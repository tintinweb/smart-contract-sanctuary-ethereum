 ...
 * @author NotOkayLabs
 */
contract HotBebra228 is ERC721A, ERC721AQueryable, Ownable, ReentrancyGuard {
    string public baseURI;
    uint256 public constant MINT_PRICE = 0.001 ether; // Change mint price for testing
    uint256 public constant MAX_PER_TX = 2;
    uint256 public constant MAX_PER_WALLET = 6;
    uint256 public constant FREE_SUPPLY = 10;
    ...
    constructor() ERC721A("HotBebra228", "HB") {
    ...
    function withdraw() external onlyOwner nonReentrant {
        require(
            isRefundGuaranteeActive() == false,
            "Founders cannot withdraw anything when the refunds are open!"
        );
