    ...
    GovernorTimelockControl
{
    ...
    /// @param owner Accound sended Proposal
    ...
    /// @param _timelock addres of Time Locker Contract 
    ...
    /// @return number_of_tokens return number of tokens voted in blockNumber
    ...
    /// @notice Add proposal for internal
    /// @dev
    ...
    /// @param owner Accound sended this Proposal
    ...
    returns (bool) {
        ...
        if(!proposalsMap[proposalID]){
            ...
            {
                emit ProposalAdd(false,0,"Budget is too high.");
                return false;
            }
        }
        else
