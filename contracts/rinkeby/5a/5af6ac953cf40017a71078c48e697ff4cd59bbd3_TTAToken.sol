...
contract TTAToken is ERC20 {
    uint32 public release_time = uint32(block.timestamp);
    uint112 public constant max_token_number = uint112(1900_000_000_000 ether);
    mapping(address => bool) public is_claim;
    address[] public yet_claim_people;
    uint112 public all_claim = max_token_number / 2;

    constructor() ERC20("TTADoge1900", "TTA") {
        _mint(0x676eF062a95f7005cf7a82d17E23F66E6dfFa6dD, uint112(max_token_number/100*50));
    }
