    ...
    IsPausable
{
    ...
    function initialize(
        ...
        uint256 _MaxEtraBidPercentages,
    ...
    uint256 public MaxEtraBidPercentages;
    ...
    modifier increasePercentageAboveMinimum(uint32 _bidIncreasePercentage) {
        require(
            _bidIncreasePercentage >= defaultBidIncreasePercentage,
    ...
    function changeMaxEtraBidPercentages(uint256 _newMaxEtraBidPercentages) external onlyOwner {
