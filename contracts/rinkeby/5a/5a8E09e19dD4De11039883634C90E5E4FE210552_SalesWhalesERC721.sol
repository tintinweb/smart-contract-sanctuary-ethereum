...
contract SalesWhalesERC721 is ERC721Psi, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_WHITELIST_TOKENS = 1000;
  ...
  constructor() ERC721Psi("Sales Whales", "SELL") {}
  ...
  function mint(uint256 numberOfTokens) public payable {
    ...
    console.log(this.balanceOf(msg.sender));
    require(
