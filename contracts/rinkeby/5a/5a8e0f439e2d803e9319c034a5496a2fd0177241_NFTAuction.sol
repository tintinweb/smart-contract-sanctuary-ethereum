...
contract NFTAuction is IERC1155Receiver ,  ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;
  ...
  function endAuction(uint256 auctionId) public  {
      ...
      require( idToAuction[auctionId].isActive= true,"Auction is not active");
       ...
       if(idToAuction[auctionId].amount==0)
       {
           ...
           IERC1155(idToAuction[auctionId].nftContract).safeTransferFrom(address(this),
           idToAuction[auctionId].seller, idToAuction[auctionId].tokenId,1,"");
          
       }
       
       else{
            idToAuction[auctionId].sold = true;
            IERC1155(idToAuction[auctionId].nftContract).safeTransferFrom(address(this),idToAuction[auctionId].bidder,
            idToAuction[auctionId].tokenId,1,"");
