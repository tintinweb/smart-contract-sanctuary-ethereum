...
contract Demo is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PUBLIC_SALE_LIMIT = 10;
    uint256 public constant PRESALE_LIMIT = 7;
    uint256 public presaleLimitSoft = 5;
    ...
    modifier maxTokensPerWallet(uint256 numberOfTokens) {
        require(
            balanceOf(msg.sender) + numberOfTokens <= PUBLIC_SALE_LIMIT,
        ...
        isValidMerkleProof(merkleProof, presaleMerkleRoot)
    {
        ...
        require(
            total <= PRESALE_LIMIT && total <= presaleLimitSoft,
    ...
    function setPresaleLimitSoft(uint256 limit) external onlyOwner {
        presaleLimitSoft = limit;
    }
