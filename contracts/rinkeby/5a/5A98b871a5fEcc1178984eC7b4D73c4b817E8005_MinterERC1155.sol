...
contract MinterERC1155 is BaseRelayRecipient, EIP712, ReentrancyGuard{
    ...
    bytes32 private _GLOBAL_HASH = keccak256("mint(address from,uint256 id,string longitude,string latitude,string altitude)");
    ...
    function mint(
        ...
        bytes32 structHash = keccak256(abi.encode(_GLOBAL_HASH, _msgSender(), id, longitude, latitude, altitude));
