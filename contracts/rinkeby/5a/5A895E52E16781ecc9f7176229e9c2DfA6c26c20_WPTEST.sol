...
contract WPTEST is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmPM3kWJtquvUZ8LtpVCrNwRgMUztQt9JuTiKx2daLbUNW/";
  ...
  constructor() ERC721("WPTEST", "WPT") {
    setHiddenMetadataUri("ipfs://QmVQ2CYYChxNecwNMXh4q6GfFopFYHyvoh7V5GTR7Nwox1/hidden.json");
  }
