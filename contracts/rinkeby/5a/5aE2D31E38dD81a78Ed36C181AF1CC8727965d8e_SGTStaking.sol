...
contract SGTStaking is Ownable, ReentrancyGuard {
    ...
    */
    constructor(address _stakingToken , address _mintingToken) {
        ...
        createRewardPlan("Plan 1" , 60 , 5 , 50);
        createRewardPlan("Plan 2" , 120 , 10 , 100);
        createRewardPlan("Plan 3" , 180 , 15 , 150);
    }
   ...
   */
    ...
    */
     ...
     * @param _votingPowerRate rate of that voting power
     */
    function updateRewardPlan(uint256 _index, string memory _name, uint256 _rewardRate, uint256 _votingPowerRate) public onlyOwner validRewardPlanIndex(_index)
    {
     ...
     * @param _index index of that reward plan
     */
    function removeRewardPlan(uint256 _index) public onlyOwner validRewardPlanIndex(_index)
    {
...
//    onlyOwner
    ...
    */
     ...
     */
    function stake(uint256 _amount, uint256 _rewardPlanIndex) public {
        createStake(
            _amount,
            _rewardPlanIndex);
    }
