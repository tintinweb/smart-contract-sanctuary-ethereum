...
contract MintLama is Ownable, ERC721 {
    ...
    function mint(uint256 count) public payable {
        ...
        require(msg.value >= count * pricePerItem, "Incorent value sent");
        
        _mintTo(msg.sender, count);
    }

    function _mintTo(address to, uint256 count) private {
        require(_counter + count <= maxSuply, "Over Max Supply");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(metadataLocation, tokenId.toString(), ".json"));
    }
