...
// File: contracts/BoatsailNFT.sol
...
contract BoatsailNFT is ERC721 {
	...
	uint256 constant public FEE_MAX_PERCENT = 0; // 20 % : 200
    uint256 constant public FEE_MIN_PERCENT = 0; // 5 % : 50
    uint256 constant private FEE_MINT = 0; // 2000000000000000; // 0.002 BNB
    address public adminAddress;

    string public collection_uri; // collection metadata
	 ...
	 */
    function initialize(
        string memory _collection_uri, //collection metadata
        address creator,
    ...
    function mintTo(string memory _tokenURI, uint256 royalty) external payable returns (uint256){        
        ...
        payable(adminAddress).transfer(FEE_MINT);
