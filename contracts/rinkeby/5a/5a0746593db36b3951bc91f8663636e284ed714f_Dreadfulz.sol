...
contract Dreadfulz is ERC721ABurnable, Ownable, ReentrancyGuard, Pausable {
    ...
    function whitelistMint(uint256 count, bytes32[] memory proof) external payable nonReentrant notBots whenNotPaused {
