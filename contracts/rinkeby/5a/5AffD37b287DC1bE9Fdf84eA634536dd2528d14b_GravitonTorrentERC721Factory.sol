...
contract GravitonTorrentERC721Factory is Ownable {
    ...
    function deployGravitonTorrentERC721(string memory tokenName, string memory tokenSymbol)
        external
        returns (address gravitonTERC721Contract)
    {
        GravitonTorrentERC721 deployedContract = new GravitonTorrentERC721(tokenName, tokenSymbol, _tnftSigner);
    ...
    Verifier
{
    ...
    function _mintTorrent(
        ...
        _tokenIds.increment();
        address signer = _verifyString(torrentMagnetLink, v, r, s);
        require(signer == _tnftSigner, "Mint: invalid signature");
