    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        price = (1 ether) / 50; // .02 eth for RINKEBY
        //price = (1 ether * 2) / 10; // .2 eth for MAINNET

        wlPrice = (1 ether * 15) / 1000; // .015 eth for RINKEBY
    ...
    /**
     * @dev returns the baseURI of the token
     *
     * - overridable
     */
    ...
    /**
     * @dev returns the generation of the token
     *
     */
    ...
    function mintNFT(uint256 _quantity) public payable virtual nonReentrant {
        require(status == Status.PUBLIC, "Public sale has not started yet");
